...
version := "201909200330-411073"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "me.shadaj" %%% "slinky-native" % "0.6.2",
  "org.scalablytyped" %%% "ant-design__icons-react-native" % "1.0.2-c14787",
  "org.scalablytyped" %%% "ant-design__react-native" % "3.2.0-c227ad",
  ...
  "org.scalablytyped" %%% "react-slinky-facade" % "201907271058-feb11c",
