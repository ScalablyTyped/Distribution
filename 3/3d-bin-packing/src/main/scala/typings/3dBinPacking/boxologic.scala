...
object boxologic {
  ...
  object Box {
    ...
    extension [Self <: Box](x: Self) {
      ...
      inline def setHit_test_point(value: (js.Any, js.Any, js.Any) => js.Any): Self = StObject.set(x, "hit_test_point", js.Any.fromFunction3(value))
      
      inline def setHit_test_single(value: js.Any => js.Any): Self = StObject.set(x, "hit_test_single", js.Any.fromFunction1(value))
  ...
  trait Boxologic extends StObject {
    ...
    /* private */ var bbfx: js.Any
    
    /* private */ var bbfy: js.Any
    
    /* private */ var bbfz: js.Any
    
    /* private */ var bboxi: js.Any
    
    /* private */ var bboxx: js.Any
    
    /* private */ var bboxy: js.Any
    
    /* private */ var bboxz: js.Any
    
    /**
      * The best layer, which can deduct the {@link best_solution_volume}.
      */
    /* private */ var best_layer: js.Any
    
    /**
      * The best orientation of the pallet, which can deduct the {@link best_solution_volume}.
      */
    /* private */ var best_orientation: js.Any
    
    /**
      * The best volume, fit the best utilization degree of the pallet space.
      */
    /* private */ var best_solution_volume: js.Any
    
    /* private */ var bfx: js.Any
    
    /* private */ var bfy: js.Any
    
    /* private */ var bfz: js.Any
    
    /**
      * Boxes, trying to pack into the {@link pallet}.
      */
    /* private */ var box_array: js.Any
    
    /* private */ var boxi: js.Any
    
    /* private */ var boxx: js.Any
    
    /* private */ var boxy: js.Any
    
    /* private */ var boxz: js.Any
    
    /**
      * Candidate {@link Box.layout_height layout_height} of the {@link cboxi current box}.
      */
    /* private */ var cbox_layout_height: js.Any
    
    /**
      * Candidate {@link Box.layout_length layout_length} of the {@link cboxi current box}.
      */
    /* private */ var cbox_layout_length: js.Any
    
    /**
      * Candidate {@link Box.layout_width layout_width} of the {@link cboxi current box}.
      */
    /* private */ var cbox_layout_width: js.Any
    
    /**
      * Index of the current {@link box}.
      */
    /* private */ var cboxi: js.Any
    ...
    /**
      ...
      */
    /* private */ var hundred_percent: js.Any
    ...
    /**
      ...
      */
    /* private */ var instanceArray: js.Any
    ...
    /**
      ...
      */
    /* private */ var layer_done: js.Any
    
    /**
      * Key of the unevened layer in the current packing layer.
      */
    /* private */ var layer_in_layer: js.Any
    ...
    /**
      ...
      */
    /* private */ var packed_layout_height: js.Any
    
    /**
      * Packed {@link Pallet.vo1lume volume} of the {@lnk pallet}.
      */
    /* private */ var packed_volume: js.Any
    ...
    /**
      ...
      */
    /* private */ var packing: js.Any
    
    /**
      * Whether the best solution is deducted.
      */
    /* private */ var packing_best: js.Any
    ...
    /**
      ...
      * @see scrap_list
      */
    /* private */ var scrap_min_z: js.Any
    
    /**
      * Sum of all boxes' volume.
      */
    /* private */ var total_box_volume: js.Any
  ...
  object Boxologic {
    ...
    extension [Self <: Boxologic](x: Self) {
      ...
      inline def setAnalyze_box(value: (js.Any, js.Any, js.Any, js.Any, js.Any, js.Any, js.Any, js.Any, js.Any) => js.Any): Self = StObject.set(x, "analyze_box", js.Any.fromFunction9(value))
      
      inline def setBbfx(value: js.Any): Self = StObject.set(x, "bbfx", value.asInstanceOf[js.Any])
      
      inline def setBbfy(value: js.Any): Self = StObject.set(x, "bbfy", value.asInstanceOf[js.Any])
      
      inline def setBbfz(value: js.Any): Self = StObject.set(x, "bbfz", value.asInstanceOf[js.Any])
      
      inline def setBboxi(value: js.Any): Self = StObject.set(x, "bboxi", value.asInstanceOf[js.Any])
      
      inline def setBboxx(value: js.Any): Self = StObject.set(x, "bboxx", value.asInstanceOf[js.Any])
      
      inline def setBboxy(value: js.Any): Self = StObject.set(x, "bboxy", value.asInstanceOf[js.Any])
      
      inline def setBboxz(value: js.Any): Self = StObject.set(x, "bboxz", value.asInstanceOf[js.Any])
      
      inline def setBest_layer(value: js.Any): Self = StObject.set(x, "best_layer", value.asInstanceOf[js.Any])
      
      inline def setBest_orientation(value: js.Any): Self = StObject.set(x, "best_orientation", value.asInstanceOf[js.Any])
      
      inline def setBest_solution_volume(value: js.Any): Self = StObject.set(x, "best_solution_volume", value.asInstanceOf[js.Any])
      
      inline def setBfx(value: js.Any): Self = StObject.set(x, "bfx", value.asInstanceOf[js.Any])
      
      inline def setBfy(value: js.Any): Self = StObject.set(x, "bfy", value.asInstanceOf[js.Any])
      
      inline def setBfz(value: js.Any): Self = StObject.set(x, "bfz", value.asInstanceOf[js.Any])
      
      inline def setBox_array(value: js.Any): Self = StObject.set(x, "box_array", value.asInstanceOf[js.Any])
      
      inline def setBoxi(value: js.Any): Self = StObject.set(x, "boxi", value.asInstanceOf[js.Any])
      
      inline def setBoxx(value: js.Any): Self = StObject.set(x, "boxx", value.asInstanceOf[js.Any])
      
      inline def setBoxy(value: js.Any): Self = StObject.set(x, "boxy", value.asInstanceOf[js.Any])
      
      inline def setBoxz(value: js.Any): Self = StObject.set(x, "boxz", value.asInstanceOf[js.Any])
      
      inline def setCbox_layout_height(value: js.Any): Self = StObject.set(x, "cbox_layout_height", value.asInstanceOf[js.Any])
      
      inline def setCbox_layout_length(value: js.Any): Self = StObject.set(x, "cbox_layout_length", value.asInstanceOf[js.Any])
      
      inline def setCbox_layout_width(value: js.Any): Self = StObject.set(x, "cbox_layout_width", value.asInstanceOf[js.Any])
      
      inline def setCboxi(value: js.Any): Self = StObject.set(x, "cboxi", value.asInstanceOf[js.Any])
      
      inline def setCheck_found(value: () => js.Any): Self = StObject.set(x, "check_found", js.Any.fromFunction0(value))
      
      inline def setConstruct_layers(value: () => js.Any): Self = StObject.set(x, "construct_layers", js.Any.fromFunction0(value))
      
      inline def setDecode(value: () => js.Any): Self = StObject.set(x, "decode", js.Any.fromFunction0(value))
      
      inline def setEncode(value: () => js.Any): Self = StObject.set(x, "encode", js.Any.fromFunction0(value))
      
      inline def setEvened(value: js.Any): Self = StObject.set(x, "evened", value.asInstanceOf[js.Any])
      
      inline def setFind_box(value: (js.Any, js.Any, js.Any, js.Any, js.Any) => js.Any): Self = StObject.set(x, "find_box", js.Any.fromFunction5(value))
      
      inline def setFind_layer(value: js.Any => js.Any): Self = StObject.set(x, "find_layer", js.Any.fromFunction1(value))
      
      inline def setFind_smallest_z(value: () => js.Any): Self = StObject.set(x, "find_smallest_z", js.Any.fromFunction0(value))
      
      inline def setHundred_percent(value: js.Any): Self = StObject.set(x, "hundred_percent", value.asInstanceOf[js.Any])
      
      inline def setInspect_validity(value: () => js.Any): Self = StObject.set(x, "inspect_validity", js.Any.fromFunction0(value))
      
      inline def setInstanceArray(value: js.Any): Self = StObject.set(x, "instanceArray", value.asInstanceOf[js.Any])
      
      inline def setIterate_layer(value: js.Any => js.Any): Self = StObject.set(x, "iterate_layer", js.Any.fromFunction1(value))
      
      inline def setIterate_orientations(value: () => js.Any): Self = StObject.set(x, "iterate_orientations", js.Any.fromFunction0(value))
      
      inline def setLayer_done(value: js.Any): Self = StObject.set(x, "layer_done", value.asInstanceOf[js.Any])
      
      inline def setLayer_in_layer(value: js.Any): Self = StObject.set(x, "layer_in_layer", value.asInstanceOf[js.Any])
      
      inline def setLayer_map(value: js.Any): Self = StObject.set(x, "layer_map", value.asInstanceOf[js.Any])
      
      inline def setLayer_thickness(value: js.Any): Self = StObject.set(x, "layer_thickness", value.asInstanceOf[js.Any])
      
      inline def setLeftInstances(value: js.Any): Self = StObject.set(x, "leftInstances", value.asInstanceOf[js.Any])
      
      inline def setLilz(value: js.Any): Self = StObject.set(x, "lilz", value.asInstanceOf[js.Any])
      
      inline def setPack(value: () => js.Any): Self = StObject.set(x, "pack", js.Any.fromFunction0(value))
      
      inline def setPack_layer(value: () => js.Any): Self = StObject.set(x, "pack_layer", js.Any.fromFunction0(value))
      
      inline def setPacked_layout_height(value: js.Any): Self = StObject.set(x, "packed_layout_height", value.asInstanceOf[js.Any])
      
      inline def setPacked_volume(value: js.Any): Self = StObject.set(x, "packed_volume", value.asInstanceOf[js.Any])
      
      inline def setPacking(value: js.Any): Self = StObject.set(x, "packing", value.asInstanceOf[js.Any])
      
      inline def setPacking_best(value: js.Any): Self = StObject.set(x, "packing_best", value.asInstanceOf[js.Any])
      
      inline def setPallet(value: js.Any): Self = StObject.set(x, "pallet", value.asInstanceOf[js.Any])
      
      inline def setPre_layer(value: js.Any): Self = StObject.set(x, "pre_layer", value.asInstanceOf[js.Any])
      
      inline def setRemain_layout_height(value: js.Any): Self = StObject.set(x, "remain_layout_height", value.asInstanceOf[js.Any])
      
      inline def setRemain_layout_length(value: js.Any): Self = StObject.set(x, "remain_layout_length", value.asInstanceOf[js.Any])
      
      inline def setReport_results(value: () => js.Any): Self = StObject.set(x, "report_results", js.Any.fromFunction0(value))
      
      inline def setScrap_list(value: js.Any): Self = StObject.set(x, "scrap_list", value.asInstanceOf[js.Any])
      
      inline def setScrap_min_z(value: js.Any): Self = StObject.set(x, "scrap_min_z", value.asInstanceOf[js.Any])
      
      inline def setTotal_box_volume(value: js.Any): Self = StObject.set(x, "total_box_volume", value.asInstanceOf[js.Any])
      
      inline def setVolume_check(value: () => js.Any): Self = StObject.set(x, "volume_check", js.Any.fromFunction0(value))
      
      inline def setWrapper(value: js.Any): Self = StObject.set(x, "wrapper", value.asInstanceOf[js.Any])
      
      inline def setWrite_box_file(value: () => js.Any): Self = StObject.set(x, "write_box_file", js.Any.fromFunction0(value))
    }
  }
