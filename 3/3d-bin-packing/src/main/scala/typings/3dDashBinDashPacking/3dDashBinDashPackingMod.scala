...
import typings.`3dDashBinDashPacking`.bws.packer.Instance
...
object `3dDashBinDashPackingMod` extends js.Object {
  ...
  class GAWrapperArray protected ()
    extends typings.`3dDashBinDashPacking`.bws.packer.GAWrapperArray {
    /**
      * @brief Copy Constructor.
      */
    def this(genes: typings.`3dDashBinDashPacking`.bws.packer.GAWrapperArray) = this()
    /**
      * Construct from instances.
      *
      * @param instanceArray Instances to be wrapped.
      */
    def this(instanceArray: typings.`3dDashBinDashPacking`.bws.packer.InstanceArray) = this()
  }
  ...
  /**
    ...
    */
  class InstanceArray ()
    extends typings.`3dDashBinDashPacking`.bws.packer.InstanceArray
  ...
  /**
    ...
    */
  class InstanceForm ()
    extends typings.`3dDashBinDashPacking`.bws.packer.InstanceForm {
  ...
  class InstanceFormArray ()
    extends typings.`3dDashBinDashPacking`.bws.packer.InstanceFormArray
  ...
  /**
    ...
    */
  class Packer ()
    extends typings.`3dDashBinDashPacking`.bws.packer.Packer {
    /**
      ...
      */
    def this(
      wrapperArray: typings.`3dDashBinDashPacking`.bws.packer.WrapperArray,
      instanceArray: typings.`3dDashBinDashPacking`.bws.packer.InstanceArray
    ) = this()
  }
  ...
  /**
    ...
    */
  class PackerForm ()
    extends typings.`3dDashBinDashPacking`.bws.packer.PackerForm {
    /**
      ...
      */
    def this(
      instanceFormArray: typings.`3dDashBinDashPacking`.bws.packer.InstanceFormArray,
      wrapperArray: typings.`3dDashBinDashPacking`.bws.packer.WrapperArray
    ) = this()
  }
  ...
  /**
    ...
    */
  class Product ()
    extends typings.`3dDashBinDashPacking`.bws.packer.Product {
    /**
      * Construct from members.
      *
  ...
  class Wrap protected ()
    extends typings.`3dDashBinDashPacking`.bws.packer.Wrap {
    /**
      * Construct from a Wrapper.
      *
      * @param wrapper A wrapper who will contain an instance.
      */
    def this(wrapper: typings.`3dDashBinDashPacking`.bws.packer.Wrapper) = this()
    /**
      ...
      */
    def this(
      wrapper: typings.`3dDashBinDashPacking`.bws.packer.Wrapper,
      instance: Instance,
      x: Double,
      y: Double,
      z: Double
  ...
  /**
    ...
    */
  class Wrapper ()
    extends typings.`3dDashBinDashPacking`.bws.packer.Wrapper {
    /**
      * Copy Constructor.
      */
    def this(wrapper: typings.`3dDashBinDashPacking`.bws.packer.Wrapper) = this()
  ...
  /**
    ...
    */
  class WrapperArray ()
    extends typings.`3dDashBinDashPacking`.bws.packer.WrapperArray
  ...
  /**
    ...
    */
  class WrapperGroup ()
    extends typings.`3dDashBinDashPacking`.bws.packer.WrapperGroup {
    /**
      * Construct from a sample.
      *
      * @param sample A sample, standard of the WrapperGroup.
      */
    def this(sample: typings.`3dDashBinDashPacking`.bws.packer.Wrapper) = this()
    /**
      * Copy Constructor.
      */
    def this(wrapperGroup: typings.`3dDashBinDashPacking`.bws.packer.WrapperGroup) = this()
    /**
