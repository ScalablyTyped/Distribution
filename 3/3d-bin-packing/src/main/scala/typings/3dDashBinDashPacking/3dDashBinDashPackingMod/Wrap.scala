...
class Wrap protected ()
  extends typings.`3dDashBinDashPacking`.bwsNs.packerNs.Wrap {
  /**
    * Construct from a Wrapper.
    *
    * @param wrapper A wrapper who will contain an instance.
    */
  def this(wrapper: typings.`3dDashBinDashPacking`.bwsNs.packerNs.Wrapper) = this()
  /**
    ...
    */
  def this(
    wrapper: typings.`3dDashBinDashPacking`.bwsNs.packerNs.Wrapper,
    instance: Instance,
    x: Double,
    y: Double,
    z: Double
