...
package object mod {
  ...
  /**
    ...
    */
  @scala.inline
  def setDefaultDeviceBackButtonListener(listener: js.Function1[/* eventObject */ js.Any, _]): scala.Unit = typings.onsenui.mod.^.asInstanceOf[js.Dynamic].applyDynamic("setDefaultDeviceBackButtonListener")(listener.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
}
