...
trait OnsTabbarElement
  ...
  def loadPage(page: js.Any, options: TabbarOptions): js.Promise[stdLib.HTMLElement] = js.native
  /**
  ...
  def setActiveTab(index: scala.Double, options: TabbarOptions): js.Promise[stdLib.HTMLElement] = js.native
  /**
