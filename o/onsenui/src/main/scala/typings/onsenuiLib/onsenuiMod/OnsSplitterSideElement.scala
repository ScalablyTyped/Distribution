...
trait OnsSplitterSideElement
  ...
  def close(options: SplitterSideOptions): js.Promise[stdLib.HTMLElement | scala.Boolean] = js.native
  /**
  ...
  def load(page: js.Any, options: SplitterSideOptions): js.Promise[stdLib.HTMLElement] = js.native
  /**
    * @description Open menu in collapse mode.
    * @return Resolves to the splitter side element or false if not in collapse mode
    */
  def open(): js.Promise[stdLib.HTMLElement | scala.Boolean] = js.native
  def open(options: SplitterSideOptions): js.Promise[stdLib.HTMLElement | scala.Boolean] = js.native
  /**
  ...
  def toggle(options: SplitterSideOptions): js.Promise[stdLib.HTMLElement | scala.Boolean] = js.native
}
