...
trait OnsCarouselElement
  ...
  def next(options: CarouselOptions): js.Promise[stdLib.HTMLElement] = js.native
  /**
    * @description Show previous ons-carousel item
    * @return Resolves to the carousel element
    */
  def prev(): js.Promise[stdLib.HTMLElement] = js.native
  def prev(options: CarouselOptions): js.Promise[stdLib.HTMLElement] = js.native
  /**
  ...
  def setActiveIndex(index: scala.Double, options: CarouselOptions): js.Promise[stdLib.HTMLElement] = js.native
}
