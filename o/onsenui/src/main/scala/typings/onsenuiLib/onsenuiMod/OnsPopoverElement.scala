...
trait OnsPopoverElement
  ...
  def hide(options: PopoverOptions): js.Promise[stdLib.HTMLElement] = js.native
  /**
  ...
  def show(target: js.Any, options: PopoverOptions): js.Promise[stdLib.HTMLElement] = js.native
}
