...
trait OnsNavigatorElement
  ...
  def insertPage(index: scala.Double, page: js.Any, options: NavigatorOptions): js.Promise[stdLib.HTMLElement] = js.native
  /**
    * @param {Object} [options] Parameter object
  ...
  def popPage(options: NavigatorOptions): js.Promise[stdLib.HTMLElement] = js.native
  /**
    * @param {*} page Page URL. Can be either a HTML document or a <code>&lt;ons-template&gt;</code>
    * @param {Object} [options] Parameter object
    * @param {String} [options.animation] Animation name. Available animations are "slide", "simpleslide", "lift", "fade" and "none"
  ...
  def pushPage(page: js.Any, options: PushPageOptions): js.Promise[stdLib.HTMLElement] = js.native
  ...
  def replacePage(page: js.Any, options: PushPageOptions): js.Promise[stdLib.HTMLElement] = js.native
  /**
  ...
  def resetToPage(page: js.Any, options: NavigatorOptions): js.Promise[stdLib.HTMLElement] = js.native
}
