...
object ClientMetadata {
  ...
  def apply(
    ...
    if (id_token_encrypted_response_alg != null) __obj.updateDynamic("id_token_encrypted_response_alg")(id_token_encrypted_response_alg)
    if (id_token_encrypted_response_enc != null) __obj.updateDynamic("id_token_encrypted_response_enc")(id_token_encrypted_response_enc)
    if (id_token_signed_response_alg != null) __obj.updateDynamic("id_token_signed_response_alg")(id_token_signed_response_alg)
    if (introspection_endpoint_auth_method != null) __obj.updateDynamic("introspection_endpoint_auth_method")(introspection_endpoint_auth_method)
    if (introspection_endpoint_auth_signing_alg != null) __obj.updateDynamic("introspection_endpoint_auth_signing_alg")(introspection_endpoint_auth_signing_alg)
    ...
    if (request_object_encryption_alg != null) __obj.updateDynamic("request_object_encryption_alg")(request_object_encryption_alg)
    if (request_object_encryption_enc != null) __obj.updateDynamic("request_object_encryption_enc")(request_object_encryption_enc)
    if (request_object_signing_alg != null) __obj.updateDynamic("request_object_signing_alg")(request_object_signing_alg)
    if (!js.isUndefined(require_auth_time)) __obj.updateDynamic("require_auth_time")(require_auth_time)
    if (response_types != null) __obj.updateDynamic("response_types")(response_types)
    if (revocation_endpoint_auth_method != null) __obj.updateDynamic("revocation_endpoint_auth_method")(revocation_endpoint_auth_method)
    if (revocation_endpoint_auth_signing_alg != null) __obj.updateDynamic("revocation_endpoint_auth_signing_alg")(revocation_endpoint_auth_signing_alg)
    if (!js.isUndefined(tls_client_certificate_bound_access_tokens)) __obj.updateDynamic("tls_client_certificate_bound_access_tokens")(tls_client_certificate_bound_access_tokens)
    if (token_endpoint_auth_method != null) __obj.updateDynamic("token_endpoint_auth_method")(token_endpoint_auth_method)
    if (token_endpoint_auth_signing_alg != null) __obj.updateDynamic("token_endpoint_auth_signing_alg")(token_endpoint_auth_signing_alg)
    if (userinfo_encrypted_response_alg != null) __obj.updateDynamic("userinfo_encrypted_response_alg")(userinfo_encrypted_response_alg)
    if (userinfo_encrypted_response_enc != null) __obj.updateDynamic("userinfo_encrypted_response_enc")(userinfo_encrypted_response_enc)
    if (userinfo_signed_response_alg != null) __obj.updateDynamic("userinfo_signed_response_alg")(userinfo_signed_response_alg)
