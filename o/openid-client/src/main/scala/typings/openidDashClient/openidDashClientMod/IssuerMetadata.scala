...
object IssuerMetadata {
  ...
  def apply(
    ...
    if (request_object_signing_alg_values_supported != null) __obj.updateDynamic("request_object_signing_alg_values_supported")(request_object_signing_alg_values_supported)
