...
class Client protected ()
  ...
  def userinfo(accessToken: String, options: AnonBody): js.Promise[UserinfoResponse] = js.native
  /**
  ...
  def userinfo(accessToken: TokenSet, options: AnonBody): js.Promise[UserinfoResponse] = js.native
}
