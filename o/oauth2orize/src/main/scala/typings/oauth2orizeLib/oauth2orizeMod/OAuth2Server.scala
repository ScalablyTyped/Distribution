...
class OAuth2Server () extends js.Object {
  ...
  def deserializeClient(obj: js.Any, done: DeserializeClientDoneFunction): scala.Unit = js.native
  ...
  def exchange(`type`: java.lang.String, fn: MiddlewareFunction): OAuth2Server = js.native
  def grant(fn: MiddlewareFunction): OAuth2Server = js.native
  def grant(`type`: java.lang.String, fn: MiddlewareFunction): OAuth2Server = js.native
  def serializeClient(client: js.Any, done: SerializeClientDoneFunction): scala.Unit = js.native
  def serializeClient(fn: SerializeClientFunction): scala.Unit = js.native
