...
object ^ extends js.Object {
  ...
  def interpolateBetween2DPointsForY(point1: openjscadLib.CSGNs.Vector2D, point2: openjscadLib.CSGNs.Vector2D, y: scala.Double): scala.Double = js.native
  ...
  def parseOptionAs3DVector(options: js.Any, optionname: js.Any, defaultvalue: js.Any): openjscadLib.CSGNs.Vector3D = js.native
  ...
  def reTesselateCoplanarPolygons(
    sourcepolygons: js.Array[openjscadLib.CSGNs.Polygon],
    destpolygons: js.Array[openjscadLib.CSGNs.Polygon]
