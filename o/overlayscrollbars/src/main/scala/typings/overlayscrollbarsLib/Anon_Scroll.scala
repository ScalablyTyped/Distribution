...
trait Anon_Scroll extends js.Object {
  var block: js.UndefOr[
    overlayscrollbarsLib.overlayscrollbarsMod.OverlayScrollbarsNs.BlockBehavior | Anon_YXBlockBehavior | (js.Tuple2[
  ...
  var scroll: js.UndefOr[
    overlayscrollbarsLib.overlayscrollbarsMod.OverlayScrollbarsNs.ScrollBehavior | Anon_YXScrollBehavior | (js.Tuple2[
