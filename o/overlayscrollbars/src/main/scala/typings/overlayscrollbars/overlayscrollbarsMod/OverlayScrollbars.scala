...
import typings.overlayscrollbars.Anon_XYEasing
...
trait OverlayScrollbars extends js.Object {
  ...
  def scroll(coordinates: Coordinates, duration: Double, easing: Anon_XYEasing): Unit = js.native
  def scroll(
    coordinates: Coordinates,
    duration: Double,
    easing: Anon_XYEasing,
    complete: js.Function1[/* repeated */ js.Any, _]
  ): Unit = js.native
