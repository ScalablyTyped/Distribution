...
trait AnonEliminationsperlifeGameswon extends js.Object {
...
object AnonEliminationsperlifeGameswon {
  @scala.inline
  def apply(
  ...
  ): AnonEliminationsperlifeGameswon = {
    ...
    __obj.asInstanceOf[AnonEliminationsperlifeGameswon]
  }
}
