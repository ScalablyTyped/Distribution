...
object Anon_Eliminationsperlife {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(eliminations_per_life = eliminations_per_life, games_won = games_won, multikill_best = multikill_best, objective_kills_average = objective_kills_average, played = played, weapon_accuracy = weapon_accuracy)
