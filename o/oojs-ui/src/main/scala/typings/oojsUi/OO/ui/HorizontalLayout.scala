...
import typings.oojsUi.OO.ui.HorizontalLayout.Props
import typings.oojsUi.OO.ui.HorizontalLayout.Prototype
import typings.oojsUi.anon.PartialRecordkeyofEventMaRemove
...
object HorizontalLayout {
  ...
  trait ConfigOptions
    ...
    var items: js.UndefOr[js.Array[Widget | Layout]] = js.undefined
  }
  object ConfigOptions {
    ...
    implicit open class MutableBuilder[Self <: ConfigOptions] (val x: Self) extends AnyVal {
      ...
      inline def setItems(value: js.Array[Widget | Layout]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      inline def setItemsVarargs(value: (Widget | Layout)*): Self = StObject.set(x, "items", js.Array(value*))
    }
  }
  ...
  Instantiable0[HorizontalLayout]
       with Instantiable1[/* config */ ConfigOptions, HorizontalLayout] {
  ...
  type EventMap = typings.oojsUi.OO.ui.mixin.GroupElement.EventMap
  ...
  trait Prototype
    ...
    def connect[T /* <: PartialRecordkeyofEventMaRemove */, C](context: C, methods: EventConnectionMap[T, C, EventMap]): this.type = js.native
    
    def disconnect[T /* <: PartialRecordkeyofEventMaRemove */, C](context: C, methods: EventConnectionMap[T, C, EventMap]): this.type = js.native
    
    def emit[K /* <: String */](
      event: /* import warning: importer.ImportType#apply Failed type conversion: K extends keyof oojs-ui.OO.ui.HorizontalLayout.EventMap ? never : K */ js.Any,
      args: Any*
    ): Boolean = js.native
