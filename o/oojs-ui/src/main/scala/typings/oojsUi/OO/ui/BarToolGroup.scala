...
object BarToolGroup {
  ...
  type ConfigOptions = typings.oojsUi.OO.ui.ToolGroup.ConfigOptions
  
  @js.native
  trait Constructor
    extends StObject
       with /** @param config Configuration options */
  Instantiable0[BarToolGroup]
       with Instantiable1[/* config */ ConfigOptions, BarToolGroup] {
  ...
  type Props = typings.oojsUi.OO.ui.ToolGroup.Props
  
  type Prototype = typings.oojsUi.OO.ui.ToolGroup.Prototype
  
  type Static = typings.oojsUi.OO.ui.ToolGroup.Static
}
