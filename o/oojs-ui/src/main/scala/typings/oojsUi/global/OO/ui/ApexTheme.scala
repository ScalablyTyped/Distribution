...
import typings.oojsUi.OO.ui.ApexThemeConstructor
...
object ApexTheme extends Shortcut {
  
  @JSGlobal("OO.ui.ApexTheme")
  @js.native
  val ^ : ApexThemeConstructor = js.native
  
  /** @deprecated Use `super` instead */
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSGlobal("OO.ui.ApexTheme.parent")
  @js.native
  open class parent ()
    extends StObject
       with Theme {
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSGlobal("OO.ui.ApexTheme.super")
  @js.native
  open class `super` ()
    extends StObject
       with Theme {
  ...
  type _To = ApexThemeConstructor
  
  /* This means you don't have to write `^`, but can instead just say `ApexTheme.foo` */
  override def _to: ApexThemeConstructor = ^
}
