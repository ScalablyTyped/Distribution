...
import typings.oojsUi.OO.ui.WikimediaUIThemeConstructor
import typings.oojsUi.anon.Off
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object WikimediaUITheme extends Shortcut {
  
  @JSGlobal("OO.ui.WikimediaUITheme")
  @js.native
  val ^ : WikimediaUIThemeConstructor = js.native
  
  /** @deprecated Use `super` instead */
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSGlobal("OO.ui.WikimediaUITheme.parent")
  @js.native
  open class parent ()
    extends StObject
       with Theme {
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSGlobal("OO.ui.WikimediaUITheme.super")
  @js.native
  open class `super` ()
    extends StObject
       with Theme {
  ...
  type _To = WikimediaUIThemeConstructor
  
  /* This means you don't have to write `^`, but can instead just say `WikimediaUITheme.foo` */
  override def _to: WikimediaUIThemeConstructor = ^
}
