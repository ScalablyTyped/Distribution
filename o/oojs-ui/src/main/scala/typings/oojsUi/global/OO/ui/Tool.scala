...
import typings.oojsUi.OO.ui.Tool.ConfigOptions
import typings.oojsUi.OO.ui.Tool.Constructor
import typings.std.HTMLElement
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object Tool extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `Tool.foo` */
