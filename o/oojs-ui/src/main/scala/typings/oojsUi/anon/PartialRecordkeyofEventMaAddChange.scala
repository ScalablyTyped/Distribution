...
/* Inlined std.Partial<std.Record<keyof oojs-ui.OO.ui.StackLayout.EventMap, any>> */
trait PartialRecordkeyofEventMaAddChange extends StObject {
...
object PartialRecordkeyofEventMaAddChange {
  
  inline def apply(): PartialRecordkeyofEventMaAddChange = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRecordkeyofEventMaAddChange]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialRecordkeyofEventMaAddChange] (val x: Self) extends AnyVal {
