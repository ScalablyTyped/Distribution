...
/* Inlined std.Partial<std.Record<keyof oojs-ui.OO.ui.ToolGroup.EventMap, any>> */
trait PartialRecordkeyofEventMaActiveAdd extends StObject {
  ...
  var move: js.UndefOr[Any] = js.undefined
...
object PartialRecordkeyofEventMaActiveAdd {
  
  inline def apply(): PartialRecordkeyofEventMaActiveAdd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRecordkeyofEventMaActiveAdd]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialRecordkeyofEventMaActiveAdd] (val x: Self) extends AnyVal {
