...
/* Inlined std.Partial<std.Record<keyof oojs-ui.OO.ui.OptionWidget.EventMap, any>> */
trait PartialRecordkeyofEventMaFlag extends StObject {
...
object PartialRecordkeyofEventMaFlag {
  
  inline def apply(): PartialRecordkeyofEventMaFlag = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRecordkeyofEventMaFlag]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialRecordkeyofEventMaFlag] (val x: Self) extends AnyVal {
