...
/* Inlined std.Partial<std.Record<keyof oojs-ui.OO.ui.OutlineControlsWidget.EventMap, any>> */
trait PartialRecordkeyofEventMaAdd extends StObject {
...
object PartialRecordkeyofEventMaAdd {
  
  inline def apply(): PartialRecordkeyofEventMaAdd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRecordkeyofEventMaAdd]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialRecordkeyofEventMaAdd] (val x: Self) extends AnyVal {
