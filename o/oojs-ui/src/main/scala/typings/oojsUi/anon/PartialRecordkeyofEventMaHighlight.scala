...
/* Inlined std.Partial<std.Record<keyof oojs-ui.OO.ui.SelectWidget.EventMap, any>> */
trait PartialRecordkeyofEventMaHighlight extends StObject {
  
  var add: js.UndefOr[Any] = js.undefined
  
  var change: js.UndefOr[Any] = js.undefined
  
  var choose: js.UndefOr[Any] = js.undefined
  ...
  var press: js.UndefOr[Any] = js.undefined
...
object PartialRecordkeyofEventMaHighlight {
  
  inline def apply(): PartialRecordkeyofEventMaHighlight = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRecordkeyofEventMaHighlight]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialRecordkeyofEventMaHighlight] (val x: Self) extends AnyVal {
    ...
    inline def setChoose(value: Any): Self = StObject.set(x, "choose", value.asInstanceOf[js.Any])
    ...
    inline def setPress(value: Any): Self = StObject.set(x, "press", value.asInstanceOf[js.Any])
