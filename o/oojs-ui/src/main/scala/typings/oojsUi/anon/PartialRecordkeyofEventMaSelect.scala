...
/* Inlined std.Partial<std.Record<keyof oojs-ui.OO.ui.MultiselectWidget.EventMap, any>> */
trait PartialRecordkeyofEventMaSelect extends StObject {
...
object PartialRecordkeyofEventMaSelect {
  
  inline def apply(): PartialRecordkeyofEventMaSelect = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRecordkeyofEventMaSelect]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialRecordkeyofEventMaSelect] (val x: Self) extends AnyVal {
