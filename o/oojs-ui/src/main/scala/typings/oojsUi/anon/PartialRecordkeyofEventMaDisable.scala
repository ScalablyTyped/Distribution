...
/* Inlined std.Partial<std.Record<keyof oojs-ui.OO.ui.ToggleWidget.EventMap, any>> */
trait PartialRecordkeyofEventMaDisable extends StObject {
...
object PartialRecordkeyofEventMaDisable {
  
  inline def apply(): PartialRecordkeyofEventMaDisable = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRecordkeyofEventMaDisable]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialRecordkeyofEventMaDisable] (val x: Self) extends AnyVal {
