...
trait DocumentPropertiesLoadOptions extends js.Object {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  var applicationName: js.UndefOr[scala.Boolean] = js.undefined
  /**
    *
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  var lastPrintDate: js.UndefOr[scala.Boolean] = js.undefined
  /**
    *
    ...
    * [Api set: WordApi 1.3]
    */
  var lastSaveTime: js.UndefOr[scala.Boolean] = js.undefined
  /**
    *
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  var security: js.UndefOr[scala.Boolean] = js.undefined
  /**
    *
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  var template: js.UndefOr[scala.Boolean] = js.undefined
  /**
    *
