...
class TableRowCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.WordNs.InterfacesNs.TableRowCollectionLoadOptions with officeDashJsDashPreviewLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  def toJSON(): officeDashJsDashPreviewLib.WordNs.InterfacesNs.TableRowCollectionData = js.native
  /**
