...
class CustomXmlPartScopedCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.WordNs.InterfacesNs.CustomXmlPartScopedCollectionLoadOptions with officeDashJsDashPreviewLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): CustomXmlPartScopedCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.WordNs.InterfacesNs.CustomXmlPartScopedCollectionData = js.native
  /**
