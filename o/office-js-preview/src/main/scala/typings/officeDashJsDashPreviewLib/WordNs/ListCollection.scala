...
class ListCollection ()
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsDashPreviewLib.WordNs.InterfacesNs.ListCollectionLoadOptions with officeDashJsDashPreviewLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): ListCollection = js.native
  def toJSON(): officeDashJsDashPreviewLib.WordNs.InterfacesNs.ListCollectionData = js.native
  /**
