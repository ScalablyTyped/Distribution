...
trait BodyData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    officeDashJsDashPreviewLib.WordNs.BodyType | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Unknown | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.MainDoc | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Section | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Header | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Footer | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.TableCell
  ] = js.undefined
}
