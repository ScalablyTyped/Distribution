...
trait ListData extends js.Object {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  var levelTypes: js.UndefOr[js.Array[officeDashJsDashPreviewLib.WordNs.ListLevelType]] = js.undefined
  /**
    *
...
object ListData {
  ...
  def apply(
    ...
    levelTypes: js.Array[officeDashJsDashPreviewLib.WordNs.ListLevelType] = null,
