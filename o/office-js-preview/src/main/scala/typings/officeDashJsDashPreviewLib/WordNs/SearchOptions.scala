...
class SearchOptions ()
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.WordNs.InterfacesNs.SearchOptionsUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.WordNs.InterfacesNs.SearchOptionsUpdateData,
...
object SearchOptions extends js.Object {
  /**
    ...
    */
  def newObject(context: officeDashJsDashPreviewLib.OfficeExtensionNs.ClientRequestContext): officeDashJsDashPreviewLib.WordNs.SearchOptions = js.native
}
