...
class RangeCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.WordNs.InterfacesNs.RangeCollectionLoadOptions with officeDashJsDashPreviewLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.WordNs.InterfacesNs.RangeCollectionData = js.native
  /**
