...
class ContentControlCollection ()
  ...
  /**
    ...
    */
  def getById(id: scala.Double): ContentControl = js.native
  /**
    *
    ...
    * @param id Required. A content control identifier.
    */
  def getByIdOrNullObject(id: scala.Double): ContentControl = js.native
  /**
    *
    ...
    */
  def getByTag(tag: java.lang.String): ContentControlCollection = js.native
  /**
    *
    ...
    */
  def getByTitle(title: java.lang.String): ContentControlCollection = js.native
  /**
    *
  ...
  /**
    ...
    */
  def getItem(index: scala.Double): ContentControl = js.native
  /**
  ...
  def load(
    option: officeDashJsDashPreviewLib.WordNs.InterfacesNs.ContentControlCollectionLoadOptions with officeDashJsDashPreviewLib.WordNs.InterfacesNs.CollectionLoadOptions
  ): ContentControlCollection = js.native
  def load(option: java.lang.String): ContentControlCollection = js.native
  def load(option: js.Array[java.lang.String]): ContentControlCollection = js.native
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): ContentControlCollection = js.native
  def toJSON(): officeDashJsDashPreviewLib.WordNs.InterfacesNs.ContentControlCollectionData = js.native
  /**
