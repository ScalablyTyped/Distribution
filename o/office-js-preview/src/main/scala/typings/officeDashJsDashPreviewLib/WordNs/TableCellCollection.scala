...
class TableCellCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.WordNs.InterfacesNs.TableCellCollectionLoadOptions with officeDashJsDashPreviewLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.WordNs.InterfacesNs.TableCellCollectionData = js.native
  /**
