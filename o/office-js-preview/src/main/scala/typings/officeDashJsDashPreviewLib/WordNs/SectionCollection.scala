...
class SectionCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.WordNs.InterfacesNs.SectionCollectionLoadOptions with officeDashJsDashPreviewLib.WordNs.InterfacesNs.CollectionLoadOptions
