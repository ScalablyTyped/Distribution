...
class TableCollection ()
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsDashPreviewLib.WordNs.InterfacesNs.TableCollectionLoadOptions with officeDashJsDashPreviewLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  def toJSON(): officeDashJsDashPreviewLib.WordNs.InterfacesNs.TableCollectionData = js.native
  /**
