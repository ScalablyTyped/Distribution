...
class InkAnalysis ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): InkAnalysis = js.native
  def load(option: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisLoadOptions): InkAnalysis = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisUpdateData,
    options: officeDashJsDashPreviewLib.OfficeExtensionNs.UpdateOptions
  ): scala.Unit = js.native
  def toJSON(): officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisData = js.native
  /**
