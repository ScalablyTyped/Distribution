...
class Application ()
  ...
  def getWindowSize(): officeDashJsDashPreviewLib.OfficeExtensionNs.ClientResult[js.Array[scala.Double]] = js.native
  def insertHtmlAtCurrentPosition(html: java.lang.String): scala.Unit = js.native
  def isViewingDeletedNotes(): officeDashJsDashPreviewLib.OfficeExtensionNs.ClientResult[scala.Boolean] = js.native
  /**
  ...
  def toJSON(): officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.ApplicationData = js.native
}
