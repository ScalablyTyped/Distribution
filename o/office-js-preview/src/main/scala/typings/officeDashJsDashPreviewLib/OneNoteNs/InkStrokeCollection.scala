...
class InkStrokeCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkStrokeCollectionLoadOptions with officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): InkStrokeCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkStrokeCollectionData = js.native
  /**
