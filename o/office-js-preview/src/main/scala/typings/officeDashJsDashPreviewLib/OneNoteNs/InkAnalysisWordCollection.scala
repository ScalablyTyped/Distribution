...
class InkAnalysisWordCollection ()
  ...
  /**
           ...
           */
  def getItem(index: java.lang.String): InkAnalysisWord = js.native
  /**
           *
           * Gets a InkAnalysisWord object by ID or by its index in the collection. Read-only.
           *
           ...
           * @param index The ID of the InkAnalysisWord object, or the index location of the InkAnalysisWord object in the collection.
           */
  def getItem(index: scala.Double): InkAnalysisWord = js.native
  /**
           *
           ...
           */
  def getItemAt(index: scala.Double): InkAnalysisWord = js.native
  /**
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisWordCollectionLoadOptions with officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ): InkAnalysisWordCollection = js.native
