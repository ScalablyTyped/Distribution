...
class InkAnalysisParagraphCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisParagraphCollectionLoadOptions with officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): InkAnalysisParagraphCollection = js.native
  def toJSON(): officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisParagraphCollectionData = js.native
  /**
