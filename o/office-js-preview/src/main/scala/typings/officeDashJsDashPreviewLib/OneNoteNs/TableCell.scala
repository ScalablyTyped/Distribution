...
class TableCell ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): TableCell = js.native
  def load(option: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.TableCellLoadOptions): TableCell = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.TableCellUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.TableCellUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.TableCellData = js.native
  /**
