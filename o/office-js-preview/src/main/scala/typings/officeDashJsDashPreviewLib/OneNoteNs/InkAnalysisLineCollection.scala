...
class InkAnalysisLineCollection ()
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisLineCollectionLoadOptions with officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): InkAnalysisLineCollection = js.native
  def toJSON(): officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisLineCollectionData = js.native
  /**
