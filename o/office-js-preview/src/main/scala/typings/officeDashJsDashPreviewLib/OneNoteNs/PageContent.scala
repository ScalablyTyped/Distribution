...
class PageContent ()
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: PageContentType | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Outline | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Image | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Ink | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Other = js.native
  /**
    *
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): PageContent = js.native
  def load(option: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.PageContentLoadOptions): PageContent = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.PageContentUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.PageContentUpdateData,
    options: officeDashJsDashPreviewLib.OfficeExtensionNs.UpdateOptions
  ): scala.Unit = js.native
  /** Sets multiple properties on the object at the same time, based on an existing loaded object. */
  def set(properties: PageContent): scala.Unit = js.native
  def toJSON(): officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.PageContentData = js.native
  /**
