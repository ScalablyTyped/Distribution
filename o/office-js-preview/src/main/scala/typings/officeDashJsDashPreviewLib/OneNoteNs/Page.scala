...
class Page ()
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  def analyzePage(): officeDashJsDashPreviewLib.OfficeExtensionNs.ClientResult[java.lang.String] = js.native
  /**
    *
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  def hasTitleContent(): officeDashJsDashPreviewLib.OfficeExtensionNs.ClientResult[scala.Boolean] = js.native
  /**
    *
  ...
  def insertPageAsSibling_After(
    location: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.After,
  ...
  /**
    ...
    */
  @JSName("insertPageAsSibling")
  def insertPageAsSibling_Before(
    location: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Before,
    title: java.lang.String
  ): Page = js.native
  /**
  ...
  def load(option: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.PageLoadOptions): Page = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.PageUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.PageUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.PageData = js.native
  /**
