...
class NotebookCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.NotebookCollectionLoadOptions with officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): NotebookCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.NotebookCollectionData = js.native
  /**
