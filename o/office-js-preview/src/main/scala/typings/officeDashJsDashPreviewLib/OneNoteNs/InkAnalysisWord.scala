...
class InkAnalysisWord ()
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisWordUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisWordUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.InkAnalysisWordData = js.native
  /**
