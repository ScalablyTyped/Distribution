...
class SectionCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.SectionCollectionLoadOptions with officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.OneNoteNs.InterfacesNs.SectionCollectionData = js.native
  /**
