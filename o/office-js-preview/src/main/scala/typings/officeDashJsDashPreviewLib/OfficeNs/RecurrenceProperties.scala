...
trait RecurrenceProperties extends js.Object {
  ...
  /**
    ...
    */
  var days: js.Array[officeDashJsDashPreviewLib.OfficeNs.MailboxEnumsNs.Days | java.lang.String]
  /**
...
object RecurrenceProperties {
  ...
  def apply(
    ...
    days: js.Array[officeDashJsDashPreviewLib.OfficeNs.MailboxEnumsNs.Days | java.lang.String],
