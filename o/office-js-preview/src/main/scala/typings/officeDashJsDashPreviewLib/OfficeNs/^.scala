...
object ^ extends js.Object {
  /**
    ...
    */
  var Preview: officeDashJsDashPreviewLib.Anon_StartCustomFunctions = js.native
  /** A Promise object. Promises can be chained via ".then", and errors can be caught via ".catch". 
    ...
    */
  var Promise: officeDashJsDashPreviewLib.OfficeNs.IPromiseConstructor = js.native
  /**
    ...
    *  </table>
    */
  var context: officeDashJsDashPreviewLib.OfficeNs.Context = js.native
  /**
    ...
    */
  def initialize(reason: officeDashJsDashPreviewLib.OfficeNs.InitializationReason): scala.Unit = js.native
  /**
  ...
  /**
    ...
    *  </table>
    */
  def select(expression: java.lang.String): officeDashJsDashPreviewLib.OfficeNs.Binding = js.native
  def select(
    expression: java.lang.String,
    callback: js.Function1[/* result */ officeDashJsDashPreviewLib.OfficeNs.AsyncResult[_], scala.Unit]
  ): officeDashJsDashPreviewLib.OfficeNs.Binding = js.native
  /**
