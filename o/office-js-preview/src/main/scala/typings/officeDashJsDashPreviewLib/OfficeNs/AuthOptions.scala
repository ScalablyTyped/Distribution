...
trait AuthOptions extends js.Object {
  ...
  /**
    ...
    */
  var authChallenge: js.UndefOr[java.lang.String] = js.undefined
  /**
    * Prompts the user to add their Office account (or to switch to it, if it is already added).
    */
  var forceAddAccount: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * Causes Office to display the add-in consent experience. Useful if the add-in's Azure permissions have changed or if the user's consent has
    * been revoked.
    */
  var forceConsent: js.UndefOr[scala.Boolean] = js.undefined
}
...
object AuthOptions {
  ...
  def apply(
    ...
    authChallenge: java.lang.String = null,
    forceAddAccount: js.UndefOr[scala.Boolean] = js.undefined,
    forceConsent: js.UndefOr[scala.Boolean] = js.undefined
  ): AuthOptions = {
