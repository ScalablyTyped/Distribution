...
trait LocationIdentifier extends js.Object {
  ...
  /**
    * The location's type.
    */
  var `type`: officeDashJsDashPreviewLib.OfficeNs.MailboxEnumsNs.LocationType | java.lang.String
}
...
object LocationIdentifier {
  ...
  def apply(
    id: java.lang.String,
    `type`: officeDashJsDashPreviewLib.OfficeNs.MailboxEnumsNs.LocationType | java.lang.String
  ): LocationIdentifier = {
