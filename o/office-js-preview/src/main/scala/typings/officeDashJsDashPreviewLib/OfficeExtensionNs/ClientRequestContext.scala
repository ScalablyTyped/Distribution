...
class ClientRequestContext () extends js.Object {
  ...
  /**
           ...
           */
  def load(`object`: ClientObject): scala.Unit = js.native
  /**
           * Queues up a command to load the specified properties of the object. You must call `context.sync()` before reading the properties. 
           * 
           * @param object The object whose properties are loaded.
           ...
           * {@link OfficeExtension.LoadOption} object.
           */
  def load(`object`: ClientObject, option: java.lang.String): scala.Unit = js.native
  /**
           * Queues up a command to load the specified properties of the object. You must call `context.sync()` before reading the properties. 
           * 
           * @param object The object whose properties are loaded.
           ...
           * {@link OfficeExtension.LoadOption} object.
           */
  def load(`object`: ClientObject, option: js.Array[java.lang.String]): scala.Unit = js.native
  /**
           * Queues up a command to load the specified properties of the object. You must call `context.sync()` before reading the properties. 
           * 
           * @param object The object whose properties are loaded.
           ...
           * {@link OfficeExtension.LoadOption} object.
           */
  def load(`object`: ClientObject, option: LoadOption): scala.Unit = js.native
  /**
