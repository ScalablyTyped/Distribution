...
class CustomPropertyCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CustomPropertyCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CustomPropertyCollectionData = js.native
}
