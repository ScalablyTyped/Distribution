...
class TableStyle ()
  ...
  def load(option: java.lang.String): TableStyle = js.native
  def load(option: js.Array[java.lang.String]): TableStyle = js.native
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): TableStyle = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableStyleLoadOptions): TableStyle = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableStyleUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableStyleUpdateData,
    options: officeDashJsDashPreviewLib.OfficeExtensionNs.UpdateOptions
  ): scala.Unit = js.native
  /** Sets multiple properties on the object at the same time, based on an existing loaded object. */
  def set(properties: TableStyle): scala.Unit = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableStyleData = js.native
}
