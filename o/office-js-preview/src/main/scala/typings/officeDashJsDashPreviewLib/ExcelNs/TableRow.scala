...
class TableRow ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): TableRow = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableRowLoadOptions): TableRow = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableRowUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableRowUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableRowData = js.native
}
