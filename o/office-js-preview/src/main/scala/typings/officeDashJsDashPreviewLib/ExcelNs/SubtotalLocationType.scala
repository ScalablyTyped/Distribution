...
object SubtotalLocationType extends js.Object {
  ...
  sealed trait atBottom
    extends officeDashJsDashPreviewLib.ExcelNs.SubtotalLocationType
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsDashPreviewLib.ExcelNs.SubtotalLocationType with java.lang.String] = js.native
}
