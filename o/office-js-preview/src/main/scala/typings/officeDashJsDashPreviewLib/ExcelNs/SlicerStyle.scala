...
class SlicerStyle ()
  ...
  def load(option: java.lang.String): SlicerStyle = js.native
  def load(option: js.Array[java.lang.String]): SlicerStyle = js.native
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): SlicerStyle = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.SlicerStyleLoadOptions): SlicerStyle = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.SlicerStyleUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.SlicerStyleUpdateData,
    options: officeDashJsDashPreviewLib.OfficeExtensionNs.UpdateOptions
  ): scala.Unit = js.native
  /** Sets multiple properties on the object at the same time, based on an existing loaded object. */
  def set(properties: SlicerStyle): scala.Unit = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.SlicerStyleData = js.native
}
