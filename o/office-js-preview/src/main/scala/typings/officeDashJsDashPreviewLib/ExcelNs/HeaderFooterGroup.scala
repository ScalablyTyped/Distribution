...
class HeaderFooterGroup ()
  ...
  /**
           ...
           * @beta
           */
  var state: HeaderFooterState | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Default | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.FirstAndDefault | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.OddAndEven | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.FirstOddAndEven = js.native
  /**
           *
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): HeaderFooterGroup = js.native
  /**
           * Queues up a command to load the specified properties of the object. You must call "context.sync()" before reading the properties.
           *
           * @remarks
           ...
           * @param options Provides options for which properties of the object to load.
           */
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.HeaderFooterGroupLoadOptions): HeaderFooterGroup = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
           ...
           */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.HeaderFooterGroupUpdateData): scala.Unit = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
           *
           * @remarks
           *
           ...
           */
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.HeaderFooterGroupUpdateData,
  ...
  /**
          ...
          */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.HeaderFooterGroupData = js.native
}
