...
class RangeView ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): RangeView = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RangeViewLoadOptions): RangeView = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RangeViewUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RangeViewUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RangeViewData = js.native
}
