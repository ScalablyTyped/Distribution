...
object DocumentPropertyItem extends js.Object {
  ...
  sealed trait appName
    extends officeDashJsDashPreviewLib.ExcelNs.DocumentPropertyItem
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsDashPreviewLib.ExcelNs.DocumentPropertyItem with java.lang.String] = js.native
}
