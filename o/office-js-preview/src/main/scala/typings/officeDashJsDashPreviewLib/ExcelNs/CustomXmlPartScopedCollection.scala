...
class CustomXmlPartScopedCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CustomXmlPartScopedCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CustomXmlPartScopedCollectionData = js.native
}
