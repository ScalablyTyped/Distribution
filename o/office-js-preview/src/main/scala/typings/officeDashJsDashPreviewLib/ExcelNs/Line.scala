...
class Line ()
  ...
  /**
    ...
    * @beta
    */
  var connectorType: ConnectorType | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Straight | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Elbow | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Curve = js.native
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): Line = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.LineLoadOptions): Line = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.LineUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.LineUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.LineData = js.native
}
