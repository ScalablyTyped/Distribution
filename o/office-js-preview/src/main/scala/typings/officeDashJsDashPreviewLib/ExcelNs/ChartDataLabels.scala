...
class ChartDataLabels ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): ChartDataLabels = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartDataLabelsLoadOptions): ChartDataLabels = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartDataLabelsUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartDataLabelsUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartDataLabelsData = js.native
}
