...
class DocumentProperties ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): DocumentProperties = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DocumentPropertiesLoadOptions): DocumentProperties = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DocumentPropertiesUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DocumentPropertiesUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DocumentPropertiesData = js.native
}
