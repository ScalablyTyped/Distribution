...
class CustomConditionalFormat ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): CustomConditionalFormat = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CustomConditionalFormatLoadOptions): CustomConditionalFormat = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CustomConditionalFormatUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CustomConditionalFormatUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CustomConditionalFormatData = js.native
}
