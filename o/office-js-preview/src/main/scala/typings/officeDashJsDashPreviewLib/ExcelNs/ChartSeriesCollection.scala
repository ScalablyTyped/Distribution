...
class ChartSeriesCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartSeriesCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): ChartSeriesCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartSeriesCollectionData = js.native
}
