...
class PivotHierarchyCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.PivotHierarchyCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): PivotHierarchyCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.PivotHierarchyCollectionData = js.native
}
