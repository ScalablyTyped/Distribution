...
class Binding ()
  ...
  /**
    ...
    * @eventproperty
    */
  val onDataChanged: officeDashJsDashPreviewLib.OfficeExtensionNs.EventHandlers[BindingDataChangedEventArgs] = js.native
  /**
    *
    ...
    * @eventproperty
    */
  val onSelectionChanged: officeDashJsDashPreviewLib.OfficeExtensionNs.EventHandlers[BindingSelectionChangedEventArgs] = js.native
  /**
    *
    ...
    * [Api set: ExcelApi 1.1]
    */
  val `type`: BindingType | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Range | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Table | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Text = js.native
  /**
    *
    * Deletes the binding.
    *
  ...
  /**
    ...
    * [Api set: ExcelApi 1.1]
    */
  def getText(): officeDashJsDashPreviewLib.OfficeExtensionNs.ClientResult[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.BindingData = js.native
}
