...
class DataValidation ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): DataValidation = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DataValidationLoadOptions): DataValidation = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DataValidationUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DataValidationUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DataValidationData = js.native
}
