...
class FilterPivotHierarchy ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): FilterPivotHierarchy = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.FilterPivotHierarchyLoadOptions): FilterPivotHierarchy = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.FilterPivotHierarchyUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.FilterPivotHierarchyUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.FilterPivotHierarchyData = js.native
}
