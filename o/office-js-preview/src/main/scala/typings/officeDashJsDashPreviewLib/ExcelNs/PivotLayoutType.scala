...
object PivotLayoutType extends js.Object {
  ...
  sealed trait compact
    extends officeDashJsDashPreviewLib.ExcelNs.PivotLayoutType
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsDashPreviewLib.ExcelNs.PivotLayoutType with java.lang.String] = js.native
}
