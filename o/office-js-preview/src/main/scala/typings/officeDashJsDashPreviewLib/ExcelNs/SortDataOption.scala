...
object SortDataOption extends js.Object {
  @js.native
  sealed trait normal
    extends officeDashJsDashPreviewLib.ExcelNs.SortDataOption
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsDashPreviewLib.ExcelNs.SortDataOption with java.lang.String] = js.native
}
