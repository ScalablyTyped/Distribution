...
class RangeCollection ()
  ...
  /**
    ...
    */
  def getItemAt(index: scala.Double): Range = js.native
  /**
  ...
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RangeCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ): RangeCollection = js.native
  def load(option: java.lang.String): RangeCollection = js.native
  def load(option: js.Array[java.lang.String]): RangeCollection = js.native
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): RangeCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RangeCollectionData = js.native
}
