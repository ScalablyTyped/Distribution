...
class NamedItem ()
  ...
  /**
    ...
    * [Api set: ExcelApi 1.4]
    */
  val scope: NamedItemScope | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Worksheet | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Workbook = js.native
  /**
    *
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): NamedItem = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.NamedItemLoadOptions): NamedItem = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.NamedItemUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.NamedItemUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.NamedItemData = js.native
}
