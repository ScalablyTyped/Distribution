...
class BindingCollection ()
  ...
  def addFromNamedItem_Range(
    ...
    bindingType: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Range,
    id: java.lang.String
  ): Binding = js.native
  /**
           *
  ...
  def addFromNamedItem_Table(
    name: java.lang.String,
    bindingType: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Table,
    id: java.lang.String
  ): Binding = js.native
  /**
           *
  ...
  def addFromNamedItem_Text(
    name: java.lang.String,
    bindingType: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Text,
    id: java.lang.String
  ): Binding = js.native
  /**
           *
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.BindingCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): BindingCollection = js.native
  /**
          ...
          */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.BindingCollectionData = js.native
}
