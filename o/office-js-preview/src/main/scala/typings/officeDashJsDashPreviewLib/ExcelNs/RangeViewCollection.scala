...
class RangeViewCollection ()
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RangeViewCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): RangeViewCollection = js.native
  /**
          ...
          */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RangeViewCollectionData = js.native
}
