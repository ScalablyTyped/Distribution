...
class PivotField ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): PivotField = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.PivotFieldLoadOptions): PivotField = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.PivotFieldUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.PivotFieldUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.PivotFieldData = js.native
}
