...
class NamedItemCollection ()
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.NamedItemCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): NamedItemCollection = js.native
  /**
          ...
          */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.NamedItemCollectionData = js.native
}
