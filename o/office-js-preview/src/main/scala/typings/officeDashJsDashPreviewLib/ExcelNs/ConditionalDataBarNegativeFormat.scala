...
class ConditionalDataBarNegativeFormat ()
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
           ...
           */
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ConditionalDataBarNegativeFormatUpdateData
  ...
  /**
          ...
          */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ConditionalDataBarNegativeFormatData = js.native
}
