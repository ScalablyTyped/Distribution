...
class ChartPoint ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): ChartPoint = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartPointLoadOptions): ChartPoint = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartPointUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartPointUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartPointData = js.native
}
