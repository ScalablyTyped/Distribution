...
class FormatProtection ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): FormatProtection = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.FormatProtectionLoadOptions): FormatProtection = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.FormatProtectionUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.FormatProtectionUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.FormatProtectionData = js.native
}
