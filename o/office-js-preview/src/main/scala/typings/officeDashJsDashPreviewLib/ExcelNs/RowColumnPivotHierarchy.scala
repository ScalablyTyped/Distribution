...
class RowColumnPivotHierarchy ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): RowColumnPivotHierarchy = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RowColumnPivotHierarchyLoadOptions): RowColumnPivotHierarchy = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RowColumnPivotHierarchyUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RowColumnPivotHierarchyUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RowColumnPivotHierarchyData = js.native
}
