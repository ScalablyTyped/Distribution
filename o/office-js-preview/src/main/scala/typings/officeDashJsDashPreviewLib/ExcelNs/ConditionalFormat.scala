...
class ConditionalFormat ()
  ...
  /**
    ...
    * [Api set: ExcelApi 1.6]
    */
  val `type`: ConditionalFormatType | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Custom | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.DataBar | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.ColorScale | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.IconSet | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.TopBottom | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.PresetCriteria | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.ContainsText | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.CellValue = js.native
  /**
    *
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): ConditionalFormat = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ConditionalFormatLoadOptions): ConditionalFormat = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ConditionalFormatUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ConditionalFormatUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ConditionalFormatData = js.native
}
