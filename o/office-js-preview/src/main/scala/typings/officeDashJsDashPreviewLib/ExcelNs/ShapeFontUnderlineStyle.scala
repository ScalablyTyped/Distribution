...
object ShapeFontUnderlineStyle extends js.Object {
  @js.native
  sealed trait dash
    extends officeDashJsDashPreviewLib.ExcelNs.ShapeFontUnderlineStyle
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsDashPreviewLib.ExcelNs.ShapeFontUnderlineStyle with java.lang.String] = js.native
}
