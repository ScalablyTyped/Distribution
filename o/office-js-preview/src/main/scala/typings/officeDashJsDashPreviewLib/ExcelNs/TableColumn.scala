...
class TableColumn ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): TableColumn = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableColumnLoadOptions): TableColumn = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableColumnUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableColumnUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableColumnData = js.native
}
