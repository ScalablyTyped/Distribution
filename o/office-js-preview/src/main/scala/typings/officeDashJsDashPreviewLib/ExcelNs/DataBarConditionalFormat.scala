...
class DataBarConditionalFormat ()
  ...
  /**
    ...
    * [Api set: ExcelApi 1.6]
    */
  var axisFormat: ConditionalDataBarAxisFormat | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Automatic | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.None | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.CellMidPoint = js.native
  /**
    *
    ...
    * [Api set: ExcelApi 1.6]
    */
  var barDirection: ConditionalDataBarDirection | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Context | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.LeftToRight | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.RightToLeft = js.native
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): DataBarConditionalFormat = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DataBarConditionalFormatLoadOptions): DataBarConditionalFormat = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DataBarConditionalFormatUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DataBarConditionalFormatUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DataBarConditionalFormatData = js.native
}
