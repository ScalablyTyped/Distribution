...
class ConditionalRangeFill ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): ConditionalRangeFill = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ConditionalRangeFillLoadOptions): ConditionalRangeFill = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ConditionalRangeFillUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ConditionalRangeFillUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ConditionalRangeFillData = js.native
}
