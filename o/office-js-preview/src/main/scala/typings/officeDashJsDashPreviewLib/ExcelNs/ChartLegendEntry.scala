...
class ChartLegendEntry ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): ChartLegendEntry = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartLegendEntryLoadOptions): ChartLegendEntry = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartLegendEntryUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartLegendEntryUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartLegendEntryData = js.native
}
