...
class DataPivotHierarchyCollection ()
  ...
  /**
           ...
           */
  def getItem(name: java.lang.String): DataPivotHierarchy = js.native
  /**
           *
           ...
           */
  def getItemOrNullObject(name: java.lang.String): DataPivotHierarchy = js.native
  /**
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DataPivotHierarchyCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ): DataPivotHierarchyCollection = js.native
  def load(option: java.lang.String): DataPivotHierarchyCollection = js.native
  def load(option: js.Array[java.lang.String]): DataPivotHierarchyCollection = js.native
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): DataPivotHierarchyCollection = js.native
  /**
           *
  ...
  /**
          ...
          */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.DataPivotHierarchyCollectionData = js.native
}
