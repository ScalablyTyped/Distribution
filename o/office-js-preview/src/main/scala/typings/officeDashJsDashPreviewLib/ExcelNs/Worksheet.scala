...
class Worksheet ()
  ...
  /**
    ...
    */
  var visibility: SheetVisibility | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Visible | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Hidden | officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.VeryHidden = js.native
  /**
    *
  ...
  @JSName("copy")
  def copy_After(positionType: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.After): Worksheet = js.native
  @JSName("copy")
  def copy_After(
  ...
  @JSName("copy")
  def copy_Before(positionType: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Before): Worksheet = js.native
  @JSName("copy")
  def copy_Before(
  ...
  @JSName("copy")
  def copy_Beginning(positionType: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.Beginning): Worksheet = js.native
  @JSName("copy")
  def copy_Beginning(
  ...
  @JSName("copy")
  def copy_End(positionType: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.End): Worksheet = js.native
  @JSName("copy")
  def copy_End(
  ...
  @JSName("copy")
  def copy_None(positionType: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.None): Worksheet = js.native
  @JSName("copy")
  def copy_None(
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.WorksheetUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.WorksheetUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.WorksheetData = js.native
}
