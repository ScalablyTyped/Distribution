...
class CellValueConditionalFormat ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): CellValueConditionalFormat = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CellValueConditionalFormatLoadOptions): CellValueConditionalFormat = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CellValueConditionalFormatUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CellValueConditionalFormatUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CellValueConditionalFormatData = js.native
}
