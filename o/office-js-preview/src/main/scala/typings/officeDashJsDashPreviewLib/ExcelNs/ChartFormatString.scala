...
class ChartFormatString ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): ChartFormatString = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartFormatStringLoadOptions): ChartFormatString = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartFormatStringUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartFormatStringUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartFormatStringData = js.native
}
