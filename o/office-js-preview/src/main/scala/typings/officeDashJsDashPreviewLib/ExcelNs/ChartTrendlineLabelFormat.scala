...
class ChartTrendlineLabelFormat ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): ChartTrendlineLabelFormat = js.native
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartTrendlineLabelFormatLoadOptions): ChartTrendlineLabelFormat = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartTrendlineLabelFormatUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartTrendlineLabelFormatUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.ChartTrendlineLabelFormatData = js.native
}
