...
class TableCollection ()
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): TableCollection = js.native
  /**
          ...
          */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TableCollectionData = js.native
}
