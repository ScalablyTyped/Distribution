...
class RowColumnPivotHierarchyCollection ()
  ...
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RowColumnPivotHierarchyCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): RowColumnPivotHierarchyCollection = js.native
  /**
    *
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.RowColumnPivotHierarchyCollectionData = js.native
}
