...
class TimelineStyleCollection ()
  ...
  /**
    ...
    */
  def add(name: java.lang.String): TimelineStyle = js.native
  def add(name: java.lang.String, makeUniqueName: scala.Boolean): TimelineStyle = js.native
  /**
    *
  ...
  /**
    ...
    */
  def getItem(name: java.lang.String): TimelineStyle = js.native
  /**
    *
    ...
    * @returns The TimelineStyle object whose name matches the input.
    */
  def getItemOrNullObject(name: java.lang.String): TimelineStyle = js.native
  /**
  ...
  def load(
    option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TimelineStyleCollectionLoadOptions with officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ): TimelineStyleCollection = js.native
  def load(option: java.lang.String): TimelineStyleCollection = js.native
  def load(option: js.Array[java.lang.String]): TimelineStyleCollection = js.native
  def load(option: officeDashJsDashPreviewLib.OfficeExtensionNs.LoadOption): TimelineStyleCollection = js.native
  ...
  /**
    ...
    */
  def setDefault(newDefaultStyle: TimelineStyle): scala.Unit = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.TimelineStyleCollectionData = js.native
}
