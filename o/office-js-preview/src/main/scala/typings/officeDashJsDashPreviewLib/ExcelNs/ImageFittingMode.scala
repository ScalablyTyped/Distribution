...
object ImageFittingMode extends js.Object {
  @js.native
  sealed trait fill
    extends officeDashJsDashPreviewLib.ExcelNs.ImageFittingMode
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsDashPreviewLib.ExcelNs.ImageFittingMode with java.lang.String] = js.native
}
