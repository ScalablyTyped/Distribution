...
class CustomXmlPart ()
  ...
  def load(option: officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CustomXmlPartLoadOptions): CustomXmlPart = js.native
  /**
    *
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsDashPreviewLib.ExcelNs.InterfacesNs.CustomXmlPartData = js.native
}
