...
class Application ()
  ...
  def load(option: officeDashJsDashPreviewLib.VisioNs.InterfacesNs.ApplicationLoadOptions): Application = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.VisioNs.InterfacesNs.ApplicationUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.VisioNs.InterfacesNs.ApplicationUpdateData,
  ...
  /**
    ...
    */
  @JSName("showToolbar")
  def showToolbar_CommandBar(id: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.CommandBar, show: scala.Boolean): scala.Unit = js.native
  @JSName("showToolbar")
  def showToolbar_PageNavigationBar(
    id: officeDashJsDashPreviewLib.officeDashJsDashPreviewLibStrings.PageNavigationBar,
    show: scala.Boolean
  ): scala.Unit = js.native
  @JSName("showToolbar")
