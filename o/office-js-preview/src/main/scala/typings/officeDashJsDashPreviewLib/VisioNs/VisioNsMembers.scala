...
@JSGlobal("Visio")
@js.native
object VisioNsMembers extends js.Object {
  /**
  ...
  /**
    ...
    */
  def run[T](
    contextObject: officeDashJsDashPreviewLib.OfficeExtensionNs.ClientRequestContext,
  ...
  def run[T](
    `object`: officeDashJsDashPreviewLib.OfficeExtensionNs.EmbeddedSession,
    batch: js.Function1[/* context */ RequestContext, js.Promise[T]]
  ): js.Promise[T] = js.native
  /**
