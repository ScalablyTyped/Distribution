...
class Comment ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Select): Comment = js.native
  def load(option: officeDashJsDashPreviewLib.VisioNs.InterfacesNs.CommentLoadOptions): Comment = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.VisioNs.InterfacesNs.CommentUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsDashPreviewLib.VisioNs.InterfacesNs.CommentUpdateData,
    options: officeDashJsDashPreviewLib.OfficeExtensionNs.UpdateOptions
  ): scala.Unit = js.native
  def toJSON(): officeDashJsDashPreviewLib.VisioNs.InterfacesNs.CommentData = js.native
}
