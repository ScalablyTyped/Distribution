...
class DocumentView ()
  ...
  def load(option: officeDashJsDashPreviewLib.Anon_Expand): DocumentView = js.native
  def load(option: officeDashJsDashPreviewLib.VisioNs.InterfacesNs.DocumentViewLoadOptions): DocumentView = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsDashPreviewLib.VisioNs.InterfacesNs.DocumentViewUpdateData): scala.Unit = js.native
  def set(
