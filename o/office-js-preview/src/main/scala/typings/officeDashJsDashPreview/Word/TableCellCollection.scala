...
import typings.officeDashJsDashPreview.Word.Interfaces.TableCellCollectionData
import typings.officeDashJsDashPreview.Word.Interfaces.TableCellCollectionLoadOptions
