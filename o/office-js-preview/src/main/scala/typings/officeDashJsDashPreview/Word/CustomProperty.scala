...
import typings.officeDashJsDashPreview.Word.Interfaces.CustomPropertyData
import typings.officeDashJsDashPreview.Word.Interfaces.CustomPropertyLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.CustomPropertyUpdateData
