...
import typings.officeDashJsDashPreview.Word.Interfaces.DocumentPropertiesData
import typings.officeDashJsDashPreview.Word.Interfaces.DocumentPropertiesLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.DocumentPropertiesUpdateData
