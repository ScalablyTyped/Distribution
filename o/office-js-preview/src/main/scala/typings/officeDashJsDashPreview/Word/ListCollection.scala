...
import typings.officeDashJsDashPreview.Word.Interfaces.ListCollectionData
import typings.officeDashJsDashPreview.Word.Interfaces.ListCollectionLoadOptions
