...
import typings.officeDashJsDashPreview.Word.Interfaces.SettingCollectionData
import typings.officeDashJsDashPreview.Word.Interfaces.SettingCollectionLoadOptions
