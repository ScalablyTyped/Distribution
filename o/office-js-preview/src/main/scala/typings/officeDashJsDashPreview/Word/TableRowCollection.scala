...
import typings.officeDashJsDashPreview.Word.Interfaces.TableRowCollectionData
import typings.officeDashJsDashPreview.Word.Interfaces.TableRowCollectionLoadOptions
