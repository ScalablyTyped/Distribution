...
object DocumentPropertiesLoadOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(applicationName)) __obj.updateDynamic("applicationName")(applicationName.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(lastPrintDate)) __obj.updateDynamic("lastPrintDate")(lastPrintDate.asInstanceOf[js.Any])
    if (!js.isUndefined(lastSaveTime)) __obj.updateDynamic("lastSaveTime")(lastSaveTime.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(security)) __obj.updateDynamic("security")(security.asInstanceOf[js.Any])
    if (!js.isUndefined(subject)) __obj.updateDynamic("subject")(subject.asInstanceOf[js.Any])
    if (!js.isUndefined(template)) __obj.updateDynamic("template")(template.asInstanceOf[js.Any])
