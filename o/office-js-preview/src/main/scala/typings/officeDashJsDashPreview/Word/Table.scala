...
import typings.officeDashJsDashPreview.Word.Interfaces.TableData
import typings.officeDashJsDashPreview.Word.Interfaces.TableLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.TableUpdateData
