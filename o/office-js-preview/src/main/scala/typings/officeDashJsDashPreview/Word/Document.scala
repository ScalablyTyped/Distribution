...
import typings.officeDashJsDashPreview.Word.Interfaces.DocumentData
import typings.officeDashJsDashPreview.Word.Interfaces.DocumentLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.DocumentUpdateData
