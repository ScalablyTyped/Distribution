...
import typings.officeDashJsDashPreview.Word.Interfaces.ParagraphData
import typings.officeDashJsDashPreview.Word.Interfaces.ParagraphLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.ParagraphUpdateData
