...
import typings.officeDashJsDashPreview.Word.Interfaces.SettingData
import typings.officeDashJsDashPreview.Word.Interfaces.SettingLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.SettingUpdateData
