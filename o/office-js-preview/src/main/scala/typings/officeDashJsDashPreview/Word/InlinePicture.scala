...
import typings.officeDashJsDashPreview.Word.Interfaces.InlinePictureData
import typings.officeDashJsDashPreview.Word.Interfaces.InlinePictureLoadOptions
