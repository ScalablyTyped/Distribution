...
import typings.officeDashJsDashPreview.Word.Interfaces.ContentControlData
import typings.officeDashJsDashPreview.Word.Interfaces.ContentControlLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.ContentControlUpdateData
