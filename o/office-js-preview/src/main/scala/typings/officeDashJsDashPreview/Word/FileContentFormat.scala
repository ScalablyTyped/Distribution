...
object FileContentFormat extends js.Object {
  ...
  /* "Base64" */ val base64: typings.officeDashJsDashPreview.Word.FileContentFormat.base64 with String = js.native
  /* "Html" */ val html: typings.officeDashJsDashPreview.Word.FileContentFormat.html with String = js.native
  /* "Ooxml" */ val ooxml: typings.officeDashJsDashPreview.Word.FileContentFormat.ooxml with String = js.native
  @JSBracketAccess
