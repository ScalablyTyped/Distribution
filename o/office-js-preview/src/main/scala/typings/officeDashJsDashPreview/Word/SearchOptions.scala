...
import typings.officeDashJsDashPreview.Word.Interfaces.SearchOptionsData
import typings.officeDashJsDashPreview.Word.Interfaces.SearchOptionsLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.SearchOptionsUpdateData
