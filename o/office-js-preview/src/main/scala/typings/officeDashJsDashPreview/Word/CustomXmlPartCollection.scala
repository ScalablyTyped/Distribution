...
import typings.officeDashJsDashPreview.Word.Interfaces.CustomXmlPartCollectionData
import typings.officeDashJsDashPreview.Word.Interfaces.CustomXmlPartCollectionLoadOptions
