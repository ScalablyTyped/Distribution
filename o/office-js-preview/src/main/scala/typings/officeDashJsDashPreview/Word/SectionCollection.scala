...
import typings.officeDashJsDashPreview.Word.Interfaces.SectionCollectionData
import typings.officeDashJsDashPreview.Word.Interfaces.SectionCollectionLoadOptions
