...
import typings.officeDashJsDashPreview.Word.Interfaces.CustomXmlPartData
import typings.officeDashJsDashPreview.Word.Interfaces.CustomXmlPartLoadOptions
