...
import typings.officeDashJsDashPreview.Word.Interfaces.CustomPropertyCollectionData
import typings.officeDashJsDashPreview.Word.Interfaces.CustomPropertyCollectionLoadOptions
