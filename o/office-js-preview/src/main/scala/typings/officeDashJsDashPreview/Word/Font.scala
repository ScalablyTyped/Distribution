...
import typings.officeDashJsDashPreview.Word.Interfaces.FontData
import typings.officeDashJsDashPreview.Word.Interfaces.FontLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.FontUpdateData
...
class Font () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.1]
    */
  var underline: UnderlineType | Mixed | None | Hidden | DotLine | Single | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Word | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble = js.native
  /**
