...
import typings.officeDashJsDashPreview.Word.Interfaces.DocumentCreatedData
import typings.officeDashJsDashPreview.Word.Interfaces.DocumentCreatedLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.DocumentCreatedUpdateData
