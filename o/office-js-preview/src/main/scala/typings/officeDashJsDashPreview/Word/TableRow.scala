...
import typings.officeDashJsDashPreview.Anon_IgnorePunct
...
import typings.officeDashJsDashPreview.Word.Interfaces.TableRowData
import typings.officeDashJsDashPreview.Word.Interfaces.TableRowLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.TableRowUpdateData
...
class TableRow () extends ClientObject {
  ...
  def load(option: Anon_Expand): TableRow = js.native
