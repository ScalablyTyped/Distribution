...
import typings.officeDashJsDashPreview.Word.Interfaces.RangeCollectionData
import typings.officeDashJsDashPreview.Word.Interfaces.RangeCollectionLoadOptions
