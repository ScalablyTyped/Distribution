...
import typings.officeDashJsDashPreview.Word.Interfaces.InlinePictureCollectionData
import typings.officeDashJsDashPreview.Word.Interfaces.InlinePictureCollectionLoadOptions
