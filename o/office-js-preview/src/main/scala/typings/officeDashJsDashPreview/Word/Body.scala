...
import typings.officeDashJsDashPreview.Word.Interfaces.BodyData
import typings.officeDashJsDashPreview.Word.Interfaces.BodyLoadOptions
import typings.officeDashJsDashPreview.Word.Interfaces.BodyUpdateData
...
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.SectionNext
...
class Body () extends ClientObject {
  ...
  def load(option: Anon_Expand): Body = js.native
