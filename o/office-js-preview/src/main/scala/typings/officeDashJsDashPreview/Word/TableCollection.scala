...
import typings.officeDashJsDashPreview.Word.Interfaces.TableCollectionData
import typings.officeDashJsDashPreview.Word.Interfaces.TableCollectionLoadOptions
