...
object HostType extends js.Object {
  ...
  /* 6 */ val Access: typings.officeDashJsDashPreview.OfficeNs.HostType.Access with Double = js.native
  /* 1 */ val Excel: typings.officeDashJsDashPreview.OfficeNs.HostType.Excel with Double = js.native
  /* 4 */ val OneNote: typings.officeDashJsDashPreview.OfficeNs.HostType.OneNote with Double = js.native
  /* 3 */ val Outlook: typings.officeDashJsDashPreview.OfficeNs.HostType.Outlook with Double = js.native
  /* 2 */ val PowerPoint: typings.officeDashJsDashPreview.OfficeNs.HostType.PowerPoint with Double = js.native
  /* 5 */ val Project: typings.officeDashJsDashPreview.OfficeNs.HostType.Project with Double = js.native
  /* 0 */ val Word: typings.officeDashJsDashPreview.OfficeNs.HostType.Word with Double = js.native
  @JSBracketAccess
