...
object BindingType extends js.Object {
  ...
  /* 1 */ val Matrix: typings.officeDashJsDashPreview.OfficeNs.BindingType.Matrix with Double = js.native
  /* 2 */ val Table: typings.officeDashJsDashPreview.OfficeNs.BindingType.Table with Double = js.native
  /* 0 */ val Text: typings.officeDashJsDashPreview.OfficeNs.BindingType.Text with Double = js.native
  @JSBracketAccess
