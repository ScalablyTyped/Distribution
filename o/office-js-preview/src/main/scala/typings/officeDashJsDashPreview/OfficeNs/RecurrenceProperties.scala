...
import typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.Days
import typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.Month
import typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.WeekNumber
