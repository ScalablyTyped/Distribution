...
object RecipientType extends js.Object {
  ...
  /* "distributionList" */ val DistributionList: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.RecipientType.DistributionList with String = js.native
  /* "externalUser" */ val ExternalUser: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.RecipientType.ExternalUser with String = js.native
  /* "other" */ val Other: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.RecipientType.Other with String = js.native
  /* "user" */ val User: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.RecipientType.User with String = js.native
  @JSBracketAccess
