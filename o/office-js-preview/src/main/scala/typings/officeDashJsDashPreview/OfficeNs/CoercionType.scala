...
object CoercionType extends js.Object {
  ...
  /* 3 */ val Html: typings.officeDashJsDashPreview.OfficeNs.CoercionType.Html with Double = js.native
  /* 6 */ val Image: typings.officeDashJsDashPreview.OfficeNs.CoercionType.Image with Double = js.native
  /* 1 */ val Matrix: typings.officeDashJsDashPreview.OfficeNs.CoercionType.Matrix with Double = js.native
  /* 4 */ val Ooxml: typings.officeDashJsDashPreview.OfficeNs.CoercionType.Ooxml with Double = js.native
  /* 5 */ val SlideRange: typings.officeDashJsDashPreview.OfficeNs.CoercionType.SlideRange with Double = js.native
  /* 2 */ val Table: typings.officeDashJsDashPreview.OfficeNs.CoercionType.Table with Double = js.native
  /* 0 */ val Text: typings.officeDashJsDashPreview.OfficeNs.CoercionType.Text with Double = js.native
  /* 7 */ val XmlSvg: typings.officeDashJsDashPreview.OfficeNs.CoercionType.XmlSvg with Double = js.native
  @JSBracketAccess
