...
object SelectionMode extends js.Object {
  ...
  /* 0 */ val Default: typings.officeDashJsDashPreview.OfficeNs.SelectionMode.Default with Double = js.native
  /* 2 */ val None: typings.officeDashJsDashPreview.OfficeNs.SelectionMode.None with Double = js.native
  /* 1 */ val Selected: typings.officeDashJsDashPreview.OfficeNs.SelectionMode.Selected with Double = js.native
  @JSBracketAccess
