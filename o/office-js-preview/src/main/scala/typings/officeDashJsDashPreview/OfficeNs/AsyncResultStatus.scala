...
object AsyncResultStatus extends js.Object {
  ...
  /* 1 */ val Failed: typings.officeDashJsDashPreview.OfficeNs.AsyncResultStatus.Failed with Double = js.native
  /* 0 */ val Succeeded: typings.officeDashJsDashPreview.OfficeNs.AsyncResultStatus.Succeeded with Double = js.native
  @JSBracketAccess
