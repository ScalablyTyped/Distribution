...
object DocumentMode extends js.Object {
  ...
  /* 0 */ val ReadOnly: typings.officeDashJsDashPreview.OfficeNs.DocumentMode.ReadOnly with Double = js.native
  /* 1 */ val ReadWrite: typings.officeDashJsDashPreview.OfficeNs.DocumentMode.ReadWrite with Double = js.native
  @JSBracketAccess
