...
trait RecurrenceTimeZone extends js.Object {
  /**
    ...
    */
  var name: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.RecurrenceTimeZone | String
  /**
...
object RecurrenceTimeZone {
  @scala.inline
  def apply(
    name: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.RecurrenceTimeZone | String,
    offset: Double
  ): RecurrenceTimeZone = {
