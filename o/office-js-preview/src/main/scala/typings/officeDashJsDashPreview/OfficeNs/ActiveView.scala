...
object ActiveView extends js.Object {
  ...
  /* 1 */ val Edit: typings.officeDashJsDashPreview.OfficeNs.ActiveView.Edit with Double = js.native
  /* 0 */ val Read: typings.officeDashJsDashPreview.OfficeNs.ActiveView.Read with Double = js.native
  @JSBracketAccess
