...
object Table extends js.Object {
  ...
  /* 0 */ val All: typings.officeDashJsDashPreview.OfficeNs.Table.All with Double = js.native
  /* 1 */ val Data: typings.officeDashJsDashPreview.OfficeNs.Table.Data with Double = js.native
  /* 2 */ val Headers: typings.officeDashJsDashPreview.OfficeNs.Table.Headers with Double = js.native
  @JSBracketAccess
