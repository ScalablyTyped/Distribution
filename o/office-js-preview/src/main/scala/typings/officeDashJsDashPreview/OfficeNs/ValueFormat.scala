...
object ValueFormat extends js.Object {
  ...
  /* 1 */ val Formatted: typings.officeDashJsDashPreview.OfficeNs.ValueFormat.Formatted with Double = js.native
  /* 0 */ val Unformatted: typings.officeDashJsDashPreview.OfficeNs.ValueFormat.Unformatted with Double = js.native
  @JSBracketAccess
