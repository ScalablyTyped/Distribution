...
object DelegatePermissions extends js.Object {
  ...
  /* 8 */ val DeleteAll: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.DelegatePermissions.DeleteAll with Double = js.native
  /* 4 */ val DeleteOwn: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.DelegatePermissions.DeleteOwn with Double = js.native
  /* 32 */ val EditAll: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.DelegatePermissions.EditAll with Double = js.native
  /* 16 */ val EditOwn: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.DelegatePermissions.EditOwn with Double = js.native
  /* 1 */ val Read: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.DelegatePermissions.Read with Double = js.native
  /* 2 */ val Write: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.DelegatePermissions.Write with Double = js.native
  @JSBracketAccess
