...
object AttachmentType extends js.Object {
  ...
  /* "cloud" */ val Cloud: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.AttachmentType.Cloud with String = js.native
  /* "file" */ val File: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.AttachmentType.File with String = js.native
  /* "item" */ val Item: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.AttachmentType.Item with String = js.native
  @JSBracketAccess
