...
object RestVersion extends js.Object {
  ...
  /* "beta" */ val Beta: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.RestVersion.Beta with String = js.native
  /* "v1.0" */ val v1_0: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.RestVersion.v1_0 with String = js.native
  /* "v2.0" */ val v2_0: typings.officeDashJsDashPreview.OfficeNs.MailboxEnumsNs.RestVersion.v2_0 with String = js.native
  @JSBracketAccess
