...
import typings.officeDashJsDashPreview.VisioNs.InterfacesNs.ApplicationData
import typings.officeDashJsDashPreview.VisioNs.InterfacesNs.ApplicationLoadOptions
import typings.officeDashJsDashPreview.VisioNs.InterfacesNs.ApplicationUpdateData
