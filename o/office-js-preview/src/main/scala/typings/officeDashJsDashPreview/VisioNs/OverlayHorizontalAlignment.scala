...
object OverlayHorizontalAlignment extends js.Object {
  ...
  /* "Center" */ val center: typings.officeDashJsDashPreview.VisioNs.OverlayHorizontalAlignment.center with String = js.native
  /* "Left" */ val left: typings.officeDashJsDashPreview.VisioNs.OverlayHorizontalAlignment.left with String = js.native
  /* "Right" */ val right: typings.officeDashJsDashPreview.VisioNs.OverlayHorizontalAlignment.right with String = js.native
  @JSBracketAccess
