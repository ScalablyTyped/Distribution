...
import typings.officeDashJsDashPreview.OfficeExtensionNs.ClientRequestContext
import typings.officeDashJsDashPreview.OfficeExtensionNs.EmbeddedSession
...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def run[T](objects: js.Array[ClientObject], batch: js.Function1[/* context */ RequestContext, js.Promise[T]]): js.Promise[T] = js.native
  /**
    ...
    */
  def run[T](`object`: ClientObject, batch: js.Function1[/* context */ RequestContext, js.Promise[T]]): js.Promise[T] = js.native
  def run[T](`object`: EmbeddedSession, batch: js.Function1[/* context */ RequestContext, js.Promise[T]]): js.Promise[T] = js.native
}
