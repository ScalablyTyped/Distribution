...
object OverlayType extends js.Object {
  ...
  /* "Html" */ val html: typings.officeDashJsDashPreview.VisioNs.OverlayType.html with String = js.native
  /* "Image" */ val image: typings.officeDashJsDashPreview.VisioNs.OverlayType.image with String = js.native
  /* "Text" */ val text: typings.officeDashJsDashPreview.VisioNs.OverlayType.text with String = js.native
  @JSBracketAccess
