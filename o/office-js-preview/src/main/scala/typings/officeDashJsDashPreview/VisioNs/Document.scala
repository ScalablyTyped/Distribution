...
import typings.officeDashJsDashPreview.VisioNs.InterfacesNs.DocumentData
import typings.officeDashJsDashPreview.VisioNs.InterfacesNs.DocumentLoadOptions
import typings.officeDashJsDashPreview.VisioNs.InterfacesNs.DocumentUpdateData
