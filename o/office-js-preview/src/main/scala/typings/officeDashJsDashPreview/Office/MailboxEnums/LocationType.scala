...
object LocationType extends js.Object {
  ...
  /* "custom" */ val Custom: typings.officeDashJsDashPreview.Office.MailboxEnums.LocationType.Custom with String = js.native
  /* "room" */ val Room: typings.officeDashJsDashPreview.Office.MailboxEnums.LocationType.Room with String = js.native
  @JSBracketAccess
