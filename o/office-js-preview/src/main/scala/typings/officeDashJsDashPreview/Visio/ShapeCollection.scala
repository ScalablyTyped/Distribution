...
import typings.officeDashJsDashPreview.Visio.Interfaces.ShapeCollectionData
import typings.officeDashJsDashPreview.Visio.Interfaces.ShapeCollectionLoadOptions
