...
import typings.officeDashJsDashPreview.Visio.Interfaces.CommentData
import typings.officeDashJsDashPreview.Visio.Interfaces.CommentLoadOptions
import typings.officeDashJsDashPreview.Visio.Interfaces.CommentUpdateData
...
class Comment () extends ClientObject {
  ...
  def load(option: Anon_Expand): Comment = js.native
