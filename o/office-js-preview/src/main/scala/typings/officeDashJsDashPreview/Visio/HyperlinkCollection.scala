...
import typings.officeDashJsDashPreview.Visio.Interfaces.HyperlinkCollectionData
import typings.officeDashJsDashPreview.Visio.Interfaces.HyperlinkCollectionLoadOptions
