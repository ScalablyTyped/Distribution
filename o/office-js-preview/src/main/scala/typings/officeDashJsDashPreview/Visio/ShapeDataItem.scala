...
import typings.officeDashJsDashPreview.Visio.Interfaces.ShapeDataItemData
import typings.officeDashJsDashPreview.Visio.Interfaces.ShapeDataItemLoadOptions
