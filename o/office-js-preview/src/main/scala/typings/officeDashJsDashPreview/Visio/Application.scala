...
import typings.officeDashJsDashPreview.Visio.Interfaces.ApplicationData
import typings.officeDashJsDashPreview.Visio.Interfaces.ApplicationLoadOptions
import typings.officeDashJsDashPreview.Visio.Interfaces.ApplicationUpdateData
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.CommandBar
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.PageNavigationBar
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.StatusBar
...
class Application () extends ClientObject {
  ...
  def load(option: Anon_Expand): Application = js.native
