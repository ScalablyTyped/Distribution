...
import typings.officeDashJsDashPreview.OneNote.Interfaces.ApplicationData
import typings.officeDashJsDashPreview.OneNote.Interfaces.ApplicationLoadOptions
