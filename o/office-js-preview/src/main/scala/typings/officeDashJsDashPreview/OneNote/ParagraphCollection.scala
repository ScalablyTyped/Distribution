...
import typings.officeDashJsDashPreview.OneNote.Interfaces.ParagraphCollectionData
import typings.officeDashJsDashPreview.OneNote.Interfaces.ParagraphCollectionLoadOptions
