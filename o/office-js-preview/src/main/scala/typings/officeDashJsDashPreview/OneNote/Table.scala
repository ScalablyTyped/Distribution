...
import typings.officeDashJsDashPreview.OneNote.Interfaces.TableData
import typings.officeDashJsDashPreview.OneNote.Interfaces.TableLoadOptions
import typings.officeDashJsDashPreview.OneNote.Interfaces.TableUpdateData
...
class Table () extends ClientObject {
  ...
  def load(option: Anon_Expand): Table = js.native
