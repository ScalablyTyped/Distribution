...
import typings.officeDashJsDashPreview.OneNote.Interfaces.ImageData
import typings.officeDashJsDashPreview.OneNote.Interfaces.ImageLoadOptions
import typings.officeDashJsDashPreview.OneNote.Interfaces.ImageUpdateData
