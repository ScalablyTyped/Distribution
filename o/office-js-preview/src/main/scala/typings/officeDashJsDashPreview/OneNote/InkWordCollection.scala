...
import typings.officeDashJsDashPreview.OneNote.Interfaces.CollectionLoadOptions
import typings.officeDashJsDashPreview.OneNote.Interfaces.InkWordCollectionData
import typings.officeDashJsDashPreview.OneNote.Interfaces.InkWordCollectionLoadOptions
...
@js.native
class InkWordCollection () extends ClientObject {
  ...
  def load(option: InkWordCollectionLoadOptions with CollectionLoadOptions): InkWordCollection = js.native
  def load(option: String): InkWordCollection = js.native
  def load(option: js.Array[String]): InkWordCollection = js.native
  def load(option: LoadOption): InkWordCollection = js.native
  /**
