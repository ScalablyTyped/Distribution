...
import typings.officeDashJsDashPreview.OneNote.Interfaces.TableCellCollectionData
import typings.officeDashJsDashPreview.OneNote.Interfaces.TableCellCollectionLoadOptions
