...
import typings.officeDashJsDashPreview.OneNote.Interfaces.NotebookCollectionData
import typings.officeDashJsDashPreview.OneNote.Interfaces.NotebookCollectionLoadOptions
