...
import typings.officeDashJsDashPreview.OneNote.Interfaces.SectionGroupData
import typings.officeDashJsDashPreview.OneNote.Interfaces.SectionGroupLoadOptions
