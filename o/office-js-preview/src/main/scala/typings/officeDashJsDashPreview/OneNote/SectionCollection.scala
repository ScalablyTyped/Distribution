...
import typings.officeDashJsDashPreview.OneNote.Interfaces.SectionCollectionData
import typings.officeDashJsDashPreview.OneNote.Interfaces.SectionCollectionLoadOptions
