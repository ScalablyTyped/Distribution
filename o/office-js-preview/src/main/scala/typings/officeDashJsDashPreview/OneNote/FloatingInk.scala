...
import typings.officeDashJsDashPreview.OneNote.Interfaces.FloatingInkData
import typings.officeDashJsDashPreview.OneNote.Interfaces.FloatingInkLoadOptions
