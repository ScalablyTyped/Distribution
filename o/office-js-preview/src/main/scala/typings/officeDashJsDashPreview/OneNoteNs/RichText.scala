...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.RichTextData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.RichTextLoadOptions
...
@js.native
class RichText () extends ClientObject {
  ...
  def load(option: Anon_Expand): RichText = js.native
