...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.CollectionLoadOptions
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkAnalysisLineCollectionData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkAnalysisLineCollectionLoadOptions
...
@js.native
class InkAnalysisLineCollection () extends ClientObject {
