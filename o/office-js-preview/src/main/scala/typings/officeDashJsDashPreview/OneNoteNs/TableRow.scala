...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.TableRowData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.TableRowLoadOptions
