...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.PageContentData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.PageContentLoadOptions
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.PageContentUpdateData
...
class PageContent () extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: PageContentType | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Outline | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Image | Ink | Other = js.native
  /**
    *
