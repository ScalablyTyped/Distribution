...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.NotebookData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.NotebookLoadOptions
