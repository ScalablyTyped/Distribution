...
import typings.officeDashJsDashPreview.OneNoteNs.PageContentType
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Ink
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Other
...
trait PageContentData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    PageContentType | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Outline | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Image | Ink | Other
  ] = js.undefined
}
...
object PageContentData {
  ...
  def apply(
    ...
    top: Int | Double = null,
    `type`: PageContentType | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Outline | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Image | Ink | Other = null
  ): PageContentData = {
