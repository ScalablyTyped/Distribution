...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.ImageData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.ImageLoadOptions
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.ImageUpdateData
