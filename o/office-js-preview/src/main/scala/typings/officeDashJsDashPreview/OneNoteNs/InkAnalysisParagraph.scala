...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkAnalysisParagraphData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkAnalysisParagraphLoadOptions
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkAnalysisParagraphUpdateData
...
class InkAnalysisParagraph () extends ClientObject {
  ...
  def load(option: Anon_Expand): InkAnalysisParagraph = js.native
