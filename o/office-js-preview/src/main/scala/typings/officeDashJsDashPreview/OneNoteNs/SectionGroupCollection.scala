...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.SectionGroupCollectionData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.SectionGroupCollectionLoadOptions
...
@js.native
class SectionGroupCollection () extends ClientObject {
