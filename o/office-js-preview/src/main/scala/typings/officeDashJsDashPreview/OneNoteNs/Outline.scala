...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.OutlineData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.OutlineLoadOptions
