...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.NotebookCollectionData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.NotebookCollectionLoadOptions
