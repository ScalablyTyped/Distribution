...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.TableData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.TableLoadOptions
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.TableUpdateData
