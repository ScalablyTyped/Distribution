...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.ParagraphCollectionData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.ParagraphCollectionLoadOptions
