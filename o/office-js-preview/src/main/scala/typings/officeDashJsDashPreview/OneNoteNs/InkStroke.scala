...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkStrokeData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkStrokeLoadOptions
