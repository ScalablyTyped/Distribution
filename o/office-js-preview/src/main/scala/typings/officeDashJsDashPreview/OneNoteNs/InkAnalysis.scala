...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkAnalysisData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkAnalysisLoadOptions
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkAnalysisUpdateData
...
class InkAnalysis () extends ClientObject {
  ...
  def load(option: Anon_Expand): InkAnalysis = js.native
