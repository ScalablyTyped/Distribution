...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkAnalysisWordCollectionData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkAnalysisWordCollectionLoadOptions
