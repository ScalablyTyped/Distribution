...
object PageContentType extends js.Object {
  ...
  /* "Image" */ val image: typings.officeDashJsDashPreview.OneNoteNs.PageContentType.image with String = js.native
  /* "Ink" */ val ink: typings.officeDashJsDashPreview.OneNoteNs.PageContentType.ink with String = js.native
  /* "Other" */ val other: typings.officeDashJsDashPreview.OneNoteNs.PageContentType.other with String = js.native
  /* "Outline" */ val outline: typings.officeDashJsDashPreview.OneNoteNs.PageContentType.outline with String = js.native
  @JSBracketAccess
