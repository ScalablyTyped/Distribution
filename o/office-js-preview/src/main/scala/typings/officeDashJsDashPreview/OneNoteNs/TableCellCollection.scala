...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.TableCellCollectionData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.TableCellCollectionLoadOptions
