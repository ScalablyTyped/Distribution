...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.ApplicationData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.ApplicationLoadOptions
