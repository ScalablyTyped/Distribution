...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.SectionGroupData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.SectionGroupLoadOptions
