...
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkWordData
import typings.officeDashJsDashPreview.OneNoteNs.InterfacesNs.InkWordLoadOptions
...
@js.native
class InkWord () extends ClientObject {
  ...
  def load(option: Anon_Expand): InkWord = js.native
