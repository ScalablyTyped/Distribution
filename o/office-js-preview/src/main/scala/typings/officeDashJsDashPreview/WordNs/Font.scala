...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.FontData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.FontLoadOptions
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.FontUpdateData
...
class Font () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.1]
    */
  var underline: UnderlineType | Mixed | None | Hidden | DotLine | Single | Word | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble = js.native
  /**
  ...
  def load(option: Anon_Expand): Font = js.native
