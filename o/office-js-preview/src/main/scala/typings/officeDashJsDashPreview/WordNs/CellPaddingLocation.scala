...
object CellPaddingLocation extends js.Object {
  ...
  /* "Bottom" */ val bottom: typings.officeDashJsDashPreview.WordNs.CellPaddingLocation.bottom with String = js.native
  /* "Left" */ val left: typings.officeDashJsDashPreview.WordNs.CellPaddingLocation.left with String = js.native
  /* "Right" */ val right: typings.officeDashJsDashPreview.WordNs.CellPaddingLocation.right with String = js.native
  /* "Top" */ val top: typings.officeDashJsDashPreview.WordNs.CellPaddingLocation.top with String = js.native
  @JSBracketAccess
