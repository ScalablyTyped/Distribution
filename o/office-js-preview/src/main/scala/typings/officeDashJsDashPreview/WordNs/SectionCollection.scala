...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.SectionCollectionData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.SectionCollectionLoadOptions
