...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.DocumentData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.DocumentLoadOptions
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.DocumentUpdateData
