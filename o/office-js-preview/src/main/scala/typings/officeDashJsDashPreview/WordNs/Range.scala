...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.RangeData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.RangeLoadOptions
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.RangeUpdateData
