...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.SettingData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.SettingLoadOptions
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.SettingUpdateData
