...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.RangeCollectionData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.RangeCollectionLoadOptions
