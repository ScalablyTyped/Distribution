...
object FileContentFormat extends js.Object {
  ...
  /* "Base64" */ val base64: typings.officeDashJsDashPreview.WordNs.FileContentFormat.base64 with String = js.native
  /* "Html" */ val html: typings.officeDashJsDashPreview.WordNs.FileContentFormat.html with String = js.native
  /* "Ooxml" */ val ooxml: typings.officeDashJsDashPreview.WordNs.FileContentFormat.ooxml with String = js.native
  @JSBracketAccess
