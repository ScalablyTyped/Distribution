...
object RangeLocation extends js.Object {
  ...
  /* "After" */ val after: typings.officeDashJsDashPreview.WordNs.RangeLocation.after with String = js.native
  /* "Before" */ val before: typings.officeDashJsDashPreview.WordNs.RangeLocation.before with String = js.native
  /* "Content" */ val content: typings.officeDashJsDashPreview.WordNs.RangeLocation.content with String = js.native
  /* "End" */ val end: typings.officeDashJsDashPreview.WordNs.RangeLocation.end with String = js.native
  /* "Start" */ val start: typings.officeDashJsDashPreview.WordNs.RangeLocation.start with String = js.native
  /* "Whole" */ val whole: typings.officeDashJsDashPreview.WordNs.RangeLocation.whole with String = js.native
  @JSBracketAccess
