...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.CollectionLoadOptions
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.CustomPropertyCollectionData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.CustomPropertyCollectionLoadOptions
