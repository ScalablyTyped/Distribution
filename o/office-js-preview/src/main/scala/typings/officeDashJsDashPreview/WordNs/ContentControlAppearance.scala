...
object ContentControlAppearance extends js.Object {
  ...
  /* "BoundingBox" */ val boundingBox: typings.officeDashJsDashPreview.WordNs.ContentControlAppearance.boundingBox with String = js.native
  /* "Hidden" */ val hidden: typings.officeDashJsDashPreview.WordNs.ContentControlAppearance.hidden with String = js.native
  /* "Tags" */ val tags: typings.officeDashJsDashPreview.WordNs.ContentControlAppearance.tags with String = js.native
  @JSBracketAccess
