...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.ParagraphCollectionData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.ParagraphCollectionLoadOptions
