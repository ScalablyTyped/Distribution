...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.SearchOptionsData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.SearchOptionsLoadOptions
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.SearchOptionsUpdateData
...
class SearchOptions () extends ClientObject {
  ...
  def load(option: Anon_Expand): SearchOptions = js.native
