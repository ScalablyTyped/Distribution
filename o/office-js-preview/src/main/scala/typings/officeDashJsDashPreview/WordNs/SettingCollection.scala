...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.SettingCollectionData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.SettingCollectionLoadOptions
