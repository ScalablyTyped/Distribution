...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.TableData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.TableLoadOptions
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.TableUpdateData
