...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.TableRowData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.TableRowLoadOptions
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.TableRowUpdateData
