...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.ParagraphData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.ParagraphLoadOptions
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.ParagraphUpdateData
