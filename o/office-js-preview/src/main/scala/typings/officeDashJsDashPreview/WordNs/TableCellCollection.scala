...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.TableCellCollectionData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.TableCellCollectionLoadOptions
