...
object InsertLocation extends js.Object {
  ...
  /* "After" */ val after: typings.officeDashJsDashPreview.WordNs.InsertLocation.after with String = js.native
  /* "Before" */ val before: typings.officeDashJsDashPreview.WordNs.InsertLocation.before with String = js.native
  /* "End" */ val end: typings.officeDashJsDashPreview.WordNs.InsertLocation.end with String = js.native
  /* "Replace" */ val replace: typings.officeDashJsDashPreview.WordNs.InsertLocation.replace with String = js.native
  /* "Start" */ val start: typings.officeDashJsDashPreview.WordNs.InsertLocation.start with String = js.native
  @JSBracketAccess
