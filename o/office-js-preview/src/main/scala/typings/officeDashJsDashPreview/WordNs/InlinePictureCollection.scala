...
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.InlinePictureCollectionData
import typings.officeDashJsDashPreview.WordNs.InterfacesNs.InlinePictureCollectionLoadOptions
