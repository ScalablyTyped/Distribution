...
import typings.officeDashJsDashPreview.WordNs.ContentControlAppearance
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.BoundingBox
