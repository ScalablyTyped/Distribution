...
import typings.officeDashJsDashPreview.Excel.Interfaces.WorkbookData
import typings.officeDashJsDashPreview.Excel.Interfaces.WorkbookLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.WorkbookUpdateData
