...
import typings.officeDashJsDashPreview.Excel.Interfaces.ShapeData
import typings.officeDashJsDashPreview.Excel.Interfaces.ShapeLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.ShapeUpdateData
