...
import typings.officeDashJsDashPreview.Excel.Interfaces.PageBreakCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.PageBreakCollectionLoadOptions
