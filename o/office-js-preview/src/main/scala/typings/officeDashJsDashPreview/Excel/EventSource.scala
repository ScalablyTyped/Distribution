...
object EventSource extends js.Object {
  ...
  /* "Local" */ val local: typings.officeDashJsDashPreview.Excel.EventSource.local with String = js.native
  /* "Remote" */ val remote: typings.officeDashJsDashPreview.Excel.EventSource.remote with String = js.native
  @JSBracketAccess
