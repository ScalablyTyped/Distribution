...
import typings.officeDashJsDashPreview.Excel.Interfaces.ShapeLineFormatData
import typings.officeDashJsDashPreview.Excel.Interfaces.ShapeLineFormatLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.ShapeLineFormatUpdateData
