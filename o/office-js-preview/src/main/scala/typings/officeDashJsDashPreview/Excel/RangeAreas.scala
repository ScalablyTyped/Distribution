...
import typings.officeDashJsDashPreview.Excel.Interfaces.RangeAreasData
import typings.officeDashJsDashPreview.Excel.Interfaces.RangeAreasLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.RangeAreasUpdateData
