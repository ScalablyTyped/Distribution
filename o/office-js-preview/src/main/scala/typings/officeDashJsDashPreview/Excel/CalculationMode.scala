...
object CalculationMode extends js.Object {
  ...
  /* "Automatic" */ val automatic: typings.officeDashJsDashPreview.Excel.CalculationMode.automatic with String = js.native
  /* "AutomaticExceptTables" */ val automaticExceptTables: typings.officeDashJsDashPreview.Excel.CalculationMode.automaticExceptTables with String = js.native
  /* "Manual" */ val manual: typings.officeDashJsDashPreview.Excel.CalculationMode.manual with String = js.native
  @JSBracketAccess
