...
import typings.officeDashJsDashPreview.Excel.Interfaces.ChartTrendlineData
import typings.officeDashJsDashPreview.Excel.Interfaces.ChartTrendlineLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.ChartTrendlineUpdateData
