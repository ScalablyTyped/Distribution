...
import typings.officeDashJsDashPreview.Excel.Interfaces.PivotTableStyleData
import typings.officeDashJsDashPreview.Excel.Interfaces.PivotTableStyleLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.PivotTableStyleUpdateData
...
class PivotTableStyle () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): PivotTableStyle = js.native
