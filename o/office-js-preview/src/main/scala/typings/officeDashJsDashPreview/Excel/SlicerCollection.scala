...
import typings.officeDashJsDashPreview.Excel.Interfaces.SlicerCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.SlicerCollectionLoadOptions
