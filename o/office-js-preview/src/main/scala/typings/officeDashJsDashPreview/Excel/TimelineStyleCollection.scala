...
import typings.officeDashJsDashPreview.Excel.Interfaces.TimelineStyleCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.TimelineStyleCollectionLoadOptions
