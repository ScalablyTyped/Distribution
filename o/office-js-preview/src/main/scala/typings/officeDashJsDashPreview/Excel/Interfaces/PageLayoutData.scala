...
import typings.officeDashJsDashPreview.Excel.PageLayoutZoomOptions
import typings.officeDashJsDashPreview.Excel.PageOrientation
import typings.officeDashJsDashPreview.Excel.PaperType
import typings.officeDashJsDashPreview.Excel.PrintComments
import typings.officeDashJsDashPreview.Excel.PrintErrorType
import typings.officeDashJsDashPreview.Excel.PrintOrder
