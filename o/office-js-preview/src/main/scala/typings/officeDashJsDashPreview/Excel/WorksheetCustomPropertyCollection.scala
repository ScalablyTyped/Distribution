...
import typings.officeDashJsDashPreview.Excel.Interfaces.WorksheetCustomPropertyCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.WorksheetCustomPropertyCollectionLoadOptions
