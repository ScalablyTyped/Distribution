...
import typings.officeDashJsDashPreview.Excel.Interfaces.ChartTrendlineFormatData
import typings.officeDashJsDashPreview.Excel.Interfaces.ChartTrendlineFormatLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.ChartTrendlineFormatUpdateData
