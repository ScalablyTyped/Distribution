...
import typings.officeDashJsDashPreview.Excel.Interfaces.ShapeFillData
import typings.officeDashJsDashPreview.Excel.Interfaces.ShapeFillLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.ShapeFillUpdateData
...
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Gradient
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Mixed
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.NoFill
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Pattern
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.PictureAndTexture
...
class ShapeFill () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ShapeFill = js.native
