...
import typings.officeDashJsDashPreview.Excel.Interfaces.HeaderFooterGroupData
import typings.officeDashJsDashPreview.Excel.Interfaces.HeaderFooterGroupLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.HeaderFooterGroupUpdateData
