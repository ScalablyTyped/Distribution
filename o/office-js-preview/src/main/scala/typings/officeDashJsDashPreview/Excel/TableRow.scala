...
import typings.officeDashJsDashPreview.Excel.Interfaces.TableRowData
import typings.officeDashJsDashPreview.Excel.Interfaces.TableRowLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.TableRowUpdateData
