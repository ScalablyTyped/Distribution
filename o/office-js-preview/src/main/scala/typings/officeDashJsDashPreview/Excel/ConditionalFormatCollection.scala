...
import typings.officeDashJsDashPreview.Excel.Interfaces.ConditionalFormatCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.ConditionalFormatCollectionLoadOptions
...
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.CellValue
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.ColorScale
...
class ConditionalFormatCollection () extends ClientObject {
  ...
  @JSName("add")
  def add_IconSet(`type`: typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.IconSet): ConditionalFormat = js.native
  @JSName("add")
