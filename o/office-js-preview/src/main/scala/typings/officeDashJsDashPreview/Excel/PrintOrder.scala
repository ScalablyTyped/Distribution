...
object PrintOrder extends js.Object {
  ...
  /* "DownThenOver" */ val downThenOver: typings.officeDashJsDashPreview.Excel.PrintOrder.downThenOver with String = js.native
  /* "OverThenDown" */ val overThenDown: typings.officeDashJsDashPreview.Excel.PrintOrder.overThenDown with String = js.native
  @JSBracketAccess
