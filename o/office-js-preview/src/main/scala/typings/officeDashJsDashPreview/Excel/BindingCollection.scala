...
import typings.officeDashJsDashPreview.Excel.Interfaces.BindingCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.BindingCollectionLoadOptions
