...
import typings.officeDashJsDashPreview.Excel.Interfaces.FormatProtectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.FormatProtectionLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.FormatProtectionUpdateData
