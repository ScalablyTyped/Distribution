...
import typings.officeDashJsDashPreview.Excel.Interfaces.GroupShapeCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.GroupShapeCollectionLoadOptions
