...
import typings.officeDashJsDashPreview.Excel.Interfaces.SettingData
import typings.officeDashJsDashPreview.Excel.Interfaces.SettingLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.SettingUpdateData
