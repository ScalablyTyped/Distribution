...
import typings.officeDashJsDashPreview.Excel.Interfaces.PivotTableCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.PivotTableCollectionLoadOptions
