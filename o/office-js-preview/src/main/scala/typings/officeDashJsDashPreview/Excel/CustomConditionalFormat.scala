...
import typings.officeDashJsDashPreview.Excel.Interfaces.CustomConditionalFormatData
import typings.officeDashJsDashPreview.Excel.Interfaces.CustomConditionalFormatLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.CustomConditionalFormatUpdateData
