...
import typings.officeDashJsDashPreview.Excel.Interfaces.IconSetConditionalFormatData
import typings.officeDashJsDashPreview.Excel.Interfaces.IconSetConditionalFormatLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.IconSetConditionalFormatUpdateData
