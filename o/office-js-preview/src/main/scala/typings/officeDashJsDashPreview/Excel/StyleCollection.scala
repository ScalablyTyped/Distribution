...
import typings.officeDashJsDashPreview.Excel.Interfaces.StyleCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.StyleCollectionLoadOptions
