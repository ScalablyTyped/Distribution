...
import typings.officeDashJsDashPreview.Excel.ConditionalDataBarAxisFormat
import typings.officeDashJsDashPreview.Excel.ConditionalDataBarDirection
import typings.officeDashJsDashPreview.Excel.ConditionalDataBarRule
