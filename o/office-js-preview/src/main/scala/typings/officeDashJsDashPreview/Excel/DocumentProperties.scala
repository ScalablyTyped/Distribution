...
import typings.officeDashJsDashPreview.Excel.Interfaces.DocumentPropertiesData
import typings.officeDashJsDashPreview.Excel.Interfaces.DocumentPropertiesLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.DocumentPropertiesUpdateData
