...
import typings.officeDashJsDashPreview.Excel.Interfaces.ChartSeriesCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.ChartSeriesCollectionLoadOptions
