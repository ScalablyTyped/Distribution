...
import typings.officeDashJsDashPreview.Excel.Interfaces.TimelineStyleData
import typings.officeDashJsDashPreview.Excel.Interfaces.TimelineStyleLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.TimelineStyleUpdateData
