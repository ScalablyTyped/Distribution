...
object ClearApplyTo extends js.Object {
  ...
  /* "All" */ val all: typings.officeDashJsDashPreview.Excel.ClearApplyTo.all with String = js.native
  /* "Contents" */ val contents: typings.officeDashJsDashPreview.Excel.ClearApplyTo.contents with String = js.native
  /* "Formats" */ val formats: typings.officeDashJsDashPreview.Excel.ClearApplyTo.formats with String = js.native
  /* "Hyperlinks" */ val hyperlinks: typings.officeDashJsDashPreview.Excel.ClearApplyTo.hyperlinks with String = js.native
  /* "RemoveHyperlinks" */ val removeHyperlinks: typings.officeDashJsDashPreview.Excel.ClearApplyTo.removeHyperlinks with String = js.native
  @JSBracketAccess
