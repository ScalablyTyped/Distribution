...
object SortBy extends js.Object {
  ...
  /* "Ascending" */ val ascending: typings.officeDashJsDashPreview.Excel.SortBy.ascending with String = js.native
  /* "Descending" */ val descending: typings.officeDashJsDashPreview.Excel.SortBy.descending with String = js.native
  @JSBracketAccess
