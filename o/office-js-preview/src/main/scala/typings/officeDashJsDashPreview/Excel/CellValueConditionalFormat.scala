...
import typings.officeDashJsDashPreview.Excel.Interfaces.CellValueConditionalFormatData
import typings.officeDashJsDashPreview.Excel.Interfaces.CellValueConditionalFormatLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.CellValueConditionalFormatUpdateData
...
class CellValueConditionalFormat () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): CellValueConditionalFormat = js.native
