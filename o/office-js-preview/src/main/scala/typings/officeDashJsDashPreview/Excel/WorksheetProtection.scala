...
import typings.officeDashJsDashPreview.Excel.Interfaces.WorksheetProtectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.WorksheetProtectionLoadOptions
