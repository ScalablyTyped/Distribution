...
import typings.officeDashJsDashPreview.Excel.ConditionalDataBarAxisFormat.automatic
import typings.officeDashJsDashPreview.Excel.ConditionalDataBarAxisFormat.cellMidPoint
import typings.officeDashJsDashPreview.Excel.ConditionalDataBarAxisFormat.none
