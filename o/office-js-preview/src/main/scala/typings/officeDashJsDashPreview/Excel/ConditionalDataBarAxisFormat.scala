...
object ConditionalDataBarAxisFormat extends js.Object {
  ...
  /* "Automatic" */ val automatic: typings.officeDashJsDashPreview.Excel.ConditionalDataBarAxisFormat.automatic with String = js.native
  /* "CellMidPoint" */ val cellMidPoint: typings.officeDashJsDashPreview.Excel.ConditionalDataBarAxisFormat.cellMidPoint with String = js.native
  /* "None" */ val none: typings.officeDashJsDashPreview.Excel.ConditionalDataBarAxisFormat.none with String = js.native
  @JSBracketAccess
