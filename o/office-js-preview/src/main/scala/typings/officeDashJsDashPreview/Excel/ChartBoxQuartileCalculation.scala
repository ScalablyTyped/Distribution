...
import typings.officeDashJsDashPreview.Excel.ChartBoxQuartileCalculation.exclusive
import typings.officeDashJsDashPreview.Excel.ChartBoxQuartileCalculation.inclusive
