...
import typings.officeDashJsDashPreview.Excel.Interfaces.NamedItemArrayValuesData
import typings.officeDashJsDashPreview.Excel.Interfaces.NamedItemArrayValuesLoadOptions
