...
import typings.officeDashJsDashPreview.Excel.Interfaces.WorksheetCustomPropertyData
import typings.officeDashJsDashPreview.Excel.Interfaces.WorksheetCustomPropertyLoadOptions
...
class WorksheetCustomProperty () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): WorksheetCustomProperty = js.native
