...
import typings.officeDashJsDashPreview.Excel.Interfaces.NamedItemData
import typings.officeDashJsDashPreview.Excel.Interfaces.NamedItemLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.NamedItemUpdateData
