...
import typings.officeDashJsDashPreview.Excel.Interfaces.RangeBorderCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.RangeBorderCollectionLoadOptions
