...
import typings.officeDashJsDashPreview.Excel.Interfaces.SettingCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.SettingCollectionLoadOptions
