...
import typings.officeDashJsDashPreview.Excel.ChartSeriesBy.auto
import typings.officeDashJsDashPreview.Excel.ChartSeriesBy.columns
import typings.officeDashJsDashPreview.Excel.ChartSeriesBy.rows
