...
import typings.officeDashJsDashPreview.Excel.Interfaces.ConditionalRangeBorderData
import typings.officeDashJsDashPreview.Excel.Interfaces.ConditionalRangeBorderLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.ConditionalRangeBorderUpdateData
