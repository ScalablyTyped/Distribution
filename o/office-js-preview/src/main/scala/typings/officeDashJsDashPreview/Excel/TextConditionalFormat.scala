...
import typings.officeDashJsDashPreview.Excel.Interfaces.TextConditionalFormatData
import typings.officeDashJsDashPreview.Excel.Interfaces.TextConditionalFormatLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.TextConditionalFormatUpdateData
