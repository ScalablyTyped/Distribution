...
import typings.officeDashJsDashPreview.Excel.HorizontalAlignment
import typings.officeDashJsDashPreview.Excel.ReadingOrder
import typings.officeDashJsDashPreview.Excel.VerticalAlignment
