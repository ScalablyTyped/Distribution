...
object ShapeScaleType extends js.Object {
  ...
  /* "CurrentSize" */ val currentSize: typings.officeDashJsDashPreview.Excel.ShapeScaleType.currentSize with String = js.native
  /* "OriginalSize" */ val originalSize: typings.officeDashJsDashPreview.Excel.ShapeScaleType.originalSize with String = js.native
  @JSBracketAccess
