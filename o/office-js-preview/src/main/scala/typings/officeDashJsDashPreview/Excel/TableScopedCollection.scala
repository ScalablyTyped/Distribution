...
import typings.officeDashJsDashPreview.Excel.Interfaces.TableScopedCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.TableScopedCollectionLoadOptions
