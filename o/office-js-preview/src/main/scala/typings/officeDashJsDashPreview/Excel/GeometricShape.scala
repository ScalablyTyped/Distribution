...
import typings.officeDashJsDashPreview.Excel.Interfaces.GeometricShapeData
import typings.officeDashJsDashPreview.Excel.Interfaces.GeometricShapeLoadOptions
...
class GeometricShape () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): GeometricShape = js.native
