...
import typings.officeDashJsDashPreview.Excel.Interfaces.DataBarConditionalFormatData
import typings.officeDashJsDashPreview.Excel.Interfaces.DataBarConditionalFormatLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.DataBarConditionalFormatUpdateData
...
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.CellMidPoint
...
class DataBarConditionalFormat () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): DataBarConditionalFormat = js.native
