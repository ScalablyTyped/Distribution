...
import typings.officeDashJsDashPreview.Excel.Interfaces.StyleData
import typings.officeDashJsDashPreview.Excel.Interfaces.StyleLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.StyleUpdateData
