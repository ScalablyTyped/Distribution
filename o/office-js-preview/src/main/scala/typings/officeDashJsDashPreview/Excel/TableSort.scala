...
import typings.officeDashJsDashPreview.Excel.Interfaces.TableSortData
import typings.officeDashJsDashPreview.Excel.Interfaces.TableSortLoadOptions
import typings.officeDashJsDashPreview.OfficeExtension.ClientObject
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.PinYin
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.StrokeCount
...
class TableSort () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): TableSort = js.native
