...
object ChartParentLabelStrategy extends js.Object {
  ...
  /* "Banner" */ val banner: typings.officeDashJsDashPreview.Excel.ChartParentLabelStrategy.banner with String = js.native
  /* "None" */ val none: typings.officeDashJsDashPreview.Excel.ChartParentLabelStrategy.none with String = js.native
  /* "Overlapping" */ val overlapping: typings.officeDashJsDashPreview.Excel.ChartParentLabelStrategy.overlapping with String = js.native
  @JSBracketAccess
