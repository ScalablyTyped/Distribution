...
object ConditionalIconCriterionOperator extends js.Object {
  ...
  /* "GreaterThan" */ val greaterThan: typings.officeDashJsDashPreview.Excel.ConditionalIconCriterionOperator.greaterThan with String = js.native
  /* "GreaterThanOrEqual" */ val greaterThanOrEqual: typings.officeDashJsDashPreview.Excel.ConditionalIconCriterionOperator.greaterThanOrEqual with String = js.native
  /* "Invalid" */ val invalid: typings.officeDashJsDashPreview.Excel.ConditionalIconCriterionOperator.invalid with String = js.native
  @JSBracketAccess
