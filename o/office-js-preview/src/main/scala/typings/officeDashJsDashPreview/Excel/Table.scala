...
import typings.officeDashJsDashPreview.Excel.Interfaces.TableData
import typings.officeDashJsDashPreview.Excel.Interfaces.TableLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.TableUpdateData
