...
import typings.officeDashJsDashPreview.Excel.Interfaces.FunctionResultData
import typings.officeDashJsDashPreview.Excel.Interfaces.FunctionResultLoadOptions
