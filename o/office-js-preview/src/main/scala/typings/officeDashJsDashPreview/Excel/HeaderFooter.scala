...
import typings.officeDashJsDashPreview.Excel.Interfaces.HeaderFooterData
import typings.officeDashJsDashPreview.Excel.Interfaces.HeaderFooterLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.HeaderFooterUpdateData
