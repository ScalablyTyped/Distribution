...
import typings.officeDashJsDashPreview.Excel.Interfaces.NumberFormatInfoData
import typings.officeDashJsDashPreview.Excel.Interfaces.NumberFormatInfoLoadOptions
...
class NumberFormatInfo () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): NumberFormatInfo = js.native
