...
import typings.officeDashJsDashPreview.Excel.Interfaces.SlicerData
import typings.officeDashJsDashPreview.Excel.Interfaces.SlicerLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.SlicerUpdateData
