...
import typings.officeDashJsDashPreview.Excel.Interfaces.TableColumnCollectionData
import typings.officeDashJsDashPreview.Excel.Interfaces.TableColumnCollectionLoadOptions
