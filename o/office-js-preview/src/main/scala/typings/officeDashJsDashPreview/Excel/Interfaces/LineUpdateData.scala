...
import typings.officeDashJsDashPreview.Excel.ArrowheadLength
import typings.officeDashJsDashPreview.Excel.ArrowheadStyle
import typings.officeDashJsDashPreview.Excel.ArrowheadWidth
import typings.officeDashJsDashPreview.Excel.ConnectorType
