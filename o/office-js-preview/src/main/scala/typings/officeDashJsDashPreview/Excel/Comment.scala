...
import typings.officeDashJsDashPreview.Excel.Interfaces.CommentData
import typings.officeDashJsDashPreview.Excel.Interfaces.CommentLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.CommentUpdateData
...
class Comment () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): Comment = js.native
