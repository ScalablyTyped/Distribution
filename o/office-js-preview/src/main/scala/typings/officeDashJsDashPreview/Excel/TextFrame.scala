...
import typings.officeDashJsDashPreview.Excel.Interfaces.TextFrameData
import typings.officeDashJsDashPreview.Excel.Interfaces.TextFrameLoadOptions
import typings.officeDashJsDashPreview.Excel.Interfaces.TextFrameUpdateData
