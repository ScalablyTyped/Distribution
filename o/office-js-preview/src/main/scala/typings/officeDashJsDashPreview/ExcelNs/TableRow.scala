...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableRowData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableRowLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableRowUpdateData
