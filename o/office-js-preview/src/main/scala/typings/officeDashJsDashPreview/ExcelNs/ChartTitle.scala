...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartTitleData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartTitleLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartTitleUpdateData
...
class ChartTitle () extends ClientObject {
  ...
  def load(option: String): ChartTitle = js.native
  def load(option: js.Array[String]): ChartTitle = js.native
  def load(option: Anon_Expand): ChartTitle = js.native
  def load(option: ChartTitleLoadOptions): ChartTitle = js.native
