...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotTableStyleCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotTableStyleCollectionLoadOptions
...
class PivotTableStyleCollection () extends ClientObject {
  ...
  def load(option: PivotTableStyleCollectionLoadOptions with CollectionLoadOptions): PivotTableStyleCollection = js.native
  def load(option: String): PivotTableStyleCollection = js.native
  def load(option: js.Array[String]): PivotTableStyleCollection = js.native
  def load(option: LoadOption): PivotTableStyleCollection = js.native
