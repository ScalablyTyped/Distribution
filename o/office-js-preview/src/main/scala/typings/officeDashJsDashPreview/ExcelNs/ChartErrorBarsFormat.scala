...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartErrorBarsFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartErrorBarsFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartErrorBarsFormatUpdateData
...
class ChartErrorBarsFormat () extends ClientObject {
  ...
  def load(option: String): ChartErrorBarsFormat = js.native
  def load(option: js.Array[String]): ChartErrorBarsFormat = js.native
  def load(option: Anon_Expand): ChartErrorBarsFormat = js.native
  def load(option: ChartErrorBarsFormatLoadOptions): ChartErrorBarsFormat = js.native
