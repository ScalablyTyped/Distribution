...
object Placement extends js.Object {
  ...
  /* "Absolute" */ val absolute: typings.officeDashJsDashPreview.ExcelNs.Placement.absolute with String = js.native
  /* "OneCell" */ val oneCell: typings.officeDashJsDashPreview.ExcelNs.Placement.oneCell with String = js.native
  /* "TwoCell" */ val twoCell: typings.officeDashJsDashPreview.ExcelNs.Placement.twoCell with String = js.native
  @JSBracketAccess
