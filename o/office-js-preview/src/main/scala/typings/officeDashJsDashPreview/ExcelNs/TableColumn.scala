...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableColumnData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableColumnLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableColumnUpdateData
...
class TableColumn () extends ClientObject {
  ...
  def load(option: String): TableColumn = js.native
  def load(option: js.Array[String]): TableColumn = js.native
  def load(option: Anon_Expand): TableColumn = js.native
  def load(option: TableColumnLoadOptions): TableColumn = js.native
