...
object FilterOperator extends js.Object {
  ...
  /* "And" */ val and: typings.officeDashJsDashPreview.ExcelNs.FilterOperator.and with String = js.native
  /* "Or" */ val or: typings.officeDashJsDashPreview.ExcelNs.FilterOperator.or with String = js.native
  @JSBracketAccess
