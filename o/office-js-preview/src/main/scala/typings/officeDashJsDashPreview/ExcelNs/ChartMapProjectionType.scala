...
object ChartMapProjectionType extends js.Object {
  ...
  /* "Albers" */ val albers: typings.officeDashJsDashPreview.ExcelNs.ChartMapProjectionType.albers with String = js.native
  /* "Automatic" */ val automatic: typings.officeDashJsDashPreview.ExcelNs.ChartMapProjectionType.automatic with String = js.native
  /* "Mercator" */ val mercator: typings.officeDashJsDashPreview.ExcelNs.ChartMapProjectionType.mercator with String = js.native
  /* "Miller" */ val miller: typings.officeDashJsDashPreview.ExcelNs.ChartMapProjectionType.miller with String = js.native
  /* "Robinson" */ val robinson: typings.officeDashJsDashPreview.ExcelNs.ChartMapProjectionType.robinson with String = js.native
  @JSBracketAccess
