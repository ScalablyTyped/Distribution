...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalFormatCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalFormatCollectionLoadOptions
...
class ConditionalFormatCollection () extends ClientObject {
  ...
  def load(option: ConditionalFormatCollectionLoadOptions with CollectionLoadOptions): ConditionalFormatCollection = js.native
  def load(option: String): ConditionalFormatCollection = js.native
  def load(option: js.Array[String]): ConditionalFormatCollection = js.native
  def load(option: LoadOption): ConditionalFormatCollection = js.native
  /**
