...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotLayoutData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotLayoutLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotLayoutUpdateData
...
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Column
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Compact
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Data
...
class PivotLayout () extends ClientObject {
  ...
  @JSName("getPivotItems")
  def getPivotItems_Filter(axis: typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Filter, cell: String): ClientResult[js.Array[PivotItem]] = js.native
  @JSName("getPivotItems")
  def getPivotItems_Filter(axis: typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Filter, cell: Range): ClientResult[js.Array[PivotItem]] = js.native
  @JSName("getPivotItems")
  ...
  def load(option: String): PivotLayout = js.native
  def load(option: js.Array[String]): PivotLayout = js.native
  def load(option: Anon_Expand): PivotLayout = js.native
  def load(option: PivotLayoutLoadOptions): PivotLayout = js.native
