...
class ChartSeries () extends ClientObject {
  ...
  def load(option: String): ChartSeries = js.native
  def load(option: js.Array[String]): ChartSeries = js.native
  def load(option: Anon_Expand): ChartSeries = js.native
  def load(option: ChartSeriesLoadOptions): ChartSeries = js.native
