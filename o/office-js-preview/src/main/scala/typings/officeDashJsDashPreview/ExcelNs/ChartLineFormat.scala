...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartLineFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartLineFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartLineFormatUpdateData
...
class ChartLineFormat () extends ClientObject {
  ...
  def load(option: String): ChartLineFormat = js.native
  def load(option: js.Array[String]): ChartLineFormat = js.native
  def load(option: Anon_Expand): ChartLineFormat = js.native
  def load(option: ChartLineFormatLoadOptions): ChartLineFormat = js.native
