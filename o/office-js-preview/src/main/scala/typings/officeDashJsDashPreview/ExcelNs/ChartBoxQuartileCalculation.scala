...
object ChartBoxQuartileCalculation extends js.Object {
  ...
  /* "Exclusive" */ val exclusive: typings.officeDashJsDashPreview.ExcelNs.ChartBoxQuartileCalculation.exclusive with String = js.native
  /* "Inclusive" */ val inclusive: typings.officeDashJsDashPreview.ExcelNs.ChartBoxQuartileCalculation.inclusive with String = js.native
  @JSBracketAccess
