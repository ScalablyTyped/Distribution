...
object PivotLayoutType extends js.Object {
  ...
  /* "Compact" */ val compact: typings.officeDashJsDashPreview.ExcelNs.PivotLayoutType.compact with String = js.native
  /* "Outline" */ val outline: typings.officeDashJsDashPreview.ExcelNs.PivotLayoutType.outline with String = js.native
  /* "Tabular" */ val tabular: typings.officeDashJsDashPreview.ExcelNs.PivotLayoutType.tabular with String = js.native
  @JSBracketAccess
