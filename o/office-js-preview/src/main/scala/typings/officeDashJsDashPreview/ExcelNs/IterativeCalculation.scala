...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.IterativeCalculationData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.IterativeCalculationLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.IterativeCalculationUpdateData
...
class IterativeCalculation () extends ClientObject {
  ...
  def load(option: String): IterativeCalculation = js.native
  def load(option: js.Array[String]): IterativeCalculation = js.native
  def load(option: Anon_Expand): IterativeCalculation = js.native
  def load(option: IterativeCalculationLoadOptions): IterativeCalculation = js.native
