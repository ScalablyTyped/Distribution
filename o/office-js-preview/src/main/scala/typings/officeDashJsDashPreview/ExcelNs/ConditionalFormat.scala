...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalFormatUpdateData
...
class ConditionalFormat () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.6]
    */
  val `type`: ConditionalFormatType | Custom | DataBar | ColorScale | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.IconSet | TopBottom | PresetCriteria | ContainsText | CellValue = js.native
  /**
    *
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ConditionalFormat = js.native
