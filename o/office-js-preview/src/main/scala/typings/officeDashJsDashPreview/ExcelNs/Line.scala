...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.LineData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.LineLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.LineUpdateData
...
class Line () extends ClientObject {
  ...
  def load(option: String): Line = js.native
  def load(option: js.Array[String]): Line = js.native
  def load(option: Anon_Expand): Line = js.native
  def load(option: LineLoadOptions): Line = js.native
