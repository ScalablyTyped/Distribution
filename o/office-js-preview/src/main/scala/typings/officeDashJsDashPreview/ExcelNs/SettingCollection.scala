...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SettingCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SettingCollectionLoadOptions
