...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalDataBarPositiveFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalDataBarPositiveFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalDataBarPositiveFormatUpdateData
...
class ConditionalDataBarPositiveFormat () extends ClientObject {
  ...
  def load(option: String): ConditionalDataBarPositiveFormat = js.native
  def load(option: js.Array[String]): ConditionalDataBarPositiveFormat = js.native
  def load(option: Anon_Expand): ConditionalDataBarPositiveFormat = js.native
  def load(option: ConditionalDataBarPositiveFormatLoadOptions): ConditionalDataBarPositiveFormat = js.native
