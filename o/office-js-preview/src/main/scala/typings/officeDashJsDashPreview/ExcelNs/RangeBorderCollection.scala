...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RangeBorderCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RangeBorderCollectionLoadOptions
...
class RangeBorderCollection () extends ClientObject {
  ...
  def load(option: RangeBorderCollectionLoadOptions with CollectionLoadOptions): RangeBorderCollection = js.native
  def load(option: String): RangeBorderCollection = js.native
  def load(option: js.Array[String]): RangeBorderCollection = js.native
  def load(option: LoadOption): RangeBorderCollection = js.native
  /**
