...
object PrintMarginUnit extends js.Object {
  ...
  /* "Centimeters" */ val centimeters: typings.officeDashJsDashPreview.ExcelNs.PrintMarginUnit.centimeters with String = js.native
  /* "Inches" */ val inches: typings.officeDashJsDashPreview.ExcelNs.PrintMarginUnit.inches with String = js.native
  /* "Points" */ val points: typings.officeDashJsDashPreview.ExcelNs.PrintMarginUnit.points with String = js.native
  @JSBracketAccess
