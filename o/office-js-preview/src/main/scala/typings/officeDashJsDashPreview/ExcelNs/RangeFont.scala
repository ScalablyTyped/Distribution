...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RangeFontData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RangeFontLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RangeFontUpdateData
...
class RangeFont () extends ClientObject {
  ...
  def load(option: String): RangeFont = js.native
  def load(option: js.Array[String]): RangeFont = js.native
  def load(option: Anon_Expand): RangeFont = js.native
  def load(option: RangeFontLoadOptions): RangeFont = js.native
