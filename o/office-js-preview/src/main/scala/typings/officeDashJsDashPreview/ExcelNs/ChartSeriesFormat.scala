...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartSeriesFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartSeriesFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartSeriesFormatUpdateData
...
class ChartSeriesFormat () extends ClientObject {
  ...
  def load(option: String): ChartSeriesFormat = js.native
  def load(option: js.Array[String]): ChartSeriesFormat = js.native
  def load(option: Anon_Expand): ChartSeriesFormat = js.native
  def load(option: ChartSeriesFormatLoadOptions): ChartSeriesFormat = js.native
