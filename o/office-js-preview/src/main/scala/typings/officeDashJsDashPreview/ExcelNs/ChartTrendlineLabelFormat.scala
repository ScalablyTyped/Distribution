...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartTrendlineLabelFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartTrendlineLabelFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartTrendlineLabelFormatUpdateData
...
class ChartTrendlineLabelFormat () extends ClientObject {
  ...
  def load(option: String): ChartTrendlineLabelFormat = js.native
  def load(option: js.Array[String]): ChartTrendlineLabelFormat = js.native
  def load(option: Anon_Expand): ChartTrendlineLabelFormat = js.native
  def load(option: ChartTrendlineLabelFormatLoadOptions): ChartTrendlineLabelFormat = js.native
