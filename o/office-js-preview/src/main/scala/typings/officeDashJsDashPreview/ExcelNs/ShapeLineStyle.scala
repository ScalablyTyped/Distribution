...
object ShapeLineStyle extends js.Object {
  ...
  /* "Single" */ val single: typings.officeDashJsDashPreview.ExcelNs.ShapeLineStyle.single with String = js.native
  /* "ThickBetweenThin" */ val thickBetweenThin: typings.officeDashJsDashPreview.ExcelNs.ShapeLineStyle.thickBetweenThin with String = js.native
  /* "ThickThin" */ val thickThin: typings.officeDashJsDashPreview.ExcelNs.ShapeLineStyle.thickThin with String = js.native
  /* "ThinThick" */ val thinThick: typings.officeDashJsDashPreview.ExcelNs.ShapeLineStyle.thinThick with String = js.native
  /* "ThinThin" */ val thinThin: typings.officeDashJsDashPreview.ExcelNs.ShapeLineStyle.thinThin with String = js.native
  @JSBracketAccess
