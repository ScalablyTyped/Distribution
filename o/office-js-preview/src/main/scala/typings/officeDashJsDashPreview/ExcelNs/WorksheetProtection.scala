...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.WorksheetProtectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.WorksheetProtectionLoadOptions
...
class WorksheetProtection () extends ClientObject {
  ...
  def load(option: String): WorksheetProtection = js.native
  def load(option: js.Array[String]): WorksheetProtection = js.native
  def load(option: Anon_Expand): WorksheetProtection = js.native
  def load(option: WorksheetProtectionLoadOptions): WorksheetProtection = js.native
  /**
    *
