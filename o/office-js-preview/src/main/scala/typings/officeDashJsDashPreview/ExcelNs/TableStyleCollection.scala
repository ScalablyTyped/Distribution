...
class TableStyleCollection () extends ClientObject {
  ...
  def load(option: TableStyleCollectionLoadOptions with CollectionLoadOptions): TableStyleCollection = js.native
  def load(option: String): TableStyleCollection = js.native
  def load(option: js.Array[String]): TableStyleCollection = js.native
  def load(option: LoadOption): TableStyleCollection = js.native
