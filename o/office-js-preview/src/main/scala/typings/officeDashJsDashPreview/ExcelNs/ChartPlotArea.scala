...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartPlotAreaData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartPlotAreaLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartPlotAreaUpdateData
...
class ChartPlotArea () extends ClientObject {
  ...
  def load(option: String): ChartPlotArea = js.native
  def load(option: js.Array[String]): ChartPlotArea = js.native
  def load(option: Anon_Expand): ChartPlotArea = js.native
  def load(option: ChartPlotAreaLoadOptions): ChartPlotArea = js.native
