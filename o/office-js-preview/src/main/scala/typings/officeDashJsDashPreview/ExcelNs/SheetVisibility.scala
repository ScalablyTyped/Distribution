...
object SheetVisibility extends js.Object {
  ...
  /* "Hidden" */ val hidden: typings.officeDashJsDashPreview.ExcelNs.SheetVisibility.hidden with String = js.native
  /* "VeryHidden" */ val veryHidden: typings.officeDashJsDashPreview.ExcelNs.SheetVisibility.veryHidden with String = js.native
  /* "Visible" */ val visible: typings.officeDashJsDashPreview.ExcelNs.SheetVisibility.visible with String = js.native
  @JSBracketAccess
