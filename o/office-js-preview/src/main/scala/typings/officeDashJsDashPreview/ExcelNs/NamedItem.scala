...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.NamedItemData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.NamedItemLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.NamedItemUpdateData
...
class NamedItem () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.4]
    */
  val scope: NamedItemScope | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Worksheet | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Workbook = js.native
  /**
    *
    ...
    */
  val `type`: NamedItemType | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.String | Integer | Double | Boolean | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Range | Error | Array = js.native
  /**
    *
