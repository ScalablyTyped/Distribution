...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RangeViewData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RangeViewLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RangeViewUpdateData
...
class RangeView () extends ClientObject {
  ...
  def load(option: String): RangeView = js.native
  def load(option: js.Array[String]): RangeView = js.native
  def load(option: Anon_Expand): RangeView = js.native
  def load(option: RangeViewLoadOptions): RangeView = js.native
