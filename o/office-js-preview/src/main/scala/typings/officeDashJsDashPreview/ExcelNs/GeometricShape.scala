...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.GeometricShapeData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.GeometricShapeLoadOptions
