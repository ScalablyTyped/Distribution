...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalRangeFillData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalRangeFillLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalRangeFillUpdateData
...
class ConditionalRangeFill () extends ClientObject {
  ...
  def load(option: String): ConditionalRangeFill = js.native
  def load(option: js.Array[String]): ConditionalRangeFill = js.native
  def load(option: Anon_Expand): ConditionalRangeFill = js.native
  def load(option: ConditionalRangeFillLoadOptions): ConditionalRangeFill = js.native
