...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RangeAreasData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RangeAreasLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RangeAreasUpdateData
