...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotTableStyleData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotTableStyleLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotTableStyleUpdateData
...
class PivotTableStyle () extends ClientObject {
  ...
  def load(option: String): PivotTableStyle = js.native
  def load(option: js.Array[String]): PivotTableStyle = js.native
  def load(option: Anon_Expand): PivotTableStyle = js.native
  def load(option: PivotTableStyleLoadOptions): PivotTableStyle = js.native
