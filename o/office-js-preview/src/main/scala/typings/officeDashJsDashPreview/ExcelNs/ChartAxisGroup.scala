...
object ChartAxisGroup extends js.Object {
  ...
  /* "Primary" */ val primary: typings.officeDashJsDashPreview.ExcelNs.ChartAxisGroup.primary with String = js.native
  /* "Secondary" */ val secondary: typings.officeDashJsDashPreview.ExcelNs.ChartAxisGroup.secondary with String = js.native
  @JSBracketAccess
