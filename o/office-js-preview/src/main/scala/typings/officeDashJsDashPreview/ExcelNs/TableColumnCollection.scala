...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableColumnCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableColumnCollectionLoadOptions
...
class TableColumnCollection () extends ClientObject {
  ...
  def load(option: TableColumnCollectionLoadOptions with CollectionLoadOptions): TableColumnCollection = js.native
  def load(option: String): TableColumnCollection = js.native
  def load(option: js.Array[String]): TableColumnCollection = js.native
  def load(option: LoadOption): TableColumnCollection = js.native
  /**
