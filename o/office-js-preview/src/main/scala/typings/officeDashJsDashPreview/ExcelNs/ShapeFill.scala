...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ShapeFillData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ShapeFillLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ShapeFillUpdateData
