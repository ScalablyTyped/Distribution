...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartFontData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartFontLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartFontUpdateData
...
class ChartFont () extends ClientObject {
  ...
  def load(option: String): ChartFont = js.native
  def load(option: js.Array[String]): ChartFont = js.native
  def load(option: Anon_Expand): ChartFont = js.native
  def load(option: ChartFontLoadOptions): ChartFont = js.native
