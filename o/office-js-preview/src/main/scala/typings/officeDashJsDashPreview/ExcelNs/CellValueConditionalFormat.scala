...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CellValueConditionalFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CellValueConditionalFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CellValueConditionalFormatUpdateData
...
class CellValueConditionalFormat () extends ClientObject {
  ...
  def load(option: String): CellValueConditionalFormat = js.native
  def load(option: js.Array[String]): CellValueConditionalFormat = js.native
  def load(option: Anon_Expand): CellValueConditionalFormat = js.native
  def load(option: CellValueConditionalFormatLoadOptions): CellValueConditionalFormat = js.native
