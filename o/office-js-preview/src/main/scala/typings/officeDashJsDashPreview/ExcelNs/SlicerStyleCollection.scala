...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerStyleCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerStyleCollectionLoadOptions
...
class SlicerStyleCollection () extends ClientObject {
  ...
  def load(option: SlicerStyleCollectionLoadOptions with CollectionLoadOptions): SlicerStyleCollection = js.native
  def load(option: String): SlicerStyleCollection = js.native
  def load(option: js.Array[String]): SlicerStyleCollection = js.native
  def load(option: LoadOption): SlicerStyleCollection = js.native
