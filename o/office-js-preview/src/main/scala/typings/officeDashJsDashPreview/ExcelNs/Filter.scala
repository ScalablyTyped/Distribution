...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.FilterData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.FilterLoadOptions
...
class Filter () extends ClientObject {
  ...
  def load(option: String): Filter = js.native
  def load(option: js.Array[String]): Filter = js.native
  def load(option: Anon_Expand): Filter = js.native
  def load(option: FilterLoadOptions): Filter = js.native
  /**
