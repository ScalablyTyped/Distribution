...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerStyleData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerStyleLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerStyleUpdateData
...
class SlicerStyle () extends ClientObject {
  ...
  def load(option: String): SlicerStyle = js.native
  def load(option: js.Array[String]): SlicerStyle = js.native
  def load(option: Anon_Expand): SlicerStyle = js.native
  def load(option: SlicerStyleLoadOptions): SlicerStyle = js.native
