...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.WorkbookProtectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.WorkbookProtectionLoadOptions
...
class WorkbookProtection () extends ClientObject {
  ...
  def load(option: String): WorkbookProtection = js.native
  def load(option: js.Array[String]): WorkbookProtection = js.native
  def load(option: Anon_Expand): WorkbookProtection = js.native
  def load(option: WorkbookProtectionLoadOptions): WorkbookProtection = js.native
  /**
    *
