...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartPointFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartPointFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartPointFormatUpdateData
...
class ChartPointFormat () extends ClientObject {
  ...
  def load(option: String): ChartPointFormat = js.native
  def load(option: js.Array[String]): ChartPointFormat = js.native
  def load(option: Anon_Expand): ChartPointFormat = js.native
  def load(option: ChartPointFormatLoadOptions): ChartPointFormat = js.native
