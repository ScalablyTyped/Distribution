...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableUpdateData
