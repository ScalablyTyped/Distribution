...
object ConditionalFormatDirection extends js.Object {
  ...
  /* "Bottom" */ val bottom: typings.officeDashJsDashPreview.ExcelNs.ConditionalFormatDirection.bottom with String = js.native
  /* "Top" */ val top: typings.officeDashJsDashPreview.ExcelNs.ConditionalFormatDirection.top with String = js.native
  @JSBracketAccess
