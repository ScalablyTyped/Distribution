...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CustomXmlPartScopedCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CustomXmlPartScopedCollectionLoadOptions
