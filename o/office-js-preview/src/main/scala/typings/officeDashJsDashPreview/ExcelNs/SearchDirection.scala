...
object SearchDirection extends js.Object {
  ...
  /* "Backwards" */ val backwards: typings.officeDashJsDashPreview.ExcelNs.SearchDirection.backwards with String = js.native
  /* "Forward" */ val forward: typings.officeDashJsDashPreview.ExcelNs.SearchDirection.forward with String = js.native
  @JSBracketAccess
