...
object ChartGradientStyle extends js.Object {
  ...
  /* "ThreePhaseColor" */ val threePhaseColor: typings.officeDashJsDashPreview.ExcelNs.ChartGradientStyle.threePhaseColor with String = js.native
  /* "TwoPhaseColor" */ val twoPhaseColor: typings.officeDashJsDashPreview.ExcelNs.ChartGradientStyle.twoPhaseColor with String = js.native
  @JSBracketAccess
