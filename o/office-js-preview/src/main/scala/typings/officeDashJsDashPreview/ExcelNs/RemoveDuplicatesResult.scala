...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RemoveDuplicatesResultData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RemoveDuplicatesResultLoadOptions
...
class RemoveDuplicatesResult () extends ClientObject {
  ...
  def load(option: String): RemoveDuplicatesResult = js.native
  def load(option: js.Array[String]): RemoveDuplicatesResult = js.native
  def load(option: Anon_Expand): RemoveDuplicatesResult = js.native
  def load(option: RemoveDuplicatesResultLoadOptions): RemoveDuplicatesResult = js.native
  /**
