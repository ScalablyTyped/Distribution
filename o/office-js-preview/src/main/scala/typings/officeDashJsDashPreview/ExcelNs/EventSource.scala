...
object EventSource extends js.Object {
  ...
  /* "Local" */ val local: typings.officeDashJsDashPreview.ExcelNs.EventSource.local with String = js.native
  /* "Remote" */ val remote: typings.officeDashJsDashPreview.ExcelNs.EventSource.remote with String = js.native
  @JSBracketAccess
