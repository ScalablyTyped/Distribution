...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotFieldData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotFieldLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotFieldUpdateData
...
class PivotField () extends ClientObject {
  ...
  def load(option: String): PivotField = js.native
  def load(option: js.Array[String]): PivotField = js.native
  def load(option: Anon_Expand): PivotField = js.native
  def load(option: PivotFieldLoadOptions): PivotField = js.native
