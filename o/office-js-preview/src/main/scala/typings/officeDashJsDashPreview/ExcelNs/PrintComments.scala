...
object PrintComments extends js.Object {
  ...
  /* "EndSheet" */ val endSheet: typings.officeDashJsDashPreview.ExcelNs.PrintComments.endSheet with String = js.native
  /* "InPlace" */ val inPlace: typings.officeDashJsDashPreview.ExcelNs.PrintComments.inPlace with String = js.native
  /* "NoComments" */ val noComments: typings.officeDashJsDashPreview.ExcelNs.PrintComments.noComments with String = js.native
  @JSBracketAccess
