...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartLegendEntryCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartLegendEntryCollectionLoadOptions
...
class ChartLegendEntryCollection () extends ClientObject {
  ...
  def load(option: ChartLegendEntryCollectionLoadOptions with CollectionLoadOptions): ChartLegendEntryCollection = js.native
  def load(option: String): ChartLegendEntryCollection = js.native
  def load(option: js.Array[String]): ChartLegendEntryCollection = js.native
  def load(option: LoadOption): ChartLegendEntryCollection = js.native
  /**
