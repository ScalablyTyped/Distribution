...
object ArrowheadWidth extends js.Object {
  ...
  /* "Medium" */ val medium: typings.officeDashJsDashPreview.ExcelNs.ArrowheadWidth.medium with String = js.native
  /* "Narrow" */ val narrow: typings.officeDashJsDashPreview.ExcelNs.ArrowheadWidth.narrow with String = js.native
  /* "Wide" */ val wide: typings.officeDashJsDashPreview.ExcelNs.ArrowheadWidth.wide with String = js.native
  @JSBracketAccess
