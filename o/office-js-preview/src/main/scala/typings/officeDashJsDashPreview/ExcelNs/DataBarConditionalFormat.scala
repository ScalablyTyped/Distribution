...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.DataBarConditionalFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.DataBarConditionalFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.DataBarConditionalFormatUpdateData
