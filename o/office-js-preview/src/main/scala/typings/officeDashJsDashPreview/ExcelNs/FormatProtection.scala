...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.FormatProtectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.FormatProtectionLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.FormatProtectionUpdateData
...
class FormatProtection () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): FormatProtection = js.native
