...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.BindingCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.BindingCollectionLoadOptions
...
class BindingCollection () extends ClientObject {
  ...
  def addFromNamedItem_Range(
    name: String,
    bindingType: typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Range,
    id: String
  ): Binding = js.native
  @JSName("addFromNamedItem")
  def addFromNamedItem_Table(
    name: String,
    bindingType: typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Table,
    id: String
  ): Binding = js.native
  @JSName("addFromNamedItem")
  ...
  def addFromSelection_Range(bindingType: typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Range, id: String): Binding = js.native
  @JSName("addFromSelection")
  def addFromSelection_Table(bindingType: typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Table, id: String): Binding = js.native
  @JSName("addFromSelection")
