...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartFormatStringData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartFormatStringLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartFormatStringUpdateData
...
class ChartFormatString () extends ClientObject {
  ...
  def load(option: String): ChartFormatString = js.native
  def load(option: js.Array[String]): ChartFormatString = js.native
  def load(option: Anon_Expand): ChartFormatString = js.native
  def load(option: ChartFormatStringLoadOptions): ChartFormatString = js.native
