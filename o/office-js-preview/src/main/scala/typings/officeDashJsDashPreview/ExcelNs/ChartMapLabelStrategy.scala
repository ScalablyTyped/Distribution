...
object ChartMapLabelStrategy extends js.Object {
  ...
  /* "BestFit" */ val bestFit: typings.officeDashJsDashPreview.ExcelNs.ChartMapLabelStrategy.bestFit with String = js.native
  /* "None" */ val none: typings.officeDashJsDashPreview.ExcelNs.ChartMapLabelStrategy.none with String = js.native
  /* "ShowAll" */ val showAll: typings.officeDashJsDashPreview.ExcelNs.ChartMapLabelStrategy.showAll with String = js.native
  @JSBracketAccess
