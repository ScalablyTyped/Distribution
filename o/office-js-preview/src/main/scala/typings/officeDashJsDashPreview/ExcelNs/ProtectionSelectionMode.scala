...
object ProtectionSelectionMode extends js.Object {
  ...
  /* "None" */ val none: typings.officeDashJsDashPreview.ExcelNs.ProtectionSelectionMode.none with String = js.native
  /* "Normal" */ val normal: typings.officeDashJsDashPreview.ExcelNs.ProtectionSelectionMode.normal with String = js.native
  /* "Unlocked" */ val unlocked: typings.officeDashJsDashPreview.ExcelNs.ProtectionSelectionMode.unlocked with String = js.native
  @JSBracketAccess
