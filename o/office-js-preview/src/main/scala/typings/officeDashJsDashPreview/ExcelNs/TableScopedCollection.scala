...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableScopedCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TableScopedCollectionLoadOptions
