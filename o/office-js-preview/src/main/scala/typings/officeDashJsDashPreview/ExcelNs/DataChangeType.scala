...
object DataChangeType extends js.Object {
  ...
  /* "CellDeleted" */ val cellDeleted: typings.officeDashJsDashPreview.ExcelNs.DataChangeType.cellDeleted with String = js.native
  /* "CellInserted" */ val cellInserted: typings.officeDashJsDashPreview.ExcelNs.DataChangeType.cellInserted with String = js.native
  /* "ColumnDeleted" */ val columnDeleted: typings.officeDashJsDashPreview.ExcelNs.DataChangeType.columnDeleted with String = js.native
  /* "ColumnInserted" */ val columnInserted: typings.officeDashJsDashPreview.ExcelNs.DataChangeType.columnInserted with String = js.native
  /* "RangeEdited" */ val rangeEdited: typings.officeDashJsDashPreview.ExcelNs.DataChangeType.rangeEdited with String = js.native
  /* "RowDeleted" */ val rowDeleted: typings.officeDashJsDashPreview.ExcelNs.DataChangeType.rowDeleted with String = js.native
  /* "RowInserted" */ val rowInserted: typings.officeDashJsDashPreview.ExcelNs.DataChangeType.rowInserted with String = js.native
  /* "Unknown" */ val unknown: typings.officeDashJsDashPreview.ExcelNs.DataChangeType.unknown with String = js.native
  @JSBracketAccess
