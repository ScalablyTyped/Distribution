...
object SortOrientation extends js.Object {
  ...
  /* "Columns" */ val columns: typings.officeDashJsDashPreview.ExcelNs.SortOrientation.columns with String = js.native
  /* "Rows" */ val rows: typings.officeDashJsDashPreview.ExcelNs.SortOrientation.rows with String = js.native
  @JSBracketAccess
