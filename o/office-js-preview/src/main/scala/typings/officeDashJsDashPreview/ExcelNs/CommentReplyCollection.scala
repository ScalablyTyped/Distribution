...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CommentReplyCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CommentReplyCollectionLoadOptions
...
class CommentReplyCollection () extends ClientObject {
  ...
  def load(option: CommentReplyCollectionLoadOptions with CollectionLoadOptions): CommentReplyCollection = js.native
  def load(option: String): CommentReplyCollection = js.native
  def load(option: js.Array[String]): CommentReplyCollection = js.native
  def load(option: LoadOption): CommentReplyCollection = js.native
  /**
