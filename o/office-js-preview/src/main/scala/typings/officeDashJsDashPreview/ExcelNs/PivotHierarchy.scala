...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotHierarchyData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotHierarchyLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotHierarchyUpdateData
...
class PivotHierarchy () extends ClientObject {
  ...
  def load(option: String): PivotHierarchy = js.native
  def load(option: js.Array[String]): PivotHierarchy = js.native
  def load(option: Anon_Expand): PivotHierarchy = js.native
  def load(option: PivotHierarchyLoadOptions): PivotHierarchy = js.native
