...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotHierarchyCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotHierarchyCollectionLoadOptions
...
class PivotHierarchyCollection () extends ClientObject {
  ...
  def load(option: PivotHierarchyCollectionLoadOptions with CollectionLoadOptions): PivotHierarchyCollection = js.native
  def load(option: String): PivotHierarchyCollection = js.native
  def load(option: js.Array[String]): PivotHierarchyCollection = js.native
  def load(option: LoadOption): PivotHierarchyCollection = js.native
  /**
