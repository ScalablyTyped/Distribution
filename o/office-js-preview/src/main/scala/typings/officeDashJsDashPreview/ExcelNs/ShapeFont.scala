...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ShapeFontData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ShapeFontLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ShapeFontUpdateData
...
class ShapeFont () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  var underline: ShapeFontUnderlineStyle | None | Single | typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Double | Heavy | Dotted | DottedHeavy | Dash | DashHeavy | DashLong | DashLongHeavy | DotDash | DotDashHeavy | DotDotDash | DotDotDashHeavy | Wavy | WavyHeavy | WavyDouble = js.native
  /**
