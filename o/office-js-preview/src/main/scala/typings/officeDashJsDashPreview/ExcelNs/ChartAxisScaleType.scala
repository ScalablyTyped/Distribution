...
object ChartAxisScaleType extends js.Object {
  ...
  /* "Linear" */ val linear: typings.officeDashJsDashPreview.ExcelNs.ChartAxisScaleType.linear with String = js.native
  /* "Logarithmic" */ val logarithmic: typings.officeDashJsDashPreview.ExcelNs.ChartAxisScaleType.logarithmic with String = js.native
  @JSBracketAccess
