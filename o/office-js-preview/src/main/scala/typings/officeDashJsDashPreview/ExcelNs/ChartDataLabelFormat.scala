...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartDataLabelFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartDataLabelFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartDataLabelFormatUpdateData
...
class ChartDataLabelFormat () extends ClientObject {
  ...
  def load(option: String): ChartDataLabelFormat = js.native
  def load(option: js.Array[String]): ChartDataLabelFormat = js.native
  def load(option: Anon_Expand): ChartDataLabelFormat = js.native
  def load(option: ChartDataLabelFormatLoadOptions): ChartDataLabelFormat = js.native
