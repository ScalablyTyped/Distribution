...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CustomPropertyData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CustomPropertyLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CustomPropertyUpdateData
