...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.GroupShapeCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.GroupShapeCollectionLoadOptions
...
class GroupShapeCollection () extends ClientObject {
  ...
  def load(option: GroupShapeCollectionLoadOptions with CollectionLoadOptions): GroupShapeCollection = js.native
  def load(option: String): GroupShapeCollection = js.native
  def load(option: js.Array[String]): GroupShapeCollection = js.native
  def load(option: LoadOption): GroupShapeCollection = js.native
  /**
