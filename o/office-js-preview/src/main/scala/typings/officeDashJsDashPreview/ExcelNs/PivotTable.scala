...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotTableData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotTableLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PivotTableUpdateData
