...
object BindingType extends js.Object {
  ...
  /* "Range" */ val range: typings.officeDashJsDashPreview.ExcelNs.BindingType.range with String = js.native
  /* "Table" */ val table: typings.officeDashJsDashPreview.ExcelNs.BindingType.table with String = js.native
  /* "Text" */ val text: typings.officeDashJsDashPreview.ExcelNs.BindingType.text with String = js.native
  @JSBracketAccess
