...
object ChartPlotAreaPosition extends js.Object {
  ...
  /* "Automatic" */ val automatic: typings.officeDashJsDashPreview.ExcelNs.ChartPlotAreaPosition.automatic with String = js.native
  /* "Custom" */ val custom: typings.officeDashJsDashPreview.ExcelNs.ChartPlotAreaPosition.custom with String = js.native
  @JSBracketAccess
