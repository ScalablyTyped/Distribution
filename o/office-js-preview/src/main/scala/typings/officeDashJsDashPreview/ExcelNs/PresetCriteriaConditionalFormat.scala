...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PresetCriteriaConditionalFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PresetCriteriaConditionalFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.PresetCriteriaConditionalFormatUpdateData
...
class PresetCriteriaConditionalFormat () extends ClientObject {
  ...
  def load(option: String): PresetCriteriaConditionalFormat = js.native
  def load(option: js.Array[String]): PresetCriteriaConditionalFormat = js.native
  def load(option: Anon_Expand): PresetCriteriaConditionalFormat = js.native
  def load(option: PresetCriteriaConditionalFormatLoadOptions): PresetCriteriaConditionalFormat = js.native
