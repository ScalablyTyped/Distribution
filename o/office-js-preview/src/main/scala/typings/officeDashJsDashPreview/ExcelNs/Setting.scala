...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SettingData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SettingLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SettingUpdateData
