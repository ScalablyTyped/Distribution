...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartTrendlineFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartTrendlineFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartTrendlineFormatUpdateData
...
class ChartTrendlineFormat () extends ClientObject {
  ...
  def load(option: String): ChartTrendlineFormat = js.native
  def load(option: js.Array[String]): ChartTrendlineFormat = js.native
  def load(option: Anon_Expand): ChartTrendlineFormat = js.native
  def load(option: ChartTrendlineFormatLoadOptions): ChartTrendlineFormat = js.native
