...
import typings.officeDashJsDashPreview.ExcelNs.ChartMapAreaLevel
import typings.officeDashJsDashPreview.ExcelNs.ChartMapLabelStrategy
import typings.officeDashJsDashPreview.ExcelNs.ChartMapProjectionType
