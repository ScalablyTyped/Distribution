...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartAxisData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartAxisLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartAxisUpdateData
...
class ChartAxis () extends ClientObject {
  ...
  def load(option: String): ChartAxis = js.native
  def load(option: js.Array[String]): ChartAxis = js.native
  def load(option: Anon_Expand): ChartAxis = js.native
  def load(option: ChartAxisLoadOptions): ChartAxis = js.native
