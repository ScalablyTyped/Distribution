...
object ChartAxisTimeUnit extends js.Object {
  ...
  /* "Days" */ val days: typings.officeDashJsDashPreview.ExcelNs.ChartAxisTimeUnit.days with String = js.native
  /* "Months" */ val months: typings.officeDashJsDashPreview.ExcelNs.ChartAxisTimeUnit.months with String = js.native
  /* "Years" */ val years: typings.officeDashJsDashPreview.ExcelNs.ChartAxisTimeUnit.years with String = js.native
  @JSBracketAccess
