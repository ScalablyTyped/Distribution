...
object ChartAxisCategoryType extends js.Object {
  ...
  /* "Automatic" */ val automatic: typings.officeDashJsDashPreview.ExcelNs.ChartAxisCategoryType.automatic with String = js.native
  /* "DateAxis" */ val dateAxis: typings.officeDashJsDashPreview.ExcelNs.ChartAxisCategoryType.dateAxis with String = js.native
  /* "TextAxis" */ val textAxis: typings.officeDashJsDashPreview.ExcelNs.ChartAxisCategoryType.textAxis with String = js.native
  @JSBracketAccess
