...
import typings.officeDashJsDashPreview.ExcelNs.ConditionalDataBarAxisFormat
import typings.officeDashJsDashPreview.ExcelNs.ConditionalDataBarDirection
import typings.officeDashJsDashPreview.ExcelNs.ConditionalDataBarRule
