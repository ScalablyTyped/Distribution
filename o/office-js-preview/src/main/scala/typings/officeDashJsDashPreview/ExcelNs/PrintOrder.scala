...
object PrintOrder extends js.Object {
  ...
  /* "DownThenOver" */ val downThenOver: typings.officeDashJsDashPreview.ExcelNs.PrintOrder.downThenOver with String = js.native
  /* "OverThenDown" */ val overThenDown: typings.officeDashJsDashPreview.ExcelNs.PrintOrder.overThenDown with String = js.native
  @JSBracketAccess
