...
object SortBy extends js.Object {
  ...
  /* "Ascending" */ val ascending: typings.officeDashJsDashPreview.ExcelNs.SortBy.ascending with String = js.native
  /* "Descending" */ val descending: typings.officeDashJsDashPreview.ExcelNs.SortBy.descending with String = js.native
  @JSBracketAccess
