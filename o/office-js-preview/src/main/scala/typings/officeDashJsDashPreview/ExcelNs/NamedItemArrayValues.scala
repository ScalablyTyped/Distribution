...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.NamedItemArrayValuesData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.NamedItemArrayValuesLoadOptions
...
class NamedItemArrayValues () extends ClientObject {
  ...
  def load(option: String): NamedItemArrayValues = js.native
  def load(option: js.Array[String]): NamedItemArrayValues = js.native
  def load(option: Anon_Expand): NamedItemArrayValues = js.native
  def load(option: NamedItemArrayValuesLoadOptions): NamedItemArrayValues = js.native
  /**
