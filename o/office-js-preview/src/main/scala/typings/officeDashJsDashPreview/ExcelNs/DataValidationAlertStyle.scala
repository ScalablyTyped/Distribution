...
object DataValidationAlertStyle extends js.Object {
  ...
  /* "Information" */ val information: typings.officeDashJsDashPreview.ExcelNs.DataValidationAlertStyle.information with String = js.native
  /* "Stop" */ val stop: typings.officeDashJsDashPreview.ExcelNs.DataValidationAlertStyle.stop with String = js.native
  /* "Warning" */ val warning: typings.officeDashJsDashPreview.ExcelNs.DataValidationAlertStyle.warning with String = js.native
  @JSBracketAccess
