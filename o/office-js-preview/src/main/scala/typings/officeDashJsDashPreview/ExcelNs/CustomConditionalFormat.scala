...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CustomConditionalFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CustomConditionalFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CustomConditionalFormatUpdateData
...
class CustomConditionalFormat () extends ClientObject {
  ...
  def load(option: String): CustomConditionalFormat = js.native
  def load(option: js.Array[String]): CustomConditionalFormat = js.native
  def load(option: Anon_Expand): CustomConditionalFormat = js.native
  def load(option: CustomConditionalFormatLoadOptions): CustomConditionalFormat = js.native
