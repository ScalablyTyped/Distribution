...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerCollectionLoadOptions
...
class SlicerCollection () extends ClientObject {
  ...
  def load(option: SlicerCollectionLoadOptions with CollectionLoadOptions): SlicerCollection = js.native
  def load(option: String): SlicerCollection = js.native
  def load(option: js.Array[String]): SlicerCollection = js.native
  def load(option: LoadOption): SlicerCollection = js.native
  /**
