...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.WorkbookData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.WorkbookLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.WorkbookUpdateData
...
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Prompt
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.Save
import typings.officeDashJsDashPreview.officeDashJsDashPreviewStrings.SkipSave
...
class Workbook () extends ClientObject {
  ...
  /**
    ...
    * @beta
    */
  var use1904DateSystem: Boolean = js.native
  /**
    *
  ...
  def load(option: String): Workbook = js.native
  def load(option: js.Array[String]): Workbook = js.native
  def load(option: Anon_Expand): Workbook = js.native
  def load(option: WorkbookLoadOptions): Workbook = js.native
  /**
    *
