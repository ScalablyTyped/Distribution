...
object DataValidationType extends js.Object {
  ...
  /* "Custom" */ val custom: typings.officeDashJsDashPreview.ExcelNs.DataValidationType.custom with String = js.native
  /* "Date" */ val date: typings.officeDashJsDashPreview.ExcelNs.DataValidationType.date with String = js.native
  /* "Decimal" */ val decimal: typings.officeDashJsDashPreview.ExcelNs.DataValidationType.decimal with String = js.native
  /* "Inconsistent" */ val inconsistent: typings.officeDashJsDashPreview.ExcelNs.DataValidationType.inconsistent with String = js.native
  /* "List" */ val list: typings.officeDashJsDashPreview.ExcelNs.DataValidationType.list with String = js.native
  /* "MixedCriteria" */ val mixedCriteria: typings.officeDashJsDashPreview.ExcelNs.DataValidationType.mixedCriteria with String = js.native
  /* "None" */ val none: typings.officeDashJsDashPreview.ExcelNs.DataValidationType.none with String = js.native
  /* "TextLength" */ val textLength: typings.officeDashJsDashPreview.ExcelNs.DataValidationType.textLength with String = js.native
  /* "Time" */ val time: typings.officeDashJsDashPreview.ExcelNs.DataValidationType.time with String = js.native
  /* "WholeNumber" */ val wholeNumber: typings.officeDashJsDashPreview.ExcelNs.DataValidationType.wholeNumber with String = js.native
  @JSBracketAccess
