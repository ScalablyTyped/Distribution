...
object DeleteShiftDirection extends js.Object {
  ...
  /* "Left" */ val left: typings.officeDashJsDashPreview.ExcelNs.DeleteShiftDirection.left with String = js.native
  /* "Up" */ val up: typings.officeDashJsDashPreview.ExcelNs.DeleteShiftDirection.up with String = js.native
  @JSBracketAccess
