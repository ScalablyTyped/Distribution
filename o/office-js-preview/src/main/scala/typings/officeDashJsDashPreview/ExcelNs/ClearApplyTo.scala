...
object ClearApplyTo extends js.Object {
  ...
  /* "All" */ val all: typings.officeDashJsDashPreview.ExcelNs.ClearApplyTo.all with String = js.native
  /* "Contents" */ val contents: typings.officeDashJsDashPreview.ExcelNs.ClearApplyTo.contents with String = js.native
  /* "Formats" */ val formats: typings.officeDashJsDashPreview.ExcelNs.ClearApplyTo.formats with String = js.native
  /* "Hyperlinks" */ val hyperlinks: typings.officeDashJsDashPreview.ExcelNs.ClearApplyTo.hyperlinks with String = js.native
  /* "RemoveHyperlinks" */ val removeHyperlinks: typings.officeDashJsDashPreview.ExcelNs.ClearApplyTo.removeHyperlinks with String = js.native
  @JSBracketAccess
