...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TextConditionalFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TextConditionalFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TextConditionalFormatUpdateData
...
class TextConditionalFormat () extends ClientObject {
  ...
  def load(option: String): TextConditionalFormat = js.native
  def load(option: js.Array[String]): TextConditionalFormat = js.native
  def load(option: Anon_Expand): TextConditionalFormat = js.native
  def load(option: TextConditionalFormatLoadOptions): TextConditionalFormat = js.native
