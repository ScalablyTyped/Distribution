...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerItemData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerItemLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerItemUpdateData
...
class SlicerItem () extends ClientObject {
  ...
  def load(option: String): SlicerItem = js.native
  def load(option: js.Array[String]): SlicerItem = js.native
  def load(option: Anon_Expand): SlicerItem = js.native
  def load(option: SlicerItemLoadOptions): SlicerItem = js.native
