...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartLegendData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartLegendLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartLegendUpdateData
