...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerItemCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.SlicerItemCollectionLoadOptions
...
class SlicerItemCollection () extends ClientObject {
  ...
  def load(option: SlicerItemCollectionLoadOptions with CollectionLoadOptions): SlicerItemCollection = js.native
  def load(option: String): SlicerItemCollection = js.native
  def load(option: js.Array[String]): SlicerItemCollection = js.native
  def load(option: LoadOption): SlicerItemCollection = js.native
  /**
