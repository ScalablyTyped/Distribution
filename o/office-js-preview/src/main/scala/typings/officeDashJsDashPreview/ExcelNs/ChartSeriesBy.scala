...
object ChartSeriesBy extends js.Object {
  ...
  /* "Auto" */ val auto: typings.officeDashJsDashPreview.ExcelNs.ChartSeriesBy.auto with String = js.native
  /* "Columns" */ val columns: typings.officeDashJsDashPreview.ExcelNs.ChartSeriesBy.columns with String = js.native
  /* "Rows" */ val rows: typings.officeDashJsDashPreview.ExcelNs.ChartSeriesBy.rows with String = js.native
  @JSBracketAccess
