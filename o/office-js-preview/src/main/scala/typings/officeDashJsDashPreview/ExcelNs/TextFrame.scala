...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TextFrameData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TextFrameLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.TextFrameUpdateData
...
class TextFrame () extends ClientObject {
  ...
  def load(option: String): TextFrame = js.native
  def load(option: js.Array[String]): TextFrame = js.native
  def load(option: Anon_Expand): TextFrame = js.native
  def load(option: TextFrameLoadOptions): TextFrame = js.native
