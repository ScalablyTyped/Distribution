...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CustomPropertyCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.CustomPropertyCollectionLoadOptions
