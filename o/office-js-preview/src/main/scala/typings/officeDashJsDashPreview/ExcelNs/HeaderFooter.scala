...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.HeaderFooterData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.HeaderFooterLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.HeaderFooterUpdateData
...
class HeaderFooter () extends ClientObject {
  ...
  def load(option: String): HeaderFooter = js.native
  def load(option: js.Array[String]): HeaderFooter = js.native
  def load(option: Anon_Expand): HeaderFooter = js.native
  def load(option: HeaderFooterLoadOptions): HeaderFooter = js.native
