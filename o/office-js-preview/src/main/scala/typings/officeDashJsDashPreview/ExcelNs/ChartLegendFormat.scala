...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartLegendFormatData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartLegendFormatLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ChartLegendFormatUpdateData
...
class ChartLegendFormat () extends ClientObject {
  ...
  def load(option: String): ChartLegendFormat = js.native
  def load(option: js.Array[String]): ChartLegendFormat = js.native
  def load(option: Anon_Expand): ChartLegendFormat = js.native
  def load(option: ChartLegendFormatLoadOptions): ChartLegendFormat = js.native
