...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RuntimeData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RuntimeLoadOptions
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.RuntimeUpdateData
...
class Runtime () extends ClientObject {
  ...
  def load(option: String): Runtime = js.native
  def load(option: js.Array[String]): Runtime = js.native
  def load(option: Anon_Expand): Runtime = js.native
  def load(option: RuntimeLoadOptions): Runtime = js.native
