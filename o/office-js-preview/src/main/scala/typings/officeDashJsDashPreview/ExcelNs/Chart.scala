...
class Chart () extends ClientObject {
  ...
  def load(option: String): Chart = js.native
  def load(option: js.Array[String]): Chart = js.native
  def load(option: Anon_Expand): Chart = js.native
  def load(option: ChartLoadOptions): Chart = js.native
