...
object ChartParentLabelStrategy extends js.Object {
  ...
  /* "Banner" */ val banner: typings.officeDashJsDashPreview.ExcelNs.ChartParentLabelStrategy.banner with String = js.native
  /* "None" */ val none: typings.officeDashJsDashPreview.ExcelNs.ChartParentLabelStrategy.none with String = js.native
  /* "Overlapping" */ val overlapping: typings.officeDashJsDashPreview.ExcelNs.ChartParentLabelStrategy.overlapping with String = js.native
  @JSBracketAccess
