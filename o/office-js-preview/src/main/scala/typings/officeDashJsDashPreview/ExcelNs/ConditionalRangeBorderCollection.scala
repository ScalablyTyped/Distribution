...
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalRangeBorderCollectionData
import typings.officeDashJsDashPreview.ExcelNs.InterfacesNs.ConditionalRangeBorderCollectionLoadOptions
