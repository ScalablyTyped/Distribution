...
/**
  ...
  * @beta
  */
trait ContentControlSelectionChangedEventArgs extends StObject {
...
object ContentControlSelectionChangedEventArgs {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ContentControlSelectionChangedEventArgs]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ContentControlSelectionChangedEventArgs] (val x: Self) extends AnyVal {
