...
trait Body extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: BodyType | Unknown_ | MainDoc | typings.officeJsPreview.officeJsPreviewStrings.Section | Header | Footer | typings.officeJsPreview.officeJsPreviewStrings.TableCell = js.native
