...
object ParagraphLoadOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(firstLineIndent)) __obj.updateDynamic("firstLineIndent")(firstLineIndent.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(leftIndent)) __obj.updateDynamic("leftIndent")(leftIndent.asInstanceOf[js.Any])
    if (!js.isUndefined(lineSpacing)) __obj.updateDynamic("lineSpacing")(lineSpacing.asInstanceOf[js.Any])
    if (!js.isUndefined(lineUnitAfter)) __obj.updateDynamic("lineUnitAfter")(lineUnitAfter.asInstanceOf[js.Any])
    if (!js.isUndefined(lineUnitBefore)) __obj.updateDynamic("lineUnitBefore")(lineUnitBefore.asInstanceOf[js.Any])
    ...
    if (listOrNullObject != null) __obj.updateDynamic("listOrNullObject")(listOrNullObject.asInstanceOf[js.Any])
    if (!js.isUndefined(outlineLevel)) __obj.updateDynamic("outlineLevel")(outlineLevel.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(rightIndent)) __obj.updateDynamic("rightIndent")(rightIndent.asInstanceOf[js.Any])
    if (!js.isUndefined(spaceAfter)) __obj.updateDynamic("spaceAfter")(spaceAfter.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(tableNestingLevel)) __obj.updateDynamic("tableNestingLevel")(tableNestingLevel.asInstanceOf[js.Any])
