...
trait StyleUpdateData extends StObject {
  ...
  /**
    ...
    * @beta
    */
  var listTemplate: js.UndefOr[ListTemplateUpdateData] = js.undefined
...
object StyleUpdateData {
  ...
  implicit open class MutableBuilder[Self <: StyleUpdateData] (val x: Self) extends AnyVal {
    ...
    inline def setListTemplate(value: ListTemplateUpdateData): Self = StObject.set(x, "listTemplate", value.asInstanceOf[js.Any])
