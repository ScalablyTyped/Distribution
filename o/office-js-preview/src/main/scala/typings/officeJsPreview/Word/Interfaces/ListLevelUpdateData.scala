...
trait ListLevelUpdateData extends StObject {
...
object ListLevelUpdateData {
  
  inline def apply(): ListLevelUpdateData = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListLevelUpdateData]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListLevelUpdateData] (val x: Self) extends AnyVal {
