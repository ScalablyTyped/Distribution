...
object ContentControlCollectionLoadOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(appearance)) __obj.updateDynamic("appearance")(appearance.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(placeholderText)) __obj.updateDynamic("placeholderText")(placeholderText.get.asInstanceOf[js.Any])
