...
import typings.officeJsPreview.Word.Interfaces.TableCollectionData
import typings.officeJsPreview.Word.Interfaces.TableCollectionLoadOptions
...
@js.native
class TableCollection () extends ClientObject {
  ...
  def load(option: TableCollectionLoadOptions with CollectionLoadOptions): TableCollection = js.native
  def load(option: String): TableCollection = js.native
  def load(option: js.Array[String]): TableCollection = js.native
  def load(option: LoadOption): TableCollection = js.native
  /**
