...
import typings.officeJsPreview.Word.Interfaces.ListCollectionData
...
trait ListCollection
  ...
  /**
    ...
    */
  def getById(id: Double): typings.officeJsPreview.Word.List = js.native
  ...
  /**
    ...
    * @param id Required. A list identifier.
    */
  def getByIdOrNullObject(id: Double): typings.officeJsPreview.Word.List = js.native
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  def getFirst(): typings.officeJsPreview.Word.List = js.native
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  def getFirstOrNullObject(): typings.officeJsPreview.Word.List = js.native
  ...
  /**
    ...
    */
  def getItem(id: Double): typings.officeJsPreview.Word.List = js.native
  
  /** Gets the loaded child items in this collection. */
  val items: js.Array[typings.officeJsPreview.Word.List] = js.native
