...
import typings.officeJsPreview.Word.Interfaces.DocumentPropertiesData
import typings.officeJsPreview.Word.Interfaces.DocumentPropertiesLoadOptions
import typings.officeJsPreview.Word.Interfaces.DocumentPropertiesUpdateData
