...
/**
  ...
  * @beta
  */
trait ListLevelLoadOptions extends StObject {
...
object ListLevelLoadOptions {
  
  inline def apply(): ListLevelLoadOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListLevelLoadOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListLevelLoadOptions] (val x: Self) extends AnyVal {
