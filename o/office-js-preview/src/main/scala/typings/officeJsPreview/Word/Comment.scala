...
import typings.officeJsPreview.Word.Interfaces.CommentData
import typings.officeJsPreview.Word.Interfaces.CommentLoadOptions
import typings.officeJsPreview.Word.Interfaces.CommentUpdateData
