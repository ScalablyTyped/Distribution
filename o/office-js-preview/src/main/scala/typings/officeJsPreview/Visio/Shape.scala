...
import typings.officeJsPreview.Visio.Interfaces.ShapeData
import typings.officeJsPreview.Visio.Interfaces.ShapeLoadOptions
import typings.officeJsPreview.Visio.Interfaces.ShapeUpdateData
