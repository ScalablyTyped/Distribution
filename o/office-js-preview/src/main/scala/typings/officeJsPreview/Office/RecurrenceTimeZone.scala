...
trait RecurrenceTimeZone extends StObject {
  ...
  /**
    ...
    */
  var name: typings.officeJsPreview.Office.MailboxEnums.RecurrenceTimeZone | String = js.native
...
object RecurrenceTimeZone {
  ...
  @scala.inline
  def apply(name: typings.officeJsPreview.Office.MailboxEnums.RecurrenceTimeZone | String): RecurrenceTimeZone = {
  ...
  implicit class RecurrenceTimeZoneMutableBuilder[Self <: RecurrenceTimeZone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typings.officeJsPreview.Office.MailboxEnums.RecurrenceTimeZone | String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
