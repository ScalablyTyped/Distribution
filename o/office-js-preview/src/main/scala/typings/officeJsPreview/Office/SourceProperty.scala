...
object SourceProperty extends js.Object {
  ...
  /* 0 */ @js.native
  object Body
    extends TopLevel[typings.officeJsPreview.Office.SourceProperty.Body with Double]
  
  /* 1 */ @js.native
  object Subject
    extends TopLevel[typings.officeJsPreview.Office.SourceProperty.Subject with Double]
