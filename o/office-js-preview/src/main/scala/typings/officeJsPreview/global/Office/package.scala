...
@scala.inline
def onReady(callback: js.Function1[/* info */ typings.officeJsPreview.anon.Host, js.Any]): js.Promise[typings.officeJsPreview.anon.Host] = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("onReady")(callback.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.officeJsPreview.anon.Host]]
