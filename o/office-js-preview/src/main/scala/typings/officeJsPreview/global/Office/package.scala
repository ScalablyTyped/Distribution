...
inline def Promise_=(x: typings.officeJsPreview.Office.IPromiseConstructor): scala.Unit = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].updateDynamic("Promise")(x.asInstanceOf[js.Any])

/**
  * Provides a method for associating action names with functions that carry out an action.
  */
inline def actions: typings.officeJsPreview.Office.Actions = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].selectDynamic("actions").asInstanceOf[typings.officeJsPreview.Office.Actions]

/**
  * Represents the add-in.
  */
inline def addin: typings.officeJsPreview.Office.Addin = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].selectDynamic("addin").asInstanceOf[typings.officeJsPreview.Office.Addin]
...
/**
  ...
  *  </table>
  */
inline def context: typings.officeJsPreview.Office.Context = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].selectDynamic("context").asInstanceOf[typings.officeJsPreview.Office.Context]
inline def context_=(x: typings.officeJsPreview.Office.Context): scala.Unit = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].updateDynamic("context")(x.asInstanceOf[js.Any])
...
/**
  ...
  */
inline def initialize(reason: typings.officeJsPreview.Office.InitializationReason): scala.Unit = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("initialize")(reason.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
...
/**
  ...
  */
inline def isSetSupported(name: java.lang.String): scala.Boolean = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("isSetSupported")(name.asInstanceOf[js.Any]).asInstanceOf[scala.Boolean]
inline def isSetSupported(name: java.lang.String, minVersion: java.lang.String): scala.Boolean = (typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("isSetSupported")(name.asInstanceOf[js.Any], minVersion.asInstanceOf[js.Any])).asInstanceOf[scala.Boolean]
...
/**
  ...
  */
inline def onReady(): js.Promise[typings.officeJsPreview.anon.Host] = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("onReady")().asInstanceOf[js.Promise[typings.officeJsPreview.anon.Host]]
inline def onReady(callback: js.Function1[/* info */ typings.officeJsPreview.anon.Host, js.Any]): js.Promise[typings.officeJsPreview.anon.Host] = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("onReady")(callback.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.officeJsPreview.anon.Host]]

/**
  * Represents the ribbon associated with the Office application.
  */
inline def ribbon: typings.officeJsPreview.Office.Ribbon = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].selectDynamic("ribbon").asInstanceOf[typings.officeJsPreview.Office.Ribbon]
...
/**
  ...
  *  </table>
  */
inline def select(expression: java.lang.String): typings.officeJsPreview.Office.Binding = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("select")(expression.asInstanceOf[js.Any]).asInstanceOf[typings.officeJsPreview.Office.Binding]
inline def select(
  expression: java.lang.String,
  callback: js.Function1[/* result */ typings.officeJsPreview.Office.AsyncResult[js.Any], scala.Unit]
...
/**
  ...
  */
inline def useShortNamespace(useShortNamespace: scala.Boolean): scala.Unit = typings.officeJsPreview.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("useShortNamespace")(useShortNamespace.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
