...
object Visio {
  ...
  object ColumnType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.officeJsPreview.Visio.ColumnType & String] = js.native
    
    /* "Currency" */ val currency: typings.officeJsPreview.Visio.ColumnType.currency & String = js.native
    
    /* "Date" */ val date: typings.officeJsPreview.Visio.ColumnType.date & String = js.native
    
    /* "Number" */ val number: typings.officeJsPreview.Visio.ColumnType.number & String = js.native
    
    /* "String" */ val string: typings.officeJsPreview.Visio.ColumnType.string & String = js.native
    
    /* "Unknown" */ val unknown: typings.officeJsPreview.Visio.ColumnType.unknown & String = js.native
  }
  ...
  object ConnectorDirection extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.officeJsPreview.Visio.ConnectorDirection & String] = js.native
    
    /* "FromTarget" */ val fromTarget: typings.officeJsPreview.Visio.ConnectorDirection.fromTarget & String = js.native
    
    /* "ToTarget" */ val toTarget: typings.officeJsPreview.Visio.ConnectorDirection.toTarget & String = js.native
  }
  ...
  object CrossFunctionalFlowchartOrientation extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.officeJsPreview.Visio.CrossFunctionalFlowchartOrientation & String] = js.native
    
    /* "Horizontal" */ val horizontal: typings.officeJsPreview.Visio.CrossFunctionalFlowchartOrientation.horizontal & String = js.native
    
    /* "Vertical" */ val vertical: typings.officeJsPreview.Visio.CrossFunctionalFlowchartOrientation.vertical & String = js.native
  }
  ...
  object DataSourceType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.officeJsPreview.Visio.DataSourceType & String] = js.native
    
    /* "Excel" */ val excel: typings.officeJsPreview.Visio.DataSourceType.excel & String = js.native
    
    /* "Unknown" */ val unknown: typings.officeJsPreview.Visio.DataSourceType.unknown & String = js.native
  }
  ...
  object DataValidationErrorType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.officeJsPreview.Visio.DataValidationErrorType & String] = js.native
    
    /* "ColumnNotMapped" */ val columnNotMapped: typings.officeJsPreview.Visio.DataValidationErrorType.columnNotMapped & String = js.native
    
    /* "ConnectorColumnAndConnectorLabelMappedElsewhere" */ val connectorColumnAndConnectorLabelMappedElsewhere: typings.officeJsPreview.Visio.DataValidationErrorType.connectorColumnAndConnectorLabelMappedElsewhere & String = js.native
    
    /* "ConnectorColumnError" */ val connectorColumnError: typings.officeJsPreview.Visio.DataValidationErrorType.connectorColumnError & String = js.native
    
    /* "ConnectorColumnMappedElsewhere" */ val connectorColumnMappedElsewhere: typings.officeJsPreview.Visio.DataValidationErrorType.connectorColumnMappedElsewhere & String = js.native
    
    /* "ConnectorLabelColumnMappedElsewhere" */ val connectorLabelColumnMappedElsewhere: typings.officeJsPreview.Visio.DataValidationErrorType.connectorLabelColumnMappedElsewhere & String = js.native
    
    /* "DelimiterError" */ val delimiterError: typings.officeJsPreview.Visio.DataValidationErrorType.delimiterError & String = js.native
    
    /* "None" */ val none: typings.officeJsPreview.Visio.DataValidationErrorType.none & String = js.native
    
    /* "SwimlaneColumnError" */ val swimlaneColumnError: typings.officeJsPreview.Visio.DataValidationErrorType.swimlaneColumnError & String = js.native
    
    /* "UniqueIdColumnError" */ val uniqueIdColumnError: typings.officeJsPreview.Visio.DataValidationErrorType.uniqueIdColumnError & String = js.native
  }
  ...
  object DataVisualizerDiagramOperationType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.officeJsPreview.Visio.DataVisualizerDiagramOperationType & String] = js.native
    
    /* "Create" */ val create: typings.officeJsPreview.Visio.DataVisualizerDiagramOperationType.create & String = js.native
    
    /* "Delete" */ val delete: typings.officeJsPreview.Visio.DataVisualizerDiagramOperationType.delete & String = js.native
    
    /* "Unknown" */ val unknown: typings.officeJsPreview.Visio.DataVisualizerDiagramOperationType.unknown & String = js.native
    
    /* "Update" */ val update: typings.officeJsPreview.Visio.DataVisualizerDiagramOperationType.update & String = js.native
    
    /* "UpdateData" */ val updateData: typings.officeJsPreview.Visio.DataVisualizerDiagramOperationType.updateData & String = js.native
    
    /* "UpdateMappings" */ val updateMappings: typings.officeJsPreview.Visio.DataVisualizerDiagramOperationType.updateMappings & String = js.native
  }
  ...
  object DataVisualizerDiagramResultType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.officeJsPreview.Visio.DataVisualizerDiagramResultType & String] = js.native
    
    /* "ConflictError" */ val conflictError: typings.officeJsPreview.Visio.DataVisualizerDiagramResultType.conflictError & String = js.native
    
    /* "Success" */ val success: typings.officeJsPreview.Visio.DataVisualizerDiagramResultType.success & String = js.native
    
    /* "Unexpected" */ val unexpected: typings.officeJsPreview.Visio.DataVisualizerDiagramResultType.unexpected & String = js.native
    
    /* "ValidationError" */ val validationError: typings.officeJsPreview.Visio.DataVisualizerDiagramResultType.validationError & String = js.native
  }
  ...
  object DataVisualizerDiagramType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.officeJsPreview.Visio.DataVisualizerDiagramType & String] = js.native
    
    /* "Audit" */ val audit: typings.officeJsPreview.Visio.DataVisualizerDiagramType.audit & String = js.native
    
    /* "BasicFlowchart" */ val basicFlowchart: typings.officeJsPreview.Visio.DataVisualizerDiagramType.basicFlowchart & String = js.native
    
    /* "CrossFunctionalFlowchart_Horizontal" */ val crossFunctionalFlowchart_Horizontal: typings.officeJsPreview.Visio.DataVisualizerDiagramType.crossFunctionalFlowchart_Horizontal & String = js.native
    
    /* "CrossFunctionalFlowchart_Vertical" */ val crossFunctionalFlowchart_Vertical: typings.officeJsPreview.Visio.DataVisualizerDiagramType.crossFunctionalFlowchart_Vertical & String = js.native
    
    /* "Network" */ val network: typings.officeJsPreview.Visio.DataVisualizerDiagramType.network & String = js.native
    
    /* "OrgChart" */ val orgChart: typings.officeJsPreview.Visio.DataVisualizerDiagramType.orgChart & String = js.native
    
    /* "Unknown" */ val unknown: typings.officeJsPreview.Visio.DataVisualizerDiagramType.unknown & String = js.native
  }
  ...
  object EventType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.officeJsPreview.Visio.EventType & String] = js.native
    
    /* "DataVisualizerDiagramOperationCompleted" */ val dataVisualizerDiagramOperationCompleted: typings.officeJsPreview.Visio.EventType.dataVisualizerDiagramOperationCompleted & String = js.native
  }
  ...
  object LayoutVariant extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.officeJsPreview.Visio.LayoutVariant & String] = js.native
    
    /* "Flowchart_BottomToTop" */ val flowchart_BottomToTop: typings.officeJsPreview.Visio.LayoutVariant.flowchart_BottomToTop & String = js.native
    
    /* "Flowchart_LeftToRight" */ val flowchart_LeftToRight: typings.officeJsPreview.Visio.LayoutVariant.flowchart_LeftToRight & String = js.native
    
    /* "Flowchart_RightToLeft" */ val flowchart_RightToLeft: typings.officeJsPreview.Visio.LayoutVariant.flowchart_RightToLeft & String = js.native
    
    /* "Flowchart_TopToBottom" */ val flowchart_TopToBottom: typings.officeJsPreview.Visio.LayoutVariant.flowchart_TopToBottom & String = js.native
    
    /* "PageDefault" */ val pageDefault: typings.officeJsPreview.Visio.LayoutVariant.pageDefault & String = js.native
    
    /* "Unknown" */ val unknown: typings.officeJsPreview.Visio.LayoutVariant.unknown & String = js.native
    
    /* "WideTree_DownThenLeft" */ val wideTree_DownThenLeft: typings.officeJsPreview.Visio.LayoutVariant.wideTree_DownThenLeft & String = js.native
    
    /* "WideTree_DownThenRight" */ val wideTree_DownThenRight: typings.officeJsPreview.Visio.LayoutVariant.wideTree_DownThenRight & String = js.native
    
    /* "WideTree_LeftThenDown" */ val wideTree_LeftThenDown: typings.officeJsPreview.Visio.LayoutVariant.wideTree_LeftThenDown & String = js.native
    
    /* "WideTree_RightThenDown" */ val wideTree_RightThenDown: typings.officeJsPreview.Visio.LayoutVariant.wideTree_RightThenDown & String = js.native
  }
  ...
  object TaskPaneType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.officeJsPreview.Visio.TaskPaneType & String] = js.native
    
    /* "DataVisualizerOrgChartMappings" */ val dataVisualizerOrgChartMappings: typings.officeJsPreview.Visio.TaskPaneType.dataVisualizerOrgChartMappings & String = js.native
    
    /* "DataVisualizerProcessMappings" */ val dataVisualizerProcessMappings: typings.officeJsPreview.Visio.TaskPaneType.dataVisualizerProcessMappings & String = js.native
    
    /* "None" */ val none: typings.officeJsPreview.Visio.TaskPaneType.none & String = js.native
  }
  ...
  /**
    ...
    */
  inline def run[T](batch: js.Function1[/* context */ typings.officeJsPreview.Visio.RequestContext, js.Promise[T]]): js.Promise[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("run")(batch.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
  /**
