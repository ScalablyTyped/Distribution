...
import typings.officeJsPreview.global.Word.^
...
/**
  ...
  */
inline def run[T](batch: js.Function1[/* context */ typings.officeJsPreview.Word.RequestContext, js.Promise[T]]): js.Promise[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("run")(batch.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
/**
