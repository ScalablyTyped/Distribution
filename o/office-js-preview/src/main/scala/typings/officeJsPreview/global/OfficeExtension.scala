...
object OfficeExtension extends js.Object {
  ...
  class ClientObject ()
    ...
    /* CompleteClass */
    override var context: typings.officeJsPreview.OfficeExtension.ClientRequestContext = js.native
    /**
  ...
  class Error ()
    ...
    /* CompleteClass */
    override var innerError: typings.officeJsPreview.OfficeExtension.Error = js.native
  ...
  class EventHandlers[T] protected ()
    ...
    /* CompleteClass */
    override def add(handler: js.Function1[T, js.Promise[_]]): typings.officeJsPreview.OfficeExtension.EventHandlerResult[T] = js.native
    /* CompleteClass */
