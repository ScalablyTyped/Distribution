...
inline def EndIgnoreIntelliSenseInternalTestClass: js.Any = typings.officeJsPreview.global.Excel.^.asInstanceOf[js.Dynamic].selectDynamic("EndIgnoreIntelliSenseInternalTestClass").asInstanceOf[js.Any]
inline def EndIgnoreIntelliSenseInternalTestClass_=(x: js.Any): scala.Unit = typings.officeJsPreview.global.Excel.^.asInstanceOf[js.Dynamic].updateDynamic("EndIgnoreIntelliSenseInternalTestClass")(x.asInstanceOf[js.Any])
...
/**
  ...
  */
inline def createWorkbook(): js.Promise[scala.Unit] = typings.officeJsPreview.global.Excel.^.asInstanceOf[js.Dynamic].applyDynamic("createWorkbook")().asInstanceOf[js.Promise[scala.Unit]]
inline def createWorkbook(base64: java.lang.String): js.Promise[scala.Unit] = typings.officeJsPreview.global.Excel.^.asInstanceOf[js.Dynamic].applyDynamic("createWorkbook")(base64.asInstanceOf[js.Any]).asInstanceOf[js.Promise[scala.Unit]]

inline def getDataCommonPostprocess(response: js.Any, callArgs: js.Any): js.Any = (typings.officeJsPreview.global.Excel.^.asInstanceOf[js.Dynamic].applyDynamic("getDataCommonPostprocess")(response.asInstanceOf[js.Any], callArgs.asInstanceOf[js.Any])).asInstanceOf[js.Any]

inline def icons: typings.officeJsPreview.Excel.IconCollections = typings.officeJsPreview.global.Excel.^.asInstanceOf[js.Dynamic].selectDynamic("icons").asInstanceOf[typings.officeJsPreview.Excel.IconCollections]
inline def icons_=(x: typings.officeJsPreview.Excel.IconCollections): scala.Unit = typings.officeJsPreview.global.Excel.^.asInstanceOf[js.Dynamic].updateDynamic("icons")(x.asInstanceOf[js.Any])

inline def postprocessBindingDescriptor(response: js.Any): js.Any = typings.officeJsPreview.global.Excel.^.asInstanceOf[js.Dynamic].applyDynamic("postprocessBindingDescriptor")(response.asInstanceOf[js.Any]).asInstanceOf[js.Any]
...
/**
  ...
  */
inline def run[T](batch: js.Function1[/* context */ typings.officeJsPreview.Excel.RequestContext, js.Promise[T]]): js.Promise[T] = typings.officeJsPreview.global.Excel.^.asInstanceOf[js.Dynamic].applyDynamic("run")(batch.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
/**
