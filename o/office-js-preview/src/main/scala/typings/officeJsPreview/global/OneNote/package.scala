...
/**
  ...
  */
@scala.inline
def run[T](batch: js.Function1[/* context */ typings.officeJsPreview.OneNote.RequestContext, js.Promise[T]]): js.Promise[T] = typings.officeJsPreview.global.OneNote.^.asInstanceOf[js.Dynamic].applyDynamic("run")(batch.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
/**
