...
object ErrorCodes extends js.Object {
  /* "AccessDenied" */ val accessDenied: typings.officeJsPreview.Word.ErrorCodes.accessDenied with String = js.native
  /* "GeneralException" */ val generalException: typings.officeJsPreview.Word.ErrorCodes.generalException with String = js.native
