...
import typings.officeJsPreview.OneNote.Interfaces.InkStrokeCollectionData
import typings.officeJsPreview.OneNote.Interfaces.InkStrokeCollectionLoadOptions
...
@js.native
class InkStrokeCollection () extends ClientObject {
