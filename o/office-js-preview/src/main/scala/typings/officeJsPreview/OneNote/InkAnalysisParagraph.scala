...
import typings.officeJsPreview.OneNote.Interfaces.InkAnalysisParagraphData
import typings.officeJsPreview.OneNote.Interfaces.InkAnalysisParagraphLoadOptions
import typings.officeJsPreview.OneNote.Interfaces.InkAnalysisParagraphUpdateData
...
trait InkAnalysisParagraph
  ...
  def load(options: InkAnalysisParagraphLoadOptions): InkAnalysisParagraph = js.native
  def load(propertyNamesAndPaths: Expand): InkAnalysisParagraph = js.native
  def load(propertyNames: String): InkAnalysisParagraph = js.native
  def load(propertyNames: js.Array[String]): InkAnalysisParagraph = js.native
