...
import typings.officeJsPreview.OneNote.Interfaces.TableCellCollectionData
import typings.officeJsPreview.OneNote.Interfaces.TableCellCollectionLoadOptions
