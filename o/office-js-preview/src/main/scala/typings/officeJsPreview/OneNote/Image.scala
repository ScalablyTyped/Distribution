...
import typings.officeJsPreview.OneNote.Interfaces.ImageData
import typings.officeJsPreview.OneNote.Interfaces.ImageLoadOptions
import typings.officeJsPreview.OneNote.Interfaces.ImageUpdateData
