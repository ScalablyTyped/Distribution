...
import typings.officeJsPreview.PowerPoint.Interfaces.ShapeLineFormatData
import typings.officeJsPreview.PowerPoint.Interfaces.ShapeLineFormatLoadOptions
