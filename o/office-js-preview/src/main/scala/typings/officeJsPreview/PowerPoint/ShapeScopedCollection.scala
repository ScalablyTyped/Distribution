...
import typings.officeJsPreview.PowerPoint.Interfaces.ShapeScopedCollectionData
import typings.officeJsPreview.PowerPoint.Interfaces.ShapeScopedCollectionLoadOptions
