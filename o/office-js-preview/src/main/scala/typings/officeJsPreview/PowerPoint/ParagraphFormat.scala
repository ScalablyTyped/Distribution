...
import typings.officeJsPreview.PowerPoint.Interfaces.ParagraphFormatData
import typings.officeJsPreview.PowerPoint.Interfaces.ParagraphFormatLoadOptions
