...
import typings.officeJsPreview.Excel.Interfaces.RuntimeData
import typings.officeJsPreview.Excel.Interfaces.RuntimeLoadOptions
import typings.officeJsPreview.Excel.Interfaces.RuntimeUpdateData
