...
trait Shape
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  var geometricShapeType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typings.officeJsPreview.Excel.GeometricShapeType, typings.officeJsPreview.officeJsPreviewStrings.LineInverse, typings.officeJsPreview.officeJsPreviewStrings.Triangle */ Any = js.native
