...
trait RunOptions
  extends typings.officeJsPreview.OfficeExtension.RunOptions[Session] {
  /**
...
object RunOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(delayForCellEdit)) __obj.updateDynamic("delayForCellEdit")(delayForCellEdit.get.asInstanceOf[js.Any])
