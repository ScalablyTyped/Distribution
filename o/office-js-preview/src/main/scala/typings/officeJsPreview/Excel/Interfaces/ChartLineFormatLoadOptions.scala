...
object ChartLineFormatLoadOptions {
  ...
  @scala.inline
  implicit class ChartLineFormatLoadOptionsMutableBuilder[Self <: ChartLineFormatLoadOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLineStyle(value: Boolean): Self = StObject.set(x, "lineStyle", value.asInstanceOf[js.Any])
