...
import typings.officeJsPreview.Excel.Interfaces.ChartSeriesCollectionData
import typings.officeJsPreview.Excel.Interfaces.ChartSeriesCollectionLoadOptions
