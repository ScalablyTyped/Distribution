...
object ChartErrorBarsData {
  ...
  @scala.inline
  implicit class ChartErrorBarsDataMutableBuilder[Self <: ChartErrorBarsData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormat(value: ChartErrorBarsFormatData): Self = StObject.set(x, "format", value.asInstanceOf[js.Any])
