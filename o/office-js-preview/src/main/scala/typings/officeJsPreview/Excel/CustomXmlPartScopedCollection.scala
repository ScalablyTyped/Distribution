...
import typings.officeJsPreview.Excel.Interfaces.CustomXmlPartScopedCollectionData
import typings.officeJsPreview.Excel.Interfaces.CustomXmlPartScopedCollectionLoadOptions
