...
import typings.officeJsPreview.Excel.Interfaces.QueryData
import typings.officeJsPreview.Excel.Interfaces.QueryLoadOptions
...
trait Query
  ...
  /**
    ...
    * [Api set: ExcelApi 1.14]
    */
  val loadedTo: LoadToType | ConnectionOnly | typings.officeJsPreview.officeJsPreviewStrings.Table | typings.officeJsPreview.officeJsPreviewStrings.PivotTable | PivotChart = js.native
