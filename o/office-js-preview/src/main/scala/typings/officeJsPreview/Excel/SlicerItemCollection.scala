...
import typings.officeJsPreview.Excel.Interfaces.SlicerItemCollectionData
import typings.officeJsPreview.Excel.Interfaces.SlicerItemCollectionLoadOptions
