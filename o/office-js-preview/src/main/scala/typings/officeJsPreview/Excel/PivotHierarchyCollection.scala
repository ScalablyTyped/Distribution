...
import typings.officeJsPreview.Excel.Interfaces.PivotHierarchyCollectionData
import typings.officeJsPreview.Excel.Interfaces.PivotHierarchyCollectionLoadOptions
