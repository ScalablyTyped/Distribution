...
object PresetCriteriaConditionalFormatLoadOptions {
  ...
  @scala.inline
  def apply(): PresetCriteriaConditionalFormatLoadOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PresetCriteriaConditionalFormatLoadOptions]
  }
  
  @scala.inline
  implicit class PresetCriteriaConditionalFormatLoadOptionsMutableBuilder[Self <: PresetCriteriaConditionalFormatLoadOptions] (val x: Self) extends AnyVal {
