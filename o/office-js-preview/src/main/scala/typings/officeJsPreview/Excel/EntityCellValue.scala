...
object EntityCellValue {
  ...
  inline def apply(`type`: entity | typings.officeJsPreview.Excel.ReferenceValueType.entity | Entity): EntityCellValue = {
  ...
  implicit open class MutableBuilder[Self <: EntityCellValue] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: entity | typings.officeJsPreview.Excel.ReferenceValueType.entity | Entity): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
