...
import typings.officeJsPreview.Excel.Interfaces.TableStyleCollectionData
import typings.officeJsPreview.Excel.Interfaces.TableStyleCollectionLoadOptions
