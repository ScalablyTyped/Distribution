...
import typings.officeJsPreview.Excel.Interfaces.ChartLegendEntryCollectionData
import typings.officeJsPreview.Excel.Interfaces.ChartLegendEntryCollectionLoadOptions
