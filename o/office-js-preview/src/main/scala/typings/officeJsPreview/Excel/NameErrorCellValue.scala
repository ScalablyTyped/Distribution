...
import typings.officeJsPreview.Excel.ErrorCellValueType.name
import typings.officeJsPreview.Excel.RangeValueType.error
import typings.officeJsPreview.officeJsPreviewStrings.Error
import typings.officeJsPreview.officeJsPreviewStrings.Name
import typings.officeJsPreview.officeJsPreviewStrings.NumbersignNAMEQuestionmark
...
object NameErrorCellValue {
  ...
  inline def apply(`type`: typings.officeJsPreview.Excel.CellValueType.error | Error): NameErrorCellValue = {
