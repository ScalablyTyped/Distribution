...
import typings.officeJsPreview.Excel.Interfaces.ConditionalDataBarNegativeFormatData
import typings.officeJsPreview.Excel.Interfaces.ConditionalDataBarNegativeFormatLoadOptions
import typings.officeJsPreview.Excel.Interfaces.ConditionalDataBarNegativeFormatUpdateData
