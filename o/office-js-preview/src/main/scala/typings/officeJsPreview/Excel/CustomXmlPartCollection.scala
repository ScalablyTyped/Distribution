...
import typings.officeJsPreview.Excel.Interfaces.CustomXmlPartCollectionData
import typings.officeJsPreview.Excel.Interfaces.CustomXmlPartCollectionLoadOptions
