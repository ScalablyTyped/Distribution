...
import typings.officeJsPreview.Excel.Interfaces.ChartCollectionData
import typings.officeJsPreview.Excel.Interfaces.ChartCollectionLoadOptions
...
trait ChartCollection
  ...
  /**
    ...
    */
  def add(
    `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 82, starting with typings.officeJsPreview.officeJsPreviewStrings.Invalid, typings.officeJsPreview.officeJsPreviewStrings.ColumnClustered, typings.officeJsPreview.officeJsPreviewStrings.ColumnStacked */ Any,
    sourceData: Range
  ): Chart = js.native
  def add(
    `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 82, starting with typings.officeJsPreview.officeJsPreviewStrings.Invalid, typings.officeJsPreview.officeJsPreviewStrings.ColumnClustered, typings.officeJsPreview.officeJsPreviewStrings.ColumnStacked */ Any,
