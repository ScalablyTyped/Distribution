...
import typings.officeJsPreview.Excel.Interfaces.ChartLegendEntryData
import typings.officeJsPreview.Excel.Interfaces.ChartLegendEntryLoadOptions
import typings.officeJsPreview.Excel.Interfaces.ChartLegendEntryUpdateData
