...
import typings.officeJsPreview.Excel.ErrorCellValueType.notAvailable
...
import typings.officeJsPreview.officeJsPreviewStrings.NumbersignNSlashAExclamationmark
...
object NotAvailableErrorCellValue {
  ...
  inline def apply(`type`: typings.officeJsPreview.Excel.CellValueType.error | Error): NotAvailableErrorCellValue = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NotAvailableErrorCellValue] (val x: Self) extends AnyVal {
