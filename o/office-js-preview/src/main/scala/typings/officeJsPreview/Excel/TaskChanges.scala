...
object TaskChanges {
  ...
  inline def apply(): TaskChanges = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TaskChanges]
  }
  
  extension [Self <: TaskChanges](x: Self) {
    ...
    inline def setEmailsToAssign(value: js.Array[String]): Self = StObject.set(x, "emailsToAssign", value.asInstanceOf[js.Any])
    
    inline def setEmailsToAssignUndefined: Self = StObject.set(x, "emailsToAssign", js.undefined)
    
    inline def setEmailsToAssignVarargs(value: String*): Self = StObject.set(x, "emailsToAssign", js.Array(value :_*))
    
    inline def setEmailsToUnassign(value: js.Array[String]): Self = StObject.set(x, "emailsToUnassign", value.asInstanceOf[js.Any])
    
    inline def setEmailsToUnassignUndefined: Self = StObject.set(x, "emailsToUnassign", js.undefined)
    
    inline def setEmailsToUnassignVarargs(value: String*): Self = StObject.set(x, "emailsToUnassign", js.Array(value :_*))
    ...
    inline def setRemoveAllPreviousAssignees(value: Boolean): Self = StObject.set(x, "removeAllPreviousAssignees", value.asInstanceOf[js.Any])
    
    inline def setRemoveAllPreviousAssigneesUndefined: Self = StObject.set(x, "removeAllPreviousAssignees", js.undefined)
