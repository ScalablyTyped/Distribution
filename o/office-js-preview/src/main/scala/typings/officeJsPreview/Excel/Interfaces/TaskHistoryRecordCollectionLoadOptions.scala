...
/**
  ...
  */
@js.native
trait TaskHistoryRecordCollectionLoadOptions extends StObject {
...
object TaskHistoryRecordCollectionLoadOptions {
  
  @scala.inline
  def apply(): TaskHistoryRecordCollectionLoadOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TaskHistoryRecordCollectionLoadOptions]
  }
  
  @scala.inline
  implicit class TaskHistoryRecordCollectionLoadOptionsMutableBuilder[Self <: TaskHistoryRecordCollectionLoadOptions] (val x: Self) extends AnyVal {
