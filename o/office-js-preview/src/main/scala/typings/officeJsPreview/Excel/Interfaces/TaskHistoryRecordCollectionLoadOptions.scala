...
/**
  ...
  */
@js.native
trait TaskHistoryRecordCollectionLoadOptions extends js.Object {
...
object TaskHistoryRecordCollectionLoadOptions {
  ...
  @scala.inline
  implicit class TaskHistoryRecordCollectionLoadOptionsOps[Self <: TaskHistoryRecordCollectionLoadOptions] (val x: Self) extends AnyVal {
