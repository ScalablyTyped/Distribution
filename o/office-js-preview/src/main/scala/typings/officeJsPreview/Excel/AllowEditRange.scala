...
import typings.officeJsPreview.Excel.Interfaces.AllowEditRangeData
import typings.officeJsPreview.Excel.Interfaces.AllowEditRangeLoadOptions
import typings.officeJsPreview.Excel.Interfaces.AllowEditRangeUpdateData
