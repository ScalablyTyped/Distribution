...
object TableColumnCollectionLoadOptions {
  ...
  @scala.inline
  def apply(): TableColumnCollectionLoadOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TableColumnCollectionLoadOptions]
  }
  
  @scala.inline
  implicit class TableColumnCollectionLoadOptionsMutableBuilder[Self <: TableColumnCollectionLoadOptions] (val x: Self) extends AnyVal {
