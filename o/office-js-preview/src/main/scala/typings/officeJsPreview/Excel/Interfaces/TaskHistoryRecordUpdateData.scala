...
object TaskHistoryRecordUpdateData {
  ...
  inline def apply(): TaskHistoryRecordUpdateData = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TaskHistoryRecordUpdateData]
  }
  
  extension [Self <: TaskHistoryRecordUpdateData](x: Self) {
    ...
    inline def setAssignee(value: User): Self = StObject.set(x, "assignee", value.asInstanceOf[js.Any])
    
    inline def setAssigneeUndefined: Self = StObject.set(x, "assignee", js.undefined)
    
    inline def setAttributionUser(value: User): Self = StObject.set(x, "attributionUser", value.asInstanceOf[js.Any])
    ...
    inline def setHistoryRecordCreatedDate(value: Date): Self = StObject.set(x, "historyRecordCreatedDate", value.asInstanceOf[js.Any])
    ...
    inline def setUndoHistoryId(value: String): Self = StObject.set(x, "undoHistoryId", value.asInstanceOf[js.Any])
