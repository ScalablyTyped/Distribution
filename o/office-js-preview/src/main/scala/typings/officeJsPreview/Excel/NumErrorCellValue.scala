...
import typings.officeJsPreview.Excel.ErrorCellValueType.num
import typings.officeJsPreview.Excel.RangeValueType.error
import typings.officeJsPreview.officeJsPreviewStrings.ArrayTooLarge
import typings.officeJsPreview.officeJsPreviewStrings.Error
import typings.officeJsPreview.officeJsPreviewStrings.Num
import typings.officeJsPreview.officeJsPreviewStrings.NumbersignNUMExclamationmark
...
object NumErrorCellValue {
  ...
  inline def apply(`type`: typings.officeJsPreview.Excel.CellValueType.error | Error): NumErrorCellValue = {
