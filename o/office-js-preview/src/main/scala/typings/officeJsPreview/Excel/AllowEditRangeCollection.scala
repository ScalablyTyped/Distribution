...
import typings.officeJsPreview.Excel.Interfaces.AllowEditRangeCollectionData
import typings.officeJsPreview.Excel.Interfaces.AllowEditRangeCollectionLoadOptions
