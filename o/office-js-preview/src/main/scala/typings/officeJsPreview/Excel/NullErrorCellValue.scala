...
import typings.officeJsPreview.Excel.ErrorCellValueType.`null`
import typings.officeJsPreview.Excel.RangeValueType.error
import typings.officeJsPreview.officeJsPreviewStrings.Error
import typings.officeJsPreview.officeJsPreviewStrings.Null
import typings.officeJsPreview.officeJsPreviewStrings.NumbersignNULLExclamationmark
...
object NullErrorCellValue {
  ...
  inline def apply(`type`: typings.officeJsPreview.Excel.CellValueType.error | Error): NullErrorCellValue = {
