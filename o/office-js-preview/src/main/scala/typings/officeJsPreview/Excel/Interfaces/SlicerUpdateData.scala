...
object SlicerUpdateData {
  ...
  @scala.inline
  implicit class SlicerUpdateDataMutableBuilder[Self <: SlicerUpdateData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNameInFormula(value: String): Self = StObject.set(x, "nameInFormula", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSlicerStyle(value: SlicerStyleUpdateData): Self = StObject.set(x, "slicerStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setWorksheet(value: WorksheetUpdateData): Self = StObject.set(x, "worksheet", value.asInstanceOf[js.Any])
