...
import typings.officeJsPreview.Excel.Interfaces.PivotTableStyleData
import typings.officeJsPreview.Excel.Interfaces.PivotTableStyleLoadOptions
import typings.officeJsPreview.Excel.Interfaces.PivotTableStyleUpdateData
