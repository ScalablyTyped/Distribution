...
import typings.officeJsPreview.Excel.ErrorCellValueType.external
import typings.officeJsPreview.Excel.RangeValueType.error
import typings.officeJsPreview.officeJsPreviewStrings.Error
import typings.officeJsPreview.officeJsPreviewStrings.External
import typings.officeJsPreview.officeJsPreviewStrings.NumbersignEXTERNALExclamationmark
...
object ExternalErrorCellValue {
  ...
  inline def apply(`type`: typings.officeJsPreview.Excel.CellValueType.error | Error): ExternalErrorCellValue = {
