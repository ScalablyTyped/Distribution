...
import typings.officeJsPreview.Excel.Interfaces.TableColumnData
import typings.officeJsPreview.Excel.Interfaces.TableColumnLoadOptions
import typings.officeJsPreview.Excel.Interfaces.TableColumnUpdateData
