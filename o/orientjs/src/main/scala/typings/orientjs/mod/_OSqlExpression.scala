...
object _OSqlExpression {
  ...
  @scala.inline
  def ORawExpression(as: String => typings.orientjs.mod.ORawExpression, db: ODB, value: String): typings.orientjs.mod.ORawExpression = {
  ...
  @scala.inline
  def OSqlFunction(abs: AbsSqlFunction, avg: AbsSqlFunction, db: ODB, sequence: SequenceSqlFunction): typings.orientjs.mod.OSqlFunction = {
