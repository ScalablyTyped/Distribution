...
class Db () extends EventEmitter {
  ...
  /**
    ...
    */
  def close(): typings.bluebird.bluebirdMod.^[Db] = js.native
  /**
  ...
  def create[T](paramtype: String, paramname: String): Statement[T] = js.native
  def createFn(fn: js.Function1[/* repeated */ js.Any, _]): typings.bluebird.bluebirdMod.^[_] = js.native
  def createFn(fn: js.Function1[/* repeated */ js.Any, _], options: js.Any): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
    ...
    */
  def createFn(name: String, fn: js.Function1[/* repeated */ js.Any, _]): typings.bluebird.bluebirdMod.^[_] = js.native
  def createFn(name: String, fn: js.Function1[/* repeated */ js.Any, _], options: js.Any): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
  ...
  /**
    ...
    * @promise {Mixed}          The results of the query / command.
    */
  def exec(query: String): typings.bluebird.bluebirdMod.^[_] = js.native
  def exec(query: String, options: QueryOptions): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
  ...
  def let[T](name: String, value: String): Statement[T] = js.native
  def let[T](name: String, value: Statement[T]): Statement[T] = js.native
  ...
  /**
    ...
    */
  def liveQuery(command: String): typings.bluebird.bluebirdMod.^[_] = js.native
  def liveQuery(command: String, options: QueryOptions): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
  ...
  /**
    ...
    */
  def open(): typings.bluebird.bluebirdMod.^[Db] = js.native
  /**
    ...
    * @promise {Mixed}          The results of the query / command.
    */
  def query(command: String): typings.bluebird.bluebirdMod.^[_] = js.native
  def query(command: String, options: QueryOptions): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
    * Create a raw expression.
    *
    * @return The raw expression instance.
    */
  def rawExpression(param: String): RawExpression = js.native
  /**
    ...
    */
  def registerTransformer[T](className: String, transformer: js.Function1[/* item */ Record, T]): Db = js.native
  /**
    * Reload the configuration for the database.
    *
    * @promise {Db}  The database with reloaded configuration.
    */
  def reload(): typings.bluebird.bluebirdMod.^[Db] = js.native
  /**
  ...
  /**
    ...
    */
  def send(operation: Double, data: js.Any): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
