...
class Db ()
  ...
  /**
    ...
    */
  def close(): bluebirdLib.bluebirdMod.^[Db] = js.native
  /**
  ...
  def createFn(fn: js.Function1[/* repeated */ js.Any, _]): bluebirdLib.bluebirdMod.^[_] = js.native
  def createFn(fn: js.Function1[/* repeated */ js.Any, _], options: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    ...
    */
  def createFn(name: java.lang.String, fn: js.Function1[/* repeated */ js.Any, _]): bluebirdLib.bluebirdMod.^[_] = js.native
  def createFn(name: java.lang.String, fn: js.Function1[/* repeated */ js.Any, _], options: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
  ...
  /**
    ...
    * @promise {Mixed}          The results of the query / command.
    */
  def exec(query: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def exec(query: java.lang.String, options: QueryOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
  ...
  /**
    ...
    */
  def liveQuery(command: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def liveQuery(command: java.lang.String, options: QueryOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
  ...
  /**
    ...
    */
  def open(): bluebirdLib.bluebirdMod.^[Db] = js.native
  /**
    ...
    * @promise {Mixed}          The results of the query / command.
    */
  def query(command: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def query(command: java.lang.String, options: QueryOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
  ...
  /**
    ...
    */
  def reload(): bluebirdLib.bluebirdMod.^[Db] = js.native
  /**
  ...
  /**
    ...
    */
  def send(operation: scala.Double, data: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
