...
class Server () extends js.Object {
  ...
  /**
    ...
    */
  def create(name: java.lang.String): bluebirdLib.bluebirdMod.^[Db] = js.native
  def create(name: DbConfig): bluebirdLib.bluebirdMod.^[Db] = js.native
  /**
  ...
  def drop(name: DbConfig): bluebirdLib.bluebirdMod.^[Db] = js.native
  /**
    ...
    */
  def exists(name: java.lang.String): bluebirdLib.bluebirdMod.^[scala.Boolean] = js.native
  def exists(name: java.lang.String, storageType: java.lang.String): bluebirdLib.bluebirdMod.^[scala.Boolean] = js.native
  /**
  ...
  /**
    ...
    */
  def list(): bluebirdLib.bluebirdMod.^[js.Array[Db]] = js.native
  /**
  ...
  def shutdown(): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
