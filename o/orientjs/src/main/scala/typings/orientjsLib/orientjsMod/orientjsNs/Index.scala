...
trait Index extends js.Object {
  ...
  def add(idx: js.Array[IndexEntry]): bluebirdLib.bluebirdMod.namespaced[js.Array[Index]] = js.native
  def add(idx: IndexEntry): bluebirdLib.bluebirdMod.namespaced[js.Array[Index]] = js.native
  def cacheData(indices: js.Array[_]): bluebirdLib.bluebirdMod.namespaced[Db] = js.native
  def configure(config: js.Any): scala.Unit = js.native
  def create(config: js.Array[IndexConfig]): bluebirdLib.bluebirdMod.namespaced[Index] = js.native
  def create(config: IndexConfig): bluebirdLib.bluebirdMod.namespaced[Index] = js.native
  def delete(name: java.lang.String): bluebirdLib.bluebirdMod.namespaced[Index] = js.native
  def drop(name: java.lang.String): bluebirdLib.bluebirdMod.namespaced[Db] = js.native
  def get(name: java.lang.String): bluebirdLib.bluebirdMod.namespaced[Index] = js.native
