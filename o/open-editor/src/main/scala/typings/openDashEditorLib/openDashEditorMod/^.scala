...
object ^ extends js.Object {
  /**
  	...
  	```
  	*/
  def apply(files: js.Array[lineDashColumnDashPathLib.lineDashColumnDashPathMod.PathLike]): scala.Unit = js.native
  def apply(files: js.Array[lineDashColumnDashPathLib.lineDashColumnDashPathMod.PathLike], options: Options): scala.Unit = js.native
  /**
  	...
  	```
  	*/
  def make(files: js.Array[lineDashColumnDashPathLib.lineDashColumnDashPathMod.PathLike]): EditorRunConfig = js.native
  def make(files: js.Array[lineDashColumnDashPathLib.lineDashColumnDashPathMod.PathLike], options: Options): EditorRunConfig = js.native
}
