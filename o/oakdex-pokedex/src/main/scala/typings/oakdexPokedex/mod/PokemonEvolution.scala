...
object PokemonEvolution {
  ...
  def apply(
    ...
    if (!js.isUndefined(happiness)) __obj.updateDynamic("happiness")(happiness.get.asInstanceOf[js.Any])
    if (hold_item != null) __obj.updateDynamic("hold_item")(hold_item.asInstanceOf[js.Any])
    if (item != null) __obj.updateDynamic("item")(item.asInstanceOf[js.Any])
    if (!js.isUndefined(level)) __obj.updateDynamic("level")(level.get.asInstanceOf[js.Any])
    if (!js.isUndefined(level_up)) __obj.updateDynamic("level_up")(level_up.get.asInstanceOf[js.Any])
    if (move_learned != null) __obj.updateDynamic("move_learned")(move_learned.asInstanceOf[js.Any])
    if (!js.isUndefined(trade)) __obj.updateDynamic("trade")(trade.get.asInstanceOf[js.Any])
