...
object abstractAsyncHooksContextManagerMod {
  
  @JSImport("@opentelemetry/context-async-hooks/build/src/AbstractAsyncHooksContextManager", "AbstractAsyncHooksContextManager")
  @js.native
