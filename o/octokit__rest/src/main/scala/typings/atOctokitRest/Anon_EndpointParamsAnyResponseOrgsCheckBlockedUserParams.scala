...
@js.native
trait Anon_EndpointParamsAnyResponseOrgsCheckBlockedUserParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: OrgsCheckBlockedUserParams): js.Promise[AnyResponse] = js.native
