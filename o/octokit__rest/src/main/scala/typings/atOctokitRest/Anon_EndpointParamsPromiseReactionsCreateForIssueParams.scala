...
trait Anon_EndpointParamsPromiseReactionsCreateForIssueParams extends js.Object {
  ...
  def apply(params: ReactionsCreateForIssueParams): js.Promise[Response[ReactionsCreateForIssueResponse]] = js.native
  def apply(params: ReactionsCreateForIssueParamsDeprecatedNumber): js.Promise[Response[ReactionsCreateForIssueResponse]] = js.native
