...
@js.native
trait Anon_EndpointParamsPromiseReposCreateUsingTemplateParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[ReposCreateUsingTemplateResponse]] = js.native
  def apply(params: ReposCreateUsingTemplateParams): js.Promise[Response[ReposCreateUsingTemplateResponse]] = js.native
