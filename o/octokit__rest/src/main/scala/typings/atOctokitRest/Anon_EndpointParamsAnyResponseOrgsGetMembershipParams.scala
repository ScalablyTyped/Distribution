...
@js.native
trait Anon_EndpointParamsAnyResponseOrgsGetMembershipParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: OrgsGetMembershipParams): js.Promise[AnyResponse] = js.native
