...
@js.native
trait Anon_EndpointParamsPromiseReactionsListForCommitCommentParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[ReactionsListForCommitCommentResponse]] = js.native
  def apply(params: ReactionsListForCommitCommentParams): js.Promise[Response[ReactionsListForCommitCommentResponse]] = js.native
