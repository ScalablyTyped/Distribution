...
@js.native
trait Anon_EndpointParamsOrgsListBlockedUsersParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[OrgsListBlockedUsersResponse]] = js.native
  def apply(params: OrgsListBlockedUsersParams): js.Promise[Response[OrgsListBlockedUsersResponse]] = js.native
