...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseTeamsRemoveProjectParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: TeamsRemoveProjectParams): js.Promise[AnyResponse] = js.native
