...
trait Anon_AddOrUpdateRestrictionsForOrg extends js.Object {
  ...
  def addOrUpdateRestrictionsForOrg(params: InteractionsAddOrUpdateRestrictionsForOrgParams): js.Promise[Response[InteractionsAddOrUpdateRestrictionsForOrgResponse]] = js.native
  /**
    * Temporarily restricts interactions to certain GitHub users within the given repository. You must have owner or admin access to set restrictions.
    */
  def addOrUpdateRestrictionsForRepo(): js.Promise[Response[InteractionsAddOrUpdateRestrictionsForRepoResponse]] = js.native
  def addOrUpdateRestrictionsForRepo(params: InteractionsAddOrUpdateRestrictionsForRepoParams): js.Promise[Response[InteractionsAddOrUpdateRestrictionsForRepoResponse]] = js.native
  /**
    * Shows which group of GitHub users can interact with this organization and when the restriction expires. If there are no restrictions, you will see an empty response.
    */
  def getRestrictionsForOrg(): js.Promise[Response[InteractionsGetRestrictionsForOrgResponse]] = js.native
  def getRestrictionsForOrg(params: InteractionsGetRestrictionsForOrgParams): js.Promise[Response[InteractionsGetRestrictionsForOrgResponse]] = js.native
  /**
    * Shows which group of GitHub users can interact with this repository and when the restriction expires. If there are no restrictions, you will see an empty response.
    */
  def getRestrictionsForRepo(): js.Promise[Response[InteractionsGetRestrictionsForRepoResponse]] = js.native
  def getRestrictionsForRepo(params: InteractionsGetRestrictionsForRepoParams): js.Promise[Response[InteractionsGetRestrictionsForRepoResponse]] = js.native
  /**
    * Removes all interaction restrictions from public repositories in the given organization. You must be an organization owner to remove restrictions.
    */
