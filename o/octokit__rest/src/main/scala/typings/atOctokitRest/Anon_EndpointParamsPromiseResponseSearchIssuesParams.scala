...
@js.native
trait Anon_EndpointParamsPromiseResponseSearchIssuesParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[SearchIssuesResponse]] = js.native
  def apply(params: SearchIssuesParams): js.Promise[Response[SearchIssuesResponse]] = js.native
