...
@js.native
trait Anon_EndpointParamsAnyResponseProjectsUpdateCardParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: ProjectsUpdateCardParams): js.Promise[AnyResponse] = js.native
