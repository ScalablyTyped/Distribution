...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseUsersDeletePublicKeyParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: UsersDeletePublicKeyParams): js.Promise[AnyResponse] = js.native
