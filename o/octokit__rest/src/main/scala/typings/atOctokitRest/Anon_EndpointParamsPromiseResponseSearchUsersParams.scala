...
@js.native
trait Anon_EndpointParamsPromiseResponseSearchUsersParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[SearchUsersResponse]] = js.native
  def apply(params: SearchUsersParams): js.Promise[Response[SearchUsersResponse]] = js.native
