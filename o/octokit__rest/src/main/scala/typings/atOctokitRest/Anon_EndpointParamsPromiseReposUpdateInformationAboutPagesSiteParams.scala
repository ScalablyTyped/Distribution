...
trait Anon_EndpointParamsPromiseReposUpdateInformationAboutPagesSiteParams extends js.Object {
  ...
  def apply(): js.Promise[Response[ReposUpdateInformationAboutPagesSiteResponse]] = js.native
  def apply(params: ReposUpdateInformationAboutPagesSiteParams): js.Promise[Response[ReposUpdateInformationAboutPagesSiteResponse]] = js.native
