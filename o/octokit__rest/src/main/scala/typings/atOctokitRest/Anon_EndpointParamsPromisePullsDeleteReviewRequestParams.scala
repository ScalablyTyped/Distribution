...
trait Anon_EndpointParamsPromisePullsDeleteReviewRequestParams extends js.Object {
  ...
  def apply(): js.Promise[Response[PullsDeleteReviewRequestResponse]] = js.native
  def apply(params: PullsDeleteReviewRequestParams): js.Promise[Response[PullsDeleteReviewRequestResponse]] = js.native
  def apply(params: PullsDeleteReviewRequestParamsDeprecatedNumber): js.Promise[Response[PullsDeleteReviewRequestResponse]] = js.native
