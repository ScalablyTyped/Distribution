...
trait Anon_EndpointParamsPromisePullsSubmitReviewParams extends js.Object {
  ...
  def apply(params: PullsSubmitReviewParams): js.Promise[Response[PullsSubmitReviewResponse]] = js.native
  def apply(params: PullsSubmitReviewParamsDeprecatedNumber): js.Promise[Response[PullsSubmitReviewResponse]] = js.native
