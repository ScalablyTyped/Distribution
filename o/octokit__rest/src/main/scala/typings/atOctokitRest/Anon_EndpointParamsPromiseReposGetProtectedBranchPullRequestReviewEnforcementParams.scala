...
trait Anon_EndpointParamsPromiseReposGetProtectedBranchPullRequestReviewEnforcementParams extends js.Object {
  ...
  def apply(params: ReposGetProtectedBranchPullRequestReviewEnforcementParams): js.Promise[Response[ReposGetProtectedBranchPullRequestReviewEnforcementResponse]] = js.native
