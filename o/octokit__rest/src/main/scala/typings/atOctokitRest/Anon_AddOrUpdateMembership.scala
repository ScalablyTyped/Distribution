...
trait Anon_AddOrUpdateMembership extends js.Object {
  ...
  def convertMemberToOutsideCollaborator(params: OrgsConvertMemberToOutsideCollaboratorParams): js.Promise[Response[OrgsConvertMemberToOutsideCollaboratorResponse]] = js.native
  /**
    * Here's how you can create a hook that posts payloads in JSON format:
    */
  def createHook(): js.Promise[Response[OrgsCreateHookResponse]] = js.native
  def createHook(params: OrgsCreateHookParams): js.Promise[Response[OrgsCreateHookResponse]] = js.native
  /**
    * Invite people to an organization by using their GitHub user ID or their email address. In order to create invitations in an organization, the authenticated user must be an organization owner.
    *
    * This endpoint triggers [notifications](https://help.github.com/articles/about-notifications/). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://developer.github.com/v3/#abuse-rate-limits)" and "[Dealing with abuse rate limits](https://developer.github.com/v3/guides/best-practices-for-integrators/#dealing-with-abuse-rate-limits)" for details.
  ...
  def get(params: OrgsGetParams): js.Promise[Response[OrgsGetResponse]] = js.native
  def getHook(): js.Promise[Response[OrgsGetHookResponse]] = js.native
  def getHook(params: OrgsGetHookParams): js.Promise[Response[OrgsGetHookResponse]] = js.native
  /**
    * In order to get a user's membership with an organization, the authenticated user must be an organization member.
    */
  ...
  def list(params: OrgsListParams): js.Promise[Response[OrgsListResponse]] = js.native
  /**
    * List the users blocked by an organization.
    */
  def listBlockedUsers(): js.Promise[Response[OrgsListBlockedUsersResponse]] = js.native
  def listBlockedUsers(params: OrgsListBlockedUsersParams): js.Promise[Response[OrgsListBlockedUsersResponse]] = js.native
  /**
    * List organizations for the authenticated user.
    *
    * **OAuth scope requirements**
  ...
  def listForAuthenticatedUser(params: OrgsListForAuthenticatedUserParams): js.Promise[Response[OrgsListForAuthenticatedUserResponse]] = js.native
  /**
    * List [public organization memberships](https://help.github.com/articles/publicizing-or-concealing-organization-membership) for the specified user.
    *
    * This method only lists _public_ memberships, regardless of authentication. If you need to fetch all of the organization memberships (public and private) for the authenticated user, use the [List your organizations](https://developer.github.com/v3/orgs/#list-your-organizations) API instead.
  ...
  def listForUser(params: OrgsListForUserParams): js.Promise[Response[OrgsListForUserResponse]] = js.native
  def listHooks(): js.Promise[Response[OrgsListHooksResponse]] = js.native
  def listHooks(params: OrgsListHooksParams): js.Promise[Response[OrgsListHooksResponse]] = js.native
  /**
    * List all teams associated with an invitation. In order to see invitations in an organization, the authenticated user must be an organization owner.
    */
  def listInvitationTeams(): js.Promise[Response[OrgsListInvitationTeamsResponse]] = js.native
  def listInvitationTeams(params: OrgsListInvitationTeamsParams): js.Promise[Response[OrgsListInvitationTeamsResponse]] = js.native
  /**
    * List all users who are members of an organization. If the authenticated user is also a member of this organization then both concealed and public members will be returned.
    */
  def listMembers(): js.Promise[Response[OrgsListMembersResponse]] = js.native
  def listMembers(params: OrgsListMembersParams): js.Promise[Response[OrgsListMembersResponse]] = js.native
  def listMemberships(): js.Promise[Response[OrgsListMembershipsResponse]] = js.native
  def listMemberships(params: OrgsListMembershipsParams): js.Promise[Response[OrgsListMembershipsResponse]] = js.native
  /**
    * List all users who are outside collaborators of an organization.
    */
  def listOutsideCollaborators(): js.Promise[Response[OrgsListOutsideCollaboratorsResponse]] = js.native
  def listOutsideCollaborators(params: OrgsListOutsideCollaboratorsParams): js.Promise[Response[OrgsListOutsideCollaboratorsResponse]] = js.native
  /**
    * The return hash contains a `role` field which refers to the Organization Invitation role and will be one of the following values: `direct_member`, `admin`, `billing_manager`, `hiring_manager`, or `reinstate`. If the invitee is not a GitHub member, the `login` field in the return hash will be `null`.
    */
  def listPendingInvitations(): js.Promise[Response[OrgsListPendingInvitationsResponse]] = js.native
  def listPendingInvitations(params: OrgsListPendingInvitationsParams): js.Promise[Response[OrgsListPendingInvitationsResponse]] = js.native
  /**
    * Members of an organization can choose to have their membership publicized or not.
    */
  def listPublicMembers(): js.Promise[Response[OrgsListPublicMembersResponse]] = js.native
  def listPublicMembers(params: OrgsListPublicMembersParams): js.Promise[Response[OrgsListPublicMembersResponse]] = js.native
  /**
    * This will trigger a [ping event](https://developer.github.com/webhooks/#ping-event) to be sent to the hook.
    */
  ...
  def update(params: OrgsUpdateParams): js.Promise[Response[OrgsUpdateResponse]] = js.native
  def updateHook(): js.Promise[Response[OrgsUpdateHookResponse]] = js.native
  def updateHook(params: OrgsUpdateHookParams): js.Promise[Response[OrgsUpdateHookResponse]] = js.native
  def updateMembership(): js.Promise[Response[OrgsUpdateMembershipResponse]] = js.native
  def updateMembership(params: OrgsUpdateMembershipParams): js.Promise[Response[OrgsUpdateMembershipResponse]] = js.native
}
