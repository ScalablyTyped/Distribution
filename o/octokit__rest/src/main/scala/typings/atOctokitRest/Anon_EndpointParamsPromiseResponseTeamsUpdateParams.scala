...
@js.native
trait Anon_EndpointParamsPromiseResponseTeamsUpdateParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[TeamsUpdateResponse]] = js.native
  def apply(params: TeamsUpdateParams): js.Promise[Response[TeamsUpdateResponse]] = js.native
