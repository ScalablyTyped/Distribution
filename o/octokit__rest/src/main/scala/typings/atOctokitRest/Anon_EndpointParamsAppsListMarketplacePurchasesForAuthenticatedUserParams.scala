...
trait Anon_EndpointParamsAppsListMarketplacePurchasesForAuthenticatedUserParams extends js.Object {
  ...
  def apply(params: AppsListMarketplacePurchasesForAuthenticatedUserParams): js.Promise[Response[AppsListMarketplacePurchasesForAuthenticatedUserResponse]] = js.native
