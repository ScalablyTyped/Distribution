...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseUsersDeleteGpgKeyParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: UsersDeleteGpgKeyParams): js.Promise[AnyResponse] = js.native
