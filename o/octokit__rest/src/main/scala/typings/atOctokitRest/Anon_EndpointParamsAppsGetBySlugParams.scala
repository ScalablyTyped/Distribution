...
@js.native
trait Anon_EndpointParamsAppsGetBySlugParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[AppsGetBySlugResponse]] = js.native
  def apply(params: AppsGetBySlugParams): js.Promise[Response[AppsGetBySlugResponse]] = js.native
