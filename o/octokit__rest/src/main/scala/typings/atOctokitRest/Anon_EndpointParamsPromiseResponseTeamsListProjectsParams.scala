...
@js.native
trait Anon_EndpointParamsPromiseResponseTeamsListProjectsParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[TeamsListProjectsResponse]] = js.native
  def apply(params: TeamsListProjectsParams): js.Promise[Response[TeamsListProjectsResponse]] = js.native
