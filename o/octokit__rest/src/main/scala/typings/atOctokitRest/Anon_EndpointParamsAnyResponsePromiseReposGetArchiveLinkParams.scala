...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseReposGetArchiveLinkParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: ReposGetArchiveLinkParams): js.Promise[AnyResponse] = js.native
