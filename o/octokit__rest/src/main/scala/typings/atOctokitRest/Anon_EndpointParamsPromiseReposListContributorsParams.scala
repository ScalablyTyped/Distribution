...
@js.native
trait Anon_EndpointParamsPromiseReposListContributorsParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[ReposListContributorsResponse]] = js.native
  def apply(params: ReposListContributorsParams): js.Promise[Response[ReposListContributorsResponse]] = js.native
