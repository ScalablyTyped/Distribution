...
@js.native
trait Anon_EndpointParamsIssuesCreateMilestoneParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[IssuesCreateMilestoneResponse]] = js.native
  def apply(params: IssuesCreateMilestoneParams): js.Promise[Response[IssuesCreateMilestoneResponse]] = js.native
