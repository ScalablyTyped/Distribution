...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseTeamsRemoveMembershipParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: TeamsRemoveMembershipParams): js.Promise[AnyResponse] = js.native
