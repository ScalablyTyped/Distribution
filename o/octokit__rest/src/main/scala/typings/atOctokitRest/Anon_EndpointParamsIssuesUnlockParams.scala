...
trait Anon_EndpointParamsIssuesUnlockParams extends js.Object {
  ...
  def apply(): js.Promise[Response[IssuesUnlockResponse]] = js.native
  def apply(params: IssuesUnlockParams): js.Promise[Response[IssuesUnlockResponse]] = js.native
  def apply(params: IssuesUnlockParamsDeprecatedNumber): js.Promise[Response[IssuesUnlockResponse]] = js.native
