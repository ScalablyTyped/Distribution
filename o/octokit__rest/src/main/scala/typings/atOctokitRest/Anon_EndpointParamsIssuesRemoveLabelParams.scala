...
trait Anon_EndpointParamsIssuesRemoveLabelParams extends js.Object {
  ...
  def apply(params: IssuesRemoveLabelParams): js.Promise[Response[IssuesRemoveLabelResponse]] = js.native
  def apply(params: IssuesRemoveLabelParamsDeprecatedNumber): js.Promise[Response[IssuesRemoveLabelResponse]] = js.native
