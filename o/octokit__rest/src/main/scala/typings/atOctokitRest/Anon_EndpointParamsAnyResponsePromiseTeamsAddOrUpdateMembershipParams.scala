...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseTeamsAddOrUpdateMembershipParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: TeamsAddOrUpdateMembershipParams): js.Promise[AnyResponse] = js.native
