...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersListPublicKeysParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[UsersListPublicKeysResponse]] = js.native
  def apply(params: UsersListPublicKeysParams): js.Promise[Response[UsersListPublicKeysResponse]] = js.native
