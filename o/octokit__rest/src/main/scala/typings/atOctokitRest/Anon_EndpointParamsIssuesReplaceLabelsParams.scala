...
trait Anon_EndpointParamsIssuesReplaceLabelsParams extends js.Object {
  ...
  def apply(params: IssuesReplaceLabelsParams): js.Promise[Response[IssuesReplaceLabelsResponse]] = js.native
  def apply(params: IssuesReplaceLabelsParamsDeprecatedNumber): js.Promise[Response[IssuesReplaceLabelsResponse]] = js.native
