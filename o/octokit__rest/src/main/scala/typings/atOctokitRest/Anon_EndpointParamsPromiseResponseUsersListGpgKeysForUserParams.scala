...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersListGpgKeysForUserParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[UsersListGpgKeysForUserResponse]] = js.native
  def apply(params: UsersListGpgKeysForUserParams): js.Promise[Response[UsersListGpgKeysForUserResponse]] = js.native
