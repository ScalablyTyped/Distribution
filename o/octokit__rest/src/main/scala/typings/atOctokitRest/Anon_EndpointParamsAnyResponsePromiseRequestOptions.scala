...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseRequestOptions extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: RequestOptions with TeamsAddOrUpdateRepoParams): js.Promise[AnyResponse] = js.native
