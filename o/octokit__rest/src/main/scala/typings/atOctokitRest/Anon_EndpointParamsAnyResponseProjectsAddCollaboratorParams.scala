...
@js.native
trait Anon_EndpointParamsAnyResponseProjectsAddCollaboratorParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: ProjectsAddCollaboratorParams): js.Promise[AnyResponse] = js.native
