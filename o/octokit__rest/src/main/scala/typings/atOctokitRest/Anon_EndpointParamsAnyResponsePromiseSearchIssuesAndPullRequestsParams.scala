...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseSearchIssuesAndPullRequestsParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: SearchIssuesAndPullRequestsParams): js.Promise[AnyResponse] = js.native
