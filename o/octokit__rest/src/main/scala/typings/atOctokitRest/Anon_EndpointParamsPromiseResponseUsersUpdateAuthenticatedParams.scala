...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersUpdateAuthenticatedParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[UsersUpdateAuthenticatedResponse]] = js.native
  def apply(params: UsersUpdateAuthenticatedParams): js.Promise[Response[UsersUpdateAuthenticatedResponse]] = js.native
