...
@js.native
trait Anon_EndpointParamsPromiseResponseSearchIssuesAndPullRequestsParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[SearchIssuesAndPullRequestsResponse]] = js.native
  def apply(params: SearchIssuesAndPullRequestsParams): js.Promise[Response[SearchIssuesAndPullRequestsResponse]] = js.native
