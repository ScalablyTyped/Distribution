...
@js.native
trait Anon_EndpointParamsPromiseReposGetProtectedBranchAdminEnforcementParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[ReposGetProtectedBranchAdminEnforcementResponse]] = js.native
  def apply(params: ReposGetProtectedBranchAdminEnforcementParams): js.Promise[Response[ReposGetProtectedBranchAdminEnforcementResponse]] = js.native
