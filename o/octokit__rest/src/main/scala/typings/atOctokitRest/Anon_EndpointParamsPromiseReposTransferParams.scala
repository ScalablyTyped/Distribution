...
@js.native
trait Anon_EndpointParamsPromiseReposTransferParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[ReposTransferResponse]] = js.native
  def apply(params: ReposTransferParams): js.Promise[Response[ReposTransferResponse]] = js.native
