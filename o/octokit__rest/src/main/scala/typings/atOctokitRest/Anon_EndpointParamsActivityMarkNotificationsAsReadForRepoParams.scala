...
trait Anon_EndpointParamsActivityMarkNotificationsAsReadForRepoParams extends js.Object {
  ...
  def apply(): js.Promise[Response[ActivityMarkNotificationsAsReadForRepoResponse]] = js.native
  def apply(params: ActivityMarkNotificationsAsReadForRepoParams): js.Promise[Response[ActivityMarkNotificationsAsReadForRepoResponse]] = js.native
