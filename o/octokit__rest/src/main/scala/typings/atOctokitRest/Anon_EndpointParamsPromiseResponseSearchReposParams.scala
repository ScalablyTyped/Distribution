...
@js.native
trait Anon_EndpointParamsPromiseResponseSearchReposParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[SearchReposResponse]] = js.native
  def apply(params: SearchReposParams): js.Promise[Response[SearchReposResponse]] = js.native
