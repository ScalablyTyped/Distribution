...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseTeamsAddOrUpdateRepoParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: TeamsAddOrUpdateRepoParams): js.Promise[AnyResponse] = js.native
