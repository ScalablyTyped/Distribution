...
@js.native
trait Anon_EndpointParamsAnyResponseAppsDeleteInstallationParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: AppsDeleteInstallationParams): js.Promise[AnyResponse] = js.native
