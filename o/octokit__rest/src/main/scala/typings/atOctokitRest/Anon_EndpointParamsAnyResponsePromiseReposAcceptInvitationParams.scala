...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseReposAcceptInvitationParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: ReposAcceptInvitationParams): js.Promise[AnyResponse] = js.native
