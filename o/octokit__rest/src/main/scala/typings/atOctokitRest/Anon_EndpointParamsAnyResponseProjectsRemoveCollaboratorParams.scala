...
@js.native
trait Anon_EndpointParamsAnyResponseProjectsRemoveCollaboratorParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: ProjectsRemoveCollaboratorParams): js.Promise[AnyResponse] = js.native
