...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersAddEmailsParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[UsersAddEmailsResponse]] = js.native
  def apply(params: UsersAddEmailsParams): js.Promise[Response[UsersAddEmailsResponse]] = js.native
