...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseUsersCheckBlockedParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: UsersCheckBlockedParams): js.Promise[AnyResponse] = js.native
