...
@js.native
trait Anon_EndpointParamsAnyResponseMigrationsGetArchiveForOrgParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: MigrationsGetArchiveForOrgParams): js.Promise[AnyResponse] = js.native
