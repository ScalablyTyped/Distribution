...
@js.native
trait Anon_EndpointParamsPromiseResponseSearchCommitsParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[SearchCommitsResponse]] = js.native
  def apply(params: SearchCommitsParams): js.Promise[Response[SearchCommitsResponse]] = js.native
