...
trait Anon_EndpointParamsIssuesListLabelsOnIssueParams extends js.Object {
  ...
  def apply(params: IssuesListLabelsOnIssueParams): js.Promise[Response[IssuesListLabelsOnIssueResponse]] = js.native
  def apply(params: IssuesListLabelsOnIssueParamsDeprecatedNumber): js.Promise[Response[IssuesListLabelsOnIssueResponse]] = js.native
