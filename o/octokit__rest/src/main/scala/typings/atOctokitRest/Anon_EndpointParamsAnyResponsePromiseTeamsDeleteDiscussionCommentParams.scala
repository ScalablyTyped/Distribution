...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseTeamsDeleteDiscussionCommentParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: TeamsDeleteDiscussionCommentParams): js.Promise[AnyResponse] = js.native
