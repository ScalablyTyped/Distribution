...
@js.native
trait Anon_EndpointParamsAnyResponseOrgsAddOrUpdateMembershipParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: OrgsAddOrUpdateMembershipParams): js.Promise[AnyResponse] = js.native
