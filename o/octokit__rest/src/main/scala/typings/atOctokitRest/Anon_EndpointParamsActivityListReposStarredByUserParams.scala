...
@js.native
trait Anon_EndpointParamsActivityListReposStarredByUserParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[ActivityListReposStarredByUserResponse]] = js.native
  def apply(params: ActivityListReposStarredByUserParams): js.Promise[Response[ActivityListReposStarredByUserResponse]] = js.native
