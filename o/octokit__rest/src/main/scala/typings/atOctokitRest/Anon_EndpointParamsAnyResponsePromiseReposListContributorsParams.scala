...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseReposListContributorsParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: ReposListContributorsParams): js.Promise[AnyResponse] = js.native
