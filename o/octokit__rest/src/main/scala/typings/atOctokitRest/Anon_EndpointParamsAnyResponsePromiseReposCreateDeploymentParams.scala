...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseReposCreateDeploymentParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: ReposCreateDeploymentParams): js.Promise[AnyResponse] = js.native
