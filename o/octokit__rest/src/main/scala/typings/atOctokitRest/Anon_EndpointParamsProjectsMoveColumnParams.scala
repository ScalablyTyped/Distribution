...
trait Anon_EndpointParamsProjectsMoveColumnParams extends js.Object {
  ...
  def apply(): js.Promise[Response[ProjectsMoveColumnResponse]] = js.native
  def apply(params: ProjectsMoveColumnParams): js.Promise[Response[ProjectsMoveColumnResponse]] = js.native
