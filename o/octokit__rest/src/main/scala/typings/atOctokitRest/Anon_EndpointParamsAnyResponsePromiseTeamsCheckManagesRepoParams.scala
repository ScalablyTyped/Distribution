...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseTeamsCheckManagesRepoParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: TeamsCheckManagesRepoParams): js.Promise[AnyResponse] = js.native
