...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersListGpgKeysParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[UsersListGpgKeysResponse]] = js.native
  def apply(params: UsersListGpgKeysParams): js.Promise[Response[UsersListGpgKeysResponse]] = js.native
