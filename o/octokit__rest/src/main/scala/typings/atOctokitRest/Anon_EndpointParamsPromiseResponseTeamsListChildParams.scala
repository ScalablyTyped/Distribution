...
@js.native
trait Anon_EndpointParamsPromiseResponseTeamsListChildParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[TeamsListChildResponse]] = js.native
  def apply(params: TeamsListChildParams): js.Promise[Response[TeamsListChildResponse]] = js.native
