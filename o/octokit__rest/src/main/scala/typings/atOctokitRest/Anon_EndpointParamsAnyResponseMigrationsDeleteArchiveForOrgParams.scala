...
@js.native
trait Anon_EndpointParamsAnyResponseMigrationsDeleteArchiveForOrgParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: MigrationsDeleteArchiveForOrgParams): js.Promise[AnyResponse] = js.native
