...
trait Anon_EndpointParamsPromisePullsCreateReviewParams extends js.Object {
  ...
  def apply(params: PullsCreateReviewParams): js.Promise[Response[PullsCreateReviewResponse]] = js.native
  def apply(params: PullsCreateReviewParamsDeprecatedNumber): js.Promise[Response[PullsCreateReviewResponse]] = js.native
