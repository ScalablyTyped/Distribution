...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseTeamsDeleteDiscussionParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: TeamsDeleteDiscussionParams): js.Promise[AnyResponse] = js.native
