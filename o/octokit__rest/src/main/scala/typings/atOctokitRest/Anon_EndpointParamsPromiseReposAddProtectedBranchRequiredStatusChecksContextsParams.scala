...
trait Anon_EndpointParamsPromiseReposAddProtectedBranchRequiredStatusChecksContextsParams extends js.Object {
  ...
  def apply(params: ReposAddProtectedBranchRequiredStatusChecksContextsParams): js.Promise[Response[ReposAddProtectedBranchRequiredStatusChecksContextsResponse]] = js.native
