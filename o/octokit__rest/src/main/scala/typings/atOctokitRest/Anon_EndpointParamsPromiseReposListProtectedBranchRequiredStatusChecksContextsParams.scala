...
trait Anon_EndpointParamsPromiseReposListProtectedBranchRequiredStatusChecksContextsParams extends js.Object {
  ...
  def apply(params: ReposListProtectedBranchRequiredStatusChecksContextsParams): js.Promise[Response[ReposListProtectedBranchRequiredStatusChecksContextsResponse]] = js.native
