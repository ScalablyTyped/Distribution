...
trait Anon_EndpointParamsOauthAuthorizationsGetOrCreateAuthorizationForAppParams extends js.Object {
  ...
  def apply(params: OauthAuthorizationsGetOrCreateAuthorizationForAppParams): js.Promise[Response[OauthAuthorizationsGetOrCreateAuthorizationForAppResponse]] = js.native
