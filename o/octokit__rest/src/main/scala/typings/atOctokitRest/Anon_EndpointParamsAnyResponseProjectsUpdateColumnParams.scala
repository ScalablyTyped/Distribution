...
@js.native
trait Anon_EndpointParamsAnyResponseProjectsUpdateColumnParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: ProjectsUpdateColumnParams): js.Promise[AnyResponse] = js.native
