...
@js.native
trait Anon_EndpointParamsPromiseResponseTeamsGetMembershipParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[TeamsGetMembershipResponse]] = js.native
  def apply(params: TeamsGetMembershipParams): js.Promise[Response[TeamsGetMembershipResponse]] = js.native
