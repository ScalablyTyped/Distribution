...
trait Anon_CheckIsStarred extends js.Object {
  ...
  def checkIsStarred(params: GistsCheckIsStarredParams): js.Promise[AnyResponse] = js.native
  /**
    * Allows you to add a new gist with one or more files.
    *
    * **Note:** Don't name your files "gistfile" with a numerical suffix. This is the format of the automatic naming scheme that Gist uses internally.
  ...
  def fork(params: GistsForkParams): js.Promise[Response[GistsForkResponse]] = js.native
  def get(): js.Promise[Response[GistsGetResponse]] = js.native
  def get(params: GistsGetParams): js.Promise[Response[GistsGetResponse]] = js.native
  def getComment(): js.Promise[Response[GistsGetCommentResponse]] = js.native
  def getComment(params: GistsGetCommentParams): js.Promise[Response[GistsGetCommentResponse]] = js.native
  def getRevision(): js.Promise[Response[GistsGetRevisionResponse]] = js.native
  def getRevision(params: GistsGetRevisionParams): js.Promise[Response[GistsGetRevisionResponse]] = js.native
  def list(): js.Promise[Response[GistsListResponse]] = js.native
  def list(params: GistsListParams): js.Promise[Response[GistsListResponse]] = js.native
  def listComments(): js.Promise[Response[GistsListCommentsResponse]] = js.native
  def listComments(params: GistsListCommentsParams): js.Promise[Response[GistsListCommentsResponse]] = js.native
  def listCommits(): js.Promise[Response[GistsListCommitsResponse]] = js.native
  def listCommits(params: GistsListCommitsParams): js.Promise[Response[GistsListCommitsResponse]] = js.native
  def listForks(): js.Promise[Response[GistsListForksResponse]] = js.native
  def listForks(params: GistsListForksParams): js.Promise[Response[GistsListForksResponse]] = js.native
  /**
    * List all public gists sorted by most recently updated to least recently updated.
    *
    * Note: With [pagination](https://developer.github.com/v3/#pagination), you can fetch up to 3000 gists. For example, you can fetch 100 pages with 30 gists per page or 30 pages with 100 gists per page.
  ...
  def listPublic(params: GistsListPublicParams): js.Promise[Response[GistsListPublicResponse]] = js.native
  def listPublicForUser(): js.Promise[Response[GistsListPublicForUserResponse]] = js.native
  def listPublicForUser(params: GistsListPublicForUserParams): js.Promise[Response[GistsListPublicForUserResponse]] = js.native
  /**
    * List the authenticated user's starred gists:
    */
  def listStarred(): js.Promise[Response[GistsListStarredResponse]] = js.native
  def listStarred(params: GistsListStarredParams): js.Promise[Response[GistsListStarredResponse]] = js.native
  /**
    * Note that you'll need to set `Content-Length` to zero when calling out to this endpoint. For more information, see "[HTTP verbs](https://developer.github.com/v3/#http-verbs)."
    */
  ...
  def update(params: GistsUpdateParams): js.Promise[Response[GistsUpdateResponse]] = js.native
  def updateComment(): js.Promise[Response[GistsUpdateCommentResponse]] = js.native
  def updateComment(params: GistsUpdateCommentParams): js.Promise[Response[GistsUpdateCommentResponse]] = js.native
}
