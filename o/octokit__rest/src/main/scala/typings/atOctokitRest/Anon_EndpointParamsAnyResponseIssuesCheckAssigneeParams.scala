...
@js.native
trait Anon_EndpointParamsAnyResponseIssuesCheckAssigneeParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: IssuesCheckAssigneeParams): js.Promise[AnyResponse] = js.native
