...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersCreateGpgKeyParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[UsersCreateGpgKeyResponse]] = js.native
  def apply(params: UsersCreateGpgKeyParams): js.Promise[Response[UsersCreateGpgKeyResponse]] = js.native
