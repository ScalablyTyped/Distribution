...
trait Anon_EndpointParamsIssuesGetMilestoneParams extends js.Object {
  ...
  def apply(params: IssuesGetMilestoneParams): js.Promise[Response[IssuesGetMilestoneResponse]] = js.native
  def apply(params: IssuesGetMilestoneParamsDeprecatedNumber): js.Promise[Response[IssuesGetMilestoneResponse]] = js.native
