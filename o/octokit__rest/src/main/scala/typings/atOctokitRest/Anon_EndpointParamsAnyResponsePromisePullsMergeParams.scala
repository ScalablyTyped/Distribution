...
@js.native
trait Anon_EndpointParamsAnyResponsePromisePullsMergeParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: PullsMergeParams): js.Promise[AnyResponse] = js.native
  def apply(params: PullsMergeParamsDeprecatedNumber): js.Promise[AnyResponse] = js.native
