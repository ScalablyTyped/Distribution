...
trait Anon_EndpointParamsAppsListMarketplacePurchasesForAuthenticatedUserStubbedParams extends js.Object {
  ...
  def apply(params: AppsListMarketplacePurchasesForAuthenticatedUserStubbedParams): js.Promise[Response[AppsListMarketplacePurchasesForAuthenticatedUserStubbedResponse]] = js.native
