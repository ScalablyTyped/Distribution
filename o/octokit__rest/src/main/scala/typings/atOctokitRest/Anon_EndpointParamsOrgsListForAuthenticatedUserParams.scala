...
@js.native
trait Anon_EndpointParamsOrgsListForAuthenticatedUserParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[OrgsListForAuthenticatedUserResponse]] = js.native
  def apply(params: OrgsListForAuthenticatedUserParams): js.Promise[Response[OrgsListForAuthenticatedUserResponse]] = js.native
