...
@js.native
trait Anon_EndpointParamsAnyResponseOrgsRemoveMembershipParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: OrgsRemoveMembershipParams): js.Promise[AnyResponse] = js.native
