...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseTeamsRemoveRepoParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: TeamsRemoveRepoParams): js.Promise[AnyResponse] = js.native
