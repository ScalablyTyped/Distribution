...
@js.native
trait Anon_EndpointParamsAnyResponseMigrationsUnlockRepoForOrgParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: MigrationsUnlockRepoForOrgParams): js.Promise[AnyResponse] = js.native
