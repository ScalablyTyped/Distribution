...
trait Anon_EndpointParamsPromisePullsListCommentsParams extends js.Object {
  ...
  def apply(params: PullsListCommentsParams): js.Promise[Response[PullsListCommentsResponse]] = js.native
  def apply(params: PullsListCommentsParamsDeprecatedNumber): js.Promise[Response[PullsListCommentsResponse]] = js.native
