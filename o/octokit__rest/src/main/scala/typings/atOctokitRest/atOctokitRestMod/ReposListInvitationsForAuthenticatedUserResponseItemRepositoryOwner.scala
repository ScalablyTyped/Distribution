...
trait ReposListInvitationsForAuthenticatedUserResponseItemRepositoryOwner extends js.Object {
...
object ReposListInvitationsForAuthenticatedUserResponseItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListInvitationsForAuthenticatedUserResponseItemRepositoryOwner]
  }
}
