...
trait IssuesListEventsForRepoResponseItemActor extends js.Object {
...
object IssuesListEventsForRepoResponseItemActor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListEventsForRepoResponseItemActor]
  }
}
