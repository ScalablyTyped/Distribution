...
trait UsersListFollowersForUserResponseItem extends js.Object {
...
object UsersListFollowersForUserResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[UsersListFollowersForUserResponseItem]
  }
}
