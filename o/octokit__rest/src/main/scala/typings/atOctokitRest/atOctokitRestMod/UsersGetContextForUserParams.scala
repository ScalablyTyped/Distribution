...
import typings.atOctokitRest.atOctokitRestStrings.issue
import typings.atOctokitRest.atOctokitRestStrings.organization
import typings.atOctokitRest.atOctokitRestStrings.pull_request
import typings.atOctokitRest.atOctokitRestStrings.repository
