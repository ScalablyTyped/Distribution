...
trait ReposGetUsersWithAccessToProtectedBranchResponseItem extends js.Object {
...
object ReposGetUsersWithAccessToProtectedBranchResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetUsersWithAccessToProtectedBranchResponseItem]
  }
}
