...
trait ActivityListWatchersForRepoResponseItem extends js.Object {
...
object ActivityListWatchersForRepoResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActivityListWatchersForRepoResponseItem]
  }
}
