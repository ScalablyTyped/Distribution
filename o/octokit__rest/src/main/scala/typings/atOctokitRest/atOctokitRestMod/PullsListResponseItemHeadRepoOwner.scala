...
trait PullsListResponseItemHeadRepoOwner extends js.Object {
...
object PullsListResponseItemHeadRepoOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsListResponseItemHeadRepoOwner]
  }
}
