...
trait PullsDeletePendingReviewResponse extends js.Object {
  var _links: PullsDeletePendingReviewResponseLinks
  var body: String
  ...
  var state: String
  var user: PullsDeletePendingReviewResponseUser
}

object PullsDeletePendingReviewResponse {
  @scala.inline
  def apply(
