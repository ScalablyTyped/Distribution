...
trait ReactionsListForTeamDiscussionCommentResponseItemUser extends js.Object {
...
object ReactionsListForTeamDiscussionCommentResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsListForTeamDiscussionCommentResponseItemUser]
  }
}
