...
trait IssuesListCommentsForRepoResponseItemUser extends js.Object {
...
object IssuesListCommentsForRepoResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListCommentsForRepoResponseItemUser]
  }
}
