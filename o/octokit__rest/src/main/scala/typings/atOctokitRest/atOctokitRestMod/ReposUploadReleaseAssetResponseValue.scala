...
trait ReposUploadReleaseAssetResponseValue extends js.Object {
  ...
  var uploader: ReposUploadReleaseAssetResponseValueUploader
  var url: String
}

object ReposUploadReleaseAssetResponseValue {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUploadReleaseAssetResponseValue]
  }
}
