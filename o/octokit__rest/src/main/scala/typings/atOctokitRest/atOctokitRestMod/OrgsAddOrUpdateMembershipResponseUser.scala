...
trait OrgsAddOrUpdateMembershipResponseUser extends js.Object {
...
object OrgsAddOrUpdateMembershipResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[OrgsAddOrUpdateMembershipResponseUser]
  }
}
