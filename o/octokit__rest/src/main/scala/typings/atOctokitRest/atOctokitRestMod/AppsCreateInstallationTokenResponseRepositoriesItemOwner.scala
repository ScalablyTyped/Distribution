...
trait AppsCreateInstallationTokenResponseRepositoriesItemOwner extends js.Object {
...
object AppsCreateInstallationTokenResponseRepositoriesItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[AppsCreateInstallationTokenResponseRepositoriesItemOwner]
  }
}
