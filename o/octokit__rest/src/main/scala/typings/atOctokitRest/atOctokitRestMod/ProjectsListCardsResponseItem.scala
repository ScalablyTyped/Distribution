...
trait ProjectsListCardsResponseItem extends js.Object {
  var archived: Boolean
  var column_url: String
  var content_url: String
  var created_at: String
  var creator: ProjectsListCardsResponseItemCreator
  var id: Double
  var node_id: String
  var note: String
...
object ProjectsListCardsResponseItem {
  @scala.inline
  def apply(
    archived: Boolean,
    column_url: String,
    ...
    __obj.asInstanceOf[ProjectsListCardsResponseItem]
  }
}
