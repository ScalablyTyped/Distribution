...
trait ReposGetBranchProtectionResponseRestrictionsAppsItemOwner extends js.Object {
...
object ReposGetBranchProtectionResponseRestrictionsAppsItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposGetBranchProtectionResponseRestrictionsAppsItemOwner]
  }
}
