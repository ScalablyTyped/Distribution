...
trait IssuesGetEventResponseIssueMilestoneCreator extends js.Object {
...
object IssuesGetEventResponseIssueMilestoneCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesGetEventResponseIssueMilestoneCreator]
  }
}
