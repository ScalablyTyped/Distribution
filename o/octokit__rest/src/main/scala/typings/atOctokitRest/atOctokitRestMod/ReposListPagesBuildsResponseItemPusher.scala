...
trait ReposListPagesBuildsResponseItemPusher extends js.Object {
...
object ReposListPagesBuildsResponseItemPusher {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListPagesBuildsResponseItemPusher]
  }
}
