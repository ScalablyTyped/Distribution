...
trait ReposListPullRequestsAssociatedWithCommitResponseItemAssigneesItem extends js.Object {
...
object ReposListPullRequestsAssociatedWithCommitResponseItemAssigneesItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListPullRequestsAssociatedWithCommitResponseItemAssigneesItem]
  }
}
