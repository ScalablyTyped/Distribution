...
trait PullsGetResponseRequestedTeamsItem extends js.Object {
...
object PullsGetResponseRequestedTeamsItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[PullsGetResponseRequestedTeamsItem]
  }
}
