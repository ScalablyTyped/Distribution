...
trait ReposCreateCommitCommentResponseUser extends js.Object {
...
object ReposCreateCommitCommentResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCreateCommitCommentResponseUser]
  }
}
