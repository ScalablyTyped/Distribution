...
trait TeamsUpdateDiscussionCommentResponseAuthor extends js.Object {
...
object TeamsUpdateDiscussionCommentResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionCommentResponseAuthor]
  }
}
