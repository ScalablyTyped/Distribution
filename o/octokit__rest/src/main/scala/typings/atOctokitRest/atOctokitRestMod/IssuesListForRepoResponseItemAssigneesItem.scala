...
trait IssuesListForRepoResponseItemAssigneesItem extends js.Object {
...
object IssuesListForRepoResponseItemAssigneesItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListForRepoResponseItemAssigneesItem]
  }
}
