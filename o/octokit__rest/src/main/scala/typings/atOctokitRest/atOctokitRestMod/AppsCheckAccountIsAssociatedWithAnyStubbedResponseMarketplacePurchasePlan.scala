...
trait AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchasePlan extends js.Object {
...
object AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchasePlan {
  @scala.inline
  def apply(
    accounts_url: String,
    ...
    __obj.asInstanceOf[AppsCheckAccountIsAssociatedWithAnyStubbedResponseMarketplacePurchasePlan]
  }
}
