...
trait PullsCreateResponseRequestedReviewersItem extends js.Object {
...
object PullsCreateResponseRequestedReviewersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateResponseRequestedReviewersItem]
  }
}
