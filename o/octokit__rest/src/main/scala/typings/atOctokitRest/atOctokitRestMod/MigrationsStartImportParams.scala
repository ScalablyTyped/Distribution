...
import typings.atOctokitRest.atOctokitRestStrings.git
import typings.atOctokitRest.atOctokitRestStrings.mercurial
import typings.atOctokitRest.atOctokitRestStrings.subversion
import typings.atOctokitRest.atOctokitRestStrings.tfvc
