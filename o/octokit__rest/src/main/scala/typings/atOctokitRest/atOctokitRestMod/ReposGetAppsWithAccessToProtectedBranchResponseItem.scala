...
trait ReposGetAppsWithAccessToProtectedBranchResponseItem extends js.Object {
  ...
  var name: String
  var node_id: String
  var owner: ReposGetAppsWithAccessToProtectedBranchResponseItemOwner
  var permissions: ReposGetAppsWithAccessToProtectedBranchResponseItemPermissions
  var slug: String
  var updated_at: String
}

object ReposGetAppsWithAccessToProtectedBranchResponseItem {
  @scala.inline
  def apply(
    created_at: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposGetAppsWithAccessToProtectedBranchResponseItem]
  }
}
