...
trait IssuesListForAuthenticatedUserResponseItemAssignee extends js.Object {
...
object IssuesListForAuthenticatedUserResponseItemAssignee {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListForAuthenticatedUserResponseItemAssignee]
  }
}
