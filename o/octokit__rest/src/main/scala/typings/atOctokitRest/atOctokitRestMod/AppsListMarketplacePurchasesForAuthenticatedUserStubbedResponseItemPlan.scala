...
trait AppsListMarketplacePurchasesForAuthenticatedUserStubbedResponseItemPlan extends js.Object {
...
object AppsListMarketplacePurchasesForAuthenticatedUserStubbedResponseItemPlan {
  @scala.inline
  def apply(
    accounts_url: String,
    ...
    __obj.asInstanceOf[AppsListMarketplacePurchasesForAuthenticatedUserStubbedResponseItemPlan]
  }
}
