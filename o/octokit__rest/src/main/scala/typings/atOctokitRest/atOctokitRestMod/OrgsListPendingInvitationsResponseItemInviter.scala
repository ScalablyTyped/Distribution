...
trait OrgsListPendingInvitationsResponseItemInviter extends js.Object {
...
object OrgsListPendingInvitationsResponseItemInviter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[OrgsListPendingInvitationsResponseItemInviter]
  }
}
