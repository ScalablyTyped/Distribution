...
@js.native
trait Anon_EndpointParamsAnyResponseGistsDeleteCommentParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: GistsDeleteCommentParams): js.Promise[AnyResponse] = js.native
