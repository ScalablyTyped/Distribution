...
@js.native
trait Anon_EndpointParamsEmptyParamsPromiseResponseUsersListBlockedResponse extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[UsersListBlockedResponse]] = js.native
  def apply(params: EmptyParams): js.Promise[Response[UsersListBlockedResponse]] = js.native
