...
@js.native
trait Anon_EndpointParamsPromiseResponseTeamsCreateDiscussionCommentParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[TeamsCreateDiscussionCommentResponse]] = js.native
  def apply(params: TeamsCreateDiscussionCommentParams): js.Promise[Response[TeamsCreateDiscussionCommentResponse]] = js.native
