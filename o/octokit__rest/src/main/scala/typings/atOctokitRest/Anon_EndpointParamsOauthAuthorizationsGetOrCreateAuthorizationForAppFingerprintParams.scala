...
trait Anon_EndpointParamsOauthAuthorizationsGetOrCreateAuthorizationForAppFingerprintParams extends js.Object {
  ...
  def apply(params: OauthAuthorizationsGetOrCreateAuthorizationForAppFingerprintParams): js.Promise[Response[OauthAuthorizationsGetOrCreateAuthorizationForAppFingerprintResponse]] = js.native
