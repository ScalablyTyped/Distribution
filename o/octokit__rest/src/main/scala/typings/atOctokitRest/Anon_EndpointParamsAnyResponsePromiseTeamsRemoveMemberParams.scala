...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseTeamsRemoveMemberParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: TeamsRemoveMemberParams): js.Promise[AnyResponse] = js.native
