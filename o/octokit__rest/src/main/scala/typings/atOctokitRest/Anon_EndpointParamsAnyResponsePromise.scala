...
@js.native
trait Anon_EndpointParamsAnyResponsePromise extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: PullsCheckIfMergedParams): js.Promise[AnyResponse] = js.native
  def apply(params: PullsCheckIfMergedParamsDeprecatedNumber): js.Promise[AnyResponse] = js.native
