...
@js.native
trait Anon_EndpointParamsActivityListRepoEventsParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: RequestOptions with ActivityListRepoEventsParams): js.Promise[AnyResponse] = js.native
