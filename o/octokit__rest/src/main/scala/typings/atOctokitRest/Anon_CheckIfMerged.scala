...
import typings.atOctokitRest.atOctokitRestMod.PullsGetCommentParams
import typings.atOctokitRest.atOctokitRestMod.PullsGetCommentResponse
...
import typings.atOctokitRest.atOctokitRestMod.PullsListCommentsForRepoParams
import typings.atOctokitRest.atOctokitRestMod.PullsListCommentsForRepoResponse
...
import typings.atOctokitRest.atOctokitRestMod.PullsUpdateBranchParams
import typings.atOctokitRest.atOctokitRestMod.PullsUpdateBranchResponse
...
trait Anon_CheckIfMerged extends js.Object {
  ...
  def createFromIssue(params: PullsCreateFromIssueParams): js.Promise[Response[PullsCreateFromIssueResponse]] = js.native
  /**
    * This endpoint triggers [notifications](https://help.github.com/articles/about-notifications/). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://developer.github.com/v3/#abuse-rate-limits)" and "[Dealing with abuse rate limits](https://developer.github.com/v3/guides/best-practices-for-integrators/#dealing-with-abuse-rate-limits)" for details.
    *
    * **Note:** To comment on a specific line in a file, you need to first determine the _position_ of that line in the diff. The GitHub REST API v3 offers the `application/vnd.github.v3.diff` [media type](https://developer.github.com/v3/media/#commits-commit-comparison-and-pull-requests). To see a pull request diff, add this media type to the `Accept` header of a call to the [single pull request](https://developer.github.com/v3/pulls/#get-a-single-pull-request) endpoint.
  ...
  def dismissReview(params: PullsDismissReviewParams): js.Promise[Response[PullsDismissReviewResponse]] = js.native
  def dismissReview(params: PullsDismissReviewParamsDeprecatedNumber): js.Promise[Response[PullsDismissReviewResponse]] = js.native
  /**
    * Draft pull requests are available in public repositories with GitHub Free and GitHub Pro, and in public and private repositories with GitHub Team and GitHub Enterprise Cloud. For more information, see [GitHub's billing plans](https://help.github.com/articles/github-s-billing-plans) in the GitHub Help documentation.
    *
    * Lists details of a pull request by providing its number.
  ...
  def getCommentsForReview(params: PullsGetCommentsForReviewParams): js.Promise[Response[PullsGetCommentsForReviewResponse]] = js.native
  def getCommentsForReview(params: PullsGetCommentsForReviewParamsDeprecatedNumber): js.Promise[Response[PullsGetCommentsForReviewResponse]] = js.native
  def getReview(): js.Promise[Response[PullsGetReviewResponse]] = js.native
  def getReview(params: PullsGetReviewParams): js.Promise[Response[PullsGetReviewResponse]] = js.native
  def getReview(params: PullsGetReviewParamsDeprecatedNumber): js.Promise[Response[PullsGetReviewResponse]] = js.native
  /**
    * Draft pull requests are available in public repositories with GitHub Free and GitHub Pro, and in public and private repositories with GitHub Team and GitHub Enterprise Cloud. For more information, see [GitHub's billing plans](https://help.github.com/articles/github-s-billing-plans) in the GitHub Help documentation.
    */
  ...
  def listCommits(params: PullsListCommitsParams): js.Promise[Response[PullsListCommitsResponse]] = js.native
  def listCommits(params: PullsListCommitsParamsDeprecatedNumber): js.Promise[Response[PullsListCommitsResponse]] = js.native
  /**
    * **Note:** The response includes a maximum of 300 files.
    */
  def listFiles(): js.Promise[Response[PullsListFilesResponse]] = js.native
  def listFiles(params: PullsListFilesParams): js.Promise[Response[PullsListFilesResponse]] = js.native
  def listFiles(params: PullsListFilesParamsDeprecatedNumber): js.Promise[Response[PullsListFilesResponse]] = js.native
  def listReviewRequests(): js.Promise[Response[PullsListReviewRequestsResponse]] = js.native
  def listReviewRequests(params: PullsListReviewRequestsParams): js.Promise[Response[PullsListReviewRequestsResponse]] = js.native
  def listReviewRequests(params: PullsListReviewRequestsParamsDeprecatedNumber): js.Promise[Response[PullsListReviewRequestsResponse]] = js.native
  /**
    * The list of reviews returns in chronological order.
    */
  def listReviews(): js.Promise[Response[PullsListReviewsResponse]] = js.native
  def listReviews(params: PullsListReviewsParams): js.Promise[Response[PullsListReviewsResponse]] = js.native
  def listReviews(params: PullsListReviewsParamsDeprecatedNumber): js.Promise[Response[PullsListReviewsResponse]] = js.native
  /**
    * This endpoint triggers [notifications](https://help.github.com/articles/about-notifications/). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://developer.github.com/v3/#abuse-rate-limits)" and "[Dealing with abuse rate limits](https://developer.github.com/v3/guides/best-practices-for-integrators/#dealing-with-abuse-rate-limits)" for details.
    */
  ...
  def update(params: PullsUpdateParams): js.Promise[Response[PullsUpdateResponse]] = js.native
  def update(params: PullsUpdateParamsDeprecatedNumber): js.Promise[Response[PullsUpdateResponse]] = js.native
  /**
    * Updates the pull request branch with the latest upstream changes by merging HEAD from the base branch into the pull request branch.
    */
  ...
  def updateReview(params: PullsUpdateReviewParams): js.Promise[Response[PullsUpdateReviewResponse]] = js.native
  def updateReview(params: PullsUpdateReviewParamsDeprecatedNumber): js.Promise[Response[PullsUpdateReviewResponse]] = js.native
}
