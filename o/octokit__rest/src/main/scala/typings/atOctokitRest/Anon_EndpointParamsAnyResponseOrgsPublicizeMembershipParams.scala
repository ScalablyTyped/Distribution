...
@js.native
trait Anon_EndpointParamsAnyResponseOrgsPublicizeMembershipParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: OrgsPublicizeMembershipParams): js.Promise[AnyResponse] = js.native
