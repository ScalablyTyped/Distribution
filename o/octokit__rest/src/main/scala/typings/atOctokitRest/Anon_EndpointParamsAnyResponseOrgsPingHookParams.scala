...
@js.native
trait Anon_EndpointParamsAnyResponseOrgsPingHookParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: RequestOptions with OrgsPingHookParams): js.Promise[AnyResponse] = js.native
