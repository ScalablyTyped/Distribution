...
trait Anon_EndpointParamsAnyResponsePromisePullsDeleteReviewRequestParams extends js.Object {
  ...
  def apply(params: PullsDeleteReviewRequestParams): js.Promise[AnyResponse] = js.native
  def apply(params: PullsDeleteReviewRequestParamsDeprecatedNumber): js.Promise[AnyResponse] = js.native
