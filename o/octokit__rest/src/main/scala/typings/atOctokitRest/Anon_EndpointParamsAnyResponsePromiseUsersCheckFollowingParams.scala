...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseUsersCheckFollowingParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[AnyResponse] = js.native
  def apply(params: UsersCheckFollowingParams): js.Promise[AnyResponse] = js.native
