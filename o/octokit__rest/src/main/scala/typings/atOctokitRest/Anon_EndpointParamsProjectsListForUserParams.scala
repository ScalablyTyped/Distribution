...
@js.native
trait Anon_EndpointParamsProjectsListForUserParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[ProjectsListForUserResponse]] = js.native
  def apply(params: ProjectsListForUserParams): js.Promise[Response[ProjectsListForUserResponse]] = js.native
