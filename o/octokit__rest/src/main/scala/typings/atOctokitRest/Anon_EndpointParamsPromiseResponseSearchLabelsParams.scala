...
@js.native
trait Anon_EndpointParamsPromiseResponseSearchLabelsParams extends js.Object {
  @JSName("endpoint")
  var endpoint_Original: Endpoint = js.native
  def apply(): js.Promise[Response[SearchLabelsResponse]] = js.native
  def apply(params: SearchLabelsParams): js.Promise[Response[SearchLabelsResponse]] = js.native
