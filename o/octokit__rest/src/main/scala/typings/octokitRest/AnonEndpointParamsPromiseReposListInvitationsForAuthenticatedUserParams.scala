...
import typings.octokitRest.mod.ReposListInvitationsForAuthenticatedUserParams
import typings.octokitRest.mod.ReposListInvitationsForAuthenticatedUserResponse
