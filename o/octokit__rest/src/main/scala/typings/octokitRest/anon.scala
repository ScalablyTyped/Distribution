...
object anon {
  ...
  trait paginatePaginateInterface extends StObject {
    ...
    /**
      ...
      * @param {object} parameters? URL, query or body parameters, as well as `headers`, `mediaType.format`, `request`, or `baseUrl`.
      */
    def paginate[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 199, starting with typings.octokitRest.octokitRestStrings.`GET SlashappSlashhookSlashdeliveries`, typings.octokitRest.octokitRestStrings.`GET SlashappSlashinstallation-requests`, typings.octokitRest.octokitRestStrings.`GET SlashappSlashinstallations` */ Any */](route: R): js.Promise[
        DataType[
    ...
    @JSName("paginate")
    def paginate_parameters[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 199, starting with typings.octokitRest.octokitRestStrings.`GET SlashappSlashhookSlashdeliveries`, typings.octokitRest.octokitRestStrings.`GET SlashappSlashinstallation-requests`, typings.octokitRest.octokitRestStrings.`GET SlashappSlashinstallations` */ Any */](
      route: R,
      parameters: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/plugin-paginate-rest.@octokit/plugin-paginate-rest/dist-types/generated/paginating-endpoints.PaginatingEndpoints[R]['parameters'] */ js.Any
    ): js.Promise[
        DataType[
    ...
    /**
      ...
      */
    @JSName("paginate")
    def paginate_response[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 199, starting with typings.octokitRest.octokitRestStrings.`GET SlashappSlashhookSlashdeliveries`, typings.octokitRest.octokitRestStrings.`GET SlashappSlashinstallation-requests`, typings.octokitRest.octokitRestStrings.`GET SlashappSlashinstallations` */ Any */, M /* <: js.Array[Any] */](
      route: R,
      mapFn: MapFunction[
          /* import warning: importer.ImportType#apply Failed type conversion: @octokit/plugin-paginate-rest.@octokit/plugin-paginate-rest/dist-types/generated/paginating-endpoints.PaginatingEndpoints[R]['response'] */ js.Any, 
          M
