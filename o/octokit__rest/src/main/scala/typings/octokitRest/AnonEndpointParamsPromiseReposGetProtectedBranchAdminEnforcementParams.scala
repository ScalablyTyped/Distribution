...
import typings.octokitRest.mod.Octokit.ReposGetProtectedBranchAdminEnforcementParams
import typings.octokitRest.mod.Octokit.ReposGetProtectedBranchAdminEnforcementResponse
