...
import typings.octokitRest.mod.Octokit.ReposReplaceProtectedBranchRequiredStatusChecksContextsParams
import typings.octokitRest.mod.Octokit.ReposReplaceProtectedBranchRequiredStatusChecksContextsResponse
