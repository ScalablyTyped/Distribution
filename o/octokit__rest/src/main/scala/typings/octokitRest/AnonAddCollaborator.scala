...
import typings.octokitRest.mod.Octokit.ProjectsGetParams
import typings.octokitRest.mod.Octokit.ProjectsGetResponse
...
import typings.octokitRest.mod.Octokit.ProjectsMoveColumnParams
