...
trait AnonAddMember extends js.Object {
  ...
  var addMemberLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsAddMemberLegacyParams = js.native
  /**
    * The "Add team member" endpoint (described below) is deprecated.
    *
    * We recommend using the [Add team membership](https://developer.github.com/v3/teams/members/#add-or-update-team-membership) endpoint instead. It allows you to invite new organization members to your teams.
    ...
    */
  @JSName("addMember")
  var addMember_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsAddMemberParams = js.native
  /**
    * Team synchronization is available for organizations using GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var addOrUpdateMembershipInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsAddOrUpdateMembershipInOrgParams = js.native
  /**
  ...
  var addOrUpdateMembershipLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsAddOrUpdateMembershipLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Add or update team membership`](https://developer.github.com/v3/teams/members/#add-or-update-team-membership) endpoint.
    *
    * Team synchronization is available for organizations using GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
  ...
  var addOrUpdateMembership_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsAddOrUpdateMembershipParams = js.native
  /**
  ...
  var addOrUpdateProjectInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsAddOrUpdateProjectInOrgParams = js.native
  /**
  ...
  var addOrUpdateProjectLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsAddOrUpdateProjectLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Add or update team project`](https://developer.github.com/v3/teams/#add-or-update-team-project) endpoint.
    *
    * Adds an organization project to a team. To add a project to a team or update the team's permission on a project, the authenticated user must have `admin` permissions for the project. The project and team must be part of the same organization.
  ...
  var addOrUpdateProject_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsAddOrUpdateProjectParams = js.native
  /**
  ...
  var addOrUpdateRepoInOrg_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsAddOrUpdateRepoInOrgParams = js.native
  /**
  ...
  var addOrUpdateRepoLegacy_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsAddOrUpdateRepoLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Add or update team repository`](https://developer.github.com/v3/teams/#add-or-update-team-repository) endpoint.
    *
    * To add a repository to a team or update the team's permission on a repository, the authenticated user must have admin access to the repository, and must be able to see the team. The repository must be owned by the organization, or a direct fork of a repository owned by the organization. You will get a `422 Unprocessable Entity` status if you attempt to add a repository to a team that is not owned by the organization.
  ...
  var addOrUpdateRepo_Original: AnonEndpointParamsAnyResponsePromiseRequestOptions = js.native
  /**
  ...
  var checkManagesRepoInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsCheckManagesRepoInOrgParams = js.native
  /**
  ...
  var checkManagesRepoLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsCheckManagesRepoLegacyParams = js.native
  /**
    * **Note**: Repositories inherited through a parent team will also be checked.
    *
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Check if a team manages a repository`](https://developer.github.com/v3/teams/#check-if-a-team-manages-a-repository) endpoint.
  ...
  var checkManagesRepo_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsCheckManagesRepoParams = js.native
  /**
  ...
  var createDiscussionCommentInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsCreateDiscussionCommentInOrgParams = js.native
  /**
  ...
  var createDiscussionCommentLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsCreateDiscussionCommentLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Create a comment`](https://developer.github.com/v3/teams/discussion_comments/#create-a-comment) endpoint.
    *
    * Creates a new comment on a team discussion. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  var createDiscussionComment_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsCreateDiscussionCommentParams = js.native
  /**
  ...
  var createDiscussionInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsCreateDiscussionInOrgParams = js.native
  /**
  ...
  var createDiscussionLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsCreateDiscussionLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Create a discussion`](https://developer.github.com/v3/teams/discussions/#create-a-discussion) endpoint.
    *
    * Creates a new discussion post on a team's page. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  var createDiscussion_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsCreateDiscussionParams = js.native
  /**
    ...
    */
  @JSName("create")
  var create_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsCreateParams = js.native
  /**
  ...
  var deleteDiscussionCommentInOrg_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsDeleteDiscussionCommentInOrgParams = js.native
  /**
  ...
  var deleteDiscussionCommentLegacy_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsDeleteDiscussionCommentLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Delete a comment`](https://developer.github.com/v3/teams/discussion_comments/#delete-a-comment) endpoint.
    *
    * Deletes a comment on a team discussion. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  var deleteDiscussionComment_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsDeleteDiscussionCommentParams = js.native
  /**
  ...
  var deleteDiscussionInOrg_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsDeleteDiscussionInOrgParams = js.native
  /**
  ...
  var deleteDiscussionLegacy_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsDeleteDiscussionLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Delete a discussion`](https://developer.github.com/v3/teams/discussions/#delete-a-discussion) endpoint.
    *
    * Delete a discussion from a team's page. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  var deleteDiscussion_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsDeleteDiscussionParams = js.native
  /**
    ...
    */
  @JSName("deleteInOrg")
  var deleteInOrg_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsDeleteInOrgParams = js.native
  /**
    ...
    */
  @JSName("deleteLegacy")
  var deleteLegacy_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsDeleteLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Delete team`](https://developer.github.com/v3/teams/#delete-team) endpoint.
    *
    * To delete a team, the authenticated user must be an organization owner or team maintainer.
    ...
    */
  @JSName("delete")
  var delete_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsDeleteParams = js.native
  /**
    ...
    */
  @JSName("getByName")
  var getByName_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetByNameParams = js.native
  /**
  ...
  var getDiscussionCommentInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetDiscussionCommentInOrgParams = js.native
  /**
  ...
  var getDiscussionCommentLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetDiscussionCommentLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Get a single comment`](https://developer.github.com/v3/teams/discussion_comments/#get-a-single-comment) endpoint.
    *
    * Get a specific comment on a team discussion. OAuth access tokens require the `read:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  var getDiscussionComment_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetDiscussionCommentParams = js.native
  /**
  ...
  var getDiscussionInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetDiscussionInOrgParams = js.native
  /**
  ...
  var getDiscussionLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetDiscussionLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Get a single discussion`](https://developer.github.com/v3/teams/discussions/#get-a-single-discussion) endpoint.
    *
    * Get a specific discussion on a team's page. OAuth access tokens require the `read:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  var getDiscussion_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetDiscussionParams = js.native
  /**
    ...
    */
  @JSName("getLegacy")
  var getLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetLegacyParams = js.native
  /**
  ...
  var getMemberLegacy_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsGetMemberLegacyParams = js.native
  /**
    * The "Get team member" endpoint (described below) is deprecated.
    *
    * We recommend using the [Get team membership](https://developer.github.com/v3/teams/members/#get-team-membership) endpoint instead. It allows you to get both active and pending memberships.
    ...
    */
  @JSName("getMember")
  var getMember_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsGetMemberParams = js.native
  /**
  ...
  var getMembershipInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetMembershipInOrgParams = js.native
  /**
  ...
  var getMembershipLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetMembershipLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Get team membership`](https://developer.github.com/v3/teams/members/#get-team-membership) endpoint.
    *
    * Team members will include the members of child teams.
  ...
  var getMembership_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetMembershipParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the [`Get team by name`](https://developer.github.com/v3/teams/#get-team-by-name) endpoint.
    * @deprecated octokit.teams.get() is deprecated, see https://developer.github.com/v3/teams/#get-team-legacy
    */
  @JSName("get")
  var get_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsGetParams = js.native
  /**
  ...
  var listChildInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListChildInOrgParams = js.native
  /**
  ...
  var listChildLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListChildLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List child teams`](https://developer.github.com/v3/teams/#list-child-teams) endpoint.
    *
    *
    ...
    */
  @JSName("listChild")
  var listChild_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListChildParams = js.native
  /**
  ...
  var listDiscussionCommentsInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListDiscussionCommentsInOrgParams = js.native
  /**
  ...
  var listDiscussionCommentsLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListDiscussionCommentsLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List comments`](https://developer.github.com/v3/teams/discussion_comments/#list-comments) endpoint.
    *
    * List all comments on a team discussion. OAuth access tokens require the `read:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  var listDiscussionComments_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListDiscussionCommentsParams = js.native
  /**
  ...
  var listDiscussionsInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListDiscussionsInOrgParams = js.native
  /**
  ...
  var listDiscussionsLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListDiscussionsLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List discussions`](https://developer.github.com/v3/teams/discussions/#list-discussions) endpoint.
    *
    * List all discussions on a team's page. OAuth access tokens require the `read:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  var listDiscussions_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListDiscussionsParams = js.native
  /**
    * List all of the teams across all of the organizations to which the authenticated user belongs. This method requires `user`, `repo`, or `read:org` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/) when authenticating via [OAuth](https://developer.github.com/apps/building-oauth-apps/).
    */
  @JSName("listForAuthenticatedUser")
  var listForAuthenticatedUser_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListForAuthenticatedUserParams = js.native
  /**
    * Team members will include the members of child teams.
    *
    * To list members in a team, the team must be visible to the authenticated user.
  ...
  var listMembersInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListMembersInOrgParams = js.native
  /**
  ...
  var listMembersLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListMembersLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List team members`](https://developer.github.com/v3/teams/members/#list-team-members) endpoint.
    *
    * Team members will include the members of child teams.
    ...
    */
  @JSName("listMembers")
  var listMembers_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListMembersParams = js.native
  /**
  ...
  var listPendingInvitationsInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListPendingInvitationsInOrgParams = js.native
  /**
  ...
  var listPendingInvitationsLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListPendingInvitationsLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List pending team invitations`](https://developer.github.com/v3/teams/members/#list-pending-team-invitations) endpoint.
    *
    * The return hash contains a `role` field which refers to the Organization Invitation role and will be one of the following values: `direct_member`, `admin`, `billing_manager`, `hiring_manager`, or `reinstate`. If the invitee is not a GitHub member, the `login` field in the return hash will be `null`.
  ...
  var listPendingInvitations_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListPendingInvitationsParams = js.native
  /**
  ...
  var listProjectsInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListProjectsInOrgParams = js.native
  /**
  ...
  var listProjectsLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListProjectsLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List team projects`](https://developer.github.com/v3/teams/#list-team-projects) endpoint.
    *
    * Lists the organization projects for a team.
    ...
    */
  @JSName("listProjects")
  var listProjects_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListProjectsParams = js.native
  /**
  ...
  var listReposInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListReposInOrgParams = js.native
  /**
  ...
  var listReposLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListReposLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List team repos`](https://developer.github.com/v3/teams/#list-team-repos) endpoint.
    * @deprecated octokit.teams.listRepos() is deprecated, see https://developer.github.com/v3/teams/#list-team-repos-legacy
    */
  @JSName("listRepos")
  var listRepos_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListReposParams = js.native
  /**
    * Lists all teams in an organization that are visible to the authenticated user.
    */
  @JSName("list")
  var list_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsListParams = js.native
  /**
  ...
  var removeMembershipInOrg_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsRemoveMembershipInOrgParams = js.native
  /**
  ...
  var removeProjectInOrg_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsRemoveProjectInOrgParams = js.native
  /**
  ...
  var removeProjectLegacy_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsRemoveProjectLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Remove team project`](https://developer.github.com/v3/teams/#remove-team-project) endpoint.
    *
    * Removes an organization project from a team. An organization owner or a team maintainer can remove any project from the team. To remove a project from a team as an organization member, the authenticated user must have `read` access to both the team and project, or `admin` access to the team or project. **Note:** This endpoint removes the project from the team, but does not delete it.
  ...
  var removeProject_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsRemoveProjectParams = js.native
  /**
  ...
  var removeRepoInOrg_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsRemoveRepoInOrgParams = js.native
  /**
  ...
  var removeRepoLegacy_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsRemoveRepoLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Remove team repository`](https://developer.github.com/v3/teams/#remove-team-repository) endpoint.
    *
    * If the authenticated user is an organization owner or a team maintainer, they can remove any repositories from the team. To remove a repository from a team as an organization member, the authenticated user must have admin access to the repository and must be able to see the team. NOTE: This does not delete the repository, it just removes it from the team.
    ...
    */
  @JSName("removeRepo")
  var removeRepo_Original: AnonEndpointParamsAnyResponsePromiseRequestOptionsTeamsRemoveRepoParams = js.native
  /**
  ...
  var reviewProjectInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsReviewProjectInOrgParams = js.native
  /**
  ...
  var reviewProjectLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsReviewProjectLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Review a team project`](https://developer.github.com/v3/teams/#review-a-team-project) endpoint.
    *
    * Checks whether a team has `read`, `write`, or `admin` permissions for an organization project. The response includes projects inherited from a parent team.
  ...
  var reviewProject_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsReviewProjectParams = js.native
  /**
  ...
  var updateDiscussionCommentInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsUpdateDiscussionCommentInOrgParams = js.native
  /**
  ...
  var updateDiscussionCommentLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsUpdateDiscussionCommentLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Edit a comment`](https://developer.github.com/v3/teams/discussion_comments/#edit-a-comment) endpoint.
    *
    * Edits the body text of a discussion comment. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  var updateDiscussionComment_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsUpdateDiscussionCommentParams = js.native
  /**
  ...
  var updateDiscussionInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsUpdateDiscussionInOrgParams = js.native
  /**
  ...
  var updateDiscussionLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsUpdateDiscussionLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Edit a discussion`](https://developer.github.com/v3/teams/discussions/#edit-a-discussion) endpoint.
    *
    * Edits the title and body text of a discussion post. Only the parameters you provide are updated. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  var updateDiscussion_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsUpdateDiscussionParams = js.native
  /**
    ...
    */
  @JSName("updateInOrg")
  var updateInOrg_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsUpdateInOrgParams = js.native
  /**
    ...
    */
  @JSName("updateLegacy")
  var updateLegacy_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsUpdateLegacyParams = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Edit team`](https://developer.github.com/v3/teams/#edit-team) endpoint.
    *
    * To edit a team, the authenticated user must either be an organization owner or a team maintainer.
    ...
    */
  @JSName("update")
  var update_Original: AnonEndpointParamsPromiseRequestOptionsResponseTeamsUpdateParams = js.native
  /**
    * The "Add team member" endpoint (described below) is deprecated.
    *
    * We recommend using the [Add team membership](https://developer.github.com/v3/teams/members/#add-or-update-team-membership) endpoint instead. It allows you to invite new organization members to your teams.
  ...
  /**
    ...
    * @deprecated octokit.teams.addMemberLegacy() is deprecated, see https://developer.github.com/v3/teams/members/#add-team-member-legacy
    */
  def addMemberLegacy(): js.Promise[Response[TeamsAddMemberLegacyResponse]] = js.native
  def addMemberLegacy(params: RequestOptions with TeamsAddMemberLegacyParams): js.Promise[Response[TeamsAddMemberLegacyResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Add or update team membership`](https://developer.github.com/v3/teams/members/#add-or-update-team-membership) endpoint.
    *
    * Team synchronization is available for organizations using GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `PUT /organizations/:org_id/team/:team_id/memberships/:username`.
    */
  def addOrUpdateMembershipInOrg(): js.Promise[Response[TeamsAddOrUpdateMembershipInOrgResponse]] = js.native
  def addOrUpdateMembershipInOrg(params: RequestOptions with TeamsAddOrUpdateMembershipInOrgParams): js.Promise[Response[TeamsAddOrUpdateMembershipInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Add or update team membership`](https://developer.github.com/v3/teams/members/#add-or-update-team-membership) endpoint.
    *
    * Team synchronization is available for organizations using GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    ...
    * @deprecated octokit.teams.addOrUpdateMembershipLegacy() is deprecated, see https://developer.github.com/v3/teams/members/#add-or-update-team-membership-legacy
    */
  def addOrUpdateMembershipLegacy(): js.Promise[Response[TeamsAddOrUpdateMembershipLegacyResponse]] = js.native
  def addOrUpdateMembershipLegacy(params: RequestOptions with TeamsAddOrUpdateMembershipLegacyParams): js.Promise[Response[TeamsAddOrUpdateMembershipLegacyResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Add or update team project`](https://developer.github.com/v3/teams/#add-or-update-team-project) endpoint.
    *
    * Adds an organization project to a team. To add a project to a team or update the team's permission on a project, the authenticated user must have `admin` permissions for the project. The project and team must be part of the same organization.
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `PUT /organizations/:org_id/team/:team_id/projects/:project_id`.
    */
  def addOrUpdateProjectInOrg(): js.Promise[Response[TeamsAddOrUpdateProjectInOrgResponse]] = js.native
  def addOrUpdateProjectInOrg(params: RequestOptions with TeamsAddOrUpdateProjectInOrgParams): js.Promise[Response[TeamsAddOrUpdateProjectInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Add or update team project`](https://developer.github.com/v3/teams/#add-or-update-team-project) endpoint.
    *
    * Adds an organization project to a team. To add a project to a team or update the team's permission on a project, the authenticated user must have `admin` permissions for the project. The project and team must be part of the same organization.
    * @deprecated octokit.teams.addOrUpdateProjectLegacy() is deprecated, see https://developer.github.com/v3/teams/#add-or-update-team-project-legacy
    */
  def addOrUpdateProjectLegacy(): js.Promise[Response[TeamsAddOrUpdateProjectLegacyResponse]] = js.native
  def addOrUpdateProjectLegacy(params: RequestOptions with TeamsAddOrUpdateProjectLegacyParams): js.Promise[Response[TeamsAddOrUpdateProjectLegacyResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Add or update team repository`](https://developer.github.com/v3/teams/#add-or-update-team-repository) endpoint.
    *
    * To add a repository to a team or update the team's permission on a repository, the authenticated user must have admin access to the repository, and must be able to see the team. The repository must be owned by the organization, or a direct fork of a repository owned by the organization. You will get a `422 Unprocessable Entity` status if you attempt to add a repository to a team that is not owned by the organization.
  ...
  def addOrUpdateRepoInOrg(params: RequestOptions with TeamsAddOrUpdateRepoInOrgParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Add or update team repository`](https://developer.github.com/v3/teams/#add-or-update-team-repository) endpoint.
    *
    * To add a repository to a team or update the team's permission on a repository, the authenticated user must have admin access to the repository, and must be able to see the team. The repository must be owned by the organization, or a direct fork of a repository owned by the organization. You will get a `422 Unprocessable Entity` status if you attempt to add a repository to a team that is not owned by the organization.
  ...
  def addOrUpdateRepoLegacy(params: RequestOptions with TeamsAddOrUpdateRepoLegacyParams): js.Promise[AnyResponse] = js.native
  /**
    * **Note**: Repositories inherited through a parent team will also be checked.
    *
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Check if a team manages a repository`](https://developer.github.com/v3/teams/#check-if-a-team-manages-a-repository) endpoint.
  ...
  /**
    ...
    * You can also get information about the specified repository, including what permissions the team grants on it, by passing the following custom [media type](https://developer.github.com/v3/media/) via the `Accept` header:
    */
  def checkManagesRepoInOrg(): js.Promise[Response[TeamsCheckManagesRepoInOrgResponse]] = js.native
  def checkManagesRepoInOrg(params: RequestOptions with TeamsCheckManagesRepoInOrgParams): js.Promise[Response[TeamsCheckManagesRepoInOrgResponse]] = js.native
  /**
    * **Note**: Repositories inherited through a parent team will also be checked.
    *
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Check if a team manages a repository`](https://developer.github.com/v3/teams/#check-if-a-team-manages-a-repository) endpoint.
    ...
    * @deprecated octokit.teams.checkManagesRepoLegacy() is deprecated, see https://developer.github.com/v3/teams/#check-if-a-team-manages-a-repository-legacy
    */
  def checkManagesRepoLegacy(): js.Promise[Response[TeamsCheckManagesRepoLegacyResponse]] = js.native
  def checkManagesRepoLegacy(params: RequestOptions with TeamsCheckManagesRepoLegacyParams): js.Promise[Response[TeamsCheckManagesRepoLegacyResponse]] = js.native
  /**
    * To create a team, the authenticated user must be a member or owner of `:org`. By default, organization members can create teams. Organization owners can limit team creation to organization owners. For more information, see "[Setting team creation permissions](https://help.github.com/en/articles/setting-team-creation-permissions-in-your-organization)."
    *
    * When you create a new team, you automatically become a team maintainer without explicitly adding yourself to the optional array of `maintainers`. For more information, see "[About teams](https://help.github.com/en/github/setting-up-and-managing-organizations-and-teams/about-teams)" in the GitHub Help documentation.
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `POST /organizations/:org_id/team/:team_id/discussions/:discussion_number/comments`.
    */
  def createDiscussionCommentInOrg(): js.Promise[Response[TeamsCreateDiscussionCommentInOrgResponse]] = js.native
  def createDiscussionCommentInOrg(params: RequestOptions with TeamsCreateDiscussionCommentInOrgParams): js.Promise[Response[TeamsCreateDiscussionCommentInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Create a comment`](https://developer.github.com/v3/teams/discussion_comments/#create-a-comment) endpoint.
    *
    * Creates a new comment on a team discussion. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    ...
    * @deprecated octokit.teams.createDiscussionCommentLegacy() is deprecated, see https://developer.github.com/v3/teams/discussion_comments/#create-a-comment-legacy
    */
  def createDiscussionCommentLegacy(): js.Promise[Response[TeamsCreateDiscussionCommentLegacyResponse]] = js.native
  def createDiscussionCommentLegacy(params: RequestOptions with TeamsCreateDiscussionCommentLegacyParams): js.Promise[Response[TeamsCreateDiscussionCommentLegacyResponse]] = js.native
  /**
    * Creates a new discussion post on a team's page. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    *
    * This endpoint triggers [notifications](https://help.github.com/articles/about-notifications/). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://developer.github.com/v3/#abuse-rate-limits)" and "[Dealing with abuse rate limits](https://developer.github.com/v3/guides/best-practices-for-integrators/#dealing-with-abuse-rate-limits)" for details.
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `POST /organizations/:org_id/team/:team_id/discussions`.
    */
  def createDiscussionInOrg(): js.Promise[Response[TeamsCreateDiscussionInOrgResponse]] = js.native
  def createDiscussionInOrg(params: RequestOptions with TeamsCreateDiscussionInOrgParams): js.Promise[Response[TeamsCreateDiscussionInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Create a discussion`](https://developer.github.com/v3/teams/discussions/#create-a-discussion) endpoint.
    *
    * Creates a new discussion post on a team's page. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    ...
    * @deprecated octokit.teams.createDiscussionLegacy() is deprecated, see https://developer.github.com/v3/teams/discussions/#create-a-discussion-legacy
    */
  def createDiscussionLegacy(): js.Promise[Response[TeamsCreateDiscussionLegacyResponse]] = js.native
  def createDiscussionLegacy(params: RequestOptions with TeamsCreateDiscussionLegacyParams): js.Promise[Response[TeamsCreateDiscussionLegacyResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Delete team`](https://developer.github.com/v3/teams/#delete-team) endpoint.
    *
    * To delete a team, the authenticated user must be an organization owner or team maintainer.
  ...
  def deleteDiscussionCommentInOrg(params: RequestOptions with TeamsDeleteDiscussionCommentInOrgParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Delete a comment`](https://developer.github.com/v3/teams/discussion_comments/#delete-a-comment) endpoint.
    *
    * Deletes a comment on a team discussion. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  def deleteDiscussionCommentLegacy(params: RequestOptions with TeamsDeleteDiscussionCommentLegacyParams): js.Promise[AnyResponse] = js.native
  /**
    * Delete a discussion from a team's page. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    *
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `DELETE /organizations/:org_id/team/:team_id/discussions/:discussion_number`.
  ...
  def deleteDiscussionInOrg(params: RequestOptions with TeamsDeleteDiscussionInOrgParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Delete a discussion`](https://developer.github.com/v3/teams/discussions/#delete-a-discussion) endpoint.
    *
    * Delete a discussion from a team's page. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  def deleteDiscussionLegacy(params: RequestOptions with TeamsDeleteDiscussionLegacyParams): js.Promise[AnyResponse] = js.native
  /**
    * To delete a team, the authenticated user must be an organization owner or team maintainer.
    *
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `DELETE /organizations/:org_id/team/:team_id`.
  ...
  def deleteInOrg(params: RequestOptions with TeamsDeleteInOrgParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Delete team`](https://developer.github.com/v3/teams/#delete-team) endpoint.
    *
    * To delete a team, the authenticated user must be an organization owner or team maintainer.
  ...
  def deleteLegacy(params: RequestOptions with TeamsDeleteLegacyParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the [`Get team by name`](https://developer.github.com/v3/teams/#get-team-by-name) endpoint.
    * @deprecated octokit.teams.get() is deprecated, see https://developer.github.com/v3/teams/#get-team-legacy
    */
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/:org_id/team/:team_id/discussions/:discussion_number/comments/:comment_number`.
    */
  def getDiscussionCommentInOrg(): js.Promise[Response[TeamsGetDiscussionCommentInOrgResponse]] = js.native
  def getDiscussionCommentInOrg(params: RequestOptions with TeamsGetDiscussionCommentInOrgParams): js.Promise[Response[TeamsGetDiscussionCommentInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Get a single comment`](https://developer.github.com/v3/teams/discussion_comments/#get-a-single-comment) endpoint.
    *
    * Get a specific comment on a team discussion. OAuth access tokens require the `read:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    * @deprecated octokit.teams.getDiscussionCommentLegacy() is deprecated, see https://developer.github.com/v3/teams/discussion_comments/#get-a-single-comment-legacy
    */
  def getDiscussionCommentLegacy(): js.Promise[Response[TeamsGetDiscussionCommentLegacyResponse]] = js.native
  def getDiscussionCommentLegacy(params: RequestOptions with TeamsGetDiscussionCommentLegacyParams): js.Promise[Response[TeamsGetDiscussionCommentLegacyResponse]] = js.native
  /**
    * Get a specific discussion on a team's page. OAuth access tokens require the `read:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    *
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/:org_id/team/:team_id/discussions/:discussion_number`.
    */
  def getDiscussionInOrg(): js.Promise[Response[TeamsGetDiscussionInOrgResponse]] = js.native
  def getDiscussionInOrg(params: RequestOptions with TeamsGetDiscussionInOrgParams): js.Promise[Response[TeamsGetDiscussionInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Get a single discussion`](https://developer.github.com/v3/teams/discussions/#get-a-single-discussion) endpoint.
    *
    * Get a specific discussion on a team's page. OAuth access tokens require the `read:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    * @deprecated octokit.teams.getDiscussionLegacy() is deprecated, see https://developer.github.com/v3/teams/discussions/#get-a-single-discussion-legacy
    */
  def getDiscussionLegacy(): js.Promise[Response[TeamsGetDiscussionLegacyResponse]] = js.native
  def getDiscussionLegacy(params: RequestOptions with TeamsGetDiscussionLegacyParams): js.Promise[Response[TeamsGetDiscussionLegacyResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the [`Get team by name`](https://developer.github.com/v3/teams/#get-team-by-name) endpoint.
    * @deprecated octokit.teams.getLegacy() is deprecated, see https://developer.github.com/v3/teams/#get-team-legacy
    */
  def getLegacy(): js.Promise[Response[TeamsGetLegacyResponse]] = js.native
  def getLegacy(params: RequestOptions with TeamsGetLegacyParams): js.Promise[Response[TeamsGetLegacyResponse]] = js.native
  /**
    * The "Get team member" endpoint (described below) is deprecated.
    *
    * We recommend using the [Get team membership](https://developer.github.com/v3/teams/members/#get-team-membership) endpoint instead. It allows you to get both active and pending memberships.
  ...
  def getMemberLegacy(params: RequestOptions with TeamsGetMemberLegacyParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Get team membership`](https://developer.github.com/v3/teams/members/#get-team-membership) endpoint.
    *
    * Team members will include the members of child teams.
  ...
  /**
    ...
    * **Note:** The `role` for organization owners returns as `maintainer`. For more information about `maintainer` roles, see [Create team](https://developer.github.com/v3/teams#create-team).
    */
  def getMembershipInOrg(): js.Promise[Response[TeamsGetMembershipInOrgResponse]] = js.native
  def getMembershipInOrg(params: RequestOptions with TeamsGetMembershipInOrgParams): js.Promise[Response[TeamsGetMembershipInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Get team membership`](https://developer.github.com/v3/teams/members/#get-team-membership) endpoint.
    *
    * Team members will include the members of child teams.
    ...
    * @deprecated octokit.teams.getMembershipLegacy() is deprecated, see https://developer.github.com/v3/teams/members/#get-team-membership-legacy
    */
  def getMembershipLegacy(): js.Promise[Response[TeamsGetMembershipLegacyResponse]] = js.native
  def getMembershipLegacy(params: RequestOptions with TeamsGetMembershipLegacyParams): js.Promise[Response[TeamsGetMembershipLegacyResponse]] = js.native
  /**
    * Lists all teams in an organization that are visible to the authenticated user.
    */
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/:org_id/team/:team_id/teams`.
    */
  def listChildInOrg(): js.Promise[Response[TeamsListChildInOrgResponse]] = js.native
  def listChildInOrg(params: RequestOptions with TeamsListChildInOrgParams): js.Promise[Response[TeamsListChildInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List child teams`](https://developer.github.com/v3/teams/#list-child-teams) endpoint.
    *
    *
    * @deprecated octokit.teams.listChildLegacy() is deprecated, see https://developer.github.com/v3/teams/#list-child-teams-legacy
    */
  def listChildLegacy(): js.Promise[Response[TeamsListChildLegacyResponse]] = js.native
  def listChildLegacy(params: RequestOptions with TeamsListChildLegacyParams): js.Promise[Response[TeamsListChildLegacyResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List comments`](https://developer.github.com/v3/teams/discussion_comments/#list-comments) endpoint.
    *
    * List all comments on a team discussion. OAuth access tokens require the `read:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/:org_id/team/:team_id/discussions/:discussion_number/comments`.
    */
  def listDiscussionCommentsInOrg(): js.Promise[Response[TeamsListDiscussionCommentsInOrgResponse]] = js.native
  def listDiscussionCommentsInOrg(params: RequestOptions with TeamsListDiscussionCommentsInOrgParams): js.Promise[Response[TeamsListDiscussionCommentsInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List comments`](https://developer.github.com/v3/teams/discussion_comments/#list-comments) endpoint.
    *
    * List all comments on a team discussion. OAuth access tokens require the `read:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    * @deprecated octokit.teams.listDiscussionCommentsLegacy() is deprecated, see https://developer.github.com/v3/teams/discussion_comments/#list-comments-legacy
    */
  def listDiscussionCommentsLegacy(): js.Promise[Response[TeamsListDiscussionCommentsLegacyResponse]] = js.native
  def listDiscussionCommentsLegacy(params: RequestOptions with TeamsListDiscussionCommentsLegacyParams): js.Promise[Response[TeamsListDiscussionCommentsLegacyResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List discussions`](https://developer.github.com/v3/teams/discussions/#list-discussions) endpoint.
    *
    * List all discussions on a team's page. OAuth access tokens require the `read:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/:org_id/team/:team_id/discussions`.
    */
  def listDiscussionsInOrg(): js.Promise[Response[TeamsListDiscussionsInOrgResponse]] = js.native
  def listDiscussionsInOrg(params: RequestOptions with TeamsListDiscussionsInOrgParams): js.Promise[Response[TeamsListDiscussionsInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List discussions`](https://developer.github.com/v3/teams/discussions/#list-discussions) endpoint.
    *
    * List all discussions on a team's page. OAuth access tokens require the `read:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    * @deprecated octokit.teams.listDiscussionsLegacy() is deprecated, see https://developer.github.com/v3/teams/discussions/#list-discussions-legacy
    */
  def listDiscussionsLegacy(): js.Promise[Response[TeamsListDiscussionsLegacyResponse]] = js.native
  def listDiscussionsLegacy(params: RequestOptions with TeamsListDiscussionsLegacyParams): js.Promise[Response[TeamsListDiscussionsLegacyResponse]] = js.native
  /**
    * List all of the teams across all of the organizations to which the authenticated user belongs. This method requires `user`, `repo`, or `read:org` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/) when authenticating via [OAuth](https://developer.github.com/apps/building-oauth-apps/).
    */
  ...
  /**
    ...
    * To list members in a team, the team must be visible to the authenticated user.
    */
  def listMembersInOrg(): js.Promise[Response[TeamsListMembersInOrgResponse]] = js.native
  def listMembersInOrg(params: RequestOptions with TeamsListMembersInOrgParams): js.Promise[Response[TeamsListMembersInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List team members`](https://developer.github.com/v3/teams/members/#list-team-members) endpoint.
    *
    * Team members will include the members of child teams.
    * @deprecated octokit.teams.listMembersLegacy() is deprecated, see https://developer.github.com/v3/teams/members/#list-team-members-legacy
    */
  def listMembersLegacy(): js.Promise[Response[TeamsListMembersLegacyResponse]] = js.native
  def listMembersLegacy(params: RequestOptions with TeamsListMembersLegacyParams): js.Promise[Response[TeamsListMembersLegacyResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List pending team invitations`](https://developer.github.com/v3/teams/members/#list-pending-team-invitations) endpoint.
    *
    * The return hash contains a `role` field which refers to the Organization Invitation role and will be one of the following values: `direct_member`, `admin`, `billing_manager`, `hiring_manager`, or `reinstate`. If the invitee is not a GitHub member, the `login` field in the return hash will be `null`.
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/:org_id/team/:team_id/invitations`.
    */
  def listPendingInvitationsInOrg(): js.Promise[Response[TeamsListPendingInvitationsInOrgResponse]] = js.native
  def listPendingInvitationsInOrg(params: RequestOptions with TeamsListPendingInvitationsInOrgParams): js.Promise[Response[TeamsListPendingInvitationsInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List pending team invitations`](https://developer.github.com/v3/teams/members/#list-pending-team-invitations) endpoint.
    *
    * The return hash contains a `role` field which refers to the Organization Invitation role and will be one of the following values: `direct_member`, `admin`, `billing_manager`, `hiring_manager`, or `reinstate`. If the invitee is not a GitHub member, the `login` field in the return hash will be `null`.
    * @deprecated octokit.teams.listPendingInvitationsLegacy() is deprecated, see https://developer.github.com/v3/teams/members/#list-pending-team-invitations-legacy
    */
  def listPendingInvitationsLegacy(): js.Promise[Response[TeamsListPendingInvitationsLegacyResponse]] = js.native
  def listPendingInvitationsLegacy(params: RequestOptions with TeamsListPendingInvitationsLegacyParams): js.Promise[Response[TeamsListPendingInvitationsLegacyResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List team projects`](https://developer.github.com/v3/teams/#list-team-projects) endpoint.
    *
    * Lists the organization projects for a team.
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/:org_id/team/:team_id/projects`.
    */
  def listProjectsInOrg(): js.Promise[Response[TeamsListProjectsInOrgResponse]] = js.native
  def listProjectsInOrg(params: RequestOptions with TeamsListProjectsInOrgParams): js.Promise[Response[TeamsListProjectsInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List team projects`](https://developer.github.com/v3/teams/#list-team-projects) endpoint.
    *
    * Lists the organization projects for a team.
    * @deprecated octokit.teams.listProjectsLegacy() is deprecated, see https://developer.github.com/v3/teams/#list-team-projects-legacy
    */
  def listProjectsLegacy(): js.Promise[Response[TeamsListProjectsLegacyResponse]] = js.native
  def listProjectsLegacy(params: RequestOptions with TeamsListProjectsLegacyParams): js.Promise[Response[TeamsListProjectsLegacyResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List team repos`](https://developer.github.com/v3/teams/#list-team-repos) endpoint.
    * @deprecated octokit.teams.listRepos() is deprecated, see https://developer.github.com/v3/teams/#list-team-repos-legacy
    */
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/:org_id/team/:team_id/repos`.
    */
  def listReposInOrg(): js.Promise[Response[TeamsListReposInOrgResponse]] = js.native
  def listReposInOrg(params: RequestOptions with TeamsListReposInOrgParams): js.Promise[Response[TeamsListReposInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List team repos`](https://developer.github.com/v3/teams/#list-team-repos) endpoint.
    * @deprecated octokit.teams.listReposLegacy() is deprecated, see https://developer.github.com/v3/teams/#list-team-repos-legacy
    */
  def listReposLegacy(): js.Promise[Response[TeamsListReposLegacyResponse]] = js.native
  def listReposLegacy(params: RequestOptions with TeamsListReposLegacyParams): js.Promise[Response[TeamsListReposLegacyResponse]] = js.native
  /**
    * The "Remove team member" endpoint (described below) is deprecated.
    *
    * We recommend using the [Remove team membership](https://developer.github.com/v3/teams/members/#remove-team-membership) endpoint instead. It allows you to remove both active and pending memberships.
  ...
  def removeMembershipInOrg(params: RequestOptions with TeamsRemoveMembershipInOrgParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Remove team membership`](https://developer.github.com/v3/teams/members/#remove-team-membership) endpoint.
    *
    * Team synchronization is available for organizations using GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
  ...
  def removeMembershipLegacy(params: RequestOptions with TeamsRemoveMembershipLegacyParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Remove team project`](https://developer.github.com/v3/teams/#remove-team-project) endpoint.
    *
    * Removes an organization project from a team. An organization owner or a team maintainer can remove any project from the team. To remove a project from a team as an organization member, the authenticated user must have `read` access to both the team and project, or `admin` access to the team or project. **Note:** This endpoint removes the project from the team, but does not delete it.
  ...
  def removeProjectInOrg(params: RequestOptions with TeamsRemoveProjectInOrgParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Remove team project`](https://developer.github.com/v3/teams/#remove-team-project) endpoint.
    *
    * Removes an organization project from a team. An organization owner or a team maintainer can remove any project from the team. To remove a project from a team as an organization member, the authenticated user must have `read` access to both the team and project, or `admin` access to the team or project. **Note:** This endpoint removes the project from the team, but does not delete it.
  ...
  def removeProjectLegacy(params: RequestOptions with TeamsRemoveProjectLegacyParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Remove team repository`](https://developer.github.com/v3/teams/#remove-team-repository) endpoint.
    *
    * If the authenticated user is an organization owner or a team maintainer, they can remove any repositories from the team. To remove a repository from a team as an organization member, the authenticated user must have admin access to the repository and must be able to see the team. NOTE: This does not delete the repository, it just removes it from the team.
  ...
  def removeRepoInOrg(params: RequestOptions with TeamsRemoveRepoInOrgParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Remove team repository`](https://developer.github.com/v3/teams/#remove-team-repository) endpoint.
    *
    * If the authenticated user is an organization owner or a team maintainer, they can remove any repositories from the team. To remove a repository from a team as an organization member, the authenticated user must have admin access to the repository and must be able to see the team. NOTE: This does not delete the repository, it just removes it from the team.
  ...
  def removeRepoLegacy(params: RequestOptions with TeamsRemoveRepoLegacyParams): js.Promise[AnyResponse] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Review a team project`](https://developer.github.com/v3/teams/#review-a-team-project) endpoint.
    *
    * Checks whether a team has `read`, `write`, or `admin` permissions for an organization project. The response includes projects inherited from a parent team.
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/:org_id/team/:team_id/projects/:project_id`.
    */
  def reviewProjectInOrg(): js.Promise[Response[TeamsReviewProjectInOrgResponse]] = js.native
  def reviewProjectInOrg(params: RequestOptions with TeamsReviewProjectInOrgParams): js.Promise[Response[TeamsReviewProjectInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Review a team project`](https://developer.github.com/v3/teams/#review-a-team-project) endpoint.
    *
    * Checks whether a team has `read`, `write`, or `admin` permissions for an organization project. The response includes projects inherited from a parent team.
    * @deprecated octokit.teams.reviewProjectLegacy() is deprecated, see https://developer.github.com/v3/teams/#review-a-team-project-legacy
    */
  def reviewProjectLegacy(): js.Promise[Response[TeamsReviewProjectLegacyResponse]] = js.native
  def reviewProjectLegacy(params: RequestOptions with TeamsReviewProjectLegacyParams): js.Promise[Response[TeamsReviewProjectLegacyResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Edit team`](https://developer.github.com/v3/teams/#edit-team) endpoint.
    *
    * To edit a team, the authenticated user must either be an organization owner or a team maintainer.
  ...
  /**
    ...
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `PATCH /organizations/:org_id/team/:team_id/discussions/:discussion_number/comments/:comment_number`.
    */
  def updateDiscussionCommentInOrg(): js.Promise[Response[TeamsUpdateDiscussionCommentInOrgResponse]] = js.native
  def updateDiscussionCommentInOrg(params: RequestOptions with TeamsUpdateDiscussionCommentInOrgParams): js.Promise[Response[TeamsUpdateDiscussionCommentInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Edit a comment`](https://developer.github.com/v3/teams/discussion_comments/#edit-a-comment) endpoint.
    *
    * Edits the body text of a discussion comment. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    * @deprecated octokit.teams.updateDiscussionCommentLegacy() is deprecated, see https://developer.github.com/v3/teams/discussion_comments/#edit-a-comment-legacy
    */
  def updateDiscussionCommentLegacy(): js.Promise[Response[TeamsUpdateDiscussionCommentLegacyResponse]] = js.native
  def updateDiscussionCommentLegacy(params: RequestOptions with TeamsUpdateDiscussionCommentLegacyParams): js.Promise[Response[TeamsUpdateDiscussionCommentLegacyResponse]] = js.native
  /**
    * Edits the title and body text of a discussion post. Only the parameters you provide are updated. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    *
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `PATCH /organizations/:org_id/team/:team_id/discussions/:discussion_number`.
    */
  def updateDiscussionInOrg(): js.Promise[Response[TeamsUpdateDiscussionInOrgResponse]] = js.native
  def updateDiscussionInOrg(params: RequestOptions with TeamsUpdateDiscussionInOrgParams): js.Promise[Response[TeamsUpdateDiscussionInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Edit a discussion`](https://developer.github.com/v3/teams/discussions/#edit-a-discussion) endpoint.
    *
    * Edits the title and body text of a discussion post. Only the parameters you provide are updated. OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    * @deprecated octokit.teams.updateDiscussionLegacy() is deprecated, see https://developer.github.com/v3/teams/discussions/#edit-a-discussion-legacy
    */
  def updateDiscussionLegacy(): js.Promise[Response[TeamsUpdateDiscussionLegacyResponse]] = js.native
  def updateDiscussionLegacy(params: RequestOptions with TeamsUpdateDiscussionLegacyParams): js.Promise[Response[TeamsUpdateDiscussionLegacyResponse]] = js.native
  /**
    * To edit a team, the authenticated user must either be an organization owner or a team maintainer.
    *
    * **Note:** You can also specify a team by `org_id` and `team_id` using the route `PATCH /organizations/:org_id/team/:team_id`.
    */
  def updateInOrg(): js.Promise[Response[TeamsUpdateInOrgResponse]] = js.native
  def updateInOrg(params: RequestOptions with TeamsUpdateInOrgParamsDeprecatedPermission with TeamsUpdateInOrgParams): js.Promise[Response[TeamsUpdateInOrgResponse]] = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`Edit team`](https://developer.github.com/v3/teams/#edit-team) endpoint.
    *
    * To edit a team, the authenticated user must either be an organization owner or a team maintainer.
    ...
    * @deprecated octokit.teams.updateLegacy() is deprecated, see https://developer.github.com/v3/teams/#edit-team-legacy
    */
  def updateLegacy(): js.Promise[Response[TeamsUpdateLegacyResponse]] = js.native
  def updateLegacy(
