...
import typings.octokitRest.mod.IssuesListEventsForRepoParams
import typings.octokitRest.mod.IssuesListEventsForRepoResponse
...
@js.native
trait AnonEndpointParamsIssuesListEventsForRepoParams extends js.Object {
  @JSName("endpoint")
