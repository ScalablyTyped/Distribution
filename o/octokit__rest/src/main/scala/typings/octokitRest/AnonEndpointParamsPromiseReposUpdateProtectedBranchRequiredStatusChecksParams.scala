...
import typings.octokitRest.mod.ReposUpdateProtectedBranchRequiredStatusChecksParams
import typings.octokitRest.mod.ReposUpdateProtectedBranchRequiredStatusChecksResponse
