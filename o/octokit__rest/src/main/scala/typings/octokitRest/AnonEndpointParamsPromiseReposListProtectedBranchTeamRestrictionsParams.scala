...
import typings.octokitRest.mod.Octokit.ReposListProtectedBranchTeamRestrictionsParams
import typings.octokitRest.mod.Octokit.ReposListProtectedBranchTeamRestrictionsResponse
