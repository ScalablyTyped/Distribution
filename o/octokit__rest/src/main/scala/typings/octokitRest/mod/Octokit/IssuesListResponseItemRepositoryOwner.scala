...
trait IssuesListResponseItemRepositoryOwner extends js.Object {
...
object IssuesListResponseItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListResponseItemRepositoryOwner]
  }
}
