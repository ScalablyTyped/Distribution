...
trait ReactionsListForTeamDiscussionCommentInOrgResponseItemUser extends js.Object {
...
object ReactionsListForTeamDiscussionCommentInOrgResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsListForTeamDiscussionCommentInOrgResponseItemUser]
  }
}
