...
trait TeamsUpdateDiscussionCommentLegacyResponseAuthor extends js.Object {
...
object TeamsUpdateDiscussionCommentLegacyResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionCommentLegacyResponseAuthor]
  }
}
