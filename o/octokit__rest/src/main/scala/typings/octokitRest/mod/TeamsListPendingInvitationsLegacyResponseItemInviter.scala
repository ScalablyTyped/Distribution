...
trait TeamsListPendingInvitationsLegacyResponseItemInviter extends js.Object {
...
object TeamsListPendingInvitationsLegacyResponseItemInviter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListPendingInvitationsLegacyResponseItemInviter]
  }
}
