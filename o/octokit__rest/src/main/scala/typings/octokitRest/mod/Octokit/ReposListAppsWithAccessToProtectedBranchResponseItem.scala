...
trait ReposListAppsWithAccessToProtectedBranchResponseItem extends js.Object {
  ...
  var name: String
  var node_id: String
  var owner: ReposListAppsWithAccessToProtectedBranchResponseItemOwner
  var permissions: ReposListAppsWithAccessToProtectedBranchResponseItemPermissions
  var slug: String
  var updated_at: String
}

object ReposListAppsWithAccessToProtectedBranchResponseItem {
  @scala.inline
  def apply(
    created_at: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposListAppsWithAccessToProtectedBranchResponseItem]
  }
}
