...
trait PullsUpdateResponseRequestedTeamsItem extends js.Object {
...
object PullsUpdateResponseRequestedTeamsItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[PullsUpdateResponseRequestedTeamsItem]
  }
}
