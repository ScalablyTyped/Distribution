...
trait TeamsReviewProjectInOrgResponseCreator extends js.Object {
...
object TeamsReviewProjectInOrgResponseCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsReviewProjectInOrgResponseCreator]
  }
}
