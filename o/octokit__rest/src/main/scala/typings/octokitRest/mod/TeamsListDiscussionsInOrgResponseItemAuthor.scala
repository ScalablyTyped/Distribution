...
trait TeamsListDiscussionsInOrgResponseItemAuthor extends js.Object {
...
object TeamsListDiscussionsInOrgResponseItemAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListDiscussionsInOrgResponseItemAuthor]
  }
}
