...
trait GistsListStarredResponseItem extends js.Object {
  var comments: Double
  var comments_url: String
  var commits_url: String
  var created_at: String
  var description: String
  var files: GistsListStarredResponseItemFiles
  ...
  var id: String
  var node_id: String
  var owner: GistsListStarredResponseItemOwner
  var public: Boolean
...
object GistsListStarredResponseItem {
  @scala.inline
  def apply(
    comments: Double,
    comments_url: String,
    ...
    __obj.asInstanceOf[GistsListStarredResponseItem]
  }
}
