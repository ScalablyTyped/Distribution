...
trait ReposListProtectedBranchUserRestrictionsResponseItem extends js.Object {
...
object ReposListProtectedBranchUserRestrictionsResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListProtectedBranchUserRestrictionsResponseItem]
  }
}
