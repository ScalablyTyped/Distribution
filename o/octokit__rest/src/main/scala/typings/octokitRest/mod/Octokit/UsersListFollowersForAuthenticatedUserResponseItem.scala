...
trait UsersListFollowersForAuthenticatedUserResponseItem extends js.Object {
...
object UsersListFollowersForAuthenticatedUserResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[UsersListFollowersForAuthenticatedUserResponseItem]
  }
}
