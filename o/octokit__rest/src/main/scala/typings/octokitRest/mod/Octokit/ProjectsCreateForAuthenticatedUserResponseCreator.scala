...
trait ProjectsCreateForAuthenticatedUserResponseCreator extends js.Object {
...
object ProjectsCreateForAuthenticatedUserResponseCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ProjectsCreateForAuthenticatedUserResponseCreator]
  }
}
