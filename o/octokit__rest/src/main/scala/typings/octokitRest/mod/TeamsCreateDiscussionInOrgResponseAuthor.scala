...
trait TeamsCreateDiscussionInOrgResponseAuthor extends js.Object {
...
object TeamsCreateDiscussionInOrgResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionInOrgResponseAuthor]
  }
}
