...
trait ReposRemoveProtectedBranchUserRestrictionsResponseItem extends js.Object {
...
object ReposRemoveProtectedBranchUserRestrictionsResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposRemoveProtectedBranchUserRestrictionsResponseItem]
  }
}
