...
trait IssuesListEventsForRepoResponseItemIssueMilestoneCreator extends js.Object {
...
object IssuesListEventsForRepoResponseItemIssueMilestoneCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListEventsForRepoResponseItemIssueMilestoneCreator]
  }
}
