...
trait TeamsListChildLegacyResponseItemParent extends js.Object {
...
object TeamsListChildLegacyResponseItemParent {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[TeamsListChildLegacyResponseItemParent]
  }
}
