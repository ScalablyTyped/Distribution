...
trait OrgsGetMembershipForAuthenticatedUserResponseUser extends js.Object {
...
object OrgsGetMembershipForAuthenticatedUserResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[OrgsGetMembershipForAuthenticatedUserResponseUser]
  }
}
