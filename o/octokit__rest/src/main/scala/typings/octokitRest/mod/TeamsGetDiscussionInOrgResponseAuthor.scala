...
trait TeamsGetDiscussionInOrgResponseAuthor extends js.Object {
...
object TeamsGetDiscussionInOrgResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsGetDiscussionInOrgResponseAuthor]
  }
}
