...
trait ReposListForOrgResponseItem extends js.Object {
  ...
  var license: ReposListForOrgResponseItemLicense
  ...
  var owner: ReposListForOrgResponseItemOwner
  var permissions: ReposListForOrgResponseItemPermissions
  var `private`: Boolean
...
object ReposListForOrgResponseItem {
  @scala.inline
  def apply(
    archive_url: String,
    archived: Boolean,
    ...
    __obj.asInstanceOf[ReposListForOrgResponseItem]
  }
}
