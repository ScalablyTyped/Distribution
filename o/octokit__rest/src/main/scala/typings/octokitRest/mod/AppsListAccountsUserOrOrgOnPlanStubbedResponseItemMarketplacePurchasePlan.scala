...
trait AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchasePlan extends js.Object {
...
object AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchasePlan {
  @scala.inline
  def apply(
    accounts_url: String,
    ...
    __obj.asInstanceOf[AppsListAccountsUserOrOrgOnPlanStubbedResponseItemMarketplacePurchasePlan]
  }
}
