...
trait ReposUpdateFileResponseContent extends js.Object {
  var _links: ReposUpdateFileResponseContentLinks
...
object ReposUpdateFileResponseContent {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUpdateFileResponseContent]
  }
}
