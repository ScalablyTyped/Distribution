...
trait TeamsCreateDiscussionCommentLegacyResponse extends js.Object {
  var author: TeamsCreateDiscussionCommentLegacyResponseAuthor
  var body: String
  ...
  var node_id: String
  var number: Double
  var reactions: TeamsCreateDiscussionCommentLegacyResponseReactions
  var updated_at: String
  var url: String
}

object TeamsCreateDiscussionCommentLegacyResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionCommentLegacyResponse]
  }
}
