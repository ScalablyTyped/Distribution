...
trait PullsCreateReviewCommentReplyResponseUser extends js.Object {
...
object PullsCreateReviewCommentReplyResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateReviewCommentReplyResponseUser]
  }
}
