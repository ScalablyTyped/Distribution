...
trait IssuesListForAuthenticatedUserResponseItemUser extends js.Object {
...
object IssuesListForAuthenticatedUserResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListForAuthenticatedUserResponseItemUser]
  }
}
