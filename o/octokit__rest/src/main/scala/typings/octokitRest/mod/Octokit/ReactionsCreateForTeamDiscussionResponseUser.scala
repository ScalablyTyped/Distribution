...
trait ReactionsCreateForTeamDiscussionResponseUser extends js.Object {
...
object ReactionsCreateForTeamDiscussionResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsCreateForTeamDiscussionResponseUser]
  }
}
