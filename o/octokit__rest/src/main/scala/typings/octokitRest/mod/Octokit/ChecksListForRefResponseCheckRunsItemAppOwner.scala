...
trait ChecksListForRefResponseCheckRunsItemAppOwner extends js.Object {
...
object ChecksListForRefResponseCheckRunsItemAppOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[ChecksListForRefResponseCheckRunsItemAppOwner]
  }
}
