...
trait PullsCreateFromIssueResponseRequestedReviewersItem extends js.Object {
...
object PullsCreateFromIssueResponseRequestedReviewersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateFromIssueResponseRequestedReviewersItem]
  }
}
