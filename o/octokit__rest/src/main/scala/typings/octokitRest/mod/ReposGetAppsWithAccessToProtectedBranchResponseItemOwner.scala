...
trait ReposGetAppsWithAccessToProtectedBranchResponseItemOwner extends js.Object {
...
object ReposGetAppsWithAccessToProtectedBranchResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposGetAppsWithAccessToProtectedBranchResponseItemOwner]
  }
}
