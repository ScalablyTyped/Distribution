...
trait ReactionsListForTeamDiscussionResponseItemUser extends js.Object {
...
object ReactionsListForTeamDiscussionResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsListForTeamDiscussionResponseItemUser]
  }
}
