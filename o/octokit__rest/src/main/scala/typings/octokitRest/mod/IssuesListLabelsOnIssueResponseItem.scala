...
trait IssuesListLabelsOnIssueResponseItem extends js.Object {
  var color: String
  var default: Boolean
...
object IssuesListLabelsOnIssueResponseItem {
  @scala.inline
  def apply(
    color: String,
    default: Boolean,
    ...
    __obj.asInstanceOf[IssuesListLabelsOnIssueResponseItem]
  }
}
