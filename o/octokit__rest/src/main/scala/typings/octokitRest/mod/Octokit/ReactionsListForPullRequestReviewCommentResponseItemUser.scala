...
trait ReactionsListForPullRequestReviewCommentResponseItemUser extends js.Object {
...
object ReactionsListForPullRequestReviewCommentResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsListForPullRequestReviewCommentResponseItemUser]
  }
}
