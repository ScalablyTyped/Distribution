...
trait GistsUpdateResponse extends js.Object {
  var comments: Double
  var comments_url: String
  var commits_url: String
  var created_at: String
  var description: String
  var files: GistsUpdateResponseFiles
  var forks: js.Array[GistsUpdateResponseForksItem]
  var forks_url: String
  var git_pull_url: String
  var git_push_url: String
  var history: js.Array[GistsUpdateResponseHistoryItem]
  var html_url: String
  var id: String
  var node_id: String
  var owner: GistsUpdateResponseOwner
  var public: Boolean
...
object GistsUpdateResponse {
  ...
  def apply(
    ...
    forks: js.Array[GistsUpdateResponseForksItem],
    forks_url: String,
    git_pull_url: String,
    git_push_url: String,
    history: js.Array[GistsUpdateResponseHistoryItem],
    html_url: String,
    id: String,
    node_id: String,
    ...
    __obj.asInstanceOf[GistsUpdateResponse]
  }
}
