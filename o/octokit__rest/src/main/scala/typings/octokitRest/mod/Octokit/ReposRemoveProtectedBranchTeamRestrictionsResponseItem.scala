...
trait ReposRemoveProtectedBranchTeamRestrictionsResponseItem extends js.Object {
...
object ReposRemoveProtectedBranchTeamRestrictionsResponseItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[ReposRemoveProtectedBranchTeamRestrictionsResponseItem]
  }
}
