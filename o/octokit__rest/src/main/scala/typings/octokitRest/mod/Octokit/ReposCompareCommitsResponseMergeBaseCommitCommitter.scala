...
trait ReposCompareCommitsResponseMergeBaseCommitCommitter extends js.Object {
...
object ReposCompareCommitsResponseMergeBaseCommitCommitter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCompareCommitsResponseMergeBaseCommitCommitter]
  }
}
