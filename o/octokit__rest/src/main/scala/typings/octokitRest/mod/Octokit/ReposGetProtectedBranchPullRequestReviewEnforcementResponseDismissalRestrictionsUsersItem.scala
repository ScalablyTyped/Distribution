...
trait ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsUsersItem extends js.Object {
...
object ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsUsersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchPullRequestReviewEnforcementResponseDismissalRestrictionsUsersItem]
  }
}
