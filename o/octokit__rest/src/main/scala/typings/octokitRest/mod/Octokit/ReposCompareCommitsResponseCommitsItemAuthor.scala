...
trait ReposCompareCommitsResponseCommitsItemAuthor extends js.Object {
...
object ReposCompareCommitsResponseCommitsItemAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCompareCommitsResponseCommitsItemAuthor]
  }
}
