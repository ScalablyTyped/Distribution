...
trait PullsUpdateResponseBaseRepo extends js.Object {
  ...
  var owner: PullsUpdateResponseBaseRepoOwner
  var permissions: PullsUpdateResponseBaseRepoPermissions
  var `private`: Boolean
...
object PullsUpdateResponseBaseRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsUpdateResponseBaseRepo]
  }
}
