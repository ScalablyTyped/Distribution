...
trait IssuesListForOrgResponseItemAssigneesItem extends js.Object {
...
object IssuesListForOrgResponseItemAssigneesItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListForOrgResponseItemAssigneesItem]
  }
}
