...
trait ChecksSetSuitesPreferencesResponseRepository extends js.Object {
  ...
  var owner: ChecksSetSuitesPreferencesResponseRepositoryOwner
  var permissions: ChecksSetSuitesPreferencesResponseRepositoryPermissions
  var `private`: Boolean
...
object ChecksSetSuitesPreferencesResponseRepository {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ChecksSetSuitesPreferencesResponseRepository]
  }
}
