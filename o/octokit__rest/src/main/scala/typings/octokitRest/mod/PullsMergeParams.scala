...
import typings.octokitRest.octokitRestStrings.merge
import typings.octokitRest.octokitRestStrings.rebase
import typings.octokitRest.octokitRestStrings.squash
