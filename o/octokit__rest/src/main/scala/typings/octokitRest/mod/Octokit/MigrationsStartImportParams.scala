...
import typings.octokitRest.octokitRestStrings.git
import typings.octokitRest.octokitRestStrings.mercurial
import typings.octokitRest.octokitRestStrings.subversion
import typings.octokitRest.octokitRestStrings.tfvc
