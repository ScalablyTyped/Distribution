...
trait ReposListCommitCommentsResponseItem extends js.Object {
  var body: String
  ...
  var url: String
  var user: ReposListCommitCommentsResponseItemUser
}

object ReposListCommitCommentsResponseItem {
  @scala.inline
  def apply(
    body: String,
    commit_id: String,
    ...
    __obj.asInstanceOf[ReposListCommitCommentsResponseItem]
  }
}
