...
trait ReposListPublicResponseItem extends js.Object {
  ...
  var owner: ReposListPublicResponseItemOwner
  var `private`: Boolean
...
object ReposListPublicResponseItem {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    __obj.asInstanceOf[ReposListPublicResponseItem]
  }
}
