...
trait UsersListGpgKeysForUserResponseItemSubkeysItem extends js.Object {
...
object UsersListGpgKeysForUserResponseItemSubkeysItem {
  @scala.inline
  def apply(
    can_certify: Boolean,
    ...
    __obj.asInstanceOf[UsersListGpgKeysForUserResponseItemSubkeysItem]
  }
}
