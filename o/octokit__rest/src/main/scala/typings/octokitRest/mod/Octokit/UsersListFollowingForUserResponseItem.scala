...
trait UsersListFollowingForUserResponseItem extends js.Object {
...
object UsersListFollowingForUserResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[UsersListFollowingForUserResponseItem]
  }
}
