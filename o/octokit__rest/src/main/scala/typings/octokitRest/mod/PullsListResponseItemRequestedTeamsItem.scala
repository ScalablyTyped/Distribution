...
trait PullsListResponseItemRequestedTeamsItem extends js.Object {
...
object PullsListResponseItemRequestedTeamsItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[PullsListResponseItemRequestedTeamsItem]
  }
}
