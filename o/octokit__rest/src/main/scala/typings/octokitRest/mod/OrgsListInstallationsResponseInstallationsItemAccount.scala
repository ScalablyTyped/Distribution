...
trait OrgsListInstallationsResponseInstallationsItemAccount extends js.Object {
...
object OrgsListInstallationsResponseInstallationsItemAccount {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[OrgsListInstallationsResponseInstallationsItemAccount]
  }
}
