...
trait IssuesGetCommentResponse extends js.Object {
  var body: String
  ...
  var url: String
  var user: IssuesGetCommentResponseUser
}

object IssuesGetCommentResponse {
  @scala.inline
  def apply(
    body: String,
    created_at: String,
    ...
    __obj.asInstanceOf[IssuesGetCommentResponse]
  }
}
