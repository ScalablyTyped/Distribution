...
trait OrgsGetMembershipResponseOrganization extends js.Object {
...
object OrgsGetMembershipResponseOrganization {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[OrgsGetMembershipResponseOrganization]
  }
}
