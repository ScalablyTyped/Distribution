...
import typings.octokitRest.octokitRestStrings.newest
import typings.octokitRest.octokitRestStrings.oldest
import typings.octokitRest.octokitRestStrings.stargazers
