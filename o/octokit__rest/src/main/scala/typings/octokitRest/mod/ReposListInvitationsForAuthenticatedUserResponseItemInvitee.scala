...
trait ReposListInvitationsForAuthenticatedUserResponseItemInvitee extends js.Object {
...
object ReposListInvitationsForAuthenticatedUserResponseItemInvitee {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListInvitationsForAuthenticatedUserResponseItemInvitee]
  }
}
