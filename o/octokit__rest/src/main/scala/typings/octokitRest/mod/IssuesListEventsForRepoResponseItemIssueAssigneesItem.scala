...
trait IssuesListEventsForRepoResponseItemIssueAssigneesItem extends js.Object {
...
object IssuesListEventsForRepoResponseItemIssueAssigneesItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListEventsForRepoResponseItemIssueAssigneesItem]
  }
}
