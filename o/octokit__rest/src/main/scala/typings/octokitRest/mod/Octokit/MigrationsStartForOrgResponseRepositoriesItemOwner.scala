...
trait MigrationsStartForOrgResponseRepositoriesItemOwner extends js.Object {
...
object MigrationsStartForOrgResponseRepositoriesItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[MigrationsStartForOrgResponseRepositoriesItemOwner]
  }
}
