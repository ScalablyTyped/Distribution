...
trait TeamsCheckManagesRepoLegacyResponse extends js.Object {
  ...
  var owner: TeamsCheckManagesRepoLegacyResponseOwner
  var permissions: TeamsCheckManagesRepoLegacyResponsePermissions
  var `private`: Boolean
...
object TeamsCheckManagesRepoLegacyResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoLegacyResponse]
  }
}
