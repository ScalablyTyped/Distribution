...
trait IssuesGetMilestoneResponse extends js.Object {
  var closed_at: String
  var closed_issues: Double
  var created_at: String
  var creator: IssuesGetMilestoneResponseCreator
...
object IssuesGetMilestoneResponse {
  @scala.inline
  def apply(
    closed_at: String,
    ...
    __obj.asInstanceOf[IssuesGetMilestoneResponse]
  }
}
