...
import typings.octokitRest.octokitRestStrings.conclusion
import typings.octokitRest.octokitRestStrings.status
...
trait ActionsListWorkflowRunsParams extends js.Object {
  ...
  /**
    ...
    */
  var status: js.UndefOr[completed | typings.octokitRest.octokitRestStrings.status | conclusion] = js.undefined
