...
trait OauthAuthorizationsCheckAuthorizationResponseUser extends js.Object {
...
object OauthAuthorizationsCheckAuthorizationResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[OauthAuthorizationsCheckAuthorizationResponseUser]
  }
}
