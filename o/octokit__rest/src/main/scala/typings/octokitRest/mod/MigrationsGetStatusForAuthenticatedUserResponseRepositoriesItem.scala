...
trait MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItem extends js.Object {
  ...
  var owner: MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemOwner
  var permissions: MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemPermissions
  var `private`: Boolean
...
object MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItem]
  }
}
