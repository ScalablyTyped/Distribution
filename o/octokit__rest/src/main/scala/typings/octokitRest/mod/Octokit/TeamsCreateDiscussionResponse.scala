...
trait TeamsCreateDiscussionResponse extends js.Object {
  var author: TeamsCreateDiscussionResponseAuthor
  var body: String
  ...
  var pinned: Boolean
  var `private`: Boolean
  var reactions: TeamsCreateDiscussionResponseReactions
  var team_url: String
  var title: String
...
object TeamsCreateDiscussionResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionResponse]
  }
}
