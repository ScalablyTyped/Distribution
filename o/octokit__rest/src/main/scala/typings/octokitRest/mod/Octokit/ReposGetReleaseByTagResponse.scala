...
trait ReposGetReleaseByTagResponse extends js.Object {
  var assets: js.Array[ReposGetReleaseByTagResponseAssetsItem]
  var assets_url: String
  var author: ReposGetReleaseByTagResponseAuthor
  var body: String
...
object ReposGetReleaseByTagResponse {
  @scala.inline
  def apply(
    assets: js.Array[ReposGetReleaseByTagResponseAssetsItem],
    assets_url: String,
    ...
    __obj.asInstanceOf[ReposGetReleaseByTagResponse]
  }
}
