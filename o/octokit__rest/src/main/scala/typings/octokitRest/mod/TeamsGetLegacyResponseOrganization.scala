...
trait TeamsGetLegacyResponseOrganization extends js.Object {
...
object TeamsGetLegacyResponseOrganization {
  @scala.inline
  def apply(
    avatar_url: String,
    blog: String,
    ...
    __obj.asInstanceOf[TeamsGetLegacyResponseOrganization]
  }
}
