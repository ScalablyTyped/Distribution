...
trait ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner extends js.Object {
...
object ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner]
  }
}
