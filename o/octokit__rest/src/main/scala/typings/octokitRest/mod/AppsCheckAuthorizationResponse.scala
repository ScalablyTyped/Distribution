...
trait AppsCheckAuthorizationResponse extends js.Object {
  var app: AppsCheckAuthorizationResponseApp
  ...
  var url: String
  var user: AppsCheckAuthorizationResponseUser
}

object AppsCheckAuthorizationResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsCheckAuthorizationResponse]
  }
}
