...
trait ActionsGetWorkflowRunResponseHeadRepositoryOwner extends js.Object {
...
object ActionsGetWorkflowRunResponseHeadRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActionsGetWorkflowRunResponseHeadRepositoryOwner]
  }
}
