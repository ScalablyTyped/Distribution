...
trait TeamsCheckManagesRepoResponseOwner extends js.Object {
...
object TeamsCheckManagesRepoResponseOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoResponseOwner]
  }
}
