...
trait ProjectsListForUserResponseItemCreator extends js.Object {
...
object ProjectsListForUserResponseItemCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ProjectsListForUserResponseItemCreator]
  }
}
