...
trait ActivityListReposStarredByAuthenticatedUserResponseItem extends js.Object {
  ...
  var owner: ActivityListReposStarredByAuthenticatedUserResponseItemOwner
  var permissions: ActivityListReposStarredByAuthenticatedUserResponseItemPermissions
  var `private`: Boolean
...
object ActivityListReposStarredByAuthenticatedUserResponseItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListReposStarredByAuthenticatedUserResponseItem]
  }
}
