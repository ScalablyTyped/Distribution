...
trait TeamsListReposLegacyResponseItem extends js.Object {
  ...
  var license: TeamsListReposLegacyResponseItemLicense
  ...
  var owner: TeamsListReposLegacyResponseItemOwner
  var permissions: TeamsListReposLegacyResponseItemPermissions
  var `private`: Boolean
...
object TeamsListReposLegacyResponseItem {
  @scala.inline
  def apply(
    archive_url: String,
    archived: Boolean,
    ...
    __obj.asInstanceOf[TeamsListReposLegacyResponseItem]
  }
}
