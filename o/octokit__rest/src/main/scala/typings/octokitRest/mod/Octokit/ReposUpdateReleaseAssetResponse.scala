...
trait ReposUpdateReleaseAssetResponse extends js.Object {
  ...
  var uploader: ReposUpdateReleaseAssetResponseUploader
  var url: String
}

object ReposUpdateReleaseAssetResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUpdateReleaseAssetResponse]
  }
}
