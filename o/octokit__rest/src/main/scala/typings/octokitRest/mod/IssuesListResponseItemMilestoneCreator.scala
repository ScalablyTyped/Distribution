...
trait IssuesListResponseItemMilestoneCreator extends js.Object {
...
object IssuesListResponseItemMilestoneCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListResponseItemMilestoneCreator]
  }
}
