...
trait MigrationsListReposForUserResponseItemOwner extends js.Object {
...
object MigrationsListReposForUserResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[MigrationsListReposForUserResponseItemOwner]
  }
}
