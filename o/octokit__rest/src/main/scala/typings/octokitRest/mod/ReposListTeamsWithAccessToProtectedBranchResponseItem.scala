...
trait ReposListTeamsWithAccessToProtectedBranchResponseItem extends js.Object {
...
object ReposListTeamsWithAccessToProtectedBranchResponseItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[ReposListTeamsWithAccessToProtectedBranchResponseItem]
  }
}
