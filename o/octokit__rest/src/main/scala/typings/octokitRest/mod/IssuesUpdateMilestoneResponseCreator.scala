...
trait IssuesUpdateMilestoneResponseCreator extends js.Object {
...
object IssuesUpdateMilestoneResponseCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesUpdateMilestoneResponseCreator]
  }
}
