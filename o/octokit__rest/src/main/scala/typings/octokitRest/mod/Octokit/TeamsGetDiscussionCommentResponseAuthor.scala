...
trait TeamsGetDiscussionCommentResponseAuthor extends js.Object {
...
object TeamsGetDiscussionCommentResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsGetDiscussionCommentResponseAuthor]
  }
}
