...
trait OrgsListMembershipsResponseItemOrganization extends js.Object {
...
object OrgsListMembershipsResponseItemOrganization {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[OrgsListMembershipsResponseItemOrganization]
  }
}
