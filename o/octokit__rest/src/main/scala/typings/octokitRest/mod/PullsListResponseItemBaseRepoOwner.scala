...
trait PullsListResponseItemBaseRepoOwner extends js.Object {
...
object PullsListResponseItemBaseRepoOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsListResponseItemBaseRepoOwner]
  }
}
