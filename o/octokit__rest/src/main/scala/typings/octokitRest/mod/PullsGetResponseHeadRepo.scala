...
trait PullsGetResponseHeadRepo extends js.Object {
  ...
  var owner: PullsGetResponseHeadRepoOwner
  var permissions: PullsGetResponseHeadRepoPermissions
  var `private`: Boolean
...
object PullsGetResponseHeadRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsGetResponseHeadRepo]
  }
}
