...
trait IssuesListCommentsResponseItemUser extends js.Object {
...
object IssuesListCommentsResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListCommentsResponseItemUser]
  }
}
