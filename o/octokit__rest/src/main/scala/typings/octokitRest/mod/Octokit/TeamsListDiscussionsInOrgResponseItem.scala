...
trait TeamsListDiscussionsInOrgResponseItem extends js.Object {
  var author: TeamsListDiscussionsInOrgResponseItemAuthor
  var body: String
  ...
  var pinned: Boolean
  var `private`: Boolean
  var reactions: TeamsListDiscussionsInOrgResponseItemReactions
  var team_url: String
  var title: String
...
object TeamsListDiscussionsInOrgResponseItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsListDiscussionsInOrgResponseItem]
  }
}
