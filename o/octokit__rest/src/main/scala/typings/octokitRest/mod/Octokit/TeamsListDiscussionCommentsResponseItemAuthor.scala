...
trait TeamsListDiscussionCommentsResponseItemAuthor extends js.Object {
...
object TeamsListDiscussionCommentsResponseItemAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListDiscussionCommentsResponseItemAuthor]
  }
}
