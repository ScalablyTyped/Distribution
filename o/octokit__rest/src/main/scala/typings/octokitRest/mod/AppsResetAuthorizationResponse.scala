...
trait AppsResetAuthorizationResponse extends js.Object {
  var app: AppsResetAuthorizationResponseApp
  ...
  var url: String
  var user: AppsResetAuthorizationResponseUser
}

object AppsResetAuthorizationResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsResetAuthorizationResponse]
  }
}
