...
trait ReposGetLatestReleaseResponseAuthor extends js.Object {
...
object ReposGetLatestReleaseResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetLatestReleaseResponseAuthor]
  }
}
