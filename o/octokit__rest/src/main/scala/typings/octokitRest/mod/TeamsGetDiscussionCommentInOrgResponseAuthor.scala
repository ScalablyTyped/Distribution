...
trait TeamsGetDiscussionCommentInOrgResponseAuthor extends js.Object {
...
object TeamsGetDiscussionCommentInOrgResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsGetDiscussionCommentInOrgResponseAuthor]
  }
}
