...
trait AppsGetUserInstallationResponse extends js.Object {
  var access_tokens_url: String
  var account: AppsGetUserInstallationResponseAccount
  var app_id: Double
  var created_at: String
  var events: js.Array[String]
  var html_url: String
  var id: Double
  var permissions: AppsGetUserInstallationResponsePermissions
...
object AppsGetUserInstallationResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsGetUserInstallationResponse]
  }
}
