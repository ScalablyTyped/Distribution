...
trait ActionsListWorkflowRunsResponseWorkflowRunsItemRepositoryOwner extends js.Object {
...
object ActionsListWorkflowRunsResponseWorkflowRunsItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActionsListWorkflowRunsResponseWorkflowRunsItemRepositoryOwner]
  }
}
