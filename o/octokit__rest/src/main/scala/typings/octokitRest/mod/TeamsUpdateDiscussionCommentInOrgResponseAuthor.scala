...
trait TeamsUpdateDiscussionCommentInOrgResponseAuthor extends js.Object {
...
object TeamsUpdateDiscussionCommentInOrgResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionCommentInOrgResponseAuthor]
  }
}
