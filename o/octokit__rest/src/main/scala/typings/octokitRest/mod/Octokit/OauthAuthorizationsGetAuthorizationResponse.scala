...
trait OauthAuthorizationsGetAuthorizationResponse extends js.Object {
  var app: OauthAuthorizationsGetAuthorizationResponseApp
...
object OauthAuthorizationsGetAuthorizationResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetAuthorizationResponse]
  }
}
