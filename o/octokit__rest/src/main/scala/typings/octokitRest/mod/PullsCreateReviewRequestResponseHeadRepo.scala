...
trait PullsCreateReviewRequestResponseHeadRepo extends js.Object {
  ...
  var owner: PullsCreateReviewRequestResponseHeadRepoOwner
  var permissions: PullsCreateReviewRequestResponseHeadRepoPermissions
  var `private`: Boolean
...
object PullsCreateReviewRequestResponseHeadRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseHeadRepo]
  }
}
