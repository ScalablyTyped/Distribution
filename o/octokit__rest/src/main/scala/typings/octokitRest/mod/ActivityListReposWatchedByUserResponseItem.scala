...
trait ActivityListReposWatchedByUserResponseItem extends js.Object {
  ...
  var license: ActivityListReposWatchedByUserResponseItemLicense
  ...
  var owner: ActivityListReposWatchedByUserResponseItemOwner
  var permissions: ActivityListReposWatchedByUserResponseItemPermissions
  var `private`: Boolean
...
object ActivityListReposWatchedByUserResponseItem {
  @scala.inline
  def apply(
    archive_url: String,
    archived: Boolean,
    ...
    __obj.asInstanceOf[ActivityListReposWatchedByUserResponseItem]
  }
}
