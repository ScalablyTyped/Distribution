...
trait MigrationsListForAuthenticatedUserResponseItemOwner extends js.Object {
...
object MigrationsListForAuthenticatedUserResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[MigrationsListForAuthenticatedUserResponseItemOwner]
  }
}
