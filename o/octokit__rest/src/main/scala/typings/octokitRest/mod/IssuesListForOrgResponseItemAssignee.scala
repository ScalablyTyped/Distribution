...
trait IssuesListForOrgResponseItemAssignee extends js.Object {
...
object IssuesListForOrgResponseItemAssignee {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListForOrgResponseItemAssignee]
  }
}
