...
trait PullsListReviewRequestsParamsDeprecatedNumber extends js.Object {
  /**
...
object PullsListReviewRequestsParamsDeprecatedNumber {
  @scala.inline
  def apply(
    number: Double,
    owner: String,
    ...
    __obj.asInstanceOf[PullsListReviewRequestsParamsDeprecatedNumber]
  }
}
