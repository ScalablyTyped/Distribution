...
trait PullsListReviewsParamsDeprecatedNumber extends js.Object {
  /**
...
object PullsListReviewsParamsDeprecatedNumber {
  @scala.inline
  def apply(
    number: Double,
    owner: String,
    ...
    __obj.asInstanceOf[PullsListReviewsParamsDeprecatedNumber]
  }
}
