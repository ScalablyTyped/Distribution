...
trait TeamsCreateDiscussionInOrgResponse extends js.Object {
  var author: TeamsCreateDiscussionInOrgResponseAuthor
  var body: String
  ...
  var pinned: Boolean
  var `private`: Boolean
  var reactions: TeamsCreateDiscussionInOrgResponseReactions
  var team_url: String
  var title: String
...
object TeamsCreateDiscussionInOrgResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionInOrgResponse]
  }
}
