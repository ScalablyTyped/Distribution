...
trait TeamsListReposInOrgResponseItem extends js.Object {
  ...
  var license: TeamsListReposInOrgResponseItemLicense
  ...
  var owner: TeamsListReposInOrgResponseItemOwner
  var permissions: TeamsListReposInOrgResponseItemPermissions
  var `private`: Boolean
...
object TeamsListReposInOrgResponseItem {
  @scala.inline
  def apply(
    archive_url: String,
    archived: Boolean,
    ...
    __obj.asInstanceOf[TeamsListReposInOrgResponseItem]
  }
}
