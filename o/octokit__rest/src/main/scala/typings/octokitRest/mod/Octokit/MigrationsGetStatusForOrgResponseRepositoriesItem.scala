...
trait MigrationsGetStatusForOrgResponseRepositoriesItem extends js.Object {
  ...
  var owner: MigrationsGetStatusForOrgResponseRepositoriesItemOwner
  var permissions: MigrationsGetStatusForOrgResponseRepositoriesItemPermissions
  var `private`: Boolean
...
object MigrationsGetStatusForOrgResponseRepositoriesItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsGetStatusForOrgResponseRepositoriesItem]
  }
}
