...
trait SearchCodeResponseItemsItemRepositoryOwner extends js.Object {
...
object SearchCodeResponseItemsItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[SearchCodeResponseItemsItemRepositoryOwner]
  }
}
