...
trait MigrationsListReposForOrgResponseItem extends js.Object {
  ...
  var license: MigrationsListReposForOrgResponseItemLicense
  ...
  var owner: MigrationsListReposForOrgResponseItemOwner
  var permissions: MigrationsListReposForOrgResponseItemPermissions
  var `private`: Boolean
...
object MigrationsListReposForOrgResponseItem {
  @scala.inline
  def apply(
    archive_url: String,
    archived: Boolean,
    ...
    __obj.asInstanceOf[MigrationsListReposForOrgResponseItem]
  }
}
