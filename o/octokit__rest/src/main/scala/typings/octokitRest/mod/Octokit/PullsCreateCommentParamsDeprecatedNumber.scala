...
import typings.octokitRest.octokitRestStrings.LEFT
import typings.octokitRest.octokitRestStrings.RIGHT
import typings.octokitRest.octokitRestStrings.side
...
object PullsCreateCommentParamsDeprecatedNumber {
  @scala.inline
  def apply(
    body: String,
    commit_id: String,
    ...
    __obj.asInstanceOf[PullsCreateCommentParamsDeprecatedNumber]
  }
}
