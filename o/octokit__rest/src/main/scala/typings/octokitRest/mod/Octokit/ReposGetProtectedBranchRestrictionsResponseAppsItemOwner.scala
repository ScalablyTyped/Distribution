...
trait ReposGetProtectedBranchRestrictionsResponseAppsItemOwner extends js.Object {
...
object ReposGetProtectedBranchRestrictionsResponseAppsItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchRestrictionsResponseAppsItemOwner]
  }
}
