...
trait ReposCreateUsingTemplateResponseOwner extends js.Object {
...
object ReposCreateUsingTemplateResponseOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCreateUsingTemplateResponseOwner]
  }
}
