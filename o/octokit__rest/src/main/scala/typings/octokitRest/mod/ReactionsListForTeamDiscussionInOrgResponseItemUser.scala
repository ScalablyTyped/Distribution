...
trait ReactionsListForTeamDiscussionInOrgResponseItemUser extends js.Object {
...
object ReactionsListForTeamDiscussionInOrgResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsListForTeamDiscussionInOrgResponseItemUser]
  }
}
