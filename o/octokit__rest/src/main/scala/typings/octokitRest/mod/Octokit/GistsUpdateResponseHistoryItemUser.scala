...
trait GistsUpdateResponseHistoryItemUser extends js.Object {
...
object GistsUpdateResponseHistoryItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[GistsUpdateResponseHistoryItemUser]
  }
}
