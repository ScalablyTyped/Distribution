...
trait IssuesListEventsForRepoResponseItemIssueUser extends js.Object {
...
object IssuesListEventsForRepoResponseItemIssueUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListEventsForRepoResponseItemIssueUser]
  }
}
