...
trait PullsCreateFromIssueResponseBaseRepo extends js.Object {
  ...
  var owner: PullsCreateFromIssueResponseBaseRepoOwner
  var permissions: PullsCreateFromIssueResponseBaseRepoPermissions
  var `private`: Boolean
...
object PullsCreateFromIssueResponseBaseRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateFromIssueResponseBaseRepo]
  }
}
