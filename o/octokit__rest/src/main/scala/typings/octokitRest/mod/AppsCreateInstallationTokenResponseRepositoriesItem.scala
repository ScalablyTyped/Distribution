...
trait AppsCreateInstallationTokenResponseRepositoriesItem extends js.Object {
  ...
  var owner: AppsCreateInstallationTokenResponseRepositoriesItemOwner
  var permissions: AppsCreateInstallationTokenResponseRepositoriesItemPermissions
  var `private`: Boolean
...
object AppsCreateInstallationTokenResponseRepositoriesItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsCreateInstallationTokenResponseRepositoriesItem]
  }
}
