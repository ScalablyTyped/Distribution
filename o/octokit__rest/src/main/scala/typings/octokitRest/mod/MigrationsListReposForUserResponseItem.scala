...
trait MigrationsListReposForUserResponseItem extends js.Object {
  ...
  var license: MigrationsListReposForUserResponseItemLicense
  ...
  var owner: MigrationsListReposForUserResponseItemOwner
  var permissions: MigrationsListReposForUserResponseItemPermissions
  var `private`: Boolean
...
object MigrationsListReposForUserResponseItem {
  @scala.inline
  def apply(
    archive_url: String,
    archived: Boolean,
    ...
    __obj.asInstanceOf[MigrationsListReposForUserResponseItem]
  }
}
