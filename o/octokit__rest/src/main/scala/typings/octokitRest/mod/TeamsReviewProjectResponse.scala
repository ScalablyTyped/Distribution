...
trait TeamsReviewProjectResponse extends js.Object {
  var body: String
  var columns_url: String
  var created_at: String
  var creator: TeamsReviewProjectResponseCreator
  var html_url: String
  var id: Double
  var name: String
  var node_id: String
  ...
  var permissions: TeamsReviewProjectResponsePermissions
  var `private`: Boolean
  var state: String
...
object TeamsReviewProjectResponse {
  @scala.inline
  def apply(
    body: String,
    columns_url: String,
    ...
    __obj.asInstanceOf[TeamsReviewProjectResponse]
  }
}
