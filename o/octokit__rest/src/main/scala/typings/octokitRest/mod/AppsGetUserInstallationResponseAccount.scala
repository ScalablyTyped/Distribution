...
trait AppsGetUserInstallationResponseAccount extends js.Object {
...
object AppsGetUserInstallationResponseAccount {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[AppsGetUserInstallationResponseAccount]
  }
}
