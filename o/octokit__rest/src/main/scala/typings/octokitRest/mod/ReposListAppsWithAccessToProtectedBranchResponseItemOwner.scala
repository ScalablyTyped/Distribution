...
trait ReposListAppsWithAccessToProtectedBranchResponseItemOwner extends js.Object {
...
object ReposListAppsWithAccessToProtectedBranchResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposListAppsWithAccessToProtectedBranchResponseItemOwner]
  }
}
