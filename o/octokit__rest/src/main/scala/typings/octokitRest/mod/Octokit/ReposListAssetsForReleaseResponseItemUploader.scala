...
trait ReposListAssetsForReleaseResponseItemUploader extends js.Object {
...
object ReposListAssetsForReleaseResponseItemUploader {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListAssetsForReleaseResponseItemUploader]
  }
}
