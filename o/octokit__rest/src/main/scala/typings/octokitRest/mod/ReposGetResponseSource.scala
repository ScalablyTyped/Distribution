...
trait ReposGetResponseSource extends js.Object {
  ...
  var owner: ReposGetResponseSourceOwner
  var permissions: ReposGetResponseSourcePermissions
  var `private`: Boolean
...
object ReposGetResponseSource {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ReposGetResponseSource]
  }
}
