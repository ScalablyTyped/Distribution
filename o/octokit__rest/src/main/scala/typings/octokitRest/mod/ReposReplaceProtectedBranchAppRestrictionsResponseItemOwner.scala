...
trait ReposReplaceProtectedBranchAppRestrictionsResponseItemOwner extends js.Object {
...
object ReposReplaceProtectedBranchAppRestrictionsResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposReplaceProtectedBranchAppRestrictionsResponseItemOwner]
  }
}
