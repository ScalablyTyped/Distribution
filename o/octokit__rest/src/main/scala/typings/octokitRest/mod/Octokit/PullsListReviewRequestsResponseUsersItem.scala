...
trait PullsListReviewRequestsResponseUsersItem extends js.Object {
...
object PullsListReviewRequestsResponseUsersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsListReviewRequestsResponseUsersItem]
  }
}
