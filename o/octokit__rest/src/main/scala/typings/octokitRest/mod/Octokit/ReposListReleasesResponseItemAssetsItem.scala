...
trait ReposListReleasesResponseItemAssetsItem extends js.Object {
  ...
  var uploader: ReposListReleasesResponseItemAssetsItemUploader
  var url: String
}

object ReposListReleasesResponseItemAssetsItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListReleasesResponseItemAssetsItem]
  }
}
