...
import typings.octokitRest.mod.Octokit.ReposDisableAutomatedSecurityFixesParams
...
@js.native
trait AnonEndpointParamsAnyResponsePromiseReposDisableAutomatedSecurityFixesParams extends js.Object {
  @JSName("endpoint")
