...
import typings.octokitRest.mod.GistsForkParams
import typings.octokitRest.mod.GistsForkResponse
...
@js.native
trait AnonEndpointParamsGistsForkParams extends js.Object {
  @JSName("endpoint")
