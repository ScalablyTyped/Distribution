...
import typings.octokitRest.mod.GistsListPublicForUserParams
import typings.octokitRest.mod.GistsListPublicForUserResponse
...
@js.native
trait AnonEndpointParamsGistsListPublicForUserParams extends js.Object {
  @JSName("endpoint")
