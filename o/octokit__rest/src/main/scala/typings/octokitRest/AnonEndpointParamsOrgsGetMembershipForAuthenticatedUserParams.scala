...
import typings.octokitRest.mod.OrgsGetMembershipForAuthenticatedUserParams
import typings.octokitRest.mod.OrgsGetMembershipForAuthenticatedUserResponse
...
@js.native
trait AnonEndpointParamsOrgsGetMembershipForAuthenticatedUserParams extends js.Object {
  @JSName("endpoint")
