...
import typings.octokitRest.mod.ReposCreateCommitCommentParams
import typings.octokitRest.mod.ReposCreateCommitCommentParamsDeprecatedLine
import typings.octokitRest.mod.ReposCreateCommitCommentParamsDeprecatedSha
import typings.octokitRest.mod.ReposCreateCommitCommentResponse
