...
import typings.octokitRest.mod.IssuesGetLabelParams
import typings.octokitRest.mod.IssuesGetLabelResponse
...
@js.native
trait AnonEndpointParamsIssuesGetLabelParams extends js.Object {
  @JSName("endpoint")
