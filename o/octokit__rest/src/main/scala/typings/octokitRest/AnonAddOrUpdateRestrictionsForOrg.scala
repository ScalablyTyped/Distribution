...
import typings.octokitRest.mod.Octokit.InteractionsAddOrUpdateRestrictionsForRepoParams
import typings.octokitRest.mod.Octokit.InteractionsAddOrUpdateRestrictionsForRepoResponse
...
import typings.octokitRest.mod.Octokit.InteractionsRemoveRestrictionsForOrgParams
