...
import typings.octokitRest.mod.IssuesUpdateLabelParams
import typings.octokitRest.mod.IssuesUpdateLabelResponse
...
@js.native
trait AnonEndpointParamsIssuesUpdateLabelParams extends js.Object {
  @JSName("endpoint")
