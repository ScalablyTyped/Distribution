...
import typings.octokitRest.mod.Octokit.ReposAcceptInvitationParams
...
@js.native
trait AnonEndpointParamsAnyResponsePromiseReposAcceptInvitationParams extends js.Object {
  @JSName("endpoint")
