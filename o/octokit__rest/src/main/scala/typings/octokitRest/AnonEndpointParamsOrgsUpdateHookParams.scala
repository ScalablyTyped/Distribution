...
import typings.octokitRest.mod.OrgsUpdateHookParams
import typings.octokitRest.mod.OrgsUpdateHookResponse
...
@js.native
trait AnonEndpointParamsOrgsUpdateHookParams extends js.Object {
  @JSName("endpoint")
