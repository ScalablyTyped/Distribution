...
import typings.octokitRest.mod.Octokit.ReposRemoveProtectedBranchAdminEnforcementParams
...
@js.native
trait AnonEndpointParamsAnyResponsePromiseReposRemoveProtectedBranchAdminEnforcementParams extends js.Object {
  @JSName("endpoint")
