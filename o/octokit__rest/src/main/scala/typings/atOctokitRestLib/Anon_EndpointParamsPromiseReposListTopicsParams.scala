...
@js.native
trait Anon_EndpointParamsPromiseReposListTopicsParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposListTopicsParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposListTopicsResponse]
  ] = js.native
