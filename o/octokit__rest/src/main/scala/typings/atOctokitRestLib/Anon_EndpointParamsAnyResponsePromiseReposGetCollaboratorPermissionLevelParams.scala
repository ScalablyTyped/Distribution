...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseReposGetCollaboratorPermissionLevelParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposGetCollaboratorPermissionLevelParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
