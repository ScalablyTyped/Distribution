...
trait ReposCreateUsingTemplateResponse extends js.Object {
  ...
  var owner: ReposCreateUsingTemplateResponseOwner
  var permissions: ReposCreateUsingTemplateResponsePermissions
  ...
  var template_repository: ReposCreateUsingTemplateResponseTemplateRepository
...
object ReposCreateUsingTemplateResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateUsingTemplateResponse]
  }
}
