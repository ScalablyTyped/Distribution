...
trait Endpoint extends js.Object {
  ...
  def apply(Route: java.lang.String): RequestOptions = js.native
  def apply(Route: java.lang.String, EndpointOptions: EndpointOptions): RequestOptions = js.native
  /**
  ...
  /**
    ...
    */
  def merge(Route: java.lang.String): RequestOptions = js.native
  def merge(Route: java.lang.String, EndpointOptions: EndpointOptions): RequestOptions = js.native
  /**
