...
trait ReposListReleasesResponseItemAuthor extends js.Object {
...
object ReposListReleasesResponseItemAuthor {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListReleasesResponseItemAuthor]
  }
}
