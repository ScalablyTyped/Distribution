...
object GistsCreateResponse {
  ...
  def apply(
    ...
    forks: js.Array[GistsCreateResponseForksItem],
    forks_url: java.lang.String,
    git_pull_url: java.lang.String,
    git_push_url: java.lang.String,
    history: js.Array[GistsCreateResponseHistoryItem],
    ...
    __obj.asInstanceOf[GistsCreateResponse]
  }
}
