...
trait ChecksGetSuiteResponseRepository extends js.Object {
  ...
  var owner: ChecksGetSuiteResponseRepositoryOwner
  var permissions: ChecksGetSuiteResponseRepositoryPermissions
...
object ChecksGetSuiteResponseRepository {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ChecksGetSuiteResponseRepository]
  }
}
