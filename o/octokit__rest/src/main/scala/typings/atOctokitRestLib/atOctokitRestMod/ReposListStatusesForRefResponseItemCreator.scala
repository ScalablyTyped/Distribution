...
trait ReposListStatusesForRefResponseItemCreator extends js.Object {
...
object ReposListStatusesForRefResponseItemCreator {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListStatusesForRefResponseItemCreator]
  }
}
