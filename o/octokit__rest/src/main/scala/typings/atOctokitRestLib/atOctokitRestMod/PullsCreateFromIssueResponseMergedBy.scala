...
trait PullsCreateFromIssueResponseMergedBy extends js.Object {
...
object PullsCreateFromIssueResponseMergedBy {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateFromIssueResponseMergedBy]
  }
}
