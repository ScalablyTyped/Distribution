...
trait ReposGetResponseParent extends js.Object {
  ...
  var owner: ReposGetResponseParentOwner
  var permissions: ReposGetResponseParentPermissions
...
object ReposGetResponseParent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ReposGetResponseParent]
  }
}
