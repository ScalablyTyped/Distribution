...
trait OauthAuthorizationsCheckAuthorizationResponse extends js.Object {
  var app: OauthAuthorizationsCheckAuthorizationResponseApp
  ...
  var user: OauthAuthorizationsCheckAuthorizationResponseUser
}

object OauthAuthorizationsCheckAuthorizationResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsCheckAuthorizationResponse]
  }
}
