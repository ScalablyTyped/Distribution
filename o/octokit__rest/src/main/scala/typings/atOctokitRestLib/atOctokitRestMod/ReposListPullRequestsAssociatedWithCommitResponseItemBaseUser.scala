...
trait ReposListPullRequestsAssociatedWithCommitResponseItemBaseUser extends js.Object {
...
object ReposListPullRequestsAssociatedWithCommitResponseItemBaseUser {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListPullRequestsAssociatedWithCommitResponseItemBaseUser]
  }
}
