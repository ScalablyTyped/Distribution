...
trait TeamsListReposResponseItem extends js.Object {
  ...
  var license: TeamsListReposResponseItemLicense
  ...
  var owner: TeamsListReposResponseItemOwner
  var permissions: TeamsListReposResponseItemPermissions
...
object TeamsListReposResponseItem {
  @scala.inline
  def apply(
