...
trait ReposGetReleaseByTagResponseAssetsItem extends js.Object {
  ...
  var uploader: ReposGetReleaseByTagResponseAssetsItemUploader
  var url: java.lang.String
}

object ReposGetReleaseByTagResponseAssetsItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetReleaseByTagResponseAssetsItem]
  }
}
