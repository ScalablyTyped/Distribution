...
trait ReactionsListForCommitCommentResponseItemUser extends js.Object {
...
object ReactionsListForCommitCommentResponseItemUser {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsListForCommitCommentResponseItemUser]
  }
}
