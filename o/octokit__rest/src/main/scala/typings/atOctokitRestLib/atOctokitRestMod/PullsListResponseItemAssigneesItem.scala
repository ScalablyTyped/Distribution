...
trait PullsListResponseItemAssigneesItem extends js.Object {
...
object PullsListResponseItemAssigneesItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsListResponseItemAssigneesItem]
  }
}
