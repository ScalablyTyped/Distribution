...
trait TeamsListDiscussionsResponseItemAuthor extends js.Object {
...
object TeamsListDiscussionsResponseItemAuthor {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsListDiscussionsResponseItemAuthor]
  }
}
