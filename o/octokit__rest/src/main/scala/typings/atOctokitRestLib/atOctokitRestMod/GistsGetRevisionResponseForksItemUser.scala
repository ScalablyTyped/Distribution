...
trait GistsGetRevisionResponseForksItemUser extends js.Object {
...
object GistsGetRevisionResponseForksItemUser {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[GistsGetRevisionResponseForksItemUser]
  }
}
