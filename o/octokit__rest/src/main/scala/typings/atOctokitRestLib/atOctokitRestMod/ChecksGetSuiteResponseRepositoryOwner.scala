...
trait ChecksGetSuiteResponseRepositoryOwner extends js.Object {
...
object ChecksGetSuiteResponseRepositoryOwner {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ChecksGetSuiteResponseRepositoryOwner]
  }
}
