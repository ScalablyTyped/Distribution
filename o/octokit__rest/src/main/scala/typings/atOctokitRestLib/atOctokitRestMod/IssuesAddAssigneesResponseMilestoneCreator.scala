...
trait IssuesAddAssigneesResponseMilestoneCreator extends js.Object {
...
object IssuesAddAssigneesResponseMilestoneCreator {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesAddAssigneesResponseMilestoneCreator]
  }
}
