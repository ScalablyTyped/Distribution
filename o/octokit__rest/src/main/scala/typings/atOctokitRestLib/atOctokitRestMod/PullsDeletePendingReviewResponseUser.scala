...
trait PullsDeletePendingReviewResponseUser extends js.Object {
...
object PullsDeletePendingReviewResponseUser {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsDeletePendingReviewResponseUser]
  }
}
