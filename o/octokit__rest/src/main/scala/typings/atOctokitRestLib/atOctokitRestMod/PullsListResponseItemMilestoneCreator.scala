...
trait PullsListResponseItemMilestoneCreator extends js.Object {
...
object PullsListResponseItemMilestoneCreator {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsListResponseItemMilestoneCreator]
  }
}
