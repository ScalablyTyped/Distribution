...
trait IssuesGetEventResponseIssueAssigneesItem extends js.Object {
...
object IssuesGetEventResponseIssueAssigneesItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesGetEventResponseIssueAssigneesItem]
  }
}
