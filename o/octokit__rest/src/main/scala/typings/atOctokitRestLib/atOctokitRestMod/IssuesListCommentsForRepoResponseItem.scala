...
trait IssuesListCommentsForRepoResponseItem extends js.Object {
  ...
  var user: IssuesListCommentsForRepoResponseItemUser
}

object IssuesListCommentsForRepoResponseItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListCommentsForRepoResponseItem]
  }
}
