...
trait PullsListCommitsResponseItemCommitter extends js.Object {
...
object PullsListCommitsResponseItemCommitter {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsListCommitsResponseItemCommitter]
  }
}
