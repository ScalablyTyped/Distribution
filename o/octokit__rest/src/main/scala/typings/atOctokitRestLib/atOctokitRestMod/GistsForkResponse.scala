...
trait GistsForkResponse extends js.Object {
  ...
  var owner: GistsForkResponseOwner
...
object GistsForkResponse {
  ...
  def apply(
    ...
    __obj.asInstanceOf[GistsForkResponse]
  }
}
