...
trait ReposCreateCommitCommentResponse extends js.Object {
  ...
  var user: ReposCreateCommitCommentResponseUser
}

object ReposCreateCommitCommentResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateCommitCommentResponse]
  }
}
