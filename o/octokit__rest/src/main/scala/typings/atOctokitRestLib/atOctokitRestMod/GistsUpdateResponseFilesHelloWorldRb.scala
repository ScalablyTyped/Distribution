...
trait GistsUpdateResponseFilesHelloWorldRb extends js.Object {
...
object GistsUpdateResponseFilesHelloWorldRb {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[GistsUpdateResponseFilesHelloWorldRb]
  }
}
