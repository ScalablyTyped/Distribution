...
trait MigrationsListForAuthenticatedUserResponseItemRepositoriesItem extends js.Object {
  ...
  var owner: MigrationsListForAuthenticatedUserResponseItemRepositoriesItemOwner
  var permissions: MigrationsListForAuthenticatedUserResponseItemRepositoriesItemPermissions
...
object MigrationsListForAuthenticatedUserResponseItemRepositoriesItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsListForAuthenticatedUserResponseItemRepositoriesItem]
  }
}
