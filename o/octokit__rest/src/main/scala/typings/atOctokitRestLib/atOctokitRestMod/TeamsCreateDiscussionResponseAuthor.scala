...
trait TeamsCreateDiscussionResponseAuthor extends js.Object {
...
object TeamsCreateDiscussionResponseAuthor {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionResponseAuthor]
  }
}
