...
object AppsCreateInstallationTokenResponse {
  @scala.inline
  def apply(expires_at: java.lang.String, token: java.lang.String): AppsCreateInstallationTokenResponse = {
    val __obj = js.Dynamic.literal(expires_at = expires_at, token = token)
