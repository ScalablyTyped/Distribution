...
trait ReposListInvitationsResponseItemInvitee extends js.Object {
...
object ReposListInvitationsResponseItemInvitee {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListInvitationsResponseItemInvitee]
  }
}
