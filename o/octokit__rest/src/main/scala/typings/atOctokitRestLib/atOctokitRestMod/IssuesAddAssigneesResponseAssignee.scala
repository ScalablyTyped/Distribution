...
trait IssuesAddAssigneesResponseAssignee extends js.Object {
...
object IssuesAddAssigneesResponseAssignee {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesAddAssigneesResponseAssignee]
  }
}
