...
trait PullsCreateReviewRequestResponseUser extends js.Object {
...
object PullsCreateReviewRequestResponseUser {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseUser]
  }
}
