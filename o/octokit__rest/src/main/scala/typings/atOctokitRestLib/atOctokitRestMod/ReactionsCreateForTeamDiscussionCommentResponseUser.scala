...
trait ReactionsCreateForTeamDiscussionCommentResponseUser extends js.Object {
...
object ReactionsCreateForTeamDiscussionCommentResponseUser {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsCreateForTeamDiscussionCommentResponseUser]
  }
}
