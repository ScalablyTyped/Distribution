...
trait ReposGetReleaseResponseAssetsItemUploader extends js.Object {
...
object ReposGetReleaseResponseAssetsItemUploader {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetReleaseResponseAssetsItemUploader]
  }
}
