...
trait SearchReposParams extends js.Object {
  ...
  /**
    ...
    */
  var sort: js.UndefOr[
    atOctokitRestLib.atOctokitRestLibStrings.stars | atOctokitRestLib.atOctokitRestLibStrings.forks | atOctokitRestLib.atOctokitRestLibStrings.`help-wanted-issues` | atOctokitRestLib.atOctokitRestLibStrings.updated
  ] = js.undefined
}
...
object SearchReposParams {
  ...
  def apply(
    ...
    sort: atOctokitRestLib.atOctokitRestLibStrings.stars | atOctokitRestLib.atOctokitRestLibStrings.forks | atOctokitRestLib.atOctokitRestLibStrings.`help-wanted-issues` | atOctokitRestLib.atOctokitRestLibStrings.updated = null
  ): SearchReposParams = {
