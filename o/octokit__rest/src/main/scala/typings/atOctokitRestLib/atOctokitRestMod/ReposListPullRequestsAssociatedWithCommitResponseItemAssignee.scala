...
trait ReposListPullRequestsAssociatedWithCommitResponseItemAssignee extends js.Object {
...
object ReposListPullRequestsAssociatedWithCommitResponseItemAssignee {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListPullRequestsAssociatedWithCommitResponseItemAssignee]
  }
}
