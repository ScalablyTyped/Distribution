...
trait IssuesListForAuthenticatedUserResponseItemMilestoneCreator extends js.Object {
...
object IssuesListForAuthenticatedUserResponseItemMilestoneCreator {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListForAuthenticatedUserResponseItemMilestoneCreator]
  }
}
