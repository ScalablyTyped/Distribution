...
trait OauthAuthorizationsListAuthorizationsResponseItem extends js.Object {
  var app: OauthAuthorizationsListAuthorizationsResponseItemApp
...
object OauthAuthorizationsListAuthorizationsResponseItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsListAuthorizationsResponseItem]
  }
}
