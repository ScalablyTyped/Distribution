...
trait TeamsUpdateDiscussionResponseAuthor extends js.Object {
...
object TeamsUpdateDiscussionResponseAuthor {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionResponseAuthor]
  }
}
