...
trait AppsCreateFromManifestResponseOwner extends js.Object {
...
object AppsCreateFromManifestResponseOwner {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsCreateFromManifestResponseOwner]
  }
}
