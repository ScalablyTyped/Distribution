...
trait IssuesListEventsForTimelineResponseItemActor extends js.Object {
...
object IssuesListEventsForTimelineResponseItemActor {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListEventsForTimelineResponseItemActor]
  }
}
