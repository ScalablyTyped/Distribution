...
trait SearchUsersParams extends js.Object {
  ...
  /**
    ...
    */
  var sort: js.UndefOr[
    atOctokitRestLib.atOctokitRestLibStrings.followers | atOctokitRestLib.atOctokitRestLibStrings.repositories | atOctokitRestLib.atOctokitRestLibStrings.joined
  ] = js.undefined
}
...
object SearchUsersParams {
  ...
  def apply(
    ...
    sort: atOctokitRestLib.atOctokitRestLibStrings.followers | atOctokitRestLib.atOctokitRestLibStrings.repositories | atOctokitRestLib.atOctokitRestLibStrings.joined = null
  ): SearchUsersParams = {
