...
trait OauthAuthorizationsResetAuthorizationResponseUser extends js.Object {
...
object OauthAuthorizationsResetAuthorizationResponseUser {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsResetAuthorizationResponseUser]
  }
}
