...
trait ReposListDeploymentStatusesResponseItemCreator extends js.Object {
...
object ReposListDeploymentStatusesResponseItemCreator {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListDeploymentStatusesResponseItemCreator]
  }
}
