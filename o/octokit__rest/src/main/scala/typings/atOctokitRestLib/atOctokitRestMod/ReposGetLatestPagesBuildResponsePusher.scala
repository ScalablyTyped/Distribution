...
trait ReposGetLatestPagesBuildResponsePusher extends js.Object {
...
object ReposGetLatestPagesBuildResponsePusher {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetLatestPagesBuildResponsePusher]
  }
}
