...
@js.native
trait Anon_EndpointParamsPromiseReposGetDeployKeyParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposGetDeployKeyParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposGetDeployKeyResponse]
  ] = js.native
