...
@js.native
trait Anon_EndpointParamsPromiseReposGetBranchProtectionParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposGetBranchProtectionParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposGetBranchProtectionResponse]
  ] = js.native
