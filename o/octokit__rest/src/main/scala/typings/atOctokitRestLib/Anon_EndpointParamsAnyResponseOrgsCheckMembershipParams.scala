...
@js.native
trait Anon_EndpointParamsAnyResponseOrgsCheckMembershipParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.OrgsCheckMembershipParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
