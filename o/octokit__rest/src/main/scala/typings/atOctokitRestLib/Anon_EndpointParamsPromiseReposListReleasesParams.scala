...
@js.native
trait Anon_EndpointParamsPromiseReposListReleasesParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposListReleasesParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposListReleasesResponse]
  ] = js.native
