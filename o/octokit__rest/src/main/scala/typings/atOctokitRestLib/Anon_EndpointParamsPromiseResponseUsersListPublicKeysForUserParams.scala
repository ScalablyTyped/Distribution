...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersListPublicKeysForUserParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.UsersListPublicKeysForUserParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.UsersListPublicKeysForUserResponse]
  ] = js.native
