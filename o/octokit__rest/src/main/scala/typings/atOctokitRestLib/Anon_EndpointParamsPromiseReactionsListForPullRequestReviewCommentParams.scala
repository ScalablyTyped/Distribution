...
@js.native
trait Anon_EndpointParamsPromiseReactionsListForPullRequestReviewCommentParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReactionsListForPullRequestReviewCommentParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[
      atOctokitRestLib.atOctokitRestMod.ReactionsListForPullRequestReviewCommentResponse
    ]
  ] = js.native
