...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseTeamsGetMembershipParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.TeamsGetMembershipParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
