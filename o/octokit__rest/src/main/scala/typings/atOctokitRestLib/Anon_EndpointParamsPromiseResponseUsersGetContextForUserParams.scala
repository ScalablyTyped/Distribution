...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersGetContextForUserParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.UsersGetContextForUserParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.UsersGetContextForUserResponse]
  ] = js.native
