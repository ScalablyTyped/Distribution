...
trait Anon_EndpointParamsAnyResponsePromiseReposRemoveProtectedBranchRequiredSignaturesParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposRemoveProtectedBranchRequiredSignaturesParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
