...
@js.native
trait Anon_EndpointParamsGistsListPublicForUserParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.GistsListPublicForUserParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.GistsListPublicForUserResponse]
  ] = js.native
