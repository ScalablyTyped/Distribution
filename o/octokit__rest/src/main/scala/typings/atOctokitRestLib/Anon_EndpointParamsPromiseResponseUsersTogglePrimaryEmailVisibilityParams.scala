...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersTogglePrimaryEmailVisibilityParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.UsersTogglePrimaryEmailVisibilityParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.UsersTogglePrimaryEmailVisibilityResponse]
  ] = js.native
