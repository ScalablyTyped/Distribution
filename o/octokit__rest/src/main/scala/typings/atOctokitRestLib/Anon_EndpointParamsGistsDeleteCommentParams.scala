...
@js.native
trait Anon_EndpointParamsGistsDeleteCommentParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.GistsDeleteCommentParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.GistsDeleteCommentResponse]
  ] = js.native
