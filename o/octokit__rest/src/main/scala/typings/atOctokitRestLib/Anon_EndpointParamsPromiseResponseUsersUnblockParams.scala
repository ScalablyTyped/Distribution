...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersUnblockParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.UsersUnblockParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.UsersUnblockResponse]
  ] = js.native
