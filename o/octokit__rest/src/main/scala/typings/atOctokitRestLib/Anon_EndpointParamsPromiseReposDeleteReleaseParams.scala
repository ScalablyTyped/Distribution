...
@js.native
trait Anon_EndpointParamsPromiseReposDeleteReleaseParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposDeleteReleaseParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposDeleteReleaseResponse]
  ] = js.native
