...
@js.native
trait Anon_EndpointParamsAppsCreateInstallationTokenParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.AppsCreateInstallationTokenParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.AppsCreateInstallationTokenResponse]
  ] = js.native
