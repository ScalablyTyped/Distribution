...
@js.native
trait Anon_EndpointParamsPromiseResponseTeamsUpdateDiscussionCommentParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.TeamsUpdateDiscussionCommentParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.TeamsUpdateDiscussionCommentResponse]
  ] = js.native
