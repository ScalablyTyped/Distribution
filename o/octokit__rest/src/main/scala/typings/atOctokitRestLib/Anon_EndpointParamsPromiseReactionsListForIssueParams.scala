...
trait Anon_EndpointParamsPromiseReactionsListForIssueParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReactionsListForIssueParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReactionsListForIssueResponse]
  ] = js.native
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReactionsListForIssueParamsDeprecatedNumber): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReactionsListForIssueResponse]
  ] = js.native
