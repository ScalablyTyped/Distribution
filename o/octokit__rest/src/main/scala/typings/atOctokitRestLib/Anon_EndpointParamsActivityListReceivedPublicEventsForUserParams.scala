...
@js.native
trait Anon_EndpointParamsActivityListReceivedPublicEventsForUserParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ActivityListReceivedPublicEventsForUserParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
