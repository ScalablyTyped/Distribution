...
@js.native
trait Anon_EndpointParamsMigrationsGetArchiveForOrgParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.MigrationsGetArchiveForOrgParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.MigrationsGetArchiveForOrgResponse]
  ] = js.native
