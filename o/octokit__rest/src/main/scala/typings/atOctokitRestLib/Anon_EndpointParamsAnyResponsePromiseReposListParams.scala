...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseReposListParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposListParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
