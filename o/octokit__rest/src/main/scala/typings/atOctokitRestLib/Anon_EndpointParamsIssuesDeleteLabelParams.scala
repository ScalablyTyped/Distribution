...
@js.native
trait Anon_EndpointParamsIssuesDeleteLabelParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.IssuesDeleteLabelParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.IssuesDeleteLabelResponse]
  ] = js.native
