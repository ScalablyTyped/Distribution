...
@js.native
trait Anon_EndpointParamsActivityListWatchersForRepoParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ActivityListWatchersForRepoParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ActivityListWatchersForRepoResponse]
  ] = js.native
