...
@js.native
trait Anon_EndpointParamsPromiseReposGetBranchParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposGetBranchParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposGetBranchResponse]
  ] = js.native
