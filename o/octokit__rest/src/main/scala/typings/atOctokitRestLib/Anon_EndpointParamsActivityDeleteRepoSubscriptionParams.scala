...
@js.native
trait Anon_EndpointParamsActivityDeleteRepoSubscriptionParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ActivityDeleteRepoSubscriptionParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ActivityDeleteRepoSubscriptionResponse]
  ] = js.native
