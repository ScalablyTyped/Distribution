...
@js.native
trait Anon_EndpointParamsPromiseReposDeleteDownloadParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposDeleteDownloadParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposDeleteDownloadResponse]
  ] = js.native
