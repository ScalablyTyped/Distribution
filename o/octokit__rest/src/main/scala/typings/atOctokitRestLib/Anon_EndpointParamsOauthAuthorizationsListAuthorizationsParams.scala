...
@js.native
trait Anon_EndpointParamsOauthAuthorizationsListAuthorizationsParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.OauthAuthorizationsListAuthorizationsParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.OauthAuthorizationsListAuthorizationsResponse]
  ] = js.native
