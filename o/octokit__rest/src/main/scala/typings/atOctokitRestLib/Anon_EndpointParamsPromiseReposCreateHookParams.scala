...
@js.native
trait Anon_EndpointParamsPromiseReposCreateHookParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposCreateHookParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposCreateHookResponse]
  ] = js.native
