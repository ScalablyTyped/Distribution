...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseReposAddCollaboratorParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposAddCollaboratorParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
