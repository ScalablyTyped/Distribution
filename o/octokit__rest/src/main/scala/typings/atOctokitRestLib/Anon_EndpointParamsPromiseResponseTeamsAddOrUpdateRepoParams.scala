...
@js.native
trait Anon_EndpointParamsPromiseResponseTeamsAddOrUpdateRepoParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.TeamsAddOrUpdateRepoParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.TeamsAddOrUpdateRepoResponse]
  ] = js.native
