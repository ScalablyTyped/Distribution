...
@js.native
trait Anon_EndpointParamsOrgsListMembershipsParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.OrgsListMembershipsParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.OrgsListMembershipsResponse]
  ] = js.native
