...
@js.native
trait Anon_EndpointParamsActivityListPublicEventsForOrgParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ActivityListPublicEventsForOrgParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
