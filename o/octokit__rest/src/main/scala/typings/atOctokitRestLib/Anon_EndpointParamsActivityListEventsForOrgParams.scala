...
@js.native
trait Anon_EndpointParamsActivityListEventsForOrgParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ActivityListEventsForOrgParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
