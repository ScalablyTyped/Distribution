...
@js.native
trait Anon_EndpointParamsPromiseResponseTeamsListDiscussionCommentsParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.TeamsListDiscussionCommentsParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.TeamsListDiscussionCommentsResponse]
  ] = js.native
