...
@js.native
trait Anon_EndpointParamsPromiseReposListCommitsParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposListCommitsParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposListCommitsResponse]
  ] = js.native
