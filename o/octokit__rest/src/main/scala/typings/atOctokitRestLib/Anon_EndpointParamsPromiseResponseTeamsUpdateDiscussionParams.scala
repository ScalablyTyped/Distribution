...
@js.native
trait Anon_EndpointParamsPromiseResponseTeamsUpdateDiscussionParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.TeamsUpdateDiscussionParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.TeamsUpdateDiscussionResponse]
  ] = js.native
