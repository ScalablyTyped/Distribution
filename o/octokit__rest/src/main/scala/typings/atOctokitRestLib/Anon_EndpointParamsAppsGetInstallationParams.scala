...
@js.native
trait Anon_EndpointParamsAppsGetInstallationParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.AppsGetInstallationParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.AppsGetInstallationResponse]
  ] = js.native
