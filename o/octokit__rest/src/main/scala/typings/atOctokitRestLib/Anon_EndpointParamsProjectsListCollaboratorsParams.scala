...
@js.native
trait Anon_EndpointParamsProjectsListCollaboratorsParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ProjectsListCollaboratorsParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ProjectsListCollaboratorsResponse]
  ] = js.native
