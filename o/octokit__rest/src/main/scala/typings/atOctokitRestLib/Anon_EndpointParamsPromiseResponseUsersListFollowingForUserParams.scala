...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersListFollowingForUserParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.UsersListFollowingForUserParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.UsersListFollowingForUserResponse]
  ] = js.native
