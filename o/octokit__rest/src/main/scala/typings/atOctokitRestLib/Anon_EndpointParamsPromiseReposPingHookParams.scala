...
@js.native
trait Anon_EndpointParamsPromiseReposPingHookParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposPingHookParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposPingHookResponse]
  ] = js.native
