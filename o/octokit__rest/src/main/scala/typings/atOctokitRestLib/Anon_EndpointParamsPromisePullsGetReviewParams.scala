...
trait Anon_EndpointParamsPromisePullsGetReviewParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.PullsGetReviewParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.PullsGetReviewResponse]
  ] = js.native
  def apply(params: atOctokitRestLib.atOctokitRestMod.PullsGetReviewParamsDeprecatedNumber): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.PullsGetReviewResponse]
  ] = js.native
