...
@js.native
trait Anon_EndpointParamsAnyResponseOauthAuthorizationsGetOrCreateAuthorizationForAppParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.OauthAuthorizationsGetOrCreateAuthorizationForAppParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
