...
trait Anon_EndpointParamsPromisePullsListFilesParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.PullsListFilesParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.PullsListFilesResponse]
  ] = js.native
  def apply(params: atOctokitRestLib.atOctokitRestMod.PullsListFilesParamsDeprecatedNumber): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.PullsListFilesResponse]
  ] = js.native
