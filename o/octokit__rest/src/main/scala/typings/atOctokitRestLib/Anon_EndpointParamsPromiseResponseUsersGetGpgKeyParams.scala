...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersGetGpgKeyParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.UsersGetGpgKeyParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.UsersGetGpgKeyResponse]
  ] = js.native
