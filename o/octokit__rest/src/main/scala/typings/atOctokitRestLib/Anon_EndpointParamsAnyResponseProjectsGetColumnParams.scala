...
@js.native
trait Anon_EndpointParamsAnyResponseProjectsGetColumnParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ProjectsGetColumnParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
