...
trait Anon_EndpointParamsAnyResponsePromiseReposRemoveProtectedBranchAdminEnforcementParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposRemoveProtectedBranchAdminEnforcementParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
