...
trait Anon_EndpointParamsActivityGetRepoSubscriptionParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ActivityGetRepoSubscriptionParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
