...
@js.native
trait Anon_EndpointParamsAnyResponseProjectsCreateColumnParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ProjectsCreateColumnParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
