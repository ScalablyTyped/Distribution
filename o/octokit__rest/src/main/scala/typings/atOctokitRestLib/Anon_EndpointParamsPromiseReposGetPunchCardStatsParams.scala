...
@js.native
trait Anon_EndpointParamsPromiseReposGetPunchCardStatsParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposGetPunchCardStatsParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposGetPunchCardStatsResponse]
  ] = js.native
