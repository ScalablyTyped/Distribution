...
trait Anon_EndpointParamsIssuesDeleteMilestoneParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.IssuesDeleteMilestoneParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.IssuesDeleteMilestoneResponse]
  ] = js.native
  def apply(params: atOctokitRestLib.atOctokitRestMod.IssuesDeleteMilestoneParamsDeprecatedNumber): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.IssuesDeleteMilestoneResponse]
  ] = js.native
