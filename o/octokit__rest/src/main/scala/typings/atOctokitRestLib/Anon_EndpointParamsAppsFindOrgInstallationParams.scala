...
@js.native
trait Anon_EndpointParamsAppsFindOrgInstallationParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.AppsFindOrgInstallationParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.AppsFindOrgInstallationResponse]
  ] = js.native
