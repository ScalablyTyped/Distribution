...
@js.native
trait Anon_EndpointParamsIssuesUpdateLabelParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.IssuesUpdateLabelParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.IssuesUpdateLabelResponse]
  ] = js.native
