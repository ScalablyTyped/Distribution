...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersCheckBlockedParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.UsersCheckBlockedParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.UsersCheckBlockedResponse]
  ] = js.native
