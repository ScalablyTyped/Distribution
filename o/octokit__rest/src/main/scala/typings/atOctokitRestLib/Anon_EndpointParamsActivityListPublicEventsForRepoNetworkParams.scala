...
trait Anon_EndpointParamsActivityListPublicEventsForRepoNetworkParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ActivityListPublicEventsForRepoNetworkParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
