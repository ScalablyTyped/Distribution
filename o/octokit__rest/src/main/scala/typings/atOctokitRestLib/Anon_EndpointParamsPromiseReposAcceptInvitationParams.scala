...
@js.native
trait Anon_EndpointParamsPromiseReposAcceptInvitationParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposAcceptInvitationParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposAcceptInvitationResponse]
  ] = js.native
