...
@js.native
trait Anon_EndpointParamsPromisePullsListCommentsForRepoParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.PullsListCommentsForRepoParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.PullsListCommentsForRepoResponse]
  ] = js.native
