...
trait Anon_EndpointParamsPromisePullsUpdateParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.PullsUpdateParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.PullsUpdateResponse]
  ] = js.native
  def apply(params: atOctokitRestLib.atOctokitRestMod.PullsUpdateParamsDeprecatedNumber): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.PullsUpdateResponse]
  ] = js.native
