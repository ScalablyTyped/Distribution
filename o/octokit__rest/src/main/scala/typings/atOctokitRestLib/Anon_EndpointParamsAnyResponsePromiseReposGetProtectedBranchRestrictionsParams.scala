...
trait Anon_EndpointParamsAnyResponsePromiseReposGetProtectedBranchRestrictionsParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposGetProtectedBranchRestrictionsParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
