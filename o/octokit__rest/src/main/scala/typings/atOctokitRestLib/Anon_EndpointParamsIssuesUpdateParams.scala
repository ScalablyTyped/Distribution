...
trait Anon_EndpointParamsIssuesUpdateParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.IssuesUpdateParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.IssuesUpdateResponse]
  ] = js.native
  def apply(params: atOctokitRestLib.atOctokitRestMod.IssuesUpdateParamsDeprecatedNumber): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.IssuesUpdateResponse]
  ] = js.native
