...
@js.native
trait Anon_EndpointParamsPromiseReactionsDeleteParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReactionsDeleteParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReactionsDeleteResponse]
  ] = js.native
