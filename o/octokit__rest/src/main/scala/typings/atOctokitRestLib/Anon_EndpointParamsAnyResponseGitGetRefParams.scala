...
@js.native
trait Anon_EndpointParamsAnyResponseGitGetRefParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.GitGetRefParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
