...
@js.native
trait Anon_EndpointParamsPromiseResponseUsersGetByUsernameParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.UsersGetByUsernameParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.UsersGetByUsernameResponse]
  ] = js.native
