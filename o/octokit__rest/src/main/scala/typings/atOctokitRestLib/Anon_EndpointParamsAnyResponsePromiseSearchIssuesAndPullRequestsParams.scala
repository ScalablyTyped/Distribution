...
trait Anon_EndpointParamsAnyResponsePromiseSearchIssuesAndPullRequestsParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.SearchIssuesAndPullRequestsParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
