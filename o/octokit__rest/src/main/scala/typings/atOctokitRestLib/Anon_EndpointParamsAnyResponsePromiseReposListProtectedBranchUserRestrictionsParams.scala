...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseReposListProtectedBranchUserRestrictionsParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposListProtectedBranchUserRestrictionsParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
