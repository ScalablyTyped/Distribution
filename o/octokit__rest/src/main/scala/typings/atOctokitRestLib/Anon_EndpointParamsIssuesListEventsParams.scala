...
trait Anon_EndpointParamsIssuesListEventsParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.IssuesListEventsParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.IssuesListEventsResponse]
  ] = js.native
  def apply(params: atOctokitRestLib.atOctokitRestMod.IssuesListEventsParamsDeprecatedNumber): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.IssuesListEventsResponse]
  ] = js.native
