...
@js.native
trait Anon_EndpointParamsPromiseReposListProtectedBranchTeamRestrictionsParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposListProtectedBranchTeamRestrictionsParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[
      atOctokitRestLib.atOctokitRestMod.ReposListProtectedBranchTeamRestrictionsResponse
    ]
  ] = js.native
