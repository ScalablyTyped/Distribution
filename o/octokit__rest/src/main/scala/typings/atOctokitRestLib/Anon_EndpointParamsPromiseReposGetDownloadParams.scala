...
@js.native
trait Anon_EndpointParamsPromiseReposGetDownloadParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposGetDownloadParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposGetDownloadResponse]
  ] = js.native
