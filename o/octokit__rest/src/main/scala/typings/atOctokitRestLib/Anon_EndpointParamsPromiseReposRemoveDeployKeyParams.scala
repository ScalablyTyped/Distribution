...
@js.native
trait Anon_EndpointParamsPromiseReposRemoveDeployKeyParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposRemoveDeployKeyParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.ReposRemoveDeployKeyResponse]
  ] = js.native
