...
trait Anon_EndpointParamsAnyResponsePromiseTeamsAddOrUpdateMembershipParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.TeamsAddOrUpdateMembershipParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
