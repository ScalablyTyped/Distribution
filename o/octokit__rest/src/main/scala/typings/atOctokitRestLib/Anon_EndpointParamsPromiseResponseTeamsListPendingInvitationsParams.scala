...
@js.native
trait Anon_EndpointParamsPromiseResponseTeamsListPendingInvitationsParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.TeamsListPendingInvitationsParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.TeamsListPendingInvitationsResponse]
  ] = js.native
