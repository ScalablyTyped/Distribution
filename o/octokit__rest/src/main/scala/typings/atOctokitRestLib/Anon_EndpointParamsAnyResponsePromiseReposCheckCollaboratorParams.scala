...
@js.native
trait Anon_EndpointParamsAnyResponsePromiseReposCheckCollaboratorParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposCheckCollaboratorParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
