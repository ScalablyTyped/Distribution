...
trait Anon_EndpointParamsAnyResponsePromiseReposRemoveProtectedBranchRequiredStatusChecksParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ReposRemoveProtectedBranchRequiredStatusChecksParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
