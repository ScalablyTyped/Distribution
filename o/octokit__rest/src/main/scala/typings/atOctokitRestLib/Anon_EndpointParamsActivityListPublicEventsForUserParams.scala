...
@js.native
trait Anon_EndpointParamsActivityListPublicEventsForUserParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.ActivityListPublicEventsForUserParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
