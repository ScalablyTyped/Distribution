...
trait Anon_EndpointParamsIssuesAddLabelsParams extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.IssuesAddLabelsParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.IssuesAddLabelsResponse]
  ] = js.native
  def apply(params: atOctokitRestLib.atOctokitRestMod.IssuesAddLabelsParamsDeprecatedNumber): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.IssuesAddLabelsResponse]
  ] = js.native
