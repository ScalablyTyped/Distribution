...
trait Anon_EndpointParamsAnyResponsePromise extends js.Object {
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.PullsCheckIfMergedParams): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
  def apply(params: atOctokitRestLib.atOctokitRestMod.PullsCheckIfMergedParamsDeprecatedNumber): js.Promise[atOctokitRestLib.atOctokitRestMod.AnyResponse] = js.native
