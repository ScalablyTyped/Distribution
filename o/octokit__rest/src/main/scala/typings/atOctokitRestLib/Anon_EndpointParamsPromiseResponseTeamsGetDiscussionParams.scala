...
@js.native
trait Anon_EndpointParamsPromiseResponseTeamsGetDiscussionParams extends js.Object {
  @JSName("endpoint")
  ...
  def apply(params: atOctokitRestLib.atOctokitRestMod.TeamsGetDiscussionParams): js.Promise[
    atOctokitRestLib.atOctokitRestMod.Response[atOctokitRestLib.atOctokitRestMod.TeamsGetDiscussionResponse]
  ] = js.native
