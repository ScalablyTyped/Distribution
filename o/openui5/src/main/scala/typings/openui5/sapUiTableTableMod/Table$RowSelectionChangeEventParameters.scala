...
trait Table$RowSelectionChangeEventParameters extends StObject {
  
  /**
    * binding context of the row which has been clicked so that selection has been changed
    */
  var rowContext: js.UndefOr[typings.openui5.sapUiModelContextMod.default] = js.undefined
...
object Table$RowSelectionChangeEventParameters {
  
  inline def apply(): Table$RowSelectionChangeEventParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Table$RowSelectionChangeEventParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Table$RowSelectionChangeEventParameters] (val x: Self) extends AnyVal {
    
    inline def setRowContext(value: typings.openui5.sapUiModelContextMod.default): Self = StObject.set(x, "rowContext", value.asInstanceOf[js.Any])
