...
trait Table$CellClickEventParameters extends StObject {
...
object Table$CellClickEventParameters {
  
  inline def apply(): Table$CellClickEventParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Table$CellClickEventParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Table$CellClickEventParameters] (val x: Self) extends AnyVal {
