...
object sapUiLayoutFormResponsiveLayoutMod {
  
  @JSImport("sap/ui/layout/form/ResponsiveLayout", JSImport.Default)
  @js.native
  /**
  ...
  type ResponsiveLayout = typings.openui5.sapUiLayoutFormFormLayoutMod.default
  
  type ResponsiveLayoutSettings = FormLayoutSettings
}
