...
object sapUiUx3ThingActionMod {
  
  @JSImport("sap/ui/ux3/ThingAction", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends ThingAction {
    def this(/**
      * initial settings for the new control
      */
    mSettings: ThingActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ThingAction]
  ...
  object ThingActionSettings {
    
    inline def apply(): ThingActionSettings = {
