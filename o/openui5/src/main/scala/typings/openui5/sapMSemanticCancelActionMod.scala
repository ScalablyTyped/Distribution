...
object sapMSemanticCancelActionMod {
  
  @JSImport("sap/m/semantic/CancelAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: CancelActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, CancelAction]
  ...
  type CancelAction = typings.openui5.sapMSemanticSemanticButtonMod.default
  
  type CancelActionSettings = SemanticButtonSettings
}
