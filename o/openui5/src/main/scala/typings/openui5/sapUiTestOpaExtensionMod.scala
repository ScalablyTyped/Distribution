...
object sapUiTestOpaExtensionMod {
  
  @JSImport("sap/ui/test/OpaExtension", JSImport.Default)
  @js.native
  /**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, OpaExtension]
  ...
  type OpaExtension = typings.openui5.sapUiBaseObjectMod.default
}
