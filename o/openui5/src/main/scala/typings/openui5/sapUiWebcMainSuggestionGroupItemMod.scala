...
object sapUiWebcMainSuggestionGroupItemMod {
  
  @JSImport("sap/ui/webc/main/SuggestionGroupItem", JSImport.Default)
  @js.native
  /**
  ...
  open class default () extends SuggestionGroupItem {
    def this(/**
      ...
      */
    mSettings: SuggestionGroupItemSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, SuggestionGroupItem]
  ...
  trait SuggestionGroupItemSettings
    extends StObject
  ...
  object SuggestionGroupItemSettings {
    
    inline def apply(): SuggestionGroupItemSettings = {
