...
object sapMSemanticEditActionMod {
  
  @JSImport("sap/m/semantic/EditAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: EditActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, EditAction]
  ...
  type EditAction = typings.openui5.sapMSemanticSemanticButtonMod.default
  
  type EditActionSettings = SemanticButtonSettings
}
