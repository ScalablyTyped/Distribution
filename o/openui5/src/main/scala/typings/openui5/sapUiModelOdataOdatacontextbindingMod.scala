...
object sapUiModelOdataOdatacontextbindingMod {
  
  @JSImport("sap/ui/model/odata/ODataContextBinding", JSImport.Default)
  @js.native
  ...
  type ODataContextBinding = typings.openui5.sapUiModelContextBindingMod.default
}
