...
object sapMSemanticGroupActionMod {
  
  @JSImport("sap/m/semantic/GroupAction", JSImport.Default)
  @js.native
  /**
    ...
    * can be used.
    */
  open class default () extends GroupAction {
    def this(/**
      ...
      */
    mSettings: GroupActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, GroupAction]
  ...
  type GroupActionSettings = SemanticButtonSettings
}
