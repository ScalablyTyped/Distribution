...
object sapMInputListItemMod {
  
  @JSImport("sap/m/InputListItem", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends InputListItem {
    def this(/**
      * initial settings for the new control
      */
    mSettings: InputListItemSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, InputListItem]
  ...
  trait InputListItem
    ...
    /**
      ...
      *
      * @returns Value of property `labelTextDirection`
      */
    def getLabelTextDirection(): TextDirection | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof TextDirection * / any */ String) = js.native
    ...
    /**
      ...
      * @returns Reference to `this` in order to allow method chaining
      */
    def setLabelTextDirection(): this.type = js.native
    def setLabelTextDirection(
      /**
      * New value for property `labelTextDirection`
      */
    sLabelTextDirection: /* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof TextDirection * / any */ String
    ): this.type = js.native
    def setLabelTextDirection(/**
      * New value for property `labelTextDirection`
      */
    sLabelTextDirection: TextDirection): this.type = js.native
  ...
  trait InputListItemSettings
    ...
    /**
      ...
      * inherits text direction from the DOM.
      */
    var labelTextDirection: js.UndefOr[
  ...
  object InputListItemSettings {
    
    inline def apply(): InputListItemSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InputListItemSettings]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: InputListItemSettings] (val x: Self) extends AnyVal {
      ...
      inline def setLabelTextDirection(
      ...
      ): Self = StObject.set(x, "labelTextDirection", value.asInstanceOf[js.Any])
      
      inline def setLabelTextDirectionUndefined: Self = StObject.set(x, "labelTextDirection", js.undefined)
