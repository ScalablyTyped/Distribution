...
object sapUiUnifiedShellHeadUserItemMod {
  
  @JSImport("sap/ui/unified/ShellHeadUserItem", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends ShellHeadUserItem {
    def this(/**
      * initial settings for the new control
      */
    mSettings: ShellHeadUserItemSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ShellHeadUserItem]
  ...
  trait ShellHeadUserItem
    ...
    /**
      ...
      * @returns Reference to `this` in order to allow method chaining
      */
    def setImage(): this.type = js.native
    def setImage(/**
    ...
    /**
      ...
      * @returns Reference to `this` in order to allow method chaining
      */
    def setShowPopupIndicator(): this.type = js.native
    def setShowPopupIndicator(/**
      * New value for property `showPopupIndicator`
      */
    bShowPopupIndicator: Boolean): this.type = js.native
  ...
  trait ShellHeadUserItemSettings
    ...
    /**
      * An image of the user, normally a URI to an image but also an icon from the sap.ui.core.IconPool is possible.
      */
    var image: js.UndefOr[URI | PropertyBindingInfo | (/* template literal string: {${string}} */ String)] = js.undefined
    ...
    /**
      ...
      * Dialog. If this property is set to true an indicator for such a popup mechanismn is shown in the item.
      */
    var showPopupIndicator: js.UndefOr[
  ...
  object ShellHeadUserItemSettings {
    
    inline def apply(): ShellHeadUserItemSettings = {
    ...
    implicit open class MutableBuilder[Self <: ShellHeadUserItemSettings] (val x: Self) extends AnyVal {
      ...
      inline def setImage(value: URI | PropertyBindingInfo | (/* template literal string: {${string}} */ String)): Self = StObject.set(x, "image", value.asInstanceOf[js.Any])
      ...
      inline def setShowPopupIndicator(value: Boolean | PropertyBindingInfo | (/* template literal string: {${string}} */ String)): Self = StObject.set(x, "showPopupIndicator", value.asInstanceOf[js.Any])
      
      inline def setShowPopupIndicatorUndefined: Self = StObject.set(x, "showPopupIndicator", js.undefined)
