...
object sapUiCommonsMenuTextFieldItemMod {
  
  @JSImport("sap/ui/commons/MenuTextFieldItem", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiUnifiedMenuTextFieldItemMod.default {
    def this(/**
  ...
  type MenuTextFieldItem = typings.openui5.sapUiUnifiedMenuTextFieldItemMod.default
  
  type MenuTextFieldItemSettings = typings.openui5.sapUiUnifiedMenuTextFieldItemMod.MenuTextFieldItemSettings
}
