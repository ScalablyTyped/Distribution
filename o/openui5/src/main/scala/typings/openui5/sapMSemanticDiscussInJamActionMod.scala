...
object sapMSemanticDiscussInJamActionMod {
  
  @JSImport("sap/m/semantic/DiscussInJamAction", JSImport.Default)
  @js.native
  /**
  ...
  type DiscussInJamAction = typings.openui5.sapMSemanticSemanticButtonMod.default
