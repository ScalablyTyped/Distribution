...
object sapMSemanticPrintActionMod {
  
  @JSImport("sap/m/semantic/PrintAction", JSImport.Default)
  @js.native
  /**
  ...
  type PrintAction = typings.openui5.sapMSemanticSemanticButtonMod.default
