...
object sapUiCoreMessageControlMessageProcessorMod {
  
  @JSImport("sap/ui/core/message/ControlMessageProcessor", JSImport.Default)
  @js.native
  /**
    * Constructor for a new ControlMessageProcessor
    */
  open class default () extends ControlMessageProcessor
  /* static members */
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ControlMessageProcessor]
