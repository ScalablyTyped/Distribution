...
import typings.openui5.sapUiWebcCommonWebComponentMod.WebComponentSettings
...
object sapUiWebcMainTabSeparatorMod {
  
  @JSImport("sap/ui/webc/main/TabSeparator", JSImport.Default)
  @js.native
  /**
  ...
  open class default () extends TabSeparator {
    def this(/**
      ...
      */
    mSettings: TabSeparatorSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, TabSeparator]
  ...
  type TabSeparatorSettings = WebComponentSettings
}
