...
object sapUiCommonsRadioButtonGroupMod {
  
  @JSImport("sap/ui/commons/RadioButtonGroup", JSImport.Default)
  @js.native
  /**
  ...
  trait RadioButtonGroup
    ...
    def setSelectedItem(/**
      * Selected item
      */
    oSelectedItem: typings.openui5.sapUiCoreItemMod.default): Unit = js.native
