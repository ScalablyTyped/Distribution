...
object sapUiWebcMainRadioButtonMod {
  
  @JSImport("sap/ui/webc/main/RadioButton", JSImport.Default)
  @js.native
  /**
  ...
  trait RadioButton$ChangeEventParameters extends StObject
  
  type RadioButtonChangeEvent = typings.openui5.sapUiBaseEventMod.default[RadioButton$ChangeEventParameters]
  
  type RadioButtonChangeEventParameters = RadioButton$ChangeEventParameters
