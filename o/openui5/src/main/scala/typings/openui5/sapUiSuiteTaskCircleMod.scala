...
import typings.openui5.sapUiSuiteLibraryMod.TaskCircleColor
import typings.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sapUiSuiteTaskCircleMod {
  
  @JSImport("sap/ui/suite/TaskCircle", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends TaskCircle {
    def this(/**
      * initial settings for the new control
      */
    mSettings: TaskCircleSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, TaskCircle]
  ...
  trait TaskCircle
    ...
    /**
      ...
      */
    def getColor(): TaskCircleColor | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof TaskCircleColor * / any */ String) = js.native
    ...
    def setColor(
      ...
      */
    sColor: /* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof TaskCircleColor * / any */ String
    ): this.type = js.native
    def setColor(/**
      * New value for property `color`
      */
    sColor: TaskCircleColor): this.type = js.native
    ...
    /**
      ...
      * @returns Reference to `this` in order to allow method chaining
      */
    def setMinValue(): this.type = js.native
    def setMinValue(/**
      * New value for property `minValue`
      */
    iMinValue: int): this.type = js.native
  ...
  trait TaskCircle$PressEventParameters extends StObject
  
  type TaskCirclePressEvent = typings.openui5.sapUiBaseEventMod.default[TaskCircle$PressEventParameters]
  
  type TaskCirclePressEventParameters = TaskCircle$PressEventParameters
  
  trait TaskCircleSettings
    extends StObject
    ...
    var color: js.UndefOr[
        TaskCircleColor | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof TaskCircleColor * / any */ String) | PropertyBindingInfo
      ] = js.undefined
    ...
    /**
      * Lower limit of the displayed values. Default is 0.
      */
    var minValue: js.UndefOr[int | PropertyBindingInfo | (/* template literal string: {${string}} */ String)] = js.undefined
  ...
  object TaskCircleSettings {
    
    inline def apply(): TaskCircleSettings = {
    ...
    implicit open class MutableBuilder[Self <: TaskCircleSettings] (val x: Self) extends AnyVal {
      ...
      inline def setColor(
        value: TaskCircleColor | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof TaskCircleColor * / any */ String) | PropertyBindingInfo
      ...
      inline def setMinValue(value: int | PropertyBindingInfo | (/* template literal string: {${string}} */ String)): Self = StObject.set(x, "minValue", value.asInstanceOf[js.Any])
