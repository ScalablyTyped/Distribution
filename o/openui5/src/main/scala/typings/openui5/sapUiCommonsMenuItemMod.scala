...
object sapUiCommonsMenuItemMod {
  
  @JSImport("sap/ui/commons/MenuItem", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiUnifiedMenuItemMod.default {
    def this(/**
  ...
  type MenuItem = typings.openui5.sapUiUnifiedMenuItemMod.default
  
  type MenuItemSettings = typings.openui5.sapUiUnifiedMenuItemMod.MenuItemSettings
}
