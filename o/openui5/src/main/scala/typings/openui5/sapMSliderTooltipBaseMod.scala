...
object sapMSliderTooltipBaseMod {
  
  @JSImport("sap/m/SliderTooltipBase", JSImport.Default)
  @js.native
  /**
  ...
  open class default () extends SliderTooltipBase {
    def this(/**
      ...
      */
    mSettings: SliderTooltipBaseSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, SliderTooltipBase]
  ...
  trait SliderTooltipBase
    ...
    def sliderValueChanged(/**
      ...
      */
    fValue: float): Unit = js.native
  }
  
  type SliderTooltipBaseSettings = ControlSettings
}
