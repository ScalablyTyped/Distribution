...
object sapMSemanticFilterSelectMod {
  
  @JSImport("sap/m/semantic/FilterSelect", JSImport.Default)
  @js.native
  /**
  ...
  open class default () extends FilterSelect {
    def this(/**
      ...
      */
    mSettings: FilterSelectSettings) = this()
    def this(/**
    ...
    /* CompleteClass */
    var __implements__sap_m_semantic_IFilter: Boolean = js.native
  }
  /* static members */
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, FilterSelect]
  ...
  type FilterSelectSettings = SemanticSelectSettings
}
