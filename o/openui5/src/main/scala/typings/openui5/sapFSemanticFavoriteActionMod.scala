...
object sapFSemanticFavoriteActionMod {
  
  @JSImport("sap/f/semantic/FavoriteAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: FavoriteActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, FavoriteAction]
  ...
  type FavoriteAction = typings.openui5.sapFSemanticSemanticToggleButtonMod.default
  
  type FavoriteActionSettings = SemanticToggleButtonSettings
}
