...
object sapMTileMod {
  ...
  @JSImport("sap/m/Tile", JSImport.Default)
  @js.native
  /**
  ...
  trait Tile
    ...
    /**
      ...
      * @returns Reference to `this` in order to allow method chaining
      */
    def setRemovable(): this.type = js.native
    def setRemovable(/**
      * New value for property `removable`
      */
    bRemovable: Boolean): this.type = js.native
  }
  
  trait Tile$PressEventParameters extends StObject
  
  type TilePressEvent = typings.openui5.sapUiBaseEventMod.default[Tile$PressEventParameters]
  
  type TilePressEventParameters = Tile$PressEventParameters
  ...
  trait TileSettings
    ...
    /**
      ...
      * by the tile container.
      */
    var removable: js.UndefOr[
        Boolean | PropertyBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  }
  object TileSettings {
    
    inline def apply(): TileSettings = {
    ...
    implicit open class MutableBuilder[Self <: TileSettings] (val x: Self) extends AnyVal {
      ...
      inline def setRemovable(value: Boolean | PropertyBindingInfo | (/* template literal string: {${string}} */ String)): Self = StObject.set(x, "removable", value.asInstanceOf[js.Any])
