...
object sapUiSuiteVerticalProgressIndicatorMod {
  
  @JSImport("sap/ui/suite/VerticalProgressIndicator", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends VerticalProgressIndicator {
    def this(/**
      * initial settings for the new control
      */
    mSettings: VerticalProgressIndicatorSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, VerticalProgressIndicator]
  ...
  @js.native
  trait VerticalProgressIndicator
    ...
    /**
      ...
      */
    def getPercentage(): int = js.native
  ...
  trait VerticalProgressIndicatorSettings
    ...
    /**
      ...
      * than 100 will be displayed as 100%, values lower than zero will be displayed as 0%.
      */
    var percentage: js.UndefOr[int | PropertyBindingInfo | (/* template literal string: {${string}} */ String)] = js.undefined
  ...
  object VerticalProgressIndicatorSettings {
    ...
    inline def apply(): VerticalProgressIndicatorSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[VerticalProgressIndicatorSettings]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: VerticalProgressIndicatorSettings] (val x: Self) extends AnyVal {
      ...
      inline def setPercentage(value: int | PropertyBindingInfo | (/* template literal string: {${string}} */ String)): Self = StObject.set(x, "percentage", value.asInstanceOf[js.Any])
