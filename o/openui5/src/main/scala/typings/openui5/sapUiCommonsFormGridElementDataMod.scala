...
object sapUiCommonsFormGridElementDataMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiLayoutFormGridElementDataMod.default {
    def this(/**
  ...
  type GridElementData = typings.openui5.sapUiLayoutFormGridElementDataMod.default
  
  type GridElementDataSettings = typings.openui5.sapUiLayoutFormGridElementDataMod.GridElementDataSettings
}
