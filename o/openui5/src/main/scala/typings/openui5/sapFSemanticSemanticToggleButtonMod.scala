...
object sapFSemanticSemanticToggleButtonMod {
  ...
  type SemanticToggleButton = typings.openui5.sapMSemanticSemanticToggleButtonMod.default
  
  type SemanticToggleButtonSettings = typings.openui5.sapMSemanticSemanticToggleButtonMod.SemanticToggleButtonSettings
}
