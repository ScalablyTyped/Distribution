...
object sapMSinglePlanningCalendarWorkWeekViewMod {
  
  @JSImport("sap/m/SinglePlanningCalendarWorkWeekView", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: SinglePlanningCalendarWorkWeekViewSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, SinglePlanningCalendarWorkWeekView]
  ...
  type SinglePlanningCalendarWorkWeekView = typings.openui5.sapMSinglePlanningCalendarViewMod.default
  
  type SinglePlanningCalendarWorkWeekViewSettings = SinglePlanningCalendarViewSettings
}
