...
import typings.openui5.sapFSemanticMainActionMod.MainActionSettings
...
object sapFSemanticTitleMainActionMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapFSemanticMainActionMod.default {
    def this(/**
  ...
  type TitleMainAction = typings.openui5.sapFSemanticMainActionMod.default
