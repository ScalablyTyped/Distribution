...
object sapMSemanticPositiveActionMod {
  
  @JSImport("sap/m/semantic/PositiveAction", JSImport.Default)
  @js.native
  /**
  ...
  object PositiveActionSettings {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PositiveActionSettings] (val x: Self) extends AnyVal {
