...
object sapMFeedContentMod {
  ...
  trait FeedContent$PressEventParameters extends StObject
  
  type FeedContentPressEvent = typings.openui5.sapUiBaseEventMod.default[FeedContent$PressEventParameters]
  
  type FeedContentPressEventParameters = FeedContent$PressEventParameters
