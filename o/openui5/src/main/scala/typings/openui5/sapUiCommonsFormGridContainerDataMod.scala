...
object sapUiCommonsFormGridContainerDataMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiLayoutFormGridContainerDataMod.default {
    def this(/**
  ...
  type GridContainerData = typings.openui5.sapUiLayoutFormGridContainerDataMod.default
  
  type GridContainerDataSettings = typings.openui5.sapUiLayoutFormGridContainerDataMod.GridContainerDataSettings
}
