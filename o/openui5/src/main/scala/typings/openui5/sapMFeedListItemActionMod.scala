...
object sapMFeedListItemActionMod {
  
  @JSImport("sap/m/FeedListItemAction", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends FeedListItemAction {
    def this(/**
      * Initial settings for the new element
      */
    mSettings: FeedListItemActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, FeedListItemAction]
  ...
  trait FeedListItemAction$PressEventParameters extends StObject
  
  type FeedListItemActionPressEvent = typings.openui5.sapUiBaseEventMod.default[FeedListItemAction$PressEventParameters]
  
  type FeedListItemActionPressEventParameters = FeedListItemAction$PressEventParameters
  
  trait FeedListItemActionSettings
    extends StObject
  ...
  object FeedListItemActionSettings {
    
    inline def apply(): FeedListItemActionSettings = {
