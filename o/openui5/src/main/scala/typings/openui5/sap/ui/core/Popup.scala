...
class Popup protected () extends ManagedObject {
  ...
  def open(
    ...
    of: js.UndefOr[js.Any | Element | typings.jquery.JQueryStatic | String],
  ...
  def setPosition(my: TypeofDock, at: js.Any, of: typings.jquery.JQueryStatic): Popup = js.native
  def setPosition(my: TypeofDock, at: js.Any, of: typings.jquery.JQueryStatic, offset: String): Popup = js.native
  def setPosition(my: TypeofDock, at: js.Any, of: typings.jquery.JQueryStatic, offset: String, collision: String): Popup = js.native
  ...
  def setPosition(my: TypeofDock, at: TypeofDock, of: typings.jquery.JQueryStatic): Popup = js.native
  def setPosition(my: TypeofDock, at: TypeofDock, of: typings.jquery.JQueryStatic, offset: String): Popup = js.native
  def setPosition(my: TypeofDock, at: TypeofDock, of: typings.jquery.JQueryStatic, offset: String, collision: String): Popup = js.native
