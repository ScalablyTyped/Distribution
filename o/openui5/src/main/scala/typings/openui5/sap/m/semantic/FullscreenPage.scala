...
import typings.openui5.sap.m.DraftIndicator
import typings.openui5.sap.m.PagingButton
...
@js.native
class FullscreenPage protected () extends ShareMenuPage {
  /**
  ...
  /**
    ...
    */
  def getCancelAction(): CancelAction = js.native
  /**
  ...
  /**
    ...
    */
  def getEditAction(): EditAction = js.native
  /**
  ...
  /**
    ...
    */
  def getForwardAction(): ForwardAction = js.native
  /**
    * Gets content of aggregation <code>mainAction</code>.Main action
    */
  def getMainAction(): MainAction = js.native
  /**
  ...
  /**
    ...
    */
  def getOpenInAction(): OpenInAction = js.native
  /**
    * Gets content of aggregation <code>pagingAction</code>.Paging action
    */
  def getPagingAction(): PagingButton = js.native
  /**
  ...
  /**
    ...
    */
  def getSaveAction(): SaveAction = js.native
  /**
