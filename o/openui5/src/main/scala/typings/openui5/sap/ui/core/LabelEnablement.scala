...
object LabelEnablement extends js.Object {
  /**
    ...
    */
  def enrich(oControl: Control): Unit = js.native
  /**
    ...
    * @returns an array of ids of the labels referencing the given element
    */
  def getReferencingLabels(oElement: Element): js.Array[String] = js.native
  /**
    ...
    * referencing labels, <code>false</code> otherwise
    */
  def isRequired(oElement: Element): Boolean = js.native
  /**
    ...
    */
  def writeLabelForAttribute(oRenderManager: RenderManager, oLabel: js.Any): Unit = js.native
}
