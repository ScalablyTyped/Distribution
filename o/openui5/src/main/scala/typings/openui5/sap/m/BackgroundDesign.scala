...
import typings.openui5.sap.m.BackgroundDesign.Solid
import typings.openui5.sap.m.BackgroundDesign.Translucent
import typings.openui5.sap.m.BackgroundDesign.Transparent
