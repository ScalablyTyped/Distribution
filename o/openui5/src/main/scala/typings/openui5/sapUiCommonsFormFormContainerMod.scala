...
object sapUiCommonsFormFormContainerMod {
  ...
  @js.native
  trait FormContainer
    extends typings.openui5.sapUiLayoutFormFormContainerMod.default
  
  type FormContainerSettings = typings.openui5.sapUiLayoutFormFormContainerMod.FormContainerSettings
}
