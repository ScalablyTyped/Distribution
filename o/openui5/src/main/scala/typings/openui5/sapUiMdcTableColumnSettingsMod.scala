...
object sapUiMdcTableColumnSettingsMod {
  
  @JSImport("sap/ui/mdc/table/ColumnSettings", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: ColumnSettingsSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ColumnSettings]
  ...
  type ColumnSettings = typings.openui5.sapUiCoreElementMod.default
  
  type ColumnSettingsSettings = ElementSettings
}
