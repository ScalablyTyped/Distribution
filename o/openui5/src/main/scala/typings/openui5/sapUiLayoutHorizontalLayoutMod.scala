...
object sapUiLayoutHorizontalLayoutMod {
  
  @JSImport("sap/ui/layout/HorizontalLayout", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends HorizontalLayout {
    def this(/**
  ...
  trait HorizontalLayout
    ...
    /**
      ...
      * @returns Reference to `this` in order to allow method chaining
      */
    def setAllowWrapping(): this.type = js.native
    def setAllowWrapping(/**
      * New value for property `allowWrapping`
      */
    bAllowWrapping: Boolean): this.type = js.native
  }
  
  trait HorizontalLayoutSettings
    extends StObject
  ...
  object HorizontalLayoutSettings {
    
    inline def apply(): HorizontalLayoutSettings = {
    ...
    extension [Self <: HorizontalLayoutSettings](x: Self) {
      ...
      inline def setAllowWrappingUndefined: Self = StObject.set(x, "allowWrapping", js.undefined)
