...
object sapUiCommonsFormFormLayoutMod {
  
  @JSImport("sap/ui/commons/form/FormLayout", JSImport.Default)
  @js.native
  /**
  ...
  type FormLayout = typings.openui5.sapUiLayoutFormFormLayoutMod.default
  
  type FormLayoutSettings = typings.openui5.sapUiLayoutFormFormLayoutMod.FormLayoutSettings
}
