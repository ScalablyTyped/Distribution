...
trait Ui5Logger extends StObject {
  ...
  def debug(sMessage: String, sDetails: Unit, sComponent: String): Unit = js.native
  ...
  def error(sMessage: String, sDetails: Unit, sComponent: String): Unit = js.native
  ...
  def fatal(sMessage: String, sDetails: Unit, sComponent: String): Unit = js.native
  ...
  def info(sMessage: String, sDetails: Unit, sComponent: String): Unit = js.native
  ...
  def isLoggable(iLevel: Unit, sComponent: String): Unit = js.native
  ...
  def trace(sMessage: String, sDetails: Unit, sComponent: String): Unit = js.native
  ...
  def warning(sMessage: String, sDetails: Unit, sComponent: String): Unit = js.native
}
