...
object sapUiCommonsFormGridLayoutMod {
  
  @JSImport("sap/ui/commons/form/GridLayout", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiLayoutFormGridLayoutMod.default {
    def this(/**
  ...
  type GridLayout = typings.openui5.sapUiLayoutFormGridLayoutMod.default
  
  type GridLayoutSettings = typings.openui5.sapUiLayoutFormGridLayoutMod.GridLayoutSettings
}
