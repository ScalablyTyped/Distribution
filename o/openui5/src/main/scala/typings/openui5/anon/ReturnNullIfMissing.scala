...
trait ReturnNullIfMissing extends StObject {
  ...
  /**
    ...
    */
  var returnNullIfMissing: js.UndefOr[Boolean] = js.undefined
...
object ReturnNullIfMissing {
  ...
  implicit open class MutableBuilder[Self <: ReturnNullIfMissing] (val x: Self) extends AnyVal {
    ...
    inline def setReturnNullIfMissing(value: Boolean): Self = StObject.set(x, "returnNullIfMissing", value.asInstanceOf[js.Any])
