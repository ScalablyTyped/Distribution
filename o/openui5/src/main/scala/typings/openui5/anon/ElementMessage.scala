...
trait ElementMessage extends StObject {
...
object ElementMessage {
  
  inline def apply(): ElementMessage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ElementMessage]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ElementMessage] (val x: Self) extends AnyVal {
