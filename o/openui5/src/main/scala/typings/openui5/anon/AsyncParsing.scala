...
trait AsyncParsing extends StObject {
...
object AsyncParsing {
  ...
  inline def apply(): AsyncParsing = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AsyncParsing]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AsyncParsing] (val x: Self) extends AnyVal {
