...
trait NoPatch extends StObject {
...
object NoPatch {
  ...
  inline def apply(): NoPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NoPatch]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NoPatch] (val x: Self) extends AnyVal {
