...
trait ActionItems extends StObject {
...
object ActionItems {
  ...
  inline def apply(): ActionItems = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ActionItems]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ActionItems] (val x: Self) extends AnyVal {
