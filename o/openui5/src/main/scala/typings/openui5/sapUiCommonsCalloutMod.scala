...
object sapUiCommonsCalloutMod {
  
  @JSImport("sap/ui/commons/Callout", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends Callout {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: CalloutSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, Callout]
  ...
  object CalloutSettings {
    
    inline def apply(): CalloutSettings = {
