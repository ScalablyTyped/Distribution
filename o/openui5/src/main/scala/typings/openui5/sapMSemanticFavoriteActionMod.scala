...
object sapMSemanticFavoriteActionMod {
  
  @JSImport("sap/m/semantic/FavoriteAction", JSImport.Default)
  @js.native
  /**
  ...
  type FavoriteAction = typings.openui5.sapMSemanticSemanticToggleButtonMod.default
