...
object sapFIllustrationMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapMIllustrationMod.default {
    def this(/**
  ...
  type Illustration = typings.openui5.sapMIllustrationMod.default
  
  type IllustrationSettings = typings.openui5.sapMIllustrationMod.IllustrationSettings
}
