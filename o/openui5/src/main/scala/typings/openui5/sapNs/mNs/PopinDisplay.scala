...
object PopinDisplay extends js.Object {
  ...
  /* 0 */ val Block: typings.openui5.sapNs.mNs.PopinDisplay.Block with Double = js.native
  /* 1 */ val Inline: typings.openui5.sapNs.mNs.PopinDisplay.Inline with Double = js.native
  /* 2 */ val WithoutHeader: typings.openui5.sapNs.mNs.PopinDisplay.WithoutHeader with Double = js.native
  @JSBracketAccess
