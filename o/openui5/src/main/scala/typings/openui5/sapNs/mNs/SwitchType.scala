...
object SwitchType extends js.Object {
  ...
  /* 0 */ val AcceptReject: typings.openui5.sapNs.mNs.SwitchType.AcceptReject with Double = js.native
  /* 1 */ val Default: typings.openui5.sapNs.mNs.SwitchType.Default with Double = js.native
  @JSBracketAccess
