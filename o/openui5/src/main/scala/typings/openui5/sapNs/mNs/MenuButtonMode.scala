...
object MenuButtonMode extends js.Object {
  ...
  /* 0 */ val Regular: typings.openui5.sapNs.mNs.MenuButtonMode.Regular with Double = js.native
  /* 1 */ val Split: typings.openui5.sapNs.mNs.MenuButtonMode.Split with Double = js.native
  @JSBracketAccess
