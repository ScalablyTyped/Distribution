...
object BackgroundDesign extends js.Object {
  ...
  /* 0 */ val Solid: typings.openui5.sapNs.uiNs.layoutNs.BackgroundDesign.Solid with Double = js.native
  /* 1 */ val Translucent: typings.openui5.sapNs.uiNs.layoutNs.BackgroundDesign.Translucent with Double = js.native
  /* 2 */ val Transparent: typings.openui5.sapNs.uiNs.layoutNs.BackgroundDesign.Transparent with Double = js.native
  @JSBracketAccess
