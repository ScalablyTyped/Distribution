...
object SelectType extends js.Object {
  ...
  /* 0 */ val Default: typings.openui5.sapNs.mNs.SelectType.Default with Double = js.native
  /* 1 */ val IconOnly: typings.openui5.sapNs.mNs.SelectType.IconOnly with Double = js.native
  @JSBracketAccess
