...
@js.native
class CalendarTimeInterval protected () extends Control {
  /**
  ...
  def addAriaLabelledBy(vAriaLabelledBy: Control): CalendarTimeInterval = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertSelectedDate(oSelectedDate: DateRange, iIndex: Double): CalendarTimeInterval = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertSpecialDate(oSpecialDate: DateTypeRange, iIndex: Double): CalendarTimeInterval = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setIntervalMinutes(iIntervalMinutes: Double): CalendarTimeInterval = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setIntervalSelection(bIntervalSelection: Boolean): CalendarTimeInterval = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setItems(iItems: Double): CalendarTimeInterval = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setPickerPopup(bPickerPopup: Boolean): CalendarTimeInterval = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSingleSelection(bSingleSelection: Boolean): CalendarTimeInterval = js.native
  /**
