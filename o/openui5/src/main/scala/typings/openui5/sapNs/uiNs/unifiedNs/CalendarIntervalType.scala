...
object CalendarIntervalType extends js.Object {
  ...
  /* 0 */ val Day: typings.openui5.sapNs.uiNs.unifiedNs.CalendarIntervalType.Day with Double = js.native
  /* 1 */ val Hour: typings.openui5.sapNs.uiNs.unifiedNs.CalendarIntervalType.Hour with Double = js.native
  /* 2 */ val Month: typings.openui5.sapNs.uiNs.unifiedNs.CalendarIntervalType.Month with Double = js.native
  @JSBracketAccess
