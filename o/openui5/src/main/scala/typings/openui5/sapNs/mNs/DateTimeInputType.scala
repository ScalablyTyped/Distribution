...
object DateTimeInputType extends js.Object {
  ...
  /* 0 */ val Date: typings.openui5.sapNs.mNs.DateTimeInputType.Date with Double = js.native
  /* 1 */ val DateTime: typings.openui5.sapNs.mNs.DateTimeInputType.DateTime with Double = js.native
  /* 2 */ val Time: typings.openui5.sapNs.mNs.DateTimeInputType.Time with Double = js.native
  @JSBracketAccess
