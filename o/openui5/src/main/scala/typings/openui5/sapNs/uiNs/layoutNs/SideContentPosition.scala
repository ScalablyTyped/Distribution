...
object SideContentPosition extends js.Object {
  ...
  /* 0 */ val Begin: typings.openui5.sapNs.uiNs.layoutNs.SideContentPosition.Begin with Double = js.native
  /* 1 */ val End: typings.openui5.sapNs.uiNs.layoutNs.SideContentPosition.End with Double = js.native
  @JSBracketAccess
