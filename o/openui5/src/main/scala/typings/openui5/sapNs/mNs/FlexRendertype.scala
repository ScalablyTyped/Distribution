...
object FlexRendertype extends js.Object {
  ...
  /* 0 */ val Div: typings.openui5.sapNs.mNs.FlexRendertype.Div with Double = js.native
  /* 1 */ val List: typings.openui5.sapNs.mNs.FlexRendertype.List with Double = js.native
  @JSBracketAccess
