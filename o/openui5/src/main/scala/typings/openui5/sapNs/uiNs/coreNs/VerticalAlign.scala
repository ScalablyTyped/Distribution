...
object VerticalAlign extends js.Object {
  ...
  /* 0 */ val Bottom: typings.openui5.sapNs.uiNs.coreNs.VerticalAlign.Bottom with Double = js.native
  /* 1 */ val Inherit: typings.openui5.sapNs.uiNs.coreNs.VerticalAlign.Inherit with Double = js.native
  /* 2 */ val Middle: typings.openui5.sapNs.uiNs.coreNs.VerticalAlign.Middle with Double = js.native
  /* 3 */ val Top: typings.openui5.sapNs.uiNs.coreNs.VerticalAlign.Top with Double = js.native
  @JSBracketAccess
