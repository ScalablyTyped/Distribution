...
object FlexJustifyContent extends js.Object {
  ...
  /* 0 */ val Center: typings.openui5.sapNs.mNs.FlexJustifyContent.Center with Double = js.native
  /* 1 */ val End: typings.openui5.sapNs.mNs.FlexJustifyContent.End with Double = js.native
  /* 2 */ val Inherit: typings.openui5.sapNs.mNs.FlexJustifyContent.Inherit with Double = js.native
  /* 3 */ val SpaceAround: typings.openui5.sapNs.mNs.FlexJustifyContent.SpaceAround with Double = js.native
  /* 4 */ val SpaceBetween: typings.openui5.sapNs.mNs.FlexJustifyContent.SpaceBetween with Double = js.native
  /* 5 */ val Start: typings.openui5.sapNs.mNs.FlexJustifyContent.Start with Double = js.native
  @JSBracketAccess
