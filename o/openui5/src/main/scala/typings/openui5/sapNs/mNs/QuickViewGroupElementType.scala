...
object QuickViewGroupElementType extends js.Object {
  ...
  /* 0 */ val email: typings.openui5.sapNs.mNs.QuickViewGroupElementType.email with Double = js.native
  /* 1 */ val link: typings.openui5.sapNs.mNs.QuickViewGroupElementType.link with Double = js.native
  /* 2 */ val mobile: typings.openui5.sapNs.mNs.QuickViewGroupElementType.mobile with Double = js.native
  /* 3 */ val pageLink: typings.openui5.sapNs.mNs.QuickViewGroupElementType.pageLink with Double = js.native
  /* 4 */ val phone: typings.openui5.sapNs.mNs.QuickViewGroupElementType.phone with Double = js.native
  /* 5 */ val text: typings.openui5.sapNs.mNs.QuickViewGroupElementType.text with Double = js.native
  @JSBracketAccess
