...
object FlexWrap extends js.Object {
  ...
  /* 0 */ val NoWrap: typings.openui5.sapNs.mNs.FlexWrap.NoWrap with Double = js.native
  /* 1 */ val Wrap: typings.openui5.sapNs.mNs.FlexWrap.Wrap with Double = js.native
  /* 2 */ val WrapReverse: typings.openui5.sapNs.mNs.FlexWrap.WrapReverse with Double = js.native
  @JSBracketAccess
