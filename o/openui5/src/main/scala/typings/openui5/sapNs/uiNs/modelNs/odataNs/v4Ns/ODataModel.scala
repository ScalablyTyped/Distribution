...
class ODataModel protected () extends Model {
  ...
  def bindContext(sPath: String, oContext: typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.Context): typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.ODataContextBinding = js.native
  def bindContext(
    sPath: String,
    oContext: typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.Context,
    mParameters: js.Any
  ): typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.ODataContextBinding = js.native
  def bindList(sPath: String, oContext: typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.Context): typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.ODataListBinding = js.native
  def bindList(
    sPath: String,
    oContext: typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.Context,
    vSorters: js.Array[Sorter]
  ): typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.ODataListBinding = js.native
  def bindList(
    sPath: String,
    oContext: typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.Context,
    vSorters: js.Array[Sorter],
  ...
  def bindList(sPath: String, oContext: typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.Context, vSorters: Sorter): typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.ODataListBinding = js.native
  def bindList(
    sPath: String,
    oContext: typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.Context,
    vSorters: Sorter,
  ...
  def bindProperty(sPath: String, oContext: typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.Context): typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.ODataPropertyBinding = js.native
  def bindProperty(
    sPath: String,
    oContext: typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.Context,
    mParameters: js.Any
  ): typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.ODataPropertyBinding = js.native
  /**
  ...
  /**
    ...
    */
  def requestCanonicalPath(oEntityContext: typings.openui5.sapNs.uiNs.modelNs.odataNs.v4Ns.Context): JQueryPromise[_] = js.native
  /**
