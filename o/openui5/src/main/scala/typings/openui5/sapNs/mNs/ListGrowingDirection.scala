...
object ListGrowingDirection extends js.Object {
  ...
  /* 0 */ val Downwards: typings.openui5.sapNs.mNs.ListGrowingDirection.Downwards with Double = js.native
  /* 1 */ val Upwards: typings.openui5.sapNs.mNs.ListGrowingDirection.Upwards with Double = js.native
  @JSBracketAccess
