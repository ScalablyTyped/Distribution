...
object IconTabFilterDesign extends js.Object {
  ...
  /* 0 */ val Horizontal: typings.openui5.sapNs.mNs.IconTabFilterDesign.Horizontal with Double = js.native
  /* 1 */ val Vertical: typings.openui5.sapNs.mNs.IconTabFilterDesign.Vertical with Double = js.native
  @JSBracketAccess
