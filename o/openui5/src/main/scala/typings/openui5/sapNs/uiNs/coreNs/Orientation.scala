...
object Orientation extends js.Object {
  ...
  /* 0 */ val Horizontal: typings.openui5.sapNs.uiNs.coreNs.Orientation.Horizontal with Double = js.native
  /* 1 */ val Vertical: typings.openui5.sapNs.uiNs.coreNs.Orientation.Vertical with Double = js.native
  @JSBracketAccess
