...
object ObjectMarkerVisibility extends js.Object {
  ...
  /* 0 */ val IconAndText: typings.openui5.sapNs.mNs.ObjectMarkerVisibility.IconAndText with Double = js.native
  /* 1 */ val IconOnly: typings.openui5.sapNs.mNs.ObjectMarkerVisibility.IconOnly with Double = js.native
  /* 2 */ val TextOnly: typings.openui5.sapNs.mNs.ObjectMarkerVisibility.TextOnly with Double = js.native
  @JSBracketAccess
