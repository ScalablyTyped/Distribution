...
object FlexAlignContent extends js.Object {
  ...
  /* 0 */ val Center: typings.openui5.sapNs.mNs.FlexAlignContent.Center with Double = js.native
  /* 1 */ val End: typings.openui5.sapNs.mNs.FlexAlignContent.End with Double = js.native
  /* 2 */ val Inherit: typings.openui5.sapNs.mNs.FlexAlignContent.Inherit with Double = js.native
  /* 3 */ val SpaceAround: typings.openui5.sapNs.mNs.FlexAlignContent.SpaceAround with Double = js.native
  /* 4 */ val SpaceBetween: typings.openui5.sapNs.mNs.FlexAlignContent.SpaceBetween with Double = js.native
  /* 5 */ val Start: typings.openui5.sapNs.mNs.FlexAlignContent.Start with Double = js.native
  /* 6 */ val Stretch: typings.openui5.sapNs.mNs.FlexAlignContent.Stretch with Double = js.native
  @JSBracketAccess
