...
object MessageType extends js.Object {
  ...
  /* 0 */ val Error: typings.openui5.sapNs.uiNs.coreNs.MessageType.Error with Double = js.native
  /* 1 */ val Information: typings.openui5.sapNs.uiNs.coreNs.MessageType.Information with Double = js.native
  /* 2 */ val None: typings.openui5.sapNs.uiNs.coreNs.MessageType.None with Double = js.native
  /* 3 */ val Success: typings.openui5.sapNs.uiNs.coreNs.MessageType.Success with Double = js.native
  /* 4 */ val Warning: typings.openui5.sapNs.uiNs.coreNs.MessageType.Warning with Double = js.native
  @JSBracketAccess
