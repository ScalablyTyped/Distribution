...
class Router protected () extends EventProvider {
  ...
  /**
    ...
    */
  def attachBypassed(oData: js.Any, fnFunction: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  def attachBypassed(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def attachRouteMatched(oData: js.Any, fnFunction: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  def attachRouteMatched(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def attachRoutePatternMatched(oData: js.Any, fnFunction: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  def attachRoutePatternMatched(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def attachViewCreated(oData: js.Any, fnFunction: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  def attachViewCreated(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    * Removes the router from the hash changer @see sap.ui.core.routing.HashChanger
    * @returns this for chaining.
    */
  def destroy(): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def detachBypassed(fnFunction: js.Any, oListener: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def detachRouteMatched(fnFunction: js.Any, oListener: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def detachRoutePatternMatched(fnFunction: js.Any, oListener: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def detachViewCreated(fnFunction: js.Any, oListener: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def fireBypassed(mArguments: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    * Fire event routeMatched to attached listeners.
    * @param mArguments the arguments to pass along with the event.
    * @returns <code>this</code> to allow method chaining
    */
  def fireRouteMatched(mArguments: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def fireRoutePatternMatched(mArguments: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    * Fire event viewCreated to attached listeners.
    * @param mArguments the arguments to pass along with the event.
    * @returns <code>this</code> to allow method chaining
    */
  def fireViewCreated(mArguments: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
  ...
  /**
    ...
    */
  def getRouter(sName: String): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
  ...
  /**
    ...
    * @returns this for chaining.
    */
  def initialize(): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    * @returns this for chaining.
    */
  def navTo(sName: String): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  def navTo(sName: String, oParameters: js.Any): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  def navTo(sName: String, oParameters: js.Any, bReplace: Boolean): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
  ...
  /**
    ...
    */
  def setView(sViewName: String, oView: View): typings.openui5.sapNs.mNs.routingNs.Router = js.native
  /**
    * Stops to listen to the hashChange of the browser.</br>If you want the router to start again, call
    * initialize again.
    * @returns this for chaining.
    */
  def stop(): typings.openui5.sapNs.mNs.routingNs.Router = js.native
}
