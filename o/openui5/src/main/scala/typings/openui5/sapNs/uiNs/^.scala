...
import typings.openui5.sapNs.uiNs.coreNs.Core
import typings.openui5.sapNs.uiNs.coreNs.Element
import typings.openui5.sapNs.uiNs.coreNs.Fragment
import typings.openui5.sapNs.uiNs.coreNs.mvcNs.Controller
import typings.openui5.sapNs.uiNs.coreNs.mvcNs.HTMLView
import typings.openui5.sapNs.uiNs.coreNs.mvcNs.JSONView
import typings.openui5.sapNs.uiNs.coreNs.mvcNs.JSView
import typings.openui5.sapNs.uiNs.coreNs.mvcNs.TemplateView
...
object ^ extends js.Object {
  ...
  def component(vConfig: String): Component | JQueryPromise[_] = js.native
  def component(vConfig: js.Any): Component | JQueryPromise[_] = js.native
  def component(vConfig: ComponentConfig): JQueryPromise[Component] | Component = js.native
  /**
    ...
    */
  def controller(sName: String): Unit | Controller = js.native
  def controller(sName: String, oControllerImpl: js.Any): Unit | Controller = js.native
  def define(aDependencies: js.Any, vFactory: js.Any): Unit = js.native
  def define(sModuleName: String, aDependencies: js.Any, vFactory: js.Any): Unit = js.native
  //  Defines a Javascript module with its name, its dependencies and a module value or factory.
  def define(vFactory: js.Any): Unit = js.native
  //  Creates 0.
  def extensionpoint(oContainer: js.Any, sExtName: String): Unit = js.native
  def extensionpoint(oContainer: js.Any, sExtName: String, fnCreateDefaultContent: js.Any): Unit = js.native
  def extensionpoint(oContainer: js.Any, sExtName: String, fnCreateDefaultContent: js.Any, oTargetControl: js.Any): Unit = js.native
  def extensionpoint(
    oContainer: js.Any,
    sExtName: String,
  ...
  def extensionpoint(oContainer: Fragment, sExtName: String): js.Array[Control] = js.native
  def extensionpoint(oContainer: Fragment, sExtName: String, fnCreateDefaultContent: js.Any): js.Array[Control] = js.native
  def extensionpoint(oContainer: Fragment, sExtName: String, fnCreateDefaultContent: js.Any, oTargetControl: Control): js.Array[Control] = js.native
  def extensionpoint(
    oContainer: Fragment,
    sExtName: String,
    fnCreateDefaultContent: js.Any,
  ...
  /**
    ...
    */
  def extensionpoint(oContainer: View, sExtName: String): js.Array[Control] = js.native
  def extensionpoint(oContainer: View, sExtName: String, fnCreateDefaultContent: js.Any): js.Array[Control] = js.native
  def extensionpoint(oContainer: View, sExtName: String, fnCreateDefaultContent: js.Any, oTargetControl: Control): js.Array[Control] = js.native
  def extensionpoint(
    oContainer: View,
    sExtName: String,
    fnCreateDefaultContent: js.Any,
  ...
  /**
    ...
    */
  def fragment(sName: String, sType: String): Control | js.Array[Control] = js.native
  def fragment(sName: String, sType: String, oController: js.Any): Unit = js.native
  def fragment(sName: String, sType: String, oController: Controller): Control | js.Array[Control] = js.native
  //  Instantiate a Fragment - this method loads the Fragment content, instantiates it, and returns this content.
  @JSName("fragment")
  def fragment_Unit(sName: String, sType: String): Unit = js.native
  ...
  def getVersionInfo(): Unit = js.native
  /**
    ...
    */
  def getVersionInfo(mOptions: String): js.Any | JQueryPromise[_] = js.native
  def getVersionInfo(mOptions: js.Any): js.Any | JQueryPromise[_] = js.native
  @JSName("getVersionInfo")
  def getVersionInfo_Unit(sLibName: String): Unit = js.native
  /**
    ...
    */
  def htmlfragment(sId: String, vFragment: String): Control | js.Array[Control] = js.native
  def htmlfragment(sId: String, vFragment: String, oController: Controller): Control | js.Array[Control] = js.native
  def htmlfragment(sId: String, vFragment: js.Any): Control | js.Array[Control] = js.native
  def htmlfragment(sId: String, vFragment: js.Any, oController: js.Any): Unit = js.native
  def htmlfragment(sId: String, vFragment: js.Any, oController: Controller): Control | js.Array[Control] = js.native
  //  Instantiates an HTML-based Fragment.
  def htmlfragment(vFragment: js.Any): Fragment = js.native
  def htmlfragment(vFragment: js.Any, oController: js.Any): Fragment = js.native
  @JSName("htmlfragment")
  def htmlfragment_Unit(sId: String, vFragment: js.Any): Unit = js.native
  /**
    ...
    */
  def htmlview(sId: String, vView: String): HTMLView | js.Any = js.native
  def htmlview(sId: String, vView: js.Any): HTMLView | js.Any = js.native
  //  Defines or creates an instance of a declarative HTML view.
  def htmlview(vView: js.Any): HTMLView = js.native
  @JSName("htmlview")
  def htmlview_HTMLView(sId: String, vView: js.Any): HTMLView = js.native
  //  Defines OR instantiates an HTML-based Fragment.
  def jsfragment(sFragmentName: String): Fragment = js.native
  /**
    ...
    * @returns the root Control(s) of the created Fragment instance
    */
  def jsfragment(sId: String, sFragmentName: String): Control | js.Array[Control] = js.native
  def jsfragment(sId: String, sFragmentName: String, oController: js.Any): Fragment = js.native
  def jsfragment(sId: String, sFragmentName: String, oController: Controller): Control | js.Array[Control] = js.native
  def jsfragment(sId: String, sFragmentName: js.Any): Control | js.Array[Control] = js.native
  def jsfragment(sId: String, sFragmentName: js.Any, oController: Controller): Control | js.Array[Control] = js.native
  @JSName("jsfragment")
  def jsfragment_Fragment(sFragmentName: String, oController: js.Any): Fragment = js.native
  @JSName("jsfragment")
  def jsfragment_Fragment(sId: String, sFragmentName: String): Fragment = js.native
  /**
    ...
    */
  def jsonview(sId: String, vView: String): JSONView = js.native
  def jsonview(sId: String, vView: js.Any): JSONView = js.native
  //  Creates a JSON view of the given name and id.
  def jsonview(vView: js.Any): View = js.native
  @JSName("jsonview")
  def jsonview_View(sId: String, vView: js.Any): View = js.native
  /**
    ...
    */
  def jsview(sId: String, vView: String): JSView | js.Any = js.native
  def jsview(sId: String, vView: String, bAsync: Boolean): JSView | js.Any = js.native
  def jsview(sId: String, vView: js.Any): JSView | js.Any = js.native
  def jsview(sId: String, vView: js.Any, bAsync: Boolean): JSView | js.Any = js.native
  //  Defines or creates an instance of a JavaScript view.
  def jsview(vView: js.Any): JSView = js.native
  @JSName("jsview")
  def jsview_JSView(sId: String, vView: js.Any): JSView = js.native
  //  Creates a lazy loading stub for a given class sClassName.
  def lazyRequire(sClassName: String): Unit = js.native
  def lazyRequire(sClassName: String, sMethods: String): Unit = js.native
  def lazyRequire(sClassName: String, sMethods: String, sModuleName: String): Unit = js.native
  /**
    ...
    * folder
    */
  def localResources(sNamespace: String): Unit = js.native
  ...
  def localResources_Any(sNamespace: String): js.Any = js.native
  /**
    ...
    */
  def namespace(sNamespace: String): js.Any = js.native
  /**
    ...
    */
  def require(vDependencies: String): js.Any = js.native
  def require(vDependencies: String, fnCallback: js.Any): js.Any = js.native
  //  Resolves one or more module dependencies.
  def require(vDependencies: js.Any): Unit = js.native
  def require(vDependencies: js.Any, fnCallback: js.Any): Unit = js.native
  def require(vDependencies: js.Array[String]): js.Any = js.native
  def require(vDependencies: js.Array[String], fnCallback: js.Any): js.Any = js.native
  /**
    ...
    */
  def resource(sLibraryName: String, sResourcePath: String): String = js.native
  //  Returns the URL of a resource that belongs to the given library and has the given relative location within the library.
  @JSName("resource")
  def resource_Unit(sLibraryName: String, sResourcePath: String): Unit = js.native
  /**
  ...
  def setRoot(oDomRef: Control, oControl: Interface): Unit = js.native
  def setRoot(oDomRef: Control, oControl: Control): Unit = js.native
  ...
  /**
    ...
    */
  def template(oTemplate: String): js.Any | js.Array[_] = js.native
  ...
  /**
    ...
    */
  def templateview(sId: String, vView: String): TemplateView | js.Any = js.native
  def templateview(sId: String, vView: js.Any): TemplateView | js.Any = js.native
  //  Defines or creates an instance of a template view.
  def templateview(vView: js.Any): TemplateView = js.native
  @JSName("templateview")
  def templateview_TemplateView(sId: String, vView: js.Any): TemplateView = js.native
  ...
  /**
    ...
    */
  def view(sId: String): View = js.native
  def view(sId: String, vView: String): View = js.native
  def view(sId: String, vView: js.Any): View = js.native
  /**
    ...
    * @returns the root Control(s) of the created Fragment instance
    */
  def xmlfragment(sId: String, vFragment: String): Control | js.Array[Control] = js.native
  def xmlfragment(sId: String, vFragment: String, oController: Controller): Control | js.Array[Control] = js.native
  def xmlfragment(sId: String, vFragment: js.Any): Control | js.Array[Control] = js.native
  def xmlfragment(sId: String, vFragment: js.Any, oController: js.Any): Fragment = js.native
  def xmlfragment(sId: String, vFragment: js.Any, oController: Controller): Control | js.Array[Control] = js.native
  //  Instantiates an XML-based Fragment.
  def xmlfragment(vFragment: js.Any): Fragment = js.native
  def xmlfragment(vFragment: js.Any, oController: js.Any): Fragment = js.native
  @JSName("xmlfragment")
  def xmlfragment_Fragment(sId: String, vFragment: js.Any): Fragment = js.native
  /**
    ...
    */
  def xmlview(sId: String, vView: String, param: js.Any): XMLView = js.native
  def xmlview(sId: String, vView: js.Any): View = js.native
  def xmlview(sId: String, vView: js.Any, param: js.Any): XMLView = js.native
  //  Instantiates an XMLView of the given name and with the given id.
  def xmlview(vView: js.Any): View = js.native
}
