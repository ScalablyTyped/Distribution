...
object LabelDesign extends js.Object {
  ...
  /* 0 */ val Bold: typings.openui5.sapNs.mNs.LabelDesign.Bold with Double = js.native
  /* 1 */ val Standard: typings.openui5.sapNs.mNs.LabelDesign.Standard with Double = js.native
  @JSBracketAccess
