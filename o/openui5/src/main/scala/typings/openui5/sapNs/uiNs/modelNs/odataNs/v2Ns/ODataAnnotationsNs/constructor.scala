package typings.openui5.sapNs.uiNs.modelNs.odataNs.v2Ns.ODataAnnotationsNs

import typings.openui5.sapNs.uiNs.modelNs.odataNs.ODataMetadata
...
@js.native
class constructor protected () extends js.Object {
  /**
    ...
    */
  def this(oMetadata: ODataMetadata, mOptions: js.Any) = this()
}
