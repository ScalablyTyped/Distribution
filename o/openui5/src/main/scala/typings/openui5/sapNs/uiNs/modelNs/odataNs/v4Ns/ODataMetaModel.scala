...
import typings.openui5.sapNs.uiNs.modelNs.odataNs.typeNs.ODataType
...
class ODataMetaModel protected () extends MetaModel {
  ...
  def bindList(
    sPath: String,
    oContext: typings.openui5.sapNs.uiNs.modelNs.Context,
    aSorters: js.Array[Sorter],
    aFilters: typings.openui5.sapNs.uiNs.modelNs.Filter
  ): ListBinding = js.native
  def bindList(sPath: String, oContext: typings.openui5.sapNs.uiNs.modelNs.Context, aSorters: Sorter): ListBinding = js.native
  def bindList(
    sPath: String,
    oContext: typings.openui5.sapNs.uiNs.modelNs.Context,
    aSorters: Sorter,
    aFilters: js.Array[typings.openui5.sapNs.uiNs.modelNs.Filter]
  ): ListBinding = js.native
  def bindList(
    sPath: String,
    oContext: typings.openui5.sapNs.uiNs.modelNs.Context,
  ...
  /**
    ...
    */
  def getMetaContext(sPath: String): typings.openui5.sapNs.uiNs.modelNs.Context = js.native
  def getObject(sPath: String, oContext: typings.openui5.sapNs.uiNs.modelNs.Context): js.Any = js.native
  /**
  ...
  def requestObject(sPath: String, oContext: typings.openui5.sapNs.uiNs.modelNs.Context): JQueryPromise[_] = js.native
  /**
