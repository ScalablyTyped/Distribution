...
object BarDesign extends js.Object {
  ...
  /* 0 */ val Auto: typings.openui5.sapNs.mNs.BarDesign.Auto with Double = js.native
  /* 1 */ val Footer: typings.openui5.sapNs.mNs.BarDesign.Footer with Double = js.native
  /* 2 */ val Header: typings.openui5.sapNs.mNs.BarDesign.Header with Double = js.native
  /* 3 */ val SubHeader: typings.openui5.sapNs.mNs.BarDesign.SubHeader with Double = js.native
  @JSBracketAccess
