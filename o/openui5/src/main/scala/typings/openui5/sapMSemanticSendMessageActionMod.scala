...
object sapMSemanticSendMessageActionMod {
  
  @JSImport("sap/m/semantic/SendMessageAction", JSImport.Default)
  @js.native
  /**
  ...
  type SendMessageAction = typings.openui5.sapMSemanticSemanticButtonMod.default
