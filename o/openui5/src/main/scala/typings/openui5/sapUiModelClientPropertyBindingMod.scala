...
object sapUiModelClientPropertyBindingMod {
  
  @JSImport("sap/ui/model/ClientPropertyBinding", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ClientPropertyBinding]
  ...
  type ClientPropertyBinding = typings.openui5.sapUiModelPropertyBindingMod.default
}
