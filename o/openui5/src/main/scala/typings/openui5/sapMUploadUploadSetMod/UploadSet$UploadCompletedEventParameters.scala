...
trait UploadSet$UploadCompletedEventParameters extends StObject {
...
object UploadSet$UploadCompletedEventParameters {
  
  inline def apply(): UploadSet$UploadCompletedEventParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UploadSet$UploadCompletedEventParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UploadSet$UploadCompletedEventParameters] (val x: Self) extends AnyVal {
