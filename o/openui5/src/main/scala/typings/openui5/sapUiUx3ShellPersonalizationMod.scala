...
object sapUiUx3ShellPersonalizationMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("sap/ui/ux3/ShellPersonalization", JSImport.Default)
  @js.native
  val default: /* undefined */ Any = js.native
  
  type _To = /* undefined */ Any
  
  /* This means you don't have to write `default`, but can instead just say `sapUiUx3ShellPersonalizationMod.foo` */
