...
object sapFSemanticSemanticButtonMod {
  
  @JSImport("sap/f/semantic/SemanticButton", JSImport.Default)
  @js.native
  /**
  ...
  type SemanticButton = typings.openui5.sapMSemanticSemanticButtonMod.default
  
  type SemanticButtonSettings = typings.openui5.sapMSemanticSemanticButtonMod.SemanticButtonSettings
}
