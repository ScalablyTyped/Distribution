...
object sapMSemanticForwardActionMod {
  
  @JSImport("sap/m/semantic/ForwardAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: ForwardActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ForwardAction]
  ...
  type ForwardAction = typings.openui5.sapMSemanticSemanticButtonMod.default
  
  type ForwardActionSettings = SemanticButtonSettings
}
