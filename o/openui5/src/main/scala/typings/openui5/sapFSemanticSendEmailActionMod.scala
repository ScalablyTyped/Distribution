...
object sapFSemanticSendEmailActionMod {
  
  @JSImport("sap/f/semantic/SendEmailAction", JSImport.Default)
  @js.native
  /**
  ...
  type SendEmailAction = typings.openui5.sapFSemanticSemanticButtonMod.default
