...
object sapUiCoreHistoryMod {
  
  @JSImport("sap/ui/core/History", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, History]
  ...
  type History = typings.openui5.sapUiBaseObjectMod.default
}
