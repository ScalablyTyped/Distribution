...
object sapUiCommonsLayoutResponsiveFlowLayoutMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiLayoutResponsiveFlowLayoutMod.default {
    def this(/**
  ...
  type ResponsiveFlowLayout = typings.openui5.sapUiLayoutResponsiveFlowLayoutMod.default
  
  type ResponsiveFlowLayoutSettings = typings.openui5.sapUiLayoutResponsiveFlowLayoutMod.ResponsiveFlowLayoutSettings
}
