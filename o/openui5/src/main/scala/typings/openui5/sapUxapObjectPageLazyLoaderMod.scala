...
object sapUxapObjectPageLazyLoaderMod {
  
  @JSImport("sap/uxap/ObjectPageLazyLoader", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends ObjectPageLazyLoader {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: ObjectPageLazyLoaderSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ObjectPageLazyLoader]
  ...
  trait ObjectPageLazyLoaderSettings
    extends StObject
  ...
  object ObjectPageLazyLoaderSettings {
    
    inline def apply(): ObjectPageLazyLoaderSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ObjectPageLazyLoaderSettings]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ObjectPageLazyLoaderSettings] (val x: Self) extends AnyVal {
