...
object sapMSemanticFlagActionMod {
  
  @JSImport("sap/m/semantic/FlagAction", JSImport.Default)
  @js.native
  /**
  ...
  type FlagAction = typings.openui5.sapMSemanticSemanticToggleButtonMod.default
