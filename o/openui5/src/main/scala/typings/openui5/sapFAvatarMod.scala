...
object sapFAvatarMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapMAvatarMod.default {
    def this(/**
  ...
  type Avatar = typings.openui5.sapMAvatarMod.default
  
  type AvatarSettings = typings.openui5.sapMAvatarMod.AvatarSettings
}
