...
object sapUiCommonsFormResponsiveLayoutMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiLayoutFormResponsiveLayoutMod.default {
    def this(/**
  ...
  type ResponsiveLayout = typings.openui5.sapUiLayoutFormResponsiveLayoutMod.default
  
  type ResponsiveLayoutSettings = typings.openui5.sapUiLayoutFormResponsiveLayoutMod.ResponsiveLayoutSettings
}
