...
object sapMTimePickerInputsMod {
  
  @JSImport("sap/m/TimePickerInputs", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends TimePickerInputs {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: TimePickerInputsSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, TimePickerInputs]
  ...
  type TimePickerInputsSettings = ControlSettings
}
