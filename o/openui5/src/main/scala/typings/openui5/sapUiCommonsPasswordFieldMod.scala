...
object sapUiCommonsPasswordFieldMod {
  
  @JSImport("sap/ui/commons/PasswordField", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: PasswordFieldSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, PasswordField]
  ...
  type PasswordField = typings.openui5.sapUiCommonsTextFieldMod.default
  
  type PasswordFieldSettings = TextFieldSettings
}
