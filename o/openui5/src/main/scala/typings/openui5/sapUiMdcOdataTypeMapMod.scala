...
object sapUiMdcOdataTypeMapMod extends Shortcut {
  
  @JSImport("sap/ui/mdc/odata/TypeMap", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `sapUiMdcOdataTypeMapMod.foo` */
