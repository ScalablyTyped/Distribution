...
object sapFSemanticDiscussInJamActionMod {
  
  @JSImport("sap/f/semantic/DiscussInJamAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: DiscussInJamActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, DiscussInJamAction]
  ...
  type DiscussInJamAction = typings.openui5.sapFSemanticSemanticButtonMod.default
  
  type DiscussInJamActionSettings = SemanticButtonSettings
}
