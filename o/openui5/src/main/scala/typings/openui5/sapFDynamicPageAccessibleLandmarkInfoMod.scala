...
object sapFDynamicPageAccessibleLandmarkInfoMod {
  
  @JSImport("sap/f/DynamicPageAccessibleLandmarkInfo", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends DynamicPageAccessibleLandmarkInfo {
    def this(/**
      * Initial settings for the new element
      */
    mSettings: DynamicPageAccessibleLandmarkInfoSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, DynamicPageAccessibleLandmarkInfo]
  ...
  @js.native
  trait DynamicPageAccessibleLandmarkInfo
  ...
  trait DynamicPageAccessibleLandmarkInfoSettings
    extends StObject
  ...
  object DynamicPageAccessibleLandmarkInfoSettings {
    
    inline def apply(): DynamicPageAccessibleLandmarkInfoSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DynamicPageAccessibleLandmarkInfoSettings]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: DynamicPageAccessibleLandmarkInfoSettings] (val x: Self) extends AnyVal {
