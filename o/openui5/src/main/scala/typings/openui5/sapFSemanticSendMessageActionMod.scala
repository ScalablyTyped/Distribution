...
object sapFSemanticSendMessageActionMod {
  
  @JSImport("sap/f/semantic/SendMessageAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: SendMessageActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, SendMessageAction]
  ...
  type SendMessageAction = typings.openui5.sapFSemanticSemanticButtonMod.default
  
  type SendMessageActionSettings = SemanticButtonSettings
}
