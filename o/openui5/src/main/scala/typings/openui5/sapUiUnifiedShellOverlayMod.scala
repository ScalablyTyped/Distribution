...
object sapUiUnifiedShellOverlayMod {
  ...
  trait ShellOverlay$ClosedEventParameters extends StObject
  
  type ShellOverlayClosedEvent = typings.openui5.sapUiBaseEventMod.default[ShellOverlay$ClosedEventParameters]
  
  type ShellOverlayClosedEventParameters = ShellOverlay$ClosedEventParameters
