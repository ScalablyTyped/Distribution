...
object sapFSemanticCopyActionMod {
  
  @JSImport("sap/f/semantic/CopyAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: CopyActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, CopyAction]
  ...
  type CopyAction = typings.openui5.sapFSemanticSemanticButtonMod.default
  
  type CopyActionSettings = SemanticButtonSettings
}
