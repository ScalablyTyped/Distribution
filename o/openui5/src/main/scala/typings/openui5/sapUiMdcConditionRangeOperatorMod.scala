...
import typings.openui5.anon.CalcRange
...
object sapUiMdcConditionRangeOperatorMod {
  
  @JSImport("sap/ui/mdc/condition/RangeOperator", JSImport.Default)
  @js.native
  open class default protected ()
    extends typings.openui5.sapUiMdcConditionOperatorMod.default {
    def this(/**
      * Included all parameters of {@link sap.ui.mdc.condition.Operator Operator} and adds some special ones
      */
    oConfiguration: CalcRange) = this()
  }
  /* static members */
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, RangeOperator]
  ...
  type RangeOperator = typings.openui5.sapUiMdcConditionOperatorMod.default
}
