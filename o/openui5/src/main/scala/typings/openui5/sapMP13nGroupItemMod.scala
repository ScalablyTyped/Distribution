...
object sapMP13nGroupItemMod {
  
  @JSImport("sap/m/P13nGroupItem", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends P13nGroupItem {
    def this(/**
      * initial settings for the new control
      */
    mSettings: P13nGroupItemSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, P13nGroupItem]
  ...
  object P13nGroupItemSettings {
    
    inline def apply(): P13nGroupItemSettings = {
