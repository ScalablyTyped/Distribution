...
object sapMImageContentMod {
  
  @JSImport("sap/m/ImageContent", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends ImageContent {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: ImageContentSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ImageContent]
  ...
  object ImageContentSettings {
    
    inline def apply(): ImageContentSettings = {
