...
object sapUiCommonsLayoutResponsiveFlowLayoutDataMod {
  
  @JSImport("sap/ui/commons/layout/ResponsiveFlowLayoutData", JSImport.Default)
  @js.native
  /**
  ...
  trait ResponsiveFlowLayoutData
    extends typings.openui5.sapUiLayoutResponsiveFlowLayoutDataMod.default
  
  type ResponsiveFlowLayoutDataSettings = typings.openui5.sapUiLayoutResponsiveFlowLayoutDataMod.ResponsiveFlowLayoutDataSettings
}
