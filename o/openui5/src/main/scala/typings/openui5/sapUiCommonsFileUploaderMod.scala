...
object sapUiCommonsFileUploaderMod {
  
  @JSImport("sap/ui/commons/FileUploader", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiUnifiedFileUploaderMod.default {
    def this(/**
  ...
  type FileUploader = typings.openui5.sapUiUnifiedFileUploaderMod.default
  
  type FileUploaderSettings = typings.openui5.sapUiUnifiedFileUploaderMod.FileUploaderSettings
}
