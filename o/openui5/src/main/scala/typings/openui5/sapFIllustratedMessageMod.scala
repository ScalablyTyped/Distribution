...
object sapFIllustratedMessageMod {
  ...
  type IllustratedMessage = typings.openui5.sapMIllustratedMessageMod.default
  
  type IllustratedMessageSettings = typings.openui5.sapMIllustratedMessageMod.IllustratedMessageSettings
}
