...
object sapUiCommonsColorPickerMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiUnifiedColorPickerMod.default {
    def this(/**
  ...
  type ColorPicker = typings.openui5.sapUiUnifiedColorPickerMod.default
  
  type ColorPickerSettings = typings.openui5.sapUiUnifiedColorPickerMod.ColorPickerSettings
}
