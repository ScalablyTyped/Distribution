...
object sapMSemanticFilterActionMod {
  
  @JSImport("sap/m/semantic/FilterAction", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends FilterAction {
    def this(/**
      ...
      */
    mSettings: FilterActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, FilterAction]
  ...
  type FilterActionSettings = SemanticButtonSettings
}
