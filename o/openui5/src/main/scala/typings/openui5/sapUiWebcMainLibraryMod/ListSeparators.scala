...
object ListSeparators extends StObject {
  ...
  sealed trait All
    extends StObject
       with ListSeparators
  /* "All" */ val All: typings.openui5.sapUiWebcMainLibraryMod.ListSeparators.All & String = js.native
  ...
  sealed trait Inner
    extends StObject
       with ListSeparators
  /* "Inner" */ val Inner: typings.openui5.sapUiWebcMainLibraryMod.ListSeparators.Inner & String = js.native
  ...
  sealed trait None
    extends StObject
       with ListSeparators
  /* "None" */ val None: typings.openui5.sapUiWebcMainLibraryMod.ListSeparators.None & String = js.native
}
