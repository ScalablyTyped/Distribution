...
@JSImport("sap/ui/webc/main/library", "PanelAccessibleRole")
@js.native
object PanelAccessibleRole extends StObject {
  ...
  /* "Complementary" */ val Complementary: typings.openui5.sapUiWebcMainLibraryMod.PanelAccessibleRole.Complementary & String = js.native
  ...
  sealed trait Form
    extends StObject
       with PanelAccessibleRole
  /* "Form" */ val Form: typings.openui5.sapUiWebcMainLibraryMod.PanelAccessibleRole.Form & String = js.native
  ...
  sealed trait Region
    extends StObject
       with PanelAccessibleRole
  /* "Region" */ val Region: typings.openui5.sapUiWebcMainLibraryMod.PanelAccessibleRole.Region & String = js.native
}
