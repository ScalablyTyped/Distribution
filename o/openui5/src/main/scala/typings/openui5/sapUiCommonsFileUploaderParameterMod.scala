...
object sapUiCommonsFileUploaderParameterMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiUnifiedFileUploaderParameterMod.default {
    def this(/**
  ...
  type FileUploaderParameter = typings.openui5.sapUiUnifiedFileUploaderParameterMod.default
  
  type FileUploaderParameterSettings = typings.openui5.sapUiUnifiedFileUploaderParameterMod.FileUploaderParameterSettings
}
