...
object sapUiCommonsMenuMod {
  
  @JSImport("sap/ui/commons/Menu", JSImport.Default)
  @js.native
  /**
  ...
  type Menu = typings.openui5.sapUiUnifiedMenuMod.default
  
  type MenuSettings = typings.openui5.sapUiUnifiedMenuMod.MenuSettings
}
