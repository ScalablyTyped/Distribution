...
object sapUiCommonsLayoutVerticalLayoutMod {
  
  @JSImport("sap/ui/commons/layout/VerticalLayout", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiLayoutVerticalLayoutMod.default {
    def this(/**
  ...
  type VerticalLayout = typings.openui5.sapUiLayoutVerticalLayoutMod.default
  
  type VerticalLayoutSettings = typings.openui5.sapUiLayoutVerticalLayoutMod.VerticalLayoutSettings
}
