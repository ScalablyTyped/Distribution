...
object sapUiCoreUtilExportCellMod {
  
  @JSImport("sap/ui/core/util/ExportCell", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends ExportCell {
    def this(/**
      * initial settings for the new control
      */
    mSettings: ExportCellSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ExportCell]
  ...
  object ExportCellSettings {
    
    inline def apply(): ExportCellSettings = {
