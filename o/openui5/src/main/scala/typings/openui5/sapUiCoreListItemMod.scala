...
object sapUiCoreListItemMod {
  
  @JSImport("sap/ui/core/ListItem", JSImport.Default)
  @js.native
  /**
  ...
  open class default () extends ListItem {
    def this(/**
      ...
      */
    mSettings: ListItemSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ListItem]
  ...
  object ListItemSettings {
    
    inline def apply(): ListItemSettings = {
