...
import typings.openui5.sapUiCoreSearchOpenSearchProviderMod.OpenSearchProviderSettings
...
object sapUiCommonsSearchProviderMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typings.openui5.sapUiCoreSearchOpenSearchProviderMod.default {
    def this(/**
  ...
  type SearchProvider = typings.openui5.sapUiCoreSearchOpenSearchProviderMod.default
