...
object sapUiFlWriteInternalFieldExtensibilitySingleTenantABAPExtensibilityVariantMod extends Shortcut {
  
  @JSImport("sap/ui/fl/write/_internal/fieldExtensibility/SingleTenantABAPExtensibilityVariant", JSImport.Default)
  @js.native
  val default: SingleTenantABAPExtensibilityVariant = js.native
  ...
  /**
    ...
    */
  @js.native
  trait SingleTenantABAPExtensibilityVariant extends StObject {
  ...
  type _To = SingleTenantABAPExtensibilityVariant
  
  /* This means you don't have to write `default`, but can instead just say `sapUiFlWriteInternalFieldExtensibilitySingleTenantABAPExtensibilityVariantMod.foo` */
  override def _to: SingleTenantABAPExtensibilityVariant = default
}
