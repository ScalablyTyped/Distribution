...
object sapMNewsContentMod {
  ...
  trait NewsContent$PressEventParameters extends StObject
  
  type NewsContentPressEvent = typings.openui5.sapUiBaseEventMod.default[NewsContent$PressEventParameters]
  
  type NewsContentPressEventParameters = NewsContent$PressEventParameters
