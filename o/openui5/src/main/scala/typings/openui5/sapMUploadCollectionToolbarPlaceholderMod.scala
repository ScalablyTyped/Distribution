...
object sapMUploadCollectionToolbarPlaceholderMod {
  
  @JSImport("sap/m/UploadCollectionToolbarPlaceholder", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: UploadCollectionToolbarPlaceholderSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, UploadCollectionToolbarPlaceholder]
  ...
  type UploadCollectionToolbarPlaceholder = typings.openui5.sapUiCoreControlMod.default
  
  type UploadCollectionToolbarPlaceholderSettings = ControlSettings
}
