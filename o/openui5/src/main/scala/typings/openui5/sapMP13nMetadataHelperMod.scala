...
object sapMP13nMetadataHelperMod {
  
  @JSImport("sap/m/p13n/MetadataHelper", JSImport.Default)
  @js.native
  /**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, MetadataHelper]
  ...
  type MetadataHelper = typings.openui5.sapUiBaseObjectMod.default
}
