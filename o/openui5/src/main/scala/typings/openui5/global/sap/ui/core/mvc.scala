...
object mvc {
  ...
  class Controller protected ()
    extends StObject
       with typings.openui5.sap.ui.core.mvc.Controller {
    /**
    ...
    def this(sName: js.Array[js.Any]) = this()
  }
  ...
  class HTMLView protected ()
    extends StObject
       with typings.openui5.sap.ui.core.mvc.HTMLView {
    /**
  ...
  class JSONView protected ()
    extends StObject
       with typings.openui5.sap.ui.core.mvc.JSONView {
    /**
  ...
  class JSView protected ()
    extends StObject
       with typings.openui5.sap.ui.core.mvc.JSView {
    /**
  ...
  class TemplateView protected ()
    extends StObject
       with typings.openui5.sap.ui.core.mvc.TemplateView {
    /**
  ...
  class View protected ()
    extends StObject
       with typings.openui5.sap.ui.core.mvc.View {
    /**
  ...
  object View {
    ...
    object mvc {
      ...
      object ViewType extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typings.openui5.sap.ui.core.mvc.View.mvc.ViewType & Double] = js.native
        
        /* 0 */ val HTML: typings.openui5.sap.ui.core.mvc.View.mvc.ViewType.HTML & Double = js.native
        
        /* 1 */ val JS: typings.openui5.sap.ui.core.mvc.View.mvc.ViewType.JS & Double = js.native
        
        /* 2 */ val JSON: typings.openui5.sap.ui.core.mvc.View.mvc.ViewType.JSON & Double = js.native
        
        /* 3 */ val Template: typings.openui5.sap.ui.core.mvc.View.mvc.ViewType.Template & Double = js.native
        
        /* 4 */ val XML: typings.openui5.sap.ui.core.mvc.View.mvc.ViewType.XML & Double = js.native
      }
    }
  }
  ...
  class XMLView ()
    extends StObject
       with typings.openui5.sap.ui.core.mvc.XMLView {
  ...
  object XMLView {
    ...
    object PreprocessorType extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.openui5.sap.ui.core.mvc.XMLView.PreprocessorType & Double] = js.native
      
      /* 0 */ val CONTROLS: typings.openui5.sap.ui.core.mvc.XMLView.PreprocessorType.CONTROLS & Double = js.native
      
      /* 1 */ val VIEWXML: typings.openui5.sap.ui.core.mvc.XMLView.PreprocessorType.VIEWXML & Double = js.native
      
      /* 2 */ val XML: typings.openui5.sap.ui.core.mvc.XMLView.PreprocessorType.XML & Double = js.native
    }
  }
}
