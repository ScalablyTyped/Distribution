...
package object ui {
  ...
  @scala.inline
  def component(vConfig: java.lang.String): typings.openui5.sap.ui.core.Component | typings.jquery.JQueryPromise[_] = typings.openui5.global.sap.ui.^.asInstanceOf[js.Dynamic].applyDynamic("component")(vConfig.asInstanceOf[js.Any]).asInstanceOf[typings.openui5.sap.ui.core.Component | typings.jquery.JQueryPromise[_]]
  @scala.inline
  def component(vConfig: js.Any): typings.openui5.sap.ui.core.Component | typings.jquery.JQueryPromise[_] = typings.openui5.global.sap.ui.^.asInstanceOf[js.Dynamic].applyDynamic("component")(vConfig.asInstanceOf[js.Any]).asInstanceOf[typings.openui5.sap.ui.core.Component | typings.jquery.JQueryPromise[_]]
  @scala.inline
  ...
  /**
    ...
    */
  @scala.inline
  def getVersionInfo(mOptions: java.lang.String): js.Any | typings.jquery.JQueryPromise[_] = typings.openui5.global.sap.ui.^.asInstanceOf[js.Dynamic].applyDynamic("getVersionInfo")(mOptions.asInstanceOf[js.Any]).asInstanceOf[js.Any | typings.jquery.JQueryPromise[_]]
  @scala.inline
  def getVersionInfo(mOptions: js.Any): js.Any | typings.jquery.JQueryPromise[_] = typings.openui5.global.sap.ui.^.asInstanceOf[js.Dynamic].applyDynamic("getVersionInfo")(mOptions.asInstanceOf[js.Any]).asInstanceOf[js.Any | typings.jquery.JQueryPromise[_]]
  ...
  @scala.inline
  def lazyRequire(sClassName: java.lang.String, sMethods: js.UndefOr[scala.Nothing], sModuleName: java.lang.String): scala.Unit = (typings.openui5.global.sap.ui.^.asInstanceOf[js.Dynamic].applyDynamic("lazyRequire")(sClassName.asInstanceOf[js.Any], sMethods.asInstanceOf[js.Any], sModuleName.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  ...
  /**
    ...
    */
  @scala.inline
  def template(oTemplate: java.lang.String): js.Any | js.Array[_] = typings.openui5.global.sap.ui.^.asInstanceOf[js.Dynamic].applyDynamic("template")(oTemplate.asInstanceOf[js.Any]).asInstanceOf[js.Any | js.Array[_]]
  @scala.inline
  ...
  @scala.inline
  def template_Union(oTemplate: js.Any): js.Any | js.Array[_] = typings.openui5.global.sap.ui.^.asInstanceOf[js.Dynamic].applyDynamic("template")(oTemplate.asInstanceOf[js.Any]).asInstanceOf[js.Any | js.Array[_]]
