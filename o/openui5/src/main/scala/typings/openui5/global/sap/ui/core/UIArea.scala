...
class UIArea protected ()
  extends typings.openui5.sap.ui.core.UIArea {
  /**
    ...
    */
  def this(oCore: typings.openui5.sap.ui.core.Core) = this()
  def this(oCore: typings.openui5.sap.ui.core.Core, oRootNode: js.Any) = this()
}
