...
/**
  ...
  */
inline def FormatException(): scala.Unit = typings.openui5.global.sap.ui.model.^.asInstanceOf[js.Dynamic].applyDynamic("FormatException")().asInstanceOf[scala.Unit]
...
/**
  ...
  */
inline def ParseException(): scala.Unit = typings.openui5.global.sap.ui.model.^.asInstanceOf[js.Dynamic].applyDynamic("ParseException")().asInstanceOf[scala.Unit]
...
/**
  ...
  */
inline def ValidateException(): scala.Unit = typings.openui5.global.sap.ui.model.^.asInstanceOf[js.Dynamic].applyDynamic("ValidateException")().asInstanceOf[scala.Unit]
