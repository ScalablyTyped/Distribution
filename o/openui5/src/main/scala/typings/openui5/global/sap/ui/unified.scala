...
object unified {
  ...
  @js.native
  class CalendarAppointment protected ()
    extends typings.openui5.sap.ui.unified.CalendarAppointment {
    /**
  ...
  @js.native
  class CalendarDateInterval protected ()
    extends typings.openui5.sap.ui.unified.CalendarDateInterval {
    /**
  ...
  object CalendarDayType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.openui5.sap.ui.unified.CalendarDayType with Double] = js.native
    
    /* 0 */ val None: typings.openui5.sap.ui.unified.CalendarDayType.None with Double = js.native
    
    /* 1 */ val Type01: typings.openui5.sap.ui.unified.CalendarDayType.Type01 with Double = js.native
    
    /* 2 */ val Type02: typings.openui5.sap.ui.unified.CalendarDayType.Type02 with Double = js.native
    
    /* 3 */ val Type03: typings.openui5.sap.ui.unified.CalendarDayType.Type03 with Double = js.native
    
    /* 4 */ val Type04: typings.openui5.sap.ui.unified.CalendarDayType.Type04 with Double = js.native
    
    /* 5 */ val Type05: typings.openui5.sap.ui.unified.CalendarDayType.Type05 with Double = js.native
    
    /* 6 */ val Type06: typings.openui5.sap.ui.unified.CalendarDayType.Type06 with Double = js.native
    
    /* 7 */ val Type07: typings.openui5.sap.ui.unified.CalendarDayType.Type07 with Double = js.native
    
    /* 8 */ val Type08: typings.openui5.sap.ui.unified.CalendarDayType.Type08 with Double = js.native
    
    /* 9 */ val Type09: typings.openui5.sap.ui.unified.CalendarDayType.Type09 with Double = js.native
    
    /* 10 */ val Type10: typings.openui5.sap.ui.unified.CalendarDayType.Type10 with Double = js.native
  }
  ...
  object CalendarIntervalType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.openui5.sap.ui.unified.CalendarIntervalType with Double] = js.native
  ...
  @JSGlobal("sap.ui.unified.CalendarLegend")
  @js.native
  class CalendarLegend protected ()
    extends typings.openui5.sap.ui.unified.CalendarLegend {
    /**
  ...
  @js.native
  class CalendarLegendItem protected ()
    extends typings.openui5.sap.ui.unified.CalendarLegendItem {
    /**
  ...
  @js.native
  class CalendarMonthInterval protected ()
    extends typings.openui5.sap.ui.unified.CalendarMonthInterval {
    /**
  ...
  class CalendarRow protected ()
    extends typings.openui5.sap.ui.unified.CalendarRow {
    /**
  ...
  class CalendarTimeInterval protected ()
    extends typings.openui5.sap.ui.unified.CalendarTimeInterval {
    /**
  ...
  @js.native
  class Calendar_ protected ()
    extends typings.openui5.sap.ui.unified.Calendar_ {
    /**
  ...
  class ContentSwitcher protected ()
    extends typings.openui5.sap.ui.unified.ContentSwitcher {
    /**
  ...
  object ContentSwitcherAnimation extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.openui5.sap.ui.unified.ContentSwitcherAnimation with Double] = js.native
    
    /* 0 */ val Fade: typings.openui5.sap.ui.unified.ContentSwitcherAnimation.Fade with Double = js.native
    
    /* 1 */ val None: typings.openui5.sap.ui.unified.ContentSwitcherAnimation.None with Double = js.native
    
    /* 2 */ val Rotate: typings.openui5.sap.ui.unified.ContentSwitcherAnimation.Rotate with Double = js.native
    
    /* 3 */ val SlideOver: typings.openui5.sap.ui.unified.ContentSwitcherAnimation.SlideOver with Double = js.native
    
    /* 4 */ val SlideRight: typings.openui5.sap.ui.unified.ContentSwitcherAnimation.SlideRight with Double = js.native
    
    /* 5 */ val ZoomIn: typings.openui5.sap.ui.unified.ContentSwitcherAnimation.ZoomIn with Double = js.native
    
    /* 6 */ val ZoomOut: typings.openui5.sap.ui.unified.ContentSwitcherAnimation.ZoomOut with Double = js.native
  }
  
  @JSGlobal("sap.ui.unified.Currency")
  @js.native
  class Currency protected ()
    extends typings.openui5.sap.ui.unified.Currency {
    /**
  ...
  class DateRange protected ()
    extends typings.openui5.sap.ui.unified.DateRange {
    /**
  ...
  @js.native
  class DateTypeRange protected ()
    extends typings.openui5.sap.ui.unified.DateTypeRange {
    /**
  ...
  /**
    ...
    */
  class FileUploader ()
    extends typings.openui5.sap.ui.unified.FileUploader {
  ...
  class FileUploaderParameter ()
    extends typings.openui5.sap.ui.unified.FileUploaderParameter {
    def this(mSettings: js.Any) = this()
    /**
      * Constructor for a new FileUploaderParameter.Accepts an object literal <code>mSettings</code> that
      * defines initialproperty values, aggregated and associated objects as well as event handlers.See
  ...
  class Menu protected ()
    extends typings.openui5.sap.ui.unified.Menu {
    /**
  ...
  class MenuItem protected ()
    extends typings.openui5.sap.ui.unified.MenuItem {
    /**
  ...
  abstract class MenuItemBase protected ()
    extends typings.openui5.sap.ui.unified.MenuItemBase {
    /**
  ...
  @js.native
  class MenuTextFieldItem protected ()
    extends typings.openui5.sap.ui.unified.MenuTextFieldItem {
    /**
  ...
  class Shell protected ()
    extends typings.openui5.sap.ui.unified.Shell {
    /**
  ...
  class ShellHeadItem protected ()
    extends typings.openui5.sap.ui.unified.ShellHeadItem {
    /**
  ...
  class ShellHeadUserItem protected ()
    extends typings.openui5.sap.ui.unified.ShellHeadUserItem {
    /**
  ...
  class ShellLayout protected ()
    extends typings.openui5.sap.ui.unified.ShellLayout {
    /**
  ...
  class ShellOverlay protected ()
    extends typings.openui5.sap.ui.unified.ShellOverlay {
    /**
  ...
  class SplitContainer protected ()
    extends typings.openui5.sap.ui.unified.SplitContainer {
    /**
  ...
  object calendar {
    ...
    @JSGlobal("sap.ui.unified.calendar.Header")
    @js.native
    class Header protected ()
      extends typings.openui5.sap.ui.unified.calendar.Header {
      /**
    ...
    class Month protected ()
      extends typings.openui5.sap.ui.unified.calendar.Month {
      /**
    ...
    class MonthPicker protected ()
      extends typings.openui5.sap.ui.unified.calendar.MonthPicker {
      /**
    ...
    class MonthsRow protected ()
      extends typings.openui5.sap.ui.unified.calendar.MonthsRow {
      /**
    ...
    class TimesRow protected ()
      extends typings.openui5.sap.ui.unified.calendar.TimesRow {
      /**
    ...
    class YearPicker protected ()
      extends typings.openui5.sap.ui.unified.calendar.YearPicker {
      /**
