...
object sapMUploadUploadSetToolbarPlaceholderMod {
  
  @JSImport("sap/m/upload/UploadSetToolbarPlaceholder", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: UploadSetToolbarPlaceholderSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, UploadSetToolbarPlaceholder]
  ...
  type UploadSetToolbarPlaceholder = typings.openui5.sapUiCoreControlMod.default
  
  type UploadSetToolbarPlaceholderSettings = ControlSettings
}
