...
trait ManagedObject$ValidationSuccessEventParameters extends StObject {
...
object ManagedObject$ValidationSuccessEventParameters {
  
  inline def apply(): ManagedObject$ValidationSuccessEventParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ManagedObject$ValidationSuccessEventParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ManagedObject$ValidationSuccessEventParameters] (val x: Self) extends AnyVal {
