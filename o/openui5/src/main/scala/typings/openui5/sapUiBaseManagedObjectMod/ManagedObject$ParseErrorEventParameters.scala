...
trait ManagedObject$ParseErrorEventParameters extends StObject {
...
object ManagedObject$ParseErrorEventParameters {
  
  inline def apply(): ManagedObject$ParseErrorEventParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ManagedObject$ParseErrorEventParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ManagedObject$ParseErrorEventParameters] (val x: Self) extends AnyVal {
