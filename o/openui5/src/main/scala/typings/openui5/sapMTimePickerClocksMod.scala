...
object sapMTimePickerClocksMod {
  
  @JSImport("sap/m/TimePickerClocks", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends TimePickerClocks {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: TimePickerClocksSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, TimePickerClocks]
  ...
  trait TimePickerClocks
    ...
    /**
      ...
      * @returns Pointer to the control instance to allow method chaining
      */
    def showFirstClock(): this.type = js.native
  }
  
  type TimePickerClocksSettings = ControlSettings
}
