...
object sapMSemanticSaveActionMod {
  
  @JSImport("sap/m/semantic/SaveAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: SaveActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, SaveAction]
  ...
  type SaveAction = typings.openui5.sapMSemanticSemanticButtonMod.default
  
  type SaveActionSettings = SemanticButtonSettings
}
