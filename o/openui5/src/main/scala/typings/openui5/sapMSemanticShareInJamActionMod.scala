...
object sapMSemanticShareInJamActionMod {
  
  @JSImport("sap/m/semantic/ShareInJamAction", JSImport.Default)
  @js.native
  /**
  ...
  type ShareInJamAction = typings.openui5.sapMSemanticSemanticButtonMod.default
