...
object sapFSemanticMessagesIndicatorMod {
  
  @JSImport("sap/f/semantic/MessagesIndicator", JSImport.Default)
  @js.native
  /**
  ...
  type MessagesIndicator = typings.openui5.sapFSemanticSemanticButtonMod.default
