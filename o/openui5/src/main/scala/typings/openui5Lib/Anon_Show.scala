...
trait Anon_Show extends js.Object {
  /**
    ...
    */
  def attachClose(fnFunction: js.Any): /* import warning: ImportType.apply Failed type conversion: typeof openui5.sap.ui.core.BusyIndicator */ js.Any = js.native
  def attachClose(fnFunction: js.Any, oListener: js.Any): /* import warning: ImportType.apply Failed type conversion: typeof openui5.sap.ui.core.BusyIndicator */ js.Any = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def attachOpen(fnFunction: js.Any): /* import warning: ImportType.apply Failed type conversion: typeof openui5.sap.ui.core.BusyIndicator */ js.Any = js.native
  def attachOpen(fnFunction: js.Any, oListener: js.Any): /* import warning: ImportType.apply Failed type conversion: typeof openui5.sap.ui.core.BusyIndicator */ js.Any = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def detachClose(fnFunction: js.Any, oListener: js.Any): /* import warning: ImportType.apply Failed type conversion: typeof openui5.sap.ui.core.BusyIndicator */ js.Any = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def detachOpen(fnFunction: js.Any, oListener: js.Any): /* import warning: ImportType.apply Failed type conversion: typeof openui5.sap.ui.core.BusyIndicator */ js.Any = js.native
  /**
