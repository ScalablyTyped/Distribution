...
class Button ()
  ...
  def addAriaDescribedBy(vAriaDescribedBy: openui5Lib.sapNs.uiNs.coreNs.Control): Button = js.native
  /**
  ...
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): Button = js.native
  /**
  ...
  /**
    ...
    */
  def getIconFirst(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setEnabled(bEnabled: scala.Boolean): Button = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setIconDensityAware(bIconDensityAware: scala.Boolean): Button = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setIconFirst(bIconFirst: scala.Boolean): Button = js.native
  /**
    * Property setter for the text
    * @param sText new value of the Text attribute
    * @returns this to allow method chaining
    */
  def setText(sText: java.lang.String): Button = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTextDirection(sTextDirection: openui5Lib.sapNs.uiNs.coreNs.TextDirection): Button = js.native
  /**
