...
abstract class Template protected ()
  ...
  /**
            ...
            */
  def byId(sId: java.lang.String): js.Any = js.native
  /**
            ...
            */
  def createControl(sId: java.lang.String, oContext: js.Any, oView: openui5Lib.sapNs.uiNs.coreNs.mvcNs.View): TemplateControl = js.native
  /**
            ...
            */
  def declareControl(sControl: java.lang.String): js.Any = js.native
  /**
  ...
  /**
            ...
            */
  def parsePath(sPath: java.lang.String): js.Any = js.native
  /**
             ...
             * @returns the created control instance
            */
  def placeAt(oRef: java.lang.String, oContext: js.Any, vPosition: java.lang.String, bInline: scala.Boolean): TemplateControl = js.native
  /**
             * Creates an anonymous TemplateControl for the Template and places the controlinto the specified DOM
             * element.
             * @param oRef the id or the DOM reference where to render the template
             ...
             * @returns the created control instance
            */
  def placeAt(oRef: java.lang.String, oContext: js.Any, vPosition: scala.Double, bInline: scala.Boolean): TemplateControl = js.native
  /**
             * Creates an anonymous TemplateControl for the Template and places the controlinto the specified DOM
             * element.
             * @param oRef the id or the DOM reference where to render the template
             ...
             * @returns the created control instance
            */
  def placeAt(oRef: js.Any, oContext: js.Any, vPosition: java.lang.String, bInline: scala.Boolean): TemplateControl = js.native
  /**
             * Creates an anonymous TemplateControl for the Template and places the controlinto the specified DOM
             * element.
             * @param oRef the id or the DOM reference where to render the template
             ...
             * @returns the created control instance
            */
  def placeAt(oRef: js.Any, oContext: js.Any, vPosition: scala.Double, bInline: scala.Boolean): TemplateControl = js.native
  /**
            ...
            */
  def setContent(sContent: java.lang.String): js.Any = js.native
}
