...
class AnalyticalBinding ()
  ...
  def filter(aFilter: openui5Lib.sapNs.uiNs.modelNs.Filter, sFilterType: openui5Lib.TypeofFilterType): AnalyticalBinding = js.native
  /**
  ...
  /**
    ...
    */
  def getAnalyticalQueryResult(): openui5Lib.sapNs.uiNs.modelNs.analyticsNs.odata4analyticsNs.QueryResult = js.native
  /**
  ...
  /**
    ...
    */
  def getGroupName(oContext: openui5Lib.sapNs.uiNs.modelNs.Context, iLevel: scala.Double): java.lang.String = js.native
  /**
    ...
    */
  def getGroupSize(oContext: openui5Lib.sapNs.uiNs.modelNs.Context, iLevel: scala.Double): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getPropertyHeading(sPropertyName: java.lang.String): java.lang.String = js.native
  /**
    * Gets the label of a property with a given name.
    * @param sPropertyName The property name.
    * @returns The label maintained for this property or null if it does not exist.
    */
  def getPropertyLabel(sPropertyName: java.lang.String): java.lang.String = js.native
  /**
    ...
    */
  def getPropertyQuickInfo(sPropertyName: java.lang.String): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getTotalSize(): scala.Double = js.native
  /**
    ...
    */
  def hasAvailableNodeContexts(oContext: openui5Lib.sapNs.uiNs.modelNs.Context, iLevel: scala.Double): scala.Boolean = js.native
  /**
    ...
    */
  def hasMeasures(): scala.Boolean = js.native
  /**
    ...
    */
  def isMeasure(sPropertyName: java.lang.String): scala.Boolean = js.native
  /**
    ...
    */
  def loadGroups(mGroupIdRanges: js.Any): scala.Unit = js.native
  /**
    ...
    * measure properties.
    */
  def providesGrandTotal(): scala.Boolean = js.native
  /**
    ...
    * to right.
    */
  def updateAnalyticalInfo(aColumns: js.Array[_]): scala.Unit = js.native
}
