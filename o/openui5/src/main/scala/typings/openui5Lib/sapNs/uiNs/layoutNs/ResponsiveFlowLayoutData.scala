...
class ResponsiveFlowLayoutData protected ()
  ...
  /**
    ...
    */
  def getLinebreakable(): scala.Boolean = js.native
  /**
    ...
    */
  def getMargin(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def setLinebreak(bLinebreak: scala.Boolean): ResponsiveFlowLayoutData = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setLinebreakable(bLinebreakable: scala.Boolean): ResponsiveFlowLayoutData = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setMargin(bMargin: scala.Boolean): ResponsiveFlowLayoutData = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setMinWidth(iMinWidth: scala.Double): ResponsiveFlowLayoutData = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setWeight(iWeight: scala.Double): ResponsiveFlowLayoutData = js.native
}
