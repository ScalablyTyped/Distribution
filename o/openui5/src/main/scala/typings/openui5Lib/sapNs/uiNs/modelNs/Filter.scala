...
class Filter protected ()
  ...
  def this(vFilterInfo: java.lang.String, vOperator: openui5Lib.TypeofFilterOperator) = this()
  def this(vFilterInfo: java.lang.String, vOperator: scala.Boolean) = this()
  def this(vFilterInfo: js.Any, vOperator: js.Any) = this()
  def this(vFilterInfo: js.Any, vOperator: openui5Lib.TypeofFilterOperator) = this()
  def this(vFilterInfo: js.Any, vOperator: scala.Boolean) = this()
  def this(vFilterInfo: js.Array[Filter], vOperator: js.Any) = this()
  def this(vFilterInfo: js.Array[Filter], vOperator: openui5Lib.TypeofFilterOperator) = this()
  ...
  def this(vFilterInfo: java.lang.String, vOperator: openui5Lib.TypeofFilterOperator, oValue1: js.Any) = this()
  ...
  def this(vFilterInfo: js.Any, vOperator: openui5Lib.TypeofFilterOperator, oValue1: js.Any) = this()
  ...
  def this(vFilterInfo: js.Array[Filter], vOperator: openui5Lib.TypeofFilterOperator, oValue1: js.Any) = this()
  ...
  def this(vFilterInfo: java.lang.String, vOperator: openui5Lib.TypeofFilterOperator, oValue1: js.Any, oValue2: js.Any) = this()
  ...
  def this(vFilterInfo: js.Any, vOperator: openui5Lib.TypeofFilterOperator, oValue1: js.Any, oValue2: js.Any) = this()
  ...
  def this(vFilterInfo: js.Array[Filter], vOperator: openui5Lib.TypeofFilterOperator, oValue1: js.Any, oValue2: js.Any) = this()
