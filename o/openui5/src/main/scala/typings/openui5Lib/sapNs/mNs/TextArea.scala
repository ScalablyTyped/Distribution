...
class TextArea protected () extends InputBase {
  ...
  /**
    ...
    */
  def getCols(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getGrowingMaxLines(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getRows(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getWrapping(): openui5Lib.sapNs.uiNs.coreNs.Wrapping = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setCols(iCols: scala.Double): TextArea = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setGrowing(bGrowing: scala.Boolean): TextArea = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setGrowingMaxLines(iGrowingMaxLines: scala.Double): TextArea = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setMaxLength(iMaxLength: scala.Double): TextArea = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setRows(iRows: scala.Double): TextArea = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setValueLiveUpdate(bValueLiveUpdate: scala.Boolean): TextArea = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setWrapping(sWrapping: openui5Lib.sapNs.uiNs.coreNs.Wrapping): TextArea = js.native
}
