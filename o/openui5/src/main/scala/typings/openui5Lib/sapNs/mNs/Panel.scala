...
class Panel protected ()
  ...
  /**
    ...
    */
  def addContent(oContent: openui5Lib.sapNs.uiNs.coreNs.Control): Panel = js.native
  /**
  ...
  /**
    ...
    */
  def getExpandAnimation(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertContent(oContent: openui5Lib.sapNs.uiNs.coreNs.Control, iIndex: scala.Double): Panel = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setExpandAnimation(bExpandAnimation: scala.Boolean): Panel = js.native
  /**
    ...
    */
  def setExpandable(bExpandable: scala.Boolean): Panel = js.native
  /**
    * Sets the expanded property of the control.
    * @param bExpanded Defines whether control is expanded or not.
    * @returns Pointer to the control instance to allow method chaining.
    */
  def setExpanded(bExpanded: scala.Boolean): Panel = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setHeaderText(sHeaderText: java.lang.String): Panel = js.native
  /**
