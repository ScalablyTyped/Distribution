...
class WizardStep protected ()
  ...
  /**
    ...
    */
  def addContent(oContent: openui5Lib.sapNs.uiNs.coreNs.Control): WizardStep = js.native
  /**
  ...
  /**
    ...
    */
  def getValidated(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertContent(oContent: openui5Lib.sapNs.uiNs.coreNs.Control, iIndex: scala.Double): WizardStep = js.native
  /**
  ...
  /**
    ...
    */
  def removeSubsequentStep(vSubsequentStep: scala.Double): js.Any = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTitle(sTitle: java.lang.String): WizardStep = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setValidated(bValidated: scala.Boolean): WizardStep = js.native
}
