...
@js.native
object ODataUtilsNs extends js.Object {
  /**
             ...
             * cannot be compared
            */
  def compare(vValue1: js.Any, vValue2: js.Any): scala.Double = js.native
  /**
             * Compares the given OData values based on their type. All date and time types can also becompared
             * with a number. This number is then interpreted as the number of milliseconds thatthe corresponding
             * date or time object should hold.
             ...
             * cannot be compared
            */
  def compare(vValue1: js.Any, vValue2: js.Any, bAsDecimal: java.lang.String): scala.Double = js.native
  /**
            ...
            */
  def formatValue(vValue: js.Any, sType: java.lang.String): java.lang.String = js.native
  /**
            ...
            */
  def getComparator(sEdmType: java.lang.String): js.Any = js.native
  /**
            ...
            */
  def setOrigin(sServiceURL: java.lang.String, vParameters: java.lang.String): java.lang.String = js.native
  /**
             * Adds an origin to the given service URL.If an origin is already present, it will only be replaced if
             * the parameters object contains the flag "force: true".In case the URL already contains URL
             * parameters, these will be kept.As a parameter, a sole alias is sufficient. The parameters
             ...
             * @returns the service URL with the added origin.
            */
  def setOrigin(sServiceURL: java.lang.String, vParameters: js.Any): java.lang.String = js.native
}
