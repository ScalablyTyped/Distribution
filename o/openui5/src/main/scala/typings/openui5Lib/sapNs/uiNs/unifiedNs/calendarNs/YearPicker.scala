...
class YearPicker protected ()
  ...
  /**
    ...
    */
  def getYears(): scala.Double = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setColumns(iColumns: scala.Double): YearPicker = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setPrimaryCalendarType(sPrimaryCalendarType: openui5Lib.sapNs.uiNs.coreNs.CalendarType): YearPicker = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setYear(iYear: scala.Double): YearPicker = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setYears(iYears: scala.Double): YearPicker = js.native
}
