...
object themingNs extends js.Object {
  ...
  object ParametersNs extends js.Object {
    /**
               ...
               * @returns Scope names
              */
    def _getScopes(bAvoidLoading: scala.Boolean): js.Array[_] = js.native
    /**
              ...
              */
    def get(vName: java.lang.String): java.lang.String | js.Any = js.native
    /**
               * Returns the current value for one or more theming parameters, depending on the given
               * arguments.<ul><li>If no parameter is given a key-value map containing all parameters is
               * returned</li><li>If a <code>string</code> is given as first parameter the value is returned as a
               ...
               * @returns the CSS parameter value(s)
              */
    def get(vName: java.lang.String, oElement: openui5Lib.sapNs.uiNs.coreNs.Element): java.lang.String | js.Any = js.native
    /**
               * Returns the current value for one or more theming parameters, depending on the given
               * arguments.<ul><li>If no parameter is given a key-value map containing all parameters is
               * returned</li><li>If a <code>string</code> is given as first parameter the value is returned as a
               ...
               * @returns the CSS parameter value(s)
              */
    def get(vName: js.Array[java.lang.String]): java.lang.String | js.Any = js.native
    /**
               * Returns the current value for one or more theming parameters, depending on the given
               * arguments.<ul><li>If no parameter is given a key-value map containing all parameters is
               * returned</li><li>If a <code>string</code> is given as first parameter the value is returned as a
               ...
               * @returns the CSS parameter value(s)
              */
    def get(vName: js.Array[java.lang.String], oElement: openui5Lib.sapNs.uiNs.coreNs.Element): java.lang.String | js.Any = js.native
    /**
              ...
              */
    def getActiveScopesFor(oElement: js.Any): js.Array[js.Array[java.lang.String]] = js.native
    /**
