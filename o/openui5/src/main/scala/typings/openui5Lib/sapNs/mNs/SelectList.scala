...
class SelectList protected ()
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): SelectList = js.native
  /**
         * Adds some item to the aggregation <code>items</code>.
         * @param oItem the item to add; if empty, nothing is inserted
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def addItem(oItem: openui5Lib.sapNs.uiNs.coreNs.Item): SelectList = js.native
  /**
  ...
  /**
        ...
        */
  def getDefaultSelectedItem(aItems: js.Array[openui5Lib.sapNs.uiNs.coreNs.Item]): openui5Lib.sapNs.uiNs.coreNs.Item | js.Any = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def insertItem(oItem: openui5Lib.sapNs.uiNs.coreNs.Item, iIndex: scala.Double): SelectList = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setEnabled(bEnabled: scala.Boolean): SelectList = js.native
  /**
  ...
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def setSelectedItem(vItem: java.lang.String): SelectList = js.native
  /**
         * Sets the <code>selectedItem</code> association.
         * @param vItem New value for the <code>selectedItem</code> association.If an ID of a
         * <code>sap.ui.core.Item</code> is given, the item with this ID becomes the <code>selectedItem</code>
  ...
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def setSelectedItem(vItem: openui5Lib.sapNs.uiNs.coreNs.Item): SelectList = js.native
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def setSelectedItemId(vItem: java.lang.String): SelectList = js.native
  /**
         * Sets property <code>selectedItemId</code>.Default value is an empty string <code>""</code> or
         * <code>undefined</code>.
         * @param vItem New value for property <code>selectedItemId</code>.
  ...
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def setSelectedKey(sKey: java.lang.String): SelectList = js.native
  /**
        ...
        */
  def setSelection(vItem: java.lang.String): scala.Unit = js.native
  /**
         * Updates and synchronizes <code>selectedItem</code> association, <code>selectedItemId</code> and
         * <code>selectedKey</code> properties.
         * @param vItem undefined
        */
  def setSelection(vItem: js.Any): scala.Unit = js.native
  /**
         * Updates and synchronizes <code>selectedItem</code> association, <code>selectedItemId</code> and
         * <code>selectedKey</code> properties.
         * @param vItem undefined
        */
  def setSelection(vItem: openui5Lib.sapNs.uiNs.coreNs.Item): scala.Unit = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setShowSecondaryValues(bShowSecondaryValues: scala.Boolean): SelectList = js.native
  /**
