...
class Slider protected ()
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): Slider = js.native
  /**
  ...
  /**
        ...
        */
  def getProgress(): scala.Boolean = js.native
  /**
        ...
        */
  def getShowHandleTooltip(): scala.Boolean = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setEnabled(bEnabled: scala.Boolean): Slider = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setMax(fMax: scala.Double): Slider = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setMin(fMin: scala.Double): Slider = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setName(sName: java.lang.String): Slider = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setProgress(bProgress: scala.Boolean): Slider = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setShowHandleTooltip(bShowHandleTooltip: scala.Boolean): Slider = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setStep(fStep: scala.Double): Slider = js.native
  /**
        ...
        */
  def setValue(fNewValue: scala.Double): Slider = js.native
  /**
  ...
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def stepDown(iStep: scala.Double): Slider = js.native
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def stepUp(iStep: scala.Double): Slider = js.native
}
