...
class P13nGroupPanel protected () extends P13nPanel {
  ...
  /**
        ...
        */
  def getMaxGroups(): java.lang.String = js.native
  /**
        ...
        */
  def indexOfGroupItem(oGroupItem: P13nGroupItem): scala.Double = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def insertGroupItem(oGroupItem: P13nGroupItem, iIndex: scala.Double): P13nGroupPanel = js.native
  /**
  ...
  /**
        ...
        */
  def removeGroupItem(vGroupItem: java.lang.String): P13nGroupItem = js.native
  /**
         * Removes a groupItem from the aggregation <code>groupItems</code>.
         * @since 1.26
         * @param vGroupItem The groupItem to remove or its index or id
  ...
  /**
         ...
         * @returns The removed groupItem or <code>null</code>
        */
  def removeGroupItem(vGroupItem: scala.Double): P13nGroupItem = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setContainerQuery(bContainerQuery: scala.Boolean): P13nGroupPanel = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setLayoutMode(sLayoutMode: java.lang.String): P13nGroupPanel = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setMaxGroups(sMaxGroups: java.lang.String): P13nGroupPanel = js.native
  /**
        ...
        */
  def setOperations(array: js.Array[_]): scala.Unit = js.native
  /**
