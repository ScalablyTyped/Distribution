...
class Table () extends ListBase {
  ...
  /**
    ...
    */
  def getColumns(bSort: scala.Boolean): js.Array[Column] = js.native
  /**
    ...
    */
  def getFixedLayout(): scala.Boolean = js.native
  /**
    ...
    */
  def getShowOverlay(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertColumn(oColumn: Column, iIndex: scala.Double): Table = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setFixedLayout(bFixedLayout: scala.Boolean): Table = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowOverlay(bShowOverlay: scala.Boolean): Table = js.native
}
