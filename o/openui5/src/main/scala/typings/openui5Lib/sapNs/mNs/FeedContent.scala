...
class FeedContent protected ()
  ...
  /**
    ...
    */
  def getTruncateValueTo(): scala.Double = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSubheader(sSubheader: java.lang.String): FeedContent = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTruncateValueTo(iTruncateValueTo: scala.Double): FeedContent = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setValue(sValue: java.lang.String): FeedContent = js.native
  /**
