...
class SearchField protected ()
  ...
  def addAriaDescribedBy(vAriaDescribedBy: openui5Lib.sapNs.uiNs.coreNs.Control): SearchField = js.native
  /**
  ...
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): SearchField = js.native
  /**
  ...
  /**
    ...
    */
  def getEnableSuggestions(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getRefreshButtonTooltip(): java.lang.String = js.native
  /**
    ...
    */
  def getSelectOnFocus(): scala.Boolean = js.native
  /**
    ...
    */
  def getShowMagnifier(): scala.Boolean = js.native
  /**
    ...
    */
  def getShowRefreshButton(): scala.Boolean = js.native
  /**
    ...
    */
  def getShowSearchButton(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfSuggestionItem(oSuggestionItem: SuggestionItem): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertSuggestionItem(oSuggestionItem: SuggestionItem, iIndex: scala.Double): SearchField = js.native
  /**
  ...
  def removeSuggestionItem(vSuggestionItem: java.lang.String): SuggestionItem = js.native
  ...
  /**
    ...
    */
  def removeSuggestionItem(vSuggestionItem: scala.Double): SuggestionItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setEnableSuggestions(bEnableSuggestions: scala.Boolean): SearchField = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setEnabled(bEnabled: scala.Boolean): SearchField = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setMaxLength(iMaxLength: scala.Double): SearchField = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setPlaceholder(sPlaceholder: java.lang.String): SearchField = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setRefreshButtonTooltip(sRefreshButtonTooltip: java.lang.String): SearchField = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSelectOnFocus(bSelectOnFocus: scala.Boolean): SearchField = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowMagnifier(bShowMagnifier: scala.Boolean): SearchField = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowRefreshButton(bShowRefreshButton: scala.Boolean): SearchField = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowSearchButton(bShowSearchButton: scala.Boolean): SearchField = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setValue(sValue: java.lang.String): SearchField = js.native
  /**
  ...
  /**
    ...
    */
  def suggest(bShow: scala.Boolean): SearchField = js.native
  /**
