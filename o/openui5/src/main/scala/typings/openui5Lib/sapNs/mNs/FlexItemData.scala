...
class FlexItemData protected ()
  ...
  /**
        ...
        */
  def getGrowFactor(): scala.Double = js.native
  /**
  ...
  /**
        ...
        */
  def getShrinkFactor(): scala.Double = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setGrowFactor(fGrowFactor: scala.Double): FlexItemData = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setOrder(iOrder: scala.Double): FlexItemData = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setShrinkFactor(fShrinkFactor: scala.Double): FlexItemData = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setStyleClass(sStyleClass: java.lang.String): FlexItemData = js.native
}
