...
class Menu protected ()
  ...
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): Menu = js.native
  /**
  ...
  /**
          ...
          */
  def getAriaDescription(): java.lang.String = js.native
  /**
  ...
  /**
          ...
          */
  def getMaxVisibleItems(): scala.Double = js.native
  /**
  ...
  /**
          ...
          */
  def indexOfItem(oItem: MenuItemBase): scala.Double = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def insertItem(oItem: MenuItemBase, iIndex: scala.Double): Menu = js.native
  /**
          ...
          */
  def open(bWithKeyboard: scala.Boolean, oOpenerRef: js.Any, sMy: js.Any, sAt: js.Any, oOf: js.Any): scala.Unit = js.native
  /**
           * Opens the menu at the specified position.The position of the menu is defined relative to an element
           * in the visible DOM by specifyingthe docking location of the menu and of the related element.See
           * {@link sap.ui.core.Popup#open Popup#open} for further details about popup positioning.
          ...
          */
  def open(
    bWithKeyboard: scala.Boolean,
    oOpenerRef: js.Any,
    sMy: js.Any,
    sAt: js.Any,
    oOf: js.Any,
    sOffset: java.lang.String
  ...
  def open(
    ...
    sMy: js.Any,
    sAt: js.Any,
    oOf: openui5Lib.sapNs.uiNs.coreNs.Element
  ): scala.Unit = js.native
  /**
           * Opens the menu at the specified position.The position of the menu is defined relative to an element
           * in the visible DOM by specifyingthe docking location of the menu and of the related element.See
  ...
  def open(
    bWithKeyboard: scala.Boolean,
    oOpenerRef: openui5Lib.sapNs.uiNs.coreNs.Element,
    sMy: js.Any,
    sAt: js.Any,
    oOf: js.Any
  ): scala.Unit = js.native
  ...
  /**
          ...
          */
  def removeItem(vItem: java.lang.String): MenuItemBase = js.native
  /**
           * Removes a item from the aggregation <code>items</code>.
           * @param vItem The item to remove or its index or id
           * @returns The removed item or <code>null</code>
  ...
  /**
           ...
           * @returns The removed item or <code>null</code>
          */
  def removeItem(vItem: scala.Double): MenuItemBase = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setAriaDescription(sAriaDescription: java.lang.String): Menu = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setEnabled(bEnabled: scala.Boolean): Menu = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setMaxVisibleItems(iMaxVisibleItems: scala.Double): Menu = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setPageSize(iPageSize: scala.Double): Menu = js.native
}
