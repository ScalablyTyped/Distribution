...
class P13nColumnsPanel protected () extends P13nPanel {
  ...
  /**
        ...
        */
  def getVisibleItemsThreshold(): scala.Double = js.native
  /**
        ...
        */
  def indexOfColumnsItem(oColumnsItem: P13nColumnsItem): scala.Double = js.native
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def insertColumnsItem(iIndex: scala.Double, oColumnsItem: P13nColumnsItem): P13nColumnsPanel = js.native
  /**
         * This method does a re-initialization of the panel
         * @since 1.28
        */
  def reInitialize(): scala.Unit = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setVisibleItemsThreshold(iVisibleItemsThreshold: scala.Double): P13nColumnsPanel = js.native
  /**
