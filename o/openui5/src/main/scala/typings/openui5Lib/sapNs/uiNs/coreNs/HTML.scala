...
class HTML protected () extends Control {
  ...
  /**
    ...
    */
  def getPreferDOM(): scala.Boolean = js.native
  /**
    ...
    */
  def getSanitizeContent(): scala.Boolean = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setContent(sContent: java.lang.String): HTML = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setPreferDOM(bPreferDOM: scala.Boolean): HTML = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSanitizeContent(bSanitizeContent: scala.Boolean): HTML = js.native
}
