...
class StandardTile protected () extends Tile {
  ...
  def addAriaDescribedBy(vAriaDescribedBy: openui5Lib.sapNs.uiNs.coreNs.Control): StandardTile = js.native
  /**
  ...
  /**
    ...
    */
  def getIcon(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setIconDensityAware(bIconDensityAware: scala.Boolean): StandardTile = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setInfo(sInfo: java.lang.String): StandardTile = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setInfoState(sInfoState: openui5Lib.sapNs.uiNs.coreNs.ValueState): StandardTile = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setNumber(sNumber: java.lang.String): StandardTile = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setNumberUnit(sNumberUnit: java.lang.String): StandardTile = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTitle(sTitle: java.lang.String): StandardTile = js.native
  /**
