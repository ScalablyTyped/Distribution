...
abstract class SimpleType protected () extends Type {
  ...
  /**
          ...
          */
  def formatValue(oValue: js.Any, sInternalType: java.lang.String): js.Any = js.native
  /**
          ...
          */
  def parseValue(oValue: js.Any, sInternalType: java.lang.String): js.Any = js.native
  /**
           * Parse a value of an internal type to the expected value of the model type.
           * @param oValue the value to be parsed
           * @param sInternalType the source type
           * @returns the parse result
          */
  def parseValue(oValue: js.Any, sInternalType: java.lang.String, aCurrentValues: js.Array[_]): js.Any = js.native
  /**
          ...
          */
  def validateValue(oValue: js.Any): scala.Unit = js.native
}
