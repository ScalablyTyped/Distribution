...
class ListItemBase protected ()
  ...
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): ListItemBase = js.native
  /**
  ...
  /**
    ...
    */
  def getTabbables(): jqueryLib.JQueryStatic = js.native
  /**
  ...
  /**
    ...
    */
  def getUnread(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setCounter(iCounter: scala.Double): ListItemBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSelected(bSelected: scala.Boolean): ListItemBase = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setUnread(bUnread: scala.Boolean): ListItemBase = js.native
}
