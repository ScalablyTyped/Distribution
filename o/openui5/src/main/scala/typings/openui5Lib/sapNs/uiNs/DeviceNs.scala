...
object DeviceNs extends js.Object {
  ...
  object browserNs extends js.Object {
    ...
    /**
      ...
      * @since 1.30.0
      */
    var edge: scala.Boolean = js.native
    /**
    ...
    /**
      ...
      */
    var internet_explorer: scala.Boolean = js.native
    /**
    ...
    /**
      ...
      * @since 1.20.0
      */
    var msie: scala.Boolean = js.native
    /**
    ...
    /**
      ...
      * @since 1.31.0
      */
    var webview: scala.Boolean = js.native
    @JSName("BROWSER")
    @js.native
    object BROWSERNs extends js.Object {
      /**
  ...
  object mediaNs extends js.Object {
    /**
      ...
      */
    def attachHandler(fnFunction: js.Any, oListener: js.Any, sName: java.lang.String): scala.Unit = js.native
    /**
      ...
      * {@link sap.ui.Device.media.RANGESETS.SAP_STANDARD default range set} is used.
      */
    def detachHandler(fnFunction: js.Any, oListener: js.Any, sName: java.lang.String): scala.Unit = js.native
    /**
      ...
      */
    def getCurrentRange(sName: java.lang.String): js.Any = js.native
    /**
      ...
      */
    def hasRangeSet(sName: java.lang.String): scala.Boolean = js.native
    /**
      ...
      */
    def initRangeSet(sName: java.lang.String): scala.Unit = js.native
    def initRangeSet(sName: java.lang.String, aRangeBorders: scala.Double): scala.Unit = js.native
    def initRangeSet(sName: java.lang.String, aRangeBorders: scala.Double, sUnit: java.lang.String): scala.Unit = js.native
    def initRangeSet(
      sName: java.lang.String,
      aRangeBorders: scala.Double,
      sUnit: java.lang.String,
      aRangeNames: js.Array[java.lang.String]
    ...
    def initRangeSet(
      ...
      sUnit: java.lang.String,
      aRangeNames: js.Array[java.lang.String],
      bSuppressClasses: scala.Boolean
    ): scala.Unit = js.native
    /**
      ...
      */
    def removeRangeSet(sName: java.lang.String): scala.Unit = js.native
    @JSName("RANGESETS")
    @js.native
  ...
  object orientationNs extends js.Object {
    ...
    /**
      ...
      * function is called in the context of the <code>window</code>.
      */
    def attachHandler(fnFunction: js.Any): scala.Unit = js.native
    def attachHandler(fnFunction: js.Any, oListener: js.Any): scala.Unit = js.native
    /**
      ...
      * @param oListener The object that wanted to be notified when the event occurred
      */
    def detachHandler(fnFunction: js.Any): scala.Unit = js.native
    def detachHandler(fnFunction: js.Any, oListener: js.Any): scala.Unit = js.native
  }
  ...
  object osNs extends js.Object {
    ...
    /**
      ...
      */
    var macintosh: scala.Boolean = js.native
    /**
    ...
    /**
      ...
      */
    var windows_phone: scala.Boolean = js.native
    @JSName("OS")
    @js.native
    object OSNs extends js.Object {
      /**
  ...
  object supportNs extends js.Object {
    /**
      ...
      */
    var matchmedia: scala.Boolean = js.native
    /**
      ...
      */
    var matchmedialistener: scala.Boolean = js.native
    /**
  ...
  object systemNs extends js.Object {
    /**
      ...
      */
    var combi: scala.Boolean = js.native
    /**
