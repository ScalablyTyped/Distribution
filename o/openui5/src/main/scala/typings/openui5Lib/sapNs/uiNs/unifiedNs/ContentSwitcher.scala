...
class ContentSwitcher protected ()
  ...
  /**
    ...
    */
  def addContent1(oContent1: openui5Lib.sapNs.uiNs.coreNs.Control): ContentSwitcher = js.native
  /**
    * Adds some content2 to the aggregation <code>content2</code>.
    * @param oContent2 the content2 to add; if empty, nothing is inserted
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def addContent2(oContent2: openui5Lib.sapNs.uiNs.coreNs.Control): ContentSwitcher = js.native
  /**
  ...
  /**
    ...
    */
  def getActiveContent(): scala.Double = js.native
  /**
  ...
  /**
    ...
    * content
    */
  def getContent1(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Control] = js.native
  /**
    * Gets content of aggregation <code>content2</code>.The controls that should be shown in the second
    * content
    */
  def getContent2(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Control] = js.native
  /**
    ...
    */
  def indexOfContent1(oContent1: openui5Lib.sapNs.uiNs.coreNs.Control): scala.Double = js.native
  /**
    * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation
    ...
    * @returns The index of the provided control in the aggregation if found, or -1 otherwise
    */
  def indexOfContent2(oContent2: openui5Lib.sapNs.uiNs.coreNs.Control): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertContent1(oContent1: openui5Lib.sapNs.uiNs.coreNs.Control, iIndex: scala.Double): ContentSwitcher = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertContent2(oContent2: openui5Lib.sapNs.uiNs.coreNs.Control, iIndex: scala.Double): ContentSwitcher = js.native
  /**
    * Removes all the controls from the aggregation <code>content1</code>.Additionally, it unregisters
    * them from the hosting UIArea.
    * @returns An array of the removed elements (might be empty)
    */
  def removeAllContent1(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Control] = js.native
  /**
    * Removes all the controls from the aggregation <code>content2</code>.Additionally, it unregisters
    * them from the hosting UIArea.
    * @returns An array of the removed elements (might be empty)
    */
  def removeAllContent2(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Control] = js.native
  def removeContent1(vContent1: java.lang.String): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  def removeContent1(vContent1: openui5Lib.sapNs.uiNs.coreNs.Control): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
    ...
    */
  def removeContent1(vContent1: scala.Double): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  def removeContent2(vContent2: java.lang.String): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  def removeContent2(vContent2: openui5Lib.sapNs.uiNs.coreNs.Control): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
    ...
    */
  def removeContent2(vContent2: scala.Double): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setActiveContent(iActiveContent: scala.Double): ContentSwitcher = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setAnimation(sAnimation: java.lang.String): ContentSwitcher = js.native
  /**
    ...
    */
  def switchContent(): scala.Unit = js.native
}
