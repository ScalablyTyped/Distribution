...
class ScrollBar protected () extends Control {
  ...
  /**
          ...
          */
  def bind(oOwnerDomRef: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
          ...
          */
  def getScrollPosition(): scala.Double = js.native
  /**
  ...
  /**
          ...
          */
  def pageDown(): scala.Unit = js.native
  /**
           * Page Up is used to scroll one page back.
          */
  def pageUp(): scala.Unit = js.native
  /**
  ...
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setScrollPosition(iScrollPosition: scala.Double): ScrollBar = js.native
  /**
  ...
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setSteps(iSteps: scala.Double): ScrollBar = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setVertical(bVertical: scala.Boolean): ScrollBar = js.native
  /**
           * Unbinds the mouse wheel scroll event of the control that has the scrollbar
           * @param oOwnerDomRef Dom ref of the Control that uses the scrollbar
          */
  def unbind(oOwnerDomRef: java.lang.String): scala.Unit = js.native
}
