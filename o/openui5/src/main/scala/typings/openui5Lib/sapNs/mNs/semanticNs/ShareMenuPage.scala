...
class ShareMenuPage protected () extends SemanticPage {
  ...
  /**
          ...
          */
  def addCustomShareMenuContent(oCustomShareMenuContent: openui5Lib.sapNs.mNs.Button): ShareMenuPage = js.native
  /**
  ...
  /**
          ...
          */
  def getCustomShareMenuContent(): js.Array[openui5Lib.sapNs.mNs.Button] = js.native
  /**
          ...
          */
  def indexOfCustomShareMenuContent(oCustomShareMenuContent: openui5Lib.sapNs.mNs.Button): scala.Double = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def insertCustomShareMenuContent(oCustomShareMenuContent: openui5Lib.sapNs.mNs.Button, iIndex: scala.Double): ShareMenuPage = js.native
  /**
          ...
          */
  def removeAllCustomShareMenuContent(): js.Array[openui5Lib.sapNs.mNs.Button] = js.native
  /**
          ...
          */
  def removeCustomShareMenuContent(vCustomShareMenuContent: java.lang.String): openui5Lib.sapNs.mNs.Button = js.native
  /**
           * Removes a customShareMenuContent from the aggregation <code>customShareMenuContent</code>.
           * @param vCustomShareMenuContent The customShareMenuContent to remove or its index or id
           * @returns The removed customShareMenuContent or <code>null</code>
          */
  def removeCustomShareMenuContent(vCustomShareMenuContent: openui5Lib.sapNs.mNs.Button): openui5Lib.sapNs.mNs.Button = js.native
  /**
           * Removes a customShareMenuContent from the aggregation <code>customShareMenuContent</code>.
           * @param vCustomShareMenuContent The customShareMenuContent to remove or its index or id
           * @returns The removed customShareMenuContent or <code>null</code>
          */
  def removeCustomShareMenuContent(vCustomShareMenuContent: scala.Double): openui5Lib.sapNs.mNs.Button = js.native
}
