...
class IBarInPageEnabler () extends js.Object {
  /**
    ...
    */
  def addChildClassTo(oControl: openui5Lib.sapNs.uiNs.coreNs.Control): scala.Unit = js.native
  /**
    ...
    */
  def renderTooltip(oRM: openui5Lib.sapNs.uiNs.coreNs.RenderManager, oControl: openui5Lib.sapNs.uiNs.coreNs.Control): scala.Unit = js.native
}
