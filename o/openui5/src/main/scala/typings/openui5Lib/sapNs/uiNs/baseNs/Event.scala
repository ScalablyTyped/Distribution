...
class Event protected () extends Object {
  /**
    ...
    */
  def this(sId: java.lang.String, oSource: EventProvider, mParameters: js.Any) = this()
  /**
    ...
    */
  def cancelBubble(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getParameter(sName: java.lang.String): js.Any = js.native
  /**
