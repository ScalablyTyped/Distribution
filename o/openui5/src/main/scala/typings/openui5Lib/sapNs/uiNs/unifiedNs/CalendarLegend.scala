...
class CalendarLegend protected ()
  ...
  /**
          ...
          */
  def indexOfItem(oItem: CalendarLegendItem): scala.Double = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def insertItem(oItem: CalendarLegendItem, iIndex: scala.Double): CalendarLegend = js.native
  /**
  ...
  /**
          ...
          */
  def removeItem(vItem: java.lang.String): CalendarLegendItem = js.native
  /**
           * Removes a item from the aggregation <code>items</code>.
           * @param vItem The item to remove or its index or id
           * @returns The removed item or <code>null</code>
  ...
  /**
           ...
           * @returns The removed item or <code>null</code>
          */
  def removeItem(vItem: scala.Double): CalendarLegendItem = js.native
  /**
