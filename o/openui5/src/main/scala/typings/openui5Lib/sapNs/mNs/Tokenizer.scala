...
class Tokenizer protected ()
  ...
  def addAriaDescribedBy(vAriaDescribedBy: openui5Lib.sapNs.uiNs.coreNs.Control): Tokenizer = js.native
  /**
  ...
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): Tokenizer = js.native
  /**
  ...
  /**
    ...
    */
  def addValidateToken(oParameters: js.Any): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getScrollDelegate(): openui5Lib.sapNs.uiNs.coreNs.delegateNs.ScrollEnablement = js.native
  /**
    * Function returns the tokens' width
    */
  def getScrollWidth(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertToken(oToken: Token, iIndex: scala.Double): Tokenizer = js.native
  /**
  ...
  /**
    ...
    * reset this flag
    */
  def scrollToEnd(bInitialize: scala.Boolean): scala.Unit = js.native
  /**
    * Function scrolls the tokens to the start
    */
  def scrollToStart(): scala.Unit = js.native
  /**
    * Function selects all tokens
    * @param optional bSelect - true for selecting, false for deselecting
    * @returns - this for chaining
    */
  def selectAllTokens(optional: scala.Boolean): Tokenizer = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setEditable(bEditable: scala.Boolean): Tokenizer = js.native
  /**
    * Function sets the tokenizer's width in pixels
    * @param nWidth the new width in pixels
    */
  def setPixelWidth(nWidth: scala.Double): scala.Unit = js.native
  /**
