package typings
package openui5Lib.sapNs.uiNs.modelNs.analyticsNs
...
class AnalyticalTreeBindingAdapter () extends js.Object {
  /**
            ...
            */
  def getNumberOfExpandedLevels(): scala.Double = js.native
  /**
            ...
            */
  def hasTotaledMeasures(): scala.Boolean = js.native
  /**
            ...
            */
  def setNumberOfExpandedLevels(iLevels: scala.Double): scala.Unit = js.native
}
