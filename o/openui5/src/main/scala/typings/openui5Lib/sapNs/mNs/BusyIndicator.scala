...
class BusyIndicator protected ()
  ...
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): BusyIndicator = js.native
  /**
  ...
  /**
    ...
    */
  def getCustomIconDensityAware(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getCustomIconRotationSpeed(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getDesign(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setCustomIconDensityAware(bCustomIconDensityAware: scala.Boolean): BusyIndicator = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setCustomIconRotationSpeed(iCustomIconRotationSpeed: scala.Double): BusyIndicator = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setDesign(sDesign: java.lang.String): BusyIndicator = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setText(sText: java.lang.String): BusyIndicator = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTextDirection(sTextDirection: openui5Lib.sapNs.uiNs.coreNs.TextDirection): BusyIndicator = js.native
}
