...
@js.native
object AppCacheBusterNs extends js.Object {
  /**
          ...
          */
  def convertURL(sUrl: java.lang.String): java.lang.String = js.native
  /**
          ...
          */
  def handleURL(sUrl: java.lang.String): scala.Boolean = js.native
  /**
           * Normalizes the given URL and make it absolute.
           * @param sUrl any URL
           * @returns normalized URL
          */
  def normalizeURL(sUrl: java.lang.String): java.lang.String = js.native
  /**
          ...
          */
  def register(base: java.lang.String): scala.Unit = js.native
}
