...
class Opa5 ()
  ...
  /**
          ...
          */
  def extendConfig(options: js.Any): scala.Unit = js.native
  /**
  ...
  /**
          ...
          */
  def getHashChanger(): openui5Lib.sapNs.uiNs.coreNs.routingNs.HashChanger = js.native
  /**
           * Returns the jQuery object of the IFrame. If the IFrame is not loaded it will return null.
           * @returns The jQuery object
          */
  def getJQuery(): jqueryLib.JQueryStatic = js.native
  /**
  ...
  /**
          ...
          */
  def iStartMyAppInAFrame(sSource: java.lang.String): js.Any = js.native
  /**
           * Starts an app in an IFrame. Only works reliably if running on the same server.
           * @param sSource The source of the IFrame
           * @param iTimeout The timeout for loading the IFrame in seconds - default is 80
           * @returns A promise that gets resolved on success
          */
  def iStartMyAppInAFrame(sSource: java.lang.String, iTimeout: scala.Double): js.Any = js.native
  /**
  ...
  /**
           ...
           * @since 1.25
          */
  def resetConfig(): scala.Unit = js.native
  /**
          ...
          */
  def stopQueue(): scala.Unit = js.native
  /**
