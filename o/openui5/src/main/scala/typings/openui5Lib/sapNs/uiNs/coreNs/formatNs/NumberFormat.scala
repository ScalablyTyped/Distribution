...
class NumberFormat protected ()
  ...
  def format(oValue: js.Array[_]): java.lang.String = js.native
  def format(oValue: js.Array[_], sMeasure: java.lang.String): java.lang.String = js.native
  /**
  ...
  def format(oValue: scala.Double, sMeasure: java.lang.String): java.lang.String = js.native
  /**
  ...
  def getCurrencyInstance(oFormatOptions: js.Any, oLocale: openui5Lib.sapNs.uiNs.coreNs.Locale): NumberFormat = js.native
  /**
  ...
  def getFloatInstance(oFormatOptions: js.Any, oLocale: openui5Lib.sapNs.uiNs.coreNs.Locale): NumberFormat = js.native
  /**
  ...
  def getIntegerInstance(oFormatOptions: js.Any, oLocale: openui5Lib.sapNs.uiNs.coreNs.Locale): NumberFormat = js.native
  /**
  ...
  def getPercentInstance(oFormatOptions: js.Any, oLocale: openui5Lib.sapNs.uiNs.coreNs.Locale): NumberFormat = js.native
  /**
    ...
    */
  def parse(sValue: java.lang.String): scala.Double | js.Array[_] = js.native
}
