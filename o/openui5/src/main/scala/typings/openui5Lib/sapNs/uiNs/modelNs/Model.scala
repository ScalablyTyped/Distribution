...
abstract class Model ()
  extends openui5Lib.sapNs.uiNs.coreNs.messageNs.MessageProcessor {
  /**
  ...
  /**
    ...
    */
  def bindContext(sPath: java.lang.String): ContextBinding = js.native
  def bindContext(sPath: java.lang.String, oContext: js.Any): ContextBinding = js.native
  def bindContext(sPath: java.lang.String, oContext: js.Any, mParameters: js.Any): ContextBinding = js.native
  def bindContext(sPath: java.lang.String, oContext: js.Any, mParameters: js.Any, oEvents: js.Any): ContextBinding = js.native
  ...
  /**
    ...
    * @param mParameters additional model specific parameters (optional)
    */
  def bindList(sPath: java.lang.String): ListBinding = js.native
  def bindList(sPath: java.lang.String, oContext: Context): ListBinding = js.native
  def bindList(sPath: java.lang.String, oContext: Context, aSorters: js.Array[Sorter]): ListBinding = js.native
  def bindList(sPath: java.lang.String, oContext: Context, aSorters: js.Array[Sorter], aFilters: js.Array[Filter]): ListBinding = js.native
  def bindList(
  ...
  /**
    ...
    * @param mParameters additional model specific parameters (optional)
    */
  def bindProperty(sPath: java.lang.String): PropertyBinding = js.native
  def bindProperty(sPath: java.lang.String, oContext: js.Any): PropertyBinding = js.native
  def bindProperty(sPath: java.lang.String, oContext: js.Any, mParameters: js.Any): PropertyBinding = js.native
  /**
    * Implement in inheriting classes
    ...
    */
  def bindTree(sPath: java.lang.String): TreeBinding = js.native
  def bindTree(sPath: java.lang.String, oContext: js.Any): TreeBinding = js.native
  def bindTree(sPath: java.lang.String, oContext: js.Any, aFilters: js.Array[_]): TreeBinding = js.native
  def bindTree(sPath: java.lang.String, oContext: js.Any, aFilters: js.Array[_], mParameters: js.Any): TreeBinding = js.native
  def bindTree(
    sPath: java.lang.String,
    oContext: js.Any,
    aFilters: js.Array[_],
  ...
  /**
    ...
    */
  def createBindingContext(sPath: java.lang.String): Context = js.native
  def createBindingContext(sPath: java.lang.String, oContext: js.Any): Context = js.native
  def createBindingContext(sPath: java.lang.String, oContext: js.Any, mParameters: js.Any): Context = js.native
  def createBindingContext(sPath: java.lang.String, oContext: js.Any, mParameters: js.Any, fnCallBack: js.Any): Context = js.native
  def createBindingContext(
    sPath: java.lang.String,
    oContext: js.Any,
    mParameters: js.Any,
    fnCallBack: js.Any,
    bReload: scala.Boolean
  ): Context = js.native
  /**
    * Implement in inheriting classes
    * @param oContext to destroy
    */
  def destroyBindingContext(oContext: js.Any): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getDefaultBindingMode(): openui5Lib.TypeofBindingMode = js.native
  /**
    * Get messages for path
    * @param sPath The binding path
    */
  def getMessagesByPath(sPath: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getObject(sPath: java.lang.String): scala.Unit = js.native
  def getObject(sPath: java.lang.String, oContext: js.Any): scala.Unit = js.native
  def getObject(sPath: java.lang.String, oContext: js.Any, mParameters: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def getOriginalProperty(sPath: java.lang.String): js.Any = js.native
  def getOriginalProperty(sPath: java.lang.String, oContext: js.Any): js.Any = js.native
  /**
    * Implement in inheriting classes
    * @param sPath the path to where to read the attribute value
    * @param oContext the context with which the path should be resolved
    */
  def getProperty(sPath: java.lang.String): scala.Unit = js.native
  def getProperty(sPath: java.lang.String, oContext: js.Any): scala.Unit = js.native
  /**
    * Check if the specified binding mode is supported by the model.
    * @param sMode the binding mode to check
    */
  def isBindingModeSupported(sMode: openui5Lib.TypeofBindingMode): scala.Unit = js.native
  /**
    * Returns whether legacy path syntax is used
    */
  def isLegacySyntax(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def setDefaultBindingMode(sMode: openui5Lib.TypeofBindingMode): Model = js.native
  /**
    ...
    */
  def setLegacySyntax(bLegacySyntax: scala.Boolean): scala.Unit = js.native
  /**
    * Set the maximum number of entries which are used for list bindings.
    * @param iSizeLimit collection size limit
    */
  def setSizeLimit(iSizeLimit: scala.Double): scala.Unit = js.native
}
