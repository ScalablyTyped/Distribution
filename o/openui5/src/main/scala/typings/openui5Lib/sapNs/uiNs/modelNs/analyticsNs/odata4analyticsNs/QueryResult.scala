...
class QueryResult protected () extends js.Object {
  ...
  /**
    ...
    */
  def findDimensionByName(sName: java.lang.String): Dimension = js.native
  /**
    ...
    */
  def findDimensionByPropertyName(sName: java.lang.String): Dimension = js.native
  /**
    * Find measure by name
    * @param sName Measure name
    * @returns The measure object with this         name or null if it does not exist
    */
  def findMeasureByName(sName: java.lang.String): Measure = js.native
  /**
    ...
    */
  def findMeasureByPropertyName(sName: java.lang.String): Measure = js.native
  /**
    * Get the names of all dimensions included in the query result
    * @returns List of all dimension names
    */
  def getAllDimensionNames(): js.Array[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  def getAllMeasureNames(): js.Array[java.lang.String] = js.native
  /**
