...
class Export protected ()
  ...
  /**
    ...
    */
  def generate(): jqueryLib.JQueryPromise[_] = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfColumn(oColumn: ExportColumn): scala.Double = js.native
  /**
    ...
    * @returns The index of the provided control in the aggregation if found, or -1 otherwise
    */
  def indexOfRow(oRow: ExportRow): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertColumn(oColumn: ExportColumn, iIndex: scala.Double): Export = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertRow(oRow: ExportRow, iIndex: scala.Double): Export = js.native
  /**
  ...
  def removeColumn(vColumn: java.lang.String): ExportColumn = js.native
  ...
  /**
    ...
    */
  def removeColumn(vColumn: scala.Double): ExportColumn = js.native
  def removeRow(vRow: java.lang.String): ExportRow = js.native
  ...
  /**
    ...
    */
  def removeRow(vRow: scala.Double): ExportRow = js.native
  /**
    ...
    * @returns Promise object
    */
  def saveFile(sFileName: java.lang.String): jqueryLib.JQueryPromise[_] = js.native
  /**
