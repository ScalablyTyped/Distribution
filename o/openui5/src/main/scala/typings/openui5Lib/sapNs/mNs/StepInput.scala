...
@JSGlobal("sap.m.StepInput")
@js.native
class StepInput protected ()
  ...
  def addAriaDescribedBy(vAriaDescribedBy: openui5Lib.sapNs.uiNs.coreNs.Control): StepInput = js.native
  /**
  ...
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): StepInput = js.native
  /**
  ...
  /**
    ...
    */
  def getLargerStep(): stdLib.Number = js.native
  /**
    ...
    */
  def getMax(): stdLib.Number = js.native
  /**
    ...
    */
  def getMin(): stdLib.Number = js.native
  /**
    ...
    */
  def getStep(): stdLib.Number = js.native
  /**
    ...
    */
  def getValue(): stdLib.Number = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setEnabled(bEnabled: scala.Boolean): StepInput = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setLargerStep(sLargerStep: stdLib.Number): StepInput = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setStep(sStep: stdLib.Number): StepInput = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setValue(sValue: stdLib.Number): StepInput = js.native
  /**
