...
class TablePersoDialog protected ()
  ...
  /**
    ...
    */
  def setHasGrouping(bHasGrouping: scala.Boolean): TablePersoDialog = js.native
  /**
  ...
  /**
    ...
    * @returns the TablePersoDialog instance.
    */
  def setShowResetAll(bShowResetAll: scala.Boolean): TablePersoDialog = js.native
  /**
    * Setter to show/hide TablePersoDialog's 'selectAll' checkbox.
    * @param bShowSelectAll selectAll checkbox visible or not.
    * @returns the TablePersoDialog instance.
    */
  def setShowSelectAll(bShowSelectAll: scala.Boolean): TablePersoDialog = js.native
}
