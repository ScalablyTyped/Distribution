...
@JSGlobal("sap.ui.model")
@js.native
object modelNsMembers extends js.Object {
  /**
    ...
    */
  def FormatException(): scala.Unit = js.native
  /**
    ...
    */
  def ParseException(): scala.Unit = js.native
  /**
    ...
    */
  def ValidateException(): scala.Unit = js.native
}
