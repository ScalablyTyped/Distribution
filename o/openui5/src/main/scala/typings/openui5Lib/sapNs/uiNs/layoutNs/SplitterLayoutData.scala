...
class SplitterLayoutData protected ()
  ...
  /**
          ...
          */
  def getMinSize(): scala.Double = js.native
  /**
  ...
  /**
          ...
          */
  def setMinSize(iMinSize: scala.Double): SplitterLayoutData = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setResizable(bResizable: scala.Boolean): SplitterLayoutData = js.native
  /**
