...
abstract class SemanticSelect protected () extends SemanticControl {
  ...
  /**
    ...
    */
  def addItem(oItem: openui5Lib.sapNs.uiNs.coreNs.Item): SemanticSelect = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertItem(oItem: openui5Lib.sapNs.uiNs.coreNs.Item, iIndex: scala.Double): SemanticSelect = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setEnabled(bEnabled: scala.Boolean): SemanticSelect = js.native
  /**
  ...
  def setSelectedItem(oSelectedItem: openui5Lib.sapNs.uiNs.coreNs.Item): SemanticSelect = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSelectedKey(sSelectedKey: java.lang.String): SemanticSelect = js.native
  /**
