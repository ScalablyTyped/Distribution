...
class ManagedObject protected () extends EventProvider {
  ...
  /**
    ...
    */
  def addAggregation(sAggregationName: java.lang.String, oObject: ManagedObject): ManagedObject = js.native
  def addAggregation(sAggregationName: java.lang.String, oObject: ManagedObject, bSuppressInvalidate: scala.Boolean): ManagedObject = js.native
  /**
    ...
    * @returns Returns <code>this</code> to allow method chaining
    */
  def addAssociation(sAssociationName: java.lang.String, sId: java.lang.String): ManagedObject = js.native
  def addAssociation(sAssociationName: java.lang.String, sId: java.lang.String, bSuppressInvalidate: scala.Boolean): ManagedObject = js.native
  def addAssociation(sAssociationName: java.lang.String, sId: ManagedObject): ManagedObject = js.native
  def addAssociation(sAssociationName: java.lang.String, sId: ManagedObject, bSuppressInvalidate: scala.Boolean): ManagedObject = js.native
  /**
  ...
  /**
    ...
    */
  def bindAggregation(sName: java.lang.String, oBindingInfo: js.Any): ManagedObject = js.native
  /**
    ...
    * @returns reference to the instance itself
    */
  def bindContext(sPath: java.lang.String): ManagedObject = js.native
  /**
    * Bind the object to the referenced entity in the model, which is used as the binding contextto
    * resolve bound properties or aggregations of the object itself and all of its childrenrelatively to
    ...
    * @returns reference to the instance itself
    */
  def bindObject(vPath: java.lang.String): ManagedObject = js.native
  def bindObject(vPath: java.lang.String, mParameters: js.Any): ManagedObject = js.native
  ...
  /**
    ...
    * @returns reference to the instance itself
    */
  def bindProperty(sName: java.lang.String, oBindingInfo: js.Any): ManagedObject = js.native
  /**
    ...
    */
  def clone(sIdSuffix: java.lang.String): ManagedObject = js.native
  def clone(sIdSuffix: java.lang.String, aLocalIds: js.Array[java.lang.String]): ManagedObject = js.native
  def clone(sIdSuffix: java.lang.String, aLocalIds: js.Array[java.lang.String], oOptions: js.Any): ManagedObject = js.native
  def create(vData: js.Any, oKeyInfo: js.Any): scala.Unit = js.native
  def create(vData: js.Any, oKeyInfo: js.Any, oScope: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def create(vData: ManagedObject, oKeyInfo: js.Any): scala.Unit = js.native
  def create(vData: ManagedObject, oKeyInfo: js.Any, oScope: js.Any): scala.Unit = js.native
  /**
    ...
    * @returns Returns <code>this</code> to allow method chaining
    */
  def destroyAggregation(sAggregationName: java.lang.String): ManagedObject = js.native
  def destroyAggregation(sAggregationName: java.lang.String, bSuppressInvalidate: scala.Boolean): ManagedObject = js.native
  /**
  ...
  /**
    ...
    */
  def findAggregatedObjects(bRecursive: scala.Boolean, fnCondition: scala.Boolean): js.Array[ManagedObject] = js.native
  /**
  ...
  def getAggregation(sAggregationName: java.lang.String, oDefaultForCreation: js.Array[_]): ManagedObject | js.Array[_] = js.native
  /**
    ...
    * 0..1-aggregations
    */
  def getAggregation(sAggregationName: java.lang.String, oDefaultForCreation: ManagedObject): ManagedObject | js.Array[_] = js.native
  /**
    ...
    */
  def getAssociation(sAssociationName: java.lang.String, oDefaultForCreation: js.Any): java.lang.String | js.Array[java.lang.String] = js.native
  /**
    * Get the binding object for a specific aggregation/property
    * @param sName the name of the property or aggregation
    * @returns the binding for the given name
    */
  def getBinding(sName: java.lang.String): openui5Lib.sapNs.uiNs.modelNs.Binding = js.native
  /**
    ...
    */
  def getBindingContext(sModelName: java.lang.String): openui5Lib.sapNs.uiNs.modelNs.Context = js.native
  /**
    ...
    */
  def getBindingInfo(sName: java.lang.String): js.Any = js.native
  /**
    * Get the binding path for a specific aggregation/property
    * @param sName the name of the property or aggregation
    * @returns the binding path for the given name
    */
  def getBindingPath(sName: java.lang.String): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getObjectBinding(sModelName: java.lang.String): openui5Lib.sapNs.uiNs.modelNs.Binding = js.native
  /**
    ...
    */
  def getOriginInfo(sPropertyName: java.lang.String): js.Any = js.native
  /**
  ...
  /**
    ...
    * @param sPropertyName the name of the property
    */
  def getProperty(sPropertyName: java.lang.String): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfAggregation(sAggregationName: java.lang.String, oObject: ManagedObject): scala.Double = js.native
  /**
    ...
    * @returns Returns <code>this</code> to allow method chaining
    */
  def insertAggregation(sAggregationName: java.lang.String, oObject: ManagedObject, iIndex: scala.Double): ManagedObject = js.native
  def insertAggregation(
    sAggregationName: java.lang.String,
    oObject: ManagedObject,
    iIndex: scala.Double,
    bSuppressInvalidate: scala.Boolean
  ): ManagedObject = js.native
  /**
  ...
  def invalidate(oOrigin: js.Any): scala.Unit = js.native
  /**
    * Find out whether a property or aggregation is bound
    * @param sName the name of the property or aggregation
    * @returns whether a binding exists for the given name
    */
  def isBound(sName: java.lang.String): scala.Boolean = js.native
  /**
    * Returns whether rerendering is currently suppressed on this ManagedObject
    */
  def isInvalidateSuppressed(): scala.Unit = js.native
  /**
    ...
    */
  def isTreeBinding(sName: java.lang.String): scala.Boolean = js.native
  /**
    ...
    */
  def propagateMessages(sName: java.lang.String, aMessages: js.Array[_]): scala.Unit = js.native
  def removeAggregation(sAggregationName: java.lang.String, vObject: java.lang.String): ManagedObject = js.native
  def removeAggregation(sAggregationName: java.lang.String, vObject: java.lang.String, bSuppressInvalidate: scala.Boolean): ManagedObject = js.native
  def removeAggregation(sAggregationName: java.lang.String, vObject: ManagedObject): ManagedObject = js.native
  def removeAggregation(sAggregationName: java.lang.String, vObject: ManagedObject, bSuppressInvalidate: scala.Boolean): ManagedObject = js.native
  /**
    ...
    */
  def removeAggregation(sAggregationName: java.lang.String, vObject: scala.Double): ManagedObject = js.native
  def removeAggregation(sAggregationName: java.lang.String, vObject: scala.Double, bSuppressInvalidate: scala.Boolean): ManagedObject = js.native
  /**
    ...
    */
  def removeAllAggregation(sAggregationName: java.lang.String): js.Array[_] = js.native
  def removeAllAggregation(sAggregationName: java.lang.String, bSuppressInvalidate: scala.Boolean): js.Array[_] = js.native
  /**
    ...
    */
  def removeAllAssociation(sAssociationName: java.lang.String): js.Array[_] = js.native
  def removeAllAssociation(sAssociationName: java.lang.String, bSuppressInvalidate: scala.Boolean): js.Array[_] = js.native
  def removeAssociation(sAssociationName: java.lang.String, vObject: java.lang.String): scala.Unit = js.native
  def removeAssociation(sAssociationName: java.lang.String, vObject: java.lang.String, bSuppressInvalidate: scala.Boolean): scala.Unit = js.native
  def removeAssociation(sAssociationName: java.lang.String, vObject: ManagedObject): scala.Unit = js.native
  def removeAssociation(sAssociationName: java.lang.String, vObject: ManagedObject, bSuppressInvalidate: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def removeAssociation(sAssociationName: java.lang.String, vObject: scala.Double): scala.Unit = js.native
  def removeAssociation(sAssociationName: java.lang.String, vObject: scala.Double, bSuppressInvalidate: scala.Boolean): scala.Unit = js.native
  /**
    ...
    * @returns Returns <code>this</code> to allow method chaining
    */
  def setAggregation(sAggregationName: java.lang.String, oObject: js.Any): ManagedObject = js.native
  def setAggregation(sAggregationName: java.lang.String, oObject: js.Any, bSuppressInvalidate: scala.Boolean): ManagedObject = js.native
  /**
    ...
    * @returns Returns <code>this</code> to allow method chaining
    */
  def setAssociation(sAssociationName: java.lang.String, sId: java.lang.String): ManagedObject = js.native
  def setAssociation(sAssociationName: java.lang.String, sId: java.lang.String, bSuppressInvalidate: scala.Boolean): ManagedObject = js.native
  def setAssociation(sAssociationName: java.lang.String, sId: ManagedObject): ManagedObject = js.native
  def setAssociation(sAssociationName: java.lang.String, sId: ManagedObject, bSuppressInvalidate: scala.Boolean): ManagedObject = js.native
  /**
  ...
  def setBindingContext(oContext: js.Any, sModelName: java.lang.String): ManagedObject = js.native
  /**
    ...
    */
  def setModel(oModel: openui5Lib.sapNs.uiNs.modelNs.Model): ManagedObject = js.native
  def setModel(oModel: openui5Lib.sapNs.uiNs.modelNs.Model, sName: java.lang.String): ManagedObject = js.native
  /**
    ...
    * @returns Returns <code>this</code> to allow method chaining
    */
  def setProperty(sPropertyName: java.lang.String, oValue: js.Any): ManagedObject = js.native
  def setProperty(sPropertyName: java.lang.String, oValue: js.Any, bSuppressInvalidate: scala.Boolean): ManagedObject = js.native
  /**
    ...
    * @returns reference to the instance itself
    */
  def unbindAggregation(sName: java.lang.String, bSuppressReset: scala.Boolean): ManagedObject = js.native
  /**
    ...
    * @returns reference to the instance itself
    */
  def unbindContext(sModelName: java.lang.String): ManagedObject = js.native
  /**
    * Removes the defined binding context of this object, all bindings will now resolverelative to the
    * parent context again.
    * @param sModelName name of the model to remove the context for.
    * @returns reference to the instance itself
    */
  def unbindObject(sModelName: java.lang.String): ManagedObject = js.native
  /**
    ...
    * @returns reference to the instance itself
    */
  def unbindProperty(sName: java.lang.String, bSuppressReset: scala.Boolean): ManagedObject = js.native
  def validateAggregation(sAggregationName: java.lang.String, oObject: js.Any, bMultiple: scala.Boolean): ManagedObject | js.Any = js.native
  /**
    ...
    */
  def validateAggregation(sAggregationName: java.lang.String, oObject: ManagedObject, bMultiple: scala.Boolean): ManagedObject | js.Any = js.native
  /**
    ...
    * passed
    */
  def validateProperty(sPropertyName: java.lang.String, oValue: js.Any): js.Any = js.native
}
