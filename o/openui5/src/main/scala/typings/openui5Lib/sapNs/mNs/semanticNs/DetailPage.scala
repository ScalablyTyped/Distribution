...
class DetailPage protected () extends ShareMenuPage {
  ...
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setDraftIndicator(oDraftIndicator: openui5Lib.sapNs.mNs.DraftIndicator): DetailPage = js.native
  /**
  ...
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setPagingAction(oPagingAction: openui5Lib.sapNs.mNs.PagingButton): DetailPage = js.native
  /**
  ...
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setSaveAsTileAction(oSaveAsTileAction: openui5Lib.sapNs.mNs.Button): DetailPage = js.native
  /**
