...
class RadioButton protected ()
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def addAriaDescribedBy(vAriaDescribedBy: openui5Lib.sapNs.uiNs.coreNs.Control): RadioButton = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): RadioButton = js.native
  /**
  ...
  /**
        ...
        */
  def getGroupName(): java.lang.String = js.native
  /**
  ...
  /**
        ...
        */
  def onsapselect(oEvent: js.Any): scala.Unit = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setActiveHandling(bActiveHandling: scala.Boolean): RadioButton = js.native
  /**
         * Method to set a RadioButton's state to active or inactive.
         * @param bActive Sets the active state to true or false
        */
  def setActiveState(bActive: scala.Boolean): scala.Unit = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setEditable(bEditable: scala.Boolean): RadioButton = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setEnabled(bEnabled: scala.Boolean): RadioButton = js.native
  /**
        ...
        */
  def setGroupName(sGroupName: java.lang.String): RadioButton = js.native
  /**
         * Sets the state of the RadioButton to selected.
         * @param bSelected defines if the radio button is selected
         * @returns Reference to the control instance for chaining
        */
  def setSelected(bSelected: scala.Boolean): RadioButton = js.native
  /**
         * Sets the text for the RadioButton's label.
         * @param sText The text to be set
         * @returns Reference to the control instance for chaining
        */
  def setText(sText: java.lang.String): RadioButton = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setTextAlign(sTextAlign: openui5Lib.sapNs.uiNs.coreNs.TextAlign): RadioButton = js.native
  /**
         * Sets the text direction for the RadioButton's label.
         * @param sDirection Text direction to be set to RadioButton's label
         * @returns Reference to the control instance for chaining
        */
  def setTextDirection(sDirection: java.lang.String): RadioButton = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setValueState(sValueState: openui5Lib.sapNs.uiNs.coreNs.ValueState): RadioButton = js.native
  /**
         * Sets the width for the RadioButton's label.
         * @param sWidth CSS size to be set as width of the label
         * @returns Reference to the control instance for chaining
        */
  def setWidth(sWidth: java.lang.String): RadioButton = js.native
}
