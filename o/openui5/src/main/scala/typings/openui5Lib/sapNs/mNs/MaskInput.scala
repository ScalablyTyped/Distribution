...
class MaskInput protected () extends InputBase {
  ...
  /**
    ...
    */
  def _feedReplaceChar(sChar: java.lang.String, iPlacePosition: scala.Double, sCurrentInputValue: java.lang.String): java.lang.String = js.native
  /**
    ...
    */
  def _isCharAllowed(sChar: java.lang.String, iIndex: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getPlaceholderSymbol(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfRule(oRule: MaskInputRule): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertRule(oRule: MaskInputRule, iIndex: scala.Double): MaskInput = js.native
  /**
  ...
  def removeRule(vRule: java.lang.String): MaskInputRule = js.native
  ...
  /**
    ...
    */
  def removeRule(vRule: scala.Double): MaskInputRule = js.native
}
