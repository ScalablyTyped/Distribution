...
class Menu protected ()
  ...
  /**
    ...
    */
  def indexOfItem(oItem: MenuItem): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertItem(oItem: MenuItem, iIndex: scala.Double): Menu = js.native
  /**
    ...
    */
  def openBy(oControl: js.Any, bWithKeyboard: js.Any): scala.Unit = js.native
  /**
  ...
  def removeItem(vItem: java.lang.String): MenuItem = js.native
  ...
  /**
    ...
    */
  def removeItem(vItem: scala.Double): MenuItem = js.native
  /**
    * Sets the title of the <code>Menu</code>.
    * @param sTitle The new title of the <code>Menu</code>
    */
  def setTitle(sTitle: java.lang.String): scala.Unit = js.native
  /**
