...
class MessageStrip protected ()
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowCloseButton(bShowCloseButton: scala.Boolean): MessageStrip = js.native
  /**
