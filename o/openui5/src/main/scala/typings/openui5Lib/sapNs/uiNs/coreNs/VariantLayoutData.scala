...
class VariantLayoutData protected () extends LayoutData {
  ...
  /**
    ...
    */
  def indexOfMultipleLayoutData(oMultipleLayoutData: LayoutData): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertMultipleLayoutData(oMultipleLayoutData: LayoutData, iIndex: scala.Double): VariantLayoutData = js.native
  /**
  ...
  def removeMultipleLayoutData(vMultipleLayoutData: java.lang.String): LayoutData = js.native
  ...
  /**
    ...
    */
  def removeMultipleLayoutData(vMultipleLayoutData: scala.Double): LayoutData = js.native
}
