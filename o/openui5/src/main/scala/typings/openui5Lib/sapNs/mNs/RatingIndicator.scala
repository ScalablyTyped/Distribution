...
class RatingIndicator protected ()
  ...
  def addAriaDescribedBy(vAriaDescribedBy: openui5Lib.sapNs.uiNs.coreNs.Control): RatingIndicator = js.native
  /**
  ...
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): RatingIndicator = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setEnabled(bEnabled: scala.Boolean): RatingIndicator = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setMaxValue(iMaxValue: scala.Double): RatingIndicator = js.native
  /**
    ...
    * @returns Returns <code>this</code> to facilitate method chaining.
    */
  def setValue(fValue: scala.Double): RatingIndicator = js.native
  /**
