...
class Title protected ()
  ...
  /**
    ...
    */
  def getLevel(): openui5Lib.sapNs.uiNs.coreNs.TitleLevel = js.native
  /**
  ...
  /**
    ...
    */
  def getTitleStyle(): openui5Lib.sapNs.uiNs.coreNs.TitleLevel = js.native
  /**
  ...
  /**
    ...
    */
  def setLevel(sLevel: openui5Lib.sapNs.uiNs.coreNs.TitleLevel): Title = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTextAlign(sTextAlign: openui5Lib.sapNs.uiNs.coreNs.TextAlign): Title = js.native
  /**
  ...
  def setTitle(oTitle: openui5Lib.sapNs.uiNs.coreNs.Title): Title = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTitleStyle(sTitleStyle: openui5Lib.sapNs.uiNs.coreNs.TitleLevel): Title = js.native
  /**
