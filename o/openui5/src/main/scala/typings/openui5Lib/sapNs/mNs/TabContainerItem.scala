...
class TabContainerItem protected ()
  ...
  /**
        ...
        */
  def addContent(oContent: openui5Lib.sapNs.uiNs.coreNs.Control): TabContainerItem = js.native
  /**
  ...
  /**
        ...
        */
  def getModified(): scala.Boolean = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def insertContent(oContent: openui5Lib.sapNs.uiNs.coreNs.Control, iIndex: scala.Double): TabContainerItem = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setKey(sKey: java.lang.String): TabContainerItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setModified(bModified: scala.Boolean): TabContainerItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setName(sName: java.lang.String): TabContainerItem = js.native
  /**
        ...
        */
  def setProperty(sName: java.lang.String, vValue: java.lang.String, bSuppressInvalidation: scala.Boolean): TabContainerItem = js.native
  /**
         * Overwrites the method in order to suppress invalidation for some properties.
         * @param sName Property name to be set
         * @param vValue Property value to be set
         ...
         * @returns This instance for chaining
        */
  def setProperty(sName: java.lang.String, vValue: scala.Boolean, bSuppressInvalidation: scala.Boolean): TabContainerItem = js.native
}
