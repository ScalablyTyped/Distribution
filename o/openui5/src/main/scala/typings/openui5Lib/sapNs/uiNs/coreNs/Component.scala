...
abstract class Component protected ()
  ...
  /**
          ...
          */
  def getOwnerComponentFor(oObject: openui5Lib.sapNs.uiNs.baseNs.ManagedObject): Component = js.native
  /**
          ...
          */
  def getOwnerIdFor(oObject: openui5Lib.sapNs.uiNs.baseNs.ManagedObject): java.lang.String = js.native
  /**
          ...
          */
  def getService(sLocalServiceAlias: java.lang.String): jqueryLib.JQueryPromise[_] = js.native
  /**
  ...
  /**
          ...
          */
  def onConfigChange(sConfigKey: java.lang.String): scala.Unit = js.native
  /**
          ...
          */
  def onWindowBeforeUnload(): java.lang.String = js.native
  /**
          ...
          */
  def onWindowError(sMessage: java.lang.String, sFile: java.lang.String, iLine: scala.Double): scala.Unit = js.native
  /**
