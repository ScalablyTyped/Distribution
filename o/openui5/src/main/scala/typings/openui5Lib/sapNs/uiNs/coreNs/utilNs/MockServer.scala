...
abstract class MockServer protected ()
  ...
  /**
    ...
    */
  def attachAfter(event: java.lang.String, fnCallback: js.Any, sEntitySet: java.lang.String): scala.Unit = js.native
  /**
    ...
    * @param sEntitySet (optional) the name of the entity set
    */
  def attachBefore(event: java.lang.String, fnCallback: js.Any, sEntitySet: java.lang.String): scala.Unit = js.native
  /**
    ...
    * @param sEntitySet (optional) the name of the entity set
    */
  def detachAfter(event: java.lang.String, fnCallback: js.Any, sEntitySet: java.lang.String): scala.Unit = js.native
  /**
    * Removes a previously attached event handler
    * @param event type according to HTTP Method
    * @param fnCallback the name of the function that will be called at this exit
    * @param sEntitySet (optional) the name of the entity set
    */
  def detachBefore(event: java.lang.String, fnCallback: js.Any, sEntitySet: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @returns the value of property <code>rootUri</code>
    */
  def getRootUri(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def setEntitySetData(sEntitySetName: js.Any, aData: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def setRequests(requests: js.Array[_]): scala.Unit = js.native
  /**
    ...
    */
  def setRootUri(rootUri: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def simulate(sMetadataUrl: java.lang.String): scala.Unit = js.native
  def simulate(sMetadataUrl: java.lang.String, vMockdataSettings: java.lang.String): scala.Unit = js.native
  def simulate(sMetadataUrl: java.lang.String, vMockdataSettings: js.Any): scala.Unit = js.native
  /**
    * Starts the server.
    */
