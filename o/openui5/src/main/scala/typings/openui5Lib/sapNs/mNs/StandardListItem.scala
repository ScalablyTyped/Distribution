...
class StandardListItem protected () extends ListItemBase {
  ...
  /**
        ...
        */
  def getAdaptTitleSize(): scala.Boolean = js.native
  /**
  ...
  /**
        ...
        */
  def getIconInset(): scala.Boolean = js.native
  /**
        ...
        */
  def getInfo(): java.lang.String = js.native
  /**
        ...
        */
  def getInfoState(): openui5Lib.sapNs.uiNs.coreNs.ValueState = js.native
  /**
        ...
        */
  def getInfoTextDirection(): openui5Lib.sapNs.uiNs.coreNs.TextDirection = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setAdaptTitleSize(bAdaptTitleSize: scala.Boolean): StandardListItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setDescription(sDescription: java.lang.String): StandardListItem = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setIconDensityAware(bIconDensityAware: scala.Boolean): StandardListItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setIconInset(bIconInset: scala.Boolean): StandardListItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setInfo(sInfo: java.lang.String): StandardListItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setInfoState(sInfoState: openui5Lib.sapNs.uiNs.coreNs.ValueState): StandardListItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setInfoTextDirection(sInfoTextDirection: openui5Lib.sapNs.uiNs.coreNs.TextDirection): StandardListItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setTitle(sTitle: java.lang.String): StandardListItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setTitleTextDirection(sTitleTextDirection: openui5Lib.sapNs.uiNs.coreNs.TextDirection): StandardListItem = js.native
}
