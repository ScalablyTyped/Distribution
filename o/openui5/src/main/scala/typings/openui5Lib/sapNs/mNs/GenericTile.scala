...
class GenericTile protected ()
  ...
  /**
    ...
    */
  def getFailedText(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    * control instead.
    */
  def getIcon(): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
    ...
    */
  def getImageDescription(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfTileContent(oTileContent: TileContent): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertTileContent(oTileContent: TileContent, iIndex: scala.Double): GenericTile = js.native
  /**
  ...
  def removeTileContent(vTileContent: java.lang.String): TileContent = js.native
  ...
  /**
    ...
    */
  def removeTileContent(vTileContent: scala.Double): TileContent = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setFailedText(sFailedText: java.lang.String): GenericTile = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setHeader(sHeader: java.lang.String): GenericTile = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setIcon(oIcon: openui5Lib.sapNs.uiNs.coreNs.Control): GenericTile = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setImageDescription(sImageDescription: java.lang.String): GenericTile = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSubheader(sSubheader: java.lang.String): GenericTile = js.native
}
