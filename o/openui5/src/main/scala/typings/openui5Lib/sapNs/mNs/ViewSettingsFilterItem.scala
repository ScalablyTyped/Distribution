...
@JSGlobal("sap.m.ViewSettingsFilterItem")
@js.native
class ViewSettingsFilterItem protected () extends ViewSettingsItem {
  /**
  ...
  /**
        ...
        */
  def indexOfItem(oItem: ViewSettingsItem): scala.Double = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def insertItem(oItem: ViewSettingsItem, iIndex: scala.Double): ViewSettingsFilterItem = js.native
  /**
  ...
  /**
        ...
        */
  def removeItem(vItem: java.lang.String): ViewSettingsItem = js.native
  /**
         * Removes a item from the aggregation <code>items</code>.
         * @param vItem The item to remove or its index or id
         * @returns The removed item or <code>null</code>
  ...
  /**
         ...
         * @returns The removed item or <code>null</code>
        */
  def removeItem(vItem: scala.Double): ViewSettingsItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setMultiSelect(bMultiSelect: scala.Boolean): ViewSettingsFilterItem = js.native
  /**
