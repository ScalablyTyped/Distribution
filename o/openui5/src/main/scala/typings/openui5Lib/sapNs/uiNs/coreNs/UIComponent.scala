...
abstract class UIComponent protected () extends Component {
  ...
  /**
    ...
    */
  def getRouter(): openui5Lib.sapNs.mNs.routingNs.Router = js.native
  def getRouterFor(oControllerOrView: openui5Lib.sapNs.uiNs.coreNs.mvcNs.Controller): openui5Lib.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    * @returns the router instance
    */
  def getRouterFor(oControllerOrView: openui5Lib.sapNs.uiNs.coreNs.mvcNs.View): openui5Lib.sapNs.mNs.routingNs.Router = js.native
  /**
    ...
    */
  def getTargets(): openui5Lib.sapNs.uiNs.coreNs.routingNs.Targets = js.native
  /**
  ...
  /**
    ...
    */
  def render(oRenderManager: RenderManager): scala.Unit = js.native
  /**
