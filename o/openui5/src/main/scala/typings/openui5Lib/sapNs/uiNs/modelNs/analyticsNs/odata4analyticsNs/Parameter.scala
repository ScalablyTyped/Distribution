...
class Parameter protected () extends js.Object {
  ...
  /**
    ...
    */
  def getURIToValueEntitySet(sServiceRootURI: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def isIntervalBoundary(): scala.Boolean = js.native
  /**
    ...
    */
  def isLowerIntervalBoundary(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def isValueSetAvailable(): scala.Boolean = js.native
}
