...
class Carousel protected ()
  ...
  /**
    ...
    */
  def addPage(oPage: openui5Lib.sapNs.uiNs.coreNs.Control): Carousel = js.native
  /**
  ...
  /**
    ...
    */
  def getShowBusyIndicator(): scala.Boolean = js.native
  /**
    ...
    */
  def getShowPageIndicator(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertPage(oPage: openui5Lib.sapNs.uiNs.coreNs.Control, iIndex: scala.Double): Carousel = js.native
  /**
  ...
  def setActivePage(oActivePage: openui5Lib.sapNs.uiNs.coreNs.Control): Carousel = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setLoop(bLoop: scala.Boolean): Carousel = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowBusyIndicator(bShowBusyIndicator: scala.Boolean): Carousel = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowPageIndicator(bShowPageIndicator: scala.Boolean): Carousel = js.native
  /**
