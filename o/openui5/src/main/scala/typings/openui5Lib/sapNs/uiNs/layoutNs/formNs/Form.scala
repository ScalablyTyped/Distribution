...
class Form protected ()
  ...
  /**
             ...
             * @returns Reference to <code>this</code> in order to allow method chaining
            */
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): Form = js.native
  /**
  ...
  /**
            ...
            */
  def indexOfFormContainer(oFormContainer: FormContainer): scala.Double = js.native
  /**
             ...
             * @returns Reference to <code>this</code> in order to allow method chaining
            */
  def insertFormContainer(oFormContainer: FormContainer, iIndex: scala.Double): Form = js.native
  /**
  ...
  /**
            ...
            */
  def removeFormContainer(vFormContainer: java.lang.String): FormContainer = js.native
  /**
             * Removes a formContainer from the aggregation <code>formContainers</code>.
             * @param vFormContainer The formContainer to remove or its index or id
             * @returns The removed formContainer or <code>null</code>
  ...
  /**
             ...
             * @returns The removed formContainer or <code>null</code>
            */
  def removeFormContainer(vFormContainer: scala.Double): FormContainer = js.native
  /**
             ...
             * @returns Reference to <code>this</code> in order to allow method chaining
            */
  def setEditable(bEditable: scala.Boolean): Form = js.native
  /**
  ...
  /**
             ...
             * @returns Reference to <code>this</code> in order to allow method chaining
            */
  def setTitle(vTitle: java.lang.String): Form = js.native
  /**
             * Sets the aggregated <code>title</code>.
             * @param vTitle The title to set
             * @returns Reference to <code>this</code> in order to allow method chaining
            */
  def setTitle(vTitle: openui5Lib.sapNs.uiNs.coreNs.Title): Form = js.native
  /**
             ...
             * @returns Reference to <code>this</code> in order to allow method chaining
            */
  def setToolbar(oToolbar: openui5Lib.sapNs.uiNs.coreNs.Toolbar): Form = js.native
  /**
