...
class FacetFilterList protected () extends List {
  ...
  /**
        ...
        */
  def getAllCount(): scala.Double = js.native
  /**
  ...
  /**
        ...
        */
  def getEnableCaseInsensitiveSearch(): scala.Boolean = js.native
  /**
  ...
  /**
        ...
        */
  def getRetainListSequence(): scala.Boolean = js.native
  /**
  ...
  /**
        ...
        */
  def getSequence(): scala.Double = js.native
  /**
        ...
        */
  def getShowRemoveFacetIcon(): scala.Boolean = js.native
  /**
  ...
  /**
        ...
        */
  def removeSelectedKey(sKey: java.lang.String, sText: java.lang.String): scala.Unit = js.native
  /**
         * Removes all selected keys from the selected keys cache and deselects all items.
         * @since 1.20.4
        */
  def removeSelectedKeys(): scala.Unit = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setActive(bActive: scala.Boolean): FacetFilterList = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setAllCount(iAllCount: scala.Double): FacetFilterList = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setEnableCaseInsensitiveSearch(bEnableCaseInsensitiveSearch: scala.Boolean): FacetFilterList = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setKey(sKey: java.lang.String): FacetFilterList = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setRetainListSequence(bRetainListSequence: scala.Boolean): FacetFilterList = js.native
  /**
        ...
        */
  def setSelectedKeys(oAKeys: js.Any): scala.Unit = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setSequence(iSequence: scala.Double): FacetFilterList = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setShowRemoveFacetIcon(bShowRemoveFacetIcon: scala.Boolean): FacetFilterList = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setWordWrap(bWordWrap: scala.Boolean): FacetFilterList = js.native
}
