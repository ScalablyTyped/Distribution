...
class ObjectIdentifier protected ()
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): ObjectIdentifier = js.native
  /**
  ...
  /**
        ...
        */
  def getBadgeAttachments(): scala.Boolean = js.native
  /**
        ...
        */
  def getBadgeNotes(): scala.Boolean = js.native
  /**
        ...
        */
  def getBadgePeople(): scala.Boolean = js.native
  /**
  ...
  /**
        ...
        */
  def getTitleActive(): scala.Boolean = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setBadgeAttachments(bBadgeAttachments: scala.Boolean): ObjectIdentifier = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setBadgeNotes(bBadgeNotes: scala.Boolean): ObjectIdentifier = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setBadgePeople(bBadgePeople: scala.Boolean): ObjectIdentifier = js.native
  /**
         * Sets text.Default value is empty/undefined.
         * @param sText New value for property text
         * @returns this to allow method chaining
        */
  def setText(sText: java.lang.String): ObjectIdentifier = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setTextDirection(sTextDirection: openui5Lib.sapNs.uiNs.coreNs.TextDirection): ObjectIdentifier = js.native
  /**
         * Sets the title.Default value is empty/undefined.
         * @param sTitle New value for property title
         * @returns this to allow method chaining
        */
  def setTitle(sTitle: java.lang.String): ObjectIdentifier = js.native
  /**
         * Sets property titleActive.Default value is false.
         * @param bValue new value for property titleActive
         * @returns this to allow method chaining
        */
  def setTitleActive(bValue: scala.Boolean): ObjectIdentifier = js.native
}
