...
class P13nSortPanel protected () extends P13nPanel {
  ...
  /**
        ...
        */
  def indexOfSortItem(oSortItem: P13nSortItem): scala.Double = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def insertSortItem(oSortItem: P13nSortItem, iIndex: scala.Double): P13nSortPanel = js.native
  /**
  ...
  /**
        ...
        */
  def removeSortItem(vSortItem: java.lang.String): P13nSortItem = js.native
  /**
         * Removes a sortItem from the aggregation <code>sortItems</code>.
         * @since 1.26
         * @param vSortItem The sortItem to remove or its index or id
  ...
  /**
         ...
         * @returns The removed sortItem or <code>null</code>
        */
  def removeSortItem(vSortItem: scala.Double): P13nSortItem = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setContainerQuery(bContainerQuery: scala.Boolean): P13nSortPanel = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setLayoutMode(sLayoutMode: java.lang.String): P13nSortPanel = js.native
  /**
  ...
  /**
         ...
         * @since 1.26
        */
  def validateConditions(): scala.Unit = js.native
}
