...
@js.native
class ComboBox protected () extends ComboBoxBase {
  /**
  ...
  /**
        ...
        */
  def getDefaultSelectedItem(): scala.Unit = js.native
  /**
        ...
        */
  def getSelectedItem(): openui5Lib.sapNs.uiNs.coreNs.Item | js.Any = js.native
  /**
        ...
        */
  def getSelectedItemId(): java.lang.String = js.native
  /**
  ...
  /**
        ...
        */
  def getShowSecondaryValues(): scala.Boolean = js.native
  /**
  ...
  /**
        ...
        */
  def setSelectedItem(vItem: java.lang.String): ComboBox = js.native
  /**
         * Sets the <code>selectedItem</code> association.Default value is <code>null</code>.
         * @param vItem New value for the <code>selectedItem</code> association.If an ID of a
         * <code>sap.ui.core.Item</code> is given, the item with this ID becomes the<code>selectedItem</code>
  ...
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def setSelectedItem(vItem: openui5Lib.sapNs.uiNs.coreNs.Item): ComboBox = js.native
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def setSelectedItemId(vItem: java.lang.String): ComboBox = js.native
  /**
         * Sets the <code>selectedItemId</code> property.Default value is an empty string <code>""</code> or
         * <code>undefined</code>.
         * @param vItem New value for property <code>selectedItemId</code>.If the provided <code>vItem</code>
  ...
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def setSelectedKey(sKey: java.lang.String): ComboBox = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setShowSecondaryValues(bShowSecondaryValues: scala.Boolean): ComboBox = js.native
  /**
         * Synchronizes the <code>selectedItem</code> association and the <code>selectedItemId</code> property.
        */
  def synchronizeSelection(): scala.Unit = js.native
}
