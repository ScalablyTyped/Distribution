...
class DeclarativeSupport () extends js.Object {
  /**
    ...
    */
  def compile(oElement: Element): scala.Unit = js.native
  def compile(oElement: Element, oView: openui5Lib.sapNs.uiNs.coreNs.mvcNs.HTMLView): scala.Unit = js.native
  def compile(oElement: Element, oView: openui5Lib.sapNs.uiNs.coreNs.mvcNs.HTMLView, isRecursive: scala.Boolean): scala.Unit = js.native
}
