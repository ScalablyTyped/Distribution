...
class Route protected ()
  ...
  /**
             ...
             * provided).
            */
  def this(The: openui5Lib.sapNs.mNs.routingNs.Router, oConfig: js.Any) = this()
  /**
             * Instantiates a SAPUI5 Route
             * @param The router instance, the route will be added to.
             * @param oConfig configuration object for the route
             ...
             * provided).
            */
  def this(The: openui5Lib.sapNs.mNs.routingNs.Router, oConfig: js.Any, oParent: Route) = this()
  /**
