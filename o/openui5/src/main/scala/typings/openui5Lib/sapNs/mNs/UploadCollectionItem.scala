...
@js.native
class UploadCollectionItem protected ()
  ...
  /**
    ...
    */
  def download(askForLocation: scala.Boolean): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getContributor(): java.lang.String = js.native
  /**
    ...
    */
  def getDocumentId(): java.lang.String = js.native
  /**
    ...
    */
  def getEnableDelete(): scala.Boolean = js.native
  /**
    ...
    */
  def getEnableEdit(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getUploadedDate(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getVisibleDelete(): scala.Boolean = js.native
  /**
    ...
    */
  def getVisibleEdit(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @returns The index of the provided control in the aggregation if found, or -1 otherwise
    */
  def indexOfMarker(oMarker: ObjectMarker): scala.Double = js.native
  /**
    ...
    * @returns The index of the provided control in the aggregation if found, or -1 otherwise
    */
  def indexOfStatus(oStatus: ObjectStatus): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertAttribute(oAttribute: ObjectAttribute, iIndex: scala.Double): UploadCollectionItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertMarker(oMarker: ObjectMarker, iIndex: scala.Double): UploadCollectionItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertStatus(oStatus: ObjectStatus, iIndex: scala.Double): UploadCollectionItem = js.native
  /**
  ...
  def removeMarker(vMarker: java.lang.String): ObjectMarker = js.native
  ...
  /**
    ...
    */
  def removeMarker(vMarker: scala.Double): ObjectMarker = js.native
  def removeStatus(vStatus: java.lang.String): ObjectStatus = js.native
  ...
  /**
    ...
    */
  def removeStatus(vStatus: scala.Double): ObjectStatus = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setAriaLabelForPicture(sAriaLabelForPicture: java.lang.String): UploadCollectionItem = js.native
  /**
    * Setter of the deprecated contributor property. The property is mapped to the aggregation attributes.
    */
  def setContributor(): scala.Unit = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setDocumentId(sDocumentId: java.lang.String): UploadCollectionItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setEnableDelete(bEnableDelete: scala.Boolean): UploadCollectionItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setEnableEdit(bEnableEdit: scala.Boolean): UploadCollectionItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setFileName(sFileName: java.lang.String): UploadCollectionItem = js.native
  /**
    * Setter of the deprecated fileSize property. The property is mapped to the aggregation attributes.
    */
  def setFileSize(): scala.Unit = js.native
  /**
  ...
  def setFileUploader(oFileUploader: openui5Lib.sapNs.uiNs.unifiedNs.FileUploader): UploadCollectionItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setMimeType(sMimeType: java.lang.String): UploadCollectionItem = js.native
  /**
    ...
    */
  def setSelected(selected: scala.Boolean): UploadCollectionItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setThumbnailUrl(sThumbnailUrl: java.lang.String): UploadCollectionItem = js.native
  /**
    * Setter of the deprecated uploadedDate property. The property is mapped to the aggregation
    * attributes.
    */
  def setUploadedDate(): scala.Unit = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setUrl(sUrl: java.lang.String): UploadCollectionItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setVisibleDelete(bVisibleDelete: scala.Boolean): UploadCollectionItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setVisibleEdit(bVisibleEdit: scala.Boolean): UploadCollectionItem = js.native
  /**
