...
class TreeBinding protected () extends Binding {
  /**
    ...
    */
  def this(oModel: Model, sPath: java.lang.String) = this()
  def this(oModel: Model, sPath: java.lang.String, oContext: js.Any) = this()
  def this(oModel: Model, sPath: java.lang.String, oContext: js.Any, aFilters: js.Array[_]) = this()
  def this(oModel: Model, sPath: java.lang.String, oContext: js.Any, aFilters: js.Array[_], mParameters: js.Any) = this()
  def this(oModel: Model, sPath: java.lang.String, oContext: js.Any, aFilters: js.Array[_], mParameters: js.Any, aSorters: js.Array[_]) = this()
  /**
  ...
  /**
    ...
    * behaviour applies
    */
  def filter(aFilters: js.Array[Filter], sFilterType: openui5Lib.TypeofFilterType): scala.Unit = js.native
  /**
    * Returns the number of child nodes of a specific context
    * @param oContext the context element of the node
    * @returns the number of children
    */
  def getChildCount(oContext: js.Any): scala.Double = js.native
  /**
    ...
    */
  def getNodeContexts(oContext: js.Any, iStartIndex: scala.Double, iLength: scala.Double): js.Array[_] = js.native
  def getNodeContexts(oContext: js.Any, iStartIndex: scala.Double, iLength: scala.Double, iThreshold: scala.Double): js.Array[_] = js.native
  /**
    * Returns the current value of the bound target
    * @param iStartIndex the startIndex where to start the retrieval of contexts
    * @param iLength determines how many contexts to retrieve beginning from the start index.
    ...
    */
  def getRootContexts(iStartIndex: scala.Double, iLength: scala.Double): js.Array[_] = js.native
  /**
    * Returns if the node has child nodes
    * @param oContext the context element of the node
    * @returns true if node has children
    */
  def hasChildren(oContext: Context): scala.Boolean = js.native
  def hasChildren(oContext: Context, mParameters: js.Any): scala.Boolean = js.native
  /**
