...
class NumericContent protected ()
  ...
  /**
    ...
    */
  def getAnimateTextChange(): scala.Boolean = js.native
  /**
    ...
    */
  def getFormatterValue(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getIconDescription(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getNullifyValue(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getWithMargin(): scala.Boolean = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setAnimateTextChange(bAnimateTextChange: scala.Boolean): NumericContent = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setFormatterValue(bFormatterValue: scala.Boolean): NumericContent = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setIconDescription(sIconDescription: java.lang.String): NumericContent = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setNullifyValue(bNullifyValue: scala.Boolean): NumericContent = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setScale(sScale: java.lang.String): NumericContent = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTruncateValueTo(iTruncateValueTo: scala.Double): NumericContent = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setValue(sValue: java.lang.String): NumericContent = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setWithMargin(bWithMargin: scala.Boolean): NumericContent = js.native
}
