...
class RadioButtonGroup protected ()
  ...
  def addAriaDescribedBy(vAriaDescribedBy: openui5Lib.sapNs.uiNs.coreNs.Control): RadioButtonGroup = js.native
  /**
  ...
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): RadioButtonGroup = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfButton(oButton: RadioButton): scala.Double = js.native
  /**
    ...
    * @returns Pointer to the control instance for chaining
    */
  def insertButton(oButton: RadioButton, iIndex: scala.Double): RadioButtonGroup = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setColumns(iColumns: scala.Double): RadioButtonGroup = js.native
  /**
    ...
    * @returns Pointer to the control instance for chaining
    */
  def setEditable(bEditable: scala.Boolean): RadioButtonGroup = js.native
  /**
    ...
    * @returns Pointer to the control instance for chaining
    */
  def setEnabled(bEnabled: scala.Boolean): RadioButtonGroup = js.native
  /**
  ...
  /**
    ...
    * @returns Pointer to the control instance for chaining
    */
  def setSelectedIndex(iSelectedIndex: scala.Double): RadioButtonGroup = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTextDirection(sTextDirection: openui5Lib.sapNs.uiNs.coreNs.TextDirection): RadioButtonGroup = js.native
  /**
    ...
    * @returns Pointer to the control instance for chaining
    */
  def setValueState(sValueState: java.lang.String): RadioButtonGroup = js.native
  /**
