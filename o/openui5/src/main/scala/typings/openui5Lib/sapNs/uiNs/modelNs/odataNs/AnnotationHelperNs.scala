...
@js.native
object AnnotationHelperNs extends js.Object {
  /**
  ...
  /**
            ...
            */
  def format(oInterface: openui5Lib.sapNs.uiNs.coreNs.utilNs.XMLPreprocessorNs.IContext): java.lang.String = js.native
  /**
             * A formatter function to be used in a complex binding inside an XML template viewin order to
             * interpret OData V4 annotations. It knows about<ul>  <li> the "14.4 Constant Expressions" for
             * "edm:Bool", "edm:Date",  "edm:DateTimeOffset", "edm:Decimal", "edm:Float", "edm:Guid", "edm:Int", 
             ...
             * @returns the resulting string value to write into the processed XML
            */
  def format(oInterface: openui5Lib.sapNs.uiNs.coreNs.utilNs.XMLPreprocessorNs.IContext, vRawValue: js.Any): java.lang.String = js.native
  /**
             * A formatter function to be used in a complex binding inside an XML template viewin order to
             * interpret OData V4 annotations. It knows about<ul>  <li> the "14.4 Constant Expressions" for
             * "edm:Bool", "edm:Date",  "edm:DateTimeOffset", "edm:Decimal", "edm:Float", "edm:Guid", "edm:Int", 
             ...
             * @returns the resulting string value to write into the processed XML
            */
  def format(oInterface: openui5Lib.sapNs.uiNs.modelNs.Context): java.lang.String = js.native
  /**
             * A formatter function to be used in a complex binding inside an XML template viewin order to
             * interpret OData V4 annotations. It knows about<ul>  <li> the "14.4 Constant Expressions" for
             * "edm:Bool", "edm:Date",  "edm:DateTimeOffset", "edm:Decimal", "edm:Float", "edm:Guid", "edm:Int", 
             ...
             * @returns the resulting string value to write into the processed XML
            */
  def format(oInterface: openui5Lib.sapNs.uiNs.modelNs.Context, vRawValue: js.Any): java.lang.String = js.native
  /**
             * A formatter function to be used in a complex binding inside an XML template viewin order to
            ...
            */
  def getNavigationPath(oInterface: openui5Lib.sapNs.uiNs.coreNs.utilNs.XMLPreprocessorNs.IContext): java.lang.String = js.native
  /**
             * A formatter function to be used in a complex binding inside an XML template viewin order to
             * interpret OData V4 annotations. It knows about the following dynamicexpressions:<ul><li>"14.5.2
             * Expression edm:AnnotationPath"</li><li>"14.5.11 Expression
             ...
             * (this is treated as falsy in <code>template:if</code>  statements!)
            */
  def getNavigationPath(oInterface: openui5Lib.sapNs.uiNs.coreNs.utilNs.XMLPreprocessorNs.IContext, vRawValue: js.Any): java.lang.String = js.native
  /**
             * A formatter function to be used in a complex binding inside an XML template viewin order to
             * interpret OData V4 annotations. It knows about the following dynamicexpressions:<ul><li>"14.5.2
             * Expression edm:AnnotationPath"</li><li>"14.5.11 Expression
             ...
             * (this is treated as falsy in <code>template:if</code>  statements!)
            */
  def getNavigationPath(oInterface: openui5Lib.sapNs.uiNs.modelNs.Context): java.lang.String = js.native
  /**
             * A formatter function to be used in a complex binding inside an XML template viewin order to
             * interpret OData V4 annotations. It knows about the following dynamicexpressions:<ul><li>"14.5.2
             * Expression edm:AnnotationPath"</li><li>"14.5.11 Expression
             ...
             * (this is treated as falsy in <code>template:if</code>  statements!)
            */
  def getNavigationPath(oInterface: openui5Lib.sapNs.uiNs.modelNs.Context, vRawValue: js.Any): java.lang.String = js.native
  /**
            ...
            */
  def gotoEntitySet(oContext: openui5Lib.sapNs.uiNs.modelNs.Context): java.lang.String = js.native
  /**
            ...
            */
  def gotoEntityType(oContext: openui5Lib.sapNs.uiNs.modelNs.Context): java.lang.String = js.native
  /**
            ...
            */
  def gotoFunctionImport(oContext: openui5Lib.sapNs.uiNs.modelNs.Context): java.lang.String = js.native
  /**
             * A formatter function to be used in a complex binding inside an XML template viewin order to
             * interpret OData V4 annotations. It knows about the following dynamicexpressions:<ul><li>"14.5.2
             * Expression edm:AnnotationPath"</li><li>"14.5.11 Expression
            ...
            */
  def isMultiple(oInterface: openui5Lib.sapNs.uiNs.coreNs.utilNs.XMLPreprocessorNs.IContext): java.lang.String = js.native
  /**
             * A formatter function to be used in a complex binding inside an XML template viewin order to
             * interpret OData V4 annotations. It knows about the following dynamicexpressions:<ul><li>"14.5.2
             * Expression edm:AnnotationPath"</li><li>"14.5.11 Expression
             ...
             * otherwise (the latter are both treated as falsy   in <code>template:if</code> statements!)
            */
  def isMultiple(oInterface: openui5Lib.sapNs.uiNs.coreNs.utilNs.XMLPreprocessorNs.IContext, vRawValue: js.Any): java.lang.String = js.native
  /**
             * A formatter function to be used in a complex binding inside an XML template viewin order to
             * interpret OData V4 annotations. It knows about the following dynamicexpressions:<ul><li>"14.5.2
             * Expression edm:AnnotationPath"</li><li>"14.5.11 Expression
             ...
             * otherwise (the latter are both treated as falsy   in <code>template:if</code> statements!)
            */
  def isMultiple(oInterface: openui5Lib.sapNs.uiNs.modelNs.Context): java.lang.String = js.native
  /**
             * A formatter function to be used in a complex binding inside an XML template viewin order to
             * interpret OData V4 annotations. It knows about the following dynamicexpressions:<ul><li>"14.5.2
             * Expression edm:AnnotationPath"</li><li>"14.5.11 Expression
             ...
             * otherwise (the latter are both treated as falsy   in <code>template:if</code> statements!)
            */
  def isMultiple(oInterface: openui5Lib.sapNs.uiNs.modelNs.Context, vRawValue: js.Any): java.lang.String = js.native
  /**
            ...
            */
  def resolvePath(oContext: openui5Lib.sapNs.uiNs.modelNs.Context): java.lang.String = js.native
  /**
             ...
             * @returns the resulting string value to write into the processed XML
            */
  def simplePath(oInterface: openui5Lib.sapNs.uiNs.coreNs.utilNs.XMLPreprocessorNs.IContext): java.lang.String = js.native
  /**
             * Formatter function that is used in a complex binding inside an XML template view.The function is
             * used to interpret OData V4 annotations, supporting the sameannotations as {@link #.format format}
             * but with a simplified output aimed atdesign-time templating with smart controls.In contrast to
             ...
             * @returns the resulting string value to write into the processed XML
            */
  def simplePath(oInterface: openui5Lib.sapNs.uiNs.coreNs.utilNs.XMLPreprocessorNs.IContext, vRawValue: js.Any): java.lang.String = js.native
  /**
             * Formatter function that is used in a complex binding inside an XML template view.The function is
             * used to interpret OData V4 annotations, supporting the sameannotations as {@link #.format format}
             * but with a simplified output aimed atdesign-time templating with smart controls.In contrast to
             ...
             * @returns the resulting string value to write into the processed XML
            */
  def simplePath(oInterface: openui5Lib.sapNs.uiNs.modelNs.Context): java.lang.String = js.native
  /**
             * Formatter function that is used in a complex binding inside an XML template view.The function is
             * used to interpret OData V4 annotations, supporting the sameannotations as {@link #.format format}
             * but with a simplified output aimed atdesign-time templating with smart controls.In contrast to
             ...
             * @returns the resulting string value to write into the processed XML
            */
  def simplePath(oInterface: openui5Lib.sapNs.uiNs.modelNs.Context, vRawValue: js.Any): java.lang.String = js.native
}
