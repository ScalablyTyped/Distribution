...
class IconTabHeader protected ()
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertItem(oItem: IconTab, iIndex: scala.Double): IconTabHeader = js.native
  /**
  ...
  /**
    ...
    */
  def setSelectedKey(sKey: java.lang.String): IconTabHeader = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowSelection(bShowSelection: scala.Boolean): IconTabHeader = js.native
}
