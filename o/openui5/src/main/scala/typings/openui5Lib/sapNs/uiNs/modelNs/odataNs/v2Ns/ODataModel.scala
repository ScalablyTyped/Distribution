...
class ODataModel protected ()
  ...
  /**
    ...
    */
  def createEntry(sPath: java.lang.String, mParameters: js.Any): openui5Lib.sapNs.uiNs.modelNs.Context = js.native
  /**
    ...
    */
  def createKey(sCollection: java.lang.String, oKeyProperties: js.Any): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def forceEntityUpdate(sKey: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getETag(sPath: java.lang.String): java.lang.String = js.native
  def getETag(sPath: java.lang.String, oContext: openui5Lib.sapNs.uiNs.modelNs.Context): java.lang.String = js.native
  def getETag(sPath: java.lang.String, oContext: openui5Lib.sapNs.uiNs.modelNs.Context, oEntity: js.Any): java.lang.String = js.native
  /**
  ...
  /**
    ...
    * @returns [sKey] key of the entry
    */
  def getKey(vValue: java.lang.String): java.lang.String = js.native
  def getKey(vValue: js.Any): java.lang.String = js.native
  def getKey(vValue: openui5Lib.sapNs.uiNs.modelNs.Context): java.lang.String = js.native
  ...
  /**
    ...
    */
  def metadataLoaded(): jqueryLib.JQueryPromise[_] = js.native
  /**
  ...
  def refresh(bForceUpdate: scala.Boolean, bRemoveData: scala.Boolean, sGroupId: java.lang.String): scala.Unit = js.native
  /**
    ...
    * currently refreshed.
    */
  def refreshMetadata(): jqueryLib.JQueryPromise[_] = js.native
  /**
  ...
  /**
    ...
    * resetted.
    */
  def resetChanges(aPath: js.Array[_]): scala.Unit = js.native
  /**
    * Returns a promise, which will resolve with the security token as soon as it is available
    * @returns the CSRF security token
    */
  def securityTokenAvailable(): jqueryLib.JQueryPromise[_] = js.native
  /**
    ...
    */
  def setChangeBatchGroups(mGroups: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def setChangeGroups(mGroups: js.Any): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def setDeferredBatchGroups(aGroupIds: js.Array[_]): scala.Unit = js.native
  /**
    ...
    */
  def setDeferredGroups(aGroupIds: js.Array[_]): scala.Unit = js.native
  /**
