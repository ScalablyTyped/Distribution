...
class Targets protected ()
  ...
  /**
            ...
            */
  def addTarget(sName: java.lang.String, oTarget: js.Any): Targets = js.native
  /**
  ...
  /**
            ...
            */
  def display(vTargets: java.lang.String): Targets = js.native
  /**
             * Creates a view and puts it in an aggregation of the specified control.
             * @param vTargets the key of the target as specified in the {@link #constructor}. To display multiple
             * targets you may also pass an array of keys.
             ...
             * @returns this pointer for chaining
            */
  def display(vTargets: java.lang.String, vData: js.Any): Targets = js.native
  /**
             * Creates a view and puts it in an aggregation of the specified control.
             * @param vTargets the key of the target as specified in the {@link #constructor}. To display multiple
             * targets you may also pass an array of keys.
             ...
             * @returns this pointer for chaining
            */
  def display(vTargets: js.Array[java.lang.String]): Targets = js.native
  /**
             * Creates a view and puts it in an aggregation of the specified control.
             * @param vTargets the key of the target as specified in the {@link #constructor}. To display multiple
             * targets you may also pass an array of keys.
             ...
             * @returns this pointer for chaining
            */
  def display(vTargets: js.Array[java.lang.String], vData: js.Any): Targets = js.native
  /**
  ...
  /**
             ...
             * an error.
            */
  def getTarget(vName: java.lang.String): Target | js.Any | js.Array[Target] = js.native
  /**
             * Returns a target by its name (if you pass myTarget: { view: "myView" }) in the config myTarget is
             * the name.
             * @param vName the name of a single target or the name of multiple targets
             ...
             * an error.
            */
  def getTarget(vName: js.Array[java.lang.String]): Target | js.Any | js.Array[Target] = js.native
  /**
