...
class FeedListItem protected () extends ListItemBase {
  ...
  /**
    ...
    */
  def getSenderActive(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setIconActive(bIconActive: scala.Boolean): FeedListItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setIconDensityAware(bIconDensityAware: scala.Boolean): FeedListItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setInfo(sInfo: java.lang.String): FeedListItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setMaxCharacters(iMaxCharacters: scala.Double): FeedListItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSender(sSender: java.lang.String): FeedListItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSenderActive(bSenderActive: scala.Boolean): FeedListItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowIcon(bShowIcon: scala.Boolean): FeedListItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setText(sText: java.lang.String): FeedListItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTimestamp(sTimestamp: java.lang.String): FeedListItem = js.native
}
