...
class ODataAnnotations protected ()
  ...
  def this(aAnnotationURI: java.lang.String, oMetadata: ODataMetadata, mParams: js.Any) = this()
  def this(aAnnotationURI: js.Array[java.lang.String], oMetadata: ODataMetadata, mParams: js.Any) = this()
  /**
            ...
            */
  def addUrl(vUrl: java.lang.String): jqueryLib.JQueryPromise[_] = js.native
  /**
             * Adds either one URL or an array of URLs to be loaded and parsed. The result will be merged into the
             * annotationsdata which can be retrieved using the getAnnotations-method.
             * @param vUrl Either one URL as string or an array of URL strings
             ...
             * success (an array        of sucessfully loaded URLs), fail (an array ob of failed URLs).
            */
  def addUrl(vUrl: js.Array[java.lang.String]): jqueryLib.JQueryPromise[_] = js.native
  /**
  ...
  /**
            ...
            */
  def setXML(oXMLDocument: js.Any, sXMLContent: java.lang.String): scala.Boolean = js.native
  /**
             * Sets an XML document
             * @param oXMLDocument The XML document to parse for annotations
             * @param sXMLContent The XML content as string to parse for annotations
             ...
             * @returns Whether or not parsing was successful
            */
  def setXML(oXMLDocument: js.Any, sXMLContent: java.lang.String, mOptions: js.Any): scala.Boolean = js.native
}
