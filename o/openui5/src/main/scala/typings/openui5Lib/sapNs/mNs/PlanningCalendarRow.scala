...
class PlanningCalendarRow protected ()
  ...
  /**
    ...
    */
  def addAppointment(oAppointment: openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment): PlanningCalendarRow = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def addIntervalHeader(oIntervalHeader: openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment): PlanningCalendarRow = js.native
  /**
  ...
  /**
    ...
    */
  def getAppointments(): js.Array[openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment] = js.native
  /**
  ...
  /**
    ...
    * should be assigned.
    */
  def getIntervalHeaders(): js.Array[openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment] = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfAppointment(oAppointment: openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment): scala.Double = js.native
  /**
    * Checks for the provided <code>sap.ui.unified.CalendarAppointment</code> in the aggregation
    ...
    * @returns The index of the provided control in the aggregation if found, or -1 otherwise
    */
  def indexOfIntervalHeader(oIntervalHeader: openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertAppointment(oAppointment: openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment, iIndex: scala.Double): PlanningCalendarRow = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertIntervalHeader(oIntervalHeader: openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment, iIndex: scala.Double): PlanningCalendarRow = js.native
  /**
    * Removes all the controls from the aggregation <code>appointments</code>.Additionally, it unregisters
    * them from the hosting UIArea.
    * @returns An array of the removed elements (might be empty)
    */
  def removeAllAppointments(): js.Array[openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment] = js.native
  /**
    ...
    * @returns An array of the removed elements (might be empty)
    */
  def removeAllIntervalHeaders(): js.Array[openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment] = js.native
  def removeAppointment(vAppointment: java.lang.String): openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment = js.native
  def removeAppointment(vAppointment: openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment): openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment = js.native
  /**
    ...
    */
  def removeAppointment(vAppointment: scala.Double): openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment = js.native
  def removeIntervalHeader(vIntervalHeader: java.lang.String): openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment = js.native
  def removeIntervalHeader(vIntervalHeader: openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment): openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment = js.native
  /**
    ...
    */
  def removeIntervalHeader(vIntervalHeader: scala.Double): openui5Lib.sapNs.uiNs.unifiedNs.CalendarAppointment = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setKey(sKey: java.lang.String): PlanningCalendarRow = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setNonWorkingDays(sNonWorkingDays: scala.Double): PlanningCalendarRow = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setNonWorkingHours(sNonWorkingHours: scala.Double): PlanningCalendarRow = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSelected(bSelected: scala.Boolean): PlanningCalendarRow = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setText(sText: java.lang.String): PlanningCalendarRow = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTitle(sTitle: java.lang.String): PlanningCalendarRow = js.native
}
