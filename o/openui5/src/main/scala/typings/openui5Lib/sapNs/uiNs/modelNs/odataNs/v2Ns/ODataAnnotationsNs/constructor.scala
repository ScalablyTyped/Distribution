package typings
package openui5Lib.sapNs.uiNs.modelNs.odataNs.v2Ns.ODataAnnotationsNs
...
class constructor protected () extends js.Object {
  /**
                ...
                */
  def this(oMetadata: openui5Lib.sapNs.uiNs.modelNs.odataNs.ODataMetadata, mOptions: js.Any) = this()
}
