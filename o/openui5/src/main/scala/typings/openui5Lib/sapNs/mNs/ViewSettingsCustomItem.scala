...
class ViewSettingsCustomItem protected () extends ViewSettingsItem {
  ...
  /**
        ...
        */
  def getCustomControl(): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
        ...
        */
  def getFilterCount(): scala.Double = js.native
  /**
        ...
        */
  def setCustomControl(oControl: openui5Lib.sapNs.uiNs.coreNs.Control): ViewSettingsCustomItem = js.native
  /**
         ...
         * @returns this pointer for chaining
        */
  def setFilterCount(iValue: scala.Double): ViewSettingsItem = js.native
}
