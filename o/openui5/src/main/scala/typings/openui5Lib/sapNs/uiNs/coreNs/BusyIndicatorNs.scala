...
object BusyIndicatorNs extends js.Object {
  /**
    ...
    */
  def attachClose(fnFunction: js.Any): openui5Lib.TypeofBusyIndicator = js.native
  def attachClose(fnFunction: js.Any, oListener: js.Any): openui5Lib.TypeofBusyIndicator = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def attachOpen(fnFunction: js.Any): openui5Lib.TypeofBusyIndicator = js.native
  def attachOpen(fnFunction: js.Any, oListener: js.Any): openui5Lib.TypeofBusyIndicator = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def detachClose(fnFunction: js.Any, oListener: js.Any): openui5Lib.TypeofBusyIndicator = js.native
  /**
    ...
    * @returns <code>this</code> to allow method chaining
    */
  def detachOpen(fnFunction: js.Any, oListener: js.Any): openui5Lib.TypeofBusyIndicator = js.native
  /**
