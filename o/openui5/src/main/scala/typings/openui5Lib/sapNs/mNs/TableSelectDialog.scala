...
class TableSelectDialog protected ()
  ...
  /**
         ...
         * @returns The index of the provided control in the aggregation if found, or -1 otherwise
        */
  def indexOfItem(oItem: ColumnListItem): scala.Double = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def insertColumn(oColumn: Column, iIndex: scala.Double): TableSelectDialog = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def insertItem(oItem: ColumnListItem, iIndex: scala.Double): TableSelectDialog = js.native
  /**
        ...
        */
  def open(sSearchValue: java.lang.String): TableSelectDialog = js.native
  /**
  ...
  /**
        ...
        */
  def removeItem(vItem: java.lang.String): ColumnListItem = js.native
  /**
         * Removes a item from the aggregation <code>items</code>.
         * @param vItem The item to remove or its index or id
         * @returns The removed item or <code>null</code>
  ...
  /**
         ...
         * @returns The removed item or <code>null</code>
        */
  def removeItem(vItem: scala.Double): ColumnListItem = js.native
  /**
  ...
  /**
         ...
         * @returns this pointer for chaining
        */
  def setGrowingThreshold(iValue: scala.Double): TableSelectDialog = js.native
  /**
         * Enables/Disables multi selection mode.
         * @param bMulti flag for multi selection mode
         * @returns this pointer for chaining
        */
  def setMultiSelect(bMulti: scala.Boolean): TableSelectDialog = js.native
  /**
         * Sets the no data text of the internal table
         * @param sNoDataText the no data text for the table
        */
  def setNoDataText(sNoDataText: java.lang.String): scala.Unit = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setRememberSelections(bRememberSelections: scala.Boolean): TableSelectDialog = js.native
  /**
         * Sets the title of the internal dialog
         * @param sTitle the title text for the dialog
         * @returns this pointer for chaining
        */
  def setTitle(sTitle: java.lang.String): TableSelectDialog = js.native
  /**
