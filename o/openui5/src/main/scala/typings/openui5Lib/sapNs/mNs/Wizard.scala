...
class Wizard protected ()
  ...
  /**
        ...
        */
  def getShowNextButton(): scala.Boolean = js.native
  /**
  ...
  /**
         ...
         * @returns Pointer to the control instance for chaining.
        */
  def goToStep(step: WizardStep, focusFirstStepElement: scala.Boolean): Wizard = js.native
  /**
        ...
        */
  def indexOfStep(oStep: WizardStep): scala.Double = js.native
  /**
         * Dynamic step insertion is not yet supported.
        */
  def insertStep(): scala.Unit = js.native
  /**
  ...
  /**
        ...
        */
  def removeAllSteps(): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
         * Dynamic step removal is not yet supported.
        */
  def removeStep(): scala.Unit = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setEnableBranching(bEnableBranching: scala.Boolean): Wizard = js.native
  /**
        ...
        */
  def setFinishButtonText(value: java.lang.String): Wizard = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to the control instance for chaining.
        */
  def setShowNextButton(value: scala.Boolean): Wizard = js.native
  /**
