...
class ListBase protected ()
  ...
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): ListBase = js.native
  /**
  ...
  /**
    ...
    */
  def fireSwipe(mArguments: js.Any): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getEnableBusyIndicator(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getGrowing(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getGrowingScrollToLoad(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getGrowingTriggerText(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getIncludeItemInSelection(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getInset(): scala.Boolean = js.native
  /**
    * Returns ItemNavigation for controls uses List
    * @since 1.16.5
    */
  def getItemNavigation(): openui5Lib.sapNs.uiNs.coreNs.delegateNs.ItemNavigation | js.Any = js.native
  /**
  ...
  /**
    ...
    * rendering
    */
  def getLastMode(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getModeAnimationOn(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * returned in array.
    */
  def getSelectedContexts(bAll: scala.Boolean): js.Array[_] = js.native
  /**
  ...
  /**
    ...
    */
  def getShowNoData(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getShowUnread(): scala.Boolean = js.native
  /**
    ...
    */
  def getSwipeContent(): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertItem(oItem: ListItemBase, iIndex: scala.Double): ListBase = js.native
  /**
  ...
  /**
    ...
    */
  def removeSelections(bAll: scala.Boolean): ListBase = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setEnableBusyIndicator(bEnableBusyIndicator: scala.Boolean): ListBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setFooterText(sFooterText: java.lang.String): ListBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setGrowing(bGrowing: scala.Boolean): ListBase = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setGrowingScrollToLoad(bGrowingScrollToLoad: scala.Boolean): ListBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setGrowingThreshold(iGrowingThreshold: scala.Double): ListBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setGrowingTriggerText(sGrowingTriggerText: java.lang.String): ListBase = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setHeaderText(sHeaderText: java.lang.String): ListBase = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setIncludeItemInSelection(bIncludeItemInSelection: scala.Boolean): ListBase = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setInset(bInset: scala.Boolean): ListBase = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setModeAnimationOn(bModeAnimationOn: scala.Boolean): ListBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setNoDataText(sNoDataText: java.lang.String): ListBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setRememberSelections(bRememberSelections: scala.Boolean): ListBase = js.native
  /**
    ...
    */
  def setSelectedItem(oListItem: ListItemBase, bSelect: scala.Boolean): ListBase = js.native
  /**
    ...
    * @param bSelect Sets selected status of the list item. Default value is true.
    */
  def setSelectedItemById(sId: java.lang.String, bSelect: scala.Boolean): ListBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowNoData(bShowNoData: scala.Boolean): ListBase = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowUnread(bShowUnread: scala.Boolean): ListBase = js.native
  /**
    * Sets the aggregated <code>swipeContent</code>.
    * @param oSwipeContent The swipeContent to set
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSwipeContent(oSwipeContent: openui5Lib.sapNs.uiNs.coreNs.Control): ListBase = js.native
  /**
