...
class UIArea protected ()
  ...
  /**
    ...
    */
  def getRootControl(idx: scala.Double): Control = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfContent(oContent: Control): scala.Double = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertContent(oContent: Control, iIndex: scala.Double): UIArea = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertDependent(oDependent: Control, iIndex: scala.Double): UIArea = js.native
  /**
  ...
  def removeContent(vContent: java.lang.String): Control = js.native
  ...
  /**
    ...
    */
  def removeContent(vContent: scala.Double): Control = js.native
  ...
  /**
    ...
    */
  def setRootControl(oRootControl: openui5Lib.sapNs.uiNs.baseNs.Interface): scala.Unit = js.native
  def setRootControl(oRootControl: Control): scala.Unit = js.native
  /**
    ...
    */
  def setRootNode(oRootNode: js.Any): scala.Unit = js.native
  /**
