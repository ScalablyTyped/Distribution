...
class Select protected ()
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): Select = js.native
  /**
         * Adds an item to the aggregation named <code>items</code>.
         * @param oItem The item to be added; if empty, nothing is added.
         * @returns <code>this</code> to allow method chaining.
        */
  def addItem(oItem: openui5Lib.sapNs.uiNs.coreNs.Item): Select = js.native
  /**
  ...
  /**
        ...
        */
  def getAutoAdjustWidth(): scala.Boolean = js.native
  /**
  ...
  /**
        ...
        */
  def getFirstItem(): openui5Lib.sapNs.uiNs.coreNs.Item | js.Any = js.native
  /**
        ...
        */
  def getForceSelection(): scala.Boolean = js.native
  /**
  ...
  /**
        ...
        */
  def getItemAt(iIndex: scala.Double): openui5Lib.sapNs.uiNs.coreNs.Item | js.Any = js.native
  /**
        ...
        */
  def getItemByKey(sKey: java.lang.String): openui5Lib.sapNs.uiNs.coreNs.Item | js.Any = js.native
  /**
  ...
  /**
        ...
        */
  def getLastItem(): openui5Lib.sapNs.uiNs.coreNs.Item | js.Any = js.native
  /**
  ...
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def insertItem(oItem: openui5Lib.sapNs.uiNs.coreNs.Item, iIndex: scala.Double): Select = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setAutoAdjustWidth(bAutoAdjustWidth: scala.Boolean): Select = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setEnabled(bEnabled: scala.Boolean): Select = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setForceSelection(bForceSelection: scala.Boolean): Select = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setName(sName: java.lang.String): Select = js.native
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def setSelectedItem(vItem: java.lang.String): Select = js.native
  /**
         * Sets the <code>selectedItem</code> association.Default value is <code>null</code>.
         * @param vItem New value for the <code>selectedItem</code> association.If an ID of a
         * <code>sap.ui.core.Item</code> is given, the item with this ID becomes the <code>selectedItem</code>
  ...
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def setSelectedItem(vItem: openui5Lib.sapNs.uiNs.coreNs.Item): Select = js.native
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def setSelectedItemId(vItem: java.lang.String): Select = js.native
  /**
         * Sets the <code>selectedItemId</code> property.Default value is an empty string <code>""</code> or
         * <code>undefined</code>.
         * @since 1.12
  ...
  /**
         ...
         * @returns <code>this</code> to allow method chaining.
        */
  def setSelectedKey(sKey: java.lang.String): Select = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setShowSecondaryValues(bShowSecondaryValues: scala.Boolean): Select = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setTextAlign(sTextAlign: openui5Lib.sapNs.uiNs.coreNs.TextAlign): Select = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setTextDirection(sTextDirection: openui5Lib.sapNs.uiNs.coreNs.TextDirection): Select = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setValueState(sValueState: openui5Lib.sapNs.uiNs.coreNs.ValueState): Select = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setValueStateText(sValueStateText: java.lang.String): Select = js.native
  /**
