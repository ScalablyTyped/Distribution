...
@JSGlobal("sap.ui.unified.ShellHeadItem")
@js.native
class ShellHeadItem protected ()
  ...
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): ShellHeadItem = js.native
  /**
  ...
  /**
          ...
          */
  def getShowMarker(): scala.Boolean = js.native
  /**
          ...
          */
  def getShowSeparator(): scala.Boolean = js.native
  /**
  ...
  /**
          ...
          */
  def getToggleEnabled(): scala.Boolean = js.native
  /**
  ...
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setSelected(bSelected: scala.Boolean): ShellHeadItem = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setShowMarker(bShowMarker: scala.Boolean): ShellHeadItem = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setShowSeparator(bShowSeparator: scala.Boolean): ShellHeadItem = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setStartsSection(bStartsSection: scala.Boolean): ShellHeadItem = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setToggleEnabled(bToggleEnabled: scala.Boolean): ShellHeadItem = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setVisible(bVisible: scala.Boolean): ShellHeadItem = js.native
}
