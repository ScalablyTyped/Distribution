...
@js.native
class QuickViewGroupElement protected ()
  ...
  /**
    ...
    */
  def getEmailSubject(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getPageLinkId(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def setEmailSubject(sEmailSubject: java.lang.String): QuickViewGroupElement = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setLabel(sLabel: java.lang.String): QuickViewGroupElement = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setPageLinkId(sPageLinkId: java.lang.String): QuickViewGroupElement = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTarget(sTarget: java.lang.String): QuickViewGroupElement = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setUrl(sUrl: java.lang.String): QuickViewGroupElement = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setValue(sValue: java.lang.String): QuickViewGroupElement = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setVisible(bVisible: scala.Boolean): QuickViewGroupElement = js.native
}
