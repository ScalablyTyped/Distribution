...
class LocaleData protected ()
  ...
  /**
          ...
          */
  def getCalendarWeek(sStyle: java.lang.String, iWeekNumber: scala.Double): java.lang.String = js.native
  /**
          ...
          */
  def getCombinedDateTimePattern(sDateStyle: java.lang.String, sTimeStyle: java.lang.String): java.lang.String = js.native
  /**
           * Get combined datetime pattern with given date and and time style
           * @param sDateStyle the required style for the date part
           * @param sTimeStyle the required style for the time part
           ...
           * @returns the combined datetime pattern
          */
  def getCombinedDateTimePattern(sDateStyle: java.lang.String, sTimeStyle: java.lang.String, sCalendarType: CalendarType): java.lang.String = js.native
  /**
          ...
          */
  def getCurrencyCodeBySymbol(sCurrencySymbol: java.lang.String): java.lang.String = js.native
  /**
          ...
          */
  def getCurrencyDigits(sCurrency: java.lang.String): scala.Double = js.native
  /**
           * Get currency format pattern
           * @param sContext the context of the currency pattern (standard or accounting)
           * @returns The pattern
          */
  def getCurrencyPattern(sContext: java.lang.String): java.lang.String = js.native
  /**
          ...
          */
  def getCurrencySymbol(sCurrency: java.lang.String): java.lang.String = js.native
  /**
          ...
          */
  def getCustomDateTimePattern(sSkeleton: java.lang.String): java.lang.String = js.native
  /**
           * Get custom datetime pattern for a given skeleton format.The format string does contain pattern
           * symbols (e.g. "yMMMd" or "Hms") and will be converted into the pattern in the usedlocale, which
           * matches the wanted symbols best. The symbols must be in canonical order, that is:Era (G), Year
           ...
           * @returns the best matching datetime pattern
          */
  def getCustomDateTimePattern(sSkeleton: java.lang.String, sCalendarType: CalendarType): java.lang.String = js.native
  /**
          ...
          */
  def getDatePattern(sStyle: java.lang.String): java.lang.String = js.native
  /**
           * Get date pattern in format "short", "medium", "long" or "full"
           * @param sStyle the required style for the date pattern
           * @param sCalendarType the type of calendar. If it's not set, it falls back to the calendar type
           ...
           * @returns the selected date pattern
          */
  def getDatePattern(sStyle: java.lang.String, sCalendarType: CalendarType): java.lang.String = js.native
  /**
          ...
          */
  def getDateTimePattern(sStyle: java.lang.String): java.lang.String = js.native
  /**
           * Get datetime pattern in style "short", "medium", "long" or "full"
           * @param sStyle the required style for the datetime pattern
           * @param sCalendarType the type of calendar. If it's not set, it falls back to the calendar type
           ...
           * @returns the selected datetime pattern
          */
  def getDateTimePattern(sStyle: java.lang.String, sCalendarType: CalendarType): java.lang.String = js.native
  /**
          ...
          */
  def getDayPeriods(sWidth: java.lang.String): js.Array[_] = js.native
  /**
           * Get day periods in width "narrow", "abbreviated" or "wide"
           * @param sWidth the required width for the day period names
           * @param sCalendarType the type of calendar. If it's not set, it falls back to the calendar type
           ...
           * @returns array of day periods (AM, PM)
          */
  def getDayPeriods(sWidth: java.lang.String, sCalendarType: CalendarType): js.Array[_] = js.native
  /**
           ...
           * @returns array of day periods (AM, PM)
          */
  def getDayPeriodsStandAlone(sWidth: java.lang.String): js.Array[_] = js.native
  /**
           * Get standalone day periods in width "narrow", "abbreviated" or "wide"
           * @param sWidth the required width for the day period names
           * @param sCalendarType the type of calendar. If it's not set, it falls back to the calendar type
           ...
           * @returns array of day periods (AM, PM)
          */
  def getDayPeriodsStandAlone(sWidth: java.lang.String, sCalendarType: CalendarType): js.Array[_] = js.native
  /**
          ...
          */
  def getDays(sWidth: java.lang.String): js.Array[_] = js.native
  /**
           * Get day names in width "narrow", "abbreviated" or "wide"
           * @param sWidth the required width for the day names
           * @param sCalendarType the type of calendar. If it's not set, it falls back to the calendar type
           ...
           * @returns array of day names (starting with Sunday)
          */
  def getDays(sWidth: java.lang.String, sCalendarType: CalendarType): js.Array[_] = js.native
  /**
           ...
           * @returns array of day names (starting with Sunday)
          */
  def getDaysStandAlone(sWidth: java.lang.String): js.Array[_] = js.native
  /**
           * Get stand alone day names in width "narrow", "abbreviated" or "wide"
           * @param sWidth the required width for the day names
           * @param sCalendarType the type of calendar. If it's not set, it falls back to the calendar type
           ...
           * @returns array of day names (starting with Sunday)
          */
  def getDaysStandAlone(sWidth: java.lang.String, sCalendarType: CalendarType): js.Array[_] = js.native
  /**
          ...
          */
  def getDecimalFormat(sStyle: java.lang.String, sNumber: java.lang.String, sPlural: java.lang.String): java.lang.String = js.native
  /**
           * Get decimal format pattern
           * @returns The pattern
          */
  def getDecimalPattern(): java.lang.String = js.native
  /**
          ...
          */
  def getDisplayName(sType: java.lang.String): scala.Unit = js.native
  /**
           * Returns the display name for a time unit (second, minute, hour, day, week, month, year)
           * @since 1.34.0
           * @param sType Type (second, minute, hour, day, week, month, year)
           ...
           * and "narrow"returns {string} display name
          */
  def getDisplayName(sType: java.lang.String, sStyle: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
          ...
          */
  def getEras(sWidth: java.lang.String): js.Array[_] = js.native
  /**
           * Returns array of eras
           * @since 1.32.0
           * @param sWidth the style of the era name. It can be 'wide', 'abbreviated' or 'narrow'
           ...
           * @returns the array of eras
          */
  def getEras(sWidth: java.lang.String, sCalendarType: CalendarType): js.Array[_] = js.native
  /**
  ...
  /**
          ...
          */
  def getIntervalPattern(sId: java.lang.String): java.lang.String = js.native
  /**
           * Returns the interval format with the given Id (see CLDR documentation for valid Ids)or the fallback
           * format if no interval format with that Id is known.The empty Id ("") might be used to retrieve the
           * interval format fallback.
           ...
           * @returns interval format string with placeholders {0} and {1}
          */
  def getIntervalPattern(sId: java.lang.String, sCalendarType: CalendarType): java.lang.String = js.native
  /**
  ...
  /**
          ...
          */
  def getMonths(sWidth: java.lang.String): js.Array[_] = js.native
  /**
           * Get month names in width "narrow", "abbreviated" or "wide"
           * @param sWidth the required width for the month names
           * @param sCalendarType the type of calendar. If it's not set, it falls back to the calendar type
           ...
           * @returns array of month names (starting with January)
          */
  def getMonths(sWidth: java.lang.String, sCalendarType: CalendarType): js.Array[_] = js.native
  /**
           ...
           * @returns array of month names (starting with January)
          */
  def getMonthsStandAlone(sWidth: java.lang.String): js.Array[_] = js.native
  /**
           * Get stand alone month names in width "narrow", "abbreviated" or "wide"
           * @param sWidth the required width for the month names
           * @param sCalendarType the type of calendar. If it's not set, it falls back to the calendar type
           ...
           * @returns array of month names (starting with January)
          */
  def getMonthsStandAlone(sWidth: java.lang.String, sCalendarType: CalendarType): js.Array[_] = js.native
  /**
          ...
          */
  def getNumberSymbol(sType: java.lang.String): java.lang.String = js.native
  /**
  ...
  /**
           ...
           * @returns The pattern
          */
  def getPercentPattern(): java.lang.String = js.native
  /**
           ...
           * @since 1.28.6
          */
  def getPreferredCalendarType(): scala.Unit = js.native
  /**
           ...
           * @since 1.34
          */
  def getPreferredHourSymbol(): scala.Unit = js.native
  /**
          ...
          */
  def getQuarters(sWidth: java.lang.String): js.Array[_] = js.native
  /**
           * Get quarter names in width "narrow", "abbreviated" or "wide"
           * @param sWidth the required width for the quarter names
           * @param sCalendarType the type of calendar. If it's not set, it falls back to the calendar type
           ...
           * @returns array of quarters
          */
  def getQuarters(sWidth: java.lang.String, sCalendarType: CalendarType): js.Array[_] = js.native
  /**
           ...
           * @returns array of quarters
          */
  def getQuartersStandAlone(sWidth: java.lang.String): js.Array[_] = js.native
  /**
           * Get stand alone quarter names in width "narrow", "abbreviated" or "wide"
           * @param sWidth the required width for the quarter names
           * @param sCalendarType the type of calendar. If it's not set, it falls back to the calendar type
           ...
           * @returns array of quarters
          */
  def getQuartersStandAlone(sWidth: java.lang.String, sCalendarType: CalendarType): js.Array[_] = js.native
  /**
          ...
          */
  def getRelativeDay(iDiff: scala.Double): java.lang.String = js.native
  /**
           * Returns the relative day resource pattern (like "Today", "Yesterday", "{0} days ago") based on the
           * givendifference of days (0 means today, 1 means tommorrow, -1 means yesterday, ...).
           * @since 1.25.0
           ...
           * @returns the relative day resource pattern
          */
  def getRelativeDay(iDiff: scala.Double, sStyle: java.lang.String): java.lang.String = js.native
  /**
           ...
           * parameter.
          */
  def getRelativeHour(iDiff: scala.Double): java.lang.String | js.Any = js.native
  /**
           * Returns the relative resource pattern with unit 'hour' (like "in {0} hour(s)", "{0} hour(s) ago"
           * under locale 'en') based on the givendifference value (positive value means in the future and
           * negative value means in the past).There's no pattern defined for 0 difference and the function
           ...
           * parameter.
          */
  def getRelativeHour(iDiff: scala.Double, sStyle: java.lang.String): java.lang.String | js.Any = js.native
  /**
           ...
           * parameter.
          */
  def getRelativeMinute(iDiff: scala.Double): java.lang.String | js.Any = js.native
  /**
           * Returns the relative resource pattern with unit 'minute' (like "in {0} minute(s)", "{0} minute(s)
           * ago" under locale 'en') based on the givendifference value (positive value means in the future and
           * negative value means in the past).There's no pattern defined for 0 difference and the function
           ...
           * parameter.
          */
  def getRelativeMinute(iDiff: scala.Double, sStyle: java.lang.String): java.lang.String | js.Any = js.native
  /**
          ...
          */
  def getRelativeMonth(iDiff: scala.Double): java.lang.String = js.native
  /**
           * Returns the relative month resource pattern (like "This month", "Last month", "{0} months ago")
           * based on the givendifference of months (0 means this month, 1 means next month, -1 means last month,
           * ...).
           ...
           * @returns the relative month resource pattern
          */
  def getRelativeMonth(iDiff: scala.Double, sStyle: java.lang.String): java.lang.String = js.native
  /**
          ...
          */
  def getRelativePattern(sScale: java.lang.String, iDiff: scala.Double): java.lang.String = js.native
  /**
           * Returns the relative format pattern with given scale (year, month, week, ...) and difference value
           * @since 1.34
           * @param sScale the scale the relative pattern is needed for
           ...
           * @returns the relative format pattern
          */
  def getRelativePattern(sScale: java.lang.String, iDiff: scala.Double, bFuture: scala.Boolean): java.lang.String = js.native
  /**
           * Returns the relative format pattern with given scale (year, month, week, ...) and difference value
           * @since 1.34
           * @param sScale the scale the relative pattern is needed for
           ...
           * @returns the relative format pattern
          */
  def getRelativePattern(sScale: java.lang.String, iDiff: scala.Double, bFuture: scala.Boolean, sStyle: java.lang.String): java.lang.String = js.native
  /**
          ...
          */
  def getRelativePatterns(aScales: js.Array[java.lang.String]): js.Array[_] = js.native
  /**
           * Returns relative time patterns for the given scales as an array of objects containing scale, value
           * and pattern.The array may contain the following values: "year", "month", "week", "day", "hour",
           * "minute" and "second". Ifno scales are given, patterns for all available scales will be returned.The
           ...
           * @returns An array of all relative time patterns
          */
  def getRelativePatterns(aScales: js.Array[java.lang.String], sStyle: java.lang.String): js.Array[_] = js.native
  /**
          ...
          */
  def getRelativeSecond(iDiff: scala.Double): java.lang.String = js.native
  /**
           * Returns the relative resource pattern with unit 'second' (like now, "in {0} seconds", "{0} seconds
           * ago" under locale 'en') based on the givendifference value (0 means now, positive value means in the
           * future and negative value means in the past).
           ...
           * @returns the relative resource pattern in unit 'second'
          */
  def getRelativeSecond(iDiff: scala.Double, sStyle: java.lang.String): java.lang.String = js.native
  /**
          ...
          */
  def getRelativeWeek(iDiff: scala.Double): java.lang.String = js.native
  /**
           * Returns the relative week resource pattern (like "This week", "Last week", "{0} weeks ago") based on
           * the givendifference of weeks (0 means this week, 1 means next week, -1 means last week, ...).
           * @since 1.31.0
           ...
           * @returns the relative week resource pattern
          */
  def getRelativeWeek(iDiff: scala.Double, sStyle: java.lang.String): java.lang.String = js.native
  /**
          ...
          */
  def getRelativeYear(iDiff: scala.Double): java.lang.String = js.native
  /**
           * Returns the relative year resource pattern (like "This year", "Last year", "{0} year ago") based on
           * the givendifference of years (0 means this year, 1 means next year, -1 means last year, ...).
           * @since 1.25.0
           ...
           * @returns the relative year resource pattern
          */
  def getRelativeYear(iDiff: scala.Double, sStyle: java.lang.String): java.lang.String = js.native
  /**
  ...
  /**
          ...
          */
  def getTimePattern(sStyle: java.lang.String): java.lang.String = js.native
  /**
           * Get time pattern in style "short", "medium", "long" or "full"
           * @param sStyle the required style for the date pattern
           * @param sCalendarType the type of calendar. If it's not set, it falls back to the calendar type
           ...
           * @returns the selected time pattern
          */
  def getTimePattern(sStyle: java.lang.String, sCalendarType: CalendarType): java.lang.String = js.native
  /**
