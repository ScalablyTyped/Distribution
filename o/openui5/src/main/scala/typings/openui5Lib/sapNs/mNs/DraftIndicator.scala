...
abstract class DraftIndicator protected ()
  ...
  /**
        ...
        */
  def clearDraftState(): scala.Unit = js.native
  /**
        ...
        */
  def getMinDisplayTime(): scala.Double = js.native
  /**
  ...
  /**
        ...
        */
  def setMinDisplayTime(iMinDisplayTime: scala.Double): DraftIndicator = js.native
  /**
         * Sets the indicator in "Saved" state
        */
  def showDraftSaved(): scala.Unit = js.native
  /**
         * Sets the indicator in "Saving..." state
        */
  def showDraftSaving(): scala.Unit = js.native
}
