...
class ODataMetaModel protected ()
  ...
  /**
            ...
            */
  def getODataAssociationEnd(oEntityType: js.Any, sName: java.lang.String): js.Any = js.native
  /**
            ...
            */
  def getODataAssociationSetEnd(oEntityType: js.Any, sName: java.lang.String): js.Any = js.native
  /**
            ...
            */
  def getODataComplexType(sQualifiedName: java.lang.String): js.Any | java.lang.String = js.native
  /**
             * Returns the OData complex type with the given qualified name, either as a path or as anobject, as
             * indicated.
             * @param sQualifiedName a qualified name, e.g. "ACME.Address"
             ...
             * a path) or <code>null</code> (for an object) if no such type is found
            */
  def getODataComplexType(sQualifiedName: java.lang.String, bAsPath: scala.Boolean): js.Any | java.lang.String = js.native
  /**
            ...
            */
  def getODataEntityContainer(bAsPath: scala.Boolean): js.Any | java.lang.String = js.native
  /**
            ...
            */
  def getODataEntitySet(sName: java.lang.String): js.Any | java.lang.String = js.native
  /**
             * Returns the OData entity set with the given simple name from the default entity container.
             * @param sName a simple name, e.g. "ProductSet"
             * @param bAsPath determines whether the entity set is returned as a path or as an object
             ...
             * path) or <code>null</code> (for an object) if no such set is found
            */
  def getODataEntitySet(sName: java.lang.String, bAsPath: scala.Boolean): js.Any | java.lang.String = js.native
  /**
            ...
            */
  def getODataEntityType(sQualifiedName: java.lang.String): js.Any | java.lang.String = js.native
  /**
             * Returns the OData entity type with the given qualified name, either as a path or as anobject, as
             * indicated.
             * @param sQualifiedName a qualified name, e.g. "ACME.Product"
             ...
             * path) or <code>null</code> (for an object) if no such type is found
            */
  def getODataEntityType(sQualifiedName: java.lang.String, bAsPath: scala.Boolean): js.Any | java.lang.String = js.native
  /**
            ...
            */
  def getODataFunctionImport(sName: java.lang.String): js.Any | java.lang.String = js.native
  /**
             * Returns the OData function import with the given simple or qualified name from the defaultentity
             * container or the respective entity container specified in the qualified name.
             * @since 1.29.0
             ...
             * a path) or <code>null</code> (for an object) if no such function import is found
            */
  def getODataFunctionImport(sName: java.lang.String, bAsPath: scala.Boolean): js.Any | java.lang.String = js.native
  /**
            ...
            */
  def getODataProperty(oType: js.Any, vName: java.lang.String): js.Any | java.lang.String = js.native
  /**
             * Returns the given OData type's property (not navigation property!) of given name.If an array is
             * given instead of a single name, it is consumed (via<code>Array.prototype.shift</code>) piece by
             * piece. Each element is interpreted as aproperty name of the current type, and the current type is
             ...
             * <code>null</code> (for an object) if no property was found at all
            */
  def getODataProperty(oType: js.Any, vName: java.lang.String, bAsPath: scala.Boolean): js.Any | java.lang.String = js.native
  /**
             * Returns the given OData type's property (not navigation property!) of given name.If an array is
             * given instead of a single name, it is consumed (via<code>Array.prototype.shift</code>) piece by
             * piece. Each element is interpreted as aproperty name of the current type, and the current type is
             ...
             * <code>null</code> (for an object) if no property was found at all
            */
  def getODataProperty(oType: js.Any, vName: js.Array[java.lang.String]): js.Any | java.lang.String = js.native
  /**
             * Returns the given OData type's property (not navigation property!) of given name.If an array is
             * given instead of a single name, it is consumed (via<code>Array.prototype.shift</code>) piece by
             * piece. Each element is interpreted as aproperty name of the current type, and the current type is
             ...
             * <code>null</code> (for an object) if no property was found at all
            */
  def getODataProperty(oType: js.Any, vName: js.Array[java.lang.String], bAsPath: scala.Boolean): js.Any | java.lang.String = js.native
  /**
            ...
            */
  def getODataValueLists(oPropertyContext: openui5Lib.sapNs.uiNs.modelNs.Context): jqueryLib.JQueryPromise[_] = js.native
  /**
