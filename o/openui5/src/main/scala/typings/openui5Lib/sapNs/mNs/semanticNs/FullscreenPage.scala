...
class FullscreenPage protected () extends ShareMenuPage {
  ...
  /**
    ...
    */
  def getDraftIndicator(): openui5Lib.sapNs.mNs.DraftIndicator = js.native
  /**
  ...
  /**
    ...
    */
  def getPagingAction(): openui5Lib.sapNs.mNs.PagingButton = js.native
  /**
  ...
  /**
    ...
    */
  def getSaveAsTileAction(): openui5Lib.sapNs.mNs.Button = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setDraftIndicator(oDraftIndicator: openui5Lib.sapNs.mNs.DraftIndicator): FullscreenPage = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setPagingAction(oPagingAction: openui5Lib.sapNs.mNs.PagingButton): FullscreenPage = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setSaveAsTileAction(oSaveAsTileAction: openui5Lib.sapNs.mNs.Button): FullscreenPage = js.native
  /**
