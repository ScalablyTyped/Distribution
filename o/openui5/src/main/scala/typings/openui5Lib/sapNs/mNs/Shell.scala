...
class Shell protected ()
  ...
  /**
    ...
    */
  def getApp(): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
    ...
    */
  def getAppWidthLimited(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getBackgroundOpacity(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getHeaderRightText(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getShowLogout(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setApp(oApp: openui5Lib.sapNs.uiNs.coreNs.Control): Shell = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setAppWidthLimited(bAppWidthLimited: scala.Boolean): Shell = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setBackgroundOpacity(fBackgroundOpacity: scala.Double): Shell = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setBackgroundRepeat(bBackgroundRepeat: scala.Boolean): Shell = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setHeaderRightText(sHeaderRightText: java.lang.String): Shell = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowLogout(bShowLogout: scala.Boolean): Shell = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTitle(sTitle: java.lang.String): Shell = js.native
}
