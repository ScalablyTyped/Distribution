...
class ShellHeadUserItem protected ()
  ...
  def addAriaLabelledBy(vAriaLabelledBy: openui5Lib.sapNs.uiNs.coreNs.Control): ShellHeadUserItem = js.native
  /**
  ...
  /**
    ...
    */
  def getShowPopupIndicator(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setShowPopupIndicator(bShowPopupIndicator: scala.Boolean): ShellHeadUserItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setUsername(sUsername: java.lang.String): ShellHeadUserItem = js.native
}
