...
class PropertyBinding protected () extends Binding {
  ...
  /**
    ...
    * @returns the binding mode
    */
  def getBindingMode(): openui5Lib.TypeofBindingMode = js.native
  /**
  ...
  /**
    ...
    */
  def setBindingMode(sBindingMode: openui5Lib.TypeofBindingMode): scala.Unit = js.native
  /**
    ...
    */
  def setExternalValue(oValue: js.Any): scala.Unit = js.native
  /**
    * Sets the optional formatter function for the binding.
    * @param fnFormatter the formatter function for the binding
    */
  def setFormatter(fnFormatter: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def setType(oType: Type, sInternalType: java.lang.String): scala.Unit = js.native
  /**
    ...
    * @param oValue the value to set for this binding
    */
  def setValue(oValue: js.Any): scala.Unit = js.native
}
