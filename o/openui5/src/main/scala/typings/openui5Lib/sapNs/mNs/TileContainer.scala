...
class TileContainer protected ()
  ...
  /**
    ...
    */
  def getAllowAdd(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getPageFirstTileIndex(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfTile(oTile: Tile): scala.Double = js.native
  /**
    ...
    * @returns this pointer for chaining
    */
  def insertTile(oTile: Tile, iIndex: scala.Double): TileContainer = js.native
  /**
    ...
    * @returns this pointer for chaining
    */
  def moveTile(vTile: Tile, iNewIndex: scala.Double): TileContainer = js.native
  /**
  ...
  def removeTile(vTile: java.lang.String): Tile = js.native
  ...
  /**
    ...
    */
  def removeTile(vTile: scala.Double): Tile = js.native
  /**
    ...
    */
  def scrollIntoView(vTile: Tile, bAnimated: scala.Boolean): scala.Unit = js.native
  def scrollIntoView(vTile: scala.Double, bAnimated: scala.Boolean): scala.Unit = js.native
  /**
    * Scrolls one page to the left.
    */
  def scrollLeft(): scala.Unit = js.native
  /**
    * Scrolls one page to the right.
    */
  def scrollRight(): scala.Unit = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setAllowAdd(bAllowAdd: scala.Boolean): TileContainer = js.native
  /**
    ...
    * @returns this pointer for chaining
    */
  def setEditable(bValue: scala.Boolean): TileContainer = js.native
  /**
