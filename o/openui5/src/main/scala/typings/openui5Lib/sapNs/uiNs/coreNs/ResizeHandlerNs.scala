...
object ResizeHandlerNs extends js.Object {
  /**
    ...
    */
  def deregister(sId: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def register(oRef: js.Any, fHandler: js.Any): java.lang.String = js.native
  def register(oRef: openui5Lib.sapNs.uiNs.coreNs.Control, fHandler: js.Any): java.lang.String = js.native
}
