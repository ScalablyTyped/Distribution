...
class GroupHeaderListItem protected () extends ListItemBase {
  ...
  /**
        ...
        */
  def setCount(sCount: java.lang.String): GroupHeaderListItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setTitle(sTitle: java.lang.String): GroupHeaderListItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setTitleTextDirection(sTitleTextDirection: openui5Lib.sapNs.uiNs.coreNs.TextDirection): GroupHeaderListItem = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setUpperCase(bUpperCase: scala.Boolean): GroupHeaderListItem = js.native
}
