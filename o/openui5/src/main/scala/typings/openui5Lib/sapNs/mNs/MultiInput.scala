...
class MultiInput protected () extends Input {
  ...
  /**
    ...
    */
  def addValidator(fValidator: js.Any): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @since 1.28
    */
  def closeMultiLine(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getEnableMultiLineMode(): scala.Boolean = js.native
  /**
    ...
    */
  def getMaxTokens(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfToken(oToken: Token): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertToken(oToken: Token, iIndex: scala.Double): MultiInput = js.native
  /**
    * Focus is on MultiInput
    * @param oEvent undefined
    */
  def onfocusin(oEvent: js.Any): scala.Unit = js.native
  /**
    * When press ESC, deselect all tokens and all texts
    * @param oEvent undefined
    */
  def onsapescape(oEvent: js.Any): scala.Unit = js.native
  /**
    * Expand multi-line MultiInput in multi-line mode
    * @since 1.28
    */
  def openMultiLine(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def removeAllValidators(): scala.Unit = js.native
  def removeToken(vToken: java.lang.String): Token = js.native
  ...
  /**
    ...
    */
  def removeToken(vToken: scala.Double): Token = js.native
  /**
    * Function removes an validation callback
    * @param fValidator undefined
    */
  def removeValidator(fValidator: js.Any): scala.Unit = js.native
  /**
    * Setter for property <code>enableMultiLineMode</code>.
    * @since 1.28
    */
  def setEnableMultiLineMode(): scala.Unit = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setMaxTokens(iMaxTokens: scala.Double): MultiInput = js.native
  /**
    * Function sets an array of tokens, existing tokens will get overridden
    * @param aTokens the new token set
    */
  def setTokens(aTokens: js.Array[Token]): scala.Unit = js.native
}
