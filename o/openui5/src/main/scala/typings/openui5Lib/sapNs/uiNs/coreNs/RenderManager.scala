...
class RenderManager ()
  ...
  /**
    ...
    */
  def addClass(sName: java.lang.String): RenderManager = js.native
  /**
    ...
    * @returns this render manager instance to allow chaining
    */
  def addStyle(sName: java.lang.String, value: java.lang.String): RenderManager = js.native
  def addStyle(sName: java.lang.String, value: scala.Double): RenderManager = js.native
  /**
    ...
    */
  def cleanupControlWithoutRendering(oControl: Control): scala.Unit = js.native
  /**
    ...
    */
  def createInvisiblePlaceholderId(oElement: Element): java.lang.String = js.native
  /**
    ...
    */
  def findPreservedContent(sId: java.lang.String): jqueryLib.JQueryStatic = js.native
  /**
    ...
    */
  def flush(oTargetDomNode: Element, bDoNotPreserve: scala.Boolean, vInsert: scala.Boolean): scala.Unit = js.native
  def flush(oTargetDomNode: Element, bDoNotPreserve: scala.Boolean, vInsert: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getHTML(oControl: Control): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getRenderer(oControl: Control): scala.Unit = js.native
  /**
    * Returns the renderer class for a given control instance
    * @param oControl the control that should be rendered
    * @returns the renderer class for a given control instance
  ...
  /**
    ...
    */
  def preserveContent(oRootNode: Element): scala.Unit = js.native
  def preserveContent(oRootNode: Element, bPreserveRoot: scala.Boolean): scala.Unit = js.native
  def preserveContent(oRootNode: Element, bPreserveRoot: scala.Boolean, bPreserveNodesWithId: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def render(oControl: Control, oTargetDomNode: Element): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def translate(sKey: java.lang.String): scala.Unit = js.native
  /**
    * Write the given texts to the buffer
    * @param sText (can be a number too)
    * @returns this render manager instance to allow chaining
    */
  def write(sText: java.lang.String): RenderManager = js.native
  def write(sText: scala.Double): RenderManager = js.native
  /**
    * @returns this render manager instance to allow chaining
    */
  ...
  /**
    ...
    * @returns this render manager instance to allow chaining
    */
  def writeAttribute(sName: java.lang.String, value: java.lang.String): RenderManager = js.native
  def writeAttribute(sName: java.lang.String, value: scala.Boolean): RenderManager = js.native
  def writeAttribute(sName: java.lang.String, value: scala.Double): RenderManager = js.native
  /**
    ...
    * @returns this render manager instance to allow chaining
    */
  def writeAttributeEscaped(sName: java.lang.String, vValue: js.Any): RenderManager = js.native
  /**
  ...
  def writeClasses(oElement: scala.Boolean): RenderManager = js.native
  /**
  ...
  /**
    ...
    * @returns this render manager instance to allow chaining
    */
  def writeEscaped(sText: java.lang.String, bLineBreaks: scala.Boolean): RenderManager = js.native
  /**
