...
class DataState ()
  ...
  /**
          ...
          */
  def changed(bNewState: scala.Boolean): scala.Boolean = js.native
  /**
  ...
  /**
          ...
          */
  def getControlMessages(): DataState | js.Array[openui5Lib.sapNs.uiNs.coreNs.Message] = js.native
  /**
           * Returns the array of state messages of the control or undefined.
           * @returns the array of messages of the control or null if no {link:sap.ui.core.messages.ModelManager
           * ModelManager} is used.
          */
  def getControlMessages(the: js.Array[openui5Lib.sapNs.uiNs.coreNs.Message]): DataState | js.Array[openui5Lib.sapNs.uiNs.coreNs.Message] = js.native
  /**
  ...
  /**
           ...
           * ModelManager} is used.
          */
  def getMessages(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Message] = js.native
  /**
           ...
           * ModelManager} is used.
          */
  def getModelMessages(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Message] = js.native
  /**
  ...
  /**
          ...
          */
  def isControlDirty(): scala.Boolean = js.native
  /**
  ...
  /**
          ...
          */
  def isLaundering(): scala.Boolean = js.native
  /**
           * Sets an array of control state messages.
           * @param the control messages
           * @returns <code>this</code> to allow method chaining
          */
  def setControlMessages(the: js.Array[openui5Lib.sapNs.uiNs.coreNs.Message]): DataState = js.native
  /**
  ...
  /**
           ...
           * @returns <code>this</code> to allow method chaining
          */
  def setLaundering(bLaundering: scala.Boolean): DataState = js.native
  /**
  ...
  /**
           ...
           * @returns <code>this</code> to allow method chaining
          */
  def setOriginalValue(vOriginalValue: scala.Boolean): DataState = js.native
  /**
