...
class TemplateControl protected ()
  ...
  /**
    ...
    */
  def bindList(sPath: java.lang.String): js.Any = js.native
  /**
    ...
    * @returns the value of the path
    */
  def bindProp(sPath: java.lang.String): js.Any = js.native
  /**
  ...
  def createControl(
    mSettings: js.Any,
    sParentPath: java.lang.String,
    bDoNotAdd: scala.Boolean,
    oView: openui5Lib.sapNs.uiNs.coreNs.mvcNs.View
  ): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
    ...
    */
  def createDOMElement(mSettings: js.Any): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  def createDOMElement(mSettings: js.Any, sParentPath: java.lang.String): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  def createDOMElement(mSettings: js.Any, sParentPath: java.lang.String, bDoNotAdd: scala.Boolean): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
