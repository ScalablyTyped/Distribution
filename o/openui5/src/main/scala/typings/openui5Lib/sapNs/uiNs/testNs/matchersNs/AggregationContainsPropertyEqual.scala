...
class AggregationContainsPropertyEqual protected () extends Matcher {
  ...
  /**
    ...
    */
  def getAggregationName(): java.lang.String = js.native
  /**
    ...
    */
  def getPropertyName(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def setAggregationName(sAggregationName: java.lang.String): AggregationContainsPropertyEqual = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setPropertyName(sPropertyName: java.lang.String): AggregationContainsPropertyEqual = js.native
  /**
