...
class P13nDimMeasurePanel protected () extends P13nPanel {
  ...
  /**
    ...
    */
  def addAvailableChartType(oAvailableChartType: openui5Lib.sapNs.uiNs.coreNs.Item): P13nDimMeasurePanel = js.native
  /**
  ...
  /**
    ...
    * @since 1.34.0
    */
  def getAvailableChartTypes(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Item] = js.native
  /**
    ...
    */
  def getChartTypeKey(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfAvailableChartType(oAvailableChartType: openui5Lib.sapNs.uiNs.coreNs.Item): scala.Double = js.native
  /**
    ...
    * @returns The index of the provided control in the aggregation if found, or -1 otherwise
    */
  def indexOfDimMeasureItem(oDimMeasureItem: P13nDimMeasureItem): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertAvailableChartType(oAvailableChartType: openui5Lib.sapNs.uiNs.coreNs.Item, iIndex: scala.Double): P13nDimMeasurePanel = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertDimMeasureItem(oDimMeasureItem: P13nDimMeasureItem, iIndex: scala.Double): P13nDimMeasurePanel = js.native
  /**
    ...
    */
  def removeAllAvailableChartTypes(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Item] = js.native
  /**
  ...
  def removeAvailableChartType(vAvailableChartType: java.lang.String): openui5Lib.sapNs.uiNs.coreNs.Item = js.native
  def removeAvailableChartType(vAvailableChartType: openui5Lib.sapNs.uiNs.coreNs.Item): openui5Lib.sapNs.uiNs.coreNs.Item = js.native
  /**
    ...
    */
  def removeAvailableChartType(vAvailableChartType: scala.Double): openui5Lib.sapNs.uiNs.coreNs.Item = js.native
  def removeDimMeasureItem(vDimMeasureItem: java.lang.String): P13nDimMeasureItem = js.native
  ...
  /**
    ...
    */
  def removeDimMeasureItem(vDimMeasureItem: scala.Double): P13nDimMeasureItem = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setChartTypeKey(sChartTypeKey: java.lang.String): P13nDimMeasurePanel = js.native
  /**
