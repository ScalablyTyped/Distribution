package typings
package openui5Lib.sapNs.uiNs.coreNs.utilNs.XMLPreprocessorNs
...
trait IContext extends js.Object {
  /**
              ...
              */
  def getInterface(iPart: scala.Double): IContext = js.native
  /**
               * Returns a context interface for the indicated part in case of the root formatterof a composite
               * binding. The new interface provides access to the originalsettings, but only to the model and path
               * of the indicated part:<pre>this.getInterface(i).getSetting(sName) ===
               ...
               * @returns the context interface related to the indicated part
              */
  def getInterface(iPart: scala.Double, sPath: java.lang.String): IContext = js.native
  /**
               ...
               * range
              */
  def getModel(iPart: scala.Double): openui5Lib.sapNs.uiNs.modelNs.Model = js.native
  /**
              ...
              */
  def getPath(iPart: scala.Double): java.lang.String = js.native
  /**
              ...
              */
  def getSetting(sName: java.lang.String): js.Any = js.native
}
