...
class DynamicSideContent protected ()
  ...
  /**
    ...
    */
  def getCurrentBreakpoint(): java.lang.String = js.native
  /**
    ...
    */
  def getEqualSplit(): scala.Boolean = js.native
  /**
    * Gets content of aggregation <code>mainContent</code>.Main content controls.
    */
  def getMainContent(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Control] = js.native
  /**
    * Gets the value of showMainContent property.
    * @returns Side content visibility state
    */
  def getShowMainContent(): scala.Boolean = js.native
  /**
    * Gets the value of showSideContent property.
    * @returns Side content visibility state
    */
  def getShowSideContent(): scala.Boolean = js.native
  /**
    * Gets content of aggregation <code>sideContent</code>.Side content controls.
    */
  def getSideContent(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Control] = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfMainContent(oMainContent: openui5Lib.sapNs.uiNs.coreNs.Control): scala.Double = js.native
  /**
    * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation
    ...
    * @returns The index of the provided control in the aggregation if found, or -1 otherwise
    */
  def indexOfSideContent(oSideContent: openui5Lib.sapNs.uiNs.coreNs.Control): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertMainContent(oMainContent: openui5Lib.sapNs.uiNs.coreNs.Control, iIndex: scala.Double): DynamicSideContent = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertSideContent(oSideContent: openui5Lib.sapNs.uiNs.coreNs.Control, iIndex: scala.Double): DynamicSideContent = js.native
  /**
    * Removes all the controls from the aggregation <code>mainContent</code>.Additionally, it unregisters
    * them from the hosting UIArea.
    * @returns An array of the removed elements (might be empty)
    */
  def removeAllMainContent(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Control] = js.native
  /**
    * Removes all the controls from the aggregation <code>sideContent</code>.Additionally, it unregisters
    * them from the hosting UIArea.
    * @returns An array of the removed elements (might be empty)
    */
  def removeAllSideContent(): js.Array[openui5Lib.sapNs.uiNs.coreNs.Control] = js.native
  def removeMainContent(vMainContent: java.lang.String): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  def removeMainContent(vMainContent: openui5Lib.sapNs.uiNs.coreNs.Control): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
    ...
    */
  def removeMainContent(vMainContent: scala.Double): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  def removeSideContent(vSideContent: java.lang.String): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  def removeSideContent(vSideContent: openui5Lib.sapNs.uiNs.coreNs.Control): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
    ...
    */
  def removeSideContent(vSideContent: scala.Double): openui5Lib.sapNs.uiNs.coreNs.Control = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setContainerQuery(bContainerQuery: scala.Boolean): DynamicSideContent = js.native
  /**
    * Sets or unsets the page in equalSplit mode.
    * @param bState Determines if the page is set to equalSplit mode
    * @returns this pointer for chaining
    */
  def setEqualSplit(bState: scala.Boolean): js.Any = js.native
  /**
    ...
    * @returns this pointer for chaining
    */
  def setShowMainContent(bVisible: scala.Boolean, bSuppressVisualUpdate: scala.Boolean): js.Any = js.native
  /**
    ...
    * @returns this pointer for chaining
    */
  def setShowSideContent(bVisible: scala.Boolean, bSuppressVisualUpdate: scala.Boolean): js.Any = js.native
  /**
