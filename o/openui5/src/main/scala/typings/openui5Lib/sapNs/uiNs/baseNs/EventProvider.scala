...
abstract class EventProvider () extends Object {
  /**
    ...
    */
  def attachEvent(sEventId: java.lang.String, oData: js.Any, fnFunction: js.Any): EventProvider = js.native
  def attachEvent(sEventId: java.lang.String, oData: js.Any, fnFunction: js.Any, oListener: js.Any): EventProvider = js.native
  /**
    ...
    * @returns Returns <code>this</code> to allow method chaining
    */
  def attachEventOnce(sEventId: java.lang.String, oData: js.Any, fnFunction: js.Any): EventProvider = js.native
  def attachEventOnce(sEventId: java.lang.String, oData: js.Any, fnFunction: js.Any, oListener: js.Any): EventProvider = js.native
  /**
    ...
    * @returns Returns <code>this</code> to allow method chaining
    */
  def detachEvent(sEventId: java.lang.String, fnFunction: js.Any): EventProvider = js.native
  def detachEvent(sEventId: java.lang.String, fnFunction: js.Any, oListener: js.Any): EventProvider = js.native
  /**
    ...
    */
  def fireEvent(sEventId: java.lang.String): EventProvider | scala.Boolean = js.native
  def fireEvent(sEventId: java.lang.String, mParameters: js.Any): EventProvider | scala.Boolean = js.native
  def fireEvent(sEventId: java.lang.String, mParameters: js.Any, bAllowPreventDefault: scala.Boolean): EventProvider | scala.Boolean = js.native
  def fireEvent(
    sEventId: java.lang.String,
    mParameters: js.Any,
    bAllowPreventDefault: scala.Boolean,
    bEnableEventBubbling: scala.Boolean
  ): EventProvider | scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def hasListeners(sEventId: java.lang.String): scala.Boolean = js.native
}
