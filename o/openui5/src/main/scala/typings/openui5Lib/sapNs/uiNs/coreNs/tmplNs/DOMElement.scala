...
class DOMElement protected ()
  ...
  /**
            ...
            */
  def attr(sName: java.lang.String, sValue: java.lang.String): js.Any = js.native
  /**
  ...
  /**
            ...
            */
  def indexOfAttribute(oAttribute: DOMAttribute): scala.Double = js.native
  /**
             ...
             * @returns The index of the provided control in the aggregation if found, or -1 otherwise
            */
  def indexOfElement(oElement: DOMElement): scala.Double = js.native
  /**
             ...
             * @returns Reference to <code>this</code> in order to allow method chaining
            */
  def insertAttribute(oAttribute: DOMAttribute, iIndex: scala.Double): DOMElement = js.native
  /**
             ...
             * @returns Reference to <code>this</code> in order to allow method chaining
            */
  def insertElement(oElement: DOMElement, iIndex: scala.Double): DOMElement = js.native
  /**
  ...
  /**
             ...
             * @param sName The name of the DOM attribute.
            */
  def removeAttr(sName: java.lang.String): DOMElement = js.native
  /**
            ...
            */
  def removeAttribute(vAttribute: java.lang.String): DOMAttribute = js.native
  /**
             * Removes a attribute from the aggregation <code>attributes</code>.
             * @param vAttribute The attribute to remove or its index or id
             * @returns The removed attribute or <code>null</code>
  ...
  /**
             ...
             * @returns The removed attribute or <code>null</code>
            */
  def removeAttribute(vAttribute: scala.Double): DOMAttribute = js.native
  /**
            ...
            */
  def removeElement(vElement: java.lang.String): DOMElement = js.native
  /**
             * Removes a element from the aggregation <code>elements</code>.
             * @param vElement The element to remove or its index or id
             * @returns The removed element or <code>null</code>
  ...
  /**
             ...
             * @returns The removed element or <code>null</code>
            */
  def removeElement(vElement: scala.Double): DOMElement = js.native
  /**
             ...
             * @returns Reference to <code>this</code> in order to allow method chaining
            */
  def setTag(sTag: java.lang.String): DOMElement = js.native
  /**
             ...
             * @returns Reference to <code>this</code> in order to allow method chaining
            */
  def setText(sText: java.lang.String): DOMElement = js.native
}
