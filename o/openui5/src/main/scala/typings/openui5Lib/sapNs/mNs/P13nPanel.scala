...
class P13nPanel protected ()
  ...
  /**
    * @since 1.28.0
    */
  def beforeNavigationTo(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getTitleLarge(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def indexOfItem(oItem: P13nItem): scala.Double = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertItem(oItem: P13nItem, iIndex: scala.Double): P13nPanel = js.native
  /**
    ...
    * @since 1.28.0
    */
  def onAfterNavigationFrom(): scala.Unit = js.native
  /**
    ...
    */
  def onBeforeNavigationFrom(): scala.Boolean = js.native
  /**
  ...
  def removeItem(vItem: java.lang.String): P13nItem = js.native
  ...
  /**
    ...
    */
  def removeItem(vItem: scala.Double): P13nItem = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTitle(sTitle: java.lang.String): P13nPanel = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setTitleLarge(sTitleLarge: java.lang.String): P13nPanel = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setType(sType: java.lang.String): P13nPanel = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setVerticalScrolling(bVerticalScrolling: scala.Boolean): P13nPanel = js.native
  /**
