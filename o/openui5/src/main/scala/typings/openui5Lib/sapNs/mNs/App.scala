...
class App protected () extends NavContainer {
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setBackgroundColor(sBackgroundColor: java.lang.String): App = js.native
  /**
  ...
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setBackgroundOpacity(fBackgroundOpacity: scala.Double): App = js.native
  /**
         ...
         * @returns Reference to <code>this</code> in order to allow method chaining
        */
  def setBackgroundRepeat(bBackgroundRepeat: scala.Boolean): App = js.native
  /**
