...
abstract class Control protected () extends Element {
  ...
  /**
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def allowTextSelection(bAllow: scala.Boolean): Control = js.native
  /**
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def attachBrowserEvent(sEventType: java.lang.String): Control = js.native
  /**
           * Allows binding handlers for any native browser event to the root HTML element of this Control. This
           * internally handlesDOM element replacements caused by re-rendering.IMPORTANT:This should be only used
           * as FALLBACK when the Control events do not cover a specific use-case! Always try usingSAPUI5 control
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def attachBrowserEvent(sEventType: java.lang.String, fnHandler: js.Any): Control = js.native
  /**
           * Allows binding handlers for any native browser event to the root HTML element of this Control. This
           * internally handlesDOM element replacements caused by re-rendering.IMPORTANT:This should be only used
           * as FALLBACK when the Control events do not cover a specific use-case! Always try usingSAPUI5 control
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def attachBrowserEvent(sEventType: java.lang.String, fnHandler: js.Any, oListener: js.Any): Control = js.native
  /**
  ...
  /**
          ...
          */
  def checkFieldGroupIds(vFieldGroupIds: java.lang.String): scala.Boolean = js.native
  /**
           * Returns whether the control has a given field group.If <code>vFieldGroupIds</code> is not given it
           * checks whether at least one field group ID is given for this control.If <code>vFieldGroupIds</code>
           * is an empty array or empty string, true is returned if there is no field group ID set for this
           ...
           * @returns true if a field group ID matches
          */
  def checkFieldGroupIds(vFieldGroupIds: js.Array[java.lang.String]): scala.Boolean = js.native
  /**
          ...
          */
  def detachBrowserEvent(sEventType: java.lang.String): scala.Unit = js.native
  /**
           * Removes event handlers which have been previously attached using {@link #attachBrowserEvent}.Note:
           * listeners are only removed, if the same combination of event type, callback functionand context
           * object is given as in the call to <code>attachBrowserEvent</code>.
           ...
           * @param oListener The context object that was given in the call to attachBrowserEvent.
          */
  def detachBrowserEvent(sEventType: java.lang.String, fnHandler: js.Any): scala.Unit = js.native
  /**
           * Removes event handlers which have been previously attached using {@link #attachBrowserEvent}.Note:
           * listeners are only removed, if the same combination of event type, callback functionand context
           * object is given as in the call to <code>attachBrowserEvent</code>.
           ...
           * @param oListener The context object that was given in the call to attachBrowserEvent.
          */
  def detachBrowserEvent(sEventType: java.lang.String, fnHandler: js.Any, oListener: js.Any): scala.Unit = js.native
  /**
  ...
  /**
          ...
          */
  def getBusy(): scala.Boolean = js.native
  /**
          ...
          */
  def getBusyIndicatorDelay(): scala.Double = js.native
  /**
          ...
          */
  def getControlsByFieldGroupId(vFieldGroupIds: java.lang.String): js.Array[Control] = js.native
  /**
           * Returns a list of all child controls with a field group ID.See {@link #checkFieldGroupIds
           * checkFieldGroupIds} for a description of the<code>vFieldGroupIds</code> parameter.Associated
           * controls are not taken into account.
           ...
           * @returns The list of controls with a field group ID
          */
  def getControlsByFieldGroupId(vFieldGroupIds: js.Array[java.lang.String]): js.Array[Control] = js.native
  /**
          ...
          */
  def getFieldGroupIds(): js.Array[java.lang.String] = js.native
  /**
          ...
          */
  def getIdForLabel(): java.lang.String = js.native
  /**
  ...
  /**
          ...
          */
  def hasStyleClass(sStyleClass: java.lang.String): scala.Boolean = js.native
  /**
           * Check if the control is currently in busy state
          */
  def isBusy(): scala.Unit = js.native
  /**
  ...
  /**
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def placeAt(oPosition: java.lang.String): Control = js.native
  /**
           * Puts <code>this</code> control into the specified container (<code>oRef</code>) at the givenposition
           * (<code>oPosition</code>).First it is checked whether <code>oRef</code> is a container element /
           * control (has amultiple aggregation with type <code>sap.ui.core.Control</code> and name 'content') or
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def placeAt(oPosition: scala.Double): Control = js.native
  /**
           * Puts <code>this</code> control into the specified container (<code>oRef</code>) at the givenposition
           * (<code>oPosition</code>).First it is checked whether <code>oRef</code> is a container element /
           * control (has amultiple aggregation with type <code>sap.ui.core.Control</code> and name 'content') or
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def placeAt(oRef: java.lang.String, oPosition: java.lang.String): Control = js.native
  /**
           * Puts <code>this</code> control into the specified container (<code>oRef</code>) at the givenposition
           * (<code>oPosition</code>).First it is checked whether <code>oRef</code> is a container element /
           * control (has amultiple aggregation with type <code>sap.ui.core.Control</code> and name 'content') or
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def placeAt(oRef: java.lang.String, oPosition: scala.Double): Control = js.native
  /**
           * Puts <code>this</code> control into the specified container (<code>oRef</code>) at the givenposition
           * (<code>oPosition</code>).First it is checked whether <code>oRef</code> is a container element /
           * control (has amultiple aggregation with type <code>sap.ui.core.Control</code> and name 'content') or
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def placeAt(oRef: Control, oPosition: java.lang.String): Control = js.native
  /**
           * Puts <code>this</code> control into the specified container (<code>oRef</code>) at the givenposition
           * (<code>oPosition</code>).First it is checked whether <code>oRef</code> is a container element /
           * control (has amultiple aggregation with type <code>sap.ui.core.Control</code> and name 'content') or
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def placeAt(oRef: Control, oPosition: scala.Double): Control = js.native
  /**
           * Puts <code>this</code> control into the specified container (<code>oRef</code>) at the givenposition
           * (<code>oPosition</code>).First it is checked whether <code>oRef</code> is a container element /
           * control (has amultiple aggregation with type <code>sap.ui.core.Control</code> and name 'content') or
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def placeAt(oRef: Element, oPosition: java.lang.String): Control = js.native
  /**
           * Puts <code>this</code> control into the specified container (<code>oRef</code>) at the givenposition
           * (<code>oPosition</code>).First it is checked whether <code>oRef</code> is a container element /
           * control (has amultiple aggregation with type <code>sap.ui.core.Control</code> and name 'content') or
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def placeAt(oRef: Element, oPosition: scala.Double): Control = js.native
  /**
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def removeStyleClass(sStyleClass: java.lang.String): Control = js.native
  /**
           * Set the controls busy state.
           * @param bBusy The new busy state to be set
           * @returns <code>this</code> to allow method chaining
          */
  def setBusy(bBusy: scala.Boolean): Control = js.native
  /**
           * Define the delay, after which the busy indicator will show up
           * @param iDelay The delay in ms
           * @returns <code>this</code> to allow method chaining
          */
  def setBusyIndicatorDelay(iDelay: scala.Double): Control = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setFieldGroupIds(sFieldGroupIds: js.Array[java.lang.String]): Control = js.native
  /**
           ...
           * @returns Reference to <code>this</code> in order to allow method chaining
          */
  def setVisible(bVisible: scala.Boolean): Control = js.native
  /**
           ...
           * @returns Returns <code>this</code> to allow method chaining
          */
  def toggleStyleClass(sStyleClass: java.lang.String, bAdd: scala.Boolean): Control = js.native
  /**
          ...
          */
  def triggerValidateFieldGroup(): scala.Unit = js.native
}
