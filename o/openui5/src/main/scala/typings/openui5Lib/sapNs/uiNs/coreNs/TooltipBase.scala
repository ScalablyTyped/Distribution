...
@js.native
class TooltipBase protected () extends Control {
  /**
  ...
  /**
    ...
    */
  def getCloseDelay(): scala.Double = js.native
  /**
    ...
    */
  def getCloseDuration(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getOffset(): java.lang.String = js.native
  /**
    ...
    */
  def getOpenDelay(): scala.Double = js.native
  /**
    ...
    */
  def getOpenDuration(): scala.Double = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setCloseDelay(iCloseDelay: scala.Double): TooltipBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setCloseDuration(iCloseDuration: scala.Double): TooltipBase = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setOffset(sOffset: java.lang.String): TooltipBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setOpenDelay(iOpenDelay: scala.Double): TooltipBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setOpenDuration(iOpenDuration: scala.Double): TooltipBase = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setText(sText: java.lang.String): TooltipBase = js.native
}
