...
class Element ()
  ...
  /**
    ...
    */
  @JSName("$")
  def $(sSuffix: java.lang.String): jqueryLib.JQueryStatic = js.native
  /**
  ...
  /**
    ...
    */
  def applyFocusInfo(oFocusInfo: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def bindElement(vPath: java.lang.String): openui5Lib.sapNs.uiNs.baseNs.ManagedObject = js.native
  def bindElement(vPath: java.lang.String, mParameters: js.Any): openui5Lib.sapNs.uiNs.baseNs.ManagedObject = js.native
  def bindElement(vPath: js.Any): openui5Lib.sapNs.uiNs.baseNs.ManagedObject = js.native
  def bindElement(vPath: js.Any, mParameters: js.Any): openui5Lib.sapNs.uiNs.baseNs.ManagedObject = js.native
  def create(vData: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def create(vData: Element): scala.Unit = js.native
  def create(vData: Element, oKeyInfo: js.Any): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def findElements(bRecursive: scala.Boolean): js.Array[Element] = js.native
  /**
  ...
  /**
    ...
    */
  def getDomRef(sSuffix: java.lang.String): Element = js.native
  /**
    ...
    */
  def getElementBinding(sModelName: java.lang.String): openui5Lib.sapNs.uiNs.modelNs.Binding = js.native
  /**
  ...
  /**
    ...
    */
  def getTooltip(): java.lang.String | TooltipBase = js.native
  /**
    ...
    */
  def getTooltip_AsString(): java.lang.String = js.native
  /**
    ...
    */
  def getTooltip_Text(): java.lang.String = js.native
  /**
    ...
    */
  def indexOfCustomData(oCustomData: CustomData): scala.Double = js.native
  /**
    ...
    * @returns The index of the provided control in the aggregation if found, or -1 otherwise
    */
  def indexOfDependent(oDependent: Control): scala.Double = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertCustomData(oCustomData: CustomData, iIndex: scala.Double): Element = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def insertDependent(oDependent: Control, iIndex: scala.Double): Element = js.native
  /**
    ...
    * in case of getter
    */
  def prop(sPropertyName: java.lang.String): js.Any | Element = js.native
  def prop(sPropertyName: java.lang.String, oValue: js.Any): js.Any | Element = js.native
  /**
  ...
  def removeCustomData(vCustomData: java.lang.String): CustomData = js.native
  ...
  /**
    ...
    */
  def removeCustomData(vCustomData: scala.Double): CustomData = js.native
  def removeDependent(vDependent: java.lang.String): Control = js.native
  ...
  /**
    ...
    */
  def removeDependent(vDependent: scala.Double): Control = js.native
  /**
  ...
  /**
    ...
    */
  def setLayoutData(oLayoutData: LayoutData): scala.Unit = js.native
  /**
    ...
    */
  def setTooltip(vTooltip: java.lang.String): scala.Unit = js.native
  def setTooltip(vTooltip: TooltipBase): scala.Unit = js.native
  /**
    ...
    * @returns reference to the instance itself
    */
  def unbindElement(sModelName: java.lang.String): openui5Lib.sapNs.uiNs.baseNs.ManagedObject = js.native
}
