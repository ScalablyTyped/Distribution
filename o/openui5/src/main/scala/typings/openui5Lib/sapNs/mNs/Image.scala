...
class Image protected ()
  ...
  /**
    ...
    */
  def getAlt(): java.lang.String = js.native
  /**
    ...
    */
  def getBackgroundPosition(): java.lang.String = js.native
  /**
    ...
    */
  def getBackgroundRepeat(): java.lang.String = js.native
  /**
    ...
    */
  def getBackgroundSize(): java.lang.String = js.native
  /**
    ...
    */
  def getDecorative(): scala.Boolean = js.native
  /**
    ...
    */
  def getDensityAware(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getUseMap(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setAlt(sAlt: java.lang.String): Image = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setBackgroundPosition(sBackgroundPosition: java.lang.String): Image = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setBackgroundRepeat(sBackgroundRepeat: java.lang.String): Image = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setBackgroundSize(sBackgroundSize: java.lang.String): Image = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setDecorative(bDecorative: scala.Boolean): Image = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setDensityAware(bDensityAware: scala.Boolean): Image = js.native
  /**
  ...
  /**
    ...
    */
  def setSrc(sSrc: js.Any): scala.Unit = js.native
  /**
    ...
    * @returns Reference to <code>this</code> in order to allow method chaining
    */
  def setUseMap(sUseMap: java.lang.String): Image = js.native
  /**
