...
trait JquerySap extends js.Object {
  ...
  def bindAnyEvent(fnCallback: js.Any): scala.Unit = js.native
  // Shortcut for jQuery("#" + id) with additionally the id being escaped properly. 
  def byId(sId: js.Any, oContext: js.Any): scala.Unit = js.native
  // Transforms a hyphen separated string to an camel case string. 
  def camelCase(sString: js.Any): scala.Unit = js.native
  // Converts a character of the string to upper case. 
  def charToUpperCase(sString: js.Any, iPos: js.Any): scala.Unit = js.native
  ...
  def checkMouseEnterOrLeave(oEvent: js.Any, oDomRef: js.Any): scala.Unit = js.native
  // Stops the delayed call. 
  def clearDelayedCall(sDelayedCallId: js.Any): scala.Unit = js.native
  // Stops the interval call. 
  def clearIntervalCall(sIntervalCallId: js.Any): scala.Unit = js.native
  // clears the whitelist for URL valiadtion 
  def clearUrlWhitelist(): scala.Unit = js.native
  ...
  def denormalizeScrollLeftRTL(iNormalizedScrollLeft: js.Any, oDomRef: js.Any): scala.Unit = js.native
  ...
  def encodeHTML(sString: js.Any): scala.Unit = js.native
  // Encode the string for inclusion into a JS string literal 
  def encodeJS(sString: js.Any): scala.Unit = js.native
  // Encode the string for inclusion into an URL parameter 
  def encodeURL(sString: js.Any): scala.Unit = js.native
  // Encode a map of parameters into a combined URL parameter string 
  def encodeURLParameters(mParams: js.Any): scala.Unit = js.native
  // Encode the string for inclusion into XML content/attribute 
  def encodeXML(sString: js.Any): scala.Unit = js.native
  // Checks whether a given sString ends with sEndString respecting the case of the strings. 
  def endsWith(sString: js.Any, sEndString: js.Any): scala.Unit = js.native
  ...
  def factory(oPrototype: js.Any): scala.Unit = js.native
  ...
  def ownerWindow(oDomRef: js.Any): scala.Unit = js.native
  // Pads a string on the left side until is has the given length. 
  def padLeft(sString: js.Any, sPadChar: js.Any, iLength: js.Any): scala.Unit = js.native
  // Pads a string on the right side until is has the given length. 
  def padRight(sString: js.Any, sPadChar: js.Any, iLength: js.Any): scala.Unit = js.native
  ...
  def registerResourcePath(sResourceNamePrefix: js.Any, vUrlPrefix: js.Any): scala.Unit = js.native
  // Removes a whitelist entry for URL valiadtion 
  def removeUrlWhitelist(iIndex: js.Any): scala.Unit = js.native
  ...
  def setIcons(oIcons: js.Any): scala.Unit = js.native
  ...
  def startsWith(sString: js.Any, sStartString: js.Any): scala.Unit = js.native
  ...
  def unbindAnyEvent(fnCallback: js.Any): scala.Unit = js.native
  // Sorts the given array in-place and removes any duplicates (identified by "==="). 
  def unique(a: js.Any): scala.Unit = js.native
  // Validates an URL. 
  def validateUrl(sUrl: js.Any): scala.Unit = js.native
}
