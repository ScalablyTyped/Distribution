...
object distTypesODotnodeMod {
  ...
  inline def o(rootUrl: String, config: Any): typings.oJs.distTypesOhandlerMod.OHandler = (^.asInstanceOf[js.Dynamic].applyDynamic("o")(rootUrl.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[typings.oJs.distTypesOhandlerMod.OHandler]
  inline def o(rootUrl: String, config: OdataConfig): typings.oJs.distTypesOhandlerMod.OHandler = (^.asInstanceOf[js.Dynamic].applyDynamic("o")(rootUrl.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[typings.oJs.distTypesOhandlerMod.OHandler]
  ...
  inline def o(rootUrl: URL, config: Any): typings.oJs.distTypesOhandlerMod.OHandler = (^.asInstanceOf[js.Dynamic].applyDynamic("o")(rootUrl.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[typings.oJs.distTypesOhandlerMod.OHandler]
  inline def o(rootUrl: URL, config: OdataConfig): typings.oJs.distTypesOhandlerMod.OHandler = (^.asInstanceOf[js.Dynamic].applyDynamic("o")(rootUrl.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[typings.oJs.distTypesOhandlerMod.OHandler]
}
