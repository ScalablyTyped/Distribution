...
object requestMethodMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.octokitTypes.octokitTypesStrings.DELETE
    - typings.octokitTypes.octokitTypesStrings.GET
    - typings.octokitTypes.octokitTypesStrings.HEAD
    - typings.octokitTypes.octokitTypesStrings.PATCH
    - typings.octokitTypes.octokitTypesStrings.POST
    - typings.octokitTypes.octokitTypesStrings.PUT
  */
