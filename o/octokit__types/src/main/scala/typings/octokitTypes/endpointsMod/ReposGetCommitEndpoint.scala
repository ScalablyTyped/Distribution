...
@js.native
trait ReposGetCommitEndpoint extends StObject {
...
object ReposGetCommitEndpoint {
  ...
  @scala.inline
  implicit class ReposGetCommitEndpointMutableBuilder[Self <: ReposGetCommitEndpoint] (val x: Self) extends AnyVal {
