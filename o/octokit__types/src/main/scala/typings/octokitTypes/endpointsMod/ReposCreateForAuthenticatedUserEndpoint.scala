...
object ReposCreateForAuthenticatedUserEndpoint {
  ...
  def apply(
    ...
    team_id: js.UndefOr[Double] = js.undefined,
    visibility: public | `private` | visibility | internal = null
  ): ReposCreateForAuthenticatedUserEndpoint = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    if (!js.isUndefined(allow_merge_commit)) __obj.updateDynamic("allow_merge_commit")(allow_merge_commit.get.asInstanceOf[js.Any])
    if (!js.isUndefined(allow_rebase_merge)) __obj.updateDynamic("allow_rebase_merge")(allow_rebase_merge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(allow_squash_merge)) __obj.updateDynamic("allow_squash_merge")(allow_squash_merge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(auto_init)) __obj.updateDynamic("auto_init")(auto_init.get.asInstanceOf[js.Any])
    if (!js.isUndefined(delete_branch_on_merge)) __obj.updateDynamic("delete_branch_on_merge")(delete_branch_on_merge.get.asInstanceOf[js.Any])
    if (description != null) __obj.updateDynamic("description")(description.asInstanceOf[js.Any])
    if (gitignore_template != null) __obj.updateDynamic("gitignore_template")(gitignore_template.asInstanceOf[js.Any])
    if (!js.isUndefined(has_issues)) __obj.updateDynamic("has_issues")(has_issues.get.asInstanceOf[js.Any])
    if (!js.isUndefined(has_projects)) __obj.updateDynamic("has_projects")(has_projects.get.asInstanceOf[js.Any])
    if (!js.isUndefined(has_wiki)) __obj.updateDynamic("has_wiki")(has_wiki.get.asInstanceOf[js.Any])
    if (homepage != null) __obj.updateDynamic("homepage")(homepage.asInstanceOf[js.Any])
    if (!js.isUndefined(is_template)) __obj.updateDynamic("is_template")(is_template.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(team_id)) __obj.updateDynamic("team_id")(team_id.get.asInstanceOf[js.Any])
