...
@js.native
trait AppsDeleteAuthorizationEndpoint extends js.Object {
  /**
...
object AppsDeleteAuthorizationEndpoint {
  ...
  @scala.inline
  implicit class AppsDeleteAuthorizationEndpointOps[Self <: AppsDeleteAuthorizationEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
