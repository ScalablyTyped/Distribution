...
object AppsListInstallationReposForAuthenticatedUserEndpoint {
  @scala.inline
  def apply(installation_id: Double, mediaType: `2`): AppsListInstallationReposForAuthenticatedUserEndpoint = {
  ...
  @scala.inline
  implicit class AppsListInstallationReposForAuthenticatedUserEndpointOps[Self <: AppsListInstallationReposForAuthenticatedUserEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
