...
object ChecksCreateSuiteEndpoint {
  ...
  inline def apply(head_sha: String, mediaType: `0`[antiope], owner: String, repo: String): ChecksCreateSuiteEndpoint = {
  ...
  extension [Self <: ChecksCreateSuiteEndpoint](x: Self) {
