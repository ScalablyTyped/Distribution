...
object CodesOfConductGetConductCodeResponseData {
  ...
  inline def apply(body: String, key: String, name: String, url: String): CodesOfConductGetConductCodeResponseData = {
  ...
  extension [Self <: CodesOfConductGetConductCodeResponseData](x: Self) {
