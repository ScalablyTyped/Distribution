...
trait TeamsGetMembershipLegacyRequestOptions extends js.Object {
...
object TeamsGetMembershipLegacyRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsGetMembershipLegacyRequestOptions]
  }
}
