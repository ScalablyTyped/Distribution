...
object ReactionsDeleteForTeamDiscussionCommentRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsDeleteForTeamDiscussionCommentRequestOptionsOps[Self <: ReactionsDeleteForTeamDiscussionCommentRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
