...
@js.native
trait AppsGetInstallationEndpoint extends js.Object {
...
object AppsGetInstallationEndpoint {
  @scala.inline
  def apply(installation_id: Double, mediaType: `2`): AppsGetInstallationEndpoint = {
  ...
  @scala.inline
  implicit class AppsGetInstallationEndpointOps[Self <: AppsGetInstallationEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
