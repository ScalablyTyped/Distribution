...
object ReposListInvitationsRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposListInvitationsRequestOptions = {
  ...
  extension [Self <: ReposListInvitationsRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashinvitations): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
