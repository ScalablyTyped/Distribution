...
object ScimSetInformationForProvisionedUserRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ScimSetInformationForProvisionedUserRequestOptions = {
  ...
  extension [Self <: ScimSetInformationForProvisionedUserRequestOptions](x: Self) {
