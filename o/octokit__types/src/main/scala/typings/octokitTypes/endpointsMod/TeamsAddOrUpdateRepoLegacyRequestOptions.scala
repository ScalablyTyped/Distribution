...
trait TeamsAddOrUpdateRepoLegacyRequestOptions extends js.Object {
...
object TeamsAddOrUpdateRepoLegacyRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsAddOrUpdateRepoLegacyRequestOptions]
  }
}
