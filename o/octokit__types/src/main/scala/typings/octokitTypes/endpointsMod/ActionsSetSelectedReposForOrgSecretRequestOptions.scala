...
object ActionsSetSelectedReposForOrgSecretRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActionsSetSelectedReposForOrgSecretRequestOptions = {
  ...
  extension [Self <: ActionsSetSelectedReposForOrgSecretRequestOptions](x: Self) {
