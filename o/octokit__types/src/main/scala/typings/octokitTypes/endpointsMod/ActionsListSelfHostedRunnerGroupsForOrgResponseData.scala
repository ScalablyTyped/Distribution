...
object ActionsListSelfHostedRunnerGroupsForOrgResponseData {
  ...
  inline def apply(runner_groups: js.Array[Default], total_count: Double): ActionsListSelfHostedRunnerGroupsForOrgResponseData = {
  ...
  extension [Self <: ActionsListSelfHostedRunnerGroupsForOrgResponseData](x: Self) {
    
    inline def setRunner_groups(value: js.Array[Default]): Self = StObject.set(x, "runner_groups", value.asInstanceOf[js.Any])
    
    inline def setRunner_groupsVarargs(value: Default*): Self = StObject.set(x, "runner_groups", js.Array(value :_*))
