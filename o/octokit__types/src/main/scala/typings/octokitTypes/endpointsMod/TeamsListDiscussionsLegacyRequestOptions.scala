...
object TeamsListDiscussionsLegacyRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsListDiscussionsLegacyRequestOptions = {
  ...
  extension [Self <: TeamsListDiscussionsLegacyRequestOptions](x: Self) {
