...
object ActionsListWorkflowRunArtifactsResponseData {
  ...
  inline def apply(artifacts: js.Array[Archivedownloadurl], total_count: Double): ActionsListWorkflowRunArtifactsResponseData = {
  ...
  extension [Self <: ActionsListWorkflowRunArtifactsResponseData](x: Self) {
