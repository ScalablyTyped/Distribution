...
object EnterpriseAdminListProvisionedGroupsEnterpriseRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): EnterpriseAdminListProvisionedGroupsEnterpriseRequestOptions = {
  ...
  extension [Self <: EnterpriseAdminListProvisionedGroupsEnterpriseRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashscimSlashv2SlashenterprisesSlashColonenterpriseSlashGroups): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
