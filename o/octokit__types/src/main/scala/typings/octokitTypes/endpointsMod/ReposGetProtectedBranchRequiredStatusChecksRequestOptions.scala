...
trait ReposGetProtectedBranchRequiredStatusChecksRequestOptions extends js.Object {
...
object ReposGetProtectedBranchRequiredStatusChecksRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchRequiredStatusChecksRequestOptions]
  }
}
