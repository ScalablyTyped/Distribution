...
object UsersAddEmailForAuthenticatedRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): UsersAddEmailForAuthenticatedRequestOptions = {
  ...
  extension [Self <: UsersAddEmailForAuthenticatedRequestOptions](x: Self) {
