...
trait PullsListCommitsEndpoint extends StObject {
...
object PullsListCommitsEndpoint {
  ...
  @scala.inline
  def apply(owner: String, pull_number: Double, repo: String): PullsListCommitsEndpoint = {
  ...
  @scala.inline
  implicit class PullsListCommitsEndpointMutableBuilder[Self <: PullsListCommitsEndpoint] (val x: Self) extends AnyVal {
