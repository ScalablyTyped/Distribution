...
trait ReposAddUserAccessRestrictionsEndpoint extends StObject {
...
object ReposAddUserAccessRestrictionsEndpoint {
  ...
  inline def apply(branch: String, owner: String, repo: String, users: js.Array[String]): ReposAddUserAccessRestrictionsEndpoint = {
  ...
  extension [Self <: ReposAddUserAccessRestrictionsEndpoint](x: Self) {
