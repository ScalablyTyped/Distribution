...
trait TeamsAddOrUpdateProjectLegacyRequestOptions extends js.Object {
...
object TeamsAddOrUpdateProjectLegacyRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsAddOrUpdateProjectLegacyRequestOptions]
  }
}
