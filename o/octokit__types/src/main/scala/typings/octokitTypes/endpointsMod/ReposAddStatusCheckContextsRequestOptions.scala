...
trait ReposAddStatusCheckContextsRequestOptions extends StObject {
...
object ReposAddStatusCheckContextsRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposAddStatusCheckContextsRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "POST", request = request.asInstanceOf[js.Any], url = "/repos/:owner/:repo/branches/:branch/protection/required_status_checks/contexts")
    __obj.asInstanceOf[ReposAddStatusCheckContextsRequestOptions]
  }
  
  extension [Self <: ReposAddStatusCheckContextsRequestOptions](x: Self) {
