...
@js.native
trait PullsGetReviewCommentResponseData extends js.Object {
...
object PullsGetReviewCommentResponseData {
  ...
  @scala.inline
  implicit class PullsGetReviewCommentResponseDataOps[Self <: PullsGetReviewCommentResponseData] (val x: Self) extends AnyVal {
    @scala.inline
