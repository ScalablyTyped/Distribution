...
object ReposRemoveStatusCheckProtectionEndpoint {
  ...
  inline def apply(branch: String, owner: String, repo: String): ReposRemoveStatusCheckProtectionEndpoint = {
    val __obj = js.Dynamic.literal(branch = branch.asInstanceOf[js.Any], owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReposRemoveStatusCheckProtectionEndpoint]
  }
  
  extension [Self <: ReposRemoveStatusCheckProtectionEndpoint](x: Self) {
