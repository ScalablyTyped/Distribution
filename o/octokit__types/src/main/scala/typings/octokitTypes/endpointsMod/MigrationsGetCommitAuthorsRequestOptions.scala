...
object MigrationsGetCommitAuthorsRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): MigrationsGetCommitAuthorsRequestOptions = {
  ...
  extension [Self <: MigrationsGetCommitAuthorsRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashimportSlashauthors): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
