...
object ProjectsDeleteColumnRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ProjectsDeleteColumnRequestOptions = {
  ...
  extension [Self <: ProjectsDeleteColumnRequestOptions](x: Self) {
