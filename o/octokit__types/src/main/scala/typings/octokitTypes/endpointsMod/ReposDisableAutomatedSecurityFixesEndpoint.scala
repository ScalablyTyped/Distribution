...
object ReposDisableAutomatedSecurityFixesEndpoint {
  ...
  inline def apply(mediaType: `0`[london], owner: String, repo: String): ReposDisableAutomatedSecurityFixesEndpoint = {
  ...
  extension [Self <: ReposDisableAutomatedSecurityFixesEndpoint](x: Self) {
