...
trait ReposSetStatusCheckContextsEndpoint extends StObject {
...
object ReposSetStatusCheckContextsEndpoint {
  ...
  inline def apply(branch: String, contexts: js.Array[String], owner: String, repo: String): ReposSetStatusCheckContextsEndpoint = {
  ...
  extension [Self <: ReposSetStatusCheckContextsEndpoint](x: Self) {
