...
object ActionsListOrgSecretsRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActionsListOrgSecretsRequestOptions = {
  ...
  extension [Self <: ActionsListOrgSecretsRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashorgsSlashColonorgSlashactionsSlashsecrets): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
