...
@js.native
trait ActionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions extends js.Object {
...
object ActionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions {
  ...
  ): ActionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = method.asInstanceOf[js.Any], request = request.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[ActionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions]
  }
  
  @scala.inline
  implicit class ActionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequestOptionsOps[Self <: ActionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions] (val x: Self) extends AnyVal {
