...
object EnterpriseAdminListSelfHostedRunnersInGroupForEnterpriseRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): EnterpriseAdminListSelfHostedRunnersInGroupForEnterpriseRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/enterprises/:enterprise/actions/runner-groups/:runner_group_id/runners")
    __obj.asInstanceOf[EnterpriseAdminListSelfHostedRunnersInGroupForEnterpriseRequestOptions]
  }
  
  extension [Self <: EnterpriseAdminListSelfHostedRunnersInGroupForEnterpriseRequestOptions](x: Self) {
