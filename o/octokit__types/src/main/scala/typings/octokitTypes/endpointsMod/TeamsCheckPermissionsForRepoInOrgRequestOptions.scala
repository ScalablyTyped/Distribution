...
object TeamsCheckPermissionsForRepoInOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsCheckPermissionsForRepoInOrgRequestOptions = {
  ...
  extension [Self <: TeamsCheckPermissionsForRepoInOrgRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashreposSlashColonownerSlashColonrepo): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
