...
trait PullsCreateReplyForReviewCommentRequestOptions extends StObject {
  ...
  var url: SlashreposSlashColonownerSlashColonrepoSlashpullsSlashColonpull_numberSlashcommentsSlashColoncomment_idSlashreplies = js.native
}
object PullsCreateReplyForReviewCommentRequestOptions {
  ...
  @scala.inline
  implicit class PullsCreateReplyForReviewCommentRequestOptionsMutableBuilder[Self <: PullsCreateReplyForReviewCommentRequestOptions] (val x: Self) extends AnyVal {
