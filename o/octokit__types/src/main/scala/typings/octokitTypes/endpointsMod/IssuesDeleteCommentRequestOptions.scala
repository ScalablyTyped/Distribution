...
object IssuesDeleteCommentRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): IssuesDeleteCommentRequestOptions = {
  ...
  extension [Self <: IssuesDeleteCommentRequestOptions](x: Self) {
