...
@js.native
trait ReactionsCreateForIssueResponseData extends js.Object {
...
object ReactionsCreateForIssueResponseData {
  ...
  @scala.inline
  def apply(content: String, created_at: String, id: Double, node_id: String, user: Avatarurl): ReactionsCreateForIssueResponseData = {
  ...
  @scala.inline
  implicit class ReactionsCreateForIssueResponseDataOps[Self <: ReactionsCreateForIssueResponseData] (val x: Self) extends AnyVal {
