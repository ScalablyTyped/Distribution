...
object PullsDismissReviewRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): PullsDismissReviewRequestOptions = {
  ...
  extension [Self <: PullsDismissReviewRequestOptions](x: Self) {
