...
@js.native
trait TeamsCheckPermissionsForProjectLegacyRequestOptions extends js.Object {
...
object TeamsCheckPermissionsForProjectLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsCheckPermissionsForProjectLegacyRequestOptionsOps[Self <: TeamsCheckPermissionsForProjectLegacyRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
