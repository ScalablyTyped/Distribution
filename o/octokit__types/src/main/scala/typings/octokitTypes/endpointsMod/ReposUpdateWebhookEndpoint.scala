...
object ReposUpdateWebhookEndpoint {
  ...
  inline def apply(hook_id: Double, owner: String, repo: String): ReposUpdateWebhookEndpoint = {
  ...
  extension [Self <: ReposUpdateWebhookEndpoint](x: Self) {
    ...
    inline def setAdd_eventsVarargs(value: String*): Self = StObject.set(x, "add_events", js.Array(value :_*))
    
    inline def setConfig(value: ReposUpdateWebhookParamsConfig): Self = StObject.set(x, "config", value.asInstanceOf[js.Any])
    ...
    inline def setRemove_eventsVarargs(value: String*): Self = StObject.set(x, "remove_events", js.Array(value :_*))
