...
object OrgsListMembersRequestOptions {
  ...
  @scala.inline
  implicit class OrgsListMembersRequestOptionsOps[Self <: OrgsListMembersRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashmembers): Self = this.set("url", value.asInstanceOf[js.Any])
  }
