...
@js.native
trait IssuesUpdateCommentResponseData extends js.Object {
...
object IssuesUpdateCommentResponseData {
  ...
  @scala.inline
  implicit class IssuesUpdateCommentResponseDataOps[Self <: IssuesUpdateCommentResponseData] (val x: Self) extends AnyVal {
