...
trait ReposGetCommitSignatureProtectionEndpoint
  extends StObject
...
object ReposGetCommitSignatureProtectionEndpoint {
  ...
  inline def apply(branch: String, mediaType: `0`[zzzax], owner: String, repo: String): ReposGetCommitSignatureProtectionEndpoint = {
  ...
  extension [Self <: ReposGetCommitSignatureProtectionEndpoint](x: Self) {
