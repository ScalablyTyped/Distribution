...
object SearchLabelsRequestOptions {
  ...
  @scala.inline
  implicit class SearchLabelsRequestOptionsOps[Self <: SearchLabelsRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashsearchSlashlabels): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
