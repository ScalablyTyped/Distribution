...
trait MigrationsGetImportProgressResponseData extends js.Object {
...
object MigrationsGetImportProgressResponseData {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsGetImportProgressResponseData]
  }
}
