...
object ChecksListForSuiteEndpoint {
  ...
  inline def apply(check_suite_id: Double, mediaType: `0`[antiope], owner: String, repo: String): ChecksListForSuiteEndpoint = {
  ...
  extension [Self <: ChecksListForSuiteEndpoint](x: Self) {
