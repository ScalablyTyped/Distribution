...
@js.native
trait ReposGetReleaseAssetResponseData extends js.Object {
...
object ReposGetReleaseAssetResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ReposGetReleaseAssetResponseData]
  }
  
  @scala.inline
  implicit class ReposGetReleaseAssetResponseDataOps[Self <: ReposGetReleaseAssetResponseData] (val x: Self) extends AnyVal {
