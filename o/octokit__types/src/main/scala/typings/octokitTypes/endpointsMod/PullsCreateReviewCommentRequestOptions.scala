...
object PullsCreateReviewCommentRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): PullsCreateReviewCommentRequestOptions = {
  ...
  extension [Self <: PullsCreateReviewCommentRequestOptions](x: Self) {
