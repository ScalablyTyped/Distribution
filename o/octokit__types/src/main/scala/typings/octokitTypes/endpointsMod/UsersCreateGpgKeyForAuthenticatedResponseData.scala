...
object UsersCreateGpgKeyForAuthenticatedResponseData {
  ...
  @scala.inline
  implicit class UsersCreateGpgKeyForAuthenticatedResponseDataMutableBuilder[Self <: UsersCreateGpgKeyForAuthenticatedResponseData] (val x: Self) extends AnyVal {
