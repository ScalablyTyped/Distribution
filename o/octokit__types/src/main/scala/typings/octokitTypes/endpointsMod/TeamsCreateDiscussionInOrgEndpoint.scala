...
object TeamsCreateDiscussionInOrgEndpoint {
  ...
  inline def apply(body: String, org_ : String, team_slug: String, title: String): TeamsCreateDiscussionInOrgEndpoint = {
  ...
  extension [Self <: TeamsCreateDiscussionInOrgEndpoint](x: Self) {
