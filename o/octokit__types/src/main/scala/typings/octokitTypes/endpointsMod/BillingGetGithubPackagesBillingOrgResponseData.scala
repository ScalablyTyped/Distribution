...
@js.native
trait BillingGetGithubPackagesBillingOrgResponseData extends js.Object {
  /**
...
object BillingGetGithubPackagesBillingOrgResponseData {
  ...
  @scala.inline
  implicit class BillingGetGithubPackagesBillingOrgResponseDataOps[Self <: BillingGetGithubPackagesBillingOrgResponseData] (val x: Self) extends AnyVal {
    @scala.inline
