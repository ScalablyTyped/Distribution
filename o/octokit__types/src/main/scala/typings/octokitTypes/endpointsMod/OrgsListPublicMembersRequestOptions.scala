...
object OrgsListPublicMembersRequestOptions {
  ...
  @scala.inline
  implicit class OrgsListPublicMembersRequestOptionsOps[Self <: OrgsListPublicMembersRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashpublic_members): Self = this.set("url", value.asInstanceOf[js.Any])
  }
