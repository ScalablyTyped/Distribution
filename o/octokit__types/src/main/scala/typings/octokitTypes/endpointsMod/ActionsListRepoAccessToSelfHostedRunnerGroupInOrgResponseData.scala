...
object ActionsListRepoAccessToSelfHostedRunnerGroupInOrgResponseData {
  ...
  inline def apply(repositories: js.Array[Allowmergecommit], total_count: Double): ActionsListRepoAccessToSelfHostedRunnerGroupInOrgResponseData = {
  ...
  extension [Self <: ActionsListRepoAccessToSelfHostedRunnerGroupInOrgResponseData](x: Self) {
