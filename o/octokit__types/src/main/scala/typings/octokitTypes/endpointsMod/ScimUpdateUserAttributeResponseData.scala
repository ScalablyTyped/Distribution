...
trait ScimUpdateUserAttributeResponseData extends js.Object {
  var active: Boolean
...
object ScimUpdateUserAttributeResponseData {
  @scala.inline
  def apply(
    active: Boolean,
    ...
    __obj.asInstanceOf[ScimUpdateUserAttributeResponseData]
  }
}
