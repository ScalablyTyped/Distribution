...
object BillingGetGithubPackagesBillingOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): BillingGetGithubPackagesBillingOrgRequestOptions = {
  ...
  extension [Self <: BillingGetGithubPackagesBillingOrgRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashorgsSlashColonorgSlashsettingsSlashbillingSlashpackages): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
