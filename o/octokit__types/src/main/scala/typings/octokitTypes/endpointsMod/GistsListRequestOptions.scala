...
object GistsListRequestOptions {
  ...
  @scala.inline
  implicit class GistsListRequestOptionsOps[Self <: GistsListRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: Slashgists): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
