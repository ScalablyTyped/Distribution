...
object ProjectsDeleteRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ProjectsDeleteRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "DELETE", request = request.asInstanceOf[js.Any], url = "/projects/:project_id")
    __obj.asInstanceOf[ProjectsDeleteRequestOptions]
  }
  
  extension [Self <: ProjectsDeleteRequestOptions](x: Self) {
