...
object ReposListPullRequestsAssociatedWithCommitRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposListPullRequestsAssociatedWithCommitRequestOptions = {
  ...
  extension [Self <: ReposListPullRequestsAssociatedWithCommitRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashcommitsSlashColoncommit_shaSlashpulls): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
