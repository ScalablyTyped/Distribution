...
trait ChecksSetSuitesPreferencesRequestOptions extends js.Object {
  ...
  var url: `SlashreposSlashColonownerSlashColonrepoSlashcheck-suitesSlashpreferences` = js.native
}
...
object ChecksSetSuitesPreferencesRequestOptions {
  ...
  @scala.inline
  implicit class ChecksSetSuitesPreferencesRequestOptionsOps[Self <: ChecksSetSuitesPreferencesRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: `SlashreposSlashColonownerSlashColonrepoSlashcheck-suitesSlashpreferences`): Self = this.set("url", value.asInstanceOf[js.Any])
  }
