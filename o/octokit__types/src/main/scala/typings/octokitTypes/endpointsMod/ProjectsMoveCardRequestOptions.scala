...
object ProjectsMoveCardRequestOptions {
  ...
  @scala.inline
  implicit class ProjectsMoveCardRequestOptionsOps[Self <: ProjectsMoveCardRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashprojectsSlashcolumnsSlashcardsSlashColoncard_idSlashmoves): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
