...
object IssuesListLabelsOnIssueEndpoint {
  ...
  @scala.inline
  def apply(issue_number: Double, owner: String, repo: String): IssuesListLabelsOnIssueEndpoint = {
  ...
  @scala.inline
  implicit class IssuesListLabelsOnIssueEndpointMutableBuilder[Self <: IssuesListLabelsOnIssueEndpoint] (val x: Self) extends AnyVal {
