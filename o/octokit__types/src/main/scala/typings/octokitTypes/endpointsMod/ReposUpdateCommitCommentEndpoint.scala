...
object ReposUpdateCommitCommentEndpoint {
  ...
  inline def apply(body: String, comment_id: Double, owner: String, repo: String): ReposUpdateCommitCommentEndpoint = {
  ...
  extension [Self <: ReposUpdateCommitCommentEndpoint](x: Self) {
