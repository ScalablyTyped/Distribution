...
object GitignoreGetTemplateRequestOptions {
  ...
  @scala.inline
  implicit class GitignoreGetTemplateRequestOptionsOps[Self <: GitignoreGetTemplateRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashgitignoreSlashtemplatesSlashColonname): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
