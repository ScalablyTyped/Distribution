...
@js.native
trait ReposGetAllStatusCheckContextsRequestOptions extends js.Object {
...
object ReposGetAllStatusCheckContextsRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetAllStatusCheckContextsRequestOptionsOps[Self <: ReposGetAllStatusCheckContextsRequestOptions] (val x: Self) extends AnyVal {
