...
@js.native
trait AppsRevokeInstallationAccessTokenRequestOptions extends js.Object {
...
object AppsRevokeInstallationAccessTokenRequestOptions {
  ...
  @scala.inline
  implicit class AppsRevokeInstallationAccessTokenRequestOptionsOps[Self <: AppsRevokeInstallationAccessTokenRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashinstallationSlashtoken): Self = this.set("url", value.asInstanceOf[js.Any])
  }
