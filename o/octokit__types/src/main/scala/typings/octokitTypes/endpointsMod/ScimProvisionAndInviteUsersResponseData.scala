...
trait ScimProvisionAndInviteUsersResponseData extends js.Object {
  var active: Boolean
...
object ScimProvisionAndInviteUsersResponseData {
  @scala.inline
  def apply(
    active: Boolean,
    ...
    __obj.asInstanceOf[ScimProvisionAndInviteUsersResponseData]
  }
}
