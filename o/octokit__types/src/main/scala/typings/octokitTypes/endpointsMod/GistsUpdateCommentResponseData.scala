...
@js.native
trait GistsUpdateCommentResponseData extends js.Object {
...
object GistsUpdateCommentResponseData {
  ...
  @scala.inline
  implicit class GistsUpdateCommentResponseDataOps[Self <: GistsUpdateCommentResponseData] (val x: Self) extends AnyVal {
    @scala.inline
