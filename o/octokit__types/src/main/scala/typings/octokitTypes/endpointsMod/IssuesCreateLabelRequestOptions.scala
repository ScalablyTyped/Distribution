...
object IssuesCreateLabelRequestOptions {
  ...
  @scala.inline
  def apply(headers: RequestHeaders, request: RequestRequestOptions): IssuesCreateLabelRequestOptions = {
  ...
  @scala.inline
  implicit class IssuesCreateLabelRequestOptionsMutableBuilder[Self <: IssuesCreateLabelRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashlabels): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
