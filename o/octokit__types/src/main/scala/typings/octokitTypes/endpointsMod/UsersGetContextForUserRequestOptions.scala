...
object UsersGetContextForUserRequestOptions {
  ...
  @scala.inline
  implicit class UsersGetContextForUserRequestOptionsOps[Self <: UsersGetContextForUserRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashusersSlashColonusernameSlashhovercard): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
