...
object ReposGetAppsWithAccessToProtectedBranchEndpoint {
  ...
  inline def apply(branch: String, owner: String, repo: String): ReposGetAppsWithAccessToProtectedBranchEndpoint = {
    val __obj = js.Dynamic.literal(branch = branch.asInstanceOf[js.Any], owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReposGetAppsWithAccessToProtectedBranchEndpoint]
  }
  
  extension [Self <: ReposGetAppsWithAccessToProtectedBranchEndpoint](x: Self) {
