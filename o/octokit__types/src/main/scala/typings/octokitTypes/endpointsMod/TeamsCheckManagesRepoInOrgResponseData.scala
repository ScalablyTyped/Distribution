...
trait TeamsCheckManagesRepoInOrgResponseData extends js.Object {
...
object TeamsCheckManagesRepoInOrgResponseData {
  @scala.inline
  def apply(organization: Eventsurl, parent: Allowmergecommit, permissions: Maintain, source: Allowmergecommit): TeamsCheckManagesRepoInOrgResponseData = {
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoInOrgResponseData]
  }
}
