...
@js.native
trait ActionsDeleteWorkflowRunEndpoint extends js.Object {
...
object ActionsDeleteWorkflowRunEndpoint {
  ...
  @scala.inline
  implicit class ActionsDeleteWorkflowRunEndpointOps[Self <: ActionsDeleteWorkflowRunEndpoint] (val x: Self) extends AnyVal {
