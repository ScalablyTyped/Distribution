...
object ProjectsListCardsRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ProjectsListCardsRequestOptions = {
  ...
  extension [Self <: ProjectsListCardsRequestOptions](x: Self) {
