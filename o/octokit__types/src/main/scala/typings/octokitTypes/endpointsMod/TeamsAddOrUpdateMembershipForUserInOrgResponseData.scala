...
object TeamsAddOrUpdateMembershipForUserInOrgResponseData {
  ...
  @scala.inline
  implicit class TeamsAddOrUpdateMembershipForUserInOrgResponseDataOps[Self <: TeamsAddOrUpdateMembershipForUserInOrgResponseData] (val x: Self) extends AnyVal {
