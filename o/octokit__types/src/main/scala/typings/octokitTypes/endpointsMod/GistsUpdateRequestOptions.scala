...
object GistsUpdateRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): GistsUpdateRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "PATCH", request = request.asInstanceOf[js.Any], url = "/gists/:gist_id")
    __obj.asInstanceOf[GistsUpdateRequestOptions]
  }
  
  extension [Self <: GistsUpdateRequestOptions](x: Self) {
