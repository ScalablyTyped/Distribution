...
@js.native
trait PullsCheckIfMergedRequestOptions extends js.Object {
...
object PullsCheckIfMergedRequestOptions {
  ...
  @scala.inline
  implicit class PullsCheckIfMergedRequestOptionsOps[Self <: PullsCheckIfMergedRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashpullsSlashColonpull_numberSlashmerge): Self = this.set("url", value.asInstanceOf[js.Any])
  }
