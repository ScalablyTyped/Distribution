...
@js.native
trait PullsDismissReviewResponseData extends js.Object {
...
object PullsDismissReviewResponseData {
  ...
  @scala.inline
  implicit class PullsDismissReviewResponseDataOps[Self <: PullsDismissReviewResponseData] (val x: Self) extends AnyVal {
    @scala.inline
