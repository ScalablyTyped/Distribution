...
@js.native
trait InteractionsSetRestrictionsForRepoRequestOptions extends js.Object {
...
object InteractionsSetRestrictionsForRepoRequestOptions {
  ...
  @scala.inline
  implicit class InteractionsSetRestrictionsForRepoRequestOptionsOps[Self <: InteractionsSetRestrictionsForRepoRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
