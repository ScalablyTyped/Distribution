...
trait TeamsUpdateDiscussionCommentInOrgResponseData extends StObject {
...
object TeamsUpdateDiscussionCommentInOrgResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionCommentInOrgResponseData]
  }
  
  @scala.inline
  implicit class TeamsUpdateDiscussionCommentInOrgResponseDataMutableBuilder[Self <: TeamsUpdateDiscussionCommentInOrgResponseData] (val x: Self) extends AnyVal {
