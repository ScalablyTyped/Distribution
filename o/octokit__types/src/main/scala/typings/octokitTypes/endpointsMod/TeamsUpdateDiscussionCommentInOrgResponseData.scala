...
@js.native
trait TeamsUpdateDiscussionCommentInOrgResponseData extends js.Object {
...
object TeamsUpdateDiscussionCommentInOrgResponseData {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionCommentInOrgResponseDataOps[Self <: TeamsUpdateDiscussionCommentInOrgResponseData] (val x: Self) extends AnyVal {
    @scala.inline
