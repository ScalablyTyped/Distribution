...
object AppsRemoveRepoFromInstallationRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): AppsRemoveRepoFromInstallationRequestOptions = {
  ...
  extension [Self <: AppsRemoveRepoFromInstallationRequestOptions](x: Self) {
