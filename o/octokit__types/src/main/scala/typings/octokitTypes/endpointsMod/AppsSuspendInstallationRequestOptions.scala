...
@js.native
trait AppsSuspendInstallationRequestOptions extends js.Object {
...
object AppsSuspendInstallationRequestOptions {
  ...
  @scala.inline
  implicit class AppsSuspendInstallationRequestOptionsOps[Self <: AppsSuspendInstallationRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashappSlashinstallationsSlashColoninstallation_idSlashsuspended): Self = this.set("url", value.asInstanceOf[js.Any])
  }
