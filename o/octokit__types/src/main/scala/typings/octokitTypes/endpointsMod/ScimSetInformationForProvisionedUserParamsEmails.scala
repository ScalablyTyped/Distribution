...
@js.native
trait ScimSetInformationForProvisionedUserParamsEmails extends js.Object {
...
object ScimSetInformationForProvisionedUserParamsEmails {
  ...
  @scala.inline
  implicit class ScimSetInformationForProvisionedUserParamsEmailsOps[Self <: ScimSetInformationForProvisionedUserParamsEmails] (val x: Self) extends AnyVal {
