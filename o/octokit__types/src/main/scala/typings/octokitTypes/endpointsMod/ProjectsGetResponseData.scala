...
trait ProjectsGetResponseData extends StObject {
...
object ProjectsGetResponseData {
  ...
  @scala.inline
  implicit class ProjectsGetResponseDataMutableBuilder[Self <: ProjectsGetResponseData] (val x: Self) extends AnyVal {
