...
object ActionsListRunnerApplicationsForOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActionsListRunnerApplicationsForOrgRequestOptions = {
  ...
  extension [Self <: ActionsListRunnerApplicationsForOrgRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashorgsSlashColonorgSlashactionsSlashrunnersSlashdownloads): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
