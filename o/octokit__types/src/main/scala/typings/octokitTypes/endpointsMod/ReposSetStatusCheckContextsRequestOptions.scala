...
object ReposSetStatusCheckContextsRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposSetStatusCheckContextsRequestOptions = {
  ...
  extension [Self <: ReposSetStatusCheckContextsRequestOptions](x: Self) {
