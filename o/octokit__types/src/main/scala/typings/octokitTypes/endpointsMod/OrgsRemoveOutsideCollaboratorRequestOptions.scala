...
object OrgsRemoveOutsideCollaboratorRequestOptions {
  ...
  @scala.inline
  implicit class OrgsRemoveOutsideCollaboratorRequestOptionsOps[Self <: OrgsRemoveOutsideCollaboratorRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashoutside_collaboratorsSlashColonusername): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
