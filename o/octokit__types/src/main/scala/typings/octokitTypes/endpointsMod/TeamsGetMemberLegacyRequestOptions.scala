...
@js.native
trait TeamsGetMemberLegacyRequestOptions extends js.Object {
...
object TeamsGetMemberLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsGetMemberLegacyRequestOptionsOps[Self <: TeamsGetMemberLegacyRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
