...
object ChecksRerequestSuiteRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ChecksRerequestSuiteRequestOptions = {
  ...
  extension [Self <: ChecksRerequestSuiteRequestOptions](x: Self) {
