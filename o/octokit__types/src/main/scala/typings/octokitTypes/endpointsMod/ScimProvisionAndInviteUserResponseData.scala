...
object ScimProvisionAndInviteUserResponseData {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ScimProvisionAndInviteUserResponseData]
  }
  
  extension [Self <: ScimProvisionAndInviteUserResponseData](x: Self) {
