...
object AppsListInstallationsEndpoint {
  @scala.inline
  def apply(mediaType: `2`): AppsListInstallationsEndpoint = {
    val __obj = js.Dynamic.literal(mediaType = mediaType.asInstanceOf[js.Any])
    __obj.asInstanceOf[AppsListInstallationsEndpoint]
  }
  @scala.inline
  implicit class AppsListInstallationsEndpointOps[Self <: AppsListInstallationsEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
