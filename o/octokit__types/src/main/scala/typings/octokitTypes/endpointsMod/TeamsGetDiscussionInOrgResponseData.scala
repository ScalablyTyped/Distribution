...
@js.native
trait TeamsGetDiscussionInOrgResponseData extends js.Object {
...
object TeamsGetDiscussionInOrgResponseData {
  ...
  @scala.inline
  implicit class TeamsGetDiscussionInOrgResponseDataOps[Self <: TeamsGetDiscussionInOrgResponseData] (val x: Self) extends AnyVal {
    @scala.inline
