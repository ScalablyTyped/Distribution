...
trait TeamsGetDiscussionInOrgResponseData extends StObject {
...
object TeamsGetDiscussionInOrgResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TeamsGetDiscussionInOrgResponseData]
  }
  
  @scala.inline
  implicit class TeamsGetDiscussionInOrgResponseDataMutableBuilder[Self <: TeamsGetDiscussionInOrgResponseData] (val x: Self) extends AnyVal {
