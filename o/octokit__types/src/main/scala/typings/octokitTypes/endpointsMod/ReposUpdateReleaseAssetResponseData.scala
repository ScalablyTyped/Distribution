...
@js.native
trait ReposUpdateReleaseAssetResponseData extends js.Object {
...
object ReposUpdateReleaseAssetResponseData {
  ...
  @scala.inline
  implicit class ReposUpdateReleaseAssetResponseDataOps[Self <: ReposUpdateReleaseAssetResponseData] (val x: Self) extends AnyVal {
