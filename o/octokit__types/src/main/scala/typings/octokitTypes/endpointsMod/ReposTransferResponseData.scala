...
@js.native
trait ReposTransferResponseData extends js.Object {
...
object ReposTransferResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ReposTransferResponseData]
  }
  
  @scala.inline
  implicit class ReposTransferResponseDataOps[Self <: ReposTransferResponseData] (val x: Self) extends AnyVal {
