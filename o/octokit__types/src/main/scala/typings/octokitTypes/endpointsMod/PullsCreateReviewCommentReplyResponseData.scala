...
trait PullsCreateReviewCommentReplyResponseData extends js.Object {
...
object PullsCreateReviewCommentReplyResponseData {
  @scala.inline
  def apply(
    _links: Pullrequest,
    ...
    __obj.asInstanceOf[PullsCreateReviewCommentReplyResponseData]
  }
}
