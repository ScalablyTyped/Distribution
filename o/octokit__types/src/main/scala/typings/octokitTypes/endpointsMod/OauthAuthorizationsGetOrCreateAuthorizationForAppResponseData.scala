...
trait OauthAuthorizationsGetOrCreateAuthorizationForAppResponseData extends StObject {
...
object OauthAuthorizationsGetOrCreateAuthorizationForAppResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetOrCreateAuthorizationForAppResponseData]
  }
  
  @scala.inline
  implicit class OauthAuthorizationsGetOrCreateAuthorizationForAppResponseDataMutableBuilder[Self <: OauthAuthorizationsGetOrCreateAuthorizationForAppResponseData] (val x: Self) extends AnyVal {
