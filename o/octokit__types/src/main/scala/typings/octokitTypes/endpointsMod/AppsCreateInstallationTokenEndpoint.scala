...
/* Inlined {  installation_id  :number,   repository_ids ? :std.Array<number>,   permissions ? :@octokit/types.@octokit/types/dist-types/generated/Endpoints.AppsCreateInstallationTokenParamsPermissions} & @octokit/types.@octokit/types/dist-types/generated/Endpoints.RequiredPreview<'machine-man'> */
