...
@js.native
trait PullsCreateReplyForReviewCommentResponseData extends js.Object {
...
object PullsCreateReplyForReviewCommentResponseData {
  ...
  @scala.inline
  implicit class PullsCreateReplyForReviewCommentResponseDataOps[Self <: PullsCreateReplyForReviewCommentResponseData] (val x: Self) extends AnyVal {
