...
@js.native
trait ActionsRemoveSelfHostedRunnerFromGroupForOrgRequestOptions extends js.Object {
...
object ActionsRemoveSelfHostedRunnerFromGroupForOrgRequestOptions {
  ...
  @scala.inline
  implicit class ActionsRemoveSelfHostedRunnerFromGroupForOrgRequestOptionsOps[Self <: ActionsRemoveSelfHostedRunnerFromGroupForOrgRequestOptions] (val x: Self) extends AnyVal {
