...
object SearchTopicsRequestOptions {
  ...
  @scala.inline
  implicit class SearchTopicsRequestOptionsOps[Self <: SearchTopicsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashsearchSlashtopics): Self = this.set("url", value.asInstanceOf[js.Any])
  }
