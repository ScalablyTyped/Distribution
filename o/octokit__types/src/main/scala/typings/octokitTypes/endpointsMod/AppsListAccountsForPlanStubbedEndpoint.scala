...
@js.native
trait AppsListAccountsForPlanStubbedEndpoint extends js.Object {
...
object AppsListAccountsForPlanStubbedEndpoint {
  ...
  @scala.inline
  implicit class AppsListAccountsForPlanStubbedEndpointOps[Self <: AppsListAccountsForPlanStubbedEndpoint] (val x: Self) extends AnyVal {
