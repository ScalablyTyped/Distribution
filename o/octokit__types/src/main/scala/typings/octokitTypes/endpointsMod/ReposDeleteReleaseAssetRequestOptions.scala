...
object ReposDeleteReleaseAssetRequestOptions {
  ...
  @scala.inline
  def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposDeleteReleaseAssetRequestOptions = {
  ...
  @scala.inline
  implicit class ReposDeleteReleaseAssetRequestOptionsMutableBuilder[Self <: ReposDeleteReleaseAssetRequestOptions] (val x: Self) extends AnyVal {
