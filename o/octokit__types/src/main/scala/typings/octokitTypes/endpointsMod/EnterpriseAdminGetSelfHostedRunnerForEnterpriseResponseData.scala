...
object EnterpriseAdminGetSelfHostedRunnerForEnterpriseResponseData {
  ...
  inline def apply(busy: Boolean, id: Double, labels: js.Array[Id], name: String, os: String, status: String): EnterpriseAdminGetSelfHostedRunnerForEnterpriseResponseData = {
  ...
  extension [Self <: EnterpriseAdminGetSelfHostedRunnerForEnterpriseResponseData](x: Self) {
