...
trait TeamsCheckManagesRepoLegacyResponseData extends js.Object {
...
object TeamsCheckManagesRepoLegacyResponseData {
  @scala.inline
  def apply(organization: Eventsurl, parent: Allowmergecommit, permissions: Maintain, source: Allowmergecommit): TeamsCheckManagesRepoLegacyResponseData = {
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoLegacyResponseData]
  }
}
