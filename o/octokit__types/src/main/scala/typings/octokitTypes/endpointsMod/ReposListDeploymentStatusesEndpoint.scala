...
object ReposListDeploymentStatusesEndpoint {
  ...
  inline def apply(deployment_id: Double, owner: String, repo: String): ReposListDeploymentStatusesEndpoint = {
  ...
  extension [Self <: ReposListDeploymentStatusesEndpoint](x: Self) {
