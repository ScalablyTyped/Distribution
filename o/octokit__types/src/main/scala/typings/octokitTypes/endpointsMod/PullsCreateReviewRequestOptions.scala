...
object PullsCreateReviewRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): PullsCreateReviewRequestOptions = {
  ...
  extension [Self <: PullsCreateReviewRequestOptions](x: Self) {
