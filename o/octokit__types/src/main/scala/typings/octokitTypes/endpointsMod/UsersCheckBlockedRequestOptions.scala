...
object UsersCheckBlockedRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): UsersCheckBlockedRequestOptions = {
  ...
  extension [Self <: UsersCheckBlockedRequestOptions](x: Self) {
