...
object ReposDownloadArchiveEndpoint {
  ...
  inline def apply(archive_format: String, owner: String, ref: String, repo: String): ReposDownloadArchiveEndpoint = {
  ...
  extension [Self <: ReposDownloadArchiveEndpoint](x: Self) {
