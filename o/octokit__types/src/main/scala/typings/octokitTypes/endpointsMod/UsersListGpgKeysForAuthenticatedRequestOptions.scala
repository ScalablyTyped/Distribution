...
object UsersListGpgKeysForAuthenticatedRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): UsersListGpgKeysForAuthenticatedRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/user/gpg_keys")
    __obj.asInstanceOf[UsersListGpgKeysForAuthenticatedRequestOptions]
  }
  
  extension [Self <: UsersListGpgKeysForAuthenticatedRequestOptions](x: Self) {
