...
@js.native
trait UsersListGpgKeysForAuthenticatedRequestOptions extends js.Object {
...
object UsersListGpgKeysForAuthenticatedRequestOptions {
  ...
  @scala.inline
  implicit class UsersListGpgKeysForAuthenticatedRequestOptionsOps[Self <: UsersListGpgKeysForAuthenticatedRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashgpg_keys): Self = this.set("url", value.asInstanceOf[js.Any])
  }
