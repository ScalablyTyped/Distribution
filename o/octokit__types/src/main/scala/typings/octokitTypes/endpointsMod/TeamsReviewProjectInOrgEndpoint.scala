...
trait TeamsReviewProjectInOrgEndpoint extends js.Object {
  var mediaType: `8`
  @JSName("org")
  var org_ : String
...
object TeamsReviewProjectInOrgEndpoint {
  @scala.inline
  def apply(mediaType: `8`, org_ : String, project_id: Double, team_slug: String): TeamsReviewProjectInOrgEndpoint = {
    ...
    __obj.asInstanceOf[TeamsReviewProjectInOrgEndpoint]
  }
}
