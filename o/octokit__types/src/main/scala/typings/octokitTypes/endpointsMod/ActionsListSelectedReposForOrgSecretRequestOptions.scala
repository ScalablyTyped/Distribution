...
object ActionsListSelectedReposForOrgSecretRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActionsListSelectedReposForOrgSecretRequestOptions = {
  ...
  extension [Self <: ActionsListSelectedReposForOrgSecretRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashorgsSlashColonorgSlashactionsSlashsecretsSlashColonsecret_nameSlashrepositories): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
