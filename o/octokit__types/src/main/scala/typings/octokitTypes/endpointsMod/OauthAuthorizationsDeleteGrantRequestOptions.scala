...
object OauthAuthorizationsDeleteGrantRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): OauthAuthorizationsDeleteGrantRequestOptions = {
  ...
  extension [Self <: OauthAuthorizationsDeleteGrantRequestOptions](x: Self) {
