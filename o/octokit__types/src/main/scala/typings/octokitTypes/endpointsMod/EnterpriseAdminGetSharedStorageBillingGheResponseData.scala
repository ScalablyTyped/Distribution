...
object EnterpriseAdminGetSharedStorageBillingGheResponseData {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[EnterpriseAdminGetSharedStorageBillingGheResponseData]
  }
  
  extension [Self <: EnterpriseAdminGetSharedStorageBillingGheResponseData](x: Self) {
