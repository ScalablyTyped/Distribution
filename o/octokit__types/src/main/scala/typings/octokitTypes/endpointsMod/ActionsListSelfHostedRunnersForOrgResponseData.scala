...
object ActionsListSelfHostedRunnersForOrgResponseData {
  ...
  @scala.inline
  implicit class ActionsListSelfHostedRunnersForOrgResponseDataMutableBuilder[Self <: ActionsListSelfHostedRunnersForOrgResponseData] (val x: Self) extends AnyVal {
