...
object TeamsListProjectsLegacyEndpoint {
  @scala.inline
  def apply(mediaType: `10`, team_id: Double): TeamsListProjectsLegacyEndpoint = {
  ...
  @scala.inline
  implicit class TeamsListProjectsLegacyEndpointOps[Self <: TeamsListProjectsLegacyEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
