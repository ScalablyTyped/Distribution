...
object ReposRemoveStatusCheckProtectionRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposRemoveStatusCheckProtectionRequestOptions = {
  ...
  extension [Self <: ReposRemoveStatusCheckProtectionRequestOptions](x: Self) {
