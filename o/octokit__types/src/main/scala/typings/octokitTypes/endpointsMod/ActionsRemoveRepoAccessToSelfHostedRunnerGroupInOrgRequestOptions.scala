...
@js.native
trait ActionsRemoveRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions extends js.Object {
...
object ActionsRemoveRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions {
  ...
  @scala.inline
  implicit class ActionsRemoveRepoAccessToSelfHostedRunnerGroupInOrgRequestOptionsOps[Self <: ActionsRemoveRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions] (val x: Self) extends AnyVal {
