...
object GitCreateTreeEndpoint {
  ...
  inline def apply(owner: String, repo: String, tree: js.Array[GitCreateTreeParamsTree]): GitCreateTreeEndpoint = {
  ...
  extension [Self <: GitCreateTreeEndpoint](x: Self) {
    ...
    inline def setTree(value: js.Array[GitCreateTreeParamsTree]): Self = StObject.set(x, "tree", value.asInstanceOf[js.Any])
    
    inline def setTreeVarargs(value: GitCreateTreeParamsTree*): Self = StObject.set(x, "tree", js.Array(value :_*))
  }
}
