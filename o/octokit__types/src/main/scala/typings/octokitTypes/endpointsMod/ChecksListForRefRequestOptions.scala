...
object ChecksListForRefRequestOptions {
  ...
  @scala.inline
  implicit class ChecksListForRefRequestOptionsOps[Self <: ChecksListForRefRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: `SlashreposSlashColonownerSlashColonrepoSlashcommitsSlashColonrefSlashcheck-runs`): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
