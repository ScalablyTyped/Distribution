...
@js.native
trait ScimUpdateAttributeForUserResponseData extends js.Object {
...
object ScimUpdateAttributeForUserResponseData {
  ...
  @scala.inline
  implicit class ScimUpdateAttributeForUserResponseDataOps[Self <: ScimUpdateAttributeForUserResponseData] (val x: Self) extends AnyVal {
