...
object MigrationsListReposForOrgEndpoint {
  @scala.inline
  def apply(mediaType: `9`, migration_id: Double, org_ : String): MigrationsListReposForOrgEndpoint = {
  ...
  @scala.inline
  implicit class MigrationsListReposForOrgEndpointOps[Self <: MigrationsListReposForOrgEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
