...
trait ReposUpdateProtectedBranchPullRequestReviewEnforcementResponseData extends js.Object {
...
object ReposUpdateProtectedBranchPullRequestReviewEnforcementResponseData {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUpdateProtectedBranchPullRequestReviewEnforcementResponseData]
  }
}
