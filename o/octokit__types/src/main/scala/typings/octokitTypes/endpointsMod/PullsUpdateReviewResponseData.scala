...
@js.native
trait PullsUpdateReviewResponseData extends js.Object {
...
object PullsUpdateReviewResponseData {
  ...
  @scala.inline
  implicit class PullsUpdateReviewResponseDataOps[Self <: PullsUpdateReviewResponseData] (val x: Self) extends AnyVal {
    @scala.inline
