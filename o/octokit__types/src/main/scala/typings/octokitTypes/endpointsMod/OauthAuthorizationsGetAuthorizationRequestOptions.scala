...
@js.native
trait OauthAuthorizationsGetAuthorizationRequestOptions extends js.Object {
...
object OauthAuthorizationsGetAuthorizationRequestOptions {
  ...
  @scala.inline
  implicit class OauthAuthorizationsGetAuthorizationRequestOptionsOps[Self <: OauthAuthorizationsGetAuthorizationRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
