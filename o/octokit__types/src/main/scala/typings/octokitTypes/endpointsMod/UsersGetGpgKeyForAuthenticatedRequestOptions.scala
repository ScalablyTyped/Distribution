...
object UsersGetGpgKeyForAuthenticatedRequestOptions {
  ...
  @scala.inline
  implicit class UsersGetGpgKeyForAuthenticatedRequestOptionsOps[Self <: UsersGetGpgKeyForAuthenticatedRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashgpg_keysSlashColongpg_key_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
