...
trait ReposGetReadmeResponseData extends StObject {
...
object ReposGetReadmeResponseData {
  ...
  @scala.inline
  implicit class ReposGetReadmeResponseDataMutableBuilder[Self <: ReposGetReadmeResponseData] (val x: Self) extends AnyVal {
