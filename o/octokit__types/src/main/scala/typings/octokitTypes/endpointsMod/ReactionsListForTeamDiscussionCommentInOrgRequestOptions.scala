...
object ReactionsListForTeamDiscussionCommentInOrgRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsListForTeamDiscussionCommentInOrgRequestOptionsOps[Self <: ReactionsListForTeamDiscussionCommentInOrgRequestOptions] (val x: Self) extends AnyVal {
