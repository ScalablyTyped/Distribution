...
object ActionsGetSelfHostedRunnerForOrgResponseData {
  ...
  inline def apply(busy: Boolean, id: Double, labels: js.Array[Id], name: String, os: String, status: String): ActionsGetSelfHostedRunnerForOrgResponseData = {
  ...
  extension [Self <: ActionsGetSelfHostedRunnerForOrgResponseData](x: Self) {
