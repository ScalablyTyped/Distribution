...
@js.native
trait ProjectsUpdateCardResponseData extends js.Object {
...
object ProjectsUpdateCardResponseData {
  ...
  @scala.inline
  implicit class ProjectsUpdateCardResponseDataOps[Self <: ProjectsUpdateCardResponseData] (val x: Self) extends AnyVal {
    @scala.inline
