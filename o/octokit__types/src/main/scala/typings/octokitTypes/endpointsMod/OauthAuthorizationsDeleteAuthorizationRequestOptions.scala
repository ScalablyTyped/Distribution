...
object OauthAuthorizationsDeleteAuthorizationRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): OauthAuthorizationsDeleteAuthorizationRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "DELETE", request = request.asInstanceOf[js.Any], url = "/authorizations/:authorization_id")
    __obj.asInstanceOf[OauthAuthorizationsDeleteAuthorizationRequestOptions]
  }
  
  extension [Self <: OauthAuthorizationsDeleteAuthorizationRequestOptions](x: Self) {
