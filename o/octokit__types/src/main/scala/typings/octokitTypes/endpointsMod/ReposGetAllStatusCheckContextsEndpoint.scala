...
@js.native
trait ReposGetAllStatusCheckContextsEndpoint extends js.Object {
...
object ReposGetAllStatusCheckContextsEndpoint {
  ...
  @scala.inline
  implicit class ReposGetAllStatusCheckContextsEndpointOps[Self <: ReposGetAllStatusCheckContextsEndpoint] (val x: Self) extends AnyVal {
