...
object ReposAddTeamAccessRestrictionsRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposAddTeamAccessRestrictionsRequestOptions = {
  ...
  extension [Self <: ReposAddTeamAccessRestrictionsRequestOptions](x: Self) {
