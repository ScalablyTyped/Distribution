...
trait ActionsDeleteWorkflowRunLogsEndpoint extends StObject {
...
object ActionsDeleteWorkflowRunLogsEndpoint {
  ...
  inline def apply(owner: String, repo: String, run_id: Double): ActionsDeleteWorkflowRunLogsEndpoint = {
  ...
  extension [Self <: ActionsDeleteWorkflowRunLogsEndpoint](x: Self) {
