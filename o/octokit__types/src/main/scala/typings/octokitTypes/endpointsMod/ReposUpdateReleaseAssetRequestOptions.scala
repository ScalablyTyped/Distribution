...
object ReposUpdateReleaseAssetRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposUpdateReleaseAssetRequestOptions = {
  ...
  extension [Self <: ReposUpdateReleaseAssetRequestOptions](x: Self) {
