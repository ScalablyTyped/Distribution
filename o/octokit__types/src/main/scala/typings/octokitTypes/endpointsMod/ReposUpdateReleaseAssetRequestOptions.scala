...
@js.native
trait ReposUpdateReleaseAssetRequestOptions extends js.Object {
...
object ReposUpdateReleaseAssetRequestOptions {
  ...
  @scala.inline
  implicit class ReposUpdateReleaseAssetRequestOptionsOps[Self <: ReposUpdateReleaseAssetRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashreleasesSlashassetsSlashColonasset_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
