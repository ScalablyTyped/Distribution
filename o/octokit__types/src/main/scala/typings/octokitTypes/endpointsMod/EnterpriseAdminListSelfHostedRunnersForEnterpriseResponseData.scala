...
object EnterpriseAdminListSelfHostedRunnersForEnterpriseResponseData {
  ...
  inline def apply(runners: js.Array[Busy], total_count: Double): EnterpriseAdminListSelfHostedRunnersForEnterpriseResponseData = {
  ...
  extension [Self <: EnterpriseAdminListSelfHostedRunnersForEnterpriseResponseData](x: Self) {
