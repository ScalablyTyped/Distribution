...
object ReposGetTeamsWithAccessToProtectedBranchEndpoint {
  ...
  inline def apply(branch: String, owner: String, repo: String): ReposGetTeamsWithAccessToProtectedBranchEndpoint = {
    val __obj = js.Dynamic.literal(branch = branch.asInstanceOf[js.Any], owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReposGetTeamsWithAccessToProtectedBranchEndpoint]
  }
  
  extension [Self <: ReposGetTeamsWithAccessToProtectedBranchEndpoint](x: Self) {
