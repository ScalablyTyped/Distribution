...
object UsersListPublicKeysForUserRequestOptions {
  ...
  @scala.inline
  implicit class UsersListPublicKeysForUserRequestOptionsOps[Self <: UsersListPublicKeysForUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashusersSlashColonusernameSlashkeys): Self = this.set("url", value.asInstanceOf[js.Any])
  }
