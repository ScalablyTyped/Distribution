...
object ReactionsDeleteLegacyRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReactionsDeleteLegacyRequestOptions = {
  ...
  extension [Self <: ReactionsDeleteLegacyRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashreactionsSlashColonreaction_id): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
