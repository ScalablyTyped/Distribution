...
object ReposAddAppAccessRestrictionsEndpoint {
  ...
  inline def apply(apps: js.Array[String], branch: String, owner: String, repo: String): ReposAddAppAccessRestrictionsEndpoint = {
  ...
  extension [Self <: ReposAddAppAccessRestrictionsEndpoint](x: Self) {
