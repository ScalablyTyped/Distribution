...
@js.native
trait ReposCreateCommitSignatureProtectionRequestOptions extends js.Object {
...
object ReposCreateCommitSignatureProtectionRequestOptions {
  ...
  @scala.inline
  implicit class ReposCreateCommitSignatureProtectionRequestOptionsOps[Self <: ReposCreateCommitSignatureProtectionRequestOptions] (val x: Self) extends AnyVal {
