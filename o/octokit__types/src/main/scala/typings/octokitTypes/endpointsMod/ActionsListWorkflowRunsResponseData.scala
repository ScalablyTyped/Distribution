...
object ActionsListWorkflowRunsResponseData {
  ...
  inline def apply(total_count: Double, workflow_runs: js.Array[Artifactsurl]): ActionsListWorkflowRunsResponseData = {
  ...
  extension [Self <: ActionsListWorkflowRunsResponseData](x: Self) {
