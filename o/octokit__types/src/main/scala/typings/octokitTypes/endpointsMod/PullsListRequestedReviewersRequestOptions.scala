...
@js.native
trait PullsListRequestedReviewersRequestOptions extends js.Object {
...
object PullsListRequestedReviewersRequestOptions {
  ...
  @scala.inline
  implicit class PullsListRequestedReviewersRequestOptionsOps[Self <: PullsListRequestedReviewersRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
