...
object InteractionsSetRestrictionsForRepoResponseData {
  ...
  inline def apply(expires_at: String, limit: String, origin: String): InteractionsSetRestrictionsForRepoResponseData = {
  ...
  extension [Self <: InteractionsSetRestrictionsForRepoResponseData](x: Self) {
