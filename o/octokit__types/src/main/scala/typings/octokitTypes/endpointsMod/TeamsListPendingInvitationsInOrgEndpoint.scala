...
@js.native
trait TeamsListPendingInvitationsInOrgEndpoint extends js.Object {
...
object TeamsListPendingInvitationsInOrgEndpoint {
  ...
  @scala.inline
  implicit class TeamsListPendingInvitationsInOrgEndpointOps[Self <: TeamsListPendingInvitationsInOrgEndpoint] (val x: Self) extends AnyVal {
