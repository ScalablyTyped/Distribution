...
object OrgsListMembershipsForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class OrgsListMembershipsForAuthenticatedUserRequestOptionsOps[Self <: OrgsListMembershipsForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashmembershipsSlashorgs): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
