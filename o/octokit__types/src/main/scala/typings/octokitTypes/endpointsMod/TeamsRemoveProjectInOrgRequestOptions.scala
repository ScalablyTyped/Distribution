...
object TeamsRemoveProjectInOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsRemoveProjectInOrgRequestOptions = {
  ...
  extension [Self <: TeamsRemoveProjectInOrgRequestOptions](x: Self) {
