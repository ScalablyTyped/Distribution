...
object TeamsCreateOrUpdateIdPGroupConnectionsLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsCreateOrUpdateIdPGroupConnectionsLegacyRequestOptionsOps[Self <: TeamsCreateOrUpdateIdPGroupConnectionsLegacyRequestOptions] (val x: Self) extends AnyVal {
