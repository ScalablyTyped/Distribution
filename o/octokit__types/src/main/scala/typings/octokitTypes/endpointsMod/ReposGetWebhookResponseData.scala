...
@js.native
trait ReposGetWebhookResponseData extends StObject {
...
object ReposGetWebhookResponseData {
  ...
  @scala.inline
  implicit class ReposGetWebhookResponseDataMutableBuilder[Self <: ReposGetWebhookResponseData] (val x: Self) extends AnyVal {
