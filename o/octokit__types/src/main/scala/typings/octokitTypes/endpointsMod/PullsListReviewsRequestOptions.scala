...
@js.native
trait PullsListReviewsRequestOptions extends js.Object {
...
object PullsListReviewsRequestOptions {
  ...
  @scala.inline
  implicit class PullsListReviewsRequestOptionsOps[Self <: PullsListReviewsRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashpullsSlashColonpull_numberSlashreviews): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
