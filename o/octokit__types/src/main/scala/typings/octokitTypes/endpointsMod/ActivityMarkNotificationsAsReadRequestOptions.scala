...
object ActivityMarkNotificationsAsReadRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActivityMarkNotificationsAsReadRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "PUT", request = request.asInstanceOf[js.Any], url = "/notifications")
    __obj.asInstanceOf[ActivityMarkNotificationsAsReadRequestOptions]
  }
  
  extension [Self <: ActivityMarkNotificationsAsReadRequestOptions](x: Self) {
