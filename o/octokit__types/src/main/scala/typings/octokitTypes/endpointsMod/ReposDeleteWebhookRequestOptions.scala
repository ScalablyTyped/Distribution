...
@js.native
trait ReposDeleteWebhookRequestOptions extends js.Object {
...
object ReposDeleteWebhookRequestOptions {
  ...
  @scala.inline
  implicit class ReposDeleteWebhookRequestOptionsOps[Self <: ReposDeleteWebhookRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashhooksSlashColonhook_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
