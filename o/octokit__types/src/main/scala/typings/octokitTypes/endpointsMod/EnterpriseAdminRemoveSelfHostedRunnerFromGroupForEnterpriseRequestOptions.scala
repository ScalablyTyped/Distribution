...
@js.native
trait EnterpriseAdminRemoveSelfHostedRunnerFromGroupForEnterpriseRequestOptions extends js.Object {
...
object EnterpriseAdminRemoveSelfHostedRunnerFromGroupForEnterpriseRequestOptions {
  ...
  ): EnterpriseAdminRemoveSelfHostedRunnerFromGroupForEnterpriseRequestOptions = {
  ...
  @scala.inline
  implicit class EnterpriseAdminRemoveSelfHostedRunnerFromGroupForEnterpriseRequestOptionsOps[Self <: EnterpriseAdminRemoveSelfHostedRunnerFromGroupForEnterpriseRequestOptions] (val x: Self) extends AnyVal {
