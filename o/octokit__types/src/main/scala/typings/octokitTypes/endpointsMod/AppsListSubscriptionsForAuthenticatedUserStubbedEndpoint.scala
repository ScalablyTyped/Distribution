...
object AppsListSubscriptionsForAuthenticatedUserStubbedEndpoint {
  ...
  inline def apply(): AppsListSubscriptionsForAuthenticatedUserStubbedEndpoint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AppsListSubscriptionsForAuthenticatedUserStubbedEndpoint]
  }
  
  extension [Self <: AppsListSubscriptionsForAuthenticatedUserStubbedEndpoint](x: Self) {
