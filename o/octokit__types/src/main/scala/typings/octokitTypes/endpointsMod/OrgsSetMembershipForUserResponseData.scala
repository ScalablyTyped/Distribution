...
@js.native
trait OrgsSetMembershipForUserResponseData extends js.Object {
...
object OrgsSetMembershipForUserResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OrgsSetMembershipForUserResponseData]
  }
  
  @scala.inline
  implicit class OrgsSetMembershipForUserResponseDataOps[Self <: OrgsSetMembershipForUserResponseData] (val x: Self) extends AnyVal {
