...
object ReactionsCreateForTeamDiscussionLegacyRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionLegacyRequestOptionsOps[Self <: ReactionsCreateForTeamDiscussionLegacyRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashteamsSlashColonteam_idSlashdiscussionsSlashColondiscussion_numberSlashreactions): Self = this.set("url", value.asInstanceOf[js.Any])
  }
