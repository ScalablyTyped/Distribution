...
trait AppsDeleteAuthorizationRequestOptions extends js.Object {
  ...
  var url: SlashapplicationsSlashColonclient_idSlashgrant = js.native
}
...
object AppsDeleteAuthorizationRequestOptions {
  ...
  @scala.inline
  implicit class AppsDeleteAuthorizationRequestOptionsOps[Self <: AppsDeleteAuthorizationRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashapplicationsSlashColonclient_idSlashgrant): Self = this.set("url", value.asInstanceOf[js.Any])
  }
