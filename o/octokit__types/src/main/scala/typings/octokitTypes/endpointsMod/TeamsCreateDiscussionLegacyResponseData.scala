...
object TeamsCreateDiscussionLegacyResponseData {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionLegacyResponseData]
  }
  
  extension [Self <: TeamsCreateDiscussionLegacyResponseData](x: Self) {
