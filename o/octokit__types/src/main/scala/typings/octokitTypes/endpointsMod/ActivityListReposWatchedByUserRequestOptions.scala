...
object ActivityListReposWatchedByUserRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActivityListReposWatchedByUserRequestOptions = {
  ...
  extension [Self <: ActivityListReposWatchedByUserRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashusersSlashColonusernameSlashsubscriptions): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
