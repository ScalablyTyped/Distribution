...
@js.native
trait ActionsCreateSelfHostedRunnerGroupForOrgRequestOptions extends js.Object {
...
object ActionsCreateSelfHostedRunnerGroupForOrgRequestOptions {
  ...
  @scala.inline
  implicit class ActionsCreateSelfHostedRunnerGroupForOrgRequestOptionsOps[Self <: ActionsCreateSelfHostedRunnerGroupForOrgRequestOptions] (val x: Self) extends AnyVal {
