...
trait IssuesGetLabelResponseData extends StObject {
...
object IssuesGetLabelResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IssuesGetLabelResponseData]
  }
  
  @scala.inline
  implicit class IssuesGetLabelResponseDataMutableBuilder[Self <: IssuesGetLabelResponseData] (val x: Self) extends AnyVal {
