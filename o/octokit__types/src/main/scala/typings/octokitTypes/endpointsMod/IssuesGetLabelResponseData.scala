...
@js.native
trait IssuesGetLabelResponseData extends js.Object {
...
object IssuesGetLabelResponseData {
  ...
  @scala.inline
  implicit class IssuesGetLabelResponseDataOps[Self <: IssuesGetLabelResponseData] (val x: Self) extends AnyVal {
    @scala.inline
