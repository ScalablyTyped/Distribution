...
@js.native
trait ReposGetAdminBranchProtectionRequestOptions extends js.Object {
...
object ReposGetAdminBranchProtectionRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetAdminBranchProtectionRequestOptionsOps[Self <: ReposGetAdminBranchProtectionRequestOptions] (val x: Self) extends AnyVal {
