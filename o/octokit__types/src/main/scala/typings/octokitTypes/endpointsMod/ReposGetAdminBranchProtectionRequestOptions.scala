...
object ReposGetAdminBranchProtectionRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposGetAdminBranchProtectionRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/repos/:owner/:repo/branches/:branch/protection/enforce_admins")
    __obj.asInstanceOf[ReposGetAdminBranchProtectionRequestOptions]
  }
  
  extension [Self <: ReposGetAdminBranchProtectionRequestOptions](x: Self) {
