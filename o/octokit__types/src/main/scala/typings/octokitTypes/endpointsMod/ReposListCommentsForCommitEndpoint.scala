...
object ReposListCommentsForCommitEndpoint {
  ...
  inline def apply(commit_sha: String, owner: String, repo: String): ReposListCommentsForCommitEndpoint = {
  ...
  extension [Self <: ReposListCommentsForCommitEndpoint](x: Self) {
