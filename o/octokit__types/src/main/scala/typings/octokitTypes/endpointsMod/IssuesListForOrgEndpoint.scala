...
object IssuesListForOrgEndpoint {
  ...
  inline def apply(org_ : String): IssuesListForOrgEndpoint = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("org")(org_.asInstanceOf[js.Any])
    __obj.asInstanceOf[IssuesListForOrgEndpoint]
  }
  
  extension [Self <: IssuesListForOrgEndpoint](x: Self) {
    
    inline def setDirection(value: asc | desc): Self = StObject.set(x, "direction", value.asInstanceOf[js.Any])
    
    inline def setDirectionUndefined: Self = StObject.set(x, "direction", js.undefined)
    
    inline def setFilter(value: assigned | created | mentioned | subscribed | all): Self = StObject.set(x, "filter", value.asInstanceOf[js.Any])
