...
object ActivityListPublicEventsForRepoNetworkRequestOptions {
  ...
  @scala.inline
  implicit class ActivityListPublicEventsForRepoNetworkRequestOptionsOps[Self <: ActivityListPublicEventsForRepoNetworkRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashnetworksSlashColonownerSlashColonrepoSlashevents): Self = this.set("url", value.asInstanceOf[js.Any])
  }
