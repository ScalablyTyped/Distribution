...
object TeamsListIdPGroupsInOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsListIdPGroupsInOrgRequestOptions = {
  ...
  extension [Self <: TeamsListIdPGroupsInOrgRequestOptions](x: Self) {
