...
object MigrationsDownloadArchiveForOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): MigrationsDownloadArchiveForOrgRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/orgs/:org/migrations/:migration_id/archive")
    __obj.asInstanceOf[MigrationsDownloadArchiveForOrgRequestOptions]
  }
  
  extension [Self <: MigrationsDownloadArchiveForOrgRequestOptions](x: Self) {
