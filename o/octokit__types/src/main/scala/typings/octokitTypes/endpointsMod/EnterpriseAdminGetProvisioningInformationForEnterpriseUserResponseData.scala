...
trait EnterpriseAdminGetProvisioningInformationForEnterpriseUserResponseData extends StObject {
...
object EnterpriseAdminGetProvisioningInformationForEnterpriseUserResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[EnterpriseAdminGetProvisioningInformationForEnterpriseUserResponseData]
  }
  
  @scala.inline
  implicit class EnterpriseAdminGetProvisioningInformationForEnterpriseUserResponseDataMutableBuilder[Self <: EnterpriseAdminGetProvisioningInformationForEnterpriseUserResponseData] (val x: Self) extends AnyVal {
