...
object OrgsListPendingInvitationsRequestOptions {
  ...
  @scala.inline
  implicit class OrgsListPendingInvitationsRequestOptionsOps[Self <: OrgsListPendingInvitationsRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashinvitations): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
