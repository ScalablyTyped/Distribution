...
trait IssuesReplaceAllLabelsRequestOptions extends js.Object {
...
object IssuesReplaceAllLabelsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesReplaceAllLabelsRequestOptions]
  }
}
