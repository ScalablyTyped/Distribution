...
@js.native
trait ProjectsGetColumnRequestOptions extends js.Object {
...
object ProjectsGetColumnRequestOptions {
  ...
  @scala.inline
  implicit class ProjectsGetColumnRequestOptionsOps[Self <: ProjectsGetColumnRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
