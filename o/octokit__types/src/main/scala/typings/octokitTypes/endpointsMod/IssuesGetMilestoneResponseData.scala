...
@js.native
trait IssuesGetMilestoneResponseData extends js.Object {
...
object IssuesGetMilestoneResponseData {
  ...
  @scala.inline
  implicit class IssuesGetMilestoneResponseDataOps[Self <: IssuesGetMilestoneResponseData] (val x: Self) extends AnyVal {
