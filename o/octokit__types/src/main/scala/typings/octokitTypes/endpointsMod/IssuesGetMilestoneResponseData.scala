...
@js.native
trait IssuesGetMilestoneResponseData extends StObject {
...
object IssuesGetMilestoneResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IssuesGetMilestoneResponseData]
  }
  
  @scala.inline
  implicit class IssuesGetMilestoneResponseDataMutableBuilder[Self <: IssuesGetMilestoneResponseData] (val x: Self) extends AnyVal {
