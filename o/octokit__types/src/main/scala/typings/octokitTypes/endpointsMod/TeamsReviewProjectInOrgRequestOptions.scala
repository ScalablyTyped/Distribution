...
trait TeamsReviewProjectInOrgRequestOptions extends js.Object {
...
object TeamsReviewProjectInOrgRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsReviewProjectInOrgRequestOptions]
  }
}
