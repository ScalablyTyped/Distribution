...
@js.native
trait UsersGetGpgKeyForAuthenticatedResponseData extends js.Object {
...
object UsersGetGpgKeyForAuthenticatedResponseData {
  ...
  @scala.inline
  implicit class UsersGetGpgKeyForAuthenticatedResponseDataOps[Self <: UsersGetGpgKeyForAuthenticatedResponseData] (val x: Self) extends AnyVal {
