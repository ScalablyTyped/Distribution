...
object EnterpriseAdminProvisionAndInviteEnterpriseGroupResponseData {
  ...
  @scala.inline
  implicit class EnterpriseAdminProvisionAndInviteEnterpriseGroupResponseDataMutableBuilder[Self <: EnterpriseAdminProvisionAndInviteEnterpriseGroupResponseData] (val x: Self) extends AnyVal {
