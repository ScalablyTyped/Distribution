...
trait ReactionsListForIssueEndpoint
  extends StObject
...
object ReactionsListForIssueEndpoint {
  ...
  inline def apply(issue_number: Double, mediaType: `0`[`squirrel-girl`], owner: String, repo: String): ReactionsListForIssueEndpoint = {
  ...
  extension [Self <: ReactionsListForIssueEndpoint](x: Self) {
