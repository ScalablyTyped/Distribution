...
trait EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseResponseData extends StObject {
...
object EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseResponseData {
  ...
  @scala.inline
  implicit class EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseResponseDataMutableBuilder[Self <: EnterpriseAdminGetSelfHostedRunnerGroupForEnterpriseResponseData] (val x: Self) extends AnyVal {
