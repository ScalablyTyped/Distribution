...
trait CodeScanningUpdateAlertRequestOptions extends StObject {
  ...
  var url: `SlashreposSlashColonownerSlashColonrepoSlashcode-scanningSlashalertsSlashColonalert_number`
}
object CodeScanningUpdateAlertRequestOptions {
  
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): CodeScanningUpdateAlertRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "PATCH", request = request.asInstanceOf[js.Any], url = "/repos/:owner/:repo/code-scanning/alerts/:alert_number")
    __obj.asInstanceOf[CodeScanningUpdateAlertRequestOptions]
  }
  
  extension [Self <: CodeScanningUpdateAlertRequestOptions](x: Self) {
