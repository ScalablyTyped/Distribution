...
@js.native
trait ActivityListNotificationsForAuthenticatedUserEndpoint extends js.Object {
  /**
...
object ActivityListNotificationsForAuthenticatedUserEndpoint {
  ...
  @scala.inline
  implicit class ActivityListNotificationsForAuthenticatedUserEndpointOps[Self <: ActivityListNotificationsForAuthenticatedUserEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
