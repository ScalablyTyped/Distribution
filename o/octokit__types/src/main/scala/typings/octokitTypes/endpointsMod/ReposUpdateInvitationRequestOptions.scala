...
object ReposUpdateInvitationRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposUpdateInvitationRequestOptions = {
  ...
  extension [Self <: ReposUpdateInvitationRequestOptions](x: Self) {
