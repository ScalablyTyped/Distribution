...
trait ReposUpdateInvitationRequestOptions extends js.Object {
  ...
  var url: SlashreposSlashColonownerSlashColonrepoSlashinvitationsSlashColoninvitation_id = js.native
}
object ReposUpdateInvitationRequestOptions {
  ...
  @scala.inline
  implicit class ReposUpdateInvitationRequestOptionsOps[Self <: ReposUpdateInvitationRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashinvitationsSlashColoninvitation_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
