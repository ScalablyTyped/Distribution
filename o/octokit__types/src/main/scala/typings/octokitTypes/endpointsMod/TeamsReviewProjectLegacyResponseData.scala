...
trait TeamsReviewProjectLegacyResponseData extends js.Object {
  var body: String
...
object TeamsReviewProjectLegacyResponseData {
  @scala.inline
  def apply(
    body: String,
    columns_url: String,
    ...
    __obj.asInstanceOf[TeamsReviewProjectLegacyResponseData]
  }
}
