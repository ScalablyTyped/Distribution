...
trait TeamsReviewProjectLegacyEndpoint extends js.Object {
  var mediaType: `8`
  var project_id: Double
  var team_id: Double
}

object TeamsReviewProjectLegacyEndpoint {
  @scala.inline
  def apply(mediaType: `8`, project_id: Double, team_id: Double): TeamsReviewProjectLegacyEndpoint = {
    ...
    __obj.asInstanceOf[TeamsReviewProjectLegacyEndpoint]
  }
}
