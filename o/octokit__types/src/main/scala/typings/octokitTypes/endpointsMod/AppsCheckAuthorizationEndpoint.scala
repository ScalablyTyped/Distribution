...
@js.native
trait AppsCheckAuthorizationEndpoint extends js.Object {
...
object AppsCheckAuthorizationEndpoint {
  ...
  @scala.inline
  implicit class AppsCheckAuthorizationEndpointOps[Self <: AppsCheckAuthorizationEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
