...
@js.native
trait EnterpriseAdminGetGithubActionsBillingGheEndpoint extends js.Object {
...
object EnterpriseAdminGetGithubActionsBillingGheEndpoint {
  ...
  @scala.inline
  implicit class EnterpriseAdminGetGithubActionsBillingGheEndpointOps[Self <: EnterpriseAdminGetGithubActionsBillingGheEndpoint] (val x: Self) extends AnyVal {
