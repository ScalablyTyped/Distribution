...
object ReposAcceptInvitationRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposAcceptInvitationRequestOptions = {
  ...
  extension [Self <: ReposAcceptInvitationRequestOptions](x: Self) {
