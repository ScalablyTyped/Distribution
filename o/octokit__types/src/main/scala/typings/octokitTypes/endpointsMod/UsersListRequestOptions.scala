...
object UsersListRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): UsersListRequestOptions = {
  ...
  extension [Self <: UsersListRequestOptions](x: Self) {
    ...
    inline def setUrl(value: Slashusers): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
