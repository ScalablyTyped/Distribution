...
object OauthAuthorizationsUpdateAuthorizationRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): OauthAuthorizationsUpdateAuthorizationRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "PATCH", request = request.asInstanceOf[js.Any], url = "/authorizations/:authorization_id")
    __obj.asInstanceOf[OauthAuthorizationsUpdateAuthorizationRequestOptions]
  }
  
  extension [Self <: OauthAuthorizationsUpdateAuthorizationRequestOptions](x: Self) {
