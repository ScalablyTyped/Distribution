...
object OauthAuthorizationsUpdateAuthorizationRequestOptions {
  ...
  @scala.inline
  implicit class OauthAuthorizationsUpdateAuthorizationRequestOptionsOps[Self <: OauthAuthorizationsUpdateAuthorizationRequestOptions] (val x: Self) extends AnyVal {
