...
object OrgsListInvitationTeamsRequestOptions {
  ...
  @scala.inline
  implicit class OrgsListInvitationTeamsRequestOptionsOps[Self <: OrgsListInvitationTeamsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashinvitationsSlashColoninvitation_idSlashteams): Self = this.set("url", value.asInstanceOf[js.Any])
  }
