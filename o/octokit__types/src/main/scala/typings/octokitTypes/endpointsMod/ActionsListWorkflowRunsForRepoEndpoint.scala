...
@js.native
trait ActionsListWorkflowRunsForRepoEndpoint extends js.Object {
  /**
...
object ActionsListWorkflowRunsForRepoEndpoint {
  @scala.inline
  def apply(owner: String, repo: String): ActionsListWorkflowRunsForRepoEndpoint = {
    val __obj = js.Dynamic.literal(owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[ActionsListWorkflowRunsForRepoEndpoint]
  }
  @scala.inline
  implicit class ActionsListWorkflowRunsForRepoEndpointOps[Self <: ActionsListWorkflowRunsForRepoEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
