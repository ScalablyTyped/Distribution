...
object ReposListForksEndpoint {
  ...
  @scala.inline
  implicit class ReposListForksEndpointOps[Self <: ReposListForksEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSort(value: newest | oldest | stargazers): Self = this.set("sort", value.asInstanceOf[js.Any])
