...
object ReposUpdateCommitCommentRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposUpdateCommitCommentRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "PATCH", request = request.asInstanceOf[js.Any], url = "/repos/:owner/:repo/comments/:comment_id")
    __obj.asInstanceOf[ReposUpdateCommitCommentRequestOptions]
  }
  
  extension [Self <: ReposUpdateCommitCommentRequestOptions](x: Self) {
