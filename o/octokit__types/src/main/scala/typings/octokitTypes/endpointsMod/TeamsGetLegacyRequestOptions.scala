...
trait TeamsGetLegacyRequestOptions extends js.Object {
  ...
  var url: SlashteamsSlashColonteam_id = js.native
}
object TeamsGetLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsGetLegacyRequestOptionsOps[Self <: TeamsGetLegacyRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashteamsSlashColonteam_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
