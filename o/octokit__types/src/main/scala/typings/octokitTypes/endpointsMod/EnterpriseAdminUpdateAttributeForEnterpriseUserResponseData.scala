...
trait EnterpriseAdminUpdateAttributeForEnterpriseUserResponseData extends StObject {
...
object EnterpriseAdminUpdateAttributeForEnterpriseUserResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[EnterpriseAdminUpdateAttributeForEnterpriseUserResponseData]
  }
  
  @scala.inline
  implicit class EnterpriseAdminUpdateAttributeForEnterpriseUserResponseDataMutableBuilder[Self <: EnterpriseAdminUpdateAttributeForEnterpriseUserResponseData] (val x: Self) extends AnyVal {
