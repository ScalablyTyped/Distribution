...
object SearchCodeRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): SearchCodeRequestOptions = {
  ...
  extension [Self <: SearchCodeRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashsearchSlashcode): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
