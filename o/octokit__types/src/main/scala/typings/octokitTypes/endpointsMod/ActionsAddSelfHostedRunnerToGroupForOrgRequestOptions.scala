...
@js.native
trait ActionsAddSelfHostedRunnerToGroupForOrgRequestOptions extends js.Object {
...
object ActionsAddSelfHostedRunnerToGroupForOrgRequestOptions {
  ...
  @scala.inline
  implicit class ActionsAddSelfHostedRunnerToGroupForOrgRequestOptionsOps[Self <: ActionsAddSelfHostedRunnerToGroupForOrgRequestOptions] (val x: Self) extends AnyVal {
