...
/* Inlined {  owner  :string,   repo  :string,   source ? :@octokit/types.@octokit/types/dist-types/generated/Endpoints.ReposEnablePagesSiteParamsSource} & @octokit/types.@octokit/types/dist-types/generated/Endpoints.RequiredPreview<'switcheroo'> */
...
object ReposEnablePagesSiteEndpoint {
  @scala.inline
  def apply(mediaType: `15`, owner: String, repo: String, source: ReposEnablePagesSiteParamsSource = null): ReposEnablePagesSiteEndpoint = {
