...
object TeamsListReposLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsListReposLegacyRequestOptionsOps[Self <: TeamsListReposLegacyRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashteamsSlashColonteam_idSlashrepos): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
