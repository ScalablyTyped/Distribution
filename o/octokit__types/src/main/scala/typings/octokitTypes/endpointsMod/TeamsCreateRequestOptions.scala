...
object TeamsCreateRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsCreateRequestOptions = {
  ...
  extension [Self <: TeamsCreateRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashorgsSlashColonorgSlashteams): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
