...
object PullsListReviewCommentsRequestOptions {
  ...
  @scala.inline
  def apply(headers: RequestHeaders, request: RequestRequestOptions): PullsListReviewCommentsRequestOptions = {
  ...
  @scala.inline
  implicit class PullsListReviewCommentsRequestOptionsMutableBuilder[Self <: PullsListReviewCommentsRequestOptions] (val x: Self) extends AnyVal {
