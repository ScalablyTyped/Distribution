...
@js.native
trait PullsListReviewCommentsRequestOptions extends js.Object {
...
object PullsListReviewCommentsRequestOptions {
  ...
  @scala.inline
  implicit class PullsListReviewCommentsRequestOptionsOps[Self <: PullsListReviewCommentsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashpullsSlashColonpull_numberSlashcomments): Self = this.set("url", value.asInstanceOf[js.Any])
  }
