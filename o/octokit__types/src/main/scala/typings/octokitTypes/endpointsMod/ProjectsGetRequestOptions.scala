...
object ProjectsGetRequestOptions {
  ...
  @scala.inline
  implicit class ProjectsGetRequestOptionsOps[Self <: ProjectsGetRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashprojectsSlashColonproject_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
