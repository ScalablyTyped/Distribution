...
object ReposGetUsersWithAccessToProtectedBranchRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposGetUsersWithAccessToProtectedBranchRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/repos/:owner/:repo/branches/:branch/protection/restrictions/users")
    __obj.asInstanceOf[ReposGetUsersWithAccessToProtectedBranchRequestOptions]
  }
  
  extension [Self <: ReposGetUsersWithAccessToProtectedBranchRequestOptions](x: Self) {
