...
object ReposListForksRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposListForksRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/repos/:owner/:repo/forks")
    __obj.asInstanceOf[ReposListForksRequestOptions]
  }
  
  extension [Self <: ReposListForksRequestOptions](x: Self) {
