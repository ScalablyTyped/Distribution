...
object AppsAddRepoToInstallationRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): AppsAddRepoToInstallationRequestOptions = {
  ...
  extension [Self <: AppsAddRepoToInstallationRequestOptions](x: Self) {
