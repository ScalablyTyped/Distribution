...
object AppsCheckTokenRequestOptions {
  ...
  @scala.inline
  implicit class AppsCheckTokenRequestOptionsOps[Self <: AppsCheckTokenRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashapplicationsSlashColonclient_idSlashtoken): Self = this.set("url", value.asInstanceOf[js.Any])
  }
