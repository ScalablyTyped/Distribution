...
object AppsListAccountsForPlanRequestOptions {
  ...
  @scala.inline
  implicit class AppsListAccountsForPlanRequestOptionsOps[Self <: AppsListAccountsForPlanRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: Slashmarketplace_listingSlashplansSlashColonplan_idSlashaccounts): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
