...
object TeamsListIdPGroupsForLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsListIdPGroupsForLegacyRequestOptionsOps[Self <: TeamsListIdPGroupsForLegacyRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: `SlashteamsSlashColonteam_idSlashteam-syncSlashgroup-mappings`): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
