...
object TeamsListIdPGroupsForLegacyRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsListIdPGroupsForLegacyRequestOptions = {
  ...
  extension [Self <: TeamsListIdPGroupsForLegacyRequestOptions](x: Self) {
