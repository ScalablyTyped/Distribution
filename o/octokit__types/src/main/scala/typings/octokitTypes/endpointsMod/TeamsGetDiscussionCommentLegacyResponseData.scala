...
@js.native
trait TeamsGetDiscussionCommentLegacyResponseData extends js.Object {
...
object TeamsGetDiscussionCommentLegacyResponseData {
  ...
  @scala.inline
  implicit class TeamsGetDiscussionCommentLegacyResponseDataOps[Self <: TeamsGetDiscussionCommentLegacyResponseData] (val x: Self) extends AnyVal {
    @scala.inline
