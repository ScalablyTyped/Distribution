...
object ActivityGetThreadRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActivityGetThreadRequestOptions = {
  ...
  extension [Self <: ActivityGetThreadRequestOptions](x: Self) {
