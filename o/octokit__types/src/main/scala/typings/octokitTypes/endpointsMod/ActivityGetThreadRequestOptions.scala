...
object ActivityGetThreadRequestOptions {
  ...
  @scala.inline
  implicit class ActivityGetThreadRequestOptionsOps[Self <: ActivityGetThreadRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashnotificationsSlashthreadsSlashColonthread_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
