...
trait MigrationsSetLfsPreferenceRequestOptions extends js.Object {
  ...
  var url: SlashreposSlashColonownerSlashColonrepoSlashimportSlashlfs = js.native
}
...
object MigrationsSetLfsPreferenceRequestOptions {
  ...
  @scala.inline
  implicit class MigrationsSetLfsPreferenceRequestOptionsOps[Self <: MigrationsSetLfsPreferenceRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashimportSlashlfs): Self = this.set("url", value.asInstanceOf[js.Any])
  }
