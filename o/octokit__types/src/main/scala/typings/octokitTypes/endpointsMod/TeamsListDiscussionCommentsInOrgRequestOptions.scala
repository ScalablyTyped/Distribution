...
object TeamsListDiscussionCommentsInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsListDiscussionCommentsInOrgRequestOptionsMutableBuilder[Self <: TeamsListDiscussionCommentsInOrgRequestOptions] (val x: Self) extends AnyVal {
