...
@js.native
trait OauthAuthorizationsCreateAuthorizationResponseData extends StObject {
...
object OauthAuthorizationsCreateAuthorizationResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsCreateAuthorizationResponseData]
  }
  
  @scala.inline
  implicit class OauthAuthorizationsCreateAuthorizationResponseDataMutableBuilder[Self <: OauthAuthorizationsCreateAuthorizationResponseData] (val x: Self) extends AnyVal {
