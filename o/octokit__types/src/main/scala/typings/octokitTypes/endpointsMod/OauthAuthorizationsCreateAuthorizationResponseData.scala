...
@js.native
trait OauthAuthorizationsCreateAuthorizationResponseData extends js.Object {
...
object OauthAuthorizationsCreateAuthorizationResponseData {
  ...
  @scala.inline
  implicit class OauthAuthorizationsCreateAuthorizationResponseDataOps[Self <: OauthAuthorizationsCreateAuthorizationResponseData] (val x: Self) extends AnyVal {
