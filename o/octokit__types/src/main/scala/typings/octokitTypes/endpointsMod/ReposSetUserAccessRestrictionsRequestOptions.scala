...
@js.native
trait ReposSetUserAccessRestrictionsRequestOptions extends js.Object {
...
object ReposSetUserAccessRestrictionsRequestOptions {
  ...
  @scala.inline
  implicit class ReposSetUserAccessRestrictionsRequestOptionsOps[Self <: ReposSetUserAccessRestrictionsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
