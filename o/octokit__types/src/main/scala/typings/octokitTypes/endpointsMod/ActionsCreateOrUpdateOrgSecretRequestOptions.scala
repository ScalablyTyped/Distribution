...
object ActionsCreateOrUpdateOrgSecretRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActionsCreateOrUpdateOrgSecretRequestOptions = {
  ...
  extension [Self <: ActionsCreateOrUpdateOrgSecretRequestOptions](x: Self) {
