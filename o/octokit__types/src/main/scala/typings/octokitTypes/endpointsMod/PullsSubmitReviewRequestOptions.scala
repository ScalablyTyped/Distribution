...
object PullsSubmitReviewRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): PullsSubmitReviewRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "POST", request = request.asInstanceOf[js.Any], url = "/repos/:owner/:repo/pulls/:pull_number/reviews/:review_id/events")
    __obj.asInstanceOf[PullsSubmitReviewRequestOptions]
  }
  
  extension [Self <: PullsSubmitReviewRequestOptions](x: Self) {
