...
object TeamsGetDiscussionCommentLegacyRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsGetDiscussionCommentLegacyRequestOptions = {
  ...
  extension [Self <: TeamsGetDiscussionCommentLegacyRequestOptions](x: Self) {
