...
object ProjectsCreateForOrgRequestOptions {
  ...
  @scala.inline
  implicit class ProjectsCreateForOrgRequestOptionsOps[Self <: ProjectsCreateForOrgRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashprojects): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
