...
object PullsGetRequestOptions {
  ...
  @scala.inline
  def apply(headers: RequestHeaders, request: RequestRequestOptions): PullsGetRequestOptions = {
  ...
  @scala.inline
  implicit class PullsGetRequestOptionsMutableBuilder[Self <: PullsGetRequestOptions] (val x: Self) extends AnyVal {
