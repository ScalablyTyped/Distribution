...
object ReposRemoveCollaboratorRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposRemoveCollaboratorRequestOptions = {
  ...
  extension [Self <: ReposRemoveCollaboratorRequestOptions](x: Self) {
