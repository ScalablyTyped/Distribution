...
@js.native
trait IssuesUpdateLabelResponseData extends js.Object {
...
object IssuesUpdateLabelResponseData {
  ...
  @scala.inline
  implicit class IssuesUpdateLabelResponseDataOps[Self <: IssuesUpdateLabelResponseData] (val x: Self) extends AnyVal {
