...
trait ActionsCreateRemoveTokenForOrgRequestOptions extends js.Object {
  ...
  var url: `SlashorgsSlashColonorgSlashactionsSlashrunnersSlashremove-token` = js.native
}
...
object ActionsCreateRemoveTokenForOrgRequestOptions {
  ...
  @scala.inline
  implicit class ActionsCreateRemoveTokenForOrgRequestOptionsOps[Self <: ActionsCreateRemoveTokenForOrgRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: `SlashorgsSlashColonorgSlashactionsSlashrunnersSlashremove-token`): Self = this.set("url", value.asInstanceOf[js.Any])
  }
