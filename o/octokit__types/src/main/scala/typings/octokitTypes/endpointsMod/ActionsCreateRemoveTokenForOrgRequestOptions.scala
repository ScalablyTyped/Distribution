...
object ActionsCreateRemoveTokenForOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActionsCreateRemoveTokenForOrgRequestOptions = {
  ...
  extension [Self <: ActionsCreateRemoveTokenForOrgRequestOptions](x: Self) {
    ...
    inline def setUrl(value: `SlashorgsSlashColonorgSlashactionsSlashrunnersSlashremove-token`): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
