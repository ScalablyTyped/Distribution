...
trait ReposAddProtectedBranchTeamRestrictionsRequestOptions extends js.Object {
...
object ReposAddProtectedBranchTeamRestrictionsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposAddProtectedBranchTeamRestrictionsRequestOptions]
  }
}
