...
object ReposListContributorsEndpoint {
  ...
  @scala.inline
  implicit class ReposListContributorsEndpointOps[Self <: ReposListContributorsEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAnon(value: String): Self = this.set("anon", value.asInstanceOf[js.Any])
    @scala.inline
