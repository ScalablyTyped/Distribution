...
object GistsDeleteRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): GistsDeleteRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "DELETE", request = request.asInstanceOf[js.Any], url = "/gists/:gist_id")
    __obj.asInstanceOf[GistsDeleteRequestOptions]
  }
  
  extension [Self <: GistsDeleteRequestOptions](x: Self) {
