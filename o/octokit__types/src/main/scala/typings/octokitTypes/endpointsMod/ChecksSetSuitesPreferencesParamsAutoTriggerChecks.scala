...
object ChecksSetSuitesPreferencesParamsAutoTriggerChecks {
  ...
  inline def apply(app_id: Double, setting: Boolean): ChecksSetSuitesPreferencesParamsAutoTriggerChecks = {
  ...
  extension [Self <: ChecksSetSuitesPreferencesParamsAutoTriggerChecks](x: Self) {
