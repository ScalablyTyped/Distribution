...
object ReposDisableAutomatedSecurityFixesRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposDisableAutomatedSecurityFixesRequestOptions = {
  ...
  extension [Self <: ReposDisableAutomatedSecurityFixesRequestOptions](x: Self) {
