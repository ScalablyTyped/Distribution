...
object TeamsGetMembershipForUserLegacyResponseData {
  ...
  inline def apply(role: String, state: String, url: String): TeamsGetMembershipForUserLegacyResponseData = {
  ...
  extension [Self <: TeamsGetMembershipForUserLegacyResponseData](x: Self) {
