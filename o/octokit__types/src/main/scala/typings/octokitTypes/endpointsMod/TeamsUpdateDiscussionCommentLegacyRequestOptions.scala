...
object TeamsUpdateDiscussionCommentLegacyRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsUpdateDiscussionCommentLegacyRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "PATCH", request = request.asInstanceOf[js.Any], url = "/teams/:team_id/discussions/:discussion_number/comments/:comment_number")
    __obj.asInstanceOf[TeamsUpdateDiscussionCommentLegacyRequestOptions]
  }
  
  extension [Self <: TeamsUpdateDiscussionCommentLegacyRequestOptions](x: Self) {
