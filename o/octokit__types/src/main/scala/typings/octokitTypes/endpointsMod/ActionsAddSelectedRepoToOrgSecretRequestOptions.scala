...
object ActionsAddSelectedRepoToOrgSecretRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActionsAddSelectedRepoToOrgSecretRequestOptions = {
  ...
  extension [Self <: ActionsAddSelectedRepoToOrgSecretRequestOptions](x: Self) {
