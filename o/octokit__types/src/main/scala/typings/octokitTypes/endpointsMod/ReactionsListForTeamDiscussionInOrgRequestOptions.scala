...
object ReactionsListForTeamDiscussionInOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReactionsListForTeamDiscussionInOrgRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/orgs/:org/teams/:team_slug/discussions/:discussion_number/reactions")
    __obj.asInstanceOf[ReactionsListForTeamDiscussionInOrgRequestOptions]
  }
  
  extension [Self <: ReactionsListForTeamDiscussionInOrgRequestOptions](x: Self) {
