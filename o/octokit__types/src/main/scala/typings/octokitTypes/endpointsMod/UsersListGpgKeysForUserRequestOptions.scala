...
object UsersListGpgKeysForUserRequestOptions {
  ...
  @scala.inline
  implicit class UsersListGpgKeysForUserRequestOptionsOps[Self <: UsersListGpgKeysForUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashusersSlashColonusernameSlashgpg_keys): Self = this.set("url", value.asInstanceOf[js.Any])
  }
