...
@js.native
trait ActionsRemoveSelectedRepoFromOrgSecretRequestOptions extends js.Object {
...
object ActionsRemoveSelectedRepoFromOrgSecretRequestOptions {
  ...
  @scala.inline
  implicit class ActionsRemoveSelectedRepoFromOrgSecretRequestOptionsOps[Self <: ActionsRemoveSelectedRepoFromOrgSecretRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
