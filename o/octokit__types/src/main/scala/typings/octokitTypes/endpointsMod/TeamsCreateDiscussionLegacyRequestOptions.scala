...
@js.native
trait TeamsCreateDiscussionLegacyRequestOptions extends js.Object {
...
object TeamsCreateDiscussionLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionLegacyRequestOptionsOps[Self <: TeamsCreateDiscussionLegacyRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashteamsSlashColonteam_idSlashdiscussions): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
