...
@js.native
trait TeamsGetDiscussionCommentInOrgResponseData extends StObject {
...
object TeamsGetDiscussionCommentInOrgResponseData {
  ...
  @scala.inline
  implicit class TeamsGetDiscussionCommentInOrgResponseDataMutableBuilder[Self <: TeamsGetDiscussionCommentInOrgResponseData] (val x: Self) extends AnyVal {
