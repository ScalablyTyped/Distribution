...
object ActivityGetThreadSubscriptionForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class ActivityGetThreadSubscriptionForAuthenticatedUserRequestOptionsOps[Self <: ActivityGetThreadSubscriptionForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
