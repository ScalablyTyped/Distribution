...
object AppsRevokeGrantForApplicationRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): AppsRevokeGrantForApplicationRequestOptions = {
  ...
  extension [Self <: AppsRevokeGrantForApplicationRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashapplicationsSlashColonclient_idSlashgrantsSlashColonaccess_token): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
