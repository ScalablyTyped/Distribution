...
object OrgsBlockUserRequestOptions {
  ...
  @scala.inline
  implicit class OrgsBlockUserRequestOptionsOps[Self <: OrgsBlockUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashblocksSlashColonusername): Self = this.set("url", value.asInstanceOf[js.Any])
  }
