...
@js.native
trait ProjectsCreateCardResponseData extends js.Object {
...
object ProjectsCreateCardResponseData {
  ...
  @scala.inline
  implicit class ProjectsCreateCardResponseDataOps[Self <: ProjectsCreateCardResponseData] (val x: Self) extends AnyVal {
    @scala.inline
