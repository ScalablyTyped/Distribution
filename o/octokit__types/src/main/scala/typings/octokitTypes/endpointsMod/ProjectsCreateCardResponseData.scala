...
trait ProjectsCreateCardResponseData extends StObject {
...
object ProjectsCreateCardResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ProjectsCreateCardResponseData]
  }
  
  @scala.inline
  implicit class ProjectsCreateCardResponseDataMutableBuilder[Self <: ProjectsCreateCardResponseData] (val x: Self) extends AnyVal {
