...
trait UsersCheckFollowingForUserRequestOptions extends js.Object {
  ...
  var url: SlashusersSlashColonusernameSlashfollowingSlashColontarget_user = js.native
}
object UsersCheckFollowingForUserRequestOptions {
  ...
  @scala.inline
  implicit class UsersCheckFollowingForUserRequestOptionsOps[Self <: UsersCheckFollowingForUserRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashusersSlashColonusernameSlashfollowingSlashColontarget_user): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
