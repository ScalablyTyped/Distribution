...
object UsersCheckFollowingForUserRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): UsersCheckFollowingForUserRequestOptions = {
  ...
  extension [Self <: UsersCheckFollowingForUserRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashusersSlashColonusernameSlashfollowingSlashColontarget_user): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
