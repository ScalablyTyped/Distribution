...
@js.native
trait PullsCreateReviewResponseData extends StObject {
...
object PullsCreateReviewResponseData {
  ...
  @scala.inline
  implicit class PullsCreateReviewResponseDataMutableBuilder[Self <: PullsCreateReviewResponseData] (val x: Self) extends AnyVal {
