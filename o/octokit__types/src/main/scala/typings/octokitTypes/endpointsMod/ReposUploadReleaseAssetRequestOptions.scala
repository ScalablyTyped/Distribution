...
object ReposUploadReleaseAssetRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposUploadReleaseAssetRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "POST", request = request.asInstanceOf[js.Any], url = "/repos/:owner/:repo/releases/:release_id/assets{?name,label}")
    __obj.asInstanceOf[ReposUploadReleaseAssetRequestOptions]
  }
  
  extension [Self <: ReposUploadReleaseAssetRequestOptions](x: Self) {
