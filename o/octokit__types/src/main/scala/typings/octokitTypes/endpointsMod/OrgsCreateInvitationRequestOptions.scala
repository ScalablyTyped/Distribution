...
object OrgsCreateInvitationRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): OrgsCreateInvitationRequestOptions = {
  ...
  extension [Self <: OrgsCreateInvitationRequestOptions](x: Self) {
