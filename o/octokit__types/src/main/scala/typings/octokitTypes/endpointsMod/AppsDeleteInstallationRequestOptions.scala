...
trait AppsDeleteInstallationRequestOptions extends js.Object {
  ...
  var url: SlashappSlashinstallationsSlashColoninstallation_id = js.native
}
...
object AppsDeleteInstallationRequestOptions {
  ...
  @scala.inline
  implicit class AppsDeleteInstallationRequestOptionsOps[Self <: AppsDeleteInstallationRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashappSlashinstallationsSlashColoninstallation_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
