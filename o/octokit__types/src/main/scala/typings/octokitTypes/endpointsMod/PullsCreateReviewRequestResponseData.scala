...
trait PullsCreateReviewRequestResponseData extends js.Object {
  var _links: Commits
...
object PullsCreateReviewRequestResponseData {
  @scala.inline
  def apply(
    _links: Commits,
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseData]
  }
}
