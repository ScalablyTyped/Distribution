...
object GitGetTreeRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): GitGetTreeRequestOptions = {
  ...
  extension [Self <: GitGetTreeRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashgitSlashtreesSlashColontree_sha): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
