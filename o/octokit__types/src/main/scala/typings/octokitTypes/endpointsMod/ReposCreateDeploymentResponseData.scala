...
@js.native
trait ReposCreateDeploymentResponseData extends js.Object {
...
object ReposCreateDeploymentResponseData {
  ...
  @scala.inline
  implicit class ReposCreateDeploymentResponseDataOps[Self <: ReposCreateDeploymentResponseData] (val x: Self) extends AnyVal {
