...
@js.native
trait ProjectsGetColumnResponseData extends js.Object {
...
object ProjectsGetColumnResponseData {
  ...
  @scala.inline
  implicit class ProjectsGetColumnResponseDataOps[Self <: ProjectsGetColumnResponseData] (val x: Self) extends AnyVal {
    @scala.inline
