...
object PullsUpdateBranchRequestOptions {
  ...
  @scala.inline
  implicit class PullsUpdateBranchRequestOptionsOps[Self <: PullsUpdateBranchRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: `SlashreposSlashColonownerSlashColonrepoSlashpullsSlashColonpull_numberSlashupdate-branch`): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
