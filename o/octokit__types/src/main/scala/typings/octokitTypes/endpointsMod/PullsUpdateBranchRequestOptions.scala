...
object PullsUpdateBranchRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): PullsUpdateBranchRequestOptions = {
  ...
  extension [Self <: PullsUpdateBranchRequestOptions](x: Self) {
    ...
    inline def setUrl(value: `SlashreposSlashColonownerSlashColonrepoSlashpullsSlashColonpull_numberSlashupdate-branch`): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
