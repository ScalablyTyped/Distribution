...
trait TeamsCreateDiscussionCommentLegacyResponseData extends StObject {
...
object TeamsCreateDiscussionCommentLegacyResponseData {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionCommentLegacyResponseDataMutableBuilder[Self <: TeamsCreateDiscussionCommentLegacyResponseData] (val x: Self) extends AnyVal {
