...
trait PullsGetReviewRequestOptions extends StObject {
...
object PullsGetReviewRequestOptions {
  ...
  @scala.inline
  def apply(headers: RequestHeaders, request: RequestRequestOptions): PullsGetReviewRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/repos/:owner/:repo/pulls/:pull_number/reviews/:review_id")
    __obj.asInstanceOf[PullsGetReviewRequestOptions]
  }
  
  @scala.inline
  implicit class PullsGetReviewRequestOptionsMutableBuilder[Self <: PullsGetReviewRequestOptions] (val x: Self) extends AnyVal {
