...
object EnterpriseAdminListSelfHostedRunnersForEnterpriseRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): EnterpriseAdminListSelfHostedRunnersForEnterpriseRequestOptions = {
  ...
  extension [Self <: EnterpriseAdminListSelfHostedRunnersForEnterpriseRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashenterprisesSlashColonenterpriseSlashactionsSlashrunners): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
