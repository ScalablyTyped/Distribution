...
object TeamsUpdateDiscussionLegacyRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsUpdateDiscussionLegacyRequestOptions = {
  ...
  extension [Self <: TeamsUpdateDiscussionLegacyRequestOptions](x: Self) {
