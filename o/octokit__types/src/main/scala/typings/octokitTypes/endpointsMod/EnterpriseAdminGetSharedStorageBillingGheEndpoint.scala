...
@js.native
trait EnterpriseAdminGetSharedStorageBillingGheEndpoint extends js.Object {
...
object EnterpriseAdminGetSharedStorageBillingGheEndpoint {
  ...
  @scala.inline
  implicit class EnterpriseAdminGetSharedStorageBillingGheEndpointOps[Self <: EnterpriseAdminGetSharedStorageBillingGheEndpoint] (val x: Self) extends AnyVal {
