...
trait ActionsCreateRegistrationTokenForOrgRequestOptions extends js.Object {
  ...
  var url: `SlashorgsSlashColonorgSlashactionsSlashrunnersSlashregistration-token` = js.native
}
object ActionsCreateRegistrationTokenForOrgRequestOptions {
  ...
  @scala.inline
  implicit class ActionsCreateRegistrationTokenForOrgRequestOptionsOps[Self <: ActionsCreateRegistrationTokenForOrgRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: `SlashorgsSlashColonorgSlashactionsSlashrunnersSlashregistration-token`): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
