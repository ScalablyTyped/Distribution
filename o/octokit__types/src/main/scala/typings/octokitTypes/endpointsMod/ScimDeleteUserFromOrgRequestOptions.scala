...
object ScimDeleteUserFromOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ScimDeleteUserFromOrgRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "DELETE", request = request.asInstanceOf[js.Any], url = "/scim/v2/organizations/:org/Users/:scim_user_id")
    __obj.asInstanceOf[ScimDeleteUserFromOrgRequestOptions]
  }
  
  extension [Self <: ScimDeleteUserFromOrgRequestOptions](x: Self) {
