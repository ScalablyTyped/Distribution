...
trait TeamsReviewProjectInOrgResponseData extends js.Object {
  var body: String
...
object TeamsReviewProjectInOrgResponseData {
  @scala.inline
  def apply(
    body: String,
    columns_url: String,
    ...
    __obj.asInstanceOf[TeamsReviewProjectInOrgResponseData]
  }
}
