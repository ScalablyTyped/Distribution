...
object ReposListForOrgEndpoint {
  ...
  @scala.inline
  implicit class ReposListForOrgEndpointOps[Self <: ReposListForOrgEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: all | public | `private` | forks | sources | member | internal): Self = this.set("type", value.asInstanceOf[js.Any])
