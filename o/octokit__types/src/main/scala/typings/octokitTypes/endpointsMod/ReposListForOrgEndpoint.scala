...
object ReposListForOrgEndpoint {
  ...
  inline def apply(org_ : String): ReposListForOrgEndpoint = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("org")(org_.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReposListForOrgEndpoint]
  }
  
  extension [Self <: ReposListForOrgEndpoint](x: Self) {
    ...
    inline def setType(value: all | public | `private` | forks | sources | member | internal): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
