...
object ReposCreateReleaseResponseData {
  ...
  extension [Self <: ReposCreateReleaseResponseData](x: Self) {
    
    inline def setAssets(value: js.Array[js.Any]): Self = StObject.set(x, "assets", value.asInstanceOf[js.Any])
    
    inline def setAssetsVarargs(value: js.Any*): Self = StObject.set(x, "assets", js.Array(value :_*))
