...
object AppsCreateFromManifestRequestOptions {
  ...
  @scala.inline
  implicit class AppsCreateFromManifestRequestOptionsMutableBuilder[Self <: AppsCreateFromManifestRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: `Slashapp-manifestsSlashColoncodeSlashconversions`): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
