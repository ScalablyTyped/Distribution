...
object AppsCreateFromManifestRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): AppsCreateFromManifestRequestOptions = {
  ...
  extension [Self <: AppsCreateFromManifestRequestOptions](x: Self) {
    ...
    inline def setUrl(value: `Slashapp-manifestsSlashColoncodeSlashconversions`): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
