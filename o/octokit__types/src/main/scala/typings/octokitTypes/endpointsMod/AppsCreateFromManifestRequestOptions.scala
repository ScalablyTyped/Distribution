...
object AppsCreateFromManifestRequestOptions {
  ...
  @scala.inline
  implicit class AppsCreateFromManifestRequestOptionsOps[Self <: AppsCreateFromManifestRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: `Slashapp-manifestsSlashColoncodeSlashconversions`): Self = this.set("url", value.asInstanceOf[js.Any])
  }
