...
object TeamsGetMembershipForUserLegacyRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsGetMembershipForUserLegacyRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/teams/:team_id/memberships/:username")
    __obj.asInstanceOf[TeamsGetMembershipForUserLegacyRequestOptions]
  }
  
  extension [Self <: TeamsGetMembershipForUserLegacyRequestOptions](x: Self) {
