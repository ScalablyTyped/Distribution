...
object ReposDeleteCommitSignatureProtectionEndpoint {
  ...
  inline def apply(branch: String, mediaType: `0`[zzzax], owner: String, repo: String): ReposDeleteCommitSignatureProtectionEndpoint = {
  ...
  extension [Self <: ReposDeleteCommitSignatureProtectionEndpoint](x: Self) {
