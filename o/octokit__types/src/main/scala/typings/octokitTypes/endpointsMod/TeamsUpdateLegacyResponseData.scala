...
@js.native
trait TeamsUpdateLegacyResponseData extends js.Object {
...
object TeamsUpdateLegacyResponseData {
  ...
  @scala.inline
  implicit class TeamsUpdateLegacyResponseDataOps[Self <: TeamsUpdateLegacyResponseData] (val x: Self) extends AnyVal {
