...
@js.native
trait ReposGetUsersWithAccessToProtectedBranchEndpoint extends js.Object {
...
object ReposGetUsersWithAccessToProtectedBranchEndpoint {
  ...
  @scala.inline
  implicit class ReposGetUsersWithAccessToProtectedBranchEndpointOps[Self <: ReposGetUsersWithAccessToProtectedBranchEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
