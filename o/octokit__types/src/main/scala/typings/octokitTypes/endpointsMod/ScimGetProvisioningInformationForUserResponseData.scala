...
object ScimGetProvisioningInformationForUserResponseData {
  ...
  @scala.inline
  implicit class ScimGetProvisioningInformationForUserResponseDataMutableBuilder[Self <: ScimGetProvisioningInformationForUserResponseData] (val x: Self) extends AnyVal {
