...
object TeamsCreateDiscussionCommentLegacyEndpoint {
  ...
  inline def apply(body: String, discussion_number: Double, team_id: Double): TeamsCreateDiscussionCommentLegacyEndpoint = {
  ...
  extension [Self <: TeamsCreateDiscussionCommentLegacyEndpoint](x: Self) {
