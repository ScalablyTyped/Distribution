...
trait ReposGetProtectedBranchPullRequestReviewEnforcementResponseData extends js.Object {
...
object ReposGetProtectedBranchPullRequestReviewEnforcementResponseData {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchPullRequestReviewEnforcementResponseData]
  }
}
