...
object CodesOfConductGetConductCodeRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): CodesOfConductGetConductCodeRequestOptions = {
  ...
  extension [Self <: CodesOfConductGetConductCodeRequestOptions](x: Self) {
    ...
    inline def setUrl(value: Slashcodes_of_conductSlashColonkey): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
