...
object EnterpriseAdminListSelfHostedRunnersInGroupForEnterpriseResponseData {
  ...
  inline def apply(runners: js.Array[Busy], total_count: Double): EnterpriseAdminListSelfHostedRunnersInGroupForEnterpriseResponseData = {
  ...
  extension [Self <: EnterpriseAdminListSelfHostedRunnersInGroupForEnterpriseResponseData](x: Self) {
