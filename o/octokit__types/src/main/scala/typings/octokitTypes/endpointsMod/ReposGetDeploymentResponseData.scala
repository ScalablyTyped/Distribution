...
@js.native
trait ReposGetDeploymentResponseData extends js.Object {
...
object ReposGetDeploymentResponseData {
  ...
  @scala.inline
  implicit class ReposGetDeploymentResponseDataOps[Self <: ReposGetDeploymentResponseData] (val x: Self) extends AnyVal {
    @scala.inline
