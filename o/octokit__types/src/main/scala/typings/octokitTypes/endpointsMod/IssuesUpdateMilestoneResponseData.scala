...
@js.native
trait IssuesUpdateMilestoneResponseData extends js.Object {
...
object IssuesUpdateMilestoneResponseData {
  ...
  @scala.inline
  implicit class IssuesUpdateMilestoneResponseDataOps[Self <: IssuesUpdateMilestoneResponseData] (val x: Self) extends AnyVal {
    @scala.inline
