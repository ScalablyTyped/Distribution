...
@js.native
trait GistsCheckIsStarredRequestOptions extends js.Object {
...
object GistsCheckIsStarredRequestOptions {
  ...
  @scala.inline
  implicit class GistsCheckIsStarredRequestOptionsOps[Self <: GistsCheckIsStarredRequestOptions] (val x: Self) extends AnyVal {
