...
object IssuesListForRepoEndpoint {
  ...
  inline def apply(owner: String, repo: String): IssuesListForRepoEndpoint = {
    val __obj = js.Dynamic.literal(owner = owner.asInstanceOf[js.Any], repo = repo.asInstanceOf[js.Any])
    __obj.asInstanceOf[IssuesListForRepoEndpoint]
  }
  
  extension [Self <: IssuesListForRepoEndpoint](x: Self) {
    ...
    inline def setSort(value: created | updated | comments): Self = StObject.set(x, "sort", value.asInstanceOf[js.Any])
