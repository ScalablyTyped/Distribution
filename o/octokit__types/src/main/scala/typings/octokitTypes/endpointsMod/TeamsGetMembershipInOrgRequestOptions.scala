...
trait TeamsGetMembershipInOrgRequestOptions extends js.Object {
...
object TeamsGetMembershipInOrgRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsGetMembershipInOrgRequestOptions]
  }
}
