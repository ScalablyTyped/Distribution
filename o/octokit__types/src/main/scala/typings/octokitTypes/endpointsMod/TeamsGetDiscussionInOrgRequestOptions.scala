...
@js.native
trait TeamsGetDiscussionInOrgRequestOptions extends js.Object {
...
object TeamsGetDiscussionInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsGetDiscussionInOrgRequestOptionsOps[Self <: TeamsGetDiscussionInOrgRequestOptions] (val x: Self) extends AnyVal {
