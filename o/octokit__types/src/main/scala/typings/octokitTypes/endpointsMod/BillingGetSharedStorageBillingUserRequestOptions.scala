...
object BillingGetSharedStorageBillingUserRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): BillingGetSharedStorageBillingUserRequestOptions = {
  ...
  extension [Self <: BillingGetSharedStorageBillingUserRequestOptions](x: Self) {
    ...
    inline def setUrl(value: `SlashusersSlashColonusernameSlashsettingsSlashbillingSlashshared-storage`): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
