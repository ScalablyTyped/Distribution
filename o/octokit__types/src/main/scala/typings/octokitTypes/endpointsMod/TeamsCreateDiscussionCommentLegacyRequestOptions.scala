...
object TeamsCreateDiscussionCommentLegacyRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsCreateDiscussionCommentLegacyRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "POST", request = request.asInstanceOf[js.Any], url = "/teams/:team_id/discussions/:discussion_number/comments")
    __obj.asInstanceOf[TeamsCreateDiscussionCommentLegacyRequestOptions]
  }
  
  extension [Self <: TeamsCreateDiscussionCommentLegacyRequestOptions](x: Self) {
