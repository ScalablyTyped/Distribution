...
object TeamsCreateDiscussionCommentLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionCommentLegacyRequestOptionsOps[Self <: TeamsCreateDiscussionCommentLegacyRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashteamsSlashColonteam_idSlashdiscussionsSlashColondiscussion_numberSlashcomments): Self = this.set("url", value.asInstanceOf[js.Any])
  }
