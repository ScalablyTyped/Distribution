...
@js.native
trait ReposGetDeployKeyResponseData extends js.Object {
...
object ReposGetDeployKeyResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ReposGetDeployKeyResponseData]
  }
  
  @scala.inline
  implicit class ReposGetDeployKeyResponseDataOps[Self <: ReposGetDeployKeyResponseData] (val x: Self) extends AnyVal {
