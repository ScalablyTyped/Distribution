...
trait UsersListFollowersForAuthenticatedUserRequestOptions extends js.Object {
  ...
  var url: SlashuserSlashfollowers = js.native
}
object UsersListFollowersForAuthenticatedUserRequestOptions {
  ...
  @scala.inline
  implicit class UsersListFollowersForAuthenticatedUserRequestOptionsOps[Self <: UsersListFollowersForAuthenticatedUserRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashuserSlashfollowers): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
