...
object TeamsRemoveProjectLegacyRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsRemoveProjectLegacyRequestOptions = {
  ...
  extension [Self <: TeamsRemoveProjectLegacyRequestOptions](x: Self) {
