...
@js.native
trait IssuesSetLabelsRequestOptions extends js.Object {
...
object IssuesSetLabelsRequestOptions {
  ...
  @scala.inline
  implicit class IssuesSetLabelsRequestOptionsOps[Self <: IssuesSetLabelsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
