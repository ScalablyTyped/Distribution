...
object IssuesSetLabelsRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): IssuesSetLabelsRequestOptions = {
  ...
  extension [Self <: IssuesSetLabelsRequestOptions](x: Self) {
