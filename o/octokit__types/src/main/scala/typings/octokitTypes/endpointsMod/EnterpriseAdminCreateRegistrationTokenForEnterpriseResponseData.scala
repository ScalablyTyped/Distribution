...
object EnterpriseAdminCreateRegistrationTokenForEnterpriseResponseData {
  ...
  inline def apply(expires_at: String, token: String): EnterpriseAdminCreateRegistrationTokenForEnterpriseResponseData = {
  ...
  extension [Self <: EnterpriseAdminCreateRegistrationTokenForEnterpriseResponseData](x: Self) {
