...
object AppsListAccountsForPlanStubbedRequestOptions {
  ...
  @scala.inline
  implicit class AppsListAccountsForPlanStubbedRequestOptionsOps[Self <: AppsListAccountsForPlanStubbedRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: Slashmarketplace_listingSlashstubbedSlashplansSlashColonplan_idSlashaccounts): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
