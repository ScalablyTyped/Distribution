...
object AppsListAccountsForPlanStubbedRequestOptions {
  ...
  @scala.inline
  def apply(headers: RequestHeaders, request: RequestRequestOptions): AppsListAccountsForPlanStubbedRequestOptions = {
  ...
  @scala.inline
  implicit class AppsListAccountsForPlanStubbedRequestOptionsMutableBuilder[Self <: AppsListAccountsForPlanStubbedRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: Slashmarketplace_listingSlashstubbedSlashplansSlashColonplan_idSlashaccounts): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
