...
object TeamsListReposInOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsListReposInOrgRequestOptions = {
  ...
  extension [Self <: TeamsListReposInOrgRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashrepos): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
