...
object TeamsCreateOrUpdateIdPGroupConnectionsLegacyResponseData {
  ...
  @scala.inline
  implicit class TeamsCreateOrUpdateIdPGroupConnectionsLegacyResponseDataOps[Self <: TeamsCreateOrUpdateIdPGroupConnectionsLegacyResponseData] (val x: Self) extends AnyVal {
