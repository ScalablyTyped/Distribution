...
object ReposSetUserAccessRestrictionsEndpoint {
  ...
  inline def apply(branch: String, owner: String, repo: String, users: js.Array[String]): ReposSetUserAccessRestrictionsEndpoint = {
  ...
  extension [Self <: ReposSetUserAccessRestrictionsEndpoint](x: Self) {
