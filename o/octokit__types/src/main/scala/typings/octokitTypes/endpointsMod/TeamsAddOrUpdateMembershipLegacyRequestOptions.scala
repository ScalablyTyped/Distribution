...
trait TeamsAddOrUpdateMembershipLegacyRequestOptions extends js.Object {
...
object TeamsAddOrUpdateMembershipLegacyRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsAddOrUpdateMembershipLegacyRequestOptions]
  }
}
