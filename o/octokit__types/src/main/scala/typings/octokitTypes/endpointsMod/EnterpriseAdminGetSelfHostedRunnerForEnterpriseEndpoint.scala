...
@js.native
trait EnterpriseAdminGetSelfHostedRunnerForEnterpriseEndpoint extends js.Object {
...
object EnterpriseAdminGetSelfHostedRunnerForEnterpriseEndpoint {
  ...
  @scala.inline
  implicit class EnterpriseAdminGetSelfHostedRunnerForEnterpriseEndpointOps[Self <: EnterpriseAdminGetSelfHostedRunnerForEnterpriseEndpoint] (val x: Self) extends AnyVal {
