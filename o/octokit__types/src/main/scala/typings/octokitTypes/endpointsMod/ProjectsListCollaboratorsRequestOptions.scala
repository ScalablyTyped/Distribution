...
@js.native
trait ProjectsListCollaboratorsRequestOptions extends js.Object {
...
object ProjectsListCollaboratorsRequestOptions {
  ...
  @scala.inline
  implicit class ProjectsListCollaboratorsRequestOptionsOps[Self <: ProjectsListCollaboratorsRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashprojectsSlashColonproject_idSlashcollaborators): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
