...
object SearchCommitsRequestOptions {
  ...
  @scala.inline
  implicit class SearchCommitsRequestOptionsOps[Self <: SearchCommitsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashsearchSlashcommits): Self = this.set("url", value.asInstanceOf[js.Any])
  }
