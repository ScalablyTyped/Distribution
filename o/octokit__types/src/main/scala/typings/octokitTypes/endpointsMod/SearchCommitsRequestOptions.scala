...
object SearchCommitsRequestOptions {
  ...
  @scala.inline
  def apply(headers: RequestHeaders, request: RequestRequestOptions): SearchCommitsRequestOptions = {
  ...
  @scala.inline
  implicit class SearchCommitsRequestOptionsMutableBuilder[Self <: SearchCommitsRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashsearchSlashcommits): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
