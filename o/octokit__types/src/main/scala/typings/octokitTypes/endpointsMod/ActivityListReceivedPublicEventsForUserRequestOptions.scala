...
object ActivityListReceivedPublicEventsForUserRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActivityListReceivedPublicEventsForUserRequestOptions = {
  ...
  extension [Self <: ActivityListReceivedPublicEventsForUserRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashusersSlashColonusernameSlashreceived_eventsSlashpublic): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
