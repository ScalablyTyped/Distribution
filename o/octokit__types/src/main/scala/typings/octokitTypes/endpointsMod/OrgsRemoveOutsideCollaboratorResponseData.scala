...
object OrgsRemoveOutsideCollaboratorResponseData {
  ...
  inline def apply(documentation_url: String, message: String): OrgsRemoveOutsideCollaboratorResponseData = {
  ...
  extension [Self <: OrgsRemoveOutsideCollaboratorResponseData](x: Self) {
