...
trait GistsUpdateResponseData extends StObject {
...
object GistsUpdateResponseData {
  ...
  @scala.inline
  implicit class GistsUpdateResponseDataMutableBuilder[Self <: GistsUpdateResponseData] (val x: Self) extends AnyVal {
