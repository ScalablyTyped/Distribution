...
object ActivityStarRepoForAuthenticatedUserRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActivityStarRepoForAuthenticatedUserRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "PUT", request = request.asInstanceOf[js.Any], url = "/user/starred/:owner/:repo")
    __obj.asInstanceOf[ActivityStarRepoForAuthenticatedUserRequestOptions]
  }
  
  extension [Self <: ActivityStarRepoForAuthenticatedUserRequestOptions](x: Self) {
