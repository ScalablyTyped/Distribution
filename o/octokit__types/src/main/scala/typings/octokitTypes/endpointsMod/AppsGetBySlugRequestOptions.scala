...
object AppsGetBySlugRequestOptions {
  ...
  @scala.inline
  implicit class AppsGetBySlugRequestOptionsOps[Self <: AppsGetBySlugRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashappsSlashColonapp_slug): Self = this.set("url", value.asInstanceOf[js.Any])
  }
