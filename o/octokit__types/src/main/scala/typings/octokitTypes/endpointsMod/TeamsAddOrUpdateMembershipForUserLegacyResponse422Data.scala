...
object TeamsAddOrUpdateMembershipForUserLegacyResponse422Data {
  ...
  inline def apply(errors: js.Array[Field], message: String): TeamsAddOrUpdateMembershipForUserLegacyResponse422Data = {
  ...
  extension [Self <: TeamsAddOrUpdateMembershipForUserLegacyResponse422Data](x: Self) {
