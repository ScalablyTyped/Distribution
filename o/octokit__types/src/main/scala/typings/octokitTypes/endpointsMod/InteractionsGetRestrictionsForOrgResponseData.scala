...
object InteractionsGetRestrictionsForOrgResponseData {
  ...
  inline def apply(expires_at: String, limit: String, origin: String): InteractionsGetRestrictionsForOrgResponseData = {
  ...
  extension [Self <: InteractionsGetRestrictionsForOrgResponseData](x: Self) {
