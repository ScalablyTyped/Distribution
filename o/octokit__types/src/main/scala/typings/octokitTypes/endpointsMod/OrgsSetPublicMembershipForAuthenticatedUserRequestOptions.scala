...
object OrgsSetPublicMembershipForAuthenticatedUserRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): OrgsSetPublicMembershipForAuthenticatedUserRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "PUT", request = request.asInstanceOf[js.Any], url = "/orgs/:org/public_members/:username")
    __obj.asInstanceOf[OrgsSetPublicMembershipForAuthenticatedUserRequestOptions]
  }
  
  extension [Self <: OrgsSetPublicMembershipForAuthenticatedUserRequestOptions](x: Self) {
