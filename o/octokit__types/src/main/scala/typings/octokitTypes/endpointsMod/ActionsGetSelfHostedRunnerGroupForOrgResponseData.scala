...
@js.native
trait ActionsGetSelfHostedRunnerGroupForOrgResponseData extends StObject {
...
object ActionsGetSelfHostedRunnerGroupForOrgResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ActionsGetSelfHostedRunnerGroupForOrgResponseData]
  }
  
  @scala.inline
  implicit class ActionsGetSelfHostedRunnerGroupForOrgResponseDataMutableBuilder[Self <: ActionsGetSelfHostedRunnerGroupForOrgResponseData] (val x: Self) extends AnyVal {
