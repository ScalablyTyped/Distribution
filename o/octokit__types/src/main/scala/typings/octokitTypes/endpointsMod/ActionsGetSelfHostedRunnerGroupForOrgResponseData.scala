...
@js.native
trait ActionsGetSelfHostedRunnerGroupForOrgResponseData extends js.Object {
...
object ActionsGetSelfHostedRunnerGroupForOrgResponseData {
  ...
  @scala.inline
  implicit class ActionsGetSelfHostedRunnerGroupForOrgResponseDataOps[Self <: ActionsGetSelfHostedRunnerGroupForOrgResponseData] (val x: Self) extends AnyVal {
