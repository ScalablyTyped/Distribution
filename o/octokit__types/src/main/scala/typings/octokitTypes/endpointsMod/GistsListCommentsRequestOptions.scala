...
object GistsListCommentsRequestOptions {
  ...
  @scala.inline
  implicit class GistsListCommentsRequestOptionsOps[Self <: GistsListCommentsRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashgistsSlashColongist_idSlashcomments): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
