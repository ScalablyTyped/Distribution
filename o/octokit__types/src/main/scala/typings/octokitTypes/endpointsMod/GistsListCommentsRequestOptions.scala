...
object GistsListCommentsRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): GistsListCommentsRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/gists/:gist_id/comments")
    __obj.asInstanceOf[GistsListCommentsRequestOptions]
  }
  
  extension [Self <: GistsListCommentsRequestOptions](x: Self) {
