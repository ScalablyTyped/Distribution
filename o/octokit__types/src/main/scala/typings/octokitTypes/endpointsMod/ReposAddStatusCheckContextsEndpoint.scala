...
@js.native
trait ReposAddStatusCheckContextsEndpoint extends js.Object {
...
object ReposAddStatusCheckContextsEndpoint {
  ...
  @scala.inline
  implicit class ReposAddStatusCheckContextsEndpointOps[Self <: ReposAddStatusCheckContextsEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
