...
object EnterpriseAdminGetProvisioningInformationForEnterpriseGroupRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): EnterpriseAdminGetProvisioningInformationForEnterpriseGroupRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/scim/v2/enterprises/:enterprise/Groups/:scim_group_id")
    __obj.asInstanceOf[EnterpriseAdminGetProvisioningInformationForEnterpriseGroupRequestOptions]
  }
  
  extension [Self <: EnterpriseAdminGetProvisioningInformationForEnterpriseGroupRequestOptions](x: Self) {
