...
@js.native
trait ReactionsDeleteForPullRequestCommentEndpoint extends js.Object {
...
object ReactionsDeleteForPullRequestCommentEndpoint {
  @scala.inline
  def apply(comment_id: Double, mediaType: `12`, owner: String, reaction_id: Double, repo: String): ReactionsDeleteForPullRequestCommentEndpoint = {
  ...
  @scala.inline
  implicit class ReactionsDeleteForPullRequestCommentEndpointOps[Self <: ReactionsDeleteForPullRequestCommentEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
