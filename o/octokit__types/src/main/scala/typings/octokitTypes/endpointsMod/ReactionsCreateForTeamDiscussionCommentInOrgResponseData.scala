...
object ReactionsCreateForTeamDiscussionCommentInOrgResponseData {
  ...
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionCommentInOrgResponseDataMutableBuilder[Self <: ReactionsCreateForTeamDiscussionCommentInOrgResponseData] (val x: Self) extends AnyVal {
