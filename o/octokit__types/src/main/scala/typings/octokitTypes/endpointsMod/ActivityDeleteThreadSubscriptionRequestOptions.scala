...
object ActivityDeleteThreadSubscriptionRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActivityDeleteThreadSubscriptionRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "DELETE", request = request.asInstanceOf[js.Any], url = "/notifications/threads/:thread_id/subscription")
    __obj.asInstanceOf[ActivityDeleteThreadSubscriptionRequestOptions]
  }
  
  extension [Self <: ActivityDeleteThreadSubscriptionRequestOptions](x: Self) {
