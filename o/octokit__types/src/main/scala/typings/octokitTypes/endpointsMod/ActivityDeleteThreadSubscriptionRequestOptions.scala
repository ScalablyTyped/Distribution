...
@js.native
trait ActivityDeleteThreadSubscriptionRequestOptions extends js.Object {
...
object ActivityDeleteThreadSubscriptionRequestOptions {
  ...
  @scala.inline
  implicit class ActivityDeleteThreadSubscriptionRequestOptionsOps[Self <: ActivityDeleteThreadSubscriptionRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashnotificationsSlashthreadsSlashColonthread_idSlashsubscription): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
