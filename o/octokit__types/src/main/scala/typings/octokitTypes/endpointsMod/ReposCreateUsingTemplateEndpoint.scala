...
object ReposCreateUsingTemplateEndpoint {
  ...
  inline def apply(mediaType: `0`[baptiste], name: String, template_owner: String, template_repo: String): ReposCreateUsingTemplateEndpoint = {
  ...
  extension [Self <: ReposCreateUsingTemplateEndpoint](x: Self) {
