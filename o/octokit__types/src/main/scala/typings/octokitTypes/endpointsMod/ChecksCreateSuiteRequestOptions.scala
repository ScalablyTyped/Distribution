...
object ChecksCreateSuiteRequestOptions {
  ...
  @scala.inline
  implicit class ChecksCreateSuiteRequestOptionsOps[Self <: ChecksCreateSuiteRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: `SlashreposSlashColonownerSlashColonrepoSlashcheck-suites`): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
