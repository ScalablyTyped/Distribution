...
object ReposCreateForAuthenticatedUserResponseData {
  ...
  extension [Self <: ReposCreateForAuthenticatedUserResponseData](x: Self) {
    ...
    inline def setTemplate_repository(value: StringDictionary[js.Any]): Self = StObject.set(x, "template_repository", value.asInstanceOf[js.Any])
