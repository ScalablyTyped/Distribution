...
@js.native
trait ReposCreateForAuthenticatedUserResponseData extends js.Object {
...
object ReposCreateForAuthenticatedUserResponseData {
  ...
  @scala.inline
  implicit class ReposCreateForAuthenticatedUserResponseDataOps[Self <: ReposCreateForAuthenticatedUserResponseData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPermissions(value: Admin): Self = this.set("permissions", value.asInstanceOf[js.Any])
