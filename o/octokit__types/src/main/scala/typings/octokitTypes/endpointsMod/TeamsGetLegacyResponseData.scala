...
@js.native
trait TeamsGetLegacyResponseData extends js.Object {
...
object TeamsGetLegacyResponseData {
  ...
  @scala.inline
  implicit class TeamsGetLegacyResponseDataOps[Self <: TeamsGetLegacyResponseData] (val x: Self) extends AnyVal {
    @scala.inline
