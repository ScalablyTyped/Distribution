...
trait TeamsGetLegacyResponseData extends StObject {
...
object TeamsGetLegacyResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TeamsGetLegacyResponseData]
  }
  
  @scala.inline
  implicit class TeamsGetLegacyResponseDataMutableBuilder[Self <: TeamsGetLegacyResponseData] (val x: Self) extends AnyVal {
