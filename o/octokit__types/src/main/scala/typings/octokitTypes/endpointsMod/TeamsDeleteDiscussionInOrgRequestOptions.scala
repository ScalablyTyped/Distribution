...
object TeamsDeleteDiscussionInOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsDeleteDiscussionInOrgRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "DELETE", request = request.asInstanceOf[js.Any], url = "/orgs/:org/teams/:team_slug/discussions/:discussion_number")
    __obj.asInstanceOf[TeamsDeleteDiscussionInOrgRequestOptions]
  }
  
  extension [Self <: TeamsDeleteDiscussionInOrgRequestOptions](x: Self) {
