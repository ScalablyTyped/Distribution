...
object AppsGetSubscriptionPlanForAccountStubbedRequestOptions {
  ...
  @scala.inline
  implicit class AppsGetSubscriptionPlanForAccountStubbedRequestOptionsOps[Self <: AppsGetSubscriptionPlanForAccountStubbedRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: Slashmarketplace_listingSlashstubbedSlashaccountsSlashColonaccount_id): Self = this.set("url", value.asInstanceOf[js.Any])
  }
