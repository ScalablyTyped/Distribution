...
@js.native
trait AppsGetSubscriptionPlanForAccountResponseData extends js.Object {
...
object AppsGetSubscriptionPlanForAccountResponseData {
  ...
  @scala.inline
  implicit class AppsGetSubscriptionPlanForAccountResponseDataOps[Self <: AppsGetSubscriptionPlanForAccountResponseData] (val x: Self) extends AnyVal {
