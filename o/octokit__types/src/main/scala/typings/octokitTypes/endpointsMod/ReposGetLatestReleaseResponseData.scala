...
@js.native
trait ReposGetLatestReleaseResponseData extends js.Object {
...
object ReposGetLatestReleaseResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ReposGetLatestReleaseResponseData]
  }
  @scala.inline
  implicit class ReposGetLatestReleaseResponseDataOps[Self <: ReposGetLatestReleaseResponseData] (val x: Self) extends AnyVal {
    @scala.inline
