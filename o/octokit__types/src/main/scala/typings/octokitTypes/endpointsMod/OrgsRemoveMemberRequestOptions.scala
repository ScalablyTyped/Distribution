...
object OrgsRemoveMemberRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): OrgsRemoveMemberRequestOptions = {
  ...
  extension [Self <: OrgsRemoveMemberRequestOptions](x: Self) {
