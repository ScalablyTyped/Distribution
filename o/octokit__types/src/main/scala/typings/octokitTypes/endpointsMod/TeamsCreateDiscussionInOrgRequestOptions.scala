...
object TeamsCreateDiscussionInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionInOrgRequestOptionsOps[Self <: TeamsCreateDiscussionInOrgRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashdiscussions): Self = this.set("url", value.asInstanceOf[js.Any])
  }
