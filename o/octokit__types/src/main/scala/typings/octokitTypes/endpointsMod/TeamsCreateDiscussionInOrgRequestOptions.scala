...
object TeamsCreateDiscussionInOrgRequestOptions {
  ...
  @scala.inline
  def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsCreateDiscussionInOrgRequestOptions = {
  ...
  @scala.inline
  implicit class TeamsCreateDiscussionInOrgRequestOptionsMutableBuilder[Self <: TeamsCreateDiscussionInOrgRequestOptions] (val x: Self) extends AnyVal {
