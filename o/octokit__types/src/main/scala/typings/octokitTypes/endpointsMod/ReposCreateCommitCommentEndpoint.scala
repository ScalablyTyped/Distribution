...
object ReposCreateCommitCommentEndpoint {
  ...
  inline def apply(body: String, commit_sha: String, owner: String, repo: String): ReposCreateCommitCommentEndpoint = {
  ...
  extension [Self <: ReposCreateCommitCommentEndpoint](x: Self) {
