...
object EnterpriseAdminSetInformationForProvisionedEnterpriseUserParamsGroups {
  ...
  inline def apply(): EnterpriseAdminSetInformationForProvisionedEnterpriseUserParamsGroups = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EnterpriseAdminSetInformationForProvisionedEnterpriseUserParamsGroups]
  }
  
  extension [Self <: EnterpriseAdminSetInformationForProvisionedEnterpriseUserParamsGroups](x: Self) {
