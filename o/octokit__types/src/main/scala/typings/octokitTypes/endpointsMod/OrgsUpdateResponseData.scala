...
object OrgsUpdateResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OrgsUpdateResponseData]
  }
  
  @scala.inline
  implicit class OrgsUpdateResponseDataMutableBuilder[Self <: OrgsUpdateResponseData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefault_repository_permission(value: String): Self = StObject.set(x, "default_repository_permission", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMembers_allowed_repository_creation_type(value: String): Self = StObject.set(x, "members_allowed_repository_creation_type", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPlan(value: Filledseats): Self = StObject.set(x, "plan", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTwo_factor_requirement_enabled(value: Boolean): Self = StObject.set(x, "two_factor_requirement_enabled", value.asInstanceOf[js.Any])
