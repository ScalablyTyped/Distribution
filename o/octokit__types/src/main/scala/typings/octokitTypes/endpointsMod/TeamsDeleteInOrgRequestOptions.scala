...
object TeamsDeleteInOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsDeleteInOrgRequestOptions = {
  ...
  extension [Self <: TeamsDeleteInOrgRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashorgsSlashColonorgSlashteamsSlashColonteam_slug): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
