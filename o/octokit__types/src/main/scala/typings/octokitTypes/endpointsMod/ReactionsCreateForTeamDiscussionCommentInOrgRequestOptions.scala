...
@js.native
trait ReactionsCreateForTeamDiscussionCommentInOrgRequestOptions extends js.Object {
  var headers: RequestHeaders = js.native
  var method: POST = js.native
  var request: RequestRequestOptions = js.native
  var url: SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashdiscussionsSlashColondiscussion_numberSlashcommentsSlashColoncomment_numberSlashreactions = js.native
}
...
object ReactionsCreateForTeamDiscussionCommentInOrgRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsCreateForTeamDiscussionCommentInOrgRequestOptionsOps[Self <: ReactionsCreateForTeamDiscussionCommentInOrgRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
