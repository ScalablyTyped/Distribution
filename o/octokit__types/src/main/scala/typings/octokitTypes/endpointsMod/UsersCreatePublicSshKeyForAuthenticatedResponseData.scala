...
object UsersCreatePublicSshKeyForAuthenticatedResponseData {
  ...
  inline def apply(key: String, key_id: String): UsersCreatePublicSshKeyForAuthenticatedResponseData = {
  ...
  extension [Self <: UsersCreatePublicSshKeyForAuthenticatedResponseData](x: Self) {
