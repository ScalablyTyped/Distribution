...
object AppsListPlansStubbedRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): AppsListPlansStubbedRequestOptions = {
  ...
  extension [Self <: AppsListPlansStubbedRequestOptions](x: Self) {
    ...
    inline def setUrl(value: Slashmarketplace_listingSlashstubbedSlashplans): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
