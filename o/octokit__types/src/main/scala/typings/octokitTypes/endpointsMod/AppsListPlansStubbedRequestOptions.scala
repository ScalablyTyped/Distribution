...
object AppsListPlansStubbedRequestOptions {
  ...
  @scala.inline
  implicit class AppsListPlansStubbedRequestOptionsOps[Self <: AppsListPlansStubbedRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: Slashmarketplace_listingSlashstubbedSlashplans): Self = this.set("url", value.asInstanceOf[js.Any])
  }
