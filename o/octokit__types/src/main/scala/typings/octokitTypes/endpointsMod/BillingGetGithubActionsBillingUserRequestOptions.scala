...
object BillingGetGithubActionsBillingUserRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): BillingGetGithubActionsBillingUserRequestOptions = {
  ...
  extension [Self <: BillingGetGithubActionsBillingUserRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashusersSlashColonusernameSlashsettingsSlashbillingSlashactions): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
