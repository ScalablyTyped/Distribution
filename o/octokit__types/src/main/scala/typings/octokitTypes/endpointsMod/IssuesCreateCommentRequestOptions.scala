...
object IssuesCreateCommentRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): IssuesCreateCommentRequestOptions = {
  ...
  extension [Self <: IssuesCreateCommentRequestOptions](x: Self) {
