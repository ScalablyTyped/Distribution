...
object ActionsGetSelfHostedRunnerForRepoEndpoint {
  ...
  inline def apply(owner: String, repo: String, runner_id: Double): ActionsGetSelfHostedRunnerForRepoEndpoint = {
  ...
  extension [Self <: ActionsGetSelfHostedRunnerForRepoEndpoint](x: Self) {
