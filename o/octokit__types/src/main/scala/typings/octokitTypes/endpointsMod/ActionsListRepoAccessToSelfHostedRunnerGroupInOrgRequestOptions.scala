...
@js.native
trait ActionsListRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions extends js.Object {
...
object ActionsListRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions {
  ...
  @scala.inline
  implicit class ActionsListRepoAccessToSelfHostedRunnerGroupInOrgRequestOptionsOps[Self <: ActionsListRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions] (val x: Self) extends AnyVal {
