...
@js.native
trait PullsUpdateReviewCommentRequestOptions extends js.Object {
...
object PullsUpdateReviewCommentRequestOptions {
  ...
  @scala.inline
  implicit class PullsUpdateReviewCommentRequestOptionsOps[Self <: PullsUpdateReviewCommentRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
