...
object PullsUpdateReviewCommentRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): PullsUpdateReviewCommentRequestOptions = {
  ...
  extension [Self <: PullsUpdateReviewCommentRequestOptions](x: Self) {
