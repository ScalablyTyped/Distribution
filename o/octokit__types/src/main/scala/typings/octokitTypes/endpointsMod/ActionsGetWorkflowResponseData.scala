...
object ActionsGetWorkflowResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ActionsGetWorkflowResponseData]
  }
  
  @scala.inline
  implicit class ActionsGetWorkflowResponseDataMutableBuilder[Self <: ActionsGetWorkflowResponseData] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBadge_url(value: String): Self = StObject.set(x, "badge_url", value.asInstanceOf[js.Any])
