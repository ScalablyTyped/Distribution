...
@js.native
trait ActionsGetWorkflowResponseData extends js.Object {
...
object ActionsGetWorkflowResponseData {
  ...
  @scala.inline
  implicit class ActionsGetWorkflowResponseDataOps[Self <: ActionsGetWorkflowResponseData] (val x: Self) extends AnyVal {
    @scala.inline
