...
object ReposDeleteCommitSignatureProtectionRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ReposDeleteCommitSignatureProtectionRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "DELETE", request = request.asInstanceOf[js.Any], url = "/repos/:owner/:repo/branches/:branch/protection/required_signatures")
    __obj.asInstanceOf[ReposDeleteCommitSignatureProtectionRequestOptions]
  }
  
  extension [Self <: ReposDeleteCommitSignatureProtectionRequestOptions](x: Self) {
