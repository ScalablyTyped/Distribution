...
@js.native
trait ScimGetProvisioningInformationForUserRequestOptions extends js.Object {
...
object ScimGetProvisioningInformationForUserRequestOptions {
  ...
  @scala.inline
  implicit class ScimGetProvisioningInformationForUserRequestOptionsOps[Self <: ScimGetProvisioningInformationForUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
