...
object ScimGetProvisioningInformationForUserRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ScimGetProvisioningInformationForUserRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/scim/v2/organizations/:org/Users/:scim_user_id")
    __obj.asInstanceOf[ScimGetProvisioningInformationForUserRequestOptions]
  }
  
  extension [Self <: ScimGetProvisioningInformationForUserRequestOptions](x: Self) {
