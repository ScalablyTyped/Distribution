...
object TeamsListDiscussionsInOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsListDiscussionsInOrgRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/orgs/:org/teams/:team_slug/discussions")
    __obj.asInstanceOf[TeamsListDiscussionsInOrgRequestOptions]
  }
  
  extension [Self <: TeamsListDiscussionsInOrgRequestOptions](x: Self) {
