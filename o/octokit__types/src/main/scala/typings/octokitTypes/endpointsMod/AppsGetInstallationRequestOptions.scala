...
object AppsGetInstallationRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): AppsGetInstallationRequestOptions = {
  ...
  extension [Self <: AppsGetInstallationRequestOptions](x: Self) {
