...
@js.native
trait ReposCreateUsingTemplateResponseData extends js.Object {
...
object ReposCreateUsingTemplateResponseData {
  ...
  @scala.inline
  implicit class ReposCreateUsingTemplateResponseDataOps[Self <: ReposCreateUsingTemplateResponseData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTemplate_repository(value: Allowmergecommit): Self = this.set("template_repository", value.asInstanceOf[js.Any])
