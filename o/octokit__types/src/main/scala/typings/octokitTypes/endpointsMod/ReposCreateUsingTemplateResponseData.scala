...
@js.native
trait ReposCreateUsingTemplateResponseData extends StObject {
  ...
  var template_repository: Allowmergecommit = js.native
...
object ReposCreateUsingTemplateResponseData {
  ...
  def apply(
    ...
    template_repository: Allowmergecommit,
    ...
    __obj.asInstanceOf[ReposCreateUsingTemplateResponseData]
  }
  
  @scala.inline
  implicit class ReposCreateUsingTemplateResponseDataMutableBuilder[Self <: ReposCreateUsingTemplateResponseData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTemplate_repository(value: Allowmergecommit): Self = StObject.set(x, "template_repository", value.asInstanceOf[js.Any])
