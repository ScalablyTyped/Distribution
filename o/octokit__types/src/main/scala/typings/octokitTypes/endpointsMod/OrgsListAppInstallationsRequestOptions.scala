...
@js.native
trait OrgsListAppInstallationsRequestOptions extends js.Object {
...
object OrgsListAppInstallationsRequestOptions {
  ...
  @scala.inline
  implicit class OrgsListAppInstallationsRequestOptionsOps[Self <: OrgsListAppInstallationsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashinstallations): Self = this.set("url", value.asInstanceOf[js.Any])
  }
