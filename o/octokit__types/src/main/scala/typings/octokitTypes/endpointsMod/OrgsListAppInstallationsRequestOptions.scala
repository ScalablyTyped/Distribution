...
trait OrgsListAppInstallationsRequestOptions extends StObject {
  ...
  var url: SlashorgsSlashColonorgSlashinstallations
}
object OrgsListAppInstallationsRequestOptions {
  
  @scala.inline
  def apply(headers: RequestHeaders, request: RequestRequestOptions): OrgsListAppInstallationsRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/orgs/:org/installations")
