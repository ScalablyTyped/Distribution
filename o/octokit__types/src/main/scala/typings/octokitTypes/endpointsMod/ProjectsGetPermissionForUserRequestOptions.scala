...
@js.native
trait ProjectsGetPermissionForUserRequestOptions extends js.Object {
...
object ProjectsGetPermissionForUserRequestOptions {
  ...
  @scala.inline
  implicit class ProjectsGetPermissionForUserRequestOptionsOps[Self <: ProjectsGetPermissionForUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashprojectsSlashColonproject_idSlashcollaboratorsSlashColonusernameSlashpermission): Self = this.set("url", value.asInstanceOf[js.Any])
  }
