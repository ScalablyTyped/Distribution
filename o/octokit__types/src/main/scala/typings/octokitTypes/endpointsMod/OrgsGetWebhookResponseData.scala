...
@js.native
trait OrgsGetWebhookResponseData extends js.Object {
...
object OrgsGetWebhookResponseData {
  ...
  @scala.inline
  implicit class OrgsGetWebhookResponseDataOps[Self <: OrgsGetWebhookResponseData] (val x: Self) extends AnyVal {
    @scala.inline
