...
@js.native
trait ReposRemoveStatusCheckContextsRequestOptions extends js.Object {
...
object ReposRemoveStatusCheckContextsRequestOptions {
  ...
  @scala.inline
  implicit class ReposRemoveStatusCheckContextsRequestOptionsOps[Self <: ReposRemoveStatusCheckContextsRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
