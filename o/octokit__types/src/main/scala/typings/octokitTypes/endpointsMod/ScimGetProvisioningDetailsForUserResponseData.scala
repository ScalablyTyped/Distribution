...
trait ScimGetProvisioningDetailsForUserResponseData extends js.Object {
  var active: Boolean
...
object ScimGetProvisioningDetailsForUserResponseData {
  @scala.inline
  def apply(
    active: Boolean,
    ...
    __obj.asInstanceOf[ScimGetProvisioningDetailsForUserResponseData]
  }
}
