...
object ChecksListAnnotationsEndpoint {
  ...
  inline def apply(check_run_id: Double, mediaType: `0`[antiope], owner: String, repo: String): ChecksListAnnotationsEndpoint = {
  ...
  extension [Self <: ChecksListAnnotationsEndpoint](x: Self) {
