...
trait ProjectsUpdateColumnRequestOptions extends StObject {
...
object ProjectsUpdateColumnRequestOptions {
  ...
  @scala.inline
  def apply(headers: RequestHeaders, request: RequestRequestOptions): ProjectsUpdateColumnRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "PATCH", request = request.asInstanceOf[js.Any], url = "/projects/columns/:column_id")
    __obj.asInstanceOf[ProjectsUpdateColumnRequestOptions]
  }
  
  @scala.inline
  implicit class ProjectsUpdateColumnRequestOptionsMutableBuilder[Self <: ProjectsUpdateColumnRequestOptions] (val x: Self) extends AnyVal {
