...
object ProjectsUpdateColumnRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ProjectsUpdateColumnRequestOptions = {
  ...
  extension [Self <: ProjectsUpdateColumnRequestOptions](x: Self) {
