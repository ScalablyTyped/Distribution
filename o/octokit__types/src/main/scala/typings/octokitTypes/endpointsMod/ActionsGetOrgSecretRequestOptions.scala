...
object ActionsGetOrgSecretRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActionsGetOrgSecretRequestOptions = {
  ...
  extension [Self <: ActionsGetOrgSecretRequestOptions](x: Self) {
