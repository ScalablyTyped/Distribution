...
object TeamsListChildInOrgRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsListChildInOrgRequestOptions = {
  ...
  extension [Self <: TeamsListChildInOrgRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashteams): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
