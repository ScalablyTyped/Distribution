...
object TeamsGetMembershipForUserInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsGetMembershipForUserInOrgRequestOptionsOps[Self <: TeamsGetMembershipForUserInOrgRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashmembershipsSlashColonusername): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
