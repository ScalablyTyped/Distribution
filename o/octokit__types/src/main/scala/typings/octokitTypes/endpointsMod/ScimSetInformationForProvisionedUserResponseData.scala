...
trait ScimSetInformationForProvisionedUserResponseData extends StObject {
...
object ScimSetInformationForProvisionedUserResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ScimSetInformationForProvisionedUserResponseData]
  }
  
  @scala.inline
  implicit class ScimSetInformationForProvisionedUserResponseDataMutableBuilder[Self <: ScimSetInformationForProvisionedUserResponseData] (val x: Self) extends AnyVal {
