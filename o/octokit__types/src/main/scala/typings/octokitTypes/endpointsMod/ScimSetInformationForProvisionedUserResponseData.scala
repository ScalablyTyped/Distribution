...
@js.native
trait ScimSetInformationForProvisionedUserResponseData extends js.Object {
...
object ScimSetInformationForProvisionedUserResponseData {
  ...
  @scala.inline
  implicit class ScimSetInformationForProvisionedUserResponseDataOps[Self <: ScimSetInformationForProvisionedUserResponseData] (val x: Self) extends AnyVal {
