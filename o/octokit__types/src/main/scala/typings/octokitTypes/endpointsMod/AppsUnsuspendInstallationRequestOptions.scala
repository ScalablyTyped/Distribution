...
object AppsUnsuspendInstallationRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): AppsUnsuspendInstallationRequestOptions = {
  ...
  extension [Self <: AppsUnsuspendInstallationRequestOptions](x: Self) {
