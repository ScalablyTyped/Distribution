...
@js.native
trait ReactionsDeleteForTeamDiscussionRequestOptions extends js.Object {
...
object ReactionsDeleteForTeamDiscussionRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsDeleteForTeamDiscussionRequestOptionsOps[Self <: ReactionsDeleteForTeamDiscussionRequestOptions] (val x: Self) extends AnyVal {
