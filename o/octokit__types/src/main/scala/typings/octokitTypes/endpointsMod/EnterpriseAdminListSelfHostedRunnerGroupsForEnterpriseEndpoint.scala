...
object EnterpriseAdminListSelfHostedRunnerGroupsForEnterpriseEndpoint {
  ...
  @scala.inline
  implicit class EnterpriseAdminListSelfHostedRunnerGroupsForEnterpriseEndpointMutableBuilder[Self <: EnterpriseAdminListSelfHostedRunnerGroupsForEnterpriseEndpoint] (val x: Self) extends AnyVal {
