...
object ReactionsCreateForCommitCommentResponseData {
  ...
  inline def apply(content: String, created_at: String, id: Double, node_id: String, user: Avatarurl): ReactionsCreateForCommitCommentResponseData = {
  ...
  extension [Self <: ReactionsCreateForCommitCommentResponseData](x: Self) {
