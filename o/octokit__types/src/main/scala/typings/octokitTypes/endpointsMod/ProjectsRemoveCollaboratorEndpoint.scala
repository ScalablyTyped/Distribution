...
object ProjectsRemoveCollaboratorEndpoint {
  ...
  inline def apply(mediaType: `0`[inertia], project_id: Double, username: String): ProjectsRemoveCollaboratorEndpoint = {
  ...
  extension [Self <: ProjectsRemoveCollaboratorEndpoint](x: Self) {
