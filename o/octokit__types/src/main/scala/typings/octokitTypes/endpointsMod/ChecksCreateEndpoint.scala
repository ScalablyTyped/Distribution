...
/* Inlined {  owner  :string,   repo  :string,   name  :string,   head_sha  :string,   details_url ? :string,   external_id ? :string,   status ? :'queued' | 'in_progress' | 'completed',   started_at ? :string,   conclusion ? :'success' | 'failure' | 'neutral' | 'cancelled' | 'skipped' | 'timed_out' | 'action_required',   completed_at ? :string,   output ? :@octokit/types.@octokit/types/dist-types/generated/Endpoints.ChecksCreateParamsOutput,   actions ? :std.Array<@octokit/types.@octokit/types/dist-types/generated/Endpoints.ChecksCreateParamsActions>} & @octokit/types.@octokit/types/dist-types/generated/Endpoints.RequiredPreview<'antiope'> */
