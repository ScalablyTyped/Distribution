...
@js.native
trait ReposGetCommitCommentResponseData extends js.Object {
...
object ReposGetCommitCommentResponseData {
  ...
  @scala.inline
  implicit class ReposGetCommitCommentResponseDataOps[Self <: ReposGetCommitCommentResponseData] (val x: Self) extends AnyVal {
