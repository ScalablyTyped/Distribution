...
@js.native
trait ReposGetReleaseResponseData extends js.Object {
...
object ReposGetReleaseResponseData {
  ...
  @scala.inline
  implicit class ReposGetReleaseResponseDataOps[Self <: ReposGetReleaseResponseData] (val x: Self) extends AnyVal {
