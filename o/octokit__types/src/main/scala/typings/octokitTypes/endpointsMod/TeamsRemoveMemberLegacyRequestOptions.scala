...
object TeamsRemoveMemberLegacyRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsRemoveMemberLegacyRequestOptions = {
  ...
  extension [Self <: TeamsRemoveMemberLegacyRequestOptions](x: Self) {
