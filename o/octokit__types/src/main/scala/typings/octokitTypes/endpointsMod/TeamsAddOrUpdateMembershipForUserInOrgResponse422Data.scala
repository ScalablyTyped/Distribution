...
object TeamsAddOrUpdateMembershipForUserInOrgResponse422Data {
  ...
  inline def apply(errors: js.Array[Field], message: String): TeamsAddOrUpdateMembershipForUserInOrgResponse422Data = {
  ...
  extension [Self <: TeamsAddOrUpdateMembershipForUserInOrgResponse422Data](x: Self) {
