...
object TeamsAddOrUpdateRepoPermissionsLegacyRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsAddOrUpdateRepoPermissionsLegacyRequestOptions = {
  ...
  extension [Self <: TeamsAddOrUpdateRepoPermissionsLegacyRequestOptions](x: Self) {
