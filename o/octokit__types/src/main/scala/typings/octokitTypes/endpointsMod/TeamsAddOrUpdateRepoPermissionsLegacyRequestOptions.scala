...
object TeamsAddOrUpdateRepoPermissionsLegacyRequestOptions {
  ...
  @scala.inline
  implicit class TeamsAddOrUpdateRepoPermissionsLegacyRequestOptionsOps[Self <: TeamsAddOrUpdateRepoPermissionsLegacyRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
