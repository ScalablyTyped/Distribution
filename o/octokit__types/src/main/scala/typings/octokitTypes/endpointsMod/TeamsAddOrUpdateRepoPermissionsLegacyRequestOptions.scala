...
trait TeamsAddOrUpdateRepoPermissionsLegacyRequestOptions extends StObject {
...
object TeamsAddOrUpdateRepoPermissionsLegacyRequestOptions {
  ...
  @scala.inline
  def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsAddOrUpdateRepoPermissionsLegacyRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "PUT", request = request.asInstanceOf[js.Any], url = "/teams/:team_id/repos/:owner/:repo")
    __obj.asInstanceOf[TeamsAddOrUpdateRepoPermissionsLegacyRequestOptions]
  }
  
  @scala.inline
  implicit class TeamsAddOrUpdateRepoPermissionsLegacyRequestOptionsMutableBuilder[Self <: TeamsAddOrUpdateRepoPermissionsLegacyRequestOptions] (val x: Self) extends AnyVal {
