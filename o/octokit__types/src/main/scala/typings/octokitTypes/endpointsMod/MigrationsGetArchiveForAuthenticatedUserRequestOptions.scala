...
object MigrationsGetArchiveForAuthenticatedUserRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): MigrationsGetArchiveForAuthenticatedUserRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "GET", request = request.asInstanceOf[js.Any], url = "/user/migrations/:migration_id/archive")
    __obj.asInstanceOf[MigrationsGetArchiveForAuthenticatedUserRequestOptions]
  }
  
  extension [Self <: MigrationsGetArchiveForAuthenticatedUserRequestOptions](x: Self) {
