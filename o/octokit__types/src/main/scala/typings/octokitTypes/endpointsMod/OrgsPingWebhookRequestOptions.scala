...
object OrgsPingWebhookRequestOptions {
  ...
  @scala.inline
  implicit class OrgsPingWebhookRequestOptionsOps[Self <: OrgsPingWebhookRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashhooksSlashColonhook_idSlashpings): Self = this.set("url", value.asInstanceOf[js.Any])
  }
