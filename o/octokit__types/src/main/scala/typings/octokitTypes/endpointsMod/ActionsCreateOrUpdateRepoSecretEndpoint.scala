...
object ActionsCreateOrUpdateRepoSecretEndpoint {
  ...
  inline def apply(owner: String, repo: String, secret_name: String): ActionsCreateOrUpdateRepoSecretEndpoint = {
  ...
  extension [Self <: ActionsCreateOrUpdateRepoSecretEndpoint](x: Self) {
