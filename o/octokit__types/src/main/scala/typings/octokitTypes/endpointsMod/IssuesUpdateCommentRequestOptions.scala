...
object IssuesUpdateCommentRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): IssuesUpdateCommentRequestOptions = {
  ...
  extension [Self <: IssuesUpdateCommentRequestOptions](x: Self) {
    ...
    inline def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashissuesSlashcommentsSlashColoncomment_id): Self = StObject.set(x, "url", value.asInstanceOf[js.Any])
  }
}
