...
trait TeamsRemoveMembershipLegacyRequestOptions extends js.Object {
...
object TeamsRemoveMembershipLegacyRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsRemoveMembershipLegacyRequestOptions]
  }
}
