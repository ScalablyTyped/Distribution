...
trait TeamsUpdateDiscussionCommentInOrgRequestOptions extends StObject {
  ...
  var url: SlashorgsSlashColonorgSlashteamsSlashColonteam_slugSlashdiscussionsSlashColondiscussion_numberSlashcommentsSlashColoncomment_number
}
object TeamsUpdateDiscussionCommentInOrgRequestOptions {
  
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): TeamsUpdateDiscussionCommentInOrgRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = "PATCH", request = request.asInstanceOf[js.Any], url = "/orgs/:org/teams/:team_slug/discussions/:discussion_number/comments/:comment_number")
    __obj.asInstanceOf[TeamsUpdateDiscussionCommentInOrgRequestOptions]
  }
  
  extension [Self <: TeamsUpdateDiscussionCommentInOrgRequestOptions](x: Self) {
