...
@js.native
trait TeamsUpdateDiscussionCommentInOrgRequestOptions extends js.Object {
...
object TeamsUpdateDiscussionCommentInOrgRequestOptions {
  ...
  @scala.inline
  implicit class TeamsUpdateDiscussionCommentInOrgRequestOptionsOps[Self <: TeamsUpdateDiscussionCommentInOrgRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
