...
/* Inlined {  owner  :string,   repo  :string,   ref  :string,   check_name ? :string,   status ? :'queued' | 'in_progress' | 'completed',   filter ? :'latest' | 'all',   per_page ? :number,   page ? :number} & @octokit/types.@octokit/types/dist-types/generated/Endpoints.RequiredPreview<'antiope'> */
