...
trait ActionsGetWorkflowRunUsageEndpoint extends StObject {
...
object ActionsGetWorkflowRunUsageEndpoint {
  ...
  inline def apply(owner: String, repo: String, run_id: Double): ActionsGetWorkflowRunUsageEndpoint = {
  ...
  extension [Self <: ActionsGetWorkflowRunUsageEndpoint](x: Self) {
