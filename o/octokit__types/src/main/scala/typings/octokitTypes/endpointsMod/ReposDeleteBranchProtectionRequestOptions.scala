...
@js.native
trait ReposDeleteBranchProtectionRequestOptions extends js.Object {
...
object ReposDeleteBranchProtectionRequestOptions {
  ...
  @scala.inline
  implicit class ReposDeleteBranchProtectionRequestOptionsOps[Self <: ReposDeleteBranchProtectionRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashbranchesSlashColonbranchSlashprotection): Self = this.set("url", value.asInstanceOf[js.Any])
  }
