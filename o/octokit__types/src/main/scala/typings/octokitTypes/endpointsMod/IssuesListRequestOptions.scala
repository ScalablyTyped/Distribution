...
object IssuesListRequestOptions {
  ...
  @scala.inline
  implicit class IssuesListRequestOptionsOps[Self <: IssuesListRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: Slashissues): Self = this.set("url", value.asInstanceOf[js.Any])
  }
