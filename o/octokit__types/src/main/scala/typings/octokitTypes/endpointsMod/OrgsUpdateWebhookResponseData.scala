...
@js.native
trait OrgsUpdateWebhookResponseData extends js.Object {
...
object OrgsUpdateWebhookResponseData {
  ...
  @scala.inline
  implicit class OrgsUpdateWebhookResponseDataOps[Self <: OrgsUpdateWebhookResponseData] (val x: Self) extends AnyVal {
    @scala.inline
