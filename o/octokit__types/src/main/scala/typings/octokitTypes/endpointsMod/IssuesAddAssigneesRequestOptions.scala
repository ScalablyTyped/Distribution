...
object IssuesAddAssigneesRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): IssuesAddAssigneesRequestOptions = {
  ...
  extension [Self <: IssuesAddAssigneesRequestOptions](x: Self) {
