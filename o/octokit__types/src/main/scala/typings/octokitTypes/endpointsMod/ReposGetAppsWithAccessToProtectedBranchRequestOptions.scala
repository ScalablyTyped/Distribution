...
object ReposGetAppsWithAccessToProtectedBranchRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetAppsWithAccessToProtectedBranchRequestOptionsOps[Self <: ReposGetAppsWithAccessToProtectedBranchRequestOptions] (val x: Self) extends AnyVal {
