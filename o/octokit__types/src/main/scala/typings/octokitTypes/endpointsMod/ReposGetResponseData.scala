...
import typings.octokitTypes.anon.HtmlurlKey
...
@js.native
trait ReposGetResponseData extends StObject {
  ...
  var template_repository: String = js.native
...
object ReposGetResponseData {
  ...
  implicit class ReposGetResponseDataMutableBuilder[Self <: ReposGetResponseData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTemplate_repository(value: String): Self = StObject.set(x, "template_repository", value.asInstanceOf[js.Any])
