...
@js.native
trait ReposGetResponseData extends js.Object {
...
object ReposGetResponseData {
  ...
  @scala.inline
  implicit class ReposGetResponseDataOps[Self <: ReposGetResponseData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTemplate_repository(value: String): Self = this.set("template_repository", value.asInstanceOf[js.Any])
