...
object ReposGetResponseData {
  ...
  extension [Self <: ReposGetResponseData](x: Self) {
    ...
    inline def setTemplate_repository(value: String): Self = StObject.set(x, "template_repository", value.asInstanceOf[js.Any])
