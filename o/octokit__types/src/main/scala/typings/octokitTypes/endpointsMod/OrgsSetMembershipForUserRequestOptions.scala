...
@js.native
trait OrgsSetMembershipForUserRequestOptions extends js.Object {
  var headers: RequestHeaders = js.native
  var method: PUT = js.native
  var request: RequestRequestOptions = js.native
  var url: SlashorgsSlashColonorgSlashmembershipsSlashColonusername = js.native
}
...
object OrgsSetMembershipForUserRequestOptions {
  ...
  @scala.inline
  implicit class OrgsSetMembershipForUserRequestOptionsOps[Self <: OrgsSetMembershipForUserRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUrl(value: SlashorgsSlashColonorgSlashmembershipsSlashColonusername): Self = this.set("url", value.asInstanceOf[js.Any])
  }
