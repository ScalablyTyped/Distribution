...
@js.native
trait ChecksGetSuiteResponseData extends js.Object {
...
object ChecksGetSuiteResponseData {
  ...
  @scala.inline
  implicit class ChecksGetSuiteResponseDataOps[Self <: ChecksGetSuiteResponseData] (val x: Self) extends AnyVal {
    @scala.inline
