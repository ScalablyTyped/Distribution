...
object ReactionsCreateForPullRequestReviewCommentRequestOptions {
  ...
  @scala.inline
  implicit class ReactionsCreateForPullRequestReviewCommentRequestOptionsOps[Self <: ReactionsCreateForPullRequestReviewCommentRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
