...
object EnterpriseAdminListSelfHostedRunnersForEnterpriseEndpoint {
  ...
  inline def apply(enterprise: String): EnterpriseAdminListSelfHostedRunnersForEnterpriseEndpoint = {
  ...
  extension [Self <: EnterpriseAdminListSelfHostedRunnersForEnterpriseEndpoint](x: Self) {
