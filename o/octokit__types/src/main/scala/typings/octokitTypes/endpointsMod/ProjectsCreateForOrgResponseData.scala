...
@js.native
trait ProjectsCreateForOrgResponseData extends js.Object {
...
object ProjectsCreateForOrgResponseData {
  ...
  @scala.inline
  implicit class ProjectsCreateForOrgResponseDataOps[Self <: ProjectsCreateForOrgResponseData] (val x: Self) extends AnyVal {
    @scala.inline
