...
trait ProjectsCreateForOrgResponseData extends StObject {
...
object ProjectsCreateForOrgResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ProjectsCreateForOrgResponseData]
  }
  
  @scala.inline
  implicit class ProjectsCreateForOrgResponseDataMutableBuilder[Self <: ProjectsCreateForOrgResponseData] (val x: Self) extends AnyVal {
