...
@js.native
trait PullsRequestReviewersResponseData extends js.Object {
...
object PullsRequestReviewersResponseData {
  ...
  @scala.inline
  implicit class PullsRequestReviewersResponseDataOps[Self <: PullsRequestReviewersResponseData] (val x: Self) extends AnyVal {
    @scala.inline
