...
@js.native
trait PullsRequestReviewersResponseData extends StObject {
...
object PullsRequestReviewersResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PullsRequestReviewersResponseData]
  }
  
  @scala.inline
  implicit class PullsRequestReviewersResponseDataMutableBuilder[Self <: PullsRequestReviewersResponseData] (val x: Self) extends AnyVal {
