...
@js.native
trait ReposUpdatePullRequestReviewProtectionRequestOptions extends js.Object {
...
object ReposUpdatePullRequestReviewProtectionRequestOptions {
  ...
  @scala.inline
  implicit class ReposUpdatePullRequestReviewProtectionRequestOptionsOps[Self <: ReposUpdatePullRequestReviewProtectionRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
