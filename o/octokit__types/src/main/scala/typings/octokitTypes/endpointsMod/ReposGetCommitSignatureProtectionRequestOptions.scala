...
@js.native
trait ReposGetCommitSignatureProtectionRequestOptions extends js.Object {
...
object ReposGetCommitSignatureProtectionRequestOptions {
  ...
  @scala.inline
  implicit class ReposGetCommitSignatureProtectionRequestOptionsOps[Self <: ReposGetCommitSignatureProtectionRequestOptions] (val x: Self) extends AnyVal {
    @scala.inline
