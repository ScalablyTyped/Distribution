...
object ActionsDeleteWorkflowRunLogsRequestOptions {
  ...
  inline def apply(headers: RequestHeaders, request: RequestRequestOptions): ActionsDeleteWorkflowRunLogsRequestOptions = {
  ...
  extension [Self <: ActionsDeleteWorkflowRunLogsRequestOptions](x: Self) {
