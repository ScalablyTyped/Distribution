...
object ActionsDeleteWorkflowRunLogsRequestOptions {
  ...
  @scala.inline
  implicit class ActionsDeleteWorkflowRunLogsRequestOptionsOps[Self <: ActionsDeleteWorkflowRunLogsRequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrl(value: SlashreposSlashColonownerSlashColonrepoSlashactionsSlashrunsSlashColonrun_idSlashlogs): Self = this.set("url", value.asInstanceOf[js.Any])
  }
}
