...
@js.native
trait TeamsCheckPermissionsForProjectLegacyResponseData extends js.Object {
...
object TeamsCheckPermissionsForProjectLegacyResponseData {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TeamsCheckPermissionsForProjectLegacyResponseData]
  }
  @scala.inline
  implicit class TeamsCheckPermissionsForProjectLegacyResponseDataOps[Self <: TeamsCheckPermissionsForProjectLegacyResponseData] (val x: Self) extends AnyVal {
    @scala.inline
