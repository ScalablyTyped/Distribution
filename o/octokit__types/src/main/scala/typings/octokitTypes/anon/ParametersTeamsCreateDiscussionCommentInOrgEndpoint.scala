...
object ParametersTeamsCreateDiscussionCommentInOrgEndpoint {
  ...
  extension [Self <: ParametersTeamsCreateDiscussionCommentInOrgEndpoint](x: Self) {
    
    inline def setParameters(value: TeamsCreateDiscussionCommentInOrgEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: TeamsCreateDiscussionCommentInOrgRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
