...
object MD5DSA {
  ...
  inline def apply(MD5_DSA: String, MD5_RSA: String, SHA256_DSA: String, SHA256_RSA: String): MD5DSA = {
  ...
  extension [Self <: MD5DSA](x: Self) {
    
    inline def setMD5_DSA(value: String): Self = StObject.set(x, "MD5_DSA", value.asInstanceOf[js.Any])
    
    inline def setMD5_RSA(value: String): Self = StObject.set(x, "MD5_RSA", value.asInstanceOf[js.Any])
