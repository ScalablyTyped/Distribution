...
trait Followersurl extends StObject {
...
object Followersurl {
  ...
  @scala.inline
  implicit class FollowersurlMutableBuilder[Self <: Followersurl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPermissions(value: Pull): Self = StObject.set(x, "permissions", value.asInstanceOf[js.Any])
