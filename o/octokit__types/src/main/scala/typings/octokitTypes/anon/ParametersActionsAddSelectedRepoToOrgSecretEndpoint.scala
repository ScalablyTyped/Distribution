...
object ParametersActionsAddSelectedRepoToOrgSecretEndpoint {
  ...
  extension [Self <: ParametersActionsAddSelectedRepoToOrgSecretEndpoint](x: Self) {
    
    inline def setParameters(value: ActionsAddSelectedRepoToOrgSecretEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ActionsAddSelectedRepoToOrgSecretRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
