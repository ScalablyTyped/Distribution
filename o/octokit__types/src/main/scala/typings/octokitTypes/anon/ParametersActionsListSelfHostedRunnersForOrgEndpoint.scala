...
object ParametersActionsListSelfHostedRunnersForOrgEndpoint {
  ...
  implicit class ParametersActionsListSelfHostedRunnersForOrgEndpointOps[Self <: ParametersActionsListSelfHostedRunnersForOrgEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequest(value: ActionsListSelfHostedRunnersForOrgRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResponse(value: OctokitResponse[ActionsListSelfHostedRunnersForOrgResponseData]): Self = this.set("response", value.asInstanceOf[js.Any])
  }
}
