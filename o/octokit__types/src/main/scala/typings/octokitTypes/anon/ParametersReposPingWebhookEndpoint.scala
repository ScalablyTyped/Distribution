...
object ParametersReposPingWebhookEndpoint {
  ...
  extension [Self <: ParametersReposPingWebhookEndpoint](x: Self) {
    
    inline def setParameters(value: ReposPingWebhookEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ReposPingWebhookRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
