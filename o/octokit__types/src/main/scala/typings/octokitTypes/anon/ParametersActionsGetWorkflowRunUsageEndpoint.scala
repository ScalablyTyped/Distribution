...
object ParametersActionsGetWorkflowRunUsageEndpoint {
  ...
  extension [Self <: ParametersActionsGetWorkflowRunUsageEndpoint](x: Self) {
    
    inline def setParameters(value: ActionsGetWorkflowRunUsageEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ActionsGetWorkflowRunUsageRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
