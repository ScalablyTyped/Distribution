...
@js.native
trait ParametersEnterpriseAdminGetSharedStorageBillingGheEndpoint extends js.Object {
...
object ParametersEnterpriseAdminGetSharedStorageBillingGheEndpoint {
  ...
  @scala.inline
  implicit class ParametersEnterpriseAdminGetSharedStorageBillingGheEndpointOps[Self <: ParametersEnterpriseAdminGetSharedStorageBillingGheEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: EnterpriseAdminGetSharedStorageBillingGheEndpoint): Self = this.set("parameters", value.asInstanceOf[js.Any])
