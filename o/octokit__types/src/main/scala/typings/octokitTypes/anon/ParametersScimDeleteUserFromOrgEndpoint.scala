...
object ParametersScimDeleteUserFromOrgEndpoint {
  ...
  extension [Self <: ParametersScimDeleteUserFromOrgEndpoint](x: Self) {
    
    inline def setParameters(value: ScimDeleteUserFromOrgEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ScimDeleteUserFromOrgRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
