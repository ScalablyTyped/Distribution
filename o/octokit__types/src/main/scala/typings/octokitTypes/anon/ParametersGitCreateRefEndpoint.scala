...
object ParametersGitCreateRefEndpoint {
  ...
  extension [Self <: ParametersGitCreateRefEndpoint](x: Self) {
    
    inline def setParameters(value: GitCreateRefEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: GitCreateRefRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
