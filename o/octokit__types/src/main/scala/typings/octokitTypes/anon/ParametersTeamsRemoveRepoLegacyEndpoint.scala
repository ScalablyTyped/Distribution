...
object ParametersTeamsRemoveRepoLegacyEndpoint {
  ...
  extension [Self <: ParametersTeamsRemoveRepoLegacyEndpoint](x: Self) {
    
    inline def setParameters(value: TeamsRemoveRepoLegacyEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: TeamsRemoveRepoLegacyRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
