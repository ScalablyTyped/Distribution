...
object ParametersActionsCancelWorkflowRunEndpoint {
  ...
  @scala.inline
  implicit class ParametersActionsCancelWorkflowRunEndpointOps[Self <: ParametersActionsCancelWorkflowRunEndpoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: ActionsCancelWorkflowRunEndpoint): Self = this.set("parameters", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRequest(value: ActionsCancelWorkflowRunRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
