...
object ParametersActionsCancelWorkflowRunEndpoint {
  ...
  extension [Self <: ParametersActionsCancelWorkflowRunEndpoint](x: Self) {
    
    inline def setParameters(value: ActionsCancelWorkflowRunEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ActionsCancelWorkflowRunRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
