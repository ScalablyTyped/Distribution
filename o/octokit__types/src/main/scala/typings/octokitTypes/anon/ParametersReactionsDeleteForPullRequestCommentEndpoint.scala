...
object ParametersReactionsDeleteForPullRequestCommentEndpoint {
  ...
  extension [Self <: ParametersReactionsDeleteForPullRequestCommentEndpoint](x: Self) {
    
    inline def setParameters(value: ReactionsDeleteForPullRequestCommentEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ReactionsDeleteForPullRequestCommentRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
