...
@js.native
trait Contributions extends js.Object {
  
  var avatar_url: String = js.native
  
  var contributions: Double = js.native
...
object Contributions {
  ...
  implicit class ContributionsOps[Self <: Contributions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContributions(value: Double): Self = this.set("contributions", value.asInstanceOf[js.Any])
