...
object Contributions {
  ...
  @scala.inline
  implicit class ContributionsMutableBuilder[Self <: Contributions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAvatar_url(value: String): Self = StObject.set(x, "avatar_url", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setContributions(value: Double): Self = StObject.set(x, "contributions", value.asInstanceOf[js.Any])
