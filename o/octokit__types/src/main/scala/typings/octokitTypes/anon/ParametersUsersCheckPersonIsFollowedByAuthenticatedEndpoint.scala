...
object ParametersUsersCheckPersonIsFollowedByAuthenticatedEndpoint {
  ...
  extension [Self <: ParametersUsersCheckPersonIsFollowedByAuthenticatedEndpoint](x: Self) {
    
    inline def setParameters(value: UsersCheckPersonIsFollowedByAuthenticatedEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: UsersCheckPersonIsFollowedByAuthenticatedRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
