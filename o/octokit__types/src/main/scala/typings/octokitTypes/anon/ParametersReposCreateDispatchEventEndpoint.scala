...
object ParametersReposCreateDispatchEventEndpoint {
  ...
  extension [Self <: ParametersReposCreateDispatchEventEndpoint](x: Self) {
    
    inline def setParameters(value: ReposCreateDispatchEventEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ReposCreateDispatchEventRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
