...
object ParametersTeamsListIdPGroupsForOrgEndpoint {
  ...
  extension [Self <: ParametersTeamsListIdPGroupsForOrgEndpoint](x: Self) {
    ...
    inline def setRequest(value: TeamsListIdPGroupsForOrgRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
    
    inline def setResponse(value: OctokitResponse[TeamsListIdPGroupsForOrgResponseData]): Self = StObject.set(x, "response", value.asInstanceOf[js.Any])
  }
}
