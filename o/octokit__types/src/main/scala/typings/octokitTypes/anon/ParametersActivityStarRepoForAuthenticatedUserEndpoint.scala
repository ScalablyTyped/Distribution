...
object ParametersActivityStarRepoForAuthenticatedUserEndpoint {
  ...
  extension [Self <: ParametersActivityStarRepoForAuthenticatedUserEndpoint](x: Self) {
    
    inline def setParameters(value: ActivityStarRepoForAuthenticatedUserEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ActivityStarRepoForAuthenticatedUserRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
