...
object ParametersActionsListArtifactsForRepoEndpoint {
  ...
  extension [Self <: ParametersActionsListArtifactsForRepoEndpoint](x: Self) {
    ...
    inline def setRequest(value: ActionsListArtifactsForRepoRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
    
    inline def setResponse(value: OctokitResponse[ActionsListArtifactsForRepoResponseData]): Self = StObject.set(x, "response", value.asInstanceOf[js.Any])
  }
}
