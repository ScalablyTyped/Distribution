...
object ParametersPullsRemoveRequestedReviewersEndpoint {
  ...
  extension [Self <: ParametersPullsRemoveRequestedReviewersEndpoint](x: Self) {
    
    inline def setParameters(value: PullsRemoveRequestedReviewersEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: PullsRemoveRequestedReviewersRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
