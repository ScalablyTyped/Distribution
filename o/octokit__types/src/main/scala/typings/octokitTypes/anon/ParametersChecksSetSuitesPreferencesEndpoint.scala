...
object ParametersChecksSetSuitesPreferencesEndpoint {
  ...
  extension [Self <: ParametersChecksSetSuitesPreferencesEndpoint](x: Self) {
    
    inline def setParameters(value: ChecksSetSuitesPreferencesEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ChecksSetSuitesPreferencesRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
