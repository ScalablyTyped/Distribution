...
object ParametersReposListForUserEndpoint {
  ...
  extension [Self <: ParametersReposListForUserEndpoint](x: Self) {
    
    inline def setParameters(value: ReposListForUserEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ReposListForUserRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
