...
object ParametersReposUpdateInformationAboutPagesSiteEndpoint {
  ...
  extension [Self <: ParametersReposUpdateInformationAboutPagesSiteEndpoint](x: Self) {
    
    inline def setParameters(value: ReposUpdateInformationAboutPagesSiteEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ReposUpdateInformationAboutPagesSiteRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
