...
object ParametersUsersGetGpgKeyForAuthenticatedEndpoint {
  ...
  extension [Self <: ParametersUsersGetGpgKeyForAuthenticatedEndpoint](x: Self) {
    
    inline def setParameters(value: UsersGetGpgKeyForAuthenticatedEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: UsersGetGpgKeyForAuthenticatedRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
