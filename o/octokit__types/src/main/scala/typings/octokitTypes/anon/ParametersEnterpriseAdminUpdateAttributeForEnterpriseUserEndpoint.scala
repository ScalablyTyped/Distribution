...
object ParametersEnterpriseAdminUpdateAttributeForEnterpriseUserEndpoint {
  ...
  extension [Self <: ParametersEnterpriseAdminUpdateAttributeForEnterpriseUserEndpoint](x: Self) {
    
    inline def setParameters(value: EnterpriseAdminUpdateAttributeForEnterpriseUserEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: EnterpriseAdminUpdateAttributeForEnterpriseUserRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
    
    inline def setResponse(value: OctokitResponse[EnterpriseAdminUpdateAttributeForEnterpriseUserResponseData]): Self = StObject.set(x, "response", value.asInstanceOf[js.Any])
  }
}
