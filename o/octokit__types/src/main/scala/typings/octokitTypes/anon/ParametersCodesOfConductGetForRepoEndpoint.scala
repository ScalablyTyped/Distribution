...
object ParametersCodesOfConductGetForRepoEndpoint {
  ...
  extension [Self <: ParametersCodesOfConductGetForRepoEndpoint](x: Self) {
    
    inline def setParameters(value: CodesOfConductGetForRepoEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: CodesOfConductGetForRepoRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
