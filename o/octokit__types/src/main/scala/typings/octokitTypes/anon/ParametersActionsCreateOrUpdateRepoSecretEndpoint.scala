...
object ParametersActionsCreateOrUpdateRepoSecretEndpoint {
  ...
  @scala.inline
  implicit class ParametersActionsCreateOrUpdateRepoSecretEndpointOps[Self <: ParametersActionsCreateOrUpdateRepoSecretEndpoint] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setParameters(value: ActionsCreateOrUpdateRepoSecretEndpoint): Self = this.set("parameters", value.asInstanceOf[js.Any])
    @scala.inline
    def setRequest(value: ActionsCreateOrUpdateRepoSecretRequestOptions): Self = this.set("request", value.asInstanceOf[js.Any])
    @scala.inline
