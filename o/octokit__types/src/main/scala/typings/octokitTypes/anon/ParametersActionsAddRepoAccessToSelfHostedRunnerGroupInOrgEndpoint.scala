...
object ParametersActionsAddRepoAccessToSelfHostedRunnerGroupInOrgEndpoint {
  ...
  extension [Self <: ParametersActionsAddRepoAccessToSelfHostedRunnerGroupInOrgEndpoint](x: Self) {
    
    inline def setParameters(value: ActionsAddRepoAccessToSelfHostedRunnerGroupInOrgEndpoint): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: ActionsAddRepoAccessToSelfHostedRunnerGroupInOrgRequestOptions): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
