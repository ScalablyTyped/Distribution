...
import typings.openapiTypes.mod.OpenAPIV2.ItemsObject
import typings.openapiTypes.mod.OpenAPIV2.Schema
import typings.openapiTypes.mod.OpenAPIV3.ExampleObject
import typings.openapiTypes.mod.OpenAPIV3.MediaTypeObject
