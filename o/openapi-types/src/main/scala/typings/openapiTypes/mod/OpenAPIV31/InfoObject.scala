...
trait InfoObject extends StObject {
  ...
  var contact: js.UndefOr[typings.openapiTypes.mod.OpenAPIV3.ContactObject] = js.undefined
...
object InfoObject {
  ...
  extension [Self <: InfoObject](x: Self) {
    ...
    inline def setContact(value: typings.openapiTypes.mod.OpenAPIV3.ContactObject): Self = StObject.set(x, "contact", value.asInstanceOf[js.Any])
