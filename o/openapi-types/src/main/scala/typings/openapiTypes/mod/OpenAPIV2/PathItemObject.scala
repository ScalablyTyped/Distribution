...
object PathItemObject {
  ...
  implicit class PathItemObjectOps[Self <: PathItemObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDel(value: OperationObject): Self = this.set("del", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setParametersVarargs(value: (ReferenceObject | Parameter)*): Self = this.set("parameters", js.Array(value :_*))
    @scala.inline
