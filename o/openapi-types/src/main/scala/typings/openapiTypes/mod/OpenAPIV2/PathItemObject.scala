...
object PathItemObject {
  ...
  extension [Self <: PathItemObject](x: Self) {
    ...
    inline def setDel(value: OperationObject): Self = StObject.set(x, "del", value.asInstanceOf[js.Any])
    ...
    inline def setParametersVarargs(value: (ReferenceObject | Parameter)*): Self = StObject.set(x, "parameters", js.Array(value :_*))
