...
object SecuritySchemeObject {
  ...
  @scala.inline
  def SecuritySchemeApiKey(in: String, name: String): typings.openapiTypes.mod.OpenAPIV2.SecuritySchemeApiKey = {
  ...
  @scala.inline
  def SecuritySchemeBasic(): typings.openapiTypes.mod.OpenAPIV2.SecuritySchemeBasic = {
