package typings.owlDotCarousel.OwlCarouselNs
...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(checkVisible)) __obj.updateDynamic("checkVisible")(checkVisible)
    ...
    if (!js.isUndefined(dotsData)) __obj.updateDynamic("dotsData")(dotsData)
    ...
    if (slideTransition != null) __obj.updateDynamic("slideTransition")(slideTransition)
