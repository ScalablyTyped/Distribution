package typings.owlCarousel.OwlCarousel
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCheckVisible(value: Boolean): Self = this.set("checkVisible", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCheckVisible: Self = this.set("checkVisible", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setDotsData(value: Boolean): Self = this.set("dotsData", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDotsData: Self = this.set("dotsData", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setLazyLoadEager(value: Double): Self = this.set("lazyLoadEager", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLazyLoadEager: Self = this.set("lazyLoadEager", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setOnDrag(value: /* repeated */ js.Any => Unit): Self = this.set("onDrag", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setSlideTransition(value: String): Self = this.set("slideTransition", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSlideTransition: Self = this.set("slideTransition", js.undefined)
    @scala.inline
