...
trait Pool extends js.Object {
  /**
    ...
    */
  val connectionsInUse: scala.Double = js.native
  /**
    * The number of currently open connections in the underlying connection pool.
    */
  val connectionsOpen: scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  val poolPingInterval: scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  val queueTimeout: scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def _logStats(): scala.Unit = js.native
  /**
  ...
  def close(drainTime: scala.Double): js.Promise[scala.Unit] = js.native
  def close(drainTime: scala.Double, callback: js.Function1[/* error */ DBError, scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @alias close
    */
  def terminate(): js.Promise[scala.Unit] = js.native
  def terminate(callback: js.Function1[/* error */ DBError, scala.Unit]): scala.Unit = js.native
  def terminate(drainTime: scala.Double): js.Promise[scala.Unit] = js.native
  def terminate(drainTime: scala.Double, callback: js.Function1[/* error */ DBError, scala.Unit]): scala.Unit = js.native
}
