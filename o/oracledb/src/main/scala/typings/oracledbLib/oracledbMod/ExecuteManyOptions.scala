...
trait ExecuteManyOptions extends js.Object {
  ...
  /**
    ...
    * @default false
    */
  var batchErrors: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    * @default false
    */
  var dmlRowCounts: js.UndefOr[scala.Boolean] = js.undefined
}
...
object ExecuteManyOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(batchErrors)) __obj.updateDynamic("batchErrors")(batchErrors)
    if (bindDefs != null) __obj.updateDynamic("bindDefs")(bindDefs.asInstanceOf[js.Any])
    if (!js.isUndefined(dmlRowCounts)) __obj.updateDynamic("dmlRowCounts")(dmlRowCounts)
