...
trait SodaCollection extends js.Object {
  ...
  /**
    ...
    */
  def createIndex(indexSpec: BTreeIndex): js.Promise[scala.Unit] = js.native
  def createIndex(indexSpec: BTreeIndex, callback: js.Function1[/* error */ DBError, scala.Unit]): scala.Unit = js.native
  def createIndex(indexSpec: SearchIndex): js.Promise[scala.Unit] = js.native
  def createIndex(indexSpec: SearchIndex, callback: js.Function1[/* error */ DBError, scala.Unit]): scala.Unit = js.native
  def createIndex(indexSpec: SpatialIndex): js.Promise[scala.Unit] = js.native
  def createIndex(indexSpec: SpatialIndex, callback: js.Function1[/* error */ DBError, scala.Unit]): scala.Unit = js.native
  /**
  ...
  def drop(callback: js.Function2[/* error */ DBError, /* result */ DropCollectionResult, scala.Unit]): scala.Unit = js.native
  /**
    ...
    * @since 3.0
    */
  def dropIndex(indexName: java.lang.String): js.Promise[DropCollectionResult] = js.native
  def dropIndex(indexName: java.lang.String, options: DropIndexOptions): js.Promise[DropCollectionResult] = js.native
  def dropIndex(
    indexName: java.lang.String,
    options: DropIndexOptions,
    callback: js.Function2[/* error */ DBError, /* result */ DropCollectionResult, scala.Unit]
  ...
  def getDataGuide(callback: js.Function2[/* error */ DBError, /* document */ SodaDocument, scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @since 3.0
    */
  def insertOne(newDocument: SodaDocument): js.Promise[scala.Unit] = js.native
  def insertOne(newDocument: SodaDocument, callback: js.Function1[/* error */ DBError, scala.Unit]): scala.Unit = js.native
  /**
