...
trait SodaOperation extends js.Object {
  ...
  def count(callback: js.Function2[/* error */ DBError, /* result */ SodaCountResult, scala.Unit]): scala.Unit = js.native
  /**
  ...
  def getCursor(callback: js.Function2[/* error */ DBError, /* cursor */ SodaDocumentCursor, scala.Unit]): scala.Unit = js.native
  /**
  ...
  def getDocuments(callback: js.Function2[/* error */ DBError, /* documents */ js.Array[SodaDocument], scala.Unit]): scala.Unit = js.native
  /**
  ...
  def getOne(callback: js.Function2[/* error */ DBError, /* document */ SodaDocument, scala.Unit]): scala.Unit = js.native
  /**
    ...
    * @since 3.0
    */
  def key(value: java.lang.String): SodaOperation = js.native
  /**
    ...
    * @since 3.0
    */
  def keys(values: js.Array[java.lang.String]): SodaOperation = js.native
  /**
    ...
    * @since 3.0
    */
  def limit(limit: scala.Double): SodaOperation = js.native
  /**
  ...
  def remove(callback: js.Function2[/* error */ DBError, /* result */ SodaRemoveResult, scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @since 3.0
    */
  def skip(skip: scala.Double): SodaOperation = js.native
  /**
    ...
    * @since 3.0
    */
  def version(version: java.lang.String): SodaOperation = js.native
}
