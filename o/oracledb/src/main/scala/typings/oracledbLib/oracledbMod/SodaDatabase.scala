...
trait SodaDatabase extends js.Object {
  /**
    ...
    * @since 3.0
    */
  def createCollection(collectionName: java.lang.String): js.Promise[SodaCollection] = js.native
  def createCollection(
    collectionName: java.lang.String,
    callback: js.Function2[/* error */ DBError, /* collection */ SodaCollection, scala.Unit]
  ): scala.Unit = js.native
  def createCollection(collectionName: java.lang.String, options: SodaCollectionOptions): js.Promise[SodaCollection] = js.native
  def createCollection(
    collectionName: java.lang.String,
  ...
  /**
    ...
    */
  def createDocument(content: java.lang.String): SodaDocument = js.native
  def createDocument(content: java.lang.String, options: SodaDocumentOptions): SodaDocument = js.native
  def createDocument(content: nodeLib.Buffer): SodaDocument = js.native
  def createDocument(content: nodeLib.Buffer, options: SodaDocumentOptions): SodaDocument = js.native
  def createDocument(content: stdLib.Record[java.lang.String, _]): SodaDocument = js.native
  def createDocument(content: stdLib.Record[java.lang.String, _], options: SodaDocumentOptions): SodaDocument = js.native
  /**
    ...
    * @since 3.0
    */
  def getCollectionNames(): js.Array[java.lang.String] = js.native
  def getCollectionNames(callback: js.Function2[/* error */ DBError, /* names */ js.Array[java.lang.String], scala.Unit]): scala.Unit = js.native
  def getCollectionNames(options: SodaCollectionNamesOptions): js.Array[java.lang.String] = js.native
  def getCollectionNames(
    options: SodaCollectionNamesOptions,
    callback: js.Function2[/* error */ DBError, /* names */ js.Array[java.lang.String], scala.Unit]
  ): scala.Unit = js.native
  /**
    ...
    * @since 3.0
    */
  def openCollection(collectionName: java.lang.String): js.Promise[SodaCollection] = js.native
  def openCollection(
    collectionName: java.lang.String,
    callback: js.Function2[/* error */ DBError, /* collection */ SodaCollection, scala.Unit]
  ): scala.Unit = js.native
