...
object platformMod {
  ...
  @JSImport("@opentelemetry/instrumentation/build/src/platform", "InstrumentationBase")
  @js.native
  abstract class InstrumentationBase[T] protected ()
    extends typings.opentelemetryInstrumentation.nodeMod.InstrumentationBase[T] {
  ...
  open class InstrumentationNodeModuleDefinition[T] protected ()
    extends typings.opentelemetryInstrumentation.nodeMod.InstrumentationNodeModuleDefinition[T] {
  ...
  open class InstrumentationNodeModuleFile[T] protected ()
    extends typings.opentelemetryInstrumentation.nodeMod.InstrumentationNodeModuleFile[T] {
    def this(
      name: String,
      supportedVersions: js.Array[String],
