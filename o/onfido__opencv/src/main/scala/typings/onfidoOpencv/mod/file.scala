...
object file {
  ...
  object fileUtil {
    ...
    @JSImport("@onfido/opencv", "file.fileUtil")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@onfido/opencv", "file.fileUtil.getFileName")
    @js.native
    ...
    @JSImport("@onfido/opencv", "file.fileUtil.getFilePath")
    @js.native
    ...
    @JSImport("@onfido/opencv", "file.fileUtil.isDir")
    @js.native
    ...
    @JSImport("@onfido/opencv", "file.fileUtil.isFile")
    @js.native
    ...
    @JSImport("@onfido/opencv", "file.fileUtil.readFile")
    @js.native
    ...
    @JSImport("@onfido/opencv", "file.fileUtil.removeFile")
    @js.native
    ...
    @JSImport("@onfido/opencv", "file.fileUtil.writeFile")
    @js.native
