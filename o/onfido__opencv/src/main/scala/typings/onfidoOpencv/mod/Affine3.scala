...
@JSImport("@onfido/opencv", "Affine3")
@js.native
open class Affine3 ()
  extends typings.mirada.mod.Affine3 {
  /**
  ...
  /**
    ...
    */
  def this(data: typings.mirada.distSrcTypesOpencvTypesMod.Mat) = this()
  def this(R: Mat3 | Vec3, t: Vec3) = this()
  def this(data: typings.mirada.distSrcTypesOpencvTypesMod.Mat, t: Vec3) = this()
}
/* static members */
object Affine3 {
