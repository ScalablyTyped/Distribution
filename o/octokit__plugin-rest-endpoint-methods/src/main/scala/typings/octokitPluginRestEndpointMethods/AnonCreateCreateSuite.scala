...
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ChecksCreateSuiteParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ChecksGetParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ChecksGetSuiteParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ChecksListAnnotationsParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ChecksListForRefParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ChecksListForSuiteParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ChecksListSuitesForRefParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ChecksRerequestSuiteParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ChecksSetSuitesPreferencesParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ChecksUpdateParams
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait AnonCreateCreateSuite extends js.Object {
  /**
    ...
    */
  @JSName("createSuite")
  var createSuite_Original: AnonEndpointParamsAnyChecksCreateSuiteParams = js.native
  /**
    ...
    */
  @JSName("create")
  var create_Original: AnonEndpointParamsAnyChecksCreateParams = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array and a `null` value for `head_branch`.
    *
    ...
    */
  @JSName("getSuite")
  var getSuite_Original: AnonEndpointParamsAnyChecksGetSuiteParams = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
    *
    ...
    */
  @JSName("get")
  var get_Original: AnonEndpointParamsAnyChecksGetParams = js.native
  /**
    * Lists annotations for a check run using the annotation `id`. GitHub Apps must have the `checks:read` permission on a private repository or pull access to a public repository to get annotations for a check run. OAuth Apps and authenticated users must have the `repo` scope to get annotations for a check run in a private repository.
    */
  @JSName("listAnnotations")
  var listAnnotations_Original: AnonEndpointParamsAnyChecksListAnnotationsParams = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
    *
    ...
    */
  @JSName("listForRef")
  var listForRef_Original: AnonEndpointParamsAnyChecksListForRefParams = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
    *
    ...
    */
  @JSName("listForSuite")
  var listForSuite_Original: AnonEndpointParamsAnyChecksListForSuiteParams = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array and a `null` value for `head_branch`.
    *
  ...
  var listSuitesForRef_Original: AnonEndpointParamsAnyChecksListSuitesForRefParams = js.native
  /**
  ...
  var rerequestSuite_Original: AnonEndpointParamsAnyAnyResponseChecksRerequestSuiteParams = js.native
  /**
  ...
  var setSuitesPreferences_Original: AnonEndpointParamsAnyChecksSetSuitesPreferencesParams = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
    *
    ...
    */
  @JSName("update")
  var update_Original: AnonEndpointParamsAnyChecksUpdateParams = js.native
  /**
    * **Note:** The Checks API only looks for pushes in the repository where the check suite or check run were created. Pushes to a branch in a forked repository are not detected and return an empty `pull_requests` array.
    *
    * Creates a new check run for a specific commit in a repository. Your GitHub App must have the `checks:write` permission to create check runs.
