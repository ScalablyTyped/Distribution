...
trait AnonAllowmergecommitAllowrebasemerge extends js.Object {
...
object AnonAllowmergecommitAllowrebasemerge {
  @scala.inline
  def apply(
    ...
    team_id: AnonType,
    visibility: AnonEnum
  ): AnonAllowmergecommitAllowrebasemerge = {
    ...
    __obj.asInstanceOf[AnonAllowmergecommitAllowrebasemerge]
  }
}
