...
import typings.octokitPluginRestEndpointMethods.typesMod.ActivityCheckWatchingRepoLegacyParams
...
import typings.octokitPluginRestEndpointMethods.typesMod.ActivityStopWatchingRepoLegacyParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActivityUnstarRepoParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActivityWatchRepoLegacyParams
...
trait AnonCheckStarringRepo extends js.Object {
  ...
  var checkWatchingRepoLegacy_Original: Anon22 = js.native
  /**
  ...
  var getRepoSubscription_Original: Anon25 = js.native
  /**
  ...
  var getThreadSubscription_Original: Anon27 = js.native
  @JSName("getThread")
  var getThread_Original: Anon26 = js.native
  /**
    * This is the user's organization dashboard. You must be authenticated as the user to view this.
    */
  @JSName("listEventsForOrg")
  var listEventsForOrg_Original: Anon28 = js.native
  /**
    * If you are authenticated as the given user, you will see your private events. Otherwise, you'll only see public events.
    */
  @JSName("listEventsForUser")
  var listEventsForUser_Original: Anon29 = js.native
  /**
    ...
    */
  @JSName("listFeeds")
  var listFeeds_Original: Anon30 = js.native
  /**
    * List all notifications for the current user.
    */
  @JSName("listNotificationsForRepo")
  var listNotificationsForRepo_Original: Anon32 = js.native
  /**
  ...
  var listNotifications_Original: Anon31 = js.native
  @JSName("listPublicEventsForOrg")
  var listPublicEventsForOrg_Original: Anon34 = js.native
  @JSName("listPublicEventsForRepoNetwork")
  var listPublicEventsForRepoNetwork_Original: Anon35 = js.native
  @JSName("listPublicEventsForUser")
  var listPublicEventsForUser_Original: Anon36 = js.native
  /**
    * We delay the public events feed by five minutes, which means the most recent event returned by the public events API actually occurred at least five minutes ago.
    */
  @JSName("listPublicEvents")
  var listPublicEvents_Original: Anon33 = js.native
  /**
    * These are events that you've received by watching repos and following users. If you are authenticated as the given user, you will see private events. Otherwise, you'll only see public events.
    */
  @JSName("listReceivedEventsForUser")
  var listReceivedEventsForUser_Original: Anon37 = js.native
  @JSName("listReceivedPublicEventsForUser")
  var listReceivedPublicEventsForUser_Original: Anon38 = js.native
  @JSName("listRepoEvents")
  var listRepoEvents_Original: Anon39 = js.native
  /**
    * You can also find out _when_ stars were created by passing the following custom [media type](https://developer.github.com/v3/media/) via the `Accept` header:
    */
  @JSName("listReposStarredByAuthenticatedUser")
  var listReposStarredByAuthenticatedUser_Original: Anon40 = js.native
  /**
    * You can also find out _when_ stars were created by passing the following custom [media type](https://developer.github.com/v3/media/) via the `Accept` header:
    */
  @JSName("listReposStarredByUser")
  var listReposStarredByUser_Original: Anon41 = js.native
  @JSName("listReposWatchedByUser")
  var listReposWatchedByUser_Original: Anon42 = js.native
  /**
    * You can also find out _when_ stars were created by passing the following custom [media type](https://developer.github.com/v3/media/) via the `Accept` header:
    */
  @JSName("listStargazersForRepo")
  var listStargazersForRepo_Original: Anon43 = js.native
  @JSName("listWatchedReposForAuthenticatedUser")
  var listWatchedReposForAuthenticatedUser_Original: Anon44 = js.native
  @JSName("listWatchersForRepo")
  var listWatchersForRepo_Original: Anon45 = js.native
  /**
    ...
    */
  @JSName("markAsRead")
  var markAsRead_Original: Anon46 = js.native
  /**
  ...
  var markNotificationsAsReadForRepo_Original: Anon47 = js.native
  @JSName("markThreadAsRead")
  var markThreadAsRead_Original: Anon48 = js.native
  /**
  ...
  var setRepoSubscription_Original: Anon49 = js.native
  /**
    * This lets you subscribe or unsubscribe from a conversation.
    */
  @JSName("setThreadSubscription")
  var setThreadSubscription_Original: Anon50 = js.native
  /**
    * Requires for the user to be authenticated.
    *
    ...
    */
  @JSName("starRepo")
  var starRepo_Original: Anon51 = js.native
  /**
    * Requires for the user to be authenticated.
    */
  @JSName("stopWatchingRepoLegacy")
  var stopWatchingRepoLegacy_Original: Anon52 = js.native
  /**
    * Requires for the user to be authenticated.
    */
  @JSName("unstarRepo")
  var unstarRepo_Original: Anon53 = js.native
  /**
  ...
  var watchRepoLegacy_Original: Anon54 = js.native
  /**
    * Requires for the user to be authenticated.
    */
