...
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsDeleteArchiveForOrgParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsDownloadArchiveForOrgParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsGetArchiveForAuthenticatedUserParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsGetArchiveForOrgParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsGetCommitAuthorsParams
...
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsGetStatusForAuthenticatedUserParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsGetStatusForOrgParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsListForAuthenticatedUserParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsListForOrgParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsListReposForOrgParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsListReposForUserParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsMapCommitAuthorParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsSetLfsPreferenceParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsStartForAuthenticatedUserParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsStartForOrgParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsStartImportParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsUnlockRepoForAuthenticatedUserParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsUnlockRepoForOrgParams
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.MigrationsUpdateImportParams
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait AnonCancelImportDeleteArchiveForAuthenticatedUser extends js.Object {
  /**
    * Stop an import for a repository.
    */
  @JSName("cancelImport")
  var cancelImport_Original: AnonEndpointParamsAnyAnyResponseMigrationsCancelImportParams = js.native
  /**
  ...
  var deleteArchiveForAuthenticatedUser_Original: AnonEndpointParamsAnyAnyResponseMigrationsDeleteArchiveForAuthenticatedUserParams = js.native
  /**
    * Deletes a previous migration archive. Migration archives are automatically deleted after seven days.
    */
  @JSName("deleteArchiveForOrg")
  var deleteArchiveForOrg_Original: AnonEndpointParamsAnyAnyResponseMigrationsDeleteArchiveForOrgParams = js.native
  /**
    * Fetches the URL to a migration archive.
    */
  @JSName("downloadArchiveForOrg")
  var downloadArchiveForOrg_Original: AnonEndpointParamsAnyAnyResponseMigrationsDownloadArchiveForOrgParams = js.native
  /**
  ...
  var getArchiveForAuthenticatedUser_Original: AnonEndpointParamsAnyAnyResponseMigrationsGetArchiveForAuthenticatedUserParams = js.native
  /**
    * Fetches the URL to a migration archive.
    *
    *
  ...
  var getArchiveForOrg_Original: AnonEndpointParamsAnyAnyResponseMigrationsGetArchiveForOrgParams = js.native
  /**
  ...
  var getCommitAuthors_Original: AnonEndpointParamsAnyMigrationsGetCommitAuthorsParams = js.native
  /**
  ...
  var getImportProgress_Original: AnonEndpointParamsAnyMigrationsGetImportProgressParams = js.native
  /**
    * List files larger than 100MB found during the import
    */
  @JSName("getLargeFiles")
  var getLargeFiles_Original: AnonEndpointParamsAnyMigrationsGetLargeFilesParams = js.native
  /**
  ...
  var getStatusForAuthenticatedUser_Original: AnonEndpointParamsAnyMigrationsGetStatusForAuthenticatedUserParams = js.native
  /**
  ...
  var getStatusForOrg_Original: AnonEndpointParamsAnyMigrationsGetStatusForOrgParams = js.native
  /**
    * Lists all migrations a user has started.
    */
  @JSName("listForAuthenticatedUser")
  var listForAuthenticatedUser_Original: AnonEndpointParamsAnyMigrationsListForAuthenticatedUserParams = js.native
  /**
    * Lists the most recent migrations.
    */
  @JSName("listForOrg")
  var listForOrg_Original: AnonEndpointParamsAnyMigrationsListForOrgParams = js.native
  /**
    * List all the repositories for this organization migration.
    */
  @JSName("listReposForOrg")
  var listReposForOrg_Original: AnonEndpointParamsAnyMigrationsListReposForOrgParams = js.native
  /**
    * Lists all the repositories for this user migration.
    */
  @JSName("listReposForUser")
  var listReposForUser_Original: AnonEndpointParamsAnyMigrationsListReposForUserParams = js.native
  /**
    * Update an author's identity for the import. Your application can continue updating authors any time before you push new commits to the repository.
    */
  @JSName("mapCommitAuthor")
  var mapCommitAuthor_Original: AnonEndpointParamsAnyMigrationsMapCommitAuthorParams = js.native
  /**
    * You can import repositories from Subversion, Mercurial, and TFS that include files larger than 100MB. This ability is powered by [Git LFS](https://git-lfs.github.com). You can learn more about our LFS feature and working with large files [on our help site](https://help.github.com/articles/versioning-large-files/).
    */
  @JSName("setLfsPreference")
  var setLfsPreference_Original: AnonEndpointParamsAnyMigrationsSetLfsPreferenceParams = js.native
  /**
    * Initiates the generation of a user migration archive.
    */
  @JSName("startForAuthenticatedUser")
  var startForAuthenticatedUser_Original: AnonEndpointParamsAnyMigrationsStartForAuthenticatedUserParams = js.native
  /**
    * Initiates the generation of a migration archive.
    */
  @JSName("startForOrg")
  var startForOrg_Original: AnonEndpointParamsAnyMigrationsStartForOrgParams = js.native
  /**
    * Start a source import to a GitHub repository using GitHub Importer.
    */
  @JSName("startImport")
  var startImport_Original: AnonEndpointParamsAnyMigrationsStartImportParams = js.native
  /**
  ...
  var unlockRepoForAuthenticatedUser_Original: AnonEndpointParamsAnyAnyResponseMigrationsUnlockRepoForAuthenticatedUserParams = js.native
  /**
  ...
  var unlockRepoForOrg_Original: AnonEndpointParamsAnyAnyResponseMigrationsUnlockRepoForOrgParams = js.native
  /**
    ...
    */
  @JSName("updateImport")
  var updateImport_Original: AnonEndpointParamsAnyMigrationsUpdateImportParams = js.native
  /**
    * Stop an import for a repository.
    */
