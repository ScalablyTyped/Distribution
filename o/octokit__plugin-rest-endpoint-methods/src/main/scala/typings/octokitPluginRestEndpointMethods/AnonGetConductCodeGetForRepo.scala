...
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.CodesOfConductGetForRepoParams
...
@js.native
trait AnonGetConductCodeGetForRepo extends js.Object {
  @JSName("getConductCode")
  var getConductCode_Original: AnonEndpointParamsAnyCodesOfConductGetConductCodeParams = js.native
  /**
    * This method returns the contents of the repository's code of conduct file, if one is detected.
    */
  @JSName("getForRepo")
  var getForRepo_Original: AnonEndpointParamsAnyCodesOfConductGetForRepoParams = js.native
  @JSName("listConductCodes")
  var listConductCodes_Original: AnonEndpointParamsAny = js.native
