...
trait Get545 extends StObject {
  ...
  /**
    ...
    */
  @JSName("get")
  var get_Original: `545`
}
object Get545 {
  
  inline def apply(get: `545`): Get545 = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any])
    __obj.asInstanceOf[Get545]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Get545] (val x: Self) extends AnyVal {
    
    inline def setGet(value: `545`): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
  }
}
