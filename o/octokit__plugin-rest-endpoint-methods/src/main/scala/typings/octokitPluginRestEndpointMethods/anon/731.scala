...
object `731` {
  ...
  extension [Self <: `731`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[IssuesGetLabelEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
