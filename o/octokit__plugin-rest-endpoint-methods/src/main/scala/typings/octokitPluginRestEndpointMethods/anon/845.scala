...
object `845` {
  ...
  @scala.inline
  implicit class `845Ops`[Self <: `845`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[PullsCheckIfMergedEndpoint, baseUrl | headers | mediaType])): Self = this.set("parameters", value.asInstanceOf[js.Any])
