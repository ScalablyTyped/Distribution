...
object `698` {
  ...
  implicit class `698MutableBuilder`[Self <: `698`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: RequestParameters & (Omit[GitCreateCommitEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
