...
object `840` {
  ...
  extension [Self <: `840`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[ProjectsMoveColumnEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
