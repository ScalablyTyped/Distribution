...
trait `1195` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/import/large_files']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1195` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1195`] (val x: Self) extends AnyVal {
