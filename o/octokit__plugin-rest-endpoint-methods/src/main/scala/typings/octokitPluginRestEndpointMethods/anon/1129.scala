...
trait `1129` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/issues/{issue_number}/assignees']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1129` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1129`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1129`] (val x: Self) extends AnyVal {
