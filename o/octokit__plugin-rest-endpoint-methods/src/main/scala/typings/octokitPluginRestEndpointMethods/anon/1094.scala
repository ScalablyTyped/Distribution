...
trait `1094` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/codespaces/secrets/{secret_name}']['get'] */ js.Any
    ], 
...
object `1094` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1094`] (val x: Self) extends AnyVal {
