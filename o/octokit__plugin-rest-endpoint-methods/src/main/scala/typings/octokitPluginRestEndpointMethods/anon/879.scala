...
trait `879` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/runners/generate-jitconfig']['post'] */ js.Any
    ], 
...
object `879` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `879`] (val x: Self) extends AnyVal {
