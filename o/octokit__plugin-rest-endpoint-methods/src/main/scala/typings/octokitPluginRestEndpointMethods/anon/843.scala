...
trait `843` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repositories/{repository_id}/environments/{environment_name}/variables']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `843` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `843`] (val x: Self) extends AnyVal {
