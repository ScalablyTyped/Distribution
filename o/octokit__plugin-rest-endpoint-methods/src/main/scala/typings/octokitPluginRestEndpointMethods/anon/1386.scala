...
trait `1386` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/branches/{branch}/protection']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1386` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1386`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1386`] (val x: Self) extends AnyVal {
