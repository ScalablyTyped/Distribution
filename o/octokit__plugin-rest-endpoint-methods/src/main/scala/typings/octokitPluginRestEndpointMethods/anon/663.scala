...
object `663` {
  ...
  extension [Self <: `663`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[ChecksListForSuiteEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
