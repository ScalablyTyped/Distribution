...
object `904` {
  ...
  extension [Self <: `904`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[ReposCreateDeployKeyEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
