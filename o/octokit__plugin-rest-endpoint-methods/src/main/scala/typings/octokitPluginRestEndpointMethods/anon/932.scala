...
trait `932` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/permissions/repositories']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `932` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `932`] (val x: Self) extends AnyVal {
