...
trait `874` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[ReactionsCreateForIssueEndpoint, baseUrl | headers | mediaType])
...
object `874` {
  ...
  inline def apply(
    parameters: RequestParameters & (Omit[ReactionsCreateForIssueEndpoint, baseUrl | headers | mediaType]),
  ...
  extension [Self <: `874`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ReactionsCreateForIssueEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
