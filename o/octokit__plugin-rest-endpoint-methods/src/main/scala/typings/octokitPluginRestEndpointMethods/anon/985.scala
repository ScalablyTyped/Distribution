...
object `985` {
  ...
  @scala.inline
  implicit class `985Ops`[Self <: `985`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[ReposListDeployKeysEndpoint, baseUrl | headers | mediaType])): Self = this.set("parameters", value.asInstanceOf[js.Any])
