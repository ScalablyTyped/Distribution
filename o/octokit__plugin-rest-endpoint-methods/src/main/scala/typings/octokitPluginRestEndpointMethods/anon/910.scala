...
object `910` {
  ...
  extension [Self <: `910`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ReposCreateInOrgEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
