...
object `1097` {
  ...
  implicit class `1097MutableBuilder`[Self <: `1097`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: RequestParameters & (Omit[UsersUnblockEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
