...
trait `1237` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/invitations']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1237` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1237`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1237`] (val x: Self) extends AnyVal {
