...
trait `891` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[ReactionsListForTeamDiscussionInOrgEndpoint, baseUrl | headers | mediaType])
...
object `891` {
  ...
  @scala.inline
  def apply(
    parameters: RequestParameters & (Omit[ReactionsListForTeamDiscussionInOrgEndpoint, baseUrl | headers | mediaType]),
  ...
  implicit class `891MutableBuilder`[Self <: `891`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(
      value: RequestParameters & (Omit[ReactionsListForTeamDiscussionInOrgEndpoint, baseUrl | headers | mediaType])
