...
trait `616` extends js.Object {
  var parameters: RequestParameters with (Omit[AppsCreateInstallationTokenEndpoint, baseUrl | headers | mediaType])
...
object `616` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[AppsCreateInstallationTokenEndpoint, baseUrl | headers | mediaType]),
