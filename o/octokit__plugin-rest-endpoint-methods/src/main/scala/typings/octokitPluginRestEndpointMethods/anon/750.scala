...
trait `750` extends js.Object {
  var parameters: RequestParameters with (Omit[MigrationsGetImportProgressEndpoint, baseUrl | headers | mediaType])
...
object `750` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[MigrationsGetImportProgressEndpoint, baseUrl | headers | mediaType]),
