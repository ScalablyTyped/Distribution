...
trait `993` extends js.Object {
  var parameters: RequestParameters with (Omit[ReposRemoveProtectedBranchTeamRestrictionsEndpoint, baseUrl | headers | mediaType])
...
object `993` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[ReposRemoveProtectedBranchTeamRestrictionsEndpoint, baseUrl | headers | mediaType]),
