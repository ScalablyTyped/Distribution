...
trait `1080` extends js.Object {
  var parameters: RequestParameters with (Omit[UsersTogglePrimaryEmailVisibilityEndpoint, baseUrl | headers | mediaType])
...
object `1080` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[UsersTogglePrimaryEmailVisibilityEndpoint, baseUrl | headers | mediaType]),
