...
trait `941` extends js.Object {
  var parameters: RequestParameters with (Omit[ReposGetProtectedBranchRequiredStatusChecksEndpoint, baseUrl | headers | mediaType])
...
object `941` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[ReposGetProtectedBranchRequiredStatusChecksEndpoint, baseUrl | headers | mediaType]),
