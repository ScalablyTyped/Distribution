...
trait `1439` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/environments/{environment_name}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1439` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1439`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1439`] (val x: Self) extends AnyVal {
