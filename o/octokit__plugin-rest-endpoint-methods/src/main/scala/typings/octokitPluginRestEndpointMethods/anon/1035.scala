...
trait `1035` extends StObject {
  ...
  var parameters: RequestParameters with (Omit[SearchReposEndpoint, baseUrl | headers | mediaType]) = js.native
...
object `1035` {
  ...
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[SearchReposEndpoint, baseUrl | headers | mediaType]),
  ...
  implicit class `1035MutableBuilder`[Self <: `1035`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[SearchReposEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
