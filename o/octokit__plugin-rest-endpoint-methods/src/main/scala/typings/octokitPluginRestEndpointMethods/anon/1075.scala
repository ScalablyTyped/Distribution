...
trait `1075` extends js.Object {
  var parameters: RequestParameters with (Omit[UsersListGpgKeysEndpoint, baseUrl | headers | mediaType])
...
object `1075` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[UsersListGpgKeysEndpoint, baseUrl | headers | mediaType]),
