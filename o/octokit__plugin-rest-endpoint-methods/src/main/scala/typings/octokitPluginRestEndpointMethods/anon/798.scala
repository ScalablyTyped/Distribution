...
object `798` {
  ...
  extension [Self <: `798`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[OrgsListAppInstallationsEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
