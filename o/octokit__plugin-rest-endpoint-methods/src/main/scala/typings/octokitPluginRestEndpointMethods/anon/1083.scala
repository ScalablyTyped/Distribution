...
trait `1083` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/codespaces/billing/selected_users']['delete'] */ js.Any
    ], 
...
object `1083` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1083`] (val x: Self) extends AnyVal {
