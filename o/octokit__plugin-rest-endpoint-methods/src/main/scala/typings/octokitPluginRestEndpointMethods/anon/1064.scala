...
trait `1064` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/codespaces/secrets/{secret_name}/repositories']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1064` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1064`] (val x: Self) extends AnyVal {
