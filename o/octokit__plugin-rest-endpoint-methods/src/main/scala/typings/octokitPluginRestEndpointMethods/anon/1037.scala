...
object `1037` {
  ...
  @scala.inline
  implicit class `1037Ops`[Self <: `1037`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[TeamsCreateEndpoint, baseUrl | headers | mediaType])): Self = this.set("parameters", value.asInstanceOf[js.Any])
    @scala.inline
