...
object `957` {
  ...
  extension [Self <: `957`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ReposGetDeploymentEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setResponse(value: OctokitResponse[ReposGetDeploymentResponseData]): Self = StObject.set(x, "response", value.asInstanceOf[js.Any])
  }
}
