...
trait `1028` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/codespaces/secrets/{secret_name}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1028` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1028`] (val x: Self) extends AnyVal {
