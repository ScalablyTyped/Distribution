...
trait `882` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/permissions/selected-actions']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `882` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `882`] (val x: Self) extends AnyVal {
