...
trait CheckAccountIsAssociatedWithAny extends js.Object {
  var addRepoToInstallation: `610`
  var checkAccountIsAssociatedWithAny: `611`
  var checkAccountIsAssociatedWithAnyStubbed: `612`
  var checkToken: `613`
  ...
  var deleteToken: `619`
  var getAuthenticated: `620`
  var getBySlug: `621`
  var getInstallation: `622`
  var getOrgInstallation: `623`
  var getRepoInstallation: `624`
  var getSubscriptionPlanForAccount: `611`
  var getSubscriptionPlanForAccountStubbed: `612`
  var getUserInstallation: `625`
  var listAccountsForPlan: `626`
  var listAccountsForPlanStubbed: `627`
  var listAccountsUserOrOrgOnPlan: `626`
  var listAccountsUserOrOrgOnPlanStubbed: `627`
  var listInstallationReposForAuthenticatedUser: `628`
  var listInstallations: `629`
  var listInstallationsForAuthenticatedUser: `630`
  var listMarketplacePurchasesForAuthenticatedUser: `631`
  var listMarketplacePurchasesForAuthenticatedUserStubbed: `632`
  var listPlans: `633`
...
object CheckAccountIsAssociatedWithAny {
  @scala.inline
  def apply(
    addRepoToInstallation: `610`,
    checkAccountIsAssociatedWithAny: `611`,
    checkAccountIsAssociatedWithAnyStubbed: `612`,
    checkToken: `613`,
    ...
    deleteToken: `619`,
    getAuthenticated: `620`,
    getBySlug: `621`,
    getInstallation: `622`,
    getOrgInstallation: `623`,
    getRepoInstallation: `624`,
    getSubscriptionPlanForAccount: `611`,
    getSubscriptionPlanForAccountStubbed: `612`,
    getUserInstallation: `625`,
    listAccountsForPlan: `626`,
    listAccountsForPlanStubbed: `627`,
    listAccountsUserOrOrgOnPlan: `626`,
    listAccountsUserOrOrgOnPlanStubbed: `627`,
    listInstallationReposForAuthenticatedUser: `628`,
    listInstallations: `629`,
    listInstallationsForAuthenticatedUser: `630`,
    listMarketplacePurchasesForAuthenticatedUser: `631`,
    listMarketplacePurchasesForAuthenticatedUserStubbed: `632`,
    listPlans: `633`,
