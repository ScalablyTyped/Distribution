...
object `917` {
  ...
  extension [Self <: `917`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ReposDeleteEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
