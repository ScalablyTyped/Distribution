...
object `692` {
  ...
  extension [Self <: `692`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[GistsListStarredEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
