...
trait `1691` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user']['patch'] */ js.Any
    ], 
...
object `1691` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1691`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1691`] (val x: Self) extends AnyVal {
