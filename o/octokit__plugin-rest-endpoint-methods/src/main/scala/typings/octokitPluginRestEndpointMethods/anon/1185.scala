...
trait `1185` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/issues/{issue_number}/labels']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1185` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1185`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1185`] (val x: Self) extends AnyVal {
