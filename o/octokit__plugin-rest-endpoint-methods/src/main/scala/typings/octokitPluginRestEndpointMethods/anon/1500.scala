...
trait `1500` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1500` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1500`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1500`] (val x: Self) extends AnyVal {
