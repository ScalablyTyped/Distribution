...
trait `851` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/runners/remove-token']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `851` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `851`] (val x: Self) extends AnyVal {
