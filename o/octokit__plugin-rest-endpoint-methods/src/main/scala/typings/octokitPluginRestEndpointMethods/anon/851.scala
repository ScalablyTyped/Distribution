...
trait `851` extends js.Object {
  var parameters: RequestParameters with (Omit[PullsUpdateCommentEndpoint, baseUrl | headers | mediaType])
...
object `851` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[PullsUpdateCommentEndpoint, baseUrl | headers | mediaType]),
