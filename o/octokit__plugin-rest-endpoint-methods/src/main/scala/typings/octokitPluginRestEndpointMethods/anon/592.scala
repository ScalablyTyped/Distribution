...
object `592` {
  ...
  extension [Self <: `592`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ActivityGetFeedsEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
