...
trait `1641` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/teams/{team_slug}/memberships/{username}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1641` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1641`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1641`] (val x: Self) extends AnyVal {
