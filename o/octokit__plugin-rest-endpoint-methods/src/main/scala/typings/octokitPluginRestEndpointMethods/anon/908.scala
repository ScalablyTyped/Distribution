...
trait `908` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/runs/{run_id}/attempts/{attempt_number}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `908` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `908`] (val x: Self) extends AnyVal {
