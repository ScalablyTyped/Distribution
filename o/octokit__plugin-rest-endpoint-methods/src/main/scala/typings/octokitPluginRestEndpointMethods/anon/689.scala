...
trait `689` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[GistsListForUserEndpoint, baseUrl | headers | mediaType])
...
object `689` {
  ...
  inline def apply(
    parameters: RequestParameters & (Omit[GistsListForUserEndpoint, baseUrl | headers | mediaType]),
  ...
  extension [Self <: `689`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[GistsListForUserEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
