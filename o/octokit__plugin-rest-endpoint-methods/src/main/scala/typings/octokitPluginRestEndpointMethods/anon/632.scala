...
object `632` {
  ...
  extension [Self <: `632`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[AppsGetRepoInstallationEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
