...
trait `1190` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/migrations/{migration_id}/archive']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1190` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1190`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1190`] (val x: Self) extends AnyVal {
