...
trait `1093` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[UsersListPublicEmailsForAuthenticatedEndpoint, baseUrl | headers | mediaType])
...
object `1093` {
  ...
  @scala.inline
  def apply(
    parameters: RequestParameters & (Omit[UsersListPublicEmailsForAuthenticatedEndpoint, baseUrl | headers | mediaType]),
  ...
  implicit class `1093MutableBuilder`[Self <: `1093`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(
      value: RequestParameters & (Omit[UsersListPublicEmailsForAuthenticatedEndpoint, baseUrl | headers | mediaType])
