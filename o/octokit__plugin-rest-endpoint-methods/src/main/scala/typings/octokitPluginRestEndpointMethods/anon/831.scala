...
trait `831` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/artifacts/{artifact_id}/{archive_format}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `831` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `831`] (val x: Self) extends AnyVal {
