...
trait `848` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/runners/registration-token']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `848` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `848`] (val x: Self) extends AnyVal {
