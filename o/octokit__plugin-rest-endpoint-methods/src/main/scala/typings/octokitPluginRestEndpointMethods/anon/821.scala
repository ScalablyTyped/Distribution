...
object `821` {
  ...
  extension [Self <: `821`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ProjectsCreateCardEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
