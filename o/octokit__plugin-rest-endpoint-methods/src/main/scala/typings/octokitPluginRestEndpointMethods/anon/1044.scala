...
trait `1044` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/enterprises/{enterprise}/actions/permissions']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1044` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1044`] (val x: Self) extends AnyVal {
