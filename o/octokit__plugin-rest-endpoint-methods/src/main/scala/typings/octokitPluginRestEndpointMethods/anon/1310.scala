...
trait `1310` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1310` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1310`] (val x: Self) extends AnyVal {
