...
trait `1470` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1470` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1470`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1470`] (val x: Self) extends AnyVal {
