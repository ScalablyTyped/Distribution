...
object `1022` {
  ...
  extension [Self <: `1022`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[ReposUpdateCommitCommentEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
