...
trait `1359` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1359` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1359`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1359`] (val x: Self) extends AnyVal {
