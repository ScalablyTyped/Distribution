...
object `703` {
  ...
  extension [Self <: `703`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[GitGetBlobEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
