...
trait `900` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/secrets/public-key']['get'] */ js.Any
    ], 
...
object `900` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `900`] (val x: Self) extends AnyVal {
