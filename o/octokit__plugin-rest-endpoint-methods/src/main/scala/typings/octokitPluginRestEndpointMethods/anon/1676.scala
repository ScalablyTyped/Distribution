...
trait `1676` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/users/{username}/gpg_keys']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1676` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1676`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1676`] (val x: Self) extends AnyVal {
