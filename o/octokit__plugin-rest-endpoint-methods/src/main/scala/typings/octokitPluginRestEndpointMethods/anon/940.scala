...
trait `940` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/runs/{run_id}/rerun']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `940` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `940`] (val x: Self) extends AnyVal {
