...
trait `1120` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/dependabot/secrets/{secret_name}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1120` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1120`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1120`] (val x: Self) extends AnyVal {
