...
trait `863` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/runs/{run_id}/pending_deployments']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `863` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `863`] (val x: Self) extends AnyVal {
