...
trait `1542` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/teams/{team_slug}/projects/{project_id}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1542` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1542`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1542`] (val x: Self) extends AnyVal {
