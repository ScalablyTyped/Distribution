...
trait `965` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/required_workflows/{required_workflow_id}/repositories']['put'] */ js.Any
    ], 
...
object `965` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `965`] (val x: Self) extends AnyVal {
