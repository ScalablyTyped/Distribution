...
trait `778` extends js.Object {
  var parameters: RequestParameters with (Omit[OrgsGetMembershipEndpoint, baseUrl | headers | mediaType])
...
object `778` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[OrgsGetMembershipEndpoint, baseUrl | headers | mediaType]),
