...
trait `1147` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/custom_roles']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1147` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1147`]
  }
  
  extension [Self <: `1147`](x: Self) {
