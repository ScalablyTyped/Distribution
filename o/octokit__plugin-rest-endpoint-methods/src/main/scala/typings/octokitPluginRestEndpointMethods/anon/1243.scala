...
trait `1243` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/projects/{project_id}/collaborators/{username}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1243` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1243`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1243`] (val x: Self) extends AnyVal {
