...
object `695` {
  ...
  extension [Self <: `695`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[GistsUpdateEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
