...
object `732` {
  ...
  extension [Self <: `732`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[IssuesGetMilestoneEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
