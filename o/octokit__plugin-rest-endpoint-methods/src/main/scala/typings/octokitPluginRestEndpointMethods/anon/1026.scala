...
trait `1026` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[ReposUpdateReleaseEndpoint, baseUrl | headers | mediaType])
...
object `1026` {
  ...
  inline def apply(
    parameters: RequestParameters & (Omit[ReposUpdateReleaseEndpoint, baseUrl | headers | mediaType]),
  ...
  extension [Self <: `1026`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[ReposUpdateReleaseEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
