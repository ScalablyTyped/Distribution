...
object `1048` {
  ...
  extension [Self <: `1048`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[TeamsDeleteInOrgEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
