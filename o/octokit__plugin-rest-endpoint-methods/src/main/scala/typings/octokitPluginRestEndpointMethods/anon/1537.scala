...
trait `1537` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/commits/{commit_sha}/comments']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1537` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1537`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1537`] (val x: Self) extends AnyVal {
