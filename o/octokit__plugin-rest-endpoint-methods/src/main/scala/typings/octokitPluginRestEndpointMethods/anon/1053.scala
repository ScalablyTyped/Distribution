...
trait `1053` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/enterprises/{enterprise}/actions/permissions/organizations']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1053` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1053`] (val x: Self) extends AnyVal {
