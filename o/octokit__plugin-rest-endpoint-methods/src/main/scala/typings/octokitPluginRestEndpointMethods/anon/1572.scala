...
trait `1572` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/blocks/{username}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1572` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1572`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1572`] (val x: Self) extends AnyVal {
