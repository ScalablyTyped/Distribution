...
trait `1148` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/milestones/{milestone_number}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1148` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1148`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1148`] (val x: Self) extends AnyVal {
