...
trait `1084` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[UsersListEndpoint, baseUrl | headers | mediaType])
...
object `1084` {
  ...
  inline def apply(
    parameters: RequestParameters & (Omit[UsersListEndpoint, baseUrl | headers | mediaType]),
  ...
  extension [Self <: `1084`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[UsersListEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
