...
trait `1402` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/releases/assets/{asset_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1402` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1402`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1402`] (val x: Self) extends AnyVal {
