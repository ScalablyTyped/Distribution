...
trait `1213` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/blocks/{username}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1213` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1213`] (val x: Self) extends AnyVal {
