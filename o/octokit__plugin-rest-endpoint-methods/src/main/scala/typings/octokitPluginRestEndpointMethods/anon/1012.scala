...
trait `1012` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/code-scanning/analyses/{analysis_id}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1012` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1012`] (val x: Self) extends AnyVal {
