...
trait CancelImport extends js.Object {
  /**
    ...
    */
  @JSName("cancelImport")
  var cancelImport_Original: `199` = js.native
  /**
  ...
  var deleteArchiveForAuthenticatedUser_Original: `200` = js.native
  /**
    * Deletes a previous migration archive. Migration archives are automatically deleted after seven days.
    */
  @JSName("deleteArchiveForOrg")
  var deleteArchiveForOrg_Original: `201` = js.native
  /**
    * Fetches the URL to a migration archive.
    */
  @JSName("downloadArchiveForOrg")
  var downloadArchiveForOrg_Original: `202` = js.native
  /**
  ...
  var getArchiveForAuthenticatedUser_Original: `203` = js.native
  /**
  ...
  var getCommitAuthors_Original: `204` = js.native
  /**
  ...
  var getImportProgress_Original: `205` = js.native
  /**
    * View the progress of an import.
    *
    * **Import status**
  ...
  var getImportStatus_Original: `205` = js.native
  /**
    * List files larger than 100MB found during the import
    */
  @JSName("getLargeFiles")
  var getLargeFiles_Original: `206` = js.native
  /**
  ...
  var getStatusForAuthenticatedUser_Original: `207` = js.native
  /**
  ...
  var getStatusForOrg_Original: `208` = js.native
  /**
    * Lists all migrations a user has started.
    */
  @JSName("listForAuthenticatedUser")
  var listForAuthenticatedUser_Original: `209` = js.native
  /**
    * Lists the most recent migrations.
    */
  @JSName("listForOrg")
  var listForOrg_Original: `210` = js.native
  /**
    * List all the repositories for this organization migration.
    */
  @JSName("listReposForOrg")
  var listReposForOrg_Original: `211` = js.native
  /**
    * Lists all the repositories for this user migration.
    */
  @JSName("listReposForUser")
  var listReposForUser_Original: `212` = js.native
  /**
    * Update an author's identity for the import. Your application can continue updating authors any time before you push new commits to the repository.
    */
  @JSName("mapCommitAuthor")
  var mapCommitAuthor_Original: `213` = js.native
  /**
    * You can import repositories from Subversion, Mercurial, and TFS that include files larger than 100MB. This ability is powered by [Git LFS](https://git-lfs.github.com). You can learn more about our LFS feature and working with large files [on our help site](https://help.github.com/articles/versioning-large-files/).
    */
  @JSName("setLfsPreference")
  var setLfsPreference_Original: `214` = js.native
  /**
    * Initiates the generation of a user migration archive.
    */
  @JSName("startForAuthenticatedUser")
  var startForAuthenticatedUser_Original: `215` = js.native
  /**
    * Initiates the generation of a migration archive.
    */
  @JSName("startForOrg")
  var startForOrg_Original: `216` = js.native
  /**
    * Start a source import to a GitHub repository using GitHub Importer.
    */
  @JSName("startImport")
  var startImport_Original: `217` = js.native
  /**
  ...
  var unlockRepoForAuthenticatedUser_Original: `218` = js.native
  /**
  ...
  var unlockRepoForOrg_Original: `219` = js.native
  /**
    ...
    */
  @JSName("updateImport")
  var updateImport_Original: `220` = js.native
  /**
    * Stop an import for a repository.
    */
  ...
  def listReposForUser(): js.Promise[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/types.@octokit/types/dist-types/generated/Endpoints.Endpoints['GET /user/:migration_id/repositories']['response'] */ js.Any
  ] = js.native
  def listReposForUser(
    params: RequestParameters with (Omit[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/types.@octokit/types/dist-types/generated/Endpoints.Endpoints['GET /user/:migration_id/repositories']['parameters'] */ js.Any, 
      baseUrl | headers | mediaType
    ])
  ): js.Promise[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/types.@octokit/types/dist-types/generated/Endpoints.Endpoints['GET /user/:migration_id/repositories']['response'] */ js.Any
