...
trait `1612` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/security-advisories/reports']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1612` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1612`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1612`] (val x: Self) extends AnyVal {
