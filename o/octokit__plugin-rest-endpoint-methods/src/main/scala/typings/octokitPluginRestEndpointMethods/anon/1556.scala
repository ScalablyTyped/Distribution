...
trait `1556` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/commits/{commit_sha}/pulls']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1556` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1556`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1556`] (val x: Self) extends AnyVal {
