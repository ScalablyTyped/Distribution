...
trait `1189` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/issues/{issue_number}/comments']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1189` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1189`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1189`] (val x: Self) extends AnyVal {
