...
object `972` {
  ...
  implicit class `972MutableBuilder`[Self <: `972`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(value: RequestParameters & (Omit[ReposGetTopPathsEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
