...
object `734` {
  ...
  extension [Self <: `734`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[IssuesListAssigneesEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
