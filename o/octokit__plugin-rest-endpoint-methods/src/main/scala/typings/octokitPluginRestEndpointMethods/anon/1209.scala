...
trait `1209` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/public_members/{username}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1209` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1209`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1209`] (val x: Self) extends AnyVal {
