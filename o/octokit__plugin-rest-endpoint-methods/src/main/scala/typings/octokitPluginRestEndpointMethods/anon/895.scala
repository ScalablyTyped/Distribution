...
trait `895` extends js.Object {
  var parameters: RequestParameters with (Omit[ReposCreateStatusEndpoint, baseUrl | headers | mediaType])
...
object `895` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[ReposCreateStatusEndpoint, baseUrl | headers | mediaType]),
