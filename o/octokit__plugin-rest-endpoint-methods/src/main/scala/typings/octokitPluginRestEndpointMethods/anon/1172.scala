...
trait `1172` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/git/refs/{ref}']['patch'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1172` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1172`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1172`] (val x: Self) extends AnyVal {
