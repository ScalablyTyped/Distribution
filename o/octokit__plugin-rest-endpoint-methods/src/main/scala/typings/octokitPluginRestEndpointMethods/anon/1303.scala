...
trait `1303` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/comments/{comment_id}/reactions/{reaction_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1303` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1303`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1303`] (val x: Self) extends AnyVal {
