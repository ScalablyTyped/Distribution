...
trait `847` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/variables']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `847` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `847`] (val x: Self) extends AnyVal {
