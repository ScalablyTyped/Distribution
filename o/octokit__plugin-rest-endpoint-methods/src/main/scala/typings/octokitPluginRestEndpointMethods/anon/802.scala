...
object `802` {
  ...
  extension [Self <: `802`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[OrgsListInvitationTeamsEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
