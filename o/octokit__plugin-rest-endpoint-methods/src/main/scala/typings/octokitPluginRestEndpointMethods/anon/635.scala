...
object `635` {
  ...
  extension [Self <: `635`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[AppsGetUserInstallationEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
