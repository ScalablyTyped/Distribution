...
trait `1134` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/interaction-limits']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1134` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1134`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1134`] (val x: Self) extends AnyVal {
