...
object `1043` {
  ...
  extension [Self <: `1043`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[TeamsCreateEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
