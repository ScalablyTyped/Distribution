...
trait `1594` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/rulesets/{ruleset_id}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1594` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1594`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1594`] (val x: Self) extends AnyVal {
