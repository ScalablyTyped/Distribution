...
trait `920` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/organization-secrets']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `920` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `920`] (val x: Self) extends AnyVal {
