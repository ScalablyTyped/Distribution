...
object `746` {
  ...
  extension [Self <: `746`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[IssuesListMilestonesEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
