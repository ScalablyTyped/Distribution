...
trait `1278` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions/{reaction_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
