...
trait `1278` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/packages/{package_type}/{package_name}/versions/{package_version_id}/restore']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1278` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1278`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1278`] (val x: Self) extends AnyVal {
