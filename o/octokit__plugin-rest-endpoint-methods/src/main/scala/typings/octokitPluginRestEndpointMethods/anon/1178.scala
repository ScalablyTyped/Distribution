...
trait `1178` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/custom_roles/{role_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1178` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1178`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1178`] (val x: Self) extends AnyVal {
