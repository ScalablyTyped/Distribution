...
trait `861` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repositories/{repository_id}/environments/{environment_name}/variables/{name}']['delete'] */ js.Any
    ], 
...
object `861` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `861`] (val x: Self) extends AnyVal {
