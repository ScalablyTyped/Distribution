...
trait `1414` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/releases/assets/{asset_id}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1414` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1414`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1414`] (val x: Self) extends AnyVal {
