...
object `799` {
  ...
  extension [Self <: `799`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[OrgsListBlockedUsersEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
