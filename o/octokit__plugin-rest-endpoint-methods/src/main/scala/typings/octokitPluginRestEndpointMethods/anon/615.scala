...
object `615` {
  ...
  extension [Self <: `615`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ActivityMarkThreadAsReadEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
