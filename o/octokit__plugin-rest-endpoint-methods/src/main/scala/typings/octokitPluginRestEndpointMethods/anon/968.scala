...
trait `968` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repositories/{repository_id}/environments/{environment_name}/variables/{name}']['patch'] */ js.Any
    ], 
...
object `968` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `968`] (val x: Self) extends AnyVal {
