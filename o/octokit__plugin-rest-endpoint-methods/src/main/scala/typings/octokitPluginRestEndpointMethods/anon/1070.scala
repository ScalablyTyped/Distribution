...
trait `1070` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/codespaces/secrets/{secret_name}/repositories/{repository_id}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1070` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1070`] (val x: Self) extends AnyVal {
