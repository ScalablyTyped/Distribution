...
object `989` {
  ...
  extension [Self <: `989`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ReposListForOrgEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
