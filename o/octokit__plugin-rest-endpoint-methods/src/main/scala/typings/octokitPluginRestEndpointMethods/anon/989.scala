...
trait `989` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/organizations/{org}/codespaces/secrets/{secret_name}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `989` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `989`] (val x: Self) extends AnyVal {
