...
object `1060` {
  ...
  extension [Self <: `1060`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[TeamsListProjectsInOrgEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
