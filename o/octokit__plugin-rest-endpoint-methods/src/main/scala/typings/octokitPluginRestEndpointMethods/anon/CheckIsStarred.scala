...
trait CheckIsStarred extends StObject {
  ...
  var checkIsStarred_Original: `293`
  ...
  var createComment_Original: `295`
  ...
  var deleteComment_Original: `297`
  
  @JSName("delete")
  var delete_Original: `296`
  ...
  @JSName("getRevision")
  var getRevision_Original: `301`
  
  @JSName("get")
  var get_Original: `299`
  ...
  /**
    ...
    */
  @JSName("listStarred")
  var listStarred_Original: `308`
  
  /**
    * Lists the authenticated user's gists or if called anonymously, this endpoint returns all public gists:
    */
  @JSName("list")
  var list_Original: `302`
  ...
  var updateComment_Original: `312`
  
  /**
    * Allows you to update a gist's description and to update, delete, or rename gist files. Files from the previous version of the gist that aren't explicitly changed during an edit are unchanged.
    */
  @JSName("update")
  var update_Original: `311`
}
object CheckIsStarred {
  ...
  implicit open class MutableBuilder[Self <: CheckIsStarred] (val x: Self) extends AnyVal {
    ...
    inline def setCheckIsStarred(value: `293`): Self = StObject.set(x, "checkIsStarred", value.asInstanceOf[js.Any])
    
    inline def setCreate(value: `294`): Self = StObject.set(x, "create", value.asInstanceOf[js.Any])
    
    inline def setCreateComment(value: `295`): Self = StObject.set(x, "createComment", value.asInstanceOf[js.Any])
    
    inline def setDelete(value: `296`): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
    
    inline def setDeleteComment(value: `297`): Self = StObject.set(x, "deleteComment", value.asInstanceOf[js.Any])
    
    inline def setFork(value: `298`): Self = StObject.set(x, "fork", value.asInstanceOf[js.Any])
    
    inline def setGet(value: `299`): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setGetComment(value: `300`): Self = StObject.set(x, "getComment", value.asInstanceOf[js.Any])
    
    inline def setGetRevision(value: `301`): Self = StObject.set(x, "getRevision", value.asInstanceOf[js.Any])
    
    inline def setList(value: `302`): Self = StObject.set(x, "list", value.asInstanceOf[js.Any])
    
    inline def setListComments(value: `303`): Self = StObject.set(x, "listComments", value.asInstanceOf[js.Any])
    
    inline def setListCommits(value: `304`): Self = StObject.set(x, "listCommits", value.asInstanceOf[js.Any])
    
    inline def setListForUser(value: `305`): Self = StObject.set(x, "listForUser", value.asInstanceOf[js.Any])
    
    inline def setListForks(value: `306`): Self = StObject.set(x, "listForks", value.asInstanceOf[js.Any])
    
    inline def setListPublic(value: `307`): Self = StObject.set(x, "listPublic", value.asInstanceOf[js.Any])
    
    inline def setListStarred(value: `308`): Self = StObject.set(x, "listStarred", value.asInstanceOf[js.Any])
    
    inline def setStar(value: `309`): Self = StObject.set(x, "star", value.asInstanceOf[js.Any])
    
    inline def setUnstar(value: `310`): Self = StObject.set(x, "unstar", value.asInstanceOf[js.Any])
    
    inline def setUpdate(value: `311`): Self = StObject.set(x, "update", value.asInstanceOf[js.Any])
    
    inline def setUpdateComment(value: `312`): Self = StObject.set(x, "updateComment", value.asInstanceOf[js.Any])
  }
}
