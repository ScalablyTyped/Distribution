...
trait `892` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/permissions/workflow']['get'] */ js.Any
    ], 
...
object `892` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `892`] (val x: Self) extends AnyVal {
