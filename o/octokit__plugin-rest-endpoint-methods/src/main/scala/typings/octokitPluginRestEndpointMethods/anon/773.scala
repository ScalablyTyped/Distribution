...
trait `773` extends js.Object {
  var parameters: RequestParameters with (Omit[OrgsCreateHookEndpoint, baseUrl | headers | mediaType])
...
object `773` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[OrgsCreateHookEndpoint, baseUrl | headers | mediaType]),
