...
object `915` {
  ...
  extension [Self <: `915`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[ReposCreateWebhookEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
