...
trait `971` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/required_workflows/{required_workflow_id}']['patch'] */ js.Any
    ], 
...
object `971` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `971`] (val x: Self) extends AnyVal {
