...
trait `1267` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/users/{username}/packages/{package_type}/{package_name}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1267` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1267`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1267`] (val x: Self) extends AnyVal {
