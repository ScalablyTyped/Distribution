...
trait `562` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[ActionsGetJobForWorkflowRunEndpoint, baseUrl | headers | mediaType])
...
object `562` {
  ...
  inline def apply(
    parameters: RequestParameters & (Omit[ActionsGetJobForWorkflowRunEndpoint, baseUrl | headers | mediaType]),
  ...
  extension [Self <: `562`](x: Self) {
    
    inline def setParameters(
      value: RequestParameters & (Omit[ActionsGetJobForWorkflowRunEndpoint, baseUrl | headers | mediaType])
