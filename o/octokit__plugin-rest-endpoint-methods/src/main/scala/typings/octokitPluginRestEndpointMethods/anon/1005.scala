...
trait `1005` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[ReposRemoveAppAccessRestrictionsEndpoint, baseUrl | headers | mediaType])
...
object `1005` {
  ...
  @scala.inline
  def apply(
    parameters: RequestParameters & (Omit[ReposRemoveAppAccessRestrictionsEndpoint, baseUrl | headers | mediaType]),
  ...
  implicit class `1005MutableBuilder`[Self <: `1005`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParameters(
      value: RequestParameters & (Omit[ReposRemoveAppAccessRestrictionsEndpoint, baseUrl | headers | mediaType])
