...
object `961` {
  ...
  extension [Self <: `961`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[ReposGetPagesEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
