...
trait `1001` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/starred/{owner}/{repo}']['put'] */ js.Any
    ], 
...
object `1001` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1001`] (val x: Self) extends AnyVal {
