...
trait `1063` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/code-scanning/codeql/databases']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1063` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1063`] (val x: Self) extends AnyVal {
