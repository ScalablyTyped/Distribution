...
object `1063` {
  ...
  extension [Self <: `1063`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[TeamsRemoveProjectInOrgEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
