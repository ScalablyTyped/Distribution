...
trait `1143` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/emojis']['get'] */ js.Any
    ], 
...
object `1143` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1143`] (val x: Self) extends AnyVal {
