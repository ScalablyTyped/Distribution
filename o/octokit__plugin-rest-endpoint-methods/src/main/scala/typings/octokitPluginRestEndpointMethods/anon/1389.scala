...
trait `1389` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1389` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1389`]
  }
  
  extension [Self <: `1389`](x: Self) {
