...
trait `964` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/variables/{name}/repositories']['put'] */ js.Any
    ], 
...
object `964` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `964`] (val x: Self) extends AnyVal {
