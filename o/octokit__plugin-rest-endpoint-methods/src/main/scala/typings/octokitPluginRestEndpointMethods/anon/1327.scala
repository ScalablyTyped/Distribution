...
trait `1327` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}/events']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1327` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1327`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1327`] (val x: Self) extends AnyVal {
