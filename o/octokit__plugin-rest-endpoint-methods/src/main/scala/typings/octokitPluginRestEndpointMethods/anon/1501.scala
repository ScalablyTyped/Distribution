...
trait `1501` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}']['patch'] */ js.Any
    ]) & RequiredPreview[Any], 
