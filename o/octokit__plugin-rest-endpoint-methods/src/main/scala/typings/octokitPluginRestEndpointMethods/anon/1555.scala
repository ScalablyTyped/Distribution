...
trait `1555` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/teams/{team_slug}/memberships/{username}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1555` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1555`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1555`] (val x: Self) extends AnyVal {
