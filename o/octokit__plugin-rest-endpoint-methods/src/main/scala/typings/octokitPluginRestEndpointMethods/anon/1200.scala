...
trait `1200` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/migrations/{migration_id}/repositories']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
