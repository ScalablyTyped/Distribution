...
object `575` {
  ...
  extension [Self <: `575`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ActionsListOrgSecretsEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setResponse(value: OctokitResponse[ActionsListOrgSecretsResponseData]): Self = StObject.set(x, "response", value.asInstanceOf[js.Any])
  }
}
