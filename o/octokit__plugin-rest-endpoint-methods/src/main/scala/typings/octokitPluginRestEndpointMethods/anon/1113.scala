...
trait `1113` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/codespaces/{codespace_name}/start']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1113` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1113`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1113`] (val x: Self) extends AnyVal {
