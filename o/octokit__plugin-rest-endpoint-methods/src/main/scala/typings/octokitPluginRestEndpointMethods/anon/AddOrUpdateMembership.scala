...
trait AddOrUpdateMembership extends js.Object {
  ...
  @JSName("blockUser")
  var blockUser_Original: `222` = js.native
  /**
  ...
  var checkBlockedUser_Original: `223` = js.native
  /**
  ...
  var getMembershipForAuthenticatedUser_Original: `234` = js.native
  /**
  ...
  var listInvitationTeams_Original: `241` = js.native
  /**
  ...
  var listOutsideCollaborators_Original: `244` = js.native
  /**
    * The return hash contains a `role` field which refers to the Organization Invitation role and will be one of the following values: `direct_member`, `admin`, `billing_manager`, `hiring_manager`, or `reinstate`. If the invitee is not a GitHub member, the `login` field in the return hash will be `null`.
    */
  @JSName("listPendingInvitations")
  var listPendingInvitations_Original: `245` = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("removeMember")
  var removeMember_Original: `249` = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("update")
  var update_Original: `253` = js.native
  /**
    * Only authenticated organization owners can add a member to the organization or update the member's role.
    *
    * *   If the authenticated user is _adding_ a member to the organization, the invited user will receive an email inviting them to the organization. The user's [membership status](https://developer.github.com/v3/orgs/members/#get-organization-membership-for-a-user) will be `pending` until they accept the invitation.
