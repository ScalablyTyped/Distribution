...
trait AcceptInvitation extends js.Object {
  ...
  var addCollaborator_Original: `329` = js.native
  /**
    * Here's how you can create a read-only deploy key:
    */
  @JSName("addDeployKey")
  var addDeployKey_Original: `330` = js.native
  /**
  ...
  var addProtectedBranchAdminEnforcement_Original: `331` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var addProtectedBranchAppRestrictions_Original: `332` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var createDeploymentStatus_Original: `342` = js.native
  /**
  ...
  var createDeployment_Original: `341` = js.native
  /**
  ...
  var createDispatchEvent_Original: `343` = js.native
  /**
  ...
  var createForAuthenticatedUser_Original: `344` = js.native
  /**
    ...
    */
  @JSName("createFork")
  var createFork_Original: `345` = js.native
  /**
    ...
    */
  @JSName("createHook")
  var createHook_Original: `346` = js.native
  /**
    ...
    */
  @JSName("createInOrg")
  var createInOrg_Original: `347` = js.native
  /**
    * Creates a new file or updates an existing file in a repository.
    */
  @JSName("createOrUpdateFile")
  var createOrUpdateFile_Original: `348` = js.native
  /**
  ...
  var createRelease_Original: `349` = js.native
  /**
    ...
    */
  @JSName("createStatus")
  var createStatus_Original: `350` = js.native
  /**
  ...
  var createUsingTemplate_Original: `351` = js.native
  @JSName("declineInvitation")
  var declineInvitation_Original: `352` = js.native
  @JSName("deleteCommitComment")
  var deleteCommitComment_Original: `354` = js.native
  /**
  ...
  var deleteDeployment_Original: `355` = js.native
  @JSName("deleteDownload")
  var deleteDownload_Original: `356` = js.native
  /**
    ...
    */
  @JSName("deleteFile")
  var deleteFile_Original: `357` = js.native
  @JSName("deleteHook")
  var deleteHook_Original: `358` = js.native
  @JSName("deleteInvitation")
  var deleteInvitation_Original: `359` = js.native
  @JSName("deleteReleaseAsset")
  var deleteReleaseAsset_Original: `361` = js.native
  /**
    * Users with push access to the repository can delete a release.
    */
  @JSName("deleteRelease")
  var deleteRelease_Original: `360` = js.native
  /**
    ...
    */
  @JSName("delete")
  var delete_Original: `353` = js.native
  /**
  ...
  var disableAutomatedSecurityFixes_Original: `362` = js.native
  @JSName("disablePagesSite")
  var disablePagesSite_Original: `363` = js.native
  /**
  ...
  var disableVulnerabilityAlerts_Original: `364` = js.native
  /**
  ...
  var enableAutomatedSecurityFixes_Original: `365` = js.native
  @JSName("enablePagesSite")
  var enablePagesSite_Original: `366` = js.native
  /**
  ...
  var enableVulnerabilityAlerts_Original: `367` = js.native
  @JSName("getAllTopics")
  var getAllTopics_Original: `369` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var getAppsWithAccessToProtectedBranch_Original: `370` = js.native
  /**
  ...
  var getArchiveLink_Original: `371` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("getBranchProtection")
  var getBranchProtection_Original: `373` = js.native
  @JSName("getBranch")
  var getBranch_Original: `372` = js.native
  /**
    * Get the total number of clones and breakdown per day or week for the last 14 days. Timestamps are aligned to UTC midnight of the beginning of the day or week. Week begins on Monday.
    */
  @JSName("getClones")
  var getClones_Original: `374` = js.native
  /**
    * Returns a weekly aggregate of the number of additions and deletions pushed to a repository.
    */
  @JSName("getCodeFrequencyStats")
  var getCodeFrequencyStats_Original: `375` = js.native
  /**
    * Checks the repository permission of a collaborator. The possible repository permissions are `admin`, `write`, `read`, and `none`.
    */
  @JSName("getCollaboratorPermissionLevel")
  var getCollaboratorPermissionLevel_Original: `376` = js.native
  /**
  ...
  var getCombinedStatusForRef_Original: `377` = js.native
  /**
    * Returns the last year of commit activity grouped by week. The `days` array is a group of commits per day, starting on `Sunday`.
    */
  @JSName("getCommitActivityStats")
  var getCommitActivityStats_Original: `379` = js.native
  @JSName("getCommitComment")
  var getCommitComment_Original: `380` = js.native
  /**
    ...
    */
  @JSName("getCommit")
  var getCommit_Original: `378` = js.native
  /**
    ...
    */
  @JSName("getContents")
  var getContents_Original: `381` = js.native
  /**
  ...
  var getContributorsStats_Original: `382` = js.native
  @JSName("getDeployKey")
  var getDeployKey_Original: `383` = js.native
  /**
    * Users with pull access can view a deployment status for a deployment:
    */
  @JSName("getDeploymentStatus")
  var getDeploymentStatus_Original: `385` = js.native
  @JSName("getDeployment")
  var getDeployment_Original: `384` = js.native
  @JSName("getDownload")
  var getDownload_Original: `386` = js.native
  @JSName("getHook")
  var getHook_Original: `387` = js.native
  @JSName("getLatestPagesBuild")
  var getLatestPagesBuild_Original: `388` = js.native
  /**
  ...
  var getLatestRelease_Original: `389` = js.native
  @JSName("getPagesBuild")
  var getPagesBuild_Original: `391` = js.native
  @JSName("getPages")
  var getPages_Original: `390` = js.native
  /**
  ...
  var getParticipationStats_Original: `392` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("getProtectedBranchAdminEnforcement")
  var getProtectedBranchAdminEnforcement_Original: `393` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("getProtectedBranchPullRequestReviewEnforcement")
  var getProtectedBranchPullRequestReviewEnforcement_Original: `394` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var getProtectedBranchRequiredSignatures_Original: `395` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("getProtectedBranchRequiredStatusChecks")
  var getProtectedBranchRequiredStatusChecks_Original: `396` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var getProtectedBranchRestrictions_Original: `397` = js.native
  /**
  ...
  var getPunchCardStats_Original: `398` = js.native
  /**
    ...
    */
  @JSName("getReadme")
  var getReadme_Original: `399` = js.native
  /**
  ...
  var getReleaseAsset_Original: `401` = js.native
  /**
    * Get a published release with the specified tag.
    */
  @JSName("getReleaseByTag")
  var getReleaseByTag_Original: `402` = js.native
  /**
    * **Note:** This returns an `upload_url` key corresponding to the endpoint for uploading release assets. This key is a [hypermedia resource](https://developer.github.com/v3/#hypermedia).
    */
  @JSName("getRelease")
  var getRelease_Original: `400` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var getTeamsWithAccessToProtectedBranch_Original: `403` = js.native
  /**
    * Get the top 10 popular contents over the last 14 days.
    */
  @JSName("getTopPaths")
  var getTopPaths_Original: `404` = js.native
  /**
    * Get the top 10 referrers over the last 14 days.
    */
  @JSName("getTopReferrers")
  var getTopReferrers_Original: `405` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var getUsersWithAccessToProtectedBranch_Original: `406` = js.native
  /**
    * Get the total number of views and breakdown per day or week for the last 14 days. Timestamps are aligned to UTC midnight of the beginning of the day or week. Week begins on Monday.
    */
  @JSName("getViews")
  var getViews_Original: `407` = js.native
  /**
    ...
    */
  @JSName("get")
  var get_Original: `368` = js.native
  @JSName("listAssetsForRelease")
  var listAssetsForRelease_Original: `409` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var listBranchesForHeadCommit_Original: `411` = js.native
  @JSName("listBranches")
  var listBranches_Original: `410` = js.native
  /**
    * For organization-owned repositories, the list of collaborators includes outside collaborators, organization members that are direct collaborators, organization members with access through team memberships, organization members with access through default organization permissions, and organization owners.
    *
    * Team members will include the members of child teams.
  ...
  var listCollaborators_Original: `412` = js.native
  /**
    * Use the `:commit_sha` to specify the commit that will have its comments listed.
    */
  @JSName("listCommentsForCommit")
  var listCommentsForCommit_Original: `413` = js.native
  /**
  ...
  var listCommitComments_Original: `414` = js.native
  /**
    * **Signature verification object**
    *
    * The response will include a `verification` object that describes the result of verifying the commit's signature. The following fields are included in the `verification` object:
    ...
    */
  @JSName("listCommits")
  var listCommits_Original: `415` = js.native
  /**
  ...
  var listContributors_Original: `416` = js.native
  @JSName("listDeployKeys")
  var listDeployKeys_Original: `417` = js.native
  /**
    * Users with pull access can view deployment statuses for a deployment:
    */
  @JSName("listDeploymentStatuses")
  var listDeploymentStatuses_Original: `418` = js.native
  /**
    * Simple filtering of deployments is available via query parameters:
    */
  @JSName("listDeployments")
  var listDeployments_Original: `419` = js.native
  @JSName("listDownloads")
  var listDownloads_Original: `420` = js.native
  /**
  ...
  var listForAuthenticatedUser_Original: `408` = js.native
  /**
    * Lists repositories for the specified organization.
    */
  @JSName("listForOrg")
  var listForOrg_Original: `421` = js.native
  /**
    * Lists public repositories for the specified user.
    */
  @JSName("listForUser")
  var listForUser_Original: `422` = js.native
  @JSName("listForks")
  var listForks_Original: `423` = js.native
  @JSName("listHooks")
  var listHooks_Original: `424` = js.native
  /**
    * When authenticating as a user, this endpoint will list all currently open repository invitations for that user.
    */
  @JSName("listInvitationsForAuthenticatedUser")
  var listInvitationsForAuthenticatedUser_Original: `426` = js.native
  /**
    * When authenticating as a user with admin rights to a repository, this endpoint will list all currently open repository invitations.
    */
  @JSName("listInvitations")
  var listInvitations_Original: `425` = js.native
  /**
    * Lists languages for the specified repository. The value shown for each language is the number of bytes of code written in that language.
    */
  @JSName("listLanguages")
  var listLanguages_Original: `427` = js.native
  @JSName("listPagesBuilds")
  var listPagesBuilds_Original: `428` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("listProtectedBranchRequiredStatusChecksContexts")
  var listProtectedBranchRequiredStatusChecksContexts_Original: `429` = js.native
  /**
    ...
    */
  @JSName("listPublic")
  var listPublic_Original: `430` = js.native
  /**
  ...
  var listPullRequestsAssociatedWithCommit_Original: `431` = js.native
  /**
    ...
    */
  @JSName("listReleases")
  var listReleases_Original: `432` = js.native
  /**
  ...
  var listStatusesForRef_Original: `433` = js.native
  @JSName("listTags")
  var listTags_Original: `434` = js.native
  @JSName("listTeams")
  var listTeams_Original: `435` = js.native
  /**
    * @deprecated octokit.repos.listTopics() has been renamed to octokit.repos.getAllTopics() (2020-03-04)
    */
  @JSName("listTopics")
  var listTopics_Original: `369` = js.native
  /**
    * Lists repositories that the authenticated user has explicit permission (`:read`, `:write`, or `:admin`) to access.
    *
    * The authenticated user has explicit permission to access repositories they own, repositories where they are a collaborator, and repositories that they can access through an organization membership.
    ...
    */
  @JSName("list")
  var list_Original: `408` = js.native
  @JSName("merge")
  var merge_Original: `436` = js.native
  /**
    * This will trigger a [ping event](https://developer.github.com/webhooks/#ping-event) to be sent to the hook.
    */
  @JSName("pingHook")
  var pingHook_Original: `437` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("removeBranchProtection")
  var removeBranchProtection_Original: `438` = js.native
  @JSName("removeCollaborator")
  var removeCollaborator_Original: `439` = js.native
  @JSName("removeDeployKey")
  var removeDeployKey_Original: `440` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchAdminEnforcement_Original: `441` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchAppRestrictions_Original: `442` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("removeProtectedBranchPullRequestReviewEnforcement")
  var removeProtectedBranchPullRequestReviewEnforcement_Original: `443` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchRequiredSignatures_Original: `444` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("removeProtectedBranchRequiredStatusChecksContexts")
  var removeProtectedBranchRequiredStatusChecksContexts_Original: `446` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("removeProtectedBranchRequiredStatusChecks")
  var removeProtectedBranchRequiredStatusChecks_Original: `445` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchRestrictions_Original: `447` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchTeamRestrictions_Original: `448` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeProtectedBranchUserRestrictions_Original: `449` = js.native
  @JSName("replaceAllTopics")
  var replaceAllTopics_Original: `450` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var replaceProtectedBranchAppRestrictions_Original: `451` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    */
  @JSName("replaceProtectedBranchRequiredStatusChecksContexts")
  var replaceProtectedBranchRequiredStatusChecksContexts_Original: `452` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var replaceProtectedBranchTeamRestrictions_Original: `453` = js.native
  /**
    * Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var requestPageBuild_Original: `455` = js.native
  /**
  ...
  var retrieveCommunityProfileMetrics_Original: `456` = js.native
  /**
