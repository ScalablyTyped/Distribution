...
trait `885` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repositories/{repository_id}/environments/{environment_name}/secrets/{secret_name}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `885` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `885`] (val x: Self) extends AnyVal {
