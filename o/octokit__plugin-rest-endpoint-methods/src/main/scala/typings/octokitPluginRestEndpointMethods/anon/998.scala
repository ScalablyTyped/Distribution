...
trait `998` extends js.Object {
  var parameters: RequestParameters with (Omit[ReposReplaceProtectedBranchTeamRestrictionsEndpoint, baseUrl | headers | mediaType])
...
object `998` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[ReposReplaceProtectedBranchTeamRestrictionsEndpoint, baseUrl | headers | mediaType]),
