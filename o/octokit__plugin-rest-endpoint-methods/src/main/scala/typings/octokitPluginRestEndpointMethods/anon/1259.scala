...
trait `1259` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/packages/{package_type}/{package_name}/versions/{package_version_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1259` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1259`] (val x: Self) extends AnyVal {
