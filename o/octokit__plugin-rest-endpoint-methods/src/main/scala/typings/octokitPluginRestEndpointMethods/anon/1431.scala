...
trait `1431` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/deployments/{deployment_id}/statuses']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1431` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1431`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1431`] (val x: Self) extends AnyVal {
