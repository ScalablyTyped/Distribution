...
trait `868` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/enterprises/{enterprise}/actions/permissions/workflow']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `868` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `868`] (val x: Self) extends AnyVal {
