...
trait GetGithubActionsBillingOrg extends StObject {
  ...
  var getGithubActionsBillingOrg_Original: `185`
  ...
  var getGithubActionsBillingUser_Original: `186`
  ...
  var getGithubPackagesBillingOrg_Original: `187`
  ...
  var getGithubPackagesBillingUser_Original: `188`
  ...
  var getSharedStorageBillingOrg_Original: `189`
  ...
  var getSharedStorageBillingUser_Original: `190`
}
object GetGithubActionsBillingOrg {
  
  inline def apply(
    getGithubActionsBillingOrg: `185`,
    getGithubActionsBillingUser: `186`,
    getGithubPackagesBillingOrg: `187`,
    getGithubPackagesBillingUser: `188`,
    getSharedStorageBillingOrg: `189`,
    getSharedStorageBillingUser: `190`
  ...
  implicit open class MutableBuilder[Self <: GetGithubActionsBillingOrg] (val x: Self) extends AnyVal {
    ...
    inline def setGetGithubActionsBillingOrg(value: `185`): Self = StObject.set(x, "getGithubActionsBillingOrg", value.asInstanceOf[js.Any])
    
    inline def setGetGithubActionsBillingUser(value: `186`): Self = StObject.set(x, "getGithubActionsBillingUser", value.asInstanceOf[js.Any])
    
    inline def setGetGithubPackagesBillingOrg(value: `187`): Self = StObject.set(x, "getGithubPackagesBillingOrg", value.asInstanceOf[js.Any])
    
    inline def setGetGithubPackagesBillingUser(value: `188`): Self = StObject.set(x, "getGithubPackagesBillingUser", value.asInstanceOf[js.Any])
    
    inline def setGetSharedStorageBillingOrg(value: `189`): Self = StObject.set(x, "getSharedStorageBillingOrg", value.asInstanceOf[js.Any])
    
    inline def setGetSharedStorageBillingUser(value: `190`): Self = StObject.set(x, "getSharedStorageBillingUser", value.asInstanceOf[js.Any])
  }
}
