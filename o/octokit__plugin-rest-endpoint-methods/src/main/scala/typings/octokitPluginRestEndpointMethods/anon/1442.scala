...
trait `1442` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/rulesets']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1442` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1442`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1442`] (val x: Self) extends AnyVal {
