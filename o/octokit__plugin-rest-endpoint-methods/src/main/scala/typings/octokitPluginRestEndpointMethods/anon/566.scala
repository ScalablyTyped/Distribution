...
object `566` {
  ...
  extension [Self <: `566`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ActionsGetRepoSecretEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
