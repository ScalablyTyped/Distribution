...
trait AddSelectedRepoToOrgSecret extends StObject {
  ...
  var addSelectedRepoToOrgSecret_Original: `222`
  ...
  var createOrUpdateOrgSecret_Original: `223`
  ...
  var createOrUpdateRepoSecret_Original: `224`
  ...
  var deleteOrgSecret_Original: `225`
  ...
  var deleteRepoSecret_Original: `226`
  ...
  var getOrgPublicKey_Original: `227`
  ...
  var getRepoPublicKey_Original: `229`
  ...
  var getRepoSecret_Original: `230`
  ...
  var listOrgSecrets_Original: `231`
  ...
  var listRepoSecrets_Original: `232`
  ...
  var listSelectedReposForOrgSecret_Original: `233`
  ...
  var removeSelectedRepoFromOrgSecret_Original: `234`
  ...
  var setSelectedReposForOrgSecret_Original: `235`
}
object AddSelectedRepoToOrgSecret {
  
  inline def apply(
    addSelectedRepoToOrgSecret: `222`,
    createOrUpdateOrgSecret: `223`,
    createOrUpdateRepoSecret: `224`,
    deleteOrgSecret: `225`,
    deleteRepoSecret: `226`,
    getOrgPublicKey: `227`,
    getOrgSecret: `228`,
    getRepoPublicKey: `229`,
    getRepoSecret: `230`,
    listOrgSecrets: `231`,
    listRepoSecrets: `232`,
    listSelectedReposForOrgSecret: `233`,
    removeSelectedRepoFromOrgSecret: `234`,
    setSelectedReposForOrgSecret: `235`
  ): AddSelectedRepoToOrgSecret = {
    val __obj = js.Dynamic.literal(addSelectedRepoToOrgSecret = addSelectedRepoToOrgSecret.asInstanceOf[js.Any], createOrUpdateOrgSecret = createOrUpdateOrgSecret.asInstanceOf[js.Any], createOrUpdateRepoSecret = createOrUpdateRepoSecret.asInstanceOf[js.Any], deleteOrgSecret = deleteOrgSecret.asInstanceOf[js.Any], deleteRepoSecret = deleteRepoSecret.asInstanceOf[js.Any], getOrgPublicKey = getOrgPublicKey.asInstanceOf[js.Any], getOrgSecret = getOrgSecret.asInstanceOf[js.Any], getRepoPublicKey = getRepoPublicKey.asInstanceOf[js.Any], getRepoSecret = getRepoSecret.asInstanceOf[js.Any], listOrgSecrets = listOrgSecrets.asInstanceOf[js.Any], listRepoSecrets = listRepoSecrets.asInstanceOf[js.Any], listSelectedReposForOrgSecret = listSelectedReposForOrgSecret.asInstanceOf[js.Any], removeSelectedRepoFromOrgSecret = removeSelectedRepoFromOrgSecret.asInstanceOf[js.Any], setSelectedReposForOrgSecret = setSelectedReposForOrgSecret.asInstanceOf[js.Any])
    __obj.asInstanceOf[AddSelectedRepoToOrgSecret]
  }
  
  extension [Self <: AddSelectedRepoToOrgSecret](x: Self) {
    
    inline def setAddSelectedRepoToOrgSecret(value: `222`): Self = StObject.set(x, "addSelectedRepoToOrgSecret", value.asInstanceOf[js.Any])
    
    inline def setCreateOrUpdateOrgSecret(value: `223`): Self = StObject.set(x, "createOrUpdateOrgSecret", value.asInstanceOf[js.Any])
    
    inline def setCreateOrUpdateRepoSecret(value: `224`): Self = StObject.set(x, "createOrUpdateRepoSecret", value.asInstanceOf[js.Any])
    
    inline def setDeleteOrgSecret(value: `225`): Self = StObject.set(x, "deleteOrgSecret", value.asInstanceOf[js.Any])
    
    inline def setDeleteRepoSecret(value: `226`): Self = StObject.set(x, "deleteRepoSecret", value.asInstanceOf[js.Any])
    
    inline def setGetOrgPublicKey(value: `227`): Self = StObject.set(x, "getOrgPublicKey", value.asInstanceOf[js.Any])
    
    inline def setGetOrgSecret(value: `228`): Self = StObject.set(x, "getOrgSecret", value.asInstanceOf[js.Any])
    
    inline def setGetRepoPublicKey(value: `229`): Self = StObject.set(x, "getRepoPublicKey", value.asInstanceOf[js.Any])
    
    inline def setGetRepoSecret(value: `230`): Self = StObject.set(x, "getRepoSecret", value.asInstanceOf[js.Any])
    
    inline def setListOrgSecrets(value: `231`): Self = StObject.set(x, "listOrgSecrets", value.asInstanceOf[js.Any])
    
    inline def setListRepoSecrets(value: `232`): Self = StObject.set(x, "listRepoSecrets", value.asInstanceOf[js.Any])
    
    inline def setListSelectedReposForOrgSecret(value: `233`): Self = StObject.set(x, "listSelectedReposForOrgSecret", value.asInstanceOf[js.Any])
    
    inline def setRemoveSelectedRepoFromOrgSecret(value: `234`): Self = StObject.set(x, "removeSelectedRepoFromOrgSecret", value.asInstanceOf[js.Any])
    
    inline def setSetSelectedReposForOrgSecret(value: `235`): Self = StObject.set(x, "setSelectedReposForOrgSecret", value.asInstanceOf[js.Any])
  }
}
