...
trait `1505` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/deployments/{deployment_id}/statuses/{status_id}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1505` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1505`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1505`] (val x: Self) extends AnyVal {
