...
trait `1333` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/packages/{package_type}/{package_name}/restore']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1333` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1333`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1333`] (val x: Self) extends AnyVal {
