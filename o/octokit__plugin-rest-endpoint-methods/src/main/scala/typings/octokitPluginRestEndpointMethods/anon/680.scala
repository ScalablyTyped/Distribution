...
object `680` {
  ...
  extension [Self <: `680`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[GistsDeleteEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
