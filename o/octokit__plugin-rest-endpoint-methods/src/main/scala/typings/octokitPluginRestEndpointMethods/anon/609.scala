...
trait `609` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[ActivityListReposWatchedByUserEndpoint, baseUrl | headers | mediaType])
...
object `609` {
  ...
  inline def apply(
    parameters: RequestParameters & (Omit[ActivityListReposWatchedByUserEndpoint, baseUrl | headers | mediaType]),
  ...
  extension [Self <: `609`](x: Self) {
    ...
    inline def setParameters(
      value: RequestParameters & (Omit[ActivityListReposWatchedByUserEndpoint, baseUrl | headers | mediaType])
