...
trait `1465` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/branches/{branch}/rename']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1465` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1465`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1465`] (val x: Self) extends AnyVal {
