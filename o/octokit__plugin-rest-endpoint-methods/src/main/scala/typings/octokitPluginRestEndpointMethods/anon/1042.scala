...
trait `1042` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/enterprises/{enterprise}/actions/permissions/organizations/{org_id}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1042` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1042`] (val x: Self) extends AnyVal {
