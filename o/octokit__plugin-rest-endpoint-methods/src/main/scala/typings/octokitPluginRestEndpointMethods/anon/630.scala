...
object `630` {
  ...
  extension [Self <: `630`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[AppsGetInstallationEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
