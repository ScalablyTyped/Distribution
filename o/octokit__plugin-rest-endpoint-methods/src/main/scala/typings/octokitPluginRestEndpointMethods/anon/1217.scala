...
trait `1217` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/projects/{project_id}/columns']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1217` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1217`]
  }
  
  extension [Self <: `1217`](x: Self) {
