...
object `927` {
  ...
  extension [Self <: `927`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ReposDeletePagesSiteEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
