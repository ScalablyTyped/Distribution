...
trait `927` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/required_workflows']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `927` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `927`] (val x: Self) extends AnyVal {
