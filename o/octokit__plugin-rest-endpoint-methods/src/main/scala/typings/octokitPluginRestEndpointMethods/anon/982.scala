...
trait `982` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/organizations/{org}/codespaces/secrets/{secret_name}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `982` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `982`] (val x: Self) extends AnyVal {
