...
trait `825` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/runners/{runner_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `825` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `825`] (val x: Self) extends AnyVal {
