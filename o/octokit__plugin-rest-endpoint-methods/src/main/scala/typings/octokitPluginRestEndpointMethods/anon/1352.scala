...
trait `1352` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/environments/{environment_name}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1352` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1352`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1352`] (val x: Self) extends AnyVal {
