...
trait `1156` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/issues/{issue_number}/comments']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1156` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1156`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1156`] (val x: Self) extends AnyVal {
