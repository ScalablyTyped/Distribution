...
trait Create extends StObject {
  ...
  var listAnnotations_Original: `201`
  ...
  var listSuitesForRef_Original: `204`
  ...
  /**
    ...
    */
  def rerequestRun(): js.Promise[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/types.@octokit/types/dist-types/generated/Endpoints.Endpoints['POST /repos/{owner}/{repo}/check-runs/{check_run_id}/rerequest']['response'] */ js.Any
  ]
  def rerequestRun(
    params: RequestParameters & (Omit[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/types.@octokit/types/dist-types/generated/Endpoints.Endpoints['POST /repos/{owner}/{repo}/check-runs/{check_run_id}/rerequest']['parameters'] */ js.Any, 
      baseUrl | headers | mediaType
    ])
  ): js.Promise[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/types.@octokit/types/dist-types/generated/Endpoints.Endpoints['POST /repos/{owner}/{repo}/check-runs/{check_run_id}/rerequest']['response'] */ js.Any
  ...
  var rerequestSuite_Original: `206`
  ...
  var setSuitesPreferences_Original: `207`
...
object Create {
  ...
  inline def apply(
    ...
    listForRef: `202`,
    listForSuite: `203`,
    listSuitesForRef: `204`,
    rerequestRun: `205`,
    rerequestSuite: `206`,
    setSuitesPreferences: `207`,
    update: `208`
  ): Create = {
  ...
  implicit open class MutableBuilder[Self <: Create] (val x: Self) extends AnyVal {
    ...
    inline def setCreate(value: `197`): Self = StObject.set(x, "create", value.asInstanceOf[js.Any])
    
    inline def setCreateSuite(value: `198`): Self = StObject.set(x, "createSuite", value.asInstanceOf[js.Any])
    
    inline def setGet(value: `199`): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setGetSuite(value: `200`): Self = StObject.set(x, "getSuite", value.asInstanceOf[js.Any])
    
    inline def setListAnnotations(value: `201`): Self = StObject.set(x, "listAnnotations", value.asInstanceOf[js.Any])
    
    inline def setListForRef(value: `202`): Self = StObject.set(x, "listForRef", value.asInstanceOf[js.Any])
    
    inline def setListForSuite(value: `203`): Self = StObject.set(x, "listForSuite", value.asInstanceOf[js.Any])
    
    inline def setListSuitesForRef(value: `204`): Self = StObject.set(x, "listSuitesForRef", value.asInstanceOf[js.Any])
    
    inline def setRerequestRun(value: `205`): Self = StObject.set(x, "rerequestRun", value.asInstanceOf[js.Any])
    
    inline def setRerequestSuite(value: `206`): Self = StObject.set(x, "rerequestSuite", value.asInstanceOf[js.Any])
    
    inline def setSetSuitesPreferences(value: `207`): Self = StObject.set(x, "setSuitesPreferences", value.asInstanceOf[js.Any])
    
    inline def setUpdate(value: `208`): Self = StObject.set(x, "update", value.asInstanceOf[js.Any])
  }
}
