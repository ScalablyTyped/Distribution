...
trait `1391` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/commits/{ref}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1391` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1391`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1391`] (val x: Self) extends AnyVal {
