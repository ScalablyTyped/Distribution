...
trait `688` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[GistsListCommitsEndpoint, baseUrl | headers | mediaType])
...
object `688` {
  ...
  inline def apply(
    parameters: RequestParameters & (Omit[GistsListCommitsEndpoint, baseUrl | headers | mediaType]),
  ...
  extension [Self <: `688`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[GistsListCommitsEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
