...
trait `1157` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/issues/comments']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1157` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1157`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1157`] (val x: Self) extends AnyVal {
