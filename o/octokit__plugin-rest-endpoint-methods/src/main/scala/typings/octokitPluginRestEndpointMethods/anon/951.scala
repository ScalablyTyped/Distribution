...
trait `951` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/variables/{name}/repositories/{repository_id}']['delete'] */ js.Any
    ], 
...
object `951` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `951`] (val x: Self) extends AnyVal {
