...
trait `1014` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/codespaces/secrets/{secret_name}/repositories']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1014` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1014`] (val x: Self) extends AnyVal {
