...
trait `1047` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/enterprises/{enterprise}/actions/permissions/organizations']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1047` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1047`] (val x: Self) extends AnyVal {
