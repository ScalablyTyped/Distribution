...
trait `683` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[GistsGetEndpoint, baseUrl | headers | mediaType])
...
object `683` {
  ...
  inline def apply(
    parameters: RequestParameters & (Omit[GistsGetEndpoint, baseUrl | headers | mediaType]),
  ...
  extension [Self <: `683`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[GistsGetEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
