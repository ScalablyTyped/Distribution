...
trait `827` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/secrets/{secret_name}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `827` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `827`] (val x: Self) extends AnyVal {
