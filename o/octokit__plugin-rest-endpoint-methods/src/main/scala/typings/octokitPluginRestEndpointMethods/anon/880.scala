...
trait `880` extends js.Object {
  var parameters: RequestParameters with (Omit[ReposAddProtectedBranchTeamRestrictionsEndpoint, baseUrl | headers | mediaType])
...
object `880` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[ReposAddProtectedBranchTeamRestrictionsEndpoint, baseUrl | headers | mediaType]),
