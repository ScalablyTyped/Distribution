...
trait `880` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/runners/generate-jitconfig']['post'] */ js.Any
    ], 
...
object `880` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `880`] (val x: Self) extends AnyVal {
