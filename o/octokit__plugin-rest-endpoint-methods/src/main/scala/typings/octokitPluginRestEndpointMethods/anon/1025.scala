...
trait `1025` extends js.Object {
  var parameters: RequestParameters with (Omit[TeamsCheckManagesRepoInOrgEndpoint, baseUrl | headers | mediaType])
...
object `1025` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[TeamsCheckManagesRepoInOrgEndpoint, baseUrl | headers | mediaType]),
