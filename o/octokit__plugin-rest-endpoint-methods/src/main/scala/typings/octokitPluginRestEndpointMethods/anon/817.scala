...
object `817` {
  ...
  extension [Self <: `817`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[OrgsUpdateEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
