...
trait `1614` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/security-advisories/{ghsa_id}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1614` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1614`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1614`] (val x: Self) extends AnyVal {
