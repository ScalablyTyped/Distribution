...
trait `1023` extends js.Object {
  var parameters: RequestParameters with (Omit[TeamsAddOrUpdateProjectInOrgEndpoint, baseUrl | headers | mediaType])
...
object `1023` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[TeamsAddOrUpdateProjectInOrgEndpoint, baseUrl | headers | mediaType]),
