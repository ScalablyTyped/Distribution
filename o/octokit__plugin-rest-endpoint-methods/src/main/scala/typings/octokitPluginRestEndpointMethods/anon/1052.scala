...
trait `1052` extends js.Object {
  var parameters: RequestParameters with (Omit[UsersAddEmailsEndpoint, baseUrl | headers | mediaType])
...
object `1052` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[UsersAddEmailsEndpoint, baseUrl | headers | mediaType]),
