...
trait `1052` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/enterprises/{enterprise}/actions/permissions']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1052` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1052`] (val x: Self) extends AnyVal {
