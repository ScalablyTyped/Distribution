...
trait `1308` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/organizations/{org}/personal-access-tokens']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1308` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1308`] (val x: Self) extends AnyVal {
