...
object `728` {
  ...
  extension [Self <: `728`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[IssuesGetEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
