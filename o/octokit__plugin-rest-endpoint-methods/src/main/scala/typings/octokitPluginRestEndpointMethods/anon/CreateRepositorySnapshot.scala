...
trait CreateRepositorySnapshot extends StObject {
  ...
  var createRepositorySnapshot_Original: `281`
  ...
  /**
    ...
    */
  @JSName("diffRange")
  var diffRange_Original: `282`
}
object CreateRepositorySnapshot {
  
  inline def apply(createRepositorySnapshot: `281`, diffRange: `282`): CreateRepositorySnapshot = {
  ...
  implicit open class MutableBuilder[Self <: CreateRepositorySnapshot] (val x: Self) extends AnyVal {
    ...
    inline def setCreateRepositorySnapshot(value: `281`): Self = StObject.set(x, "createRepositorySnapshot", value.asInstanceOf[js.Any])
    
    inline def setDiffRange(value: `282`): Self = StObject.set(x, "diffRange", value.asInstanceOf[js.Any])
  }
}
