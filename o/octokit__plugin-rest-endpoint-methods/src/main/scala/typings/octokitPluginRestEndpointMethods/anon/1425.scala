...
trait `1425` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/stats/code_frequency']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1425` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1425`] (val x: Self) extends AnyVal {
