...
trait `946` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/secrets/{secret_name}/repositories/{repository_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `946` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `946`] (val x: Self) extends AnyVal {
