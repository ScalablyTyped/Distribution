...
trait `1033` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/installations/{installation_id}/repositories/{repository_id}']['delete'] */ js.Any
    ], 
...
object `1033` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1033`] (val x: Self) extends AnyVal {
