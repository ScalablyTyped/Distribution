...
trait `1281` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pulls/{pull_number}/commits']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1281` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1281`] (val x: Self) extends AnyVal {
