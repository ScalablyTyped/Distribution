...
trait `1566` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/hooks/{hook_id}/pings']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1566` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1566`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1566`] (val x: Self) extends AnyVal {
