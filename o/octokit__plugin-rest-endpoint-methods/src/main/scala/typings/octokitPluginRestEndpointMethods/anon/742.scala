...
object `742` {
  ...
  extension [Self <: `742`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[IssuesListForRepoEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
