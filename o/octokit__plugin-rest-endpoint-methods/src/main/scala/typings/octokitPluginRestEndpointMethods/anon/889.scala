...
trait `889` extends StObject {
  
  var parameters: RequestParameters & (Omit[ReactionsListForPullRequestReviewCommentEndpoint, baseUrl | headers | mediaType])
...
object `889` {
  ...
  @scala.inline
  def apply(
    parameters: RequestParameters & (Omit[ReactionsListForPullRequestReviewCommentEndpoint, baseUrl | headers | mediaType]),
    response: OctokitResponse[ReactionsListForPullRequestReviewCommentResponseData]
  ): `889` = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], response = response.asInstanceOf[js.Any])
    __obj.asInstanceOf[`889`]
  }
  
  @scala.inline
  implicit class `889MutableBuilder`[Self <: `889`] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setParameters(
      value: RequestParameters & (Omit[ReactionsListForPullRequestReviewCommentEndpoint, baseUrl | headers | mediaType])
