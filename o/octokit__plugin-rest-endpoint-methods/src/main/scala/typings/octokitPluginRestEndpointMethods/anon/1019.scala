...
trait `1019` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/code-scanning/analyses']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1019` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1019`] (val x: Self) extends AnyVal {
