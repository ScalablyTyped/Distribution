...
object `725` {
  ...
  extension [Self <: `725`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[IssuesDeleteCommentEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
