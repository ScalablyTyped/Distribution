...
trait `1058` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/code-scanning/default-setup']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1058` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1058`] (val x: Self) extends AnyVal {
