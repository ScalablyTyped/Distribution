...
trait `987` extends js.Object {
  var parameters: RequestParameters with (Omit[ReposRemoveProtectedBranchAppRestrictionsEndpoint, baseUrl | headers | mediaType])
...
object `987` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[ReposRemoveProtectedBranchAppRestrictionsEndpoint, baseUrl | headers | mediaType]),
