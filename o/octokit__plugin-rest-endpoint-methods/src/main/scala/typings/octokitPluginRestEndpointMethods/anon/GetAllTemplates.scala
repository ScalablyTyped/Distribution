...
trait GetAllTemplates extends StObject {
  ...
  var getAllTemplates_Original: `286`
  ...
  /**
    ...
    */
  @JSName("getTemplate")
  var getTemplate_Original: `287`
}
object GetAllTemplates {
  
  inline def apply(getAllTemplates: `286`, getTemplate: `287`): GetAllTemplates = {
  ...
  extension [Self <: GetAllTemplates](x: Self) {
    ...
    inline def setGetAllTemplates(value: `286`): Self = StObject.set(x, "getAllTemplates", value.asInstanceOf[js.Any])
    
    inline def setGetTemplate(value: `287`): Self = StObject.set(x, "getTemplate", value.asInstanceOf[js.Any])
  }
}
