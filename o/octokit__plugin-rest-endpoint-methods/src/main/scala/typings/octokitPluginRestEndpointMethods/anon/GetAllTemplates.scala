...
trait GetAllTemplates extends StObject {
  ...
  var getAllTemplates_Original: `328`
  ...
  /**
    ...
    */
  @JSName("getTemplate")
  var getTemplate_Original: `329`
}
object GetAllTemplates {
  
  inline def apply(getAllTemplates: `328`, getTemplate: `329`): GetAllTemplates = {
  ...
  implicit open class MutableBuilder[Self <: GetAllTemplates] (val x: Self) extends AnyVal {
    ...
    inline def setGetAllTemplates(value: `328`): Self = StObject.set(x, "getAllTemplates", value.asInstanceOf[js.Any])
    
    inline def setGetTemplate(value: `329`): Self = StObject.set(x, "getTemplate", value.asInstanceOf[js.Any])
  }
}
