...
trait `898` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{org}/{repo}/actions/required_workflows/{required_workflow_id_for_repo}/timing']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `898` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `898`] (val x: Self) extends AnyVal {
