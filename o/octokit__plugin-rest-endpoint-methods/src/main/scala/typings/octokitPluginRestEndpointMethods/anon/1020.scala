...
object `1020` {
  ...
  extension [Self <: `1020`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ReposUpdateEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
