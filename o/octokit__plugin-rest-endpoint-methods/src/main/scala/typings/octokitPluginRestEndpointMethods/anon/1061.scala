...
object `1061` {
  ...
  extension [Self <: `1061`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[TeamsListReposInOrgEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
