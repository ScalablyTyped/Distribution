...
trait `1128` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/issues/{issue_number}/labels']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1128` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1128`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1128`] (val x: Self) extends AnyVal {
