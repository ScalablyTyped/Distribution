...
trait `1248` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/import/authors/{author_id}']['patch'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1248` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1248`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1248`] (val x: Self) extends AnyVal {
