...
object `962` {
  ...
  extension [Self <: `962`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[ReposGetPagesBuildEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
