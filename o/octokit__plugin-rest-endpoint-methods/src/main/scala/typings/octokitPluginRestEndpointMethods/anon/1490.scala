...
trait `1490` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/hooks/{hook_id}/deliveries']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1490` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1490`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1490`] (val x: Self) extends AnyVal {
