...
trait `1126` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/dependabot/secrets/{secret_name}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1126` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1126`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1126`] (val x: Self) extends AnyVal {
