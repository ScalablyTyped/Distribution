...
trait `969` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/variables/{name}']['patch'] */ js.Any
    ], 
...
object `969` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `969`] (val x: Self) extends AnyVal {
