...
object `755` {
  ...
  @scala.inline
  implicit class `755Ops`[Self <: `755`] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setParameters(value: RequestParameters with (Omit[MarkdownRenderRawEndpoint, baseUrl | headers | mediaType])): Self = this.set("parameters", value.asInstanceOf[js.Any])
    @scala.inline
