...
trait `1392` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/stats/commit_activity']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1392` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1392`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1392`] (val x: Self) extends AnyVal {
