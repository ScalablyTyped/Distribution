...
trait `842` extends js.Object {
  var parameters: RequestParameters with (Omit[PullsListCommentsForRepoEndpoint, baseUrl | headers | mediaType])
...
object `842` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[PullsListCommentsForRepoEndpoint, baseUrl | headers | mediaType]),
