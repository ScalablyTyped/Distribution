...
object `796` {
  ...
  extension [Self <: `796`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[OrgsGetWebhookEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
