...
trait `1045` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/enterprise-installation/{enterprise_or_org}/server-statistics']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1045` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1045`] (val x: Self) extends AnyVal {
