...
@js.native
trait AddOrUpdateMembershipInOrg extends js.Object {
  /**
  ...
  var createDiscussionCommentInOrg_Original: `482` = js.native
  /**
  ...
  var createDiscussionInOrg_Original: `483` = js.native
  /**
    ...
    */
  @JSName("create")
  var create_Original: `481` = js.native
  /**
  ...
  var deleteDiscussionCommentInOrg_Original: `484` = js.native
  /**
  ...
  var deleteDiscussionInOrg_Original: `485` = js.native
  /**
    ...
    */
  @JSName("deleteInOrg")
  var deleteInOrg_Original: `486` = js.native
  /**
    ...
    */
  @JSName("getByName")
  var getByName_Original: `487` = js.native
  /**
  ...
  var getDiscussionCommentInOrg_Original: `488` = js.native
  /**
  ...
  var getDiscussionInOrg_Original: `489` = js.native
  /**
  ...
  var getMembershipInOrg_Original: `490` = js.native
  /**
  ...
  var listChildInOrg_Original: `492` = js.native
  /**
  ...
  var listDiscussionCommentsInOrg_Original: `493` = js.native
  /**
  ...
  var listDiscussionsInOrg_Original: `494` = js.native
  /**
    * List all of the teams across all of the organizations to which the authenticated user belongs. This method requires `user`, `repo`, or `read:org` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/) when authenticating via [OAuth](https://developer.github.com/apps/building-oauth-apps/).
    */
  @JSName("listForAuthenticatedUser")
  var listForAuthenticatedUser_Original: `495` = js.native
  /**
    * Team members will include the members of child teams.
    *
  ...
  var listMembersInOrg_Original: `496` = js.native
  /**
  ...
  var listPendingInvitationsInOrg_Original: `497` = js.native
  /**
  ...
  var listProjectsInOrg_Original: `498` = js.native
  /**
  ...
  var listReposInOrg_Original: `499` = js.native
  /**
    * Lists all teams in an organization that are visible to the authenticated user.
    */
  @JSName("list")
  var list_Original: `491` = js.native
  /**
    * Team synchronization is available for organizations using GitHub Enterprise Cloud. For more information, see [GitHub's products](https://help.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
    *
  ...
  var removeMembershipInOrg_Original: `500` = js.native
  /**
  ...
  var removeProjectInOrg_Original: `501` = js.native
  /**
  ...
  var removeRepoInOrg_Original: `502` = js.native
  /**
  ...
  var reviewProjectInOrg_Original: `503` = js.native
  /**
