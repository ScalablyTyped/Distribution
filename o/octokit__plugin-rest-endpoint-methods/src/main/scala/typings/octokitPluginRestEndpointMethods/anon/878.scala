...
trait `878` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/workflows/{workflow_id}/enable']['put'] */ js.Any
    ], 
...
object `878` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `878`] (val x: Self) extends AnyVal {
