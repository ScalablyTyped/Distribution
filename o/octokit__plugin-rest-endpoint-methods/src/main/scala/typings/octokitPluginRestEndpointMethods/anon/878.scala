...
trait `878` extends js.Object {
  var parameters: RequestParameters with (Omit[ReposAddProtectedBranchRequiredSignaturesEndpoint, baseUrl | headers | mediaType])
...
object `878` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[ReposAddProtectedBranchRequiredSignaturesEndpoint, baseUrl | headers | mediaType]),
