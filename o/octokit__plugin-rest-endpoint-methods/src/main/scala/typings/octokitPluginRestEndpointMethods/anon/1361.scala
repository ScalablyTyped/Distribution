...
trait `1361` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/invitations/{invitation_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1361` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1361`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1361`] (val x: Self) extends AnyVal {
