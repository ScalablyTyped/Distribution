...
trait `1481` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/environments/{environment_name}/deployment_protection_rules']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1481` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1481`] (val x: Self) extends AnyVal {
