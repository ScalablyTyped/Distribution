...
object `701` {
  ...
  extension [Self <: `701`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[GitCreateTreeEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
