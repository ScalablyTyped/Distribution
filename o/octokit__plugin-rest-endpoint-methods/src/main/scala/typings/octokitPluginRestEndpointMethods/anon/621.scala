...
object `621` {
  ...
  extension [Self <: `621`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[AppsCheckTokenEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
