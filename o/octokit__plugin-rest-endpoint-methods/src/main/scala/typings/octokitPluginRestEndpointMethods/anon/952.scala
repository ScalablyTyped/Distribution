...
trait `952` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/actions/required_workflows/{required_workflow_id}/repositories/{repository_id}']['delete'] */ js.Any
    ], 
...
object `952` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `952`] (val x: Self) extends AnyVal {
