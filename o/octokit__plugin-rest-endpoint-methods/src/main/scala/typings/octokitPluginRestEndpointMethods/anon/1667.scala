...
trait `1667` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/ssh_signing_keys/{ssh_signing_key_id}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1667` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1667`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1667`] (val x: Self) extends AnyVal {
