...
object `649` {
  ...
  extension [Self <: `649`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[AppsSuspendInstallationEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
