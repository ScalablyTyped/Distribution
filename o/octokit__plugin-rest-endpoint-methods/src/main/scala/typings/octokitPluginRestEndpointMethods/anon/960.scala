...
trait `960` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[ReposGetLatestReleaseEndpoint, baseUrl | headers | mediaType])
...
object `960` {
  ...
  inline def apply(
    parameters: RequestParameters & (Omit[ReposGetLatestReleaseEndpoint, baseUrl | headers | mediaType]),
  ...
  extension [Self <: `960`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ReposGetLatestReleaseEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
