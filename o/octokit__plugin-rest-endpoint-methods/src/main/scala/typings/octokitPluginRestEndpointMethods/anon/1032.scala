...
object `1032` {
  ...
  extension [Self <: `1032`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[SearchCommitsEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
