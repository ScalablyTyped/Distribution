...
trait `1510` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/rulesets']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1510` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1510`] (val x: Self) extends AnyVal {
