...
trait GetAllCommonlyUsed extends StObject {
  ...
  var getAllCommonlyUsed_Original: `378`
  ...
  /**
    ...
    */
  @JSName("getForRepo")
  var getForRepo_Original: `379`
  
  @JSName("get")
  var get_Original: `377`
}
object GetAllCommonlyUsed {
  
  inline def apply(get: `377`, getAllCommonlyUsed: `378`, getForRepo: `379`): GetAllCommonlyUsed = {
  ...
  implicit open class MutableBuilder[Self <: GetAllCommonlyUsed] (val x: Self) extends AnyVal {
    ...
    inline def setGet(value: `377`): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setGetAllCommonlyUsed(value: `378`): Self = StObject.set(x, "getAllCommonlyUsed", value.asInstanceOf[js.Any])
    
    inline def setGetForRepo(value: `379`): Self = StObject.set(x, "getForRepo", value.asInstanceOf[js.Any])
  }
}
