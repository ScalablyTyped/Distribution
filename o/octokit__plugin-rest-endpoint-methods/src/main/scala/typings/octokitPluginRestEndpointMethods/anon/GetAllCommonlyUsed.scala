...
trait GetAllCommonlyUsed extends StObject {
  ...
  var getAllCommonlyUsed_Original: `372`
  ...
  /**
    ...
    */
  @JSName("getForRepo")
  var getForRepo_Original: `373`
  
  @JSName("get")
  var get_Original: `371`
}
object GetAllCommonlyUsed {
  
  inline def apply(get: `371`, getAllCommonlyUsed: `372`, getForRepo: `373`): GetAllCommonlyUsed = {
  ...
  implicit open class MutableBuilder[Self <: GetAllCommonlyUsed] (val x: Self) extends AnyVal {
    ...
    inline def setGet(value: `371`): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setGetAllCommonlyUsed(value: `372`): Self = StObject.set(x, "getAllCommonlyUsed", value.asInstanceOf[js.Any])
    
    inline def setGetForRepo(value: `373`): Self = StObject.set(x, "getForRepo", value.asInstanceOf[js.Any])
  }
}
