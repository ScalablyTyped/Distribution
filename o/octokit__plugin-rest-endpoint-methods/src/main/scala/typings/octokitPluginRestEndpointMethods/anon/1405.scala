...
trait `1405` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/automated-security-fixes']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1405` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1405`] (val x: Self) extends AnyVal {
