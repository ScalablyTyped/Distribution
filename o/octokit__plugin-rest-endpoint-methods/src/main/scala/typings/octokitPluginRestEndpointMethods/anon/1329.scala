...
trait `1329` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pulls/{pull_number}/update-branch']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1329` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1329`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1329`] (val x: Self) extends AnyVal {
