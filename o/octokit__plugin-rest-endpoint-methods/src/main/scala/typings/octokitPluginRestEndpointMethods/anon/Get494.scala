...
trait Get494 extends StObject {
  ...
  /**
    ...
    */
  @JSName("get")
  var get_Original: `494`
}
object Get494 {
  
  inline def apply(get: `494`): Get494 = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any])
    __obj.asInstanceOf[Get494]
  }
  
  extension [Self <: Get494](x: Self) {
    
    inline def setGet(value: `494`): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
  }
}
