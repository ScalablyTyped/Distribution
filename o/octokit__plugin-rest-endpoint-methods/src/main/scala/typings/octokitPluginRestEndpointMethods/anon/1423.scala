...
trait `1423` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/hooks/{hook_id}/config']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1423` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1423`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1423`] (val x: Self) extends AnyVal {
