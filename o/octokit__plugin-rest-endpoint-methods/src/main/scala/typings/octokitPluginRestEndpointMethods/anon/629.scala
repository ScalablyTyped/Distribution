...
object `629` {
  ...
  extension [Self <: `629`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[AppsGetBySlugEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
