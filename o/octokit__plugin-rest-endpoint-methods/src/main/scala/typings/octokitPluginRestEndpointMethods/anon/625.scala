...
object `625` {
  ...
  extension [Self <: `625`](x: Self) {
    
    inline def setParameters(value: RequestParameters & (Omit[AppsDeleteAuthorizationEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
