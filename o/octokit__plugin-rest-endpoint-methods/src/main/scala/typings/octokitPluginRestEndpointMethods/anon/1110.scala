...
trait `1110` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/codespaces/billing/selected_users']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1110` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `1110`] (val x: Self) extends AnyVal {
