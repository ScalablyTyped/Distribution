...
object `1000` {
  ...
  extension [Self <: `1000`](x: Self) {
    ...
    inline def setParameters(value: RequestParameters & (Omit[ReposListTagsEndpoint, baseUrl | headers | mediaType])): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
