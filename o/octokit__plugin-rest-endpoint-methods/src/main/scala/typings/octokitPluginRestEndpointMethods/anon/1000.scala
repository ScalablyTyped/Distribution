...
trait `1000` extends js.Object {
  var parameters: RequestParameters with (Omit[ReposRequestPageBuildEndpoint, baseUrl | headers | mediaType])
...
object `1000` {
  @scala.inline
  def apply(
    parameters: RequestParameters with (Omit[ReposRequestPageBuildEndpoint, baseUrl | headers | mediaType]),
