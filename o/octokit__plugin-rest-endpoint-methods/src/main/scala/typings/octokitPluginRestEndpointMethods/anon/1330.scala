...
trait `1330` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/branches/{branch}/protection/required_signatures']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1330` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1330`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1330`] (val x: Self) extends AnyVal {
