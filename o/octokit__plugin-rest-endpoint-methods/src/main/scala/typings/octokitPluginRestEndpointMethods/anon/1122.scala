...
trait `1122` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/dependabot/alerts/{alert_number}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1122` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1122`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1122`] (val x: Self) extends AnyVal {
