...
trait `857` extends StObject {
  ...
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{org}/{repo}/actions/required_workflows/{required_workflow_id_for_repo}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `857` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `857`] (val x: Self) extends AnyVal {
