...
trait AnonActionsActionsdescription extends js.Object {
...
object AnonActionsActionsdescription {
  @scala.inline
  def apply(
    actions: AnonType,
    ...
    outputDottitle: AnonType,
    owner: AnonRequired,
    repo: AnonRequired,
    started_at: AnonType,
    status: AnonEnum
  ): AnonActionsActionsdescription = {
    ...
    __obj.asInstanceOf[AnonActionsActionsdescription]
  }
}
