...
import typings.octokitPluginRestEndpointMethods.anon.Get670
import typings.octokitPluginRestEndpointMethods.anon.Get756
import typings.octokitPluginRestEndpointMethods.anon.Get866
