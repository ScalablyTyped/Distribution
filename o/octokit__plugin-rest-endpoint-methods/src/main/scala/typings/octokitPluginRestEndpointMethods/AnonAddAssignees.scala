...
import typings.octokitPluginRestEndpointMethods.typesMod.IssuesReplaceAllLabelsParams
...
trait AnonAddAssignees extends js.Object {
  ...
  def removeAllLabels(): js.Promise[AnyResponse] = js.native
  def removeAllLabels(
  ...
  def replaceAllLabels(): js.Promise[
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify OctokitResponse<IssuesReplaceAllLabelsResponse> */ _
  ] = js.native
  def replaceAllLabels(
    params: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RequestParameters */ js.Any) with IssuesReplaceAllLabelsParams
  ): js.Promise[
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify OctokitResponse<IssuesReplaceAllLabelsResponse> */ _
  ] = js.native
  /**
