...
trait AnonCancelImport extends js.Object {
  /**
    ...
    */
  @JSName("cancelImport")
  var cancelImport_Original: Anon196 = js.native
  /**
  ...
  var deleteArchiveForAuthenticatedUser_Original: Anon197 = js.native
  /**
    * Deletes a previous migration archive. Migration archives are automatically deleted after seven days.
    */
  @JSName("deleteArchiveForOrg")
  var deleteArchiveForOrg_Original: Anon198 = js.native
  /**
    * Fetches the URL to a migration archive.
    */
  @JSName("downloadArchiveForOrg")
  var downloadArchiveForOrg_Original: Anon199 = js.native
  /**
  ...
  var getArchiveForAuthenticatedUser_Original: Anon200 = js.native
  /**
  ...
  var getCommitAuthors_Original: Anon201 = js.native
  /**
  ...
  var getImportProgress_Original: Anon202 = js.native
  /**
    * List files larger than 100MB found during the import
    */
  @JSName("getLargeFiles")
  var getLargeFiles_Original: Anon203 = js.native
  /**
  ...
  var getStatusForAuthenticatedUser_Original: Anon204 = js.native
  /**
  ...
  var getStatusForOrg_Original: Anon205 = js.native
  /**
    * Lists all migrations a user has started.
    */
  @JSName("listForAuthenticatedUser")
  var listForAuthenticatedUser_Original: Anon206 = js.native
  /**
    * Lists the most recent migrations.
    */
  @JSName("listForOrg")
  var listForOrg_Original: Anon207 = js.native
  /**
    * List all the repositories for this organization migration.
    */
  @JSName("listReposForOrg")
  var listReposForOrg_Original: Anon208 = js.native
  /**
    * Lists all the repositories for this user migration.
    */
  @JSName("listReposForUser")
  var listReposForUser_Original: Anon209 = js.native
  /**
    * Update an author's identity for the import. Your application can continue updating authors any time before you push new commits to the repository.
    */
  @JSName("mapCommitAuthor")
  var mapCommitAuthor_Original: Anon210 = js.native
  /**
    * You can import repositories from Subversion, Mercurial, and TFS that include files larger than 100MB. This ability is powered by [Git LFS](https://git-lfs.github.com). You can learn more about our LFS feature and working with large files [on our help site](https://help.github.com/articles/versioning-large-files/).
    */
  @JSName("setLfsPreference")
  var setLfsPreference_Original: Anon211 = js.native
  /**
    * Initiates the generation of a user migration archive.
    */
  @JSName("startForAuthenticatedUser")
  var startForAuthenticatedUser_Original: Anon212 = js.native
  /**
    * Initiates the generation of a migration archive.
    */
  @JSName("startForOrg")
  var startForOrg_Original: Anon213 = js.native
  /**
    * Start a source import to a GitHub repository using GitHub Importer.
    */
  @JSName("startImport")
  var startImport_Original: Anon214 = js.native
  /**
  ...
  var unlockRepoForAuthenticatedUser_Original: Anon215 = js.native
  /**
  ...
  var unlockRepoForOrg_Original: Anon216 = js.native
  /**
    ...
    */
  @JSName("updateImport")
  var updateImport_Original: Anon217 = js.native
  /**
    * Stop an import for a repository.
    */
