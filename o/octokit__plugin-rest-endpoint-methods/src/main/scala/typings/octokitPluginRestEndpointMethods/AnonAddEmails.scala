...
trait AnonAddEmails extends js.Object {
  /**
    ...
    */
  @JSName("addEmails")
  var addEmails_Original: Anon480 = js.native
  @JSName("block")
  var block_Original: Anon481 = js.native
  /**
    ...
    */
  @JSName("checkBlocked")
  var checkBlocked_Original: Anon482 = js.native
  @JSName("checkFollowingForUser")
  var checkFollowingForUser_Original: Anon484 = js.native
  @JSName("checkFollowing")
  var checkFollowing_Original: Anon483 = js.native
  /**
    * Adds a GPG key to the authenticated user's GitHub account. Requires that you are authenticated via Basic Auth, or OAuth with at least `write:gpg_key` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    */
  @JSName("createGpgKey")
  var createGpgKey_Original: Anon485 = js.native
  /**
    * Adds a public SSH key to the authenticated user's GitHub account. Requires that you are authenticated via Basic Auth, or OAuth with at least `write:public_key` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    */
  @JSName("createPublicKey")
  var createPublicKey_Original: Anon486 = js.native
  /**
    * This endpoint is accessible with the `user` scope.
    */
  @JSName("deleteEmails")
  var deleteEmails_Original: Anon487 = js.native
  /**
    ...
    */
  @JSName("deleteGpgKey")
  var deleteGpgKey_Original: Anon488 = js.native
  /**
  ...
  var deletePublicKey_Original: Anon489 = js.native
  /**
    ...
    */
  @JSName("follow")
  var follow_Original: Anon490 = js.native
  /**
  ...
  var getAuthenticated_Original: Anon30 = js.native
  /**
  ...
  var getByUsername_Original: Anon491 = js.native
  /**
  ...
  var getContextForUser_Original: Anon492 = js.native
  /**
    ...
    */
  @JSName("getGpgKey")
  var getGpgKey_Original: Anon493 = js.native
  /**
    ...
    */
  @JSName("getPublicKey")
  var getPublicKey_Original: Anon494 = js.native
  /**
    * List the users you've blocked on your personal account.
    */
  @JSName("listBlocked")
  var listBlocked_Original: Anon30 = js.native
  /**
    * Lists all of your email addresses, and specifies which one is visible to the public. This endpoint is accessible with the `user:email` scope.
    */
  @JSName("listEmails")
  var listEmails_Original: Anon496 = js.native
  @JSName("listFollowersForAuthenticatedUser")
  var listFollowersForAuthenticatedUser_Original: Anon497 = js.native
  @JSName("listFollowersForUser")
  var listFollowersForUser_Original: Anon498 = js.native
  @JSName("listFollowingForAuthenticatedUser")
  var listFollowingForAuthenticatedUser_Original: Anon499 = js.native
  @JSName("listFollowingForUser")
  var listFollowingForUser_Original: Anon500 = js.native
  /**
    * Lists the GPG keys for a user. This information is accessible by anyone.
    */
  @JSName("listGpgKeysForUser")
  var listGpgKeysForUser_Original: Anon502 = js.native
  /**
    ...
    */
  @JSName("listGpgKeys")
  var listGpgKeys_Original: Anon501 = js.native
  /**
  ...
  var listPublicEmails_Original: Anon503 = js.native
  /**
    * Lists the _verified_ public SSH keys for a user. This is accessible by anyone.
    */
  @JSName("listPublicKeysForUser")
  var listPublicKeysForUser_Original: Anon505 = js.native
  /**
  ...
  var listPublicKeys_Original: Anon504 = js.native
  /**
    ...
    */
  @JSName("list")
  var list_Original: Anon495 = js.native
  /**
    * Sets the visibility for your primary email addresses.
    */
  @JSName("togglePrimaryEmailVisibility")
  var togglePrimaryEmailVisibility_Original: Anon506 = js.native
  @JSName("unblock")
  var unblock_Original: Anon507 = js.native
  /**
    * Unfollowing a user requires the user to be logged in and authenticated with basic auth or OAuth with the `user:follow` scope.
    */
  @JSName("unfollow")
  var unfollow_Original: Anon508 = js.native
  /**
    * **Note:** If your email is set to private and you send an `email` parameter as part of this request to update your profile, your privacy settings are still enforced: the email address will not be displayed on your public profile or via the API.
    */
  @JSName("updateAuthenticated")
  var updateAuthenticated_Original: Anon509 = js.native
  /**
    * This endpoint is accessible with the `user` scope.
    */
