...
trait OrgsListInvitationTeamsResponseItem extends js.Object {
...
object OrgsListInvitationTeamsResponseItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[OrgsListInvitationTeamsResponseItem]
  }
}
