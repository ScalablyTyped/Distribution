...
trait ChecksCreateSuiteResponseRepositoryOwner extends js.Object {
...
object ChecksCreateSuiteResponseRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ChecksCreateSuiteResponseRepositoryOwner]
  }
}
