...
trait MigrationsListForOrgResponseItemRepositoriesItem extends js.Object {
  ...
  var owner: MigrationsListForOrgResponseItemRepositoriesItemOwner
  var permissions: MigrationsListForOrgResponseItemRepositoriesItemPermissions
  var `private`: Boolean
...
object MigrationsListForOrgResponseItemRepositoriesItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsListForOrgResponseItemRepositoriesItem]
  }
}
