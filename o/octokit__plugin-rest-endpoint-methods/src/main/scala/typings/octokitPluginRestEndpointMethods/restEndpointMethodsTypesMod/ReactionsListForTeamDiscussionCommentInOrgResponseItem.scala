...
trait ReactionsListForTeamDiscussionCommentInOrgResponseItem extends js.Object {
  var content: String
  var created_at: String
  var id: Double
  var node_id: String
  var user: ReactionsListForTeamDiscussionCommentInOrgResponseItemUser
}

object ReactionsListForTeamDiscussionCommentInOrgResponseItem {
  @scala.inline
  def apply(
    content: String,
    created_at: String,
    ...
    __obj.asInstanceOf[ReactionsListForTeamDiscussionCommentInOrgResponseItem]
  }
}
