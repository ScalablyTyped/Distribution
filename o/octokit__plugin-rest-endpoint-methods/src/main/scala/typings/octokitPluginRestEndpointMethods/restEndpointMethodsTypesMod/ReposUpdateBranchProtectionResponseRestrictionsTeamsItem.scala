...
trait ReposUpdateBranchProtectionResponseRestrictionsTeamsItem extends js.Object {
...
object ReposUpdateBranchProtectionResponseRestrictionsTeamsItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[ReposUpdateBranchProtectionResponseRestrictionsTeamsItem]
  }
}
