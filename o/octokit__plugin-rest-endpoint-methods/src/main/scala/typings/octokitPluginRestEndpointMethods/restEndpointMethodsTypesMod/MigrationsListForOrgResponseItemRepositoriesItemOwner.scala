...
trait MigrationsListForOrgResponseItemRepositoriesItemOwner extends js.Object {
...
object MigrationsListForOrgResponseItemRepositoriesItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[MigrationsListForOrgResponseItemRepositoriesItemOwner]
  }
}
