...
trait ReposGetTeamsWithAccessToProtectedBranchResponseItem extends js.Object {
...
object ReposGetTeamsWithAccessToProtectedBranchResponseItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[ReposGetTeamsWithAccessToProtectedBranchResponseItem]
  }
}
