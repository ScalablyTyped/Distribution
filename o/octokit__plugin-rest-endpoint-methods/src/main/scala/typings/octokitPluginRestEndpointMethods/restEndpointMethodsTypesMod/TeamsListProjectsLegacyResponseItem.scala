...
trait TeamsListProjectsLegacyResponseItem extends js.Object {
  var body: String
  var columns_url: String
  var created_at: String
  var creator: TeamsListProjectsLegacyResponseItemCreator
  var html_url: String
  var id: Double
  var name: String
  var node_id: String
  ...
  var permissions: TeamsListProjectsLegacyResponseItemPermissions
  var `private`: Boolean
  var state: String
...
object TeamsListProjectsLegacyResponseItem {
  @scala.inline
  def apply(
    body: String,
    columns_url: String,
    ...
    __obj.asInstanceOf[TeamsListProjectsLegacyResponseItem]
  }
}
