...
trait ChecksCreateSuiteResponseRepository extends js.Object {
  ...
  var owner: ChecksCreateSuiteResponseRepositoryOwner
  var permissions: ChecksCreateSuiteResponseRepositoryPermissions
  var `private`: Boolean
...
object ChecksCreateSuiteResponseRepository {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ChecksCreateSuiteResponseRepository]
  }
}
