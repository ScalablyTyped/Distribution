...
trait TeamsUpdateInOrgResponse extends js.Object {
  ...
  var name: String
  var node_id: String
  var organization: TeamsUpdateInOrgResponseOrganization
  var parent: Null
...
object TeamsUpdateInOrgResponse {
  @scala.inline
  def apply(
    created_at: String,
    description: String,
    ...
    __obj.asInstanceOf[TeamsUpdateInOrgResponse]
  }
}
