...
trait ReposGetDeploymentStatusResponseCreator extends js.Object {
...
object ReposGetDeploymentStatusResponseCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetDeploymentStatusResponseCreator]
  }
}
