...
trait AppsFindOrgInstallationResponseAccount extends js.Object {
...
object AppsFindOrgInstallationResponseAccount {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[AppsFindOrgInstallationResponseAccount]
  }
}
