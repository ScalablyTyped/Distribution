...
trait ReposListDeploymentsResponseItemCreator extends js.Object {
...
object ReposListDeploymentsResponseItemCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListDeploymentsResponseItemCreator]
  }
}
