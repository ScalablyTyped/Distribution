...
trait ReactionsCreateForTeamDiscussionInOrgResponse extends js.Object {
  var content: String
  var created_at: String
  var id: Double
  var node_id: String
  var user: ReactionsCreateForTeamDiscussionInOrgResponseUser
}

object ReactionsCreateForTeamDiscussionInOrgResponse {
  @scala.inline
  def apply(
    content: String,
    created_at: String,
    ...
    __obj.asInstanceOf[ReactionsCreateForTeamDiscussionInOrgResponse]
  }
}
