...
trait ReposListReleasesResponseItemAssetsItemUploader extends js.Object {
...
object ReposListReleasesResponseItemAssetsItemUploader {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListReleasesResponseItemAssetsItemUploader]
  }
}
