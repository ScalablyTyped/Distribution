...
trait ActivityListWatchedReposForAuthenticatedUserResponseItem extends js.Object {
  ...
  var license: ActivityListWatchedReposForAuthenticatedUserResponseItemLicense
  ...
  var owner: ActivityListWatchedReposForAuthenticatedUserResponseItemOwner
  var permissions: ActivityListWatchedReposForAuthenticatedUserResponseItemPermissions
  var `private`: Boolean
...
object ActivityListWatchedReposForAuthenticatedUserResponseItem {
  @scala.inline
  def apply(
    archive_url: String,
    archived: Boolean,
    ...
    __obj.asInstanceOf[ActivityListWatchedReposForAuthenticatedUserResponseItem]
  }
}
