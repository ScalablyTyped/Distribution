...
trait TeamsReviewProjectLegacyResponseCreator extends js.Object {
...
object TeamsReviewProjectLegacyResponseCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsReviewProjectLegacyResponseCreator]
  }
}
