...
trait ReposCompareCommitsResponseCommitsItemCommitter extends js.Object {
...
object ReposCompareCommitsResponseCommitsItemCommitter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCompareCommitsResponseCommitsItemCommitter]
  }
}
