...
trait AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePendingChangePlan extends js.Object {
...
object AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePendingChangePlan {
  @scala.inline
  def apply(
    accounts_url: String,
    ...
    __obj.asInstanceOf[AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePendingChangePlan]
  }
}
