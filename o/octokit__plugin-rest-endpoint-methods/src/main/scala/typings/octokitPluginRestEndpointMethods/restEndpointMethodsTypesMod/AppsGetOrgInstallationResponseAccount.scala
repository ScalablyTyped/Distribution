...
trait AppsGetOrgInstallationResponseAccount extends js.Object {
...
object AppsGetOrgInstallationResponseAccount {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[AppsGetOrgInstallationResponseAccount]
  }
}
