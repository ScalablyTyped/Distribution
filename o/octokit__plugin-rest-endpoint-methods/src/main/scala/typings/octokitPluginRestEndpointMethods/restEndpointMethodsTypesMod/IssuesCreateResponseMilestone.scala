...
trait IssuesCreateResponseMilestone extends js.Object {
  var closed_at: String
  var closed_issues: Double
  var created_at: String
  var creator: IssuesCreateResponseMilestoneCreator
...
object IssuesCreateResponseMilestone {
  @scala.inline
  def apply(
    closed_at: String,
    ...
    __obj.asInstanceOf[IssuesCreateResponseMilestone]
  }
}
