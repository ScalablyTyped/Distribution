...
trait ReposUpdateInvitationResponseRepositoryOwner extends js.Object {
...
object ReposUpdateInvitationResponseRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposUpdateInvitationResponseRepositoryOwner]
  }
}
