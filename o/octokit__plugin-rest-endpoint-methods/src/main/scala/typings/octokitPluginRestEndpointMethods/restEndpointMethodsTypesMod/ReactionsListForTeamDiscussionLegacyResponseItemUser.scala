...
trait ReactionsListForTeamDiscussionLegacyResponseItemUser extends js.Object {
...
object ReactionsListForTeamDiscussionLegacyResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsListForTeamDiscussionLegacyResponseItemUser]
  }
}
