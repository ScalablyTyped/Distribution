...
trait MigrationsStartForAuthenticatedUserResponseRepositoriesItemOwner extends js.Object {
...
object MigrationsStartForAuthenticatedUserResponseRepositoriesItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[MigrationsStartForAuthenticatedUserResponseRepositoriesItemOwner]
  }
}
