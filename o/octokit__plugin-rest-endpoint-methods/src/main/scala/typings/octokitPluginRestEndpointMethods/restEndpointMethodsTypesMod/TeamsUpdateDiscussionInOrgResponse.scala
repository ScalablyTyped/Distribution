...
trait TeamsUpdateDiscussionInOrgResponse extends js.Object {
  var author: TeamsUpdateDiscussionInOrgResponseAuthor
  var body: String
  ...
  var pinned: Boolean
  var `private`: Boolean
  var reactions: TeamsUpdateDiscussionInOrgResponseReactions
  var team_url: String
  var title: String
...
object TeamsUpdateDiscussionInOrgResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionInOrgResponse]
  }
}
