...
trait ReposAddCollaboratorResponseRepositoryOwner extends js.Object {
...
object ReposAddCollaboratorResponseRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposAddCollaboratorResponseRepositoryOwner]
  }
}
