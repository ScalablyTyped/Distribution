...
trait ActivityListNotificationsResponseItemRepositoryOwner extends js.Object {
...
object ActivityListNotificationsResponseItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActivityListNotificationsResponseItemRepositoryOwner]
  }
}
