...
trait ReposAddProtectedBranchAppRestrictionsResponseItemOwner extends js.Object {
...
object ReposAddProtectedBranchAppRestrictionsResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposAddProtectedBranchAppRestrictionsResponseItemOwner]
  }
}
