...
trait AppsGetInstallationResponseAccount extends js.Object {
...
object AppsGetInstallationResponseAccount {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[AppsGetInstallationResponseAccount]
  }
}
