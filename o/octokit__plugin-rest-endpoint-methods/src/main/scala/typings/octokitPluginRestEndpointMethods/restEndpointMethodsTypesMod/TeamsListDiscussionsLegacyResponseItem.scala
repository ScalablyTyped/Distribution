...
trait TeamsListDiscussionsLegacyResponseItem extends js.Object {
  var author: TeamsListDiscussionsLegacyResponseItemAuthor
  var body: String
  ...
  var pinned: Boolean
  var `private`: Boolean
  var reactions: TeamsListDiscussionsLegacyResponseItemReactions
  var team_url: String
  var title: String
...
object TeamsListDiscussionsLegacyResponseItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsListDiscussionsLegacyResponseItem]
  }
}
