...
trait UsersListFollowingForAuthenticatedUserResponseItem extends js.Object {
...
object UsersListFollowingForAuthenticatedUserResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[UsersListFollowingForAuthenticatedUserResponseItem]
  }
}
