...
trait ReposCompareCommitsResponseBaseCommitCommitter extends js.Object {
...
object ReposCompareCommitsResponseBaseCommitCommitter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCompareCommitsResponseBaseCommitCommitter]
  }
}
