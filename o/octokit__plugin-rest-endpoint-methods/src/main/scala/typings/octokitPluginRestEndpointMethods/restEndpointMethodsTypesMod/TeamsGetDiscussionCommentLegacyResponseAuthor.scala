...
trait TeamsGetDiscussionCommentLegacyResponseAuthor extends js.Object {
...
object TeamsGetDiscussionCommentLegacyResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsGetDiscussionCommentLegacyResponseAuthor]
  }
}
