...
trait TeamsGetDiscussionCommentLegacyResponseReactions extends js.Object {
  var `-1`: Double
  @JSName("+1")
...
object TeamsGetDiscussionCommentLegacyResponseReactions {
  @scala.inline
  def apply(
    `-1`: Double,
    Plussign1: Double,
    ...
    __obj.asInstanceOf[TeamsGetDiscussionCommentLegacyResponseReactions]
  }
}
