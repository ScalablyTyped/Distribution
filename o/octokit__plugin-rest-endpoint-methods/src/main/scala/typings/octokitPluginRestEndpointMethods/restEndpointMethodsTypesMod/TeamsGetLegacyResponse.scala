...
trait TeamsGetLegacyResponse extends js.Object {
  ...
  var name: String
  var node_id: String
  var organization: TeamsGetLegacyResponseOrganization
  var parent: Null
...
object TeamsGetLegacyResponse {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TeamsGetLegacyResponse]
  }
}
