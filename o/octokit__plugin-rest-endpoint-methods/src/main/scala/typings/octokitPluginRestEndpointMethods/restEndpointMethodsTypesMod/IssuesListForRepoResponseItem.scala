...
trait IssuesListForRepoResponseItem extends js.Object {
  var active_lock_reason: String
  var assignee: IssuesListForRepoResponseItemAssignee
  var assignees: js.Array[IssuesListForRepoResponseItemAssigneesItem]
  var body: String
  var closed_at: Null
  var comments: Double
  ...
  var html_url: String
  var id: Double
  var labels: js.Array[IssuesListForRepoResponseItemLabelsItem]
  var labels_url: String
  var locked: Boolean
  var milestone: IssuesListForRepoResponseItemMilestone
  var node_id: String
  var number: Double
  var pull_request: IssuesListForRepoResponseItemPullRequest
  var repository_url: String
  var state: String
  var title: String
  var updated_at: String
  var url: String
  var user: IssuesListForRepoResponseItemUser
}

object IssuesListForRepoResponseItem {
  @scala.inline
  def apply(
    active_lock_reason: String,
    assignee: IssuesListForRepoResponseItemAssignee,
    assignees: js.Array[IssuesListForRepoResponseItemAssigneesItem],
    body: String,
    closed_at: Null,
    comments: Double,
    comments_url: String,
    ...
    html_url: String,
    id: Double,
    labels: js.Array[IssuesListForRepoResponseItemLabelsItem],
    labels_url: String,
    locked: Boolean,
    ...
    __obj.asInstanceOf[IssuesListForRepoResponseItem]
  }
}
