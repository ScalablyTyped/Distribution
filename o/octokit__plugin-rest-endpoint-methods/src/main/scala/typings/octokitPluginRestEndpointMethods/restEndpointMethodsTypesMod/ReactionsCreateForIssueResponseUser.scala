...
trait ReactionsCreateForIssueResponseUser extends js.Object {
...
object ReactionsCreateForIssueResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsCreateForIssueResponseUser]
  }
}
