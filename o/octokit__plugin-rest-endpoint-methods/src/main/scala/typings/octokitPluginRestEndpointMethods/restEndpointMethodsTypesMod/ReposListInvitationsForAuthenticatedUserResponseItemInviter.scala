...
trait ReposListInvitationsForAuthenticatedUserResponseItemInviter extends js.Object {
...
object ReposListInvitationsForAuthenticatedUserResponseItemInviter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListInvitationsForAuthenticatedUserResponseItemInviter]
  }
}
