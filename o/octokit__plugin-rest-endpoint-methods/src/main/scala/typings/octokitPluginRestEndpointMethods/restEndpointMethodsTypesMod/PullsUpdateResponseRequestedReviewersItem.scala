...
trait PullsUpdateResponseRequestedReviewersItem extends js.Object {
...
object PullsUpdateResponseRequestedReviewersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsUpdateResponseRequestedReviewersItem]
  }
}
