...
trait ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepository extends js.Object {
  ...
  var owner: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepositoryOwner
  var `private`: Boolean
...
object ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepository {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    __obj.asInstanceOf[ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepository]
  }
}
