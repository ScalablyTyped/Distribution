...
trait TeamsReviewProjectInOrgResponse extends js.Object {
  var body: String
  var columns_url: String
  var created_at: String
  var creator: TeamsReviewProjectInOrgResponseCreator
  var html_url: String
  var id: Double
  var name: String
  var node_id: String
  ...
  var permissions: TeamsReviewProjectInOrgResponsePermissions
  var `private`: Boolean
  var state: String
...
object TeamsReviewProjectInOrgResponse {
  @scala.inline
  def apply(
    body: String,
    columns_url: String,
    ...
    __obj.asInstanceOf[TeamsReviewProjectInOrgResponse]
  }
}
