...
trait ReposReplaceProtectedBranchUserRestrictionsResponseItem extends js.Object {
...
object ReposReplaceProtectedBranchUserRestrictionsResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposReplaceProtectedBranchUserRestrictionsResponseItem]
  }
}
