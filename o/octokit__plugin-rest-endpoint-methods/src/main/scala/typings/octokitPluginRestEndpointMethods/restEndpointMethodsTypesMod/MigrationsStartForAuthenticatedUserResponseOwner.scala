...
trait MigrationsStartForAuthenticatedUserResponseOwner extends js.Object {
...
object MigrationsStartForAuthenticatedUserResponseOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[MigrationsStartForAuthenticatedUserResponseOwner]
  }
}
