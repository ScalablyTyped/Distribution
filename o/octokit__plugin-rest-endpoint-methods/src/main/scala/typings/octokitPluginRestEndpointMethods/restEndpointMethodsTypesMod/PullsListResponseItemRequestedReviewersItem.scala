...
trait PullsListResponseItemRequestedReviewersItem extends js.Object {
...
object PullsListResponseItemRequestedReviewersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsListResponseItemRequestedReviewersItem]
  }
}
