...
trait ReactionsCreateForTeamDiscussionCommentLegacyResponseUser extends js.Object {
...
object ReactionsCreateForTeamDiscussionCommentLegacyResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsCreateForTeamDiscussionCommentLegacyResponseUser]
  }
}
