...
trait ReposAddCollaboratorResponseInvitee extends js.Object {
...
object ReposAddCollaboratorResponseInvitee {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposAddCollaboratorResponseInvitee]
  }
}
