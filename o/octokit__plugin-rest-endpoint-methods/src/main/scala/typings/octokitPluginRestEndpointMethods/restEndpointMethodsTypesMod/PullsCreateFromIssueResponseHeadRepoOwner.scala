...
trait PullsCreateFromIssueResponseHeadRepoOwner extends js.Object {
...
object PullsCreateFromIssueResponseHeadRepoOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateFromIssueResponseHeadRepoOwner]
  }
}
