...
trait IssuesListForAuthenticatedUserResponseItemRepository extends js.Object {
  ...
  var owner: IssuesListForAuthenticatedUserResponseItemRepositoryOwner
  var permissions: IssuesListForAuthenticatedUserResponseItemRepositoryPermissions
  var `private`: Boolean
...
object IssuesListForAuthenticatedUserResponseItemRepository {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListForAuthenticatedUserResponseItemRepository]
  }
}
