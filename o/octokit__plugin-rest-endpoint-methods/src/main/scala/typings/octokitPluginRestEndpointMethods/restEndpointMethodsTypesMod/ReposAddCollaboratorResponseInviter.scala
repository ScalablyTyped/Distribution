...
trait ReposAddCollaboratorResponseInviter extends js.Object {
...
object ReposAddCollaboratorResponseInviter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposAddCollaboratorResponseInviter]
  }
}
