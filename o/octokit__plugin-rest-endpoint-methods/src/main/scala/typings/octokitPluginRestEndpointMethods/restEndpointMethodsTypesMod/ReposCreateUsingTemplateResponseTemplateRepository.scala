...
trait ReposCreateUsingTemplateResponseTemplateRepository extends js.Object {
  ...
  var owner: ReposCreateUsingTemplateResponseTemplateRepositoryOwner
  var permissions: ReposCreateUsingTemplateResponseTemplateRepositoryPermissions
  var `private`: Boolean
...
object ReposCreateUsingTemplateResponseTemplateRepository {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateUsingTemplateResponseTemplateRepository]
  }
}
