...
trait ReposGetReleaseByTagResponseAuthor extends js.Object {
...
object ReposGetReleaseByTagResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetReleaseByTagResponseAuthor]
  }
}
