...
trait MigrationsGetStatusForAuthenticatedUserResponseOwner extends js.Object {
...
object MigrationsGetStatusForAuthenticatedUserResponseOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[MigrationsGetStatusForAuthenticatedUserResponseOwner]
  }
}
