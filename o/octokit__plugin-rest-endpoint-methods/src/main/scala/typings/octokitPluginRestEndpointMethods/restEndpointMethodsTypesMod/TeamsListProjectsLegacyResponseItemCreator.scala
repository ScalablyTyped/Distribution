...
trait TeamsListProjectsLegacyResponseItemCreator extends js.Object {
...
object TeamsListProjectsLegacyResponseItemCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListProjectsLegacyResponseItemCreator]
  }
}
