...
trait GistsCreateResponseHistoryItemUser extends js.Object {
...
object GistsCreateResponseHistoryItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[GistsCreateResponseHistoryItemUser]
  }
}
