...
trait AnonCreateForCommitComment extends js.Object {
  ...
  var createForCommitComment_Original: Anon294 = js.native
  /**
  ...
  var createForIssueComment_Original: Anon296 = js.native
  /**
    * Create a reaction to an [issue](https://developer.github.com/v3/issues/). A response with a `Status: 200 OK` means that you already added the reaction type to this issue.
    */
  @JSName("createForIssue")
  var createForIssue_Original: Anon295 = js.native
  /**
  ...
  var createForPullRequestReviewComment_Original: Anon297 = js.native
  /**
  ...
  var createForTeamDiscussionCommentInOrg_Original: Anon298 = js.native
  /**
  ...
  var createForTeamDiscussionInOrg_Original: Anon299 = js.native
  /**
  ...
  var deleteForCommitComment_Original: Anon301 = js.native
  /**
  ...
  var deleteForIssueComment_Original: Anon303 = js.native
  /**
  ...
  var deleteForIssue_Original: Anon302 = js.native
  /**
  ...
  var deleteForPullRequestComment_Original: Anon304 = js.native
  /**
  ...
  var deleteForTeamDiscussionComment_Original: Anon306 = js.native
  /**
  ...
  var deleteForTeamDiscussion_Original: Anon305 = js.native
  /**
    ...
    */
  @JSName("deleteLegacy")
  var deleteLegacy_Original: Anon307 = js.native
  /**
    * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Reactions API. We recommend migrating your existing code to use the new delete reactions endpoints. For more information, see this [blog post](https://developer.github.com/changes/2020-02-26-new-delete-reactions-endpoints/).
    *
    * OAuth access tokens require the `write:discussion` [scope](https://developer.github.com/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/), when deleting a [team discussion](https://developer.github.com/v3/teams/discussions/) or [team discussion comment](https://developer.github.com/v3/teams/discussion_comments/).
    ...
    */
  @JSName("delete")
  var delete_Original: Anon300 = js.native
  /**
    * List the reactions to a [commit comment](https://developer.github.com/v3/repos/comments/).
    */
  @JSName("listForCommitComment")
  var listForCommitComment_Original: Anon308 = js.native
  /**
    * List the reactions to an [issue comment](https://developer.github.com/v3/issues/comments/).
    */
  @JSName("listForIssueComment")
  var listForIssueComment_Original: Anon310 = js.native
  /**
    * List the reactions to an [issue](https://developer.github.com/v3/issues/).
    */
  @JSName("listForIssue")
  var listForIssue_Original: Anon309 = js.native
  /**
  ...
  var listForPullRequestReviewComment_Original: Anon311 = js.native
  /**
  ...
  var listForTeamDiscussionCommentInOrg_Original: Anon312 = js.native
  /**
  ...
  var listForTeamDiscussionInOrg_Original: Anon313 = js.native
  /**
    * Create a reaction to a [commit comment](https://developer.github.com/v3/repos/comments/). A response with a `Status: 200 OK` means that you already added the reaction type to this commit comment.
    */
