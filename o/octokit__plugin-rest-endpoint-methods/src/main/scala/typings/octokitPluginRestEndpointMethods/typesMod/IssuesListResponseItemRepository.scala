...
trait IssuesListResponseItemRepository extends js.Object {
  ...
  var owner: IssuesListResponseItemRepositoryOwner
  var permissions: IssuesListResponseItemRepositoryPermissions
  var `private`: Boolean
...
object IssuesListResponseItemRepository {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListResponseItemRepository]
  }
}
