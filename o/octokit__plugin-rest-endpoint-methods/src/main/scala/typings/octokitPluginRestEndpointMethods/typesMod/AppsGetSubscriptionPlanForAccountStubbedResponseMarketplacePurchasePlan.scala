...
trait AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePurchasePlan extends js.Object {
...
object AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePurchasePlan {
  @scala.inline
  def apply(
    accounts_url: String,
  ...
  ): AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePurchasePlan = {
    ...
    __obj.asInstanceOf[AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePurchasePlan]
  }
}
