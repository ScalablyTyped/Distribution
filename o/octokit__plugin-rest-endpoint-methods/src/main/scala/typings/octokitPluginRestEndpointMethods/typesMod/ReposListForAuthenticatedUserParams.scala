...
trait ReposListForAuthenticatedUserParams extends js.Object {
  /**
...
object ReposListForAuthenticatedUserParams {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListForAuthenticatedUserParams]
  }
}
