...
trait AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePendingChangePlan extends js.Object {
...
object AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePendingChangePlan {
  @scala.inline
  def apply(
    accounts_url: String,
  ...
  ): AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePendingChangePlan = {
    ...
    __obj.asInstanceOf[AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePendingChangePlan]
  }
}
