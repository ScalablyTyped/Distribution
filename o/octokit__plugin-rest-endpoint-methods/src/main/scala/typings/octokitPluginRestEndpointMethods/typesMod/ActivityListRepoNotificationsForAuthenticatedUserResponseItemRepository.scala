...
trait ActivityListRepoNotificationsForAuthenticatedUserResponseItemRepository extends js.Object {
  ...
  var owner: ActivityListRepoNotificationsForAuthenticatedUserResponseItemRepositoryOwner
  var `private`: Boolean
...
object ActivityListRepoNotificationsForAuthenticatedUserResponseItemRepository {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    trees_url: String,
    url: String
  ): ActivityListRepoNotificationsForAuthenticatedUserResponseItemRepository = {
    ...
    __obj.asInstanceOf[ActivityListRepoNotificationsForAuthenticatedUserResponseItemRepository]
  }
}
