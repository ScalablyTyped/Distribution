...
trait AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItem extends js.Object {
  ...
  var owner: AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemOwner
  var permissions: AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemPermissions
  var `private`: Boolean
...
object AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItem]
  }
}
