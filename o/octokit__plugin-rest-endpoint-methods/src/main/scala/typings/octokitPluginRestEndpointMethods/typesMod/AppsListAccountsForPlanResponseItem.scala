...
trait AppsListAccountsForPlanResponseItem extends js.Object {
  var email: Null
  var id: Double
  var login: String
  var marketplace_pending_change: AppsListAccountsForPlanResponseItemMarketplacePendingChange
  var marketplace_purchase: AppsListAccountsForPlanResponseItemMarketplacePurchase
  var organization_billing_email: String
  var `type`: String
  var url: String
}

object AppsListAccountsForPlanResponseItem {
  @scala.inline
  def apply(
    email: Null,
    id: Double,
    ...
    __obj.asInstanceOf[AppsListAccountsForPlanResponseItem]
  }
}
