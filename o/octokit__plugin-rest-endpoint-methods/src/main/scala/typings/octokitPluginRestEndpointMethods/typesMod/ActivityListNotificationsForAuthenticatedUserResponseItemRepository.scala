...
trait ActivityListNotificationsForAuthenticatedUserResponseItemRepository extends js.Object {
  ...
  var owner: ActivityListNotificationsForAuthenticatedUserResponseItemRepositoryOwner
  var `private`: Boolean
...
object ActivityListNotificationsForAuthenticatedUserResponseItemRepository {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    trees_url: String,
    url: String
  ): ActivityListNotificationsForAuthenticatedUserResponseItemRepository = {
    ...
    __obj.asInstanceOf[ActivityListNotificationsForAuthenticatedUserResponseItemRepository]
  }
}
