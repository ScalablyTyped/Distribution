...
trait AppsListAccountsForPlanStubbedResponseItemMarketplacePurchasePlan extends js.Object {
...
object AppsListAccountsForPlanStubbedResponseItemMarketplacePurchasePlan {
  @scala.inline
  def apply(
    accounts_url: String,
  ...
  ): AppsListAccountsForPlanStubbedResponseItemMarketplacePurchasePlan = {
    ...
    __obj.asInstanceOf[AppsListAccountsForPlanStubbedResponseItemMarketplacePurchasePlan]
  }
}
