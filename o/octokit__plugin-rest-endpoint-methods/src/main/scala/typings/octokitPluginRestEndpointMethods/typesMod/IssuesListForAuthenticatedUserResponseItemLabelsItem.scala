...
trait IssuesListForAuthenticatedUserResponseItemLabelsItem extends js.Object {
  var color: String
  var default: Boolean
...
object IssuesListForAuthenticatedUserResponseItemLabelsItem {
  @scala.inline
  def apply(
    color: String,
    default: Boolean,
    ...
    __obj.asInstanceOf[IssuesListForAuthenticatedUserResponseItemLabelsItem]
  }
}
