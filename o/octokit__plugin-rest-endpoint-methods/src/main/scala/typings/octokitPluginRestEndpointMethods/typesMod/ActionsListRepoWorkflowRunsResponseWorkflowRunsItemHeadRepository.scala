...
trait ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepository extends js.Object {
  ...
  var owner: ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner
  var `private`: Boolean
...
object ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepository {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    __obj.asInstanceOf[ActionsListRepoWorkflowRunsResponseWorkflowRunsItemHeadRepository]
  }
}
