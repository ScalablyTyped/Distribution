...
trait OrgsCreateInvitationResponseInviter extends js.Object {
...
object OrgsCreateInvitationResponseInviter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[OrgsCreateInvitationResponseInviter]
  }
}
