...
trait AppsGetRepoInstallationResponseAccount extends js.Object {
...
object AppsGetRepoInstallationResponseAccount {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[AppsGetRepoInstallationResponseAccount]
  }
}
