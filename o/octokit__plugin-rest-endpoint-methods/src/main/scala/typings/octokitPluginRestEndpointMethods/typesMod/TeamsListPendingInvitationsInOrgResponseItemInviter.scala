...
trait TeamsListPendingInvitationsInOrgResponseItemInviter extends js.Object {
...
object TeamsListPendingInvitationsInOrgResponseItemInviter {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListPendingInvitationsInOrgResponseItemInviter]
  }
}
