...
trait OrgsGetMembershipForAuthenticatedUserResponseOrganization extends js.Object {
...
object OrgsGetMembershipForAuthenticatedUserResponseOrganization {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[OrgsGetMembershipForAuthenticatedUserResponseOrganization]
  }
}
