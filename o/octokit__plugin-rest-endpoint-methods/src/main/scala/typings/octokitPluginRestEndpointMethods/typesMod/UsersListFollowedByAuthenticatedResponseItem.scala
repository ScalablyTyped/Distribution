...
trait UsersListFollowedByAuthenticatedResponseItem extends js.Object {
...
object UsersListFollowedByAuthenticatedResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[UsersListFollowedByAuthenticatedResponseItem]
  }
}
