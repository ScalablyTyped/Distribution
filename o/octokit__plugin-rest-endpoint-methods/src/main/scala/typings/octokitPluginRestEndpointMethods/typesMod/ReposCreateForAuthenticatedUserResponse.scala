...
trait ReposCreateForAuthenticatedUserResponse extends js.Object {
  ...
  var owner: ReposCreateForAuthenticatedUserResponseOwner
  var permissions: ReposCreateForAuthenticatedUserResponsePermissions
  var `private`: Boolean
...
object ReposCreateForAuthenticatedUserResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateForAuthenticatedUserResponse]
  }
}
