...
trait ReposCreateForAuthenticatedUserResponseOwner extends js.Object {
...
object ReposCreateForAuthenticatedUserResponseOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCreateForAuthenticatedUserResponseOwner]
  }
}
