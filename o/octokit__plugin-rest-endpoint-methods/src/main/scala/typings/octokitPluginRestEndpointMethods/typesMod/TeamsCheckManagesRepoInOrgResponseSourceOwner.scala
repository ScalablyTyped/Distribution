...
trait TeamsCheckManagesRepoInOrgResponseSourceOwner extends js.Object {
...
object TeamsCheckManagesRepoInOrgResponseSourceOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    `type`: String,
    url: String
  ): TeamsCheckManagesRepoInOrgResponseSourceOwner = {
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoInOrgResponseSourceOwner]
  }
}
