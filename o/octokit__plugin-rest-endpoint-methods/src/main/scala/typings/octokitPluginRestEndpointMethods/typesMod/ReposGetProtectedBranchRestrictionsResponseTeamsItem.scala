...
trait ReposGetProtectedBranchRestrictionsResponseTeamsItem extends js.Object {
...
object ReposGetProtectedBranchRestrictionsResponseTeamsItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchRestrictionsResponseTeamsItem]
  }
}
