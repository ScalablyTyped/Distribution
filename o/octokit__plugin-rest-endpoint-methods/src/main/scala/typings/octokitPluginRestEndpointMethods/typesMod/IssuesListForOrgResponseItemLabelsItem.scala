...
trait IssuesListForOrgResponseItemLabelsItem extends js.Object {
  var color: String
  var default: Boolean
...
object IssuesListForOrgResponseItemLabelsItem {
  @scala.inline
  def apply(
    color: String,
    default: Boolean,
    ...
    __obj.asInstanceOf[IssuesListForOrgResponseItemLabelsItem]
  }
}
