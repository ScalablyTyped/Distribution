...
trait ProjectsReviewUserPermissionLevelResponseUser extends js.Object {
...
object ProjectsReviewUserPermissionLevelResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ProjectsReviewUserPermissionLevelResponseUser]
  }
}
