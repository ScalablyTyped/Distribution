...
trait GistsListForUserResponseItem extends js.Object {
  var comments: Double
  var comments_url: String
  var commits_url: String
  var created_at: String
  var description: String
  var files: GistsListForUserResponseItemFiles
  ...
  var id: String
  var node_id: String
  var owner: GistsListForUserResponseItemOwner
  var public: Boolean
...
object GistsListForUserResponseItem {
  @scala.inline
  def apply(
    comments: Double,
    comments_url: String,
    ...
    __obj.asInstanceOf[GistsListForUserResponseItem]
  }
}
