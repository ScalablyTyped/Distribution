...
trait ReposGetBranchProtectionResponseRestrictionsTeamsItem extends js.Object {
...
object ReposGetBranchProtectionResponseRestrictionsTeamsItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[ReposGetBranchProtectionResponseRestrictionsTeamsItem]
  }
}
