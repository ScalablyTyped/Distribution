...
trait PullsListCommentsForRepoResponseItem extends js.Object {
  var _links: PullsListCommentsForRepoResponseItemLinks
  ...
  var url: String
  var user: PullsListCommentsForRepoResponseItemUser
}

object PullsListCommentsForRepoResponseItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsListCommentsForRepoResponseItem]
  }
}
