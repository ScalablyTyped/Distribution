...
trait ReposUploadReleaseAssetResponseUploader extends js.Object {
...
object ReposUploadReleaseAssetResponseUploader {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    `type`: String,
    url: String
  ): ReposUploadReleaseAssetResponseUploader = {
    ...
    __obj.asInstanceOf[ReposUploadReleaseAssetResponseUploader]
  }
}
