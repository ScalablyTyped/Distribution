...
trait AppsGetSubscriptionPlanForAccountResponse extends js.Object {
  var email: Null
  var id: Double
  var login: String
  var marketplace_pending_change: AppsGetSubscriptionPlanForAccountResponseMarketplacePendingChange
  var marketplace_purchase: AppsGetSubscriptionPlanForAccountResponseMarketplacePurchase
  var organization_billing_email: String
  var `type`: String
  var url: String
}

object AppsGetSubscriptionPlanForAccountResponse {
  @scala.inline
  def apply(
    email: Null,
    id: Double,
    ...
    __obj.asInstanceOf[AppsGetSubscriptionPlanForAccountResponse]
  }
}
