...
trait ActivityListRepoNotificationsForAuthenticatedUserResponseItem extends js.Object {
  var id: String
  var last_read_at: String
  var reason: String
  var repository: ActivityListRepoNotificationsForAuthenticatedUserResponseItemRepository
  var subject: ActivityListRepoNotificationsForAuthenticatedUserResponseItemSubject
  var unread: Boolean
  var updated_at: String
  var url: String
}

object ActivityListRepoNotificationsForAuthenticatedUserResponseItem {
  @scala.inline
  def apply(
    id: String,
    last_read_at: String,
    ...
    __obj.asInstanceOf[ActivityListRepoNotificationsForAuthenticatedUserResponseItem]
  }
}
