...
trait ReposListForksResponseItem extends js.Object {
  ...
  var license: ReposListForksResponseItemLicense
  ...
  var owner: ReposListForksResponseItemOwner
  var permissions: ReposListForksResponseItemPermissions
  var `private`: Boolean
...
object ReposListForksResponseItem {
  @scala.inline
  def apply(
    archive_url: String,
    archived: Boolean,
    ...
    __obj.asInstanceOf[ReposListForksResponseItem]
  }
}
