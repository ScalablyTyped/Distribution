...
trait ReposUpdateReleaseResponseAssetsItemUploader extends js.Object {
...
object ReposUpdateReleaseResponseAssetsItemUploader {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposUpdateReleaseResponseAssetsItemUploader]
  }
}
