...
trait ReposRemoveProtectedBranchAppRestrictionsResponseItem extends js.Object {
  ...
  var name: String
  var node_id: String
  var owner: ReposRemoveProtectedBranchAppRestrictionsResponseItemOwner
  var permissions: ReposRemoveProtectedBranchAppRestrictionsResponseItemPermissions
  var slug: String
  var updated_at: String
}

object ReposRemoveProtectedBranchAppRestrictionsResponseItem {
  @scala.inline
  def apply(
    created_at: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposRemoveProtectedBranchAppRestrictionsResponseItem]
  }
}
