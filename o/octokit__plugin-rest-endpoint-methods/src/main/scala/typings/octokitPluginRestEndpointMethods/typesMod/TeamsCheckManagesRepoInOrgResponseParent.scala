...
trait TeamsCheckManagesRepoInOrgResponseParent extends js.Object {
  ...
  var owner: TeamsCheckManagesRepoInOrgResponseParentOwner
  var permissions: TeamsCheckManagesRepoInOrgResponseParentPermissions
  var `private`: Boolean
...
object TeamsCheckManagesRepoInOrgResponseParent {
  @scala.inline
  def apply(
  ...
  ): TeamsCheckManagesRepoInOrgResponseParent = {
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoInOrgResponseParent]
  }
}
