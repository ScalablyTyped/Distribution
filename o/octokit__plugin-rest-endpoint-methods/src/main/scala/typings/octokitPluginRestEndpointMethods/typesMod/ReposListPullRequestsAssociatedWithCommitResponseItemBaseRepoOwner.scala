...
trait ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoOwner extends js.Object {
...
object ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoOwner]
  }
}
