...
trait AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePurchase extends js.Object {
  var billing_cycle: String
  var free_trial_ends_on: String
  var next_billing_date: String
  var on_free_trial: Boolean
  var plan: AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePurchasePlan
  var unit_count: Null
  var updated_at: String
}

object AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePurchase {
  @scala.inline
  def apply(
    ...
    unit_count: Null,
    updated_at: String
  ): AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePurchase = {
    ...
    __obj.asInstanceOf[AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePurchase]
  }
}
