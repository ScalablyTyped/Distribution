...
trait PullsGetResponseRequestedReviewersItem extends js.Object {
...
object PullsGetResponseRequestedReviewersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsGetResponseRequestedReviewersItem]
  }
}
