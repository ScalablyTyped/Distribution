...
trait ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepositoryOwner extends js.Object {
...
object ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActionsListRepoWorkflowRunsResponseWorkflowRunsItemRepositoryOwner]
  }
}
