...
trait ReposUpdateCommitCommentResponseUser extends js.Object {
...
object ReposUpdateCommitCommentResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposUpdateCommitCommentResponseUser]
  }
}
