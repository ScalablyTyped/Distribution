...
trait ActivityGetThreadSubscriptionForAuthenticatedUserResponse extends js.Object {
...
object ActivityGetThreadSubscriptionForAuthenticatedUserResponse {
  @scala.inline
  def apply(
    created_at: String,
    ignored: Boolean,
    ...
    __obj.asInstanceOf[ActivityGetThreadSubscriptionForAuthenticatedUserResponse]
  }
}
