...
trait AppsGetSubscriptionPlanForAccountResponseMarketplacePendingChangePlan extends js.Object {
...
object AppsGetSubscriptionPlanForAccountResponseMarketplacePendingChangePlan {
  @scala.inline
  def apply(
    accounts_url: String,
  ...
  ): AppsGetSubscriptionPlanForAccountResponseMarketplacePendingChangePlan = {
    ...
    __obj.asInstanceOf[AppsGetSubscriptionPlanForAccountResponseMarketplacePendingChangePlan]
  }
}
