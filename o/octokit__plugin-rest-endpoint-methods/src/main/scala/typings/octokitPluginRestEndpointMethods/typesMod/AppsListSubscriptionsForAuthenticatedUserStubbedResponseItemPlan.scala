...
trait AppsListSubscriptionsForAuthenticatedUserStubbedResponseItemPlan extends js.Object {
...
object AppsListSubscriptionsForAuthenticatedUserStubbedResponseItemPlan {
  @scala.inline
  def apply(
    accounts_url: String,
