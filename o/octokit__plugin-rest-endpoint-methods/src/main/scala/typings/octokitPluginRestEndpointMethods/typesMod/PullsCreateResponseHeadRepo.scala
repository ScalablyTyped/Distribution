...
trait PullsCreateResponseHeadRepo extends js.Object {
  ...
  var owner: PullsCreateResponseHeadRepoOwner
  var permissions: PullsCreateResponseHeadRepoPermissions
  var `private`: Boolean
...
object PullsCreateResponseHeadRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateResponseHeadRepo]
  }
}
