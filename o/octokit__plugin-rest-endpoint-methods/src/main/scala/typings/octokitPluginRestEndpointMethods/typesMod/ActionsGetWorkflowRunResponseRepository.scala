...
trait ActionsGetWorkflowRunResponseRepository extends js.Object {
  ...
  var owner: ActionsGetWorkflowRunResponseRepositoryOwner
  var `private`: Boolean
...
object ActionsGetWorkflowRunResponseRepository {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    __obj.asInstanceOf[ActionsGetWorkflowRunResponseRepository]
  }
}
