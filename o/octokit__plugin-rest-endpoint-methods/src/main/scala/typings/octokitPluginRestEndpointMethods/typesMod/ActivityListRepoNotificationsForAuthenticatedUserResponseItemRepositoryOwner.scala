...
trait ActivityListRepoNotificationsForAuthenticatedUserResponseItemRepositoryOwner extends js.Object {
...
object ActivityListRepoNotificationsForAuthenticatedUserResponseItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    `type`: String,
    url: String
  ): ActivityListRepoNotificationsForAuthenticatedUserResponseItemRepositoryOwner = {
    ...
    __obj.asInstanceOf[ActivityListRepoNotificationsForAuthenticatedUserResponseItemRepositoryOwner]
  }
}
