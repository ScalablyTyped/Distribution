...
trait IssuesListResponseItemAssigneesItem extends js.Object {
...
object IssuesListResponseItemAssigneesItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListResponseItemAssigneesItem]
  }
}
