...
trait ReposCreateForkResponse extends js.Object {
  ...
  var owner: ReposCreateForkResponseOwner
  var permissions: ReposCreateForkResponsePermissions
  var `private`: Boolean
...
object ReposCreateForkResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateForkResponse]
  }
}
