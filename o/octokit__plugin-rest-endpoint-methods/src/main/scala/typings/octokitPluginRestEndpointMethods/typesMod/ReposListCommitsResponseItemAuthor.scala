...
trait ReposListCommitsResponseItemAuthor extends js.Object {
...
object ReposListCommitsResponseItemAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListCommitsResponseItemAuthor]
  }
}
