...
trait MigrationsStartForAuthenticatedUserResponseRepositoriesItem extends js.Object {
  ...
  var owner: MigrationsStartForAuthenticatedUserResponseRepositoriesItemOwner
  var permissions: MigrationsStartForAuthenticatedUserResponseRepositoriesItemPermissions
  var `private`: Boolean
...
object MigrationsStartForAuthenticatedUserResponseRepositoriesItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsStartForAuthenticatedUserResponseRepositoriesItem]
  }
}
