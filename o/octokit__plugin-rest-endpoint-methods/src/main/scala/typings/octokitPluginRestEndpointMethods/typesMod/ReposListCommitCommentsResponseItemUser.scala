...
trait ReposListCommitCommentsResponseItemUser extends js.Object {
...
object ReposListCommitCommentsResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposListCommitCommentsResponseItemUser]
  }
}
