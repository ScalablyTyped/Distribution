...
trait TeamsCheckManagesRepoInOrgResponseParentOwner extends js.Object {
...
object TeamsCheckManagesRepoInOrgResponseParentOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    `type`: String,
    url: String
  ): TeamsCheckManagesRepoInOrgResponseParentOwner = {
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoInOrgResponseParentOwner]
  }
}
