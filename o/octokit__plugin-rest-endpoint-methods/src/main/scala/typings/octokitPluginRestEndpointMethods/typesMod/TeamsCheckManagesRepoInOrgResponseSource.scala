...
trait TeamsCheckManagesRepoInOrgResponseSource extends js.Object {
  ...
  var owner: TeamsCheckManagesRepoInOrgResponseSourceOwner
  var permissions: TeamsCheckManagesRepoInOrgResponseSourcePermissions
  var `private`: Boolean
...
object TeamsCheckManagesRepoInOrgResponseSource {
  @scala.inline
  def apply(
  ...
  ): TeamsCheckManagesRepoInOrgResponseSource = {
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoInOrgResponseSource]
  }
}
