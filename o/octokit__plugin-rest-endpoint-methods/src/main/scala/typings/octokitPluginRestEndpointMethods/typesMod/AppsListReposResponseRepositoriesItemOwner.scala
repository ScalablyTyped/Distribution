...
trait AppsListReposResponseRepositoriesItemOwner extends js.Object {
...
object AppsListReposResponseRepositoriesItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[AppsListReposResponseRepositoriesItemOwner]
  }
}
