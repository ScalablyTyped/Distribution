...
trait AppsListSubscriptionsForAuthenticatedUserStubbedResponseItem extends js.Object {
  var account: AppsListSubscriptionsForAuthenticatedUserStubbedResponseItemAccount
  var billing_cycle: String
  var free_trial_ends_on: String
  var next_billing_date: String
  var on_free_trial: Boolean
  var plan: AppsListSubscriptionsForAuthenticatedUserStubbedResponseItemPlan
  var unit_count: Null
  var updated_at: String
}

object AppsListSubscriptionsForAuthenticatedUserStubbedResponseItem {
  @scala.inline
  def apply(
