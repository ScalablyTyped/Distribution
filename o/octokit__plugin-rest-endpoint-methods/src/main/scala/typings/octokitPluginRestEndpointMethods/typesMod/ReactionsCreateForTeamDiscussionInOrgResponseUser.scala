...
trait ReactionsCreateForTeamDiscussionInOrgResponseUser extends js.Object {
...
object ReactionsCreateForTeamDiscussionInOrgResponseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReactionsCreateForTeamDiscussionInOrgResponseUser]
  }
}
