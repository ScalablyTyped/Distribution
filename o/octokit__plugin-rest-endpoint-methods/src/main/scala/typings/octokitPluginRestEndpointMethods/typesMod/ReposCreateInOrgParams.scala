...
import typings.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.visibility
...
trait ReposCreateInOrgParams extends js.Object {
  ...
  var visibility: js.UndefOr[
    public | `private` | typings.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.visibility | internal
  ] = js.undefined
}
