...
trait ReposUpdateBranchProtectionResponseRestrictionsUsersItem extends js.Object {
...
object ReposUpdateBranchProtectionResponseRestrictionsUsersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposUpdateBranchProtectionResponseRestrictionsUsersItem]
  }
}
