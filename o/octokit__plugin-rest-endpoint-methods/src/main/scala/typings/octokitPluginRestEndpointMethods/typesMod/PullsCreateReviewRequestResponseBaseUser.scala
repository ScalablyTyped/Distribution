...
trait PullsCreateReviewRequestResponseBaseUser extends js.Object {
...
object PullsCreateReviewRequestResponseBaseUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseBaseUser]
  }
}
