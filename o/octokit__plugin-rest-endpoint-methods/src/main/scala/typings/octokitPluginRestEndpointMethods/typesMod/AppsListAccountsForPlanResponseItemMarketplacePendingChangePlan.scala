...
trait AppsListAccountsForPlanResponseItemMarketplacePendingChangePlan extends js.Object {
...
object AppsListAccountsForPlanResponseItemMarketplacePendingChangePlan {
  @scala.inline
  def apply(
    accounts_url: String,
  ...
  ): AppsListAccountsForPlanResponseItemMarketplacePendingChangePlan = {
    ...
    __obj.asInstanceOf[AppsListAccountsForPlanResponseItemMarketplacePendingChangePlan]
  }
}
