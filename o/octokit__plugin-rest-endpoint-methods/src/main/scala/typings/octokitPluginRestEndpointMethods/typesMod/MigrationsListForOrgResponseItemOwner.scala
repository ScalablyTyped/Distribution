...
trait MigrationsListForOrgResponseItemOwner extends js.Object {
...
object MigrationsListForOrgResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[MigrationsListForOrgResponseItemOwner]
  }
}
