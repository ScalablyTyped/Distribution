...
trait AppsGetSubscriptionPlanForAccountResponseMarketplacePurchasePlan extends js.Object {
...
object AppsGetSubscriptionPlanForAccountResponseMarketplacePurchasePlan {
  @scala.inline
  def apply(
    accounts_url: String,
  ...
  ): AppsGetSubscriptionPlanForAccountResponseMarketplacePurchasePlan = {
    ...
    __obj.asInstanceOf[AppsGetSubscriptionPlanForAccountResponseMarketplacePurchasePlan]
  }
}
