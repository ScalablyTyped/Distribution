...
trait TeamsCheckManagesRepoInOrgResponseOrganization extends js.Object {
...
object TeamsCheckManagesRepoInOrgResponseOrganization {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    `type`: String,
    url: String
  ): TeamsCheckManagesRepoInOrgResponseOrganization = {
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoInOrgResponseOrganization]
  }
}
