...
trait ChecksListForSuiteResponseCheckRunsItemApp extends js.Object {
  ...
  var name: String
  var node_id: String
  var owner: ChecksListForSuiteResponseCheckRunsItemAppOwner
  var permissions: ChecksListForSuiteResponseCheckRunsItemAppPermissions
  var slug: String
  var updated_at: String
}

object ChecksListForSuiteResponseCheckRunsItemApp {
  @scala.inline
  def apply(
    created_at: String,
    description: String,
    ...
    __obj.asInstanceOf[ChecksListForSuiteResponseCheckRunsItemApp]
  }
}
