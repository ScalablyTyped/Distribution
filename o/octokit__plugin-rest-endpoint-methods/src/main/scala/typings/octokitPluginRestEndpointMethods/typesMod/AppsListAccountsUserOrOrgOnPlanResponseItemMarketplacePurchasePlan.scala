...
trait AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchasePlan extends js.Object {
...
object AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchasePlan {
  @scala.inline
  def apply(
    accounts_url: String,
    ...
    __obj.asInstanceOf[AppsListAccountsUserOrOrgOnPlanResponseItemMarketplacePurchasePlan]
  }
}
