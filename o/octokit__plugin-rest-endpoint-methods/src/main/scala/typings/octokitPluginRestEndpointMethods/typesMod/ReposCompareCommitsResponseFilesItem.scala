...
trait ReposCompareCommitsResponseFilesItem extends js.Object {
...
object ReposCompareCommitsResponseFilesItem {
  @scala.inline
  def apply(
    additions: Double,
    blob_url: String,
    ...
    __obj.asInstanceOf[ReposCompareCommitsResponseFilesItem]
  }
}
