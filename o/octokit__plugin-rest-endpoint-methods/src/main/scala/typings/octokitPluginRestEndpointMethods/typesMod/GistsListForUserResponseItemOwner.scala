...
trait GistsListForUserResponseItemOwner extends js.Object {
...
object GistsListForUserResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    `type`: String,
    url: String
  ): GistsListForUserResponseItemOwner = {
    ...
    __obj.asInstanceOf[GistsListForUserResponseItemOwner]
  }
}
