...
import typings.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.QuotationmarkmasterQuotationmark
import typings.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.`Quotationmarkgh-pagesQuotationmark`
import typings.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.`Quotationmarkmaster SlashdocsQuotationmark`
