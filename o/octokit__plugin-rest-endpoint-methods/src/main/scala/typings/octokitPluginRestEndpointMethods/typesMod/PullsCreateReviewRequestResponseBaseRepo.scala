...
trait PullsCreateReviewRequestResponseBaseRepo extends js.Object {
  ...
  var owner: PullsCreateReviewRequestResponseBaseRepoOwner
  var permissions: PullsCreateReviewRequestResponseBaseRepoPermissions
  var `private`: Boolean
...
object PullsCreateReviewRequestResponseBaseRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseBaseRepo]
  }
}
