...
trait PullsListCommentsForRepoResponseItemUser extends js.Object {
...
object PullsListCommentsForRepoResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsListCommentsForRepoResponseItemUser]
  }
}
