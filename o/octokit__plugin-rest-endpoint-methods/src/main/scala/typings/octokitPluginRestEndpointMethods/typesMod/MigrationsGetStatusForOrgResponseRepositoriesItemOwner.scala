...
trait MigrationsGetStatusForOrgResponseRepositoriesItemOwner extends js.Object {
...
object MigrationsGetStatusForOrgResponseRepositoriesItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[MigrationsGetStatusForOrgResponseRepositoriesItemOwner]
  }
}
