...
trait ChecksListForSuiteResponseCheckRunsItemAppOwner extends js.Object {
...
object ChecksListForSuiteResponseCheckRunsItemAppOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[ChecksListForSuiteResponseCheckRunsItemAppOwner]
  }
}
