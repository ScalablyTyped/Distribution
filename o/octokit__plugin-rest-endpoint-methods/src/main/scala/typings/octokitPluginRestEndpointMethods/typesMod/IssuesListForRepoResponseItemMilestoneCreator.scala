...
trait IssuesListForRepoResponseItemMilestoneCreator extends js.Object {
...
object IssuesListForRepoResponseItemMilestoneCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListForRepoResponseItemMilestoneCreator]
  }
}
