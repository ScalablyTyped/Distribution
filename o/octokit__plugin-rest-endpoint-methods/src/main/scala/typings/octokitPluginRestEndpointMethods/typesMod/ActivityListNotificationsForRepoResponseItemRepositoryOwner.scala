...
trait ActivityListNotificationsForRepoResponseItemRepositoryOwner extends js.Object {
...
object ActivityListNotificationsForRepoResponseItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActivityListNotificationsForRepoResponseItemRepositoryOwner]
  }
}
