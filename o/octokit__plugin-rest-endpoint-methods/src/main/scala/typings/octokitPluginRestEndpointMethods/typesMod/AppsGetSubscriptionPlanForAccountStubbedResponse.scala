...
trait AppsGetSubscriptionPlanForAccountStubbedResponse extends js.Object {
  var email: Null
  var id: Double
  var login: String
  var marketplace_pending_change: AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePendingChange
  var marketplace_purchase: AppsGetSubscriptionPlanForAccountStubbedResponseMarketplacePurchase
  var organization_billing_email: String
  var `type`: String
  var url: String
}

object AppsGetSubscriptionPlanForAccountStubbedResponse {
  @scala.inline
  def apply(
    email: Null,
    id: Double,
    ...
    __obj.asInstanceOf[AppsGetSubscriptionPlanForAccountStubbedResponse]
  }
}
