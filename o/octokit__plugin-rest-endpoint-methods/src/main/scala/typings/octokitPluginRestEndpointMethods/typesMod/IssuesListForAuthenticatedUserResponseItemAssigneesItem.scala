...
trait IssuesListForAuthenticatedUserResponseItemAssigneesItem extends js.Object {
...
object IssuesListForAuthenticatedUserResponseItemAssigneesItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListForAuthenticatedUserResponseItemAssigneesItem]
  }
}
