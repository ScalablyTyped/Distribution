...
trait ActivityListRepoNotificationsForAuthenticatedUserParams extends js.Object {
  /**
...
object ActivityListRepoNotificationsForAuthenticatedUserParams {
  @scala.inline
  def apply(
    owner: String,
    repo: String,
    ...
    __obj.asInstanceOf[ActivityListRepoNotificationsForAuthenticatedUserParams]
  }
}
