...
trait ActivityListNotificationsForAuthenticatedUserParams extends js.Object {
  /**
...
object ActivityListNotificationsForAuthenticatedUserParams {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListNotificationsForAuthenticatedUserParams]
  }
}
