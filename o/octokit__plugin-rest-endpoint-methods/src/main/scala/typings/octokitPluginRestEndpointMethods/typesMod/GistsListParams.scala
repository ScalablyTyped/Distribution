...
trait GistsListParams extends js.Object {
  /**
...
object GistsListParams {
  @scala.inline
  def apply(page: Int | Double = null, per_page: Int | Double = null, since: String = null): GistsListParams = {
