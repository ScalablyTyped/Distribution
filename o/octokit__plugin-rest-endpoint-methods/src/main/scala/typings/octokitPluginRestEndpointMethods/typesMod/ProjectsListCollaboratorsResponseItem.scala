...
trait ProjectsListCollaboratorsResponseItem extends js.Object {
...
object ProjectsListCollaboratorsResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ProjectsListCollaboratorsResponseItem]
  }
}
