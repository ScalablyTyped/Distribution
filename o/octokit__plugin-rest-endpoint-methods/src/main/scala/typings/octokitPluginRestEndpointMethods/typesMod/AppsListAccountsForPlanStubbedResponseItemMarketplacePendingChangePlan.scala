...
trait AppsListAccountsForPlanStubbedResponseItemMarketplacePendingChangePlan extends js.Object {
...
object AppsListAccountsForPlanStubbedResponseItemMarketplacePendingChangePlan {
  @scala.inline
  def apply(
    accounts_url: String,
  ...
  ): AppsListAccountsForPlanStubbedResponseItemMarketplacePendingChangePlan = {
    ...
    __obj.asInstanceOf[AppsListAccountsForPlanStubbedResponseItemMarketplacePendingChangePlan]
  }
}
