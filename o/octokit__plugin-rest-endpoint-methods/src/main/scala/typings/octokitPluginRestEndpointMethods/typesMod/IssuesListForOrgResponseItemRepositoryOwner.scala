...
trait IssuesListForOrgResponseItemRepositoryOwner extends js.Object {
...
object IssuesListForOrgResponseItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListForOrgResponseItemRepositoryOwner]
  }
}
