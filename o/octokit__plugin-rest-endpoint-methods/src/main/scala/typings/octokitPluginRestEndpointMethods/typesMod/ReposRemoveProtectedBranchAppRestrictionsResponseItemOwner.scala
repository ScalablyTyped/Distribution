...
trait ReposRemoveProtectedBranchAppRestrictionsResponseItemOwner extends js.Object {
...
object ReposRemoveProtectedBranchAppRestrictionsResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[ReposRemoveProtectedBranchAppRestrictionsResponseItemOwner]
  }
}
