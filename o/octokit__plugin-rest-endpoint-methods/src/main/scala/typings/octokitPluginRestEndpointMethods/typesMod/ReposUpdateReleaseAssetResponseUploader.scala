...
trait ReposUpdateReleaseAssetResponseUploader extends js.Object {
...
object ReposUpdateReleaseAssetResponseUploader {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposUpdateReleaseAssetResponseUploader]
  }
}
