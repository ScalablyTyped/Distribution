...
trait ChecksListForSuiteResponseCheckRunsItemPullRequestsItemBaseRepo extends js.Object {
  var id: Double
  var name: String
  var url: String
}

object ChecksListForSuiteResponseCheckRunsItemPullRequestsItemBaseRepo {
  @scala.inline
