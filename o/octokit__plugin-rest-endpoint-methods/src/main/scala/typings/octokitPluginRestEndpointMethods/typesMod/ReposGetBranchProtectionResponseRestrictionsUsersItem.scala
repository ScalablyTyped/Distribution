...
trait ReposGetBranchProtectionResponseRestrictionsUsersItem extends js.Object {
...
object ReposGetBranchProtectionResponseRestrictionsUsersItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposGetBranchProtectionResponseRestrictionsUsersItem]
  }
}
