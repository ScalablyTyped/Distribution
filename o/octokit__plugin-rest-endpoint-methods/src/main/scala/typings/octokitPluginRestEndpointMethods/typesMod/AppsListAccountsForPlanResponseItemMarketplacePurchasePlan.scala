...
trait AppsListAccountsForPlanResponseItemMarketplacePurchasePlan extends js.Object {
...
object AppsListAccountsForPlanResponseItemMarketplacePurchasePlan {
  @scala.inline
  def apply(
    accounts_url: String,
  ...
  ): AppsListAccountsForPlanResponseItemMarketplacePurchasePlan = {
    ...
    __obj.asInstanceOf[AppsListAccountsForPlanResponseItemMarketplacePurchasePlan]
  }
}
