...
trait ReposAddProtectedBranchUserRestrictionsResponseItem extends js.Object {
...
object ReposAddProtectedBranchUserRestrictionsResponseItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposAddProtectedBranchUserRestrictionsResponseItem]
  }
}
