...
trait ActivityListNotificationsForRepoResponseItemRepository extends js.Object {
  ...
  var owner: ActivityListNotificationsForRepoResponseItemRepositoryOwner
  var `private`: Boolean
...
object ActivityListNotificationsForRepoResponseItemRepository {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    __obj.asInstanceOf[ActivityListNotificationsForRepoResponseItemRepository]
  }
}
