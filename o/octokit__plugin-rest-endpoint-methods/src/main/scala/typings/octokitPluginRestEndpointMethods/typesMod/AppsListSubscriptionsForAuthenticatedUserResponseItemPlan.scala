...
trait AppsListSubscriptionsForAuthenticatedUserResponseItemPlan extends js.Object {
...
object AppsListSubscriptionsForAuthenticatedUserResponseItemPlan {
  @scala.inline
  def apply(
    accounts_url: String,
  ...
  ): AppsListSubscriptionsForAuthenticatedUserResponseItemPlan = {
    ...
    __obj.asInstanceOf[AppsListSubscriptionsForAuthenticatedUserResponseItemPlan]
  }
}
