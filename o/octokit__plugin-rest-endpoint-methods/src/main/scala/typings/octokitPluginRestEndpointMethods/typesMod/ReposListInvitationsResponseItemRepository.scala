...
trait ReposListInvitationsResponseItemRepository extends js.Object {
  ...
  var owner: ReposListInvitationsResponseItemRepositoryOwner
  var `private`: Boolean
...
object ReposListInvitationsResponseItemRepository {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    __obj.asInstanceOf[ReposListInvitationsResponseItemRepository]
  }
}
