...
trait ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepo extends js.Object {
  ...
  var owner: ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoOwner
  var permissions: ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepoPermissions
  var `private`: Boolean
...
object ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepo {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListPullRequestsAssociatedWithCommitResponseItemBaseRepo]
  }
}
