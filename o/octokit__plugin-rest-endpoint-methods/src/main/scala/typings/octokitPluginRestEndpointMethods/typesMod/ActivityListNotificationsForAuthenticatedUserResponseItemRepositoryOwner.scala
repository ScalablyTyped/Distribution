...
trait ActivityListNotificationsForAuthenticatedUserResponseItemRepositoryOwner extends js.Object {
...
object ActivityListNotificationsForAuthenticatedUserResponseItemRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    `type`: String,
    url: String
  ): ActivityListNotificationsForAuthenticatedUserResponseItemRepositoryOwner = {
    ...
    __obj.asInstanceOf[ActivityListNotificationsForAuthenticatedUserResponseItemRepositoryOwner]
  }
}
