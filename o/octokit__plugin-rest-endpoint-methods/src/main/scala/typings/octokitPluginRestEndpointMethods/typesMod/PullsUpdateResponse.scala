...
trait PullsUpdateResponse extends js.Object {
  var _links: PullsUpdateResponseLinks
  var active_lock_reason: String
  var additions: Double
  var assignee: PullsUpdateResponseAssignee
  var assignees: js.Array[PullsUpdateResponseAssigneesItem]
  var author_association: String
  var base: PullsUpdateResponseBase
  var body: String
  ...
  var diff_url: String
  var draft: Boolean
  var head: PullsUpdateResponseHead
  var html_url: String
  var id: Double
  var issue_url: String
  var labels: js.Array[PullsUpdateResponseLabelsItem]
  var locked: Boolean
  ...
  var merged_by: PullsUpdateResponseMergedBy
  var milestone: PullsUpdateResponseMilestone
  var node_id: String
  var number: Double
  var patch_url: String
  var rebaseable: Boolean
  var requested_reviewers: js.Array[PullsUpdateResponseRequestedReviewersItem]
  var requested_teams: js.Array[PullsUpdateResponseRequestedTeamsItem]
  ...
  var url: String
  var user: PullsUpdateResponseUser
}
