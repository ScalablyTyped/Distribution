...
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.ActivityMarkThreadAsReadParams
...
@js.native
trait AnonEndpointParamsActivityMarkThreadAsReadParams extends js.Object {
