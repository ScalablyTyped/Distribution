...
import typings.octokitPluginRestEndpointMethods.anon.Get1011
import typings.octokitPluginRestEndpointMethods.anon.Get1267
...
object parametersAndResponseTypesMod {
  ...
  object RestEndpointMethodTypes {
    ...
    extension [Self <: RestEndpointMethodTypes](x: Self) {
      ...
      inline def setEmojis(value: Get1011): Self = StObject.set(x, "emojis", value.asInstanceOf[js.Any])
      ...
      inline def setRateLimit(value: Get1267): Self = StObject.set(x, "rateLimit", value.asInstanceOf[js.Any])
