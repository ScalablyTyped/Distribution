...
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsCreateRegistrationTokenParams
...
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsDeleteSecretFromRepoParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsDownloadArtifactParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsGetArtifactParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsGetPublicKeyParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsGetSecretParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsGetSelfHostedRunnerParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsGetWorkflowJobParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsGetWorkflowParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsGetWorkflowRunParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsListArtifactsForRepoParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsListDownloadsForSelfHostedRunnerApplicationParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsListJobsForWorkflowRunParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsListRepoWorkflowRunsParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsListRepoWorkflowsParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsListSecretsForRepoParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsListSelfHostedRunnersForRepoParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsListWorkflowJobLogsParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsListWorkflowRunArtifactsParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsListWorkflowRunLogsParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsListWorkflowRunsParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsReRunWorkflowParams
import typings.octokitPluginRestEndpointMethods.typesMod.ActionsRemoveSelfHostedRunnerParams
...
trait AnonCancelWorkflowRun extends js.Object {
  ...
  var listArtifactsForRepo_Original: Anon8 = js.native
  /**
  ...
  var listRepoWorkflowRuns_Original: Anon11 = js.native
  /**
  ...
  var listRepoWorkflows_Original: Anon12 = js.native
  /**
  ...
  var listSecretsForRepo_Original: Anon13 = js.native
  /**
  ...
  var listSelfHostedRunnersForRepo_Original: Anon14 = js.native
  /**
  ...
  var listWorkflowJobLogs_Original: Anon15 = js.native
  /**
  ...
  var listWorkflowRunArtifacts_Original: Anon16 = js.native
  /**
  ...
  var listWorkflowRunLogs_Original: Anon17 = js.native
  /**
  ...
  var listWorkflowRuns_Original: Anon18 = js.native
  /**
  ...
  var reRunWorkflow_Original: Anon19 = js.native
  /**
  ...
  var removeSelfHostedRunner_Original: Anon20 = js.native
  /**
    * Cancels a workflow run using its `id`. Anyone with write access to the repository can use this endpoint. GitHub Apps must have the `actions` permission to use this endpoint.
    */
  ...
  def listArtifactsForRepo(): js.Promise[
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify OctokitResponse<ActionsListArtifactsForRepoResponse> */ _
  ] = js.native
  def listArtifactsForRepo(
    params: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify RequestParameters */ js.Any) with ActionsListArtifactsForRepoParams
  ): js.Promise[
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify OctokitResponse<ActionsListArtifactsForRepoResponse> */ _
  ] = js.native
  /**
