...
trait AnonDeploymentidOwnerPage extends js.Object {
...
object AnonDeploymentidOwnerPage {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonDeploymentidOwnerPage]
  }
}
