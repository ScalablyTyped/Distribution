...
import typings.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.GitignoreGetTemplateParams
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait AnonGetTemplateListTemplates extends js.Object {
  /**
    ...
    */
  @JSName("getTemplate")
  var getTemplate_Original: AnonEndpointParamsAnyGitignoreGetTemplateParams = js.native
  /**
  ...
  var listTemplates_Original: AnonEndpointParamsAny = js.native
  /**
    * The API also allows fetching the source of a single template.
    *
    * Use the raw [media type](https://developer.github.com/v3/media/) to get the raw contents.
