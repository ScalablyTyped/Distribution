...
class Flow () extends js.Object {
  ...
  def consume(topic: java.lang.String): stdLib.Promise[_] = js.native
  ...
  def consume(topics: js.Array[java.lang.String]): stdLib.Promise[ScalablyTyped.runtime.StringDictionary[java.lang.String]] = js.native
  ...
  def define(topic: java.lang.String, data: stdLib.Promise[Primitive]): this.type = js.native
