...
object DocumentMode extends StObject {
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.officeJs.Office.DocumentMode with Double] = js.native
  
  /* 0 */ val ReadOnly: typings.officeJs.Office.DocumentMode.ReadOnly with Double = js.native
  
  /* 1 */ val ReadWrite: typings.officeJs.Office.DocumentMode.ReadWrite with Double = js.native
}
