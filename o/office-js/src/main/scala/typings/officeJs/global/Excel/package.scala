...
import typings.officeJs.global.Excel.^
...
/**
  ...
  */
inline def run[T](batch: js.Function1[/* context */ typings.officeJs.Excel.RequestContext, js.Promise[T]]): js.Promise[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("run")(batch.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
/**
