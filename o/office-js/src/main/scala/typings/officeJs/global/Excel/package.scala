...
package object Excel {
  ...
  /**
    ...
    */
  @scala.inline
  def createWorkbook(): js.Promise[scala.Unit] = typings.officeJs.global.Excel.^.asInstanceOf[js.Dynamic].applyDynamic("createWorkbook")().asInstanceOf[js.Promise[scala.Unit]]
  @scala.inline
  def createWorkbook(base64: java.lang.String): js.Promise[scala.Unit] = typings.officeJs.global.Excel.^.asInstanceOf[js.Dynamic].applyDynamic("createWorkbook")(base64.asInstanceOf[js.Any]).asInstanceOf[js.Promise[scala.Unit]]
  
  @scala.inline
  def getDataCommonPostprocess(response: js.Any, callArgs: js.Any): js.Any = (typings.officeJs.global.Excel.^.asInstanceOf[js.Dynamic].applyDynamic("getDataCommonPostprocess")(response.asInstanceOf[js.Any], callArgs.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  
  @scala.inline
  def icons: typings.officeJs.Excel.IconCollections = typings.officeJs.global.Excel.^.asInstanceOf[js.Dynamic].selectDynamic("icons").asInstanceOf[typings.officeJs.Excel.IconCollections]
  @scala.inline
  def icons_=(x: typings.officeJs.Excel.IconCollections): scala.Unit = typings.officeJs.global.Excel.^.asInstanceOf[js.Dynamic].updateDynamic("icons")(x.asInstanceOf[js.Any])
  
  @scala.inline
  def postprocessBindingDescriptor(response: js.Any): js.Any = typings.officeJs.global.Excel.^.asInstanceOf[js.Dynamic].applyDynamic("postprocessBindingDescriptor")(response.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  /**
    ...
    */
  @scala.inline
  def run[T](batch: js.Function1[/* context */ typings.officeJs.Excel.RequestContext, js.Promise[T]]): js.Promise[T] = typings.officeJs.global.Excel.^.asInstanceOf[js.Dynamic].applyDynamic("run")(batch.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
  /**
