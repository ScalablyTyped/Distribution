...
package object Office {
  ...
  /** A Promise object. Promises can be chained via ".then", and errors can be caught via ".catch". 
    ...
    */
  @scala.inline
  def Promise: typings.officeJs.Office.IPromiseConstructor = typings.officeJs.global.Office.^.asInstanceOf[js.Dynamic].selectDynamic("Promise").asInstanceOf[typings.officeJs.Office.IPromiseConstructor]
  @scala.inline
  ...
  @scala.inline
  def onReady(callback: js.Function1[/* info */ typings.officeJs.anon.Host, _]): js.Promise[typings.officeJs.anon.Host] = typings.officeJs.global.Office.^.asInstanceOf[js.Dynamic].applyDynamic("onReady")(callback.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.officeJs.anon.Host]]
  ...
  def select(
    ...
    callback: js.Function1[/* result */ typings.officeJs.Office.AsyncResult[_], scala.Unit]
