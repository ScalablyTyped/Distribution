...
object EventType extends StObject {
  ...
  /* 10 */ val ItemChanged: typings.officeJs.Office.EventType.ItemChanged & Double = js.native
  
  /* 11 */ val NodeDeleted: typings.officeJs.Office.EventType.NodeDeleted & Double = js.native
  
  /* 12 */ val NodeInserted: typings.officeJs.Office.EventType.NodeInserted & Double = js.native
  
  /* 13 */ val NodeReplaced: typings.officeJs.Office.EventType.NodeReplaced & Double = js.native
  
  /* 14 */ val RecipientsChanged: typings.officeJs.Office.EventType.RecipientsChanged & Double = js.native
  
  /* 15 */ val RecurrenceChanged: typings.officeJs.Office.EventType.RecurrenceChanged & Double = js.native
  
  /* 16 */ val ResourceSelectionChanged: typings.officeJs.Office.EventType.ResourceSelectionChanged & Double = js.native
  
  /* 17 */ val SettingsChanged: typings.officeJs.Office.EventType.SettingsChanged & Double = js.native
  
  /* 18 */ val TaskSelectionChanged: typings.officeJs.Office.EventType.TaskSelectionChanged & Double = js.native
  
  /* 19 */ val ViewSelectionChanged: typings.officeJs.Office.EventType.ViewSelectionChanged & Double = js.native
}
