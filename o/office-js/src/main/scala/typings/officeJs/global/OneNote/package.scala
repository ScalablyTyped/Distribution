...
/**
  ...
  */
inline def run[T](batch: js.Function1[/* context */ typings.officeJs.OneNote.RequestContext, js.Promise[T]]): js.Promise[T] = typings.officeJs.global.OneNote.^.asInstanceOf[js.Dynamic].applyDynamic("run")(batch.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
/**
