...
import typings.officeJs.global.OneNote.^
...
/**
  ...
  */
inline def run[T](batch: js.Function1[/* context */ typings.officeJs.OneNote.RequestContext, js.Promise[T]]): js.Promise[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("run")(batch.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
/**
