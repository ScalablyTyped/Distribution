...
import typings.officeJs.OneNote.Interfaces.InkAnalysisLineData
import typings.officeJs.OneNote.Interfaces.InkAnalysisLineLoadOptions
import typings.officeJs.OneNote.Interfaces.InkAnalysisLineUpdateData
