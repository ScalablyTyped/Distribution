...
import typings.officeJs.OneNote.Interfaces.InkAnalysisParagraphCollectionData
import typings.officeJs.OneNote.Interfaces.InkAnalysisParagraphCollectionLoadOptions
