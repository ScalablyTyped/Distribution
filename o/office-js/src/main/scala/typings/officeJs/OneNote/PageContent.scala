...
import typings.officeJs.OneNote.Interfaces.PageContentData
import typings.officeJs.OneNote.Interfaces.PageContentLoadOptions
import typings.officeJs.OneNote.Interfaces.PageContentUpdateData
...
trait PageContent extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: PageContentType | typings.officeJs.officeJsStrings.Outline | typings.officeJs.officeJsStrings.Image | Ink | Other = js.native
