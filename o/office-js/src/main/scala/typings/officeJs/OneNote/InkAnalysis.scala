...
import typings.officeJs.OneNote.Interfaces.InkAnalysisData
import typings.officeJs.OneNote.Interfaces.InkAnalysisLoadOptions
import typings.officeJs.OneNote.Interfaces.InkAnalysisUpdateData
