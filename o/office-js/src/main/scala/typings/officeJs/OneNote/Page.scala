...
import typings.officeJs.OneNote.Interfaces.PageData
import typings.officeJs.OneNote.Interfaces.PageLoadOptions
import typings.officeJs.OneNote.Interfaces.PageUpdateData
