...
import typings.officeJs.OneNote.Interfaces.InkAnalysisWordCollectionData
import typings.officeJs.OneNote.Interfaces.InkAnalysisWordCollectionLoadOptions
