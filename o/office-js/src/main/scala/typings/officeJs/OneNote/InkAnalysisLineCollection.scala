...
import typings.officeJs.OneNote.Interfaces.InkAnalysisLineCollectionData
import typings.officeJs.OneNote.Interfaces.InkAnalysisLineCollectionLoadOptions
