...
import typings.officeJs.OneNote.Interfaces.TableData
import typings.officeJs.OneNote.Interfaces.TableLoadOptions
import typings.officeJs.OneNote.Interfaces.TableUpdateData
