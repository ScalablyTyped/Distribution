...
trait ParagraphInfo extends StObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  var numberType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 63, starting with typings.officeJs.OneNote.NumberType, typings.officeJs.officeJsStrings.None, typings.officeJs.officeJsStrings.Arabic */ Any
}
object ParagraphInfo {
  ...
  inline def apply(
    ...
    numberType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 63, starting with typings.officeJs.OneNote.NumberType, typings.officeJs.officeJsStrings.None, typings.officeJs.officeJsStrings.Arabic */ Any
  ): ParagraphInfo = {
  ...
  implicit open class MutableBuilder[Self <: ParagraphInfo] (val x: Self) extends AnyVal {
    ...
    inline def setNumberType(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 63, starting with typings.officeJs.OneNote.NumberType, typings.officeJs.officeJsStrings.None, typings.officeJs.officeJsStrings.Arabic */ Any
