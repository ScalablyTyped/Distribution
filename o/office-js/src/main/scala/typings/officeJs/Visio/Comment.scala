...
import typings.officeJs.Visio.Interfaces.CommentData
import typings.officeJs.Visio.Interfaces.CommentLoadOptions
import typings.officeJs.Visio.Interfaces.CommentUpdateData
