...
import typings.officeJs.Excel.ErrorCellValueType.external
import typings.officeJs.Excel.RangeValueType.error
import typings.officeJs.officeJsStrings.Error
import typings.officeJs.officeJsStrings.External
import typings.officeJs.officeJsStrings.NumbersignEXTERNALExclamationmark
...
object ExternalErrorCellValue {
  ...
  inline def apply(`type`: typings.officeJs.Excel.CellValueType.error | Error): ExternalErrorCellValue = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ExternalErrorCellValue] (val x: Self) extends AnyVal {
