...
import typings.officeJs.Excel.Interfaces.CellValueConditionalFormatData
import typings.officeJs.Excel.Interfaces.CellValueConditionalFormatLoadOptions
import typings.officeJs.Excel.Interfaces.CellValueConditionalFormatUpdateData
