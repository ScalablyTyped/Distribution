...
import typings.officeJs.Excel.Interfaces.ConditionalFormatCollectionData
import typings.officeJs.Excel.Interfaces.ConditionalFormatCollectionLoadOptions
