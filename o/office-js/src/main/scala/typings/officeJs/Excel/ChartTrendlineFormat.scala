...
import typings.officeJs.Excel.Interfaces.ChartTrendlineFormatData
import typings.officeJs.Excel.Interfaces.ChartTrendlineFormatLoadOptions
import typings.officeJs.Excel.Interfaces.ChartTrendlineFormatUpdateData
