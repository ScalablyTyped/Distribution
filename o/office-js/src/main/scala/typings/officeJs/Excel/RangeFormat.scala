...
import typings.officeJs.Excel.Interfaces.RangeFormatData
import typings.officeJs.Excel.Interfaces.RangeFormatLoadOptions
import typings.officeJs.Excel.Interfaces.RangeFormatUpdateData
