...
import typings.officeJs.Excel.Interfaces.ShapeData
import typings.officeJs.Excel.Interfaces.ShapeLoadOptions
import typings.officeJs.Excel.Interfaces.ShapeUpdateData
...
import typings.officeJs.officeJsStrings.BringForward
import typings.officeJs.officeJsStrings.BringToFront
import typings.officeJs.officeJsStrings.CurrentSize
...
import typings.officeJs.officeJsStrings.OriginalSize
import typings.officeJs.officeJsStrings.PNG
import typings.officeJs.officeJsStrings.SVG
import typings.officeJs.officeJsStrings.ScaleFromBottomRight
import typings.officeJs.officeJsStrings.ScaleFromMiddle
import typings.officeJs.officeJsStrings.ScaleFromTopLeft
import typings.officeJs.officeJsStrings.SendBackward
import typings.officeJs.officeJsStrings.SendToBack
...
class Shape () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  val `type`: ShapeType | Unsupported | typings.officeJs.officeJsStrings.Image | typings.officeJs.officeJsStrings.GeometricShape | Group | typings.officeJs.officeJsStrings.Line = js.native
  /**
    *
