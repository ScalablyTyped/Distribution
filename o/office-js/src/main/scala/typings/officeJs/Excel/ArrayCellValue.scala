...
trait ArrayCellValue
  ...
  /**
    ...
    * [Api set: ExcelApi 1.16]
    */
  var `type`: array | typings.officeJs.Excel.ReferenceValueType.array | Array
}
object ArrayCellValue {
  ...
  implicit open class MutableBuilder[Self <: ArrayCellValue] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: array | typings.officeJs.Excel.ReferenceValueType.array | Array): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
