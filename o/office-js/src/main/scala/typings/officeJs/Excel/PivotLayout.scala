...
trait PivotLayout extends ClientObject {
  ...
  @JSName("getPivotItems")
  def getPivotItems_Filter(axis: typings.officeJs.officeJsStrings.Filter, cell: String): ClientResult[js.Array[PivotItem]] = js.native
  @JSName("getPivotItems")
  def getPivotItems_Filter(axis: typings.officeJs.officeJsStrings.Filter, cell: Range): ClientResult[js.Array[PivotItem]] = js.native
  @JSName("getPivotItems")
