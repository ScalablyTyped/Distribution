...
trait SortField extends js.Object {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.2]
    */
  var sortOn: js.UndefOr[SortOn | Value | CellColor | FontColor | typings.officeJs.officeJsStrings.Icon] = js.undefined
  /**
    *
...
object SortField {
  ...
  def apply(
    ...
    icon: Icon = null,
    sortOn: SortOn | Value | CellColor | FontColor | typings.officeJs.officeJsStrings.Icon = null,
