...
import typings.officeJs.Excel.Interfaces.PivotItemData
import typings.officeJs.Excel.Interfaces.PivotItemLoadOptions
import typings.officeJs.Excel.Interfaces.PivotItemUpdateData
