...
import typings.officeJs.officeJsStrings.WorksheetActivated
...
object WorksheetActivatedEventArgs {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: WorksheetActivatedEventArgs] (val x: Self) extends AnyVal {
