...
import typings.officeJs.Excel.ErrorCellValueType.placeholder
...
import typings.officeJs.officeJsStrings.Placeholder
...
object PlaceholderErrorCellValue {
  ...
  inline def apply(
    ...
    `type`: typings.officeJs.Excel.CellValueType.error | Error
