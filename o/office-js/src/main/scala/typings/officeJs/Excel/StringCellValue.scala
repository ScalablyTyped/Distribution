...
import typings.officeJs.Excel.RangeValueType.string
...
trait StringCellValue extends StObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.16]
    */
  var `type`: typings.officeJs.Excel.CellValueType.string | String
}
object StringCellValue {
  
  inline def apply(basicValue: java.lang.String, `type`: typings.officeJs.Excel.CellValueType.string | String): StringCellValue = {
  ...
  extension [Self <: StringCellValue](x: Self) {
    ...
    inline def setType(value: typings.officeJs.Excel.CellValueType.string | String): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
