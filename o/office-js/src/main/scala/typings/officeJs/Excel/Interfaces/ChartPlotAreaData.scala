...
object ChartPlotAreaData {
  ...
  @scala.inline
  implicit class ChartPlotAreaDataMutableBuilder[Self <: ChartPlotAreaData] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFormat(value: ChartPlotAreaFormatData): Self = StObject.set(x, "format", value.asInstanceOf[js.Any])
