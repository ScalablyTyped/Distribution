...
import typings.officeJs.Excel.ErrorCellValueType.div0
import typings.officeJs.Excel.RangeValueType.error
import typings.officeJs.officeJsStrings.Div0
import typings.officeJs.officeJsStrings.Error
import typings.officeJs.officeJsStrings.NumbersignDIVSlash0Exclamationmark
...
object Div0ErrorCellValue {
  ...
  inline def apply(`type`: typings.officeJs.Excel.CellValueType.error | Error): Div0ErrorCellValue = {
