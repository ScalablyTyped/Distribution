...
import typings.officeJs.Excel.Interfaces.TimelineStyleData
import typings.officeJs.Excel.Interfaces.TimelineStyleLoadOptions
import typings.officeJs.Excel.Interfaces.TimelineStyleUpdateData
