...
import typings.officeJs.Excel.Interfaces.DataPivotHierarchyCollectionData
import typings.officeJs.Excel.Interfaces.DataPivotHierarchyCollectionLoadOptions
