...
import typings.officeJs.Excel.Interfaces.WorksheetCustomPropertyData
import typings.officeJs.Excel.Interfaces.WorksheetCustomPropertyLoadOptions
import typings.officeJs.Excel.Interfaces.WorksheetCustomPropertyUpdateData
