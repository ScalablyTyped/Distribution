...
import typings.officeJs.Excel.Interfaces.TextConditionalFormatData
import typings.officeJs.Excel.Interfaces.TextConditionalFormatLoadOptions
import typings.officeJs.Excel.Interfaces.TextConditionalFormatUpdateData
