...
import typings.officeJs.Excel.Interfaces.ChartAxisTitleData
import typings.officeJs.Excel.Interfaces.ChartAxisTitleLoadOptions
import typings.officeJs.Excel.Interfaces.ChartAxisTitleUpdateData
