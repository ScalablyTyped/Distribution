...
import typings.officeJs.Excel.Interfaces.PivotHierarchyData
import typings.officeJs.Excel.Interfaces.PivotHierarchyLoadOptions
import typings.officeJs.Excel.Interfaces.PivotHierarchyUpdateData
