...
import typings.officeJs.Excel.ErrorCellValueType.notAvailable
...
import typings.officeJs.officeJsStrings.NumbersignNSlashAExclamationmark
...
object NotAvailableErrorCellValue {
  ...
  inline def apply(`type`: typings.officeJs.Excel.CellValueType.error | Error): NotAvailableErrorCellValue = {
