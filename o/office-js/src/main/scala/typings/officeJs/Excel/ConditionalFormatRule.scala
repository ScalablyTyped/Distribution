...
import typings.officeJs.Excel.Interfaces.ConditionalFormatRuleData
import typings.officeJs.Excel.Interfaces.ConditionalFormatRuleLoadOptions
import typings.officeJs.Excel.Interfaces.ConditionalFormatRuleUpdateData
