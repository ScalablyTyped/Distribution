...
import typings.officeJs.Excel.ErrorCellValueType.ref
import typings.officeJs.Excel.RangeValueType.error
import typings.officeJs.officeJsStrings.Error
import typings.officeJs.officeJsStrings.ExternalLinksCalculatedRef
import typings.officeJs.officeJsStrings.ExternalLinksStructuredRef
import typings.officeJs.officeJsStrings.NumbersignREFExclamationmark
import typings.officeJs.officeJsStrings.Ref
...
object RefErrorCellValue {
  ...
  inline def apply(`type`: typings.officeJs.Excel.CellValueType.error | Error): RefErrorCellValue = {
