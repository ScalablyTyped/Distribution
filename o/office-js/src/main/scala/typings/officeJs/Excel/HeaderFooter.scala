...
import typings.officeJs.Excel.Interfaces.HeaderFooterData
import typings.officeJs.Excel.Interfaces.HeaderFooterLoadOptions
import typings.officeJs.Excel.Interfaces.HeaderFooterUpdateData
