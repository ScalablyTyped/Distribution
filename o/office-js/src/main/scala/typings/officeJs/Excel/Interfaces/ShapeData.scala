...
trait ShapeData extends StObject {
  ...
  var geometricShapeType: js.UndefOr[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 179, starting with typings.officeJs.Excel.GeometricShapeType, typings.officeJs.officeJsStrings.LineInverse, typings.officeJs.officeJsStrings.Triangle */ Any
  ] = js.undefined
...
object ShapeData {
  ...
  implicit open class MutableBuilder[Self <: ShapeData] (val x: Self) extends AnyVal {
    ...
    inline def setGeometricShapeType(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 179, starting with typings.officeJs.Excel.GeometricShapeType, typings.officeJs.officeJsStrings.LineInverse, typings.officeJs.officeJsStrings.Triangle */ Any
