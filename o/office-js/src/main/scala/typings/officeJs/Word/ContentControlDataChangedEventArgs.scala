...
/**
  ...
  * [Api set: WordApi 1.5]
  */
trait ContentControlDataChangedEventArgs extends StObject {
...
object ContentControlDataChangedEventArgs {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ContentControlDataChangedEventArgs]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ContentControlDataChangedEventArgs] (val x: Self) extends AnyVal {
