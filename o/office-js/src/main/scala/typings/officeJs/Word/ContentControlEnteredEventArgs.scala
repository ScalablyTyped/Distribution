...
/**
  ...
  * [Api set: WordApi 1.5]
  */
trait ContentControlEnteredEventArgs extends StObject {
...
object ContentControlEnteredEventArgs {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ContentControlEnteredEventArgs]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ContentControlEnteredEventArgs] (val x: Self) extends AnyVal {
