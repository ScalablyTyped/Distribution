...
import typings.officeJs.Word.Interfaces.ParagraphFormatData
import typings.officeJs.Word.Interfaces.ParagraphFormatLoadOptions
import typings.officeJs.Word.Interfaces.ParagraphFormatUpdateData
