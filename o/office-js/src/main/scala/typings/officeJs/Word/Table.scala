...
trait Table
  ...
  def getRange(rangeLocation: typings.officeJs.Word.RangeLocation.end): Range = js.native
  def getRange(rangeLocation: typings.officeJs.Word.RangeLocation.start): Range = js.native
