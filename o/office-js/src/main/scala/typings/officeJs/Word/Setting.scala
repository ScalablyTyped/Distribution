...
import typings.officeJs.Word.Interfaces.SettingData
import typings.officeJs.Word.Interfaces.SettingLoadOptions
import typings.officeJs.Word.Interfaces.SettingUpdateData
