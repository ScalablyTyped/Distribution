...
trait List
  ...
  /**
    ...
    */
  def load(): typings.officeJs.Word.List = js.native
  def load(options: ListLoadOptions): typings.officeJs.Word.List = js.native
  def load(propertyNamesAndPaths: Expand): typings.officeJs.Word.List = js.native
  def load(propertyNames: String): typings.officeJs.Word.List = js.native
  def load(propertyNames: js.Array[String]): typings.officeJs.Word.List = js.native
