...
/**
  ...
  * [Api set: WordApi 1.5]
  */
trait ContentControlDeletedEventArgs extends StObject {
...
object ContentControlDeletedEventArgs {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ContentControlDeletedEventArgs]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ContentControlDeletedEventArgs] (val x: Self) extends AnyVal {
