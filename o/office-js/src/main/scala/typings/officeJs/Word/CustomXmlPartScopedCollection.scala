...
import typings.officeJs.Word.Interfaces.CustomXmlPartScopedCollectionData
import typings.officeJs.Word.Interfaces.CustomXmlPartScopedCollectionLoadOptions
