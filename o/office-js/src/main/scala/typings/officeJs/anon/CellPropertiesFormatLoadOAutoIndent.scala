...
@js.native
trait CellPropertiesFormatLoadOAutoIndent extends js.Object {
...
object CellPropertiesFormatLoadOAutoIndent {
  ...
  @scala.inline
  implicit class CellPropertiesFormatLoadOAutoIndentOps[Self <: CellPropertiesFormatLoadOAutoIndent] (val x: Self) extends AnyVal {
