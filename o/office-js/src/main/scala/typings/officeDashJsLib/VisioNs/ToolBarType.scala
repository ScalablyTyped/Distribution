...
object ToolBarType extends js.Object {
  ...
  sealed trait commandBar
    extends officeDashJsLib.VisioNs.ToolBarType
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.VisioNs.ToolBarType with java.lang.String] = js.native
}
