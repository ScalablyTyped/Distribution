...
class Page ()
  ...
  def load(option: officeDashJsLib.VisioNs.InterfacesNs.PageLoadOptions): Page = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.VisioNs.InterfacesNs.PageUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.VisioNs.InterfacesNs.PageUpdateData,
    options: officeDashJsLib.OfficeExtensionNs.UpdateOptions
  ): scala.Unit = js.native
  /** Sets multiple properties on the object at the same time, based on an existing loaded object. */
  def set(properties: Page): scala.Unit = js.native
  def toJSON(): officeDashJsLib.VisioNs.InterfacesNs.PageData = js.native
}
