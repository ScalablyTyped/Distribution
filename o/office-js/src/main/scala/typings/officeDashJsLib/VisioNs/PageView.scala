...
class PageView ()
  ...
  /**
    ...
    * [Api set:  1.1]
    */
  def getPosition(): officeDashJsLib.OfficeExtensionNs.ClientResult[Position] = js.native
  /**
    *
  ...
  /**
    ...
    */
  def isShapeInViewport(Shape: Shape): officeDashJsLib.OfficeExtensionNs.ClientResult[scala.Boolean] = js.native
  /**
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.VisioNs.InterfacesNs.PageViewUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.VisioNs.InterfacesNs.PageViewUpdateData,
