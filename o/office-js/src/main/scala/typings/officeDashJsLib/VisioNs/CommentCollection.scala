...
class CommentCollection ()
  ...
  def load(
    option: officeDashJsLib.VisioNs.InterfacesNs.CommentCollectionLoadOptions with officeDashJsLib.VisioNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): CommentCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.VisioNs.InterfacesNs.CommentCollectionData = js.native
}
