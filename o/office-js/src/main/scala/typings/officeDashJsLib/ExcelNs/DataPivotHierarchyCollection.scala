...
class DataPivotHierarchyCollection ()
  ...
  def load(
    option: officeDashJsLib.ExcelNs.InterfacesNs.DataPivotHierarchyCollectionLoadOptions with officeDashJsLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): DataPivotHierarchyCollection = js.native
  /**
    *
