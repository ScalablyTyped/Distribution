...
object ShapeTextHorizontalOverflow extends js.Object {
  @js.native
  sealed trait clip
    extends officeDashJsLib.ExcelNs.ShapeTextHorizontalOverflow
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.ExcelNs.ShapeTextHorizontalOverflow with java.lang.String] = js.native
}
