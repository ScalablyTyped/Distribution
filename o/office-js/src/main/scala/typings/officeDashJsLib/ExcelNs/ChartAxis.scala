...
class ChartAxis ()
  ...
  /**
    ...
    */
  var alignment: ChartTickLabelAlignment | officeDashJsLib.officeDashJsLibStrings.Center | officeDashJsLib.officeDashJsLibStrings.Left | officeDashJsLib.officeDashJsLibStrings.Right = js.native
  /**
    *
    ...
    */
  val axisGroup: ChartAxisGroup | officeDashJsLib.officeDashJsLibStrings.Primary | officeDashJsLib.officeDashJsLibStrings.Secondary = js.native
  /**
    *
    ...
    * [Api set: ExcelApi 1.7]
    */
  var baseTimeUnit: ChartAxisTimeUnit | officeDashJsLib.officeDashJsLibStrings.Days | officeDashJsLib.officeDashJsLibStrings.Months | officeDashJsLib.officeDashJsLibStrings.Years = js.native
  /**
    *
  ...
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  var displayUnit: ChartAxisDisplayUnit | officeDashJsLib.officeDashJsLibStrings.None | officeDashJsLib.officeDashJsLibStrings.Hundreds | officeDashJsLib.officeDashJsLibStrings.Thousands | officeDashJsLib.officeDashJsLibStrings.TenThousands | officeDashJsLib.officeDashJsLibStrings.HundredThousands | officeDashJsLib.officeDashJsLibStrings.Millions | officeDashJsLib.officeDashJsLibStrings.TenMillions | officeDashJsLib.officeDashJsLibStrings.HundredMillions | officeDashJsLib.officeDashJsLibStrings.Billions | officeDashJsLib.officeDashJsLibStrings.Trillions | officeDashJsLib.officeDashJsLibStrings.Custom = js.native
  /**
    *
  ...
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  var majorTickMark: ChartAxisTickMark | officeDashJsLib.officeDashJsLibStrings.None | officeDashJsLib.officeDashJsLibStrings.Cross | officeDashJsLib.officeDashJsLibStrings.Inside | officeDashJsLib.officeDashJsLibStrings.Outside = js.native
  /**
    *
    ...
    * [Api set: ExcelApi 1.7]
    */
  var majorTimeUnitScale: ChartAxisTimeUnit | officeDashJsLib.officeDashJsLibStrings.Days | officeDashJsLib.officeDashJsLibStrings.Months | officeDashJsLib.officeDashJsLibStrings.Years = js.native
  /**
    *
  ...
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  var minorTickMark: ChartAxisTickMark | officeDashJsLib.officeDashJsLibStrings.None | officeDashJsLib.officeDashJsLibStrings.Cross | officeDashJsLib.officeDashJsLibStrings.Inside | officeDashJsLib.officeDashJsLibStrings.Outside = js.native
  /**
    *
    ...
    * [Api set: ExcelApi 1.7]
    */
  var minorTimeUnitScale: ChartAxisTimeUnit | officeDashJsLib.officeDashJsLibStrings.Days | officeDashJsLib.officeDashJsLibStrings.Months | officeDashJsLib.officeDashJsLibStrings.Years = js.native
  /**
    *
  ...
  /**
    ...
    * [Api set: ExcelApi 1.8]
    */
  var position: ChartAxisPosition | officeDashJsLib.officeDashJsLibStrings.Automatic | officeDashJsLib.officeDashJsLibStrings.Maximum | officeDashJsLib.officeDashJsLibStrings.Minimum | officeDashJsLib.officeDashJsLibStrings.Custom = js.native
  /**
    *
  ...
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  var scaleType: ChartAxisScaleType | officeDashJsLib.officeDashJsLibStrings.Linear | officeDashJsLib.officeDashJsLibStrings.Logarithmic = js.native
  /**
    *
  ...
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  var tickLabelPosition: ChartAxisTickLabelPosition | officeDashJsLib.officeDashJsLibStrings.NextToAxis | officeDashJsLib.officeDashJsLibStrings.High | officeDashJsLib.officeDashJsLibStrings.Low | officeDashJsLib.officeDashJsLibStrings.None = js.native
  /**
    *
  ...
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  val `type`: ChartAxisType | officeDashJsLib.officeDashJsLibStrings.Invalid | officeDashJsLib.officeDashJsLibStrings.Category | officeDashJsLib.officeDashJsLibStrings.Value | officeDashJsLib.officeDashJsLibStrings.Series = js.native
  /**
    *
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartAxisUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartAxisUpdateData,
