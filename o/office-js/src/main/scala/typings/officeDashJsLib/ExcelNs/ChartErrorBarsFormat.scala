...
class ChartErrorBarsFormat ()
  ...
  def load(option: officeDashJsLib.Anon_Expand): ChartErrorBarsFormat = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.ChartErrorBarsFormatLoadOptions): ChartErrorBarsFormat = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartErrorBarsFormatUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartErrorBarsFormatUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.ChartErrorBarsFormatData = js.native
}
