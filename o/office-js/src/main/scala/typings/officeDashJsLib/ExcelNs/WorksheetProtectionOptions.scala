...
trait WorksheetProtectionOptions extends js.Object {
  ...
  var selectionMode: js.UndefOr[
    ProtectionSelectionMode | officeDashJsLib.officeDashJsLibStrings.Normal | officeDashJsLib.officeDashJsLibStrings.Unlocked | officeDashJsLib.officeDashJsLibStrings.None
  ] = js.undefined
}
...
object WorksheetProtectionOptions {
  ...
  def apply(
    ...
    selectionMode: ProtectionSelectionMode | officeDashJsLib.officeDashJsLibStrings.Normal | officeDashJsLib.officeDashJsLibStrings.Unlocked | officeDashJsLib.officeDashJsLibStrings.None = null
