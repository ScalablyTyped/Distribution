...
class ShapeFill ()
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  val `type`: ShapeFillType | officeDashJsLib.officeDashJsLibStrings.NoFill | officeDashJsLib.officeDashJsLibStrings.Solid | officeDashJsLib.officeDashJsLibStrings.Gradient | officeDashJsLib.officeDashJsLibStrings.Pattern | officeDashJsLib.officeDashJsLibStrings.PictureAndTexture | officeDashJsLib.officeDashJsLibStrings.Mixed = js.native
  /**
    *
  ...
  def load(option: officeDashJsLib.Anon_Expand): ShapeFill = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.ShapeFillLoadOptions): ShapeFill = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.ShapeFillUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.ShapeFillUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.ShapeFillData = js.native
}
