...
class ShapeLineFormat ()
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  var style: ShapeLineStyle | officeDashJsLib.officeDashJsLibStrings.Single | officeDashJsLib.officeDashJsLibStrings.ThickBetweenThin | officeDashJsLib.officeDashJsLibStrings.ThickThin | officeDashJsLib.officeDashJsLibStrings.ThinThick | officeDashJsLib.officeDashJsLibStrings.ThinThin = js.native
  /**
    *
  ...
  def load(option: officeDashJsLib.Anon_Expand): ShapeLineFormat = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.ShapeLineFormatLoadOptions): ShapeLineFormat = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.ShapeLineFormatUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.ShapeLineFormatUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.ShapeLineFormatData = js.native
}
