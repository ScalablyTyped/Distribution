...
class ChartLegendEntryCollection ()
  ...
  def load(
    option: officeDashJsLib.ExcelNs.InterfacesNs.ChartLegendEntryCollectionLoadOptions with officeDashJsLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): ChartLegendEntryCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.ChartLegendEntryCollectionData = js.native
}
