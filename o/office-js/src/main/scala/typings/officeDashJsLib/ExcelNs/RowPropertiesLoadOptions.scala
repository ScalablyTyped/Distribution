...
trait RowPropertiesLoadOptions extends CellPropertiesLoadOptions {
  /**
    ...
    */
  @JSName("format")
  var format_RowPropertiesLoadOptions: js.UndefOr[CellPropertiesFormatLoadOptions with officeDashJsLib.Anon_RowHeight] = js.undefined
  /**
    *
...
object RowPropertiesLoadOptions {
  ...
  def apply(
    ...
    format: CellPropertiesFormatLoadOptions with officeDashJsLib.Anon_RowHeight = null,
