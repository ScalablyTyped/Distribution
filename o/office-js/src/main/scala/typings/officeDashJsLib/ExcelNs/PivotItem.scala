...
class PivotItem ()
  ...
  def load(option: officeDashJsLib.Anon_Select): PivotItem = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.PivotItemLoadOptions): PivotItem = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.PivotItemUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.PivotItemUpdateData,
    options: officeDashJsLib.OfficeExtensionNs.UpdateOptions
  ): scala.Unit = js.native
  /** Sets multiple properties on the object at the same time, based on an existing loaded object. */
  def set(properties: PivotItem): scala.Unit = js.native
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.PivotItemData = js.native
}
