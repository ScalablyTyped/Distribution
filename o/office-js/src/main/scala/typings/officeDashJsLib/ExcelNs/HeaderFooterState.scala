...
object HeaderFooterState extends js.Object {
  ...
  sealed trait default
    extends officeDashJsLib.ExcelNs.HeaderFooterState
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.ExcelNs.HeaderFooterState with java.lang.String] = js.native
}
