...
class IterativeCalculation ()
  ...
  def load(option: officeDashJsLib.Anon_Expand): IterativeCalculation = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.IterativeCalculationLoadOptions): IterativeCalculation = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.IterativeCalculationUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.IterativeCalculationUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.IterativeCalculationData = js.native
}
