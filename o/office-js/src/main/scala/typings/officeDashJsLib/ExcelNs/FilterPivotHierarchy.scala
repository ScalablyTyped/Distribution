...
class FilterPivotHierarchy ()
  ...
  /**
    ...
    * [Api set: ExcelApi 1.8]
    */
  var enableMultipleFilterItems: scala.Boolean = js.native
  /**
    *
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.FilterPivotHierarchyUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.FilterPivotHierarchyUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.FilterPivotHierarchyData = js.native
}
