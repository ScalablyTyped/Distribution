...
trait HeaderFooterGroupData extends js.Object {
  ...
  var state: js.UndefOr[
    officeDashJsLib.ExcelNs.HeaderFooterState | officeDashJsLib.officeDashJsLibStrings.Default | officeDashJsLib.officeDashJsLibStrings.FirstAndDefault | officeDashJsLib.officeDashJsLibStrings.OddAndEven | officeDashJsLib.officeDashJsLibStrings.FirstOddAndEven
  ] = js.undefined
  /**
    *
...
object HeaderFooterGroupData {
  ...
  def apply(
    ...
    state: officeDashJsLib.ExcelNs.HeaderFooterState | officeDashJsLib.officeDashJsLibStrings.Default | officeDashJsLib.officeDashJsLibStrings.FirstAndDefault | officeDashJsLib.officeDashJsLibStrings.OddAndEven | officeDashJsLib.officeDashJsLibStrings.FirstOddAndEven = null,
