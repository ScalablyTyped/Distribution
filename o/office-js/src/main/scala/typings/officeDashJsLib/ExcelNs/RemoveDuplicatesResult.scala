...
class RemoveDuplicatesResult ()
  ...
  def load(option: officeDashJsLib.Anon_Expand): RemoveDuplicatesResult = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.RemoveDuplicatesResultLoadOptions): RemoveDuplicatesResult = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.RemoveDuplicatesResultData = js.native
}
