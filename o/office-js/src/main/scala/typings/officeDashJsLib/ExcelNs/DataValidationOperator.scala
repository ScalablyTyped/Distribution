...
object DataValidationOperator extends js.Object {
  ...
  sealed trait between
    extends officeDashJsLib.ExcelNs.DataValidationOperator
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.ExcelNs.DataValidationOperator with java.lang.String] = js.native
}
