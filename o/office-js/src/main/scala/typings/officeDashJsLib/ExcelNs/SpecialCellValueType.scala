...
object SpecialCellValueType extends js.Object {
  ...
  @js.native
  sealed trait all
    extends officeDashJsLib.ExcelNs.SpecialCellValueType
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.ExcelNs.SpecialCellValueType with java.lang.String] = js.native
}
