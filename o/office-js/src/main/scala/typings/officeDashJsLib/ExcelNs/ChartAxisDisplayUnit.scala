...
object ChartAxisDisplayUnit extends js.Object {
  ...
  sealed trait billions
    extends officeDashJsLib.ExcelNs.ChartAxisDisplayUnit
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.ExcelNs.ChartAxisDisplayUnit with java.lang.String] = js.native
}
