...
class Chart ()
  ...
  /**
    ...
    * [Api set: ExcelApi 1.8]
    */
  var displayBlanksAs: ChartDisplayBlanksAs | officeDashJsLib.officeDashJsLibStrings.NotPlotted | officeDashJsLib.officeDashJsLibStrings.Zero | officeDashJsLib.officeDashJsLibStrings.Interplotted = js.native
  /**
    *
  ...
  /**
    ...
    * [Api set: ExcelApi 1.8]
    */
  var plotBy: ChartPlotBy | officeDashJsLib.officeDashJsLibStrings.Rows | officeDashJsLib.officeDashJsLibStrings.Columns = js.native
  /**
    *
  ...
  def getImage(width: scala.Double): officeDashJsLib.OfficeExtensionNs.ClientResult[java.lang.String] = js.native
  def getImage(width: scala.Double, height: scala.Double): officeDashJsLib.OfficeExtensionNs.ClientResult[java.lang.String] = js.native
  def getImage(width: scala.Double, height: scala.Double, fittingMode: ImageFittingMode): officeDashJsLib.OfficeExtensionNs.ClientResult[java.lang.String] = js.native
  @JSName("getImage")
  def getImage_Fill(
    width: scala.Double,
    height: scala.Double,
    fittingMode: officeDashJsLib.officeDashJsLibStrings.Fill
  ): officeDashJsLib.OfficeExtensionNs.ClientResult[java.lang.String] = js.native
  @JSName("getImage")
  def getImage_Fit(width: scala.Double, height: scala.Double, fittingMode: officeDashJsLib.officeDashJsLibStrings.Fit): officeDashJsLib.OfficeExtensionNs.ClientResult[java.lang.String] = js.native
  @JSName("getImage")
  def getImage_FitAndCenter(
    width: scala.Double,
    height: scala.Double,
    fittingMode: officeDashJsLib.officeDashJsLibStrings.FitAndCenter
  ): officeDashJsLib.OfficeExtensionNs.ClientResult[java.lang.String] = js.native
  /**
  ...
  def load(option: officeDashJsLib.Anon_Expand): Chart = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.ChartLoadOptions): Chart = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartUpdateData,
  ...
  @JSName("setData")
  def setData_Auto(sourceData: Range, seriesBy: officeDashJsLib.officeDashJsLibStrings.Auto): scala.Unit = js.native
  @JSName("setData")
  def setData_Columns(sourceData: Range, seriesBy: officeDashJsLib.officeDashJsLibStrings.Columns): scala.Unit = js.native
  @JSName("setData")
  def setData_Rows(sourceData: Range, seriesBy: officeDashJsLib.officeDashJsLibStrings.Rows): scala.Unit = js.native
