...
class PivotItemCollection ()
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsLib.ExcelNs.InterfacesNs.PivotItemCollectionLoadOptions with officeDashJsLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): PivotItemCollection = js.native
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.PivotItemCollectionData = js.native
}
