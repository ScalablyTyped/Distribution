...
object ConditionalTopBottomCriterionType extends js.Object {
  ...
  sealed trait bottomItems
    extends officeDashJsLib.ExcelNs.ConditionalTopBottomCriterionType
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.ExcelNs.ConditionalTopBottomCriterionType with java.lang.String] = js.native
}
