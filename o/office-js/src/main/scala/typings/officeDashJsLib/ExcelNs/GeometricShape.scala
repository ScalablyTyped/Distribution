...
class GeometricShape ()
  ...
  def load(option: officeDashJsLib.Anon_Expand): GeometricShape = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.GeometricShapeLoadOptions): GeometricShape = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.GeometricShapeData = js.native
}
