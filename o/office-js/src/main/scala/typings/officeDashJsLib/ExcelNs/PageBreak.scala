...
class PageBreak ()
  ...
  def load(option: officeDashJsLib.Anon_Expand): PageBreak = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.PageBreakLoadOptions): PageBreak = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.PageBreakData = js.native
}
