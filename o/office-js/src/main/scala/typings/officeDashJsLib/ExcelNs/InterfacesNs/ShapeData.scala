...
trait ShapeData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    officeDashJsLib.ExcelNs.ShapeType | officeDashJsLib.officeDashJsLibStrings.Unsupported | officeDashJsLib.officeDashJsLibStrings.Image | officeDashJsLib.officeDashJsLibStrings.GeometricShape | officeDashJsLib.officeDashJsLibStrings.Group | officeDashJsLib.officeDashJsLibStrings.Line
  ] = js.undefined
  /**
    *
...
object ShapeData {
  ...
  def apply(
    ...
    `type`: officeDashJsLib.ExcelNs.ShapeType | officeDashJsLib.officeDashJsLibStrings.Unsupported | officeDashJsLib.officeDashJsLibStrings.Image | officeDashJsLib.officeDashJsLibStrings.GeometricShape | officeDashJsLib.officeDashJsLibStrings.Group | officeDashJsLib.officeDashJsLibStrings.Line = null,
