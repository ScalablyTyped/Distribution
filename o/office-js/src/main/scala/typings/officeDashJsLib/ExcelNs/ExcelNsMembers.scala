...
object ExcelNsMembers extends js.Object {
  ...
  /**
       ...
       */
  def createWorkbook(): stdLib.Promise[js.Object] = js.native
  /**
       *
       * Creates and opens a new workbook.  Optionally, the workbook can be pre-populated with a base64-encoded .xlsx file.
       *
       ...
       * @param base64File Optional. The base64 encoded .xlsx file. The default value is null.
       */
  def createWorkbook(base64: java.lang.String): stdLib.Promise[js.Object] = js.native
  /**
  ...
  /**
      ...
      * @param batch - A function that takes in a RequestContext and returns a promise (typically, just the result of "context.sync()"). The context parameter facilitates requests to the Excel application. Since the Office add-in and the Excel application run in two different processes, the RequestContext is required to get access to the Excel object model from the add-in.
      */
  def run[T](options: RunOptions, batch: js.Function1[/* context */ RequestContext, stdLib.Promise[T]]): stdLib.Promise[T] = js.native
}
