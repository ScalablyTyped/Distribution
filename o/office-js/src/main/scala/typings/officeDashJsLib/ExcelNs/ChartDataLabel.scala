...
class ChartDataLabel ()
  ...
  def load(option: officeDashJsLib.Anon_Expand): ChartDataLabel = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.ChartDataLabelLoadOptions): ChartDataLabel = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartDataLabelUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartDataLabelUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.ChartDataLabelData = js.native
}
