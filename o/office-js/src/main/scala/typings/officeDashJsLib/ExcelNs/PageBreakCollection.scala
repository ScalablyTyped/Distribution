...
class PageBreakCollection ()
  ...
  def load(
    option: officeDashJsLib.ExcelNs.InterfacesNs.PageBreakCollectionLoadOptions with officeDashJsLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): PageBreakCollection = js.native
  /**
    *
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.PageBreakCollectionData = js.native
}
