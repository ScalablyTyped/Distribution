...
class Workbook ()
  ...
  /**
    ...
    * @eventproperty
    */
  val onAutoSaveSettingChanged: officeDashJsLib.OfficeExtensionNs.EventHandlers[WorkbookAutoSaveSettingChangedEventArgs] = js.native
  /**
    *
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  def getIsActiveCollabSession(): officeDashJsLib.OfficeExtensionNs.ClientResult[scala.Boolean] = js.native
  /**
    *
