...
class Image ()
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  val format: PictureFormat | officeDashJsLib.officeDashJsLibStrings.UNKNOWN | officeDashJsLib.officeDashJsLibStrings.BMP | officeDashJsLib.officeDashJsLibStrings.JPEG | officeDashJsLib.officeDashJsLibStrings.GIF | officeDashJsLib.officeDashJsLibStrings.PNG | officeDashJsLib.officeDashJsLibStrings.SVG = js.native
  /**
    *
  ...
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.ImageLoadOptions): Image = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.ImageData = js.native
}
