...
class ChartErrorBars ()
  ...
  def load(option: officeDashJsLib.Anon_Expand): ChartErrorBars = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.ChartErrorBarsLoadOptions): ChartErrorBars = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartErrorBarsUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartErrorBarsUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.ChartErrorBarsData = js.native
}
