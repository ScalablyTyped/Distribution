...
trait SearchCriteria extends js.Object {
  ...
  var searchDirection: js.UndefOr[
    SearchDirection | officeDashJsLib.officeDashJsLibStrings.Forward | officeDashJsLib.officeDashJsLibStrings.Backwards
  ] = js.undefined
}
...
object SearchCriteria {
  ...
  def apply(
    ...
    searchDirection: SearchDirection | officeDashJsLib.officeDashJsLibStrings.Forward | officeDashJsLib.officeDashJsLibStrings.Backwards = null
  ): SearchCriteria = {
