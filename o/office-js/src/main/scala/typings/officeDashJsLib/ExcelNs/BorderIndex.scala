...
object BorderIndex extends js.Object {
  ...
  sealed trait diagonalDown
    extends officeDashJsLib.ExcelNs.BorderIndex
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.ExcelNs.BorderIndex with java.lang.String] = js.native
}
