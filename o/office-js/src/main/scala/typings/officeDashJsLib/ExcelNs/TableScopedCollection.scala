...
class TableScopedCollection ()
  ...
  def load(
    option: officeDashJsLib.ExcelNs.InterfacesNs.TableScopedCollectionLoadOptions with officeDashJsLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): TableScopedCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.TableScopedCollectionData = js.native
}
