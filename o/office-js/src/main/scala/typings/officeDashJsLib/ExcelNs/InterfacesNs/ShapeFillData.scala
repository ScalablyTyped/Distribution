...
trait ShapeFillData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    officeDashJsLib.ExcelNs.ShapeFillType | officeDashJsLib.officeDashJsLibStrings.NoFill | officeDashJsLib.officeDashJsLibStrings.Solid | officeDashJsLib.officeDashJsLibStrings.Gradient | officeDashJsLib.officeDashJsLibStrings.Pattern | officeDashJsLib.officeDashJsLibStrings.PictureAndTexture | officeDashJsLib.officeDashJsLibStrings.Mixed
  ] = js.undefined
}
...
object ShapeFillData {
  ...
  def apply(
    ...
    `type`: officeDashJsLib.ExcelNs.ShapeFillType | officeDashJsLib.officeDashJsLibStrings.NoFill | officeDashJsLib.officeDashJsLibStrings.Solid | officeDashJsLib.officeDashJsLibStrings.Gradient | officeDashJsLib.officeDashJsLibStrings.Pattern | officeDashJsLib.officeDashJsLibStrings.PictureAndTexture | officeDashJsLib.officeDashJsLibStrings.Mixed = null
  ): ShapeFillData = {
