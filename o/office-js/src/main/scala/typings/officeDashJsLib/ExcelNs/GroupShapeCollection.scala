...
class GroupShapeCollection ()
  ...
  def load(
    option: officeDashJsLib.ExcelNs.InterfacesNs.GroupShapeCollectionLoadOptions with officeDashJsLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): GroupShapeCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.GroupShapeCollectionData = js.native
}
