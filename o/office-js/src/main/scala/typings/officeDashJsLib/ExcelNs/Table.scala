...
class Table ()
  ...
  /**
           ...
           * @eventproperty
           */
  val onSelectionChanged: officeDashJsLib.OfficeExtensionNs.EventHandlers[TableSelectionChangedEventArgs] = js.native
  /**
           *
  ...
  /**
           ...
           * @param options Provides options for which properties of the object to load.
           */
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.TableLoadOptions): Table = js.native
  /**
           *
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
           ...
           */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.TableUpdateData): scala.Unit = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
           *
           * @remarks
           *
           ...
           */
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.TableUpdateData,
    options: officeDashJsLib.OfficeExtensionNs.UpdateOptions
  ): scala.Unit = js.native
  /** Sets multiple properties on the object at the same time, based on an existing loaded object. */
  def set(properties: Table): scala.Unit = js.native
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.TableData = js.native
}
