...
class RangeCollection ()
  ...
  def load(
    option: officeDashJsLib.ExcelNs.InterfacesNs.RangeCollectionLoadOptions with officeDashJsLib.ExcelNs.InterfacesNs.CollectionLoadOptions
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.RangeCollectionData = js.native
}
