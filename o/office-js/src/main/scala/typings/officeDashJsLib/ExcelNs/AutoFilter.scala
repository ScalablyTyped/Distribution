...
class AutoFilter ()
  ...
  def load(option: officeDashJsLib.Anon_Expand): AutoFilter = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.AutoFilterLoadOptions): AutoFilter = js.native
  /**
    *
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.AutoFilterData = js.native
}
