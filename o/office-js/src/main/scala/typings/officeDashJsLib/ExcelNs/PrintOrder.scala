...
object PrintOrder extends js.Object {
  ...
  sealed trait downThenOver
    extends officeDashJsLib.ExcelNs.PrintOrder
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.ExcelNs.PrintOrder with java.lang.String] = js.native
}
