...
object Placement extends js.Object {
  ...
  sealed trait absolute
    extends officeDashJsLib.ExcelNs.Placement
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.ExcelNs.Placement with java.lang.String] = js.native
}
