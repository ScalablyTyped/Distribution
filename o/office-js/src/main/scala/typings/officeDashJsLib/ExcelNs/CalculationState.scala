...
object CalculationState extends js.Object {
  ...
  sealed trait calculating
    extends officeDashJsLib.ExcelNs.CalculationState
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.ExcelNs.CalculationState with java.lang.String] = js.native
}
