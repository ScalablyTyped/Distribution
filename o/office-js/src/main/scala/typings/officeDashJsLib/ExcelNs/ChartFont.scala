...
class ChartFont ()
  ...
  /**
    ...
    * [Api set: ExcelApi 1.1]
    */
  var underline: ChartUnderlineStyle | officeDashJsLib.officeDashJsLibStrings.None | officeDashJsLib.officeDashJsLibStrings.Single = js.native
  /**
  ...
  def load(option: officeDashJsLib.Anon_Expand): ChartFont = js.native
  def load(option: officeDashJsLib.ExcelNs.InterfacesNs.ChartFontLoadOptions): ChartFont = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartFontUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.ExcelNs.InterfacesNs.ChartFontUpdateData,
    options: officeDashJsLib.OfficeExtensionNs.UpdateOptions
  ): scala.Unit = js.native
  def toJSON(): officeDashJsLib.ExcelNs.InterfacesNs.ChartFontData = js.native
}
