...
trait NotificationMessageDetails extends js.Object {
  ...
  /**
    ...
    */
  var `type`: officeDashJsLib.OfficeNs.MailboxEnumsNs.ItemNotificationMessageType | java.lang.String
}
...
object NotificationMessageDetails {
  ...
  def apply(
    ...
    `type`: officeDashJsLib.OfficeNs.MailboxEnumsNs.ItemNotificationMessageType | java.lang.String,
