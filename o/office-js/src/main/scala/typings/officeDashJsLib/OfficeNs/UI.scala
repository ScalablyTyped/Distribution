...
trait UI extends js.Object {
  /**
    ...
    */
  def closeContainer(): scala.Unit = js.native
  /**
  ...
  def messageParent(message: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def messageParent(message: scala.Boolean): scala.Unit = js.native
}
