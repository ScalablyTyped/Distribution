...
object LocationType extends js.Object {
  ...
  @js.native
  sealed trait Custom
    extends officeDashJsLib.OfficeNs.MailboxEnumsNs.LocationType
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.OfficeNs.MailboxEnumsNs.LocationType with java.lang.String] = js.native
}
