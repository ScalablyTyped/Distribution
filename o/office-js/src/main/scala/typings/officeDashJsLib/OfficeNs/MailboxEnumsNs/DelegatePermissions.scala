...
object DelegatePermissions extends js.Object {
  ...
  sealed trait DeleteAll
    extends officeDashJsLib.OfficeNs.MailboxEnumsNs.DelegatePermissions
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[officeDashJsLib.OfficeNs.MailboxEnumsNs.DelegatePermissions with scala.Double] = js.native
}
