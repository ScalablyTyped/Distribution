...
trait Diagnostics extends js.Object {
  /**
    ...
    * </table>
    */
  var OWAView: officeDashJsLib.OfficeNs.MailboxEnumsNs.OWAView | officeDashJsLib.officeDashJsLibStrings.OneColumn | officeDashJsLib.officeDashJsLibStrings.TwoColumns | officeDashJsLib.officeDashJsLibStrings.ThreeColumns
  /**
