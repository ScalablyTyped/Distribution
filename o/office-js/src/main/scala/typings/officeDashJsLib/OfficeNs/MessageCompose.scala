...
/**
     ...
     */
/* RemoveMultipleInheritance: Dropped parents List(officeDashJsLib.OfficeNs.ItemCompose because Would inherit conflicting mutable fields List(notificationMessages, body, recurrence, dateTimeCreated, itemType, dateTimeModifed, seriesId))*/
@js.native
