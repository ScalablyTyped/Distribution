...
/**
  ...
  */
/* RemoveMultipleInheritance: Dropped parents List(officeDashJsLib.OfficeNs.ItemCompose because Would inherit conflicting mutable fields List(body, dateTimeCreated, dateTimeModifed, itemType, notificationMessages, recurrence, seriesId))*/
@js.native
