...
class InkAnalysisWordCollection ()
  ...
  def load(
    option: officeDashJsLib.OneNoteNs.InterfacesNs.InkAnalysisWordCollectionLoadOptions with officeDashJsLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): InkAnalysisWordCollection = js.native
  def toJSON(): officeDashJsLib.OneNoteNs.InterfacesNs.InkAnalysisWordCollectionData = js.native
  /**
