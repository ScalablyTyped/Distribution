...
class PageContentCollection ()
  ...
  def load(
    option: officeDashJsLib.OneNoteNs.InterfacesNs.PageContentCollectionLoadOptions with officeDashJsLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): PageContentCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.OneNoteNs.InterfacesNs.PageContentCollectionData = js.native
  /**
