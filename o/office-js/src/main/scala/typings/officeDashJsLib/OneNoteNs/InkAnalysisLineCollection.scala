...
class InkAnalysisLineCollection ()
  ...
  /**
           ...
           */
  def getItem(index: java.lang.String): InkAnalysisLine = js.native
  /**
           *
           * Gets a InkAnalysisLine object by ID or by its index in the collection. Read-only.
           *
           ...
           * @param index The ID of the InkAnalysisLine object, or the index location of the InkAnalysisLine object in the collection.
           */
  def getItem(index: scala.Double): InkAnalysisLine = js.native
  /**
           *
           ...
           */
  def getItemAt(index: scala.Double): InkAnalysisLine = js.native
  /**
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsLib.OneNoteNs.InterfacesNs.InkAnalysisLineCollectionLoadOptions with officeDashJsLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ): InkAnalysisLineCollection = js.native
  def load(option: java.lang.String): InkAnalysisLineCollection = js.native
  def load(option: js.Array[java.lang.String]): InkAnalysisLineCollection = js.native
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): InkAnalysisLineCollection = js.native
  def toJSON(): officeDashJsLib.OneNoteNs.InterfacesNs.InkAnalysisLineCollectionData = js.native
  /**
