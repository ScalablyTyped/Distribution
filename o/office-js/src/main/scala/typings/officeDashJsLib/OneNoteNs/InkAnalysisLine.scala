...
class InkAnalysisLine ()
  ...
  def load(option: officeDashJsLib.Anon_Select): InkAnalysisLine = js.native
  def load(option: officeDashJsLib.OneNoteNs.InterfacesNs.InkAnalysisLineLoadOptions): InkAnalysisLine = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.OneNoteNs.InterfacesNs.InkAnalysisLineUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.OneNoteNs.InterfacesNs.InkAnalysisLineUpdateData,
    options: officeDashJsLib.OfficeExtensionNs.UpdateOptions
  ): scala.Unit = js.native
  def toJSON(): officeDashJsLib.OneNoteNs.InterfacesNs.InkAnalysisLineData = js.native
  /**
