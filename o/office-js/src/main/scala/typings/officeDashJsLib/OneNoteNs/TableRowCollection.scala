...
class TableRowCollection ()
  ...
  def load(
    option: officeDashJsLib.OneNoteNs.InterfacesNs.TableRowCollectionLoadOptions with officeDashJsLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.OneNoteNs.InterfacesNs.TableRowCollectionData = js.native
  /**
