...
trait PageContentData extends js.Object {
  ...
  /**
               ...
               */
  var `type`: js.UndefOr[
    officeDashJsLib.OneNoteNs.PageContentType | officeDashJsLib.officeDashJsLibStrings.Outline | officeDashJsLib.officeDashJsLibStrings.Image | officeDashJsLib.officeDashJsLibStrings.Ink | officeDashJsLib.officeDashJsLibStrings.Other
  ] = js.undefined
}
