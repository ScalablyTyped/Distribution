...
class Section ()
  ...
  /**
    ...
    */
  val isEncrypted: scala.Boolean = js.native
  /**
    *
  ...
  /**
    ...
    */
  def addPage(title: java.lang.String): Page = js.native
  /**
    *
  ...
  /**
    ...
    */
  def insertSectionAsSibling(location: InsertLocation, title: java.lang.String): Section = js.native
  @JSName("insertSectionAsSibling")
  def insertSectionAsSibling_After(location: officeDashJsLib.officeDashJsLibStrings.After, title: java.lang.String): Section = js.native
  /**
    *
    * Inserts a new section before or after the current section.
    *
    ...
    */
  @JSName("insertSectionAsSibling")
  def insertSectionAsSibling_Before(location: officeDashJsLib.officeDashJsLibStrings.Before, title: java.lang.String): Section = js.native
  /**
  ...
  def load(option: officeDashJsLib.OneNoteNs.InterfacesNs.SectionLoadOptions): Section = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.OneNoteNs.InterfacesNs.SectionData = js.native
  /**
