...
class Table ()
  ...
  def load(option: officeDashJsLib.OneNoteNs.InterfacesNs.TableLoadOptions): Table = js.native
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.OneNoteNs.InterfacesNs.TableUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.OneNoteNs.InterfacesNs.TableUpdateData,
  ...
  def toJSON(): officeDashJsLib.OneNoteNs.InterfacesNs.TableData = js.native
  /**
