...
class ParagraphCollection ()
  ...
  def load(
    option: officeDashJsLib.OneNoteNs.InterfacesNs.ParagraphCollectionLoadOptions with officeDashJsLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ...
  def toJSON(): officeDashJsLib.OneNoteNs.InterfacesNs.ParagraphCollectionData = js.native
  /**
