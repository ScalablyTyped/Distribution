...
class TableRow ()
  ...
  /**
           ...
           * @param values Strings to insert in the new row, specified as an array. Must not have more cells than in the current row. Optional.
           */
  def insertRowAsSibling(insertLocation: InsertLocation, values: js.Array[java.lang.String]): TableRow = js.native
  /**
           *
           * Inserts a row before or after the current row.
           *
  ...
  def insertRowAsSibling_After(insertLocation: officeDashJsLib.officeDashJsLibStrings.After): TableRow = js.native
  /**
           *
           * Inserts a row before or after the current row.
           *
           ...
           */
  @JSName("insertRowAsSibling")
  def insertRowAsSibling_After(insertLocation: officeDashJsLib.officeDashJsLibStrings.After, values: js.Array[java.lang.String]): TableRow = js.native
  /**
           *
           * Inserts a row before or after the current row.
           *
           ...
           */
  @JSName("insertRowAsSibling")
  def insertRowAsSibling_Before(insertLocation: officeDashJsLib.officeDashJsLibStrings.Before): TableRow = js.native
  /**
           *
           * Inserts a row before or after the current row.
           *
           ...
           */
  @JSName("insertRowAsSibling")
  def insertRowAsSibling_Before(insertLocation: officeDashJsLib.officeDashJsLibStrings.Before, values: js.Array[java.lang.String]): TableRow = js.native
  /**
