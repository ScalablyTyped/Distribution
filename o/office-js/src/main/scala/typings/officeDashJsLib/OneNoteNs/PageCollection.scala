...
class PageCollection ()
  ...
  def load(
    option: officeDashJsLib.OneNoteNs.InterfacesNs.PageCollectionLoadOptions with officeDashJsLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ...
  def toJSON(): officeDashJsLib.OneNoteNs.InterfacesNs.PageCollectionData = js.native
  /**
