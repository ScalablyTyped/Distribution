...
class InkWordCollection ()
  ...
  def load(
    option: officeDashJsLib.OneNoteNs.InterfacesNs.InkWordCollectionLoadOptions with officeDashJsLib.OneNoteNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): InkWordCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.OneNoteNs.InterfacesNs.InkWordCollectionData = js.native
  /**
