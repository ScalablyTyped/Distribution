...
class CustomProperty ()
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: DocumentPropertyType | officeDashJsLib.officeDashJsLibStrings.String | officeDashJsLib.officeDashJsLibStrings.Number | officeDashJsLib.officeDashJsLibStrings.Date | officeDashJsLib.officeDashJsLibStrings.Boolean = js.native
  /**
    *
  ...
  def load(option: officeDashJsLib.WordNs.InterfacesNs.CustomPropertyLoadOptions): CustomProperty = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.WordNs.InterfacesNs.CustomPropertyUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.WordNs.InterfacesNs.CustomPropertyUpdateData,
    options: officeDashJsLib.OfficeExtensionNs.UpdateOptions
  ): scala.Unit = js.native
  def toJSON(): officeDashJsLib.WordNs.InterfacesNs.CustomPropertyData = js.native
  /**
