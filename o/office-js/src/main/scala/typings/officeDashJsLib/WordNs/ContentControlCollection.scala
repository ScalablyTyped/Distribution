...
class ContentControlCollection ()
  ...
  def load(
    option: officeDashJsLib.WordNs.InterfacesNs.ContentControlCollectionLoadOptions with officeDashJsLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): ContentControlCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.WordNs.InterfacesNs.ContentControlCollectionData = js.native
  /**
