...
class RangeCollection ()
  ...
  def load(
    option: officeDashJsLib.WordNs.InterfacesNs.RangeCollectionLoadOptions with officeDashJsLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): RangeCollection = js.native
  def toJSON(): officeDashJsLib.WordNs.InterfacesNs.RangeCollectionData = js.native
  /**
