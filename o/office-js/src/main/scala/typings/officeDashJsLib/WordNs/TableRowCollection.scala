...
class TableRowCollection ()
  ...
  def load(
    option: officeDashJsLib.WordNs.InterfacesNs.TableRowCollectionLoadOptions with officeDashJsLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.WordNs.InterfacesNs.TableRowCollectionData = js.native
  /**
