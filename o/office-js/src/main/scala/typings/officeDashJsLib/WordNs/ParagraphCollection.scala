...
class ParagraphCollection ()
  ...
  def load(
    option: officeDashJsLib.WordNs.InterfacesNs.ParagraphCollectionLoadOptions with officeDashJsLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): ParagraphCollection = js.native
  /**
    ...
    */
  def toJSON(): officeDashJsLib.WordNs.InterfacesNs.ParagraphCollectionData = js.native
  /**
