...
class DocumentProperties ()
  ...
  def load(option: officeDashJsLib.Anon_Expand): DocumentProperties = js.native
  def load(option: officeDashJsLib.WordNs.InterfacesNs.DocumentPropertiesLoadOptions): DocumentProperties = js.native
  ...
  /** Sets multiple properties of an object at the same time. You can pass either a plain object with the appropriate properties, or another API object of the same type.
    ...
    */
  def set(properties: officeDashJsLib.WordNs.InterfacesNs.DocumentPropertiesUpdateData): scala.Unit = js.native
  def set(
    properties: officeDashJsLib.WordNs.InterfacesNs.DocumentPropertiesUpdateData,
  ...
  /**
    ...
    */
  def toJSON(): officeDashJsLib.WordNs.InterfacesNs.DocumentPropertiesData = js.native
  /**
