...
object ContentControlAppearance extends js.Object {
  ...
  sealed trait boundingBox
    extends officeDashJsLib.WordNs.ContentControlAppearance
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[officeDashJsLib.WordNs.ContentControlAppearance with java.lang.String] = js.native
}
