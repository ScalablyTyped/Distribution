...
class CustomPropertyCollection ()
  ...
  def load(
    option: officeDashJsLib.WordNs.InterfacesNs.CustomPropertyCollectionLoadOptions with officeDashJsLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  def toJSON(): officeDashJsLib.WordNs.InterfacesNs.CustomPropertyCollectionData = js.native
  /**
