...
class InlinePictureCollection ()
  ...
  def load(
    option: officeDashJsLib.WordNs.InterfacesNs.InlinePictureCollectionLoadOptions with officeDashJsLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  def load(option: officeDashJsLib.OfficeExtensionNs.LoadOption): InlinePictureCollection = js.native
  def toJSON(): officeDashJsLib.WordNs.InterfacesNs.InlinePictureCollectionData = js.native
  /**
