...
class SectionCollection ()
  ...
  /**
           ...
           */
  def load(
    option: officeDashJsLib.WordNs.InterfacesNs.SectionCollectionLoadOptions with officeDashJsLib.WordNs.InterfacesNs.CollectionLoadOptions
  ...
  def toJSON(): officeDashJsLib.WordNs.InterfacesNs.SectionCollectionData = js.native
  /**
