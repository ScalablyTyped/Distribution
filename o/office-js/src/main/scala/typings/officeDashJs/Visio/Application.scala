...
import typings.officeDashJs.Visio.Interfaces.ApplicationData
import typings.officeDashJs.Visio.Interfaces.ApplicationLoadOptions
import typings.officeDashJs.Visio.Interfaces.ApplicationUpdateData
