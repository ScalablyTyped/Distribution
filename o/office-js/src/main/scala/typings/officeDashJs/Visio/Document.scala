...
import typings.officeDashJs.Visio.Interfaces.DocumentData
import typings.officeDashJs.Visio.Interfaces.DocumentLoadOptions
import typings.officeDashJs.Visio.Interfaces.DocumentUpdateData
