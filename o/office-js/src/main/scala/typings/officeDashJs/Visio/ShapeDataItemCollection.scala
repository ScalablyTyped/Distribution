...
import typings.officeDashJs.Visio.Interfaces.CollectionLoadOptions
import typings.officeDashJs.Visio.Interfaces.ShapeDataItemCollectionData
import typings.officeDashJs.Visio.Interfaces.ShapeDataItemCollectionLoadOptions
