...
import typings.officeDashJs.Visio.Interfaces.ShapeData
import typings.officeDashJs.Visio.Interfaces.ShapeLoadOptions
import typings.officeDashJs.Visio.Interfaces.ShapeUpdateData
