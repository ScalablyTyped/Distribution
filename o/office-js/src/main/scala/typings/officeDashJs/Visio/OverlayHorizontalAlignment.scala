...
import typings.officeDashJs.Visio.OverlayHorizontalAlignment.center
import typings.officeDashJs.Visio.OverlayHorizontalAlignment.left
import typings.officeDashJs.Visio.OverlayHorizontalAlignment.right
