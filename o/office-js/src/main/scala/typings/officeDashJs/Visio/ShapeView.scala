...
import typings.officeDashJs.Visio.Interfaces.ShapeViewData
import typings.officeDashJs.Visio.Interfaces.ShapeViewLoadOptions
import typings.officeDashJs.Visio.Interfaces.ShapeViewUpdateData
