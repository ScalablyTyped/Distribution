...
object OverlayVerticalAlignment extends js.Object {
  ...
  /* "Bottom" */ val bottom: typings.officeDashJs.Visio.OverlayVerticalAlignment.bottom with String = js.native
  /* "Middle" */ val middle: typings.officeDashJs.Visio.OverlayVerticalAlignment.middle with String = js.native
  /* "Top" */ val top: typings.officeDashJs.Visio.OverlayVerticalAlignment.top with String = js.native
  @JSBracketAccess
