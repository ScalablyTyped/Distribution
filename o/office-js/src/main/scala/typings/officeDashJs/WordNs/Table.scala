...
import typings.officeDashJs.WordNs.InterfacesNs.TableData
import typings.officeDashJs.WordNs.InterfacesNs.TableLoadOptions
import typings.officeDashJs.WordNs.InterfacesNs.TableUpdateData
