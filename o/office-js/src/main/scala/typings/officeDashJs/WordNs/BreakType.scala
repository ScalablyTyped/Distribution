...
object BreakType extends js.Object {
  ...
  /* "Line" */ val line: typings.officeDashJs.WordNs.BreakType.line with String = js.native
  /* "Next" */ val next: typings.officeDashJs.WordNs.BreakType.next with String = js.native
  /* "Page" */ val page: typings.officeDashJs.WordNs.BreakType.page with String = js.native
  /* "SectionContinuous" */ val sectionContinuous: typings.officeDashJs.WordNs.BreakType.sectionContinuous with String = js.native
  /* "SectionEven" */ val sectionEven: typings.officeDashJs.WordNs.BreakType.sectionEven with String = js.native
  /* "SectionNext" */ val sectionNext: typings.officeDashJs.WordNs.BreakType.sectionNext with String = js.native
  /* "SectionOdd" */ val sectionOdd: typings.officeDashJs.WordNs.BreakType.sectionOdd with String = js.native
  @JSBracketAccess
