...
object SelectionMode extends js.Object {
  ...
  /* "End" */ val end: typings.officeDashJs.WordNs.SelectionMode.end with String = js.native
  /* "Select" */ val select: typings.officeDashJs.WordNs.SelectionMode.select with String = js.native
  /* "Start" */ val start: typings.officeDashJs.WordNs.SelectionMode.start with String = js.native
  @JSBracketAccess
