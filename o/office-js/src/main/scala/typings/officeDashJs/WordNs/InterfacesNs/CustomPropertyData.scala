...
import typings.officeDashJs.WordNs.DocumentPropertyType
...
trait CustomPropertyData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    DocumentPropertyType | typings.officeDashJs.officeDashJsStrings.String | Number | Date | Boolean
  ] = js.undefined
  /**
    *
...
object CustomPropertyData {
  ...
  def apply(
    key: String = null,
    `type`: DocumentPropertyType | typings.officeDashJs.officeDashJsStrings.String | Number | Date | Boolean = null,
    value: js.Any = null
  ): CustomPropertyData = {
