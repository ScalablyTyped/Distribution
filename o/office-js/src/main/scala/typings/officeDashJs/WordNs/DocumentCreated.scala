...
import typings.officeDashJs.WordNs.InterfacesNs.DocumentCreatedData
import typings.officeDashJs.WordNs.InterfacesNs.DocumentCreatedLoadOptions
import typings.officeDashJs.WordNs.InterfacesNs.DocumentCreatedUpdateData
