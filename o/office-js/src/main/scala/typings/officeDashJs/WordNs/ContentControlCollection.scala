...
import typings.officeDashJs.WordNs.InterfacesNs.ContentControlCollectionData
import typings.officeDashJs.WordNs.InterfacesNs.ContentControlCollectionLoadOptions
