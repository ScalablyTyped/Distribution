...
import typings.officeDashJs.WordNs.InterfacesNs.SectionCollectionData
import typings.officeDashJs.WordNs.InterfacesNs.SectionCollectionLoadOptions
...
@js.native
class SectionCollection () extends ClientObject {
