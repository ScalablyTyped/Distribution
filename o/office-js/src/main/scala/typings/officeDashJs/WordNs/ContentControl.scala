...
import typings.officeDashJs.WordNs.InterfacesNs.ContentControlData
import typings.officeDashJs.WordNs.InterfacesNs.ContentControlLoadOptions
import typings.officeDashJs.WordNs.InterfacesNs.ContentControlUpdateData
