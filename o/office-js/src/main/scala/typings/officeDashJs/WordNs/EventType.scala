...
object EventType extends js.Object {
  ...
  /* "AnnotationAdded" */ val annotationAdded: typings.officeDashJs.WordNs.EventType.annotationAdded with String = js.native
  /* "AnnotationChanged" */ val annotationChanged: typings.officeDashJs.WordNs.EventType.annotationChanged with String = js.native
  /* "AnnotationDeleted" */ val annotationDeleted: typings.officeDashJs.WordNs.EventType.annotationDeleted with String = js.native
  /* "ContentControlAdded" */ val contentControlAdded: typings.officeDashJs.WordNs.EventType.contentControlAdded with String = js.native
  /* "ContentControlDataChanged" */ val contentControlDataChanged: typings.officeDashJs.WordNs.EventType.contentControlDataChanged with String = js.native
  /* "ContentControlDeleted" */ val contentControlDeleted: typings.officeDashJs.WordNs.EventType.contentControlDeleted with String = js.native
  /* "ContentControlSelectionChanged" */ val contentControlSelectionChanged: typings.officeDashJs.WordNs.EventType.contentControlSelectionChanged with String = js.native
  @JSBracketAccess
