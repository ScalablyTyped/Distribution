...
object ContentControlAppearance extends js.Object {
  ...
  /* "BoundingBox" */ val boundingBox: typings.officeDashJs.WordNs.ContentControlAppearance.boundingBox with String = js.native
  /* "Hidden" */ val hidden: typings.officeDashJs.WordNs.ContentControlAppearance.hidden with String = js.native
  /* "Tags" */ val tags: typings.officeDashJs.WordNs.ContentControlAppearance.tags with String = js.native
  @JSBracketAccess
