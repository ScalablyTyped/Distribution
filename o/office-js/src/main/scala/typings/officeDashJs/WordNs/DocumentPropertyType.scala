...
object DocumentPropertyType extends js.Object {
  ...
  /* "Boolean" */ val boolean: typings.officeDashJs.WordNs.DocumentPropertyType.boolean with String = js.native
  /* "Date" */ val date: typings.officeDashJs.WordNs.DocumentPropertyType.date with String = js.native
  /* "Number" */ val number: typings.officeDashJs.WordNs.DocumentPropertyType.number with String = js.native
  /* "String" */ val string: typings.officeDashJs.WordNs.DocumentPropertyType.string with String = js.native
  @JSBracketAccess
