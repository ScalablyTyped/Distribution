...
import typings.officeDashJs.WordNs.InterfacesNs.SearchOptionsData
import typings.officeDashJs.WordNs.InterfacesNs.SearchOptionsLoadOptions
import typings.officeDashJs.WordNs.InterfacesNs.SearchOptionsUpdateData
