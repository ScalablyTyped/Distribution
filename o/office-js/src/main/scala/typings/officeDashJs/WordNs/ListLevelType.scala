...
object ListLevelType extends js.Object {
  ...
  /* "Bullet" */ val bullet: typings.officeDashJs.WordNs.ListLevelType.bullet with String = js.native
  /* "Number" */ val number: typings.officeDashJs.WordNs.ListLevelType.number with String = js.native
  /* "Picture" */ val picture: typings.officeDashJs.WordNs.ListLevelType.picture with String = js.native
  @JSBracketAccess
