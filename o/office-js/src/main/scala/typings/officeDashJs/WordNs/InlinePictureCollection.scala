...
import typings.officeDashJs.WordNs.InterfacesNs.InlinePictureCollectionData
import typings.officeDashJs.WordNs.InterfacesNs.InlinePictureCollectionLoadOptions
