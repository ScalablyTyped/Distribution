...
import typings.officeDashJs.WordNs.InterfacesNs.CustomPropertyCollectionData
import typings.officeDashJs.WordNs.InterfacesNs.CustomPropertyCollectionLoadOptions
