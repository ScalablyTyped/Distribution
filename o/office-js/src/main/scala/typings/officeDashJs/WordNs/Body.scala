...
import typings.officeDashJs.WordNs.InterfacesNs.BodyData
import typings.officeDashJs.WordNs.InterfacesNs.BodyLoadOptions
import typings.officeDashJs.WordNs.InterfacesNs.BodyUpdateData
