...
import typings.officeDashJs.WordNs.InterfacesNs.CustomPropertyData
import typings.officeDashJs.WordNs.InterfacesNs.CustomPropertyLoadOptions
import typings.officeDashJs.WordNs.InterfacesNs.CustomPropertyUpdateData
