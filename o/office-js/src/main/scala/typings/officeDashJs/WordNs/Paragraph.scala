...
import typings.officeDashJs.WordNs.InterfacesNs.ParagraphData
import typings.officeDashJs.WordNs.InterfacesNs.ParagraphLoadOptions
import typings.officeDashJs.WordNs.InterfacesNs.ParagraphUpdateData
