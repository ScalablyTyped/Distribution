...
import typings.officeDashJs.WordNs.InterfacesNs.DocumentData
import typings.officeDashJs.WordNs.InterfacesNs.DocumentLoadOptions
import typings.officeDashJs.WordNs.InterfacesNs.DocumentUpdateData
