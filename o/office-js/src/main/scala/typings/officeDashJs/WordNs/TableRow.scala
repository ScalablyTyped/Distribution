...
import typings.officeDashJs.WordNs.InterfacesNs.TableRowData
import typings.officeDashJs.WordNs.InterfacesNs.TableRowLoadOptions
import typings.officeDashJs.WordNs.InterfacesNs.TableRowUpdateData
