...
import typings.officeDashJs.WordNs.InterfacesNs.SectionData
import typings.officeDashJs.WordNs.InterfacesNs.SectionLoadOptions
import typings.officeDashJs.WordNs.InterfacesNs.SectionUpdateData
