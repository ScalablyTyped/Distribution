...
import typings.officeDashJs.WordNs.InterfacesNs.TableCellData
import typings.officeDashJs.WordNs.InterfacesNs.TableCellLoadOptions
import typings.officeDashJs.WordNs.InterfacesNs.TableCellUpdateData
