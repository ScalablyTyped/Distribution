...
object LocationRelation extends js.Object {
  ...
  /* "AdjacentAfter" */ val adjacentAfter: typings.officeDashJs.WordNs.LocationRelation.adjacentAfter with String = js.native
  /* "AdjacentBefore" */ val adjacentBefore: typings.officeDashJs.WordNs.LocationRelation.adjacentBefore with String = js.native
  /* "After" */ val after: typings.officeDashJs.WordNs.LocationRelation.after with String = js.native
  /* "Before" */ val before: typings.officeDashJs.WordNs.LocationRelation.before with String = js.native
  /* "Contains" */ val contains: typings.officeDashJs.WordNs.LocationRelation.contains with String = js.native
  /* "ContainsEnd" */ val containsEnd: typings.officeDashJs.WordNs.LocationRelation.containsEnd with String = js.native
  /* "ContainsStart" */ val containsStart: typings.officeDashJs.WordNs.LocationRelation.containsStart with String = js.native
  /* "Equal" */ val equal: typings.officeDashJs.WordNs.LocationRelation.equal with String = js.native
  /* "Inside" */ val inside: typings.officeDashJs.WordNs.LocationRelation.inside with String = js.native
  /* "InsideEnd" */ val insideEnd: typings.officeDashJs.WordNs.LocationRelation.insideEnd with String = js.native
  /* "InsideStart" */ val insideStart: typings.officeDashJs.WordNs.LocationRelation.insideStart with String = js.native
  /* "OverlapsAfter" */ val overlapsAfter: typings.officeDashJs.WordNs.LocationRelation.overlapsAfter with String = js.native
  /* "OverlapsBefore" */ val overlapsBefore: typings.officeDashJs.WordNs.LocationRelation.overlapsBefore with String = js.native
  /* "Unrelated" */ val unrelated: typings.officeDashJs.WordNs.LocationRelation.unrelated with String = js.native
  @JSBracketAccess
