...
import typings.officeDashJs.OneNote.Interfaces.InkAnalysisData
import typings.officeDashJs.OneNote.Interfaces.InkAnalysisLoadOptions
import typings.officeDashJs.OneNote.Interfaces.InkAnalysisUpdateData
