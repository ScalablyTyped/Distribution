...
import typings.officeDashJs.OneNote.Interfaces.InkAnalysisWordData
import typings.officeDashJs.OneNote.Interfaces.InkAnalysisWordLoadOptions
import typings.officeDashJs.OneNote.Interfaces.InkAnalysisWordUpdateData
