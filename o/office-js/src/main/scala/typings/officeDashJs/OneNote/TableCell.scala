...
import typings.officeDashJs.OneNote.Interfaces.TableCellData
import typings.officeDashJs.OneNote.Interfaces.TableCellLoadOptions
import typings.officeDashJs.OneNote.Interfaces.TableCellUpdateData
