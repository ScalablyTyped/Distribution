...
import typings.officeDashJs.OneNote.Interfaces.ParagraphData
import typings.officeDashJs.OneNote.Interfaces.ParagraphLoadOptions
import typings.officeDashJs.OneNote.Interfaces.ParagraphUpdateData
