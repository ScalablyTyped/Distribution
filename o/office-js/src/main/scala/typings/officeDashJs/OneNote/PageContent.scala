...
import typings.officeDashJs.OneNote.Interfaces.PageContentData
import typings.officeDashJs.OneNote.Interfaces.PageContentLoadOptions
import typings.officeDashJs.OneNote.Interfaces.PageContentUpdateData
...
class PageContent () extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: PageContentType | typings.officeDashJs.officeDashJsStrings.Outline | typings.officeDashJs.officeDashJsStrings.Image | Ink | Other = js.native
  /**
    *
  ...
  def load(option: Anon_Expand): PageContent = js.native
