...
import typings.officeDashJs.OneNote.Interfaces.PageData
import typings.officeDashJs.OneNote.Interfaces.PageLoadOptions
import typings.officeDashJs.OneNote.Interfaces.PageUpdateData
