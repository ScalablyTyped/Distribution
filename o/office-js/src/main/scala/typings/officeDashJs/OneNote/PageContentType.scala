...
object PageContentType extends js.Object {
  ...
  /* "Image" */ val image: typings.officeDashJs.OneNote.PageContentType.image with String = js.native
  /* "Ink" */ val ink: typings.officeDashJs.OneNote.PageContentType.ink with String = js.native
  /* "Other" */ val other: typings.officeDashJs.OneNote.PageContentType.other with String = js.native
  /* "Outline" */ val outline: typings.officeDashJs.OneNote.PageContentType.outline with String = js.native
  @JSBracketAccess
