...
import typings.officeDashJs.OneNote.Interfaces.InkAnalysisWordCollectionData
import typings.officeDashJs.OneNote.Interfaces.InkAnalysisWordCollectionLoadOptions
