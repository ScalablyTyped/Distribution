...
import typings.officeDashJs.OneNote.Interfaces.SectionGroupCollectionData
import typings.officeDashJs.OneNote.Interfaces.SectionGroupCollectionLoadOptions
