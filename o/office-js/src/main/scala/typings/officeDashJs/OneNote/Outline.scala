...
import typings.officeDashJs.OneNote.Interfaces.OutlineData
import typings.officeDashJs.OneNote.Interfaces.OutlineLoadOptions
...
class Outline () extends ClientObject {
  ...
  def load(option: Anon_Expand): Outline = js.native
