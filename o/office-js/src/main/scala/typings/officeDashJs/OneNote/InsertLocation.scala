...
object InsertLocation extends js.Object {
  ...
  /* "After" */ val after: typings.officeDashJs.OneNote.InsertLocation.after with String = js.native
  /* "Before" */ val before: typings.officeDashJs.OneNote.InsertLocation.before with String = js.native
  @JSBracketAccess
