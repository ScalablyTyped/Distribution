...
import typings.officeDashJs.OneNote.Interfaces.TableData
import typings.officeDashJs.OneNote.Interfaces.TableLoadOptions
import typings.officeDashJs.OneNote.Interfaces.TableUpdateData
