...
import typings.officeDashJs.OneNote.Interfaces.ImageData
import typings.officeDashJs.OneNote.Interfaces.ImageLoadOptions
import typings.officeDashJs.OneNote.Interfaces.ImageUpdateData
