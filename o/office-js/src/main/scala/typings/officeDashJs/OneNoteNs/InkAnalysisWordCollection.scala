...
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisWordCollectionData
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisWordCollectionLoadOptions
