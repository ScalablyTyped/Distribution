...
import typings.officeDashJs.OneNoteNs.InterfacesNs.ParagraphCollectionData
import typings.officeDashJs.OneNoteNs.InterfacesNs.ParagraphCollectionLoadOptions
