...
import typings.officeDashJs.OneNoteNs.InterfacesNs.ImageData
import typings.officeDashJs.OneNoteNs.InterfacesNs.ImageLoadOptions
import typings.officeDashJs.OneNoteNs.InterfacesNs.ImageUpdateData
