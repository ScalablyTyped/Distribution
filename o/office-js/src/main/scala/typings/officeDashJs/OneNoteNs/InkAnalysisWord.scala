...
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisWordData
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisWordLoadOptions
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisWordUpdateData
