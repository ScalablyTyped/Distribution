...
import typings.officeDashJs.OneNoteNs.InterfacesNs.TableData
import typings.officeDashJs.OneNoteNs.InterfacesNs.TableLoadOptions
import typings.officeDashJs.OneNoteNs.InterfacesNs.TableUpdateData
