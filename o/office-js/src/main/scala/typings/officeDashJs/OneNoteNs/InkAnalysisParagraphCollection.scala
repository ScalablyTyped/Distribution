...
import typings.officeDashJs.OneNoteNs.InterfacesNs.CollectionLoadOptions
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisParagraphCollectionData
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisParagraphCollectionLoadOptions
