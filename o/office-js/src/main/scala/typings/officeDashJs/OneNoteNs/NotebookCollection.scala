...
import typings.officeDashJs.OneNoteNs.InterfacesNs.NotebookCollectionData
import typings.officeDashJs.OneNoteNs.InterfacesNs.NotebookCollectionLoadOptions
