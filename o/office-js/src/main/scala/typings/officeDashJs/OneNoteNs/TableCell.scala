...
import typings.officeDashJs.OneNoteNs.InterfacesNs.TableCellData
import typings.officeDashJs.OneNoteNs.InterfacesNs.TableCellLoadOptions
import typings.officeDashJs.OneNoteNs.InterfacesNs.TableCellUpdateData
...
class TableCell () extends ClientObject {
  ...
  def load(option: Anon_Expand): TableCell = js.native
