...
import typings.officeDashJs.OneNoteNs.InterfacesNs.TableCellCollectionData
import typings.officeDashJs.OneNoteNs.InterfacesNs.TableCellCollectionLoadOptions
