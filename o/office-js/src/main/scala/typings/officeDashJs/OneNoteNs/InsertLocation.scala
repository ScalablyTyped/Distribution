...
object InsertLocation extends js.Object {
  ...
  /* "After" */ val after: typings.officeDashJs.OneNoteNs.InsertLocation.after with String = js.native
  /* "Before" */ val before: typings.officeDashJs.OneNoteNs.InsertLocation.before with String = js.native
  @JSBracketAccess
