...
import typings.officeDashJs.OneNoteNs.InterfacesNs.SectionGroupData
import typings.officeDashJs.OneNoteNs.InterfacesNs.SectionGroupLoadOptions
...
class SectionGroup () extends ClientObject {
  ...
  def load(option: Anon_Expand): SectionGroup = js.native
