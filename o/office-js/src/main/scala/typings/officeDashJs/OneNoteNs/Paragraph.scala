...
import typings.officeDashJs.OneNoteNs.InterfacesNs.ParagraphData
import typings.officeDashJs.OneNoteNs.InterfacesNs.ParagraphLoadOptions
import typings.officeDashJs.OneNoteNs.InterfacesNs.ParagraphUpdateData
...
class Paragraph () extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: ParagraphType | typings.officeDashJs.officeDashJsStrings.RichText | typings.officeDashJs.officeDashJsStrings.Image | typings.officeDashJs.officeDashJsStrings.Table | Ink | Other = js.native
  def addNoteTag(
  ...
  def load(option: Anon_Expand): Paragraph = js.native
