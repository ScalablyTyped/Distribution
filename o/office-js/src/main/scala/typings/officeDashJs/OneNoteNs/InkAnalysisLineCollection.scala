...
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisLineCollectionData
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisLineCollectionLoadOptions
