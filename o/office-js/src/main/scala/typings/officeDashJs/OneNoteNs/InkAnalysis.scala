...
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisData
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisLoadOptions
import typings.officeDashJs.OneNoteNs.InterfacesNs.InkAnalysisUpdateData
