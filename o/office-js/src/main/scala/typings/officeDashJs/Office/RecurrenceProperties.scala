...
import typings.officeDashJs.Office.MailboxEnums.Days
import typings.officeDashJs.Office.MailboxEnums.Month
import typings.officeDashJs.Office.MailboxEnums.WeekNumber
