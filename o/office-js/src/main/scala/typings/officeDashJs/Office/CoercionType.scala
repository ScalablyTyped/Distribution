...
object CoercionType extends js.Object {
  ...
  /* 3 */ val Html: typings.officeDashJs.Office.CoercionType.Html with Double = js.native
  /* 6 */ val Image: typings.officeDashJs.Office.CoercionType.Image with Double = js.native
  /* 1 */ val Matrix: typings.officeDashJs.Office.CoercionType.Matrix with Double = js.native
  /* 4 */ val Ooxml: typings.officeDashJs.Office.CoercionType.Ooxml with Double = js.native
  /* 5 */ val SlideRange: typings.officeDashJs.Office.CoercionType.SlideRange with Double = js.native
  /* 2 */ val Table: typings.officeDashJs.Office.CoercionType.Table with Double = js.native
  /* 0 */ val Text: typings.officeDashJs.Office.CoercionType.Text with Double = js.native
  /* 7 */ val XmlSvg: typings.officeDashJs.Office.CoercionType.XmlSvg with Double = js.native
  @JSBracketAccess
