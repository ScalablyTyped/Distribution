...
object Index extends js.Object {
  ...
  /* 0 */ val First: typings.officeDashJs.Office.Index.First with Double = js.native
  /* 1 */ val Last: typings.officeDashJs.Office.Index.Last with Double = js.native
  /* 2 */ val Next: typings.officeDashJs.Office.Index.Next with Double = js.native
  /* 3 */ val Previous: typings.officeDashJs.Office.Index.Previous with Double = js.native
  @JSBracketAccess
