...
object ItemType extends js.Object {
  ...
  /* "appointment" */ val Appointment: typings.officeDashJs.Office.MailboxEnums.ItemType.Appointment with String = js.native
  /* "message" */ val Message: typings.officeDashJs.Office.MailboxEnums.ItemType.Message with String = js.native
  @JSBracketAccess
