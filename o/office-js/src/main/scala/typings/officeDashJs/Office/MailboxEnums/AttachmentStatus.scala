...
object AttachmentStatus extends js.Object {
  ...
  /* "added" */ val Added: typings.officeDashJs.Office.MailboxEnums.AttachmentStatus.Added with String = js.native
  /* "removed" */ val Removed: typings.officeDashJs.Office.MailboxEnums.AttachmentStatus.Removed with String = js.native
  @JSBracketAccess
