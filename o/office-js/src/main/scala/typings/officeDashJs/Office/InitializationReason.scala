...
object InitializationReason extends js.Object {
  ...
  /* 1 */ val DocumentOpened: typings.officeDashJs.Office.InitializationReason.DocumentOpened with Double = js.native
  /* 0 */ val Inserted: typings.officeDashJs.Office.InitializationReason.Inserted with Double = js.native
  @JSBracketAccess
