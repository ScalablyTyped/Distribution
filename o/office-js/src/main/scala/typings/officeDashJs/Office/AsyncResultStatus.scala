...
object AsyncResultStatus extends js.Object {
  ...
  /* 1 */ val Failed: typings.officeDashJs.Office.AsyncResultStatus.Failed with Double = js.native
  /* 0 */ val Succeeded: typings.officeDashJs.Office.AsyncResultStatus.Succeeded with Double = js.native
  @JSBracketAccess
