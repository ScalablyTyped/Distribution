...
import typings.officeDashJs.Office.BindingType.Matrix
import typings.officeDashJs.Office.BindingType.Text
...
object BindingType extends js.Object {
  ...
  /* 2 */ @js.native
  object Table
    extends TopLevel[typings.officeDashJs.Office.BindingType.Table with Double]
