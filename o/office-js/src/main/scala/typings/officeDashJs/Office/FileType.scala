...
object FileType extends js.Object {
  ...
  /* 1 */ val Compressed: typings.officeDashJs.Office.FileType.Compressed with Double = js.native
  /* 2 */ val Pdf: typings.officeDashJs.Office.FileType.Pdf with Double = js.native
  /* 0 */ val Text: typings.officeDashJs.Office.FileType.Text with Double = js.native
  @JSBracketAccess
