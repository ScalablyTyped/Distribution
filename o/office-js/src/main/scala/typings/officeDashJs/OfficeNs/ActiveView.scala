...
object ActiveView extends js.Object {
  ...
  /* 1 */ val Edit: typings.officeDashJs.OfficeNs.ActiveView.Edit with Double = js.native
  /* 0 */ val Read: typings.officeDashJs.OfficeNs.ActiveView.Read with Double = js.native
  @JSBracketAccess
