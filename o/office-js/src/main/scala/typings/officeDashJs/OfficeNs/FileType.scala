...
object FileType extends js.Object {
  ...
  /* 1 */ val Compressed: typings.officeDashJs.OfficeNs.FileType.Compressed with Double = js.native
  /* 2 */ val Pdf: typings.officeDashJs.OfficeNs.FileType.Pdf with Double = js.native
  /* 0 */ val Text: typings.officeDashJs.OfficeNs.FileType.Text with Double = js.native
  @JSBracketAccess
