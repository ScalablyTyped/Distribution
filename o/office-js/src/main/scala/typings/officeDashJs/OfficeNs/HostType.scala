...
object HostType extends js.Object {
  ...
  /* 6 */ val Access: typings.officeDashJs.OfficeNs.HostType.Access with Double = js.native
  /* 1 */ val Excel: typings.officeDashJs.OfficeNs.HostType.Excel with Double = js.native
  /* 4 */ val OneNote: typings.officeDashJs.OfficeNs.HostType.OneNote with Double = js.native
  /* 3 */ val Outlook: typings.officeDashJs.OfficeNs.HostType.Outlook with Double = js.native
  /* 2 */ val PowerPoint: typings.officeDashJs.OfficeNs.HostType.PowerPoint with Double = js.native
  /* 5 */ val Project: typings.officeDashJs.OfficeNs.HostType.Project with Double = js.native
  /* 0 */ val Word: typings.officeDashJs.OfficeNs.HostType.Word with Double = js.native
  @JSBracketAccess
