...
object ItemNotificationMessageType extends js.Object {
  ...
  /* "errorMessage" */ val ErrorMessage: typings.officeDashJs.OfficeNs.MailboxEnumsNs.ItemNotificationMessageType.ErrorMessage with String = js.native
  /* "informationalMessage" */ val InformationalMessage: typings.officeDashJs.OfficeNs.MailboxEnumsNs.ItemNotificationMessageType.InformationalMessage with String = js.native
  /* "progressIndicator" */ val ProgressIndicator: typings.officeDashJs.OfficeNs.MailboxEnumsNs.ItemNotificationMessageType.ProgressIndicator with String = js.native
  @JSBracketAccess
