...
object OWAView extends js.Object {
  ...
  /* "OneColumn" */ val OneColumn: typings.officeDashJs.OfficeNs.MailboxEnumsNs.OWAView.OneColumn with String = js.native
  /* "ThreeColumns" */ val ThreeColumns: typings.officeDashJs.OfficeNs.MailboxEnumsNs.OWAView.ThreeColumns with String = js.native
  /* "TwoColumns" */ val TwoColumns: typings.officeDashJs.OfficeNs.MailboxEnumsNs.OWAView.TwoColumns with String = js.native
  @JSBracketAccess
