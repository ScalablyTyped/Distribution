...
object DocumentMode extends js.Object {
  ...
  /* 0 */ val ReadOnly: typings.officeDashJs.OfficeNs.DocumentMode.ReadOnly with Double = js.native
  /* 1 */ val ReadWrite: typings.officeDashJs.OfficeNs.DocumentMode.ReadWrite with Double = js.native
  @JSBracketAccess
