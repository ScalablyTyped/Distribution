...
object AttachmentType extends js.Object {
  ...
  /* "cloud" */ val Cloud: typings.officeDashJs.OfficeNs.MailboxEnumsNs.AttachmentType.Cloud with String = js.native
  /* "file" */ val File: typings.officeDashJs.OfficeNs.MailboxEnumsNs.AttachmentType.File with String = js.native
  /* "item" */ val Item: typings.officeDashJs.OfficeNs.MailboxEnumsNs.AttachmentType.Item with String = js.native
  @JSBracketAccess
