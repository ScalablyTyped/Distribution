...
object CoercionType extends js.Object {
  ...
  /* 3 */ val Html: typings.officeDashJs.OfficeNs.CoercionType.Html with Double = js.native
  /* 6 */ val Image: typings.officeDashJs.OfficeNs.CoercionType.Image with Double = js.native
  /* 1 */ val Matrix: typings.officeDashJs.OfficeNs.CoercionType.Matrix with Double = js.native
  /* 4 */ val Ooxml: typings.officeDashJs.OfficeNs.CoercionType.Ooxml with Double = js.native
  /* 5 */ val SlideRange: typings.officeDashJs.OfficeNs.CoercionType.SlideRange with Double = js.native
  /* 2 */ val Table: typings.officeDashJs.OfficeNs.CoercionType.Table with Double = js.native
  /* 0 */ val Text: typings.officeDashJs.OfficeNs.CoercionType.Text with Double = js.native
  /* 7 */ val XmlSvg: typings.officeDashJs.OfficeNs.CoercionType.XmlSvg with Double = js.native
  @JSBracketAccess
