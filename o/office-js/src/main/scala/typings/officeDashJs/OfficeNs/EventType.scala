...
object EventType extends js.Object {
  ...
  /* 2 */ val AttachmentsChanged: typings.officeDashJs.OfficeNs.EventType.AttachmentsChanged with Double = js.native
  /* 3 */ val BindingDataChanged: typings.officeDashJs.OfficeNs.EventType.BindingDataChanged with Double = js.native
  /* 4 */ val BindingSelectionChanged: typings.officeDashJs.OfficeNs.EventType.BindingSelectionChanged with Double = js.native
  /* 6 */ val DialogEventReceived: typings.officeDashJs.OfficeNs.EventType.DialogEventReceived with Double = js.native
  /* 5 */ val DialogMessageReceived: typings.officeDashJs.OfficeNs.EventType.DialogMessageReceived with Double = js.native
  /* 7 */ val DocumentSelectionChanged: typings.officeDashJs.OfficeNs.EventType.DocumentSelectionChanged with Double = js.native
  /* 9 */ val EnhancedLocationsChanged: typings.officeDashJs.OfficeNs.EventType.EnhancedLocationsChanged with Double = js.native
  /* 8 */ val ItemChanged: typings.officeDashJs.OfficeNs.EventType.ItemChanged with Double = js.native
  /* 10 */ val NodeDeleted: typings.officeDashJs.OfficeNs.EventType.NodeDeleted with Double = js.native
  /* 11 */ val NodeInserted: typings.officeDashJs.OfficeNs.EventType.NodeInserted with Double = js.native
  /* 12 */ val NodeReplaced: typings.officeDashJs.OfficeNs.EventType.NodeReplaced with Double = js.native
  /* 13 */ val OfficeThemeChanged: typings.officeDashJs.OfficeNs.EventType.OfficeThemeChanged with Double = js.native
  /* 14 */ val RecipientsChanged: typings.officeDashJs.OfficeNs.EventType.RecipientsChanged with Double = js.native
  /* 15 */ val RecurrenceChanged: typings.officeDashJs.OfficeNs.EventType.RecurrenceChanged with Double = js.native
  /* 16 */ val ResourceSelectionChanged: typings.officeDashJs.OfficeNs.EventType.ResourceSelectionChanged with Double = js.native
  /* 17 */ val SettingsChanged: typings.officeDashJs.OfficeNs.EventType.SettingsChanged with Double = js.native
  /* 18 */ val TaskSelectionChanged: typings.officeDashJs.OfficeNs.EventType.TaskSelectionChanged with Double = js.native
  /* 19 */ val ViewSelectionChanged: typings.officeDashJs.OfficeNs.EventType.ViewSelectionChanged with Double = js.native
  @JSBracketAccess
