...
object Index extends js.Object {
  ...
  /* 0 */ val First: typings.officeDashJs.OfficeNs.Index.First with Double = js.native
  /* 1 */ val Last: typings.officeDashJs.OfficeNs.Index.Last with Double = js.native
  /* 2 */ val Next: typings.officeDashJs.OfficeNs.Index.Next with Double = js.native
  /* 3 */ val Previous: typings.officeDashJs.OfficeNs.Index.Previous with Double = js.native
  @JSBracketAccess
