...
object BindingType extends js.Object {
  ...
  /* 1 */ val Matrix: typings.officeDashJs.OfficeNs.BindingType.Matrix with Double = js.native
  /* 2 */ val Table: typings.officeDashJs.OfficeNs.BindingType.Table with Double = js.native
  /* 0 */ val Text: typings.officeDashJs.OfficeNs.BindingType.Text with Double = js.native
  @JSBracketAccess
