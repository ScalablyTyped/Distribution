...
object PlatformType extends js.Object {
  ...
  /* 4 */ val Android: typings.officeDashJs.OfficeNs.PlatformType.Android with Double = js.native
  /* 2 */ val Mac: typings.officeDashJs.OfficeNs.PlatformType.Mac with Double = js.native
  /* 1 */ val OfficeOnline: typings.officeDashJs.OfficeNs.PlatformType.OfficeOnline with Double = js.native
  /* 0 */ val PC: typings.officeDashJs.OfficeNs.PlatformType.PC with Double = js.native
  /* 5 */ val Universal: typings.officeDashJs.OfficeNs.PlatformType.Universal with Double = js.native
  /* 3 */ val iOS: typings.officeDashJs.OfficeNs.PlatformType.iOS with Double = js.native
  @JSBracketAccess
