...
object ItemType extends js.Object {
  ...
  /* "appointment" */ val Appointment: typings.officeDashJs.OfficeNs.MailboxEnumsNs.ItemType.Appointment with String = js.native
  /* "message" */ val Message: typings.officeDashJs.OfficeNs.MailboxEnumsNs.ItemType.Message with String = js.native
  @JSBracketAccess
