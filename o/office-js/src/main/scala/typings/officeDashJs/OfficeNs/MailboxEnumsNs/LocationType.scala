...
object LocationType extends js.Object {
  ...
  /* "custom" */ val Custom: typings.officeDashJs.OfficeNs.MailboxEnumsNs.LocationType.Custom with String = js.native
  /* "room" */ val Room: typings.officeDashJs.OfficeNs.MailboxEnumsNs.LocationType.Room with String = js.native
  @JSBracketAccess
