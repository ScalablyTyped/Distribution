...
object FilterType extends js.Object {
  ...
  /* 0 */ val All: typings.officeDashJs.OfficeNs.FilterType.All with Double = js.native
  /* 1 */ val OnlyVisible: typings.officeDashJs.OfficeNs.FilterType.OnlyVisible with Double = js.native
  @JSBracketAccess
