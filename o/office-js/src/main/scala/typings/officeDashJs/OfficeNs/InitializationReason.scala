...
object InitializationReason extends js.Object {
  ...
  /* 1 */ val DocumentOpened: typings.officeDashJs.OfficeNs.InitializationReason.DocumentOpened with Double = js.native
  /* 0 */ val Inserted: typings.officeDashJs.OfficeNs.InitializationReason.Inserted with Double = js.native
  @JSBracketAccess
