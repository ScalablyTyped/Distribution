...
object ProjectProjectFields extends js.Object {
  ...
  /* 0 */ val CurrencyDigits: typings.officeDashJs.OfficeNs.ProjectProjectFields.CurrencyDigits with Double = js.native
  /* 1 */ val CurrencySymbol: typings.officeDashJs.OfficeNs.ProjectProjectFields.CurrencySymbol with Double = js.native
  /* 2 */ val CurrencySymbolPosition: typings.officeDashJs.OfficeNs.ProjectProjectFields.CurrencySymbolPosition with Double = js.native
  /* 3 */ val DurationUnits: typings.officeDashJs.OfficeNs.ProjectProjectFields.DurationUnits with Double = js.native
  /* 5 */ val Finish: typings.officeDashJs.OfficeNs.ProjectProjectFields.Finish with Double = js.native
  /* 4 */ val GUID: typings.officeDashJs.OfficeNs.ProjectProjectFields.GUID with Double = js.native
  /* 10 */ val ProjectServerUrl: typings.officeDashJs.OfficeNs.ProjectProjectFields.ProjectServerUrl with Double = js.native
  /* 7 */ val ReadOnly: typings.officeDashJs.OfficeNs.ProjectProjectFields.ReadOnly with Double = js.native
  /* 6 */ val Start: typings.officeDashJs.OfficeNs.ProjectProjectFields.Start with Double = js.native
  /* 8 */ val VERSION: typings.officeDashJs.OfficeNs.ProjectProjectFields.VERSION with Double = js.native
  /* 12 */ val WSSList: typings.officeDashJs.OfficeNs.ProjectProjectFields.WSSList with Double = js.native
  /* 11 */ val WSSUrl: typings.officeDashJs.OfficeNs.ProjectProjectFields.WSSUrl with Double = js.native
  /* 9 */ val WorkUnits: typings.officeDashJs.OfficeNs.ProjectProjectFields.WorkUnits with Double = js.native
  @JSBracketAccess
