...
object SourceProperty extends js.Object {
  ...
  /* 0 */ val Body: typings.officeDashJs.OfficeNs.SourceProperty.Body with Double = js.native
  /* 1 */ val Subject: typings.officeDashJs.OfficeNs.SourceProperty.Subject with Double = js.native
  @JSBracketAccess
