...
object AttachmentContentFormat extends js.Object {
  ...
  /* "base64" */ val Base64: typings.officeDashJs.OfficeNs.MailboxEnumsNs.AttachmentContentFormat.Base64 with String = js.native
  /* "eml" */ val Eml: typings.officeDashJs.OfficeNs.MailboxEnumsNs.AttachmentContentFormat.Eml with String = js.native
  /* "iCalendar" */ val ICalendar: typings.officeDashJs.OfficeNs.MailboxEnumsNs.AttachmentContentFormat.ICalendar with String = js.native
  /* "url" */ val Url: typings.officeDashJs.OfficeNs.MailboxEnumsNs.AttachmentContentFormat.Url with String = js.native
  @JSBracketAccess
