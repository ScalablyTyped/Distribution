...
object SelectionMode extends js.Object {
  ...
  /* 0 */ val Default: typings.officeDashJs.OfficeNs.SelectionMode.Default with Double = js.native
  /* 2 */ val None: typings.officeDashJs.OfficeNs.SelectionMode.None with Double = js.native
  /* 1 */ val Selected: typings.officeDashJs.OfficeNs.SelectionMode.Selected with Double = js.native
  @JSBracketAccess
