...
object ValueFormat extends js.Object {
  ...
  /* 1 */ val Formatted: typings.officeDashJs.OfficeNs.ValueFormat.Formatted with Double = js.native
  /* 0 */ val Unformatted: typings.officeDashJs.OfficeNs.ValueFormat.Unformatted with Double = js.native
  @JSBracketAccess
