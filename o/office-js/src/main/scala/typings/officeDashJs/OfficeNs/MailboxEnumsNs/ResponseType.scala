...
object ResponseType extends js.Object {
  ...
  /* "accepted" */ val Accepted: typings.officeDashJs.OfficeNs.MailboxEnumsNs.ResponseType.Accepted with String = js.native
  /* "declined" */ val Declined: typings.officeDashJs.OfficeNs.MailboxEnumsNs.ResponseType.Declined with String = js.native
  /* "none" */ val None: typings.officeDashJs.OfficeNs.MailboxEnumsNs.ResponseType.None with String = js.native
  /* "organizer" */ val Organizer: typings.officeDashJs.OfficeNs.MailboxEnumsNs.ResponseType.Organizer with String = js.native
  /* "tentative" */ val Tentative: typings.officeDashJs.OfficeNs.MailboxEnumsNs.ResponseType.Tentative with String = js.native
  @JSBracketAccess
