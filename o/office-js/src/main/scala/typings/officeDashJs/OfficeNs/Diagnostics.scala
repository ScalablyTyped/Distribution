...
import typings.officeDashJs.OfficeNs.MailboxEnumsNs.OWAView
import typings.officeDashJs.officeDashJsStrings.OneColumn
import typings.officeDashJs.officeDashJsStrings.ThreeColumns
import typings.officeDashJs.officeDashJsStrings.TwoColumns
...
trait Diagnostics extends js.Object {
  /**
    ...
    * **{@link https://docs.microsoft.com/outlook/add-ins/#extension-points | Applicable Outlook mode}**: Compose or Read
    */
  var OWAView: typings.officeDashJs.OfficeNs.MailboxEnumsNs.OWAView | OneColumn | TwoColumns | ThreeColumns
  /**
