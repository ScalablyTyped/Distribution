...
object AsyncResultStatus extends js.Object {
  ...
  /* 1 */ val Failed: typings.officeDashJs.OfficeNs.AsyncResultStatus.Failed with Double = js.native
  /* 0 */ val Succeeded: typings.officeDashJs.OfficeNs.AsyncResultStatus.Succeeded with Double = js.native
  @JSBracketAccess
