...
object AttachmentStatus extends js.Object {
  ...
  /* "added" */ val Added: typings.officeDashJs.OfficeNs.MailboxEnumsNs.AttachmentStatus.Added with String = js.native
  /* "removed" */ val Removed: typings.officeDashJs.OfficeNs.MailboxEnumsNs.AttachmentStatus.Removed with String = js.native
  @JSBracketAccess
