...
import typings.officeDashJs.Anon_Host
...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def initialize(reason: InitializationReason): Unit = js.native
  /**
    ...
    */
  def onReady(): js.Promise[Anon_Host] = js.native
  def onReady(callback: js.Function1[/* info */ Anon_Host, _]): js.Promise[Anon_Host] = js.native
  /**
    ...
    *  </table>
    */
  def select(expression: String): Binding = js.native
  def select(expression: String, callback: js.Function1[/* result */ AsyncResult[_], Unit]): Binding = js.native
  /**
    ...
    */
  def useShortNamespace(useShortNamespace: Boolean): Unit = js.native
}
