...
object ConditionalTopBottomCriterionType extends js.Object {
  ...
  /* "BottomItems" */ val bottomItems: typings.officeDashJs.ExcelNs.ConditionalTopBottomCriterionType.bottomItems with String = js.native
  /* "BottomPercent" */ val bottomPercent: typings.officeDashJs.ExcelNs.ConditionalTopBottomCriterionType.bottomPercent with String = js.native
  /* "Invalid" */ val invalid: typings.officeDashJs.ExcelNs.ConditionalTopBottomCriterionType.invalid with String = js.native
  /* "TopItems" */ val topItems: typings.officeDashJs.ExcelNs.ConditionalTopBottomCriterionType.topItems with String = js.native
  /* "TopPercent" */ val topPercent: typings.officeDashJs.ExcelNs.ConditionalTopBottomCriterionType.topPercent with String = js.native
  @JSBracketAccess
