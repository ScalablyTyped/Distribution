...
import typings.officeDashJs.ExcelNs.HorizontalAlignment
import typings.officeDashJs.ExcelNs.ReadingOrder
import typings.officeDashJs.ExcelNs.VerticalAlignment
