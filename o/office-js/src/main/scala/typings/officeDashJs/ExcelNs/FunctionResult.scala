...
import typings.officeDashJs.ExcelNs.InterfacesNs.FunctionResultData
import typings.officeDashJs.ExcelNs.InterfacesNs.FunctionResultLoadOptions
...
class FunctionResult[T] () extends ClientObject {
  ...
  def load(option: String): FunctionResult[T] = js.native
  def load(option: js.Array[String]): FunctionResult[T] = js.native
  def load(option: Anon_Expand): FunctionResult[T] = js.native
  def load(option: FunctionResultLoadOptions): FunctionResult[T] = js.native
  /**
