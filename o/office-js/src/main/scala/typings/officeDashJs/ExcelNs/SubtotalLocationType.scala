...
object SubtotalLocationType extends js.Object {
  ...
  /* "AtBottom" */ val atBottom: typings.officeDashJs.ExcelNs.SubtotalLocationType.atBottom with String = js.native
  /* "AtTop" */ val atTop: typings.officeDashJs.ExcelNs.SubtotalLocationType.atTop with String = js.native
  /* "Off" */ val off: typings.officeDashJs.ExcelNs.SubtotalLocationType.off with String = js.native
  @JSBracketAccess
