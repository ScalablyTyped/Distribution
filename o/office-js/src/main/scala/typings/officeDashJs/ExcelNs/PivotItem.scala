...
import typings.officeDashJs.ExcelNs.InterfacesNs.PivotItemData
import typings.officeDashJs.ExcelNs.InterfacesNs.PivotItemLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.PivotItemUpdateData
...
class PivotItem () extends ClientObject {
  ...
  def load(option: String): PivotItem = js.native
  def load(option: js.Array[String]): PivotItem = js.native
  def load(option: Anon_Expand): PivotItem = js.native
  def load(option: PivotItemLoadOptions): PivotItem = js.native
