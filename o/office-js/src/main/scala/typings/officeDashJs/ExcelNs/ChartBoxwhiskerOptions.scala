...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartBoxwhiskerOptionsData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartBoxwhiskerOptionsLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartBoxwhiskerOptionsUpdateData
...
class ChartBoxwhiskerOptions () extends ClientObject {
  ...
  def load(option: String): ChartBoxwhiskerOptions = js.native
  def load(option: js.Array[String]): ChartBoxwhiskerOptions = js.native
  def load(option: Anon_Expand): ChartBoxwhiskerOptions = js.native
  def load(option: ChartBoxwhiskerOptionsLoadOptions): ChartBoxwhiskerOptions = js.native
