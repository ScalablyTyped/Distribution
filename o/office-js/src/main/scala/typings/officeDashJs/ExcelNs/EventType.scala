...
object EventType extends js.Object {
  ...
  /* "AgaveVisualUpdate" */ val agaveVisualUpdate: typings.officeDashJs.ExcelNs.EventType.agaveVisualUpdate with String = js.native
  /* "ChartActivated" */ val chartActivated: typings.officeDashJs.ExcelNs.EventType.chartActivated with String = js.native
  /* "ChartAdded" */ val chartAdded: typings.officeDashJs.ExcelNs.EventType.chartAdded with String = js.native
  /* "ChartDeactivated" */ val chartDeactivated: typings.officeDashJs.ExcelNs.EventType.chartDeactivated with String = js.native
  /* "ChartDeleted" */ val chartDeleted: typings.officeDashJs.ExcelNs.EventType.chartDeleted with String = js.native
  /* "RibbonCommandExecuted" */ val ribbonCommandExecuted: typings.officeDashJs.ExcelNs.EventType.ribbonCommandExecuted with String = js.native
  /* "ShapeActivated" */ val shapeActivated: typings.officeDashJs.ExcelNs.EventType.shapeActivated with String = js.native
  /* "ShapeDeactivated" */ val shapeDeactivated: typings.officeDashJs.ExcelNs.EventType.shapeDeactivated with String = js.native
  /* "TableAdded" */ val tableAdded: typings.officeDashJs.ExcelNs.EventType.tableAdded with String = js.native
  /* "TableChanged" */ val tableChanged: typings.officeDashJs.ExcelNs.EventType.tableChanged with String = js.native
  /* "TableDeleted" */ val tableDeleted: typings.officeDashJs.ExcelNs.EventType.tableDeleted with String = js.native
  /* "TableFiltered" */ val tableFiltered: typings.officeDashJs.ExcelNs.EventType.tableFiltered with String = js.native
  /* "TableSelectionChanged" */ val tableSelectionChanged: typings.officeDashJs.ExcelNs.EventType.tableSelectionChanged with String = js.native
  /* "VisualChange" */ val visualChange: typings.officeDashJs.ExcelNs.EventType.visualChange with String = js.native
  /* "VisualSelectionChanged" */ val visualSelectionChanged: typings.officeDashJs.ExcelNs.EventType.visualSelectionChanged with String = js.native
  /* "WACOperationEvent" */ val wacoperationEvent: typings.officeDashJs.ExcelNs.EventType.wacoperationEvent with String = js.native
  /* "WorkbookAutoSaveSettingChanged" */ val workbookAutoSaveSettingChanged: typings.officeDashJs.ExcelNs.EventType.workbookAutoSaveSettingChanged with String = js.native
  /* "WorksheetActivated" */ val worksheetActivated: typings.officeDashJs.ExcelNs.EventType.worksheetActivated with String = js.native
  /* "WorksheetAdded" */ val worksheetAdded: typings.officeDashJs.ExcelNs.EventType.worksheetAdded with String = js.native
  /* "WorksheetCalculated" */ val worksheetCalculated: typings.officeDashJs.ExcelNs.EventType.worksheetCalculated with String = js.native
  /* "WorksheetChanged" */ val worksheetChanged: typings.officeDashJs.ExcelNs.EventType.worksheetChanged with String = js.native
  /* "WorksheetColumnSorted" */ val worksheetColumnSorted: typings.officeDashJs.ExcelNs.EventType.worksheetColumnSorted with String = js.native
  /* "WorksheetDeactivated" */ val worksheetDeactivated: typings.officeDashJs.ExcelNs.EventType.worksheetDeactivated with String = js.native
  /* "WorksheetDeleted" */ val worksheetDeleted: typings.officeDashJs.ExcelNs.EventType.worksheetDeleted with String = js.native
  /* "WorksheetFiltered" */ val worksheetFiltered: typings.officeDashJs.ExcelNs.EventType.worksheetFiltered with String = js.native
  /* "WorksheetFormatChanged" */ val worksheetFormatChanged: typings.officeDashJs.ExcelNs.EventType.worksheetFormatChanged with String = js.native
  /* "WorksheetRowHiddenChanged" */ val worksheetRowHiddenChanged: typings.officeDashJs.ExcelNs.EventType.worksheetRowHiddenChanged with String = js.native
  /* "WorksheetRowSorted" */ val worksheetRowSorted: typings.officeDashJs.ExcelNs.EventType.worksheetRowSorted with String = js.native
  /* "WorksheetSelectionChanged" */ val worksheetSelectionChanged: typings.officeDashJs.ExcelNs.EventType.worksheetSelectionChanged with String = js.native
  /* "WorksheetSingleClicked" */ val worksheetSingleClicked: typings.officeDashJs.ExcelNs.EventType.worksheetSingleClicked with String = js.native
  @JSBracketAccess
