...
object DeleteShiftDirection extends js.Object {
  ...
  /* "Left" */ val left: typings.officeDashJs.ExcelNs.DeleteShiftDirection.left with String = js.native
  /* "Up" */ val up: typings.officeDashJs.ExcelNs.DeleteShiftDirection.up with String = js.native
  @JSBracketAccess
