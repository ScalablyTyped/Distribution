...
class RowColumnPivotHierarchy () extends ClientObject {
  ...
  def load(option: String): RowColumnPivotHierarchy = js.native
  def load(option: js.Array[String]): RowColumnPivotHierarchy = js.native
  def load(option: Anon_Expand): RowColumnPivotHierarchy = js.native
  def load(option: RowColumnPivotHierarchyLoadOptions): RowColumnPivotHierarchy = js.native
