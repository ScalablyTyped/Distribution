...
object ConditionalTextOperator extends js.Object {
  ...
  /* "BeginsWith" */ val beginsWith: typings.officeDashJs.ExcelNs.ConditionalTextOperator.beginsWith with String = js.native
  /* "Contains" */ val contains: typings.officeDashJs.ExcelNs.ConditionalTextOperator.contains with String = js.native
  /* "EndsWith" */ val endsWith: typings.officeDashJs.ExcelNs.ConditionalTextOperator.endsWith with String = js.native
  /* "Invalid" */ val invalid: typings.officeDashJs.ExcelNs.ConditionalTextOperator.invalid with String = js.native
  /* "NotContains" */ val notContains: typings.officeDashJs.ExcelNs.ConditionalTextOperator.notContains with String = js.native
  @JSBracketAccess
