...
import typings.officeDashJs.ExcelNs.InterfacesNs.TopBottomConditionalFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.TopBottomConditionalFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.TopBottomConditionalFormatUpdateData
...
class TopBottomConditionalFormat () extends ClientObject {
  ...
  def load(option: String): TopBottomConditionalFormat = js.native
  def load(option: js.Array[String]): TopBottomConditionalFormat = js.native
  def load(option: Anon_Expand): TopBottomConditionalFormat = js.native
  def load(option: TopBottomConditionalFormatLoadOptions): TopBottomConditionalFormat = js.native
