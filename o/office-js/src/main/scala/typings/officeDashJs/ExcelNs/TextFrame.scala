...
import typings.officeDashJs.ExcelNs.InterfacesNs.TextFrameData
import typings.officeDashJs.ExcelNs.InterfacesNs.TextFrameLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.TextFrameUpdateData
