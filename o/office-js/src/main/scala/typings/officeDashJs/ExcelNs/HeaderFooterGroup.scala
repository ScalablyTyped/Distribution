...
import typings.officeDashJs.ExcelNs.InterfacesNs.HeaderFooterGroupData
import typings.officeDashJs.ExcelNs.InterfacesNs.HeaderFooterGroupLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.HeaderFooterGroupUpdateData
