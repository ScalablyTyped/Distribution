...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartLegendEntryData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartLegendEntryLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartLegendEntryUpdateData
