...
import typings.officeDashJs.ExcelNs.InterfacesNs.StyleData
import typings.officeDashJs.ExcelNs.InterfacesNs.StyleLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.StyleUpdateData
...
import typings.officeDashJs.officeDashJsStrings.CenterAcrossSelection
import typings.officeDashJs.officeDashJsStrings.Context
import typings.officeDashJs.officeDashJsStrings.Distributed
import typings.officeDashJs.officeDashJsStrings.Fill
import typings.officeDashJs.officeDashJsStrings.General
...
class Style () extends ClientObject {
  ...
  def load(option: String): Style = js.native
  def load(option: js.Array[String]): Style = js.native
  def load(option: Anon_Expand): Style = js.native
  def load(option: StyleLoadOptions): Style = js.native
