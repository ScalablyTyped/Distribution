...
import typings.officeDashJs.ExcelNs.InterfacesNs.WorksheetProtectionData
import typings.officeDashJs.ExcelNs.InterfacesNs.WorksheetProtectionLoadOptions
