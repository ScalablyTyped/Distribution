...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartTrendlineFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartTrendlineFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartTrendlineFormatUpdateData
