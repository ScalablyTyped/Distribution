...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartLegendFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartLegendFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartLegendFormatUpdateData
