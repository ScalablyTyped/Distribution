...
import typings.officeDashJs.ExcelNs.InterfacesNs.ShapeFillData
import typings.officeDashJs.ExcelNs.InterfacesNs.ShapeFillLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ShapeFillUpdateData
...
class ShapeFill () extends ClientObject {
  ...
  def load(option: String): ShapeFill = js.native
  def load(option: js.Array[String]): ShapeFill = js.native
  def load(option: Anon_Expand): ShapeFill = js.native
  def load(option: ShapeFillLoadOptions): ShapeFill = js.native
