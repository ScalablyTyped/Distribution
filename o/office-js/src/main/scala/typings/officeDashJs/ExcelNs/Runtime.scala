...
import typings.officeDashJs.ExcelNs.InterfacesNs.RuntimeData
import typings.officeDashJs.ExcelNs.InterfacesNs.RuntimeLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.RuntimeUpdateData
