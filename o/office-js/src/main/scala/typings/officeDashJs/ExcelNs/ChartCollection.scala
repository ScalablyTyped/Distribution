...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartCollectionData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartCollectionLoadOptions
...
class ChartCollection () extends ClientObject {
  ...
  def load(option: ChartCollectionLoadOptions with CollectionLoadOptions): ChartCollection = js.native
  def load(option: String): ChartCollection = js.native
  def load(option: js.Array[String]): ChartCollection = js.native
  def load(option: LoadOption): ChartCollection = js.native
  /**
