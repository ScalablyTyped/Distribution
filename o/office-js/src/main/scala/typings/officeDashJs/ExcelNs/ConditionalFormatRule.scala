...
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalFormatRuleData
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalFormatRuleLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalFormatRuleUpdateData
...
class ConditionalFormatRule () extends ClientObject {
  ...
  def load(option: String): ConditionalFormatRule = js.native
  def load(option: js.Array[String]): ConditionalFormatRule = js.native
  def load(option: Anon_Expand): ConditionalFormatRule = js.native
  def load(option: ConditionalFormatRuleLoadOptions): ConditionalFormatRule = js.native
