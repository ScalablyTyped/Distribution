...
import typings.officeDashJs.ExcelNs.InterfacesNs.DocumentPropertiesData
import typings.officeDashJs.ExcelNs.InterfacesNs.DocumentPropertiesLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.DocumentPropertiesUpdateData
