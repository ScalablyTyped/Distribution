...
import typings.officeDashJs.ExcelNs.InterfacesNs.TableRowData
import typings.officeDashJs.ExcelNs.InterfacesNs.TableRowLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.TableRowUpdateData
