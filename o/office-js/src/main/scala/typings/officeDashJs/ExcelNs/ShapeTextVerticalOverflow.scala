...
object ShapeTextVerticalOverflow extends js.Object {
  ...
  /* "Clip" */ val clip: typings.officeDashJs.ExcelNs.ShapeTextVerticalOverflow.clip with String = js.native
  /* "Ellipsis" */ val ellipsis: typings.officeDashJs.ExcelNs.ShapeTextVerticalOverflow.ellipsis with String = js.native
  /* "Overflow" */ val overflow: typings.officeDashJs.ExcelNs.ShapeTextVerticalOverflow.overflow with String = js.native
  @JSBracketAccess
