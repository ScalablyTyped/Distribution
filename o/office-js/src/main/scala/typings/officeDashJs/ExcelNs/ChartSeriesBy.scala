...
object ChartSeriesBy extends js.Object {
  ...
  /* "Auto" */ val auto: typings.officeDashJs.ExcelNs.ChartSeriesBy.auto with String = js.native
  /* "Columns" */ val columns: typings.officeDashJs.ExcelNs.ChartSeriesBy.columns with String = js.native
  /* "Rows" */ val rows: typings.officeDashJs.ExcelNs.ChartSeriesBy.rows with String = js.native
  @JSBracketAccess
