...
object ChartDisplayBlanksAs extends js.Object {
  ...
  /* "Interplotted" */ val interplotted: typings.officeDashJs.ExcelNs.ChartDisplayBlanksAs.interplotted with String = js.native
  /* "NotPlotted" */ val notPlotted: typings.officeDashJs.ExcelNs.ChartDisplayBlanksAs.notPlotted with String = js.native
  /* "Zero" */ val zero: typings.officeDashJs.ExcelNs.ChartDisplayBlanksAs.zero with String = js.native
  @JSBracketAccess
