...
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalDataBarNegativeFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalDataBarNegativeFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalDataBarNegativeFormatUpdateData
...
class ConditionalDataBarNegativeFormat () extends ClientObject {
  ...
  def load(option: String): ConditionalDataBarNegativeFormat = js.native
  def load(option: js.Array[String]): ConditionalDataBarNegativeFormat = js.native
  def load(option: Anon_Expand): ConditionalDataBarNegativeFormat = js.native
  def load(option: ConditionalDataBarNegativeFormatLoadOptions): ConditionalDataBarNegativeFormat = js.native
