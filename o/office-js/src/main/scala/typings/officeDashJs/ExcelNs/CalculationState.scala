...
object CalculationState extends js.Object {
  ...
  /* "Calculating" */ val calculating: typings.officeDashJs.ExcelNs.CalculationState.calculating with String = js.native
  /* "Done" */ val done: typings.officeDashJs.ExcelNs.CalculationState.done with String = js.native
  /* "Pending" */ val pending: typings.officeDashJs.ExcelNs.CalculationState.pending with String = js.native
  @JSBracketAccess
