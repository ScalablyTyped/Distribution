...
import typings.officeDashJs.ExcelNs.InterfacesNs.HeaderFooterData
import typings.officeDashJs.ExcelNs.InterfacesNs.HeaderFooterLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.HeaderFooterUpdateData
