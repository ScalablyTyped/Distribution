...
object ShapeTextReadingOrder extends js.Object {
  ...
  /* "LeftToRight" */ val leftToRight: typings.officeDashJs.ExcelNs.ShapeTextReadingOrder.leftToRight with String = js.native
  /* "RightToLeft" */ val rightToLeft: typings.officeDashJs.ExcelNs.ShapeTextReadingOrder.rightToLeft with String = js.native
  @JSBracketAccess
