...
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalRangeFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalRangeFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalRangeFormatUpdateData
...
class ConditionalRangeFormat () extends ClientObject {
  ...
  def load(option: String): ConditionalRangeFormat = js.native
  def load(option: js.Array[String]): ConditionalRangeFormat = js.native
  def load(option: Anon_Expand): ConditionalRangeFormat = js.native
  def load(option: ConditionalRangeFormatLoadOptions): ConditionalRangeFormat = js.native
