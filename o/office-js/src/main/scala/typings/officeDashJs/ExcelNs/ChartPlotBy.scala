...
object ChartPlotBy extends js.Object {
  ...
  /* "Columns" */ val columns: typings.officeDashJs.ExcelNs.ChartPlotBy.columns with String = js.native
  /* "Rows" */ val rows: typings.officeDashJs.ExcelNs.ChartPlotBy.rows with String = js.native
  @JSBracketAccess
