...
import typings.officeDashJs.ExcelNs.InterfacesNs.ColorScaleConditionalFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.ColorScaleConditionalFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ColorScaleConditionalFormatUpdateData
...
class ColorScaleConditionalFormat () extends ClientObject {
  ...
  def load(option: String): ColorScaleConditionalFormat = js.native
  def load(option: js.Array[String]): ColorScaleConditionalFormat = js.native
  def load(option: Anon_Expand): ColorScaleConditionalFormat = js.native
  def load(option: ColorScaleConditionalFormatLoadOptions): ColorScaleConditionalFormat = js.native
