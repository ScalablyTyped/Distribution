...
object CalculationType extends js.Object {
  ...
  /* "Full" */ val full: typings.officeDashJs.ExcelNs.CalculationType.full with String = js.native
  /* "FullRebuild" */ val fullRebuild: typings.officeDashJs.ExcelNs.CalculationType.fullRebuild with String = js.native
  /* "Recalculate" */ val recalculate: typings.officeDashJs.ExcelNs.CalculationType.recalculate with String = js.native
  @JSBracketAccess
