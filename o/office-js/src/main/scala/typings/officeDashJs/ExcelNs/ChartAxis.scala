...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAxisData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAxisLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAxisUpdateData
