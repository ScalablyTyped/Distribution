...
import typings.officeDashJs.ExcelNs.InterfacesNs.BindingData
import typings.officeDashJs.ExcelNs.InterfacesNs.BindingLoadOptions
...
class Binding () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.1]
    */
  val `type`: BindingType | typings.officeDashJs.officeDashJsStrings.Range | typings.officeDashJs.officeDashJsStrings.Table | Text = js.native
  /**
    *
    * Deletes the binding.
    *
  ...
  def load(propertyNamesAndPaths: Anon_Expand): Binding = js.native
