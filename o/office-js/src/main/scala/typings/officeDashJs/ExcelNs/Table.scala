...
import typings.officeDashJs.ExcelNs.InterfacesNs.TableData
import typings.officeDashJs.ExcelNs.InterfacesNs.TableLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.TableUpdateData
