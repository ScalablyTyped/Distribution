...
object ChartAxisDisplayUnit extends js.Object {
  ...
  /* "Billions" */ val billions: typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit.billions with String = js.native
  /* "Custom" */ val custom: typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit.custom with String = js.native
  /* "HundredMillions" */ val hundredMillions: typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit.hundredMillions with String = js.native
  /* "HundredThousands" */ val hundredThousands: typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit.hundredThousands with String = js.native
  /* "Hundreds" */ val hundreds: typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit.hundreds with String = js.native
  /* "Millions" */ val millions: typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit.millions with String = js.native
  /* "None" */ val none: typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit.none with String = js.native
  /* "TenMillions" */ val tenMillions: typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit.tenMillions with String = js.native
  /* "TenThousands" */ val tenThousands: typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit.tenThousands with String = js.native
  /* "Thousands" */ val thousands: typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit.thousands with String = js.native
  /* "Trillions" */ val trillions: typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit.trillions with String = js.native
  @JSBracketAccess
