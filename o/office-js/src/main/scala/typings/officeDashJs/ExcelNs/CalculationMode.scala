...
object CalculationMode extends js.Object {
  ...
  /* "Automatic" */ val automatic: typings.officeDashJs.ExcelNs.CalculationMode.automatic with String = js.native
  /* "AutomaticExceptTables" */ val automaticExceptTables: typings.officeDashJs.ExcelNs.CalculationMode.automaticExceptTables with String = js.native
  /* "Manual" */ val manual: typings.officeDashJs.ExcelNs.CalculationMode.manual with String = js.native
  @JSBracketAccess
