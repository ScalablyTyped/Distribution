...
object Placement extends js.Object {
  ...
  /* "Absolute" */ val absolute: typings.officeDashJs.ExcelNs.Placement.absolute with String = js.native
  /* "OneCell" */ val oneCell: typings.officeDashJs.ExcelNs.Placement.oneCell with String = js.native
  /* "TwoCell" */ val twoCell: typings.officeDashJs.ExcelNs.Placement.twoCell with String = js.native
  @JSBracketAccess
