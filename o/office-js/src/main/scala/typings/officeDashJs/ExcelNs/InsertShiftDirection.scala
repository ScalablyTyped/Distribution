...
object InsertShiftDirection extends js.Object {
  ...
  /* "Down" */ val down: typings.officeDashJs.ExcelNs.InsertShiftDirection.down with String = js.native
  /* "Right" */ val right: typings.officeDashJs.ExcelNs.InsertShiftDirection.right with String = js.native
  @JSBracketAccess
