...
import typings.officeDashJs.ExcelNs.InterfacesNs.GeometricShapeData
import typings.officeDashJs.ExcelNs.InterfacesNs.GeometricShapeLoadOptions
...
class GeometricShape () extends ClientObject {
  ...
  def load(option: String): GeometricShape = js.native
  def load(option: js.Array[String]): GeometricShape = js.native
  def load(option: Anon_Expand): GeometricShape = js.native
  def load(option: GeometricShapeLoadOptions): GeometricShape = js.native
  /**
