...
import typings.officeDashJs.ExcelNs.InterfacesNs.PivotTableData
import typings.officeDashJs.ExcelNs.InterfacesNs.PivotTableLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.PivotTableUpdateData
