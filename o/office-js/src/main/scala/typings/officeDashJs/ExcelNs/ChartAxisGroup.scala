...
object ChartAxisGroup extends js.Object {
  ...
  /* "Primary" */ val primary: typings.officeDashJs.ExcelNs.ChartAxisGroup.primary with String = js.native
  /* "Secondary" */ val secondary: typings.officeDashJs.ExcelNs.ChartAxisGroup.secondary with String = js.native
  @JSBracketAccess
