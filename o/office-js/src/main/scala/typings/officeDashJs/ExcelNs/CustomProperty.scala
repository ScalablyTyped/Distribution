...
import typings.officeDashJs.ExcelNs.InterfacesNs.CustomPropertyData
import typings.officeDashJs.ExcelNs.InterfacesNs.CustomPropertyLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.CustomPropertyUpdateData
