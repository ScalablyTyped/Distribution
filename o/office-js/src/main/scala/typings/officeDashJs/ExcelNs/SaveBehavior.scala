...
object SaveBehavior extends js.Object {
  ...
  /* "Prompt" */ val prompt: typings.officeDashJs.ExcelNs.SaveBehavior.prompt with String = js.native
  /* "Save" */ val save: typings.officeDashJs.ExcelNs.SaveBehavior.save with String = js.native
  @JSBracketAccess
