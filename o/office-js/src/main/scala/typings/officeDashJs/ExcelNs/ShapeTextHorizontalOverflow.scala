...
object ShapeTextHorizontalOverflow extends js.Object {
  ...
  /* "Clip" */ val clip: typings.officeDashJs.ExcelNs.ShapeTextHorizontalOverflow.clip with String = js.native
  /* "Overflow" */ val overflow: typings.officeDashJs.ExcelNs.ShapeTextHorizontalOverflow.overflow with String = js.native
  @JSBracketAccess
