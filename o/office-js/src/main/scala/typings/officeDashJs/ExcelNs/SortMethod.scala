...
object SortMethod extends js.Object {
  ...
  /* "PinYin" */ val pinYin: typings.officeDashJs.ExcelNs.SortMethod.pinYin with String = js.native
  /* "StrokeCount" */ val strokeCount: typings.officeDashJs.ExcelNs.SortMethod.strokeCount with String = js.native
  @JSBracketAccess
