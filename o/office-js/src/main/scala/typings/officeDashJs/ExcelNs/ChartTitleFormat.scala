...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartTitleFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartTitleFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartTitleFormatUpdateData
...
class ChartTitleFormat () extends ClientObject {
  ...
  def load(option: String): ChartTitleFormat = js.native
  def load(option: js.Array[String]): ChartTitleFormat = js.native
  def load(option: Anon_Expand): ChartTitleFormat = js.native
  def load(option: ChartTitleFormatLoadOptions): ChartTitleFormat = js.native
