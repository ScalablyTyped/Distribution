...
object NamedItemScope extends js.Object {
  ...
  /* "Workbook" */ val workbook: typings.officeDashJs.ExcelNs.NamedItemScope.workbook with String = js.native
  /* "Worksheet" */ val worksheet: typings.officeDashJs.ExcelNs.NamedItemScope.worksheet with String = js.native
  @JSBracketAccess
