...
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeAreasData
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeAreasLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeAreasUpdateData
