...
import typings.officeDashJs.ExcelNs.InterfacesNs.CellValueConditionalFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.CellValueConditionalFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.CellValueConditionalFormatUpdateData
