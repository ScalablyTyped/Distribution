...
object ConditionalIconCriterionOperator extends js.Object {
  ...
  /* "GreaterThan" */ val greaterThan: typings.officeDashJs.ExcelNs.ConditionalIconCriterionOperator.greaterThan with String = js.native
  /* "GreaterThanOrEqual" */ val greaterThanOrEqual: typings.officeDashJs.ExcelNs.ConditionalIconCriterionOperator.greaterThanOrEqual with String = js.native
  /* "Invalid" */ val invalid: typings.officeDashJs.ExcelNs.ConditionalIconCriterionOperator.invalid with String = js.native
  @JSBracketAccess
