...
object ChartAxisScaleType extends js.Object {
  ...
  /* "Linear" */ val linear: typings.officeDashJs.ExcelNs.ChartAxisScaleType.linear with String = js.native
  /* "Logarithmic" */ val logarithmic: typings.officeDashJs.ExcelNs.ChartAxisScaleType.logarithmic with String = js.native
  @JSBracketAccess
