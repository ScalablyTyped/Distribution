...
object ConditionalDataBarAxisFormat extends js.Object {
  ...
  /* "Automatic" */ val automatic: typings.officeDashJs.ExcelNs.ConditionalDataBarAxisFormat.automatic with String = js.native
  /* "CellMidPoint" */ val cellMidPoint: typings.officeDashJs.ExcelNs.ConditionalDataBarAxisFormat.cellMidPoint with String = js.native
  /* "None" */ val none: typings.officeDashJs.ExcelNs.ConditionalDataBarAxisFormat.none with String = js.native
  @JSBracketAccess
