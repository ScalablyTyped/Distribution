...
object ArrowheadLength extends js.Object {
  ...
  /* "Long" */ val long: typings.officeDashJs.ExcelNs.ArrowheadLength.long with String = js.native
  /* "Medium" */ val medium: typings.officeDashJs.ExcelNs.ArrowheadLength.medium with String = js.native
  /* "Short" */ val short: typings.officeDashJs.ExcelNs.ArrowheadLength.short with String = js.native
  @JSBracketAccess
