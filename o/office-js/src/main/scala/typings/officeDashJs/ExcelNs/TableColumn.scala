...
import typings.officeDashJs.ExcelNs.InterfacesNs.TableColumnData
import typings.officeDashJs.ExcelNs.InterfacesNs.TableColumnLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.TableColumnUpdateData
