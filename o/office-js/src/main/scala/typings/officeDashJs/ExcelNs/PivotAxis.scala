...
object PivotAxis extends js.Object {
  ...
  /* "Column" */ val column: typings.officeDashJs.ExcelNs.PivotAxis.column with String = js.native
  /* "Data" */ val data: typings.officeDashJs.ExcelNs.PivotAxis.data with String = js.native
  /* "Filter" */ val filter: typings.officeDashJs.ExcelNs.PivotAxis.filter with String = js.native
  /* "Row" */ val row: typings.officeDashJs.ExcelNs.PivotAxis.row with String = js.native
  /* "Unknown" */ val unknown: typings.officeDashJs.ExcelNs.PivotAxis.unknown with String = js.native
  @JSBracketAccess
