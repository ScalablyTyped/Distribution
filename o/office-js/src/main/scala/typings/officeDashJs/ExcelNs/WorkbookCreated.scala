...
import typings.officeDashJs.ExcelNs.InterfacesNs.WorkbookCreatedData
...
class WorkbookCreated () extends ClientObject {
  ...
  def load(option: String): WorkbookCreated = js.native
  def load(option: js.Array[String]): WorkbookCreated = js.native
  def load(option: Anon_Expand): WorkbookCreated = js.native
  /**
