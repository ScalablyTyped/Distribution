...
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeFontData
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeFontLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeFontUpdateData
...
class RangeFont () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.1]
    */
  var underline: RangeUnderlineStyle | None | Single | typings.officeDashJs.officeDashJsStrings.Double | SingleAccountant | DoubleAccountant = js.native
  /**
