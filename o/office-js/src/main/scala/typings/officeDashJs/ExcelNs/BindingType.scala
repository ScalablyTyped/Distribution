...
object BindingType extends js.Object {
  ...
  /* "Range" */ val range: typings.officeDashJs.ExcelNs.BindingType.range with String = js.native
  /* "Table" */ val table: typings.officeDashJs.ExcelNs.BindingType.table with String = js.native
  /* "Text" */ val text: typings.officeDashJs.ExcelNs.BindingType.text with String = js.native
  @JSBracketAccess
