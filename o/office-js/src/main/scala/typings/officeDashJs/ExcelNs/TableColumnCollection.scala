...
import typings.officeDashJs.ExcelNs.InterfacesNs.TableColumnCollectionData
import typings.officeDashJs.ExcelNs.InterfacesNs.TableColumnCollectionLoadOptions
