...
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeViewCollectionData
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeViewCollectionLoadOptions
...
class RangeViewCollection () extends ClientObject {
  ...
  def load(option: RangeViewCollectionLoadOptions with CollectionLoadOptions): RangeViewCollection = js.native
  def load(option: String): RangeViewCollection = js.native
  def load(option: js.Array[String]): RangeViewCollection = js.native
  def load(option: LoadOption): RangeViewCollection = js.native
  /**
