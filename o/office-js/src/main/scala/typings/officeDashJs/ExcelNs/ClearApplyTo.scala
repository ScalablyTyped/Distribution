...
object ClearApplyTo extends js.Object {
  ...
  /* "All" */ val all: typings.officeDashJs.ExcelNs.ClearApplyTo.all with String = js.native
  /* "Contents" */ val contents: typings.officeDashJs.ExcelNs.ClearApplyTo.contents with String = js.native
  /* "Formats" */ val formats: typings.officeDashJs.ExcelNs.ClearApplyTo.formats with String = js.native
  /* "Hyperlinks" */ val hyperlinks: typings.officeDashJs.ExcelNs.ClearApplyTo.hyperlinks with String = js.native
  /* "RemoveHyperlinks" */ val removeHyperlinks: typings.officeDashJs.ExcelNs.ClearApplyTo.removeHyperlinks with String = js.native
  @JSBracketAccess
