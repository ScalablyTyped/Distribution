...
import typings.officeDashJs.ExcelNs.ChartTextHorizontalAlignment
import typings.officeDashJs.ExcelNs.ChartTextVerticalAlignment
import typings.officeDashJs.ExcelNs.ChartTitlePosition
