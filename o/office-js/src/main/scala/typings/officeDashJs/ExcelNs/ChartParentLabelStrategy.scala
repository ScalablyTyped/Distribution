...
object ChartParentLabelStrategy extends js.Object {
  ...
  /* "Banner" */ val banner: typings.officeDashJs.ExcelNs.ChartParentLabelStrategy.banner with String = js.native
  /* "None" */ val none: typings.officeDashJs.ExcelNs.ChartParentLabelStrategy.none with String = js.native
  /* "Overlapping" */ val overlapping: typings.officeDashJs.ExcelNs.ChartParentLabelStrategy.overlapping with String = js.native
  @JSBracketAccess
