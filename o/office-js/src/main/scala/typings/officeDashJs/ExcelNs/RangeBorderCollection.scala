...
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeBorderCollectionData
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeBorderCollectionLoadOptions
