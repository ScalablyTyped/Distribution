...
import typings.officeDashJs.ExcelNs.InterfacesNs.ShapeData
import typings.officeDashJs.ExcelNs.InterfacesNs.ShapeLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ShapeUpdateData
...
import typings.officeDashJs.officeDashJsStrings.CurrentSize
...
import typings.officeDashJs.officeDashJsStrings.ScaleFromBottomRight
import typings.officeDashJs.officeDashJsStrings.ScaleFromMiddle
...
class Shape () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.9]
    */
  val `type`: ShapeType | Unsupported | typings.officeDashJs.officeDashJsStrings.Image | typings.officeDashJs.officeDashJsStrings.GeometricShape | Group | typings.officeDashJs.officeDashJsStrings.Line = js.native
  /**
    *
