...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartTitleData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartTitleLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartTitleUpdateData
