...
object ChartAxisTimeUnit extends js.Object {
  ...
  /* "Days" */ val days: typings.officeDashJs.ExcelNs.ChartAxisTimeUnit.days with String = js.native
  /* "Months" */ val months: typings.officeDashJs.ExcelNs.ChartAxisTimeUnit.months with String = js.native
  /* "Years" */ val years: typings.officeDashJs.ExcelNs.ChartAxisTimeUnit.years with String = js.native
  @JSBracketAccess
