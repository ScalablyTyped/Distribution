...
import typings.officeDashJs.ExcelNs.InterfacesNs.NamedItemArrayValuesData
import typings.officeDashJs.ExcelNs.InterfacesNs.NamedItemArrayValuesLoadOptions
