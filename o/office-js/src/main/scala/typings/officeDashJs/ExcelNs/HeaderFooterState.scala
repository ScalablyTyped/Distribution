...
object HeaderFooterState extends js.Object {
  ...
  /* "Default" */ val default: typings.officeDashJs.ExcelNs.HeaderFooterState.default with String = js.native
  /* "FirstAndDefault" */ val firstAndDefault: typings.officeDashJs.ExcelNs.HeaderFooterState.firstAndDefault with String = js.native
  /* "FirstOddAndEven" */ val firstOddAndEven: typings.officeDashJs.ExcelNs.HeaderFooterState.firstOddAndEven with String = js.native
  /* "OddAndEven" */ val oddAndEven: typings.officeDashJs.ExcelNs.HeaderFooterState.oddAndEven with String = js.native
  @JSBracketAccess
