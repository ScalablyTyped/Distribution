...
object ConditionalFormatDirection extends js.Object {
  ...
  /* "Bottom" */ val bottom: typings.officeDashJs.ExcelNs.ConditionalFormatDirection.bottom with String = js.native
  /* "Top" */ val top: typings.officeDashJs.ExcelNs.ConditionalFormatDirection.top with String = js.native
  @JSBracketAccess
