...
object EventSource extends js.Object {
  ...
  /* "Local" */ val local: typings.officeDashJs.ExcelNs.EventSource.local with String = js.native
  /* "Remote" */ val remote: typings.officeDashJs.ExcelNs.EventSource.remote with String = js.native
  @JSBracketAccess
