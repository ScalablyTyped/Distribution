...
class ChartGridlinesFormat () extends ClientObject {
  ...
  def load(option: String): ChartGridlinesFormat = js.native
  def load(option: js.Array[String]): ChartGridlinesFormat = js.native
  def load(option: Anon_Expand): ChartGridlinesFormat = js.native
  def load(option: ChartGridlinesFormatLoadOptions): ChartGridlinesFormat = js.native
