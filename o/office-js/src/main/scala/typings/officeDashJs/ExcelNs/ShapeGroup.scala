...
import typings.officeDashJs.ExcelNs.InterfacesNs.ShapeGroupData
import typings.officeDashJs.ExcelNs.InterfacesNs.ShapeGroupLoadOptions
...
class ShapeGroup () extends ClientObject {
  ...
  def load(option: String): ShapeGroup = js.native
  def load(option: js.Array[String]): ShapeGroup = js.native
  def load(option: Anon_Expand): ShapeGroup = js.native
  def load(option: ShapeGroupLoadOptions): ShapeGroup = js.native
  /**
