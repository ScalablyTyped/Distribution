...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartFontData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartFontLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartFontUpdateData
