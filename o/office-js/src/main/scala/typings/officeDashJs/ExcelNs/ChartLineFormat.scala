...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartLineFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartLineFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartLineFormatUpdateData
