...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAxisFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAxisFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAxisFormatUpdateData
...
class ChartAxisFormat () extends ClientObject {
  ...
  def load(option: String): ChartAxisFormat = js.native
  def load(option: js.Array[String]): ChartAxisFormat = js.native
  def load(option: Anon_Expand): ChartAxisFormat = js.native
  def load(option: ChartAxisFormatLoadOptions): ChartAxisFormat = js.native
