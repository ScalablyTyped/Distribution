...
object SortBy extends js.Object {
  ...
  /* "Ascending" */ val ascending: typings.officeDashJs.ExcelNs.SortBy.ascending with String = js.native
  /* "Descending" */ val descending: typings.officeDashJs.ExcelNs.SortBy.descending with String = js.native
  @JSBracketAccess
