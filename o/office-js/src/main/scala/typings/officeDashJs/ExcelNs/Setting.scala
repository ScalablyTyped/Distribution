...
import typings.officeDashJs.ExcelNs.InterfacesNs.SettingData
import typings.officeDashJs.ExcelNs.InterfacesNs.SettingLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.SettingUpdateData
...
class Setting () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): Setting = js.native
