...
class FilterPivotHierarchy () extends ClientObject {
  ...
  def load(option: String): FilterPivotHierarchy = js.native
  def load(option: js.Array[String]): FilterPivotHierarchy = js.native
  def load(option: Anon_Expand): FilterPivotHierarchy = js.native
  def load(option: FilterPivotHierarchyLoadOptions): FilterPivotHierarchy = js.native
