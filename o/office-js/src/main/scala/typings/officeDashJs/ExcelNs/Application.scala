...
import typings.officeDashJs.ExcelNs.InterfacesNs.ApplicationData
import typings.officeDashJs.ExcelNs.InterfacesNs.ApplicationLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ApplicationUpdateData
