...
object CloseBehavior extends js.Object {
  ...
  /* "Save" */ val save: typings.officeDashJs.ExcelNs.CloseBehavior.save with String = js.native
  /* "SkipSave" */ val skipSave: typings.officeDashJs.ExcelNs.CloseBehavior.skipSave with String = js.native
  @JSBracketAccess
