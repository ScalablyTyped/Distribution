...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAxisTitleFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAxisTitleFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAxisTitleFormatUpdateData
...
class ChartAxisTitleFormat () extends ClientObject {
  ...
  def load(option: String): ChartAxisTitleFormat = js.native
  def load(option: js.Array[String]): ChartAxisTitleFormat = js.native
  def load(option: Anon_Expand): ChartAxisTitleFormat = js.native
  def load(option: ChartAxisTitleFormatLoadOptions): ChartAxisTitleFormat = js.native
