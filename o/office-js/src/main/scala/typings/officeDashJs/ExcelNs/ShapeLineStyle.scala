...
object ShapeLineStyle extends js.Object {
  ...
  /* "Single" */ val single: typings.officeDashJs.ExcelNs.ShapeLineStyle.single with String = js.native
  /* "ThickBetweenThin" */ val thickBetweenThin: typings.officeDashJs.ExcelNs.ShapeLineStyle.thickBetweenThin with String = js.native
  /* "ThickThin" */ val thickThin: typings.officeDashJs.ExcelNs.ShapeLineStyle.thickThin with String = js.native
  /* "ThinThick" */ val thinThick: typings.officeDashJs.ExcelNs.ShapeLineStyle.thinThick with String = js.native
  /* "ThinThin" */ val thinThin: typings.officeDashJs.ExcelNs.ShapeLineStyle.thinThin with String = js.native
  @JSBracketAccess
