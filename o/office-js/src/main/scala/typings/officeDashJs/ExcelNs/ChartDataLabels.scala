...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartDataLabelsData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartDataLabelsLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartDataLabelsUpdateData
