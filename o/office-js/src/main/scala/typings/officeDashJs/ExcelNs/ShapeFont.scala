...
import typings.officeDashJs.ExcelNs.InterfacesNs.ShapeFontData
import typings.officeDashJs.ExcelNs.InterfacesNs.ShapeFontLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ShapeFontUpdateData
...
class ShapeFont () extends ClientObject {
  ...
  def load(option: String): ShapeFont = js.native
  def load(option: js.Array[String]): ShapeFont = js.native
  def load(option: Anon_Expand): ShapeFont = js.native
  def load(option: ShapeFontLoadOptions): ShapeFont = js.native
