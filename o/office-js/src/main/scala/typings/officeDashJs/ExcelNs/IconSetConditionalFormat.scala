...
import typings.officeDashJs.ExcelNs.InterfacesNs.IconSetConditionalFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.IconSetConditionalFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.IconSetConditionalFormatUpdateData
...
class IconSetConditionalFormat () extends ClientObject {
  ...
  def load(option: String): IconSetConditionalFormat = js.native
  def load(option: js.Array[String]): IconSetConditionalFormat = js.native
  def load(option: Anon_Expand): IconSetConditionalFormat = js.native
  def load(option: IconSetConditionalFormatLoadOptions): IconSetConditionalFormat = js.native
