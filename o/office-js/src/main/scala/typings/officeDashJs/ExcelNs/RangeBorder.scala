...
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeBorderData
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeBorderLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.RangeBorderUpdateData
...
class RangeBorder () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): RangeBorder = js.native
