...
import typings.officeDashJs.ExcelNs.InterfacesNs.WorkbookData
import typings.officeDashJs.ExcelNs.InterfacesNs.WorkbookLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.WorkbookUpdateData
