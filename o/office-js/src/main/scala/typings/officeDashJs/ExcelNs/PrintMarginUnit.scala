...
object PrintMarginUnit extends js.Object {
  ...
  /* "Centimeters" */ val centimeters: typings.officeDashJs.ExcelNs.PrintMarginUnit.centimeters with String = js.native
  /* "Inches" */ val inches: typings.officeDashJs.ExcelNs.PrintMarginUnit.inches with String = js.native
  /* "Points" */ val points: typings.officeDashJs.ExcelNs.PrintMarginUnit.points with String = js.native
  @JSBracketAccess
