...
object ShapeScaleType extends js.Object {
  ...
  /* "CurrentSize" */ val currentSize: typings.officeDashJs.ExcelNs.ShapeScaleType.currentSize with String = js.native
  /* "OriginalSize" */ val originalSize: typings.officeDashJs.ExcelNs.ShapeScaleType.originalSize with String = js.native
  @JSBracketAccess
