...
import typings.officeDashJs.ExcelNs.InterfacesNs.FilterPivotHierarchyCollectionData
import typings.officeDashJs.ExcelNs.InterfacesNs.FilterPivotHierarchyCollectionLoadOptions
...
class FilterPivotHierarchyCollection () extends ClientObject {
  ...
  def load(option: FilterPivotHierarchyCollectionLoadOptions with CollectionLoadOptions): FilterPivotHierarchyCollection = js.native
  def load(option: String): FilterPivotHierarchyCollection = js.native
  def load(option: js.Array[String]): FilterPivotHierarchyCollection = js.native
  def load(option: LoadOption): FilterPivotHierarchyCollection = js.native
  /**
    *
