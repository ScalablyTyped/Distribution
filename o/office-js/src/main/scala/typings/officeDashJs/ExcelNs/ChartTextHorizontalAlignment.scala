...
object ChartTextHorizontalAlignment extends js.Object {
  ...
  /* "Center" */ val center: typings.officeDashJs.ExcelNs.ChartTextHorizontalAlignment.center with String = js.native
  /* "Distributed" */ val distributed: typings.officeDashJs.ExcelNs.ChartTextHorizontalAlignment.distributed with String = js.native
  /* "Justify" */ val justify: typings.officeDashJs.ExcelNs.ChartTextHorizontalAlignment.justify with String = js.native
  /* "Left" */ val left: typings.officeDashJs.ExcelNs.ChartTextHorizontalAlignment.left with String = js.native
  /* "Right" */ val right: typings.officeDashJs.ExcelNs.ChartTextHorizontalAlignment.right with String = js.native
  @JSBracketAccess
