...
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalRangeBorderData
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalRangeBorderLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalRangeBorderUpdateData
...
class ConditionalRangeBorder () extends ClientObject {
  ...
  def load(option: String): ConditionalRangeBorder = js.native
  def load(option: js.Array[String]): ConditionalRangeBorder = js.native
  def load(option: Anon_Expand): ConditionalRangeBorder = js.native
  def load(option: ConditionalRangeBorderLoadOptions): ConditionalRangeBorder = js.native
