...
object ChartTickLabelAlignment extends js.Object {
  ...
  /* "Center" */ val center: typings.officeDashJs.ExcelNs.ChartTickLabelAlignment.center with String = js.native
  /* "Left" */ val left: typings.officeDashJs.ExcelNs.ChartTickLabelAlignment.left with String = js.native
  /* "Right" */ val right: typings.officeDashJs.ExcelNs.ChartTickLabelAlignment.right with String = js.native
  @JSBracketAccess
