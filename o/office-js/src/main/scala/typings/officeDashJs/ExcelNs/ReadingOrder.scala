...
object ReadingOrder extends js.Object {
  ...
  /* "Context" */ val context: typings.officeDashJs.ExcelNs.ReadingOrder.context with String = js.native
  /* "LeftToRight" */ val leftToRight: typings.officeDashJs.ExcelNs.ReadingOrder.leftToRight with String = js.native
  /* "RightToLeft" */ val rightToLeft: typings.officeDashJs.ExcelNs.ReadingOrder.rightToLeft with String = js.native
  @JSBracketAccess
