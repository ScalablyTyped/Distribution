...
import typings.officeDashJs.ExcelNs.InterfacesNs.TableScopedCollectionData
import typings.officeDashJs.ExcelNs.InterfacesNs.TableScopedCollectionLoadOptions
...
@js.native
class TableScopedCollection () extends ClientObject {
  ...
  def load(option: TableScopedCollectionLoadOptions with CollectionLoadOptions): TableScopedCollection = js.native
  def load(option: String): TableScopedCollection = js.native
  def load(option: js.Array[String]): TableScopedCollection = js.native
  def load(option: LoadOption): TableScopedCollection = js.native
  /**
