...
import typings.officeDashJs.ExcelNs.InterfacesNs.GroupShapeCollectionData
import typings.officeDashJs.ExcelNs.InterfacesNs.GroupShapeCollectionLoadOptions
