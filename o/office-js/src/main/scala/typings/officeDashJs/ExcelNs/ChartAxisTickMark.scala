...
object ChartAxisTickMark extends js.Object {
  ...
  /* "Cross" */ val cross: typings.officeDashJs.ExcelNs.ChartAxisTickMark.cross with String = js.native
  /* "Inside" */ val inside: typings.officeDashJs.ExcelNs.ChartAxisTickMark.inside with String = js.native
  /* "None" */ val none: typings.officeDashJs.ExcelNs.ChartAxisTickMark.none with String = js.native
  /* "Outside" */ val outside: typings.officeDashJs.ExcelNs.ChartAxisTickMark.outside with String = js.native
  @JSBracketAccess
