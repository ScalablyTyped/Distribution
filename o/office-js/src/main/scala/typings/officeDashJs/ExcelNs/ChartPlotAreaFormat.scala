...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartPlotAreaFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartPlotAreaFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartPlotAreaFormatUpdateData
...
class ChartPlotAreaFormat () extends ClientObject {
  ...
  def load(option: String): ChartPlotAreaFormat = js.native
  def load(option: js.Array[String]): ChartPlotAreaFormat = js.native
  def load(option: Anon_Expand): ChartPlotAreaFormat = js.native
  def load(option: ChartPlotAreaFormatLoadOptions): ChartPlotAreaFormat = js.native
