...
import typings.officeDashJs.ExcelNs.InterfacesNs.TextConditionalFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.TextConditionalFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.TextConditionalFormatUpdateData
