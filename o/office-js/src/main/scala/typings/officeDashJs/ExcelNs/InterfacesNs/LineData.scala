...
import typings.officeDashJs.ExcelNs.ArrowheadLength
import typings.officeDashJs.ExcelNs.ArrowheadStyle
import typings.officeDashJs.ExcelNs.ArrowheadWidth
import typings.officeDashJs.ExcelNs.ConnectorType
