...
import typings.officeDashJs.ExcelNs.ChartAxisCategoryType
import typings.officeDashJs.ExcelNs.ChartAxisDisplayUnit
import typings.officeDashJs.ExcelNs.ChartAxisGroup
import typings.officeDashJs.ExcelNs.ChartAxisPosition
import typings.officeDashJs.ExcelNs.ChartAxisScaleType
import typings.officeDashJs.ExcelNs.ChartAxisTickLabelPosition
import typings.officeDashJs.ExcelNs.ChartAxisTickMark
import typings.officeDashJs.ExcelNs.ChartAxisTimeUnit
import typings.officeDashJs.ExcelNs.ChartAxisType
import typings.officeDashJs.ExcelNs.ChartTickLabelAlignment
