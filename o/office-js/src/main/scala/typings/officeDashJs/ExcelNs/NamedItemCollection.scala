...
import typings.officeDashJs.ExcelNs.InterfacesNs.NamedItemCollectionData
import typings.officeDashJs.ExcelNs.InterfacesNs.NamedItemCollectionLoadOptions
...
class NamedItemCollection () extends ClientObject {
  ...
  def load(option: NamedItemCollectionLoadOptions with CollectionLoadOptions): NamedItemCollection = js.native
  def load(option: String): NamedItemCollection = js.native
  def load(option: js.Array[String]): NamedItemCollection = js.native
  def load(option: LoadOption): NamedItemCollection = js.native
  /**
