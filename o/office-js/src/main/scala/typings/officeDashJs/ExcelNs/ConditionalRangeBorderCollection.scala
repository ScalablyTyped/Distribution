...
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalRangeBorderCollectionData
import typings.officeDashJs.ExcelNs.InterfacesNs.ConditionalRangeBorderCollectionLoadOptions
...
class ConditionalRangeBorderCollection () extends ClientObject {
  ...
  def load(option: ConditionalRangeBorderCollectionLoadOptions with CollectionLoadOptions): ConditionalRangeBorderCollection = js.native
  def load(option: String): ConditionalRangeBorderCollection = js.native
  def load(option: js.Array[String]): ConditionalRangeBorderCollection = js.native
  def load(option: LoadOption): ConditionalRangeBorderCollection = js.native
  /**
