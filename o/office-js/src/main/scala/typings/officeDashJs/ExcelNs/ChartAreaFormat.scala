...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAreaFormatData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAreaFormatLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartAreaFormatUpdateData
...
class ChartAreaFormat () extends ClientObject {
  ...
  def load(option: String): ChartAreaFormat = js.native
  def load(option: js.Array[String]): ChartAreaFormat = js.native
  def load(option: Anon_Expand): ChartAreaFormat = js.native
  def load(option: ChartAreaFormatLoadOptions): ChartAreaFormat = js.native
