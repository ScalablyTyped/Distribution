...
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartPivotOptionsData
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartPivotOptionsLoadOptions
import typings.officeDashJs.ExcelNs.InterfacesNs.ChartPivotOptionsUpdateData
