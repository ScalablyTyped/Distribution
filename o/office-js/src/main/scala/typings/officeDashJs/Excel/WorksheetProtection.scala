...
import typings.officeDashJs.Excel.Interfaces.WorksheetProtectionData
import typings.officeDashJs.Excel.Interfaces.WorksheetProtectionLoadOptions
...
class WorksheetProtection () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): WorksheetProtection = js.native
