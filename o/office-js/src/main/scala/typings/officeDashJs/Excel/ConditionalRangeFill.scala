...
import typings.officeDashJs.Excel.Interfaces.ConditionalRangeFillData
import typings.officeDashJs.Excel.Interfaces.ConditionalRangeFillLoadOptions
import typings.officeDashJs.Excel.Interfaces.ConditionalRangeFillUpdateData
...
class ConditionalRangeFill () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ConditionalRangeFill = js.native
