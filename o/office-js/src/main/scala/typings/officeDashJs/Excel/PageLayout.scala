...
import typings.officeDashJs.Excel.Interfaces.PageLayoutData
import typings.officeDashJs.Excel.Interfaces.PageLayoutLoadOptions
import typings.officeDashJs.Excel.Interfaces.PageLayoutUpdateData
