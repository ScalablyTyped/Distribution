...
object ChartGradientStyleType extends js.Object {
  ...
  /* "ExtremeValue" */ val extremeValue: typings.officeDashJs.Excel.ChartGradientStyleType.extremeValue with String = js.native
  /* "Number" */ val number: typings.officeDashJs.Excel.ChartGradientStyleType.number with String = js.native
  /* "Percent" */ val percent: typings.officeDashJs.Excel.ChartGradientStyleType.percent with String = js.native
  @JSBracketAccess
