...
object ChartDisplayBlanksAs extends js.Object {
  ...
  /* "Interplotted" */ val interplotted: typings.officeDashJs.Excel.ChartDisplayBlanksAs.interplotted with String = js.native
  /* "NotPlotted" */ val notPlotted: typings.officeDashJs.Excel.ChartDisplayBlanksAs.notPlotted with String = js.native
  /* "Zero" */ val zero: typings.officeDashJs.Excel.ChartDisplayBlanksAs.zero with String = js.native
  @JSBracketAccess
