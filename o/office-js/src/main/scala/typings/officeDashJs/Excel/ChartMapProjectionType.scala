...
object ChartMapProjectionType extends js.Object {
  ...
  /* "Albers" */ val albers: typings.officeDashJs.Excel.ChartMapProjectionType.albers with String = js.native
  /* "Automatic" */ val automatic: typings.officeDashJs.Excel.ChartMapProjectionType.automatic with String = js.native
  /* "Mercator" */ val mercator: typings.officeDashJs.Excel.ChartMapProjectionType.mercator with String = js.native
  /* "Miller" */ val miller: typings.officeDashJs.Excel.ChartMapProjectionType.miller with String = js.native
  /* "Robinson" */ val robinson: typings.officeDashJs.Excel.ChartMapProjectionType.robinson with String = js.native
  @JSBracketAccess
