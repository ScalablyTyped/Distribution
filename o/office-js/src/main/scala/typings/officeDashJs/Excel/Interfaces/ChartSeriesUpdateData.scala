...
import typings.officeDashJs.Excel.ChartGradientStyle
import typings.officeDashJs.Excel.ChartGradientStyleType
import typings.officeDashJs.Excel.ChartMarkerStyle
import typings.officeDashJs.Excel.ChartParentLabelStrategy
import typings.officeDashJs.Excel.ChartSplitType
