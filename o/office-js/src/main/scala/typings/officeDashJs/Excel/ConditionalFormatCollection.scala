...
import typings.officeDashJs.Excel.Interfaces.ConditionalFormatCollectionData
import typings.officeDashJs.Excel.Interfaces.ConditionalFormatCollectionLoadOptions
