...
import typings.officeDashJs.Excel.Interfaces.TimelineStyleCollectionData
import typings.officeDashJs.Excel.Interfaces.TimelineStyleCollectionLoadOptions
