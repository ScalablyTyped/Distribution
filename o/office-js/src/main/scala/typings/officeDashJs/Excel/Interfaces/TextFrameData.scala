...
import typings.officeDashJs.Excel.ShapeAutoSize
import typings.officeDashJs.Excel.ShapeTextHorizontalAlignment
import typings.officeDashJs.Excel.ShapeTextHorizontalOverflow
import typings.officeDashJs.Excel.ShapeTextOrientation
import typings.officeDashJs.Excel.ShapeTextReadingOrder
import typings.officeDashJs.Excel.ShapeTextVerticalAlignment
import typings.officeDashJs.Excel.ShapeTextVerticalOverflow
