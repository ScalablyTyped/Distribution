...
import typings.officeDashJs.Excel.ChartMapAreaLevel
import typings.officeDashJs.Excel.ChartMapLabelStrategy
import typings.officeDashJs.Excel.ChartMapProjectionType
