...
import typings.officeDashJs.Excel.Interfaces.LineData
import typings.officeDashJs.Excel.Interfaces.LineLoadOptions
import typings.officeDashJs.Excel.Interfaces.LineUpdateData
