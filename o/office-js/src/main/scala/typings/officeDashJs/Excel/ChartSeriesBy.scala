...
object ChartSeriesBy extends js.Object {
  ...
  /* "Auto" */ val auto: typings.officeDashJs.Excel.ChartSeriesBy.auto with String = js.native
  /* "Columns" */ val columns: typings.officeDashJs.Excel.ChartSeriesBy.columns with String = js.native
  /* "Rows" */ val rows: typings.officeDashJs.Excel.ChartSeriesBy.rows with String = js.native
  @JSBracketAccess
