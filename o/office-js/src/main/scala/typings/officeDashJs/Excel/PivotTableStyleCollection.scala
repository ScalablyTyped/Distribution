...
import typings.officeDashJs.Excel.Interfaces.PivotTableStyleCollectionData
import typings.officeDashJs.Excel.Interfaces.PivotTableStyleCollectionLoadOptions
