...
import typings.officeDashJs.Excel.Interfaces.PivotItemData
import typings.officeDashJs.Excel.Interfaces.PivotItemLoadOptions
import typings.officeDashJs.Excel.Interfaces.PivotItemUpdateData
