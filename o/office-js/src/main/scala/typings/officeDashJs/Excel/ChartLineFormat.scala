...
import typings.officeDashJs.Excel.Interfaces.ChartLineFormatData
import typings.officeDashJs.Excel.Interfaces.ChartLineFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartLineFormatUpdateData
