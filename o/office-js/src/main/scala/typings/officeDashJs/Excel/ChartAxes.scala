...
import typings.officeDashJs.Excel.Interfaces.ChartAxesData
import typings.officeDashJs.Excel.Interfaces.ChartAxesLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartAxesUpdateData
