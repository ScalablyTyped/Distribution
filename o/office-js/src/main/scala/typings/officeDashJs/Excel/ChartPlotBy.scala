...
object ChartPlotBy extends js.Object {
  ...
  /* "Columns" */ val columns: typings.officeDashJs.Excel.ChartPlotBy.columns with String = js.native
  /* "Rows" */ val rows: typings.officeDashJs.Excel.ChartPlotBy.rows with String = js.native
  @JSBracketAccess
