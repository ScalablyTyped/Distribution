...
import typings.officeDashJs.Excel.Interfaces.TableColumnData
import typings.officeDashJs.Excel.Interfaces.TableColumnLoadOptions
import typings.officeDashJs.Excel.Interfaces.TableColumnUpdateData
...
class TableColumn () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): TableColumn = js.native
