...
import typings.officeDashJs.Excel.Interfaces.TableStyleData
import typings.officeDashJs.Excel.Interfaces.TableStyleLoadOptions
import typings.officeDashJs.Excel.Interfaces.TableStyleUpdateData
