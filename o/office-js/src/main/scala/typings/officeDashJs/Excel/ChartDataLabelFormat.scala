...
import typings.officeDashJs.Excel.Interfaces.ChartDataLabelFormatData
import typings.officeDashJs.Excel.Interfaces.ChartDataLabelFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartDataLabelFormatUpdateData
