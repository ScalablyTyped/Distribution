...
import typings.officeDashJs.Excel.Interfaces.ChartFontData
import typings.officeDashJs.Excel.Interfaces.ChartFontLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartFontUpdateData
