...
import typings.officeDashJs.Excel.Interfaces.RangeFormatData
import typings.officeDashJs.Excel.Interfaces.RangeFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.RangeFormatUpdateData
