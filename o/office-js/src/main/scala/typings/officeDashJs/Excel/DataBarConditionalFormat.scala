...
import typings.officeDashJs.Excel.Interfaces.DataBarConditionalFormatData
import typings.officeDashJs.Excel.Interfaces.DataBarConditionalFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.DataBarConditionalFormatUpdateData
