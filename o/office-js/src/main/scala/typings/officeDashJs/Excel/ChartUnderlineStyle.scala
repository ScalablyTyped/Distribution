...
object ChartUnderlineStyle extends js.Object {
  ...
  /* "None" */ val none: typings.officeDashJs.Excel.ChartUnderlineStyle.none with String = js.native
  /* "Single" */ val single: typings.officeDashJs.Excel.ChartUnderlineStyle.single with String = js.native
  @JSBracketAccess
