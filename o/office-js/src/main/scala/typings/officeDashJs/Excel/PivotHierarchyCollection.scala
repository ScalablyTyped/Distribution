...
import typings.officeDashJs.Excel.Interfaces.PivotHierarchyCollectionData
import typings.officeDashJs.Excel.Interfaces.PivotHierarchyCollectionLoadOptions
