...
import typings.officeDashJs.Excel.Interfaces.PivotLayoutData
import typings.officeDashJs.Excel.Interfaces.PivotLayoutLoadOptions
import typings.officeDashJs.Excel.Interfaces.PivotLayoutUpdateData
