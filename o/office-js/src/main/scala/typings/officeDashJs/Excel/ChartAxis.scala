...
import typings.officeDashJs.Excel.Interfaces.ChartAxisData
import typings.officeDashJs.Excel.Interfaces.ChartAxisLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartAxisUpdateData
