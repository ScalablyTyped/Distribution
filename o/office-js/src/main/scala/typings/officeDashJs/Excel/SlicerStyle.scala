...
import typings.officeDashJs.Excel.Interfaces.SlicerStyleData
import typings.officeDashJs.Excel.Interfaces.SlicerStyleLoadOptions
import typings.officeDashJs.Excel.Interfaces.SlicerStyleUpdateData
