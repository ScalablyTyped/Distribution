...
import typings.officeDashJs.Excel.Interfaces.ChartDataLabelData
import typings.officeDashJs.Excel.Interfaces.ChartDataLabelLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartDataLabelUpdateData
...
class ChartDataLabel () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ChartDataLabel = js.native
