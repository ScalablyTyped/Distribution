...
object CloseBehavior extends js.Object {
  ...
  /* "Save" */ val save: typings.officeDashJs.Excel.CloseBehavior.save with String = js.native
  /* "SkipSave" */ val skipSave: typings.officeDashJs.Excel.CloseBehavior.skipSave with String = js.native
  @JSBracketAccess
