...
import typings.officeDashJs.Excel.ConditionalDataBarAxisFormat
import typings.officeDashJs.Excel.ConditionalDataBarDirection
import typings.officeDashJs.Excel.ConditionalDataBarRule
