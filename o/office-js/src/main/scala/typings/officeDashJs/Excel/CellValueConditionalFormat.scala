...
import typings.officeDashJs.Excel.Interfaces.CellValueConditionalFormatData
import typings.officeDashJs.Excel.Interfaces.CellValueConditionalFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.CellValueConditionalFormatUpdateData
