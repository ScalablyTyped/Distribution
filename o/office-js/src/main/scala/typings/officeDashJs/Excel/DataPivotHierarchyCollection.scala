...
import typings.officeDashJs.Excel.Interfaces.DataPivotHierarchyCollectionData
import typings.officeDashJs.Excel.Interfaces.DataPivotHierarchyCollectionLoadOptions
