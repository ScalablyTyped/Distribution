...
import typings.officeDashJs.Excel.Interfaces.ShapeData
import typings.officeDashJs.Excel.Interfaces.ShapeLoadOptions
import typings.officeDashJs.Excel.Interfaces.ShapeUpdateData
