...
import typings.officeDashJs.Excel.Interfaces.ChartLegendEntryCollectionData
import typings.officeDashJs.Excel.Interfaces.ChartLegendEntryCollectionLoadOptions
