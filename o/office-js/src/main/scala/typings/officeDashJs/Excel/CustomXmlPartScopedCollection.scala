...
import typings.officeDashJs.Excel.Interfaces.CustomXmlPartScopedCollectionData
import typings.officeDashJs.Excel.Interfaces.CustomXmlPartScopedCollectionLoadOptions
