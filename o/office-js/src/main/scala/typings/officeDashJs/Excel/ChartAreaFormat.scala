...
import typings.officeDashJs.Excel.Interfaces.ChartAreaFormatData
import typings.officeDashJs.Excel.Interfaces.ChartAreaFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartAreaFormatUpdateData
