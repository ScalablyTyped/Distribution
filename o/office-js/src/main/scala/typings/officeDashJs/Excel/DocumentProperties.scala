...
import typings.officeDashJs.Excel.Interfaces.DocumentPropertiesData
import typings.officeDashJs.Excel.Interfaces.DocumentPropertiesLoadOptions
import typings.officeDashJs.Excel.Interfaces.DocumentPropertiesUpdateData
