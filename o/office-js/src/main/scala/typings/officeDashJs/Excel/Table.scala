...
import typings.officeDashJs.Excel.Interfaces.TableData
import typings.officeDashJs.Excel.Interfaces.TableLoadOptions
import typings.officeDashJs.Excel.Interfaces.TableUpdateData
...
class Table () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): Table = js.native
