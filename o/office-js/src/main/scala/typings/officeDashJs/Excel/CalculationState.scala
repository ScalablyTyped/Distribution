...
import typings.officeDashJs.Excel.CalculationState.calculating
import typings.officeDashJs.Excel.CalculationState.done
import typings.officeDashJs.Excel.CalculationState.pending
