...
object CalculationState extends js.Object {
  ...
  /* "Calculating" */ val calculating: typings.officeDashJs.Excel.CalculationState.calculating with String = js.native
  /* "Done" */ val done: typings.officeDashJs.Excel.CalculationState.done with String = js.native
  /* "Pending" */ val pending: typings.officeDashJs.Excel.CalculationState.pending with String = js.native
  @JSBracketAccess
