...
object ChartAxisDisplayUnit extends js.Object {
  ...
  /* "Billions" */ val billions: typings.officeDashJs.Excel.ChartAxisDisplayUnit.billions with String = js.native
  /* "Custom" */ val custom: typings.officeDashJs.Excel.ChartAxisDisplayUnit.custom with String = js.native
  /* "HundredMillions" */ val hundredMillions: typings.officeDashJs.Excel.ChartAxisDisplayUnit.hundredMillions with String = js.native
  /* "HundredThousands" */ val hundredThousands: typings.officeDashJs.Excel.ChartAxisDisplayUnit.hundredThousands with String = js.native
  /* "Hundreds" */ val hundreds: typings.officeDashJs.Excel.ChartAxisDisplayUnit.hundreds with String = js.native
  /* "Millions" */ val millions: typings.officeDashJs.Excel.ChartAxisDisplayUnit.millions with String = js.native
  /* "None" */ val none: typings.officeDashJs.Excel.ChartAxisDisplayUnit.none with String = js.native
  /* "TenMillions" */ val tenMillions: typings.officeDashJs.Excel.ChartAxisDisplayUnit.tenMillions with String = js.native
  /* "TenThousands" */ val tenThousands: typings.officeDashJs.Excel.ChartAxisDisplayUnit.tenThousands with String = js.native
  /* "Thousands" */ val thousands: typings.officeDashJs.Excel.ChartAxisDisplayUnit.thousands with String = js.native
  /* "Trillions" */ val trillions: typings.officeDashJs.Excel.ChartAxisDisplayUnit.trillions with String = js.native
  @JSBracketAccess
