...
import typings.officeDashJs.Excel.DataValidationErrorAlert
import typings.officeDashJs.Excel.DataValidationPrompt
import typings.officeDashJs.Excel.DataValidationRule
import typings.officeDashJs.Excel.DataValidationType
