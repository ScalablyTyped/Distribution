...
import typings.officeDashJs.officeDashJsStrings.Information
import typings.officeDashJs.officeDashJsStrings.Stop
import typings.officeDashJs.officeDashJsStrings.Warning
