...
import typings.officeDashJs.Excel.Interfaces.ShapeFillData
import typings.officeDashJs.Excel.Interfaces.ShapeFillLoadOptions
import typings.officeDashJs.Excel.Interfaces.ShapeFillUpdateData
