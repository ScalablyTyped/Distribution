...
import typings.officeDashJs.Excel.Interfaces.ConditionalRangeFontData
import typings.officeDashJs.Excel.Interfaces.ConditionalRangeFontLoadOptions
import typings.officeDashJs.Excel.Interfaces.ConditionalRangeFontUpdateData
...
class ConditionalRangeFont () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ConditionalRangeFont = js.native
