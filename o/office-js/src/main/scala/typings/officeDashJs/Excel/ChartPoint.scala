...
import typings.officeDashJs.Excel.Interfaces.ChartPointData
import typings.officeDashJs.Excel.Interfaces.ChartPointLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartPointUpdateData
...
class ChartPoint () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ChartPoint = js.native
