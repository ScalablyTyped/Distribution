...
import typings.officeDashJs.Excel.Interfaces.CustomXmlPartCollectionData
import typings.officeDashJs.Excel.Interfaces.CustomXmlPartCollectionLoadOptions
