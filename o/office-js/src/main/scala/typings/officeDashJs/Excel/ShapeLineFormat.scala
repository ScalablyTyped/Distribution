...
import typings.officeDashJs.Excel.Interfaces.ShapeLineFormatData
import typings.officeDashJs.Excel.Interfaces.ShapeLineFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.ShapeLineFormatUpdateData
