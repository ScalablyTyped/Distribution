...
import typings.officeDashJs.Excel.Interfaces.RuntimeData
import typings.officeDashJs.Excel.Interfaces.RuntimeLoadOptions
import typings.officeDashJs.Excel.Interfaces.RuntimeUpdateData
