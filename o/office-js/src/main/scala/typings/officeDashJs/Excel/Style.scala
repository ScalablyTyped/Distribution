...
import typings.officeDashJs.Excel.Interfaces.StyleData
import typings.officeDashJs.Excel.Interfaces.StyleLoadOptions
import typings.officeDashJs.Excel.Interfaces.StyleUpdateData
