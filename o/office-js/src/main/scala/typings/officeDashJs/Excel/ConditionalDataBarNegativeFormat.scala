...
import typings.officeDashJs.Excel.Interfaces.ConditionalDataBarNegativeFormatData
import typings.officeDashJs.Excel.Interfaces.ConditionalDataBarNegativeFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.ConditionalDataBarNegativeFormatUpdateData
