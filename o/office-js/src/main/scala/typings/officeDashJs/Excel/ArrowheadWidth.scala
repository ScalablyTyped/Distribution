...
object ArrowheadWidth extends js.Object {
  ...
  /* "Medium" */ val medium: typings.officeDashJs.Excel.ArrowheadWidth.medium with String = js.native
  /* "Narrow" */ val narrow: typings.officeDashJs.Excel.ArrowheadWidth.narrow with String = js.native
  /* "Wide" */ val wide: typings.officeDashJs.Excel.ArrowheadWidth.wide with String = js.native
  @JSBracketAccess
