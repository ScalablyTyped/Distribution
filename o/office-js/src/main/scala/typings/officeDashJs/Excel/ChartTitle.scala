...
import typings.officeDashJs.Excel.Interfaces.ChartTitleData
import typings.officeDashJs.Excel.Interfaces.ChartTitleLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartTitleUpdateData
