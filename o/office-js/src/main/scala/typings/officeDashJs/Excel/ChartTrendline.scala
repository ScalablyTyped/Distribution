...
import typings.officeDashJs.Excel.Interfaces.ChartTrendlineData
import typings.officeDashJs.Excel.Interfaces.ChartTrendlineLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartTrendlineUpdateData
