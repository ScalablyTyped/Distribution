...
object PivotAxis extends js.Object {
  ...
  /* "Column" */ val column: typings.officeDashJs.Excel.PivotAxis.column with String = js.native
  /* "Data" */ val data: typings.officeDashJs.Excel.PivotAxis.data with String = js.native
  /* "Filter" */ val filter: typings.officeDashJs.Excel.PivotAxis.filter with String = js.native
  /* "Row" */ val row: typings.officeDashJs.Excel.PivotAxis.row with String = js.native
  /* "Unknown" */ val unknown: typings.officeDashJs.Excel.PivotAxis.unknown with String = js.native
  @JSBracketAccess
