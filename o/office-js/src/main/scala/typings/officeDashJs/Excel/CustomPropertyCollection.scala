...
import typings.officeDashJs.Excel.Interfaces.CustomPropertyCollectionData
import typings.officeDashJs.Excel.Interfaces.CustomPropertyCollectionLoadOptions
