...
import typings.officeDashJs.Excel.CalculationMode
import typings.officeDashJs.officeDashJsStrings.Automatic
import typings.officeDashJs.officeDashJsStrings.AutomaticExceptTables
import typings.officeDashJs.officeDashJsStrings.Manual
