...
import typings.officeDashJs.Excel.Interfaces.IterativeCalculationData
import typings.officeDashJs.Excel.Interfaces.IterativeCalculationLoadOptions
import typings.officeDashJs.Excel.Interfaces.IterativeCalculationUpdateData
