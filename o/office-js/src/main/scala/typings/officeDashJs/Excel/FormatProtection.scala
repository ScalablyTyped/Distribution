...
import typings.officeDashJs.Excel.Interfaces.FormatProtectionData
import typings.officeDashJs.Excel.Interfaces.FormatProtectionLoadOptions
import typings.officeDashJs.Excel.Interfaces.FormatProtectionUpdateData
