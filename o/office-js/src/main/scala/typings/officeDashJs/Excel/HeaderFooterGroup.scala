...
import typings.officeDashJs.Excel.Interfaces.HeaderFooterGroupData
import typings.officeDashJs.Excel.Interfaces.HeaderFooterGroupLoadOptions
import typings.officeDashJs.Excel.Interfaces.HeaderFooterGroupUpdateData
