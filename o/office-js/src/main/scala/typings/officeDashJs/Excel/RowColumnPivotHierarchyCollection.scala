...
import typings.officeDashJs.Excel.Interfaces.RowColumnPivotHierarchyCollectionData
import typings.officeDashJs.Excel.Interfaces.RowColumnPivotHierarchyCollectionLoadOptions
