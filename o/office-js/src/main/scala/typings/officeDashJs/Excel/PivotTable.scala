...
import typings.officeDashJs.Excel.Interfaces.PivotTableData
import typings.officeDashJs.Excel.Interfaces.PivotTableLoadOptions
import typings.officeDashJs.Excel.Interfaces.PivotTableUpdateData
