...
import typings.officeDashJs.Excel.Interfaces.TopBottomConditionalFormatData
import typings.officeDashJs.Excel.Interfaces.TopBottomConditionalFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.TopBottomConditionalFormatUpdateData
