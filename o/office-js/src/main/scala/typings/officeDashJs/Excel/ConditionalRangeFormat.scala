...
import typings.officeDashJs.Excel.Interfaces.ConditionalRangeFormatData
import typings.officeDashJs.Excel.Interfaces.ConditionalRangeFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.ConditionalRangeFormatUpdateData
