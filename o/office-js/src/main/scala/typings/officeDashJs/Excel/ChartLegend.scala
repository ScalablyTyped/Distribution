...
import typings.officeDashJs.Excel.Interfaces.ChartLegendData
import typings.officeDashJs.Excel.Interfaces.ChartLegendLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartLegendUpdateData
