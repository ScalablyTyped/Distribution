...
import typings.officeDashJs.Excel.Interfaces.ChartTitleFormatData
import typings.officeDashJs.Excel.Interfaces.ChartTitleFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartTitleFormatUpdateData
...
class ChartTitleFormat () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ChartTitleFormat = js.native
