...
import typings.officeDashJs.Excel.Interfaces.TimelineStyleData
import typings.officeDashJs.Excel.Interfaces.TimelineStyleLoadOptions
import typings.officeDashJs.Excel.Interfaces.TimelineStyleUpdateData
