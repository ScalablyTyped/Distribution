...
import typings.officeDashJs.Excel.Interfaces.NamedItemData
import typings.officeDashJs.Excel.Interfaces.NamedItemLoadOptions
import typings.officeDashJs.Excel.Interfaces.NamedItemUpdateData
