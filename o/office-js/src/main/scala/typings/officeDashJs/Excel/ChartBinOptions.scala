...
import typings.officeDashJs.Excel.Interfaces.ChartBinOptionsData
import typings.officeDashJs.Excel.Interfaces.ChartBinOptionsLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartBinOptionsUpdateData
...
class ChartBinOptions () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ChartBinOptions = js.native
