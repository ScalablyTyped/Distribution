...
import typings.officeDashJs.Excel.Interfaces.SlicerItemData
import typings.officeDashJs.Excel.Interfaces.SlicerItemLoadOptions
import typings.officeDashJs.Excel.Interfaces.SlicerItemUpdateData
