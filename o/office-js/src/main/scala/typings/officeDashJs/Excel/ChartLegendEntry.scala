...
import typings.officeDashJs.Excel.Interfaces.ChartLegendEntryData
import typings.officeDashJs.Excel.Interfaces.ChartLegendEntryLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartLegendEntryUpdateData
