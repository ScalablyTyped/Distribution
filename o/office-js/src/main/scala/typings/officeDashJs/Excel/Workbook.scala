...
import typings.officeDashJs.Excel.Interfaces.WorkbookData
import typings.officeDashJs.Excel.Interfaces.WorkbookLoadOptions
import typings.officeDashJs.Excel.Interfaces.WorkbookUpdateData
