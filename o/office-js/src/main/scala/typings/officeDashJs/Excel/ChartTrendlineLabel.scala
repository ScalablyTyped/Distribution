...
import typings.officeDashJs.Excel.Interfaces.ChartTrendlineLabelData
import typings.officeDashJs.Excel.Interfaces.ChartTrendlineLabelLoadOptions
import typings.officeDashJs.Excel.Interfaces.ChartTrendlineLabelUpdateData
...
class ChartTrendlineLabel () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: Anon_Expand): ChartTrendlineLabel = js.native
