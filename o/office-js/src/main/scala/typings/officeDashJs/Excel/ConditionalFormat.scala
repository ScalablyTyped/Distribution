...
import typings.officeDashJs.Excel.Interfaces.ConditionalFormatData
import typings.officeDashJs.Excel.Interfaces.ConditionalFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.ConditionalFormatUpdateData
