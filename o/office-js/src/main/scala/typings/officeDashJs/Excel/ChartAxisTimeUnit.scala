...
object ChartAxisTimeUnit extends js.Object {
  ...
  /* "Days" */ val days: typings.officeDashJs.Excel.ChartAxisTimeUnit.days with String = js.native
  /* "Months" */ val months: typings.officeDashJs.Excel.ChartAxisTimeUnit.months with String = js.native
  /* "Years" */ val years: typings.officeDashJs.Excel.ChartAxisTimeUnit.years with String = js.native
  @JSBracketAccess
