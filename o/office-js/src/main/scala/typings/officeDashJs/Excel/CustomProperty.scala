...
import typings.officeDashJs.Excel.Interfaces.CustomPropertyData
import typings.officeDashJs.Excel.Interfaces.CustomPropertyLoadOptions
import typings.officeDashJs.Excel.Interfaces.CustomPropertyUpdateData
...
class CustomProperty () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  val `type`: DocumentPropertyType | Number | Boolean | Date | typings.officeDashJs.officeDashJsStrings.String | Float = js.native
  /**
    *
