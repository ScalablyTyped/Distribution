...
import typings.officeDashJs.Excel.ChartDataLabelPosition
import typings.officeDashJs.Excel.ChartTextHorizontalAlignment
import typings.officeDashJs.Excel.ChartTextVerticalAlignment
