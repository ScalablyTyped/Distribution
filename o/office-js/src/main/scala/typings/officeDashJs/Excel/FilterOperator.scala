...
object FilterOperator extends js.Object {
  ...
  /* "And" */ val and: typings.officeDashJs.Excel.FilterOperator.and with String = js.native
  /* "Or" */ val or: typings.officeDashJs.Excel.FilterOperator.or with String = js.native
  @JSBracketAccess
