...
import typings.officeDashJs.Excel.HorizontalAlignment
import typings.officeDashJs.Excel.ReadingOrder
import typings.officeDashJs.Excel.VerticalAlignment
