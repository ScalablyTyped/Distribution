...
import typings.officeDashJs.Excel.Interfaces.SettingData
import typings.officeDashJs.Excel.Interfaces.SettingLoadOptions
import typings.officeDashJs.Excel.Interfaces.SettingUpdateData
