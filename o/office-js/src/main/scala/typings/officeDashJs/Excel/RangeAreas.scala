...
import typings.officeDashJs.Excel.Interfaces.RangeAreasData
import typings.officeDashJs.Excel.Interfaces.RangeAreasLoadOptions
import typings.officeDashJs.Excel.Interfaces.RangeAreasUpdateData
