...
import typings.officeDashJs.Excel.Interfaces.RangeBorderData
import typings.officeDashJs.Excel.Interfaces.RangeBorderLoadOptions
import typings.officeDashJs.Excel.Interfaces.RangeBorderUpdateData
