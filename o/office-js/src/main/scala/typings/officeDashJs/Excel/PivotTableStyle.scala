...
import typings.officeDashJs.Excel.Interfaces.PivotTableStyleData
import typings.officeDashJs.Excel.Interfaces.PivotTableStyleLoadOptions
import typings.officeDashJs.Excel.Interfaces.PivotTableStyleUpdateData
