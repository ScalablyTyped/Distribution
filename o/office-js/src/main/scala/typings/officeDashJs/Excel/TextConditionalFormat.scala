...
import typings.officeDashJs.Excel.Interfaces.TextConditionalFormatData
import typings.officeDashJs.Excel.Interfaces.TextConditionalFormatLoadOptions
import typings.officeDashJs.Excel.Interfaces.TextConditionalFormatUpdateData
