...
import typings.officeDashJs.Word.Interfaces.ParagraphData
import typings.officeDashJs.Word.Interfaces.ParagraphLoadOptions
import typings.officeDashJs.Word.Interfaces.ParagraphUpdateData
