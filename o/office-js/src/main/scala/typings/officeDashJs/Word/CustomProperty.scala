...
import typings.officeDashJs.Word.Interfaces.CustomPropertyData
import typings.officeDashJs.Word.Interfaces.CustomPropertyLoadOptions
import typings.officeDashJs.Word.Interfaces.CustomPropertyUpdateData
...
class CustomProperty () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: DocumentPropertyType | typings.officeDashJs.officeDashJsStrings.String | Number | Date | Boolean = js.native
  /**
    *
