...
object TableLoadOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(headerRowCount)) __obj.updateDynamic("headerRowCount")(headerRowCount.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(nestingLevel)) __obj.updateDynamic("nestingLevel")(nestingLevel.asInstanceOf[js.Any])
