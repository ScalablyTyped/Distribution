...
import typings.officeDashJs.Word.Interfaces.ContentControlCollectionData
import typings.officeDashJs.Word.Interfaces.ContentControlCollectionLoadOptions
