...
import typings.officeDashJs.Word.Interfaces.TableBorderData
import typings.officeDashJs.Word.Interfaces.TableBorderLoadOptions
import typings.officeDashJs.Word.Interfaces.TableBorderUpdateData
