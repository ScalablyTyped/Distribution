...
import typings.officeDashJs.Word.Interfaces.DocumentPropertiesData
import typings.officeDashJs.Word.Interfaces.DocumentPropertiesLoadOptions
import typings.officeDashJs.Word.Interfaces.DocumentPropertiesUpdateData
