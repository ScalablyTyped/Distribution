...
import typings.officeDashJs.Word.Interfaces.BodyData
import typings.officeDashJs.Word.Interfaces.BodyLoadOptions
import typings.officeDashJs.Word.Interfaces.BodyUpdateData
...
class Body () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: BodyType | Unknown_ | MainDoc | typings.officeDashJs.officeDashJsStrings.Section | Header | Footer | typings.officeDashJs.officeDashJsStrings.TableCell = js.native
  /**
    *
