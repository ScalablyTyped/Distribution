...
import typings.officeDashJs.Word.Interfaces.TableCellData
import typings.officeDashJs.Word.Interfaces.TableCellLoadOptions
import typings.officeDashJs.Word.Interfaces.TableCellUpdateData
