...
import typings.officeDashJs.Word.Interfaces.TableData
import typings.officeDashJs.Word.Interfaces.TableLoadOptions
import typings.officeDashJs.Word.Interfaces.TableUpdateData
