...
import typings.officeDashJs.Word.Interfaces.InlinePictureData
import typings.officeDashJs.Word.Interfaces.InlinePictureLoadOptions
import typings.officeDashJs.Word.Interfaces.InlinePictureUpdateData
