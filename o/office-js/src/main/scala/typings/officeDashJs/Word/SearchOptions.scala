...
import typings.officeDashJs.Word.Interfaces.SearchOptionsData
import typings.officeDashJs.Word.Interfaces.SearchOptionsLoadOptions
import typings.officeDashJs.Word.Interfaces.SearchOptionsUpdateData
