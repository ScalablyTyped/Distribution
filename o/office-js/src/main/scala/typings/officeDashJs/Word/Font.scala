...
import typings.officeDashJs.Word.Interfaces.FontData
import typings.officeDashJs.Word.Interfaces.FontLoadOptions
import typings.officeDashJs.Word.Interfaces.FontUpdateData
...
class Font () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.1]
    */
  var underline: UnderlineType | Mixed | None | Hidden | DotLine | Single | typings.officeDashJs.officeDashJsStrings.Word | typings.officeDashJs.officeDashJsStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble = js.native
  /**
