...
object CellPaddingLocation extends js.Object {
  ...
  /* "Bottom" */ val bottom: typings.officeDashJs.Word.CellPaddingLocation.bottom with String = js.native
  /* "Left" */ val left: typings.officeDashJs.Word.CellPaddingLocation.left with String = js.native
  /* "Right" */ val right: typings.officeDashJs.Word.CellPaddingLocation.right with String = js.native
  /* "Top" */ val top: typings.officeDashJs.Word.CellPaddingLocation.top with String = js.native
  @JSBracketAccess
