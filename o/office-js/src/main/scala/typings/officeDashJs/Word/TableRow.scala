...
import typings.officeDashJs.Word.Interfaces.TableRowData
import typings.officeDashJs.Word.Interfaces.TableRowLoadOptions
import typings.officeDashJs.Word.Interfaces.TableRowUpdateData
