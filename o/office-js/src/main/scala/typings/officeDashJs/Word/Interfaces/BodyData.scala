...
trait BodyData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    BodyType | Unknown | MainDoc | typings.officeDashJs.officeDashJsStrings.Section | Header | Footer | typings.officeDashJs.officeDashJsStrings.TableCell
  ] = js.undefined
}
...
object BodyData {
  ...
  def apply(
    ...
    text: String = null,
    `type`: BodyType | Unknown | MainDoc | typings.officeDashJs.officeDashJsStrings.Section | Header | Footer | typings.officeDashJs.officeDashJsStrings.TableCell = null
  ): BodyData = {
