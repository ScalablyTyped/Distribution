...
import typings.officeDashJs.Word.Interfaces.DocumentData
import typings.officeDashJs.Word.Interfaces.DocumentLoadOptions
import typings.officeDashJs.Word.Interfaces.DocumentUpdateData
...
class Document () extends ClientObject {
  ...
  def load(option: Anon_Expand): Document = js.native
