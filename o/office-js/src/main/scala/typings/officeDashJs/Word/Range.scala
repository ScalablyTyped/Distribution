...
import typings.officeDashJs.Word.Interfaces.RangeData
import typings.officeDashJs.Word.Interfaces.RangeLoadOptions
import typings.officeDashJs.Word.Interfaces.RangeUpdateData
