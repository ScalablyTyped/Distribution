...
object OverlayHorizontalAlignment extends js.Object {
  ...
  /* "Center" */ val center: typings.officeDashJs.VisioNs.OverlayHorizontalAlignment.center with String = js.native
  /* "Left" */ val left: typings.officeDashJs.VisioNs.OverlayHorizontalAlignment.left with String = js.native
  /* "Right" */ val right: typings.officeDashJs.VisioNs.OverlayHorizontalAlignment.right with String = js.native
  @JSBracketAccess
