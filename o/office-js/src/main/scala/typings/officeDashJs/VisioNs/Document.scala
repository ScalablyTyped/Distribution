...
import typings.officeDashJs.VisioNs.InterfacesNs.DocumentData
import typings.officeDashJs.VisioNs.InterfacesNs.DocumentLoadOptions
import typings.officeDashJs.VisioNs.InterfacesNs.DocumentUpdateData
