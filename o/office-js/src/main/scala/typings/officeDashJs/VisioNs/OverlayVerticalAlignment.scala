...
object OverlayVerticalAlignment extends js.Object {
  ...
  /* "Bottom" */ val bottom: typings.officeDashJs.VisioNs.OverlayVerticalAlignment.bottom with String = js.native
  /* "Middle" */ val middle: typings.officeDashJs.VisioNs.OverlayVerticalAlignment.middle with String = js.native
  /* "Top" */ val top: typings.officeDashJs.VisioNs.OverlayVerticalAlignment.top with String = js.native
  @JSBracketAccess
