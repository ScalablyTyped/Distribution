...
import typings.officeDashJs.VisioNs.InterfacesNs.HyperlinkCollectionData
import typings.officeDashJs.VisioNs.InterfacesNs.HyperlinkCollectionLoadOptions
