...
import typings.officeDashJs.VisioNs.InterfacesNs.ShapeDataItemCollectionData
import typings.officeDashJs.VisioNs.InterfacesNs.ShapeDataItemCollectionLoadOptions
