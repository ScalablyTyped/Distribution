...
object ToolBarType extends js.Object {
  ...
  /* "CommandBar" */ val commandBar: typings.officeDashJs.VisioNs.ToolBarType.commandBar with String = js.native
  /* "PageNavigationBar" */ val pageNavigationBar: typings.officeDashJs.VisioNs.ToolBarType.pageNavigationBar with String = js.native
  /* "StatusBar" */ val statusBar: typings.officeDashJs.VisioNs.ToolBarType.statusBar with String = js.native
  @JSBracketAccess
