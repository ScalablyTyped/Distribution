...
import typings.officeDashJs.VisioNs.InterfacesNs.ShapeData
import typings.officeDashJs.VisioNs.InterfacesNs.ShapeLoadOptions
import typings.officeDashJs.VisioNs.InterfacesNs.ShapeUpdateData
