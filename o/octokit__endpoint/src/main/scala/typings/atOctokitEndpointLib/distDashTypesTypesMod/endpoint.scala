...
trait endpoint extends js.Object {
  ...
  /**
    ...
    */
  def apply[R /* <: Route */](route: /* import warning: LimitUnionLength.enterTypeRef Was union type with length 509 */ js.Any): RequestOptions | (/* import warning: ImportType.apply Failed type conversion: @octokit/endpoint.@octokit/endpoint/dist-types/generated/routes.Routes[R][1] */ js.Any) = js.native
  def apply[R /* <: Route */](
    route: /* import warning: LimitUnionLength.enterTypeRef Was union type with length 509 */ js.Any,
    options: Parameters | ((/* import warning: ImportType.apply Failed type conversion: @octokit/endpoint.@octokit/endpoint/dist-types/generated/routes.Routes[R][0] */ js.Any) with Parameters)
  ): RequestOptions | (/* import warning: ImportType.apply Failed type conversion: @octokit/endpoint.@octokit/endpoint/dist-types/generated/routes.Routes[R][1] */ js.Any) = js.native
  /**
