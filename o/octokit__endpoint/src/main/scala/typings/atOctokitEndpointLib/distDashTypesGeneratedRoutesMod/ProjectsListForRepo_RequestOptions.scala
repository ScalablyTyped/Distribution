...
trait ProjectsListForRepo_RequestOptions extends js.Object {
...
object ProjectsListForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsListForRepo_RequestOptions]
  }
}
