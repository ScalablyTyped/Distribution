...
trait ReactionsListForPullRequestReviewComment_RequestOptions extends js.Object {
...
object ReactionsListForPullRequestReviewComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsListForPullRequestReviewComment_RequestOptions]
  }
}
