...
trait ReposGetParticipationStats_RequestOptions extends js.Object {
...
object ReposGetParticipationStats_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetParticipationStats_RequestOptions]
  }
}
