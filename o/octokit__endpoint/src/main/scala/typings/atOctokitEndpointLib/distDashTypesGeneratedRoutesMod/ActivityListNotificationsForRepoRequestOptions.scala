...
trait ActivityListNotificationsForRepoRequestOptions extends js.Object {
...
object ActivityListNotificationsForRepoRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListNotificationsForRepoRequestOptions]
  }
}
