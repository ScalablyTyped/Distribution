...
trait PullsCreateComment_RequestOptions extends js.Object {
...
object PullsCreateComment_RequestOptions {
  @scala.inline
  def apply(
  ...
  ): PullsCreateComment_RequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[PullsCreateComment_RequestOptions]
  }
}
