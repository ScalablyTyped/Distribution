...
trait InteractionsAddOrUpdateRestrictionsForOrg_RequestOptions extends js.Object {
...
object InteractionsAddOrUpdateRestrictionsForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[InteractionsAddOrUpdateRestrictionsForOrg_RequestOptions]
  }
}
