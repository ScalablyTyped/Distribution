...
trait UsersListFollowersForAuthenticatedUser_RequestOptions extends js.Object {
...
object UsersListFollowersForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersListFollowersForAuthenticatedUser_RequestOptions]
  }
}
