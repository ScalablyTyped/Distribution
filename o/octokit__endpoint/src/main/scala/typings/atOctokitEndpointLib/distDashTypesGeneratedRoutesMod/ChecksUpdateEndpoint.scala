...
trait ChecksUpdateEndpoint extends js.Object {
  ...
  var `output.title`: js.UndefOr[java.lang.String] = js.undefined
...
object ChecksUpdateEndpoint {
  ...
  def apply(
    ...
    `output.title`: java.lang.String = null,
    ...
    if (`output.title` != null) __obj.updateDynamic("output.title")(`output.title`)
