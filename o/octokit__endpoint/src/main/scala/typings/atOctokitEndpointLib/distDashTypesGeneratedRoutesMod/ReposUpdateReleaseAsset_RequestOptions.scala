...
trait ReposUpdateReleaseAsset_RequestOptions extends js.Object {
...
object ReposUpdateReleaseAsset_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUpdateReleaseAsset_RequestOptions]
  }
}
