...
trait PullsDeleteReviewRequestRequestOptions extends js.Object {
...
object PullsDeleteReviewRequestRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsDeleteReviewRequestRequestOptions]
  }
}
