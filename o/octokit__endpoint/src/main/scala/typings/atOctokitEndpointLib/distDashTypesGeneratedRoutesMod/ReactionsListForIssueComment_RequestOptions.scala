...
trait ReactionsListForIssueComment_RequestOptions extends js.Object {
...
object ReactionsListForIssueComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsListForIssueComment_RequestOptions]
  }
}
