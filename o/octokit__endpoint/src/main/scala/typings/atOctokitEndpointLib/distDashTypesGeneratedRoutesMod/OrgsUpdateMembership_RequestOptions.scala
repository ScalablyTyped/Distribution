...
trait OrgsUpdateMembership_RequestOptions extends js.Object {
...
object OrgsUpdateMembership_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsUpdateMembership_RequestOptions]
  }
}
