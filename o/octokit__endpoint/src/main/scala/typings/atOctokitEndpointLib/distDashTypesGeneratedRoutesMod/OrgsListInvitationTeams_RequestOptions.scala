...
trait OrgsListInvitationTeams_RequestOptions extends js.Object {
...
object OrgsListInvitationTeams_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsListInvitationTeams_RequestOptions]
  }
}
