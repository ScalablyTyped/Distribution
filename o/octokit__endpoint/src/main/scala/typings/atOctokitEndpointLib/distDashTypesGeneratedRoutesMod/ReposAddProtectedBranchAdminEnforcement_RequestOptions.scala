...
trait ReposAddProtectedBranchAdminEnforcement_RequestOptions extends js.Object {
...
object ReposAddProtectedBranchAdminEnforcement_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposAddProtectedBranchAdminEnforcement_RequestOptions]
  }
}
