...
trait PullsListReviewRequestsRequestOptions extends js.Object {
...
object PullsListReviewRequestsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsListReviewRequestsRequestOptions]
  }
}
