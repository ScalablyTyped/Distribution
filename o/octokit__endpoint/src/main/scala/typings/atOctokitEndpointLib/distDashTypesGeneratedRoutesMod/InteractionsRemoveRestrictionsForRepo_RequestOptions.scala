...
trait InteractionsRemoveRestrictionsForRepo_RequestOptions extends js.Object {
...
object InteractionsRemoveRestrictionsForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[InteractionsRemoveRestrictionsForRepo_RequestOptions]
  }
}
