...
trait ActivityListWatchersForRepo_RequestOptions extends js.Object {
...
object ActivityListWatchersForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListWatchersForRepo_RequestOptions]
  }
}
