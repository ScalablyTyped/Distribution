...
trait OauthAuthorizationsCheckAuthorizationRequestOptions extends js.Object {
...
object OauthAuthorizationsCheckAuthorizationRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsCheckAuthorizationRequestOptions]
  }
}
