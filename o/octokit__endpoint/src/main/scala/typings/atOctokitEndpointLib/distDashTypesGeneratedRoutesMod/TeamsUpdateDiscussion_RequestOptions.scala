...
trait TeamsUpdateDiscussion_RequestOptions extends js.Object {
...
object TeamsUpdateDiscussion_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussion_RequestOptions]
  }
}
