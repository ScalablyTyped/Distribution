...
trait ActivityListReposWatchedByUser_RequestOptions extends js.Object {
...
object ActivityListReposWatchedByUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListReposWatchedByUser_RequestOptions]
  }
}
