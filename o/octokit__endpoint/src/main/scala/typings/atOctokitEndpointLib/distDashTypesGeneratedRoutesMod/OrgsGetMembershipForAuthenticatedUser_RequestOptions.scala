...
trait OrgsGetMembershipForAuthenticatedUser_RequestOptions extends js.Object {
...
object OrgsGetMembershipForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsGetMembershipForAuthenticatedUser_RequestOptions]
  }
}
