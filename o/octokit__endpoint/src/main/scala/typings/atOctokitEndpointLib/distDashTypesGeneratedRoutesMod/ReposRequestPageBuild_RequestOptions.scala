...
trait ReposRequestPageBuild_RequestOptions extends js.Object {
...
object ReposRequestPageBuild_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRequestPageBuild_RequestOptions]
  }
}
