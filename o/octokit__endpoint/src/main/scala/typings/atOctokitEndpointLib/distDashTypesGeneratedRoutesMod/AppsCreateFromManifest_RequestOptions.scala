...
trait AppsCreateFromManifest_RequestOptions extends js.Object {
...
object AppsCreateFromManifest_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsCreateFromManifest_RequestOptions]
  }
}
