...
trait ActivityListNotificationsForRepo_RequestOptions extends js.Object {
...
object ActivityListNotificationsForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListNotificationsForRepo_RequestOptions]
  }
}
