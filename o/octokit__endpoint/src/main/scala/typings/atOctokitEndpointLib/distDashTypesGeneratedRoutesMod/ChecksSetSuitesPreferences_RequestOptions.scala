...
trait ChecksSetSuitesPreferences_RequestOptions extends js.Object {
...
object ChecksSetSuitesPreferences_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ChecksSetSuitesPreferences_RequestOptions]
  }
}
