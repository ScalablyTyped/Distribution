...
trait ReposListDeploymentStatuses_RequestOptions extends js.Object {
...
object ReposListDeploymentStatuses_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListDeploymentStatuses_RequestOptions]
  }
}
