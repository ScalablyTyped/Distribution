...
trait OrgsRemoveCredentialAuthorizationRequestOptions extends js.Object {
...
object OrgsRemoveCredentialAuthorizationRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsRemoveCredentialAuthorizationRequestOptions]
  }
}
