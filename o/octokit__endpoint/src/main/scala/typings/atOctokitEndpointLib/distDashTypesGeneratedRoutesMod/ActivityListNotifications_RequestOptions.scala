...
trait ActivityListNotifications_RequestOptions extends js.Object {
...
object ActivityListNotifications_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListNotifications_RequestOptions]
  }
}
