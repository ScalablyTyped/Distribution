...
trait ActivityCheckStarringRepo_RequestOptions extends js.Object {
...
object ActivityCheckStarringRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityCheckStarringRepo_RequestOptions]
  }
}
