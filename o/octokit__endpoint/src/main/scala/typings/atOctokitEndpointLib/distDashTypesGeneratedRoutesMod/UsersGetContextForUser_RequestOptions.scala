...
trait UsersGetContextForUser_RequestOptions extends js.Object {
...
object UsersGetContextForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersGetContextForUser_RequestOptions]
  }
}
