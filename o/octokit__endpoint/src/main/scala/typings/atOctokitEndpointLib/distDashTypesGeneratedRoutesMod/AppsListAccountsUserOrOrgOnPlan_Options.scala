...
trait AppsListAccountsUserOrOrgOnPlan_Options extends js.Object {
...
object AppsListAccountsUserOrOrgOnPlan_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListAccountsUserOrOrgOnPlan_Options]
  }
}
