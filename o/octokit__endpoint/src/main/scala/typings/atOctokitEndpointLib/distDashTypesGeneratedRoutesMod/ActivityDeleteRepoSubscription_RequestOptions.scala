...
trait ActivityDeleteRepoSubscription_RequestOptions extends js.Object {
...
object ActivityDeleteRepoSubscription_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityDeleteRepoSubscription_RequestOptions]
  }
}
