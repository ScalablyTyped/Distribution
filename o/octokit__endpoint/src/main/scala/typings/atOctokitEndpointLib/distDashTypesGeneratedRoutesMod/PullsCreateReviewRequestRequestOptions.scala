...
trait PullsCreateReviewRequestRequestOptions extends js.Object {
...
object PullsCreateReviewRequestRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestRequestOptions]
  }
}
