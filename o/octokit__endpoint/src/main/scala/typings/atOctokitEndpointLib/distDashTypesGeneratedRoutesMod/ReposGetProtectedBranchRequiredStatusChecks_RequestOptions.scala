...
trait ReposGetProtectedBranchRequiredStatusChecks_RequestOptions extends js.Object {
...
object ReposGetProtectedBranchRequiredStatusChecks_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchRequiredStatusChecks_RequestOptions]
  }
}
