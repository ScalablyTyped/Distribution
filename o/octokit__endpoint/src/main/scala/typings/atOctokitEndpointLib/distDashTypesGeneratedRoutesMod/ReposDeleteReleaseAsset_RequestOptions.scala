...
trait ReposDeleteReleaseAsset_RequestOptions extends js.Object {
...
object ReposDeleteReleaseAsset_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposDeleteReleaseAsset_RequestOptions]
  }
}
