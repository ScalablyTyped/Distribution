...
trait TeamsUpdateDiscussionCommentRequestOptions extends js.Object {
...
object TeamsUpdateDiscussionCommentRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionCommentRequestOptions]
  }
}
