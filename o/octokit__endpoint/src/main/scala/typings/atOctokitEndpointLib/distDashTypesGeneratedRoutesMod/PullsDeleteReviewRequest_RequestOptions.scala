...
trait PullsDeleteReviewRequest_RequestOptions extends js.Object {
...
object PullsDeleteReviewRequest_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsDeleteReviewRequest_RequestOptions]
  }
}
