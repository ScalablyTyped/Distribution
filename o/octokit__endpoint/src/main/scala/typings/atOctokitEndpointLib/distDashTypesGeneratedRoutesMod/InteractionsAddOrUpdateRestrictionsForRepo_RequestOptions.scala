...
trait InteractionsAddOrUpdateRestrictionsForRepo_RequestOptions extends js.Object {
...
object InteractionsAddOrUpdateRestrictionsForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[InteractionsAddOrUpdateRestrictionsForRepo_RequestOptions]
  }
}
