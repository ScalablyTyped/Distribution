...
trait ReposRemoveProtectedBranchUserRestrictions_RequestOptions extends js.Object {
...
object ReposRemoveProtectedBranchUserRestrictions_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRemoveProtectedBranchUserRestrictions_RequestOptions]
  }
}
