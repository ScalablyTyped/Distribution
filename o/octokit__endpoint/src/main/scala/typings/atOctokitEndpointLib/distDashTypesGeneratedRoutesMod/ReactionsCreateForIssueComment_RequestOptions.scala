...
trait ReactionsCreateForIssueComment_RequestOptions extends js.Object {
...
object ReactionsCreateForIssueComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsCreateForIssueComment_RequestOptions]
  }
}
