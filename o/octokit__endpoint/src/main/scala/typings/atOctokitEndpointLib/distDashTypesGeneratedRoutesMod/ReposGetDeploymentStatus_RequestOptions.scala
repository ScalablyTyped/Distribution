...
trait ReposGetDeploymentStatus_RequestOptions extends js.Object {
...
object ReposGetDeploymentStatus_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetDeploymentStatus_RequestOptions]
  }
}
