...
trait AppsFindRepoInstallationRequestOptions extends js.Object {
...
object AppsFindRepoInstallationRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsFindRepoInstallationRequestOptions]
  }
}
