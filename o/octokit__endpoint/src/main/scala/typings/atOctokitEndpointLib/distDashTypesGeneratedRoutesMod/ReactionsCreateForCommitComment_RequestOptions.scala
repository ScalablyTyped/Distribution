...
trait ReactionsCreateForCommitComment_RequestOptions extends js.Object {
...
object ReactionsCreateForCommitComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsCreateForCommitComment_RequestOptions]
  }
}
