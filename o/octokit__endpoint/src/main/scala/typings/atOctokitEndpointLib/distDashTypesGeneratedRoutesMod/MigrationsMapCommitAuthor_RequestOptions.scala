...
trait MigrationsMapCommitAuthor_RequestOptions extends js.Object {
...
object MigrationsMapCommitAuthor_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsMapCommitAuthor_RequestOptions]
  }
}
