...
trait TeamsCreateDiscussionComment_RequestOptions extends js.Object {
...
object TeamsCreateDiscussionComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionComment_RequestOptions]
  }
}
