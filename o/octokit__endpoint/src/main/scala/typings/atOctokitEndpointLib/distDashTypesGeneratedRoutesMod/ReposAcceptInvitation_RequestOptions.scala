...
trait ReposAcceptInvitation_RequestOptions extends js.Object {
...
object ReposAcceptInvitation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposAcceptInvitation_RequestOptions]
  }
}
