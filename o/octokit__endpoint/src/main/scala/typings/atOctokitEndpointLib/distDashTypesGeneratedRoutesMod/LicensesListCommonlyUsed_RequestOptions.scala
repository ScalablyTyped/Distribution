...
trait LicensesListCommonlyUsed_RequestOptions extends js.Object {
...
object LicensesListCommonlyUsed_RequestOptions {
  @scala.inline
  def apply(
  ...
  ): LicensesListCommonlyUsed_RequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[LicensesListCommonlyUsed_RequestOptions]
  }
}
