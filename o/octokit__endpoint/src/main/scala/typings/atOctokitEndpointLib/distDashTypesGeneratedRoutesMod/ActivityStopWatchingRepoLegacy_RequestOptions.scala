...
trait ActivityStopWatchingRepoLegacy_RequestOptions extends js.Object {
...
object ActivityStopWatchingRepoLegacy_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityStopWatchingRepoLegacy_RequestOptions]
  }
}
