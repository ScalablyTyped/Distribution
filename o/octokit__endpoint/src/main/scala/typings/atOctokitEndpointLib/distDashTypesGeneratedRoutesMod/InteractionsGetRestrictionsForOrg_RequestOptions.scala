...
trait InteractionsGetRestrictionsForOrg_RequestOptions extends js.Object {
...
object InteractionsGetRestrictionsForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[InteractionsGetRestrictionsForOrg_RequestOptions]
  }
}
