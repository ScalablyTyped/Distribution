...
trait ReposGetArchiveLink_RequestOptions extends js.Object {
...
object ReposGetArchiveLink_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetArchiveLink_RequestOptions]
  }
}
