...
trait ProjectsDeleteColumn_RequestOptions extends js.Object {
...
object ProjectsDeleteColumn_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsDeleteColumn_RequestOptions]
  }
}
