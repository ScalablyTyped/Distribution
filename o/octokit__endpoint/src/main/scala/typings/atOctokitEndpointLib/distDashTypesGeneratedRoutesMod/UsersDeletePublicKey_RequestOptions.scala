...
trait UsersDeletePublicKey_RequestOptions extends js.Object {
...
object UsersDeletePublicKey_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersDeletePublicKey_RequestOptions]
  }
}
