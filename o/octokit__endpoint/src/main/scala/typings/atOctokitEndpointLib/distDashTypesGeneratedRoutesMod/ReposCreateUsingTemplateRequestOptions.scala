...
trait ReposCreateUsingTemplateRequestOptions extends js.Object {
...
object ReposCreateUsingTemplateRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateUsingTemplateRequestOptions]
  }
}
