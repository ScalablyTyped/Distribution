...
trait AppsRemoveRepoFromInstallation_RequestOptions extends js.Object {
...
object AppsRemoveRepoFromInstallation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsRemoveRepoFromInstallation_RequestOptions]
  }
}
