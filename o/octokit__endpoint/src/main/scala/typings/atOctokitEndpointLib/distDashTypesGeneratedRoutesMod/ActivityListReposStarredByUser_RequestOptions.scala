...
trait ActivityListReposStarredByUser_RequestOptions extends js.Object {
...
object ActivityListReposStarredByUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListReposStarredByUser_RequestOptions]
  }
}
