...
trait AppsListInstallationsForAuthenticatedUser_RequestOptions extends js.Object {
...
object AppsListInstallationsForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListInstallationsForAuthenticatedUser_RequestOptions]
  }
}
