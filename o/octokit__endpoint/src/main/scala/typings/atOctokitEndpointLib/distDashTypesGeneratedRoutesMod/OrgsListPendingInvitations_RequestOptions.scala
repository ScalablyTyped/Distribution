...
trait OrgsListPendingInvitations_RequestOptions extends js.Object {
...
object OrgsListPendingInvitations_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsListPendingInvitations_RequestOptions]
  }
}
