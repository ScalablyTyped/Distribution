...
trait ReactionsListForIssueComment_Options extends js.Object {
...
object ReactionsListForIssueComment_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsListForIssueComment_Options]
  }
}
