...
trait CodesOfConductListConductCodesRequestOptions extends js.Object {
...
object CodesOfConductListConductCodesRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[CodesOfConductListConductCodesRequestOptions]
  }
}
