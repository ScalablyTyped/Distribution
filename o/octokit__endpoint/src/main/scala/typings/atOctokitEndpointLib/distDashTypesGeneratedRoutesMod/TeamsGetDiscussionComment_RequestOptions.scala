...
trait TeamsGetDiscussionComment_RequestOptions extends js.Object {
...
object TeamsGetDiscussionComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsGetDiscussionComment_RequestOptions]
  }
}
