...
trait UsersUpdateAuthenticated_RequestOptions extends js.Object {
...
object UsersUpdateAuthenticated_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersUpdateAuthenticated_RequestOptions]
  }
}
