...
trait OauthAuthorizationsResetAuthorization_RequestOptions extends js.Object {
...
object OauthAuthorizationsResetAuthorization_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsResetAuthorization_RequestOptions]
  }
}
