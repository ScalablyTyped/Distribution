...
trait AppsGetUserInstallation_RequestOptions extends js.Object {
...
object AppsGetUserInstallation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsGetUserInstallation_RequestOptions]
  }
}
