...
trait PullsGetCommentsForReview_RequestOptions extends js.Object {
...
object PullsGetCommentsForReview_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsGetCommentsForReview_RequestOptions]
  }
}
