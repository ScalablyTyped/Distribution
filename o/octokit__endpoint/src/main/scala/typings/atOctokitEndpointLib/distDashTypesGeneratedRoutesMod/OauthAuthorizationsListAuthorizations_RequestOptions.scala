...
trait OauthAuthorizationsListAuthorizations_RequestOptions extends js.Object {
...
object OauthAuthorizationsListAuthorizations_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsListAuthorizations_RequestOptions]
  }
}
