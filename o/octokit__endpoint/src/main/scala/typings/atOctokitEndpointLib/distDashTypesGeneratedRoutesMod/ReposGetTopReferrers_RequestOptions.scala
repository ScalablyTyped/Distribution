...
trait ReposGetTopReferrers_RequestOptions extends js.Object {
...
object ReposGetTopReferrers_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetTopReferrers_RequestOptions]
  }
}
