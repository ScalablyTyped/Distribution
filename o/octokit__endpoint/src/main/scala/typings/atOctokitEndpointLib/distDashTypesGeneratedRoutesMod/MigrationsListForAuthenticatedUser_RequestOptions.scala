...
trait MigrationsListForAuthenticatedUser_RequestOptions extends js.Object {
...
object MigrationsListForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsListForAuthenticatedUser_RequestOptions]
  }
}
