...
trait ReposRemoveProtectedBranchRequiredSignaturesRequestOptions extends js.Object {
...
object ReposRemoveProtectedBranchRequiredSignaturesRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRemoveProtectedBranchRequiredSignaturesRequestOptions]
  }
}
