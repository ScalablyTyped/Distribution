...
trait ReposGetProtectedBranchRequiredSignaturesRequestOptions extends js.Object {
...
object ReposGetProtectedBranchRequiredSignaturesRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchRequiredSignaturesRequestOptions]
  }
}
