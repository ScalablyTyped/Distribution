...
trait OrgsConcealMembership_RequestOptions extends js.Object {
...
object OrgsConcealMembership_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsConcealMembership_RequestOptions]
  }
}
