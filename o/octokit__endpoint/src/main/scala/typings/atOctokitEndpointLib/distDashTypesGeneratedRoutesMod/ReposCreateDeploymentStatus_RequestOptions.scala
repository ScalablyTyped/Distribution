...
trait ReposCreateDeploymentStatus_RequestOptions extends js.Object {
...
object ReposCreateDeploymentStatus_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateDeploymentStatus_RequestOptions]
  }
}
