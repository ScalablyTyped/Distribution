...
trait ReposRemoveProtectedBranchRequiredStatusChecks_RequestOptions extends js.Object {
...
object ReposRemoveProtectedBranchRequiredStatusChecks_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRemoveProtectedBranchRequiredStatusChecks_RequestOptions]
  }
}
