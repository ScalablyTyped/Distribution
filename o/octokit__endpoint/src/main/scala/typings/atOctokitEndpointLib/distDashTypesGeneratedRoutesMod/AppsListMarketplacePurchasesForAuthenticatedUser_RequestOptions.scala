...
trait AppsListMarketplacePurchasesForAuthenticatedUser_RequestOptions extends js.Object {
...
object AppsListMarketplacePurchasesForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListMarketplacePurchasesForAuthenticatedUser_RequestOptions]
  }
}
