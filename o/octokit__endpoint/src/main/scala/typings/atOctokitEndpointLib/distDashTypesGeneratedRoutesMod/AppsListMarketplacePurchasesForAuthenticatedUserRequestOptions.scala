...
trait AppsListMarketplacePurchasesForAuthenticatedUserRequestOptions extends js.Object {
...
object AppsListMarketplacePurchasesForAuthenticatedUserRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListMarketplacePurchasesForAuthenticatedUserRequestOptions]
  }
}
