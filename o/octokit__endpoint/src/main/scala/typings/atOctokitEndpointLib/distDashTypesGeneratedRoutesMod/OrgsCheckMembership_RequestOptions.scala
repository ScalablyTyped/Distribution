...
trait OrgsCheckMembership_RequestOptions extends js.Object {
...
object OrgsCheckMembership_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsCheckMembership_RequestOptions]
  }
}
