...
trait ActivityCheckWatchingRepoLegacyRequestOptions extends js.Object {
...
object ActivityCheckWatchingRepoLegacyRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityCheckWatchingRepoLegacyRequestOptions]
  }
}
