...
trait IssuesListLabelsForMilestone_Options extends js.Object {
...
object IssuesListLabelsForMilestone_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListLabelsForMilestone_Options]
  }
}
