...
trait TeamsUpdateDiscussionComment_Options extends js.Object {
...
object TeamsUpdateDiscussionComment_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionComment_Options]
  }
}
