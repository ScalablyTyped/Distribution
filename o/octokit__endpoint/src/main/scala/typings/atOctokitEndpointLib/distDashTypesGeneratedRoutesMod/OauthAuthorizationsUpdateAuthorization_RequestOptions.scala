...
trait OauthAuthorizationsUpdateAuthorization_RequestOptions extends js.Object {
...
object OauthAuthorizationsUpdateAuthorization_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsUpdateAuthorization_RequestOptions]
  }
}
