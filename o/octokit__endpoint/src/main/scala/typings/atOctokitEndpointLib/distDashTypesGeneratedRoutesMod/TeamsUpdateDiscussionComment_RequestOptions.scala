...
trait TeamsUpdateDiscussionComment_RequestOptions extends js.Object {
...
object TeamsUpdateDiscussionComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionComment_RequestOptions]
  }
}
