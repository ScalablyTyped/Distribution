...
trait ActivityGetThreadSubscription_RequestOptions extends js.Object {
...
object ActivityGetThreadSubscription_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityGetThreadSubscription_RequestOptions]
  }
}
