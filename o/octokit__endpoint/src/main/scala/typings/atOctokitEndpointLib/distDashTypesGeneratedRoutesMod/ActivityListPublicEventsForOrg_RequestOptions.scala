...
trait ActivityListPublicEventsForOrg_RequestOptions extends js.Object {
...
object ActivityListPublicEventsForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListPublicEventsForOrg_RequestOptions]
  }
}
