...
trait UsersCheckFollowing_RequestOptions extends js.Object {
...
object UsersCheckFollowing_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersCheckFollowing_RequestOptions]
  }
}
