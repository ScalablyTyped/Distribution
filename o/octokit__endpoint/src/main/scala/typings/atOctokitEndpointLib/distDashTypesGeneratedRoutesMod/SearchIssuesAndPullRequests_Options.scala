...
trait SearchIssuesAndPullRequests_Options extends js.Object {
...
object SearchIssuesAndPullRequests_Options {
  @scala.inline
  def apply(
    q: java.lang.String,
  ...
  ): SearchIssuesAndPullRequests_Options = {
    val __obj = js.Dynamic.literal(q = q)
    if (order != null) __obj.updateDynamic("order")(order)
    if (page != null) __obj.updateDynamic("page")(page.asInstanceOf[js.Any])
    if (per_page != null) __obj.updateDynamic("per_page")(per_page.asInstanceOf[js.Any])
    if (sort != null) __obj.updateDynamic("sort")(sort)
    __obj.asInstanceOf[SearchIssuesAndPullRequests_Options]
  }
}
