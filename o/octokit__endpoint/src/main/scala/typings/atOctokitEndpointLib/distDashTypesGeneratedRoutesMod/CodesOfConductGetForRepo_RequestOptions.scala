...
trait CodesOfConductGetForRepo_RequestOptions extends js.Object {
...
object CodesOfConductGetForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[CodesOfConductGetForRepo_RequestOptions]
  }
}
