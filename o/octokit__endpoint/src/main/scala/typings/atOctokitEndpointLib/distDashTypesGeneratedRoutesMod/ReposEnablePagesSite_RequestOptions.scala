...
trait ReposEnablePagesSite_RequestOptions extends js.Object {
...
object ReposEnablePagesSite_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposEnablePagesSite_RequestOptions]
  }
}
