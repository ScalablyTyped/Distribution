...
trait ActivitySetThreadSubscription_RequestOptions extends js.Object {
...
object ActivitySetThreadSubscription_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivitySetThreadSubscription_RequestOptions]
  }
}
