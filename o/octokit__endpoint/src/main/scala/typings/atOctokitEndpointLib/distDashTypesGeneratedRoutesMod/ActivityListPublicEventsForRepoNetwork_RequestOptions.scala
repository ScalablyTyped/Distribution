...
trait ActivityListPublicEventsForRepoNetwork_RequestOptions extends js.Object {
...
object ActivityListPublicEventsForRepoNetwork_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListPublicEventsForRepoNetwork_RequestOptions]
  }
}
