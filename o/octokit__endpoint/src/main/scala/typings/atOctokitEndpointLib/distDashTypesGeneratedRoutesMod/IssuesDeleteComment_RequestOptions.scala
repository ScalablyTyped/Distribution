...
trait IssuesDeleteComment_RequestOptions extends js.Object {
...
object IssuesDeleteComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesDeleteComment_RequestOptions]
  }
}
