...
trait ActivityListReposStarredByAuthenticatedUser_RequestOptions extends js.Object {
...
object ActivityListReposStarredByAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListReposStarredByAuthenticatedUser_RequestOptions]
  }
}
