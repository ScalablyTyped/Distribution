...
trait GitignoreListTemplates_RequestOptions extends js.Object {
...
object GitignoreListTemplates_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[GitignoreListTemplates_RequestOptions]
  }
}
