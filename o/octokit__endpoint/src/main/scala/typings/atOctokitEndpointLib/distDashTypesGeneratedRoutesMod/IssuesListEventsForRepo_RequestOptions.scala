...
trait IssuesListEventsForRepo_RequestOptions extends js.Object {
...
object IssuesListEventsForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListEventsForRepo_RequestOptions]
  }
}
