...
trait ReposGetCombinedStatusForRef_RequestOptions extends js.Object {
...
object ReposGetCombinedStatusForRef_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetCombinedStatusForRef_RequestOptions]
  }
}
