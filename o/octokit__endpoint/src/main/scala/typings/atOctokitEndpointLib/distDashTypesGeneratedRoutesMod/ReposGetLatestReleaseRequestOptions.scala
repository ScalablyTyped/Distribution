...
trait ReposGetLatestReleaseRequestOptions extends js.Object {
...
object ReposGetLatestReleaseRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetLatestReleaseRequestOptions]
  }
}
