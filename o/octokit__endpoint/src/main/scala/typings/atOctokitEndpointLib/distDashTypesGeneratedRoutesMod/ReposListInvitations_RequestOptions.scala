...
trait ReposListInvitations_RequestOptions extends js.Object {
...
object ReposListInvitations_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListInvitations_RequestOptions]
  }
}
