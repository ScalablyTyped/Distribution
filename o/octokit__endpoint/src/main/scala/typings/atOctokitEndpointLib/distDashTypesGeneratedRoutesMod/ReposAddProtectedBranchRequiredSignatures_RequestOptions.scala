...
trait ReposAddProtectedBranchRequiredSignatures_RequestOptions extends js.Object {
...
object ReposAddProtectedBranchRequiredSignatures_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposAddProtectedBranchRequiredSignatures_RequestOptions]
  }
}
