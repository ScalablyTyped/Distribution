...
trait PullsCreateComment_Options extends js.Object {
...
object PullsCreateComment_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateComment_Options]
  }
}
