...
trait MigrationsGetArchiveForAuthenticatedUser_RequestOptions extends js.Object {
...
object MigrationsGetArchiveForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsGetArchiveForAuthenticatedUser_RequestOptions]
  }
}
