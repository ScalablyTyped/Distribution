...
trait AppsFindOrgInstallation_RequestOptions extends js.Object {
...
object AppsFindOrgInstallation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsFindOrgInstallation_RequestOptions]
  }
}
