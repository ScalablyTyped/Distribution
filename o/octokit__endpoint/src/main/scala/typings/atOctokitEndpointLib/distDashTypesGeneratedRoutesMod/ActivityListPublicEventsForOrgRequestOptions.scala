...
trait ActivityListPublicEventsForOrgRequestOptions extends js.Object {
...
object ActivityListPublicEventsForOrgRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListPublicEventsForOrgRequestOptions]
  }
}
