...
trait ReposGetReleaseByTag_RequestOptions extends js.Object {
...
object ReposGetReleaseByTag_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetReleaseByTag_RequestOptions]
  }
}
