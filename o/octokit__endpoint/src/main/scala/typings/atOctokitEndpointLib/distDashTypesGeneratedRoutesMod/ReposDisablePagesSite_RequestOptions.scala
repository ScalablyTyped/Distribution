...
trait ReposDisablePagesSite_RequestOptions extends js.Object {
...
object ReposDisablePagesSite_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposDisablePagesSite_RequestOptions]
  }
}
