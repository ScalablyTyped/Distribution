...
trait TeamsDeleteDiscussion_RequestOptions extends js.Object {
...
object TeamsDeleteDiscussion_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsDeleteDiscussion_RequestOptions]
  }
}
