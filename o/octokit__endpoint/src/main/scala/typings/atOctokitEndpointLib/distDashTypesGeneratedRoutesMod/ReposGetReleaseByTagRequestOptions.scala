...
trait ReposGetReleaseByTagRequestOptions extends js.Object {
...
object ReposGetReleaseByTagRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetReleaseByTagRequestOptions]
  }
}
