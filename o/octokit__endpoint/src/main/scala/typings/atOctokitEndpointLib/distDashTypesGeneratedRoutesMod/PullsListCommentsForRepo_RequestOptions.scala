...
trait PullsListCommentsForRepo_RequestOptions extends js.Object {
...
object PullsListCommentsForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsListCommentsForRepo_RequestOptions]
  }
}
