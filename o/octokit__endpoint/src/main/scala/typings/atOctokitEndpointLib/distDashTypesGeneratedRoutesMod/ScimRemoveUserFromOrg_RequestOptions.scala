...
trait ScimRemoveUserFromOrg_RequestOptions extends js.Object {
...
object ScimRemoveUserFromOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ScimRemoveUserFromOrg_RequestOptions]
  }
}
