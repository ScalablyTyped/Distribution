...
trait ReposRemoveDeployKey_RequestOptions extends js.Object {
...
object ReposRemoveDeployKey_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRemoveDeployKey_RequestOptions]
  }
}
