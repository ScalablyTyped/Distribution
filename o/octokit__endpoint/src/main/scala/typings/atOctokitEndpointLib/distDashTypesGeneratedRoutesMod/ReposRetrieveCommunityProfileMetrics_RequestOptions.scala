...
trait ReposRetrieveCommunityProfileMetrics_RequestOptions extends js.Object {
...
object ReposRetrieveCommunityProfileMetrics_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRetrieveCommunityProfileMetrics_RequestOptions]
  }
}
