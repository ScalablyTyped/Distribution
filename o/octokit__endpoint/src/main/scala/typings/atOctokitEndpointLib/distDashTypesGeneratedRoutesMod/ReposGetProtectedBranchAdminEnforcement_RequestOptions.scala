...
trait ReposGetProtectedBranchAdminEnforcement_RequestOptions extends js.Object {
...
object ReposGetProtectedBranchAdminEnforcement_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchAdminEnforcement_RequestOptions]
  }
}
