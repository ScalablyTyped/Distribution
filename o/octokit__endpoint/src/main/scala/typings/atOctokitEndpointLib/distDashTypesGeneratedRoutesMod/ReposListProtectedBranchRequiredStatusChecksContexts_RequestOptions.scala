...
trait ReposListProtectedBranchRequiredStatusChecksContexts_RequestOptions extends js.Object {
...
object ReposListProtectedBranchRequiredStatusChecksContexts_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListProtectedBranchRequiredStatusChecksContexts_RequestOptions]
  }
}
