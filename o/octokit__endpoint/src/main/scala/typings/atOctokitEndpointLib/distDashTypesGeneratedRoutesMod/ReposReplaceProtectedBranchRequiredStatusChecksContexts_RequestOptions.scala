...
trait ReposReplaceProtectedBranchRequiredStatusChecksContexts_RequestOptions extends js.Object {
  var headers: atOctokitEndpointLib.distDashTypesTypesMod.Headers
  var method: atOctokitEndpointLib.atOctokitEndpointLibStrings.PUT
...
object ReposReplaceProtectedBranchRequiredStatusChecksContexts_RequestOptions {
  @scala.inline
  def apply(
    headers: atOctokitEndpointLib.distDashTypesTypesMod.Headers,
    method: atOctokitEndpointLib.atOctokitEndpointLibStrings.PUT,
    ...
    __obj.asInstanceOf[ReposReplaceProtectedBranchRequiredStatusChecksContexts_RequestOptions]
  }
}
