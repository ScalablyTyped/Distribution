...
trait ActivityListReceivedPublicEventsForUser_RequestOptions extends js.Object {
...
object ActivityListReceivedPublicEventsForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListReceivedPublicEventsForUser_RequestOptions]
  }
}
