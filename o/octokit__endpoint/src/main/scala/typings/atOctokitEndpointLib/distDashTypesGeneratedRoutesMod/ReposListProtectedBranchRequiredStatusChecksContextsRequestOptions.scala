...
trait ReposListProtectedBranchRequiredStatusChecksContextsRequestOptions extends js.Object {
...
object ReposListProtectedBranchRequiredStatusChecksContextsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListProtectedBranchRequiredStatusChecksContextsRequestOptions]
  }
}
