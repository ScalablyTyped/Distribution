...
trait ChecksRerequestSuite_RequestOptions extends js.Object {
...
object ChecksRerequestSuite_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ChecksRerequestSuite_RequestOptions]
  }
}
