...
trait ScimReplaceProvisionedUserInformation_Options extends js.Object {
  var external_identity_guid: js.UndefOr[scala.Double] = js.undefined
  var org: java.lang.String
  var scim_user_id: scala.Double
}

object ScimReplaceProvisionedUserInformation_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ScimReplaceProvisionedUserInformation_Options]
  }
}
