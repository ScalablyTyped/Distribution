...
trait ReposGetBranchProtection_RequestOptions extends js.Object {
...
object ReposGetBranchProtection_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetBranchProtection_RequestOptions]
  }
}
