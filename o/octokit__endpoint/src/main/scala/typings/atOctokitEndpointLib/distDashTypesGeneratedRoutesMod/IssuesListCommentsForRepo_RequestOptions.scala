...
trait IssuesListCommentsForRepo_RequestOptions extends js.Object {
...
object IssuesListCommentsForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListCommentsForRepo_RequestOptions]
  }
}
