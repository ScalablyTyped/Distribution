...
trait SearchIssuesAndPullRequests_RequestOptions extends js.Object {
...
object SearchIssuesAndPullRequests_RequestOptions {
  @scala.inline
  def apply(
  ...
  ): SearchIssuesAndPullRequests_RequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[SearchIssuesAndPullRequests_RequestOptions]
  }
}
