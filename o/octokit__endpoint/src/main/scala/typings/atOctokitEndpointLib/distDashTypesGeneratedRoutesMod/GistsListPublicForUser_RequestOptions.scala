...
trait GistsListPublicForUser_RequestOptions extends js.Object {
...
object GistsListPublicForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[GistsListPublicForUser_RequestOptions]
  }
}
