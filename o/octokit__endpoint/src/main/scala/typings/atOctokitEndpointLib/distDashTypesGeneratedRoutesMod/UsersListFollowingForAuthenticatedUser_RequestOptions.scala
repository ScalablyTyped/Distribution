...
trait UsersListFollowingForAuthenticatedUser_RequestOptions extends js.Object {
...
object UsersListFollowingForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersListFollowingForAuthenticatedUser_RequestOptions]
  }
}
