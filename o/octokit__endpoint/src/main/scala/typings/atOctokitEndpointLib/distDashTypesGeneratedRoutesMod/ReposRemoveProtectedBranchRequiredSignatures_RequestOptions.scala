...
trait ReposRemoveProtectedBranchRequiredSignatures_RequestOptions extends js.Object {
...
object ReposRemoveProtectedBranchRequiredSignatures_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRemoveProtectedBranchRequiredSignatures_RequestOptions]
  }
}
