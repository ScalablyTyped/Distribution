...
trait AppsGetUserInstallationRequestOptions extends js.Object {
...
object AppsGetUserInstallationRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsGetUserInstallationRequestOptions]
  }
}
