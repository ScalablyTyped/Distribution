...
trait TeamsDeleteDiscussionCommentRequestOptions extends js.Object {
...
object TeamsDeleteDiscussionCommentRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsDeleteDiscussionCommentRequestOptions]
  }
}
