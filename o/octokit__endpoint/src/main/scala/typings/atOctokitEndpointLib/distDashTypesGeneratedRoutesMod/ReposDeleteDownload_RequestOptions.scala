...
trait ReposDeleteDownload_RequestOptions extends js.Object {
...
object ReposDeleteDownload_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposDeleteDownload_RequestOptions]
  }
}
