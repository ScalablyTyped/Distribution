...
trait ReposAddProtectedBranchRequiredStatusChecksContexts_RequestOptions extends js.Object {
...
object ReposAddProtectedBranchRequiredStatusChecksContexts_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposAddProtectedBranchRequiredStatusChecksContexts_RequestOptions]
  }
}
