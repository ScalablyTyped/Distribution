...
trait OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprint_Options extends js.Object {
...
object OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprint_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprint_Options]
  }
}
