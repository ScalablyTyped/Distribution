...
trait OauthAuthorizationsListGrants_RequestOptions extends js.Object {
...
object OauthAuthorizationsListGrants_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsListGrants_RequestOptions]
  }
}
