...
trait ReposListProtectedBranchTeamRestrictionsRequestOptions extends js.Object {
...
object ReposListProtectedBranchTeamRestrictionsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListProtectedBranchTeamRestrictionsRequestOptions]
  }
}
