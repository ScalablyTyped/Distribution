...
trait OauthAuthorizationsDeleteAuthorization_RequestOptions extends js.Object {
...
object OauthAuthorizationsDeleteAuthorization_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsDeleteAuthorization_RequestOptions]
  }
}
