...
trait ReposCreateForAuthenticatedUser_RequestOptions extends js.Object {
...
object ReposCreateForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateForAuthenticatedUser_RequestOptions]
  }
}
