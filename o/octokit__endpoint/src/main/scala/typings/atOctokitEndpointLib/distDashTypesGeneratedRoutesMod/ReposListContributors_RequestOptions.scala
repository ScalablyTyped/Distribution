...
trait ReposListContributors_RequestOptions extends js.Object {
...
object ReposListContributors_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListContributors_RequestOptions]
  }
}
