...
trait TeamsDeleteDiscussionRequestOptions extends js.Object {
...
object TeamsDeleteDiscussionRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsDeleteDiscussionRequestOptions]
  }
}
