...
trait ReposRemoveCollaborator_RequestOptions extends js.Object {
...
object ReposRemoveCollaborator_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRemoveCollaborator_RequestOptions]
  }
}
