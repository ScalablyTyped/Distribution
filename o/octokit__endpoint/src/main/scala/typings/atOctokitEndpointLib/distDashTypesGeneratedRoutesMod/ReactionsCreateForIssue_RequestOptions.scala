...
trait ReactionsCreateForIssue_RequestOptions extends js.Object {
...
object ReactionsCreateForIssue_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsCreateForIssue_RequestOptions]
  }
}
