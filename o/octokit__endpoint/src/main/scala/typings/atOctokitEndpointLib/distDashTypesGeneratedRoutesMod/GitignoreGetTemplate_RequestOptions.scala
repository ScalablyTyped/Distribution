...
trait GitignoreGetTemplate_RequestOptions extends js.Object {
...
object GitignoreGetTemplate_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[GitignoreGetTemplate_RequestOptions]
  }
}
