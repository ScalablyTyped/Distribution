...
trait IssuesListLabelsForMilestone_RequestOptions extends js.Object {
...
object IssuesListLabelsForMilestone_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListLabelsForMilestone_RequestOptions]
  }
}
