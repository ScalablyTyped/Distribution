...
trait ReactionsListForCommitComment_RequestOptions extends js.Object {
...
object ReactionsListForCommitComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsListForCommitComment_RequestOptions]
  }
}
