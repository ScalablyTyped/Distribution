...
trait IssuesListAssignees_RequestOptions extends js.Object {
...
object IssuesListAssignees_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListAssignees_RequestOptions]
  }
}
