...
trait ActivityWatchRepoLegacy_RequestOptions extends js.Object {
...
object ActivityWatchRepoLegacy_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityWatchRepoLegacy_RequestOptions]
  }
}
