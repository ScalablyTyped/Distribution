...
trait IssuesReplaceLabels_RequestOptions extends js.Object {
...
object IssuesReplaceLabels_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesReplaceLabels_RequestOptions]
  }
}
