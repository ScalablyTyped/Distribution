...
trait ReactionsListForIssue_RequestOptions extends js.Object {
...
object ReactionsListForIssue_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsListForIssue_RequestOptions]
  }
}
