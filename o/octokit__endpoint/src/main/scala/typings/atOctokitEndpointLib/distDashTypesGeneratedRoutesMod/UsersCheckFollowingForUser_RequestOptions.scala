...
trait UsersCheckFollowingForUser_RequestOptions extends js.Object {
...
object UsersCheckFollowingForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersCheckFollowingForUser_RequestOptions]
  }
}
