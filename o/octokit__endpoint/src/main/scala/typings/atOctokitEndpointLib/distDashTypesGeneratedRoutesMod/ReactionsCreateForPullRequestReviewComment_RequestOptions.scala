...
trait ReactionsCreateForPullRequestReviewComment_RequestOptions extends js.Object {
...
object ReactionsCreateForPullRequestReviewComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsCreateForPullRequestReviewComment_RequestOptions]
  }
}
