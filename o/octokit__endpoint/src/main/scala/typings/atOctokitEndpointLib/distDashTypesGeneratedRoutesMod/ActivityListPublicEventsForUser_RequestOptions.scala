...
trait ActivityListPublicEventsForUser_RequestOptions extends js.Object {
...
object ActivityListPublicEventsForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListPublicEventsForUser_RequestOptions]
  }
}
