...
trait ScimUpdateProvisionedOrgMembership_RequestOptions extends js.Object {
...
object ScimUpdateProvisionedOrgMembership_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ScimUpdateProvisionedOrgMembership_RequestOptions]
  }
}
