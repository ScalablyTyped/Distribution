...
trait ReposDeleteInvitation_RequestOptions extends js.Object {
...
object ReposDeleteInvitation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposDeleteInvitation_RequestOptions]
  }
}
