...
trait ReposListCommentsForCommit_RequestOptions extends js.Object {
...
object ReposListCommentsForCommit_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListCommentsForCommit_RequestOptions]
  }
}
