...
trait TeamsRemoveMembership_RequestOptions extends js.Object {
...
object TeamsRemoveMembership_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsRemoveMembership_RequestOptions]
  }
}
