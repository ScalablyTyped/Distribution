...
trait ReactionsCreateForTeamDiscussionComment_RequestOptions extends js.Object {
...
object ReactionsCreateForTeamDiscussionComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsCreateForTeamDiscussionComment_RequestOptions]
  }
}
