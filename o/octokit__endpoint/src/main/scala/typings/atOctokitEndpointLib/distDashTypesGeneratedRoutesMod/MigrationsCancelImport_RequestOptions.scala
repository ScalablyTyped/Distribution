...
trait MigrationsCancelImport_RequestOptions extends js.Object {
...
object MigrationsCancelImport_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsCancelImport_RequestOptions]
  }
}
