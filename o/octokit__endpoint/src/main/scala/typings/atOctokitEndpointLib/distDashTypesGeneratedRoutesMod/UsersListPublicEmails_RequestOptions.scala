...
trait UsersListPublicEmails_RequestOptions extends js.Object {
...
object UsersListPublicEmails_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersListPublicEmails_RequestOptions]
  }
}
