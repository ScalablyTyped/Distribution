...
trait ReposGetProtectedBranchRequiredSignatures_RequestOptions extends js.Object {
...
object ReposGetProtectedBranchRequiredSignatures_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchRequiredSignatures_RequestOptions]
  }
}
