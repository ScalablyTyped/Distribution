...
trait ProjectsCreateForAuthenticatedUser_RequestOptions extends js.Object {
...
object ProjectsCreateForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsCreateForAuthenticatedUser_RequestOptions]
  }
}
