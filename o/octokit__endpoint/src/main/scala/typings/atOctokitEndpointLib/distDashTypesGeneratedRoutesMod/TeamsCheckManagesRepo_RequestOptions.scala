...
trait TeamsCheckManagesRepo_RequestOptions extends js.Object {
...
object TeamsCheckManagesRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepo_RequestOptions]
  }
}
