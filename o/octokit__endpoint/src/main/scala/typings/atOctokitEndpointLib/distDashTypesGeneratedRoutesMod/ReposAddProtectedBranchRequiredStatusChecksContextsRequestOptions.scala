...
trait ReposAddProtectedBranchRequiredStatusChecksContextsRequestOptions extends js.Object {
...
object ReposAddProtectedBranchRequiredStatusChecksContextsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposAddProtectedBranchRequiredStatusChecksContextsRequestOptions]
  }
}
