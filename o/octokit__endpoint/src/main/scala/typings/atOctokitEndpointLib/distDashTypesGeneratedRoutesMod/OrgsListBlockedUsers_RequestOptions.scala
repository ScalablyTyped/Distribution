...
trait OrgsListBlockedUsers_RequestOptions extends js.Object {
...
object OrgsListBlockedUsers_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsListBlockedUsers_RequestOptions]
  }
}
