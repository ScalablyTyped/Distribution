...
trait ScimProvisionInviteUsers_RequestOptions extends js.Object {
...
object ScimProvisionInviteUsers_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ScimProvisionInviteUsers_RequestOptions]
  }
}
