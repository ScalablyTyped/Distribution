...
trait ReposReplaceProtectedBranchTeamRestrictionsRequestOptions extends js.Object {
...
object ReposReplaceProtectedBranchTeamRestrictionsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposReplaceProtectedBranchTeamRestrictionsRequestOptions]
  }
}
