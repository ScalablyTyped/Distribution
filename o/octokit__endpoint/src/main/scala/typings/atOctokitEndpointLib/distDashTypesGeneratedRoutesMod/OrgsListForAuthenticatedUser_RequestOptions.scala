...
trait OrgsListForAuthenticatedUser_RequestOptions extends js.Object {
...
object OrgsListForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsListForAuthenticatedUser_RequestOptions]
  }
}
