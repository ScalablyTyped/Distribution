...
trait TeamsCreateDiscussion_RequestOptions extends js.Object {
...
object TeamsCreateDiscussion_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCreateDiscussion_RequestOptions]
  }
}
