...
trait IssuesListEventsForTimeline_RequestOptions extends js.Object {
...
object IssuesListEventsForTimeline_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListEventsForTimeline_RequestOptions]
  }
}
