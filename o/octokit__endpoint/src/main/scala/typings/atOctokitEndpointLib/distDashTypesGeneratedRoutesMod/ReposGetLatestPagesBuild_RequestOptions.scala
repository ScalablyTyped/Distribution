...
trait ReposGetLatestPagesBuild_RequestOptions extends js.Object {
...
object ReposGetLatestPagesBuild_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetLatestPagesBuild_RequestOptions]
  }
}
