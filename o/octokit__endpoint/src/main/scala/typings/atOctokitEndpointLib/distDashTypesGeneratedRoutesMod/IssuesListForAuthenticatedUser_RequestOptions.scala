...
trait IssuesListForAuthenticatedUser_RequestOptions extends js.Object {
...
object IssuesListForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListForAuthenticatedUser_RequestOptions]
  }
}
