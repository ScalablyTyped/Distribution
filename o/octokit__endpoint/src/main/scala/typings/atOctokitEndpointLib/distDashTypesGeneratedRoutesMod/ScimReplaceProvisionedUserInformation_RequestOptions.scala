...
trait ScimReplaceProvisionedUserInformation_RequestOptions extends js.Object {
...
object ScimReplaceProvisionedUserInformation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ScimReplaceProvisionedUserInformation_RequestOptions]
  }
}
