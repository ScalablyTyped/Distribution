...
trait OauthAuthorizationsGetAuthorization_RequestOptions extends js.Object {
...
object OauthAuthorizationsGetAuthorization_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetAuthorization_RequestOptions]
  }
}
