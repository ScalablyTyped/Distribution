...
trait ReposListAssetsForRelease_RequestOptions extends js.Object {
...
object ReposListAssetsForRelease_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListAssetsForRelease_RequestOptions]
  }
}
