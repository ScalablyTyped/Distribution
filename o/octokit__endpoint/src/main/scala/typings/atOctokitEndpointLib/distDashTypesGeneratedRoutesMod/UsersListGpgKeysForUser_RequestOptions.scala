...
trait UsersListGpgKeysForUser_RequestOptions extends js.Object {
...
object UsersListGpgKeysForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersListGpgKeysForUser_RequestOptions]
  }
}
