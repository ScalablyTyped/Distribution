...
trait ReposUpdateInvitation_RequestOptions extends js.Object {
...
object ReposUpdateInvitation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUpdateInvitation_RequestOptions]
  }
}
