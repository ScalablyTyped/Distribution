...
trait ReposEnablePagesSiteRequestOptions extends js.Object {
...
object ReposEnablePagesSiteRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposEnablePagesSiteRequestOptions]
  }
}
