...
trait ChecksListAnnotations_RequestOptions extends js.Object {
...
object ChecksListAnnotations_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ChecksListAnnotations_RequestOptions]
  }
}
