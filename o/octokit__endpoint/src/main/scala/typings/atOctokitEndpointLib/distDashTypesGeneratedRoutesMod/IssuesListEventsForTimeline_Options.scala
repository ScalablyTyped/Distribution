...
trait IssuesListEventsForTimeline_Options extends js.Object {
...
object IssuesListEventsForTimeline_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListEventsForTimeline_Options]
  }
}
