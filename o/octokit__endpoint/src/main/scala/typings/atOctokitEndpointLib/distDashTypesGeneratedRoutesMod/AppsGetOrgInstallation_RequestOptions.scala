...
trait AppsGetOrgInstallation_RequestOptions extends js.Object {
...
object AppsGetOrgInstallation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsGetOrgInstallation_RequestOptions]
  }
}
