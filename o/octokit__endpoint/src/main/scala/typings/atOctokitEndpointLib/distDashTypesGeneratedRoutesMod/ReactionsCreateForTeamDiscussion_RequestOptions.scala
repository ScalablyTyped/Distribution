...
trait ReactionsCreateForTeamDiscussion_RequestOptions extends js.Object {
...
object ReactionsCreateForTeamDiscussion_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsCreateForTeamDiscussion_RequestOptions]
  }
}
