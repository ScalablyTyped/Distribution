...
trait ReposRequestPageBuildRequestOptions extends js.Object {
...
object ReposRequestPageBuildRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRequestPageBuildRequestOptions]
  }
}
