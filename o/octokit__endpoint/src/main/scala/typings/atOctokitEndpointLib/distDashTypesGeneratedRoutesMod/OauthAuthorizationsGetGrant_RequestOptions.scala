...
trait OauthAuthorizationsGetGrant_RequestOptions extends js.Object {
...
object OauthAuthorizationsGetGrant_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetGrant_RequestOptions]
  }
}
