...
trait AppsGetRepoInstallation_RequestOptions extends js.Object {
...
object AppsGetRepoInstallation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsGetRepoInstallation_RequestOptions]
  }
}
