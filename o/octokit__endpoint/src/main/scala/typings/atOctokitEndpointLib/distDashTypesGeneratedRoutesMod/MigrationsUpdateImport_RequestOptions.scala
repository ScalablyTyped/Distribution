...
trait MigrationsUpdateImport_RequestOptions extends js.Object {
...
object MigrationsUpdateImport_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsUpdateImport_RequestOptions]
  }
}
