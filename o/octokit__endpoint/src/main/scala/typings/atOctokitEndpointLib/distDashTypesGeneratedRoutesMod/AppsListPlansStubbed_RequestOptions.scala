...
trait AppsListPlansStubbed_RequestOptions extends js.Object {
...
object AppsListPlansStubbed_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListPlansStubbed_RequestOptions]
  }
}
