...
trait GistsCheckIsStarred_RequestOptions extends js.Object {
...
object GistsCheckIsStarred_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[GistsCheckIsStarred_RequestOptions]
  }
}
