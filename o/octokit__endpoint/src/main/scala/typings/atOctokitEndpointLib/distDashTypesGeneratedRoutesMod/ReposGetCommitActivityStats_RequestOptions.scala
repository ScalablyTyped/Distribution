...
trait ReposGetCommitActivityStats_RequestOptions extends js.Object {
...
object ReposGetCommitActivityStats_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetCommitActivityStats_RequestOptions]
  }
}
