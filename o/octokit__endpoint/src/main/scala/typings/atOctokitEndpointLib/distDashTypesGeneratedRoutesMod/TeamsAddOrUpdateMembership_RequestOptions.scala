...
trait TeamsAddOrUpdateMembership_RequestOptions extends js.Object {
...
object TeamsAddOrUpdateMembership_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsAddOrUpdateMembership_RequestOptions]
  }
}
