...
trait OrgsCheckPublicMembership_RequestOptions extends js.Object {
...
object OrgsCheckPublicMembership_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsCheckPublicMembership_RequestOptions]
  }
}
