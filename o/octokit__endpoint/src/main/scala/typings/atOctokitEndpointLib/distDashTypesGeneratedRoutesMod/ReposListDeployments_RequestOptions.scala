...
trait ReposListDeployments_RequestOptions extends js.Object {
...
object ReposListDeployments_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListDeployments_RequestOptions]
  }
}
