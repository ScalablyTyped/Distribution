...
trait OauthAuthorizationsCheckAuthorization_RequestOptions extends js.Object {
...
object OauthAuthorizationsCheckAuthorization_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsCheckAuthorization_RequestOptions]
  }
}
