...
trait InteractionsRemoveRestrictionsForOrg_RequestOptions extends js.Object {
...
object InteractionsRemoveRestrictionsForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[InteractionsRemoveRestrictionsForOrg_RequestOptions]
  }
}
