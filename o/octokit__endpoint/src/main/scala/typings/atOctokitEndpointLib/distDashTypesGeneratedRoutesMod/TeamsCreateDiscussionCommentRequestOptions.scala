...
trait TeamsCreateDiscussionCommentRequestOptions extends js.Object {
...
object TeamsCreateDiscussionCommentRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionCommentRequestOptions]
  }
}
