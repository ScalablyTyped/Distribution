...
trait MigrationsGetStatusForAuthenticatedUser_RequestOptions extends js.Object {
...
object MigrationsGetStatusForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsGetStatusForAuthenticatedUser_RequestOptions]
  }
}
