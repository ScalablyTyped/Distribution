...
trait InteractionsGetRestrictionsForRepo_RequestOptions extends js.Object {
...
object InteractionsGetRestrictionsForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[InteractionsGetRestrictionsForRepo_RequestOptions]
  }
}
