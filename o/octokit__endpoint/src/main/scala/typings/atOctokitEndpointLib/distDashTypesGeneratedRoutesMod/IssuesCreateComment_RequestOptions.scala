...
trait IssuesCreateComment_RequestOptions extends js.Object {
...
object IssuesCreateComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesCreateComment_RequestOptions]
  }
}
