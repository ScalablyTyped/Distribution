...
trait OauthAuthorizationsRevokeGrantForApplication_RequestOptions extends js.Object {
...
object OauthAuthorizationsRevokeGrantForApplication_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsRevokeGrantForApplication_RequestOptions]
  }
}
