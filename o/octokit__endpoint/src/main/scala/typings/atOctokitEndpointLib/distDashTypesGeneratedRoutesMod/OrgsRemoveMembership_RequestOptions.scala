...
trait OrgsRemoveMembership_RequestOptions extends js.Object {
...
object OrgsRemoveMembership_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsRemoveMembership_RequestOptions]
  }
}
