...
trait AppsListMarketplacePurchasesForAuthenticatedUserStubbedRequestOptions extends js.Object {
...
object AppsListMarketplacePurchasesForAuthenticatedUserStubbedRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListMarketplacePurchasesForAuthenticatedUserStubbedRequestOptions]
  }
}
