...
trait ActivityListEventsForOrg_RequestOptions extends js.Object {
...
object ActivityListEventsForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListEventsForOrg_RequestOptions]
  }
}
