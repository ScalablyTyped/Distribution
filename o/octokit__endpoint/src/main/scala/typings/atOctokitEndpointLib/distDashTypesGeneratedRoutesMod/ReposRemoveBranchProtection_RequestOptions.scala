...
trait ReposRemoveBranchProtection_RequestOptions extends js.Object {
...
object ReposRemoveBranchProtection_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRemoveBranchProtection_RequestOptions]
  }
}
