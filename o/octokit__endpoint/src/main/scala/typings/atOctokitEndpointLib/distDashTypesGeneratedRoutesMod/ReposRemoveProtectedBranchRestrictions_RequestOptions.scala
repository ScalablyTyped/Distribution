...
trait ReposRemoveProtectedBranchRestrictions_RequestOptions extends js.Object {
...
object ReposRemoveProtectedBranchRestrictions_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRemoveProtectedBranchRestrictions_RequestOptions]
  }
}
