...
trait ProjectsAddCollaborator_RequestOptions extends js.Object {
...
object ProjectsAddCollaborator_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsAddCollaborator_RequestOptions]
  }
}
