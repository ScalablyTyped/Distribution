...
trait TeamsDeleteDiscussionComment_RequestOptions extends js.Object {
...
object TeamsDeleteDiscussionComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsDeleteDiscussionComment_RequestOptions]
  }
}
