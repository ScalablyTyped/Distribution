...
trait ActivityListRepoEvents_RequestOptions extends js.Object {
...
object ActivityListRepoEvents_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListRepoEvents_RequestOptions]
  }
}
