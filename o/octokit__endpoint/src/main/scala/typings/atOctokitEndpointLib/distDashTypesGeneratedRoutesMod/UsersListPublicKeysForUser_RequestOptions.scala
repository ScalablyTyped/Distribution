...
trait UsersListPublicKeysForUser_RequestOptions extends js.Object {
...
object UsersListPublicKeysForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersListPublicKeysForUser_RequestOptions]
  }
}
