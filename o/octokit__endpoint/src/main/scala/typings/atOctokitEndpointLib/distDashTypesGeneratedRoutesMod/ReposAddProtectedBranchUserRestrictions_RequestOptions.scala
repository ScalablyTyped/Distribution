...
trait ReposAddProtectedBranchUserRestrictions_RequestOptions extends js.Object {
...
object ReposAddProtectedBranchUserRestrictions_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposAddProtectedBranchUserRestrictions_RequestOptions]
  }
}
