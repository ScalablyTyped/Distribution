...
trait ReactionsListForTeamDiscussionComment_RequestOptions extends js.Object {
...
object ReactionsListForTeamDiscussionComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsListForTeamDiscussionComment_RequestOptions]
  }
}
