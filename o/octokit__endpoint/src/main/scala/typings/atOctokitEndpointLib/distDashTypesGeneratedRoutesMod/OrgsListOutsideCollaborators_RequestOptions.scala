...
trait OrgsListOutsideCollaborators_RequestOptions extends js.Object {
...
object OrgsListOutsideCollaborators_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsListOutsideCollaborators_RequestOptions]
  }
}
