...
trait ProjectsRemoveCollaborator_RequestOptions extends js.Object {
...
object ProjectsRemoveCollaborator_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsRemoveCollaborator_RequestOptions]
  }
}
