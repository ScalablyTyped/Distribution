...
trait AppsAddRepoToInstallation_RequestOptions extends js.Object {
...
object AppsAddRepoToInstallation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsAddRepoToInstallation_RequestOptions]
  }
}
