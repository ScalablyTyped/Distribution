...
trait AppsListInstallations_RequestOptions extends js.Object {
...
object AppsListInstallations_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListInstallations_RequestOptions]
  }
}
