...
trait ReposGetCollaboratorPermissionLevel_RequestOptions extends js.Object {
...
object ReposGetCollaboratorPermissionLevel_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetCollaboratorPermissionLevel_RequestOptions]
  }
}
