...
trait ReposGetPunchCardStatsRequestOptions extends js.Object {
...
object ReposGetPunchCardStatsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetPunchCardStatsRequestOptions]
  }
}
