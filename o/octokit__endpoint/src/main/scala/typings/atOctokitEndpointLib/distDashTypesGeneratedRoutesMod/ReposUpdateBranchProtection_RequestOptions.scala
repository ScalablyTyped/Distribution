...
trait ReposUpdateBranchProtection_RequestOptions extends js.Object {
...
object ReposUpdateBranchProtection_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUpdateBranchProtection_RequestOptions]
  }
}
