...
trait ProjectsCreateForRepo_RequestOptions extends js.Object {
...
object ProjectsCreateForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsCreateForRepo_RequestOptions]
  }
}
