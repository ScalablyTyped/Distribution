...
trait ProjectsUpdateColumn_RequestOptions extends js.Object {
...
object ProjectsUpdateColumn_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsUpdateColumn_RequestOptions]
  }
}
