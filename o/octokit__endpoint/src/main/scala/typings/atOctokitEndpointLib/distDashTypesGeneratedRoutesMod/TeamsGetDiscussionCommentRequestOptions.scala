...
trait TeamsGetDiscussionCommentRequestOptions extends js.Object {
...
object TeamsGetDiscussionCommentRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsGetDiscussionCommentRequestOptions]
  }
}
