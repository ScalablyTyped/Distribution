...
trait UsersListPublicKeys_RequestOptions extends js.Object {
...
object UsersListPublicKeys_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersListPublicKeys_RequestOptions]
  }
}
