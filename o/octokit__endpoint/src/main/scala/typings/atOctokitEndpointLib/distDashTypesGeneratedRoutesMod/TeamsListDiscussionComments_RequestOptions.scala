...
trait TeamsListDiscussionComments_RequestOptions extends js.Object {
...
object TeamsListDiscussionComments_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsListDiscussionComments_RequestOptions]
  }
}
