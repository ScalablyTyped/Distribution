...
trait MigrationsStartImportRequestOptions extends js.Object {
...
object MigrationsStartImportRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsStartImportRequestOptions]
  }
}
