...
trait AppsCheckAccountIsAssociatedWithAny_RequestOptions extends js.Object {
...
object AppsCheckAccountIsAssociatedWithAny_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsCheckAccountIsAssociatedWithAny_RequestOptions]
  }
}
