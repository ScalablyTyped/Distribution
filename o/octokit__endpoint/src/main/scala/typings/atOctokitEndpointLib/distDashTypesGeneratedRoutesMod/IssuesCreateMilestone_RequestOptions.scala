...
trait IssuesCreateMilestone_RequestOptions extends js.Object {
...
object IssuesCreateMilestone_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesCreateMilestone_RequestOptions]
  }
}
