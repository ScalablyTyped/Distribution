...
trait TeamsAddOrUpdateRepo_RequestOptions extends js.Object {
...
object TeamsAddOrUpdateRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsAddOrUpdateRepo_RequestOptions]
  }
}
