...
trait ReposListProtectedBranchUserRestrictions_RequestOptions extends js.Object {
...
object ReposListProtectedBranchUserRestrictions_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListProtectedBranchUserRestrictions_RequestOptions]
  }
}
