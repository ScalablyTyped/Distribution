...
trait ReposCreateCommitComment_RequestOptions extends js.Object {
...
object ReposCreateCommitComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateCommitComment_RequestOptions]
  }
}
