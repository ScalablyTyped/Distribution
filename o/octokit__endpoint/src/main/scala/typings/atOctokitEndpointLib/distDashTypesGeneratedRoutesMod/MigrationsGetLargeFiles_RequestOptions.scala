...
trait MigrationsGetLargeFiles_RequestOptions extends js.Object {
...
object MigrationsGetLargeFiles_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsGetLargeFiles_RequestOptions]
  }
}
