...
trait UsersTogglePrimaryEmailVisibility_RequestOptions extends js.Object {
...
object UsersTogglePrimaryEmailVisibility_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersTogglePrimaryEmailVisibility_RequestOptions]
  }
}
