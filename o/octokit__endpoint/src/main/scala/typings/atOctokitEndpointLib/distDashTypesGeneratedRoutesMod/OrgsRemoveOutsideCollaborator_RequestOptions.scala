...
trait OrgsRemoveOutsideCollaborator_RequestOptions extends js.Object {
...
object OrgsRemoveOutsideCollaborator_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsRemoveOutsideCollaborator_RequestOptions]
  }
}
