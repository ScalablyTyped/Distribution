...
trait AppsCheckAccountIsAssociatedWithAnyStubbed_RequestOptions extends js.Object {
...
object AppsCheckAccountIsAssociatedWithAnyStubbed_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsCheckAccountIsAssociatedWithAnyStubbed_RequestOptions]
  }
}
