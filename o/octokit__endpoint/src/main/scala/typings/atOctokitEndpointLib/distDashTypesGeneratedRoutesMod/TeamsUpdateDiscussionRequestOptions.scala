...
trait TeamsUpdateDiscussionRequestOptions extends js.Object {
...
object TeamsUpdateDiscussionRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsUpdateDiscussionRequestOptions]
  }
}
