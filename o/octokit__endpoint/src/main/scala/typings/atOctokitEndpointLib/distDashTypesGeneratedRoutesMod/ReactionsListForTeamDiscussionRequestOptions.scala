...
trait ReactionsListForTeamDiscussionRequestOptions extends js.Object {
...
object ReactionsListForTeamDiscussionRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsListForTeamDiscussionRequestOptions]
  }
}
