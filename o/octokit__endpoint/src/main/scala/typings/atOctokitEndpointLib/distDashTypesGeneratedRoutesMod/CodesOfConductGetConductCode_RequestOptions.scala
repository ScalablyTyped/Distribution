...
trait CodesOfConductGetConductCode_RequestOptions extends js.Object {
...
object CodesOfConductGetConductCode_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[CodesOfConductGetConductCode_RequestOptions]
  }
}
