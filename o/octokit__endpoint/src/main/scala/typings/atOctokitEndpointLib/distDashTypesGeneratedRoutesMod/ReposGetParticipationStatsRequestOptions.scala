...
trait ReposGetParticipationStatsRequestOptions extends js.Object {
...
object ReposGetParticipationStatsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetParticipationStatsRequestOptions]
  }
}
