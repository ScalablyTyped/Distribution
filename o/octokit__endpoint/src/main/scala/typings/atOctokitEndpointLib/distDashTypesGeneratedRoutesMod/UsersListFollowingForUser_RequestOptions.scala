...
trait UsersListFollowingForUser_RequestOptions extends js.Object {
...
object UsersListFollowingForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersListFollowingForUser_RequestOptions]
  }
}
