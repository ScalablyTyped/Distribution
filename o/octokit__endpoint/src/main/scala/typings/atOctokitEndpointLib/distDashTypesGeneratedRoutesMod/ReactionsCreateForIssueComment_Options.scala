...
trait ReactionsCreateForIssueComment_Options extends js.Object {
...
object ReactionsCreateForIssueComment_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsCreateForIssueComment_Options]
  }
}
