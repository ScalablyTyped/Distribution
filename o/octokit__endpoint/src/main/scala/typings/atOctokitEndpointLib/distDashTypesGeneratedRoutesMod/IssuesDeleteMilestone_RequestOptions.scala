...
trait IssuesDeleteMilestone_RequestOptions extends js.Object {
...
object IssuesDeleteMilestone_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesDeleteMilestone_RequestOptions]
  }
}
