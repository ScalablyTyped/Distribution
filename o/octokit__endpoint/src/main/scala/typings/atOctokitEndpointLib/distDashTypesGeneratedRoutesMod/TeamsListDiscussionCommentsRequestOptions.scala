...
trait TeamsListDiscussionCommentsRequestOptions extends js.Object {
...
object TeamsListDiscussionCommentsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsListDiscussionCommentsRequestOptions]
  }
}
