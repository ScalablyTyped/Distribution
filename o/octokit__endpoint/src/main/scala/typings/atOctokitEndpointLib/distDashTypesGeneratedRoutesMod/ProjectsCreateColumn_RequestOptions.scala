...
trait ProjectsCreateColumn_RequestOptions extends js.Object {
...
object ProjectsCreateColumn_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsCreateColumn_RequestOptions]
  }
}
