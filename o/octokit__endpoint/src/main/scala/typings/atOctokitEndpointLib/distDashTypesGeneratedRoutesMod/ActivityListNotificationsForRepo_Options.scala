...
trait ActivityListNotificationsForRepo_Options extends js.Object {
...
object ActivityListNotificationsForRepo_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListNotificationsForRepo_Options]
  }
}
