...
trait ReposRemoveProtectedBranchRequiredStatusChecksContextsRequestOptions extends js.Object {
...
object ReposRemoveProtectedBranchRequiredStatusChecksContextsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRemoveProtectedBranchRequiredStatusChecksContextsRequestOptions]
  }
}
