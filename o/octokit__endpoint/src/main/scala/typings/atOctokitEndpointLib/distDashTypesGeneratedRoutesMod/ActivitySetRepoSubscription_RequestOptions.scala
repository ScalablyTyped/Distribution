...
trait ActivitySetRepoSubscription_RequestOptions extends js.Object {
...
object ActivitySetRepoSubscription_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivitySetRepoSubscription_RequestOptions]
  }
}
