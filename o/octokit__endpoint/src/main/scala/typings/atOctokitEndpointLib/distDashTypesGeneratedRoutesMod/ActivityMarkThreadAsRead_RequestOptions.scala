...
trait ActivityMarkThreadAsRead_RequestOptions extends js.Object {
...
object ActivityMarkThreadAsRead_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityMarkThreadAsRead_RequestOptions]
  }
}
