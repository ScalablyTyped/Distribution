...
trait AppsListAccountsUserOrOrgOnPlan_RequestOptions extends js.Object {
...
object AppsListAccountsUserOrOrgOnPlan_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListAccountsUserOrOrgOnPlan_RequestOptions]
  }
}
