...
trait AppsGetInstallation_RequestOptions extends js.Object {
...
object AppsGetInstallation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsGetInstallation_RequestOptions]
  }
}
