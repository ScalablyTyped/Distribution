...
trait OrgsListCredentialAuthorizations_RequestOptions extends js.Object {
...
object OrgsListCredentialAuthorizations_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsListCredentialAuthorizations_RequestOptions]
  }
}
