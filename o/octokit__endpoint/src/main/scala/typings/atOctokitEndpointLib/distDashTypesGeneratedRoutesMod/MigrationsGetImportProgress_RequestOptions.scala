...
trait MigrationsGetImportProgress_RequestOptions extends js.Object {
...
object MigrationsGetImportProgress_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsGetImportProgress_RequestOptions]
  }
}
