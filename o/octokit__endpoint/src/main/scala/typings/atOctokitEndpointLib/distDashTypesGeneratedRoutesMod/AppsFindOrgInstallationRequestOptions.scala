...
trait AppsFindOrgInstallationRequestOptions extends js.Object {
...
object AppsFindOrgInstallationRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsFindOrgInstallationRequestOptions]
  }
}
