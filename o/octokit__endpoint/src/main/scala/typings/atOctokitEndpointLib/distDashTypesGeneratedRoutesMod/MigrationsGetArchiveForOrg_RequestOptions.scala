...
trait MigrationsGetArchiveForOrg_RequestOptions extends js.Object {
...
object MigrationsGetArchiveForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsGetArchiveForOrg_RequestOptions]
  }
}
