...
trait TeamsAddOrUpdateProject_RequestOptions extends js.Object {
...
object TeamsAddOrUpdateProject_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsAddOrUpdateProject_RequestOptions]
  }
}
