...
trait OrgsRemoveCredentialAuthorization_RequestOptions extends js.Object {
...
object OrgsRemoveCredentialAuthorization_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsRemoveCredentialAuthorization_RequestOptions]
  }
}
