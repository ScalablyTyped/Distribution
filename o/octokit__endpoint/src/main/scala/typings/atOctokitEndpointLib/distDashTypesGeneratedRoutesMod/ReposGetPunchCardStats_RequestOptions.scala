...
trait ReposGetPunchCardStats_RequestOptions extends js.Object {
...
object ReposGetPunchCardStats_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetPunchCardStats_RequestOptions]
  }
}
