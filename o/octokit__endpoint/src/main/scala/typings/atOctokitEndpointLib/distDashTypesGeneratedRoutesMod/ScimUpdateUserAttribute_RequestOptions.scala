...
trait ScimUpdateUserAttribute_RequestOptions extends js.Object {
...
object ScimUpdateUserAttribute_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ScimUpdateUserAttribute_RequestOptions]
  }
}
