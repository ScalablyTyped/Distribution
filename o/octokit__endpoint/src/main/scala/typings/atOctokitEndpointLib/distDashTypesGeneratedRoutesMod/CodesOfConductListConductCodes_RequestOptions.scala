...
trait CodesOfConductListConductCodes_RequestOptions extends js.Object {
...
object CodesOfConductListConductCodes_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[CodesOfConductListConductCodes_RequestOptions]
  }
}
