...
trait ReactionsListForTeamDiscussionComment_Options extends js.Object {
...
object ReactionsListForTeamDiscussionComment_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsListForTeamDiscussionComment_Options]
  }
}
