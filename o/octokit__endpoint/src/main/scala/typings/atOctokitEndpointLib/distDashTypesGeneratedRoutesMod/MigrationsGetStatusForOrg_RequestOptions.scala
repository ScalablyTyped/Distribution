...
trait MigrationsGetStatusForOrg_RequestOptions extends js.Object {
...
object MigrationsGetStatusForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsGetStatusForOrg_RequestOptions]
  }
}
