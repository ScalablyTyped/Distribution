...
trait ScimListProvisionedIdentities_RequestOptions extends js.Object {
...
object ScimListProvisionedIdentities_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ScimListProvisionedIdentities_RequestOptions]
  }
}
