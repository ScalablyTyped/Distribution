...
trait ReposListInvitationsForAuthenticatedUser_RequestOptions extends js.Object {
...
object ReposListInvitationsForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListInvitationsForAuthenticatedUser_RequestOptions]
  }
}
