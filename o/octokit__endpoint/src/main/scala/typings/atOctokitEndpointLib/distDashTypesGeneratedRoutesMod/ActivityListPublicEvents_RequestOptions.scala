...
trait ActivityListPublicEvents_RequestOptions extends js.Object {
...
object ActivityListPublicEvents_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListPublicEvents_RequestOptions]
  }
}
