...
trait ReposReplaceProtectedBranchUserRestrictions_RequestOptions extends js.Object {
...
object ReposReplaceProtectedBranchUserRestrictions_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposReplaceProtectedBranchUserRestrictions_RequestOptions]
  }
}
