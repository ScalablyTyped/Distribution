...
trait OauthAuthorizationsGetOrCreateAuthorizationForApp_RequestOptions extends js.Object {
...
object OauthAuthorizationsGetOrCreateAuthorizationForApp_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetOrCreateAuthorizationForApp_RequestOptions]
  }
}
