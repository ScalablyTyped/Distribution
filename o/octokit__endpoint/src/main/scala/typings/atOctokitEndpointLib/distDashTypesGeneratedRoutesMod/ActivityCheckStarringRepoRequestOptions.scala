...
trait ActivityCheckStarringRepoRequestOptions extends js.Object {
...
object ActivityCheckStarringRepoRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityCheckStarringRepoRequestOptions]
  }
}
