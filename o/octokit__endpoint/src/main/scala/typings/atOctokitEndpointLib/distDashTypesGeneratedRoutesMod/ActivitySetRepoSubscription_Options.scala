...
trait ActivitySetRepoSubscription_Options extends js.Object {
...
object ActivitySetRepoSubscription_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivitySetRepoSubscription_Options]
  }
}
