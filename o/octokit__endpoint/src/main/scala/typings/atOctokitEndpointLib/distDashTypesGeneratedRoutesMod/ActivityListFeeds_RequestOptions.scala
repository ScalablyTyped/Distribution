...
trait ActivityListFeeds_RequestOptions extends js.Object {
...
object ActivityListFeeds_RequestOptions {
  @scala.inline
  def apply(
  ...
  ): ActivityListFeeds_RequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ActivityListFeeds_RequestOptions]
  }
}
