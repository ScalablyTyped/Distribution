...
trait ReposCompareCommits_RequestOptions extends js.Object {
...
object ReposCompareCommits_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCompareCommits_RequestOptions]
  }
}
