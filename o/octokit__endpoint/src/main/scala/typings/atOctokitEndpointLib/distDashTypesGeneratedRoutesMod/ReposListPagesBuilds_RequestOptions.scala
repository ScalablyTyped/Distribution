...
trait ReposListPagesBuilds_RequestOptions extends js.Object {
...
object ReposListPagesBuilds_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListPagesBuilds_RequestOptions]
  }
}
