...
trait ReposGetProtectedBranchRestrictions_RequestOptions extends js.Object {
...
object ReposGetProtectedBranchRestrictions_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchRestrictions_RequestOptions]
  }
}
