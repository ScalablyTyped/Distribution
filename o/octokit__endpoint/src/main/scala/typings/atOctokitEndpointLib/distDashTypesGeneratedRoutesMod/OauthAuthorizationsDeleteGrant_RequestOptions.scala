...
trait OauthAuthorizationsDeleteGrant_RequestOptions extends js.Object {
...
object OauthAuthorizationsDeleteGrant_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsDeleteGrant_RequestOptions]
  }
}
