...
trait IssuesCheckAssignee_RequestOptions extends js.Object {
...
object IssuesCheckAssignee_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesCheckAssignee_RequestOptions]
  }
}
