...
trait ScimProvisionInviteUsersRequestOptions extends js.Object {
...
object ScimProvisionInviteUsersRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ScimProvisionInviteUsersRequestOptions]
  }
}
