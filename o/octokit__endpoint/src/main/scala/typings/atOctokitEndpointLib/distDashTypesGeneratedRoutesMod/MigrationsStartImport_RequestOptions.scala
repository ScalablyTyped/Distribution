...
trait MigrationsStartImport_RequestOptions extends js.Object {
...
object MigrationsStartImport_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsStartImport_RequestOptions]
  }
}
