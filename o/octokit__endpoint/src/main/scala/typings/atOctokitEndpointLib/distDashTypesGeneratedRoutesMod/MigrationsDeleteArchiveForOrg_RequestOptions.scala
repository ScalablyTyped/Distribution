...
trait MigrationsDeleteArchiveForOrg_RequestOptions extends js.Object {
...
object MigrationsDeleteArchiveForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsDeleteArchiveForOrg_RequestOptions]
  }
}
