...
trait OrgsListMemberships_RequestOptions extends js.Object {
...
object OrgsListMemberships_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsListMemberships_RequestOptions]
  }
}
