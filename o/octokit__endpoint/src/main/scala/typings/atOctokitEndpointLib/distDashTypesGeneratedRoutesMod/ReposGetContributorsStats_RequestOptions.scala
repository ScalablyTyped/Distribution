...
trait ReposGetContributorsStats_RequestOptions extends js.Object {
...
object ReposGetContributorsStats_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetContributorsStats_RequestOptions]
  }
}
