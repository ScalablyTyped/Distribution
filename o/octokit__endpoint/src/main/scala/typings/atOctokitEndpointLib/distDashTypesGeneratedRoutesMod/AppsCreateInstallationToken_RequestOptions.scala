...
trait AppsCreateInstallationToken_RequestOptions extends js.Object {
...
object AppsCreateInstallationToken_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsCreateInstallationToken_RequestOptions]
  }
}
