...
trait ProjectsReviewUserPermissionLevel_RequestOptions extends js.Object {
...
object ProjectsReviewUserPermissionLevel_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsReviewUserPermissionLevel_RequestOptions]
  }
}
