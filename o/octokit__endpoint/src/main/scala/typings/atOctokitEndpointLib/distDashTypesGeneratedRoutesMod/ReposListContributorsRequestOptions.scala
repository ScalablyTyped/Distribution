...
trait ReposListContributorsRequestOptions extends js.Object {
...
object ReposListContributorsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListContributorsRequestOptions]
  }
}
