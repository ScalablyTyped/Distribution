...
trait AppsDeleteInstallation_RequestOptions extends js.Object {
...
object AppsDeleteInstallation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsDeleteInstallation_RequestOptions]
  }
}
