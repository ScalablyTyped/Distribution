...
trait ReposCheckCollaborator_RequestOptions extends js.Object {
...
object ReposCheckCollaborator_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCheckCollaborator_RequestOptions]
  }
}
