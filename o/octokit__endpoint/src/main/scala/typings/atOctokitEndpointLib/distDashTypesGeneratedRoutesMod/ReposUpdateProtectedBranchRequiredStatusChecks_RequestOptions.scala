...
trait ReposUpdateProtectedBranchRequiredStatusChecks_RequestOptions extends js.Object {
...
object ReposUpdateProtectedBranchRequiredStatusChecks_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUpdateProtectedBranchRequiredStatusChecks_RequestOptions]
  }
}
