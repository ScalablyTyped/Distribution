...
trait MigrationsListForOrg_RequestOptions extends js.Object {
...
object MigrationsListForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsListForOrg_RequestOptions]
  }
}
