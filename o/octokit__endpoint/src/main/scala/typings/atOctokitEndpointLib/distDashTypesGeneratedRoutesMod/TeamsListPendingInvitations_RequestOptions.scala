...
trait TeamsListPendingInvitations_RequestOptions extends js.Object {
...
object TeamsListPendingInvitations_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsListPendingInvitations_RequestOptions]
  }
}
