...
trait ChecksListSuitesForRef_RequestOptions extends js.Object {
...
object ChecksListSuitesForRef_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ChecksListSuitesForRef_RequestOptions]
  }
}
