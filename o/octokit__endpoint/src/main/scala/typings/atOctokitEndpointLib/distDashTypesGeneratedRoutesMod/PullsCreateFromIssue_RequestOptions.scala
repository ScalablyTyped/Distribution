...
trait PullsCreateFromIssue_RequestOptions extends js.Object {
...
object PullsCreateFromIssue_RequestOptions {
  @scala.inline
  def apply(
  ...
  ): PullsCreateFromIssue_RequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[PullsCreateFromIssue_RequestOptions]
  }
}
