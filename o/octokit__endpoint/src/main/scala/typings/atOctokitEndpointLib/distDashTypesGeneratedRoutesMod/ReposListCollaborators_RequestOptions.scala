...
trait ReposListCollaborators_RequestOptions extends js.Object {
...
object ReposListCollaborators_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListCollaborators_RequestOptions]
  }
}
