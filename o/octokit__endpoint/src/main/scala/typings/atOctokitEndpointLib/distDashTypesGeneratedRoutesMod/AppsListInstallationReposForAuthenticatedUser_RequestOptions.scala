...
trait AppsListInstallationReposForAuthenticatedUser_RequestOptions extends js.Object {
...
object AppsListInstallationReposForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListInstallationReposForAuthenticatedUser_RequestOptions]
  }
}
