...
trait ReposGetReleaseAsset_RequestOptions extends js.Object {
...
object ReposGetReleaseAsset_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetReleaseAsset_RequestOptions]
  }
}
