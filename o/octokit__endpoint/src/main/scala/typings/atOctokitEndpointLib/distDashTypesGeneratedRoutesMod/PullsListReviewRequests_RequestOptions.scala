...
trait PullsListReviewRequests_RequestOptions extends js.Object {
...
object PullsListReviewRequests_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsListReviewRequests_RequestOptions]
  }
}
