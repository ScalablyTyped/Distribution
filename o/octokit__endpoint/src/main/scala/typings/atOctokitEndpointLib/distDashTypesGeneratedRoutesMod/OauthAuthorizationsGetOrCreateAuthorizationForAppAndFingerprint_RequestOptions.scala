...
trait OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprint_RequestOptions extends js.Object {
...
object OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprint_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprint_RequestOptions]
  }
}
