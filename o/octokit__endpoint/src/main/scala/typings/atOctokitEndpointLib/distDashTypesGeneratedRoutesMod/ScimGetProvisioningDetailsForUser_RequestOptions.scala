...
trait ScimGetProvisioningDetailsForUser_RequestOptions extends js.Object {
...
object ScimGetProvisioningDetailsForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ScimGetProvisioningDetailsForUser_RequestOptions]
  }
}
