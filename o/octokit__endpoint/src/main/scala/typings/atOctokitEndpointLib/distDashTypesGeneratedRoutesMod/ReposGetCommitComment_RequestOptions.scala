...
trait ReposGetCommitComment_RequestOptions extends js.Object {
...
object ReposGetCommitComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetCommitComment_RequestOptions]
  }
}
