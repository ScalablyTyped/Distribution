...
trait AppsFindUserInstallationRequestOptions extends js.Object {
...
object AppsFindUserInstallationRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsFindUserInstallationRequestOptions]
  }
}
