...
trait AppsListAccountsUserOrOrgOnPlanStubbed_Options extends js.Object {
...
object AppsListAccountsUserOrOrgOnPlanStubbed_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListAccountsUserOrOrgOnPlanStubbed_Options]
  }
}
