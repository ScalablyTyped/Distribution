...
trait ActivityListEventsForUser_RequestOptions extends js.Object {
...
object ActivityListEventsForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListEventsForUser_RequestOptions]
  }
}
