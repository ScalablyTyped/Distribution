...
trait ReposGetCodeFrequencyStats_RequestOptions extends js.Object {
...
object ReposGetCodeFrequencyStats_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetCodeFrequencyStats_RequestOptions]
  }
}
