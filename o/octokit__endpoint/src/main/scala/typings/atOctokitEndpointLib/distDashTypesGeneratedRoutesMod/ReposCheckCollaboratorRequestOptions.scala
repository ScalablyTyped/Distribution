...
trait ReposCheckCollaboratorRequestOptions extends js.Object {
...
object ReposCheckCollaboratorRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCheckCollaboratorRequestOptions]
  }
}
