...
trait AppsFindUserInstallation_RequestOptions extends js.Object {
...
object AppsFindUserInstallation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsFindUserInstallation_RequestOptions]
  }
}
