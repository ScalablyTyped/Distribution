...
trait MigrationsStartForAuthenticatedUser_RequestOptions extends js.Object {
...
object MigrationsStartForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsStartForAuthenticatedUser_RequestOptions]
  }
}
