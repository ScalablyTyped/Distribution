...
trait AppsGetAuthenticated_RequestOptions extends js.Object {
...
object AppsGetAuthenticated_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsGetAuthenticated_RequestOptions]
  }
}
