...
trait ActivityMarkNotificationsAsReadForRepo_RequestOptions extends js.Object {
...
object ActivityMarkNotificationsAsReadForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityMarkNotificationsAsReadForRepo_RequestOptions]
  }
}
