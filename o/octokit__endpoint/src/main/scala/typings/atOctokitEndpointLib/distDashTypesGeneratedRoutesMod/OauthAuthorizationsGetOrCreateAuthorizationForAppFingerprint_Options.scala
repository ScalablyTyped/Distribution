...
trait OauthAuthorizationsGetOrCreateAuthorizationForAppFingerprint_Options extends js.Object {
...
object OauthAuthorizationsGetOrCreateAuthorizationForAppFingerprint_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetOrCreateAuthorizationForAppFingerprint_Options]
  }
}
