...
trait MigrationsUnlockRepoForOrg_RequestOptions extends js.Object {
...
object MigrationsUnlockRepoForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsUnlockRepoForOrg_RequestOptions]
  }
}
