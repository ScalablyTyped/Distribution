...
trait ActivityListWatchedReposForAuthenticatedUser_RequestOptions extends js.Object {
...
object ActivityListWatchedReposForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListWatchedReposForAuthenticatedUser_RequestOptions]
  }
}
