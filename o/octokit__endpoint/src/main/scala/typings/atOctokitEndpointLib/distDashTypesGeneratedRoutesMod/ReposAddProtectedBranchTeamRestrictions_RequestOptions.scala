...
trait ReposAddProtectedBranchTeamRestrictions_RequestOptions extends js.Object {
...
object ReposAddProtectedBranchTeamRestrictions_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposAddProtectedBranchTeamRestrictions_RequestOptions]
  }
}
