...
trait MigrationsGetCommitAuthors_RequestOptions extends js.Object {
...
object MigrationsGetCommitAuthors_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsGetCommitAuthors_RequestOptions]
  }
}
