...
trait PullsDeletePendingReview_RequestOptions extends js.Object {
...
object PullsDeletePendingReview_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsDeletePendingReview_RequestOptions]
  }
}
