...
trait PullsCreateFromIssue_Options extends js.Object {
...
object PullsCreateFromIssue_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateFromIssue_Options]
  }
}
