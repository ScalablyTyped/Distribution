...
trait PullsCreateCommentReply_Options extends js.Object {
...
object PullsCreateCommentReply_Options {
  @scala.inline
  def apply(
  ...
  ): PullsCreateCommentReply_Options = {
    ...
    __obj.asInstanceOf[PullsCreateCommentReply_Options]
  }
}
