...
trait OrgsListPublicMembers_RequestOptions extends js.Object {
...
object OrgsListPublicMembers_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsListPublicMembers_RequestOptions]
  }
}
