...
trait ProjectsListCollaborators_RequestOptions extends js.Object {
...
object ProjectsListCollaborators_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsListCollaborators_RequestOptions]
  }
}
