...
trait ReposListBranchesForHeadCommit_RequestOptions extends js.Object {
...
object ReposListBranchesForHeadCommit_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListBranchesForHeadCommit_RequestOptions]
  }
}
