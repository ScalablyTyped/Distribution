...
trait AppsCreateContentAttachment_RequestOptions extends js.Object {
...
object AppsCreateContentAttachment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsCreateContentAttachment_RequestOptions]
  }
}
