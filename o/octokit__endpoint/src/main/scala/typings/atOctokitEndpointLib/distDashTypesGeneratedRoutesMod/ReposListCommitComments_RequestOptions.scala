...
trait ReposListCommitComments_RequestOptions extends js.Object {
...
object ReposListCommitComments_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListCommitComments_RequestOptions]
  }
}
