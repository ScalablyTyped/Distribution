...
trait ReposUploadReleaseAsset_RequestOptions extends js.Object {
...
object ReposUploadReleaseAsset_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUploadReleaseAsset_RequestOptions]
  }
}
