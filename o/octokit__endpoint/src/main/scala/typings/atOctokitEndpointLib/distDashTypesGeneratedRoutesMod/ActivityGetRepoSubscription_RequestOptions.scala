...
trait ActivityGetRepoSubscription_RequestOptions extends js.Object {
...
object ActivityGetRepoSubscription_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityGetRepoSubscription_RequestOptions]
  }
}
