...
trait ReposListProtectedBranchTeamRestrictions_RequestOptions extends js.Object {
...
object ReposListProtectedBranchTeamRestrictions_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListProtectedBranchTeamRestrictions_RequestOptions]
  }
}
