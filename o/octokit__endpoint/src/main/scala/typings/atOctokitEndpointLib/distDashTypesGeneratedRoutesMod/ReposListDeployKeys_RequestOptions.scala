...
trait ReposListDeployKeys_RequestOptions extends js.Object {
...
object ReposListDeployKeys_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListDeployKeys_RequestOptions]
  }
}
