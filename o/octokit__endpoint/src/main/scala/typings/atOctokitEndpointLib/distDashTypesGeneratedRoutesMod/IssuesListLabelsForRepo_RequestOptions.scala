...
trait IssuesListLabelsForRepo_RequestOptions extends js.Object {
...
object IssuesListLabelsForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListLabelsForRepo_RequestOptions]
  }
}
