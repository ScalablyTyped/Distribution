...
trait ReposGetCommitRefSha_RequestOptions extends js.Object {
...
object ReposGetCommitRefSha_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetCommitRefSha_RequestOptions]
  }
}
