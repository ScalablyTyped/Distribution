...
trait PullsCreateCommentReply_RequestOptions extends js.Object {
...
object PullsCreateCommentReply_RequestOptions {
  @scala.inline
  def apply(
  ...
  ): PullsCreateCommentReply_RequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[PullsCreateCommentReply_RequestOptions]
  }
}
