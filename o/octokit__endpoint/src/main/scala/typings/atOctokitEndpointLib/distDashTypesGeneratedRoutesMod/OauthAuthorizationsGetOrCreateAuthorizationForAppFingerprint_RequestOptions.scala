...
trait OauthAuthorizationsGetOrCreateAuthorizationForAppFingerprint_RequestOptions extends js.Object {
...
object OauthAuthorizationsGetOrCreateAuthorizationForAppFingerprint_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsGetOrCreateAuthorizationForAppFingerprint_RequestOptions]
  }
}
