...
trait ReposCreateForAuthenticatedUser_Options extends js.Object {
...
object ReposCreateForAuthenticatedUser_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateForAuthenticatedUser_Options]
  }
}
