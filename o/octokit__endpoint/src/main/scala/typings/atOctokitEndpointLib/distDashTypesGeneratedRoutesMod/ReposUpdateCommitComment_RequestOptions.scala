...
trait ReposUpdateCommitComment_RequestOptions extends js.Object {
...
object ReposUpdateCommitComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUpdateCommitComment_RequestOptions]
  }
}
