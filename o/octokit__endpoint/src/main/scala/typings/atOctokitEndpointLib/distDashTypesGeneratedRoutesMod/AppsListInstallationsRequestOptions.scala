...
trait AppsListInstallationsRequestOptions extends js.Object {
...
object AppsListInstallationsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListInstallationsRequestOptions]
  }
}
