...
trait IssuesRemoveAssignees_RequestOptions extends js.Object {
...
object IssuesRemoveAssignees_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesRemoveAssignees_RequestOptions]
  }
}
