...
trait OauthAuthorizationsCreateAuthorization_RequestOptions extends js.Object {
...
object OauthAuthorizationsCreateAuthorization_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsCreateAuthorization_RequestOptions]
  }
}
