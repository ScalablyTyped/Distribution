...
trait AppsListAccountsUserOrOrgOnPlanStubbed_RequestOptions extends js.Object {
...
object AppsListAccountsUserOrOrgOnPlanStubbed_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsListAccountsUserOrOrgOnPlanStubbed_RequestOptions]
  }
}
