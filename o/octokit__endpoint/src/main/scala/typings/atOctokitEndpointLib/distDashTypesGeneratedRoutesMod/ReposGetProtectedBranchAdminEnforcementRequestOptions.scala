...
trait ReposGetProtectedBranchAdminEnforcementRequestOptions extends js.Object {
...
object ReposGetProtectedBranchAdminEnforcementRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchAdminEnforcementRequestOptions]
  }
}
