...
trait ReposListAssetsForReleaseRequestOptions extends js.Object {
...
object ReposListAssetsForReleaseRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListAssetsForReleaseRequestOptions]
  }
}
