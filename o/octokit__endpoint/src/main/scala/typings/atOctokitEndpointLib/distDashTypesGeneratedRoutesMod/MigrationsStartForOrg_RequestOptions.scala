...
trait MigrationsStartForOrg_RequestOptions extends js.Object {
...
object MigrationsStartForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsStartForOrg_RequestOptions]
  }
}
