...
trait AppsFindRepoInstallation_RequestOptions extends js.Object {
...
object AppsFindRepoInstallation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AppsFindRepoInstallation_RequestOptions]
  }
}
