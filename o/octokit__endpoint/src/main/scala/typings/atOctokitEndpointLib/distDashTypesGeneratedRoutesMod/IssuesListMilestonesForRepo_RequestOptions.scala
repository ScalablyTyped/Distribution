...
trait IssuesListMilestonesForRepo_RequestOptions extends js.Object {
...
object IssuesListMilestonesForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListMilestonesForRepo_RequestOptions]
  }
}
