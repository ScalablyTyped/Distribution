...
trait ReposUpdateProtectedBranchRequiredStatusChecksRequestOptions extends js.Object {
...
object ReposUpdateProtectedBranchRequiredStatusChecksRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposUpdateProtectedBranchRequiredStatusChecksRequestOptions]
  }
}
