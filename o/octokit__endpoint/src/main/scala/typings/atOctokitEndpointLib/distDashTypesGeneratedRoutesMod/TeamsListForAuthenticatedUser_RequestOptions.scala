...
trait TeamsListForAuthenticatedUser_RequestOptions extends js.Object {
...
object TeamsListForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsListForAuthenticatedUser_RequestOptions]
  }
}
