...
trait UsersCreatePublicKey_RequestOptions extends js.Object {
...
object UsersCreatePublicKey_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersCreatePublicKey_RequestOptions]
  }
}
