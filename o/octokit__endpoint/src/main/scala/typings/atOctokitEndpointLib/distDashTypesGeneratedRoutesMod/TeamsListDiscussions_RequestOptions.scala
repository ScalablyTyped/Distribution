...
trait TeamsListDiscussions_RequestOptions extends js.Object {
...
object TeamsListDiscussions_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsListDiscussions_RequestOptions]
  }
}
