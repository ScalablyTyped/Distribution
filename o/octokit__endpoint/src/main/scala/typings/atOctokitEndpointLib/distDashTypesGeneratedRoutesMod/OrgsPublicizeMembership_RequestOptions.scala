...
trait OrgsPublicizeMembership_RequestOptions extends js.Object {
...
object OrgsPublicizeMembership_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsPublicizeMembership_RequestOptions]
  }
}
