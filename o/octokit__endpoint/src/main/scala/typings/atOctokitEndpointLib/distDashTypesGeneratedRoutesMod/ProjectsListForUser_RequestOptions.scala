...
trait ProjectsListForUser_RequestOptions extends js.Object {
...
object ProjectsListForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsListForUser_RequestOptions]
  }
}
