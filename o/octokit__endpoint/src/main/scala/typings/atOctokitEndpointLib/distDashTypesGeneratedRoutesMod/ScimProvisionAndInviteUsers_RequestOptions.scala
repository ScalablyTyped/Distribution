...
trait ScimProvisionAndInviteUsers_RequestOptions extends js.Object {
...
object ScimProvisionAndInviteUsers_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ScimProvisionAndInviteUsers_RequestOptions]
  }
}
