...
trait ReposGetProtectedBranchRestrictionsRequestOptions extends js.Object {
...
object ReposGetProtectedBranchRestrictionsRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchRestrictionsRequestOptions]
  }
}
