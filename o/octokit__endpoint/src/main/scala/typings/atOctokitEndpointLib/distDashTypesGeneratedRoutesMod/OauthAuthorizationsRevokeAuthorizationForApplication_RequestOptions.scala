...
trait OauthAuthorizationsRevokeAuthorizationForApplication_RequestOptions extends js.Object {
...
object OauthAuthorizationsRevokeAuthorizationForApplication_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsRevokeAuthorizationForApplication_RequestOptions]
  }
}
