...
trait MigrationsSetLfsPreference_RequestOptions extends js.Object {
...
object MigrationsSetLfsPreference_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsSetLfsPreference_RequestOptions]
  }
}
