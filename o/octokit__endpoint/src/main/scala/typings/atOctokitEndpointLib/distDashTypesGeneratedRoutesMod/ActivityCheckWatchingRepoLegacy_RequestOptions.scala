...
trait ActivityCheckWatchingRepoLegacy_RequestOptions extends js.Object {
...
object ActivityCheckWatchingRepoLegacy_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityCheckWatchingRepoLegacy_RequestOptions]
  }
}
