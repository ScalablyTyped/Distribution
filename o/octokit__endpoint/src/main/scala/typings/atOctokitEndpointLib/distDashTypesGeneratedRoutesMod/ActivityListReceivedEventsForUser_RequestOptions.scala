...
trait ActivityListReceivedEventsForUser_RequestOptions extends js.Object {
...
object ActivityListReceivedEventsForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListReceivedEventsForUser_RequestOptions]
  }
}
