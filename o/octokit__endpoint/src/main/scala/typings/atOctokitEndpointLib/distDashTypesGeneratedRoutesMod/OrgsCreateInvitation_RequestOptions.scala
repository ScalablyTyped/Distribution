...
trait OrgsCreateInvitation_RequestOptions extends js.Object {
...
object OrgsCreateInvitation_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsCreateInvitation_RequestOptions]
  }
}
