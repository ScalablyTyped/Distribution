...
trait ActivityListStargazersForRepo_RequestOptions extends js.Object {
...
object ActivityListStargazersForRepo_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityListStargazersForRepo_RequestOptions]
  }
}
