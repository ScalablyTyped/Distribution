...
trait ReposRemoveProtectedBranchAdminEnforcement_RequestOptions extends js.Object {
...
object ReposRemoveProtectedBranchAdminEnforcement_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposRemoveProtectedBranchAdminEnforcement_RequestOptions]
  }
}
