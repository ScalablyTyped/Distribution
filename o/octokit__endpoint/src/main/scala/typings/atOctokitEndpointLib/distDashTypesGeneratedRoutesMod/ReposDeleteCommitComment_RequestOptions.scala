...
trait ReposDeleteCommitComment_RequestOptions extends js.Object {
...
object ReposDeleteCommitComment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposDeleteCommitComment_RequestOptions]
  }
}
