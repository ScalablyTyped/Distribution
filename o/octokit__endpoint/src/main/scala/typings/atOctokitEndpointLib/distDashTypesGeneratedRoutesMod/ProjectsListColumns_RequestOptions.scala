...
trait ProjectsListColumns_RequestOptions extends js.Object {
...
object ProjectsListColumns_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsListColumns_RequestOptions]
  }
}
