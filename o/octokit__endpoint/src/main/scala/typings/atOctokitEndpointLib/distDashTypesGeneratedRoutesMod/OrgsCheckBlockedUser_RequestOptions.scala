...
trait OrgsCheckBlockedUser_RequestOptions extends js.Object {
...
object OrgsCheckBlockedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsCheckBlockedUser_RequestOptions]
  }
}
