...
trait ActivityDeleteThreadSubscription_RequestOptions extends js.Object {
...
object ActivityDeleteThreadSubscription_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ActivityDeleteThreadSubscription_RequestOptions]
  }
}
