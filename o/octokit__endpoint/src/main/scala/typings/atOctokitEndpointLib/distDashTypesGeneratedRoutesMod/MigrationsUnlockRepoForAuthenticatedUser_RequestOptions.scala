...
trait MigrationsUnlockRepoForAuthenticatedUser_RequestOptions extends js.Object {
...
object MigrationsUnlockRepoForAuthenticatedUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[MigrationsUnlockRepoForAuthenticatedUser_RequestOptions]
  }
}
