...
trait ReactionsListForTeamDiscussion_RequestOptions extends js.Object {
...
object ReactionsListForTeamDiscussion_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReactionsListForTeamDiscussion_RequestOptions]
  }
}
