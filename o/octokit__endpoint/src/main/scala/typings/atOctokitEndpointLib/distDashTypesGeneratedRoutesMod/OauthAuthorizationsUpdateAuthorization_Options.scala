...
trait OauthAuthorizationsUpdateAuthorization_Options extends js.Object {
...
object OauthAuthorizationsUpdateAuthorization_Options {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OauthAuthorizationsUpdateAuthorization_Options]
  }
}
