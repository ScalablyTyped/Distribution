...
trait UsersListFollowersForUser_RequestOptions extends js.Object {
...
object UsersListFollowersForUser_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[UsersListFollowersForUser_RequestOptions]
  }
}
