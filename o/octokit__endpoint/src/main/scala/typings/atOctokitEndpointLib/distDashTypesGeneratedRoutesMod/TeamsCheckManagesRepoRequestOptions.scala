...
trait TeamsCheckManagesRepoRequestOptions extends js.Object {
...
object TeamsCheckManagesRepoRequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoRequestOptions]
  }
}
