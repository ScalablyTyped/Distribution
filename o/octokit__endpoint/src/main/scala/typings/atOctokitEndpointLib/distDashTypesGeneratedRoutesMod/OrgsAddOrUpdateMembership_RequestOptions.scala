...
trait OrgsAddOrUpdateMembership_RequestOptions extends js.Object {
...
object OrgsAddOrUpdateMembership_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[OrgsAddOrUpdateMembership_RequestOptions]
  }
}
