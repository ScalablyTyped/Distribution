...
trait ReposGetLatestRelease_RequestOptions extends js.Object {
...
object ReposGetLatestRelease_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetLatestRelease_RequestOptions]
  }
}
