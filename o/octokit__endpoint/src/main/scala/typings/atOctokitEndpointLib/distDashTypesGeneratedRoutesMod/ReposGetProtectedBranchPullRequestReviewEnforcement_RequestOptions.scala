...
trait ReposGetProtectedBranchPullRequestReviewEnforcement_RequestOptions extends js.Object {
...
object ReposGetProtectedBranchPullRequestReviewEnforcement_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposGetProtectedBranchPullRequestReviewEnforcement_RequestOptions]
  }
}
