...
trait ReposCreateDeployment_RequestOptions extends js.Object {
...
object ReposCreateDeployment_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposCreateDeployment_RequestOptions]
  }
}
