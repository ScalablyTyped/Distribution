...
trait ReposAddCollaborator_RequestOptions extends js.Object {
...
object ReposAddCollaborator_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposAddCollaborator_RequestOptions]
  }
}
