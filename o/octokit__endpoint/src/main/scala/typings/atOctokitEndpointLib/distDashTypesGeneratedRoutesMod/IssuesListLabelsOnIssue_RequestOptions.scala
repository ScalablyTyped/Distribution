...
trait IssuesListLabelsOnIssue_RequestOptions extends js.Object {
...
object IssuesListLabelsOnIssue_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IssuesListLabelsOnIssue_RequestOptions]
  }
}
