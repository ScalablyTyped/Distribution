...
trait ProjectsCreateForOrg_RequestOptions extends js.Object {
...
object ProjectsCreateForOrg_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ProjectsCreateForOrg_RequestOptions]
  }
}
