...
trait ReposListStatusesForRef_RequestOptions extends js.Object {
...
object ReposListStatusesForRef_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReposListStatusesForRef_RequestOptions]
  }
}
