...
trait PullsCreateReviewRequest_RequestOptions extends js.Object {
...
object PullsCreateReviewRequest_RequestOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PullsCreateReviewRequest_RequestOptions]
  }
}
