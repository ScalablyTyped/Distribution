...
import typings.atOctokitEndpoint.Fn_Options
...
trait endpoint extends js.Object {
  ...
  @JSName("merge")
  var merge_Original: Fn_Options = js.native
  /**
  ...
  /**
    ...
    */
  def apply[R /* <: Route */](route: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 521 */ js.Any): RequestOptions | (/* import warning: ImportType.apply Failed type conversion: @octokit/endpoint.@octokit/endpoint/dist-types/generated/routes.Routes[R][1] */ js.Any) = js.native
  def apply[R /* <: Route */](
