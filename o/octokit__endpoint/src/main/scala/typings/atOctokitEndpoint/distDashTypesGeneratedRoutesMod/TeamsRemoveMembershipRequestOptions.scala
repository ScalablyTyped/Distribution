...
trait TeamsRemoveMembershipRequestOptions extends js.Object {
  var headers: Headers
  var method: DELETE
...
object TeamsRemoveMembershipRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: DELETE, request: EndpointRequestOptions, url: Url): TeamsRemoveMembershipRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[TeamsRemoveMembershipRequestOptions]
  }
}
