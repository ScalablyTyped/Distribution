...
trait OrgsListBlockedUsersRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object OrgsListBlockedUsersRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): OrgsListBlockedUsersRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[OrgsListBlockedUsersRequestOptions]
  }
}
