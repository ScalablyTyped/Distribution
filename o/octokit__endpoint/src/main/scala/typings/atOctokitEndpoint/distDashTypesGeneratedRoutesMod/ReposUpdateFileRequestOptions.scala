...
trait ReposUpdateFileRequestOptions extends js.Object {
  var headers: Headers
  var method: PUT
...
object ReposUpdateFileRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PUT, request: EndpointRequestOptions, url: Url): ReposUpdateFileRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ReposUpdateFileRequestOptions]
  }
}
