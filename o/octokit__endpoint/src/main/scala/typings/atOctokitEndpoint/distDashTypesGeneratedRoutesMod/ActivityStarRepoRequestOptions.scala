...
trait ActivityStarRepoRequestOptions extends js.Object {
  var headers: Headers
  var method: PUT
...
object ActivityStarRepoRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PUT, request: EndpointRequestOptions, url: Url): ActivityStarRepoRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ActivityStarRepoRequestOptions]
  }
}
