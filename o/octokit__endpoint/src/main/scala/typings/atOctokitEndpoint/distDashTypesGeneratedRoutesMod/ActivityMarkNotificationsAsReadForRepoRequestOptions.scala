...
trait ActivityMarkNotificationsAsReadForRepoRequestOptions extends js.Object {
  var headers: Headers
  var method: PUT
...
object ActivityMarkNotificationsAsReadForRepoRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PUT, request: EndpointRequestOptions, url: Url): ActivityMarkNotificationsAsReadForRepoRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ActivityMarkNotificationsAsReadForRepoRequestOptions]
  }
}
