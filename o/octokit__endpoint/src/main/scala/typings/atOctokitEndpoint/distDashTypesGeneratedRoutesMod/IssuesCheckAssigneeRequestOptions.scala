...
trait IssuesCheckAssigneeRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object IssuesCheckAssigneeRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): IssuesCheckAssigneeRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[IssuesCheckAssigneeRequestOptions]
  }
}
