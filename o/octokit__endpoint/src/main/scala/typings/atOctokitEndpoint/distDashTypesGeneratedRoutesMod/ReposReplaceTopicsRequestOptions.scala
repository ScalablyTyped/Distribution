...
trait ReposReplaceTopicsRequestOptions extends js.Object {
  var headers: Headers
  var method: PUT
...
object ReposReplaceTopicsRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PUT, request: EndpointRequestOptions, url: Url): ReposReplaceTopicsRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ReposReplaceTopicsRequestOptions]
  }
}
