...
trait ReposUpdateCommitCommentRequestOptions extends js.Object {
  var headers: Headers
  var method: PATCH
...
object ReposUpdateCommitCommentRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PATCH, request: EndpointRequestOptions, url: Url): ReposUpdateCommitCommentRequestOptions = {
