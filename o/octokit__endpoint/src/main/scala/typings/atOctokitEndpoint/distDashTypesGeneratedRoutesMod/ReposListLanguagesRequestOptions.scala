...
trait ReposListLanguagesRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object ReposListLanguagesRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): ReposListLanguagesRequestOptions = {
