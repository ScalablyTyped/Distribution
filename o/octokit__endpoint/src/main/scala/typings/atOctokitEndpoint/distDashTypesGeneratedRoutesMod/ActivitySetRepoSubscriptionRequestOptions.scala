...
trait ActivitySetRepoSubscriptionRequestOptions extends js.Object {
  var headers: Headers
  var method: PUT
...
object ActivitySetRepoSubscriptionRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PUT, request: EndpointRequestOptions, url: Url): ActivitySetRepoSubscriptionRequestOptions = {
