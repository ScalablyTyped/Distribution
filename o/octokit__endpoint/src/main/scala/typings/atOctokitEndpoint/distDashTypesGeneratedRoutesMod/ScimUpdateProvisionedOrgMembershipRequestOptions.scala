...
trait ScimUpdateProvisionedOrgMembershipRequestOptions extends js.Object {
  var headers: Headers
  var method: PUT
...
object ScimUpdateProvisionedOrgMembershipRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PUT, request: EndpointRequestOptions, url: Url): ScimUpdateProvisionedOrgMembershipRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ScimUpdateProvisionedOrgMembershipRequestOptions]
  }
}
