...
trait TeamsListDiscussionsRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object TeamsListDiscussionsRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): TeamsListDiscussionsRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[TeamsListDiscussionsRequestOptions]
  }
}
