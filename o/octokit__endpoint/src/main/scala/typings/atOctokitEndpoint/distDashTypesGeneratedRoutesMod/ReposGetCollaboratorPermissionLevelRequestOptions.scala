...
trait ReposGetCollaboratorPermissionLevelRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object ReposGetCollaboratorPermissionLevelRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): ReposGetCollaboratorPermissionLevelRequestOptions = {
