...
trait ReposReplaceProtectedBranchAppRestrictionsRequestOptions extends js.Object {
  var headers: Headers
  var method: PUT
...
object ReposReplaceProtectedBranchAppRestrictionsRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PUT, request: EndpointRequestOptions, url: Url): ReposReplaceProtectedBranchAppRestrictionsRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ReposReplaceProtectedBranchAppRestrictionsRequestOptions]
  }
}
