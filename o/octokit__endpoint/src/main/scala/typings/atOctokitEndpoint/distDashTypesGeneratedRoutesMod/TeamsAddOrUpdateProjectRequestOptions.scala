...
trait TeamsAddOrUpdateProjectRequestOptions extends js.Object {
  var headers: Headers
  var method: PUT
...
object TeamsAddOrUpdateProjectRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PUT, request: EndpointRequestOptions, url: Url): TeamsAddOrUpdateProjectRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[TeamsAddOrUpdateProjectRequestOptions]
  }
}
