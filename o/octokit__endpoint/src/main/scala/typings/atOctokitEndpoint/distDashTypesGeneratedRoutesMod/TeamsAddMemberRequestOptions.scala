...
trait TeamsAddMemberRequestOptions extends js.Object {
  var headers: Headers
  var method: PUT
...
object TeamsAddMemberRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PUT, request: EndpointRequestOptions, url: Url): TeamsAddMemberRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[TeamsAddMemberRequestOptions]
  }
}
