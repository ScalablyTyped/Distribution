...
trait ReactionsCreateForTeamDiscussionRequestOptions extends js.Object {
  var headers: Headers
  var method: POST
...
object ReactionsCreateForTeamDiscussionRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: POST, request: EndpointRequestOptions, url: Url): ReactionsCreateForTeamDiscussionRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ReactionsCreateForTeamDiscussionRequestOptions]
  }
}
