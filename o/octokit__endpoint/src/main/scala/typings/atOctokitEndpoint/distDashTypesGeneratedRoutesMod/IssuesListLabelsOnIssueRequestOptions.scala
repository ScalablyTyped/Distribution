...
trait IssuesListLabelsOnIssueRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object IssuesListLabelsOnIssueRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): IssuesListLabelsOnIssueRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[IssuesListLabelsOnIssueRequestOptions]
  }
}
