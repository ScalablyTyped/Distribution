...
trait ReposCreateDeploymentStatusRequestOptions extends js.Object {
  var headers: Headers
  var method: POST
...
object ReposCreateDeploymentStatusRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: POST, request: EndpointRequestOptions, url: Url): ReposCreateDeploymentStatusRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ReposCreateDeploymentStatusRequestOptions]
  }
}
