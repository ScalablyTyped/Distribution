...
trait ActivityListReposWatchedByUserRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object ActivityListReposWatchedByUserRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): ActivityListReposWatchedByUserRequestOptions = {
