...
trait SearchReposLegacyRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object SearchReposLegacyRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): SearchReposLegacyRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[SearchReposLegacyRequestOptions]
  }
}
