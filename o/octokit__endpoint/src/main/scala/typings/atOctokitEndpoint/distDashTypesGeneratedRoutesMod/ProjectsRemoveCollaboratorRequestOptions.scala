...
trait ProjectsRemoveCollaboratorRequestOptions extends js.Object {
  var headers: Headers
  var method: DELETE
...
object ProjectsRemoveCollaboratorRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: DELETE, request: EndpointRequestOptions, url: Url): ProjectsRemoveCollaboratorRequestOptions = {
