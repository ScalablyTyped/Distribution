...
trait ReposGetTeamsWithAccessToProtectedBranchRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object ReposGetTeamsWithAccessToProtectedBranchRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): ReposGetTeamsWithAccessToProtectedBranchRequestOptions = {
