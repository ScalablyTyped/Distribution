...
trait UsersListPublicEmailsRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object UsersListPublicEmailsRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): UsersListPublicEmailsRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[UsersListPublicEmailsRequestOptions]
  }
}
