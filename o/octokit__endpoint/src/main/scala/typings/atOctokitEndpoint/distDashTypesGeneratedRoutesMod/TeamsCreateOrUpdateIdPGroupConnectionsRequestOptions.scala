...
trait TeamsCreateOrUpdateIdPGroupConnectionsRequestOptions extends js.Object {
  var headers: Headers
  var method: PATCH
...
object TeamsCreateOrUpdateIdPGroupConnectionsRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PATCH, request: EndpointRequestOptions, url: Url): TeamsCreateOrUpdateIdPGroupConnectionsRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[TeamsCreateOrUpdateIdPGroupConnectionsRequestOptions]
  }
}
