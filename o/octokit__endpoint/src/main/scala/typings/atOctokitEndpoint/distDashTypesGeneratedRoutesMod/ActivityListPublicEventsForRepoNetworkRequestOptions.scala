...
trait ActivityListPublicEventsForRepoNetworkRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object ActivityListPublicEventsForRepoNetworkRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): ActivityListPublicEventsForRepoNetworkRequestOptions = {
