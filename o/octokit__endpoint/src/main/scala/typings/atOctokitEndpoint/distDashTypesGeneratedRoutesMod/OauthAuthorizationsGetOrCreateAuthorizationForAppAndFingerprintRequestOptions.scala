...
object OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PUT, request: EndpointRequestOptions, url: Url): OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequestOptions = {
