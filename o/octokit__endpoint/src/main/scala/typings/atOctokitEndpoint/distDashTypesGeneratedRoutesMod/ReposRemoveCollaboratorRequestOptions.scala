...
trait ReposRemoveCollaboratorRequestOptions extends js.Object {
  var headers: Headers
  var method: DELETE
...
object ReposRemoveCollaboratorRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: DELETE, request: EndpointRequestOptions, url: Url): ReposRemoveCollaboratorRequestOptions = {
