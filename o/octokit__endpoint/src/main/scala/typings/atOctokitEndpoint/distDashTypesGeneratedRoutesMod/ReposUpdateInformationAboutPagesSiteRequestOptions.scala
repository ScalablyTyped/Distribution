...
trait ReposUpdateInformationAboutPagesSiteRequestOptions extends js.Object {
  var headers: Headers
  var method: PUT
...
object ReposUpdateInformationAboutPagesSiteRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: PUT, request: EndpointRequestOptions, url: Url): ReposUpdateInformationAboutPagesSiteRequestOptions = {
