...
trait ReposGetDeploymentRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object ReposGetDeploymentRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): ReposGetDeploymentRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ReposGetDeploymentRequestOptions]
  }
}
