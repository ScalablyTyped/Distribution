...
trait ReposAddProtectedBranchUserRestrictionsRequestOptions extends js.Object {
  var headers: Headers
  var method: POST
...
object ReposAddProtectedBranchUserRestrictionsRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: POST, request: EndpointRequestOptions, url: Url): ReposAddProtectedBranchUserRestrictionsRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ReposAddProtectedBranchUserRestrictionsRequestOptions]
  }
}
