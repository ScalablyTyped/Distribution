...
trait OauthAuthorizationsDeleteGrantRequestOptions extends js.Object {
  var headers: Headers
  var method: DELETE
...
object OauthAuthorizationsDeleteGrantRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: DELETE, request: EndpointRequestOptions, url: Url): OauthAuthorizationsDeleteGrantRequestOptions = {
