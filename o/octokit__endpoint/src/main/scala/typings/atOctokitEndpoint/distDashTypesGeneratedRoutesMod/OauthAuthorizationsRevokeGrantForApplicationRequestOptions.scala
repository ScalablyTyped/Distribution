...
trait OauthAuthorizationsRevokeGrantForApplicationRequestOptions extends js.Object {
  var headers: Headers
  var method: DELETE
...
object OauthAuthorizationsRevokeGrantForApplicationRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: DELETE, request: EndpointRequestOptions, url: Url): OauthAuthorizationsRevokeGrantForApplicationRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[OauthAuthorizationsRevokeGrantForApplicationRequestOptions]
  }
}
