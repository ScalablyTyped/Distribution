...
trait GistsListPublicForUserRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object GistsListPublicForUserRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): GistsListPublicForUserRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[GistsListPublicForUserRequestOptions]
  }
}
