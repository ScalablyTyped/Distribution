...
trait CodesOfConductGetForRepoRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object CodesOfConductGetForRepoRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): CodesOfConductGetForRepoRequestOptions = {
