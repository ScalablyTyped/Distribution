...
trait ReposListPagesBuildsRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object ReposListPagesBuildsRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): ReposListPagesBuildsRequestOptions = {
    val __obj = js.Dynamic.literal(headers = headers, method = method, request = request, url = url)
  
    __obj.asInstanceOf[ReposListPagesBuildsRequestOptions]
  }
}
