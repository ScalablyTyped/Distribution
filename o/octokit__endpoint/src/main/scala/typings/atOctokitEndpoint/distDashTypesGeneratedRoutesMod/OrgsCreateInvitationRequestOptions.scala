...
trait OrgsCreateInvitationRequestOptions extends js.Object {
  var headers: Headers
  var method: POST
...
object OrgsCreateInvitationRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: POST, request: EndpointRequestOptions, url: Url): OrgsCreateInvitationRequestOptions = {
