...
trait ReposGetReleaseRequestOptions extends js.Object {
  var headers: Headers
  var method: GET
...
object ReposGetReleaseRequestOptions {
  @scala.inline
  def apply(headers: Headers, method: GET, request: EndpointRequestOptions, url: Url): ReposGetReleaseRequestOptions = {
