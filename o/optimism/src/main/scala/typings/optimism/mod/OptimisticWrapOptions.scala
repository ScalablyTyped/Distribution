...
object OptimisticWrapOptions {
  ...
  @scala.inline
  implicit class OptimisticWrapOptionsOps[Self <: OptimisticWrapOptions[_, _], TArgs /* <: js.Array[_] */, TKeyArgs /* <: js.Array[_] */] (val x: Self with (OptimisticWrapOptions[TArgs, TKeyArgs])) extends AnyVal {
