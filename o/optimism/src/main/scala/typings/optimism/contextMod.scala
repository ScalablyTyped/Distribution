...
object contextMod {
  ...
  /* import warning: parser.TsParser#tsDeclVar Dropped IArray(noContext) */ inline def bindContext[TArgs /* <: js.Array[js.Any] */, TResult](callback: js.Function1[/* args */ TArgs, TResult]): js.Function1[/* args */ TArgs, TResult] = ^.asInstanceOf[js.Dynamic].applyDynamic("bindContext")(callback.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* args */ TArgs, TResult]]
  ...
  object parentEntrySlot {
    ...
    inline def withValue[TResult, TArgs /* <: js.Array[js.Any] */, TThis](value: AnyEntry, callback: js.ThisFunction1[/* this */ TThis, /* args */ TArgs, TResult]): TResult = (^.asInstanceOf[js.Dynamic].applyDynamic("withValue")(value.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[TResult]
    inline def withValue[TResult, TArgs /* <: js.Array[js.Any] */, TThis](
      value: AnyEntry,
