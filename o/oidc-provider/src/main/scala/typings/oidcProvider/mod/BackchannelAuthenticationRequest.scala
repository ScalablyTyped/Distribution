...
@js.native
trait BackchannelAuthenticationRequest
  extends StObject
     with BaseToken {
  ...
  @JSName("kind")
  val kind_BackchannelAuthenticationRequest: typings.oidcProvider.oidcProviderStrings.BackchannelAuthenticationRequest = js.native
