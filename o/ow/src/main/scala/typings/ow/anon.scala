...
import typings.ow.distModifiersMod.Optionalify
import typings.ow.distPredicatesAnyMod.AnyPredicate
import typings.ow.distPredicatesArrayBufferMod.ArrayBufferPredicate
import typings.ow.distPredicatesArrayMod.ArrayPredicate
import typings.ow.distPredicatesBasePredicateMod.BasePredicate
import typings.ow.distPredicatesBigintMod.BigIntPredicate
import typings.ow.distPredicatesBooleanMod.BooleanPredicate
import typings.ow.distPredicatesDataViewMod.DataViewPredicate
import typings.ow.distPredicatesDateMod.DatePredicate
import typings.ow.distPredicatesErrorMod.ErrorPredicate
import typings.ow.distPredicatesMapMod.MapPredicate
import typings.ow.distPredicatesNumberMod.NumberPredicate
import typings.ow.distPredicatesObjectMod.ObjectPredicate
import typings.ow.distPredicatesPredicateMod.Predicate
import typings.ow.distPredicatesSetMod.SetPredicate
import typings.ow.distPredicatesStringMod.StringPredicate
import typings.ow.distPredicatesTypedArrayMod.TypedArrayPredicate
import typings.ow.distPredicatesWeakMapMod.WeakMapPredicate
import typings.ow.distPredicatesWeakSetMod.WeakSetPredicate
