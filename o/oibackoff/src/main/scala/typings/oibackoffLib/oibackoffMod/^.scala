...
object ^ extends js.Object {
  def backoff(): oibackoffLib.oibackoffMod.BackoffInstance = js.native
  def backoff(opts: oibackoffLib.oibackoffMod.BackoffOptions): oibackoffLib.oibackoffMod.BackoffInstance = js.native
