...
object CanvasPressEvent {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CanvasPressEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CanvasPressEvent] (val x: Self) extends AnyVal {
