...
/* Rewritten from type alias, can be one of: 
  - typings.openseadragon.openseadragonStrings.`bounds-change`
  - typings.openseadragon.openseadragonStrings.`clip-change`
  - typings.openseadragon.openseadragonStrings.`composite-operation-change`
  - typings.openseadragon.openseadragonStrings.`fully-loaded-change`
  - typings.openseadragon.openseadragonStrings.`opacity-change`
*/
