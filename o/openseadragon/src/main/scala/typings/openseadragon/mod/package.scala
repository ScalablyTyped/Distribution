...
package object mod {
  ...
  @scala.inline
  def cancelEvent(event: typings.openseadragon.mod.OSDEvent[_]): scala.Unit = typings.openseadragon.mod.^.asInstanceOf[js.Dynamic].applyDynamic("cancelEvent")(event.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
  ...
  @scala.inline
  def getMousePosition(event: typings.openseadragon.mod.OSDEvent[_]): typings.openseadragon.mod.Point = typings.openseadragon.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getMousePosition")(event.asInstanceOf[js.Any]).asInstanceOf[typings.openseadragon.mod.Point]
  ...
  @scala.inline
  def indexOf(array: js.Array[_], searchElement: js.Object): scala.Double = (typings.openseadragon.mod.^.asInstanceOf[js.Dynamic].applyDynamic("indexOf")(array.asInstanceOf[js.Any], searchElement.asInstanceOf[js.Any])).asInstanceOf[scala.Double]
  @scala.inline
  def indexOf(array: js.Array[_], searchElement: js.Object, fromIndex: scala.Double): scala.Double = (typings.openseadragon.mod.^.asInstanceOf[js.Dynamic].applyDynamic("indexOf")(array.asInstanceOf[js.Any], searchElement.asInstanceOf[js.Any], fromIndex.asInstanceOf[js.Any])).asInstanceOf[scala.Double]
  ...
  def removeEvent(
    element: java.lang.String,
    eventName: java.lang.String,
    handler: typings.openseadragon.mod.EventHandler[_]
  ...
  @scala.inline
  def stopEvent(event: typings.openseadragon.mod.OSDEvent[_]): scala.Unit = typings.openseadragon.mod.^.asInstanceOf[js.Dynamic].applyDynamic("stopEvent")(event.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
