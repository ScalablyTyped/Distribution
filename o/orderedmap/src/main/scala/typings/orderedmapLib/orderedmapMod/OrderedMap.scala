...
trait OrderedMap[T] extends js.Object {
  ...
  def append(map: org.scalablytyped.runtime.StringDictionary[T]): this.type = js.native
  ...
  def prepend(map: org.scalablytyped.runtime.StringDictionary[T]): this.type = js.native
  def remove(key: java.lang.String): this.type = js.native
  def subtract(map: OrderedMap[T]): this.type = js.native
  def subtract(map: org.scalablytyped.runtime.StringDictionary[T]): this.type = js.native
