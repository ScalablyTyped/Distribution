...
object overlayMod {
  ...
  @JSImport("@orbit-ui/react-components/dist/overlay", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@orbit-ui/react-components/dist/overlay", "Overlay")
  @js.native
  val Overlay: OrbitComponent[HTMLElement, InnerOverlayProps] = js.native
  
  @JSImport("@orbit-ui/react-components/dist/overlay", "OverlayArrow")
  @js.native
  val OverlayArrow: OrbitComponent[HTMLElement, InnerOverlayArrowProps] = js.native
  
  @JSImport("@orbit-ui/react-components/dist/overlay", "Underlay")
  @js.native
