...
object distDateInputSrcDateInputMod {
  ...
  object DatePreset {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: DatePreset] (val x: Self) extends AnyVal {
  ...
  trait InnerDateInputProps
    ...
    var onDateChange: js.UndefOr[
        js.Function2[/* event */ ChangeEvent[HTMLInputElement], /* date */ js.Date, Unit]
      ] = js.undefined
  ...
  object InnerDateInputProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: InnerDateInputProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnDateChange(value: (/* event */ ChangeEvent[HTMLInputElement], /* date */ js.Date) => Unit): Self = StObject.set(x, "onDateChange", js.Any.fromFunction2(value))
