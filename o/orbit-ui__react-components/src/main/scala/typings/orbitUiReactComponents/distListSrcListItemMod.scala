...
object distListSrcListItemMod {
  
  @JSImport("@orbit-ui/react-components/dist/list/src/ListItem", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@orbit-ui/react-components/dist/list/src/ListItem", "ListItem")
  @js.native
  val ListItem: OrbitComponent[HTMLElement, InnerListItemProps] = js.native
  
  trait InnerListItemProps extends StObject {
  ...
  object InnerListItemProps {
    
    inline def apply(): InnerListItemProps = {
  ...
  type ListItemProps = ComponentProps[OrbitComponent[HTMLElement, InnerListItemProps]]
}
