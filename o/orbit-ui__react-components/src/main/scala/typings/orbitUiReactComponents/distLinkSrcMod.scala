...
object distLinkSrcMod {
  
  @JSImport("@orbit-ui/react-components/dist/link/src", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@orbit-ui/react-components/dist/link/src", "IconLink")
  @js.native
  ...
  @JSImport("@orbit-ui/react-components/dist/link/src", "Link")
  @js.native
  val Link: OrbitComponent[HTMLElement, InnerLinkProps] = js.native
  
  @JSImport("@orbit-ui/react-components/dist/link/src", "TextLink")
  @js.native
