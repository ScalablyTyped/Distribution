...
object distSharedSrcUseControllableStateMod {
  
  @JSImport("@orbit-ui/react-components/dist/shared/src/useControllableState", JSImport.Namespace)
  @js.native
  ...
  trait ControllableStateOptions[T] extends StObject {
    
    var onChange: js.UndefOr[
        js.Function2[/* newState */ T, /* context */ js.UndefOr[OnChangeContext], js.UndefOr[T]]
      ] = js.undefined
  }
  object ControllableStateOptions {
    
    inline def apply[T](): ControllableStateOptions[T] = {
  ...
  trait OnChangeContext extends StObject {
    
    var isControlled: Boolean
    
    var isInitial: Boolean
  }
  object OnChangeContext {
    
    inline def apply(isControlled: Boolean, isInitial: Boolean): OnChangeContext = {
      val __obj = js.Dynamic.literal(isControlled = isControlled.asInstanceOf[js.Any], isInitial = isInitial.asInstanceOf[js.Any])
