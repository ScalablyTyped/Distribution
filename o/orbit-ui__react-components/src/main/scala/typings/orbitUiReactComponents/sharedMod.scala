...
object sharedMod {
  ...
  open class CompositeKeyWeakMap[T] ()
    extends typings.orbitUiReactComponents.sharedSrcMod.CompositeKeyWeakMap[T]
  
  @JSImport("@orbit-ui/react-components/dist/shared", "DomScope")
  @js.native
  open class DomScope protected ()
    extends typings.orbitUiReactComponents.sharedSrcMod.DomScope {
  ...
  open class ElementIterator[T] protected ()
    extends typings.orbitUiReactComponents.sharedSrcMod.ElementIterator[T] {
  ...
  open class FocusManager protected ()
    extends typings.orbitUiReactComponents.sharedSrcMod.FocusManager {
