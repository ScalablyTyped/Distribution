...
trait AlignContent extends StObject {
  ...
  var WebkitAlignContent: js.UndefOr[typings.csstype.mod.Property.AlignContent] = js.undefined
  ...
  var alignContent: js.UndefOr[typings.csstype.mod.Property.AlignContent] = js.undefined
...
object AlignContent {
  ...
  implicit open class MutableBuilder[Self <: AlignContent] (val x: Self) extends AnyVal {
    ...
    inline def setWebkitAlignContent(value: typings.csstype.mod.Property.AlignContent): Self = StObject.set(x, "WebkitAlignContent", value.asInstanceOf[js.Any])
