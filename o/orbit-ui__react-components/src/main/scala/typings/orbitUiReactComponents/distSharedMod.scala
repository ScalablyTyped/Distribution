...
object distSharedMod {
  ...
  open class CompositeKeyWeakMap[T] ()
    extends typings.orbitUiReactComponents.distSharedSrcMod.CompositeKeyWeakMap[T]
  
  @JSImport("@orbit-ui/react-components/dist/shared", "DomScope")
  @js.native
  open class DomScope protected ()
    extends typings.orbitUiReactComponents.distSharedSrcMod.DomScope {
  ...
  open class ElementIterator[T] protected ()
    extends typings.orbitUiReactComponents.distSharedSrcMod.ElementIterator[T] {
  ...
  open class FocusManager protected ()
    extends typings.orbitUiReactComponents.distSharedSrcMod.FocusManager {
