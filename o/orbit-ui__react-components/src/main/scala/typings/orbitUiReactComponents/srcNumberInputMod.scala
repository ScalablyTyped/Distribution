...
object srcNumberInputMod {
  ...
  type BoxProps = typings.orbitUiReactComponents.srcBoxMod.BoxProps
  ...
  trait InnerNumberInputProps
    ...
    var onValueChange: js.UndefOr[
        js.Function2[/* event */ SyntheticEvent[typings.std.Element, Event], /* value */ Double, Unit]
      ] = js.undefined
  ...
  object InnerNumberInputProps {
    ...
    extension [Self <: InnerNumberInputProps](x: Self) {
      ...
      inline def setOnValueChange(value: (/* event */ SyntheticEvent[typings.std.Element, Event], /* value */ Double) => Unit): Self = StObject.set(x, "onValueChange", js.Any.fromFunction2(value))
