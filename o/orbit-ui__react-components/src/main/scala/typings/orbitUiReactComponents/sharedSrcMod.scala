...
object sharedSrcMod {
  ...
  open class CompositeKeyWeakMap[T] ()
    extends typings.orbitUiReactComponents.mergePropsMod.CompositeKeyWeakMap[T]
  
  @JSImport("@orbit-ui/react-components/dist/shared/src", "DomScope")
  @js.native
  open class DomScope protected ()
    extends typings.orbitUiReactComponents.useFocusScopeMod.DomScope {
  ...
  open class ElementIterator[T] protected ()
    extends typings.orbitUiReactComponents.useFocusManagerMod.ElementIterator[T] {
  ...
  open class FocusManager protected ()
    extends typings.orbitUiReactComponents.useFocusManagerMod.FocusManager {
