...
object searchInputMod {
  ...
  trait InnerSearchInputProps
    ...
    /**
      * @ignore
      */
    var onKeyDown: js.UndefOr[KeyboardEventHandler[typings.std.Element]] = js.undefined
  ...
  object InnerSearchInputProps {
    ...
    extension [Self <: InnerSearchInputProps](x: Self) {
      ...
      inline def setOnValueChange(value: (/* event */ SyntheticEvent[typings.std.Element, Event], /* value */ String) => Unit): Self = StObject.set(x, "onValueChange", js.Any.fromFunction2(value))
