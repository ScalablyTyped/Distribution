...
object distDisclosureSrcMod {
  
  @JSImport("@orbit-ui/react-components/dist/disclosure/src", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@orbit-ui/react-components/dist/disclosure/src", "Disclosure")
  @js.native
  val Disclosure: OrbitComponent[HTMLElement, InnerDisclosureProps] = js.native
  
  @JSImport("@orbit-ui/react-components/dist/disclosure/src", "DisclosureArrow")
  @js.native
  val DisclosureArrow: OrbitComponent[HTMLElement, InnerDisclosureArrowProps] = js.native
  
  @JSImport("@orbit-ui/react-components/dist/disclosure/src", "DisclosureContext")
  @js.native
