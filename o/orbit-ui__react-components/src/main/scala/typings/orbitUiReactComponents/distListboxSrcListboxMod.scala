...
object distListboxSrcListboxMod {
  ...
  type CollectionNode = typings.orbitUiReactComponents.distCollectionSrcUseCollectionMod.CollectionNode
  ...
  object InnerListboxProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: InnerListboxProps] (val x: Self) extends AnyVal {
