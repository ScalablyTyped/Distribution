...
object inputGroupContextMod {
  ...
  - typings.orbitUiReactComponents.toolbarContextMod.ToolbarContextType because var conflicts: disabled. Inlined orientation */ trait InputGroupContextType
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.orbitUiReactComponents.toolbarContextMod.ToolbarContextType because var conflicts: disabled. Inlined orientation */ trait UseInputGroupPropsReturn
    extends StObject
       with UseFieldInputPropsReturn {
