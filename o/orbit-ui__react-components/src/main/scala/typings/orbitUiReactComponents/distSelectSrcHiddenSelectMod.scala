...
object distSelectSrcHiddenSelectMod {
  ...
  - Dropped 'input' extends react.react.JSXElementConstructor<infer P> ? P : 'input' extends keyof react.react.JSX.IntrinsicElements ? react.react.JSX.IntrinsicElements['input'] : {} */ trait HiddenSelectProps extends StObject {
  ...
  object HiddenSelectProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: HiddenSelectProps] (val x: Self) extends AnyVal {
