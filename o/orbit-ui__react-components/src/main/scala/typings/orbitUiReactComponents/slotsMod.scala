...
object slotsMod {
  ...
  type GetSlotsReturn[T /* <: SlotOptions */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ key in keyof std.Omit<T, '_'> ]:? react.react.ReactElement}
    */ typings.orbitUiReactComponents.orbitUiReactComponentsStrings.GetSlotsReturn & TopLevel[Any]
