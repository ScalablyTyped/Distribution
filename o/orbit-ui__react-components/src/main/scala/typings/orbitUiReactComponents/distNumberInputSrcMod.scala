...
object distNumberInputSrcMod {
  
  @JSImport("@orbit-ui/react-components/dist/number-input/src", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@orbit-ui/react-components/dist/number-input/src", "NumberInput")
  @js.native
