...
object global {
  ...
  object OO {
    ...
    object SortedEmitterList extends Shortcut {
      ...
      @JSGlobal("OO.SortedEmitterList")
      @js.native
      val ^ : SortedEmitterListConstructor = js.native
      
      /** @deprecated Use `super` instead */
      /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
      @JSGlobal("OO.SortedEmitterList.parent")
      @js.native
      open class parent ()
        extends StObject
           with typings.oojs.OO.EmitterList
      ...
      /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
      @JSGlobal("OO.SortedEmitterList.super")
      @js.native
      open class `super` ()
        extends StObject
           with typings.oojs.OO.EmitterList
