...
trait ojFilmStripEventMap extends baseComponentEventMap[ojFilmStripSettableProperties] {
  ...
  var currentItemChanged: JetElementCustomEvent[Anon_Id]
...
object ojFilmStripEventMap {
  ...
  def apply(
    ...
    copy: ClipboardEvent,
    cuechange: Event,
    currentItemChanged: JetElementCustomEvent[Anon_Id],
    cut: ClipboardEvent,
    dblclick: MouseEvent,
    drag: DragEvent,
    dragend: DragEvent,
