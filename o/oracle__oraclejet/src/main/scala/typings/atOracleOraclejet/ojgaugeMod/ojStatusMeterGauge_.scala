...
import typings.atOracleOraclejet.atOracleOraclejetStrings.angleExtentChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.centerChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.indicatorSize
import typings.atOracleOraclejet.atOracleOraclejetStrings.indicatorSizeChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.innerRadius
import typings.atOracleOraclejet.atOracleOraclejetStrings.innerRadiusChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.thresholdDisplay
import typings.atOracleOraclejet.atOracleOraclejetStrings.thresholdDisplayChanged
...
trait ojStatusMeterGauge_ extends dvtBaseGauge[ojStatusMeterGaugeSettableProperties] {
  ...
  var onCenterChanged: (js.Function1[
    /* event */ JetElementCustomEvent[Anon_ContextRendererAnonInsertAnonPreventDefaultCenterContext], 
    _
  ]) | Null = js.native
  ...
  var onLabelChanged: (js.Function1[/* event */ JetElementCustomEvent[Anon_AutoCenter], _]) | Null = js.native
  var onMaxChanged: (js.Function1[/* event */ JetElementCustomEvent[Double], _]) | Null = js.native
  var onMetricLabelChanged: (js.Function1[/* event */ JetElementCustomEvent[Anon_AutoBillionCenter], _]) | Null = js.native
  ...
  var onPlotAreaChanged: (js.Function1[/* event */ JetElementCustomEvent[Anon_AutoBorderColor], _]) | Null = js.native
  ...
  var onTooltipChanged: (js.Function1[
    /* event */ JetElementCustomEvent[Anon_ContextRendererAnonInsertAnonPreventDefaultTooltipContext_117442419], 
    _
  ]) | Null = js.native
  ...
  def addEventListener_centerChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[Anon_ContextRendererAnonInsertAnonPreventDefaultCenterContext], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_labelChanged(
    `type`: labelChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[Anon_AutoCenter], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_labelChanged(
    `type`: labelChanged,
  ...
  def addEventListener_metricLabelChanged(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[Anon_AutoBillionCenter], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_metricLabelChanged(
    `type`: metricLabelChanged,
  ...
  def addEventListener_plotAreaChanged(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[Anon_AutoBorderColor], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_plotAreaChanged(
    `type`: plotAreaChanged,
  ...
  def addEventListener_tooltipChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[Anon_ContextRendererAnonInsertAnonPreventDefaultTooltipContext_117442419], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
