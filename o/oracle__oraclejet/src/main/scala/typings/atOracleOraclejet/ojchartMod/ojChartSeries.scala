...
import typings.atOracleOraclejet.atOracleOraclejetStrings.assignedToY2
import typings.atOracleOraclejet.atOracleOraclejetStrings.assignedToY2Changed
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.displayInLegend
import typings.atOracleOraclejet.atOracleOraclejetStrings.displayInLegendChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.pieSliceExplode
import typings.atOracleOraclejet.atOracleOraclejetStrings.pieSliceExplodeChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.stackCategory
import typings.atOracleOraclejet.atOracleOraclejetStrings.stackCategoryChanged
...
trait ojChartSeries extends JetElement[ojChartSeriesSettableProperties] {
  ...
  var onBoxPlotChanged: (js.Function1[
    /* event */ JetElementCustomEvent[js.UndefOr[Anon_MedianSvgClassNameMedianSvgStyleQ2Color]], 
    _
  ]) | Null = js.native
  ...
  def addEventListener_boxPlotChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[js.UndefOr[Anon_MedianSvgClassNameMedianSvgStyleQ2Color]], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
