...
import typings.atOracleOraclejet.atOracleOraclejetStrings.areaColor
import typings.atOracleOraclejet.atOracleOraclejetStrings.areaColorChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.areaSvgClassName
import typings.atOracleOraclejet.atOracleOraclejetStrings.areaSvgClassNameChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.areaSvgStyle
import typings.atOracleOraclejet.atOracleOraclejetStrings.areaSvgStyleChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.barGapRatio
import typings.atOracleOraclejet.atOracleOraclejetStrings.barGapRatioChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.baselineScaling
import typings.atOracleOraclejet.atOracleOraclejetStrings.baselineScalingChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.firstColor
import typings.atOracleOraclejet.atOracleOraclejetStrings.firstColorChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.highColor
import typings.atOracleOraclejet.atOracleOraclejetStrings.highColorChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.human
import typings.atOracleOraclejet.atOracleOraclejetStrings.lastColor
import typings.atOracleOraclejet.atOracleOraclejetStrings.lastColorChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.line
import typings.atOracleOraclejet.atOracleOraclejetStrings.lineStyle
import typings.atOracleOraclejet.atOracleOraclejetStrings.lineStyleChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.lineType
import typings.atOracleOraclejet.atOracleOraclejetStrings.lineTypeChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.lineWidth
import typings.atOracleOraclejet.atOracleOraclejetStrings.lineWidthChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.lineWithArea
import typings.atOracleOraclejet.atOracleOraclejetStrings.lowColor
import typings.atOracleOraclejet.atOracleOraclejetStrings.lowColorChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.referenceObjects
import typings.atOracleOraclejet.atOracleOraclejetStrings.referenceObjectsChanged
...
import typings.atOracleOraclejet.ojchartMod.ojSparkChart.ItemContext
...
trait ojSparkChart_[K, D] extends dvtBaseComponent[ojSparkChartSettableProperties[K, D]] {
  ...
  var onTooltipChanged: (js.Function1[/* event */ JetElementCustomEvent[Anon_ContextRenderer], _]) | Null = js.native
  ...
  def addEventListener_tooltipChanged(
    `type`: tooltipChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[Anon_ContextRenderer], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_tooltipChanged(
    `type`: tooltipChanged,
  ...
  @JSName("getProperty")
  def getProperty_areaSvgStyle(property: areaSvgStyle): /* import warning: ImportType.apply Failed type conversion: @oracle/oraclejet.@oracle/oraclejet/ojchart.ojSparkChart<K, D>['areaSvgStyle'] */ js.Any = js.native
  @JSName("getProperty")
  ...
  @JSName("getProperty")
  def getProperty_svgStyle(property: svgStyle): /* import warning: ImportType.apply Failed type conversion: @oracle/oraclejet.@oracle/oraclejet/ojchart.ojSparkChart<K, D>['svgStyle'] */ js.Any = js.native
  @JSName("getProperty")
