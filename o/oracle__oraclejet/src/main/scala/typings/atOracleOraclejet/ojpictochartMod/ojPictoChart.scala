...
import typings.atOracleOraclejet.ojpictochartMod.ojPictoChartNs.ItemContext
import typings.atOracleOraclejet.ojpictochartMod.ojPictoChartNs.NodeContext
...
@js.native
trait ojPictoChart[K, D] extends dvtBaseComponent[ojPictoChartSettableProperties[K, D]] {
  ...
  @JSName("translations")
  var translations_ojPictoChart: Anon_ComponentNameLabelAndValue = js.native
