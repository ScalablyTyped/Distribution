...
object ojAccordionEventMap {
  ...
  def apply(
    ...
    ended: Event,
    error: ErrorEvent,
    expandedChanged: JetElementCustomEvent[js.Array[Anon_Id] | Null],
    focus: FocusEvent,
    focusin: FocusEvent,
    focusout: FocusEvent,
