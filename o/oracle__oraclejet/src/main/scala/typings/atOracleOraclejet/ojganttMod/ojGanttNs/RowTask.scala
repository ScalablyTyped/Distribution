...
trait RowTask[K2] extends js.Object {
  var baseline: js.UndefOr[Anon_BorderRadiusEnd] = js.undefined
  ...
  var progress: js.UndefOr[Anon_BorderRadiusHeightSvgClassName] = js.undefined
...
object RowTask {
  ...
  def apply[K2](
    id: K2,
    baseline: Anon_BorderRadiusEnd = null,
    ...
    progress: Anon_BorderRadiusHeightSvgClassName = null,
