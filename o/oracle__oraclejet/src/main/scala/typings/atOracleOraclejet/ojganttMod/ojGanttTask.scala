...
import typings.atOracleOraclejet.atOracleOraclejetStrings.baselineChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.blur
import typings.atOracleOraclejet.atOracleOraclejetStrings.borderRadius
import typings.atOracleOraclejet.atOracleOraclejetStrings.borderRadiusChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.height
import typings.atOracleOraclejet.atOracleOraclejetStrings.heightChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.progressChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.rowId
import typings.atOracleOraclejet.atOracleOraclejetStrings.rowIdChanged
...
trait ojGanttTask extends JetElement[ojGanttTaskSettableProperties] {
  var baseline: Anon_BorderRadiusEnd = js.native
  ...
  var onBaselineChanged: (js.Function1[/* event */ JetElementCustomEvent[Anon_BorderRadiusEnd], _]) | Null = js.native
  ...
  var onProgressChanged: (js.Function1[/* event */ JetElementCustomEvent[Anon_BorderRadiusHeightSvgClassName], _]) | Null = js.native
  ...
  var progress: Anon_BorderRadiusHeightSvgClassName = js.native
  ...
  def addEventListener_baselineChanged(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[Anon_BorderRadiusEnd], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_baselineChanged(
    `type`: baselineChanged,
  ...
  def addEventListener_progressChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[Anon_BorderRadiusHeightSvgClassName], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_rowIdChanged(
    `type`: rowIdChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.UndefOr[_]], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_rowIdChanged(
    `type`: rowIdChanged,
  ...
  @JSName("getProperty")
  def getProperty_baseline(property: baseline): Anon_BorderRadiusEnd = js.native
  @JSName("getProperty")
  ...
  @JSName("getProperty")
  def getProperty_labelStyle(property: labelStyle): /* import warning: ImportType.apply Failed type conversion: @oracle/oraclejet.@oracle/oraclejet/ojgantt.ojGanttTask['labelStyle'] */ js.Any = js.native
  @JSName("getProperty")
  def getProperty_progress(property: progress): Anon_BorderRadiusHeightSvgClassName = js.native
  @JSName("getProperty")
  ...
  @JSName("getProperty")
  def getProperty_svgStyle(property: svgStyle): /* import warning: ImportType.apply Failed type conversion: @oracle/oraclejet.@oracle/oraclejet/ojgantt.ojGanttTask['svgStyle'] */ js.Any = js.native
  @JSName("getProperty")
  ...
  @JSName("setProperty")
  def setProperty_baseline(property: baseline, value: Anon_BorderRadiusEnd): Unit = js.native
  @JSName("setProperty")
  ...
  @JSName("setProperty")
  def setProperty_progress(property: progress, value: Anon_BorderRadiusHeightSvgClassName): Unit = js.native
  @JSName("setProperty")
