package typings.atOracleOraclejet.ojswitcherMod
...
trait ojSwitcherEventMap extends HTMLElementEventMap {
  var valueChanged: JetElementCustomEvent[String]
}

object ojSwitcherEventMap {
  @scala.inline
  def apply(
    abort: UIEvent,
