...
import typings.atOracleOraclejet.atOracleOraclejetStrings.descendantsConnectivity
import typings.atOracleOraclejet.atOracleOraclejetStrings.descendantsConnectivityChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.showDisclosure
import typings.atOracleOraclejet.atOracleOraclejetStrings.showDisclosureChanged
...
trait ojDiagramNode extends JetElement[ojDiagramNodeSettableProperties] {
  ...
  var onIconChanged: (js.Function1[
    /* event */ JetElementCustomEvent[js.UndefOr[Anon_BorderColorBorderRadiusBorderWidth]], 
    _
  ]) | Null = js.native
  ...
  var onOverviewChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[Anon_IconAnonCircle]], _]) | Null = js.native
  ...
  def addEventListener_iconChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[js.UndefOr[Anon_BorderColorBorderRadiusBorderWidth]], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_overviewChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[js.UndefOr[Anon_IconAnonCircle]], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
