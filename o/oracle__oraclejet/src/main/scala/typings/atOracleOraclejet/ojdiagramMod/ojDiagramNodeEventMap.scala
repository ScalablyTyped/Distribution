...
trait ojDiagramNodeEventMap
  ...
  var overviewChanged: JetElementCustomEvent[js.UndefOr[Anon_IconAnonCircle]]
...
object ojDiagramNodeEventMap {
  ...
  def apply(
    ...
    iconChanged: JetElementCustomEvent[js.UndefOr[Anon_BorderColorBorderRadiusBorderWidth]],
    input: Event,
    invalid: Event,
    ...
    mouseup: MouseEvent,
    overviewChanged: JetElementCustomEvent[js.UndefOr[Anon_IconAnonCircle]],
