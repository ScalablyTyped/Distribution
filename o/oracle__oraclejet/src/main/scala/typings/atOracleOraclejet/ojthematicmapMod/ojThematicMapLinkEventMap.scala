...
trait ojThematicMapLinkEventMap
  ...
  var endLocationChanged: JetElementCustomEvent[Anon_IdLocation]
  var selectableChanged: JetElementCustomEvent[auto | off]
  var shortDescChanged: JetElementCustomEvent[String]
  var startLocationChanged: JetElementCustomEvent[Anon_IdLocation]
...
object ojThematicMapLinkEventMap {
  ...
  def apply(
    ...
    emptied: Event,
    endLocationChanged: JetElementCustomEvent[Anon_IdLocation],
    ended: Event,
    error: ErrorEvent,
    focus: FocusEvent,
    focusin: FocusEvent,
    ...
    stalled: Event,
    startLocationChanged: JetElementCustomEvent[Anon_IdLocation],
    submit: Event,
    suspend: Event,
