...
import typings.atOracleOraclejet.atOracleOraclejetStrings.borderStyle
import typings.atOracleOraclejet.atOracleOraclejetStrings.borderStyleChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.location
import typings.atOracleOraclejet.atOracleOraclejetStrings.locationChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.opacity
import typings.atOracleOraclejet.atOracleOraclejetStrings.opacityChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.shape
import typings.atOracleOraclejet.atOracleOraclejetStrings.shapeChanged
...
trait ojThematicMapMarker extends JetElement[ojThematicMapMarkerSettableProperties] {
  ...
  @JSName("getProperty")
  def getProperty_labelStyle(property: labelStyle): /* import warning: ImportType.apply Failed type conversion: @oracle/oraclejet.@oracle/oraclejet/ojthematicmap.ojThematicMapMarker['labelStyle'] */ js.Any = js.native
  @JSName("getProperty")
  ...
  @JSName("getProperty")
  def getProperty_svgStyle(property: svgStyle): /* import warning: ImportType.apply Failed type conversion: @oracle/oraclejet.@oracle/oraclejet/ojthematicmap.ojThematicMapMarker['svgStyle'] */ js.Any = js.native
  @JSName("getProperty")
