...
import typings.atOracleOraclejet.ojsunburstMod.ojSunburst.DataContext
import typings.atOracleOraclejet.ojsunburstMod.ojSunburst.NodeContext
...
trait ojSunburst_[K, D] extends dvtBaseComponent[ojSunburstSettableProperties[K, D]] {
  ...
  @JSName("translations")
  var translations_ojSunburst_ : Anon_ComponentNameLabelAndValueLabelClearSelectionLabelColor = js.native
