...
import typings.atOracleOraclejet.ojlistviewMod.ojListViewNs.ContextByNode
...
@js.native
trait ojListView[K, D] extends baseComponent[ojListViewSettableProperties[K, D]] {
  ...
  @JSName("translations")
  var translations_ojListView: Anon_AccessibleNavigateSkipItems = js.native
