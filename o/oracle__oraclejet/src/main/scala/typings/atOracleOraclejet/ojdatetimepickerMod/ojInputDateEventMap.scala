...
import typings.atOracleOraclejet.ojdatetimepickerMod.ojInputDate.ojAnimateEnd
import typings.atOracleOraclejet.ojdatetimepickerMod.ojInputDate.ojAnimateStart
