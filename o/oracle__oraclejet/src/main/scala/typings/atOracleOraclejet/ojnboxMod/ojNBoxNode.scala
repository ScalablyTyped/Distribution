...
import typings.atOracleOraclejet.atOracleOraclejetStrings.columnChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.groupCategory
import typings.atOracleOraclejet.atOracleOraclejetStrings.groupCategoryChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.icon
import typings.atOracleOraclejet.atOracleOraclejetStrings.iconChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.indicatorColor
import typings.atOracleOraclejet.atOracleOraclejetStrings.indicatorColorChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.indicatorIcon
import typings.atOracleOraclejet.atOracleOraclejetStrings.indicatorIconChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.rowChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.scroll
import typings.atOracleOraclejet.atOracleOraclejetStrings.secondaryLabel
import typings.atOracleOraclejet.atOracleOraclejetStrings.secondaryLabelChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.xPercentage
import typings.atOracleOraclejet.atOracleOraclejetStrings.xPercentageChanged
import typings.atOracleOraclejet.atOracleOraclejetStrings.yPercentage
import typings.atOracleOraclejet.atOracleOraclejetStrings.yPercentageChanged
...
trait ojNBoxNode extends JetElement[ojNBoxNodeSettableProperties] {
  ...
  var icon: js.UndefOr[Anon_BorderColorBorderRadiusBorderWidthCircleColor] = js.native
  var indicatorColor: js.UndefOr[String] = js.native
  var indicatorIcon: js.UndefOr[Anon_BorderColorBorderRadiusBorderWidthCircleColorDiamond] = js.native
  ...
  var onIconChanged: (js.Function1[
    /* event */ JetElementCustomEvent[js.UndefOr[Anon_BorderColorBorderRadiusBorderWidthCircleColor]], 
    _
  ]) | Null = js.native
  ...
  var onIndicatorIconChanged: (js.Function1[
    /* event */ JetElementCustomEvent[js.UndefOr[Anon_BorderColorBorderRadiusBorderWidthCircleColorDiamond]], 
    _
  ]) | Null = js.native
  ...
  var onSvgStyleChanged: (js.Function1[/* event */ JetElementCustomEvent[js.Object | Null], _]) | Null = js.native
  var onXPercentageChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[Double | Null]], _]) | Null = js.native
  var onYPercentageChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[Double | Null]], _]) | Null = js.native
  ...
  def addEventListener_iconChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[js.UndefOr[Anon_BorderColorBorderRadiusBorderWidthCircleColor]], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_indicatorIconChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[js.UndefOr[Anon_BorderColorBorderRadiusBorderWidthCircleColorDiamond]], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_svgStyleChanged(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.Object | Null], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_svgStyleChanged(
    `type`: svgStyleChanged,
  ...
  def addEventListener_xPercentageChanged(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.UndefOr[Double | Null]], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_xPercentageChanged(
    `type`: xPercentageChanged,
  ...
  @JSName("getProperty")
  def getProperty_icon(property: icon): js.UndefOr[Anon_BorderColorBorderRadiusBorderWidthCircleColor] = js.native
  @JSName("getProperty")
  def getProperty_indicatorColor(property: indicatorColor): js.UndefOr[String] = js.native
  @JSName("getProperty")
  def getProperty_indicatorIcon(property: indicatorIcon): js.UndefOr[Anon_BorderColorBorderRadiusBorderWidthCircleColorDiamond] = js.native
  @JSName("getProperty")
  ...
  @JSName("setProperty")
  def setProperty_icon(property: icon, value: Anon_BorderColorBorderRadiusBorderWidthCircleColor): Unit = js.native
  @JSName("setProperty")
  def setProperty_indicatorColor(property: indicatorColor, value: String): Unit = js.native
  @JSName("setProperty")
  def setProperty_indicatorIcon(property: indicatorIcon, value: Anon_BorderColorBorderRadiusBorderWidthCircleColorDiamond): Unit = js.native
  @JSName("setProperty")
