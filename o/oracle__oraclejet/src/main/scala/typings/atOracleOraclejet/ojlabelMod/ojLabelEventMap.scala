...
trait ojLabelEventMap extends baseComponentEventMap[ojLabelSettableProperties] {
  ...
  var helpChanged: JetElementCustomEvent[Anon_DefinitionSource]
...
object ojLabelEventMap {
  ...
  def apply(
    ...
    helpChanged: JetElementCustomEvent[Anon_DefinitionSource],
    input: Event,
    invalid: Event,
