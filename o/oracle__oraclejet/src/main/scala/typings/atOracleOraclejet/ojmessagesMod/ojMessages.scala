...
import typings.atOracleOraclejet.atOracleOraclejetStrings.messages
import typings.atOracleOraclejet.atOracleOraclejetStrings.messagesChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.translationsChanged
...
trait ojMessages extends JetElement[ojMessagesSettableProperties] {
  ...
  var onTranslationsChanged: (js.Function1[/* event */ JetElementCustomEvent[Anon_AriaLiveRegion], _]) | Null = js.native
  ...
  def addEventListener_translationsChanged(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[Anon_AriaLiveRegion], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_translationsChanged(
    `type`: translationsChanged,
