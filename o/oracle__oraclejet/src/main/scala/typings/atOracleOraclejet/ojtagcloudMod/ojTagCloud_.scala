...
import typings.atOracleOraclejet.ojtagcloudMod.ojTagCloud.ItemContext
import typings.atOracleOraclejet.ojtagcloudMod.ojTagCloud.NodeContext
...
trait ojTagCloud_[K, D] extends dvtBaseComponent[ojTagCloudSettableProperties[K, D]] {
  ...
  @JSName("translations")
  var translations_ojTagCloud_ : Anon_ComponentNameLabelAndValue = js.native
