...
import typings.atOracleOraclejet.atOracleOraclejetStrings.accept
import typings.atOracleOraclejet.atOracleOraclejetStrings.acceptChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.selectOn
import typings.atOracleOraclejet.atOracleOraclejetStrings.selectOnChanged
...
trait ojFilePicker extends JetElement[ojFilePickerSettableProperties] {
  ...
  def addEventListener(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[auto | click | drop | clickAndDrop], 
      _
    ]
  ): Unit = js.native
  def addEventListener(
  ...
  def addEventListener(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[multiple | single], _]
  ): Unit = js.native
  def addEventListener(
    `type`: selectionModeChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[multiple | single], _],
  ...
  @JSName("addEventListener")
  def addEventListener_acceptChanged(
    `type`: acceptChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.Array[String] | Null], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_acceptChanged(
    `type`: acceptChanged,
  ...
  def setProperty(property: selectOn, value: drop): Unit = js.native
  ...
  def setProperty[T /* <: String */](property: T, value: JetSetPropertyType[T, ojFilePickerSettableProperties]): Unit = js.native
  @JSName("setProperty")
