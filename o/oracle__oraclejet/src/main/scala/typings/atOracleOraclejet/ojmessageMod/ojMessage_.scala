...
import typings.atOracleOraclejet.atOracleOraclejetStrings.message
import typings.atOracleOraclejet.atOracleOraclejetStrings.messageChanged
...
trait ojMessage_ extends JetElement[ojMessageSettableProperties] {
  ...
  var onTranslationsChanged: (js.Function1[/* event */ JetElementCustomEvent[Anon_Categories], _]) | Null = js.native
  ...
  def addEventListener_translationsChanged(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[Anon_Categories], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_translationsChanged(
    `type`: translationsChanged,
