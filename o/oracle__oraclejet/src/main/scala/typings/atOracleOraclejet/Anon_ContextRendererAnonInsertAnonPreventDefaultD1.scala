...
import typings.atOracleOraclejet.ojthematicmapMod.ojThematicMapNs.TooltipContext
...
object Anon_ContextRendererAnonInsertAnonPreventDefaultD1 {
  @scala.inline
  def apply[K1, K3, D3, K2, D2, D1](renderer: TooltipContext[K1, K2, K3, D1, D2, D3] => Anon_Insert | Anon_PreventDefault): Anon_ContextRendererAnonInsertAnonPreventDefaultD1[K1, K3, D3, K2, D2, D1] = {
