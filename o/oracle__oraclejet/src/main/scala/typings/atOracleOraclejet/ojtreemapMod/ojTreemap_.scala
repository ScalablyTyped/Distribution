...
import typings.atOracleOraclejet.ojtreemapMod.ojTreemap.DataContext
import typings.atOracleOraclejet.ojtreemapMod.ojTreemap.NodeContext
...
trait ojTreemap_[K, D] extends dvtBaseComponent[ojTreemapSettableProperties[K, D]] {
  ...
  @JSName("translations")
  var translations_ojTreemap_ : Anon_ComponentNameLabelAndValueLabelClearSelectionLabelColorLabelCountWithTotal = js.native
