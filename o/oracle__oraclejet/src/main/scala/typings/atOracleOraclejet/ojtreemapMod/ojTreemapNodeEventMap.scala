...
trait ojTreemapNodeEventMap extends HTMLElementEventMap {
  ...
  var headerChanged: JetElementCustomEvent[js.UndefOr[Anon_CenterEndIsolate]]
...
object ojTreemapNodeEventMap {
  ...
  def apply(
    ...
    headerChanged: JetElementCustomEvent[js.UndefOr[Anon_CenterEndIsolate]],
    input: Event,
    invalid: Event,
