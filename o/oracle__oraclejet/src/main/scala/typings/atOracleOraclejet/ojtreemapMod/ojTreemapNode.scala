...
import typings.atOracleOraclejet.atOracleOraclejetStrings.groupLabelDisplay
import typings.atOracleOraclejet.atOracleOraclejetStrings.groupLabelDisplayChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.labelHalign
import typings.atOracleOraclejet.atOracleOraclejetStrings.labelHalignChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.labelValign
import typings.atOracleOraclejet.atOracleOraclejetStrings.labelValignChanged
...
trait ojTreemapNode extends JetElement[ojTreemapNodeSettableProperties] {
  ...
  var header: js.UndefOr[Anon_CenterEndIsolate] = js.native
  ...
  var onHeaderChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[Anon_CenterEndIsolate]], _]) | Null = js.native
  ...
  def addEventListener_headerChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[js.UndefOr[Anon_CenterEndIsolate]], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("getProperty")
  def getProperty_header(property: header): js.UndefOr[Anon_CenterEndIsolate] = js.native
  @JSName("getProperty")
  ...
  @JSName("setProperty")
  def setProperty_header(property: header, value: Anon_CenterEndIsolate): Unit = js.native
  @JSName("setProperty")
