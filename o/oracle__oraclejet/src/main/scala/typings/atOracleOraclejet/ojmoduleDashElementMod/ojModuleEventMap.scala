...
object ojModuleEventMap {
  ...
  def apply(
    abort: UIEvent,
    animationChanged: JetElementCustomEvent[
      /* import warning: importer.ImportType#apply Failed type conversion: @oracle/oraclejet.@oracle/oraclejet/ojmodule-element.ojModule['animation'] */ js.Any
    ],
    ...
    click: MouseEvent,
    close: Event,
    configChanged: JetElementCustomEvent[Anon_CleanupMode],
    ...
    mouseup: MouseEvent,
    ojTransitionEnd: ojTransitionEnd,
    ojTransitionStart: ojTransitionStart,
    ojViewConnected: ojViewConnected,
    ojViewDisconnected: ojViewDisconnected,
