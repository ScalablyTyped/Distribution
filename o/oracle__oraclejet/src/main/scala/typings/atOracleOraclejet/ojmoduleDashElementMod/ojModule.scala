...
import typings.atOracleOraclejet.atOracleOraclejetStrings.animation
import typings.atOracleOraclejet.atOracleOraclejetStrings.animationChanged
...
import typings.atOracleOraclejet.atOracleOraclejetStrings.config
import typings.atOracleOraclejet.atOracleOraclejetStrings.configChanged
...
trait ojModule extends JetElement[ojModuleSettableProperties] {
  ...
  var onConfigChanged: (js.Function1[/* event */ JetElementCustomEvent[Anon_CleanupMode], _]) | Null = js.native
  ...
  def addEventListener_configChanged(
    `type`: configChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[Anon_CleanupMode], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_configChanged(
    `type`: configChanged,
  ...
  def addEventListener_ojTransitionEnd(
    `type`: typings.atOracleOraclejet.atOracleOraclejetStrings.ojTransitionEnd,
  ...
  def addEventListener_ojTransitionStart(
    `type`: typings.atOracleOraclejet.atOracleOraclejetStrings.ojTransitionStart,
  ...
  def addEventListener_ojViewConnected(
    `type`: typings.atOracleOraclejet.atOracleOraclejetStrings.ojViewConnected,
  ...
  def addEventListener_ojViewDisconnected(
    `type`: typings.atOracleOraclejet.atOracleOraclejetStrings.ojViewDisconnected,
