...
import typings.atOracleOraclejet.atOracleOraclejetStrings.filterOnOpen
import typings.atOracleOraclejet.atOracleOraclejetStrings.filterOnOpenChanged
...
trait ojComboboxOne[K, D]
  ...
  var filterOnOpen: none | typings.atOracleOraclejet.atOracleOraclejetStrings.rawValue = js.native
  ...
  var onFilterOnOpenChanged: (js.Function1[
    /* event */ JetElementCustomEvent[none | typings.atOracleOraclejet.atOracleOraclejetStrings.rawValue], 
    _
  ]) | Null = js.native
  ...
  def addEventListener(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[none | typings.atOracleOraclejet.atOracleOraclejetStrings.rawValue], 
      _
    ]
  ): Unit = js.native
  def addEventListener(
  ...
  def addEventListener_ojValueUpdated(
    `type`: typings.atOracleOraclejet.atOracleOraclejetStrings.ojValueUpdated,
  ...
  @JSName("getProperty")
  def getProperty_filterOnOpen(property: filterOnOpen): none | typings.atOracleOraclejet.atOracleOraclejetStrings.rawValue = js.native
  @JSName("getProperty")
  ...
  def setProperty(property: filterOnOpen, value: typings.atOracleOraclejet.atOracleOraclejetStrings.rawValue): Unit = js.native
  @JSName("setProperty")
