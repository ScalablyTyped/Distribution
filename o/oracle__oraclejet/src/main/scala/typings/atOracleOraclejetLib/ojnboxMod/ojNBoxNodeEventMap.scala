...
object ojNBoxNodeEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("groupCategoryChanged")(groupCategoryChanged)
    __obj.updateDynamic("iconChanged")(iconChanged)
    __obj.updateDynamic("indicatorColorChanged")(indicatorColorChanged)
    __obj.updateDynamic("indicatorIconChanged")(indicatorIconChanged)
    ...
    __obj.updateDynamic("secondaryLabelChanged")(secondaryLabelChanged)
    ...
    __obj.updateDynamic("xPercentageChanged")(xPercentageChanged)
    __obj.updateDynamic("yPercentageChanged")(yPercentageChanged)
