...
@js.native
trait ojChartGroup
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojChartGroupSettableProperties] {
  ...
  @JSName("getProperty")
  def getProperty_name(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.name): js.UndefOr[java.lang.String] = js.native
  @JSName("getProperty")
  ...
  def setProperties(properties: ojChartGroupSettablePropertiesLenient): scala.Unit = js.native
  def setProperty(
  ...
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojChartGroupSettableProperties]
  ): scala.Unit = js.native
  @JSName("setProperty")
