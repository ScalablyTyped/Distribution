...
object ojChartSettableProperties {
  ...
  def apply[K, D](
    ...
    dataLabel: atOracleOraclejetLib.ojchartMod.ojChartNs.DataLabelContext => atOracleOraclejetLib.Anon_Insert | atOracleOraclejetLib.Anon_PreventDefault,
    ...
    groupComparator: (/* param0 */ js.Object, /* param1 */ js.Object) => scala.Double = null,
    seriesComparator: (/* param0 */ js.Object, /* param1 */ js.Object) => scala.Double = null
