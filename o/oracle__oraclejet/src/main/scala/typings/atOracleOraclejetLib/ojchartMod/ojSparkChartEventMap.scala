...
trait ojSparkChartEventMap[K, D]
  ...
  var areaSvgStyleChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
...
object ojSparkChartEventMap {
  ...
  def apply[K, D](
    ...
    areaSvgStyleChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      /* import warning: ImportType.apply Failed type conversion: @oracle/oraclejet.@oracle/oraclejet/ojchart.ojSparkChart<K, D>['areaSvgStyle'] */ js.Any
    ],
