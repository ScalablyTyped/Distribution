...
trait ojSparkChartEventMap[K, D]
  ...
  var areaSvgStyleChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[_]
...
object ojSparkChartEventMap {
  ...
  def apply[K, D](
    ...
    areaSvgStyleChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[_],
    ...
    __obj.updateDynamic("areaColorChanged")(areaColorChanged)
    __obj.updateDynamic("areaSvgClassNameChanged")(areaSvgClassNameChanged)
    __obj.updateDynamic("areaSvgStyleChanged")(areaSvgStyleChanged)
    __obj.updateDynamic("asChanged")(asChanged)
    __obj.updateDynamic("auxclick")(auxclick)
    __obj.updateDynamic("barGapRatioChanged")(barGapRatioChanged)
    __obj.updateDynamic("baselineScalingChanged")(baselineScalingChanged)
    ...
    __obj.updateDynamic("firstColorChanged")(firstColorChanged)
    ...
    __obj.updateDynamic("highColorChanged")(highColorChanged)
    ...
    __obj.updateDynamic("lastColorChanged")(lastColorChanged)
    __obj.updateDynamic("lineStyleChanged")(lineStyleChanged)
    __obj.updateDynamic("lineTypeChanged")(lineTypeChanged)
    ...
    __obj.updateDynamic("lowColorChanged")(lowColorChanged)
