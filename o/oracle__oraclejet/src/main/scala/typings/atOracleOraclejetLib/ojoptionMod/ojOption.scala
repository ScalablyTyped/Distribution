...
@js.native
trait ojOption
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojOptionSettableProperties] {
  ...
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojOptionSettableProperties]
  ): scala.Unit = js.native
  @JSName("setProperty")
