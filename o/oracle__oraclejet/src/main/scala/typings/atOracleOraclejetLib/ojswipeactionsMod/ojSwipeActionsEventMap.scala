...
trait ojSwipeActionsEventMap
  extends atOracleOraclejetLib.atOracleOraclejetMod.baseComponentEventMap[ojSwipeActionsSettableProperties] {
  var ojAction: atOracleOraclejetLib.ojswipeactionsMod.ojSwipeActionsNs.ojAction
}
...
object ojSwipeActionsEventMap {
  ...
  def apply(
    ...
    ojAction: atOracleOraclejetLib.ojswipeactionsMod.ojSwipeActionsNs.ojAction,
