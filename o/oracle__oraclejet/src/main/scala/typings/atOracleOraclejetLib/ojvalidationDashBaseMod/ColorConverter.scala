...
class ColorConverter ()
  extends Converter[atOracleOraclejetLib.ojcolorMod.^] {
  def this(options: atOracleOraclejetLib.ojvalidationDashBaseMod.ColorConverterNs.ConverterOptions) = this()
  /* CompleteClass */
  override def format(value: atOracleOraclejetLib.ojcolorMod.^): java.lang.String | scala.Null = js.native
  @JSName("getHint")
  def getHint_MColorConverter(): java.lang.String = js.native
  /* CompleteClass */
  override def parse(value: java.lang.String): atOracleOraclejetLib.ojcolorMod.^  | scala.Null = js.native
