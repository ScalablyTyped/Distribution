...
object ojColorSpectrumEventMap {
  ...
  def apply(
    ...
    ojAnimateEnd: atOracleOraclejetLib.ojcolorspectrumMod.ojColorSpectrumNs.ojAnimateEnd,
    ojAnimateStart: atOracleOraclejetLib.ojcolorspectrumMod.ojColorSpectrumNs.ojAnimateStart,
