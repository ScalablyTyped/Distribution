...
object ojDiagramLinkEventMap {
  ...
  def apply(
    ...
    endNodeChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[_],
    ended: stdLib.Event,
    ...
    startNodeChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[_],
    submit: stdLib.Event,
    ...
    __obj.updateDynamic("endConnectorTypeChanged")(endConnectorTypeChanged)
    __obj.updateDynamic("endNodeChanged")(endNodeChanged)
    ...
    __obj.updateDynamic("startConnectorTypeChanged")(startConnectorTypeChanged)
    __obj.updateDynamic("startNodeChanged")(startNodeChanged)
