...
trait ojDiagramLink
  ...
  var onEndConnectorTypeChanged: (js.Function1[
    /* event */ atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      /* import warning: ImportType.apply Failed type conversion: this['endConnectorType'] */ js.Any
    ], 
    _
  ]) | scala.Null = js.native
  var onEndNodeChanged: (js.Function1[
    /* event */ atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      /* import warning: ImportType.apply Failed type conversion: this['endNode'] */ js.Any
    ], 
    _
  ]) | scala.Null = js.native
  ...
  var onStartConnectorTypeChanged: (js.Function1[
    /* event */ atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      /* import warning: ImportType.apply Failed type conversion: this['startConnectorType'] */ js.Any
    ], 
    _
  ]) | scala.Null = js.native
  var onStartNodeChanged: (js.Function1[
    /* event */ atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      /* import warning: ImportType.apply Failed type conversion: this['startNode'] */ js.Any
    ], 
    _
  ]) | scala.Null = js.native
