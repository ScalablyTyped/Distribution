...
trait ojMenuSelectMany
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojMenuSelectManySettableProperties] {
  ...
  var onOptionsChanged: (js.Function1[
    /* event */ atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      js.Array[atOracleOraclejetLib.ojmenuselectmanyMod.ojMenuSelectManyNs.Option] | (atOracleOraclejetLib.ojdataproviderMod.DataProvider[_, _]) | scala.Null
    ], 
    _
  ]) | scala.Null = js.native
  ...
  var options: js.Array[atOracleOraclejetLib.ojmenuselectmanyMod.ojMenuSelectManyNs.Option] | (atOracleOraclejetLib.ojdataproviderMod.DataProvider[_, _]) | scala.Null = js.native
  ...
  @JSName("getProperty")
  def getProperty_options(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.options): js.Array[atOracleOraclejetLib.ojmenuselectmanyMod.ojMenuSelectManyNs.Option] | (atOracleOraclejetLib.ojdataproviderMod.DataProvider[_, _]) | scala.Null = js.native
  @JSName("getProperty")
  def getProperty_value(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.value): js.Array[_] = js.native
  def setProperties(properties: ojMenuSelectManySettablePropertiesLenient): scala.Unit = js.native
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojMenuSelectManySettableProperties]
  ): scala.Unit = js.native
  @JSName("setProperty")
  ...
  def setProperty_options(
    ...
    value: atOracleOraclejetLib.ojdataproviderMod.DataProvider[_, _]
  ): scala.Unit = js.native
  @JSName("setProperty")
  def setProperty_options(
    property: atOracleOraclejetLib.atOracleOraclejetLibStrings.options,
    value: js.Array[atOracleOraclejetLib.ojmenuselectmanyMod.ojMenuSelectManyNs.Option]
  ): scala.Unit = js.native
  @JSName("setProperty")
