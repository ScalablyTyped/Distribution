...
@js.native
trait ojGanttRow
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojGanttRowSettableProperties] {
  ...
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojGanttRowSettableProperties]
  ): scala.Unit = js.native
  @JSName("setProperty")
