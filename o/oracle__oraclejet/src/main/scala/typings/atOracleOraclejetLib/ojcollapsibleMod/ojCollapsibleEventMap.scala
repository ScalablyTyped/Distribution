...
trait ojCollapsibleEventMap
  extends atOracleOraclejetLib.atOracleOraclejetMod.baseComponentEventMap[ojCollapsibleSettableProperties] {
  var disabledChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[scala.Boolean]
  var expandAreaChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
    atOracleOraclejetLib.atOracleOraclejetLibStrings.header | atOracleOraclejetLib.atOracleOraclejetLibStrings.disclosureIcon
  ]
  var expandedChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[scala.Boolean]
  var ojBeforeCollapse: atOracleOraclejetLib.ojcollapsibleMod.ojCollapsibleNs.ojBeforeCollapse
  var ojBeforeExpand: atOracleOraclejetLib.ojcollapsibleMod.ojCollapsibleNs.ojBeforeExpand
  var ojCollapse: atOracleOraclejetLib.ojcollapsibleMod.ojCollapsibleNs.ojCollapse
  var ojExpand: atOracleOraclejetLib.ojcollapsibleMod.ojCollapsibleNs.ojExpand
}
...
object ojCollapsibleEventMap {
  ...
  def apply(
    ...
    expandAreaChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      atOracleOraclejetLib.atOracleOraclejetLibStrings.header | atOracleOraclejetLib.atOracleOraclejetLibStrings.disclosureIcon
    ],
    expandedChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[scala.Boolean],
    ...
    ojBeforeCollapse: atOracleOraclejetLib.ojcollapsibleMod.ojCollapsibleNs.ojBeforeCollapse,
    ojBeforeExpand: atOracleOraclejetLib.ojcollapsibleMod.ojCollapsibleNs.ojBeforeExpand,
    ojCollapse: atOracleOraclejetLib.ojcollapsibleMod.ojCollapsibleNs.ojCollapse,
    ojExpand: atOracleOraclejetLib.ojcollapsibleMod.ojCollapsibleNs.ojExpand,
    ...
    val __obj = js.Dynamic.literal(abort = abort, animationcancel = animationcancel, animationend = animationend, animationiteration = animationiteration, animationstart = animationstart, auxclick = auxclick, blur = blur, cancel = cancel, canplay = canplay, canplaythrough = canplaythrough, change = change, click = click, close = close, contextmenu = contextmenu, copy = copy, cuechange = cuechange, cut = cut, dblclick = dblclick, disabledChanged = disabledChanged, drag = drag, dragend = dragend, dragenter = dragenter, dragexit = dragexit, dragleave = dragleave, dragover = dragover, dragstart = dragstart, drop = drop, durationchange = durationchange, emptied = emptied, ended = ended, error = error, expandAreaChanged = expandAreaChanged, expandedChanged = expandedChanged, focus = focus, fullscreenchange = fullscreenchange, fullscreenerror = fullscreenerror, gotpointercapture = gotpointercapture, input = input, invalid = invalid, keydown = keydown, keypress = keypress, keyup = keyup, load = load, loadeddata = loadeddata, loadedmetadata = loadedmetadata, loadend = loadend, loadstart = loadstart, lostpointercapture = lostpointercapture, mousedown = mousedown, mouseenter = mouseenter, mouseleave = mouseleave, mousemove = mousemove, mouseout = mouseout, mouseover = mouseover, mouseup = mouseup, ojBeforeCollapse = ojBeforeCollapse, ojBeforeExpand = ojBeforeExpand, ojCollapse = ojCollapse, ojExpand = ojExpand, paste = paste, pause = pause, play = play, playing = playing, pointercancel = pointercancel, pointerdown = pointerdown, pointerenter = pointerenter, pointerleave = pointerleave, pointermove = pointermove, pointerout = pointerout, pointerover = pointerover, pointerup = pointerup, progress = progress, ratechange = ratechange, reset = reset, resize = resize, scroll = scroll, securitypolicyviolation = securitypolicyviolation, seeked = seeked, seeking = seeking, select = select, selectionchange = selectionchange, selectstart = selectstart, stalled = stalled, submit = submit, suspend = suspend, timeupdate = timeupdate, toggle = toggle, touchcancel = touchcancel, touchend = touchend, touchmove = touchmove, touchstart = touchstart, transitioncancel = transitioncancel, transitionend = transitionend, transitionrun = transitionrun, transitionstart = transitionstart, translationsChanged = translationsChanged, volumechange = volumechange, waiting = waiting, wheel = wheel)
