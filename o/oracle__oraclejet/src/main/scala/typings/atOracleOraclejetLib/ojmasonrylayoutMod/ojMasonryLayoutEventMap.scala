...
object ojMasonryLayoutEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("ojBeforeInsert")(ojBeforeInsert)
    __obj.updateDynamic("ojBeforeRemove")(ojBeforeRemove)
    __obj.updateDynamic("ojBeforeReorder")(ojBeforeReorder)
    __obj.updateDynamic("ojBeforeResize")(ojBeforeResize)
    __obj.updateDynamic("ojInsert")(ojInsert)
    ...
    __obj.updateDynamic("reorderHandleChanged")(reorderHandleChanged)
