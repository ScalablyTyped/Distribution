...
trait ojLabelEventMap
  extends atOracleOraclejetLib.atOracleOraclejetMod.baseComponentEventMap[ojLabelSettableProperties] {
  var forChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[java.lang.String | scala.Null]
  var helpChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[atOracleOraclejetLib.Anon_DefinitionSource]
  var labelIdChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[java.lang.String | scala.Null]
  var showRequiredChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[scala.Boolean | scala.Null]
}
...
object ojLabelEventMap {
  ...
  def apply(
    ...
    forChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[java.lang.String | scala.Null],
    fullscreenchange: stdLib.Event,
    fullscreenerror: stdLib.Event,
    gotpointercapture: stdLib.PointerEvent,
    helpChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[atOracleOraclejetLib.Anon_DefinitionSource],
    input: stdLib.Event,
    invalid: stdLib.Event,
    keydown: stdLib.KeyboardEvent,
    keypress: stdLib.KeyboardEvent,
    keyup: stdLib.KeyboardEvent,
    labelIdChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[java.lang.String | scala.Null],
    load: stdLib.Event,
    ...
    showRequiredChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[scala.Boolean | scala.Null],
    ...
    __obj.updateDynamic("forChanged")(forChanged)
    ...
    __obj.updateDynamic("labelIdChanged")(labelIdChanged)
    ...
    __obj.updateDynamic("showRequiredChanged")(showRequiredChanged)
