...
@js.native
trait ojOptgroup
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojOptgroupSettableProperties] {
  ...
  def setProperties(properties: ojOptgroupSettablePropertiesLenient): scala.Unit = js.native
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojOptgroupSettableProperties]
  ): scala.Unit = js.native
  @JSName("setProperty")
