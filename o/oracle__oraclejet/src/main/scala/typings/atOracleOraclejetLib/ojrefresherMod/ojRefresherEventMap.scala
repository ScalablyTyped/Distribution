...
trait ojRefresherEventMap
  extends atOracleOraclejetLib.atOracleOraclejetMod.baseComponentEventMap[ojRefresherSettableProperties] {
  var refreshContentChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[js.Function0[js.Promise[_]]]
  var targetChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[stdLib.Element]
  var textChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[java.lang.String]
  var thresholdChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[scala.Double]
}
...
object ojRefresherEventMap {
  ...
  def apply(
    ...
    refreshContentChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[js.Function0[js.Promise[_]]],
    reset: stdLib.Event,
    ...
    targetChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[stdLib.Element],
    textChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[java.lang.String],
    thresholdChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[scala.Double],
