...
object ojRefresherEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("refreshContentChanged")(refreshContentChanged)
    ...
    __obj.updateDynamic("targetChanged")(targetChanged)
    __obj.updateDynamic("textChanged")(textChanged)
    __obj.updateDynamic("thresholdChanged")(thresholdChanged)
