package typings
package atOracleOraclejetLib.ojdeferMod
...
@js.native
trait ojDefer
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojDeferSettableProperties] {
  ...
  def getProperty[T /* <: java.lang.String */](property: T): /* import warning: ImportType.apply Failed type conversion: @oracle/oraclejet.@oracle/oraclejet/ojdefer.ojDefer[T] */ js.Any = js.native
  def setProperties(properties: ojDeferSettablePropertiesLenient): scala.Unit = js.native
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: (/* import warning: ImportType.apply Failed type conversion: @oracle/oraclejet.@oracle/oraclejet/ojdefer.ojDeferSettableProperties[T] */ js.Any) | (atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojDeferSettableProperties])
  ): scala.Unit = js.native
}
