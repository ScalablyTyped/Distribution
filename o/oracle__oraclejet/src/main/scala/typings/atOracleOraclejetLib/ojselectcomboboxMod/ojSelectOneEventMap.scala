...
object ojSelectOneEventMap {
  ...
  def apply[K, D](
    ...
    ojAnimateEnd: atOracleOraclejetLib.ojselectcomboboxMod.ojSelectOneNs.ojAnimateEnd,
    ojAnimateStart: atOracleOraclejetLib.ojselectcomboboxMod.ojSelectOneNs.ojAnimateStart,
    ...
    __obj.updateDynamic("minimumResultsForSearchChanged")(minimumResultsForSearchChanged)
    ...
    __obj.updateDynamic("renderModeChanged")(renderModeChanged)
