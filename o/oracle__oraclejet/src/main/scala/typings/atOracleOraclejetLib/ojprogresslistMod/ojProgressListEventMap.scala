...
trait ojProgressListEventMap
  ...
  var dataChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[(atOracleOraclejetLib.ojdataproviderMod.DataProvider[_, _]) | scala.Null]
}
...
object ojProgressListEventMap {
  ...
  def apply(
    ...
    dataChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[(atOracleOraclejetLib.ojdataproviderMod.DataProvider[_, _]) | scala.Null],
