...
object ojFormLayoutEventMap {
  ...
  def apply(
    ...
    directionChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      atOracleOraclejetLib.atOracleOraclejetLibStrings.column | atOracleOraclejetLib.atOracleOraclejetLibStrings.row
    ],
    ...
    labelEdgeChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      atOracleOraclejetLib.atOracleOraclejetLibStrings.start | atOracleOraclejetLib.atOracleOraclejetLibStrings.top
    ],
    labelWidthChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[java.lang.String],
    labelWrappingChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      atOracleOraclejetLib.atOracleOraclejetLibStrings.truncate | atOracleOraclejetLib.atOracleOraclejetLibStrings.wrap
    ],
    load: stdLib.Event,
    ...
    maxColumnsChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[scala.Double],
    ...
    __obj.updateDynamic("directionChanged")(directionChanged)
    ...
    __obj.updateDynamic("labelEdgeChanged")(labelEdgeChanged)
    __obj.updateDynamic("labelWidthChanged")(labelWidthChanged)
    __obj.updateDynamic("labelWrappingChanged")(labelWrappingChanged)
    ...
    __obj.updateDynamic("maxColumnsChanged")(maxColumnsChanged)
