...
trait ojButtonsetMany extends ojButtonset[ojButtonsetManySettableProperties] {
  ...
  var value: js.Array[_] | scala.Null = js.native
  ...
  def addEventListener_valueChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ stdLib.HTMLElement, 
      /* ev */ atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[js.Array[_] | scala.Null], 
      _
    ]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("getProperty")
  def getProperty_value(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.value): js.Array[_] | scala.Null = js.native
  def setProperties(properties: ojButtonsetManySettablePropertiesLenient): scala.Unit = js.native
  def setProperty(
