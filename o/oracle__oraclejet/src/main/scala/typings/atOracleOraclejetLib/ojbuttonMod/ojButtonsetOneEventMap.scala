...
trait ojButtonsetOneEventMap
  extends atOracleOraclejetLib.atOracleOraclejetMod.baseComponentEventMap[ojButtonsetOneSettableProperties] {
  ...
  var valueChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[_]
}
...
object ojButtonsetOneEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("focusManagementChanged")(focusManagementChanged)
