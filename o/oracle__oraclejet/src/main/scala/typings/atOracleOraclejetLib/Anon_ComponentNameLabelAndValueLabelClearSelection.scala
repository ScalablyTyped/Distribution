...
trait Anon_ComponentNameLabelAndValueLabelClearSelection extends js.Object {
  ...
  var promotedLink: js.UndefOr[java.lang.String] = js.undefined
  var promotedLinkAriaDesc: js.UndefOr[java.lang.String] = js.undefined
  var promotedLinks: js.UndefOr[java.lang.String] = js.undefined
...
object Anon_ComponentNameLabelAndValueLabelClearSelection {
  ...
  def apply(
    ...
    promotedLink: java.lang.String = null,
    promotedLinkAriaDesc: java.lang.String = null,
    promotedLinks: java.lang.String = null,
    ...
    if (promotedLink != null) __obj.updateDynamic("promotedLink")(promotedLink)
    if (promotedLinkAriaDesc != null) __obj.updateDynamic("promotedLinkAriaDesc")(promotedLinkAriaDesc)
    if (promotedLinks != null) __obj.updateDynamic("promotedLinks")(promotedLinks)
