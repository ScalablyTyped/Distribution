...
trait ojConveyorBeltEventMap
  extends atOracleOraclejetLib.atOracleOraclejetMod.baseComponentEventMap[ojConveyorBeltSettableProperties] {
  var contentParentChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[java.lang.String | scala.Null]
...
object ojConveyorBeltEventMap {
  ...
  def apply(
    ...
    close: stdLib.Event,
    contentParentChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[java.lang.String | scala.Null],
