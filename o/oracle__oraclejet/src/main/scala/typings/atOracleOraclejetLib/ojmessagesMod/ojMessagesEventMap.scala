...
object ojMessagesEventMap {
  ...
  def apply(
    ...
    messagesChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      js.Array[atOracleOraclejetLib.ojmessageMod.ojMessageNs.Message] | scala.Null | (atOracleOraclejetLib.ojdataproviderMod.DataProvider[_, atOracleOraclejetLib.ojmessageMod.ojMessageNs.Message])
    ],
    ...
    positionChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[atOracleOraclejetLib.ojmessagesMod.ojMessagesNs.Position | scala.Null],
    ...
    translationsChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[atOracleOraclejetLib.Anon_AriaLiveRegion],
    ...
    __obj.updateDynamic("messagesChanged")(messagesChanged)
