...
object ojLegendSectionEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("collapsibleChanged")(collapsibleChanged)
    ...
    __obj.updateDynamic("textHalignChanged")(textHalignChanged)
    __obj.updateDynamic("textStyleChanged")(textStyleChanged)
