...
object ojLegendItemEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("categoryVisibilityChanged")(categoryVisibilityChanged)
    ...
    __obj.updateDynamic("lineStyleChanged")(lineStyleChanged)
    __obj.updateDynamic("lineWidthChanged")(lineWidthChanged)
    ...
    __obj.updateDynamic("markerColorChanged")(markerColorChanged)
    __obj.updateDynamic("markerShapeChanged")(markerShapeChanged)
    __obj.updateDynamic("markerSvgClassNameChanged")(markerSvgClassNameChanged)
    __obj.updateDynamic("markerSvgStyleChanged")(markerSvgStyleChanged)
    ...
    __obj.updateDynamic("symbolTypeChanged")(symbolTypeChanged)
