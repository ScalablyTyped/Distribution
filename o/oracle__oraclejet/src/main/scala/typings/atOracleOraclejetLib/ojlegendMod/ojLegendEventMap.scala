...
object ojLegendEventMap {
  ...
  def apply[K, D](
    ...
    __obj.updateDynamic("halignChanged")(halignChanged)
    ...
    __obj.updateDynamic("scrollingChanged")(scrollingChanged)
    ...
    __obj.updateDynamic("symbolHeightChanged")(symbolHeightChanged)
    __obj.updateDynamic("symbolWidthChanged")(symbolWidthChanged)
    ...
    __obj.updateDynamic("valignChanged")(valignChanged)
