...
trait ojAccordionEventMap
  extends atOracleOraclejetLib.atOracleOraclejetMod.baseComponentEventMap[ojAccordionSettableProperties] {
  var expandedChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[js.Array[atOracleOraclejetLib.Anon_Id] | scala.Null]
  var multipleChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[scala.Boolean]
  var ojBeforeCollapse: atOracleOraclejetLib.ojaccordionMod.ojAccordionNs.ojBeforeCollapse
  var ojBeforeExpand: atOracleOraclejetLib.ojaccordionMod.ojAccordionNs.ojBeforeExpand
  var ojCollapse: atOracleOraclejetLib.ojaccordionMod.ojAccordionNs.ojCollapse
  var ojExpand: atOracleOraclejetLib.ojaccordionMod.ojAccordionNs.ojExpand
}
...
object ojAccordionEventMap {
  ...
  def apply(
    ...
    expandedChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[js.Array[atOracleOraclejetLib.Anon_Id] | scala.Null],
    ...
    multipleChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[scala.Boolean],
    ojBeforeCollapse: atOracleOraclejetLib.ojaccordionMod.ojAccordionNs.ojBeforeCollapse,
    ojBeforeExpand: atOracleOraclejetLib.ojaccordionMod.ojAccordionNs.ojBeforeExpand,
    ojCollapse: atOracleOraclejetLib.ojaccordionMod.ojAccordionNs.ojCollapse,
    ojExpand: atOracleOraclejetLib.ojaccordionMod.ojAccordionNs.ojExpand,
    ...
    __obj.updateDynamic("multipleChanged")(multipleChanged)
