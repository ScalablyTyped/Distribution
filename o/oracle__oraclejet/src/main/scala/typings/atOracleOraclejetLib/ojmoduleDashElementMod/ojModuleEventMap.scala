...
trait ojModuleEventMap
  ...
  var ojViewConnected: atOracleOraclejetLib.ojmoduleDashElementMod.ojModuleNs.ojViewConnected
  var ojViewDisconnected: atOracleOraclejetLib.ojmoduleDashElementMod.ojModuleNs.ojViewDisconnected
}
...
object ojModuleEventMap {
  ...
  def apply(
    ...
    close: stdLib.Event,
    configChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[atOracleOraclejetLib.Anon_CleanupMode],
    ...
    ojTransitionEnd: atOracleOraclejetLib.ojmoduleDashElementMod.ojModuleNs.ojTransitionEnd,
    ojTransitionStart: atOracleOraclejetLib.ojmoduleDashElementMod.ojModuleNs.ojTransitionStart,
    ojViewConnected: atOracleOraclejetLib.ojmoduleDashElementMod.ojModuleNs.ojViewConnected,
    ojViewDisconnected: atOracleOraclejetLib.ojmoduleDashElementMod.ojModuleNs.ojViewDisconnected,
    ...
    __obj.updateDynamic("animationChanged")(animationChanged)
    ...
    __obj.updateDynamic("configChanged")(configChanged)
    ...
    __obj.updateDynamic("ojTransitionEnd")(ojTransitionEnd)
    __obj.updateDynamic("ojTransitionStart")(ojTransitionStart)
    __obj.updateDynamic("ojViewConnected")(ojViewConnected)
    __obj.updateDynamic("ojViewDisconnected")(ojViewDisconnected)
