...
trait baseComponentEventMap[SP /* <: baseComponentSettableProperties */]
  ...
  var translationsChanged: JetElementCustomEvent[js.Object | scala.Null]
}

object baseComponentEventMap {
  @scala.inline
  def apply[SP /* <: baseComponentSettableProperties */](
    ...
    translationsChanged: JetElementCustomEvent[js.Object | scala.Null],
    volumechange: stdLib.Event,
    waiting: stdLib.Event,
    wheel: stdLib.WheelEvent
  ): baseComponentEventMap[SP] = {
