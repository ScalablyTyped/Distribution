...
trait baseComponent[SP /* <: baseComponentSettableProperties */] extends JetElement[SP] {
  var onTranslationsChanged: (js.Function1[/* event */ JetElementCustomEvent[js.Object | scala.Null], _]) | scala.Null = js.native
  var translations: js.Object | scala.Null = js.native
  ...
  def addEventListener_translationsChanged(
    ...
    listener: js.ThisFunction1[
      ...
      /* ev */ JetElementCustomEvent[js.Object | scala.Null], 
      _
    ]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("getProperty")
  def getProperty_translations(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.translations): js.Object | scala.Null = js.native
  def refresh(): scala.Unit = js.native
  def setProperties(properties: baseComponentSettablePropertiesLenient): scala.Unit = js.native
  def setProperty[T /* <: java.lang.String */](property: T, value: JetSetPropertyType[T, baseComponentSettableProperties]): scala.Unit = js.native
  @JSName("setProperty")
  def setProperty_translations(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.translations): scala.Unit = js.native
  @JSName("setProperty")
  def setProperty_translations(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.translations, value: js.Object): scala.Unit = js.native
}
