...
object ojDialogEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("cancelBehaviorChanged")(cancelBehaviorChanged)
    ...
    __obj.updateDynamic("dialogTitleChanged")(dialogTitleChanged)
    __obj.updateDynamic("drag")(drag)
    __obj.updateDynamic("dragAffordanceChanged")(dragAffordanceChanged)
    ...
    __obj.updateDynamic("initialVisibilityChanged")(initialVisibilityChanged)
    ...
    __obj.updateDynamic("modalityChanged")(modalityChanged)
    ...
    __obj.updateDynamic("ojBeforeClose")(ojBeforeClose)
    __obj.updateDynamic("ojBeforeOpen")(ojBeforeOpen)
    __obj.updateDynamic("ojClose")(ojClose)
    __obj.updateDynamic("ojFocus")(ojFocus)
    __obj.updateDynamic("ojOpen")(ojOpen)
    __obj.updateDynamic("ojResize")(ojResize)
    __obj.updateDynamic("ojResizeStart")(ojResizeStart)
    __obj.updateDynamic("ojResizeStop")(ojResizeStop)
    ...
    __obj.updateDynamic("resizeBehaviorChanged")(resizeBehaviorChanged)
    __obj.updateDynamic("roleChanged")(roleChanged)
