...
object editableValueEventMap {
  ...
  def apply[V, SP /* <: editableValueSettableProperties[V, SV, RV] */, SV, RV](
    ...
    ojAnimateEnd: atOracleOraclejetLib.ojeditablevalueMod.editableValueNs.ojAnimateEnd,
    ojAnimateStart: atOracleOraclejetLib.ojeditablevalueMod.editableValueNs.ojAnimateStart,
