...
trait ojValidationGroup
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojValidationGroupSettableProperties] {
  var onValidChanged: (js.Function1[
    /* event */ atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      /* import warning: ImportType.apply Failed type conversion: this['valid'] */ js.Any
    ], 
    _
  ...
  def setProperties(properties: ojValidationGroupSettablePropertiesLenient): scala.Unit = js.native
  def setProperty(
  ...
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojValidationGroupSettableProperties]
  ): scala.Unit = js.native
  @JSName("setProperty")
