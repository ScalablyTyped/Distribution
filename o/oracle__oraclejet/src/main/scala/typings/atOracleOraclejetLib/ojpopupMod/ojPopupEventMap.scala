...
object ojPopupEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("autoDismissChanged")(autoDismissChanged)
    ...
    __obj.updateDynamic("chromeChanged")(chromeChanged)
    ...
    __obj.updateDynamic("initialFocusChanged")(initialFocusChanged)
    ...
    __obj.updateDynamic("tailChanged")(tailChanged)
