...
object ojPictoChartItemEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("borderWidthChanged")(borderWidthChanged)
    ...
    __obj.updateDynamic("columnSpanChanged")(columnSpanChanged)
    ...
    __obj.updateDynamic("nameChanged")(nameChanged)
    ...
    __obj.updateDynamic("rowSpanChanged")(rowSpanChanged)
    ...
    __obj.updateDynamic("shapeChanged")(shapeChanged)
    __obj.updateDynamic("shortDescChanged")(shortDescChanged)
    __obj.updateDynamic("sourceChanged")(sourceChanged)
    __obj.updateDynamic("sourceHoverChanged")(sourceHoverChanged)
    __obj.updateDynamic("sourceHoverSelectedChanged")(sourceHoverSelectedChanged)
    __obj.updateDynamic("sourceSelectedChanged")(sourceSelectedChanged)
