...
object ojPictoChartEventMap {
  ...
  def apply[K, D](
    ...
    __obj.updateDynamic("columnCountChanged")(columnCountChanged)
    __obj.updateDynamic("columnWidthChanged")(columnWidthChanged)
    ...
    __obj.updateDynamic("layoutOriginChanged")(layoutOriginChanged)
    ...
    __obj.updateDynamic("rowCountChanged")(rowCountChanged)
    __obj.updateDynamic("rowHeightChanged")(rowHeightChanged)
