...
@js.native
trait ojMessage
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojMessageSettableProperties] {
  ...
  def addEventListener_ojAnimateEnd(
    ...
    listener: js.ThisFunction1[
      /* this */ stdLib.HTMLElement, 
      /* ev */ atOracleOraclejetLib.ojmessageMod.ojMessageNs.ojAnimateEnd, 
      _
    ]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_ojAnimateStart(
    ...
    listener: js.ThisFunction1[
      /* this */ stdLib.HTMLElement, 
      /* ev */ atOracleOraclejetLib.ojmessageMod.ojMessageNs.ojAnimateStart, 
      _
    ]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_ojClose(
    ...
    listener: js.ThisFunction1[
      /* this */ stdLib.HTMLElement, 
      /* ev */ atOracleOraclejetLib.ojmessageMod.ojMessageNs.ojClose, 
      _
    ]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("getProperty")
  def getProperty_message(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.message): atOracleOraclejetLib.ojmessageMod.ojMessageNs.Message = js.native
  @JSName("getProperty")
  def getProperty_translations(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.translations): atOracleOraclejetLib.Anon_Categories = js.native
  def setProperties(properties: ojMessageSettablePropertiesLenient): scala.Unit = js.native
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojMessageSettableProperties]
  ): scala.Unit = js.native
  @JSName("setProperty")
  ...
  @JSName("setProperty")
  def setProperty_message(
    property: atOracleOraclejetLib.atOracleOraclejetLibStrings.message,
    value: atOracleOraclejetLib.ojmessageMod.ojMessageNs.Message
  ): scala.Unit = js.native
  @JSName("setProperty")
  def setProperty_translations(
    property: atOracleOraclejetLib.atOracleOraclejetLibStrings.translations,
    value: atOracleOraclejetLib.Anon_Categories
  ): scala.Unit = js.native
}
