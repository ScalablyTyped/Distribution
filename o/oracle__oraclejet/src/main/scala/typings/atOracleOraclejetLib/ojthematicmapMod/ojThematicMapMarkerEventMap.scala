...
object ojThematicMapMarkerEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("borderStyleChanged")(borderStyleChanged)
    ...
    __obj.updateDynamic("heightChanged")(heightChanged)
    ...
    __obj.updateDynamic("labelPositionChanged")(labelPositionChanged)
    ...
    __obj.updateDynamic("locationChanged")(locationChanged)
    ...
    __obj.updateDynamic("opacityChanged")(opacityChanged)
    ...
    __obj.updateDynamic("xChanged")(xChanged)
    __obj.updateDynamic("yChanged")(yChanged)
