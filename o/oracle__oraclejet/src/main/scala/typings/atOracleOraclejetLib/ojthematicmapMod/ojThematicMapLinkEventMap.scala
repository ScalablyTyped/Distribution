...
trait ojThematicMapLinkEventMap
  ...
  var endLocationChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[atOracleOraclejetLib.Anon_IdLocation]
  ...
  var startLocationChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[atOracleOraclejetLib.Anon_IdLocation]
...
object ojThematicMapLinkEventMap {
  ...
  def apply(
    ...
    endLocationChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[atOracleOraclejetLib.Anon_IdLocation],
    ended: stdLib.Event,
    ...
    startLocationChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[atOracleOraclejetLib.Anon_IdLocation],
    submit: stdLib.Event,
