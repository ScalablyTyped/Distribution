...
object ojThematicMapLinkEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("endLocationChanged")(endLocationChanged)
    ...
    __obj.updateDynamic("selectableChanged")(selectableChanged)
    __obj.updateDynamic("shortDescChanged")(shortDescChanged)
    __obj.updateDynamic("stalled")(stalled)
    __obj.updateDynamic("startLocationChanged")(startLocationChanged)
    ...
    __obj.updateDynamic("widthChanged")(widthChanged)
