...
@js.native
trait ojTagCloudItem
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojTagCloudItemSettableProperties] {
  ...
  @JSName("addEventListener")
  def addEventListener_urlChanged(
    `type`: atOracleOraclejetLib.atOracleOraclejetLibStrings.urlChanged,
    listener: js.ThisFunction1[
      /* this */ stdLib.HTMLElement, 
      /* ev */ atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[java.lang.String], 
      _
  ...
  @JSName("getProperty")
  def getProperty_svgStyle(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.svgStyle): /* import warning: ImportType.apply Failed type conversion: @oracle/oraclejet.@oracle/oraclejet/ojtagcloud.ojTagCloudItem['svgStyle'] */ js.Any = js.native
  @JSName("getProperty")
  def getProperty_url(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.url): java.lang.String = js.native
  @JSName("getProperty")
  def getProperty_value(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.value): scala.Double | scala.Null = js.native
  def setProperties(properties: ojTagCloudItemSettablePropertiesLenient): scala.Unit = js.native
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojTagCloudItemSettableProperties]
  ): scala.Unit = js.native
  @JSName("setProperty")
  ...
  @JSName("setProperty")
  def setProperty_url(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.url, value: java.lang.String): scala.Unit = js.native
  @JSName("setProperty")
