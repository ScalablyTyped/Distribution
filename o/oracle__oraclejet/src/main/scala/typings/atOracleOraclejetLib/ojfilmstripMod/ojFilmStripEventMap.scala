...
object ojFilmStripEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("arrowPlacementChanged")(arrowPlacementChanged)
    __obj.updateDynamic("arrowVisibilityChanged")(arrowVisibilityChanged)
    ...
    __obj.updateDynamic("loopingChanged")(loopingChanged)
    __obj.updateDynamic("lostpointercapture")(lostpointercapture)
    __obj.updateDynamic("maxItemsPerPageChanged")(maxItemsPerPageChanged)
