...
object ojSliderEventMap {
  ...
  def apply(
    ...
    ojAnimateEnd: atOracleOraclejetLib.ojsliderMod.ojSliderNs.ojAnimateEnd,
    ojAnimateStart: atOracleOraclejetLib.ojsliderMod.ojSliderNs.ojAnimateStart,
    ...
    transientValueChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[scala.Double],
