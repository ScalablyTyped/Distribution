...
object ojDateTimePickerEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("datePickerChanged")(datePickerChanged)
    __obj.updateDynamic("dayFormatterChanged")(dayFormatterChanged)
    __obj.updateDynamic("dayMetaDataChanged")(dayMetaDataChanged)
    ...
    __obj.updateDynamic("keyboardEditChanged")(keyboardEditChanged)
    ...
    __obj.updateDynamic("timePickerChanged")(timePickerChanged)
