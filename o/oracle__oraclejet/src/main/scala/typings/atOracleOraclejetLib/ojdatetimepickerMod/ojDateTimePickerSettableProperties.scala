...
trait ojDateTimePickerSettableProperties extends ojInputDateTimeSettableProperties {
  @JSName("keyboardEdit")
  var keyboardEdit_ojDateTimePickerSettableProperties: atOracleOraclejetLib.atOracleOraclejetLibStrings.disabled
  @JSName("renderMode")
  var renderMode_ojDateTimePickerSettableProperties: atOracleOraclejetLib.atOracleOraclejetLibStrings.jet
}
