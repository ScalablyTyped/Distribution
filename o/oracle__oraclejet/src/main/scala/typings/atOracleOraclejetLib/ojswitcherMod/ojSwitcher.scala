...
@js.native
trait ojSwitcher
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojSwitcherSettableProperties] {
  ...
  @JSName("getProperty")
  def getProperty_value(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.value): java.lang.String = js.native
  def refresh(): scala.Unit = js.native
  def setProperties(properties: ojSwitcherSettablePropertiesLenient): scala.Unit = js.native
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojSwitcherSettableProperties]
  ): scala.Unit = js.native
  @JSName("setProperty")
