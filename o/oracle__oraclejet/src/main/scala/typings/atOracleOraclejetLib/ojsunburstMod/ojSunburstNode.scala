...
trait ojSunburstNode
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojSunburstNodeSettableProperties] {
  ...
  var onRadiusChanged: (js.Function1[
    /* event */ atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
      /* import warning: ImportType.apply Failed type conversion: this['radius'] */ js.Any
    ], 
    _
  ]) | scala.Null = js.native
  ...
  def addEventListener(
    `type`: atOracleOraclejetLib.atOracleOraclejetLibStrings.radiusChanged,
    listener: js.ThisFunction1[
      /* this */ stdLib.HTMLElement, 
      /* ev */ atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[
        /* import warning: ImportType.apply Failed type conversion: this['radius'] */ js.Any
  ...
  @JSName("getProperty")
  def getProperty_radius(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.radius): js.UndefOr[scala.Double] = js.native
  @JSName("getProperty")
  ...
  def setProperties(properties: ojSunburstNodeSettablePropertiesLenient): scala.Unit = js.native
  def setProperty(
  ...
  def setProperty(
    property: atOracleOraclejetLib.atOracleOraclejetLibStrings.labelDisplay,
    value: atOracleOraclejetLib.atOracleOraclejetLibStrings.rotated
  ): scala.Unit = js.native
  def setProperty(
  ...
  def setProperty(
    property: atOracleOraclejetLib.atOracleOraclejetLibStrings.labelHalign,
    value: atOracleOraclejetLib.atOracleOraclejetLibStrings.inner
  ): scala.Unit = js.native
  def setProperty(
    property: atOracleOraclejetLib.atOracleOraclejetLibStrings.labelHalign,
  ...
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojSunburstNodeSettableProperties]
  ): scala.Unit = js.native
  @JSName("setProperty")
  ...
  @JSName("setProperty")
  def setProperty_radius(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.radius, value: scala.Double): scala.Unit = js.native
  @JSName("setProperty")
