...
@js.native
trait ojLabelValue
  extends atOracleOraclejetLib.atOracleOraclejetMod.JetElement[ojLabelValueSettableProperties] {
  var labelEdge: atOracleOraclejetLib.atOracleOraclejetLibStrings.start | atOracleOraclejetLib.atOracleOraclejetLibStrings.top | atOracleOraclejetLib.atOracleOraclejetLibStrings.inherit = js.native
  ...
  def addEventListener(
    `type`: atOracleOraclejetLib.atOracleOraclejetLibStrings.labelEdgeChanged,
  ...
  @JSName("getProperty")
  def getProperty_labelEdge(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.labelEdge): atOracleOraclejetLib.atOracleOraclejetLibStrings.start | atOracleOraclejetLib.atOracleOraclejetLibStrings.top | atOracleOraclejetLib.atOracleOraclejetLibStrings.inherit = js.native
  @JSName("getProperty")
  def getProperty_labelWidth(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.labelWidth): java.lang.String = js.native
  def refresh(): scala.Unit = js.native
  def setProperties(properties: ojLabelValueSettablePropertiesLenient): scala.Unit = js.native
  def setProperty(
    property: atOracleOraclejetLib.atOracleOraclejetLibStrings.labelEdge,
  ...
  def setProperty[T /* <: java.lang.String */](
    property: T,
    value: atOracleOraclejetLib.atOracleOraclejetMod.JetSetPropertyType[T, ojLabelValueSettableProperties]
  ): scala.Unit = js.native
  @JSName("setProperty")
  def setProperty_labelWidth(property: atOracleOraclejetLib.atOracleOraclejetLibStrings.labelWidth, value: java.lang.String): scala.Unit = js.native
}
