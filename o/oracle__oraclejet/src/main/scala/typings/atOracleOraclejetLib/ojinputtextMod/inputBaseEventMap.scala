...
object inputBaseEventMap {
  ...
  def apply[V, SP /* <: inputBaseSettableProperties[V, SV, V] */, SV, RV](
    ...
    asyncValidatorsChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[js.Array[atOracleOraclejetLib.ojvalidationDashBaseMod.AsyncValidator[V]]],
    ...
    ojAnimateEnd: atOracleOraclejetLib.ojinputtextMod.inputBaseNs.ojAnimateEnd,
    ojAnimateStart: atOracleOraclejetLib.ojinputtextMod.inputBaseNs.ojAnimateStart,
    ...
    rawValueChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[RV],
