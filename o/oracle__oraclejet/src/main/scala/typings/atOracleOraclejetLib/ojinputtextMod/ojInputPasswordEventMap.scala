...
trait ojInputPasswordEventMap
  ...
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojInputPasswordEventMap: atOracleOraclejetLib.ojinputtextMod.ojInputPasswordNs.ojAnimateEnd
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojInputPasswordEventMap: atOracleOraclejetLib.ojinputtextMod.ojInputPasswordNs.ojAnimateStart
}
...
object ojInputPasswordEventMap {
  ...
  def apply(
    ...
    ojAnimateEnd: atOracleOraclejetLib.ojinputtextMod.ojInputPasswordNs.ojAnimateEnd,
    ojAnimateStart: atOracleOraclejetLib.ojinputtextMod.ojInputPasswordNs.ojAnimateStart,
    ...
    valueChanged: atOracleOraclejetLib.atOracleOraclejetMod.JetElementCustomEvent[java.lang.String | scala.Null],
