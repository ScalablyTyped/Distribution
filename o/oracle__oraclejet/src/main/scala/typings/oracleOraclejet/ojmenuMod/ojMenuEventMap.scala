...
object ojMenuEventMap {
  ...
  @scala.inline
  implicit class ojMenuEventMapOps[Self <: ojMenuEventMap] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOpenOptionsChanged(value: JetElementCustomEvent[OpenOptions]): Self = this.set("openOptionsChanged", value.asInstanceOf[js.Any])
  }
