...
import typings.oracleOraclejet.oracleOraclejetStrings.ojBeforeInsert
import typings.oracleOraclejet.oracleOraclejetStrings.ojBeforeRemove
import typings.oracleOraclejet.oracleOraclejetStrings.ojBeforeReorder
import typings.oracleOraclejet.oracleOraclejetStrings.ojBeforeResize
import typings.oracleOraclejet.oracleOraclejetStrings.ojInsert
...
object ojmasonrylayoutMod {
  ...
  trait ojMasonryLayout
    ...
    var onReorderHandleChanged: (js.Function1[/* event */ JetElementCustomEvent[String | Null], Any]) | Null = js.native
  ...
  object ojMasonryLayoutEventMap {
    ...
    inline def apply(
      ...
      mouseup: MouseEvent,
      ojAnimateEnd: typings.oracleOraclejet.ojmasonrylayoutMod.ojMasonryLayout.ojAnimateEnd,
      ojAnimateStart: typings.oracleOraclejet.ojmasonrylayoutMod.ojMasonryLayout.ojAnimateStart,
      ojBeforeInsert: typings.oracleOraclejet.ojmasonrylayoutMod.ojMasonryLayout.ojBeforeInsert,
      ojBeforeRemove: typings.oracleOraclejet.ojmasonrylayoutMod.ojMasonryLayout.ojBeforeRemove,
      ojBeforeReorder: typings.oracleOraclejet.ojmasonrylayoutMod.ojMasonryLayout.ojBeforeReorder,
      ojBeforeResize: typings.oracleOraclejet.ojmasonrylayoutMod.ojMasonryLayout.ojBeforeResize,
      ojInsert: typings.oracleOraclejet.ojmasonrylayoutMod.ojMasonryLayout.ojInsert,
      ojRemove: typings.oracleOraclejet.ojmasonrylayoutMod.ojMasonryLayout.ojRemove,
      ojReorder: typings.oracleOraclejet.ojmasonrylayoutMod.ojMasonryLayout.ojReorder,
      ojResize: typings.oracleOraclejet.ojmasonrylayoutMod.ojMasonryLayout.ojResize,
