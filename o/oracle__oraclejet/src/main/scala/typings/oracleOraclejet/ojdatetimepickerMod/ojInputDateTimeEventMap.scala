...
trait ojInputDateTimeEventMap[SP /* <: ojInputDateTimeSettableProperties */] extends ojInputDateEventMap[SP] {
  @JSName("ojAnimateEnd")
  var ojAnimateEnd_ojInputDateTimeEventMap: ojAnimateEnd = js.native
  @JSName("ojAnimateStart")
  var ojAnimateStart_ojInputDateTimeEventMap: ojAnimateStart = js.native
...
object ojInputDateTimeEventMap {
  ...
  def apply[/* <: typings.oracleOraclejet.ojdatetimepickerMod.ojInputDateTimeSettableProperties */ SP](
    ...
    submit: Event,
    suspend: Event,
    timePickerChanged: JetElementCustomEvent[FooterLayout],
    timeupdate: Event,
    toggle: Event,
  ...
  @scala.inline
  implicit class ojInputDateTimeEventMapOps[Self <: ojInputDateTimeEventMap[_], /* <: typings.oracleOraclejet.ojdatetimepickerMod.ojInputDateTimeSettableProperties */ SP] (val x: Self with ojInputDateTimeEventMap[SP]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setTimePickerChanged(value: JetElementCustomEvent[FooterLayout]): Self = this.set("timePickerChanged", value.asInstanceOf[js.Any])
  }
