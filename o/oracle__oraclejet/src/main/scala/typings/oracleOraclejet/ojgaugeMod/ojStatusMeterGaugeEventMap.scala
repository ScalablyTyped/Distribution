...
trait ojStatusMeterGaugeEventMap extends dvtBaseComponentEventMap[ojStatusMeterGaugeSettableProperties] {
  ...
  var centerChanged: JetElementCustomEvent[Anon10]
  ...
  var labelChanged: JetElementCustomEvent[AnonPositionStyle]
  var maxChanged: JetElementCustomEvent[Double]
  var metricLabelChanged: JetElementCustomEvent[AnonConverterPosition]
  var minChanged: JetElementCustomEvent[Double]
  var orientationChanged: JetElementCustomEvent[circular | vertical | horizontal]
  var plotAreaChanged: JetElementCustomEvent[AnonBorderColorBorderRadius]
  ...
  var tooltipChanged: JetElementCustomEvent[Anon11]
...
object ojStatusMeterGaugeEventMap {
  ...
  def apply(
    ...
    centerChanged: JetElementCustomEvent[Anon10],
    change: Event_,
    click: MouseEvent,
    close: Event_,
    ...
    keyup: KeyboardEvent,
    labelChanged: JetElementCustomEvent[AnonPositionStyle],
    load: Event_,
    loadeddata: Event_,
    ...
    metricLabelChanged: JetElementCustomEvent[AnonConverterPosition],
    ...
    play: Event_,
    playing: Event_,
    plotAreaChanged: JetElementCustomEvent[AnonBorderColorBorderRadius],
    ...
    timeupdate: Event_,
    toggle: Event_,
    tooltipChanged: JetElementCustomEvent[Anon11],
