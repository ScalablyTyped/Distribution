...
trait ojLedGaugeEventMap extends dvtBaseComponentEventMap[ojLedGaugeSettableProperties] {
  ...
  var labelChanged: JetElementCustomEvent[AnonText]
  var maxChanged: JetElementCustomEvent[Double]
  var metricLabelChanged: JetElementCustomEvent[AnonTextType]
  ...
  var tooltipChanged: JetElementCustomEvent[Anon8]
...
object ojLedGaugeEventMap {
  ...
  def apply(
    ...
    keyup: KeyboardEvent,
    labelChanged: JetElementCustomEvent[AnonText],
    load: Event_,
    loadeddata: Event_,
    ...
    metricLabelChanged: JetElementCustomEvent[AnonTextType],
    ...
    timeupdate: Event_,
    toggle: Event_,
    tooltipChanged: JetElementCustomEvent[Anon8],
