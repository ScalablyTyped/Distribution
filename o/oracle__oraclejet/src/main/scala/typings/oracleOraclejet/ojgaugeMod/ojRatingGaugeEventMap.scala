...
trait ojRatingGaugeEventMap extends dvtBaseComponentEventMap[ojRatingGaugeSettableProperties] {
  ...
  var changedStateChanged: JetElementCustomEvent[AnonBorderColorCircle]
  var hoverStateChanged: JetElementCustomEvent[AnonBorderColorCircle]
  ...
  var selectedStateChanged: JetElementCustomEvent[AnonBorderColorCircle]
  var stepChanged: JetElementCustomEvent[`0.5` | `1`]
  var thresholdsChanged: JetElementCustomEvent[js.Array[Threshold]]
  var tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultTooltipContext242250892]
  var transientValueChanged: JetElementCustomEvent[Double | Null]
  var unselectedStateChanged: JetElementCustomEvent[AnonBorderColorCircle]
...
object ojRatingGaugeEventMap {
  ...
  def apply(
    ...
    changedStateChanged: JetElementCustomEvent[AnonBorderColorCircle],
    click: MouseEvent,
    close: Event_,
    ...
    hoverStateChanged: JetElementCustomEvent[AnonBorderColorCircle],
    input: Event_,
    invalid: Event_,
    ...
    seeking: Event_,
    select: Event_,
    selectedStateChanged: JetElementCustomEvent[AnonBorderColorCircle],
    ...
    timeupdate: Event_,
    toggle: Event_,
    tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultTooltipContext242250892],
    ...
    unselectedStateChanged: JetElementCustomEvent[AnonBorderColorCircle],
