...
trait AnonItemKeyPreviousItemPreviousKey
...
object AnonItemKeyPreviousItemPreviousKey {
  @scala.inline
  def apply(
    item: Element,
    key: js.Any,
  ...
  ): AnonItemKeyPreviousItemPreviousKey = {
    ...
    __obj.asInstanceOf[AnonItemKeyPreviousItemPreviousKey]
  }
}
