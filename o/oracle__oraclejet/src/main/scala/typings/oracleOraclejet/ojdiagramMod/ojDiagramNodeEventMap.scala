...
trait ojDiagramNodeEventMap
  ...
  var iconChanged: JetElementCustomEvent[js.UndefOr[AnonOpacity]]
  ...
  var overviewChanged: JetElementCustomEvent[js.UndefOr[AnonIconAnonShape]]
...
object ojDiagramNodeEventMap {
  ...
  def apply(
    ...
    iconChanged: JetElementCustomEvent[js.UndefOr[AnonOpacity]],
    input: Event_,
    invalid: Event_,
    ...
    mouseup: MouseEvent,
    overviewChanged: JetElementCustomEvent[js.UndefOr[AnonIconAnonShape]],
