...
trait ojDiagramNodeEventMap
  ...
  var iconChanged: JetElementCustomEvent[js.UndefOr[AnonBorderColorBorderRadiusBorderWidth]]
  ...
  var overviewChanged: JetElementCustomEvent[js.UndefOr[AnonIconAnonCircle]]
...
object ojDiagramNodeEventMap {
  ...
  def apply(
    ...
    iconChanged: JetElementCustomEvent[js.UndefOr[AnonBorderColorBorderRadiusBorderWidth]],
    input: Event_,
    invalid: Event_,
    ...
    mouseup: MouseEvent,
    overviewChanged: JetElementCustomEvent[js.UndefOr[AnonIconAnonCircle]],
