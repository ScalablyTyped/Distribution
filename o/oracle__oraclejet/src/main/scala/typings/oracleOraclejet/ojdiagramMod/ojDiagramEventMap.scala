...
trait ojDiagramEventMap[K1, K2, D1, D2] extends dvtBaseComponentEventMap[ojDiagramSettableProperties[K1, K2, D1, D2]] {
  ...
  var dndChanged: JetElementCustomEvent[AnonDragDrop]
  ...
  var overviewChanged: JetElementCustomEvent[AnonBottom]
  ...
  var tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsert[K1, K2, D1, D2]]
...
object ojDiagramEventMap {
  ...
  def apply[K1, K2, D1, D2](
    ...
    cut: ClipboardEvent,
    dblclick: MouseEvent,
    dndChanged: JetElementCustomEvent[AnonDragDrop],
    drag: DragEvent,
    dragend: DragEvent,
    dragenter: DragEvent,
    dragexit: Event_,
    ...
    ojExpand: ojExpand,
    overviewChanged: JetElementCustomEvent[AnonBottom],
    ...
    timeupdate: Event_,
    toggle: Event_,
    tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsert[K1, K2, D1, D2]],
