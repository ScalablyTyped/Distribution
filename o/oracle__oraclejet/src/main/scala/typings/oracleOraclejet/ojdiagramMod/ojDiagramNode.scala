...
import typings.oracleOraclejet.oracleOraclejetStrings.descendantsConnectivity
import typings.oracleOraclejet.oracleOraclejetStrings.descendantsConnectivityChanged
...
trait ojDiagramNode
  ...
  def addEventListener(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.UndefOr[auto | off]], Any]
  ): Unit = js.native
  def addEventListener(
    `type`: selectableChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.UndefOr[auto | off]], Any],
  ...
  def addEventListener_iconChanged(
    `type`: iconChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.UndefOr[Opacity]], Any]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_iconChanged(
    `type`: iconChanged,
  ...
  def addEventListener_overviewChanged(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.UndefOr[`6`]], Any]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_overviewChanged(
    `type`: overviewChanged,
  ...
  var onDescendantsConnectivityChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[connected | disjoint | unknown]], Any]) | Null = js.native
  
  var onIconChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[Opacity]], Any]) | Null = js.native
  
  var onLabelChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[String]], Any]) | Null = js.native
  
  var onLabelStyleChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[js.Object | Null]], Any]) | Null = js.native
  
  var onOverviewChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[`6`]], Any]) | Null = js.native
  
  var onSelectableChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[auto | off]], Any]) | Null = js.native
  
  var onShortDescChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[String]], Any]) | Null = js.native
  
  var onShowDisclosureChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[on | off]], Any]) | Null = js.native
