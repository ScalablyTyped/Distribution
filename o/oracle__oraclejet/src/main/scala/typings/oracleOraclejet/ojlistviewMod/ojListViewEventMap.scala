...
trait ojListViewEventMap[K, D] extends baseComponentEventMap[ojListViewSettableProperties[K, D]] {
  ...
  var firstSelectedItemChanged: JetElementCustomEvent[AnonKey[K, D]]
  ...
  var scrollPositionChanged: JetElementCustomEvent[AnonOffsetX[K]]
...
object ojListViewEventMap {
  ...
  def apply[K, D](
    ...
    firstSelectedItemChanged: JetElementCustomEvent[AnonKey[K, D]],
    focus: FocusEvent,
    focusin: FocusEvent,
    focusout: FocusEvent,
    ...
    scrollPositionChanged: JetElementCustomEvent[AnonOffsetX[K]],
