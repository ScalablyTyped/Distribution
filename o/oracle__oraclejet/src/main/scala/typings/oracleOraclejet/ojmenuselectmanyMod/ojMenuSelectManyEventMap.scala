...
object ojMenuSelectManyEventMap {
  ...
  @scala.inline
  implicit class ojMenuSelectManyEventMapOps[Self <: ojMenuSelectManyEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptionsChanged(value: JetElementCustomEvent[js.Array[Option] | (DataProvider[_, _]) | Null]): Self = this.set("optionsChanged", value.asInstanceOf[js.Any])
