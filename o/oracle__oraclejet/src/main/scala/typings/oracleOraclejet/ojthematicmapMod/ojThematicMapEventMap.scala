...
trait ojThematicMapEventMap[K1, K2, K3, D1, D2, D3] extends dvtBaseComponentEventMap[ojThematicMapSettableProperties[K1, K2, K3, D1, D2, D3]] {
  ...
  var tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultD1[K1, K2, K3, D1, D2, D3]]
...
object ojThematicMapEventMap {
  ...
  def apply[K1, K2, K3, D1, D2, D3](
    ...
    timeupdate: Event_,
    toggle: Event_,
    tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultD1[K1, K2, K3, D1, D2, D3]],
