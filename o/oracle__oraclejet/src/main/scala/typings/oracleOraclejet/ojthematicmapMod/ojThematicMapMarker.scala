...
trait ojThematicMapMarker
  ...
  def addEventListener(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[solid | none], js.Any]
  ): Unit = js.native
  def addEventListener(
    `type`: borderStyleChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[solid | none], js.Any],
  ...
  def addEventListener(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[bottom | center | top], 
      js.Any
    ]
  ): Unit = js.native
  def addEventListener(
  ...
  var onBorderStyleChanged: (js.Function1[/* event */ JetElementCustomEvent[solid | none], js.Any]) | Null = js.native
  ...
  var onHeightChanged: (js.Function1[/* event */ JetElementCustomEvent[Double], js.Any]) | Null = js.native
  
  var onLabelChanged: (js.Function1[/* event */ JetElementCustomEvent[String], js.Any]) | Null = js.native
  
  var onLabelPositionChanged: (js.Function1[/* event */ JetElementCustomEvent[bottom | center | top], js.Any]) | Null = js.native
  ...
  var onLocationChanged: (js.Function1[/* event */ JetElementCustomEvent[String], js.Any]) | Null = js.native
  
  var onOpacityChanged: (js.Function1[/* event */ JetElementCustomEvent[Double], js.Any]) | Null = js.native
  
  var onRotationChanged: (js.Function1[/* event */ JetElementCustomEvent[Double], js.Any]) | Null = js.native
  
  var onSelectableChanged: (js.Function1[/* event */ JetElementCustomEvent[auto | off], js.Any]) | Null = js.native
  ...
  var onWidthChanged: (js.Function1[/* event */ JetElementCustomEvent[Double], js.Any]) | Null = js.native
  
  var onXChanged: (js.Function1[/* event */ JetElementCustomEvent[Double | Null], js.Any]) | Null = js.native
  
  var onYChanged: (js.Function1[/* event */ JetElementCustomEvent[Double | Null], js.Any]) | Null = js.native
