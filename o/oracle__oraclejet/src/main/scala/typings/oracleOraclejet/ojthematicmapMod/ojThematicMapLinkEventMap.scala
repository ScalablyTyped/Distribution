...
trait ojThematicMapLinkEventMap
  ...
  var endLocationChanged: JetElementCustomEvent[AnonIdLocation]
  var selectableChanged: JetElementCustomEvent[auto | off]
  var shortDescChanged: JetElementCustomEvent[String]
  var startLocationChanged: JetElementCustomEvent[AnonIdLocation]
...
object ojThematicMapLinkEventMap {
  ...
  def apply(
    ...
    emptied: Event_,
    endLocationChanged: JetElementCustomEvent[AnonIdLocation],
    ended: Event_,
    error: ErrorEvent,
    focus: FocusEvent,
    focusin: FocusEvent,
    ...
    stalled: Event_,
    startLocationChanged: JetElementCustomEvent[AnonIdLocation],
    submit: Event_,
    suspend: Event_,
