...
trait ojThematicMapLink
  ...
  def addEventListener_endLocationChanged(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[Location], js.Any]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_endLocationChanged(
    `type`: endLocationChanged,
  ...
  var onEndLocationChanged: (js.Function1[/* event */ JetElementCustomEvent[Location], js.Any]) | Null = js.native
  ...
  var onStartLocationChanged: (js.Function1[/* event */ JetElementCustomEvent[Location], js.Any]) | Null = js.native
