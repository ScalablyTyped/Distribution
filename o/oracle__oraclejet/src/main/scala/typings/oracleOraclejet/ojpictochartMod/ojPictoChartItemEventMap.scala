...
trait ojPictoChartItemEventMap
  ...
  var columnSpanChanged: JetElementCustomEvent[Double] = js.native
  
  var countChanged: JetElementCustomEvent[Double] = js.native
  
  var drillingChanged: JetElementCustomEvent[inherit | off | on] = js.native
  
  var nameChanged: JetElementCustomEvent[String] = js.native
  
  var rowSpanChanged: JetElementCustomEvent[Double] = js.native
...
object ojPictoChartItemEventMap {
  ...
  implicit class ojPictoChartItemEventMapOps[Self <: ojPictoChartItemEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColumnSpanChanged(value: JetElementCustomEvent[Double]): Self = this.set("columnSpanChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCountChanged(value: JetElementCustomEvent[Double]): Self = this.set("countChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDrillingChanged(value: JetElementCustomEvent[inherit | off | on]): Self = this.set("drillingChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNameChanged(value: JetElementCustomEvent[String]): Self = this.set("nameChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRowSpanChanged(value: JetElementCustomEvent[Double]): Self = this.set("rowSpanChanged", value.asInstanceOf[js.Any])
