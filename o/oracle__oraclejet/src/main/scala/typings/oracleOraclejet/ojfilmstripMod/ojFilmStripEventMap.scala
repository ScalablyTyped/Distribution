...
object ojFilmStripEventMap {
  ...
  @scala.inline
  implicit class ojFilmStripEventMapOps[Self <: ojFilmStripEventMap] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setArrowPlacementChanged(value: JetElementCustomEvent[adjacent | overlay]): Self = this.set("arrowPlacementChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setArrowVisibilityChanged(value: JetElementCustomEvent[visible | hidden | hover | auto]): Self = this.set("arrowVisibilityChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setCurrentItemChanged(value: JetElementCustomEvent[Id]): Self = this.set("currentItemChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setLoopingChanged(value: JetElementCustomEvent[off | page]): Self = this.set("loopingChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setMaxItemsPerPageChanged(value: JetElementCustomEvent[Double]): Self = this.set("maxItemsPerPageChanged", value.asInstanceOf[js.Any])
    @scala.inline
