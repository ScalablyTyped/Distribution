...
trait ojFilmStripEventMap extends baseComponentEventMap[ojFilmStripSettableProperties] {
  ...
  var currentItemChanged: JetElementCustomEvent[AnonId]
...
object ojFilmStripEventMap {
  ...
  def apply(
    ...
    copy: ClipboardEvent,
    cuechange: Event_,
    currentItemChanged: JetElementCustomEvent[AnonId],
    cut: ClipboardEvent,
    dblclick: MouseEvent,
    drag: DragEvent,
    dragend: DragEvent,
