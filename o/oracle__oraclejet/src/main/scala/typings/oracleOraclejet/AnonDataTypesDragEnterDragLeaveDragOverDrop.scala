...
trait AnonDataTypesDragEnterDragLeaveDragOverDrop extends js.Object {
...
object AnonDataTypesDragEnterDragLeaveDragOverDrop {
  @scala.inline
  def apply(
  ...
  ): AnonDataTypesDragEnterDragLeaveDragOverDrop = {
    ...
    __obj.asInstanceOf[AnonDataTypesDragEnterDragLeaveDragOverDrop]
  }
}
