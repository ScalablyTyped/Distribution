...
trait AnonBorderColorBorderRadiusBorderWidth extends js.Object {
...
object AnonBorderColorBorderRadiusBorderWidth {
  @scala.inline
  def apply(
  ...
  ): AnonBorderColorBorderRadiusBorderWidth = {
    ...
    __obj.asInstanceOf[AnonBorderColorBorderRadiusBorderWidth]
  }
}
