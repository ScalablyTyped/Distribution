...
trait editableValueEventMap[V, SP /* <: editableValueSettableProperties[V, SV, RV] */, SV, RV] extends baseComponentEventMap[SP] {
  ...
  var displayOptionsChanged: JetElementCustomEvent[AnonConverterHint]
  var helpChanged: JetElementCustomEvent[AnonInstruction]
  var helpHintsChanged: JetElementCustomEvent[AnonDefinition]
