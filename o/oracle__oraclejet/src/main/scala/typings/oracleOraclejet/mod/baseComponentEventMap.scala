...
object baseComponentEventMap {
  ...
  @scala.inline
  implicit class baseComponentEventMapOps[Self <: baseComponentEventMap[_], /* <: typings.oracleOraclejet.mod.baseComponentSettableProperties */ SP] (val x: Self with baseComponentEventMap[SP]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setTranslationsChanged(value: JetElementCustomEvent[js.Object | Null]): Self = this.set("translationsChanged", value.asInstanceOf[js.Any])
  }
