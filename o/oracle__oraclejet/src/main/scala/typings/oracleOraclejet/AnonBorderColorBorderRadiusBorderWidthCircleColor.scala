...
trait AnonBorderColorBorderRadiusBorderWidthCircleColor extends js.Object {
...
object AnonBorderColorBorderRadiusBorderWidthCircleColor {
  @scala.inline
  def apply(
    borderWidth: Double,
    opacity: Double,
  ...
  ): AnonBorderColorBorderRadiusBorderWidthCircleColor = {
    ...
    __obj.asInstanceOf[AnonBorderColorBorderRadiusBorderWidthCircleColor]
  }
}
