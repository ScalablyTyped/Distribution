...
trait ojTabBarEventMap[K, D] extends baseComponentEventMap[ojTabBarSettableProperties[K, D]] {
  ...
  var itemChanged: JetElementCustomEvent[AnonContextRendererSelectableBoolean[K, D]]
...
object ojTabBarEventMap {
  ...
  def apply[K, D](
    ...
    input: Event_,
    invalid: Event_,
    itemChanged: JetElementCustomEvent[AnonContextRendererSelectableBoolean[K, D]],
