...
import typings.oracleOraclejet.anon.CancelEdit
...
import typings.oracleOraclejet.anon.DictpropNameDirection
import typings.oracleOraclejet.anon.Horizontal
import typings.oracleOraclejet.anon.MaxColumnCount
import typings.oracleOraclejet.anon.NewDimensions
...
import typings.oracleOraclejet.anon.ScrollX
...
object ojdatagridMod {
  ...
  object ojDataGrid {
    ...
    type ojBeforeCurrentCell[K] = CustomEvent[typings.oracleOraclejet.anon.CurrentCell[K]]
    
    type ojBeforeEdit[K, D] = CustomEvent[typings.oracleOraclejet.anon.CellContext[K, D]]
    
    type ojBeforeEditEnd[K, D] = CustomEvent[CancelEdit[K, D]]
    
    type ojResize = CustomEvent[NewDimensions]
    
    type ojScroll = CustomEvent[ScrollX]
  ...
  object ojDataGridEventMap {
    ...
    inline def apply[K, D](
      ...
      mouseup: MouseEvent,
      ojBeforeCurrentCell: typings.oracleOraclejet.ojdatagridMod.ojDataGrid.ojBeforeCurrentCell[K],
      ojBeforeEdit: typings.oracleOraclejet.ojdatagridMod.ojDataGrid.ojBeforeEdit[K, D],
      ojBeforeEditEnd: typings.oracleOraclejet.ojdatagridMod.ojDataGrid.ojBeforeEditEnd[K, D],
      ojResize: typings.oracleOraclejet.ojdatagridMod.ojDataGrid.ojResize,
      ojScroll: typings.oracleOraclejet.ojdatagridMod.ojDataGrid.ojScroll,
      ojSort: typings.oracleOraclejet.ojdatagridMod.ojDataGrid.ojSort,
