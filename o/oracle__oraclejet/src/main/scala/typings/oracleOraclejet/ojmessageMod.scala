...
import typings.oracleOraclejet.anon.ActionElement
...
object ojmessageMod {
  ...
  trait ojMessage
    ...
    def addEventListener_messageChanged(
      `type`: messageChanged,
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[Message], Any]
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_messageChanged(
      `type`: messageChanged,
    ...
    var onMessageChanged: (js.Function1[/* event */ JetElementCustomEvent[Message], Any]) | Null = js.native
    
    var onOjAnimateEnd: (js.Function1[/* event */ typings.oracleOraclejet.ojmessageMod.ojMessage.ojAnimateEnd, Any]) | Null = js.native
    
    var onOjAnimateStart: (js.Function1[/* event */ typings.oracleOraclejet.ojmessageMod.ojMessage.ojAnimateStart, Any]) | Null = js.native
    
    var onOjClose: (js.Function1[/* event */ typings.oracleOraclejet.ojmessageMod.ojMessage.ojClose, Any]) | Null = js.native
    
    var onTranslationsChanged: (js.Function1[/* event */ JetElementCustomEvent[CategoriesLabelCloseIcon], Any]) | Null = js.native
  ...
  object ojMessage {
    ...
    type ojAnimateStart = CustomEvent[ActionElement]
  ...
  object ojMessageEventMap {
    ...
    inline def apply(
      ...
      mouseup: MouseEvent,
      ojAnimateEnd: typings.oracleOraclejet.ojmessageMod.ojMessage.ojAnimateEnd,
      ojAnimateStart: typings.oracleOraclejet.ojmessageMod.ojMessage.ojAnimateStart,
      ojClose: typings.oracleOraclejet.ojmessageMod.ojMessage.ojClose,
