...
trait ojGanttEventMap[K1, K2, D1, D2] extends dvtBaseComponentEventMap[ojGanttSettableProperties[K1, K2, D1, D2]] {
  ...
  var gridlinesChanged: JetElementCustomEvent[AnonAutoHidden]
  var majorAxisChanged: JetElementCustomEvent[AnonConverter]
  var minorAxisChanged: JetElementCustomEvent[AnonConverter]
  ...
  var rowAxisChanged: JetElementCustomEvent[AnonLabel[K2, D2]]
  ...
  var taskDefaultsChanged: JetElementCustomEvent[AnonAutoBaseline]
  var tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefault[K2, D2]]
...
object ojGanttEventMap {
  ...
  def apply[K1, K2, D1, D2](
    ...
    gridlinesChanged: JetElementCustomEvent[AnonAutoHidden],
    input: Event_,
    invalid: Event_,
    ...
    majorAxisChanged: JetElementCustomEvent[AnonConverter],
    minorAxisChanged: JetElementCustomEvent[AnonConverter],
    ...
    reset: Event_,
    resize: UIEvent,
    rowAxisChanged: JetElementCustomEvent[AnonLabel[K2, D2]],
    ...
    taskDefaultsChanged: JetElementCustomEvent[AnonAutoBaseline],
    timeupdate: Event_,
    toggle: Event_,
    tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefault[K2, D2]],
