...
object ojGanttSettablePropertiesLenient {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ojGanttSettablePropertiesLenient[?, ?, ?, ?], K1, K2, D1, D2] (val x: Self & (ojGanttSettablePropertiesLenient[K1, K2, D1, D2])) extends AnyVal {
