...
- Dropped {[ P in keyof @oracle/oraclejet.@oracle/oraclejet/ojgantt.ojGanttSettableProperties<K1, K2, D1, D2> ]:? @oracle/oraclejet.@oracle/oraclejet/ojgantt.ojGanttSettableProperties<K1, K2, D1, D2>[P]} */ trait ojGanttSettablePropertiesLenient[K1, K2, D1, D2]
