...
trait ojGanttTaskEventMap
  ...
  var baselineChanged: JetElementCustomEvent[AnonBorderRadiusEnd]
  ...
  var progressChanged: JetElementCustomEvent[AnonBorderRadiusHeightSvgClassName]
...
object ojGanttTaskEventMap {
  ...
  def apply(
    ...
    auxclick: MouseEvent,
    baselineChanged: JetElementCustomEvent[AnonBorderRadiusEnd],
    blur: FocusEvent,
    ...
    progressChanged: JetElementCustomEvent[AnonBorderRadiusHeightSvgClassName],
    ratechange: Event_,
    reset: Event_,
    resize: UIEvent,
