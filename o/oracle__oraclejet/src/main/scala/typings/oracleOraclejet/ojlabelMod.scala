...
object ojlabelMod {
  ...
  trait ojLabel
    ...
    def addEventListener_helpChanged(
      `type`: helpChanged,
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[DefinitionSource], Any]
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_helpChanged(
      `type`: helpChanged,
    ...
    var onForChanged: (js.Function1[/* event */ JetElementCustomEvent[String | Null], Any]) | Null = js.native
    
    var onHelpChanged: (js.Function1[/* event */ JetElementCustomEvent[DefinitionSource], Any]) | Null = js.native
    
    var onLabelIdChanged: (js.Function1[/* event */ JetElementCustomEvent[String | Null], Any]) | Null = js.native
    
    var onShowRequiredChanged: (js.Function1[/* event */ JetElementCustomEvent[Boolean | Null], Any]) | Null = js.native
