...
trait ojTreemapNodeEventMap
  ...
  var groupLabelDisplayChanged: JetElementCustomEvent[js.UndefOr[node | off | header]] = js.native
  
  var headerChanged: JetElementCustomEvent[js.UndefOr[Isolate]] = js.native
  
  var labelChanged: JetElementCustomEvent[js.UndefOr[String]] = js.native
  
  var labelDisplayChanged: JetElementCustomEvent[js.UndefOr[off | node]] = js.native
  
  var labelHalignChanged: JetElementCustomEvent[js.UndefOr[start | end | center]] = js.native
  
  var labelStyleChanged: JetElementCustomEvent[js.UndefOr[js.Object]] = js.native
  
  var labelValignChanged: JetElementCustomEvent[js.UndefOr[top | bottom | center]] = js.native
...
object ojTreemapNodeEventMap {
  ...
  def apply(
    ...
    groupLabelDisplayChanged: JetElementCustomEvent[js.UndefOr[node | off | header]],
    headerChanged: JetElementCustomEvent[js.UndefOr[Isolate]],
    input: Event,
    invalid: Event,
    ...
    labelDisplayChanged: JetElementCustomEvent[js.UndefOr[off | node]],
    labelHalignChanged: JetElementCustomEvent[js.UndefOr[start | end | center]],
    labelStyleChanged: JetElementCustomEvent[js.UndefOr[js.Object]],
    labelValignChanged: JetElementCustomEvent[js.UndefOr[top | bottom | center]],
    load: Event,
    loadeddata: Event,
  ...
  implicit class ojTreemapNodeEventMapOps[Self <: ojTreemapNodeEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroupLabelDisplayChanged(value: JetElementCustomEvent[js.UndefOr[node | off | header]]): Self = this.set("groupLabelDisplayChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHeaderChanged(value: JetElementCustomEvent[js.UndefOr[Isolate]]): Self = this.set("headerChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelChanged(value: JetElementCustomEvent[js.UndefOr[String]]): Self = this.set("labelChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelDisplayChanged(value: JetElementCustomEvent[js.UndefOr[off | node]]): Self = this.set("labelDisplayChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelHalignChanged(value: JetElementCustomEvent[js.UndefOr[start | end | center]]): Self = this.set("labelHalignChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabelValignChanged(value: JetElementCustomEvent[js.UndefOr[top | bottom | center]]): Self = this.set("labelValignChanged", value.asInstanceOf[js.Any])
