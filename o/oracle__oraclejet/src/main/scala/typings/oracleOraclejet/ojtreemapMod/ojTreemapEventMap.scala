...
trait ojTreemapEventMap[K, D] extends dvtBaseComponentEventMap[ojTreemapSettableProperties[K, D]] {
  ...
  var nodeContentChanged: JetElementCustomEvent[AnonContextRendererAnonInsertDK[K, D]]
  var nodeDefaultsChanged: JetElementCustomEvent[AnonBottomCenter]
  ...
  var tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultDK[K, D]]
...
object ojTreemapEventMap {
  ...
  def apply[K, D](
    ...
    mouseup: MouseEvent,
    nodeContentChanged: JetElementCustomEvent[AnonContextRendererAnonInsertDK[K, D]],
    nodeDefaultsChanged: JetElementCustomEvent[AnonBottomCenter],
    ...
    timeupdate: Event_,
    toggle: Event_,
    tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultDK[K, D]],
