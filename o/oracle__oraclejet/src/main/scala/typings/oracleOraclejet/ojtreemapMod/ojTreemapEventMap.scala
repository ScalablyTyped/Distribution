...
trait ojTreemapEventMap[K, D] extends dvtBaseComponentEventMap[ojTreemapSettableProperties[K, D]] {
  ...
  var nodeContentChanged: JetElementCustomEvent[Anon26[K, D]]
  var nodeDefaultsChanged: JetElementCustomEvent[AnonGroupLabelDisplay]
  ...
  var tooltipChanged: JetElementCustomEvent[Anon27[K, D]]
...
object ojTreemapEventMap {
  ...
  def apply[K, D](
    ...
    mouseup: MouseEvent,
    nodeContentChanged: JetElementCustomEvent[Anon26[K, D]],
    nodeDefaultsChanged: JetElementCustomEvent[AnonGroupLabelDisplay],
    ...
    timeupdate: Event_,
    toggle: Event_,
    tooltipChanged: JetElementCustomEvent[Anon27[K, D]],
