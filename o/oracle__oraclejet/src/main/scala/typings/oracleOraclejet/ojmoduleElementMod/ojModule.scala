...
import typings.oracleOraclejet.oracleOraclejetStrings.config
import typings.oracleOraclejet.oracleOraclejetStrings.configChanged
...
trait ojModule extends JetElement[ojModuleSettableProperties] {
  ...
  var onConfigChanged: (js.Function1[/* event */ JetElementCustomEvent[AnonCleanupMode], _]) | Null = js.native
  ...
  def addEventListener_configChanged(
    `type`: configChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[AnonCleanupMode], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_configChanged(
    `type`: configChanged,
