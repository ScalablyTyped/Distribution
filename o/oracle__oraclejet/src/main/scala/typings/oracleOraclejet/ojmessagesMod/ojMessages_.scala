...
import typings.oracleOraclejet.oracleOraclejetStrings.messages
import typings.oracleOraclejet.oracleOraclejetStrings.messagesChanged
...
import typings.oracleOraclejet.oracleOraclejetStrings.translationsChanged
...
trait ojMessages_ extends JetElement[ojMessagesSettableProperties] {
  ...
  var onTranslationsChanged: (js.Function1[/* event */ JetElementCustomEvent[AnonAriaLiveRegion], _]) | Null = js.native
  ...
  def addEventListener_messagesChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[js.Array[Message] | Null | (DataProvider[_, Message])], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_positionChanged(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[Position | Null], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_positionChanged(
    `type`: positionChanged,
  ...
  def addEventListener_translationsChanged(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[AnonAriaLiveRegion], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_translationsChanged(
    `type`: translationsChanged,
  ...
  @JSName("getProperty")
  def getProperty_translations(property: translations): AnonAriaLiveRegion = js.native
  ...
  @JSName("setProperty")
  def setProperty_translations(property: translations, value: AnonAriaLiveRegion): Unit = js.native
}
