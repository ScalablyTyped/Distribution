...
object ojmoduleElementMod {
  ...
  trait ojModule
    ...
    def addEventListener_configChanged(
      `type`: configChanged,
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[CleanupMode], Any]
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_configChanged(
      `type`: configChanged,
    ...
    var onConfigChanged: (js.Function1[/* event */ JetElementCustomEvent[CleanupMode], Any]) | Null = js.native
