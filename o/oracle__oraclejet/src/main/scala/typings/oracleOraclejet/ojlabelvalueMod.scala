...
object ojlabelvalueMod {
  ...
  trait ojLabelValue
    extends StObject
       with JetElement[ojLabelValueSettableProperties] {
    ...
    def addEventListener(
      ...
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[start | top | inherit], Any]
    ): Unit = js.native
    def addEventListener(
      `type`: labelEdgeChanged,
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[start | top | inherit], Any],
    ...
    var onLabelEdgeChanged: (js.Function1[/* event */ JetElementCustomEvent[start | top | inherit], Any]) | Null = js.native
    ...
    def setProperty(property: labelEdge, value: start | top | inherit): Unit = js.native
  ...
  object ojLabelValueSettableProperties {
    ...
    inline def apply(labelEdge: start | top | inherit, labelWidth: String): ojLabelValueSettableProperties = {
  ...
  object ojLabelValueSettablePropertiesLenient {
    ...
    inline def apply(): ojLabelValueSettablePropertiesLenient = {
