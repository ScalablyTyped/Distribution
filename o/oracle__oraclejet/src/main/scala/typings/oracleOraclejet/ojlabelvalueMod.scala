...
object ojlabelvalueMod {
  ...
  trait ojLabelValueEventMap extends HTMLElementEventMap {
    ...
    var labelEdgeChanged: JetElementCustomEvent[start | top | inherit] = js.native
  ...
  object ojLabelValueEventMap {
    ...
    implicit class ojLabelValueEventMapMutableBuilder[Self <: ojLabelValueEventMap] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLabelEdgeChanged(value: JetElementCustomEvent[start | top | inherit]): Self = StObject.set(x, "labelEdgeChanged", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLabelWidthChanged(value: JetElementCustomEvent[String]): Self = StObject.set(x, "labelWidthChanged", value.asInstanceOf[js.Any])
    }
  }
