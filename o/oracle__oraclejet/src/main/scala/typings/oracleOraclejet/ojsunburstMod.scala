...
import typings.oracleOraclejet.anon.DictpropNameData
import typings.oracleOraclejet.anon.DictpropNameValue
...
import typings.oracleOraclejet.oracleOraclejetStrings.labelHalign
import typings.oracleOraclejet.oracleOraclejetStrings.labelHalignChanged
...
import typings.oracleOraclejet.oracleOraclejetStrings.radius
import typings.oracleOraclejet.oracleOraclejetStrings.radiusChanged
...
import typings.oracleOraclejet.oracleOraclejetStrings.showDisclosure
import typings.oracleOraclejet.oracleOraclejetStrings.showDisclosureChanged
...
object ojsunburstMod {
  ...
  trait ojSunburst[K, D]
    ...
    def addEventListener_nodeDefaultsChanged(
      ...
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[HoverColor], Any]
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_nodeDefaultsChanged(
      `type`: nodeDefaultsChanged,
    ...
    def addEventListener_rootNodeContentChanged(
      ...
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[`18`[K, D]], Any]
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_rootNodeContentChanged(
      `type`: rootNodeContentChanged,
    ...
    def addEventListener_tooltipChanged(
      `type`: tooltipChanged,
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[`19`[K, D]], Any]
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_tooltipChanged(
      `type`: tooltipChanged,
    ...
    def getNode(subIdPath: js.Array[Any]): DataContext | Null = js.native
    ...
    @JSName("getProperty")
    def getProperty_selection(property: selection): js.Array[Any] = js.native
    @JSName("getProperty")
    ...
    var onAnimationUpdateColorChanged: (js.Function1[/* event */ JetElementCustomEvent[String], Any]) | Null = js.native
    
    var onAsChanged: (js.Function1[/* event */ JetElementCustomEvent[String], Any]) | Null = js.native
    
    var onColorLabelChanged: (js.Function1[/* event */ JetElementCustomEvent[String], Any]) | Null = js.native
    
    var onDataChanged: (js.Function1[/* event */ JetElementCustomEvent[(DataProvider[K, D]) | Null], Any]) | Null = js.native
    
    var onDisplayLevelsChanged: (js.Function1[/* event */ JetElementCustomEvent[Double], Any]) | Null = js.native
    ...
    var onNodeDefaultsChanged: (js.Function1[/* event */ JetElementCustomEvent[HoverColor], Any]) | Null = js.native
    
    var onOjBeforeCollapse: (js.Function1[/* event */ typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojBeforeCollapse, Any]) | Null = js.native
    
    var onOjBeforeDrill: (js.Function1[/* event */ typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojBeforeDrill, Any]) | Null = js.native
    
    var onOjBeforeExpand: (js.Function1[/* event */ typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojBeforeExpand, Any]) | Null = js.native
    
    var onOjCollapse: (js.Function1[/* event */ typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojCollapse, Any]) | Null = js.native
    
    var onOjDrill: (js.Function1[/* event */ typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojDrill, Any]) | Null = js.native
    
    var onOjExpand: (js.Function1[/* event */ typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojExpand, Any]) | Null = js.native
    
    var onOjRotateInput: (js.Function1[/* event */ typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojRotateInput, Any]) | Null = js.native
    ...
    var onRootNodeContentChanged: (js.Function1[/* event */ JetElementCustomEvent[`18`[K, D]], Any]) | Null = js.native
    
    var onRotationChanged: (js.Function1[/* event */ JetElementCustomEvent[off | on], Any]) | Null = js.native
    
    var onSelectionChanged: (js.Function1[/* event */ JetElementCustomEvent[js.Array[Any]], Any]) | Null = js.native
    
    var onSelectionModeChanged: (js.Function1[/* event */ JetElementCustomEvent[none | single | multiple], Any]) | Null = js.native
    
    var onSizeLabelChanged: (js.Function1[/* event */ JetElementCustomEvent[String], Any]) | Null = js.native
    
    var onSortingChanged: (js.Function1[/* event */ JetElementCustomEvent[on | off], Any]) | Null = js.native
    
    var onStartAngleChanged: (js.Function1[/* event */ JetElementCustomEvent[Double], Any]) | Null = js.native
    
    var onTooltipChanged: (js.Function1[/* event */ JetElementCustomEvent[`19`[K, D]], Any]) | Null = js.native
    ...
    def setProperty(property: rotation, value: off | on): Unit = js.native
    def setProperty(property: selectionMode, value: none | single | multiple): Unit = js.native
    def setProperty(property: sorting, value: on | off): Unit = js.native
    ...
    @JSName("setProperty")
    def setProperty_rootNode(property: rootNode, value: Any): Unit = js.native
    @JSName("setProperty")
    def setProperty_rootNodeContent(property: rootNodeContent, value: `18`[K, D]): Unit = js.native
    @JSName("setProperty")
    def setProperty_selection(property: selection, value: js.Array[Any]): Unit = js.native
    @JSName("setProperty")
    ...
    @JSName("translations")
    var translations_ojSunburst: LabelColor = js.native
  }
  object ojSunburst {
    ...
    object NodeContext {
      ...
      extension [Self <: NodeContext](x: Self) {
        ...
        inline def setIndexPathVarargs(value: Double*): Self = StObject.set(x, "indexPath", js.Array(value*))
    ...
    type ojBeforeCollapse = CustomEvent[DictpropNameData]
    
    type ojBeforeDrill = CustomEvent[DictpropNameData]
    
    type ojBeforeExpand = CustomEvent[DictpropNameData]
    
    type ojCollapse = CustomEvent[DictpropNameData]
    
    type ojDrill = CustomEvent[DictpropNameData]
    
    type ojExpand = CustomEvent[DictpropNameData]
  ...
  trait ojSunburstEventMap[K, D]
    ...
    var selectionChanged: JetElementCustomEvent[js.Array[Any]]
  ...
  object ojSunburstEventMap {
    ...
    inline def apply[K, D](
      ...
      ojBeforeCollapse: typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojBeforeCollapse,
      ojBeforeDrill: typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojBeforeDrill,
      ojBeforeExpand: typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojBeforeExpand,
      ojCollapse: typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojCollapse,
      ojDrill: typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojDrill,
      ojExpand: typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojExpand,
      ojRotateInput: typings.oracleOraclejet.ojsunburstMod.ojSunburst.ojRotateInput,
      ...
      seeking: Event,
      select: Event,
      selectionChanged: JetElementCustomEvent[js.Array[Any]],
    ...
    extension [Self <: ojSunburstEventMap[?, ?], K, D](x: Self & (ojSunburstEventMap[K, D])) {
      ...
      inline def setSelectionChanged(value: JetElementCustomEvent[js.Array[Any]]): Self = StObject.set(x, "selectionChanged", value.asInstanceOf[js.Any])
  ...
  trait ojSunburstNode
    ...
    def addEventListener(
      ...
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.UndefOr[off | auto]], Any]
    ): Unit = js.native
    def addEventListener(
      `type`: selectableChanged,
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.UndefOr[off | auto]], Any],
    ...
    var onBorderWidthChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[Double]], Any]) | Null = js.native
    ...
    var onLabelChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[String]], Any]) | Null = js.native
    ...
    var onLabelHalignChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[inner | outer | center]], Any]) | Null = js.native
    
    var onLabelStyleChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[js.Object]], Any]) | Null = js.native
    ...
    var onRadiusChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[Double]], Any]) | Null = js.native
    
    var onSelectableChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[off | auto]], Any]) | Null = js.native
    
    var onShortDescChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[String]], Any]) | Null = js.native
    
    var onShowDisclosureChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[on | off | inherit]], Any]) | Null = js.native
    ...
    def setProperty(property: labelDisplay, value: horizontal | rotated | off | auto): Unit = js.native
    def setProperty(property: labelHalign, value: inner | outer | center): Unit = js.native
    def setProperty(
      property: pattern,
    ...
    def setProperty(property: selectable, value: off | auto): Unit = js.native
    def setProperty(property: showDisclosure, value: on | off | inherit): Unit = js.native
  ...
  object ojSunburstSettableProperties {
    ...
    extension [Self <: ojSunburstSettableProperties[?, ?], K, D](x: Self & (ojSunburstSettableProperties[K, D])) {
      ...
      inline def setRootNode(value: Any): Self = StObject.set(x, "rootNode", value.asInstanceOf[js.Any])
      ...
      inline def setSelection(value: js.Array[Any]): Self = StObject.set(x, "selection", value.asInstanceOf[js.Any])
