...
trait AnonAutoBillionConverterMillion extends js.Object {
...
object AnonAutoBillionConverterMillion {
  @scala.inline
  def apply(
    converter: js.Object,
    rendered: off | on,
    ...
    style: js.Object
  ): AnonAutoBillionConverterMillion = {
    ...
    __obj.asInstanceOf[AnonAutoBillionConverterMillion]
  }
}
