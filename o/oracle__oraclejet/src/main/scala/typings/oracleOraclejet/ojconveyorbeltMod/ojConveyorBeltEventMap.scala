...
object ojConveyorBeltEventMap {
  ...
  @scala.inline
  implicit class ojConveyorBeltEventMapOps[Self <: ojConveyorBeltEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentParentChanged(value: JetElementCustomEvent[String | Null]): Self = this.set("contentParentChanged", value.asInstanceOf[js.Any])
