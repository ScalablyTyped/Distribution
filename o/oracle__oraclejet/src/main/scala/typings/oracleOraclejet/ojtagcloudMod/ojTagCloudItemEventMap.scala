...
trait ojTagCloudItemEventMap
  ...
  var urlChanged: JetElementCustomEvent[String] = js.native
...
object ojTagCloudItemEventMap {
  ...
  implicit class ojTagCloudItemEventMapOps[Self <: ojTagCloudItemEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUrlChanged(value: JetElementCustomEvent[String]): Self = this.set("urlChanged", value.asInstanceOf[js.Any])
    @scala.inline
