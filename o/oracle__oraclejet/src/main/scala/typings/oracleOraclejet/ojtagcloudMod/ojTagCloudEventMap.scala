...
trait ojTagCloudEventMap[K, D] extends dvtBaseComponentEventMap[ojTagCloudSettableProperties[K, D]] {
  ...
  var styleDefaultsChanged: JetElementCustomEvent[AnonHoverBehaviorDelay]
  var tooltipChanged: JetElementCustomEvent[Anon24[K]]
...
object ojTagCloudEventMap {
  ...
  def apply[K, D](
    ...
    selectstart: Event_,
    stalled: Event_,
    styleDefaultsChanged: JetElementCustomEvent[AnonHoverBehaviorDelay],
    submit: Event_,
    suspend: Event_,
    timeupdate: Event_,
    toggle: Event_,
    tooltipChanged: JetElementCustomEvent[Anon24[K]],
