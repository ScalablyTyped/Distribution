...
object ojAccordionEventMap {
  ...
  @scala.inline
  implicit class ojAccordionEventMapOps[Self <: ojAccordionEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpandedChanged(value: JetElementCustomEvent[js.Array[Id] | Null]): Self = this.set("expandedChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMultipleChanged(value: JetElementCustomEvent[Boolean]): Self = this.set("multipleChanged", value.asInstanceOf[js.Any])
