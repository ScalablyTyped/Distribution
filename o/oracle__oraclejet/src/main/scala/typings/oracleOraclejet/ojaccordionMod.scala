...
object ojaccordionMod {
  ...
  trait ojAccordion
    ...
    def addEventListener_expandedChanged(
      ...
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.Array[Id] | Null], Any]
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_expandedChanged(
      `type`: expandedChanged,
    ...
    var onExpandedChanged: (js.Function1[/* event */ JetElementCustomEvent[js.Array[Id] | Null], Any]) | Null = js.native
    
    var onMultipleChanged: (js.Function1[/* event */ JetElementCustomEvent[Boolean], Any]) | Null = js.native
    ...
    var onOjBeforeExpand: (js.Function1[/* event */ typings.oracleOraclejet.ojaccordionMod.ojAccordion.ojBeforeExpand, Any]) | Null = js.native
    
    var onOjCollapse: (js.Function1[/* event */ typings.oracleOraclejet.ojaccordionMod.ojAccordion.ojCollapse, Any]) | Null = js.native
    
    var onOjExpand: (js.Function1[/* event */ typings.oracleOraclejet.ojaccordionMod.ojAccordion.ojExpand, Any]) | Null = js.native
