...
object ojProgressListEventMap {
  ...
  @scala.inline
  implicit class ojProgressListEventMapOps[Self <: ojProgressListEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataChanged(value: JetElementCustomEvent[(DataProvider[_, _]) | Null]): Self = this.set("dataChanged", value.asInstanceOf[js.Any])
  }
}
