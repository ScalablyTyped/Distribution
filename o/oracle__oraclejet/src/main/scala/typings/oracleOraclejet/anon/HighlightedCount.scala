...
@js.native
trait HighlightedCount extends StObject {
...
object HighlightedCount {
  ...
  @scala.inline
  implicit class HighlightedCountMutableBuilder[Self <: HighlightedCount] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHighlightedCount(value: String): Self = StObject.set(x, "highlightedCount", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHighlightedCountUndefined: Self = StObject.set(x, "highlightedCount", js.undefined)
    
    @scala.inline
    def setLabelAdditionalData(value: String): Self = StObject.set(x, "labelAdditionalData", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelAdditionalDataUndefined: Self = StObject.set(x, "labelAdditionalData", js.undefined)
    ...
    @scala.inline
    def setLabelOther(value: String): Self = StObject.set(x, "labelOther", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelOtherUndefined: Self = StObject.set(x, "labelOther", js.undefined)
