...
object ColumnIndex {
  ...
  @scala.inline
  implicit class ColumnIndexMutableBuilder[Self <: ColumnIndex[_], K] (val x: Self with ColumnIndex[K]) extends AnyVal {
    ...
    @scala.inline
    def setColumnKey(value: K): Self = StObject.set(x, "columnKey", value.asInstanceOf[js.Any])
