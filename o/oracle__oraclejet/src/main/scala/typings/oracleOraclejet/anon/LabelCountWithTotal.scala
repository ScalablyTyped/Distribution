...
@js.native
trait LabelCountWithTotal extends js.Object {
...
object LabelCountWithTotal {
  @scala.inline
  def apply(): LabelCountWithTotal = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LabelCountWithTotal]
  }
  @scala.inline
  implicit class LabelCountWithTotalOps[Self <: LabelCountWithTotal] (val x: Self) extends AnyVal {
    @scala.inline
