...
object Vertical {
  ...
  implicit class VerticalOps[Self <: Vertical] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHorizontal(value: hidden | visible | auto): Self = this.set("horizontal", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteHorizontal: Self = this.set("horizontal", js.undefined)
    @scala.inline
    def setVertical(value: hidden | visible | auto): Self = this.set("vertical", value.asInstanceOf[js.Any])
    @scala.inline
