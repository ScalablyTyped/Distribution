...
object Add {
  ...
  implicit open class MutableBuilder[Self <: Add] (val x: Self) extends AnyVal {
    ...
    inline def setError(value: (Add, /* xhr */ Any, /* options */ js.Object) => Unit): Self = StObject.set(x, "error", js.Any.fromFunction3(value))
    ...
    inline def setSuccess(value: (Add, /* response */ Any, /* options */ js.Object) => Unit): Self = StObject.set(x, "success", js.Any.fromFunction3(value))
