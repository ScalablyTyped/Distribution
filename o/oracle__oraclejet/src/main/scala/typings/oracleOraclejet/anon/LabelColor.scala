...
object LabelColor {
  ...
  implicit class LabelColorOps[Self <: LabelColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTooltipCollapse(value: String): Self = this.set("tooltipCollapse", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTooltipCollapse: Self = this.set("tooltipCollapse", js.undefined)
    
    @scala.inline
    def setTooltipExpand(value: String): Self = this.set("tooltipExpand", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTooltipExpand: Self = this.set("tooltipExpand", js.undefined)
  }
}
