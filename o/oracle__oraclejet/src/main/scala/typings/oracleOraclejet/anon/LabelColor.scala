...
object LabelColor {
  ...
  implicit class LabelColorMutableBuilder[Self <: LabelColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTooltipCollapse(value: String): Self = StObject.set(x, "tooltipCollapse", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTooltipCollapseUndefined: Self = StObject.set(x, "tooltipCollapse", js.undefined)
    
    @scala.inline
    def setTooltipExpand(value: String): Self = StObject.set(x, "tooltipExpand", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTooltipExpandUndefined: Self = StObject.set(x, "tooltipExpand", js.undefined)
  }
}
