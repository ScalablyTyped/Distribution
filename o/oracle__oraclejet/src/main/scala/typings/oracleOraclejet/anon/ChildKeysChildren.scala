...
trait ChildKeysChildren extends js.Object {
...
object ChildKeysChildren {
  @scala.inline
  def apply(childKeys: OptionsKeys = null, children: String = null, label: String = null, value: String = null): ChildKeysChildren = {
