...
@js.native
trait LabelDataVisualization extends js.Object {
  ...
  var tooltipIsolate: js.UndefOr[String] = js.native
  var tooltipRestore: js.UndefOr[String] = js.native
}

object LabelDataVisualization {
  @scala.inline
  def apply(): LabelDataVisualization = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LabelDataVisualization]
  }
  @scala.inline
  implicit class LabelDataVisualizationOps[Self <: LabelDataVisualization] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setTooltipIsolate(value: String): Self = this.set("tooltipIsolate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTooltipIsolate: Self = this.set("tooltipIsolate", js.undefined)
    @scala.inline
    def setTooltipRestore(value: String): Self = this.set("tooltipRestore", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTooltipRestore: Self = this.set("tooltipRestore", js.undefined)
  }
