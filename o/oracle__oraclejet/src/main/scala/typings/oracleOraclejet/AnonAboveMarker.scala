...
trait AnonAboveMarker extends js.Object {
  ...
  var groupSeparators: AnonAutoColor
...
object AnonAboveMarker {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonAboveMarker]
  }
}
