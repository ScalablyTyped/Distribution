...
object ojCheckboxsetEventMap {
  ...
  @scala.inline
  implicit class ojCheckboxsetEventMapOps[Self <: ojCheckboxsetEventMap[_, _], K, D] (val x: Self with (ojCheckboxsetEventMap[K, D])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setLabelledByChanged(value: JetElementCustomEvent[String | Null]): Self = this.set("labelledByChanged", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOptionsChanged(value: JetElementCustomEvent[(DataProvider[K, D]) | Null]): Self = this.set("optionsChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setOptionsKeysChanged(value: JetElementCustomEvent[js.UndefOr[OptionsKeys]]): Self = this.set("optionsKeysChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setRequiredChanged(value: JetElementCustomEvent[Boolean]): Self = this.set("requiredChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setValueChanged(value: JetElementCustomEvent[js.Array[_]]): Self = this.set("valueChanged", value.asInstanceOf[js.Any])
  }
