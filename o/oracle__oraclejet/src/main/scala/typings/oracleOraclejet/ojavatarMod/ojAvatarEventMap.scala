...
@js.native
trait ojAvatarEventMap
  extends ElementEventMap
     with GlobalEventHandlersEventMap
     with DocumentAndElementEventHandlersEventMap {
  var initialsChanged: JetElementCustomEvent[String] = js.native
  var sizeChanged: JetElementCustomEvent[xxs | xs | sm | md | lg | xl | xxl] = js.native
  var srcChanged: JetElementCustomEvent[String] = js.native
}

object ojAvatarEventMap {
  @scala.inline
  def apply(
    abort: UIEvent,
    ...
    initialsChanged: JetElementCustomEvent[String],
    input: Event,
    invalid: Event,
    ...
    selectstart: Event,
    sizeChanged: JetElementCustomEvent[xxs | xs | sm | md | lg | xl | xxl],
    srcChanged: JetElementCustomEvent[String],
    stalled: Event,
    submit: Event,
    suspend: Event,
    timeupdate: Event,
  ...
  implicit class ojAvatarEventMapOps[Self <: ojAvatarEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInitialsChanged(value: JetElementCustomEvent[String]): Self = this.set("initialsChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setSizeChanged(value: JetElementCustomEvent[xxs | xs | sm | md | lg | xl | xxl]): Self = this.set("sizeChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setSrcChanged(value: JetElementCustomEvent[String]): Self = this.set("srcChanged", value.asInstanceOf[js.Any])
  }
