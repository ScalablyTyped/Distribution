...
trait ojAvatarEventMap
  ...
  var initialsChanged: JetElementCustomEvent[String]
  var sizeChanged: JetElementCustomEvent[xxs | xs | sm | md | lg | xl | xxl]
  var srcChanged: JetElementCustomEvent[String]
}
