...
object ojcolorspectrumMod {
  ...
  trait ojColorSpectrum
    ...
    def addEventListener_transientValueChanged(
      ...
      listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[^], Any]
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_transientValueChanged(
      `type`: transientValueChanged,
    ...
    var onOjAnimateEnd_ojColorSpectrum: (js.Function1[/* event */ ojAnimateEnd, Any]) | Null = js.native
    
    @JSName("onOjAnimateStart")
    var onOjAnimateStart_ojColorSpectrum: (js.Function1[/* event */ ojAnimateStart, Any]) | Null = js.native
    
    var onTransientValueChanged: (js.Function1[/* event */ JetElementCustomEvent[^], Any]) | Null = js.native
