...
object ojswitcherMod {
  ...
  trait ojSwitcherEventMap extends HTMLElementEventMap {
    ...
    var valueChanged: JetElementCustomEvent[String] = js.native
  }
  object ojSwitcherEventMap {
    ...
    @scala.inline
    implicit class ojSwitcherEventMapMutableBuilder[Self <: ojSwitcherEventMap] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setValueChanged(value: JetElementCustomEvent[String]): Self = StObject.set(x, "valueChanged", value.asInstanceOf[js.Any])
    }
  }
  ...
  object ojSwitcherSettableProperties {
    ...
    @scala.inline
    implicit class ojSwitcherSettablePropertiesMutableBuilder[Self <: ojSwitcherSettableProperties] (val x: Self) extends AnyVal {
  ...
  object ojSwitcherSettablePropertiesLenient {
    ...
    @scala.inline
    implicit class ojSwitcherSettablePropertiesLenientMutableBuilder[Self <: ojSwitcherSettablePropertiesLenient] (val x: Self) extends AnyVal {
