...
object ojswitcherMod {
  ...
  trait ojSwitcher
    extends StObject
       with JetElement[ojSwitcherSettableProperties] {
    ...
    var onValueChanged: (js.Function1[/* event */ JetElementCustomEvent[String], js.Any]) | Null = js.native
  ...
  object ojSwitcherSettableProperties {
    ...
    inline def apply(value: String): ojSwitcherSettableProperties = {
  ...
  object ojSwitcherSettablePropertiesLenient {
    ...
    inline def apply(): ojSwitcherSettablePropertiesLenient = {
