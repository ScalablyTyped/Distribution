...
trait AnonActionCloseElementEndCallback
...
object AnonActionCloseElementEndCallback {
  @scala.inline
  def apply(
    action: open | close,
    element: Element,
  ...
  ): AnonActionCloseElementEndCallback = {
    ...
    __obj.asInstanceOf[AnonActionCloseElementEndCallback]
  }
}
