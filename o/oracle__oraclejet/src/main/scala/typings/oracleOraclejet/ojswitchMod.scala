...
object ojswitchMod {
  ...
  trait ojSwitch
    ...
    var onOjAnimateEnd_ojSwitch: (js.Function1[/* event */ ojAnimateEnd, Any]) | Null = js.native
    
    @JSName("onOjAnimateStart")
    var onOjAnimateStart_ojSwitch: (js.Function1[/* event */ ojAnimateStart, Any]) | Null = js.native
