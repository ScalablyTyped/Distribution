...
trait ojSunburstEventMap[K, D] extends dvtBaseComponentEventMap[ojSunburstSettableProperties[K, D]] {
  ...
  var rootNodeContentChanged: JetElementCustomEvent[`16`[K, D]]
  ...
  var tooltipChanged: JetElementCustomEvent[`17`[K, D]]
...
object ojSunburstEventMap {
  ...
  def apply[K, D](
    ...
    rootNodeContentChanged: JetElementCustomEvent[`16`[K, D]],
    ...
    timeupdate: Event,
    toggle: Event,
    tooltipChanged: JetElementCustomEvent[`17`[K, D]],
