...
trait ojSunburstEventMap[K, D] extends dvtBaseComponentEventMap[ojSunburstSettableProperties[K, D]] {
  ...
  var nodeDefaultsChanged: JetElementCustomEvent[AnonAutoBorderColorBorderWidth]
  ...
  var rootNodeContentChanged: JetElementCustomEvent[AnonContextRendererAnonInsertD[K, D]]
  ...
  var tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultD[K, D]]
...
object ojSunburstEventMap {
  ...
  def apply[K, D](
    ...
    mouseup: MouseEvent,
    nodeDefaultsChanged: JetElementCustomEvent[AnonAutoBorderColorBorderWidth],
    ...
    rootNodeContentChanged: JetElementCustomEvent[AnonContextRendererAnonInsertD[K, D]],
    ...
    timeupdate: Event_,
    toggle: Event_,
    tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultD[K, D]],
