...
trait ojSunburst_[K, D] extends dvtBaseComponent[ojSunburstSettableProperties[K, D]] {
  ...
  var nodeDefaults: AnonAutoBorderColorBorderWidth = js.native
  ...
  var onNodeDefaultsChanged: (js.Function1[/* event */ JetElementCustomEvent[AnonAutoBorderColorBorderWidth], _]) | Null = js.native
  ...
  var onRootNodeContentChanged: (js.Function1[/* event */ JetElementCustomEvent[AnonContextRendererAnonInsertD[K, D]], _]) | Null = js.native
  ...
  var onTooltipChanged: (js.Function1[
    /* event */ JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultD[K, D]], 
    _
  ]) | Null = js.native
  ...
  var rootNodeContent: AnonContextRendererAnonInsertD[K, D] = js.native
  ...
  var tooltip: AnonContextRendererAnonInsertAnonPreventDefaultD[K, D] = js.native
  var touchResponse: touchStart | auto = js.native
  @JSName("translations")
  var translations_ojSunburst_ : AnonComponentNameLabelAndValueLabelClearSelectionLabelColor = js.native
  ...
  def addEventListener_nodeDefaultsChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[AnonAutoBorderColorBorderWidth], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_rootNodeContentChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[AnonContextRendererAnonInsertD[K, D]], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_tooltipChanged(
    ...
    listener: js.ThisFunction1[
      /* this */ HTMLElement, 
      /* ev */ JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultD[K, D]], 
      _
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("getProperty")
  def getProperty_nodeDefaults(property: nodeDefaults): AnonAutoBorderColorBorderWidth = js.native
  @JSName("getProperty")
  ...
  @JSName("getProperty")
  def getProperty_rootNodeContent(property: rootNodeContent): AnonContextRendererAnonInsertD[K, D] = js.native
  @JSName("getProperty")
  ...
  @JSName("getProperty")
  def getProperty_tooltip(property: tooltip): AnonContextRendererAnonInsertAnonPreventDefaultD[K, D] = js.native
  @JSName("getProperty")
  ...
  @JSName("setProperty")
  def setProperty_nodeDefaults(property: nodeDefaults, value: AnonAutoBorderColorBorderWidth): Unit = js.native
  @JSName("setProperty")
  def setProperty_rootNode(property: rootNode, value: js.Any): Unit = js.native
  @JSName("setProperty")
  def setProperty_rootNodeContent(property: rootNodeContent, value: AnonContextRendererAnonInsertD[K, D]): Unit = js.native
  @JSName("setProperty")
  ...
  @JSName("setProperty")
  def setProperty_tooltip(property: tooltip, value: AnonContextRendererAnonInsertAnonPreventDefaultD[K, D]): Unit = js.native
  @JSName("setProperty")
  def setProperty_translations(property: translations, value: AnonComponentNameLabelAndValueLabelClearSelectionLabelColor): Unit = js.native
}
