...
trait ojNBoxEventMap[K, D] extends dvtBaseComponentEventMap[ojNBoxSettableProperties[K, D]] {
  ...
  var styleDefaultsChanged: JetElementCustomEvent[AnonAnimationDurationCellDefaults]
  var tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultK[K]]
...
object ojNBoxEventMap {
  ...
  def apply[K, D](
    ...
    selectstart: Event_,
    stalled: Event_,
    styleDefaultsChanged: JetElementCustomEvent[AnonAnimationDurationCellDefaults],
    submit: Event_,
    suspend: Event_,
    timeupdate: Event_,
    toggle: Event_,
    tooltipChanged: JetElementCustomEvent[AnonContextRendererAnonInsertAnonPreventDefaultK[K]],
