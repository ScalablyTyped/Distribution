...
trait ojNBoxNodeEventMap
  ...
  var iconChanged: JetElementCustomEvent[js.UndefOr[AnonBorderColorBorderRadiusBorderWidthCircleColor]]
  var indicatorColorChanged: JetElementCustomEvent[js.UndefOr[String]]
  var indicatorIconChanged: JetElementCustomEvent[js.UndefOr[AnonBorderColorBorderRadiusBorderWidthCircleColorDiamond]]
...
object ojNBoxNodeEventMap {
  ...
  def apply(
    ...
    iconChanged: JetElementCustomEvent[js.UndefOr[AnonBorderColorBorderRadiusBorderWidthCircleColor]],
    indicatorColorChanged: JetElementCustomEvent[js.UndefOr[String]],
    indicatorIconChanged: JetElementCustomEvent[js.UndefOr[AnonBorderColorBorderRadiusBorderWidthCircleColorDiamond]],
    input: Event_,
    invalid: Event_,
