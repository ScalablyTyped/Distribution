...
trait ojChartItemEventMap
  ...
  var boxPlotChanged: JetElementCustomEvent[js.UndefOr[AnonMedianSvgClassNameMedianSvgStyle]]
...
object ojChartItemEventMap {
  ...
  def apply(
    ...
    boxPlotChanged: JetElementCustomEvent[js.UndefOr[AnonMedianSvgClassNameMedianSvgStyle]],
    cancel: Event_,
    canplay: Event_,
