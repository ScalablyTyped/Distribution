...
import typings.oracleOraclejet.oracleOraclejetStrings.dateChanged
...
import typings.oracleOraclejet.oracleOraclejetStrings.high
import typings.oracleOraclejet.oracleOraclejetStrings.highChanged
...
import typings.oracleOraclejet.oracleOraclejetStrings.lowChanged
...
trait ojSparkChartItem
  extends StObject
     with JetElement[ojSparkChartItemSettableProperties] {
  ...
  var onDateChanged: (js.Function1[/* event */ JetElementCustomEvent[String], Any]) | Null = js.native
  
  var onHighChanged: (js.Function1[/* event */ JetElementCustomEvent[Double | Null], Any]) | Null = js.native
  
  var onLowChanged: (js.Function1[/* event */ JetElementCustomEvent[Double | Null], Any]) | Null = js.native
  
  var onMarkerDisplayedChanged: (js.Function1[/* event */ JetElementCustomEvent[off | on], Any]) | Null = js.native
  ...
  def setProperty(property: markerDisplayed, value: off | on): Unit = js.native
  def setProperty(
