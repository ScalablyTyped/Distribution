...
trait ojSparkChartItem
  ...
  var onDateChanged: (js.Function1[/* event */ JetElementCustomEvent[String], js.Any]) | Null = js.native
  
  var onHighChanged: (js.Function1[/* event */ JetElementCustomEvent[Double | Null], js.Any]) | Null = js.native
  
  var onLowChanged: (js.Function1[/* event */ JetElementCustomEvent[Double | Null], js.Any]) | Null = js.native
  
  var onMarkerDisplayedChanged: (js.Function1[/* event */ JetElementCustomEvent[off | on], js.Any]) | Null = js.native
