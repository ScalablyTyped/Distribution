...
trait ojChartSeries extends JetElement[ojChartSeriesSettableProperties] {
  ...
  def addEventListener_boxPlotChanged(
    `type`: boxPlotChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.UndefOr[Q2Color]], _]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_boxPlotChanged(
    `type`: boxPlotChanged,
  ...
  var onBoxPlotChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[Q2Color]], _]) | Null = js.native
