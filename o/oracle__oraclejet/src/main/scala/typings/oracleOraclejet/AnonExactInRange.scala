...
trait AnonExactInRange extends js.Object {
...
object AnonExactInRange {
  @scala.inline
  def apply(exact: String = null, inRange: String = null, max: String = null, min: String = null): AnonExactInRange = {
    ...
    __obj.asInstanceOf[AnonExactInRange]
  }
}
