...
object ojTimeAxisEventMap {
  ...
  implicit class ojTimeAxisEventMapOps[Self <: ojTimeAxisEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConverterChanged(value: JetElementCustomEvent[Converters | Converter[String]]): Self = this.set("converterChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEndChanged(value: JetElementCustomEvent[String]): Self = this.set("endChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setScaleChanged(value: JetElementCustomEvent[seconds | minutes | hours | days | weeks | months | quarters | years]): Self = this.set("scaleChanged", value.asInstanceOf[js.Any])
