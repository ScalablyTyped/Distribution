...
object ojInputPasswordSettablePropertiesLenient {
  ...
  extension [Self <: ojInputPasswordSettablePropertiesLenient](x: Self) {
    ...
    inline def setAsyncValidatorsVarargs(value: (AsyncValidator[String | Null])*): Self = StObject.set(x, "asyncValidators", js.Array(value :_*))
    ...
    inline def setValidatorsVarargs(value: ((Validator[String | Null]) | RegisteredValidator)*): Self = StObject.set(x, "validators", js.Array(value :_*))
