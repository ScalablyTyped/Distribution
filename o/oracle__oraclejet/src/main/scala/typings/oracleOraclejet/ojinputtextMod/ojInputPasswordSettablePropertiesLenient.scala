...
trait ojInputPasswordSettablePropertiesLenient
  ...
  var validators: js.UndefOr[(js.Array[(Validator[String | Null]) | RegisteredValidator]) | Null] = js.undefined
  
  var value: js.UndefOr[String | Null] = js.undefined
}
object ojInputPasswordSettablePropertiesLenient {
  
  inline def apply(): ojInputPasswordSettablePropertiesLenient = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ojInputPasswordSettablePropertiesLenient]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ojInputPasswordSettablePropertiesLenient] (val x: Self) extends AnyVal {
    
    inline def setAsyncValidators(value: js.Array[AsyncValidator[String | Null]]): Self = StObject.set(x, "asyncValidators", value.asInstanceOf[js.Any])
    
    inline def setAsyncValidatorsUndefined: Self = StObject.set(x, "asyncValidators", js.undefined)
    
    inline def setAsyncValidatorsVarargs(value: (AsyncValidator[String | Null])*): Self = StObject.set(x, "asyncValidators", js.Array(value*))
    ...
    inline def setValidators(value: js.Array[(Validator[String | Null]) | RegisteredValidator]): Self = StObject.set(x, "validators", value.asInstanceOf[js.Any])
    ...
    inline def setValidatorsVarargs(value: ((Validator[String | Null]) | RegisteredValidator)*): Self = StObject.set(x, "validators", js.Array(value*))
