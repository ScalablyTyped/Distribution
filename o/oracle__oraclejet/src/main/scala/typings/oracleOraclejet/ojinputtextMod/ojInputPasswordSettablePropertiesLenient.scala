...
object ojInputPasswordSettablePropertiesLenient {
  ...
  @scala.inline
  implicit class ojInputPasswordSettablePropertiesLenientMutableBuilder[Self <: ojInputPasswordSettablePropertiesLenient] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAsyncValidators(value: js.Array[AsyncValidator[String | Null]]): Self = StObject.set(x, "asyncValidators", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAsyncValidatorsUndefined: Self = StObject.set(x, "asyncValidators", js.undefined)
    
    @scala.inline
    def setAsyncValidatorsVarargs(value: (AsyncValidator[String | Null])*): Self = StObject.set(x, "asyncValidators", js.Array(value :_*))
    ...
    @scala.inline
    def setValidators(value: js.Array[(Validator[String | Null]) | RegisteredValidator]): Self = StObject.set(x, "validators", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setValidatorsVarargs(value: ((Validator[String | Null]) | RegisteredValidator)*): Self = StObject.set(x, "validators", js.Array(value :_*))
