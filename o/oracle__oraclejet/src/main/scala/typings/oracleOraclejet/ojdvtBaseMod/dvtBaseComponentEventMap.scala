...
object dvtBaseComponentEventMap {
  ...
  @scala.inline
  implicit class dvtBaseComponentEventMapOps[Self <: dvtBaseComponentEventMap[_], SP /* <: dvtBaseComponentSettableProperties */] (val x: Self with dvtBaseComponentEventMap[SP]) extends AnyVal {
