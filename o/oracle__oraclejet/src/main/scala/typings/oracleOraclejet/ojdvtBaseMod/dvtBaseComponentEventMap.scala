...
object dvtBaseComponentEventMap {
  ...
  @scala.inline
  implicit class dvtBaseComponentEventMapOps[Self <: dvtBaseComponentEventMap[_], /* <: typings.oracleOraclejet.ojdvtBaseMod.dvtBaseComponentSettableProperties */ SP] (val x: Self with dvtBaseComponentEventMap[SP]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setTrackResizeChanged(value: JetElementCustomEvent[on | off]): Self = this.set("trackResizeChanged", value.asInstanceOf[js.Any])
  }
