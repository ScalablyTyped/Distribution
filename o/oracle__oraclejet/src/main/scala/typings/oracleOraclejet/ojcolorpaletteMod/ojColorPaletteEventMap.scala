...
object ojColorPaletteEventMap {
  ...
  implicit class ojColorPaletteEventMapOps[Self <: ojColorPaletteEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelDisplayChanged(value: JetElementCustomEvent[auto | off]): Self = this.set("labelDisplayChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLayoutChanged(value: JetElementCustomEvent[grid | list]): Self = this.set("layoutChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPaletteChanged(value: JetElementCustomEvent[js.Array[Label]]): Self = this.set("paletteChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSwatchSizeChanged(value: JetElementCustomEvent[xs | sm | lg]): Self = this.set("swatchSizeChanged", value.asInstanceOf[js.Any])
  }
}
