...
object ojCollapsibleEventMap {
  ...
  implicit class ojCollapsibleEventMapOps[Self <: ojCollapsibleEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExpandAreaChanged(value: JetElementCustomEvent[header | disclosureIcon]): Self = this.set("expandAreaChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setExpandedChanged(value: JetElementCustomEvent[Boolean]): Self = this.set("expandedChanged", value.asInstanceOf[js.Any])
