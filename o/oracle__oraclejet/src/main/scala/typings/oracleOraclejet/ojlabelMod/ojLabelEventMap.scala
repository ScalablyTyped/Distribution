...
object ojLabelEventMap {
  ...
  @scala.inline
  implicit class ojLabelEventMapOps[Self <: ojLabelEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForChanged(value: JetElementCustomEvent[String | Null]): Self = this.set("forChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHelpChanged(value: JetElementCustomEvent[DefinitionSource]): Self = this.set("helpChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelIdChanged(value: JetElementCustomEvent[String | Null]): Self = this.set("labelIdChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShowRequiredChanged(value: JetElementCustomEvent[Boolean | Null]): Self = this.set("showRequiredChanged", value.asInstanceOf[js.Any])
  }
}
