...
trait ojLabelEventMap extends baseComponentEventMap[ojLabelSettableProperties] {
  ...
  var helpChanged: JetElementCustomEvent[AnonDefinitionSource]
...
object ojLabelEventMap {
  ...
  def apply(
    ...
    helpChanged: JetElementCustomEvent[AnonDefinitionSource],
    input: Event_,
    invalid: Event_,
