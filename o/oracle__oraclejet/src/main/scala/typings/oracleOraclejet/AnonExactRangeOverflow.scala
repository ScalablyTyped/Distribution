...
trait AnonExactRangeOverflow extends js.Object {
...
object AnonExactRangeOverflow {
  @scala.inline
  def apply(exact: String = null, rangeOverflow: String = null, rangeUnderflow: String = null): AnonExactRangeOverflow = {
    ...
    __obj.asInstanceOf[AnonExactRangeOverflow]
  }
}
