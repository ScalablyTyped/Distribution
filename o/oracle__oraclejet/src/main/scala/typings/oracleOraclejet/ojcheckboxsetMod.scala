...
object ojcheckboxsetMod {
  ...
  trait ojCheckboxset[K, D]
    ...
    var onOjAnimateEnd_ojCheckboxset: (js.Function1[/* event */ ojAnimateEnd, js.Any]) | Null = js.native
    
    @JSName("onOjAnimateStart")
    var onOjAnimateStart_ojCheckboxset: (js.Function1[/* event */ ojAnimateStart, js.Any]) | Null = js.native
  ...
  trait ojCheckboxsetSettableProperties[K, D]
    extends StObject
       with editableValueSettableProperties[js.Array[js.Any], js.Array[js.Any], js.Array[js.Any]] {
