...
object ojcheckboxsetMod {
  ...
  trait ojCheckboxset[K, D]
    ...
    var onOjAnimateEnd_ojCheckboxset: (js.Function1[/* event */ ojAnimateEnd, Any]) | Null = js.native
    
    @JSName("onOjAnimateStart")
    var onOjAnimateStart_ojCheckboxset: (js.Function1[/* event */ ojAnimateStart, Any]) | Null = js.native
