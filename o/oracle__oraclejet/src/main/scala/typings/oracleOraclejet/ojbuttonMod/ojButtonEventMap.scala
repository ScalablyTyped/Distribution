...
trait ojButtonEventMap[SP /* <: ojButtonSettableProperties */] extends baseComponentEventMap[SP] {
  ...
  var ojAction: typings.oracleOraclejet.ojbuttonMod.ojButton.ojAction = js.native
}
...
object ojButtonEventMap {
  ...
  @scala.inline
  implicit class ojButtonEventMapOps[Self <: ojButtonEventMap[_], /* <: typings.oracleOraclejet.ojbuttonMod.ojButtonSettableProperties */ SP] (val x: Self with ojButtonEventMap[SP]) extends AnyVal {
    @scala.inline
