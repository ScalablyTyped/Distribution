...
trait ojButtonsetManyEventMap
  extends StObject
     with baseComponentEventMap[ojButtonsetManySettableProperties] {
  ...
  var focusManagementChanged: JetElementCustomEvent[oneTabstop | none]
  
  var valueChanged: JetElementCustomEvent[js.Array[Any] | Null]
}
object ojButtonsetManyEventMap {
  ...
  inline def apply(
    ...
    change: Event,
    chromingChanged: JetElementCustomEvent[full | half | outlined],
    click: MouseEvent,
    close: Event,
    ...
    error: ErrorEvent,
    focus: FocusEvent,
    focusManagementChanged: JetElementCustomEvent[oneTabstop | none],
    focusin: FocusEvent,
    focusout: FocusEvent,
    ...
    valueChanged: JetElementCustomEvent[js.Array[Any] | Null],
    volumechange: Event,
    waiting: Event,
  ...
  implicit open class MutableBuilder[Self <: ojButtonsetManyEventMap] (val x: Self) extends AnyVal {
    ...
    inline def setFocusManagementChanged(value: JetElementCustomEvent[oneTabstop | none]): Self = StObject.set(x, "focusManagementChanged", value.asInstanceOf[js.Any])
    
    inline def setValueChanged(value: JetElementCustomEvent[js.Array[Any] | Null]): Self = StObject.set(x, "valueChanged", value.asInstanceOf[js.Any])
  }
}
