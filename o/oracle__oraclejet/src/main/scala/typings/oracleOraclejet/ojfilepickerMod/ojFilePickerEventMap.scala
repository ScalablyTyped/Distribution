...
trait ojFilePickerEventMap
  ...
  var acceptChanged: JetElementCustomEvent[js.Array[String] | Null] = js.native
  
  var ojSelect: typings.oracleOraclejet.ojfilepickerMod.ojFilePicker.ojSelect = js.native
  
  var selectOnChanged: JetElementCustomEvent[auto | click | drop | clickAndDrop] = js.native
  
  var selectionModeChanged: JetElementCustomEvent[multiple | single] = js.native
}
object ojFilePickerEventMap {
  
  @scala.inline
  def apply(
    abort: UIEvent,
    acceptChanged: JetElementCustomEvent[js.Array[String] | Null],
    ...
    seeking: Event,
    select: Event,
    selectOnChanged: JetElementCustomEvent[auto | click | drop | clickAndDrop],
    selectionModeChanged: JetElementCustomEvent[multiple | single],
  ...
  implicit class ojFilePickerEventMapOps[Self <: ojFilePickerEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAcceptChanged(value: JetElementCustomEvent[js.Array[String] | Null]): Self = this.set("acceptChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOjSelect(value: ojSelect): Self = this.set("ojSelect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSelectOnChanged(value: JetElementCustomEvent[auto | click | drop | clickAndDrop]): Self = this.set("selectOnChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSelectionModeChanged(value: JetElementCustomEvent[multiple | single]): Self = this.set("selectionModeChanged", value.asInstanceOf[js.Any])
  }
}
