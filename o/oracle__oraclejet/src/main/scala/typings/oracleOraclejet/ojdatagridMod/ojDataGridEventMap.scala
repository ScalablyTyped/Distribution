...
trait ojDataGridEventMap[K, D] extends baseComponentEventMap[ojDataGridSettableProperties[K, D]] {
  ...
  var gridlinesChanged: JetElementCustomEvent[AnonHidden]
  var headerChanged: JetElementCustomEvent[AnonColumnColumnEnd[K, D]]
...
object ojDataGridEventMap {
  ...
  def apply[K, D](
    ...
    gridlinesChanged: JetElementCustomEvent[AnonHidden],
    headerChanged: JetElementCustomEvent[AnonColumnColumnEnd[K, D]],
    input: Event_,
    invalid: Event_,
