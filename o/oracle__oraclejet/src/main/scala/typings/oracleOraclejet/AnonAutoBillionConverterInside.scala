...
trait AnonAutoBillionConverterInside extends js.Object {
...
object AnonAutoBillionConverterInside {
  @scala.inline
  def apply(
    converter: js.Object,
    ...
    style: js.Object
  ): AnonAutoBillionConverterInside = {
    ...
    __obj.asInstanceOf[AnonAutoBillionConverterInside]
  }
}
