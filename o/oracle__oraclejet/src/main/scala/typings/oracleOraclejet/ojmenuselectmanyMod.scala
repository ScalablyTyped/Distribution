...
object ojmenuselectmanyMod {
  ...
  trait ojMenuSelectMany
    ...
    def addEventListener_optionsChanged(
      ...
      listener: js.ThisFunction1[
          /* this */ HTMLElement, 
          /* ev */ JetElementCustomEvent[js.Array[Option] | (DataProvider[js.Any, js.Any]) | Null], 
          js.Any
        ]
    ): Unit = js.native
    @JSName("addEventListener")
    ...
    @JSName("getProperty")
    def getProperty_options(property: options): js.Array[Option] | (DataProvider[js.Any, js.Any]) | Null = js.native
    @JSName("getProperty")
    def getProperty_value(property: value): js.Array[js.Any] = js.native
    ...
    var onOptionsChanged: (js.Function1[
        /* event */ JetElementCustomEvent[js.Array[Option] | (DataProvider[js.Any, js.Any]) | Null], 
        js.Any
      ]) | Null = js.native
    
    var onValueChanged: (js.Function1[/* event */ JetElementCustomEvent[js.Array[js.Any]], js.Any]) | Null = js.native
    
    var options: js.Array[Option] | (DataProvider[js.Any, js.Any]) | Null = js.native
    ...
    @JSName("setProperty")
    def setProperty_options(property: options, value: DataProvider[js.Any, js.Any]): Unit = js.native
    @JSName("setProperty")
  ...
  object ojMenuSelectMany {
    ...
    object Option {
      ...
      inline def apply(label: String, value: js.Any): Option = {
  ...
  trait ojMenuSelectManyEventMap
    ...
    var optionsChanged: JetElementCustomEvent[js.Array[Option] | (DataProvider[js.Any, js.Any]) | Null]
    
    var valueChanged: JetElementCustomEvent[js.Array[js.Any]]
  }
  object ojMenuSelectManyEventMap {
    ...
    inline def apply(
      ...
      mouseup: MouseEvent,
      optionsChanged: JetElementCustomEvent[js.Array[Option] | (DataProvider[js.Any, js.Any]) | Null],
      ...
      valueChanged: JetElementCustomEvent[js.Array[js.Any]],
      volumechange: Event,
      waiting: Event,
      wheel: WheelEvent
    ...
    extension [Self <: ojMenuSelectManyEventMap](x: Self) {
      ...
      inline def setOptionsChanged(value: JetElementCustomEvent[js.Array[Option] | (DataProvider[js.Any, js.Any]) | Null]): Self = StObject.set(x, "optionsChanged", value.asInstanceOf[js.Any])
      
      inline def setValueChanged(value: JetElementCustomEvent[js.Array[js.Any]]): Self = StObject.set(x, "valueChanged", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait ojMenuSelectManySettableProperties
    ...
    var options: js.Array[Option] | (DataProvider[js.Any, js.Any]) | Null
    
    var value: js.Array[js.Any]
  }
  object ojMenuSelectManySettableProperties {
    
    inline def apply(disabled: Boolean, value: js.Array[js.Any]): ojMenuSelectManySettableProperties = {
    ...
    extension [Self <: ojMenuSelectManySettableProperties](x: Self) {
      ...
      inline def setOptions(value: js.Array[Option] | (DataProvider[js.Any, js.Any])): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
  ...
  trait ojMenuSelectManySettablePropertiesLenient
    ...
    var options: js.UndefOr[js.Array[Option] | (DataProvider[js.Any, js.Any]) | Null] = js.undefined
