...
object ojmenuselectmanyMod {
  ...
  @js.native
  trait ojMenuSelectMany extends JetElement[ojMenuSelectManySettableProperties] {
    ...
    def addEventListener_optionsChanged(
      ...
      listener: js.ThisFunction1[
          /* this */ HTMLElement, 
          /* ev */ JetElementCustomEvent[js.Array[Option] | (DataProvider[_, _]) | Null], 
          _
        ]
    ): Unit = js.native
    @JSName("addEventListener")
  ...
  @js.native
  trait ojMenuSelectManyEventMap extends HTMLElementEventMap {
    
    var disabledChanged: JetElementCustomEvent[Boolean] = js.native
    
    var optionsChanged: JetElementCustomEvent[js.Array[Option] | (DataProvider[_, _]) | Null] = js.native
    
    var valueChanged: JetElementCustomEvent[js.Array[_]] = js.native
  }
  object ojMenuSelectManyEventMap {
    ...
    @scala.inline
    implicit class ojMenuSelectManyEventMapMutableBuilder[Self <: ojMenuSelectManyEventMap] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setDisabledChanged(value: JetElementCustomEvent[Boolean]): Self = StObject.set(x, "disabledChanged", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOptionsChanged(value: JetElementCustomEvent[js.Array[Option] | (DataProvider[_, _]) | Null]): Self = StObject.set(x, "optionsChanged", value.asInstanceOf[js.Any])
  ...
  object ojMenuSelectManySettableProperties {
    ...
    @scala.inline
    implicit class ojMenuSelectManySettablePropertiesMutableBuilder[Self <: ojMenuSelectManySettableProperties] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setDisabled(value: Boolean): Self = StObject.set(x, "disabled", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOptions(value: js.Array[Option] | (DataProvider[_, _])): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
  ...
  object ojMenuSelectManySettablePropertiesLenient {
    ...
    @scala.inline
    implicit class ojMenuSelectManySettablePropertiesLenientMutableBuilder[Self <: ojMenuSelectManySettablePropertiesLenient] (val x: Self) extends AnyVal {
