...
trait ojComboboxOneEventMap[K, D]
  ...
  var asyncValidatorsChanged: JetElementCustomEvent[js.Array[AsyncValidator[Any]]]
  ...
  var validatorsChanged: JetElementCustomEvent[(js.Array[Validator[Any] | RegisteredValidator]) | Null]
  
  @JSName("valueChanged")
  var valueChanged_ojComboboxOneEventMap: JetElementCustomEvent[
...
object ojComboboxOneEventMap {
  ...
  extension [Self <: ojComboboxOneEventMap[?, ?], K, D](x: Self & (ojComboboxOneEventMap[K, D])) {
    ...
    inline def setValidatorsChanged(value: JetElementCustomEvent[(js.Array[Validator[Any] | RegisteredValidator]) | Null]): Self = StObject.set(x, "validatorsChanged", value.asInstanceOf[js.Any])
