...
trait ojSelectOneEventMap[K, D]
  ...
  var optionsKeysChanged: JetElementCustomEvent[AnonChildrenLabel]
  ...
  var valueOptionChanged: JetElementCustomEvent[AnonLabelValue]
}
...
object ojSelectOneEventMap {
  ...
  def apply[K, D](
    ...
    optionsKeysChanged: JetElementCustomEvent[AnonChildrenLabel],
    ...
    valueOptionChanged: JetElementCustomEvent[AnonLabelValue],
    volumechange: Event_,
    waiting: Event_,
    wheel: WheelEvent
