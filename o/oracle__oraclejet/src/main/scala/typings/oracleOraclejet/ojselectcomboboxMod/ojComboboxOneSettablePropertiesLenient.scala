...
object ojComboboxOneSettablePropertiesLenient {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ojComboboxOneSettablePropertiesLenient[?, ?], K, D] (val x: Self & (ojComboboxOneSettablePropertiesLenient[K, D])) extends AnyVal {
