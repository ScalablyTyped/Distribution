...
object ojCombobox {
  ...
  object Optgroup {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: typings.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Optgroup] (val x: Self) extends AnyVal {
  ...
  object Option {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: typings.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Option] (val x: Self) extends AnyVal {
