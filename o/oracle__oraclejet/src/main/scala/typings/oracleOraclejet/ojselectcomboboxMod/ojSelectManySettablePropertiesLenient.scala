...
object ojSelectManySettablePropertiesLenient {
  ...
  @scala.inline
  implicit class ojSelectManySettablePropertiesLenientMutableBuilder[Self <: ojSelectManySettablePropertiesLenient[_, _], K, D] (val x: Self with (ojSelectManySettablePropertiesLenient[K, D])) extends AnyVal {
