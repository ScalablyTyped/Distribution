...
trait ojComboboxManyEventMap[K, D]
  ...
  var asyncValidatorsChanged: JetElementCustomEvent[js.Array[AsyncValidator[js.Array[Any]]]]
  ...
  var validatorsChanged: JetElementCustomEvent[(js.Array[Validator[js.Array[Any]] | RegisteredValidator]) | Null]
...
object ojComboboxManyEventMap {
  ...
  inline def apply[K, D](
    ...
    asyncValidatorsChanged: JetElementCustomEvent[js.Array[AsyncValidator[js.Array[Any]]]],
    auxclick: MouseEvent,
    ...
    validatorsChanged: JetElementCustomEvent[(js.Array[Validator[js.Array[Any]] | RegisteredValidator]) | Null],
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ojComboboxManyEventMap[?, ?], K, D] (val x: Self & (ojComboboxManyEventMap[K, D])) extends AnyVal {
    
    inline def setAsyncValidatorsChanged(value: JetElementCustomEvent[js.Array[AsyncValidator[js.Array[Any]]]]): Self = StObject.set(x, "asyncValidatorsChanged", value.asInstanceOf[js.Any])
    ...
    inline def setValidatorsChanged(value: JetElementCustomEvent[(js.Array[Validator[js.Array[Any]] | RegisteredValidator]) | Null]): Self = StObject.set(x, "validatorsChanged", value.asInstanceOf[js.Any])
