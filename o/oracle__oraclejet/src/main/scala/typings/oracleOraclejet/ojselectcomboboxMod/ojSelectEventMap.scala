...
object ojSelectEventMap {
  ...
  @scala.inline
  implicit class ojSelectEventMapOps[Self <: ojSelectEventMap[_, _, _], V, /* <: typings.oracleOraclejet.ojselectcomboboxMod.ojSelectSettableProperties[V, SV] */ SP, SV] (val x: Self with (ojSelectEventMap[V, SP, SV])) extends AnyVal {
    @scala.inline
