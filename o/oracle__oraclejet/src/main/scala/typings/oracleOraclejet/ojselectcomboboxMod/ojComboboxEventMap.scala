...
object ojComboboxEventMap {
  @scala.inline
  def apply[V, /* <: typings.oracleOraclejet.ojselectcomboboxMod.ojComboboxSettableProperties[V, SV, RV] */ SP, SV, RV](
    abort: UIEvent,
  ...
  @scala.inline
  implicit class ojComboboxEventMapOps[Self <: ojComboboxEventMap[_, _, _, _], V, /* <: typings.oracleOraclejet.ojselectcomboboxMod.ojComboboxSettableProperties[V, SV, RV] */ SP, SV, RV] (val x: Self with (ojComboboxEventMap[V, SP, SV, RV])) extends AnyVal {
    @scala.inline
