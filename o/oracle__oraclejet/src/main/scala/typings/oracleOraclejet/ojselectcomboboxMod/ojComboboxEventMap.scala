...
object ojComboboxEventMap {
  ...
  @scala.inline
  implicit class ojComboboxEventMapOps[Self <: ojComboboxEventMap[_, _, _, _], V, SP /* <: ojComboboxSettableProperties[V, SV, RV] */, SV, RV] (val x: Self with (ojComboboxEventMap[V, SP, SV, RV])) extends AnyVal {
