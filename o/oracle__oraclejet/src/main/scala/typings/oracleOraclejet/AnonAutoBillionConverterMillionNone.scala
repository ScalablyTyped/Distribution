...
trait AnonAutoBillionConverterMillionNone extends js.Object {
...
object AnonAutoBillionConverterMillionNone {
  @scala.inline
  def apply(
  ...
  ): AnonAutoBillionConverterMillionNone = {
    ...
    __obj.asInstanceOf[AnonAutoBillionConverterMillionNone]
  }
}
