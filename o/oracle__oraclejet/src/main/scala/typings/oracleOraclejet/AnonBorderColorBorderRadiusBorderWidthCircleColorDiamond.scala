...
trait AnonBorderColorBorderRadiusBorderWidthCircleColorDiamond extends js.Object {
...
object AnonBorderColorBorderRadiusBorderWidthCircleColorDiamond {
  @scala.inline
  def apply(
    borderWidth: Double,
    opacity: Double,
  ...
  ): AnonBorderColorBorderRadiusBorderWidthCircleColorDiamond = {
    ...
    __obj.asInstanceOf[AnonBorderColorBorderRadiusBorderWidthCircleColorDiamond]
  }
}
