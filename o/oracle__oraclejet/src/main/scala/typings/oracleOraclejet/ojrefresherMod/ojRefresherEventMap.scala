...
object ojRefresherEventMap {
  ...
  @scala.inline
  implicit class ojRefresherEventMapOps[Self <: ojRefresherEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefreshContentChanged(value: JetElementCustomEvent[js.Function0[js.Promise[_]]]): Self = this.set("refreshContentChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTargetChanged(value: JetElementCustomEvent[Element]): Self = this.set("targetChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTextChanged(value: JetElementCustomEvent[String]): Self = this.set("textChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setThresholdChanged(value: JetElementCustomEvent[Double]): Self = this.set("thresholdChanged", value.asInstanceOf[js.Any])
  }
}
