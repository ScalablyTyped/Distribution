...
object ojoptgroupMod {
  ...
  object ojOptgroupEventMap {
    ...
    @scala.inline
    implicit class ojOptgroupEventMapMutableBuilder[Self <: ojOptgroupEventMap] (val x: Self) extends AnyVal {
  ...
  object ojOptgroupSettableProperties {
    ...
    @scala.inline
    implicit class ojOptgroupSettablePropertiesMutableBuilder[Self <: ojOptgroupSettableProperties] (val x: Self) extends AnyVal {
  ...
  object ojOptgroupSettablePropertiesLenient {
    ...
    @scala.inline
    implicit class ojOptgroupSettablePropertiesLenientMutableBuilder[Self <: ojOptgroupSettablePropertiesLenient] (val x: Self) extends AnyVal {
