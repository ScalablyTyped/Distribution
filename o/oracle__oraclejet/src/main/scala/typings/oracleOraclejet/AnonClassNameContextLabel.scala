...
trait AnonClassNameContextLabel[K, D] extends js.Object {
...
object AnonClassNameContextLabel {
  @scala.inline
  def apply[K, D](
    ...
    __obj.asInstanceOf[AnonClassNameContextLabel[K, D]]
  }
}
