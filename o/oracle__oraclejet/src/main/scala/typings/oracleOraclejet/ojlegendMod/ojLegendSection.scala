...
trait ojLegendSection
  ...
  def addEventListener(
    ...
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.UndefOr[on | off]], js.Any]
  ): Unit = js.native
  def addEventListener(
    `type`: collapsibleChanged,
    listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ JetElementCustomEvent[js.UndefOr[on | off]], js.Any],
  ...
  var onCollapsibleChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[on | off]], js.Any]) | Null = js.native
  
  var onTextChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[String]], js.Any]) | Null = js.native
  
  var onTextHalignChanged: (js.Function1[/* event */ JetElementCustomEvent[js.UndefOr[center | end | start]], js.Any]) | Null = js.native
