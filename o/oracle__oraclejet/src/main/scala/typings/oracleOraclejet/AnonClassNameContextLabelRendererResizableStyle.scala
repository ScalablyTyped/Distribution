...
trait AnonClassNameContextLabelRendererResizableStyle[K, D] extends js.Object {
...
object AnonClassNameContextLabelRendererResizableStyle {
  @scala.inline
  def apply[K, D](
  ...
  ): AnonClassNameContextLabelRendererResizableStyle[K, D] = {
    ...
    __obj.asInstanceOf[AnonClassNameContextLabelRendererResizableStyle[K, D]]
  }
}
