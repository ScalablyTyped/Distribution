...
object ojavatarMod {
  ...
  trait ojAvatar
    ...
    var onInitialsChanged: (js.Function1[/* event */ JetElementCustomEvent[String], Any]) | Null = js.native
    
    var onSizeChanged: (js.Function1[/* event */ JetElementCustomEvent[xxs | xs | sm | md | lg | xl | xxl], Any]) | Null = js.native
    
    var onSrcChanged: (js.Function1[/* event */ JetElementCustomEvent[String], Any]) | Null = js.native
