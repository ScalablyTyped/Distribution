...
trait AnonAutoClassNameContext[K, D] extends js.Object {
  ...
  var footerRenderer: js.UndefOr[
    (js.Function1[/* context */ FooterRendererContext[K, D], AnonInsertHTMLElement | Unit]) | Null
  ] = js.undefined
  ...
  var headerRenderer: js.UndefOr[
    (js.Function1[/* context */ HeaderRendererContext[K, D], AnonInsertHTMLElement | Unit]) | Null
  ] = js.undefined
  ...
  var renderer: js.UndefOr[
    (js.Function1[/* context */ ColumnsRendererContext[K, D], AnonInsertHTMLElement | Unit]) | Null
  ] = js.undefined
  ...
  var template: js.UndefOr[AnonColumnIndexComponentElement] = js.undefined
  var width: js.UndefOr[Double | Null] = js.undefined
}

object AnonAutoClassNameContext {
  @scala.inline
  def apply[K, D](
    className: String = null,
    field: String = null,
    footerClassName: String = null,
    footerRenderer: /* context */ FooterRendererContext[K, D] => AnonInsertHTMLElement | Unit = null,
    footerStyle: String = null,
    footerTemplate: AnonComponentElementElement = null,
    headerClassName: String = null,
    headerRenderer: /* context */ HeaderRendererContext[K, D] => AnonInsertHTMLElement | Unit = null,
    headerStyle: String = null,
    headerTemplate: AnonComponentElementData = null,
    headerText: String = null,
    renderer: /* context */ ColumnsRendererContext[K, D] => AnonInsertHTMLElement | Unit = null,
    resizable: enabled | disabled = null,
    sortProperty: String = null,
    sortable: auto | enabled | disabled = null,
    style: String = null,
    template: AnonColumnIndexComponentElement = null,
    width: Int | Double = null
  ): AnonAutoClassNameContext[K, D] = {
    ...
    __obj.asInstanceOf[AnonAutoClassNameContext[K, D]]
  }
}
