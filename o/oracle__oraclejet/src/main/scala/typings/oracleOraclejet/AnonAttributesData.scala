...
object AnonAttributesData {
  ...
  def apply(
    ...
    urlRoot: String = null,
    validate: js.Object | String | (js.Function2[/* attributes */ js.Object, /* options */ js.UndefOr[AnonAttributesData], Double]) = null
  ): AnonAttributesData = {
    ...
    __obj.asInstanceOf[AnonAttributesData]
  }
}
