...
object ojTrainEventMap {
  ...
  implicit class ojTrainEventMapOps[Self <: ojTrainEventMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSelectedStepChanged(value: JetElementCustomEvent[String]): Self = this.set("selectedStepChanged", value.asInstanceOf[js.Any])
    @scala.inline
    def setStepsChanged(value: JetElementCustomEvent[js.Array[Step]]): Self = this.set("stepsChanged", value.asInstanceOf[js.Any])
  }
