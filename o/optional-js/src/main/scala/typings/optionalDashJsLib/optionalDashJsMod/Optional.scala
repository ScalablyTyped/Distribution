...
trait Optional[T] extends js.Object {
  ...
  /**
    ...
    */
  def filter(predicate: js.Function1[/* value */ T, scala.Boolean]): Optional[js.UndefOr[T | scala.Null]]
  /**
    ...
    */
  def flatMap[U](mapper: js.Function1[/* value */ T, js.UndefOr[Optional[U] | scala.Null]]): Optional[U]
  /**
  ...
  /**
    ...
    */
  def ifPresentOrElse(action: js.Function1[/* value */ T, scala.Unit], emptyAction: js.Function0[scala.Unit]): scala.Unit
  /**
    * Return true if there is a value present, otherwise false.
    *
    * @return true if there is a value present, otherwise false
    */
  def isPresent(): scala.Boolean
  /**
    ...
    */
  def map[U](mapper: js.Function1[/* value */ T, js.UndefOr[U | scala.Null]]): Optional[U]
  /**
  ...
  /**
    ...
    */
  def orElseThrow(exceptionSupplier: js.Function0[stdLib.Error]): T
}
...
object Optional {
  ...
  def apply[T](
    _value: js.Any,
    filter: js.Function1[/* value */ T, scala.Boolean] => Optional[js.UndefOr[T | scala.Null]],
    flatMap: js.Function1[/* value */ T, js.UndefOr[Optional[js.Any] | scala.Null]] => Optional[js.Any],
    get: () => T,
    ifPresent: js.Function1[/* value */ T, scala.Unit] => scala.Unit,
    ifPresentOrElse: (js.Function1[/* value */ T, scala.Unit], js.Function0[scala.Unit]) => scala.Unit,
    isPresent: () => scala.Boolean,
    map: js.Function1[/* value */ T, js.UndefOr[js.Any | scala.Null]] => Optional[js.Any],
    or: js.Function0[Optional[T]] => Optional[T],
    orElse: T => T,
    orElseGet: js.Function0[T] => T,
    orElseThrow: js.Function0[stdLib.Error] => T
  ): Optional[T] = {
    val __obj = js.Dynamic.literal(_value = _value, filter = js.Any.fromFunction1(filter), flatMap = js.Any.fromFunction1(flatMap), get = js.Any.fromFunction0(get), ifPresent = js.Any.fromFunction1(ifPresent), ifPresentOrElse = js.Any.fromFunction2(ifPresentOrElse), isPresent = js.Any.fromFunction0(isPresent), map = js.Any.fromFunction1(map), or = js.Any.fromFunction1(or), orElse = js.Any.fromFunction1(orElse), orElseGet = js.Any.fromFunction1(orElseGet), orElseThrow = js.Any.fromFunction1(orElseThrow))
