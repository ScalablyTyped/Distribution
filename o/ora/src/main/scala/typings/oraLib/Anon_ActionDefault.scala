...
@js.native
trait Anon_ActionDefault extends js.Object {
  ...
  /**
  	...
  	*/
  // TODO: Remove this for the next major release
  def default(): oraLib.oraMod.oraNs.Ora = js.native
  def default(options: java.lang.String): oraLib.oraMod.oraNs.Ora = js.native
  def default(options: oraLib.oraMod.oraNs.Options): oraLib.oraMod.oraNs.Ora = js.native
  /**
