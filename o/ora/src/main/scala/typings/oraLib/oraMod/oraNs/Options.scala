...
trait Options extends js.Object {
  ...
  /**
  		...
  		```
  		*/
  val spinner: js.UndefOr[cliDashSpinnersLib.cliDashSpinnersMod.cliSpinnersNs.SpinnerName | Spinner] = js.undefined
  /**
...
object Options {
  ...
  def apply(
    ...
    spinner: cliDashSpinnersLib.cliDashSpinnersMod.cliSpinnersNs.SpinnerName | Spinner = null,
