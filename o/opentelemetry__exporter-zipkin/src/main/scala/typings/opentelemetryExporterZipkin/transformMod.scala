...
import typings.opentelemetryExporterZipkin.typesMod.Annotation
import typings.opentelemetryExporterZipkin.typesMod.Span
import typings.opentelemetryExporterZipkin.typesMod.Tags
import typings.opentelemetryResources.mod.Resource
import typings.opentelemetrySdkTraceBase.readableSpanMod.ReadableSpan
import typings.opentelemetrySdkTraceBase.timedEventMod.TimedEvent
