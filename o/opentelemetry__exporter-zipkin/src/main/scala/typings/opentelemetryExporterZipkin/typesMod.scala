...
object typesMod {
  ...
  object SpanKind extends StObject {
    ...
    sealed trait CLIENT
      extends StObject
         with SpanKind
    /* "CLIENT" */ val CLIENT: typings.opentelemetryExporterZipkin.typesMod.SpanKind.CLIENT & String = js.native
    
    @js.native
    sealed trait CONSUMER
      extends StObject
         with SpanKind
    /* "CONSUMER" */ val CONSUMER: typings.opentelemetryExporterZipkin.typesMod.SpanKind.CONSUMER & String = js.native
    
    @js.native
    sealed trait PRODUCER
      extends StObject
         with SpanKind
    /* "PRODUCER" */ val PRODUCER: typings.opentelemetryExporterZipkin.typesMod.SpanKind.PRODUCER & String = js.native
    
    @js.native
    sealed trait SERVER
      extends StObject
         with SpanKind
    /* "SERVER" */ val SERVER: typings.opentelemetryExporterZipkin.typesMod.SpanKind.SERVER & String = js.native
  }
