...
class Graticule () extends js.Object {
  ...
  /**
    ...
    * @api
    */
  def getMeridians(): js.Array[openlayersLib.openlayersMod.geomNs.LineString] = js.native
  /**
    * Get the list of parallels.  Pallels are lines of equal latitude.
    * @return The parallels.
    * @api
    */
  def getParallels(): js.Array[openlayersLib.openlayersMod.geomNs.LineString] = js.native
  /**
