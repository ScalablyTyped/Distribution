...
trait DefaultsOptions extends js.Object {
  ...
  var attributionOptions: js.UndefOr[typings.openlayers.openlayersMod.olxNs.controlNs.AttributionOptions] = js.undefined
...
object DefaultsOptions {
  ...
  def apply(
    ...
    attributionOptions: typings.openlayers.openlayersMod.olxNs.controlNs.AttributionOptions = null,
