...
class Map protected () extends Object {
  ...
  /**
    ...
    * @api stable
    */
  def forEachLayerAtPixel[T](pixel: Pixel, callback: js.Function2[/* layer */ Layer, /* color */ Color, T]): T = js.native
  def forEachLayerAtPixel[T](pixel: Pixel, callback: js.Function2[/* layer */ Layer, /* color */ Color, T], opt_this: js.Any): T = js.native
  def forEachLayerAtPixel[T](
    pixel: Pixel,
    callback: js.Function2[/* layer */ Layer, /* color */ Color, T],
    opt_this: js.Any,
