...
import typings.openlayers.openlayersMod.olx.style.RegularShapeOptions
import typings.openlayers.openlayersMod.olx.style.StrokeOptions
import typings.openlayers.openlayersMod.olx.style.StyleOptions
import typings.openlayers.openlayersMod.olx.style.TextOptions
