...
import typings.openlayers.openlayersMod.WFSFeatureCollectionMetadata
import typings.openlayers.openlayersMod.WFSTransactionResponse
import typings.openlayers.openlayersMod.olx.format.ReadOptions
import typings.openlayers.openlayersMod.olx.format.WFSOptions
import typings.openlayers.openlayersMod.olx.format.WFSWriteGetFeatureOptions
import typings.openlayers.openlayersMod.olx.format.WFSWriteTransactionOptions
