...
import typings.openlayers.openlayersMod.olx.ProjectionOptions
...
object proj extends js.Object {
  ...
  class Projection protected () extends js.Object {
    ...
    /**
      ...
      * @api
      */
    def getPointResolution(resolution: Double, point: Coordinate): Double = js.native
    /**
    ...
    /**
      ...
      * @api
      */
    def setGetPointResolution(func: js.Function2[/* resolution */ Double, /* coords */ Coordinate, Double]): Unit = js.native
    /**
  ...
  */
  ...
  /**
    ...
    */
  def getPointResolution(projection: Projection, resolution: Double, point: Coordinate): Double = js.native
  /**
