...
import typings.openlayers.openlayersMod.FeatureLoader
import typings.openlayers.openlayersMod.FeatureUrlFunction
import typings.openlayers.openlayersMod.LoadingStrategy
...
object VectorOptions {
  ...
  def apply(
    ...
    loader: (/* extent */ Extent, /* resolution */ Double, /* proj */ Projection) => Unit = null,
    logo: String | LogoOptions = null,
    overlaps: js.UndefOr[Boolean] = js.undefined,
    strategy: (/* extent */ Extent, /* resolution */ Double) => js.Array[Extent] = null,
