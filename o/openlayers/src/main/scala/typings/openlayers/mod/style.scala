...
object style {
  ...
  open class Icon ()
    ...
    /**
      ...
      * @api
      */
    def getImage(pixelRatio: Double): typings.openlayers.mod.style.Image | HTMLCanvasElement = js.native
  ...
  open class RegularShape protected ()
    ...
    /**
      ...
      * @api
      */
    def getImage(pixelRatio: Double): HTMLCanvasElement | HTMLVideoElement | typings.openlayers.mod.style.Image = js.native
  ...
  open class Style () extends StObject {
    ...
    /**
      ...
      * @api
      */
    def getImage(): typings.openlayers.mod.style.Image = js.native
    ...
    /**
      ...
      * @api
      */
    def setImage(image: typings.openlayers.mod.style.Image): Unit = js.native
