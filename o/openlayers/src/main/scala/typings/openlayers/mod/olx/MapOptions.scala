...
object MapOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(loadTilesWhileAnimating)) __obj.updateDynamic("loadTilesWhileAnimating")(loadTilesWhileAnimating.get.asInstanceOf[js.Any])
    if (!js.isUndefined(loadTilesWhileInteracting)) __obj.updateDynamic("loadTilesWhileInteracting")(loadTilesWhileInteracting.get.asInstanceOf[js.Any])
