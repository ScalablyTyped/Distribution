...
object proj {
  ...
  /**
    ...
    * @api
    */
  inline def addEquivalentProjections(projections: js.Array[typings.openlayers.mod.proj.Projection]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addEquivalentProjections")(projections.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    * @api stable
    */
  inline def addProjection(projection: typings.openlayers.mod.proj.Projection): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addProjection")(projection.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def equivalent(
    projection1: typings.openlayers.mod.proj.Projection,
    projection2: typings.openlayers.mod.proj.Projection
  ...
  /**
    ...
    * @api stable
    */
  inline def get(projectionLike: ProjectionLike): typings.openlayers.mod.proj.Projection = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(projectionLike.asInstanceOf[js.Any]).asInstanceOf[typings.openlayers.mod.proj.Projection]
  ...
  /**
    ...
    */
  inline def getPointResolution(projection: typings.openlayers.mod.proj.Projection, resolution: Double, point: Coordinate_): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getPointResolution")(projection.asInstanceOf[js.Any], resolution.asInstanceOf[js.Any], point.asInstanceOf[js.Any])).asInstanceOf[Double]
