...
import typings.oauthJs.AnonSignatureMethod
...
trait SignatureMethodStatic extends js.Object {
  ...
  var REGISTERED: StringDictionary[AnonSignatureMethod]
  /**
  ...
  /**
    ...
    */
  def makeSubclass(getSignatureFunction: js.Function1[/* baseString */ String, String]): AnonSignatureMethod
  ...
  /**
    ...
    */
  def registerMethodClass(names: js.Array[String], classConstructor: AnonSignatureMethod): Unit
...
object SignatureMethodStatic {
  @scala.inline
  def apply(
    REGISTERED: StringDictionary[AnonSignatureMethod],
    getBaseString: Message => String,
    makeSubclass: js.Function1[/* baseString */ String, String] => AnonSignatureMethod,
    newMethod: (String, Accessor) => SignatureMethod,
    normalizeParameters: ParameterListOrMap => String,
    normalizeUrl: String => String,
    parseUri: String => Uri,
    registerMethodClass: (js.Array[String], AnonSignatureMethod) => Unit,
