...
@js.native
trait OptionspathAsArraytrue extends js.Object {
...
object OptionspathAsArraytrue {
  ...
  @scala.inline
  implicit class OptionspathAsArraytrueOps[Self <: OptionspathAsArraytrue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPathAsArray(value: js.UndefOr[Boolean] with `true`): Self = this.set("pathAsArray", value.asInstanceOf[js.Any])
