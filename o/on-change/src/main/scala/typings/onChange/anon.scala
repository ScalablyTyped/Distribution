...
object anon {
  ...
  /* Inlined on-change.on-change.Options & {  ignoreSymbols :true,   pathAsArray :true} */
  trait OptionsignoreSymbolstruep extends StObject {
    ...
    /**
    	...
    	*/
    @JSName("equals")
    var equals_FOptionsignoreSymbolstruep: js.UndefOr[js.Function2[/* a */ Any, /* b */ Any, Boolean]] = js.undefined
  ...
  object OptionsignoreSymbolstruep {
    
    inline def apply(): OptionsignoreSymbolstruep = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OptionsignoreSymbolstruep]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: OptionsignoreSymbolstruep] (val x: Self) extends AnyVal {
