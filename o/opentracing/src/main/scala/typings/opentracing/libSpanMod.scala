...
@js.native
object libSpanMod extends js.Object {
  @js.native
  class Span () extends js.Object {
    /* protected */ def _addTags(keyValuePairs: StringDictionary[js.Any]): Unit = js.native
    /* protected */ def _context(): typings.opentracing.libSpanUnderscoreContextMod.default = js.native
    ...
    /* protected */ def _tracer(): typings.opentracing.libTracerMod.default = js.native
    /**
    ...
    /**
      ...
      * @return {SpanContext}
      */
    def context(): typings.opentracing.libSpanUnderscoreContextMod.default = js.native
    /**
    ...
    /**
      ...
      * @return {Tracer}
      */
    def tracer(): typings.opentracing.libTracerMod.default = js.native
  }
