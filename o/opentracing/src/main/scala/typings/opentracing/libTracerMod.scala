...
object libTracerMod {
  ...
  open class Tracer () extends StObject {
    ...
    /* protected */ def _extract(format: String, carrier: Any): typings.opentracing.libSpanContextMod.default | Null = js.native
    
    /* protected */ def _inject(spanContext: typings.opentracing.libSpanContextMod.default, format: String, carrier: Any): Unit = js.native
    
    /* protected */ def _startSpan(name: String, fields: SpanOptions): typings.opentracing.libSpanMod.default = js.native
    ...
    /**
      ...
      *         be found in `carrier`
      */
    def extract(format: String, carrier: Any): typings.opentracing.libSpanContextMod.default | Null = js.native
    ...
    /**
      ...
      */
    def inject(spanContext: typings.opentracing.libSpanContextMod.default, format: String, carrier: Any): Unit = js.native
    def inject(spanContext: typings.opentracing.libSpanMod.default, format: String, carrier: Any): Unit = js.native
    ...
    /**
      ...
      */
    def startSpan(name: String): typings.opentracing.libSpanMod.default = js.native
    def startSpan(name: String, options: SpanOptions): typings.opentracing.libSpanMod.default = js.native
  }
  ...
  trait SpanOptions extends StObject {
    ...
    var childOf: js.UndefOr[
        typings.opentracing.libSpanMod.default | typings.opentracing.libSpanContextMod.default
      ] = js.undefined
    ...
    /**
      ...
      */
    var references: js.UndefOr[js.Array[typings.opentracing.libReferenceMod.default]] = js.undefined
  ...
  object SpanOptions {
    ...
    extension [Self <: SpanOptions](x: Self) {
      ...
      inline def setReferences(value: js.Array[typings.opentracing.libReferenceMod.default]): Self = StObject.set(x, "references", value.asInstanceOf[js.Any])
      
      inline def setReferencesUndefined: Self = StObject.set(x, "references", js.undefined)
      
      inline def setReferencesVarargs(value: typings.opentracing.libReferenceMod.default*): Self = StObject.set(x, "references", js.Array(value*))
