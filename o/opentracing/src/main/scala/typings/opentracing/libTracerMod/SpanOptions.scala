...
trait SpanOptions extends js.Object {
  ...
  var childOf: js.UndefOr[
    typings.opentracing.libSpanMod.default | typings.opentracing.libSpanUnderscoreContextMod.default
  ] = js.undefined
  /**
...
object SpanOptions {
  @scala.inline
  def apply(
    childOf: typings.opentracing.libSpanMod.default | typings.opentracing.libSpanUnderscoreContextMod.default = null,
    references: js.Array[typings.opentracing.libReferenceMod.default] = null,
