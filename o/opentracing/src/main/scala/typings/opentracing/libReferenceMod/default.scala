...
class default protected () extends Reference {
  ...
  /* CompleteClass */
  override var _referencedContext: typings.opentracing.libSpanUnderscoreContextMod.default = js.native
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def referencedContext(): typings.opentracing.libSpanUnderscoreContextMod.default = js.native
  /**
