...
trait ObjectPathStatic extends js.Object {
  ...
  @JSName("coalesce")
  def coalesce_TResultTResult[TResult](`object`: js.Object, paths: js.Array[Path], defaultValue: TResult): TResult = js.native
  /**
    * Get the first non undefined property
    */
  @JSName("coalesce")
  def coalesce_TResultTResult[TResult](`object`: js.Object, paths: Path, defaultValue: TResult): TResult = js.native
  /**
    * Deletes a member from object or array
    */
  def del(`object`: js.Object, path: Path): org.scalablytyped.runtime.StringDictionary[js.Any] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("ensureExists")
  def ensureExists_TResultTResult[TResult](`object`: js.Object, path: Path, defaultValue: TResult): TResult = js.native
  /**
  ...
  /**
    ...
    */
  def has(`object`: js.Object, path: Path): scala.Boolean = js.native
  /**
    * Insert an item in an array path
    */
  def insert(`object`: js.Object, path: Path, value: js.Any): scala.Unit = js.native
  def insert(`object`: js.Object, path: Path, value: js.Any, at: scala.Double): scala.Unit = js.native
  /**
    * Create (if path isn't an array) and push the value to it. Can push unlimited number of values
    */
  def push(`object`: js.Object, path: Path, items: js.Any*): scala.Unit = js.native
  /**
  ...
  def set[TResult](`object`: js.Object, path: Path, value: TResult, doNotReplace: scala.Boolean): js.UndefOr[TResult] = js.native
}
