...
trait EventSource extends js.Object {
  ...
  def getHandlerForEvent(eventType: java.lang.String): js.Function1[/* param0 */ stdLib.Event, scala.Unit]
}
...
object EventSource {
  ...
  def apply(
    ...
    getHandlerForEvent: java.lang.String => js.Function1[/* param0 */ stdLib.Event, scala.Unit]
  ): EventSource = {
