...
trait WMTS
  ...
  def getDimensions(): org.scalablytyped.runtime.StringDictionary[js.Any] = js.native
  ...
  def updateDimensions(dimensions: org.scalablytyped.runtime.StringDictionary[js.Any]): scala.Unit = js.native
}
