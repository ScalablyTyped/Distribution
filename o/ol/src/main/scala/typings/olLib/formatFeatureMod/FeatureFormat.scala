...
trait FeatureFormat extends js.Object {
  ...
  def readFeature(source: js.Object): olLib.featureMod.FeatureLike = js.native
  def readFeature(source: js.Object, opt_options: ReadOptions): olLib.featureMod.FeatureLike = js.native
  ...
  def readFeatures(source: js.Object): js.Array[olLib.featureMod.FeatureLike] = js.native
  def readFeatures(source: js.Object, opt_options: ReadOptions): js.Array[olLib.featureMod.FeatureLike] = js.native
  ...
  def readGeometry(source: js.Object): olLib.geomGeometryMod.default = js.native
  def readGeometry(source: js.Object, opt_options: ReadOptions): olLib.geomGeometryMod.default = js.native
  ...
  def readProjection(source: js.Object): olLib.projProjectionMod.default = js.native
