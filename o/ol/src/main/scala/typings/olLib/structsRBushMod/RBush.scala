...
trait RBush[T] extends js.Object {
  ...
  def forEach[S](callback: js.ThisFunction1[/* this */ S, /* p0 */ T, scala.Unit]): js.Any = js.native
  def forEach[S](callback: js.ThisFunction1[/* this */ S, /* p0 */ T, scala.Unit], opt_this: S): js.Any = js.native
  def forEachInExtent[S](extent: olLib.extentMod.Extent, callback: js.ThisFunction1[/* this */ S, /* p0 */ T, scala.Unit]): js.Any = js.native
  def forEachInExtent[S](
    extent: olLib.extentMod.Extent,
    callback: js.ThisFunction1[/* this */ S, /* p0 */ T, scala.Unit],
    opt_this: S
  ): js.Any = js.native
