...
object ImageStyle {
  ...
  def apply(
    ...
    listenImageChange: (js.ThisFunction1[js.Any, /* param1 */ olLib.eventsEventMod.default, scala.Unit], js.Any) => olLib.eventsMod.EventsKey,
    load: () => scala.Unit,
    ...
    unlistenImageChange: (js.ThisFunction1[js.Any, /* param1 */ olLib.eventsEventMod.default, scala.Unit], js.Any) => scala.Unit
  ): ImageStyle = {
