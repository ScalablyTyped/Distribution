...
trait CanvasReplay
  ...
  def updateFillStyle(
    ...
    createFill: js.ThisFunction2[
      /* this */ this.type, 
      /* p0 */ olLib.renderCanvasMod.FillStrokeState, 
      /* p1 */ olLib.geomGeometryMod.default | olLib.renderFeatureMod.default, 
      js.Array[_]
    ],
  ...
  def updateStrokeStyle(
    state: olLib.renderCanvasMod.FillStrokeState,
    applyStroke: js.ThisFunction1[/* this */ this.type, /* p0 */ olLib.renderCanvasMod.FillStrokeState, scala.Unit]
  ): scala.Unit = js.native
}
