...
object gml3Mod {
  ...
  trait GML3
    ...
    def curveMemberParser(node: Element, objectStack: js.Array[js.Any]): Unit = js.native
    
    def exteriorParser(node: Element, objectStack: js.Array[js.Any]): Unit = js.native
    
    def interiorParser(node: Element, objectStack: js.Array[js.Any]): Unit = js.native
    
    def readCurve(node: Element, objectStack: js.Array[js.Any]): js.UndefOr[typings.ol.lineStringMod.default] = js.native
    
    def readEnvelope(node: Element, objectStack: js.Array[js.Any]): js.UndefOr[Extent] = js.native
    
    def readFlatPos(node: Node, objectStack: js.Array[js.Any]): js.UndefOr[js.Array[Double]] = js.native
    
    def readFlatPosList(node: Element, objectStack: js.Array[js.Any]): js.UndefOr[js.Array[Double]] = js.native
    
    def readLineStringSegment(node: Element, objectStack: js.Array[js.Any]): js.UndefOr[js.Array[Double]] = js.native
    
    def readMultiCurve(node: Element, objectStack: js.Array[js.Any]): js.UndefOr[typings.ol.multiLineStringMod.default] = js.native
    
    def readMultiSurface(node: Element, objectStack: js.Array[js.Any]): js.UndefOr[typings.ol.multiPolygonMod.default] = js.native
    
    def readPatch(node: Element, objectStack: js.Array[js.Any]): js.UndefOr[js.Array[js.Array[Double]]] = js.native
    
    def readPolygonPatch(node: Element, objectStack: js.Array[js.Any]): js.UndefOr[js.Array[js.Array[Double]]] = js.native
    
    def readSegment(node: Element, objectStack: js.Array[js.Any]): js.UndefOr[js.Array[Double]] = js.native
    
    def readSurface(node: Element, objectStack: js.Array[js.Any]): js.UndefOr[typings.ol.polygonMod.default] = js.native
    
    def surfaceMemberParser(node: Element, objectStack: js.Array[js.Any]): Unit = js.native
    ...
    def writeLineStringOrCurveMember(node: Node, line: typings.ol.lineStringMod.default, objectStack: js.Array[js.Any]): Unit = js.native
