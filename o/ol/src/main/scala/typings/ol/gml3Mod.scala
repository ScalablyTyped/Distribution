...
object gml3Mod {
  ...
  trait GML3
    ...
    def readCurve(node: Element, objectStack: js.Array[Any]): js.UndefOr[typings.ol.lineStringMod.default] = js.native
    ...
    def readMultiCurve(node: Element, objectStack: js.Array[Any]): js.UndefOr[typings.ol.multiLineStringMod.default] = js.native
    
    def readMultiSurface(node: Element, objectStack: js.Array[Any]): js.UndefOr[typings.ol.multiPolygonMod.default] = js.native
    ...
    def readSurface(node: Element, objectStack: js.Array[Any]): js.UndefOr[typings.ol.polygonMod.default] = js.native
    ...
    def writeLineStringOrCurveMember(node: Node, line: typings.ol.lineStringMod.default, objectStack: js.Array[Any]): Unit = js.native
