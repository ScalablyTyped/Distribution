...
trait VectorSource[GeomType /* <: typings.ol.geomGeometryMod.default */]
  ...
  def forEachFeature[T](callback: js.Function1[/* p0 */ typings.ol.featureMod.default[GeomType], T]): T = js.native
  def forEachFeatureAtCoordinateDirect[T](
    coordinate: Coordinate,
    callback: js.Function1[/* p0 */ typings.ol.featureMod.default[GeomType], T]
  ): T = js.native
  def forEachFeatureInExtent[T](extent: Extent, callback: js.Function1[/* p0 */ typings.ol.featureMod.default[GeomType], T]): T = js.native
  def forEachFeatureIntersectingExtent[T](extent: Extent, callback: js.Function1[/* p0 */ typings.ol.featureMod.default[GeomType], T]): T = js.native
