...
object tilegridWmtsMod {
  ...
  inline def createFromCapabilitiesMatrixSet(matrixSet: js.Any): WMTSTileGrid = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromCapabilitiesMatrixSet")(matrixSet.asInstanceOf[js.Any]).asInstanceOf[WMTSTileGrid]
  ...
  inline def createFromCapabilitiesMatrixSet(matrixSet: js.Any, opt_extent: Extent): WMTSTileGrid = (^.asInstanceOf[js.Dynamic].applyDynamic("createFromCapabilitiesMatrixSet")(matrixSet.asInstanceOf[js.Any], opt_extent.asInstanceOf[js.Any])).asInstanceOf[WMTSTileGrid]
