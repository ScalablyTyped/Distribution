...
trait GMLBase
  ...
  def readFeaturesInternal(node: Element, objectStack: js.Array[_]): js.Array[typings.ol.featureMod.default] = js.native
  def readGeometryElement(node: Element, objectStack: js.Array[_]): typings.ol.geomGeometryMod.default = js.native
