...
object formatGmlbaseMod {
  ...
  trait GMLBase
    ...
    def readFeatureElementInternal(node: Element, objectStack: js.Array[Any], asFeature: Boolean): typings.ol.featureMod.default[typings.ol.geomGeometryMod.default] | js.Object = js.native
    ...
    def readGeometryElement(node: Element, objectStack: js.Array[Any]): js.UndefOr[typings.ol.geomGeometryMod.default | Extent] = js.native
    
    /* protected */ @JSName("readGeometryFromNode")
    def readGeometryFromNode_default(node: Element): typings.ol.geomGeometryMod.default = js.native
    /* protected */ @JSName("readGeometryFromNode")
    def readGeometryFromNode_default(node: Element, opt_options: ReadOptions): typings.ol.geomGeometryMod.default = js.native
