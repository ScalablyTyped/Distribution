...
object geomPolygonMod {
  ...
  inline def fromCircle(circle: typings.ol.geomCircleMod.default, opt_sides: Double): Polygon = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCircle")(circle.asInstanceOf[js.Any], opt_sides.asInstanceOf[js.Any])).asInstanceOf[Polygon]
  inline def fromCircle(circle: typings.ol.geomCircleMod.default, opt_sides: Double, opt_angle: Double): Polygon = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCircle")(circle.asInstanceOf[js.Any], opt_sides.asInstanceOf[js.Any], opt_angle.asInstanceOf[js.Any])).asInstanceOf[Polygon]
  inline def fromCircle(circle: typings.ol.geomCircleMod.default, opt_sides: Unit, opt_angle: Double): Polygon = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCircle")(circle.asInstanceOf[js.Any], opt_sides.asInstanceOf[js.Any], opt_angle.asInstanceOf[js.Any])).asInstanceOf[Polygon]
