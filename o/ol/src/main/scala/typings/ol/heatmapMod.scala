...
object heatmapMod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setWeightFunction1(value: /* p0 */ typings.ol.olFeatureMod.default[typings.ol.geometryMod.default] => Double): Self = StObject.set(x, "weight", js.Any.fromFunction1(value))
