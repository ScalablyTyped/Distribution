...
object formatWfsMod {
  ...
  object Options {
    ...
    implicit open class MutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      inline def setGmlFormat(value: typings.ol.formatGmlbaseMod.default): Self = StObject.set(x, "gmlFormat", value.asInstanceOf[js.Any])
  ...
  object WriteGetFeatureOptions {
    ...
    implicit open class MutableBuilder[Self <: WriteGetFeatureOptions] (val x: Self) extends AnyVal {
      ...
      inline def setFilter(value: typings.ol.formatFilterFilterMod.default): Self = StObject.set(x, "filter", value.asInstanceOf[js.Any])
  ...
  object WriteTransactionOptions {
    ...
    implicit open class MutableBuilder[Self <: WriteTransactionOptions] (val x: Self) extends AnyVal {
      ...
      inline def setGmlOptions(value: typings.ol.formatGmlbaseMod.Options): Self = StObject.set(x, "gmlOptions", value.asInstanceOf[js.Any])
