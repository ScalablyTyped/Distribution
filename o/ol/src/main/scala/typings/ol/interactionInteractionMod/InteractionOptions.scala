...
trait InteractionOptions extends js.Object {
  def handleEvent(p0: typings.ol.mapBrowserEventMod.default): Boolean = js.native
}
...
object InteractionOptions {
  ...
  implicit class InteractionOptionsOps[Self <: InteractionOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHandleEvent(value: typings.ol.mapBrowserEventMod.default => Boolean): Self = this.set("handleEvent", js.Any.fromFunction1(value))
  }
