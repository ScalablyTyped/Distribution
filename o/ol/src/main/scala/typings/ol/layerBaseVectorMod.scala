...
object layerBaseVectorMod {
  ...
  @js.native
  open class default[VectorSourceType /* <: typings.ol.sourceVectorMod.default[typings.ol.geomGeometryMod.default] | typings.ol.sourceVectorTileMod.default */] () extends BaseVectorLayer[VectorSourceType] {
