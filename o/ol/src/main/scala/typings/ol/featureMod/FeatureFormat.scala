...
trait FeatureFormat extends js.Object {
  ...
  def readGeometry(source: Document_): typings.ol.geometryMod.default = js.native
  def readGeometry(source: Document_, opt_options: ReadOptions): typings.ol.geometryMod.default = js.native
  ...
  def readProjection(source: Document_): typings.ol.projectionMod.default = js.native
