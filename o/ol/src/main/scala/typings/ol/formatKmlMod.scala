...
object formatKmlMod {
  ...
  inline def getDefaultFillStyle(): typings.ol.styleFillMod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultFillStyle")().asInstanceOf[typings.ol.styleFillMod.default]
  ...
  inline def getDefaultStrokeStyle(): typings.ol.styleStrokeMod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultStrokeStyle")().asInstanceOf[typings.ol.styleStrokeMod.default]
  ...
  inline def getDefaultTextStyle(): typings.ol.styleTextMod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultTextStyle")().asInstanceOf[typings.ol.styleTextMod.default]
