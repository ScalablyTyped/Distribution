...
object formatXMLFeatureMod extends js.Object {
  ...
  trait XMLFeature
    ...
    def readFeatureFromNode(node: Node): typings.ol.featureMod.default[typings.ol.geomGeometryMod.default] = js.native
    def readFeatureFromNode(node: Node, opt_options: ReadOptions): typings.ol.featureMod.default[typings.ol.geomGeometryMod.default] = js.native
    ...
    /* protected */ def readFeaturesFromNode(node: Node): js.Array[typings.ol.featureMod.default[typings.ol.geomGeometryMod.default]] = js.native
    /* protected */ def readFeaturesFromNode(node: Node, opt_options: ReadOptions): js.Array[typings.ol.featureMod.default[typings.ol.geomGeometryMod.default]] = js.native
