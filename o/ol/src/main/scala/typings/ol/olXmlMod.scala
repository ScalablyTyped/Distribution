...
object olXmlMod {
  ...
  inline def isDocument(`object`: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDocument")(`object`.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  inline def makeArrayPusher[T](valueReader: js.ThisFunction2[/* this */ T, /* p0 */ Element, /* p1 */ js.Array[js.Any], js.Any]): Parser = ^.asInstanceOf[js.Dynamic].applyDynamic("makeArrayPusher")(valueReader.asInstanceOf[js.Any]).asInstanceOf[Parser]
  ...
  inline def makeObjectPropertyPusher[T](valueReader: js.ThisFunction2[/* this */ T, /* p0 */ Element, /* p1 */ js.Array[js.Any], js.Any]): Parser = ^.asInstanceOf[js.Dynamic].applyDynamic("makeObjectPropertyPusher")(valueReader.asInstanceOf[js.Any]).asInstanceOf[Parser]
  ...
  inline def makeObjectPropertySetter[T](valueReader: js.ThisFunction2[/* this */ T, /* p0 */ Element, /* p1 */ js.Array[js.Any], js.Any]): Parser = ^.asInstanceOf[js.Dynamic].applyDynamic("makeObjectPropertySetter")(valueReader.asInstanceOf[js.Any]).asInstanceOf[Parser]
  ...
  inline def makeReplacer[T](valueReader: js.ThisFunction2[/* this */ T, /* p0 */ Node, /* p1 */ js.Array[js.Any], js.Any]): Parser = ^.asInstanceOf[js.Dynamic].applyDynamic("makeReplacer")(valueReader.asInstanceOf[js.Any]).asInstanceOf[Parser]
  ...
  inline def makeSequence(`object`: StringDictionary[js.Any], orderedKeys: js.Array[String]): js.Array[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeSequence")(`object`.asInstanceOf[js.Any], orderedKeys.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Any]]
  ...
  inline def makeSimpleNodeFactory(opt_nodeName: String): js.Function3[
    /* p0 */ js.Any, 
    /* p1 */ js.Array[js.Any], 
    /* p2 */ js.UndefOr[String], 
    js.UndefOr[Node]
  ...
  inline def makeSimpleNodeFactory(opt_nodeName: String, opt_namespaceURI: String): js.Function3[
    /* p0 */ js.Any, 
    /* p1 */ js.Array[js.Any], 
    /* p2 */ js.UndefOr[String], 
    js.UndefOr[Node]
  ...
  inline def makeSimpleNodeFactory(opt_nodeName: Unit, opt_namespaceURI: String): js.Function3[
    /* p0 */ js.Any, 
    /* p1 */ js.Array[js.Any], 
    /* p2 */ js.UndefOr[String], 
    js.UndefOr[Node]
