...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTileClass(value: typings.ol.olVectorTileMod.default): Self = this.set("tileClass", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTileUrlFunction(value: (/* p0 */ TileCoord, /* p1 */ Double, /* p2 */ typings.ol.projectionMod.default) => String): Self = this.set("tileUrlFunction", js.Any.fromFunction3(value))
    @scala.inline
