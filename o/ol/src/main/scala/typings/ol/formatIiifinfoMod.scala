...
object formatIiifinfoMod {
  ...
  object Versions extends StObject {
    ...
    sealed trait VERSION1
      extends StObject
         with Versions
    /* "version1" */ val VERSION1: typings.ol.formatIiifinfoMod.Versions.VERSION1 & String = js.native
    
    @js.native
    sealed trait VERSION2
      extends StObject
         with Versions
    /* "version2" */ val VERSION2: typings.ol.formatIiifinfoMod.Versions.VERSION2 & String = js.native
    
    @js.native
    sealed trait VERSION3
      extends StObject
         with Versions
    /* "version3" */ val VERSION3: typings.ol.formatIiifinfoMod.Versions.VERSION3 & String = js.native
  }
