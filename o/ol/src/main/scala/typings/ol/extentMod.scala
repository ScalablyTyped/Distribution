...
object extentMod {
  ...
  inline def applyTransform(extent: Extent, transformFn: TransformFunction, dest: Unit, stops: Double): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("applyTransform")(extent.asInstanceOf[js.Any], transformFn.asInstanceOf[js.Any], dest.asInstanceOf[js.Any], stops.asInstanceOf[js.Any])).asInstanceOf[Extent]
  inline def applyTransform(extent: Extent, transformFn: TransformFunction, dest: Extent): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("applyTransform")(extent.asInstanceOf[js.Any], transformFn.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Extent]
  inline def applyTransform(extent: Extent, transformFn: TransformFunction, dest: Extent, stops: Double): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("applyTransform")(extent.asInstanceOf[js.Any], transformFn.asInstanceOf[js.Any], dest.asInstanceOf[js.Any], stops.asInstanceOf[js.Any])).asInstanceOf[Extent]
  ...
  inline def buffer(extent: Extent, value: Double, dest: Extent): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("buffer")(extent.asInstanceOf[js.Any], value.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Extent]
  ...
  inline def clone_(extent: Extent, dest: Extent): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("clone")(extent.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Extent]
  ...
  inline def coordinateRelationship(extent: Extent, coordinate: Coordinate): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("coordinateRelationship")(extent.asInstanceOf[js.Any], coordinate.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  inline def createOrUpdate(minX: Double, minY: Double, maxX: Double, maxY: Double, dest: Extent): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("createOrUpdate")(minX.asInstanceOf[js.Any], minY.asInstanceOf[js.Any], maxX.asInstanceOf[js.Any], maxY.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Extent]
  
  inline def createOrUpdateEmpty(): Extent = ^.asInstanceOf[js.Dynamic].applyDynamic("createOrUpdateEmpty")().asInstanceOf[Extent]
  inline def createOrUpdateEmpty(dest: Extent): Extent = ^.asInstanceOf[js.Dynamic].applyDynamic("createOrUpdateEmpty")(dest.asInstanceOf[js.Any]).asInstanceOf[Extent]
  ...
  inline def createOrUpdateFromCoordinate(coordinate: Coordinate, dest: Extent): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("createOrUpdateFromCoordinate")(coordinate.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Extent]
  ...
  inline def createOrUpdateFromCoordinates(coordinates: js.Array[Coordinate], dest: Extent): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("createOrUpdateFromCoordinates")(coordinates.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Extent]
  ...
  inline def createOrUpdateFromFlatCoordinates(flatCoordinates: js.Array[Double], offset: Double, end: Double, stride: Double, dest: Extent): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("createOrUpdateFromFlatCoordinates")(flatCoordinates.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], end.asInstanceOf[js.Any], stride.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Extent]
  ...
  inline def createOrUpdateFromRings(rings: js.Array[js.Array[Coordinate]], dest: Extent): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("createOrUpdateFromRings")(rings.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Extent]
  ...
  inline def forEachCorner[S](extent: Extent, callback: js.Function1[/* arg0 */ Coordinate, S]): Boolean | S = (^.asInstanceOf[js.Dynamic].applyDynamic("forEachCorner")(extent.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Boolean | S]
  ...
  inline def getForViewAndSize(center: Coordinate, resolution: Double, rotation: Double, size: Size, dest: Extent): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("getForViewAndSize")(center.asInstanceOf[js.Any], resolution.asInstanceOf[js.Any], rotation.asInstanceOf[js.Any], size.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Extent]
  ...
  inline def getIntersection(extent1: Extent, extent2: Extent, dest: Extent): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("getIntersection")(extent1.asInstanceOf[js.Any], extent2.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Extent]
  ...
  inline def getRotatedViewport(center: Coordinate, resolution: Double, rotation: Double, size: Size): js.Array[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("getRotatedViewport")(center.asInstanceOf[js.Any], resolution.asInstanceOf[js.Any], rotation.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[js.Array[Double]]
  ...
  inline def returnOrUpdate(extent: Extent, dest: Extent): Extent = (^.asInstanceOf[js.Dynamic].applyDynamic("returnOrUpdate")(extent.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Extent]
  ...
  inline def wrapAndSliceX(extent: Extent, projection: default): js.Array[Extent] = (^.asInstanceOf[js.Dynamic].applyDynamic("wrapAndSliceX")(extent.asInstanceOf[js.Any], projection.asInstanceOf[js.Any])).asInstanceOf[js.Array[Extent]]
