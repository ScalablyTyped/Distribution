...
object formatFeatureMod {
  ...
  inline def transformGeometryWithOptions(geometry: typings.ol.geomGeometryMod.default, write: Boolean, opt_options: ReadOptions): typings.ol.geomGeometryMod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("transformGeometryWithOptions")(geometry.asInstanceOf[js.Any], write.asInstanceOf[js.Any], opt_options.asInstanceOf[js.Any])).asInstanceOf[typings.ol.geomGeometryMod.default]
  inline def transformGeometryWithOptions(geometry: typings.ol.geomGeometryMod.default, write: Boolean, opt_options: WriteOptions): typings.ol.geomGeometryMod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("transformGeometryWithOptions")(geometry.asInstanceOf[js.Any], write.asInstanceOf[js.Any], opt_options.asInstanceOf[js.Any])).asInstanceOf[typings.ol.geomGeometryMod.default]
  ...
  trait FeatureFormat extends StObject {
    ...
    /* protected */ var dataProjection: typings.ol.projProjectionMod.default = js.native
    
    /* protected */ var defaultFeatureProjection: typings.ol.projProjectionMod.default = js.native
    ...
    def readGeometry(source: Element, opt_options: ReadOptions): typings.ol.geomGeometryMod.default = js.native
    ...
    def readProjection(source: Element): typings.ol.projProjectionMod.default = js.native
