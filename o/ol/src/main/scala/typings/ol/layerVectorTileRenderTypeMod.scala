...
object layerVectorTileRenderTypeMod {
  ...
  object default extends StObject {
    ...
    /* "hybrid" */ val HYBRID: typings.ol.layerVectorTileRenderTypeMod.VectorTileRenderType.HYBRID & String = js.native
    
    /* "image" */ val IMAGE: typings.ol.layerVectorTileRenderTypeMod.VectorTileRenderType.IMAGE & String = js.native
    
    /* "vector" */ val VECTOR: typings.ol.layerVectorTileRenderTypeMod.VectorTileRenderType.VECTOR & String = js.native
  }
