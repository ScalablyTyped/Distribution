...
object interactionMouseWheelZoomMod {
  ...
  object Mode extends StObject {
    ...
    sealed trait TRACKPAD
      extends StObject
         with Mode
    /* "trackpad" */ val TRACKPAD: typings.ol.interactionMouseWheelZoomMod.Mode.TRACKPAD & String = js.native
    
    @js.native
    sealed trait WHEEL
      extends StObject
         with Mode
    /* "wheel" */ val WHEEL: typings.ol.interactionMouseWheelZoomMod.Mode.WHEEL & String = js.native
  }
