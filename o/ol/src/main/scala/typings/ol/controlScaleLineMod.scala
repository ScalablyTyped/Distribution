...
object controlScaleLineMod {
  ...
  object Units extends StObject {
    ...
    sealed trait DEGREES
      extends StObject
         with Units
    /* "degrees" */ val DEGREES: typings.ol.controlScaleLineMod.Units.DEGREES & String = js.native
    
    @js.native
    sealed trait IMPERIAL
      extends StObject
         with Units
    /* "imperial" */ val IMPERIAL: typings.ol.controlScaleLineMod.Units.IMPERIAL & String = js.native
    
    @js.native
    sealed trait METRIC
      extends StObject
         with Units
    /* "metric" */ val METRIC: typings.ol.controlScaleLineMod.Units.METRIC & String = js.native
    
    @js.native
    sealed trait NAUTICAL
      extends StObject
         with Units
    /* "nautical" */ val NAUTICAL: typings.ol.controlScaleLineMod.Units.NAUTICAL & String = js.native
    
    @js.native
    sealed trait US
      extends StObject
         with Units
    /* "us" */ val US: typings.ol.controlScaleLineMod.Units.US & String = js.native
  }
