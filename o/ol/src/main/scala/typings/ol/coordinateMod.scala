...
object coordinateMod {
  ...
  inline def createStringXY(fractionDigits: Double): CoordinateFormat = ^.asInstanceOf[js.Dynamic].applyDynamic("createStringXY")(fractionDigits.asInstanceOf[js.Any]).asInstanceOf[CoordinateFormat]
  ...
  inline def degreesToStringHDMS(hemispheres: String, degrees: Double, fractionDigits: Double): String = (^.asInstanceOf[js.Dynamic].applyDynamic("degreesToStringHDMS")(hemispheres.asInstanceOf[js.Any], degrees.asInstanceOf[js.Any], fractionDigits.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def format(coordinate: Coordinate, template: String, fractionDigits: Double): String = (^.asInstanceOf[js.Dynamic].applyDynamic("format")(coordinate.asInstanceOf[js.Any], template.asInstanceOf[js.Any], fractionDigits.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def getWorldsAway(
    ...
    sourceExtentWidth: Double
  ): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWorldsAway")(coordinate.asInstanceOf[js.Any], projection.asInstanceOf[js.Any], sourceExtentWidth.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def toStringHDMS(coordinate: Coordinate, fractionDigits: Double): String = (^.asInstanceOf[js.Dynamic].applyDynamic("toStringHDMS")(coordinate.asInstanceOf[js.Any], fractionDigits.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def toStringXY(coordinate: Coordinate, fractionDigits: Double): String = (^.asInstanceOf[js.Dynamic].applyDynamic("toStringXY")(coordinate.asInstanceOf[js.Any], fractionDigits.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  type CoordinateFormat = js.Function1[/* arg0 */ js.UndefOr[js.Array[Double]], String]
}
