...
object mod {
  ...
  inline def apply(input: js.Object, props: String*): js.Object = ^.asInstanceOf[js.Dynamic].apply(List(input.asInstanceOf[js.Any]).`++`(props.asInstanceOf[Seq[js.Any]])*).asInstanceOf[js.Object]
