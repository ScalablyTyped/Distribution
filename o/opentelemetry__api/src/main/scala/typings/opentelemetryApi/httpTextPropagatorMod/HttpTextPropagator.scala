package typings.opentelemetryApi.httpTextPropagatorMod
...
@js.native
trait HttpTextPropagator extends js.Object {
...
object HttpTextPropagator {
  ...
  @scala.inline
  implicit class HttpTextPropagatorOps[Self <: HttpTextPropagator] (val x: Self) extends AnyVal {
