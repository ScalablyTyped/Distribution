...
object oNodeMod {
  ...
  inline def o(rootUrl: String, config: Any): typings.odata.ohandlerMod.OHandler = (^.asInstanceOf[js.Dynamic].applyDynamic("o")(rootUrl.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[typings.odata.ohandlerMod.OHandler]
  ...
  inline def o(rootUrl: URL, config: Any): typings.odata.ohandlerMod.OHandler = (^.asInstanceOf[js.Dynamic].applyDynamic("o")(rootUrl.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[typings.odata.ohandlerMod.OHandler]
