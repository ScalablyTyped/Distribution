...
trait OHandler[T] extends js.Object {
  ...
  def get[T](callback: js.Function1[/* data */ T, Unit], errorCallback: js.Function1[/* status */ Double, Unit]): Promise[OHandler[T]] = js.native
  ...
  def save[T](callback: js.Function1[/* data */ T, Unit], errorCallback: js.Function1[/* status */ Double, Unit]): Promise[OHandler[T]] = js.native
