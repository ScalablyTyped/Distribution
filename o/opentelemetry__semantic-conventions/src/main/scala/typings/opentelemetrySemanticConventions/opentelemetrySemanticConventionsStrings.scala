...
import typings.opentelemetrySemanticConventions.semanticAttributesMod.DbCassandraConsistencyLevelValues
import typings.opentelemetrySemanticConventions.semanticAttributesMod.DbSystemValues
import typings.opentelemetrySemanticConventions.semanticAttributesMod.FaasDocumentOperationValues
import typings.opentelemetrySemanticConventions.semanticAttributesMod.FaasInvokedProviderValues
import typings.opentelemetrySemanticConventions.semanticAttributesMod.FaasTriggerValues
import typings.opentelemetrySemanticConventions.semanticAttributesMod.HttpFlavorValues
import typings.opentelemetrySemanticConventions.semanticAttributesMod.MessageTypeValues
import typings.opentelemetrySemanticConventions.semanticAttributesMod.MessagingDestinationKindValues
import typings.opentelemetrySemanticConventions.semanticAttributesMod.MessagingOperationValues
import typings.opentelemetrySemanticConventions.semanticAttributesMod.NetHostConnectionSubtypeValues
import typings.opentelemetrySemanticConventions.semanticAttributesMod.NetHostConnectionTypeValues
import typings.opentelemetrySemanticConventions.semanticAttributesMod.NetTransportValues
import typings.opentelemetrySemanticConventions.semanticResourceAttributesMod.AwsEcsLaunchtypeValues
import typings.opentelemetrySemanticConventions.semanticResourceAttributesMod.CloudPlatformValues
import typings.opentelemetrySemanticConventions.semanticResourceAttributesMod.CloudProviderValues
import typings.opentelemetrySemanticConventions.semanticResourceAttributesMod.HostArchValues
import typings.opentelemetrySemanticConventions.semanticResourceAttributesMod.OsTypeValues
import typings.opentelemetrySemanticConventions.semanticResourceAttributesMod.TelemetrySdkLanguageValues
