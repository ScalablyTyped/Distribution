...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fluentui__react-focus" % "7.1.1-0ce87d",
  ...
  "org.scalablytyped" %%% "uifabric__foundation" % "7.5.14-077f3d",
  "org.scalablytyped" %%% "uifabric__icons" % "7.3.13-a63627",
