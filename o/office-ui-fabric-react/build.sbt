...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fluentui__react-focus" % "7.4.2-97b6ef",
  ...
  "org.scalablytyped" %%% "uifabric__foundation" % "7.7.3-c728c2",
  "org.scalablytyped" %%% "uifabric__icons" % "7.3.29-9420a2",
