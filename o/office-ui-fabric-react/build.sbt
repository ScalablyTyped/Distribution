...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fluentui__date-time-utilities" % "8.5.2-f18d81",
  "org.scalablytyped" %%% "fluentui__dom-utilities" % "2.2.2-d40a2d",
  "org.scalablytyped" %%% "fluentui__merge-styles" % "8.5.3-73eb96",
  "org.scalablytyped" %%% "fluentui__react-focus" % "8.8.8-c7361d",
  "org.scalablytyped" %%% "fluentui__react-window-provider" % "2.2.3-133000",
  ...
  "org.scalablytyped" %%% "uifabric__foundation" % "7.10.16-065877",
  "org.scalablytyped" %%% "uifabric__icons" % "7.9.5-518903",
  "org.scalablytyped" %%% "uifabric__merge-styles" % "7.20.2-3f17c4",
  "org.scalablytyped" %%% "uifabric__react-hooks" % "7.16.4-efb75a",
