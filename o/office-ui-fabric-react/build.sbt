...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fluentui__react-focus" % "7.12.0-089832",
  ...
  "org.scalablytyped" %%% "uifabric__foundation" % "7.7.17-d61b51",
  "org.scalablytyped" %%% "uifabric__icons" % "7.3.43-66bf10",
