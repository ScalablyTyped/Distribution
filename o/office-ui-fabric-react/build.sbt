...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fluentui__react-focus" % "7.1.12-dfcb34",
  ...
  "org.scalablytyped" %%% "uifabric__foundation" % "7.5.24-afbdc6",
  "org.scalablytyped" %%% "uifabric__icons" % "7.3.23-e09a24",
