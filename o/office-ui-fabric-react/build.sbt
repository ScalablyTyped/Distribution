...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fluentui__date-time-utilities" % "8.5.2-f96636",
  "org.scalablytyped" %%% "fluentui__dom-utilities" % "2.2.2-1c7dc5",
  "org.scalablytyped" %%% "fluentui__merge-styles" % "8.5.3-1bae50",
  "org.scalablytyped" %%% "fluentui__react-focus" % "8.8.8-b4c1d3",
  "org.scalablytyped" %%% "fluentui__react-window-provider" % "2.2.3-001e5e",
  ...
  "org.scalablytyped" %%% "uifabric__foundation" % "7.10.16-e02cdb",
  "org.scalablytyped" %%% "uifabric__icons" % "7.9.5-0c103b",
  "org.scalablytyped" %%% "uifabric__merge-styles" % "7.20.2-4cd325",
  "org.scalablytyped" %%% "uifabric__react-hooks" % "7.16.4-d0d284",
