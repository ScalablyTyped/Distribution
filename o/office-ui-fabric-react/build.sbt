...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fluentui__date-time-utilities" % "8.5.2-b96543",
  "org.scalablytyped" %%% "fluentui__dom-utilities" % "2.2.2-d82555",
  "org.scalablytyped" %%% "fluentui__merge-styles" % "8.5.3-0f28f1",
  "org.scalablytyped" %%% "fluentui__react-focus" % "8.8.6-84d167",
  "org.scalablytyped" %%% "fluentui__react-window-provider" % "2.2.2-14a3ae",
  ...
  "org.scalablytyped" %%% "uifabric__foundation" % "7.10.15-d91ddd",
  "org.scalablytyped" %%% "uifabric__icons" % "7.9.4-23a0eb",
  "org.scalablytyped" %%% "uifabric__merge-styles" % "7.20.1-3e326a",
  "org.scalablytyped" %%% "uifabric__react-hooks" % "7.16.3-c44354",
