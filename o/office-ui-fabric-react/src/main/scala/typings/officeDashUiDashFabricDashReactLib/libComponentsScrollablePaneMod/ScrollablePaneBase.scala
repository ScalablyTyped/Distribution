package typings
package officeDashUiDashFabricDashReactLib.libComponentsScrollablePaneMod
...
class ScrollablePaneBase protected ()
  extends officeDashUiDashFabricDashReactLib.libComponentsScrollablePaneScrollablePaneDotBaseMod.ScrollablePaneBase {
