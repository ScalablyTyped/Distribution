package typings
package officeDashUiDashFabricDashReactLib.libComponentsKeytipLayerMod
...
class KeytipLayerBase protected ()
  extends officeDashUiDashFabricDashReactLib.libComponentsKeytipLayerKeytipLayerDotBaseMod.KeytipLayerBase {
