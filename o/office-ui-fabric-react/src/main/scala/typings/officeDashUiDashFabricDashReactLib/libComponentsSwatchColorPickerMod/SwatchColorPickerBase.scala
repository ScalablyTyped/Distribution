package typings
package officeDashUiDashFabricDashReactLib.libComponentsSwatchColorPickerMod
...
class SwatchColorPickerBase protected ()
  extends officeDashUiDashFabricDashReactLib.libComponentsSwatchColorPickerSwatchColorPickerDotBaseMod.SwatchColorPickerBase {
