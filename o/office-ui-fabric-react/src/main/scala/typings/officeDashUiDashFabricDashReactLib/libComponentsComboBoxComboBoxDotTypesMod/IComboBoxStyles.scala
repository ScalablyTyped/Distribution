...
trait IComboBoxStyles extends js.Object {
  ...
  /**
    ...
    */
  var inputDisabled: atUifabricMergeDashStylesLib.libIStyleMod.IStyle
  /**
  ...
  /**
    ...
    */
  var labelDisabled: atUifabricMergeDashStylesLib.libIStyleMod.IStyle
  /**
    * Styles for the container of all the Combobox options
    * Includes the headers and dividers.
    */
  var optionsContainer: atUifabricMergeDashStylesLib.libIStyleMod.IStyle
  /**
    * Styles for the optionsContainerWrapper.
    */
  var optionsContainerWrapper: atUifabricMergeDashStylesLib.libIStyleMod.IStyle
  /**
