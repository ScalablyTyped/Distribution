package typings
package officeDashUiDashFabricDashReactLib.libComponentsSearchBoxMod
...
class SearchBoxBase protected ()
  extends officeDashUiDashFabricDashReactLib.libComponentsSearchBoxSearchBoxDotBaseMod.SearchBoxBase {
