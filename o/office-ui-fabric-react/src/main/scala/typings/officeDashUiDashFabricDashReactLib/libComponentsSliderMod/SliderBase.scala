package typings
package officeDashUiDashFabricDashReactLib.libComponentsSliderMod
...
class SliderBase protected ()
  extends officeDashUiDashFabricDashReactLib.libComponentsSliderSliderDotBaseMod.SliderBase {
