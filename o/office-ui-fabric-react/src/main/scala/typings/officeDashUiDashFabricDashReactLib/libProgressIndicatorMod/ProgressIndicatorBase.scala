package typings
package officeDashUiDashFabricDashReactLib.libProgressIndicatorMod
...
class ProgressIndicatorBase protected ()
  extends officeDashUiDashFabricDashReactLib.libComponentsProgressIndicatorMod.ProgressIndicatorBase {
