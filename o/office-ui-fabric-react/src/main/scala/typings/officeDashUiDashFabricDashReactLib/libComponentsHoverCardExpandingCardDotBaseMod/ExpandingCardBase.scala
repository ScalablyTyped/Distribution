package typings
package officeDashUiDashFabricDashReactLib.libComponentsHoverCardExpandingCardDotBaseMod
...
class ExpandingCardBase protected ()
  ...
  def componentDidMount_MExpandingCardBase(): scala.Unit = js.native
...
object ExpandingCardBase extends js.Object {
  var defaultProps: officeDashUiDashFabricDashReactLib.Anon_CompactCardHeight = js.native
}
