package typings
package officeDashUiDashFabricDashReactLib.libComponentsLayerMod
...
class LayerBase protected ()
  extends officeDashUiDashFabricDashReactLib.libComponentsLayerLayerDotBaseMod.LayerBase {
