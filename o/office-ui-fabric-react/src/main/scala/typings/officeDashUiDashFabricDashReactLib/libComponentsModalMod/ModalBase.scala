package typings
package officeDashUiDashFabricDashReactLib.libComponentsModalMod
...
class ModalBase protected ()
  extends officeDashUiDashFabricDashReactLib.libComponentsModalModalDotBaseMod.ModalBase {
