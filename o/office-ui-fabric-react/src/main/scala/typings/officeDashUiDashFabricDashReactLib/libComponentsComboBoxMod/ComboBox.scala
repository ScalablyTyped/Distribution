package typings
package officeDashUiDashFabricDashReactLib.libComponentsComboBoxMod
...
class ComboBox protected ()
  extends officeDashUiDashFabricDashReactLib.libComponentsComboBoxComboBoxMod.ComboBox {
