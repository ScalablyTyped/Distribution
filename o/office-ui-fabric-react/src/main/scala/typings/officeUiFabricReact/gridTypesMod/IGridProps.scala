...
object IGridProps {
  @scala.inline
  def apply(columnCount: Double, items: js.Array[_], onRenderItem: (js.Any, Double) => Element): IGridProps = {
  ...
  implicit class IGridPropsOps[Self <: IGridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefFunction1(value: /* ref */ IGrid | Null => Unit): Self = this.set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    def setComponentRef(value: IRefObject[IGrid]): Self = this.set("componentRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStylesFunction1(value: IGridStyleProps => DeepPartial[IGridStyles]): Self = this.set("styles", js.Any.fromFunction1(value))
    @scala.inline
    def setStyles(value: IStyleFunctionOrObject[IGridStyleProps, IGridStyles]): Self = this.set("styles", value.asInstanceOf[js.Any])
    @scala.inline
