...
object IPersonaWithMenu {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onEmptied: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onEnded: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onError: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    ...
    onPause: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onPhotoLoadingStateChange: /* newImageLoadState */ ImageLoadState => Unit = null,
    onPlay: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onPlaying: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    ...
    onProgress: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onRateChange: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    ...
    onStalled: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onSubmit: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onSuspend: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
    onWaiting: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event_] => Unit = null,
