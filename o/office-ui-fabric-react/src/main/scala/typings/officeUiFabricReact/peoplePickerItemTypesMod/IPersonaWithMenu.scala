...
object IPersonaWithMenu {
  ...
  def apply(
    ...
    lang: String = null,
    menuItems: js.Array[IContextualMenuItem] = null,
    onAbort: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onAnimationEnd: AnimationEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onAnimationIteration: AnimationEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onAnimationStart: AnimationEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onAuxClick: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onBlur: FocusEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onCanPlay: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onChange: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onClick: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onCompositionStart: CompositionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onCompositionUpdate: CompositionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onContextMenu: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onCut: ClipboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onDoubleClick: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => Unit = null,
    onDrag: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onDragEnd: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onDragEnter: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onDragExit: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onDragLeave: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onDragOver: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onDragStart: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onDrop: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onDurationChange: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onEmptied: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onEncrypted: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onEnded: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onError: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onFocus: FocusEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onInput: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onInvalid: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onKeyDown: KeyboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onKeyPress: KeyboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onKeyUp: KeyboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onLoad: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onLoadStart: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onLoadedData: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onMouseDown: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onPause: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onPhotoLoadingStateChange: /* newImageLoadState */ ImageLoadState => Unit = null,
    onPlay: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onPlaying: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onPointerCancel: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onPointerDown: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onPointerEnter: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onPointerLeave: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onPointerMove: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onPointerOut: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onPointerOver: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onPointerUp: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onProgress: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onRateChange: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    ...
    onSeeked: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onSeeking: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onSelect: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onStalled: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onSubmit: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onSuspend: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onTouchCancel: TouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onTouchEnd: TouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onTouchMove: TouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onTouchStart: TouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onTransitionEnd: TransitionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    onVolumeChange: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onWaiting: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => Unit = null,
    onWheel: WheelEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => Unit = null,
    ...
    if (!js.isUndefined(allowPhoneInitials)) __obj.updateDynamic("allowPhoneInitials")(allowPhoneInitials.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(hidePersonaDetails)) __obj.updateDynamic("hidePersonaDetails")(hidePersonaDetails.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(imageShouldFadeIn)) __obj.updateDynamic("imageShouldFadeIn")(imageShouldFadeIn.get.asInstanceOf[js.Any])
    if (!js.isUndefined(imageShouldStartVisible)) __obj.updateDynamic("imageShouldStartVisible")(imageShouldStartVisible.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showInitialsUntilImageLoads)) __obj.updateDynamic("showInitialsUntilImageLoads")(showInitialsUntilImageLoads.get.asInstanceOf[js.Any])
