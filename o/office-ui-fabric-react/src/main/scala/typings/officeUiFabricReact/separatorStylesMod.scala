...
object separatorStylesMod {
  ...
  @scala.inline
  def getStyles(props: ISeparatorStyleProps): ISeparatorStyles = ^.asInstanceOf[js.Dynamic].applyDynamic("getStyles")(props.asInstanceOf[js.Any]).asInstanceOf[ISeparatorStyles]
}
