...
object IPivotProps {
  ...
  def apply(
    ...
    ref: js.UndefOr[Null | LegacyRef[PivotBase]] = js.undefined,
    resource: String = null,
    results: js.UndefOr[Double] = js.undefined,
    role: String = null,
    security: String = null,
    selectedKey: js.UndefOr[Null | String] = js.undefined,
    slot: String = null,
    ...
    if (!js.isUndefined(headersOnly)) __obj.updateDynamic("headersOnly")(headersOnly.get.asInstanceOf[js.Any])
    ...
    if (linkSize != null) __obj.updateDynamic("linkSize")(linkSize.asInstanceOf[js.Any])
