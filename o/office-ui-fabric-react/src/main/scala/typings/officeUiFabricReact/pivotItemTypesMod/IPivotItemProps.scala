...
object IPivotItemProps {
  ...
  def apply(
    ...
    if (headerButtonProps != null) __obj.updateDynamic("headerButtonProps")(headerButtonProps.asInstanceOf[js.Any])
    ...
    if (itemKey != null) __obj.updateDynamic("itemKey")(itemKey.asInstanceOf[js.Any])
