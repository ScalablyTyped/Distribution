...
object libComponentsContextualMenuMod {
  ...
  open class ContextualMenuBase protected ()
    extends typings.officeUiFabricReact.libComponentsContextualMenuContextualMenuDotbaseMod.ContextualMenuBase {
  ...
  open class ContextualMenuItemBase protected ()
    extends typings.officeUiFabricReact.libComponentsContextualMenuContextualMenuItemDotbaseMod.ContextualMenuItemBase {
