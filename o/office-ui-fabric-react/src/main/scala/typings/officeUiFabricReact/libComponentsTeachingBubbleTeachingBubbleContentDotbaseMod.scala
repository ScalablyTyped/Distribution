...
import typings.officeUiFabricReact.libComponentsTeachingBubbleTeachingBubbleDotbaseMod.ITeachingBubbleState
...
object libComponentsTeachingBubbleTeachingBubbleContentDotbaseMod {
