...
import typings.officeUiFabricReact.libComponentsDocumentCardDocumentCardActivityDotbaseMod.DocumentCardActivityBase
...
object libComponentsDocumentCardDocumentCardActivityDottypesMod {
