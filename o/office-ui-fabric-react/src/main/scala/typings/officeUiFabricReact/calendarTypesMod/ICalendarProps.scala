...
object ICalendarProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(autoNavigateOnSelection)) __obj.updateDynamic("autoNavigateOnSelection")(autoNavigateOnSelection.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(selectDateOnClick)) __obj.updateDynamic("selectDateOnClick")(selectDateOnClick.asInstanceOf[js.Any])
