...
object libUtilitiesSelectionMod {
  ...
  open class Selection[TItem] protected ()
    extends typings.officeUiFabricReact.libUtilitiesSelectionSelectionMod.Selection[TItem] {
    /**
  ...
  open class SelectionZone protected ()
    extends typings.officeUiFabricReact.libUtilitiesSelectionSelectionZoneMod.SelectionZone {
