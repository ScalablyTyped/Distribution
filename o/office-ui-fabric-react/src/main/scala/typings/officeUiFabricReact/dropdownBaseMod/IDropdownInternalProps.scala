...
- typings.officeUiFabricReact.withResponsiveModeMod.IWithResponsiveModeState because var conflicts: responsiveMode. Inlined  */ trait IDropdownInternalProps extends IDropdownProps
...
object IDropdownInternalProps {
  ...
  def apply(
    ...
    selectedKeys: js.UndefOr[Null | (js.Array[Double | String])] = js.undefined,
    slot: String = null,
    ...
    if (!js.isUndefined(notifyOnReselect)) __obj.updateDynamic("notifyOnReselect")(notifyOnReselect.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(selectedKeys)) __obj.updateDynamic("selectedKeys")(selectedKeys.asInstanceOf[js.Any])
