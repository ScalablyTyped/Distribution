...
object libUtilitiesDecoratorsMod {
  
  @JSImport("office-ui-fabric-react/lib/utilities/decorators", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("office-ui-fabric-react/lib/utilities/decorators", "ResponsiveMode")
  @js.native
