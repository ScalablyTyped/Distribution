...
object IHoverCardProps {
  ...
  def apply(
    ...
    cardDismissDelay: js.UndefOr[Double] = js.undefined,
    cardOpenDelay: js.UndefOr[Double] = js.undefined,
    ...
    eventListenerTarget: js.UndefOr[Null | HTMLElement | String] = js.undefined,
    expandedCardOpenDelay: js.UndefOr[Double] = js.undefined,
    ...
    target: js.UndefOr[Null | HTMLElement | String] = js.undefined,
    theme: ITheme = null,
    title: String = null,
    ...
    if (!js.isUndefined(cardDismissDelay)) __obj.updateDynamic("cardDismissDelay")(cardDismissDelay.get.asInstanceOf[js.Any])
    if (!js.isUndefined(cardOpenDelay)) __obj.updateDynamic("cardOpenDelay")(cardOpenDelay.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(eventListenerTarget)) __obj.updateDynamic("eventListenerTarget")(eventListenerTarget.asInstanceOf[js.Any])
    if (!js.isUndefined(expandedCardOpenDelay)) __obj.updateDynamic("expandedCardOpenDelay")(expandedCardOpenDelay.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(instantOpenOnClick)) __obj.updateDynamic("instantOpenOnClick")(instantOpenOnClick.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(openHotKey)) __obj.updateDynamic("openHotKey")(openHotKey.get.asInstanceOf[js.Any])
