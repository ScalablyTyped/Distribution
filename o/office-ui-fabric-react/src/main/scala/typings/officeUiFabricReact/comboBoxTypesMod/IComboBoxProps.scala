...
object IComboBoxProps {
  ...
  def apply(
    ...
    dropdownMaxWidth: js.UndefOr[Double] = js.undefined,
    dropdownWidth: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(allowFreeform)) __obj.updateDynamic("allowFreeform")(allowFreeform.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(dropdownMaxWidth)) __obj.updateDynamic("dropdownMaxWidth")(dropdownMaxWidth.get.asInstanceOf[js.Any])
    if (!js.isUndefined(dropdownWidth)) __obj.updateDynamic("dropdownWidth")(dropdownWidth.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isButtonAriaHidden)) __obj.updateDynamic("isButtonAriaHidden")(isButtonAriaHidden.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(persistMenu)) __obj.updateDynamic("persistMenu")(persistMenu.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(scrollSelectedToTop)) __obj.updateDynamic("scrollSelectedToTop")(scrollSelectedToTop.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useComboBoxAsMenuWidth)) __obj.updateDynamic("useComboBoxAsMenuWidth")(useComboBoxAsMenuWidth.get.asInstanceOf[js.Any])
