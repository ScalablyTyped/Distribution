...
object ISelectableDroppableTextProps {
  ...
  def apply[TComponent, TListenerElement](
    ...
    defaultSelectedKey: js.UndefOr[Null | String | Double | (js.Array[Double | String])] = js.undefined,
    ...
    onAbort: SyntheticEvent[TListenerElement, Event] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[TListenerElement, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onEmptied: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onEncrypted: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onEnded: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onError: SyntheticEvent[TListenerElement, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onLoadStart: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onLoadedData: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[TListenerElement, Event] => Unit = null,
    ...
    onPause: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onPlay: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onPlaying: SyntheticEvent[TListenerElement, Event] => Unit = null,
    ...
    onProgress: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onRateChange: SyntheticEvent[TListenerElement, Event] => Unit = null,
    ...
    onSeeked: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onSeeking: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onSelect: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onStalled: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onSubmit: FormEvent[TListenerElement] => Unit = null,
    onSuspend: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[TListenerElement, Event] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[TListenerElement, Event] => Unit = null,
    onWaiting: SyntheticEvent[TListenerElement, Event] => Unit = null,
    ...
    selectedKey: js.UndefOr[Null | String | Double | (js.Array[Double | String])] = js.undefined,
    slot: String = null,
    ...
    if (!js.isUndefined(defaultSelectedKey)) __obj.updateDynamic("defaultSelectedKey")(defaultSelectedKey.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(openOnKeyboardFocus)) __obj.updateDynamic("openOnKeyboardFocus")(openOnKeyboardFocus.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(selectedKey)) __obj.updateDynamic("selectedKey")(selectedKey.asInstanceOf[js.Any])
