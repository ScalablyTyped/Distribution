...
@JSImport("office-ui-fabric-react/lib/index.bundle", "GroupedListV2Wrapper")
@js.native
open class GroupedListV2Wrapper protected ()
  extends typings.officeUiFabricReact.mod.GroupedListV2Wrapper {
...
object GroupedListV2Wrapper {
  ...
  @JSImport("office-ui-fabric-react/lib/index.bundle", "GroupedListV2Wrapper.displayName")
  @js.native
