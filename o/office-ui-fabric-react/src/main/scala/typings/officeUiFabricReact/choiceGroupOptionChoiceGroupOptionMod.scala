...
object choiceGroupOptionChoiceGroupOptionMod {
  
  @JSImport("office-ui-fabric-react/lib/components/ChoiceGroup/ChoiceGroupOption/ChoiceGroupOption", "ChoiceGroupOption")
  @js.native
