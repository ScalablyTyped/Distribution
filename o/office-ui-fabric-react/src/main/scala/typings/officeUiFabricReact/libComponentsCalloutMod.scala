...
object libComponentsCalloutMod {
  
  @JSImport("office-ui-fabric-react/lib/components/Callout", "Callout")
  @js.native
  open class Callout protected ()
    extends typings.officeUiFabricReact.libComponentsCalloutCalloutMod.Callout {
  ...
  open class CalloutContentBase protected ()
    extends typings.officeUiFabricReact.libComponentsCalloutCalloutContentDotbaseMod.CalloutContentBase {
    def this(props: ICalloutProps) = this()
  }
  /* static members */
