...
trait IDocumentCardProps
  ...
  /**
    ...
    */
  @JSName("onClick")
  var onClick_IDocumentCardProps: js.UndefOr[js.Function1[/* ev */ js.UndefOr[SyntheticEvent[HTMLElement, Event_]], Unit]] = js.undefined
  /**
...
object IDocumentCardProps {
  ...
  def apply(
    ...
    onClick: /* ev */ js.UndefOr[SyntheticEvent[HTMLElement, Event_]] => Unit = null,
