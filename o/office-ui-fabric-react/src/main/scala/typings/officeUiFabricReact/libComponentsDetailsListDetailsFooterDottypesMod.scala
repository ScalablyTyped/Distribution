...
import typings.officeUiFabricReact.libComponentsDetailsListDetailsRowDottypesMod.IDetailsItemProps
...
object libComponentsDetailsListDetailsFooterDottypesMod {
