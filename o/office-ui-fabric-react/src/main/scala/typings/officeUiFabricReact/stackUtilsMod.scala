...
object stackUtilsMod extends js.Object {
  def parseGap(gap: js.UndefOr[scala.Nothing], theme: ITheme): AnonColumnGap = js.native
  def parseGap(gap: String, theme: ITheme): AnonColumnGap = js.native
  def parseGap(gap: Double, theme: ITheme): AnonColumnGap = js.native
