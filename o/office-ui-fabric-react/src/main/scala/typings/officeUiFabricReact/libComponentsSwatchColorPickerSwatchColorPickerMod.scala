...
object libComponentsSwatchColorPickerSwatchColorPickerMod {
  
  @JSImport("office-ui-fabric-react/lib/components/SwatchColorPicker/SwatchColorPicker", "SwatchColorPicker")
  @js.native
