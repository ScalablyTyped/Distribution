...
object colorPickerStylesMod {
  ...
  @scala.inline
  def getStyles(props: IColorPickerStyleProps): IColorPickerStyles = ^.asInstanceOf[js.Dynamic].applyDynamic("getStyles")(props.asInstanceOf[js.Any]).asInstanceOf[IColorPickerStyles]
}
