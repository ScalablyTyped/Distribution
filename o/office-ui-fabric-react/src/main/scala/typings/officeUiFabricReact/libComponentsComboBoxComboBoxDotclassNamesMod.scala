...
import typings.officeUiFabricReact.libComponentsComboBoxComboBoxDottypesMod.IComboBoxClassNames
import typings.officeUiFabricReact.libComponentsComboBoxComboBoxDottypesMod.IComboBoxOptionClassNames
