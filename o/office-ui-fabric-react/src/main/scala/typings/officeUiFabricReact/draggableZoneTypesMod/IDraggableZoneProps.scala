...
object IDraggableZoneProps {
  ...
  def apply(
    ...
    onDragChange: (/* event */ (MouseEvent[HTMLElement, NativeMouseEvent]) with TouchEvent[HTMLElement], /* dragData */ IDragData) => Unit = null,
    ...
    onStart: (/* event */ (MouseEvent[HTMLElement, NativeMouseEvent]) with TouchEvent[HTMLElement], /* dragData */ IDragData) => Unit = null,
    onStop: (/* event */ (MouseEvent[HTMLElement, NativeMouseEvent]) with TouchEvent[HTMLElement], /* dragData */ IDragData) => Unit = null,
