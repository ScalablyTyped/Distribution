...
object libComponentsPickersMod {
  ...
  open class Autofill protected ()
    extends typings.officeUiFabricReact.libComponentsPickersAutoFillBaseAutoFillMod.Autofill {
  ...
  open class BaseAutoFill protected ()
    extends typings.officeUiFabricReact.libComponentsPickersAutoFillBaseAutoFillMod.BaseAutoFill {
    def this(props: IAutofillProps) = this()
  }
  ...
  open class BasePeoplePicker protected ()
    extends typings.officeUiFabricReact.libComponentsPickersPeoplePickerPeoplePickerMod.BasePeoplePicker {
  ...
  open class BasePicker[T, P /* <: IBasePickerProps[T] */] protected ()
    extends typings.officeUiFabricReact.libComponentsPickersBasePickerMod.BasePicker[T, P] {
  ...
  open class BasePickerListBelow[T, P /* <: IBasePickerProps[T] */] protected ()
    extends typings.officeUiFabricReact.libComponentsPickersBasePickerMod.BasePickerListBelow[T, P] {
    def this(basePickerProps: P) = this()
  }
  ...
  open class CompactPeoplePickerBase protected ()
    extends typings.officeUiFabricReact.libComponentsPickersPeoplePickerPeoplePickerMod.CompactPeoplePickerBase {
    def this(basePickerProps: IPeoplePickerProps) = this()
  }
  /* static members */
  ...
  open class ListPeoplePickerBase protected ()
    extends typings.officeUiFabricReact.libComponentsPickersPeoplePickerPeoplePickerMod.ListPeoplePickerBase {
    def this(basePickerProps: IPeoplePickerProps) = this()
  }
  /* static members */
  ...
  open class MemberListPeoplePicker protected ()
    extends typings.officeUiFabricReact.libComponentsPickersPeoplePickerPeoplePickerMod.MemberListPeoplePicker {
    def this(basePickerProps: IPeoplePickerProps) = this()
  }
  ...
  open class NormalPeoplePickerBase protected ()
    extends typings.officeUiFabricReact.libComponentsPickersPeoplePickerPeoplePickerMod.NormalPeoplePickerBase {
    def this(basePickerProps: IPeoplePickerProps) = this()
  }
  /* static members */
  ...
  open class Suggestions[T] protected ()
    extends typings.officeUiFabricReact.libComponentsPickersSuggestionsSuggestionsMod.Suggestions[T] {
  ...
  open class SuggestionsController[T] ()
    extends typings.officeUiFabricReact.libComponentsPickersSuggestionsSuggestionsControllerMod.SuggestionsController[T]
  
  @JSImport("office-ui-fabric-react/lib/components/pickers", "SuggestionsItem")
  @js.native
  open class SuggestionsItem[T] protected ()
    extends typings.officeUiFabricReact.libComponentsPickersSuggestionsSuggestionsItemMod.SuggestionsItem[T] {
  ...
  open class TagPickerBase protected ()
    extends typings.officeUiFabricReact.libComponentsPickersTagPickerTagPickerMod.TagPickerBase {
