...
object ILayerProps {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onAnimationEnd: AnimationEvent[HTMLDivElement | LayerBase] => Unit = null,
    onAnimationIteration: AnimationEvent[HTMLDivElement | LayerBase] => Unit = null,
    onAnimationStart: AnimationEvent[HTMLDivElement | LayerBase] => Unit = null,
    onAuxClick: MouseEvent[HTMLDivElement | LayerBase, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[HTMLDivElement | LayerBase] => Unit = null,
    onBlur: FocusEvent[HTMLDivElement | LayerBase] => Unit = null,
    onCanPlay: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onChange: FormEvent[HTMLDivElement | LayerBase] => Unit = null,
    onClick: MouseEvent[HTMLDivElement | LayerBase, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[HTMLDivElement | LayerBase] => Unit = null,
    onCompositionStart: CompositionEvent[HTMLDivElement | LayerBase] => Unit = null,
    onCompositionUpdate: CompositionEvent[HTMLDivElement | LayerBase] => Unit = null,
    onContextMenu: MouseEvent[HTMLDivElement | LayerBase, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[HTMLDivElement | LayerBase] => Unit = null,
    onCut: ClipboardEvent[HTMLDivElement | LayerBase] => Unit = null,
    onDoubleClick: MouseEvent[HTMLDivElement | LayerBase, NativeMouseEvent] => Unit = null,
    onDrag: DragEvent[HTMLDivElement | LayerBase] => Unit = null,
    onDragEnd: DragEvent[HTMLDivElement | LayerBase] => Unit = null,
    onDragEnter: DragEvent[HTMLDivElement | LayerBase] => Unit = null,
    onDragExit: DragEvent[HTMLDivElement | LayerBase] => Unit = null,
    onDragLeave: DragEvent[HTMLDivElement | LayerBase] => Unit = null,
    onDragOver: DragEvent[HTMLDivElement | LayerBase] => Unit = null,
    onDragStart: DragEvent[HTMLDivElement | LayerBase] => Unit = null,
    onDrop: DragEvent[HTMLDivElement | LayerBase] => Unit = null,
    onDurationChange: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onEmptied: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onEncrypted: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onEnded: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onError: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onFocus: FocusEvent[HTMLDivElement | LayerBase] => Unit = null,
    onInput: FormEvent[HTMLDivElement | LayerBase] => Unit = null,
    onInvalid: FormEvent[HTMLDivElement | LayerBase] => Unit = null,
    onKeyDown: KeyboardEvent[HTMLDivElement | LayerBase] => Unit = null,
    onKeyPress: KeyboardEvent[HTMLDivElement | LayerBase] => Unit = null,
    onKeyUp: KeyboardEvent[HTMLDivElement | LayerBase] => Unit = null,
    onLayerDidMount: () => Unit = null,
    onLayerMounted: () => Unit = null,
    onLayerWillUnmount: () => Unit = null,
    onLoad: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onLoadStart: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onLoadedData: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onMouseDown: MouseEvent[HTMLDivElement | LayerBase, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[HTMLDivElement | LayerBase, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[HTMLDivElement | LayerBase, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[HTMLDivElement | LayerBase, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[HTMLDivElement | LayerBase, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[HTMLDivElement | LayerBase, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[HTMLDivElement | LayerBase, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[HTMLDivElement | LayerBase] => Unit = null,
    onPause: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onPlay: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onPlaying: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onPointerCancel: PointerEvent[HTMLDivElement | LayerBase] => Unit = null,
    onPointerDown: PointerEvent[HTMLDivElement | LayerBase] => Unit = null,
    onPointerEnter: PointerEvent[HTMLDivElement | LayerBase] => Unit = null,
    onPointerLeave: PointerEvent[HTMLDivElement | LayerBase] => Unit = null,
    onPointerMove: PointerEvent[HTMLDivElement | LayerBase] => Unit = null,
    onPointerOut: PointerEvent[HTMLDivElement | LayerBase] => Unit = null,
    onPointerOver: PointerEvent[HTMLDivElement | LayerBase] => Unit = null,
    onPointerUp: PointerEvent[HTMLDivElement | LayerBase] => Unit = null,
    onProgress: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onRateChange: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onReset: FormEvent[HTMLDivElement | LayerBase] => Unit = null,
    onScroll: UIEvent[HTMLDivElement | LayerBase, NativeUIEvent] => Unit = null,
    onSeeked: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onSeeking: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onSelect: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onStalled: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onSubmit: FormEvent[HTMLDivElement | LayerBase] => Unit = null,
    onSuspend: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onTouchCancel: TouchEvent[HTMLDivElement | LayerBase] => Unit = null,
    onTouchEnd: TouchEvent[HTMLDivElement | LayerBase] => Unit = null,
    onTouchMove: TouchEvent[HTMLDivElement | LayerBase] => Unit = null,
    onTouchStart: TouchEvent[HTMLDivElement | LayerBase] => Unit = null,
    onTransitionEnd: TransitionEvent[HTMLDivElement | LayerBase] => Unit = null,
    onVolumeChange: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onWaiting: SyntheticEvent[HTMLDivElement | LayerBase, Event] => Unit = null,
    onWheel: WheelEvent[HTMLDivElement | LayerBase] => Unit = null,
    ...
    if (!js.isUndefined(eventBubblingEnabled)) __obj.updateDynamic("eventBubblingEnabled")(eventBubblingEnabled.get.asInstanceOf[js.Any])
