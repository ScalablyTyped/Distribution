...
object choiceGroupStylesMod {
  ...
  @scala.inline
  def getStyles(props: IChoiceGroupStyleProps): IChoiceGroupStyles = ^.asInstanceOf[js.Dynamic].applyDynamic("getStyles")(props.asInstanceOf[js.Any]).asInstanceOf[IChoiceGroupStyles]
}
