...
object suggestionItemDefaultMod {
  ...
  inline def SuggestionItemSmall(persona: IPersonaProps, suggestionProps: IBasePickerSuggestionsProps[Any]): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("SuggestionItemSmall")(persona.asInstanceOf[js.Any], suggestionProps.asInstanceOf[js.Any])).asInstanceOf[Element]
}
