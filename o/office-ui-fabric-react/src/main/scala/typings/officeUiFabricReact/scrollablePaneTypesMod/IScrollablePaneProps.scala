...
object IScrollablePaneProps {
  ...
  def apply(
    ...
    id: String = null,
    initialScrollPosition: js.UndefOr[Double] = js.undefined,
    inlist: js.Any = null,
    ...
    if (!js.isUndefined(initialScrollPosition)) __obj.updateDynamic("initialScrollPosition")(initialScrollPosition.get.asInstanceOf[js.Any])
