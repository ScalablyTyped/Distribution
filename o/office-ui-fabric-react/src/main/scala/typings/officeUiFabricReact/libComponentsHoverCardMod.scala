...
object libComponentsHoverCardMod {
  ...
  open class ExpandingCardBase protected ()
    extends typings.officeUiFabricReact.libComponentsHoverCardExpandingCardDotbaseMod.ExpandingCardBase {
  ...
  open class HoverCardBase protected ()
    extends typings.officeUiFabricReact.libComponentsHoverCardHoverCardDotbaseMod.HoverCardBase {
  ...
  open class PlainCardBase protected ()
    extends typings.officeUiFabricReact.libComponentsHoverCardPlainCardPlainCardDotbaseMod.PlainCardBase {
