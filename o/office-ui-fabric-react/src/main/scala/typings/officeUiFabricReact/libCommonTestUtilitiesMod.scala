...
object libCommonTestUtilitiesMod {
  ...
  inline def expectMissing(wrapper: ReactWrapper[Any, Any, Component[js.Object, js.Object, Any]], className: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("expectMissing")(wrapper.asInstanceOf[js.Any], className.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def expectOne(wrapper: ReactWrapper[Any, Any, Component[js.Object, js.Object, Any]], className: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("expectOne")(wrapper.asInstanceOf[js.Any], className.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def findNodes(wrapper: ReactWrapper[Any, Any, Component[js.Object, js.Object, Any]], className: String): ReactWrapper[Any, Any, Component[js.Object, js.Object, Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("findNodes")(wrapper.asInstanceOf[js.Any], className.asInstanceOf[js.Any])).asInstanceOf[ReactWrapper[Any, Any, Component[js.Object, js.Object, Any]]]
  ...
  inline def mountAttached[C /* <: Component[js.Object, js.Object, Any] */, P, S](element: ReactElement): ReactWrapper[P, S, C] = ^.asInstanceOf[js.Dynamic].applyDynamic("mountAttached")(element.asInstanceOf[js.Any]).asInstanceOf[ReactWrapper[P, S, C]]
