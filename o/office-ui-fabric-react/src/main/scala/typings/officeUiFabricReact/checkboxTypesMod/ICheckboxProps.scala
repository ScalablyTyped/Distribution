...
object ICheckboxProps {
  ...
  def apply(
    ...
    lang: String = null,
    name: String = null,
    onAbort: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onAnimationEnd: AnimationEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onAnimationIteration: AnimationEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onAnimationStart: AnimationEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onAuxClick: MouseEvent[HTMLElement | HTMLInputElement, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onBlur: FocusEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onCanPlay: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onChange: (/* ev */ js.UndefOr[FormEvent[HTMLElement | HTMLInputElement]], /* checked */ js.UndefOr[Boolean]) => Unit = null,
    onClick: MouseEvent[HTMLElement | HTMLInputElement, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onCompositionStart: CompositionEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onCompositionUpdate: CompositionEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onContextMenu: MouseEvent[HTMLElement | HTMLInputElement, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onCut: ClipboardEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onDoubleClick: MouseEvent[HTMLElement | HTMLInputElement, NativeMouseEvent] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onEmptied: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onEncrypted: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onEnded: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onError: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onFocus: FocusEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onInput: FormEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onInvalid: FormEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onKeyDown: KeyboardEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onKeyPress: KeyboardEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onKeyUp: KeyboardEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onLoad: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onLoadStart: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onLoadedData: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onMouseDown: MouseEvent[HTMLElement | HTMLInputElement, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[HTMLElement | HTMLInputElement, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[HTMLElement | HTMLInputElement, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[HTMLElement | HTMLInputElement, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[HTMLElement | HTMLInputElement, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[HTMLElement | HTMLInputElement, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[HTMLElement | HTMLInputElement, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onPause: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onPlay: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onPlaying: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onPointerCancel: PointerEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onPointerDown: PointerEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onPointerEnter: PointerEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onPointerLeave: PointerEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onPointerMove: PointerEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onPointerOut: PointerEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onPointerOver: PointerEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onPointerUp: PointerEvent[HTMLElement | HTMLInputElement] => Unit = null,
    ...
    onSeeking: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onSelect: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onStalled: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onSubmit: FormEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onSuspend: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onTouchCancel: TouchEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onTouchEnd: TouchEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onTouchMove: TouchEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onTouchStart: TouchEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onTransitionEnd: TransitionEvent[HTMLElement | HTMLInputElement] => Unit = null,
    onVolumeChange: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onWaiting: SyntheticEvent[HTMLElement | HTMLInputElement, Event] => Unit = null,
    onWheel: WheelEvent[HTMLElement | HTMLInputElement] => Unit = null,
