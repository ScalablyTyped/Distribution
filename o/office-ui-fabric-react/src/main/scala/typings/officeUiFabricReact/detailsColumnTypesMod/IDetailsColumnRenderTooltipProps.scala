...
import typings.officeUiFabricReact.tooltipHostTypesMod.TooltipOverflowMode
...
object IDetailsColumnRenderTooltipProps {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onAnimationEnd: AnimationEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onAnimationIteration: AnimationEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onAnimationStart: AnimationEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onAuxClick: MouseEvent[HTMLDivElement | TooltipHostBase, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onBlur: FocusEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onCanPlay: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onChange: FormEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onClick: MouseEvent[HTMLDivElement | TooltipHostBase, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onCompositionStart: CompositionEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onCompositionUpdate: CompositionEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onContextMenu: MouseEvent[HTMLDivElement | TooltipHostBase, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onCut: ClipboardEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onDoubleClick: MouseEvent[HTMLDivElement | TooltipHostBase, NativeMouseEvent] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onEmptied: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onEncrypted: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onEnded: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onError: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onFocus: FocusEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onInput: FormEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onInvalid: FormEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onKeyDown: KeyboardEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onKeyPress: KeyboardEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onKeyUp: KeyboardEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onLoad: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onLoadStart: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onLoadedData: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onMouseDown: MouseEvent[HTMLDivElement | TooltipHostBase, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[HTMLDivElement | TooltipHostBase, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[HTMLDivElement | TooltipHostBase, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[HTMLDivElement | TooltipHostBase, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[HTMLDivElement | TooltipHostBase, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[HTMLDivElement | TooltipHostBase, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[HTMLDivElement | TooltipHostBase, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onPause: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onPlay: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onPlaying: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onPointerCancel: PointerEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onPointerDown: PointerEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onPointerEnter: PointerEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onPointerLeave: PointerEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onPointerMove: PointerEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onPointerOut: PointerEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onPointerOver: PointerEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onPointerUp: PointerEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onProgress: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onRateChange: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    ...
    onSeeked: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onSeeking: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onSelect: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onStalled: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onSubmit: FormEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onSuspend: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onTooltipToggle: /* isTooltipVisible */ Boolean => Unit = null,
    onTouchCancel: TouchEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onTouchEnd: TouchEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onTouchMove: TouchEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onTouchStart: TouchEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onTransitionEnd: TransitionEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
    onVolumeChange: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onWaiting: SyntheticEvent[HTMLDivElement | TooltipHostBase, Event] => Unit = null,
    onWheel: WheelEvent[HTMLDivElement | TooltipHostBase] => Unit = null,
