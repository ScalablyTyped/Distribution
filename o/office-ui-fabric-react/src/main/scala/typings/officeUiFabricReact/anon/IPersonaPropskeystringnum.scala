...
object IPersonaPropskeystringnum {
  @scala.inline
  def apply(key: String | Double): IPersonaPropskeystringnum = {
    val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
    __obj.asInstanceOf[IPersonaPropskeystringnum]
  }
  @scala.inline
  implicit class IPersonaPropskeystringnumOps[Self <: IPersonaPropskeystringnum] (val x: Self) extends AnyVal {
    @scala.inline
