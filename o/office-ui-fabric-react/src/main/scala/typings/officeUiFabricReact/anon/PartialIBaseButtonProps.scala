...
object PartialIBaseButtonProps {
  ...
  inline def apply(): PartialIBaseButtonProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIBaseButtonProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialIBaseButtonProps] (val x: Self) extends AnyVal {
    ...
    inline def setComponentRefFunction1(value: /* ref */ IButton | Null => scala.Unit): Self = StObject.set(x, "componentRef", js.Any.fromFunction1(value))
    ...
    inline def setElementRefFunction1(value: /* instance */ HTMLElement | Null => scala.Unit): Self = StObject.set(x, "elementRef", js.Any.fromFunction1(value))
    ...
    inline def setOnAfterMenuDismiss(value: () => scala.Unit): Self = StObject.set(x, "onAfterMenuDismiss", js.Any.fromFunction0(value))
    ...
    inline def setOnMenuClick(
      value: (/* ev */ js.UndefOr[(MouseEvent[HTMLElement, NativeMouseEvent]) | KeyboardEvent[HTMLElement]], /* button */ js.UndefOr[IButtonProps]) => scala.Unit
    ...
    inline def setOnRenderAriaDescription(
      value: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
          js.Function1[/* props */ js.UndefOr[IButtonProps], typings.react.mod.global.JSX.Element | Null]
