...
object PartialIBaseButtonProps {
  ...
  def apply(
    ...
    onAfterMenuDismiss: () => scala.Unit = null,
    ...
    onMenuClick: (/* ev */ js.UndefOr[(MouseEvent[HTMLElement, NativeMouseEvent]) | KeyboardEvent[HTMLElement]], /* button */ js.UndefOr[IButtonProps]) => scala.Unit = null,
    ...
    if (!js.isUndefined(menuTriggerKeyCode)) __obj.updateDynamic("menuTriggerKeyCode")(menuTriggerKeyCode.get.asInstanceOf[js.Any])
