...
object ReadonlyIPanelProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onAnimationEnd: AnimationEvent[PanelBase] => scala.Unit = null,
    onAnimationIteration: AnimationEvent[PanelBase] => scala.Unit = null,
    onAnimationStart: AnimationEvent[PanelBase] => scala.Unit = null,
    onAuxClick: MouseEvent[PanelBase, NativeMouseEvent] => scala.Unit = null,
    onBeforeInput: FormEvent[PanelBase] => scala.Unit = null,
    onBlur: FocusEvent[PanelBase] => scala.Unit = null,
    onCanPlay: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onCanPlayThrough: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onChange: FormEvent[PanelBase] => scala.Unit = null,
    onClick: MouseEvent[PanelBase, NativeMouseEvent] => scala.Unit = null,
    onCompositionEnd: CompositionEvent[PanelBase] => scala.Unit = null,
    onCompositionStart: CompositionEvent[PanelBase] => scala.Unit = null,
    onCompositionUpdate: CompositionEvent[PanelBase] => scala.Unit = null,
    onContextMenu: MouseEvent[PanelBase, NativeMouseEvent] => scala.Unit = null,
    onCopy: ClipboardEvent[PanelBase] => scala.Unit = null,
    onCut: ClipboardEvent[PanelBase] => scala.Unit = null,
    onDismiss: /* ev */ js.UndefOr[SyntheticEvent[HTMLElement, Event]] => scala.Unit = null,
    onDismissed: () => scala.Unit = null,
    onDoubleClick: MouseEvent[PanelBase, NativeMouseEvent] => scala.Unit = null,
    onDrag: DragEvent[PanelBase] => scala.Unit = null,
    onDragEnd: DragEvent[PanelBase] => scala.Unit = null,
    onDragEnter: DragEvent[PanelBase] => scala.Unit = null,
    onDragExit: DragEvent[PanelBase] => scala.Unit = null,
    onDragLeave: DragEvent[PanelBase] => scala.Unit = null,
    onDragOver: DragEvent[PanelBase] => scala.Unit = null,
    onDragStart: DragEvent[PanelBase] => scala.Unit = null,
    onDrop: DragEvent[PanelBase] => scala.Unit = null,
    onDurationChange: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onEmptied: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onEncrypted: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onEnded: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onError: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onFocus: FocusEvent[PanelBase] => scala.Unit = null,
    onInput: FormEvent[PanelBase] => scala.Unit = null,
    onInvalid: FormEvent[PanelBase] => scala.Unit = null,
    onKeyDown: KeyboardEvent[PanelBase] => scala.Unit = null,
    onKeyPress: KeyboardEvent[PanelBase] => scala.Unit = null,
    onKeyUp: KeyboardEvent[PanelBase] => scala.Unit = null,
    onLightDismissClick: () => scala.Unit = null,
    onLoad: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onLoadStart: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onLoadedData: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onLoadedMetadata: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onMouseDown: MouseEvent[PanelBase, NativeMouseEvent] => scala.Unit = null,
    onMouseEnter: MouseEvent[PanelBase, NativeMouseEvent] => scala.Unit = null,
    onMouseLeave: MouseEvent[PanelBase, NativeMouseEvent] => scala.Unit = null,
    onMouseMove: MouseEvent[PanelBase, NativeMouseEvent] => scala.Unit = null,
    onMouseOut: MouseEvent[PanelBase, NativeMouseEvent] => scala.Unit = null,
    onMouseOver: MouseEvent[PanelBase, NativeMouseEvent] => scala.Unit = null,
    onMouseUp: MouseEvent[PanelBase, NativeMouseEvent] => scala.Unit = null,
    onOpen: () => scala.Unit = null,
    onOpened: () => scala.Unit = null,
    onOuterClick: () => scala.Unit = null,
    onPaste: ClipboardEvent[PanelBase] => scala.Unit = null,
    onPause: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onPlay: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onPlaying: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onPointerCancel: PointerEvent[PanelBase] => scala.Unit = null,
    onPointerDown: PointerEvent[PanelBase] => scala.Unit = null,
    onPointerEnter: PointerEvent[PanelBase] => scala.Unit = null,
    onPointerLeave: PointerEvent[PanelBase] => scala.Unit = null,
    onPointerMove: PointerEvent[PanelBase] => scala.Unit = null,
    onPointerOut: PointerEvent[PanelBase] => scala.Unit = null,
    onPointerOver: PointerEvent[PanelBase] => scala.Unit = null,
    onPointerUp: PointerEvent[PanelBase] => scala.Unit = null,
    onProgress: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onRateChange: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    ...
    onReset: FormEvent[PanelBase] => scala.Unit = null,
    onScroll: UIEvent[PanelBase, NativeUIEvent] => scala.Unit = null,
    onSeeked: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onSeeking: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onSelect: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onStalled: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onSubmit: FormEvent[PanelBase] => scala.Unit = null,
    onSuspend: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onTimeUpdate: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onTouchCancel: TouchEvent[PanelBase] => scala.Unit = null,
    onTouchEnd: TouchEvent[PanelBase] => scala.Unit = null,
    onTouchMove: TouchEvent[PanelBase] => scala.Unit = null,
    onTouchStart: TouchEvent[PanelBase] => scala.Unit = null,
    onTransitionEnd: TransitionEvent[PanelBase] => scala.Unit = null,
    onVolumeChange: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onWaiting: SyntheticEvent[PanelBase, Event] => scala.Unit = null,
    onWheel: WheelEvent[PanelBase] => scala.Unit = null,
