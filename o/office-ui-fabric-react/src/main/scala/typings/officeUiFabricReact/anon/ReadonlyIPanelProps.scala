...
trait ReadonlyIPanelProps extends StObject {
  ...
  val onOuterClick: js.UndefOr[js.Function0[scala.Unit]] = js.undefined
...
object ReadonlyIPanelProps {
  ...
  extension [Self <: ReadonlyIPanelProps](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[PanelBase] => scala.Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[PanelBase] => scala.Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
    ...
    inline def setOnOuterClick(value: () => scala.Unit): Self = StObject.set(x, "onOuterClick", js.Any.fromFunction0(value))
