...
trait ReadonlyIToggleProps extends StObject {
  ...
  val onResize: js.UndefOr[ReactEventHandler[HTMLElement]] = js.undefined
...
object ReadonlyIToggleProps {
  ...
  implicit open class MutableBuilder[Self <: ReadonlyIToggleProps] (val x: Self) extends AnyVal {
    ...
    inline def setComponentRefFunction1(value: /* ref */ IToggle | Null => scala.Unit): Self = StObject.set(x, "componentRef", js.Any.fromFunction1(value))
    ...
    inline def setOnChange(
      value: (/* event */ MouseEvent[HTMLElement, NativeMouseEvent], /* checked */ js.UndefOr[Boolean]) => scala.Unit
    ): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
    
    inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    inline def setOnChanged(value: /* checked */ Boolean => scala.Unit): Self = StObject.set(x, "onChanged", js.Any.fromFunction1(value))
