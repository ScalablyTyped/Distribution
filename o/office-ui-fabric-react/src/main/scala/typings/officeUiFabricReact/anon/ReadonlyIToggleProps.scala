...
trait ReadonlyIToggleProps extends js.Object {
  ...
  val label: js.UndefOr[String | Element] = js.native
...
object ReadonlyIToggleProps {
  ...
  implicit class ReadonlyITogglePropsOps[Self <: ReadonlyIToggleProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentRefFunction1(value: /* ref */ IToggle | Null => scala.Unit): Self = this.set("componentRef", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnChanged(value: /* checked */ Boolean => scala.Unit): Self = this.set("onChanged", js.Any.fromFunction1(value))
    @scala.inline
