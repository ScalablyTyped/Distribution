...
object PickIIconPropsExcludekeyo {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onAnimationEnd: AnimationEvent[HTMLElement] => scala.Unit = null,
    onAnimationIteration: AnimationEvent[HTMLElement] => scala.Unit = null,
    onAnimationStart: AnimationEvent[HTMLElement] => scala.Unit = null,
    onAuxClick: MouseEvent[HTMLElement, NativeMouseEvent] => scala.Unit = null,
    onBeforeInput: FormEvent[HTMLElement] => scala.Unit = null,
    onBlur: FocusEvent[HTMLElement] => scala.Unit = null,
    onCanPlay: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onChange: FormEvent[HTMLElement] => scala.Unit = null,
    onClick: MouseEvent[HTMLElement, NativeMouseEvent] => scala.Unit = null,
    onCompositionEnd: CompositionEvent[HTMLElement] => scala.Unit = null,
    onCompositionStart: CompositionEvent[HTMLElement] => scala.Unit = null,
    onCompositionUpdate: CompositionEvent[HTMLElement] => scala.Unit = null,
    onContextMenu: MouseEvent[HTMLElement, NativeMouseEvent] => scala.Unit = null,
    onCopy: ClipboardEvent[HTMLElement] => scala.Unit = null,
    onCut: ClipboardEvent[HTMLElement] => scala.Unit = null,
    onDoubleClick: MouseEvent[HTMLElement, NativeMouseEvent] => scala.Unit = null,
    onDrag: DragEvent[HTMLElement] => scala.Unit = null,
    onDragEnd: DragEvent[HTMLElement] => scala.Unit = null,
    onDragEnter: DragEvent[HTMLElement] => scala.Unit = null,
    onDragExit: DragEvent[HTMLElement] => scala.Unit = null,
    onDragLeave: DragEvent[HTMLElement] => scala.Unit = null,
    onDragOver: DragEvent[HTMLElement] => scala.Unit = null,
    onDragStart: DragEvent[HTMLElement] => scala.Unit = null,
    onDrop: DragEvent[HTMLElement] => scala.Unit = null,
    onDurationChange: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onEmptied: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onEncrypted: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onEnded: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onError: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onFocus: FocusEvent[HTMLElement] => scala.Unit = null,
    onInput: FormEvent[HTMLElement] => scala.Unit = null,
    onInvalid: FormEvent[HTMLElement] => scala.Unit = null,
    onKeyDown: KeyboardEvent[HTMLElement] => scala.Unit = null,
    onKeyPress: KeyboardEvent[HTMLElement] => scala.Unit = null,
    onKeyUp: KeyboardEvent[HTMLElement] => scala.Unit = null,
    onLoad: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onLoadStart: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onLoadedData: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onMouseDown: MouseEvent[HTMLElement, NativeMouseEvent] => scala.Unit = null,
    onMouseEnter: MouseEvent[HTMLElement, NativeMouseEvent] => scala.Unit = null,
    onMouseLeave: MouseEvent[HTMLElement, NativeMouseEvent] => scala.Unit = null,
    onMouseMove: MouseEvent[HTMLElement, NativeMouseEvent] => scala.Unit = null,
    onMouseOut: MouseEvent[HTMLElement, NativeMouseEvent] => scala.Unit = null,
    onMouseOver: MouseEvent[HTMLElement, NativeMouseEvent] => scala.Unit = null,
    onMouseUp: MouseEvent[HTMLElement, NativeMouseEvent] => scala.Unit = null,
    onPaste: ClipboardEvent[HTMLElement] => scala.Unit = null,
    onPause: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onPlay: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onPlaying: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onPointerCancel: PointerEvent[HTMLElement] => scala.Unit = null,
    onPointerDown: PointerEvent[HTMLElement] => scala.Unit = null,
    onPointerEnter: PointerEvent[HTMLElement] => scala.Unit = null,
    onPointerLeave: PointerEvent[HTMLElement] => scala.Unit = null,
    onPointerMove: PointerEvent[HTMLElement] => scala.Unit = null,
    onPointerOut: PointerEvent[HTMLElement] => scala.Unit = null,
    onPointerOver: PointerEvent[HTMLElement] => scala.Unit = null,
    onPointerUp: PointerEvent[HTMLElement] => scala.Unit = null,
    onProgress: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onRateChange: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onReset: FormEvent[HTMLElement] => scala.Unit = null,
    onScroll: UIEvent[HTMLElement, NativeUIEvent] => scala.Unit = null,
    onSeeked: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onSeeking: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onSelect: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onStalled: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onSubmit: FormEvent[HTMLElement] => scala.Unit = null,
    onSuspend: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onTouchCancel: TouchEvent[HTMLElement] => scala.Unit = null,
    onTouchEnd: TouchEvent[HTMLElement] => scala.Unit = null,
    onTouchMove: TouchEvent[HTMLElement] => scala.Unit = null,
    onTouchStart: TouchEvent[HTMLElement] => scala.Unit = null,
    onTransitionEnd: TransitionEvent[HTMLElement] => scala.Unit = null,
    onVolumeChange: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onWaiting: SyntheticEvent[HTMLElement, Event] => scala.Unit = null,
    onWheel: WheelEvent[HTMLElement] => scala.Unit = null,
