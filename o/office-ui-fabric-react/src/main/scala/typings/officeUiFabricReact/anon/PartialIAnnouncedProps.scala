...
object PartialIAnnouncedProps {
  ...
  def apply(
    ...
    lang: String = null,
    message: String = null,
    onAbort: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onAnimationEnd: AnimationEvent[HTMLDivElement] => scala.Unit = null,
    onAnimationIteration: AnimationEvent[HTMLDivElement] => scala.Unit = null,
    onAnimationStart: AnimationEvent[HTMLDivElement] => scala.Unit = null,
    onAuxClick: MouseEvent[HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onBeforeInput: FormEvent[HTMLDivElement] => scala.Unit = null,
    onBlur: FocusEvent[HTMLDivElement] => scala.Unit = null,
    onCanPlay: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onChange: FormEvent[HTMLDivElement] => scala.Unit = null,
    onClick: MouseEvent[HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onCompositionEnd: CompositionEvent[HTMLDivElement] => scala.Unit = null,
    onCompositionStart: CompositionEvent[HTMLDivElement] => scala.Unit = null,
    onCompositionUpdate: CompositionEvent[HTMLDivElement] => scala.Unit = null,
    onContextMenu: MouseEvent[HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onCopy: ClipboardEvent[HTMLDivElement] => scala.Unit = null,
    onCut: ClipboardEvent[HTMLDivElement] => scala.Unit = null,
    onDoubleClick: MouseEvent[HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    ...
    onDurationChange: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onEmptied: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onEncrypted: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onEnded: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onError: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onFocus: FocusEvent[HTMLDivElement] => scala.Unit = null,
    onInput: FormEvent[HTMLDivElement] => scala.Unit = null,
    onInvalid: FormEvent[HTMLDivElement] => scala.Unit = null,
    onKeyDown: KeyboardEvent[HTMLDivElement] => scala.Unit = null,
    onKeyPress: KeyboardEvent[HTMLDivElement] => scala.Unit = null,
    onKeyUp: KeyboardEvent[HTMLDivElement] => scala.Unit = null,
    onLoad: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onLoadStart: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onLoadedData: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onMouseDown: MouseEvent[HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseEnter: MouseEvent[HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseLeave: MouseEvent[HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseMove: MouseEvent[HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseOut: MouseEvent[HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseOver: MouseEvent[HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseUp: MouseEvent[HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onPaste: ClipboardEvent[HTMLDivElement] => scala.Unit = null,
    onPause: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onPlay: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onPlaying: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onPointerCancel: PointerEvent[HTMLDivElement] => scala.Unit = null,
    onPointerDown: PointerEvent[HTMLDivElement] => scala.Unit = null,
    onPointerEnter: PointerEvent[HTMLDivElement] => scala.Unit = null,
    onPointerLeave: PointerEvent[HTMLDivElement] => scala.Unit = null,
    onPointerMove: PointerEvent[HTMLDivElement] => scala.Unit = null,
    onPointerOut: PointerEvent[HTMLDivElement] => scala.Unit = null,
    onPointerOver: PointerEvent[HTMLDivElement] => scala.Unit = null,
    onPointerUp: PointerEvent[HTMLDivElement] => scala.Unit = null,
    onProgress: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onRateChange: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onReset: FormEvent[HTMLDivElement] => scala.Unit = null,
    onScroll: UIEvent[HTMLDivElement, NativeUIEvent] => scala.Unit = null,
    onSeeked: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onSeeking: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onSelect: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onStalled: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onSubmit: FormEvent[HTMLDivElement] => scala.Unit = null,
    onSuspend: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onTouchCancel: TouchEvent[HTMLDivElement] => scala.Unit = null,
    onTouchEnd: TouchEvent[HTMLDivElement] => scala.Unit = null,
    onTouchMove: TouchEvent[HTMLDivElement] => scala.Unit = null,
    onTouchStart: TouchEvent[HTMLDivElement] => scala.Unit = null,
    onTransitionEnd: TransitionEvent[HTMLDivElement] => scala.Unit = null,
    onVolumeChange: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onWaiting: SyntheticEvent[HTMLDivElement, Event] => scala.Unit = null,
    onWheel: WheelEvent[HTMLDivElement] => scala.Unit = null,
