...
object ReadonlyICheckboxProps {
  ...
  implicit class ReadonlyICheckboxPropsOps[Self <: ReadonlyICheckboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnBlur(value: FocusEvent[HTMLElement | HTMLInputElement] => scala.Unit): Self = this.set("onBlur", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnFocus(value: FocusEvent[HTMLElement | HTMLInputElement] => scala.Unit): Self = this.set("onFocus", js.Any.fromFunction1(value))
    @scala.inline
