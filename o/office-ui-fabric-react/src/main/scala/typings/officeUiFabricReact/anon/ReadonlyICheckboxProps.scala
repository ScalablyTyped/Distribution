...
object ReadonlyICheckboxProps {
  ...
  implicit class ReadonlyICheckboxPropsMutableBuilder[Self <: ReadonlyICheckboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnBlur(value: FocusEvent[HTMLElement | HTMLInputElement] => scala.Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnChange(
      value: (/* ev */ js.UndefOr[FormEvent[HTMLElement | HTMLInputElement]], /* checked */ js.UndefOr[Boolean]) => scala.Unit
    ...
    @scala.inline
    def setOnFocus(value: FocusEvent[HTMLElement | HTMLInputElement] => scala.Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
