...
object IPersonaPropsValidationSt {
  ...
  def apply(
    ...
    lang: String = null,
    onAbort: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onAnimationEnd: AnimationEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onAnimationIteration: AnimationEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onAnimationStart: AnimationEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onAuxClick: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onBeforeInput: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onBlur: FocusEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onCanPlay: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onCanPlayThrough: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onChange: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onClick: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onCompositionEnd: CompositionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onCompositionStart: CompositionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onCompositionUpdate: CompositionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onContextMenu: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onCopy: ClipboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onCut: ClipboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onDoubleClick: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onDrag: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onDragEnd: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onDragEnter: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onDragExit: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onDragLeave: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onDragOver: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onDragStart: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onDrop: DragEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onDurationChange: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onEmptied: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onEncrypted: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onEnded: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onError: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onFocus: FocusEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onInput: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onInvalid: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onKeyDown: KeyboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onKeyPress: KeyboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onKeyUp: KeyboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onLoad: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onLoadStart: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onLoadedData: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onLoadedMetadata: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onMouseDown: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseEnter: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseLeave: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseMove: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseOut: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseOver: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onMouseUp: MouseEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeMouseEvent] => scala.Unit = null,
    onPaste: ClipboardEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPause: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onPhotoLoadingStateChange: /* newImageLoadState */ ImageLoadState => scala.Unit = null,
    onPlay: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onPlaying: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onPointerCancel: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerDown: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerEnter: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerLeave: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerMove: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerOut: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerOver: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onPointerUp: PointerEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onProgress: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onRateChange: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    ...
    onReset: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onScroll: UIEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, NativeUIEvent] => scala.Unit = null,
    onSeeked: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onSeeking: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onSelect: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onStalled: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onSubmit: FormEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onSuspend: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onTimeUpdate: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onTouchCancel: TouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onTouchEnd: TouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onTouchMove: TouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onTouchStart: TouchEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onTransitionEnd: TransitionEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
    onVolumeChange: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onWaiting: SyntheticEvent[PersonaBase | PersonaCoinBase | HTMLDivElement, Event] => scala.Unit = null,
    onWheel: WheelEvent[PersonaBase | PersonaCoinBase | HTMLDivElement] => scala.Unit = null,
