...
trait IPanelProps extends HTMLAttributes[PanelBase] {
  ...
  /**
    ...
    */
  var onDismiss: js.UndefOr[js.Function1[/* ev */ js.UndefOr[SyntheticEvent[HTMLElement, Event_]], Unit]] = js.undefined
  /**
...
object IPanelProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[PanelBase, Event_] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[PanelBase, Event_] => Unit = null,
    ...
    onDismiss: /* ev */ js.UndefOr[SyntheticEvent[HTMLElement, Event_]] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onEmptied: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onEnded: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onError: SyntheticEvent[PanelBase, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[PanelBase, Event_] => Unit = null,
    ...
    onPause: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onPlay: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onPlaying: SyntheticEvent[PanelBase, Event_] => Unit = null,
    ...
    onProgress: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onRateChange: SyntheticEvent[PanelBase, Event_] => Unit = null,
    ...
    onStalled: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onSubmit: FormEvent[PanelBase] => Unit = null,
    onSuspend: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[PanelBase, Event_] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[PanelBase, Event_] => Unit = null,
    onWaiting: SyntheticEvent[PanelBase, Event_] => Unit = null,
