...
import typings.officeUiFabricReact.libComponentsDocumentCardDocumentCardLogoDotbaseMod.DocumentCardLogoBase
...
object libComponentsDocumentCardDocumentCardLogoDottypesMod {
  ...
  object IDocumentCardLogoProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: IDocumentCardLogoProps] (val x: Self) extends AnyVal {
  ...
  object IDocumentCardLogoStyleProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: IDocumentCardLogoStyleProps] (val x: Self) extends AnyVal {
  ...
  object IDocumentCardLogoStyles {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: IDocumentCardLogoStyles] (val x: Self) extends AnyVal {
