...
object groupedListMod {
  ...
  @js.native
  val GroupedList: FunctionComponent[typings.officeUiFabricReact.groupedListTypesMod.IGroupedListProps] = js.native
  ...
  trait IGroupedListProps
    extends StObject
       with typings.officeUiFabricReact.groupedListTypesMod.IGroupedListProps
}
