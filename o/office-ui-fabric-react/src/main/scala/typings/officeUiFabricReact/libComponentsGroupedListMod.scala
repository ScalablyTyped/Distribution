...
object libComponentsGroupedListMod {
  ...
  @JSImport("office-ui-fabric-react/lib/components/GroupedList", "GroupedListV2FC")
  @js.native
  ...
  /**
    ...
    * conditions.
    */
  @JSImport("office-ui-fabric-react/lib/components/GroupedList", "GroupedListV2_unstable")
  @js.native
  val GroupedListV2Unstable: FunctionComponent[IGroupedListV2Props] = js.native
  
  @JSImport("office-ui-fabric-react/lib/components/GroupedList", "GroupedListV2Wrapper")
  @js.native
  open class GroupedListV2Wrapper protected ()
    extends typings.officeUiFabricReact.libComponentsGroupedListGroupedListV2DotbaseMod.GroupedListV2Wrapper {
  ...
  object GroupedListV2Wrapper {
    ...
    @JSImport("office-ui-fabric-react/lib/components/GroupedList", "GroupedListV2Wrapper.displayName")
    @js.native
