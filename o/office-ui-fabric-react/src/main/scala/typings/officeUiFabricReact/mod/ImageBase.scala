...
class ImageBase protected ()
  extends typings.officeUiFabricReact.libImageMod.ImageBase {
...
object ImageBase {
  ...
  @JSImport("office-ui-fabric-react", "ImageBase._svgRegex")
  @js.native
  ...
  @JSImport("office-ui-fabric-react", "ImageBase.defaultProps")
  @js.native
