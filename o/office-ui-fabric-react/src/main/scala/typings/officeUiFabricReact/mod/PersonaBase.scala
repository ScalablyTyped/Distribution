...
object PersonaBase {
  ...
  inline def defaultProps_=(x: typings.officeUiFabricReact.personaTypesMod.IPersonaProps): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
}
