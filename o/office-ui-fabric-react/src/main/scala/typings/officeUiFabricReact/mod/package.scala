...
@scala.inline
def createMemoizer[F /* <: js.Function1[/* input */ js.Any, js.Any] */](getValue: F): F = typings.officeUiFabricReact.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createMemoizer")(getValue.asInstanceOf[js.Any]).asInstanceOf[F]
...
@scala.inline
def createTheme(theme: scala.Unit, depComments: scala.Boolean): typings.fluentuiTheme.themeMod.Theme = (typings.officeUiFabricReact.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createTheme")(theme.asInstanceOf[js.Any], depComments.asInstanceOf[js.Any])).asInstanceOf[typings.fluentuiTheme.themeMod.Theme]
@scala.inline
...
@scala.inline
def getInitials(displayName: scala.Unit, isRtl: scala.Boolean): java.lang.String = (typings.officeUiFabricReact.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getInitials")(displayName.asInstanceOf[js.Any], isRtl.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
@scala.inline
...
@scala.inline
def getNativeElementProps[TAttributes /* <: typings.react.mod.HTMLAttributes[js.Any] */](tagName: java.lang.String, props: js.Object): TAttributes = (typings.officeUiFabricReact.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getNativeElementProps")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[TAttributes]
@scala.inline
...
@scala.inline
def initializeIcons(baseUrl: scala.Unit, options: typings.uifabricStyling.iconsMod.IIconOptions): scala.Unit = (typings.officeUiFabricReact.mod.^.asInstanceOf[js.Dynamic].applyDynamic("initializeIcons")(baseUrl.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
@scala.inline
def omit[TObj /* <: typings.std.Record[java.lang.String, js.Any] */](obj: TObj, exclusions: js.Array[/* keyof TObj */ java.lang.String]): TObj = (typings.officeUiFabricReact.mod.^.asInstanceOf[js.Dynamic].applyDynamic("omit")(obj.asInstanceOf[js.Any], exclusions.asInstanceOf[js.Any])).asInstanceOf[TObj]
