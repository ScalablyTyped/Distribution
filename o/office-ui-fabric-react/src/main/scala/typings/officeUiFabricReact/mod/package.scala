...
import typings.officeUiFabricReact.libComponentsDetailsListShimmeredDetailsListDottypesMod.IShimmeredDetailsListProps
...
import typings.officeUiFabricReact.libComponentsSeparatorSeparatorDottypesMod.ISeparatorProps
...
import typings.officeUiFabricReact.libComponentsStackStackItemStackItemDottypesMod.IStackItemProps
...
IFabricProps & RefAttributes[typings.officeUiFabricReact.libComponentsFabricFabricDotbaseMod.FabricBase]] = ^.asInstanceOf[js.Dynamic].selectDynamic("Fabric").asInstanceOf[ForwardRefExoticComponent[
...
inline def createGenericItem(
  name: String,
  currentValidationState: typings.officeUiFabricReact.libComponentsPickersBasePickerDottypesMod.ValidationState
...
inline def getBackgroundShade(color: IColor, shade: typings.officeUiFabricReact.libUtilitiesColorShadesMod.Shade): IColor | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getBackgroundShade")(color.asInstanceOf[js.Any], shade.asInstanceOf[js.Any])).asInstanceOf[IColor | Null]
inline def getBackgroundShade(
  color: IColor,
  shade: typings.officeUiFabricReact.libUtilitiesColorShadesMod.Shade,
  isInverted: Boolean
...
inline def getBoundsFromTargetWindow(target: typings.officeUiFabricReact.libUtilitiesMod.Rectangle, targetWindow: IWindowWithSegments): IRectangle = (^.asInstanceOf[js.Dynamic].applyDynamic("getBoundsFromTargetWindow")(target.asInstanceOf[js.Any], targetWindow.asInstanceOf[js.Any])).asInstanceOf[IRectangle]
...
inline def getDateRangeArray(
  date: js.Date,
  dateRangeType: typings.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DateRangeType,
  firstDayOfWeek: typings.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DayOfWeek
...
inline def getDateRangeArray(
  ...
  dateRangeType: typings.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DateRangeType,
  firstDayOfWeek: typings.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DayOfWeek,
  workWeekDays: js.Array[typings.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DayOfWeek]
...
inline def getFadedOverflowStyle(
  theme: ITheme,
  color: js.UndefOr[
  /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 124, starting with typings.officeUiFabricReact.officeUiFabricReactStrings.bodyBackground, typings.officeUiFabricReact.officeUiFabricReactStrings.bodyBackgroundHovered, typings.officeUiFabricReact.officeUiFabricReactStrings.bodyBackgroundChecked */ Any
],
...
inline def getInitialResponsiveMode(): typings.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode = ^.asInstanceOf[js.Dynamic].applyDynamic("getInitialResponsiveMode")().asInstanceOf[typings.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode]
...
inline def getMaxHeight(
  target: typings.officeUiFabricReact.libUtilitiesMod.Rectangle,
  targetEdge: typings.officeUiFabricReact.libCommonDirectionalHintMod.DirectionalHint
...
inline def getMaxHeight(target: Point, targetEdge: typings.officeUiFabricReact.libCommonDirectionalHintMod.DirectionalHint): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getMaxHeight")(target.asInstanceOf[js.Any], targetEdge.asInstanceOf[js.Any])).asInstanceOf[Double]
inline def getMaxHeight(
  target: Point,
  targetEdge: typings.officeUiFabricReact.libCommonDirectionalHintMod.DirectionalHint,
  gapSpace: Double
...
inline def getOppositeEdge(edge: typings.officeUiFabricReact.libUtilitiesPositioningPositioningDottypesMod.RectangleEdge): typings.officeUiFabricReact.libUtilitiesPositioningPositioningDottypesMod.RectangleEdge = ^.asInstanceOf[js.Dynamic].applyDynamic("getOppositeEdge")(edge.asInstanceOf[js.Any]).asInstanceOf[typings.officeUiFabricReact.libUtilitiesPositioningPositioningDottypesMod.RectangleEdge]
...
inline def getResponsiveMode(): typings.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode = ^.asInstanceOf[js.Dynamic].applyDynamic("getResponsiveMode")().asInstanceOf[typings.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode]
inline def getResponsiveMode(currentWindow: Window): typings.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode = ^.asInstanceOf[js.Dynamic].applyDynamic("getResponsiveMode")(currentWindow.asInstanceOf[js.Any]).asInstanceOf[typings.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode]
...
inline def getShade(color: IColor, shade: typings.officeUiFabricReact.libUtilitiesColorShadesMod.Shade): IColor | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getShade")(color.asInstanceOf[js.Any], shade.asInstanceOf[js.Any])).asInstanceOf[IColor | Null]
inline def getShade(
  color: IColor,
  shade: typings.officeUiFabricReact.libUtilitiesColorShadesMod.Shade,
  isInverted: Boolean
...
inline def getWeekNumber(
  date: js.Date,
  firstDayOfWeek: typings.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DayOfWeek,
  firstWeekOfYear: typings.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.FirstWeekOfYear
...
inline def isValidShade(shade: typings.officeUiFabricReact.libUtilitiesColorShadesMod.Shade): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isValidShade")(shade.asInstanceOf[js.Any]).asInstanceOf[Boolean]
...
inline def presenceBoolean(presence: typings.officeUiFabricReact.libComponentsPersonaPersonaDottypesMod.PersonaPresence): IsAvailable = ^.asInstanceOf[js.Dynamic].applyDynamic("presenceBoolean")(presence.asInstanceOf[js.Any]).asInstanceOf[IsAvailable]
...
inline def setResponsiveMode(
  responsiveMode: typings.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode
