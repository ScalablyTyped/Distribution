...
object libComponentsTooltipMod {
  ...
  open class TooltipBase protected ()
    extends typings.officeUiFabricReact.libComponentsTooltipTooltipDotbaseMod.TooltipBase {
  ...
  open class TooltipHostBase protected ()
    extends typings.officeUiFabricReact.libComponentsTooltipTooltipHostDotbaseMod.TooltipHostBase {
