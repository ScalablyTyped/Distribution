...
import typings.officeUiFabricReact.libComponentsPersonaPersonaDottypesMod.IPersonaCoinStyleProps
...
object libComponentsPickersPeoplePickerPeoplePickerItemsPeoplePickerItemDottypesMod {
  ...
  - typings.officeUiFabricReact.libComponentsPickersPeoplePickerPeoplePickerItemsPeoplePickerItemDottypesMod.IPeoplePickerItemSharedProps because var conflicts: className. Inlined theme */ trait IPeoplePickerItemSelectedProps
    extends StObject
