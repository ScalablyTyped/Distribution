...
object sliderStylesMod {
  ...
  @scala.inline
  def getStyles(props: ISliderStyleProps): ISliderStyles = ^.asInstanceOf[js.Dynamic].applyDynamic("getStyles")(props.asInstanceOf[js.Any]).asInstanceOf[ISliderStyles]
}
