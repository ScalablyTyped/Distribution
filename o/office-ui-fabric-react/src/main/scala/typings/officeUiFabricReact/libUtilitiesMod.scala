...
object libUtilitiesMod {
  ...
  open class AutoScroll protected ()
    extends typings.uifabricUtilities.mod.AutoScroll {
  ...
  open class BaseComponent[TProps /* <: IBaseProps[Any] */, TState] protected ()
    extends typings.uifabricUtilities.mod.BaseComponent[TProps, TState] {
    /**
  ...
  open class Customizations ()
    extends typings.uifabricUtilities.mod.Customizations
  /* static members */
  ...
  open class Customizer protected ()
    extends typings.uifabricUtilities.mod.Customizer {
  ...
  open class DelayedRender protected ()
    extends typings.uifabricUtilities.mod.DelayedRender {
  ...
  open class EventGroup protected ()
    extends typings.uifabricUtilities.mod.EventGroup {
  ...
  open class FabricPerformance ()
    extends typings.uifabricUtilities.mod.FabricPerformance
  /* static members */
  ...
  open class GlobalSettings ()
    extends typings.uifabricUtilities.mod.GlobalSettings
  /* static members */
  ...
  @JSImport("office-ui-fabric-react/lib/Utilities", "SELECTION_ITEMS_CHANGE")
  @js.native
