...
object libComponentsDialogMod {
  ...
  open class DialogBase protected ()
    extends typings.officeUiFabricReact.libComponentsDialogDialogDotbaseMod.DialogBase {
  ...
  open class DialogContentBase protected ()
    extends typings.officeUiFabricReact.libComponentsDialogDialogContentDotbaseMod.DialogContentBase {
  ...
  open class DialogFooterBase protected ()
    extends typings.officeUiFabricReact.libComponentsDialogDialogFooterDotbaseMod.DialogFooterBase {
