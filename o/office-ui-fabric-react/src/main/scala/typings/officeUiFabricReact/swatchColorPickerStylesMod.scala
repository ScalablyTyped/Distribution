...
object swatchColorPickerStylesMod {
  ...
  @scala.inline
  def getStyles(props: ISwatchColorPickerStyleProps): ISwatchColorPickerStyles = ^.asInstanceOf[js.Dynamic].applyDynamic("getStyles")(props.asInstanceOf[js.Any]).asInstanceOf[ISwatchColorPickerStyles]
}
