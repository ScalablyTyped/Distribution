...
object libComponentsAutofillMod {
  
  @JSImport("office-ui-fabric-react/lib/components/Autofill", "Autofill")
  @js.native
  open class Autofill protected ()
    extends typings.officeUiFabricReact.libComponentsAutofillAutofillMod.Autofill {
  ...
  open class BaseAutoFill protected ()
    extends typings.officeUiFabricReact.libComponentsAutofillAutofillMod.BaseAutoFill {
    def this(props: IAutofillProps) = this()
  }
}
