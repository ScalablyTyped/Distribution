...
import typings.officeUiFabricReact.buttonActionExampleMod.IButtonExampleProps
import typings.officeUiFabricReact.buttonTypesMod.IButtonProps
import typings.officeUiFabricReact.calendarButtonExampleMod.ICalendarButtonExampleProps
import typings.officeUiFabricReact.calendarDayMod.ICalendarDayProps
import typings.officeUiFabricReact.calendarInlineExampleMod.ICalendarInlineExampleProps
import typings.officeUiFabricReact.calendarMonthMod.ICalendarMonthProps
import typings.officeUiFabricReact.calendarTypesMod.ICalendarProps
import typings.officeUiFabricReact.calendarYearMod.ICalendarYearProps
import typings.officeUiFabricReact.calloutTypesMod.ICalloutProps
import typings.officeUiFabricReact.cardCalloutMod.ICardCalloutProps
...
import typings.officeUiFabricReact.listBasicExampleMod.IListBasicExampleProps
import typings.officeUiFabricReact.listGhostingExampleMod.IListGhostingExampleProps
import typings.officeUiFabricReact.listGridExampleMod.IListGridExampleProps
import typings.officeUiFabricReact.listScrollingExampleMod.IListScrollingExampleProps
...
import typings.officeUiFabricReact.selectedItemWithContextMenuMod.ISelectedItemWithContextMenuProps
...
trait officeUiFabricReactProps {
  ...
  type ButtonAnchorExampleProps = typings.officeUiFabricReact.buttonAnchorExampleMod.IButtonExampleProps
  @scala.inline
  def ButtonCommandBarExampleProps: typings.officeUiFabricReact.buttonCommandBarExampleMod.IButtonExampleProps.type = typings.officeUiFabricReact.buttonCommandBarExampleMod.IButtonExampleProps
  type ButtonCommandBarExampleProps = typings.officeUiFabricReact.buttonCommandBarExampleMod.IButtonExampleProps
  @scala.inline
  def ButtonCommandExampleProps: typings.officeUiFabricReact.buttonCommandExampleMod.IButtonExampleProps.type = typings.officeUiFabricReact.buttonCommandExampleMod.IButtonExampleProps
  type ButtonCommandExampleProps = typings.officeUiFabricReact.buttonCommandExampleMod.IButtonExampleProps
  @scala.inline
  def ButtonCompoundExampleProps: typings.officeUiFabricReact.buttonCompoundExampleMod.IButtonExampleProps.type = typings.officeUiFabricReact.buttonCompoundExampleMod.IButtonExampleProps
  type ButtonCompoundExampleProps = typings.officeUiFabricReact.buttonCompoundExampleMod.IButtonExampleProps
  @scala.inline
  def ButtonContextualMenuExampleProps: typings.officeUiFabricReact.buttonContextualMenuExampleMod.IButtonExampleProps.type = typings.officeUiFabricReact.buttonContextualMenuExampleMod.IButtonExampleProps
  type ButtonContextualMenuExampleProps = typings.officeUiFabricReact.buttonContextualMenuExampleMod.IButtonExampleProps
  @scala.inline
  def ButtonDefaultExampleProps: typings.officeUiFabricReact.buttonDefaultExampleMod.IButtonExampleProps.type = typings.officeUiFabricReact.buttonDefaultExampleMod.IButtonExampleProps
  type ButtonDefaultExampleProps = typings.officeUiFabricReact.buttonDefaultExampleMod.IButtonExampleProps
  @scala.inline
  ...
  @scala.inline
  def ButtonSplitCustomExampleProps: typings.officeUiFabricReact.buttonCustomSplitExampleMod.IButtonExampleProps.type = typings.officeUiFabricReact.buttonCustomSplitExampleMod.IButtonExampleProps
  type ButtonSplitCustomExampleProps = typings.officeUiFabricReact.buttonCustomSplitExampleMod.IButtonExampleProps
  @scala.inline
  def ButtonSplitExampleProps: typings.officeUiFabricReact.buttonSplitExampleMod.IButtonExampleProps.type = typings.officeUiFabricReact.buttonSplitExampleMod.IButtonExampleProps
  type ButtonSplitExampleProps = typings.officeUiFabricReact.buttonSplitExampleMod.IButtonExampleProps
  @scala.inline
