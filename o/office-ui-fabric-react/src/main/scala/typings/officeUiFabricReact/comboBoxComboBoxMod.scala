...
object comboBoxComboBoxMod {
  ...
  object IComboBoxState {
    ...
    @scala.inline
    implicit class IComboBoxStateMutableBuilder[Self <: IComboBoxState] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setCurrentOptions(value: js.Array[IComboBoxOption]): Self = StObject.set(x, "currentOptions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCurrentOptionsVarargs(value: IComboBoxOption*): Self = StObject.set(x, "currentOptions", js.Array(value :_*))
      
      @scala.inline
      def setCurrentPendingValue(value: String): Self = StObject.set(x, "currentPendingValue", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCurrentPendingValueUndefined: Self = StObject.set(x, "currentPendingValue", js.undefined)
      
      @scala.inline
      def setCurrentPendingValueValidIndex(value: Double): Self = StObject.set(x, "currentPendingValueValidIndex", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCurrentPendingValueValidIndexOnHover(value: Double): Self = StObject.set(x, "currentPendingValueValidIndexOnHover", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFocusState(value: none | focused | focusing): Self = StObject.set(x, "focusState", value.asInstanceOf[js.Any])
