...
object DEFAULT_ROW_HEIGHTS {
  ...
  @JSImport("office-ui-fabric-react/lib/index.bundle", "DEFAULT_ROW_HEIGHTS")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("office-ui-fabric-react/lib/index.bundle", "DEFAULT_ROW_HEIGHTS.compactRowHeight")
  @js.native
  ...
  @JSImport("office-ui-fabric-react/lib/index.bundle", "DEFAULT_ROW_HEIGHTS.rowHeight")
  @js.native
