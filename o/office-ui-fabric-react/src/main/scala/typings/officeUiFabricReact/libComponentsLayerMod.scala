...
object libComponentsLayerMod {
  ...
  open class LayerBase protected ()
    extends typings.officeUiFabricReact.libComponentsLayerLayerDotbaseMod.LayerBase {
  ...
  open class LayerHost protected ()
    extends typings.officeUiFabricReact.libComponentsLayerLayerHostMod.LayerHost {
