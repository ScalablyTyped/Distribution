...
object libButtonMod {
  ...
  open class ActionButton protected ()
    extends typings.officeUiFabricReact.libComponentsButtonMod.ActionButton {
  ...
  open class BaseButton protected ()
    extends typings.officeUiFabricReact.libComponentsButtonMod.BaseButton {
  ...
  open class Button protected ()
    extends typings.officeUiFabricReact.libComponentsButtonMod.Button {
    def this(props: IButtonProps) = this()
  }
  ...
  open class CommandBarButton protected ()
    extends typings.officeUiFabricReact.libComponentsButtonMod.CommandBarButton {
    def this(props: IButtonProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
  ...
  open class CompoundButton protected ()
    extends typings.officeUiFabricReact.libComponentsButtonMod.CompoundButton {
    def this(props: IButtonProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
  ...
  open class DefaultButton protected ()
    extends typings.officeUiFabricReact.libComponentsButtonMod.DefaultButton {
    def this(props: IButtonProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
  ...
  open class IconButton protected ()
    extends typings.officeUiFabricReact.libComponentsButtonMod.IconButton {
    def this(props: IButtonProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
  ...
  open class MessageBarButton protected ()
    extends typings.officeUiFabricReact.libComponentsButtonMod.MessageBarButton {
    def this(props: IButtonProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
  ...
  open class PrimaryButton protected ()
    extends typings.officeUiFabricReact.libComponentsButtonMod.PrimaryButton {
    def this(props: IButtonProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
