...
object contextualMenuSplitButtonMod {
  ...
  class ContextualMenuSplitButton protected () extends ContextualMenuItemWrapper {
    ...
    var _onIconItemClick: js.Any = js.native
    
    var _onItemMouseEnterIcon: js.Any = js.native
    
    var _onItemMouseEnterPrimary: js.Any = js.native
    
    var _onItemMouseMoveIcon: js.Any = js.native
    
    var _onItemMouseMovePrimary: js.Any = js.native
    ...
    var _renderSplitDivider: js.Any = js.native
    
    var _renderSplitIconButton: js.Any = js.native
    
    var _renderSplitPrimaryButton: js.Any = js.native
  ...
  trait IContextualMenuSplitButtonState extends StObject
}
