...
import typings.officeDashUiDashFabricDashReact.Anon_Options
...
class DropdownBase protected ()
  extends typings.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactMod.DropdownBase {
