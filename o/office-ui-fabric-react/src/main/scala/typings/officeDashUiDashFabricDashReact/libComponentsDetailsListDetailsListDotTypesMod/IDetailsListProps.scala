...
object IDetailsListProps {
  ...
  def apply(
    ...
    if (ariaLabelForGrid != null) __obj.updateDynamic("ariaLabelForGrid")(ariaLabelForGrid)
    if (ariaLabelForListHeader != null) __obj.updateDynamic("ariaLabelForListHeader")(ariaLabelForListHeader)
    ...
    if (constrainMode != null) __obj.updateDynamic("constrainMode")(constrainMode)
    if (!js.isUndefined(disableSelectionZone)) __obj.updateDynamic("disableSelectionZone")(disableSelectionZone)
    ...
    if (groupProps != null) __obj.updateDynamic("groupProps")(groupProps)
    ...
    if (!js.isUndefined(isHeaderVisible)) __obj.updateDynamic("isHeaderVisible")(isHeaderVisible)
    if (!js.isUndefined(isPlaceholderData)) __obj.updateDynamic("isPlaceholderData")(isPlaceholderData)
    ...
    if (rowElementEventMap != null) __obj.updateDynamic("rowElementEventMap")(rowElementEventMap)
    ...
    if (selectionZoneProps != null) __obj.updateDynamic("selectionZoneProps")(selectionZoneProps)
    if (setKey != null) __obj.updateDynamic("setKey")(setKey)
    if (!js.isUndefined(shouldApplyApplicationRole)) __obj.updateDynamic("shouldApplyApplicationRole")(shouldApplyApplicationRole)
