...
object IColumn {
  ...
  def apply(
    ...
    if (!js.isUndefined(isCollapsable)) __obj.updateDynamic("isCollapsable")(isCollapsable)
    if (!js.isUndefined(isCollapsible)) __obj.updateDynamic("isCollapsible")(isCollapsible)
    if (!js.isUndefined(isFiltered)) __obj.updateDynamic("isFiltered")(isFiltered)
    if (!js.isUndefined(isGrouped)) __obj.updateDynamic("isGrouped")(isGrouped)
    if (!js.isUndefined(isIconOnly)) __obj.updateDynamic("isIconOnly")(isIconOnly)
    if (!js.isUndefined(isMenuOpen)) __obj.updateDynamic("isMenuOpen")(isMenuOpen)
    ...
    if (!js.isUndefined(isSortedDescending)) __obj.updateDynamic("isSortedDescending")(isSortedDescending)
