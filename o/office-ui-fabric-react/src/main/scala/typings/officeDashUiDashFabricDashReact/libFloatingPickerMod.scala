...
object libFloatingPickerMod extends js.Object {
  ...
  class BaseFloatingPeoplePicker ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsFloatingPickerMod.BaseFloatingPeoplePicker
  
  @js.native
  class BaseFloatingPicker[T, P /* <: IBaseFloatingPickerProps[T] */] protected ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsFloatingPickerMod.BaseFloatingPicker[T, P] {
    def this(basePickerProps: P) = this()
  }
  
  @js.native
  class FloatingPeoplePicker ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsFloatingPickerMod.FloatingPeoplePicker
  
  @js.native
  class SuggestionsControl[T] protected ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsFloatingPickerMod.SuggestionsControl[T] {
    def this(suggestionsProps: ISuggestionsControlProps[T]) = this()
  }
  
  @js.native
  class SuggestionsCore[T] protected ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsFloatingPickerMod.SuggestionsCore[T] {
    def this(suggestionsProps: ISuggestionsCoreProps[T]) = this()
  }
  
  @js.native
  class SuggestionsHeaderFooterItem ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsFloatingPickerMod.SuggestionsHeaderFooterItem
  
  @js.native
  class SuggestionsStore[T] ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsFloatingPickerMod.SuggestionsStore[T] {
