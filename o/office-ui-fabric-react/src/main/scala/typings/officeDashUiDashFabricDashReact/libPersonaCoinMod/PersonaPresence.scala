...
@JSImport("office-ui-fabric-react/lib/PersonaCoin", "PersonaPresence")
@js.native
object PersonaPresence extends js.Object {
  ...
  def apply(value: Double): js.UndefOr[
    typings.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaDotTypesMod.PersonaPresence with Double
  ] = js.native
}
