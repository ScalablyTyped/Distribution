package typings.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaCoinMod
...
class PersonaCoinBase protected ()
  extends typings.officeDashUiDashFabricDashReact.libComponentsPersonaPersonaCoinPersonaCoinDotBaseMod.PersonaCoinBase {
