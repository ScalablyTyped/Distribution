...
object libButtonMod extends js.Object {
  ...
  class BaseButton protected ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsButtonMod.BaseButton {
    def this(props: IBaseButtonProps, rootClassName: String) = this()
  }
  
  @js.native
  class Button protected ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsButtonMod.Button {
