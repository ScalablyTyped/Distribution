...
trait Anon_HeaderClassName extends js.Object {
  /**
...
object Anon_HeaderClassName {
  ...
  def apply(
    ...
    if (!js.isUndefined(isActionable)) __obj.updateDynamic("isActionable")(isActionable)
    if (!js.isUndefined(isEmpty)) __obj.updateDynamic("isEmpty")(isEmpty)
    if (!js.isUndefined(isIconOnly)) __obj.updateDynamic("isIconOnly")(isIconOnly)
    if (!js.isUndefined(isIconVisible)) __obj.updateDynamic("isIconVisible")(isIconVisible)
    if (!js.isUndefined(isPadded)) __obj.updateDynamic("isPadded")(isPadded)
    ...
    __obj.asInstanceOf[Anon_HeaderClassName]
  }
}
