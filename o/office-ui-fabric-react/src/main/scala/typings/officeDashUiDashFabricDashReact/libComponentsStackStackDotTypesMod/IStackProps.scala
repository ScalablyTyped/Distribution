...
object IStackProps {
  ...
  def apply(
    ...
    color: String = null,
    contentEditable: Booleanish | typings.react.reactStrings.inherit = null,
  ...
  {[ key in keyof TSlots ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[key]>>}
    */ typings.atUifabricFoundation.atUifabricFoundationStrings.Anon_Slots with IStackSlots = null,
