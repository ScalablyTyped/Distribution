package typings.officeDashUiDashFabricDashReact.libColorMod

import typings.officeDashUiDashFabricDashReact.libUtilitiesColorInterfacesMod.IColor
import typings.officeDashUiDashFabricDashReact.libUtilitiesColorInterfacesMod.IHSL
import typings.officeDashUiDashFabricDashReact.libUtilitiesColorInterfacesMod.IHSV
import typings.officeDashUiDashFabricDashReact.libUtilitiesColorInterfacesMod.IRGB
...
import typings.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactNumbers.`255`
import typings.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactNumbers.`359`
...
import typings.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactStrings.b
import typings.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactStrings.g
import typings.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactStrings.r
...
object ^ extends js.Object {
  ...
  def getBackgroundShade(color: IColor, shade: typings.officeDashUiDashFabricDashReact.libUtilitiesColorShadesMod.Shade): IColor | Null = js.native
  def getBackgroundShade(
    color: IColor,
    shade: typings.officeDashUiDashFabricDashReact.libUtilitiesColorShadesMod.Shade,
    isInverted: Boolean
  ): IColor | Null = js.native
  ...
  def getShade(color: IColor, shade: typings.officeDashUiDashFabricDashReact.libUtilitiesColorShadesMod.Shade): IColor | Null = js.native
  def getShade(
    color: IColor,
    shade: typings.officeDashUiDashFabricDashReact.libUtilitiesColorShadesMod.Shade,
    isInverted: Boolean
  ...
  def isValidShade(shade: typings.officeDashUiDashFabricDashReact.libUtilitiesColorShadesMod.Shade): Boolean = js.native
