...
trait officeDashUiDashFabricDashReactProps {
  ...
  @scala.inline
  def BaseExtendedPickerProps: IBaseExtendedPickerProps.type = typings.officeDashUiDashFabricDashReact.libComponentsExtendedPickerBaseExtendedPickerDotTypesMod.IBaseExtendedPickerProps
  type BaseExtendedPickerProps[T] = IBaseExtendedPickerProps[T]
  type BaseFloatingPeoplePickerProps = IPeopleFloatingPickerProps
  type BaseFloatingPickerProps[T] = IBaseFloatingPickerProps[T]
  ...
  type BasePickerProps[T] = IBasePickerProps[T]
  type BasePickerListBelowProps[T] = IBasePickerProps[T]
  @scala.inline
  def BaseSelectedItemsListProps: IBaseSelectedItemsListProps.type = typings.officeDashUiDashFabricDashReact.libComponentsSelectedItemsListBaseSelectedItemsListDotTypesMod.IBaseSelectedItemsListProps
  type BaseSelectedItemsListProps[T] = IBaseSelectedItemsListProps[T]
  @scala.inline
  ...
  @scala.inline
  def GridCellProps: IGridCellProps.type = typings.officeDashUiDashFabricDashReact.libUtilitiesGridGridCellDotTypesMod.IGridCellProps
  type GridCellProps[T] = IGridCellProps[T]
  @scala.inline
