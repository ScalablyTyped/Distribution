...
import typings.officeDashUiDashFabricDashReact.Anon_AddMeasurementToCache
import typings.officeDashUiDashFabricDashReact.Anon_Children
import typings.officeDashUiDashFabricDashReact.Anon_CurrentState
import typings.officeDashUiDashFabricDashReact.Anon_IsAvailable
import typings.officeDashUiDashFabricDashReact.Anon_IsMeasured
...
import typings.officeDashUiDashFabricDashReact.libComponentsStackStackDotTypesMod.IStackProps
...
import typings.officeDashUiDashFabricDashReact.officeDashUiDashFabricDashReactNumbers.`1000`
...
object ^ extends js.Object {
  ...
  val Stack: StatelessComponent[IStackProps] with Anon_Item = js.native
  ...
  def getWindow(rootElement: typings.std.Element): js.UndefOr[Window] = js.native
  ...
  def on(element: typings.std.Element, eventName: String, callback: js.Function1[/* ev */ Event, Unit]): js.Function0[Unit] = js.native
  def on(
  ...
  def raiseClick(target: typings.std.Element): Unit = js.native
  ...
  def setFocusVisibility(enabled: Boolean, target: typings.std.Element): Unit = js.native
