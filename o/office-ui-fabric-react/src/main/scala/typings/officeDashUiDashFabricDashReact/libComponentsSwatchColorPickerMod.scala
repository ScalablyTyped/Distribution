...
@js.native
object libComponentsSwatchColorPickerMod extends js.Object {
  @js.native
  class ColorPickerGridCellBase ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsSwatchColorPickerColorPickerGridCellDotBaseMod.ColorPickerGridCellBase
  
  @js.native
  class SwatchColorPickerBase protected ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsSwatchColorPickerSwatchColorPickerDotBaseMod.SwatchColorPickerBase {
