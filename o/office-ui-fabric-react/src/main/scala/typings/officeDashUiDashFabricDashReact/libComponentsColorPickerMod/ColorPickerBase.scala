package typings.officeDashUiDashFabricDashReact.libComponentsColorPickerMod
...
class ColorPickerBase protected ()
  extends typings.officeDashUiDashFabricDashReact.libComponentsColorPickerColorPickerDotBaseMod.ColorPickerBase {
