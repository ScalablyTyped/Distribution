...
object ISwatchColorPickerProps {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(colorCells = colorCells, columnCount = columnCount)
    ...
    if (!js.isUndefined(focusOnHover)) __obj.updateDynamic("focusOnHover")(focusOnHover)
    ...
    if (mouseLeaveParentSelector != null) __obj.updateDynamic("mouseLeaveParentSelector")(mouseLeaveParentSelector)
