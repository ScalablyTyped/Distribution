...
import typings.officeDashUiDashFabricDashReact.libComponentsDropdownDropdownDotTypesMod.IDropdownOption
...
@js.native
object libComponentsDropdownUtilitiesDropdownSizePosCacheMod extends js.Object {
  @js.native
