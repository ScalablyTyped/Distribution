...
object libDetailsListMod extends js.Object {
  ...
  class DetailsColumnBase protected ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsDetailsListMod.DetailsColumnBase {
  ...
  class DetailsRowBase protected ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsDetailsListMod.DetailsRowBase {
    def this(props: IDetailsRowBaseProps) = this()
  }
  
  @js.native
  class Selection ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsDetailsListMod.Selection {
