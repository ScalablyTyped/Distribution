...
object ISpinnerProps {
  ...
  def apply(
    ...
    `aria-live`: typings.react.reactStrings.off | typings.react.reactStrings.assertive | typings.react.reactStrings.polite = null,
    ...
    typeof: String = null,
    unselectable: on | typings.react.reactStrings.off = null,
    vocab: String = null
  ): ISpinnerProps = {
