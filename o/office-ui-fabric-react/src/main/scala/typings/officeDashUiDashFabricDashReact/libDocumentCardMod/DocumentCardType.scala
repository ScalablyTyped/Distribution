...
@JSImport("office-ui-fabric-react/lib/DocumentCard", "DocumentCardType")
@js.native
object DocumentCardType extends js.Object {
  ...
  def apply(value: Double): js.UndefOr[
    typings.officeDashUiDashFabricDashReact.libComponentsDocumentCardDocumentCardDotTypesMod.DocumentCardType with Double
  ] = js.native
}
