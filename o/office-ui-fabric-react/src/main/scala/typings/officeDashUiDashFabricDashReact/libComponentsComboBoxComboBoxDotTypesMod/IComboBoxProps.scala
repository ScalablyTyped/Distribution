...
object IComboBoxProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[IComboBox, Event] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[IComboBox, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[IComboBox, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[IComboBox, Event] => Unit = null,
    onEmptied: SyntheticEvent[IComboBox, Event] => Unit = null,
    onEncrypted: SyntheticEvent[IComboBox, Event] => Unit = null,
    onEnded: SyntheticEvent[IComboBox, Event] => Unit = null,
    onError: SyntheticEvent[IComboBox, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[IComboBox, Event] => Unit = null,
    onLoadStart: SyntheticEvent[IComboBox, Event] => Unit = null,
    onLoadedData: SyntheticEvent[IComboBox, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[IComboBox, Event] => Unit = null,
    ...
    onPause: SyntheticEvent[IComboBox, Event] => Unit = null,
    onPendingValueChanged: (/* option */ js.UndefOr[IComboBoxOption], /* index */ js.UndefOr[Double], /* value */ js.UndefOr[String]) => Unit = null,
    onPlay: SyntheticEvent[IComboBox, Event] => Unit = null,
    onPlaying: SyntheticEvent[IComboBox, Event] => Unit = null,
    ...
    onProgress: SyntheticEvent[IComboBox, Event] => Unit = null,
    onRateChange: SyntheticEvent[IComboBox, Event] => Unit = null,
    ...
    onSeeked: SyntheticEvent[IComboBox, Event] => Unit = null,
    onSeeking: SyntheticEvent[IComboBox, Event] => Unit = null,
    onSelect: SyntheticEvent[IComboBox, Event] => Unit = null,
    onStalled: SyntheticEvent[IComboBox, Event] => Unit = null,
    onSubmit: FormEvent[IComboBox] => Unit = null,
    onSuspend: SyntheticEvent[IComboBox, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[IComboBox, Event] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[IComboBox, Event] => Unit = null,
    onWaiting: SyntheticEvent[IComboBox, Event] => Unit = null,
