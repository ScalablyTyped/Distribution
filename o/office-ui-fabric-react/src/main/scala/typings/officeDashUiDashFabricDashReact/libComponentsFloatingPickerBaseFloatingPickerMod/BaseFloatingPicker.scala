...
import typings.officeDashUiDashFabricDashReact.libComponentsFloatingPickerSuggestionsSuggestionsControlMod.SuggestionsControl
...
class BaseFloatingPicker[T, P /* <: IBaseFloatingPickerProps[T] */] protected ()
  ...
  /* protected */ def onSuggestionClick(ev: typings.react.reactMod.MouseEvent[HTMLElement, MouseEvent], item: T, index: Double): Unit = js.native
