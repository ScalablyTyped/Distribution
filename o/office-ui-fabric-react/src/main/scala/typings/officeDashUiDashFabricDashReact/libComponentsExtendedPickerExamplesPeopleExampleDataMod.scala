...
@js.native
object libComponentsExtendedPickerExamplesPeopleExampleDataMod extends js.Object {
  ...
  val people: js.Array[IExtendedPersonaProps with Anon_KeyNumberString] = js.native
}
