package typings.officeDashUiDashFabricDashReact.libComponentsColorPickerColorSliderColorSliderDotBaseMod

import typings.officeDashUiDashFabricDashReact.libComponentsColorPickerColorSliderColorSliderDotTypesMod.IColorSlider
