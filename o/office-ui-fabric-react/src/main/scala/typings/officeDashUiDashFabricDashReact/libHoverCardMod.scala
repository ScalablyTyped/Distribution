...
object libHoverCardMod extends js.Object {
  ...
  class ExpandingCardBase protected ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsHoverCardMod.ExpandingCardBase {
    def this(props: IExpandingCardProps) = this()
  }
  
  @js.native
  class HoverCardBase protected ()
    extends typings.officeDashUiDashFabricDashReact.libComponentsHoverCardMod.HoverCardBase {
