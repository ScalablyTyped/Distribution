...
import typings.officeDashUiDashFabricDashReact.libComponentsSliderSliderDotBaseMod.SliderBase
...
object ISliderProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(originFromZero)) __obj.updateDynamic("originFromZero")(originFromZero)
