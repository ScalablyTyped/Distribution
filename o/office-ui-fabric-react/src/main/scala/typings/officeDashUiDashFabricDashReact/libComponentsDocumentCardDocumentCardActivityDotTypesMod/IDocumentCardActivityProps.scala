...
import typings.officeDashUiDashFabricDashReact.libComponentsDocumentCardDocumentCardActivityDotBaseMod.DocumentCardActivityBase
...
object IDocumentCardActivityProps {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(activity = activity, people = people)
