...
object OidcClientSettings {
  ...
  def apply(
    ...
    if (!js.isUndefined(filter_protocol_claims)) __obj.updateDynamic("filter_protocol_claims")(filter_protocol_claims.get.asInstanceOf[js.Any])
    if (!js.isUndefined(load_user_profile)) __obj.updateDynamic("load_user_profile")(load_user_profile.get.asInstanceOf[js.Any])
