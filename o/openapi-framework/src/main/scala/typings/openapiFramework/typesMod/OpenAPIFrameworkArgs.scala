...
trait OpenAPIFrameworkArgs extends js.Object {
  ...
  var externalSchemas: js.UndefOr[typings.openapiFramework.anon.String] = js.native
...
object OpenAPIFrameworkArgs {
  ...
  implicit class OpenAPIFrameworkArgsOps[Self <: OpenAPIFrameworkArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExternalSchemas(value: typings.openapiFramework.anon.String): Self = this.set("externalSchemas", value.asInstanceOf[js.Any])
    @scala.inline
