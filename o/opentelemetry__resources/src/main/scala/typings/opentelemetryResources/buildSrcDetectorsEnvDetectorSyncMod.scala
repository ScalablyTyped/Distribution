...
object buildSrcDetectorsEnvDetectorSyncMod {
  
  @JSImport("@opentelemetry/resources/build/src/detectors/EnvDetectorSync", "envDetectorSync")
  @js.native
  ...
  trait EnvDetectorSync_
    ...
    /* private */ var _isBaggageOctetString: Any = js.native
