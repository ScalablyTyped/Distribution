...
/* Inlined std.Omit<@onfleet/node-onfleet.@onfleet/node-onfleet/Resources/Tasks.TaskAutoAssignOptions, 'team'> */
trait TasksAutoAssign extends StObject {
...
object TasksAutoAssign {
  
  inline def apply(mode: String): TasksAutoAssign = {
    val __obj = js.Dynamic.literal(mode = mode.asInstanceOf[js.Any])
    __obj.asInstanceOf[TasksAutoAssign]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TasksAutoAssign] (val x: Self) extends AnyVal {
