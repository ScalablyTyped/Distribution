...
object buildSrcTraceTraceStateMod {
  ...
  open class TraceState ()
    extends StObject
       with typings.opentelemetryApi.buildSrcTraceTraceStateMod.TraceState {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def set(key: String, value: String): typings.opentelemetryApi.buildSrcTraceTraceStateMod.TraceState = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def unset(key: String): typings.opentelemetryApi.buildSrcTraceTraceStateMod.TraceState = js.native
  }
}
