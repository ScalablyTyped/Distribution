...
object utilsEnvironmentMod {
  ...
  object DEFAULT_ENVIRONMENT {
    ...
    inline def OTEL_LOG_LEVEL_=(x: LogLevel): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OTEL_LOG_LEVEL")(x.asInstanceOf[js.Any])
    ...
    inline def OTEL_NO_PATCH_MODULES_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OTEL_NO_PATCH_MODULES")(x.asInstanceOf[js.Any])
    ...
    inline def OTEL_SAMPLING_PROBABILITY_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OTEL_SAMPLING_PROBABILITY")(x.asInstanceOf[js.Any])
  }
  
  inline def parseEnvironment(values: ENVIRONMENT_MAP): ENVIRONMENT = ^.asInstanceOf[js.Dynamic].applyDynamic("parseEnvironment")(values.asInstanceOf[js.Any]).asInstanceOf[ENVIRONMENT]
  ...
  object ENVIRONMENT {
    ...
    extension [Self <: ENVIRONMENT](x: Self) {
      ...
      inline def setOTEL_NO_PATCH_MODULESUndefined: Self = StObject.set(x, "OTEL_NO_PATCH_MODULES", js.undefined)
      ...
      inline def setOTEL_SAMPLING_PROBABILITYUndefined: Self = StObject.set(x, "OTEL_SAMPLING_PROBABILITY", js.undefined)
    }
  }
