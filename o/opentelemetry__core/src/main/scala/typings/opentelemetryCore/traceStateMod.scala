...
object traceStateMod {
  ...
  open class TraceState ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def set(key: String, value: String): typings.opentelemetryApi.traceStateMod.TraceState = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def unset(key: String): typings.opentelemetryApi.traceStateMod.TraceState = js.native
  }
}
