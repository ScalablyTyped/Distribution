...
trait `200Content371Headers` extends StObject {
  
  /** Response */
  var `200`: Content371Headers
...
object `200Content371Headers` {
  
  inline def apply(
    `200`: Content371Headers,
    ...
    __obj.asInstanceOf[`200Content371Headers`]
  }
  
  extension [Self <: `200Content371Headers`](x: Self) {
    
    inline def set200(value: Content371Headers): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
