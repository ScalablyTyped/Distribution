...
trait `200Content800` extends StObject {
...
object `200Content800` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content800`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content800`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content800): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
