...
trait `200Content138404410` extends StObject {
...
object `200Content138404410` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content138404410`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content138404410`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content138): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
