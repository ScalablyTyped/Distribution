...
trait `200Content478` extends StObject {
...
object `200Content478` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content478`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content478`] (val x: Self) extends AnyVal {
