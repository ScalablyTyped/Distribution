...
object `200ContentApplicationjsonSubject` {
  ...
  inline def apply(`200`: ContentApplicationjsonSubject, `304`: Any, `401`: Content55, `403`: Content55): `200ContentApplicationjsonSubject` = {
  ...
  extension [Self <: `200ContentApplicationjsonSubject`](x: Self) {
