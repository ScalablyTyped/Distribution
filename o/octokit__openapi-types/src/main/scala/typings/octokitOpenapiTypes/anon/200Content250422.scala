...
trait `200Content250422` extends StObject {
...
object `200Content250422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content250422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content250422`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content250): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
