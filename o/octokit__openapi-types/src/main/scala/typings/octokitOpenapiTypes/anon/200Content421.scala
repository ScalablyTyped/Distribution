...
trait `200Content421` extends StObject {
...
object `200Content421` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content421`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content421`] (val x: Self) extends AnyVal {
