...
trait Lastusedat extends StObject {
  ...
  var repository: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['full-repository'] */ js.Any
...
object Lastusedat {
  ...
  inline def apply(
    ...
    repository: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['full-repository'] */ js.Any,
    start_url: String,
    ...
    __obj.asInstanceOf[Lastusedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Lastusedat] (val x: Self) extends AnyVal {
