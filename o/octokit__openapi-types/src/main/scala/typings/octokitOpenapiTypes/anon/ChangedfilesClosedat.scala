...
trait ChangedfilesClosedat extends StObject {
...
object ChangedfilesClosedat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ChangedfilesClosedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChangedfilesClosedat] (val x: Self) extends AnyVal {
