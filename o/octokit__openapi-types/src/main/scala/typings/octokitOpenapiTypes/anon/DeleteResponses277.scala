...
trait DeleteResponses277 extends StObject {
  ...
  /**
    ...
    */
  var delete: Responses277
  
  /** Get a deployment */
  var get: ParametersPathDeploymentid
}
object DeleteResponses277 {
  
  inline def apply(delete: Responses277, get: ParametersPathDeploymentid): DeleteResponses277 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteResponses277]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteResponses277] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: Responses277): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
