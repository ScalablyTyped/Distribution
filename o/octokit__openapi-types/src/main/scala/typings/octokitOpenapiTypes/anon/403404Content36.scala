...
trait `403404Content36` extends StObject {
...
object `403404Content36` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`403404Content36`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `403404Content36`] (val x: Self) extends AnyVal {
