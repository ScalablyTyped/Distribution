...
trait `200Content792` extends StObject {
...
object `200Content792` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content792`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content792`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content792): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
