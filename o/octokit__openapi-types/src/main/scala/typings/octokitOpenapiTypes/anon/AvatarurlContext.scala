...
trait AvatarurlContext extends StObject {
...
object AvatarurlContext {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[AvatarurlContext]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AvatarurlContext] (val x: Self) extends AnyVal {
