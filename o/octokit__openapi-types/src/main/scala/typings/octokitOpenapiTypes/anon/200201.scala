...
object `200201` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200201`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content133): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
    
    inline def set201(value: Content133): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
