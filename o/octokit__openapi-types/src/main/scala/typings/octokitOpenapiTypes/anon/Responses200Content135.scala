...
trait Responses200Content135 extends StObject {
...
object Responses200Content135 {
  
  inline def apply(parameters: PathDiscussionnumber, responses: `200Content135`): Responses200Content135 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content135]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content135] (val x: Self) extends AnyVal {
