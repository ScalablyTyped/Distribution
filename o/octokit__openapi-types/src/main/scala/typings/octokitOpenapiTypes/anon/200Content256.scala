...
trait `200Content256` extends StObject {
...
object `200Content256` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content256`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content256`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content256): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
