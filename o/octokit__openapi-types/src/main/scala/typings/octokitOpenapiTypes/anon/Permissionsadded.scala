...
trait Permissionsadded extends StObject {
...
object Permissionsadded {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Permissionsadded]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Permissionsadded] (val x: Self) extends AnyVal {
