...
trait DeleteParametersPathProjectidTeamidResponses90 extends StObject {
  ...
  /**
    ...
    */
  var delete: ParametersPathProjectidTeamidResponses90
...
object DeleteParametersPathProjectidTeamidResponses90 {
  
  inline def apply(
    delete: ParametersPathProjectidTeamidResponses90,
    get: ParametersPathProjectidTeamid,
    put: RequestBodyContentApplicationjsonPermission
  ): DeleteParametersPathProjectidTeamidResponses90 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathProjectidTeamidResponses90]
  }
  
  extension [Self <: DeleteParametersPathProjectidTeamidResponses90](x: Self) {
    
    inline def setDelete(value: ParametersPathProjectidTeamidResponses90): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
