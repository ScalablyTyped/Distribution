...
object Responses200ContentApplicationjsonDaysleftinbillingcycle {
  ...
  inline def apply(parameters: PathEnterpriseString, responses: `200ContentApplicationjsonDaysleftinbillingcycle`): Responses200ContentApplicationjsonDaysleftinbillingcycle = {
