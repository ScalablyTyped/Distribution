...
trait `201Content467HeadersLocation` extends StObject {
  
  /** Response */
  var `201`: Content467HeadersLocation
...
object `201Content467HeadersLocation` {
  
  inline def apply(
    `201`: Content467HeadersLocation,
  ...
  ): `201Content467HeadersLocation` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("201")(`201`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`201Content467HeadersLocation`]
  }
  
  extension [Self <: `201Content467HeadersLocation`](x: Self) {
    
    inline def set201(value: Content467HeadersLocation): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
