...
object RequestBodyContentApplicationjsonKeyid {
  ...
  inline def apply(parameters: PathSecretname, requestBody: ContentApplicationjsonKeyid, responses: `201Content67`): RequestBodyContentApplicationjsonKeyid = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], requestBody = requestBody.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestBodyContentApplicationjsonKeyid]
  }
  
  extension [Self <: RequestBodyContentApplicationjsonKeyid](x: Self) {
