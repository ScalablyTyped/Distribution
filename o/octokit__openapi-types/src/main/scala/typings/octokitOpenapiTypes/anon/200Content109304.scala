...
trait `200Content109304` extends StObject {
...
object `200Content109304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content109304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content109304`] (val x: Self) extends AnyVal {
