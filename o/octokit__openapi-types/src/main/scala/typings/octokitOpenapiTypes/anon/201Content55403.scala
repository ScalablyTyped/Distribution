...
trait `201Content55403` extends StObject {
...
object `201Content55403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content55403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content55403`] (val x: Self) extends AnyVal {
