...
trait `201Content357` extends StObject {
...
object `201Content357` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content357`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content357`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content357): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
