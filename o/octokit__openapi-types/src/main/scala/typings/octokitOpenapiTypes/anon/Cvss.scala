...
trait Cvss extends StObject {
  ...
  val vulnerabilities: js.Array[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-security-vulnerability'] */ js.Any
  ]
