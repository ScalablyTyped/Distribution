...
trait DeleteParametersPathTeamidResponses75 extends StObject {
  ...
  /**
    ...
    */
  var delete: ParametersPathTeamidResponses75
...
object DeleteParametersPathTeamidResponses75 {
  
  inline def apply(
    delete: ParametersPathTeamidResponses75,
    get: ParametersPathTeamid,
    patch: RequestBodyContentApplicationjsonParentteamid
  ): DeleteParametersPathTeamidResponses75 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], patch = patch.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathTeamidResponses75]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPathTeamidResponses75] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathTeamidResponses75): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
