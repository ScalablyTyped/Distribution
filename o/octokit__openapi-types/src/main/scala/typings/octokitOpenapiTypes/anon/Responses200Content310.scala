...
object Responses200Content310 {
  ...
  inline def apply(parameters: `141`, responses: `200Content310`): Responses200Content310 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content310]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content310] (val x: Self) extends AnyVal {
