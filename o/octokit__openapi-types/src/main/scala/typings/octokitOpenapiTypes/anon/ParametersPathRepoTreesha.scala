...
trait ParametersPathRepoTreesha extends StObject {
  ...
  var responses: `200519`
}
object ParametersPathRepoTreesha {
  
  inline def apply(parameters: PathRepoTreesha, responses: `200519`): ParametersPathRepoTreesha = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathRepoTreesha] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200519`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
