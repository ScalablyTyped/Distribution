...
trait InstallationIssueLabel extends StObject {
...
object InstallationIssueLabel {
  
  inline def apply(issue: AssigneesAuthorassociation, repository: Allowupdatebranch, sender: Avatarurl): InstallationIssueLabel = {
    val __obj = js.Dynamic.literal(action = "unlabeled", issue = issue.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[InstallationIssueLabel]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InstallationIssueLabel] (val x: Self) extends AnyVal {
