...
trait `200Content310403` extends StObject {
...
object `200Content310403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content310403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content310403`] (val x: Self) extends AnyVal {
