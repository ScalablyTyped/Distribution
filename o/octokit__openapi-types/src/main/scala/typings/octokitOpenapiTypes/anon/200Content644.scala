...
trait `200Content644` extends StObject {
...
object `200Content644` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content644`]
  }
  
  extension [Self <: `200Content644`](x: Self) {
    
    inline def set200(value: Content644): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
