...
trait PerpageVisibility extends StObject {
...
object PerpageVisibility {
  
  inline def apply(package_type: npm | maven | rubygems | docker | nuget | container): PerpageVisibility = {
    val __obj = js.Dynamic.literal(package_type = package_type.asInstanceOf[js.Any])
    __obj.asInstanceOf[PerpageVisibility]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PerpageVisibility] (val x: Self) extends AnyVal {
