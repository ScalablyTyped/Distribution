...
object `20039` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`20039`]
  }
  
  extension [Self <: `20039`](x: Self) {
    
    inline def set200(value: `39`): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
