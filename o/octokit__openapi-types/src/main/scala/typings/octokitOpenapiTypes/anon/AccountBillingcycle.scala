...
trait AccountBillingcycle extends StObject {
...
object AccountBillingcycle {
  
  inline def apply(account: IdLogin, billing_cycle: String, on_free_trial: Boolean, plan: Bullets, unit_count: Double): AccountBillingcycle = {
    ...
    __obj.asInstanceOf[AccountBillingcycle]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AccountBillingcycle] (val x: Self) extends AnyVal {
