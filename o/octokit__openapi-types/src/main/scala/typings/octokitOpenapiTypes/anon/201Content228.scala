...
trait `201Content228` extends StObject {
...
object `201Content228` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content228`]
  }
  
  extension [Self <: `201Content228`](x: Self) {
    
    inline def set201(value: Content228): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
