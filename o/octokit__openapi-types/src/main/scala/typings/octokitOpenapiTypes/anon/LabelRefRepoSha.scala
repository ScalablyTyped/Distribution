...
trait LabelRefRepoSha extends StObject {
...
object LabelRefRepoSha {
  
  inline def apply(label: String, ref: String, repo: Fork, sha: String): LabelRefRepoSha = {
    ...
    __obj.asInstanceOf[LabelRefRepoSha]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LabelRefRepoSha] (val x: Self) extends AnyVal {
