...
trait BypassmodeConditions extends StObject {
...
object BypassmodeConditions {
  
  inline def apply(): BypassmodeConditions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BypassmodeConditions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BypassmodeConditions] (val x: Self) extends AnyVal {
