...
trait `200Content69422` extends StObject {
...
object `200Content69422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content69422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content69422`] (val x: Self) extends AnyVal {
