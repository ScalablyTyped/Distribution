...
object DeleteResponses92 {
  ...
  inline def apply(delete: Responses92, get: Responses200Content90, put: Responses200403422): DeleteResponses92 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteResponses92]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteResponses92] (val x: Self) extends AnyVal {
