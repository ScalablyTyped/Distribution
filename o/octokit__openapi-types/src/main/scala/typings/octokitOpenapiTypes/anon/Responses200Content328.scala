...
object Responses200Content328 {
  ...
  inline def apply(parameters: Query205, responses: `200Content328`): Responses200Content328 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content328]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content328] (val x: Self) extends AnyVal {
