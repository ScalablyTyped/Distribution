...
trait `200ContentApplicationjsonGitstatus401Content48` extends StObject {
...
object `200ContentApplicationjsonGitstatus401Content48` {
  ...
  inline def apply(
    ...
    `404`: Content48,
    `500`: Content48
  ): `200ContentApplicationjsonGitstatus401Content48` = {
    ...
    __obj.asInstanceOf[`200ContentApplicationjsonGitstatus401Content48`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonGitstatus401Content48`] (val x: Self) extends AnyVal {
