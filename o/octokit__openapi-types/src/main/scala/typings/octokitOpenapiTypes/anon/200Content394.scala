...
trait `200Content394` extends StObject {
...
object `200Content394` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content394`]
  }
  
  extension [Self <: `200Content394`](x: Self) {
    
    inline def set200(value: Content394): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
