...
trait `200Content583304` extends StObject {
...
object `200Content583304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content583304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content583304`] (val x: Self) extends AnyVal {
