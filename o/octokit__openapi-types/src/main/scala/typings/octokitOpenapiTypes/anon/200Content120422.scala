...
trait `200Content120422` extends StObject {
...
object `200Content120422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content120422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content120422`] (val x: Self) extends AnyVal {
