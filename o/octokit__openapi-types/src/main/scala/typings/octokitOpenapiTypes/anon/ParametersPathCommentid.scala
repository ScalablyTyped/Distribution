...
object ParametersPathCommentid {
  ...
  inline def apply(parameters: PathCommentid, responses: `20043`): ParametersPathCommentid = {
  ...
  extension [Self <: ParametersPathCommentid](x: Self) {
    ...
    inline def setResponses(value: `20043`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
