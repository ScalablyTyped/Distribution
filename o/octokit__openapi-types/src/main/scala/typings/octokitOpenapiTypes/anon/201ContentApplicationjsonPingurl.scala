...
object `201ContentApplicationjsonPingurl` {
  ...
  inline def apply(`201`: ContentApplicationjsonPingurl, `403`: Content48, `404`: Content48, `422`: Content397): `201ContentApplicationjsonPingurl` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `201ContentApplicationjsonPingurl`] (val x: Self) extends AnyVal {
