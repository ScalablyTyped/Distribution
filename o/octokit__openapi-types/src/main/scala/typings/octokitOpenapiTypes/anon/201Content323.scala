...
trait `201Content323` extends StObject {
...
object `201Content323` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content323`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content323`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content323): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
