...
trait `200Content380` extends StObject {
...
object `200Content380` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content380`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content380`] (val x: Self) extends AnyVal {
