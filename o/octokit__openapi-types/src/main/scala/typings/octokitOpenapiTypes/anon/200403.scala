...
object `200403` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200403`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content0): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
