...
trait `200ContentApplicationjson603` extends StObject {
  
  /** Response */
  var `200`: ContentApplicationjson603
...
object `200ContentApplicationjson603` {
  
  inline def apply(
    `200`: ContentApplicationjson603,
    ...
    __obj.asInstanceOf[`200ContentApplicationjson603`]
  }
  
  extension [Self <: `200ContentApplicationjson603`](x: Self) {
    
    inline def set200(value: ContentApplicationjson603): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
