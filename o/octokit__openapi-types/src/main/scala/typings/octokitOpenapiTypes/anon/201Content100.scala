...
trait `201Content100` extends StObject {
...
object `201Content100` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content100`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content100`] (val x: Self) extends AnyVal {
