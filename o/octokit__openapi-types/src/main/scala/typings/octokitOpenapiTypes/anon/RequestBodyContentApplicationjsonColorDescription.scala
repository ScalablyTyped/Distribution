...
trait RequestBodyContentApplicationjsonColorDescription extends StObject {
  ...
  var responses: `201Content280`
}
object RequestBodyContentApplicationjsonColorDescription {
  
  inline def apply(parameters: `144`, requestBody: ContentApplicationjsonColorDescription, responses: `201Content280`): RequestBodyContentApplicationjsonColorDescription = {
  ...
  extension [Self <: RequestBodyContentApplicationjsonColorDescription](x: Self) {
    ...
    inline def setResponses(value: `201Content280`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
