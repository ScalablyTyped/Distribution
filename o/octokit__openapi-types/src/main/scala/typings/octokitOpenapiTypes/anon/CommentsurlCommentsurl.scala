...
trait CommentsurlCommentsurl extends StObject {
  ...
  /**
    ...
    */
  var performed_via_github_app: js.UndefOr[NodeidOwnerPermissions | Null] = js.undefined
...
object CommentsurlCommentsurl {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CommentsurlCommentsurl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommentsurlCommentsurl] (val x: Self) extends AnyVal {
    ...
    inline def setPerformed_via_github_app(value: NodeidOwnerPermissions): Self = StObject.set(x, "performed_via_github_app", value.asInstanceOf[js.Any])
