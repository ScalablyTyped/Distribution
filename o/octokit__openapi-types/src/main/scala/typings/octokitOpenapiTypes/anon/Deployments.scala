...
trait Deployments extends StObject {
  ...
  /** @enum {string} */
  var organization_projects: js.UndefOr[read | write] = js.undefined
  ...
  /** @enum {string} */
  var repository_projects: js.UndefOr[read | write] = js.undefined
...
object Deployments {
  ...
  implicit open class MutableBuilder[Self <: Deployments] (val x: Self) extends AnyVal {
    ...
    inline def setOrganization_projects(value: read | write): Self = StObject.set(x, "organization_projects", value.asInstanceOf[js.Any])
    ...
    inline def setRepository_projects(value: read | write): Self = StObject.set(x, "repository_projects", value.asInstanceOf[js.Any])
