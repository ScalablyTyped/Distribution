...
trait `200Content664` extends StObject {
...
object `200Content664` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content664`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content664`] (val x: Self) extends AnyVal {
