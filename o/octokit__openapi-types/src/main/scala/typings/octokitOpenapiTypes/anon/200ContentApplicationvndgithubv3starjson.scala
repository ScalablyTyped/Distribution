...
object `200ContentApplicationvndgithubv3starjson` {
  ...
  inline def apply(
    `200`: ContentApplicationvndgithubv3starjson,
  ...
  ): `200ContentApplicationvndgithubv3starjson` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationvndgithubv3starjson`] (val x: Self) extends AnyVal {
