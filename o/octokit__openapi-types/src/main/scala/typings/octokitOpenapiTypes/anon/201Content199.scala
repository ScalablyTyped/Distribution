...
trait `201Content199` extends StObject {
...
object `201Content199` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content199`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content199`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content199): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
