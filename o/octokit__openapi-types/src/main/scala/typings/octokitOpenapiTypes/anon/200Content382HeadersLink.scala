...
trait `200Content382HeadersLink` extends StObject {
  
  /** @description Response */
  var `200`: Content382HeadersLink
...
object `200Content382HeadersLink` {
  
  inline def apply(
    `200`: Content382HeadersLink,
    ...
    __obj.asInstanceOf[`200Content382HeadersLink`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content382HeadersLink`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content382HeadersLink): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
