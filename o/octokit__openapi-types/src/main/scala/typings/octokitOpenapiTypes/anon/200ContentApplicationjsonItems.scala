...
object `200ContentApplicationjsonItems` {
  ...
  inline def apply(
    `200`: ContentApplicationjsonItems,
  ...
  ): `200ContentApplicationjsonItems` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonItems`] (val x: Self) extends AnyVal {
