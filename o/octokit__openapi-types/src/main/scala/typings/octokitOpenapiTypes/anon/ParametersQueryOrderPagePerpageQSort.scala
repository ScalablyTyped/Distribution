...
trait ParametersQueryOrderPagePerpageQSort extends StObject {
  ...
  var responses: `200ContentApplicationjson778`
}
object ParametersQueryOrderPagePerpageQSort {
  
  inline def apply(parameters: QueryOrderPagePerpageQSort, responses: `200ContentApplicationjson778`): ParametersQueryOrderPagePerpageQSort = {
  ...
  implicit open class MutableBuilder[Self <: ParametersQueryOrderPagePerpageQSort] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200ContentApplicationjson778`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
