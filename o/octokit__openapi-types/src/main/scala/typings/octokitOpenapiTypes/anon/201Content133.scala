...
trait `201Content133` extends StObject {
...
object `201Content133` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content133`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content133`] (val x: Self) extends AnyVal {
