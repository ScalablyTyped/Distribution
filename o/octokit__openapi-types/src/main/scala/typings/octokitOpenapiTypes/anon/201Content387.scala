...
trait `201Content387` extends StObject {
...
object `201Content387` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content387`]
  }
  
  extension [Self <: `201Content387`](x: Self) {
    
    inline def set201(value: Content387): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
