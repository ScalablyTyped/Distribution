...
trait OrganizationProjectcolumn extends StObject {
...
object OrganizationProjectcolumn {
  
  inline def apply(project_column: AfteridCardsurl): OrganizationProjectcolumn = {
    val __obj = js.Dynamic.literal(action = "deleted", project_column = project_column.asInstanceOf[js.Any])
    __obj.asInstanceOf[OrganizationProjectcolumn]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OrganizationProjectcolumn] (val x: Self) extends AnyVal {
