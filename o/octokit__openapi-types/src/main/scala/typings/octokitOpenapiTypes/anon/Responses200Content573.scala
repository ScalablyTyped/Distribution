...
object Responses200Content573 {
  ...
  inline def apply(parameters: `553`, responses: `200Content573`): Responses200Content573 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content573]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content573] (val x: Self) extends AnyVal {
