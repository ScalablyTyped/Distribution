...
trait `201Content326` extends StObject {
...
object `201Content326` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content326`]
  }
  
  extension [Self <: `201Content326`](x: Self) {
    
    inline def set201(value: Content326): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
