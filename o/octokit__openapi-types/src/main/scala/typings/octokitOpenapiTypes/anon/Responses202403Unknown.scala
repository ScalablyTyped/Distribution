...
object Responses202403Unknown {
  ...
  inline def apply(parameters: `135`, responses: `202403Unknown`): Responses202403Unknown = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses202403Unknown]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses202403Unknown] (val x: Self) extends AnyVal {
