...
trait CommentsCommentsurl extends StObject {
  ...
  /**
    ...
    */
  var performed_via_github_app: js.UndefOr[HtmlurlIdName | Null] = js.undefined
...
object CommentsCommentsurl {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CommentsCommentsurl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommentsCommentsurl] (val x: Self) extends AnyVal {
    ...
    inline def setPerformed_via_github_app(value: HtmlurlIdName): Self = StObject.set(x, "performed_via_github_app", value.asInstanceOf[js.Any])
