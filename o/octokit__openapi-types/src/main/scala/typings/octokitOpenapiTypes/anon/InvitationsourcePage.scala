...
trait InvitationsourcePage extends StObject {
...
object InvitationsourcePage {
  
  inline def apply(): InvitationsourcePage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InvitationsourcePage]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InvitationsourcePage] (val x: Self) extends AnyVal {
