...
object `200ContentApplicationjsonGitstatus` {
  ...
  inline def apply(`200`: ContentApplicationjsonGitstatus, `401`: Content48, `403`: Content48, `404`: Content48): `200ContentApplicationjsonGitstatus` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonGitstatus`] (val x: Self) extends AnyVal {
