...
trait `200ContentApplicationjsonInstallations304` extends StObject {
...
object `200ContentApplicationjsonInstallations304` {
  
  inline def apply(
    `200`: ContentApplicationjsonInstallations,
  ...
  ): `200ContentApplicationjsonInstallations304` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("401")(`401`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjsonInstallations304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonInstallations304`] (val x: Self) extends AnyVal {
