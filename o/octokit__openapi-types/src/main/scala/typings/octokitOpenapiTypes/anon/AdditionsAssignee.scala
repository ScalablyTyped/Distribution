...
trait AdditionsAssignee extends StObject {
  ...
  /** User */
  var merged_by: js.UndefOr[Deleted | Null] = js.undefined
  ...
  var requested_reviewers: js.Array[OneOf[js.Tuple2[Deleted | Null, MembersurlName]]]
...
object AdditionsAssignee {
  ...
  inline def apply(
    ...
    number: Double,
    patch_url: String,
    requested_reviewers: js.Array[OneOf[js.Tuple2[Deleted | Null, MembersurlName]]],
    ...
    __obj.asInstanceOf[AdditionsAssignee]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AdditionsAssignee] (val x: Self) extends AnyVal {
    ...
    inline def setMerged_by(value: Deleted): Self = StObject.set(x, "merged_by", value.asInstanceOf[js.Any])
    ...
    inline def setRequested_reviewers(value: js.Array[OneOf[js.Tuple2[Deleted | Null, MembersurlName]]]): Self = StObject.set(x, "requested_reviewers", value.asInstanceOf[js.Any])
    
    inline def setRequested_reviewersVarargs(value: (OneOf[js.Tuple2[Deleted | Null, MembersurlName]])*): Self = StObject.set(x, "requested_reviewers", js.Array(value*))
