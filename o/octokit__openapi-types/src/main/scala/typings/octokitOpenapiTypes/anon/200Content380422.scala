...
trait `200Content380422` extends StObject {
...
object `200Content380422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content380422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content380422`] (val x: Self) extends AnyVal {
