...
object Responses200Content535 {
  ...
  inline def apply(parameters: PathOwnerString, responses: `200Content535`): Responses200Content535 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content535]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content535] (val x: Self) extends AnyVal {
