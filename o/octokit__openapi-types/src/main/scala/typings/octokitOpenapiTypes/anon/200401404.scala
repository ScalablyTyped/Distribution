...
object `200401404` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200401404`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content50): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
