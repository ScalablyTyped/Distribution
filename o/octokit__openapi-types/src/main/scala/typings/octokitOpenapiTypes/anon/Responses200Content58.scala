...
object Responses200Content58 {
  ...
  inline def apply(parameters: `47`, responses: `200Content58`): Responses200Content58 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content58]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content58] (val x: Self) extends AnyVal {
