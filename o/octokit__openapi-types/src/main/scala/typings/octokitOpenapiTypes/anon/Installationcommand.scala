...
trait Installationcommand extends StObject {
  
  var author: js.UndefOr[Receivedeventsurl] = js.undefined
  
  var body: js.UndefOr[String | (Record[String, scala.Nothing])] = js.undefined
  
  var body_html: js.UndefOr[String] = js.undefined
  
  var container_metadata: js.UndefOr[Manifest] = js.undefined
  ...
  var release: js.UndefOr[Tagname] = js.undefined
...
object Installationcommand {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Installationcommand]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Installationcommand] (val x: Self) extends AnyVal {
    ...
    inline def setNpm_metadata(value: Bugs): Self = StObject.set(x, "npm_metadata", value.asInstanceOf[js.Any])
    ...
    inline def setRelease(value: Tagname): Self = StObject.set(x, "release", value.asInstanceOf[js.Any])
