...
trait PerformedviagithubappRename extends StObject {
...
object PerformedviagithubappRename {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[PerformedviagithubappRename]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PerformedviagithubappRename] (val x: Self) extends AnyVal {
