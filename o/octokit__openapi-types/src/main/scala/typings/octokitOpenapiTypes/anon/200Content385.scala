...
trait `200Content385` extends StObject {
...
object `200Content385` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content385`]
  }
  
  extension [Self <: `200Content385`](x: Self) {
    
    inline def set200(value: Content385): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
