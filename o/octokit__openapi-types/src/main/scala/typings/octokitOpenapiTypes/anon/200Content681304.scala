...
trait `200Content681304` extends StObject {
...
object `200Content681304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content681304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content681304`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content681): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
