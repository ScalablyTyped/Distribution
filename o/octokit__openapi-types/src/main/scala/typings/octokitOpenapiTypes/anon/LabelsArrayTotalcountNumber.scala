...
trait LabelsArrayTotalcountNumber extends StObject {
...
object LabelsArrayTotalcountNumber {
  ...
  inline def apply(
    ...
    total_count: Double
  ): LabelsArrayTotalcountNumber = {
    val __obj = js.Dynamic.literal(labels = labels.asInstanceOf[js.Any], total_count = total_count.asInstanceOf[js.Any])
    __obj.asInstanceOf[LabelsArrayTotalcountNumber]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LabelsArrayTotalcountNumber] (val x: Self) extends AnyVal {
