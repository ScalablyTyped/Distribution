...
trait `200Content265` extends StObject {
...
object `200Content265` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content265`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content265`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content265): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
