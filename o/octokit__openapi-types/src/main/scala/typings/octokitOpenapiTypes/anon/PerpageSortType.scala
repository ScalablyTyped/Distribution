...
trait PerpageSortType extends StObject {
...
object PerpageSortType {
  
  inline def apply(): PerpageSortType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PerpageSortType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PerpageSortType] (val x: Self) extends AnyVal {
