...
trait GetResponses200Content91403 extends StObject {
  
  /** Lists all teams in an organization that are visible to the authenticated user. */
  var get: Responses200Content91403
...
object GetResponses200Content91403 {
  
  inline def apply(get: Responses200Content91403, post: RequestBodyContentApplicationjsonMaintainers): GetResponses200Content91403 = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content91403]
  }
  
  extension [Self <: GetResponses200Content91403](x: Self) {
    
    inline def setGet(value: Responses200Content91403): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
