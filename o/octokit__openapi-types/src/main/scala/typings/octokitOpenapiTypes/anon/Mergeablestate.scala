...
trait Mergeablestate extends StObject {
...
object Mergeablestate {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Mergeablestate]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Mergeablestate] (val x: Self) extends AnyVal {
    ...
    inline def setBase(value: LabelRefRepoShaUser): Self = StObject.set(x, "base", value.asInstanceOf[js.Any])
