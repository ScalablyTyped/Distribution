...
trait `200Content177422` extends StObject {
...
object `200Content177422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content177422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content177422`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content177): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
