...
object `200Content584` {
  ...
  inline def apply(`200`: Content584, `304`: Any, `401`: Content48, `403`: Content48, `404`: Content48): `200Content584` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content584`] (val x: Self) extends AnyVal {
