...
trait `200Content356` extends StObject {
...
object `200Content356` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content356`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content356`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content356): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
