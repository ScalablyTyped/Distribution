...
trait `401Content36403ContentApplicationjsonErrors` extends StObject {
...
object `401Content36403ContentApplicationjsonErrors` {
  ...
  inline def apply(
    ...
    `404`: Content36
  ): `401Content36403ContentApplicationjsonErrors` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("401")(`401`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`401Content36403ContentApplicationjsonErrors`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `401Content36403ContentApplicationjsonErrors`] (val x: Self) extends AnyVal {
