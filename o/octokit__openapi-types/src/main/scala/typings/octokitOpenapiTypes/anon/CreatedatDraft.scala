...
trait CreatedatDraft extends StObject {
...
object CreatedatDraft {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CreatedatDraft]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreatedatDraft] (val x: Self) extends AnyVal {
