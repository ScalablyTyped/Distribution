...
trait `200Content349Headers24` extends StObject {
  
  /** Response */
  var `200`: Content349Headers24
...
object `200Content349Headers24` {
  
  inline def apply(
    `200`: Content349Headers24,
  ...
  ): `200Content349Headers24` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200Content349Headers24`]
  }
  
  extension [Self <: `200Content349Headers24`](x: Self) {
    
    inline def set200(value: Content349Headers24): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
