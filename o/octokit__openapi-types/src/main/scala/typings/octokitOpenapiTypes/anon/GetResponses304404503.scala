...
object GetResponses304404503 {
  ...
  inline def apply(get: Responses304404503, patch: RequestBodyContentApplicationjsonResolutioncomment): GetResponses304404503 = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses304404503] (val x: Self) extends AnyVal {
