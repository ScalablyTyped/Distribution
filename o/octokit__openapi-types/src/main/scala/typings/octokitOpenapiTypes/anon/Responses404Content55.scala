...
trait Responses404Content55 extends StObject {
  
  var parameters: PathInstallationidNumber
  
  var responses: `404Content55`
}
object Responses404Content55 {
  
  inline def apply(parameters: PathInstallationidNumber, responses: `404Content55`): Responses404Content55 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses404Content55]
  }
  
  extension [Self <: Responses404Content55](x: Self) {
