...
object GetResponses404Unknown {
  ...
  inline def apply(delete: ParametersPathUsernameResponses, get: Responses404Unknown, put: Responses92): GetResponses404Unknown = {
  ...
  extension [Self <: GetResponses404Unknown](x: Self) {
    ...
    inline def setPut(value: Responses92): Self = StObject.set(x, "put", value.asInstanceOf[js.Any])
  }
}
