...
trait Transientenvironment extends StObject {
  ...
  var payload: String | (Record[String, scala.Nothing])
  
  /**
    * App
    * @description GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
    */
  var performed_via_github_app: js.UndefOr[NodeidOwner | Null] = js.undefined
...
object Transientenvironment {
  ...
  inline def apply(
    ...
    payload: String | (Record[String, scala.Nothing]),
    ref: String,
    ...
    __obj.asInstanceOf[Transientenvironment]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Transientenvironment] (val x: Self) extends AnyVal {
    ...
    inline def setPayload(value: String | (Record[String, scala.Nothing])): Self = StObject.set(x, "payload", value.asInstanceOf[js.Any])
    
    inline def setPerformed_via_github_app(value: NodeidOwner): Self = StObject.set(x, "performed_via_github_app", value.asInstanceOf[js.Any])
