...
trait `200Content380403` extends StObject {
...
object `200Content380403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content380403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content380403`] (val x: Self) extends AnyVal {
