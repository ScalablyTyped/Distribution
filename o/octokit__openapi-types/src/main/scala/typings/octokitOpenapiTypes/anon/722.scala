...
object `722` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `722`] (val x: Self) extends AnyVal {
    ...
    inline def setApplicationSlashjsonVarargs(
      value: (/* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['labeled-issue-event'] */ js.Any)*
