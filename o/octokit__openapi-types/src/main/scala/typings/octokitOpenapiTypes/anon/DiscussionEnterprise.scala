...
trait DiscussionEnterprise extends StObject {
...
object DiscussionEnterprise {
  ...
  inline def apply(
    ...
    sender: Avatarurl
  ): DiscussionEnterprise = {
    val __obj = js.Dynamic.literal(action = "deleted", comment = comment.asInstanceOf[js.Any], discussion = discussion.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[DiscussionEnterprise]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DiscussionEnterprise] (val x: Self) extends AnyVal {
