...
trait `201Content537` extends StObject {
...
object `201Content537` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content537`]
  }
  
  extension [Self <: `201Content537`](x: Self) {
    
    inline def set201(value: Content537): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
