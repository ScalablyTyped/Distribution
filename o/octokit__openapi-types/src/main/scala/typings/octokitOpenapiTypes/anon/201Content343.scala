...
trait `201Content343` extends StObject {
...
object `201Content343` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content343`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content343`] (val x: Self) extends AnyVal {
