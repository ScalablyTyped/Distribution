...
trait `201Content463` extends StObject {
...
object `201Content463` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content463`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content463`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content463): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
