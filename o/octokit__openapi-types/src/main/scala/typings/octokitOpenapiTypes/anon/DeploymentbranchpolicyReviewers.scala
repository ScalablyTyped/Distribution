...
trait DeploymentbranchpolicyReviewers extends StObject {
  ...
  var reviewers: js.UndefOr[js.Array[`494`] | Null] = js.undefined
...
object DeploymentbranchpolicyReviewers {
  ...
  extension [Self <: DeploymentbranchpolicyReviewers](x: Self) {
    ...
    inline def setReviewers(value: js.Array[`494`]): Self = StObject.set(x, "reviewers", value.asInstanceOf[js.Any])
    ...
    inline def setReviewersVarargs(value: `494`*): Self = StObject.set(x, "reviewers", js.Array(value*))
