...
import typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.suspend
import typings.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait RepositoryRequester extends StObject {
...
object RepositoryRequester {
  
  inline def apply(installation: Contactemail, sender: Avatarurl): RepositoryRequester = {
    val __obj = js.Dynamic.literal(action = "suspend", installation = installation.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[RepositoryRequester]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RepositoryRequester] (val x: Self) extends AnyVal {
    
    inline def setAction(value: suspend): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
