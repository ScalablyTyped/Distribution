...
trait PackageversionidNumber extends StObject {
...
object PackageversionidNumber {
  
  inline def apply(
    package_name: String,
    package_type: npm | maven | rubygems | docker | nuget | container,
    package_version_id: Double
  ): PackageversionidNumber = {
    ...
    __obj.asInstanceOf[PackageversionidNumber]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PackageversionidNumber] (val x: Self) extends AnyVal {
