...
trait GetParametersPathDiscussionnumberQueryContentPage extends StObject {
  ...
  /**
    ...
    */
  var post: Responses200Content113
}
object GetParametersPathDiscussionnumberQueryContentPage {
  
  inline def apply(get: ParametersPathDiscussionnumberQueryContentPage, post: Responses200Content113): GetParametersPathDiscussionnumberQueryContentPage = {
  ...
  extension [Self <: GetParametersPathDiscussionnumberQueryContentPage](x: Self) {
    ...
    inline def setPost(value: Responses200Content113): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
