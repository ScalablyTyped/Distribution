...
trait DraftEventsurl extends StObject {
...
object DraftEventsurl {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[DraftEventsurl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DraftEventsurl] (val x: Self) extends AnyVal {
