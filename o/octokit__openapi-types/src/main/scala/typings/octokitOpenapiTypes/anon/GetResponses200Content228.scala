...
trait GetResponses200Content228 extends StObject {
  ...
  /**
    ...
    */
  var get: Responses200Content228
...
object GetResponses200Content228 {
  
  inline def apply(
    delete: ParametersPathRepoSecretnameResponses,
    get: Responses200Content228,
    put: RequestBodyContentApplicationjson163
  ): GetResponses200Content228 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content228]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses200Content228] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathRepoSecretnameResponses): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
    
    inline def setGet(value: Responses200Content228): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
