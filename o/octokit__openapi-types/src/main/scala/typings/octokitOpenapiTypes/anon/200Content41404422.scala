...
trait `200Content41404422` extends StObject {
...
object `200Content41404422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content41404422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content41404422`] (val x: Self) extends AnyVal {
