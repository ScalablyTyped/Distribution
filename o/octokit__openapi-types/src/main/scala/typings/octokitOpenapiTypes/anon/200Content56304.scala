...
trait `200Content56304` extends StObject {
...
object `200Content56304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content56304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content56304`] (val x: Self) extends AnyVal {
