...
trait `201Content257` extends StObject {
...
object `201Content257` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content257`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content257`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content257): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
