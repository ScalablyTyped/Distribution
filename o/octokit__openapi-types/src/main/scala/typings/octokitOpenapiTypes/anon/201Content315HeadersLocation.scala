...
trait `201Content315HeadersLocation` extends StObject {
...
object `201Content315HeadersLocation` {
  ...
  ): `201Content315HeadersLocation` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("201")(`201`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`201Content315HeadersLocation`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content315HeadersLocation`] (val x: Self) extends AnyVal {
