...
object RequestBodyContentApplicationjsonAssigneesArray {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestBodyContentApplicationjsonAssigneesArray] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200260`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
