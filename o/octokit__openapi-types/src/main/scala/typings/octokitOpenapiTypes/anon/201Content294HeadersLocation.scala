...
trait `201Content294HeadersLocation` extends StObject {
  
  /** @description Response */
  var `201`: Content294HeadersLocation
...
object `201Content294HeadersLocation` {
  
  inline def apply(
    `201`: Content294HeadersLocation,
  ...
  ): `201Content294HeadersLocation` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("201")(`201`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`201Content294HeadersLocation`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content294HeadersLocation`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content294HeadersLocation): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
