...
trait `403Content41404ContentApplicationjsonDocumentationurlMessage` extends StObject {
...
object `403Content41404ContentApplicationjsonDocumentationurlMessage` {
  ...
  ): `403Content41404ContentApplicationjsonDocumentationurlMessage` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("401")(`401`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`403Content41404ContentApplicationjsonDocumentationurlMessage`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `403Content41404ContentApplicationjsonDocumentationurlMessage`] (val x: Self) extends AnyVal {
