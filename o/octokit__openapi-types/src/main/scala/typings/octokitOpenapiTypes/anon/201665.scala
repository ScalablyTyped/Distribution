...
object `201665` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201665`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201665`] (val x: Self) extends AnyVal {
    
    inline def set201(value: `665`): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
