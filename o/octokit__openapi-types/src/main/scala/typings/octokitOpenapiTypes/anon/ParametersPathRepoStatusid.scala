...
trait ParametersPathRepoStatusid extends StObject {
  ...
  var responses: `200694`
}
object ParametersPathRepoStatusid {
  
  inline def apply(parameters: PathRepoStatusid, responses: `200694`): ParametersPathRepoStatusid = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathRepoStatusid] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200694`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
