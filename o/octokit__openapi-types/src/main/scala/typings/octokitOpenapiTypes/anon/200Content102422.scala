...
trait `200Content102422` extends StObject {
...
object `200Content102422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content102422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content102422`] (val x: Self) extends AnyVal {
