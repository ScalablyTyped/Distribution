...
trait `200Content658` extends StObject {
...
object `200Content658` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content658`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content658`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content658): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
