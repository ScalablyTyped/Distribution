...
trait `200621404Content36` extends StObject {
...
object `200621404Content36` {
  
  inline def apply(`200`: `621`, `404`: Content36): `200621404Content36` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200621404Content36`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200621404Content36`] (val x: Self) extends AnyVal {
