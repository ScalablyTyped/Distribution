...
trait `200Content336404` extends StObject {
...
object `200Content336404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content336404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content336404`] (val x: Self) extends AnyVal {
