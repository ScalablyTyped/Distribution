...
trait `403404Content41` extends StObject {
...
object `403404Content41` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`403404Content41`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `403404Content41`] (val x: Self) extends AnyVal {
