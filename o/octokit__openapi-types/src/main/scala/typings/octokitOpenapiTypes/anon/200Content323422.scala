...
trait `200Content323422` extends StObject {
...
object `200Content323422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content323422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content323422`] (val x: Self) extends AnyVal {
