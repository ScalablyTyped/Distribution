...
object `200ContentApplicationjsonStatusesurl` {
  ...
  inline def apply(`200`: ContentApplicationjsonStatusesurl, `404`: Content55): `200ContentApplicationjsonStatusesurl` = {
  ...
  extension [Self <: `200ContentApplicationjsonStatusesurl`](x: Self) {
