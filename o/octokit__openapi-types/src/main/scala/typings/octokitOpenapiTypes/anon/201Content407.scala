...
trait `201Content407` extends StObject {
...
object `201Content407` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content407`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content407`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content407): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
