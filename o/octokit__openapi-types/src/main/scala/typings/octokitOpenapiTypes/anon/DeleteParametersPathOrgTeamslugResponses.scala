...
trait DeleteParametersPathOrgTeamslugResponses extends StObject {
  ...
  /**
    ...
    */
  var delete: ParametersPathOrgTeamslugResponses
...
object DeleteParametersPathOrgTeamslugResponses {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPathOrgTeamslugResponses] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathOrgTeamslugResponses): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
