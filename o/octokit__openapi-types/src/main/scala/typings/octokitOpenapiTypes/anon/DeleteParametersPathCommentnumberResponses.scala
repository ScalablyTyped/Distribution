...
trait DeleteParametersPathCommentnumberResponses extends StObject {
  ...
  /**
    ...
    */
  var patch: Responses200Content118
}
object DeleteParametersPathCommentnumberResponses {
  ...
  extension [Self <: DeleteParametersPathCommentnumberResponses](x: Self) {
    ...
    inline def setPatch(value: Responses200Content118): Self = StObject.set(x, "patch", value.asInstanceOf[js.Any])
  }
}
