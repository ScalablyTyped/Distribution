...
trait GetParametersPathCheckrunid extends StObject {
  ...
  /**
    ...
    */
  var patch: RequestBodyContent183
}
object GetParametersPathCheckrunid {
  
  inline def apply(get: ParametersPathCheckrunid, patch: RequestBodyContent183): GetParametersPathCheckrunid = {
  ...
  extension [Self <: GetParametersPathCheckrunid](x: Self) {
    
    inline def setGet(value: ParametersPathCheckrunid): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setPatch(value: RequestBodyContent183): Self = StObject.set(x, "patch", value.asInstanceOf[js.Any])
  }
}
