...
trait `200Content390` extends StObject {
...
object `200Content390` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content390`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content390`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content390): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
