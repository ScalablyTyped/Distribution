...
object `200Content423` {
  ...
  inline def apply(`200`: Content423, `304`: Any, `403`: Content48, `404`: Content48): `200Content423` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content423`] (val x: Self) extends AnyVal {
