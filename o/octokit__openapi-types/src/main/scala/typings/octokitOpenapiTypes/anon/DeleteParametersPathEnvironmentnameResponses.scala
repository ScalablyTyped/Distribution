...
object DeleteParametersPathEnvironmentnameResponses {
  ...
  extension [Self <: DeleteParametersPathEnvironmentnameResponses](x: Self) {
    ...
    inline def setPut(value: RequestBodyContent232): Self = StObject.set(x, "put", value.asInstanceOf[js.Any])
  }
}
