...
trait CommentIssue extends StObject {
...
object CommentIssue {
  ...
  inline def apply(): CommentIssue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CommentIssue]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommentIssue] (val x: Self) extends AnyVal {
