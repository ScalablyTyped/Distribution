...
trait `200Content325403` extends StObject {
...
object `200Content325403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content325403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content325403`] (val x: Self) extends AnyVal {
