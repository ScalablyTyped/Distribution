...
trait `200Content508Headers25` extends StObject {
  
  /** @description Response */
  var `200`: Content508Headers25
...
object `200Content508Headers25` {
  
  inline def apply(
    `200`: Content508Headers25,
  ...
  ): `200Content508Headers25` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200Content508Headers25`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content508Headers25`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content508Headers25): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
