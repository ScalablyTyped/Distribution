...
trait `200Content371` extends StObject {
...
object `200Content371` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content371`]
  }
  
  extension [Self <: `200Content371`](x: Self) {
    
    inline def set200(value: Content371): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
