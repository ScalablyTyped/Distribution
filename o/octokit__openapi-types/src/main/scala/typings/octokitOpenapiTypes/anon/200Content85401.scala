...
trait `200Content85401` extends StObject {
...
object `200Content85401` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content85401`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content85401`] (val x: Self) extends AnyVal {
