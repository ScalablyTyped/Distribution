...
trait `200Content796` extends StObject {
...
object `200Content796` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content796`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content796`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content796): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
