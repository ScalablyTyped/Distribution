...
trait ParametersPathStatusid extends StObject {
  ...
  var responses: `200230`
}
object ParametersPathStatusid {
  
  inline def apply(parameters: PathStatusid, responses: `200230`): ParametersPathStatusid = {
  ...
  extension [Self <: ParametersPathStatusid](x: Self) {
    ...
    inline def setResponses(value: `200230`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
