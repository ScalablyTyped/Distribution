...
trait Actionsrunnerjitconfig extends StObject {
  
  /** @description Accepted */
  var accepted: ContentApplicationjsonRecord
  
  /** @description Response */
  var actions_runner_jitconfig: ContentApplicationjsonEncodedjitconfig
...
object Actionsrunnerjitconfig {
  
  inline def apply(
    accepted: ContentApplicationjsonRecord,
    actions_runner_jitconfig: ContentApplicationjsonEncodedjitconfig,
    ...
    __obj.asInstanceOf[Actionsrunnerjitconfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Actionsrunnerjitconfig] (val x: Self) extends AnyVal {
    
    inline def setAccepted(value: ContentApplicationjsonRecord): Self = StObject.set(x, "accepted", value.asInstanceOf[js.Any])
    
    inline def setActions_runner_jitconfig(value: ContentApplicationjsonEncodedjitconfig): Self = StObject.set(x, "actions_runner_jitconfig", value.asInstanceOf[js.Any])
