...
object Responses200Content431 {
  ...
  inline def apply(parameters: `165`, responses: `200Content431`): Responses200Content431 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content431]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content431] (val x: Self) extends AnyVal {
