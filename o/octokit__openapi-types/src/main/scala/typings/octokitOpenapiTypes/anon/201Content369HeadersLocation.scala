...
trait `201Content369HeadersLocation` extends StObject {
...
object `201Content369HeadersLocation` {
  ...
  ): `201Content369HeadersLocation` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("201")(`201`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`201Content369HeadersLocation`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content369HeadersLocation`] (val x: Self) extends AnyVal {
