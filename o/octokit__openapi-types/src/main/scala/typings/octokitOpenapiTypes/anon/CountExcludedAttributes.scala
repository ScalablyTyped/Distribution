...
trait CountExcludedAttributes extends StObject {
...
object CountExcludedAttributes {
  
  inline def apply(): CountExcludedAttributes = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CountExcludedAttributes]
  }
  
  extension [Self <: CountExcludedAttributes](x: Self) {
