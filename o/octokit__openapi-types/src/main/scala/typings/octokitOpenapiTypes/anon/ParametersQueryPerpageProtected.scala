...
object ParametersQueryPerpageProtected {
  ...
  inline def apply(parameters: QueryPerpageProtected, responses: `200Content556`): ParametersQueryPerpageProtected = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[ParametersQueryPerpageProtected]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ParametersQueryPerpageProtected] (val x: Self) extends AnyVal {
