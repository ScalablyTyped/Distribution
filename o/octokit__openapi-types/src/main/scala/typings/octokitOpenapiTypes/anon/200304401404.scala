...
object `200304401404` {
  ...
  inline def apply(`200`: Content585, `304`: Any, `401`: Content48, `404`: Content48): `200304401404` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200304401404`] (val x: Self) extends AnyVal {
