...
trait RepoRulesetid extends StObject {
...
object RepoRulesetid {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[RepoRulesetid]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RepoRulesetid] (val x: Self) extends AnyVal {
