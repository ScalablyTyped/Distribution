...
object PostRequestBodyContentApplicationjsonEmail {
  ...
  inline def apply(get: Responses200Content81, post: RequestBodyContentApplicationjsonEmail): PostRequestBodyContentApplicationjsonEmail = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[PostRequestBodyContentApplicationjsonEmail]
  }
  
  extension [Self <: PostRequestBodyContentApplicationjsonEmail](x: Self) {
