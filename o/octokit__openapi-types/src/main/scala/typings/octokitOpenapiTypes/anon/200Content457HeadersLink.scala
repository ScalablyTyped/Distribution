...
trait `200Content457HeadersLink` extends StObject {
  
  /** @description Response */
  var `200`: Content457HeadersLink
...
object `200Content457HeadersLink` {
  
  inline def apply(
    `200`: Content457HeadersLink,
    ...
    __obj.asInstanceOf[`200Content457HeadersLink`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content457HeadersLink`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content457HeadersLink): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
