...
trait `201Content390` extends StObject {
...
object `201Content390` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content390`]
  }
  
  extension [Self <: `201Content390`](x: Self) {
    
    inline def set201(value: Content390): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
