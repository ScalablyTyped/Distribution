...
trait GetParametersPathDiscussionnumberTeamidQueryContentPage extends StObject {
  ...
  /**
    ...
    */
  var post: ParametersPathDiscussionnumberTeamidRequestBodyContentApplicationjson121
}
object GetParametersPathDiscussionnumberTeamidQueryContentPage {
  
  inline def apply(
    get: ParametersPathDiscussionnumberTeamidQueryContentPage,
    post: ParametersPathDiscussionnumberTeamidRequestBodyContentApplicationjson121
  ...
  extension [Self <: GetParametersPathDiscussionnumberTeamidQueryContentPage](x: Self) {
    ...
    inline def setPost(value: ParametersPathDiscussionnumberTeamidRequestBodyContentApplicationjson121): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
