...
object `200410` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200410`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content262): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
