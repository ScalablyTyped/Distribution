...
object ParametersPathDiscussionnumberTeamidQueryDirectionPage {
  ...
  inline def apply(parameters: PathDiscussionnumberTeamidQueryDirectionPage, responses: `200Content117`): ParametersPathDiscussionnumberTeamidQueryDirectionPage = {
