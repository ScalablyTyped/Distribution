...
trait LastreadatRead extends StObject {
...
object LastreadatRead {
  
  inline def apply(): LastreadatRead = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LastreadatRead]
  }
  
  extension [Self <: LastreadatRead](x: Self) {
