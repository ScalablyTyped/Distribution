...
trait `200Content108304` extends StObject {
...
object `200Content108304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content108304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content108304`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content108): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
