...
object Responses200Content131 {
  ...
  inline def apply(parameters: `55`, responses: `200Content131`): Responses200Content131 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content131]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content131] (val x: Self) extends AnyVal {
