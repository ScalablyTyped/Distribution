...
trait `200Content126` extends StObject {
...
object `200Content126` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content126`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content126`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content126): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
