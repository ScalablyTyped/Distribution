...
trait `200Content288` extends StObject {
...
object `200Content288` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content288`]
  }
  
  extension [Self <: `200Content288`](x: Self) {
    
    inline def set200(value: Content288): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
