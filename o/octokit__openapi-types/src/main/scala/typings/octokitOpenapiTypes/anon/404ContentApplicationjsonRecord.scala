...
trait `404ContentApplicationjsonRecord` extends StObject {
  ...
  var `404`: ContentApplicationjsonRecord
}
object `404ContentApplicationjsonRecord` {
  ...
  inline def apply(
    ...
    `404`: ContentApplicationjsonRecord
  ): `404ContentApplicationjsonRecord` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`404ContentApplicationjsonRecord`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `404ContentApplicationjsonRecord`] (val x: Self) extends AnyVal {
    ...
    inline def set404(value: ContentApplicationjsonRecord): Self = StObject.set(x, "404", value.asInstanceOf[js.Any])
  }
}
