...
trait `200Content48304` extends StObject {
...
object `200Content48304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content48304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content48304`] (val x: Self) extends AnyVal {
