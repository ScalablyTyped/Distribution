...
trait `201Content279` extends StObject {
...
object `201Content279` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content279`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content279`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content279): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
