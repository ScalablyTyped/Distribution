...
trait `401403ContentApplicationjsonDocumentationurlErrors` extends StObject {
...
object `401403ContentApplicationjsonDocumentationurlErrors` {
  ...
  ): `401403ContentApplicationjsonDocumentationurlErrors` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("401")(`401`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`401403ContentApplicationjsonDocumentationurlErrors`]
  }
  
  extension [Self <: `401403ContentApplicationjsonDocumentationurlErrors`](x: Self) {
