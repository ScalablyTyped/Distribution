...
trait Anonymousaccessenabled extends StObject {
  ...
  var parent: js.UndefOr[Allowupdatebranch] = js.undefined
  ...
  var source: js.UndefOr[Allowupdatebranch] = js.undefined
...
object Anonymousaccessenabled {
  ...
  implicit open class MutableBuilder[Self <: Anonymousaccessenabled] (val x: Self) extends AnyVal {
    ...
    inline def setParent(value: Allowupdatebranch): Self = StObject.set(x, "parent", value.asInstanceOf[js.Any])
    ...
    inline def setSource(value: Allowupdatebranch): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
