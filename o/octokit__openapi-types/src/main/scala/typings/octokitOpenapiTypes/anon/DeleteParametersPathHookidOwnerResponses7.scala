...
trait DeleteParametersPathHookidOwnerResponses7 extends StObject {
  
  /** Delete a repository webhook */
  var delete: ParametersPathHookidOwnerResponses7
...
object DeleteParametersPathHookidOwnerResponses7 {
  
  inline def apply(
    delete: ParametersPathHookidOwnerResponses7,
    get: ParametersPathHookidOwner,
    patch: RequestBodyContentApplicationjsonAddevents
  ): DeleteParametersPathHookidOwnerResponses7 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], patch = patch.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathHookidOwnerResponses7]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPathHookidOwnerResponses7] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathHookidOwnerResponses7): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
