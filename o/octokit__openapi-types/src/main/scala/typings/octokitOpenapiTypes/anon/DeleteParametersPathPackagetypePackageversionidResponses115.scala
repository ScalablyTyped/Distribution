...
trait DeleteParametersPathPackagetypePackageversionidResponses115 extends StObject {
  ...
  /**
    ...
    */
  var delete: ParametersPathPackagetypePackageversionidResponses115
...
object DeleteParametersPathPackagetypePackageversionidResponses115 {
  
  inline def apply(
    delete: ParametersPathPackagetypePackageversionidResponses115,
    get: ParametersPathPackagetypePackageversionid
  ): DeleteParametersPathPackagetypePackageversionidResponses115 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathPackagetypePackageversionidResponses115]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPathPackagetypePackageversionidResponses115] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathPackagetypePackageversionidResponses115): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
