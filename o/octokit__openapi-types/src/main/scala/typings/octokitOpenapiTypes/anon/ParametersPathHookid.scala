...
object ParametersPathHookid {
  ...
  inline def apply(parameters: PathHookid, responses: `20085`): ParametersPathHookid = {
  ...
  extension [Self <: ParametersPathHookid](x: Self) {
    ...
    inline def setResponses(value: `20085`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
