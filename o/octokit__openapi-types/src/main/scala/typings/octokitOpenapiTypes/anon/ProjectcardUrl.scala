...
trait ProjectcardUrl extends StObject {
...
object ProjectcardUrl {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ProjectcardUrl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ProjectcardUrl] (val x: Self) extends AnyVal {
