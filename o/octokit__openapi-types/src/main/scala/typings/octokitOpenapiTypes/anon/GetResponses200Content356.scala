...
object GetResponses200Content356 {
  ...
  inline def apply(get: Responses200Content356, post: RequestBodyContentApplicationjsonPattern): GetResponses200Content356 = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content356]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses200Content356] (val x: Self) extends AnyVal {
