...
trait `200Content428404` extends StObject {
...
object `200Content428404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content428404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content428404`] (val x: Self) extends AnyVal {
