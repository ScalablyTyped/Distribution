...
object ParametersPathTeamidQueryDirectionPage {
  ...
  inline def apply(parameters: PathTeamidQueryDirectionPage, responses: `200Content108`): ParametersPathTeamidQueryDirectionPage = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[ParametersPathTeamidQueryDirectionPage]
  }
  
  extension [Self <: ParametersPathTeamidQueryDirectionPage](x: Self) {
