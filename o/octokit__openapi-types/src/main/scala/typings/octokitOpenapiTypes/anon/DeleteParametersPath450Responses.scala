...
trait DeleteParametersPath450Responses extends StObject {
  ...
  /**
    ...
    */
  var delete: ParametersPath450Responses
...
object DeleteParametersPath450Responses {
  
  inline def apply(
    delete: ParametersPath450Responses,
    get: ParametersPath450,
    put: RequestBodyContentApplicationjsonKeyidSelectedrepositoryids
  ): DeleteParametersPath450Responses = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPath450Responses]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPath450Responses] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPath450Responses): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
    
    inline def setGet(value: ParametersPath450): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
