...
trait `200Content486` extends StObject {
...
object `200Content486` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content486`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content486`] (val x: Self) extends AnyVal {
