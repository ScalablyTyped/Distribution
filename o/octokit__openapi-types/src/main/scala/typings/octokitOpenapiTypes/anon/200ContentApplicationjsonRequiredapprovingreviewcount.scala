...
object `200ContentApplicationjsonRequiredapprovingreviewcount` {
  ...
  inline def apply(`200`: ContentApplicationjsonRequiredapprovingreviewcount, `301`: Content41, `404`: Content41): `200ContentApplicationjsonRequiredapprovingreviewcount` = {
