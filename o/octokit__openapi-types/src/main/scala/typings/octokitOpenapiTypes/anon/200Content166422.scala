...
trait `200Content166422` extends StObject {
...
object `200Content166422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content166422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content166422`] (val x: Self) extends AnyVal {
