...
trait `200Content765` extends StObject {
...
object `200Content765` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content765`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content765`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content765): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
