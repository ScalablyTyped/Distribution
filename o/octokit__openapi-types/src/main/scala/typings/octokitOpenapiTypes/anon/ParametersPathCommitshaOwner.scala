...
trait ParametersPathCommitshaOwner extends StObject {
  ...
  var responses: `200Content680`
}
object ParametersPathCommitshaOwner {
  
  inline def apply(parameters: PathCommitshaOwner, responses: `200Content680`): ParametersPathCommitshaOwner = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathCommitshaOwner] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200Content680`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
