...
trait `200Content37` extends StObject {
...
object `200Content37` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content37`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content37`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content37): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
