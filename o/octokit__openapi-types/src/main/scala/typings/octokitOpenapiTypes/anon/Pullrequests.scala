...
trait Pullrequests extends StObject {
...
object Pullrequests {
  ...
  inline def apply(): Pullrequests = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Pullrequests]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Pullrequests] (val x: Self) extends AnyVal {
