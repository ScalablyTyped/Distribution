...
trait `200ContentApplicationjson606` extends StObject {
  
  /** Response */
  var `200`: ContentApplicationjson606
...
object `200ContentApplicationjson606` {
  
  inline def apply(
    `200`: ContentApplicationjson606,
  ...
  ): `200ContentApplicationjson606` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.updateDynamic("503")(`503`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjson606`]
  }
  
  extension [Self <: `200ContentApplicationjson606`](x: Self) {
    
    inline def set200(value: ContentApplicationjson606): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
