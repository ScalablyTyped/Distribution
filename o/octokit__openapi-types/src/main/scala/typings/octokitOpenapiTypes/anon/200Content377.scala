...
trait `200Content377` extends StObject {
...
object `200Content377` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content377`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content377`] (val x: Self) extends AnyVal {
