...
trait CommentsComments extends StObject {
  ...
  /**
    ...
    */
  var performed_via_github_app: js.UndefOr[NameNodeidOwner | Null] = js.undefined
...
object CommentsComments {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CommentsComments]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommentsComments] (val x: Self) extends AnyVal {
    ...
    inline def setPerformed_via_github_app(value: NameNodeidOwner): Self = StObject.set(x, "performed_via_github_app", value.asInstanceOf[js.Any])
