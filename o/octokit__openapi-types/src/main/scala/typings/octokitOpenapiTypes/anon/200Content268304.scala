...
trait `200Content268304` extends StObject {
...
object `200Content268304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content268304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content268304`] (val x: Self) extends AnyVal {
