...
trait `200Content68422` extends StObject {
...
object `200Content68422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content68422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content68422`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content68): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
