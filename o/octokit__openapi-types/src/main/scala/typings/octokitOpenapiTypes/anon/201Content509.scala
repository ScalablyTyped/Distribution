...
trait `201Content509` extends StObject {
...
object `201Content509` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content509`]
  }
  
  extension [Self <: `201Content509`](x: Self) {
    
    inline def set201(value: Content509): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
