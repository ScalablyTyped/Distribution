...
trait ParametersQueryPerpageSinceSort extends StObject {
  ...
  var responses: `200Content547`
}
object ParametersQueryPerpageSinceSort {
  
  inline def apply(parameters: QueryPerpageSinceSort, responses: `200Content547`): ParametersQueryPerpageSinceSort = {
  ...
  extension [Self <: ParametersQueryPerpageSinceSort](x: Self) {
    ...
    inline def setResponses(value: `200Content547`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
