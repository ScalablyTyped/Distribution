...
trait `403ContentApplicationjsonDocumentationurl404` extends StObject {
...
object `403ContentApplicationjsonDocumentationurl404` {
  ...
  ): `403ContentApplicationjsonDocumentationurl404` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`403ContentApplicationjsonDocumentationurl404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `403ContentApplicationjsonDocumentationurl404`] (val x: Self) extends AnyVal {
