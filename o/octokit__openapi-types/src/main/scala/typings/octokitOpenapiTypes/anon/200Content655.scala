...
trait `200Content655` extends StObject {
...
object `200Content655` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content655`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content655`] (val x: Self) extends AnyVal {
