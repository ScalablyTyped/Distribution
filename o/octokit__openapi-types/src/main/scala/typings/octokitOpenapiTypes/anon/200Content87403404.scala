...
trait `200Content87403404` extends StObject {
...
object `200Content87403404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content87403404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content87403404`] (val x: Self) extends AnyVal {
