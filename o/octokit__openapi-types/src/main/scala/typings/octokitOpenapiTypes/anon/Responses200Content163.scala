...
object Responses200Content163 {
  ...
  inline def apply(parameters: PathBranch, responses: `200Content163`): Responses200Content163 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content163]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content163] (val x: Self) extends AnyVal {
