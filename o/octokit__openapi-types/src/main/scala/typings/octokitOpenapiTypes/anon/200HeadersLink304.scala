...
trait `200HeadersLink304` extends StObject {
...
object `200HeadersLink304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200HeadersLink304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200HeadersLink304`] (val x: Self) extends AnyVal {
