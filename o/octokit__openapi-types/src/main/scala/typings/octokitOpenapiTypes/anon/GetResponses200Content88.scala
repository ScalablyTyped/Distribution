...
trait GetResponses200Content88 extends StObject {
...
object GetResponses200Content88 {
  
  inline def apply(
    delete: ParametersPathSecretnameResponses,
    get: Responses200Content88,
    put: RequestBodyContentApplicationjsonEncryptedvalueKeyid
  ): GetResponses200Content88 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content88]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses200Content88] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathSecretnameResponses): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
    
    inline def setGet(value: Responses200Content88): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
