...
object `201ContentApplicationjsonMergeable` {
  ...
  inline def apply(`201`: ContentApplicationjsonMergeable, `403`: Content48, `422`: Content397): `201ContentApplicationjsonMergeable` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `201ContentApplicationjsonMergeable`] (val x: Self) extends AnyVal {
