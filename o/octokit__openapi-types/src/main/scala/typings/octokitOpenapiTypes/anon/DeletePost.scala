...
trait DeletePost extends StObject {
  ...
  var post: RequestBodyContentApplicationjson268
}
object DeletePost {
  
  inline def apply(
    delete: RequestBodyContentApplicationjsonAssigneesArray,
    post: RequestBodyContentApplicationjson268
  ): DeletePost = {
  ...
  extension [Self <: DeletePost](x: Self) {
    ...
    inline def setPost(value: RequestBodyContentApplicationjson268): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
