...
object Responses200Content110 {
  ...
  inline def apply(parameters: `47`, responses: `200Content110`): Responses200Content110 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content110]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content110] (val x: Self) extends AnyVal {
