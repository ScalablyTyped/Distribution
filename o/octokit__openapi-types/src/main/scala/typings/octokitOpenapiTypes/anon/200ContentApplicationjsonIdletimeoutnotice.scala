...
trait `200ContentApplicationjsonIdletimeoutnotice` extends StObject {
...
object `200ContentApplicationjsonIdletimeoutnotice` {
  ...
  inline def apply(
    ...
    `404`: Content41,
    `500`: Content41
  ): `200ContentApplicationjsonIdletimeoutnotice` = {
    ...
    __obj.asInstanceOf[`200ContentApplicationjsonIdletimeoutnotice`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonIdletimeoutnotice`] (val x: Self) extends AnyVal {
