...
trait `201Content249` extends StObject {
...
object `201Content249` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content249`]
  }
  
  extension [Self <: `201Content249`](x: Self) {
    
    inline def set201(value: Content249): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
