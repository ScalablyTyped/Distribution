...
trait ClosedatComments extends StObject {
  ...
  /**
    ...
    */
  var performed_via_github_app: js.UndefOr[ExternalurlHtmlurlId | Null] = js.undefined
...
object ClosedatComments {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ClosedatComments]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ClosedatComments] (val x: Self) extends AnyVal {
    ...
    inline def setPerformed_via_github_app(value: ExternalurlHtmlurlId): Self = StObject.set(x, "performed_via_github_app", value.asInstanceOf[js.Any])
