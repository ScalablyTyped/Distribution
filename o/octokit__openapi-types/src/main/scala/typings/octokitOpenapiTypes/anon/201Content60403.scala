...
trait `201Content60403` extends StObject {
...
object `201Content60403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content60403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content60403`] (val x: Self) extends AnyVal {
