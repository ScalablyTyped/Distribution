...
trait OrgidRunnergroupid extends StObject {
...
object OrgidRunnergroupid {
  
  inline def apply(enterprise: String, org_id: Double, runner_group_id: Double): OrgidRunnergroupid = {
    ...
    __obj.asInstanceOf[OrgidRunnergroupid]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OrgidRunnergroupid] (val x: Self) extends AnyVal {
