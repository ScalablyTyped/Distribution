...
trait DismissedbyDismissedcomment extends StObject {
...
object DismissedbyDismissedcomment {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[DismissedbyDismissedcomment]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DismissedbyDismissedcomment] (val x: Self) extends AnyVal {
