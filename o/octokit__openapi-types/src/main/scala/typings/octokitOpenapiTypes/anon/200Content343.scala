...
trait `200Content343` extends StObject {
...
object `200Content343` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content343`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content343`] (val x: Self) extends AnyVal {
