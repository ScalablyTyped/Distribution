...
trait EmailsExternalId extends StObject {
  
  var active: js.UndefOr[Boolean] = js.undefined
  
  var emails: js.UndefOr[js.Array[`415`]] = js.undefined
...
object EmailsExternalId {
  
  inline def apply(id: String, schemas: js.Array[String]): EmailsExternalId = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], schemas = schemas.asInstanceOf[js.Any])
    __obj.asInstanceOf[EmailsExternalId]
  }
  
  extension [Self <: EmailsExternalId](x: Self) {
    
    inline def setActive(value: Boolean): Self = StObject.set(x, "active", value.asInstanceOf[js.Any])
    
    inline def setActiveUndefined: Self = StObject.set(x, "active", js.undefined)
    
    inline def setEmails(value: js.Array[`415`]): Self = StObject.set(x, "emails", value.asInstanceOf[js.Any])
    
    inline def setEmailsUndefined: Self = StObject.set(x, "emails", js.undefined)
    
    inline def setEmailsVarargs(value: `415`*): Self = StObject.set(x, "emails", js.Array(value*))
