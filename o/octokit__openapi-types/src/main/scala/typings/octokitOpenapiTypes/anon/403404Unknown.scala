...
trait `403404Unknown` extends StObject {
...
object `403404Unknown` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`403404Unknown`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `403404Unknown`] (val x: Self) extends AnyVal {
