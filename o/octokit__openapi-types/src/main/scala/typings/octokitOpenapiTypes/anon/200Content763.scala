...
trait `200Content763` extends StObject {
...
object `200Content763` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content763`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content763`] (val x: Self) extends AnyVal {
