...
object GetResponses200Content87403 {
  
  inline def apply(get: Responses200Content87403, post: RequestBodyContentApplicationjsonMaintainers): GetResponses200Content87403 = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content87403]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses200Content87403] (val x: Self) extends AnyVal {
    
    inline def setGet(value: Responses200Content87403): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
