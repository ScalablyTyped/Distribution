...
object `403404409` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `403404409`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content230): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
