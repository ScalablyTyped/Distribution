...
trait AssigneesAuthorassociation extends StObject {
  ...
  /**
    ...
    */
  var performed_via_github_app: js.UndefOr[CreatedatDescriptionEvents | Null] = js.undefined
...
object AssigneesAuthorassociation {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[AssigneesAuthorassociation]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AssigneesAuthorassociation] (val x: Self) extends AnyVal {
    ...
    inline def setPerformed_via_github_app(value: CreatedatDescriptionEvents): Self = StObject.set(x, "performed_via_github_app", value.asInstanceOf[js.Any])
