...
object `201ContentApplicationjsonInreplytoidHeadersLocation` {
  ...
  inline def apply(`201`: ContentApplicationjsonInreplytoidHeadersLocation, `403`: Content41, `422`: Content414): `201ContentApplicationjsonInreplytoidHeadersLocation` = {
