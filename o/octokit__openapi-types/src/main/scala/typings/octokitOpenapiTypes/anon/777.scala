...
object `777` {
  ...
  inline def apply(incomplete_results: Boolean, items: js.Array[ScoreTextmatches], total_count: Double): `777` = {
    val __obj = js.Dynamic.literal(incomplete_results = incomplete_results.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any], total_count = total_count.asInstanceOf[js.Any])
    __obj.asInstanceOf[`777`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `777`] (val x: Self) extends AnyVal {
