...
trait CommentsurlCommitsurl extends StObject {
...
object CommentsurlCommitsurl {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CommentsurlCommitsurl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommentsurlCommitsurl] (val x: Self) extends AnyVal {
    ...
    inline def setHead(value: LabelRefString): Self = StObject.set(x, "head", value.asInstanceOf[js.Any])
