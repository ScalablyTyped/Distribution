...
trait `200Content430` extends StObject {
...
object `200Content430` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content430`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content430`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content430): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
