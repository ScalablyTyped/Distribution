...
trait RequestBodyContentApplicationjsonBodyEvent extends StObject {
  ...
  var responses: `200ContentApplicationjsonBodyBodyhtml403Content6`
}
object RequestBodyContentApplicationjsonBodyEvent {
  ...
  inline def apply(
    ...
    responses: `200ContentApplicationjsonBodyBodyhtml403Content6`
  ...
  extension [Self <: RequestBodyContentApplicationjsonBodyEvent](x: Self) {
    ...
    inline def setResponses(value: `200ContentApplicationjsonBodyBodyhtml403Content6`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
