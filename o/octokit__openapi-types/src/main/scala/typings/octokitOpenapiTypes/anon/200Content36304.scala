...
trait `200Content36304` extends StObject {
...
object `200Content36304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content36304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content36304`] (val x: Self) extends AnyVal {
