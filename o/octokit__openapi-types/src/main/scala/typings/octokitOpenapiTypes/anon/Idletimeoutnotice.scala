...
trait Idletimeoutnotice extends StObject {
...
object Idletimeoutnotice {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Idletimeoutnotice]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Idletimeoutnotice] (val x: Self) extends AnyVal {
