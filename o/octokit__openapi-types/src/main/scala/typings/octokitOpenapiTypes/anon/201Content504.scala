...
trait `201Content504` extends StObject {
...
object `201Content504` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content504`]
  }
  
  extension [Self <: `201Content504`](x: Self) {
    
    inline def set201(value: Content504): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
