...
trait `200Content243422` extends StObject {
...
object `200Content243422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content243422`]
  }
  
  extension [Self <: `200Content243422`](x: Self) {
    
    inline def set200(value: Content243): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
