...
trait `200Content32403` extends StObject {
...
object `200Content32403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content32403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content32403`] (val x: Self) extends AnyVal {
