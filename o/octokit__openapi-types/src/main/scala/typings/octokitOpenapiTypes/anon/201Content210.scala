...
trait `201Content210` extends StObject {
...
object `201Content210` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content210`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content210`] (val x: Self) extends AnyVal {
