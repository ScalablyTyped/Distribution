...
trait CommentDiscussion extends StObject {
...
object CommentDiscussion {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(action = "created", comment = comment.asInstanceOf[js.Any], discussion = discussion.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[CommentDiscussion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommentDiscussion] (val x: Self) extends AnyVal {
