...
trait RequestBodyContentApplicationjsonCommitid extends StObject {
  ...
  var responses: `201Content303HeadersLocation`
}
object RequestBodyContentApplicationjsonCommitid {
  ...
  inline def apply(
    ...
    responses: `201Content303HeadersLocation`
  ...
  extension [Self <: RequestBodyContentApplicationjsonCommitid](x: Self) {
    ...
    inline def setResponses(value: `201Content303HeadersLocation`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
