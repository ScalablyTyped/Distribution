...
object Responses200Content508 {
  ...
  inline def apply(parameters: PathOrgStringQuery473, responses: `200Content508`): Responses200Content508 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content508]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content508] (val x: Self) extends AnyVal {
