...
object `201ContentApplicationjsonReposcount` {
  ...
  inline def apply(`201`: ContentApplicationjsonReposcount, `403`: Content55, `422`: Content421): `201ContentApplicationjsonReposcount` = {
  ...
  extension [Self <: `201ContentApplicationjsonReposcount`](x: Self) {
