...
object RequestBodyContent21 {
  ...
  inline def apply(parameters: PathGistid, requestBody: Content21, responses: `404422`): RequestBodyContent21 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], requestBody = requestBody.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestBodyContent21]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestBodyContent21] (val x: Self) extends AnyVal {
