...
trait Secretscanning extends StObject {
  ...
  var advanced_security: js.UndefOr[`387`] = js.undefined
  
  var secret_scanning: js.UndefOr[`387`] = js.undefined
  
  var secret_scanning_push_protection: js.UndefOr[`387`] = js.undefined
}
object Secretscanning {
  ...
  implicit open class MutableBuilder[Self <: Secretscanning] (val x: Self) extends AnyVal {
    ...
    inline def setSecret_scanning(value: `387`): Self = StObject.set(x, "secret_scanning", value.asInstanceOf[js.Any])
    
    inline def setSecret_scanningUndefined: Self = StObject.set(x, "secret_scanning", js.undefined)
    
    inline def setSecret_scanning_push_protection(value: `387`): Self = StObject.set(x, "secret_scanning_push_protection", value.asInstanceOf[js.Any])
