...
object Responses200ContentApplicationjsonRepositoriesArray {
  ...
  inline def apply(parameters: PathOrgStringQuery, responses: `200ContentApplicationjsonRepositoriesArray`): Responses200ContentApplicationjsonRepositoriesArray = {
