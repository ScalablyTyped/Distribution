...
trait ParametersPathOwnerPullnumber extends StObject {
  ...
  var responses: `201Content303HeadersLocation404`
}
object ParametersPathOwnerPullnumber {
  ...
  inline def apply(
    ...
    responses: `201Content303HeadersLocation404`
  ...
  extension [Self <: ParametersPathOwnerPullnumber](x: Self) {
    ...
    inline def setResponses(value: `201Content303HeadersLocation404`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
