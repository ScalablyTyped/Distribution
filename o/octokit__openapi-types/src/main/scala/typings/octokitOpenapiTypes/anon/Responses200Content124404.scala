...
object Responses200Content124404 {
  ...
  inline def apply(parameters: PathTeamidQueryPage, responses: `200Content124404`): Responses200Content124404 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content124404]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content124404] (val x: Self) extends AnyVal {
