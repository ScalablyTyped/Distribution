...
trait Reviewcommenturl extends StObject {
...
object Reviewcommenturl {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Reviewcommenturl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Reviewcommenturl] (val x: Self) extends AnyVal {
