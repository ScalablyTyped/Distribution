...
trait Resolvedat extends StObject {
  ...
  var updated_at: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['nullable-alert-updated-at'] */ js.Any
  ] = js.undefined
...
object Resolvedat {
  ...
  inline def apply(): Resolvedat = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Resolvedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Resolvedat] (val x: Self) extends AnyVal {
    ...
    inline def setUpdated_at(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['nullable-alert-updated-at'] */ js.Any
