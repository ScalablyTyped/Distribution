...
trait Originalstartline extends StObject {
...
object Originalstartline {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Originalstartline]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Originalstartline] (val x: Self) extends AnyVal {
