...
trait Pushertype extends StObject {
...
object Pushertype {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(pusher_type = pusher_type.asInstanceOf[js.Any], ref = ref.asInstanceOf[js.Any], ref_type = ref_type.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[Pushertype]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Pushertype] (val x: Self) extends AnyVal {
