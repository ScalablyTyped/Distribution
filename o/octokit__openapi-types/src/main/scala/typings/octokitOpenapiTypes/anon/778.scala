...
object `778` {
  ...
  inline def apply(incomplete_results: Boolean, items: js.Array[Hasdiscussions], total_count: Double): `778` = {
    val __obj = js.Dynamic.literal(incomplete_results = incomplete_results.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any], total_count = total_count.asInstanceOf[js.Any])
    __obj.asInstanceOf[`778`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `778`] (val x: Self) extends AnyVal {
