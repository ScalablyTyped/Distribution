...
trait `200ContentApplicationjsonArchivedColumnname` extends StObject {
...
object `200ContentApplicationjsonArchivedColumnname` {
  ...
  inline def apply(
    ...
    `403`: Content41,
    `404`: Content41
  ): `200ContentApplicationjsonArchivedColumnname` = {
    ...
    __obj.asInstanceOf[`200ContentApplicationjsonArchivedColumnname`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonArchivedColumnname`] (val x: Self) extends AnyVal {
