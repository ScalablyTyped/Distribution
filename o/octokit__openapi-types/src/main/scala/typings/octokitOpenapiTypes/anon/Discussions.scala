...
trait Discussions extends StObject {
...
object Discussions {
  ...
  inline def apply(): Discussions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Discussions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Discussions] (val x: Self) extends AnyVal {
