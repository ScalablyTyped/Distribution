...
trait `200Content325404422` extends StObject {
...
object `200Content325404422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content325404422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content325404422`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content325): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
