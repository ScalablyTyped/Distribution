...
trait `200Content112404410` extends StObject {
...
object `200Content112404410` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content112404410`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content112404410`] (val x: Self) extends AnyVal {
