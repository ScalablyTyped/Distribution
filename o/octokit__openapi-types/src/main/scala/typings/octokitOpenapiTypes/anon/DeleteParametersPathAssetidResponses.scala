...
trait DeleteParametersPathAssetidResponses extends StObject {
  ...
  var patch: RequestBodyContentApplicationjsonLabel
}
object DeleteParametersPathAssetidResponses {
  
  inline def apply(
    delete: ParametersPathAssetidResponses,
    get: ParametersPathAssetid,
    patch: RequestBodyContentApplicationjsonLabel
  ): DeleteParametersPathAssetidResponses = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], patch = patch.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathAssetidResponses]
  }
  
  extension [Self <: DeleteParametersPathAssetidResponses](x: Self) {
    ...
    inline def setPatch(value: RequestBodyContentApplicationjsonLabel): Self = StObject.set(x, "patch", value.asInstanceOf[js.Any])
  }
}
