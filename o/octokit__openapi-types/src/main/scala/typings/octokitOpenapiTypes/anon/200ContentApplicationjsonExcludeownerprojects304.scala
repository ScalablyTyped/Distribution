...
trait `200ContentApplicationjsonExcludeownerprojects304` extends StObject {
...
object `200ContentApplicationjsonExcludeownerprojects304` {
  ...
  inline def apply(
    ...
    `403`: Content36,
    `404`: Content36
  ): `200ContentApplicationjsonExcludeownerprojects304` = {
    ...
    __obj.asInstanceOf[`200ContentApplicationjsonExcludeownerprojects304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonExcludeownerprojects304`] (val x: Self) extends AnyVal {
