...
trait `200Content453` extends StObject {
...
object `200Content453` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content453`]
  }
  
  extension [Self <: `200Content453`](x: Self) {
    
    inline def set200(value: Content453): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
