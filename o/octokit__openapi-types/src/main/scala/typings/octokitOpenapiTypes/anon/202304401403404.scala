...
trait `202304401403404` extends StObject {
...
object `202304401403404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`202304401403404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `202304401403404`] (val x: Self) extends AnyVal {
