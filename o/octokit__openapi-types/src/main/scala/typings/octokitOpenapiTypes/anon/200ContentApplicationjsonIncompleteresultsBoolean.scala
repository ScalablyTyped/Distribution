...
object `200ContentApplicationjsonIncompleteresultsBoolean` {
  ...
  inline def apply(
    `200`: ContentApplicationjsonIncompleteresultsBoolean,
  ...
  ): `200ContentApplicationjsonIncompleteresultsBoolean` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonIncompleteresultsBoolean`] (val x: Self) extends AnyVal {
