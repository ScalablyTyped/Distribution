...
trait DeleteParametersPathProjectidResponses extends StObject {
  ...
  /**
    ...
    */
  var put: RequestBodyContent121
}
object DeleteParametersPathProjectidResponses {
  
  inline def apply(delete: ParametersPathProjectidResponses, get: ParametersPathProjectid, put: RequestBodyContent121): DeleteParametersPathProjectidResponses = {
  ...
  implicit open class MutableBuilder[Self <: DeleteParametersPathProjectidResponses] (val x: Self) extends AnyVal {
    ...
    inline def setPut(value: RequestBodyContent121): Self = StObject.set(x, "put", value.asInstanceOf[js.Any])
  }
}
