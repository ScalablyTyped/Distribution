...
object Responses200Content305 {
  ...
  inline def apply(parameters: `141`, responses: `200Content305`): Responses200Content305 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content305]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content305] (val x: Self) extends AnyVal {
