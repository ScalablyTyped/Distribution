...
trait Keyid extends StObject {
  ...
  var selected_repository_ids: js.UndefOr[js.Array[Partial[String] & Partial[Double]]] = js.undefined
...
object Keyid {
  ...
  extension [Self <: Keyid](x: Self) {
    ...
    inline def setSelected_repository_ids(value: js.Array[Partial[String] & Partial[Double]]): Self = StObject.set(x, "selected_repository_ids", value.asInstanceOf[js.Any])
    
    inline def setSelected_repository_idsUndefined: Self = StObject.set(x, "selected_repository_ids", js.undefined)
    
    inline def setSelected_repository_idsVarargs(value: (Partial[String] & Partial[Double])*): Self = StObject.set(x, "selected_repository_ids", js.Array(value*))
