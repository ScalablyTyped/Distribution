...
object Responses200Content324 {
  ...
  inline def apply(parameters: PathPullnumberQueryPage, responses: `200Content324`): Responses200Content324 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content324]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content324] (val x: Self) extends AnyVal {
