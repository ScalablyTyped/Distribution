...
trait Affectedpackagename extends StObject {
...
object Affectedpackagename {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Affectedpackagename]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Affectedpackagename] (val x: Self) extends AnyVal {
