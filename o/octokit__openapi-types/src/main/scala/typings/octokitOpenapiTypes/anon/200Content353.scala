...
trait `200Content353` extends StObject {
...
object `200Content353` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content353`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content353`] (val x: Self) extends AnyVal {
