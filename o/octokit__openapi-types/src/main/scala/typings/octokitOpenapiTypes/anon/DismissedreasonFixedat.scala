...
trait DismissedreasonFixedat extends StObject {
  ...
  var fixed_at: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['alert-fixed-at'] */ js.Any
  ] = js.undefined
...
object DismissedreasonFixedat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[DismissedreasonFixedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DismissedreasonFixedat] (val x: Self) extends AnyVal {
