...
trait `422Content346` extends StObject {
...
object `422Content346` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`422Content346`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `422Content346`] (val x: Self) extends AnyVal {
