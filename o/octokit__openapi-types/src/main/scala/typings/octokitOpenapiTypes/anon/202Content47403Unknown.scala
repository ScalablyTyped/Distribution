...
trait `202Content47403Unknown` extends StObject {
...
object `202Content47403Unknown` {
  
  inline def apply(`202`: Content47, `403`: Any): `202Content47403Unknown` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("202")(`202`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`202Content47403Unknown`]
  }
  
  extension [Self <: `202Content47403Unknown`](x: Self) {
