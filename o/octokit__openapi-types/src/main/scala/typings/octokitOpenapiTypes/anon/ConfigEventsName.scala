...
trait ConfigEventsName extends StObject {
  ...
  var config: js.UndefOr[InsecuresslSecret] = js.undefined
...
object ConfigEventsName {
  
  inline def apply(): ConfigEventsName = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ConfigEventsName]
  }
  
  extension [Self <: ConfigEventsName](x: Self) {
