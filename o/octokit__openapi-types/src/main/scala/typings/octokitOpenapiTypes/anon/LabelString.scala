...
object LabelString {
  ...
  inline def apply(label: String, ref: String, sha: String): LabelString = {
  ...
  implicit open class MutableBuilder[Self <: LabelString] (val x: Self) extends AnyVal {
    ...
    inline def setRepo(value: Forkscount): Self = StObject.set(x, "repo", value.asInstanceOf[js.Any])
