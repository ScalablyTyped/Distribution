...
trait `201Content297` extends StObject {
...
object `201Content297` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content297`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content297`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content297): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
