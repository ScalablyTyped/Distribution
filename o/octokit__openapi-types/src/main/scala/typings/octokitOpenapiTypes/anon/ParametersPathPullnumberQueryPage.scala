...
object ParametersPathPullnumberQueryPage {
  ...
  inline def apply(parameters: PathPullnumberQueryPage, responses: `200Content214`): ParametersPathPullnumberQueryPage = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[ParametersPathPullnumberQueryPage]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ParametersPathPullnumberQueryPage] (val x: Self) extends AnyVal {
