...
trait GetParametersQueryContentPage extends StObject {
  ...
  /**
    ...
    */
  var post: RequestBodyContentApplicationjson119
}
object GetParametersQueryContentPage {
  
  inline def apply(get: ParametersQueryContentPage, post: RequestBodyContentApplicationjson119): GetParametersQueryContentPage = {
  ...
  implicit open class MutableBuilder[Self <: GetParametersQueryContentPage] (val x: Self) extends AnyVal {
    ...
    inline def setPost(value: RequestBodyContentApplicationjson119): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
