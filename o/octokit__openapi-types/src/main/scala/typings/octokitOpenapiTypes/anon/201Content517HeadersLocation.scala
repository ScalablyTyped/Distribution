...
trait `201Content517HeadersLocation` extends StObject {
  
  /** Response */
  var `201`: Content517HeadersLocation
...
object `201Content517HeadersLocation` {
  
  inline def apply(
    `201`: Content517HeadersLocation,
  ...
  ): `201Content517HeadersLocation` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("201")(`201`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`201Content517HeadersLocation`]
  }
  
  extension [Self <: `201Content517HeadersLocation`](x: Self) {
    
    inline def set201(value: Content517HeadersLocation): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
