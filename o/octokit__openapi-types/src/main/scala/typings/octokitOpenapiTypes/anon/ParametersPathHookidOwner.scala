...
trait ParametersPathHookidOwner extends StObject {
  ...
  var responses: `200251`
}
object ParametersPathHookidOwner {
  
  inline def apply(parameters: PathHookidOwner, responses: `200251`): ParametersPathHookidOwner = {
  ...
  extension [Self <: ParametersPathHookidOwner](x: Self) {
    ...
    inline def setResponses(value: `200251`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
