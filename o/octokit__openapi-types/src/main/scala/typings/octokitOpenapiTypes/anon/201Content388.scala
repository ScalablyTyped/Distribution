...
trait `201Content388` extends StObject {
...
object `201Content388` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content388`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content388`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content388): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
