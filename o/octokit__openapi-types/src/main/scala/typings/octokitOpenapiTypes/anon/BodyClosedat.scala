...
trait BodyClosedat extends StObject {
  ...
  /**
    ...
    */
  var performed_via_github_app: js.UndefOr[EventsExternalurlHtmlurl | Null] = js.undefined
...
object BodyClosedat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[BodyClosedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BodyClosedat] (val x: Self) extends AnyVal {
    ...
    inline def setPerformed_via_github_app(value: EventsExternalurlHtmlurl): Self = StObject.set(x, "performed_via_github_app", value.asInstanceOf[js.Any])
