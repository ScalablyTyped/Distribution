...
object `201ContentApplicationjsonCreatedatEnabled` {
  ...
  inline def apply(`201`: ContentApplicationjsonCreatedatEnabled, `403`: Content36, `404`: Content36): `201ContentApplicationjsonCreatedatEnabled` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `201ContentApplicationjsonCreatedatEnabled`] (val x: Self) extends AnyVal {
