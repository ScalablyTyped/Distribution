...
trait GetParametersPathPullnumberResponses404Unknown extends StObject {
  ...
  var put: RequestBodyContent311
}
object GetParametersPathPullnumberResponses404Unknown {
  
  inline def apply(get: ParametersPathPullnumberResponses404Unknown, put: RequestBodyContent311): GetParametersPathPullnumberResponses404Unknown = {
  ...
  extension [Self <: GetParametersPathPullnumberResponses404Unknown](x: Self) {
    ...
    inline def setPut(value: RequestBodyContent311): Self = StObject.set(x, "put", value.asInstanceOf[js.Any])
  }
}
