...
trait Images extends StObject {
  ...
  var annotations: js.UndefOr[js.Array[Endline]] = js.undefined
...
object Images {
  ...
  extension [Self <: Images](x: Self) {
    ...
    inline def setAnnotations(value: js.Array[Endline]): Self = StObject.set(x, "annotations", value.asInstanceOf[js.Any])
    
    inline def setAnnotationsUndefined: Self = StObject.set(x, "annotations", js.undefined)
    
    inline def setAnnotationsVarargs(value: Endline*): Self = StObject.set(x, "annotations", js.Array(value*))
