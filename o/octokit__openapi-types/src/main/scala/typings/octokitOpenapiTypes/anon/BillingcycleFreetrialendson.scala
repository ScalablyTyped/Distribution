...
trait BillingcycleFreetrialendson extends StObject {
...
object BillingcycleFreetrialendson {
  
  inline def apply(): BillingcycleFreetrialendson = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BillingcycleFreetrialendson]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BillingcycleFreetrialendson] (val x: Self) extends AnyVal {
