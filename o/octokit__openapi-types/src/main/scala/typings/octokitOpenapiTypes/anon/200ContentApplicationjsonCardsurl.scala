...
object `200ContentApplicationjsonCardsurl` {
  ...
  inline def apply(`200`: ContentApplicationjsonCardsurl, `304`: Any, `401`: Content6, `403`: Content6): `200ContentApplicationjsonCardsurl` = {
  ...
  extension [Self <: `200ContentApplicationjsonCardsurl`](x: Self) {
