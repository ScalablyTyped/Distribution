...
trait ActivelockreasonAssignee extends StObject {
...
object ActivelockreasonAssignee {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ActivelockreasonAssignee]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ActivelockreasonAssignee] (val x: Self) extends AnyVal {
