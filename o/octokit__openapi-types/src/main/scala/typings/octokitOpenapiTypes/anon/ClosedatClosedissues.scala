...
trait ClosedatClosedissues extends StObject {
...
object ClosedatClosedissues {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ClosedatClosedissues]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ClosedatClosedissues] (val x: Self) extends AnyVal {
