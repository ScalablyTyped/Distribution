...
object `200ContentApplicationjsonConditions` {
  ...
  inline def apply(`200`: ContentApplicationjsonConditions, `304`: Any, `403`: Content48, `404`: Content48): `200ContentApplicationjsonConditions` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonConditions`] (val x: Self) extends AnyVal {
