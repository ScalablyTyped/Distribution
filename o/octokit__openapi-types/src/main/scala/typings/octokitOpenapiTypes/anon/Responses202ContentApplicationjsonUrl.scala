...
object Responses202ContentApplicationjsonUrl {
  ...
  inline def apply(parameters: PathPullnumberRepo, requestBody: Content317, responses: `202ContentApplicationjsonUrl`): Responses202ContentApplicationjsonUrl = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], requestBody = requestBody.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses202ContentApplicationjsonUrl]
  }
  
  extension [Self <: Responses202ContentApplicationjsonUrl](x: Self) {
