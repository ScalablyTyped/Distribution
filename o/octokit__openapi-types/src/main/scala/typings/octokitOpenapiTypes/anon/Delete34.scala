...
trait Delete34 extends StObject {
...
object Delete34 {
  ...
  inline def apply(delete: `34`): Delete34 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any])
    __obj.asInstanceOf[Delete34]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Delete34] (val x: Self) extends AnyVal {
