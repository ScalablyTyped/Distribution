...
trait `201Content508HeadersLocation` extends StObject {
  
  /** Response */
  var `201`: Content508HeadersLocation
...
object `201Content508HeadersLocation` {
  
  inline def apply(
    `201`: Content508HeadersLocation,
  ...
  ): `201Content508HeadersLocation` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("201")(`201`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`201Content508HeadersLocation`]
  }
  
  extension [Self <: `201Content508HeadersLocation`](x: Self) {
    
    inline def set201(value: Content508HeadersLocation): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
