...
trait NodeidOwnerPermissions extends StObject {
...
object NodeidOwnerPermissions {
  
  inline def apply(html_url: String, name: String, node_id: String): NodeidOwnerPermissions = {
    ...
    __obj.asInstanceOf[NodeidOwnerPermissions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NodeidOwnerPermissions] (val x: Self) extends AnyVal {
