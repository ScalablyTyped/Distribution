...
trait `200Content343401` extends StObject {
...
object `200Content343401` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content343401`]
  }
  
  extension [Self <: `200Content343401`](x: Self) {
    
    inline def set200(value: Content343): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
