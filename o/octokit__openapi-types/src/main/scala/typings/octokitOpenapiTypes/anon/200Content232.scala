...
trait `200Content232` extends StObject {
...
object `200Content232` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content232`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content232`] (val x: Self) extends AnyVal {
