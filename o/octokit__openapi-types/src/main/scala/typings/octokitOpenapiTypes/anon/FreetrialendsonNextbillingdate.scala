...
trait FreetrialendsonNextbillingdate extends StObject {
...
object FreetrialendsonNextbillingdate {
  ...
  inline def apply(
  ...
  ): FreetrialendsonNextbillingdate = {
    ...
    __obj.asInstanceOf[FreetrialendsonNextbillingdate]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FreetrialendsonNextbillingdate] (val x: Self) extends AnyVal {
