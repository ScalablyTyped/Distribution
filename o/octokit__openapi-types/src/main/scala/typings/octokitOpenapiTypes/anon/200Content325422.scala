...
trait `200Content325422` extends StObject {
...
object `200Content325422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content325422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content325422`] (val x: Self) extends AnyVal {
