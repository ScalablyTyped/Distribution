...
trait `201Content437` extends StObject {
...
object `201Content437` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content437`]
  }
  
  extension [Self <: `201Content437`](x: Self) {
    
    inline def set201(value: Content437): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
