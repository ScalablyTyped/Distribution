...
trait `200Content362` extends StObject {
...
object `200Content362` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content362`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content362`] (val x: Self) extends AnyVal {
