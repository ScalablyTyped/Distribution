...
trait DeleteParametersPathSecretnameResponses6 extends StObject {
  ...
  var delete: ParametersPathSecretnameResponses6
...
object DeleteParametersPathSecretnameResponses6 {
  
  inline def apply(
    delete: ParametersPathSecretnameResponses6,
    get: ParametersPathSecretname,
    put: RequestBodyContentApplicationjsonEncryptedvalue
  ): DeleteParametersPathSecretnameResponses6 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathSecretnameResponses6]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPathSecretnameResponses6] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathSecretnameResponses6): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
