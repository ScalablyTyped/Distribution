...
object RequestBodyContentApplicationjsonName {
  ...
  inline def apply(parameters: PathRunnergroupid, requestBody: ContentApplicationjsonName, responses: `200Content20`): RequestBodyContentApplicationjsonName = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], requestBody = requestBody.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestBodyContentApplicationjsonName]
  }
  
  extension [Self <: RequestBodyContentApplicationjsonName](x: Self) {
