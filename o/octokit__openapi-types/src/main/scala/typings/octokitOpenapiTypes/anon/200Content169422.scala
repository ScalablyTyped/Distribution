...
trait `200Content169422` extends StObject {
...
object `200Content169422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content169422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content169422`] (val x: Self) extends AnyVal {
