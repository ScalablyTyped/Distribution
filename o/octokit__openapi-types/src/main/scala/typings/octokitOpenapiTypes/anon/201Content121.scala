...
trait `201Content121` extends StObject {
...
object `201Content121` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content121`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content121`] (val x: Self) extends AnyVal {
