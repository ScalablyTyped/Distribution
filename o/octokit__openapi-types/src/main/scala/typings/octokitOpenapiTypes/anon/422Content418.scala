...
trait `422Content418` extends StObject {
...
object `422Content418` {
  
  inline def apply(`200`: ContentApplicationjsonLabelsArray, `404`: Content55, `422`: Content418): `422Content418` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`422Content418`]
  }
  
  extension [Self <: `422Content418`](x: Self) {
