...
trait ParametersQueryPagePerpageRole extends StObject {
  ...
  var responses: `200Content440Headers`
}
object ParametersQueryPagePerpageRole {
  
  inline def apply(parameters: QueryPagePerpageRole, responses: `200Content440Headers`): ParametersQueryPagePerpageRole = {
  ...
  extension [Self <: ParametersQueryPagePerpageRole](x: Self) {
    ...
    inline def setResponses(value: `200Content440Headers`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
