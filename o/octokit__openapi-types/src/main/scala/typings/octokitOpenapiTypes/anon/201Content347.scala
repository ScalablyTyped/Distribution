...
trait `201Content347` extends StObject {
...
object `201Content347` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content347`]
  }
  
  extension [Self <: `201Content347`](x: Self) {
    
    inline def set201(value: Content347): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
