...
trait PackagetypePagePerpage extends StObject {
...
object PackagetypePagePerpage {
  
  inline def apply(package_type: npm | maven | rubygems | docker | nuget | container): PackagetypePagePerpage = {
    val __obj = js.Dynamic.literal(package_type = package_type.asInstanceOf[js.Any])
    __obj.asInstanceOf[PackagetypePagePerpage]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PackagetypePagePerpage] (val x: Self) extends AnyVal {
