...
trait `200Content508HeadersLinkString304` extends StObject {
...
object `200Content508HeadersLinkString304` {
  
  inline def apply(
    `200`: Content508HeadersLinkString,
    ...
    `404`: Content36,
    `422`: Content346
  ): `200Content508HeadersLinkString304` = {
    ...
    __obj.asInstanceOf[`200Content508HeadersLinkString304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content508HeadersLinkString304`] (val x: Self) extends AnyVal {
