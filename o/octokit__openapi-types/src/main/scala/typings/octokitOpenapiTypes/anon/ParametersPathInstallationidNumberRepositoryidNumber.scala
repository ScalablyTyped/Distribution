...
object ParametersPathInstallationidNumberRepositoryidNumber {
  ...
  inline def apply(parameters: PathInstallationidNumberRepositoryidNumber, responses: `304Unknown403Content48`): ParametersPathInstallationidNumberRepositoryidNumber = {
