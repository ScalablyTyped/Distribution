...
trait `200Content391` extends StObject {
...
object `200Content391` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content391`]
  }
  
  extension [Self <: `200Content391`](x: Self) {
    
    inline def set200(value: Content391): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
