...
trait KeyidSelectedrepositoryids extends StObject {
...
object KeyidSelectedrepositoryids {
  ...
  inline def apply(key_id: String): KeyidSelectedrepositoryids = {
    val __obj = js.Dynamic.literal(key_id = key_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeyidSelectedrepositoryids]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: KeyidSelectedrepositoryids] (val x: Self) extends AnyVal {
