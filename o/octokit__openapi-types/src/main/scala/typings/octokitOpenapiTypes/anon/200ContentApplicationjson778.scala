...
trait `200ContentApplicationjson778` extends StObject {
  
  /** @description Response */
  var `200`: ContentApplicationjson778
...
object `200ContentApplicationjson778` {
  
  inline def apply(
    `200`: ContentApplicationjson778,
  ...
  ): `200ContentApplicationjson778` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.updateDynamic("503")(`503`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjson778`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjson778`] (val x: Self) extends AnyVal {
    
    inline def set200(value: ContentApplicationjson778): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
