...
trait ActivelockreasonAdditions extends StObject {
  ...
  var requested_teams: js.Array[MembersurlName]
...
object ActivelockreasonAdditions {
  ...
  inline def apply(
    ...
    requested_teams: js.Array[MembersurlName],
    ...
    __obj.asInstanceOf[ActivelockreasonAdditions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ActivelockreasonAdditions] (val x: Self) extends AnyVal {
    ...
    inline def setRequested_teams(value: js.Array[MembersurlName]): Self = StObject.set(x, "requested_teams", value.asInstanceOf[js.Any])
    
    inline def setRequested_teamsVarargs(value: MembersurlName*): Self = StObject.set(x, "requested_teams", js.Array(value*))
