...
trait Headrepositoryid extends StObject {
  ...
  var head_commit: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['nullable-simple-commit'] */ js.Any
  
  var head_repository: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['minimal-repository'] */ js.Any
  ...
  var referenced_workflows: js.UndefOr[
    (js.Array[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['referenced-workflow'] */ js.Any
    ]) | Null
  ] = js.undefined
  ...
  var triggering_actor: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['simple-user'] */ js.Any
  ] = js.undefined
...
object Headrepositoryid {
  ...
  inline def apply(
    ...
    event: String,
    head_commit: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['nullable-simple-commit'] */ js.Any,
    head_repository: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['minimal-repository'] */ js.Any,
    head_sha: String,
    html_url: String,
    id: Double,
    jobs_url: String,
  ...
  implicit open class MutableBuilder[Self <: Headrepositoryid] (val x: Self) extends AnyVal {
    ...
    inline def setHead_commit(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['nullable-simple-commit'] */ js.Any
    ): Self = StObject.set(x, "head_commit", value.asInstanceOf[js.Any])
    
    inline def setHead_repository(
    ...
    ): Self = StObject.set(x, "head_repository", value.asInstanceOf[js.Any])
    ...
    inline def setReferenced_workflows(
      value: js.Array[
          /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['referenced-workflow'] */ js.Any
        ]
    ): Self = StObject.set(x, "referenced_workflows", value.asInstanceOf[js.Any])
    ...
    inline def setReferenced_workflowsVarargs(
      value: (/* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['referenced-workflow'] */ js.Any)*
    ): Self = StObject.set(x, "referenced_workflows", js.Array(value*))
    ...
    inline def setTriggering_actor(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['simple-user'] */ js.Any
    ): Self = StObject.set(x, "triggering_actor", value.asInstanceOf[js.Any])
