...
trait KeyPage extends StObject {
  ...
  var key: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['parameters']['actions-cache-key'] */ js.Any
  ] = js.undefined
  ...
  var sort: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['parameters']['actions-cache-list-sort'] */ js.Any
  ] = js.undefined
}
object KeyPage {
  
  inline def apply(): KeyPage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[KeyPage]
  }
  
  extension [Self <: KeyPage](x: Self) {
    ...
    inline def setKey(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['parameters']['actions-cache-key'] */ js.Any
    ...
    inline def setSort(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['parameters']['actions-cache-list-sort'] */ js.Any
