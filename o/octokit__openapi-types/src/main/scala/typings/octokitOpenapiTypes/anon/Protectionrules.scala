...
trait Protectionrules extends StObject {
...
object Protectionrules {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Protectionrules]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Protectionrules] (val x: Self) extends AnyVal {
