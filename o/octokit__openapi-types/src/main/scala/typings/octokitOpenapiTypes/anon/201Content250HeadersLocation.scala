...
trait `201Content250HeadersLocation` extends StObject {
  
  /** @description Response */
  var `201`: Content250HeadersLocation
...
object `201Content250HeadersLocation` {
  
  inline def apply(
    `201`: Content250HeadersLocation,
  ...
  ): `201Content250HeadersLocation` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("201")(`201`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`201Content250HeadersLocation`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content250HeadersLocation`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content250HeadersLocation): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
