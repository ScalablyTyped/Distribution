...
trait `200274403` extends StObject {
...
object `200274403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200274403`]
  }
  
  extension [Self <: `200274403`](x: Self) {
    
    inline def set200(value: `274`): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
