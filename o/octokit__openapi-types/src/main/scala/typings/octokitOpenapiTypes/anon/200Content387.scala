...
trait `200Content387` extends StObject {
...
object `200Content387` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content387`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content387`] (val x: Self) extends AnyVal {
