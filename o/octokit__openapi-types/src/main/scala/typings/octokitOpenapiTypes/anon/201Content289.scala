...
trait `201Content289` extends StObject {
...
object `201Content289` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content289`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content289`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content289): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
