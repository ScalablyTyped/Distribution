...
trait DismissedcommentDismissedreasonState extends StObject {
...
object DismissedcommentDismissedreasonState {
  ...
  ): DismissedcommentDismissedreasonState = {
    val __obj = js.Dynamic.literal(state = state.asInstanceOf[js.Any])
    __obj.asInstanceOf[DismissedcommentDismissedreasonState]
  }
  
  extension [Self <: DismissedcommentDismissedreasonState](x: Self) {
