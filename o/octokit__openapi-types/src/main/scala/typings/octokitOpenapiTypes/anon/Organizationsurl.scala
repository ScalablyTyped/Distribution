...
import typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.Mannequin_
...
trait Organizationsurl extends StObject {
  ...
  /** @enum {string} */
  var `type`: js.UndefOr[
    Bot | typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.User | typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.Organization | Mannequin_
  ] = js.undefined
...
object Organizationsurl {
  ...
  inline def apply(id: Double, login: String): Organizationsurl = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Organizationsurl] (val x: Self) extends AnyVal {
    ...
    inline def setType(
      value: Bot | typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.User | typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.Organization | Mannequin_
