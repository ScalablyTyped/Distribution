...
trait `201Content464` extends StObject {
...
object `201Content464` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content464`]
  }
  
  extension [Self <: `201Content464`](x: Self) {
    
    inline def set201(value: Content464): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
