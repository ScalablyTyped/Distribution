...
trait `200Content39` extends StObject {
...
object `200Content39` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content39`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content39`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content39): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
