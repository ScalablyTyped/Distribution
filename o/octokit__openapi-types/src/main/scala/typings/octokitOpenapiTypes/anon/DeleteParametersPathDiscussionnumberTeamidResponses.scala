...
trait DeleteParametersPathDiscussionnumberTeamidResponses extends StObject {
  ...
  /**
    ...
    */
  var patch: Responses200Content116
}
object DeleteParametersPathDiscussionnumberTeamidResponses {
  ...
  extension [Self <: DeleteParametersPathDiscussionnumberTeamidResponses](x: Self) {
    ...
    inline def setPatch(value: Responses200Content116): Self = StObject.set(x, "patch", value.asInstanceOf[js.Any])
  }
}
