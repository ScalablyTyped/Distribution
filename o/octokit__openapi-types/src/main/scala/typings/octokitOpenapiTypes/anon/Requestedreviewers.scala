...
trait Requestedreviewers extends StObject {
...
object Requestedreviewers {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Requestedreviewers]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Requestedreviewers] (val x: Self) extends AnyVal {
