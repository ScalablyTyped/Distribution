...
trait `20082404` extends StObject {
...
object `20082404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`20082404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `20082404`] (val x: Self) extends AnyVal {
    
    inline def set200(value: `82`): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
