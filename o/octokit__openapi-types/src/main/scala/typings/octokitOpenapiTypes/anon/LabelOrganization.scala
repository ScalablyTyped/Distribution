...
trait LabelOrganization extends StObject {
...
object LabelOrganization {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(action = "unlabeled", discussion = discussion.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[LabelOrganization]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LabelOrganization] (val x: Self) extends AnyVal {
