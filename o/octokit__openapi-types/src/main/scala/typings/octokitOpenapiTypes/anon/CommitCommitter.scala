...
trait CommitCommitter extends StObject {
...
object CommitCommitter {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CommitCommitter]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommitCommitter] (val x: Self) extends AnyVal {
    ...
    inline def setCommit(value: CommitterMessage): Self = StObject.set(x, "commit", value.asInstanceOf[js.Any])
