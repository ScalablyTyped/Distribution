...
trait `201Content103` extends StObject {
...
object `201Content103` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content103`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content103`] (val x: Self) extends AnyVal {
