...
trait `200Content94304` extends StObject {
...
object `200Content94304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content94304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content94304`] (val x: Self) extends AnyVal {
