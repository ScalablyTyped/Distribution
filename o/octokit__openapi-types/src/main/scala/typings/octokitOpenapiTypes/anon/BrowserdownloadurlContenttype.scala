...
trait BrowserdownloadurlContenttype extends StObject {
  ...
  /** User */
  var uploader: js.UndefOr[Deleted | Null] = js.undefined
  
  /** Format: uri */
  var url: String
}
object BrowserdownloadurlContenttype {
  ...
  inline def apply(
    ...
    updated_at: String,
    url: String
  ): BrowserdownloadurlContenttype = {
    val __obj = js.Dynamic.literal(browser_download_url = browser_download_url.asInstanceOf[js.Any], content_type = content_type.asInstanceOf[js.Any], created_at = created_at.asInstanceOf[js.Any], download_count = download_count.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], node_id = node_id.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any], state = "uploaded", updated_at = updated_at.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], label = null)
    __obj.asInstanceOf[BrowserdownloadurlContenttype]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BrowserdownloadurlContenttype] (val x: Self) extends AnyVal {
    ...
    inline def setState(value: uploaded): Self = StObject.set(x, "state", value.asInstanceOf[js.Any])
    
    inline def setUpdated_at(value: String): Self = StObject.set(x, "updated_at", value.asInstanceOf[js.Any])
    
    inline def setUploader(value: Deleted): Self = StObject.set(x, "uploader", value.asInstanceOf[js.Any])
