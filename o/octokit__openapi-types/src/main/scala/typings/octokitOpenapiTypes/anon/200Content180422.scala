...
trait `200Content180422` extends StObject {
...
object `200Content180422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content180422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content180422`] (val x: Self) extends AnyVal {
