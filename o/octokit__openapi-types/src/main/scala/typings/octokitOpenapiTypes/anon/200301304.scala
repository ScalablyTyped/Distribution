...
object `200301304` {
  ...
  inline def apply(`200`: Content417, `301`: Content48, `304`: Any, `403`: Content48, `404`: Content48): `200301304` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200301304`] (val x: Self) extends AnyVal {
