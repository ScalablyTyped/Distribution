...
trait `200Content408` extends StObject {
...
object `200Content408` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content408`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content408`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content408): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
