...
trait MilestoneNumber_ extends StObject {
...
object MilestoneNumber_ {
  
  inline def apply(number: Double, pull_request: Mergedby, repository: Allowupdatebranch): MilestoneNumber_ = {
    val __obj = js.Dynamic.literal(action = "milestoned", number = number.asInstanceOf[js.Any], pull_request = pull_request.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any])
    __obj.asInstanceOf[MilestoneNumber_]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MilestoneNumber_] (val x: Self) extends AnyVal {
