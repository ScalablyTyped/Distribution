...
trait Waittimerstartedat extends StObject {
  ...
  var reviewers: js.Array[ReviewerType]
...
object Waittimerstartedat {
  
  inline def apply(
    current_user_can_approve: Boolean,
    environment: HtmlurlId,
    reviewers: js.Array[ReviewerType],
    wait_timer: Double
  ): Waittimerstartedat = {
    ...
    __obj.asInstanceOf[Waittimerstartedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Waittimerstartedat] (val x: Self) extends AnyVal {
