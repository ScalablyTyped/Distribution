...
trait `200748404Content41` extends StObject {
...
object `200748404Content41` {
  
  inline def apply(`200`: `748`, `404`: Content41): `200748404Content41` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200748404Content41`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200748404Content41`] (val x: Self) extends AnyVal {
