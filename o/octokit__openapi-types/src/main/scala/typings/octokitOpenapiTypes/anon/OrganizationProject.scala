...
trait OrganizationProject extends StObject {
...
object OrganizationProject {
  ...
  inline def apply(project: Ownerurl, sender: Avatarurl): OrganizationProject = {
    val __obj = js.Dynamic.literal(action = "created", project = project.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[OrganizationProject]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OrganizationProject] (val x: Self) extends AnyVal {
