...
trait Previouscolumnname extends StObject {
...
object Previouscolumnname {
  
  inline def apply(column_name: String, id: Double, project_id: Double, project_url: String, url: String): Previouscolumnname = {
