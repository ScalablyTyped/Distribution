...
object ParametersPathChecksuiteid {
  ...
  inline def apply(parameters: PathChecksuiteid, responses: `222`): ParametersPathChecksuiteid = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathChecksuiteid] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `222`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
