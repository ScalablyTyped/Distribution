...
object ParametersPathChecksuiteid {
  ...
  inline def apply(parameters: PathChecksuiteid, responses: `177`): ParametersPathChecksuiteid = {
  ...
  extension [Self <: ParametersPathChecksuiteid](x: Self) {
    ...
    inline def setResponses(value: `177`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
