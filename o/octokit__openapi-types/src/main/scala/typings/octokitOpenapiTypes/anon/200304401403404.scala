...
trait `200304401403404` extends StObject {
...
object `200304401403404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200304401403404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200304401403404`] (val x: Self) extends AnyVal {
