...
trait GetResponses200Content114 extends StObject {
  ...
  /**
    ...
    */
  var get: Responses200Content114
...
object GetResponses200Content114 {
  
  inline def apply(
    delete: ParametersPathTeamslugResponses,
    get: Responses200Content114,
    patch: RequestBodyContentApplicationjsonParentteamid
  ): GetResponses200Content114 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], patch = patch.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content114]
  }
  
  extension [Self <: GetResponses200Content114](x: Self) {
    
    inline def setDelete(value: ParametersPathTeamslugResponses): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
    
    inline def setGet(value: Responses200Content114): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
