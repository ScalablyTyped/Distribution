...
object Responses469 {
  ...
  inline def apply(parameters: PathTeamslugStringQuery407, responses: `469`): Responses469 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses469]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses469] (val x: Self) extends AnyVal {
