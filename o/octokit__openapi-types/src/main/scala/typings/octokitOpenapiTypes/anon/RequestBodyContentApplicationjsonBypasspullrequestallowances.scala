...
trait RequestBodyContentApplicationjsonBypasspullrequestallowances extends StObject {
  ...
  var responses: `200Content176422`
}
object RequestBodyContentApplicationjsonBypasspullrequestallowances {
  ...
  extension [Self <: RequestBodyContentApplicationjsonBypasspullrequestallowances](x: Self) {
    ...
    inline def setResponses(value: `200Content176422`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
