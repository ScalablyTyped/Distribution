...
trait `200Content413` extends StObject {
...
object `200Content413` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content413`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content413`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content413): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
