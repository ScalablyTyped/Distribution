...
trait Latestcheckrunscount extends StObject {
...
object Latestcheckrunscount {
  
  inline def apply(
    app: DescriptionEvents,
    ...
    __obj.asInstanceOf[Latestcheckrunscount]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Latestcheckrunscount] (val x: Self) extends AnyVal {
    
    inline def setAfter(value: String): Self = StObject.set(x, "after", value.asInstanceOf[js.Any])
    
    inline def setAfterNull: Self = StObject.set(x, "after", null)
    
    inline def setApp(value: DescriptionEvents): Self = StObject.set(x, "app", value.asInstanceOf[js.Any])
