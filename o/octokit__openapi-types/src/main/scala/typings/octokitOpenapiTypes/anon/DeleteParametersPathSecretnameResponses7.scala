...
trait DeleteParametersPathSecretnameResponses7 extends StObject {
  ...
  /**
    ...
    */
  var delete: ParametersPathSecretnameResponses7
...
object DeleteParametersPathSecretnameResponses7 {
  
  inline def apply(
    delete: ParametersPathSecretnameResponses7,
    get: Responses200Content74,
    put: RequestBodyContentApplicationjsonKeyid
  ): DeleteParametersPathSecretnameResponses7 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathSecretnameResponses7]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPathSecretnameResponses7] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathSecretnameResponses7): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
