...
trait Archivedat extends StObject {
  ...
  var content_type: typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.Issue | PullRequest | DraftIssue
  ...
  var creator: js.UndefOr[Avatarurl] = js.undefined
...
object Archivedat {
  ...
  inline def apply(
    ...
    content_type: typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.Issue | PullRequest | DraftIssue,
    created_at: String,
    id: Double,
    updated_at: String
  ): Archivedat = {
    ...
    __obj.asInstanceOf[Archivedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Archivedat] (val x: Self) extends AnyVal {
    ...
    inline def setContent_type(value: typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.Issue | PullRequest | DraftIssue): Self = StObject.set(x, "content_type", value.asInstanceOf[js.Any])
