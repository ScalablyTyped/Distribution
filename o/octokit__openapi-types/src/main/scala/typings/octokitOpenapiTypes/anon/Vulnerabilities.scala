...
trait Vulnerabilities extends StObject {
  
  /** @description A list of users receiving credit for their participation in the security advisory. */
  var credits: js.UndefOr[js.Array[LoginStringType] | Null] = js.undefined
  ...
  var vulnerabilities: js.Array[PackagePatchedversions]
}
object Vulnerabilities {
  
  inline def apply(description: String, summary: String, vulnerabilities: js.Array[PackagePatchedversions]): Vulnerabilities = {
    ...
    __obj.asInstanceOf[Vulnerabilities]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Vulnerabilities] (val x: Self) extends AnyVal {
    
    inline def setCredits(value: js.Array[LoginStringType]): Self = StObject.set(x, "credits", value.asInstanceOf[js.Any])
    ...
    inline def setCreditsVarargs(value: LoginStringType*): Self = StObject.set(x, "credits", js.Array(value*))
    ...
    inline def setVulnerabilities(value: js.Array[PackagePatchedversions]): Self = StObject.set(x, "vulnerabilities", value.asInstanceOf[js.Any])
    
    inline def setVulnerabilitiesVarargs(value: PackagePatchedversions*): Self = StObject.set(x, "vulnerabilities", js.Array(value*))
  }
}
