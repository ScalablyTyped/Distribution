...
object `401402` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `401402`] (val x: Self) extends AnyVal {
    ...
    inline def set402(value: Content41): Self = StObject.set(x, "402", value.asInstanceOf[js.Any])
