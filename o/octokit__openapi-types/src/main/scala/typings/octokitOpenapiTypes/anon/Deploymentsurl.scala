...
trait Deploymentsurl extends StObject {
  ...
  var owner: js.UndefOr[Gravatarid] = js.undefined
...
object Deploymentsurl {
  ...
  inline def apply(): Deploymentsurl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Deploymentsurl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Deploymentsurl] (val x: Self) extends AnyVal {
    ...
    inline def setOwner(value: Gravatarid): Self = StObject.set(x, "owner", value.asInstanceOf[js.Any])
