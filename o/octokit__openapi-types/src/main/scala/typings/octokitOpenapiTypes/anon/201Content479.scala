...
trait `201Content479` extends StObject {
...
object `201Content479` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content479`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content479`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content479): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
