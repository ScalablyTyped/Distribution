...
trait GetResponses200Content324 extends StObject {
  ...
  /**
    ...
    */
  var post: Responses200Content325
}
object GetResponses200Content324 {
  
  inline def apply(get: Responses200Content324, post: Responses200Content325): GetResponses200Content324 = {
  ...
  implicit open class MutableBuilder[Self <: GetResponses200Content324] (val x: Self) extends AnyVal {
    ...
    inline def setPost(value: Responses200Content325): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
