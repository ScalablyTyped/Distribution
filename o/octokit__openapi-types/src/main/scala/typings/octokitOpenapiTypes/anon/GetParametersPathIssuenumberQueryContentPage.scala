...
trait GetParametersPathIssuenumberQueryContentPage extends StObject {
  ...
  var post: ParametersPathIssuenumberRequestBodyContentApplicationjson121
}
object GetParametersPathIssuenumberQueryContentPage {
  
  inline def apply(
    get: ParametersPathIssuenumberQueryContentPage,
    post: ParametersPathIssuenumberRequestBodyContentApplicationjson121
  ...
  extension [Self <: GetParametersPathIssuenumberQueryContentPage](x: Self) {
    
    inline def setGet(value: ParametersPathIssuenumberQueryContentPage): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setPost(value: ParametersPathIssuenumberRequestBodyContentApplicationjson121): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
