...
trait `542` extends StObject {
  ...
  var `type`: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['security-advisory-credit-types'] */ js.Any
  ] = js.undefined
}
object `542` {
  
  inline def apply(): `542` = {
