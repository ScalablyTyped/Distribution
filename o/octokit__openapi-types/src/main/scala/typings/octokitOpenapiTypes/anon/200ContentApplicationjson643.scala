...
trait `200ContentApplicationjson643` extends StObject {
  
  /** @description Response */
  var `200`: ContentApplicationjson643
...
object `200ContentApplicationjson643` {
  
  inline def apply(
    `200`: ContentApplicationjson643,
    ...
    __obj.asInstanceOf[`200ContentApplicationjson643`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjson643`] (val x: Self) extends AnyVal {
    
    inline def set200(value: ContentApplicationjson643): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
