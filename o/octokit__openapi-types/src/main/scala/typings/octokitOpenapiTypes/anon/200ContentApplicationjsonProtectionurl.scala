...
object `200ContentApplicationjsonProtectionurl` {
  ...
  inline def apply(`200`: ContentApplicationjsonProtectionurl, `301`: Content48, `404`: Content48): `200ContentApplicationjsonProtectionurl` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonProtectionurl`] (val x: Self) extends AnyVal {
