...
object `202401` {
  ...
  extension [Self <: `202401`](x: Self) {
    ...
    inline def set201(value: Content93): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
    
    inline def set202(value: Content93): Self = StObject.set(x, "202", value.asInstanceOf[js.Any])
