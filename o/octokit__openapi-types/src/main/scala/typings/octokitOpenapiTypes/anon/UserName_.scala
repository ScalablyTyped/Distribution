...
trait UserName_ extends StObject {
...
object UserName_ {
  ...
  inline def apply(emails: js.Array[TypeValue], name: Formatted, userName: String): UserName_ = {
    ...
    __obj.asInstanceOf[UserName_]
  }
  
  extension [Self <: UserName_](x: Self) {
    ...
    inline def setEmails(value: js.Array[TypeValue]): Self = StObject.set(x, "emails", value.asInstanceOf[js.Any])
    
    inline def setEmailsVarargs(value: TypeValue*): Self = StObject.set(x, "emails", js.Array(value*))
