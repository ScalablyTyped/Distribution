...
object `200304403404` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200304403404`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content34): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
