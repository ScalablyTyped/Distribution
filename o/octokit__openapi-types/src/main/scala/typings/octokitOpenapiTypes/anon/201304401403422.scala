...
trait `201304401403422` extends StObject {
...
object `201304401403422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201304401403422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201304401403422`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content109): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
