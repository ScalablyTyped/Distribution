...
trait `201Content299` extends StObject {
...
object `201Content299` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content299`]
  }
  
  extension [Self <: `201Content299`](x: Self) {
    
    inline def set201(value: Content299): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
