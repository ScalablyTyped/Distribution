...
trait `200Content87403` extends StObject {
...
object `200Content87403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content87403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content87403`] (val x: Self) extends AnyVal {
