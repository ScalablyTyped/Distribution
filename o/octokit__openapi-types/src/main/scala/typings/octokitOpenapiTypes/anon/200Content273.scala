...
trait `200Content273` extends StObject {
...
object `200Content273` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content273`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content273`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content273): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
