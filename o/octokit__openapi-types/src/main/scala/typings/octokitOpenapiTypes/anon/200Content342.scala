...
trait `200Content342` extends StObject {
...
object `200Content342` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content342`]
  }
  
  extension [Self <: `200Content342`](x: Self) {
    
    inline def set200(value: Content342): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
