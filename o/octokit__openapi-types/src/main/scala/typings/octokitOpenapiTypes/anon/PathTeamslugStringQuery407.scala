...
trait PathTeamslugStringQuery407 extends StObject {
  
  var path: TeamslugString
  
  var query: `407`
}
object PathTeamslugStringQuery407 {
  
  inline def apply(path: TeamslugString, query: `407`): PathTeamslugStringQuery407 = {
