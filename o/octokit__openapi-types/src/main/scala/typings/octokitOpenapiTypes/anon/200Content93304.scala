...
trait `200Content93304` extends StObject {
...
object `200Content93304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content93304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content93304`] (val x: Self) extends AnyVal {
