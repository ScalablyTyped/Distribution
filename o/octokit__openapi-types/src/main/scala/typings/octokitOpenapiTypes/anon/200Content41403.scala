...
trait `200Content41403` extends StObject {
...
object `200Content41403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content41403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content41403`] (val x: Self) extends AnyVal {
