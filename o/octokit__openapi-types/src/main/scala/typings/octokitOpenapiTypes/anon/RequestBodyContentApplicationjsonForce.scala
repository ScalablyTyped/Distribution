...
trait RequestBodyContentApplicationjsonForce extends StObject {
  ...
  var responses: `200Content250422`
}
object RequestBodyContentApplicationjsonForce {
  
  inline def apply(parameters: `248`, requestBody: ContentApplicationjsonForce, responses: `200Content250422`): RequestBodyContentApplicationjsonForce = {
  ...
  implicit open class MutableBuilder[Self <: RequestBodyContentApplicationjsonForce] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200Content250422`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
