...
object `201806` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201806`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201806`] (val x: Self) extends AnyVal {
    
    inline def set201(value: `806`): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
