...
trait DeleteResponses403500 extends StObject {
  ...
  /**
    ...
    */
  var get: Parameters157
}
object DeleteResponses403500 {
  
  inline def apply(delete: Responses403500, get: Parameters157): DeleteResponses403500 = {
  ...
  extension [Self <: DeleteResponses403500](x: Self) {
    ...
    inline def setGet(value: Parameters157): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
  }
}
