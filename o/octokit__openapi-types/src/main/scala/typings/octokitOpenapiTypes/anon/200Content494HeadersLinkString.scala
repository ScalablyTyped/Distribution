...
trait `200Content494HeadersLinkString` extends StObject {
...
object `200Content494HeadersLinkString` {
  
  inline def apply(
    `200`: Content494HeadersLinkString,
    ...
    `401`: Content36,
    `403`: Content36
  ): `200Content494HeadersLinkString` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("401")(`401`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200Content494HeadersLinkString`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content494HeadersLinkString`] (val x: Self) extends AnyVal {
