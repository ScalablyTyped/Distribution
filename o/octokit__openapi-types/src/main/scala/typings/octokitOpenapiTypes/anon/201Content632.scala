...
trait `201Content632` extends StObject {
...
object `201Content632` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content632`]
  }
  
  extension [Self <: `201Content632`](x: Self) {
    
    inline def set201(value: Content632): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
