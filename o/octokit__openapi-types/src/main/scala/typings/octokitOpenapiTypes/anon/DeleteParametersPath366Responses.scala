...
trait DeleteParametersPath366Responses extends StObject {
  ...
  /**
    ...
    */
  var delete: ParametersPath366Responses
...
object DeleteParametersPath366Responses {
  
  inline def apply(
    delete: ParametersPath366Responses,
    get: ParametersPath366,
    put: RequestBodyContentApplicationjsonKeyidSelectedrepositoryids
  ): DeleteParametersPath366Responses = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPath366Responses]
  }
  
  extension [Self <: DeleteParametersPath366Responses](x: Self) {
    
    inline def setDelete(value: ParametersPath366Responses): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
    
    inline def setGet(value: ParametersPath366): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
