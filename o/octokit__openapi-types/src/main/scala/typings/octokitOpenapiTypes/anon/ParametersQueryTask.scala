...
trait ParametersQueryTask extends StObject {
  ...
  var responses: `200Content504Headers`
}
object ParametersQueryTask {
  
  inline def apply(parameters: QueryTask, responses: `200Content504Headers`): ParametersQueryTask = {
  ...
  extension [Self <: ParametersQueryTask](x: Self) {
    ...
    inline def setResponses(value: `200Content504Headers`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
