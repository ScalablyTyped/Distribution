...
trait `200Content213` extends StObject {
...
object `200Content213` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content213`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content213`] (val x: Self) extends AnyVal {
