...
trait OwnerPermissionsSlug extends StObject {
...
object OwnerPermissionsSlug {
  
  inline def apply(html_url: String, name: String, node_id: String): OwnerPermissionsSlug = {
    ...
    __obj.asInstanceOf[OwnerPermissionsSlug]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OwnerPermissionsSlug] (val x: Self) extends AnyVal {
