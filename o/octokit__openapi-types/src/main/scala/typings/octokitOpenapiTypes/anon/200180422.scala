...
trait `200180422` extends StObject {
...
object `200180422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200180422`]
  }
  
  extension [Self <: `200180422`](x: Self) {
    
    inline def set200(value: `180`): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
