...
object `200ContentApplicationjsonFingerprint` {
  ...
  inline def apply(`200`: ContentApplicationjsonFingerprint, `404`: Content55, `422`: Content421): `200ContentApplicationjsonFingerprint` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjsonFingerprint`]
  }
  
  extension [Self <: `200ContentApplicationjsonFingerprint`](x: Self) {
