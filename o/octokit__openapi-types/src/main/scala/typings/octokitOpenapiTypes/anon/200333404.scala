...
trait `200333404` extends StObject {
...
object `200333404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200333404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200333404`] (val x: Self) extends AnyVal {
    
    inline def set200(value: `333`): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
