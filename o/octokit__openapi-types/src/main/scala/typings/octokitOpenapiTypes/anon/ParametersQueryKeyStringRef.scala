...
trait ParametersQueryKeyStringRef extends StObject {
  ...
  var responses: `200492`
}
object ParametersQueryKeyStringRef {
  
  inline def apply(parameters: QueryKeyStringRef, responses: `200492`): ParametersQueryKeyStringRef = {
  ...
  extension [Self <: ParametersQueryKeyStringRef](x: Self) {
    ...
    inline def setResponses(value: `200492`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
