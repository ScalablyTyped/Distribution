...
trait ParametersQueryKeyStringRef extends StObject {
  ...
  var responses: `200641`
}
object ParametersQueryKeyStringRef {
  
  inline def apply(parameters: QueryKeyStringRef, responses: `200641`): ParametersQueryKeyStringRef = {
  ...
  implicit open class MutableBuilder[Self <: ParametersQueryKeyStringRef] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200641`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
