...
object RequestBodyContentApplicationjsonAssignees {
  ...
  inline def apply(parameters: `144`, requestBody: ContentApplicationjsonAssignees, responses: `403404410`): RequestBodyContentApplicationjsonAssignees = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], requestBody = requestBody.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestBodyContentApplicationjsonAssignees]
  }
  
  extension [Self <: RequestBodyContentApplicationjsonAssignees](x: Self) {
