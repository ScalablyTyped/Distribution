...
trait RequestBodyContentApplicationjsonObject extends StObject {
  ...
  var responses: `201Content237`
}
object RequestBodyContentApplicationjsonObject {
  
  inline def apply(parameters: `135`, requestBody: ContentApplicationjsonObject, responses: `201Content237`): RequestBodyContentApplicationjsonObject = {
  ...
  implicit open class MutableBuilder[Self <: RequestBodyContentApplicationjsonObject] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `201Content237`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
