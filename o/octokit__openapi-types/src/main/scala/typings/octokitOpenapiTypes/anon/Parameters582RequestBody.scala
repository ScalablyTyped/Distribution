...
trait Parameters582RequestBody extends StObject {
  
  var parameters: `582`
  
  var requestBody: js.UndefOr[ContentApplicationjsonGithubownedallowed] = js.undefined
}
object Parameters582RequestBody {
  
  inline def apply(parameters: `582`): Parameters582RequestBody = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any])
    __obj.asInstanceOf[Parameters582RequestBody]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Parameters582RequestBody] (val x: Self) extends AnyVal {
