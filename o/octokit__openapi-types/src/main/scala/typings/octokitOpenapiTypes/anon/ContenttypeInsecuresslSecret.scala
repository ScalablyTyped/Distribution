...
trait ContenttypeInsecuresslSecret extends StObject {
...
object ContenttypeInsecuresslSecret {
  
  inline def apply(): ContenttypeInsecuresslSecret = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ContenttypeInsecuresslSecret]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ContenttypeInsecuresslSecret] (val x: Self) extends AnyVal {
