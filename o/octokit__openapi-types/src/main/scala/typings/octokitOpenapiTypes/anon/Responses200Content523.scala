...
object Responses200Content523 {
  ...
  inline def apply(parameters: PathPackagenamePackagetypeUsername, responses: `200Content523`): Responses200Content523 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content523]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content523] (val x: Self) extends AnyVal {
