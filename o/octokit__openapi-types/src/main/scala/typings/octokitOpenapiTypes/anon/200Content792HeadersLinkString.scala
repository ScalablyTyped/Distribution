...
trait `200Content792HeadersLinkString` extends StObject {
  
  /** @description Response */
  var `200`: Content792HeadersLinkString
...
object `200Content792HeadersLinkString` {
  
  inline def apply(
    `200`: Content792HeadersLinkString,
    ...
    `403`: Content41,
    `404`: Content41
  ): `200Content792HeadersLinkString` = {
    ...
    __obj.asInstanceOf[`200Content792HeadersLinkString`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content792HeadersLinkString`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content792HeadersLinkString): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
