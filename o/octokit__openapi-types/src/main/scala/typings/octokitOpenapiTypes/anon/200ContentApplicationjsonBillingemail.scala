...
object `200ContentApplicationjsonBillingemail` {
  ...
  inline def apply(`200`: ContentApplicationjsonBillingemail, `404`: Content55): `200ContentApplicationjsonBillingemail` = {
  ...
  extension [Self <: `200ContentApplicationjsonBillingemail`](x: Self) {
