...
object ParametersPathPackagenamePackagetypePackageversionidUsername {
  ...
  inline def apply(
    ...
    responses: `401Content36403Content36`
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ParametersPathPackagenamePackagetypePackageversionidUsername] (val x: Self) extends AnyVal {
