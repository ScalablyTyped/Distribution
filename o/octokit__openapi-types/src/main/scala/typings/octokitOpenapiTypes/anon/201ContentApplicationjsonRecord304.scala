...
trait `201ContentApplicationjsonRecord304` extends StObject {
...
object `201ContentApplicationjsonRecord304` {
  ...
  inline def apply(
    ...
    `403`: Content36,
    `422`: Content471
  ): `201ContentApplicationjsonRecord304` = {
    ...
    __obj.asInstanceOf[`201ContentApplicationjsonRecord304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201ContentApplicationjsonRecord304`] (val x: Self) extends AnyVal {
