...
trait DeleteParametersPathTeamslugResponses extends StObject {
...
object DeleteParametersPathTeamslugResponses {
  
  inline def apply(delete: ParametersPathTeamslugResponses, put: ParametersPathTeamslug): DeleteParametersPathTeamslugResponses = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathTeamslugResponses]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPathTeamslugResponses] (val x: Self) extends AnyVal {
