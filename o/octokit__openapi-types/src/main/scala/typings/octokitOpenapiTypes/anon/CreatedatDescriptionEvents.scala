...
trait CreatedatDescriptionEvents extends StObject {
...
object CreatedatDescriptionEvents {
  
  inline def apply(html_url: String, name: String, node_id: String): CreatedatDescriptionEvents = {
    ...
    __obj.asInstanceOf[CreatedatDescriptionEvents]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreatedatDescriptionEvents] (val x: Self) extends AnyVal {
