...
trait `301Content41` extends StObject {
...
object `301Content41` {
  ...
  inline def apply(`200`: ContentApplicationjsonContactemail, `301`: Content41, `404`: Content41): `301Content41` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("301")(`301`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`301Content41`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `301Content41`] (val x: Self) extends AnyVal {
