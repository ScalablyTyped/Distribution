...
trait Clientip extends StObject {
...
object Clientip {
  ...
  inline def apply(): Clientip = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Clientip]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Clientip] (val x: Self) extends AnyVal {
