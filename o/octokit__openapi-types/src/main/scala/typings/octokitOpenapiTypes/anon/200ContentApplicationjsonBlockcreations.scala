...
object `200ContentApplicationjsonBlockcreations` {
  ...
  inline def apply(`200`: ContentApplicationjsonBlockcreations, `404`: Content48): `200ContentApplicationjsonBlockcreations` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonBlockcreations`] (val x: Self) extends AnyVal {
