...
trait RequestBodyContentApplicationjsonUsers extends StObject {
  ...
  var responses: `200Content73422`
}
object RequestBodyContentApplicationjsonUsers {
  
  inline def apply(parameters: PathBranch, requestBody: ContentApplicationjsonUsers, responses: `200Content73422`): RequestBodyContentApplicationjsonUsers = {
  ...
  extension [Self <: RequestBodyContentApplicationjsonUsers](x: Self) {
    ...
    inline def setResponses(value: `200Content73422`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
