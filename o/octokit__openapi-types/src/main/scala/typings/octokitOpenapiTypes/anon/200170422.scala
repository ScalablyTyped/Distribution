...
trait `200170422` extends StObject {
...
object `200170422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200170422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200170422`] (val x: Self) extends AnyVal {
    
    inline def set200(value: `170`): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
