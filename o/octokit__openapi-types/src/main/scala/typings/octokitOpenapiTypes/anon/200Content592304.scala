...
trait `200Content592304` extends StObject {
...
object `200Content592304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content592304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content592304`] (val x: Self) extends AnyVal {
