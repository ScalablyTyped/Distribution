...
trait GetResponses200401403404500 extends StObject {
  ...
  /**
    ...
    */
  var put: Responses355
}
object GetResponses200401403404500 {
  
  inline def apply(get: Responses200401403404500, put: Responses355): GetResponses200401403404500 = {
  ...
  extension [Self <: GetResponses200401403404500](x: Self) {
    ...
    inline def setPut(value: Responses355): Self = StObject.set(x, "put", value.asInstanceOf[js.Any])
  }
}
