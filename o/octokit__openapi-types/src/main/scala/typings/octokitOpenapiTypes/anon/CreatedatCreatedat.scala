...
trait CreatedatCreatedat extends StObject {
  ...
  /**
    ...
    */
  var performed_via_github_app: js.UndefOr[OwnerPermissionsSlug | Null] = js.undefined
...
object CreatedatCreatedat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CreatedatCreatedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreatedatCreatedat] (val x: Self) extends AnyVal {
    ...
    inline def setPerformed_via_github_app(value: OwnerPermissionsSlug): Self = StObject.set(x, "performed_via_github_app", value.asInstanceOf[js.Any])
