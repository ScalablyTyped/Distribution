...
trait `200Content491` extends StObject {
...
object `200Content491` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content491`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content491`] (val x: Self) extends AnyVal {
