...
trait Responses201Content63 extends StObject {
...
object Responses201Content63 {
  
  inline def apply(parameters: `181`, responses: `201Content63`): Responses201Content63 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses201Content63]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses201Content63] (val x: Self) extends AnyVal {
