...
object Deploymenturl {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(created_at = created_at.asInstanceOf[js.Any], deployment_url = deployment_url.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], node_id = node_id.asInstanceOf[js.Any], repository_url = repository_url.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any], target_url = target_url.asInstanceOf[js.Any], updated_at = updated_at.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], creator = null)
    __obj.asInstanceOf[Deploymenturl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Deploymenturl] (val x: Self) extends AnyVal {
