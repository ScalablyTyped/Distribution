...
trait ParametersQueryPerpageQString extends StObject {
  ...
  var responses: `200ContentApplicationjson596`
}
object ParametersQueryPerpageQString {
  
  inline def apply(parameters: QueryPerpageQString, responses: `200ContentApplicationjson596`): ParametersQueryPerpageQString = {
  ...
  extension [Self <: ParametersQueryPerpageQString](x: Self) {
    ...
    inline def setResponses(value: `200ContentApplicationjson596`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
