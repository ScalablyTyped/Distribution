...
trait ParametersQueryPerpageQString extends StObject {
  ...
  var responses: `200ContentApplicationjson780`
}
object ParametersQueryPerpageQString {
  
  inline def apply(parameters: QueryPerpageQString, responses: `200ContentApplicationjson780`): ParametersQueryPerpageQString = {
  ...
  implicit open class MutableBuilder[Self <: ParametersQueryPerpageQString] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200ContentApplicationjson780`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
