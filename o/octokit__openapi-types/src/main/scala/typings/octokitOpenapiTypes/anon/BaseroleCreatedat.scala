...
trait BaseroleCreatedat extends StObject {
...
object BaseroleCreatedat {
  
  inline def apply(id: Double, name: String): BaseroleCreatedat = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[BaseroleCreatedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BaseroleCreatedat] (val x: Self) extends AnyVal {
