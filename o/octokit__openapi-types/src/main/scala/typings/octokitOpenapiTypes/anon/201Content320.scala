...
trait `201Content320` extends StObject {
...
object `201Content320` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content320`]
  }
  
  extension [Self <: `201Content320`](x: Self) {
    
    inline def set201(value: Content320): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
