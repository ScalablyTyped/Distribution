...
object DeleteResponses404410 {
  ...
  inline def apply(delete: Responses404410, get: ParametersPath134, patch: Responses403410): DeleteResponses404410 = {
  ...
  implicit open class MutableBuilder[Self <: DeleteResponses404410] (val x: Self) extends AnyVal {
    ...
    inline def setGet(value: ParametersPath134): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
