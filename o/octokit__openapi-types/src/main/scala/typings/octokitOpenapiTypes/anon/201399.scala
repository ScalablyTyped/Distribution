...
object `201399` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201399`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201399`] (val x: Self) extends AnyVal {
    
    inline def set201(value: `399`): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
