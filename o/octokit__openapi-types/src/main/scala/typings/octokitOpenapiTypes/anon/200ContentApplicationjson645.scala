...
trait `200ContentApplicationjson645` extends StObject {
  
  /** @description Response */
  var `200`: ContentApplicationjson645
...
object `200ContentApplicationjson645` {
  
  inline def apply(
    `200`: ContentApplicationjson645,
  ...
  ): `200ContentApplicationjson645` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjson645`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjson645`] (val x: Self) extends AnyVal {
    
    inline def set200(value: ContentApplicationjson645): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
