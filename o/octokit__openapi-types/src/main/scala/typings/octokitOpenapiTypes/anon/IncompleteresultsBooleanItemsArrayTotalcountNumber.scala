...
trait IncompleteresultsBooleanItemsArrayTotalcountNumber extends StObject {
  ...
  var items: js.Array[BodytextClosedat]
  
  var total_count: Double
}
object IncompleteresultsBooleanItemsArrayTotalcountNumber {
  
  inline def apply(incomplete_results: Boolean, items: js.Array[BodytextClosedat], total_count: Double): IncompleteresultsBooleanItemsArrayTotalcountNumber = {
  ...
  implicit open class MutableBuilder[Self <: IncompleteresultsBooleanItemsArrayTotalcountNumber] (val x: Self) extends AnyVal {
    ...
    inline def setItems(value: js.Array[BodytextClosedat]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsVarargs(value: BodytextClosedat*): Self = StObject.set(x, "items", js.Array(value*))
