...
import typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.new_permissions_accepted
import typings.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait RepositoriesRepository extends StObject {
  
  /** @enum {string} */
  var action: new_permissions_accepted
...
object RepositoriesRepository {
  ...
  inline def apply(installation: Contactemail, sender: Avatarurl): RepositoriesRepository = {
    val __obj = js.Dynamic.literal(action = "new_permissions_accepted", installation = installation.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[RepositoriesRepository]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RepositoriesRepository] (val x: Self) extends AnyVal {
    
    inline def setAction(value: new_permissions_accepted): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
