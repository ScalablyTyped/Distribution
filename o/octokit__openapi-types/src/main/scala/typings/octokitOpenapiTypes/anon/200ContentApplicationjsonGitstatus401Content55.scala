...
trait `200ContentApplicationjsonGitstatus401Content55` extends StObject {
...
object `200ContentApplicationjsonGitstatus401Content55` {
  ...
  inline def apply(
    ...
    `404`: Content55,
    `500`: Content55
  ): `200ContentApplicationjsonGitstatus401Content55` = {
    ...
    __obj.asInstanceOf[`200ContentApplicationjsonGitstatus401Content55`]
  }
  
  extension [Self <: `200ContentApplicationjsonGitstatus401Content55`](x: Self) {
