...
trait `201304403404` extends StObject {
  
  /** @description Response */
  var `201`: ContentApplicationjsonHistory
...
object `201304403404` {
  ...
  inline def apply(
    `201`: ContentApplicationjsonHistory,
    ...
    __obj.asInstanceOf[`201304403404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201304403404`] (val x: Self) extends AnyVal {
    
    inline def set201(value: ContentApplicationjsonHistory): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
