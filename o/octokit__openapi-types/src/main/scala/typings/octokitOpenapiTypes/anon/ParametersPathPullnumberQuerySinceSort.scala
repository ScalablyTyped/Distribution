...
trait ParametersPathPullnumberQuerySinceSort extends StObject {
  ...
  var responses: `200Content300`
}
object ParametersPathPullnumberQuerySinceSort {
  
  inline def apply(parameters: PathPullnumberQuerySinceSort, responses: `200Content300`): ParametersPathPullnumberQuerySinceSort = {
  ...
  extension [Self <: ParametersPathPullnumberQuerySinceSort](x: Self) {
    ...
    inline def setResponses(value: `200Content300`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
