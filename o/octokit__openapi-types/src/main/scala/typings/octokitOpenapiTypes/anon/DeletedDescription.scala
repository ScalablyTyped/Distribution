...
trait DeletedDescription extends StObject {
  ...
  var parent: js.UndefOr[DescriptionHtmlurl | Null] = js.undefined
...
object DeletedDescription {
  
  inline def apply(id: Double, name: String): DeletedDescription = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeletedDescription]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeletedDescription] (val x: Self) extends AnyVal {
    ...
    inline def setParent(value: DescriptionHtmlurl): Self = StObject.set(x, "parent", value.asInstanceOf[js.Any])
