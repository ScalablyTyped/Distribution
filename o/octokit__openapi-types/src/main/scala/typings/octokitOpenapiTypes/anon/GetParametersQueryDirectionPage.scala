...
trait GetParametersQueryDirectionPage extends StObject {
  ...
  /**
    ...
    */
  var post: Responses201Content117
}
object GetParametersQueryDirectionPage {
  
  inline def apply(get: ParametersQueryDirectionPage, post: Responses201Content117): GetParametersQueryDirectionPage = {
  ...
  implicit open class MutableBuilder[Self <: GetParametersQueryDirectionPage] (val x: Self) extends AnyVal {
    ...
    inline def setPost(value: Responses201Content117): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
