...
trait `201Content426` extends StObject {
...
object `201Content426` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content426`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content426`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content426): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
