...
trait PatchPut extends StObject {
  ...
  /**
    ...
    */
  var patch: RequestBodyContent254
...
object PatchPut {
  ...
  inline def apply(
    ...
    get: Responses200Content252,
    patch: RequestBodyContent254,
  ...
  extension [Self <: PatchPut](x: Self) {
    ...
    inline def setPatch(value: RequestBodyContent254): Self = StObject.set(x, "patch", value.asInstanceOf[js.Any])
