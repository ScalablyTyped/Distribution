...
trait Protectionruleid extends StObject {
...
object Protectionruleid {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Protectionruleid]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Protectionruleid] (val x: Self) extends AnyVal {
