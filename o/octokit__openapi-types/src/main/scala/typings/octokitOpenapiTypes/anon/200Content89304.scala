...
trait `200Content89304` extends StObject {
...
object `200Content89304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content89304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content89304`] (val x: Self) extends AnyVal {
