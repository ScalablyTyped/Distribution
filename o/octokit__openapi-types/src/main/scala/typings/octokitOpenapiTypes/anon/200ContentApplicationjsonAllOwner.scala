...
object `200ContentApplicationjsonAllOwner` {
  ...
  inline def apply(`200`: ContentApplicationjsonAllOwner, `404`: Content55): `200ContentApplicationjsonAllOwner` = {
  ...
  extension [Self <: `200ContentApplicationjsonAllOwner`](x: Self) {
