...
trait `200Content71422` extends StObject {
...
object `200Content71422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content71422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content71422`] (val x: Self) extends AnyVal {
