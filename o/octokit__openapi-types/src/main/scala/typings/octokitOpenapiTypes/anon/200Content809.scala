...
trait `200Content809` extends StObject {
...
object `200Content809` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content809`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content809`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content809): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
