...
trait Actionscachekey extends StObject {
  ...
  /**
    ...
    * The default is `web`.
    */
  var `audit-log-include`: web | git | all
...
object Actionscachekey {
  ...
  inline def apply(
    ...
    __obj.updateDynamic("audit-log-after")(`audit-log-after`.asInstanceOf[js.Any])
    __obj.updateDynamic("audit-log-before")(`audit-log-before`.asInstanceOf[js.Any])
    __obj.updateDynamic("audit-log-include")(`audit-log-include`.asInstanceOf[js.Any])
    __obj.updateDynamic("audit-log-order")(`audit-log-order`.asInstanceOf[js.Any])
    __obj.updateDynamic("audit-log-phrase")(`audit-log-phrase`.asInstanceOf[js.Any])
    ...
    __obj.updateDynamic("group-id")(`group-id`.asInstanceOf[js.Any])
    ...
    __obj.updateDynamic("scim-group-id")(`scim-group-id`.asInstanceOf[js.Any])
    __obj.updateDynamic("scim-user-id")(`scim-user-id`.asInstanceOf[js.Any])
    ...
    __obj.updateDynamic("start-index")(`start-index`.asInstanceOf[js.Any])
  ...
  extension [Self <: Actionscachekey](x: Self) {
    ...
    inline def `setAudit-log-after`(value: String): Self = StObject.set(x, "audit-log-after", value.asInstanceOf[js.Any])
    
    inline def `setAudit-log-before`(value: String): Self = StObject.set(x, "audit-log-before", value.asInstanceOf[js.Any])
    
    inline def `setAudit-log-include`(value: web | git | all): Self = StObject.set(x, "audit-log-include", value.asInstanceOf[js.Any])
    
    inline def `setAudit-log-order`(value: desc | asc): Self = StObject.set(x, "audit-log-order", value.asInstanceOf[js.Any])
    
    inline def `setAudit-log-phrase`(value: String): Self = StObject.set(x, "audit-log-phrase", value.asInstanceOf[js.Any])
    ...
    inline def `setGroup-id`(value: Double): Self = StObject.set(x, "group-id", value.asInstanceOf[js.Any])
    ...
    inline def `setScim-group-id`(value: String): Self = StObject.set(x, "scim-group-id", value.asInstanceOf[js.Any])
    
    inline def `setScim-user-id`(value: String): Self = StObject.set(x, "scim-user-id", value.asInstanceOf[js.Any])
