...
trait `200Content651` extends StObject {
...
object `200Content651` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content651`]
  }
  
  extension [Self <: `200Content651`](x: Self) {
    
    inline def set200(value: Content651): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
