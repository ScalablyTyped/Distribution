...
trait CvssvectorstringCweids extends StObject {
  ...
  var vulnerabilities: js.UndefOr[js.Array[PackagePatchedversions] | Null] = js.undefined
}
object CvssvectorstringCweids {
  
  inline def apply(description: String, summary: String): CvssvectorstringCweids = {
    val __obj = js.Dynamic.literal(description = description.asInstanceOf[js.Any], summary = summary.asInstanceOf[js.Any])
    __obj.asInstanceOf[CvssvectorstringCweids]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CvssvectorstringCweids] (val x: Self) extends AnyVal {
