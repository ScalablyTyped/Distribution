...
trait `200Content91403404` extends StObject {
...
object `200Content91403404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content91403404`]
  }
  
  extension [Self <: `200Content91403404`](x: Self) {
    
    inline def set200(value: Content91): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
