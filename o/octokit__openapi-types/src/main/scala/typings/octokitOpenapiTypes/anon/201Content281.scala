...
trait `201Content281` extends StObject {
...
object `201Content281` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content281`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content281`] (val x: Self) extends AnyVal {
