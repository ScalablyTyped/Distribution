...
trait RequestBodyContentApplicationjsonUselfs extends StObject {
  ...
  var responses: `200Content252422`
}
object RequestBodyContentApplicationjsonUselfs {
  
  inline def apply(parameters: `144`, requestBody: ContentApplicationjsonUselfs, responses: `200Content252422`): RequestBodyContentApplicationjsonUselfs = {
  ...
  extension [Self <: RequestBodyContentApplicationjsonUselfs](x: Self) {
    ...
    inline def setResponses(value: `200Content252422`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
