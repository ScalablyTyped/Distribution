...
trait GetParameters319 extends StObject {
...
object GetParameters319 {
  
  inline def apply(get: Parameters319, post: RequestBodyContentApplicationjsonAssignees): GetParameters319 = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetParameters319]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetParameters319] (val x: Self) extends AnyVal {
    
    inline def setGet(value: Parameters319): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
