...
trait `200ContentApplicationjson644` extends StObject {
  
  /** @description Response */
  var `200`: ContentApplicationjson644
...
object `200ContentApplicationjson644` {
  
  inline def apply(
    `200`: ContentApplicationjson644,
  ...
  ): `200ContentApplicationjson644` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.updateDynamic("503")(`503`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjson644`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjson644`] (val x: Self) extends AnyVal {
    
    inline def set200(value: ContentApplicationjson644): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
