...
trait `200ContentApplicationjsonColumnurl304Unknown` extends StObject {
...
object `200ContentApplicationjsonColumnurl304Unknown` {
  ...
  inline def apply(
    ...
    `404`: Content48,
    `422`: Content395
  ): `200ContentApplicationjsonColumnurl304Unknown` = {
    ...
    __obj.asInstanceOf[`200ContentApplicationjsonColumnurl304Unknown`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonColumnurl304Unknown`] (val x: Self) extends AnyVal {
