...
trait `201Content572` extends StObject {
...
object `201Content572` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content572`]
  }
  
  extension [Self <: `201Content572`](x: Self) {
    
    inline def set201(value: Content572): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
