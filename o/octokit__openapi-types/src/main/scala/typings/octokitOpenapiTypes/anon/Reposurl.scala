...
trait Reposurl extends StObject {
...
object Reposurl {
  ...
  inline def apply(): Reposurl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Reposurl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Reposurl] (val x: Self) extends AnyVal {
