...
trait `200Content510400` extends StObject {
...
object `200Content510400` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content510400`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content510400`] (val x: Self) extends AnyVal {
