...
trait DescriptionEvents extends StObject {
  ...
  var events: js.UndefOr[
    js.Array[
      /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 53, starting with typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.branch_protection_rule, typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.check_run, typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.check_suite */ Any
    ]
  ] = js.undefined
...
object DescriptionEvents {
  
  inline def apply(html_url: String, name: String, node_id: String): DescriptionEvents = {
    ...
    __obj.asInstanceOf[DescriptionEvents]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescriptionEvents] (val x: Self) extends AnyVal {
    ...
    inline def setEventsVarargs(
      value: (/* import warning: LimitUnionLength.leaveTypeRef Was union type with length 53, starting with typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.branch_protection_rule, typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.check_run, typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.check_suite */ Any)*
