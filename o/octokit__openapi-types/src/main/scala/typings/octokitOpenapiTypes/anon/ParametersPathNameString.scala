...
trait ParametersPathNameString extends StObject {
  ...
  var responses: `200343`
}
object ParametersPathNameString {
  
  inline def apply(parameters: PathNameString, responses: `200343`): ParametersPathNameString = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathNameString] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200343`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
