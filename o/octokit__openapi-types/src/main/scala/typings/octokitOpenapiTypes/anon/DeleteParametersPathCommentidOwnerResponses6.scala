...
trait DeleteParametersPathCommentidOwnerResponses6 extends StObject {
  ...
  var patch: Responses200Content196
}
object DeleteParametersPathCommentidOwnerResponses6 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPathCommentidOwnerResponses6] (val x: Self) extends AnyVal {
    ...
    inline def setPatch(value: Responses200Content196): Self = StObject.set(x, "patch", value.asInstanceOf[js.Any])
  }
}
