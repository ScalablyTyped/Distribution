...
object Responses200Content252 {
  ...
  inline def apply(parameters: `135`, responses: `200Content252`): Responses200Content252 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content252]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content252] (val x: Self) extends AnyVal {
