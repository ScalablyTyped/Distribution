...
trait `201Content303` extends StObject {
...
object `201Content303` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content303`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content303`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content303): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
