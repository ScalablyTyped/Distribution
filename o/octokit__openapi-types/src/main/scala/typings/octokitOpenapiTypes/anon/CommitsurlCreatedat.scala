...
trait CommitsurlCreatedat extends StObject {
  ...
  /**
    ...
    */
  var auto_merge: CommitmessageCommittitle | Null
  
  var base: RepoDownloadsurl
...
object CommitsurlCreatedat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CommitsurlCreatedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommitsurlCreatedat] (val x: Self) extends AnyVal {
    ...
    inline def setAuto_merge(value: CommitmessageCommittitle): Self = StObject.set(x, "auto_merge", value.asInstanceOf[js.Any])
    
    inline def setAuto_mergeNull: Self = StObject.set(x, "auto_merge", null)
    
    inline def setBase(value: RepoDownloadsurl): Self = StObject.set(x, "base", value.asInstanceOf[js.Any])
    ...
    inline def setHead(value: RepoDownloadsurl): Self = StObject.set(x, "head", value.asInstanceOf[js.Any])
