...
trait `201Content251` extends StObject {
...
object `201Content251` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content251`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content251`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content251): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
