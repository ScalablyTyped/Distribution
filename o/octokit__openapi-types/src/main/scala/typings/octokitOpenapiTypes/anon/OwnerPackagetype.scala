...
trait OwnerPackagetype extends StObject {
...
object OwnerPackagetype {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OwnerPackagetype]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OwnerPackagetype] (val x: Self) extends AnyVal {
