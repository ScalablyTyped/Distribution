...
object GetResponses200Content294 {
  ...
  inline def apply(get: Responses200Content294): GetResponses200Content294 = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content294]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses200Content294] (val x: Self) extends AnyVal {
