...
object Responses200ContentApplicationjsonRequiredworkflowsArray {
  ...
  inline def apply(parameters: PathOrgStringQuery, responses: `200ContentApplicationjsonRequiredworkflowsArray`): Responses200ContentApplicationjsonRequiredworkflowsArray = {
