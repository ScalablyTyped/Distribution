...
trait Bugs extends StObject {
  ...
  var author: js.UndefOr[String | (Record[String, scala.Nothing])] = js.undefined
  
  var bin: js.UndefOr[Record[String, scala.Nothing]] = js.undefined
  
  var bugs: js.UndefOr[String | (Record[String, scala.Nothing])] = js.undefined
  
  var commit_oid: js.UndefOr[String] = js.undefined
  
  var contributors: js.UndefOr[js.Array[String]] = js.undefined
  ...
  var directories: js.UndefOr[String | (Record[String, scala.Nothing])] = js.undefined
  
  var dist: js.UndefOr[String | (Record[String, scala.Nothing])] = js.undefined
  ...
  var repository: js.UndefOr[String | (Record[String, scala.Nothing])] = js.undefined
...
object Bugs {
  ...
  implicit open class MutableBuilder[Self <: Bugs] (val x: Self) extends AnyVal {
    ...
    inline def setAuthor(value: String | (Record[String, scala.Nothing])): Self = StObject.set(x, "author", value.asInstanceOf[js.Any])
    ...
    inline def setBugs(value: String | (Record[String, scala.Nothing])): Self = StObject.set(x, "bugs", value.asInstanceOf[js.Any])
    ...
    inline def setDirectories(value: String | (Record[String, scala.Nothing])): Self = StObject.set(x, "directories", value.asInstanceOf[js.Any])
    
    inline def setDirectoriesUndefined: Self = StObject.set(x, "directories", js.undefined)
    
    inline def setDist(value: String | (Record[String, scala.Nothing])): Self = StObject.set(x, "dist", value.asInstanceOf[js.Any])
    ...
    inline def setRepository(value: String | (Record[String, scala.Nothing])): Self = StObject.set(x, "repository", value.asInstanceOf[js.Any])
