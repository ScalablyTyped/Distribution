...
trait `201Content342` extends StObject {
...
object `201Content342` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content342`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content342`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content342): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
