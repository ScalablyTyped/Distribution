...
trait RequestBodyContentApplicationjsonBasetree extends StObject {
  ...
  var responses: `201Content253`
}
object RequestBodyContentApplicationjsonBasetree {
  
  inline def apply(parameters: `141`, requestBody: ContentApplicationjsonBasetree, responses: `201Content253`): RequestBodyContentApplicationjsonBasetree = {
  ...
  implicit open class MutableBuilder[Self <: RequestBodyContentApplicationjsonBasetree] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `201Content253`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
