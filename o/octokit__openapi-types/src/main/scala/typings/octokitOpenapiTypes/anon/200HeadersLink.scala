...
trait `200HeadersLink` extends StObject {
...
object `200HeadersLink` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200HeadersLink`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200HeadersLink`] (val x: Self) extends AnyVal {
