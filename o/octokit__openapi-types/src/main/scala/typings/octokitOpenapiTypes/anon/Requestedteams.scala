...
trait Requestedteams extends StObject {
  ...
  /**
    ...
    */
  var auto_merge: js.UndefOr[Mergemethod | Null] = js.undefined
...
object Requestedteams {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(_links = _links.asInstanceOf[js.Any], assignees = assignees.asInstanceOf[js.Any], author_association = author_association.asInstanceOf[js.Any], base = base.asInstanceOf[js.Any], comments_url = comments_url.asInstanceOf[js.Any], commits_url = commits_url.asInstanceOf[js.Any], created_at = created_at.asInstanceOf[js.Any], diff_url = diff_url.asInstanceOf[js.Any], head = head.asInstanceOf[js.Any], html_url = html_url.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], issue_url = issue_url.asInstanceOf[js.Any], labels = labels.asInstanceOf[js.Any], locked = locked.asInstanceOf[js.Any], node_id = node_id.asInstanceOf[js.Any], number = number.asInstanceOf[js.Any], patch_url = patch_url.asInstanceOf[js.Any], requested_reviewers = requested_reviewers.asInstanceOf[js.Any], requested_teams = requested_teams.asInstanceOf[js.Any], review_comment_url = review_comment_url.asInstanceOf[js.Any], review_comments_url = review_comments_url.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any], statuses_url = statuses_url.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any], updated_at = updated_at.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], active_lock_reason = null, assignee = null, body = null, closed_at = null, merge_commit_sha = null, merged_at = null, milestone = null, user = null)
    __obj.asInstanceOf[Requestedteams]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Requestedteams] (val x: Self) extends AnyVal {
    ...
    inline def setHead(value: LabelString): Self = StObject.set(x, "head", value.asInstanceOf[js.Any])
