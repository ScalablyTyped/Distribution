...
object CommentnumberDiscussionnumberOrg {
  ...
  inline def apply(comment_number: Double, discussion_number: Double, org_ : String, team_slug: String): CommentnumberDiscussionnumberOrg = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CommentnumberDiscussionnumberOrg] (val x: Self) extends AnyVal {
