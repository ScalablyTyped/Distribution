...
trait `200Content804` extends StObject {
...
object `200Content804` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content804`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content804`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content804): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
