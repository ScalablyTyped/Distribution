...
trait TotalResults extends StObject {
  
  var Resources: js.Array[ActiveDisplayName]
...
object TotalResults {
  ...
  inline def apply(
    Resources: js.Array[ActiveDisplayName],
    itemsPerPage: Double,
    ...
    __obj.asInstanceOf[TotalResults]
  }
  
  extension [Self <: TotalResults](x: Self) {
    
    inline def setItemsPerPage(value: Double): Self = StObject.set(x, "itemsPerPage", value.asInstanceOf[js.Any])
    
    inline def setResources(value: js.Array[ActiveDisplayName]): Self = StObject.set(x, "Resources", value.asInstanceOf[js.Any])
    
    inline def setResourcesVarargs(value: ActiveDisplayName*): Self = StObject.set(x, "Resources", js.Array(value*))
