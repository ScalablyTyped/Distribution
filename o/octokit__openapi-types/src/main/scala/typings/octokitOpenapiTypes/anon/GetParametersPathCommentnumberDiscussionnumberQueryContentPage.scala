...
trait GetParametersPathCommentnumberDiscussionnumberQueryContentPage extends StObject {
  ...
  /**
    ...
    */
  var post: Responses201Content113
}
object GetParametersPathCommentnumberDiscussionnumberQueryContentPage {
  
  inline def apply(get: ParametersPathCommentnumberDiscussionnumberQueryContentPage, post: Responses201Content113): GetParametersPathCommentnumberDiscussionnumberQueryContentPage = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetParametersPathCommentnumberDiscussionnumberQueryContentPage]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetParametersPathCommentnumberDiscussionnumberQueryContentPage] (val x: Self) extends AnyVal {
    ...
    inline def setPost(value: Responses201Content113): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
