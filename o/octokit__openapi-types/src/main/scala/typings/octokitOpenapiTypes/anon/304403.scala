...
object `304403` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `304403`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content28): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
