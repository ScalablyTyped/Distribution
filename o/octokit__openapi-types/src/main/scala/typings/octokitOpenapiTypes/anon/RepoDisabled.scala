...
trait RepoDisabled extends StObject {
...
object RepoDisabled {
  ...
  inline def apply(label: String, ref: String, repo: Disabled, sha: String): RepoDisabled = {
    ...
    __obj.asInstanceOf[RepoDisabled]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RepoDisabled] (val x: Self) extends AnyVal {
