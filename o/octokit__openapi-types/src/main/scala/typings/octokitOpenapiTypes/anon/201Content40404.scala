...
trait `201Content40404` extends StObject {
...
object `201Content40404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content40404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content40404`] (val x: Self) extends AnyVal {
