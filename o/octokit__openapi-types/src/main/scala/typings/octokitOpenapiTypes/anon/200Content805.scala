...
trait `200Content805` extends StObject {
...
object `200Content805` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content805`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content805`] (val x: Self) extends AnyVal {
