...
trait `201Content385` extends StObject {
...
object `201Content385` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content385`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content385`] (val x: Self) extends AnyVal {
