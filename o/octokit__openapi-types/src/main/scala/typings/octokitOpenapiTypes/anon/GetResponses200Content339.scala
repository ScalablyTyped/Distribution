...
object GetResponses200Content339 {
  ...
  inline def apply(get: Responses200Content339, post: RequestBodyContentApplicationjsonReadonly): GetResponses200Content339 = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content339]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses200Content339] (val x: Self) extends AnyVal {
