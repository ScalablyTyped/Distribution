...
object Mergemethod {
  ...
  inline def apply(merge_method: merge | squash | rebase): Mergemethod = {
    val __obj = js.Dynamic.literal(merge_method = merge_method.asInstanceOf[js.Any], commit_message = null, commit_title = null, enabled_by = null)
    __obj.asInstanceOf[Mergemethod]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Mergemethod] (val x: Self) extends AnyVal {
    ...
    inline def setCommit_titleNull: Self = StObject.set(x, "commit_title", null)
