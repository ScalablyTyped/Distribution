...
trait Runnergroupname extends StObject {
...
object Runnergroupname {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Runnergroupname]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Runnergroupname] (val x: Self) extends AnyVal {
    ...
    inline def setSteps(value: js.Array[NameNumber]): Self = StObject.set(x, "steps", value.asInstanceOf[js.Any])
    
    inline def setStepsVarargs(value: NameNumber*): Self = StObject.set(x, "steps", js.Array(value*))
