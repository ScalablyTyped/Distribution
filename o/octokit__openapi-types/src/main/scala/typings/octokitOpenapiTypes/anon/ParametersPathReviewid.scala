...
trait ParametersPathReviewid extends StObject {
  ...
  var responses: `200Content315404`
}
object ParametersPathReviewid {
  
  inline def apply(parameters: PathReviewid, responses: `200Content315404`): ParametersPathReviewid = {
  ...
  extension [Self <: ParametersPathReviewid](x: Self) {
    ...
    inline def setResponses(value: `200Content315404`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
