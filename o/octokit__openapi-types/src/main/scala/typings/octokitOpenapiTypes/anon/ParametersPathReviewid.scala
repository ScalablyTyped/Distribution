...
trait ParametersPathReviewid extends StObject {
  ...
  var responses: `200Content380404`
}
object ParametersPathReviewid {
  
  inline def apply(parameters: PathReviewid, responses: `200Content380404`): ParametersPathReviewid = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathReviewid] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200Content380404`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
