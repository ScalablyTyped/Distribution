...
trait ParametersPathReviewid extends StObject {
  ...
  var responses: `200Content325404`
}
object ParametersPathReviewid {
  
  inline def apply(parameters: PathReviewid, responses: `200Content325404`): ParametersPathReviewid = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathReviewid] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200Content325404`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
