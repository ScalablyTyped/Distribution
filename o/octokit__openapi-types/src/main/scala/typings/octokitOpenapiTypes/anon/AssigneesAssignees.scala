...
trait AssigneesAssignees extends StObject {
  ...
  /**
    ...
    */
  var performed_via_github_app: js.UndefOr[DescriptionEventsExternalurl | Null] = js.undefined
...
object AssigneesAssignees {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[AssigneesAssignees]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AssigneesAssignees] (val x: Self) extends AnyVal {
    ...
    inline def setPerformed_via_github_app(value: DescriptionEventsExternalurl): Self = StObject.set(x, "performed_via_github_app", value.asInstanceOf[js.Any])
