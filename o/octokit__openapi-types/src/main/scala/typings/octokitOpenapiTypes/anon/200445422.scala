...
trait `200445422` extends StObject {
...
object `200445422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200445422`]
  }
  
  extension [Self <: `200445422`](x: Self) {
    
    inline def set200(value: `445`): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
