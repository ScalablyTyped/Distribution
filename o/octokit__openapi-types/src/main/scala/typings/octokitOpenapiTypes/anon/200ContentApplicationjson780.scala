...
trait `200ContentApplicationjson780` extends StObject {
  
  /** @description Response */
  var `200`: ContentApplicationjson780
...
object `200ContentApplicationjson780` {
  
  inline def apply(
    `200`: ContentApplicationjson780,
  ...
  ): `200ContentApplicationjson780` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.updateDynamic("503")(`503`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjson780`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjson780`] (val x: Self) extends AnyVal {
    
    inline def set200(value: ContentApplicationjson780): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
