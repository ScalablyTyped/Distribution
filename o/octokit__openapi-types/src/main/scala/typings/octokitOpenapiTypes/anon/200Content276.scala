...
trait `200Content276` extends StObject {
...
object `200Content276` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content276`]
  }
  
  extension [Self <: `200Content276`](x: Self) {
    
    inline def set200(value: Content276): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
