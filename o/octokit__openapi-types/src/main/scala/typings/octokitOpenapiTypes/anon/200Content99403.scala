...
trait `200Content99403` extends StObject {
...
object `200Content99403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content99403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content99403`] (val x: Self) extends AnyVal {
