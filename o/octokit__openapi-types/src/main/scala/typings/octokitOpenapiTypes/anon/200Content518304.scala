...
trait `200Content518304` extends StObject {
...
object `200Content518304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content518304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content518304`] (val x: Self) extends AnyVal {
