...
trait `422Content414` extends StObject {
...
object `422Content414` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`422Content414`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `422Content414`] (val x: Self) extends AnyVal {
