...
trait `200Content184` extends StObject {
...
object `200Content184` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content184`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content184`] (val x: Self) extends AnyVal {
