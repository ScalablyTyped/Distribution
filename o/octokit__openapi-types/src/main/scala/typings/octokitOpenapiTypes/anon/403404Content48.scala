...
trait `403404Content48` extends StObject {
...
object `403404Content48` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`403404Content48`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `403404Content48`] (val x: Self) extends AnyVal {
