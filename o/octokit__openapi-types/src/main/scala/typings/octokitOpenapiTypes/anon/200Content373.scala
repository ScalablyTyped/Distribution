...
trait `200Content373` extends StObject {
...
object `200Content373` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content373`]
  }
  
  extension [Self <: `200Content373`](x: Self) {
    
    inline def set200(value: Content373): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
