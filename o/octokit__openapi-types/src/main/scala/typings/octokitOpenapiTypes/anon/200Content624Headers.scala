...
trait `200Content624Headers` extends StObject {
  
  /** Response */
  var `200`: Content624Headers
...
object `200Content624Headers` {
  
  inline def apply(
    `200`: Content624Headers,
    ...
    __obj.asInstanceOf[`200Content624Headers`]
  }
  
  extension [Self <: `200Content624Headers`](x: Self) {
    
    inline def set200(value: Content624Headers): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
