...
trait Responses200Content430 extends StObject {
  
  var parameters: PathEnterpriseString
  
  var responses: `200Content430`
}
object Responses200Content430 {
  
  inline def apply(parameters: PathEnterpriseString, responses: `200Content430`): Responses200Content430 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content430]
  }
  
  extension [Self <: Responses200Content430](x: Self) {
