...
trait Runattempt extends StObject {
  ...
  /** @enum {string|null} */
  /** @enum {string} */
  var conclusion: success | failure | _empty | skipped | cancelled | action_required | neutral | timed_out | Null
...
object Runattempt {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Runattempt]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Runattempt] (val x: Self) extends AnyVal {
    ...
    inline def setConclusion(value: success | failure | _empty | skipped | cancelled | action_required | neutral | timed_out): Self = StObject.set(x, "conclusion", value.asInstanceOf[js.Any])
