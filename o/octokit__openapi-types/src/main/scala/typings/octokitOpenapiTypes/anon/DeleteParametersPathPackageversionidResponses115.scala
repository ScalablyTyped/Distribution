...
trait DeleteParametersPathPackageversionidResponses115 extends StObject {
  ...
  /**
    ...
    */
  var delete: ParametersPathPackageversionidResponses115
...
object DeleteParametersPathPackageversionidResponses115 {
  
  inline def apply(delete: ParametersPathPackageversionidResponses115, get: ParametersPathPackageversionid): DeleteParametersPathPackageversionidResponses115 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathPackageversionidResponses115]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPathPackageversionidResponses115] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathPackageversionidResponses115): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
