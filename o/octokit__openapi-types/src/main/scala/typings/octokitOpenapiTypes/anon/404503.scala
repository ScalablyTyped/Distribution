...
object `404503` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `404503`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content82): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
