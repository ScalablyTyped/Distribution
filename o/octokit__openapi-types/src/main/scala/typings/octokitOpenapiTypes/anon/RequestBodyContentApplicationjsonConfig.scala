...
trait RequestBodyContentApplicationjsonConfig extends StObject {
  ...
  var responses: `20085404`
}
object RequestBodyContentApplicationjsonConfig {
  
  inline def apply(parameters: PathHookid, requestBody: ContentApplicationjsonConfig, responses: `20085404`): RequestBodyContentApplicationjsonConfig = {
  ...
  extension [Self <: RequestBodyContentApplicationjsonConfig](x: Self) {
    ...
    inline def setResponses(value: `20085404`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
