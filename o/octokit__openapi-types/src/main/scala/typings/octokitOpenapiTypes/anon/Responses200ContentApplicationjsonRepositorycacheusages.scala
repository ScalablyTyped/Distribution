...
object Responses200ContentApplicationjsonRepositorycacheusages {
  ...
  inline def apply(parameters: PathOrgString, responses: `200ContentApplicationjsonRepositorycacheusages`): Responses200ContentApplicationjsonRepositorycacheusages = {
