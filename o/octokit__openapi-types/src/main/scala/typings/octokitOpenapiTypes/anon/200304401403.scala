...
object `200304401403` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200304401403`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content43): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
