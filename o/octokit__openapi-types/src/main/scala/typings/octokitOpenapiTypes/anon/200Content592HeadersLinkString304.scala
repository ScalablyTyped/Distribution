...
trait `200Content592HeadersLinkString304` extends StObject {
...
object `200Content592HeadersLinkString304` {
  ...
  inline def apply(
    ...
    `404`: Content41,
    `422`: Content414
  ): `200Content592HeadersLinkString304` = {
    ...
    __obj.asInstanceOf[`200Content592HeadersLinkString304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content592HeadersLinkString304`] (val x: Self) extends AnyVal {
