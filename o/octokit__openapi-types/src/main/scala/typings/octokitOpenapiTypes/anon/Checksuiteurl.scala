...
trait Checksuiteurl extends StObject {
  ...
  /** @enum {string|null} */
  /** @enum {string} */
  var conclusion: success | failure | neutral | cancelled | timed_out | action_required | stale | _empty | skipped | Null
...
object Checksuiteurl {
  ...
  implicit open class MutableBuilder[Self <: Checksuiteurl] (val x: Self) extends AnyVal {
    ...
    inline def setConclusion(
      value: success | failure | neutral | cancelled | timed_out | action_required | stale | _empty | skipped
