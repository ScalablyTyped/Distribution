...
trait ParametersPathHookidOrg extends StObject {
  ...
  var responses: `200460`
}
object ParametersPathHookidOrg {
  
  inline def apply(parameters: PathHookidOrg, responses: `200460`): ParametersPathHookidOrg = {
  ...
  extension [Self <: ParametersPathHookidOrg](x: Self) {
    ...
    inline def setResponses(value: `200460`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
