...
object Responses200ContentApplicationjsonRepositoryselectionTotalcount {
  ...
  inline def apply(parameters: `416`, responses: `200ContentApplicationjsonRepositoryselectionTotalcount`): Responses200ContentApplicationjsonRepositoryselectionTotalcount = {
