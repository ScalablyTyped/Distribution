...
trait CommentsurlCreatedat extends StObject {
  ...
  /**
    ...
    */
  var performed_via_github_app: js.UndefOr[IdNameNodeid | Null] = js.undefined
...
object CommentsurlCreatedat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CommentsurlCreatedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommentsurlCreatedat] (val x: Self) extends AnyVal {
    ...
    inline def setPerformed_via_github_app(value: IdNameNodeid): Self = StObject.set(x, "performed_via_github_app", value.asInstanceOf[js.Any])
