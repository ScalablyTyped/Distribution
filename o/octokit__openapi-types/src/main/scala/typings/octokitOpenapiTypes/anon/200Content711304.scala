...
trait `200Content711304` extends StObject {
...
object `200Content711304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content711304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content711304`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content711): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
