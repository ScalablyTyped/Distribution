...
trait `200Content99403404` extends StObject {
...
object `200Content99403404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content99403404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content99403404`] (val x: Self) extends AnyVal {
