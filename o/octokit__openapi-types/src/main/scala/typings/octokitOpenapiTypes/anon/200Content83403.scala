...
trait `200Content83403` extends StObject {
...
object `200Content83403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content83403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content83403`] (val x: Self) extends AnyVal {
