...
trait SlugUpdatedat extends StObject {
...
object SlugUpdatedat {
  
  inline def apply(html_url: String, name: String, node_id: String): SlugUpdatedat = {
    ...
    __obj.asInstanceOf[SlugUpdatedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SlugUpdatedat] (val x: Self) extends AnyVal {
