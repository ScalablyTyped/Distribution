...
object `201ContentApplicationjsonDefaultDescription` {
  ...
  inline def apply(`201`: ContentApplicationjsonDefaultDescription, `404`: Content41, `422`: Content414): `201ContentApplicationjsonDefaultDescription` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `201ContentApplicationjsonDefaultDescription`] (val x: Self) extends AnyVal {
