...
trait `200Content294422` extends StObject {
...
object `200Content294422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content294422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content294422`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content294): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
