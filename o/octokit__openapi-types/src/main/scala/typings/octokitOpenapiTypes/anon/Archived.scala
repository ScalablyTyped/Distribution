...
trait Archived extends StObject {
  ...
  var code_of_conduct: js.UndefOr[Body] = js.undefined
...
object Archived {
  ...
  extension [Self <: Archived](x: Self) {
    ...
    inline def setCode_of_conduct(value: Body): Self = StObject.set(x, "code_of_conduct", value.asInstanceOf[js.Any])
