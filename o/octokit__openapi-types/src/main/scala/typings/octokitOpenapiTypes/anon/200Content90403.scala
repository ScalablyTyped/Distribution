...
trait `200Content90403` extends StObject {
...
object `200Content90403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content90403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content90403`] (val x: Self) extends AnyVal {
