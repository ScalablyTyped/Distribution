...
trait GetResponses200Content243 extends StObject {
  ...
  /**
    ...
    */
  var get: Responses200Content243
...
object GetResponses200Content243 {
  
  inline def apply(
    delete: ParametersPathRepoSecretnameResponses,
    get: Responses200Content243,
    put: RequestBodyContentApplicationjson191
  ): GetResponses200Content243 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content243]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses200Content243] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathRepoSecretnameResponses): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
    
    inline def setGet(value: Responses200Content243): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
