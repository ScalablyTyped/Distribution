...
object Deployment {
  ...
  implicit open class MutableBuilder[Self <: Deployment] (val x: Self) extends AnyVal {
    ...
    inline def setCheck_suite(value: Pullrequests): Self = StObject.set(x, "check_suite", value.asInstanceOf[js.Any])
