...
object `200304400` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200304400`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content267): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
