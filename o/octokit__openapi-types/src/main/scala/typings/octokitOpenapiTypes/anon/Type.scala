...
trait Type extends StObject {
  ...
  var before: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['parameters']['before-repo-date'] */ js.Any
  ] = js.undefined
  ...
  var since: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['parameters']['since-repo-date'] */ js.Any
  ] = js.undefined
...
object Type {
  ...
  implicit open class MutableBuilder[Self <: Type] (val x: Self) extends AnyVal {
    ...
    inline def setBefore(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['parameters']['before-repo-date'] */ js.Any
    ...
    inline def setSince(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['parameters']['since-repo-date'] */ js.Any
