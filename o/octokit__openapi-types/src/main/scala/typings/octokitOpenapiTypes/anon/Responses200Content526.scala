...
object Responses200Content526 {
  ...
  inline def apply(parameters: `472`, responses: `200Content526`): Responses200Content526 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content526]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content526] (val x: Self) extends AnyVal {
