...
trait EncryptedvalueKeyid extends StObject {
  ...
  var selected_repository_ids: js.UndefOr[js.Array[String | Double]] = js.undefined
...
object EncryptedvalueKeyid {
  ...
  inline def apply(visibility: all | `private` | selected): EncryptedvalueKeyid = {
  ...
  implicit open class MutableBuilder[Self <: EncryptedvalueKeyid] (val x: Self) extends AnyVal {
    ...
    inline def setSelected_repository_ids(value: js.Array[String | Double]): Self = StObject.set(x, "selected_repository_ids", value.asInstanceOf[js.Any])
    
    inline def setSelected_repository_idsUndefined: Self = StObject.set(x, "selected_repository_ids", js.undefined)
    
    inline def setSelected_repository_idsVarargs(value: (String | Double)*): Self = StObject.set(x, "selected_repository_ids", js.Array(value*))
