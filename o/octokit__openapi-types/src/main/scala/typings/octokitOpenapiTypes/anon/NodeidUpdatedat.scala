...
trait NodeidUpdatedat extends StObject {
...
object NodeidUpdatedat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[NodeidUpdatedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NodeidUpdatedat] (val x: Self) extends AnyVal {
