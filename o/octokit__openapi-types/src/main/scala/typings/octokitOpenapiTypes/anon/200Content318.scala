...
trait `200Content318` extends StObject {
...
object `200Content318` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content318`]
  }
  
  extension [Self <: `200Content318`](x: Self) {
    
    inline def set200(value: Content318): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
