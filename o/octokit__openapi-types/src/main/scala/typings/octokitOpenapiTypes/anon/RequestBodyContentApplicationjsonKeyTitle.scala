...
trait RequestBodyContentApplicationjsonKeyTitle extends StObject {
  ...
  var responses: `201Content388`
}
object RequestBodyContentApplicationjsonKeyTitle {
  
  inline def apply(requestBody: ContentApplicationjsonKeyTitle, responses: `201Content388`): RequestBodyContentApplicationjsonKeyTitle = {
  ...
  implicit open class MutableBuilder[Self <: RequestBodyContentApplicationjsonKeyTitle] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `201Content388`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
