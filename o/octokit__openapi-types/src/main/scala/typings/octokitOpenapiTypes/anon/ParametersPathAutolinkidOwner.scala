...
trait ParametersPathAutolinkidOwner extends StObject {
  ...
  var responses: `200658`
}
object ParametersPathAutolinkidOwner {
  
  inline def apply(parameters: PathAutolinkidOwner, responses: `200658`): ParametersPathAutolinkidOwner = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathAutolinkidOwner] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200658`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
