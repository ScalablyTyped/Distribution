...
trait ParametersPathHookidOwnerRequestBody extends StObject {
...
object ParametersPathHookidOwnerRequestBody {
  
  inline def apply(parameters: PathHookidOwner, responses: `200Content2`): ParametersPathHookidOwnerRequestBody = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[ParametersPathHookidOwnerRequestBody]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ParametersPathHookidOwnerRequestBody] (val x: Self) extends AnyVal {
