...
trait Securityadvisory extends StObject {
  ...
  var dependency: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-dependency'] */ js.Any
  
  var dismissed_at: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-dismissed_at'] */ js.Any
  ...
  var dismissed_comment: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-dismissed-comment'] */ js.Any
  
  var dismissed_reason: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-dismissed-reason'] */ js.Any
  
  var fixed_at: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-fixed-at'] */ js.Any
  ...
  var state: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-state'] */ js.Any
...
object Securityadvisory {
  ...
  inline def apply(
    ...
    dependency: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-dependency'] */ js.Any,
    dismissed_at: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-dismissed_at'] */ js.Any,
    ...
    dismissed_comment: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-dismissed-comment'] */ js.Any,
    dismissed_reason: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-dismissed-reason'] */ js.Any,
    fixed_at: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-fixed-at'] */ js.Any,
    ...
    state: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-state'] */ js.Any,
    ...
    val __obj = js.Dynamic.literal(created_at = created_at.asInstanceOf[js.Any], dependency = dependency.asInstanceOf[js.Any], dismissed_at = dismissed_at.asInstanceOf[js.Any], dismissed_by = dismissed_by.asInstanceOf[js.Any], dismissed_comment = dismissed_comment.asInstanceOf[js.Any], dismissed_reason = dismissed_reason.asInstanceOf[js.Any], fixed_at = fixed_at.asInstanceOf[js.Any], html_url = html_url.asInstanceOf[js.Any], number = number.asInstanceOf[js.Any], security_advisory = security_advisory.asInstanceOf[js.Any], security_vulnerability = security_vulnerability.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any], updated_at = updated_at.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
  ...
  implicit open class MutableBuilder[Self <: Securityadvisory] (val x: Self) extends AnyVal {
    ...
    inline def setDependency(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-dependency'] */ js.Any
    ): Self = StObject.set(x, "dependency", value.asInstanceOf[js.Any])
    
    inline def setDismissed_at(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-dismissed_at'] */ js.Any
    ...
    inline def setFixed_at(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-fixed-at'] */ js.Any
    ...
    inline def setState(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['schemas']['dependabot-alert-state'] */ js.Any
