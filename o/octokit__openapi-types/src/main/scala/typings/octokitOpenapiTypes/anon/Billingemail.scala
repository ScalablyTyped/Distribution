...
trait Billingemail extends StObject {
  ...
  /**
    ...
    */
  var secret_scanning_push_protection_custom_link: js.UndefOr[String | Null] = js.undefined
...
object Billingemail {
  ...
  implicit open class MutableBuilder[Self <: Billingemail] (val x: Self) extends AnyVal {
    ...
    inline def setSecret_scanning_push_protection_custom_linkNull: Self = StObject.set(x, "secret_scanning_push_protection_custom_link", null)
