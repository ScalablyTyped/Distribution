...
object Responses200Content458 {
  ...
  inline def apply(parameters: `4`, responses: `200Content458`): Responses200Content458 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content458]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content458] (val x: Self) extends AnyVal {
