...
trait Unitcount extends StObject {
...
object Unitcount {
  ...
  inline def apply(account: IdLogin, billing_cycle: String, on_free_trial: Boolean, plan: Bullets, unit_count: Double): Unitcount = {
    ...
    __obj.asInstanceOf[Unitcount]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Unitcount] (val x: Self) extends AnyVal {
