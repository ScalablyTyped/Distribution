...
trait NodeidPerformedviagithubapp extends StObject {
...
object NodeidPerformedviagithubapp {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NodeidPerformedviagithubapp] (val x: Self) extends AnyVal {
