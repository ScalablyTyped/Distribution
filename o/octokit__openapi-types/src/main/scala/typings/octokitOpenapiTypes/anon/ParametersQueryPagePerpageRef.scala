...
trait ParametersQueryPagePerpageRef extends StObject {
  ...
  var responses: `200Content453`
}
object ParametersQueryPagePerpageRef {
  
  inline def apply(parameters: QueryPagePerpageRef, responses: `200Content453`): ParametersQueryPagePerpageRef = {
  ...
  extension [Self <: ParametersQueryPagePerpageRef](x: Self) {
    ...
    inline def setResponses(value: `200Content453`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
