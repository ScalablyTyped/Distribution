...
trait EnvironmentnameOwnerProtectionruleid extends StObject {
...
object EnvironmentnameOwnerProtectionruleid {
  
  inline def apply(environment_name: String, owner: String, protection_rule_id: Double, repo: String): EnvironmentnameOwnerProtectionruleid = {
    ...
    __obj.asInstanceOf[EnvironmentnameOwnerProtectionruleid]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EnvironmentnameOwnerProtectionruleid] (val x: Self) extends AnyVal {
