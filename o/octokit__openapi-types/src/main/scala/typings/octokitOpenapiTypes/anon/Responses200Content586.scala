...
object Responses200Content586 {
  ...
  inline def apply(parameters: PathOwnerString, responses: `200Content586`): Responses200Content586 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content586]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content586] (val x: Self) extends AnyVal {
