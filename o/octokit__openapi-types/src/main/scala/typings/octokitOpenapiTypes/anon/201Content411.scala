...
trait `201Content411` extends StObject {
...
object `201Content411` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content411`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content411`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content411): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
