...
trait Runnergroupid extends StObject {
  ...
  /** @enum {string|null} */
  var conclusion: success | failure | _empty | cancelled | neutral | Null
  ...
  var steps: js.Array[CompletedatConclusion]
...
object Runnergroupid {
  ...
  inline def apply(
    ...
    steps: js.Array[CompletedatConclusion],
    url: String
  ): Runnergroupid = {
  ...
  implicit open class MutableBuilder[Self <: Runnergroupid] (val x: Self) extends AnyVal {
    ...
    inline def setConclusion(value: success | failure | _empty | cancelled | neutral): Self = StObject.set(x, "conclusion", value.asInstanceOf[js.Any])
    ...
    inline def setSteps(value: js.Array[CompletedatConclusion]): Self = StObject.set(x, "steps", value.asInstanceOf[js.Any])
    
    inline def setStepsVarargs(value: CompletedatConclusion*): Self = StObject.set(x, "steps", js.Array(value*))
