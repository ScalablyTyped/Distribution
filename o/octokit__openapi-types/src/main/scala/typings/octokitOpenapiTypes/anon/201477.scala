...
object `201477` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201477`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201477`] (val x: Self) extends AnyVal {
    
    inline def set201(value: `477`): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
