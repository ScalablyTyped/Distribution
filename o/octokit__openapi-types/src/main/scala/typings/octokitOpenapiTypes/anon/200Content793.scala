...
trait `200Content793` extends StObject {
...
object `200Content793` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content793`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content793`] (val x: Self) extends AnyVal {
