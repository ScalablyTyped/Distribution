...
trait `200Content104403` extends StObject {
...
object `200Content104403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content104403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content104403`] (val x: Self) extends AnyVal {
