...
trait `201Content490` extends StObject {
...
object `201Content490` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content490`]
  }
  
  extension [Self <: `201Content490`](x: Self) {
    
    inline def set201(value: Content490): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
