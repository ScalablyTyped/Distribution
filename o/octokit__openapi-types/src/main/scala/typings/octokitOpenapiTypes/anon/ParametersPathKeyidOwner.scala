...
trait ParametersPathKeyidOwner extends StObject {
  ...
  var responses: `200279`
}
object ParametersPathKeyidOwner {
  
  inline def apply(parameters: PathKeyidOwner, responses: `200279`): ParametersPathKeyidOwner = {
  ...
  extension [Self <: ParametersPathKeyidOwner](x: Self) {
    ...
    inline def setResponses(value: `200279`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
