...
trait ParametersPathIssuenumberName extends StObject {
  ...
  var responses: `200264`
}
object ParametersPathIssuenumberName {
  
  inline def apply(parameters: PathIssuenumberName, responses: `200264`): ParametersPathIssuenumberName = {
  ...
  extension [Self <: ParametersPathIssuenumberName](x: Self) {
    ...
    inline def setResponses(value: `200264`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
