...
trait ParametersPathIssuenumberName extends StObject {
  ...
  var responses: `200271`
}
object ParametersPathIssuenumberName {
  
  inline def apply(parameters: PathIssuenumberName, responses: `200271`): ParametersPathIssuenumberName = {
  ...
  extension [Self <: ParametersPathIssuenumberName](x: Self) {
    ...
    inline def setResponses(value: `200271`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
