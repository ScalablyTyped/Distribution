...
trait `200HeadersContentType` extends StObject {
  
  /** @description Response */
  var `200`: HeadersContentType
...
object `200HeadersContentType` {
  
  inline def apply(
    `200`: HeadersContentType,
  ...
  ): `200HeadersContentType` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200HeadersContentType`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200HeadersContentType`] (val x: Self) extends AnyVal {
    
    inline def set200(value: HeadersContentType): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
