...
object Responses200Content356 {
  ...
  inline def apply(parameters: `141`, responses: `200Content356`): Responses200Content356 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content356]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content356] (val x: Self) extends AnyVal {
