...
trait `201Content295` extends StObject {
...
object `201Content295` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content295`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content295`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content295): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
