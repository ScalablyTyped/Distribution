...
trait CommitsCommitsurl extends StObject {
...
object CommitsCommitsurl {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CommitsCommitsurl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommitsCommitsurl] (val x: Self) extends AnyVal {
    ...
    inline def setHead(value: RefString): Self = StObject.set(x, "head", value.asInstanceOf[js.Any])
