...
trait PageParticipating extends StObject {
...
object PageParticipating {
  
  inline def apply(): PageParticipating = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PageParticipating]
  }
  
  extension [Self <: PageParticipating](x: Self) {
