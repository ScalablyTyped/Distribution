...
trait DeleteRequestBodyResponses158 extends StObject {
  
  /**
    * Delete an email address for the authenticated user
    * @description This endpoint is accessible with the `user` scope.
    */
  var delete: RequestBodyResponses158
...
object DeleteRequestBodyResponses158 {
  
  inline def apply(
    delete: RequestBodyResponses158,
    get: Responses200Content457HeadersLink,
    post: Responses201304401403404
  ): DeleteRequestBodyResponses158 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteRequestBodyResponses158]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteRequestBodyResponses158] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: RequestBodyResponses158): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
