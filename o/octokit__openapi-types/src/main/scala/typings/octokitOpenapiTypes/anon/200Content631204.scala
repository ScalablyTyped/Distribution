...
trait `200Content631204` extends StObject {
...
object `200Content631204` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content631204`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content631204`] (val x: Self) extends AnyVal {
