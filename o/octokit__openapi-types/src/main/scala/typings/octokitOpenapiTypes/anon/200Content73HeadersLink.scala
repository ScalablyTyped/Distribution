...
trait `200Content73HeadersLink` extends StObject {
  
  /** Response */
  var `200`: Content73HeadersLink
...
object `200Content73HeadersLink` {
  
  inline def apply(
    `200`: Content73HeadersLink,
  ...
  ): `200Content73HeadersLink` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200Content73HeadersLink`]
  }
  
  extension [Self <: `200Content73HeadersLink`](x: Self) {
    
    inline def set200(value: Content73HeadersLink): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
