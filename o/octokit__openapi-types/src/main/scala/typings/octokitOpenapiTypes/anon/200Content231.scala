...
trait `200Content231` extends StObject {
...
object `200Content231` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content231`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content231`] (val x: Self) extends AnyVal {
