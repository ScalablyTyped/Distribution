...
trait BodyChangedfiles extends StObject {
...
object BodyChangedfiles {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[BodyChangedfiles]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BodyChangedfiles] (val x: Self) extends AnyVal {
