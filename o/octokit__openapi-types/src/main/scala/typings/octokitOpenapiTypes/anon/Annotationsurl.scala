...
object Annotationsurl {
  ...
  inline def apply(annotations_count: Double, annotations_url: String): Annotationsurl = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Annotationsurl] (val x: Self) extends AnyVal {
