...
trait `201Content654` extends StObject {
...
object `201Content654` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content654`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content654`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content654): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
