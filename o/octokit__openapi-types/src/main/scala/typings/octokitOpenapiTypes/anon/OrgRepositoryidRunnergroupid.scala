...
object OrgRepositoryidRunnergroupid {
  ...
  inline def apply(org_ : String, repository_id: Double, runner_group_id: Double): OrgRepositoryidRunnergroupid = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OrgRepositoryidRunnergroupid] (val x: Self) extends AnyVal {
