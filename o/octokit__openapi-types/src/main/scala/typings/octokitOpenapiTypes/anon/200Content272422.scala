...
trait `200Content272422` extends StObject {
...
object `200Content272422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content272422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content272422`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content272): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
