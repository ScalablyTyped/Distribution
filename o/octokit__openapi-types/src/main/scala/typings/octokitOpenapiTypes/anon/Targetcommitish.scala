...
trait Targetcommitish extends StObject {
...
object Targetcommitish {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(author = author.asInstanceOf[js.Any], created_at = created_at.asInstanceOf[js.Any], draft = draft.asInstanceOf[js.Any], html_url = html_url.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], prerelease = prerelease.asInstanceOf[js.Any], published_at = published_at.asInstanceOf[js.Any], tag_name = tag_name.asInstanceOf[js.Any], target_commitish = target_commitish.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[Targetcommitish]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Targetcommitish] (val x: Self) extends AnyVal {
