...
trait RepositorySecurityadvisory extends StObject {
...
object RepositorySecurityadvisory {
  
  inline def apply(security_advisory: Cwes): RepositorySecurityadvisory = {
    val __obj = js.Dynamic.literal(action = "published", security_advisory = security_advisory.asInstanceOf[js.Any])
    __obj.asInstanceOf[RepositorySecurityadvisory]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RepositorySecurityadvisory] (val x: Self) extends AnyVal {
