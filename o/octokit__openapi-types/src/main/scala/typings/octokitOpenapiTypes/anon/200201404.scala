...
object `200201404` {
  ...
  extension [Self <: `200201404`](x: Self) {
    ...
    inline def set200(value: Content477): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
    
    inline def set201(value: Content477): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
