...
trait EventsName extends StObject {
...
object EventsName {
  ...
  inline def apply(): EventsName = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EventsName]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EventsName] (val x: Self) extends AnyVal {
