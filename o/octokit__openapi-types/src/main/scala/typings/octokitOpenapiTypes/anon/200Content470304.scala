...
trait `200Content470304` extends StObject {
...
object `200Content470304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content470304`]
  }
  
  extension [Self <: `200Content470304`](x: Self) {
    
    inline def set200(value: Content470): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
