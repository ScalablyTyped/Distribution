...
trait `200Content71304` extends StObject {
...
object `200Content71304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content71304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content71304`] (val x: Self) extends AnyVal {
