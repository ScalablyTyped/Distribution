...
trait NodeidReviewers extends StObject {
...
object NodeidReviewers {
  
  inline def apply(id: Double, node_id: String, `type`: String): NodeidReviewers = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], node_id = node_id.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[NodeidReviewers]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NodeidReviewers] (val x: Self) extends AnyVal {
