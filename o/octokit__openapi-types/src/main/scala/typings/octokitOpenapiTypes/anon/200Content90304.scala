...
trait `200Content90304` extends StObject {
...
object `200Content90304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content90304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content90304`] (val x: Self) extends AnyVal {
