...
trait ParametersPathHookidOwnerRepo extends StObject {
  ...
  var responses: `200522`
}
object ParametersPathHookidOwnerRepo {
  
  inline def apply(parameters: PathHookidOwnerRepo, responses: `200522`): ParametersPathHookidOwnerRepo = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathHookidOwnerRepo] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200522`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
