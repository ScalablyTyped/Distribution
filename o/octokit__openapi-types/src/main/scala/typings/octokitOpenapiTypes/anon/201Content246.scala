...
trait `201Content246` extends StObject {
...
object `201Content246` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content246`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content246`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content246): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
