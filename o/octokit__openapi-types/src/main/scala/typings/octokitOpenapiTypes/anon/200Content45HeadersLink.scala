...
trait `200Content45HeadersLink` extends StObject {
...
object `200Content45HeadersLink` {
  
  inline def apply(
    `200`: Content45HeadersLink,
  ...
  ): `200Content45HeadersLink` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("401")(`401`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200Content45HeadersLink`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content45HeadersLink`] (val x: Self) extends AnyVal {
