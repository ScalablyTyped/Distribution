...
trait `429` extends StObject {
  ...
  /** Response */
  var `200`: ContentApplicationscimjson
  ...
  var `429`: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['responses']['scim_too_many_requests'] */ js.Any
}
object `429` {
  
  inline def apply(
    `200`: ContentApplicationscimjson,
    ...
    `429`: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['responses']['scim_too_many_requests'] */ js.Any
  ): `429` = {
  ...
  extension [Self <: `429`](x: Self) {
    ...
    inline def set200(value: ContentApplicationscimjson): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
    ...
    inline def set429(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.components['responses']['scim_too_many_requests'] */ js.Any
    ): Self = StObject.set(x, "429", value.asInstanceOf[js.Any])
  }
}
