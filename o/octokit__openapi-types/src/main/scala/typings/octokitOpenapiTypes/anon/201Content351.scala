...
trait `201Content351` extends StObject {
...
object `201Content351` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content351`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content351`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content351): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
