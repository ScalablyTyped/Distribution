...
trait `200HeadersXCommonMarkerVersionString` extends StObject {
...
object `200HeadersXCommonMarkerVersionString` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200HeadersXCommonMarkerVersionString`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200HeadersXCommonMarkerVersionString`] (val x: Self) extends AnyVal {
