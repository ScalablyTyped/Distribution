...
trait `404410422` extends StObject {
  ...
  /** Response */
  var `201`: Content264HeadersLocation
...
object `404410422` {
  ...
  extension [Self <: `404410422`](x: Self) {
    ...
    inline def set201(value: Content264HeadersLocation): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
