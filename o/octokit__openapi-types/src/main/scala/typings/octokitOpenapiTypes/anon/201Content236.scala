...
trait `201Content236` extends StObject {
...
object `201Content236` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content236`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content236`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content236): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
