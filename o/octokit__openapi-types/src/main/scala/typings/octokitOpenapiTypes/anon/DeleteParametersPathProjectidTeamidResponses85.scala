...
trait DeleteParametersPathProjectidTeamidResponses85 extends StObject {
  ...
  /**
    ...
    */
  var delete: ParametersPathProjectidTeamidResponses85
...
object DeleteParametersPathProjectidTeamidResponses85 {
  
  inline def apply(
    delete: ParametersPathProjectidTeamidResponses85,
    get: ParametersPathProjectidTeamid,
    put: Responses403ContentApplicationjsonDocumentationurl404
  ): DeleteParametersPathProjectidTeamidResponses85 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathProjectidTeamidResponses85]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPathProjectidTeamidResponses85] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathProjectidTeamidResponses85): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
