...
trait CommentsCommitid extends StObject {
  ...
  var comments: js.UndefOr[js.Array[AuthorassociationBody]] = js.undefined
...
object CommentsCommitid {
  ...
  extension [Self <: CommentsCommitid](x: Self) {
    ...
    inline def setCommentsVarargs(value: AuthorassociationBody*): Self = StObject.set(x, "comments", js.Array(value*))
