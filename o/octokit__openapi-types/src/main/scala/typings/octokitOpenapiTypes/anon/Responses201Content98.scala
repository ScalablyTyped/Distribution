...
trait Responses201Content98 extends StObject {
...
object Responses201Content98 {
  
  inline def apply(parameters: `55`, responses: `201Content98`): Responses201Content98 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses201Content98]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses201Content98] (val x: Self) extends AnyVal {
