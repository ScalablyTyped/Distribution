...
object Responses200ContentApplicationjsonInstallationsTotalcount {
  ...
  inline def apply(parameters: PathOrgStringQuery, responses: `200ContentApplicationjsonInstallationsTotalcount`): Responses200ContentApplicationjsonInstallationsTotalcount = {
