...
object Responses200ContentApplicationjsonInstallationsTotalcount {
  ...
  inline def apply(parameters: PathOrgStringQuery426, responses: `200ContentApplicationjsonInstallationsTotalcount`): Responses200ContentApplicationjsonInstallationsTotalcount = {
