...
object Responses200Content634 {
  ...
  inline def apply(parameters: `630`, responses: `200Content634`): Responses200Content634 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content634]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content634] (val x: Self) extends AnyVal {
