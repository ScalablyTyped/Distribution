...
trait GetResponses200Content154 extends StObject {
  ...
  /**
    ...
    */
  var get: Responses200Content154
...
object GetResponses200Content154 {
  
  inline def apply(get: Responses200Content154, put: RequestBodyContentApplicationjsonEnabled): GetResponses200Content154 = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content154]
  }
  
  extension [Self <: GetResponses200Content154](x: Self) {
    
    inline def setGet(value: Responses200Content154): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
