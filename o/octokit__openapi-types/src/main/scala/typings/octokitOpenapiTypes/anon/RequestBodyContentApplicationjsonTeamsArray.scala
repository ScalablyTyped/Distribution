...
trait RequestBodyContentApplicationjsonTeamsArray extends StObject {
  ...
  var responses: `200180422`
}
object RequestBodyContentApplicationjsonTeamsArray {
  
  inline def apply(parameters: PathBranch, requestBody: ContentApplicationjsonTeamsArray, responses: `200180422`): RequestBodyContentApplicationjsonTeamsArray = {
  ...
  extension [Self <: RequestBodyContentApplicationjsonTeamsArray](x: Self) {
    ...
    inline def setResponses(value: `200180422`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
