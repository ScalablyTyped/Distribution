...
trait ParametersQueryKeyRef extends StObject {
  ...
  var responses: `200172`
}
object ParametersQueryKeyRef {
  
  inline def apply(parameters: QueryKeyRef, responses: `200172`): ParametersQueryKeyRef = {
  ...
  implicit open class MutableBuilder[Self <: ParametersQueryKeyRef] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200172`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
