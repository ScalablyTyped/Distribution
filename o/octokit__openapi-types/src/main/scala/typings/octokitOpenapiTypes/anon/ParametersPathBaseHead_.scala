...
trait ParametersPathBaseHead_ extends StObject {
  ...
  var responses: `200Content261`
}
object ParametersPathBaseHead_ {
  
  inline def apply(parameters: PathBaseHead_, responses: `200Content261`): ParametersPathBaseHead_ = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathBaseHead_] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200Content261`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
