...
trait GetResponses200Content387 extends StObject {
  ...
  /**
    ...
    */
  var get: Responses200Content387
...
object GetResponses200Content387 {
  
  inline def apply(get: Responses200Content387, post: RequestBodyContentApplicationjsonKeyTitle): GetResponses200Content387 = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content387]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses200Content387] (val x: Self) extends AnyVal {
    
    inline def setGet(value: Responses200Content387): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
