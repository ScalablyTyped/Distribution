...
trait CountPath extends StObject {
...
object CountPath {
  ...
  inline def apply(count: Double, path: String, title: String, uniques: Double): CountPath = {
    ...
    __obj.asInstanceOf[CountPath]
  }
  
  extension [Self <: CountPath](x: Self) {
