...
object Originalposition {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(_links = _links.asInstanceOf[js.Any], author_association = author_association.asInstanceOf[js.Any], body = body.asInstanceOf[js.Any], commit_id = commit_id.asInstanceOf[js.Any], created_at = created_at.asInstanceOf[js.Any], diff_hunk = diff_hunk.asInstanceOf[js.Any], html_url = html_url.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], node_id = node_id.asInstanceOf[js.Any], original_commit_id = original_commit_id.asInstanceOf[js.Any], original_line = original_line.asInstanceOf[js.Any], original_position = original_position.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], pull_request_url = pull_request_url.asInstanceOf[js.Any], reactions = reactions.asInstanceOf[js.Any], side = side.asInstanceOf[js.Any], updated_at = updated_at.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], line = null, original_start_line = null, position = null, pull_request_review_id = null, start_line = null, start_side = null, user = null)
    __obj.asInstanceOf[Originalposition]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Originalposition] (val x: Self) extends AnyVal {
