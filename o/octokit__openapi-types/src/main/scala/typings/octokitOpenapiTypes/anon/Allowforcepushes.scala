...
trait Allowforcepushes extends StObject {
  ...
  var allow_deletions: js.UndefOr[`408`] = js.undefined
  
  var allow_force_pushes: js.UndefOr[`408`] = js.undefined
  
  var block_creations: js.UndefOr[`408`] = js.undefined
  ...
  var required_linear_history: js.UndefOr[`408`] = js.undefined
  ...
  var required_status_checks: js.UndefOr[Contextsurl] = js.undefined
  
  var restrictions: js.UndefOr[Appsurl] = js.undefined
  
  var url: js.UndefOr[String] = js.undefined
}
object Allowforcepushes {
  
  inline def apply(): Allowforcepushes = {
  ...
  extension [Self <: Allowforcepushes](x: Self) {
    ...
    inline def setAllow_deletions(value: `408`): Self = StObject.set(x, "allow_deletions", value.asInstanceOf[js.Any])
    
    inline def setAllow_deletionsUndefined: Self = StObject.set(x, "allow_deletions", js.undefined)
    
    inline def setAllow_force_pushes(value: `408`): Self = StObject.set(x, "allow_force_pushes", value.asInstanceOf[js.Any])
    
    inline def setAllow_force_pushesUndefined: Self = StObject.set(x, "allow_force_pushes", js.undefined)
    
    inline def setBlock_creations(value: `408`): Self = StObject.set(x, "block_creations", value.asInstanceOf[js.Any])
    ...
    inline def setRequired_linear_history(value: `408`): Self = StObject.set(x, "required_linear_history", value.asInstanceOf[js.Any])
