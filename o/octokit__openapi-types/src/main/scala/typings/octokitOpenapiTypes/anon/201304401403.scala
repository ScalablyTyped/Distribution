...
object `201304401403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201304401403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201304401403`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content155): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
