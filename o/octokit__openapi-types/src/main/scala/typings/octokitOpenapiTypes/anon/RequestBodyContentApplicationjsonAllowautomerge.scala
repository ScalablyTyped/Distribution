...
object RequestBodyContentApplicationjsonAllowautomerge {
  ...
  inline def apply(parameters: PathOrg, requestBody: ContentApplicationjsonAllowautomerge, responses: `201403422`): RequestBodyContentApplicationjsonAllowautomerge = {
