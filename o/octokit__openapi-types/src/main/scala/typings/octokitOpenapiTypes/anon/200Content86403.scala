...
trait `200Content86403` extends StObject {
...
object `200Content86403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content86403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content86403`] (val x: Self) extends AnyVal {
