...
trait `200Content593304` extends StObject {
...
object `200Content593304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content593304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content593304`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content593): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
