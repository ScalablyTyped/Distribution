...
trait `200Content654` extends StObject {
...
object `200Content654` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content654`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content654`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content654): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
