...
trait Originalenvironment extends StObject {
...
object Originalenvironment {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Originalenvironment]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Originalenvironment] (val x: Self) extends AnyVal {
