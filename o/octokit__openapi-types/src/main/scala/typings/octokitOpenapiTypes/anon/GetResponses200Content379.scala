...
trait GetResponses200Content379 extends StObject {
  ...
  /**
    ...
    */
  var post: Responses200Content380
}
object GetResponses200Content379 {
  
  inline def apply(get: Responses200Content379, post: Responses200Content380): GetResponses200Content379 = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content379]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses200Content379] (val x: Self) extends AnyVal {
    
    inline def setGet(value: Responses200Content379): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setPost(value: Responses200Content380): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
