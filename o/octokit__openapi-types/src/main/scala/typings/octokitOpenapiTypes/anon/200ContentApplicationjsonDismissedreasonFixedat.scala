...
trait `200ContentApplicationjsonDismissedreasonFixedat` extends StObject {
...
object `200ContentApplicationjsonDismissedreasonFixedat` {
  ...
  inline def apply(
  ...
  ): `200ContentApplicationjsonDismissedreasonFixedat` = {
    ...
    __obj.asInstanceOf[`200ContentApplicationjsonDismissedreasonFixedat`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200ContentApplicationjsonDismissedreasonFixedat`] (val x: Self) extends AnyVal {
