...
trait CommentsurlCommits extends StObject {
...
object CommentsurlCommits {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CommentsurlCommits]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommentsurlCommits] (val x: Self) extends AnyVal {
    ...
    inline def setBase(value: RepoFork): Self = StObject.set(x, "base", value.asInstanceOf[js.Any])
