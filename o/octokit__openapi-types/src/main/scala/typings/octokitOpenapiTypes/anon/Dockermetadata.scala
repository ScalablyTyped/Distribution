...
trait Dockermetadata extends StObject {
...
object Dockermetadata {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Dockermetadata]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Dockermetadata] (val x: Self) extends AnyVal {
    ...
    inline def setPackage_files(value: js.Array[Sha1]): Self = StObject.set(x, "package_files", value.asInstanceOf[js.Any])
    
    inline def setPackage_filesVarargs(value: Sha1*): Self = StObject.set(x, "package_files", js.Array(value*))
    ...
    inline def setRelease(value: Publishedat): Self = StObject.set(x, "release", value.asInstanceOf[js.Any])
