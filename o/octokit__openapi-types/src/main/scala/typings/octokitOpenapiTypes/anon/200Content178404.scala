...
trait `200Content178404` extends StObject {
...
object `200Content178404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content178404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content178404`] (val x: Self) extends AnyVal {
