...
trait Repositoriesadded extends StObject {
  ...
  var repositories_removed: js.Array[FullnameId]
...
object Repositoriesadded {
  ...
  implicit open class MutableBuilder[Self <: Repositoriesadded] (val x: Self) extends AnyVal {
    ...
    inline def setRepositories_removed(value: js.Array[FullnameId]): Self = StObject.set(x, "repositories_removed", value.asInstanceOf[js.Any])
    
    inline def setRepositories_removedVarargs(value: FullnameId*): Self = StObject.set(x, "repositories_removed", js.Array(value*))
