...
trait `200Content99422` extends StObject {
...
object `200Content99422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content99422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content99422`] (val x: Self) extends AnyVal {
