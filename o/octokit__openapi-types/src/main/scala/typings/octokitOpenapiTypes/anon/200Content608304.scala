...
trait `200Content608304` extends StObject {
...
object `200Content608304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content608304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content608304`] (val x: Self) extends AnyVal {
