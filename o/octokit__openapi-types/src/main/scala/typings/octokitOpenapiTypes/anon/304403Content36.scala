...
trait `304403Content36` extends StObject {
...
object `304403Content36` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`304403Content36`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `304403Content36`] (val x: Self) extends AnyVal {
