...
trait BypassactorsConditions extends StObject {
...
object BypassactorsConditions {
  
  inline def apply(enforcement: disabled | active | evaluate, name: String): BypassactorsConditions = {
    val __obj = js.Dynamic.literal(enforcement = enforcement.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[BypassactorsConditions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BypassactorsConditions] (val x: Self) extends AnyVal {
