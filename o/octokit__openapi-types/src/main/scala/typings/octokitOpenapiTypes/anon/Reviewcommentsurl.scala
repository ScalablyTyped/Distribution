...
trait Reviewcommentsurl extends StObject {
...
object Reviewcommentsurl {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Reviewcommentsurl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Reviewcommentsurl] (val x: Self) extends AnyVal {
