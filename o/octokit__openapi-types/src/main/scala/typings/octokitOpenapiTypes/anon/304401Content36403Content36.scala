...
trait `304401Content36403Content36` extends StObject {
...
object `304401Content36403Content36` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`304401Content36403Content36`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `304401Content36403Content36`] (val x: Self) extends AnyVal {
