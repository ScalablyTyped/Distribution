...
trait Removeevents extends StObject {
  ...
  var config: js.UndefOr[AddressContenttype] = js.undefined
...
object Removeevents {
  ...
  inline def apply(): Removeevents = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Removeevents]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Removeevents] (val x: Self) extends AnyVal {
    ...
    inline def setConfig(value: AddressContenttype): Self = StObject.set(x, "config", value.asInstanceOf[js.Any])
