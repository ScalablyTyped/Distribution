...
trait `200Content508304` extends StObject {
...
object `200Content508304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content508304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content508304`] (val x: Self) extends AnyVal {
