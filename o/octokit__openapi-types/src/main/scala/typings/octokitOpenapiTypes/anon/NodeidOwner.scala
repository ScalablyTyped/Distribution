...
import typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.merge_group
import typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.merge_queue_entry
...
import typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.secret_scanning_alert_location
...
import typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.workflow_job
import typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.workflow_run
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait NodeidOwner extends StObject {
  ...
  var events: js.UndefOr[
    js.Array[
      branch_protection_rule | check_run | check_suite | code_scanning_alert | commit_comment | content_reference | create | delete | deployment | deployment_review | deployment_status | deploy_key | discussion | discussion_comment | fork | gollum | issues | issue_comment | label | member_ | membership | milestone | organization_ | org_block | page_build | project | project_card | project_column | public | pull_request | pull_request_review | pull_request_review_comment | push | registry_package | release | repository_ | repository_dispatch | secret_scanning_alert | star | status | team_ | team_add | watch | workflow_dispatch | workflow_run | merge_queue_entry | workflow_job | pull_request_review_thread | secret_scanning_alert_location | merge_group
    ]
  ] = js.undefined
...
object NodeidOwner {
  ...
  inline def apply(html_url: String, name: String, node_id: String): NodeidOwner = {
    ...
    __obj.asInstanceOf[NodeidOwner]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NodeidOwner] (val x: Self) extends AnyVal {
