...
trait DeleteParametersPathDiscussionnumberResponses extends StObject {
  ...
  /**
    ...
    */
  var patch: RequestBodyContentApplicationjsonTitle
}
object DeleteParametersPathDiscussionnumberResponses {
  ...
  inline def apply(
    ...
    patch: RequestBodyContentApplicationjsonTitle
  ...
  extension [Self <: DeleteParametersPathDiscussionnumberResponses](x: Self) {
    ...
    inline def setPatch(value: RequestBodyContentApplicationjsonTitle): Self = StObject.set(x, "patch", value.asInstanceOf[js.Any])
  }
}
