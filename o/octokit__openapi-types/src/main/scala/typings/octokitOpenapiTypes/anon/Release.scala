...
object Release {
  ...
  inline def apply(release: Assetsurl, repository: Allowupdatebranch, sender: Avatarurl): Release = {
    val __obj = js.Dynamic.literal(action = "created", release = release.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
