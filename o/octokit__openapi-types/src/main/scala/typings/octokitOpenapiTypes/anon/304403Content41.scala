...
trait `304403Content41` extends StObject {
...
object `304403Content41` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`304403Content41`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `304403Content41`] (val x: Self) extends AnyVal {
