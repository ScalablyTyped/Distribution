...
object `201409` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `201409`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content286): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
