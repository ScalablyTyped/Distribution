...
object Responses200Content527 {
  ...
  inline def apply(parameters: `496`, responses: `200Content527`): Responses200Content527 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content527]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content527] (val x: Self) extends AnyVal {
