...
trait `201Content792` extends StObject {
...
object `201Content792` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content792`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content792`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content792): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
