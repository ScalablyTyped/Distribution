...
trait `200Content63Headers` extends StObject {
...
object `200Content63Headers` {
  
  inline def apply(
    `200`: Content63Headers,
    ...
    __obj.asInstanceOf[`200Content63Headers`]
  }
  
  extension [Self <: `200Content63Headers`](x: Self) {
