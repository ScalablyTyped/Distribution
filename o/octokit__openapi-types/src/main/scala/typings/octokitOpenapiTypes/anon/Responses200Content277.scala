...
object Responses200Content277 {
  ...
  inline def apply(parameters: `135`, responses: `200Content277`): Responses200Content277 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content277]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content277] (val x: Self) extends AnyVal {
