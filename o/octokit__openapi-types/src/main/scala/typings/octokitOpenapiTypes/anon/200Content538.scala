...
trait `200Content538` extends StObject {
...
object `200Content538` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content538`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content538`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content538): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
