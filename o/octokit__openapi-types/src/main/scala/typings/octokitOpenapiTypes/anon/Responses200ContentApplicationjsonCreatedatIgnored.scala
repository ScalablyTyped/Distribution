...
object Responses200ContentApplicationjsonCreatedatIgnored {
  ...
  inline def apply(parameters: `491`, responses: `200ContentApplicationjsonCreatedatIgnored`): Responses200ContentApplicationjsonCreatedatIgnored = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200ContentApplicationjsonCreatedatIgnored]
  }
  
  extension [Self <: Responses200ContentApplicationjsonCreatedatIgnored](x: Self) {
