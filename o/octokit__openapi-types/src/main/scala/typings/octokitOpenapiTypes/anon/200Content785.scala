...
trait `200Content785` extends StObject {
...
object `200Content785` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content785`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content785`] (val x: Self) extends AnyVal {
