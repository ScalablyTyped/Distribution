...
object `307403` {
  ...
  inline def apply(`307`: Content41, `403`: ContentApplicationjsonDocumentationurl, `404`: Content41): `307403` = {
  ...
  implicit open class MutableBuilder[Self <: `307403`] (val x: Self) extends AnyVal {
    ...
    inline def set307(value: Content41): Self = StObject.set(x, "307", value.asInstanceOf[js.Any])
