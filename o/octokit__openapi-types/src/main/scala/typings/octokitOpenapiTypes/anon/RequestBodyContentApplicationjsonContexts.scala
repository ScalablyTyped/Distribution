...
trait RequestBodyContentApplicationjsonContexts extends StObject {
  ...
  var responses: `200Content167404`
}
object RequestBodyContentApplicationjsonContexts {
  
  inline def apply(parameters: PathBranch, requestBody: ContentApplicationjsonContexts, responses: `200Content167404`): RequestBodyContentApplicationjsonContexts = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], requestBody = requestBody.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestBodyContentApplicationjsonContexts]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestBodyContentApplicationjsonContexts] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200Content167404`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
