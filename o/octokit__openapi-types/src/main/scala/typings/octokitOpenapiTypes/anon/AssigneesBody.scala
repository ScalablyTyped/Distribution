...
trait AssigneesBody extends StObject {
  ...
  var labels: js.UndefOr[js.Array[String | ColorDescription]] = js.undefined
...
object AssigneesBody {
  
  inline def apply(): AssigneesBody = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AssigneesBody]
  }
  
  extension [Self <: AssigneesBody](x: Self) {
    ...
    inline def setLabels(value: js.Array[String | ColorDescription]): Self = StObject.set(x, "labels", value.asInstanceOf[js.Any])
    
    inline def setLabelsUndefined: Self = StObject.set(x, "labels", js.undefined)
    
    inline def setLabelsVarargs(value: (String | ColorDescription)*): Self = StObject.set(x, "labels", js.Array(value*))
