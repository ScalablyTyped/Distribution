...
trait `200Content80422` extends StObject {
...
object `200Content80422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content80422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content80422`] (val x: Self) extends AnyVal {
