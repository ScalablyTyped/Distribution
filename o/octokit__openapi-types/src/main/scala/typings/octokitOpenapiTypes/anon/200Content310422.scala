...
trait `200Content310422` extends StObject {
...
object `200Content310422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content310422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content310422`] (val x: Self) extends AnyVal {
