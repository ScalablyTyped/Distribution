...
trait GetResponses200Content145404 extends StObject {
  ...
  /**
    ...
    */
  var get: Responses200Content145404
  ...
  /**
    ...
    */
  var put: ParametersPathTeamidUsernameRequestBody
}
object GetResponses200Content145404 {
  
  inline def apply(
    delete: ParametersPathTeamidUsername,
    get: Responses200Content145404,
    put: ParametersPathTeamidUsernameRequestBody
  ): GetResponses200Content145404 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content145404]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses200Content145404] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: ParametersPathTeamidUsername): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
    
    inline def setGet(value: Responses200Content145404): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setPut(value: ParametersPathTeamidUsernameRequestBody): Self = StObject.set(x, "put", value.asInstanceOf[js.Any])
  }
}
