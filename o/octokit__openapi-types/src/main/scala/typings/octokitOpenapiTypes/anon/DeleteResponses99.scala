...
trait DeleteResponses99 extends StObject {
...
object DeleteResponses99 {
  
  inline def apply(delete: Responses99, get: ParametersPathPackagename): DeleteResponses99 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteResponses99]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteResponses99] (val x: Self) extends AnyVal {
    
    inline def setDelete(value: Responses99): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
