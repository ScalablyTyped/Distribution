...
trait `200Content283304` extends StObject {
...
object `200Content283304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content283304`]
  }
  
  extension [Self <: `200Content283304`](x: Self) {
    
    inline def set200(value: Content283): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
