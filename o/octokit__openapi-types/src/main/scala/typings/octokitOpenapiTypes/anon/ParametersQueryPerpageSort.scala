...
trait ParametersQueryPerpageSort extends StObject {
  ...
  var responses: `200Content93400`
}
object ParametersQueryPerpageSort {
  
  inline def apply(parameters: QueryPerpageSort, responses: `200Content93400`): ParametersQueryPerpageSort = {
  ...
  implicit open class MutableBuilder[Self <: ParametersQueryPerpageSort] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200Content93400`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
