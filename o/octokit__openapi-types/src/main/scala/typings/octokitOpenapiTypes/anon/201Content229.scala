...
trait `201Content229` extends StObject {
...
object `201Content229` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content229`]
  }
  
  extension [Self <: `201Content229`](x: Self) {
    
    inline def set201(value: Content229): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
