...
trait `200Content580HeadersLinkString` extends StObject {
...
object `200Content580HeadersLinkString` {
  
  inline def apply(
    `200`: Content580HeadersLinkString,
    ...
    `401`: Content41,
    `403`: Content41
  ): `200Content580HeadersLinkString` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("401")(`401`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200Content580HeadersLinkString`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content580HeadersLinkString`] (val x: Self) extends AnyVal {
