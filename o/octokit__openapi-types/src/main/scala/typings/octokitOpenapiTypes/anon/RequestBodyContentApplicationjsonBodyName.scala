...
object RequestBodyContentApplicationjsonBodyName {
  ...
  inline def apply(parameters: PathOrg, requestBody: ContentApplicationjsonBodyName, responses: `410`): RequestBodyContentApplicationjsonBodyName = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], requestBody = requestBody.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestBodyContentApplicationjsonBodyName]
  }
  
  extension [Self <: RequestBodyContentApplicationjsonBodyName](x: Self) {
