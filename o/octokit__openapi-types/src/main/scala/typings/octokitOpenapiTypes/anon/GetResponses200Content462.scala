...
trait GetResponses200Content462 extends StObject {
  ...
  var delete: ParametersPathOwnerRepoSecretnameResponses
  ...
  /**
    ...
    * ```
    */
  var put: RequestBodyContentApplicationjson88Responses201Content4
}
object GetResponses200Content462 {
  
  inline def apply(
    delete: ParametersPathOwnerRepoSecretnameResponses,
    get: Responses200Content462,
    put: RequestBodyContentApplicationjson88Responses201Content4
  ): GetResponses200Content462 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content462]
  }
  
  extension [Self <: GetResponses200Content462](x: Self) {
    
    inline def setDelete(value: ParametersPathOwnerRepoSecretnameResponses): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
    
    inline def setGet(value: Responses200Content462): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setPut(value: RequestBodyContentApplicationjson88Responses201Content4): Self = StObject.set(x, "put", value.asInstanceOf[js.Any])
  }
}
