...
object CommentnumberDiscussionnumber {
  ...
  inline def apply(comment_number: Double, discussion_number: Double, team_id: Double): CommentnumberDiscussionnumber = {
  ...
  extension [Self <: CommentnumberDiscussionnumber](x: Self) {
