...
trait `200Content15304` extends StObject {
...
object `200Content15304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content15304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content15304`] (val x: Self) extends AnyVal {
