...
object Contenturl {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(archived = archived.asInstanceOf[js.Any], column_id = column_id.asInstanceOf[js.Any], column_url = column_url.asInstanceOf[js.Any], created_at = created_at.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], node_id = node_id.asInstanceOf[js.Any], project_url = project_url.asInstanceOf[js.Any], updated_at = updated_at.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], creator = null, note = null)
    __obj.asInstanceOf[Contenturl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Contenturl] (val x: Self) extends AnyVal {
