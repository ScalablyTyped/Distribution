...
trait AuthorassociationAutomerge extends StObject {
...
object AuthorassociationAutomerge {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[AuthorassociationAutomerge]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AuthorassociationAutomerge] (val x: Self) extends AnyVal {
