...
trait `200Content80Headers28` extends StObject {
  
  /** @description Response */
  var `200`: Content80Headers28
...
object `200Content80Headers28` {
  
  inline def apply(
    `200`: Content80Headers28,
  ...
  ): `200Content80Headers28` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200Content80Headers28`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content80Headers28`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content80Headers28): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
