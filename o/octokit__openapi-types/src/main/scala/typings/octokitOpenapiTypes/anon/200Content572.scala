...
trait `200Content572` extends StObject {
...
object `200Content572` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content572`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content572`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content572): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
