...
trait GetParametersPathTeamidQueryDirectionPage extends StObject {
  ...
  /**
    ...
    */
  var post: Responses201Content115
}
object GetParametersPathTeamidQueryDirectionPage {
  
  inline def apply(get: ParametersPathTeamidQueryDirectionPage, post: Responses201Content115): GetParametersPathTeamidQueryDirectionPage = {
  ...
  implicit open class MutableBuilder[Self <: GetParametersPathTeamidQueryDirectionPage] (val x: Self) extends AnyVal {
    ...
    inline def setPost(value: Responses201Content115): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
