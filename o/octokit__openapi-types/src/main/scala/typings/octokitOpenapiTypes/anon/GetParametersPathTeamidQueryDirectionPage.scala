...
trait GetParametersPathTeamidQueryDirectionPage extends StObject {
  ...
  /**
    ...
    */
  var post: Responses201Content116
}
object GetParametersPathTeamidQueryDirectionPage {
  
  inline def apply(get: ParametersPathTeamidQueryDirectionPage, post: Responses201Content116): GetParametersPathTeamidQueryDirectionPage = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetParametersPathTeamidQueryDirectionPage]
  }
  
  extension [Self <: GetParametersPathTeamidQueryDirectionPage](x: Self) {
    
    inline def setGet(value: ParametersPathTeamidQueryDirectionPage): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setPost(value: Responses201Content116): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
