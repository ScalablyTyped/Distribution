...
import typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.pattern_deleted
import typings.octokitOpenapiTypes.octokitOpenapiTypesStrings.pattern_edited
...
trait Pushprotectionbypassedby extends StObject {
  ...
  var resolution: js.UndefOr[
    _empty | false_positive | wont_fix | revoked | used_in_tests | pattern_deleted | pattern_edited | Null
  ] = js.undefined
...
object Pushprotectionbypassedby {
  ...
  implicit open class MutableBuilder[Self <: Pushprotectionbypassedby] (val x: Self) extends AnyVal {
    ...
    inline def setResolution(
      value: _empty | false_positive | wont_fix | revoked | used_in_tests | pattern_deleted | pattern_edited
