...
trait ParametersPath extends StObject {
  ...
  var responses: `201Content394`
}
object ParametersPath {
  
  inline def apply(parameters: Path, responses: `201Content394`): ParametersPath = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPath] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `201Content394`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
