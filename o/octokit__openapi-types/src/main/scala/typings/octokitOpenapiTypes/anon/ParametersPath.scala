...
trait ParametersPath extends StObject {
  ...
  var responses: `201Content470`
}
object ParametersPath {
  
  inline def apply(parameters: Path, responses: `201Content470`): ParametersPath = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPath] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `201Content470`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
