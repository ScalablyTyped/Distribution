...
trait ParametersPathAccountidNumber extends StObject {
  ...
  var responses: `200ContentApplicationjsonMarketplacepurchase`
}
object ParametersPathAccountidNumber {
  
  inline def apply(parameters: PathAccountidNumber, responses: `200ContentApplicationjsonMarketplacepurchase`): ParametersPathAccountidNumber = {
  ...
  extension [Self <: ParametersPathAccountidNumber](x: Self) {
    ...
    inline def setResponses(value: `200ContentApplicationjsonMarketplacepurchase`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
