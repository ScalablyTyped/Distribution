...
trait `200Content29403` extends StObject {
...
object `200Content29403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content29403`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content29403`] (val x: Self) extends AnyVal {
