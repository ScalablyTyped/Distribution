...
trait PullrequestRepository extends StObject {
...
object PullrequestRepository {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(action = "closed", number = number.asInstanceOf[js.Any], pull_request = pull_request.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[PullrequestRepository]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PullrequestRepository] (val x: Self) extends AnyVal {
