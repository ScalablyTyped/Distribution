...
trait DeleteParametersPathRepoResponses extends StObject {
  ...
  /**
    ...
    */
  var put: ParametersPathRepoRequestBody
}
object DeleteParametersPathRepoResponses {
  
  inline def apply(delete: ParametersPathRepoResponses, get: ParametersPathRepo, put: ParametersPathRepoRequestBody): DeleteParametersPathRepoResponses = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathRepoResponses]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteParametersPathRepoResponses] (val x: Self) extends AnyVal {
    ...
    inline def setPut(value: ParametersPathRepoRequestBody): Self = StObject.set(x, "put", value.asInstanceOf[js.Any])
  }
}
