...
trait DeleteParametersPathRepoResponses extends StObject {
  ...
  /**
    ...
    */
  var put: RequestBodyContentApplicationjson131
}
object DeleteParametersPathRepoResponses {
  ...
  inline def apply(
    ...
    put: RequestBodyContentApplicationjson131
  ...
  extension [Self <: DeleteParametersPathRepoResponses](x: Self) {
    ...
    inline def setPut(value: RequestBodyContentApplicationjson131): Self = StObject.set(x, "put", value.asInstanceOf[js.Any])
  }
}
