...
trait ColumnsurlCreatedat extends StObject {
...
object ColumnsurlCreatedat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ColumnsurlCreatedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColumnsurlCreatedat] (val x: Self) extends AnyVal {
