...
trait `200Content666` extends StObject {
...
object `200Content666` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content666`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content666`] (val x: Self) extends AnyVal {
