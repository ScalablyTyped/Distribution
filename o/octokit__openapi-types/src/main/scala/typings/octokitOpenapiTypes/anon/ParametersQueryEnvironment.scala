...
trait ParametersQueryEnvironment extends StObject {
  ...
  var responses: `200Content162Headers`
}
object ParametersQueryEnvironment {
  
  inline def apply(parameters: QueryEnvironment, responses: `200Content162Headers`): ParametersQueryEnvironment = {
  ...
  extension [Self <: ParametersQueryEnvironment](x: Self) {
    ...
    inline def setResponses(value: `200Content162Headers`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
