...
trait Accesstokensurl extends StObject {
  ...
  var suspended_by: Avatarurl | Null
...
object Accesstokensurl {
  ...
  implicit open class MutableBuilder[Self <: Accesstokensurl] (val x: Self) extends AnyVal {
    ...
    inline def setSuspended_by(value: Avatarurl): Self = StObject.set(x, "suspended_by", value.asInstanceOf[js.Any])
    
    inline def setSuspended_byNull: Self = StObject.set(x, "suspended_by", null)
