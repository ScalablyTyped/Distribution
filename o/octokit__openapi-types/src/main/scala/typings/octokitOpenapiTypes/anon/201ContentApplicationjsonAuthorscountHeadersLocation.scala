...
object `201ContentApplicationjsonAuthorscountHeadersLocation` {
  ...
  inline def apply(`201`: ContentApplicationjsonAuthorscountHeadersLocation, `404`: Content55, `422`: Content421): `201ContentApplicationjsonAuthorscountHeadersLocation` = {
