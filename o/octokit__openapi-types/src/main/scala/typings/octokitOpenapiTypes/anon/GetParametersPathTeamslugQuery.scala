...
trait GetParametersPathTeamslugQuery extends StObject {
  ...
  /**
    ...
    */
  var get: ParametersPathTeamslugQuery
...
object GetParametersPathTeamslugQuery {
  
  inline def apply(get: ParametersPathTeamslugQuery, post: RequestBodyContentApplicationjsonPrivate): GetParametersPathTeamslugQuery = {
    val __obj = js.Dynamic.literal(get = get.asInstanceOf[js.Any], post = post.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetParametersPathTeamslugQuery]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetParametersPathTeamslugQuery] (val x: Self) extends AnyVal {
    
    inline def setGet(value: ParametersPathTeamslugQuery): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
