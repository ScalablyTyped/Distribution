...
trait `201Content514` extends StObject {
...
object `201Content514` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content514`]
  }
  
  extension [Self <: `201Content514`](x: Self) {
    
    inline def set201(value: Content514): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
