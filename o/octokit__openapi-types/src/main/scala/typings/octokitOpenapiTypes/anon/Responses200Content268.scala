...
object Responses200Content268 {
  ...
  inline def apply(parameters: PathOwner, responses: `200Content268`): Responses200Content268 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content268]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content268] (val x: Self) extends AnyVal {
