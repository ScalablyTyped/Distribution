...
trait `200Content337` extends StObject {
...
object `200Content337` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content337`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content337`] (val x: Self) extends AnyVal {
