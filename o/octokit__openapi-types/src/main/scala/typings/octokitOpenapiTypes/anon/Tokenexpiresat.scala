...
trait Tokenexpiresat extends StObject {
...
object Tokenexpiresat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Tokenexpiresat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Tokenexpiresat] (val x: Self) extends AnyVal {
