...
trait `200Content236422` extends StObject {
...
object `200Content236422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content236422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content236422`] (val x: Self) extends AnyVal {
