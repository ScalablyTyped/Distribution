...
object RequestBodyContentApplicationjsonSelectedusernames {
  ...
  inline def apply(parameters: `55`, requestBody: ContentApplicationjsonSelectedusernames, responses: `304404422`): RequestBodyContentApplicationjsonSelectedusernames = {
