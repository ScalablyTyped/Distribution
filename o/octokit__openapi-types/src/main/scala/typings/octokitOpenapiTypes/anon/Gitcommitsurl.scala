...
trait Gitcommitsurl extends StObject {
...
object Gitcommitsurl {
  
  inline def apply(): Gitcommitsurl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Gitcommitsurl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Gitcommitsurl] (val x: Self) extends AnyVal {
