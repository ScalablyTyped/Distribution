...
trait DismissedbyDismissedreason extends StObject {
  ...
  /**
    ...
    * @enum {string}
    */
  var state: open | fixed
  
  var tool: NameVersion
  
  /** Format: uri */
  var url: String
}
object DismissedbyDismissedreason {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[DismissedbyDismissedreason]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DismissedbyDismissedreason] (val x: Self) extends AnyVal {
    ...
    inline def setRule(value: IdSeverity): Self = StObject.set(x, "rule", value.asInstanceOf[js.Any])
    
    inline def setState(value: open | fixed): Self = StObject.set(x, "state", value.asInstanceOf[js.Any])
    
    inline def setTool(value: NameVersion): Self = StObject.set(x, "tool", value.asInstanceOf[js.Any])
