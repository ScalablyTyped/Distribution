...
trait `201Content511` extends StObject {
...
object `201Content511` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content511`]
  }
  
  extension [Self <: `201Content511`](x: Self) {
    
    inline def set201(value: Content511): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
