...
trait BodytextClosedat extends StObject {
...
object BodytextClosedat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[BodytextClosedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BodytextClosedat] (val x: Self) extends AnyVal {
