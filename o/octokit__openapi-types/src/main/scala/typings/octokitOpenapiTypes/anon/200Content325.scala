...
trait `200Content325` extends StObject {
...
object `200Content325` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content325`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content325`] (val x: Self) extends AnyVal {
