...
object `410422` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `410422`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content270): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
