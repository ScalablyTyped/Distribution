...
trait `200Content89401` extends StObject {
...
object `200Content89401` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content89401`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content89401`] (val x: Self) extends AnyVal {
