...
trait `201Content253` extends StObject {
...
object `201Content253` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content253`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content253`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content253): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
