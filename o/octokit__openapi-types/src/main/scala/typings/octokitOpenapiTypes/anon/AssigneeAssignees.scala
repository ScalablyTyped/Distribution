...
trait AssigneeAssignees extends StObject {
...
object AssigneeAssignees {
  
  inline def apply(title: String | Double): AssigneeAssignees = {
    val __obj = js.Dynamic.literal(title = title.asInstanceOf[js.Any])
    __obj.asInstanceOf[AssigneeAssignees]
  }
  
  extension [Self <: AssigneeAssignees](x: Self) {
