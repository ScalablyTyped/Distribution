...
trait GetParametersPathIssuenumber extends StObject {
  ...
  /**
    ...
    */
  var patch: Responses301403
}
object GetParametersPathIssuenumber {
  
  inline def apply(get: ParametersPathIssuenumber, patch: Responses301403): GetParametersPathIssuenumber = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetParametersPathIssuenumber] (val x: Self) extends AnyVal {
    
    inline def setGet(value: ParametersPathIssuenumber): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setPatch(value: Responses301403): Self = StObject.set(x, "patch", value.asInstanceOf[js.Any])
  }
}
