...
trait TypeVisibility extends StObject {
...
object TypeVisibility {
  
  inline def apply(): TypeVisibility = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TypeVisibility]
  }
  
  extension [Self <: TypeVisibility](x: Self) {
