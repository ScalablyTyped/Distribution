...
trait `200Content317304` extends StObject {
...
object `200Content317304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content317304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content317304`] (val x: Self) extends AnyVal {
