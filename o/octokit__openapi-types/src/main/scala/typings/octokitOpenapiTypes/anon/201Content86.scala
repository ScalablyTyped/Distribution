...
trait `201Content86` extends StObject {
...
object `201Content86` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content86`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content86`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content86): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
