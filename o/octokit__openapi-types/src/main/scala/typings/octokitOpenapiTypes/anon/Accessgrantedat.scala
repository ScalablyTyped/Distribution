...
trait Accessgrantedat extends StObject {
...
object Accessgrantedat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Accessgrantedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Accessgrantedat] (val x: Self) extends AnyVal {
