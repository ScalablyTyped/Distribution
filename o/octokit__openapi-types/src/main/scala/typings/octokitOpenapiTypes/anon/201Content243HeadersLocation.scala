...
trait `201Content243HeadersLocation` extends StObject {
  
  /** Response */
  var `201`: Content243HeadersLocation
...
object `201Content243HeadersLocation` {
  
  inline def apply(
    `201`: Content243HeadersLocation,
  ...
  ): `201Content243HeadersLocation` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("201")(`201`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`201Content243HeadersLocation`]
  }
  
  extension [Self <: `201Content243HeadersLocation`](x: Self) {
    
    inline def set201(value: Content243HeadersLocation): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
