...
object Conclusion {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(app = app.asInstanceOf[js.Any], head_sha = head_sha.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], node_id = node_id.asInstanceOf[js.Any], output = output.asInstanceOf[js.Any], pull_requests = pull_requests.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], check_suite = null, completed_at = null, conclusion = null, details_url = null, external_id = null, html_url = null, started_at = null)
