...
trait `200Content797` extends StObject {
...
object `200Content797` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content797`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content797`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content797): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
