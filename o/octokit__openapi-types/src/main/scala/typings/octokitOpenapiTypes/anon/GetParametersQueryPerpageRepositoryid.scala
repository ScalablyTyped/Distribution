...
trait GetParametersQueryPerpageRepositoryid extends StObject {
  ...
  /**
    ...
    */
  var post: RequestBodyContent363
}
object GetParametersQueryPerpageRepositoryid {
  
  inline def apply(get: ParametersQueryPerpageRepositoryid, post: RequestBodyContent363): GetParametersQueryPerpageRepositoryid = {
  ...
  extension [Self <: GetParametersQueryPerpageRepositoryid](x: Self) {
    ...
    inline def setPost(value: RequestBodyContent363): Self = StObject.set(x, "post", value.asInstanceOf[js.Any])
  }
}
