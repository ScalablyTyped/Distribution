...
trait `200Content167404` extends StObject {
...
object `200Content167404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content167404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content167404`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content167): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
