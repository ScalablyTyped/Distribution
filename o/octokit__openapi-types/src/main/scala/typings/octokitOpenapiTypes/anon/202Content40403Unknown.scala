...
trait `202Content40403Unknown` extends StObject {
...
object `202Content40403Unknown` {
  
  inline def apply(`202`: Content40, `403`: Any): `202Content40403Unknown` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("202")(`202`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`202Content40403Unknown`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `202Content40403Unknown`] (val x: Self) extends AnyVal {
