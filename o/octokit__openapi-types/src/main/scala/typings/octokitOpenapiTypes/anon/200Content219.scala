...
trait `200Content219` extends StObject {
...
object `200Content219` {
  ...
  inline def apply(`200`: Content219, `304`: Any, `401`: Content6, `403`: Content6, `404`: Content6): `200Content219` = {
  ...
  extension [Self <: `200Content219`](x: Self) {
