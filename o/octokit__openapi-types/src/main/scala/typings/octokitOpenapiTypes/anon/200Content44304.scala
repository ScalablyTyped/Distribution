...
trait `200Content44304` extends StObject {
...
object `200Content44304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content44304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content44304`] (val x: Self) extends AnyVal {
