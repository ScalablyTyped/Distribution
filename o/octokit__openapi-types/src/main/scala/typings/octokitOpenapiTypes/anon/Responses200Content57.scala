...
object Responses200Content57 {
  ...
  inline def apply(parameters: `47`, responses: `200Content57`): Responses200Content57 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content57]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content57] (val x: Self) extends AnyVal {
