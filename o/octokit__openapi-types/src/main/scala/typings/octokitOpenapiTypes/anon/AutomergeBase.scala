...
trait AutomergeBase extends StObject {
...
object AutomergeBase {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[AutomergeBase]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AutomergeBase] (val x: Self) extends AnyVal {
    ...
    inline def setBase(value: RepoDisabled): Self = StObject.set(x, "base", value.asInstanceOf[js.Any])
    ...
    inline def setHead(value: LabelStringRefString): Self = StObject.set(x, "head", value.asInstanceOf[js.Any])
