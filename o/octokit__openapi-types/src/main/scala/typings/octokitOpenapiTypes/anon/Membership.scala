...
object Membership {
  ...
  inline def apply(organization: Hooksurl, sender: Avatarurl): Membership = {
    val __obj = js.Dynamic.literal(action = "deleted", organization = organization.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
