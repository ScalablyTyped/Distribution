...
object Responses200Content87 {
  ...
  inline def apply(parameters: `55`, responses: `200Content87`): Responses200Content87 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content87]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content87] (val x: Self) extends AnyVal {
