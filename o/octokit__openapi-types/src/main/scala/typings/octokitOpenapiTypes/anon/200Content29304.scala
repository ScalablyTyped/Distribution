...
trait `200Content29304` extends StObject {
...
object `200Content29304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content29304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content29304`] (val x: Self) extends AnyVal {
