...
object `201304401403404` {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `201304401403404`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content457): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
