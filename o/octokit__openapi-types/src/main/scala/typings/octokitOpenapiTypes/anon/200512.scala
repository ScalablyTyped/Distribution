...
object `200512` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200512`]
  }
  
  extension [Self <: `200512`](x: Self) {
    
    inline def set200(value: `512`): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
