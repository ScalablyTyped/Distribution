...
trait ContenttypeCreatedat extends StObject {
...
object ContenttypeCreatedat {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ContenttypeCreatedat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ContenttypeCreatedat] (val x: Self) extends AnyVal {
