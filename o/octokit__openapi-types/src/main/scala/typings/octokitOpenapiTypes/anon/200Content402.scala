...
trait `200Content402` extends StObject {
...
object `200Content402` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content402`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content402`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content402): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
