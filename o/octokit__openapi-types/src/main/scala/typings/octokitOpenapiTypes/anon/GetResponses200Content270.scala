...
trait GetResponses200Content270 extends StObject {
...
object GetResponses200Content270 {
  
  inline def apply(
    delete: ParametersPathRepoSecretnameResponses,
    get: Responses200Content270,
    put: RequestBodyContentApplicationjson191
  ): GetResponses200Content270 = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetResponses200Content270]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResponses200Content270] (val x: Self) extends AnyVal {
