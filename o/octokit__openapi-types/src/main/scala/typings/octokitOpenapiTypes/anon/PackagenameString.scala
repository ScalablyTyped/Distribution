...
trait PackagenameString extends StObject {
  
  var package_name: String
  
  var package_type: npm | maven | rubygems | docker | nuget | container
}
object PackagenameString {
  
  inline def apply(package_name: String, package_type: npm | maven | rubygems | docker | nuget | container): PackagenameString = {
    val __obj = js.Dynamic.literal(package_name = package_name.asInstanceOf[js.Any], package_type = package_type.asInstanceOf[js.Any])
    __obj.asInstanceOf[PackagenameString]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PackagenameString] (val x: Self) extends AnyVal {
