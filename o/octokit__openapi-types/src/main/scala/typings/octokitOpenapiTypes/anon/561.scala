...
object `561` {
  ...
  inline def apply(applicationSlashjson: js.Array[DismissedcommentDismissedreason]): `561` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `561`] (val x: Self) extends AnyVal {
