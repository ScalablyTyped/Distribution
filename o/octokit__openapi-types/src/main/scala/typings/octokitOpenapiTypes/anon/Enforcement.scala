...
trait Enforcement extends StObject {
...
object Enforcement {
  ...
  inline def apply(): Enforcement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Enforcement]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Enforcement] (val x: Self) extends AnyVal {
