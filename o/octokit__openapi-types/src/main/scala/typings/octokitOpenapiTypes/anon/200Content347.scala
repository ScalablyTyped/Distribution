...
trait `200Content347` extends StObject {
...
object `200Content347` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content347`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content347`] (val x: Self) extends AnyVal {
