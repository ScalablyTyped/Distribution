...
trait PayloadReason extends StObject {
...
object PayloadReason {
  ...
  inline def apply(reason: String, verified: Boolean): PayloadReason = {
    ...
    __obj.asInstanceOf[PayloadReason]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PayloadReason] (val x: Self) extends AnyVal {
