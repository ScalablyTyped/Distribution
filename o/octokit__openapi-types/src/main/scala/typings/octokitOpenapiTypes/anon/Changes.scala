...
trait Changes extends StObject {
  ...
  var changes: js.UndefOr[Authorizedactornames] = js.undefined
...
object Changes {
  ...
  inline def apply(repository: Allowupdatebranch, rule: Adminenforced, sender: Avatarurl): Changes = {
    val __obj = js.Dynamic.literal(action = "edited", repository = repository.asInstanceOf[js.Any], rule = rule.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
  ...
  implicit open class MutableBuilder[Self <: Changes] (val x: Self) extends AnyVal {
    ...
    inline def setChanges(value: Authorizedactornames): Self = StObject.set(x, "changes", value.asInstanceOf[js.Any])
