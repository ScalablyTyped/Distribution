...
trait `200181422` extends StObject {
...
object `200181422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200181422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200181422`] (val x: Self) extends AnyVal {
    
    inline def set200(value: `181`): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
