...
trait `201Content92` extends StObject {
...
object `201Content92` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content92`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content92`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content92): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
