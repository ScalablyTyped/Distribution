...
trait `200Content69304` extends StObject {
...
object `200Content69304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content69304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content69304`] (val x: Self) extends AnyVal {
