...
trait `200Content581` extends StObject {
...
object `200Content581` {
  ...
  inline def apply(`200`: Content581, `304`: Any, `401`: Content48, `403`: Content48, `404`: Content48): `200Content581` = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content581`] (val x: Self) extends AnyVal {
