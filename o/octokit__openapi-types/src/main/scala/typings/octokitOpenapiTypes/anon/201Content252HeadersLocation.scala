...
trait `201Content252HeadersLocation` extends StObject {
  
  /** Response */
  var `201`: Content252HeadersLocation
...
object `201Content252HeadersLocation` {
  
  inline def apply(
    `201`: Content252HeadersLocation,
  ...
  ): `201Content252HeadersLocation` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("201")(`201`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`201Content252HeadersLocation`]
  }
  
  extension [Self <: `201Content252HeadersLocation`](x: Self) {
    
    inline def set201(value: Content252HeadersLocation): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
