...
trait `200Content93400` extends StObject {
...
object `200Content93400` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content93400`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content93400`] (val x: Self) extends AnyVal {
