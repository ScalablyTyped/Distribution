...
trait `200Content497304` extends StObject {
...
object `200Content497304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content497304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content497304`] (val x: Self) extends AnyVal {
