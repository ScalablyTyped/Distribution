...
trait ParametersPathAppslugString extends StObject {
  ...
  var responses: `403Content36`
}
object ParametersPathAppslugString {
  
  inline def apply(parameters: PathAppslugString, responses: `403Content36`): ParametersPathAppslugString = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathAppslugString] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `403Content36`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
