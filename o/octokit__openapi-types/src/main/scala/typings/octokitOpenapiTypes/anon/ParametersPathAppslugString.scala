...
trait ParametersPathAppslugString extends StObject {
  ...
  var responses: `403Content55`
}
object ParametersPathAppslugString {
  
  inline def apply(parameters: PathAppslugString, responses: `403Content55`): ParametersPathAppslugString = {
  ...
  extension [Self <: ParametersPathAppslugString](x: Self) {
    ...
    inline def setResponses(value: `403Content55`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
