...
trait `200Content212404` extends StObject {
...
object `200Content212404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content212404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content212404`] (val x: Self) extends AnyVal {
