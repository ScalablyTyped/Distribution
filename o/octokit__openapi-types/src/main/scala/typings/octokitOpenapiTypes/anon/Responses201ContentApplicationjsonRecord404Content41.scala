...
trait Responses201ContentApplicationjsonRecord404Content41 extends StObject {
...
object Responses201ContentApplicationjsonRecord404Content41 {
  
  inline def apply(
    parameters: PathOrgSecretname,
    requestBody: ContentApplicationjsonKeyid,
    responses: `201ContentApplicationjsonRecord404Content41`
  ): Responses201ContentApplicationjsonRecord404Content41 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], requestBody = requestBody.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses201ContentApplicationjsonRecord404Content41]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses201ContentApplicationjsonRecord404Content41] (val x: Self) extends AnyVal {
