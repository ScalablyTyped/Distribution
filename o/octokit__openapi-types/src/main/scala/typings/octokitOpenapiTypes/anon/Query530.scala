...
trait Query530 extends StObject {
...
object Query530 {
  ...
  inline def apply(path: DiscussionnumberOrgTeamslug, query: `530`): Query530 = {
    val __obj = js.Dynamic.literal(path = path.asInstanceOf[js.Any], query = query.asInstanceOf[js.Any])
    __obj.asInstanceOf[Query530]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Query530] (val x: Self) extends AnyVal {
