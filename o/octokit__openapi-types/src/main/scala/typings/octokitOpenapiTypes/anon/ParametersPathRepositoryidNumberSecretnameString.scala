...
object ParametersPathRepositoryidNumberSecretnameString {
  ...
  inline def apply(parameters: PathRepositoryidNumberSecretnameString, responses: `404Content36500Content36`): ParametersPathRepositoryidNumberSecretnameString = {
