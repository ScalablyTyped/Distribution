...
object ParametersPathRepositoryidNumberSecretnameString {
  ...
  inline def apply(parameters: PathRepositoryidNumberSecretnameString, responses: `404Content41500Content41`): ParametersPathRepositoryidNumberSecretnameString = {
