...
object ParametersPathRepositoryidNumberSecretnameString {
  ...
  inline def apply(parameters: PathRepositoryidNumberSecretnameString, responses: `404Content55500Content55`): ParametersPathRepositoryidNumberSecretnameString = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[ParametersPathRepositoryidNumberSecretnameString]
  }
  
  extension [Self <: ParametersPathRepositoryidNumberSecretnameString](x: Self) {
