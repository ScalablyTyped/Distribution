...
trait Currentuserorganizationurl extends StObject {
  
  var _links: Currentuseractor
...
object Currentuserorganizationurl {
  
  inline def apply(_links: Currentuseractor, timeline_url: String, user_url: String): Currentuserorganizationurl = {
  ...
  implicit open class MutableBuilder[Self <: Currentuserorganizationurl] (val x: Self) extends AnyVal {
    ...
    inline def set_links(value: Currentuseractor): Self = StObject.set(x, "_links", value.asInstanceOf[js.Any])
  }
}
