...
trait `200Content214422` extends StObject {
...
object `200Content214422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content214422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content214422`] (val x: Self) extends AnyVal {
