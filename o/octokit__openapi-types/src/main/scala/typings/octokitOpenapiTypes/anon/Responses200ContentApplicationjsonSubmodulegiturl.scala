...
object Responses200ContentApplicationjsonSubmodulegiturl {
  ...
  inline def apply(parameters: PathOwnerStringQuery197, responses: `200ContentApplicationjsonSubmodulegiturl`): Responses200ContentApplicationjsonSubmodulegiturl = {
