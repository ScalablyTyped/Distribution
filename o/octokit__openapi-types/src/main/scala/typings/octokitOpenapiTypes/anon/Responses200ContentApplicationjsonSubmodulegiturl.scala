...
object Responses200ContentApplicationjsonSubmodulegiturl {
  ...
  inline def apply(parameters: PathOwnerStringQuery205, responses: `200ContentApplicationjsonSubmodulegiturl`): Responses200ContentApplicationjsonSubmodulegiturl = {
