...
trait `200ContentApplicationjsonFingerprint422Content397` extends StObject {
...
object `200ContentApplicationjsonFingerprint422Content397` {
  
  inline def apply(`200`: ContentApplicationjsonFingerprint, `422`: Content397): `200ContentApplicationjsonFingerprint422Content397` = {
