...
trait `201Content287` extends StObject {
...
object `201Content287` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content287`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201Content287`] (val x: Self) extends AnyVal {
    
    inline def set201(value: Content287): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
