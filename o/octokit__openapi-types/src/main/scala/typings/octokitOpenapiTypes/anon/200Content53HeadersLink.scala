...
trait `200Content53HeadersLink` extends StObject {
...
object `200Content53HeadersLink` {
  
  inline def apply(
    `200`: Content53HeadersLink,
  ...
  ): `200Content53HeadersLink` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("401")(`401`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200Content53HeadersLink`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content53HeadersLink`] (val x: Self) extends AnyVal {
