...
trait `201Content626` extends StObject {
...
object `201Content626` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content626`]
  }
  
  extension [Self <: `201Content626`](x: Self) {
    
    inline def set201(value: Content626): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
