...
trait `200Content807` extends StObject {
...
object `200Content807` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content807`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content807`] (val x: Self) extends AnyVal {
    
    inline def set200(value: Content807): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
