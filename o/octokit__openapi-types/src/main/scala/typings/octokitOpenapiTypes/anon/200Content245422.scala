...
trait `200Content245422` extends StObject {
...
object `200Content245422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content245422`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content245422`] (val x: Self) extends AnyVal {
