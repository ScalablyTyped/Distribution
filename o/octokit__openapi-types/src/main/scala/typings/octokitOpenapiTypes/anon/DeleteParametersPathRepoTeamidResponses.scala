...
trait DeleteParametersPathRepoTeamidResponses extends StObject {
  ...
  /**
    ...
    */
  var put: RequestBodyContentApplicationjson358
}
object DeleteParametersPathRepoTeamidResponses {
  ...
  inline def apply(
    ...
    put: RequestBodyContentApplicationjson358
  ): DeleteParametersPathRepoTeamidResponses = {
    val __obj = js.Dynamic.literal(delete = delete.asInstanceOf[js.Any], get = get.asInstanceOf[js.Any], put = put.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteParametersPathRepoTeamidResponses]
  }
  
  extension [Self <: DeleteParametersPathRepoTeamidResponses](x: Self) {
    
    inline def setDelete(value: ParametersPathRepoTeamidResponses): Self = StObject.set(x, "delete", value.asInstanceOf[js.Any])
    
    inline def setGet(value: ParametersPathRepoTeamid): Self = StObject.set(x, "get", value.asInstanceOf[js.Any])
    
    inline def setPut(value: RequestBodyContentApplicationjson358): Self = StObject.set(x, "put", value.asInstanceOf[js.Any])
  }
}
