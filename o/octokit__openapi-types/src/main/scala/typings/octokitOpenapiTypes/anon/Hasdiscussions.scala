...
trait Hasdiscussions extends StObject {
...
object Hasdiscussions {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Hasdiscussions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Hasdiscussions] (val x: Self) extends AnyVal {
