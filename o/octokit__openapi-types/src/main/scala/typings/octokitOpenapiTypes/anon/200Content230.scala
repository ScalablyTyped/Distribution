...
trait `200Content230` extends StObject {
...
object `200Content230` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content230`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content230`] (val x: Self) extends AnyVal {
