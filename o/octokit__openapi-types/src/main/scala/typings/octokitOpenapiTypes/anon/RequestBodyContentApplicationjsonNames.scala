...
trait RequestBodyContentApplicationjsonNames extends StObject {
  ...
  var responses: `200Content341404`
}
object RequestBodyContentApplicationjsonNames {
  
  inline def apply(parameters: `144`, requestBody: ContentApplicationjsonNames, responses: `200Content341404`): RequestBodyContentApplicationjsonNames = {
  ...
  extension [Self <: RequestBodyContentApplicationjsonNames](x: Self) {
    ...
    inline def setResponses(value: `200Content341404`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
