...
trait `200Content80304` extends StObject {
...
object `200Content80304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content80304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content80304`] (val x: Self) extends AnyVal {
