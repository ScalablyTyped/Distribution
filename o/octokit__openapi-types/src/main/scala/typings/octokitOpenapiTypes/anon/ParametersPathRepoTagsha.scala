...
trait ParametersPathRepoTagsha extends StObject {
  ...
  var responses: `200701`
}
object ParametersPathRepoTagsha {
  
  inline def apply(parameters: PathRepoTagsha, responses: `200701`): ParametersPathRepoTagsha = {
  ...
  implicit open class MutableBuilder[Self <: ParametersPathRepoTagsha] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200701`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
