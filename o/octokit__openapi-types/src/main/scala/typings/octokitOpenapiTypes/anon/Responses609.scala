...
object Responses609 {
  ...
  inline def apply(parameters: PathMilestonenumberOwner, responses: `609`): Responses609 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses609]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses609] (val x: Self) extends AnyVal {
