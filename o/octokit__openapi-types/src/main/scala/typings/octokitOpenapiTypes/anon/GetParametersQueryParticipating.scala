...
trait GetParametersQueryParticipating extends StObject {
  ...
  var put: RequestBodyContentApplicationjson291
}
object GetParametersQueryParticipating {
  
  inline def apply(get: ParametersQueryParticipating, put: RequestBodyContentApplicationjson291): GetParametersQueryParticipating = {
  ...
  extension [Self <: GetParametersQueryParticipating](x: Self) {
    ...
    inline def setPut(value: RequestBodyContentApplicationjson291): Self = StObject.set(x, "put", value.asInstanceOf[js.Any])
  }
}
