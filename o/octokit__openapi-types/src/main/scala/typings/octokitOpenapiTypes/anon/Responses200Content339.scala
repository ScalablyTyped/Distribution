...
object Responses200Content339 {
  ...
  inline def apply(parameters: PathOwner, responses: `200Content339`): Responses200Content339 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200Content339]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Responses200Content339] (val x: Self) extends AnyVal {
