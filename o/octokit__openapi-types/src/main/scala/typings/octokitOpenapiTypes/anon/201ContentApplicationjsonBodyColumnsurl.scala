...
trait `201ContentApplicationjsonBodyColumnsurl` extends StObject {
...
object `201ContentApplicationjsonBodyColumnsurl` {
  ...
  inline def apply(
    ...
    `403`: Content41,
    `422`: Content549
  ): `201ContentApplicationjsonBodyColumnsurl` = {
    ...
    __obj.asInstanceOf[`201ContentApplicationjsonBodyColumnsurl`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `201ContentApplicationjsonBodyColumnsurl`] (val x: Self) extends AnyVal {
