...
trait ParametersQueryQString extends StObject {
  ...
  var responses: `200ContentApplicationjson779`
}
object ParametersQueryQString {
  
  inline def apply(parameters: QueryQString, responses: `200ContentApplicationjson779`): ParametersQueryQString = {
  ...
  implicit open class MutableBuilder[Self <: ParametersQueryQString] (val x: Self) extends AnyVal {
    ...
    inline def setResponses(value: `200ContentApplicationjson779`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
