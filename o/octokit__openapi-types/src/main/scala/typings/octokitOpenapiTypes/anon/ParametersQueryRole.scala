...
trait ParametersQueryRole extends StObject {
  ...
  var responses: `200Content73Headers`
}
object ParametersQueryRole {
  
  inline def apply(parameters: QueryRole, responses: `200Content73Headers`): ParametersQueryRole = {
  ...
  extension [Self <: ParametersQueryRole](x: Self) {
    ...
    inline def setResponses(value: `200Content73Headers`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
