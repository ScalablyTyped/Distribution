...
trait CreditsCveid extends StObject {
  ...
  var vulnerabilities: js.UndefOr[js.Array[PackagePatchedversions]] = js.undefined
}
object CreditsCveid {
  
  inline def apply(): CreditsCveid = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreditsCveid]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreditsCveid] (val x: Self) extends AnyVal {
