...
trait `200Content32304` extends StObject {
...
object `200Content32304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content32304`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content32304`] (val x: Self) extends AnyVal {
