...
trait `200Content133` extends StObject {
...
object `200Content133` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content133`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content133`] (val x: Self) extends AnyVal {
