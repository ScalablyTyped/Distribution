...
trait `200Content358404` extends StObject {
...
object `200Content358404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content358404`]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `200Content358404`] (val x: Self) extends AnyVal {
