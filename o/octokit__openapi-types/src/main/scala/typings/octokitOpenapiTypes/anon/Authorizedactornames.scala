...
trait Authorizedactornames extends StObject {
  ...
  var admin_enforced: js.UndefOr[`446`] = js.undefined
  
  var authorized_actor_names: js.UndefOr[FromArray] = js.undefined
  
  var authorized_actors_only: js.UndefOr[`446`] = js.undefined
  
  var authorized_dismissal_actors_only: js.UndefOr[`446`] = js.undefined
  
  var linear_history_requirement_enforcement_level: js.UndefOr[`447`] = js.undefined
  
  var required_status_checks: js.UndefOr[FromArray] = js.undefined
  
  var required_status_checks_enforcement_level: js.UndefOr[`447`] = js.undefined
}
object Authorizedactornames {
  ...
  implicit open class MutableBuilder[Self <: Authorizedactornames] (val x: Self) extends AnyVal {
    ...
    inline def setAdmin_enforced(value: `446`): Self = StObject.set(x, "admin_enforced", value.asInstanceOf[js.Any])
    ...
    inline def setAuthorized_actors_only(value: `446`): Self = StObject.set(x, "authorized_actors_only", value.asInstanceOf[js.Any])
    
    inline def setAuthorized_actors_onlyUndefined: Self = StObject.set(x, "authorized_actors_only", js.undefined)
    
    inline def setAuthorized_dismissal_actors_only(value: `446`): Self = StObject.set(x, "authorized_dismissal_actors_only", value.asInstanceOf[js.Any])
    ...
    inline def setLinear_history_requirement_enforcement_level(value: `447`): Self = StObject.set(x, "linear_history_requirement_enforcement_level", value.asInstanceOf[js.Any])
    ...
    inline def setRequired_status_checks_enforcement_level(value: `447`): Self = StObject.set(x, "required_status_checks_enforcement_level", value.asInstanceOf[js.Any])
