...
object Enabledorganizations {
  ...
  inline def apply(enabled_organizations: all | none_ | selected): Enabledorganizations = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Enabledorganizations] (val x: Self) extends AnyVal {
