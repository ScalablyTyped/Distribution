...
object promisesMod {
  ...
  inline def promiseMapSerial[T](arr: js.Array[Any], func: asyncF[T]): js.Promise[js.Array[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("promiseMapSerial")(arr.asInstanceOf[js.Any], func.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[T]]]
  
  inline def promisify(func: js.Function): js.Function1[/* repeated */ Any, js.Promise[Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("promisify")(func.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* repeated */ Any, js.Promise[Any]]]
