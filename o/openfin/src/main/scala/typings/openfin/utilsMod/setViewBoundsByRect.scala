...
object setViewBoundsByRect extends js.Object {
  def apply(rect: Bounds, ofView: View): js.Promise[Unit] = js.native
  def apply(rect: ClientRect, ofView: View): js.Promise[Unit] = js.native
  def apply(rect: DOMRect, ofView: View): js.Promise[Unit] = js.native
}
