package typings.openfin.utilErrorsMod
...
@js.native
trait ErrorPlainObject extends js.Object {
...
object ErrorPlainObject {
  ...
  @scala.inline
  implicit class ErrorPlainObjectOps[Self <: ErrorPlainObject] (val x: Self) extends AnyVal {
