...
import typings.openfin.AnonDownloadedBytes
import typings.openfin.AnonPath
import typings.openfin.AnonResult
import typings.openfin.AnonToken
import typings.openfin.AnonUuid
