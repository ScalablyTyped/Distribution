...
package object fdc3 {
  type AppChannel = typings.openfin.mainMod.AppChannel
  ...
  type ChannelBase = typings.openfin.contextChannelsMod.ChannelBase
  ...
  type FDC3Error = typings.openfin.mainMod.FDC3Error
  ...
  type SystemChannel = typings.openfin.contextChannelsMod.SystemChannel
}
