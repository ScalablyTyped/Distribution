...
object WindowAlertRequestedEvent {
  ...
  @scala.inline
  implicit class WindowAlertRequestedEventOps[Self <: WindowAlertRequestedEvent[_, _], Topic, Type] (val x: Self with (WindowAlertRequestedEvent[Topic, Type])) extends AnyVal {
    @scala.inline
