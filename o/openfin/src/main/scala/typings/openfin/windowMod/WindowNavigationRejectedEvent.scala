...
object WindowNavigationRejectedEvent {
  ...
  inline def apply[Topic, Type](name: String, topic: Topic, `type`: Type, url: String, uuid: String): WindowNavigationRejectedEvent[Topic, Type] = {
  ...
  extension [Self <: WindowNavigationRejectedEvent[?, ?], Topic, Type](x: Self & (WindowNavigationRejectedEvent[Topic, Type])) {
