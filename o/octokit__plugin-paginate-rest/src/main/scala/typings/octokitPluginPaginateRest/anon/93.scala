...
trait `93` extends StObject {
  ...
  var parameters: (ToOctokitParameters[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/actions/organization-variables']['get'] */ js.Any
  ]) & RequiredPreview[Any]
