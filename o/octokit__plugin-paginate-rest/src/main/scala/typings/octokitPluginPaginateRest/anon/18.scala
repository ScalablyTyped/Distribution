...
trait `18` extends StObject {
  ...
  var parameters: ToOctokitParameters[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/organizations/{org}/personal-access-tokens/{pat_id}/repositories']['get'] */ js.Any
  ]
