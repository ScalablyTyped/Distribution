...
trait `189` extends StObject {
  ...
  var parameters: ToOctokitParameters[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/stargazers']['get'] */ js.Any
  ]
