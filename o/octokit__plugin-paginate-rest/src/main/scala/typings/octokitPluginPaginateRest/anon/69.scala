...
trait `69` extends StObject {
  ...
  var parameters: ToOctokitParameters[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/secret-scanning/alerts']['get'] */ js.Any
  ]
