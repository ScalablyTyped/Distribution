...
trait `76` extends StObject {
  ...
  var parameters: (ToOctokitParameters[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/teams/{team_slug}/invitations']['get'] */ js.Any
  ]) & RequiredPreview[Any]
