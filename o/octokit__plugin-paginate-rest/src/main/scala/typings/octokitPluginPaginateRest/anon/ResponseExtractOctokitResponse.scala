...
trait ResponseExtractOctokitResponse extends StObject {
  ...
  var parameters: (ToOctokitParameters[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/enterprises/{enterprise}/dependabot/alerts']['get'] */ js.Any
  ]) & RequiredPreview[Any]
