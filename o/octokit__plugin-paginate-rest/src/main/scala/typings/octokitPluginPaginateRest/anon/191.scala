...
trait `191` extends StObject {
  ...
  var parameters: (ToOctokitParameters[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repositories/{repository_id}/environments/{environment_name}/secrets']['get'] */ js.Any
  ]) & RequiredPreview[Any]
