...
trait Paginate extends StObject {
  ...
  @JSName("paginate")
  def paginate_parameters[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 190, starting with typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashhookSlashdeliveries`, typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashinstallations`, typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashenterprisesSlashLeftcurlybracketenterpriseRightcurlybracketSlashactionsSlashrunner-groups` */ Any */](
    route: R,
    parameters: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/plugin-paginate-rest.@octokit/plugin-paginate-rest/dist-types/generated/paginating-endpoints.PaginatingEndpoints[R]['parameters'] */ js.Any
  ): js.Promise[
    DataType[
  ...
  /**
    ...
    */
  @JSName("paginate")
  def paginate_response[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 190, starting with typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashhookSlashdeliveries`, typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashinstallations`, typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashenterprisesSlashLeftcurlybracketenterpriseRightcurlybracketSlashactionsSlashrunner-groups` */ Any */, M /* <: js.Array[Any] */](
    route: R,
    mapFn: MapFunction[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/plugin-paginate-rest.@octokit/plugin-paginate-rest/dist-types/generated/paginating-endpoints.PaginatingEndpoints[R]['response'] */ js.Any, 
      M
