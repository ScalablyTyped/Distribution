...
trait ParametersActionsListSelfHostedRunnersForRepoEndpoint extends StObject {
  ...
  var response: OctokitResponse[ActionsListSelfHostedRunnersForRepoResponseData] & `0`
}
object ParametersActionsListSelfHostedRunnersForRepoEndpoint {
  ...
  extension [Self <: ParametersActionsListSelfHostedRunnersForRepoEndpoint](x: Self) {
    ...
    inline def setResponse(value: OctokitResponse[ActionsListSelfHostedRunnersForRepoResponseData] & `0`): Self = StObject.set(x, "response", value.asInstanceOf[js.Any])
  }
}
