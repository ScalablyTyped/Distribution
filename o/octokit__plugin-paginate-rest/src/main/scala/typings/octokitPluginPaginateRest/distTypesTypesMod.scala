...
object distTypesTypesMod {
  ...
  trait ComposePaginateInterface extends StObject {
    ...
    def iterator[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 190, starting with typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashhookSlashdeliveries`, typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashinstallations`, typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashenterprisesSlashLeftcurlybracketenterpriseRightcurlybracketSlashactionsSlashrunner-groups` */ Any */](octokit: Octokit, route: R): AsyncIterableIterator[
        OctokitResponse[
          DataType[
            /* import warning: importer.ImportType#apply Failed type conversion: @octokit/plugin-paginate-rest.@octokit/plugin-paginate-rest/dist-types/generated/paginating-endpoints.PaginatingEndpoints[R]['response'] */ js.Any
          ], 
    ...
    @JSName("iterator")
    def iterator_parameters[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 190, starting with typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashhookSlashdeliveries`, typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashinstallations`, typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashenterprisesSlashLeftcurlybracketenterpriseRightcurlybracketSlashactionsSlashrunner-groups` */ Any */](
      octokit: Octokit,
      route: R,
  ...
  trait PaginateInterface extends StObject {
    ...
    def iterator[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 190, starting with typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashhookSlashdeliveries`, typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashinstallations`, typings.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashenterprisesSlashLeftcurlybracketenterpriseRightcurlybracketSlashactionsSlashrunner-groups` */ Any */](route: R): AsyncIterableIterator[
        OctokitResponse[
          DataType[
            /* import warning: importer.ImportType#apply Failed type conversion: @octokit/plugin-paginate-rest.@octokit/plugin-paginate-rest/dist-types/generated/paginating-endpoints.PaginatingEndpoints[R]['response'] */ js.Any
          ], 
