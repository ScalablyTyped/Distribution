...
trait Anon_PrivateKey extends js.Object {
  var privateKey: openpgpLib.openpgpMod.openpgpNs.keyNs.Key
  var privateKeyArmored: java.lang.String
  var publicKey: openpgpLib.openpgpMod.openpgpNs.keyNs.Key
...
object Anon_PrivateKey {
  ...
  def apply(
    ...
    publicKey: openpgpLib.openpgpMod.openpgpNs.keyNs.Key,
