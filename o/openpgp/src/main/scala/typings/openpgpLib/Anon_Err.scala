...
trait Anon_Err extends js.Object {
  ...
  var keys: js.Array[openpgpLib.openpgpMod.openpgpNs.keyNs.Key]
}

object Anon_Err {
  @scala.inline
  def apply(keys: js.Array[openpgpLib.openpgpMod.openpgpNs.keyNs.Key], err: js.Array[stdLib.Error] = null): Anon_Err = {
