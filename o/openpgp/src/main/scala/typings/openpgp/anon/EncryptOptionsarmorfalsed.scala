...
object EncryptOptionsarmorfalsed {
  ...
  @scala.inline
  implicit class EncryptOptionsarmorfalsedOps[Self <: EncryptOptionsarmorfalsed] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setArmor(value: js.UndefOr[Boolean] with `false`): Self = this.set("armor", value.asInstanceOf[js.Any])
    @scala.inline
