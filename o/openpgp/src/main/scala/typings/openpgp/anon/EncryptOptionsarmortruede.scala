...
/* Inlined openpgp.openpgp.EncryptOptions & {  armor ? :true,   detached ? :false} */
trait EncryptOptionsarmortruede extends js.Object {
  /**
  ...
  /**
    ...
    */
  var privateKeys: js.UndefOr[typings.openpgp.mod.key.Key | js.Array[_]] = js.undefined
  /**
    * (optional) array of keys or single key, used to encrypt the message
    */
  var publicKeys: js.UndefOr[typings.openpgp.mod.key.Key | js.Array[_]] = js.undefined
  /**
...
object EncryptOptionsarmortruede {
  @scala.inline
  def apply(
    ...
    privateKeys: typings.openpgp.mod.key.Key | js.Array[_] = null,
    publicKeys: typings.openpgp.mod.key.Key | js.Array[_] = null,
    returnSessionKey: js.UndefOr[Boolean] = js.undefined,
    sessionKey: Algorithm = null,
    signature: typings.openpgp.mod.signature.Signature = null,
    streaming: web | node | `false` = null,
    toUserIds: js.Array[UserID] = null,
    wildcard: js.UndefOr[Boolean] = js.undefined
  ): EncryptOptionsarmortruede = {
    ...
    __obj.asInstanceOf[EncryptOptionsarmortruede]
  }
}
