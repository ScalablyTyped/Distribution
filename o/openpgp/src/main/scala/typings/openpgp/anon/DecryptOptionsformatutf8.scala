...
object DecryptOptionsformatutf8 {
  ...
  def apply(
    ...
    privateKeys: typings.openpgp.mod.key.Key | js.Array[typings.openpgp.mod.key.Key] = null,
    publicKeys: typings.openpgp.mod.key.Key | js.Array[typings.openpgp.mod.key.Key] = null,
