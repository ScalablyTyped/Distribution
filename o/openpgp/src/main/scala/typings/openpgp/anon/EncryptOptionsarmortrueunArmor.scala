...
trait EncryptOptionsarmortrueunArmor extends StObject {
...
object EncryptOptionsarmortrueunArmor {
  ...
  inline def apply(message: typings.openpgp.mod.message.Message): EncryptOptionsarmortrueunArmor = {
    val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any])
    __obj.asInstanceOf[EncryptOptionsarmortrueunArmor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EncryptOptionsarmortrueunArmor] (val x: Self) extends AnyVal {
