...
object webHash extends js.Object {
  ...
  /* 2 */ val `SHA-1`: typings.openpgp.openpgpMod.enums.webHash.`SHA-1` with Double = js.native
  /* 8 */ val `SHA-256`: typings.openpgp.openpgpMod.enums.webHash.`SHA-256` with Double = js.native
  /* 9 */ val `SHA-384`: typings.openpgp.openpgpMod.enums.webHash.`SHA-384` with Double = js.native
  /* 10 */ val `SHA-512`: typings.openpgp.openpgpMod.enums.webHash.`SHA-512` with Double = js.native
  @JSBracketAccess
