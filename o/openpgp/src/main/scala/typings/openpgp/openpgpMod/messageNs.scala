...
import typings.openpgp.openpgpMod.packetNs.Literal
...
object messageNs extends js.Object {
  ...
  class Message protected () extends js.Object {
    ...
    def verify(keys: js.Array[_], date: Date, streaming: Boolean): js.Promise[js.Array[Anon_Keyid]] = js.native
    /**
    ...
    def verifyDetached(keys: js.Array[_], signature: Signature, date: Date): js.Promise[js.Array[Anon_Keyid]] = js.native
  }
  ...
  def createVerificationObject(
    signature: typings.openpgp.openpgpMod.packetNs.Signature,
  ...
  /**
    ...
    * @returns list of signer's keyid and validity of signature
    */
  def createVerificationObjects(signatureList: js.Array[_], literalDataList: js.Array[_], keys: js.Array[_], date: Date): js.Promise[js.Array[Anon_Keyid]] = js.native
  /**
