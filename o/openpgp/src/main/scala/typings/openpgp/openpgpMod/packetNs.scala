...
import typings.openpgp.openpgpMod.packetNs.Marker
import typings.openpgp.openpgpMod.packetNs.OnePassSignature
import typings.openpgp.openpgpMod.packetNs.PublicKey
import typings.openpgp.openpgpMod.packetNs.PublicKeyEncryptedSessionKey
...
import typings.openpgp.openpgpMod.packetNs.SymEncryptedSessionKey
import typings.openpgp.openpgpMod.packetNs.UserAttribute
...
object packetNs extends js.Object {
  ...
  class List () extends js.Object {
    ...
    /**
      ...
      * @returns
      */
    def findPacket(`type`: packet): js.UndefOr[List] = js.native
    /**
