...
trait AnonKeyidValid extends js.Object {
  var keyid: Keyid
  var valid: Boolean
  var verified: js.Promise[Boolean]
}

object AnonKeyidValid {
  @scala.inline
  def apply(keyid: Keyid, valid: Boolean, verified: js.Promise[Boolean]): AnonKeyidValid = {
    ...
    __obj.asInstanceOf[AnonKeyidValid]
  }
}
