...
package object mod {
  ...
  @scala.inline
  def convertStreams_false(obj: js.Object, streaming: typings.openpgp.openpgpBooleans.`false`, keys: js.Array[_]): js.Object = (typings.openpgp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("convertStreams")(obj.asInstanceOf[js.Any], streaming.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[js.Object]
  
  @scala.inline
  def convertStreams_node(obj: js.Object, streaming: typings.openpgp.openpgpStrings.node, keys: js.Array[_]): js.Object = (typings.openpgp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("convertStreams")(obj.asInstanceOf[js.Any], streaming.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[js.Object]
  
  @scala.inline
  def convertStreams_web(obj: js.Object, streaming: typings.openpgp.openpgpStrings.web, keys: js.Array[_]): js.Object = (typings.openpgp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("convertStreams")(obj.asInstanceOf[js.Any], streaming.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[js.Object]
  ...
  @scala.inline
  def decryptKey(privateKey: typings.openpgp.mod.key.Key, passphrase: js.Array[_]): js.Promise[typings.openpgp.anon.KeyKey] = (typings.openpgp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("decryptKey")(privateKey.asInstanceOf[js.Any], passphrase.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.openpgp.anon.KeyKey]]
  ...
  @scala.inline
  def encryptKey(privateKey: typings.openpgp.mod.key.Key, passphrase: js.Array[_]): js.Promise[typings.openpgp.anon.KeyKey] = (typings.openpgp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("encryptKey")(privateKey.asInstanceOf[js.Any], passphrase.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.openpgp.anon.KeyKey]]
  ...
  @scala.inline
  def reformatKey(privateKey: typings.openpgp.mod.key.Key, userIds: js.Array[_]): js.Promise[js.Object] = (typings.openpgp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("reformatKey")(privateKey.asInstanceOf[js.Any], userIds.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Object]]
  @scala.inline
  def reformatKey(
  ...
  @scala.inline
  def toArray(param: js.Object): js.UndefOr[js.Array[_]] = typings.openpgp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("toArray")(param.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[js.Array[_]]]
