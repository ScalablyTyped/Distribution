...
object worker {
  ...
  object worker {
    ...
    /**
      ...
      */
    inline def configure(config: js.Object): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("configure")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
    ...
    /**
      ...
      * @param options The api function's options
      */
    inline def delegate(method: String, options: js.Object): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("delegate")(method.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /**
      ...
      */
    inline def randomCallback(): js.Promise[js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomCallback")().asInstanceOf[js.Promise[js.Object]]
    
    /**
      * Respond to the main window.
      * @param event Contains event type and data
      */
    inline def response(event: js.Object): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("response")(event.asInstanceOf[js.Any]).asInstanceOf[Unit]
