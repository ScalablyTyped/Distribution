...
import typings.onesignalDashCordovaDashPlugin.Anon_0
import typings.onesignalDashCordovaDashPlugin.Anon_01
import typings.onesignalDashCordovaDashPlugin.Anon_From
import typings.onesignalDashCordovaDashPlugin.Anon_FromTo
import typings.onesignalDashCordovaDashPlugin.Anon_FromToOSSubscriptionState
...
trait OneSignalCordovaPlugin extends js.Object {
  var OSInFocusDisplayOption: Anon_0 = js.native
  var OSNotificationPermission: Anon_01 = js.native
  def addEmailSubscriptionObserver(callback: js.Function1[/* change */ Anon_From, Unit]): Unit = js.native
  /**
    *  The passed in function will be fired when a notification permission
    *  setting changes.
    */
  def addPermissionObserver(callback: js.Function1[/* change */ Anon_FromTo, Unit]): Unit = js.native
  /**
    *  The passed in function will be fired when a notification subscription
    *  property changes.
    */
  def addSubscriptionObserver(callback: js.Function1[/* change */ Anon_FromToOSSubscriptionState, Unit]): Unit = js.native
  /**
  ...
  def getIds(IdsReceivedCallBack: js.Function1[/* id */ Anon_PushToken, Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    *  OneSignal.
    */
  def setLogLevel(logLevel: Anon_LogLevel): Unit = js.native
  /**
