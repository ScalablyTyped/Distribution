...
object PartialOSNotification {
  ...
  def apply(
    ...
    if (!js.isUndefined(isAppInFocus)) __obj.updateDynamic("isAppInFocus")(isAppInFocus.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(shown)) __obj.updateDynamic("shown")(shown.get.asInstanceOf[js.Any])
