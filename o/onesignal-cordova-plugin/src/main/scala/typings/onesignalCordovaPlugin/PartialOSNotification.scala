...
object PartialOSNotification {
  ...
  def apply(
    ...
    displayType: OSDisplayType = null,
    ...
    isAppInFocus: js.UndefOr[Boolean] = js.undefined,
    ...
    payload: OSNotificationPayload = null,
    priority: Int | Double = null,
    send_after: String = null,
    shown: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(isAppInFocus)) __obj.updateDynamic("isAppInFocus")(isAppInFocus.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(shown)) __obj.updateDynamic("shown")(shown.asInstanceOf[js.Any])
