...
object jsUtilsMod {
  ...
  inline def get[T](obj: js.Any, path: String, defaultValue: T): T = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(obj.asInstanceOf[js.Any], path.asInstanceOf[js.Any], defaultValue.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  inline def isObject(input: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isObject")(input.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  inline def isString(input: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isString")(input.asInstanceOf[js.Any]).asInstanceOf[Boolean]
