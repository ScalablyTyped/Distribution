...
trait DAVCollectionOptions[T] extends StObject {
  ...
  var constructor: js.UndefOr[js.Function1[/* options */ DAVCollectionOptions[T], Any]] = js.undefined
...
object DAVCollectionOptions {
  ...
  implicit open class MutableBuilder[Self <: DAVCollectionOptions[?], T] (val x: Self & DAVCollectionOptions[T]) extends AnyVal {
    ...
    inline def setConstructor(value: /* options */ DAVCollectionOptions[T] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
