...
object AddressBookOptions {
  ...
  implicit class AddressBookOptionsOps[Self <: AddressBookOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConstructor(value: /* options */ js.UndefOr[AddressBookOptions] => js.Any): Self = this.set("constructor", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setObjectsVarargs(value: VCard*): Self = this.set("objects", js.Array(value :_*))
    
    @scala.inline
    def setObjects(value: js.Array[VCard]): Self = this.set("objects", value.asInstanceOf[js.Any])
