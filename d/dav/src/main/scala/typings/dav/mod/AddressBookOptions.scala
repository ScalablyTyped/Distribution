...
object AddressBookOptions {
  ...
  extension [Self <: AddressBookOptions](x: Self) {
    
    inline def setAccount(value: Account): Self = StObject.set(x, "account", value.asInstanceOf[js.Any])
    
    inline def setAccountUndefined: Self = StObject.set(x, "account", js.undefined)
    
    inline def setConstructor(value: /* options */ js.UndefOr[AddressBookOptions] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setObjectsVarargs(value: VCard*): Self = StObject.set(x, "objects", js.Array(value :_*))
