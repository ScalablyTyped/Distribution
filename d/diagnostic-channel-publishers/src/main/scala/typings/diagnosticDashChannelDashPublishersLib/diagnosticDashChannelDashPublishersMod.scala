...
object diagnosticDashChannelDashPublishersMod extends js.Object {
  ...
  object consoleNs extends js.Object {
    val console: diagnosticDashChannelLib.distSrcPatchRequireMod.IModulePatcher = js.native
    def enable(): scala.Unit = js.native
  }
  ...
  object mysqlNs extends js.Object {
    val mysql: diagnosticDashChannelLib.distSrcPatchRequireMod.IModulePatcher = js.native
    def enable(): scala.Unit = js.native
  }
  ...
  object pgPoolNs extends js.Object {
    val postgresPool1: diagnosticDashChannelLib.distSrcPatchRequireMod.IModulePatcher = js.native
    def enable(): scala.Unit = js.native
  }
  ...
  object redisNs extends js.Object {
    val redis: diagnosticDashChannelLib.distSrcPatchRequireMod.IModulePatcher = js.native
    def enable(): scala.Unit = js.native
  }
