...
class Base protected () extends js.Object {
  ...
  def addColumnAsync(tableName: java.lang.String, columnName: java.lang.String, columnSpec: ColumnSpec): bluebirdLib.bluebirdMod.^[_] = js.native
  def addForeignKey(
    tableName: java.lang.String,
  ...
  def addIndexAsync(tableName: java.lang.String, indexName: java.lang.String, columns: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def addIndexAsync(
    tableName: java.lang.String,
    indexName: java.lang.String,
    columns: java.lang.String,
  ...
  def addIndexAsync(tableName: java.lang.String, indexName: java.lang.String, columns: js.Array[java.lang.String]): bluebirdLib.bluebirdMod.^[_] = js.native
  def addIndexAsync(
    tableName: java.lang.String,
    indexName: java.lang.String,
    columns: js.Array[java.lang.String],
  ...
  def addMigrationRecordAsync(name: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def addSeedRecord(name: java.lang.String, callback: CallbackFunction): scala.Unit = js.native
  def addSeedRecordAsync(name: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def allAsync(sql: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def allAsync(sql: java.lang.String, params: js.Array[_]): bluebirdLib.bluebirdMod.^[_] = js.native
  def allLoadedMigrations(callback: CallbackFunction): scala.Unit = js.native
  def allLoadedMigrationsAsync(): bluebirdLib.bluebirdMod.^[_] = js.native
  def allLoadedSeeds(callback: CallbackFunction): scala.Unit = js.native
  def allLoadedSeedsAsync(): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def changeColumnAsync(tableName: java.lang.String, columnName: java.lang.String, columnSpec: ColumnSpec): bluebirdLib.bluebirdMod.^[_] = js.native
  def checkDBMS(dbms: js.Any, callback: CallbackFunction): scala.Unit = js.native
  def checkDBMSAsync(dbms: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def close(): scala.Unit = js.native
  def close(callback: CallbackFunction): scala.Unit = js.native
  // Promisified methods
  def closeAsync(): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def createDatabaseAsync(options: js.Any*): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def createMigrationsTableAsync(): bluebirdLib.bluebirdMod.^[_] = js.native
  def createSeedsTable(callback: CallbackFunction): scala.Unit = js.native
  def createSeedsTableAsync(): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def createTableAsync(tableName: java.lang.String, options: CreateTableOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  def createTableAsync(tableName: java.lang.String, options: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def deleteMigration(migrationName: java.lang.String, callback: CallbackFunction): scala.Unit = js.native
  def deleteMigrationAsync(migrationName: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def deleteSeed(seedName: java.lang.String, callback: CallbackFunction): scala.Unit = js.native
  def deleteSeedAsync(seedName: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def dropDatabase(options: js.Any*): scala.Unit = js.native
  def dropDatabaseAsync(options: js.Any*): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def dropTableAsync(tableName: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def dropTableAsync(tableName: java.lang.String, options: DropTableOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  def endMigration(callback: CallbackFunction): scala.Unit = js.native
  def endMigrationAsync(callback: CallbackFunction): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def insertAsync(tableName: java.lang.String, columnNameOrValueArray: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def insertAsync(tableName: java.lang.String, columnNameOrValueArray: js.Any, valueArrayOrCb: CallbackFunction): bluebirdLib.bluebirdMod.^[_] = js.native
  def insertAsync(
    tableName: java.lang.String,
    columnNameOrValueArray: js.Any,
    valueArrayOrCb: CallbackFunction,
  ...
  def insertAsync(tableName: java.lang.String, columnNameOrValueArray: js.Any, valueArrayOrCb: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def insertAsync(
    tableName: java.lang.String,
    columnNameOrValueArray: js.Any,
    valueArrayOrCb: js.Any,
  ...
  def lookupAsync(tableName: java.lang.String, column: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def lookupAsync(tableName: java.lang.String, column: java.lang.String, id: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def lookupAsync(tableName: java.lang.String, column: java.lang.String, id: js.Any, callback: CallbackFunction): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def recurseCallbackArrayAsync(foreignKeys: js.Array[java.lang.String]): bluebirdLib.bluebirdMod.^[_] = js.native
  def remove(table: java.lang.String, ids: js.Any, callback: CallbackFunction): scala.Unit = js.native
  def removeAsync(table: java.lang.String, ids: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def removeColumn(tableName: java.lang.String, columnName: java.lang.String, callback: CallbackFunction): scala.Unit = js.native
  def removeColumnAsync(tableName: java.lang.String, columnName: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def removeForeignKeyAsync(tableName: java.lang.String, keyName: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def removeForeignKeyAsync(tableName: java.lang.String, keyName: java.lang.String, options: RemoveForeignKeyOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def removeIndexAsync(tableNameOrIndexName: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def removeIndexAsync(tableNameOrIndexName: java.lang.String, indexName: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def renameColumn(
    tableName: java.lang.String,
  ...
  def renameColumnAsync(tableName: java.lang.String, oldColumnName: java.lang.String, newColumnName: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def renameTable(tableName: java.lang.String, newTableName: java.lang.String, callback: CallbackFunction): scala.Unit = js.native
  def renameTableAsync(tableName: java.lang.String, newTableName: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def runSqlAsync(): bluebirdLib.bluebirdMod.^[_] = js.native
  def runSqlAsync(sql: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def runSqlAsync(sql: java.lang.String, params: js.Array[_]): bluebirdLib.bluebirdMod.^[_] = js.native
  def startMigration(callback: CallbackFunction): scala.Unit = js.native
  def startMigrationAsync(): bluebirdLib.bluebirdMod.^[_] = js.native
  def switchDatabase(options: js.Any*): scala.Unit = js.native
  def switchDatabaseAsync(options: js.Any*): bluebirdLib.bluebirdMod.^[_] = js.native
  def truncate(tableName: java.lang.String, callback: CallbackFunction): scala.Unit = js.native
  def truncateAsync(tableName: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  ...
  def updateAsync(tableName: java.lang.String, columnNameOrValueArray: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def updateAsync(tableName: java.lang.String, columnNameOrValueArray: js.Any, valueArrayOrIds: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def updateAsync(
    tableName: java.lang.String,
    columnNameOrValueArray: js.Any,
    valueArrayOrIds: js.Any,
