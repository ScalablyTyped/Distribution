package typings.domexception.domexceptionMod
...
object ^ extends TopLevel[
      Instantiable0[DOMException] with (Instantiable1[/* message */ String, DOMException]) with (Instantiable2[/* message */ String, /* name */ String, DOMException])
    ] {
