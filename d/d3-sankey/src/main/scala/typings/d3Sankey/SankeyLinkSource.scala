...
trait SankeyLinkSource extends js.Object {
  /**
  ...
  /**
    ...
    */
  var source: Double | String | SankeyNodeHeight
  /**
    ...
    */
  var target: Double | String | SankeyNodeHeight
  /**
...
object SankeyLinkSource {
  @scala.inline
  def apply(
    source: Double | String | SankeyNodeHeight,
    target: Double | String | SankeyNodeHeight,
    value: Double,
    ...
    __obj.asInstanceOf[SankeyLinkSource]
  }
}
