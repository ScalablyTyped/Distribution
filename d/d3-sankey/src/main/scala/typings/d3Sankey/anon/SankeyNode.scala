...
object SankeyNode {
  ...
  implicit class SankeyNodeOps[Self <: SankeyNode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSourceLinksVarargs(value: SankeyLink*): Self = this.set("sourceLinks", js.Array(value :_*))
    @scala.inline
    def setSourceLinks(value: js.Array[SankeyLink]): Self = this.set("sourceLinks", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSourceLinks: Self = this.set("sourceLinks", js.undefined)
    @scala.inline
    def setTargetLinksVarargs(value: SankeyLink*): Self = this.set("targetLinks", js.Array(value :_*))
    @scala.inline
    def setTargetLinks(value: js.Array[SankeyLink]): Self = this.set("targetLinks", value.asInstanceOf[js.Any])
    @scala.inline
