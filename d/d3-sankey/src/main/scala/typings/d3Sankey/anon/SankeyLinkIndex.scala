...
object SankeyLinkIndex {
  ...
  @scala.inline
  implicit class SankeyLinkIndexOps[Self <: SankeyLinkIndex] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSource(value: Double | String | SankeyNodeDepth): Self = this.set("source", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTarget(value: Double | String | SankeyNodeDepth): Self = this.set("target", value.asInstanceOf[js.Any])
