...
trait SankeyLayout[Data, N /* <: SankeyExtraProperties */, L /* <: SankeyExtraProperties */] extends js.Object {
  ...
  /**
    ...
    */
  def nodeAlign(): js.Function2[/* node */ SankeyNode[N, L], /* n */ scala.Double, scala.Double] = js.native
  /**
    ...
    */
  def nodeAlign(nodeAlign: js.Function2[/* node */ SankeyNode[N, L], /* n */ scala.Double, scala.Double]): this.type = js.native
  /**
    ...
    */
  def nodeId(): js.Function1[/* node */ SankeyNode[N, L], java.lang.String | scala.Double] = js.native
  /**
    ...
    */
  def nodeId(nodeId: js.Function1[/* node */ SankeyNode[N, L], java.lang.String | scala.Double]): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def nodeWidth(width: scala.Double): this.type = js.native
  /**
