...
object UriFactory {
  ...
  /**
    ...
    */
  @scala.inline
  def createConflictUri(databaseId: String, collectionId: String, conflictId: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("createConflictUri")(databaseId.asInstanceOf[js.Any], collectionId.asInstanceOf[js.Any], conflictId.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  /**
    ...
    */
  @scala.inline
  def createDatabaseUri(databaseId: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("createDatabaseUri")(databaseId.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  /**
    ...
    */
  @scala.inline
  def createDocumentCollectionUri(databaseId: String, collectionId: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("createDocumentCollectionUri")(databaseId.asInstanceOf[js.Any], collectionId.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  /**
    ...
    */
  @scala.inline
  def createDocumentUri(databaseId: String, collectionId: String, documentId: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("createDocumentUri")(databaseId.asInstanceOf[js.Any], collectionId.asInstanceOf[js.Any], documentId.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  /**
    ...
    */
  @scala.inline
  def createPartitionKeyRangesUri(databaseId: String, collectionId: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("createPartitionKeyRangesUri")(databaseId.asInstanceOf[js.Any], collectionId.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  /**
    ...
    */
  @scala.inline
  def createPermissionUri(databaseId: String, userId: String, permissionId: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("createPermissionUri")(databaseId.asInstanceOf[js.Any], userId.asInstanceOf[js.Any], permissionId.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  /**
    ...
    */
  @scala.inline
  def createStoredProcedureUri(databaseId: String, collectionId: String, storedProcedureId: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("createStoredProcedureUri")(databaseId.asInstanceOf[js.Any], collectionId.asInstanceOf[js.Any], storedProcedureId.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  /**
    ...
    */
  @scala.inline
  def createTriggerUri(databaseId: String, collectionId: String, triggerId: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("createTriggerUri")(databaseId.asInstanceOf[js.Any], collectionId.asInstanceOf[js.Any], triggerId.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  /**
    ...
    */
  @scala.inline
  def createUserDefinedFunctionUri(databaseId: String, collectionId: String, udfId: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("createUserDefinedFunctionUri")(databaseId.asInstanceOf[js.Any], collectionId.asInstanceOf[js.Any], udfId.asInstanceOf[js.Any])).asInstanceOf[String]
}
