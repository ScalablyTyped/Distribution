...
- typings.documentdb.mod.AbstractMeta because var conflicts: id. Inlined _self, _ts, _rid, _etag, _attachments */ trait RetrievedDocument
  extends StObject
     with NewDocument {
...
object RetrievedDocument {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RetrievedDocument] (val x: Self) extends AnyVal {
