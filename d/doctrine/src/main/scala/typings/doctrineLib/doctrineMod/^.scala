...
object ^ extends js.Object {
  ...
  def parse(content: java.lang.String): doctrineLib.doctrineMod.Annotation = js.native
  def parse(content: java.lang.String, options: doctrineLib.doctrineMod.Options): doctrineLib.doctrineMod.Annotation = js.native
