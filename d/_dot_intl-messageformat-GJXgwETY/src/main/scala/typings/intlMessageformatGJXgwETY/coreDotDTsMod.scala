...
object coreDotDTsMod {
  
  @JSImport(".intl-messageformat-GJXgwETY/src/core.d.ts", "IntlMessageFormat")
  @js.native
  ...
  object IntlMessageFormat {
    ...
    @JSImport(".intl-messageformat-GJXgwETY/src/core.d.ts", "IntlMessageFormat.__parse")
    @js.native
    ...
    @JSImport(".intl-messageformat-GJXgwETY/src/core.d.ts", "IntlMessageFormat.formats")
    @js.native
    ...
    @JSImport(".intl-messageformat-GJXgwETY/src/core.d.ts", "IntlMessageFormat.memoizedDefaultLocale")
    @js.native
