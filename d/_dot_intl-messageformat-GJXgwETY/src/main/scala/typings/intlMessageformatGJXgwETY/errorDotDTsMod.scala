...
object errorDotDTsMod {
  
  @js.native
  sealed trait ErrorCode extends StObject
  @JSImport(".intl-messageformat-GJXgwETY/src/error.d.ts", "ErrorCode")
  @js.native
  ...
  @JSImport(".intl-messageformat-GJXgwETY/src/error.d.ts", "FormatError")
  @js.native
  ...
  @JSImport(".intl-messageformat-GJXgwETY/src/error.d.ts", "InvalidValueError")
  @js.native
  ...
  @JSImport(".intl-messageformat-GJXgwETY/src/error.d.ts", "InvalidValueTypeError")
  @js.native
  ...
  @JSImport(".intl-messageformat-GJXgwETY/src/error.d.ts", "MissingValueError")
  @js.native
