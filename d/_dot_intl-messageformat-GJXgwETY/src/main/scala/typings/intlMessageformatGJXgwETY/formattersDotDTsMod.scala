...
import typings.intlMessageformatGJXgwETY.formattersDotDTsMod.PART_TYPE.`object`
import typings.intlMessageformatGJXgwETY.formattersDotDTsMod.PART_TYPE.literal
...
object formattersDotDTsMod {
  
  @JSImport(".intl-messageformat-GJXgwETY/src/formatters.d.ts", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @js.native
  sealed trait PART_TYPE extends StObject
  @JSImport(".intl-messageformat-GJXgwETY/src/formatters.d.ts", "PART_TYPE")
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.intlMessageformatGJXgwETY.formattersDotDTsMod.LiteralPart
    - typings.intlMessageformatGJXgwETY.formattersDotDTsMod.ObjectPart[T]
  */
  trait MessageFormatPart[T] extends StObject
  object MessageFormatPart {
    
    inline def LiteralPart(`type`: literal, value: String): typings.intlMessageformatGJXgwETY.formattersDotDTsMod.LiteralPart = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.intlMessageformatGJXgwETY.formattersDotDTsMod.LiteralPart]
    }
    
    inline def ObjectPart[T](`type`: `object`, value: T): typings.intlMessageformatGJXgwETY.formattersDotDTsMod.ObjectPart[T] = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.intlMessageformatGJXgwETY.formattersDotDTsMod.ObjectPart[T]]
    }
  }
