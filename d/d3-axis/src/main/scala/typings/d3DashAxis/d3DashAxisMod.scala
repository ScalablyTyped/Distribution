...
@js.native
object d3DashAxisMod extends js.Object {
  @js.native
  trait Axis[Domain] extends js.Object {
    /**
      ...
      */
    def apply(context: Selection[SVGGElement | SVGSVGElement, _, _, _]): Unit = js.native
    /**
      * Render the axis to the given context.
      *
    ...
    /**
      ...
      */
    @JSName("tickFormat")
    def tickFormat_This(): this.type = js.native
    /**
    ...
    /**
      ...
      */
    @JSName("tickValues")
    def tickValues_This(): this.type = js.native
    /**
      * Sets the arguments that will be passed to scale.ticks and scale.tickFormat when the axis is rendered, and returns the axis generator.
      *
