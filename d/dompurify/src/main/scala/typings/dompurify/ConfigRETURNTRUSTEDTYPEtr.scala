...
trait ConfigRETURNTRUSTEDTYPEtr extends js.Object {
  ...
  var RETURN_TRUSTED_TYPE: js.UndefOr[Boolean with `true`] = js.undefined
...
object ConfigRETURNTRUSTEDTYPEtr {
  ...
  def apply(
    ...
    RETURN_TRUSTED_TYPE: js.UndefOr[Boolean with `true`] = js.undefined,
