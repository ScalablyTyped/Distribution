...
object storeMod extends TopLevel[TypeofStore with Instantiable0[Store]] {
  ...
  @js.native
  class PutDirectives ()
    extends typings.dojo.dojo.store.api.Store.PutDirectives
  ...
  @js.native
  class QueryOptions ()
    extends typings.dojo.dojo.store.api.Store.QueryOptions
  ...
  @js.native
  class QueryResults ()
    extends typings.dojo.dojo.store.api.Store.QueryResults
  ...
  class SortInformation ()
    extends typings.dojo.dojo.store.api.Store.SortInformation
  ...
  @js.native
  class Transaction ()
    extends typings.dojo.dojo.store.api.Store.Transaction
