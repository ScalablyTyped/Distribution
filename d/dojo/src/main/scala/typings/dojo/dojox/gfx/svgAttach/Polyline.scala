...
/**
  ...
  *
  */
@JSGlobal("dojox.gfx.svg_attach.Polyline")
@js.native
class Polyline () extends js.Object {
  ...
  /**
    ...
    * @param closed
    */
  def setShape(points: js.Array[_], closed: js.Any): js.Function = js.native
  /**
    * sets a polyline/polygon shape object (SVG)
    *
    * @param points a polyline/polygon shape object, or an array of points
    * @param closed
    */
  def setShape(points: js.Object, closed: js.Any): js.Function = js.native
  /**
