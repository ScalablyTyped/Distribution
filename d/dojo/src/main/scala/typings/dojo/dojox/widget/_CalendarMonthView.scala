...
- typings.dojo.dijit._TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget._CalendarMonthView")
@js.native
class _CalendarMonthView () extends _CalendarView {
  ...
  @JSName("watch")
  def watch_datePart(property: datePart, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_displayedYear(property: displayedYear, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
