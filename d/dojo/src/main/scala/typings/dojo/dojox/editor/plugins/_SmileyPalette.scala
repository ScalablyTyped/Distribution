...
- typings.dojo.dijit._TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins._SmileyPalette")
@js.native
class _SmileyPalette () extends _Widget {
  ...
  /**
    ...
    */
  @JSName("dyeClass")
  var dyeClass_F_SmileyPalette: js.Object = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("style")
  var style__SmileyPalette: String = js.native
  /**
    * Widget tab index.
    *
    */
...
@js.native
object _SmileyPalette extends js.Object {
  /**
