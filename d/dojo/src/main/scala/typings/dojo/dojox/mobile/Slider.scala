...
class Slider () extends _WidgetBase {
  ...
  @JSName("watch")
  def watch_flip(property: flip, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_halo(property: halo, callback: Fn_NewValueOldValuePropertyNumber): Anon_Unwatch = js.native
  @JSName("watch")
