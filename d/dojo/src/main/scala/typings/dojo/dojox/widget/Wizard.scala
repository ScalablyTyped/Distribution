...
class Wizard () extends StackContainer {
  ...
  @JSName("watch")
  def watch_cancelButtonLabel(property: cancelButtonLabel, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_cancelFunction(property: cancelFunction, callback: Fn_NewValueOldValuePropertyFunction): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_contextRequire(property: contextRequire, callback: Fn_NewValueOldValuePropertyFunction): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_doneButtonLabel(property: doneButtonLabel, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_hideDisabled(property: hideDisabled, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_nextButtonLabel(property: nextButtonLabel, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_previousButtonLabel(property: previousButtonLabel, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
