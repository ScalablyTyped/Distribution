...
- typings.dojo.dijit._Container because Inheritance from two classes. Inlined addChild, addChild, buildRendering, getIndexOfChild, hasChildren, removeChild, removeChild */ @JSGlobal("dojox.mobile._PickerBase")
@js.native
class _PickerBase () extends _WidgetBase {
  ...
  /**
    ...
    */
  @JSName("style")
  var style__PickerBase: String = js.native
  /**
