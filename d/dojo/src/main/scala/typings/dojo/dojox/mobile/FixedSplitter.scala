...
class FixedSplitter () extends _WidgetBase {
  ...
  @JSName("watch")
  def watch_screenSizeAware(property: screenSizeAware, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_screenSizeAwareClass(property: screenSizeAwareClass, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_style(property: style, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_variablePane(property: variablePane, callback: Fn_NewValueOldValuePropertyNumber): Anon_Unwatch = js.native
}
