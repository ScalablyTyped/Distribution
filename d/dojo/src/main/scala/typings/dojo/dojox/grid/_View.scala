...
class _View () extends _Widget {
  ...
  @JSName("watch")
  def watch_classTag(property: classTag, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_defaultWidth(property: defaultWidth, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_firstScroll(property: firstScroll, callback: Fn_NewValueOldValuePropertyNumber): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_lastTop(property: lastTop, callback: Fn_NewValueOldValuePropertyNumber): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_marginBottom(property: marginBottom, callback: Fn_NewValueOldValuePropertyNumber): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_rowPad(property: rowPad, callback: Fn_NewValueOldValuePropertyNumber): Anon_Unwatch = js.native
  @JSName("watch")
  ...
  @JSName("watch")
  def watch_viewWidth(property: viewWidth, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
}
