...
class Gauge () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_Gauge: String = js.native
  /**
  ...
  /**
    ...
    */
  def addIndicator(indicator: Indicator): js.Any = js.native
  /**
  ...
  /**
    ...
    * @param e The event object
    */
  def handleTouchStartIndicator(indicator: Indicator, e: js.Object): Unit = js.native
  /**
  ...
  /**
    ...
    * @param indicator A dojox.gauges._Indicator or an object with similar parameters(value, color, offset, etc.).
    */
  def moveIndicatorToFront(indicator: Indicator): Unit = js.native
  /**
    ...
    */
  def removeIndicator(indicator: Indicator): Unit = js.native
  /**
  ...
  /**
    ...
    * @param e
    */
  def updateTooltip(txt: String, e: Event_): Unit = js.native
  @JSName("watch")
