...
class ExpandoPane ()
  ...
  @JSName("watch")
  def watch_easeIn(property: easeIn, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_easeOut(property: easeOut, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_previewOnDblClick(property: previewOnDblClick, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_previewOpacity(property: previewOpacity, callback: Fn_NewValueOldValuePropertyNumber): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_searchContainerNode(property: searchContainerNode, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_startExpanded(property: startExpanded, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
