...
object widgets extends js.Object {
  ...
  class Container () extends _WidgetBase {
    ...
    @JSName("watch")
    def watch_scrollable(property: scrollable, callback: Fn_NewValue): Anon_Unwatch = js.native
    @JSName("watch")
  ...
  /**
    ...
    */
  @js.native
  class _ScrollableMixin ()
    extends typings.dojo.dojox.mobile.scrollable {
    /**
      * e.g. Allow ScrollableView in a SwapView.
      *
      */
