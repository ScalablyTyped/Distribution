...
@js.native
class _SelectStackMixin () extends js.Object {
  /**
  ...
  /**
    ...
    */
  def onAddChild(pane: _Widget, insertIndex: Double): Unit = js.native
  /**
    * Called when the stack container removes a pane
    *
    * @param pane
    */
  def onRemoveChild(pane: _Widget): Unit = js.native
  /**
    * Called when the stack container selects a new pane
    *
    * @param pane
    */
  def onSelectChild(pane: _Widget): Unit = js.native
  /**
