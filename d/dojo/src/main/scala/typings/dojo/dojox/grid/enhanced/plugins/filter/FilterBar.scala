...
import typings.dojo.dojoStrings.plugin
...
- typings.dojo.dijit._TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.grid.enhanced.plugins.filter.FilterBar")
@js.native
class FilterBar () extends _Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_FilterBar: String = js.native
  /**
  ...
  /**
    ...
    * @param coordX
    */
  def getColumnIdx(coordX: Double): Double = js.native
  @JSName("get")
  ...
  /**
    *
    */
  def isFilterBarShown(): Boolean = js.native
  @JSName("set")
  ...
  /**
    ...
    * @param animArgs
    */
  def showFilterBar(toShow: js.Any, useAnim: js.Any, animArgs: js.Any): Unit = js.native
  /**
    *
    * @param toHide
    */
  def toggleClearFilterBtn(toHide: js.Any): Unit = js.native
  /**
    *
    * @param useAnim
    * @param animArgs
    */
  def toggleFilterBar(useAnim: js.Any, animArgs: js.Any): Unit = js.native
  @JSName("watch")
  ...
  @JSName("watch")
  def watch_plugin(property: plugin, callback: Fn_NewValueOldValue): Anon_Unwatch = js.native
  @JSName("watch")
