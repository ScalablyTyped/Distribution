...
class ColumnView () extends SimpleColumnView {
  ...
  @JSName("watch")
  def watch_headerPadding(property: headerPadding, callback: Fn_NewValueOldValuePropertyNumber): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_secondarySheetProps(property: secondarySheetProps, callback: Fn_NewValueOldValue): Anon_Unwatch = js.native
}
