...
object _base_ {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(Cube = js.Any.fromFunction0(Cube), Cylinder = js.Any.fromFunction0(Cylinder), Edges = js.Any.fromFunction0(Edges), Matrix3D = js.Any.fromFunction1(Matrix3D), Object = js.Any.fromFunction0(Object), Orbit = js.Any.fromFunction0(Orbit), Path3d = js.Any.fromFunction0(Path3d), Polygon = js.Any.fromFunction0(Polygon), Quads = js.Any.fromFunction0(Quads), Scene = js.Any.fromFunction0(Scene), Triangles = js.Any.fromFunction0(Triangles), Viewport = js.Any.fromFunction0(Viewport), defaultCube = defaultCube, defaultCylinder = defaultCylinder, defaultEdges = defaultEdges, defaultOrbit = defaultOrbit, defaultPath3d = defaultPath3d, defaultPolygon = defaultPolygon, defaultQuads = defaultQuads, defaultTriangles = defaultTriangles, drawer = drawer, gradient = js.Any.fromFunction7(gradient), lighting = lighting, matrix = matrix, scheduler = scheduler, vector = vector)
