...
- typings.dojo.dojox.widget.CalendarYear because Inheritance from two classes. Inlined 
- typings.dojo.dojox.widget.CalendarMonth because Inheritance from two classes. Inlined 
- typings.dojo.dojox.widget.CalendarDay because Inheritance from two classes. Inlined parent */ @JSGlobal("dojox.widget.Calendar3Pane")
@js.native
