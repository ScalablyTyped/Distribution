...
/**
  ...
  *
  */
@JSGlobal("dojox.gfx3d._base.Quads")
@js.native
class Quads () extends js.Object {
  /**
  ...
  /**
    ...
    */
  def setObject(newObject: js.Array[Object], style: String): js.Function = js.native
  /**
    * setup the object
    *
    * @param newObject
    * @param style               Optional
    */
  def setObject(newObject: Object, style: String): js.Function = js.native
  /**
