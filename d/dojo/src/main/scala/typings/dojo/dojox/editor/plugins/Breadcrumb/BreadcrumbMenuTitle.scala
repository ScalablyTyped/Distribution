package typings.dojo.dojox.editor.plugins.Breadcrumb
...
- typings.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.Breadcrumb._BreadcrumbMenuTitle")
@js.native
