package typings.dojo.dojox.editor.plugins.CollapsibleToolbar
...
- typings.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.CollapsibleToolbar._CollapsibleToolbarButton")
@js.native
