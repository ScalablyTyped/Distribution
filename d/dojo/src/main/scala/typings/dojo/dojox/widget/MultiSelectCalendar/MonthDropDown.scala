package typings.dojo.dojox.widget.MultiSelectCalendar
...
- typings.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.widget.MultiSelectCalendar._MonthDropDown")
@js.native
class MonthDropDown () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_MonthDropDown: String = js.native
  /**
