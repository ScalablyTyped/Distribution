package typings.dojo.dojox.editor.plugins.TextColor
...
- typings.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.TextColor._TextColorDropDown")
@js.native
class TextColorDropDown () extends Widget {
  /**
  ...
  /**
    ...
    */
  @JSName("style")
  var style_TextColorDropDown: String = js.native
  /**
