package typings.dojo.dojox.calc.Executor
...
- typings.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.calc._Executor._Executor")
@js.native
class Executor () extends WidgetBase {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_Executor: String = js.native
  /**
