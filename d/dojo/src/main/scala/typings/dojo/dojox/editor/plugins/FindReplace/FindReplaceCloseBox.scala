...
- typings.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dojox.editor.plugins.FindReplace._FindReplaceCloseBox")
@js.native
class FindReplaceCloseBox () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_FindReplaceCloseBox: String = js.native
  /**
