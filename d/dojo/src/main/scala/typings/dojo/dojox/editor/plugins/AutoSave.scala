...
@JSGlobal("dojox.editor.plugins.AutoSave")
@js.native
object AutoSave extends js.Object {
  /**
  ...
  class _AutoSaveSettingDialog () extends _Widget {
    ...
    /**
      ...
      */
    @JSName("style")
    var style__AutoSaveSettingDialog: String = js.native
    /**
    ...
    @JSName("watch")
    def watch_btnCancel(property: btnCancel, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
    @JSName("watch")
    def watch_btnOk(property: btnOk, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
    @JSName("watch")
    def watch_contextRequire(property: contextRequire, callback: Fn_NewValueOldValuePropertyFunction): Anon_Unwatch = js.native
    @JSName("watch")
    def watch_dialogDescription(property: dialogDescription, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
    @JSName("watch")
    def watch_dialogTitle(property: dialogTitle, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
    @JSName("watch")
    def watch_paramLabel(property: paramLabel, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
    @JSName("watch")
    def watch_paramName(property: paramName, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
    @JSName("watch")
