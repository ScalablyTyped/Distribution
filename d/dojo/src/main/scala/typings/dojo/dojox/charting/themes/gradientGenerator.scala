package typings.dojo.dojox.charting.themes
...
/**
  ...
  *
  */
trait gradientGenerator extends js.Object {
  /**
    *
    */
...
object gradientGenerator {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(Adobebricks = Adobebricks, Algae = Algae, Bahamation = Bahamation, BlueDusk = BlueDusk, Charged = Charged, Chris = Chris, Claro = Claro, CubanShirts = CubanShirts, Desert = Desert, Distinctive = Distinctive, Dollar = Dollar, Electric = Electric, Grasshopper = Grasshopper, Grasslands = Grasslands, GreySkies = GreySkies, Harmony = Harmony, IndigoNation = IndigoNation, Ireland = Ireland, Julie = Julie, MiamiNice = MiamiNice, Midwest = Midwest, Minty = Minty, PrimaryColors = PrimaryColors, PurpleRain = PurpleRain, Renkoo = Renkoo, RoyalPurples = RoyalPurples, SageToLime = SageToLime, Shrooms = Shrooms, Tom = Tom, Tufte = Tufte, WatersEdge = WatersEdge, Wetland = Wetland, base = base, blue = blue, cyan = cyan, generateFills = js.Any.fromFunction4(generateFills), generateGradientByIntensity = js.Any.fromFunction2(generateGradientByIntensity), generateMiniTheme = js.Any.fromFunction5(generateMiniTheme), green = green, orange = orange, purple = purple, red = red, updateFills = js.Any.fromFunction4(updateFills))
  
    __obj.asInstanceOf[gradientGenerator]
  }
}
