...
class EntityPalette () extends _Widget {
  ...
  @JSName("watch")
  def watch_dyeClass(property: dyeClass, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  ...
  @JSName("watch")
  def watch_showCode(property: showCode, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_showEntityName(property: showEntityName, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
