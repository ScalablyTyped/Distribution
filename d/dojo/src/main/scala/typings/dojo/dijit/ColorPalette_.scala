...
- typings.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.ColorPalette")
@js.native
class ColorPalette_ () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_ColorPalette_ : String = js.native
  /**
    * Widget tab index.
    * 
    */
