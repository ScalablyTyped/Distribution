...
object _BidiMixin {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(applyTextDir = js.Any.fromFunction2(applyTextDir), enforceTextDirWithUcc = js.Any.fromFunction2(enforceTextDirWithUcc), getTextDir = js.Any.fromFunction1(getTextDir), restoreOriginalText = js.Any.fromFunction1(restoreOriginalText), textDir = textDir)
