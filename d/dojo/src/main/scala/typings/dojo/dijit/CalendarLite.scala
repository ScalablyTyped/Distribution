...
- typings.dojo.dijit._TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.CalendarLite")
@js.native
class CalendarLite () extends _WidgetBase {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_CalendarLite: String = js.native
  /**
  ...
  @JSName("watch")
  def watch_dateTemplateString(property: dateTemplateString, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_dayWidth(property: dayWidth, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_dowTemplateString(property: dowTemplateString, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  ...
  @JSName("watch")
  def watch_weekTemplateString(property: weekTemplateString, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
}

@JSGlobal("dijit.CalendarLite")
@js.native
object CalendarLite extends js.Object {
  /**
    ...
    */
  @js.native
  class _MonthWidget () extends _WidgetBase {
    def this(params: js.Object) = this()
    def this(params: js.Object, srcNodeRef: HTMLElement) = this()
    /**
      * HTML style attributes as cssText string or name/value hash
      ...
      */
    @JSName("style")
    var style__MonthWidget: String = js.native
    /**
      * Track specified handles and remove/destroy them when this instance is destroyed, unless they were
      * already removed/destroyed manually.
      * 
