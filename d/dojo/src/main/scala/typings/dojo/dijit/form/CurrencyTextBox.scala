...
class CurrencyTextBox () extends NumberTextBox {
  ...
  /**
    ...
    */
  @JSName("isValid")
  var isValid_Original_CurrencyTextBox: Fn_IsFocusedBoolean = js.native
  @JSName("get")
  ...
  @JSName("watch")
  def watch_currency(property: currency, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
}
