...
- typings.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit._editor.plugins.FontChoice._FontNameDropDown")
@js.native
class FontNameDropDown () extends Widget {
  ...
  var contextRequire_FFontNameDropDown: js.Function = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("style")
  var style_FontNameDropDown: String = js.native
  /**
