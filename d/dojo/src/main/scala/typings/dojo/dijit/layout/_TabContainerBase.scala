...
class _TabContainerBase () extends StackContainer {
  ...
  @JSName("watch")
  def watch_nested(property: nested, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_searchContainerNode(property: searchContainerNode, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_tabPosition(property: tabPosition, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_tabStrip(property: tabStrip, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
