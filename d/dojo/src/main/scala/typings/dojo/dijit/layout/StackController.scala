...
class StackController () extends _Widget {
  ...
  @JSName("watch")
  def watch_buttonWidgetCloseClass(property: buttonWidgetCloseClass, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_containerId(property: containerId, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
