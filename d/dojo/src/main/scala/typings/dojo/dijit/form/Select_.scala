...
- typings.dojo.dijit.KeyNavMixin because Inheritance from two classes. Inlined childSelector, focusedChild, multiCharSearchDuration, focus, focusChild, focusFirstChild, focusLastChild, onKeyboardSearch
- typings.dojo.dijit.HasDropDown because Inheritance from two classes. Inlined autoWidth, dropDown, dropDownPosition, forceWidth, maxHeight, buildRendering, closeDropDown, destroy, isLoaded, loadAndOpenDropDown, loadDropDown, openDropDown, postCreate, toggleDropDown */ @JSGlobal("dijit.form.Select")
@js.native
class Select_ () extends FormSelectWidget {
  ...
  /**
    ...
    */
  @JSName("isValid")
  def isValid_MSelect_(isFocused: Boolean): Boolean = js.native
  /**
