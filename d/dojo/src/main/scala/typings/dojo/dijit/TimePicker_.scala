...
- typings.dojo.dijit.form.ListBase because Inheritance from two classes. Inlined 
- typings.dojo.dijit.form.ListMouseMixin because Inheritance from two classes. Inlined selected, postCreate, selectFirstNode, selectLastNode, selectNextNode, selectPreviousNode */ @JSGlobal("dijit._TimePicker")
@js.native
