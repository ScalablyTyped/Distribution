...
import typings.dojo.dojoStrings.dialogId
...
/**
  * Permalink: http://dojotoolkit.org/api/1.9/dijit/DialogUnderlay.html
  *
...
- typings.dojo.dijit._TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.DialogUnderlay")
@js.native
class DialogUnderlay () extends _Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_DialogUnderlay: String = js.native
  /**
  ...
  @JSName("get")
  def get_dialogId(property: dialogId): String = js.native
  @JSName("get")
  ...
  @JSName("set")
  def set_dialogId(property: dialogId, value: String): Unit = js.native
  @JSName("set")
  ...
  /**
    ...
    * 
    * @param attrs The parameters to create DialogUnderlay with.             
    * @param zIndex zIndex of the underlay             
    */
  def show(attrs: js.Object, zIndex: Double): Unit = js.native
  @JSName("watch")
  def watch_attachScope(property: attachScope, callback: Fn_NewValueOldValue): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_dialogId(property: dialogId, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
