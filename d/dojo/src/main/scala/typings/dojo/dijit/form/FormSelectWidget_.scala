...
import typings.dojo.dijit.form.FormSelectWidget.SelectOption
...
@js.native
class FormSelectWidget_ () extends FormValueWidget {
  ...
  /**
    ...
    */
  @JSName("value")
  var value_FormSelectWidget_ : String = js.native
  /**
    ...
    * @param option             
    */
  def addOption(option: js.Array[SelectOption]): Unit = js.native
  /**
    * Adds an option or options to the end of the select.  If value
    * of the option is empty or missing, a separator is created instead.
    * Passing in an array of options will yield slightly better performance
    ...
    * @param option             
    */
  def addOption(option: SelectOption): Unit = js.native
  /**
  ...
  /**
    ...
    * @param valueOrIdx             
    */
  def removeOption(valueOrIdx: SelectOption): Unit = js.native
  /**
  ...
  /**
    ...
    * @param newOption             
    */
  def updateOption(newOption: js.Array[SelectOption]): Unit = js.native
  /**
    * Updates the values of the given option.  The option to update
    * is matched based on the value of the entered option.  Passing
    * in an array of new options will yield better performance since
    ...
    * @param newOption             
    */
  def updateOption(newOption: SelectOption): Unit = js.native
  @JSName("watch")
  def watch_labelAttr(
    property: labelAttr,
  ...
  @JSName("watch")
  def watch_loadChildrenOnOpen(
    property: loadChildrenOnOpen,
    callback: js.Function3[
      /* property */ js.UndefOr[String], 
