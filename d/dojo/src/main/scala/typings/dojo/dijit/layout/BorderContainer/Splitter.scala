...
- typings.dojo.dijit.TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.layout.BorderContainer._Splitter")
@js.native
class Splitter () extends Widget {
  ...
  /**
    ...
    */
  @JSName("style")
  var style_Splitter: String = js.native
  /**
