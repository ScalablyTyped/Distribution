...
class HorizontalRule () extends _Widget {
  ...
  @JSName("watch")
  def watch_container(property: container, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_count(property: count, callback: Fn_NewValueOldValuePropertyNumber): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_ruleStyle(property: ruleStyle, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
