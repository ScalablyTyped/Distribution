...
- typings.dojo.dijit._TemplatedMixin because Inheritance from two classes. Inlined attachScope, searchContainerNode, templatePath, templateString, buildRendering, destroyRendering, getCachedTemplate, getCachedTemplate */ @JSGlobal("dijit.ProgressBar")
@js.native
class ProgressBar () extends _Widget {
  ...
  @JSName("watch")
  def watch_indeterminate(property: indeterminate, callback: Fn_NewValue): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_label(property: label, callback: Fn_NewValueOldValue): Anon_Unwatch = js.native
  @JSName("watch")
  ...
  @JSName("watch")
  def watch_places(property: places, callback: Fn_NewValueOldValuePropertyNumber): Anon_Unwatch = js.native
  @JSName("watch")
  def watch_progress(property: progress, callback: Fn_NewValueOldValueProperty): Anon_Unwatch = js.native
  @JSName("watch")
