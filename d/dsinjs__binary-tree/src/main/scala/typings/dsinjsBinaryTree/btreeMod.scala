...
import typings.dsinjsBinaryTree.btreenodeMod.BTreeNode
...
object btreeMod {
  ...
  open class BTree[T] protected () extends StObject {
    ...
    /**
      ...
      */
    def toJSON(): typings.dsinjsBinaryTree.btreenodeMod.BTreeNodeStruct[T] = js.native
  ...
  open class ExtendedWindow ()
    ...
    var BTreeNode: Instantiable1[
        /* attr */ typings.dsinjsBinaryTree.btreenodeMod.BTreeNodeStruct[/* import warning: RewrittenClass.unapply cls was tparam T */ Any], 
