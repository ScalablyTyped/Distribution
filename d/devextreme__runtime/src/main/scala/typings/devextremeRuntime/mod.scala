...
import typings.devextremeRuntime.templateMod.IModel
import typings.devextremeRuntime.updateUndefinedFromDefaultsMod.DefaultEntries
...
object mod {
  ...
  open class UndefinedNativeElementRef[T] ()
    extends typings.devextremeRuntime.undefinedNativeElementRefMod.UndefinedNativeElementRef[T]
