...
import typings.devextremeRuntime.esmAngularTemplateMod.IModel
import typings.devextremeRuntime.esmAngularUpdateUndefinedFromDefaultsMod.DefaultEntries
...
object esmAngularMod {
  ...
  open class UndefinedNativeElementRef[T] ()
    extends typings.devextremeRuntime.esmAngularUndefinedNativeElementRefMod.UndefinedNativeElementRef[T]
