...
import typings.devextremeRuntime.angularTemplateMod.IModel
import typings.devextremeRuntime.angularUpdateUndefinedFromDefaultsMod.DefaultEntries
...
object angularMod {
  ...
  open class UndefinedNativeElementRef[T] ()
    extends typings.devextremeRuntime.angularUndefinedNativeElementRefMod.UndefinedNativeElementRef[T]
