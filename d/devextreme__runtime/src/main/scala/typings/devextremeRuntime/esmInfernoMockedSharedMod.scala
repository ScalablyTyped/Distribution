...
object esmInfernoMockedSharedMod {
  
  @JSImport("@devextreme/runtime/esm/inferno/mocked/shared", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@devextreme/runtime/esm/inferno/mocked/shared", "ERROR_MSG")
  @js.native
