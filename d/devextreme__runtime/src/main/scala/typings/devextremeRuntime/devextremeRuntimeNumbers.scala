...
import typings.devextremeRuntime.mockedVnodeFlagsMod.ChildFlags
import typings.devextremeRuntime.mockedVnodeFlagsMod.VNodeFlags
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object devextremeRuntimeNumbers {
  
  @js.native
  sealed trait `-16385`
    extends StObject
       with VNodeFlags
       with typings.devextremeRuntime.vnodeFlagsMod.VNodeFlags
  ...
  sealed trait `0`
    extends StObject
       with ChildFlags
       with typings.devextremeRuntime.vnodeFlagsMod.ChildFlags
  ...
  sealed trait `2033`
    extends StObject
       with VNodeFlags
       with typings.devextremeRuntime.vnodeFlagsMod.VNodeFlags
  inline def `2033`: `2033` = 2033.asInstanceOf[`2033`]
