...
import typings.devextremeRuntime.hooksMod.Dispatch
import typings.devextremeRuntime.hooksMod.SetStateAction
import typings.devextremeRuntime.portalMod.PortalProps
...
object infernoHooksMod {
  ...
  open class HookContainer ()
    extends typings.devextremeRuntime.containerMod.HookContainer {
  ...
  open class InfernoWrapperComponent ()
    extends typings.devextremeRuntime.baseHooksComponentMod.InfernoWrapperComponent {
    def this(props: RenderFn) = this()
    def this(props: Unit, context: Any) = this()
    def this(props: RenderFn, context: Any) = this()
  }
  ...
  inline def createRecorder(component: typings.devextremeRuntime.containerMod.HookContainer): ComponentDidMount = ^.asInstanceOf[js.Dynamic].applyDynamic("createRecorder")(component.asInstanceOf[js.Any]).asInstanceOf[ComponentDidMount]
  ...
  inline def renderChild(
    component: typings.devextremeRuntime.containerMod.HookContainer,
