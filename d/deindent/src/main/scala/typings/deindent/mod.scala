...
object mod {
  ...
  inline def apply(template: TemplateStringsArray, substitutions: Any*): String = ^.asInstanceOf[js.Dynamic].apply(List(template.asInstanceOf[js.Any]).`++`(substitutions.asInstanceOf[Seq[js.Any]])*).asInstanceOf[String]
