...
object libSequenceComparisonCommonMod {
  ...
  object SesType extends StObject {
    ...
    sealed trait Add
      extends StObject
         with SesType
    /* 1 */ val Add: typings.devexpressUtils.libSequenceComparisonCommonMod.SesType.Add & Double = js.native
    
    @js.native
    sealed trait Common
      extends StObject
         with SesType
    /* 0 */ val Common: typings.devexpressUtils.libSequenceComparisonCommonMod.SesType.Common & Double = js.native
    
    @js.native
    sealed trait Delete
      extends StObject
         with SesType
    /* -1 */ val Delete: typings.devexpressUtils.libSequenceComparisonCommonMod.SesType.Delete & Double = js.native
  }
