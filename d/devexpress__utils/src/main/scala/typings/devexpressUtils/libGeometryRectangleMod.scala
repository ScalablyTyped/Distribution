...
import typings.devexpressUtils.libClassFlagMod.Flag
...
import typings.devexpressUtils.libGeometrySizeMod.Size
...
object libGeometryRectangleMod {
  ...
  object HitTestDeviation extends StObject {
    ...
    /* 2 */ val Bottom: typings.devexpressUtils.libGeometryRectangleMod.HitTestDeviation.Bottom & Double = js.native
    
    @js.native
    sealed trait Left
      extends StObject
         with HitTestDeviation
    /* 4 */ val Left: typings.devexpressUtils.libGeometryRectangleMod.HitTestDeviation.Left & Double = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with HitTestDeviation
    /* 0 */ val None: typings.devexpressUtils.libGeometryRectangleMod.HitTestDeviation.None & Double = js.native
    
    @js.native
    sealed trait Right
      extends StObject
         with HitTestDeviation
    /* 8 */ val Right: typings.devexpressUtils.libGeometryRectangleMod.HitTestDeviation.Right & Double = js.native
    
    @js.native
    sealed trait Top
      extends StObject
         with HitTestDeviation
    /* 1 */ val Top: typings.devexpressUtils.libGeometryRectangleMod.HitTestDeviation.Top & Double = js.native
  }
