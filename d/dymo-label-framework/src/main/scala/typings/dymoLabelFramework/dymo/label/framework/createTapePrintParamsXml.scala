...
@JSGlobal("dymo.label.framework.createTapePrintParamsXml")
@js.native
object createTapePrintParamsXml extends js.Object {
  /**
  	 ...
  	 */
  def apply(params: CreateTapePrintParamsXmlParams): String = js.native
}
