...
object TwinTurboRoll extends js.Object {
  ...
  /* 2 */ val Auto: typings.dymoDashLabelDashFramework.dymoNs.labelNs.frameworkNs.TwinTurboRoll.Auto with Double = js.native
  /* 0 */ val Left: typings.dymoDashLabelDashFramework.dymoNs.labelNs.frameworkNs.TwinTurboRoll.Left with Double = js.native
  /* 1 */ val Right: typings.dymoDashLabelDashFramework.dymoNs.labelNs.frameworkNs.TwinTurboRoll.Right with Double = js.native
  @JSBracketAccess
