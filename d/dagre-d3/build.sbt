...
name := "dagre-d3"
version := "0.4-dt-20180917Z-f59858"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "1.0.0",
  "org.scala-js" %%% "scalajs-dom" % "0.9.6",
  "org.scalablytyped" %%% "d3" % "5.7-dt-20190103Z-bf97f7",
  ...
  "org.scalablytyped" %%% "d3-contour" % "1.3-dt-20181031Z-675c12",
  ...
  "org.scalablytyped" %%% "d3-geo" % "1.11-dt-20190103Z-78b14d",
