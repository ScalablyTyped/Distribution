...
name := "dagre-d3"
version := "0.4-dt-20180917Z-e74d3a"
scalaVersion := "2.12.7"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "runtime" % "1.0.0-M1",
  "com.scalablytyped" %%% "d3" % "5.0-dt-20181018Z-171237",
  "com.scalablytyped" %%% "d3-array" % "1.2-dt-20181018Z-e09a78",
  "com.scalablytyped" %%% "d3-axis" % "1.0-dt-20180927Z-483169",
  "com.scalablytyped" %%% "d3-brush" % "1.0-dt-20181206Z-e7e7ea",
