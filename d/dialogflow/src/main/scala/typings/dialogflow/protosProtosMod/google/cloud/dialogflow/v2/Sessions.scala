...
import typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.Sessions.DetectIntentCallback
import typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.Sessions.StreamingDetectIntentCallback
