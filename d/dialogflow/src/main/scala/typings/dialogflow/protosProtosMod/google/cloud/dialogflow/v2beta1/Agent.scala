...
object Agent {
  ...
  object ApiVersion extends StObject {
    ...
    sealed trait API_VERSION_UNSPECIFIED
      extends StObject
         with ApiVersion
    /* 0 */ val API_VERSION_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.ApiVersion.API_VERSION_UNSPECIFIED & Double = js.native
    
    @js.native
    sealed trait API_VERSION_V1
      extends StObject
         with ApiVersion
    /* 1 */ val API_VERSION_V1: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.ApiVersion.API_VERSION_V1 & Double = js.native
    
    @js.native
    sealed trait API_VERSION_V2
      extends StObject
         with ApiVersion
    /* 2 */ val API_VERSION_V2: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.ApiVersion.API_VERSION_V2 & Double = js.native
    
    @js.native
    sealed trait API_VERSION_V2_BETA_1
      extends StObject
         with ApiVersion
    /* 3 */ val API_VERSION_V2_BETA_1: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.ApiVersion.API_VERSION_V2_BETA_1 & Double = js.native
  }
  ...
  object MatchMode extends StObject {
    ...
    sealed trait MATCH_MODE_HYBRID
      extends StObject
         with MatchMode
    /* 1 */ val MATCH_MODE_HYBRID: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.MatchMode.MATCH_MODE_HYBRID & Double = js.native
    
    @js.native
    sealed trait MATCH_MODE_ML_ONLY
      extends StObject
         with MatchMode
    /* 2 */ val MATCH_MODE_ML_ONLY: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.MatchMode.MATCH_MODE_ML_ONLY & Double = js.native
    
    @js.native
    sealed trait MATCH_MODE_UNSPECIFIED
      extends StObject
         with MatchMode
    /* 0 */ val MATCH_MODE_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.MatchMode.MATCH_MODE_UNSPECIFIED & Double = js.native
  }
  ...
  object Tier extends StObject {
    ...
    sealed trait TIER_ENTERPRISE
      extends StObject
         with Tier
    /* 2 */ val TIER_ENTERPRISE: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.Tier.TIER_ENTERPRISE & Double = js.native
    
    @js.native
    sealed trait TIER_ENTERPRISE_PLUS
      extends StObject
         with Tier
    /* 3 */ val TIER_ENTERPRISE_PLUS: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.Tier.TIER_ENTERPRISE_PLUS & Double = js.native
    
    @js.native
    sealed trait TIER_STANDARD
      extends StObject
         with Tier
    /* 1 */ val TIER_STANDARD: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.Tier.TIER_STANDARD & Double = js.native
    
    @js.native
    sealed trait TIER_UNSPECIFIED
      extends StObject
         with Tier
    /* 0 */ val TIER_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Agent.Tier.TIER_UNSPECIFIED & Double = js.native
  }
