...
object KnowledgeOperationMetadata {
  ...
  object State extends StObject {
    ...
    sealed trait DONE
      extends StObject
         with State
    /* 3 */ val DONE: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata.State.DONE & Double = js.native
    
    @js.native
    sealed trait PENDING
      extends StObject
         with State
    /* 1 */ val PENDING: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata.State.PENDING & Double = js.native
    
    @js.native
    sealed trait RUNNING
      extends StObject
         with State
    /* 2 */ val RUNNING: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata.State.RUNNING & Double = js.native
    
    @js.native
    sealed trait STATE_UNSPECIFIED
      extends StObject
         with State
    /* 0 */ val STATE_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata.State.STATE_UNSPECIFIED & Double = js.native
  }
