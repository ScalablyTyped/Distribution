...
object Intent {
  ...
  object Message {
    ...
    object BrowseCarouselCard {
        ...
        object OpenUrlAction {
          ...
          object UrlTypeHint extends StObject {
            ...
            sealed trait AMP_ACTION
              extends StObject
                 with UrlTypeHint
            /* 1 */ val AMP_ACTION: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.OpenUrlAction.UrlTypeHint.AMP_ACTION & Double = js.native
            
            @js.native
            sealed trait AMP_CONTENT
              extends StObject
                 with UrlTypeHint
            /* 2 */ val AMP_CONTENT: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.OpenUrlAction.UrlTypeHint.AMP_CONTENT & Double = js.native
            
            @js.native
            sealed trait URL_TYPE_HINT_UNSPECIFIED
              extends StObject
                 with UrlTypeHint
            /* 0 */ val URL_TYPE_HINT_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.OpenUrlAction.UrlTypeHint.URL_TYPE_HINT_UNSPECIFIED & Double = js.native
          }
      ...
      object ImageDisplayOptions extends StObject {
        ...
        /* 4 */ val BLURRED_BACKGROUND: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.ImageDisplayOptions.BLURRED_BACKGROUND & Double = js.native
        
        @js.native
        sealed trait CROPPED
          extends StObject
             with ImageDisplayOptions
        /* 3 */ val CROPPED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.ImageDisplayOptions.CROPPED & Double = js.native
        
        @js.native
        sealed trait GRAY
          extends StObject
             with ImageDisplayOptions
        /* 1 */ val GRAY: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.ImageDisplayOptions.GRAY & Double = js.native
        
        @js.native
        sealed trait IMAGE_DISPLAY_OPTIONS_UNSPECIFIED
          extends StObject
             with ImageDisplayOptions
        /* 0 */ val IMAGE_DISPLAY_OPTIONS_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.ImageDisplayOptions.IMAGE_DISPLAY_OPTIONS_UNSPECIFIED & Double = js.native
        
        @js.native
        sealed trait WHITE
          extends StObject
             with ImageDisplayOptions
        /* 2 */ val WHITE: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.ImageDisplayOptions.WHITE & Double = js.native
      }
    ...
    open class Card ()
      ...
      var buttons_Card: js.Array[
            typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Card.IButton
          ] = js.native
    ...
    object Card {
      ...
      open class Button ()
        extends StObject
           with typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Card.IButton {
        def this(properties: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Card.IButton) = this()
      ...
      object Button {
        ...
        inline def create(): Button = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[Button]
        inline def create(
          properties: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Card.IButton
        ...
        /* static member */
        inline def encode(
          message: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Card.IButton
      ...
      object IButton {
        ...
        inline def apply(): typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Card.IButton = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Card.IButton]
        }
        
        @scala.inline
        implicit open class MutableBuilder[Self <: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Card.IButton] (val x: Self) extends AnyVal {
    ...
    object ColumnProperties {
      ...
      object HorizontalAlignment extends StObject {
        ...
        /* 2 */ val CENTER: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ColumnProperties.HorizontalAlignment.CENTER & Double = js.native
        
        @js.native
        sealed trait HORIZONTAL_ALIGNMENT_UNSPECIFIED
          extends StObject
             with HorizontalAlignment
        /* 0 */ val HORIZONTAL_ALIGNMENT_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ColumnProperties.HorizontalAlignment.HORIZONTAL_ALIGNMENT_UNSPECIFIED & Double = js.native
        
        @js.native
        sealed trait LEADING
          extends StObject
             with HorizontalAlignment
        /* 1 */ val LEADING: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ColumnProperties.HorizontalAlignment.LEADING & Double = js.native
        
        @js.native
        sealed trait TRAILING
          extends StObject
             with HorizontalAlignment
        /* 3 */ val TRAILING: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ColumnProperties.HorizontalAlignment.TRAILING & Double = js.native
      }
    ...
    open class ListSelect ()
      ...
      var items_ListSelect: js.Array[
            typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.IItem
          ] = js.native
    ...
    object ListSelect {
      ...
      open class Item ()
        extends StObject
           with typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.IItem {
        def this(properties: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.IItem) = this()
      ...
      object Item {
        ...
        inline def create(): Item = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[Item]
        inline def create(
          properties: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.IItem
        ...
        /* static member */
        inline def encode(
          message: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.IItem
        ): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
        inline def encode(
          message: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.IItem,
          writer: Writer
      ...
      object IItem {
        ...
        inline def apply(): typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.IItem = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.IItem]
        }
        
        @scala.inline
        implicit open class MutableBuilder[Self <: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.IItem] (val x: Self) extends AnyVal {
    ...
    object MediaContent {
      ...
      object ResponseMediaType extends StObject {
        ...
        /* 1 */ val AUDIO: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.ResponseMediaType.AUDIO & Double = js.native
        
        @js.native
        sealed trait RESPONSE_MEDIA_TYPE_UNSPECIFIED
          extends StObject
             with ResponseMediaType
        /* 0 */ val RESPONSE_MEDIA_TYPE_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.ResponseMediaType.RESPONSE_MEDIA_TYPE_UNSPECIFIED & Double = js.native
      }
    ...
    object Platform extends StObject {
      ...
      sealed trait ACTIONS_ON_GOOGLE
        extends StObject
           with Platform
      /* 8 */ val ACTIONS_ON_GOOGLE: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Platform.ACTIONS_ON_GOOGLE & Double = js.native
      
      @js.native
      sealed trait FACEBOOK
        extends StObject
           with Platform
      /* 1 */ val FACEBOOK: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Platform.FACEBOOK & Double = js.native
      
      @js.native
      sealed trait GOOGLE_HANGOUTS
        extends StObject
           with Platform
      /* 11 */ val GOOGLE_HANGOUTS: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Platform.GOOGLE_HANGOUTS & Double = js.native
      
      @js.native
      sealed trait KIK
        extends StObject
           with Platform
      /* 4 */ val KIK: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Platform.KIK & Double = js.native
      
      @js.native
      sealed trait LINE
        extends StObject
           with Platform
      /* 6 */ val LINE: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Platform.LINE & Double = js.native
      
      @js.native
      sealed trait PLATFORM_UNSPECIFIED
        extends StObject
           with Platform
      /* 0 */ val PLATFORM_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Platform.PLATFORM_UNSPECIFIED & Double = js.native
      
      @js.native
      sealed trait SKYPE
        extends StObject
           with Platform
      /* 5 */ val SKYPE: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Platform.SKYPE & Double = js.native
      
      @js.native
      sealed trait SLACK
        extends StObject
           with Platform
      /* 2 */ val SLACK: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Platform.SLACK & Double = js.native
      
      @js.native
      sealed trait TELEGRAM
        extends StObject
           with Platform
      /* 3 */ val TELEGRAM: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Platform.TELEGRAM & Double = js.native
      
      @js.native
      sealed trait TELEPHONY
        extends StObject
           with Platform
      /* 10 */ val TELEPHONY: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Platform.TELEPHONY & Double = js.native
      
      @js.native
      sealed trait VIBER
        extends StObject
           with Platform
      /* 7 */ val VIBER: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Platform.VIBER & Double = js.native
    }
    ...
    object RbmCardContent {
      ...
      object RbmMedia {
        ...
        object Height extends StObject {
          ...
          sealed trait HEIGHT_UNSPECIFIED
            extends StObject
               with Height
          /* 0 */ val HEIGHT_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.RbmMedia.Height.HEIGHT_UNSPECIFIED & Double = js.native
          
          @js.native
          sealed trait MEDIUM
            extends StObject
               with Height
          /* 2 */ val MEDIUM: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.RbmMedia.Height.MEDIUM & Double = js.native
          
          @js.native
          sealed trait SHORT
            extends StObject
               with Height
          /* 1 */ val SHORT: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.RbmMedia.Height.SHORT & Double = js.native
          
          @js.native
          sealed trait TALL
            extends StObject
               with Height
          /* 3 */ val TALL: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.RbmMedia.Height.TALL & Double = js.native
        }
        ...
        /**
          ...
          */
        /* static member */
        inline def create(): RbmMedia = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[RbmMedia]
        inline def create(properties: IRbmMedia): RbmMedia = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[RbmMedia]
        
        inline def decode(reader: js.typedarray.Uint8Array): RbmMedia = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmMedia]
        inline def decode(reader: js.typedarray.Uint8Array, length: Double): RbmMedia = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmMedia]
        /**
          ...
          */
        /* static member */
        inline def decode(reader: Reader): RbmMedia = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmMedia]
        inline def decode(reader: Reader, length: Double): RbmMedia = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmMedia]
        
        inline def decodeDelimited(reader: js.typedarray.Uint8Array): RbmMedia = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmMedia]
        /**
          ...
          */
        /* static member */
        inline def decodeDelimited(reader: Reader): RbmMedia = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmMedia]
        ...
        /**
          ...
          */
        /* static member */
        inline def encode(message: IRbmMedia): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
        inline def encode(message: IRbmMedia, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
        ...
        /**
          ...
          */
        /* static member */
        inline def encodeDelimited(message: IRbmMedia): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
        inline def encodeDelimited(message: IRbmMedia, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
        ...
        /**
          ...
          */
        /* static member */
        inline def fromObject(`object`: StringDictionary[Any]): RbmMedia = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[RbmMedia]
        ...
        /**
          ...
          */
        /* static member */
        inline def toObject(message: RbmMedia): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
        inline def toObject(message: RbmMedia, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
      ...
      /**
        ...
        */
      /* static member */
      inline def create(): RbmCardContent = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[RbmCardContent]
      inline def create(properties: IRbmCardContent): RbmCardContent = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[RbmCardContent]
      
      inline def decode(reader: js.typedarray.Uint8Array): RbmCardContent = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmCardContent]
      inline def decode(reader: js.typedarray.Uint8Array, length: Double): RbmCardContent = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmCardContent]
      /**
        ...
        */
      /* static member */
      inline def decode(reader: Reader): RbmCardContent = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmCardContent]
      inline def decode(reader: Reader, length: Double): RbmCardContent = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmCardContent]
      
      inline def decodeDelimited(reader: js.typedarray.Uint8Array): RbmCardContent = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmCardContent]
      /**
        ...
        */
      /* static member */
      inline def decodeDelimited(reader: Reader): RbmCardContent = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmCardContent]
      ...
      /**
        ...
        */
      /* static member */
      inline def encode(message: IRbmCardContent): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encode(message: IRbmCardContent, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def encodeDelimited(message: IRbmCardContent): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encodeDelimited(message: IRbmCardContent, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def fromObject(`object`: StringDictionary[Any]): RbmCardContent = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[RbmCardContent]
      ...
      /**
        ...
        */
      /* static member */
      inline def toObject(message: RbmCardContent): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
      inline def toObject(message: RbmCardContent, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
      ...
      object IRbmMedia {
        ...
        inline def apply(): IRbmMedia = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[IRbmMedia]
        }
        
        @scala.inline
        implicit open class MutableBuilder[Self <: IRbmMedia] (val x: Self) extends AnyVal {
    ...
    object RbmCarouselCard {
      ...
      object CardWidth extends StObject {
        ...
        sealed trait CARD_WIDTH_UNSPECIFIED
          extends StObject
             with CardWidth
        /* 0 */ val CARD_WIDTH_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCarouselCard.CardWidth.CARD_WIDTH_UNSPECIFIED & Double = js.native
        
        @js.native
        sealed trait MEDIUM
          extends StObject
             with CardWidth
        /* 2 */ val MEDIUM: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCarouselCard.CardWidth.MEDIUM & Double = js.native
        
        @js.native
        sealed trait SMALL
          extends StObject
             with CardWidth
        /* 1 */ val SMALL: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmCarouselCard.CardWidth.SMALL & Double = js.native
      }
      ...
      /**
        ...
        */
      /* static member */
      inline def create(): RbmCarouselCard = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[RbmCarouselCard]
      inline def create(properties: IRbmCarouselCard): RbmCarouselCard = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[RbmCarouselCard]
      
      inline def decode(reader: js.typedarray.Uint8Array): RbmCarouselCard = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmCarouselCard]
      inline def decode(reader: js.typedarray.Uint8Array, length: Double): RbmCarouselCard = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmCarouselCard]
      /**
        ...
        */
      /* static member */
      inline def decode(reader: Reader): RbmCarouselCard = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmCarouselCard]
      inline def decode(reader: Reader, length: Double): RbmCarouselCard = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmCarouselCard]
      
      inline def decodeDelimited(reader: js.typedarray.Uint8Array): RbmCarouselCard = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmCarouselCard]
      /**
        ...
        */
      /* static member */
      inline def decodeDelimited(reader: Reader): RbmCarouselCard = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmCarouselCard]
      ...
      /**
        ...
        */
      /* static member */
      inline def encode(message: IRbmCarouselCard): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encode(message: IRbmCarouselCard, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def encodeDelimited(message: IRbmCarouselCard): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encodeDelimited(message: IRbmCarouselCard, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def fromObject(`object`: StringDictionary[Any]): RbmCarouselCard = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[RbmCarouselCard]
      ...
      /**
        ...
        */
      /* static member */
      inline def toObject(message: RbmCarouselCard): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
      inline def toObject(message: RbmCarouselCard, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
    ...
    object RbmStandaloneCard {
      ...
      object CardOrientation extends StObject {
        ...
        /* 0 */ val CARD_ORIENTATION_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.CardOrientation.CARD_ORIENTATION_UNSPECIFIED & Double = js.native
        
        @js.native
        sealed trait HORIZONTAL
          extends StObject
             with CardOrientation
        /* 1 */ val HORIZONTAL: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.CardOrientation.HORIZONTAL & Double = js.native
        
        @js.native
        sealed trait VERTICAL
          extends StObject
             with CardOrientation
        /* 2 */ val VERTICAL: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.CardOrientation.VERTICAL & Double = js.native
      }
      ...
      object ThumbnailImageAlignment extends StObject {
        ...
        /* 1 */ val LEFT: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment.LEFT & Double = js.native
        
        @js.native
        sealed trait RIGHT
          extends StObject
             with ThumbnailImageAlignment
        /* 2 */ val RIGHT: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment.RIGHT & Double = js.native
        
        @js.native
        sealed trait THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED
          extends StObject
             with ThumbnailImageAlignment
        /* 0 */ val THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment.THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED & Double = js.native
      }
      ...
      /**
        ...
        */
      /* static member */
      inline def create(): RbmStandaloneCard = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[RbmStandaloneCard]
      inline def create(properties: IRbmStandaloneCard): RbmStandaloneCard = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[RbmStandaloneCard]
      
      inline def decode(reader: js.typedarray.Uint8Array): RbmStandaloneCard = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmStandaloneCard]
      inline def decode(reader: js.typedarray.Uint8Array, length: Double): RbmStandaloneCard = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmStandaloneCard]
      /**
        ...
        */
      /* static member */
      inline def decode(reader: Reader): RbmStandaloneCard = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmStandaloneCard]
      inline def decode(reader: Reader, length: Double): RbmStandaloneCard = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmStandaloneCard]
      
      inline def decodeDelimited(reader: js.typedarray.Uint8Array): RbmStandaloneCard = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmStandaloneCard]
      /**
        ...
        */
      /* static member */
      inline def decodeDelimited(reader: Reader): RbmStandaloneCard = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmStandaloneCard]
      ...
      /**
        ...
        */
      /* static member */
      inline def encode(message: IRbmStandaloneCard): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encode(message: IRbmStandaloneCard, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def encodeDelimited(message: IRbmStandaloneCard): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encodeDelimited(message: IRbmStandaloneCard, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def fromObject(`object`: StringDictionary[Any]): RbmStandaloneCard = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[RbmStandaloneCard]
      ...
      /**
        ...
        */
      /* static member */
      inline def toObject(message: RbmStandaloneCard): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
      inline def toObject(message: RbmStandaloneCard, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
    ...
    object RbmSuggestedAction {
      ...
      /**
        ...
        * @param [properties] Properties to set
        */
      open class RbmSuggestedActionDial ()
        extends StObject
      ...
      object RbmSuggestedActionDial {
        ...
        /**
          ...
          */
        /* static member */
        inline def create(): RbmSuggestedActionDial = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[RbmSuggestedActionDial]
        inline def create(properties: IRbmSuggestedActionDial): RbmSuggestedActionDial = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionDial]
        
        inline def decode(reader: js.typedarray.Uint8Array): RbmSuggestedActionDial = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionDial]
        inline def decode(reader: js.typedarray.Uint8Array, length: Double): RbmSuggestedActionDial = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestedActionDial]
        /**
          ...
          */
        /* static member */
        inline def decode(reader: Reader): RbmSuggestedActionDial = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionDial]
        inline def decode(reader: Reader, length: Double): RbmSuggestedActionDial = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestedActionDial]
        
        inline def decodeDelimited(reader: js.typedarray.Uint8Array): RbmSuggestedActionDial = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionDial]
        /**
          ...
          */
        /* static member */
        inline def decodeDelimited(reader: Reader): RbmSuggestedActionDial = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionDial]
        ...
        /**
          ...
          */
        /* static member */
        inline def encode(message: IRbmSuggestedActionDial): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
        inline def encode(message: IRbmSuggestedActionDial, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
        ...
        /**
          ...
          */
        /* static member */
        inline def encodeDelimited(message: IRbmSuggestedActionDial): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
        inline def encodeDelimited(message: IRbmSuggestedActionDial, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
        ...
        /**
          ...
          */
        /* static member */
        inline def fromObject(`object`: StringDictionary[Any]): RbmSuggestedActionDial = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionDial]
        ...
        /**
          ...
          */
        /* static member */
        inline def toObject(message: RbmSuggestedActionDial): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
        inline def toObject(message: RbmSuggestedActionDial, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
      ...
      /**
        ...
        * @param [properties] Properties to set
        */
      open class RbmSuggestedActionOpenUri ()
        extends StObject
      ...
      object RbmSuggestedActionOpenUri {
        ...
        /**
          ...
          */
        /* static member */
        inline def create(): RbmSuggestedActionOpenUri = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[RbmSuggestedActionOpenUri]
        inline def create(properties: IRbmSuggestedActionOpenUri): RbmSuggestedActionOpenUri = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionOpenUri]
        
        inline def decode(reader: js.typedarray.Uint8Array): RbmSuggestedActionOpenUri = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionOpenUri]
        inline def decode(reader: js.typedarray.Uint8Array, length: Double): RbmSuggestedActionOpenUri = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestedActionOpenUri]
        /**
          ...
          */
        /* static member */
        inline def decode(reader: Reader): RbmSuggestedActionOpenUri = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionOpenUri]
        inline def decode(reader: Reader, length: Double): RbmSuggestedActionOpenUri = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestedActionOpenUri]
        
        inline def decodeDelimited(reader: js.typedarray.Uint8Array): RbmSuggestedActionOpenUri = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionOpenUri]
        /**
          ...
          */
        /* static member */
        inline def decodeDelimited(reader: Reader): RbmSuggestedActionOpenUri = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionOpenUri]
        ...
        /**
          ...
          */
        /* static member */
        inline def encode(message: IRbmSuggestedActionOpenUri): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
        inline def encode(message: IRbmSuggestedActionOpenUri, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
        ...
        /**
          ...
          */
        /* static member */
        inline def encodeDelimited(message: IRbmSuggestedActionOpenUri): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
        inline def encodeDelimited(message: IRbmSuggestedActionOpenUri, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
        ...
        /**
          ...
          */
        /* static member */
        inline def fromObject(`object`: StringDictionary[Any]): RbmSuggestedActionOpenUri = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionOpenUri]
        ...
        /**
          ...
          */
        /* static member */
        inline def toObject(message: RbmSuggestedActionOpenUri): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
        inline def toObject(message: RbmSuggestedActionOpenUri, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
      ...
      /**
        ...
        * @param [properties] Properties to set
        */
      open class RbmSuggestedActionShareLocation ()
        extends StObject
      ...
      object RbmSuggestedActionShareLocation {
        ...
        /**
          ...
          */
        /* static member */
        inline def create(): RbmSuggestedActionShareLocation = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[RbmSuggestedActionShareLocation]
        inline def create(properties: IRbmSuggestedActionShareLocation): RbmSuggestedActionShareLocation = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionShareLocation]
        
        inline def decode(reader: js.typedarray.Uint8Array): RbmSuggestedActionShareLocation = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionShareLocation]
        inline def decode(reader: js.typedarray.Uint8Array, length: Double): RbmSuggestedActionShareLocation = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestedActionShareLocation]
        /**
          ...
          */
        /* static member */
        inline def decode(reader: Reader): RbmSuggestedActionShareLocation = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionShareLocation]
        inline def decode(reader: Reader, length: Double): RbmSuggestedActionShareLocation = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestedActionShareLocation]
        
        inline def decodeDelimited(reader: js.typedarray.Uint8Array): RbmSuggestedActionShareLocation = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionShareLocation]
        /**
          ...
          */
        /* static member */
        inline def decodeDelimited(reader: Reader): RbmSuggestedActionShareLocation = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionShareLocation]
        ...
        /**
          ...
          */
        /* static member */
        inline def encode(message: IRbmSuggestedActionShareLocation): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
        inline def encode(message: IRbmSuggestedActionShareLocation, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
        ...
        /**
          ...
          */
        /* static member */
        inline def encodeDelimited(message: IRbmSuggestedActionShareLocation): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
        inline def encodeDelimited(message: IRbmSuggestedActionShareLocation, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
        ...
        /**
          ...
          */
        /* static member */
        inline def fromObject(`object`: StringDictionary[Any]): RbmSuggestedActionShareLocation = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedActionShareLocation]
        ...
        /**
          ...
          */
        /* static member */
        inline def toObject(message: RbmSuggestedActionShareLocation): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
        inline def toObject(message: RbmSuggestedActionShareLocation, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
      ...
      /**
        ...
        */
      /* static member */
      inline def create(): RbmSuggestedAction = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[RbmSuggestedAction]
      inline def create(properties: IRbmSuggestedAction): RbmSuggestedAction = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedAction]
      
      inline def decode(reader: js.typedarray.Uint8Array): RbmSuggestedAction = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedAction]
      inline def decode(reader: js.typedarray.Uint8Array, length: Double): RbmSuggestedAction = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestedAction]
      /**
        ...
        */
      /* static member */
      inline def decode(reader: Reader): RbmSuggestedAction = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedAction]
      inline def decode(reader: Reader, length: Double): RbmSuggestedAction = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestedAction]
      
      inline def decodeDelimited(reader: js.typedarray.Uint8Array): RbmSuggestedAction = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedAction]
      /**
        ...
        */
      /* static member */
      inline def decodeDelimited(reader: Reader): RbmSuggestedAction = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedAction]
      ...
      /**
        ...
        */
      /* static member */
      inline def encode(message: IRbmSuggestedAction): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encode(message: IRbmSuggestedAction, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def encodeDelimited(message: IRbmSuggestedAction): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encodeDelimited(message: IRbmSuggestedAction, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def fromObject(`object`: StringDictionary[Any]): RbmSuggestedAction = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedAction]
      ...
      /**
        ...
        */
      /* static member */
      inline def toObject(message: RbmSuggestedAction): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
      inline def toObject(message: RbmSuggestedAction, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
      ...
      object IRbmSuggestedActionDial {
        ...
        inline def apply(): IRbmSuggestedActionDial = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[IRbmSuggestedActionDial]
        }
        
        @scala.inline
        implicit open class MutableBuilder[Self <: IRbmSuggestedActionDial] (val x: Self) extends AnyVal {
      ...
      object IRbmSuggestedActionOpenUri {
        ...
        inline def apply(): IRbmSuggestedActionOpenUri = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[IRbmSuggestedActionOpenUri]
        }
        
        @scala.inline
        implicit open class MutableBuilder[Self <: IRbmSuggestedActionOpenUri] (val x: Self) extends AnyVal {
    ...
    object RbmSuggestedReply {
      ...
      /**
        ...
        */
      /* static member */
      inline def create(): RbmSuggestedReply = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[RbmSuggestedReply]
      inline def create(properties: IRbmSuggestedReply): RbmSuggestedReply = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedReply]
      
      inline def decode(reader: js.typedarray.Uint8Array): RbmSuggestedReply = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedReply]
      inline def decode(reader: js.typedarray.Uint8Array, length: Double): RbmSuggestedReply = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestedReply]
      /**
        ...
        */
      /* static member */
      inline def decode(reader: Reader): RbmSuggestedReply = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedReply]
      inline def decode(reader: Reader, length: Double): RbmSuggestedReply = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestedReply]
      
      inline def decodeDelimited(reader: js.typedarray.Uint8Array): RbmSuggestedReply = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedReply]
      /**
        ...
        */
      /* static member */
      inline def decodeDelimited(reader: Reader): RbmSuggestedReply = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedReply]
      ...
      /**
        ...
        */
      /* static member */
      inline def encode(message: IRbmSuggestedReply): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encode(message: IRbmSuggestedReply, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def encodeDelimited(message: IRbmSuggestedReply): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encodeDelimited(message: IRbmSuggestedReply, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def fromObject(`object`: StringDictionary[Any]): RbmSuggestedReply = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestedReply]
      ...
      /**
        ...
        */
      /* static member */
      inline def toObject(message: RbmSuggestedReply): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
      inline def toObject(message: RbmSuggestedReply, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
    ...
    object RbmSuggestion {
      ...
      /**
        ...
        */
      /* static member */
      inline def create(): RbmSuggestion = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[RbmSuggestion]
      inline def create(properties: IRbmSuggestion): RbmSuggestion = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestion]
      
      inline def decode(reader: js.typedarray.Uint8Array): RbmSuggestion = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestion]
      inline def decode(reader: js.typedarray.Uint8Array, length: Double): RbmSuggestion = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestion]
      /**
        ...
        */
      /* static member */
      inline def decode(reader: Reader): RbmSuggestion = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestion]
      inline def decode(reader: Reader, length: Double): RbmSuggestion = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmSuggestion]
      
      inline def decodeDelimited(reader: js.typedarray.Uint8Array): RbmSuggestion = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestion]
      /**
        ...
        */
      /* static member */
      inline def decodeDelimited(reader: Reader): RbmSuggestion = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestion]
      ...
      /**
        ...
        */
      /* static member */
      inline def encode(message: IRbmSuggestion): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encode(message: IRbmSuggestion, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def encodeDelimited(message: IRbmSuggestion): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encodeDelimited(message: IRbmSuggestion, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def fromObject(`object`: StringDictionary[Any]): RbmSuggestion = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[RbmSuggestion]
      ...
      /**
        ...
        */
      /* static member */
      inline def toObject(message: RbmSuggestion): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
      inline def toObject(message: RbmSuggestion, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
    ...
    object RbmText {
      ...
      /**
        ...
        */
      /* static member */
      inline def create(): RbmText = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[RbmText]
      inline def create(properties: IRbmText): RbmText = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[RbmText]
      
      inline def decode(reader: js.typedarray.Uint8Array): RbmText = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmText]
      inline def decode(reader: js.typedarray.Uint8Array, length: Double): RbmText = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmText]
      /**
        ...
        */
      /* static member */
      inline def decode(reader: Reader): RbmText = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmText]
      inline def decode(reader: Reader, length: Double): RbmText = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[RbmText]
      
      inline def decodeDelimited(reader: js.typedarray.Uint8Array): RbmText = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmText]
      /**
        ...
        */
      /* static member */
      inline def decodeDelimited(reader: Reader): RbmText = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[RbmText]
      ...
      /**
        ...
        */
      /* static member */
      inline def encode(message: IRbmText): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encode(message: IRbmText, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def encodeDelimited(message: IRbmText): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encodeDelimited(message: IRbmText, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def fromObject(`object`: StringDictionary[Any]): RbmText = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[RbmText]
      ...
      /**
        ...
        */
      /* static member */
      inline def toObject(message: RbmText): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
      inline def toObject(message: RbmText, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
    ...
    object TelephonyPlayAudio {
      ...
      /**
        ...
        */
      /* static member */
      inline def create(): TelephonyPlayAudio = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[TelephonyPlayAudio]
      inline def create(properties: ITelephonyPlayAudio): TelephonyPlayAudio = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[TelephonyPlayAudio]
      
      inline def decode(reader: js.typedarray.Uint8Array): TelephonyPlayAudio = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonyPlayAudio]
      inline def decode(reader: js.typedarray.Uint8Array, length: Double): TelephonyPlayAudio = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TelephonyPlayAudio]
      /**
        ...
        */
      /* static member */
      inline def decode(reader: Reader): TelephonyPlayAudio = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonyPlayAudio]
      inline def decode(reader: Reader, length: Double): TelephonyPlayAudio = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TelephonyPlayAudio]
      
      inline def decodeDelimited(reader: js.typedarray.Uint8Array): TelephonyPlayAudio = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonyPlayAudio]
      /**
        ...
        */
      /* static member */
      inline def decodeDelimited(reader: Reader): TelephonyPlayAudio = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonyPlayAudio]
      ...
      /**
        ...
        */
      /* static member */
      inline def encode(message: ITelephonyPlayAudio): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encode(message: ITelephonyPlayAudio, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def encodeDelimited(message: ITelephonyPlayAudio): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encodeDelimited(message: ITelephonyPlayAudio, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def fromObject(`object`: StringDictionary[Any]): TelephonyPlayAudio = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TelephonyPlayAudio]
      ...
      /**
        ...
        */
      /* static member */
      inline def toObject(message: TelephonyPlayAudio): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
      inline def toObject(message: TelephonyPlayAudio, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
    ...
    /**
      ...
      * @param [properties] Properties to set
      */
    open class TelephonySynthesizeSpeech ()
      extends StObject
    ...
    object TelephonySynthesizeSpeech {
      ...
      /**
        ...
        */
      /* static member */
      inline def create(): TelephonySynthesizeSpeech = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[TelephonySynthesizeSpeech]
      inline def create(properties: ITelephonySynthesizeSpeech): TelephonySynthesizeSpeech = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[TelephonySynthesizeSpeech]
      
      inline def decode(reader: js.typedarray.Uint8Array): TelephonySynthesizeSpeech = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonySynthesizeSpeech]
      inline def decode(reader: js.typedarray.Uint8Array, length: Double): TelephonySynthesizeSpeech = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TelephonySynthesizeSpeech]
      /**
        ...
        */
      /* static member */
      inline def decode(reader: Reader): TelephonySynthesizeSpeech = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonySynthesizeSpeech]
      inline def decode(reader: Reader, length: Double): TelephonySynthesizeSpeech = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TelephonySynthesizeSpeech]
      
      inline def decodeDelimited(reader: js.typedarray.Uint8Array): TelephonySynthesizeSpeech = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonySynthesizeSpeech]
      /**
        ...
        */
      /* static member */
      inline def decodeDelimited(reader: Reader): TelephonySynthesizeSpeech = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonySynthesizeSpeech]
      ...
      /**
        ...
        */
      /* static member */
      inline def encode(message: ITelephonySynthesizeSpeech): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encode(message: ITelephonySynthesizeSpeech, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def encodeDelimited(message: ITelephonySynthesizeSpeech): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encodeDelimited(message: ITelephonySynthesizeSpeech, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def fromObject(`object`: StringDictionary[Any]): TelephonySynthesizeSpeech = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TelephonySynthesizeSpeech]
      ...
      /**
        ...
        */
      /* static member */
      inline def toObject(message: TelephonySynthesizeSpeech): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
      inline def toObject(message: TelephonySynthesizeSpeech, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
    ...
    /**
      ...
      * @param [properties] Properties to set
      */
    open class TelephonyTransferCall ()
      extends StObject
    ...
    object TelephonyTransferCall {
      ...
      /**
        ...
        */
      /* static member */
      inline def create(): TelephonyTransferCall = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[TelephonyTransferCall]
      inline def create(properties: ITelephonyTransferCall): TelephonyTransferCall = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[TelephonyTransferCall]
      
      inline def decode(reader: js.typedarray.Uint8Array): TelephonyTransferCall = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonyTransferCall]
      inline def decode(reader: js.typedarray.Uint8Array, length: Double): TelephonyTransferCall = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TelephonyTransferCall]
      /**
        ...
        */
      /* static member */
      inline def decode(reader: Reader): TelephonyTransferCall = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonyTransferCall]
      inline def decode(reader: Reader, length: Double): TelephonyTransferCall = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TelephonyTransferCall]
      
      inline def decodeDelimited(reader: js.typedarray.Uint8Array): TelephonyTransferCall = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonyTransferCall]
      /**
        ...
        */
      /* static member */
      inline def decodeDelimited(reader: Reader): TelephonyTransferCall = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TelephonyTransferCall]
      ...
      /**
        ...
        */
      /* static member */
      inline def encode(message: ITelephonyTransferCall): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encode(message: ITelephonyTransferCall, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def encodeDelimited(message: ITelephonyTransferCall): Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any]).asInstanceOf[Writer]
      inline def encodeDelimited(message: ITelephonyTransferCall, writer: Writer): Writer = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeDelimited")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Writer]
      ...
      /**
        ...
        */
      /* static member */
      inline def fromObject(`object`: StringDictionary[Any]): TelephonyTransferCall = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TelephonyTransferCall]
      ...
      /**
        ...
        */
      /* static member */
      inline def toObject(message: TelephonyTransferCall): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
      inline def toObject(message: TelephonyTransferCall, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
    ...
    object ICard {
      ...
      implicit open class MutableBuilder[Self <: ICard] (val x: Self) extends AnyVal {
        ...
        inline def setButtonsVarargs(
          value: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.Card.IButton*
    ...
    object IListSelect {
      ...
      implicit open class MutableBuilder[Self <: IListSelect] (val x: Self) extends AnyVal {
        ...
        inline def setItemsVarargs(
          value: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.IItem*
    ...
    object IRbmCardContent {
      ...
      inline def apply(): IRbmCardContent = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[IRbmCardContent]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: IRbmCardContent] (val x: Self) extends AnyVal {
        ...
        inline def setMedia(value: IRbmMedia): Self = StObject.set(x, "media", value.asInstanceOf[js.Any])
        
        inline def setMediaNull: Self = StObject.set(x, "media", null)
        
        inline def setMediaUndefined: Self = StObject.set(x, "media", js.undefined)
        
        inline def setSuggestions(value: js.Array[IRbmSuggestion]): Self = StObject.set(x, "suggestions", value.asInstanceOf[js.Any])
        
        inline def setSuggestionsNull: Self = StObject.set(x, "suggestions", null)
        
        inline def setSuggestionsUndefined: Self = StObject.set(x, "suggestions", js.undefined)
        
        inline def setSuggestionsVarargs(value: IRbmSuggestion*): Self = StObject.set(x, "suggestions", js.Array(value*))
    ...
    object IRbmCarouselCard {
      ...
      inline def apply(): IRbmCarouselCard = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[IRbmCarouselCard]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: IRbmCarouselCard] (val x: Self) extends AnyVal {
        
        inline def setCardContents(value: js.Array[IRbmCardContent]): Self = StObject.set(x, "cardContents", value.asInstanceOf[js.Any])
        
        inline def setCardContentsNull: Self = StObject.set(x, "cardContents", null)
        
        inline def setCardContentsUndefined: Self = StObject.set(x, "cardContents", js.undefined)
        
        inline def setCardContentsVarargs(value: IRbmCardContent*): Self = StObject.set(x, "cardContents", js.Array(value*))
        
        inline def setCardWidth(
    ...
    object IRbmStandaloneCard {
      ...
      inline def apply(): IRbmStandaloneCard = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[IRbmStandaloneCard]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: IRbmStandaloneCard] (val x: Self) extends AnyVal {
        
        inline def setCardContent(value: IRbmCardContent): Self = StObject.set(x, "cardContent", value.asInstanceOf[js.Any])
        
        inline def setCardContentNull: Self = StObject.set(x, "cardContent", null)
        
        inline def setCardContentUndefined: Self = StObject.set(x, "cardContent", js.undefined)
        
        inline def setCardOrientation(
        ...
        inline def setThumbnailImageAlignment(
    ...
    object IRbmSuggestedAction {
      ...
      inline def apply(): IRbmSuggestedAction = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[IRbmSuggestedAction]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: IRbmSuggestedAction] (val x: Self) extends AnyVal {
        
        inline def setDial(value: IRbmSuggestedActionDial): Self = StObject.set(x, "dial", value.asInstanceOf[js.Any])
        
        inline def setDialNull: Self = StObject.set(x, "dial", null)
        
        inline def setDialUndefined: Self = StObject.set(x, "dial", js.undefined)
        
        inline def setOpenUrl(value: IRbmSuggestedActionOpenUri): Self = StObject.set(x, "openUrl", value.asInstanceOf[js.Any])
        
        inline def setOpenUrlNull: Self = StObject.set(x, "openUrl", null)
        ...
        inline def setShareLocation(value: IRbmSuggestedActionShareLocation): Self = StObject.set(x, "shareLocation", value.asInstanceOf[js.Any])
        
        inline def setShareLocationNull: Self = StObject.set(x, "shareLocation", null)
    ...
    object IRbmSuggestedReply {
      ...
      inline def apply(): IRbmSuggestedReply = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[IRbmSuggestedReply]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: IRbmSuggestedReply] (val x: Self) extends AnyVal {
    ...
    object IRbmSuggestion {
      ...
      inline def apply(): IRbmSuggestion = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[IRbmSuggestion]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: IRbmSuggestion] (val x: Self) extends AnyVal {
        
        inline def setAction(value: IRbmSuggestedAction): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
        
        inline def setActionNull: Self = StObject.set(x, "action", null)
        
        inline def setActionUndefined: Self = StObject.set(x, "action", js.undefined)
        
        inline def setReply(value: IRbmSuggestedReply): Self = StObject.set(x, "reply", value.asInstanceOf[js.Any])
    ...
    object IRbmText {
      ...
      inline def apply(): IRbmText = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[IRbmText]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: IRbmText] (val x: Self) extends AnyVal {
        
        inline def setRbmSuggestion(value: js.Array[IRbmSuggestion]): Self = StObject.set(x, "rbmSuggestion", value.asInstanceOf[js.Any])
        
        inline def setRbmSuggestionNull: Self = StObject.set(x, "rbmSuggestion", null)
        
        inline def setRbmSuggestionUndefined: Self = StObject.set(x, "rbmSuggestion", js.undefined)
        
        inline def setRbmSuggestionVarargs(value: IRbmSuggestion*): Self = StObject.set(x, "rbmSuggestion", js.Array(value*))
    ...
    object ITelephonyPlayAudio {
      ...
      inline def apply(): ITelephonyPlayAudio = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[ITelephonyPlayAudio]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: ITelephonyPlayAudio] (val x: Self) extends AnyVal {
    ...
    object ITelephonySynthesizeSpeech {
      ...
      inline def apply(): ITelephonySynthesizeSpeech = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[ITelephonySynthesizeSpeech]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: ITelephonySynthesizeSpeech] (val x: Self) extends AnyVal {
    ...
    object ITelephonyTransferCall {
      ...
      inline def apply(): ITelephonyTransferCall = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[ITelephonyTransferCall]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: ITelephonyTransferCall] (val x: Self) extends AnyVal {
  ...
  object TrainingPhrase {
    ...
    object Type extends StObject {
      ...
      sealed trait EXAMPLE
        extends StObject
           with Type
      /* 1 */ val EXAMPLE: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.Type.EXAMPLE & Double = js.native
      
      @js.native
      sealed trait TEMPLATE
        extends StObject
           with Type
      /* 2 */ val TEMPLATE: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.Type.TEMPLATE & Double = js.native
      
      @js.native
      sealed trait TYPE_UNSPECIFIED
        extends StObject
           with Type
      /* 0 */ val TYPE_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.Type.TYPE_UNSPECIFIED & Double = js.native
    }
  ...
  object WebhookState extends StObject {
    ...
    sealed trait WEBHOOK_STATE_ENABLED
      extends StObject
         with WebhookState
    /* 1 */ val WEBHOOK_STATE_ENABLED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.WebhookState.WEBHOOK_STATE_ENABLED & Double = js.native
    
    @js.native
    sealed trait WEBHOOK_STATE_ENABLED_FOR_SLOT_FILLING
      extends StObject
         with WebhookState
    /* 2 */ val WEBHOOK_STATE_ENABLED_FOR_SLOT_FILLING: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.WebhookState.WEBHOOK_STATE_ENABLED_FOR_SLOT_FILLING & Double = js.native
    
    @js.native
    sealed trait WEBHOOK_STATE_UNSPECIFIED
      extends StObject
         with WebhookState
    /* 0 */ val WEBHOOK_STATE_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.WebhookState.WEBHOOK_STATE_UNSPECIFIED & Double = js.native
  }
  ...
  object IMessage {
    ...
    implicit open class MutableBuilder[Self <: IMessage] (val x: Self) extends AnyVal {
      ...
      inline def setRbmCarouselRichCard(value: IRbmCarouselCard): Self = StObject.set(x, "rbmCarouselRichCard", value.asInstanceOf[js.Any])
      
      inline def setRbmCarouselRichCardNull: Self = StObject.set(x, "rbmCarouselRichCard", null)
      
      inline def setRbmCarouselRichCardUndefined: Self = StObject.set(x, "rbmCarouselRichCard", js.undefined)
      
      inline def setRbmStandaloneRichCard(value: IRbmStandaloneCard): Self = StObject.set(x, "rbmStandaloneRichCard", value.asInstanceOf[js.Any])
      
      inline def setRbmStandaloneRichCardNull: Self = StObject.set(x, "rbmStandaloneRichCard", null)
      
      inline def setRbmStandaloneRichCardUndefined: Self = StObject.set(x, "rbmStandaloneRichCard", js.undefined)
      
      inline def setRbmText(value: IRbmText): Self = StObject.set(x, "rbmText", value.asInstanceOf[js.Any])
      
      inline def setRbmTextNull: Self = StObject.set(x, "rbmText", null)
      ...
      inline def setTelephonyPlayAudio(value: ITelephonyPlayAudio): Self = StObject.set(x, "telephonyPlayAudio", value.asInstanceOf[js.Any])
      
      inline def setTelephonyPlayAudioNull: Self = StObject.set(x, "telephonyPlayAudio", null)
      
      inline def setTelephonyPlayAudioUndefined: Self = StObject.set(x, "telephonyPlayAudio", js.undefined)
      
      inline def setTelephonySynthesizeSpeech(value: ITelephonySynthesizeSpeech): Self = StObject.set(x, "telephonySynthesizeSpeech", value.asInstanceOf[js.Any])
      
      inline def setTelephonySynthesizeSpeechNull: Self = StObject.set(x, "telephonySynthesizeSpeech", null)
      
      inline def setTelephonySynthesizeSpeechUndefined: Self = StObject.set(x, "telephonySynthesizeSpeech", js.undefined)
      
      inline def setTelephonyTransferCall(value: ITelephonyTransferCall): Self = StObject.set(x, "telephonyTransferCall", value.asInstanceOf[js.Any])
      
      inline def setTelephonyTransferCallNull: Self = StObject.set(x, "telephonyTransferCall", null)
