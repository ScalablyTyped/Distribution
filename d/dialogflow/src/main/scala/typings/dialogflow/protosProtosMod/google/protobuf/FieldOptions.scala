...
object FieldOptions {
  ...
  object CType extends StObject {
    ...
    sealed trait CORD
      extends StObject
         with CType
    /* 1 */ val CORD: typings.dialogflow.protosProtosMod.google.protobuf.FieldOptions.CType.CORD & Double = js.native
    
    @js.native
    sealed trait STRING
      extends StObject
         with CType
    /* 0 */ val STRING: typings.dialogflow.protosProtosMod.google.protobuf.FieldOptions.CType.STRING & Double = js.native
    
    @js.native
    sealed trait STRING_PIECE
      extends StObject
         with CType
    /* 2 */ val STRING_PIECE: typings.dialogflow.protosProtosMod.google.protobuf.FieldOptions.CType.STRING_PIECE & Double = js.native
  }
  ...
  object JSType extends StObject {
    ...
    sealed trait JS_NORMAL
      extends StObject
         with JSType
    /* 0 */ val JS_NORMAL: typings.dialogflow.protosProtosMod.google.protobuf.FieldOptions.JSType.JS_NORMAL & Double = js.native
    
    @js.native
    sealed trait JS_NUMBER
      extends StObject
         with JSType
    /* 2 */ val JS_NUMBER: typings.dialogflow.protosProtosMod.google.protobuf.FieldOptions.JSType.JS_NUMBER & Double = js.native
    
    @js.native
    sealed trait JS_STRING
      extends StObject
         with JSType
    /* 1 */ val JS_STRING: typings.dialogflow.protosProtosMod.google.protobuf.FieldOptions.JSType.JS_STRING & Double = js.native
  }
