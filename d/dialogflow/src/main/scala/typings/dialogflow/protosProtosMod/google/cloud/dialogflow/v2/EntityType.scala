...
object EntityType {
  ...
  object AutoExpansionMode extends StObject {
    ...
    /* 1 */ val AUTO_EXPANSION_MODE_DEFAULT: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.EntityType.AutoExpansionMode.AUTO_EXPANSION_MODE_DEFAULT & Double = js.native
    
    @js.native
    sealed trait AUTO_EXPANSION_MODE_UNSPECIFIED
      extends StObject
         with AutoExpansionMode
    /* 0 */ val AUTO_EXPANSION_MODE_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.EntityType.AutoExpansionMode.AUTO_EXPANSION_MODE_UNSPECIFIED & Double = js.native
  }
  ...
  object Kind extends StObject {
    ...
    sealed trait KIND_LIST
      extends StObject
         with Kind
    /* 2 */ val KIND_LIST: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.EntityType.Kind.KIND_LIST & Double = js.native
    
    @js.native
    sealed trait KIND_MAP
      extends StObject
         with Kind
    /* 1 */ val KIND_MAP: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.EntityType.Kind.KIND_MAP & Double = js.native
    
    @js.native
    sealed trait KIND_REGEXP
      extends StObject
         with Kind
    /* 3 */ val KIND_REGEXP: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.EntityType.Kind.KIND_REGEXP & Double = js.native
    
    @js.native
    sealed trait KIND_UNSPECIFIED
      extends StObject
         with Kind
    /* 0 */ val KIND_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.EntityType.Kind.KIND_UNSPECIFIED & Double = js.native
  }
