...
object Document {
  ...
  object KnowledgeType extends StObject {
    ...
    sealed trait EXTRACTIVE_QA
      extends StObject
         with KnowledgeType
    /* 2 */ val EXTRACTIVE_QA: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Document.KnowledgeType.EXTRACTIVE_QA & Double = js.native
    
    @js.native
    sealed trait FAQ
      extends StObject
         with KnowledgeType
    /* 1 */ val FAQ: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Document.KnowledgeType.FAQ & Double = js.native
    
    @js.native
    sealed trait KNOWLEDGE_TYPE_UNSPECIFIED
      extends StObject
         with KnowledgeType
    /* 0 */ val KNOWLEDGE_TYPE_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Document.KnowledgeType.KNOWLEDGE_TYPE_UNSPECIFIED & Double = js.native
  }
