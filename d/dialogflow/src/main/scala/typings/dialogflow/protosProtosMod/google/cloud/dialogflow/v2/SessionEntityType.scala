...
object SessionEntityType {
  ...
  object EntityOverrideMode extends StObject {
    ...
    /* 1 */ val ENTITY_OVERRIDE_MODE_OVERRIDE: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_OVERRIDE & Double = js.native
    
    @js.native
    sealed trait ENTITY_OVERRIDE_MODE_SUPPLEMENT
      extends StObject
         with EntityOverrideMode
    /* 2 */ val ENTITY_OVERRIDE_MODE_SUPPLEMENT: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_SUPPLEMENT & Double = js.native
    
    @js.native
    sealed trait ENTITY_OVERRIDE_MODE_UNSPECIFIED
      extends StObject
         with EntityOverrideMode
    /* 0 */ val ENTITY_OVERRIDE_MODE_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2.SessionEntityType.EntityOverrideMode.ENTITY_OVERRIDE_MODE_UNSPECIFIED & Double = js.native
  }
