...
import typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.IFollowupIntentInfo
import typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.IMessage
import typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.IParameter
...
import typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.WebhookState
...
object IIntent {
  ...
  def apply(
    ...
    if (!js.isUndefined(endInteraction)) __obj.updateDynamic("endInteraction")(endInteraction)
