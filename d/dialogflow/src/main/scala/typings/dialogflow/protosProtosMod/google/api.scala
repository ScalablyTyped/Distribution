...
object api {
  ...
  object FieldBehavior extends StObject {
    ...
    sealed trait FIELD_BEHAVIOR_UNSPECIFIED
      extends StObject
         with FieldBehavior
    /* 0 */ val FIELD_BEHAVIOR_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.api.FieldBehavior.FIELD_BEHAVIOR_UNSPECIFIED & Double = js.native
    
    @js.native
    sealed trait IMMUTABLE
      extends StObject
         with FieldBehavior
    /* 5 */ val IMMUTABLE: typings.dialogflow.protosProtosMod.google.api.FieldBehavior.IMMUTABLE & Double = js.native
    
    @js.native
    sealed trait INPUT_ONLY
      extends StObject
         with FieldBehavior
    /* 4 */ val INPUT_ONLY: typings.dialogflow.protosProtosMod.google.api.FieldBehavior.INPUT_ONLY & Double = js.native
    
    @js.native
    sealed trait OPTIONAL
      extends StObject
         with FieldBehavior
    /* 1 */ val OPTIONAL: typings.dialogflow.protosProtosMod.google.api.FieldBehavior.OPTIONAL & Double = js.native
    
    @js.native
    sealed trait OUTPUT_ONLY
      extends StObject
         with FieldBehavior
    /* 3 */ val OUTPUT_ONLY: typings.dialogflow.protosProtosMod.google.api.FieldBehavior.OUTPUT_ONLY & Double = js.native
    
    @js.native
    sealed trait REQUIRED
      extends StObject
         with FieldBehavior
    /* 2 */ val REQUIRED: typings.dialogflow.protosProtosMod.google.api.FieldBehavior.REQUIRED & Double = js.native
  }
  ...
  object ResourceDescriptor {
    ...
    object History extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typings.dialogflow.protosProtosMod.google.api.ResourceDescriptor.History & Double
          ] = js.native
      
      @js.native
      sealed trait FUTURE_MULTI_PATTERN
        extends StObject
           with typings.dialogflow.protosProtosMod.google.api.ResourceDescriptor.History
      /* 2 */ val FUTURE_MULTI_PATTERN: typings.dialogflow.protosProtosMod.google.api.ResourceDescriptor.History.FUTURE_MULTI_PATTERN & Double = js.native
      
      @js.native
      sealed trait HISTORY_UNSPECIFIED
        extends StObject
           with typings.dialogflow.protosProtosMod.google.api.ResourceDescriptor.History
      /* 0 */ val HISTORY_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.api.ResourceDescriptor.History.HISTORY_UNSPECIFIED & Double = js.native
      
      @js.native
      sealed trait ORIGINALLY_SINGLE_PATTERN
        extends StObject
           with typings.dialogflow.protosProtosMod.google.api.ResourceDescriptor.History
      /* 1 */ val ORIGINALLY_SINGLE_PATTERN: typings.dialogflow.protosProtosMod.google.api.ResourceDescriptor.History.ORIGINALLY_SINGLE_PATTERN & Double = js.native
    }
