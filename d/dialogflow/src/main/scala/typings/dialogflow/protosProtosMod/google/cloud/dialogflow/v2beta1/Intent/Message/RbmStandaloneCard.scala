...
object RbmStandaloneCard extends js.Object {
  ...
  object CardOrientation extends js.Object {
    ...
    /* 0 */ val CARD_ORIENTATION_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.CardOrientation.CARD_ORIENTATION_UNSPECIFIED with Double = js.native
    /* 1 */ val HORIZONTAL: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.CardOrientation.HORIZONTAL with Double = js.native
    /* 2 */ val VERTICAL: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.CardOrientation.VERTICAL with Double = js.native
    @JSBracketAccess
  ...
  object ThumbnailImageAlignment extends js.Object {
    ...
    /* 1 */ val LEFT: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment.LEFT with Double = js.native
    /* 2 */ val RIGHT: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment.RIGHT with Double = js.native
    /* 0 */ val THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment.THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED with Double = js.native
    @JSBracketAccess
