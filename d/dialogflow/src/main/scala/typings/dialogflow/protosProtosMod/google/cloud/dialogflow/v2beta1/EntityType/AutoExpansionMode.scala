...
object AutoExpansionMode extends js.Object {
  ...
  /* 1 */ val AUTO_EXPANSION_MODE_DEFAULT: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.EntityType.AutoExpansionMode.AUTO_EXPANSION_MODE_DEFAULT with Double = js.native
  /* 0 */ val AUTO_EXPANSION_MODE_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.EntityType.AutoExpansionMode.AUTO_EXPANSION_MODE_UNSPECIFIED with Double = js.native
  @JSBracketAccess
