...
object KnowledgeAnswers {
  ...
  object Answer {
    ...
    object MatchConfidenceLevel extends StObject {
      ...
      /* 3 */ val HIGH: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.MatchConfidenceLevel.HIGH & Double = js.native
      
      @js.native
      sealed trait LOW
        extends StObject
           with MatchConfidenceLevel
      /* 1 */ val LOW: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.MatchConfidenceLevel.LOW & Double = js.native
      
      @js.native
      sealed trait MATCH_CONFIDENCE_LEVEL_UNSPECIFIED
        extends StObject
           with MatchConfidenceLevel
      /* 0 */ val MATCH_CONFIDENCE_LEVEL_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.MatchConfidenceLevel.MATCH_CONFIDENCE_LEVEL_UNSPECIFIED & Double = js.native
      
      @js.native
      sealed trait MEDIUM
        extends StObject
           with MatchConfidenceLevel
      /* 2 */ val MEDIUM: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.MatchConfidenceLevel.MEDIUM & Double = js.native
    }
  ...
  object IAnswer {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: IAnswer] (val x: Self) extends AnyVal {
