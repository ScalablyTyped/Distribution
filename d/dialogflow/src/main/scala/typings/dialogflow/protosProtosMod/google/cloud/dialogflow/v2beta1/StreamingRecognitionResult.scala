...
object StreamingRecognitionResult {
  ...
  object MessageType extends StObject {
    ...
    sealed trait END_OF_SINGLE_UTTERANCE
      extends StObject
         with MessageType
    /* 2 */ val END_OF_SINGLE_UTTERANCE: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.MessageType.END_OF_SINGLE_UTTERANCE & Double = js.native
    
    @js.native
    sealed trait MESSAGE_TYPE_UNSPECIFIED
      extends StObject
         with MessageType
    /* 0 */ val MESSAGE_TYPE_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.MessageType.MESSAGE_TYPE_UNSPECIFIED & Double = js.native
    
    @js.native
    sealed trait TRANSCRIPT
      extends StObject
         with MessageType
    /* 1 */ val TRANSCRIPT: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.MessageType.TRANSCRIPT & Double = js.native
  }
