...
object ValidationError {
  ...
  object Severity extends StObject {
    ...
    sealed trait CRITICAL
      extends StObject
         with Severity
    /* 4 */ val CRITICAL: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.ValidationError.Severity.CRITICAL & Double = js.native
    
    @js.native
    sealed trait ERROR
      extends StObject
         with Severity
    /* 3 */ val ERROR: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.ValidationError.Severity.ERROR & Double = js.native
    
    @js.native
    sealed trait INFO
      extends StObject
         with Severity
    /* 1 */ val INFO: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.ValidationError.Severity.INFO & Double = js.native
    
    @js.native
    sealed trait SEVERITY_UNSPECIFIED
      extends StObject
         with Severity
    /* 0 */ val SEVERITY_UNSPECIFIED: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.ValidationError.Severity.SEVERITY_UNSPECIFIED & Double = js.native
    
    @js.native
    sealed trait WARNING
      extends StObject
         with Severity
    /* 2 */ val WARNING: typings.dialogflow.protosProtosMod.google.cloud.dialogflow.v2beta1.ValidationError.Severity.WARNING & Double = js.native
  }
