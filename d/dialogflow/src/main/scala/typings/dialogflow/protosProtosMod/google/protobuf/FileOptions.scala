...
object FileOptions {
  ...
  object OptimizeMode extends StObject {
    ...
    sealed trait CODE_SIZE
      extends StObject
         with OptimizeMode
    /* 2 */ val CODE_SIZE: typings.dialogflow.protosProtosMod.google.protobuf.FileOptions.OptimizeMode.CODE_SIZE & Double = js.native
    
    @js.native
    sealed trait LITE_RUNTIME
      extends StObject
         with OptimizeMode
    /* 3 */ val LITE_RUNTIME: typings.dialogflow.protosProtosMod.google.protobuf.FileOptions.OptimizeMode.LITE_RUNTIME & Double = js.native
    
    @js.native
    sealed trait SPEED
      extends StObject
         with OptimizeMode
    /* 1 */ val SPEED: typings.dialogflow.protosProtosMod.google.protobuf.FileOptions.OptimizeMode.SPEED & Double = js.native
  }
