...
object IInputAudioConfig {
  @scala.inline
  def apply(
    audioEncoding: AudioEncoding | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.AudioEncoding * / any */ String) = null,
    enableWordInfo: js.UndefOr[Boolean] = js.undefined,
    languageCode: String = null,
    model: String = null,
    modelVariant: SpeechModelVariant | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.SpeechModelVariant * / any */ String) = null,
