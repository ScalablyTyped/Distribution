...
class StreamingRecognitionResult ()
  ...
  @JSName("messageType")
  var messageType_StreamingRecognitionResult: MessageType | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.MessageType * / any */ String) = js.native
  ...
  @JSName("stability")
  var stability_StreamingRecognitionResult: Double = js.native
...
object StreamingRecognitionResult {
  ...
  /** MessageType enum. */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.MessageType")
  @js.native
