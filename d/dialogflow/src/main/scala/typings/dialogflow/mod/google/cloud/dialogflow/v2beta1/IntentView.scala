...
object IntentView extends StObject {
  ...
  sealed trait INTENT_VIEW_FULL
    extends StObject
       with IntentView
  /* 1 */ val INTENT_VIEW_FULL: typings.dialogflow.mod.google.cloud.dialogflow.v2beta1.IntentView.INTENT_VIEW_FULL & Double = js.native
  
  @js.native
  sealed trait INTENT_VIEW_UNSPECIFIED
    extends StObject
       with IntentView
  /* 0 */ val INTENT_VIEW_UNSPECIFIED: typings.dialogflow.mod.google.cloud.dialogflow.v2beta1.IntentView.INTENT_VIEW_UNSPECIFIED & Double = js.native
}
