...
object ISessionEntityType {
  ...
  def apply(
    ...
    entityOverrideMode: EntityOverrideMode | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.SessionEntityType.EntityOverrideMode * / any */ String) = null,
    name: String = null
  ): ISessionEntityType = {
