...
import typings.dialogflow.mod.google.cloud.dialogflow.v2beta1.Agents.DeleteAgentCallback
import typings.dialogflow.mod.google.cloud.dialogflow.v2beta1.Agents.ExportAgentCallback
import typings.dialogflow.mod.google.cloud.dialogflow.v2beta1.Agents.GetAgentCallback
import typings.dialogflow.mod.google.cloud.dialogflow.v2beta1.Agents.GetValidationResultCallback
import typings.dialogflow.mod.google.cloud.dialogflow.v2beta1.Agents.ImportAgentCallback
import typings.dialogflow.mod.google.cloud.dialogflow.v2beta1.Agents.RestoreAgentCallback
import typings.dialogflow.mod.google.cloud.dialogflow.v2beta1.Agents.SearchAgentsCallback
import typings.dialogflow.mod.google.cloud.dialogflow.v2beta1.Agents.SetAgentCallback
import typings.dialogflow.mod.google.cloud.dialogflow.v2beta1.Agents.TrainAgentCallback
...
@JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.Agents")
@js.native
class Agents protected () extends Service {
  ...
  /**
    ...
    * @returns Promise
    */
  def getValidationResult(request: IGetValidationResultRequest): js.Promise[ValidationResult] = js.native
  /**
    * Calls GetValidationResult.
    * @param request GetValidationResultRequest message or plain object
    * @param callback Node-style callback called with the error, if any, and ValidationResult
    */
  def getValidationResult(request: IGetValidationResultRequest, callback: GetValidationResultCallback): Unit = js.native
...
object Agents {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.Agents.create")
  @js.native
  ...
  /**
    ...
    */
  type GetValidationResultCallback = js.Function2[/* error */ Error | Null, /* response */ js.UndefOr[ValidationResult], Unit]
