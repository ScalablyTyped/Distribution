...
class Intent_ () extends IIntent {
  ...
  /** Intent webhookState. */
  @JSName("webhookState")
  var webhookState_Intent_ : WebhookState | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.Intent.WebhookState * / any */ String) = js.native
  /**
