...
class TrainingPhrase_ () extends ITrainingPhrase {
  ...
  /** TrainingPhrase type. */
  @JSName("type")
  var type_TrainingPhrase_ : Type | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.Type * / any */ String) = js.native
  /**
