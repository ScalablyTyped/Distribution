...
class EntityType_ () extends IEntityType {
  ...
  var autoExpansionMode_EntityType_ : AutoExpansionMode | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.EntityType.AutoExpansionMode * / any */ String) = js.native
  ...
  /** EntityType kind. */
  @JSName("kind")
  var kind_EntityType_ : Kind | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.EntityType.Kind * / any */ String) = js.native
  /** EntityType name. */
  @JSName("name")
