...
object ^ extends js.Object {
  /**
    ...
    */
  def create(): typings.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard = js.native
  def create(properties: IBrowseCarouselCard): typings.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard = js.native
  /**
    ...
    */
  def decode(reader: Reader): typings.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard = js.native
  def decode(reader: Reader, length: Double): typings.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard = js.native
  def decode(reader: Uint8Array): typings.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard = js.native
  def decode(reader: Uint8Array, length: Double): typings.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typings.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard = js.native
  def decodeDelimited(reader: Uint8Array): typings.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard = js.native
  /**
  ...
  /**
    ...
    * @returns BrowseCarouselCard
    */
  def fromObject(`object`: StringDictionary[js.Any]): typings.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard = js.native
  /**
    ...
    */
  def toObject(message: typings.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard): StringDictionary[js.Any] = js.native
  def toObject(
    message: typings.dialogflow.mod.google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard,
