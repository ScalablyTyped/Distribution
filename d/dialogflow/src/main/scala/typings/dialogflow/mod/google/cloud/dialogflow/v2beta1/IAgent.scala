...
object IAgent {
  @scala.inline
  def apply(
    apiVersion: ApiVersion | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.Agent.ApiVersion * / any */ String) = null,
    ...
    matchMode: MatchMode | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.Agent.MatchMode * / any */ String) = null,
    parent: String = null,
    supportedLanguageCodes: js.Array[String] = null,
    tier: Tier | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.Agent.Tier * / any */ String) = null,
