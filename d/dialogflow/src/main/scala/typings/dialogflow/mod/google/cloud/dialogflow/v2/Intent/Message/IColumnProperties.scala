...
object IColumnProperties {
  ...
  def apply(
    ...
    horizontalAlignment: js.UndefOr[
      Null | HorizontalAlignment | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.Intent.Message.ColumnProperties.HorizontalAlignment * / any */ String)
    ] = js.undefined
  ): IColumnProperties = {
