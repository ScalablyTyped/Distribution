...
class MediaContent_ () extends IMediaContent {
  ...
  @JSName("mediaType")
  var mediaType_MediaContent_ : ResponseMediaType | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.Intent.Message.MediaContent.ResponseMediaType * / any */ String) = js.native
  /**
