...
object IOutputAudioConfig {
  @scala.inline
  def apply(
    audioEncoding: OutputAudioEncoding | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.OutputAudioEncoding * / any */ String) = null,
