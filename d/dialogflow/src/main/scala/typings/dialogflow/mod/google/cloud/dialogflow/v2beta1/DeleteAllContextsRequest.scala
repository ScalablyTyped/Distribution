...
@JSImport("dialogflow/protos/protos", "google.cloud.dialogflow.v2beta1.DeleteAllContextsRequest")
@js.native
/**
...
object DeleteAllContextsRequest {
  ...
  inline def decode(reader: Uint8Array): DeleteAllContextsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[DeleteAllContextsRequest]
  inline def decode(reader: Uint8Array, length: Double): DeleteAllContextsRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[DeleteAllContextsRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): DeleteAllContextsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[DeleteAllContextsRequest]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromObject(`object`: StringDictionary[js.Any]): DeleteAllContextsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[DeleteAllContextsRequest]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: DeleteAllContextsRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: DeleteAllContextsRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
