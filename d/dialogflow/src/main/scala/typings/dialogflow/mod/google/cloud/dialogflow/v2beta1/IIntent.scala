...
object IIntent {
  ...
  def apply(
    ...
    webhookState: js.UndefOr[
      Null | WebhookState | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.Intent.WebhookState * / any */ String)
    ] = js.undefined
  ): IIntent = {
