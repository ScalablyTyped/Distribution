...
object ListSessionEntityTypesResponse {
  ...
  inline def decode(reader: Uint8Array): ListSessionEntityTypesResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ListSessionEntityTypesResponse]
  inline def decode(reader: Uint8Array, length: Double): ListSessionEntityTypesResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ListSessionEntityTypesResponse]
  ...
  inline def decodeDelimited(reader: Uint8Array): ListSessionEntityTypesResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ListSessionEntityTypesResponse]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromObject(`object`: StringDictionary[js.Any]): ListSessionEntityTypesResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ListSessionEntityTypesResponse]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: ListSessionEntityTypesResponse): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ListSessionEntityTypesResponse, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
