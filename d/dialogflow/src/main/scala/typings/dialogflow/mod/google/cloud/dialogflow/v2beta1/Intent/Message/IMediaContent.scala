...
object IMediaContent {
  ...
  def apply(
    ...
    mediaType: ResponseMediaType | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.ResponseMediaType * / any */ String) = null
  ): IMediaContent = {
