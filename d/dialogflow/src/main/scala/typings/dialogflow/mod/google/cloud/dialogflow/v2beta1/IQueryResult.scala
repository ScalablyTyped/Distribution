...
object IQueryResult {
  ...
  implicit class IQueryResultMutableBuilder[Self <: IQueryResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKnowledgeAnswers(value: IKnowledgeAnswers): Self = StObject.set(x, "knowledgeAnswers", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setKnowledgeAnswersNull: Self = StObject.set(x, "knowledgeAnswers", null)
