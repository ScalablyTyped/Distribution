...
object IInputAudioConfig {
  ...
  def apply(
    audioEncoding: js.UndefOr[
      Null | AudioEncoding | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.AudioEncoding * / any */ String)
    ] = js.undefined,
    ...
    modelVariant: js.UndefOr[
      Null | SpeechModelVariant | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.SpeechModelVariant * / any */ String)
    ] = js.undefined,
