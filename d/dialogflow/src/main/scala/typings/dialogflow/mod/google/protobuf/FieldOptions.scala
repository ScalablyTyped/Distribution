...
object FieldOptions {
  ...
  object CType extends StObject {
    ...
    /* 1 */ val CORD: typings.dialogflow.mod.google.protobuf.FieldOptions.CType.CORD with Double = js.native
    
    @js.native
    sealed trait STRING extends CType
    /* 0 */ val STRING: typings.dialogflow.mod.google.protobuf.FieldOptions.CType.STRING with Double = js.native
    
    @js.native
    sealed trait STRING_PIECE extends CType
    /* 2 */ val STRING_PIECE: typings.dialogflow.mod.google.protobuf.FieldOptions.CType.STRING_PIECE with Double = js.native
  }
  ...
  object JSType extends StObject {
    ...
    /* 0 */ val JS_NORMAL: typings.dialogflow.mod.google.protobuf.FieldOptions.JSType.JS_NORMAL with Double = js.native
    
    @js.native
    sealed trait JS_NUMBER extends JSType
    /* 2 */ val JS_NUMBER: typings.dialogflow.mod.google.protobuf.FieldOptions.JSType.JS_NUMBER with Double = js.native
    
    @js.native
    sealed trait JS_STRING extends JSType
    /* 1 */ val JS_STRING: typings.dialogflow.mod.google.protobuf.FieldOptions.JSType.JS_STRING with Double = js.native
  }
