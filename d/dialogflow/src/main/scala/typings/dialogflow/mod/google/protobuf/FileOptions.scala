...
object FileOptions {
  ...
  object OptimizeMode extends StObject {
    ...
    /* 2 */ val CODE_SIZE: typings.dialogflow.mod.google.protobuf.FileOptions.OptimizeMode.CODE_SIZE with Double = js.native
    
    @js.native
    sealed trait LITE_RUNTIME extends OptimizeMode
    /* 3 */ val LITE_RUNTIME: typings.dialogflow.mod.google.protobuf.FileOptions.OptimizeMode.LITE_RUNTIME with Double = js.native
    
    @js.native
    sealed trait SPEED extends OptimizeMode
    /* 1 */ val SPEED: typings.dialogflow.mod.google.protobuf.FileOptions.OptimizeMode.SPEED with Double = js.native
  }
