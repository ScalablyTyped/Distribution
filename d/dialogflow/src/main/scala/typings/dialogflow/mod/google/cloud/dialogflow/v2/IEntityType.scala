...
object IEntityType {
  @scala.inline
  def apply(
    autoExpansionMode: AutoExpansionMode | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.EntityType.AutoExpansionMode * / any */ String) = null,
    displayName: String = null,
    enableFuzzyExtraction: js.UndefOr[Boolean] = js.undefined,
    entities: js.Array[IEntity] = null,
    kind: Kind | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.EntityType.Kind * / any */ String) = null,
    name: String = null
  ): IEntityType = {
