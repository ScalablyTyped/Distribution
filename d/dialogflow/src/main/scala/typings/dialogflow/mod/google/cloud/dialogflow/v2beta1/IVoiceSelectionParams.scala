...
object IVoiceSelectionParams {
  ...
  def apply(
    name: String = null,
    ssmlGender: SsmlVoiceGender | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2beta1.SsmlVoiceGender * / any */ String) = null
