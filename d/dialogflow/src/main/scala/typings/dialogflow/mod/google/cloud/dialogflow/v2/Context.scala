...
object Context {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): Context = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[Context]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): Context = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[Context]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): Context = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[Context]
  /**
  ...
  /**
    ...
    */
  /* static member */
  inline def fromObject(`object`: StringDictionary[Any]): Context = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[Context]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: Context): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: Context, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
