...
object IOpenUrlAction {
  ...
  def apply(
    url: String = null,
    urlTypeHint: UrlTypeHint | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.OpenUrlAction.UrlTypeHint * / any */ String) = null
  ): IOpenUrlAction = {
