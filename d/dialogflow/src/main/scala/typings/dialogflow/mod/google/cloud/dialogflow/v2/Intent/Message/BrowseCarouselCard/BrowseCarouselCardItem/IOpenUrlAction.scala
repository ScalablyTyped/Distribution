...
object IOpenUrlAction {
  ...
  def apply(
    ...
    urlTypeHint: js.UndefOr[
      Null | UrlTypeHint | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.OpenUrlAction.UrlTypeHint * / any */ String)
    ] = js.undefined
  ): IOpenUrlAction = {
