...
object IBrowseCarouselCard {
  ...
  def apply(
    imageDisplayOptions: js.UndefOr[
      Null | ImageDisplayOptions | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.dialogflow.v2.Intent.Message.BrowseCarouselCard.ImageDisplayOptions * / any */ String)
    ] = js.undefined,
