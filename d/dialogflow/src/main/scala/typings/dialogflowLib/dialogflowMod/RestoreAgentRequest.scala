...
trait RestoreAgentRequest extends js.Object {
...
object RestoreAgentRequest {
  @scala.inline
  def apply(parent: java.lang.String, agentContent: java.lang.String = null, agentUri: java.lang.String = null): RestoreAgentRequest = {
    ...
    __obj.asInstanceOf[RestoreAgentRequest]
  }
}
