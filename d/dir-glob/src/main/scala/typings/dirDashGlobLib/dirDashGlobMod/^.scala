...
object ^ extends js.Object {
  ...
  def apply(input: java.lang.String | js.Array[java.lang.String], options: Options): js.Promise[js.Array[java.lang.String]] = js.native
  def sync(input: java.lang.String): js.Array[java.lang.String] = js.native
  def sync(input: java.lang.String, options: Options): js.Array[java.lang.String] = js.native
  def sync(input: js.Array[java.lang.String]): js.Array[java.lang.String] = js.native
  def sync(input: js.Array[java.lang.String], options: Options): js.Array[java.lang.String] = js.native
}
