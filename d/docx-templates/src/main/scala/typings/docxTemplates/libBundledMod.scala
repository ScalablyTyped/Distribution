...
object libBundledMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.docxTemplates.libBundledMod.TextNode
    - typings.docxTemplates.libBundledMod.NonTextNode
  */
  trait Node extends StObject
  object Node {
    
    inline def NonTextNode(_attrs: Dictkey, _children: js.Array[Node], _tag: String): typings.docxTemplates.libBundledMod.NonTextNode = {
      ...
      __obj.asInstanceOf[typings.docxTemplates.libBundledMod.NonTextNode]
    }
    
    inline def TextNode(_children: js.Array[Node], _text: String): typings.docxTemplates.libBundledMod.TextNode = {
      val __obj = js.Dynamic.literal(_children = _children.asInstanceOf[js.Any], _fTextNode = true, _text = _text.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.docxTemplates.libBundledMod.TextNode]
    }
  }
