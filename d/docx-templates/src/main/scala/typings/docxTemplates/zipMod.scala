...
object zipMod {
  ...
  inline def zipLoad(inputFile: ArrayBuffer): js.Promise[JSZip] = ^.asInstanceOf[js.Dynamic].applyDynamic("zipLoad")(inputFile.asInstanceOf[js.Any]).asInstanceOf[js.Promise[JSZip]]
  
  inline def zipSave(zip: JSZip): js.Promise[Uint8Array] = ^.asInstanceOf[js.Dynamic].applyDynamic("zipSave")(zip.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Uint8Array]]
  ...
  inline def zipSetBinary(zip: JSZip, filename: String, data: ArrayBuffer): JSZip = (^.asInstanceOf[js.Dynamic].applyDynamic("zipSetBinary")(zip.asInstanceOf[js.Any], filename.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[JSZip]
