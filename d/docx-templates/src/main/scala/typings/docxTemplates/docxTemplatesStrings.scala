...
object docxTemplatesStrings {
  ...
  sealed trait Dotgif
    extends StObject
       with ImageExtension
  inline def Dotgif: Dotgif = ".gif".asInstanceOf[Dotgif]
  
  @js.native
  sealed trait Dotjpeg
    extends StObject
       with ImageExtension
  inline def Dotjpeg: Dotjpeg = ".jpeg".asInstanceOf[Dotjpeg]
  ...
  sealed trait Dotsvg
    extends StObject
       with ImageExtension
  inline def Dotsvg: Dotsvg = ".svg".asInstanceOf[Dotsvg]
  ...
  @js.native
  sealed trait JS extends StObject
  inline def JS: JS = "JS".asInstanceOf[JS]
