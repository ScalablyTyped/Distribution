...
package object deepDashDiffMod {
  type Filter[LHS, RHS] = js.Function3[/* target */ LHS, /* source */ RHS, /* change */ Diff[LHS, RHS], Boolean]
  type Observer[LHS, RHS] = js.Function1[/* diff */ Diff[LHS, RHS], Unit]
