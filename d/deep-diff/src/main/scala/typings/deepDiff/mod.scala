...
object mod {
  ...
  inline def diff[LHS, RHS](lhs: LHS, rhs: RHS): js.UndefOr[js.Array[Diff_[LHS, RHS]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("diff")(lhs.asInstanceOf[js.Any], rhs.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[js.Array[Diff_[LHS, RHS]]]]
  ...
  inline def diff[LHS, RHS](lhs: LHS, rhs: RHS, prefilter: PreFilter[LHS, RHS]): js.UndefOr[js.Array[Diff_[LHS, RHS]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("diff")(lhs.asInstanceOf[js.Any], rhs.asInstanceOf[js.Any], prefilter.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[js.Array[Diff_[LHS, RHS]]]]
  ...
  inline def diff_LHSRHS_Accumulator[LHS, RHS](lhs: LHS, rhs: RHS): Accumulator[LHS, RHS] = (^.asInstanceOf[js.Dynamic].applyDynamic("diff")(lhs.asInstanceOf[js.Any], rhs.asInstanceOf[js.Any])).asInstanceOf[Accumulator[LHS, RHS]]
  inline def diff_LHSRHS_Accumulator[LHS, RHS](lhs: LHS, rhs: RHS, prefilter: PreFilter[LHS, RHS]): Accumulator[LHS, RHS] = (^.asInstanceOf[js.Dynamic].applyDynamic("diff")(lhs.asInstanceOf[js.Any], rhs.asInstanceOf[js.Any], prefilter.asInstanceOf[js.Any])).asInstanceOf[Accumulator[LHS, RHS]]
  ...
  inline def orderIndependentDiff[LHS, RHS](lhs: LHS, rhs: RHS): js.UndefOr[js.Array[Diff_[LHS, RHS]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("orderIndependentDiff")(lhs.asInstanceOf[js.Any], rhs.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[js.Array[Diff_[LHS, RHS]]]]
  ...
  inline def orderIndependentDiff[LHS, RHS](lhs: LHS, rhs: RHS, prefilter: PreFilter[LHS, RHS]): js.UndefOr[js.Array[Diff_[LHS, RHS]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("orderIndependentDiff")(lhs.asInstanceOf[js.Any], rhs.asInstanceOf[js.Any], prefilter.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[js.Array[Diff_[LHS, RHS]]]]
  ...
  inline def orderIndependentDiff_LHSRHS_Accumulator[LHS, RHS](lhs: LHS, rhs: RHS): Accumulator[LHS, RHS] = (^.asInstanceOf[js.Dynamic].applyDynamic("orderIndependentDiff")(lhs.asInstanceOf[js.Any], rhs.asInstanceOf[js.Any])).asInstanceOf[Accumulator[LHS, RHS]]
  inline def orderIndependentDiff_LHSRHS_Accumulator[LHS, RHS](lhs: LHS, rhs: RHS, prefilter: PreFilter[LHS, RHS]): Accumulator[LHS, RHS] = (^.asInstanceOf[js.Dynamic].applyDynamic("orderIndependentDiff")(lhs.asInstanceOf[js.Any], rhs.asInstanceOf[js.Any], prefilter.asInstanceOf[js.Any])).asInstanceOf[Accumulator[LHS, RHS]]
