...
object ^ extends js.Object {
  ...
  @JSName("diff")
  def `diff_LHSRHS<union>`[LHS, RHS](lhs: LHS, rhs: RHS): js.UndefOr[js.Array[Diff[LHS, RHS]]] = js.native
  @JSName("diff")
  def `diff_LHSRHS<union>`[LHS, RHS](lhs: LHS, rhs: RHS, prefilter: PreFilter[LHS, RHS]): js.UndefOr[js.Array[Diff[LHS, RHS]]] = js.native
  ...
  def `orderIndependentDiff_LHSRHS<union>`[LHS, RHS](lhs: LHS, rhs: RHS): js.UndefOr[js.Array[Diff[LHS, RHS]]] = js.native
  @JSName("orderIndependentDiff")
  def `orderIndependentDiff_LHSRHS<union>`[LHS, RHS](lhs: LHS, rhs: RHS, prefilter: PreFilter[LHS, RHS]): js.UndefOr[js.Array[Diff[LHS, RHS]]] = js.native
