...
trait ScaleLogarithmic[Range, Output] extends ScaleContinuousNumeric[Range, Output] {
  /**
       ...
       */
  def base(): scala.Double = js.native
  /**
       * Sets the base for this logarithmic scale to the specified value.
       */
  def base(base: scala.Double): this.type = js.native
  /**
  ...
  /**
       ...
       */
  @JSName("interpolate")
  def interpolate_NewOutputScaleLogarithmic[NewOutput](interpolate: InterpolatorFactory[Range, NewOutput]): ScaleLogarithmic[Range, NewOutput] = js.native
}
