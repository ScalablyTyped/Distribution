...
trait ScaleQuantile[Range] extends js.Object {
  ...
  /**
       ...
       */
  def domain(domain: js.Array[js.UndefOr[scala.Double | d3DashScaleLib.Anon_ValueOf | scala.Null]]): this.type = js.native
  /**
  ...
  /**
       ...
       */
  def quantiles(): js.Array[scala.Double] = js.native
  /**
