...
trait ScaleTime[Range, Output] extends js.Object {
  ...
  /**
       ...
       * @param value A temporal value from the domain. If the value is not a Date, it will be coerced to Date.
       */
  def apply(value: stdLib.Date): Output = js.native
  /**
  ...
  /**
       ...
       */
  def domain(): js.Array[stdLib.Date] = js.native
  /**
       ...
       */
  def domain(domain: js.Array[stdLib.Date | scala.Double | d3DashScaleLib.Anon_ValueOf]): this.type = js.native
  /**
  ...
  /**
       ...
       */
  @JSName("interpolate")
  def interpolate_NewOutputScaleTime[NewOutput](interpolate: InterpolatorFactory[Range, NewOutput]): ScaleTime[Range, NewOutput] = js.native
  /**
       ...
       */
  def invert(value: d3DashScaleLib.Anon_ValueOf): stdLib.Date = js.native
  /**
       * Given a value from the range, returns the corresponding value from the domain. Inversion is useful for interaction,
       * say to determine the data value corresponding to the position of the mouse.
       *
       ...
       * @param value A numeric value from the range.
       */
  def invert(value: scala.Double): stdLib.Date = js.native
  /**
  ...
  /**
       ...
       */
  def nice(interval: d3DashTimeLib.d3DashTimeMod.CountableTimeInterval): this.type = js.native
  /**
       * Extends the domain so that it starts and ends on nice round values.
       * This method typically modifies the scale’s domain, and may only extend the bounds to the nearest round value.
       *
       ...
       * @param step An optional step number to be applied to the time interval when considering ticks.
       */
  def nice(interval: d3DashTimeLib.d3DashTimeMod.CountableTimeInterval, step: scala.Double): this.type = js.native
  /**
  ...
  /**
       ...
       * @param range Array of range values.
       */
  def rangeRound(range: js.Array[scala.Double | d3DashScaleLib.Anon_ValueOf]): this.type = js.native
  /**
       ...
       */
  def tickFormat(): js.Function1[/* d */ stdLib.Date, java.lang.String] = js.native
  /**
       * Returns a time format function suitable for displaying tick values.
       *
       ...
       */
  def tickFormat(count: scala.Double): js.Function1[/* d */ stdLib.Date, java.lang.String] = js.native
  /**
       * Returns a time format function suitable for displaying tick values.
       *
       * The specified count is currently ignored, but is accepted for consistency with other scales such as continuous.tickFormat.
       ...
       * @param specifier An optional valid date format specifier string (see d3-time-format).
       */
  def tickFormat(count: scala.Double, specifier: java.lang.String): js.Function1[/* d */ stdLib.Date, java.lang.String] = js.native
  /**
       * Returns a time format function suitable for displaying tick values.
       *
       ...
       * @param specifier An optional valid date format specifier string (see d3-time-format).
       */
  def tickFormat(interval: d3DashTimeLib.d3DashTimeMod.TimeInterval): js.Function1[/* d */ stdLib.Date, java.lang.String] = js.native
  /**
       * Returns a time format function suitable for displaying tick values.
       *
       * The specified time interval is currently ignored, but is accepted for consistency with other scales such as continuous.tickFormat.
       ...
       * @param specifier An optional valid date format specifier string (see d3-time-format).
       */
  def tickFormat(interval: d3DashTimeLib.d3DashTimeMod.TimeInterval, specifier: java.lang.String): js.Function1[/* d */ stdLib.Date, java.lang.String] = js.native
  /**
       ...
       */
  def ticks(): js.Array[stdLib.Date] = js.native
  /**
       * Returns representative dates from the scale’s domain. The returned tick values are uniformly-spaced (mostly),
       * have sensible values (such as every day at midnight), and are guaranteed to be within the extent of the domain.
       * Ticks are often used to display reference lines, or tick marks, in conjunction with the visualized data.
       ...
       * @param count Expected number of ticks.
       */
  def ticks(count: scala.Double): js.Array[stdLib.Date] = js.native
  /**
       * Returns representative dates from the scale’s domain. The returned tick values are uniformly-spaced (mostly),
       * have sensible values (such as every day at midnight), and are guaranteed to be within the extent of the domain.
       * Ticks are often used to display reference lines, or tick marks, in conjunction with the visualized data.
       ...
       * @param interval A time interval to specify the expected ticks.
       */
  def ticks(interval: d3DashTimeLib.d3DashTimeMod.TimeInterval): js.Array[stdLib.Date] = js.native
}
