...
@js.native
trait HistogramGeneratorDate[Datum, Value /* <: js.UndefOr[stdLib.Date] */]
  extends HistogramCommon[Datum, stdLib.Date] {
  def domain(): js.Function1[/* values */ stdLib.ArrayLike[Value], js.Tuple2[stdLib.Date, stdLib.Date]] = js.native
  def domain(
    domainAccessor: js.Function1[/* values */ stdLib.ArrayLike[Value], js.Tuple2[stdLib.Date, stdLib.Date]]
  ): this.type = js.native
  def domain(domain: js.Tuple2[stdLib.Date, stdLib.Date]): this.type = js.native
