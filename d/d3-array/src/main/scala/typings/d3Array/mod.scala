...
object mod {
  ...
  inline def difference[T](iterable: js.Iterable[T], others: js.Iterable[T]*): InternSet[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("difference")(List(iterable.asInstanceOf[js.Any]).`++`(others.asInstanceOf[Seq[js.Any]])*).asInstanceOf[InternSet[T]]
