package typings
package dsvLib.dsvMod.underscoreDsvNs
...
trait Dsv extends js.Object {
  ...
  def format(rows: js.Array[_]): java.lang.String = js.native
  ...
  def formatRows(rows: js.Array[_]): java.lang.String = js.native
  ...
  [  {"Year": "1997", "Make": "Ford", "Model": "E350", "Length": "2.34"},
    {"Year": "2000", "Make": "Mercury", "Model": "Cougar", "Length": "2.38"} ]
  		 */
  def parse[TRow](table: java.lang.String): js.Array[TRow] = js.native
  def parse[TRow](
  ...
  def parseRows[TRow](table: java.lang.String): js.Array[TRow] = js.native
  def parseRows[TRow](
    table: java.lang.String,
    /** coerce cells (strings) into different types or modify them. return null to strip this row from the output results.*/
  accessor: js.Function1[/* row */ js.Array[java.lang.String], TRow]
  ): js.Array[TRow] = js.native
}
