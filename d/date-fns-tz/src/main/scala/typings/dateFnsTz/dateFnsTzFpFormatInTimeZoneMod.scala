...
object dateFnsTzFpFormatInTimeZoneMod extends Shortcut {
  
  @JSImport("date-fns-tz/fp/formatInTimeZone", JSImport.Namespace)
  @js.native
  ...
  /* This means you don't have to write `^`, but can instead just say `dateFnsTzFpFormatInTimeZoneMod.foo` */
