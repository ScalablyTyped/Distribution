...
object dateFnsTzFpFormatInTimeZoneIndexMod extends Shortcut {
  
  @JSImport("date-fns-tz/fp/formatInTimeZone/index", JSImport.Namespace)
  @js.native
  ...
  /* This means you don't have to write `^`, but can instead just say `dateFnsTzFpFormatInTimeZoneIndexMod.foo` */
