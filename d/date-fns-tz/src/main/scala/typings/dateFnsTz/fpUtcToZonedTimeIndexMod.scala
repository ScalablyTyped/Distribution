...
object fpUtcToZonedTimeIndexMod extends Shortcut {
  
  @JSImport("date-fns-tz/fp/utcToZonedTime/index", JSImport.Namespace)
  @js.native
  val ^ : CurriedFn2[String, js.Date | String | Double, js.Date] = js.native
  
  type _To = CurriedFn2[String, js.Date | String | Double, js.Date]
  
  /* This means you don't have to write `^`, but can instead just say `fpUtcToZonedTimeIndexMod.foo` */
