...
object ASPxClientCardViewBatchEditCardValidatingEventArgs {
  ...
  inline def apply(validationInfo: Any, visibleIndex: Double): ASPxClientCardViewBatchEditCardValidatingEventArgs = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ASPxClientCardViewBatchEditCardValidatingEventArgs] (val x: Self) extends AnyVal {
