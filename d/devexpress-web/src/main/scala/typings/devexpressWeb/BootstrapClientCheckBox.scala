...
object BootstrapClientCheckBox {
  ...
  @scala.inline
  implicit class BootstrapClientCheckBoxOps[Self <: BootstrapClientCheckBox] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setCheckedChanged(value: ASPxClientEvent[ASPxClientProcessingModeEventHandler[BootstrapClientCheckBox]]): Self = this.set("CheckedChanged", value.asInstanceOf[js.Any])
    @scala.inline
