...
object ASPxClientVerticalGridBatchEditChangesSavingEventArgs {
  ...
  inline def apply(cancel: Boolean, deletedValues: js.Any, insertedValues: js.Any, updatedValues: js.Any): ASPxClientVerticalGridBatchEditChangesSavingEventArgs = {
  ...
  extension [Self <: ASPxClientVerticalGridBatchEditChangesSavingEventArgs](x: Self) {
