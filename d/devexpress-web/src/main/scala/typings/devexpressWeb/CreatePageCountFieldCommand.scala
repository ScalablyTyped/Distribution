...
object CreatePageCountFieldCommand {
  ...
  inline def apply(execute: () => Boolean, getState: () => SimpleCommandState): CreatePageCountFieldCommand = {
    val __obj = js.Dynamic.literal(execute = js.Any.fromFunction0(execute), getState = js.Any.fromFunction0(getState))
    __obj.asInstanceOf[CreatePageCountFieldCommand]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreatePageCountFieldCommand] (val x: Self) extends AnyVal {
