...
object GoToLastDataRecordCommand {
  ...
  inline def apply(execute: () => Boolean, getState: () => SimpleCommandState): GoToLastDataRecordCommand = {
    val __obj = js.Dynamic.literal(execute = js.Any.fromFunction0(execute), getState = js.Any.fromFunction0(getState))
    __obj.asInstanceOf[GoToLastDataRecordCommand]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GoToLastDataRecordCommand] (val x: Self) extends AnyVal {
