...
object ASPxClientCardViewBatchEditChangesSavingEventArgs {
  ...
  @scala.inline
  implicit class ASPxClientCardViewBatchEditChangesSavingEventArgsMutableBuilder[Self <: ASPxClientCardViewBatchEditChangesSavingEventArgs] (val x: Self) extends AnyVal {
