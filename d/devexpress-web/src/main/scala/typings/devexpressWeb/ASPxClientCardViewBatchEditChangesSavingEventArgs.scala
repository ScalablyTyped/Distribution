...
object ASPxClientCardViewBatchEditChangesSavingEventArgs {
  ...
  inline def apply(cancel: Boolean, deletedValues: js.Any, insertedValues: js.Any, updatedValues: js.Any): ASPxClientCardViewBatchEditChangesSavingEventArgs = {
  ...
  extension [Self <: ASPxClientCardViewBatchEditChangesSavingEventArgs](x: Self) {
