...
@js.native
class ASPxClientFileManagerCommandConsts () extends js.Object

/* static members */
@JSGlobal("ASPxClientFileManagerCommandConsts")
@js.native
object ASPxClientFileManagerCommandConsts extends js.Object {
  /**
    * The name of a command that is executed when an end-user copies an item.
    */
  val Copy: String = js.native
  /**
