...
object ASPxClientVerticalGridBatchEditChangesCancelingEventArgs {
  ...
  inline def apply(cancel: Boolean, deletedValues: js.Any, insertedValues: js.Any, updatedValues: js.Any): ASPxClientVerticalGridBatchEditChangesCancelingEventArgs = {
  ...
  extension [Self <: ASPxClientVerticalGridBatchEditChangesCancelingEventArgs](x: Self) {
