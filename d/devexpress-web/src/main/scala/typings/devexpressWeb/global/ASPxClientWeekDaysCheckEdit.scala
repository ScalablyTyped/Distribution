...
class ASPxClientWeekDaysCheckEdit ()
  extends typings.devexpressWeb.ASPxClientWeekDaysCheckEdit {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetValue(): typings.devexpressWeb.ASPxClientWeekDays = js.native
  /**
    * Returns a value specifying whether a control is displayed.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetValue(value: typings.devexpressWeb.ASPxClientWeekDays): Unit = js.native
  /**
    * Specifies whether a control is displayed.
