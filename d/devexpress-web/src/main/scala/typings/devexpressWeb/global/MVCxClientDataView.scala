...
@js.native
open class MVCxClientDataView ()
  extends StObject
     with typings.devexpressWeb.MVCxClientDataView {
...
object MVCxClientDataView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.MVCxClientDataView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientDataView]
}
