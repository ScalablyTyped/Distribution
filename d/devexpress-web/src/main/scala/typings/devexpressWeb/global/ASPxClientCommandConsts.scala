...
/**
  ...
  */
@JSGlobal("ASPxClientCommandConsts")
@js.native
class ASPxClientCommandConsts ()
  extends typings.devexpressWeb.ASPxClientCommandConsts

/* static members */
@JSGlobal("ASPxClientCommandConsts")
@js.native
object ASPxClientCommandConsts extends js.Object {
  /**
  ...
  /**
    ...
    */
  var PASTEHTMLMERGEFORMATTING_COMMAND: String = js.native
  /**
    ...
    */
  var PASTEHTMLPLAINTEXT_COMMAND: String = js.native
  /**
  ...
  /**
    ...
    */
  var SUPERSCRIPT_COMMAND: String = js.native
  /**
    * Identifies a command that invokes the Cell Properties dialog.
    */
  var TABLECELLPROPERTIES_DIALOG_COMMAND: String = js.native
  /**
    * Identifies a command that invokes the Column Properties dialog.
    */
  var TABLECOLUMNPROPERTIES_DIALOG_COMMAND: String = js.native
  /**
    * Identifies a command that invokes the Table Properties dialog.
    */
  var TABLEPROPERTIES_DIALOG_COMMAND: String = js.native
  /**
    * Identifies a command that invokes the Row Properties dialog.
    */
  var TABLEROWPROPERTIES_DIALOG_COMMAND: String = js.native
  /**
