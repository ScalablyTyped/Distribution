...
@js.native
class ASPxClientBinaryImage ()
  extends StObject
     with typings.devexpressWeb.ASPxClientBinaryImage {
...
object ASPxClientBinaryImage {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientBinaryImage = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientBinaryImage]
}
