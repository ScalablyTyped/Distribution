...
class MVCxClientListBox ()
  extends StObject
     with typings.devexpressWeb.MVCxClientListBox {
...
object MVCxClientListBox {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientListBox = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientListBox]
}
