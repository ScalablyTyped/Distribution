...
@js.native
open class ASPxClientQueryBuilder ()
  extends StObject
     with typings.devexpressWeb.ASPxClientQueryBuilder {
...
object ASPxClientQueryBuilder {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientQueryBuilder = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientQueryBuilder]
}
