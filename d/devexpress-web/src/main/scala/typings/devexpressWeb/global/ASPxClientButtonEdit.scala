...
@js.native
open class ASPxClientButtonEdit ()
  extends StObject
...
object ASPxClientButtonEdit {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientButtonEdit = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientButtonEdit]
}
