...
@js.native
class ASPxClientImageSlider ()
  extends StObject
     with typings.devexpressWeb.ASPxClientImageSlider {
...
object ASPxClientImageSlider {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientImageSlider = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientImageSlider]
}
