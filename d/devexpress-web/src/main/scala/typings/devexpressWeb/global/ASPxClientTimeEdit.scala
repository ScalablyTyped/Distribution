...
@js.native
class ASPxClientTimeEdit ()
  extends typings.devexpressWeb.ASPxClientTimeEdit {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var DateChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientTimeEdit]] = js.native
  /**
  ...
  /* CompleteClass */
  @JSName("TextChanged")
  override var TextChanged_ASPxClientSpinEditBase: typings.devexpressWeb.ASPxClientEvent[
...
object ASPxClientTimeEdit extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientTimeEdit = js.native
}
