...
@js.native
class ASPxClientRecurrenceTypeEdit ()
  extends typings.devexpressWeb.ASPxClientRecurrenceTypeEdit {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetRecurrenceType(recurrenceType: typings.devexpressWeb.ASPxClientRecurrenceType): Unit = js.native
  /**
