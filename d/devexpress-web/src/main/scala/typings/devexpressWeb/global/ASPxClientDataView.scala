...
@js.native
open class ASPxClientDataView ()
  extends StObject
     with typings.devexpressWeb.ASPxClientDataView {
...
object ASPxClientDataView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientDataView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientDataView]
}
