...
class ASPxClientCheckBoxList ()
  extends typings.devexpressWeb.ASPxClientCheckBoxList {
  /**
  ...
  override var SelectedIndexChanged_ASPxClientCheckBoxList: typings.devexpressWeb.ASPxClientEvent[
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetSelectedValues(): js.Array[_] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SelectValues(values: js.Array[_]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def UnselectValues(values: js.Array[_]): Unit = js.native
  /**
...
object ASPxClientCheckBoxList extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientCheckBoxList = js.native
}
