...
@js.native
open class MVCxClientCardView ()
  extends StObject
     with typings.devexpressWeb.MVCxClientCardView {
...
object MVCxClientCardView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.MVCxClientCardView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientCardView]
}
