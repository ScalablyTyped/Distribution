...
class ASPxClientWebChartHitInfo ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var annotation: typings.devexpressWeb.ASPxClientAnnotation = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var axisLabelItem: typings.devexpressWeb.ASPxClientAxisLabelItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var chartTitle: typings.devexpressWeb.ASPxClientChartTitle = js.native
  
  /**
    * Gets the client-side constant line instance from under the test point.
    */
  /* CompleteClass */
  var constantLine: typings.devexpressWeb.ASPxClientConstantLine = js.native
  
  /**
    * Gets a custom legend item which is located under the test point.
    */
  /* CompleteClass */
  var customLegendItem: typings.devexpressWeb.ASPxClientCustomLegendItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var fibonacciIndicator: typings.devexpressWeb.ASPxClientFibonacciIndicator = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var nonDefaultPane: typings.devexpressWeb.ASPxClientXYDiagramPane = js.native
  
  /**
    * Gets the client-side pane title instance from under the test point.
    */
  /* CompleteClass */
  var paneTitle: typings.devexpressWeb.ASPxClientPaneTitle = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var regressionLine: typings.devexpressWeb.ASPxClientRegressionLine = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var seriesLabel: typings.devexpressWeb.ASPxClientSeriesLabel = js.native
  
  /**
    * Gets the client-side series point instance from under the test point.
    */
  /* CompleteClass */
  var seriesPoint: typings.devexpressWeb.ASPxClientSeriesPoint = js.native
  
  /**
    * Gets the client-side series title instance from under the test point.
    */
  /* CompleteClass */
  var seriesTitle: typings.devexpressWeb.ASPxClientSeriesTitle = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var trendLine: typings.devexpressWeb.ASPxClientTrendLine = js.native
}
