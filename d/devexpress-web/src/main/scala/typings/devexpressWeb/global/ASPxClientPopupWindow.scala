...
@js.native
class ASPxClientPopupWindow ()
  extends typings.devexpressWeb.ASPxClientPopupWindow {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var popupControl: typings.devexpressWeb.ASPxClientPopupControl = js.native
  /**
