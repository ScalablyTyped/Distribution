...
@js.native
class ASPxClientCaptcha ()
  extends StObject
     with typings.devexpressWeb.ASPxClientCaptcha {
...
object ASPxClientCaptcha {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientCaptcha = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientCaptcha]
}
