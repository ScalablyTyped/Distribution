...
@js.native
class ASPxClientRadioButtonList ()
  extends StObject
...
object ASPxClientRadioButtonList {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientRadioButtonList = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientRadioButtonList]
}
