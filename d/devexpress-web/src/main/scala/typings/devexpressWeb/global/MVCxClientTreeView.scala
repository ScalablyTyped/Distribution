...
class MVCxClientTreeView ()
  extends typings.devexpressWeb.MVCxClientTreeView {
  /**
    * Occurs when a callback for server-side processing is initiated.
    */
  /* CompleteClass */
  override var BeginCallback: typings.devexpressWeb.ASPxClientEvent[ASPxClientBeginCallbackEventHandler[typings.devexpressWeb.ASPxClientTreeView]] = js.native
  /**
    * Occurs when a callback for server-side processing is initiated.
    */
  /* CompleteClass */
  @JSName("BeginCallback")
  override var BeginCallback_MVCxClientTreeView: typings.devexpressWeb.ASPxClientEvent[MVCxClientBeginCallbackEventHandler[typings.devexpressWeb.MVCxClientTreeView]] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var CallbackError: typings.devexpressWeb.ASPxClientEvent[ASPxClientCallbackErrorEventHandler[typings.devexpressWeb.ASPxClientTreeView]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var EndCallback: typings.devexpressWeb.ASPxClientEvent[ASPxClientEndCallbackEventHandler[typings.devexpressWeb.ASPxClientTreeView]] = js.native
  /**
    * Fires on the client side after a node's expansion state has been changed by end-user interaction.
    */
  /* CompleteClass */
  override var ExpandedChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientTreeViewNodeEventHandler[typings.devexpressWeb.ASPxClientTreeView]] = js.native
  /**
    * Fires on the client side before the expansion state of a node is changed via end-user interaction.
    */
  /* CompleteClass */
  override var ExpandedChanging: typings.devexpressWeb.ASPxClientEvent[
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var NodeClick: typings.devexpressWeb.ASPxClientEvent[
...
object MVCxClientTreeView extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientTreeView = js.native
}
