...
class ASPxClientDockZone ()
  extends StObject
     with typings.devexpressWeb.ASPxClientDockZone {
...
object ASPxClientDockZone {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientDockZone = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientDockZone]
}
