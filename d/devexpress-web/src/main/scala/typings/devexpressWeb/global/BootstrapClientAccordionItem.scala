...
open class BootstrapClientAccordionItem ()
  extends StObject
     with typings.devexpressWeb.BootstrapClientAccordionItem {
  ...
  /* CompleteClass */
  @JSName("group")
  var group_BootstrapClientAccordionItem: typings.devexpressWeb.BootstrapClientAccordionGroup = js.native
  ...
  /* CompleteClass */
  @JSName("navBar")
  var navBar_BootstrapClientAccordionItem: typings.devexpressWeb.BootstrapClientAccordion = js.native
}
