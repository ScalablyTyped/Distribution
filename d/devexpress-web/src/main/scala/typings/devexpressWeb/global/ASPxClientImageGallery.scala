...
class ASPxClientImageGallery ()
  extends StObject
     with typings.devexpressWeb.ASPxClientImageGallery {
...
object ASPxClientImageGallery {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientImageGallery = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientImageGallery]
}
