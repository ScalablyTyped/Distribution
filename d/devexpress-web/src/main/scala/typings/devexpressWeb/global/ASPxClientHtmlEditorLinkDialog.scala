...
@js.native
open class ASPxClientHtmlEditorLinkDialog ()
  extends StObject
     with typings.devexpressWeb.ASPxClientHtmlEditorLinkDialog {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetEmailTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  
  /**
    * Provides access to the client object of the file manager used in the Link dialog's "Select Document" popup window.
    */
  /* CompleteClass */
  override def GetFileManager(): typings.devexpressWeb.ASPxClientFileManager = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetLinkTypeRadioButtonList(): typings.devexpressWeb.ASPxClientRadioButtonList = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetOpenInNewWindowCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  
  /**
    * Provides access to the client object of the "Cancel" button in the Link dialog's "Select Document" popup window.
    */
  /* CompleteClass */
  override def GetSelectDocumentPopupCancelButton(): typings.devexpressWeb.ASPxClientButton = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetSelectDocumentPopupControl(): typings.devexpressWeb.ASPxClientPopupControl = js.native
  
  /**
    * Provides access to the client object of the "Select" button in the Link dialog's "Select Document" popup window.
    */
  /* CompleteClass */
  override def GetSelectDocumentPopupSelectButton(): typings.devexpressWeb.ASPxClientButton = js.native
  
  /**
    * Provides access to the client object of the "Subject" text box in the Html Editor's Link dialog.
    */
  /* CompleteClass */
  override def GetSubjectTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  
  /**
    * Provides access to the client object of the "Text" text box in the Html Editor's Link dialog.
    */
  /* CompleteClass */
  override def GetTextTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  
  /**
    * Provides access to the client object of the "ToolTip" text box in the Html Editor's Link dialog.
    */
  /* CompleteClass */
  override def GetTooltipTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  
  /**
    * Provides access to the client object of the "URL" text box in the Html Editor's Link dialog.
    */
  /* CompleteClass */
  override def GetUrlTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
}
