...
@js.native
open class MVCxClientRichEdit ()
  extends StObject
     with typings.devexpressWeb.MVCxClientRichEdit {
...
object MVCxClientRichEdit {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.MVCxClientRichEdit = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientRichEdit]
}
