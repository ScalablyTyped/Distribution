...
@js.native
open class ASPxClientGaugeControl ()
  extends StObject
     with typings.devexpressWeb.ASPxClientGaugeControl {
...
object ASPxClientGaugeControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientGaugeControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientGaugeControl]
}
