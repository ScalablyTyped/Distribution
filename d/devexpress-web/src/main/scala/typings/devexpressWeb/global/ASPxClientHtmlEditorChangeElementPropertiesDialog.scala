...
@js.native
open class ASPxClientHtmlEditorChangeElementPropertiesDialog ()
  extends StObject
     with typings.devexpressWeb.ASPxClientHtmlEditorChangeElementPropertiesDialog {
  
  /**
    * Provides access to the client object of the "Accept" text box in the Html Editor's "Change Element Properties" dialog.
    */
  /* CompleteClass */
  override def GetAcceptTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  
  /**
    * Provides access to the client object of the "Action" text box in the Html Editor's "Change Element Properties" dialog.
    */
  /* CompleteClass */
  override def GetActionTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  
  /**
    * Provides access to the client object of the "Alt" text box in the Html Editor's "Change Element Properties" dialog.
    */
  /* CompleteClass */
  override def GetAltTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetCheckedCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetDirectionComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  
  /**
    * Provides access to the client object of the "Disabled" check box in the Html Editor's "Change Element Properties" dialog.
    */
  /* CompleteClass */
  override def GetDisabledCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  
  /**
    * Provides access to the client object of the "For" text box in the Html Editor's "Change Element Properties" dialog.
    */
  /* CompleteClass */
  override def GetForTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetIdTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  
  /**
    * Provides access to the client object of the "Input type" combo box in the Html Editor's "Change Element Properties" dialog.
    */
  /* CompleteClass */
  override def GetInputTypeComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetMaxLengthTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  
  /**
    * Provides access to the client object of the "Method" text box in the Html Editor's "Change Element Properties" dialog.
    */
  /* CompleteClass */
  override def GetMethodTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  
  /**
    * Provides access to the client object of the "Name" text box in the Html Editor's "Change Element Properties" dialog.
    */
  /* CompleteClass */
  override def GetNameTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetReadonlyCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetValueTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
