...
class MVCxClientCalendar ()
  extends typings.devexpressWeb.MVCxClientCalendar {
  /**
  ...
  override var BeginCallback_MVCxClientCalendar: typings.devexpressWeb.ASPxClientEvent[MVCxClientBeginCallbackEventHandler[typings.devexpressWeb.MVCxClientCalendar]] = js.native
  /**
...
object MVCxClientCalendar extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientCalendar = js.native
}
