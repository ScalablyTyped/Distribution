...
@js.native
open class ASPxClientWebChartControl ()
  extends StObject
     with typings.devexpressWeb.ASPxClientWebChartControl {
...
object ASPxClientWebChartControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientWebChartControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientWebChartControl]
}
