...
@js.native
open class BootstrapClientToolbar ()
  extends StObject
     with typings.devexpressWeb.BootstrapClientMenu {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetSelectedItem(item: typings.devexpressWeb.BootstrapClientMenuItem): Unit = js.native
