...
@js.native
open class ASPxClientHtmlEditorImageDialog ()
  extends StObject
     with typings.devexpressWeb.ASPxClientHtmlEditorImageDialog {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetCreateThumbnailCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetDescriptionTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetSizeComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  
  /**
    * Provides access to the client object of the "New image name" text box in the Html Editor's Image dialog.
    */
  /* CompleteClass */
  override def GetThumbnailNameTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetWrapTextCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
}
