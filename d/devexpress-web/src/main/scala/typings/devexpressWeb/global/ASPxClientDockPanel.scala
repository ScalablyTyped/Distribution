...
class ASPxClientDockPanel ()
  extends StObject
     with typings.devexpressWeb.ASPxClientDockPanel {
...
object ASPxClientDockPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientDockPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientDockPanel]
}
