...
@js.native
class MVCxClientDockManager ()
  extends StObject
     with typings.devexpressWeb.MVCxClientDockManager {
...
object MVCxClientDockManager {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientDockManager = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientDockManager]
}
