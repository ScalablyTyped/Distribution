...
@js.native
open class ASPxClientCrosshairElementBase ()
  extends StObject
     with typings.devexpressWeb.ASPxClientCrosshairElementBase {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var LabelElement: typings.devexpressWeb.ASPxClientCrosshairSeriesLabelElement = js.native
