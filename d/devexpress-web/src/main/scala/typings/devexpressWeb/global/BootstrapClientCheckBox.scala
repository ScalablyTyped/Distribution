...
@js.native
class BootstrapClientCheckBox ()
  extends typings.devexpressWeb.BootstrapClientCheckBox {
  /**
    * Occurs on the client side when the editor's checked state has been changed.
    */
  /* CompleteClass */
  override var CheckedChanged: typings.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typings.devexpressWeb.BootstrapClientCheckBox]
  ] = js.native
  /**
