...
open class FloatingObjectAlignmentPositionSettings ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var horizontalPositionAlignment: typings.devexpressWeb.FloatingObjectHorizontalPositionAlignment = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var verticalPositionAlignment: typings.devexpressWeb.FloatingObjectVerticalPositionAlignment = js.native
