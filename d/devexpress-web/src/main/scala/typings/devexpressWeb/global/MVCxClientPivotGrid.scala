...
@js.native
open class MVCxClientPivotGrid ()
  extends StObject
     with typings.devexpressWeb.MVCxClientPivotGrid {
...
object MVCxClientPivotGrid {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.MVCxClientPivotGrid = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientPivotGrid]
}
