...
class ASPxClientTokenBox ()
  extends StObject
     with typings.devexpressWeb.ASPxClientTokenBox {
...
object ASPxClientTokenBox {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientTokenBox = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientTokenBox]
}
