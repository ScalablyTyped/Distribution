...
import typings.devexpressWeb.BootstrapClientSparklineTooltipHiddenEventHandler
import typings.devexpressWeb.BootstrapClientSparklineTooltipShownEventHandler
...
class BootstrapClientSparkline ()
  extends typings.devexpressWeb.BootstrapClientSparkline {
  /**
  ...
  override var TooltipHidden: typings.devexpressWeb.ASPxClientEvent[
    BootstrapClientSparklineTooltipHiddenEventHandler[typings.devexpressWeb.BootstrapClientSparkline]
  ] = js.native
  /* CompleteClass */
  override var TooltipShown: typings.devexpressWeb.ASPxClientEvent[
    BootstrapClientSparklineTooltipShownEventHandler[typings.devexpressWeb.BootstrapClientSparkline]
  ] = js.native
  /**
