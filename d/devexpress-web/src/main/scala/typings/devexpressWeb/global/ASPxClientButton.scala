...
@js.native
class ASPxClientButton ()
  extends typings.devexpressWeb.ASPxClientButton {
  /**
    * Occurs on the client side when the button's checked state is changed.
    */
  /* CompleteClass */
  override var CheckedChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientButton]] = js.native
  /**
    * Occurs on the client side after a button is clicked.
    */
  /* CompleteClass */
  override var Click: typings.devexpressWeb.ASPxClientEvent[ASPxClientButtonClickEventHandler[typings.devexpressWeb.ASPxClientButton]] = js.native
  /**
    * Fires on the client side when the button receives input focus.
    */
  /* CompleteClass */
  override var GotFocus: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientButton]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var LostFocus: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientButton]] = js.native
  /**
...
object ASPxClientButton extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientButton = js.native
}
