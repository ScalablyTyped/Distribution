...
@JSGlobal("ASPxDesignerSaveAsDialog")
@js.native
open class ASPxDesignerSaveAsDialog ()
  extends StObject
     with typings.devexpressWeb.ASPxDesignerSaveAsDialog {
  ...
  /* CompleteClass */
  override def save(url: String): Unit = js.native
