...
class MVCxClientPageControl ()
  extends StObject
     with typings.devexpressWeb.MVCxClientPageControl {
...
object MVCxClientPageControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientPageControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientPageControl]
}
