...
@js.native
open class ASPxClientCallbackPanel ()
  extends StObject
     with typings.devexpressWeb.ASPxClientCallbackPanel {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var Collapsed: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientPanel]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var Expanded: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientPanel]] = js.native
...
object ASPxClientCallbackPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientCallbackPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientCallbackPanel]
}
