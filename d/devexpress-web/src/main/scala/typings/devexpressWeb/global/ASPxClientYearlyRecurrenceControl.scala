...
@js.native
open class ASPxClientYearlyRecurrenceControl ()
  extends StObject
     with typings.devexpressWeb.ASPxClientYearlyRecurrenceControl {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def CreateValueAccessor(): typings.devexpressWeb.DefaultRecurrenceRuleValuesAccessor = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Update(recurrenceInfo: typings.devexpressWeb.ASPxClientRecurrenceInfo): Unit = js.native
