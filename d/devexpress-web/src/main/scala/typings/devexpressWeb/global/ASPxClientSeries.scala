...
open class ASPxClientSeries ()
  extends StObject
     with typings.devexpressWeb.ASPxClientSeries {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var crosshairValueItems: js.Array[typings.devexpressWeb.ASPxClientCrosshairValueItem] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var fibonacciIndicators: js.Array[typings.devexpressWeb.ASPxClientFibonacciIndicator] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var indicators: js.Array[typings.devexpressWeb.ASPxClientIndicator] = js.native
  
  /**
    * Gets the settings of series labels.
    */
  /* CompleteClass */
  var label: typings.devexpressWeb.ASPxClientSeriesLabel = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var points: js.Array[typings.devexpressWeb.ASPxClientSeriesPoint] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var regressionLines: js.Array[typings.devexpressWeb.ASPxClientRegressionLine] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var titles: js.Array[typings.devexpressWeb.ASPxClientSeriesTitle] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var trendLines: js.Array[typings.devexpressWeb.ASPxClientTrendLine] = js.native
