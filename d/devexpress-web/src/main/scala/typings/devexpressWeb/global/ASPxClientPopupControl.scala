...
object ASPxClientPopupControl {
  ...
  /* static member */
  @scala.inline
  def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientPopupControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientPopupControl]
  ...
  /* static member */
  @scala.inline
  def GetPopupControlCollection(): typings.devexpressWeb.ASPxClientPopupControlCollection = ^.asInstanceOf[js.Dynamic].applyDynamic("GetPopupControlCollection")().asInstanceOf[typings.devexpressWeb.ASPxClientPopupControlCollection]
}
