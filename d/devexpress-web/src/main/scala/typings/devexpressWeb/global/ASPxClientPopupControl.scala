...
class ASPxClientPopupControl ()
  extends StObject
     with typings.devexpressWeb.ASPxClientPopupControl {
...
object ASPxClientPopupControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientPopupControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientPopupControl]
  
  /**
    * Returns a collection of client popup control objects.
    */
  /* static member */
  inline def GetPopupControlCollection(): typings.devexpressWeb.ASPxClientPopupControlCollection = ^.asInstanceOf[js.Dynamic].applyDynamic("GetPopupControlCollection")().asInstanceOf[typings.devexpressWeb.ASPxClientPopupControlCollection]
}
