...
class ASPxClientSplitter ()
  extends typings.devexpressWeb.ASPxClientSplitter {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var PaneCollapsed: typings.devexpressWeb.ASPxClientEvent[ASPxClientSplitterPaneEventHandler[typings.devexpressWeb.ASPxClientSplitter]] = js.native
  /**
    * Fires before a pane is collapsed.
    */
  /* CompleteClass */
  override var PaneCollapsing: typings.devexpressWeb.ASPxClientEvent[
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var PaneContentUrlLoaded: typings.devexpressWeb.ASPxClientEvent[ASPxClientSplitterPaneEventHandler[typings.devexpressWeb.ASPxClientSplitter]] = js.native
  /**
    * Fires after a pane has been expanded.
    */
  /* CompleteClass */
  override var PaneExpanded: typings.devexpressWeb.ASPxClientEvent[ASPxClientSplitterPaneEventHandler[typings.devexpressWeb.ASPxClientSplitter]] = js.native
  /**
    * Fires before a pane is expanded.
    */
  /* CompleteClass */
  override var PaneExpanding: typings.devexpressWeb.ASPxClientEvent[
    ASPxClientSplitterPaneCancelEventHandler[typings.devexpressWeb.ASPxClientSplitter]
  ] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var PaneResizeCompleted: typings.devexpressWeb.ASPxClientEvent[ASPxClientSplitterPaneEventHandler[typings.devexpressWeb.ASPxClientSplitter]] = js.native
  /**
    * Fires after a pane has been resized.
    */
  /* CompleteClass */
  override var PaneResized: typings.devexpressWeb.ASPxClientEvent[ASPxClientSplitterPaneEventHandler[typings.devexpressWeb.ASPxClientSplitter]] = js.native
  /**
    * Fires before a pane is resized.
    */
  /* CompleteClass */
  override var PaneResizing: typings.devexpressWeb.ASPxClientEvent[
    ASPxClientSplitterPaneCancelEventHandler[typings.devexpressWeb.ASPxClientSplitter]
  ] = js.native
  /**
...
object ASPxClientSplitter extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientSplitter = js.native
}
