...
class MVCxClientCallbackPanel ()
  extends StObject
     with typings.devexpressWeb.MVCxClientCallbackPanel {
...
object MVCxClientCallbackPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientCallbackPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientCallbackPanel]
}
