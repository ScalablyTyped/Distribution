...
class ASPxClientClickEventArgs protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ColumnFieldName: String = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ColumnValue: js.Any = js.native
  /**
    * Gets a column value type.
    */
  /* CompleteClass */
  override var ColumnValueType: String = js.native
  /**
    * Gets the index of the data field which corresponds to the clicked summary value.
    */
  /* CompleteClass */
  override var DataIndex: Double = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var RowFieldName: String = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var RowValue: js.Any = js.native
  /**
    * Gets a row value type.
    */
  /* CompleteClass */
  override var RowValueType: String = js.native
  /**
