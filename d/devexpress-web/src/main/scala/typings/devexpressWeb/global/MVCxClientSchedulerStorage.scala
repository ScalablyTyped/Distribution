...
open class MVCxClientSchedulerStorage ()
  extends StObject
     with typings.devexpressWeb.MVCxClientSchedulerStorage {
...
object MVCxClientSchedulerStorage {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.MVCxClientSchedulerStorage = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientSchedulerStorage]
}
