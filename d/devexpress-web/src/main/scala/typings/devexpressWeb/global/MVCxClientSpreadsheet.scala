...
@js.native
open class MVCxClientSpreadsheet ()
  extends StObject
     with typings.devexpressWeb.MVCxClientSpreadsheet {
...
object MVCxClientSpreadsheet {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.MVCxClientSpreadsheet = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientSpreadsheet]
}
