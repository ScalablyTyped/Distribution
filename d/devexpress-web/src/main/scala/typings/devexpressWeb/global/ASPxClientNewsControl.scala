...
class ASPxClientNewsControl ()
  extends StObject
     with typings.devexpressWeb.ASPxClientNewsControl {
...
object ASPxClientNewsControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientNewsControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientNewsControl]
}
