...
class ASPxClientTimer ()
  extends typings.devexpressWeb.ASPxClientTimer {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var Tick: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientTimer]] = js.native
  /**
...
object ASPxClientTimer extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientTimer = js.native
}
