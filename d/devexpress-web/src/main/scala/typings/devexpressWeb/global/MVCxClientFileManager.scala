...
@js.native
class MVCxClientFileManager ()
  extends typings.devexpressWeb.MVCxClientFileManager {
  /**
...
object MVCxClientFileManager extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientFileManager = js.native
}
