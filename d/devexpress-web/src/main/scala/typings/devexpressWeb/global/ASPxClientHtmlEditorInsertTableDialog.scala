...
@js.native
class ASPxClientHtmlEditorInsertTableDialog ()
  extends typings.devexpressWeb.ASPxClientHtmlEditorInsertTableDialog {
  /**
    * Provides access to the client object of the "Accessibility" check box related to the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetAccessibilityCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  /**
    * Provides access to the client object of the "Alignment" combo box in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetAlignmentComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetBorderColorColorEdit(): typings.devexpressWeb.ASPxClientColorEdit = js.native
  /**
    * Provides access to the client object of the "Border size" spin editor in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetBorderWidthSpinEdit(): typings.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetCaptionTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  /**
    * Provides access to the client object of the "Cell padding" spin editor in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetCellPaddingSpinEdit(): typings.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    * Provides access to the client object of the "Cell spacing" spin editor in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetCellSpacingSpinEdit(): typings.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    * Provides access to the client object of the "Columns" spin editor in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetColumnCountSpinEdit(): typings.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    * Provides access to the client object of the "Equal column widths" check box in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetEqualWidthCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetHeadersComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  /**
    * Provides access to the client object of the "Height" combo box in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetHeightTypeComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetHeightValueSpinEdit(): typings.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetHeightValueTypeComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetRowCountSpinEdit(): typings.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    * Provides access to the client object of the "Summary" text box in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetSummaryTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  /**
    * Provides access to the client object of the "Width" combo box in the Html Editor's Table dialogs.
    */
  /* CompleteClass */
  override def GetWidthTypeComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetWidthValueSpinEdit(): typings.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetWidthValueTypeComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
}
