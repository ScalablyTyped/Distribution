...
class ASPxClientRibbon ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ActiveTabChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientRibbonTabEventHandler[typings.devexpressWeb.ASPxClientRibbon]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var CommandExecuted: typings.devexpressWeb.ASPxClientEvent[
  ...
  /**
    ...
    */
  /* CompleteClass */
  var DialogBoxLauncherClicked: typings.devexpressWeb.ASPxClientEvent[
  ...
  /**
    ...
    */
  /* CompleteClass */
  var FileTabClicked: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientRibbon]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var KeyTipsClosedOnEscape: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientRibbon]] = js.native
  
  /**
    * Occurs on the client side when the ribbon minimization state is changed by end-user actions.
    */
  /* CompleteClass */
  var MinimizationStateChanged: typings.devexpressWeb.ASPxClientEvent[
...
object ASPxClientRibbon {
  ...
  /* static member */
  @scala.inline
  def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientRibbon = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientRibbon]
}
