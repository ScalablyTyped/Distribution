...
class MVCxClientScheduler ()
  extends StObject
     with typings.devexpressWeb.MVCxClientScheduler {
...
object MVCxClientScheduler {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientScheduler = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientScheduler]
}
