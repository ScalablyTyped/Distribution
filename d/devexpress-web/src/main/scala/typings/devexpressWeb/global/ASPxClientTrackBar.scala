...
class ASPxClientTrackBar ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var Track: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientTrackBar]] = js.native
  
  /**
    * Occurs on the client-side when an end-user releases a drag handle after moving it.
    */
  /* CompleteClass */
  var TrackEnd: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientTrackBar]] = js.native
  
  /**
    * Occurs on the client-side when an end-user presses a drag handle and moves it.
    */
  /* CompleteClass */
  var TrackStart: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientTrackBar]] = js.native
...
object ASPxClientTrackBar {
  ...
  /* static member */
  @scala.inline
  def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientTrackBar = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientTrackBar]
}
