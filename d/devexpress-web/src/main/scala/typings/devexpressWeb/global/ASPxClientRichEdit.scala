...
@js.native
open class ASPxClientRichEdit ()
  extends StObject
     with typings.devexpressWeb.ASPxClientRichEdit {
...
object ASPxClientRichEdit {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientRichEdit = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientRichEdit]
}
