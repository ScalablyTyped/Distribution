...
class ASPxClientHtmlEditorYouTubeDialog ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetAllowFullscreenCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetConfidentModeCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetShowSameVideosCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetShowVideoNameCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
