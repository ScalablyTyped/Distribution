...
import typings.devexpressWeb.ASPxClientDropDownCommandEventHandler
...
@js.native
class ASPxClientDropDownEdit ()
  extends typings.devexpressWeb.ASPxClientDropDownEdit {
  /**
    * Occurs on the client side after an editor button is clicked.
    */
  /* CompleteClass */
  override var ButtonClick: typings.devexpressWeb.ASPxClientEvent[
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var CloseUp: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientDropDownEditBase]] = js.native
  /**
    * Occurs on the client-side when the <strong>drop down window</strong> is opened by the dropdown button click.
    */
  /* CompleteClass */
  override var DropDown: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientDropDownEditBase]] = js.native
  /**
    * Allows you to handle a click on 'Ok' and 'Cancel' buttons in the drop-down window.
    */
  /* CompleteClass */
  override var DropDownCommandButtonClick: typings.devexpressWeb.ASPxClientEvent[
    ASPxClientDropDownCommandEventHandler[typings.devexpressWeb.ASPxClientDropDownEdit]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var KeyDown: typings.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typings.devexpressWeb.ASPxClientTextEdit]] = js.native
  /**
    * Occurs on the client-side when an end-user presses and releases a key while the editor has focus.
    */
  /* CompleteClass */
  override var KeyPress: typings.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typings.devexpressWeb.ASPxClientTextEdit]] = js.native
  /**
    * Occurs on the client-side when an end-user releases a pressed key while the editor has focus.
    */
  /* CompleteClass */
  override var KeyUp: typings.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typings.devexpressWeb.ASPxClientTextEdit]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var QueryCloseUp: typings.devexpressWeb.ASPxClientEvent[ASPxClientCancelEventHandler[typings.devexpressWeb.ASPxClientDropDownEditBase]] = js.native
  /**
    * Fires on the client side when the editor's text is changed and focus moves out of the editor by end-user interactions.
    */
  /* CompleteClass */
  override var TextChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientTextEdit]] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var UserInput: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientTextEdit]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetKeyValue(): String = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetKeyValue(keyValue: String): Unit = js.native
  /**
...
object ASPxClientDropDownEdit extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientDropDownEdit = js.native
}
