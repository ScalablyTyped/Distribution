...
class ASPxClientPivotCustomization ()
  extends typings.devexpressWeb.ASPxClientPivotCustomization {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetPivotGrid(): typings.devexpressWeb.ASPxClientPivotGrid = js.native
  /**
    * Returns a value specifying whether a control is displayed.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetLayout(layout: String): Unit = js.native
  /**
    * Specifies whether a control is displayed.
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def UpdateHeight(): Unit = js.native
}
