...
class ASPxClientSpreadsheetPopupMenuItemCollection ()
  extends StObject
     with typings.devexpressWeb.ASPxClientSpreadsheetPopupMenuItemCollection {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Add(item: typings.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Get(index: Double): typings.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetByName(name: String): typings.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Insert(index: Double, item: typings.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem): Unit = js.native
