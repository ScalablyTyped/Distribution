...
open class BootstrapClientTreeViewNode ()
  ...
  /* CompleteClass */
  @JSName("parent")
  var parent_BootstrapClientTreeViewNode: typings.devexpressWeb.BootstrapClientTreeViewNode = js.native
  ...
  /* CompleteClass */
  @JSName("treeView")
  var treeView_BootstrapClientTreeViewNode: typings.devexpressWeb.BootstrapClientTreeView = js.native
}
