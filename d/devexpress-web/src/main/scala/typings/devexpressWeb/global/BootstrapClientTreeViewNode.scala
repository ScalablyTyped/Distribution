...
class BootstrapClientTreeViewNode ()
  extends typings.devexpressWeb.BootstrapClientTreeViewNode {
  /**
  ...
  /* CompleteClass */
  @JSName("parent")
  override var parent_BootstrapClientTreeViewNode: typings.devexpressWeb.BootstrapClientTreeViewNode = js.native
  /**
  ...
  /* CompleteClass */
  @JSName("treeView")
  override var treeView_BootstrapClientTreeViewNode: typings.devexpressWeb.BootstrapClientTreeView = js.native
  /**
