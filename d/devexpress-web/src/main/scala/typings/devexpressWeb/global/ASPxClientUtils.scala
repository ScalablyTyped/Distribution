...
object ASPxClientUtils {
  ...
  /**
    ...
    */
  /* static member */
  inline def AddClassNameToElement(element: js.Any, className: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("AddClassNameToElement")(element.asInstanceOf[js.Any], className.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def ArrayClear(array: js.Array[js.Any]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("ArrayClear")(array.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def ArrayIndexOf(array: js.Array[js.Any], element: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("ArrayIndexOf")(array.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  /**
    ...
    */
  /* static member */
  inline def ArrayInsert(array: js.Array[js.Any], element: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("ArrayInsert")(array.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def ArrayRemove(array: js.Array[js.Any], element: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("ArrayRemove")(array.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def ArrayRemoveAt(array: js.Array[js.Any], index: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("ArrayRemoveAt")(array.asInstanceOf[js.Any], index.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def AttachEventToElement(element: js.Any, eventName: String, method: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("AttachEventToElement")(element.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any], method.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def DetachEventFromElement(element: js.Any, eventName: String, method: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("DetachEventFromElement")(element.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any], method.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetAbsoluteX(element: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("GetAbsoluteX")(element.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetAbsoluteY(element: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("GetAbsoluteY")(element.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetChildById(element: js.Any, id: String): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("GetChildById")(element.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetChildByTagName(element: js.Any, tagName: String, index: Double): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("GetChildByTagName")(element.asInstanceOf[js.Any], tagName.asInstanceOf[js.Any], index.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetEditorValuesInContainer(containerOrId: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("GetEditorValuesInContainer")(containerOrId.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  inline def GetEditorValuesInContainer(containerOrId: js.Any, processInvisibleEditors: Boolean): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("GetEditorValuesInContainer")(containerOrId.asInstanceOf[js.Any], processInvisibleEditors.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetEventSource(htmlEvent: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("GetEventSource")(htmlEvent.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetEventX(htmlEvent: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("GetEventX")(htmlEvent.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetEventY(htmlEvent: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("GetEventY")(htmlEvent.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetIsParent(parentElement: js.Any, element: js.Any): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("GetIsParent")(parentElement.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetKeyCode(htmlEvent: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("GetKeyCode")(htmlEvent.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetParentByClassName(element: js.Any, className: String): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("GetParentByClassName")(element.asInstanceOf[js.Any], className.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetParentById(element: js.Any, id: String): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("GetParentById")(element.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetParentByTagName(element: js.Any, tagName: String): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("GetParentByTagName")(element.asInstanceOf[js.Any], tagName.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  /**
    ...
    */
  /* static member */
  inline def GetShortcutCodeByEvent(htmlEvent: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("GetShortcutCodeByEvent")(htmlEvent.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    */
  /* static member */
  inline def IsExists(obj: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("IsExists")(obj.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  /* static member */
  inline def PreventDragStart(htmlEvent: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("PreventDragStart")(htmlEvent.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  /* static member */
  inline def PreventEvent(htmlEvent: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("PreventEvent")(htmlEvent.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  /* static member */
  inline def PreventEventAndBubble(htmlEvent: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("PreventEventAndBubble")(htmlEvent.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  /* static member */
  inline def RemoveClassNameFromElement(element: js.Any, className: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("RemoveClassNameFromElement")(element.asInstanceOf[js.Any], className.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def SetAbsoluteX(element: js.Any, x: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("SetAbsoluteX")(element.asInstanceOf[js.Any], x.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def SetAbsoluteY(element: js.Any, y: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("SetAbsoluteY")(element.asInstanceOf[js.Any], y.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def SetCookie(name: String, value: String, expirationDate: Date): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("SetCookie")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any], expirationDate.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def SetEditorValues(values: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("SetEditorValues")(values.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def ToggleClassName(element: js.Any, className: String, toggleState: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("ToggleClassName")(element.asInstanceOf[js.Any], className.asInstanceOf[js.Any], toggleState.asInstanceOf[js.Any])).asInstanceOf[Unit]
