...
@js.native
class ASPxClientVerticalGrid ()
  extends typings.devexpressWeb.ASPxClientVerticalGrid {
  /**
    * Fires when a user changes the summary item value.
    */
  /* CompleteClass */
  override var BatchEditSummaryDisplayText: typings.devexpressWeb.ASPxClientEvent[
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ToolbarItemClick: typings.devexpressWeb.ASPxClientEvent[
...
object ASPxClientVerticalGrid extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientVerticalGrid = js.native
}
