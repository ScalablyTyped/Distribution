...
class FloatingObjectTextWrappingSettings ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var floatingObjectTextWrapSide: typings.devexpressWeb.FloatingObjectTextWrapSide = js.native
  
  /**
    * Gets or sets a value specifying how text is wrapped around a floating object.
    */
  /* CompleteClass */
  var floatingObjectTextWrapType: typings.devexpressWeb.FloatingObjectTextWrapType = js.native
