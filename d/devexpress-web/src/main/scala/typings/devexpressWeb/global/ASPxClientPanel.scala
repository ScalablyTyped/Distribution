...
@js.native
class ASPxClientPanel ()
  extends StObject
     with typings.devexpressWeb.ASPxClientPanel {
...
object ASPxClientPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientPanel]
}
