...
@js.native
class ASPxClientHtmlEditorTableColumnPropertiesDialog ()
  extends typings.devexpressWeb.ASPxClientHtmlEditorTableColumnPropertiesDialog {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetHorizontalAlignmentComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetVerticalAlignmentComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  /**
