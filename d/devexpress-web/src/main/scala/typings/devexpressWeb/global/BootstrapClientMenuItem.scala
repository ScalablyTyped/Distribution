...
class BootstrapClientMenuItem ()
  extends typings.devexpressWeb.BootstrapClientMenuItem {
  /**
  ...
  /* CompleteClass */
  @JSName("parent")
  override var parent_BootstrapClientMenuItem: typings.devexpressWeb.BootstrapClientMenuItem = js.native
  /**
