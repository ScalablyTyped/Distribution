...
@js.native
class BootstrapClientMenuItem ()
  extends StObject
     with typings.devexpressWeb.BootstrapClientMenuItem {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var menu: typings.devexpressWeb.ASPxClientMenuBase = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var parent: typings.devexpressWeb.ASPxClientMenuItem = js.native
  /**
    * Gets the immediate parent item to which the current item belongs.
    */
  /* CompleteClass */
  @JSName("parent")
  var parent_BootstrapClientMenuItem: typings.devexpressWeb.BootstrapClientMenuItem = js.native
}
