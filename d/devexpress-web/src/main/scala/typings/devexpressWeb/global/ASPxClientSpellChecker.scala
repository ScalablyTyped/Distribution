...
class ASPxClientSpellChecker ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var AfterCheck: typings.devexpressWeb.ASPxClientEvent[ASPxClientAfterCheckEventHandler[typings.devexpressWeb.ASPxClientSpellChecker]] = js.native
  
  /**
    * Client-side event that occurs before the spell check starts.
    */
  /* CompleteClass */
  var BeforeCheck: typings.devexpressWeb.ASPxClientEvent[ASPxClientBeforeCheckEventHandler[typings.devexpressWeb.ASPxClientSpellChecker]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var CheckCompleteFormShowing: typings.devexpressWeb.ASPxClientEvent[ASPxClientCancelEventHandler[typings.devexpressWeb.ASPxClientSpellChecker]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var WordChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientWordChangedEventHandler[typings.devexpressWeb.ASPxClientSpellChecker]] = js.native
