...
class ASPxClientPopupControlCollection ()
  extends typings.devexpressWeb.ASPxClientPopupControlCollection {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var BrowserWindowResized: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientControlCollection]] = js.native
  /**
