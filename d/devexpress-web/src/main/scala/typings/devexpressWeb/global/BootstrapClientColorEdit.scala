...
@js.native
class BootstrapClientColorEdit ()
  extends typings.devexpressWeb.ASPxClientColorEdit {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ColorChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientColorEdit]] = js.native
  /**
  ...
  /* CompleteClass */
  @JSName("TextChanged")
  override var TextChanged_ASPxClientColorEdit: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientColorEdit]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def IsAutomaticColorSelected(): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetColor(value: String): Unit = js.native
  /**
