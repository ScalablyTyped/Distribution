...
class ASPxClientRoundPanel ()
  extends StObject
     with typings.devexpressWeb.ASPxClientRoundPanel {
...
object ASPxClientRoundPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientRoundPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientRoundPanel]
}
