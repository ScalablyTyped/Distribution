...
class ASPxClientGridLookup ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var BeginCallback: typings.devexpressWeb.ASPxClientEvent[ASPxClientBeginCallbackEventHandler[typings.devexpressWeb.ASPxClientGridLookup]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var EndCallback: typings.devexpressWeb.ASPxClientEvent[ASPxClientEndCallbackEventHandler[typings.devexpressWeb.ASPxClientGridLookup]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var RowClick: typings.devexpressWeb.ASPxClientEvent[
