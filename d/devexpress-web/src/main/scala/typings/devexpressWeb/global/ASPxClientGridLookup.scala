...
import typings.devexpressWeb.ASPxClientGridViewRowClickEventHandler
...
class ASPxClientGridLookup ()
  extends StObject
     with typings.devexpressWeb.ASPxClientGridLookup {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var BeginCallback: typings.devexpressWeb.ASPxClientEvent[ASPxClientBeginCallbackEventHandler[typings.devexpressWeb.ASPxClientGridLookup]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var EndCallback: typings.devexpressWeb.ASPxClientEvent[ASPxClientEndCallbackEventHandler[typings.devexpressWeb.ASPxClientGridLookup]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetGridView(): typings.devexpressWeb.ASPxClientGridView = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var RowClick: typings.devexpressWeb.ASPxClientEvent[
    ASPxClientGridViewRowClickEventHandler[typings.devexpressWeb.ASPxClientGridLookup]
  ] = js.native
...
object ASPxClientGridLookup {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientGridLookup = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientGridLookup]
}
