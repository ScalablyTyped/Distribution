...
class ASPxClientRatingControl ()
  extends StObject
     with typings.devexpressWeb.ASPxClientRatingControl {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ItemClick: typings.devexpressWeb.ASPxClientEvent[
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ItemMouseOut: typings.devexpressWeb.ASPxClientEvent[
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ItemMouseOver: typings.devexpressWeb.ASPxClientEvent[
    ASPxClientRatingControlItemMouseEventHandler[typings.devexpressWeb.ASPxClientRatingControl]
  ] = js.native
...
object ASPxClientRatingControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientRatingControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientRatingControl]
}
