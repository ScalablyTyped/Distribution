...
class ASPxClientNavBar ()
  extends StObject
     with typings.devexpressWeb.ASPxClientNavBar {
...
object ASPxClientNavBar {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientNavBar = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientNavBar]
}
