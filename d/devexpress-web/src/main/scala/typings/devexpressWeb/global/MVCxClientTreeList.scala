...
class MVCxClientTreeList ()
  extends StObject
     with typings.devexpressWeb.MVCxClientTreeList {
...
object MVCxClientTreeList {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientTreeList = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientTreeList]
}
