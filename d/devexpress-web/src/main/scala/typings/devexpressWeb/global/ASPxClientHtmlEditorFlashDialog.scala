...
class ASPxClientHtmlEditorFlashDialog ()
  extends typings.devexpressWeb.ASPxClientHtmlEditorFlashDialog {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetEnableFlashMenuCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetQualityComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  /**
