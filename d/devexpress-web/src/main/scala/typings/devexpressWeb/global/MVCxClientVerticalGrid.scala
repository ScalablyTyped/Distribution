...
@js.native
open class MVCxClientVerticalGrid ()
  extends StObject
...
object MVCxClientVerticalGrid {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.MVCxClientVerticalGrid = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientVerticalGrid]
}
