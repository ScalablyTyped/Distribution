...
class ASPxClientObjectContainer ()
  extends StObject
     with typings.devexpressWeb.ASPxClientObjectContainer {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var FlashScriptCommand: typings.devexpressWeb.ASPxClientEvent[
...
object ASPxClientObjectContainer {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientObjectContainer = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientObjectContainer]
}
