...
@js.native
open class ASPxClientReportViewer ()
  extends StObject
     with typings.devexpressWeb.ASPxClientReportViewer {
...
object ASPxClientReportViewer {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientReportViewer = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientReportViewer]
}
