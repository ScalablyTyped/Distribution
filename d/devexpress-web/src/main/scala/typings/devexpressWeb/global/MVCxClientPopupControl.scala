...
@js.native
open class MVCxClientPopupControl ()
  extends StObject
     with typings.devexpressWeb.MVCxClientPopupControl {
...
object MVCxClientPopupControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.MVCxClientPopupControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientPopupControl]
}
