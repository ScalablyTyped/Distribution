...
@js.native
open class ASPxClientPageControl ()
  extends StObject
     with typings.devexpressWeb.ASPxClientPageControl {
  
  /**
    * Fires on the client side after the active tab has been changed within a tab control.
    */
  /* CompleteClass */
  var ActiveTabChanged: typings.devexpressWeb.ASPxClientEvent[
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ActiveTabChanging: typings.devexpressWeb.ASPxClientEvent[
  ...
  /**
    ...
    */
  /* CompleteClass */
  var TabClick: typings.devexpressWeb.ASPxClientEvent[
...
object ASPxClientPageControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientPageControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientPageControl]
}
