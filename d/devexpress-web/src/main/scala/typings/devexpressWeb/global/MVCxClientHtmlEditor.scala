...
@js.native
open class MVCxClientHtmlEditor ()
  extends StObject
     with typings.devexpressWeb.MVCxClientHtmlEditor {
...
object MVCxClientHtmlEditor {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.MVCxClientHtmlEditor = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientHtmlEditor]
}
