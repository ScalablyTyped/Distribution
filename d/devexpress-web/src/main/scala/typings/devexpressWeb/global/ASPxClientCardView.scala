...
class ASPxClientCardView ()
  extends StObject
     with typings.devexpressWeb.ASPxClientCardView {
...
object ASPxClientCardView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientCardView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientCardView]
}
