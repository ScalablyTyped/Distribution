...
open class ASPxClientPivotGrid ()
  extends StObject
     with typings.devexpressWeb.ASPxClientPivotGrid {
...
object ASPxClientPivotGrid {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientPivotGrid = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientPivotGrid]
}
