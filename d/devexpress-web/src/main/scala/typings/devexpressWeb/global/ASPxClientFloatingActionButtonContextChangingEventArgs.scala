...
@js.native
class ASPxClientFloatingActionButtonContextChangingEventArgs protected ()
  extends typings.devexpressWeb.ASPxClientFloatingActionButtonContextChangingEventArgs {
  /**
