...
object MVCxClientRoundPanel {
  ...
  /* static member */
  @scala.inline
  def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientRoundPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientRoundPanel]
}
