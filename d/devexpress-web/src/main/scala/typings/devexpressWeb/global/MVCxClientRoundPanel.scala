...
@js.native
open class MVCxClientRoundPanel ()
  extends StObject
     with typings.devexpressWeb.MVCxClientRoundPanel {
...
object MVCxClientRoundPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.MVCxClientRoundPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientRoundPanel]
}
