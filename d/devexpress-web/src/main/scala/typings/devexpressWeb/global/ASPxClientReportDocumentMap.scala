...
class ASPxClientReportDocumentMap ()
  extends typings.devexpressWeb.ASPxClientReportDocumentMap {
  /**
    * Occurs after the content of the Document Viewer's document map is updated.
    */
  /* CompleteClass */
  override var ContentChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientReportDocumentMap]] = js.native
  /**
