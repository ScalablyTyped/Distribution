...
@js.native
open class ASPxClientReportDocumentMap ()
  extends StObject
     with typings.devexpressWeb.ASPxClientReportDocumentMap {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ContentChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typings.devexpressWeb.ASPxClientReportDocumentMap]] = js.native
