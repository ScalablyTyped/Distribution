...
class MVCxClientNavBar ()
  extends typings.devexpressWeb.MVCxClientNavBar {
  /**
  ...
  override var BeginCallback_MVCxClientNavBar: typings.devexpressWeb.ASPxClientEvent[MVCxClientBeginCallbackEventHandler[typings.devexpressWeb.MVCxClientNavBar]] = js.native
  /**
...
object MVCxClientNavBar extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientNavBar = js.native
}
