...
@js.native
class MVCxClientUploadControl ()
  extends StObject
     with typings.devexpressWeb.ASPxClientUploadControl {
...
object MVCxClientUploadControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientUploadControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientUploadControl]
}
