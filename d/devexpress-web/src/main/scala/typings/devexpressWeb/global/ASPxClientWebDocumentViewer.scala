...
@js.native
open class ASPxClientWebDocumentViewer ()
  extends StObject
     with typings.devexpressWeb.ASPxClientWebDocumentViewer {
...
object ASPxClientWebDocumentViewer {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientWebDocumentViewer = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientWebDocumentViewer]
}
