...
@js.native
class ASPxClientWebDocumentViewer ()
  extends StObject
...
object ASPxClientWebDocumentViewer {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientWebDocumentViewer = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientWebDocumentViewer]
}
