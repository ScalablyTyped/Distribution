...
class BootstrapClientAccordion ()
  extends typings.devexpressWeb.BootstrapClientAccordion {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetActiveGroup(group: typings.devexpressWeb.BootstrapClientAccordionGroup): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetSelectedItem(item: typings.devexpressWeb.BootstrapClientAccordionItem): Unit = js.native
  /**
    * Specifies whether a control is displayed.
