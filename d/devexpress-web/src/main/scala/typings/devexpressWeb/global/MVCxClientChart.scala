...
@js.native
class MVCxClientChart ()
  extends StObject
     with typings.devexpressWeb.MVCxClientChart {
...
object MVCxClientChart {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientChart = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientChart]
}
