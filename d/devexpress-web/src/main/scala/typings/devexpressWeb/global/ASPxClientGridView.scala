...
class ASPxClientGridView ()
  extends StObject
     with typings.devexpressWeb.ASPxClientGridView {
...
object ASPxClientGridView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientGridView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientGridView]
}
