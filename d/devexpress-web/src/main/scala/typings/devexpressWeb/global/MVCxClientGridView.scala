...
class MVCxClientGridView ()
  extends StObject
     with typings.devexpressWeb.MVCxClientGridView {
...
object MVCxClientGridView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.MVCxClientGridView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.MVCxClientGridView]
}
