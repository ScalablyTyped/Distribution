...
@js.native
class ParagraphFormattingSettings ()
  extends StObject
     with typings.devexpressWeb.ParagraphFormattingSettings {
  
  /**
    * Specifies the paragraph alignment.
    */
  /* CompleteClass */
  var alignment: typings.devexpressWeb.ParagraphAlignment = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var lineSpacingType: typings.devexpressWeb.ParagraphLineSpacingType = js.native
