...
class BootstrapClientDateEdit ()
  extends typings.devexpressWeb.BootstrapClientDateEdit {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var CalendarCellClick: typings.devexpressWeb.ASPxClientEvent[
    ASPxClientCalendarCellClickEventHandler[typings.devexpressWeb.ASPxClientDateEdit]
  ] = js.native
  /**
    * Allows you to disable the calendar's days.
    */
  /* CompleteClass */
  override var CalendarCustomDisabledDate: typings.devexpressWeb.ASPxClientEvent[
    ASPxClientCalendarCustomDisabledDateEventHandler[typings.devexpressWeb.ASPxClientDateEdit]
  ] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var DateChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientDateEdit]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ParseDate: typings.devexpressWeb.ASPxClientEvent[ASPxClientParseDateEventHandler[typings.devexpressWeb.ASPxClientDateEdit]] = js.native
  /**
  ...
  /* CompleteClass */
  @JSName("TextChanged")
  override var TextChanged_ASPxClientDateEdit: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientDateEdit]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetCalendar(): typings.devexpressWeb.ASPxClientCalendar = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetTimeEdit(): typings.devexpressWeb.ASPxClientTimeEdit = js.native
  /**
