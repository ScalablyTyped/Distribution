...
class BootstrapClientPopupMenu ()
  extends typings.devexpressWeb.BootstrapClientPopupMenu {
  /**
    * Occurs on the client side when a submenu closes.
    */
  /* CompleteClass */
  override var CloseUp: typings.devexpressWeb.ASPxClientEvent[ASPxClientMenuItemEventHandler[typings.devexpressWeb.ASPxClientMenuBase]] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ItemClick: typings.devexpressWeb.ASPxClientEvent[ASPxClientMenuItemClickEventHandler[typings.devexpressWeb.ASPxClientMenuBase]] = js.native
  /**
    * Occurs on the client side when the mouse cursor moves outside a menu item.
    */
  /* CompleteClass */
  override var ItemMouseOut: typings.devexpressWeb.ASPxClientEvent[ASPxClientMenuItemMouseEventHandler[typings.devexpressWeb.ASPxClientMenuBase]] = js.native
  /**
    * Occurs on the client side when the mouse cursor is moved into a menu item.
    */
  /* CompleteClass */
  override var ItemMouseOver: typings.devexpressWeb.ASPxClientEvent[ASPxClientMenuItemMouseEventHandler[typings.devexpressWeb.ASPxClientMenuBase]] = js.native
  /**
    * Occurs on the client side when a submenu pops up.
    */
  /* CompleteClass */
  override var PopUp: typings.devexpressWeb.ASPxClientEvent[ASPxClientMenuItemEventHandler[typings.devexpressWeb.ASPxClientMenuBase]] = js.native
  /**
