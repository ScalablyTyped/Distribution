...
class ASPxClientTitleIndex ()
  extends StObject
     with typings.devexpressWeb.ASPxClientTitleIndex {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var BeginCallback: typings.devexpressWeb.ASPxClientEvent[ASPxClientBeginCallbackEventHandler[typings.devexpressWeb.ASPxClientTitleIndex]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var CallbackError: typings.devexpressWeb.ASPxClientEvent[ASPxClientCallbackErrorEventHandler[typings.devexpressWeb.ASPxClientTitleIndex]] = js.native
  
  /**
    * Occurs on the client side after a callback's server-side processing has been completed.
    */
  /* CompleteClass */
  var EndCallback: typings.devexpressWeb.ASPxClientEvent[ASPxClientEndCallbackEventHandler[typings.devexpressWeb.ASPxClientTitleIndex]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ItemClick: typings.devexpressWeb.ASPxClientEvent[ASPxClientTitleIndexItemEventHandler[typings.devexpressWeb.ASPxClientTitleIndex]] = js.native
...
object ASPxClientTitleIndex {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientTitleIndex = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientTitleIndex]
}
