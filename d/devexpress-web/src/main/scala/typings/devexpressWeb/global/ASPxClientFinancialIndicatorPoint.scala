...
class ASPxClientFinancialIndicatorPoint ()
  extends typings.devexpressWeb.ASPxClientFinancialIndicatorPoint {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var financialIndicator: typings.devexpressWeb.ASPxClientFinancialIndicator = js.native
  /**
