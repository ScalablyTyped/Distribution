...
@js.native
class ASPxClientFloatingActionButtonActionItemClickEventArgs protected ()
  extends typings.devexpressWeb.ASPxClientFloatingActionButtonActionItemClickEventArgs {
  /**
