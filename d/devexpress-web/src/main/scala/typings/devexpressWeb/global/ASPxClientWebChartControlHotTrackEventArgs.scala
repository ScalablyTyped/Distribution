...
class ASPxClientWebChartControlHotTrackEventArgs protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var additionalHitObject: typings.devexpressWeb.ASPxClientWebChartElement = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var hitInfo: typings.devexpressWeb.ASPxClientWebChartHitInfo = js.native
  /**
    * Provides access on the client side to the chart element, for which the event was raised.
    */
  /* CompleteClass */
  override var hitObject: typings.devexpressWeb.ASPxClientWebChartElement = js.native
  /**
