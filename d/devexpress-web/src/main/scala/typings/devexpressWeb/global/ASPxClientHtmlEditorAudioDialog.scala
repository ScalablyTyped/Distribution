...
class ASPxClientHtmlEditorAudioDialog ()
  extends typings.devexpressWeb.ASPxClientHtmlEditorAudioDialog {
  /**
    * Provides access to the client object of the "Auto play" check box in the Html Editor's Audio dialogs.
    */
  /* CompleteClass */
  override def GetAutoPlayCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetBorderStyleComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetBottomMarginTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetCssClassNameComboBox(): typings.devexpressWeb.ASPxClientComboBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetHeightSpinEdit(): typings.devexpressWeb.ASPxClientSpinEdit = js.native
  /**
    * Provides access to the client object of the "Left margin" text box in the Html Editor's dialogs (Style Settings).
    */
  /* CompleteClass */
  override def GetLeftMarginTextBox(): typings.devexpressWeb.ASPxClientTextBox = js.native
  /**
    * Provides access to the client object of the "Loop" check box in the Html Editor's Audio dialogs.
    */
  /* CompleteClass */
  override def GetLoopCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def GetMediaFileSelector(): typings.devexpressWeb.ASPxClientMediaFileSelector = js.native
  /**
    * Provides access to the client object of the "More options" check box in the Html Editor's Audio/Video/Flash/Image dialogs.
    */
  /* CompleteClass */
  override def GetMoreOptionsCheckBox(): typings.devexpressWeb.ASPxClientCheckBox = js.native
  /**
