...
@js.native
open class ASPxClientCallback ()
  extends StObject
     with typings.devexpressWeb.ASPxClientCallback {
...
object ASPxClientCallback {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientCallback = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientCallback]
}
