...
/**
  ...
  */
@JSGlobal("ASPxClientRadioButton")
@js.native
open class ASPxClientRadioButton ()
  extends StObject
     with typings.devexpressWeb.ASPxClientRadioButton {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var CheckedChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientCheckBox]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetCheckState(checkState: String): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetChecked(isChecked: Boolean): Unit = js.native
...
object ASPxClientRadioButton {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typings.devexpressWeb.ASPxClientRadioButton = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.devexpressWeb.ASPxClientRadioButton]
}
