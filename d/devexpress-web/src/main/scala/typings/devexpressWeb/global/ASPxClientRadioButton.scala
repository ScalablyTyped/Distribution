...
class ASPxClientRadioButton ()
  extends typings.devexpressWeb.ASPxClientRadioButton {
  /**
    * Occurs on the client side when the editor's checked state is changed.
    */
  /* CompleteClass */
  override var CheckedChanged: typings.devexpressWeb.ASPxClientEvent[ASPxClientProcessingModeEventHandler[typings.devexpressWeb.ASPxClientCheckBox]] = js.native
  /**
...
@JSGlobal("ASPxClientRadioButton")
@js.native
object ASPxClientRadioButton extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): typings.devexpressWeb.ASPxClientRadioButton = js.native
}
