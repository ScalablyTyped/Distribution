...
trait ASPxClientHtmlEditor
  ...
  /**
    ...
    */
  def CreateChangeMediaElementCommandArguments(element: Any): ASPxClientHtmlEditorChangeMediaElementCommandArguments = js.native
  ...
  /**
    ...
    */
  def ExecuteCommand(commandName: String, parameter: Any, addToUndoHistory: Boolean): Boolean = js.native
  ...
  /**
    ...
    */
  def GetDesignViewDocument(): Any = js.native
  ...
  /**
    ...
    */
  def GetPreviewDocument(): Any = js.native
  ...
  /**
    ...
    */
  def ReplacePlaceholders(html: String, placeholders: js.Array[Any]): String = js.native
