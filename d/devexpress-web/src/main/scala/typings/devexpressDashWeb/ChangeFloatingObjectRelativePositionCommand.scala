...
trait ChangeFloatingObjectRelativePositionCommand extends CommandBase {
  /**
    ...
    */
  def execute(settings: FloatingObjectRelativePositionSettings): Boolean
  /**
...
object ChangeFloatingObjectRelativePositionCommand {
  @scala.inline
  def apply(execute: FloatingObjectRelativePositionSettings => Boolean, getState: () => js.Any): ChangeFloatingObjectRelativePositionCommand = {
