...
trait ChangeTextBoxRelativeSizeCommand extends CommandBase {
  /**
    ...
    */
  def execute(settings: TextBoxRelativeSizeSettings): Boolean
  /**
...
object ChangeTextBoxRelativeSizeCommand {
  @scala.inline
  def apply(execute: TextBoxRelativeSizeSettings => Boolean, getState: () => js.Any): ChangeTextBoxRelativeSizeCommand = {
