...
trait SubDocument extends js.Object {
  ...
  /**
    ...
    */
  def findBookmarks(name: String): js.Array[Bookmark] = js.native
  /**
    ...
    */
  def findBookmarks(position: Double): js.Array[Bookmark] = js.native
  /**
  ...
  /**
    ...
    */
  def findFields(position: Double): js.Array[Field] = js.native
  /**
  ...
  /**
    ...
    * @param position An integer value specifying the target position in the sub-document.
    */
  def findParagraphs(position: Double): js.Array[Paragraph] = js.native
  /**
  ...
  /**
    ...
    */
  def findTables(position: Double): js.Array[Field] = js.native
  /**
