...
trait ASPxClientHiddenField extends ASPxClientControl {
  ...
  /**
    ...
    */
  def Add(propertyName: String, propertyValue: js.Object): Unit
  /**
  ...
  /**
    ...
    * @param propertyName A string value that specifies the property name.
    */
  def Get(propertyName: String): js.Object
  /**
  ...
  /**
    ...
    */
  def Set(propertyName: String, propertyValue: js.Object): Unit
}
