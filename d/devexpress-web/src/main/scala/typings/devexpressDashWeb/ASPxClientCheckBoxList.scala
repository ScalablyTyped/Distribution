...
trait ASPxClientCheckBoxList extends ASPxClientCheckListBase {
  ...
  /**
    ...
    */
  def SelectValues(values: js.Array[js.Object]): Unit
  /**
  ...
  /**
    ...
    * @param values An array of Object[] objects that are the item values.
    */
  def UnselectValues(values: js.Array[js.Object]): Unit
}
...
object ASPxClientCheckBoxList {
  ...
  def apply(
    ...
    SelectValues: js.Array[js.Object] => Unit,
    ...
    UnselectValues: js.Array[js.Object] => Unit,
    Validate: () => Unit,
