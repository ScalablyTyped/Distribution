...
trait ASPxClientHtmlEditorStatic extends ASPxClientControlStatic {
  /**
    ...
    */
  def CustomDialogComplete(status: js.Object, data: js.Object): Unit = js.native
  /**
    * Highlights the text.
    ...
    */
  def HighlightText(text: String, searchContainer: js.Object): Unit = js.native
  /**
    ...
    */
  def HighlightText(text: String, searchContainer: js.Object, className: String): Unit = js.native
  /**
    ...
    */
  def HighlightText(text: String, searchContainer: js.Object, color: String, backgroundColor: String): Unit = js.native
}
