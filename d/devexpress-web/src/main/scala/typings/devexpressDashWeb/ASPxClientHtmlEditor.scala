...
trait ASPxClientHtmlEditor extends ASPxClientControl {
  ...
  /**
    ...
    */
  def ExecuteCommand(commandName: String, parameter: js.Object, addToUndoHistory: Boolean): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def ReplacePlaceholders(html: String, placeholders: js.Array[js.Object]): String = js.native
  /**
