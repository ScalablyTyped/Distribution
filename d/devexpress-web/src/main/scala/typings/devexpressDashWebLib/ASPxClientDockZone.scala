...
trait ASPxClientDockZone extends ASPxClientControl {
  ...
  /**
       ...
       */
  var zoneUID: java.lang.String = js.native
  /**
       * Gets a value that indicates whether the zone can enlarge its size.
       */
  def GetAllowGrowing(): scala.Boolean = js.native
  /**
  ...
  /**
       ...
       */
  def GetPanelByVisibleIndex(visibleIndex: scala.Double): ASPxClientDockPanel = js.native
  /**
       * Gets the number of panels contained in the zone.
       */
  def GetPanelCount(): scala.Double = js.native
  /**
