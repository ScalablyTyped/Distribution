...
trait ASPxClientUploadControl extends ASPxClientControl {
  ...
  /**
       ...
       */
  def AddFileInput(): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def GetAddButtonText(): java.lang.String = js.native
  /**
  ...
  /**
       ...
       */
  def GetFileInputCount(): scala.Double = js.native
  /**
       ...
       */
  def GetSelectedFiles(inputIndex: scala.Double): js.Array[ASPxClientUploadControlFile] = js.native
  /**
  ...
  /**
       ...
       */
  def GetUploadButtonText(): java.lang.String = js.native
  /**
       * Specifies whether the upload control's Advanced mode is enabled.
       */
  def IsAdvancedModeEnabled(): scala.Boolean = js.native
  /**
       ...
       */
  def RemoveFileFromSelection(fileIndex: scala.Double): scala.Unit = js.native
  /**
       ...
       */
  def RemoveFileFromSelection(file: ASPxClientUploadControlFile): scala.Unit = js.native
  /**
       ...
       */
  def RemoveFileInput(index: scala.Double): scala.Unit = js.native
  /**
       ...
       */
  def SetAddButtonText(text: java.lang.String): scala.Unit = js.native
  /**
       ...
       */
  def SetDialogTriggerID(ids: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def SetFileInputCount(count: scala.Double): scala.Unit = js.native
  /**
       * Sets the text to be displayed within the upload button.
       * @param text A string value specifying the text to be displayed within the button.
       */
  def SetUploadButtonText(text: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def UploadFile(): scala.Unit = js.native
}
