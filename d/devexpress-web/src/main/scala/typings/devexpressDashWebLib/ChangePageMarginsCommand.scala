...
trait ChangePageMarginsCommand extends CommandBase {
  /**
       ...
       */
  def execute(left: scala.Double, top: scala.Double, right: scala.Double, bottom: scala.Double): scala.Boolean = js.native
  /**
       ...
       */
  def execute(margins: Margins): scala.Boolean = js.native
  /**
