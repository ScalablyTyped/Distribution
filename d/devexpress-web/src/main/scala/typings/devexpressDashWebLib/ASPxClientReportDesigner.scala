...
trait ASPxClientReportDesigner extends ASPxClientControl {
  ...
  /**
       ...
       */
  def AddParameterType(parameterInfo: ASPxDesignerParameterType, editorOptions: ASPxDesignerEditorOptions): scala.Unit = js.native
  /**
       ...
       */
  def AddToPropertyGrid(groupName: java.lang.String, property: ASPxDesignerElementSerializationInfo): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def GetJsonReportModel(): java.lang.String = js.native
  /**
       ...
       */
  def GetParameterEditor(parameterType: java.lang.String): ASPxDesignerEditorOptions = js.native
  /**
       * Returns an object that contains information on the specified parameter type.
       * @param parameterType A string that specifies a parameter type.
       */
  def GetParameterInfo(parameterType: java.lang.String): ASPxDesignerParameterType = js.native
  /**
  ...
  /**
       ...
       */
  def GetPropertyInfo(controlType: java.lang.String, path: java.lang.String): ASPxDesignerElementSerializationInfo = js.native
  /**
  ...
  /**
       ...
       */
  def OpenReport(url: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def RemoveParameterType(parameterType: java.lang.String): scala.Unit = js.native
  /**
       ...
       */
  def ReportStorageGetData(url: java.lang.String): js.Any = js.native
  /**
  ...
  /**
       ...
       */
  def ReportStorageSetData(reportLayout: java.lang.String, url: java.lang.String): js.Any = js.native
  /**
       * Stores the specified report to a report storage using a new URL.
       * @param reportLayout A string that specifies the report layout to be saved.
       * @param url A string that specifies the default report URL.
       */
  def ReportStorageSetNewData(reportLayout: java.lang.String, url: java.lang.String): js.Any = js.native
  /**
  ...
  /**
       ...
       */
  def SaveNewReport(reportName: java.lang.String): js.Any = js.native
  /**
