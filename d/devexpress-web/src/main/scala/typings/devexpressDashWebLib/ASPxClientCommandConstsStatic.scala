...
object ASPxClientCommandConstsStatic {
  ...
  def apply(
    ...
    __obj.updateDynamic("APPLYCSS_COMMAND")(APPLYCSS_COMMAND)
    __obj.updateDynamic("BACKCOLOR_COMMAND")(BACKCOLOR_COMMAND)
    __obj.updateDynamic("BOLD_COMMAND")(BOLD_COMMAND)
    __obj.updateDynamic("CHANGEAUDIO_COMMAND")(CHANGEAUDIO_COMMAND)
    __obj.updateDynamic("CHANGEAUDIO_DIALOG_COMMAND")(CHANGEAUDIO_DIALOG_COMMAND)
    __obj.updateDynamic("CHANGEELEMENTPROPERTIES_COMMAND")(CHANGEELEMENTPROPERTIES_COMMAND)
    __obj.updateDynamic("CHANGEELEMENTPROPERTIES_DIALOG_COMMAND")(CHANGEELEMENTPROPERTIES_DIALOG_COMMAND)
    __obj.updateDynamic("CHANGEFLASH_COMMAND")(CHANGEFLASH_COMMAND)
    __obj.updateDynamic("CHANGEFLASH_DIALOG_COMMAND")(CHANGEFLASH_DIALOG_COMMAND)
    __obj.updateDynamic("CHANGEIMAGE_COMMAND")(CHANGEIMAGE_COMMAND)
    __obj.updateDynamic("CHANGEIMAGE_DIALOG_COMMAND")(CHANGEIMAGE_DIALOG_COMMAND)
    __obj.updateDynamic("CHANGELINK_DIALOG_COMMAND")(CHANGELINK_DIALOG_COMMAND)
    __obj.updateDynamic("CHANGEPLACEHOLDER_COMMAND")(CHANGEPLACEHOLDER_COMMAND)
    __obj.updateDynamic("CHANGEPLACEHOLDER_DIALOG_COMMAND")(CHANGEPLACEHOLDER_DIALOG_COMMAND)
    __obj.updateDynamic("CHANGETABLECELL_COMMAND")(CHANGETABLECELL_COMMAND)
    __obj.updateDynamic("CHANGETABLECOLUMN_COMMAND")(CHANGETABLECOLUMN_COMMAND)
    __obj.updateDynamic("CHANGETABLEROW_COMMAND")(CHANGETABLEROW_COMMAND)
    __obj.updateDynamic("CHANGETABLE_COMMAND")(CHANGETABLE_COMMAND)
    __obj.updateDynamic("CHANGEVIDEO_COMMAND")(CHANGEVIDEO_COMMAND)
    __obj.updateDynamic("CHANGEVIDEO_DIALOG_COMMAND")(CHANGEVIDEO_DIALOG_COMMAND)
    __obj.updateDynamic("CHANGEYOUTUBEVIDEO_COMMAND")(CHANGEYOUTUBEVIDEO_COMMAND)
    __obj.updateDynamic("CHANGEYOUTUBEVIDEO_DIALOG_COMMAND")(CHANGEYOUTUBEVIDEO_DIALOG_COMMAND)
    __obj.updateDynamic("CHECKSPELLING_COMMAND")(CHECKSPELLING_COMMAND)
    __obj.updateDynamic("COLLAPSETAG_COMMAND")(COLLAPSETAG_COMMAND)
    __obj.updateDynamic("COMMENT_COMMAND")(COMMENT_COMMAND)
    __obj.updateDynamic("CONTINUEORDEREDLIST_COMMAND")(CONTINUEORDEREDLIST_COMMAND)
    __obj.updateDynamic("COPY_COMMAND")(COPY_COMMAND)
    __obj.updateDynamic("CUSTOMDIALOG_COMMAND")(CUSTOMDIALOG_COMMAND)
    __obj.updateDynamic("CUT_COMMAND")(CUT_COMMAND)
    __obj.updateDynamic("DELETETABLECOLUMN_COMMAND")(DELETETABLECOLUMN_COMMAND)
    __obj.updateDynamic("DELETETABLEROW_COMMAND")(DELETETABLEROW_COMMAND)
    __obj.updateDynamic("DELETETABLE_COMMAND")(DELETETABLE_COMMAND)
    __obj.updateDynamic("DELETE_COMMAND")(DELETE_COMMAND)
    __obj.updateDynamic("EXPANDTAG_COMMAND")(EXPANDTAG_COMMAND)
    __obj.updateDynamic("EXPORT_COMMAND")(EXPORT_COMMAND)
    __obj.updateDynamic("FINDANDREPLACE_DIALOG_COMMAND")(FINDANDREPLACE_DIALOG_COMMAND)
    __obj.updateDynamic("FONTCOLOR_COMMAND")(FONTCOLOR_COMMAND)
    __obj.updateDynamic("FONTNAME_COMMAND")(FONTNAME_COMMAND)
    __obj.updateDynamic("FONTSIZE_COMMAND")(FONTSIZE_COMMAND)
    __obj.updateDynamic("FORMATBLOCK_COMMAND")(FORMATBLOCK_COMMAND)
    __obj.updateDynamic("FORMATDOCUMENT_COMMAND")(FORMATDOCUMENT_COMMAND)
    __obj.updateDynamic("FULLSCREEN_COMMAND")(FULLSCREEN_COMMAND)
    __obj.updateDynamic("INDENTLINE_COMMAND")(INDENTLINE_COMMAND)
    __obj.updateDynamic("INDENT_COMMAND")(INDENT_COMMAND)
    __obj.updateDynamic("INSERTAUDIO_COMMAND")(INSERTAUDIO_COMMAND)
    __obj.updateDynamic("INSERTAUDIO_DIALOG_COMMAND")(INSERTAUDIO_DIALOG_COMMAND)
    __obj.updateDynamic("INSERTFLASH_COMMAND")(INSERTFLASH_COMMAND)
    __obj.updateDynamic("INSERTFLASH_DIALOG_COMMAND")(INSERTFLASH_DIALOG_COMMAND)
    __obj.updateDynamic("INSERTIMAGE_COMMAND")(INSERTIMAGE_COMMAND)
    __obj.updateDynamic("INSERTIMAGE_DIALOG_COMMAND")(INSERTIMAGE_DIALOG_COMMAND)
    __obj.updateDynamic("INSERTLINK_COMMAND")(INSERTLINK_COMMAND)
    __obj.updateDynamic("INSERTLINK_DIALOG_COMMAND")(INSERTLINK_DIALOG_COMMAND)
    __obj.updateDynamic("INSERTORDEREDLIST_COMMAND")(INSERTORDEREDLIST_COMMAND)
    __obj.updateDynamic("INSERTPLACEHOLDER_COMMAND")(INSERTPLACEHOLDER_COMMAND)
    __obj.updateDynamic("INSERTPLACEHOLDER_DIALOG_COMMAND")(INSERTPLACEHOLDER_DIALOG_COMMAND)
    __obj.updateDynamic("INSERTTABLECOLUMNTOLEFT_COMMAND")(INSERTTABLECOLUMNTOLEFT_COMMAND)
    __obj.updateDynamic("INSERTTABLECOLUMNTORIGHT_COMMAND")(INSERTTABLECOLUMNTORIGHT_COMMAND)
    __obj.updateDynamic("INSERTTABLEROWABOVE_COMMAND")(INSERTTABLEROWABOVE_COMMAND)
    __obj.updateDynamic("INSERTTABLEROWBELOW_COMMAND")(INSERTTABLEROWBELOW_COMMAND)
    __obj.updateDynamic("INSERTTABLE_COMMAND")(INSERTTABLE_COMMAND)
    __obj.updateDynamic("INSERTTABLE_DIALOG_COMMAND")(INSERTTABLE_DIALOG_COMMAND)
    __obj.updateDynamic("INSERTUNORDEREDLIST_COMMAND")(INSERTUNORDEREDLIST_COMMAND)
    __obj.updateDynamic("INSERTVIDEO_COMMAND")(INSERTVIDEO_COMMAND)
    __obj.updateDynamic("INSERTVIDEO_DIALOG_COMMAND")(INSERTVIDEO_DIALOG_COMMAND)
    __obj.updateDynamic("INSERTYOUTUBEVIDEO_COMMAND")(INSERTYOUTUBEVIDEO_COMMAND)
    __obj.updateDynamic("INSERTYOUTUBEVIDEO_DIALOG_COMMAND")(INSERTYOUTUBEVIDEO_DIALOG_COMMAND)
    __obj.updateDynamic("ITALIC_COMMAND")(ITALIC_COMMAND)
    __obj.updateDynamic("JUSTIFYCENTER_COMMAND")(JUSTIFYCENTER_COMMAND)
    __obj.updateDynamic("JUSTIFYFULL_COMMAND")(JUSTIFYFULL_COMMAND)
    __obj.updateDynamic("JUSTIFYLEFT_COMMAND")(JUSTIFYLEFT_COMMAND)
    __obj.updateDynamic("JUSTIFYRIGHT_COMMAND")(JUSTIFYRIGHT_COMMAND)
    __obj.updateDynamic("MERGETABLECELLDOWN_COMMAND")(MERGETABLECELLDOWN_COMMAND)
    __obj.updateDynamic("MERGETABLECELLRIGHT_COMMAND")(MERGETABLECELLRIGHT_COMMAND)
    __obj.updateDynamic("OUTDENTLINE_COMMAND")(OUTDENTLINE_COMMAND)
    __obj.updateDynamic("OUTDENT_COMMAND")(OUTDENT_COMMAND)
    __obj.updateDynamic("PASTEFROMWORDDIALOG_COMMAND")(PASTEFROMWORDDIALOG_COMMAND)
    __obj.updateDynamic("PASTEFROMWORD_COMMAND")(PASTEFROMWORD_COMMAND)
    __obj.updateDynamic("PASTEHTMLMERGEFORMATTING_COMMAND")(PASTEHTMLMERGEFORMATTING_COMMAND)
    __obj.updateDynamic("PASTEHTMLPLAINTEXT_COMMAND")(PASTEHTMLPLAINTEXT_COMMAND)
    __obj.updateDynamic("PASTEHTMLSOURCEFORMATTING_COMMAND")(PASTEHTMLSOURCEFORMATTING_COMMAND)
    __obj.updateDynamic("PASTEHTML_COMMAND")(PASTEHTML_COMMAND)
    __obj.updateDynamic("PASTE_COMMAND")(PASTE_COMMAND)
    __obj.updateDynamic("PRINT_COMMAND")(PRINT_COMMAND)
    __obj.updateDynamic("REDO_COMMAND")(REDO_COMMAND)
    __obj.updateDynamic("REMOVEFORMAT_COMMAND")(REMOVEFORMAT_COMMAND)
    __obj.updateDynamic("RESTARTORDEREDLIST_COMMAND")(RESTARTORDEREDLIST_COMMAND)
    __obj.updateDynamic("SELECT_ALL")(SELECT_ALL)
    __obj.updateDynamic("SHOWINTELLISENSE_COMMAND")(SHOWINTELLISENSE_COMMAND)
    __obj.updateDynamic("SHOWSEARCHPANEL_COMMAND")(SHOWSEARCHPANEL_COMMAND)
    __obj.updateDynamic("SPLITTABLECELLHORIZONTALLY_COMMAND")(SPLITTABLECELLHORIZONTALLY_COMMAND)
    __obj.updateDynamic("SPLITTABLECELLVERTICALLY_COMMAND")(SPLITTABLECELLVERTICALLY_COMMAND)
    __obj.updateDynamic("STRIKETHROUGH_COMMAND")(STRIKETHROUGH_COMMAND)
    __obj.updateDynamic("SUBSCRIPT_COMMAND")(SUBSCRIPT_COMMAND)
    __obj.updateDynamic("SUPERSCRIPT_COMMAND")(SUPERSCRIPT_COMMAND)
    __obj.updateDynamic("TABLECELLPROPERTIES_DIALOG_COMMAND")(TABLECELLPROPERTIES_DIALOG_COMMAND)
    __obj.updateDynamic("TABLECOLUMNPROPERTIES_DIALOG_COMMAND")(TABLECOLUMNPROPERTIES_DIALOG_COMMAND)
    __obj.updateDynamic("TABLEPROPERTIES_DIALOG_COMMAND")(TABLEPROPERTIES_DIALOG_COMMAND)
    __obj.updateDynamic("TABLEROWPROPERTIES_DIALOG_COMMAND")(TABLEROWPROPERTIES_DIALOG_COMMAND)
    __obj.updateDynamic("UNCOMMENTHTML_COMMAND")(UNCOMMENTHTML_COMMAND)
    __obj.updateDynamic("UNDERLINE_COMMAND")(UNDERLINE_COMMAND)
    __obj.updateDynamic("UNDO_COMMAND")(UNDO_COMMAND)
    __obj.updateDynamic("UNLINK_COMMAND")(UNLINK_COMMAND)
    __obj.updateDynamic("UPDATEDOCUMENT_COMMAND")(UPDATEDOCUMENT_COMMAND)
