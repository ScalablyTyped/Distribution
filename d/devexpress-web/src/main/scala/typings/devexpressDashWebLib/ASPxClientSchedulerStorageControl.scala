...
trait ASPxClientSchedulerStorageControl extends ASPxClientControl {
  ...
  /**
       ...
       */
  def DeleteAppointment(appointment: ASPxClientAppointment): scala.Unit = js.native
  /**
       * Dismisses all reminders.
       */
  def DismissAllReminders(): scala.Unit = js.native
  /**
       ...
       */
  def GetAppointmentById(onSuccess: js.Function1[/* arg1 */ java.lang.String, scala.Unit], appointmentId: java.lang.String): scala.Unit = js.native
  /**
       ...
       */
  def GetAppointments(onSuccess: js.Function1[/* arg1 */ java.lang.String, scala.Unit], interval: ASPxClientTimeInterval): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def GetResourceById(onSuccess: js.Function1[/* arg1 */ java.lang.String, scala.Unit], resourceId: java.lang.String): scala.Unit = js.native
  /**
       ...
       */
  def GetResources(onSuccess: js.Function1[/* arg1 */ java.lang.String, scala.Unit]): scala.Unit = js.native
  /**
       * Client-side scripting method to insert the specified appointment.
       * @param appointment An ASPxClientAppointment object representing the client-side appointment.
       */
  def InsertAppointment(appointment: ASPxClientAppointment): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def SnoozeAllReminders(): scala.Unit = js.native
  /**
       * Client-side scripting method to update the specified appointment.
       * @param appointment An ASPxClientAppointment object representing the client-side appointment.
       */
  def UpdateAppointment(appointment: ASPxClientAppointment): scala.Unit = js.native
}
