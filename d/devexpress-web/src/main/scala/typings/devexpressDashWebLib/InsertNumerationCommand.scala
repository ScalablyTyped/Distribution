...
trait InsertNumerationCommand extends CommandWithSimpleStateBase {
  /**
       ...
       */
  def execute(abstractNumberingListIndex: scala.Double): scala.Boolean = js.native
  /**
       ...
       */
  def execute(numberingListIndex: scala.Double, isAbstractNumberingList: scala.Boolean): scala.Boolean = js.native
}
