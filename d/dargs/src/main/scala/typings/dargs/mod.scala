  ...
  */
  ...
  object Options {
    ...
    implicit class OptionsMutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExcludes(value: js.Array[String | RegExp]): Self = StObject.set(x, "excludes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExcludesUndefined: Self = StObject.set(x, "excludes", js.undefined)
      
      @scala.inline
      def setExcludesVarargs(value: (String | RegExp)*): Self = StObject.set(x, "excludes", js.Array(value :_*))
      ...
      @scala.inline
      def setIncludes(value: js.Array[String | RegExp]): Self = StObject.set(x, "includes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIncludesUndefined: Self = StObject.set(x, "includes", js.undefined)
      
      @scala.inline
      def setIncludesVarargs(value: (String | RegExp)*): Self = StObject.set(x, "includes", js.Array(value :_*))
