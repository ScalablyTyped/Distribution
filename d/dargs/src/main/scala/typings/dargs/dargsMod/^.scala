package typings.dargs.dargsMod

import typings.dargs.Anon_
...
object ^ extends js.Object {
  ...
  ```
  */
  def apply(`object`: Anon_): js.Array[String] = js.native
  def apply(`object`: Anon_, options: Options): js.Array[String] = js.native
}
