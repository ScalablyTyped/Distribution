...
object libEsmMod {
  ...
  object ElementType extends StObject {
    ...
    sealed trait CDATA
      extends StObject
         with ElementType
    /* "cdata" */ val CDATA: typings.domelementtype.libEsmMod.ElementType.CDATA & String = js.native
    ...
    sealed trait Comment
      extends StObject
         with ElementType
    /* "comment" */ val Comment: typings.domelementtype.libEsmMod.ElementType.Comment & String = js.native
    ...
    sealed trait Directive
      extends StObject
         with ElementType
    /* "directive" */ val Directive: typings.domelementtype.libEsmMod.ElementType.Directive & String = js.native
    ...
    sealed trait Doctype
      extends StObject
         with ElementType
    /* "doctype" */ val Doctype: typings.domelementtype.libEsmMod.ElementType.Doctype & String = js.native
    ...
    sealed trait Root
      extends StObject
         with ElementType
    /* "root" */ val Root: typings.domelementtype.libEsmMod.ElementType.Root & String = js.native
    ...
    sealed trait Script
      extends StObject
         with ElementType
    /* "script" */ val Script: typings.domelementtype.libEsmMod.ElementType.Script & String = js.native
    ...
    sealed trait Style
      extends StObject
         with ElementType
    /* "style" */ val Style: typings.domelementtype.libEsmMod.ElementType.Style & String = js.native
    ...
    sealed trait Tag
      extends StObject
         with ElementType
    /* "tag" */ val Tag: typings.domelementtype.libEsmMod.ElementType.Tag & String = js.native
    ...
    sealed trait Text
      extends StObject
         with ElementType
    /* "text" */ val Text: typings.domelementtype.libEsmMod.ElementType.Text & String = js.native
  }
