...
class BootstrapBinaryImage () extends BootstrapClientEdit {
  ...
  def getUploadedFileName(): java.lang.String = js.native
  @JSName("off")
  ...
  @JSName("off")
  def off_click(
    eventName: devexpressDashAspnetcoreDashBootstrapLib.devexpressDashAspnetcoreDashBootstrapLibStrings.click
  ): this.type = js.native
  @JSName("off")
  def off_click(
    eventName: devexpressDashAspnetcoreDashBootstrapLib.devexpressDashAspnetcoreDashBootstrapLibStrings.click,
    callback: js.ThisFunction1[/* this */ this.type, /* args */ js.UndefOr[EditClickEventArgs], scala.Unit]
  ): this.type = js.native
  @JSName("off")
  def off_endCallback(
