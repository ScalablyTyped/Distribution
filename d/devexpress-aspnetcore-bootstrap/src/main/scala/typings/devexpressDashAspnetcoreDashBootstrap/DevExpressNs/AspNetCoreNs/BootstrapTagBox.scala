...
import typings.devexpressDashAspnetcoreDashBootstrap.devexpressDashAspnetcoreDashBootstrapStrings.customHighlighting
...
import typings.devexpressDashAspnetcoreDashBootstrap.devexpressDashAspnetcoreDashBootstrapStrings.itemFiltering
...
import typings.devexpressDashAspnetcoreDashBootstrap.devexpressDashAspnetcoreDashBootstrapStrings.selectedIndexChanged
import typings.devexpressDashAspnetcoreDashBootstrap.devexpressDashAspnetcoreDashBootstrapStrings.tagsChanged
...
class BootstrapTagBox () extends BootstrapClientEdit {
  ...
  @JSName("off")
  def off_tagsChanged(eventName: tagsChanged): this.type = js.native
  @JSName("off")
  def off_tagsChanged(
