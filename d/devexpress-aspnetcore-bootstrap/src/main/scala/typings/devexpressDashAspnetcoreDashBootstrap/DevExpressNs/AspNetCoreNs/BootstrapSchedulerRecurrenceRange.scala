...
object BootstrapSchedulerRecurrenceRange extends js.Object {
  ...
  /* "EndByDate" */ val EndByDate: typings.devexpressDashAspnetcoreDashBootstrap.DevExpressNs.AspNetCoreNs.BootstrapSchedulerRecurrenceRange.EndByDate with String = js.native
  /* "NoEndDate" */ val NoEndDate: typings.devexpressDashAspnetcoreDashBootstrap.DevExpressNs.AspNetCoreNs.BootstrapSchedulerRecurrenceRange.NoEndDate with String = js.native
  /* "OccurrenceCount" */ val OccurrenceCount: typings.devexpressDashAspnetcoreDashBootstrap.DevExpressNs.AspNetCoreNs.BootstrapSchedulerRecurrenceRange.OccurrenceCount with String = js.native
  @JSBracketAccess
