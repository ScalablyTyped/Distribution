...
@js.native
open class BootstrapSchedulerAppointmentDragInfo protected ()
  extends StObject
     with typings.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapSchedulerAppointmentDragInfo {
