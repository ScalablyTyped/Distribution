...
class BootstrapTab protected ()
  extends typings.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapTab {
  ...
  /* CompleteClass */
  override val tabControl: typings.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapTabControl | Null = js.native
  /* CompleteClass */
