...
class BootstrapTimeInterval protected ()
  ...
  /* CompleteClass */
  override def equals(interval: typings.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapTimeInterval): Boolean = js.native
  ...
  /* CompleteClass */
  override def intersectsWithExcludingBounds(interval: typings.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapTimeInterval): Boolean = js.native
