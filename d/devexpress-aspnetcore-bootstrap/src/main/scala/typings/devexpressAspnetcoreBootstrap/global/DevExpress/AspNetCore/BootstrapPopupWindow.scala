...
class BootstrapPopupWindow protected ()
  extends typings.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapPopupWindow {
  ...
  /* CompleteClass */
  override val popupControl: typings.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapPopupControl | Null = js.native
  /* CompleteClass */
