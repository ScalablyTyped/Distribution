...
@js.native
open class BootstrapAccordionItem protected ()
  extends StObject
  ...
  /* CompleteClass */
  override val group: typings.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapAccordionGroup | Null = js.native
