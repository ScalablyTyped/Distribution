...
object BootstrapChartZoomEndEventArgs {
  ...
  inline def apply(component: js.Any, element: js.Any, rangeEnd: js.Any, rangeStart: js.Any, sender: Control): BootstrapChartZoomEndEventArgs = {
  ...
  extension [Self <: BootstrapChartZoomEndEventArgs](x: Self) {
    ...
    inline def setRangeEnd(value: js.Any): Self = StObject.set(x, "rangeEnd", value.asInstanceOf[js.Any])
    
    inline def setRangeStart(value: js.Any): Self = StObject.set(x, "rangeStart", value.asInstanceOf[js.Any])
  }
}
