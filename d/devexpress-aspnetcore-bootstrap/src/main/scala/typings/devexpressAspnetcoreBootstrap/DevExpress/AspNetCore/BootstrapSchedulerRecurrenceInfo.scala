...
object BootstrapSchedulerRecurrenceInfo {
  ...
  extension [Self <: BootstrapSchedulerRecurrenceInfo](x: Self) {
    ...
    inline def setGetRange(value: () => BootstrapSchedulerRecurrenceRange): Self = StObject.set(x, "getRange", js.Any.fromFunction0(value))
    ...
    inline def setSetRange(value: BootstrapSchedulerRecurrenceRange => Unit): Self = StObject.set(x, "setRange", js.Any.fromFunction1(value))
    ...
    inline def setSetWeekOfMonth(value: WeekOfMonth => Unit): Self = StObject.set(x, "setWeekOfMonth", js.Any.fromFunction1(value))
  }
}
