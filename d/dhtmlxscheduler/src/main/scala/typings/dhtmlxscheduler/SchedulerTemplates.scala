...
trait SchedulerTemplates extends StObject {
  ...
  /**
    ...
    */
  def timeline_cell_class(evs: js.Array[js.Any], date: Date, section: js.Any): String
  ...
  /**
    ...
    */
  def timeline_cell_value(evs: js.Array[js.Any], date: Date): String
...
object SchedulerTemplates {
  ...
  def apply(
    ...
    time_picker: () => String,
    timeline_cell_class: (js.Array[js.Any], Date, js.Any) => String,
    timeline_cell_value: (js.Array[js.Any], Date) => String,
