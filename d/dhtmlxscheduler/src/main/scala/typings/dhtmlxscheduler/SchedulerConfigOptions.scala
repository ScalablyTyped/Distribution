...
object SchedulerConfigOptions {
  ...
  implicit class SchedulerConfigOptionsMutableBuilder[Self <: SchedulerConfigOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIcons_edit(value: js.Array[_]): Self = StObject.set(x, "icons_edit", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIcons_editVarargs(value: js.Any*): Self = StObject.set(x, "icons_edit", js.Array(value :_*))
    
    @scala.inline
    def setIcons_select(value: js.Array[_]): Self = StObject.set(x, "icons_select", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRecurring_workdays(value: js.Array[_]): Self = StObject.set(x, "recurring_workdays", value.asInstanceOf[js.Any])
