...
package object mod {
  ...
  @scala.inline
  def canonicalize(obj: js.Any, stack: js.Array[_], replacementStack: js.Array[_]): js.Any = (typings.diff.mod.^.asInstanceOf[js.Dynamic].applyDynamic("canonicalize")(obj.asInstanceOf[js.Any], stack.asInstanceOf[js.Any], replacementStack.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  def diffChars(
    oldStr: java.lang.String,
    newStr: java.lang.String,
    options: typings.diff.mod.BaseOptions with typings.diff.mod.CallbackOptions
  ...
  def diffJson(
    ...
    options: typings.diff.mod.JsonOptions with typings.diff.mod.CallbackOptions
  ...
  @scala.inline
  def diffJson_Array(oldObj: java.lang.String, newObj: js.Object, options: typings.diff.mod.JsonOptions): js.Array[typings.diff.mod.Change] = (typings.diff.mod.^.asInstanceOf[js.Dynamic].applyDynamic("diffJson")(oldObj.asInstanceOf[js.Any], newObj.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.diff.mod.Change]]
  @scala.inline
  def diffJson_Array(oldObj: js.Object, newObj: java.lang.String, options: typings.diff.mod.JsonOptions): js.Array[typings.diff.mod.Change] = (typings.diff.mod.^.asInstanceOf[js.Dynamic].applyDynamic("diffJson")(oldObj.asInstanceOf[js.Any], newObj.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.diff.mod.Change]]
  @scala.inline
  def diffJson_Array(oldObj: js.Object, newObj: js.Object, options: typings.diff.mod.JsonOptions): js.Array[typings.diff.mod.Change] = (typings.diff.mod.^.asInstanceOf[js.Dynamic].applyDynamic("diffJson")(oldObj.asInstanceOf[js.Any], newObj.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.diff.mod.Change]]
  ...
  def diffLines(
    oldStr: java.lang.String,
    newStr: java.lang.String,
    options: typings.diff.mod.LinesOptions with typings.diff.mod.CallbackOptions
  ...
  @scala.inline
  def diffLines_Array(oldStr: java.lang.String, newStr: java.lang.String, options: typings.diff.mod.LinesOptions): js.Array[typings.diff.mod.Change] = (typings.diff.mod.^.asInstanceOf[js.Dynamic].applyDynamic("diffLines")(oldStr.asInstanceOf[js.Any], newStr.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.diff.mod.Change]]
  ...
  @scala.inline
  def diffTrimmedLines_Array(oldStr: java.lang.String, newStr: java.lang.String, options: typings.diff.mod.LinesOptions): js.Array[typings.diff.mod.Change] = (typings.diff.mod.^.asInstanceOf[js.Dynamic].applyDynamic("diffTrimmedLines")(oldStr.asInstanceOf[js.Any], newStr.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.diff.mod.Change]]
  ...
  def diffWords(
    oldStr: java.lang.String,
    newStr: java.lang.String,
    options: typings.diff.mod.WordsOptions with typings.diff.mod.CallbackOptions
