...
object fnmatchDTsMod {
  ...
  @JSImport(".editorconfig-Lg6IaxjZ/src/lib/fnmatch.d.ts", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport(".editorconfig-Lg6IaxjZ/src/lib/fnmatch.d.ts", "Minimatch")
  @js.native
