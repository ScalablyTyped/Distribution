...
import typings.gitlabNBHG3ede.deploymentsDTsMod.DeploymentSchema
...
object environmentsDTsMod {
  
  @JSImport(".gitlab-nBHG3ede/dist/types/core/services/Environments.d.ts", "Environments")
  @js.native
