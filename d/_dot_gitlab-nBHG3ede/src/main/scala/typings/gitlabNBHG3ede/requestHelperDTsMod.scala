...
import typings.gitlabNBHG3ede.baseServiceDTsMod.BaseService
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object requestHelperDTsMod {
  
  object RequestHelper {
    
    @JSImport(".gitlab-nBHG3ede/dist/types/core/infrastructure/RequestHelper.d.ts", "RequestHelper")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport(".gitlab-nBHG3ede/dist/types/core/infrastructure/RequestHelper.d.ts", "RequestHelper.del")
    @js.native
    ...
    @JSImport(".gitlab-nBHG3ede/dist/types/core/infrastructure/RequestHelper.d.ts", "RequestHelper.get")
    @js.native
    ...
    @JSImport(".gitlab-nBHG3ede/dist/types/core/infrastructure/RequestHelper.d.ts", "RequestHelper.post")
    @js.native
    ...
    @JSImport(".gitlab-nBHG3ede/dist/types/core/infrastructure/RequestHelper.d.ts", "RequestHelper.put")
    @js.native
    ...
    @JSImport(".gitlab-nBHG3ede/dist/types/core/infrastructure/RequestHelper.d.ts", "RequestHelper.stream")
    @js.native
