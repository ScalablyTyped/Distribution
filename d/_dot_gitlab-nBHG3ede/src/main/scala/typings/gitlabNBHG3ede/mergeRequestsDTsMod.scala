...
import typings.gitlabNBHG3ede.anon.mergerequestIIdnumberunde
import typings.gitlabNBHG3ede.anon.projectIdstringnumberPagi
import typings.gitlabNBHG3ede.anon.shastringundefinedBaseReq
import typings.gitlabNBHG3ede.baseServiceDTsMod.BaseServiceOptions
import typings.gitlabNBHG3ede.gitlabNBHG3edeBooleans.`true`
...
object mergeRequestsDTsMod {
  
  @JSImport(".gitlab-nBHG3ede/dist/types/core/services/MergeRequests.d.ts", "MergeRequests")
  @js.native
