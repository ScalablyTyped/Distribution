...
/* Inlined {  groupId :string | number} & {  level :.gitlab-nBHG3ede..gitlab-nBHG3ede/dist/types/core/services/NotificationSettings.d.ts.NotificationSettingLevel | undefined} & .gitlab-nBHG3ede..gitlab-nBHG3ede/dist/types/core/infrastructure/index.d.ts.BaseRequestOptions */
