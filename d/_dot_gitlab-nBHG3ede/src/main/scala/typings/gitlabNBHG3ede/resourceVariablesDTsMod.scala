...
import typings.gitlabNBHG3ede.gitlabNBHG3edeStrings.env_var
import typings.gitlabNBHG3ede.gitlabNBHG3edeStrings.file
...
object resourceVariablesDTsMod {
  
  @JSImport(".gitlab-nBHG3ede/dist/types/core/templates/ResourceVariables.d.ts", "ResourceVariables")
  @js.native
