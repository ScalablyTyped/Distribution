...
/* Inlined std.Omit<.highlight.js-Y75vKsj1.Mode, 'contains'> & {  contains :std.Array<.highlight.js-Y75vKsj1.CompiledMode>,   keywords :.highlight.js-Y75vKsj1.KeywordDict,   data :std.Record<string, any>,   terminatorEnd :string,   keywordPatternRe :std.RegExp,   beginRe :std.RegExp,   endRe :std.RegExp,   illegalRe :std.RegExp,   matcher :any,   isCompiled :true,   starts :.highlight.js-Y75vKsj1.CompiledMode | undefined,   parent :.highlight.js-Y75vKsj1.CompiledMode | undefined} */
