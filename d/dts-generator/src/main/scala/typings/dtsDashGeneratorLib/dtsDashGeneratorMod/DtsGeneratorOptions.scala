package typings
package dtsDashGeneratorLib.dtsDashGeneratorMod
...
trait DtsGeneratorOptions extends js.Object {
  ...
  var moduleResolution: js.UndefOr[typescriptLib.typescriptMod.ModuleResolutionKind] = js.undefined
  ...
  var target: js.UndefOr[typescriptLib.typescriptMod.ScriptTarget] = js.undefined
  /**
...
object DtsGeneratorOptions {
  ...
  def apply(
    ...
    moduleResolution: typescriptLib.typescriptMod.ModuleResolutionKind = null,
    ...
    target: typescriptLib.typescriptMod.ScriptTarget = null,
