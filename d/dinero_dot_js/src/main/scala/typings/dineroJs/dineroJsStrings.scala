...
import typings.dineroJs.mod.Currency
import typings.dineroJs.mod.RoundingMode
...
object dineroJsStrings {
  ...
  sealed trait HALF_AWAY_FROM_ZERO
    extends StObject
       with RoundingMode
  inline def HALF_AWAY_FROM_ZERO: HALF_AWAY_FROM_ZERO = "HALF_AWAY_FROM_ZERO".asInstanceOf[HALF_AWAY_FROM_ZERO]
  ...
  sealed trait HALF_ODD
    extends StObject
       with RoundingMode
  inline def HALF_ODD: HALF_ODD = "HALF_ODD".asInstanceOf[HALF_ODD]
  
  @js.native
  sealed trait HALF_TOWARDS_ZERO
    extends StObject
       with RoundingMode
  inline def HALF_TOWARDS_ZERO: HALF_TOWARDS_ZERO = "HALF_TOWARDS_ZERO".asInstanceOf[HALF_TOWARDS_ZERO]
