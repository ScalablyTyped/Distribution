...
object mod {
  ...
  object Distribution {
    ...
    extension [Self <: Distribution](x: Self) {
      ...
      inline def setMean(value: () => Double): Self = StObject.set(x, "mean", js.Any.fromFunction0(value))
      
      inline def setMedian(value: () => Double): Self = StObject.set(x, "median", js.Any.fromFunction0(value))
