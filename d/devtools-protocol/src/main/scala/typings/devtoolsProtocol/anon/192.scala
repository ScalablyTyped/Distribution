...
object `192` {
  ...
  inline def apply(paramsType: js.Array[js.UndefOr[DetachFromTargetRequest]], returnType: Unit): `192` = {
  ...
  extension [Self <: `192`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: js.UndefOr[DetachFromTargetRequest]*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
