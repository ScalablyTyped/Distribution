...
object `29` {
  ...
  inline def apply(paramsType: js.Array[StartObservingRequest], returnType: Unit): `29` = {
  ...
  extension [Self <: `29`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: StartObservingRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
