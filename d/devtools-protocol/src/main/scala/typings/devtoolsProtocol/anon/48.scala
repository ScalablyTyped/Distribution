...
object `48` {
  ...
  inline def apply(paramsType: js.Array[StopCastingRequest], returnType: Unit): `48` = {
  ...
  extension [Self <: `48`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: StopCastingRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
