...
object `132` {
  ...
  implicit class `132Ops`[Self <: `132`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsTypeVarargs(value: js.UndefOr[SetPausedInDebuggerMessageRequest]*): Self = this.set("paramsType", js.Array(value :_*))
    
    @scala.inline
    def setParamsType(value: js.Array[js.UndefOr[SetPausedInDebuggerMessageRequest]]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
