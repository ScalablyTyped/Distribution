...
object `135` {
  ...
  inline def apply(paramsType: js.Array[SetShowGridOverlaysRequest], returnType: Unit): `135` = {
  ...
  extension [Self <: `135`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetShowGridOverlaysRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
