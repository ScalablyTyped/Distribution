...
object `172` {
  ...
  inline def apply(paramsType: js.Array[DispatchSyncEventRequest], returnType: Unit): `172` = {
  ...
  extension [Self <: `172`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: DispatchSyncEventRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
