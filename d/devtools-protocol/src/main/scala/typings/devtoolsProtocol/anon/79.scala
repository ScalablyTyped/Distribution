...
object `79` {
  ...
  implicit class `79Ops`[Self <: `79`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsTypeVarargs(value: SetDocumentCookieDisabledRequest*): Self = this.set("paramsType", js.Array(value :_*))
    
    @scala.inline
    def setParamsType(value: js.Array[SetDocumentCookieDisabledRequest]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
