...
object `52` {
  ...
  inline def apply(paramsType: js.Array[RemoveAttributeRequest], returnType: Unit): `52` = {
  ...
  extension [Self <: `52`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: RemoveAttributeRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
