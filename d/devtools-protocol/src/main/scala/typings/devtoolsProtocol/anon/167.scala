...
object `167` {
  ...
  inline def apply(paramsType: js.Array[SetTimeDomainRequest], returnType: Unit): `167` = {
  ...
  extension [Self <: `167`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetTimeDomainRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
