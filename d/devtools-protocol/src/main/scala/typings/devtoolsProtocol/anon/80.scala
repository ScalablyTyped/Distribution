...
object `80` {
  ...
  inline def apply(paramsType: js.Array[SetEmitTouchEventsForMouseRequest], returnType: Unit): `80` = {
  ...
  extension [Self <: `80`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetEmitTouchEventsForMouseRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
