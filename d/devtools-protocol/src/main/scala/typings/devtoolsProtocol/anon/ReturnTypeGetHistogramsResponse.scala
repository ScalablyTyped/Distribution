...
object ReturnTypeGetHistogramsResponse {
  ...
  extension [Self <: ReturnTypeGetHistogramsResponse](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: js.UndefOr[GetHistogramsRequest]*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
