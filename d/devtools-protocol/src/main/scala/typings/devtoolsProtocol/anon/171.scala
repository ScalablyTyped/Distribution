...
object `171` {
  ...
  inline def apply(paramsType: js.Array[DeliverPushMessageRequest], returnType: Unit): `171` = {
  ...
  extension [Self <: `171`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: DeliverPushMessageRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
