...
object `81` {
  ...
  inline def apply(paramsType: js.Array[js.UndefOr[SetEmulatedMediaRequest]], returnType: Unit): `81` = {
  ...
  extension [Self <: `81`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: js.UndefOr[SetEmulatedMediaRequest]*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
