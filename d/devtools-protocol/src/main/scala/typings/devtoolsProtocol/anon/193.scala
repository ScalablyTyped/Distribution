...
object `193` {
  ...
  inline def apply(paramsType: js.Array[DisposeBrowserContextRequest], returnType: Unit): `193` = {
  ...
  extension [Self <: `193`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: DisposeBrowserContextRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
