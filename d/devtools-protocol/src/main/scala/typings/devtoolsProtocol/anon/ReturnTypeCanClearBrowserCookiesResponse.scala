...
@js.native
trait ReturnTypeCanClearBrowserCookiesResponse extends js.Object {
  var paramsType: js.Array[js.Any] = js.native
  var returnType: CanClearBrowserCookiesResponse = js.native
}
...
object ReturnTypeCanClearBrowserCookiesResponse {
  ...
  @scala.inline
  implicit class ReturnTypeCanClearBrowserCookiesResponseOps[Self <: ReturnTypeCanClearBrowserCookiesResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: CanClearBrowserCookiesResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
