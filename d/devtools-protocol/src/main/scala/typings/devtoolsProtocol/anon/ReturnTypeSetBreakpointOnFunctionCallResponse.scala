...
object ReturnTypeSetBreakpointOnFunctionCallResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ReturnTypeSetBreakpointOnFunctionCallResponse] (val x: Self) extends AnyVal {
    ...
    inline def setParamsTypeVarargs(value: SetBreakpointOnFunctionCallRequest*): Self = StObject.set(x, "paramsType", js.Array(value*))
