...
@js.native
trait ReturnTypeGetBrowserSamplingProfileResponse extends js.Object {
...
object ReturnTypeGetBrowserSamplingProfileResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetBrowserSamplingProfileResponseOps[Self <: ReturnTypeGetBrowserSamplingProfileResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReturnType(value: GetBrowserSamplingProfileResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
}
