...
object `170` {
  ...
  inline def apply(paramsType: js.Array[SetOverrideCertificateErrorsRequest], returnType: Unit): `170` = {
  ...
  extension [Self <: `170`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetOverrideCertificateErrorsRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
