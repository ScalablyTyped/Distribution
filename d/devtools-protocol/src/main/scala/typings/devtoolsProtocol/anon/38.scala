...
object `38` {
  ...
  inline def apply(paramsType: js.Array[js.UndefOr[SetDockTileRequest]], returnType: Unit): `38` = {
  ...
  extension [Self <: `38`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: js.UndefOr[SetDockTileRequest]*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
