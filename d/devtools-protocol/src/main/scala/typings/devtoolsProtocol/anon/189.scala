...
object `189` {
  ...
  inline def apply(paramsType: js.Array[UntrackIndexedDBForOriginRequest], returnType: Unit): `189` = {
  ...
  extension [Self <: `189`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: UntrackIndexedDBForOriginRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
