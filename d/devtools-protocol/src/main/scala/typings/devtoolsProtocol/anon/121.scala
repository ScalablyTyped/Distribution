...
object `121` {
  ...
  implicit class `121MutableBuilder`[Self <: `121`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsType(value: js.Array[SetExtraHTTPHeadersRequest]): Self = StObject.set(x, "paramsType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setParamsTypeVarargs(value: SetExtraHTTPHeadersRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
