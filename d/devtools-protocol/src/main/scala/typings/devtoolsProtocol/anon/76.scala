...
object `76` {
  ...
  inline def apply(paramsType: js.Array[js.UndefOr[SetDefaultBackgroundColorOverrideRequest]], returnType: Unit): `76` = {
  ...
  extension [Self <: `76`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: js.UndefOr[SetDefaultBackgroundColorOverrideRequest]*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
