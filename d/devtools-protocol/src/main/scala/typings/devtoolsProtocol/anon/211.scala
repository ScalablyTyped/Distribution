...
object `211` {
  ...
  inline def apply(paramsType: js.Array[SetUserVerifiedRequest], returnType: Unit): `211` = {
  ...
  extension [Self <: `211`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetUserVerifiedRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
