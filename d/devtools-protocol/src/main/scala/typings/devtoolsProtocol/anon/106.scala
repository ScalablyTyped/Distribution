...
object `106` {
  ...
  inline def apply(paramsType: js.Array[ReleaseSnapshotRequest], returnType: Unit): `106` = {
  ...
  extension [Self <: `106`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: ReleaseSnapshotRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
