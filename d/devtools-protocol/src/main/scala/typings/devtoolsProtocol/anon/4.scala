...
object `4` {
  ...
  implicit class `4Ops`[Self <: `4`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsTypeVarargs(value: SetBreakpointsActiveRequest*): Self = this.set("paramsType", js.Array(value :_*))
    @scala.inline
    def setParamsType(value: js.Array[SetBreakpointsActiveRequest]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
    @scala.inline
