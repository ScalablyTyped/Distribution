...
object `128` {
  ...
  inline def apply(paramsType: js.Array[HighlightRectRequest], returnType: Unit): `128` = {
  ...
  extension [Self <: `128`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: HighlightRectRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
