...
object `191` {
  ...
  inline def apply(paramsType: js.Array[ExposeDevToolsProtocolRequest], returnType: Unit): `191` = {
  ...
  extension [Self <: `191`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: ExposeDevToolsProtocolRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
