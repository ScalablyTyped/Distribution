...
@js.native
trait ReturnTypeGetDOMCountersResponse extends js.Object {
...
object ReturnTypeGetDOMCountersResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetDOMCountersResponseOps[Self <: ReturnTypeGetDOMCountersResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: GetDOMCountersResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
