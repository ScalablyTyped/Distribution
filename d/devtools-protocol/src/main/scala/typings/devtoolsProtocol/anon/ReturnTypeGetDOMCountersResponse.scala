...
object ReturnTypeGetDOMCountersResponse {
  ...
  inline def apply(paramsType: js.Array[js.Any], returnType: GetDOMCountersResponse): ReturnTypeGetDOMCountersResponse = {
    val __obj = js.Dynamic.literal(paramsType = paramsType.asInstanceOf[js.Any], returnType = returnType.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReturnTypeGetDOMCountersResponse]
  }
  
  extension [Self <: ReturnTypeGetDOMCountersResponse](x: Self) {
