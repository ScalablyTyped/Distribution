...
object `72` {
  ...
  inline def apply(paramsType: js.Array[SetDOMStorageItemRequest], returnType: Unit): `72` = {
  ...
  extension [Self <: `72`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetDOMStorageItemRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
