...
object `40` {
  ...
  implicit class `40Ops`[Self <: `40`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsTypeVarargs(value: TrackComputedStyleUpdatesRequest*): Self = this.set("paramsType", js.Array(value :_*))
    
    @scala.inline
    def setParamsType(value: js.Array[TrackComputedStyleUpdatesRequest]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
