...
object `119` {
  ...
  inline def apply(paramsType: js.Array[SetCookiesRequest], returnType: Unit): `119` = {
  ...
  extension [Self <: `119`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetCookiesRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
