...
object `200` {
  ...
  inline def apply(paramsType: js.Array[RecordClockSyncMarkerRequest], returnType: Unit): `200` = {
  ...
  extension [Self <: `200`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: RecordClockSyncMarkerRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
