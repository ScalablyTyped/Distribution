...
object `97` {
  ...
  inline def apply(paramsType: js.Array[DispatchKeyEventRequest], returnType: Unit): `97` = {
  ...
  extension [Self <: `97`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: DispatchKeyEventRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
