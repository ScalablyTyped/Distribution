...
object ReturnTypeEvaluateOnCallFrameResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ReturnTypeEvaluateOnCallFrameResponse] (val x: Self) extends AnyVal {
    ...
    inline def setParamsTypeVarargs(value: EvaluateOnCallFrameRequest*): Self = StObject.set(x, "paramsType", js.Array(value*))
