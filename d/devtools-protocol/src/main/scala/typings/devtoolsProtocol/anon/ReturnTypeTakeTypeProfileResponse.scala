...
trait ReturnTypeTakeTypeProfileResponse extends StObject {
  ...
  var returnType: TakeTypeProfileResponse
}
object ReturnTypeTakeTypeProfileResponse {
  
  inline def apply(paramsType: js.Array[js.Any], returnType: TakeTypeProfileResponse): ReturnTypeTakeTypeProfileResponse = {
    val __obj = js.Dynamic.literal(paramsType = paramsType.asInstanceOf[js.Any], returnType = returnType.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReturnTypeTakeTypeProfileResponse]
  }
  
  extension [Self <: ReturnTypeTakeTypeProfileResponse](x: Self) {
    ...
    inline def setReturnType(value: TakeTypeProfileResponse): Self = StObject.set(x, "returnType", value.asInstanceOf[js.Any])
  }
}
