...
@js.native
trait ReturnTypeGetBestEffortCoverageResponse extends js.Object {
...
object ReturnTypeGetBestEffortCoverageResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetBestEffortCoverageResponseOps[Self <: ReturnTypeGetBestEffortCoverageResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReturnType(value: GetBestEffortCoverageResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
}
