...
object `134` {
  ...
  inline def apply(paramsType: js.Array[SetShowFPSCounterRequest], returnType: Unit): `134` = {
  ...
  extension [Self <: `134`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetShowFPSCounterRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
