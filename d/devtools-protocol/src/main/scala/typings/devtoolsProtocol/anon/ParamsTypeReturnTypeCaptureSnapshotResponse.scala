...
@js.native
trait ParamsTypeReturnTypeCaptureSnapshotResponse extends js.Object {
  var paramsType: js.Array[js.UndefOr[CaptureSnapshotRequest]] = js.native
...
object ParamsTypeReturnTypeCaptureSnapshotResponse {
  ...
  @scala.inline
  implicit class ParamsTypeReturnTypeCaptureSnapshotResponseOps[Self <: ParamsTypeReturnTypeCaptureSnapshotResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setParamsTypeVarargs(value: js.UndefOr[CaptureSnapshotRequest]*): Self = this.set("paramsType", js.Array(value :_*))
    @scala.inline
    def setParamsType(value: js.Array[js.UndefOr[CaptureSnapshotRequest]]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
    @scala.inline
