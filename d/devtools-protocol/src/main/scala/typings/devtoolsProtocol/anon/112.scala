...
object `112` {
  ...
  inline def apply(paramsType: js.Array[DeleteCookiesRequest], returnType: Unit): `112` = {
  ...
  extension [Self <: `112`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: DeleteCookiesRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
