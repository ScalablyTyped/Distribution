...
object ReturnTypeGetProcessInfoResponse {
  ...
  inline def apply(paramsType: js.Array[js.Any], returnType: GetProcessInfoResponse): ReturnTypeGetProcessInfoResponse = {
    val __obj = js.Dynamic.literal(paramsType = paramsType.asInstanceOf[js.Any], returnType = returnType.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReturnTypeGetProcessInfoResponse]
  }
  
  extension [Self <: ReturnTypeGetProcessInfoResponse](x: Self) {
