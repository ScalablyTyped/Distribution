...
@js.native
trait ReturnTypeGetProcessInfoResponse extends js.Object {
...
object ReturnTypeGetProcessInfoResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetProcessInfoResponseOps[Self <: ReturnTypeGetProcessInfoResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: GetProcessInfoResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
