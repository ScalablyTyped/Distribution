...
object `63` {
  ...
  implicit class `63Ops`[Self <: `63`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsTypeVarargs(value: RemoveEventListenerBreakpointRequest*): Self = this.set("paramsType", js.Array(value :_*))
    
    @scala.inline
    def setParamsType(value: js.Array[RemoveEventListenerBreakpointRequest]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
