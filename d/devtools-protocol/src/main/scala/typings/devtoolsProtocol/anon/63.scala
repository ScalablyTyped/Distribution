...
object `63` {
  ...
  inline def apply(paramsType: js.Array[RemoveEventListenerBreakpointRequest], returnType: Unit): `63` = {
  ...
  extension [Self <: `63`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: RemoveEventListenerBreakpointRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
