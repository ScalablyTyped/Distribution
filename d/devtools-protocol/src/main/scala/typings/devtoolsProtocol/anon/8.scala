...
object `8` {
  ...
  implicit class `8Ops`[Self <: `8`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsTypeVarargs(value: SetVariableValueRequest*): Self = this.set("paramsType", js.Array(value :_*))
    @scala.inline
    def setParamsType(value: js.Array[SetVariableValueRequest]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
    @scala.inline
