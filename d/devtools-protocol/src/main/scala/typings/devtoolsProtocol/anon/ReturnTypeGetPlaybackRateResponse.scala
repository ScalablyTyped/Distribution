...
@js.native
trait ReturnTypeGetPlaybackRateResponse extends js.Object {
...
object ReturnTypeGetPlaybackRateResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetPlaybackRateResponseOps[Self <: ReturnTypeGetPlaybackRateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: GetPlaybackRateResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
