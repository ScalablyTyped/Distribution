...
@js.native
trait ReturnTypeStopSamplingResponse extends js.Object {
...
object ReturnTypeStopSamplingResponse {
  ...
  @scala.inline
  implicit class ReturnTypeStopSamplingResponseOps[Self <: ReturnTypeStopSamplingResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: StopSamplingResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
