...
object `36` {
  ...
  inline def apply(paramsType: js.Array[SetDownloadBehaviorRequest], returnType: Unit): `36` = {
  ...
  extension [Self <: `36`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetDownloadBehaviorRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
