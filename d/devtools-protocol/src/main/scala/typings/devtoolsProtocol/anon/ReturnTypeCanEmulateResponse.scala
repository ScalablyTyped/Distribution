...
object ReturnTypeCanEmulateResponse {
  ...
  inline def apply(paramsType: js.Array[js.Any], returnType: CanEmulateResponse): ReturnTypeCanEmulateResponse = {
    val __obj = js.Dynamic.literal(paramsType = paramsType.asInstanceOf[js.Any], returnType = returnType.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReturnTypeCanEmulateResponse]
  }
  
  extension [Self <: ReturnTypeCanEmulateResponse](x: Self) {
