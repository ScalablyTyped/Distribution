...
@js.native
trait ReturnTypeCanEmulateResponse extends js.Object {
...
object ReturnTypeCanEmulateResponse {
  ...
  @scala.inline
  implicit class ReturnTypeCanEmulateResponseOps[Self <: ReturnTypeCanEmulateResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setReturnType(value: CanEmulateResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
