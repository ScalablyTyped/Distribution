...
object `56` {
  ...
  inline def apply(paramsType: js.Array[js.UndefOr[FocusRequest]], returnType: Unit): `56` = {
  ...
  extension [Self <: `56`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: js.UndefOr[FocusRequest]*): Self = StObject.set(x, "paramsType", js.Array(value*))
