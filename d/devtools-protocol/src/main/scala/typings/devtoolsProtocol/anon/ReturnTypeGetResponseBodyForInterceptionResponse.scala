...
object ReturnTypeGetResponseBodyForInterceptionResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ReturnTypeGetResponseBodyForInterceptionResponse] (val x: Self) extends AnyVal {
    ...
    inline def setParamsTypeVarargs(value: GetResponseBodyForInterceptionRequest*): Self = StObject.set(x, "paramsType", js.Array(value*))
