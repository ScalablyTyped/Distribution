...
object ReturnTypeCanClearBrowserCacheResponse {
  ...
  @scala.inline
  implicit class ReturnTypeCanClearBrowserCacheResponseMutableBuilder[Self <: ReturnTypeCanClearBrowserCacheResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReturnType(value: CanClearBrowserCacheResponse): Self = StObject.set(x, "returnType", value.asInstanceOf[js.Any])
  }
}
