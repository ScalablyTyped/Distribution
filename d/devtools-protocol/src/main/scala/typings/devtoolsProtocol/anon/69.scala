...
object `69` {
  ...
  inline def apply(paramsType: js.Array[SetXHRBreakpointRequest], returnType: Unit): `69` = {
  ...
  extension [Self <: `69`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetXHRBreakpointRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
