...
object `55` {
  ...
  implicit class `55MutableBuilder`[Self <: `55`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsType(value: js.Array[SetAttributeValueRequest]): Self = StObject.set(x, "paramsType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setParamsTypeVarargs(value: SetAttributeValueRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
