...
object `55` {
  ...
  inline def apply(paramsType: js.Array[SetAttributeValueRequest], returnType: Unit): `55` = {
  ...
  extension [Self <: `55`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetAttributeValueRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
