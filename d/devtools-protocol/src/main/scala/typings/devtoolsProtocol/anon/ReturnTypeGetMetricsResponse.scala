...
@js.native
trait ReturnTypeGetMetricsResponse extends js.Object {
...
object ReturnTypeGetMetricsResponse {
  ...
  @scala.inline
  implicit class ReturnTypeGetMetricsResponseOps[Self <: ReturnTypeGetMetricsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReturnType(value: GetMetricsResponse): Self = this.set("returnType", value.asInstanceOf[js.Any])
  }
}
