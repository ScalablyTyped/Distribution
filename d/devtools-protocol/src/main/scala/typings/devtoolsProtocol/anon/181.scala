...
object `181` {
  ...
  inline def apply(paramsType: js.Array[ClearDataForOriginRequest], returnType: Unit): `181` = {
  ...
  extension [Self <: `181`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: ClearDataForOriginRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
