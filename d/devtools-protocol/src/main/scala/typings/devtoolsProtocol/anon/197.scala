...
object `197` {
  ...
  inline def apply(paramsType: js.Array[SetRemoteLocationsRequest], returnType: Unit): `197` = {
  ...
  extension [Self <: `197`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetRemoteLocationsRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
