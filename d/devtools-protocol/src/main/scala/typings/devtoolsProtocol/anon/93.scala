...
object `93` {
  ...
  inline def apply(paramsType: js.Array[CloseRequest], returnType: Unit): `93` = {
  ...
  extension [Self <: `93`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: CloseRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
