...
object `184` {
  ...
  inline def apply(paramsType: js.Array[js.UndefOr[ClearCookiesRequest]], returnType: Unit): `184` = {
  ...
  extension [Self <: `184`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: js.UndefOr[ClearCookiesRequest]*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
