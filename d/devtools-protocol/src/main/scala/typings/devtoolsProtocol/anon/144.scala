...
object `144` {
  ...
  inline def apply(paramsType: js.Array[NavigateToHistoryEntryRequest], returnType: Unit): `144` = {
  ...
  extension [Self <: `144`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: NavigateToHistoryEntryRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
