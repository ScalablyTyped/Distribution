...
object `109` {
  ...
  implicit class `109Ops`[Self <: `109`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParamsTypeVarargs(value: SimulatePressureNotificationRequest*): Self = this.set("paramsType", js.Array(value :_*))
    
    @scala.inline
    def setParamsType(value: js.Array[SimulatePressureNotificationRequest]): Self = this.set("paramsType", value.asInstanceOf[js.Any])
