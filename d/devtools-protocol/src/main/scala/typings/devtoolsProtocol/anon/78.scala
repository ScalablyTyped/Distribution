...
object `78` {
  ...
  inline def apply(paramsType: js.Array[SetScrollbarsHiddenRequest], returnType: Unit): `78` = {
  ...
  extension [Self <: `78`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetScrollbarsHiddenRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
