...
@js.native
trait ParamsType extends StObject {
...
object ParamsType {
  ...
  @scala.inline
  def apply(paramsType: js.Array[js.Any], returnType: Unit): ParamsType = {
    val __obj = js.Dynamic.literal(paramsType = paramsType.asInstanceOf[js.Any], returnType = returnType.asInstanceOf[js.Any])
    __obj.asInstanceOf[ParamsType]
  }
  
  @scala.inline
  implicit class ParamsTypeMutableBuilder[Self <: ParamsType] (val x: Self) extends AnyVal {
