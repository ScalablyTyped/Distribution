...
object `70` {
  ...
  inline def apply(paramsType: js.Array[ClearRequest], returnType: Unit): `70` = {
  ...
  extension [Self <: `70`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: ClearRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
