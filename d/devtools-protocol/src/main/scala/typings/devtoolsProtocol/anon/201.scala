...
object `201` {
  ...
  inline def apply(paramsType: js.Array[js.UndefOr[StartRequest]], returnType: Unit): `201` = {
  ...
  extension [Self <: `201`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: js.UndefOr[StartRequest]*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
