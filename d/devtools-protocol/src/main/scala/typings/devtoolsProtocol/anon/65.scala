...
object `65` {
  ...
  inline def apply(paramsType: js.Array[RemoveXHRBreakpointRequest], returnType: Unit): `65` = {
  ...
  extension [Self <: `65`](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: RemoveXHRBreakpointRequest*): Self = StObject.set(x, "paramsType", js.Array(value :_*))
