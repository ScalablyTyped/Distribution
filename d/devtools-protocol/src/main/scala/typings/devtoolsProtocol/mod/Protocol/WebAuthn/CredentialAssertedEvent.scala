...
trait CredentialAssertedEvent extends StObject {
  
  var authenticatorId: AuthenticatorId
  
  var credential: Credential
}
object CredentialAssertedEvent {
  
  inline def apply(authenticatorId: AuthenticatorId, credential: Credential): CredentialAssertedEvent = {
    ...
    __obj.asInstanceOf[CredentialAssertedEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CredentialAssertedEvent] (val x: Self) extends AnyVal {
