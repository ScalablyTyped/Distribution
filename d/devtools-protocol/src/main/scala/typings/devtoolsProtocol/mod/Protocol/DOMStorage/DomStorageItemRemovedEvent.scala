...
@js.native
trait DomStorageItemRemovedEvent extends js.Object {
...
object DomStorageItemRemovedEvent {
  ...
  @scala.inline
  implicit class DomStorageItemRemovedEventOps[Self <: DomStorageItemRemovedEvent] (val x: Self) extends AnyVal {
    @scala.inline
