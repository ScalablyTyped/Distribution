...
object RestartFrameResponse {
  ...
  inline def apply(callFrames: js.Array[CallFrame]): RestartFrameResponse = {
    val __obj = js.Dynamic.literal(callFrames = callFrames.asInstanceOf[js.Any])
    __obj.asInstanceOf[RestartFrameResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RestartFrameResponse] (val x: Self) extends AnyVal {
