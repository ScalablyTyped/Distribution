...
/* Rewritten from type alias, can be one of: 
  - typings.devtoolsProtocol.devtoolsProtocolStrings.formSubmissionGet
  - typings.devtoolsProtocol.devtoolsProtocolStrings.formSubmissionPost
  - typings.devtoolsProtocol.devtoolsProtocolStrings.httpHeaderRefresh
  - typings.devtoolsProtocol.devtoolsProtocolStrings.scriptInitiated
  - typings.devtoolsProtocol.devtoolsProtocolStrings.metaTagRefresh
  - typings.devtoolsProtocol.devtoolsProtocolStrings.pageBlockInterstitial
  - typings.devtoolsProtocol.devtoolsProtocolStrings.reload
  - typings.devtoolsProtocol.devtoolsProtocolStrings.anchorClick
*/
