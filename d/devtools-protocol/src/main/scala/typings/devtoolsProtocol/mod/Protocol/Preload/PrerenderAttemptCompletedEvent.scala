...
object PrerenderAttemptCompletedEvent {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(finalStatus = finalStatus.asInstanceOf[js.Any], initiatingFrameId = initiatingFrameId.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any], prerenderingUrl = prerenderingUrl.asInstanceOf[js.Any])
