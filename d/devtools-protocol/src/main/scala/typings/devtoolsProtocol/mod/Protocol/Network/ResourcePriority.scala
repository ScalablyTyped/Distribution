...
/* Rewritten from type alias, can be one of: 
  - typings.devtoolsProtocol.devtoolsProtocolStrings.VeryLow
  - typings.devtoolsProtocol.devtoolsProtocolStrings.Low
  - typings.devtoolsProtocol.devtoolsProtocolStrings.Medium
