...
object StorageType {
  ...
  inline def all: typings.devtoolsProtocol.devtoolsProtocolStrings.all = "all".asInstanceOf[typings.devtoolsProtocol.devtoolsProtocolStrings.all]
  
  inline def appcache: typings.devtoolsProtocol.devtoolsProtocolStrings.appcache = "appcache".asInstanceOf[typings.devtoolsProtocol.devtoolsProtocolStrings.appcache]
  
  inline def cache_storage: typings.devtoolsProtocol.devtoolsProtocolStrings.cache_storage = "cache_storage".asInstanceOf[typings.devtoolsProtocol.devtoolsProtocolStrings.cache_storage]
  
  inline def cookies: typings.devtoolsProtocol.devtoolsProtocolStrings.cookies = "cookies".asInstanceOf[typings.devtoolsProtocol.devtoolsProtocolStrings.cookies]
  ...
  inline def service_workers: typings.devtoolsProtocol.devtoolsProtocolStrings.service_workers = "service_workers".asInstanceOf[typings.devtoolsProtocol.devtoolsProtocolStrings.service_workers]
