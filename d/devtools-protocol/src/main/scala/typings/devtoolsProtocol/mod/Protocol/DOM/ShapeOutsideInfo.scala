...
object ShapeOutsideInfo {
  ...
  @scala.inline
  def apply(bounds: Quad, marginShape: js.Array[js.Any], shape: js.Array[js.Any]): ShapeOutsideInfo = {
  ...
  implicit class ShapeOutsideInfoMutableBuilder[Self <: ShapeOutsideInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMarginShape(value: js.Array[js.Any]): Self = StObject.set(x, "marginShape", value.asInstanceOf[js.Any])
