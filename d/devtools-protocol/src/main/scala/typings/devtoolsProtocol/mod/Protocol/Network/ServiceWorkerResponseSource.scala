...
/* Rewritten from type alias, can be one of: 
  - typings.devtoolsProtocol.devtoolsProtocolStrings.`cache-storage`
  - typings.devtoolsProtocol.devtoolsProtocolStrings.`http-cache`
  - typings.devtoolsProtocol.devtoolsProtocolStrings.`fallback-code`
