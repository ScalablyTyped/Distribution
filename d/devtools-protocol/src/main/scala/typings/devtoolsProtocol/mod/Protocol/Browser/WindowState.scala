...
/* Rewritten from type alias, can be one of: 
  - typings.devtoolsProtocol.devtoolsProtocolStrings.normal
  - typings.devtoolsProtocol.devtoolsProtocolStrings.minimized
  - typings.devtoolsProtocol.devtoolsProtocolStrings.maximized
