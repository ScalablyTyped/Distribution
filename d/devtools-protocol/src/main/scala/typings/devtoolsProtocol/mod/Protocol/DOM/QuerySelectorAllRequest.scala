...
object QuerySelectorAllRequest {
  ...
  inline def apply(nodeId: NodeId, selector: String): QuerySelectorAllRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: QuerySelectorAllRequest] (val x: Self) extends AnyVal {
