...
@js.native
trait GetFlattenedDocumentRequest extends js.Object {
...
object GetFlattenedDocumentRequest {
  ...
  @scala.inline
  implicit class GetFlattenedDocumentRequestOps[Self <: GetFlattenedDocumentRequest] (val x: Self) extends AnyVal {
