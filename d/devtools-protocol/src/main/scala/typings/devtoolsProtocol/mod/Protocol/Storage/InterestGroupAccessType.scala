...
*/
trait InterestGroupAccessType extends StObject
object InterestGroupAccessType {
  
  inline def bid: typings.devtoolsProtocol.devtoolsProtocolStrings.bid = "bid".asInstanceOf[typings.devtoolsProtocol.devtoolsProtocolStrings.bid]
  ...
  inline def win: typings.devtoolsProtocol.devtoolsProtocolStrings.win = "win".asInstanceOf[typings.devtoolsProtocol.devtoolsProtocolStrings.win]
}
