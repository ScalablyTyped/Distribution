...
/* Rewritten from type alias, can be one of: 
  - typings.devtoolsProtocol.devtoolsProtocolStrings.UseCached
  - typings.devtoolsProtocol.devtoolsProtocolStrings.Refresh
*/
trait TrustTokenParamsRefreshPolicy extends js.Object
