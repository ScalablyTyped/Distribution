...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.devtoolsProtocol.devtoolsProtocolStrings.CoopSandboxedIFrameCannotNavigateToCoopPage
  - typings.devtoolsProtocol.devtoolsProtocolStrings.CorpNotSameOrigin
  - typings.devtoolsProtocol.devtoolsProtocolStrings.CorpNotSameOriginAfterDefaultedToSameOriginByCoep
