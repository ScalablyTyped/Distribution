...
import typings.uvu1yNNGH0U.mod.uvu.Test
...
object mod {
  ...
  @JSImport(".uvu-1yNNGH0U", JSImport.Namespace)
  @js.native
  ...
  @JSImport(".uvu-1yNNGH0U", "test")
  @js.native
  val test: Test[Context] = js.native
  
  type Callback[T] = typings.uvu1yNNGH0U.mod.uvu.Callback[T]
  ...
  object uvu {
    ...
    trait Hook[T] extends StObject {
      ...
      def apply(hook: typings.uvu1yNNGH0U.mod.uvu.Callback[T]): Unit = js.native
      
      def each(hook: typings.uvu1yNNGH0U.mod.uvu.Callback[T]): Unit = js.native
    }
    
    @js.native
    trait Test[T] extends StObject {
      
      def apply(name: String, test: typings.uvu1yNNGH0U.mod.uvu.Callback[T]): Unit = js.native
      
      def after(hook: typings.uvu1yNNGH0U.mod.uvu.Callback[T]): Unit = js.native
      @JSName("after")
      var after_Original: Hook[T] = js.native
      
      def before(hook: typings.uvu1yNNGH0U.mod.uvu.Callback[T]): Unit = js.native
      @JSName("before")
      var before_Original: Hook[T] = js.native
      
      def only(name: String, test: typings.uvu1yNNGH0U.mod.uvu.Callback[T]): Unit = js.native
      
      def run(): js.Function0[Unit] = js.native
      
      def skip(): Unit = js.native
      def skip(name: String): Unit = js.native
      def skip(name: String, test: typings.uvu1yNNGH0U.mod.uvu.Callback[T]): Unit = js.native
      def skip(name: Unit, test: typings.uvu1yNNGH0U.mod.uvu.Callback[T]): Unit = js.native
    }
  }
}
