...
trait Contours extends js.Object {
  /**
       ...
       */
  def apply(values: js.Array[scala.Double]): js.Array[ContourMultiPolygon] = js.native
  /**
       ...
       */
  def contour(values: js.Array[scala.Double], threshold: scala.Double): ContourMultiPolygon = js.native
  /**
  ...
  /**
       ...
       */
  def smooth(): scala.Boolean = js.native
  /**
       ...
       */
  def smooth(smooth: scala.Boolean): this.type = js.native
  /**
