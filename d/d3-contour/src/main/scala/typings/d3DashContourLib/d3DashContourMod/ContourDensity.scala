...
trait ContourDensity[Datum] extends js.Object {
  ...
  /**
    ...
    */
  def bandwidth(bandwidth: scala.Double): this.type = js.native
  /**
    * Returns the current cell size, which defaults to 4.
    */
  def cellSize(): scala.Double = js.native
  /**
    ...
    */
  def cellSize(cellSize: scala.Double): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def thresholds(): d3DashArrayLib.d3DashArrayMod.ThresholdCountGenerator[scala.Double] | d3DashArrayLib.d3DashArrayMod.ThresholdNumberArrayGenerator[scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  def thresholds(
    thresholds: d3DashArrayLib.d3DashArrayMod.ThresholdCountGenerator[scala.Double] | d3DashArrayLib.d3DashArrayMod.ThresholdNumberArrayGenerator[scala.Double]
  ): this.type = js.native
  /**
    ...
    */
  def thresholds(thresholds: js.Array[scala.Double]): this.type = js.native
  /**
    * Returns the current point weight accessor.
    */
  def weight(): js.Function1[/* d */ Datum, scala.Double] = js.native
  /**
    * Sets the point weight accessor and returns the density contour estimator.
    *
    * @param weight A point weight accessor function.
    */
  def weight(weight: js.Function1[/* d */ Datum, scala.Double]): this.type = js.native
  /**
    ...
    */
  def x(): js.Function1[/* d */ Datum, scala.Double] = js.native
  /**
    ...
    * x-coordinate.
    */
  def x(x: js.Function1[/* d */ Datum, scala.Double]): this.type = js.native
  /**
    ...
    */
  def y(): js.Function1[/* d */ Datum, scala.Double] = js.native
  /**
    ...
    * y-coordinate.
    */
  def y(y: js.Function1[/* d */ Datum, scala.Double]): this.type = js.native
}
