...
trait DurandalSystemModule extends js.Object {
  ...
  /**
       ...
       */
  def acquire(moduleId: java.lang.String): DurandalPromise[_] = js.native
  /**
       ...
       * @returns {Promise} A promise for the loaded module.
       */
  def acquire(moduleIds: java.lang.String*): DurandalPromise[js.Array[_]] = js.native
  /**
       ...
       * @returns {Promise} A promise for the loaded module.
       */
  def acquire(modules: js.Array[java.lang.String]): DurandalPromise[js.Array[_]] = js.native
  /**
  ...
  /**
       ...
       * @returns {boolean} Whether or not Durandal is current debugging.
       */
  def debug(enable: scala.Boolean): scala.Boolean = js.native
  /**
  ...
  /**
       ...
       * @returns {Deferred} The deferred object.
       */
  def defer[T](action: js.Function1[/* dfd */ DurandalDeferred[T], scala.Unit]): DurandalDeferred[T] = js.native
  /**
       * Logs an error.
       * @param {string} obj The error to report.
       */
  def error(error: java.lang.String): scala.Unit = js.native
  /**
       * Logs an error.
  ...
  /**
       ...
       */
  def getModuleId(obj: js.Any): java.lang.String = js.native
  /**
  ...
  /**
       ...
       */
  def isArguments(obj: js.Any): scala.Boolean = js.native
  /**
  ...
  /**
       ...
       */
  def keys(obj: js.Any): js.Array[java.lang.String] = js.native
  /**
       * Logs data to the console. Pass any number of parameters to be logged. Log output is not processed if the framework is not running in debug mode.
       * @param {object} info* The objects to log.
       */
  def log(msgs: js.Any*): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def setModuleId(obj: js.Any, id: java.lang.String): scala.Unit = js.native
  /**
       * Uses a setTimeout to wait the specified milliseconds.
       * @param {number} milliseconds The number of milliseconds to wait.
       * @returns {Promise}
      */
  def wait(milliseconds: scala.Double): DurandalPromise[_] = js.native
}
