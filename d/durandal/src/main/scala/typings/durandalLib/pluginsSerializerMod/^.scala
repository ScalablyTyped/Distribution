...
object ^ extends js.Object {
  ...
  def deserialize[T](text: java.lang.String, settings: durandalLib.pluginsSerializerMod.DeserializerOptions): T = js.native
  ...
  def serialize(`object`: js.Any, settings: durandalLib.pluginsSerializerMod.SerializerOptions): java.lang.String = js.native
