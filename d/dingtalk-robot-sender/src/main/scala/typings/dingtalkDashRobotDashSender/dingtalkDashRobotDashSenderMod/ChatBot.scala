...
trait ChatBot extends js.Object {
  /**
    ...
    * @return
    */
  def actionCard(card: Anon_0): js.Promise[AxiosResponse[_]] = js.native
  /**
    * 发送feedCard，支持多图文链接
  ...
  /**
    ...
    * @return
    */
  def link(link: Anon_MessageUrl): js.Promise[AxiosResponse[_]] = js.native
  ...
  /**
    ...
    * @return
    */
  def markdown(title: String, text: String, at: Anon_AtMobiles): js.Promise[AxiosResponse[_]] = js.native
  /**
    * 发送钉钉消息
    *
  ...
  def text(content: String, at: Anon_AtMobiles): js.Promise[AxiosResponse[_]] = js.native
}
