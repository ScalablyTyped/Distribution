...
trait Device extends js.Object {
  /**
    ...
    */
  def disableSynchronization(): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def enableSynchronization(): js.Promise[scala.Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def installApp(): js.Promise[scala.Unit] = js.native
  def installApp(path: js.Any): js.Promise[scala.Unit] = js.native
  /**
    * Launch the app
    * @param config
    ...
    */
  def launchApp(config: DeviceLanchAppConfig): js.Promise[scala.Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def pressBack(): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def reloadReactNative(): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def resetContentAndSettings(): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def sendToHome(): js.Promise[scala.Unit] = js.native
  /**
    * Mock handling of received user activity when app is in foreground.
    * @param params
    */
  def sendUserActivity(params: js.Any*): js.Promise[scala.Unit] = js.native
  /**
    * Mock handling of received user notification when app is in foreground.
    * @param params
    */
  def sendUserNotification(params: js.Any*): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def setLocation(lat: scala.Double, lon: scala.Double): js.Promise[scala.Unit] = js.native
  /**
    ...
    * @param orientation
    */
  def setOrientation(orientation: Orientation): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def setURLBlacklist(urls: js.Array[java.lang.String]): js.Promise[scala.Unit] = js.native
  /**
    * Simulate shake (iOS Only)
    */
  def shake(): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def terminateApp(): js.Promise[scala.Unit] = js.native
  def terminateApp(bundle: java.lang.String): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def uninstallApp(): js.Promise[scala.Unit] = js.native
  def uninstallApp(bundle: java.lang.String): js.Promise[scala.Unit] = js.native
}
