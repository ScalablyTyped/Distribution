...
@js.native
trait EventLocation extends StObject {
...
object EventLocation {
  ...
  @scala.inline
  def apply(): EventLocation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EventLocation]
  }
  
  @scala.inline
  implicit class EventLocationMutableBuilder[Self <: EventLocation] (val x: Self) extends AnyVal {
