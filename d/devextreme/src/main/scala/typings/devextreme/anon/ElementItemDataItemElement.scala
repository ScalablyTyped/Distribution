...
object ElementItemDataItemElement {
  ...
  inline def apply(): ElementItemDataItemElement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ElementItemDataItemElement]
  }
  
  extension [Self <: ElementItemDataItemElement](x: Self) {
    
    inline def setComponent(value: dxTabPanel): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
