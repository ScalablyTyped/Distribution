...
object AllowedPageSizes {
  ...
  def apply(
    ...
    if (!js.isUndefined(showNavigationButtons)) __obj.updateDynamic("showNavigationButtons")(showNavigationButtons.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showPageSizeSelector)) __obj.updateDynamic("showPageSizeSelector")(showPageSizeSelector.get.asInstanceOf[js.Any])
