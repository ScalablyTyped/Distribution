...
@js.native
trait ItemDataItemElementItemIndex extends js.Object {
...
object ItemDataItemElementItemIndex {
  ...
  @scala.inline
  implicit class ItemDataItemElementItemIndexOps[Self <: ItemDataItemElementItemIndex] (val x: Self) extends AnyVal {
    @scala.inline
