...
object ComponentElementEventJQueryEvent {
  @scala.inline
  def apply(): ComponentElementEventJQueryEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ComponentElementEventJQueryEvent]
  }
  @scala.inline
  implicit class ComponentElementEventJQueryEventOps[Self <: ComponentElementEventJQueryEvent] (val x: Self) extends AnyVal {
    @scala.inline
