...
@js.native
trait EventJQueryEventModel[T] extends js.Object {
...
object EventJQueryEventModel {
  @scala.inline
  def apply[T](): EventJQueryEventModel[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EventJQueryEventModel[T]]
  }
  @scala.inline
  implicit class EventJQueryEventModelOps[Self <: EventJQueryEventModel[_], T] (val x: Self with EventJQueryEventModel[T]) extends AnyVal {
    @scala.inline
