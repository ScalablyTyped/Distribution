...
@js.native
trait ModelToComponent extends js.Object {
...
object ModelToComponent {
  @scala.inline
  def apply(): ModelToComponent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ModelToComponent]
  }
  @scala.inline
  implicit class ModelToComponentOps[Self <: ModelToComponent] (val x: Self) extends AnyVal {
    @scala.inline
