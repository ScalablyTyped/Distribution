...
@js.native
trait CellElementColumn extends StObject {
...
object CellElementColumn {
  
  @scala.inline
  def apply(): CellElementColumn = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CellElementColumn]
  }
  
  @scala.inline
  implicit class CellElementColumnMutableBuilder[Self <: CellElementColumn] (val x: Self) extends AnyVal {
