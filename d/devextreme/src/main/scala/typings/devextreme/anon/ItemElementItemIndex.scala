...
@js.native
trait ItemElementItemIndex[T] extends StObject {
...
object ItemElementItemIndex {
  ...
  @scala.inline
  def apply[T](): ItemElementItemIndex[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ItemElementItemIndex[T]]
  }
  
  @scala.inline
  implicit class ItemElementItemIndexMutableBuilder[Self <: ItemElementItemIndex[_], T] (val x: Self with ItemElementItemIndex[T]) extends AnyVal {
    ...
    @scala.inline
    def setItemElement(value: js.Any): Self = StObject.set(x, "itemElement", value.asInstanceOf[js.Any])
