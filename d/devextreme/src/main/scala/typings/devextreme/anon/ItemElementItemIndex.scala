...
object ItemElementItemIndex {
  ...
  @scala.inline
  implicit class ItemElementItemIndexOps[Self <: ItemElementItemIndex[_], T] (val x: Self with ItemElementItemIndex[T]) extends AnyVal {
    ...
    @scala.inline
    def setItemElement(value: js.Any): Self = this.set("itemElement", value.asInstanceOf[js.Any])
