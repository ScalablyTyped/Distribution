...
object ItemElementItemIndex {
  ...
  inline def apply[T](): ItemElementItemIndex[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ItemElementItemIndex[T]]
  }
  
  extension [Self <: ItemElementItemIndex[?], T](x: Self & ItemElementItemIndex[T]) {
    ...
    inline def setItemElement(value: js.Any): Self = StObject.set(x, "itemElement", value.asInstanceOf[js.Any])
