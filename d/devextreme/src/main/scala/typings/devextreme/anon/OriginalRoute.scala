...
@js.native
trait OriginalRoute extends js.Object {
...
object OriginalRoute {
  ...
  @scala.inline
  implicit class OriginalRouteOps[Self <: OriginalRoute] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOriginalRoute(value: js.Any): Self = this.set("originalRoute", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOriginalRoute: Self = this.set("originalRoute", js.undefined)
  }
