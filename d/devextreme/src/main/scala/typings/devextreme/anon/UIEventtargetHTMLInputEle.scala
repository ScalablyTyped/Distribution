...
trait UIEventtargetHTMLInputEle extends StObject {
  ...
  def initUIEvent(typeArg: String, bubblesArg: Boolean, cancelableArg: Boolean, viewArg: typings.std.Window): Unit = js.native
  def initUIEvent(
    typeArg: String,
    bubblesArg: Boolean,
    cancelableArg: Boolean,
    viewArg: typings.std.Window,
    detailArg: Double
  ): Unit = js.native
  ...
  def initUIEvent(typeArg: String, bubblesArg: Boolean, cancelableArg: Unit, viewArg: typings.std.Window): Unit = js.native
  def initUIEvent(
    typeArg: String,
    bubblesArg: Boolean,
    cancelableArg: Unit,
  ...
  def initUIEvent(typeArg: String, bubblesArg: Unit, cancelableArg: Boolean, viewArg: typings.std.Window): Unit = js.native
  def initUIEvent(
    typeArg: String,
    bubblesArg: Unit,
    cancelableArg: Boolean,
  ...
  def initUIEvent(typeArg: String, bubblesArg: Unit, cancelableArg: Unit, viewArg: typings.std.Window): Unit = js.native
  def initUIEvent(
    typeArg: String,
    bubblesArg: Unit,
    cancelableArg: Unit,
  ...
  /* standard dom */
  val view: typings.std.Window | Null = js.native
