...
import typings.devextreme.mod.DevExpress.ui.dxProgressBar
...
@js.native
trait ElementEventJQueryEvent extends js.Object {
...
object ElementEventJQueryEvent {
  @scala.inline
  def apply(): ElementEventJQueryEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ElementEventJQueryEvent]
  }
  @scala.inline
  implicit class ElementEventJQueryEventOps[Self <: ElementEventJQueryEvent] (val x: Self) extends AnyVal {
    @scala.inline
