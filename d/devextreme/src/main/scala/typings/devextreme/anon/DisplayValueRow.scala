...
object DisplayValueRow {
  ...
  inline def apply(): DisplayValueRow = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DisplayValueRow]
  }
  
  extension [Self <: DisplayValueRow](x: Self) {
    
    inline def setColumn(value: DisplayValueRow): Self = StObject.set(x, "column", value.asInstanceOf[js.Any])
