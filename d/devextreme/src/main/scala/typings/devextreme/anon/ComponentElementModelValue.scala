...
@js.native
trait ComponentElementModelValue extends StObject {
...
object ComponentElementModelValue {
  ...
  @scala.inline
  def apply(): ComponentElementModelValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ComponentElementModelValue]
  }
  
  @scala.inline
  implicit class ComponentElementModelValueMutableBuilder[Self <: ComponentElementModelValue] (val x: Self) extends AnyVal {
