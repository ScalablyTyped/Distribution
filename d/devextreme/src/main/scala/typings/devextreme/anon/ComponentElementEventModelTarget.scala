...
@js.native
trait ComponentElementEventModelTarget extends js.Object {
...
object ComponentElementEventModelTarget {
  ...
  @scala.inline
  implicit class ComponentElementEventModelTargetOps[Self <: ComponentElementEventModelTarget] (val x: Self) extends AnyVal {
