...
@js.native
trait PreviousValue[T] extends StObject {
...
object PreviousValue {
  ...
  @scala.inline
  def apply[T](): PreviousValue[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PreviousValue[T]]
  }
  
  @scala.inline
  implicit class PreviousValueMutableBuilder[Self <: PreviousValue[_], T] (val x: Self with PreviousValue[T]) extends AnyVal {
