...
@js.native
trait JQueryEvent[T] extends js.Object {
...
object JQueryEvent {
  @scala.inline
  def apply[T](): JQueryEvent[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[JQueryEvent[T]]
  }
  @scala.inline
  implicit class JQueryEventOps[Self <: JQueryEvent[_], T] (val x: Self with JQueryEvent[T]) extends AnyVal {
    @scala.inline
