...
object ElementModelTarget {
  ...
  inline def apply[T](): ElementModelTarget[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ElementModelTarget[T]]
  }
  
  extension [Self <: ElementModelTarget[?], T](x: Self & ElementModelTarget[T]) {
    ...
    inline def setTarget(value: basePointObject | dxChartAnnotationConfig | js.Any): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
