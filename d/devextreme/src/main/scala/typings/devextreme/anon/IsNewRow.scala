...
trait IsNewRow extends StObject {
...
object IsNewRow {
  ...
  inline def apply(): IsNewRow = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IsNewRow]
  }
  
  extension [Self <: IsNewRow](x: Self) {
    
    inline def setColumns(value: js.Array[dxDataGridColumn]): Self = StObject.set(x, "columns", value.asInstanceOf[js.Any])
    
    inline def setColumnsUndefined: Self = StObject.set(x, "columns", js.undefined)
    
    inline def setColumnsVarargs(value: dxDataGridColumn*): Self = StObject.set(x, "columns", js.Array(value :_*))
