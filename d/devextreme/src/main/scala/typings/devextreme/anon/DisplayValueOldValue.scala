...
object DisplayValueOldValue {
  ...
  inline def apply(): DisplayValueOldValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DisplayValueOldValue]
  }
  
  extension [Self <: DisplayValueOldValue](x: Self) {
    
    inline def setColumn(value: DisplayValueOldValue): Self = StObject.set(x, "column", value.asInstanceOf[js.Any])
