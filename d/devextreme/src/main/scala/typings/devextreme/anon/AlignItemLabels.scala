...
trait AlignItemLabels extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[typings.devextreme.mod.DevExpress.ui.dxForm.Item]] = js.undefined
...
object AlignItemLabels {
  ...
  extension [Self <: AlignItemLabels](x: Self) {
    ...
    inline def setItems(value: js.Array[typings.devextreme.mod.DevExpress.ui.dxForm.Item]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: typings.devextreme.mod.DevExpress.ui.dxForm.Item*): Self = StObject.set(x, "items", js.Array(value*))
