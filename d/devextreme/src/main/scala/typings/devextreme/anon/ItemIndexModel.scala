...
trait ItemIndexModel extends StObject {
...
object ItemIndexModel {
  ...
  @scala.inline
  def apply(): ItemIndexModel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ItemIndexModel]
  }
  
  @scala.inline
  implicit class ItemIndexModelMutableBuilder[Self <: ItemIndexModel] (val x: Self) extends AnyVal {
