...
trait DropInsideItemElement extends StObject {
...
object DropInsideItemElement {
  
  @scala.inline
  def apply(): DropInsideItemElement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DropInsideItemElement]
  }
  
  @scala.inline
  implicit class DropInsideItemElementMutableBuilder[Self <: DropInsideItemElement] (val x: Self) extends AnyVal {
