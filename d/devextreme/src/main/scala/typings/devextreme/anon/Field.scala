...
trait Field extends StObject {
  ...
  var field: js.UndefOr[typings.devextreme.mod.DevExpress.ui.dxFilterBuilder.Field] = js.undefined
...
object Field {
  ...
  implicit open class MutableBuilder[Self <: Field] (val x: Self) extends AnyVal {
    ...
    inline def setField(value: typings.devextreme.mod.DevExpress.ui.dxFilterBuilder.Field): Self = StObject.set(x, "field", value.asInstanceOf[js.Any])
