...
object CheckTypeForAllData {
  ...
  @scala.inline
  implicit class CheckTypeForAllDataMutableBuilder[Self <: CheckTypeForAllData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSortingMethod(value: Boolean | (js.Function2[/* a */ js.Any, /* b */ js.Any, Double])): Self = StObject.set(x, "sortingMethod", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSortingMethodFunction2(value: (/* a */ js.Any, /* b */ js.Any) => Double): Self = StObject.set(x, "sortingMethod", js.Any.fromFunction2(value))
