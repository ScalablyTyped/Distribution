...
object Options {
  ...
  extension [Self <: Options](x: Self) {
    ...
    inline def setOriginalMarker(value: js.Any): Self = StObject.set(x, "originalMarker", value.asInstanceOf[js.Any])
    
    inline def setOriginalMarkerUndefined: Self = StObject.set(x, "originalMarker", js.undefined)
  }
}
