...
object CustomItem {
  ...
  inline def apply[T](): CustomItem[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CustomItem[T]]
  }
  
  extension [Self <: CustomItem[?], T](x: Self & CustomItem[T]) {
    
    inline def setComponent(value: T): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    
    inline def setComponentUndefined: Self = StObject.set(x, "component", js.undefined)
    
    inline def setCustomItem(value: String | js.Any | typings.devextreme.mod.global.Promise[js.Any] | JQueryPromise[js.Any]): Self = StObject.set(x, "customItem", value.asInstanceOf[js.Any])
