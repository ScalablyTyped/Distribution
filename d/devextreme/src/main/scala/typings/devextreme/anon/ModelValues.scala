...
@js.native
trait ModelValues extends StObject {
...
object ModelValues {
  ...
  @scala.inline
  def apply(): ModelValues = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ModelValues]
  }
  
  @scala.inline
  implicit class ModelValuesMutableBuilder[Self <: ModelValues] (val x: Self) extends AnyVal {
