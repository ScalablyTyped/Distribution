...
@js.native
trait CancelChanges[T] extends js.Object {
...
object CancelChanges {
  ...
  @scala.inline
  def apply[T](): CancelChanges[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CancelChanges[T]]
  }
  
  @scala.inline
  implicit class CancelChangesOps[Self <: CancelChanges[_], T] (val x: Self with CancelChanges[T]) extends AnyVal {
