...
trait AnonElementEventJQueryEvent[T] extends js.Object {
...
object AnonElementEventJQueryEvent {
  @scala.inline
  def apply[T](
    component: T = null,
    ...
    __obj.asInstanceOf[AnonElementEventJQueryEvent[T]]
  }
}
