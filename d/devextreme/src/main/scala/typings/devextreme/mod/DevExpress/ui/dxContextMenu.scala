...
object dxContextMenu {
  ...
  */
  ...
  trait ExplicitTypes[TKey] extends StObject {
    ...
    var ContentReadyEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.ContentReadyEvent[TKey]
    
    var DisposingEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.DisposingEvent[TKey]
    
    var HiddenEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.HiddenEvent[TKey]
    
    var HidingEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.HidingEvent[TKey]
    
    var InitializedEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.InitializedEvent[TKey]
    
    var ItemClickEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.ItemClickEvent[TKey]
    
    var ItemContextMenuEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.ItemContextMenuEvent[TKey]
    
    var ItemRenderedEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.ItemRenderedEvent[TKey]
    
    var OptionChangedEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.OptionChangedEvent[TKey]
    
    var PositioningEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.PositioningEvent[TKey]
    
    var Properties: typings.devextreme.mod.DevExpress.ui.dxContextMenu.Properties[TKey]
    
    var SelectionChangedEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.SelectionChangedEvent[TKey]
    
    var ShowingEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.ShowingEvent[TKey]
    
    var ShownEvent: typings.devextreme.mod.DevExpress.ui.dxContextMenu.ShownEvent[TKey]
  }
