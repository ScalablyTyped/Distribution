...
trait BaseGaugeOptions[T] extends BaseWidgetOptions[T] {
  ...
  var onTooltipHidden: js.UndefOr[js.Function1[/* e */ ComponentElementModelTarget[T], _]] = js.undefined
  /** @name BaseGauge.Options.onTooltipShown */
  var onTooltipShown: js.UndefOr[js.Function1[/* e */ ComponentElementModelTarget[T], _]] = js.undefined
...
object BaseGaugeOptions {
  ...
  def apply[T](
    ...
    onTooltipHidden: /* e */ ComponentElementModelTarget[T] => _ = null,
    onTooltipShown: /* e */ ComponentElementModelTarget[T] => _ = null,
