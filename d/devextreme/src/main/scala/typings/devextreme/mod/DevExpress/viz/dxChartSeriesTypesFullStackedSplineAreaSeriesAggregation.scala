...
object dxChartSeriesTypesFullStackedSplineAreaSeriesAggregation {
  ...
  @scala.inline
  implicit class dxChartSeriesTypesFullStackedSplineAreaSeriesAggregationOps[Self <: dxChartSeriesTypesFullStackedSplineAreaSeriesAggregation] (val x: Self) extends AnyVal {
