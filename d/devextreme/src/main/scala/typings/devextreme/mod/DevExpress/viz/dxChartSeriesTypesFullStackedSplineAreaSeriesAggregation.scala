...
trait dxChartSeriesTypesFullStackedSplineAreaSeriesAggregation
  ...
  /**
    ...
    */
  @JSName("method")
  var method_dxChartSeriesTypesFullStackedSplineAreaSeriesAggregation: js.UndefOr[ChartSingleValueSeriesAggregationMethod] = js.undefined
}
object dxChartSeriesTypesFullStackedSplineAreaSeriesAggregation {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: dxChartSeriesTypesFullStackedSplineAreaSeriesAggregation] (val x: Self) extends AnyVal {
