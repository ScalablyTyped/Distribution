...
import typings.devextreme.AnonValidationGroup
...
object dxButtonOptions {
  ...
  def apply(
    ...
    icon: String = null,
    onClick: /* e */ AnonValidationGroup => _ = null,
    onContentReady: /* e */ AnonComponentElement[dxButton] => _ = null,
    onDisposing: /* e */ AnonModel[dxButton] => _ = null,
    onInitialized: /* e */ AnonElement[dxButton] => _ = null,
    onOptionChanged: /* e */ AnonName[dxButton] => _ = null,
    rtlEnabled: js.UndefOr[Boolean] = js.undefined,
    stylingMode: text | outlined | contained = null,
    tabIndex: Int | Double = null,
    template: typings.devextreme.mod.DevExpress.core.template | (js.Function2[/* buttonData */ AnonIcon, /* contentElement */ dxElement, String | Element | JQuery]) = null,
    text: String = null,
