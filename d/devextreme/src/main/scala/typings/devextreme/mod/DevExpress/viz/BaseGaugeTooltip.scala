...
trait BaseGaugeTooltip extends BaseWidgetTooltip {
  ...
  var customizeTooltip: js.UndefOr[js.Function1[/* scaleValue */ ValueText, _]] = js.undefined
}
...
object BaseGaugeTooltip {
  ...
  def apply(
    ...
    contentTemplate: template | (js.Function2[/* scaleValue */ ValueText, /* element */ dxElement, String | Element | JQuery]) = null,
    cornerRadius: js.UndefOr[Double] = js.undefined,
    customizeTooltip: /* scaleValue */ ValueText => _ = null,
