...
object BaseGaugeTooltip {
  ...
  implicit class BaseGaugeTooltipOps[Self <: BaseGaugeTooltip] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentTemplateFunction2(value: (/* scaleValue */ ValueText, /* element */ dxElement) => String | Element | JQuery): Self = this.set("contentTemplate", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setCustomizeTooltip(value: /* scaleValue */ ValueText => _): Self = this.set("customizeTooltip", js.Any.fromFunction1(value))
    @scala.inline
