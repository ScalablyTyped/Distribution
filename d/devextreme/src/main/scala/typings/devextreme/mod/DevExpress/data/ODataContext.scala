...
trait ODataContext extends StObject {
  ...
  /**
    ...
    */
  def get(operationName: String, params: js.Any): Promise[js.Any] & JQueryPromise[js.Any] = js.native
  
  /**
    * [descr:ODataContext.invoke(operationName, params, httpMethod)]
    */
  def invoke(operationName: String, params: js.Any, httpMethod: js.Any): Promise[Unit] & JQueryPromise[Unit] = js.native
