...
/* Inlined parent std.Omit<devextreme.devextreme.DevExpress.ui.dxTextBoxOptions<TComponent>, 'validationMessagePosition'> */
trait dxDropDownEditorOptions[TComponent] extends StObject {
