...
@js.native
trait dxDiagramBeforeChangeConnectorTextArgs extends js.Object {
...
object dxDiagramBeforeChangeConnectorTextArgs {
  ...
  @scala.inline
  def apply(): dxDiagramBeforeChangeConnectorTextArgs = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[dxDiagramBeforeChangeConnectorTextArgs]
  }
  
  @scala.inline
  implicit class dxDiagramBeforeChangeConnectorTextArgsOps[Self <: dxDiagramBeforeChangeConnectorTextArgs] (val x: Self) extends AnyVal {
