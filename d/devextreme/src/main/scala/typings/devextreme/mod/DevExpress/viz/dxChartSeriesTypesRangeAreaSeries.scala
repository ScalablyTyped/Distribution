...
object dxChartSeriesTypesRangeAreaSeries {
  @scala.inline
  def apply(
    aggregation: dxChartSeriesTypesRangeAreaSeriesAggregation = null,
    ...
    label: dxChartSeriesTypesRangeAreaSeriesLabel = null,
    ...
    pane: String = null,
    point: dxChartSeriesTypesRangeAreaSeriesPoint = null,
  ...
  ): dxChartSeriesTypesRangeAreaSeries = {
