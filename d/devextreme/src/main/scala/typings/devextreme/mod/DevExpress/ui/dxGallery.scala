...
import typings.devextreme.mod.DevExpress.ui.dxGallery.ItemLike
...
@js.native
trait dxGallery[TItem /* <: ItemLike */, TKey]
  extends StObject
     with CollectionWidget[dxGalleryOptions[TItem, TKey], TItem, TKey] {
...
object dxGallery {
  ...
  type ContentReadyEvent[TItem /* <: ItemLike */, TKey] = EventInfo[dxGallery[TItem, TKey]]
  
  type DisposingEvent[TItem /* <: ItemLike */, TKey] = EventInfo[dxGallery[TItem, TKey]]
  
  trait ExplicitTypes[TItem /* <: ItemLike */, TKey] extends StObject {
    
    var ContentReadyEvent: typings.devextreme.mod.DevExpress.ui.dxGallery.ContentReadyEvent[TItem, TKey]
    
    var DisposingEvent: typings.devextreme.mod.DevExpress.ui.dxGallery.DisposingEvent[TItem, TKey]
    
    var InitializedEvent: typings.devextreme.mod.DevExpress.ui.dxGallery.InitializedEvent[TItem, TKey]
    
    var ItemClickEvent: typings.devextreme.mod.DevExpress.ui.dxGallery.ItemClickEvent[TItem, TKey]
    
    var ItemContextMenuEvent: typings.devextreme.mod.DevExpress.ui.dxGallery.ItemContextMenuEvent[TItem, TKey]
    
    var ItemHoldEvent: typings.devextreme.mod.DevExpress.ui.dxGallery.ItemHoldEvent[TItem, TKey]
    
    var ItemRenderedEvent: typings.devextreme.mod.DevExpress.ui.dxGallery.ItemRenderedEvent[TItem, TKey]
    
    var OptionChangedEvent: typings.devextreme.mod.DevExpress.ui.dxGallery.OptionChangedEvent[TItem, TKey]
    
    var Properties: typings.devextreme.mod.DevExpress.ui.dxGallery.Properties[TItem, TKey]
    
    var SelectionChangedEvent: typings.devextreme.mod.DevExpress.ui.dxGallery.SelectionChangedEvent[TItem, TKey]
  }
  ...
  type InitializedEvent[TItem /* <: ItemLike */, TKey] = InitializedEventInfo[dxGallery[TItem, TKey]]
  
  type Item = dxGalleryItem
  
  trait ItemClickEvent[TItem /* <: ItemLike */, TKey]
    extends StObject
       with NativeEventInfo[dxGallery[TItem, TKey], KeyboardEvent | MouseEvent | PointerEvent]
       with ItemInfo[TItem]
  object ItemClickEvent {
    
    inline def apply[TItem /* <: ItemLike */, TKey](
      component: dxGallery[TItem, TKey],
  ...
  trait ItemContextMenuEvent[TItem /* <: ItemLike */, TKey]
    extends StObject
       with NativeEventInfo[dxGallery[TItem, TKey], MouseEvent | PointerEvent | TouchEvent]
       with ItemInfo[TItem]
  ...
  trait ItemRenderedEvent[TItem /* <: ItemLike */, TKey]
    extends StObject
       with EventInfo[dxGallery[TItem, TKey]]
       with ItemInfo[TItem]
  ...
  type Properties[TItem /* <: ItemLike */, TKey] = dxGalleryOptions[TItem, TKey]
