...
object dxFileUploader {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.devextreme.devextremeStrings.instantly
    - typings.devextreme.devextremeStrings.useButtons
    - typings.devextreme.devextremeStrings.useForm
  */
  trait FileUploadMode extends StObject
  object FileUploadMode {
    
    inline def instantly: typings.devextreme.devextremeStrings.instantly = "instantly".asInstanceOf[typings.devextreme.devextremeStrings.instantly]
    
    inline def useButtons: typings.devextreme.devextremeStrings.useButtons = "useButtons".asInstanceOf[typings.devextreme.devextremeStrings.useButtons]
    
    inline def useForm: typings.devextreme.devextremeStrings.useForm = "useForm".asInstanceOf[typings.devextreme.devextremeStrings.useForm]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.devextreme.devextremeStrings.PUT
  */
  trait UploadHttpMethod extends StObject
  object UploadHttpMethod {
    
    inline def POST: typings.devextreme.devextremeStrings.POST = "POST".asInstanceOf[typings.devextreme.devextremeStrings.POST]
    
    inline def PUT: typings.devextreme.devextremeStrings.PUT = "PUT".asInstanceOf[typings.devextreme.devextremeStrings.PUT]
  }
