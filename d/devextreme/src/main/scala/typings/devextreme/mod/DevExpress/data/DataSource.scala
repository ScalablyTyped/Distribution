...
import typings.devextreme.anon.keyinEventNameFunctionChanged
...
trait DataSource[TItem, TKey]
  ...
  /**
    ...
    */
  def store(): typings.devextreme.mod.DevExpress.data.utils.Store[TItem, TKey] = js.native
...
object DataSource {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - js.Array[TItem]
    - typings.devextreme.mod.DevExpress.data.utils.Store[TItem, TKey]
    - typings.devextreme.mod.DevExpress.data.DataSource.DataSourceOptionsStub[scala.Any, scala.Any, TItem]
    - typings.devextreme.mod.DevExpress.data.DataSource[TItem, TKey]
  */
  ...
  trait DataSourceOptionsStub[TStoreItem, TMappedItem, TItem] extends StObject {
    ...
    var store: js.UndefOr[
        js.Array[TStoreItem] | (typings.devextreme.mod.DevExpress.data.utils.Store[TStoreItem, Any]) | (typings.devextreme.mod.DevExpress.data.utils.StoreOptions[TStoreItem, Any])
      ] = js.undefined
  }
  object DataSourceOptionsStub {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: DataSourceOptionsStub[?, ?, ?], TStoreItem, TMappedItem, TItem] (val x: Self & (DataSourceOptionsStub[TStoreItem, TMappedItem, TItem])) extends AnyVal {
      ...
      inline def setStore(
        value: js.Array[TStoreItem] | (typings.devextreme.mod.DevExpress.data.utils.Store[TStoreItem, Any]) | (typings.devextreme.mod.DevExpress.data.utils.StoreOptions[TStoreItem, Any])
