...
object dxPolarChartValueAxisStripsLabel {
  @scala.inline
  def apply(): dxPolarChartValueAxisStripsLabel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[dxPolarChartValueAxisStripsLabel]
  }
  @scala.inline
  implicit class dxPolarChartValueAxisStripsLabelOps[Self <: dxPolarChartValueAxisStripsLabel] (val x: Self) extends AnyVal {
    @scala.inline
