...
object dxChartSeriesTypesFullStackedSplineSeries {
  @scala.inline
  def apply(
    aggregation: dxChartSeriesTypesFullStackedSplineSeriesAggregation = null,
    ...
    label: dxChartSeriesTypesFullStackedSplineSeriesLabel = null,
  ...
  ): dxChartSeriesTypesFullStackedSplineSeries = {
