...
object dxMenu {
  ...
  trait ExplicitTypes[TKey] extends StObject {
    ...
    var ContentReadyEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.ContentReadyEvent[TKey]
    
    var DisposingEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.DisposingEvent[TKey]
    
    var InitializedEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.InitializedEvent[TKey]
    
    var ItemClickEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.ItemClickEvent[TKey]
    
    var ItemContextMenuEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.ItemContextMenuEvent[TKey]
    
    var ItemRenderedEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.ItemRenderedEvent[TKey]
    
    var OptionChangedEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.OptionChangedEvent[TKey]
    
    var Properties: typings.devextreme.mod.DevExpress.ui.dxMenu.Properties[TKey]
    
    var SelectionChangedEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.SelectionChangedEvent[TKey]
    
    var SubmenuHiddenEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.SubmenuHiddenEvent[TKey]
    
    var SubmenuHidingEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.SubmenuHidingEvent[TKey]
    
    var SubmenuShowingEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.SubmenuShowingEvent[TKey]
    
    var SubmenuShownEvent: typings.devextreme.mod.DevExpress.ui.dxMenu.SubmenuShownEvent[TKey]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.devextreme.devextremeStrings.leftOrTop
    - typings.devextreme.devextremeStrings.rightOrBottom
  */
  ...
  object SubmenuDirection {
    ...
    inline def leftOrTop: typings.devextreme.devextremeStrings.leftOrTop = "leftOrTop".asInstanceOf[typings.devextreme.devextremeStrings.leftOrTop]
    
    inline def rightOrBottom: typings.devextreme.devextremeStrings.rightOrBottom = "rightOrBottom".asInstanceOf[typings.devextreme.devextremeStrings.rightOrBottom]
  }
