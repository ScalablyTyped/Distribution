...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.devextreme.devextremeStrings.anyof
  - typings.devextreme.devextremeStrings.noneof
*/
...
object FilterOperation {
  ...
  inline def anyof: typings.devextreme.devextremeStrings.anyof = "anyof".asInstanceOf[typings.devextreme.devextremeStrings.anyof]
  ...
  inline def noneof: typings.devextreme.devextremeStrings.noneof = "noneof".asInstanceOf[typings.devextreme.devextremeStrings.noneof]
