...
object dxTabs {
  ...
  trait ExplicitTypes[TItem /* <: ItemLike */, TKey] extends StObject {
    ...
    var ContentReadyEvent: typings.devextreme.mod.DevExpress.ui.dxTabs.ContentReadyEvent[TItem, TKey]
    
    var DisposingEvent: typings.devextreme.mod.DevExpress.ui.dxTabs.DisposingEvent[TItem, TKey]
    
    var InitializedEvent: typings.devextreme.mod.DevExpress.ui.dxTabs.InitializedEvent[TItem, TKey]
    
    var ItemClickEvent: typings.devextreme.mod.DevExpress.ui.dxTabs.ItemClickEvent[TItem, TKey]
    
    var ItemContextMenuEvent: typings.devextreme.mod.DevExpress.ui.dxTabs.ItemContextMenuEvent[TItem, TKey]
    
    var ItemHoldEvent: typings.devextreme.mod.DevExpress.ui.dxTabs.ItemHoldEvent[TItem, TKey]
    
    var ItemRenderedEvent: typings.devextreme.mod.DevExpress.ui.dxTabs.ItemRenderedEvent[TItem, TKey]
    
    var OptionChangedEvent: typings.devextreme.mod.DevExpress.ui.dxTabs.OptionChangedEvent[TItem, TKey]
    
    var Properties: typings.devextreme.mod.DevExpress.ui.dxTabs.Properties[TItem, TKey]
    
    var SelectionChangedEvent: typings.devextreme.mod.DevExpress.ui.dxTabs.SelectionChangedEvent[TItem, TKey]
  }
