...
trait DataSourceOptions[TStoreItem, TMappedItem, TItem, TKey] extends StObject {
  ...
  var store: js.UndefOr[
    js.Array[TStoreItem] | (typings.devextreme.mod.DevExpress.data.utils.Store[TStoreItem, TKey]) | (typings.devextreme.mod.DevExpress.data.utils.StoreOptions[TStoreItem, TKey])
  ] = js.undefined
}
object DataSourceOptions {
  ...
  implicit open class MutableBuilder[Self <: DataSourceOptions[?, ?, ?, ?], TStoreItem, TMappedItem, TItem, TKey] (val x: Self & (DataSourceOptions[TStoreItem, TMappedItem, TItem, TKey])) extends AnyVal {
    ...
    inline def setStore(
      value: js.Array[TStoreItem] | (typings.devextreme.mod.DevExpress.data.utils.Store[TStoreItem, TKey]) | (typings.devextreme.mod.DevExpress.data.utils.StoreOptions[TStoreItem, TKey])
