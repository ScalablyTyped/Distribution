...
import typings.devextreme.mod.DevExpress.ui.dxPopup.ResizeEndEvent
import typings.devextreme.mod.DevExpress.ui.dxPopup.ResizeEvent
import typings.devextreme.mod.DevExpress.ui.dxPopup.ResizeStartEvent
import typings.devextreme.mod.DevExpress.ui.dxPopup.TitleRenderedInfo
import typings.devextreme.mod.DevExpress.ui.dxPopup.ToolbarItem
...
object dxPopupOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: dxPopupOptions[?], TComponent] (val x: Self & dxPopupOptions[TComponent]) extends AnyVal {
