...
object dxChartSeriesTypesStackedSplineAreaSeries {
  @scala.inline
  def apply(
    aggregation: dxChartSeriesTypesStackedSplineAreaSeriesAggregation = null,
    ...
    label: dxChartSeriesTypesStackedSplineAreaSeriesLabel = null,
    ...
    pane: String = null,
    point: dxChartSeriesTypesStackedSplineAreaSeriesPoint = null,
  ...
  ): dxChartSeriesTypesStackedSplineAreaSeries = {
