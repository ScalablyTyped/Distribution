...
import typings.devextreme.mod.DevExpress.ui.dxTreeList.ColumnButtonClickEvent
import typings.devextreme.mod.DevExpress.ui.dxTreeList.ColumnButtonTemplateData
...
object dxTreeListColumnButton {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: dxTreeListColumnButton[?, ?], TRowData, TKey] (val x: Self & (dxTreeListColumnButton[TRowData, TKey])) extends AnyVal {
