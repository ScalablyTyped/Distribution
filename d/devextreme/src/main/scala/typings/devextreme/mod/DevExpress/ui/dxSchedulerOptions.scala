...
import typings.devextreme.mod.DevExpress.ui.dxScheduler.Appointment
import typings.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentAddedEvent
import typings.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentAddingEvent
import typings.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentClickEvent
import typings.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentCollectorTemplateData
import typings.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentContextMenuEvent
import typings.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentDblClickEvent
import typings.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentDeletedEvent
import typings.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentDeletingEvent
import typings.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentFormOpeningEvent
...
import typings.devextreme.mod.DevExpress.ui.dxScheduler.CellClickEvent
import typings.devextreme.mod.DevExpress.ui.dxScheduler.CellContextMenuEvent
import typings.devextreme.mod.DevExpress.ui.dxScheduler.DateNavigatorTextInfo
...
object dxSchedulerOptions {
  ...
  extension [Self <: dxSchedulerOptions](x: Self) {
    ...
    inline def setOnAppointmentTooltipShowing(value: /* e */ AppointmentTooltipShowingEvent => Unit): Self = StObject.set(x, "onAppointmentTooltipShowing", js.Any.fromFunction1(value))
