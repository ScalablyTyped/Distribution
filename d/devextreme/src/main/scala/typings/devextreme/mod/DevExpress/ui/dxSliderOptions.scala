...
object dxSliderOptions {
  ...
  def apply(
    ...
    min: Int | Double = null,
    name: String = null,
    onContentReady: /* e */ AnonComponentElement[dxSlider] => _ = null,
    onDisposing: /* e */ AnonModel[dxSlider] => _ = null,
    onInitialized: /* e */ AnonElement[dxSlider] => _ = null,
    onOptionChanged: /* e */ AnonName[dxSlider] => _ = null,
    onValueChanged: /* e */ AnonJQueryEvent[dxSlider] => _ = null,
