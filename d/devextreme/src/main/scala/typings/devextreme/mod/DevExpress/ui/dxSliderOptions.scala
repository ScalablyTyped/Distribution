...
object dxSliderOptions {
  ...
  def apply(
    ...
    name: String = null,
    onContentReady: /* e */ ComponentElement[dxSlider] => _ = null,
    onDisposing: /* e */ Model[dxSlider] => _ = null,
    onInitialized: /* e */ Element[dxSlider] => _ = null,
    onOptionChanged: /* e */ Name[dxSlider] => _ = null,
    onValueChanged: /* e */ JQueryEvent[dxSlider] => _ = null,
