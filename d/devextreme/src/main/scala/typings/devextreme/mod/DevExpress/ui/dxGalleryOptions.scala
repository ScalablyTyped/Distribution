...
object dxGalleryOptions {
  ...
  def apply(
    ...
    initialItemWidth: js.UndefOr[Double] = js.undefined,
    ...
    onContentReady: /* e */ ComponentElement[dxGallery] => _ = null,
    onDisposing: /* e */ Model[dxGallery] => _ = null,
    onInitialized: /* e */ typings.devextreme.anon.Element[dxGallery] => _ = null,
    onItemClick: (js.Function1[/* e */ Event[dxGallery], _]) | String = null,
    onItemContextMenu: /* e */ Event[dxGallery] => _ = null,
    onItemHold: /* e */ ItemData[dxGallery] => _ = null,
    onItemRendered: /* e */ ItemElement[dxGallery] => _ = null,
    onOptionChanged: /* e */ Name[dxGallery] => _ = null,
    onSelectionChanged: /* e */ AddedItems[dxGallery] => _ = null,
    ...
    slideshowDelay: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(indicatorEnabled)) __obj.updateDynamic("indicatorEnabled")(indicatorEnabled.get.asInstanceOf[js.Any])
    if (!js.isUndefined(initialItemWidth)) __obj.updateDynamic("initialItemWidth")(initialItemWidth.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(slideshowDelay)) __obj.updateDynamic("slideshowDelay")(slideshowDelay.get.asInstanceOf[js.Any])
    if (!js.isUndefined(stretchImages)) __obj.updateDynamic("stretchImages")(stretchImages.get.asInstanceOf[js.Any])
