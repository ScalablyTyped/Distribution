...
trait AnonComponentElementEventJQueryEvent extends js.Object {
...
object AnonComponentElementEventJQueryEvent {
  @scala.inline
  def apply(
  ...
  ): AnonComponentElementEventJQueryEvent = {
    ...
    __obj.asInstanceOf[AnonComponentElementEventJQueryEvent]
  }
}
