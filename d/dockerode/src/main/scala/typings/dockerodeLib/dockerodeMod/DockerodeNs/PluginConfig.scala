...
trait PluginConfig extends js.Object {
  var Args: dockerodeLib.dockerodeMod.DockerodeNs.Args
  ...
  var Linux: dockerodeLib.dockerodeMod.DockerodeNs.Linux
  var Mounts: js.Array[PluginMount]
  var Network: dockerodeLib.dockerodeMod.DockerodeNs.Network
