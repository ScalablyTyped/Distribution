...
class Network protected () extends js.Object {
  ...
  def connect(callback: Callback[_]): scala.Unit = js.native
  def connect(options: js.Object): js.Promise[_] = js.native
  def connect(options: js.Object, callback: Callback[_]): scala.Unit = js.native
  def disconnect(): js.Promise[_] = js.native
  def disconnect(callback: Callback[_]): scala.Unit = js.native
  def disconnect(options: js.Object): js.Promise[_] = js.native
  def disconnect(options: js.Object, callback: Callback[_]): scala.Unit = js.native
