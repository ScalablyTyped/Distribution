...
class Plugin protected () extends js.Object {
  ...
  def configure(callback: Callback[_]): scala.Unit = js.native
  def configure(options: js.Object): js.Promise[_] = js.native
  def configure(options: js.Object, callback: Callback[_]): scala.Unit = js.native
  def disable(): js.Promise[_] = js.native
  def disable(callback: Callback[_]): scala.Unit = js.native
  def disable(options: js.Object): js.Promise[_] = js.native
  def disable(options: js.Object, callback: Callback[_]): scala.Unit = js.native
  def enable(): js.Promise[_] = js.native
  def enable(callback: Callback[_]): scala.Unit = js.native
  def enable(options: js.Object): js.Promise[_] = js.native
  def enable(options: js.Object, callback: Callback[_]): scala.Unit = js.native
  def inspect(): js.Promise[PluginInspectInfo] = js.native
  def inspect(callback: Callback[PluginInspectInfo]): scala.Unit = js.native
  def privileges(): js.Promise[_] = js.native
  def privileges(callback: Callback[_]): scala.Unit = js.native
  def pull(options: js.Object): js.Promise[_] = js.native
  def pull(options: js.Object, callback: Callback[_]): scala.Unit = js.native
  def push(): js.Promise[_] = js.native
  def push(callback: Callback[_]): scala.Unit = js.native
  def push(options: js.Object): js.Promise[_] = js.native
  def push(options: js.Object, callback: Callback[_]): scala.Unit = js.native
  ...
  def upgrade(auth: js.Any, callback: Callback[_]): scala.Unit = js.native
  def upgrade(auth: js.Any, options: js.Object): js.Promise[_] = js.native
  def upgrade(auth: js.Any, options: js.Object, callback: Callback[_]): scala.Unit = js.native
}
