...
object Anon_AutoRemove {
  ...
  def apply(
    ...
    Devices: js.Array[dockerodeLib.dockerodeMod.DockerodeNs.DeviceMapping] = null,
    ...
    LogConfig: dockerodeLib.dockerodeMod.DockerodeNs.LogConfig = null,
    ...
    Mounts: dockerodeLib.dockerodeMod.DockerodeNs.MountConfig = null,
    ...
    PortBindings: dockerodeLib.dockerodeMod.DockerodeNs.PortMap = null,
    ...
    RestartPolicy: dockerodeLib.dockerodeMod.DockerodeNs.RestartPolicy = null,
