...
@js.native
trait ArgsEscaped extends js.Object {
...
object ArgsEscaped {
  ...
  @scala.inline
  implicit class ArgsEscapedOps[Self <: ArgsEscaped] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setArgsEscaped(value: Boolean): Self = this.set("ArgsEscaped", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnBuildVarargs(value: js.Any*): Self = this.set("OnBuild", js.Array(value :_*))
    @scala.inline
    def setOnBuild(value: js.Array[_]): Self = this.set("OnBuild", value.asInstanceOf[js.Any])
    @scala.inline
