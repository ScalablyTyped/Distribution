...
open class Image protected () extends StObject {
  ...
  def get(): js.Promise[ReadableStream[Any]] = js.native
  def get(callback: Callback[ReadableStream[Any]]): Unit = js.native
  ...
  def push(): js.Promise[ReadableStream[Any]] = js.native
  def push(callback: Callback[ReadableStream[Any]]): Unit = js.native
  def push(options: ImagePushOptions): js.Promise[ReadableStream[Any]] = js.native
  def push(options: ImagePushOptions, callback: Callback[ReadableStream[Any]]): Unit = js.native
