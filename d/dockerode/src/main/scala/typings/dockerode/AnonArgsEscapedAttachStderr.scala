...
trait AnonArgsEscapedAttachStderr extends js.Object {
...
object AnonArgsEscapedAttachStderr {
  @scala.inline
  def apply(
    ArgsEscaped: Boolean,
    ...
    __obj.asInstanceOf[AnonArgsEscapedAttachStderr]
  }
}
