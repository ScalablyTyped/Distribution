...
import typings.terserMCwkxx7L.anon.Col
import typings.terserMCwkxx7L.terserMCwkxx7LBooleans.`false`
import typings.terserMCwkxx7L.terserMCwkxx7LStrings.all
import typings.terserMCwkxx7L.terserMCwkxx7LStrings.some
...
object OutputOptions {
  ...
  extension [Self <: OutputOptions](x: Self) {
    ...
    inline def setCommentsFunction2(value: (/* node */ ASTNode, /* comment */ Col) => Boolean): Self = StObject.set(x, "comments", js.Any.fromFunction2(value))
