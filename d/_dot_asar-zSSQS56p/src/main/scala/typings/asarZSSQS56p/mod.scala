...
import typings.asarZSSQS56p.anon.Algorithm
import typings.asarZSSQS56p.anon.Stat
import typings.asarZSSQS56p.asarZSSQS56pBooleans.`true`
...
object mod {
  ...
  @JSImport(".asar-zSSQS56p", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.asarZSSQS56p.asarZSSQS56pStrings.directory
    - typings.asarZSSQS56p.asarZSSQS56pStrings.file
    - typings.asarZSSQS56p.asarZSSQS56pStrings.link
  */
  trait InputMetadataType extends StObject
  object InputMetadataType {
    
    inline def directory: typings.asarZSSQS56p.asarZSSQS56pStrings.directory = "directory".asInstanceOf[typings.asarZSSQS56p.asarZSSQS56pStrings.directory]
    
    inline def file: typings.asarZSSQS56p.asarZSSQS56pStrings.file = "file".asInstanceOf[typings.asarZSSQS56p.asarZSSQS56pStrings.file]
    
    inline def link: typings.asarZSSQS56p.asarZSSQS56pStrings.link = "link".asInstanceOf[typings.asarZSSQS56p.asarZSSQS56pStrings.link]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.asarZSSQS56p.mod.DirectoryMetadata
    - typings.asarZSSQS56p.mod.FileMetadata
    - typings.asarZSSQS56p.mod.LinkMetadata
  */
  trait Metadata extends StObject
  object Metadata {
    
    inline def DirectoryMetadata(files: StringDictionary[EntryMetadata], unpacked: Boolean): typings.asarZSSQS56p.mod.DirectoryMetadata = {
      val __obj = js.Dynamic.literal(files = files.asInstanceOf[js.Any], unpacked = unpacked.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.asarZSSQS56p.mod.DirectoryMetadata]
    }
    
    inline def FileMetadata(unpacked: Boolean): typings.asarZSSQS56p.mod.FileMetadata = {
      val __obj = js.Dynamic.literal(unpacked = unpacked.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.asarZSSQS56p.mod.FileMetadata]
    }
    
    inline def LinkMetadata(link: String): typings.asarZSSQS56p.mod.LinkMetadata = {
      val __obj = js.Dynamic.literal(link = link.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.asarZSSQS56p.mod.LinkMetadata]
    }
  }
}
