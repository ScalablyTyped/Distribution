...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-router" % "5.1-dt-20201002Z-f6b3aa",
  "org.scalablytyped" %%% "react-router-dom" % "5.1-dt-20201006Z-c16539",
  "org.scalablytyped" %%% "react-router-redux" % "5.0-dt-20200515Z-e0becb",
