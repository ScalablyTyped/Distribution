...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-router" % "5.0-dt-20190520Z-68ffd3",
  "org.scalablytyped" %%% "react-router-dom" % "4.3-dt-20190506Z-201d50",
  "org.scalablytyped" %%% "react-router-redux" % "5.0-dt-20190212Z-b3d0ec",
