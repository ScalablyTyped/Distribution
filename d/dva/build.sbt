...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-router" % "4.4-dt-20190103Z-90fc15",
  "org.scalablytyped" %%% "react-router-dom" % "4.3-dt-20181211Z-732555",
  "org.scalablytyped" %%% "react-router-redux" % "5.0-dt-20181122Z-9a5469",
