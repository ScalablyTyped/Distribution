...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-router" % "4.4-dt-20190228Z-73dcd2",
  "org.scalablytyped" %%% "react-router-dom" % "4.3-dt-20190404Z-cbdfd3",
  "org.scalablytyped" %%% "react-router-redux" % "5.0-dt-20190212Z-3af6b3",
