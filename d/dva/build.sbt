...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "react-router" % "4.4-dt-20181109Z-ab18e0",
  "com.scalablytyped" %%% "react-router-dom" % "4.3-dt-20180915Z-e7e767",
  "com.scalablytyped" %%% "react-router-redux" % "5.0-dt-20180915Z-871951",
