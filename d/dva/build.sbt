...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-router" % "6.4.2-2befe3",
  "org.scalablytyped" %%% "react-router-dom" % "6.4.2-b3580e",
  "org.scalablytyped" %%% "react-router-redux" % "5.0-dt-20220712Z-e71795",
