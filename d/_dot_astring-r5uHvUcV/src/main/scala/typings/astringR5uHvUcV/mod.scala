package typings.astringR5uHvUcV
...
object mod {
  ...
  @JSImport(".astring-r5uHvUcV", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport(".astring-r5uHvUcV", "GENERATOR")
  @js.native
  val GENERATOR_ : Generator = js.native
  
  @JSImport(".astring-r5uHvUcV", "baseGenerator")
  @js.native
  ...
  {[ T in estree.estree.Node['type'] ]: (node : estree.estree.Node & {  type :T}, state : .astring-r5uHvUcV..astring-r5uHvUcV.State): void}
    */ typings.astringR5uHvUcV.astringR5uHvUcVStrings.Generator & TopLevel[Any]
