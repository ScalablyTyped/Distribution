...
object EnumDWTCapPrinterMode extends StObject {
  ...
  /* 2 */ val TWPM_COMPOUNDSTRING: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapPrinterMode.TWPM_COMPOUNDSTRING & Double = js.native
  ...
  sealed trait TWPM_MULTISTRING
    extends StObject
       with EnumDWTCapPrinterMode
  /* 1 */ val TWPM_MULTISTRING: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapPrinterMode.TWPM_MULTISTRING & Double = js.native
  ...
  sealed trait TWPM_SINGLESTRING
    extends StObject
       with EnumDWTCapPrinterMode
  /* 0 */ val TWPM_SINGLESTRING: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapPrinterMode.TWPM_SINGLESTRING & Double = js.native
}
