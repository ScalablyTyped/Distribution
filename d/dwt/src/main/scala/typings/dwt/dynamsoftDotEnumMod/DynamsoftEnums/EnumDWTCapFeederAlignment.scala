...
object EnumDWTCapFeederAlignment extends StObject {
  ...
  /* 2 */ val TWFA_CENTER: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapFeederAlignment.TWFA_CENTER & Double = js.native
  ...
  sealed trait TWFA_LEFT
    extends StObject
       with EnumDWTCapFeederAlignment
  /* 1 */ val TWFA_LEFT: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapFeederAlignment.TWFA_LEFT & Double = js.native
  ...
  sealed trait TWFA_NONE
    extends StObject
       with EnumDWTCapFeederAlignment
  /* 0 */ val TWFA_NONE: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapFeederAlignment.TWFA_NONE & Double = js.native
  ...
  sealed trait TWFA_RIGHT
    extends StObject
       with EnumDWTCapFeederAlignment
  /* 3 */ val TWFA_RIGHT: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapFeederAlignment.TWFA_RIGHT & Double = js.native
}
