...
object EnumDWTOCRDownloadType extends StObject {
  ...
  /* 0 */ val OCRDT_Dll: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTOCRDownloadType.OCRDT_Dll & Double = js.native
  
  @js.native
  sealed trait OCRDT_LANGUAGE
    extends StObject
       with EnumDWTOCRDownloadType
  /* 1 */ val OCRDT_LANGUAGE: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTOCRDownloadType.OCRDT_LANGUAGE & Double = js.native
}
