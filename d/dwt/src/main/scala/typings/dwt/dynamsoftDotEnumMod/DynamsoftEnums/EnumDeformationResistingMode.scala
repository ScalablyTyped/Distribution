...
object EnumDeformationResistingMode extends StObject {
  ...
  /* 1 */ val DRM_AUTO: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDeformationResistingMode.DRM_AUTO & Double = js.native
  
  @js.native
  sealed trait DRM_GENERAL
    extends StObject
       with EnumDeformationResistingMode
  /* 2 */ val DRM_GENERAL: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDeformationResistingMode.DRM_GENERAL & Double = js.native
  
  @js.native
  sealed trait DRM_SKIP
    extends StObject
       with EnumDeformationResistingMode
  /* 0 */ val DRM_SKIP: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDeformationResistingMode.DRM_SKIP & Double = js.native
}
