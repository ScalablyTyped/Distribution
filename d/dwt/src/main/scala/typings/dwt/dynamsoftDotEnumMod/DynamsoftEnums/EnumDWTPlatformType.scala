...
object EnumDWTPlatformType extends StObject {
  ...
  /* 2 */ val enumLinux: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTPlatformType.enumLinux & Double = js.native
  ...
  sealed trait enumMac
    extends StObject
       with EnumDWTPlatformType
  /* 1 */ val enumMac: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTPlatformType.enumMac & Double = js.native
  ...
  sealed trait enumWindow
    extends StObject
       with EnumDWTPlatformType
  /* 0 */ val enumWindow: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTPlatformType.enumWindow & Double = js.native
}
