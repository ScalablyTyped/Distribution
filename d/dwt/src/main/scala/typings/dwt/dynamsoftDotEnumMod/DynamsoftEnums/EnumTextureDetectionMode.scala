...
object EnumTextureDetectionMode extends StObject {
  ...
  /* 1 */ val TDM_AUTO: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumTextureDetectionMode.TDM_AUTO & Double = js.native
  
  @js.native
  sealed trait TDM_GENERAL_WIDTH_CONCENTRATION
    extends StObject
       with EnumTextureDetectionMode
  /* 2 */ val TDM_GENERAL_WIDTH_CONCENTRATION: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumTextureDetectionMode.TDM_GENERAL_WIDTH_CONCENTRATION & Double = js.native
  
  @js.native
  sealed trait TDM_SKIP
    extends StObject
       with EnumTextureDetectionMode
  /* 0 */ val TDM_SKIP: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumTextureDetectionMode.TDM_SKIP & Double = js.native
}
