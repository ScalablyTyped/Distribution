...
object EnumDWTCapType extends StObject {
  ...
  sealed trait TWON_ARRAY
    extends StObject
       with EnumDWTCapType
  /* 3 */ val TWON_ARRAY: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapType.TWON_ARRAY & Double = js.native
  ...
  sealed trait TWON_ENUMERATION
    extends StObject
       with EnumDWTCapType
  /* 4 */ val TWON_ENUMERATION: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapType.TWON_ENUMERATION & Double = js.native
  ...
  sealed trait TWON_NONE
    extends StObject
       with EnumDWTCapType
  /* 0 */ val TWON_NONE: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapType.TWON_NONE & Double = js.native
  ...
  sealed trait TWON_ONEVALUE
    extends StObject
       with EnumDWTCapType
  /* 5 */ val TWON_ONEVALUE: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapType.TWON_ONEVALUE & Double = js.native
  ...
  sealed trait TWON_RANGE
    extends StObject
       with EnumDWTCapType
  /* 6 */ val TWON_RANGE: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapType.TWON_RANGE & Double = js.native
}
