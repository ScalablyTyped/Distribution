...
object EnumDWTFitWindowType extends StObject {
  ...
  /* 0 */ val enumFitWindow: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTFitWindowType.enumFitWindow & Double = js.native
  ...
  sealed trait enumFitWindowHeight
    extends StObject
       with EnumDWTFitWindowType
  /* 1 */ val enumFitWindowHeight: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTFitWindowType.enumFitWindowHeight & Double = js.native
  ...
  sealed trait enumFitWindowWidth
    extends StObject
       with EnumDWTFitWindowType
  /* 2 */ val enumFitWindowWidth: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTFitWindowType.enumFitWindowWidth & Double = js.native
}
