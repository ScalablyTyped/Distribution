...
object EnumDWTCapBitOrder extends StObject {
  ...
  /* 0 */ val TWBO_LSBFIRST: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapBitOrder.TWBO_LSBFIRST & Double = js.native
  ...
  sealed trait TWBO_MSBFIRST
    extends StObject
       with EnumDWTCapBitOrder
  /* 1 */ val TWBO_MSBFIRST: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapBitOrder.TWBO_MSBFIRST & Double = js.native
}
