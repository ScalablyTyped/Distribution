...
object EnumDWTBorderStyle extends StObject {
  ...
  /* 0 */ val TWBS_NONE: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTBorderStyle.TWBS_NONE & Double = js.native
  ...
  sealed trait TWBS_SINGLE3D
    extends StObject
       with EnumDWTBorderStyle
  /* 2 */ val TWBS_SINGLE3D: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTBorderStyle.TWBS_SINGLE3D & Double = js.native
  ...
  sealed trait TWBS_SINGLEFLAT
    extends StObject
       with EnumDWTBorderStyle
  /* 1 */ val TWBS_SINGLEFLAT: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTBorderStyle.TWBS_SINGLEFLAT & Double = js.native
}
