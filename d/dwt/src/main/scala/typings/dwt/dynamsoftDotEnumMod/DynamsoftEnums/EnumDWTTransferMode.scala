...
object EnumDWTTransferMode extends StObject {
  ...
  /* 1 */ val TWSX_FILE: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTTransferMode.TWSX_FILE & Double = js.native
  ...
  sealed trait TWSX_MEMORY
    extends StObject
       with EnumDWTTransferMode
  /* 2 */ val TWSX_MEMORY: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTTransferMode.TWSX_MEMORY & Double = js.native
  ...
  sealed trait TWSX_NATIVE
    extends StObject
       with EnumDWTTransferMode
  /* 0 */ val TWSX_NATIVE: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTTransferMode.TWSX_NATIVE & Double = js.native
}
