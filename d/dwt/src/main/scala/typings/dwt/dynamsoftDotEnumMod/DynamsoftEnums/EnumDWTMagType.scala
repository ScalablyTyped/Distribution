...
object EnumDWTMagType extends StObject {
  ...
  sealed trait TWMD_INVALID
    extends StObject
       with EnumDWTMagType
  /* 2 */ val TWMD_INVALID: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTMagType.TWMD_INVALID & Double = js.native
  ...
  sealed trait TWMD_MICR
    extends StObject
       with EnumDWTMagType
  /* 0 */ val TWMD_MICR: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTMagType.TWMD_MICR & Double = js.native
  ...
  sealed trait TWMD_RAW
    extends StObject
       with EnumDWTMagType
  /* 1 */ val TWMD_RAW: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTMagType.TWMD_RAW & Double = js.native
}
