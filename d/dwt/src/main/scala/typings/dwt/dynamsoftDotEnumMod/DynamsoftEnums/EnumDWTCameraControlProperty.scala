...
object EnumDWTCameraControlProperty extends StObject {
  ...
  /* 4 */ val CCP_EXPOSURE: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_EXPOSURE & Double = js.native
  ...
  sealed trait CCP_FOCUS
    extends StObject
       with EnumDWTCameraControlProperty
  /* 6 */ val CCP_FOCUS: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_FOCUS & Double = js.native
  ...
  sealed trait CCP_IRIS
    extends StObject
       with EnumDWTCameraControlProperty
  /* 5 */ val CCP_IRIS: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_IRIS & Double = js.native
  ...
  sealed trait CCP_PAN
    extends StObject
       with EnumDWTCameraControlProperty
  /* 0 */ val CCP_PAN: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_PAN & Double = js.native
  ...
  sealed trait CCP_ROLL
    extends StObject
       with EnumDWTCameraControlProperty
  /* 2 */ val CCP_ROLL: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_ROLL & Double = js.native
  ...
  sealed trait CCP_TILT
    extends StObject
       with EnumDWTCameraControlProperty
  /* 1 */ val CCP_TILT: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_TILT & Double = js.native
  ...
  sealed trait CCP_ZOOM
    extends StObject
       with EnumDWTCameraControlProperty
  /* 3 */ val CCP_ZOOM: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCameraControlProperty.CCP_ZOOM & Double = js.native
}
