...
object EnumResultCoordinateType extends StObject {
  ...
  /* 2 */ val RCT_PERCENTAGE: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumResultCoordinateType.RCT_PERCENTAGE & Double = js.native
  
  @js.native
  sealed trait RCT_PIXEL
    extends StObject
       with EnumResultCoordinateType
  /* 1 */ val RCT_PIXEL: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumResultCoordinateType.RCT_PIXEL & Double = js.native
}
