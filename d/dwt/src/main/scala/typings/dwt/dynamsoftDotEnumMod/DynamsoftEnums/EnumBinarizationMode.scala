...
object EnumBinarizationMode extends StObject {
  ...
  /* 1 */ val BM_AUTO: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumBinarizationMode.BM_AUTO & Double = js.native
  
  @js.native
  sealed trait BM_LOCAL_BLOCK
    extends StObject
       with EnumBinarizationMode
  /* 2 */ val BM_LOCAL_BLOCK: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumBinarizationMode.BM_LOCAL_BLOCK & Double = js.native
  
  @js.native
  sealed trait BM_SKIP
    extends StObject
       with EnumBinarizationMode
  /* 0 */ val BM_SKIP: typings.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumBinarizationMode.BM_SKIP & Double = js.native
}
