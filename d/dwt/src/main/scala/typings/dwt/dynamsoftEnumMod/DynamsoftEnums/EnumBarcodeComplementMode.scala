...
object EnumBarcodeComplementMode extends StObject {
  ...
  /* 1 */ val BCM_AUTO: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumBarcodeComplementMode.BCM_AUTO & Double = js.native
  
  @js.native
  sealed trait BCM_GENERAL
    extends StObject
       with EnumBarcodeComplementMode
  /* 2 */ val BCM_GENERAL: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumBarcodeComplementMode.BCM_GENERAL & Double = js.native
  
  @js.native
  sealed trait BCM_SKIP
    extends StObject
       with EnumBarcodeComplementMode
  /* 0 */ val BCM_SKIP: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumBarcodeComplementMode.BCM_SKIP & Double = js.native
}
