...
object EnumDWTUploadDataFormat extends StObject {
  ...
  /* 1 */ val Base64: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTUploadDataFormat.Base64 & Double = js.native
  
  @js.native
  sealed trait Binary
    extends StObject
       with EnumDWTUploadDataFormat
  /* 0 */ val Binary: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTUploadDataFormat.Binary & Double = js.native
}
