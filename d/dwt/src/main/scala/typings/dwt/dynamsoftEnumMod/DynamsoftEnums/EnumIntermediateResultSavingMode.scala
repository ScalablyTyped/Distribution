...
object EnumIntermediateResultSavingMode extends StObject {
  ...
  /* 4 */ val IRSM_BOTH: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumIntermediateResultSavingMode.IRSM_BOTH & Double = js.native
  
  @js.native
  sealed trait IRSM_FILESYSTEM
    extends StObject
       with EnumIntermediateResultSavingMode
  /* 2 */ val IRSM_FILESYSTEM: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumIntermediateResultSavingMode.IRSM_FILESYSTEM & Double = js.native
  
  @js.native
  sealed trait IRSM_MEMORY
    extends StObject
       with EnumIntermediateResultSavingMode
  /* 1 */ val IRSM_MEMORY: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumIntermediateResultSavingMode.IRSM_MEMORY & Double = js.native
}
