...
object EnumDWTCapFlipRotation extends StObject {
  ...
  /* 0 */ val TWFR_BOOK: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapFlipRotation.TWFR_BOOK & Double = js.native
  ...
  sealed trait TWFR_FANFOLD
    extends StObject
       with EnumDWTCapFlipRotation
  /* 1 */ val TWFR_FANFOLD: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapFlipRotation.TWFR_FANFOLD & Double = js.native
}
