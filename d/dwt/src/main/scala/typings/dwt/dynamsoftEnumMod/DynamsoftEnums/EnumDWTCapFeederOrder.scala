...
object EnumDWTCapFeederOrder extends StObject {
  ...
  /* 0 */ val TWFO_FIRSTPAGEFIRST: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapFeederOrder.TWFO_FIRSTPAGEFIRST & Double = js.native
  ...
  sealed trait TWFO_LASTPAGEFIRST
    extends StObject
       with EnumDWTCapFeederOrder
  /* 1 */ val TWFO_LASTPAGEFIRST: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTCapFeederOrder.TWFO_LASTPAGEFIRST & Double = js.native
}
