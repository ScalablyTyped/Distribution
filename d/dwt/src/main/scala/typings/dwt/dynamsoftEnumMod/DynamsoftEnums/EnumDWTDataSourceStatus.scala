...
object EnumDWTDataSourceStatus extends StObject {
  ...
  /* 3 */ val TWDSS_ACQUIRING: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTDataSourceStatus.TWDSS_ACQUIRING & Double = js.native
  ...
  sealed trait TWDSS_CLOSED
    extends StObject
       with EnumDWTDataSourceStatus
  /* 0 */ val TWDSS_CLOSED: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTDataSourceStatus.TWDSS_CLOSED & Double = js.native
  ...
  sealed trait TWDSS_ENABLED
    extends StObject
       with EnumDWTDataSourceStatus
  /* 2 */ val TWDSS_ENABLED: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTDataSourceStatus.TWDSS_ENABLED & Double = js.native
  ...
  sealed trait TWDSS_OPENED
    extends StObject
       with EnumDWTDataSourceStatus
  /* 1 */ val TWDSS_OPENED: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTDataSourceStatus.TWDSS_OPENED & Double = js.native
}
