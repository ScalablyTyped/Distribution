...
object EnumConflictMode extends StObject {
  ...
  /* 1 */ val CM_IGNORE: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumConflictMode.CM_IGNORE with Double = js.native
  
  @js.native
  sealed trait CM_OVERWRITE extends EnumConflictMode
  /* 2 */ val CM_OVERWRITE: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumConflictMode.CM_OVERWRITE with Double = js.native
}
