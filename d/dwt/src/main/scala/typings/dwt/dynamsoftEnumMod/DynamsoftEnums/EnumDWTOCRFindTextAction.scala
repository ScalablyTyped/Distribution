...
object EnumDWTOCRFindTextAction extends StObject {
  ...
  /* 0 */ val OCRFT_HIGHLIGHT: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRFindTextAction.OCRFT_HIGHLIGHT & Double = js.native
  
  @js.native
  sealed trait OCRFT_MARKFORREDACT
    extends StObject
       with EnumDWTOCRFindTextAction
  /* 2 */ val OCRFT_MARKFORREDACT: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRFindTextAction.OCRFT_MARKFORREDACT & Double = js.native
  
  @js.native
  sealed trait OCRFT_STRIKEOUT
    extends StObject
       with EnumDWTOCRFindTextAction
  /* 1 */ val OCRFT_STRIKEOUT: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumDWTOCRFindTextAction.OCRFT_STRIKEOUT & Double = js.native
}
