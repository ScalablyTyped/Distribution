...
object EnumGrayscaleTransformationMode extends StObject {
  ...
  /* 1 */ val GTM_INVERTED: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumGrayscaleTransformationMode.GTM_INVERTED & Double = js.native
  
  @js.native
  sealed trait GTM_ORIGINAL
    extends StObject
       with EnumGrayscaleTransformationMode
  /* 2 */ val GTM_ORIGINAL: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumGrayscaleTransformationMode.GTM_ORIGINAL & Double = js.native
  
  @js.native
  sealed trait GTM_SKIP
    extends StObject
       with EnumGrayscaleTransformationMode
  /* 0 */ val GTM_SKIP: typings.dwt.dynamsoftEnumMod.DynamsoftEnums.EnumGrayscaleTransformationMode.GTM_SKIP & Double = js.native
}
