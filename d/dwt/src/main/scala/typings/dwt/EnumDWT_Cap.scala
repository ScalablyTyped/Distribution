...
object EnumDWT_Cap extends js.Object {
  ...
  @js.native
  sealed trait CAP_ALARMS extends EnumDWT_Cap
  ...
  /** If TRUE, the Source will automatically feed the next page from the document feeder after the
    ...
    */
  @js.native
  sealed trait CAP_AUTOFEED extends EnumDWT_Cap
  ...
  /** The number of images to automatically capture. This does not refer to the number of images to
    ...
    */
  @js.native
  sealed trait CAP_AUTOMATICCAPTURE extends EnumDWT_Cap
  
  /** Added 2.1  */
  @js.native
  sealed trait CAP_AUTOMATICSENSEMEDIUM extends EnumDWT_Cap
  ...
  /** This capability is intended to boost the performance of a Source. The fundamental assumption
    ...
    */
  @js.native
  sealed trait CAP_AUTOSCAN extends EnumDWT_Cap
  
  /** The minutes of battery power remaining to the device. */
  @js.native
  sealed trait CAP_BATTERYMINUTES extends EnumDWT_Cap
  ...
  @js.native
  sealed trait CAP_BATTERYPERCENTAGE extends EnumDWT_Cap
  
  /** Added 2.0  */
  @js.native
  sealed trait CAP_CAMERAENABLED extends EnumDWT_Cap
  
  /** Added 2.0    */
  @js.native
  sealed trait CAP_CAMERAORDER extends EnumDWT_Cap
  
  /** This capability queries the Source for UI support for preview mode. If TRUE, the Source supports preview UI. */
  @js.native
  sealed trait CAP_CAMERAPREVIEWUI extends EnumDWT_Cap
  
  /** Added 1.91  */
  @js.native
  sealed trait CAP_CAMERASIDE extends EnumDWT_Cap
  
  /** A general note about the acquired image. */
  @js.native
  sealed trait CAP_CAPTION extends EnumDWT_Cap
  ...
  @js.native
  sealed trait CAP_CLEARBUFFERS extends EnumDWT_Cap
  ...
  /** If TRUE, the Source will eject the current page being acquired from and will leave the feeder
    ...
    */
  @js.native
  sealed trait CAP_CLEARPAGE extends EnumDWT_Cap
  
  @js.native
  sealed trait CAP_CUSTOMDSDATA extends EnumDWT_Cap
  
  /** Added 2.1  */
  @js.native
  sealed trait CAP_CUSTOMINTERFACEGUID extends EnumDWT_Cap
  ...
  /** If TRUE, the physical hardware (e.g., scanner, digital camera, image database, etc.) that
    ...
    */
  @js.native
  sealed trait CAP_DEVICEONLINE extends EnumDWT_Cap
  ...
  /** The date and time of the device's clock.
    ...
    */
  @js.native
  sealed trait CAP_DEVICETIMEDATE extends EnumDWT_Cap
  ...
  /** This indicates whether the scanner supports duplex. If so, it further indicates whether one-path
    ...
    */
  @js.native
  sealed trait CAP_DUPLEX extends EnumDWT_Cap
  ...
  /** Allows the application to specify the starting endorser / imprinter number. All other endorser/
    ...
    */
  @js.native
  sealed trait CAP_ENDORSER extends EnumDWT_Cap
  
  /** Allows the application and Source to negotiate capabilities to be used in States 5 and 6. */
  @js.native
  sealed trait CAP_EXTENDEDCAPS extends EnumDWT_Cap
  ...
  /** Helps the Application determine any special actions it may need to take when negotiating
    ...
    */
  @js.native
  sealed trait CAP_FEEDERALIGNMENT extends EnumDWT_Cap
  ...
  /** If TRUE, Source must acquire data from the document feeder acquire area and other feeder
    ...
    */
  @js.native
  sealed trait CAP_FEEDERENABLED extends EnumDWT_Cap
  
  /** Reflect whether there are documents loaded in the Source's feeder. */
  @js.native
  sealed trait CAP_FEEDERLOADED extends EnumDWT_Cap
  ...
  /** TWFO_FIRSTPAGEFIRST if the feeder starts with the top of the first page.
    ...
    */
  @js.native
  sealed trait CAP_FEEDERORDER extends EnumDWT_Cap
  
  /** Added 2.0  */
  @js.native
  sealed trait CAP_FEEDERPOCKET extends EnumDWT_Cap
  
  /** Added 2.0   */
  @js.native
  sealed trait CAP_FEEDERPREP extends EnumDWT_Cap
  ...
  /** If TRUE, the Source will eject the current page and advance the next page in the document feeder
    ...
    */
  @js.native
  sealed trait CAP_FEEDPAGE extends EnumDWT_Cap
  ...
  /** If TRUE, the Source will display a progress indicator during acquisition and transfer, regardless
    ...
    */
  @js.native
  sealed trait CAP_INDICATORS extends EnumDWT_Cap
  ...
  /** CapGet() returns the current list of available printer devices, along with the one currently being used for negotiation.
    ...
    */
  @js.native
  sealed trait CAP_PRINTER extends EnumDWT_Cap
  
  /** Turns the current CAP_PRINTER device on or off. */
  @js.native
  sealed trait CAP_PRINTERENABLED extends EnumDWT_Cap
  
  /** The User can set the starting number for the current CAP_PRINTER device. */
  @js.native
  sealed trait CAP_PRINTERINDEX extends EnumDWT_Cap
  ...
  /** Indicates whether the physical hardware (e.g. scanner, digital camera) is capable of acquiring
    ...
    */
  @js.native
  sealed trait CAP_REACQUIREALLOWED extends EnumDWT_Cap
  ...
  /** If TRUE, the Source will return the current page to the input side of the document feeder and
    ...
    */
  @js.native
  sealed trait CAP_REWINDPAGE extends EnumDWT_Cap
  
  /** Added 1.91   */
  @js.native
  sealed trait CAP_SEGMENTED extends EnumDWT_Cap
  ...
  /** A string containing the serial number of the currently selected device in the Source. Multiple
    ...
    */
  @js.native
  sealed trait CAP_SERIALNUMBER extends EnumDWT_Cap
  ...
  /** Returns a list of all the capabilities for which the Source will answer inquiries. Does not indicate
    ...
    */
  @js.native
  sealed trait CAP_SUPPORTEDCAPS extends EnumDWT_Cap
  ...
  /** Returns a list of all the capabilities for which the Source will answer inquiries. Does not indicate
    ...
    */
  @js.native
  sealed trait CAP_SUPPORTEDCAPSEXT extends EnumDWT_Cap
  ...
  /** Allows an application to request the delivery of thumbnail representations for the set of images
    ...
    */
  @js.native
  sealed trait CAP_THUMBNAILSENABLED extends EnumDWT_Cap
  ...
  /** For automatic capture, this value selects the number of milliseconds before the first picture is to
    ...
    */
  @js.native
  sealed trait CAP_TIMEBEFOREFIRSTCAPTURE extends EnumDWT_Cap
  
  /** For automatic capture, this value selects the milliseconds to wait between pictures taken, or images scanned. */
  @js.native
  sealed trait CAP_TIMEBETWEENCAPTURES extends EnumDWT_Cap
  ...
  /** The date and time the image was acquired.
    ...
    */
  @js.native
  sealed trait CAP_TIMEDATE extends EnumDWT_Cap
  ...
  /** If TRUE, indicates that this Source supports acquisition with the UI disabled; i.e.,
    ...
    */
  @js.native
  sealed trait CAP_UICONTROLLABLE extends EnumDWT_Cap
  
  /** The application is willing to accept this number of images. */
  @js.native
  sealed trait CAP_XFERCOUNT extends EnumDWT_Cap
  
  /** TRUE enables and FALSE disables the Source's Auto-brightness function (if any). */
  @js.native
  sealed trait ICAP_AUTOBRIGHT extends EnumDWT_Cap
  ...
  /** Use this capability to have the Source discard blank images. The Application never sees these
    ...
    */
  @js.native
  sealed trait ICAP_AUTODISCARDBLANKPAGES extends EnumDWT_Cap
  
  /** Turns automatic border detection on and off. */
  @js.native
  sealed trait ICAP_AUTOMATICBORDERDETECTION extends EnumDWT_Cap
  
  /** Added 2.1  */
  @js.native
  sealed trait ICAP_AUTOMATICCOLORENABLED extends EnumDWT_Cap
  
  /** Added 2.1  */
  @js.native
  sealed trait ICAP_AUTOMATICCOLORNONCOLORPIXELTYPE extends EnumDWT_Cap
  
  /** Added 2.1  */
  @js.native
  sealed trait ICAP_AUTOMATICCROPUSESFRAME extends EnumDWT_Cap
  
  /** Turns automatic deskew correction on and off. */
  @js.native
  sealed trait ICAP_AUTOMATICDESKEW extends EnumDWT_Cap
  
  /** Added 2.1  */
  @js.native
  sealed trait ICAP_AUTOMATICLENGTHDETECTION extends EnumDWT_Cap
  ...
  /** When TRUE this capability depends on intelligent features within the Source to automatically
    ...
    */
  @js.native
  sealed trait ICAP_AUTOMATICROTATE extends EnumDWT_Cap
  
  /** Added 2.0   */
  @js.native
  sealed trait ICAP_AUTOSIZE extends EnumDWT_Cap
  
  /** Turns bar code detection on and off. */
  @js.native
  sealed trait ICAP_BARCODEDETECTIONENABLED extends EnumDWT_Cap
  
  /** Restricts the number of times a search will be retried if none are found on each page. */
  @js.native
  sealed trait ICAP_BARCODEMAXRETRIES extends EnumDWT_Cap
  
  /** The maximum number of supported search priorities. */
  @js.native
  sealed trait ICAP_BARCODEMAXSEARCHPRIORITIES extends EnumDWT_Cap
  
  /** Restricts bar code searching to certain orientations, or prioritizes one orientation over the other. */
  @js.native
  sealed trait ICAP_BARCODESEARCHMODE extends EnumDWT_Cap
  
  /** A prioritized list of bar code types dictating the order in which bar codes will be sought. */
  @js.native
  sealed trait ICAP_BARCODESEARCHPRIORITIES extends EnumDWT_Cap
  
  /** Restricts the total time spent on searching for a bar code on each page. */
  @js.native
  sealed trait ICAP_BARCODETIMEOUT extends EnumDWT_Cap
  ...
  /** Specifies the pixel bit depths for the Current value of ICAP_PIXELTYPE. For example, when
    ...
    */
  @js.native
  sealed trait ICAP_BITDEPTH extends EnumDWT_Cap
  ...
  /** Specifies the Reduction Method the Source should use to reduce the bit depth of the data. Most
    ...
    */
  @js.native
  sealed trait ICAP_BITDEPTHREDUCTION extends EnumDWT_Cap
  ...
  /** Used for CCITT Group 3 2-dimensional compression. The 'K' factor indicates how often the
    ...
    */
  @js.native
  sealed trait ICAP_CCITTKFACTOR extends EnumDWT_Cap
  
  /** Added 2.1  */
  @js.native
  sealed trait ICAP_COLORMANAGEMENTENABLED extends EnumDWT_Cap
  ...
  /** Allows the application to query the data source to see if it supports extended image attribute capabilities,
    ...
    */
  @js.native
  sealed trait ICAP_EXTIMAGEINFO extends EnumDWT_Cap
  
  /** Added 1.91   */
  @js.native
  sealed trait ICAP_FEEDERTYPE extends EnumDWT_Cap
  ...
  /** Describes the color characteristic of the subtractive filter applied to the image data. Multiple
    ...
    */
  @js.native
  sealed trait ICAP_FILTER extends EnumDWT_Cap
  
  /** Specifies whether or not the image was acquired using a flash. */
  @js.native
  sealed trait ICAP_FLASHUSED extends EnumDWT_Cap
  ...
  /** For devices that support flash. CapSet() selects the flash to be used (if any). CapGet() reports the current setting.
    ...
    */
  @js.native
  sealed trait ICAP_FLASHUSED2 extends EnumDWT_Cap
  ...
  /** Flip rotation is used to properly orient images that flip orientation every other image.
    ...
    */
  @js.native
  sealed trait ICAP_FLIPROTATION extends EnumDWT_Cap
  
  /** The list of frames the Source will acquire on each page. */
  @js.native
  sealed trait ICAP_FRAMES extends EnumDWT_Cap
  
  /** Gamma correction value for the image data. */
  @js.native
  sealed trait ICAP_GAMMA extends EnumDWT_Cap
  
  /** A list of names of the halftone patterns available within the Source. */
  @js.native
  sealed trait ICAP_HALFTONES extends EnumDWT_Cap
  ...
  /** Specifies which value in an image should be interpreted as the lightest "highlight." All values
    ...
    */
  @js.native
  sealed trait ICAP_HIGHLIGHT extends EnumDWT_Cap
  
  /** Added 1.91  */
  @js.native
  sealed trait ICAP_ICCPROFILE extends EnumDWT_Cap
  ...
  /** Informs the application which file formats the Source can generate (CapGet()). Tells the Source which file formats the application can handle (CapSet()).
    ...
    */
  @js.native
  sealed trait ICAP_IMAGEFILEFORMAT extends EnumDWT_Cap
  ...
  @js.native
  sealed trait ICAP_IMAGEFILTER extends EnumDWT_Cap
  
  /** Added 2.1  */
  @js.native
  sealed trait ICAP_IMAGEMERGE extends EnumDWT_Cap
  
  /** Added 2.1  */
  @js.native
  sealed trait ICAP_IMAGEMERGEHEIGHTTHRESHOLD extends EnumDWT_Cap
  ...
  /** Defines which edge of the "paper" the image's "top" is aligned with. This information is used to adjust the frames to match the
    ...
    */
  @js.native
  sealed trait ICAP_ORIENTATION extends EnumDWT_Cap
  ...
  /** Overscan is used to scan outside of the boundaries described by ICAP_FRAMES, and is used to help acquire image data that
    ...
    */
  @js.native
  sealed trait ICAP_OVERSCAN extends EnumDWT_Cap
  
  /** Turns patch code detection on and off. */
  @js.native
  sealed trait ICAP_PATCHCODEDETECTIONENABLED extends EnumDWT_Cap
  
  /** Restricts the number of times a search will be retried if none are found on each page. */
  @js.native
  sealed trait ICAP_PATCHCODEMAXRETRIES extends EnumDWT_Cap
  
  /** The maximum number of supported search priorities. */
  @js.native
  sealed trait ICAP_PATCHCODEMAXSEARCHPRIORITIES extends EnumDWT_Cap
  
  /** Restricts patch code searching to certain orientations, or prioritizes one orientation over the other. */
  @js.native
  sealed trait ICAP_PATCHCODESEARCHMODE extends EnumDWT_Cap
  
  /** A prioritized list of patch code types dictating the order in which patch codes will be sought. */
  @js.native
  sealed trait ICAP_PATCHCODESEARCHPRIORITIES extends EnumDWT_Cap
  
  /** Restricts the total time spent on searching for a patch code on each page. */
  @js.native
  sealed trait ICAP_PATCHCODETIMEOUT extends EnumDWT_Cap
  
  /** The maximum physical height (Y-axis) the Source can acquire (measured in units of ICAP_UNITS). */
  @js.native
  sealed trait ICAP_PHYSICALHEIGHT extends EnumDWT_Cap
  
  /** The maximum physical width (X-axis) the Source can acquire (measured in units of ICAP_UNITS). */
  @js.native
  sealed trait ICAP_PHYSICALWIDTH extends EnumDWT_Cap
  
  /** Sense of the pixel whose numeric value is zero (minimum data value).  */
  @js.native
  sealed trait ICAP_PIXELFLAVOR extends EnumDWT_Cap
  ...
  /** Used only for CCITT data compression. Specifies whether the compressed codes' pixel "sense"
    ...
    */
  @js.native
  sealed trait ICAP_PIXELFLAVORCODES extends EnumDWT_Cap
  
  /** The type of pixel data that a Source is capable of acquiring (for example, black and white, gray, RGB, etc.). */
  @js.native
  sealed trait ICAP_PIXELTYPE extends EnumDWT_Cap
  ...
  /** Allows the application and Source to identify which color data formats are available. There are
    ...
    */
  @js.native
  sealed trait ICAP_PLANARCHUNKY extends EnumDWT_Cap
  ...
  /** How the Source can/should rotate the scanned image data prior to transfer. This doesn't use
    ...
    */
  @js.native
  sealed trait ICAP_ROTATION extends EnumDWT_Cap
  ...
  /** Specifies which value in an image should be interpreted as the darkest "shadow." All values
    ...
    */
  @js.native
  sealed trait ICAP_SHADOW extends EnumDWT_Cap
  
  /** Provides a list of bar code types that can be detected by the current Data Source. */
  @js.native
  sealed trait ICAP_SUPPORTEDBARCODETYPES extends EnumDWT_Cap
  
  /** Added 2.1   */
  @js.native
  sealed trait ICAP_SUPPORTEDEXTIMAGEINFO extends EnumDWT_Cap
  
  /** A list of patch code types that may be detected by the current Data Source. */
  @js.native
  sealed trait ICAP_SUPPORTEDPATCHCODETYPES extends EnumDWT_Cap
  ...
  /** For devices that support fixed frame sizes.
    ...
    */
  @js.native
  sealed trait ICAP_SUPPORTEDSIZES extends EnumDWT_Cap
  ...
  @js.native
  sealed trait ICAP_TIMEFILL extends EnumDWT_Cap
  ...
  /** If TRUE the Source will issue a MSG_XFERREADY before starting the scan.
    ...
    */
  @js.native
  sealed trait ICAP_UNDEFINEDIMAGESIZE extends EnumDWT_Cap
  ...
  /** The native optical resolution along the X-axis of the device being controlled by the Source. Most
    ...
    */
  @js.native
  sealed trait ICAP_XNATIVERESOLUTION extends EnumDWT_Cap
  ...
  /** All the X-axis resolutions the Source can provide.
    ...
    */
  @js.native
  sealed trait ICAP_XRESOLUTION extends EnumDWT_Cap
  ...
  @js.native
  sealed trait ICAP_XSCALING extends EnumDWT_Cap
  ...
  /** The native optical resolution along the Y-axis of the device being controlled by the Source.
    ...
    */
  @js.native
  sealed trait ICAP_YNATIVERESOLUTION extends EnumDWT_Cap
  ...
  /** All the Y-axis resolutions the Source can provide.
    ...
    */
  @js.native
  sealed trait ICAP_YRESOLUTION extends EnumDWT_Cap
  ...
  /** All the Y-axis scaling values available. A value of '1.0' is equivalent to 100% scaling. Do not use values less than or equal to zero.
    ...
    */
  @js.native
  sealed trait ICAP_YSCALING extends EnumDWT_Cap
