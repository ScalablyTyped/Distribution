...
object LocationOnButtonClick {
  ...
  inline def apply(): LocationOnButtonClick = {
  ...
  extension [Self <: LocationOnButtonClick](x: Self) {
    ...
    inline def setSequence(value: `9`): Self = StObject.set(x, "sequence", value.asInstanceOf[js.Any])
