...
trait Webcam extends js.Object {
  /**
    ...
    * @return {void}
    */
  def CaptureImage(OnCaptureSuccess: js.Function0[scala.Unit], OnCaptureError: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
  ...
  def GetFramePartURL(): java.lang.String = js.native
  /**
  ...
  def GetFrameURL(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    * @return {string array}
    */
  def GetSourceList(): js.Array[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    * @return {void}
    */
  def PlayVideo(DWObject: WebTwain, quality: scala.Double, onFrameCaptured: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    ...
    * @return {boolean}
    */
  def SelectSource(strSourceName: java.lang.String): scala.Boolean = js.native
  /**
    ...
    * @return {boolean}
    */
  def SetCameraControlPropertySetting(property: EnumDWT_CameraControlProperty, value: scala.Double, auto: scala.Boolean): scala.Boolean = js.native
  /**
    ...
    * @return {boolean}
    */
  def SetFrameRate(value: scala.Double): scala.Boolean = js.native
  /**
    ...
    * @return {boolean}
    */
  def SetMediaType(value: java.lang.String): scala.Boolean = js.native
  /**
    ...
    * @return {boolean}
    */
  def SetResolution(value: java.lang.String): scala.Boolean = js.native
  /**
    ...
    * @return {boolean}
    */
  def SetVideoPropertySetting(property: EnumDWT_VideoProperty, value: scala.Double, auto: scala.Boolean): scala.Boolean = js.native
  /**
    ...
    * @return {boolean}
    */
  def SetVideoRotateMode(enumAngle: EnumDWT_VideoRotateMode): scala.Boolean = js.native
  /**
    *  Stop the video stream in the specified container
    * @method Dynamsoft.WebTwain#StopVideo 
    * @return {boolean}
    */
  def StopVideo(): scala.Boolean = js.native
}
