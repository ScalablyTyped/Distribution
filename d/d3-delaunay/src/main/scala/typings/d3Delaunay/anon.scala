...
object anon {
  ...
  /* n */ NumberDictionary[Point] {
    ...
    def findLast(predicate: js.Function3[/* value */ Point, /* index */ Double, /* array */ js.Array[Point], Any]): js.UndefOr[Point] = js.native
    def findLast(
      predicate: js.Function3[/* value */ Point, /* index */ Double, /* array */ js.Array[Point], Any],
      thisArg: Any
    ): js.UndefOr[Point] = js.native
    ...
    /**
      ...
      */
    /* standard es2023.array */
    def findLastIndex(predicate: js.Function3[/* value */ Point, /* index */ Double, /* array */ js.Array[Point], Any]): Double = js.native
    def findLastIndex(
      predicate: js.Function3[/* value */ Point, /* index */ Double, /* array */ js.Array[Point], Any],
      thisArg: Any
    ): Double = js.native
    ...
    @JSName("find")
    def find_S[S /* <: Point */](
      predicate: js.Function3[/* value */ Point, /* index */ Double, /* obj */ js.Array[Point], /* is S */ Boolean]
    ): js.UndefOr[S] = js.native
    @JSName("find")
    def find_S[S /* <: Point */](
      predicate: js.Function3[/* value */ Point, /* index */ Double, /* obj */ js.Array[Point], /* is S */ Boolean],
