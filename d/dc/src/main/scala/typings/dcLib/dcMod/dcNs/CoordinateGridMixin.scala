...
trait CoordinateGridMixin[T]
  ...
  @JSName("xAxis")
  var xAxis_Original: IGetSet[_, T] = js.native
  @JSName("xUnits")
  ...
  @JSName("yAxis")
  var yAxis_Original: IGetSet[_, T] = js.native
  @JSName("y")
  ...
  def xAxis(t: js.Any): js.Any = js.native
  ...
  def yAxis(t: js.Any): js.Any = js.native
