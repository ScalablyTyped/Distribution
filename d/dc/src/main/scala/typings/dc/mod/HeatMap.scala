...
trait HeatMap
  ...
  @JSName("boxOnClick")
  var boxOnClick_Original: IGetSet[js.Function1[/* d */ js.Any, Unit], HeatMap] = js.native
  
  def colOrdering(): Accessor[js.Any, String] = js.native
  def colOrdering(t: Accessor[js.Any, String]): HeatMap = js.native
  @JSName("colOrdering")
  var colOrdering_Original: IGetSet[Accessor[js.Any, String], HeatMap] = js.native
  
  def cols(): js.Array[String | Double] = js.native
  def cols(t: js.Array[String | Double]): HeatMap = js.native
  
  def colsLabel(): Accessor[js.Any, String] = js.native
  def colsLabel(t: Accessor[js.Any, String]): HeatMap = js.native
  @JSName("colsLabel")
  var colsLabel_Original: IGetSet[Accessor[js.Any, String], HeatMap] = js.native
  
  @JSName("cols")
  var cols_Original: IGetSet[js.Array[String | Double], HeatMap] = js.native
  
  def rowOrdering(): Accessor[js.Any, String] = js.native
  def rowOrdering(t: Accessor[js.Any, String]): HeatMap = js.native
  @JSName("rowOrdering")
  var rowOrdering_Original: IGetSet[Accessor[js.Any, String], HeatMap] = js.native
  
  def rows(): js.Array[String | Double] = js.native
  def rows(t: js.Array[String | Double]): HeatMap = js.native
  
  def rowsLabel(): Accessor[js.Any, String] = js.native
  def rowsLabel(t: Accessor[js.Any, String]): HeatMap = js.native
  @JSName("rowsLabel")
  var rowsLabel_Original: IGetSet[Accessor[js.Any, String], HeatMap] = js.native
  ...
  @JSName("xAxisOnClick")
  var xAxisOnClick_Original: IGetSet[js.Function1[/* d */ js.Any, Unit], HeatMap] = js.native
  ...
  @JSName("yAxisOnClick")
  var yAxisOnClick_Original: IGetSet[js.Function1[/* d */ js.Any, Unit], HeatMap] = js.native
