...
object actionMod {
  ...
  object ActionTypes extends StObject {
    ...
    sealed trait Append
      extends StObject
         with ActionTypes
    /* "append" */ val Append: typings.deta.actionMod.ActionTypes.Append & String = js.native
    
    @js.native
    sealed trait Increment
      extends StObject
         with ActionTypes
    /* "increment" */ val Increment: typings.deta.actionMod.ActionTypes.Increment & String = js.native
    
    @js.native
    sealed trait Prepend
      extends StObject
         with ActionTypes
    /* "prepend" */ val Prepend: typings.deta.actionMod.ActionTypes.Prepend & String = js.native
    
    @js.native
    sealed trait Set
      extends StObject
         with ActionTypes
    /* "set" */ val Set: typings.deta.actionMod.ActionTypes.Set & String = js.native
    
    @js.native
    sealed trait Trim
      extends StObject
         with ActionTypes
    /* "trim" */ val Trim: typings.deta.actionMod.ActionTypes.Trim & String = js.native
  }
}
