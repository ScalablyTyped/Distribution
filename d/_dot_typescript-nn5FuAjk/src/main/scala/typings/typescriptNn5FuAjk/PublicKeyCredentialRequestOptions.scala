...
trait PublicKeyCredentialRequestOptions extends StObject {
  ...
  var allowCredentials: js.UndefOr[Array[PublicKeyCredentialDescriptor]] = js.undefined
...
object PublicKeyCredentialRequestOptions {
  ...
  extension [Self <: PublicKeyCredentialRequestOptions](x: Self) {
    ...
    inline def setAllowCredentials(value: Array[PublicKeyCredentialDescriptor]): Self = StObject.set(x, "allowCredentials", value.asInstanceOf[js.Any])
