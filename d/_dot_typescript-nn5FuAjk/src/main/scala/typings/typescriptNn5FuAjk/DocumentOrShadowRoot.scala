...
trait DocumentOrShadowRoot extends StObject {
  ...
  def elementsFromPoint(x: Double, y: Double): Array[Element]
  
  /** Returns document's fullscreen element. */
  val fullscreenElement: Element | Null
  
  def getAnimations(): Array[Animation]
...
object DocumentOrShadowRoot {
  ...
  inline def apply(
    ...
    elementsFromPoint: (Double, Double) => Array[Element],
  ...
  extension [Self <: DocumentOrShadowRoot](x: Self) {
    ...
    inline def setElementsFromPoint(value: (Double, Double) => Array[Element]): Self = StObject.set(x, "elementsFromPoint", js.Any.fromFunction2(value))
    ...
    inline def setGetAnimations(value: () => Array[Animation]): Self = StObject.set(x, "getAnimations", js.Any.fromFunction0(value))
