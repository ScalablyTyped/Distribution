...
trait WebGL2RenderingContextBase extends StObject {
  ...
  def drawBuffers(buffers: Array[GLenum]): Unit = js.native
  ...
  def getActiveUniforms(program: WebGLProgram, uniformIndices: Array[GLuint], pname: GLenum): Any = js.native
  def getActiveUniforms(program: WebGLProgram, uniformIndices: Iterable[GLuint], pname: GLenum): Any = js.native
  ...
  def getUniformIndices(program: WebGLProgram, uniformNames: Array[java.lang.String]): Array[GLuint] | Null = js.native
  def getUniformIndices(program: WebGLProgram, uniformNames: Iterable[java.lang.String]): Iterable[GLuint] | Null = js.native
  
  def invalidateFramebuffer(target: GLenum, attachments: Array[GLenum]): Unit = js.native
  def invalidateFramebuffer(target: GLenum, attachments: Iterable[GLenum]): Unit = js.native
  
  def invalidateSubFramebuffer(target: GLenum, attachments: Array[GLenum], x: GLint, y: GLint, width: GLsizei, height: GLsizei): Unit = js.native
  ...
  def transformFeedbackVaryings(program: WebGLProgram, varyings: Array[java.lang.String], bufferMode: GLenum): Unit = js.native
