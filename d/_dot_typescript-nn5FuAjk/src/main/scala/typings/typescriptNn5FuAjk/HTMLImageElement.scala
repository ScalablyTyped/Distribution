...
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.`lazy`
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.async
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.auto
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.eager
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.sync
...
trait HTMLImageElement
  ...
  def decode(): Promise[Unit] = js.native
