...
/* Rewritten from type alias, can be one of: 
  - typings.typescriptNn5FuAjk.ts.RenameInfoSuccess
  - typings.typescriptNn5FuAjk.ts.RenameInfoFailure
*/
trait RenameInfo extends StObject
object RenameInfo {
  
  inline def RenameInfoFailure(localizedErrorMessage: java.lang.String): typings.typescriptNn5FuAjk.ts.RenameInfoFailure = {
    val __obj = js.Dynamic.literal(canRename = false, localizedErrorMessage = localizedErrorMessage.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.typescriptNn5FuAjk.ts.RenameInfoFailure]
  }
  ...
  inline def RenameInfoSuccess(
    ...
    __obj.asInstanceOf[typings.typescriptNn5FuAjk.ts.RenameInfoSuccess]
  }
}
