...
trait ParsedCommandLine extends StObject {
  ...
  var fileNames: Array[java.lang.String]
...
object ParsedCommandLine {
  ...
  inline def apply(errors: Array[Diagnostic], fileNames: Array[java.lang.String], options: CompilerOptions): ParsedCommandLine = {
  ...
  extension [Self <: ParsedCommandLine](x: Self) {
    ...
    inline def setFileNames(value: Array[java.lang.String]): Self = StObject.set(x, "fileNames", value.asInstanceOf[js.Any])
