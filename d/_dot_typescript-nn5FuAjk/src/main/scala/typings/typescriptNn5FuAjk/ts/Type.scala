...
trait Type
  ...
  def isClass(): /* is .typescript-nn5FuAjk.ts.InterfaceType */ Boolean
  
  def isClassOrInterface(): /* is .typescript-nn5FuAjk.ts.InterfaceType */ Boolean
  
  def isIndexType(): /* is .typescript-nn5FuAjk.ts.IndexType */ Boolean
  
  def isIntersection(): /* is .typescript-nn5FuAjk.ts.IntersectionType */ Boolean
  
  def isLiteral(): /* is .typescript-nn5FuAjk.ts.LiteralType */ Boolean
  
  def isNumberLiteral(): /* is .typescript-nn5FuAjk.ts.NumberLiteralType */ Boolean
  
  def isStringLiteral(): /* is .typescript-nn5FuAjk.ts.StringLiteralType */ Boolean
  
  def isTypeParameter(): /* is .typescript-nn5FuAjk.ts.TypeParameter */ Boolean
  
  def isUnion(): /* is .typescript-nn5FuAjk.ts.UnionType */ Boolean
  
  def isUnionOrIntersection(): /* is .typescript-nn5FuAjk.ts.UnionOrIntersectionType */ Boolean
...
object Type {
  ...
  extension [Self <: Type](x: Self) {
    ...
    inline def setIsClass(value: () => /* is .typescript-nn5FuAjk.ts.InterfaceType */ Boolean): Self = StObject.set(x, "isClass", js.Any.fromFunction0(value))
    
    inline def setIsClassOrInterface(value: () => /* is .typescript-nn5FuAjk.ts.InterfaceType */ Boolean): Self = StObject.set(x, "isClassOrInterface", js.Any.fromFunction0(value))
    
    inline def setIsIndexType(value: () => /* is .typescript-nn5FuAjk.ts.IndexType */ Boolean): Self = StObject.set(x, "isIndexType", js.Any.fromFunction0(value))
    
    inline def setIsIntersection(value: () => /* is .typescript-nn5FuAjk.ts.IntersectionType */ Boolean): Self = StObject.set(x, "isIntersection", js.Any.fromFunction0(value))
    
    inline def setIsLiteral(value: () => /* is .typescript-nn5FuAjk.ts.LiteralType */ Boolean): Self = StObject.set(x, "isLiteral", js.Any.fromFunction0(value))
    
    inline def setIsNumberLiteral(value: () => /* is .typescript-nn5FuAjk.ts.NumberLiteralType */ Boolean): Self = StObject.set(x, "isNumberLiteral", js.Any.fromFunction0(value))
    
    inline def setIsStringLiteral(value: () => /* is .typescript-nn5FuAjk.ts.StringLiteralType */ Boolean): Self = StObject.set(x, "isStringLiteral", js.Any.fromFunction0(value))
    
    inline def setIsTypeParameter(value: () => /* is .typescript-nn5FuAjk.ts.TypeParameter */ Boolean): Self = StObject.set(x, "isTypeParameter", js.Any.fromFunction0(value))
    
    inline def setIsUnion(value: () => /* is .typescript-nn5FuAjk.ts.UnionType */ Boolean): Self = StObject.set(x, "isUnion", js.Any.fromFunction0(value))
    
    inline def setIsUnionOrIntersection(value: () => /* is .typescript-nn5FuAjk.ts.UnionOrIntersectionType */ Boolean): Self = StObject.set(x, "isUnionOrIntersection", js.Any.fromFunction0(value))
