...
import typings.typescriptNn5FuAjk.anon.`4`
...
trait TypeChecker extends StObject {
  ...
  /** Note that the resulting nodes cannot be checked. */
  def signatureToSignatureDeclaration(signature: Signature, kind: SyntaxKind): js.UndefOr[SignatureDeclaration & `4`] = js.native
  def signatureToSignatureDeclaration(signature: Signature, kind: SyntaxKind, enclosingDeclaration: Unit, flags: NodeBuilderFlags): js.UndefOr[SignatureDeclaration & `4`] = js.native
  def signatureToSignatureDeclaration(signature: Signature, kind: SyntaxKind, enclosingDeclaration: Node): js.UndefOr[SignatureDeclaration & `4`] = js.native
  def signatureToSignatureDeclaration(signature: Signature, kind: SyntaxKind, enclosingDeclaration: Node, flags: NodeBuilderFlags): js.UndefOr[SignatureDeclaration & `4`] = js.native
