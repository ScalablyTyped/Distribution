...
trait SourceFile
  ...
  val endOfFileToken: Token[typings.typescriptNn5FuAjk.ts.SyntaxKind.EndOfFileToken] = js.native
  ...
  @JSName("kind")
  val kind_SourceFile: typings.typescriptNn5FuAjk.ts.SyntaxKind.SourceFile = js.native
