...
trait NodeVisitor extends StObject {
  ...
  def apply[T /* <: Node */](nodes: T, visitor: Unit, test: Unit, lift: js.Function1[/* node */ Array[Node], T]): T = js.native
  ...
  def apply[T /* <: Node */](nodes: T, visitor: Visitor, test: Unit, lift: js.Function1[/* node */ Array[Node], T]): T = js.native
