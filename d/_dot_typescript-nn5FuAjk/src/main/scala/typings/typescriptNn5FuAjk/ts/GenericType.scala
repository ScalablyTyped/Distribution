...
- typings.typescriptNn5FuAjk.ts.FlowType because Already inherited
- typings.typescriptNn5FuAjk.ts.Type because Already inherited
- typings.typescriptNn5FuAjk.ts.ObjectType because Already inherited
- typings.typescriptNn5FuAjk.ts.TypeReference because var conflicts: aliasSymbol, aliasTypeArguments, flags, objectFlags, pattern, symbol. Inlined target, node, typeArguments */ trait GenericType
  extends StObject
     with InterfaceType {
