...
trait TransformationResult[T /* <: Node */] extends StObject {
  ...
  var diagnostics: js.UndefOr[Array[DiagnosticWithLocation]] = js.undefined
...
object TransformationResult {
  ...
  extension [Self <: TransformationResult[?], T /* <: Node */](x: Self & TransformationResult[T]) {
    ...
    inline def setDiagnostics(value: Array[DiagnosticWithLocation]): Self = StObject.set(x, "diagnostics", value.asInstanceOf[js.Any])
    ...
    inline def setTransformed(value: Array[T]): Self = StObject.set(x, "transformed", value.asInstanceOf[js.Any])
  }
}
