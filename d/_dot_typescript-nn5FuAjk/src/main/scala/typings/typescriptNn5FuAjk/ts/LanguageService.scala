...
import typings.typescriptNn5FuAjk.anon.WithMetadataCompletionInfFlags
...
trait LanguageService extends StObject {
  ...
  /**
    ...
    */
  def getCompletionsAtPosition(fileName: java.lang.String, position: Double): js.UndefOr[WithMetadataCompletionInfFlags] = js.native
  def getCompletionsAtPosition(
    fileName: java.lang.String,
    position: Double,
    options: Unit,
    formattingSettings: FormatCodeSettings
  ): js.UndefOr[WithMetadataCompletionInfFlags] = js.native
  def getCompletionsAtPosition(fileName: java.lang.String, position: Double, options: GetCompletionsAtPositionOptions): js.UndefOr[WithMetadataCompletionInfFlags] = js.native
  def getCompletionsAtPosition(
    fileName: java.lang.String,
    position: Double,
