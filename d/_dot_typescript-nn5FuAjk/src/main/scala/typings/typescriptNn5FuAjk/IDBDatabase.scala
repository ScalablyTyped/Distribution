...
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.versionchange
...
trait IDBDatabase
  ...
  def transaction(storeNames: Array[java.lang.String]): IDBTransaction = js.native
  def transaction(storeNames: Array[java.lang.String], mode: IDBTransactionMode): IDBTransaction = js.native
