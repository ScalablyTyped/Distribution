...
trait TypeAcquisition
  ...
  var exclude: js.UndefOr[Array[String]] = js.undefined
  
  var include: js.UndefOr[Array[String]] = js.undefined
}
object TypeAcquisition {
  ...
  extension [Self <: TypeAcquisition](x: Self) {
    ...
    inline def setExclude(value: Array[String]): Self = StObject.set(x, "exclude", value.asInstanceOf[js.Any])
    
    inline def setExcludeUndefined: Self = StObject.set(x, "exclude", js.undefined)
    
    inline def setInclude(value: Array[String]): Self = StObject.set(x, "include", value.asInstanceOf[js.Any])
