...
object OpenRequest {
  ...
  inline def apply(arguments: OpenRequestArgs, seq: Double): OpenRequest = {
    val __obj = js.Dynamic.literal(arguments = arguments.asInstanceOf[js.Any], command = "open", seq = seq.asInstanceOf[js.Any])
