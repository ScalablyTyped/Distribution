...
trait WatchOptions
  ...
  var fallbackPolling: js.UndefOr[PollingWatchKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.PollingWatchKind] = js.undefined
  
  var synchronousWatchDirectory: js.UndefOr[Boolean] = js.undefined
  
  var watchDirectory: js.UndefOr[
    WatchDirectoryKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.WatchDirectoryKind
  ] = js.undefined
  
  var watchFile: js.UndefOr[WatchFileKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.WatchFileKind] = js.undefined
}
object WatchOptions {
  ...
  extension [Self <: WatchOptions](x: Self) {
    ...
    inline def setFallbackPolling(value: PollingWatchKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.PollingWatchKind): Self = StObject.set(x, "fallbackPolling", value.asInstanceOf[js.Any])
    ...
    inline def setWatchDirectory(value: WatchDirectoryKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.WatchDirectoryKind): Self = StObject.set(x, "watchDirectory", value.asInstanceOf[js.Any])
    
    inline def setWatchDirectoryUndefined: Self = StObject.set(x, "watchDirectory", js.undefined)
    
    inline def setWatchFile(value: WatchFileKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.WatchFileKind): Self = StObject.set(x, "watchFile", value.asInstanceOf[js.Any])
