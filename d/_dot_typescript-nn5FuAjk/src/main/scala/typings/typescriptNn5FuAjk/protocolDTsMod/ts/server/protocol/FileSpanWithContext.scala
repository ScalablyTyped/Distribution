...
- typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.TextSpan because Already inherited
- typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.TextSpanWithContext because var conflicts: end, start. Inlined contextStart, contextEnd */ trait FileSpanWithContext
  extends StObject
     with FileSpan {
