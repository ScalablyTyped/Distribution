...
trait CompilerOptions
  ...
  var jsx: js.UndefOr[JsxEmit | typings.typescriptNn5FuAjk.protocolDTsMod.ts.JsxEmit] = js.undefined
  ...
  var module: js.UndefOr[ModuleKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.ModuleKind] = js.undefined
  
  var moduleResolution: js.UndefOr[
    ModuleResolutionKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.ModuleResolutionKind
  ] = js.undefined
  
  var newLine: js.UndefOr[NewLineKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.NewLineKind] = js.undefined
  ...
  var target: js.UndefOr[ScriptTarget | typings.typescriptNn5FuAjk.protocolDTsMod.ts.ScriptTarget] = js.undefined
...
object CompilerOptions {
  ...
  extension [Self <: CompilerOptions](x: Self) {
    ...
    inline def setJsx(value: JsxEmit | typings.typescriptNn5FuAjk.protocolDTsMod.ts.JsxEmit): Self = StObject.set(x, "jsx", value.asInstanceOf[js.Any])
    ...
    inline def setModule(value: ModuleKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.ModuleKind): Self = StObject.set(x, "module", value.asInstanceOf[js.Any])
    
    inline def setModuleResolution(value: ModuleResolutionKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.ModuleResolutionKind): Self = StObject.set(x, "moduleResolution", value.asInstanceOf[js.Any])
    
    inline def setModuleResolutionUndefined: Self = StObject.set(x, "moduleResolution", js.undefined)
    
    inline def setModuleUndefined: Self = StObject.set(x, "module", js.undefined)
    
    inline def setNewLine(value: NewLineKind | typings.typescriptNn5FuAjk.protocolDTsMod.ts.NewLineKind): Self = StObject.set(x, "newLine", value.asInstanceOf[js.Any])
    ...
    inline def setTarget(value: ScriptTarget | typings.typescriptNn5FuAjk.protocolDTsMod.ts.ScriptTarget): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
