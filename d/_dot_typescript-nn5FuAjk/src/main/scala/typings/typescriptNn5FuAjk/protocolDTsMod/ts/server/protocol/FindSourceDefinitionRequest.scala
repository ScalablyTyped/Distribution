...
object FindSourceDefinitionRequest {
  ...
  inline def apply(arguments: FileLocationRequestArgs, seq: Double): FindSourceDefinitionRequest = {
    val __obj = js.Dynamic.literal(arguments = arguments.asInstanceOf[js.Any], command = "findSourceDefinition", seq = seq.asInstanceOf[js.Any])
