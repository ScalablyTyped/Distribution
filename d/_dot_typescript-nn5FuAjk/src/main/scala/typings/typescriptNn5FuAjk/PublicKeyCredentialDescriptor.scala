...
trait PublicKeyCredentialDescriptor extends StObject {
  ...
  var transports: js.UndefOr[Array[AuthenticatorTransport]] = js.undefined
...
object PublicKeyCredentialDescriptor {
  ...
  extension [Self <: PublicKeyCredentialDescriptor](x: Self) {
    ...
    inline def setTransports(value: Array[AuthenticatorTransport]): Self = StObject.set(x, "transports", value.asInstanceOf[js.Any])
