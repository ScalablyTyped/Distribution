...
trait PerformanceObserverInit extends StObject {
  ...
  var entryTypes: js.UndefOr[Array[java.lang.String]] = js.undefined
...
object PerformanceObserverInit {
  ...
  extension [Self <: PerformanceObserverInit](x: Self) {
    ...
    inline def setEntryTypes(value: Array[java.lang.String]): Self = StObject.set(x, "entryTypes", value.asInstanceOf[js.Any])
