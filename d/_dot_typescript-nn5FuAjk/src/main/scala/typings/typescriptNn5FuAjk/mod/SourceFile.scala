...
trait SourceFile
  ...
  val endOfFileToken: Token[typings.typescriptNn5FuAjk.mod.SyntaxKind.EndOfFileToken] = js.native
  ...
  @JSName("kind")
  val kind_SourceFile: typings.typescriptNn5FuAjk.mod.SyntaxKind.SourceFile = js.native
