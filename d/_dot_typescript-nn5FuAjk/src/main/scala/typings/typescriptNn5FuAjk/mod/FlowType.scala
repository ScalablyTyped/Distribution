...
/* Rewritten from type alias, can be one of: 
  - typings.typescriptNn5FuAjk.mod.Type
  - typings.typescriptNn5FuAjk.mod.IncompleteType
*/
trait FlowType extends StObject
object FlowType {
  
  inline def IncompleteType(flags: TypeFlags, `type`: Type): typings.typescriptNn5FuAjk.mod.IncompleteType = {
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.typescriptNn5FuAjk.mod.IncompleteType]
  }
  ...
  inline def Type(
    ...
    getConstraint: () => js.UndefOr[typings.typescriptNn5FuAjk.mod.Type],
    getConstructSignatures: () => Array[Signature],
    getDefault: () => js.UndefOr[typings.typescriptNn5FuAjk.mod.Type],
    getFlags: () => TypeFlags,
    getNonNullableType: () => typings.typescriptNn5FuAjk.mod.Type,
    getNumberIndexType: () => js.UndefOr[typings.typescriptNn5FuAjk.mod.Type],
    getProperties: () => Array[Symbol],
    getProperty: java.lang.String => js.UndefOr[Symbol],
    getStringIndexType: () => js.UndefOr[typings.typescriptNn5FuAjk.mod.Type],
    ...
    __obj.asInstanceOf[typings.typescriptNn5FuAjk.mod.Type]
  }
}
