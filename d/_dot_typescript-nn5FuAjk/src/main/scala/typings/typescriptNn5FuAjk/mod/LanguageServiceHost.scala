...
- typings.typescriptNn5FuAjk.mod.ModuleResolutionHost because var conflicts: directoryExists, getCurrentDirectory. Inlined fileExists, readFile, trace, realpath, getDirectories, useCaseSensitiveFileNames
- typings.typescriptNn5FuAjk.mod.MinimalResolutionCacheHost because var conflicts: directoryExists, getCurrentDirectory. Inlined getCompilationSettings, getCompilerHost */ @js.native
