...
import typings.typescriptNn5FuAjk.mod.SyntaxKind.FalseKeyword
...
import typings.typescriptNn5FuAjk.mod.SyntaxKind.SuperKeyword
import typings.typescriptNn5FuAjk.mod.SyntaxKind.ThisKeyword
import typings.typescriptNn5FuAjk.mod.SyntaxKind.TrueKeyword
import typings.typescriptNn5FuAjk.mod.SyntaxKind.UniqueKeyword
import typings.typescriptNn5FuAjk.mod.SyntaxKind.Unknown
...
trait NodeFactory extends StObject {
  ...
  def createJSDocAugmentsTag(tagName: Unit, className: ExpressionWithTypeArgumenEnd): JSDocAugmentsTag = js.native
  def createJSDocAugmentsTag(tagName: Unit, className: ExpressionWithTypeArgumenEnd, comment: java.lang.String): JSDocAugmentsTag = js.native
  def createJSDocAugmentsTag(tagName: Unit, className: ExpressionWithTypeArgumenEnd, comment: NodeArray[JSDocComment]): JSDocAugmentsTag = js.native
  def createJSDocAugmentsTag(tagName: Identifier, className: ExpressionWithTypeArgumenEnd): JSDocAugmentsTag = js.native
  def createJSDocAugmentsTag(tagName: Identifier, className: ExpressionWithTypeArgumenEnd, comment: java.lang.String): JSDocAugmentsTag = js.native
  def createJSDocAugmentsTag(tagName: Identifier, className: ExpressionWithTypeArgumenEnd, comment: NodeArray[JSDocComment]): JSDocAugmentsTag = js.native
  ...
  def createJSDocImplementsTag(tagName: Unit, className: ExpressionWithTypeArgumenEnd): JSDocImplementsTag = js.native
  def createJSDocImplementsTag(tagName: Unit, className: ExpressionWithTypeArgumenEnd, comment: java.lang.String): JSDocImplementsTag = js.native
  def createJSDocImplementsTag(tagName: Unit, className: ExpressionWithTypeArgumenEnd, comment: NodeArray[JSDocComment]): JSDocImplementsTag = js.native
  def createJSDocImplementsTag(tagName: Identifier, className: ExpressionWithTypeArgumenEnd): JSDocImplementsTag = js.native
  def createJSDocImplementsTag(tagName: Identifier, className: ExpressionWithTypeArgumenEnd, comment: java.lang.String): JSDocImplementsTag = js.native
  def createJSDocImplementsTag(tagName: Identifier, className: ExpressionWithTypeArgumenEnd, comment: NodeArray[JSDocComment]): JSDocImplementsTag = js.native
  ...
  @JSName("createToken")
  def createToken_TKind_UnionUnknownEndOfFileToken_Token[TKind /* <: Unknown | typings.typescriptNn5FuAjk.mod.SyntaxKind.EndOfFileToken */](token: TKind): Token[TKind] = js.native
  ...
  def createTypeOperatorNode(operator: typings.typescriptNn5FuAjk.mod.SyntaxKind.ReadonlyKeyword, `type`: TypeNode): TypeOperatorNode = js.native
  ...
  def updateJSDocAugmentsTag(node: JSDocAugmentsTag, tagName: Unit, className: ExpressionWithTypeArgumenEnd): JSDocAugmentsTag = js.native
  def updateJSDocAugmentsTag(
    node: JSDocAugmentsTag,
    tagName: Unit,
    className: ExpressionWithTypeArgumenEnd,
    comment: java.lang.String
  ...
  def updateJSDocAugmentsTag(node: JSDocAugmentsTag, tagName: Identifier, className: ExpressionWithTypeArgumenEnd): JSDocAugmentsTag = js.native
  def updateJSDocAugmentsTag(
    node: JSDocAugmentsTag,
    tagName: Identifier,
    className: ExpressionWithTypeArgumenEnd,
  ...
  def updateJSDocImplementsTag(node: JSDocImplementsTag, tagName: Unit, className: ExpressionWithTypeArgumenEnd): JSDocImplementsTag = js.native
  ...
  def updateJSDocImplementsTag(node: JSDocImplementsTag, tagName: Identifier, className: ExpressionWithTypeArgumenEnd): JSDocImplementsTag = js.native
  def updateJSDocImplementsTag(
    node: JSDocImplementsTag,
    tagName: Identifier,
    className: ExpressionWithTypeArgumenEnd,
