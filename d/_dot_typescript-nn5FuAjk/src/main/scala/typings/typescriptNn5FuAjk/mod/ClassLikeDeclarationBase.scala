...
trait ClassLikeDeclarationBase
  ...
  @JSName("kind")
  val kind_ClassLikeDeclarationBase: typings.typescriptNn5FuAjk.mod.SyntaxKind.ClassDeclaration | typings.typescriptNn5FuAjk.mod.SyntaxKind.ClassExpression = js.native
