...
- typings.typescriptNn5FuAjk.mod.FlowType because Already inherited
- typings.typescriptNn5FuAjk.mod.Type because Already inherited
- typings.typescriptNn5FuAjk.mod.ObjectType because Already inherited
- typings.typescriptNn5FuAjk.mod.TypeReference because var conflicts: aliasSymbol, aliasTypeArguments, flags, objectFlags, pattern, symbol. Inlined target, node, typeArguments */ trait GenericType
  extends StObject
     with InterfaceType {
