...
trait WatchOptions
  ...
  var excludeDirectories: js.UndefOr[Array[java.lang.String]] = js.undefined
  
  var excludeFiles: js.UndefOr[Array[java.lang.String]] = js.undefined
...
object WatchOptions {
  ...
  extension [Self <: WatchOptions](x: Self) {
    ...
    inline def setExcludeDirectories(value: Array[java.lang.String]): Self = StObject.set(x, "excludeDirectories", value.asInstanceOf[js.Any])
    
    inline def setExcludeDirectoriesUndefined: Self = StObject.set(x, "excludeDirectories", js.undefined)
    
    inline def setExcludeFiles(value: Array[java.lang.String]): Self = StObject.set(x, "excludeFiles", value.asInstanceOf[js.Any])
