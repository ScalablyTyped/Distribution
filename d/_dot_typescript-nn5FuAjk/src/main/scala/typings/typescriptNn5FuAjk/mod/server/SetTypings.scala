...
import typings.typescriptNn5FuAjk.mod.SortedReadonlyArray
...
object SetTypings {
  ...
  extension [Self <: SetTypings](x: Self) {
    ...
    inline def setTypings_(value: Array[String]): Self = StObject.set(x, "typings", value.asInstanceOf[js.Any])
