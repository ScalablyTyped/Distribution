...
trait IdentifierTypePredicate
  ...
  @JSName("kind")
  var kind_IdentifierTypePredicate: typings.typescriptNn5FuAjk.mod.TypePredicateKind.Identifier
...
object IdentifierTypePredicate {
  ...
  extension [Self <: IdentifierTypePredicate](x: Self) {
    ...
    inline def setKind(value: typings.typescriptNn5FuAjk.mod.TypePredicateKind.Identifier): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
