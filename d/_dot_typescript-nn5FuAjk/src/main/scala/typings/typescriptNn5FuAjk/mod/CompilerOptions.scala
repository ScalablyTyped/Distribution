...
trait CompilerOptions
  ...
  var lib: js.UndefOr[Array[java.lang.String]] = js.undefined
  ...
  var moduleSuffixes: js.UndefOr[Array[java.lang.String]] = js.undefined
  ...
  var paths: js.UndefOr[MapLike[Array[java.lang.String]]] = js.undefined
  ...
  var rootDirs: js.UndefOr[Array[java.lang.String]] = js.undefined
  ...
  var typeRoots: js.UndefOr[Array[java.lang.String]] = js.undefined
  
  var types: js.UndefOr[Array[java.lang.String]] = js.undefined
...
object CompilerOptions {
  ...
  extension [Self <: CompilerOptions](x: Self) {
    ...
    inline def setLib(value: Array[java.lang.String]): Self = StObject.set(x, "lib", value.asInstanceOf[js.Any])
    ...
    inline def setModuleSuffixes(value: Array[java.lang.String]): Self = StObject.set(x, "moduleSuffixes", value.asInstanceOf[js.Any])
    ...
    inline def setPaths(value: MapLike[Array[java.lang.String]]): Self = StObject.set(x, "paths", value.asInstanceOf[js.Any])
    ...
    inline def setRootDirs(value: Array[java.lang.String]): Self = StObject.set(x, "rootDirs", value.asInstanceOf[js.Any])
    ...
    inline def setTypeRoots(value: Array[java.lang.String]): Self = StObject.set(x, "typeRoots", value.asInstanceOf[js.Any])
    
    inline def setTypeRootsUndefined: Self = StObject.set(x, "typeRoots", js.undefined)
    
    inline def setTypes(value: Array[java.lang.String]): Self = StObject.set(x, "types", value.asInstanceOf[js.Any])
