...
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.`not-equal`
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.`timed-out`
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.ok
...
trait Atomics extends StObject {
  ...
  val toStringTag: typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.Atomics = js.native
