...
trait Int8Array
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any]): Int8Array = js.native
  def filter(
    predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any],
    thisArg: Any
  ): Int8Array = js.native
  ...
  val toStringTag: typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.Int8Array = js.native
