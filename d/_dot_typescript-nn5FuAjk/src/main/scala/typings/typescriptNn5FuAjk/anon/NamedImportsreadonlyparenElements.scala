...
import typings.typescriptNn5FuAjk.ts.SyntaxKind.NamedImports
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined .typescript-nn5FuAjk.ts.NamedImports & { readonly parent :.typescript-nn5FuAjk.ts.ImportClause & { readonly isTypeOnly :true}} */
@js.native
trait NamedImportsreadonlyparenElements extends StObject {
  ...
  val parent: ImportClause & ImportClausereadonlyisTypForEachChild = js.native
