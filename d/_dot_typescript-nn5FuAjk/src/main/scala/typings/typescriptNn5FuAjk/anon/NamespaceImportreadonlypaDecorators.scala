...
import typings.typescriptNn5FuAjk.ts.SyntaxKind.NamespaceImport
import typings.typescriptNn5FuAjk.ts.TypeOnlyAliasDeclaration
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined .typescript-nn5FuAjk.ts.NamespaceImport & { readonly parent :.typescript-nn5FuAjk.ts.ImportClause & { readonly isTypeOnly :true}} */
@js.native
trait NamespaceImportreadonlypaDecorators
  extends StObject
