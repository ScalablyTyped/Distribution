...
import typings.typescriptNn5FuAjk.mod.ImportDeclaration
import typings.typescriptNn5FuAjk.mod.ModifiersArray
import typings.typescriptNn5FuAjk.mod.NamedImportBindings
...
import typings.typescriptNn5FuAjk.mod.SyntaxKind.ImportClause
...
/* Inlined .typescript-nn5FuAjk..typescript-nn5FuAjk.ImportClause & { readonly isTypeOnly :true,  readonly name :.typescript-nn5FuAjk..typescript-nn5FuAjk.Identifier} */
@js.native
trait ImportClausereadonlyisTypDecorators
  extends StObject
