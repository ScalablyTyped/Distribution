...
import typings.typescriptNn5FuAjk.ts.SyntaxKind.ExportSpecifier
...
/* Inlined { readonly isTypeOnly :true} & .typescript-nn5FuAjk.ts.ExportSpecifier */
@js.native
trait readonlyisTypeOnlytrueExpDecorators
  extends StObject
