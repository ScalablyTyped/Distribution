...
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.ExportSpecifier
...
/* Inlined { readonly isTypeOnly :true} & .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExportSpecifier */
@js.native
