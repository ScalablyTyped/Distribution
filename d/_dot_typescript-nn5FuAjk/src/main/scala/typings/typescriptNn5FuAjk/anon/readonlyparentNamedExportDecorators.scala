...
/* Inlined { readonly parent :.typescript-nn5FuAjk.ts.NamedExports & { readonly parent :.typescript-nn5FuAjk.ts.ExportDeclaration & { readonly isTypeOnly :true}}} & .typescript-nn5FuAjk.ts.ExportSpecifier */
@js.native
trait readonlyparentNamedExportDecorators
  extends StObject
  ...
  val parent: NamedExportsreadonlyparenElements & NamedExports = js.native
