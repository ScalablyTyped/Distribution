...
import typings.typescriptNn5FuAjk.mod.CompletionEntry
import typings.typescriptNn5FuAjk.mod.CompletionInfoFlags
import typings.typescriptNn5FuAjk.mod.TextSpan
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkBooleans.`true`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined .typescript-nn5FuAjk..typescript-nn5FuAjk.WithMetadata<.typescript-nn5FuAjk..typescript-nn5FuAjk.CompletionInfo> */
trait WithMetadataCompletionInfEntries extends StObject {
...
object WithMetadataCompletionInfEntries {
  ...
  inline def apply(
  ...
  ): WithMetadataCompletionInfEntries = {
    ...
    __obj.asInstanceOf[WithMetadataCompletionInfEntries]
  }
  
  extension [Self <: WithMetadataCompletionInfEntries](x: Self) {
