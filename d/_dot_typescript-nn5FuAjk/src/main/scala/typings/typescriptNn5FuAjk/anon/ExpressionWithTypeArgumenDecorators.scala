...
import typings.typescriptNn5FuAjk.ts.LeftHandSideExpression
...
import typings.typescriptNn5FuAjk.ts.PropertyAccessEntityNameExpression
import typings.typescriptNn5FuAjk.ts.SourceFile
import typings.typescriptNn5FuAjk.ts.SourceFileLike
import typings.typescriptNn5FuAjk.ts.SyntaxKind.ExpressionWithTypeArguments
import typings.typescriptNn5FuAjk.ts.TypeNode
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined .typescript-nn5FuAjk.ts.ExpressionWithTypeArguments & { readonly expression :.typescript-nn5FuAjk.ts.Identifier | .typescript-nn5FuAjk.ts.PropertyAccessEntityNameExpression} */
@js.native
trait ExpressionWithTypeArgumenDecorators extends StObject {
