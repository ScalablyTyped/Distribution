...
import typings.typescriptNn5FuAjk.mod.AssertClause
import typings.typescriptNn5FuAjk.mod.Decorator
import typings.typescriptNn5FuAjk.mod.Expression
import typings.typescriptNn5FuAjk.mod.Identifier
import typings.typescriptNn5FuAjk.mod.ModifiersArray
import typings.typescriptNn5FuAjk.mod.ModuleBlock
import typings.typescriptNn5FuAjk.mod.NamedExportBindings
...
import typings.typescriptNn5FuAjk.mod.NumericLiteral
import typings.typescriptNn5FuAjk.mod.SourceFile
import typings.typescriptNn5FuAjk.mod.SourceFileLike
import typings.typescriptNn5FuAjk.mod.StringLiteral
import typings.typescriptNn5FuAjk.mod.SyntaxKind.ExportDeclaration
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkBooleans.`true`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined .typescript-nn5FuAjk..typescript-nn5FuAjk.ExportDeclaration & { readonly isTypeOnly :true} */
@js.native
trait ExportDeclarationreadonlyAssertClause extends StObject {
