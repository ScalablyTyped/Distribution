...
import typings.typescriptNn5FuAjk.ts.SyntaxKind.NamedExports
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined .typescript-nn5FuAjk.ts.NamedExports & { readonly parent :.typescript-nn5FuAjk.ts.ExportDeclaration & { readonly isTypeOnly :true}} */
@js.native
trait NamedExportsreadonlyparenElements extends StObject {
  ...
  val parent: ExportDeclaration & ExportDeclarationreadonlyDeclarationBrand = js.native
