...
import typings.typescriptNn5FuAjk.ts.SyntaxKind.ImportEqualsDeclaration
...
/* Inlined .typescript-nn5FuAjk.ts.ImportEqualsDeclaration & { readonly isTypeOnly :true} */
@js.native
trait ImportEqualsDeclarationreDecorators
  extends StObject
