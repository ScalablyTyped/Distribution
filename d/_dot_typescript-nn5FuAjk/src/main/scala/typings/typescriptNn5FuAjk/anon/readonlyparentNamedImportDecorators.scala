...
import typings.typescriptNn5FuAjk.ts.SyntaxKind.ImportSpecifier
import typings.typescriptNn5FuAjk.ts.TypeOnlyAliasDeclaration
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined { readonly parent :.typescript-nn5FuAjk.ts.NamedImports & { readonly parent :.typescript-nn5FuAjk.ts.ImportClause & { readonly isTypeOnly :true}}} & .typescript-nn5FuAjk.ts.ImportSpecifier */
@js.native
trait readonlyparentNamedImportDecorators
  extends StObject
  ...
  val parent: NamedImportsreadonlyparenElements & NamedImports = js.native
