...
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings._empty
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.auto
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.encrypted
...
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.waitingforkey
...
trait HTMLMediaElement
  ...
  def play(): Promise[Unit] = js.native
  ...
  var preload: none_ | metadata | auto | _empty = js.native
  ...
  /** Available only in secure contexts. */
  def setMediaKeys(): Promise[Unit] = js.native
  def setMediaKeys(mediaKeys: MediaKeys): Promise[Unit] = js.native
