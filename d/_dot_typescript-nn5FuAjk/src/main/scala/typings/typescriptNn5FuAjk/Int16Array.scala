...
trait Int16Array
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any]): Int16Array = js.native
  def filter(
    predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any],
    thisArg: Any
  ...
  def slice(start: Unit, end: Double): Int16Array = js.native
  ...
  def subarray(begin: Unit, end: Double): Int16Array = js.native
  
  @JSName(js.Symbol.toStringTag)
  val toStringTag: typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.Int16Array = js.native
