...
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.backward
import typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.forward
...
trait HTMLTextAreaElement
  ...
  var selectionDirection: forward | backward | none_ = js.native
  ...
  def setSelectionRange(start: Double, end: Double, direction: forward | backward | none_): Unit = js.native
  def setSelectionRange(start: Double, end: Null, direction: forward | backward | none_): Unit = js.native
  def setSelectionRange(start: Null, end: Double): Unit = js.native
  def setSelectionRange(start: Null, end: Double, direction: forward | backward | none_): Unit = js.native
  def setSelectionRange(start: Null, end: Null, direction: forward | backward | none_): Unit = js.native
