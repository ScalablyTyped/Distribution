...
open class CSSKeyframesRule ()
  extends StObject
     with typings.typescriptNn5FuAjk.CSSKeyframesRule {
  ...
  /* CompleteClass */
  override val cssRules: typings.typescriptNn5FuAjk.CSSRuleList = js.native
  ...
  /* CompleteClass */
  override def findRule(select: java.lang.String): typings.typescriptNn5FuAjk.CSSKeyframeRule | Null = js.native
  
  /* CompleteClass */
  var name: java.lang.String = js.native
  
  /* CompleteClass */
  override val parentRule: typings.typescriptNn5FuAjk.CSSRule | Null = js.native
  
  /* CompleteClass */
  override val parentStyleSheet: typings.typescriptNn5FuAjk.CSSStyleSheet | Null = js.native
