...
open class CSSImportRule ()
  extends StObject
     with typings.typescriptNn5FuAjk.CSSImportRule {
  ...
  /* CompleteClass */
  override val media: typings.typescriptNn5FuAjk.MediaList = js.native
  ...
  /* CompleteClass */
  override val styleSheet: typings.typescriptNn5FuAjk.CSSStyleSheet = js.native
