...
open class DOMException ()
  extends StObject
     with typings.typescriptNn5FuAjk.DOMException {
...
object DOMException {
  ...
  @JSGlobal("DOMException.ABORT_ERR")
  @js.native
  val ABORT_ERR: Double = js.native
  
  @JSGlobal("DOMException.DATA_CLONE_ERR")
  @js.native
  val DATA_CLONE_ERR: Double = js.native
  
  @JSGlobal("DOMException.DOMSTRING_SIZE_ERR")
  @js.native
  val DOMSTRING_SIZE_ERR: Double = js.native
  
  @JSGlobal("DOMException.HIERARCHY_REQUEST_ERR")
  @js.native
  val HIERARCHY_REQUEST_ERR: Double = js.native
  
  @JSGlobal("DOMException.INDEX_SIZE_ERR")
  @js.native
  val INDEX_SIZE_ERR: Double = js.native
  
  @JSGlobal("DOMException.INUSE_ATTRIBUTE_ERR")
  @js.native
  val INUSE_ATTRIBUTE_ERR: Double = js.native
  
  @JSGlobal("DOMException.INVALID_ACCESS_ERR")
  @js.native
  val INVALID_ACCESS_ERR: Double = js.native
  
  @JSGlobal("DOMException.INVALID_CHARACTER_ERR")
  @js.native
  val INVALID_CHARACTER_ERR: Double = js.native
  
  @JSGlobal("DOMException.INVALID_MODIFICATION_ERR")
  @js.native
  val INVALID_MODIFICATION_ERR: Double = js.native
  
  @JSGlobal("DOMException.INVALID_NODE_TYPE_ERR")
  @js.native
  val INVALID_NODE_TYPE_ERR: Double = js.native
  
  @JSGlobal("DOMException.INVALID_STATE_ERR")
  @js.native
  val INVALID_STATE_ERR: Double = js.native
  
  @JSGlobal("DOMException.NAMESPACE_ERR")
  @js.native
  val NAMESPACE_ERR: Double = js.native
  
  @JSGlobal("DOMException.NETWORK_ERR")
  @js.native
  val NETWORK_ERR: Double = js.native
  
  @JSGlobal("DOMException.NOT_FOUND_ERR")
  @js.native
  val NOT_FOUND_ERR: Double = js.native
  
  @JSGlobal("DOMException.NOT_SUPPORTED_ERR")
  @js.native
  val NOT_SUPPORTED_ERR: Double = js.native
  
  @JSGlobal("DOMException.NO_DATA_ALLOWED_ERR")
  @js.native
  val NO_DATA_ALLOWED_ERR: Double = js.native
  
  @JSGlobal("DOMException.NO_MODIFICATION_ALLOWED_ERR")
  @js.native
  val NO_MODIFICATION_ALLOWED_ERR: Double = js.native
  
  @JSGlobal("DOMException.QUOTA_EXCEEDED_ERR")
  @js.native
  val QUOTA_EXCEEDED_ERR: Double = js.native
  
  @JSGlobal("DOMException.SECURITY_ERR")
  @js.native
  val SECURITY_ERR: Double = js.native
  
  @JSGlobal("DOMException.SYNTAX_ERR")
  @js.native
  val SYNTAX_ERR: Double = js.native
  
  @JSGlobal("DOMException.TIMEOUT_ERR")
  @js.native
  val TIMEOUT_ERR: Double = js.native
  
  @JSGlobal("DOMException.TYPE_MISMATCH_ERR")
  @js.native
  val TYPE_MISMATCH_ERR: Double = js.native
  
  @JSGlobal("DOMException.URL_MISMATCH_ERR")
  @js.native
  val URL_MISMATCH_ERR: Double = js.native
  
  @JSGlobal("DOMException.VALIDATION_ERR")
  @js.native
  val VALIDATION_ERR: Double = js.native
  
  @JSGlobal("DOMException.WRONG_DOCUMENT_ERR")
  @js.native
