...
open class DOMRectReadOnly ()
  extends StObject
     with typings.typescriptNn5FuAjk.DOMRectReadOnly {
...
object DOMRectReadOnly {
  ...
  inline def fromRect(): typings.typescriptNn5FuAjk.DOMRectReadOnly = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRect")().asInstanceOf[typings.typescriptNn5FuAjk.DOMRectReadOnly]
  inline def fromRect(other: DOMRectInit): typings.typescriptNn5FuAjk.DOMRectReadOnly = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRect")(other.asInstanceOf[js.Any]).asInstanceOf[typings.typescriptNn5FuAjk.DOMRectReadOnly]
}
