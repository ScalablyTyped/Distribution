...
trait RTCEncodedVideoFrameMetadata extends StObject {
  ...
  var dependencies: js.UndefOr[Array[Double]] = js.undefined
...
object RTCEncodedVideoFrameMetadata {
  ...
  extension [Self <: RTCEncodedVideoFrameMetadata](x: Self) {
    ...
    inline def setDependencies(value: Array[Double]): Self = StObject.set(x, "dependencies", value.asInstanceOf[js.Any])
