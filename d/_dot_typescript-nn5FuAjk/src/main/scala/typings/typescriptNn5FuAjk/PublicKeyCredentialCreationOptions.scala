...
trait PublicKeyCredentialCreationOptions extends StObject {
  ...
  var excludeCredentials: js.UndefOr[Array[PublicKeyCredentialDescriptor]] = js.undefined
...
object PublicKeyCredentialCreationOptions {
  ...
  extension [Self <: PublicKeyCredentialCreationOptions](x: Self) {
    ...
    inline def setExcludeCredentials(value: Array[PublicKeyCredentialDescriptor]): Self = StObject.set(x, "excludeCredentials", value.asInstanceOf[js.Any])
    ...
    inline def setPubKeyCredParams(value: Array[PublicKeyCredentialParameters]): Self = StObject.set(x, "pubKeyCredParams", value.asInstanceOf[js.Any])
