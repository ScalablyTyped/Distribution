...
object FontFace {
  ...
  extension [Self <: FontFace](x: Self) {
    ...
    inline def setLoad(value: () => Promise[FontFace]): Self = StObject.set(x, "load", js.Any.fromFunction0(value))
    
    inline def setLoaded(value: Promise[FontFace]): Self = StObject.set(x, "loaded", value.asInstanceOf[js.Any])
