...
trait FormatCodeSettings
  ...
  var insertSpaceAfterCommaDelimiter: js.UndefOr[Boolean] = js.undefined
  
  var insertSpaceAfterConstructor: js.UndefOr[Boolean] = js.undefined
  
  var insertSpaceAfterFunctionKeywordForAnonymousFunctions: js.UndefOr[Boolean] = js.undefined
  
  var insertSpaceAfterKeywordsInControlFlowStatements: js.UndefOr[Boolean] = js.undefined
  
  var insertSpaceAfterOpeningAndBeforeClosingEmptyBraces: js.UndefOr[Boolean] = js.undefined
  ...
  var insertSpaceAfterOpeningAndBeforeClosingNonemptyBrackets: js.UndefOr[Boolean] = js.undefined
  
  var insertSpaceAfterOpeningAndBeforeClosingNonemptyParenthesis: js.UndefOr[Boolean] = js.undefined
  
  var insertSpaceAfterOpeningAndBeforeClosingTemplateStringBraces: js.UndefOr[Boolean] = js.undefined
  
  var insertSpaceAfterSemicolonInForStatements: js.UndefOr[Boolean] = js.undefined
  
  var insertSpaceAfterTypeAssertion: js.UndefOr[Boolean] = js.undefined
  
  var insertSpaceBeforeAndAfterBinaryOperators: js.UndefOr[Boolean] = js.undefined
  ...
  var placeOpenBraceOnNewLineForControlBlocks: js.UndefOr[Boolean] = js.undefined
  
  var placeOpenBraceOnNewLineForFunctions: js.UndefOr[Boolean] = js.undefined
  
  var semicolons: js.UndefOr[SemicolonPreference] = js.undefined
}
