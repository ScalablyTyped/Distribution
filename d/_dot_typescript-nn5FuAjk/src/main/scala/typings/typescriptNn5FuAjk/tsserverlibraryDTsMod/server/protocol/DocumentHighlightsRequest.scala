...
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.server.protocol.CommandTypes.DocumentHighlights
...
object DocumentHighlightsRequest {
  ...
  inline def apply(arguments: DocumentHighlightsRequestArgs, command: DocumentHighlights, seq: Double): DocumentHighlightsRequest = {
