...
/* Rewritten from type alias, can be one of: 
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.Type
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.IncompleteType
*/
trait FlowType extends StObject
object FlowType {
  
  inline def IncompleteType(flags: TypeFlags, `type`: Type): typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.IncompleteType = {
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.IncompleteType]
  }
  ...
  inline def Type(
    ...
    getConstraint: () => js.UndefOr[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.Type],
    getConstructSignatures: () => Array[Signature],
    getDefault: () => js.UndefOr[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.Type],
    getFlags: () => TypeFlags,
    getNonNullableType: () => typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.Type,
    getNumberIndexType: () => js.UndefOr[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.Type],
    getProperties: () => Array[Symbol],
    getProperty: java.lang.String => js.UndefOr[Symbol],
    getStringIndexType: () => js.UndefOr[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.Type],
    ...
    __obj.asInstanceOf[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.Type]
  }
}
