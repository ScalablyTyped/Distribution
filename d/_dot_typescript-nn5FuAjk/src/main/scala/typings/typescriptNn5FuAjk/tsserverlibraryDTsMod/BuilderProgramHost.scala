...
object BuilderProgramHost {
  ...
  extension [Self <: BuilderProgramHost](x: Self) {
    ...
    inline def setWriteFile(
      value: (/* fileName */ java.lang.String, /* text */ java.lang.String, /* writeByteOrderMark */ Boolean, /* onError */ js.UndefOr[js.Function1[/* message */ java.lang.String, Unit]], /* sourceFiles */ js.UndefOr[Array[SourceFile]], /* data */ js.UndefOr[WriteFileCallbackData]) => Unit
