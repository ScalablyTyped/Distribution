...
- typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.TypeElement because var conflicts: _declarationBrand. Inlined _typeElementBrand, questionToken */ @js.native
