...
import typings.typescriptNn5FuAjk.anon.Affected
import typings.typescriptNn5FuAjk.anon.Config
import typings.typescriptNn5FuAjk.anon.Errors
import typings.typescriptNn5FuAjk.anon.EscapedIdentifier
import typings.typescriptNn5FuAjk.anon.ExpressionWithTypeArgumen
import typings.typescriptNn5FuAjk.anon.FileExists
import typings.typescriptNn5FuAjk.anon.FnCall
import typings.typescriptNn5FuAjk.anon.Metadata
import typings.typescriptNn5FuAjk.anon.Options
...
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.AsteriskAsteriskToken
...
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.ImportKeyword
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.KeyOfKeyword
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.MultiLineCommentTrivia
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.NewKeyword
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.SingleLineCommentTrivia
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.UniqueKeyword
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.^
...
inline def createEnumDeclaration(decorators: Array[Decorator], modifiers: Unit, name: java.lang.String, members: Array[EnumMember]): EnumDeclaration = (^.asInstanceOf[js.Dynamic].applyDynamic("createEnumDeclaration")(decorators.asInstanceOf[js.Any], modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], members.asInstanceOf[js.Any])).asInstanceOf[EnumDeclaration]
...
inline def createGetAccessor(decorators: Unit, modifiers: Unit, name: java.lang.String, parameters: Array[ParameterDeclaration]): GetAccessorDeclaration = (^.asInstanceOf[js.Dynamic].applyDynamic("createGetAccessor")(decorators.asInstanceOf[js.Any], modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], parameters.asInstanceOf[js.Any])).asInstanceOf[GetAccessorDeclaration]
...
inline def createJSDocComment(comment: java.lang.String, tags: Array[JSDocTag]): JSDoc = (^.asInstanceOf[js.Dynamic].applyDynamic("createJSDocComment")(comment.asInstanceOf[js.Any], tags.asInstanceOf[js.Any])).asInstanceOf[JSDoc]
...
inline def createModifiersFromModifierFlags(flags: ModifierFlags): js.UndefOr[Array[Modifier]] = ^.asInstanceOf[js.Dynamic].applyDynamic("createModifiersFromModifierFlags")(flags.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Array[Modifier]]]
...
inline def createModuleDeclaration(decorators: Unit, modifiers: Array[Modifier], name: ModuleName, body: Unit, flags: NodeFlags): ModuleDeclaration = (^.asInstanceOf[js.Dynamic].applyDynamic("createModuleDeclaration")(decorators.asInstanceOf[js.Any], modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], body.asInstanceOf[js.Any], flags.asInstanceOf[js.Any])).asInstanceOf[ModuleDeclaration]
...
inline def createModuleDeclaration(decorators: Unit, modifiers: Array[Modifier], name: ModuleName, body: ModuleBody, flags: NodeFlags): ModuleDeclaration = (^.asInstanceOf[js.Dynamic].applyDynamic("createModuleDeclaration")(decorators.asInstanceOf[js.Any], modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], body.asInstanceOf[js.Any], flags.asInstanceOf[js.Any])).asInstanceOf[ModuleDeclaration]
...
inline def createModuleDeclaration(decorators: Array[Decorator], modifiers: Unit, name: ModuleName, body: Unit, flags: NodeFlags): ModuleDeclaration = (^.asInstanceOf[js.Dynamic].applyDynamic("createModuleDeclaration")(decorators.asInstanceOf[js.Any], modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], body.asInstanceOf[js.Any], flags.asInstanceOf[js.Any])).asInstanceOf[ModuleDeclaration]
...
inline def createProgram(rootNames: Array[java.lang.String], options: CompilerOptions): Program = (^.asInstanceOf[js.Dynamic].applyDynamic("createProgram")(rootNames.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Program]
inline def createProgram(
  rootNames: Array[java.lang.String],
  options: CompilerOptions,
  host: Unit,
  oldProgram: Unit,
  configFileParsingDiagnostics: Array[Diagnostic]
...
inline def createProgram(rootNames: Array[java.lang.String], options: CompilerOptions, host: CompilerHost): Program = (^.asInstanceOf[js.Dynamic].applyDynamic("createProgram")(rootNames.asInstanceOf[js.Any], options.asInstanceOf[js.Any], host.asInstanceOf[js.Any])).asInstanceOf[Program]
inline def createProgram(
  rootNames: Array[java.lang.String],
  options: CompilerOptions,
  host: CompilerHost,
...
inline def createPropertySignature(modifiers: Array[Modifier], name: java.lang.String): PropertySignature = (^.asInstanceOf[js.Dynamic].applyDynamic("createPropertySignature")(modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[PropertySignature]
inline def createPropertySignature(
  modifiers: Array[Modifier],
  name: java.lang.String,
  questionToken: Unit,
...
inline def createPropertySignature(modifiers: Array[Modifier], name: java.lang.String, questionToken: Unit, `type`: TypeNode): PropertySignature = (^.asInstanceOf[js.Dynamic].applyDynamic("createPropertySignature")(modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], questionToken.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[PropertySignature]
inline def createPropertySignature(
  modifiers: Array[Modifier],
  name: java.lang.String,
  questionToken: Unit,
...
inline def createPropertySignature(modifiers: Array[Modifier], name: java.lang.String, questionToken: QuestionToken): PropertySignature = (^.asInstanceOf[js.Dynamic].applyDynamic("createPropertySignature")(modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], questionToken.asInstanceOf[js.Any])).asInstanceOf[PropertySignature]
inline def createPropertySignature(
  modifiers: Array[Modifier],
  name: java.lang.String,
  questionToken: QuestionToken,
...
inline def createPropertySignature(modifiers: Array[Modifier], name: java.lang.String, questionToken: QuestionToken, `type`: TypeNode): PropertySignature = (^.asInstanceOf[js.Dynamic].applyDynamic("createPropertySignature")(modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], questionToken.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[PropertySignature]
inline def createPropertySignature(
  modifiers: Array[Modifier],
  name: java.lang.String,
  questionToken: QuestionToken,
...
inline def createSetAccessor(decorators: Unit, modifiers: Unit, name: java.lang.String, parameters: Array[ParameterDeclaration]): SetAccessorDeclaration = (^.asInstanceOf[js.Dynamic].applyDynamic("createSetAccessor")(decorators.asInstanceOf[js.Any], modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], parameters.asInstanceOf[js.Any])).asInstanceOf[SetAccessorDeclaration]
...
inline def createSolutionBuilder[T /* <: BuilderProgram */](host: SolutionBuilderHost[T], rootNames: Array[java.lang.String], defaultOptions: BuildOptions): SolutionBuilder[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("createSolutionBuilder")(host.asInstanceOf[js.Any], rootNames.asInstanceOf[js.Any], defaultOptions.asInstanceOf[js.Any])).asInstanceOf[SolutionBuilder[T]]
...
inline def createTypeParameterDeclaration(modifiers: Array[Modifier], name: java.lang.String): TypeParameterDeclaration = (^.asInstanceOf[js.Dynamic].applyDynamic("createTypeParameterDeclaration")(modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[TypeParameterDeclaration]
inline def createTypeParameterDeclaration(modifiers: Array[Modifier], name: java.lang.String, constraint: Unit, defaultType: TypeNode): TypeParameterDeclaration = (^.asInstanceOf[js.Dynamic].applyDynamic("createTypeParameterDeclaration")(modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], constraint.asInstanceOf[js.Any], defaultType.asInstanceOf[js.Any])).asInstanceOf[TypeParameterDeclaration]
inline def createTypeParameterDeclaration(modifiers: Array[Modifier], name: java.lang.String, constraint: TypeNode): TypeParameterDeclaration = (^.asInstanceOf[js.Dynamic].applyDynamic("createTypeParameterDeclaration")(modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], constraint.asInstanceOf[js.Any])).asInstanceOf[TypeParameterDeclaration]
inline def createTypeParameterDeclaration(modifiers: Array[Modifier], name: java.lang.String, constraint: TypeNode, defaultType: TypeNode): TypeParameterDeclaration = (^.asInstanceOf[js.Dynamic].applyDynamic("createTypeParameterDeclaration")(modifiers.asInstanceOf[js.Any], name.asInstanceOf[js.Any], constraint.asInstanceOf[js.Any], defaultType.asInstanceOf[js.Any])).asInstanceOf[TypeParameterDeclaration]
...
inline def createTypeReferenceNode(typeName: java.lang.String, typeArguments: Array[TypeNode]): TypeReferenceNode = (^.asInstanceOf[js.Dynamic].applyDynamic("createTypeReferenceNode")(typeName.asInstanceOf[js.Any], typeArguments.asInstanceOf[js.Any])).asInstanceOf[TypeReferenceNode]
...
inline def createVariableDeclarationList(declarations: Array[VariableDeclaration], flags: NodeFlags): VariableDeclarationList = (^.asInstanceOf[js.Dynamic].applyDynamic("createVariableDeclarationList")(declarations.asInstanceOf[js.Any], flags.asInstanceOf[js.Any])).asInstanceOf[VariableDeclarationList]
...
inline def createWatchCompilerHost[T /* <: BuilderProgram */](rootFiles: Array[java.lang.String], options: CompilerOptions, system: System): WatchCompilerHostOfFilesAndCompilerOptions[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("createWatchCompilerHost")(rootFiles.asInstanceOf[js.Any], options.asInstanceOf[js.Any], system.asInstanceOf[js.Any])).asInstanceOf[WatchCompilerHostOfFilesAndCompilerOptions[T]]
inline def createWatchCompilerHost[T /* <: BuilderProgram */](
  rootFiles: Array[java.lang.String],
  options: CompilerOptions,
  system: System,
  createProgram: Unit,
  reportDiagnostic: Unit,
...
inline def displayPartsToString(displayParts: Array[SymbolDisplayPart]): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("displayPartsToString")(displayParts.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
...
inline def formatDiagnostics(diagnostics: Array[Diagnostic], host: FormatDiagnosticsHost): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatDiagnostics")(diagnostics.asInstanceOf[js.Any], host.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]

inline def formatDiagnosticsWithColorAndContext(diagnostics: Array[Diagnostic], host: FormatDiagnosticsHost): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatDiagnosticsWithColorAndContext")(diagnostics.asInstanceOf[js.Any], host.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
...
inline def getAllJSDocTagsOfKind(node: Node, kind: SyntaxKind): Array[JSDocTag] = (^.asInstanceOf[js.Dynamic].applyDynamic("getAllJSDocTagsOfKind")(node.asInstanceOf[js.Any], kind.asInstanceOf[js.Any])).asInstanceOf[Array[JSDocTag]]

inline def getAutomaticTypeDirectiveNames(options: CompilerOptions, host: ModuleResolutionHost): Array[java.lang.String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getAutomaticTypeDirectiveNames")(options.asInstanceOf[js.Any], host.asInstanceOf[js.Any])).asInstanceOf[Array[java.lang.String]]
...
inline def getEffectiveTypeRoots(options: CompilerOptions, host: GetEffectiveTypeRootsHost): js.UndefOr[Array[java.lang.String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getEffectiveTypeRoots")(options.asInstanceOf[js.Any], host.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Array[java.lang.String]]]
...
inline def getLeadingCommentRanges(text: java.lang.String, pos: Double): js.UndefOr[Array[CommentRange]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getLeadingCommentRanges")(text.asInstanceOf[js.Any], pos.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Array[CommentRange]]]
...
inline def getOriginalNode_T_Node_T[T /* <: Node */](node: Node, nodeTest: js.Function1[/* node */ Node, /* is T */ Boolean]): T = (^.asInstanceOf[js.Dynamic].applyDynamic("getOriginalNode")(node.asInstanceOf[js.Any], nodeTest.asInstanceOf[js.Any])).asInstanceOf[T]

inline def getOriginalNode_Union(node: Node): js.UndefOr[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("getOriginalNode")(node.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Node]]

inline def getOutputFileNames(commandLine: ParsedCommandLine, inputFileName: java.lang.String, ignoreCase: Boolean): Array[java.lang.String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getOutputFileNames")(commandLine.asInstanceOf[js.Any], inputFileName.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[Array[java.lang.String]]
...
inline def getSupportedCodeFixes(): Array[java.lang.String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getSupportedCodeFixes")().asInstanceOf[Array[java.lang.String]]
...
inline def getTrailingCommentRanges(text: java.lang.String, pos: Double): js.UndefOr[Array[CommentRange]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getTrailingCommentRanges")(text.asInstanceOf[js.Any], pos.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Array[CommentRange]]]
...
inline def hasOnlyExpressionInitializer(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.HasExpressionInitializer */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("hasOnlyExpressionInitializer")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.HasExpressionInitializer */ Boolean]
...
inline def isAccessor(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AccessorDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAccessor")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AccessorDeclaration */ Boolean]

inline def isArrayBindingPattern(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ArrayBindingPattern */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArrayBindingPattern")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ArrayBindingPattern */ Boolean]

inline def isArrayLiteralExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ArrayLiteralExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArrayLiteralExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ArrayLiteralExpression */ Boolean]

inline def isArrayTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ArrayTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArrayTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ArrayTypeNode */ Boolean]

inline def isArrowFunction(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ArrowFunction */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArrowFunction")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ArrowFunction */ Boolean]

inline def isAsExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AsExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAsExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AsExpression */ Boolean]

inline def isAssertClause(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AssertClause */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAssertClause")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AssertClause */ Boolean]

inline def isAssertEntry(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AssertEntry */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAssertEntry")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AssertEntry */ Boolean]

inline def isAssertionExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AssertionExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAssertionExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AssertionExpression */ Boolean]

inline def isAssertionKey(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AssertionKey */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAssertionKey")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AssertionKey */ Boolean]

inline def isAsteriskToken(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AsteriskToken */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAsteriskToken")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AsteriskToken */ Boolean]

inline def isAwaitExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AwaitExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAwaitExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.AwaitExpression */ Boolean]

inline def isBigIntLiteral(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BigIntLiteral */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBigIntLiteral")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BigIntLiteral */ Boolean]

inline def isBinaryExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BinaryExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBinaryExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BinaryExpression */ Boolean]

inline def isBindingElement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BindingElement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBindingElement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BindingElement */ Boolean]

inline def isBindingName(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BindingName */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBindingName")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BindingName */ Boolean]

inline def isBlock(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.Block */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBlock")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.Block */ Boolean]

inline def isBreakOrContinueStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BreakOrContinueStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBreakOrContinueStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BreakOrContinueStatement */ Boolean]

inline def isBreakStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BreakStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBreakStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BreakStatement */ Boolean]

inline def isBundle(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.Bundle */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBundle")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.Bundle */ Boolean]

inline def isCallChain(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CallChain */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCallChain")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CallChain */ Boolean]

inline def isCallExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CallExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCallExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CallExpression */ Boolean]

inline def isCallLikeExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CallLikeExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCallLikeExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CallLikeExpression */ Boolean]
...
inline def isCallSignatureDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CallSignatureDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCallSignatureDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CallSignatureDeclaration */ Boolean]

inline def isCaseBlock(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CaseBlock */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCaseBlock")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CaseBlock */ Boolean]

inline def isCaseClause(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CaseClause */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCaseClause")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CaseClause */ Boolean]

inline def isCaseOrDefaultClause(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CaseOrDefaultClause */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCaseOrDefaultClause")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CaseOrDefaultClause */ Boolean]

inline def isCatchClause(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CatchClause */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCatchClause")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CatchClause */ Boolean]

inline def isClassDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ClassDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isClassDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ClassDeclaration */ Boolean]

inline def isClassElement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ClassElement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isClassElement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ClassElement */ Boolean]

inline def isClassExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ClassExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isClassExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ClassExpression */ Boolean]

inline def isClassLike(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ClassLikeDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isClassLike")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ClassLikeDeclaration */ Boolean]
...
inline def isClassStaticBlockDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ClassStaticBlockDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isClassStaticBlockDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ClassStaticBlockDeclaration */ Boolean]

inline def isCommaListExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CommaListExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCommaListExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.CommaListExpression */ Boolean]

inline def isComputedPropertyName(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ComputedPropertyName */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isComputedPropertyName")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ComputedPropertyName */ Boolean]

inline def isConditionalExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ConditionalExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isConditionalExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ConditionalExpression */ Boolean]

inline def isConditionalTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ConditionalTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isConditionalTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ConditionalTypeNode */ Boolean]
...
inline def isConstructSignatureDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ConstructSignatureDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isConstructSignatureDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ConstructSignatureDeclaration */ Boolean]

inline def isConstructorDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ConstructorDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isConstructorDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ConstructorDeclaration */ Boolean]

inline def isConstructorTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ConstructorTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isConstructorTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ConstructorTypeNode */ Boolean]

inline def isContinueStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ContinueStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isContinueStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ContinueStatement */ Boolean]

inline def isDebuggerStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.DebuggerStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDebuggerStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.DebuggerStatement */ Boolean]

inline def isDecorator(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.Decorator */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDecorator")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.Decorator */ Boolean]

inline def isDefaultClause(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.DefaultClause */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDefaultClause")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.DefaultClause */ Boolean]

inline def isDeleteExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.DeleteExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDeleteExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.DeleteExpression */ Boolean]

inline def isDoStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.DoStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDoStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.DoStatement */ Boolean]

inline def isDotDotDotToken(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.DotDotDotToken */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDotDotDotToken")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.DotDotDotToken */ Boolean]

inline def isElementAccessChain(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ElementAccessChain */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isElementAccessChain")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ElementAccessChain */ Boolean]

inline def isElementAccessExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ElementAccessExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isElementAccessExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ElementAccessExpression */ Boolean]
...
inline def isEmptyBindingPattern(node: BindingName): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BindingPattern */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEmptyBindingPattern")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.BindingPattern */ Boolean]

inline def isEmptyStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.EmptyStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEmptyStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.EmptyStatement */ Boolean]

inline def isEntityName(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.EntityName */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEntityName")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.EntityName */ Boolean]

inline def isEnumDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.EnumDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEnumDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.EnumDeclaration */ Boolean]

inline def isEnumMember(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.EnumMember */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEnumMember")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.EnumMember */ Boolean]

inline def isExportAssignment(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExportAssignment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isExportAssignment")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExportAssignment */ Boolean]

inline def isExportDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExportDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isExportDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExportDeclaration */ Boolean]

inline def isExportSpecifier(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExportSpecifier */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isExportSpecifier")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExportSpecifier */ Boolean]

inline def isExpressionStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExpressionStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isExpressionStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExpressionStatement */ Boolean]

inline def isExpressionWithTypeArguments(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExpressionWithTypeArguments */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isExpressionWithTypeArguments")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExpressionWithTypeArguments */ Boolean]
...
inline def isExternalModuleReference(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExternalModuleReference */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isExternalModuleReference")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ExternalModuleReference */ Boolean]

inline def isForInStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ForInStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isForInStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ForInStatement */ Boolean]

inline def isForOfStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ForOfStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isForOfStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ForOfStatement */ Boolean]

inline def isForStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ForStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isForStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ForStatement */ Boolean]

inline def isFunctionDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.FunctionDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFunctionDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.FunctionDeclaration */ Boolean]

inline def isFunctionExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.FunctionExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFunctionExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.FunctionExpression */ Boolean]

inline def isFunctionLike(): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SignatureDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFunctionLike")().asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SignatureDeclaration */ Boolean]
inline def isFunctionLike(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SignatureDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFunctionLike")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SignatureDeclaration */ Boolean]
...
inline def isFunctionTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.FunctionTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFunctionTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.FunctionTypeNode */ Boolean]

inline def isGetAccessor(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.GetAccessorDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isGetAccessor")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.GetAccessorDeclaration */ Boolean]

inline def isGetAccessorDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.GetAccessorDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isGetAccessorDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.GetAccessorDeclaration */ Boolean]

inline def isHeritageClause(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.HeritageClause */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isHeritageClause")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.HeritageClause */ Boolean]

inline def isIdentifier(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.Identifier */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isIdentifier")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.Identifier */ Boolean]

/**
  * @deprecated Use `isMemberName` instead.
  */
inline def isIdentifierOrPrivateIdentifier(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MemberName */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isIdentifierOrPrivateIdentifier")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MemberName */ Boolean]
...
inline def isIfStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.IfStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isIfStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.IfStatement */ Boolean]

inline def isImportClause(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ImportClause */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isImportClause")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ImportClause */ Boolean]

inline def isImportDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ImportDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isImportDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ImportDeclaration */ Boolean]

inline def isImportEqualsDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ImportEqualsDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isImportEqualsDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ImportEqualsDeclaration */ Boolean]
...
inline def isImportSpecifier(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ImportSpecifier */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isImportSpecifier")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ImportSpecifier */ Boolean]

inline def isImportTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ImportTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isImportTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ImportTypeNode */ Boolean]

inline def isIndexSignatureDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.IndexSignatureDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isIndexSignatureDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.IndexSignatureDeclaration */ Boolean]

inline def isIndexedAccessTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.IndexedAccessTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isIndexedAccessTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.IndexedAccessTypeNode */ Boolean]

inline def isInferTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.InferTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInferTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.InferTypeNode */ Boolean]

inline def isInterfaceDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.InterfaceDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInterfaceDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.InterfaceDeclaration */ Boolean]

inline def isIntersectionTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.IntersectionTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isIntersectionTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.IntersectionTypeNode */ Boolean]
...
inline def isIterationStatement_false(node: Node, lookInLabeledStatements: `false`): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.IterationStatement */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isIterationStatement")(node.asInstanceOf[js.Any], lookInLabeledStatements.asInstanceOf[js.Any])).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.IterationStatement */ Boolean]

inline def isJSDoc(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDoc */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDoc")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDoc */ Boolean]

inline def isJSDocAllType(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocAllType */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocAllType")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocAllType */ Boolean]

inline def isJSDocAugmentsTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocAugmentsTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocAugmentsTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocAugmentsTag */ Boolean]

inline def isJSDocAuthorTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocAuthorTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocAuthorTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocAuthorTag */ Boolean]

inline def isJSDocCallbackTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocCallbackTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocCallbackTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocCallbackTag */ Boolean]

inline def isJSDocClassTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocClassTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocClassTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocClassTag */ Boolean]
...
inline def isJSDocDeprecatedTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocDeprecatedTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocDeprecatedTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocDeprecatedTag */ Boolean]

inline def isJSDocEnumTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocEnumTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocEnumTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocEnumTag */ Boolean]

inline def isJSDocFunctionType(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocFunctionType */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocFunctionType")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocFunctionType */ Boolean]

inline def isJSDocImplementsTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocImplementsTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocImplementsTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocImplementsTag */ Boolean]

inline def isJSDocLink(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocLink */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocLink")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocLink */ Boolean]

inline def isJSDocLinkCode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocLinkCode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocLinkCode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocLinkCode */ Boolean]
...
inline def isJSDocLinkPlain(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocLinkPlain */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocLinkPlain")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocLinkPlain */ Boolean]

inline def isJSDocMemberName(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocMemberName */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocMemberName")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocMemberName */ Boolean]

inline def isJSDocNameReference(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocNameReference */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocNameReference")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocNameReference */ Boolean]

inline def isJSDocNamepathType(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocNamepathType */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocNamepathType")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocNamepathType */ Boolean]

inline def isJSDocNonNullableType(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocNonNullableType */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocNonNullableType")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocNonNullableType */ Boolean]

inline def isJSDocNullableType(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocNullableType */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocNullableType")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocNullableType */ Boolean]

inline def isJSDocOptionalType(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocOptionalType */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocOptionalType")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocOptionalType */ Boolean]

inline def isJSDocOverrideTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocOverrideTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocOverrideTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocOverrideTag */ Boolean]

inline def isJSDocParameterTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocParameterTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocParameterTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocParameterTag */ Boolean]

inline def isJSDocPrivateTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocPrivateTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocPrivateTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocPrivateTag */ Boolean]

inline def isJSDocPropertyLikeTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocPropertyLikeTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocPropertyLikeTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocPropertyLikeTag */ Boolean]

inline def isJSDocPropertyTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocPropertyTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocPropertyTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocPropertyTag */ Boolean]

inline def isJSDocProtectedTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocProtectedTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocProtectedTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocProtectedTag */ Boolean]

inline def isJSDocPublicTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocPublicTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocPublicTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocPublicTag */ Boolean]

inline def isJSDocReadonlyTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocReadonlyTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocReadonlyTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocReadonlyTag */ Boolean]

inline def isJSDocReturnTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocReturnTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocReturnTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocReturnTag */ Boolean]

inline def isJSDocSeeTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocSeeTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocSeeTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocSeeTag */ Boolean]

inline def isJSDocSignature(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocSignature */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocSignature")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocSignature */ Boolean]

inline def isJSDocTemplateTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocTemplateTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocTemplateTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocTemplateTag */ Boolean]

inline def isJSDocThisTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocThisTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocThisTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocThisTag */ Boolean]

inline def isJSDocTypeExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocTypeExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocTypeExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocTypeExpression */ Boolean]

inline def isJSDocTypeLiteral(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocTypeLiteral */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocTypeLiteral")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocTypeLiteral */ Boolean]

inline def isJSDocTypeTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocTypeTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocTypeTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocTypeTag */ Boolean]

inline def isJSDocTypedefTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocTypedefTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocTypedefTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocTypedefTag */ Boolean]

inline def isJSDocUnknownTag(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocUnknownTag */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocUnknownTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocUnknownTag */ Boolean]

inline def isJSDocUnknownType(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocUnknownType */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocUnknownType")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocUnknownType */ Boolean]

inline def isJSDocVariadicType(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocVariadicType */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJSDocVariadicType")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JSDocVariadicType */ Boolean]

inline def isJsxAttribute(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxAttribute */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxAttribute")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxAttribute */ Boolean]

inline def isJsxAttributes(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxAttributes */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxAttributes")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxAttributes */ Boolean]

inline def isJsxClosingElement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxClosingElement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxClosingElement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxClosingElement */ Boolean]

inline def isJsxClosingFragment(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxClosingFragment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxClosingFragment")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxClosingFragment */ Boolean]

inline def isJsxElement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxElement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxElement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxElement */ Boolean]

inline def isJsxExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxExpression */ Boolean]

inline def isJsxFragment(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxFragment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxFragment")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxFragment */ Boolean]

inline def isJsxOpeningElement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxOpeningElement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxOpeningElement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxOpeningElement */ Boolean]

inline def isJsxOpeningFragment(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxOpeningFragment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxOpeningFragment")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxOpeningFragment */ Boolean]

inline def isJsxOpeningLikeElement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxOpeningLikeElement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxOpeningLikeElement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxOpeningLikeElement */ Boolean]

inline def isJsxSelfClosingElement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxSelfClosingElement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxSelfClosingElement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxSelfClosingElement */ Boolean]

inline def isJsxSpreadAttribute(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxSpreadAttribute */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxSpreadAttribute")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxSpreadAttribute */ Boolean]

inline def isJsxText(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxText */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isJsxText")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.JsxText */ Boolean]

inline def isLabeledStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.LabeledStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isLabeledStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.LabeledStatement */ Boolean]
...
inline def isLiteralExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.LiteralExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isLiteralExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.LiteralExpression */ Boolean]

inline def isLiteralTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.LiteralTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isLiteralTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.LiteralTypeNode */ Boolean]

inline def isMappedTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MappedTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMappedTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MappedTypeNode */ Boolean]

inline def isMemberName(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MemberName */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMemberName")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MemberName */ Boolean]

inline def isMetaProperty(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MetaProperty */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMetaProperty")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MetaProperty */ Boolean]

inline def isMethodDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MethodDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMethodDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MethodDeclaration */ Boolean]

inline def isMethodSignature(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MethodSignature */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMethodSignature")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MethodSignature */ Boolean]

inline def isMinusToken(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MinusToken */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMinusToken")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MinusToken */ Boolean]

inline def isMissingDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MissingDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMissingDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.MissingDeclaration */ Boolean]

inline def isModifier(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.Modifier */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isModifier")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.Modifier */ Boolean]

inline def isModuleBlock(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ModuleBlock */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isModuleBlock")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ModuleBlock */ Boolean]

inline def isModuleDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ModuleDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isModuleDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ModuleDeclaration */ Boolean]

inline def isNamedExportBindings(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamedExportBindings */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNamedExportBindings")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamedExportBindings */ Boolean]

inline def isNamedExports(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamedExports */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNamedExports")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamedExports */ Boolean]

inline def isNamedImports(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamedImports */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNamedImports")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamedImports */ Boolean]

inline def isNamedTupleMember(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamedTupleMember */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNamedTupleMember")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamedTupleMember */ Boolean]

inline def isNamespaceExport(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamespaceExport */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNamespaceExport")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamespaceExport */ Boolean]

inline def isNamespaceExportDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamespaceExportDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNamespaceExportDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamespaceExportDeclaration */ Boolean]

inline def isNamespaceImport(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamespaceImport */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNamespaceImport")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NamespaceImport */ Boolean]

inline def isNewExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NewExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNewExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NewExpression */ Boolean]

inline def isNoSubstitutionTemplateLiteral(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NoSubstitutionTemplateLiteral */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNoSubstitutionTemplateLiteral")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NoSubstitutionTemplateLiteral */ Boolean]

inline def isNonNullChain(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NonNullChain */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNonNullChain")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NonNullChain */ Boolean]

inline def isNonNullExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NonNullExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNonNullExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NonNullExpression */ Boolean]

inline def isNotEmittedStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NotEmittedStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNotEmittedStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NotEmittedStatement */ Boolean]
...
inline def isNumericLiteral(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NumericLiteral */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNumericLiteral")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.NumericLiteral */ Boolean]

inline def isObjectBindingPattern(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ObjectBindingPattern */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isObjectBindingPattern")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ObjectBindingPattern */ Boolean]

inline def isObjectLiteralElement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ObjectLiteralElement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isObjectLiteralElement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ObjectLiteralElement */ Boolean]

inline def isObjectLiteralElementLike(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ObjectLiteralElementLike */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isObjectLiteralElementLike")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ObjectLiteralElementLike */ Boolean]

inline def isObjectLiteralExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ObjectLiteralExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isObjectLiteralExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ObjectLiteralExpression */ Boolean]

inline def isOmittedExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.OmittedExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isOmittedExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.OmittedExpression */ Boolean]
...
inline def isOptionalTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.OptionalTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isOptionalTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.OptionalTypeNode */ Boolean]

inline def isParameter(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ParameterDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isParameter")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ParameterDeclaration */ Boolean]

inline def isParameterPropertyDeclaration(node: Node, parent: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ParameterPropertyDeclaration */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isParameterPropertyDeclaration")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ParameterPropertyDeclaration */ Boolean]

inline def isParenthesizedExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ParenthesizedExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isParenthesizedExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ParenthesizedExpression */ Boolean]

inline def isParenthesizedTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ParenthesizedTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isParenthesizedTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ParenthesizedTypeNode */ Boolean]
...
inline def isPartiallyEmittedExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PartiallyEmittedExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPartiallyEmittedExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PartiallyEmittedExpression */ Boolean]

inline def isPlusToken(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PlusToken */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPlusToken")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PlusToken */ Boolean]

inline def isPostfixUnaryExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PostfixUnaryExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPostfixUnaryExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PostfixUnaryExpression */ Boolean]

inline def isPrefixUnaryExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PrefixUnaryExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPrefixUnaryExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PrefixUnaryExpression */ Boolean]

inline def isPrivateIdentifier(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PrivateIdentifier */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPrivateIdentifier")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PrivateIdentifier */ Boolean]

inline def isPropertyAccessChain(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertyAccessChain */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPropertyAccessChain")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertyAccessChain */ Boolean]

inline def isPropertyAccessExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertyAccessExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPropertyAccessExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertyAccessExpression */ Boolean]
...
inline def isPropertyAssignment(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertyAssignment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPropertyAssignment")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertyAssignment */ Boolean]

inline def isPropertyDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertyDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPropertyDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertyDeclaration */ Boolean]

inline def isPropertyName(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertyName */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPropertyName")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertyName */ Boolean]

inline def isPropertySignature(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertySignature */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPropertySignature")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.PropertySignature */ Boolean]

inline def isQualifiedName(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.QualifiedName */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isQualifiedName")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.QualifiedName */ Boolean]

inline def isRegularExpressionLiteral(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.RegularExpressionLiteral */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isRegularExpressionLiteral")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.RegularExpressionLiteral */ Boolean]

inline def isRestTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.RestTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isRestTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.RestTypeNode */ Boolean]

inline def isReturnStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ReturnStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isReturnStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ReturnStatement */ Boolean]

inline def isSemicolonClassElement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SemicolonClassElement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isSemicolonClassElement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SemicolonClassElement */ Boolean]

inline def isSetAccessor(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SetAccessorDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isSetAccessor")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SetAccessorDeclaration */ Boolean]

inline def isSetAccessorDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SetAccessorDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isSetAccessorDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SetAccessorDeclaration */ Boolean]

inline def isShorthandPropertyAssignment(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ShorthandPropertyAssignment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isShorthandPropertyAssignment")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ShorthandPropertyAssignment */ Boolean]

inline def isSourceFile(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SourceFile */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isSourceFile")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SourceFile */ Boolean]

inline def isSpreadAssignment(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SpreadAssignment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isSpreadAssignment")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SpreadAssignment */ Boolean]

inline def isSpreadElement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SpreadElement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isSpreadElement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SpreadElement */ Boolean]

inline def isStringLiteral(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.StringLiteral */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isStringLiteral")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.StringLiteral */ Boolean]

inline def isStringLiteralLike(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.StringLiteralLike */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isStringLiteralLike")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.StringLiteralLike */ Boolean]
...
inline def isSwitchStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SwitchStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isSwitchStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SwitchStatement */ Boolean]

inline def isSyntheticExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SyntheticExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isSyntheticExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.SyntheticExpression */ Boolean]

inline def isTaggedTemplateExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TaggedTemplateExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTaggedTemplateExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TaggedTemplateExpression */ Boolean]

inline def isTemplateExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTemplateExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateExpression */ Boolean]

inline def isTemplateHead(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateHead */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTemplateHead")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateHead */ Boolean]

inline def isTemplateLiteral(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateLiteral */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTemplateLiteral")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateLiteral */ Boolean]

inline def isTemplateLiteralToken(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateLiteralToken */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTemplateLiteralToken")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateLiteralToken */ Boolean]

inline def isTemplateLiteralTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateLiteralTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTemplateLiteralTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateLiteralTypeNode */ Boolean]

inline def isTemplateLiteralTypeSpan(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateLiteralTypeSpan */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTemplateLiteralTypeSpan")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateLiteralTypeSpan */ Boolean]

inline def isTemplateMiddle(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateMiddle */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTemplateMiddle")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateMiddle */ Boolean]
...
inline def isTemplateSpan(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateSpan */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTemplateSpan")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateSpan */ Boolean]

inline def isTemplateTail(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateTail */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTemplateTail")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TemplateTail */ Boolean]

inline def isThisTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ThisTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isThisTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ThisTypeNode */ Boolean]

inline def isThrowStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ThrowStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isThrowStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.ThrowStatement */ Boolean]
...
inline def isTryStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TryStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTryStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TryStatement */ Boolean]

inline def isTupleTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TupleTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTupleTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TupleTypeNode */ Boolean]

inline def isTypeAliasDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeAliasDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeAliasDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeAliasDeclaration */ Boolean]

/** @deprecated Use `isTypeAssertionExpression` instead. */
inline def isTypeAssertion(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeAssertion */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeAssertion")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeAssertion */ Boolean]

inline def isTypeAssertionExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeAssertion */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeAssertionExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeAssertion */ Boolean]

inline def isTypeElement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeElement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeElement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeElement */ Boolean]

inline def isTypeLiteralNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeLiteralNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeLiteralNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeLiteralNode */ Boolean]
...
/**
  ...
  * of a TypeNode.
  */
inline def isTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeNode */ Boolean]

inline def isTypeOfExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeOfExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeOfExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeOfExpression */ Boolean]

inline def isTypeOnlyImportOrExportDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeOnlyAliasDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeOnlyImportOrExportDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeOnlyAliasDeclaration */ Boolean]

inline def isTypeOperatorNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeOperatorNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeOperatorNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeOperatorNode */ Boolean]

inline def isTypeParameterDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeParameterDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeParameterDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeParameterDeclaration */ Boolean]

inline def isTypePredicateNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypePredicateNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypePredicateNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypePredicateNode */ Boolean]

inline def isTypeQueryNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeQueryNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeQueryNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeQueryNode */ Boolean]

inline def isTypeReferenceNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeReferenceNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypeReferenceNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.TypeReferenceNode */ Boolean]

inline def isUnionTypeNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.UnionTypeNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isUnionTypeNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.UnionTypeNode */ Boolean]

inline def isUnparsedNode(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.UnparsedNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isUnparsedNode")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.UnparsedNode */ Boolean]

inline def isUnparsedPrepend(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.UnparsedPrepend */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isUnparsedPrepend")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.UnparsedPrepend */ Boolean]

inline def isUnparsedSource(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.UnparsedSource */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isUnparsedSource")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.UnparsedSource */ Boolean]

inline def isUnparsedTextLike(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.UnparsedTextLike */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isUnparsedTextLike")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.UnparsedTextLike */ Boolean]

inline def isVariableDeclaration(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.VariableDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isVariableDeclaration")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.VariableDeclaration */ Boolean]

inline def isVariableDeclarationList(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.VariableDeclarationList */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isVariableDeclarationList")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.VariableDeclarationList */ Boolean]

inline def isVariableStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.VariableStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isVariableStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.VariableStatement */ Boolean]

inline def isVoidExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.VoidExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isVoidExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.VoidExpression */ Boolean]

inline def isWhileStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.WhileStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isWhileStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.WhileStatement */ Boolean]
...
inline def isWithStatement(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.WithStatement */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isWithStatement")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.WithStatement */ Boolean]

inline def isYieldExpression(node: Node): /* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.YieldExpression */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isYieldExpression")(node.asInstanceOf[js.Any]).asInstanceOf[/* is .typescript-nn5FuAjk..typescript-nn5FuAjk/lib/tsserverlibrary.d.ts.YieldExpression */ Boolean]
...
inline def parseCommandLine(commandLine: Array[java.lang.String]): ParsedCommandLine = ^.asInstanceOf[js.Dynamic].applyDynamic("parseCommandLine")(commandLine.asInstanceOf[js.Any]).asInstanceOf[ParsedCommandLine]
inline def parseCommandLine(
  commandLine: Array[java.lang.String],
...
inline def versionMajorMinor: /* "4.7" */ java.lang.String = ^.asInstanceOf[js.Dynamic].selectDynamic("versionMajorMinor").asInstanceOf[/* "4.7" */ java.lang.String]
...
/**
  ...
  * @param context A lexical environment context for the visitor.
  */
inline def visitEachChild_T_Node_T[T /* <: Node */](node: T, visitor: Visitor, context: TransformationContext): T = (^.asInstanceOf[js.Dynamic].applyDynamic("visitEachChild")(node.asInstanceOf[js.Any], visitor.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[T]
...
inline def visitNode[T /* <: Node */](node: T, visitor: Unit, test: Unit, lift: js.Function1[/* node */ Array[Node], T]): js.UndefOr[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("visitNode")(node.asInstanceOf[js.Any], visitor.asInstanceOf[js.Any], test.asInstanceOf[js.Any], lift.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[T]]
...
inline def visitNode[T /* <: Node */](node: T, visitor: Visitor, test: Unit, lift: js.Function1[/* node */ Array[Node], T]): js.UndefOr[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("visitNode")(node.asInstanceOf[js.Any], visitor.asInstanceOf[js.Any], test.asInstanceOf[js.Any], lift.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[T]]
...
/**
  ...
  * @param lift An optional callback to execute to lift a NodeArray into a valid Node.
  */
inline def visitNode_T_Node_T[T /* <: Node */](node: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("visitNode")(node.asInstanceOf[js.Any]).asInstanceOf[T]
inline def visitNode_T_Node_T[T /* <: Node */](node: T, visitor: Unit, test: js.Function1[/* node */ Node, Boolean]): T = (^.asInstanceOf[js.Dynamic].applyDynamic("visitNode")(node.asInstanceOf[js.Any], visitor.asInstanceOf[js.Any], test.asInstanceOf[js.Any])).asInstanceOf[T]
inline def visitNode_T_Node_T[T /* <: Node */](
  node: T,
  visitor: Unit,
  test: js.Function1[/* node */ Node, Boolean],
  lift: js.Function1[/* node */ Array[Node], T]
...
inline def visitNode_T_Node_T[T /* <: Node */](node: T, visitor: Unit, test: Unit, lift: js.Function1[/* node */ Array[Node], T]): T = (^.asInstanceOf[js.Dynamic].applyDynamic("visitNode")(node.asInstanceOf[js.Any], visitor.asInstanceOf[js.Any], test.asInstanceOf[js.Any], lift.asInstanceOf[js.Any])).asInstanceOf[T]
inline def visitNode_T_Node_T[T /* <: Node */](node: T, visitor: Visitor): T = (^.asInstanceOf[js.Dynamic].applyDynamic("visitNode")(node.asInstanceOf[js.Any], visitor.asInstanceOf[js.Any])).asInstanceOf[T]
inline def visitNode_T_Node_T[T /* <: Node */](node: T, visitor: Visitor, test: js.Function1[/* node */ Node, Boolean]): T = (^.asInstanceOf[js.Dynamic].applyDynamic("visitNode")(node.asInstanceOf[js.Any], visitor.asInstanceOf[js.Any], test.asInstanceOf[js.Any])).asInstanceOf[T]
inline def visitNode_T_Node_T[T /* <: Node */](
  node: T,
  visitor: Visitor,
  test: js.Function1[/* node */ Node, Boolean],
...
inline def visitNode_T_Node_T[T /* <: Node */](node: T, visitor: Visitor, test: Unit, lift: js.Function1[/* node */ Array[Node], T]): T = (^.asInstanceOf[js.Dynamic].applyDynamic("visitNode")(node.asInstanceOf[js.Any], visitor.asInstanceOf[js.Any], test.asInstanceOf[js.Any], lift.asInstanceOf[js.Any])).asInstanceOf[T]
...
type AbstractKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.AbstractKeyword]
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.OmittedExpression
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SpreadElement
  ...
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.AssignmentExpression[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.EqualsToken]
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.Identifier
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.PropertyAccessExpression
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.ElementAccessExpression
*/
type ArrayBindingOrAssignmentElement = _ArrayBindingOrAssignmentElement | AssignmentExpression[EqualsToken]

type AssertKeyword = KeywordToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.AssertKeyword]

type AssertsKeyword = KeywordToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.AssertsKeyword]

type AssertsToken = AssertsKeyword

/* Rewritten from type alias, can be one of: 
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.QuestionQuestionToken
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.LogicalOperatorOrHigher
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.AssignmentOperator
*/
type AssignmentOperatorOrHigher = _AssignmentOperatorOrHigher | LogicalOperatorOrHigher

type AssignmentOperatorToken = Token[AssignmentOperator]

type AsteriskToken = PunctuationToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.AsteriskToken]

type AsyncKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.AsyncKeyword]

type AwaitKeyword = KeywordToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.AwaitKeyword]
...
/* Rewritten from type alias, can be one of: 
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.AssignmentOperatorOrHigher
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.ObjectBindingOrAssignmentElement
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.ArrayBindingOrAssignmentElement
*/
type BindingOrAssignmentElement = _BindingOrAssignmentElement | AssignmentExpression[EqualsToken]

/* Rewritten from type alias, can be one of: 
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.DotDotDotToken
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SpreadElement
  - typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SpreadAssignment
*/
...
type ColonToken = PunctuationToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.ColonToken]
...
type ConstKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.ConstKeyword]
...
type DeclareKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.DeclareKeyword]

type DefaultKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.DefaultKeyword]
...
type DotDotDotToken = PunctuationToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.DotDotDotToken]

type DotToken = PunctuationToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.DotToken]
...
type EqualsToken = PunctuationToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.EqualsToken]

type ErrorCallback = js.Function2[/* message */ DiagnosticMessage, /* length */ Double, Unit]

type ExclamationToken = PunctuationToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.ExclamationToken]

type ExponentiationOperator = AsteriskAsteriskToken

type ExportKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.ExportKeyword]
...
type InKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.InKeyword]
...
type MinusToken = PunctuationToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.MinusToken]
...
type OutKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.OutKeyword]

type OverrideKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.OverrideKeyword]

type ParameterPropertyModifier = AccessibilityModifier | ReadonlyKeyword

type PlusToken = PunctuationToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.PlusToken]

type PrivateKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.PrivateKeyword]

type ProtectedKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.ProtectedKeyword]

type PublicKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.PublicKeyword]

type PunctuationToken[TKind /* <: PunctuationSyntaxKind */] = Token[TKind]

type QuestionDotToken = PunctuationToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.QuestionDotToken]

type QuestionToken = PunctuationToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.QuestionToken]

type ReadonlyKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.ReadonlyKeyword]
...
type StaticKeyword = ModifierToken[typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.StaticKeyword]
