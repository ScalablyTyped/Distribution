...
trait ModuleResolutionHost extends StObject {
  ...
  var getDirectories: js.UndefOr[js.Function1[/* path */ java.lang.String, Array[java.lang.String]]] = js.undefined
...
object ModuleResolutionHost {
  ...
  extension [Self <: ModuleResolutionHost](x: Self) {
    ...
    inline def setGetDirectories(value: /* path */ java.lang.String => Array[java.lang.String]): Self = StObject.set(x, "getDirectories", js.Any.fromFunction1(value))
