...
- typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.ModuleResolutionHost because var conflicts: directoryExists, getCurrentDirectory. Inlined fileExists, readFile, trace, realpath, getDirectories, useCaseSensitiveFileNames
- typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.MinimalResolutionCacheHost because var conflicts: directoryExists, getCurrentDirectory. Inlined getCompilationSettings, getCompilerHost */ @js.native
