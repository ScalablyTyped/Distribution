...
trait ClassLikeDeclarationBase
  ...
  @JSName("kind")
  val kind_ClassLikeDeclarationBase: typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.ClassDeclaration | typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SyntaxKind.ClassExpression = js.native
