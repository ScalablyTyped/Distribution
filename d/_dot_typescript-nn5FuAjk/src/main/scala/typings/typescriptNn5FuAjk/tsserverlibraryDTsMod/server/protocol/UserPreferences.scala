...
trait UserPreferences extends StObject {
  ...
  val displayPartsForJSDoc: js.UndefOr[Boolean] = js.undefined
  ...
  val lazyConfiguredProjectsFromExternalProject: js.UndefOr[Boolean] = js.undefined
...
object UserPreferences {
  ...
  extension [Self <: UserPreferences](x: Self) {
    ...
    inline def setDisplayPartsForJSDoc(value: Boolean): Self = StObject.set(x, "displayPartsForJSDoc", value.asInstanceOf[js.Any])
    
    inline def setDisplayPartsForJSDocUndefined: Self = StObject.set(x, "displayPartsForJSDoc", js.undefined)
    ...
    inline def setLazyConfiguredProjectsFromExternalProject(value: Boolean): Self = StObject.set(x, "lazyConfiguredProjectsFromExternalProject", value.asInstanceOf[js.Any])
    
    inline def setLazyConfiguredProjectsFromExternalProjectUndefined: Self = StObject.set(x, "lazyConfiguredProjectsFromExternalProject", js.undefined)
