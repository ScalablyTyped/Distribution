...
- typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.FlowType because Already inherited
- typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.Type because Already inherited
- typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.ObjectType because Already inherited
- typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.TypeReference because var conflicts: aliasSymbol, aliasTypeArguments, flags, objectFlags, pattern, symbol. Inlined target, node, typeArguments */ trait GenericType
  extends StObject
     with InterfaceType {
