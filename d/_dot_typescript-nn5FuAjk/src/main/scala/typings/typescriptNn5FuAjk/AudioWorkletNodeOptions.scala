...
trait AudioWorkletNodeOptions
  ...
  var outputChannelCount: js.UndefOr[Array[Double]] = js.undefined
...
object AudioWorkletNodeOptions {
  ...
  extension [Self <: AudioWorkletNodeOptions](x: Self) {
    ...
    inline def setOutputChannelCount(value: Array[Double]): Self = StObject.set(x, "outputChannelCount", value.asInstanceOf[js.Any])
