...
trait ProxyHandler[T /* <: js.Object */] extends StObject {
  ...
  @JSName("apply")
  var apply: js.UndefOr[js.Function3[/* target */ T, /* thisArg */ Any, /* argArray */ Array[Any], Any]] = js.undefined
  
  var construct: js.UndefOr[
    js.Function3[/* target */ T, /* argArray */ Array[Any], /* newTarget */ Function, js.Object]
  ] = js.undefined
...
object ProxyHandler {
  ...
  extension [Self <: ProxyHandler[?], T /* <: js.Object */](x: Self & ProxyHandler[T]) {
    ...
    inline def setApply(value: (/* target */ T, /* thisArg */ Any, /* argArray */ Array[Any]) => Any): Self = StObject.set(x, "apply", js.Any.fromFunction3(value))
    
    inline def setApplyUndefined: Self = StObject.set(x, "apply", js.undefined)
    
    inline def setConstruct(value: (/* target */ T, /* argArray */ Array[Any], /* newTarget */ Function) => js.Object): Self = StObject.set(x, "construct", js.Any.fromFunction3(value))
    
    inline def setConstructUndefined: Self = StObject.set(x, "construct", js.undefined)
    
    inline def setDefineProperty(
      value: (/* target */ T, /* p */ java.lang.String | js.Symbol, /* attributes */ PropertyDescriptor) => scala.Boolean
    ...
    inline def setGetOwnPropertyDescriptor(value: (/* target */ T, /* p */ java.lang.String | js.Symbol) => js.UndefOr[PropertyDescriptor]): Self = StObject.set(x, "getOwnPropertyDescriptor", js.Any.fromFunction2(value))
