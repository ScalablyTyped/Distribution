...
import typings.typescriptNn5FuAjk.Intl.DateTimeFormatPartTypes
import typings.typescriptNn5FuAjk.Intl.DisplayNamesFallback
import typings.typescriptNn5FuAjk.Intl.DisplayNamesLanguageDisplay
import typings.typescriptNn5FuAjk.Intl.DisplayNamesType
import typings.typescriptNn5FuAjk.Intl.ES2018NumberFormatPartType
import typings.typescriptNn5FuAjk.Intl.ES2020NumberFormatPartType
import typings.typescriptNn5FuAjk.Intl.LDMLPluralRule
import typings.typescriptNn5FuAjk.Intl.ListFormatLocaleMatcher
import typings.typescriptNn5FuAjk.Intl.ListFormatStyle
import typings.typescriptNn5FuAjk.Intl.ListFormatType
import typings.typescriptNn5FuAjk.Intl.LocaleCollationCaseFirst
import typings.typescriptNn5FuAjk.Intl.LocaleHourCycleKey
import typings.typescriptNn5FuAjk.Intl.NumberFormatPartTypes
import typings.typescriptNn5FuAjk.Intl.PluralRuleType
import typings.typescriptNn5FuAjk.Intl.RelativeTimeFormatLocaleMatcher
import typings.typescriptNn5FuAjk.Intl.RelativeTimeFormatNumeric
import typings.typescriptNn5FuAjk.Intl.RelativeTimeFormatStyle
import typings.typescriptNn5FuAjk.Intl.RelativeTimeFormatUnit
import typings.typescriptNn5FuAjk.WebAssembly.ImportExportKind
import typings.typescriptNn5FuAjk.WebAssembly.TableKind
import typings.typescriptNn5FuAjk.WebAssembly.ValueType
import typings.typescriptNn5FuAjk.mod.CompletionsTriggerCharacter
import typings.typescriptNn5FuAjk.mod.RefactorTriggerReason
import typings.typescriptNn5FuAjk.mod.SignatureHelpRetriggerCharacter
import typings.typescriptNn5FuAjk.mod.SignatureHelpTriggerCharacter
import typings.typescriptNn5FuAjk.mod.TypeOfTag
import typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.CommandTypes
import typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.IndentStyle
import typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.JsxEmit
import typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.ModuleKind
import typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.ModuleResolutionKind
import typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.NewLineKind
import typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.PollingWatchKind
import typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.ScriptTarget
import typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.WatchDirectoryKind
import typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.WatchFileKind
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.server.protocol.DiagnosticEventKind
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.server.protocol.InlayHintKind
import typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.server.protocol.ScriptKindName
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typescriptNn5FuAjkStrings {
  ...
  @js.native
  sealed trait `2020` extends StObject
  ...
  sealed trait `@`
    extends StObject
       ...
       with typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.server.protocol.CompletionsTriggerCharacter
       with typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.CompletionsTriggerCharacter
       with typings.typescriptNn5FuAjk.ts.CompletionsTriggerCharacter
       with typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.CompletionsTriggerCharacter
  ...
  sealed trait Comma
    extends StObject
       ...
       with typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.server.protocol.SignatureHelpRetriggerCharacter
       with typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SignatureHelpRetriggerCharacter
       with typings.typescriptNn5FuAjk.ts.SignatureHelpRetriggerCharacter
       with typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.SignatureHelpRetriggerCharacter
       with SignatureHelpTriggerCharacter
       with typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.server.protocol.SignatureHelpTriggerCharacter
       with typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.SignatureHelpTriggerCharacter
       with typings.typescriptNn5FuAjk.ts.SignatureHelpTriggerCharacter
       with typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.SignatureHelpTriggerCharacter
  ...
  inline def DynamicPriority: DynamicPriority = "DynamicPriority".asInstanceOf[DynamicPriority]
  ...
  sealed trait DynamicPriorityPolling
    extends StObject
       ...
       with WatchFileKind
  inline def DynamicPriorityPolling: DynamicPriorityPolling = "DynamicPriorityPolling".asInstanceOf[DynamicPriorityPolling]
  ...
  sealed trait Enum
    extends StObject
       with InlayHintKind
       with typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.InlayHintKind
  ...
  sealed trait FixedChunkSize
    extends StObject
       with PollingWatchKind
  inline def FixedChunkSize: FixedChunkSize = "FixedChunkSize".asInstanceOf[FixedChunkSize]
  ...
  sealed trait FixedChunkSizePolling
    extends StObject
       with WatchDirectoryKind
       with WatchFileKind
  inline def FixedChunkSizePolling: FixedChunkSizePolling = "FixedChunkSizePolling".asInstanceOf[FixedChunkSizePolling]
  
  @js.native
  sealed trait FixedInterval
    extends StObject
       with PollingWatchKind
  inline def FixedInterval: FixedInterval = "FixedInterval".asInstanceOf[FixedInterval]
  ...
  sealed trait FixedPollingInterval
    extends StObject
       with WatchDirectoryKind
       with WatchFileKind
  inline def FixedPollingInterval: FixedPollingInterval = "FixedPollingInterval".asInstanceOf[FixedPollingInterval]
  ...
  sealed trait JS
    extends StObject
       with ScriptKindName
       with typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.ScriptKindName
  ...
  sealed trait PriorityInterval
    extends StObject
       with PollingWatchKind
  inline def PriorityInterval: PriorityInterval = "PriorityInterval".asInstanceOf[PriorityInterval]
  
  @js.native
  sealed trait PriorityPollingInterval
    extends StObject
       with WatchFileKind
  inline def PriorityPollingInterval: PriorityPollingInterval = "PriorityPollingInterval".asInstanceOf[PriorityPollingInterval]
  ...
  sealed trait UseFsEvents
    extends StObject
       with WatchDirectoryKind
       with WatchFileKind
  inline def UseFsEvents: UseFsEvents = "UseFsEvents".asInstanceOf[UseFsEvents]
  
  @js.native
  sealed trait UseFsEventsOnParentDirectory
    extends StObject
       with WatchFileKind
  inline def UseFsEventsOnParentDirectory: UseFsEventsOnParentDirectory = "UseFsEventsOnParentDirectory".asInstanceOf[UseFsEventsOnParentDirectory]
  ...
  @js.native
  sealed trait beginInstallTypes extends StObject
  inline def beginInstallTypes: beginInstallTypes = "beginInstallTypes".asInstanceOf[beginInstallTypes]
  ...
  @js.native
  sealed trait bigint_
    extends StObject
       with TypeOfTag
       with typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.TypeOfTag
       with typings.typescriptNn5FuAjk.ts.TypeOfTag
  inline def bigint_ : bigint_ = "bigint".asInstanceOf[bigint_]
  ...
  @js.native
  sealed trait completionEntryDetails
    extends StObject
       with CommandTypes
  inline def completionEntryDetails: completionEntryDetails = "completionEntryDetails".asInstanceOf[completionEntryDetails]
  ...
  @js.native
  sealed trait configFileDiag extends StObject
  inline def configFileDiag: configFileDiag = "configFileDiag".asInstanceOf[configFileDiag]
  ...
  @js.native
  sealed trait configured extends StObject
  ...
  @js.native
  sealed trait endInstallTypes extends StObject
  inline def endInstallTypes: endInstallTypes = "endInstallTypes".asInstanceOf[endInstallTypes]
  ...
  @js.native
  sealed trait event_ extends StObject
  ...
  sealed trait `implicit`
    extends StObject
       ...
       with typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.RefactorTriggerReason
       with typings.typescriptNn5FuAjk.tsserverlibraryDTsMod.server.protocol.RefactorTriggerReason
       with typings.typescriptNn5FuAjk.ts.RefactorTriggerReason
       with typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.RefactorTriggerReason
  ...
  @js.native
  sealed trait jsconfigDotjson extends StObject
  inline def jsconfigDotjson: jsconfigDotjson = "jsconfig.json".asInstanceOf[jsconfigDotjson]
  ...
  @js.native
  sealed trait largeFileReferenced extends StObject
  inline def largeFileReferenced: largeFileReferenced = "largeFileReferenced".asInstanceOf[largeFileReferenced]
  ...
  @js.native
  sealed trait `navtree-full`
    extends StObject
       with CommandTypes
  inline def `navtree-full`: `navtree-full` = "navtree-full".asInstanceOf[`navtree-full`]
  ...
  @js.native
  sealed trait preserve_
    extends StObject
       with SelectionMode
  inline def preserve_ : preserve_ = "preserve".asInstanceOf[preserve_]
  ...
  @js.native
  sealed trait projectLanguageServiceState extends StObject
  inline def projectLanguageServiceState: projectLanguageServiceState = "projectLanguageServiceState".asInstanceOf[projectLanguageServiceState]
  
  @js.native
  sealed trait projectLoadingFinish extends StObject
  inline def projectLoadingFinish: projectLoadingFinish = "projectLoadingFinish".asInstanceOf[projectLoadingFinish]
  
  @js.native
  sealed trait projectLoadingStart extends StObject
  inline def projectLoadingStart: projectLoadingStart = "projectLoadingStart".asInstanceOf[projectLoadingStart]
  
  @js.native
  sealed trait projectsUpdatedInBackground extends StObject
  inline def projectsUpdatedInBackground: projectsUpdatedInBackground = "projectsUpdatedInBackground".asInstanceOf[projectsUpdatedInBackground]
  ...
  inline def requestCompleted: requestCompleted = "requestCompleted".asInstanceOf[requestCompleted]
  ...
  @js.native
  sealed trait semanticDiag
    extends StObject
       with DiagnosticEventKind
       with typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.DiagnosticEventKind
  inline def semanticDiag: semanticDiag = "semanticDiag".asInstanceOf[semanticDiag]
  ...
  @js.native
  sealed trait suggestionDiag
    extends StObject
       with DiagnosticEventKind
       with typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.DiagnosticEventKind
  inline def suggestionDiag: suggestionDiag = "suggestionDiag".asInstanceOf[suggestionDiag]
  ...
  @js.native
  sealed trait surveyReady extends StObject
  inline def surveyReady: surveyReady = "surveyReady".asInstanceOf[surveyReady]
  ...
  @js.native
  sealed trait syntaxDiag
    extends StObject
       with DiagnosticEventKind
       with typings.typescriptNn5FuAjk.protocolDTsMod.ts.server.protocol.DiagnosticEventKind
  inline def syntaxDiag: syntaxDiag = "syntaxDiag".asInstanceOf[syntaxDiag]
  ...
  @js.native
  sealed trait `top-level`
    extends StObject
       with FrameType
  inline def `top-level`: `top-level` = "top-level".asInstanceOf[`top-level`]
  ...
  @js.native
  sealed trait tsconfigDotjson extends StObject
  inline def tsconfigDotjson: tsconfigDotjson = "tsconfig.json".asInstanceOf[tsconfigDotjson]
  ...
  @js.native
  sealed trait typesInstallerInitializationFailed extends StObject
  inline def typesInstallerInitializationFailed: typesInstallerInitializationFailed = "typesInstallerInitializationFailed".asInstanceOf[typesInstallerInitializationFailed]
  ...
  @js.native
  sealed trait typingsInstalled extends StObject
  inline def typingsInstalled: typingsInstalled = "typingsInstalled".asInstanceOf[typingsInstalled]
