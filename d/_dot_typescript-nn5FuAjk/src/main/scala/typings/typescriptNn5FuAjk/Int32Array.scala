...
trait Int32Array
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any]): Int32Array = js.native
  def filter(
    predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any],
    thisArg: Any
  ...
  val toStringTag: typings.typescriptNn5FuAjk.typescriptNn5FuAjkStrings.Int32Array = js.native
