...
import typings.immutableHHD54iTc.Immutable.Seq.Indexed
import typings.immutableHHD54iTc.Immutable.Seq.Keyed
import typings.immutableHHD54iTc.anon.Done
...
object Immutable {
  ...
  object Collection {
    ...
    - typings.immutableHHD54iTc.Immutable.Iterable because Already inherited
    - typings.immutableHHD54iTc.Immutable.Iterable.Indexed because var conflicts: size. Inlined fromEntrySeq, interpose, interleave, splice, zip, zipWith, zipWith, zipWith, indexOf, lastIndexOf, findIndex, findIndex, findLastIndex, findLastIndex */ @js.native
    trait Indexed[T]
      extends StObject
      ...
      def findIndex(
        predicate: js.Function3[
              ...
              /* iter */ js.UndefOr[/*this*/ typings.immutableHHD54iTc.Immutable.Iterable.Indexed[T]], 
              Boolean
            ]
      ): Double = js.native
      def findIndex(
      ...
      /**
        ...
        */
      def fromEntrySeq(): typings.immutableHHD54iTc.Immutable.Seq.Keyed[Any, Any] = js.native
      ...
      /**
        ...
        *     // Seq [ 1, 'A', 'X', 2, 'B', 'Y' ]
        */
      def interleave(iterables: (Iterable[Any, T])*): /*this*/ typings.immutableHHD54iTc.Immutable.Iterable.Indexed[T] = js.native
      ...
      /**
        ...
        * in this Iterable.
        */
      def interpose(separator: T): /*this*/ typings.immutableHHD54iTc.Immutable.Iterable.Indexed[T] = js.native
      ...
      /**
        ...
        *
        */
      def splice(index: Double, removeNum: Double, values: (/*Array<Iterable.Indexed<T> | T>*/ Any)*): /*this*/ typings.immutableHHD54iTc.Immutable.Iterable.Indexed[T] = js.native
      ...
      /**
        ...
        *
        */
      def zip(iterables: (Iterable[Any, Any])*): /*this*/ typings.immutableHHD54iTc.Immutable.Iterable.Indexed[Any] = js.native
      
      def zipWith[Z](zipper: js.Function1[/* repeated */ Any, Z], iterables: (Iterable[Any, Any])*): typings.immutableHHD54iTc.Immutable.Iterable.Indexed[Z] = js.native
      /**
        * Returns an Iterable of the same type "zipped" with the provided
        ...
        *
        */
      def zipWith[U, Z](zipper: js.Function2[T, /* otherValue */ U, Z], otherIterable: Iterable[Any, U]): typings.immutableHHD54iTc.Immutable.Iterable.Indexed[Z] = js.native
      def zipWith[U, V, Z](
        zipper: js.Function3[T, /* otherValue */ U, /* thirdValue */ V, Z],
        otherIterable: Iterable[Any, U],
        thirdIterable: Iterable[Any, V]
      ): typings.immutableHHD54iTc.Immutable.Iterable.Indexed[Z] = js.native
    }
    
    /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
    - typings.immutableHHD54iTc.Immutable.Iterable because Already inherited
    - typings.immutableHHD54iTc.Immutable.Iterable.Keyed because var conflicts: size. Inlined flip, mapKeys, mapKeys, mapEntries, mapEntries, keyOf, lastKeyOf, findKey, findKey, findLastKey, findLastKey */ @js.native
    trait Keyed[K, V]
      extends StObject
         with Collection[K, V] {
      ...
      def findKey(
        predicate: js.Function3[
              /* value */ js.UndefOr[V], 
              /* key */ js.UndefOr[K], 
              /* iter */ js.UndefOr[/*this*/ typings.immutableHHD54iTc.Immutable.Iterable.Keyed[K, V]], 
              Boolean
            ]
      ): K = js.native
      def findKey(
      ...
      /**
        ...
        *
        */
      def flip(): /*this*/ typings.immutableHHD54iTc.Immutable.Iterable.Keyed[V, K] = js.native
      ...
      ): /*this*/ typings.immutableHHD54iTc.Immutable.Iterable.Keyed[KM, VM] = js.native
      def mapEntries[KM, VM](
        mapper: js.Function3[
              /* entry */ js.UndefOr[/*(K, V)*/ js.Array[Any]], 
              /* index */ js.UndefOr[Double], 
      ...
      ): /*this*/ typings.immutableHHD54iTc.Immutable.Iterable.Keyed[M, V] = js.native
      def mapKeys[M](
        mapper: js.Function3[
              /* key */ js.UndefOr[K], 
              /* value */ js.UndefOr[V], 
    ...
    /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
    - typings.immutableHHD54iTc.Immutable.Iterable because Already inherited
    - typings.immutableHHD54iTc.Immutable.Iterable.Set because var conflicts: size. Inlined  */ @js.native
    trait Set[T]
      extends StObject
         with Collection[T, T]
  }
  ...
  trait Iterable[K, V] extends StObject {
    ...
    ): /*Map*/ Keyed[G, /*this*/ Iterable[K, V]] = js.native
    def groupBy[G](
      grouper: js.Function3[
          /* value */ js.UndefOr[V], 
          /* key */ js.UndefOr[K], 
    ...
    /**
      ...
      */
    def toOrderedMap(): Map[K, V] = js.native
    ...
    /**
      ...
      * for convenience and to allow for chained expressions.
      */
    def toOrderedSet(): Set[V] = js.native
    ...
    /**
      ...
      */
    def toSetSeq(): typings.immutableHHD54iTc.Immutable.Seq.Set[V] = js.native
  ...
  object Iterable {
    ...
    trait Indexed[T]
      ...
      /**
        ...
        *
        */
      def zipWith[U, Z](zipper: js.Function2[/* value */ T, /* otherValue */ U, Z], otherIterable: Iterable[Any, U]): typings.immutableHHD54iTc.Immutable.Iterable.Indexed[Z] = js.native
      def zipWith[U, V, Z](
  ...
  trait List[T]
    extends StObject
       with typings.immutableHHD54iTc.Immutable.Collection.Indexed[T] {
    ...
    /**
      ...
      * @alias removeIn
      */
    def deleteIn(keyPath: js.Array[Any]): List[T] = js.native
    def deleteIn(keyPath: Iterable[Any, Any]): List[T] = js.native
    ...
    /**
      * @see `Map#merge`
      */
    def merge(iterables: (js.Array[T] | typings.immutableHHD54iTc.Immutable.Iterable.Indexed[T])*): List[T] = js.native
    
    /**
      * @see `Map#mergeDeep`
      */
    def mergeDeep(iterables: (js.Array[T] | typings.immutableHHD54iTc.Immutable.Iterable.Indexed[T])*): List[T] = js.native
    
    def mergeDeepIn(
      keyPath: js.Array[Any],
      iterables: (js.Array[T] | typings.immutableHHD54iTc.Immutable.Iterable.Indexed[T])*
    ): List[T] = js.native
    /**
      * @see `Map#mergeDeepIn`
      */
    def mergeDeepIn(keyPath: Iterable[Any, Any], iterables: typings.immutableHHD54iTc.Immutable.Iterable.Indexed[T]*): List[T] = js.native
    ...
    /**
      * @see `Map#mergeIn`
      */
    def mergeIn(keyPath: Iterable[Any, Any], iterables: typings.immutableHHD54iTc.Immutable.Iterable.Indexed[T]*): List[T] = js.native
    ...
    def removeIn(keyPath: js.Array[Any]): List[T] = js.native
    def removeIn(keyPath: Iterable[Any, Any]): List[T] = js.native
    ...
    /**
      ...
      * the List.
      */
    def setIn(keyPath: js.Array[Any], value: Any): List[T] = js.native
    def setIn(keyPath: Iterable[Any, Any], value: Any): List[T] = js.native
    ...
    def update(index: Double, notSetValue: T, updater: js.Function1[/* value */ T, T]): List[T] = js.native
    def update(index: Double, updater: js.Function1[/* value */ T, T]): List[T] = js.native
    /**
    ...
    def updateIn(keyPath: js.Array[Any], notSetValue: Any, updater: js.Function1[/* value */ Any, Any]): List[T] = js.native
    /**
      * @see `Map#updateIn`
      */
    def updateIn(keyPath: js.Array[Any], updater: js.Function1[/* value */ Any, Any]): List[T] = js.native
    def updateIn(keyPath: Iterable[Any, Any], notSetValue: Any, updater: js.Function1[/* value */ Any, Any]): List[T] = js.native
    def updateIn(keyPath: Iterable[Any, Any], updater: js.Function1[/* value */ Any, Any]): List[T] = js.native
    ...
    /**
      ...
      */
    def withMutations(mutator: js.Function1[/* mutable */ List[T], Any]): List[T] = js.native
  }
  
  @js.native
  trait Map[K, V]
    extends StObject
       with typings.immutableHHD54iTc.Immutable.Collection.Keyed[K, V] {
  ...
  trait Set[T]
    extends StObject
       with typings.immutableHHD54iTc.Immutable.Collection.Set[T] {
