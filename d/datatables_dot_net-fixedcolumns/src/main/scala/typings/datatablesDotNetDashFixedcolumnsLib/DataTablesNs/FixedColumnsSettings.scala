...
trait FixedColumnsSettings extends js.Object {
  /*
    ...
    * 'none' | 'semiauto' | 'auto'
    */
  var heightMatch: js.UndefOr[
    datatablesDotNetDashFixedcolumnsLib.datatablesDotNetDashFixedcolumnsLibStrings.none | datatablesDotNetDashFixedcolumnsLib.datatablesDotNetDashFixedcolumnsLibStrings.semiauto | datatablesDotNetDashFixedcolumnsLib.datatablesDotNetDashFixedcolumnsLibStrings.auto
  ] = js.undefined
  /*
...
object FixedColumnsSettings {
  @scala.inline
  def apply(
    heightMatch: datatablesDotNetDashFixedcolumnsLib.datatablesDotNetDashFixedcolumnsLibStrings.none | datatablesDotNetDashFixedcolumnsLib.datatablesDotNetDashFixedcolumnsLibStrings.semiauto | datatablesDotNetDashFixedcolumnsLib.datatablesDotNetDashFixedcolumnsLibStrings.auto = null,
