...
object ^ extends js.Object {
  ...
  def define(name: java.lang.String, config: DefineConfig): (org.scalablytyped.runtime.Instantiable1[/* attrs */ js.Any, dynamodbLib.modelMod.Model]) with dynamodbLib.TypeofModel = js.native
  ...
  def model(name: java.lang.String): (org.scalablytyped.runtime.Instantiable1[/* attrs */ js.Any, dynamodbLib.modelMod.Model]) with dynamodbLib.TypeofModel = js.native
  def model(name: java.lang.String, model: dynamodbLib.modelMod.Model): (org.scalablytyped.runtime.Instantiable1[/* attrs */ js.Any, dynamodbLib.modelMod.Model]) with dynamodbLib.TypeofModel = js.native
