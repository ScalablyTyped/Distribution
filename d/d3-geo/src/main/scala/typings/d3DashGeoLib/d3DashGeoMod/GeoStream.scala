...
trait GeoStream extends js.Object {
  /**
       ...
       */
  var sphere: js.UndefOr[js.Function0[scala.Unit]] = js.native
  /**
       ...
       */
  def lineEnd(): scala.Unit = js.native
  /**
       ...
       */
  def lineStart(): scala.Unit = js.native
  /**
  ...
  /**
       ...
       * @param z Optional z-coordinate of point.
       */
  def point(x: scala.Double, y: scala.Double, z: scala.Double): scala.Unit = js.native
  /**
       * Indicates the end of a polygon.
       */
  def polygonEnd(): scala.Unit = js.native
  /**
       * Indicates the start of a polygon. The first line of a polygon indicates the exterior ring, and any subsequent lines indicate interior holes.
       */
  def polygonStart(): scala.Unit = js.native
}
