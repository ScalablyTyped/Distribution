...
trait GeoCircleGenerator[This, Datum] extends js.Object {
  /**
    ...
    */
  def apply(`this`: This): geojsonLib.geojsonMod.Polygon = js.native
  def apply(`this`: This, d: Datum, args: js.Any*): geojsonLib.geojsonMod.Polygon = js.native
  /**
    * Returns the current center accessor, which defaults to a function returning [0, 0].
    */
  def center(): js.ThisFunction2[
    /* this */ This, 
    /* d */ Datum, 
    /* repeated */ js.Any, 
  ...
  /**
    ...
    */
  def center(center: js.Tuple2[scala.Double, scala.Double]): this.type = js.native
  /**
    * Returns the current precision accessor, which defaults to a function returning 6.
    */
  def precision(): js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double] = js.native
  /**
    ...
    */
  def precision(precision: js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double]): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def radius(): js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double] = js.native
  /**
    ...
    */
  def radius(radius: js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double]): this.type = js.native
  /**
