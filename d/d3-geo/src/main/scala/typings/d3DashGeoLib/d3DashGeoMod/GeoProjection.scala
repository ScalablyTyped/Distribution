...
trait GeoProjection extends GeoStreamWrapper {
  ...
  var invert: js.UndefOr[
    js.Function1[
      ...
      (js.Tuple2[scala.Double, scala.Double]) | scala.Null
    ]
  ] = js.native
  /**
    ...
    */
  def apply(point: js.Tuple2[scala.Double, scala.Double]): (js.Tuple2[scala.Double, scala.Double]) | scala.Null = js.native
  /**
  ...
  /**
    ...
    */
  def center(): js.Tuple2[scala.Double, scala.Double] = js.native
  /**
    ...
    * @param point A point specified as a two-dimensional array [longitude, latitude] in degrees.
    */
  def center(point: js.Tuple2[scala.Double, scala.Double]): this.type = js.native
  /**
    ...
    */
  def clipAngle(): scala.Double | scala.Null = js.native
  /**
    ...
    */
  def clipAngle(angle: scala.Double): this.type = js.native
  /**
    ...
    */
  @JSName("clipAngle")
  def `clipAngle_<this>`(): this.type = js.native
  /**
  ...
  /**
    ...
    * @param object A geographic geometry collection supported by d3-geo (An extension of GeoJSON geometry collection).
    */
  def fitHeight(height: scala.Double, `object`: ExtendedGeometryCollection[GeoGeometryObjects]): this.type = js.native
  /**
    * A convenience method for projection.fitSize where the width is automatically chosen from the aspect ratio of object and the given constraint on height.
    *
    * @param height The height of the extent.
    * @param object A geographic feature supported by d3-geo (An extension of GeoJSON feature).
    */
  def fitHeight(height: scala.Double, `object`: GeoGeometryObjects): this.type = js.native
  /**
  ...
  /**
    ...
    * @param object A geographic geometry collection supported by d3-geo (An extension of GeoJSON geometry collection).
    */
  def fitWidth(width: scala.Double, `object`: ExtendedGeometryCollection[GeoGeometryObjects]): this.type = js.native
  /**
    * A convenience method for projection.fitSize where the height is automatically chosen from the aspect ratio of object and the given constraint on width.
    *
    * @param width The width of the extent.
    * @param object A geographic feature supported by d3-geo (An extension of GeoJSON feature).
    */
  def fitWidth(width: scala.Double, `object`: GeoGeometryObjects): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def rotate(): js.Tuple3[scala.Double, scala.Double, scala.Double] = js.native
  /**
    ...
    */
  def rotate(angles: js.Tuple2[scala.Double, scala.Double]): this.type = js.native
  def rotate(angles: js.Tuple3[scala.Double, scala.Double, scala.Double]): this.type = js.native
  /**
