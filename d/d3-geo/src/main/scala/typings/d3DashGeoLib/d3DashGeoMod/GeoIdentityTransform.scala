...
trait GeoIdentityTransform extends GeoStreamWrapper {
  /**
    ...
    */
  def clipExtent(): (js.Tuple2[js.Tuple2[scala.Double, scala.Double], js.Tuple2[scala.Double, scala.Double]]) | scala.Null = js.native
  /**
    ...
    */
  def clipExtent(extent: js.Tuple2[js.Tuple2[scala.Double, scala.Double], js.Tuple2[scala.Double, scala.Double]]): this.type = js.native
  /**
    ...
    */
  @JSName("clipExtent")
  def `clipExtent_<this>`(): this.type = js.native
  /**
    ...
    */
  def fitExtent(
    extent: js.Tuple2[js.Tuple2[scala.Double, scala.Double], js.Tuple2[scala.Double, scala.Double]],
  ...
  /**
    ...
    * @param object A GeoJson Geometry Object or GeoSphere object supported by d3-geo (An extension of GeoJSON).
    */
  def fitSize(size: js.Tuple2[scala.Double, scala.Double], `object`: GeoGeometryObjects): this.type = js.native
  /**
    * Returns true if x-reflection is enabled, which defaults to false.
    */
  def reflectX(): scala.Boolean = js.native
  /**
    * Sets whether or not the x-dimension is reflected (negated) in the output.
    *
    * @param reflect true = reflect x-dimension, false = do not reflect x-dimension.
    */
  def reflectX(reflect: scala.Boolean): this.type = js.native
  /**
    * Returns true if y-reflection is enabled, which defaults to false.
    */
  def reflectY(): scala.Boolean = js.native
  /**
    ...
    */
  def reflectY(reflect: scala.Boolean): this.type = js.native
  /**
    * Returns the current scale factor.
    *
    * The scale factor corresponds linearly to the distance between projected points; however, absolute scale factors are not equivalent across projections.
    */
  def scale(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def translate(): js.Tuple2[scala.Double, scala.Double] = js.native
  /**
    ...
    */
  def translate(point: js.Tuple2[scala.Double, scala.Double]): this.type = js.native
}
