...
trait Quadtree[T] extends js.Object {
  ...
  /**
    ...
    */
  def cover(x: scala.Double, y: scala.Double): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def extent(extend: js.Tuple2[js.Tuple2[scala.Double, scala.Double], js.Tuple2[scala.Double, scala.Double]]): this.type = js.native
  /**
    ...
    */
  def find(x: scala.Double, y: scala.Double): js.UndefOr[T] = js.native
  def find(x: scala.Double, y: scala.Double, radius: scala.Double): js.UndefOr[T] = js.native
  /**
