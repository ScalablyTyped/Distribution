...
/* Inlined .protobufjs-eQaYEpP4..protobufjs-eQaYEpP4.Type & {  Annotation :.protobufjs-eQaYEpP4..protobufjs-eQaYEpP4.Type} */
object GeneratedCodeInfo {
  
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.Annotation")
  @js.native
  ...
  /** Comment text, if any. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.comment")
  @js.native
  ...
  /**
    ...
    */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.ctor")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.extensions")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.fieldsArray")
  @js.native
  val fieldsArray: js.Array[Field] = js.native
  
  /** Defining file name. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.filename")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.fullName")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.name")
  @js.native
  def name: String = js.native
  inline def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  /** Nested objects by name. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.nested")
  @js.native
  def nested: js.UndefOr[StringDictionary[ReflectionObject]] = js.native
  
  /** Nested objects of this namespace as an array for iteration. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.nestedArray")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.oneofsArray")
  @js.native
  val oneofsArray: js.Array[OneOf] = js.native
  
  /** Options. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.options")
  @js.native
  ...
  /** Parent namespace. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.parent")
  @js.native
  ...
  /** Parsed Options. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.parsedOptions")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.reserved")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.resolved")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "GeneratedCodeInfo.root")
  @js.native
