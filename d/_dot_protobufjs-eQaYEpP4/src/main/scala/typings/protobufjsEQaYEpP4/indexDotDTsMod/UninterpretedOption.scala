...
import typings.protobufjsEQaYEpP4.mod.AnyNestedObject
import typings.protobufjsEQaYEpP4.mod.Codegen
import typings.protobufjsEQaYEpP4.mod.Constructor
import typings.protobufjsEQaYEpP4.mod.Enum
import typings.protobufjsEQaYEpP4.mod.Field
import typings.protobufjsEQaYEpP4.mod.IConversionOptions
import typings.protobufjsEQaYEpP4.mod.INamespace
import typings.protobufjsEQaYEpP4.mod.IToJSONOptions
import typings.protobufjsEQaYEpP4.mod.IType
import typings.protobufjsEQaYEpP4.mod.Message
import typings.protobufjsEQaYEpP4.mod.Namespace
import typings.protobufjsEQaYEpP4.mod.OneOf
import typings.protobufjsEQaYEpP4.mod.Reader
import typings.protobufjsEQaYEpP4.mod.ReflectionObject
import typings.protobufjsEQaYEpP4.mod.Root
import typings.protobufjsEQaYEpP4.mod.Service
import typings.protobufjsEQaYEpP4.mod.Type
import typings.protobufjsEQaYEpP4.mod.TypeDecorator
import typings.protobufjsEQaYEpP4.mod.Writer
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined .protobufjs-eQaYEpP4..protobufjs-eQaYEpP4.Type & {  NamePart :.protobufjs-eQaYEpP4..protobufjs-eQaYEpP4.Type} */
object UninterpretedOption {
  
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.NamePart")
  @js.native
  def NamePart: Type = js.native
  inline def NamePart_=(x: Type): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NamePart")(x.asInstanceOf[js.Any])
  ...
  /** Comment text, if any. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.comment")
  @js.native
  ...
  /**
    ...
    */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.ctor")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.extensions")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.fieldsArray")
  @js.native
  val fieldsArray: js.Array[Field] = js.native
  
  /** Defining file name. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.filename")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.fullName")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.name")
  @js.native
  def name: String = js.native
  inline def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  /** Nested objects by name. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.nested")
  @js.native
  def nested: js.UndefOr[StringDictionary[ReflectionObject]] = js.native
  
  /** Nested objects of this namespace as an array for iteration. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.nestedArray")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.oneofsArray")
  @js.native
  val oneofsArray: js.Array[OneOf] = js.native
  
  /** Options. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.options")
  @js.native
  ...
  /** Parent namespace. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.parent")
  @js.native
  ...
  /** Parsed Options. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.parsedOptions")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.reserved")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.resolved")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "UninterpretedOption.root")
  @js.native
  ...
  /**
    ...
    */
  inline def toJSON(): IType = ^.asInstanceOf[js.Dynamic].applyDynamic("toJSON")().asInstanceOf[IType]
  inline def toJSON(toJSONOptions: IToJSONOptions): IType = ^.asInstanceOf[js.Dynamic].applyDynamic("toJSON")(toJSONOptions.asInstanceOf[js.Any]).asInstanceOf[IType]
  ...
  inline def toJSON_INamespace(toJSONOptions: IToJSONOptions): INamespace = ^.asInstanceOf[js.Dynamic].applyDynamic("toJSON")(toJSONOptions.asInstanceOf[js.Any]).asInstanceOf[INamespace]
