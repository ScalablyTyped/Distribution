...
/* Inlined .protobufjs-eQaYEpP4..protobufjs-eQaYEpP4.Type & {  ExtensionRange :.protobufjs-eQaYEpP4..protobufjs-eQaYEpP4.Type,   ReservedRange :.protobufjs-eQaYEpP4..protobufjs-eQaYEpP4.Type} */
object DescriptorProto {
  
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.ExtensionRange")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.ReservedRange")
  @js.native
  ...
  /** Comment text, if any. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.comment")
  @js.native
  ...
  /**
    ...
    */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.ctor")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.extensions")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.fieldsArray")
  @js.native
  val fieldsArray: js.Array[Field] = js.native
  
  /** Defining file name. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.filename")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.fullName")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.name")
  @js.native
  def name: String = js.native
  inline def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  /** Nested objects by name. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.nested")
  @js.native
  def nested: js.UndefOr[StringDictionary[ReflectionObject]] = js.native
  
  /** Nested objects of this namespace as an array for iteration. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.nestedArray")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.oneofsArray")
  @js.native
  val oneofsArray: js.Array[OneOf] = js.native
  
  /** Options. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.options")
  @js.native
  ...
  /** Parent namespace. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.parent")
  @js.native
  ...
  /** Parsed Options. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.parsedOptions")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.reserved")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.resolved")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "DescriptorProto.root")
  @js.native
