...
/* Inlined .protobufjs-eQaYEpP4..protobufjs-eQaYEpP4.Type & {  Label :.protobufjs-eQaYEpP4..protobufjs-eQaYEpP4.Enum,   Type :.protobufjs-eQaYEpP4..protobufjs-eQaYEpP4.Enum} */
object FieldDescriptorProto {
  
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.Label")
  @js.native
  def Label: Enum = js.native
  inline def Label_=(x: Enum): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Label")(x.asInstanceOf[js.Any])
  
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.Type")
  @js.native
  ...
  /** Comment text, if any. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.comment")
  @js.native
  ...
  /**
    ...
    */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.ctor")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.extensions")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.fieldsArray")
  @js.native
  val fieldsArray: js.Array[Field] = js.native
  
  /** Defining file name. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.filename")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.fullName")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.name")
  @js.native
  def name: String = js.native
  inline def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  /** Nested objects by name. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.nested")
  @js.native
  def nested: js.UndefOr[StringDictionary[ReflectionObject]] = js.native
  
  /** Nested objects of this namespace as an array for iteration. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.nestedArray")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.oneofsArray")
  @js.native
  val oneofsArray: js.Array[OneOf] = js.native
  
  /** Options. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.options")
  @js.native
  ...
  /** Parent namespace. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.parent")
  @js.native
  ...
  /** Parsed Options. */
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.parsedOptions")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.reserved")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.resolved")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/ext/descriptor/index.d.ts", "FieldDescriptorProto.root")
  @js.native
