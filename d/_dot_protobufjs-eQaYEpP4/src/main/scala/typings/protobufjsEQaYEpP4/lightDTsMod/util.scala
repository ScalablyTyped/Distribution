...
import typings.protobufjsEQaYEpP4.mod.FetchCallback
import typings.protobufjsEQaYEpP4.mod.IConversionOptions
import typings.protobufjsEQaYEpP4.mod.IFetchOptions
import typings.protobufjsEQaYEpP4.mod.OneOfGetter
import typings.protobufjsEQaYEpP4.mod.OneOfSetter
import typings.protobufjsEQaYEpP4.mod.PoolAllocator
import typings.protobufjsEQaYEpP4.mod.PoolSlicer
import typings.protobufjsEQaYEpP4.mod.asPromiseCallback
...
object util {
  ...
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util")
  @js.native
  val ^ : js.Any = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.Array")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.Buffer")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.EventEmitter")
  @js.native
  /** Constructs a new event emitter instance. */
  open class EventEmitter ()
    extends typings.protobufjsEQaYEpP4.mod.util.EventEmitter
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.Long")
  @js.native
  open class Long protected ()
    extends StObject
       with typings.protobufjsEQaYEpP4.mod.Long {
    def this(params: Any*) = this()
  ...
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.Long")
  @js.native
  def Long: Constructor[typings.protobufjsEQaYEpP4.mod.Long] = js.native
  
  /** Helper class for working with the low and high bits of a 64 bit value. */
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.LongBits")
  @js.native
  open class LongBits protected ()
    extends typings.protobufjsEQaYEpP4.mod.util.LongBits {
    /**
  ...
  object LongBits {
    ...
    inline def from(value: String): typings.protobufjsEQaYEpP4.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(value.asInstanceOf[js.Any]).asInstanceOf[typings.protobufjsEQaYEpP4.mod.util.LongBits]
    inline def from(value: Double): typings.protobufjsEQaYEpP4.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(value.asInstanceOf[js.Any]).asInstanceOf[typings.protobufjsEQaYEpP4.mod.util.LongBits]
    /**
      ...
      */
    /* static member */
    inline def from(value: typings.protobufjsEQaYEpP4.mod.Long): typings.protobufjsEQaYEpP4.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(value.asInstanceOf[js.Any]).asInstanceOf[typings.protobufjsEQaYEpP4.mod.util.LongBits]
    ...
    /**
      ...
      */
    /* static member */
    inline def fromHash(hash: String): typings.protobufjsEQaYEpP4.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHash")(hash.asInstanceOf[js.Any]).asInstanceOf[typings.protobufjsEQaYEpP4.mod.util.LongBits]
    ...
    /**
      ...
      */
    /* static member */
    inline def fromNumber(value: Double): typings.protobufjsEQaYEpP4.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("fromNumber")(value.asInstanceOf[js.Any]).asInstanceOf[typings.protobufjsEQaYEpP4.mod.util.LongBits]
    
    /** Zero bits. */
    /* static member */
    @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.LongBits.zero")
    @js.native
    def zero: typings.protobufjsEQaYEpP4.mod.util.LongBits = js.native
    
    /** Zero hash. */
    /* static member */
    @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.LongBits.zeroHash")
    @js.native
    ...
    inline def zero_=(x: typings.protobufjsEQaYEpP4.mod.util.LongBits): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("zero")(x.asInstanceOf[js.Any])
  }
  
  inline def Long_=(x: Constructor[typings.protobufjsEQaYEpP4.mod.Long]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Long")(x.asInstanceOf[js.Any])
  
  /** Error subclass indicating a protocol specifc error. */
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.ProtocolError")
  @js.native
  open class ProtocolError[T /* <: typings.protobufjsEQaYEpP4.mod.Message[T] */] protected ()
    extends typings.protobufjsEQaYEpP4.mod.util.ProtocolError[T] {
    /**
  ...
  object base64 {
    ...
    @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.base64")
    @js.native
    val ^ : js.Any = js.native
  ...
  object codegen {
    ...
    @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.codegen")
    @js.native
    val ^ : js.Any = js.native
    
    /** When set to `true`, codegen will log generated code to console. Useful for debugging. */
    @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.codegen.verbose")
    @js.native
  ...
  /**
    ...
    */
  inline def compareFieldsById(a: typings.protobufjsEQaYEpP4.mod.Field, b: typings.protobufjsEQaYEpP4.mod.Field): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("compareFieldsById")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  /**
    ...
    */
  inline def decorateEnum(`object`: js.Object): typings.protobufjsEQaYEpP4.mod.Enum = ^.asInstanceOf[js.Dynamic].applyDynamic("decorateEnum")(`object`.asInstanceOf[js.Any]).asInstanceOf[typings.protobufjsEQaYEpP4.mod.Enum]
  
  /** Decorator root (TypeScript). */
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.decorateRoot")
  @js.native
  def decorateRoot: typings.protobufjsEQaYEpP4.mod.Root = js.native
  inline def decorateRoot_=(x: typings.protobufjsEQaYEpP4.mod.Root): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("decorateRoot")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  inline def decorateType[T /* <: typings.protobufjsEQaYEpP4.mod.Message[T] */](ctor: Constructor[T]): typings.protobufjsEQaYEpP4.mod.Type = ^.asInstanceOf[js.Dynamic].applyDynamic("decorateType")(ctor.asInstanceOf[js.Any]).asInstanceOf[typings.protobufjsEQaYEpP4.mod.Type]
  inline def decorateType[T /* <: typings.protobufjsEQaYEpP4.mod.Message[T] */](ctor: Constructor[T], typeName: String): typings.protobufjsEQaYEpP4.mod.Type = (^.asInstanceOf[js.Dynamic].applyDynamic("decorateType")(ctor.asInstanceOf[js.Any], typeName.asInstanceOf[js.Any])).asInstanceOf[typings.protobufjsEQaYEpP4.mod.Type]
  
  /** An immuable empty array. */
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.emptyArray")
  @js.native
  val emptyArray: js.Array[Any] = js.native
  
  /** An immutable empty object. */
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.emptyObject")
  @js.native
  ...
  object float {
    ...
    @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.float")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.global")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.isNode")
  @js.native
  ...
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.key2Re")
  @js.native
  val key2Re: js.RegExp = js.native
  
  /** Regular expression used to verify 32 bit (`int32` etc.) map keys. */
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.key32Re")
  @js.native
  val key32Re: js.RegExp = js.native
  
  /** Regular expression used to verify 64 bit (`int64` etc.) map keys. */
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.key64Re")
  @js.native
  ...
  /**
    ...
    */
  inline def longFromHash(hash: String): typings.protobufjsEQaYEpP4.mod.Long | Double = ^.asInstanceOf[js.Dynamic].applyDynamic("longFromHash")(hash.asInstanceOf[js.Any]).asInstanceOf[typings.protobufjsEQaYEpP4.mod.Long | Double]
  inline def longFromHash(hash: String, unsigned: Boolean): typings.protobufjsEQaYEpP4.mod.Long | Double = (^.asInstanceOf[js.Dynamic].applyDynamic("longFromHash")(hash.asInstanceOf[js.Any], unsigned.asInstanceOf[js.Any])).asInstanceOf[typings.protobufjsEQaYEpP4.mod.Long | Double]
  ...
  /**
    ...
    * @returns Hash
    */
  inline def longToHash(value: typings.protobufjsEQaYEpP4.mod.Long): String = ^.asInstanceOf[js.Dynamic].applyDynamic("longToHash")(value.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  object path {
    ...
    @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.path")
    @js.native
    val ^ : js.Any = js.native
  ...
  /**
    ...
    */
  @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.toJSONOptions")
  @js.native
  ...
  object utf8 {
    ...
    @JSImport(".protobufjs-eQaYEpP4/light.d.ts", "util.utf8")
    @js.native
    val ^ : js.Any = js.native
