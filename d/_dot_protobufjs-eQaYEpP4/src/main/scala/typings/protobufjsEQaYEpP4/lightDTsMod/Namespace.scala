...
@JSImport(".protobufjs-eQaYEpP4/light.d.ts", "Namespace")
@js.native
open class Namespace protected ()
  extends typings.protobufjsEQaYEpP4.mod.Namespace {
  /**
...
object Namespace {
  ...
  /**
    ...
    */
  inline def arrayToJSON(array: js.Array[typings.protobufjsEQaYEpP4.mod.ReflectionObject]): js.UndefOr[StringDictionary[Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("arrayToJSON")(array.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[StringDictionary[Any]]]
  inline def arrayToJSON(array: js.Array[typings.protobufjsEQaYEpP4.mod.ReflectionObject], toJSONOptions: IToJSONOptions): js.UndefOr[StringDictionary[Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("arrayToJSON")(array.asInstanceOf[js.Any], toJSONOptions.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[StringDictionary[Any]]]
  ...
  /**
    ...
    */
  inline def fromJSON(name: String, json: StringDictionary[Any]): typings.protobufjsEQaYEpP4.mod.Namespace = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(name.asInstanceOf[js.Any], json.asInstanceOf[js.Any])).asInstanceOf[typings.protobufjsEQaYEpP4.mod.Namespace]
