...
import typings.protobufjsEQaYEpP4.mod.^
import typings.protobufjsEQaYEpP4.mod.rpc.ServiceMethod
...
{[ P in keyof T ]:? T[P]}
  */ typings.protobufjsEQaYEpP4.protobufjsEQaYEpP4Strings.Properties & TopLevel[T]
