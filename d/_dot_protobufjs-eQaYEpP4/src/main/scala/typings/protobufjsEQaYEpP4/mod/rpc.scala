...
import typings.protobufjsEQaYEpP4.mod.util.EventEmitter
...
object rpc {
  ...
  @JSImport(".protobufjs-eQaYEpP4", "rpc.Service")
  @js.native
  open class Service protected () extends EventEmitter {
    ...
    /**
      ...
      * @returns `this`
      */
    def end(): typings.protobufjsEQaYEpP4.mod.rpc.Service = js.native
    def end(endedByRPC: Boolean): typings.protobufjsEQaYEpP4.mod.rpc.Service = js.native
