...
@js.native
class namespaced[K, V] protected () extends DataLoader[K, V] {
  def this(batchLoadFn: dataloaderLib.dataloaderMod.DataLoaderNs.BatchLoadFn[K, V]) = this()
  def this(batchLoadFn: dataloaderLib.dataloaderMod.DataLoaderNs.BatchLoadFn[K, V], options: dataloaderLib.dataloaderMod.DataLoaderNs.Options[K, V]) = this()
  /**
