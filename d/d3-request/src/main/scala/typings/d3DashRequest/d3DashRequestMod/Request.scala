...
trait Request extends js.Object {
  ...
  /**
    ...
    */
  def mimeType(): String | Null = js.native
  /**
  ...
  @JSName("mimeType")
  def mimeType_This(): this.type = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("on")
  def on_This(`type`: String): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def password(): String | Null = js.native
  /**
  ...
  @JSName("password")
  def password_This(): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def user(): String | Null = js.native
  /**
  ...
  @JSName("user")
  def user_This(): this.type = js.native
}
