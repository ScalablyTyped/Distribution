...
object UseComboboxProps {
  ...
  extension [Self <: UseComboboxProps[?], Item](x: Self & UseComboboxProps[Item]) {
    ...
    inline def setOnHighlightedIndexChange(value: /* changes */ UseComboboxStateChange[Item] => Unit): Self = StObject.set(x, "onHighlightedIndexChange", js.Any.fromFunction1(value))
    
    inline def setOnHighlightedIndexChangeUndefined: Self = StObject.set(x, "onHighlightedIndexChange", js.undefined)
    
    inline def setOnInputValueChange(value: /* changes */ UseComboboxStateChange[Item] => Unit): Self = StObject.set(x, "onInputValueChange", js.Any.fromFunction1(value))
    
    inline def setOnInputValueChangeUndefined: Self = StObject.set(x, "onInputValueChange", js.undefined)
    
    inline def setOnIsOpenChange(value: /* changes */ UseComboboxStateChange[Item] => Unit): Self = StObject.set(x, "onIsOpenChange", js.Any.fromFunction1(value))
    
    inline def setOnIsOpenChangeUndefined: Self = StObject.set(x, "onIsOpenChange", js.undefined)
    
    inline def setOnSelectedItemChange(value: /* changes */ UseComboboxStateChange[Item] => Unit): Self = StObject.set(x, "onSelectedItemChange", js.Any.fromFunction1(value))
    
    inline def setOnSelectedItemChangeUndefined: Self = StObject.set(x, "onSelectedItemChange", js.undefined)
    
    inline def setOnStateChange(value: /* changes */ UseComboboxStateChange[Item] => Unit): Self = StObject.set(x, "onStateChange", js.Any.fromFunction1(value))
