...
- typings.downshift.mod.GetToggleButtonPropsOptions because Inheritance from two classes. Inlined disabled */ trait UseSelectGetToggleButtonPropsOptions
  extends StObject
...
object UseSelectGetToggleButtonPropsOptions {
  ...
  @scala.inline
  def apply(): UseSelectGetToggleButtonPropsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UseSelectGetToggleButtonPropsOptions]
  }
  
  @scala.inline
  implicit class UseSelectGetToggleButtonPropsOptionsMutableBuilder[Self <: UseSelectGetToggleButtonPropsOptions] (val x: Self) extends AnyVal {
