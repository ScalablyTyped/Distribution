...
object UseSelectStateChangeOptions {
  ...
  @scala.inline
  implicit class UseSelectStateChangeOptionsMutableBuilder[Self <: UseSelectStateChangeOptions[?], Item] (val x: Self & UseSelectStateChangeOptions[Item]) extends AnyVal {
