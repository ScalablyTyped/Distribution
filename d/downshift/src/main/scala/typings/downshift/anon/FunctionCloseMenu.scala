...
object FunctionCloseMenu {
  ...
  implicit class FunctionCloseMenuOps[Self <: FunctionCloseMenu] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFunctionCloseMenu(value: typings.downshift.mod.UseSelectStateChangeTypes.FunctionCloseMenu): Self = this.set("FunctionCloseMenu", value.asInstanceOf[js.Any])
