...
import typings.downshift.mod.UseComboboxStateChangeTypes.FunctionOpenMenu
import typings.downshift.mod.UseComboboxStateChangeTypes.FunctionReset
import typings.downshift.mod.UseComboboxStateChangeTypes.FunctionSelectItem
import typings.downshift.mod.UseComboboxStateChangeTypes.FunctionSetHighlightedIndex
import typings.downshift.mod.UseComboboxStateChangeTypes.FunctionSetInputValue
...
import typings.downshift.mod.UseComboboxStateChangeTypes.ToggleButtonClick
...
object ControlledPropUpdatedSelectedItem {
  ...
  implicit class ControlledPropUpdatedSelectedItemOps[Self <: ControlledPropUpdatedSelectedItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setControlledPropUpdatedSelectedItem(value: typings.downshift.mod.UseComboboxStateChangeTypes.ControlledPropUpdatedSelectedItem): Self = this.set("ControlledPropUpdatedSelectedItem", value.asInstanceOf[js.Any])
    @scala.inline
    def setFunctionCloseMenu(value: typings.downshift.mod.UseComboboxStateChangeTypes.FunctionCloseMenu): Self = this.set("FunctionCloseMenu", value.asInstanceOf[js.Any])
    @scala.inline
