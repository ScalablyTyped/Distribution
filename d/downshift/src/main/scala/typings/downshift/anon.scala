...
object anon {
  ...
  object DropdownClick {
    ...
    def apply(
      ...
      FunctionReset: typings.downshift.mod.UseMultipleSelectionStateChangeTypes.FunctionReset,
  ...
  object FunctionCloseMenu {
    ...
    def apply(
      ...
      FunctionSelectItem: typings.downshift.mod.UseSelectStateChangeTypes.FunctionSelectItem,
      FunctionSetHighlightedIndex: typings.downshift.mod.UseSelectStateChangeTypes.FunctionSetHighlightedIndex,
      FunctionSetInputValue: typings.downshift.mod.UseSelectStateChangeTypes.FunctionSetInputValue,
