...
trait Actions[Item] extends js.Object {
  ...
  def clearSelection(cb: Callback): scala.Unit = js.native
  def closeMenu(): scala.Unit = js.native
  def closeMenu(cb: Callback): scala.Unit = js.native
  // props
  def itemToString(item: Item): java.lang.String = js.native
  def openMenu(): scala.Unit = js.native
  def openMenu(cb: Callback): scala.Unit = js.native
  def reset(): scala.Unit = js.native
  def reset(otherStateToSet: stdLib.Partial[StateChangeOptions[Item]]): scala.Unit = js.native
  def reset(otherStateToSet: stdLib.Partial[StateChangeOptions[Item]], cb: Callback): scala.Unit = js.native
  ...
  def selectHighlightedItem(otherStateToSet: stdLib.Partial[StateChangeOptions[Item]], cb: Callback): scala.Unit = js.native
  ...
  def selectItem(item: Item, otherStateToSet: stdLib.Partial[StateChangeOptions[Item]], cb: Callback): scala.Unit = js.native
  ...
  def selectItemAtIndex(index: scala.Double, otherStateToSet: stdLib.Partial[StateChangeOptions[Item]], cb: Callback): scala.Unit = js.native
  ...
  def setHighlightedIndex(index: scala.Double, otherStateToSet: stdLib.Partial[StateChangeOptions[Item]], cb: Callback): scala.Unit = js.native
  def setItemCount(count: scala.Double): scala.Unit = js.native
  def setState(stateToSet: StateChangeFunction[Item]): scala.Unit = js.native
  def setState(stateToSet: StateChangeFunction[Item], cb: Callback): scala.Unit = js.native
  def setState(stateToSet: stdLib.Partial[StateChangeOptions[Item]]): scala.Unit = js.native
  def setState(stateToSet: stdLib.Partial[StateChangeOptions[Item]], cb: Callback): scala.Unit = js.native
  ...
  def toggleMenu(otherStateToSet: stdLib.Partial[StateChangeOptions[Item]], cb: Callback): scala.Unit = js.native
