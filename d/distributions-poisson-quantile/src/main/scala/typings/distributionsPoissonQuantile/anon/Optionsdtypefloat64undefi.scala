...
@js.native
trait Optionsdtypefloat64undefi extends js.Object {
...
object Optionsdtypefloat64undefi {
  ...
  @scala.inline
  implicit class Optionsdtypefloat64undefiOps[Self <: Optionsdtypefloat64undefi] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDtype(value: js.UndefOr[DataType] with js.UndefOr[float64]): Self = this.set("dtype", value.asInstanceOf[js.Any])
