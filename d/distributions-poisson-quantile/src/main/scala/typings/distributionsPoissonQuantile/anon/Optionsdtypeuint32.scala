...
object Optionsdtypeuint32 {
  ...
  @scala.inline
  implicit class Optionsdtypeuint32Ops[Self <: Optionsdtypeuint32] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDtype(value: js.UndefOr[DataType] with uint32): Self = this.set("dtype", value.asInstanceOf[js.Any])
    @scala.inline
