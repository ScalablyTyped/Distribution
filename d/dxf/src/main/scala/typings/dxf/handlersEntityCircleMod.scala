...
object handlersEntityCircleMod {
  
  @JSImport("dxf/handlers/entity/circle", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("dxf/handlers/entity/circle", "TYPE")
  @js.native
  val TYPE: String = js.native
  
  inline def process(value: Property): CircleEntityData = ^.asInstanceOf[js.Dynamic].applyDynamic("process")(value.asInstanceOf[js.Any]).asInstanceOf[CircleEntityData]
  
  /* Inlined {  r :number | undefined} & std.Partial<dxf.dxf/Common.Point3D> & std.Partial<dxf.dxf/handlers/entity/common.CommonEntityData> */
  trait CircleEntityData
    extends StObject
       with Entity {
  ...
  object CircleEntityData {
    
    inline def apply(): CircleEntityData = {
