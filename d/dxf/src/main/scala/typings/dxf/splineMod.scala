...
object splineMod {
  ...
  object SplineTypeFlag extends StObject {
    ...
    sealed trait CLOSED
      extends StObject
         with SplineTypeFlag
    /* 1 */ val CLOSED: typings.dxf.splineMod.SplineTypeFlag.CLOSED & Double = js.native
    
    @js.native
    sealed trait LINEAR
      extends StObject
         with SplineTypeFlag
    /* 16 */ val LINEAR: typings.dxf.splineMod.SplineTypeFlag.LINEAR & Double = js.native
    
    @js.native
    sealed trait PERIODIC
      extends StObject
         with SplineTypeFlag
    /* 2 */ val PERIODIC: typings.dxf.splineMod.SplineTypeFlag.PERIODIC & Double = js.native
    
    @js.native
    sealed trait PLANAR
      extends StObject
         with SplineTypeFlag
    /* 8 */ val PLANAR: typings.dxf.splineMod.SplineTypeFlag.PLANAR & Double = js.native
    
    @js.native
    sealed trait RATIONAL
      extends StObject
         with SplineTypeFlag
    /* 4 */ val RATIONAL: typings.dxf.splineMod.SplineTypeFlag.RATIONAL & Double = js.native
  }
