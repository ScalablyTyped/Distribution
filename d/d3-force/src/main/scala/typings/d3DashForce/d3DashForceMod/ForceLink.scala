...
@js.native
trait ForceLink[NodeDatum /* <: SimulationNodeDatum */, LinkDatum /* <: SimulationLinkDatum[NodeDatum] */] extends Force[NodeDatum, LinkDatum] {
  /**
  ...
  /**
    ...
    */
  @JSName("initialize")
  def initialize_MForceLink(nodes: js.Array[NodeDatum]): Unit = js.native
  /**
