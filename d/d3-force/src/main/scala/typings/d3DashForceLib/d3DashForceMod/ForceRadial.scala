...
trait ForceRadial[NodeDatum /* <: SimulationNodeDatum */]
  ...
  /**
    ...
    */
  @JSName("initialize")
  def initialize_MForceRadial(nodes: js.Array[NodeDatum]): scala.Unit = js.native
  /**
    * Return the current radius accessor for the circle.
    */
  def radius(): js.Function3[/* d */ NodeDatum, /* i */ scala.Double, /* data */ js.Array[NodeDatum], scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  def y(): js.Function3[/* d */ NodeDatum, /* i */ scala.Double, /* data */ js.Array[NodeDatum], scala.Double] = js.native
  /**
