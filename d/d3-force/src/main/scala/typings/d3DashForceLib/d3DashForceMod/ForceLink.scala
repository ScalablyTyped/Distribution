...
trait ForceLink[NodeDatum /* <: SimulationNodeDatum */, LinkDatum /* <: SimulationLinkDatum[NodeDatum] */] extends Force[NodeDatum, LinkDatum] {
  /**
    ...
    */
  def distance(): js.Function3[
    /* link */ LinkDatum, 
    /* i */ scala.Double, 
    /* links */ js.Array[LinkDatum], 
    scala.Double
  ] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("initialize")
  def initialize_MForceLink(nodes: js.Array[NodeDatum]): scala.Unit = js.native
  /**
    * Return the current iteration count which defaults to 1.
    */
  def iterations(): scala.Double = js.native
  /**
    ...
    */
  def iterations(iterations: scala.Double): this.type = js.native
  /**
