...
trait Simulation[NodeDatum /* <: SimulationNodeDatum */, LinkDatum /* <: js.UndefOr[SimulationLinkDatum[NodeDatum]] */] extends js.Object {
  ...
  /**
       ...
       */
  def alphaDecay(): scala.Double = js.native
  /**
       ...
       */
  def alphaDecay(decay: scala.Double): this.type = js.native
  /**
       * Return the current minimum alpha value, which defaults to 0.001.
       */
  def alphaMin(): scala.Double = js.native
  /**
       ...
       */
  def alphaMin(min: scala.Double): this.type = js.native
  /**
       * Returns the current target alpha value, which defaults to 0.
       */
  def alphaTarget(): scala.Double = js.native
  /**
       ...
       */
  def alphaTarget(target: scala.Double): this.type = js.native
  /**
       ...
       */
  def find(x: scala.Double, y: scala.Double): js.UndefOr[NodeDatum] = js.native
  /**
       * Return the node closest to the position [x,y] with the given search radius.
       * If radius is not specified, it defaults to infinity.
       * If there is no node within the search area, returns undefined.
       ...
       * @param radius Optional search radius. Defaults to infinity.
       */
  def find(x: scala.Double, y: scala.Double, radius: scala.Double): js.UndefOr[NodeDatum] = js.native
  /**
       ...
       */
  def force(name: java.lang.String): this.type = js.native
  /**
       ...
       */
  def force(name: java.lang.String, force: Force[NodeDatum, LinkDatum]): this.type = js.native
  /**
  ...
  /**
       ...
       */
  def on(typenames: java.lang.String): js.UndefOr[js.ThisFunction0[/* this */ Simulation[NodeDatum, LinkDatum], scala.Unit]] = js.native
  /**
       ...
       */
  def on(typenames: java.lang.String, listener: js.ThisFunction0[/* this */ this.type, scala.Unit]): this.type = js.native
  /**
  ...
  /**
       ...
       */
  @JSName("on")
  def on_end(typenames: d3DashForceLib.d3DashForceLibStrings.end): js.UndefOr[js.ThisFunction0[/* this */ Simulation[NodeDatum, LinkDatum], scala.Unit]] = js.native
  /**
       * Set the event listener for the specified typenames and return this simulation.
       * If an event listener was already registered for the same type and name,
       * the existing listener is removed before the new listener is added.
  ...
  @JSName("on")
  def on_end(
    typenames: d3DashForceLib.d3DashForceLibStrings.end,
  ...
  /**
       ...
       */
  @JSName("on")
  def `on_end_<this>`(typenames: d3DashForceLib.d3DashForceLibStrings.end): this.type = js.native
  /**
       * Return the first currently-assigned listener matching the specified typenames, if any.
       *
       * @param typenames The typenames is a string containing one or more typename separated by whitespace. Each typename is a type,
       ...
       */
  @JSName("on")
  def on_tick(typenames: d3DashForceLib.d3DashForceLibStrings.tick): js.UndefOr[js.ThisFunction0[/* this */ Simulation[NodeDatum, LinkDatum], scala.Unit]] = js.native
  /**
       * Set the event listener for the specified typenames and return this simulation.
       * If an event listener was already registered for the same type and name,
       * the existing listener is removed before the new listener is added.
  ...
  @JSName("on")
  def on_tick(
    typenames: d3DashForceLib.d3DashForceLibStrings.tick,
    listener: js.ThisFunction0[/* this */ this.type, scala.Unit]
  ): this.type = js.native
  /**
       * Remove the current event listeners for the specified typenames, if any, return the simulation.
       ...
       */
  @JSName("on")
  def `on_tick_<this>`(typenames: d3DashForceLib.d3DashForceLibStrings.tick): this.type = js.native
  /**
  ...
  /**
       ...
       */
  def velocityDecay(): scala.Double = js.native
  /**
       ...
       */
  def velocityDecay(decay: scala.Double): this.type = js.native
}
