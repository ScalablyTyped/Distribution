...
@js.native
trait ForceX[NodeDatum /* <: SimulationNodeDatum */]
  ...
  /**
    ...
    */
  @JSName("initialize")
  def initialize_MForceX(nodes: js.Array[NodeDatum]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def x(): js.Function3[/* d */ NodeDatum, /* i */ scala.Double, /* data */ js.Array[NodeDatum], scala.Double] = js.native
  /**
