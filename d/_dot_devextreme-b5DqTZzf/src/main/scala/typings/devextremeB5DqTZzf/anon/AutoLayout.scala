...
trait AutoLayout extends StObject {
  ...
  /**
    ...
    */
  var autoLayout: js.UndefOr[off | tree | layered | Orientation] = js.undefined
...
object AutoLayout {
  ...
  extension [Self <: AutoLayout](x: Self) {
    ...
    inline def setAutoLayout(value: off | tree | layered | Orientation): Self = StObject.set(x, "autoLayout", value.asInstanceOf[js.Any])
