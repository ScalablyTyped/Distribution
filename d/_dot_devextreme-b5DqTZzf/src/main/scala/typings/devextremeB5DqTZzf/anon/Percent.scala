...
trait Percent extends StObject {
  ...
  var item: js.UndefOr[typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxFunnel.Item] = js.undefined
...
object Percent {
  ...
  extension [Self <: Percent](x: Self) {
    ...
    inline def setItem(value: typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxFunnel.Item): Self = StObject.set(x, "item", value.asInstanceOf[js.Any])
