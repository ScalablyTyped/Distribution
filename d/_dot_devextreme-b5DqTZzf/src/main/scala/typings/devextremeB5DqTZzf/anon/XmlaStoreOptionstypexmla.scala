...
/* Inlined .devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.data.XmlaStoreOptions & {  type :'xmla'} */
trait XmlaStoreOptionstypexmla extends StObject {
  
  /**
    * Specifies a function that customizes the request before it is sent to the server.
    */
  var beforeSend: js.UndefOr[js.Function1[/* options */ Data, Unit]] = js.undefined
...
object XmlaStoreOptionstypexmla {
  ...
  extension [Self <: XmlaStoreOptionstypexmla](x: Self) {
    ...
    inline def setBeforeSend(value: /* options */ Data => Unit): Self = StObject.set(x, "beforeSend", js.Any.fromFunction1(value))
