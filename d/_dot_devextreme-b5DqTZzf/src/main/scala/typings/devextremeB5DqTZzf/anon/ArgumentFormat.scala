...
trait ArgumentFormat extends StObject {
  ...
  /**
    ...
    */
  var argumentFormat: js.UndefOr[typings.devextremeB5DqTZzf.mod.DevExpress.ui.Format] = js.undefined
...
object ArgumentFormat {
  ...
  extension [Self <: ArgumentFormat](x: Self) {
    ...
    inline def setArgumentFormat(value: typings.devextremeB5DqTZzf.mod.DevExpress.ui.Format): Self = StObject.set(x, "argumentFormat", value.asInstanceOf[js.Any])
