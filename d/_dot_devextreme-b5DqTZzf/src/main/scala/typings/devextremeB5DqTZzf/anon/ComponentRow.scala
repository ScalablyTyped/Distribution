...
trait ComponentRow[TRowData, TKey] extends StObject {
  ...
  var row: js.UndefOr[typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.Row[TRowData, TKey]] = js.undefined
}
object ComponentRow {
  ...
  extension [Self <: ComponentRow[?, ?], TRowData, TKey](x: Self & (ComponentRow[TRowData, TKey])) {
    ...
    inline def setRow(value: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.Row[TRowData, TKey]): Self = StObject.set(x, "row", value.asInstanceOf[js.Any])
