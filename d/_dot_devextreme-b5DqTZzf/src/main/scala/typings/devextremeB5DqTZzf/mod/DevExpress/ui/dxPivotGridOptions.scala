...
import typings.devextremeB5DqTZzf.anon.AllowFieldDragging
import typings.devextremeB5DqTZzf.anon.ApplyChangesMode
import typings.devextremeB5DqTZzf.anon.CollapseAll
import typings.devextremeB5DqTZzf.anon.CustomLoad
import typings.devextremeB5DqTZzf.anon.Enabled
import typings.devextremeB5DqTZzf.anon.IndicatorSrc
import typings.devextremeB5DqTZzf.anon.Mode
...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.rows
...
import typings.devextremeB5DqTZzf.mod.DevExpress.data.PivotGridDataSource.Options
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxPivotGrid.CellClickEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxPivotGrid.CellPreparedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxPivotGrid.ContextMenuPreparingEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxPivotGrid.ExportedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxPivotGrid.ExportingEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxPivotGrid.FileSavingEvent
...
trait dxPivotGridOptions
  ...
  /**
    ...
    */
  var dataSource: js.UndefOr[js.Array[Any] | PivotGridDataSource | Options] = js.undefined
...
object dxPivotGridOptions {
  ...
  extension [Self <: dxPivotGridOptions](x: Self) {
    ...
    inline def setDataFieldArea(value: column | row): Self = StObject.set(x, "dataFieldArea", value.asInstanceOf[js.Any])
    ...
    inline def setRowHeaderLayout(value: standard | tree): Self = StObject.set(x, "rowHeaderLayout", value.asInstanceOf[js.Any])
    ...
    inline def setShowTotalsPrior(value: both | columns | none | rows): Self = StObject.set(x, "showTotalsPrior", value.asInstanceOf[js.Any])
