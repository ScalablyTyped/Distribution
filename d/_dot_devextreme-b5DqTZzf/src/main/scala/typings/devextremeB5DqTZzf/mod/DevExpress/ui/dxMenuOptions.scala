...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.leftOrTop
...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.rightOrBottom
...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxMenu.SubmenuHiddenEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxMenu.SubmenuHidingEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxMenu.SubmenuShowingEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxMenu.SubmenuShownEvent
...
/* Inlined parent .devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.ui.dxMenuBaseOptions<.devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.ui.dxMenu<TKey>, .devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.ui.dxMenuItem, TKey> */
...
object dxMenuOptions {
  ...
  extension [Self <: dxMenuOptions[?], TKey](x: Self & dxMenuOptions[TKey]) {
    ...
    inline def setShowFirstSubmenuMode(value: DelayName | onClick | onHover): Self = StObject.set(x, "showFirstSubmenuMode", value.asInstanceOf[js.Any])
    ...
    inline def setSubmenuDirection(value: auto | leftOrTop | rightOrBottom): Self = StObject.set(x, "submenuDirection", value.asInstanceOf[js.Any])
