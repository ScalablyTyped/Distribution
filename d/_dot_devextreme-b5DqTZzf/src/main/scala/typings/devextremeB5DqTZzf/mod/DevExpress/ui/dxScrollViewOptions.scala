...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxScrollView.PullDownEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxScrollView.ReachBottomEvent
