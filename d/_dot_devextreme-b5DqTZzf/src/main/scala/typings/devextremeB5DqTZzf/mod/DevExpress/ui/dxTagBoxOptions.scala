...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTagBox.MultiTagPreparingEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTagBox.SelectAllValueChangedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTagBox.SelectionChangedEvent
...
/* Inlined parent std.Pick<.devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.ui.dxSelectBoxOptions<.devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.ui.dxTagBox>, std.Exclude<keyof .devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.ui.dxSelectBoxOptions<.devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.ui.dxTagBox>, 'onSelectionChanged'>> */
...
object dxTagBoxOptions {
  ...
  extension [Self <: dxTagBoxOptions](x: Self) {
    ...
    inline def setSearchMode(value: contains | startswith): Self = StObject.set(x, "searchMode", value.asInstanceOf[js.Any])
