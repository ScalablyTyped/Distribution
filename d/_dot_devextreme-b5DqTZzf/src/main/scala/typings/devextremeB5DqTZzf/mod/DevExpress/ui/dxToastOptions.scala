...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.error
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.info
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.success
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.warning
...
object dxToastOptions {
  ...
  extension [Self <: dxToastOptions](x: Self) {
    ...
    inline def setType(value: custom | error | info | success | warning): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
