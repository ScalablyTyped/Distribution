...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.nextColumn
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.widget
...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.ColumnChooser
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.ColumnFixing
...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.FilterPanel
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.FilterRow
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.HeaderFilter
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.KeyDownInfo
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.KeyboardNavigation
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.LoadPanel
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.NewRowInfo
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.Pager
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.PagingBase
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.RowDragging
...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.SearchPanel
...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.Sorting
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.StateStoring
...
trait GridBaseOptions[TComponent /* <: GridBase[TRowData, TKey] */, TRowData, TKey]
  ...
  /**
    ...
    */
  var columnWidth: js.UndefOr[Double | auto] = js.undefined
  ...
  /**
    ...
    */
  var dataSource: js.UndefOr[DataSourceLike[TRowData, TKey]] = js.undefined
...
object GridBaseOptions {
  ...
  extension [Self <: GridBaseOptions[?, ?, ?], TComponent /* <: GridBase[TRowData, TKey] */, TRowData, TKey](x: Self & (GridBaseOptions[TComponent, TRowData, TKey])) {
    ...
    inline def setColumnResizingMode(value: nextColumn | widget): Self = StObject.set(x, "columnResizingMode", value.asInstanceOf[js.Any])
    
    inline def setColumnResizingModeUndefined: Self = StObject.set(x, "columnResizingMode", js.undefined)
    
    inline def setColumnWidth(value: Double | auto): Self = StObject.set(x, "columnWidth", value.asInstanceOf[js.Any])
    ...
    inline def setFilterSyncEnabled(value: Boolean | auto): Self = StObject.set(x, "filterSyncEnabled", value.asInstanceOf[js.Any])
