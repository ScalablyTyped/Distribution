...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui._Format
...
trait FormatObject
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[PredefinedFormat | String] = js.undefined
}
object FormatObject {
  ...
  extension [Self <: FormatObject](x: Self) {
    ...
    inline def setType(value: PredefinedFormat | String): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
