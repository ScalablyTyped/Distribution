...
import typings.devextremeB5DqTZzf.anon.Bing
import typings.devextremeB5DqTZzf.anon.Color
import typings.devextremeB5DqTZzf.anon.IconSrc
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.bing
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.google
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.googleStatic
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.hybrid
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.roadmap
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.satellite
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxMap.ClickEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxMap.MarkerAddedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxMap.MarkerRemovedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxMap.ReadyEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxMap.RouteAddedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxMap.RouteRemovedEvent
...
object dxMapOptions {
  ...
  extension [Self <: dxMapOptions](x: Self) {
    ...
    inline def setProvider(value: bing | google | googleStatic): Self = StObject.set(x, "provider", value.asInstanceOf[js.Any])
    ...
    inline def setType(value: hybrid | roadmap | satellite): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
