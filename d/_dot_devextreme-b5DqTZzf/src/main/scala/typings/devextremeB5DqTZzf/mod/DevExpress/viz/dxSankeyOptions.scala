...
import typings.devextremeB5DqTZzf.anon.ColorMode
import typings.devextremeB5DqTZzf.anon.HorizontalOffset
import typings.devextremeB5DqTZzf.anon.KeepLabels
import typings.devextremeB5DqTZzf.anon.Padding
...
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxSankey.LinkClickEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxSankey.LinkHoverEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxSankey.NodeClickEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxSankey.NodeHoverEvent
...
object dxSankeyOptions {
  ...
  extension [Self <: dxSankeyOptions](x: Self) {
    ...
    inline def setAlignmentVarargs(value: (bottom | center | top)*): Self = StObject.set(x, "alignment", js.Array(value*))
