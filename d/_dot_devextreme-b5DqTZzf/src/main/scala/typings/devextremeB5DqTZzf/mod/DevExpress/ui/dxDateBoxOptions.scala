...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.calendar
...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.native
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.rollers
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.time
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDateBox.DisabledDate
...
object dxDateBoxOptions {
  ...
  extension [Self <: dxDateBoxOptions](x: Self) {
    ...
    inline def setPickerType(value: calendar | list | native | rollers): Self = StObject.set(x, "pickerType", value.asInstanceOf[js.Any])
    ...
    inline def setType(value: date | datetime | time): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
