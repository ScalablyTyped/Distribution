...
object dxTabs {
  ...
  type ContentReadyEvent[TItem /* <: ItemLike */, TKey] = EventInfo[TabsInstance[TItem, TKey]]
  
  type DisposingEvent[TItem /* <: ItemLike */, TKey] = EventInfo[TabsInstance[TItem, TKey]]
  
  trait ExplicitTypes[TItem /* <: ItemLike */, TKey] extends StObject {
    
    var ContentReadyEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabs.ContentReadyEvent[TItem, TKey]
    
    var DisposingEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabs.DisposingEvent[TItem, TKey]
    
    var InitializedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabs.InitializedEvent[TItem, TKey]
    
    var ItemClickEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabs.ItemClickEvent[TItem, TKey]
    
    var ItemContextMenuEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabs.ItemContextMenuEvent[TItem, TKey]
    
    var ItemHoldEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabs.ItemHoldEvent[TItem, TKey]
    
    var ItemRenderedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabs.ItemRenderedEvent[TItem, TKey]
    
    var OptionChangedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabs.OptionChangedEvent[TItem, TKey]
    
    var Properties: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabs.Properties[TItem, TKey]
    
    var SelectionChangedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabs.SelectionChangedEvent[TItem, TKey]
  }
  ...
  type InitializedEvent[TItem /* <: ItemLike */, TKey] = InitializedEventInfo[TabsInstance[TItem, TKey]]
  
  type Item = dxTabsItem
  
  trait ItemClickEvent[TItem /* <: ItemLike */, TKey]
    extends StObject
       with NativeEventInfo[TabsInstance[TItem, TKey], KeyboardEvent | MouseEvent | PointerEvent]
       with ItemInfo[TItem]
  object ItemClickEvent {
    
    inline def apply[TItem /* <: ItemLike */, TKey](
      component: TabsInstance[TItem, TKey],
  ...
  trait ItemContextMenuEvent[TItem /* <: ItemLike */, TKey]
    extends StObject
       with NativeEventInfo[TabsInstance[TItem, TKey], MouseEvent | PointerEvent | TouchEvent]
       with ItemInfo[TItem]
  ...
  trait ItemRenderedEvent[TItem /* <: ItemLike */, TKey]
    extends StObject
       with EventInfo[TabsInstance[TItem, TKey]]
       with ItemInfo[TItem]
  ...
  type Properties[TItem /* <: ItemLike */, TKey] = dxTabsBaseOptions[TabsInstance[TItem, TKey], TItem, TKey]
  ...
  trait TabsInstance[TItem, TKey]
    extends StObject
       with CollectionWidget[Properties[TItem, TKey], TItem, TKey]
}
