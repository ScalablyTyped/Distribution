...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxForm.EditorEnterKeyEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxForm.FieldDataChangedEvent
...
trait dxFormOptions
  ...
  /**
    ...
    */
  var labelMode: js.UndefOr[outside | floating | static | hidden] = js.undefined
...
object dxFormOptions {
  ...
  extension [Self <: dxFormOptions](x: Self) {
    ...
    inline def setColCount(value: Double | auto): Self = StObject.set(x, "colCount", value.asInstanceOf[js.Any])
    ...
    inline def setLabelLocation(value: left | right | top): Self = StObject.set(x, "labelLocation", value.asInstanceOf[js.Any])
    
    inline def setLabelLocationUndefined: Self = StObject.set(x, "labelLocation", js.undefined)
    
    inline def setLabelMode(value: outside | floating | static | hidden): Self = StObject.set(x, "labelMode", value.asInstanceOf[js.Any])
