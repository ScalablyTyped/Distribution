...
import typings.devextremeB5DqTZzf.anon.Component
...
trait dxDeferRenderingOptions
  ...
  /**
    ...
    */
  var onRendered: js.UndefOr[js.Function1[/* e */ Component, Unit]] = js.undefined
  
  /**
    * A function that is executed when the content is displayed and animation is completed.
    */
  var onShown: js.UndefOr[js.Function1[/* e */ Component, Unit]] = js.undefined
...
object dxDeferRenderingOptions {
  ...
  extension [Self <: dxDeferRenderingOptions](x: Self) {
    ...
    inline def setOnRendered(value: /* e */ Component => Unit): Self = StObject.set(x, "onRendered", js.Any.fromFunction1(value))
    
    inline def setOnRenderedUndefined: Self = StObject.set(x, "onRendered", js.undefined)
    
    inline def setOnShown(value: /* e */ Component => Unit): Self = StObject.set(x, "onShown", js.Any.fromFunction1(value))
