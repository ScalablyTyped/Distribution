...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.POST
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.PUT
...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.useForm
...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxFileUploader.BeforeSendEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxFileUploader.DropZoneEnterEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxFileUploader.DropZoneLeaveEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxFileUploader.FilesUploadedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxFileUploader.ProgressEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxFileUploader.UploadAbortedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxFileUploader.UploadErrorEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxFileUploader.UploadStartedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxFileUploader.UploadedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxFileUploader.ValueChangedEvent
...
object dxFileUploaderOptions {
  ...
  extension [Self <: dxFileUploaderOptions](x: Self) {
    ...
    inline def setUploadMethod(value: POST | PUT): Self = StObject.set(x, "uploadMethod", value.asInstanceOf[js.Any])
    
    inline def setUploadMethodUndefined: Self = StObject.set(x, "uploadMethod", js.undefined)
    
    inline def setUploadMode(value: instantly | useButtons | useForm): Self = StObject.set(x, "uploadMode", value.asInstanceOf[js.Any])
