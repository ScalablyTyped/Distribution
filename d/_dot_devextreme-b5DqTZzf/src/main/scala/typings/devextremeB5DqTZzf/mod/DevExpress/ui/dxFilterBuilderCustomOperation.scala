...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxFilterBuilder.CustomOperationEditorTemplate
...
trait dxFilterBuilderCustomOperation extends StObject {
  ...
  /**
    ...
    */
  var customizeText: js.UndefOr[js.Function1[/* fieldInfo */ typings.devextremeB5DqTZzf.anon.Field, String]] = js.undefined
...
object dxFilterBuilderCustomOperation {
  ...
  extension [Self <: dxFilterBuilderCustomOperation](x: Self) {
    ...
    inline def setCustomizeText(value: /* fieldInfo */ typings.devextremeB5DqTZzf.anon.Field => String): Self = StObject.set(x, "customizeText", js.Any.fromFunction1(value))
    
    inline def setCustomizeTextUndefined: Self = StObject.set(x, "customizeText", js.undefined)
    
    inline def setDataTypes(value: js.Array[string_ | number | date | boolean_ | `object` | datetime]): Self = StObject.set(x, "dataTypes", value.asInstanceOf[js.Any])
    
    inline def setDataTypesUndefined: Self = StObject.set(x, "dataTypes", js.undefined)
    
    inline def setDataTypesVarargs(value: (string_ | number | date | boolean_ | `object` | datetime)*): Self = StObject.set(x, "dataTypes", js.Array(value*))
