...
import typings.devextremeB5DqTZzf.anon.BorderColorColor
import typings.devextremeB5DqTZzf.anon.BorderWidth
import typings.devextremeB5DqTZzf.anon.ColorGroupingField
import typings.devextremeB5DqTZzf.anon.Margin
...
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxVectorMap.CenterChangedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxVectorMap.ClickEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxVectorMap.SelectionChangedEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxVectorMap.TooltipHiddenEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxVectorMap.TooltipShownEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxVectorMap.ZoomFactorChangedEvent
...
trait dxVectorMapOptions
  ...
  var projection: js.UndefOr[
    equirectangular | lambert | mercator | miller | VectorMapProjectionConfig | String | Any
  ] = js.undefined
...
object dxVectorMapOptions {
  ...
  extension [Self <: dxVectorMapOptions](x: Self) {
    ...
    inline def setProjection(value: equirectangular | lambert | mercator | miller | VectorMapProjectionConfig | String | Any): Self = StObject.set(x, "projection", value.asInstanceOf[js.Any])
