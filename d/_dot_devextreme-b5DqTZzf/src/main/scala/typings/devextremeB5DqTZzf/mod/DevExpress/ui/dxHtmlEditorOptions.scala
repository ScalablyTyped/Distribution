...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.html
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.markdown
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxHtmlEditor.FocusInEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxHtmlEditor.FocusOutEvent
...
object dxHtmlEditorOptions {
  ...
  extension [Self <: dxHtmlEditorOptions](x: Self) {
    ...
    inline def setValueType(value: html | markdown): Self = StObject.set(x, "valueType", value.asInstanceOf[js.Any])
