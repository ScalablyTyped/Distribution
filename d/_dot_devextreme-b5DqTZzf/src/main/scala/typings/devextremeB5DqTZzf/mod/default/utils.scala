...
import typings.devextremeB5DqTZzf.anon.AllowPan
import typings.devextremeB5DqTZzf.mod.DevExpress.dxSchedulerTimeZone
...
object utils {
  ...
  @JSImport(".devextreme-b5DqTZzf", "default.utils")
  @js.native
