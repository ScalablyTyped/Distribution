...
import typings.devextremeB5DqTZzf.anon.ShowMode
...
trait dxSliderBaseOptions[TComponent]
  ...
  /**
    ...
    */
  var label: js.UndefOr[typings.devextremeB5DqTZzf.anon.Format] = js.undefined
...
object dxSliderBaseOptions {
  ...
  extension [Self <: dxSliderBaseOptions[?], TComponent](x: Self & dxSliderBaseOptions[TComponent]) {
    ...
    inline def setLabel(value: typings.devextremeB5DqTZzf.anon.Format): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
