...
import typings.devextremeB5DqTZzf.anon.Column
...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.ColumnButtonClickEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxDataGrid.ColumnButtonTemplateData
...
object dxDataGridColumnButton {
  ...
  extension [Self <: dxDataGridColumnButton[?, ?], TRowData, TKey](x: Self & (dxDataGridColumnButton[TRowData, TKey])) {
    ...
    inline def setName(value: cancel | delete | edit | save | undelete | String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
