...
import typings.devextremeB5DqTZzf.anon.DelayName
import typings.devextremeB5DqTZzf.anon.Hide
...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxContextMenu.HiddenEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxContextMenu.HidingEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxContextMenu.Item
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxContextMenu.PositioningEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxContextMenu.ShowingEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxContextMenu.ShownEvent
...
/* Inlined parent .devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.ui.dxMenuBaseOptions<.devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.ui.dxContextMenu<TKey>, .devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.ui.dxContextMenuItem, TKey> */
trait dxContextMenuOptions[TKey] extends StObject {
  ...
  /**
    ...
    */
  var dataSource: js.UndefOr[DataSourceLike[Item, TKey]] = js.undefined
...
object dxContextMenuOptions {
  ...
  extension [Self <: dxContextMenuOptions[?], TKey](x: Self & dxContextMenuOptions[TKey]) {
    ...
    inline def setSelectionMode(value: none | single_): Self = StObject.set(x, "selectionMode", value.asInstanceOf[js.Any])
    ...
    inline def setShowSubmenuMode(value: DelayName | onClick | onHover): Self = StObject.set(x, "showSubmenuMode", value.asInstanceOf[js.Any])
    
    inline def setShowSubmenuModeUndefined: Self = StObject.set(x, "showSubmenuMode", js.undefined)
    
    inline def setSubmenuDirection(value: auto | left | right): Self = StObject.set(x, "submenuDirection", value.asInstanceOf[js.Any])
