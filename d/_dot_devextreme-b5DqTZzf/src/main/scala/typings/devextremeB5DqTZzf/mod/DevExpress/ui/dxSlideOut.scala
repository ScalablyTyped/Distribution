...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.ItemLike
...
object dxSlideOut {
  ...
  trait ExplicitTypes[TItem /* <: ItemLike */, TKey] extends StObject {
    ...
    var ContentReadyEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.ContentReadyEvent[TItem, TKey]
    
    var DisposingEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.DisposingEvent[TItem, TKey]
    
    var InitializedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.InitializedEvent[TItem, TKey]
    
    var ItemClickEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.ItemClickEvent[TItem, TKey]
    
    var ItemContextMenuEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.ItemContextMenuEvent[TItem, TKey]
    
    var ItemHoldEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.ItemHoldEvent[TItem, TKey]
    
    var ItemRenderedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.ItemRenderedEvent[TItem, TKey]
    
    var MenuGroupRenderedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.MenuGroupRenderedEvent[TItem, TKey]
    
    var MenuItemRenderedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.MenuItemRenderedEvent[TItem, TKey]
    
    var OptionChangedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.OptionChangedEvent[TItem, TKey]
    
    var Properties: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.Properties[TItem, TKey]
    
    var SelectionChangedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSlideOut.SelectionChangedEvent[TItem, TKey]
  }
