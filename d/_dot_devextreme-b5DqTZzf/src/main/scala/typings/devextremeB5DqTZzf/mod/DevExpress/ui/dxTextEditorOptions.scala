...
object dxTextEditorOptions {
  ...
  extension [Self <: dxTextEditorOptions[?], TComponent](x: Self & dxTextEditorOptions[TComponent]) {
    ...
    inline def setButtons(value: js.Array[String | clear | dxTextEditorButton]): Self = StObject.set(x, "buttons", value.asInstanceOf[js.Any])
    
    inline def setButtonsUndefined: Self = StObject.set(x, "buttons", js.undefined)
    
    inline def setButtonsVarargs(value: (String | clear | dxTextEditorButton)*): Self = StObject.set(x, "buttons", js.Array(value*))
