...
import typings.devextremeB5DqTZzf.anon.NameField
...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.shift
...
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxPieChart.LegendClickEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxPieChart.PieSeriesType
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxPieChart.SegmentsDirectionType
...
trait dxPieChartOptions
  ...
  /**
    ...
    */
  var segmentsDirection: js.UndefOr[SegmentsDirectionType] = js.undefined
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[PieSeriesType] = js.undefined
}
object dxPieChartOptions {
  ...
  extension [Self <: dxPieChartOptions](x: Self) {
    ...
    inline def setResolveLabelOverlapping(value: hide | none | shift): Self = StObject.set(x, "resolveLabelOverlapping", value.asInstanceOf[js.Any])
    
    inline def setResolveLabelOverlappingUndefined: Self = StObject.set(x, "resolveLabelOverlapping", js.undefined)
    
    inline def setSegmentsDirection(value: SegmentsDirectionType): Self = StObject.set(x, "segmentsDirection", value.asInstanceOf[js.Any])
    ...
    inline def setType(value: PieSeriesType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
