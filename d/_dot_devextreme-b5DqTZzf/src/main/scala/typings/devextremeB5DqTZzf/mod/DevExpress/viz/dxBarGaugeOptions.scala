...
import typings.devextremeB5DqTZzf.anon.ConnectorColor
...
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxBarGauge.TooltipHiddenEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.viz.dxBarGauge.TooltipShownEvent
