...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.expand
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.left
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.overlap
...
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.shrink
...
trait dxDrawerOptions
  ...
  var template: js.UndefOr[
    typings.devextremeB5DqTZzf.mod.DevExpress.core.template | (js.Function1[/* Element */ DxElement_[HTMLElement], Any])
  ] = js.undefined
}
object dxDrawerOptions {
  ...
  extension [Self <: dxDrawerOptions](x: Self) {
    ...
    inline def setOpenedStateMode(value: overlap | shrink | push): Self = StObject.set(x, "openedStateMode", value.asInstanceOf[js.Any])
    ...
    inline def setPosition(value: left | right | top | bottom | before | after): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
    
    inline def setPositionUndefined: Self = StObject.set(x, "position", js.undefined)
    
    inline def setRevealMode(value: slide | expand): Self = StObject.set(x, "revealMode", value.asInstanceOf[js.Any])
