...
/* Inlined parent .devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.core.Skip<.devextreme-b5DqTZzf..devextreme-b5DqTZzf.DevExpress.ui.HierarchicalCollectionWidgetOptions<TComponent, TItem, TKey>, 'dataSource'> */
trait dxMenuBaseOptions[TComponent /* <: dxMenuBase[Any, TItem, TKey] */, TItem /* <: dxMenuBaseItem */, TKey] extends StObject {
  ...
  /**
    ...
    */
  var dataSource: js.UndefOr[DataSourceLike[TItem, TKey]] = js.undefined
