...
import typings.devextremeB5DqTZzf.anon.Line
import typings.devextremeB5DqTZzf.anon.Shift
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.betweenLabels
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.betweenTicks
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.crossLabels
import typings.devextremeB5DqTZzf.devextremeB5DqTZzfStrings.crossTicks
...
trait dxChartCommonAxisSettings extends StObject {
  ...
  /**
    * 
    */
  var aggregatedPointsPosition: js.UndefOr[betweenTicks | crossTicks] = js.undefined
...
object dxChartCommonAxisSettings {
  ...
  extension [Self <: dxChartCommonAxisSettings](x: Self) {
    ...
    inline def setAggregatedPointsPosition(value: betweenTicks | crossTicks): Self = StObject.set(x, "aggregatedPointsPosition", value.asInstanceOf[js.Any])
