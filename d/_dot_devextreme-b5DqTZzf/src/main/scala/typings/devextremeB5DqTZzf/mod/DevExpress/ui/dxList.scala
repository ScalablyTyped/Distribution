...
import typings.devextremeB5DqTZzf.anon.Group
...
object dxList {
  ...
  trait ExplicitTypes[TItem /* <: ItemLike */, TKey] extends StObject {
    ...
    var ContentReadyEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.ContentReadyEvent[TItem, TKey]
    
    var DisposingEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.DisposingEvent[TItem, TKey]
    
    var GroupRenderedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.GroupRenderedEvent[TItem, TKey]
    
    var InitializedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.InitializedEvent[TItem, TKey]
    
    var ItemClickEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.ItemClickEvent[TItem, TKey]
    
    var ItemContextMenuEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.ItemContextMenuEvent[TItem, TKey]
    
    var ItemDeletedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.ItemDeletedEvent[TItem, TKey]
    
    var ItemDeletingEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.ItemDeletingEvent[TItem, TKey]
    
    var ItemHoldEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.ItemHoldEvent[TItem, TKey]
    
    var ItemRenderedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.ItemRenderedEvent[TItem, TKey]
    
    var ItemReorderedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.ItemReorderedEvent[TItem, TKey]
    
    var ItemSwipeEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.ItemSwipeEvent[TItem, TKey]
    
    var OptionChangedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.OptionChangedEvent[TItem, TKey]
    
    var PageLoadingEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.PageLoadingEvent[TItem, TKey]
    
    var Properties: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.Properties[TItem, TKey]
    
    var PullRefreshEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.PullRefreshEvent[TItem, TKey]
    
    var ScrollEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.ScrollEvent[TItem, TKey]
    
    var SelectAllValueChangedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.SelectAllValueChangedEvent[TItem, TKey]
    
    var SelectionChangedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxList.SelectionChangedEvent[TItem, TKey]
  }
