...
object dxTabPanel {
  ...
  trait ExplicitTypes[TItem /* <: ItemLike */, TKey] extends StObject {
    ...
    var ContentReadyEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.ContentReadyEvent[TItem, TKey]
    
    var DisposingEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.DisposingEvent[TItem, TKey]
    
    var InitializedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.InitializedEvent[TItem, TKey]
    
    var ItemClickEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.ItemClickEvent[TItem, TKey]
    
    var ItemContextMenuEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.ItemContextMenuEvent[TItem, TKey]
    
    var ItemHoldEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.ItemHoldEvent[TItem, TKey]
    
    var ItemRenderedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.ItemRenderedEvent[TItem, TKey]
    
    var OptionChangedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.OptionChangedEvent[TItem, TKey]
    
    var Properties: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.Properties[TItem, TKey]
    
    var SelectionChangedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.SelectionChangedEvent[TItem, TKey]
    
    var TitleClickEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.TitleClickEvent[TItem, TKey]
    
    var TitleHoldEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.TitleHoldEvent[TItem, TKey]
    
    var TitleRenderedEvent: typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxTabPanel.TitleRenderedEvent[TItem, TKey]
  }
