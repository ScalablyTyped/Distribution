...
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSpeedDialAction.ClickEvent
import typings.devextremeB5DqTZzf.mod.DevExpress.ui.dxSpeedDialAction.ContentReadyEvent
