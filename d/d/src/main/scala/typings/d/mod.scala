...
object mod {
  ...
  */
  ...
  object Flags {
    ...
    inline def c: typings.d.dStrings.c = "c".asInstanceOf[typings.d.dStrings.c]
    
    inline def ce: typings.d.dStrings.ce = "ce".asInstanceOf[typings.d.dStrings.ce]
    
    inline def cew: typings.d.dStrings.cew = "cew".asInstanceOf[typings.d.dStrings.cew]
    
    inline def cw: typings.d.dStrings.cw = "cw".asInstanceOf[typings.d.dStrings.cw]
    
    inline def e: typings.d.dStrings.e = "e".asInstanceOf[typings.d.dStrings.e]
    
    inline def ew: typings.d.dStrings.ew = "ew".asInstanceOf[typings.d.dStrings.ew]
    
    inline def w: typings.d.dStrings.w = "w".asInstanceOf[typings.d.dStrings.w]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.d.dStrings.ce
  */
  trait GetSetFlags extends StObject
  object GetSetFlags {
