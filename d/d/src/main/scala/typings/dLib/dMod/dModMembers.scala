...
@js.native
object dModMembers extends js.Object {
  def apply(flags: dLib.dMod.dNs.Flags, value: js.Any): stdLib.PropertyDescriptor = js.native
  def apply(flags: dLib.dMod.dNs.Flags, value: js.Any, options: stdLib.PropertyDescriptor): stdLib.PropertyDescriptor = js.native
  ...
  def gs(flags: dLib.dMod.dNs.GetSetFlags, get: scala.Null, set: js.Function1[/* repeated */ js.Any, _]): stdLib.PropertyDescriptor = js.native
  def gs(
    flags: dLib.dMod.dNs.GetSetFlags,
    get: scala.Null,
    set: js.Function1[/* repeated */ js.Any, _],
  ...
  def gs(flags: dLib.dMod.dNs.GetSetFlags, options: stdLib.PropertyDescriptor): stdLib.PropertyDescriptor = js.native
  def gs(
    get: dLib.dMod.dNs.GetSetFlags | js.UndefOr[scala.Nothing],
    set: js.Function1[/* repeated */ js.Any, _]
  ): stdLib.PropertyDescriptor = js.native
