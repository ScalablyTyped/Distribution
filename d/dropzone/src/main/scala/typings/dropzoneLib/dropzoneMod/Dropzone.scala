...
trait Dropzone extends js.Object {
  var defaultOptions: dropzoneLib.dropzoneMod.DropzoneNs.DropzoneOptions = js.native
  var files: js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile] = js.native
  def accept(
  ...
  def addFile(file: dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile): scala.Unit = js.native
  def cancelUpload(file: dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile): scala.Unit = js.native
  ...
  def emit_addedfiles(
    ...
    files: js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile]
  ): Dropzone = js.native
  @JSName("emit")
  def emit_canceled(
  ...
  @JSName("emit")
  def emit_canceledmultiple(
    eventName: dropzoneLib.dropzoneLibStrings.canceledmultiple,
    file: js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile]
  ): Dropzone = js.native
  @JSName("emit")
  def emit_complete(
  ...
  def enqueueFile(file: dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile): scala.Unit = js.native
  def enqueueFiles(file: js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile]): scala.Unit = js.native
  def getAcceptedFiles(): js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile] = js.native
  def getActiveFiles(): js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile] = js.native
  def getAddedFiles(): js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile] = js.native
  def getFilesWithStatus(status: java.lang.String): js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile] = js.native
  def getQueuedFiles(): js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile] = js.native
  def getRejectedFiles(): js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile] = js.native
  ...
  def on_addedfile(
    eventName: dropzoneLib.dropzoneLibStrings.addedfile,
    callback: js.Function1[/* file */ dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile, _]
  ): Dropzone = js.native
  @JSName("on")
  def on_addedfiles(
    eventName: dropzoneLib.dropzoneLibStrings.addedfiles,
    callback: js.Function1[/* files */ js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile], _]
  ): Dropzone = js.native
  @JSName("on")
  def on_canceled(
    eventName: dropzoneLib.dropzoneLibStrings.canceled,
  ...
  def on_canceledmultiple(
    eventName: dropzoneLib.dropzoneLibStrings.canceledmultiple,
    callback: js.Function1[/* file */ js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile], _]
  ): Dropzone = js.native
  @JSName("on")
  def on_complete(
    eventName: dropzoneLib.dropzoneLibStrings.complete,
  ...
  def processFile(file: dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile): scala.Unit = js.native
  def processFiles(files: js.Array[dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile]): scala.Unit = js.native
  ...
  def removeFile(file: dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile): scala.Unit = js.native
  def resizeImage(file: dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile): scala.Unit = js.native
  def resizeImage(file: dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile, width: scala.Double): scala.Unit = js.native
  def resizeImage(file: dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile, width: scala.Double, height: scala.Double): scala.Unit = js.native
  def resizeImage(
    file: dropzoneLib.dropzoneMod.DropzoneNs.DropzoneFile,
    width: scala.Double,
    height: scala.Double,
