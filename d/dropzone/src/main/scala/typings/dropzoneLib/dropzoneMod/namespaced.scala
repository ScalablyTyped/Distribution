...
@js.native
class namespaced protected () extends Dropzone {
  def this(container: dropzoneLib.dropzoneMod.Global.HTMLElement) = this()
  def this(container: java.lang.String) = this()
  def this(container: dropzoneLib.dropzoneMod.Global.HTMLElement, options: dropzoneLib.dropzoneMod.DropzoneNs.DropzoneOptions) = this()
...
object namespaced extends js.Object {
  ...
  var instances: js.Array[dropzoneLib.dropzoneMod.Dropzone] = js.native
