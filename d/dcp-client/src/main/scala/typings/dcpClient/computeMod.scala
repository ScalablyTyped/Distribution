...
import typings.dcpClient.mod.JobHandle
import typings.dcpClient.mod.JobHistory
import typings.dcpClient.mod.JobInfo
import typings.dcpClient.mod.Ranges
import typings.dcpClient.mod.SliceProfile
import typings.dcpClient.mod.WorkValue
import typings.dcpClient.mod.WorkValueQuote
import typings.dcpClient.mod.jobId
...
object computeMod {
  ...
  trait Compute extends StObject {
    ...
    /**
      ...
      */
    def calculateSlicePayment(sliceProfile: SliceProfile, workValue: WorkValue): js.Promise[Double] = js.native
    ...
    /**
      ...
      * @param arguments
      */
    def `do`(n: Double, work: String, arguments: js.Object): js.Promise[JobHandle] = js.native
    ...
    /**
      ...
      * @param arguments
      */
    def `for`(rangeObject: js.Object, work: String, arguments: js.Object): js.Promise[JobHandle] = js.native
    def `for`(rangeObject: Ranges, work: String, arguments: js.Object): js.Promise[JobHandle] = js.native
    /**
      ...
      * @param arguments
      */
    def `for`(start: Double, end: Double, step: Double, work: String, arguments: js.Object): js.Promise[JobHandle] = js.native
    ...
    /**
      ...
      * @param jobId
      */
    def getJobInfo(jobId: Double): js.Promise[JobInfo] = js.native
    ...
    /**
      ...
      */
    def getMarketValue(): js.Promise[WorkValueQuote] = js.native
    ...
    /**
      ...
      * @param jobId
      */
    def getSliceInfo(jobId: Double): js.Promise[JobHistory] = js.native
    ...
    def status(job: JobHandle): js.Promise[JobHandle] = js.native
    /**
      ...
      */
    def status(job: jobId): js.Promise[JobHandle] = js.native
    /**
      ...
      * @param endTime
      */
    def status(paymentAccount: String, startTime: Double, endTime: Double): js.Promise[JobHandle] = js.native
  }
}
