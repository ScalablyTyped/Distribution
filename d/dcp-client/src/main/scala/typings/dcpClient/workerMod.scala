...
import typings.dcpClient.mod.PaymentParams
import typings.dcpClient.mod.Sandbox
import typings.dcpClient.mod.SchedMsg
import typings.dcpClient.mod.Supervisor
...
object workerMod {
  ...
  @JSImport("dcp-client/src/worker", "Worker")
  @js.native
