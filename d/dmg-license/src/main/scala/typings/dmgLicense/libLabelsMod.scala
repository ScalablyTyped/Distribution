...
import typings.dmgLicense.libLabelsMod.Labels.CreateOptions
import typings.dmgLicense.libLabelsMod.Labels.ForEachOptions
import typings.dmgLicense.libLabelsMod.Labels.MapOptions
import typings.dmgLicense.libLabelsMod.Labels.WithLanguageName
import typings.dmgLicense.libLabelsMod.Labels.WithoutLanguageName
...
object libLabelsMod {
  ...
  object default {
    ...
    /**
      ...
      */
    inline def prepare(labels: Labels[String], lang: typings.dmgLicense.libLanguageMod.default): Buffer = (^.asInstanceOf[js.Dynamic].applyDynamic("prepare")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any])).asInstanceOf[Buffer]
    ...
    /**
      ...
      * @returns A `Buffer` in `STR#` format.
      */
    inline def prepareDefault(lang: typings.dmgLicense.libLanguageMod.default): Buffer = ^.asInstanceOf[js.Dynamic].applyDynamic("prepareDefault")(lang.asInstanceOf[js.Any]).asInstanceOf[Buffer]
    ...
    inline def prepareSpec(labels: Null, lang: typings.dmgLicense.libLanguageMod.default, contextOrOptions: Options): js.Promise[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSpec")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Buffer]]
    inline def prepareSpec(
      labels: Unit,
      lang: typings.dmgLicense.libLanguageMod.default,
      contextOrOptions: typings.dmgLicense.libContextMod.default
    ): js.Promise[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSpec")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Buffer]]
    inline def prepareSpec(labels: Unit, lang: typings.dmgLicense.libLanguageMod.default, contextOrOptions: Options): js.Promise[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSpec")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Buffer]]
    /**
      * Prepares a label set for insertion into a disk image as a `STR#` resource.
      *
      * @remarks
    ...
    inline def prepareSpec(labels: LabelsSpec, lang: typings.dmgLicense.libLanguageMod.default, contextOrOptions: Options): js.Promise[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSpec")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Buffer]]
  }
  ...
  object Labels {
    ...
    inline def prepareSpec(labels: Null, lang: default, contextOrOptions: typings.dmgLicense.libContextMod.default): js.Promise[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSpec")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Buffer]]
    ...
    inline def prepareSpec(labels: Unit, lang: default, contextOrOptions: typings.dmgLicense.libContextMod.default): js.Promise[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSpec")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Buffer]]
    ...
    /**
      ...
      * @returns A `Buffer` in `STR#` format.
      */
    inline def prepareSpec(labels: LabelsSpec, lang: default, contextOrOptions: typings.dmgLicense.libContextMod.default): js.Promise[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSpec")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Buffer]]
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.dmgLicense.libLabelsMod.LabelsSpec.LabelsInline
    - typings.dmgLicense.libLabelsMod.LabelsSpec.LabelsRaw
  */
