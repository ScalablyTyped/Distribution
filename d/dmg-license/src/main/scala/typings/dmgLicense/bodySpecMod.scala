...
object bodySpecMod {
  ...
  object default {
    ...
    inline def prepare(spec: BodySpec, lang: typings.dmgLicense.languageMod.default): js.Promise[Data] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepare")(spec.asInstanceOf[js.Any], lang.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Data]]
    inline def prepare(
      spec: BodySpec,
    ...
    inline def prepare(spec: BodySpec, lang: typings.dmgLicense.languageMod.default, contextOrOptions: Options): js.Promise[Data] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepare")(spec.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Data]]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.dmgLicense.bodySpecMod.BodySpec.BodyInline
    - typings.dmgLicense.bodySpecMod.BodySpec.BodyInFile
  */
  ...
  object BodySpec {
    ...
    inline def prepare(spec: BodySpec, lang: default, contextOrOptions: typings.dmgLicense.contextMod.default): js.Promise[Data] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepare")(spec.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Data]]
