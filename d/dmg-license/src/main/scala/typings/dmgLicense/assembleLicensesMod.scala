...
object assembleLicensesMod {
  
  @JSImport("dmg-license/lib/assembleLicenses", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default(spec: LicenseSpec, optionsOrContext: typings.dmgLicense.contextMod.default): js.Promise[AssembledLicenseSet] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(spec.asInstanceOf[js.Any], optionsOrContext.asInstanceOf[js.Any])).asInstanceOf[js.Promise[AssembledLicenseSet]]
