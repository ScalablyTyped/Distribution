...
object libLanguageMod {
  ...
  object default {
    ...
    inline def bySpec(lang: LangSpecs, context: typings.dmgLicense.libContextMod.default): js.Array[Language] = (^.asInstanceOf[js.Dynamic].applyDynamic("bySpec")(lang.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[js.Array[Language]]
