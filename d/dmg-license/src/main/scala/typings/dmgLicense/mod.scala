...
import typings.dmgLicense.libBodySpecMod.BodySpec
...
import typings.dmgLicense.libLabelsMod.LabelsSpec
import typings.dmgLicense.libLabelsMod.LabelsSpec.LabelsInline
import typings.dmgLicense.libLabelsMod.LabelsSpec.LabelsRaw
import typings.dmgLicense.libLanguageMod.LangSpec
import typings.dmgLicense.libLanguageMod.LangSpecs
import typings.dmgLicense.libLanguageMod.default
import typings.dmgLicense.libSpecFromJSONMod.FromJSONOptions
...
object mod {
  ...
  open class BadJSONLicenseSpecError protected ()
    extends typings.dmgLicense.libSpecFromJSONMod.BadJSONLicenseSpecError {
  ...
  object BodySpec {
    ...
    inline def prepare(spec: typings.dmgLicense.libBodySpecMod.BodySpec, lang: default): js.Promise[Data] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepare")(spec.asInstanceOf[js.Any], lang.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Data]]
    inline def prepare(
      spec: typings.dmgLicense.libBodySpecMod.BodySpec,
      lang: default,
    ...
    inline def prepare(spec: typings.dmgLicense.libBodySpecMod.BodySpec, lang: default, contextOrOptions: Options): js.Promise[Data] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepare")(spec.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Data]]
  }
  
  @JSImport("dmg-license", "LabelEncodingError")
  @js.native
  open class LabelEncodingError protected ()
    extends typings.dmgLicense.libLabelsMod.LabelEncodingError {
  ...
  object Labels {
    ...
    ): typings.dmgLicense.libLabelsMod.Labels[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(fun.asInstanceOf[js.Any]).asInstanceOf[typings.dmgLicense.libLabelsMod.Labels[T]]
    inline def create[T](
      fun: js.Function2[
          /* keyof dmg-license.dmg-license/lib/Labels.Labels<string> */ /* key */ languageName | agree | disagree | print | save | message, 
          /* index */ Double, 
    ...
    ): typings.dmgLicense.libLabelsMod.Labels[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(fun.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.dmgLicense.libLabelsMod.Labels[T]]
    ...
    inline def createAsync[T](
      ...
      options: CreateOptions
    ): js.Promise[typings.dmgLicense.libLabelsMod.Labels[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("createAsync")(fun.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.dmgLicense.libLabelsMod.Labels[T]]]
    ...
    ): typings.dmgLicense.libLabelsMod.Labels[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("map")(labels.asInstanceOf[js.Any], fun.asInstanceOf[js.Any])).asInstanceOf[typings.dmgLicense.libLabelsMod.Labels[U]]
    inline def map[T, U](
      labels: typings.dmgLicense.libLabelsMod.Labels[T],
      fun: js.Function3[
          /* label */ T, 
    ...
    inline def map[T, U](
      ...
      options: MapOptions[T, U]
    ): typings.dmgLicense.libLabelsMod.Labels[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("map")(labels.asInstanceOf[js.Any], fun.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.dmgLicense.libLabelsMod.Labels[U]]
    ...
    ): js.Promise[typings.dmgLicense.libLabelsMod.Labels[U]] = (^.asInstanceOf[js.Dynamic].applyDynamic("mapAsync")(labels.asInstanceOf[js.Any], fun.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.dmgLicense.libLabelsMod.Labels[U]]]
    inline def mapAsync[T, U](
      labels: typings.dmgLicense.libLabelsMod.Labels[T],
      fun: js.Function3[
          /* label */ T, 
    ...
    inline def mapAsync[T, U](
      ...
      options: MapOptions[T, js.Promise[U]]
    ): js.Promise[typings.dmgLicense.libLabelsMod.Labels[U]] = (^.asInstanceOf[js.Dynamic].applyDynamic("mapAsync")(labels.asInstanceOf[js.Any], fun.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.dmgLicense.libLabelsMod.Labels[U]]]
    ...
    /**
      ...
      */
    inline def prepare(labels: typings.dmgLicense.libLabelsMod.Labels[String], lang: default): Buffer = (^.asInstanceOf[js.Dynamic].applyDynamic("prepare")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any])).asInstanceOf[Buffer]
  ...
  @js.native
  open class Language ()
    extends typings.dmgLicense.libLanguageMod.Language
  /* static members */
  object Language {
    ...
    inline def add(lang: typings.dmgLicense.libLanguageMod.Language): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("add")(lang.asInstanceOf[js.Any]).asInstanceOf[Unit]
    
    @JSImport("dmg-license", "Language.byID")
    @js.native
    def byID: js.Array[js.UndefOr[typings.dmgLicense.libLanguageMod.Language]] = js.native
    inline def byID_=(x: js.Array[js.UndefOr[typings.dmgLicense.libLanguageMod.Language]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("byID")(x.asInstanceOf[js.Any])
    
    inline def bySpec(lang: LangSpecs): js.Array[typings.dmgLicense.libLanguageMod.Language] = ^.asInstanceOf[js.Dynamic].applyDynamic("bySpec")(lang.asInstanceOf[js.Any]).asInstanceOf[js.Array[typings.dmgLicense.libLanguageMod.Language]]
    inline def bySpec(lang: LangSpecs, context: typings.dmgLicense.libContextMod.default): js.Array[typings.dmgLicense.libLanguageMod.Language] = (^.asInstanceOf[js.Dynamic].applyDynamic("bySpec")(lang.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.dmgLicense.libLanguageMod.Language]]
    
    @JSImport("dmg-license", "Language.byTag")
    @js.native
    def byTag: StringDictionary[js.UndefOr[typings.dmgLicense.libLanguageMod.Language]] = js.native
    inline def byTag_=(x: StringDictionary[js.UndefOr[typings.dmgLicense.libLanguageMod.Language]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("byTag")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("dmg-license", "NoDefaultLabelsError")
  @js.native
  open class NoDefaultLabelsError protected ()
    extends typings.dmgLicense.libLabelsMod.NoDefaultLabelsError {
