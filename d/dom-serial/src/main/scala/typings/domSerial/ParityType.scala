...
// mix spec and Chromium implementation
/* Rewritten from type alias, can be one of: 
  - typings.domSerial.domSerialStrings.none
  - typings.domSerial.domSerialStrings.even
  - typings.domSerial.domSerialStrings.odd
  - typings.domSerial.domSerialStrings.mark
  - typings.domSerial.domSerialStrings.space
*/
trait ParityType extends js.Object
object ParityType {
