...
import typings.domhandler.nodeMod.ChildNode
import typings.domhandler.nodeMod.ParentNode
...
object esmMod {
  ...
  open class CDATA protected ()
    extends typings.domhandler.nodeMod.CDATA {
    /**
  ...
  open class Comment protected ()
    extends typings.domhandler.nodeMod.Comment {
    /**
  ...
  @JSImport("domhandler/lib/esm", "DataNode")
  @js.native
  ...
  open class Document protected ()
    extends typings.domhandler.nodeMod.Document {
    /**
      * @param children Children of the node. Only certain node types can have children.
      */
    def this(children: js.Array[ChildNode]) = this()
  ...
  open class DomHandler () extends StObject {
    ...
    /* protected */ var lastNode: typings.domhandler.nodeMod.DataNode | Null = js.native
    ...
    var root: typings.domhandler.nodeMod.Document = js.native
  ...
  @JSImport("domhandler/lib/esm", "Node")
  @js.native
  abstract class Node ()
    extends typings.domhandler.nodeMod.Node
  
  @JSImport("domhandler/lib/esm", "NodeWithChildren")
  @js.native
  ...
  open class ProcessingInstruction protected ()
    extends typings.domhandler.nodeMod.ProcessingInstruction {
  ...
  open class Text protected ()
    extends typings.domhandler.nodeMod.Text {
    /**
      * @param data The content of the data node
      */
    def this(data: String) = this()
  ...
  inline def cloneNode[T /* <: typings.domhandler.nodeMod.Node */](node: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(node.asInstanceOf[js.Any]).asInstanceOf[T]
  inline def cloneNode[T /* <: typings.domhandler.nodeMod.Node */](node: T, recursive: Boolean): T = (^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(node.asInstanceOf[js.Any], recursive.asInstanceOf[js.Any])).asInstanceOf[T]
  
  inline def hasChildren(node: typings.domhandler.nodeMod.Node): /* is domhandler.domhandler/lib/esm/node.ParentNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("hasChildren")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/esm/node.ParentNode */ Boolean]
  
  inline def isCDATA(node: typings.domhandler.nodeMod.Node): /* is domhandler.domhandler/lib/esm/node.CDATA */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCDATA")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/esm/node.CDATA */ Boolean]
  
  inline def isComment(node: typings.domhandler.nodeMod.Node): /* is domhandler.domhandler/lib/esm/node.Comment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isComment")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/esm/node.Comment */ Boolean]
  
  inline def isDirective(node: typings.domhandler.nodeMod.Node): /* is domhandler.domhandler/lib/esm/node.ProcessingInstruction */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDirective")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/esm/node.ProcessingInstruction */ Boolean]
  
  inline def isDocument(node: typings.domhandler.nodeMod.Node): /* is domhandler.domhandler/lib/esm/node.Document */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDocument")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/esm/node.Document */ Boolean]
  
  inline def isTag(node: typings.domhandler.nodeMod.Node): /* is domhandler.domhandler/lib/esm/node.Element */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/esm/node.Element */ Boolean]
  
  inline def isText(node: typings.domhandler.nodeMod.Node): /* is domhandler.domhandler/lib/esm/node.Text */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isText")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/esm/node.Text */ Boolean]
  ...
  type ElementCallback = js.Function1[/* element */ typings.domhandler.nodeMod.Element, Unit]
