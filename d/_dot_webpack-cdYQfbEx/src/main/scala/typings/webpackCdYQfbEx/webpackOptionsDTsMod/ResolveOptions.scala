...
import typings.webpackCdYQfbEx.anon.Alias
...
trait ResolveOptions extends StObject {
  ...
  /**
  	 ...
  	 */
  var fileSystem: js.UndefOr[StringDictionary[Any]] = js.undefined
  ...
  /**
  	 ...
  	 */
  var ignoreRootsErrors: js.UndefOr[Boolean] = js.undefined
  ...
  /**
  	 * Custom resolver
  	 */
  var resolver: js.UndefOr[StringDictionary[Any]] = js.undefined
...
object ResolveOptions {
  ...
  extension [Self <: ResolveOptions](x: Self) {
    ...
    inline def setFileSystem(value: StringDictionary[Any]): Self = StObject.set(x, "fileSystem", value.asInstanceOf[js.Any])
    
    inline def setFileSystemUndefined: Self = StObject.set(x, "fileSystem", js.undefined)
    
    inline def setIgnoreRootsErrors(value: Boolean): Self = StObject.set(x, "ignoreRootsErrors", value.asInstanceOf[js.Any])
    
    inline def setIgnoreRootsErrorsUndefined: Self = StObject.set(x, "ignoreRootsErrors", js.undefined)
    ...
    inline def setResolver(value: StringDictionary[Any]): Self = StObject.set(x, "resolver", value.asInstanceOf[js.Any])
