...
import typings.webpackCdYQfbEx.anon.Name
import typings.webpackCdYQfbEx.webpackCdYQfbExBooleans.`false`
import typings.webpackCdYQfbEx.webpackCdYQfbExStrings.`total-size`
import typings.webpackCdYQfbEx.webpackCdYQfbExStrings.hashed
import typings.webpackCdYQfbEx.webpackCdYQfbExStrings.multiple
import typings.webpackCdYQfbEx.webpackCdYQfbExStrings.named
import typings.webpackCdYQfbEx.webpackCdYQfbExStrings.natural
import typings.webpackCdYQfbEx.webpackCdYQfbExStrings.single
import typings.webpackCdYQfbEx.webpackCdYQfbExStrings.size
...
object OptimizationOptions {
  ...
  extension [Self <: OptimizationOptions](x: Self) {
    ...
    inline def setMinimizerVarargs(value: (WebpackPluginInstance | WebpackPluginFunction)*): Self = StObject.set(x, "minimizer", js.Array(value*))
