...
object progressPluginDTsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.webpackCdYQfbEx.progressPluginDTsMod.ProgressPluginOptions
    - typings.webpackCdYQfbEx.progressPluginDTsMod.HandlerFunction
  */
