...
object webpackCdYQfbExStrings {
  ...
  inline def `electron-preload`: `electron-preload` = "electron-preload".asInstanceOf[`electron-preload`]
  ...
  inline def webassemblySlashexperimental: webassemblySlashexperimental = "webassembly/experimental".asInstanceOf[webassemblySlashexperimental]
