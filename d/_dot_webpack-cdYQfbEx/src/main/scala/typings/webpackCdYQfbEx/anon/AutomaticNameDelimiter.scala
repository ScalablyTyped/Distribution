...
trait AutomaticNameDelimiter extends StObject {
  ...
  /**
  					 ...
  					 */
  var test: js.UndefOr[js.Function | String | js.RegExp] = js.undefined
}
object AutomaticNameDelimiter {
  ...
  extension [Self <: AutomaticNameDelimiter](x: Self) {
    ...
    inline def setTest(value: js.Function | String | js.RegExp): Self = StObject.set(x, "test", value.asInstanceOf[js.Any])
