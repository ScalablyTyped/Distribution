...
package object esmMod {
  ...
  type ConfigType = java.lang.String | scala.Double | typings.std.Date | typings.dayjs.esmMod.Dayjs
  ...
  type OptionType = typings.dayjs.anon.Format | java.lang.String | js.Array[java.lang.String]
  
  type PluginFunc[T] = js.Function3[
    /* option */ T, 
    /* c */ org.scalablytyped.runtime.Instantiable1[
      /* config */ js.UndefOr[typings.dayjs.esmMod.ConfigType], 
