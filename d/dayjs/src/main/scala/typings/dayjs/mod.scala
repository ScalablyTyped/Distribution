...
object mod {
  ...
  class Dayjs () extends StObject {
    ...
    def tz(timezone: js.UndefOr[scala.Nothing], keepLocalTime: Boolean): typings.dayjs.pluginTimezoneMod.dayjsAugmentingMod.Dayjs = js.native
  ...
  @js.native
  def localeData(): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.GlobalLocaleDataReturn = js.native
  ...
  @JSImport("dayjs", "utc")
  @js.native
  def utc(config: js.UndefOr[ConfigType], format: String): typings.dayjs.pluginUtcMod.dayjsAugmentingMod.Dayjs = js.native
  @JSImport("dayjs", "utc")
  @js.native
  def utc(config: ConfigType): typings.dayjs.pluginUtcMod.dayjsAugmentingMod.Dayjs = js.native
  ...
  @JSImport("dayjs", "weekdays")
  @js.native
  def weekdays(localOrder: Boolean): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames = js.native
  ...
  @JSImport("dayjs", "weekdaysMin")
  @js.native
  def weekdaysMin(localOrder: Boolean): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames = js.native
  ...
  @JSImport("dayjs", "weekdaysShort")
  @js.native
  def weekdaysShort(localOrder: Boolean): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames = js.native
