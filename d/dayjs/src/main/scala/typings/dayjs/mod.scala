...
object mod {
  ...
  */
  ...
  trait DayjsTimezone extends StObject {
    ...
    def apply(): typings.dayjs.pluginTimezoneMod.dayjsAugmentingMod.Dayjs = js.native
    def apply(date: Unit, timezone: String): typings.dayjs.pluginTimezoneMod.dayjsAugmentingMod.Dayjs = js.native
