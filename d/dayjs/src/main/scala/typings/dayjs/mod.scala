...
object mod {
  ...
  class Dayjs () extends StObject {
    ...
    def add(value: Duration): typings.dayjs.pluginDurationMod.dayjsAugmentingMod.Dayjs = js.native
    ...
    def subtract(value: Duration): typings.dayjs.pluginDurationMod.dayjsAugmentingMod.Dayjs = js.native
  ...
  @scala.inline
  def isDayjs(d: js.Any): /* is dayjs.dayjs.Dayjs */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDayjs")(d.asInstanceOf[js.Any]).asInstanceOf[/* is dayjs.dayjs.Dayjs */ Boolean]
  
  @scala.inline
  def isDuration(d: js.Any): /* is dayjs.dayjs/plugin/duration.Duration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDuration")(d.asInstanceOf[js.Any]).asInstanceOf[/* is dayjs.dayjs/plugin/duration.Duration */ Boolean]
  ...
  @scala.inline
  def localeData(): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.GlobalLocaleDataReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("localeData")().asInstanceOf[typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.GlobalLocaleDataReturn]
  ...
  @scala.inline
  def months(): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.MonthNames = ^.asInstanceOf[js.Dynamic].applyDynamic("months")().asInstanceOf[typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.MonthNames]
  
  @scala.inline
  def monthsShort(): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.MonthNames = ^.asInstanceOf[js.Dynamic].applyDynamic("monthsShort")().asInstanceOf[typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.MonthNames]
  ...
  @scala.inline
  def utc(): typings.dayjs.pluginUtcMod.dayjsAugmentingMod.Dayjs = ^.asInstanceOf[js.Dynamic].applyDynamic("utc")().asInstanceOf[typings.dayjs.pluginUtcMod.dayjsAugmentingMod.Dayjs]
  @scala.inline
  def utc(config: Unit, format: String): typings.dayjs.pluginUtcMod.dayjsAugmentingMod.Dayjs = (^.asInstanceOf[js.Dynamic].applyDynamic("utc")(config.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.pluginUtcMod.dayjsAugmentingMod.Dayjs]
  @scala.inline
  def utc(config: ConfigType): typings.dayjs.pluginUtcMod.dayjsAugmentingMod.Dayjs = ^.asInstanceOf[js.Dynamic].applyDynamic("utc")(config.asInstanceOf[js.Any]).asInstanceOf[typings.dayjs.pluginUtcMod.dayjsAugmentingMod.Dayjs]
  @scala.inline
  def utc(config: ConfigType, format: String): typings.dayjs.pluginUtcMod.dayjsAugmentingMod.Dayjs = (^.asInstanceOf[js.Dynamic].applyDynamic("utc")(config.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.pluginUtcMod.dayjsAugmentingMod.Dayjs]
  
  @scala.inline
  def weekdays(): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames = ^.asInstanceOf[js.Dynamic].applyDynamic("weekdays")().asInstanceOf[typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames]
  @scala.inline
  def weekdays(localOrder: Boolean): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames = ^.asInstanceOf[js.Dynamic].applyDynamic("weekdays")(localOrder.asInstanceOf[js.Any]).asInstanceOf[typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames]
  
  @scala.inline
  def weekdaysMin(): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames = ^.asInstanceOf[js.Dynamic].applyDynamic("weekdaysMin")().asInstanceOf[typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames]
  @scala.inline
  def weekdaysMin(localOrder: Boolean): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames = ^.asInstanceOf[js.Dynamic].applyDynamic("weekdaysMin")(localOrder.asInstanceOf[js.Any]).asInstanceOf[typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames]
  
  @scala.inline
  def weekdaysShort(): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames = ^.asInstanceOf[js.Dynamic].applyDynamic("weekdaysShort")().asInstanceOf[typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames]
  @scala.inline
  def weekdaysShort(localOrder: Boolean): typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames = ^.asInstanceOf[js.Dynamic].applyDynamic("weekdaysShort")(localOrder.asInstanceOf[js.Any]).asInstanceOf[typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames]
