...
object mod {
  ...
  inline def isDayjs(d: js.Any): /* is dayjs.dayjs.Dayjs */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDayjs")(d.asInstanceOf[js.Any]).asInstanceOf[/* is dayjs.dayjs.Dayjs */ Boolean]
  
  inline def isDuration(d: js.Any): /* is dayjs.dayjs/plugin/duration.Duration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDuration")(d.asInstanceOf[js.Any]).asInstanceOf[/* is dayjs.dayjs/plugin/duration.Duration */ Boolean]
