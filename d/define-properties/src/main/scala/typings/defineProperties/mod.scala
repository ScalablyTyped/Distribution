...
object mod {
  ...
  /**
    ...
    */
  inline def apply[M /* <: js.Object */](`object`: js.Object, map: M & ThisType[Any]): Unit = (^.asInstanceOf[js.Dynamic].apply(`object`.asInstanceOf[js.Any], map.asInstanceOf[js.Any])).asInstanceOf[Unit]
