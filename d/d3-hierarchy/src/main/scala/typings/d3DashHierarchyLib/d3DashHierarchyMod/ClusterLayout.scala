...
trait ClusterLayout[Datum] extends js.Object {
  ...
  /**
    ...
    */
  def nodeSize(): (js.Tuple2[scala.Double, scala.Double]) | scala.Null = js.native
  /**
    ...
    */
  def nodeSize(size: js.Tuple2[scala.Double, scala.Double]): this.type = js.native
  /**
    * Returns the current separation accessor, which defaults to: `(a, b) => a.parent == b.parent ? 1 : 2`.
    */
  def separation(): js.Function2[/* a */ HierarchyPointNode[Datum], /* b */ HierarchyPointNode[Datum], scala.Double] = js.native
  /**
    ...
    */
  def separation(
    separation: js.Function2[/* a */ HierarchyPointNode[Datum], /* b */ HierarchyPointNode[Datum], scala.Double]
  ): this.type = js.native
  /**
    ...
    */
  def size(): (js.Tuple2[scala.Double, scala.Double]) | scala.Null = js.native
  /**
