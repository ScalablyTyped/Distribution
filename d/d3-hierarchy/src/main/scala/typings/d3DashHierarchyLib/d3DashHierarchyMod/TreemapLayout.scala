...
trait TreemapLayout[Datum] extends js.Object {
  ...
  /**
       ...
       */
  def padding(): js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double] = js.native
  /**
       ...
       */
  def padding(padding: js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double]): this.type = js.native
  /**
  ...
  /**
       ...
       */
  def paddingBottom(): js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double] = js.native
  /**
       ...
       */
  def paddingBottom(padding: js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double]): this.type = js.native
  /**
       ...
       */
  def paddingBottom(padding: scala.Double): this.type = js.native
  /**
       * Returns the current inner padding function, which defaults to the constant zero.
       */
  def paddingInner(): js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double] = js.native
  /**
       ...
       */
  def paddingInner(padding: js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double]): this.type = js.native
  /**
  ...
  /**
       ...
       */
  def paddingLeft(): js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double] = js.native
  /**
       ...
       */
  def paddingLeft(padding: js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double]): this.type = js.native
  /**
       ...
       */
  def paddingLeft(padding: scala.Double): this.type = js.native
  /**
       * Returns the current top padding function.
       */
  def paddingOuter(): js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double] = js.native
  /**
       ...
       */
  def paddingOuter(padding: js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double]): this.type = js.native
  /**
       * Sets the top, right, bottom and left padding to the specified function and returns this treemap layout.
       *
  ...
  /**
       ...
       */
  def paddingRight(): js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double] = js.native
  /**
       ...
       */
  def paddingRight(padding: js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double]): this.type = js.native
  /**
       ...
       */
  def paddingRight(padding: scala.Double): this.type = js.native
  /**
       * Returns the current top padding function, which defaults to the constant zero.
       */
  def paddingTop(): js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double] = js.native
  /**
       ...
       */
  def paddingTop(padding: js.Function1[/* node */ HierarchyRectangularNode[Datum], scala.Double]): this.type = js.native
  /**
       ...
       */
  def paddingTop(padding: scala.Double): this.type = js.native
  /**
