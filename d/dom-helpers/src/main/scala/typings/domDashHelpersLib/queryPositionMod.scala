...
object queryPositionMod extends js.Object {
  /**
    ...
    */
  def apply(element: stdLib.Element): domDashHelpersLib.queryOffsetMod.DomHelpersRect = js.native
  def apply(element: stdLib.Element, offsetParent: stdLib.Node): domDashHelpersLib.queryOffsetMod.DomHelpersRect = js.native
}
