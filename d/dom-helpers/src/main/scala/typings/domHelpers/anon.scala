...
object anon {
  ...
  @js.native
  trait Once[K /* <: /* keyof std.HTMLElementEventMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 92 */ js.Any */] extends StObject {
  ...
  object Once {
    ...
    @scala.inline
    implicit class OnceMutableBuilder[Self <: Once[_], K /* <: /* keyof std.HTMLElementEventMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 92 */ js.Any */] (val x: Self with Once[K]) extends AnyVal {
      
      @scala.inline
      def set__once(value: EventHandler[K]): Self = StObject.set(x, "__once", value.asInstanceOf[js.Any])
      
      @scala.inline
      def set__onceUndefined: Self = StObject.set(x, "__once", js.undefined)
    }
  }
