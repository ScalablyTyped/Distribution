...
@js.native
trait FnAbortAnimationcancelAnimationendAnimationiteration extends js.Object {
  ...
  def apply(node: HTMLElement, eventName: loadend, handler: EventHandler[loadend]): js.Function0[Unit] = js.native
  def apply(node: HTMLElement, eventName: loadend, handler: EventHandler[loadend], options: Boolean): js.Function0[Unit] = js.native
  def apply(
    node: HTMLElement,
    eventName: loadend,
