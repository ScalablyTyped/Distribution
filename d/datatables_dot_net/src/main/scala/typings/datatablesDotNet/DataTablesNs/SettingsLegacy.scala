...
trait SettingsLegacy extends js.Object {
  ...
  var _iDisplayLength: Double = js.native
  var _iDisplayStart: Double = js.native
  var _iRecordsDisplay: Double = js.native
  ...
  var aiDisplay: js.Array[Double] = js.native
  ...
  var asDataSearch: js.Array[String] = js.native
  var asDestroyStripes: js.Array[String] = js.native
  var asStripeClasses: js.Array[String] = js.native
  var bAjaxDataGet: Boolean = js.native
  var bDeferLoading: Boolean = js.native
  var bDrawing: Boolean = js.native
  var bFiltered: Boolean = js.native
  var bInitialized: Boolean = js.native
  var bJUI: Boolean = js.native
  var bSortCellsTop: Boolean = js.native
  ...
  var iDraw: Double = js.native
  var iDrawError: Double = js.native
  var iTabIndex: Double = js.native
  var jqXHR: js.Any = js.native
  var nScrollFoot: Node = js.native
  var nScrollHead: Node = js.native
  var nTBody: Node = js.native
  var nTFoot: Node = js.native
  var nTHead: Node = js.native
  var nTable: Node = js.native
  ...
  var sAjaxDataProp: String = js.native
  var sAjaxSource: String = js.native
  var sCookiePrefix: String = js.native
  var sDestroyWidth: Double = js.native
  var sDom: String = js.native
  var sInstance: String = js.native
  var sPaginationType: String = js.native
  var sServerMethod: String = js.native
  var sTableId: String = js.native
  def fnCookieCallback(name: String, data: js.Any, expires: String, path: String, cookie: String): Unit = js.native
  def fnDisplayEnd(): Double = js.native
  def fnFormatNumber(formatNumber: Double): Unit = js.native
  def fnRecordsDisplay(): Double = js.native
  def fnRecordsTotal(): Double = js.native
  def rowIdFn(mSource: String): js.Function0[Unit] = js.native
  def rowIdFn(mSource: js.Function0[Unit]): js.Function0[Unit] = js.native
  def rowIdFn(mSource: Double): js.Function0[Unit] = js.native
}
