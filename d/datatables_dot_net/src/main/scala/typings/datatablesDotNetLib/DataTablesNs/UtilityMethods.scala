...
trait UtilityMethods extends js.Object {
  ...
  /**
    ...
    */
  def each(fn: js.Function3[/* value */ js.Any, /* index */ scala.Double, /* dt */ Api, scala.Unit]): Api = js.native
  /**
    * Reduce an Api instance to a single context and result set.
    *
    * @param idx Index to select
    */
  def eq(idx: scala.Double): Api = js.native
  /**
    * Iterate over the result set of an API instance and test each item, creating a new instance from those items which pass.
    *
    * @param fn Callback function which is called for each item in the API instance result set. The callback is called with three parameters.
    */
  def filter(fn: js.Function3[/* value */ js.Any, /* index */ scala.Double, /* dt */ Api, scala.Boolean]): Api = js.native
  /**
  ...
  /**
    ...
    * @param fn Callback function which is called for each item in the API instance result set. The callback is called with three parameters.
    */
  def map(fn: js.Function3[/* value */ js.Any, /* index */ scala.Double, /* dt */ Api, _]): Api = js.native
  def pluck(property: java.lang.String): Api = js.native
  /**
    ...
    */
  def pluck(property: scala.Double): Api = js.native
  /**
  ...
  /**
    ...
    */
  def push(value_1: js.Any, value_2: js.Any*): scala.Double = js.native
  /**
  ...
  def sort(fn: js.Function2[/* value1 */ js.Any, /* value2 */ js.Any, scala.Double]): Api = js.native
  /**
    ...
    */
  def splice(index: scala.Double, howMany: scala.Double): js.Array[_] = js.native
  def splice(index: scala.Double, howMany: scala.Double, value_1: js.Any, value_2: js.Any*): js.Array[_] = js.native
  /**
    * Convert the API instance to a jQuery object, with the objects from the instance's result set in the jQuery result set.
    */
  @JSName("to$")
  def to$(): datatablesDotNetLib.JQuery = js.native
  /**
  ...
  /**
    * Convert the API instance to a jQuery object, with the objects from the instance's result set in the jQuery result set.
    */
  def toJQuery(): datatablesDotNetLib.JQuery = js.native
  /**
  ...
  /**
    ...
    * @param value_1 Item to add to the API instance's result set.
    */
  def unshift(value_1: js.Any, value_2: js.Any*): scala.Double = js.native
}
