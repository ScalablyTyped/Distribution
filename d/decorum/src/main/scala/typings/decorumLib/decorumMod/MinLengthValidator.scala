...
class MinLengthValidator protected ()
  extends decorumLib.decorumMod.decorumNs.MinLengthValidator {
  def this(minLength: scala.Double) = this()
  def this(minLength: scala.Double, message: decorumLib.decorumMod.decorumNs.MessageHandler[decorumLib.decorumMod.decorumNs.MinLengthValidator]) = this()
  ...
  /* CompleteClass */
  override var minLength: scala.Double = js.native
  /**
  ...
  /* CompleteClass */
  override def isValid(value: java.lang.String): scala.Boolean = js.native
  /**
