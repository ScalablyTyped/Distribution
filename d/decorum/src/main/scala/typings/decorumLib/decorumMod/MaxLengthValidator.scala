...
class MaxLengthValidator protected ()
  extends decorumLib.decorumMod.decorumNs.MaxLengthValidator {
  def this(maxLength: scala.Double) = this()
  def this(maxLength: scala.Double, message: decorumLib.decorumMod.decorumNs.MessageHandler[decorumLib.decorumMod.decorumNs.MaxLengthValidator]) = this()
  ...
  /* CompleteClass */
  override var maxLength: scala.Double = js.native
  /**
