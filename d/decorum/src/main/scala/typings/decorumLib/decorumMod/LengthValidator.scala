...
class LengthValidator protected ()
  extends decorumLib.decorumMod.decorumNs.LengthValidator {
  def this(length: scala.Double) = this()
  def this(length: scala.Double, message: decorumLib.decorumMod.decorumNs.MessageHandler[decorumLib.decorumMod.decorumNs.LengthValidator]) = this()
