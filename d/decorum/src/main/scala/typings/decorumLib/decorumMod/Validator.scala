...
object Validator extends js.Object {
  ...
  def addValidator(
    ...
    validator: decorumLib.decorumMod.BaseValidator
  ...
  /**
    ...
    */
  def decorate(objectType: js.Any, definitions: decorumLib.decorumMod.ValidationDefinitions): scala.Unit = js.native
  /**
    ...
    */
  def `new`(model: js.Any): decorumLib.decorumMod.ModelValidator = js.native
  /**
    * Creates an anonymous validator, immediately validates the model, and returns any validation errors on the
    * model as a result.
    * @param model The model to validate.
    */
  def validate(model: js.Any): decorumLib.decorumMod.IValidationResult = js.native
}
