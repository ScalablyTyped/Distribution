...
class FieldOptions protected () extends js.Object {
  ...
  /**
    ...
    */
  def addValidator(validator: BaseValidator): scala.Unit = js.native
  /**
    * Gets the "friendly" name of the field for use in validation error messages. Defaults to just "Field".
    * @returns {string}
    */
  def getFriendlyName(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def setFriendlyName(name: java.lang.String): scala.Unit = js.native
  /**
    ...
    *     valid for the field.
    */
  def validateValue(value: js.Any, model: js.Any): js.Array[java.lang.String] = js.native
}
