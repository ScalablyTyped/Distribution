...
class PatternValidator protected ()
  extends decorumLib.decorumMod.decorumNs.PatternValidator {
  def this(pattern: stdLib.RegExp) = this()
  def this(pattern: stdLib.RegExp, message: decorumLib.decorumMod.decorumNs.MessageHandler[decorumLib.decorumMod.decorumNs.PatternValidator]) = this()
