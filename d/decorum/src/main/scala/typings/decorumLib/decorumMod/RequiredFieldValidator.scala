...
class RequiredFieldValidator ()
  extends decorumLib.decorumMod.decorumNs.RequiredFieldValidator {
  def this(message: decorumLib.decorumMod.decorumNs.MessageHandler[decorumLib.decorumMod.decorumNs.RequiredFieldValidator]) = this()
