...
trait PerAxisOptions extends js.Object {
  /**
    ...
    */
  var axisLabelColor: js.UndefOr[java.lang.String] = js.undefined
  /**
    * Size of the font (in pixels) to use in the axis labels, both x- and y-axis.
    */
  var axisLabelFontSize: js.UndefOr[scala.Double] = js.undefined
  /**
  ...
  /**
    ...
    */
  var axisLabelWidth: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var axisLineColor: js.UndefOr[java.lang.String] = js.undefined
  /**
    * Thickness (in pixels) of the x- and y-axis lines.
    */
  var axisLineWidth: js.UndefOr[scala.Double] = js.undefined
  /**
    * The size of the line to display next to each tick mark on x- or y-axes.
    */
  var axisTickSize: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var drawAxis: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    */
  var drawGrid: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    * gridlines.
    */
  var gridLinePattern: js.UndefOr[js.Array[scala.Double]] = js.undefined
  /**
  ...
  /**
    ...
    * like 20 or 30.
    */
  var maxNumberWidth: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    * basis.
    */
  var pixelsPerLabel: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var sigFigs: js.UndefOr[scala.Double] = js.undefined
  /**
