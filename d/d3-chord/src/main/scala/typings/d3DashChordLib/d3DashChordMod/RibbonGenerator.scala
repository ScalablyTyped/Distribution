...
trait RibbonGenerator[This, RibbonDatum, RibbonSubgroupDatum] extends js.Object {
  /**
       ...
       */
  def apply(`this`: This, d: RibbonDatum, args: js.Any*): java.lang.String | scala.Null = js.native
  /**
       * Returns the current rendering context, which defaults to null.
       */
  def context(): stdLib.CanvasRenderingContext2D | scala.Null = js.native
  /**
       ...
       */
  def context(context: stdLib.CanvasRenderingContext2D): this.type = js.native
  /**
  ...
  /**
       ...
       */
  def endAngle(): js.ThisFunction2[/* this */ This, /* d */ RibbonSubgroupDatum, /* repeated */js.Any, scala.Double] = js.native
  /**
       ...
       */
  def endAngle(
    angle: js.ThisFunction2[/* this */ This, /* d */ RibbonSubgroupDatum, /* repeated */js.Any, scala.Double]
  ): this.type = js.native
  /**
  ...
  /**
       ...
       * target object returned by the source or target accessor, respectively.
       */
  def radius(): js.ThisFunction2[/* this */ This, /* d */ RibbonSubgroupDatum, /* repeated */js.Any, scala.Double] = js.native
  /**
       ...
       */
  def radius(
    radius: js.ThisFunction2[/* this */ This, /* d */ RibbonSubgroupDatum, /* repeated */js.Any, scala.Double]
  ): this.type = js.native
  /**
  ...
  /**
       ...
       * target object returned by the source or target accessor, respectively.
       */
  def startAngle(): js.ThisFunction2[/* this */ This, /* d */ RibbonSubgroupDatum, /* repeated */js.Any, scala.Double] = js.native
  /**
