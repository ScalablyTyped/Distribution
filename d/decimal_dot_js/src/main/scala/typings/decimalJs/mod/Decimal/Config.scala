...
object Config {
  ...
  implicit class ConfigOps[Self <: Config] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModulo(value: Modulo): Self = this.set("modulo", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRounding(value: Rounding): Self = this.set("rounding", value.asInstanceOf[js.Any])
    @scala.inline
