...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "app-builder-lib" % "20.39.0-18cdc2",
  ...
  "org.scalablytyped" %%% "electron-publish" % "20.39.0-9ac72f",
  ...
  "org.scalablytyped" %%% "read-config-file" % "3.2.2-4a6f52",
