...
object androidParserDTsMod {
  
  @JSImport(".logkitty-0luekPG6/build/android/AndroidParser.d.ts", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
       with AndroidParser {
  ...
  object default {
    ...
    @JSImport(".logkitty-0luekPG6/build/android/AndroidParser.d.ts", "default.headerRegex")
    @js.native
    ...
    @JSImport(".logkitty-0luekPG6/build/android/AndroidParser.d.ts", "default.timeRegex")
    @js.native
