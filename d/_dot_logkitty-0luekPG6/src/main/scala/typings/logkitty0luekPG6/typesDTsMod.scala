...
object typesDTsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.logkitty0luekPG6.logkitty0luekPG6Strings.ios
    - typings.logkitty0luekPG6.logkitty0luekPG6Strings.android
  */
  trait Platform extends StObject
  object Platform {
    
    inline def android: typings.logkitty0luekPG6.logkitty0luekPG6Strings.android = "android".asInstanceOf[typings.logkitty0luekPG6.logkitty0luekPG6Strings.android]
    
    inline def ios: typings.logkitty0luekPG6.logkitty0luekPG6Strings.ios = "ios".asInstanceOf[typings.logkitty0luekPG6.logkitty0luekPG6Strings.ios]
  }
}
