...
import typings.logkitty0luekPG6.typesDTsMod.IParser
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object iosParserDTsMod {
  
  @JSImport(".logkitty-0luekPG6/build/ios/IosParser.d.ts", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
       with IosParser {
  ...
  object default {
    ...
    @JSImport(".logkitty-0luekPG6/build/ios/IosParser.d.ts", "default.headerRegex")
    @js.native
    ...
    @JSImport(".logkitty-0luekPG6/build/ios/IosParser.d.ts", "default.timeRegex")
    @js.native
