...
trait Anon_AddSuffixCeilDayFloor extends js.Object {
...
object Anon_AddSuffixCeilDayFloor {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AddSuffixCeilDayFloor]
  }
}
