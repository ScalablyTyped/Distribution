...
trait Anon_0123456FirstWeekContainsDate extends js.Object {
...
object Anon_0123456FirstWeekContainsDate {
  @scala.inline
  def apply(
  ...
  ): Anon_0123456FirstWeekContainsDate = {
    ...
    __obj.asInstanceOf[Anon_0123456FirstWeekContainsDate]
  }
}
