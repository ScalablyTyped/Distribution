...
trait Anon_01234567FirstWeekContainsDate extends js.Object {
...
object Anon_01234567FirstWeekContainsDate {
  @scala.inline
  def apply(
  ...
  ): Anon_01234567FirstWeekContainsDate = {
    ...
    __obj.asInstanceOf[Anon_01234567FirstWeekContainsDate]
  }
}
