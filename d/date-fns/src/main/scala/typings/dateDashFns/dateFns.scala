...
trait dateFns extends js.Object {
  ...
  def eachWeekOfInterval(interval: Interval, options: Anon_012): js.Array[Date] = js.native
  ...
  def endOfDecade(date: Double, options: Anon_01): Date = js.native
  def endOfDecade(date: Date): Date = js.native
  def endOfDecade(date: Date, options: Anon_01): Date = js.native
  ...
  def endOfWeek(date: Double, options: Anon_012): Date = js.native
  def endOfWeek(date: Date): Date = js.native
  def endOfWeek(date: Date, options: Anon_012): Date = js.native
  ...
  def lastDayOfQuarter(date: Double, options: Anon_01): Date = js.native
  def lastDayOfQuarter(date: Date): Date = js.native
  def lastDayOfQuarter(date: Date, options: Anon_01): Date = js.native
  def lastDayOfWeek(date: Double): Date = js.native
  def lastDayOfWeek(date: Double, options: Anon_012): Date = js.native
  def lastDayOfWeek(date: Date): Date = js.native
  def lastDayOfWeek(date: Date, options: Anon_012): Date = js.native
  ...
  def parseISO(argument: String, options: Anon_01): Date = js.native
  ...
  def set(date: Double, values: Anon_DateHours): Date = js.native
  def set(date: Date, values: Anon_DateHours): Date = js.native
  ...
  def setDay(date: Double, day: Double, options: Anon_012): Date = js.native
  def setDay(date: Date, day: Double): Date = js.native
  def setDay(date: Date, day: Double, options: Anon_012): Date = js.native
  ...
  def setWeek(date: Double, week: Double, options: Anon_01234567FirstWeekContainsDateLocaleWeekStartsOn): Date = js.native
  def setWeek(date: Date, week: Double): Date = js.native
  def setWeek(date: Date, week: Double, options: Anon_01234567FirstWeekContainsDateLocaleWeekStartsOn): Date = js.native
  def setWeekYear(date: Double, weekYear: Double): Date = js.native
  def setWeekYear(date: Double, weekYear: Double, options: Anon_01234567FirstWeekContainsDateLocaleWeekStartsOn): Date = js.native
  def setWeekYear(date: Date, weekYear: Double): Date = js.native
  def setWeekYear(date: Date, weekYear: Double, options: Anon_01234567FirstWeekContainsDateLocaleWeekStartsOn): Date = js.native
  ...
  def startOfWeek(date: Double, options: Anon_012): Date = js.native
  def startOfWeek(date: Date): Date = js.native
  def startOfWeek(date: Date, options: Anon_012): Date = js.native
  def startOfWeekYear(date: Double): Date = js.native
  def startOfWeekYear(date: Double, options: Anon_01234567FirstWeekContainsDateLocaleWeekStartsOn): Date = js.native
  def startOfWeekYear(date: Date): Date = js.native
  def startOfWeekYear(date: Date, options: Anon_01234567FirstWeekContainsDateLocaleWeekStartsOn): Date = js.native
