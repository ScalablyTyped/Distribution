...
object dateFnsFormatDistanceStrictMod extends js.Object {
  ...
  object default extends js.Object {
    ...
    def apply(date: Double, baseDate: Double, options: AnonAddSuffixCeil): String = js.native
    def apply(date: Double, baseDate: Date): String = js.native
    def apply(date: Double, baseDate: Date, options: AnonAddSuffixCeil): String = js.native
    def apply(date: Date, baseDate: Double): String = js.native
    def apply(date: Date, baseDate: Double, options: AnonAddSuffixCeil): String = js.native
    def apply(date: Date, baseDate: Date): String = js.native
    def apply(date: Date, baseDate: Date, options: AnonAddSuffixCeil): String = js.native
  }
