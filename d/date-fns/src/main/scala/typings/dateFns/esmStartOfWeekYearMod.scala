...
object esmStartOfWeekYearMod {
  ...
  object default {
    ...
    inline def apply(date: js.Date, options: `1`): js.Date = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
    ...
    inline def apply(date: Double, options: `1`): js.Date = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
