...
trait AnonAddSuffixCeilDayFloor extends js.Object {
...
object AnonAddSuffixCeilDayFloor {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAddSuffixCeilDayFloor]
  }
}
