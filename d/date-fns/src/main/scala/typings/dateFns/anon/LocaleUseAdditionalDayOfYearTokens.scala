...
@js.native
trait LocaleUseAdditionalDayOfYearTokens extends js.Object {
...
object LocaleUseAdditionalDayOfYearTokens {
  ...
  @scala.inline
  implicit class LocaleUseAdditionalDayOfYearTokensOps[Self <: LocaleUseAdditionalDayOfYearTokens] (val x: Self) extends AnyVal {
    @scala.inline
