...
@js.native
trait UseAdditionalWeekYearTokensWeekStartsOn extends js.Object {
...
object UseAdditionalWeekYearTokensWeekStartsOn {
  ...
  @scala.inline
  implicit class UseAdditionalWeekYearTokensWeekStartsOnOps[Self <: UseAdditionalWeekYearTokensWeekStartsOn] (val x: Self) extends AnyVal {
