...
object esmIsSameWeekMod extends js.Object {
  ...
  object default extends js.Object {
    ...
    def apply(dateLeft: Double, dateRight: Double, options: Anon012): Boolean = js.native
    ...
    def apply(dateLeft: Double, dateRight: Date, options: Anon012): Boolean = js.native
    ...
    def apply(dateLeft: Date, dateRight: Double, options: Anon012): Boolean = js.native
    ...
    def apply(dateLeft: Date, dateRight: Date, options: Anon012): Boolean = js.native
  }
