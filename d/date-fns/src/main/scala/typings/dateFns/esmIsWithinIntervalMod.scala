...
object esmIsWithinIntervalMod {
  ...
  object default {
    ...
    inline def apply(date: js.Date, interval: typings.dateFns.mod.Interval | Interval): Boolean = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], interval.asInstanceOf[js.Any])).asInstanceOf[Boolean]
