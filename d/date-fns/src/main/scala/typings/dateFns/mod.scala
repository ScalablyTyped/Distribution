...
object mod {
  ...
  inline def add(date: js.Date, duration: typings.dateFns.mod.Duration): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(date.asInstanceOf[js.Any], duration.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  inline def add(date: Double, duration: typings.dateFns.mod.Duration): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(date.asInstanceOf[js.Any], duration.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def clamp(date: js.Date, interval: typings.dateFns.mod.Interval): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("clamp")(date.asInstanceOf[js.Any], interval.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  inline def clamp(date: Double, interval: typings.dateFns.mod.Interval): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("clamp")(date.asInstanceOf[js.Any], interval.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  @JSImport("date-fns", "daysInWeek")
  @js.native
  val daysInWeek: Double = js.native
  
  @JSImport("date-fns", "daysInYear")
  @js.native
  ...
  inline def differenceInCalendarWeeks(dateLeft: js.Date, dateRight: js.Date, options: typings.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("differenceInCalendarWeeks")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def differenceInCalendarWeeks(dateLeft: js.Date, dateRight: Double, options: typings.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("differenceInCalendarWeeks")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def differenceInCalendarWeeks(dateLeft: Double, dateRight: js.Date, options: typings.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("differenceInCalendarWeeks")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def eachDayOfInterval(interval: typings.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachDayOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  inline def eachDayOfInterval(interval: typings.dateFns.mod.Interval, options: Step): js.Array[js.Date] = (^.asInstanceOf[js.Dynamic].applyDynamic("eachDayOfInterval")(interval.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Date]]
  
  inline def eachHourOfInterval(interval: typings.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachHourOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  inline def eachHourOfInterval(interval: typings.dateFns.mod.Interval, options: Step): js.Array[js.Date] = (^.asInstanceOf[js.Dynamic].applyDynamic("eachHourOfInterval")(interval.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Date]]
  
  inline def eachMinuteOfInterval(interval: typings.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachMinuteOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  inline def eachMinuteOfInterval(interval: typings.dateFns.mod.Interval, options: Step): js.Array[js.Date] = (^.asInstanceOf[js.Dynamic].applyDynamic("eachMinuteOfInterval")(interval.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Date]]
  
  inline def eachMonthOfInterval(interval: typings.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachMonthOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  
  inline def eachQuarterOfInterval(interval: typings.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachQuarterOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  
  inline def eachWeekOfInterval(interval: typings.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachWeekOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  inline def eachWeekOfInterval(interval: typings.dateFns.mod.Interval, options: typings.dateFns.anon.Locale): js.Array[js.Date] = (^.asInstanceOf[js.Dynamic].applyDynamic("eachWeekOfInterval")(interval.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Date]]
  
  inline def eachWeekendOfInterval(interval: typings.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachWeekendOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  ...
  inline def eachYearOfInterval(interval: typings.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachYearOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  ...
  inline def endOfWeek(date: js.Date, options: typings.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("endOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def endOfWeek(date: Double, options: typings.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("endOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def format(date: js.Date, format: String, options: FirstWeekContainsDate): String = (^.asInstanceOf[js.Dynamic].applyDynamic("format")(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatDistance(date: js.Date, baseDate: js.Date, options: AddSuffix): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatDistance")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatDistance(date: js.Date, baseDate: Double, options: AddSuffix): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatDistance")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatDistance(date: Double, baseDate: js.Date, options: AddSuffix): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatDistance")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatDistanceStrict(date: js.Date, baseDate: js.Date, options: Unit): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatDistanceStrict")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatDistanceStrict(date: js.Date, baseDate: Double, options: Unit): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatDistanceStrict")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatDistanceStrict(date: Double, baseDate: js.Date, options: Unit): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatDistanceStrict")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatDistanceToNow(date: js.Date, options: AddSuffix): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatDistanceToNow")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatDistanceToNowStrict(date: js.Date, options: Unit): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatDistanceToNowStrict")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatRelative(date: js.Date, baseDate: js.Date, options: typings.dateFns.anon.Locale): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatRelative")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatRelative(date: js.Date, baseDate: Double, options: typings.dateFns.anon.Locale): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatRelative")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatRelative(date: Double, baseDate: js.Date, options: typings.dateFns.anon.Locale): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatRelative")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def getWeek(date: js.Date, options: FirstWeekContainsDateLocaleWeekStartsOn): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getWeekOfMonth(date: js.Date, options: typings.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeekOfMonth")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getWeekYear(date: js.Date, options: FirstWeekContainsDateLocaleWeekStartsOn): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeekYear")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getWeeksInMonth(date: js.Date, options: typings.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeeksInMonth")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def intlFormat(argument: js.Date, formatOptions: scala.Unit, localeOptions: typings.dateFns.anon.`0`): String = (^.asInstanceOf[js.Dynamic].applyDynamic("intlFormat")(argument.asInstanceOf[js.Any], formatOptions.asInstanceOf[js.Any], localeOptions.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def intlFormat(argument: Double, formatOptions: scala.Unit, localeOptions: typings.dateFns.anon.`0`): String = (^.asInstanceOf[js.Dynamic].applyDynamic("intlFormat")(argument.asInstanceOf[js.Any], formatOptions.asInstanceOf[js.Any], localeOptions.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def isSameWeek(dateLeft: js.Date, dateRight: js.Date, options: typings.dateFns.anon.Locale): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isSameWeek")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isSameWeek(dateLeft: js.Date, dateRight: Double, options: typings.dateFns.anon.Locale): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isSameWeek")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isSameWeek(dateLeft: Double, dateRight: js.Date, options: typings.dateFns.anon.Locale): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isSameWeek")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isThisWeek(date: js.Date, options: typings.dateFns.anon.Locale): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isThisWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isWithinInterval(date: js.Date, interval: typings.dateFns.mod.Interval): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isWithinInterval")(date.asInstanceOf[js.Any], interval.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def lastDayOfWeek(date: js.Date, options: typings.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("lastDayOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def lastDayOfWeek(date: Double, options: typings.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("lastDayOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def milliseconds(duration: typings.dateFns.mod.Duration): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("milliseconds")(duration.asInstanceOf[js.Any]).asInstanceOf[Double]
  
  @JSImport("date-fns", "millisecondsInHour")
  @js.native
  val millisecondsInHour: Double = js.native
  
  @JSImport("date-fns", "millisecondsInMinute")
  @js.native
  val millisecondsInMinute: Double = js.native
  
  @JSImport("date-fns", "millisecondsInSecond")
  @js.native
  ...
  @JSImport("date-fns", "minutesInHour")
  @js.native
  ...
  @JSImport("date-fns", "monthsInQuarter")
  @js.native
  val monthsInQuarter: Double = js.native
  
  @JSImport("date-fns", "monthsInYear")
  @js.native
  ...
  inline def nextDay(date: js.Date, day: typings.dateFns.mod.Day): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("nextDay")(date.asInstanceOf[js.Any], day.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  inline def nextDay(date: Double, day: typings.dateFns.mod.Day): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("nextDay")(date.asInstanceOf[js.Any], day.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  @JSImport("date-fns", "quartersInYear")
  @js.native
  ...
  @JSImport("date-fns", "secondsInDay")
  @js.native
  val secondsInDay: Double = js.native
  
  @JSImport("date-fns", "secondsInHour")
  @js.native
  val secondsInHour: Double = js.native
  
  @JSImport("date-fns", "secondsInMinute")
  @js.native
  val secondsInMinute: Double = js.native
  
  @JSImport("date-fns", "secondsInMonth")
  @js.native
  val secondsInMonth: Double = js.native
  
  @JSImport("date-fns", "secondsInQuarter")
  @js.native
  val secondsInQuarter: Double = js.native
  
  @JSImport("date-fns", "secondsInWeek")
  @js.native
  val secondsInWeek: Double = js.native
  
  @JSImport("date-fns", "secondsInYear")
  @js.native
  ...
  inline def setDay(date: js.Date, day: Double, options: typings.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setDay")(date.asInstanceOf[js.Any], day.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def setDay(date: Double, day: Double, options: typings.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setDay")(date.asInstanceOf[js.Any], day.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def setDefaultOptions(newOptions: FirstWeekContainsDateLocaleWeekStartsOn): scala.Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setDefaultOptions")(newOptions.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
  ...
  inline def setWeek(date: js.Date, week: Double, options: FirstWeekContainsDateLocaleWeekStartsOn): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setWeek")(date.asInstanceOf[js.Any], week.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def setWeek(date: Double, week: Double, options: FirstWeekContainsDateLocaleWeekStartsOn): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setWeek")(date.asInstanceOf[js.Any], week.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def setWeekYear(date: js.Date, weekYear: Double, options: FirstWeekContainsDateLocaleWeekStartsOn): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setWeekYear")(date.asInstanceOf[js.Any], weekYear.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def setWeekYear(date: Double, weekYear: Double, options: FirstWeekContainsDateLocaleWeekStartsOn): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setWeekYear")(date.asInstanceOf[js.Any], weekYear.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def startOfWeek(date: js.Date, options: typings.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("startOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def startOfWeek(date: Double, options: typings.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("startOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def startOfWeekYear(date: js.Date, options: FirstWeekContainsDateLocaleWeekStartsOn): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("startOfWeekYear")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def startOfWeekYear(date: Double, options: FirstWeekContainsDateLocaleWeekStartsOn): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("startOfWeekYear")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def sub(date: js.Date, duration: typings.dateFns.mod.Duration): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("sub")(date.asInstanceOf[js.Any], duration.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  inline def sub(date: Double, duration: typings.dateFns.mod.Duration): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("sub")(date.asInstanceOf[js.Any], duration.asInstanceOf[js.Any])).asInstanceOf[js.Date]
