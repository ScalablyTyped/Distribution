...
import typings.dateFns.Anon012
...
object differenceInCalendarWeeks extends js.Object {
  ...
  def apply(dateLeft: Double, dateRight: Double, options: Anon012): Double = js.native
  def apply(dateLeft: Double, dateRight: Date): Double = js.native
  def apply(dateLeft: Double, dateRight: Date, options: Anon012): Double = js.native
  def apply(dateLeft: Date, dateRight: Double): Double = js.native
  def apply(dateLeft: Date, dateRight: Double, options: Anon012): Double = js.native
  def apply(dateLeft: Date, dateRight: Date): Double = js.native
  def apply(dateLeft: Date, dateRight: Date, options: Anon012): Double = js.native
}
