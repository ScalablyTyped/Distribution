...
trait AnonUseAdditionalDayOfYearTokens extends js.Object {
...
object AnonUseAdditionalDayOfYearTokens {
  @scala.inline
  def apply(
  ...
  ): AnonUseAdditionalDayOfYearTokens = {
    ...
    __obj.asInstanceOf[AnonUseAdditionalDayOfYearTokens]
  }
}
