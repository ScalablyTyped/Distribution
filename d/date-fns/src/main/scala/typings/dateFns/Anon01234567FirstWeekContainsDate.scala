...
trait Anon01234567FirstWeekContainsDate extends js.Object {
...
object Anon01234567FirstWeekContainsDate {
  @scala.inline
  def apply(
  ...
  ): Anon01234567FirstWeekContainsDate = {
    ...
    __obj.asInstanceOf[Anon01234567FirstWeekContainsDate]
  }
}
