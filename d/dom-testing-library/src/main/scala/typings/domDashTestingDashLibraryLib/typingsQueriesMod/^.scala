package typings
package domDashTestingDashLibraryLib.typingsQueriesMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("dom-testing-library/typings/queries", JSImport.Namespace)
@js.native
object ^ extends js.Object {
  ...
  val getAllBySelectText: AllByBoundAttribute = js.native
  ...
  val getAllByValue: AllByBoundAttribute = js.native
  ...
  val getBySelectText: GetByBoundAttribute = js.native
  ...
  val getByValue: GetByBoundAttribute = js.native
  ...
  val queryAllBySelectText: AllByBoundAttribute = js.native
  ...
  val queryAllByValue: AllByBoundAttribute = js.native
  ...
  val queryBySelectText: QueryByBoundAttribute = js.native
  ...
  val queryByValue: QueryByBoundAttribute = js.native
}
