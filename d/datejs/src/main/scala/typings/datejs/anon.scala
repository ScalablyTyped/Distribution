...
object anon {
  ...
  /* Inlined std.Partial<{  millisecond :number,   second :number,   minute :number,   hour :number,   day :number,   month :number,   year :number}> */
  trait Partialmillisecondnumbers extends StObject {
  ...
  object Partialmillisecondnumbers {
    
    inline def apply(): Partialmillisecondnumbers = {
  ...
  /* Inlined std.Partial<{  milliseconds :number,   seconds :number,   minutes :number,   hours :number,   days :number,   months :number,   years :number}> */
  trait Partialmillisecondsnumber extends StObject {
  ...
  object Partialmillisecondsnumber {
    
    inline def apply(): Partialmillisecondsnumber = {
      val __obj = js.Dynamic.literal()
