...
trait TimeLocaleObject extends js.Object {
  /**
    ...
    */
  def format(specifier: java.lang.String): js.Function1[/* date */ stdLib.Date, java.lang.String]
  /**
    ...
    * @param specifier A specifier string for the date format.
    */
  def parse(specifier: java.lang.String): js.Function1[/* dateString */ java.lang.String, stdLib.Date | scala.Null]
  /**
    ...
    * @param specifier A specifier string for the date format.
    */
  def utcFormat(specifier: java.lang.String): js.Function1[/* date */ stdLib.Date, java.lang.String]
  /**
