...
trait B3 extends js.Object {
  ...
  /**
    ...
    */
  var sampler: js.UndefOr[RateLimit] = js.undefined
}
...
object B3 {
  ...
  def apply(
    ...
    if (!js.isUndefined(runtimeId)) __obj.updateDynamic("runtimeId")(runtimeId.get.asInstanceOf[js.Any])
