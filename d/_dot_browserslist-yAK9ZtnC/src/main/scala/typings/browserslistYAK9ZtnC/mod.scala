...
import typings.browserslistYAK9ZtnC.browserslistYAK9ZtnCBooleans.`false`
...
object mod {
  ...
  @JSImport(".browserslist-yAK9ZtnC", JSImport.Namespace)
  @js.native
  ...
  /**
    ...
    */
  @JSImport(".browserslist-yAK9ZtnC", "defaults")
  @js.native
  ...
  @JSImport(".browserslist-yAK9ZtnC", "nodeVersions")
  @js.native
  ...
  object usage {
    ...
    @JSImport(".browserslist-yAK9ZtnC", "usage")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport(".browserslist-yAK9ZtnC", "usage.custom")
    @js.native
    ...
    @JSImport(".browserslist-yAK9ZtnC", "usage.global")
    @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typings.browserslistYAK9ZtnC.browserslistYAK9ZtnCStrings.`my stats`
    - typings.browserslistYAK9ZtnC.mod.Stats
    - typings.browserslistYAK9ZtnC.anon.DataByBrowser
  */
