...
trait RenderProps extends js.Object {
  ...
  def getBackProps(data: dayzedLib.Anon_Offset): stdLib.Record[java.lang.String, _]
  def getDateProps(data: dayzedLib.Anon_DateObj): stdLib.Record[java.lang.String, _]
  def getForwardProps(data: dayzedLib.Anon_Offset): stdLib.Record[java.lang.String, _]
}
