...
@js.native
trait TemplateDocumentVisibility extends js.Object {
...
object TemplateDocumentVisibility {
  ...
  @scala.inline
  implicit class TemplateDocumentVisibilityOps[Self <: TemplateDocumentVisibility] (val x: Self) extends AnyVal {
