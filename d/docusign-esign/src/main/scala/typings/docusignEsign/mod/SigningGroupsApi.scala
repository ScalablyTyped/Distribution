...
@js.native
open class SigningGroupsApi () extends StObject {
  def this(apiClient: ApiClient) = this()
  
  def createList(accountId: String): js.Promise[SigningGroupInformation] = js.native
  def createList(accountId: String, optsOrCallback: Any): js.Promise[SigningGroupInformation] = js.native
  def createList(accountId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[SigningGroupInformation] = js.native
  def createList(
    accountId: String,
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[SigningGroupInformation] = js.native
  ...
  def deleteList(accountId: String, optsOrCallback: Any): js.Promise[SigningGroupInformation] = js.native
  def deleteList(accountId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[SigningGroupInformation] = js.native
  def deleteList(
    accountId: String,
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ...
  def deleteUsers(accountId: String, signingGroupId: String, optsOrCallback: Any): js.Promise[SigningGroupUsers] = js.native
  def deleteUsers(accountId: String, signingGroupId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[SigningGroupUsers] = js.native
  def deleteUsers(
    accountId: String,
  ...
  def list(accountId: String, optsOrCallback: Any): js.Promise[SigningGroupInformation] = js.native
  def list(accountId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[SigningGroupInformation] = js.native
  def list(
    accountId: String,
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ...
  def update(accountId: String, signingGroupId: String, optsOrCallback: Any): js.Promise[SigningGroup] = js.native
  def update(accountId: String, signingGroupId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[SigningGroup] = js.native
  def update(
    accountId: String,
    signingGroupId: String,
    optsOrCallback: Any,
  ...
  def updateList(accountId: String, optsOrCallback: Any): js.Promise[SigningGroupInformation] = js.native
  def updateList(accountId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[SigningGroupInformation] = js.native
  def updateList(
    accountId: String,
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ...
  def updateUsers(accountId: String, signingGroupId: String, optsOrCallback: Any): js.Promise[SigningGroupUsers] = js.native
  def updateUsers(accountId: String, signingGroupId: String, optsOrCallback: Any, callback: js.Function0[Unit]): js.Promise[SigningGroupUsers] = js.native
  def updateUsers(
    accountId: String,
    signingGroupId: String,
    optsOrCallback: Any,
