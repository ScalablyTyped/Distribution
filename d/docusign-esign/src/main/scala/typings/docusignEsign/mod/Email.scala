...
object Email {
  ...
  implicit open class MutableBuilder[Self <: Email] (val x: Self) extends AnyVal {
    ...
    inline def setConcealValueOnDocumentMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "concealValueOnDocumentMetadata", value.asInstanceOf[js.Any])
    
    inline def setConcealValueOnDocumentMetadataUndefined: Self = StObject.set(x, "concealValueOnDocumentMetadata", js.undefined)
    ...
    inline def setDisableAutoSizeMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "disableAutoSizeMetadata", value.asInstanceOf[js.Any])
    
    inline def setDisableAutoSizeMetadataUndefined: Self = StObject.set(x, "disableAutoSizeMetadata", js.undefined)
    ...
    inline def setMaxLengthMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "maxLengthMetadata", value.asInstanceOf[js.Any])
    
    inline def setMaxLengthMetadataUndefined: Self = StObject.set(x, "maxLengthMetadata", js.undefined)
    ...
    inline def setOriginalValueMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "originalValueMetadata", value.asInstanceOf[js.Any])
    
    inline def setOriginalValueMetadataUndefined: Self = StObject.set(x, "originalValueMetadata", js.undefined)
    ...
    inline def setSenderRequired(value: String): Self = StObject.set(x, "senderRequired", value.asInstanceOf[js.Any])
    
    inline def setSenderRequiredMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "senderRequiredMetadata", value.asInstanceOf[js.Any])
    
    inline def setSenderRequiredMetadataUndefined: Self = StObject.set(x, "senderRequiredMetadata", js.undefined)
    
    inline def setSenderRequiredUndefined: Self = StObject.set(x, "senderRequired", js.undefined)
    ...
    inline def setValidationMessageMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "validationMessageMetadata", value.asInstanceOf[js.Any])
    
    inline def setValidationMessageMetadataUndefined: Self = StObject.set(x, "validationMessageMetadata", js.undefined)
    ...
    inline def setValidationPatternMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "validationPatternMetadata", value.asInstanceOf[js.Any])
    
    inline def setValidationPatternMetadataUndefined: Self = StObject.set(x, "validationPatternMetadata", js.undefined)
