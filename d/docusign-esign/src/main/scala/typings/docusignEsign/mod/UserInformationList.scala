...
@js.native
trait UserInformationList extends js.Object {
...
object UserInformationList {
  ...
  @scala.inline
  def apply(): UserInformationList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UserInformationList]
  }
  
  @scala.inline
  implicit class UserInformationListOps[Self <: UserInformationList] (val x: Self) extends AnyVal {
