...
@js.native
trait TemplateRecipientTabs extends js.Object {
...
object TemplateRecipientTabs {
  ...
  @scala.inline
  def apply(): TemplateRecipientTabs = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TemplateRecipientTabs]
  }
  
  @scala.inline
  implicit class TemplateRecipientTabsOps[Self <: TemplateRecipientTabs] (val x: Self) extends AnyVal {
