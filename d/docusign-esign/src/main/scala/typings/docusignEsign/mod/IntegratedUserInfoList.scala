...
trait IntegratedUserInfoList extends StObject {
  
  var allUsersSelected: js.UndefOr[String] = js.undefined
...
object IntegratedUserInfoList {
  ...
  @scala.inline
  implicit class IntegratedUserInfoListMutableBuilder[Self <: IntegratedUserInfoList] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAllUsersSelected(value: String): Self = StObject.set(x, "allUsersSelected", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAllUsersSelectedUndefined: Self = StObject.set(x, "allUsersSelected", js.undefined)
