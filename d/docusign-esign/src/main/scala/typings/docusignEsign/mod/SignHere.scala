...
@js.native
trait SignHere extends js.Object {
...
object SignHere {
  ...
  @scala.inline
  implicit class SignHereOps[Self <: SignHere] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsSealSignTab(value: String): Self = this.set("isSealSignTab", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIsSealSignTab: Self = this.set("isSealSignTab", js.undefined)
    ...
    @scala.inline
    def setOptionalMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("optionalMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOptionalMetadata: Self = this.set("optionalMetadata", js.undefined)
    ...
    @scala.inline
    def setScaleValueMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("scaleValueMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteScaleValueMetadata: Self = this.set("scaleValueMetadata", js.undefined)
    ...
    @scala.inline
    def setStamp(value: Stamp): Self = this.set("stamp", value.asInstanceOf[js.Any])
