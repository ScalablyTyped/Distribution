...
@js.native
class UsersApi protected () extends StObject {
  ...
  def getProfileImage(accountId: String, userId: String, optsOrCallback: Unit, callback: js.Function0[Unit]): js.Promise[js.Object] = js.native
