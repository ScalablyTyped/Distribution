...
open class UsersApi () extends StObject {
  ...
  def create(
    ...
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[NewUsersSummary] = js.native
  ...
  def deleteContactWithId(
    accountId: String,
    contactId: String,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[ContactUpdateResponse] = js.native
  ...
  def getProfile(
    ...
    userId: String,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[UserProfile] = js.native
  ...
  def getSettings(
    ...
    userId: String,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[UserSettingsInformation] = js.native
  ...
  def list(
    ...
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[UserInformationList] = js.native
