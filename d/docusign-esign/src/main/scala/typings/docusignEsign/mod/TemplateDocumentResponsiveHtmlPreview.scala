...
@js.native
trait TemplateDocumentResponsiveHtmlPreview extends js.Object {
...
object TemplateDocumentResponsiveHtmlPreview {
  ...
  @scala.inline
  implicit class TemplateDocumentResponsiveHtmlPreviewOps[Self <: TemplateDocumentResponsiveHtmlPreview] (val x: Self) extends AnyVal {
