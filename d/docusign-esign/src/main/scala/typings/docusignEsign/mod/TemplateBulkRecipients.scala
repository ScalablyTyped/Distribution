...
@js.native
trait TemplateBulkRecipients extends js.Object {
...
object TemplateBulkRecipients {
  ...
  @scala.inline
  def apply(): TemplateBulkRecipients = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TemplateBulkRecipients]
  }
  
  @scala.inline
  implicit class TemplateBulkRecipientsOps[Self <: TemplateBulkRecipients] (val x: Self) extends AnyVal {
