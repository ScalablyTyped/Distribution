...
trait EnvelopeId extends StObject {
...
object EnvelopeId {
  ...
  inline def apply(): EnvelopeId = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EnvelopeId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EnvelopeId] (val x: Self) extends AnyVal {
