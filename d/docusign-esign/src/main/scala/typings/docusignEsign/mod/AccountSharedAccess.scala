...
@js.native
trait AccountSharedAccess extends js.Object {
...
object AccountSharedAccess {
  ...
  @scala.inline
  implicit class AccountSharedAccessOps[Self <: AccountSharedAccess] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSharedAccessVarargs(value: (/* Information about shared items. */ MemberSharedItems)*): Self = this.set("sharedAccess", js.Array(value :_*))
    
    @scala.inline
    def setSharedAccess(value: js.Array[/* Information about shared items. */ MemberSharedItems]): Self = this.set("sharedAccess", value.asInstanceOf[js.Any])
