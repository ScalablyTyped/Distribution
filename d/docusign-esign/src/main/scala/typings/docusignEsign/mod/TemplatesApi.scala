...
class TemplatesApi protected () extends StObject {
  ...
  def createTemplate(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[TemplateSummary] = js.native
  ...
  def listTemplates(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[EnvelopeTemplateResults] = js.native
