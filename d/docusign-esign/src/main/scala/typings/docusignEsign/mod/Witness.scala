...
@js.native
trait Witness extends js.Object {
  ...
  /**
    ...
    */
  var witnessFor: js.UndefOr[String] = js.native
  
  /**
    * The GUID of the person or party for whom the recipient is a witness.
    */
  var witnessForGuid: js.UndefOr[String] = js.native
}
object Witness {
  ...
  @scala.inline
  implicit class WitnessOps[Self <: Witness] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWitnessFor(value: String): Self = this.set("witnessFor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteWitnessFor: Self = this.set("witnessFor", js.undefined)
    
    @scala.inline
    def setWitnessForGuid(value: String): Self = this.set("witnessForGuid", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteWitnessForGuid: Self = this.set("witnessForGuid", js.undefined)
  }
}
