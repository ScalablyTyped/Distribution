...
@js.native
trait AccountIdentityVerificationStep extends js.Object {
...
object AccountIdentityVerificationStep {
  ...
  @scala.inline
  implicit class AccountIdentityVerificationStepOps[Self <: AccountIdentityVerificationStep] (val x: Self) extends AnyVal {
