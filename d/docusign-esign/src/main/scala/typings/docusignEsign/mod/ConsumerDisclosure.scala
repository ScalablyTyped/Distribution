...
@js.native
trait ConsumerDisclosure extends js.Object {
...
object ConsumerDisclosure {
  ...
  @scala.inline
  def apply(): ConsumerDisclosure = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ConsumerDisclosure]
  }
  
  @scala.inline
  implicit class ConsumerDisclosureOps[Self <: ConsumerDisclosure] (val x: Self) extends AnyVal {
