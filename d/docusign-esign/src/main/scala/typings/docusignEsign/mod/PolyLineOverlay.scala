...
trait PolyLineOverlay extends StObject {
  ...
  /**
    ...
    */
  var graphicsContext: js.UndefOr[GraphicsContext] = js.undefined
  ...
  /**
    ...
    */
  var polyLines: js.UndefOr[js.Array[PolyLine]] = js.undefined
...
object PolyLineOverlay {
  ...
  inline def apply(): PolyLineOverlay = {
  ...
  implicit open class MutableBuilder[Self <: PolyLineOverlay] (val x: Self) extends AnyVal {
    ...
    inline def setGraphicsContext(value: GraphicsContext): Self = StObject.set(x, "graphicsContext", value.asInstanceOf[js.Any])
    
    inline def setGraphicsContextUndefined: Self = StObject.set(x, "graphicsContext", js.undefined)
