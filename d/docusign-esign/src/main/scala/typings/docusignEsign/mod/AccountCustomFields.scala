...
@js.native
trait AccountCustomFields extends js.Object {
...
object AccountCustomFields {
  ...
  @scala.inline
  def apply(): AccountCustomFields = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AccountCustomFields]
  }
  
  @scala.inline
  implicit class AccountCustomFieldsOps[Self <: AccountCustomFields] (val x: Self) extends AnyVal {
