...
@js.native
trait CertifiedDelivery extends js.Object {
...
object CertifiedDelivery {
  ...
  @scala.inline
  def apply(): CertifiedDelivery = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CertifiedDelivery]
  }
  
  @scala.inline
  implicit class CertifiedDeliveryOps[Self <: CertifiedDelivery] (val x: Self) extends AnyVal {
