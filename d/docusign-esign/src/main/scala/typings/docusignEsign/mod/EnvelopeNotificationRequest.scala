...
@js.native
trait EnvelopeNotificationRequest extends js.Object {
...
object EnvelopeNotificationRequest {
  ...
  @scala.inline
  implicit class EnvelopeNotificationRequestOps[Self <: EnvelopeNotificationRequest] (val x: Self) extends AnyVal {
