...
open class NotaryApi () extends StObject {
  ...
  def createNotaryJurisdictions(
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[NotaryJurisdiction] = js.native
  ...
  def getNotary(
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[NotaryResult] = js.native
  ...
  def getNotaryJurisdictions(callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]): js.Promise[NotaryJurisdictionList] = js.native
  ...
  def listNotaryJournals(
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[NotaryJournalList] = js.native
