...
@js.native
trait FormulaTab extends js.Object {
...
object FormulaTab {
  ...
  @scala.inline
  implicit class FormulaTabOps[Self <: FormulaTab] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHiddenMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("hiddenMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHiddenMetadata: Self = this.set("hiddenMetadata", js.undefined)
    ...
    @scala.inline
    def setPaymentDetails(value: PaymentDetails): Self = this.set("paymentDetails", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePaymentDetails: Self = this.set("paymentDetails", js.undefined)
    ...
    @scala.inline
    def setRoundDecimalPlaces(value: String): Self = this.set("roundDecimalPlaces", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRoundDecimalPlaces: Self = this.set("roundDecimalPlaces", js.undefined)
    
    @scala.inline
    def setRoundDecimalPlacesMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("roundDecimalPlacesMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRoundDecimalPlacesMetadata: Self = this.set("roundDecimalPlacesMetadata", js.undefined)
