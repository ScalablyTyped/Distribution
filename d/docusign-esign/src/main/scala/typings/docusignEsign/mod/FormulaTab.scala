...
trait FormulaTab extends StObject {
  ...
  /**
    ...
    */
  var hiddenMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.native
  ...
  /**
    ...
    *
    */
  var paymentDetails: js.UndefOr[PaymentDetails] = js.native
  ...
  /**
    ...
    */
  var roundDecimalPlaces: js.UndefOr[String] = js.native
  
  /**
    * Metadata that indicates whether the `roundDecimalPlaces` property is editable.
    */
  var roundDecimalPlacesMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.native
