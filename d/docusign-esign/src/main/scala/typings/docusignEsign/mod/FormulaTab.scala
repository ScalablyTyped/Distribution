...
object FormulaTab {
  ...
  extension [Self <: FormulaTab](x: Self) {
    ...
    inline def setHiddenMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "hiddenMetadata", value.asInstanceOf[js.Any])
    
    inline def setHiddenMetadataUndefined: Self = StObject.set(x, "hiddenMetadata", js.undefined)
    ...
    inline def setPaymentDetails(value: PaymentDetails): Self = StObject.set(x, "paymentDetails", value.asInstanceOf[js.Any])
    
    inline def setPaymentDetailsUndefined: Self = StObject.set(x, "paymentDetails", js.undefined)
    ...
    inline def setRoundDecimalPlaces(value: String): Self = StObject.set(x, "roundDecimalPlaces", value.asInstanceOf[js.Any])
    
    inline def setRoundDecimalPlacesMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "roundDecimalPlacesMetadata", value.asInstanceOf[js.Any])
    
    inline def setRoundDecimalPlacesMetadataUndefined: Self = StObject.set(x, "roundDecimalPlacesMetadata", js.undefined)
    
    inline def setRoundDecimalPlacesUndefined: Self = StObject.set(x, "roundDecimalPlaces", js.undefined)
