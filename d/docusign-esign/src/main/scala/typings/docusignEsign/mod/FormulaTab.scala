...
trait FormulaTab extends StObject {
  ...
  /**
    ...
    */
  var hiddenMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.undefined
  ...
  /**
    ...
    *
    */
  var paymentDetails: js.UndefOr[PaymentDetails] = js.undefined
  ...
  /**
    ...
    */
  var roundDecimalPlaces: js.UndefOr[String] = js.undefined
  
  /**
    * Metadata that indicates whether the `roundDecimalPlaces` property is editable.
    */
  var roundDecimalPlacesMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.undefined
...
object FormulaTab {
  ...
  @scala.inline
  def apply(): FormulaTab = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FormulaTab]
  }
  
  @scala.inline
  implicit class FormulaTabMutableBuilder[Self <: FormulaTab] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHiddenMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "hiddenMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHiddenMetadataUndefined: Self = StObject.set(x, "hiddenMetadata", js.undefined)
    ...
    @scala.inline
    def setPaymentDetails(value: PaymentDetails): Self = StObject.set(x, "paymentDetails", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPaymentDetailsUndefined: Self = StObject.set(x, "paymentDetails", js.undefined)
    ...
    @scala.inline
    def setRoundDecimalPlaces(value: String): Self = StObject.set(x, "roundDecimalPlaces", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRoundDecimalPlacesMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "roundDecimalPlacesMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRoundDecimalPlacesMetadataUndefined: Self = StObject.set(x, "roundDecimalPlacesMetadata", js.undefined)
    
    @scala.inline
    def setRoundDecimalPlacesUndefined: Self = StObject.set(x, "roundDecimalPlaces", js.undefined)
