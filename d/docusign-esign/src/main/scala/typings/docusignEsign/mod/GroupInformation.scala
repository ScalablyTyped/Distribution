...
trait GroupInformation extends js.Object {
  ...
  /**
    ...
    */
  var groups: js.UndefOr[js.Array[/* This object contains information about a group. */ Group]] = js.native
...
object GroupInformation {
  ...
  @scala.inline
  implicit class GroupInformationOps[Self <: GroupInformation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroupsVarargs(value: (/* This object contains information about a group. */ Group)*): Self = this.set("groups", js.Array(value :_*))
    
    @scala.inline
    def setGroups(value: js.Array[/* This object contains information about a group. */ Group]): Self = this.set("groups", value.asInstanceOf[js.Any])
