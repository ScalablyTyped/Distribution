...
trait GroupInformation extends StObject {
  ...
  /**
    ...
    */
  var groups: js.UndefOr[js.Array[/* This object contains information about a group. */ Group]] = js.undefined
...
object GroupInformation {
  ...
  implicit class GroupInformationMutableBuilder[Self <: GroupInformation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroups(value: js.Array[/* This object contains information about a group. */ Group]): Self = StObject.set(x, "groups", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGroupsUndefined: Self = StObject.set(x, "groups", js.undefined)
    
    @scala.inline
    def setGroupsVarargs(value: (/* This object contains information about a group. */ Group)*): Self = StObject.set(x, "groups", js.Array(value :_*))
