...
trait List extends StObject {
  ...
  /**
    ...
    */
  var listSelectedValueMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.undefined
...
object List {
  ...
  extension [Self <: typings.docusignEsign.mod.List](x: Self) {
    ...
    inline def setListItems(value: js.Array[ListItem]): Self = StObject.set(x, "listItems", value.asInstanceOf[js.Any])
    ...
    inline def setListSelectedValueMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "listSelectedValueMetadata", value.asInstanceOf[js.Any])
    
    inline def setListSelectedValueMetadataUndefined: Self = StObject.set(x, "listSelectedValueMetadata", js.undefined)
