...
@js.native
class BillingApi protected () extends js.Object {
  ...
  def getPlan(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[AccountBillingPlanResponse] = js.native
  ...
  def listInvoices(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[BillingInvoicesResponse] = js.native
  ...
  def listPayments(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[BillingPaymentsResponse] = js.native
  ...
  def makePayment(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[BillingPaymentResponse] = js.native
  ...
  def purchaseEnvelopes(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[Unit] = js.native
  ...
  def updateDowngradeAccountBillingPlan(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[DowngradePlanUpdateResponse] = js.native
  ...
  def updatePlan(accountId: String, optsOrCallback: js.UndefOr[scala.Nothing], callback: js.Function0[Unit]): js.Promise[BillingPlanUpdateResponse] = js.native
