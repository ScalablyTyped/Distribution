...
open class BillingApi () extends StObject {
  ...
  ): js.Promise[BillingPlanResponse] = js.native
  ...
  def getCreditCardInfo(
    accountId: String,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[CreditCardInformation] = js.native
  ...
  def getDowngradeRequestBillingInfo(
    accountId: String,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[DowngradRequestBillingInfoResponse] = js.native
  ...
  def getInvoice(
    ...
    invoiceId: String,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[BillingInvoice] = js.native
  ...
  def getPayment(
    ...
    paymentId: String,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[BillingPaymentItem] = js.native
  ...
  def getPlan(
    ...
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[AccountBillingPlanResponse] = js.native
  ...
  def listBillingPlans(callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]): js.Promise[BillingPlansResponse] = js.native
  ...
  def listInvoices(
    ...
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[BillingInvoicesResponse] = js.native
  ...
  def listInvoicesPastDue(
    accountId: String,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[BillingInvoicesSummary] = js.native
  ...
  def listPayments(
    ...
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[BillingPaymentsResponse] = js.native
  ...
  def makePayment(
    ...
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[BillingPaymentResponse] = js.native
  ...
  def updateDowngradeAccountBillingPlan(
    accountId: String,
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[DowngradePlanUpdateResponse] = js.native
  ...
  def updatePlan(
    ...
    optsOrCallback: Any,
    callback: js.Function3[/* error */ Any, /* data */ Any, /* response */ Any, Unit]
  ): js.Promise[BillingPlanUpdateResponse] = js.native
