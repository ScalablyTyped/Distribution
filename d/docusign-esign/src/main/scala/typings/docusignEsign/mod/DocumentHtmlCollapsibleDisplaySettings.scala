...
@js.native
trait DocumentHtmlCollapsibleDisplaySettings extends js.Object {
...
object DocumentHtmlCollapsibleDisplaySettings {
  ...
  @scala.inline
  implicit class DocumentHtmlCollapsibleDisplaySettingsOps[Self <: DocumentHtmlCollapsibleDisplaySettings] (val x: Self) extends AnyVal {
