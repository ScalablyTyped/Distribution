...
object DocumentHtmlCollapsibleDisplaySettings {
  ...
  @scala.inline
  def apply(): DocumentHtmlCollapsibleDisplaySettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DocumentHtmlCollapsibleDisplaySettings]
  }
  
  @scala.inline
  implicit class DocumentHtmlCollapsibleDisplaySettingsMutableBuilder[Self <: DocumentHtmlCollapsibleDisplaySettings] (val x: Self) extends AnyVal {
