...
@js.native
trait SmartSection extends js.Object {
...
object SmartSection {
  ...
  @scala.inline
  implicit class SmartSectionOps[Self <: SmartSection] (val x: Self) extends AnyVal {
    ...
    ): Self = this.set("displaySettings", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEndPosition(value: SmartSectionAnchorPosition): Self = this.set("endPosition", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOverlayType(value: String): Self = this.set("overlayType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOverlayType: Self = this.set("overlayType", js.undefined)
    
    @scala.inline
    def setOverlayTypeMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = this.set("overlayTypeMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteOverlayTypeMetadata: Self = this.set("overlayTypeMetadata", js.undefined)
    ...
    @scala.inline
    def setStartPosition(value: SmartSectionAnchorPosition): Self = this.set("startPosition", value.asInstanceOf[js.Any])
