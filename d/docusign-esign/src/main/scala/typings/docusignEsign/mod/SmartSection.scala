...
object SmartSection {
  ...
  implicit open class MutableBuilder[Self <: SmartSection] (val x: Self) extends AnyVal {
    ...
    inline def setEndPosition(value: SmartSectionAnchorPosition): Self = StObject.set(x, "endPosition", value.asInstanceOf[js.Any])
    ...
    inline def setOverlayTypeMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "overlayTypeMetadata", value.asInstanceOf[js.Any])
    
    inline def setOverlayTypeMetadataUndefined: Self = StObject.set(x, "overlayTypeMetadata", js.undefined)
    ...
    inline def setStartPosition(value: SmartSectionAnchorPosition): Self = StObject.set(x, "startPosition", value.asInstanceOf[js.Any])
