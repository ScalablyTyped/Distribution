...
@js.native
trait SmartSection extends StObject {
  ...
  /**
    ...
    */
  var displaySettings: js.UndefOr[
  ...
  /**
    ...
    */
  var endPosition: js.UndefOr[SmartSectionAnchorPosition] = js.native
  ...
  /**
    ...
    *
    */
  var overlayType: js.UndefOr[String] = js.native
  
  /**
    * Metadata that indicates whether the `overlayType` property is editable.
    */
  var overlayTypeMetadata: js.UndefOr[/* Metadata about a property. */ PropertyMetadata] = js.native
  ...
  /**
    ...
    */
  var startPosition: js.UndefOr[SmartSectionAnchorPosition] = js.native
...
object SmartSection {
  ...
  @scala.inline
  def apply(): SmartSection = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SmartSection]
  }
  
  @scala.inline
  implicit class SmartSectionMutableBuilder[Self <: SmartSection] (val x: Self) extends AnyVal {
    ...
    def setDisplaySettings(
      value: /* These properties define how a Smart Section displays. A Smart Section is a type of display section. */ SmartSectionDisplaySettings
    ): Self = StObject.set(x, "displaySettings", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setEndPosition(value: SmartSectionAnchorPosition): Self = StObject.set(x, "endPosition", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOverlayType(value: String): Self = StObject.set(x, "overlayType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOverlayTypeMetadata(value: /* Metadata about a property. */ PropertyMetadata): Self = StObject.set(x, "overlayTypeMetadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOverlayTypeMetadataUndefined: Self = StObject.set(x, "overlayTypeMetadata", js.undefined)
    
    @scala.inline
    def setOverlayTypeUndefined: Self = StObject.set(x, "overlayType", js.undefined)
    ...
    @scala.inline
    def setStartPosition(value: SmartSectionAnchorPosition): Self = StObject.set(x, "startPosition", value.asInstanceOf[js.Any])
