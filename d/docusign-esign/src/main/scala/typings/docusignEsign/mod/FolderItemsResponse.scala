...
@js.native
trait FolderItemsResponse extends js.Object {
...
object FolderItemsResponse {
  ...
  @scala.inline
  def apply(): FolderItemsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FolderItemsResponse]
  }
  
  @scala.inline
  implicit class FolderItemsResponseOps[Self <: FolderItemsResponse] (val x: Self) extends AnyVal {
