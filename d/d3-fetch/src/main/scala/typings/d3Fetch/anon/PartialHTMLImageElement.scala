...
trait PartialHTMLImageElement extends js.Object {
  ...
  var crossOrigin: js.UndefOr[String | Null] = js.native
  
  var currentSrc: js.UndefOr[String] = js.native
  
  var dataset: js.UndefOr[DOMStringMap] = js.native
  
  var decode: js.UndefOr[js.Function0[js.Promise[Unit]]] = js.native
  
  var decoding: js.UndefOr[async | sync | auto] = js.native
  ...
  var hspace: js.UndefOr[Double] = js.native
  ...
  var isMap: js.UndefOr[Boolean] = js.native
  ...
  var longDesc: js.UndefOr[String] = js.native
  ...
  var lowsrc: js.UndefOr[String] = js.native
  ...
  var naturalHeight: js.UndefOr[Double] = js.native
  
  var naturalWidth: js.UndefOr[Double] = js.native
  ...
  var vspace: js.UndefOr[Double] = js.native
...
object PartialHTMLImageElement {
  ...
  implicit class PartialHTMLImageElementOps[Self <: PartialHTMLImageElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PartialHTMLImageElement, /* ev */ ProgressEvent[EventTarget], _]): Self = this.set("onprogress", value.asInstanceOf[js.Any])
