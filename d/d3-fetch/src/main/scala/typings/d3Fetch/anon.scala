...
object anon {
  ...
  object PartialHTMLImageElement {
    ...
    implicit class PartialHTMLImageElementMutableBuilder[Self <: PartialHTMLImageElement] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnprogress(value: js.ThisFunction1[PartialHTMLImageElement, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
