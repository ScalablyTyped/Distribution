...
@js.native
object d3DashBrushMod extends js.Object {
  @js.native
  trait BrushBehavior[Datum] extends js.Object {
    /**
      ...
      */
    def apply(group: Selection[SVGGElement, Datum, _, _], args: js.Any*): Unit = js.native
    /**
    ...
    /**
      ...
      */
    def move(group: Selection[SVGGElement, Datum, _, _]): Unit = js.native
    /**
      ...
      */
    def move(group: Selection[SVGGElement, Datum, _, _], selection: BrushSelection): Unit = js.native
    /**
      * Sets the active selection of the brush on the specified SVG G element(s) selection
      ...
      * for a y-brush, it must be defined as [y0, y1].
      */
    def move(group: Selection[SVGGElement, Datum, _, _], selection: ValueFn[SVGGElement, Datum, BrushSelection]): Unit = js.native
    /**
      ...
      * for a y-brush, it must be defined as [y0, y1].
      */
    def move(group: TransitionLike[SVGGElement, Datum], selection: BrushSelection): Unit = js.native
    /**
      * Sets the active selection of the brush on the specified SVG G element(s) transition
      ...
      * for a y-brush, it must be defined as [y0, y1].
      */
    def move(group: TransitionLike[SVGGElement, Datum], selection: ValueFn[SVGGElement, Datum, BrushSelection]): Unit = js.native
    /**
  ...
  type BrushSelection = js.Tuple2[Double | (js.Tuple2[Double, Double]), Double | (js.Tuple2[Double, Double])]
}
