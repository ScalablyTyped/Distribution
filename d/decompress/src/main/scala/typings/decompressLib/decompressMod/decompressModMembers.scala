...
object decompressModMembers extends js.Object {
  def apply(input: java.lang.String | nodeLib.Buffer): stdLib.Promise[js.Array[decompressLib.decompressMod.decompressNs.File]] = js.native
  def apply(
    input: java.lang.String | nodeLib.Buffer,
    output: java.lang.String | decompressLib.decompressMod.decompressNs.DecompressOptions
  ): stdLib.Promise[js.Array[decompressLib.decompressMod.decompressNs.File]] = js.native
  def apply(
    input: java.lang.String | nodeLib.Buffer,
    output: java.lang.String | decompressLib.decompressMod.decompressNs.DecompressOptions,
