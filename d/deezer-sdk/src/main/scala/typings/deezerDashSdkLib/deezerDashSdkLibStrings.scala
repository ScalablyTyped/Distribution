...
object deezerDashSdkLibStrings {
  @js.native
  sealed trait DELETE
    extends deezerDashSdkLib.DeezerSdkNs.HttpMethod
  ...
  @js.native
  sealed trait artist
    extends deezerDashSdkLib.DeezerSdkNs.RadioType
  
  @js.native
  sealed trait big
    extends deezerDashSdkLib.DeezerSdkNs.WidgetSize
  
  @js.native
  sealed trait classic
    extends deezerDashSdkLib.DeezerSdkNs.WidgetFormat
  
  @js.native
  sealed trait connected
    extends deezerDashSdkLib.DeezerSdkNs.ConnectionStatus
  
  @js.native
  sealed trait current_track
    extends deezerDashSdkLib.DeezerSdkNs.PlayerEvent
  
  @js.native
  sealed trait dark
    extends deezerDashSdkLib.DeezerSdkNs.WidgetLayout
