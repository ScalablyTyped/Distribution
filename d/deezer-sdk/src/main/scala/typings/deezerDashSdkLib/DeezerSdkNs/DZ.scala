...
trait DZ extends js.Object {
  /**
    ...
    */
  val Event: deezerDashSdkLib.DeezerSdkNs.Event = js.native
  /**
  ...
  /**
    ...
    */
  def getLoginStatus(callback: js.Function1[/* loginStatus */ LoginStatus, scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def login(callback: js.Function1[/* response */ LoginResponse, scala.Unit]): scala.Unit = js.native
  /**
  ...
  def logout(callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  def ready(callback: js.Function1[/* sdkOptions */ SdkOptions, scala.Unit]): scala.Unit = js.native
}
