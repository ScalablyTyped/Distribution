...
trait PlayerOptions extends js.Object {
  ...
  /**
    ...
    */
  val container: js.UndefOr[java.lang.String] = js.undefined
  /**
  ...
  /**
    ...
    * See: {@link https://developers.deezer.com/sdk/javascript/player#options | Player options}
    */
  var onload: js.UndefOr[js.Function1[/* state */ PlayerState, scala.Unit]] = js.undefined
  /**
    ...
    * See: {@link https://developers.deezer.com/sdk/javascript/player#options | Player options}
    */
  val playlist: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object PlayerOptions {
  ...
  def apply(
    ...
    onload: /* state */ PlayerState => scala.Unit = null,
    playlist: js.UndefOr[scala.Boolean] = js.undefined,
