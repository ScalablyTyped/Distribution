...
import typings.handlebarsPfdZsGKG.hbs.AST.Expression
...
object Handlebars {
  ...
  trait HelperOptions extends StObject {
    ...
    def fn(context: Any, options: typings.handlebarsPfdZsGKG.Handlebars.RuntimeOptions): String
    @JSName("fn")
    ...
    def inverse(context: Any, options: typings.handlebarsPfdZsGKG.Handlebars.RuntimeOptions): String
    @JSName("inverse")
  ...
  object HelperOptions {
    ...
    inline def apply(
      fn: (Any, /* options */ js.UndefOr[typings.handlebarsPfdZsGKG.Handlebars.RuntimeOptions]) => String,
      hash: Any,
      inverse: (Any, /* options */ js.UndefOr[typings.handlebarsPfdZsGKG.Handlebars.RuntimeOptions]) => String
    ): HelperOptions = {
  ...
  trait ICompiler extends StObject {
    ...
    def BlockStatement(block: typings.handlebarsPfdZsGKG.hbs.AST.BlockStatement): Unit = js.native
    
    def BooleanLiteral(bool: typings.handlebarsPfdZsGKG.hbs.AST.BooleanLiteral): Unit = js.native
    
    def CommentStatement(): Unit = js.native
    def CommentStatement(comment: typings.handlebarsPfdZsGKG.hbs.AST.CommentStatement): Unit = js.native
    
    def ContentStatement(content: typings.handlebarsPfdZsGKG.hbs.AST.ContentStatement): Unit = js.native
    
    def Decorator(decorator: typings.handlebarsPfdZsGKG.hbs.AST.Decorator): Unit = js.native
    
    def DecoratorBlock(decorator: typings.handlebarsPfdZsGKG.hbs.AST.DecoratorBlock): Unit = js.native
    
    def Hash(hash: typings.handlebarsPfdZsGKG.hbs.AST.Hash): Unit = js.native
    
    def MustacheStatement(mustache: typings.handlebarsPfdZsGKG.hbs.AST.MustacheStatement): Unit = js.native
    
    def NullLiteral(): Unit = js.native
    
    def NumberLiteral(num: typings.handlebarsPfdZsGKG.hbs.AST.NumberLiteral): Unit = js.native
    
    def PartialBlockStatement(partial: typings.handlebarsPfdZsGKG.hbs.AST.PartialBlockStatement): Unit = js.native
    
    def PartialStatement(partial: typings.handlebarsPfdZsGKG.hbs.AST.PartialStatement): Unit = js.native
    
    def PathExpression(path: typings.handlebarsPfdZsGKG.hbs.AST.PathExpression): Unit = js.native
    
    def Program(program: typings.handlebarsPfdZsGKG.hbs.AST.Program): Unit = js.native
    
    def StringLiteral(str: typings.handlebarsPfdZsGKG.hbs.AST.StringLiteral): Unit = js.native
    
    def SubExpression(sexpr: typings.handlebarsPfdZsGKG.hbs.AST.SubExpression): Unit = js.native
  ...
  object RuntimeOptions {
    ...
    inline def apply(): typings.handlebarsPfdZsGKG.Handlebars.RuntimeOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.handlebarsPfdZsGKG.Handlebars.RuntimeOptions]
    }
    
    extension [Self <: typings.handlebarsPfdZsGKG.Handlebars.RuntimeOptions](x: Self) {
  ...
  type TemplateDelegate[T] = js.Function2[
    /* context */ T, 
    /* options */ js.UndefOr[typings.handlebarsPfdZsGKG.Handlebars.RuntimeOptions], 
    String
  ]
