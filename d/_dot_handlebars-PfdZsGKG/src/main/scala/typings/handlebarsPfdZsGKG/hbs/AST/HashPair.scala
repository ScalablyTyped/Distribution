...
trait HashPair
  ...
  @JSName("type")
  var type_HashPair: typings.handlebarsPfdZsGKG.handlebarsPfdZsGKGStrings.HashPair
...
object HashPair {
  ...
  extension [Self <: HashPair](x: Self) {
    ...
    inline def setType(value: typings.handlebarsPfdZsGKG.handlebarsPfdZsGKGStrings.HashPair): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
