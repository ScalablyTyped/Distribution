...
trait StringLiteral
  ...
  @JSName("type")
  var type_StringLiteral: typings.handlebarsPfdZsGKG.handlebarsPfdZsGKGStrings.StringLiteral
...
object StringLiteral {
  ...
  extension [Self <: StringLiteral](x: Self) {
    ...
    inline def setType(value: typings.handlebarsPfdZsGKG.handlebarsPfdZsGKGStrings.StringLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
