...
trait SubExpression
  ...
  @JSName("type")
  var type_SubExpression: typings.handlebarsPfdZsGKG.handlebarsPfdZsGKGStrings.SubExpression
}
object SubExpression {
  ...
  extension [Self <: SubExpression](x: Self) {
    ...
    inline def setType(value: typings.handlebarsPfdZsGKG.handlebarsPfdZsGKGStrings.SubExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
