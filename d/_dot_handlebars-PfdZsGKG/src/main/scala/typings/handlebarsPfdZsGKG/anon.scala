...
import typings.handlebarsPfdZsGKG.hbs.AST.helpers
...
object anon {
  ...
  trait TypeofAST extends StObject {
    ...
    val helpers: typings.handlebarsPfdZsGKG.hbs.AST.helpers
  }
  object TypeofAST {
  ...
  trait TypeofHandlebars extends StObject {
    ...
    var Exception: Instantiable2[
        ...
        typings.handlebarsPfdZsGKG.Handlebars.Exception
      ] = js.native
    
    def K(): Unit = js.native
    
    var SafeString: Instantiable1[/* str */ String, typings.handlebarsPfdZsGKG.Handlebars.SafeString] = js.native
    ...
    var Visitor: Instantiable0[typings.handlebarsPfdZsGKG.Handlebars.Visitor] = js.native
