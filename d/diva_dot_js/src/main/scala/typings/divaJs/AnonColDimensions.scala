...
trait AnonColDimensions extends js.Object {
  var col: Double
...
object AnonColDimensions {
  @scala.inline
  def apply(col: Double, dimensions: Dimensions, offset: Offset, row: Double, url: String, zoomLevel: Double): AnonColDimensions = {
    ...
    __obj.asInstanceOf[AnonColDimensions]
  }
}
