...
import typings.divaDotJs.Anon_Height
import typings.divaDotJs.Anon_IncludePadding
import typings.divaDotJs.Anon_Left
import typings.divaDotJs.Anon_ObjectData
...
import typings.divaDotJs.interfacesMod.State
