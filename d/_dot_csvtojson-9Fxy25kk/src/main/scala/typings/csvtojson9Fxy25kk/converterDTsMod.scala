...
import typings.csvtojson9Fxy25kk.parametersDTsMod.CSVParseParam
import typings.csvtojson9Fxy25kk.parseRuntimeDTsMod.ParseRuntime
...
object converterDTsMod {
  
  @JSImport(".csvtojson-9Fxy25kk/v2/Converter.d.ts", "Converter")
  @js.native
