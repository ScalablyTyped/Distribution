...
object cjsimportprocessorDTsMod {
  
  @JSImport(".sucrase-TbLAtQ5t/dist/types/CJSImportProcessor.d.ts", JSImport.Default)
  @js.native
  open class default protected ()
    ...
    /* private */ /* CompleteClass */
    var getFreeIdentifierForPath: Any = js.native
    ...
    /* CompleteClass */
    override val nameManager: typings.sucraseTbLAtQ5t.nameManagerDTsMod.default = js.native
    ...
    /* CompleteClass */
    override val tokens: typings.sucraseTbLAtQ5t.tokenProcessorDTsMod.default = js.native
  }
  ...
  trait CJSImportProcessor extends StObject {
    ...
    /* private */ var getFreeIdentifierForPath: Any
    ...
    val nameManager: typings.sucraseTbLAtQ5t.nameManagerDTsMod.default
    ...
    val tokens: typings.sucraseTbLAtQ5t.tokenProcessorDTsMod.default
  }
  object CJSImportProcessor {
    ...
    extension [Self <: CJSImportProcessor](x: Self) {
      ...
      inline def setGetFreeIdentifierForPath(value: Any): Self = StObject.set(x, "getFreeIdentifierForPath", value.asInstanceOf[js.Any])
      ...
      inline def setTokens(value: typings.sucraseTbLAtQ5t.tokenProcessorDTsMod.default): Self = StObject.set(x, "tokens", value.asInstanceOf[js.Any])
    }
  }
}
