...
object tokenProcessorDTsMod {
  
  @JSImport(".sucrase-TbLAtQ5t/dist/types/TokenProcessor.d.ts", JSImport.Default)
  @js.native
  open class default protected ()
    ...
    /* CompleteClass */
    override def getResultCodeIndex(): Double = js.native
  ...
  object TokenProcessor {
    ...
    extension [Self <: TokenProcessor](x: Self) {
      ...
      inline def setGetResultCodeIndex(value: () => Double): Self = StObject.set(x, "getResultCodeIndex", js.Any.fromFunction0(value))
