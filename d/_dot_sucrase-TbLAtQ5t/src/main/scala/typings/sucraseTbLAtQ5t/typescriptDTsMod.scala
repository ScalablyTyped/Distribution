...
object typescriptDTsMod {
  
  @JSImport(".sucrase-TbLAtQ5t/dist/types/parser/plugins/typescript.d.ts", JSImport.Namespace)
  @js.native
  ...
  inline def tsStartParseNewArguments(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("tsStartParseNewArguments")().asInstanceOf[Unit]
