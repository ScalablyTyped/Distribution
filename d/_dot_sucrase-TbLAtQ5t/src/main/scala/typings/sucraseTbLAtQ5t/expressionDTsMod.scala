...
object expressionDTsMod {
  
  @JSImport(".sucrase-TbLAtQ5t/dist/types/parser/traverser/expression.d.ts", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport(".sucrase-TbLAtQ5t/dist/types/parser/traverser/expression.d.ts", "StopState")
  @js.native
