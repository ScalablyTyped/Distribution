...
object cjsimporttransformerDTsMod {
  
  @JSImport(".sucrase-TbLAtQ5t/dist/types/transformers/CJSImportTransformer.d.ts", JSImport.Default)
  @js.native
  ...
  trait CJSImportTransformer
    ...
    val importProcessor: typings.sucraseTbLAtQ5t.cjsimportprocessorDTsMod.default = js.native
