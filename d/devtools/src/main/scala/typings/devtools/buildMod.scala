...
object buildMod {
  ...
  object default {
    ...
    @scala.inline
    def attachToSession(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("attachToSession")().asInstanceOf[Unit]
    
    @scala.inline
    def newSession(): js.Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("newSession")().asInstanceOf[js.Promise[js.Any]]
    @scala.inline
    def newSession(
    ...
    @scala.inline
    def newSession(options: Unit, modifier: js.Function): js.Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("newSession")(options.asInstanceOf[js.Any], modifier.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Any]]
    @scala.inline
    def newSession(options: Unit, modifier: js.Function, userPrototype: js.Object): js.Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("newSession")(options.asInstanceOf[js.Any], modifier.asInstanceOf[js.Any], userPrototype.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Any]]
    @scala.inline
    ...
    @scala.inline
    def newSession(options: Unit, modifier: Unit, userPrototype: js.Object): js.Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("newSession")(options.asInstanceOf[js.Any], modifier.asInstanceOf[js.Any], userPrototype.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Any]]
    @scala.inline
