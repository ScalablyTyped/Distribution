...
object Message {
  ...
  inline def apply(message: String, puppeteerVersion: js.Any, ready: Boolean): Message = {
  ...
  extension [Self <: Message](x: Self) {
    ...
    inline def setPuppeteerVersion(value: js.Any): Self = StObject.set(x, "puppeteerVersion", value.asInstanceOf[js.Any])
