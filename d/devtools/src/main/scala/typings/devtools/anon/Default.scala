...
trait Default extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[/* option */ js.UndefOr[Record[String, WebDriverLogTypes]], Unit]] = js.undefined
}
object Default {
  ...
  implicit open class MutableBuilder[Self <: Default] (val x: Self) extends AnyVal {
    ...
    inline def setValidate(value: /* option */ js.UndefOr[Record[String, WebDriverLogTypes]] => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
