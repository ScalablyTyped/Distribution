...
import typings.devtools.buildTypesMod.ActiveListener
import typings.puppeteerCore.libCjsPuppeteerCommonDialogMod.Dialog
...
object buildDevtoolsdriverMod {
  ...
  trait DevToolsDriver extends StObject {
    ...
    var elementStore: typings.devtools.buildElementstoreMod.default = js.native
