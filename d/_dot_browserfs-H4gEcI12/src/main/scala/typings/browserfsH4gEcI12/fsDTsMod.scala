...
import typings.browserfsH4gEcI12.anon.AutoClose
import typings.browserfsH4gEcI12.anon.Encoding
import typings.browserfsH4gEcI12.anon.EncodingFlag
import typings.browserfsH4gEcI12.anon.Fd
import typings.browserfsH4gEcI12.anon.Flag
import typings.browserfsH4gEcI12.anon.Interval
import typings.browserfsH4gEcI12.anon.Mode
import typings.browserfsH4gEcI12.anon.Persistent
import typings.browserfsH4gEcI12.anon.TypeofFS
import typings.browserfsH4gEcI12.anon.TypeofStats
...
object fsDTsMod {
  ...
  @JSImport(".browserfs-H4gEcI12/dist/node/core/FS.d.ts", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
       with FS
  ...
  object default {
    ...
    @JSImport(".browserfs-H4gEcI12/dist/node/core/FS.d.ts", "default.Stats")
    @js.native
  ...
  trait FS extends StObject {
    ...
    def fstat(fd: Double, cb: BFSCallback[typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default]): Unit = js.native
    ...
    /**
      ...
      */
    def fstatSync(fd: Double): typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default = js.native
    ...
    def lstat(path: String, cb: BFSCallback[typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default]): Unit = js.native
    ...
    /**
      ...
      * @return [BrowserFS.node.fs.Stats]
      */
    def lstatSync(path: String): typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default = js.native
    ...
    def stat(path: String, cb: BFSCallback[typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default]): Unit = js.native
    ...
    /**
      ...
      * @return [BrowserFS.node.fs.Stats]
      */
    def statSync(path: String): typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default = js.native
    ...
    def unwatchFile(
      ...
      listener: js.Function2[
          /* curr */ typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default, 
          /* prev */ typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default, 
          Unit
        ]
    ): Unit = js.native
