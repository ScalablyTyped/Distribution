...
object html5fsDTsMod {
  
  @JSImport(".browserfs-H4gEcI12/dist/node/backend/HTML5FS.d.ts", JSImport.Default)
  @js.native
  /**
  ...
  object default {
    ...
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/HTML5FS.d.ts", "default.Name")
    @js.native
    val Name: String = js.native
    
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/HTML5FS.d.ts", "default.Options")
    @js.native
  ...
  @JSImport(".browserfs-H4gEcI12/dist/node/backend/HTML5FS.d.ts", "HTML5FSFile")
  @js.native
  open class HTML5FSFile protected ()
    extends typings.browserfsH4gEcI12.preloadFileDTsMod.default[HTML5FS]
       with File {
    def this(
      fs: HTML5FS,
      entry: FileEntry,
      path: String,
      flag: FileFlag,
      stat: typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default
    ) = this()
    def this(
      fs: HTML5FS,
      entry: FileEntry,
