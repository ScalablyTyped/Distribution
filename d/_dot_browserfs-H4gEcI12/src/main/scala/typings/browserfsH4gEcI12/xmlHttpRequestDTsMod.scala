...
object xmlHttpRequestDTsMod {
  
  @JSImport(".browserfs-H4gEcI12/dist/node/backend/XmlHttpRequest.d.ts", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/XmlHttpRequest.d.ts", "default.Name")
    @js.native
    val Name: String = js.native
    
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/XmlHttpRequest.d.ts", "default.Options")
    @js.native
