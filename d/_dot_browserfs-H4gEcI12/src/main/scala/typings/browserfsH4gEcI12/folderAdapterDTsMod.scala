...
object folderAdapterDTsMod {
  
  @JSImport(".browserfs-H4gEcI12/dist/node/backend/FolderAdapter.d.ts", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/FolderAdapter.d.ts", "default.Name")
    @js.native
    val Name: String = js.native
    
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/FolderAdapter.d.ts", "default.Options")
    @js.native
