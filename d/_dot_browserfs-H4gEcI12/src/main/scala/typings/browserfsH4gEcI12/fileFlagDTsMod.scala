...
object fileFlagDTsMod {
  
  @js.native
  sealed trait ActionType extends StObject
  @JSImport(".browserfs-H4gEcI12/dist/node/core/file_flag.d.ts", "ActionType")
  @js.native
  object ActionType extends StObject {
    ...
    sealed trait CREATE_FILE
      extends StObject
         with ActionType
    /* 3 */ val CREATE_FILE: typings.browserfsH4gEcI12.fileFlagDTsMod.ActionType.CREATE_FILE & Double = js.native
    
    @js.native
    sealed trait NOP
      extends StObject
         with ActionType
    /* 0 */ val NOP: typings.browserfsH4gEcI12.fileFlagDTsMod.ActionType.NOP & Double = js.native
    
    @js.native
    sealed trait THROW_EXCEPTION
      extends StObject
         with ActionType
    /* 1 */ val THROW_EXCEPTION: typings.browserfsH4gEcI12.fileFlagDTsMod.ActionType.THROW_EXCEPTION & Double = js.native
    
    @js.native
    sealed trait TRUNCATE_FILE
      extends StObject
         with ActionType
    /* 2 */ val TRUNCATE_FILE: typings.browserfsH4gEcI12.fileFlagDTsMod.ActionType.TRUNCATE_FILE & Double = js.native
  }
  
  @JSImport(".browserfs-H4gEcI12/dist/node/core/file_flag.d.ts", "FileFlag")
  @js.native
  ...
  object FileFlag {
    ...
    @JSImport(".browserfs-H4gEcI12/dist/node/core/file_flag.d.ts", "FileFlag.flagCache")
    @js.native
    ...
    @JSImport(".browserfs-H4gEcI12/dist/node/core/file_flag.d.ts", "FileFlag.validFlagStrs")
    @js.native
