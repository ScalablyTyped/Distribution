...
object nodeFsStatsDTsMod {
  
  @JSImport(".browserfs-H4gEcI12/dist/node/core/node_fs_stats.d.ts", JSImport.Default)
  @js.native
  ...
  @JSImport(".browserfs-H4gEcI12/dist/node/core/node_fs_stats.d.ts", "FileType")
  @js.native
  object FileType extends StObject {
    ...
    sealed trait DIRECTORY
      extends StObject
         with FileType
    /* 16384 */ val DIRECTORY: typings.browserfsH4gEcI12.nodeFsStatsDTsMod.FileType.DIRECTORY & Double = js.native
    
    @js.native
    sealed trait FILE
      extends StObject
         with FileType
    /* 32768 */ val FILE: typings.browserfsH4gEcI12.nodeFsStatsDTsMod.FileType.FILE & Double = js.native
    
    @js.native
    sealed trait SYMLINK
      extends StObject
         with FileType
    /* 40960 */ val SYMLINK: typings.browserfsH4gEcI12.nodeFsStatsDTsMod.FileType.SYMLINK & Double = js.native
  }
