...
import typings.browserfsH4gEcI12.anon.Fs
...
object mountableFileSystemDTsMod {
  
  @JSImport(".browserfs-H4gEcI12/dist/node/backend/MountableFileSystem.d.ts", JSImport.Default)
  @js.native
  /**
  ...
  object default {
    ...
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/MountableFileSystem.d.ts", "default.Name")
    @js.native
    val Name: String = js.native
    
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/MountableFileSystem.d.ts", "default.Options")
    @js.native
