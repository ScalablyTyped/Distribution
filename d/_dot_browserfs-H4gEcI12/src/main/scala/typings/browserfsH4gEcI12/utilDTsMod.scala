...
object utilDTsMod {
  ...
  @JSImport(".browserfs-H4gEcI12/dist/node/core/util.d.ts", JSImport.Namespace)
  @js.native
  ...
  @JSImport(".browserfs-H4gEcI12/dist/node/core/util.d.ts", "isIE")
  @js.native
  val isIE: Boolean = js.native
  
  @JSImport(".browserfs-H4gEcI12/dist/node/core/util.d.ts", "isWebWorker")
  @js.native
