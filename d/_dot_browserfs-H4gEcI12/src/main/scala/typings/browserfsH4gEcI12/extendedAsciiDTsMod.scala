...
object extendedAsciiDTsMod {
  
  @JSImport(".browserfs-H4gEcI12/dist/node/generic/extended_ascii.d.ts", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
       with ExtendedASCII
  ...
  object default {
    ...
    @JSImport(".browserfs-H4gEcI12/dist/node/generic/extended_ascii.d.ts", "default.extendedChars")
    @js.native
