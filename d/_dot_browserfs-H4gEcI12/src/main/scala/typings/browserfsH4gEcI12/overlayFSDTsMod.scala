...
import typings.browserfsH4gEcI12.anon.Readable
...
object overlayFSDTsMod {
  
  @JSImport(".browserfs-H4gEcI12/dist/node/backend/OverlayFS.d.ts", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/OverlayFS.d.ts", "default.Name")
    @js.native
    val Name: String = js.native
    
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/OverlayFS.d.ts", "default.Options")
    @js.native
  ...
  @JSImport(".browserfs-H4gEcI12/dist/node/backend/OverlayFS.d.ts", "UnlockedOverlayFS")
  @js.native
  open class UnlockedOverlayFS protected ()
    ...
    def _syncAsync(
      file: typings.browserfsH4gEcI12.preloadFileDTsMod.default[UnlockedOverlayFS],
      cb: BFSOneArgCallback
    ): Unit = js.native
    
    def _syncSync(file: typings.browserfsH4gEcI12.preloadFileDTsMod.default[UnlockedOverlayFS]): Unit = js.native
    ...
    def mkdir(p: String, mode: Double, cb: BFSCallback[typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default]): Unit = js.native
    /* InferMemberOverrides */
  ...
  @js.native
  trait OverlayFS
    extends typings.browserfsH4gEcI12.lockedFsDTsMod.default[UnlockedOverlayFS] {
