...
object preloadFileDTsMod {
  
  @JSImport(".browserfs-H4gEcI12/dist/node/generic/preload_file.d.ts", JSImport.Default)
  @js.native
  open class default[T /* <: FileSystem */] protected () extends PreloadFile[T] {
    /**
      ...
      */
    def this(_fs: T, _path: String, _flag: FileFlag, _stat: typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default) = this()
    def this(
      _fs: T,
      _path: String,
      _flag: FileFlag,
      _stat: typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default,
      contents: Buffer
    ) = this()
  }
  
  @JSImport(".browserfs-H4gEcI12/dist/node/generic/preload_file.d.ts", "NoSyncFile")
  @js.native
  open class NoSyncFile[T /* <: FileSystem */] protected ()
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def stat(cb: BFSCallback[typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default]): Unit = js.native
    
    /**
      * Synchronous `stat`.
      */
    /* InferMemberOverrides */
    override def statSync(): typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default = js.native
  ...
  trait PreloadFile[T /* <: FileSystem */] extends BaseFile {
    ...
    /**
      ...
      */
    def getStats(): typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default = js.native
    ...
    /**
      ...
      * @param [Function(BrowserFS.ApiError, BrowserFS.node.fs.Stats)] cb
      */
    def stat(cb: BFSCallback[typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default]): Unit = js.native
    
    /**
      * Synchronous `stat`.
      */
    def statSync(): typings.browserfsH4gEcI12.nodeFsStatsDTsMod.default = js.native
