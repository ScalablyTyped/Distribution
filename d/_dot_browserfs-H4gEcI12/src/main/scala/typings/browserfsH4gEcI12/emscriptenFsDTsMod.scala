...
import typings.browserfsH4gEcI12.anon.Opts
import typings.browserfsH4gEcI12.anon.`0`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object emscriptenFsDTsMod {
  
  @JSImport(".browserfs-H4gEcI12/dist/node/generic/emscripten_fs.d.ts", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
  ...
  trait BFSEmscriptenFS
    ...
    def getNodeFS(): typings.browserfsH4gEcI12.fsDTsMod.default = js.native
