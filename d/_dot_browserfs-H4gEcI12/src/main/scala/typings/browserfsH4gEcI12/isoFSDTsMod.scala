...
object isoFSDTsMod {
  ...
  @JSImport(".browserfs-H4gEcI12/dist/node/backend/IsoFS.d.ts", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/IsoFS.d.ts", "default.Name")
    @js.native
    val Name: String = js.native
    
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/IsoFS.d.ts", "default.Options")
    @js.native
