...
object dropboxDTsMod {
  
  @JSImport(".browserfs-H4gEcI12/dist/node/backend/Dropbox.d.ts", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/Dropbox.d.ts", "default.Name")
    @js.native
    val Name: String = js.native
    
    @JSImport(".browserfs-H4gEcI12/dist/node/backend/Dropbox.d.ts", "default.Options")
    @js.native
  ...
  @JSImport(".browserfs-H4gEcI12/dist/node/backend/Dropbox.d.ts", "DropboxFile")
  @js.native
  open class DropboxFile protected ()
    extends typings.browserfsH4gEcI12.preloadFileDTsMod.default[DropboxFileSystem]
       with File {
    def this(
  ...
  trait DropboxFileSystem
    ...
    /**
      ...
      */
    def convert(err: ApiError): typings.browserfsH4gEcI12.apiErrorDTsMod.ApiError = js.native
    def convert(err: ApiError, path: String): typings.browserfsH4gEcI12.apiErrorDTsMod.ApiError = js.native
