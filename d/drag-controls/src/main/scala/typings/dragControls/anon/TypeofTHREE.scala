...
import typings.three.mod.AnimationLoader
import typings.three.mod.AnimationObjectGroup
import typings.three.mod.ArcCurve
import typings.three.mod.ArrayCamera
import typings.three.mod.ArrowHelper
...
import typings.three.mod.BoxHelper
import typings.three.mod.BufferAttribute
import typings.three.mod.BufferGeometryLoader
import typings.three.mod.CameraHelper
...
import typings.three.mod.CubeTexture
import typings.three.mod.CubeTextureLoader
...
import typings.three.mod.DirectionalLightShadow
import typings.three.mod.DiscreteInterpolant
import typings.three.mod.EdgesGeometry
import typings.three.mod.EllipseCurve
...
import typings.three.mod.FramebufferTexture
import typings.three.mod.Frustum
import typings.three.mod.GLBufferAttribute
import typings.three.mod.GridHelper
import typings.three.mod.Group
import typings.three.mod.HemisphereLightHelper
import typings.three.mod.HemisphereLightProbe
import typings.three.mod.ImageBitmapLoader
import typings.three.mod.ImageLoader
import typings.three.mod.InstancedBufferAttribute
...
import typings.three.mod.LineCurve
import typings.three.mod.LineCurve3
import typings.three.mod.LineDashedMaterial
import typings.three.mod.LineLoop
import typings.three.mod.LineSegments
import typings.three.mod.LinearInterpolant
import typings.three.mod.Loader
import typings.three.mod.MaterialLoader
import typings.three.mod.Matrix3
import typings.three.mod.Matrix4
import typings.three.mod.Mesh
import typings.three.mod.MeshBasicMaterial
import typings.three.mod.MeshDepthMaterial
import typings.three.mod.MeshDistanceMaterial
import typings.three.mod.MeshLambertMaterial
import typings.three.mod.MeshMatcapMaterial
import typings.three.mod.MeshNormalMaterial
import typings.three.mod.MeshPhongMaterial
import typings.three.mod.MeshPhysicalMaterial
import typings.three.mod.MeshStandardMaterial
import typings.three.mod.MeshToonMaterial
import typings.three.mod.NumberKeyframeTrack
import typings.three.mod.ObjectLoader
...
import typings.three.mod.Points
import typings.three.mod.PointsMaterial
import typings.three.mod.PolarGridHelper
import typings.three.mod.PositionalAudio
import typings.three.mod.PropertyMixer
import typings.three.mod.QuadraticBezierCurve
import typings.three.mod.QuadraticBezierCurve3
import typings.three.mod.QuaternionKeyframeTrack
import typings.three.mod.QuaternionLinearInterpolant
import typings.three.mod.RawShaderMaterial
import typings.three.mod.Ray
import typings.three.mod.Raycaster
import typings.three.mod.RectAreaLight
import typings.three.mod.Scene
import typings.three.mod.ShaderMaterial
import typings.three.mod.ShadowMaterial
import typings.three.mod.Shape
...
import typings.three.mod.SplineCurve
import typings.three.mod.SpotLight
import typings.three.mod.SpotLightHelper
import typings.three.mod.SpotLightShadow
import typings.three.mod.Sprite
import typings.three.mod.SpriteMaterial
...
import typings.three.mod.WebGL1Renderer
import typings.three.mod.WebGL3DRenderTarget
import typings.three.mod.WebGLArrayRenderTarget
import typings.three.mod.WebGLBufferRenderer
import typings.three.mod.WebGLColorBuffer
import typings.three.mod.WebGLCubeUVMaps
import typings.three.mod.WebGLDepthBuffer
import typings.three.mod.WebGLGeometries
...
import typings.three.mod.WebGLRenderLists
import typings.three.mod.WebGLRenderTarget
import typings.three.mod.WebGLShadowMap
import typings.three.mod.WebGLStencilBuffer
import typings.three.mod.WebGLTextures
import typings.three.mod.WebXRController
import typings.three.mod.WebXRManager
...
trait TypeofTHREE extends StObject {
  ...
  var AmbientLightProbe: Instantiable0[typings.three.mod.AmbientLightProbe]
  ...
  var AnimationClip: TypeofAnimationClip
  
  var AnimationLoader: Instantiable0[typings.three.mod.AnimationLoader]
  
  var AnimationMixer: Instantiable1[/* root */ Object3D[Event], typings.three.mod.AnimationMixer]
  
  var AnimationObjectGroup: Instantiable1[/* args (repeated) */ Any, typings.three.mod.AnimationObjectGroup]
  ...
  var ArrayCamera: Instantiable0[typings.three.mod.ArrayCamera]
  ...
  var Audio: Instantiable1[/* listener */ AudioListener, typings.three.mod.Audio[AudioNode]]
  
  var AudioAnalyser: Instantiable1[/* audio */ Audio[AudioNode], typings.three.mod.AudioAnalyser]
  
  val AudioContext: TypeofAudioContext
  
  var AudioListener: Instantiable0[typings.three.mod.AudioListener]
  
  var AudioLoader: Instantiable0[typings.three.mod.AudioLoader]
  ...
  var Box2: Instantiable0[typings.three.mod.Box2]
  
  var Box3: Instantiable0[typings.three.mod.Box3]
  
  var Box3Helper: Instantiable1[/* box */ Box3, typings.three.mod.Box3Helper]
  
  var BoxGeometry: TypeofBoxGeometry
  
  var BoxHelper: Instantiable1[/* object */ Object3D[Event], typings.three.mod.BoxHelper]
  ...
  var Camera: Instantiable0[typings.three.mod.Camera]
  ...
  var CompressedTextureLoader: Instantiable0[typings.three.mod.CompressedTextureLoader]
  
  var ConeGeometry: TypeofConeGeometry
  ...
  var DirectionalLight: Instantiable0[typings.three.mod.DirectionalLight]
  ...
  var EventDispatcher: Instantiable0[typings.three.mod.EventDispatcher[BaseEvent]]
  
  var ExtrudeGeometry: TypeofExtrudeGeometry
  
  var FileLoader: Instantiable0[typings.three.mod.FileLoader]
  
  var Float16BufferAttribute: Instantiable2[
  ...
  var HemisphereLightProbe: Instantiable0[typings.three.mod.HemisphereLightProbe]
  
  var IcosahedronGeometry: TypeofIcosahedronGeometry
  
  var ImageBitmapLoader: Instantiable0[typings.three.mod.ImageBitmapLoader]
  
  var ImageLoader: Instantiable0[typings.three.mod.ImageLoader]
  ...
  var InstancedBufferGeometry: Instantiable0[typings.three.mod.InstancedBufferGeometry]
  ...
  var LOD: Instantiable0[typings.three.mod.LOD]
  
  var LatheGeometry: TypeofLatheGeometry
  ...
  var MaterialLoader: Instantiable0[typings.three.mod.MaterialLoader]
  
  val MathUtils: TypeofMathUtils
  
  var Matrix3: Instantiable0[typings.three.mod.Matrix3]
  ...
  var MeshDepthMaterial: Instantiable0[typings.three.mod.MeshDepthMaterial]
  
  var MeshDistanceMaterial: Instantiable0[typings.three.mod.MeshDistanceMaterial]
  
  var MeshLambertMaterial: Instantiable0[typings.three.mod.MeshLambertMaterial]
  
  var MeshMatcapMaterial: Instantiable0[typings.three.mod.MeshMatcapMaterial]
  
  var MeshNormalMaterial: Instantiable0[typings.three.mod.MeshNormalMaterial]
  
  var MeshPhongMaterial: Instantiable0[typings.three.mod.MeshPhongMaterial]
  
  var MeshPhysicalMaterial: Instantiable0[typings.three.mod.MeshPhysicalMaterial]
  
  var MeshStandardMaterial: Instantiable0[typings.three.mod.MeshStandardMaterial]
  ...
  var Path: Instantiable0[typings.three.mod.Path]
  
  var PerspectiveCamera: Instantiable0[typings.three.mod.PerspectiveCamera]
  
  var Plane: Instantiable0[typings.three.mod.Plane]
  
  var PlaneGeometry: TypeofPlaneGeometry
  
  var PlaneHelper: Instantiable1[/* plane */ Plane, typings.three.mod.PlaneHelper]
  
  var PointLight: Instantiable0[typings.three.mod.PointLight]
  ...
  var PolyhedronGeometry: TypeofPolyhedronGeometry
  ...
  var Ray: Instantiable0[typings.three.mod.Ray]
  
  var Raycaster: Instantiable0[typings.three.mod.Raycaster]
  ...
  var Scene: Instantiable0[typings.three.mod.Scene]
  
  val ShaderChunk: TypeofShaderChunk
  
  val ShaderLib: TypeofShaderLib
  
  var ShaderMaterial: Instantiable0[typings.three.mod.ShaderMaterial]
  
  var ShadowMaterial: Instantiable0[typings.three.mod.ShadowMaterial]
  
  var Shape: Instantiable0[typings.three.mod.Shape]
  
  var ShapeGeometry: TypeofShapeGeometry
  
  var ShapePath: Instantiable0[typings.three.mod.ShapePath]
  ...
  var Sphere: Instantiable0[typings.three.mod.Sphere]
  
  var SphereGeometry: TypeofSphereGeometry
  
  var Spherical: Instantiable0[typings.three.mod.Spherical]
  
  var SphericalHarmonics3: TypeofSphericalHarmonics3
  
  var SplineCurve: Instantiable0[typings.three.mod.SplineCurve]
  ...
  var TextureLoader: Instantiable0[typings.three.mod.TextureLoader]
  
  var TorusGeometry: TypeofTorusGeometry
  
  var TorusKnotGeometry: TypeofTorusKnotGeometry
  ...
  val UniformsLib: TypeofUniformsLib
  ...
  var Vector3: Instantiable0[typings.three.mod.Vector3]
  
  var Vector4: Instantiable0[typings.three.mod.Vector4]
  ...
  var WebGLClipping: Instantiable1[/* properties */ WebGLProperties, typings.three.mod.WebGLClipping]
  ...
  var WebGLDepthBuffer: Instantiable0[typings.three.mod.WebGLDepthBuffer]
  
  var WebGLExtensions: Instantiable1[/* gl */ WebGLRenderingContext, typings.three.mod.WebGLExtensions]
  ...
  var WebGLInfo: Instantiable1[/* gl */ WebGLRenderingContext, typings.three.mod.WebGLInfo]
  ...
  var WebGLProperties: Instantiable0[typings.three.mod.WebGLProperties]
  
  var WebGLRenderList: Instantiable1[/* properties */ WebGLProperties, typings.three.mod.WebGLRenderList]
  ...
  def WebGLShader(gl: WebGLRenderingContext, `type`: String, string: String): typings.std.WebGLShader
  ...
  var WebGLStencilBuffer: Instantiable0[typings.three.mod.WebGLStencilBuffer]
  ...
  var WebGLUniforms: TypeofWebGLUniforms
  
  def WebGLUniformsGroups(gl: WebGLRenderingContext, info: WebGLInfo, capabilities: WebGLCapabilities, state: WebGLState): Bind
  
  var WebGLUtils: Instantiable3[
    /* gl */ WebGLRenderingContext, 
    /* extensions */ Any, 
    /* capabilities */ Any, 
    typings.three.mod.WebGLUtils
  ]
  
  var WebXRController: Instantiable0[typings.three.mod.WebXRController]
...
object TypeofTHREE {
  ...
  inline def apply(
    ...
    AnimationClip: TypeofAnimationClip,
    AnimationLoader: Instantiable0[AnimationLoader],
    AnimationMixer: Instantiable1[/* root */ Object3D[Event], typings.three.mod.AnimationMixer],
    ...
    Audio: Instantiable1[/* listener */ AudioListener, typings.three.mod.Audio[AudioNode]],
    AudioAnalyser: Instantiable1[/* audio */ Audio[AudioNode], AudioAnalyser],
    AudioContext: TypeofAudioContext,
    ...
    Box3: Instantiable0[typings.three.mod.Box3],
    Box3Helper: Instantiable1[/* box */ Box3, Box3Helper],
    ...
    ConeGeometry: TypeofConeGeometry,
    CubeCamera: Instantiable3[
      /* near */ Double, 
      /* far */ Double, 
      /* renderTarget */ WebGLCubeRenderTarget, 
      CubeCamera
    ...
    IcosahedronGeometry: TypeofIcosahedronGeometry,
    ...
    InterleavedBufferAttribute: Instantiable3[
      /* interleavedBuffer */ InterleavedBuffer, 
      /* itemSize */ Double, 
      /* offset */ Double, 
      InterleavedBufferAttribute
    ],
    Interpolant: Instantiable3[
      /* parameterPositions */ Any, 
      /* sampleValues */ Any, 
      /* sampleSize */ Double, 
      Interpolant
    ...
    MeshLambertMaterial: Instantiable0[MeshLambertMaterial],
    MeshMatcapMaterial: Instantiable0[MeshMatcapMaterial],
    MeshNormalMaterial: Instantiable0[MeshNormalMaterial],
    MeshPhongMaterial: Instantiable0[MeshPhongMaterial],
  ...
  extension [Self <: TypeofTHREE](x: Self) {
    ...
    inline def setAmbientLightProbe(value: Instantiable0[AmbientLightProbe]): Self = StObject.set(x, "AmbientLightProbe", value.asInstanceOf[js.Any])
    
    inline def setAnimationAction(value: Instantiable2[/* mixer */ AnimationMixer, /* clip */ AnimationClip, AnimationAction]): Self = StObject.set(x, "AnimationAction", value.asInstanceOf[js.Any])
    
    inline def setAnimationClip(value: TypeofAnimationClip): Self = StObject.set(x, "AnimationClip", value.asInstanceOf[js.Any])
    
    inline def setAnimationLoader(value: Instantiable0[AnimationLoader]): Self = StObject.set(x, "AnimationLoader", value.asInstanceOf[js.Any])
    
    inline def setAnimationMixer(value: Instantiable1[/* root */ Object3D[Event], typings.three.mod.AnimationMixer]): Self = StObject.set(x, "AnimationMixer", value.asInstanceOf[js.Any])
    
    inline def setAnimationObjectGroup(value: Instantiable1[/* args (repeated) */ Any, AnimationObjectGroup]): Self = StObject.set(x, "AnimationObjectGroup", value.asInstanceOf[js.Any])
    
    inline def setAnimationUtils(value: TypeofAnimationUtils): Self = StObject.set(x, "AnimationUtils", value.asInstanceOf[js.Any])
    ...
    inline def setArrayCamera(value: Instantiable0[ArrayCamera]): Self = StObject.set(x, "ArrayCamera", value.asInstanceOf[js.Any])
    
    inline def setArrowHelper(
      value: Instantiable6[
          /* dir */ js.UndefOr[Vector3], 
          /* origin */ js.UndefOr[Vector3], 
          /* length */ js.UndefOr[Double], 
    ...
    ): Self = StObject.set(x, "ArrowHelper", value.asInstanceOf[js.Any])
    
    inline def setAudio(value: Instantiable1[/* listener */ AudioListener, typings.three.mod.Audio[AudioNode]]): Self = StObject.set(x, "Audio", value.asInstanceOf[js.Any])
    
    inline def setAudioAnalyser(value: Instantiable1[/* audio */ Audio[AudioNode], AudioAnalyser]): Self = StObject.set(x, "AudioAnalyser", value.asInstanceOf[js.Any])
    
    inline def setAudioContext(value: TypeofAudioContext): Self = StObject.set(x, "AudioContext", value.asInstanceOf[js.Any])
    
    inline def setAudioListener(value: Instantiable0[typings.three.mod.AudioListener]): Self = StObject.set(x, "AudioListener", value.asInstanceOf[js.Any])
    
    inline def setAudioLoader(value: Instantiable0[AudioLoader]): Self = StObject.set(x, "AudioLoader", value.asInstanceOf[js.Any])
    ...
    inline def setBox2(value: Instantiable0[Box2]): Self = StObject.set(x, "Box2", value.asInstanceOf[js.Any])
    
    inline def setBox3(value: Instantiable0[typings.three.mod.Box3]): Self = StObject.set(x, "Box3", value.asInstanceOf[js.Any])
    
    inline def setBox3Helper(value: Instantiable1[/* box */ Box3, Box3Helper]): Self = StObject.set(x, "Box3Helper", value.asInstanceOf[js.Any])
    
    inline def setBoxGeometry(value: TypeofBoxGeometry): Self = StObject.set(x, "BoxGeometry", value.asInstanceOf[js.Any])
    
    inline def setBoxHelper(value: Instantiable1[/* object */ Object3D[Event], BoxHelper]): Self = StObject.set(x, "BoxHelper", value.asInstanceOf[js.Any])
    ...
    inline def setCamera(value: Instantiable0[typings.three.mod.Camera]): Self = StObject.set(x, "Camera", value.asInstanceOf[js.Any])
    
    inline def setCameraHelper(value: Instantiable1[/* camera */ Camera, CameraHelper]): Self = StObject.set(x, "CameraHelper", value.asInstanceOf[js.Any])
    ...
    ): Self = StObject.set(x, "CanvasTexture", value.asInstanceOf[js.Any])
    ...
    inline def setCloneUniforms(value: Any => Any): Self = StObject.set(x, "cloneUniforms", js.Any.fromFunction1(value))
    
    inline def setCloneUniformsGroups(value: js.Array[UniformsGroup] => js.Array[UniformsGroup]): Self = StObject.set(x, "cloneUniformsGroups", js.Any.fromFunction1(value))
    
    inline def setColor(value: TypeofColor): Self = StObject.set(x, "Color", value.asInstanceOf[js.Any])
    ...
    inline def setCompressedTextureLoader(value: Instantiable0[CompressedTextureLoader]): Self = StObject.set(x, "CompressedTextureLoader", value.asInstanceOf[js.Any])
    
    inline def setConeGeometry(value: TypeofConeGeometry): Self = StObject.set(x, "ConeGeometry", value.asInstanceOf[js.Any])
    
    inline def setCubeCamera(
      value: Instantiable3[
          /* near */ Double, 
          /* far */ Double, 
          /* renderTarget */ WebGLCubeRenderTarget, 
    ...
    inline def setDirectionalLight(value: Instantiable0[typings.three.mod.DirectionalLight]): Self = StObject.set(x, "DirectionalLight", value.asInstanceOf[js.Any])
    ...
    inline def setEventDispatcher(value: Instantiable0[EventDispatcher[BaseEvent]]): Self = StObject.set(x, "EventDispatcher", value.asInstanceOf[js.Any])
    
    inline def setExtrudeGeometry(value: TypeofExtrudeGeometry): Self = StObject.set(x, "ExtrudeGeometry", value.asInstanceOf[js.Any])
    
    inline def setFileLoader(value: Instantiable0[FileLoader]): Self = StObject.set(x, "FileLoader", value.asInstanceOf[js.Any])
    
    inline def setFloat16BufferAttribute(
    ...
    ): Self = StObject.set(x, "Frustum", value.asInstanceOf[js.Any])
    ...
    inline def setHemisphereLightHelper(value: Instantiable2[/* light */ HemisphereLight, /* size */ Double, HemisphereLightHelper]): Self = StObject.set(x, "HemisphereLightHelper", value.asInstanceOf[js.Any])
    
    inline def setHemisphereLightProbe(value: Instantiable0[HemisphereLightProbe]): Self = StObject.set(x, "HemisphereLightProbe", value.asInstanceOf[js.Any])
    
    inline def setIcosahedronGeometry(value: TypeofIcosahedronGeometry): Self = StObject.set(x, "IcosahedronGeometry", value.asInstanceOf[js.Any])
    
    inline def setImageBitmapLoader(value: Instantiable0[ImageBitmapLoader]): Self = StObject.set(x, "ImageBitmapLoader", value.asInstanceOf[js.Any])
    
    inline def setImageLoader(value: Instantiable0[ImageLoader]): Self = StObject.set(x, "ImageLoader", value.asInstanceOf[js.Any])
    ...
    ): Self = StObject.set(x, "InstancedBufferAttribute", value.asInstanceOf[js.Any])
    
    inline def setInstancedBufferGeometry(value: Instantiable0[InstancedBufferGeometry]): Self = StObject.set(x, "InstancedBufferGeometry", value.asInstanceOf[js.Any])
    
    inline def setInstancedInterleavedBuffer(
      value: Instantiable2[/* array */ ArrayLike[Double], /* stride */ Double, InstancedInterleavedBuffer]
    ): Self = StObject.set(x, "InstancedInterleavedBuffer", value.asInstanceOf[js.Any])
    
    inline def setInstancedMesh(
      value: Instantiable3[
          /* import warning: RewrittenClass.unapply cls was tparam TGeometry */ /* geometry */ Any, 
          /* import warning: RewrittenClass.unapply cls was tparam TMaterial */ /* material */ Any, 
          /* count */ Double, 
    ...
    ): Self = StObject.set(x, "InterleavedBuffer", value.asInstanceOf[js.Any])
    
    inline def setInterleavedBufferAttribute(
      value: Instantiable3[
          /* interleavedBuffer */ InterleavedBuffer, 
          /* itemSize */ Double, 
          /* offset */ Double, 
    ...
    ): Self = StObject.set(x, "InterleavedBufferAttribute", value.asInstanceOf[js.Any])
    
    inline def setInterpolant(
      value: Instantiable3[
          /* parameterPositions */ Any, 
          /* sampleValues */ Any, 
          /* sampleSize */ Double, 
    ...
    inline def setLOD(value: Instantiable0[LOD]): Self = StObject.set(x, "LOD", value.asInstanceOf[js.Any])
    
    inline def setLatheGeometry(value: TypeofLatheGeometry): Self = StObject.set(x, "LatheGeometry", value.asInstanceOf[js.Any])
    ...
    inline def setLoaderUtils(value: LoaderUtils): Self = StObject.set(x, "LoaderUtils", value.asInstanceOf[js.Any])
    ...
    inline def setMaterialLoader(value: Instantiable0[MaterialLoader]): Self = StObject.set(x, "MaterialLoader", value.asInstanceOf[js.Any])
    
    inline def setMathUtils(value: TypeofMathUtils): Self = StObject.set(x, "MathUtils", value.asInstanceOf[js.Any])
    
    inline def setMatrix3(value: Instantiable0[Matrix3]): Self = StObject.set(x, "Matrix3", value.asInstanceOf[js.Any])
    ...
    inline def setMeshDepthMaterial(value: Instantiable0[MeshDepthMaterial]): Self = StObject.set(x, "MeshDepthMaterial", value.asInstanceOf[js.Any])
    
    inline def setMeshDistanceMaterial(value: Instantiable0[MeshDistanceMaterial]): Self = StObject.set(x, "MeshDistanceMaterial", value.asInstanceOf[js.Any])
    
    inline def setMeshLambertMaterial(value: Instantiable0[MeshLambertMaterial]): Self = StObject.set(x, "MeshLambertMaterial", value.asInstanceOf[js.Any])
    
    inline def setMeshMatcapMaterial(value: Instantiable0[MeshMatcapMaterial]): Self = StObject.set(x, "MeshMatcapMaterial", value.asInstanceOf[js.Any])
    
    inline def setMeshNormalMaterial(value: Instantiable0[MeshNormalMaterial]): Self = StObject.set(x, "MeshNormalMaterial", value.asInstanceOf[js.Any])
    
    inline def setMeshPhongMaterial(value: Instantiable0[MeshPhongMaterial]): Self = StObject.set(x, "MeshPhongMaterial", value.asInstanceOf[js.Any])
    
    inline def setMeshPhysicalMaterial(value: Instantiable0[MeshPhysicalMaterial]): Self = StObject.set(x, "MeshPhysicalMaterial", value.asInstanceOf[js.Any])
    
    inline def setMeshStandardMaterial(value: Instantiable0[MeshStandardMaterial]): Self = StObject.set(x, "MeshStandardMaterial", value.asInstanceOf[js.Any])
    ...
    inline def setObject3D(value: TypeofObject3D): Self = StObject.set(x, "Object3D", value.asInstanceOf[js.Any])
    ...
    inline def setPlaneGeometry(value: TypeofPlaneGeometry): Self = StObject.set(x, "PlaneGeometry", value.asInstanceOf[js.Any])
    
    inline def setPlaneHelper(value: Instantiable1[/* plane */ Plane, PlaneHelper]): Self = StObject.set(x, "PlaneHelper", value.asInstanceOf[js.Any])
    
    inline def setPointLight(value: Instantiable0[typings.three.mod.PointLight]): Self = StObject.set(x, "PointLight", value.asInstanceOf[js.Any])
    ...
    ): Self = StObject.set(x, "PolarGridHelper", value.asInstanceOf[js.Any])
    
    inline def setPolyhedronGeometry(value: TypeofPolyhedronGeometry): Self = StObject.set(x, "PolyhedronGeometry", value.asInstanceOf[js.Any])
    ...
    inline def setQuaternionLinearInterpolant(
      value: Instantiable3[
          /* parameterPositions */ Any, 
          /* samplesValues */ Any, 
          /* sampleSize */ Double, 
    ...
    inline def setRay(value: Instantiable0[Ray]): Self = StObject.set(x, "Ray", value.asInstanceOf[js.Any])
    
    inline def setRaycaster(value: Instantiable0[Raycaster]): Self = StObject.set(x, "Raycaster", value.asInstanceOf[js.Any])
    ...
    inline def setScene(value: Instantiable0[Scene]): Self = StObject.set(x, "Scene", value.asInstanceOf[js.Any])
    
    inline def setShaderChunk(value: TypeofShaderChunk): Self = StObject.set(x, "ShaderChunk", value.asInstanceOf[js.Any])
    
    inline def setShaderLib(value: TypeofShaderLib): Self = StObject.set(x, "ShaderLib", value.asInstanceOf[js.Any])
    
    inline def setShaderMaterial(value: Instantiable0[ShaderMaterial]): Self = StObject.set(x, "ShaderMaterial", value.asInstanceOf[js.Any])
    
    inline def setShadowMaterial(value: Instantiable0[ShadowMaterial]): Self = StObject.set(x, "ShadowMaterial", value.asInstanceOf[js.Any])
    
    inline def setShape(value: Instantiable0[Shape]): Self = StObject.set(x, "Shape", value.asInstanceOf[js.Any])
    
    inline def setShapeGeometry(value: TypeofShapeGeometry): Self = StObject.set(x, "ShapeGeometry", value.asInstanceOf[js.Any])
    
    inline def setShapePath(value: Instantiable0[ShapePath]): Self = StObject.set(x, "ShapePath", value.asInstanceOf[js.Any])
    ...
    inline def setSphere(value: Instantiable0[Sphere]): Self = StObject.set(x, "Sphere", value.asInstanceOf[js.Any])
    
    inline def setSphereGeometry(value: TypeofSphereGeometry): Self = StObject.set(x, "SphereGeometry", value.asInstanceOf[js.Any])
    
    inline def setSpherical(value: Instantiable0[Spherical]): Self = StObject.set(x, "Spherical", value.asInstanceOf[js.Any])
    
    inline def setSphericalHarmonics3(value: TypeofSphericalHarmonics3): Self = StObject.set(x, "SphericalHarmonics3", value.asInstanceOf[js.Any])
    
    inline def setSplineCurve(value: Instantiable0[SplineCurve]): Self = StObject.set(x, "SplineCurve", value.asInstanceOf[js.Any])
    
    inline def setSpotLight(
      value: Instantiable6[
          /* color */ js.UndefOr[ColorRepresentation], 
          /* intensity */ js.UndefOr[Double], 
          /* distance */ js.UndefOr[Double], 
    ...
    inline def setTexture(value: TypeofTexture): Self = StObject.set(x, "Texture", value.asInstanceOf[js.Any])
    ...
    inline def setUniformsLib(value: TypeofUniformsLib): Self = StObject.set(x, "UniformsLib", value.asInstanceOf[js.Any])
    ...
    inline def setVector4(value: Instantiable0[Vector4]): Self = StObject.set(x, "Vector4", value.asInstanceOf[js.Any])
    ...
    ): Self = StObject.set(x, "VideoTexture", value.asInstanceOf[js.Any])
    ...
    ): Self = StObject.set(x, "WebGLBufferRenderer", value.asInstanceOf[js.Any])
    
    inline def setWebGLCapabilities(
      value: Instantiable3[
          /* gl */ WebGLRenderingContext, 
          /* extensions */ Any, 
          /* parameters */ WebGLCapabilitiesParameters, 
    ...
    ): Self = StObject.set(x, "WebGLCapabilities", value.asInstanceOf[js.Any])
    
    inline def setWebGLClipping(value: Instantiable1[/* properties */ WebGLProperties, typings.three.mod.WebGLClipping]): Self = StObject.set(x, "WebGLClipping", value.asInstanceOf[js.Any])
    ...
    inline def setWebGLExtensions(value: Instantiable1[/* gl */ WebGLRenderingContext, typings.three.mod.WebGLExtensions]): Self = StObject.set(x, "WebGLExtensions", value.asInstanceOf[js.Any])
    
    inline def setWebGLGeometries(
      value: Instantiable3[
          /* gl */ WebGLRenderingContext, 
          /* attributes */ WebGLAttributes, 
          /* info */ WebGLInfo, 
    ...
    ): Self = StObject.set(x, "WebGLGeometries", value.asInstanceOf[js.Any])
    
    inline def setWebGLIndexedBufferRenderer(
      value: Instantiable4[
          /* gl */ WebGLRenderingContext, 
          /* extensions */ Any, 
          /* info */ Any, 
    ...
    ): Self = StObject.set(x, "WebGLIndexedBufferRenderer", value.asInstanceOf[js.Any])
    
    inline def setWebGLInfo(value: Instantiable1[/* gl */ WebGLRenderingContext, typings.three.mod.WebGLInfo]): Self = StObject.set(x, "WebGLInfo", value.asInstanceOf[js.Any])
    
    inline def setWebGLLights(
    ...
    ): Self = StObject.set(x, "WebGLObjects", value.asInstanceOf[js.Any])
    
    inline def setWebGLProgram(
      value: Instantiable3[
          /* renderer */ WebGLRenderer, 
          /* cacheKey */ String, 
          /* parameters */ js.Object, 
    ...
    ): Self = StObject.set(x, "WebGLProgram", value.asInstanceOf[js.Any])
    
    inline def setWebGLPrograms(
      value: Instantiable6[
          /* renderer */ WebGLRenderer, 
          /* cubemaps */ WebGLCubeMaps, 
          /* extensions */ WebGLExtensions, 
    ...
    ): Self = StObject.set(x, "WebGLPrograms", value.asInstanceOf[js.Any])
    
    inline def setWebGLProperties(value: Instantiable0[typings.three.mod.WebGLProperties]): Self = StObject.set(x, "WebGLProperties", value.asInstanceOf[js.Any])
    
    inline def setWebGLRenderList(value: Instantiable1[/* properties */ WebGLProperties, WebGLRenderList]): Self = StObject.set(x, "WebGLRenderList", value.asInstanceOf[js.Any])
    ...
    inline def setWebGLShader(value: (WebGLRenderingContext, String, String) => WebGLShader): Self = StObject.set(x, "WebGLShader", js.Any.fromFunction3(value))
    
    inline def setWebGLShadowMap(
      value: Instantiable3[
          /* _renderer */ WebGLRenderer, 
          /* _objects */ WebGLObjects, 
          /* _capabilities */ WebGLCapabilities, 
    ...
    ): Self = StObject.set(x, "WebGLShadowMap", value.asInstanceOf[js.Any])
    
    inline def setWebGLState(
      value: Instantiable3[
          /* gl */ WebGLRenderingContext, 
          /* extensions */ WebGLExtensions, 
          /* capabilities */ WebGLCapabilities, 
    ...
    ): Self = StObject.set(x, "WebGLState", value.asInstanceOf[js.Any])
    
    inline def setWebGLStencilBuffer(value: Instantiable0[WebGLStencilBuffer]): Self = StObject.set(x, "WebGLStencilBuffer", value.asInstanceOf[js.Any])
    
    inline def setWebGLTextures(
      value: Instantiable7[
          /* gl */ WebGLRenderingContext, 
          /* extensions */ WebGLExtensions, 
          /* state */ WebGLState, 
    ...
    ): Self = StObject.set(x, "WebGLTextures", value.asInstanceOf[js.Any])
    
    inline def setWebGLUniforms(value: TypeofWebGLUniforms): Self = StObject.set(x, "WebGLUniforms", value.asInstanceOf[js.Any])
    
    inline def setWebGLUniformsGroups(value: (WebGLRenderingContext, WebGLInfo, WebGLCapabilities, WebGLState) => Bind): Self = StObject.set(x, "WebGLUniformsGroups", js.Any.fromFunction4(value))
    
    inline def setWebGLUtils(
      value: Instantiable3[
          /* gl */ WebGLRenderingContext, 
          /* extensions */ Any, 
          /* capabilities */ Any, 
    ...
    ): Self = StObject.set(x, "WebGLUtils", value.asInstanceOf[js.Any])
    
    inline def setWebXRController(value: Instantiable0[WebXRController]): Self = StObject.set(x, "WebXRController", value.asInstanceOf[js.Any])
