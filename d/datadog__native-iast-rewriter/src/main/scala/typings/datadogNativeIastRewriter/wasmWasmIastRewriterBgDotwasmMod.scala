...
object wasmWasmIastRewriterBgDotwasmMod {
  ...
  inline def rewriterSetLogger(a: Double, b: Double, c: Double, d: Double, e: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("rewriter_setLogger")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any], d.asInstanceOf[js.Any], e.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def wbindgenFree(a: Double, b: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("__wbindgen_free")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Unit]
