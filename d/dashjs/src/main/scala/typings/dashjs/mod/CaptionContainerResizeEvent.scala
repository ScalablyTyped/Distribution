...
object CaptionContainerResizeEvent {
  ...
  @scala.inline
  implicit class CaptionContainerResizeEventOps[Self <: CaptionContainerResizeEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: captionContainerResize): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
