...
object Middleware {
  @scala.inline
  def apply[/* <: typings.dexie.anon.Stack */ TStack](
  ...
  @scala.inline
  implicit class MiddlewareOps[Self <: Middleware[_], /* <: typings.dexie.anon.Stack */ TStack] (val x: Self with Middleware[TStack]) extends AnyVal {
    @scala.inline
