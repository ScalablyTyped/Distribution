package typings.d3DashQueue.d3DashQueueMod
...
object Queue {
  ...
  def apply(
    abort: () => Queue,
    await: js.Function2[/* error */ js.Any | Null, /* repeated */ js.Any, Unit] => Queue,
    awaitAll: js.Function2[/* error */ js.Any | Null, /* results */ js.UndefOr[js.Array[_]], Unit] => Queue,
    defer: (js.Function1[/* repeated */ js.Any, Unit], /* repeated */ js.Any) => Queue
  ): Queue = {
