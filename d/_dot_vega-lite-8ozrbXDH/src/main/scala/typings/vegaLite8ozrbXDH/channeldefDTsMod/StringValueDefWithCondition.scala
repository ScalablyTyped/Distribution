...
/* Inlined .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/channeldef.d.ts.ValueDefWithCondition<.vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/channeldef.d.ts.MarkPropFieldOrDatumDef<F, T>, string | null> */
