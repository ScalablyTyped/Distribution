...
import typings.vegaLite8ozrbXDH.legendDTsMod.Legend
...
/* Inlined .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/channeldef.d.ts.LegendMixins & .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/channeldef.d.ts.ScaleDatumDef<F> */
