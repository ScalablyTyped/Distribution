...
import typings.vegaLite8ozrbXDH.transformDTsMod.FilterTransform
...
object formatparseDTsMod {
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/compile/data/formatparse.d.ts", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/compile/data/formatparse.d.ts", "ParseNode")
  @js.native
