...
object componentDotDTsMod {
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/compile/header/component.d.ts", "HEADER_CHANNELS")
  @js.native
  val HEADER_CHANNELS: js.Array[HeaderChannel] = js.native
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/compile/header/component.d.ts", "HEADER_TYPES")
  @js.native
  val HEADER_TYPES: js.Array[HeaderType] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.row
    - typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.column
  */
  trait HeaderChannel extends StObject
  object HeaderChannel {
    
    inline def column: typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.column = "column".asInstanceOf[typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.column]
    
    inline def row: typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.row = "row".asInstanceOf[typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.row]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.header
    - typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.footer
  */
  trait HeaderType extends StObject
  object HeaderType {
    
    inline def footer: typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.footer = "footer".asInstanceOf[typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.footer]
    
    inline def header: typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.header = "header".asInstanceOf[typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.header]
  }
