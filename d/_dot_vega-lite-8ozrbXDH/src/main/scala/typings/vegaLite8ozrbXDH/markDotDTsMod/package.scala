...
import typings.vegaLite8ozrbXDH.markDotDTsMod.^
...
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.filled
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.geoshape
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.hide
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.image
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.invalid
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.line
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.mark
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.order
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.point
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.radius2
...
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.strokeDashOffset
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.strokeJoin
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.strokeMiterLimit
...
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.theta2
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.tick
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.timeUnitBandPosition
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.timeUnitBandSize
...
/* keyof .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.MarkConfigMixins<any> */ mark | arc | area | bar | circle | image | line | point | rect | rule | square | text | tick | trail | geoshape] = ^.asInstanceOf[js.Dynamic].selectDynamic("MARK_CONFIGS").asInstanceOf[js.Array[
/* keyof .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.MarkConfigMixins<any> */ mark | arc | area | bar | circle | image | line | point | rect | rule | square | text | tick | trail | geoshape]]
...
/* keyof .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.VLOnlyMarkConfig<any> */ filled | invalid | order | timeUnitBandPosition | timeUnitBandSize | theta2 | radius2 | color] = ^.asInstanceOf[js.Dynamic].selectDynamic("VL_ONLY_MARK_CONFIG_PROPERTIES").asInstanceOf[js.Array[
/* keyof .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.VLOnlyMarkConfig<any> */ filled | invalid | order | timeUnitBandPosition | timeUnitBandSize | theta2 | radius2 | color]]
...
inline def isMark(m: String): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.Mark */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMark")(m.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.Mark */ Boolean]

inline def isMarkDef(mark: String): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.GenericMarkDef<any> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMarkDef")(mark.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.GenericMarkDef<any> */ Boolean]
inline def isMarkDef(mark: GenericMarkDef[Any]): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.GenericMarkDef<any> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMarkDef")(mark.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.GenericMarkDef<any> */ Boolean]
...
inline def isPrimitiveMark(mark: AnyMark): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.Mark */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPrimitiveMark")(mark.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.Mark */ Boolean]
...
inline def isRelativeBandSize(o: Double): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.RelativeBandSize */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isRelativeBandSize")(o.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.RelativeBandSize */ Boolean]
inline def isRelativeBandSize(o: ExprRef): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.RelativeBandSize */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isRelativeBandSize")(o.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.RelativeBandSize */ Boolean]
inline def isRelativeBandSize(o: RelativeBandSize): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.RelativeBandSize */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isRelativeBandSize")(o.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.RelativeBandSize */ Boolean]
inline def isRelativeBandSize(o: SignalRef): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.RelativeBandSize */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isRelativeBandSize")(o.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.RelativeBandSize */ Boolean]
