...
/* Inlined parent .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/mark.d.ts.VLOnlyMarkConfig<ES> */
/* Inlined parent .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/vega.schema.d.ts.MapExcludeValueRefAndReplaceSignalWith<std.Omit<vega.vega.MarkConfig, 'tooltip' | 'fill' | 'stroke'>, ES> */
