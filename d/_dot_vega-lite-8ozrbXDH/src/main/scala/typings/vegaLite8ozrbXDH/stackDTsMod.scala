...
import typings.vegaLite8ozrbXDH.sortDTsMod.SortFields
import typings.vegaLite8ozrbXDH.stackDotDTsMod.StackOffset
import typings.vegaLite8ozrbXDH.transformDTsMod.StackTransform
...
object stackDTsMod {
  ...
  @JSImport(".vega-lite-8ozrbXDH/build/src/compile/data/stack.d.ts", "StackNode")
  @js.native
