...
object utilDTsMod {
  ...
  @JSImport(".vega-lite-8ozrbXDH/build/src/util.d.ts", JSImport.Namespace)
  @js.native
  ...
  @JSImport(".vega-lite-8ozrbXDH/build/src/util.d.ts", "duplicate")
  @js.native
  ...
  @JSImport(".vega-lite-8ozrbXDH/build/src/util.d.ts", "stringify")
  @js.native
  ...
  {[ P in keyof T ]:? .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/util.d.ts.DeepPartial<T[P]>}
    */ typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.DeepPartial & TopLevel[T]
  
  type Dict[T] = Record[String, T]
  
  type Flag[S /* <: String */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in S ]: 1}
    */ typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.Flag & TopLevel[Any]
}
