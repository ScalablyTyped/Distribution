...
import typings.vegaLite8ozrbXDH.channeldefDTsMod.ConditionValueDefMixins
import typings.vegaLite8ozrbXDH.channeldefDTsMod.FormatMixins
...
object guideDotDTsMod {
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/guide.d.ts", "VL_ONLY_LEGEND_CONFIG")
  @js.native
  val VL_ONLY_LEGEND_CONFIG: js.Array[
    /* keyof .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/legend.d.ts.LegendConfig<any> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 75 */ Any
  ] = js.native
  ...
  /* Inlined std.Partial<std.Record<.vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/vega.schema.d.ts.VgEncodeChannel, .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/guide.d.ts.GuideEncodingConditionalValueDef>> */
