...
object datetimeDTsMod {
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/datetime.d.ts", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/datetime.d.ts", "DAYS")
  @js.native
  val DAYS: js.Array[String] = js.native
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/datetime.d.ts", "MONTHS")
  @js.native
  val MONTHS: js.Array[String] = js.native
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/datetime.d.ts", "SHORT_DAYS")
  @js.native
  val SHORT_DAYS: js.Array[String] = js.native
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/datetime.d.ts", "SHORT_MONTHS")
  @js.native
  ...
  inline def isDateTime(o: Any): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/datetime.d.ts.DateTime */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDateTime")(o.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/datetime.d.ts.DateTime */ Boolean]
