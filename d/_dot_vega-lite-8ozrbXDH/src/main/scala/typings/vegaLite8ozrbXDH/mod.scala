...
import typings.vegaLite8ozrbXDH.compileDTsMod.CompileOptions
...
import typings.vegaLite8ozrbXDH.utilDTsMod.DeepPartial
...
object mod {
  ...
  @JSImport(".vega-lite-8ozrbXDH", JSImport.Namespace)
  @js.native
  ...
  @JSImport(".vega-lite-8ozrbXDH", "duplicate")
  @js.native
  ...
  @JSImport(".vega-lite-8ozrbXDH", "stringify")
  @js.native
  ...
  @JSImport(".vega-lite-8ozrbXDH", "version")
  @js.native
