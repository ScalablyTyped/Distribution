...
/* Inlined .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/compile/mark/encode/valueref.d.ts.MidPointParams & {  channel :'x2' | 'y2' | 'radius2' | 'theta2'} */
trait MidPointParamschannelx2y2 extends StObject {
  
  var bandPosition: js.UndefOr[Double | SignalRef] = js.undefined
  
  var channel: typings.vegaLite8ozrbXDH.channelDTsMod.Channel & (x2 | y2 | radius2 | theta2)
...
object MidPointParamschannelx2y2 {
  ...
  inline def apply(
    channel: typings.vegaLite8ozrbXDH.channelDTsMod.Channel & (x2 | y2 | radius2 | theta2),
  ...
  extension [Self <: MidPointParamschannelx2y2](x: Self) {
    ...
    inline def setChannel(value: typings.vegaLite8ozrbXDH.channelDTsMod.Channel & (x2 | y2 | radius2 | theta2)): Self = StObject.set(x, "channel", value.asInstanceOf[js.Any])
