...
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.left
import typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.right
...
trait Baseline extends StObject {
  ...
  var align: center | left | right | SignalRef | FieldField | Scale | FieldScale | Band | Range | ValueAlign
...
object Baseline {
  ...
  inline def apply(
    align: center | left | right | SignalRef | FieldField | Scale | FieldScale | Band | Range | ValueAlign,
  ...
  extension [Self <: Baseline](x: Self) {
    ...
    inline def setAlign(
      value: center | left | right | SignalRef | FieldField | Scale | FieldScale | Band | Range | ValueAlign
