...
trait LegendConfig extends StObject {
  ...
  var legend: typings.vegaLite8ozrbXDH.legendDTsMod.Legend[SignalRef]
...
object LegendConfig {
  ...
  inline def apply(
    legend: typings.vegaLite8ozrbXDH.legendDTsMod.Legend[SignalRef],
  ...
  extension [Self <: LegendConfig](x: Self) {
    ...
    inline def setLegend(value: typings.vegaLite8ozrbXDH.legendDTsMod.Legend[SignalRef]): Self = StObject.set(x, "legend", value.asInstanceOf[js.Any])
