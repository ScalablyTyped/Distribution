...
trait EndPositionPrefix[P /* <: PartsMixins[Any] */] extends StObject {
  ...
  var extraEncoding: js.UndefOr[typings.vegaLite8ozrbXDH.encodingDTsMod.Encoding[String]] = js.undefined
  
  var mark: typings.vegaLite8ozrbXDH.markDotDTsMod.Mark | (typings.vegaLite8ozrbXDH.markDotDTsMod.MarkDef[typings.vegaLite8ozrbXDH.markDotDTsMod.Mark, ExprRef | SignalRef])
...
object EndPositionPrefix {
  ...
  inline def apply[P /* <: PartsMixins[Any] */](
    mark: typings.vegaLite8ozrbXDH.markDotDTsMod.Mark | (typings.vegaLite8ozrbXDH.markDotDTsMod.MarkDef[typings.vegaLite8ozrbXDH.markDotDTsMod.Mark, ExprRef | SignalRef]),
  ...
  extension [Self <: EndPositionPrefix[?], P /* <: PartsMixins[Any] */](x: Self & EndPositionPrefix[P]) {
    ...
    inline def setExtraEncoding(value: typings.vegaLite8ozrbXDH.encodingDTsMod.Encoding[String]): Self = StObject.set(x, "extraEncoding", value.asInstanceOf[js.Any])
    
    inline def setExtraEncodingUndefined: Self = StObject.set(x, "extraEncoding", js.undefined)
    
    inline def setMark(
      value: typings.vegaLite8ozrbXDH.markDotDTsMod.Mark | (typings.vegaLite8ozrbXDH.markDotDTsMod.MarkDef[typings.vegaLite8ozrbXDH.markDotDTsMod.Mark, ExprRef | SignalRef])
