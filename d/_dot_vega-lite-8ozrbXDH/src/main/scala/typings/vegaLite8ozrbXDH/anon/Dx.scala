...
trait Dx extends StObject {
  ...
  var frame: String | SignalRef | FieldField | Scale | FieldScale | Band | Range | ValueString
...
object Dx {
  ...
  inline def apply(
    ...
    frame: String | SignalRef | FieldField | Scale | FieldScale | Band | Range | ValueString,
