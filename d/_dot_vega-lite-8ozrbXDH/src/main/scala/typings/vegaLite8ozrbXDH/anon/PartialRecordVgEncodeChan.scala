...
/* Inlined std.Partial<std.Record<.vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/vega.schema.d.ts.VgEncodeChannel, .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/vega.schema.d.ts.VgValueRef | std.Array<.vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/vega.schema.d.ts.VgValueRef & {  test :string | undefined}>>> */
...
object PartialRecordVgEncodeChan {
  ...
  inline def apply(): PartialRecordVgEncodeChan = {
