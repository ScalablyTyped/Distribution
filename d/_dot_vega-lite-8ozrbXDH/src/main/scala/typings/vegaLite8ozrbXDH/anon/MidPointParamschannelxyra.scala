...
/* Inlined .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/compile/mark/encode/valueref.d.ts.MidPointParams & {  channel :'x' | 'y' | 'radius' | 'theta'} */
trait MidPointParamschannelxyra extends StObject {
  
  var bandPosition: js.UndefOr[Double | SignalRef] = js.undefined
  
  var channel: typings.vegaLite8ozrbXDH.channelDTsMod.Channel & (x | y | radius | theta)
...
object MidPointParamschannelxyra {
  ...
  inline def apply(
    channel: typings.vegaLite8ozrbXDH.channelDTsMod.Channel & (x | y | radius | theta),
  ...
  extension [Self <: MidPointParamschannelxyra](x: Self) {
    ...
    inline def setChannel(
      value: typings.vegaLite8ozrbXDH.channelDTsMod.Channel & (typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.x | y | radius | theta)
