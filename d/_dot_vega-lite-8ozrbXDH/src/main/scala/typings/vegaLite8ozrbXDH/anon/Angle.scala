...
trait Angle extends StObject {
  ...
  var baseline: String | SignalRef | FieldField | Scale | FieldScale | Band | Range | ValueTextBaseline | Signal
...
object Angle {
  ...
  inline def apply(
    baseline: String | SignalRef | FieldField | Scale | FieldScale | Band | Range | ValueTextBaseline | Signal,
  ...
  extension [Self <: Angle](x: Self) {
    ...
    inline def setBaseline(
      value: String | SignalRef | FieldField | Scale | FieldScale | Band | Range | ValueTextBaseline | Signal
