...
/* Inlined .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/toplevel.d.ts.TopLevel<.vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/layer.d.ts.LayerSpec<.vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/channeldef.d.ts.Field>> */
trait TopLevelLayerSpecField
  ...
  /**
    ...
    */
  var encoding: js.UndefOr[SharedCompositeEncoding[typings.vegaLite8ozrbXDH.channeldefDTsMod.Field]] = js.undefined
  ...
  /**
    ...
    */
  var layer: js.Array[
    LayerSpec[typings.vegaLite8ozrbXDH.channeldefDTsMod.Field] | UnitSpec[typings.vegaLite8ozrbXDH.channeldefDTsMod.Field]
  ]
...
object TopLevelLayerSpecField {
  ...
  extension [Self <: TopLevelLayerSpecField](x: Self) {
    ...
    inline def setEncoding(value: SharedCompositeEncoding[typings.vegaLite8ozrbXDH.channeldefDTsMod.Field]): Self = StObject.set(x, "encoding", value.asInstanceOf[js.Any])
    ...
    inline def setLayerVarargs(
      value: (LayerSpec[typings.vegaLite8ozrbXDH.channeldefDTsMod.Field] | UnitSpec[typings.vegaLite8ozrbXDH.channeldefDTsMod.Field])*
