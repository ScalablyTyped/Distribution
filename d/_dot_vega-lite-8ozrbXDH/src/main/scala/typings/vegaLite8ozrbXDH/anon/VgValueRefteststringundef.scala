...
/* Inlined .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/vega.schema.d.ts.VgValueRef & {  test :string | undefined} */
trait VgValueRefteststringundef extends StObject {
  ...
  var value: js.UndefOr[typings.vegaLite8ozrbXDH.channeldefDTsMod.Value[scala.Nothing]] = js.undefined
}
object VgValueRefteststringundef {
  ...
  extension [Self <: VgValueRefteststringundef](x: Self) {
    ...
    inline def setValue(value: typings.vegaLite8ozrbXDH.channeldefDTsMod.Value[scala.Nothing]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
