...
trait Aria extends StObject {
  ...
  var align: String | SignalRef | FieldField | Scale | FieldScale | Band | Range | ValueAlign
...
object Aria {
  ...
  inline def apply(
    align: String | SignalRef | FieldField | Scale | FieldScale | Band | Range | ValueAlign,
  ...
  extension [Self <: Aria](x: Self) {
    ...
    inline def setAlign(value: String | SignalRef | FieldField | Scale | FieldScale | Band | Range | ValueAlign): Self = StObject.set(x, "align", value.asInstanceOf[js.Any])
