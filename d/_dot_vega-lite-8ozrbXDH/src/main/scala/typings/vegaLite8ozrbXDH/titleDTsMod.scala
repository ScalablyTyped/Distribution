...
import typings.vegaLite8ozrbXDH.anon.NonMarkTitleProperties
...
object titleDTsMod {
  ...
  @JSImport(".vega-lite-8ozrbXDH/build/src/title.d.ts", JSImport.Namespace)
  @js.native
  ...
  /* Inlined .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/vega.schema.d.ts.MapExcludeValueRefAndReplaceSignalWith<std.Omit<vega.vega.BaseTitle, 'align' | 'baseline'>, ES> & .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/vega.schema.d.ts.MappedExcludeValueRef<std.Pick<vega.vega.BaseTitle, 'align' | 'baseline'>> */
  ...
  /* Inlined .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/title.d.ts.BaseTitleNoValueRefs<ES> */
