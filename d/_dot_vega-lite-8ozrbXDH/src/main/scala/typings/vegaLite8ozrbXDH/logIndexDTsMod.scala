...
object logIndexDTsMod {
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "LocalLogger")
  @js.native
  open class LocalLogger ()
    extends StObject
       with LoggerInterface {
    
    var debugs: js.Array[Any] = js.native
    
    var infos: js.Array[Any] = js.native
    
    /* private */ var `private`: Any = js.native
    
    var warns: js.Array[Any] = js.native
  }
  ...
  object message {
    ...
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.ADD_SAME_CHILD_TWICE")
    @js.native
    val ADD_SAME_CHILD_TWICE: /* "Attempt to add the same child twice." */ String = js.native
    
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.CANNOT_UNION_CUSTOM_DOMAIN_WITH_FIELD_DOMAIN")
    @js.native
    ...
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.CONCAT_CANNOT_SHARE_AXIS")
    @js.native
    ...
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.FACETED_INDEPENDENT_DIFFERENT_SOURCES")
    @js.native
    ...
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.FACETED_INDEPENDENT_SAME_FIELDS_DIFFERENT_SOURCES")
    @js.native
    ...
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.FACETED_INDEPENDENT_SAME_SOURCE")
    @js.native
    ...
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.FIT_NON_SINGLE")
    @js.native
    val FIT_NON_SINGLE: /* "Autosize \"fit\" only works for single views and layered views." */ String = js.native
    
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.INTERVAL_INITIALIZED_WITH_X_Y")
    @js.native
    val INTERVAL_INITIALIZED_WITH_X_Y: /* "Interval selections should be initialized using \"x\" and/or \"y\" keys." */ String = js.native
    
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.INVALID_CHANNEL_FOR_AXIS")
    @js.native
    val INVALID_CHANNEL_FOR_AXIS: /* "Invalid channel for axis." */ String = js.native
    
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.LEGEND_BINDINGS_MUST_HAVE_PROJECTION")
    @js.native
    ...
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.LINE_WITH_VARYING_SIZE")
    @js.native
    ...
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.MORE_THAN_ONE_SORT")
    @js.native
    ...
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.NEEDS_SAME_SELECTION")
    @js.native
    val NEEDS_SAME_SELECTION: /* "The same selection must be used to override scale domains in a layered view." */ String = js.native
    
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.NO_FIELDS_NEEDS_AS")
    @js.native
    ...
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.REPLACE_ANGLE_WITH_THETA")
    @js.native
    val REPLACE_ANGLE_WITH_THETA: /* "Arc marks uses theta channel rather than angle, replacing angle with theta." */ String = js.native
    
    @JSImport(".vega-lite-8ozrbXDH/build/src/log/index.d.ts", "message.SCALE_BINDINGS_CONTINUOUS")
    @js.native
