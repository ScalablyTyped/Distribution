...
object zoomDTsMod extends Shortcut {
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/compile/selection/zoom.d.ts", JSImport.Default)
  @js.native
  val default: SelectionCompiler[interval] = js.native
  
  type _To = SelectionCompiler[interval]
  
  /* This means you don't have to write `default`, but can instead just say `zoomDTsMod.foo` */
