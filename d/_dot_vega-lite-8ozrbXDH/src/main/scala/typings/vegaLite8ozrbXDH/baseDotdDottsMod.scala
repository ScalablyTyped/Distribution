...
import typings.vegaLite8ozrbXDH.repeaterDTsMod.RepeaterValue
...
object baseDotdDottsMod {
  ...
  type NonFacetUnitNormalizer[S /* <: GenericUnitSpec[Any, Any] */] = ExtraNormalizer[
    S, 
