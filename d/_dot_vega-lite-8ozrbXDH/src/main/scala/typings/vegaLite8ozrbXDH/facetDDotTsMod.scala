...
object facetDDotTsMod {
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/spec/facet.d.ts", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def isFacetFieldDef[F /* <: Field */](channelDef: ChannelDef[F]): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/facet.d.ts.FacetFieldDef<F, any> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFacetFieldDef")(channelDef.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/facet.d.ts.FacetFieldDef<F, any> */ Boolean]
  
  inline def isFacetMapping[F /* <: Field */, ES /* <: ExprRef | SignalRef */](f: FacetFieldDef[F, ES]): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/facet.d.ts.FacetMapping<F, .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/facet.d.ts.FacetFieldDef<F, .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/expr.d.ts.ExprRef | vega-typings.vega-typings/types/spec/signal.SignalRef>> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFacetMapping")(f.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/facet.d.ts.FacetMapping<F, .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/facet.d.ts.FacetFieldDef<F, .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/expr.d.ts.ExprRef | vega-typings.vega-typings/types/spec/signal.SignalRef>> */ Boolean]
  inline def isFacetMapping[F /* <: Field */, ES /* <: ExprRef | SignalRef */](f: FacetMapping[F, FacetFieldDef[F, ExprRef | SignalRef]]): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/facet.d.ts.FacetMapping<F, .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/facet.d.ts.FacetFieldDef<F, .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/expr.d.ts.ExprRef | vega-typings.vega-typings/types/spec/signal.SignalRef>> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFacetMapping")(f.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/facet.d.ts.FacetMapping<F, .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/facet.d.ts.FacetFieldDef<F, .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/expr.d.ts.ExprRef | vega-typings.vega-typings/types/spec/signal.SignalRef>> */ Boolean]
  ...
  trait GenericFacetSpec[U /* <: GenericUnitSpec[Any, Any] */, L /* <: GenericLayerSpec[Any] */, F /* <: Field */]
    extends StObject
       with BaseSpec
  ...
  object GenericFacetSpec {
    ...
    inline def apply[U /* <: GenericUnitSpec[Any, Any] */, L /* <: GenericLayerSpec[Any] */, F /* <: Field */](
    ...
    extension [Self <: GenericFacetSpec[?, ?, ?], U /* <: GenericUnitSpec[Any, Any] */, L /* <: GenericLayerSpec[Any] */, F /* <: Field */](x: Self & (GenericFacetSpec[U, L, F])) {
