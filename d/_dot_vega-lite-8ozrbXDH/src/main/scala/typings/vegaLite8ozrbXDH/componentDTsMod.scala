...
import typings.vegaLite8ozrbXDH.anon.PartialAxisComponentProps
...
object componentDTsMod {
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/compile/axis/component.d.ts", "AXIS_COMPONENT_PROPERTIES")
  @js.native
  val AXIS_COMPONENT_PROPERTIES: js.Array[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 81 */ Any
  ] = js.native
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/compile/axis/component.d.ts", "AxisComponent")
  @js.native
  ...
  /* Inlined std.Omit<vega.vega.Axis, 'title' | .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/axis.d.ts.ConditionalAxisProp> & std.Omit<.vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/axis.d.ts.AxisPropsWithCondition<vega.vega.SignalRef>, 'title'> & {  title :vega.vega.Text | std.Array<.vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/channeldef.d.ts.FieldDefBase<string, .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/bin.d.ts.Bin>> | vega.vega.SignalRef,   labelExpr :string,   disable :boolean} */
