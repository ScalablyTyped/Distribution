...
import typings.vegaLite8ozrbXDH.specBaseDTsMod.BoundsMixins
...
object concatDotDTsMod {
  
  @JSImport(".vega-lite-8ozrbXDH/build/src/spec/concat.d.ts", JSImport.Namespace)
  @js.native
  ...
  inline def isConcatSpec(spec: BaseSpec): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/concat.d.ts.GenericConcatSpec<any> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isConcatSpec")(spec.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/spec/concat.d.ts.GenericConcatSpec<any> */ Boolean]
