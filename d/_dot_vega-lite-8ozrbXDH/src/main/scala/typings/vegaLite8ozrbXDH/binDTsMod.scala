...
object binDTsMod {
  ...
  @JSImport(".vega-lite-8ozrbXDH/build/src/bin.d.ts", JSImport.Namespace)
  @js.native
  ...
  inline def isBinParams(bin: Boolean): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/bin.d.ts.BinParams */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBinParams")(bin.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/bin.d.ts.BinParams */ Boolean]
  inline def isBinParams(bin: BinParams): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/bin.d.ts.BinParams */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBinParams")(bin.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/bin.d.ts.BinParams */ Boolean]
  
  inline def isBinParams_binned(bin: binned): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/bin.d.ts.BinParams */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBinParams")(bin.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/bin.d.ts.BinParams */ Boolean]
  ...
  inline def isParameterExtent(extent: BinExtent): /* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/selection.d.ts.ParameterExtent */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isParameterExtent")(extent.asInstanceOf[js.Any]).asInstanceOf[/* is .vega-lite-8ozrbXDH..vega-lite-8ozrbXDH/build/src/selection.d.ts.ParameterExtent */ Boolean]
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Boolean
    - typings.vegaLite8ozrbXDH.binDTsMod.BinParams
    - typings.vegaLite8ozrbXDH.vegaLite8ozrbXDHStrings.binned
    - scala.Null
  */
