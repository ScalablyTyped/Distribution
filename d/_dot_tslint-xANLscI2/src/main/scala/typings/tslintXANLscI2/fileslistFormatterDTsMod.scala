...
object fileslistFormatterDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/formatters/fileslistFormatter.d.ts", "Formatter")
  @js.native
  ...
  object Formatter {
    ...
    @JSImport(".tslint-xANLscI2/lib/formatters/fileslistFormatter.d.ts", "Formatter.metadata")
    @js.native
