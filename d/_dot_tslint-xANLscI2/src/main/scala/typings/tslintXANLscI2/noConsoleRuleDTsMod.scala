...
object noConsoleRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noConsoleRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noConsoleRule.d.ts", "Rule.metadata")
    @js.native
