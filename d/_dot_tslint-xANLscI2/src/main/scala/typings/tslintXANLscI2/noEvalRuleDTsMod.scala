...
object noEvalRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noEvalRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noEvalRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noEvalRule.d.ts", "Rule.metadata")
    @js.native
