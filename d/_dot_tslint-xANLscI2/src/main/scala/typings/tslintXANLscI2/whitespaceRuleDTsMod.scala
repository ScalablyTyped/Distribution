...
object whitespaceRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/whitespaceRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/whitespaceRule.d.ts", "Rule.FAILURE_STRING_INVALID")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/whitespaceRule.d.ts", "Rule.FAILURE_STRING_MISSING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/whitespaceRule.d.ts", "Rule.metadata")
    @js.native
