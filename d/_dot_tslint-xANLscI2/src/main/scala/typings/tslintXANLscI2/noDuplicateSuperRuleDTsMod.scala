...
object noDuplicateSuperRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noDuplicateSuperRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noDuplicateSuperRule.d.ts", "Rule.FAILURE_STRING_DUPLICATE")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noDuplicateSuperRule.d.ts", "Rule.FAILURE_STRING_LOOP")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noDuplicateSuperRule.d.ts", "Rule.metadata")
    @js.native
