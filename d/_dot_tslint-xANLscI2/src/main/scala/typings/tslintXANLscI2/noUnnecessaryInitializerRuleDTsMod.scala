...
object noUnnecessaryInitializerRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noUnnecessaryInitializerRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noUnnecessaryInitializerRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noUnnecessaryInitializerRule.d.ts", "Rule.FAILURE_STRING_PARAMETER")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noUnnecessaryInitializerRule.d.ts", "Rule.metadata")
    @js.native
