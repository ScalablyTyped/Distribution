...
object preferConstRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/preferConstRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/preferConstRule.d.ts", "Rule.metadata")
    @js.native
