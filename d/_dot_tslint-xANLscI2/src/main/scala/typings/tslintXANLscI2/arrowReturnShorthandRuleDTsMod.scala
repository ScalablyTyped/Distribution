...
object arrowReturnShorthandRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/arrowReturnShorthandRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/arrowReturnShorthandRule.d.ts", "Rule.metadata")
    @js.native
