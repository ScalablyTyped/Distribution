...
import typings.tslintXANLscI2.tslintXANLscI2Strings.`Shorthand method assignments have been disallowedDot`
import typings.tslintXANLscI2.tslintXANLscI2Strings.`Shorthand property and method assignments have been disallowedDot`
import typings.tslintXANLscI2.tslintXANLscI2Strings.`Shorthand property assignments have been disallowedDot`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object objectLiteralShorthandRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/objectLiteralShorthandRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/objectLiteralShorthandRule.d.ts", "Rule.LONGHAND_METHOD")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/objectLiteralShorthandRule.d.ts", "Rule.LONGHAND_PROPERTY")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/objectLiteralShorthandRule.d.ts", "Rule.SHORTHAND_ASSIGNMENT")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/objectLiteralShorthandRule.d.ts", "Rule.metadata")
    @js.native
