...
object stylishFormatterDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/formatters/stylishFormatter.d.ts", "Formatter")
  @js.native
  ...
  object Formatter {
    ...
    @JSImport(".tslint-xANLscI2/lib/formatters/stylishFormatter.d.ts", "Formatter.metadata")
    @js.native
