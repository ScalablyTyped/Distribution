...
object preferObjectSpreadRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/preferObjectSpreadRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/preferObjectSpreadRule.d.ts", "Rule.ASSIGNMENT_FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/preferObjectSpreadRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/preferObjectSpreadRule.d.ts", "Rule.metadata")
    @js.native
