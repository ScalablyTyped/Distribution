...
object matchDefaultExportNameRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/matchDefaultExportNameRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/matchDefaultExportNameRule.d.ts", "Rule.metadata")
    @js.native
