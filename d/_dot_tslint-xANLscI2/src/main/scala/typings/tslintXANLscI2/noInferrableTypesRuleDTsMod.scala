...
object noInferrableTypesRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noInferrableTypesRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noInferrableTypesRule.d.ts", "Rule.metadata")
    @js.native
