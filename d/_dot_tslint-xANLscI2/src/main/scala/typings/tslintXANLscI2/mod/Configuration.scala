...
import typings.tslintXANLscI2.configurationDTsMod.RawConfigFile
...
object Configuration {
  ...
  @JSImport(".tslint-xANLscI2", "Configuration")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport(".tslint-xANLscI2", "Configuration.CONFIG_FILENAME")
  @js.native
  val CONFIG_FILENAME: /* "tslint.json" */ String = js.native
  
  @JSImport(".tslint-xANLscI2", "Configuration.CONFIG_FILENAMES")
  @js.native
  val CONFIG_FILENAMES: js.Array[String] = js.native
  
  @JSImport(".tslint-xANLscI2", "Configuration.DEFAULT_CONFIG")
  @js.native
  val DEFAULT_CONFIG: IConfigurationFile = js.native
  
  @JSImport(".tslint-xANLscI2", "Configuration.EMPTY_CONFIG")
  @js.native
  val EMPTY_CONFIG: IConfigurationFile = js.native
  
  @JSImport(".tslint-xANLscI2", "Configuration.JSON_CONFIG_FILENAME")
  @js.native
