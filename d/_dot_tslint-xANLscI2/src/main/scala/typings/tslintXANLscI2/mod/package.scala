...
import typings.tslintXANLscI2.mod.^
...
import typings.tslintXANLscI2.utilsDTsMod.EqualsKind
import typings.tslintXANLscI2.utilsDTsMod.FilterCallback
import typings.tslintXANLscI2.utilsDTsMod.ForEachCommentCallback
import typings.tslintXANLscI2.utilsDTsMod.ForEachTokenCallback
...
inline def doesIntersect(
  failure: typings.tslintXANLscI2.ruleDTsMod.RuleFailure,
...
inline def removeDisabledFailures(sourceFile: SourceFile, failures: js.Array[typings.tslintXANLscI2.ruleDTsMod.RuleFailure]): js.Array[typings.tslintXANLscI2.ruleDTsMod.RuleFailure] = (^.asInstanceOf[js.Dynamic].applyDynamic("removeDisabledFailures")(sourceFile.asInstanceOf[js.Any], failures.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.tslintXANLscI2.ruleDTsMod.RuleFailure]]
