...
object interfaceNameRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/interfaceNameRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/interfaceNameRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/interfaceNameRule.d.ts", "Rule.FAILURE_STRING_NO_PREFIX")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/interfaceNameRule.d.ts", "Rule.metadata")
    @js.native
