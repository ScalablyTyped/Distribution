...
object jsonFormatterDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/formatters/jsonFormatter.d.ts", "Formatter")
  @js.native
  ...
  object Formatter {
    ...
    @JSImport(".tslint-xANLscI2/lib/formatters/jsonFormatter.d.ts", "Formatter.metadata")
    @js.native
