...
object memberAccessRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/memberAccessRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/memberAccessRule.d.ts", "Rule.FAILURE_STRING_NO_PUBLIC")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/memberAccessRule.d.ts", "Rule.metadata")
    @js.native
