...
object noDuplicateVariableRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noDuplicateVariableRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noDuplicateVariableRule.d.ts", "Rule.metadata")
    @js.native
