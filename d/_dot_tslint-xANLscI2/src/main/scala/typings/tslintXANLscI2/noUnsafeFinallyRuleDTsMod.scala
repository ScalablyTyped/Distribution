...
object noUnsafeFinallyRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noUnsafeFinallyRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noUnsafeFinallyRule.d.ts", "Rule.metadata")
    @js.native
