...
object noStringLiteralRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noStringLiteralRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noStringLiteralRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noStringLiteralRule.d.ts", "Rule.metadata")
    @js.native
