...
object noUnusedVariableRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noUnusedVariableRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noUnusedVariableRule.d.ts", "Rule.metadata")
    @js.native
