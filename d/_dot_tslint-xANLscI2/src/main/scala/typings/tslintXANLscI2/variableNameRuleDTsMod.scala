...
object variableNameRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/variableNameRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/variableNameRule.d.ts", "Rule.FAILURE_STRING_CONST")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/variableNameRule.d.ts", "Rule.KEYWORD_FAILURE")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/variableNameRule.d.ts", "Rule.metadata")
    @js.native
