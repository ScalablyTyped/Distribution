...
object promiseFunctionAsyncRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/promiseFunctionAsyncRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/promiseFunctionAsyncRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/promiseFunctionAsyncRule.d.ts", "Rule.metadata")
    @js.native
