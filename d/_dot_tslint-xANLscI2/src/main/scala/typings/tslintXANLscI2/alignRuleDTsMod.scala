...
object alignRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/alignRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/alignRule.d.ts", "Rule.FAILURE_STRING_SUFFIX")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/alignRule.d.ts", "Rule.metadata")
    @js.native
