...
object banCommaOperatorRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/banCommaOperatorRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/banCommaOperatorRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/banCommaOperatorRule.d.ts", "Rule.metadata")
    @js.native
