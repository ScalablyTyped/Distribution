...
object vsoFormatterDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/formatters/vsoFormatter.d.ts", "Formatter")
  @js.native
  ...
  object Formatter {
    ...
    @JSImport(".tslint-xANLscI2/lib/formatters/vsoFormatter.d.ts", "Formatter.metadata")
    @js.native
