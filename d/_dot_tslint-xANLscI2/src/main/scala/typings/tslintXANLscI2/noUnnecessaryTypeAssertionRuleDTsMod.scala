...
object noUnnecessaryTypeAssertionRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noUnnecessaryTypeAssertionRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noUnnecessaryTypeAssertionRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noUnnecessaryTypeAssertionRule.d.ts", "Rule.metadata")
    @js.native
