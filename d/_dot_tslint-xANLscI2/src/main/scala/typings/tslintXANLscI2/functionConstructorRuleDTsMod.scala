...
object functionConstructorRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/functionConstructorRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/functionConstructorRule.d.ts", "Rule.FAILURE")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/functionConstructorRule.d.ts", "Rule.metadata")
    @js.native
