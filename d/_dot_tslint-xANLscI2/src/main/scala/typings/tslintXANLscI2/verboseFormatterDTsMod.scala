...
object verboseFormatterDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/formatters/verboseFormatter.d.ts", "Formatter")
  @js.native
  ...
  object Formatter {
    ...
    @JSImport(".tslint-xANLscI2/lib/formatters/verboseFormatter.d.ts", "Formatter.metadata")
    @js.native
