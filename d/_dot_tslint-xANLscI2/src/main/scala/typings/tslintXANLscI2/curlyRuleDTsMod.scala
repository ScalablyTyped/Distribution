...
object curlyRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/curlyRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/curlyRule.d.ts", "Rule.FAILURE_STRING_AS_NEEDED")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/curlyRule.d.ts", "Rule.metadata")
    @js.native
