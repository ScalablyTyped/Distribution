...
object noEmptyRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noEmptyRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noEmptyRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noEmptyRule.d.ts", "Rule.metadata")
    @js.native
