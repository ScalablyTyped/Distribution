...
import typings.tslintXANLscI2.lintErrorDTsMod.LintError
import typings.tslintXANLscI2.runnerDTsMod.Logger
import typings.tslintXANLscI2.tslintXANLscI2Booleans.`false`
...
object testDTsMod {
  ...
  @JSImport(".tslint-xANLscI2/lib/test.d.ts", JSImport.Namespace)
  @js.native
