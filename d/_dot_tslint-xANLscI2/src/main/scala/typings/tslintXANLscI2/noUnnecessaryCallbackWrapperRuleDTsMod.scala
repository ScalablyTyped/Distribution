...
object noUnnecessaryCallbackWrapperRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noUnnecessaryCallbackWrapperRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noUnnecessaryCallbackWrapperRule.d.ts", "Rule.metadata")
    @js.native
