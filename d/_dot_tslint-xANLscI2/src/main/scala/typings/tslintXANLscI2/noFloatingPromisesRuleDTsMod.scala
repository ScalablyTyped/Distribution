...
object noFloatingPromisesRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noFloatingPromisesRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noFloatingPromisesRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noFloatingPromisesRule.d.ts", "Rule.metadata")
    @js.native
