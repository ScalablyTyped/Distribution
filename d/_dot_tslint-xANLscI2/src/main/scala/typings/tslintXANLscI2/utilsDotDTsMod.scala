...
object utilsDotDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/utils.d.ts", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.tslintXANLscI2.tslintXANLscI2Strings.utf8
    - typings.tslintXANLscI2.tslintXANLscI2Strings.`utf8-bom`
    - typings.tslintXANLscI2.tslintXANLscI2Strings.utf16le
    - typings.tslintXANLscI2.tslintXANLscI2Strings.utf16be
  */
  trait Encoding extends StObject
  object Encoding {
    
    inline def utf16be: typings.tslintXANLscI2.tslintXANLscI2Strings.utf16be = "utf16be".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.utf16be]
    
    inline def utf16le: typings.tslintXANLscI2.tslintXANLscI2Strings.utf16le = "utf16le".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.utf16le]
    
    inline def utf8: typings.tslintXANLscI2.tslintXANLscI2Strings.utf8 = "utf8".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.utf8]
    
    inline def `utf8-bom`: typings.tslintXANLscI2.tslintXANLscI2Strings.`utf8-bom` = "utf8-bom".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.`utf8-bom`]
  }
