...
object switchFinalBreakRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/switchFinalBreakRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/switchFinalBreakRule.d.ts", "Rule.FAILURE_STRING_ALWAYS")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/switchFinalBreakRule.d.ts", "Rule.FAILURE_STRING_NEVER")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/switchFinalBreakRule.d.ts", "Rule.metadata")
    @js.native
