...
object junitFormatterDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/formatters/junitFormatter.d.ts", "Formatter")
  @js.native
  ...
  object Formatter {
    ...
    @JSImport(".tslint-xANLscI2/lib/formatters/junitFormatter.d.ts", "Formatter.metadata")
    @js.native
