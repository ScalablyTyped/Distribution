...
object numberLiteralFormatRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/numberLiteralFormatRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/numberLiteralFormatRule.d.ts", "Rule.FAILURE_STRING_LEADING_0")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/numberLiteralFormatRule.d.ts", "Rule.FAILURE_STRING_LEADING_DECIMAL")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/numberLiteralFormatRule.d.ts", "Rule.FAILURE_STRING_NOT_UPPERCASE")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/numberLiteralFormatRule.d.ts", "Rule.FAILURE_STRING_TRAILING_0")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/numberLiteralFormatRule.d.ts", "Rule.FAILURE_STRING_TRAILING_DECIMAL")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/numberLiteralFormatRule.d.ts", "Rule.metadata")
    @js.native
