...
object noDuplicateSwitchCaseRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noDuplicateSwitchCaseRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noDuplicateSwitchCaseRule.d.ts", "Rule.metadata")
    @js.native
