...
object noObjectLiteralTypeAssertionRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noObjectLiteralTypeAssertionRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noObjectLiteralTypeAssertionRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noObjectLiteralTypeAssertionRule.d.ts", "Rule.metadata")
    @js.native
