...
object noSparseArraysRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noSparseArraysRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noSparseArraysRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noSparseArraysRule.d.ts", "Rule.metadata")
    @js.native
