...
object noPromiseAsBooleanRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noPromiseAsBooleanRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noPromiseAsBooleanRule.d.ts", "Rule.metadata")
    @js.native
