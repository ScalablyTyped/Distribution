...
object proseFormatterDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/formatters/proseFormatter.d.ts", "Formatter")
  @js.native
  ...
  object Formatter {
    ...
    @JSImport(".tslint-xANLscI2/lib/formatters/proseFormatter.d.ts", "Formatter.metadata")
    @js.native
