...
object preferReadonlyRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/preferReadonlyRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/preferReadonlyRule.d.ts", "Rule.metadata")
    @js.native
