...
object maxClassesPerFileRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/maxClassesPerFileRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/maxClassesPerFileRule.d.ts", "Rule.metadata")
    @js.native
