...
object callableTypesRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/callableTypesRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/callableTypesRule.d.ts", "Rule.metadata")
    @js.native
