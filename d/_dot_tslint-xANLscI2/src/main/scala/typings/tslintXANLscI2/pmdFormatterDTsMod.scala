...
object pmdFormatterDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/formatters/pmdFormatter.d.ts", "Formatter")
  @js.native
  ...
  object Formatter {
    ...
    @JSImport(".tslint-xANLscI2/lib/formatters/pmdFormatter.d.ts", "Formatter.metadata")
    @js.native
