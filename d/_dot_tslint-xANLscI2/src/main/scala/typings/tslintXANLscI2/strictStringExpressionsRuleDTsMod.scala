...
object strictStringExpressionsRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/strictStringExpressionsRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/strictStringExpressionsRule.d.ts", "Rule.CONVERSION_REQUIRED")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/strictStringExpressionsRule.d.ts", "Rule.metadata")
    @js.native
