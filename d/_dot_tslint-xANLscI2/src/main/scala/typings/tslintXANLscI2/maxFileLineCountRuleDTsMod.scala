...
object maxFileLineCountRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/maxFileLineCountRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/maxFileLineCountRule.d.ts", "Rule.metadata")
    @js.native
