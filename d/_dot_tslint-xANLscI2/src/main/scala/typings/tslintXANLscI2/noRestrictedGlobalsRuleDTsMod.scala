...
object noRestrictedGlobalsRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noRestrictedGlobalsRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noRestrictedGlobalsRule.d.ts", "Rule.metadata")
    @js.native
