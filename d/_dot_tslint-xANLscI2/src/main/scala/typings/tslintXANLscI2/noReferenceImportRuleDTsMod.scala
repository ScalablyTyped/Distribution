...
object noReferenceImportRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noReferenceImportRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noReferenceImportRule.d.ts", "Rule.metadata")
    @js.native
