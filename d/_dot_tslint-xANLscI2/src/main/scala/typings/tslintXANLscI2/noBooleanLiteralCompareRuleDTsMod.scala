...
object noBooleanLiteralCompareRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noBooleanLiteralCompareRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noBooleanLiteralCompareRule.d.ts", "Rule.metadata")
    @js.native
