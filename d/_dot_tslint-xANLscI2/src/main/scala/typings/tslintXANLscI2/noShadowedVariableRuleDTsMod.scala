...
object noShadowedVariableRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noShadowedVariableRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noShadowedVariableRule.d.ts", "Rule.metadata")
    @js.native
