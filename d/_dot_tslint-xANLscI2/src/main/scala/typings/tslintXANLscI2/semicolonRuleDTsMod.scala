...
object semicolonRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/semicolonRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/semicolonRule.d.ts", "Rule.FAILURE_STRING_COMMA")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/semicolonRule.d.ts", "Rule.FAILURE_STRING_MISSING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/semicolonRule.d.ts", "Rule.FAILURE_STRING_UNNECESSARY")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/semicolonRule.d.ts", "Rule.metadata")
    @js.native
