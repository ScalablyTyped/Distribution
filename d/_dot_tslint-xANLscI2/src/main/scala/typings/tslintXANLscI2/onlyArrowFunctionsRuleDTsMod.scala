...
object onlyArrowFunctionsRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/onlyArrowFunctionsRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/onlyArrowFunctionsRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/onlyArrowFunctionsRule.d.ts", "Rule.metadata")
    @js.native
