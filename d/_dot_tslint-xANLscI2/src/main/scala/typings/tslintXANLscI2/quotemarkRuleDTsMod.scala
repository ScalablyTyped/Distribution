...
object quotemarkRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/quotemarkRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/quotemarkRule.d.ts", "Rule.metadata")
    @js.native
