...
object banTsIgnoreRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/banTsIgnoreRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/banTsIgnoreRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/banTsIgnoreRule.d.ts", "Rule.metadata")
    @js.native
