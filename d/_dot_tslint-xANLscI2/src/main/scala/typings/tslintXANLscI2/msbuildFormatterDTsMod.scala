...
object msbuildFormatterDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/formatters/msbuildFormatter.d.ts", "Formatter")
  @js.native
  ...
  object Formatter {
    ...
    @JSImport(".tslint-xANLscI2/lib/formatters/msbuildFormatter.d.ts", "Formatter.metadata")
    @js.native
