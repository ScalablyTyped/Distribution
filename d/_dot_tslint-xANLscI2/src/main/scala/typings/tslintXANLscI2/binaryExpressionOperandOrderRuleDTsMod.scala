...
object binaryExpressionOperandOrderRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/binaryExpressionOperandOrderRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/binaryExpressionOperandOrderRule.d.ts", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/binaryExpressionOperandOrderRule.d.ts", "Rule.metadata")
    @js.native
