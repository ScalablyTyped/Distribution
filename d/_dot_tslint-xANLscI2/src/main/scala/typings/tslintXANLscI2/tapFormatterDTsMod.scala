...
object tapFormatterDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/formatters/tapFormatter.d.ts", "Formatter")
  @js.native
  ...
  object Formatter {
    ...
    @JSImport(".tslint-xANLscI2/lib/formatters/tapFormatter.d.ts", "Formatter.metadata")
    @js.native
