...
object noUseBeforeDeclareRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noUseBeforeDeclareRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noUseBeforeDeclareRule.d.ts", "Rule.metadata")
    @js.native
