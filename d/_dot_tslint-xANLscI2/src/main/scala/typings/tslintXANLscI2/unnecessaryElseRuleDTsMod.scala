...
object unnecessaryElseRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/unnecessaryElseRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/unnecessaryElseRule.d.ts", "Rule.metadata")
    @js.native
