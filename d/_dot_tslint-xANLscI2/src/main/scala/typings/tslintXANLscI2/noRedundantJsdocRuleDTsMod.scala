...
object noRedundantJsdocRuleDTsMod {
  
  @JSImport(".tslint-xANLscI2/lib/rules/noRedundantJsdocRule.d.ts", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noRedundantJsdocRule.d.ts", "Rule.FAILURE_STRING_REDUNDANT_TYPE")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/rules/noRedundantJsdocRule.d.ts", "Rule.metadata")
    @js.native
