...
import typings.tslintXANLscI2.mod.ILinterOptions
import typings.tslintXANLscI2.mod.LintResult
...
object linterDTsMod {
  ...
  @JSImport(".tslint-xANLscI2/lib/linter.d.ts", "Linter")
  @js.native
  ...
  object Linter {
    ...
    @JSImport(".tslint-xANLscI2/lib/linter.d.ts", "Linter.VERSION")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/linter.d.ts", "Linter.findConfiguration")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/linter.d.ts", "Linter.findConfigurationPath")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/linter.d.ts", "Linter.getRulesDirectories")
    @js.native
    ...
    @JSImport(".tslint-xANLscI2/lib/linter.d.ts", "Linter.loadConfigurationFromPath")
    @js.native
