...
import typings.tslintXANLscI2.anon.OptionsAny
import typings.tslintXANLscI2.tslintXANLscI2Booleans.`true`
...
object ruleDTsMod {
  ...
  @JSImport(".tslint-xANLscI2/lib/language/rule/rule.d.ts", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport(".tslint-xANLscI2/lib/language/rule/rule.d.ts", "Replacement")
  @js.native
  ...
  @JSImport(".tslint-xANLscI2/lib/language/rule/rule.d.ts", "RuleFailure")
  @js.native
  ...
  @JSImport(".tslint-xANLscI2/lib/language/rule/rule.d.ts", "RuleFailurePosition")
  @js.native
  ...
  inline def isTypedRule(rule: IRule): /* is .tslint-xANLscI2..tslint-xANLscI2/lib/language/rule/rule.d.ts.ITypedRule */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypedRule")(rule.asInstanceOf[js.Any]).asInstanceOf[/* is .tslint-xANLscI2..tslint-xANLscI2/lib/language/rule/rule.d.ts.ITypedRule */ Boolean]
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.tslintXANLscI2.tslintXANLscI2Strings.warning
    - typings.tslintXANLscI2.tslintXANLscI2Strings.error
    - typings.tslintXANLscI2.tslintXANLscI2Strings.off
  */
  trait RuleSeverity extends StObject
  object RuleSeverity {
    
    inline def error: typings.tslintXANLscI2.tslintXANLscI2Strings.error = "error".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.error]
    
    inline def off: typings.tslintXANLscI2.tslintXANLscI2Strings.off = "off".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.off]
    
    inline def warning: typings.tslintXANLscI2.tslintXANLscI2Strings.warning = "warning".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.warning]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.tslintXANLscI2.tslintXANLscI2Strings.functionality
    - typings.tslintXANLscI2.tslintXANLscI2Strings.maintainability
    - typings.tslintXANLscI2.tslintXANLscI2Strings.style
    - typings.tslintXANLscI2.tslintXANLscI2Strings.typescript
    - typings.tslintXANLscI2.tslintXANLscI2Strings.formatting
  */
  trait RuleType extends StObject
  object RuleType {
    
    inline def formatting: typings.tslintXANLscI2.tslintXANLscI2Strings.formatting = "formatting".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.formatting]
    
    inline def functionality: typings.tslintXANLscI2.tslintXANLscI2Strings.functionality = "functionality".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.functionality]
    
    inline def maintainability: typings.tslintXANLscI2.tslintXANLscI2Strings.maintainability = "maintainability".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.maintainability]
    
    inline def style: typings.tslintXANLscI2.tslintXANLscI2Strings.style = "style".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.style]
    
    inline def typescript: typings.tslintXANLscI2.tslintXANLscI2Strings.typescript = "typescript".asInstanceOf[typings.tslintXANLscI2.tslintXANLscI2Strings.typescript]
  }
}
