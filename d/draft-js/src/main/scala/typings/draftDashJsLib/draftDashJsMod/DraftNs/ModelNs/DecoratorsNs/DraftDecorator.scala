...
object DraftDecorator {
  ...
  def apply(
    ...
    strategy: (draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentBlock, js.Function2[/* start */ scala.Double, /* end */ scala.Double, scala.Unit], draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentState) => scala.Unit,
