package typings
package draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ConstantsNs
...
/* Rewritten from type alias, can be one of: 
  - draftDashJsLib.draftDashJsLibStrings.internal
  - draftDashJsLib.draftDashJsLibStrings.external
*/
