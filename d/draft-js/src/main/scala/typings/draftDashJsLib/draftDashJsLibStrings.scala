...
object draftDashJsLibStrings {
  @js.native
  sealed trait BOLD
    extends draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ConstantsNs.DraftInlineStyleType
  ...
  @js.native
  sealed trait IMAGE
    extends draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ConstantsNs.ComposedEntityType
  
  @js.native
  sealed trait IMMUTABLE
    extends draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ConstantsNs.DraftEntityMutability
  ...
  sealed trait `adjust-depth`
    extends draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.EditorChangeType
  
  @js.native
  sealed trait after
    extends draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ConstantsNs.DraftInsertionType
  ...
  sealed trait backspace
    extends draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ConstantsNs.DraftEditorCommand
  ...
  sealed trait backward
    extends draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ConstantsNs.DraftRemovalDirection
  ...
  @js.native
  sealed trait center
    extends draftDashJsLib.draftDashJsMod.DraftNs.ComponentNs.BaseNs.DraftTextAlignment
  ...
  sealed trait external
    extends draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ConstantsNs.DraftDragType
  ...
  sealed trait handled
    extends draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ConstantsNs.DraftHandleValue
  ...
  sealed trait redo
    extends draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ConstantsNs.DraftEditorCommand
       with draftDashJsLib.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.EditorChangeType
