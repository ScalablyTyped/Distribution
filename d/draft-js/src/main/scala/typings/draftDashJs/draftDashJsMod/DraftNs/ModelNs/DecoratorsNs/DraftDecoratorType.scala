package typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.DecoratorsNs
...
object DraftDecoratorType {
  ...
  def apply(
    ...
    getDecorations: (typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentBlock, typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentState) => List[String],
