...
object DraftDecorator {
  ...
  def apply(
    ...
    strategy: (typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentBlock, js.Function2[/* start */ Double, /* end */ Double, Unit], typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentState) => Unit,
