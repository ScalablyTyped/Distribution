...
- Dropped {[ P in keyof any ]: any} */ trait EditorState extends js.Object {
  ...
  def getCurrentContent(): typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentState
  /**
  ...
  def getNativelyRenderedContent(): typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentState
  def getRedoStack(): Stack[typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentState]
  def getSelection(): typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.SelectionState
  def getUndoStack(): Stack[typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentState]
...
object EditorState {
  ...
  def apply(
    ...
    getCurrentContent: () => typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentState,
    ...
    getNativelyRenderedContent: () => typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentState,
    getRedoStack: () => Stack[typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentState],
    getSelection: () => typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.SelectionState,
    getUndoStack: () => Stack[typings.draftDashJs.draftDashJsMod.DraftNs.ModelNs.ImmutableDataNs.ContentState],
