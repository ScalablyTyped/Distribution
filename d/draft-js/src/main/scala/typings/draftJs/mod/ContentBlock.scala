...
@js.native
class ContentBlock ()
  extends typings.draftJs.mod.Draft.Model.ImmutableData.ContentBlock {
  /**
  ...
  /* CompleteClass */
  override def getCharacterList(): List[typings.draftJs.mod.Draft.Model.ImmutableData.CharacterMetadata] = js.native
  /* CompleteClass */
