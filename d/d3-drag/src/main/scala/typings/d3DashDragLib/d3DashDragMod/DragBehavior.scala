...
trait DragBehavior[GElement /* <: DraggedElementBaseType */, Datum, Subject]
  ...
  /**
       ...
       */
  def apply(selection: d3DashSelectionLib.d3DashSelectionMod.Selection[GElement, Datum, _, _], args: js.Any*): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def container(): d3DashSelectionLib.d3DashSelectionMod.ValueFn[GElement, Datum, DragContainerElement] = js.native
  /**
       ...
       */
  def container(accessor: d3DashSelectionLib.d3DashSelectionMod.ValueFn[GElement, Datum, DragContainerElement]): this.type = js.native
  /**
  ...
  /**
       ...
       */
  def filter(): d3DashSelectionLib.d3DashSelectionMod.ValueFn[GElement, Datum, scala.Boolean] = js.native
  /**
       ...
       */
  def filter(filterFn: d3DashSelectionLib.d3DashSelectionMod.ValueFn[GElement, Datum, scala.Boolean]): this.type = js.native
  /**
  ...
  /**
       ...
       */
  def subject(): d3DashSelectionLib.d3DashSelectionMod.ValueFn[GElement, Datum, Subject] = js.native
  /**
       ...
       */
  def subject(accessor: d3DashSelectionLib.d3DashSelectionMod.ValueFn[GElement, Datum, Subject]): this.type = js.native
  /**
       ...
       */
  def touchable(): d3DashSelectionLib.d3DashSelectionMod.ValueFn[GElement, Datum, scala.Boolean] = js.native
  /**
       ...
       */
  def touchable(touchable: d3DashSelectionLib.d3DashSelectionMod.ValueFn[GElement, Datum, scala.Boolean]): this.type = js.native
  /**
