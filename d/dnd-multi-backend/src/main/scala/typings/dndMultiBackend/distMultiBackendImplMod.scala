...
object distMultiBackendImplMod {
  
  @JSImport("dnd-multi-backend/dist/MultiBackendImpl", "MultiBackendImpl")
  @js.native
  ...
  object MultiBackendImpl {
    ...
    @JSImport("dnd-multi-backend/dist/MultiBackendImpl", "MultiBackendImpl.isSetUp")
    @js.native
