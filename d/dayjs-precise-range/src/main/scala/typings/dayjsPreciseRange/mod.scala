...
object mod {
  ...
  @js.native
  open class Dayjs ()
    extends typings.dayjs.mod.Dayjs {
  ...
  object dayjsAugmentingMod {
    ...
    trait Dayjs extends StObject {
      ...
      @JSName("preciseDiff")
      def preciseDiff_true(d2: typings.dayjsPreciseRange.mod.dayjsAugmentingMod.Dayjs, returnValueObject: `true`): PreciseRangeValueObject = js.native
    }
