package typings.dayjsPreciseRange

import typings.dayjs.ILocale
import typings.dayjs.anon.PartialILocale
import typings.dayjs.mod.ConfigType
import typings.dayjs.mod.OptionType
import typings.dayjs.mod.PluginFunc
import typings.dayjs.pluginDurationMod.CreateDurationType
import typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.GlobalLocaleDataReturn
import typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.MonthNames
import typings.dayjs.pluginLocaleDataMod.dayjsAugmentingMod.WeekdayNames
import typings.dayjsPreciseRange.dayjsPreciseRangeBooleans.`false`
import typings.dayjsPreciseRange.dayjsPreciseRangeBooleans.`true`
import typings.dayjsPreciseRange.mod.dayjsAugmentingMod.PreciseRangeValueObject
...
object global {
  ...
  object preciseDiff {
    ...
    inline def apply(): typings.dayjs.mod.Dayjs = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: Unit, format: Unit, locale: String): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: Unit, format: Unit, locale: String, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: Unit, format: Unit, locale: Unit, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: Unit, format: Unit, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: Unit, format: OptionType): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: Unit, format: OptionType, locale: String): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: Unit, format: OptionType, locale: String, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: Unit, format: OptionType, locale: Unit, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: Unit, format: OptionType, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: ConfigType): typings.dayjs.mod.Dayjs = ^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any]).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: ConfigType, format: Unit, locale: String): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: ConfigType, format: Unit, locale: String, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: ConfigType, format: Unit, locale: Unit, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: ConfigType, format: Unit, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: ConfigType, format: OptionType): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: ConfigType, format: OptionType, locale: String): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: ConfigType, format: OptionType, locale: String, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: ConfigType, format: OptionType, locale: Unit, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], locale.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    inline def apply(date: ConfigType, format: OptionType, strict: Boolean): typings.dayjs.mod.Dayjs = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], format.asInstanceOf[js.Any], strict.asInstanceOf[js.Any])).asInstanceOf[typings.dayjs.mod.Dayjs]
    ...
    @js.native
    open class Dayjs ()
      extends typings.dayjsPreciseRange.mod.Dayjs {
    ...
    object dayjsMod {
      ...
      inline def preciseDiff_false(
        d1: typings.dayjsPreciseRange.mod.dayjsAugmentingMod.Dayjs,
        d2: typings.dayjsPreciseRange.mod.dayjsAugmentingMod.Dayjs,
      ...
      ): typings.dayjsPreciseRange.mod.dayjsAugmentingMod.PreciseRangeValueObject = (^.asInstanceOf[js.Dynamic].applyDynamic("preciseDiff")(d1.asInstanceOf[js.Any], d2.asInstanceOf[js.Any], returnValueObject.asInstanceOf[js.Any])).asInstanceOf[typings.dayjsPreciseRange.mod.dayjsAugmentingMod.PreciseRangeValueObject]
      
      @js.native
      trait Dayjs extends StObject {
        
        def preciseDiff(d2: typings.dayjsPreciseRange.mod.dayjsAugmentingMod.Dayjs): String = js.native
        @JSName("preciseDiff")
        def preciseDiff_false(d2: typings.dayjsPreciseRange.mod.dayjsAugmentingMod.Dayjs, returnValueObject: `false`): String = js.native
        @JSName("preciseDiff")
        def preciseDiff_true(d2: typings.dayjsPreciseRange.mod.dayjsAugmentingMod.Dayjs, returnValueObject: `true`): typings.dayjsPreciseRange.mod.dayjsAugmentingMod.PreciseRangeValueObject = js.native
      }
