...
trait Stack[This, Datum, Key] extends js.Object {
  ...
  /**
       ...
       */
  def offset(
    offset: js.Function2[/* series */ Series[Datum, Key], /* order */ js.Array[scala.Double], scala.Unit]
  ): this.type = js.native
  /**
       * Returns the current offset accessor, which defaults to stackOffsetNone; this uses a zero baseline.
       */
  @JSName("offset")
  def offset_Function2(): js.Function2[/* series */ Series[Datum, Key], /* order */ js.Array[scala.Double], scala.Unit] = js.native
  /**
  ...
  /**
       ...
       */
  def order(order: js.Array[scala.Double]): this.type = js.native
  /**
       ...
       */
  def order(order: js.Function1[/* series */ Series[Datum, Key], js.Array[scala.Double]]): this.type = js.native
  /**
       * Returns the current order accessor, which defaults to stackOrderNone; this uses the order given by the key accessor.
       */
  @JSName("order")
  def order_Function1(): js.Function1[/* series */ Series[Datum, Key], js.Array[scala.Double]] = js.native
  /**
  ...
  /**
       ...
       */
  def value(value: scala.Double): this.type = js.native
}
