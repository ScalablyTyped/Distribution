...
trait Pie[This, Datum] extends js.Object {
  ...
  /**
    ...
    */
  def endAngle(): js.ThisFunction2[/* this */ This, /* data */ js.Array[Datum], /* repeated */ js.Any, scala.Double] = js.native
  /**
    ...
    */
  def endAngle(
    angle: js.ThisFunction2[/* this */ This, /* data */ js.Array[Datum], /* repeated */ js.Any, scala.Double]
  ): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def padAngle(): js.ThisFunction2[/* this */ This, /* data */ js.Array[Datum], /* repeated */ js.Any, scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  def sort(): (js.Function2[/* a */ Datum, /* b */ Datum, scala.Double]) | scala.Null = js.native
  /**
  ...
  /**
    ...
    */
  def sortValues(): (js.Function2[/* a */ scala.Double, /* b */ scala.Double, scala.Double]) | scala.Null = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("sortValues")
  def `sortValues_<this>`(): this.type = js.native
  /**
    ...
    */
  @JSName("sort")
  def `sort_<this>`(): this.type = js.native
  /**
    * Returns the current start angle accessor, which defaults to a function returning a constant zero.
    */
  def startAngle(): js.ThisFunction2[/* this */ This, /* data */ js.Array[Datum], /* repeated */ js.Any, scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  def value(value: js.Function3[/* d */ Datum, /* i */ scala.Double, /* data */ js.Array[Datum], scala.Double]): this.type = js.native
  /**
