...
@js.native
trait Line[Datum] extends js.Object {
  /**
  ...
  /**
       ...
       */
  def x(): js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double] = js.native
  /**
       ...
       * being passed the element d, the index i, and the array data as three arguments.
       */
  def x(x: js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double]): this.type = js.native
  /**
  ...
  /**
       ...
       */
  def y(): js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double] = js.native
  /**
       ...
       * being passed the element d, the index i, and the array data as three arguments.
       */
  def y(y: js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double]): this.type = js.native
  /**
