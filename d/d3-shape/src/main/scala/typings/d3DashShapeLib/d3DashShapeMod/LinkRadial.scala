...
trait LinkRadial[This, LinkDatum, NodeDatum] extends js.Object {
  /**
       ...
       */
  def apply(`this`: This, d: LinkDatum, args: js.Any*): java.lang.String | scala.Null = js.native
  /**
       ...
       */
  def angle(): js.ThisFunction2[/* this */ This, /* node */ NodeDatum, /* repeated */js.Any, scala.Double] = js.native
  /**
       ...
       */
  def angle(angle: js.ThisFunction2[/* this */ This, /* node */ NodeDatum, /* repeated */js.Any, scala.Double]): this.type = js.native
  /**
  ...
  /**
       ...
       */
  def radius(): js.ThisFunction2[/* this */ This, /* node */ NodeDatum, /* repeated */js.Any, scala.Double] = js.native
  /**
       ...
       */
  def radius(
    radius: js.ThisFunction2[/* this */ This, /* node */ NodeDatum, /* repeated */js.Any, scala.Double]
  ): this.type = js.native
  /**
