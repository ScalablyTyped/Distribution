...
trait Link[This, LinkDatum, NodeDatum] extends js.Object {
  ...
  /**
       ...
       */
  def x(): js.ThisFunction2[/* this */ This, /* node */ NodeDatum, /* repeated */js.Any, scala.Double] = js.native
  /**
       ...
       */
  def x(x: js.ThisFunction2[/* this */ This, /* node */ NodeDatum, /* repeated */js.Any, scala.Double]): this.type = js.native
  /**
       ...
       */
  def y(): js.ThisFunction2[/* this */ This, /* node */ NodeDatum, /* repeated */js.Any, scala.Double] = js.native
  /**
       ...
       * receives as its first argument a node object followed by all additional arguments that were passed into the link generator.
       */
  def y(y: js.ThisFunction2[/* this */ This, /* node */ NodeDatum, /* repeated */js.Any, scala.Double]): this.type = js.native
}
