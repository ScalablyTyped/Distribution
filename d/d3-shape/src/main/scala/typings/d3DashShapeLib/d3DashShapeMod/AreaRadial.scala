...
trait AreaRadial[Datum] extends js.Object {
  ...
  /**
    ...
    */
  @JSName("curve")
  def curve_CCurveFactoryC[C /* <: CurveFactory */](): C = js.native
  /**
  ...
  /**
    ...
    */
  def endAngle(): (js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double]) | scala.Null = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("endAngle")
  def `endAngle_<this>`(): this.type = js.native
  /**
    * Returns the current innerRadius accessor. The default innerRadius accessor is a function a constant value of zero.
    */
  def innerRadius(): js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  def innerRadius(radius: scala.Double): this.type = js.native
  /**
  ...
  /**
    ...
    * @param radius A constant value.
    */
  def outerRadius(radius: scala.Double): this.type = js.native
  /**
    ...
    */
  @JSName("outerRadius")
  def `outerRadius_<this>`(): this.type = js.native
  /**
  ...
  /**
    ...
    * two-element array of numbers.
    */
  def startAngle(): js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double] = js.native
  /**
