...
trait Area[Datum] extends js.Object {
  ...
  /**
    ...
    * two-element array of numbers.
    */
  def x0(): js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double] = js.native
  /**
    ...
    * being passed the element d, the index i, and the array data as three arguments.
    */
  def x0(x: js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double]): this.type = js.native
  /**
    * Sets x0 to a constant number and returns this area generator.
    *
    * @param x A constant value.
    */
  def x0(x: scala.Double): this.type = js.native
  /**
    ...
    */
  def x1(): (js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double]) | scala.Null = js.native
  /**
    ...
    * being passed the element d, the index i, and the array data as three arguments.
    */
  def x1(x: js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double]): this.type = js.native
  /**
    * Sets x1 to a constant number and returns this area generator.
    *
    * @param x A constant value.
    */
  def x1(x: scala.Double): this.type = js.native
  /**
    ...
    */
  @JSName("x1")
  def `x1_<this>`(): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def y0(): js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double] = js.native
  /**
    ...
    * being passed the element d, the index i, and the array data as three arguments.
    */
  def y0(y: js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double]): this.type = js.native
  /**
    * Sets y0 to a constant number and returns this area generator.
    *
    * @param y A constant value.
    */
  def y0(y: scala.Double): this.type = js.native
  /**
    ...
    */
  def y1(): (js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double]) | scala.Null = js.native
  /**
    ...
    * being passed the element d, the index i, and the array data as three arguments.
    */
  def y1(y: js.Function3[/* d */ Datum, /* index */ scala.Double, /* data */ js.Array[Datum], scala.Double]): this.type = js.native
  /**
    * Sets y1 to a constant number and returns this area generator.
    *
    * @param y A constant value.
    */
  def y1(y: scala.Double): this.type = js.native
  /**
    ...
    */
  @JSName("y1")
  def `y1_<this>`(): this.type = js.native
}
