...
trait Symbol[This, Datum] extends js.Object {
  /**
    ...
    */
  def apply(`this`: This): java.lang.String | scala.Null = js.native
  def apply(`this`: This, d: Datum, args: js.Any*): java.lang.String | scala.Null = js.native
  /**
  ...
  /**
    ...
    */
  def size(): js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double] = js.native
  /**
    ...
    */
  def size(size: js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double]): this.type = js.native
  /**
