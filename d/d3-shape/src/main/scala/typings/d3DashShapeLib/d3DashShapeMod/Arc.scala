...
trait Arc[This, Datum] extends js.Object {
  ...
  /**
    ...
    * @param d The datum for which the arc is to be generated.
    */
  def centroid(d: Datum, args: js.Any*): js.Tuple2[scala.Double, scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  def cornerRadius(): js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double] = js.native
  /**
    ...
    */
  def cornerRadius(radius: js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double]): this.type = js.native
  /**
    ...
    */
  def cornerRadius(radius: scala.Double): this.type = js.native
  /**
    ...
    */
  def endAngle(): js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double] = js.native
  /**
    ...
    * receives the same arguments that were passed into the arc generator.
    */
  def endAngle(angle: js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double]): this.type = js.native
  /**
  ...
  /**
    ...
    * of the first argument passed into it.
    */
  def innerRadius(): js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double] = js.native
  /**
    ...
    * receives the same arguments that were passed into the arc generator.
    */
  def innerRadius(radius: js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double]): this.type = js.native
  /**
  ...
  /**
    ...
    * of the first argument passed into it.
    */
  def outerRadius(): js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double] = js.native
  /**
    ...
    * receives the same arguments that were passed into the arc generator.
    */
  def outerRadius(radius: js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double]): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def padAngle(
    angle: js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, js.UndefOr[scala.Double]]
  ): this.type = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("padAngle")
  def padAngle_ThisFunction2(): js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, js.UndefOr[scala.Double]] = js.native
  /**
    ...
    */
  def padRadius(): (js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double]) | scala.Null = js.native
  /*
    ...
    * receives the same arguments that were passed into the arc generator.
    */
  def padRadius(radius: js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double]): this.type = js.native
  /**
    ...
    */
  def padRadius(radius: scala.Double): this.type = js.native
  /**
    ...
    */
  @JSName("padRadius")
  def `padRadius_<this>`(): this.type = js.native
  /**
    * Returns the current start angle accessor, which defaults to a function returning the startAngle property
    * of the first argument passed into it.
    */
  def startAngle(): js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double] = js.native
  /**
    ...
    * receives the same arguments that were passed into the arc generator.
    */
  def startAngle(angle: js.ThisFunction2[/* this */ This, /* d */ Datum, /* repeated */ js.Any, scala.Double]): this.type = js.native
  /**
