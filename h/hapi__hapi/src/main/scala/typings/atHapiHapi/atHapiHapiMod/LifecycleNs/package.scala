...
package object LifecycleNs {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.atHapiHapi.atHapiHapiStrings.error
    - typings.atHapiHapi.atHapiHapiStrings.log
    - typings.atHapiHapi.atHapiHapiStrings.ignore
    - typings.atHapiHapi.atHapiHapiMod.LifecycleNs.Method
  */
