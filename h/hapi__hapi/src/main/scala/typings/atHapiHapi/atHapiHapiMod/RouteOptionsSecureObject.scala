...
import typings.atHapiHapi.Anon_Allowfrom
import typings.atHapiHapi.Anon_IncludeSubDomains
...
trait RouteOptionsSecureObject extends js.Object {
  /**
    ...
    */
  var hsts: js.UndefOr[Boolean | Double | Anon_IncludeSubDomains] = js.undefined
  /**
  ...
  /**
    ...
    */
  var xframe: js.UndefOr[`true` | deny | sameorigin | Anon_Allowfrom] = js.undefined
  /**
...
object RouteOptionsSecureObject {
  ...
  def apply(
    xss: Boolean,
    hsts: Boolean | Double | Anon_IncludeSubDomains = null,
