...
import typings.atHapiHapi.atHapiHapiStrings.buffer
import typings.atHapiHapi.atHapiHapiStrings.hex
import typings.atHapiHapi.atHapiHapiStrings.latin1
import typings.atHapiHapi.atHapiHapiStrings.plain
import typings.atHapiHapi.atHapiHapiStrings.stream
import typings.atHapiHapi.atHapiHapiStrings.ucs2
import typings.atHapiHapi.atHapiHapiStrings.utf16le
import typings.atHapiHapi.atHapiHapiStrings.utf8
...
trait ResponseObject extends Podium {
  ...
  def etag(tag: String, options: Anon_Vary): ResponseObject = js.native
  /**
