...
import typings.hapiHapi.libTypesPluginMod.DecorateName
import typings.hapiHapi.libTypesPluginMod.DecorationMethod
import typings.hapiHapi.libTypesPluginMod.Dependencies
import typings.hapiHapi.libTypesPluginMod.HandlerDecorationMethod
import typings.hapiHapi.libTypesPluginMod.Plugin
import typings.hapiHapi.libTypesPluginMod.PluginProperties
import typings.hapiHapi.libTypesPluginMod.PluginsListRegistered
import typings.hapiHapi.libTypesPluginMod.ServerRealm
import typings.hapiHapi.libTypesPluginMod.ServerRegisterOptions
import typings.hapiHapi.libTypesPluginMod.ServerRegisterPluginObject
import typings.hapiHapi.libTypesPluginMod.ServerRegisterPluginObjectArray
...
import typings.hapiHapi.libTypesRouteMod.PayloadCompressionDecoderSettings
import typings.hapiHapi.libTypesRouteMod.RouteCompressionEncoderSettings
import typings.hapiHapi.libTypesRouteMod.RulesOptions
import typings.hapiHapi.libTypesRouteMod.RulesProcessor
import typings.hapiHapi.libTypesRouteMod.ServerRoute
import typings.hapiHapi.libTypesServerAuthMod.ServerAuth
import typings.hapiHapi.libTypesServerCacheMod.CachePolicyOptions
import typings.hapiHapi.libTypesServerCacheMod.ServerCache
import typings.hapiHapi.libTypesServerEventsMod.ServerEvents
import typings.hapiHapi.libTypesServerEventsMod.ServerEventsApplication
import typings.hapiHapi.libTypesServerExtMod.ServerExtEventsObject
import typings.hapiHapi.libTypesServerExtMod.ServerExtEventsRequestObject
import typings.hapiHapi.libTypesServerExtMod.ServerExtOptions
import typings.hapiHapi.libTypesServerExtMod.ServerExtPointFunction
...
import typings.hapiHapi.libTypesServerInfoMod.ServerInfo
import typings.hapiHapi.libTypesServerInjectMod.ServerInjectOptions
import typings.hapiHapi.libTypesServerInjectMod.ServerInjectResponse
import typings.hapiHapi.libTypesServerMethodsMod.ServerMethod
import typings.hapiHapi.libTypesServerMethodsMod.ServerMethodConfigurationObject
import typings.hapiHapi.libTypesServerMethodsMod.ServerMethodOptions
import typings.hapiHapi.libTypesServerMethodsMod.ServerMethods
import typings.hapiHapi.libTypesServerOptionsMod.ServerOptions
import typings.hapiHapi.libTypesServerStateMod.ServerState
...
import typings.hapiMimos.mod.Mimos
...
object libTypesServerServerMod {
  
  @JSImport("@hapi/hapi/lib/types/server/server", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@hapi/hapi/lib/types/server/server", "Server")
  @js.native
  /**
    ...
    */
  open class Server_[A] () extends StObject {
    ...
    /**
      ...
      * are called, where:
      */
    def control(server: Server_[ServerApplicationState]): Unit = js.native
    ...
    def decorate_server(
      ...
      method: js.Function1[
          /* existing */ js.Function1[/* repeated */ Any, Any], 
          DecorationMethod[Server_[ServerApplicationState]]
        ],
      options: `0`
    ): Unit = js.native
    @JSName("decorate")
    def decorate_server(`type`: server, property: DecorateName, method: DecorationMethod[Server_[ServerApplicationState]]): Unit = js.native
    @JSName("decorate")
    def decorate_server(
      `type`: server,
      property: DecorateName,
      method: DecorationMethod[Server_[ServerApplicationState]],
      options: Apply
    ): Unit = js.native
    @JSName("decorate")
    ...
    def dependency(
      ...
      after: js.Function1[/* server */ Server_[ServerApplicationState], js.Promise[Unit]]
    ): Unit = js.native
    ...
    def ext(events: js.Array[ServerExtEventsObject[A] | ServerExtEventsRequestObject]): Unit = js.native
    /**
      ...
      */
    def ext(events: ServerExtEventsObject[A]): Unit = js.native
    ...
    /**
      ...
      */
    def ext(event: ServerExtType, method: ServerExtPointFunction[A]): Unit = js.native
    def ext(event: ServerExtType, method: ServerExtPointFunction[A], options: ServerExtOptions): Unit = js.native
    ...
    /**
      ...
      */
    def lookup(id: String): RequestRoute[ReqRefDefaults] | Null = js.native
    ...
    /**
      ...
      */
    def `match`(method: HTTP_METHODS, path: String): RequestRoute[ReqRefDefaults] | Null = js.native
    def `match`(method: HTTP_METHODS, path: String, host: String): RequestRoute[ReqRefDefaults] | Null = js.native
    ...
    /**
      ...
      */
    var mime: Mimos[js.Object] = js.native
    ...
    def register(plugins: js.Array[(Plugin[Any, Unit]) | (ServerRegisterPluginObject[Any, Unit])]): js.Promise[this.type] = js.native
    def register(
      plugins: js.Array[(Plugin[Any, Unit]) | (ServerRegisterPluginObject[Any, Unit])],
    ...
    /**
      ...
      */
    def register[T, D](plugins: Plugin[T, D]): js.Promise[this.type & D] = js.native
    def register[T, D](plugins: Plugin[T, D], options: ServerRegisterOptions): js.Promise[this.type & D] = js.native
    def register[T, D](plugin: ServerRegisterPluginObject[T, D]): js.Promise[this.type & D] = js.native
    def register[T, D](plugin: ServerRegisterPluginObject[T, D], options: ServerRegisterOptions): js.Promise[this.type & D] = js.native
    @JSName("register")
    def register_TUVWXYZ[T, U, V, W, X, Y, Z](plugins: ServerRegisterPluginObjectArray[T, U, V, W, X, Y, Z]): js.Promise[this.type] = js.native
    @JSName("register")
    def register_TUVWXYZ[T, U, V, W, X, Y, Z](plugins: ServerRegisterPluginObjectArray[T, U, V, W, X, Y, Z], options: ServerRegisterOptions): js.Promise[this.type] = js.native
    ...
    /**
      ...
      */
    def table(): js.Array[RequestRoute[ReqRefDefaults]] = js.native
    def table(host: String): js.Array[RequestRoute[ReqRefDefaults]] = js.native
    def table(host: js.Array[String]): js.Array[RequestRoute[ReqRefDefaults]] = js.native
  ...
  inline def server[A](): Server_[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("server")().asInstanceOf[Server_[A]]
  inline def server[A](opts: ServerOptions): Server_[A] = ^.asInstanceOf[js.Dynamic].applyDynamic("server")(opts.asInstanceOf[js.Any]).asInstanceOf[Server_[A]]
