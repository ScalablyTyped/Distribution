...
object libTypesServerStateMod {
  ...
  trait ServerState extends StObject {
    ...
    /**
      ...
      */
    def parse(header: String): js.Promise[Record[String, String]] = js.native
  ...
  type ServerStateCookieOptions = StateOptions[Request[ReqRefDefaults]]
  ...
  object ServerStateFormat {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ServerStateFormat] (val x: Self) extends AnyVal {
