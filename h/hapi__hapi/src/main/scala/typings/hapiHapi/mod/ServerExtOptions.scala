...
trait ServerExtOptions extends js.Object {
  ...
  /**
    ...
    */
  var sandbox: js.UndefOr[typings.hapiHapi.hapiHapiStrings.server | plugin] = js.native
}
...
object ServerExtOptions {
  ...
  implicit class ServerExtOptionsOps[Self <: ServerExtOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSandbox(value: typings.hapiHapi.hapiHapiStrings.server | plugin): Self = this.set("sandbox", value.asInstanceOf[js.Any])
    @scala.inline
