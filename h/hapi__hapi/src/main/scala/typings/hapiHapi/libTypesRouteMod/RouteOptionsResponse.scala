...
trait RouteOptionsResponse extends StObject {
  ...
  /**
    ...
    */
  var status: js.UndefOr[Record[String, RouteOptionsResponseSchema]] = js.undefined
}
object RouteOptionsResponse {
  ...
  implicit open class MutableBuilder[Self <: RouteOptionsResponse] (val x: Self) extends AnyVal {
    ...
    inline def setStatus(value: Record[String, RouteOptionsResponseSchema]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
