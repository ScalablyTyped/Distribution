...
import typings.hapiHapi.libTypesPluginMod.PluginSpecificConfiguration
...
trait CommonRouteProperties[Refs /* <: ReqRef */] extends StObject {
  ...
  /**
    ...
    */
  var app: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @hapi/hapi.@hapi/hapi/lib/types/request.MergeRefs<Refs>['RouteApp'] */ js.Any
  ] = js.undefined
  ...
  /**
    ...
    */
  var bind: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @hapi/hapi.@hapi/hapi/lib/types/request.MergeRefs<Refs>['Bind'] */ js.Any
  ] = js.undefined
  ...
  /**
    ...
    */
  var compression: js.UndefOr[Record[String, RouteCompressionEncoderSettings]] = js.undefined
...
object CommonRouteProperties {
  ...
  implicit open class MutableBuilder[Self <: CommonRouteProperties[?], Refs /* <: ReqRef */] (val x: Self & CommonRouteProperties[Refs]) extends AnyVal {
    ...
    inline def setApp(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @hapi/hapi.@hapi/hapi/lib/types/request.MergeRefs<Refs>['RouteApp'] */ js.Any
    ): Self = StObject.set(x, "app", value.asInstanceOf[js.Any])
    
    inline def setAppUndefined: Self = StObject.set(x, "app", js.undefined)
    
    inline def setBind(
      value: /* import warning: importer.ImportType#apply Failed type conversion: @hapi/hapi.@hapi/hapi/lib/types/request.MergeRefs<Refs>['Bind'] */ js.Any
    ...
    inline def setCompression(value: Record[String, RouteCompressionEncoderSettings]): Self = StObject.set(x, "compression", value.asInstanceOf[js.Any])
    ...
    inline def setTimeout(value: Server): Self = StObject.set(x, "timeout", value.asInstanceOf[js.Any])
