...
import typings.hapiHapi.hapiHapiStrings.disabled
import typings.hapiHapi.hapiHapiStrings.enabled
...
trait RouteOptionsSecureObject extends StObject {
  ...
  /**
    ...
    */
  var xss: js.UndefOr[disabled | enabled | `false`] = js.undefined
}
object RouteOptionsSecureObject {
  ...
  implicit open class MutableBuilder[Self <: RouteOptionsSecureObject] (val x: Self) extends AnyVal {
    ...
    inline def setXss(value: disabled | enabled | `false`): Self = StObject.set(x, "xss", value.asInstanceOf[js.Any])
