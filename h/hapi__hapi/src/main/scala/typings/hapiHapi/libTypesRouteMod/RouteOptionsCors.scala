...
trait RouteOptionsCors extends StObject {
  ...
  /**
    ...
    */
  var preflightStatusCode: js.UndefOr[`200` | `204`] = js.undefined
}
object RouteOptionsCors {
  ...
  implicit open class MutableBuilder[Self <: RouteOptionsCors] (val x: Self) extends AnyVal {
    ...
    inline def setPreflightStatusCode(value: `200` | `204`): Self = StObject.set(x, "preflightStatusCode", value.asInstanceOf[js.Any])
    
    inline def setPreflightStatusCodeUndefined: Self = StObject.set(x, "preflightStatusCode", js.undefined)
  }
}
