...
import typings.hapiHapi.hapiHapiStrings.remove
...
trait RouteOptionsPayload extends StObject {
  ...
  /**
    ...
    */
  var compression: js.UndefOr[Record[String, PayloadCompressionDecoderSettings]] = js.undefined
...
object RouteOptionsPayload {
  ...
  implicit open class MutableBuilder[Self <: RouteOptionsPayload] (val x: Self) extends AnyVal {
    ...
    inline def setCompression(value: Record[String, PayloadCompressionDecoderSettings]): Self = StObject.set(x, "compression", value.asInstanceOf[js.Any])
