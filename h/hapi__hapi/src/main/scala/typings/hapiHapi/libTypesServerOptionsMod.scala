...
import typings.hapiHapi.anon.CleanStop
...
import typings.hapiHapi.anon.Remote
...
import typings.hapiHapi.libTypesServerCacheMod.CacheProvider
...
object libTypesServerOptionsMod {
  ...
  trait ServerOptions extends StObject {
    ...
    var info: js.UndefOr[Remote] = js.undefined
    ...
    /**
      ...
      */
    var operations: js.UndefOr[CleanStop] = js.undefined
  ...
  object ServerOptions {
    ...
    implicit open class MutableBuilder[Self <: ServerOptions] (val x: Self) extends AnyVal {
      ...
      inline def setInfo(value: Remote): Self = StObject.set(x, "info", value.asInstanceOf[js.Any])
      ...
      inline def setOperations(value: CleanStop): Self = StObject.set(x, "operations", value.asInstanceOf[js.Any])
