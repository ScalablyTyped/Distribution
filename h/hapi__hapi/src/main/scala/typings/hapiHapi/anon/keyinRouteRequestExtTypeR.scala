...
trait keyinRouteRequestExtTypeR extends StObject {
  ...
  var onPostResponse: js.UndefOr[RouteExtObject | js.Array[RouteExtObject]] = js.undefined
...
object keyinRouteRequestExtTypeR {
  ...
  extension [Self <: keyinRouteRequestExtTypeR](x: Self) {
    ...
    inline def setOnCredentialsVarargs(value: RouteExtObject*): Self = StObject.set(x, "onCredentials", js.Array(value*))
    ...
    inline def setOnPostAuthVarargs(value: RouteExtObject*): Self = StObject.set(x, "onPostAuth", js.Array(value*))
    ...
    inline def setOnPostHandlerVarargs(value: RouteExtObject*): Self = StObject.set(x, "onPostHandler", js.Array(value*))
    
    inline def setOnPostResponse(value: RouteExtObject | js.Array[RouteExtObject]): Self = StObject.set(x, "onPostResponse", value.asInstanceOf[js.Any])
    
    inline def setOnPostResponseUndefined: Self = StObject.set(x, "onPostResponse", js.undefined)
    
    inline def setOnPostResponseVarargs(value: RouteExtObject*): Self = StObject.set(x, "onPostResponse", js.Array(value*))
    ...
    inline def setOnPreAuthVarargs(value: RouteExtObject*): Self = StObject.set(x, "onPreAuth", js.Array(value*))
    ...
    inline def setOnPreHandlerVarargs(value: RouteExtObject*): Self = StObject.set(x, "onPreHandler", js.Array(value*))
    ...
    inline def setOnPreResponseVarargs(value: RouteExtObject*): Self = StObject.set(x, "onPreResponse", js.Array(value*))
  }
}
