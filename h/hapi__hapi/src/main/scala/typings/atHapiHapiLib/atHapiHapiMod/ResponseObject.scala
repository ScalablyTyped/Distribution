...
trait ResponseObject
  ...
  /**
    ...
    */
  val headers: atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[java.lang.String | js.Array[java.lang.String]] = js.native
  /**
    * Default value: {}.
  ...
  /**
    ...
    */
  val source: atHapiHapiLib.atHapiHapiMod.LifecycleNs.ReturnValue = js.native
  /**
    * Default value: 200.
  ...
  /**
    ...
    */
  val variety: atHapiHapiLib.atHapiHapiLibStrings.plain | atHapiHapiLib.atHapiHapiLibStrings.buffer | atHapiHapiLib.atHapiHapiLibStrings.stream = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("encoding")
  def encoding_ascii(encoding: atHapiHapiLib.atHapiHapiLibStrings.ascii): ResponseObject = js.native
  @JSName("encoding")
  def encoding_base64(encoding: atHapiHapiLib.atHapiHapiLibStrings.base64): ResponseObject = js.native
  @JSName("encoding")
  def encoding_binary(encoding: atHapiHapiLib.atHapiHapiLibStrings.binary): ResponseObject = js.native
  @JSName("encoding")
  def encoding_hex(encoding: atHapiHapiLib.atHapiHapiLibStrings.hex): ResponseObject = js.native
  @JSName("encoding")
  def encoding_latin1(encoding: atHapiHapiLib.atHapiHapiLibStrings.latin1): ResponseObject = js.native
  @JSName("encoding")
  def encoding_ucs2(encoding: atHapiHapiLib.atHapiHapiLibStrings.ucs2): ResponseObject = js.native
  @JSName("encoding")
  def encoding_utf16le(encoding: atHapiHapiLib.atHapiHapiLibStrings.utf16le): ResponseObject = js.native
  @JSName("encoding")
  def encoding_utf8(encoding: atHapiHapiLib.atHapiHapiLibStrings.utf8): ResponseObject = js.native
  /**
  ...
  def etag(tag: java.lang.String, options: atHapiHapiLib.Anon_Vary): ResponseObject = js.native
  /**
  ...
  /**
    ...
    */
  def replacer(method: atHapiHapiLib.atHapiHapiMod.JsonNs.StringifyReplacer): ResponseObject = js.native
  /**
