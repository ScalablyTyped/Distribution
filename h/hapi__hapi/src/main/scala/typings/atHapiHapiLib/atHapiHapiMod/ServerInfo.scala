...
trait ServerInfo extends js.Object {
  ...
  /**
    ...
    */
  var protocol: atHapiHapiLib.atHapiHapiLibStrings.http | atHapiHapiLib.atHapiHapiLibStrings.https | atHapiHapiLib.atHapiHapiLibStrings.socket
  /**
...
object ServerInfo {
  ...
  def apply(
    ...
    protocol: atHapiHapiLib.atHapiHapiLibStrings.http | atHapiHapiLib.atHapiHapiLibStrings.https | atHapiHapiLib.atHapiHapiLibStrings.socket,
