...
trait ServerMethodCache
  extends atHapiCatboxLib.atHapiCatboxMod.PolicyOptions[js.Any] {
  @JSName("generateTimeout")
  var generateTimeout_ServerMethodCache: scala.Double | atHapiHapiLib.atHapiHapiLibNumbers.`false`
}

object ServerMethodCache {
  @scala.inline
  def apply(
    generateTimeout: scala.Double | atHapiHapiLib.atHapiHapiLibNumbers.`false`,
    dropOnError: js.UndefOr[scala.Boolean] = js.undefined,
    expiresAt: java.lang.String = null,
    expiresIn: scala.Int | scala.Double = null,
    generateFunc: atHapiCatboxLib.atHapiCatboxMod.GenerateFunc[js.Any] = null,
