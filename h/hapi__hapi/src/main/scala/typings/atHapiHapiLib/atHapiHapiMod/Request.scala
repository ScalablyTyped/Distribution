...
trait Request
  ...
  /**
    ...
    */
  val headers: atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[java.lang.String] = js.native
  /**
    * Request information:
  ...
  /**
    ...
    */
  val method: atHapiHapiLib.atHapiHapiMod.UtilNs.HTTP_METHODS_PARTIAL_LOWERCASE = js.native
  /**
    * The parsed content-type header. Only available when payload parsing enabled and no payload error occurred.
    */
  val mime: java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  val params: atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[java.lang.String] = js.native
  /**
    * An array containing all the path params values in the order they appeared in the path.
    */
  val paramsArray: js.Array[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val payload: nodeLib.streamMod.Readable | nodeLib.Buffer | java.lang.String | js.Object = js.native
  /**
  ...
  /**
    ...
    */
  val pre: atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[_] = js.native
  /**
    * Same as pre but represented as the response object created by the pre method.
    */
  val preResponses: atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[_] = js.native
  /**
  ...
  /**
    ...
    */
  val raw: atHapiHapiLib.Anon_Req = js.native
  /**
    ...
    */
  var response: ResponseObject | atHapiBoomLib.atHapiBoomMod.namespaced[_] = js.native
  /**
  ...
  /**
    ...
    */
  val state: atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[_] = js.native
  /**
  ...
  def generateResponse(source: java.lang.String, options: atHapiHapiLib.Anon_Close): ResponseObject = js.native
  def generateResponse(source: js.Object): ResponseObject = js.native
  def generateResponse(source: js.Object, options: atHapiHapiLib.Anon_Close): ResponseObject = js.native
  def generateResponse(source: scala.Null, options: atHapiHapiLib.Anon_Close): ResponseObject = js.native
  /**
    ...
    */
  def log(tags: java.lang.String): scala.Unit = js.native
  def log(tags: java.lang.String, data: java.lang.String): scala.Unit = js.native
  def log(tags: java.lang.String, data: js.Function0[java.lang.String | js.Object]): scala.Unit = js.native
  def log(tags: java.lang.String, data: js.Object): scala.Unit = js.native
  def log(tags: js.Array[java.lang.String]): scala.Unit = js.native
  def log(tags: js.Array[java.lang.String], data: java.lang.String): scala.Unit = js.native
  def log(tags: js.Array[java.lang.String], data: js.Function0[java.lang.String | js.Object]): scala.Unit = js.native
  def log(tags: js.Array[java.lang.String], data: js.Object): scala.Unit = js.native
  /**
    ...
    */
  def setMethod(method: atHapiHapiLib.atHapiHapiMod.UtilNs.HTTP_METHODS_PARTIAL): scala.Unit = js.native
  /**
