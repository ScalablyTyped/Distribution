...
trait ServerOptions extends js.Object {
  ...
  var cache: js.UndefOr[
    CacheProvider[atHapiCatboxLib.atHapiCatboxMod.ClientOptions] | ServerOptionsCache | js.Array[ServerOptionsCache]
  ] = js.undefined
  /**
  ...
  /**
    ...
    * false.
    */
  var debug: js.UndefOr[atHapiHapiLib.atHapiHapiLibNumbers.`false` | atHapiHapiLib.Anon_False] = js.undefined
  /**
  ...
  /**
    ...
    */
  var load: js.UndefOr[atHapiHapiLib.Anon_Concurrent] = js.undefined
  /**
    * Default value: none.
    ...
    */
  var mime: js.UndefOr[atHapiMimosLib.atHapiMimosMod.MimosOptions] = js.undefined
  /**
    * Default value: {}.
  ...
  /**
    ...
    */
  var query: js.UndefOr[atHapiHapiLib.Anon_Parser] = js.undefined
  /**
    ...
    */
  var router: js.UndefOr[atHapiHapiLib.Anon_IsCaseSensitive] = js.undefined
  /**
    * Default value: none.
  ...
  var state: js.UndefOr[atHapiHapiLib.Anon_Base64] = js.undefined
  /**
    * Default value: none.
...
object ServerOptions {
  ...
  def apply(
    ...
    cache: CacheProvider[atHapiCatboxLib.atHapiCatboxMod.ClientOptions] | ServerOptionsCache | js.Array[ServerOptionsCache] = null,
    compression: scala.Boolean | ServerOptionsCompression = null,
    debug: atHapiHapiLib.atHapiHapiLibNumbers.`false` | atHapiHapiLib.Anon_False = null,
    host: java.lang.String = null,
    listener: nodeLib.httpMod.Server = null,
    load: atHapiHapiLib.Anon_Concurrent = null,
    mime: atHapiMimosLib.atHapiMimosMod.MimosOptions = null,
    plugins: PluginSpecificConfiguration = null,
    port: scala.Double | java.lang.String = null,
    query: atHapiHapiLib.Anon_Parser = null,
    router: atHapiHapiLib.Anon_IsCaseSensitive = null,
    routes: RouteOptions = null,
    state: atHapiHapiLib.Anon_Base64 = null,
