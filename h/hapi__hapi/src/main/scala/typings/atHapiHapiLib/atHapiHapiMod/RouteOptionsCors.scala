...
trait RouteOptionsCors extends js.Object {
  ...
  var origin: js.UndefOr[
    js.Array[java.lang.String] | atHapiHapiLib.atHapiHapiLibStrings.`*` | atHapiHapiLib.atHapiHapiLibStrings.ignore
  ] = js.undefined
}
...
object RouteOptionsCors {
  ...
  def apply(
    ...
    origin: js.Array[java.lang.String] | atHapiHapiLib.atHapiHapiLibStrings.`*` | atHapiHapiLib.atHapiHapiLibStrings.ignore = null
  ): RouteOptionsCors = {
