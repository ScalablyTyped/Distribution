...
trait RouteOptionsValidate extends js.Object {
  ...
  /**
    ...
    * @default true
    */
  var options: js.UndefOr[atHapiJoiLib.atHapiJoiMod.ValidationOptions | js.Object] = js.undefined
  /**
...
object RouteOptionsValidate {
  ...
  def apply(
    ...
    options: atHapiJoiLib.atHapiJoiMod.ValidationOptions | js.Object = null,
