...
trait RouteOptionsPayload extends js.Object {
  /**
    ...
    */
  var allow: js.UndefOr[java.lang.String | js.Array[java.lang.String]] = js.undefined
  /**
    * Default value: none.
    ...
    */
  var compression: js.UndefOr[atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[PayloadCompressionDecoderSettings]] = js.undefined
  /**
    ...
    */
  var defaultContentType: js.UndefOr[java.lang.String] = js.undefined
  /**
  ...
  /**
    ...
    */
  var multipart: js.UndefOr[atHapiHapiLib.atHapiHapiLibNumbers.`false` | atHapiHapiLib.Anon_Annotated] = js.undefined
  /**
    * Default value: 'data'.
  ...
  /**
    ...
    */
  var `override`: js.UndefOr[java.lang.String] = js.undefined
  /**
    * Default value: true.
    ...
    */
  var parse: js.UndefOr[scala.Boolean | atHapiHapiLib.atHapiHapiLibStrings.gunzip] = js.undefined
  /**
    ...
    */
  var timeout: js.UndefOr[atHapiHapiLib.atHapiHapiLibNumbers.`false` | scala.Double] = js.undefined
  /**
...
object RouteOptionsPayload {
  ...
  def apply(
    ...
    compression: atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[PayloadCompressionDecoderSettings] = null,
    ...
    multipart: atHapiHapiLib.atHapiHapiLibNumbers.`false` | atHapiHapiLib.Anon_Annotated = null,
    output: PayloadOutput = null,
    `override`: java.lang.String = null,
    parse: scala.Boolean | atHapiHapiLib.atHapiHapiLibStrings.gunzip = null,
    timeout: atHapiHapiLib.atHapiHapiLibNumbers.`false` | scala.Double = null,
