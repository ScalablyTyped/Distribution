...
trait ServerState extends js.Object {
  ...
  def add(name: java.lang.String, options: ServerStateCookieOptions): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def parse(header: java.lang.String): js.Promise[atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[java.lang.String]] = js.native
}
