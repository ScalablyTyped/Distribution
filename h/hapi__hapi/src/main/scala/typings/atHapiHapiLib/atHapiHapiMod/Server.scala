...
class Server () extends js.Object {
  ...
  /**
    ...
    */
  val decorations: atHapiHapiLib.Anon_Request = js.native
  /**
  ...
  /**
    ...
    */
  val load: atHapiHapiLib.Anon_ConcurrentEventLoopDelay = js.native
  /**
    ...
    */
  val methods: atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[ServerMethod] = js.native
  /**
  ...
  /**
    ...
    */
  val `type`: atHapiHapiLib.atHapiHapiLibStrings.socket | atHapiHapiLib.atHapiHapiLibStrings.tcp = js.native
  /**
  ...
  /**
    * [See docs](https://github.com/hapijs/hapi/blob/master/API.md#-servercacheoptions)
    */
  def cache[T, O /* <: CachePolicyOptions[T] */](options: O): atHapiCatboxLib.atHapiCatboxMod.Policy[T, O] = js.native
  /**
  ...
  def decorate_handler(
    `type`: atHapiHapiLib.atHapiHapiLibStrings.handler,
  ...
  def decorate_handler(
    ...
    property: DecorateName,
    method: HandlerDecorationMethod,
    options: atHapiHapiLib.Anon_Apply
  ): scala.Unit = js.native
  @JSName("decorate")
  def decorate_request(
    `type`: atHapiHapiLib.atHapiHapiLibStrings.request,
    property: DecorateName,
  ...
  def decorate_request(
    ...
    options: atHapiHapiLib.Anon_ApplyExtend
  ): scala.Unit = js.native
  @JSName("decorate")
  def decorate_request(
    `type`: atHapiHapiLib.atHapiHapiLibStrings.request,
    ...
    options: atHapiHapiLib.Anon_ApplyExtendTrue
  ): scala.Unit = js.native
  @JSName("decorate")
  def decorate_server(
    `type`: atHapiHapiLib.atHapiHapiLibStrings.server,
    property: DecorateName,
  ...
  def decorate_server(
    ...
    options: atHapiHapiLib.Anon_ApplyExtendTrueBoolean
  ): scala.Unit = js.native
  @JSName("decorate")
  def decorate_toolkit(
    `type`: atHapiHapiLib.atHapiHapiLibStrings.toolkit,
    property: DecorateName,
  ...
  def ext(event: ServerRequestExtType, method: atHapiHapiLib.atHapiHapiMod.LifecycleNs.Method): scala.Unit = js.native
  def ext(
    event: ServerRequestExtType,
    method: atHapiHapiLib.atHapiHapiMod.LifecycleNs.Method,
  ...
  /**
    ...
    */
  def `match`(method: atHapiHapiLib.atHapiHapiMod.UtilNs.HTTP_METHODS, path: java.lang.String): RequestRoute | scala.Null = js.native
  def `match`(
    method: atHapiHapiLib.atHapiHapiMod.UtilNs.HTTP_METHODS,
    path: java.lang.String,
    host: java.lang.String
  ): RequestRoute | scala.Null = js.native
  /**
  ...
  /**
    ...
    */
  def rules(processor: js.Function2[/* rules */ js.Object, /* info */ atHapiHapiLib.Anon_Method, js.Object]): scala.Unit = js.native
  def rules(
    processor: js.Function2[/* rules */ js.Object, /* info */ atHapiHapiLib.Anon_Method, js.Object],
    options: atHapiHapiLib.Anon_Validate
  ): scala.Unit = js.native
  ...
  def stop(options: atHapiHapiLib.Anon_Timeout): js.Promise[scala.Unit] = js.native
  /**
