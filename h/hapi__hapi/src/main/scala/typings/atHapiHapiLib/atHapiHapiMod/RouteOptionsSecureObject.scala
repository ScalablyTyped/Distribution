...
trait RouteOptionsSecureObject extends js.Object {
  ...
  /**
    ...
    */
  var referrer: js.UndefOr[atHapiHapiLib.atHapiHapiLibNumbers.`false` | ReferrerPolicy] = js.undefined
  /**
    * controls the 'X-Frame-Options' header
    */
  var xframe: js.UndefOr[
    atHapiHapiLib.atHapiHapiLibNumbers.`true` | atHapiHapiLib.atHapiHapiLibStrings.deny | atHapiHapiLib.atHapiHapiLibStrings.sameorigin | atHapiHapiLib.Anon_Allowfrom
  ] = js.undefined
  /**
...
object RouteOptionsSecureObject {
  ...
  def apply(
    ...
    xframe: atHapiHapiLib.atHapiHapiLibNumbers.`true` | atHapiHapiLib.atHapiHapiLibStrings.deny | atHapiHapiLib.atHapiHapiLibStrings.sameorigin | atHapiHapiLib.Anon_Allowfrom = null
