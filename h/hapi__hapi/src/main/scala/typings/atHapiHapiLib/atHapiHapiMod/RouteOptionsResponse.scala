...
trait RouteOptionsResponse extends js.Object {
  ...
  /**
    ...
    */
  var emptyStatusCode: js.UndefOr[
    atHapiHapiLib.atHapiHapiLibNumbers.`200` | atHapiHapiLib.atHapiHapiLibNumbers.`204`
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var modify: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * Default value: none.
    ...
    */
  var options: js.UndefOr[atHapiJoiLib.atHapiJoiMod.ValidationOptions] = js.undefined
  ...
  /**
    ...
    */
  var sample: js.UndefOr[scala.Double] = js.undefined
  /**
  ...
  /**
    ...
    */
  var status: js.UndefOr[atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[RouteOptionsResponseSchema]] = js.undefined
}
...
object RouteOptionsResponse {
  ...
  def apply(
    ...
    emptyStatusCode: atHapiHapiLib.atHapiHapiLibNumbers.`200` | atHapiHapiLib.atHapiHapiLibNumbers.`204` = null,
    failAction: atHapiHapiLib.atHapiHapiMod.LifecycleNs.FailAction = null,
    modify: js.UndefOr[scala.Boolean] = js.undefined,
    options: atHapiJoiLib.atHapiJoiMod.ValidationOptions = null,
    ranges: js.UndefOr[scala.Boolean] = js.undefined,
    sample: scala.Int | scala.Double = null,
    schema: RouteOptionsResponseSchema = null,
    status: atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[RouteOptionsResponseSchema] = null
