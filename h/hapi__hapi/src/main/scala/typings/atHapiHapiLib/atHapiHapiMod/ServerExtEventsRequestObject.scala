...
trait ServerExtEventsRequestObject extends js.Object {
  /**
    ...
    */
  var method: atHapiHapiLib.atHapiHapiMod.LifecycleNs.Method | js.Array[atHapiHapiLib.atHapiHapiMod.LifecycleNs.Method]
  /**
...
object ServerExtEventsRequestObject {
  @scala.inline
  def apply(
    method: atHapiHapiLib.atHapiHapiMod.LifecycleNs.Method | js.Array[atHapiHapiLib.atHapiHapiMod.LifecycleNs.Method],
