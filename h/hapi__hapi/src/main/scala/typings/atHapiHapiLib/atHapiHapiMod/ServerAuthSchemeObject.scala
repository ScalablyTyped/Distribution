...
trait ServerAuthSchemeObject extends js.Object {
  ...
  /**
    ...
    * * payload
    */
  var options: js.UndefOr[atHapiHapiLib.Anon_Payload] = js.undefined
  /**
  ...
  /**
    ...
    * @return the Lifecycle.ReturnValue
    */
  def authenticate(request: Request, h: ResponseToolkit): atHapiHapiLib.atHapiHapiMod.LifecycleNs.ReturnValue
}

object ServerAuthSchemeObject {
  @scala.inline
  def apply(
    authenticate: (Request, ResponseToolkit) => atHapiHapiLib.atHapiHapiMod.LifecycleNs.ReturnValue,
    api: ServerAuthSchemeObjectApi = null,
    options: atHapiHapiLib.Anon_Payload = null,
    payload: (/* request */ Request, /* h */ ResponseToolkit) => atHapiHapiLib.atHapiHapiMod.LifecycleNs.ReturnValue = null,
    response: (/* request */ Request, /* h */ ResponseToolkit) => atHapiHapiLib.atHapiHapiMod.LifecycleNs.ReturnValue = null,
