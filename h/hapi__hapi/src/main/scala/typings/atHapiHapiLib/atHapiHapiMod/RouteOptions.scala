...
trait RouteOptions extends js.Object {
  ...
  /**
    ...
    */
  var auth: js.UndefOr[
    atHapiHapiLib.atHapiHapiLibNumbers.`false` | java.lang.String | RouteOptionsAccess
  ] = js.undefined
  /**
    * Default value: null.
  ...
  /**
    ...
    */
  var cache: js.UndefOr[atHapiHapiLib.atHapiHapiLibNumbers.`false` | RouteOptionsCache] = js.undefined
  /**
    ...
    */
  var compression: js.UndefOr[atHapiHapiLib.atHapiHapiMod.UtilNs.Dictionary[RouteCompressionEncoderSettings]] = js.undefined
  /**
  ...
  {[ key in @hapi/hapi.@hapi/hapi.RouteRequestExtType ]:? @hapi/hapi.@hapi/hapi.RouteExtObject | std.Array<@hapi/hapi.@hapi/hapi.RouteExtObject>}
    */ atHapiHapiLib.atHapiHapiLibStrings.RouteOptions with js.Any
  ] = js.undefined
  /**
    ...
    */
  var files: js.UndefOr[atHapiHapiLib.Anon_RelativeTo] = js.undefined
  /**
    * Default value: none.
    ...
    */
  var handler: js.UndefOr[atHapiHapiLib.atHapiHapiMod.LifecycleNs.Method | js.Object] = js.undefined
  /**
    * Default value: none.
  ...
  /**
    ...
    */
  var json: js.UndefOr[atHapiHapiLib.atHapiHapiMod.JsonNs.StringifyArguments] = js.undefined
  /**
    * Default value: none.
  ...
  /**
    ...
    */
  var log: js.UndefOr[atHapiHapiLib.Anon_Collect] = js.undefined
  /**
    * Default value: none.
  ...
  /**
    ...
    */
  var state: js.UndefOr[atHapiHapiLib.Anon_FailAction] = js.undefined
  /**
    * Default value: none.
  ...
  /**
    ...
    */
  var timeout: js.UndefOr[atHapiHapiLib.Anon_Server] = js.undefined
  /**
...
object RouteOptions {
  ...
  def apply(
    ...
    auth: atHapiHapiLib.atHapiHapiLibNumbers.`false` | java.lang.String | RouteOptionsAccess = null,
    bind: js.Object = null,
  ...
  {[ key in @hapi/hapi.@hapi/hapi.RouteRequestExtType ]:? @hapi/hapi.@hapi/hapi.RouteExtObject | std.Array<@hapi/hapi.@hapi/hapi.RouteExtObject>}
    */ atHapiHapiLib.atHapiHapiLibStrings.RouteOptions with js.Any = null,
