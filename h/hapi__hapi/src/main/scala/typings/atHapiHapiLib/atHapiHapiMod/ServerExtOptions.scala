...
trait ServerExtOptions extends js.Object {
  ...
  var sandbox: js.UndefOr[
    atHapiHapiLib.atHapiHapiLibStrings.server | atHapiHapiLib.atHapiHapiLibStrings.plugin
  ] = js.undefined
}
...
object ServerExtOptions {
  ...
  def apply(
    ...
    bind: js.Object = null,
    sandbox: atHapiHapiLib.atHapiHapiLibStrings.server | atHapiHapiLib.atHapiHapiLibStrings.plugin = null
  ): ServerExtOptions = {
