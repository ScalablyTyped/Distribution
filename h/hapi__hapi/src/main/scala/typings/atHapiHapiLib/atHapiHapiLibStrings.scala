...
object atHapiHapiLibStrings {
  ...
  @js.native
  sealed trait Empty
    extends atHapiHapiLib.atHapiHapiMod.ReferrerPolicy
  ...
  @js.native
  sealed trait HEAD
    extends atHapiHapiLib.atHapiHapiMod.UtilNs.HTTP_METHODS
  ...
  @js.native
  sealed trait data
    extends atHapiHapiLib.atHapiHapiMod.PayloadOutput
  ...
  @js.native
  sealed trait delete
    extends atHapiHapiLib.atHapiHapiMod.UtilNs.HTTP_METHODS_PARTIAL_LOWERCASE
  ...
  sealed trait disconnect
    extends atHapiHapiLib.atHapiHapiMod.RequestEventType
  
  @js.native
  sealed trait error
    extends atHapiHapiLib.atHapiHapiMod.LifecycleNs._FailAction
  ...
  sealed trait onCredentials
    extends atHapiHapiLib.atHapiHapiMod.RouteRequestExtType
  ...
  sealed trait onPostStart
    extends atHapiHapiLib.atHapiHapiMod.ServerExtType
