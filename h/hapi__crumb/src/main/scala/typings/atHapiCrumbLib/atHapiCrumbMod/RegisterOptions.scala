package typings
package atHapiCrumbLib.atHapiCrumbMod
...
trait RegisterOptions extends js.Object {
  ...
  /**
    ...
    * @default { path: '/' }
    */
  var cookieOptions: js.UndefOr[atHapiHapiLib.atHapiHapiMod.ServerStateCookieOptions] = js.undefined
  /**
...
object RegisterOptions {
  ...
  def apply(
    ...
    cookieOptions: atHapiHapiLib.atHapiHapiMod.ServerStateCookieOptions = null,
