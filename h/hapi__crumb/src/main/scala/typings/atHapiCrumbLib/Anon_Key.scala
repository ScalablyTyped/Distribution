...
trait Anon_Key extends js.Object {
  ...
  var source: js.UndefOr[
    atHapiCrumbLib.atHapiCrumbLibStrings.payload | atHapiCrumbLib.atHapiCrumbLibStrings.query
  ] = js.undefined
}
...
object Anon_Key {
  ...
  def apply(
    ...
    source: atHapiCrumbLib.atHapiCrumbLibStrings.payload | atHapiCrumbLib.atHapiCrumbLibStrings.query = null
  ): Anon_Key = {
