...
name := "hapi__crumb"
version := "7.3-dt-20190425Z-364ce9"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "hapi__hapi" % "18.2-dt-20190624Z-d83d8a",
  "org.scalablytyped" %%% "hapi__iron" % "5.1-dt-20190404Z-943b26",
  "org.scalablytyped" %%% "hapi__joi" % "15.0-dt-20190903Z-6c0b76",
  "org.scalablytyped" %%% "hapi__mimos" % "4.1-dt-20190404Z-915dfd",
  "org.scalablytyped" %%% "hapi__podium" % "3.4-dt-20190404Z-a4bd6d",
  "org.scalablytyped" %%% "hapi__shot" % "4.1-dt-20190404Z-7deebf",
