...
name := "hapi__crumb"
version := "7.3-dt-20190425Z-6331ac"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "hapi__hapi" % "18.2-dt-20190624Z-febedd",
  "org.scalablytyped" %%% "hapi__iron" % "5.1-dt-20190404Z-c11a1b",
  ...
  "org.scalablytyped" %%% "hapi__shot" % "4.1-dt-20190404Z-af6db3",
