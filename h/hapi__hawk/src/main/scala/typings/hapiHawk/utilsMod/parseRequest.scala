...
object parseRequest extends js.Object {
  ...
  def apply(req: typings.node.httpsMod.RequestOptions): CustomRequest = js.native
  def apply(req: typings.node.httpsMod.RequestOptions, options: ParseRequestOptions): CustomRequest = js.native
}
