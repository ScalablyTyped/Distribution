...
inline def apply(commonProfile: typings.hafasClient.mod.Profile, userAgent: java.lang.String): typings.hafasClient.mod.HafasClient = (typings.hafasClient.mod.^.asInstanceOf[js.Dynamic].apply(commonProfile.asInstanceOf[js.Any], userAgent.asInstanceOf[js.Any])).asInstanceOf[typings.hafasClient.mod.HafasClient]
