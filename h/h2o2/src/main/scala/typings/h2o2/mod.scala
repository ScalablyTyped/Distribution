...
object mod extends Shortcut {
  ...
  object hapiAugmentingMod {
    ...
    object ResponseToolkit {
      ...
      @scala.inline
      def apply(proxy: ProxyHandlerOptions => js.Promise[ResponseObject]): typings.h2o2.mod.hapiAugmentingMod.ResponseToolkit = {
      ...
      @scala.inline
      implicit class ResponseToolkitMutableBuilder[Self <: typings.h2o2.mod.hapiAugmentingMod.ResponseToolkit] (val x: Self) extends AnyVal {
