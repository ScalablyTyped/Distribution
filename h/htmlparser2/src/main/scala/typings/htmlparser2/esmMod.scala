...
object esmMod {
  ...
  inline def createDomStream(cb: js.Function2[/* error */ js.Error | Null, /* dom */ js.Array[ChildNode], Unit]): typings.htmlparser2.parserMod.Parser = ^.asInstanceOf[js.Dynamic].applyDynamic("createDomStream")(cb.asInstanceOf[js.Any]).asInstanceOf[typings.htmlparser2.parserMod.Parser]
  ...
  ): typings.htmlparser2.parserMod.Parser = (^.asInstanceOf[js.Dynamic].applyDynamic("createDomStream")(cb.asInstanceOf[js.Any], options.asInstanceOf[js.Any], elementCb.asInstanceOf[js.Any])).asInstanceOf[typings.htmlparser2.parserMod.Parser]
  inline def createDomStream(
    cb: js.Function2[/* error */ js.Error | Null, /* dom */ js.Array[ChildNode], Unit],
    options: Options
  ): typings.htmlparser2.parserMod.Parser = (^.asInstanceOf[js.Dynamic].applyDynamic("createDomStream")(cb.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.htmlparser2.parserMod.Parser]
  inline def createDomStream(
    cb: js.Function2[/* error */ js.Error | Null, /* dom */ js.Array[ChildNode], Unit],
    options: Options,
    elementCb: js.Function1[/* element */ Element, Unit]
