...
@js.native
trait PartialHandlerOnattribute extends js.Object {
  ...
  var onparserinit: js.UndefOr[js.Function1[/* parser */ this.type, Unit]] = js.native
...
object PartialHandlerOnattribute {
  @scala.inline
  def apply(): PartialHandlerOnattribute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialHandlerOnattribute]
  }
  @scala.inline
  implicit class PartialHandlerOnattributeOps[Self <: PartialHandlerOnattribute] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnparserinit(value: PartialHandlerOnattribute => Unit): Self = this.set("onparserinit", js.Any.fromFunction1(value))
    @scala.inline
