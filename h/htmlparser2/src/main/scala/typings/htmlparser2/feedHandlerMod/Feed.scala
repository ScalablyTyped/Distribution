...
trait Feed extends js.Object {
  ...
  var items: js.UndefOr[js.Array[FeedItem]] = js.native
  var link: js.UndefOr[String] = js.native
  var title: js.UndefOr[String] = js.native
  var `type`: js.UndefOr[String] = js.native
  var updated: js.UndefOr[Date] = js.native
}
...
object Feed {
  ...
  implicit class FeedOps[Self <: Feed] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUpdated(value: Date): Self = this.set("updated", value.asInstanceOf[js.Any])
    @scala.inline
