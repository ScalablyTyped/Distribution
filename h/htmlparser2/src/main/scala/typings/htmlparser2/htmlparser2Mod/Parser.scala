...
class Parser protected () extends js.Object {
  def this(handler: Partial[typings.domhandler.domhandlerMod.DomHandler]) = this()
  def this(handler: Partial[typings.domhandler.domhandlerMod.DomHandler], options: ParserOptions) = this()
  /***
