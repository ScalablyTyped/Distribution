...
object tokenizerMod {
  ...
  object QuoteType extends StObject {
    ...
    sealed trait Double
      extends StObject
         with QuoteType
    /* 3 */ val Double: typings.htmlparser2.tokenizerMod.QuoteType.Double & scala.Double = js.native
    
    @js.native
    sealed trait NoValue
      extends StObject
         with QuoteType
    /* 0 */ val NoValue: typings.htmlparser2.tokenizerMod.QuoteType.NoValue & scala.Double = js.native
    
    @js.native
    sealed trait Single
      extends StObject
         with QuoteType
    /* 2 */ val Single: typings.htmlparser2.tokenizerMod.QuoteType.Single & scala.Double = js.native
    
    @js.native
    sealed trait Unquoted
      extends StObject
         with QuoteType
    /* 1 */ val Unquoted: typings.htmlparser2.tokenizerMod.QuoteType.Unquoted & scala.Double = js.native
  }
