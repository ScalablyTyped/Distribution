...
import typings.htmlparser2.libEsmTokenizerMod.Callbacks
import typings.htmlparser2.libEsmTokenizerMod.default
...
object libEsmMod {
  ...
  @js.native
  open class Parser ()
    extends typings.htmlparser2.libEsmParserMod.Parser {
  ...
  inline def createDocumentStream(callback: js.Function2[/* error */ js.Error | Null, /* document */ Document, Unit]): typings.htmlparser2.libEsmParserMod.Parser = ^.asInstanceOf[js.Dynamic].applyDynamic("createDocumentStream")(callback.asInstanceOf[js.Any]).asInstanceOf[typings.htmlparser2.libEsmParserMod.Parser]
  ...
  ): typings.htmlparser2.libEsmParserMod.Parser = (^.asInstanceOf[js.Dynamic].applyDynamic("createDocumentStream")(callback.asInstanceOf[js.Any], options.asInstanceOf[js.Any], elementCallback.asInstanceOf[js.Any])).asInstanceOf[typings.htmlparser2.libEsmParserMod.Parser]
  inline def createDocumentStream(
    callback: js.Function2[/* error */ js.Error | Null, /* document */ Document, Unit],
    options: Options
  ): typings.htmlparser2.libEsmParserMod.Parser = (^.asInstanceOf[js.Dynamic].applyDynamic("createDocumentStream")(callback.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.htmlparser2.libEsmParserMod.Parser]
  inline def createDocumentStream(
    callback: js.Function2[/* error */ js.Error | Null, /* document */ Document, Unit],
    options: Options,
    elementCallback: js.Function1[/* element */ Element, Unit]
  ...
  inline def createDomStream(callback: js.Function2[/* error */ js.Error | Null, /* dom */ js.Array[ChildNode], Unit]): typings.htmlparser2.libEsmParserMod.Parser = ^.asInstanceOf[js.Dynamic].applyDynamic("createDomStream")(callback.asInstanceOf[js.Any]).asInstanceOf[typings.htmlparser2.libEsmParserMod.Parser]
  inline def createDomStream(
    callback: js.Function2[/* error */ js.Error | Null, /* dom */ js.Array[ChildNode], Unit],
    options: Unit,
    elementCallback: js.Function1[/* element */ Element, Unit]
  ): typings.htmlparser2.libEsmParserMod.Parser = (^.asInstanceOf[js.Dynamic].applyDynamic("createDomStream")(callback.asInstanceOf[js.Any], options.asInstanceOf[js.Any], elementCallback.asInstanceOf[js.Any])).asInstanceOf[typings.htmlparser2.libEsmParserMod.Parser]
  inline def createDomStream(
    callback: js.Function2[/* error */ js.Error | Null, /* dom */ js.Array[ChildNode], Unit],
    options: Options
  ): typings.htmlparser2.libEsmParserMod.Parser = (^.asInstanceOf[js.Dynamic].applyDynamic("createDomStream")(callback.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.htmlparser2.libEsmParserMod.Parser]
  inline def createDomStream(
    callback: js.Function2[/* error */ js.Error | Null, /* dom */ js.Array[ChildNode], Unit],
    options: Options,
    elementCallback: js.Function1[/* element */ Element, Unit]
