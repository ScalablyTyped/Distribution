...
import typings.hashIt.distCjsTypesConstantsMod.Class
...
object distCjsTypesCacheMod {
  
  @JSImport("hash-it/dist/cjs/types/cache", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("hash-it/dist/cjs/types/cache", "NON_ENUMERABLE_CLASS_CACHE")
  @js.native
