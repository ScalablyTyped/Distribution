...
import typings.hashIt.distEsmTypesConstantsMod.Class
...
object distEsmTypesCacheMod {
  
  @JSImport("hash-it/dist/esm/types/cache", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("hash-it/dist/esm/types/cache", "NON_ENUMERABLE_CLASS_CACHE")
  @js.native
