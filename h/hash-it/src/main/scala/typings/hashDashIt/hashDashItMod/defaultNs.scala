package typings.hashDashIt.hashDashItMod

import typings.hashDashIt.hashDashItMod.hashNs.isNs.Comparator
...
object defaultNs extends js.Object {
  /**
    ...
    */
  def is(`object`: js.Any): js.Function1[/* anotherObject */ js.Any, Boolean] = js.native
  /**
