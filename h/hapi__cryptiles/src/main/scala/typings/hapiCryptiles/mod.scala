...
object mod {
  ...
  inline def fixedTimeComparison(a: String, b: js.Array[js.Any]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("fixedTimeComparison")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def fixedTimeComparison(a: js.Array[js.Any], b: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("fixedTimeComparison")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def fixedTimeComparison(a: js.Array[js.Any], b: js.Array[js.Any]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("fixedTimeComparison")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Boolean]
