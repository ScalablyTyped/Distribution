...
trait Options[EncodingType] extends js.Object {
  ...
  val algorithm: js.UndefOr[
    hashaLib.hashaLibStrings.md5 | hashaLib.hashaLibStrings.sha1 | hashaLib.hashaLibStrings.sha256 | hashaLib.hashaLibStrings.sha512 | AlgorithmName
  ] = js.undefined
  /**
...
object Options {
  ...
  def apply[EncodingType](
    algorithm: hashaLib.hashaLibStrings.md5 | hashaLib.hashaLibStrings.sha1 | hashaLib.hashaLibStrings.sha256 | hashaLib.hashaLibStrings.sha512 | AlgorithmName = null,
