...
trait Config extends js.Object {
  ...
  var onProxyReqWs: js.UndefOr[
    js.Function5[
      ...
      /* req */ nodeLib.httpMod.IncomingMessage, 
      /* socket */ nodeLib.netMod.Socket, 
      /* options */ httpDashProxyLib.httpDashProxyMod.ServerOptions, 
      /* head */ js.Any, 
      scala.Unit
    ]
  ] = js.undefined
...
object Config {
  ...
  def apply(
    ...
    onProxyReqWs: (/* proxyReq */ nodeLib.httpMod.ClientRequest, /* req */ nodeLib.httpMod.IncomingMessage, /* socket */ nodeLib.netMod.Socket, /* options */ httpDashProxyLib.httpDashProxyMod.ServerOptions, /* head */ js.Any) => scala.Unit = null,
