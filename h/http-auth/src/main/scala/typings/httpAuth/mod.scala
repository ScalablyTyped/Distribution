...
object mod {
  ...
  */
  ...
  object Algorithm {
    ...
    inline def MD5: typings.httpAuth.httpAuthStrings.MD5 = "MD5".asInstanceOf[typings.httpAuth.httpAuthStrings.MD5]
    
    inline def `MD5-sess`: typings.httpAuth.httpAuthStrings.`MD5-sess` = "MD5-sess".asInstanceOf[typings.httpAuth.httpAuthStrings.`MD5-sess`]
  }
  ...
  */
  ...
  object Qop {
    ...
    inline def auth: typings.httpAuth.httpAuthStrings.auth = "auth".asInstanceOf[typings.httpAuth.httpAuthStrings.auth]
