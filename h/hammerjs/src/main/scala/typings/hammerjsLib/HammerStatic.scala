...
trait HammerStatic
  ...
  var MouseInput: hammerjsLib.MouseInput = js.native
  var Pan: PanRecognizerStatic = js.native
  var Pinch: PinchRecognizerStatic = js.native
  var PointerEventInput: hammerjsLib.PointerEventInput = js.native
  ...
  var SingleTouchInput: hammerjsLib.SingleTouchInput = js.native
  var Swipe: SwipeRecognizerStatic = js.native
  var Tap: TapRecognizerStatic = js.native
  var TouchAction: hammerjsLib.TouchAction = js.native
  var TouchInput: hammerjsLib.TouchInput = js.native
  var TouchMouseInput: hammerjsLib.TouchMouseInput = js.native
