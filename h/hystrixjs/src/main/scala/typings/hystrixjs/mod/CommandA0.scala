...
object CommandA0 {
  ...
  inline def apply[R](execute: () => js.Thenable[Any]): CommandA0[R] = {
  ...
  extension [Self <: CommandA0[?], R](x: Self & CommandA0[R]) {
    ...
    inline def setExecute(value: () => js.Thenable[Any]): Self = StObject.set(x, "execute", js.Any.fromFunction0(value))
  }
}
