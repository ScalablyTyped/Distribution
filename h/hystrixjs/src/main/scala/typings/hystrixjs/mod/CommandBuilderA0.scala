...
object CommandBuilderA0 {
  ...
  @scala.inline
  implicit class CommandBuilderA0MutableBuilder[Self <: CommandBuilderA0[?], R] (val x: Self & CommandBuilderA0[R]) extends AnyVal {
    ...
    @scala.inline
    def setFallbackTo(value: js.Function1[/* error */ Error, js.Thenable[R]] => CommandBuilderA0[R]): Self = StObject.set(x, "fallbackTo", js.Any.fromFunction1(value))
