...
trait CommandBuilderA1[R, T] extends js.Object {
  ...
  def fallbackTo(value: js.Function2[/* error */ stdLib.Error, /* args */ js.Array[T], stdLib.PromiseLike[R]]): CommandBuilderA1[R, T]
  ...
  def run(value: js.Function1[/* t */ T, stdLib.PromiseLike[R]]): CommandBuilderA1[R, T]
