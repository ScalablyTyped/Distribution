...
trait CommandBuilderA5[R, T, U, V, W, X] extends js.Object {
  ...
  def fallbackTo(
    value: js.Function2[/* error */ stdLib.Error, /* args */ js.Tuple5[T, U, V, W, X], stdLib.PromiseLike[R]]
  ...
  def run(value: js.Function5[/* t */ T, /* u */ U, /* v */ V, /* w */ W, /* x */ X, stdLib.PromiseLike[R]]): CommandBuilderA5[R, T, U, V, W, X]
