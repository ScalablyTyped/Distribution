...
trait CommandBuilderA2[R, T, U] extends js.Object {
  ...
  def fallbackTo(value: js.Function2[/* error */ stdLib.Error, /* args */ js.Tuple2[T, U], stdLib.PromiseLike[R]]): CommandBuilderA2[R, T, U]
  ...
  def run(value: js.Function2[/* t */ T, /* u */ U, stdLib.PromiseLike[R]]): CommandBuilderA2[R, T, U]
