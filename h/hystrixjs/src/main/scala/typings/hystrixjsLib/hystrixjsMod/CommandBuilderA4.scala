...
trait CommandBuilderA4[R, T, U, V, W] extends js.Object {
  ...
  def fallbackTo(
    value: js.Function2[/* error */ stdLib.Error, /* args */ js.Tuple4[T, U, V, W], stdLib.PromiseLike[R]]
  ...
  def run(value: js.Function4[/* t */ T, /* u */ U, /* v */ V, /* w */ W, stdLib.PromiseLike[R]]): CommandBuilderA4[R, T, U, V, W]
