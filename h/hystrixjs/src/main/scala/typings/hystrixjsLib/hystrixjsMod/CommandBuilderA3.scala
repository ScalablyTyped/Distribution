...
trait CommandBuilderA3[R, T, U, V] extends js.Object {
  ...
  def fallbackTo(
    value: js.Function2[/* error */ stdLib.Error, /* args */ js.Tuple3[T, U, V], stdLib.PromiseLike[R]]
  ...
  def run(value: js.Function3[/* t */ T, /* u */ U, /* v */ V, stdLib.PromiseLike[R]]): CommandBuilderA3[R, T, U, V]
