...
trait CommandBuilder extends js.Object {
  ...
  def fallbackTo(
    value: js.Function2[/* error */ stdLib.Error, /* args */ js.UndefOr[js.Array[_]], stdLib.PromiseLike[_]]
  ): CommandBuilder
  ...
  def run(value: js.Function1[/* repeated */js.Any, stdLib.PromiseLike[_]]): CommandBuilder
