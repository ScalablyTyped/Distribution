...
trait CommandBuilderA0[R] extends js.Object {
  ...
  def fallbackTo(value: js.Function1[/* error */ stdLib.Error, stdLib.PromiseLike[R]]): CommandBuilderA0[R]
  ...
  def run(value: js.Function0[stdLib.PromiseLike[R]]): CommandBuilderA0[R]
