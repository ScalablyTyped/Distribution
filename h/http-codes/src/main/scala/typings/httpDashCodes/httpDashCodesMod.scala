package typings.httpDashCodes

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("http-codes", JSImport.Namespace)
@js.native
object httpDashCodesMod extends js.Object {
  ...
  val PAYLOAD_TOO_LARGE: Double = js.native
  ...
  val RANGE_NOT_SATISFIABLE: Double = js.native
  ...
  val URI_TOO_LONG: Double = js.native
