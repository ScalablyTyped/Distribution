package typings.heremaps.HNs.mapNs.DomIconNs
...
object Options {
  @scala.inline
  def apply(
    onAttach: (/* el */ Element, /* icon */ DomIcon, /* marker */ DomMarker) => Unit = null,
    onDetach: (/* el */ Element, /* icon */ DomIcon, /* marker */ DomMarker) => Unit = null
  ): Options = {
