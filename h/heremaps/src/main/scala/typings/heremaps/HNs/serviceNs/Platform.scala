...
import typings.heremaps.HNs.serviceNs.PlatformNs.DefaultLayersOptions
import typings.heremaps.HNs.serviceNs.PlatformNs.Options
import typings.heremaps.HNs.serviceNs.metaInfoNs.Service
...
class Platform protected () extends js.Object {
  ...
  def getEnterpriseRoutingService(opt_options: typings.heremaps.HNs.serviceNs.EnterpriseRoutingServiceNs.Options): EnterpriseRoutingService = js.native
  /**
  ...
  def getGeocodingService(opt_options: typings.heremaps.HNs.serviceNs.GeocodingServiceNs.Options): GeocodingService = js.native
  /**
  ...
  def getMapTileService(opt_options: typings.heremaps.HNs.serviceNs.MapTileServiceNs.Options): MapTileService = js.native
  /**
  ...
  def getMetaInfoService(opt_params: typings.heremaps.HNs.serviceNs.metaInfoNs.ServiceNs.Options): Service = js.native
  /**
  ...
  def getRoutingService(opt_options: typings.heremaps.HNs.serviceNs.RoutingServiceNs.Options): RoutingService = js.native
  /**
  ...
  /**
    ...
    */
  def getVenueService(): typings.heremaps.HNs.serviceNs.venuesNs.Service = js.native
  def getVenueService(opt_params: typings.heremaps.HNs.serviceNs.venuesNs.ServiceNs.Options): typings.heremaps.HNs.serviceNs.venuesNs.Service = js.native
  /**
