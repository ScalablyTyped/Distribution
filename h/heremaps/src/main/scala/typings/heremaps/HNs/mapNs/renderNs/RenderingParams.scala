...
import typings.heremaps.HNs.geoNs.PixelProjection
import typings.heremaps.HNs.mathNs.Point
import typings.heremaps.HNs.mathNs.Size
...
trait RenderingParams extends js.Object {
  /**
    ...
    * @type {H.geo.Rect}
    */
  var bounds: typings.heremaps.HNs.geoNs.Rect
  /**
...
object RenderingParams {
  @scala.inline
  def apply(
    bounds: typings.heremaps.HNs.geoNs.Rect,
    cacheOnly: Boolean,
    pixelRatio: Double,
