...
import typings.heremaps.HNs.mapNs.providerNs.ImageTileProvider
import typings.heremaps.HNs.serviceNs.MapTileServiceNs.Info
import typings.heremaps.HNs.serviceNs.MapTileServiceNs.Options
