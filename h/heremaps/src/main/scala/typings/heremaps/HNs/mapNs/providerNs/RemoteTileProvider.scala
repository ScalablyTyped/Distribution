...
import typings.heremaps.HNs.mapNs.providerNs.TileProviderNs.Options
import typings.heremaps.HNs.netNs.RequestNs.Priority
import typings.heremaps.HNs.utilNs.ICache
import typings.heremaps.HNs.utilNs.ICancelable
