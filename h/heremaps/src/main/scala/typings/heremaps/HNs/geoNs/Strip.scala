...
class Strip () extends js.Object {
  ...
  /**
    ...
    */
  def eachLatLngAlt(
    eachFn: js.Function4[/* lat */ Latitude, /* lng */ Longitude, /* alt */ Altitude, /* n */ Double, Unit]
  ): Unit = js.native
  def eachLatLngAlt(
    eachFn: js.Function4[/* lat */ Latitude, /* lng */ Longitude, /* alt */ Altitude, /* n */ Double, Unit],
    opt_start: Double
  ...
  def getDBCs(opt_closed: Boolean): Double = js.native
  /**
...
object Strip extends js.Object {
  /**
    ...
    */
  def fromLatLngArray(latLngs: js.Array[Double]): Strip = js.native
  /**
