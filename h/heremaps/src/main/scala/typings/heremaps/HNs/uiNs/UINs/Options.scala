package typings.heremaps.HNs.uiNs.UINs

import typings.heremaps.HNs.uiNs.UnitSystem
...
trait Options extends js.Object {
  var distancemeasurement: js.UndefOr[typings.heremaps.HNs.uiNs.DistanceMeasurementNs.Options | Boolean] = js.undefined
  var locale: js.UndefOr[Localization | String] = js.undefined
  var mapsettings: js.UndefOr[typings.heremaps.HNs.uiNs.MapSettingsControlNs.Options | Boolean] = js.undefined
  var panorama: js.UndefOr[typings.heremaps.HNs.uiNs.PanoNs.Options | Boolean] = js.undefined
  var scalebar: js.UndefOr[typings.heremaps.HNs.uiNs.ScaleBarNs.Options | Boolean] = js.undefined
  var unitSystem: js.UndefOr[UnitSystem] = js.undefined
  var zoom: js.UndefOr[typings.heremaps.HNs.uiNs.ZoomControlNs.Options | Boolean] = js.undefined
  var zoomrectangle: js.UndefOr[typings.heremaps.HNs.uiNs.ZoomRectangleNs.Options | Boolean] = js.undefined
}

object Options {
  @scala.inline
  def apply(
    distancemeasurement: typings.heremaps.HNs.uiNs.DistanceMeasurementNs.Options | Boolean = null,
    locale: Localization | String = null,
    mapsettings: typings.heremaps.HNs.uiNs.MapSettingsControlNs.Options | Boolean = null,
    panorama: typings.heremaps.HNs.uiNs.PanoNs.Options | Boolean = null,
    scalebar: typings.heremaps.HNs.uiNs.ScaleBarNs.Options | Boolean = null,
    unitSystem: UnitSystem = null,
    zoom: typings.heremaps.HNs.uiNs.ZoomControlNs.Options | Boolean = null,
    zoomrectangle: typings.heremaps.HNs.uiNs.ZoomRectangleNs.Options | Boolean = null
  ): Options = {
