...
import typings.heremaps.HNs.MapNs.Options
...
import typings.heremaps.HNs.mapNs.Imprint
...
import typings.heremaps.HNs.mapNs.layerNs.BaseTileLayer
import typings.heremaps.HNs.mapNs.layerNs.Layer
import typings.heremaps.HNs.mapNs.renderNs.p2dNs.RenderEngine
...
import typings.heremaps.HNs.utilNs.Request
...
@JSGlobal("H.Map")
@js.native
class Map protected () extends EventTarget {
  /**
    * Constructor
  ...
  /**
    ...
    * @returns {H.geo.Point}
    */
  def getCenter(): typings.heremaps.HNs.geoNs.Point = js.native
  /**
  ...
  /**
    ...
    * @returns {?H.geo.Point}
    */
  def screenToGeo(x: Double, y: Double): typings.heremaps.HNs.geoNs.Point = js.native
  /**
