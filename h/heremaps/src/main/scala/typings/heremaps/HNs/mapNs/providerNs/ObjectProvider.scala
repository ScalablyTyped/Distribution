...
import typings.heremaps.HNs.mapNs.ObjectNs.Type
import typings.heremaps.HNs.mapNs.Overlay
...
class ObjectProvider () extends Provider {
  ...
  def requestDomMarkers(
    geoRect: typings.heremaps.HNs.geoNs.Rect,
    zoomLevel: Double,
    visiblesOnly: Boolean,
    cacheOnly: Boolean
  ): js.Array[DomMarker] = js.native
  /**
