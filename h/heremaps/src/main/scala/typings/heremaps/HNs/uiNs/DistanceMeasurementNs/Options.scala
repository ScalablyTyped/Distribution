package typings.heremaps.HNs.uiNs.DistanceMeasurementNs
...
trait Options extends js.Object {
  ...
  var lineStyle: SpatialStyle | typings.heremaps.HNs.mapNs.SpatialStyleNs.Options
...
object Options {
  @scala.inline
  def apply(
    lineStyle: SpatialStyle | typings.heremaps.HNs.mapNs.SpatialStyleNs.Options,
    alignment: LayoutAlignment = null,
    distanceFormatter: /* n */ Double => Unit = null,
    endIcon: Icon = null,
    splitIcon: Icon = null,
    startIcon: Icon = null,
