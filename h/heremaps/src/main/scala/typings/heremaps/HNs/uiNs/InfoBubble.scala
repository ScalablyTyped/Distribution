...
import typings.heremaps.HNs.uiNs.InfoBubbleNs.Options
import typings.heremaps.HNs.uiNs.InfoBubbleNs.State
import typings.heremaps.HNs.uiNs.baseNs.Element
...
@js.native
class InfoBubble protected () extends Element {
  /**
    * Constructor
