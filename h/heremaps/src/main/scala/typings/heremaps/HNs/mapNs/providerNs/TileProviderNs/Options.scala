package typings.heremaps.HNs.mapNs.providerNs.TileProviderNs
...
trait Options extends js.Object {
  var getCopyrights: js.UndefOr[
    js.Function2[
      /* rect */ typings.heremaps.HNs.geoNs.Rect, 
      /* number */ Double, 
      js.Array[ICopyright]
    ]
  ] = js.undefined
...
object Options {
  @scala.inline
  def apply(
    getCopyrights: (/* rect */ typings.heremaps.HNs.geoNs.Rect, /* number */ Double) => js.Array[ICopyright] = null,
    max: Int | Double = null,
    min: Int | Double = null,
