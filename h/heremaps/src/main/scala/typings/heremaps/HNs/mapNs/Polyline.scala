...
import typings.heremaps.HNs.geoNs.LineString
import typings.heremaps.HNs.geoNs.MultiLineString
import typings.heremaps.HNs.geoNs.Strip
import typings.heremaps.HNs.mapNs.PolylineNs.Options
...
class Polyline protected () extends GeoShape {
  ...
  /**
    ...
    */
  def clip(geoRect: typings.heremaps.HNs.geoNs.Rect): js.Array[js.Array[Double]] = js.native
  /**
