package typings.heremaps.H.map.Group
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setObjectsVarargs(value: Object*): Self = this.set("objects", js.Array(value :_*))
    
    @scala.inline
    def setObjects(value: js.Array[Object]): Self = this.set("objects", value.asInstanceOf[js.Any])
