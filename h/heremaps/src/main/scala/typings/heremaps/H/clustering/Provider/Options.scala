...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClusteringOptions(value: ClusteringOptions): Self = this.set("clusteringOptions", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteClusteringOptions: Self = this.set("clusteringOptions", js.undefined)
    @scala.inline
