...
object ^ extends js.Object {
  def createDefault(map: Map, mapTypes: DefaultLayers): typings.heremaps.H.ui.UI = js.native
  def createDefault(map: Map, mapTypes: DefaultLayers, opt_locale: String): typings.heremaps.H.ui.UI = js.native
  def createDefault(map: Map, mapTypes: DefaultLayers, opt_locale: Localization): typings.heremaps.H.ui.UI = js.native
  /**
    ...
    */
  def createDefault(map: Map, mapTypes: MapTypes): typings.heremaps.H.ui.UI = js.native
  def createDefault(map: Map, mapTypes: MapTypes, opt_locale: String): typings.heremaps.H.ui.UI = js.native
  def createDefault(map: Map, mapTypes: MapTypes, opt_locale: Localization): typings.heremaps.H.ui.UI = js.native
}
