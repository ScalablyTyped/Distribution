...
class Container ()
  ...
  def this(opt_elementType: java.lang.String, opt_className: java.lang.String, opt_children: js.Array[Element]) = this()
  /**
  ...
  /**
    ...
    */
  def removeChild(child: Element): scala.Unit = js.native
  /**
