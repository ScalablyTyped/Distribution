...
class Spatial protected () extends Object {
  /**
               ...
               */
  def this(isClosed: scala.Boolean) = this()
  /**
               * Constructor
               * @param isClosed {boolean} - Indicates whether this spatial object represents a closed shape
               * @param opt_options {H.map.Spatial.Options=} - The options to apply
               */
  def this(isClosed: scala.Boolean, opt_options: heremapsLib.HNs.mapNs.SpatialNs.Options) = this()
  /**
               ...
               */
  def getArrows(): ArrowStyle | scala.Unit = js.native
  /**
  ...
  /**
               ...
               * @returns {H.map.Spatial} - the Spatial instance itself
               */
  def setArrows(opt_arrows: heremapsLib.HNs.mapNs.ArrowStyleNs.Options): Spatial = js.native
  /**
  ...
  /**
               ...
               * @returns {H.map.Spatial} - the Spatial instance itself
               */
  def setStyle(opt_style: heremapsLib.HNs.mapNs.SpatialStyleNs.Options): Spatial = js.native
}
