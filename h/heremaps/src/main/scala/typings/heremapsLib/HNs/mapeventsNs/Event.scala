...
class Event protected ()
  ...
  /**
               ...
               */
  def this(`type`: java.lang.String, pointers: js.Array[Pointer], changedPointers: js.Array[Pointer], targetPointers: js.Array[Pointer], currentPointer: Pointer, target: heremapsLib.HNs.Map, originalEvent: Event) = this()
  /**
               * Constructor
               * @param type {string} - type of event
               * @param pointers {Array<H.mapevents.Pointer>} - pointers which are currently on the screen
               ...
               * @param originalEvent {Event} - original dom event
               */
  def this(`type`: java.lang.String, pointers: js.Array[Pointer], changedPointers: js.Array[Pointer], targetPointers: js.Array[Pointer], currentPointer: Pointer, target: heremapsLib.HNs.mapNs.Object, originalEvent: Event) = this()
  var changedPointers: js.Array[Pointer] = js.native
  var currentPointer: Pointer = js.native
  @JSName("currentTarget")
  var currentTarget_Event: heremapsLib.HNs.mapNs.Object | heremapsLib.HNs.Map = js.native
  var originalEvent: Event = js.native
  var pointers: js.Array[Pointer] = js.native
  var targetPointers: js.Array[Pointer] = js.native
  @JSName("target")
  var target_Event: heremapsLib.HNs.mapNs.Object | heremapsLib.HNs.Map = js.native
}
