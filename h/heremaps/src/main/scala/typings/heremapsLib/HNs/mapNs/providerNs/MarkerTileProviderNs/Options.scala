...
object Options {
  @scala.inline
  def apply(
    requestData: (scala.Double, scala.Double, scala.Double, js.Function1[/* markers */ js.Array[heremapsLib.HNs.mapNs.AbstractMarker], scala.Unit], js.Function0[scala.Unit]) => heremapsLib.HNs.utilNs.ICancelable,
