package typings
package heremapsLib.HNs.utilNs.OListNs
...
class Event protected ()
  ...
  /**
    ...
    */
  def this(list: heremapsLib.HNs.utilNs.OList, `type`: java.lang.String, idx: scala.Double, added: js.Any, removed: js.Any, moved: js.Any) = this()
}
