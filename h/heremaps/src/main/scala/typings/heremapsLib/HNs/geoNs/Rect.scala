...
class Rect protected () extends js.Object {
  ...
  /**
    ...
    */
  def containsLatLng(lat: Latitude, lng: Longitude): scala.Boolean = js.native
  def containsLatLng(lat: Latitude, lng: Longitude, opt_skipValidation: scala.Boolean): scala.Boolean = js.native
  /**
    ...
    */
  def containsPoint(geoPoint: IPoint): scala.Boolean = js.native
  def containsPoint(geoPoint: IPoint, opt_skipValidation: scala.Boolean): scala.Boolean = js.native
  /**
    ...
    */
  def containsRect(geoRect: Rect): scala.Boolean = js.native
  def containsRect(geoRect: Rect, opt_skipValidation: scala.Boolean): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def intersects(geoRect: Rect): scala.Boolean = js.native
  def intersects(geoRect: Rect, opt_skipValidation: scala.Boolean): scala.Boolean = js.native
  /**
    ...
    */
  def isCDB(): scala.Boolean = js.native
  /**
  ...
  def mergeLatLng(lat: Latitude, lng: Longitude, opt_skipValidation: scala.Boolean): Rect = js.native
  def mergeLatLng(lat: Latitude, lng: Longitude, opt_skipValidation: scala.Boolean, opt_out: Rect): Rect = js.native
  /**
  ...
  def mergePoint(geoPoint: IPoint, opt_skipValidation: scala.Boolean): Rect = js.native
  def mergePoint(geoPoint: IPoint, opt_skipValidation: scala.Boolean, opt_out: Rect): Rect = js.native
  /**
  ...
  def mergeRect(geoRect: Rect, opt_skipValidation: scala.Boolean): Rect = js.native
  def mergeRect(geoRect: Rect, opt_skipValidation: scala.Boolean, opt_out: Rect): Rect = js.native
  /**
    * This method returns the smallest bounding box that covers this rectangular area and the rectangular area supplied by the caller.
  ...
  def mergeTopLeftBottomRight(
    ...
    bottom: Latitude,
    right: Longitude,
    opt_skipValidation: scala.Boolean
  ): Rect = js.native
  def mergeTopLeftBottomRight(
    top: Latitude,
    left: Longitude,
...
object Rect extends js.Object {
  /**
    ...
    */
  def coverLatLngAlts(latLngAltArray: js.Array[scala.Double]): heremapsLib.HNs.geoNs.Rect | scala.Unit = js.native
  def coverLatLngAlts(latLngAltArray: js.Array[scala.Double], opt_skipValidation: scala.Boolean): heremapsLib.HNs.geoNs.Rect | scala.Unit = js.native
  /**
    ...
    */
  def coverPoints(pointArray: js.Array[heremapsLib.HNs.geoNs.IPoint]): heremapsLib.HNs.geoNs.Rect = js.native
  def coverPoints(pointArray: js.Array[heremapsLib.HNs.geoNs.IPoint], opt_skipValidation: scala.Boolean): heremapsLib.HNs.geoNs.Rect = js.native
  /**
    ...
    */
  def coverRects(rectArray: js.Array[heremapsLib.HNs.geoNs.Rect]): heremapsLib.HNs.geoNs.Rect | scala.Unit = js.native
  def coverRects(rectArray: js.Array[heremapsLib.HNs.geoNs.Rect], opt_skipValidation: scala.Boolean): heremapsLib.HNs.geoNs.Rect | scala.Unit = js.native
  /**
    ...
    */
  def fromPoints(topLeft: heremapsLib.HNs.geoNs.IPoint, bottomRight: heremapsLib.HNs.geoNs.IPoint): heremapsLib.HNs.geoNs.Rect = js.native
  def fromPoints(
    topLeft: heremapsLib.HNs.geoNs.IPoint,
    bottomRight: heremapsLib.HNs.geoNs.IPoint,
    opt_skipValidation: scala.Boolean
  ): heremapsLib.HNs.geoNs.Rect = js.native
  /**
    ...
    */
  def merge(
    topA: heremapsLib.HNs.geoNs.Latitude,
    leftA: heremapsLib.HNs.geoNs.Longitude,
    bottomA: heremapsLib.HNs.geoNs.Latitude,
    rightA: heremapsLib.HNs.geoNs.Longitude,
    topB: heremapsLib.HNs.geoNs.Latitude,
    leftB: heremapsLib.HNs.geoNs.Longitude,
    bottomB: heremapsLib.HNs.geoNs.Latitude,
    rightB: heremapsLib.HNs.geoNs.Longitude
  ): heremapsLib.HNs.geoNs.Rect = js.native
  def merge(
    topA: heremapsLib.HNs.geoNs.Latitude,
    leftA: heremapsLib.HNs.geoNs.Longitude,
    ...
    bottomB: heremapsLib.HNs.geoNs.Latitude,
    rightB: heremapsLib.HNs.geoNs.Longitude,
    opt_out: heremapsLib.HNs.geoNs.Rect
  ): heremapsLib.HNs.geoNs.Rect = js.native
}
