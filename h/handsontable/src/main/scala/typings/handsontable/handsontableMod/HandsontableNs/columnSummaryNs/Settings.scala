package typings.handsontable.handsontableMod.HandsontableNs.columnSummaryNs

import typings.handsontable.handsontableMod.HandsontableNs.pluginsNs.ColumnSummary
import typings.handsontable.handsontableMod.HandsontableNs.pluginsNs.Endpoint
