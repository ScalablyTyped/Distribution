...
object EditorType {
  ...
  @scala.inline
  def mobile: typings.handsontable.handsontableStrings.mobile = this.cast("mobile")
  @scala.inline
  def password: typings.handsontable.handsontableStrings.password = this.cast("password")
  @scala.inline
  def select: typings.handsontable.handsontableStrings.select = this.cast("select")
  @scala.inline
