...
trait Time extends js.Object {
  var editor: Instantiable0[typings.handsontable.handsontableMod.HandsontableNs.underscoreEditorsNs.Text] = js.native
  @JSName("renderer")
  var renderer_Original: typings.handsontable.handsontableMod.HandsontableNs.renderersNs.Text = js.native
  @JSName("validator")
  var validator_Original: typings.handsontable.handsontableMod.HandsontableNs.validatorsNs.Time = js.native
  def renderer(
    instance: Core,
