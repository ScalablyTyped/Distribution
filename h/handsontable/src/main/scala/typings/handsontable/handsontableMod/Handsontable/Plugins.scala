...
import typings.handsontable.Anon_HotInstance
...
trait Plugins extends js.Object {
  ...
  var ColumnSummary: typings.handsontable.handsontableMod.Handsontable.plugins.ColumnSummary
  var Comments: typings.handsontable.handsontableMod.Handsontable.plugins.Comments
  var ContextMenu: typings.handsontable.handsontableMod.Handsontable.plugins.ContextMenu
  var CopyPaste: typings.handsontable.handsontableMod.Handsontable.plugins.CopyPaste
  var DragToScroll: typings.handsontable.handsontableMod.Handsontable.plugins.DragToScroll
  var DropdownMenu: typings.handsontable.handsontableMod.Handsontable.plugins.DropdownMenu
  var ExportFile: typings.handsontable.handsontableMod.Handsontable.plugins.ExportFile
  var Filters: typings.handsontable.handsontableMod.Handsontable.plugins.Filters
  var Formulas: typings.handsontable.handsontableMod.Handsontable.plugins.Formulas
  var GanttChart: typings.handsontable.handsontableMod.Handsontable.plugins.GanttChart
  var HeaderTooltips: typings.handsontable.handsontableMod.Handsontable.plugins.HeaderTooltips
  var HiddenColumns: typings.handsontable.handsontableMod.Handsontable.plugins.HiddenColumns
  var HiddenRows: typings.handsontable.handsontableMod.Handsontable.plugins.HiddenRows
  var ManualColumnFreeze: typings.handsontable.handsontableMod.Handsontable.plugins.ManualColumnFreeze
  var ManualColumnMove: typings.handsontable.handsontableMod.Handsontable.plugins.ManualColumnMove
  var ManualColumnResize: typings.handsontable.handsontableMod.Handsontable.plugins.ManualColumnResize
  var ManualRowMove: typings.handsontable.handsontableMod.Handsontable.plugins.ManualRowMove
  var ManualRowResize: typings.handsontable.handsontableMod.Handsontable.plugins.ManualRowResize
  var MergeCells: typings.handsontable.handsontableMod.Handsontable.plugins.MergeCells
  var MultiColumnSorting: typings.handsontable.handsontableMod.Handsontable.plugins.MultiColumnSorting
  var MultipleSelectionHandles: typings.handsontable.handsontableMod.Handsontable.plugins.MultipleSelectionHandles
  var NestedHeaders: typings.handsontable.handsontableMod.Handsontable.plugins.NestedHeaders
  var NestedRows: typings.handsontable.handsontableMod.Handsontable.plugins.NestedRows
  var ObserveChanges: typings.handsontable.handsontableMod.Handsontable.plugins.ObserveChanges
  var Search: typings.handsontable.handsontableMod.Handsontable.plugins.Search
  var TouchScroll: typings.handsontable.handsontableMod.Handsontable.plugins.TouchScroll
  var TrimRows: typings.handsontable.handsontableMod.Handsontable.plugins.TrimRows
  def registerPlugin(pluginName: String, pluginClass: Anon_HotInstance): Unit
}
