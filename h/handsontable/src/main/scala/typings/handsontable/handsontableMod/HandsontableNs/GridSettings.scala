...
import typings.handsontable.handsontableMod.HandsontableNs.autoColumnSizeNs.Settings
import typings.handsontable.handsontableMod.HandsontableNs.commentsNs.CommentConfig
import typings.handsontable.handsontableMod.HandsontableNs.contextMenuNs.PredefinedMenuItemKey
import typings.handsontable.handsontableMod.HandsontableNs.nestedHeadersNs.NestedHeader
...
trait GridSettings extends Events {
  ...
  var autoRowSize: js.UndefOr[
    typings.handsontable.handsontableMod.HandsontableNs.autoRowSizeNs.Settings | Boolean
  ] = js.undefined
  ...
  var collapsibleColumns: js.UndefOr[
    Boolean | (js.Array[
      typings.handsontable.handsontableMod.HandsontableNs.collapsibleColumnsNs.Settings
    ])
  ] = js.undefined
  var columnHeaderHeight: js.UndefOr[Double | js.Array[js.UndefOr[Double]]] = js.undefined
  var columnSorting: js.UndefOr[
    Boolean | typings.handsontable.handsontableMod.HandsontableNs.columnSortingNs.Settings
  ] = js.undefined
  var columnSummary: js.UndefOr[
    js.Array[typings.handsontable.handsontableMod.HandsontableNs.columnSummaryNs.Settings] | (js.Function0[
      js.Array[typings.handsontable.handsontableMod.HandsontableNs.columnSummaryNs.Settings]
    ])
  ] = js.undefined
  ...
  var comments: js.UndefOr[
    Boolean | typings.handsontable.handsontableMod.HandsontableNs.commentsNs.Settings | js.Array[CommentConfig]
  ] = js.undefined
  var contextMenu: js.UndefOr[
    Boolean | js.Array[PredefinedMenuItemKey] | typings.handsontable.handsontableMod.HandsontableNs.contextMenuNs.Settings
  ] = js.undefined
  ...
  var customBorders: js.UndefOr[
    Boolean | js.Array[typings.handsontable.handsontableMod.HandsontableNs.customBordersNs.Settings]
  ] = js.undefined
  ...
  var fillHandle: js.UndefOr[
    Boolean | vertical | horizontal | typings.handsontable.handsontableMod.HandsontableNs.autoFillNs.Settings
  ] = js.undefined
  ...
  var formulas: js.UndefOr[
    Boolean | typings.handsontable.handsontableMod.HandsontableNs.formulasNs.Settings
  ] = js.undefined
  var fragmentSelection: js.UndefOr[Boolean | cell] = js.undefined
  var ganttChart: js.UndefOr[typings.handsontable.handsontableMod.HandsontableNs.ganttChartNs.Settings] = js.undefined
  var headerTooltips: js.UndefOr[
    Boolean | typings.handsontable.handsontableMod.HandsontableNs.headerTooltipsNs.Settings
  ] = js.undefined
  var height: js.UndefOr[Double | String | (js.Function0[Double | String])] = js.undefined
  var hiddenColumns: js.UndefOr[
    Boolean | typings.handsontable.handsontableMod.HandsontableNs.hiddenColumnsNs.Settings
  ] = js.undefined
  var hiddenRows: js.UndefOr[
    Boolean | typings.handsontable.handsontableMod.HandsontableNs.hiddenRowsNs.Settings
  ] = js.undefined
  ...
  var mergeCells: js.UndefOr[
    Boolean | js.Array[typings.handsontable.handsontableMod.HandsontableNs.mergeCellsNs.Settings]
  ] = js.undefined
  ...
  var multiColumnSorting: js.UndefOr[
    Boolean | typings.handsontable.handsontableMod.HandsontableNs.multiColumnSortingNs.Settings
  ] = js.undefined
  ...
  var renderer: js.UndefOr[
    RendererType | String | typings.handsontable.handsontableMod.HandsontableNs.renderersNs.Base
  ] = js.undefined
  ...
  var validator: js.UndefOr[
    typings.handsontable.handsontableMod.HandsontableNs.validatorsNs.Base | RegExp | ValidatorType | String
  ] = js.undefined
...
object GridSettings {
  ...
  def apply(
    ...
    autoRowSize: typings.handsontable.handsontableMod.HandsontableNs.autoRowSizeNs.Settings | Boolean = null,
    ...
    columnSorting: Boolean | typings.handsontable.handsontableMod.HandsontableNs.columnSortingNs.Settings = null,
    columnSummary: js.Array[typings.handsontable.handsontableMod.HandsontableNs.columnSummaryNs.Settings] | (js.Function0[
      js.Array[typings.handsontable.handsontableMod.HandsontableNs.columnSummaryNs.Settings]
    ]) = null,
    columns: js.Array[ColumnSettings] | (js.Function1[/* index */ Double, ColumnSettings]) = null,
    commentedCellClassName: String = null,
    comments: Boolean | typings.handsontable.handsontableMod.HandsontableNs.commentsNs.Settings | js.Array[CommentConfig] = null,
    contextMenu: Boolean | js.Array[PredefinedMenuItemKey] | typings.handsontable.handsontableMod.HandsontableNs.contextMenuNs.Settings = null,
    ...
    customBorders: Boolean | js.Array[typings.handsontable.handsontableMod.HandsontableNs.customBordersNs.Settings] = null,
    ...
    dropdownMenu: Boolean | js.Array[PredefinedMenuItemKey] | typings.handsontable.handsontableMod.HandsontableNs.contextMenuNs.Settings = null,
    ...
    fillHandle: Boolean | vertical | horizontal | typings.handsontable.handsontableMod.HandsontableNs.autoFillNs.Settings = null,
    ...
    formulas: Boolean | typings.handsontable.handsontableMod.HandsontableNs.formulasNs.Settings = null,
    fragmentSelection: Boolean | cell = null,
    ganttChart: typings.handsontable.handsontableMod.HandsontableNs.ganttChartNs.Settings = null,
    headerTooltips: Boolean | typings.handsontable.handsontableMod.HandsontableNs.headerTooltipsNs.Settings = null,
    height: Double | String | (js.Function0[Double | String]) = null,
    hiddenColumns: Boolean | typings.handsontable.handsontableMod.HandsontableNs.hiddenColumnsNs.Settings = null,
    hiddenRows: Boolean | typings.handsontable.handsontableMod.HandsontableNs.hiddenRowsNs.Settings = null,
    ...
    mergeCells: Boolean | js.Array[typings.handsontable.handsontableMod.HandsontableNs.mergeCellsNs.Settings] = null,
    minCols: Int | Double = null,
    minRows: Int | Double = null,
    minSpareCols: Int | Double = null,
    minSpareRows: Int | Double = null,
    multiColumnSorting: Boolean | typings.handsontable.handsontableMod.HandsontableNs.multiColumnSortingNs.Settings = null,
    ...
    renderer: RendererType | String | typings.handsontable.handsontableMod.HandsontableNs.renderersNs.Base = null,
    ...
    validator: typings.handsontable.handsontableMod.HandsontableNs.validatorsNs.Base | RegExp | ValidatorType | String = null,
