...
trait Sheet extends js.Object {
  ...
  def getCellAt(row: Double, column: Double): typings.handsontable.handsontableMod.HandsontableNs.pluginsNs.CellValue | Unit = js.native
  ...
  def parseExpression(
    cellValue: typings.handsontable.handsontableMod.HandsontableNs.pluginsNs.CellValue,
    formula: String
  ): Unit = js.native
