...
trait Date extends js.Object {
  var editor: Instantiable0[typings.handsontable.handsontableMod.HandsontableNs.underscoreEditorsNs.Date] = js.native
  @JSName("renderer")
  var renderer_Original: typings.handsontable.handsontableMod.HandsontableNs.renderersNs.Autocomplete = js.native
  @JSName("validator")
  var validator_Original: typings.handsontable.handsontableMod.HandsontableNs.validatorsNs.Date = js.native
  def renderer(
    instance: Core,
