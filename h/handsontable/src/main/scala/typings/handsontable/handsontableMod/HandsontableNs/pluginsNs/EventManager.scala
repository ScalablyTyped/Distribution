...
trait EventManager extends js.Object {
  ...
  def addEventListener(element: Element, eventName: String, callback: js.Function1[/* event */ Event, Unit]): js.Function0[Unit]
  def clear(): Unit
  def clearEvents(): Unit
  def destroy(): Unit
  def extendEvent(context: js.Object, event: Event): js.Any
  def fireEvent(element: Element, eventName: String): Unit
  def removeEventListener(element: Element, eventName: String, callback: js.Function1[/* event */ Event, Unit]): Unit
}
