...
trait Numeric extends js.Object {
  ...
  var editor: Instantiable0[typings.handsontable.handsontableMod.HandsontableNs.underscoreEditorsNs.Numeric] = js.native
  @JSName("renderer")
  var renderer_Original: typings.handsontable.handsontableMod.HandsontableNs.renderersNs.Numeric = js.native
  @JSName("validator")
  var validator_Original: typings.handsontable.handsontableMod.HandsontableNs.validatorsNs.Numeric = js.native
  def renderer(
    instance: Core,
