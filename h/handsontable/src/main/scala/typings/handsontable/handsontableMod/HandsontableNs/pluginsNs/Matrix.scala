...
trait Matrix extends js.Object {
  ...
  def add(cellValue: typings.handsontable.handsontableMod.HandsontableNs.pluginsNs.CellValue): Unit = js.native
  ...
  def remove(cellValue: typings.handsontable.handsontableMod.HandsontableNs.pluginsNs.CellValue): Unit = js.native
