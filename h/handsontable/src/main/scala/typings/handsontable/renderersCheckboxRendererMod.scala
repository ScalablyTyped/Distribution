...
object renderersCheckboxRendererMod {
  
  @JSImport("handsontable/renderers/checkboxRenderer", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("handsontable/renderers/checkboxRenderer", "RENDERER_TYPE")
  @js.native
