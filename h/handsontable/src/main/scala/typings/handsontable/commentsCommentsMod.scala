...
object commentsCommentsMod {
  ...
  trait CommentsRangeObject extends StObject {
    ...
    var from: typings.handsontable.coordsMod.default
    
    var to: js.UndefOr[typings.handsontable.coordsMod.default] = js.undefined
  }
  object CommentsRangeObject {
    
    inline def apply(from: typings.handsontable.coordsMod.default): CommentsRangeObject = {
    ...
    extension [Self <: CommentsRangeObject](x: Self) {
      ...
      inline def setFrom(value: typings.handsontable.coordsMod.default): Self = StObject.set(x, "from", value.asInstanceOf[js.Any])
      
      inline def setTo(value: typings.handsontable.coordsMod.default): Self = StObject.set(x, "to", value.asInstanceOf[js.Any])
