...
import typings.handsontable.mod.Handsontable.plugins.FiltersPlugin.ActionBarComponent
import typings.handsontable.mod.Handsontable.plugins.FiltersPlugin.CellLikeData
import typings.handsontable.mod.Handsontable.plugins.FiltersPlugin.ConditionCollection
import typings.handsontable.mod.Handsontable.plugins.FiltersPlugin.ConditionComponent
