package typings.handsontable.mod.Handsontable.wot
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.handsontable.handsontableStrings.debug
*/
...
object OverlayType {
  ...
  @scala.inline
  def debug: typings.handsontable.handsontableStrings.debug = "debug".asInstanceOf[typings.handsontable.handsontableStrings.debug]
  @scala.inline
