...
import typings.handsontable.AnonHotInstance
...
trait Plugins_ extends js.Object {
  ...
  def registerPlugin(pluginName: String, pluginClass: AnonHotInstance): Unit
}
...
object Plugins_ {
  ...
  def apply(
    ...
    TrimRows: TrimRows,
    registerPlugin: (String, AnonHotInstance) => Unit
  ): Plugins_ = {
