...
trait Plugins_ extends js.Object {
  ...
  var AutoRowSize: typings.handsontable.mod.Handsontable.plugins.AutoRowSize = js.native
  
  var Autofill: typings.handsontable.mod.Handsontable.plugins.Autofill = js.native
  
  var BasePlugin: Base = js.native
  
  var BindRowsWithHeaders: typings.handsontable.mod.Handsontable.plugins.BindRowsWithHeaders = js.native
  
  var CollapsibleColumns: typings.handsontable.mod.Handsontable.plugins.CollapsibleColumns = js.native
  
  var ColumnSorting: typings.handsontable.mod.Handsontable.plugins.ColumnSorting = js.native
  
  var ColumnSummary: typings.handsontable.mod.Handsontable.plugins.ColumnSummary = js.native
  
  var Comments: typings.handsontable.mod.Handsontable.plugins.Comments = js.native
  
  var ContextMenu: typings.handsontable.mod.Handsontable.plugins.ContextMenu = js.native
  
  var CopyPaste: typings.handsontable.mod.Handsontable.plugins.CopyPaste = js.native
  
  var CustomBorders: typings.handsontable.mod.Handsontable.plugins.CustomBorders = js.native
  
  var DragToScroll: typings.handsontable.mod.Handsontable.plugins.DragToScroll = js.native
  
  var DropdownMenu: typings.handsontable.mod.Handsontable.plugins.DropdownMenu = js.native
  
  var ExportFile: typings.handsontable.mod.Handsontable.plugins.ExportFile = js.native
  
  var Filters: typings.handsontable.mod.Handsontable.plugins.Filters = js.native
  
  var Formulas: typings.handsontable.mod.Handsontable.plugins.Formulas = js.native
  
  var HeaderTooltips: typings.handsontable.mod.Handsontable.plugins.HeaderTooltips = js.native
  
  var HiddenColumns: typings.handsontable.mod.Handsontable.plugins.HiddenColumns = js.native
  
  var HiddenRows: typings.handsontable.mod.Handsontable.plugins.HiddenRows = js.native
  
  var ManualColumnFreeze: typings.handsontable.mod.Handsontable.plugins.ManualColumnFreeze = js.native
  
  var ManualColumnMove: typings.handsontable.mod.Handsontable.plugins.ManualColumnMove = js.native
  
  var ManualColumnResize: typings.handsontable.mod.Handsontable.plugins.ManualColumnResize = js.native
  
  var ManualRowMove: typings.handsontable.mod.Handsontable.plugins.ManualRowMove = js.native
  
  var ManualRowResize: typings.handsontable.mod.Handsontable.plugins.ManualRowResize = js.native
  
  var MergeCells: typings.handsontable.mod.Handsontable.plugins.MergeCells = js.native
  
  var MultiColumnSorting: typings.handsontable.mod.Handsontable.plugins.MultiColumnSorting = js.native
  
  var MultipleSelectionHandles: typings.handsontable.mod.Handsontable.plugins.MultipleSelectionHandles = js.native
  
  var NestedHeaders: typings.handsontable.mod.Handsontable.plugins.NestedHeaders = js.native
  
  var NestedRows: typings.handsontable.mod.Handsontable.plugins.NestedRows = js.native
  
  var ObserveChanges: typings.handsontable.mod.Handsontable.plugins.ObserveChanges = js.native
  
  var Search: typings.handsontable.mod.Handsontable.plugins.Search = js.native
  
  var TouchScroll: typings.handsontable.mod.Handsontable.plugins.TouchScroll = js.native
  
  var TrimRows: typings.handsontable.mod.Handsontable.plugins.TrimRows = js.native
