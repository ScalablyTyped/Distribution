...
object undoRedoUndoRedoMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.handsontable.undoRedoUndoRedoMod.ChangeAction
    - typings.handsontable.undoRedoUndoRedoMod.InsertRowAction
    - typings.handsontable.undoRedoUndoRedoMod.RemoveRowAction
    - typings.handsontable.undoRedoUndoRedoMod.InsertColAction
    - typings.handsontable.undoRedoUndoRedoMod.RemoveColAction
    - typings.handsontable.undoRedoUndoRedoMod.FilterAction
  */
  trait Action extends StObject
  object Action {
    
    inline def ChangeAction(changes: js.Array[CellChange], selected: js.Array[js.Tuple2[Double, Double]]): typings.handsontable.undoRedoUndoRedoMod.ChangeAction = {
      val __obj = js.Dynamic.literal(actionType = "change", changes = changes.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.handsontable.undoRedoUndoRedoMod.ChangeAction]
    }
    
    inline def FilterAction(conditionsStack: js.Array[ColumnConditions]): typings.handsontable.undoRedoUndoRedoMod.FilterAction = {
      val __obj = js.Dynamic.literal(actionType = "filter", conditionsStack = conditionsStack.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.handsontable.undoRedoUndoRedoMod.FilterAction]
    }
    
    inline def InsertColAction(amount: Double, index: Double): typings.handsontable.undoRedoUndoRedoMod.InsertColAction = {
      val __obj = js.Dynamic.literal(actionType = "insert_col", amount = amount.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.handsontable.undoRedoUndoRedoMod.InsertColAction]
    }
    
    inline def InsertRowAction(amount: Double, index: Double): typings.handsontable.undoRedoUndoRedoMod.InsertRowAction = {
      val __obj = js.Dynamic.literal(actionType = "insert_row", amount = amount.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.handsontable.undoRedoUndoRedoMod.InsertRowAction]
    }
    ...
    inline def RemoveColAction(
      ...
      __obj.asInstanceOf[typings.handsontable.undoRedoUndoRedoMod.RemoveColAction]
    }
    
    inline def RemoveRowAction(data: js.Array[js.Array[CellValue]], index: Double): typings.handsontable.undoRedoUndoRedoMod.RemoveRowAction = {
      val __obj = js.Dynamic.literal(actionType = "remove_row", data = data.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.handsontable.undoRedoUndoRedoMod.RemoveRowAction]
    }
  }
