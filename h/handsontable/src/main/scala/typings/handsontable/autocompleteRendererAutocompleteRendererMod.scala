...
object autocompleteRendererAutocompleteRendererMod {
  
  @JSImport("handsontable/renderers/autocompleteRenderer/autocompleteRenderer", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("handsontable/renderers/autocompleteRenderer/autocompleteRenderer", "RENDERER_TYPE")
  @js.native
  val RENDERER_TYPE: autocomplete = js.native
