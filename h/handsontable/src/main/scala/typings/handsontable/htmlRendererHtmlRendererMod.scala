...
object htmlRendererHtmlRendererMod {
  
  @JSImport("handsontable/renderers/htmlRenderer/htmlRenderer", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("handsontable/renderers/htmlRenderer/htmlRenderer", "RENDERER_TYPE")
  @js.native
