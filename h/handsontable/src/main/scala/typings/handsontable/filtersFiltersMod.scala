...
object filtersFiltersMod {
  ...
  open class Filters protected () extends BasePlugin {
    ...
    var conditionCollection: typings.handsontable.conditionCollectionMod.default = js.native
    
    var conditionUpdateObserver: typings.handsontable.conditionUpdateObserverMod.default = js.native
