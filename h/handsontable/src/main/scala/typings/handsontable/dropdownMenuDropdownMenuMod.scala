...
import typings.handsontable.contextMenuContextMenuMod.MenuConfig
import typings.handsontable.contextMenuContextMenuMod.PredefinedMenuItemKey
import typings.handsontable.contextMenuContextMenuMod.Selection
...
object dropdownMenuDropdownMenuMod {
