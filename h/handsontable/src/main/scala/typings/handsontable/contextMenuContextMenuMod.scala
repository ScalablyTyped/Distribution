...
object contextMenuContextMenuMod {
  ...
  */
  ...
  trait Selection extends StObject {
    ...
    var end: typings.handsontable.coordsMod.default
    
    var start: typings.handsontable.coordsMod.default
  }
  object Selection {
    
    inline def apply(end: typings.handsontable.coordsMod.default, start: typings.handsontable.coordsMod.default): Selection = {
    ...
    extension [Self <: Selection](x: Self) {
      ...
      inline def setEnd(value: typings.handsontable.coordsMod.default): Self = StObject.set(x, "end", value.asInstanceOf[js.Any])
      
      inline def setStart(value: typings.handsontable.coordsMod.default): Self = StObject.set(x, "start", value.asInstanceOf[js.Any])
    }
  }
