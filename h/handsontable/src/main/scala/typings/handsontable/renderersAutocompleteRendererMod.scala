...
object renderersAutocompleteRendererMod {
  
  @JSImport("handsontable/renderers/autocompleteRenderer", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("handsontable/renderers/autocompleteRenderer", "RENDERER_TYPE")
  @js.native
