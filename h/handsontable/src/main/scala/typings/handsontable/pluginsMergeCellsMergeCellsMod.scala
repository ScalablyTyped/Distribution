...
object pluginsMergeCellsMergeCellsMod {
  ...
  open class MergeCells protected () extends BasePlugin {
    ...
    def mergeSelection(cellRange: typings.handsontable.`3rdpartyWalkontableSrcCellRangeMod`.default): Unit = js.native
    ...
    def unmergeSelection(cellRange: typings.handsontable.`3rdpartyWalkontableSrcCellRangeMod`.default): Unit = js.native
  }
