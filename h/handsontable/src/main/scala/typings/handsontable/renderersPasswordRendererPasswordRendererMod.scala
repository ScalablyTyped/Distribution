...
object renderersPasswordRendererPasswordRendererMod {
  
  @JSImport("handsontable/renderers/passwordRenderer/passwordRenderer", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("handsontable/renderers/passwordRenderer/passwordRenderer", "RENDERER_TYPE")
  @js.native
