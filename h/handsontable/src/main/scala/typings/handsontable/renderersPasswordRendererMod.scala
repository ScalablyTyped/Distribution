...
object renderersPasswordRendererMod {
  
  @JSImport("handsontable/renderers/passwordRenderer", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("handsontable/renderers/passwordRenderer", "RENDERER_TYPE")
  @js.native
  val RENDERER_TYPE: password = js.native
