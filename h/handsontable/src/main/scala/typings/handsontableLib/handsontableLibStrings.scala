...
object handsontableLibStrings {
  ...
  @js.native
  sealed trait GantChartDOTloadData
    extends handsontableLib.handsontableMod.HandsontableNs.ChangeSource
  
  @js.native
  sealed trait ObserveChangesDOTchange
    extends handsontableLib.handsontableMod.HandsontableNs.ChangeSource
  
  @js.native
  sealed trait STATE_EDITING
    extends handsontableLib.handsontableMod.HandsontableNs.underscoreEditorsNs.EditorState
  
  @js.native
  sealed trait STATE_FINISHED
    extends handsontableLib.handsontableMod.HandsontableNs.underscoreEditorsNs.EditorState
  
  @js.native
  sealed trait STATE_VIRGIN
    extends handsontableLib.handsontableMod.HandsontableNs.underscoreEditorsNs.EditorState
  
  @js.native
  sealed trait STATE_WAITING
    extends handsontableLib.handsontableMod.HandsontableNs.underscoreEditorsNs.EditorState
  ...
  sealed trait autocomplete
    extends handsontableLib.handsontableMod.HandsontableNs.CellType
       with handsontableLib.handsontableMod.HandsontableNs.EditorType
       with handsontableLib.handsontableMod.HandsontableNs.RendererType
       with handsontableLib.handsontableMod.HandsontableNs.ValidatorType
  ...
  @js.native
  sealed trait html
    extends handsontableLib.handsontableMod.HandsontableNs.RendererType
  ...
  @js.native
  sealed trait mobile
    extends handsontableLib.handsontableMod.HandsontableNs.EditorType
