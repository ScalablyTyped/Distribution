...
trait Date extends js.Object {
  var editor: org.scalablytyped.runtime.Instantiable0[handsontableLib.handsontableMod.HandsontableNs.underscoreEditorsNs.Date] = js.native
  @JSName("renderer")
  var renderer_Original: handsontableLib.handsontableMod.HandsontableNs.renderersNs.Autocomplete = js.native
  @JSName("validator")
  var validator_Original: handsontableLib.handsontableMod.HandsontableNs.validatorsNs.Date = js.native
  def renderer(
