...
trait Checkbox extends js.Object {
  var editor: org.scalablytyped.runtime.Instantiable0[handsontableLib.handsontableMod.HandsontableNs.underscoreEditorsNs.Checkbox] = js.native
  @JSName("renderer")
  var renderer_Original: handsontableLib.handsontableMod.HandsontableNs.renderersNs.Checkbox = js.native
  def renderer(
