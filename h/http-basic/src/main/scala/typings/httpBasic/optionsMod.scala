  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setRetryDelayFunction3(
        value: (/* err */ (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify NodeJS.ErrnoException */ Any) | Null, /* res */ ^[ReadableStream[Any]] | Unit, /* attemptNumber */ Double) => Double
      ...
      inline def setRetryFunction3(
        value: (/* err */ (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify NodeJS.ErrnoException */ Any) | Null, /* res */ ^[ReadableStream[Any]] | Unit, /* attemptNumber */ Double) => Boolean
