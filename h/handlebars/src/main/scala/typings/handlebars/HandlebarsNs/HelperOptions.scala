...
trait HelperOptions extends js.Object {
  ...
  def fn(context: js.Any, options: typings.handlebars.HandlebarsNs.RuntimeOptions): String = js.native
  def inverse(context: js.Any): String = js.native
  def inverse(context: js.Any, options: typings.handlebars.HandlebarsNs.RuntimeOptions): String = js.native
}
