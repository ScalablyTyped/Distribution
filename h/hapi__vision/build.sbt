...
name := "hapi__vision"
version := "5.5-dt-20190412Z-c83e0e"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "hapi__hapi" % "18.2-dt-20190417Z-672f76",
  "org.scalablytyped" %%% "hapi__iron" % "5.1-dt-20190404Z-11a671",
  ...
  "org.scalablytyped" %%% "hapi__shot" % "4.1-dt-20190404Z-9f790c",
