...
name := "hapi__vision"
version := "5.5-dt-20190412Z-83945e"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "hapi__hapi" % "18.2-dt-20190417Z-af80dc",
  "org.scalablytyped" %%% "hapi__iron" % "5.1-dt-20190404Z-6495d2",
  ...
  "org.scalablytyped" %%% "hapi__shot" % "4.1-dt-20190404Z-fe2102",
