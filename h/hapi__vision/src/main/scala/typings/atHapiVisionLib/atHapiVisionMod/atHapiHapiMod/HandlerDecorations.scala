...
trait HandlerDecorations extends js.Object {
  /**
    ...
    */
  var view: js.UndefOr[java.lang.String | atHapiVisionLib.Anon_Context] = js.undefined
}

object HandlerDecorations {
  @scala.inline
  def apply(view: java.lang.String | atHapiVisionLib.Anon_Context = null): HandlerDecorations = {
