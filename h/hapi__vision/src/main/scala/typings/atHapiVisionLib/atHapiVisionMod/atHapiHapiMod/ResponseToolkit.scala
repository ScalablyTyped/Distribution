...
trait ResponseToolkit extends js.Object {
  /**
    ...
    */
  def view(templatePath: java.lang.String): atHapiHapiLib.atHapiHapiMod.ResponseObject = js.native
  def view(templatePath: java.lang.String, context: js.Any): atHapiHapiLib.atHapiHapiMod.ResponseObject = js.native
  def view(
