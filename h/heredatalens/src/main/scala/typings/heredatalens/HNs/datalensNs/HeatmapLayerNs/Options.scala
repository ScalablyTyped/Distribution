...
trait Options extends js.Object {
  ...
  var dataToRows: js.UndefOr[
    js.Function4[
      /* data */ Data, 
      /* x */ typings.heredatalens.HNs.datalensNs.QueryTileProviderNs.X, 
      /* y */ typings.heredatalens.HNs.datalensNs.QueryTileProviderNs.Y, 
      /* zoom */ Zoom, 
      js.Array[Row]
    ]
  ] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    dataToRows: (/* data */ Data, /* x */ typings.heredatalens.HNs.datalensNs.QueryTileProviderNs.X, /* y */ typings.heredatalens.HNs.datalensNs.QueryTileProviderNs.Y, /* zoom */ Zoom) => js.Array[Row] = null,
