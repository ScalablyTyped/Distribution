...
object InputScale extends js.Object {
  ...
  /* 0 */ val DB: typings.heredatalens.HNs.datalensNs.HeatmapLayerNs.InputScale.DB with Double = js.native
  /* 1 */ val LINEAR: typings.heredatalens.HNs.datalensNs.HeatmapLayerNs.InputScale.LINEAR with Double = js.native
  /* 2 */ val LOG: typings.heredatalens.HNs.datalensNs.HeatmapLayerNs.InputScale.LOG with Double = js.native
  @JSBracketAccess
