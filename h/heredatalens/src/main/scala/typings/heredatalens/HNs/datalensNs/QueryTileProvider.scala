...
import typings.heredatalens.HNs.datalensNs.QueryTileProviderNs.Options
import typings.heredatalens.HNs.datalensNs.QueryTileProviderNs.TileParamNames
...
@js.native
class QueryTileProvider protected () extends RemoteTileProvider {
  /**
    * Constructor
