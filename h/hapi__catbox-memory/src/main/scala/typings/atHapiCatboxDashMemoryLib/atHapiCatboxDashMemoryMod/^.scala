...
@js.native
class ^[T] () extends CatboxMemory[T] {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def drop(key: atHapiCatboxLib.atHapiCatboxMod.CacheKey): js.Promise[scala.Unit] = js.native
  /**
    * get(key, callback) - retrieve an item from the cache engine if found where:
    *  * key - a cache key object (see [ICacheKey]).
    */
  /* CompleteClass */
  override def get(key: atHapiCatboxLib.atHapiCatboxMod.CacheKey): js.Promise[scala.Null | atHapiCatboxLib.atHapiCatboxMod.CachedObject[T]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def set(key: atHapiCatboxLib.atHapiCatboxMod.CacheKey, value: T, ttl: scala.Double): js.Promise[scala.Unit] = js.native
