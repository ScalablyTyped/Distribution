...
object distZigZagEncodingMod {
  ...
  object default {
    ...
    /**
      ...
      */
    /* static member */
    inline def decode(buffer: typings.hdrHistogramJs.distByteBufferMod.default): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(buffer.asInstanceOf[js.Any]).asInstanceOf[Double]
    ...
    /**
      ...
      */
    /* static member */
    inline def encode(buffer: typings.hdrHistogramJs.distByteBufferMod.default, value: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(buffer.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
  }
