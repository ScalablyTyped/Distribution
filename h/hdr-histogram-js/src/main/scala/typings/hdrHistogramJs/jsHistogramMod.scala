...
object jsHistogramMod {
  
  @JSImport("hdr-histogram-js/dist/JsHistogram", JSImport.Default)
  @js.native
  abstract class default protected () extends JsHistogram {
    def this(
  ...
  abstract class JsHistogram protected ()
    ...
    var percentileIterator: typings.hdrHistogramJs.percentileIteratorMod.default = js.native
