...
object abstractHistogramEncodingMod {
  ...
  inline def encodeIntoByteBuffer(buffer: default): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeIntoByteBuffer")(buffer.asInstanceOf[js.Any]).asInstanceOf[Double]
  
  inline def encodeIntoCompressedByteBuffer(targetBuffer: default): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("encodeIntoCompressedByteBuffer")(targetBuffer.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def encodeIntoCompressedByteBuffer(targetBuffer: default, compressionLevel: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeIntoCompressedByteBuffer")(targetBuffer.asInstanceOf[js.Any], compressionLevel.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  object hdrHistogramJsAbstractHistogramAugmentingMod {
    ...
    object AbstractHistogram {
      ...
      extension [Self <: typings.hdrHistogramJs.abstractHistogramEncodingMod.hdrHistogramJsAbstractHistogramAugmentingMod.AbstractHistogram](x: Self) {
        
        inline def setEncodeIntoByteBuffer(value: /* buffer */ default => Double): Self = StObject.set(x, "encodeIntoByteBuffer", js.Any.fromFunction1(value))
        
        inline def setEncodeIntoCompressedByteBuffer(value: (/* targetBuffer */ default, /* compressionLevel */ js.UndefOr[Double]) => Double): Self = StObject.set(x, "encodeIntoCompressedByteBuffer", js.Any.fromFunction2(value))
      }
    }
  }
}
