...
object PlusNativeObj {
  ...
  def apply(
    ...
    if (AnimationViewStyles != null) __obj.updateDynamic("AnimationViewStyles")(AnimationViewStyles)
    if (Bitmap != null) __obj.updateDynamic("Bitmap")(Bitmap)
    if (BitmapSaveOptions != null) __obj.updateDynamic("BitmapSaveOptions")(BitmapSaveOptions)
    if (ImageSlider != null) __obj.updateDynamic("ImageSlider")(ImageSlider)
    if (ImageSliderImageStyles != null) __obj.updateDynamic("ImageSliderImageStyles")(ImageSliderImageStyles)
    if (ImageSliderStyles != null) __obj.updateDynamic("ImageSliderStyles")(ImageSliderStyles)
    ...
    if (ViewAnimationOptions != null) __obj.updateDynamic("ViewAnimationOptions")(ViewAnimationOptions)
    if (ViewDrawTagStyles != null) __obj.updateDynamic("ViewDrawTagStyles")(ViewDrawTagStyles)
    if (ViewEvents != null) __obj.updateDynamic("ViewEvents")(ViewEvents)
    if (ViewStatusbarStyles != null) __obj.updateDynamic("ViewStatusbarStyles")(ViewStatusbarStyles)
    if (ViewStyles != null) __obj.updateDynamic("ViewStyles")(ViewStyles)
