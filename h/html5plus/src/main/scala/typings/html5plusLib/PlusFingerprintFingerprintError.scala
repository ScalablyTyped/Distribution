...
trait PlusFingerprintFingerprintError extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/fingerprint.html](http://www.html5plus.org/doc/zh_cn/fingerprint.html)
    */
  var AUTHENTICATE_MISMATCH: js.UndefOr[scala.Double] = js.undefined
  /**
    * 指纹识别次数超过限制
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/fingerprint.html](http://www.html5plus.org/doc/zh_cn/fingerprint.html)
    */
  var AUTHENTICATE_OVERLIMIT: js.UndefOr[scala.Double] = js.undefined
  /**
    * 取消指纹识别
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/fingerprint.html](http://www.html5plus.org/doc/zh_cn/fingerprint.html)
    */
  var FINGERPRINT_UNENROLLED: js.UndefOr[scala.Double] = js.undefined
  /**
    * 设备未设置密码锁屏
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/fingerprint.html](http://www.html5plus.org/doc/zh_cn/fingerprint.html)
    */
  var KEYGUARD_INSECURE: js.UndefOr[scala.Double] = js.undefined
  /**
    * 未知错误
    * 其它未知错误，错误代码常量值为7。
    * 
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/fingerprint.html](http://www.html5plus.org/doc/zh_cn/fingerprint.html)
    */
  var UNSUPPORT: js.UndefOr[scala.Double] = js.undefined
  /**
    * 错误代码
...
object PlusFingerprintFingerprintError {
  @scala.inline
  def apply(
    AUTHENTICATE_MISMATCH: scala.Int | scala.Double = null,
    AUTHENTICATE_OVERLIMIT: scala.Int | scala.Double = null,
    CANCEL: scala.Int | scala.Double = null,
    FINGERPRINT_UNENROLLED: scala.Int | scala.Double = null,
    KEYGUARD_INSECURE: scala.Int | scala.Double = null,
    UNKNOWN_ERROR: scala.Int | scala.Double = null,
    UNSUPPORT: scala.Int | scala.Double = null,
