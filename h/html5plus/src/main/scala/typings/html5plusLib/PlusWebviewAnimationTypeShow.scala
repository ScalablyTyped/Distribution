...
trait PlusWebviewAnimationTypeShow extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var `fade-in`: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 无动画效果
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var `pop-in`: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 从下侧竖向滑动效果
    * 页面从屏幕下侧向上竖向滑动显示。
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var `slide-in-bottom`: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 从左侧横向滑动效果
    * 页面从屏幕左侧向右横向滑动显示。
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var `slide-in-left`: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 从右侧横向滑动效果
    * 页面从屏幕右侧外向内横向滑动显示。
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var `slide-in-right`: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 从上侧竖向滑动效果
    * 页面从屏幕上侧向下竖向滑动显示。
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var `slide-in-top`: js.UndefOr[java.lang.String] = js.undefined
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var `zoom-fade-out`: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 从小到大逐渐放大显示效果
    * 页面在屏幕中间从小到大逐渐放大显示。
    * 	对应关闭动画"zoom-in"。
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var `zoom-out`: js.UndefOr[java.lang.String] = js.undefined
}
...
object PlusWebviewAnimationTypeShow {
  ...
  def apply(
    ...
    `fade-in`: java.lang.String = null,
    none: java.lang.String = null,
    `pop-in`: java.lang.String = null,
    `slide-in-bottom`: java.lang.String = null,
    `slide-in-left`: java.lang.String = null,
    `slide-in-right`: java.lang.String = null,
    `slide-in-top`: java.lang.String = null,
    `zoom-fade-out`: java.lang.String = null,
    `zoom-out`: java.lang.String = null
