...
trait PlusZipCompressImageOptions extends js.Object {
  ...
  var rotate: js.UndefOr[
    html5plusLib.html5plusLibStrings.`90` | html5plusLib.html5plusLibStrings.`180` | html5plusLib.html5plusLibStrings.`270`
  ] = js.undefined
  /**
    * 压缩转换原始图片的路径
    * 支持以下图片路径：
    ...
    */
  var src: js.UndefOr[
    html5plusLib.html5plusLibStrings.`_www/` | html5plusLib.html5plusLibStrings.`_doc/` | html5plusLib.html5plusLibStrings.`_documents/` | html5plusLib.html5plusLibStrings.`_downloads/`
  ] = js.undefined
  /**
    * 缩放图片的宽度
...
object PlusZipCompressImageOptions {
  ...
  def apply(
    ...
    dst: html5plusLib.html5plusLibStrings.`_doc/` | html5plusLib.html5plusLibStrings.`_documents/` | html5plusLib.html5plusLibStrings.`_downloads/` = null,
    ...
    rotate: html5plusLib.html5plusLibStrings.`90` | html5plusLib.html5plusLibStrings.`180` | html5plusLib.html5plusLibStrings.`270` = null,
    src: html5plusLib.html5plusLibStrings.`_www/` | html5plusLib.html5plusLibStrings.`_doc/` | html5plusLib.html5plusLibStrings.`_documents/` | html5plusLib.html5plusLibStrings.`_downloads/` = null,
