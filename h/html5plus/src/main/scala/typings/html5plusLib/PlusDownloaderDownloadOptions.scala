...
trait PlusDownloaderDownloadOptions extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/downloader.html](http://www.html5plus.org/doc/zh_cn/downloader.html)
    */
  var method: js.UndefOr[html5plusLib.html5plusLibStrings.GET | html5plusLib.html5plusLibStrings.POST] = js.undefined
  /**
    * 下载任务的优先级
...
object PlusDownloaderDownloadOptions {
  ...
  def apply(
    ...
    method: html5plusLib.html5plusLibStrings.GET | html5plusLib.html5plusLibStrings.POST = null,
