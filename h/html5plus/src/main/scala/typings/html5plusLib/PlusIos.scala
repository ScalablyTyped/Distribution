...
trait PlusIos extends js.Object {
  ...
  def deleteObject(obj: js.Any): scala.Unit = js.native
  /**
    * 实现代理的方法
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/ios.html](http://www.html5plus.org/doc/zh_cn/ios.html)
  ...
  def implements(name: java.lang.String): PlusIosInstanceObject = js.native
  def implements(name: java.lang.String, obj: js.Any): PlusIosInstanceObject = js.native
  /**
    * 导入Objective-C类对象
  ...
  def importClass(classname: java.lang.String): PlusIosClassObject = js.native
  /**
    * 调用对象（类对象/示例对象）的方法
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/ios.html](http://www.html5plus.org/doc/zh_cn/ios.html)
  ...
  def invoke(obj: PlusIosInstanceObject, name: java.lang.String): js.Any = js.native
  def invoke(obj: PlusIosInstanceObject, name: java.lang.String, args: js.Any): js.Any = js.native
  /**
    * 创建实例对象
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/ios.html](http://www.html5plus.org/doc/zh_cn/ios.html)
  ...
  def newObject(classname: java.lang.String): PlusIosInstanceObject = js.native
  def newObject(classname: java.lang.String, args: js.Any): PlusIosInstanceObject = js.native
}
