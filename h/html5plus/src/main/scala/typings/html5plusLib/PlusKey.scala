...
trait PlusKey extends js.Object {
  ...
  def addEventListener(event: PlusKeyKeyType): scala.Unit = js.native
  def addEventListener(event: PlusKeyKeyType, listener: js.Function1[/* result */ PlusKeyKeyEvent, scala.Unit]): scala.Unit = js.native
  def addEventListener(
    event: PlusKeyKeyType,
    listener: js.Function1[/* result */ PlusKeyKeyEvent, scala.Unit],
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/key.html](http://www.html5plus.org/doc/zh_cn/key.html)
    */
  def hideSoftKeybord(): scala.Unit = js.native
  /**
    * 移除按键事件监听器
  ...
  def removeEventListener(event: PlusKeyKeyType): scala.Unit = js.native
  def removeEventListener(event: PlusKeyKeyType, listener: js.Function1[/* result */ PlusKeyKeyEvent, scala.Unit]): scala.Unit = js.native
  /**
    * 设置辅助输入类型
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/key.html](http://www.html5plus.org/doc/zh_cn/key.html)
    */
  def setAssistantType(): scala.Unit = js.native
  def setAssistantType(`type`: java.lang.String): scala.Unit = js.native
  /**
    * 显示软键盘
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/key.html](http://www.html5plus.org/doc/zh_cn/key.html)
    */
  def showSoftKeybord(): scala.Unit = js.native
}
