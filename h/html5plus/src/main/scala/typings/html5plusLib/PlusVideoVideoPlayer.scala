...
trait PlusVideoVideoPlayer extends js.Object {
  ...
  def addEventListener(event: PlusVideoVideoPlayerEvents): scala.Unit = js.native
  def addEventListener(event: PlusVideoVideoPlayerEvents, listener: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/video.html](http://www.html5plus.org/doc/zh_cn/video.html)
    */
  def playbackRate(): scala.Unit = js.native
  ...
  def requestFullScreen(direction: scala.Double): scala.Unit = js.native
  /**
    * 跳转到指定位置
    * 如果视频未处于播放状态，则操作无效。
    * 
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/video.html](http://www.html5plus.org/doc/zh_cn/video.html)
    */
  def sendDanmu(): scala.Unit = js.native
  def sendDanmu(danmu: js.Any): scala.Unit = js.native
  /**
  ...
  def setOptions(options: PlusVideoVideoPlayerStyles): scala.Unit = js.native
  /**
    * 设置视频播放控件参数
    * 用于动态更新视频播放控件的配置参数。
    * 	注意：有些选项无法动态更新，只能创建时进行设置，详情参考VideoPlayerStyles。
  ...
  def setStyles(styles: PlusVideoVideoPlayerStyles): scala.Unit = js.native
  /**
    * 显示视频播放控件
