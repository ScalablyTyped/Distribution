...
trait PlusDownloaderDownload extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/downloader.html](http://www.html5plus.org/doc/zh_cn/downloader.html)
    */
  var downloadedSize: js.UndefOr[scala.Double] = js.native
  /**
    * 下载的文件名称
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/downloader.html](http://www.html5plus.org/doc/zh_cn/downloader.html)
    */
  var totalSize: js.UndefOr[scala.Double] = js.native
  /**
    * 下载文件的地址
  ...
  def addEventListener(
    ...
    listener: js.Function2[/* result0 */ this.type, /* result1 */ scala.Double, scala.Unit]
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/downloader.html](http://www.html5plus.org/doc/zh_cn/downloader.html)
    */
  def getResponseHeader(): java.lang.String = js.native
  def getResponseHeader(headerName: java.lang.String): java.lang.String = js.native
  /**
    * 暂停下载任务
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/downloader.html](http://www.html5plus.org/doc/zh_cn/downloader.html)
    */
  def setRequestHeader(): scala.Unit = js.native
  def setRequestHeader(headerName: java.lang.String): scala.Unit = js.native
