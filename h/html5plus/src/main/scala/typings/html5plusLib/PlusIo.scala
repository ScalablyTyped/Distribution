...
trait PlusIo extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
    */
  var PRIVATE_DOC: js.UndefOr[scala.Double] = js.native
  /**
    * 应用运行资源目录常量
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
    */
  var PRIVATE_WWW: js.UndefOr[scala.Double] = js.native
  /**
    * 程序公用文档目录常量
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
    */
  var PUBLIC_DOCUMENTS: js.UndefOr[scala.Double] = js.native
  /**
    * 程序公用下载目录常量
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
    */
  var PUBLIC_DOWNLOADS: js.UndefOr[scala.Double] = js.native
  /**
    * 相对路径URL
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
    */
  def convertAbsoluteFileSystem(): java.lang.String = js.native
  def convertAbsoluteFileSystem(path: java.lang.String): java.lang.String = js.native
  /**
    * 将本地URL路径转换成平台绝对路径
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
    */
  def convertLocalFileSystemURL(): java.lang.String = js.native
  def convertLocalFileSystemURL(url: java.lang.String): java.lang.String = js.native
  /**
    * 请求本地文件系统对象
  ...
  def requestFileSystem(`type`: scala.Double): scala.Unit = js.native
  def requestFileSystem(`type`: scala.Double, succesCB: js.Function1[/* result */ PlusIoFileSystem, scala.Unit]): scala.Unit = js.native
  def requestFileSystem(
    `type`: scala.Double,
    succesCB: js.Function1[/* result */ PlusIoFileSystem, scala.Unit],
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
    */
  def resolveLocalFileSystemURL(): scala.Unit = js.native
  def resolveLocalFileSystemURL(url: java.lang.String): scala.Unit = js.native
  def resolveLocalFileSystemURL(url: java.lang.String, succesCB: js.Function1[/* result */ PlusIoDirectoryEntry, scala.Unit]): scala.Unit = js.native
