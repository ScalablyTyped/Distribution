...
trait PlusMaps extends js.Object {
  ...
  def create(id: java.lang.String): PlusMapsMap = js.native
  def create(id: java.lang.String, styles: PlusMapsMapStyles): PlusMapsMap = js.native
  /**
    * 查找已经创建的Map对象
  ...
  def getMapById(id: java.lang.String): PlusMapsMap = js.native
  /**
    * 调用系统第三方程序进行导航
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/maps.html](http://www.html5plus.org/doc/zh_cn/maps.html)
    */
  def openSysMap(): scala.Unit = js.native
  def openSysMap(dst: PlusMapsPoint): scala.Unit = js.native
  def openSysMap(dst: PlusMapsPoint, des: java.lang.String): scala.Unit = js.native
  def openSysMap(dst: PlusMapsPoint, des: java.lang.String, src: PlusMapsPoint): scala.Unit = js.native
}
