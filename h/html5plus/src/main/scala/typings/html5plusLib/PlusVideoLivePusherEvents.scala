...
trait PlusVideoLivePusherEvents extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/video.html](http://www.html5plus.org/doc/zh_cn/video.html)
    */
  var netstatus: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 状态变化事件
    * 当推流连接服务器状态变化时触发。
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/video.html](http://www.html5plus.org/doc/zh_cn/video.html)
    */
  var statechange: js.UndefOr[java.lang.String] = js.undefined
}
...
object PlusVideoLivePusherEvents {
  ...
  def apply(
    ...
    netstatus: java.lang.String = null,
    statechange: java.lang.String = null
  ): PlusVideoLivePusherEvents = {
