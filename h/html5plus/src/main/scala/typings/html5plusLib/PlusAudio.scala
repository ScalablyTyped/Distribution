...
/**
  ...
  */
@js.native
trait PlusAudio extends js.Object {
  /**
    * 音频播放对象
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/audio.html](http://www.html5plus.org/doc/zh_cn/audio.html)
    */
  var ROUTE_EARPIECE: js.UndefOr[scala.Double] = js.native
  /**
    * 设备的扬声器音频输出线路
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/audio.html](http://www.html5plus.org/doc/zh_cn/audio.html)
    */
  var ROUTE_SPEAKER: js.UndefOr[scala.Double] = js.native
  /**
  ...
  def createPlayer(path: java.lang.String): PlusAudioAudioPlayer = js.native
  /**
    * 获取当前设备的录音对象
