...
trait PlusRuntime extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  var arguments: js.UndefOr[java.lang.String] = js.native
  /**
    * 应用的市场推广渠道标识
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  var innerVersion: js.UndefOr[java.lang.String] = js.native
  /**
    * 获取当前应用首页加载的时间
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  var launchLoadedTime: js.UndefOr[scala.Double] = js.native
  /**
    * 应用启动来源
    * 5+ APP启动类型，可取以下值：
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  var launcher: js.UndefOr[
    html5plusLib.html5plusLibStrings.default | html5plusLib.html5plusLibStrings.scheme | html5plusLib.html5plusLibStrings.push | html5plusLib.html5plusLibStrings.stream | html5plusLib.html5plusLibStrings.shortcut | html5plusLib.html5plusLibStrings.barcode
  ] = js.native
  /**
    * 应用安装来源
    * 5+应用安装来源，可取以下值：
  ...
  var origin: js.UndefOr[
    html5plusLib.html5plusLibStrings.default | html5plusLib.html5plusLibStrings.stream | html5plusLib.html5plusLibStrings.push | html5plusLib.html5plusLibStrings.scheme | html5plusLib.html5plusLibStrings.barcode | html5plusLib.html5plusLibStrings.silent
  ] = js.native
  /**
    * 获取当前应用的进程标识
    * 当前应用所属系统进程标识。
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  var processId: js.UndefOr[java.lang.String] = js.native
  /**
    * 获取当前应用的启动时间
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  var startupTime: js.UndefOr[scala.Double] = js.native
  /**
    * 客户端的版本号
  ...
  def getProperty(appid: java.lang.String): scala.Unit = js.native
  def getProperty(
    appid: java.lang.String,
    getPropertyCB: js.Function1[/* result */ PlusRuntimeWidgetInfo, scala.Unit]
  ...
  def install(filePath: java.lang.String): scala.Unit = js.native
  def install(filePath: java.lang.String, options: PlusRuntimeWidgetOptions): scala.Unit = js.native
  def install(
    filePath: java.lang.String,
    options: PlusRuntimeWidgetOptions,
    installSuccessCB: js.Function1[/* result */ PlusRuntimeWidgetInfo, scala.Unit]
  ): scala.Unit = js.native
  def install(
    filePath: java.lang.String,
    options: PlusRuntimeWidgetOptions,
    installSuccessCB: js.Function1[/* result */ PlusRuntimeWidgetInfo, scala.Unit],
    installErrorCB: js.Function1[/* result */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  /**
    * 判断第三方程序是否已存在
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  def isApplicationExist(): scala.Boolean = js.native
  def isApplicationExist(appInf: PlusRuntimeApplicationInf): scala.Boolean = js.native
  /**
    * 判断是否自定义应用启动页面加载地址
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  def isCustomLaunchPath(): scala.Boolean = js.native
  /**
    * 调用第三方程序
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  def launchApplication(): scala.Unit = js.native
  def launchApplication(appInf: PlusRuntimeApplicationInf): scala.Unit = js.native
  def launchApplication(appInf: PlusRuntimeApplicationInf, errorCB: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
    * 调用第三方程序打开指定的文件
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  def openFile(): scala.Unit = js.native
  def openFile(filepath: java.lang.String): scala.Unit = js.native
  def openFile(filepath: java.lang.String, options: PlusRuntimeOpenFileOptions): scala.Unit = js.native
  def openFile(
    filepath: java.lang.String,
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  def openURL(): scala.Unit = js.native
  def openURL(url: java.lang.String): scala.Unit = js.native
  def openURL(url: java.lang.String, errorCB: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  def openURL(
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  def openWeb(): scala.Unit = js.native
  def openWeb(url: java.lang.String): scala.Unit = js.native
  /**
    * 处理直达页面链接参数
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  def processDirectPage(): java.lang.String = js.native
  /**
    * 退出客户端程序
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/runtime.html](http://www.html5plus.org/doc/zh_cn/runtime.html)
    */
  def setBadgeNumber(): scala.Unit = js.native
  def setBadgeNumber(number: scala.Double): scala.Unit = js.native
  def setBadgeNumber(number: scala.Double, options: PlusRuntimeBadgeOptions): scala.Unit = js.native
}
