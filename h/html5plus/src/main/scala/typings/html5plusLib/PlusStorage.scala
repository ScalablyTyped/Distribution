...
trait PlusStorage extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/storage.html](http://www.html5plus.org/doc/zh_cn/storage.html)
    */
  def getItem(): java.lang.String = js.native
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/storage.html](http://www.html5plus.org/doc/zh_cn/storage.html)
    */
  def key(): scala.Unit = js.native
  def key(index: scala.Double): scala.Unit = js.native
  /**
    * 通过key值删除键值对存储的数据
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/storage.html](http://www.html5plus.org/doc/zh_cn/storage.html)
    */
  def removeItem(): scala.Unit = js.native
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/storage.html](http://www.html5plus.org/doc/zh_cn/storage.html)
    */
  def setItem(): scala.Unit = js.native
  def setItem(key: java.lang.String): scala.Unit = js.native
