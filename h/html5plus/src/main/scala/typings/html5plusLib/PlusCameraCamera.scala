...
trait PlusCameraCamera extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/camera.html](http://www.html5plus.org/doc/zh_cn/camera.html)
    */
  def captureImage(): scala.Unit = js.native
  def captureImage(successCB: js.Function1[/* result */ java.lang.String, scala.Unit]): scala.Unit = js.native
  def captureImage(
  ...
  def startVideoCapture(successCB: js.Function1[/* result */ java.lang.String, scala.Unit]): scala.Unit = js.native
