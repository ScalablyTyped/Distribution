...
trait PlusSpeech extends js.Object {
  ...
  def addEventListener(event: PlusSpeechSpeechRecoginzeEvents): scala.Unit = js.native
  def addEventListener(event: PlusSpeechSpeechRecoginzeEvents, listener: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/speech.html](http://www.html5plus.org/doc/zh_cn/speech.html)
    */
  def startRecognize(): scala.Unit = js.native
  def startRecognize(options: PlusSpeechSpeechRecognizeOptions): scala.Unit = js.native
  def startRecognize(
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/speech.html](http://www.html5plus.org/doc/zh_cn/speech.html)
    */
  def stopRecognize(): scala.Unit = js.native
}
