...
trait PlusDevice extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  var imei: js.UndefOr[java.lang.String] = js.native
  /**
    * 设备的国际移动用户识别码
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  var vendor: js.UndefOr[java.lang.String] = js.native
  /**
    * 发出蜂鸣声
    * 调用此方法使得设备发出蜂鸣声。
    * 
  ...
  def dial(number: java.lang.String): scala.Unit = js.native
  def dial(number: java.lang.String, confirm: scala.Boolean): scala.Unit = js.native
  /**
    * 获取设备的系统音量
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  def isWakelock(): scala.Boolean = js.native
  /**
    * 设置设备的系统音量
    * 调用此方法调节设备的系统音量。
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  def setVolume(): scala.Unit = js.native
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  def setWakelock(): scala.Unit = js.native
  def setWakelock(lock: scala.Boolean): scala.Unit = js.native
  /**
    * 设备振动
    * 调用此方法使得设备振动。
    * 
