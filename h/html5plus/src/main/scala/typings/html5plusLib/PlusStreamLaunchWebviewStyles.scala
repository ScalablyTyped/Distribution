...
trait PlusStreamLaunchWebviewStyles extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/stream.html](http://www.html5plus.org/doc/zh_cn/stream.html)
    */
  var blockNetworkImage: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * 指定首页Webview的id
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/stream.html](http://www.html5plus.org/doc/zh_cn/stream.html)
    */
  var launch_path: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 流应用首页是否显示
...
object PlusStreamLaunchWebviewStyles {
  @scala.inline
  def apply(
    blockNetworkImage: js.UndefOr[scala.Boolean] = js.undefined,
    id: java.lang.String = null,
    launch_path: java.lang.String = null,
