...
trait PlusNetXMLHttpRequest extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  var onabort: js.UndefOr[js.Function1[/* result */ PlusNetProgressEvent, scala.Unit]] = js.native
  /**
    * 网络请求错误事件
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  var onerror: js.UndefOr[js.Function1[/* result */ PlusNetProgressEvent, scala.Unit]] = js.native
  /**
    * 网络请求成功事件
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  var onload: js.UndefOr[js.Function1[/* result */ PlusNetProgressEvent, scala.Unit]] = js.native
  /**
    * 网络请求结束事件
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  var onloadend: js.UndefOr[js.Function1[/* result */ PlusNetProgressEvent, scala.Unit]] = js.native
  /**
    * 网络请求开始事件
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  var onloadstart: js.UndefOr[js.Function1[/* result */ PlusNetProgressEvent, scala.Unit]] = js.native
  /**
    * 网络请求传输数据事件
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  var onprogress: js.UndefOr[js.Function1[/* result */ PlusNetProgressEvent, scala.Unit]] = js.native
  /**
    * 网络请求状态发生变化事件
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  var onreadystatechange: js.UndefOr[js.Function0[scala.Unit]] = js.native
  /**
    * 网络请求超时事件
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  var ontimeout: js.UndefOr[js.Function1[/* result */ PlusNetProgressEvent, scala.Unit]] = js.native
  /**
    * HTTP 请求的状态
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  var response: js.UndefOr[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  var responseType: js.UndefOr[java.lang.String] = js.native
  /**
    * 请求响应的Document对象
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  var responseXML: js.UndefOr[java.lang.String] = js.native
  /**
    * 服务器返回的HTTP状态代码
  ...
  def open(method: java.lang.String): scala.Unit = js.native
  def open(method: java.lang.String, url: java.lang.String): scala.Unit = js.native
  def open(method: java.lang.String, url: java.lang.String, username: java.lang.String): scala.Unit = js.native
  def open(
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/net.html](http://www.html5plus.org/doc/zh_cn/net.html)
    */
  def overrideMimeType(): scala.Unit = js.native
  ...
  def send(body: java.lang.String): scala.Unit = js.native
  /**
    * 指定一个HTTP请求的Header
