...
trait PlusBluetooth extends js.Object {
  ...
  def closeBLEConnection(deviceId: java.lang.String): scala.Unit = js.native
  def closeBLEConnection(deviceId: java.lang.String, success: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  ...
  def closeBluetoothAdapter(success: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  ...
  def createBLEConnection(deviceId: java.lang.String): scala.Unit = js.native
  def createBLEConnection(deviceId: java.lang.String, timeout: scala.Double): scala.Unit = js.native
  ...
  def getBLEDeviceCharacteristics(deviceId: java.lang.String): scala.Unit = js.native
  def getBLEDeviceCharacteristics(deviceId: java.lang.String, serviceId: java.lang.String): scala.Unit = js.native
  ...
  def getBLEDeviceServices(deviceId: java.lang.String): scala.Unit = js.native
  def getBLEDeviceServices(deviceId: java.lang.String, success: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  ...
  def getBluetoothAdapterState(success: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  ...
  def getBluetoothDevices(success: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  ...
  def getConnectedBluetoothDevices(services: js.Array[_]): scala.Unit = js.native
  def getConnectedBluetoothDevices(services: js.Array[_], success: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  ...
  def notifyBLECharacteristicValueChange(
    deviceId: js.UndefOr[java.lang.String],
    serviceId: js.UndefOr[java.lang.String],
    characteristicId: js.UndefOr[java.lang.String],
    state: js.UndefOr[scala.Boolean],
    success: js.UndefOr[js.Function1[/* result */ js.Any, scala.Unit]],
    fail: js.UndefOr[js.Function1[/* result */ js.Any, scala.Unit]],
    complete: js.UndefOr[js.Function1[/* result */ js.Any, scala.Unit]]
  ): scala.Unit = js.native
  /**
    * 监听低功耗蓝牙设备的特征值变化事件
    * 
  ...
  def onBLECharacteristicValueChange(callback: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
    * 监听低功耗蓝牙设备连接状态变化事件
  ...
  def onBLEConnectionStateChange(callback: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
    * 监听蓝牙适配器状态变化事件
    * 蓝牙适配器状态发生变化时触发回调。
    * 
  ...
  def onBluetoothAdapterStateChange(changeCB: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
    * 监听搜索到新设备的事件
    * 搜索到新设备时触发回调。
    * 
  ...
  def onBluetoothDeviceFound(callback: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
    * 初始化蓝牙模块
  ...
  def openBluetoothAdapter(success: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  ...
  def startBluetoothDevicesDiscovery(
    ...
    allowDuplicatesKey: js.UndefOr[scala.Boolean],
  ...
  def stopBluetoothDevicesDiscovery(success: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  ...
  def writeBLECharacteristicValue(
    ...
    serviceId: js.UndefOr[java.lang.String],
    characteristicId: js.UndefOr[java.lang.String],
    value: js.UndefOr[stdLib.ArrayBuffer],
    success: js.UndefOr[js.Function1[/* result */ js.Any, scala.Unit]],
    fail: js.UndefOr[js.Function1[/* result */ js.Any, scala.Unit]],
    complete: js.UndefOr[js.Function1[/* result */ js.Any, scala.Unit]]
  ): scala.Unit = js.native
