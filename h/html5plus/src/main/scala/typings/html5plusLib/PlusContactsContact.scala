...
/**
  ...
  */
@js.native
trait PlusContactsContact extends js.Object {
  /**
    * 数组，联系人的地址
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/contacts.html](http://www.html5plus.org/doc/zh_cn/contacts.html)
    */
  var birthday: js.UndefOr[stdLib.Date] = js.native
  /**
    * 数组，联系人的组名
  ...
  def remove(successCB: js.Function0[scala.Unit]): scala.Unit = js.native
  def remove(successCB: js.Function0[scala.Unit], errorCB: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
    * 保存联系人
  ...
  def save(successCB: js.Function0[scala.Unit]): scala.Unit = js.native
  def save(successCB: js.Function0[scala.Unit], errorCB: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
}
