...
/**
  ...
  */
@js.native
trait PlusBarcode extends js.Object {
  /**
    * Aztec二维码，数值为3
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var AZTEC: js.UndefOr[scala.Double] = js.native
  /**
    * Barcode扫码控件对象
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var CODABAR: js.UndefOr[scala.Double] = js.native
  /**
    * Code128条形码，数值为10
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var CODE128: js.UndefOr[scala.Double] = js.native
  /**
    * Code39条形码，数值为8
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var CODE39: js.UndefOr[scala.Double] = js.native
  /**
    * Code93条形码，数值为9
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var CODE93: js.UndefOr[scala.Double] = js.native
  /**
    * Data Matrix二维码，数值为4
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var DATAMATRIX: js.UndefOr[scala.Double] = js.native
  /**
    * EAN条形码标准版，数值为1
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var EAN13: js.UndefOr[scala.Double] = js.native
  /**
    * ENA条形码简版，数值为2
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var EAN8: js.UndefOr[scala.Double] = js.native
  /**
    * ITF条形码，数值为11
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var ITF: js.UndefOr[scala.Double] = js.native
  /**
    * MaxiCode二维码，数值为12
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var MAXICODE: js.UndefOr[scala.Double] = js.native
  /**
    * PDF 417二维条码，数值为13
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var PDF417: js.UndefOr[scala.Double] = js.native
  /**
    * QR二维码，数值为0
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var QR: js.UndefOr[scala.Double] = js.native
  /**
    * RSS 14条形组合码，数值为14
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var RSS14: js.UndefOr[scala.Double] = js.native
  /**
    * 扩展式RSS条形组合码，数值为15
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var RSSEXPANDED: js.UndefOr[scala.Double] = js.native
  /**
    * UPC条形码标准版，数值为5
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var UPCA: js.UndefOr[scala.Double] = js.native
  /**
    * UPC条形码缩短版，数值为6
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var UPCE: js.UndefOr[scala.Double] = js.native
  /**
    * 创建Barcode对象
  ...
  def create(id: java.lang.String): PlusBarcodeBarcode = js.native
  def create(id: java.lang.String, filters: js.Array[_]): PlusBarcodeBarcode = js.native
  def create(id: java.lang.String, filters: js.Array[_], styles: PlusBarcodeBarcodeStyles): PlusBarcodeBarcode = js.native
  /**
    * 查找已经创建的Barcode对象
  ...
  def getBarcodeById(id: java.lang.String): PlusBarcodeBarcode = js.native
  /**
    * 通过图片扫码识别
  ...
  def scan(path: java.lang.String): scala.Unit = js.native
  def scan(
    path: java.lang.String,
    successCB: js.Function3[
