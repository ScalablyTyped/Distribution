...
trait PlusAndroid extends js.Object {
  ...
  def getAttribute(obj: PlusAndroidInstanceObject, name: java.lang.String): js.Any = js.native
  /**
    * 实现Interface的方法
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/android.html](http://www.html5plus.org/doc/zh_cn/android.html)
  ...
  def implements(name: java.lang.String): PlusAndroidInstanceObject = js.native
  def implements(name: java.lang.String, obj: js.Any): PlusAndroidInstanceObject = js.native
  /**
    * 导入Java类对象
  ...
  def importClass(classname: java.lang.String): PlusAndroidClassObject = js.native
  /**
    * 调用对象（类对象/实例对象）的方法
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/android.html](http://www.html5plus.org/doc/zh_cn/android.html)
  ...
  def invoke(obj: PlusAndroidInstanceObject, name: java.lang.String): js.Any = js.native
  def invoke(obj: PlusAndroidInstanceObject, name: java.lang.String, args: js.Any): js.Any = js.native
  /**
    * 创建实例对象
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/android.html](http://www.html5plus.org/doc/zh_cn/android.html)
  ...
  def newObject(classname: java.lang.String): PlusAndroidInstanceObject = js.native
  def newObject(classname: java.lang.String, args: js.Any): PlusAndroidInstanceObject = js.native
  /**
    * 获取应用主Activity实例对象
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/android.html](http://www.html5plus.org/doc/zh_cn/android.html)
    */
  def setAttribute(): scala.Unit = js.native
  def setAttribute(obj: PlusAndroidInstanceObject): scala.Unit = js.native
  def setAttribute(obj: PlusAndroidInstanceObject, name: java.lang.String): scala.Unit = js.native
  def setAttribute(obj: PlusAndroidInstanceObject, name: java.lang.String, value: js.Any): scala.Unit = js.native
}
