...
trait PlusVideoVideoPlayerEvents extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/video.html](http://www.html5plus.org/doc/zh_cn/video.html)
    */
  var ended: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 视频错误事件
    * 当视频播放出错时触发。
    * 	无事件回调函数参数。
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/video.html](http://www.html5plus.org/doc/zh_cn/video.html)
    */
  var fullscreenchange: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 视频暂停事件
    * 当视频暂停播放时触发。
    * 	无事件回调函数参数。
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/video.html](http://www.html5plus.org/doc/zh_cn/video.html)
    */
  var timeupdate: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 视频缓冲事件
    * 当视频播放出现缓冲时触发。
    * 	无事件回调函数参数。
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/video.html](http://www.html5plus.org/doc/zh_cn/video.html)
    */
  var waiting: js.UndefOr[java.lang.String] = js.undefined
}

object PlusVideoVideoPlayerEvents {
  @scala.inline
  def apply(
    ended: java.lang.String = null,
    error: java.lang.String = null,
    fullscreenchange: java.lang.String = null,
    pause: java.lang.String = null,
    play: java.lang.String = null,
    timeupdate: java.lang.String = null,
    waiting: java.lang.String = null
