...
trait PlusContacts extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/contacts.html](http://www.html5plus.org/doc/zh_cn/contacts.html)
    */
  var ADDRESSBOOK_PHONE: js.UndefOr[scala.Double] = js.native
  /**
    * SIM卡通讯录
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/contacts.html](http://www.html5plus.org/doc/zh_cn/contacts.html)
    */
  var ADDRESSBOOK_SIM: js.UndefOr[scala.Double] = js.native
  /**
    * 通讯录对象
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/contacts.html](http://www.html5plus.org/doc/zh_cn/contacts.html)
    */
  def getAddressBook(): scala.Unit = js.native
  def getAddressBook(`type`: scala.Double): scala.Unit = js.native
  def getAddressBook(`type`: scala.Double, successCB: js.Function1[/* result */ PlusContactsAddressBook, scala.Unit]): scala.Unit = js.native
  def getAddressBook(
    `type`: scala.Double,
    successCB: js.Function1[/* result */ PlusContactsAddressBook, scala.Unit],
