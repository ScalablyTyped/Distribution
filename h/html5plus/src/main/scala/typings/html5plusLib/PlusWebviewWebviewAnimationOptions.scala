...
trait PlusWebviewWebviewAnimationOptions extends js.Object {
  ...
  var action: js.UndefOr[
    html5plusLib.html5plusLibStrings.none | html5plusLib.html5plusLibStrings.hide | html5plusLib.html5plusLibStrings.close
  ] = js.undefined
  /**
    * 动画样式
    * 用于指定动画窗口的起始位置，目标位置等。
...
object PlusWebviewWebviewAnimationOptions {
  @scala.inline
  def apply(
    action: html5plusLib.html5plusLibStrings.none | html5plusLib.html5plusLibStrings.hide | html5plusLib.html5plusLibStrings.close = null,
