...
trait PlusNavigatorSplashscreenOptions extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/navigator.html](http://www.html5plus.org/doc/zh_cn/navigator.html)
    */
  var autoclose_w2a: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * 启动界面延时关闭时间
    * 仅在设置为自动关闭启动界面时有效。
    * 
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/navigator.html](http://www.html5plus.org/doc/zh_cn/navigator.html)
    */
  var delay_w2a: js.UndefOr[scala.Double] = js.undefined
  /**
    * 启动界面的图片路径
...
object PlusNavigatorSplashscreenOptions {
  ...
  def apply(
    ...
    autoclose_w2a: js.UndefOr[scala.Boolean] = js.undefined,
    delay: scala.Int | scala.Double = null,
    delay_w2a: scala.Int | scala.Double = null,
