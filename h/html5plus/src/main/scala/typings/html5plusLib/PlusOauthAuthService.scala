...
trait PlusOauthAuthService extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/oauth.html](http://www.html5plus.org/doc/zh_cn/oauth.html)
    */
  def addPhoneNumber(): scala.Unit = js.native
  def addPhoneNumber(successCallback: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  def addPhoneNumber(
  ...
  def authorize(successCallback: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  def authorize(
    successCallback: js.Function1[/* result */ js.Any, scala.Unit],
    errorCallback: js.Function1[/* result */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  ...
  def getUserInfo(successCallback: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  def getUserInfo(
    successCallback: js.Function1[/* result */ js.Any, scala.Unit],
    errorCallback: js.Function1[/* result */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  ...
  def login(successCallback: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  def login(
    successCallback: js.Function1[/* result */ js.Any, scala.Unit],
    errorCallback: js.Function1[/* result */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  ...
  def logout(successCallback: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  def logout(
    successCallback: js.Function1[/* result */ js.Any, scala.Unit],
    errorCallback: js.Function1[/* result */ js.Any, scala.Unit]
  ): scala.Unit = js.native
