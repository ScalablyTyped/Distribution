...
trait PlusWebviewWebviewSubNViewStyles extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    html5plusLib.html5plusLibStrings.NView | html5plusLib.html5plusLibStrings.ImageSlider
  ] = js.undefined
}
...
object PlusWebviewWebviewSubNViewStyles {
  ...
  def apply(
    ...
    `type`: html5plusLib.html5plusLibStrings.NView | html5plusLib.html5plusLibStrings.ImageSlider = null
