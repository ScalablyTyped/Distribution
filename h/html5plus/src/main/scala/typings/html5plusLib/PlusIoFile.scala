...
trait PlusIoFile extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
    */
  var lastModifiedDate: js.UndefOr[stdLib.Date] = js.native
  /**
    * 文件数据对象的名称，不包括路径
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/io.html](http://www.html5plus.org/doc/zh_cn/io.html)
  ...
  def slice(start: scala.Double): PlusIoFile = js.native
  def slice(start: scala.Double, end: scala.Double): PlusIoFile = js.native
}
