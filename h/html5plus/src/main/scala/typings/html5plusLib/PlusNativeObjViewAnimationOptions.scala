...
trait PlusNativeObjViewAnimationOptions extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/nativeobj.html](http://www.html5plus.org/doc/zh_cn/nativeobj.html)
    */
  var frames: js.UndefOr[scala.Double] = js.undefined
  /**
    * 动画作用区域
    * 支持以下属性：
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/nativeobj.html](http://www.html5plus.org/doc/zh_cn/nativeobj.html)
    */
  var `type`: js.UndefOr[html5plusLib.html5plusLibStrings.shrink] = js.undefined
}
...
object PlusNativeObjViewAnimationOptions {
  ...
  def apply(
    ...
    frames: scala.Int | scala.Double = null,
    region: PlusNativeObjRect = null,
    `type`: html5plusLib.html5plusLibStrings.shrink = null
