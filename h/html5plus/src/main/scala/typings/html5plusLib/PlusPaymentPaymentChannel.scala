...
trait PlusPaymentPaymentChannel extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/payment.html](http://www.html5plus.org/doc/zh_cn/payment.html)
    */
  var serviceReady: js.UndefOr[scala.Boolean] = js.native
  /**
    * 安装支付通道依赖的服务
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/payment.html](http://www.html5plus.org/doc/zh_cn/payment.html)
    */
  def installService(): scala.Unit = js.native
  /**
    * 向IAP服务器请求支付订单
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/payment.html](http://www.html5plus.org/doc/zh_cn/payment.html)
    */
  def requestOrder(): scala.Unit = js.native
  def requestOrder(ids: js.Array[_]): scala.Unit = js.native
  def requestOrder(ids: js.Array[_], successCB: js.Function1[/* result */ js.Array[PlusPayment], scala.Unit]): scala.Unit = js.native
  def requestOrder(
    ids: js.Array[_],
    successCB: js.Function1[/* result */ js.Array[PlusPayment], scala.Unit],
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/payment.html](http://www.html5plus.org/doc/zh_cn/payment.html)
    */
  def restoreComplateRequest(): scala.Unit = js.native
  def restoreComplateRequest(options: js.Any): scala.Unit = js.native
  def restoreComplateRequest(options: js.Any, successCB: js.Function1[/* result */ js.Array[PlusPayment], scala.Unit]): scala.Unit = js.native
}
