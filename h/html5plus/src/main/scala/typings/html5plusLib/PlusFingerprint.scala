...
trait PlusFingerprint extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/fingerprint.html](http://www.html5plus.org/doc/zh_cn/fingerprint.html)
    */
  def authenticate(): scala.Unit = js.native
  def authenticate(successCB: js.Function0[scala.Unit]): scala.Unit = js.native
  def authenticate(
    successCB: js.Function0[scala.Unit],
    errorCB: js.Function1[/* result */ PlusFingerprintFingerprintError, scala.Unit]
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/fingerprint.html](http://www.html5plus.org/doc/zh_cn/fingerprint.html)
    */
  def isEnrolledFingerprints(): scala.Boolean = js.native
  /**
    * 当前设备是否设置密码锁屏
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/fingerprint.html](http://www.html5plus.org/doc/zh_cn/fingerprint.html)
    */
  def isKeyguardSecure(): scala.Boolean = js.native
  /**
    * 当前设备环境是否支持指纹识别
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/fingerprint.html](http://www.html5plus.org/doc/zh_cn/fingerprint.html)
    */
  def isSupport(): scala.Boolean = js.native
}
