...
/**
  ...
  */
@js.native
trait PlusWebview extends js.Object {
  /**
    * 一组用于定义页面或控件关闭的动画效果
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
  ...
  def close(id_wvobj: java.lang.String): scala.Unit = js.native
  def close(id_wvobj: java.lang.String, aniClose: java.lang.String): scala.Unit = js.native
  def close(id_wvobj: java.lang.String, aniClose: java.lang.String, duration: scala.Double): scala.Unit = js.native
  def close(
    id_wvobj: java.lang.String,
    aniClose: java.lang.String,
  ...
  def create(url: java.lang.String): PlusWebviewWebviewObject = js.native
  def create(url: java.lang.String, id: java.lang.String): PlusWebviewWebviewObject = js.native
  def create(url: java.lang.String, id: java.lang.String, styles: PlusWebviewWebviewStyles): PlusWebviewWebviewObject = js.native
  def create(url: java.lang.String, id: java.lang.String, styles: PlusWebviewWebviewStyles, extras: js.Any): PlusWebviewWebviewObject = js.native
  /**
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  def defaultHardwareAccelerated(): scala.Boolean = js.native
  /**
    * 获取屏幕所有可视的Webview窗口
  ...
  def getWebviewById(id: java.lang.String): PlusWebviewWebviewObject = js.native
  /**
    * 隐藏Webview窗口
  ...
  def hide(id_wvobj: java.lang.String): scala.Unit = js.native
  def hide(id_wvobj: java.lang.String, aniHide: java.lang.String): scala.Unit = js.native
  def hide(id_wvobj: java.lang.String, aniHide: java.lang.String, duration: scala.Double): scala.Unit = js.native
  def hide(
    id_wvobj: java.lang.String,
    aniHide: java.lang.String,
    duration: scala.Double,
    extras: PlusWebviewWebviewExtraOptions
  ): scala.Unit = js.native
  /**
  ...
  def open(
    ...
    aniShow: js.UndefOr[java.lang.String],
    duration: js.UndefOr[scala.Double],
    showedCB: js.UndefOr[js.Function0[scala.Unit]]
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  def prefetchURL(): scala.Unit = js.native
  def prefetchURL(url: java.lang.String): scala.Unit = js.native
  /**
    * 预载网络页面（多个地址）
    * 预载网络页面会向服务器发起http/https请求获取html页面内容，
    * 	待Webview窗口加载此url页面时会则根据缓存机制优先使用预载的页面内容(加快页面显示速度)。
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  def prefetchURLs(): scala.Unit = js.native
  def prefetchURLs(urls: js.Array[_]): scala.Unit = js.native
  /**
    * 显示Webview窗口
  ...
  def show(id_wvobj: java.lang.String): PlusWebviewWebviewObject = js.native
  def show(id_wvobj: java.lang.String, aniShow: java.lang.String): PlusWebviewWebviewObject = js.native
  def show(id_wvobj: java.lang.String, aniShow: java.lang.String, duration: scala.Double): PlusWebviewWebviewObject = js.native
  def show(
    id_wvobj: java.lang.String,
    aniShow: java.lang.String,
    duration: scala.Double,
  ...
  def startAnimation(options: PlusWebviewWebviewAnimationOptions): scala.Unit = js.native
  def startAnimation(options: PlusWebviewWebviewAnimationOptions, otherOptions: PlusWebviewWebviewAnimationOptions): scala.Unit = js.native
  def startAnimation(
