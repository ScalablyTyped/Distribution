...
trait PlusBarcodeBarcode extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var onerror: js.UndefOr[js.Function1[/* result */ js.Any, scala.Unit]] = js.native
  /**
    * 条码识别成功事件
  ...
  var onmarked: js.UndefOr[
    js.Function3[
      /* result0 */ scala.Double, 
      /* result1 */ java.lang.String, 
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  def setFlash(): scala.Unit = js.native
  def setFlash(open: scala.Boolean): scala.Unit = js.native
  /**
    * 设置Barcode扫码控件的配置参数
  ...
  def setStyles(styles: PlusBarcodeBarcodeStyles): scala.Unit = js.native
  /**
    * 开始条码识别
  ...
  def start(optons: PlusBarcodeBarcodeOptions): scala.Unit = js.native
}
