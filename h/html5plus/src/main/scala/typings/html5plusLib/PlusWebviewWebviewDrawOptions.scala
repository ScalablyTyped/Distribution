...
trait PlusWebviewWebviewDrawOptions extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var bit: js.UndefOr[html5plusLib.html5plusLibStrings.RGB565 | html5plusLib.html5plusLibStrings.ARGB] = js.undefined
  /**
    * 是否检测截屏图片是否为空白
    * 可取值：
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var checkKeyboard: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * 设置截屏区域
...
object PlusWebviewWebviewDrawOptions {
  @scala.inline
  def apply(
    bit: html5plusLib.html5plusLibStrings.RGB565 | html5plusLib.html5plusLibStrings.ARGB = null,
    check: js.UndefOr[scala.Boolean] = js.undefined,
    checkKeyboard: js.UndefOr[scala.Boolean] = js.undefined,
