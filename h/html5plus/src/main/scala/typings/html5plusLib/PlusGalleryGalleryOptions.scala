...
trait PlusGalleryGalleryOptions extends js.Object {
  ...
  var filter: js.UndefOr[
    html5plusLib.html5plusLibStrings.image | html5plusLib.html5plusLibStrings.video | html5plusLib.html5plusLibStrings.none
  ] = js.undefined
  /**
    * 最多选择的图片数量
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/gallery.html](http://www.html5plus.org/doc/zh_cn/gallery.html)
    */
  var onmaxed: js.UndefOr[js.Function0[scala.Unit]] = js.undefined
  /**
    * 相册选择界面弹出指示区域
