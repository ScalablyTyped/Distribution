...
trait PlusPush extends js.Object {
  ...
  def addEventListener(`type`: java.lang.String, listener: js.Function1[/* result */ java.lang.String, scala.Unit]): scala.Unit = js.native
  def addEventListener(
    `type`: java.lang.String,
    listener: js.Function1[/* result */ java.lang.String, scala.Unit],
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/push.html](http://www.html5plus.org/doc/zh_cn/push.html)
    */
  def createMessage(): scala.Unit = js.native
  def createMessage(content: java.lang.String): scala.Unit = js.native
  def createMessage(content: java.lang.String, payload: java.lang.String): scala.Unit = js.native
  def createMessage(content: java.lang.String, payload: java.lang.String, options: PlusPushMessageOptions): scala.Unit = js.native
  /**
    * 获取所有推送消息
    * 获取客户端接收到的所有推送消息。
  ...
  def remove(message: PlusPushPushMessage): scala.Unit = js.native
  /**
    * 设置程序是否将消息显示在系统消息中心
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/push.html](http://www.html5plus.org/doc/zh_cn/push.html)
    */
  def setAutoNotification(): scala.Unit = js.native
  def setAutoNotification(notify: scala.Boolean): scala.Unit = js.native
}
