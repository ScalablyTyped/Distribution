...
trait PlusNativeUI extends js.Object {
  ...
  def actionSheet(
    ...
    actionsheetCallback: js.Function1[/* result */ js.Any, scala.Unit]
  ...
  def alert(message: java.lang.String, alertCB: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  def alert(
    message: java.lang.String,
    alertCB: js.Function1[/* result */ js.Any, scala.Unit],
  ...
  def alert(
    ...
    alertCB: js.Function1[/* result */ js.Any, scala.Unit],
    title: java.lang.String,
    buttonCapture: java.lang.String
  ): scala.Unit = js.native
  /**
    * 关闭自动消失的提示消息
    * 关闭已经显示的所有自动消失的提示框。
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/nativeui.html](http://www.html5plus.org/doc/zh_cn/nativeui.html)
    */
  def closeToast(): scala.Unit = js.native
  /**
    * 关闭系统等待对话框
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/nativeui.html](http://www.html5plus.org/doc/zh_cn/nativeui.html)
    */
  def closeWaiting(): scala.Unit = js.native
  /**
    * 弹出系统确认对话框
  ...
  def confirm(message: java.lang.String, confirmCB: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  def confirm(
    message: java.lang.String,
    confirmCB: js.Function1[/* result */ js.Any, scala.Unit],
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/nativeui.html](http://www.html5plus.org/doc/zh_cn/nativeui.html)
    */
  def pickDate(): scala.Unit = js.native
  def pickDate(successCB: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  def pickDate(
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/nativeui.html](http://www.html5plus.org/doc/zh_cn/nativeui.html)
    */
  def pickTime(): scala.Unit = js.native
  def pickTime(successCB: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  def pickTime(
    successCB: js.Function1[/* result */ js.Any, scala.Unit],
    errorCB: js.Function1[/* result */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  ...
  def previewImage(urls: js.Array[_]): scala.Unit = js.native
  def previewImage(urls: js.Array[_], options: PlusNativeUIPreviewImageOptions): scala.Unit = js.native
  /**
    * 弹出系统输入对话框
  ...
  def prompt(message: java.lang.String): scala.Unit = js.native
  def prompt(message: java.lang.String, promptCB: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  def prompt(
    message: java.lang.String,
    promptCB: js.Function1[/* result */ js.Any, scala.Unit],
    title: java.lang.String
  ): scala.Unit = js.native
  def prompt(
    message: java.lang.String,
  ...
  def showWaiting(title: java.lang.String): PlusNativeUIWaitingObj = js.native
  def showWaiting(title: java.lang.String, options: PlusNativeUIWaitingOptions): PlusNativeUIWaitingObj = js.native
  /**
    * 显示自动消失的提示消息
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/nativeui.html](http://www.html5plus.org/doc/zh_cn/nativeui.html)
    */
  def toast(): scala.Unit = js.native
  def toast(message: java.lang.String): scala.Unit = js.native
  def toast(message: java.lang.String, options: PlusNativeUIToastOptions): scala.Unit = js.native
}
