...
trait PlusOrientation extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/orientation.html](http://www.html5plus.org/doc/zh_cn/orientation.html)
    */
  def getCurrentOrientation(): scala.Unit = js.native
  def getCurrentOrientation(successCB: js.Function1[/* result */ java.lang.String, scala.Unit]): scala.Unit = js.native
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/orientation.html](http://www.html5plus.org/doc/zh_cn/orientation.html)
    */
  def watchOrientation(): scala.Double = js.native
  def watchOrientation(successCB: js.Function1[/* result */ java.lang.String, scala.Unit]): scala.Double = js.native
