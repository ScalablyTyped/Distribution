...
trait PlusDownloader extends js.Object {
  ...
  def clear(state: PlusDownloaderDownloadState): scala.Unit = js.native
  /**
    * 新建下载任务
  ...
  def createDownload(url: java.lang.String): PlusDownloaderDownload = js.native
  def createDownload(url: java.lang.String, options: PlusDownloaderDownloadOptions): PlusDownloaderDownload = js.native
  def createDownload(
    url: java.lang.String,
    options: PlusDownloaderDownloadOptions,
    completedCB: js.Function2[/* result0 */ PlusDownloaderDownload, /* result1 */ scala.Double, scala.Unit]
  ...
  def enumerate(enumCB: js.Function1[/* result */ js.Array[_], scala.Unit]): scala.Unit = js.native
  def enumerate(enumCB: js.Function1[/* result */ js.Array[_], scala.Unit], state: PlusDownloaderDownloadState): scala.Unit = js.native
  /**
    * 开始所有下载任务
