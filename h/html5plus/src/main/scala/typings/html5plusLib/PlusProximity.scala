...
trait PlusProximity extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/proximity.html](http://www.html5plus.org/doc/zh_cn/proximity.html)
    */
  def getCurrentProximity(): scala.Unit = js.native
  def getCurrentProximity(successCB: js.Function1[/* result */ scala.Double, scala.Unit]): scala.Unit = js.native
  def getCurrentProximity(
    successCB: js.Function1[/* result */ scala.Double, scala.Unit],
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/proximity.html](http://www.html5plus.org/doc/zh_cn/proximity.html)
    */
  def watchProximity(): scala.Double = js.native
  def watchProximity(changeCB: js.Function1[/* result */ scala.Double, scala.Unit]): scala.Double = js.native
  def watchProximity(
    changeCB: js.Function1[/* result */ scala.Double, scala.Unit],
    errorCB: js.Function1[/* result */ js.Any, scala.Unit]
