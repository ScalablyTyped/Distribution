...
trait PlusVideo extends js.Object {
  ...
  def createLivePusher(id: java.lang.String): PlusVideoLivePusher = js.native
  def createLivePusher(id: java.lang.String, styles: PlusVideoLivePusherStyles): PlusVideoLivePusher = js.native
  /**
    * 创建VideoPlayer对象
    * 调用此方法创建后并不会显示，需要调用Webview窗口的append方法将其添加到Webview窗口后才能显示。
    * 	注意：此时需要通过styles参数的top/left/width/height属性设置控件的位置及大小。
  ...
  def createVideoPlayer(id: java.lang.String): PlusVideoVideoPlayer = js.native
  def createVideoPlayer(id: java.lang.String, styles: PlusVideoVideoPlayerStyles): PlusVideoVideoPlayer = js.native
  /**
    * 查找已经创建的LivePusher对象
  ...
  def getLivePusherById(id: java.lang.String): PlusVideoLivePusher = js.native
  /**
  ...
  def getVideoPlayerById(id: java.lang.String): PlusVideoVideoPlayer = js.native
}
