...
trait PlusShareShareService extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/share.html](http://www.html5plus.org/doc/zh_cn/share.html)
    */
  var authenticated: js.UndefOr[scala.Boolean] = js.native
  /**
    * 分享服务描述
    * 用于描述分享服务的信息：
    * 	如“新浪微博”、“腾讯微博”、“微信”、“QQ”。
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/share.html](http://www.html5plus.org/doc/zh_cn/share.html)
    */
  var nativeClient: js.UndefOr[scala.Boolean] = js.native
  /**
    * 授权认证操作
  ...
  def authorize(successCallback: js.Function1[/* result */ this.type, scala.Unit]): scala.Unit = js.native
  def authorize(
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/share.html](http://www.html5plus.org/doc/zh_cn/share.html)
    */
  def forbid(): scala.Unit = js.native
  /**
    * 调用微信小程序
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/share.html](http://www.html5plus.org/doc/zh_cn/share.html)
    */
  def launchMiniProgram(): scala.Unit = js.native
  def launchMiniProgram(options: PlusShareWeixinMiniProgramOptions): scala.Unit = js.native
  /**
    * 发送分享
  ...
  def send(msg: PlusShareShareMessage): scala.Unit = js.native
  def send(msg: PlusShareShareMessage, successCB: js.Function0[scala.Unit]): scala.Unit = js.native
  def send(
