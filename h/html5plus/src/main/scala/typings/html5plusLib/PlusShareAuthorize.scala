...
trait PlusShareAuthorize extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/share.html](http://www.html5plus.org/doc/zh_cn/share.html)
    */
  var onauthenticated: js.UndefOr[js.Function0[scala.Unit]] = js.native
  /**
    * 分享授权认证失败事件
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/share.html](http://www.html5plus.org/doc/zh_cn/share.html)
    */
  var onloaded: js.UndefOr[js.Function1[/* result */ js.Any, scala.Unit]] = js.native
  /**
    * 加载分享授权页面
  ...
  def load(id: java.lang.String): scala.Unit = js.native
  /**
    * 设置分享授权控件是否可见
