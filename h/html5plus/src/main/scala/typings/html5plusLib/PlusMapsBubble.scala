...
trait PlusMapsBubble extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/maps.html](http://www.html5plus.org/doc/zh_cn/maps.html)
    */
  def loadImage(): scala.Unit = js.native
  def loadImage(path: java.lang.String): scala.Unit = js.native
  /**
    * 从图片数据加载气泡显示的内容
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/maps.html](http://www.html5plus.org/doc/zh_cn/maps.html)
    */
  def loadImageDataURL(): scala.Unit = js.native
  def loadImageDataURL(data: java.lang.String): scala.Unit = js.native
  /**
    * 设置气泡上显示的图标
