...
trait PlusShare extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/share.html](http://www.html5plus.org/doc/zh_cn/share.html)
    */
  def sendWithSystem(): scala.Unit = js.native
  def sendWithSystem(msg: PlusShareShareMessage): scala.Unit = js.native
  def sendWithSystem(msg: PlusShareShareMessage, successCB: js.Function0[scala.Unit]): scala.Unit = js.native
  def sendWithSystem(
