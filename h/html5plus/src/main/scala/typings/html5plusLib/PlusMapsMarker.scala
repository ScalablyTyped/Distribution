...
trait PlusMapsMarker extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/maps.html](http://www.html5plus.org/doc/zh_cn/maps.html)
    */
  var onDrag: js.UndefOr[js.Function1[/* result */ js.Any, scala.Unit]] = js.native
  /**
    * 用户点击地图标点事件
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/maps.html](http://www.html5plus.org/doc/zh_cn/maps.html)
    */
  var onclick: js.UndefOr[js.Function1[/* result */ PlusMapsOverlay, scala.Unit]] = js.native
  /**
    * 覆盖物显示到最上层
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/maps.html](http://www.html5plus.org/doc/zh_cn/maps.html)
    */
  def bringToTop(): scala.Unit = js.native
  /**
    * 获取标点上显示的文本标注
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/maps.html](http://www.html5plus.org/doc/zh_cn/maps.html)
    */
  def hideBubble(): scala.Unit = js.native
  /**
    * 获取标点是否允许拖拽
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/maps.html](http://www.html5plus.org/doc/zh_cn/maps.html)
  ...
  def setBubble(buuble: PlusMapsBubble): scala.Unit = js.native
  def setBubble(buuble: PlusMapsBubble, pop: scala.Boolean): scala.Unit = js.native
  /**
    * 设置标点的是否允许拖拽
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/maps.html](http://www.html5plus.org/doc/zh_cn/maps.html)
    */
  def setIcons(): scala.Unit = js.native
  def setIcons(icons: js.Array[_]): scala.Unit = js.native
  /**
    * 设置标点上显示的文本标注
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/maps.html](http://www.html5plus.org/doc/zh_cn/maps.html)
    */
  def setPoint(): scala.Unit = js.native
  def setPoint(point: PlusMapsPoint): scala.Unit = js.native
}
