...
trait PlusWebviewWebviewOverrideUrlOptions extends js.Object {
  ...
  var effect: js.UndefOr[
    html5plusLib.html5plusLibStrings.instant | html5plusLib.html5plusLibStrings.Empty
  ] = js.undefined
  /**
    * 排除拦截处理请求类型
  ...
  var exclude: js.UndefOr[
    html5plusLib.html5plusLibStrings.none | html5plusLib.html5plusLibStrings.redirect
  ] = js.undefined
  /**
    * 区配是否需要处理的URL请求
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var mode: js.UndefOr[html5plusLib.html5plusLibStrings.allow | html5plusLib.html5plusLibStrings.reject] = js.undefined
}

object PlusWebviewWebviewOverrideUrlOptions {
  @scala.inline
  def apply(
    effect: html5plusLib.html5plusLibStrings.instant | html5plusLib.html5plusLibStrings.Empty = null,
    exclude: html5plusLib.html5plusLibStrings.none | html5plusLib.html5plusLibStrings.redirect = null,
    `match`: java.lang.String = null,
    mode: html5plusLib.html5plusLibStrings.allow | html5plusLib.html5plusLibStrings.reject = null
