...
trait PlusBarcodeBarcodeOptions extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var conserve: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * 保存扫码成功时图片保存路径
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/barcode.html](http://www.html5plus.org/doc/zh_cn/barcode.html)
    */
  var sound: js.UndefOr[html5plusLib.html5plusLibStrings.none | html5plusLib.html5plusLibStrings.default] = js.undefined
  /**
    * 扫码成功时是否需要震动提醒
...
object PlusBarcodeBarcodeOptions {
  @scala.inline
  def apply(
    conserve: js.UndefOr[scala.Boolean] = js.undefined,
    filename: java.lang.String = null,
    sound: html5plusLib.html5plusLibStrings.none | html5plusLib.html5plusLibStrings.default = null,
