...
/**
  ...
  */
@js.native
trait PlusAccelerometer extends js.Object {
  /**
    * 设备加速度信息对象
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/accelerometer.html](http://www.html5plus.org/doc/zh_cn/accelerometer.html)
    */
  def getCurrentAcceleration(): scala.Unit = js.native
  def getCurrentAcceleration(successCB: js.Function1[/* result */ PlusAccelerometerAcceleration, scala.Unit]): scala.Unit = js.native
  def getCurrentAcceleration(
    successCB: js.Function1[/* result */ PlusAccelerometerAcceleration, scala.Unit],
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/accelerometer.html](http://www.html5plus.org/doc/zh_cn/accelerometer.html)
    */
  def watchAcceleration(): scala.Double = js.native
  def watchAcceleration(successCB: js.Function1[/* result */ PlusAccelerometerAcceleration, scala.Unit]): scala.Double = js.native
