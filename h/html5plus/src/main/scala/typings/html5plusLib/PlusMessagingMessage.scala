...
trait PlusMessagingMessage extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/messaging.html](http://www.html5plus.org/doc/zh_cn/messaging.html)
    */
  var bodyType: js.UndefOr[
    html5plusLib.html5plusLibStrings.`text/plain` | html5plusLib.html5plusLibStrings.`text/html`
  ] = js.native
  /**
    * 抄送人信息
    * 字符串数组类型，仅发送邮件时有效，输入的地址收件人信息必须符合消息类型格式。
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/messaging.html](http://www.html5plus.org/doc/zh_cn/messaging.html)
    */
  def addAttachment(): scala.Unit = js.native
  def addAttachment(url: java.lang.String): scala.Unit = js.native
}
