...
trait PlusUploaderUpload extends js.Object {
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/uploader.html](http://www.html5plus.org/doc/zh_cn/uploader.html)
    */
  var responseText: js.UndefOr[java.lang.String] = js.native
  /**
    * 任务的状态
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/uploader.html](http://www.html5plus.org/doc/zh_cn/uploader.html)
    */
  var uploadedSize: js.UndefOr[scala.Double] = js.native
  /**
    * 上传文件的服务器地址
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/uploader.html](http://www.html5plus.org/doc/zh_cn/uploader.html)
    */
  def addData(): scala.Boolean = js.native
  def addData(key: java.lang.String): scala.Boolean = js.native
  def addData(key: java.lang.String, value: java.lang.String): scala.Boolean = js.native
  /**
    * 添加上传任务事件监听器
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/uploader.html](http://www.html5plus.org/doc/zh_cn/uploader.html)
    */
  def addFile(): scala.Boolean = js.native
  def addFile(path: java.lang.String): scala.Boolean = js.native
  def addFile(path: java.lang.String, options: PlusUploaderUploadFileOptions): scala.Boolean = js.native
  /**
    * 获取上传请求HTTP响应头部信息
