...
trait PlusScreen extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  var dpiX: js.UndefOr[scala.Double] = js.native
  /**
    * 设备屏幕垂直方向的密度
    * 设备屏幕的密度为每英寸所显示的像素点数，密度越高显示清晰度越高，单位为dpi。
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  var dpiY: js.UndefOr[scala.Double] = js.native
  /**
    * 设备屏幕高度分辨率
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  var resolutionHeight: js.UndefOr[scala.Double] = js.native
  /**
    * 设备屏幕宽度分辨率
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  var resolutionWidth: js.UndefOr[scala.Double] = js.native
  /**
    * 逻辑分辨率与实际分辨率的比例
  ...
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  def lockOrientation(): scala.Unit = js.native
  def lockOrientation(orientation: java.lang.String): scala.Unit = js.native
  /**
    * 设置屏幕亮度
    * 调用此方法调节设备屏幕亮度。
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  def setBrightness(): scala.Unit = js.native
  def setBrightness(brightness: scala.Double): scala.Unit = js.native
  /**
    * 解除锁定屏幕方向
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/device.html](http://www.html5plus.org/doc/zh_cn/device.html)
    */
  def unlockOrientation(): scala.Unit = js.native
}
