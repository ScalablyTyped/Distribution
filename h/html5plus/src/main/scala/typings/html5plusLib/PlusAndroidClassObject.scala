...
trait PlusAndroidClassObject extends js.Object {
  ...
  def plusGetAttribute(name: java.lang.String): js.Any = js.native
  /**
    * 设置Java类对象的静态属性
    * 
    * 参考: [http://www.html5plus.org/doc/zh_cn/android.html](http://www.html5plus.org/doc/zh_cn/android.html)
    */
  def plusSetAttribute(): scala.Unit = js.native
  def plusSetAttribute(name: java.lang.String): scala.Unit = js.native
  def plusSetAttribute(name: java.lang.String, value: js.Any): scala.Unit = js.native
}
