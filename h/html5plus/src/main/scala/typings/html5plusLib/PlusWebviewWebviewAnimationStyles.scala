...
trait PlusWebviewWebviewAnimationStyles extends js.Object {
  /**
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var fromLeft: js.UndefOr[java.lang.String] = js.undefined
  /**
    * 画窗口的目标左侧位置
    * 持百分比、像素值。
    ...
    * 参考: [http://www.html5plus.org/doc/zh_cn/webview.html](http://www.html5plus.org/doc/zh_cn/webview.html)
    */
  var toLeft: js.UndefOr[java.lang.String] = js.undefined
}

object PlusWebviewWebviewAnimationStyles {
  @scala.inline
  def apply(fromLeft: java.lang.String = null, toLeft: java.lang.String = null): PlusWebviewWebviewAnimationStyles = {
