...
- typings.highlightJs.mod.CompiledMode because var conflicts: contains, isCompiled, keywords. Inlined className, returnBegin, __beforeBegin, beginKeywords, end, endScope, onColonend, `match`, scope, excludeBegin, lexemes, cachedVariants, onColonbegin, endsParent, parent, subLanguage, beginScope, relevance, variants, skip, excludeEnd, label, starts, begin, endSameAsBegin, endsWithParent, returnEnd, illegal, data, terminatorEnd, keywordPatternRe, beginRe, endRe, illegalRe, matcher */ trait CompiledLanguage
  extends StObject
     with LanguageDetail {
...
object CompiledLanguage {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(begin = begin.asInstanceOf[js.Any], beginRe = beginRe.asInstanceOf[js.Any], beginScope = beginScope.asInstanceOf[js.Any], contains = contains.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], end = end.asInstanceOf[js.Any], endRe = endRe.asInstanceOf[js.Any], endScope = endScope.asInstanceOf[js.Any], illegalRe = illegalRe.asInstanceOf[js.Any], isCompiled = true, keywordPatternRe = keywordPatternRe.asInstanceOf[js.Any], keywords = keywords.asInstanceOf[js.Any], matcher = matcher.asInstanceOf[js.Any], parent = parent.asInstanceOf[js.Any], scope = scope.asInstanceOf[js.Any], starts = starts.asInstanceOf[js.Any], terminatorEnd = terminatorEnd.asInstanceOf[js.Any])
