...
import typings.highlightJs.anon.Block
import typings.highlightJs.anon.BlockLanguage
import typings.highlightJs.anon.El
...
trait HLJSPlugin extends StObject {
  ...
  var beforeColonhighlightElement: js.UndefOr[js.Function1[/* data */ typings.highlightJs.anon.Language, Unit]] = js.undefined
}
object HLJSPlugin {
  ...
  implicit open class MutableBuilder[Self <: HLJSPlugin] (val x: Self) extends AnyVal {
    ...
    inline def setBeforeColonhighlightElement(value: /* data */ typings.highlightJs.anon.Language => Unit): Self = StObject.set(x, "before:highlightElement", js.Any.fromFunction1(value))
