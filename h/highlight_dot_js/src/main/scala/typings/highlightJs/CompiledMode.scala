...
trait CompiledMode extends StObject {
  ...
  var compiled: js.UndefOr[Boolean] & `true`
  ...
  var keywords: (js.UndefOr[(Record[String, js.Any]) | String]) & KeywordDict
...
object CompiledMode {
  ...
  inline def apply(
    beginRe: RegExp,
    compiled: js.UndefOr[Boolean] & `true`,
    contains: js.Array[CompiledMode],
    data: Record[String, js.Any],
    endRe: RegExp,
    illegalRe: RegExp,
    keywordPatternRe: RegExp,
    keywords: (js.UndefOr[(Record[String, js.Any]) | String]) & KeywordDict,
    matcher: js.Any,
  ...
  extension [Self <: CompiledMode](x: Self) {
    ...
    inline def setCompiled(value: js.UndefOr[Boolean] & `true`): Self = StObject.set(x, "compiled", value.asInstanceOf[js.Any])
    ...
    inline def setKeywords(value: (js.UndefOr[(Record[String, js.Any]) | String]) & KeywordDict): Self = StObject.set(x, "keywords", value.asInstanceOf[js.Any])
