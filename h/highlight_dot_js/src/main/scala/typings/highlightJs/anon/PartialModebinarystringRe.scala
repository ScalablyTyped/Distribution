...
import typings.highlightJs.CallbackResponse
import typings.highlightJs.Mode
import typings.highlightJs.ModeCallback
...
@js.native
trait PartialModebinarystringRe extends js.Object {
...
object PartialModebinarystringRe {
  ...
  @scala.inline
  implicit class PartialModebinarystringReOps[Self <: PartialModebinarystringRe] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBinary(value: String | RegExp): Self = this.set("binary", value.asInstanceOf[js.Any])
