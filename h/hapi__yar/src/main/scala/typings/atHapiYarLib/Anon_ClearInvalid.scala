...
trait Anon_ClearInvalid extends js.Object {
  ...
  /**
    ...
    * Defaults to uuidv4
    */
  var customSessionIDGenerator: js.UndefOr[js.Function1[/* req */ atHapiHapiLib.atHapiHapiMod.Request, java.lang.String]] = js.undefined
  /**
  ...
  var isSameSite: js.UndefOr[
    atHapiYarLib.atHapiYarLibStrings.Lax | atHapiYarLib.atHapiYarLibStrings.Strict | atHapiYarLib.atHapiYarLibNumbers.`false`
  ] = js.undefined
  /**
...
object Anon_ClearInvalid {
  ...
  def apply(
    ...
    customSessionIDGenerator: /* req */ atHapiHapiLib.atHapiHapiMod.Request => java.lang.String = null,
    ignoreErrors: js.UndefOr[scala.Boolean] = js.undefined,
    isHttpOnly: js.UndefOr[scala.Boolean] = js.undefined,
    isSameSite: atHapiYarLib.atHapiYarLibStrings.Lax | atHapiYarLib.atHapiYarLibStrings.Strict | atHapiYarLib.atHapiYarLibNumbers.`false` = null,
