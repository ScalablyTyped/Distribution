...
object svSEMod extends Shortcut {
  
  @JSImport("hyperformula/typings/i18n/languages/svSE", JSImport.Default)
  @js.native
  val default: RawTranslationPackage = js.native
  
  type _To = RawTranslationPackage
  
  /* This means you don't have to write `default`, but can instead just say `svSEMod.foo` */
