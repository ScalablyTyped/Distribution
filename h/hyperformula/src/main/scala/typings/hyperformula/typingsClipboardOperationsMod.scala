...
import typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellType.EMPTY
import typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellType.FORMULA
import typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellType.PARSING_ERROR
import typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellType.VALUE
...
object typingsClipboardOperationsMod {
  ...
  object ClipboardCellType extends StObject {
    ...
    /* 1 */ val EMPTY: typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellType.EMPTY & Double = js.native
    
    @js.native
    sealed trait FORMULA
      extends StObject
         with ClipboardCellType
    /* 2 */ val FORMULA: typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellType.FORMULA & Double = js.native
    
    @js.native
    sealed trait PARSING_ERROR
      extends StObject
         with ClipboardCellType
    /* 3 */ val PARSING_ERROR: typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellType.PARSING_ERROR & Double = js.native
    
    @js.native
    sealed trait VALUE
      extends StObject
         with ClipboardCellType
    /* 0 */ val VALUE: typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellType.VALUE & Double = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellValue
    - typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellFormula
    - typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellEmpty
    - typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellParsingError
  */
  trait ClipboardCell extends StObject
  object ClipboardCell {
    
    inline def ClipboardCellEmpty(`type`: EMPTY): typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellEmpty = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellEmpty]
    }
    
    inline def ClipboardCellFormula(hash: String, `type`: FORMULA): typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellFormula = {
      val __obj = js.Dynamic.literal(hash = hash.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellFormula]
    }
    
    inline def ClipboardCellParsingError(errors: js.Array[ParsingError_], rawInput: String, `type`: PARSING_ERROR): typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellParsingError = {
      val __obj = js.Dynamic.literal(errors = errors.asInstanceOf[js.Any], rawInput = rawInput.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellParsingError]
    }
    
    inline def ClipboardCellValue(parsedValue: ValueCellVertexValue, `type`: VALUE): typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellValue = {
      val __obj = js.Dynamic.literal(parsedValue = parsedValue.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.hyperformula.typingsClipboardOperationsMod.ClipboardCellValue]
    }
  }
