...
object plPLMod extends Shortcut {
  
  @JSImport("hyperformula/typings/i18n/languages/plPL", JSImport.Default)
  @js.native
  val default: RawTranslationPackage = js.native
  
  type _To = RawTranslationPackage
  
  /* This means you don't have to write `default`, but can instead just say `plPLMod.foo` */
