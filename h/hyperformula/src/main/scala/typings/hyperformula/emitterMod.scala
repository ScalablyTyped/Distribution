...
object emitterMod {
  ...
  object Events extends StObject {
    ...
    sealed trait EvaluationResumed
      extends StObject
         with Events
    /* "evaluationResumed" */ val EvaluationResumed: typings.hyperformula.emitterMod.Events.EvaluationResumed & String = js.native
    
    @js.native
    sealed trait EvaluationSuspended
      extends StObject
         with Events
    /* "evaluationSuspended" */ val EvaluationSuspended: typings.hyperformula.emitterMod.Events.EvaluationSuspended & String = js.native
    
    @js.native
    sealed trait NamedExpressionAdded
      extends StObject
         with Events
    /* "namedExpressionAdded" */ val NamedExpressionAdded: typings.hyperformula.emitterMod.Events.NamedExpressionAdded & String = js.native
    
    @js.native
    sealed trait NamedExpressionRemoved
      extends StObject
         with Events
    /* "namedExpressionRemoved" */ val NamedExpressionRemoved: typings.hyperformula.emitterMod.Events.NamedExpressionRemoved & String = js.native
    
    @js.native
    sealed trait SheetAdded
      extends StObject
         with Events
    /* "sheetAdded" */ val SheetAdded: typings.hyperformula.emitterMod.Events.SheetAdded & String = js.native
    
    @js.native
    sealed trait SheetRemoved
      extends StObject
         with Events
    /* "sheetRemoved" */ val SheetRemoved: typings.hyperformula.emitterMod.Events.SheetRemoved & String = js.native
    
    @js.native
    sealed trait SheetRenamed
      extends StObject
         with Events
    /* "sheetRenamed" */ val SheetRenamed: typings.hyperformula.emitterMod.Events.SheetRenamed & String = js.native
    
    @js.native
    sealed trait ValuesUpdated
      extends StObject
         with Events
    /* "valuesUpdated" */ val ValuesUpdated: typings.hyperformula.emitterMod.Events.ValuesUpdated & String = js.native
  }
