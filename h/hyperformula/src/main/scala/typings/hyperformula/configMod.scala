...
object configMod {
  ...
  - typings.hyperformula.parserConfigMod.ParserConfig because var conflicts: arrayColumnSeparator, arrayRowSeparator, decimalSeparator, functionArgSeparator, ignoreWhiteSpace, maxColumns, maxRows. Inlined translationPackage, errorMapping */ @JSImport("hyperformula/typings/Config", "Config")
  @js.native
  open class Config ()
    extends StObject
       with ConfigParams {
