...
object ptPTMod extends Shortcut {
  
  @JSImport("hyperformula/typings/i18n/languages/ptPT", JSImport.Default)
  @js.native
  val default: RawTranslationPackage = js.native
  
  type _To = RawTranslationPackage
  
  /* This means you don't have to write `default`, but can instead just say `ptPTMod.foo` */
