...
object interpreterValueMod {
  ...
  object NumberType extends StObject {
    ...
    sealed trait NUMBER_CURRENCY
      extends StObject
         with NumberType
    /* "NUMBER_CURRENCY" */ val NUMBER_CURRENCY: typings.hyperformula.interpreterValueMod.NumberType.NUMBER_CURRENCY & String = js.native
    
    @js.native
    sealed trait NUMBER_DATE
      extends StObject
         with NumberType
    /* "NUMBER_DATE" */ val NUMBER_DATE: typings.hyperformula.interpreterValueMod.NumberType.NUMBER_DATE & String = js.native
    
    @js.native
    sealed trait NUMBER_DATETIME
      extends StObject
         with NumberType
    /* "NUMBER_DATETIME" */ val NUMBER_DATETIME: typings.hyperformula.interpreterValueMod.NumberType.NUMBER_DATETIME & String = js.native
    
    @js.native
    sealed trait NUMBER_PERCENT
      extends StObject
         with NumberType
    /* "NUMBER_PERCENT" */ val NUMBER_PERCENT: typings.hyperformula.interpreterValueMod.NumberType.NUMBER_PERCENT & String = js.native
    
    @js.native
    sealed trait NUMBER_RAW
      extends StObject
         with NumberType
    /* "NUMBER_RAW" */ val NUMBER_RAW: typings.hyperformula.interpreterValueMod.NumberType.NUMBER_RAW & String = js.native
    
    @js.native
    sealed trait NUMBER_TIME
      extends StObject
         with NumberType
    /* "NUMBER_TIME" */ val NUMBER_TIME: typings.hyperformula.interpreterValueMod.NumberType.NUMBER_TIME & String = js.native
  }
  ...
  @JSImport("hyperformula/typings/interpreter/InterpreterValue", "RichNumber")
  @js.native
  abstract class RichNumber protected () extends StObject {
    def this(`val`: Double) = this()
    def this(`val`: Double, format: String) = this()
