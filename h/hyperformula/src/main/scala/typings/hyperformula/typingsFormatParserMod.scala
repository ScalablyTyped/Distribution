...
object typingsFormatParserMod {
  ...
  object FormatExpressionType extends StObject {
    ...
    /* "DATE" */ val DATE: typings.hyperformula.typingsFormatParserMod.FormatExpressionType.DATE & String = js.native
    
    @js.native
    sealed trait NUMBER
      extends StObject
         with FormatExpressionType
    /* "NUMBER" */ val NUMBER: typings.hyperformula.typingsFormatParserMod.FormatExpressionType.NUMBER & String = js.native
    
    @js.native
    sealed trait STRING
      extends StObject
         with FormatExpressionType
    /* "STRING" */ val STRING: typings.hyperformula.typingsFormatParserMod.FormatExpressionType.STRING & String = js.native
  }
  ...
  object TokenType extends StObject {
    ...
    sealed trait FORMAT
      extends StObject
         with TokenType
    /* "FORMAT" */ val FORMAT: typings.hyperformula.typingsFormatParserMod.TokenType.FORMAT & String = js.native
    
    @js.native
    sealed trait FREE_TEXT
      extends StObject
         with TokenType
    /* "FREE_TEXT" */ val FREE_TEXT: typings.hyperformula.typingsFormatParserMod.TokenType.FREE_TEXT & String = js.native
  }
