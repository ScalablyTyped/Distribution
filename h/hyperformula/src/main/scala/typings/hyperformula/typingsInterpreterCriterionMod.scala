...
object typingsInterpreterCriterionMod {
  ...
  object CriterionType extends StObject {
    ...
    sealed trait EQUAL
      extends StObject
         with CriterionType
    /* "EQUAL" */ val EQUAL: typings.hyperformula.typingsInterpreterCriterionMod.CriterionType.EQUAL & String = js.native
    
    @js.native
    sealed trait GREATER_THAN
      extends StObject
         with CriterionType
    /* "GREATER_THAN" */ val GREATER_THAN: typings.hyperformula.typingsInterpreterCriterionMod.CriterionType.GREATER_THAN & String = js.native
    
    @js.native
    sealed trait GREATER_THAN_OR_EQUAL
      extends StObject
         with CriterionType
    /* "GREATER_THAN_OR_EQUAL" */ val GREATER_THAN_OR_EQUAL: typings.hyperformula.typingsInterpreterCriterionMod.CriterionType.GREATER_THAN_OR_EQUAL & String = js.native
    
    @js.native
    sealed trait LESS_THAN
      extends StObject
         with CriterionType
    /* "LESS_THAN" */ val LESS_THAN: typings.hyperformula.typingsInterpreterCriterionMod.CriterionType.LESS_THAN & String = js.native
    
    @js.native
    sealed trait LESS_THAN_OR_EQUAL
      extends StObject
         with CriterionType
    /* "LESS_THAN_OR_EQUAL" */ val LESS_THAN_OR_EQUAL: typings.hyperformula.typingsInterpreterCriterionMod.CriterionType.LESS_THAN_OR_EQUAL & String = js.native
    
    @js.native
    sealed trait NOT_EQUAL
      extends StObject
         with CriterionType
    /* "NOT_EQUAL" */ val NOT_EQUAL: typings.hyperformula.typingsInterpreterCriterionMod.CriterionType.NOT_EQUAL & String = js.native
  }
