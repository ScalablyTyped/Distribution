...
import typings.hyperformula.operationsMod.AddColumnsCommand
import typings.hyperformula.operationsMod.AddRowsCommand
import typings.hyperformula.operationsMod.ColumnsRemoval
import typings.hyperformula.operationsMod.Operations
import typings.hyperformula.operationsMod.RemoveColumnsCommand
import typings.hyperformula.operationsMod.RemoveRowsCommand
import typings.hyperformula.operationsMod.RowsRemoval
...
object undoRedoMod {
  ...
  @JSImport("hyperformula/typings/UndoRedo", "BaseUndoEntry")
  @js.native
  abstract class BaseUndoEntry ()
    extends StObject
       with UndoEntry {
