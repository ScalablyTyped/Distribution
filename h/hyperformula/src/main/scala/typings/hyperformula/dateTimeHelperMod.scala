...
object dateTimeHelperMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.hyperformula.dateTimeHelperMod.SimpleTime
    - typings.hyperformula.dateTimeHelperMod.SimpleDate
    - typings.hyperformula.dateTimeHelperMod.SimpleDateTime
  */
  trait DateTime extends StObject
  object DateTime {
    
    inline def SimpleDate(day: Double, month: Double, year: Double): typings.hyperformula.dateTimeHelperMod.SimpleDate = {
      val __obj = js.Dynamic.literal(day = day.asInstanceOf[js.Any], month = month.asInstanceOf[js.Any], year = year.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.hyperformula.dateTimeHelperMod.SimpleDate]
    }
    
    inline def SimpleDateTime(day: Double, hours: Double, minutes: Double, month: Double, seconds: Double, year: Double): typings.hyperformula.dateTimeHelperMod.SimpleDateTime = {
      ...
      __obj.asInstanceOf[typings.hyperformula.dateTimeHelperMod.SimpleDateTime]
    }
    
    inline def SimpleTime(hours: Double, minutes: Double, seconds: Double): typings.hyperformula.dateTimeHelperMod.SimpleTime = {
      ...
      __obj.asInstanceOf[typings.hyperformula.dateTimeHelperMod.SimpleTime]
    }
  }
  ...
  - typings.hyperformula.dateTimeHelperMod.DateTime because Already inherited */ trait SimpleDateTime
    extends StObject
       with SimpleDate
       with SimpleTime
