...
object cellAddressMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.hyperformula.addressMod.AddressWithSheet because Already inherited
  - typings.hyperformula.addressMod.AddressWithRow because var conflicts: sheet. Inlined row, isRowAbsolute, isRowRelative, shiftedByRows, toSimpleRowAddress */ @JSImport("hyperformula/typings/parser/CellAddress", "CellAddress")
  @js.native
  ...
  object CellReferenceType extends StObject {
    ...
    /* "CELL_REFERENCE_ABSOLUTE" */ val CELL_REFERENCE_ABSOLUTE: typings.hyperformula.cellAddressMod.CellReferenceType.CELL_REFERENCE_ABSOLUTE & String = js.native
    ...
    sealed trait CELL_REFERENCE_ABSOLUTE_COL
      extends StObject
         with CellReferenceType
    /* "CELL_REFERENCE_ABSOLUTE_COL" */ val CELL_REFERENCE_ABSOLUTE_COL: typings.hyperformula.cellAddressMod.CellReferenceType.CELL_REFERENCE_ABSOLUTE_COL & String = js.native
    ...
    sealed trait CELL_REFERENCE_ABSOLUTE_ROW
      extends StObject
         with CellReferenceType
    /* "CELL_REFERENCE_ABSOLUTE_ROW" */ val CELL_REFERENCE_ABSOLUTE_ROW: typings.hyperformula.cellAddressMod.CellReferenceType.CELL_REFERENCE_ABSOLUTE_ROW & String = js.native
    ...
    sealed trait CELL_REFERENCE_RELATIVE
      extends StObject
         with CellReferenceType
    /* "CELL_REFERENCE" */ val CELL_REFERENCE_RELATIVE: typings.hyperformula.cellAddressMod.CellReferenceType.CELL_REFERENCE_RELATIVE & String = js.native
  }
}
