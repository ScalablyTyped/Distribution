...
object RangeSheetReferenceType extends StObject {
  ...
  /* 2 */ val BOTH_ABSOLUTE: typings.hyperformula.astMod.RangeSheetReferenceType.BOTH_ABSOLUTE & Double = js.native
  
  @js.native
  sealed trait RELATIVE
    extends StObject
       with RangeSheetReferenceType
  /* 0 */ val RELATIVE: typings.hyperformula.astMod.RangeSheetReferenceType.RELATIVE & Double = js.native
  
  @js.native
  sealed trait START_ABSOLUTE
    extends StObject
       with RangeSheetReferenceType
  /* 1 */ val START_ABSOLUTE: typings.hyperformula.astMod.RangeSheetReferenceType.START_ABSOLUTE & Double = js.native
}
