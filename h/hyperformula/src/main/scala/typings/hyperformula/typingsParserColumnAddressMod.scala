...
object typingsParserColumnAddressMod {
  ...
  object ReferenceType extends StObject {
    ...
    sealed trait ABSOLUTE
      extends StObject
         with ReferenceType
    /* "ABSOLUTE" */ val ABSOLUTE: typings.hyperformula.typingsParserColumnAddressMod.ReferenceType.ABSOLUTE & String = js.native
    
    @js.native
    sealed trait RELATIVE
      extends StObject
         with ReferenceType
    /* "RELATIVE" */ val RELATIVE: typings.hyperformula.typingsParserColumnAddressMod.ReferenceType.RELATIVE & String = js.native
  }
}
