...
trait WreckObject extends js.Object {
  var agents: atHapiWreckLib.Anon_Http = js.native
  ...
  def request(method: java.lang.String, uri: java.lang.String, options: RequestOptions): js.Promise[nodeLib.httpMod.IncomingMessage] with atHapiWreckLib.Anon_ReqClientRequest = js.native
