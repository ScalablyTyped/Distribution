...
trait Render extends js.Object {
  ...
  def render(data: hexoLib.hexoMod.RenderNs.Data): js.Promise[java.lang.String] = js.native
  def render(
    data: hexoLib.hexoMod.RenderNs.Data,
    fn: js.Function2[/* err */ js.Any, /* result */ java.lang.String, scala.Unit]
  ): js.Promise[java.lang.String] = js.native
  def render(data: hexoLib.hexoMod.RenderNs.Data, option: js.Any): js.Promise[java.lang.String] = js.native
  def render(
    data: hexoLib.hexoMod.RenderNs.Data,
    option: js.Any,
    fn: js.Function2[/* err */ js.Any, /* result */ java.lang.String, scala.Unit]
  ): js.Promise[java.lang.String] = js.native
  def renderSync(data: hexoLib.hexoMod.RenderNs.Data): java.lang.String = js.native
  def renderSync(data: hexoLib.hexoMod.RenderNs.Data, option: js.Any): java.lang.String = js.native
}
