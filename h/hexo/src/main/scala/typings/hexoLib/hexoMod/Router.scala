...
trait Router extends js.Object {
  ...
  /**
    ...
    */
  def get(path: java.lang.String): js.UndefOr[hexoLib.hexoMod.RouterNs.RouteStream] = js.native
  /**
  ...
  def set(path: java.lang.String, data: hexoLib.hexoMod.RouterNs.Data): this.type = js.native
  /**
