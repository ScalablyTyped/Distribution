package typings.highchartsNg.mod._Global_

import typings.highcharts.mod.Options
import typings.highchartsNg.AnonCurrentMax
import typings.highchartsNg.AnonHeight
import typings.highchartsNg.AnonText
