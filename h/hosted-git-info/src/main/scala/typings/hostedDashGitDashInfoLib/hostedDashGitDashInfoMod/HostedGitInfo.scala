...
trait HostedGitInfo extends js.Object {
  ...
  def browse(opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  ...
  def browse(path: java.lang.String, fragment: java.lang.String, opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  def browse(path: java.lang.String, opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  def bugs(): js.UndefOr[java.lang.String] = js.native
  def bugs(opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  def docs(): js.UndefOr[java.lang.String] = js.native
  def docs(opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  def file(path: java.lang.String): js.UndefOr[java.lang.String] = js.native
  def file(path: java.lang.String, opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  def getDefaultRepresentation(): java.lang.String = js.native
  def git(): js.UndefOr[java.lang.String] = js.native
  def git(opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  // /From git-host-info
  ...
  def https(opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  def path(): js.UndefOr[java.lang.String] = js.native
  def path(opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  def shortcut(): js.UndefOr[java.lang.String] = js.native
  def shortcut(opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  def ssh(): js.UndefOr[java.lang.String] = js.native
  def ssh(opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  def sshurl(): js.UndefOr[java.lang.String] = js.native
  def sshurl(opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  def tarball(): js.UndefOr[java.lang.String] = js.native
  def tarball(opts: FillOptions): js.UndefOr[java.lang.String] = js.native
  def toString(opts: FillOptions): js.UndefOr[java.lang.String] = js.native
}
