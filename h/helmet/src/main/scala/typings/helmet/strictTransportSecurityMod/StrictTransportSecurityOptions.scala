...
@js.native
trait StrictTransportSecurityOptions extends js.Object {
...
object StrictTransportSecurityOptions {
  ...
  @scala.inline
  implicit class StrictTransportSecurityOptionsOps[Self <: StrictTransportSecurityOptions] (val x: Self) extends AnyVal {
