...
object IHelmetContentSecurityPolicyDirectives {
  ...
  def apply(
    ...
    if (!js.isUndefined(`block-all-mixed-content`)) __obj.updateDynamic("block-all-mixed-content")(`block-all-mixed-content`.get.asInstanceOf[js.Any])
    if (!js.isUndefined(blockAllMixedContent)) __obj.updateDynamic("blockAllMixedContent")(blockAllMixedContent.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(`upgrade-insecure-requests`)) __obj.updateDynamic("upgrade-insecure-requests")(`upgrade-insecure-requests`.get.asInstanceOf[js.Any])
    if (!js.isUndefined(upgradeInsecureRequests)) __obj.updateDynamic("upgradeInsecureRequests")(upgradeInsecureRequests.get.asInstanceOf[js.Any])
