...
object mod {
  ...
  inline def hide(
    path: String,
    callback: js.Function2[/* error */ js.Error | Null, /* newpath */ js.UndefOr[String | Buffer | URL_], Any]
  ...
  inline def isHidden(path: String, callback: js.Function2[/* error */ js.Error | Null, /* result */ Boolean, Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("isHidden")(path.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def isHidden(path: Buffer, callback: js.Function2[/* error */ js.Error | Null, /* result */ Boolean, Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("isHidden")(path.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def isHidden(path: URL_, callback: js.Function2[/* error */ js.Error | Null, /* result */ Boolean, Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("isHidden")(path.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def shouldBeHidden(path: String, callback: js.Function2[/* error */ js.Error | Null, /* result */ Boolean, Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("shouldBeHidden")(path.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def shouldBeHidden(path: Buffer, callback: js.Function2[/* error */ js.Error | Null, /* result */ Boolean, Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("shouldBeHidden")(path.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def shouldBeHidden(path: URL_, callback: js.Function2[/* error */ js.Error | Null, /* result */ Boolean, Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("shouldBeHidden")(path.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
