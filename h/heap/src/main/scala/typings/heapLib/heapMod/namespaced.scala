...
@js.native
// Constructor
class namespaced[T] () extends Heap[T] {
...
object namespaced extends js.Object {
  // Build the heap.
  def heapify[T](array: js.Array[T]): heapLib.heapMod.Heap[T] = js.native
  def heapify[T](array: js.Array[T], cmp: js.Function2[/* a */ T, /* b */ T, scala.Double]): heapLib.heapMod.Heap[T] = js.native
