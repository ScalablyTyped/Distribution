...
class Response[R] protected () extends js.Object {
  ...
  def emote(strings: java.lang.String*): scala.Unit = js.native
  def locked(strings: java.lang.String*): scala.Unit = js.native
  def play(strings: java.lang.String*): scala.Unit = js.native
  ...
  def topic(strings: java.lang.String*): scala.Unit = js.native
}
