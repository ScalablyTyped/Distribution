...
import typings.hmscoreReactNativeHmsPush.srcHmsPushProfileTypesMod.ProfileTypeEnum
import typings.hmscoreReactNativeHmsPush.srcHmsPushResultCodeMod.HmsPushResultCodeInterface
import typings.hmscoreReactNativeHmsPush.srcLocalNotificationLocalNotificationAttributesMod.LocalNotificationAttributes
import typings.hmscoreReactNativeHmsPush.srcRemoteDataMessageMod.BackgroundRemoteMessage
...
object mod {
  ...
  object HmsLocalNotification {
    ...
    @js.native
    val Importance: typings.hmscoreReactNativeHmsPush.srcLocalNotificationImportanceMod.Importance = js.native
    
    @JSImport("@hmscore/react-native-hms-push", "HmsLocalNotification.Priority")
    @js.native
    val Priority: typings.hmscoreReactNativeHmsPush.srcLocalNotificationPriorityMod.Priority = js.native
    
    @JSImport("@hmscore/react-native-hms-push", "HmsLocalNotification.RepeatType")
    @js.native
    val RepeatType: typings.hmscoreReactNativeHmsPush.srcLocalNotificationRepeatTypeMod.RepeatType = js.native
    
    @JSImport("@hmscore/react-native-hms-push", "HmsLocalNotification.Visibility")
    @js.native
    val Visibility: typings.hmscoreReactNativeHmsPush.srcLocalNotificationVisibilityMod.Visibility = js.native
