...
trait Options extends js.Object {
  ...
  var cookie: js.UndefOr[
    hapiLib.hapiMod.ServerStateCookieOptions with hapiDashAuthDashCookieLib.Anon_Name
  ] = js.undefined
  /**
...
object Options {
  ...
  def apply(
    ...
    cookie: hapiLib.hapiMod.ServerStateCookieOptions with hapiDashAuthDashCookieLib.Anon_Name = null,
