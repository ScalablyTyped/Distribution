...
import typings.hapiAuthCookie.hapiAuthCookieBooleans.`false`
import typings.hapiAuthCookie.hapiAuthCookieStrings.Lax
import typings.hapiAuthCookie.hapiAuthCookieStrings.Strict
import typings.hapiAuthCookie.hapiAuthCookieStrings.base64
import typings.hapiAuthCookie.hapiAuthCookieStrings.base64json
import typings.hapiAuthCookie.hapiAuthCookieStrings.form
import typings.hapiAuthCookie.hapiAuthCookieStrings.iron
import typings.hapiAuthCookie.hapiAuthCookieStrings.none
...
object anon {
  ...
  object RedirectTo {
    ...
    @scala.inline
    implicit class RedirectToMutableBuilder[Self <: RedirectTo] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setRedirectTo(value: Boolean): Self = StObject.set(x, "redirectTo", value.asInstanceOf[js.Any])
  ...
  object ServerStateCookieOptionsn {
    ...
    @scala.inline
    implicit class ServerStateCookieOptionsnMutableBuilder[Self <: ServerStateCookieOptionsn] (val x: Self) extends AnyVal {
