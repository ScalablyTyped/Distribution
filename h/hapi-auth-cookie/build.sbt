...
version := "10.0-dt-20190318Z-08a70a"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "hapi" % "18.0-dt-20191014Z-97681f",
  "org.scalablytyped" %%% "iron" % "5.0-dt-20180214Z-eee525",
  ...
  "org.scalablytyped" %%% "shot" % "4.0-dt-20181002Z-2d8697",
