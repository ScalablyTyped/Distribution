...
@js.native
trait MessageEventPayload extends js.Object {
...
object MessageEventPayload {
  ...
  @scala.inline
  implicit class MessageEventPayloadOps[Self <: MessageEventPayload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: Messages): Self = this.set("type", value.asInstanceOf[js.Any])
