...
trait Options
  extends htmlDashWebpackDashPluginLib.htmlDashWebpackDashPluginMod.Options {
...
object Options {
  ...
  def apply(
    ...
    minify: htmlDashWebpackDashPluginLib.htmlDashWebpackDashPluginLibNumbers.`false` | htmlDashWebpackDashPluginLib.htmlDashWebpackDashPluginMod.MinifyOptions = null,
    ...
    templateParameters: htmlDashWebpackDashPluginLib.htmlDashWebpackDashPluginLibNumbers.`false` | (js.Function3[
      ...
      /* assets */ htmlDashWebpackDashPluginLib.htmlDashWebpackDashPluginMod.TemplateParametersAssets, 
      Options, 
      _
