package typings.harmonyDashProxy.harmonyDashProxyMod.harmonyProxy
...
object ProxyHandler {
  ...
  def apply[T](
    ...
    construct: (/* target */ T, /* thisArg */ js.Any, /* argArray */ js.UndefOr[js.Any]) => _ = null,
    defineProperty: (/* target */ T, /* p */ PropertyKey, /* attributes */ PropertyDescriptor) => Boolean = null,
    deleteProperty: (/* target */ T, /* p */ PropertyKey) => Boolean = null,
    enumerate: /* target */ T => js.Array[PropertyKey] = null,
    get: (/* target */ T, /* p */ PropertyKey, /* receiver */ js.Any) => _ = null,
    getOwnPropertyDescriptor: (/* target */ T, /* p */ PropertyKey) => PropertyDescriptor = null,
    getPrototypeOf: /* target */ T => _ = null,
    has: (/* target */ T, /* p */ PropertyKey) => Boolean = null,
    isExtensible: /* target */ T => Boolean = null,
    ownKeys: /* target */ T => js.Array[PropertyKey] = null,
    preventExtensions: /* target */ T => Boolean = null,
    set: (/* target */ T, /* p */ PropertyKey, /* value */ js.Any, /* receiver */ js.Any) => Boolean = null,
    setPrototypeOf: (/* target */ T, /* v */ js.Any) => Boolean = null
  ): ProxyHandler[T] = {
