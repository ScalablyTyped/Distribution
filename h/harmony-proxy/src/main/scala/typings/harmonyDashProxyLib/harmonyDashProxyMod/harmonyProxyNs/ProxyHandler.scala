...
object ProxyHandler {
  ...
  def apply[T](
    ...
    defineProperty: (/* target */ T, /* p */ PropertyKey, /* attributes */ stdLib.PropertyDescriptor) => scala.Boolean = null,
    ...
    getOwnPropertyDescriptor: (/* target */ T, /* p */ PropertyKey) => stdLib.PropertyDescriptor = null,
