...
object BaseHeatmapConfiguration {
  @scala.inline
  def apply[/* <: java.lang.String */ V](): BaseHeatmapConfiguration[V] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BaseHeatmapConfiguration[V]]
  }
  @scala.inline
  implicit class BaseHeatmapConfigurationOps[Self <: BaseHeatmapConfiguration[_], /* <: java.lang.String */ V] (val x: Self with BaseHeatmapConfiguration[V]) extends AnyVal {
    @scala.inline
