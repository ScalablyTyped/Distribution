...
object HeatmapConfiguration {
  ...
  @scala.inline
  implicit class HeatmapConfigurationOps[Self <: HeatmapConfiguration[_, _, _], V /* <: String */, X /* <: String */, Y /* <: String */] (val x: Self with (HeatmapConfiguration[V, X, Y])) extends AnyVal {
