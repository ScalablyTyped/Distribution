...
object windbarbMod {
  ...
  @JSImport("highcharts/modules/windbarb", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/windbarb", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/windbarb", "Highcharts.SeriesPalettes")
    @js.native
