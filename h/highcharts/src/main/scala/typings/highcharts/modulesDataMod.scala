...
object modulesDataMod {
  
  @JSImport("highcharts/modules/data", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/data", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/data", "Highcharts.SeriesPalettes")
    @js.native
  ...
  object highchartsAugmentingMod {
    ...
    trait DataDateFormatObject extends StObject {
      ...
      @JSName("parser")
      var parser_Original: DataDateFormatCallbackFunction
