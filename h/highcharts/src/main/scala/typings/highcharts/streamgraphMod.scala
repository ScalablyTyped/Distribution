...
object streamgraphMod {
  ...
  @JSImport("highcharts/modules/streamgraph", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/streamgraph", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/streamgraph", "Highcharts.SeriesPalettes")
    @js.native
