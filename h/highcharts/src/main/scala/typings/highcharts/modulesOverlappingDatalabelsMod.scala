...
object modulesOverlappingDatalabelsMod {
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/overlapping-datalabels", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/overlapping-datalabels", "Highcharts.SeriesPalettes")
    @js.native
