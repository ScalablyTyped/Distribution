...
object PointInstrumentObject {
  ...
  implicit class PointInstrumentObjectOps[Self <: PointInstrumentObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInstrumentMapping(value: PointInstrumentMappingObject): Self = this.set("instrumentMapping", value.asInstanceOf[js.Any])
    @scala.inline
    def setInstrumentOptions(value: PointInstrumentOptionsObject): Self = this.set("instrumentOptions", value.asInstanceOf[js.Any])
    @scala.inline
