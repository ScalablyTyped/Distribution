...
object highcharts3dMod {
  ...
  @JSImport("highcharts/highcharts-3d", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @scala.inline
  def default(highcharts: TypeofHighcharts): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(highcharts.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  @scala.inline
  def factory(highcharts: TypeofHighcharts): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("factory")(highcharts.asInstanceOf[js.Any]).asInstanceOf[Unit]
