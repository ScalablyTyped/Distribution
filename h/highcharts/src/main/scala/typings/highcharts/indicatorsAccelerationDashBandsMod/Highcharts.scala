package typings.highcharts.indicatorsAccelerationDashBandsMod
...
import typings.highcharts.highchartsMod.AxisPlotBandsOptions
import typings.highcharts.highchartsMod.AxisPlotLinesOptions
...
@JSImport("highcharts/indicators/acceleration-bands", "Highcharts")
@js.native
object Highcharts extends js.Object {
  @js.native
  class Annotation protected ()
    extends typings.highcharts.highchartsMod.Annotation {
    /**
      ...
      *        the options object
      */
    def this(chart: typings.highcharts.highchartsMod.Chart, userOptions: AnnotationsOptions) = this()
  }
  
  @js.native
  class Axis protected ()
    extends typings.highcharts.highchartsMod.Axis {
    /**
      ...
      *        Axis options.
      */
    def this(chart: typings.highcharts.highchartsMod.Chart, options: AxisOptions) = this()
  }
  
  @js.native
  class Chart protected ()
    extends typings.highcharts.highchartsMod.Chart {
    /**
  ...
  class Color protected ()
    extends typings.highcharts.highchartsMod.Color {
    /**
  ...
  class ColorAxis protected ()
    extends typings.highcharts.highchartsMod.ColorAxis {
    /**
      ...
      */
    def this(chart: typings.highcharts.highchartsMod.Chart, userOptions: ColorAxisOptions) = this()
  }
  
  @js.native
  class Legend protected ()
    extends typings.highcharts.highchartsMod.Legend {
    /**
      ...
      *        Legend options.
      */
    def this(chart: typings.highcharts.highchartsMod.Chart, options: LegendOptions) = this()
  }
  
  @js.native
  class PlotLineOrBand protected ()
    extends typings.highcharts.highchartsMod.PlotLineOrBand {
    /**
      * The object wrapper for plot lines and plot bands
      */
    def this(axis: typings.highcharts.highchartsMod.Axis) = this()
    def this(axis: typings.highcharts.highchartsMod.Axis, options: AxisPlotBandsOptions) = this()
    def this(axis: typings.highcharts.highchartsMod.Axis, options: AxisPlotLinesOptions) = this()
  }
  
  @js.native
  class Point ()
    extends typings.highcharts.highchartsMod.Point
  
  @js.native
  class Pointer protected ()
    extends typings.highcharts.highchartsMod.Pointer {
    /**
      ...
      */
    def this(chart: typings.highcharts.highchartsMod.Chart, options: Options) = this()
  }
  
  @js.native
  class SVGElement ()
    extends typings.highcharts.highchartsMod.SVGElement
  
  @js.native
  class SVGRenderer protected ()
    extends typings.highcharts.highchartsMod.SVGRenderer {
    /**
  ...
  class Series protected ()
    extends typings.highcharts.highchartsMod.Series {
    /**
      ...
      *        The series options.
      */
    def this(chart: typings.highcharts.highchartsMod.Chart, options: js.Object) = this()
    def this(chart: typings.highcharts.highchartsMod.Chart, options: SeriesOptionsType) = this()
  }
  
  @js.native
  class Tick protected ()
    extends typings.highcharts.highchartsMod.Tick {
    /**
      * The Tick class.
      *
      * @param axis
      ...
      */
    def this(axis: typings.highcharts.highchartsMod.Axis, pos: Double) = this()
    def this(axis: typings.highcharts.highchartsMod.Axis, pos: Double, `type`: String) = this()
    def this(axis: typings.highcharts.highchartsMod.Axis, pos: Double, `type`: String, noLabel: Boolean) = this()
    def this(
  ...
  class Time protected ()
    extends typings.highcharts.highchartsMod.Time {
    /**
  ...
  class Tooltip protected ()
    extends typings.highcharts.highchartsMod.Tooltip {
    /**
      * Tooltip of a chart.
      *
      * @param chart
  ...
  var time: typings.highcharts.highchartsMod.Time = js.native
  ...
  def animate(el: typings.highcharts.highchartsMod.SVGElement, params: CSSObject): Unit = js.native
  def animate(el: typings.highcharts.highchartsMod.SVGElement, params: CSSObject, opt: AnimationOptionsObject): Unit = js.native
  def animate(el: typings.highcharts.highchartsMod.SVGElement, params: SVGAttributes): Unit = js.native
  def animate(
    el: typings.highcharts.highchartsMod.SVGElement,
  ...
  def chart(options: Options): typings.highcharts.highchartsMod.Chart = js.native
  def chart(options: Options, callback: ChartCallbackFunction): typings.highcharts.highchartsMod.Chart = js.native
  def chart(renderTo: String, options: Options): typings.highcharts.highchartsMod.Chart = js.native
  def chart(renderTo: String, options: Options, callback: ChartCallbackFunction): typings.highcharts.highchartsMod.Chart = js.native
  def chart(renderTo: HTMLDOMElement, options: Options): typings.highcharts.highchartsMod.Chart = js.native
  def chart(renderTo: HTMLDOMElement, options: Options, callback: ChartCallbackFunction): typings.highcharts.highchartsMod.Chart = js.native
  def clearTimeout(id: Double): Unit = js.native
  def color(input: ColorType): typings.highcharts.highchartsMod.Color = js.native
  ...
  def error(code: String, stop: Boolean, chart: typings.highcharts.highchartsMod.Chart): Unit = js.native
  def error(
    code: String,
    stop: Boolean,
    chart: typings.highcharts.highchartsMod.Chart,
  ...
  def error(code: Double, stop: Boolean, chart: typings.highcharts.highchartsMod.Chart): Unit = js.native
  def error(
    code: Double,
    stop: Boolean,
    chart: typings.highcharts.highchartsMod.Chart,
  ...
  def format(str: String, ctx: js.Any, time: typings.highcharts.highchartsMod.Time): String = js.native
  def formatSingle(format: String, `val`: js.Any): String = js.native
  def formatSingle(format: String, `val`: js.Any, time: typings.highcharts.highchartsMod.Time): String = js.native
  ...
  def seriesType(`type`: String, parent: String, options: Dictionary[_]): typings.highcharts.highchartsMod.Series = js.native
  def seriesType(`type`: String, parent: String, options: Dictionary[_], props: Dictionary[_]): typings.highcharts.highchartsMod.Series = js.native
  def seriesType(
    `type`: String,
    parent: String,
  ...
  ): typings.highcharts.highchartsMod.Series = js.native
  def seriesType(`type`: String, parent: String, options: SeriesOptionsType): typings.highcharts.highchartsMod.Series = js.native
  def seriesType(`type`: String, parent: String, options: SeriesOptionsType, props: Dictionary[_]): typings.highcharts.highchartsMod.Series = js.native
  def seriesType(
    `type`: String,
    parent: String,
  ...
  def setAnimation(animation: js.UndefOr[scala.Nothing], chart: typings.highcharts.highchartsMod.Chart): Unit = js.native
  def setAnimation(animation: Boolean, chart: typings.highcharts.highchartsMod.Chart): Unit = js.native
  def setAnimation(animation: AnimationOptionsObject, chart: typings.highcharts.highchartsMod.Chart): Unit = js.native
  ...
  def stop(el: typings.highcharts.highchartsMod.SVGElement): Unit = js.native
  def stop(el: typings.highcharts.highchartsMod.SVGElement, prop: String): Unit = js.native
