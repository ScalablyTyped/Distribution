...
object pyramid3dMod {
  ...
  @JSImport("highcharts/modules/pyramid3d", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/pyramid3d", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/pyramid3d", "Highcharts.SeriesPalettes")
    @js.native
