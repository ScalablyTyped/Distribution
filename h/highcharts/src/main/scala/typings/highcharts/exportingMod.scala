...
object exportingMod {
  ...
  @JSImport("highcharts/modules/exporting", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/exporting", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/exporting", "Highcharts.SeriesPalettes")
    @js.native
