...
object xrangeMod {
  ...
  @JSImport("highcharts/modules/xrange", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/xrange", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/xrange", "Highcharts.SeriesPalettes")
    @js.native
