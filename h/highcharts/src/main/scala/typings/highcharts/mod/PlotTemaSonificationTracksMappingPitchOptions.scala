...
trait PlotTemaSonificationTracksMappingPitchOptions extends StObject {
...
object PlotTemaSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
