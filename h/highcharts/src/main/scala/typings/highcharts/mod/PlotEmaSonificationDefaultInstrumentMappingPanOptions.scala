...
trait PlotEmaSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotEmaSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotEmaSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
