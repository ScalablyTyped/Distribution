...
trait PlotColumnSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotColumnSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
