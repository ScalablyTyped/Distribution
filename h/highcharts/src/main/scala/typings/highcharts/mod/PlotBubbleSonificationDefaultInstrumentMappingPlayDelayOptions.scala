...
trait PlotBubbleSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotBubbleSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
