...
trait PlotSlowstochasticSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
