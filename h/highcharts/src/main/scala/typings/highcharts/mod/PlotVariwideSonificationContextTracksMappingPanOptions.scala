...
trait PlotVariwideSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotVariwideSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
