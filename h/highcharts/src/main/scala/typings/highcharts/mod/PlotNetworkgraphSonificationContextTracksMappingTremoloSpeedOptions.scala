...
trait PlotNetworkgraphSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
