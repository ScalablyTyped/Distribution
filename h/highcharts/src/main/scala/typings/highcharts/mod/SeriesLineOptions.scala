...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesLineOptions
  extends StObject
     with PlotLineOptions {
...
object SeriesLineOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | line): SeriesLineOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesLineOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | line): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
