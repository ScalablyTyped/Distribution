...
trait PlotNatrSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotNatrSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotNatrSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
