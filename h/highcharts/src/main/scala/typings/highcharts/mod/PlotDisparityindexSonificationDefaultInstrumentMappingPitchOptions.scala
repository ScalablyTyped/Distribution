...
trait PlotDisparityindexSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
