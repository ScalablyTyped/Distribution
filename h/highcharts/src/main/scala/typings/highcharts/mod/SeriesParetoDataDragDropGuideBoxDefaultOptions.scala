...
trait SeriesParetoDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesParetoDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesParetoDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesParetoDataDragDropGuideBoxDefaultOptions]
  }
}
