...
trait PlotLinearregressionangleSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
