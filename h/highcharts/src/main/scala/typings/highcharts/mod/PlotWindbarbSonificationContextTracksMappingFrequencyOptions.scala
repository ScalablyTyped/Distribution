...
trait PlotWindbarbSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotWindbarbSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotWindbarbSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
