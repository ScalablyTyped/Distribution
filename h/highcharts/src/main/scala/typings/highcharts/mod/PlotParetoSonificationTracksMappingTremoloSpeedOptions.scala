...
trait PlotParetoSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotParetoSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
