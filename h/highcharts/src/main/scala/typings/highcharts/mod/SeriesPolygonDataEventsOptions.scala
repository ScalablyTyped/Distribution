...
trait SeriesPolygonDataEventsOptions extends js.Object {
  /**
...
object SeriesPolygonDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesPolygonDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesPolygonDataEventsOptions]
  }
}
