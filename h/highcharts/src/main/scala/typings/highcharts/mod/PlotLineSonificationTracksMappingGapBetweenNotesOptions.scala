...
trait PlotLineSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotLineSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
