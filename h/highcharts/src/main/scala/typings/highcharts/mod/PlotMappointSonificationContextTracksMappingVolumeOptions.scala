...
trait PlotMappointSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotMappointSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
