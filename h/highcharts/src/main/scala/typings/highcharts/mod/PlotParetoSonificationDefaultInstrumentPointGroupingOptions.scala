...
trait PlotParetoSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotParetoSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotParetoSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
