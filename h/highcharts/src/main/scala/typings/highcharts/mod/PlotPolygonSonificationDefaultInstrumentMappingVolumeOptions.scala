...
trait PlotPolygonSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotPolygonSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
