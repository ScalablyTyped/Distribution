...
trait PlotWmaSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotWmaSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotWmaSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
