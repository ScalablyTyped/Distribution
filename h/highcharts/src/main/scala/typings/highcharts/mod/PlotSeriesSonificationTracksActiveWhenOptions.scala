...
trait PlotSeriesSonificationTracksActiveWhenOptions extends StObject {
...
object PlotSeriesSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotSeriesSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
