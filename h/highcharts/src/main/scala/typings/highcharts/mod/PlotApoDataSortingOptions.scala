...
@js.native
trait PlotApoDataSortingOptions extends js.Object {
  /**
...
object PlotApoDataSortingOptions {
  @scala.inline
  def apply(): PlotApoDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoDataSortingOptions]
  }
  @scala.inline
  implicit class PlotApoDataSortingOptionsOps[Self <: PlotApoDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
