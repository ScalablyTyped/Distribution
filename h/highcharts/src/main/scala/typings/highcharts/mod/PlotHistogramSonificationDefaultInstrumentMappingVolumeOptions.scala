...
trait PlotHistogramSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotHistogramSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
