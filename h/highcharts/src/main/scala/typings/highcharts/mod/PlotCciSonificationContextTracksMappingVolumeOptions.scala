...
trait PlotCciSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotCciSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotCciSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
