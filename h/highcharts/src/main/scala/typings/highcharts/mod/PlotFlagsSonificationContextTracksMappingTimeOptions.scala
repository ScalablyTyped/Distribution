...
trait PlotFlagsSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
