...
trait PlotAtrSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
