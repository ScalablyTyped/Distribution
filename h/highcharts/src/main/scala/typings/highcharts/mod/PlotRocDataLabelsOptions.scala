...
@js.native
trait PlotRocDataLabelsOptions extends js.Object {
...
object PlotRocDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotRocDataLabelsOptionsOps[Self <: PlotRocDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotRocDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
