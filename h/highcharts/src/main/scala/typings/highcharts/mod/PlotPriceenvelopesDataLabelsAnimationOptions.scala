...
@js.native
trait PlotPriceenvelopesDataLabelsAnimationOptions extends js.Object {
...
object PlotPriceenvelopesDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): PlotPriceenvelopesDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class PlotPriceenvelopesDataLabelsAnimationOptionsOps[Self <: PlotPriceenvelopesDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
