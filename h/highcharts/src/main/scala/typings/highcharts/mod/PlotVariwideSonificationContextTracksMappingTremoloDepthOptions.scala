...
trait PlotVariwideSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotVariwideSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
