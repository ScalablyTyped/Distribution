...
@js.native
trait PlotPpoDataSortingOptions extends StObject {
...
object PlotPpoDataSortingOptions {
  
  @scala.inline
  def apply(): PlotPpoDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotPpoDataSortingOptionsMutableBuilder[Self <: PlotPpoDataSortingOptions] (val x: Self) extends AnyVal {
