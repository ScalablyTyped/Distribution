...
trait PlotWordcloudOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotWordcloudDataLabelsOptions | js.Array[PlotWordcloudDataLabelsOptions]] = js.undefined
...
object PlotWordcloudOptions {
  ...
  extension [Self <: PlotWordcloudOptions](x: Self) {
    ...
    inline def setDataLabels(value: PlotWordcloudDataLabelsOptions | js.Array[PlotWordcloudDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotWordcloudDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotWordcloudDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
