...
trait PlotOhlcSonificationTracksActiveWhenOptions extends StObject {
...
object PlotOhlcSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotOhlcSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOhlcSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
