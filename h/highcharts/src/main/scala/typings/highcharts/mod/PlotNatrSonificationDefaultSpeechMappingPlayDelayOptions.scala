...
trait PlotNatrSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotNatrSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotNatrSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
