...
trait PlotAtrSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotAtrSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
