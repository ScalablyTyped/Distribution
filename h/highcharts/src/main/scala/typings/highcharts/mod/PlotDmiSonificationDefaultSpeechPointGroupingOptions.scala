...
trait PlotDmiSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotDmiSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotDmiSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
