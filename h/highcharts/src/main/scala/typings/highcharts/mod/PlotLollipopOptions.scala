...
trait PlotLollipopOptions extends StObject {
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotLollipopDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotLollipopOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotLollipopSonificationOptions] = js.undefined
...
object PlotLollipopOptions {
  ...
  inline def apply(): PlotLollipopOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotLollipopDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotLollipopOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setSonification(value: PlotLollipopSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
