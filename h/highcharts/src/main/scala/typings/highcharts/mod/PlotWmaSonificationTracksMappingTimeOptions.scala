...
trait PlotWmaSonificationTracksMappingTimeOptions extends StObject {
...
object PlotWmaSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
