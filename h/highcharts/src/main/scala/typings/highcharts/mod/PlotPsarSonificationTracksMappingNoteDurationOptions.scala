...
trait PlotPsarSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotPsarSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
