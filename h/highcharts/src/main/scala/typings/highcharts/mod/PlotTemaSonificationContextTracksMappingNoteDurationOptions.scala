...
trait PlotTemaSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
