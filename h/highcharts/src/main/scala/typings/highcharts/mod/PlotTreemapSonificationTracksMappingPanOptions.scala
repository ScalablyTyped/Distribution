...
trait PlotTreemapSonificationTracksMappingPanOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
