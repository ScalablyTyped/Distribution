...
trait SonificationGlobalTracksMappingTremoloSpeedOptions extends StObject {
...
object SonificationGlobalTracksMappingTremoloSpeedOptions {
  
  inline def apply(): SonificationGlobalTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
