...
trait PlotAoSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotAoSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
