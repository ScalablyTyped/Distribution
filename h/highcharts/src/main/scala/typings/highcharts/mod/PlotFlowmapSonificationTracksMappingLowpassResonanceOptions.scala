...
trait PlotFlowmapSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
