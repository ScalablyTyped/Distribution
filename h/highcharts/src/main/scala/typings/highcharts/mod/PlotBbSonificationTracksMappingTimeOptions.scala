...
trait PlotBbSonificationTracksMappingTimeOptions extends StObject {
...
object PlotBbSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotBbSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBbSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
