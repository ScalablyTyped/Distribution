...
trait PlotCylinderSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
