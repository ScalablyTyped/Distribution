...
trait PlotSunburstSonificationTracksActiveWhenOptions extends StObject {
...
object PlotSunburstSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotSunburstSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
