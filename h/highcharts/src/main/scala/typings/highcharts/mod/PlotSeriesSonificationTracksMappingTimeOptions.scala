...
trait PlotSeriesSonificationTracksMappingTimeOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
