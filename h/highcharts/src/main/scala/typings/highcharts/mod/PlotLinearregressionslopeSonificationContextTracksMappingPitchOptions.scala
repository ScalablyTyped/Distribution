...
trait PlotLinearregressionslopeSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotLinearregressionslopeSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
