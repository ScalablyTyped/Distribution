...
trait PlotVariwideSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotVariwideSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
