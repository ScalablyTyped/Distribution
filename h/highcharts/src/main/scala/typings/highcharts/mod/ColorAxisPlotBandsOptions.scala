...
trait ColorAxisPlotBandsOptions extends StObject {
  ...
  /**
    ...
    * `mousemove`.
    */
  var events: js.UndefOr[ColorAxisPlotBandsEventsOptions] = js.undefined
  ...
  /**
    ...
    */
  var label: js.UndefOr[ColorAxisPlotBandsLabelOptions] = js.undefined
...
object ColorAxisPlotBandsOptions {
  
  inline def apply(): ColorAxisPlotBandsOptions = {
  ...
  extension [Self <: ColorAxisPlotBandsOptions](x: Self) {
    ...
    inline def setEvents(value: ColorAxisPlotBandsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setLabel(value: ColorAxisPlotBandsLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
