...
trait PlotWordcloudDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotWordcloudDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotWordcloudDataLabelsOptions {
  
  inline def apply(): PlotWordcloudDataLabelsOptions = {
  ...
  extension [Self <: PlotWordcloudDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotWordcloudDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
