...
trait PlotArearangeSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
