...
trait SeriesVectorDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesVectorDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesVectorDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesVectorDataDragDropDragHandleOptions]
  }
}
