...
trait PlotRocSonificationTracksMappingPanOptions extends StObject {
...
object PlotRocSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotRocSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRocSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
