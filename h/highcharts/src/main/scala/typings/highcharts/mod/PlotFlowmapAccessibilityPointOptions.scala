...
trait PlotFlowmapAccessibilityPointOptions extends StObject {
...
object PlotFlowmapAccessibilityPointOptions {
  
  inline def apply(): PlotFlowmapAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapAccessibilityPointOptions] (val x: Self) extends AnyVal {
