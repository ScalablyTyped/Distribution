...
trait PlotFunnelSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotFunnelSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
