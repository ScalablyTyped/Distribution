...
trait PlotAreaSonificationPointGroupingOptions extends StObject {
...
object PlotAreaSonificationPointGroupingOptions {
  
  inline def apply(): PlotAreaSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
