...
trait PlotCmoSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotCmoSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotCmoSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
