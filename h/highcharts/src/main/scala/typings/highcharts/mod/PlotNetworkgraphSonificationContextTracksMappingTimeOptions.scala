...
trait PlotNetworkgraphSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
