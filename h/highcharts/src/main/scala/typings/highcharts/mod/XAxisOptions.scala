...
object XAxisOptions {
  ...
  extension [Self <: XAxisOptions](x: Self) {
    ...
    inline def setBreaksVarargs(value: XAxisBreaksOptions*): Self = StObject.set(x, "breaks", js.Array(value :_*))
    ...
    inline def setPlotBandsVarargs(value: XAxisPlotBandsOptions*): Self = StObject.set(x, "plotBands", js.Array(value :_*))
    ...
    inline def setPlotLinesVarargs(value: XAxisPlotLinesOptions*): Self = StObject.set(x, "plotLines", js.Array(value :_*))
