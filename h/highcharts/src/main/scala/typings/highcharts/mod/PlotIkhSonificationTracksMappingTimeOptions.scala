...
trait PlotIkhSonificationTracksMappingTimeOptions extends StObject {
...
object PlotIkhSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
