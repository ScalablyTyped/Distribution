...
trait PlotApoSonificationTracksMappingPanOptions extends StObject {
...
object PlotApoSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
