...
trait PlotTemaSonificationTracksActiveWhenOptions extends StObject {
...
object PlotTemaSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotTemaSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
