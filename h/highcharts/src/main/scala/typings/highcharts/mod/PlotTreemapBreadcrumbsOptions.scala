...
trait PlotTreemapBreadcrumbsOptions extends StObject {
  ...
  /**
    ...
    */
  var buttonTheme: js.UndefOr[PlotTreemapBreadcrumbsButtonThemeOptions | SVGAttributes] = js.undefined
  
  var events: js.UndefOr[PlotTreemapBreadcrumbsEventsOptions] = js.undefined
  ...
  /**
    ...
    * position properties.
    */
  var position: js.UndefOr[BreadcrumbsAlignOptions | PlotTreemapBreadcrumbsPositionOptions] = js.undefined
  ...
  /**
    ...
    */
  var separator: js.UndefOr[PlotTreemapBreadcrumbsSeparatorOptions] = js.undefined
...
object PlotTreemapBreadcrumbsOptions {
  
  inline def apply(): PlotTreemapBreadcrumbsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapBreadcrumbsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapBreadcrumbsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setButtonTheme(value: PlotTreemapBreadcrumbsButtonThemeOptions | SVGAttributes): Self = StObject.set(x, "buttonTheme", value.asInstanceOf[js.Any])
    
    inline def setButtonThemeUndefined: Self = StObject.set(x, "buttonTheme", js.undefined)
    
    inline def setEvents(value: PlotTreemapBreadcrumbsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setPosition(value: BreadcrumbsAlignOptions | PlotTreemapBreadcrumbsPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
    ...
    inline def setSeparator(value: PlotTreemapBreadcrumbsSeparatorOptions): Self = StObject.set(x, "separator", value.asInstanceOf[js.Any])
