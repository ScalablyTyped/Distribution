...
trait PlotFunnelPointEventsOptions extends js.Object {
  /**
...
object PlotFunnelPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotFunnelPointEventsOptions]
  }
}
