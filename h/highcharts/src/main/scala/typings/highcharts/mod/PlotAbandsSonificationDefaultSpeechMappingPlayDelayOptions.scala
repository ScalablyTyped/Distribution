...
trait PlotAbandsSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotAbandsSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
