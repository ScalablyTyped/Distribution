...
trait PlotAreasplinerangeOnPointPositionOptions extends StObject {
...
object PlotAreasplinerangeOnPointPositionOptions {
  
  inline def apply(): PlotAreasplinerangeOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplinerangeOnPointPositionOptions] (val x: Self) extends AnyVal {
