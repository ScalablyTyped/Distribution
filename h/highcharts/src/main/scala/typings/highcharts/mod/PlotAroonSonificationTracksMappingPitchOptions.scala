...
trait PlotAroonSonificationTracksMappingPitchOptions extends StObject {
...
object PlotAroonSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotAroonSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
