...
trait PlotTrixSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
