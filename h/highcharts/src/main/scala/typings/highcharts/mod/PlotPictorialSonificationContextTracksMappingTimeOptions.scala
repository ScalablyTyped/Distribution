...
trait PlotPictorialSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotPictorialSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
