...
trait PlotFunnel3dSonificationDefaultInstrumentMappingHighpassResonanceOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultInstrumentMappingHighpassResonanceOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultInstrumentMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultInstrumentMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultInstrumentMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
