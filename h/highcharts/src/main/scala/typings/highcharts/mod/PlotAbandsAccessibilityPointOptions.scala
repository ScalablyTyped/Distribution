...
trait PlotAbandsAccessibilityPointOptions extends StObject {
...
object PlotAbandsAccessibilityPointOptions {
  
  inline def apply(): PlotAbandsAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsAccessibilityPointOptions] (val x: Self) extends AnyVal {
