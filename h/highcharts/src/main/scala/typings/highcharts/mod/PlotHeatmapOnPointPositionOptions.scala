...
trait PlotHeatmapOnPointPositionOptions extends StObject {
...
object PlotHeatmapOnPointPositionOptions {
  
  inline def apply(): PlotHeatmapOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapOnPointPositionOptions] (val x: Self) extends AnyVal {
