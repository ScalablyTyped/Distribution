...
trait PlotLinearregressionslopeSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
