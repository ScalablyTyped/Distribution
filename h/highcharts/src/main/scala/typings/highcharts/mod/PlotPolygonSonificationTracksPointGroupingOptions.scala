...
trait PlotPolygonSonificationTracksPointGroupingOptions extends StObject {
...
object PlotPolygonSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotPolygonSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
