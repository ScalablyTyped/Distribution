...
trait PlotNatrSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotNatrSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotNatrSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
