...
trait SeriesTimelineDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesTimelineDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesTimelineDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesTimelineDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesTimelineDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesTimelineDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesTimelineDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesTimelineDataDragDropOptions]
  }
}
