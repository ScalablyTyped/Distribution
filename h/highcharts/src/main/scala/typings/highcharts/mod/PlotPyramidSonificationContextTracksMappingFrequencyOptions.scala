...
trait PlotPyramidSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotPyramidSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
