...
trait PlotPictorialOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotPictorialDataLabelsOptions | js.Array[PlotPictorialDataLabelsOptions]] = js.undefined
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotPictorialSonificationOptions] = js.undefined
...
object PlotPictorialOptions {
  
  inline def apply(): PlotPictorialOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataLabels(value: PlotPictorialDataLabelsOptions | js.Array[PlotPictorialDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotPictorialDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    ...
    inline def setSonification(value: PlotPictorialSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
