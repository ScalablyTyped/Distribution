...
trait PlotFlowmapSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotFlowmapSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
