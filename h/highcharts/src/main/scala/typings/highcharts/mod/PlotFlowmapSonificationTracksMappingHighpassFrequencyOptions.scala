...
trait PlotFlowmapSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
