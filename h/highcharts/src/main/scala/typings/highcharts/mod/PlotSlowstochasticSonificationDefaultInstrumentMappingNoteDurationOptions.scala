...
trait PlotSlowstochasticSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
