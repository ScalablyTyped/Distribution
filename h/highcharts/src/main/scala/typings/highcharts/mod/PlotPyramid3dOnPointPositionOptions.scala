...
trait PlotPyramid3dOnPointPositionOptions extends StObject {
...
object PlotPyramid3dOnPointPositionOptions {
  
  inline def apply(): PlotPyramid3dOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dOnPointPositionOptions] (val x: Self) extends AnyVal {
