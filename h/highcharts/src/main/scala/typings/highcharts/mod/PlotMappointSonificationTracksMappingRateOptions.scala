...
trait PlotMappointSonificationTracksMappingRateOptions extends StObject {
...
object PlotMappointSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
