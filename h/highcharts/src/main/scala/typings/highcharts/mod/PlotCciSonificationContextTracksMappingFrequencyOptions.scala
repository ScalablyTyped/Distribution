...
trait PlotCciSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotCciSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotCciSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
