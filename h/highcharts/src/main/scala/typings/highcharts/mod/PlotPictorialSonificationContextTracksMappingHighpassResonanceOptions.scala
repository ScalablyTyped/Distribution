...
trait PlotPictorialSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPictorialSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
