...
trait PlotMapSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotMapSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
