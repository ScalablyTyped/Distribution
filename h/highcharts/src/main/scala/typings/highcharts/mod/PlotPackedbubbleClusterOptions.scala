...
trait PlotPackedbubbleClusterOptions extends StObject {
  ...
  var events: js.UndefOr[PlotPackedbubbleClusterEventsOptions] = js.undefined
  ...
  /**
    ...
    * iterations.
    */
  var layoutAlgorithm: js.UndefOr[PlotPackedbubbleClusterLayoutAlgorithmOptions] = js.undefined
  ...
  var states: js.UndefOr[PlotPackedbubbleClusterStatesOptions] = js.undefined
  ...
  /**
    ...
    * `className` option.
    */
  var zones: js.UndefOr[js.Array[PlotPackedbubbleClusterZonesOptions]] = js.undefined
}
object PlotPackedbubbleClusterOptions {
  
  inline def apply(): PlotPackedbubbleClusterOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleClusterOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPackedbubbleClusterOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: PlotPackedbubbleClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    inline def setLayoutAlgorithm(value: PlotPackedbubbleClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setStates(value: PlotPackedbubbleClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    inline def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    inline def setZones(value: js.Array[PlotPackedbubbleClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
    
    inline def setZonesUndefined: Self = StObject.set(x, "zones", js.undefined)
    
    inline def setZonesVarargs(value: PlotPackedbubbleClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value*))
  }
}
