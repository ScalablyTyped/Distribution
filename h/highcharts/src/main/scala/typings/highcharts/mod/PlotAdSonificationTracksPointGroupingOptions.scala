...
trait PlotAdSonificationTracksPointGroupingOptions extends StObject {
...
object PlotAdSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotAdSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
