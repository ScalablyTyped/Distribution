...
trait PlotCylinderSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
