...
trait PlotCciSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotCciSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
