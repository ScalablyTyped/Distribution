...
trait PlotNetworkgraphSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
