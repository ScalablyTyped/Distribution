...
trait PlotLineSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotLineSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotLineSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
