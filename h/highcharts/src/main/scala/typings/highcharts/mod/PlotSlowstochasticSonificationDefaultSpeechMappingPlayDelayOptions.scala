...
trait PlotSlowstochasticSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
