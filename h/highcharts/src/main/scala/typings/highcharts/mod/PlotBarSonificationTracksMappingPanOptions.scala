...
trait PlotBarSonificationTracksMappingPanOptions extends StObject {
...
object PlotBarSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
