...
trait PlotTrixSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
