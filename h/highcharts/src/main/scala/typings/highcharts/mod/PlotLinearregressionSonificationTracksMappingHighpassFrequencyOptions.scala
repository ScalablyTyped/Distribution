...
trait PlotLinearregressionSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
