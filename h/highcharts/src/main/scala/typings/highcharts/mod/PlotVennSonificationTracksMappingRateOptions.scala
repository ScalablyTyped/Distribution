...
trait PlotVennSonificationTracksMappingRateOptions extends StObject {
...
object PlotVennSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
