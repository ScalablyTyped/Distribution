...
trait PlotItemSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotItemSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
