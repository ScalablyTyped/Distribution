...
trait PlotBubbleSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotBubbleSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
