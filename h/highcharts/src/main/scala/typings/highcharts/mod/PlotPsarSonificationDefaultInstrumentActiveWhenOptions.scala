...
trait PlotPsarSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotPsarSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotPsarSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
