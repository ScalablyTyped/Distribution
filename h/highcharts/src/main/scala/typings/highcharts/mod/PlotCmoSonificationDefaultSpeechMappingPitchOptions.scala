...
trait PlotCmoSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotCmoSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotCmoSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
