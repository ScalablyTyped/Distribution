...
trait PlotTreemapSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotTreemapSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
