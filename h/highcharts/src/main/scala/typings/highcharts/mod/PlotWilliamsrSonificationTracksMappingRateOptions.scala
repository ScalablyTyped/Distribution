...
trait PlotWilliamsrSonificationTracksMappingRateOptions extends StObject {
...
object PlotWilliamsrSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotWilliamsrSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWilliamsrSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
