...
trait PlotAreasplineOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotAreasplineOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotAreasplineOnPointPositionOptions] = js.undefined
}
object PlotAreasplineOnPointOptions {
  
  inline def apply(): PlotAreasplineOnPointOptions = {
  ...
  implicit open class MutableBuilder[Self <: PlotAreasplineOnPointOptions] (val x: Self) extends AnyVal {
    ...
    inline def setPosition(value: js.Object | PlotAreasplineOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
