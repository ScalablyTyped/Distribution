...
trait PlotPsarSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPsarSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
