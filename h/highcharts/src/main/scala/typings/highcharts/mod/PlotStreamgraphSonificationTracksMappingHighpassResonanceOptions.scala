...
trait PlotStreamgraphSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
