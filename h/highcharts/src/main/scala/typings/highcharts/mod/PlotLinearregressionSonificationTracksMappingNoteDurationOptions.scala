...
trait PlotLinearregressionSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
