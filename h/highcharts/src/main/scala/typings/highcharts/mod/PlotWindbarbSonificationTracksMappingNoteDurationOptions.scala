...
trait PlotWindbarbSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotWindbarbSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotWindbarbSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
