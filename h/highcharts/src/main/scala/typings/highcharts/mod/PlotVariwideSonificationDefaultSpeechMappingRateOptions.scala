...
trait PlotVariwideSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotVariwideSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
