...
trait PlotParetoMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotParetoMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotParetoMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotParetoMarkerStatesHoverOptions]
  }
}
