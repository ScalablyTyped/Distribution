...
trait PlotFunnelSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotFunnelSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
