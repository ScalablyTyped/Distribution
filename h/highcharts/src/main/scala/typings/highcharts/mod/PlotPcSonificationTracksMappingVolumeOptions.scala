...
trait PlotPcSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotPcSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
