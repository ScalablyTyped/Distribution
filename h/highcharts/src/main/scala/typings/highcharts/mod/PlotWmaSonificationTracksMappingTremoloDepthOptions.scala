...
trait PlotWmaSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotWmaSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
