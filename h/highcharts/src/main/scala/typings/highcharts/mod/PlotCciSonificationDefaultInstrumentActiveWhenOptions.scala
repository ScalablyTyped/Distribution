...
trait PlotCciSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotCciSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotCciSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
