...
trait PlotApoOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotApoSonificationOptions] = js.undefined
...
object PlotApoOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotApoSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
