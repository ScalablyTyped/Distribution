...
trait PlotSeriesSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotSeriesSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
