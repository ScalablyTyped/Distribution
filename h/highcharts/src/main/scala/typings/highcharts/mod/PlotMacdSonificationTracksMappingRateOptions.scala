...
trait PlotMacdSonificationTracksMappingRateOptions extends StObject {
...
object PlotMacdSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotMacdSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMacdSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
