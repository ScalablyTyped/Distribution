...
trait PlotHistogramSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotHistogramSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
