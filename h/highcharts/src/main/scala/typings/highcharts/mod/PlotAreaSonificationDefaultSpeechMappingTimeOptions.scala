...
trait PlotAreaSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotAreaSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotAreaSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
