...
trait PlotIkhSonificationPointGroupingOptions extends StObject {
...
object PlotIkhSonificationPointGroupingOptions {
  
  inline def apply(): PlotIkhSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
