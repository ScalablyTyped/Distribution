...
trait PlotNetworkgraphSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
