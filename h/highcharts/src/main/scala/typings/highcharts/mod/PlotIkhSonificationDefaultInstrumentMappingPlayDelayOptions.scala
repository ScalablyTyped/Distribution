...
trait PlotIkhSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotIkhSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotIkhSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
