...
trait PlotKeltnerchannelsSonificationTracksMappingTimeOptions extends StObject {
...
object PlotKeltnerchannelsSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotKeltnerchannelsSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
