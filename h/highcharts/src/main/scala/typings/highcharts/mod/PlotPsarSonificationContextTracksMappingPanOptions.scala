...
trait PlotPsarSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotPsarSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
