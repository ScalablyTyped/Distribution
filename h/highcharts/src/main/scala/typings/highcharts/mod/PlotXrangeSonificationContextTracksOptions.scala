...
trait PlotXrangeSonificationContextTracksOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotXrangeSonificationContextTracksActiveWhenOptions] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[PlotXrangeSonificationContextTracksMappingOptions] = js.undefined
  ...
  /**
    ...
    */
  var pointGrouping: js.UndefOr[PlotXrangeSonificationContextTracksPointGroupingOptions] = js.undefined
  ...
  /**
    * (Highcharts, Highstock, Gantt) Set a context track to play periodically
    * every `timeInterval` milliseconds while the sonification is playing.
    */
  ...
  /**
    * (Highcharts, Highstock, Gantt) Set a context track to play periodically
    * every `valueInterval` units of a data property `valueProp` while the
  ...
  /**
    * (Highcharts, Highstock, Gantt) How to map context events to time when
    * using the `valueInterval` option.
    */
  var valueMapFunction: js.UndefOr[OptionsValueMapFunctionValue] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) The point property to play context for
    * when using `valueInterval`.
    */
  var valueProp: js.UndefOr[String] = js.undefined
}
object PlotXrangeSonificationContextTracksOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotXrangeSonificationContextTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotXrangeSonificationContextTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotXrangeSonificationContextTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
