...
trait PlotHeatmapSonificationContextTracksPointGroupingOptions extends StObject {
  
  /**
    * (Highcharts, Highmaps) The grouping algorithm, deciding which points to
  ...
  /**
    * (Highcharts, Highmaps) Whether or not to group points
    */
  var enabled: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Highcharts, Highmaps) The size of each group in milliseconds. Audio
    * events closer than this are grouped together.
    */
  var groupTimespan: js.UndefOr[Double] = js.undefined
  
  /**
    * (Highcharts, Highmaps) The data property for each point to compare when
...
object PlotHeatmapSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
