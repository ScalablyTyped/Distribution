...
trait PlotCylinderSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotCylinderSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
