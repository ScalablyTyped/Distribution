...
trait PlotLineSonificationTracksPointGroupingOptions extends StObject {
...
object PlotLineSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotLineSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
