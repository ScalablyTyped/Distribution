...
trait PlotPcSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotPcSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotPcSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
