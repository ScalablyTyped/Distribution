...
trait PlotMacdSonificationTracksActiveWhenOptions extends StObject {
...
object PlotMacdSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotMacdSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMacdSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
