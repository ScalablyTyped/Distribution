...
trait PlotFunnelSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotFunnelSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
