...
trait PlotWmaSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotWmaSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotWmaSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
