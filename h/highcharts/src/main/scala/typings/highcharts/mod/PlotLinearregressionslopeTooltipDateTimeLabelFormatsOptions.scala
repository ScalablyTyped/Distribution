...
trait PlotLinearregressionslopeTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotLinearregressionslopeTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotLinearregressionslopeTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeTooltipDateTimeLabelFormatsOptions]
  }
}
