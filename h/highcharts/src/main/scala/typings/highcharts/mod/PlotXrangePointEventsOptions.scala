...
trait PlotXrangePointEventsOptions extends js.Object {
  /**
...
object PlotXrangePointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotXrangePointEventsOptions]
  }
}
