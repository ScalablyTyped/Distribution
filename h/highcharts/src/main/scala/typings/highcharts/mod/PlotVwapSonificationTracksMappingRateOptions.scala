...
trait PlotVwapSonificationTracksMappingRateOptions extends StObject {
...
object PlotVwapSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotVwapSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVwapSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
