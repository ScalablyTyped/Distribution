...
trait PlotCmoSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
