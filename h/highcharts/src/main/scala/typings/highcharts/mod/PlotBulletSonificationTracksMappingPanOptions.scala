...
trait PlotBulletSonificationTracksMappingPanOptions extends StObject {
...
object PlotBulletSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
