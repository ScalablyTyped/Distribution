...
trait PlotIkhSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotIkhSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
