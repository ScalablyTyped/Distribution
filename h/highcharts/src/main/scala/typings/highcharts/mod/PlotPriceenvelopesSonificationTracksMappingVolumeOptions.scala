...
trait PlotPriceenvelopesSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
