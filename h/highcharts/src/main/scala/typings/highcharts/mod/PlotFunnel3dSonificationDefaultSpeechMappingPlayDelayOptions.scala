...
trait PlotFunnel3dSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
