...
trait PlotTreemapSonificationTracksMappingRateOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
