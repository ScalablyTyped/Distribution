...
trait PlotDumbbellSonificationTracksPointGroupingOptions extends StObject {
...
object PlotDumbbellSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
