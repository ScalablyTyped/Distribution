...
trait PlotWindbarbOnPointPositionOptions extends StObject {
...
object PlotWindbarbOnPointPositionOptions {
  
  inline def apply(): PlotWindbarbOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbOnPointPositionOptions] (val x: Self) extends AnyVal {
