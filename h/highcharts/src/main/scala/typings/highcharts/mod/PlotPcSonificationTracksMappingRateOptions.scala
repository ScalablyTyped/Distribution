...
trait PlotPcSonificationTracksMappingRateOptions extends StObject {
...
object PlotPcSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
