...
trait PlotColumnpyramidSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
