...
trait PlotColumnSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotColumnSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotColumnSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
