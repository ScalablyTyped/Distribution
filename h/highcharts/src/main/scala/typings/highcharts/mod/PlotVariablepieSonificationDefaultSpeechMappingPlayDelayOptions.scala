...
trait PlotVariablepieSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotVariablepieSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
