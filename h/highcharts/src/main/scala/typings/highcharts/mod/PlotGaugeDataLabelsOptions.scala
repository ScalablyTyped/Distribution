...
trait PlotGaugeDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotGaugeDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotGaugeDataLabelsOptions {
  ...
  inline def apply(): PlotGaugeDataLabelsOptions = {
  ...
  extension [Self <: PlotGaugeDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotGaugeDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
