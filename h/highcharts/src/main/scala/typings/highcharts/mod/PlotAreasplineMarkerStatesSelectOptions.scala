...
trait PlotAreasplineMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAreasplineMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplineMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineMarkerStatesSelectOptions]
  }
}
