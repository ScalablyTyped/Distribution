...
@js.native
trait PlotBubbleDataLabelsAnimationOptions extends js.Object {
...
object PlotBubbleDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotBubbleDataLabelsAnimationOptionsOps[Self <: PlotBubbleDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
