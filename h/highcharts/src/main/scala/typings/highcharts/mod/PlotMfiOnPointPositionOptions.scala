...
trait PlotMfiOnPointPositionOptions extends StObject {
...
object PlotMfiOnPointPositionOptions {
  
  inline def apply(): PlotMfiOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMfiOnPointPositionOptions] (val x: Self) extends AnyVal {
