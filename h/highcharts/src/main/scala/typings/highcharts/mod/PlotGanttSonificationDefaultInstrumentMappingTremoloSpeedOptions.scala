...
trait PlotGanttSonificationDefaultInstrumentMappingTremoloSpeedOptions extends StObject {
...
object PlotGanttSonificationDefaultInstrumentMappingTremoloSpeedOptions {
  
  inline def apply(): PlotGanttSonificationDefaultInstrumentMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationDefaultInstrumentMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationDefaultInstrumentMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
