...
trait PlotPolygonSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotPolygonSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
