...
trait PlotPivotpointsSonificationTracksMappingTimeOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
