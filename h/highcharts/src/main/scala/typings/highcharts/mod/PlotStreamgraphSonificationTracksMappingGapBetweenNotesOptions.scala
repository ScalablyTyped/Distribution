...
trait PlotStreamgraphSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
