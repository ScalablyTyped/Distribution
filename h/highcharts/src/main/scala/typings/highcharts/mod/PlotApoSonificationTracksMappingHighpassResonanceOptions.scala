...
trait PlotApoSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotApoSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
