...
trait PlotWaterfallSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotWaterfallSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotWaterfallSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
