...
object PlotMappointClusterOptions {
  ...
  inline def apply(): PlotMappointClusterOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointClusterOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointClusterOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: PlotMappointClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    inline def setLayoutAlgorithm(value: PlotMappointClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setStates(value: PlotMappointClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    inline def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    inline def setZones(value: js.Array[PlotMappointClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
