...
trait PlotDumbbellSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
