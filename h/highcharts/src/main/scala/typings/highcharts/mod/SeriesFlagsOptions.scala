...
object SeriesFlagsOptions {
  ...
  @scala.inline
  implicit class SeriesFlagsOptionsOps[Self <: SeriesFlagsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | flags): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
