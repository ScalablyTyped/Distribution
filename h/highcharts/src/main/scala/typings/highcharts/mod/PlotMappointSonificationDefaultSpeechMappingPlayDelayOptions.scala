...
trait PlotMappointSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotMappointSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotMappointSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
