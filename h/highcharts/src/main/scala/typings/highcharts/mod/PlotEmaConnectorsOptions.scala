...
trait PlotEmaConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotEmaConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotEmaConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotEmaConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotEmaConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotEmaConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotEmaConnectorsMarkerOptions = null,
    startMarker: PlotEmaConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotEmaConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotEmaConnectorsOptions]
  }
}
