...
trait PlotEmaStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotEmaStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotEmaStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotEmaStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotEmaStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotEmaStatesSelectOptions]
  }
}
