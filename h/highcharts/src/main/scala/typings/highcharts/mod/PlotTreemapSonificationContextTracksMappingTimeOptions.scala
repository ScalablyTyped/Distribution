...
trait PlotTreemapSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotTreemapSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
