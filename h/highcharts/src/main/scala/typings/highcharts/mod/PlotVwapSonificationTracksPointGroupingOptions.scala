...
trait PlotVwapSonificationTracksPointGroupingOptions extends StObject {
...
object PlotVwapSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotVwapSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVwapSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
