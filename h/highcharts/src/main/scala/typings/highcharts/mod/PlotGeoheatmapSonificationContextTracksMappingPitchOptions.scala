...
trait PlotGeoheatmapSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
