...
trait PlotFlagsSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotFlagsSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
