...
trait PlotAreaSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotAreaSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotAreaSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
