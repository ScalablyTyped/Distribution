...
trait PlotStreamgraphSonificationTracksPointGroupingOptions extends StObject {
...
object PlotStreamgraphSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
