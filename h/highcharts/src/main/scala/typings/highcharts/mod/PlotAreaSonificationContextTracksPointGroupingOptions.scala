...
trait PlotAreaSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotAreaSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotAreaSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
