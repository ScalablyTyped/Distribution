...
trait PlotTilemapSonificationTracksMappingRateOptions extends StObject {
...
object PlotTilemapSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotTilemapSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTilemapSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
