...
trait PlotHistogramSonificationTracksActiveWhenOptions extends StObject {
...
object PlotHistogramSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotHistogramSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
