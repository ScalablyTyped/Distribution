...
trait PlotVariablepieSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotVariablepieSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
