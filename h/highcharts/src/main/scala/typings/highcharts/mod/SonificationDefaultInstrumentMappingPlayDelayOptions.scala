...
trait SonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object SonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): SonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
