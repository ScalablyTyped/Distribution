...
trait PlotXrangeSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotXrangeSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
