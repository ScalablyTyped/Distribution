...
trait PlotTreemapSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotTreemapSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
