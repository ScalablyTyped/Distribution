...
trait PlotPpoSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotPpoSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotPpoSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
