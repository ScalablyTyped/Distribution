...
trait PlotLineSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotLineSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotLineSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
