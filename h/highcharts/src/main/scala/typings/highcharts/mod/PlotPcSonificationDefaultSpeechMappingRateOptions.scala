...
trait PlotPcSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotPcSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotPcSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
