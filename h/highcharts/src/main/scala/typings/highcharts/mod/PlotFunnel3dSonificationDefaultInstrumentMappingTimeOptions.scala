...
trait PlotFunnel3dSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
