...
trait PlotApoSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
