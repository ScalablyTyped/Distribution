...
trait PlotAbandsConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotAbandsConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAbandsConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsConnectorsEndMarkerOptions]
  }
}
