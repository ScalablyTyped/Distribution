...
trait PlotLinearregressionslopeConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeConnectorsEndMarkerOptions]
  }
}
