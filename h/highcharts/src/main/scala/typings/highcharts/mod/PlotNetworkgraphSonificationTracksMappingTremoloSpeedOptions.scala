...
trait PlotNetworkgraphSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
