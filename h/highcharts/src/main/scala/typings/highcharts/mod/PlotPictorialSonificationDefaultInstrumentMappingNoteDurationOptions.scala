...
trait PlotPictorialSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotPictorialSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
