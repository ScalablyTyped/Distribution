...
trait PlotWmaSonificationPointGroupingOptions extends StObject {
...
object PlotWmaSonificationPointGroupingOptions {
  
  inline def apply(): PlotWmaSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
