...
trait PlotAtrSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotAtrSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
