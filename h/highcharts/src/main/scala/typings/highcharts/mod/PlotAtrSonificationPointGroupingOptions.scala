...
trait PlotAtrSonificationPointGroupingOptions extends StObject {
...
object PlotAtrSonificationPointGroupingOptions {
  
  inline def apply(): PlotAtrSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
