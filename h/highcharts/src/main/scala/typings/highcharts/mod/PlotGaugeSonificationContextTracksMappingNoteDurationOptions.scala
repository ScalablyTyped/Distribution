...
trait PlotGaugeSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotGaugeSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotGaugeSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
