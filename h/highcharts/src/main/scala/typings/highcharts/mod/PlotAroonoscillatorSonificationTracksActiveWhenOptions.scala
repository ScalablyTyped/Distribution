...
trait PlotAroonoscillatorSonificationTracksActiveWhenOptions extends StObject {
...
object PlotAroonoscillatorSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotAroonoscillatorSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonoscillatorSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
