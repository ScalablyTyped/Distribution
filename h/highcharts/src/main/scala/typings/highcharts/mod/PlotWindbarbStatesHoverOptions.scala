...
trait PlotWindbarbStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotWindbarbStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotWindbarbStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotWindbarbStatesHoverAnimationOptions = null,
  ...
  ): PlotWindbarbStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotWindbarbStatesHoverOptions]
  }
}
