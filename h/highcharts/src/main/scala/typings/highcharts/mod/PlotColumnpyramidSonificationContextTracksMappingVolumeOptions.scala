...
trait PlotColumnpyramidSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
