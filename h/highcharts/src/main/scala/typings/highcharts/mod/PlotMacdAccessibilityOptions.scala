...
trait PlotMacdAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMacdAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotMacdAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotMacdAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotMacdAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotMacdAccessibilityOptions]
  }
}
