...
trait PlotWordcloudSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
