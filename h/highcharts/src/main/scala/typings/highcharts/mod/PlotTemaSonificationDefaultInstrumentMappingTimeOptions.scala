...
trait PlotTemaSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotTemaSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotTemaSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
