...
trait PlotWindbarbSonificationTracksMappingTimeOptions extends StObject {
...
object PlotWindbarbSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotWindbarbSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
