...
trait PlotStochasticSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotStochasticSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
