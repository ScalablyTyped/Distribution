...
trait PlotPackedbubbleConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotPackedbubbleConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPackedbubbleConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleConnectorsStartMarkerOptions]
  }
}
