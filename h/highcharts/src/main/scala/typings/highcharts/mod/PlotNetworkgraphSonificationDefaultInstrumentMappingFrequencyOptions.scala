...
trait PlotNetworkgraphSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
