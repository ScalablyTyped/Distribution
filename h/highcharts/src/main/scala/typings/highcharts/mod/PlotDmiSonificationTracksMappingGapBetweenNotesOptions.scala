...
trait PlotDmiSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotDmiSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
