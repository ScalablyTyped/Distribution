...
trait PlotArcdiagramSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
