...
object ChartParallelAxesLabelsSymbolOptions {
  ...
  inline def apply(): ChartParallelAxesLabelsSymbolOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesLabelsSymbolOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartParallelAxesLabelsSymbolOptions] (val x: Self) extends AnyVal {
