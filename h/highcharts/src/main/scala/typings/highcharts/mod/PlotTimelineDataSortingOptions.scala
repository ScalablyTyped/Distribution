...
trait PlotTimelineDataSortingOptions extends StObject {
...
object PlotTimelineDataSortingOptions {
  
  inline def apply(): PlotTimelineDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineDataSortingOptions] (val x: Self) extends AnyVal {
