...
trait PlotFunnelSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotFunnelSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
