...
trait PlotBoxplotSonificationPointGroupingOptions extends StObject {
...
object PlotBoxplotSonificationPointGroupingOptions {
  
  inline def apply(): PlotBoxplotSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBoxplotSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
