...
trait SonificationGlobalContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object SonificationGlobalContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
