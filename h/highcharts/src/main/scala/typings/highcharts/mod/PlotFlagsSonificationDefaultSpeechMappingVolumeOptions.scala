...
trait PlotFlagsSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotFlagsSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
