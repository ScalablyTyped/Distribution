...
trait PlotTreegraphBreadcrumbsEventsOptions extends StObject {
...
object PlotTreegraphBreadcrumbsEventsOptions {
  
  inline def apply(): PlotTreegraphBreadcrumbsEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphBreadcrumbsEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphBreadcrumbsEventsOptions] (val x: Self) extends AnyVal {
