...
trait PlotHeikinashiOnPointConnectorOptions extends StObject {
...
object PlotHeikinashiOnPointConnectorOptions {
  
  inline def apply(): PlotHeikinashiOnPointConnectorOptions = {
