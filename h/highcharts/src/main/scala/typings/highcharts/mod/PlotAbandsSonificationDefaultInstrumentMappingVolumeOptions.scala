...
trait PlotAbandsSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotAbandsSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
