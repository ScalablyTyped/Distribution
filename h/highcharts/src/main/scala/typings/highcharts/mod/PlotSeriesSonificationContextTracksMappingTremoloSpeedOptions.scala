...
trait PlotSeriesSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
