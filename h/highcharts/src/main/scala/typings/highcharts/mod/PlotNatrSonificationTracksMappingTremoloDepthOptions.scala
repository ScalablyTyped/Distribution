...
trait PlotNatrSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotNatrSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
