...
trait PlotObvSonificationTracksMappingPanOptions extends StObject {
...
object PlotObvSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotObvSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotObvSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotObvSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
