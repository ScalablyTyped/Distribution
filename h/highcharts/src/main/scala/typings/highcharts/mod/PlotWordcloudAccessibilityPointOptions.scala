...
trait PlotWordcloudAccessibilityPointOptions extends StObject {
...
object PlotWordcloudAccessibilityPointOptions {
  
  inline def apply(): PlotWordcloudAccessibilityPointOptions = {
