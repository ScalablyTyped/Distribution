...
trait PlotAoSonificationPointGroupingOptions extends StObject {
...
object PlotAoSonificationPointGroupingOptions {
  
  inline def apply(): PlotAoSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
