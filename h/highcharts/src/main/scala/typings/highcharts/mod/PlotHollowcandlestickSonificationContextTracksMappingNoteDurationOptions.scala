...
trait PlotHollowcandlestickSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotHollowcandlestickSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
