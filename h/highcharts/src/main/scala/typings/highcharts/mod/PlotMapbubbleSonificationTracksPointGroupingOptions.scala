...
trait PlotMapbubbleSonificationTracksPointGroupingOptions extends StObject {
...
object PlotMapbubbleSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotMapbubbleSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
