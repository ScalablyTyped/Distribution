...
trait PlotSeriesMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    * marker.
    */
  var states: js.UndefOr[PlotSeriesMarkerStatesOptions] = js.undefined
  /**
...
object PlotSeriesMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotSeriesMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotSeriesMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesMarkerOptions]
  }
}
