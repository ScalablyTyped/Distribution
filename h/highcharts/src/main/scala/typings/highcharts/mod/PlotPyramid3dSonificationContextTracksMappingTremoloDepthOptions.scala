...
trait PlotPyramid3dSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
