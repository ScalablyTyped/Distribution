...
trait PlotNatrSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotNatrSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
