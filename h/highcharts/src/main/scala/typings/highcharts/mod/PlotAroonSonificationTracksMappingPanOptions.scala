...
trait PlotAroonSonificationTracksMappingPanOptions extends StObject {
...
object PlotAroonSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotAroonSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
