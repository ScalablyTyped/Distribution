...
trait PlotAroonStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotAroonStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAroonStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotAroonStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotAroonStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotAroonStatesSelectOptions]
  }
}
