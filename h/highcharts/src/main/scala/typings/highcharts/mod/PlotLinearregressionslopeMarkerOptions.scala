...
trait PlotLinearregressionslopeMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressionslopeMarkerStatesOptions] = js.undefined
  /**
...
object PlotLinearregressionslopeMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLinearregressionslopeMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLinearregressionslopeMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeMarkerOptions]
  }
}
