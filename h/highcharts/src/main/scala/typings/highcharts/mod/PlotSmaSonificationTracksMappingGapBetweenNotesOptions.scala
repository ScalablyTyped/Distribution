...
trait PlotSmaSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotSmaSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
