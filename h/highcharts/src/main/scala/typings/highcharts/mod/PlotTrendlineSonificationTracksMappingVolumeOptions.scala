...
trait PlotTrendlineSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
