...
trait PlotChaikinMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotChaikinMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotChaikinMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinMarkerStatesSelectOptions]
  }
}
