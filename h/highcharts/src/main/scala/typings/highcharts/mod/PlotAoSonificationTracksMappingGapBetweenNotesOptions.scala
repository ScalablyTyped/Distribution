...
trait PlotAoSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotAoSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
