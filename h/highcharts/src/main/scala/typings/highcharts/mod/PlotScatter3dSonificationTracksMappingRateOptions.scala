...
trait PlotScatter3dSonificationTracksMappingRateOptions extends StObject {
...
object PlotScatter3dSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotScatter3dSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatter3dSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
