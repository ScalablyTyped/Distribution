...
trait PlotBubbleSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotBubbleSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
