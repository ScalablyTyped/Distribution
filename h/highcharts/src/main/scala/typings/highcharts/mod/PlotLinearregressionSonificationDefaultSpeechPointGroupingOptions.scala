...
trait PlotLinearregressionSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotLinearregressionSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
