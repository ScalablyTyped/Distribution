...
trait PlotLinearregressioninterceptSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
