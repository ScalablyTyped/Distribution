...
trait PlotParetoDataGroupingOptions extends js.Object {
  /**
...
object PlotParetoDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotParetoDataGroupingOptions]
  }
}
