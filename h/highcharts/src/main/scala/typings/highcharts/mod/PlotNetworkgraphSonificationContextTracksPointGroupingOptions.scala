...
trait PlotNetworkgraphSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
