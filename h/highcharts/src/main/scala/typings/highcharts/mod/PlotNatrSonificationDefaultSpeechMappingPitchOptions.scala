...
trait PlotNatrSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotNatrSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotNatrSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
