...
trait PlotWaterfallSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotWaterfallSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotWaterfallSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
