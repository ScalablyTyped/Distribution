...
trait PlotGeoheatmapDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotGeoheatmapDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotGeoheatmapDataLabelsOptions {
  
  inline def apply(): PlotGeoheatmapDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapDataLabelsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotGeoheatmapDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
