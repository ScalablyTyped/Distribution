...
trait PlotColumnpyramidSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
