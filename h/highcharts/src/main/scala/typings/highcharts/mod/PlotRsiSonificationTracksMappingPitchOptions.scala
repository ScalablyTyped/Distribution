...
trait PlotRsiSonificationTracksMappingPitchOptions extends StObject {
...
object PlotRsiSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
