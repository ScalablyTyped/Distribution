...
trait PlotVwapConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotVwapConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVwapConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVwapConnectorsMarkerOptions]
  }
}
