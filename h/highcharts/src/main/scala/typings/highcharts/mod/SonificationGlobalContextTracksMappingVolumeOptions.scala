...
trait SonificationGlobalContextTracksMappingVolumeOptions extends StObject {
...
object SonificationGlobalContextTracksMappingVolumeOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
