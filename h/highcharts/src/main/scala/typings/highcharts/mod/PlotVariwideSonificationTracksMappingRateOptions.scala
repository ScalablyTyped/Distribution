...
trait PlotVariwideSonificationTracksMappingRateOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
