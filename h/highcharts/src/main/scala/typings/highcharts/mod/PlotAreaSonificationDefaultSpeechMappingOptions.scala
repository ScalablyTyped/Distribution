...
trait PlotAreaSonificationDefaultSpeechMappingOptions extends StObject {
  ...
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAreaSonificationDefaultSpeechMappingPitchOptions
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAreaSonificationDefaultSpeechMappingPlayDelayOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var rate: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAreaSonificationDefaultSpeechMappingRateOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAreaSonificationDefaultSpeechMappingTimeOptions
  ] = js.undefined
  ...
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAreaSonificationDefaultSpeechMappingVolumeOptions
  ] = js.undefined
}
object PlotAreaSonificationDefaultSpeechMappingOptions {
  
  inline def apply(): PlotAreaSonificationDefaultSpeechMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultSpeechMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultSpeechMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotAreaSonificationDefaultSpeechMappingPitchOptions
    ): Self = StObject.set(x, "pitch", value.asInstanceOf[js.Any])
    
    inline def setPitchUndefined: Self = StObject.set(x, "pitch", js.undefined)
    
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotAreaSonificationDefaultSpeechMappingPlayDelayOptions
    ...
    inline def setRate(
      value: Double | js.Object | String | js.Function | PlotAreaSonificationDefaultSpeechMappingRateOptions
    ...
    inline def setTime(
      value: Double | js.Object | String | js.Function | PlotAreaSonificationDefaultSpeechMappingTimeOptions
    ): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setVolume(
      value: Double | js.Object | String | js.Function | PlotAreaSonificationDefaultSpeechMappingVolumeOptions
