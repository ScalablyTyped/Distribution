...
trait PlotDependencywheelSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotDependencywheelSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
