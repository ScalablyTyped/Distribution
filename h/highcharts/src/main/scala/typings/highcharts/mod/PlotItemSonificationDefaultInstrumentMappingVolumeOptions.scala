...
trait PlotItemSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotItemSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotItemSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
