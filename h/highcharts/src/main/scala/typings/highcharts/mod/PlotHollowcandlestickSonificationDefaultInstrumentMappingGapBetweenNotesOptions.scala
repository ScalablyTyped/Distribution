...
trait PlotHollowcandlestickSonificationDefaultInstrumentMappingGapBetweenNotesOptions extends StObject {
...
object PlotHollowcandlestickSonificationDefaultInstrumentMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationDefaultInstrumentMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationDefaultInstrumentMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationDefaultInstrumentMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
