...
trait PlotBubbleConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotBubbleConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBubbleConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleConnectorsEndMarkerOptions]
  }
}
