...
trait PlotFunnelSonificationDefaultInstrumentMappingGapBetweenNotesOptions extends StObject {
...
object PlotFunnelSonificationDefaultInstrumentMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultInstrumentMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultInstrumentMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultInstrumentMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
