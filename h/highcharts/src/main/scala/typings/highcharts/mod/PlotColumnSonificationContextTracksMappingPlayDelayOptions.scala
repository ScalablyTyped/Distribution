...
trait PlotColumnSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
