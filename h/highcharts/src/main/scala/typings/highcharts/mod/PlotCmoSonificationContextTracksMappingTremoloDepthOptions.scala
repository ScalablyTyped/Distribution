...
trait PlotCmoSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
