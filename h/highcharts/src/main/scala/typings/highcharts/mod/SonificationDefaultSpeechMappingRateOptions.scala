...
trait SonificationDefaultSpeechMappingRateOptions extends StObject {
...
object SonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): SonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
