...
trait PlotNatrSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
