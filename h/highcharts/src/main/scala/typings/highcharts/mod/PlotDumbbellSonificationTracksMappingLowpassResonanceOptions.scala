...
trait PlotDumbbellSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
