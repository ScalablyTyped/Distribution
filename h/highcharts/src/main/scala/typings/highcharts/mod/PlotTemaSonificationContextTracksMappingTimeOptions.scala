...
trait PlotTemaSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
