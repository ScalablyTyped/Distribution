...
object PlotSmaDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotSmaDataLabelsOptionsMutableBuilder[Self <: PlotSmaDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSmaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
