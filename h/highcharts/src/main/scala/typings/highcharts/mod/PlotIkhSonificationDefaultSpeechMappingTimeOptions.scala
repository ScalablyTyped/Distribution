...
trait PlotIkhSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotIkhSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotIkhSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
