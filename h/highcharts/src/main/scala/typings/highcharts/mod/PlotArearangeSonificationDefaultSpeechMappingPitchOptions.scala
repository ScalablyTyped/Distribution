...
trait PlotArearangeSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotArearangeSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
