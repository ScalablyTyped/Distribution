...
trait PlotCciSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotCciSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotCciSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
