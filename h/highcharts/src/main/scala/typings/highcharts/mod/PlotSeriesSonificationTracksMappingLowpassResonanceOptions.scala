...
trait PlotSeriesSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
