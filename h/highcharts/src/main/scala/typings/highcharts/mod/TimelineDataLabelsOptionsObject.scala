...
@js.native
trait TimelineDataLabelsOptionsObject extends js.Object {
  /**
...
object TimelineDataLabelsOptionsObject {
  ...
  implicit class TimelineDataLabelsOptionsObjectOps[Self <: TimelineDataLabelsOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormatter(value: TimelineDataLabelsFormatterCallbackFunction): Self = this.set("formatter", value.asInstanceOf[js.Any])
    @scala.inline
