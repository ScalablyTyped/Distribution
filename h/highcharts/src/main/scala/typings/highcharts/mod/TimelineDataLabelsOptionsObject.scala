...
trait TimelineDataLabelsOptionsObject extends StObject {
  ...
  /**
    ...
    */
  var formatter: js.UndefOr[TimelineDataLabelsFormatterCallbackFunction] = js.native
...
object TimelineDataLabelsOptionsObject {
  ...
  @scala.inline
  implicit class TimelineDataLabelsOptionsObjectMutableBuilder[Self <: TimelineDataLabelsOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTimelineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFormatter(value: TimelineDataLabelsFormatterCallbackFunction): Self = StObject.set(x, "formatter", value.asInstanceOf[js.Any])
