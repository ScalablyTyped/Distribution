...
trait PlotTreemapSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
