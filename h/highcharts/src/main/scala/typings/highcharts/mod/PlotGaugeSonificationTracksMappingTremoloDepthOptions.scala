...
trait PlotGaugeSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
