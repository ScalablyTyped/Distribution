...
trait DrilldownBreadcrumbsOptions extends StObject {
  ...
  /**
    ...
    */
  var buttonTheme: js.UndefOr[DrilldownBreadcrumbsButtonThemeOptions | SVGAttributes] = js.undefined
  
  var events: js.UndefOr[DrilldownBreadcrumbsEventsOptions] = js.undefined
  ...
  /**
    ...
    * position properties.
    */
  var position: js.UndefOr[BreadcrumbsAlignOptions | DrilldownBreadcrumbsPositionOptions] = js.undefined
  ...
  /**
    ...
    */
  var separator: js.UndefOr[DrilldownBreadcrumbsSeparatorOptions] = js.undefined
...
object DrilldownBreadcrumbsOptions {
  
  inline def apply(): DrilldownBreadcrumbsOptions = {
  ...
  extension [Self <: DrilldownBreadcrumbsOptions](x: Self) {
    ...
    inline def setButtonTheme(value: DrilldownBreadcrumbsButtonThemeOptions | SVGAttributes): Self = StObject.set(x, "buttonTheme", value.asInstanceOf[js.Any])
    
    inline def setButtonThemeUndefined: Self = StObject.set(x, "buttonTheme", js.undefined)
    
    inline def setEvents(value: DrilldownBreadcrumbsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setPosition(value: BreadcrumbsAlignOptions | DrilldownBreadcrumbsPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
    ...
    inline def setSeparator(value: DrilldownBreadcrumbsSeparatorOptions): Self = StObject.set(x, "separator", value.asInstanceOf[js.Any])
