...
trait PlotTrixSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotTrixSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
