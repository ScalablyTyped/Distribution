...
trait PlotGaugeSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotGaugeSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotGaugeSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
