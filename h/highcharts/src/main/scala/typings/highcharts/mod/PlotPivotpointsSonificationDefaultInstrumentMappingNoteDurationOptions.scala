...
trait PlotPivotpointsSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
