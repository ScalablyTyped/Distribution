...
trait PlotIkhSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotIkhSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotIkhSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
