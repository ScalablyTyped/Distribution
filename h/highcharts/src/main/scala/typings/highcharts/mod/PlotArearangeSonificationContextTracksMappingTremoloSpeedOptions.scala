...
trait PlotArearangeSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotArearangeSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotArearangeSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
