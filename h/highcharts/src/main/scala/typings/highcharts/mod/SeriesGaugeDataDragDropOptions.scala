...
trait SeriesGaugeDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesGaugeDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesGaugeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesGaugeDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesGaugeDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesGaugeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesGaugeDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesGaugeDataDragDropOptions]
  }
}
