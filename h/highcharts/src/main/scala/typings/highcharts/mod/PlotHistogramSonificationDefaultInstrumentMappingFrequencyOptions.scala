...
trait PlotHistogramSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotHistogramSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
