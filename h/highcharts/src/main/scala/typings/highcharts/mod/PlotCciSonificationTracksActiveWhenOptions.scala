...
trait PlotCciSonificationTracksActiveWhenOptions extends StObject {
...
object PlotCciSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotCciSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
