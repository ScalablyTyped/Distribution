...
trait PlotMfiSonificationTracksPointGroupingOptions extends StObject {
...
object PlotMfiSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotMfiSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMfiSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
