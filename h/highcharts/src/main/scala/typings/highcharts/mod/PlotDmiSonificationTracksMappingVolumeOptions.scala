...
trait PlotDmiSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotDmiSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
