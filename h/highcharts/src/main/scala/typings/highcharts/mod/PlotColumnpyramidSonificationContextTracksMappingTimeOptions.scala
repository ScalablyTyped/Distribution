...
trait PlotColumnpyramidSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
