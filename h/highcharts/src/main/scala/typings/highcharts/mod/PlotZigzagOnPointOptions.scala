...
trait PlotZigzagOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotZigzagOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotZigzagOnPointPositionOptions] = js.undefined
}
object PlotZigzagOnPointOptions {
  
  inline def apply(): PlotZigzagOnPointOptions = {
  ...
  extension [Self <: PlotZigzagOnPointOptions](x: Self) {
    ...
    inline def setPosition(value: js.Object | PlotZigzagOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
