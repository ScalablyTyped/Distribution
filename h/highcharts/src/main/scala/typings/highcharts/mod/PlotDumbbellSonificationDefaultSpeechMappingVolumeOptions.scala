...
trait PlotDumbbellSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotDumbbellSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
