...
trait PlotPolygonSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotPolygonSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
