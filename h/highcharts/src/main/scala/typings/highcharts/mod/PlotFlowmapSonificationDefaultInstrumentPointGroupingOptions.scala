...
trait PlotFlowmapSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotFlowmapSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
