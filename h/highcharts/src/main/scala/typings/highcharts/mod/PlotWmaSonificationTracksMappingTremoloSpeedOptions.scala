...
trait PlotWmaSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotWmaSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
