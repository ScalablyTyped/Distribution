...
trait PlotVectorSonificationPointGroupingOptions extends StObject {
...
object PlotVectorSonificationPointGroupingOptions {
  
  inline def apply(): PlotVectorSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVectorSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
