...
trait PlotTemaSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
