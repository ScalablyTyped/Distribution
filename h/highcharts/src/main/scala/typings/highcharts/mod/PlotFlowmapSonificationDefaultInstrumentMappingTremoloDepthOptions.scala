...
trait PlotFlowmapSonificationDefaultInstrumentMappingTremoloDepthOptions extends StObject {
...
object PlotFlowmapSonificationDefaultInstrumentMappingTremoloDepthOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultInstrumentMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultInstrumentMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultInstrumentMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
