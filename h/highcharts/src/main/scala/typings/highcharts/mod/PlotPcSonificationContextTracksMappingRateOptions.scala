...
trait PlotPcSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotPcSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotPcSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
