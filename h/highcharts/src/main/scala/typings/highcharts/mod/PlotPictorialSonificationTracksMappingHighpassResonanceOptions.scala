...
trait PlotPictorialSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
