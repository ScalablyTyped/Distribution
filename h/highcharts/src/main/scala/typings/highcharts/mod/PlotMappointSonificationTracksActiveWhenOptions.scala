...
trait PlotMappointSonificationTracksActiveWhenOptions extends StObject {
...
object PlotMappointSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotMappointSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
