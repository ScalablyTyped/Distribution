...
trait PlotIkhSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotIkhSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotIkhSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
