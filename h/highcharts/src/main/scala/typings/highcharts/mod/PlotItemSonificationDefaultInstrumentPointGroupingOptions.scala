...
trait PlotItemSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotItemSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotItemSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
