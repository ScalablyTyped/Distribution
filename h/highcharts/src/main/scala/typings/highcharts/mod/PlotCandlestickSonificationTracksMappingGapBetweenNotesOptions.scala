...
trait PlotCandlestickSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
