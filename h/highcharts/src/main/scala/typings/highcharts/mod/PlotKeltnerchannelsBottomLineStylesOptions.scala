...
object PlotKeltnerchannelsBottomLineStylesOptions {
  ...
  @scala.inline
  def apply(): PlotKeltnerchannelsBottomLineStylesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsBottomLineStylesOptions]
  }
  
  @scala.inline
  implicit class PlotKeltnerchannelsBottomLineStylesOptionsMutableBuilder[Self <: PlotKeltnerchannelsBottomLineStylesOptions] (val x: Self) extends AnyVal {
