...
trait PlotTreemapSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotTreemapSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
