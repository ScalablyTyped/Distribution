...
trait PlotTreemapSonificationTracksActiveWhenOptions extends StObject {
...
object PlotTreemapSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotTreemapSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
