...
trait PlotApoSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotApoSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotApoSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
