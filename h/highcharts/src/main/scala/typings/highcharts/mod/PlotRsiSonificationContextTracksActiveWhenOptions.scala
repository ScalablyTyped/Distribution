...
trait PlotRsiSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotRsiSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
