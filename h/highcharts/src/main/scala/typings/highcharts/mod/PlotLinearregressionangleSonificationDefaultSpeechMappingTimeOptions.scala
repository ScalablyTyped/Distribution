...
trait PlotLinearregressionangleSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotLinearregressionangleSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
