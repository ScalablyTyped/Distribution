...
trait PlotArcdiagramSonificationPointGroupingOptions extends StObject {
...
object PlotArcdiagramSonificationPointGroupingOptions {
  
  inline def apply(): PlotArcdiagramSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
