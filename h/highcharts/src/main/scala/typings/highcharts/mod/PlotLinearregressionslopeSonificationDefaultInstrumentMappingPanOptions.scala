...
trait PlotLinearregressionslopeSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
