...
trait SeriesWaterfallDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesWaterfallDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesWaterfallDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesWaterfallDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesWaterfallDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesWaterfallDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesWaterfallDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesWaterfallDataDragDropOptions]
  }
}
