...
trait PlotSlowstochasticSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
