...
trait PlotAroonConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotAroonConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonConnectorsEndMarkerOptions]
  }
}
