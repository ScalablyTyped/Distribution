...
trait PlotXrangeSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotXrangeSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
