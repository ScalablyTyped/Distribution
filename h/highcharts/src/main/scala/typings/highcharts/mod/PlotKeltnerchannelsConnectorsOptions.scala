...
trait PlotKeltnerchannelsConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotKeltnerchannelsConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotKeltnerchannelsConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotKeltnerchannelsConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotKeltnerchannelsConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotKeltnerchannelsConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotKeltnerchannelsConnectorsMarkerOptions = null,
    startMarker: PlotKeltnerchannelsConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotKeltnerchannelsConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsConnectorsOptions]
  }
}
