...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesZigzagOptions
  extends StObject
...
object SeriesZigzagOptions {
  ...
  inline def apply(`type`: String | zigzag): SeriesZigzagOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesZigzagOptions] (val x: Self) extends AnyVal {
