...
trait PlotPsarSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPsarSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
