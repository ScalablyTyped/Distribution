...
trait PlotColumnrangeDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotColumnrangeDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnrangeDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotColumnrangeDragDropDragHandleOptions]
  }
}
