...
trait PlotHlcSonificationDefaultInstrumentMappingLowpassFrequencyOptions extends StObject {
...
object PlotHlcSonificationDefaultInstrumentMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotHlcSonificationDefaultInstrumentMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcSonificationDefaultInstrumentMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHlcSonificationDefaultInstrumentMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
