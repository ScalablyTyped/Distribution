...
trait PlotXrangeSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotXrangeSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
