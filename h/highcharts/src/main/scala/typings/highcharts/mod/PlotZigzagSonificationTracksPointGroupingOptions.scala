...
trait PlotZigzagSonificationTracksPointGroupingOptions extends StObject {
...
object PlotZigzagSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotZigzagSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotZigzagSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
