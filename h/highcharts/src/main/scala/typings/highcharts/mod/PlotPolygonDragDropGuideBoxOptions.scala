...
object PlotPolygonDragDropGuideBoxOptions {
  ...
  inline def apply(): PlotPolygonDragDropGuideBoxOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonDragDropGuideBoxOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonDragDropGuideBoxOptions] (val x: Self) extends AnyVal {
