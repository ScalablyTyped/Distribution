...
trait PlotVwapSonificationTracksMappingPanOptions extends StObject {
...
object PlotVwapSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotVwapSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVwapSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
