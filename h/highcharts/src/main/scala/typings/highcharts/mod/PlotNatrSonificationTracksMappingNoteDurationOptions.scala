...
trait PlotNatrSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotNatrSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
