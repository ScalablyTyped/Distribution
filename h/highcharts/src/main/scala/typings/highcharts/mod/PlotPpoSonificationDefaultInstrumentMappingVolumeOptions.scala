...
trait PlotPpoSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotPpoSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotPpoSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
