...
trait PlotAtrSonificationTracksActiveWhenOptions extends StObject {
...
object PlotAtrSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotAtrSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
