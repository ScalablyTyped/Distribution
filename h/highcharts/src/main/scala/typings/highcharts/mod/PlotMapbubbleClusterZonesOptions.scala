...
trait PlotMapbubbleClusterZonesOptions extends StObject {
...
object PlotMapbubbleClusterZonesOptions {
  
  inline def apply(): PlotMapbubbleClusterZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleClusterZonesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleClusterZonesOptions] (val x: Self) extends AnyVal {
