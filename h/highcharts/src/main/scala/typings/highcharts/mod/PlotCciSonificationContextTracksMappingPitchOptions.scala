...
trait PlotCciSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotCciSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotCciSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
