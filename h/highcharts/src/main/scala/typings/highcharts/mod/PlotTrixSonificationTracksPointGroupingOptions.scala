...
trait PlotTrixSonificationTracksPointGroupingOptions extends StObject {
...
object PlotTrixSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotTrixSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
