...
trait PlotPictorialSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotPictorialSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
