...
trait PlotWordcloudSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotWordcloudSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
