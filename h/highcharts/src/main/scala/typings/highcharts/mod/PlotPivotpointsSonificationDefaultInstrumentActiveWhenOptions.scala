...
trait PlotPivotpointsSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
