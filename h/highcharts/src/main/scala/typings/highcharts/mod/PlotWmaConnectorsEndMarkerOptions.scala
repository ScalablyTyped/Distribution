...
trait PlotWmaConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotWmaConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWmaConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWmaConnectorsEndMarkerOptions]
  }
}
