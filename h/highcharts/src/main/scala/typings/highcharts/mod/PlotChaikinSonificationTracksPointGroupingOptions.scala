...
trait PlotChaikinSonificationTracksPointGroupingOptions extends StObject {
...
object PlotChaikinSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotChaikinSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotChaikinSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
