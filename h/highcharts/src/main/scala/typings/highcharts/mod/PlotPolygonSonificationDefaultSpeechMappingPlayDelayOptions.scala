...
trait PlotPolygonSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotPolygonSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
