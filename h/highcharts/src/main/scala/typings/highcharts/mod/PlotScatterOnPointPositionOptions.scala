...
trait PlotScatterOnPointPositionOptions extends StObject {
...
object PlotScatterOnPointPositionOptions {
  
  inline def apply(): PlotScatterOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatterOnPointPositionOptions] (val x: Self) extends AnyVal {
