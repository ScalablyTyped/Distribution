...
trait PlotFlagsSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
