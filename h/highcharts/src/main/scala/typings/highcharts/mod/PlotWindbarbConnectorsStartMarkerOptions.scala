...
trait PlotWindbarbConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotWindbarbConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWindbarbConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWindbarbConnectorsStartMarkerOptions]
  }
}
