...
trait PlotDisparityindexSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
