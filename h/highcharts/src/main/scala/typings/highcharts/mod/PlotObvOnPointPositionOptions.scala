...
trait PlotObvOnPointPositionOptions extends StObject {
...
object PlotObvOnPointPositionOptions {
  
  inline def apply(): PlotObvOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotObvOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotObvOnPointPositionOptions] (val x: Self) extends AnyVal {
