...
trait PlotSeriesSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
