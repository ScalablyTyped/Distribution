...
trait PlotLollipopSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
