...
trait PlotGanttSonificationContextTracksPointGroupingOptions extends StObject {
  
  /**
    * (Gantt) The grouping algorithm, deciding which points to keep when
  ...
  /**
    * (Gantt) Whether or not to group points
    */
  var enabled: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Gantt) The size of each group in milliseconds. Audio events closer than
    * this are grouped together.
    */
  var groupTimespan: js.UndefOr[Double] = js.undefined
  
  /**
    * (Gantt) The data property for each point to compare when deciding which
...
object PlotGanttSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
