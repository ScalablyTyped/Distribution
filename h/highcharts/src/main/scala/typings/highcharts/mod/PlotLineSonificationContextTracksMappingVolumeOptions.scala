...
trait PlotLineSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotLineSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotLineSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
