...
trait PlotSmaSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotSmaSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
