...
trait PlotSplineSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotSplineSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotSplineSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
