...
trait PlotBellcurveSonificationPointGroupingOptions extends StObject {
...
object PlotBellcurveSonificationPointGroupingOptions {
  
  inline def apply(): PlotBellcurveSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBellcurveSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
