...
object StockToolsGuiDefinitionsVerticalLabelsVerticalLabelOptions {
  ...
  @scala.inline
  implicit class StockToolsGuiDefinitionsVerticalLabelsVerticalLabelOptionsOps[Self <: StockToolsGuiDefinitionsVerticalLabelsVerticalLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
