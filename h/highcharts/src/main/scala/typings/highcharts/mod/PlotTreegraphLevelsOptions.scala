...
trait PlotTreegraphLevelsOptions extends StObject {
  ...
  /**
    ...
    * charts.
    */
  var colorVariation: js.UndefOr[PlotTreegraphLevelsColorVariationOptions] = js.undefined
  ...
  var dataLabels: js.UndefOr[
    PlotTreegraphLevelsDataLabelsOptions | js.Array[PlotTreegraphLevelsDataLabelsOptions]
  ] = js.undefined
...
object PlotTreegraphLevelsOptions {
  
  inline def apply(): PlotTreegraphLevelsOptions = {
  ...
  implicit open class MutableBuilder[Self <: PlotTreegraphLevelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setColorVariation(value: PlotTreegraphLevelsColorVariationOptions): Self = StObject.set(x, "colorVariation", value.asInstanceOf[js.Any])
    
    inline def setColorVariationUndefined: Self = StObject.set(x, "colorVariation", js.undefined)
    
    inline def setDataLabels(value: PlotTreegraphLevelsDataLabelsOptions | js.Array[PlotTreegraphLevelsDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotTreegraphLevelsDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
