...
trait PlotHeatmapSonificationTracksMappingPitchOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
