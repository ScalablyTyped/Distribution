...
trait YAxisCrosshairLabelOptions extends js.Object {
  /**
...
object YAxisCrosshairLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[YAxisCrosshairLabelOptions]
  }
}
