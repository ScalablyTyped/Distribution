...
trait PlotFunnelSonificationTracksActiveWhenOptions extends StObject {
...
object PlotFunnelSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotFunnelSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
