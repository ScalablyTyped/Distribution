...
trait PlotPieSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotPieSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotPieSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
