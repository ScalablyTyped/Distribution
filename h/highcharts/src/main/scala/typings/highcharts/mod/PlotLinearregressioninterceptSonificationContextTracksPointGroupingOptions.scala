...
trait PlotLinearregressioninterceptSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
