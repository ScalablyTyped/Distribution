...
trait PlotArcdiagramSonificationTracksMappingPitchOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
