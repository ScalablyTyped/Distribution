...
trait PlotBubbleSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
