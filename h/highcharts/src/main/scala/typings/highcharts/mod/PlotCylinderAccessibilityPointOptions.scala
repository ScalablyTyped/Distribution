...
trait PlotCylinderAccessibilityPointOptions extends StObject {
...
object PlotCylinderAccessibilityPointOptions {
  
  inline def apply(): PlotCylinderAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderAccessibilityPointOptions] (val x: Self) extends AnyVal {
