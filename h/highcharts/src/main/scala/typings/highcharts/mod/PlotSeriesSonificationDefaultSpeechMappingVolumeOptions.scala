...
trait PlotSeriesSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotSeriesSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
