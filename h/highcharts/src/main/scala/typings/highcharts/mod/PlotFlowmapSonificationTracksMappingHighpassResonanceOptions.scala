...
trait PlotFlowmapSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
