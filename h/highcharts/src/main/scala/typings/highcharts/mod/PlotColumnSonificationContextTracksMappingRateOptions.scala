...
trait PlotColumnSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
