...
trait PlotAreaSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotAreaSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotAreaSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
