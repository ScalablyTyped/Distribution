...
trait PlotDisparityindexSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
