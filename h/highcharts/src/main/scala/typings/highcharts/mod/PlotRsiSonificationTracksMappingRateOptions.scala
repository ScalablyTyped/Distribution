...
trait PlotRsiSonificationTracksMappingRateOptions extends StObject {
...
object PlotRsiSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
