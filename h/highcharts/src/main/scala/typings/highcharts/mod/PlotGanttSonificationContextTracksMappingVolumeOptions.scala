...
trait PlotGanttSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotGanttSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
