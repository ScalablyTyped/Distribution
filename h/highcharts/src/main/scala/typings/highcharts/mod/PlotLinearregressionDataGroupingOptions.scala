...
trait PlotLinearregressionDataGroupingOptions extends js.Object {
  /**
...
object PlotLinearregressionDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionDataGroupingOptions]
  }
}
