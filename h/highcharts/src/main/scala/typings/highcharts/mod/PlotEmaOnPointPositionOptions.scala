...
trait PlotEmaOnPointPositionOptions extends StObject {
...
object PlotEmaOnPointPositionOptions {
  
  inline def apply(): PlotEmaOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaOnPointPositionOptions] (val x: Self) extends AnyVal {
