...
trait PlotVbpSonificationTracksMappingTimeOptions extends StObject {
...
object PlotVbpSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotVbpSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVbpSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
