...
trait PlotHeatmapDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotHeatmapDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotHeatmapDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapDragDropDragHandleOptions]
  }
}
