...
trait PlotBbSonificationTracksMappingRateOptions extends StObject {
...
object PlotBbSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotBbSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBbSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
