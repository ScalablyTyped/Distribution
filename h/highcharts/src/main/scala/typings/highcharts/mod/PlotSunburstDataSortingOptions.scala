...
trait PlotSunburstDataSortingOptions extends StObject {
...
object PlotSunburstDataSortingOptions {
  
  inline def apply(): PlotSunburstDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstDataSortingOptions] (val x: Self) extends AnyVal {
