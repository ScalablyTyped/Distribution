...
trait PlotColumnSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotColumnSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotColumnSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
