...
trait PlotAreasplineConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotAreasplineConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplineConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineConnectorsStartMarkerOptions]
  }
}
