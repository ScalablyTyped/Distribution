...
trait PlotNetworkgraphSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
