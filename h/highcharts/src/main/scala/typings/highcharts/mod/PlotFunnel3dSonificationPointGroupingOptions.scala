...
trait PlotFunnel3dSonificationPointGroupingOptions extends StObject {
...
object PlotFunnel3dSonificationPointGroupingOptions {
  
  inline def apply(): PlotFunnel3dSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
