...
trait PlotHeatmapSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotHeatmapSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
