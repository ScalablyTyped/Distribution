...
trait PlotAroonoscillatorSonificationDefaultInstrumentMappingTremoloDepthOptions extends StObject {
...
object PlotAroonoscillatorSonificationDefaultInstrumentMappingTremoloDepthOptions {
  
  inline def apply(): PlotAroonoscillatorSonificationDefaultInstrumentMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorSonificationDefaultInstrumentMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonoscillatorSonificationDefaultInstrumentMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
