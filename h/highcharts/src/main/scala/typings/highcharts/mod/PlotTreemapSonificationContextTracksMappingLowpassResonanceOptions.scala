...
trait PlotTreemapSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotTreemapSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
