...
trait PlotVwapConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotVwapConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVwapConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVwapConnectorsEndMarkerOptions]
  }
}
