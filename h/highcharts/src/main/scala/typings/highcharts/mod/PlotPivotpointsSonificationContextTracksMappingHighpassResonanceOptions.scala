...
trait PlotPivotpointsSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
