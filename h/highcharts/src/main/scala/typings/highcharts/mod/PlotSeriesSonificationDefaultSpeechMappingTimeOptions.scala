...
trait PlotSeriesSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotSeriesSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
