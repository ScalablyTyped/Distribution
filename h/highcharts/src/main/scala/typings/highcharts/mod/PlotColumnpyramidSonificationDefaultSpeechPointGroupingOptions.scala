...
trait PlotColumnpyramidSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
