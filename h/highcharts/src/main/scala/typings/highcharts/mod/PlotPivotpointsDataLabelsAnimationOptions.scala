...
@js.native
trait PlotPivotpointsDataLabelsAnimationOptions extends js.Object {
...
object PlotPivotpointsDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotPivotpointsDataLabelsAnimationOptionsOps[Self <: PlotPivotpointsDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
