...
trait PlotItemSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotItemSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
