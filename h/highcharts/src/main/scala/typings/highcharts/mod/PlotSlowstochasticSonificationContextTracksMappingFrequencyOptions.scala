...
trait PlotSlowstochasticSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
