...
trait PlotCandlestickSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
