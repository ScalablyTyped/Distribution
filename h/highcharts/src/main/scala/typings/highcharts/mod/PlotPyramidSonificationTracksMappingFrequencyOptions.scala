...
trait PlotPyramidSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
