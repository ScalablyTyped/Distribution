...
trait PlotStreamgraphSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
