...
trait PlotLinearregressioninterceptSonificationContextTracksOptions extends StObject {
  ...
  var activeWhen: js.UndefOr[
    js.Object | js.Function | PlotLinearregressioninterceptSonificationContextTracksActiveWhenOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[PlotLinearregressioninterceptSonificationContextTracksMappingOptions] = js.undefined
  ...
  /**
    ...
    * tracks.
    */
  var pointGrouping: js.UndefOr[PlotLinearregressioninterceptSonificationContextTracksPointGroupingOptions] = js.undefined
...
object PlotLinearregressioninterceptSonificationContextTracksOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationContextTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationContextTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationContextTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(
      value: js.Object | js.Function | PlotLinearregressioninterceptSonificationContextTracksActiveWhenOptions
    ...
    inline def setMapping(value: PlotLinearregressioninterceptSonificationContextTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotLinearregressioninterceptSonificationContextTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
