...
trait PlotAroonDataGroupingOptions extends js.Object {
  /**
...
object PlotAroonDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotAroonDataGroupingOptions]
  }
}
