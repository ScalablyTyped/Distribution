...
trait PlotArcdiagramSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
