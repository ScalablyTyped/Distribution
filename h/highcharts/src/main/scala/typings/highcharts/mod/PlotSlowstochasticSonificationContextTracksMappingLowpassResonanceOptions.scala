...
trait PlotSlowstochasticSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
