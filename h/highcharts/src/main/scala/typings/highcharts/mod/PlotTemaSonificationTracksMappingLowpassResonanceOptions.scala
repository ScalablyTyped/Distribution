...
trait PlotTemaSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotTemaSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
