...
trait PlotAreaSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotAreaSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotAreaSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
