...
trait PlotCandlestickSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
