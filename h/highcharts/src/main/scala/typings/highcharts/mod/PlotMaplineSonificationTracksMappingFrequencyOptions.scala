...
trait PlotMaplineSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotMaplineSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotMaplineSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
