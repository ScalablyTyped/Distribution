...
trait PlotVariablepieSonificationTracksPointGroupingOptions extends StObject {
...
object PlotVariablepieSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotVariablepieSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
