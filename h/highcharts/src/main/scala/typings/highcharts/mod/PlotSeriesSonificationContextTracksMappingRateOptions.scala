...
trait PlotSeriesSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
