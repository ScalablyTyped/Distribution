...
trait PlotDependencywheelSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
