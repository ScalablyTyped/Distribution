...
trait PlotPolygonOnPointPositionOptions extends StObject {
...
object PlotPolygonOnPointPositionOptions {
  
  inline def apply(): PlotPolygonOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonOnPointPositionOptions] (val x: Self) extends AnyVal {
