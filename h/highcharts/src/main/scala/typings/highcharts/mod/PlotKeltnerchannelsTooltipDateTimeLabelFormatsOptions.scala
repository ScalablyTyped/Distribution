...
trait PlotKeltnerchannelsTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotKeltnerchannelsTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotKeltnerchannelsTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsTooltipDateTimeLabelFormatsOptions]
  }
}
