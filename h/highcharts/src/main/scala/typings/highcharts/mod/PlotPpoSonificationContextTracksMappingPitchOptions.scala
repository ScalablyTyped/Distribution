...
trait PlotPpoSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotPpoSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotPpoSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
