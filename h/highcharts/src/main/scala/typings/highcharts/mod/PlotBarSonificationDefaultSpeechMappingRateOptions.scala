...
trait PlotBarSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotBarSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotBarSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
