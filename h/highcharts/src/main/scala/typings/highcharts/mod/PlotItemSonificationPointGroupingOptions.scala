...
trait PlotItemSonificationPointGroupingOptions extends StObject {
...
object PlotItemSonificationPointGroupingOptions {
  
  inline def apply(): PlotItemSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
