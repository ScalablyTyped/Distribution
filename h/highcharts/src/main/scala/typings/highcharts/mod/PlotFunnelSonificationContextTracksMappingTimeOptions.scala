...
trait PlotFunnelSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotFunnelSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
