...
trait PlotTilemapDataSortingOptions extends StObject {
...
object PlotTilemapDataSortingOptions {
  
  inline def apply(): PlotTilemapDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTilemapDataSortingOptions] (val x: Self) extends AnyVal {
