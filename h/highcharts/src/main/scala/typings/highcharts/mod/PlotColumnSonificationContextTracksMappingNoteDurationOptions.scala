...
trait PlotColumnSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
