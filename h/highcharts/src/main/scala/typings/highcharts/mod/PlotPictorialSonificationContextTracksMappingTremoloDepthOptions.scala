...
trait PlotPictorialSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPictorialSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
