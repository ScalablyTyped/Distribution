...
trait PlotParetoSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotParetoSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
