...
trait PlotWordcloudSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotWordcloudSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
