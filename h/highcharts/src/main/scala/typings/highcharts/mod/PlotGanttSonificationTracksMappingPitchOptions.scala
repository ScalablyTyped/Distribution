...
trait PlotGanttSonificationTracksMappingPitchOptions extends StObject {
...
object PlotGanttSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
