...
trait PlotBubbleSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotBubbleSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotBubbleSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
