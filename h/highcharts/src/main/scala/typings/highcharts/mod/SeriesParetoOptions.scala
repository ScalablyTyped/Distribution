...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesParetoOptions extends PlotParetoOptions {
  /**
...
object SeriesParetoOptions {
  ...
  def apply(
    ...
    data: js.Array[(js.Array[Double | String]) | PointOptionsObject] = null,
