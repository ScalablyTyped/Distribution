...
trait PlotNetworkgraphSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
