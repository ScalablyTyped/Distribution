...
trait PlotItemSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotItemSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotItemSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
