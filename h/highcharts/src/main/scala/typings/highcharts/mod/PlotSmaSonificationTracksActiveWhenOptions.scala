...
trait PlotSmaSonificationTracksActiveWhenOptions extends StObject {
...
object PlotSmaSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotSmaSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
