...
trait PlotWordcloudSonificationTracksMappingPitchOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
