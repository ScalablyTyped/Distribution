...
trait PlotScatterSonificationTracksPointGroupingOptions extends StObject {
...
object PlotScatterSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotScatterSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatterSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
