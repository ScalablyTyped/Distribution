...
trait PlotTreemapSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
