...
trait PlotAbandsSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotAbandsSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
