...
trait PlotTrendlineSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
