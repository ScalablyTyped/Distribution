...
trait PlotAbandsSonificationTracksActiveWhenOptions extends StObject {
...
object PlotAbandsSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotAbandsSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
