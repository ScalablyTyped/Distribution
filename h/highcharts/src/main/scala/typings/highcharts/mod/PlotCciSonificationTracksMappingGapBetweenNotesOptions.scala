...
trait PlotCciSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotCciSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
