...
trait PlotDependencywheelSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotDependencywheelSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
