...
trait PlotAbandsSonificationTracksMappingPitchOptions extends StObject {
...
object PlotAbandsSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotAbandsSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
