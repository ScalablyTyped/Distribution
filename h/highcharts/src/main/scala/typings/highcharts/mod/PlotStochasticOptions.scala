...
trait PlotStochasticOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotStochasticSonificationOptions] = js.undefined
...
object PlotStochasticOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotStochasticSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
