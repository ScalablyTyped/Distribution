...
trait PlotSlowstochasticSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
