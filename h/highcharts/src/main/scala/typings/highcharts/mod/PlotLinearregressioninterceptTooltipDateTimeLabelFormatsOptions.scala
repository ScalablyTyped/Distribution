...
trait PlotLinearregressioninterceptTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotLinearregressioninterceptTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotLinearregressioninterceptTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptTooltipDateTimeLabelFormatsOptions]
  }
}
