...
trait PlotPpoSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPpoSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPpoSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
