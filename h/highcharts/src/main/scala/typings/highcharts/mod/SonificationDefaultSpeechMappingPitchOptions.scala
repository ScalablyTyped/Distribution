...
trait SonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object SonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): SonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
