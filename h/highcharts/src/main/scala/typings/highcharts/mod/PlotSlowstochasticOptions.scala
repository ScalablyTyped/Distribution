...
trait PlotSlowstochasticOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotSlowstochasticSonificationOptions] = js.undefined
...
object PlotSlowstochasticOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotSlowstochasticOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotSlowstochasticSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
