...
trait PlotPpoSonificationPointGroupingOptions extends StObject {
...
object PlotPpoSonificationPointGroupingOptions {
  
  inline def apply(): PlotPpoSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
