...
trait PlotDumbbellSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
