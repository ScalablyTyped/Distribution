...
trait PlotPsarSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotPsarSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotPsarSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
