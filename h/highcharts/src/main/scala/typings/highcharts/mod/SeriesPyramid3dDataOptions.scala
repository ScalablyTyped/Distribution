...
trait SeriesPyramid3dDataOptions extends js.Object {
  var accessibility: js.UndefOr[SeriesPyramid3dDataAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[SeriesPyramid3dDataDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[SeriesPyramid3dDataEventsOptions] = js.undefined
  /**
...
object SeriesPyramid3dDataOptions {
  @scala.inline
  def apply(
    accessibility: SeriesPyramid3dDataAccessibilityOptions = null,
    ...
    dragDrop: SeriesPyramid3dDataDragDropOptions = null,
    drilldown: String = null,
    events: SeriesPyramid3dDataEventsOptions = null,
    ...
    __obj.asInstanceOf[SeriesPyramid3dDataOptions]
  }
}
