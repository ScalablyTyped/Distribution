...
trait PlotBarSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotBarSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotBarSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
