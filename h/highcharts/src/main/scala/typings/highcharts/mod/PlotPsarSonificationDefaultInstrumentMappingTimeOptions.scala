...
trait PlotPsarSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotPsarSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotPsarSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
