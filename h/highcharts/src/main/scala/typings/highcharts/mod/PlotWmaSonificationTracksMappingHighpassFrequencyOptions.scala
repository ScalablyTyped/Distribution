...
trait PlotWmaSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotWmaSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
