...
trait PlotMapbubbleAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMapbubbleAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotMapbubbleAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotMapbubbleAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotMapbubbleAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleAccessibilityOptions]
  }
}
