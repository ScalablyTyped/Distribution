...
trait PlotStochasticSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotStochasticSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
