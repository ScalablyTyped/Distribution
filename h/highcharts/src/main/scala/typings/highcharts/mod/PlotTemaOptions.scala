...
trait PlotTemaOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotTemaSonificationOptions] = js.undefined
...
object PlotTemaOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotTemaSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
