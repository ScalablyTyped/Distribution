...
@js.native
trait PlotSlowstochasticAnimationOptions extends js.Object {
...
object PlotSlowstochasticAnimationOptions {
  ...
  @scala.inline
  implicit class PlotSlowstochasticAnimationOptionsOps[Self <: PlotSlowstochasticAnimationOptions] (val x: Self) extends AnyVal {
