...
trait PlotAoSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotAoSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
