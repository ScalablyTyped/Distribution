...
@js.native
trait NavigatorXAxisPlotBandsOptions extends js.Object {
...
object NavigatorXAxisPlotBandsOptions {
  ...
  @scala.inline
  implicit class NavigatorXAxisPlotBandsOptionsOps[Self <: NavigatorXAxisPlotBandsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: NavigatorXAxisPlotBandsEventsOptions): Self = this.set("events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: NavigatorXAxisPlotBandsLabelOptions): Self = this.set("label", value.asInstanceOf[js.Any])
