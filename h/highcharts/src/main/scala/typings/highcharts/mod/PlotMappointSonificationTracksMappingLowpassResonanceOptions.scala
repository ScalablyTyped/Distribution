...
trait PlotMappointSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotMappointSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
