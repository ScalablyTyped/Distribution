...
trait PlotXrangeSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotXrangeSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
