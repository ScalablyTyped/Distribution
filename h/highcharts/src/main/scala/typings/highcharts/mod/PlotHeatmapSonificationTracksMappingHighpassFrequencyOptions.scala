...
trait PlotHeatmapSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
