...
trait PlotOhlcPointEventsOptions extends js.Object {
  /**
...
object PlotOhlcPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotOhlcPointEventsOptions]
  }
}
