...
trait SeriesPackedbubbleDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesPackedbubbleDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesPackedbubbleDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesPackedbubbleDataDragDropDragHandleOptions]
  }
}
