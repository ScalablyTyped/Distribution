...
trait PlotDmiSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
