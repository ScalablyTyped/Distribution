...
trait PlotAtrSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
