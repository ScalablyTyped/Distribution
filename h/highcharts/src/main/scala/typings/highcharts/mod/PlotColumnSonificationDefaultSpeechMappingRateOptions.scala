...
trait PlotColumnSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotColumnSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotColumnSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
