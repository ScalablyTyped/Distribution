...
trait PlotFlagsSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
