...
trait PlotPivotpointsSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
