...
trait PlotColumnpyramidSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
