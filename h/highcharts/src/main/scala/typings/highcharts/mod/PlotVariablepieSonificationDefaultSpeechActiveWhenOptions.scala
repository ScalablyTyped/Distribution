...
trait PlotVariablepieSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotVariablepieSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
