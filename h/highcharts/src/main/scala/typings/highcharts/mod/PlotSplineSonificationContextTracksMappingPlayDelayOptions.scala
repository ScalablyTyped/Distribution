...
trait PlotSplineSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
