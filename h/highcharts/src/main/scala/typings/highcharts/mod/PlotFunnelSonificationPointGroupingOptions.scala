...
trait PlotFunnelSonificationPointGroupingOptions extends StObject {
...
object PlotFunnelSonificationPointGroupingOptions {
  
  inline def apply(): PlotFunnelSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
