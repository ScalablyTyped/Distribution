...
trait PlotCandlestickSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotCandlestickSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
