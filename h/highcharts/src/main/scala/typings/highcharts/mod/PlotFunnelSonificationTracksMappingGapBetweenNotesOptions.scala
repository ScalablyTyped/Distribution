...
trait PlotFunnelSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
