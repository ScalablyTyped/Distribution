...
trait PlotWordcloudSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
