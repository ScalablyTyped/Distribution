...
trait PlotArcdiagramSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
