...
trait PlotPsarSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotPsarSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotPsarSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
