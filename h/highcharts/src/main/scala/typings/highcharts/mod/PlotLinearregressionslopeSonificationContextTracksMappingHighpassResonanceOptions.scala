...
trait PlotLinearregressionslopeSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotLinearregressionslopeSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
