...
trait PlotPyramidSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
