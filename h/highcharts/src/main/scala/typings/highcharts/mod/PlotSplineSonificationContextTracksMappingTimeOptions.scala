...
trait PlotSplineSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
