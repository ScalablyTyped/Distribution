...
trait PlotDependencywheelSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
