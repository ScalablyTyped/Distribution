...
trait PlotMomentumSonificationTracksPointGroupingOptions extends StObject {
...
object PlotMomentumSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotMomentumSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMomentumSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
