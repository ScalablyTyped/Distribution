...
trait PlotGeoheatmapOptions extends StObject {
  ...
  /**
    ...
    */
  var borderWidth: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotGeoheatmapDataLabelsOptions | js.Array[PlotGeoheatmapDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotGeoheatmapDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotGeoheatmapJitterOptions] = js.undefined
  ...
  /**
    ...
    */
  var nullColor: js.UndefOr[String] = js.undefined
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotGeoheatmapSonificationOptions] = js.undefined
...
object PlotGeoheatmapOptions {
  
  inline def apply(): PlotGeoheatmapOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataLabels(value: PlotGeoheatmapDataLabelsOptions | js.Array[PlotGeoheatmapDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotGeoheatmapDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotGeoheatmapDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setJitter(value: PlotGeoheatmapJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
    ...
    inline def setNullColor(value: String): Self = StObject.set(x, "nullColor", value.asInstanceOf[js.Any])
    ...
    inline def setSonification(value: PlotGeoheatmapSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
