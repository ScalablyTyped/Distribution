...
trait PlotArcdiagramSonificationTracksMappingPanOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
