...
trait PlotGanttSonificationTracksPointGroupingOptions extends StObject {
...
object PlotGanttSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotGanttSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
