...
trait PlotStochasticSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotStochasticSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
