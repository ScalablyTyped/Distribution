...
trait PlotFunnelSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
