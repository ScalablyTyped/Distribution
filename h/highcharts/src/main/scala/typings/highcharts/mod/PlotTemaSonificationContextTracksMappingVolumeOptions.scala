...
trait PlotTemaSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
