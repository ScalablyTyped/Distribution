...
trait PlotLinearregressionangleSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
