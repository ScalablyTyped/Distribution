...
trait PlotLinearregressionslopeSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotLinearregressionslopeSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
