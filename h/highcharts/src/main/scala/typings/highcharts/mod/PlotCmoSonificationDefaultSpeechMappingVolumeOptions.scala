...
trait PlotCmoSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotCmoSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotCmoSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
