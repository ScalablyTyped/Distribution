...
trait PlotTreemapSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
