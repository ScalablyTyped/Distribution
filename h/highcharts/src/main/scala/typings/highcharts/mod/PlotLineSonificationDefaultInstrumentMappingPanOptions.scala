...
trait PlotLineSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotLineSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotLineSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
