...
trait PlotPivotpointsConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPivotpointsConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPivotpointsConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPivotpointsConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotPivotpointsConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotPivotpointsConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotPivotpointsConnectorsMarkerOptions = null,
    startMarker: PlotPivotpointsConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotPivotpointsConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsConnectorsOptions]
  }
}
