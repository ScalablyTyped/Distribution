...
trait PlotParetoSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotParetoSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotParetoSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
