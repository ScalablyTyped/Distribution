...
trait PlotTreegraphClusterLayoutAlgorithmOptions extends StObject {
...
object PlotTreegraphClusterLayoutAlgorithmOptions {
  
  inline def apply(): PlotTreegraphClusterLayoutAlgorithmOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphClusterLayoutAlgorithmOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphClusterLayoutAlgorithmOptions] (val x: Self) extends AnyVal {
