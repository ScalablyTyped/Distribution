...
trait PlotTreemapSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
