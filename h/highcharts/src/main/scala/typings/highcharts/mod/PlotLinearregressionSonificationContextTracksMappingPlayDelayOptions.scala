...
trait PlotLinearregressionSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
