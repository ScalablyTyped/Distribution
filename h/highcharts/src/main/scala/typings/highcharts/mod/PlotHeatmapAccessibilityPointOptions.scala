...
trait PlotHeatmapAccessibilityPointOptions extends StObject {
...
object PlotHeatmapAccessibilityPointOptions {
  
  inline def apply(): PlotHeatmapAccessibilityPointOptions = {
