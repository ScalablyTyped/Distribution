...
trait PlotParetoSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotParetoSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotParetoSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
