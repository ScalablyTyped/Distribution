...
trait PlotPyramidSonificationTracksOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotPyramidSonificationTracksActiveWhenOptions] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[PlotPyramidSonificationTracksMappingOptions] = js.undefined
  ...
  /**
    ...
    * tracks.
    */
  var pointGrouping: js.UndefOr[PlotPyramidSonificationTracksPointGroupingOptions] = js.undefined
...
object PlotPyramidSonificationTracksOptions {
  
  inline def apply(): PlotPyramidSonificationTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotPyramidSonificationTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotPyramidSonificationTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotPyramidSonificationTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
