...
trait SeriesScatterDataMarkerStatesSelectOptions extends js.Object {
  /**
...
object SeriesScatterDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesScatterDataMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[SeriesScatterDataMarkerStatesSelectOptions]
  }
}
