...
trait PlotArcdiagramSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
