...
trait PlotTimelineSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
