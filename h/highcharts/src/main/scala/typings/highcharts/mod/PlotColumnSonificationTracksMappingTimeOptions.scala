...
trait PlotColumnSonificationTracksMappingTimeOptions extends StObject {
...
object PlotColumnSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
