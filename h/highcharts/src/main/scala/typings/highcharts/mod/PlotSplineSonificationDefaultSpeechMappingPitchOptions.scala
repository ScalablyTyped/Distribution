...
trait PlotSplineSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotSplineSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotSplineSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
