...
trait PlotAbandsSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotAbandsSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
