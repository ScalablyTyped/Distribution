...
trait PlotArearangeSonificationTracksMappingPanOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
