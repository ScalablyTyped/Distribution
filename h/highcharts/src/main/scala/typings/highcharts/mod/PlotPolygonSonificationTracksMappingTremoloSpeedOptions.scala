...
trait PlotPolygonSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
