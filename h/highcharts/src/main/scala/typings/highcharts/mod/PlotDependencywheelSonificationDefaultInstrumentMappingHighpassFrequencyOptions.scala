...
trait PlotDependencywheelSonificationDefaultInstrumentMappingHighpassFrequencyOptions extends StObject {
  
  /**
    * (Highcharts) How to perform the mapping.
    */
  var mapFunction: js.UndefOr[OptionsMapFunctionValue] = js.undefined
  
  /**
    * (Highcharts) A point property to map the mapping parameter to.
    *
  ...
  /**
    * (Highcharts) The maximum value for the audio parameter. This is the
    * highest value the audio parameter will be mapped to.
    */
  var max: js.UndefOr[Double] = js.undefined
  
  /**
    * (Highcharts) The minimum value for the audio parameter. This is the
    * lowest value the audio parameter will be mapped to.
    */
  var min: js.UndefOr[Double] = js.undefined
  
  /**
    * (Highcharts) A fixed value to use for the prop when mapping.
    *
  ...
  /**
    * (Highcharts) What data values to map the parameter within.
    *
...
object PlotDependencywheelSonificationDefaultInstrumentMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultInstrumentMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultInstrumentMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultInstrumentMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
