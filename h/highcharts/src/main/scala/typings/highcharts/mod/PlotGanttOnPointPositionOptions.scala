...
trait PlotGanttOnPointPositionOptions extends StObject {
...
object PlotGanttOnPointPositionOptions {
  
  inline def apply(): PlotGanttOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttOnPointPositionOptions] (val x: Self) extends AnyVal {
