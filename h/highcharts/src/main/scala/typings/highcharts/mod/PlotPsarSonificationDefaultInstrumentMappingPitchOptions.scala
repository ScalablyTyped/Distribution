...
trait PlotPsarSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotPsarSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotPsarSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
