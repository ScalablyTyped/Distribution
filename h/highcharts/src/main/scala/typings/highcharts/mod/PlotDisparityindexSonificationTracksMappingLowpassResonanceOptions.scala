...
trait PlotDisparityindexSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
