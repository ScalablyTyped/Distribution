...
trait PlotFlagsSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotFlagsSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
