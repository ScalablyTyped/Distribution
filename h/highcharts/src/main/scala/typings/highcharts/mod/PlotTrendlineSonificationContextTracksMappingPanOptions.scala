...
trait PlotTrendlineSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
