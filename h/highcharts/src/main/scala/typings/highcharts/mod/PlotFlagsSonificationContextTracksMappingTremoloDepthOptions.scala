...
trait PlotFlagsSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
