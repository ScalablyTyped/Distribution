...
trait PlotPsarSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotPsarSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
