...
trait PlotHeatmapSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
