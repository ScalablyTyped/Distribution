...
trait PlotMappointSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotMappointSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
