...
@js.native
trait PlotPriceenvelopesDataLabelsOptions extends js.Object {
...
object PlotPriceenvelopesDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotPriceenvelopesDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotPriceenvelopesDataLabelsOptionsOps[Self <: PlotPriceenvelopesDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPriceenvelopesDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
