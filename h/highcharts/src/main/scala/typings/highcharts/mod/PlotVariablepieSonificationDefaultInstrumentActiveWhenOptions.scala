...
trait PlotVariablepieSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotVariablepieSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
