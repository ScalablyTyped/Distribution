...
trait PlotPcSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotPcSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotPcSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
