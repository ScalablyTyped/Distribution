...
trait PlotItemSonificationTracksPointGroupingOptions extends StObject {
...
object PlotItemSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotItemSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
