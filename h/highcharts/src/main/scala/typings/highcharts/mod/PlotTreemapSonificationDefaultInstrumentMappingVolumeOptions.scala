...
trait PlotTreemapSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotTreemapSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
