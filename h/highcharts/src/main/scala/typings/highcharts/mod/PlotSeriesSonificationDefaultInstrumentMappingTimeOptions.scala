...
trait PlotSeriesSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotSeriesSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
