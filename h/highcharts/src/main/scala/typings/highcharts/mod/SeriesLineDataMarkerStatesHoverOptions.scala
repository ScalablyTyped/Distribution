...
trait SeriesLineDataMarkerStatesHoverOptions extends js.Object {
  /**
...
object SeriesLineDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesLineDataMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[SeriesLineDataMarkerStatesHoverOptions]
  }
}
