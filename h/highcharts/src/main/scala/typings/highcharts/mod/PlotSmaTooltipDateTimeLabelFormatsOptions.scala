...
trait PlotSmaTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotSmaTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotSmaTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotSmaTooltipDateTimeLabelFormatsOptions]
  }
}
