...
@js.native
trait PlotLinearregressioninterceptDataLabelsAnimationOptions extends js.Object {
...
object PlotLinearregressioninterceptDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressioninterceptDataLabelsAnimationOptionsOps[Self <: PlotLinearregressioninterceptDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
