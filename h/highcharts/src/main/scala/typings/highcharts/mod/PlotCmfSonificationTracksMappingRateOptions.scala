...
trait PlotCmfSonificationTracksMappingRateOptions extends StObject {
...
object PlotCmfSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotCmfSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmfSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
