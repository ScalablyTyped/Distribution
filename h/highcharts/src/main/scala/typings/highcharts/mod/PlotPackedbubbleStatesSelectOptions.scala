...
trait PlotPackedbubbleStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotPackedbubbleStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPackedbubbleStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotPackedbubbleStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotPackedbubbleStatesSelectAnimationOptions = null,
  ...
  ): PlotPackedbubbleStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleStatesSelectOptions]
  }
}
