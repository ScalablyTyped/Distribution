...
trait PlotScatter3dMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotScatter3dMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatter3dMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dMarkerStatesHoverOptions]
  }
}
