...
trait PlotAoSonificationTracksPointGroupingOptions extends StObject {
...
object PlotAoSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotAoSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
