...
trait PlotAroonSonificationPointGroupingOptions extends StObject {
...
object PlotAroonSonificationPointGroupingOptions {
  
  inline def apply(): PlotAroonSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
