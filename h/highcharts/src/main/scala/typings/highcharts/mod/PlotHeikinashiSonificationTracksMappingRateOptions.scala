...
trait PlotHeikinashiSonificationTracksMappingRateOptions extends StObject {
...
object PlotHeikinashiSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotHeikinashiSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeikinashiSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeikinashiSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
