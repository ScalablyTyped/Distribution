...
trait PlotFunnelSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotFunnelSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
