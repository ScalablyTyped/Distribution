...
trait PlotHistogramSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotHistogramSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
