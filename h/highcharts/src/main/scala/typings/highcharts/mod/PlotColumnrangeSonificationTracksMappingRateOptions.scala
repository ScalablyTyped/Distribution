...
trait PlotColumnrangeSonificationTracksMappingRateOptions extends StObject {
...
object PlotColumnrangeSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotColumnrangeSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
