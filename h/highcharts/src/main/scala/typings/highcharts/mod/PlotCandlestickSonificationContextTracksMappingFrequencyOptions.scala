...
trait PlotCandlestickSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
