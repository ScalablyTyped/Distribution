...
trait PlotMappointSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotMappointSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
