...
trait PlotTrendlineSonificationTracksPointGroupingOptions extends StObject {
...
object PlotTrendlineSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
