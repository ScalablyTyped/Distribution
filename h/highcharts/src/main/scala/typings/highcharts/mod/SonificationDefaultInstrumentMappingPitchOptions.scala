...
trait SonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object SonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): SonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
