...
trait PlotParetoSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotParetoSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
