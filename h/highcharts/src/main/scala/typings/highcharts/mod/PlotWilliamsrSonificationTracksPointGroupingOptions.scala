...
trait PlotWilliamsrSonificationTracksPointGroupingOptions extends StObject {
...
object PlotWilliamsrSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotWilliamsrSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWilliamsrSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
