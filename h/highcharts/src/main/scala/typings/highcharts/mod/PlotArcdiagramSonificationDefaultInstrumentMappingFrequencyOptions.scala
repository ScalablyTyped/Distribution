...
trait PlotArcdiagramSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
