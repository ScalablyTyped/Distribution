...
trait PlotEmaSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotEmaSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotEmaSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
