...
trait PlotPictorialSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotPictorialSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
