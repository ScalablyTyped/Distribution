...
trait PlotVwapSonificationTracksActiveWhenOptions extends StObject {
...
object PlotVwapSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotVwapSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVwapSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
