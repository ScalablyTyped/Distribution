...
trait PlotPolygonSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
