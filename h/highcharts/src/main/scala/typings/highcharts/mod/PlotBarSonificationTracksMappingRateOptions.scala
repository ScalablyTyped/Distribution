...
trait PlotBarSonificationTracksMappingRateOptions extends StObject {
...
object PlotBarSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
