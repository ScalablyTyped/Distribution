...
trait PlotVbpConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotVbpConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVbpConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotVbpConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotVbpConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotVbpConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotVbpConnectorsMarkerOptions = null,
    startMarker: PlotVbpConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotVbpConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotVbpConnectorsOptions]
  }
}
