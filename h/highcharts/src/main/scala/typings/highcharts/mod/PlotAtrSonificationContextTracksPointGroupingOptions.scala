...
trait PlotAtrSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotAtrSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
