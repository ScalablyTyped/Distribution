...
trait PlotIkhSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotIkhSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
