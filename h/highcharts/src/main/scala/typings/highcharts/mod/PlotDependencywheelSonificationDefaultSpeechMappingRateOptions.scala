...
trait PlotDependencywheelSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotDependencywheelSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
