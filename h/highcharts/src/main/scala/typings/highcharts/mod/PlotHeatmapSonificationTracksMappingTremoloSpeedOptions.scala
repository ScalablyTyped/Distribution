...
trait PlotHeatmapSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
