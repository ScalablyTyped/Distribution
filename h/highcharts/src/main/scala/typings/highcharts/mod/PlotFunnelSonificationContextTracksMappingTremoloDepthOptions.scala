...
trait PlotFunnelSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotFunnelSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
