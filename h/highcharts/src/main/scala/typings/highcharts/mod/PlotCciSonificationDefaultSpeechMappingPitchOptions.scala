...
trait PlotCciSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotCciSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotCciSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
