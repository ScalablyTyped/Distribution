...
trait PlotSplineSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
