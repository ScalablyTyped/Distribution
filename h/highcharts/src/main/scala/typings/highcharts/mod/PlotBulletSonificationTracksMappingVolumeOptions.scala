...
trait PlotBulletSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotBulletSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
