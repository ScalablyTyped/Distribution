...
trait PlotTreemapSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotTreemapSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
