...
trait PlotNetworkgraphSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
