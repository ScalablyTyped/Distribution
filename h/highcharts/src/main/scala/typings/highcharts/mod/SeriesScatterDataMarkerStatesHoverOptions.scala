...
trait SeriesScatterDataMarkerStatesHoverOptions extends js.Object {
  /**
...
object SeriesScatterDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesScatterDataMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[SeriesScatterDataMarkerStatesHoverOptions]
  }
}
