...
trait PlotRsiOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotRsiSonificationOptions] = js.undefined
...
object PlotRsiOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotRsiSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
