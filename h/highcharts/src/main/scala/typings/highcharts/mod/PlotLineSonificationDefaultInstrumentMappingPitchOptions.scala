...
trait PlotLineSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotLineSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotLineSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
