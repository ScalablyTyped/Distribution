...
trait PlotColumnrangeAccessibilityPointOptions extends StObject {
...
object PlotColumnrangeAccessibilityPointOptions {
  
  inline def apply(): PlotColumnrangeAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeAccessibilityPointOptions] (val x: Self) extends AnyVal {
