...
trait PlotWmaSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotWmaSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotWmaSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
