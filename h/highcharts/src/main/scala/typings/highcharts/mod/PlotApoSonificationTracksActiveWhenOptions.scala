...
trait PlotApoSonificationTracksActiveWhenOptions extends StObject {
...
object PlotApoSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotApoSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
