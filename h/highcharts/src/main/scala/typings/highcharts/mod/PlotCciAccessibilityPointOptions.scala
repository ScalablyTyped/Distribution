...
trait PlotCciAccessibilityPointOptions extends StObject {
...
object PlotCciAccessibilityPointOptions {
  
  inline def apply(): PlotCciAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciAccessibilityPointOptions] (val x: Self) extends AnyVal {
