...
trait PlotCmoOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotCmoSonificationOptions] = js.undefined
...
object PlotCmoOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotCmoSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
