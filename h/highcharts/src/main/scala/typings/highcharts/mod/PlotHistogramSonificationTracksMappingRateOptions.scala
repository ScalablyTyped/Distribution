...
trait PlotHistogramSonificationTracksMappingRateOptions extends StObject {
...
object PlotHistogramSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotHistogramSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
