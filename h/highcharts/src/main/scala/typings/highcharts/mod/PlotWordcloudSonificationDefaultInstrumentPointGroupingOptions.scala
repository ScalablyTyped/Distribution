...
trait PlotWordcloudSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotWordcloudSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
