...
trait PlotBarSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotBarSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
