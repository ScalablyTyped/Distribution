...
trait PlotColumnpyramidSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
