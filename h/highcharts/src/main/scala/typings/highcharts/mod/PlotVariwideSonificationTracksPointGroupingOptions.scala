...
trait PlotVariwideSonificationTracksPointGroupingOptions extends StObject {
...
object PlotVariwideSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotVariwideSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
