...
trait PlotCmoSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotCmoSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
