...
trait PlotCylinderSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotCylinderSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
