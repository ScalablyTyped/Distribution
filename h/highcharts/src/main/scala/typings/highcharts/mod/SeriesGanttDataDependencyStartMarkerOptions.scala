...
trait SeriesGanttDataDependencyStartMarkerOptions extends js.Object {
  /**
...
object SeriesGanttDataDependencyStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesGanttDataDependencyStartMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesGanttDataDependencyStartMarkerOptions]
  }
}
