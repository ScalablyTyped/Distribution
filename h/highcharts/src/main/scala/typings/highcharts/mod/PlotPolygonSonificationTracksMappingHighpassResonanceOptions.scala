...
trait PlotPolygonSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
