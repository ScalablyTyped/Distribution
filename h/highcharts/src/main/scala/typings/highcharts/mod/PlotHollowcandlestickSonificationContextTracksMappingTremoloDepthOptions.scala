...
trait PlotHollowcandlestickSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotHollowcandlestickSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
