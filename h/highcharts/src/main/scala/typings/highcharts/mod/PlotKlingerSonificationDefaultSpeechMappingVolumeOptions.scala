...
trait PlotKlingerSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotKlingerSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
