...
trait PlotGanttDataSortingOptions extends StObject {
...
object PlotGanttDataSortingOptions {
  
  inline def apply(): PlotGanttDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttDataSortingOptions] (val x: Self) extends AnyVal {
