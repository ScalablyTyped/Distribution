...
trait PlotWindbarbSonificationTracksMappingPitchOptions extends StObject {
...
object PlotWindbarbSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotWindbarbSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
