...
trait PlotLinearregressionSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
