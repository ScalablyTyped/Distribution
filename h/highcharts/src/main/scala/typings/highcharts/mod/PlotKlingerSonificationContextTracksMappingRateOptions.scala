...
trait PlotKlingerSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotKlingerSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
