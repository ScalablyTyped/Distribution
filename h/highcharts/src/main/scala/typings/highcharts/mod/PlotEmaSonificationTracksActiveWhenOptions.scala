...
trait PlotEmaSonificationTracksActiveWhenOptions extends StObject {
...
object PlotEmaSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotEmaSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
