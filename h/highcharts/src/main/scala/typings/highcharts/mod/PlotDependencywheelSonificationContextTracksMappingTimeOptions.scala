...
trait PlotDependencywheelSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
