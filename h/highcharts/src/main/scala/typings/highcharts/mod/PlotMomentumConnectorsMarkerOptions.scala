...
trait PlotMomentumConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotMomentumConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMomentumConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumConnectorsMarkerOptions]
  }
}
