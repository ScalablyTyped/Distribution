...
trait PlotPcSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotPcSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotPcSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
