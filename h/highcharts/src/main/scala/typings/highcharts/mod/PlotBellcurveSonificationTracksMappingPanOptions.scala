...
trait PlotBellcurveSonificationTracksMappingPanOptions extends StObject {
...
object PlotBellcurveSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotBellcurveSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBellcurveSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
