...
trait PlotCandlestickConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotCandlestickConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotCandlestickConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotCandlestickConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotCandlestickConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotCandlestickConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotCandlestickConnectorsMarkerOptions = null,
    startMarker: PlotCandlestickConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotCandlestickConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotCandlestickConnectorsOptions]
  }
}
