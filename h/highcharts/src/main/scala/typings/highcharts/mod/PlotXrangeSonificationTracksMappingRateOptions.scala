...
trait PlotXrangeSonificationTracksMappingRateOptions extends StObject {
...
object PlotXrangeSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotXrangeSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
