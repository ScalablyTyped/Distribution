...
trait PlotSupertrendSonificationTracksActiveWhenOptions extends StObject {
...
object PlotSupertrendSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
