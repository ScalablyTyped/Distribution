...
trait PlotTreemapAccessibilityPointOptions extends StObject {
...
object PlotTreemapAccessibilityPointOptions {
  
  inline def apply(): PlotTreemapAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapAccessibilityPointOptions] (val x: Self) extends AnyVal {
