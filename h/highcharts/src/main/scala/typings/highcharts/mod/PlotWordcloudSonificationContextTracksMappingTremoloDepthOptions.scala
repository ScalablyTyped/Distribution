...
trait PlotWordcloudSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
