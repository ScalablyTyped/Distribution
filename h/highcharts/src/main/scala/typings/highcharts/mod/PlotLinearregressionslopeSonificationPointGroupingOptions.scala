...
trait PlotLinearregressionslopeSonificationPointGroupingOptions extends StObject {
...
object PlotLinearregressionslopeSonificationPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
