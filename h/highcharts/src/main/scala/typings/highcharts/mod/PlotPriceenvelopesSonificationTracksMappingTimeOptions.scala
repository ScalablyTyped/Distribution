...
trait PlotPriceenvelopesSonificationTracksMappingTimeOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
