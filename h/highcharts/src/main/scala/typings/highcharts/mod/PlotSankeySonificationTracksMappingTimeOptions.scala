...
trait PlotSankeySonificationTracksMappingTimeOptions extends StObject {
...
object PlotSankeySonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotSankeySonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeySonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeySonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
