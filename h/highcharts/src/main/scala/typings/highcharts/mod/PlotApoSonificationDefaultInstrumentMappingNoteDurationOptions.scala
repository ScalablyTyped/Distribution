...
trait PlotApoSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotApoSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotApoSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
