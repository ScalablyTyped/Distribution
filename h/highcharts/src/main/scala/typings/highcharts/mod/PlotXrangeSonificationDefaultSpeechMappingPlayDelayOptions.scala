...
trait PlotXrangeSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotXrangeSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
