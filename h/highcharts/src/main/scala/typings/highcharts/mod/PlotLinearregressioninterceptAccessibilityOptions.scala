...
trait PlotLinearregressioninterceptAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotLinearregressioninterceptAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotLinearregressioninterceptAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotLinearregressioninterceptAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotLinearregressioninterceptAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptAccessibilityOptions]
  }
}
