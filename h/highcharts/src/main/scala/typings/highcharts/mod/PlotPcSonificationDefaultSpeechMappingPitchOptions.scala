...
trait PlotPcSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotPcSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotPcSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
