...
trait PlotMapSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotMapSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
