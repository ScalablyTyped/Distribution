...
trait PlotWordcloudSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
