...
trait PlotPieStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotPieStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPieStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotPieStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotPieStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotPieStatesSelectOptions]
  }
}
