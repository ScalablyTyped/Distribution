...
trait PlotTrendlineSonificationTracksMappingRateOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
