...
import typings.highcharts.highchartsStrings.flowmap
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesFlowmapOptions
  extends StObject
     with PlotFlowmapOptions {
  
  /**
    * Not available
    */
  var affectsMapView: Unit
  ...
  /**
    ...
    * example)
    */
  var data: js.UndefOr[js.Array[Double | Null | SeriesFlowmapDataOptions]] = js.undefined
...
object SeriesFlowmapOptions {
  
  inline def apply(affectsMapView: Unit, `type`: String | flowmap): SeriesFlowmapOptions = {
    val __obj = js.Dynamic.literal(affectsMapView = affectsMapView.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesFlowmapOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesFlowmapOptions] (val x: Self) extends AnyVal {
    
    inline def setAffectsMapView(value: Unit): Self = StObject.set(x, "affectsMapView", value.asInstanceOf[js.Any])
    
    inline def setData(value: js.Array[Double | Null | SeriesFlowmapDataOptions]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    inline def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    inline def setDataVarargs(value: (Double | Null | SeriesFlowmapDataOptions)*): Self = StObject.set(x, "data", js.Array(value*))
    ...
    inline def setType(value: String | flowmap): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
