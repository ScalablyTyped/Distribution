...
trait PlotHeatmapSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotHeatmapSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
