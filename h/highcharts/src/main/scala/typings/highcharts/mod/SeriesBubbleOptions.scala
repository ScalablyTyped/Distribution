...
import typings.highcharts.highchartsStrings.bubble
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesBubbleOptions extends PlotBubbleOptions {
  /**
...
object SeriesBubbleOptions {
  ...
  def apply(
    ...
    dataLabels: PlotBubbleDataLabelsOptions | js.Array[PlotBubbleDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotBubbleDataSortingOptions = null,
