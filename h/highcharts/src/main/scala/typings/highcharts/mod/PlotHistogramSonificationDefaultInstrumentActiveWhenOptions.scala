...
trait PlotHistogramSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotHistogramSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
