...
trait PlotHollowcandlestickSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotHollowcandlestickSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
