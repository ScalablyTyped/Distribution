...
trait PlotLineSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotLineSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotLineSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
