...
trait PlotFunnelSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotFunnelSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
