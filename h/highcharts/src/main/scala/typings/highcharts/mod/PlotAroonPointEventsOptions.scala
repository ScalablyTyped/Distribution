...
trait PlotAroonPointEventsOptions extends js.Object {
  /**
...
object PlotAroonPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotAroonPointEventsOptions]
  }
}
