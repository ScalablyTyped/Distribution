...
trait PlotBarSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotBarSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotBarSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
