...
trait PlotTrendlineSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotTrendlineSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
