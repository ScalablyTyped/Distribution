...
trait PlotMappointSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotMappointSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
