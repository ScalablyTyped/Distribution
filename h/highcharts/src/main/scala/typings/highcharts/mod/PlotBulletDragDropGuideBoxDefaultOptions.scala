...
trait PlotBulletDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotBulletDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBulletDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotBulletDragDropGuideBoxDefaultOptions]
  }
}
