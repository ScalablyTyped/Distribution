...
trait PlotWilliamsrSonificationTracksActiveWhenOptions extends StObject {
...
object PlotWilliamsrSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotWilliamsrSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWilliamsrSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
