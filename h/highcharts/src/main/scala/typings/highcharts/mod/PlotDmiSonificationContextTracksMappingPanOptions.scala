...
trait PlotDmiSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
