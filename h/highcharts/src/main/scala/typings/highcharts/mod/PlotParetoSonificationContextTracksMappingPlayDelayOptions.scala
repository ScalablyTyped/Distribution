...
trait PlotParetoSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
