...
trait PlotTemaSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotTemaSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
