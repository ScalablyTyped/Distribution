...
trait PlotMaplineSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotMaplineSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotMaplineSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
