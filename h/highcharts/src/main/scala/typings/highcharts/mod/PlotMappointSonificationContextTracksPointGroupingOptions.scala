...
trait PlotMappointSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotMappointSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
