...
trait PlotParetoSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
