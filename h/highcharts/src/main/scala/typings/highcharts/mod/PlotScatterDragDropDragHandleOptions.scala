...
trait PlotScatterDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotScatterDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatterDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotScatterDragDropDragHandleOptions]
  }
}
