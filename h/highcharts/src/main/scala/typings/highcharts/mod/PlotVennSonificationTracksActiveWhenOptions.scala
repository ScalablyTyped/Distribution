...
trait PlotVennSonificationTracksActiveWhenOptions extends StObject {
...
object PlotVennSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotVennSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
