...
trait PlotAreaOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotAreaSonificationOptions] = js.undefined
...
object PlotAreaOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotAreaSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
