...
trait PlotScatterSonificationTracksMappingTimeOptions extends StObject {
...
object PlotScatterSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotScatterSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatterSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
