...
trait PlotVbpAccessibilityPointOptions extends StObject {
...
object PlotVbpAccessibilityPointOptions {
  
  inline def apply(): PlotVbpAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVbpAccessibilityPointOptions] (val x: Self) extends AnyVal {
