...
trait PlotApoSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
