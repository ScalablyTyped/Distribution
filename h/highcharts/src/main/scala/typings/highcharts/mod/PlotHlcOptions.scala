...
trait PlotHlcOptions extends StObject {
  ...
  /**
    ...
    */
  var pointValKey: js.UndefOr[OptionsHLCPointValKeyValue] = js.undefined
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotHlcSonificationOptions] = js.undefined
...
object PlotHlcOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHlcOptions] (val x: Self) extends AnyVal {
    ...
    inline def setPointValKey(value: OptionsHLCPointValKeyValue): Self = StObject.set(x, "pointValKey", value.asInstanceOf[js.Any])
    ...
    inline def setSonification(value: PlotHlcSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
