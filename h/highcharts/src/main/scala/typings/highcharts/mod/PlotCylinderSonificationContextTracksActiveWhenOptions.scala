...
trait PlotCylinderSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotCylinderSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
