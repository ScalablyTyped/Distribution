...
trait PlotNetworkgraphSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
