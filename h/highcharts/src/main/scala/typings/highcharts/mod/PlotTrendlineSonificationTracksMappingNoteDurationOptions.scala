...
trait PlotTrendlineSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
