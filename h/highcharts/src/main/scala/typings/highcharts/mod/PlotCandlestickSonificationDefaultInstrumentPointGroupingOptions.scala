...
trait PlotCandlestickSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotCandlestickSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
