...
trait PlotVariablepieDataGroupingOptions extends js.Object {
  /**
...
object PlotVariablepieDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVariablepieDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepieDataGroupingOptions]
  }
}
