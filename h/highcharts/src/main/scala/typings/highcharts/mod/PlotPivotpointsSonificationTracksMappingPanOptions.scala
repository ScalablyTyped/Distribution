...
trait PlotPivotpointsSonificationTracksMappingPanOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
