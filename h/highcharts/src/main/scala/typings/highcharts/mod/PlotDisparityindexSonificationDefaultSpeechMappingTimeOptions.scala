...
trait PlotDisparityindexSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
