...
trait PlotLinearregressionslopeSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
