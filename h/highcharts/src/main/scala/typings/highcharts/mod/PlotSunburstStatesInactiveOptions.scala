...
trait PlotSunburstStatesInactiveOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSunburstStatesInactiveAnimationOptions] = js.undefined
  /**
...
object PlotSunburstStatesInactiveOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSunburstStatesInactiveAnimationOptions = null,
    opacity: Int | Double = null
  ): PlotSunburstStatesInactiveOptions = {
