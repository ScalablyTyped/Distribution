...
trait PlotCandlestickSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotCandlestickSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
