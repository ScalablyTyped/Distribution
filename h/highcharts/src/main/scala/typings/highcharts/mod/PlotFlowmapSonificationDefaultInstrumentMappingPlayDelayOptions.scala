...
trait PlotFlowmapSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotFlowmapSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
