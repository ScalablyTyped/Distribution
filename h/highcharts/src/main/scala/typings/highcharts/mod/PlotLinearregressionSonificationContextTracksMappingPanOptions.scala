...
trait PlotLinearregressionSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
