...
trait PlotBarSonificationTracksMappingPitchOptions extends StObject {
...
object PlotBarSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
