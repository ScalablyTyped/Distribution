...
trait PlotGaugeSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotGaugeSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotGaugeSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
