...
trait PlotRsiSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotRsiSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotRsiSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
