...
trait PlotAoSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotAoSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotAoSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
