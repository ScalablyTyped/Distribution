...
trait PlotIkhConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotIkhConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotIkhConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotIkhConnectorsMarkerOptions]
  }
}
