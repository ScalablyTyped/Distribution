...
trait PlotKlingerSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotKlingerSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
