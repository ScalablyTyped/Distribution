...
trait PlotBarSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotBarSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotBarSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
