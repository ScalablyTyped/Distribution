...
trait PlotLinearregressionslopeSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotLinearregressionslopeSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
