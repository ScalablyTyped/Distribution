...
trait PlotSolidgaugeSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotSolidgaugeSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotSolidgaugeSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSolidgaugeSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
