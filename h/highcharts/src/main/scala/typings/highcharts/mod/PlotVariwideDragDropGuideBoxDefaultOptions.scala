...
trait PlotVariwideDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotVariwideDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVariwideDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotVariwideDragDropGuideBoxDefaultOptions]
  }
}
