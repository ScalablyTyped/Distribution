...
trait PlotDmiSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotDmiSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotDmiSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
