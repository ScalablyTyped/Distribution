...
trait PlotMapDragDropOptions extends js.Object {
  /**
    * (Highmaps) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotMapDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotMapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotMapDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotMapDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotMapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotMapDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotMapDragDropOptions]
  }
}
