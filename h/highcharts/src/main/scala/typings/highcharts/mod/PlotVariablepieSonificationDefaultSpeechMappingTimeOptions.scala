...
trait PlotVariablepieSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotVariablepieSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
