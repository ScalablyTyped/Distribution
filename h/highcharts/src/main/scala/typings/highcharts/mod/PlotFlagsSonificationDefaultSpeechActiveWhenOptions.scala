...
trait PlotFlagsSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotFlagsSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
