...
trait PlotObvAccessibilityPointOptions extends StObject {
...
object PlotObvAccessibilityPointOptions {
  
  inline def apply(): PlotObvAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotObvAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotObvAccessibilityPointOptions] (val x: Self) extends AnyVal {
