...
trait PlotCmfAccessibilityPointOptions extends StObject {
...
object PlotCmfAccessibilityPointOptions {
  
  inline def apply(): PlotCmfAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmfAccessibilityPointOptions] (val x: Self) extends AnyVal {
