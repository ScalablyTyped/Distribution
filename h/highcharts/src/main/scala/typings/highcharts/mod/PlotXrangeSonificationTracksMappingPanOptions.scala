...
trait PlotXrangeSonificationTracksMappingPanOptions extends StObject {
...
object PlotXrangeSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotXrangeSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
