...
trait PlotCmfSonificationTracksActiveWhenOptions extends StObject {
...
object PlotCmfSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotCmfSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmfSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
