...
trait PlotLinearregressionSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
