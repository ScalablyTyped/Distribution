...
trait PlotPyramid3dSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
