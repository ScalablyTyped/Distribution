...
trait PlotStochasticSonificationTracksMappingPitchOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
