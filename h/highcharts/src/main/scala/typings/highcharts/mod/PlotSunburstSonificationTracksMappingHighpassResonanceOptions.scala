...
trait PlotSunburstSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotSunburstSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotSunburstSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
