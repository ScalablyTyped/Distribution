...
trait PlotWaterfallSonificationTracksMappingPitchOptions extends StObject {
...
object PlotWaterfallSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotWaterfallSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
