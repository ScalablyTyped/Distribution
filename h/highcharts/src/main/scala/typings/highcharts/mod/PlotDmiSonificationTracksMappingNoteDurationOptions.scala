...
trait PlotDmiSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotDmiSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
