...
trait PlotGaugeSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotGaugeSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotGaugeSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
