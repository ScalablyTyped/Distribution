...
trait PlotArearangeSonificationTracksPointGroupingOptions extends StObject {
...
object PlotArearangeSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotArearangeSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
