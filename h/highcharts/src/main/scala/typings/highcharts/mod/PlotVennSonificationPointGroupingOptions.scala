...
trait PlotVennSonificationPointGroupingOptions extends StObject {
...
object PlotVennSonificationPointGroupingOptions {
  
  inline def apply(): PlotVennSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
