...
trait PlotWordcloudSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotWordcloudSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
