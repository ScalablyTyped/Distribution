...
trait PlotPieSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotPieSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotPieSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
