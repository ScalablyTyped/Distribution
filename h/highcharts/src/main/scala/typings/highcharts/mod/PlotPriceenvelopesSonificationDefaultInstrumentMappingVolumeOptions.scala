...
trait PlotPriceenvelopesSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
