...
trait SonificationGlobalContextTracksMappingTremoloDepthOptions extends StObject {
...
object SonificationGlobalContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
