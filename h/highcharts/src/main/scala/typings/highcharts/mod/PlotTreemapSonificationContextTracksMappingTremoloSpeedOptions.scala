...
trait PlotTreemapSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotTreemapSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
