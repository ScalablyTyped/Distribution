...
trait PlotWmaSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotWmaSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
