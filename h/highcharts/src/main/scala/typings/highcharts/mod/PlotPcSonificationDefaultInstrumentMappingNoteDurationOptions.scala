...
trait PlotPcSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotPcSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotPcSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
