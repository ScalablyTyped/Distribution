...
object NavigationAnnotationsLabelsOptions {
  ...
  @scala.inline
  def apply(): NavigationAnnotationsLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigationAnnotationsLabelsOptions]
  }
  
  @scala.inline
  implicit class NavigationAnnotationsLabelsOptionsMutableBuilder[Self <: NavigationAnnotationsLabelsOptions] (val x: Self) extends AnyVal {
