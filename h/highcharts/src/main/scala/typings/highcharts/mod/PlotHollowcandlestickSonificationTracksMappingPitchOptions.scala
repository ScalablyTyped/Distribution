...
trait PlotHollowcandlestickSonificationTracksMappingPitchOptions extends StObject {
...
object PlotHollowcandlestickSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
