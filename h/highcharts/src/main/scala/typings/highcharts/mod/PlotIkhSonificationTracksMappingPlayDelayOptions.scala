...
trait PlotIkhSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotIkhSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
