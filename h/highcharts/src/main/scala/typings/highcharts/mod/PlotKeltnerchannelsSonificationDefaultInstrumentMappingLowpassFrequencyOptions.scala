...
trait PlotKeltnerchannelsSonificationDefaultInstrumentMappingLowpassFrequencyOptions extends StObject {
...
object PlotKeltnerchannelsSonificationDefaultInstrumentMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotKeltnerchannelsSonificationDefaultInstrumentMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsSonificationDefaultInstrumentMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsSonificationDefaultInstrumentMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
