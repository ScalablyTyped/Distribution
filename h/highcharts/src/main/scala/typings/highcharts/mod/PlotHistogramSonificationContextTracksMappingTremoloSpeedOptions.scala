...
trait PlotHistogramSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotHistogramSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
