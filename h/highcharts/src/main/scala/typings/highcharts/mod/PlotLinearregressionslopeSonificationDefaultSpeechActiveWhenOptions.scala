...
trait PlotLinearregressionslopeSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
