...
trait PlotNetworkgraphSonificationDefaultInstrumentMappingLowpassResonanceOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultInstrumentMappingLowpassResonanceOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultInstrumentMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultInstrumentMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultInstrumentMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
