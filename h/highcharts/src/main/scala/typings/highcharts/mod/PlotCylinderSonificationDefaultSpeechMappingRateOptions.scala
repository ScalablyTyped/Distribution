...
trait PlotCylinderSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotCylinderSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
