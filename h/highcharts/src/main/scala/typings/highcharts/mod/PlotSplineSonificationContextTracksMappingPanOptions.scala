...
trait PlotSplineSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
