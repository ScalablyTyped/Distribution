...
trait PlotPpoSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotPpoSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotPpoSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
