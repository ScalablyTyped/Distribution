...
trait SonificationGlobalTracksMappingLowpassResonanceOptions extends StObject {
...
object SonificationGlobalTracksMappingLowpassResonanceOptions {
  
  inline def apply(): SonificationGlobalTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
