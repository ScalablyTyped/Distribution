...
trait PlotColumnpyramidSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
