...
trait PlotXrangeSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotXrangeSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
