...
trait PlotTimelineConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotTimelineConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTimelineConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineConnectorsMarkerOptions]
  }
}
