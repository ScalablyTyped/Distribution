...
trait PlotHistogramSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotHistogramSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
