...
trait PlotGaugeSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
