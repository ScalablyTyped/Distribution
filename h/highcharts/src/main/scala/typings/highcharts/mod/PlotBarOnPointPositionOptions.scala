...
trait PlotBarOnPointPositionOptions extends StObject {
...
object PlotBarOnPointPositionOptions {
  
  inline def apply(): PlotBarOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarOnPointPositionOptions] (val x: Self) extends AnyVal {
