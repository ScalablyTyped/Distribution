...
trait PlotOrganizationSonificationDefaultInstrumentMappingHighpassFrequencyOptions extends StObject {
...
object PlotOrganizationSonificationDefaultInstrumentMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotOrganizationSonificationDefaultInstrumentMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationSonificationDefaultInstrumentMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOrganizationSonificationDefaultInstrumentMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
