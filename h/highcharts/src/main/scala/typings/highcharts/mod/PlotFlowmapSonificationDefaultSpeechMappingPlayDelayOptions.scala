...
trait PlotFlowmapSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotFlowmapSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
