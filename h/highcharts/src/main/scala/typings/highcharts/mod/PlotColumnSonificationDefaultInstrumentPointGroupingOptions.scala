...
trait PlotColumnSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotColumnSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotColumnSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
