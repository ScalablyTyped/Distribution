...
trait PlotSmaSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotSmaSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
