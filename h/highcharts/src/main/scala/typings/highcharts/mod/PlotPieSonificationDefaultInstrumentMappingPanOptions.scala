...
trait PlotPieSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotPieSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotPieSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
