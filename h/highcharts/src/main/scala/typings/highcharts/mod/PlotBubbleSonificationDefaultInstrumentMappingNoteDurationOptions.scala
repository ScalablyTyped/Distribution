...
trait PlotBubbleSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotBubbleSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
