...
trait PlotGanttSonificationTracksMappingTimeOptions extends StObject {
...
object PlotGanttSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
