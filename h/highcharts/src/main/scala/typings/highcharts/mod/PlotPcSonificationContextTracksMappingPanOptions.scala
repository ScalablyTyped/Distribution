...
trait PlotPcSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotPcSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotPcSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
