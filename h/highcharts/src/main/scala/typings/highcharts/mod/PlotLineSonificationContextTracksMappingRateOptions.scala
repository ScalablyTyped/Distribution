...
trait PlotLineSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotLineSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotLineSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
