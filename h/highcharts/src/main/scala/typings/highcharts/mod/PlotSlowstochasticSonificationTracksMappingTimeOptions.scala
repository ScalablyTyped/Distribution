...
trait PlotSlowstochasticSonificationTracksMappingTimeOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
