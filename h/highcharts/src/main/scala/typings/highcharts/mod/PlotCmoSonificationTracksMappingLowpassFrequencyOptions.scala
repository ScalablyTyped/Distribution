...
trait PlotCmoSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotCmoSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
