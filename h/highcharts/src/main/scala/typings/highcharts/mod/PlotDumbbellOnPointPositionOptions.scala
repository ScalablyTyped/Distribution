...
trait PlotDumbbellOnPointPositionOptions extends StObject {
...
object PlotDumbbellOnPointPositionOptions {
  
  inline def apply(): PlotDumbbellOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellOnPointPositionOptions] (val x: Self) extends AnyVal {
