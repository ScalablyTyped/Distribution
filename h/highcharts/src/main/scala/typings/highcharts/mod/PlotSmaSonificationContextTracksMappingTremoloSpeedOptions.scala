...
trait PlotSmaSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotSmaSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
