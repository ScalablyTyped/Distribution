...
trait PlotSunburstAccessibilityPointOptions extends StObject {
...
object PlotSunburstAccessibilityPointOptions {
  
  inline def apply(): PlotSunburstAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstAccessibilityPointOptions] (val x: Self) extends AnyVal {
