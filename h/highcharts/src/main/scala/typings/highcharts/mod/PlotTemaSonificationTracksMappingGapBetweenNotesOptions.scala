...
trait PlotTemaSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotTemaSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
