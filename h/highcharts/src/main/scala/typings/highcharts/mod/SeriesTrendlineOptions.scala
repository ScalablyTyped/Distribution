...
import typings.highcharts.highchartsStrings.trendline
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesTrendlineOptions
  extends StObject
     with PlotTrendlineOptions {
...
object SeriesTrendlineOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | trendline): SeriesTrendlineOptions = {
  ...
  extension [Self <: SeriesTrendlineOptions](x: Self) {
    ...
    inline def setType(value: String | trendline): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
