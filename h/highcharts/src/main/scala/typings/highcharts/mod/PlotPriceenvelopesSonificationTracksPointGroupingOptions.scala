...
trait PlotPriceenvelopesSonificationTracksPointGroupingOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
