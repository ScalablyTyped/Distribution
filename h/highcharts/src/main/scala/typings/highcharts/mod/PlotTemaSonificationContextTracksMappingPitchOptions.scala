...
trait PlotTemaSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
