...
trait PlotCciSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotCciSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
