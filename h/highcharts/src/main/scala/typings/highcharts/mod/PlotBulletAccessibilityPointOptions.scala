...
trait PlotBulletAccessibilityPointOptions extends StObject {
...
object PlotBulletAccessibilityPointOptions {
  
  inline def apply(): PlotBulletAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletAccessibilityPointOptions] (val x: Self) extends AnyVal {
