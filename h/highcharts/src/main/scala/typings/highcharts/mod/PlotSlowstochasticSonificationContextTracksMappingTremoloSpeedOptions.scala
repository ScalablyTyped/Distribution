...
trait PlotSlowstochasticSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
