...
trait PlotPyramid3dAccessibilityPointOptions extends StObject {
...
object PlotPyramid3dAccessibilityPointOptions {
  
  inline def apply(): PlotPyramid3dAccessibilityPointOptions = {
