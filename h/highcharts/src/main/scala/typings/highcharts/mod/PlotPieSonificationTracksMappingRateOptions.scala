...
trait PlotPieSonificationTracksMappingRateOptions extends StObject {
...
object PlotPieSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotPieSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
