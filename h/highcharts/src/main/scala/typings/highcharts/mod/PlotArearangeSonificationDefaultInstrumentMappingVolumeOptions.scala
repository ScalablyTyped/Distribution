...
trait PlotArearangeSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotArearangeSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
