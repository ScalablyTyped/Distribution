...
trait PlotXrangeSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotXrangeSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
