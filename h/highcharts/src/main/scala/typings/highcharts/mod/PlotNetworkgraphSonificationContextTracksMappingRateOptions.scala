...
trait PlotNetworkgraphSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
