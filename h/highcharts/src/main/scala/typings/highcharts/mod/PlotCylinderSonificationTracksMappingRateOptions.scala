...
trait PlotCylinderSonificationTracksMappingRateOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
