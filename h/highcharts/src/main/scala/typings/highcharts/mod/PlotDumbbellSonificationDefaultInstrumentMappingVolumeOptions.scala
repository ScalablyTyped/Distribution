...
trait PlotDumbbellSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotDumbbellSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
