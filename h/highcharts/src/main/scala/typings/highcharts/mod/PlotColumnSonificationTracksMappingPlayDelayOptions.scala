...
trait PlotColumnSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotColumnSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
