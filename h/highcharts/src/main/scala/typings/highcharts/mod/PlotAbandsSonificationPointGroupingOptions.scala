...
trait PlotAbandsSonificationPointGroupingOptions extends StObject {
...
object PlotAbandsSonificationPointGroupingOptions {
  
  inline def apply(): PlotAbandsSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
