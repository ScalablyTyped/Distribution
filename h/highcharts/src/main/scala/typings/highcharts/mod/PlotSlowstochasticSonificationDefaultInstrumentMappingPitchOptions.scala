...
trait PlotSlowstochasticSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
