...
trait PlotHollowcandlestickSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotHollowcandlestickSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
