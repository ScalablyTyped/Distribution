...
trait PlotBubbleSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotBubbleSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
