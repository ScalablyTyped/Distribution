...
trait PlotSeriesSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
