...
trait PlotParetoStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotParetoStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotParetoStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotParetoStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotParetoStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotParetoStatesHoverOptions]
  }
}
