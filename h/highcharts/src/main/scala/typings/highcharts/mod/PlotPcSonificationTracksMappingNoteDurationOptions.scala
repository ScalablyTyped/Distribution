...
trait PlotPcSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotPcSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
