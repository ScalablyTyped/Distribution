...
trait PlotGaugeSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotGaugeSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotGaugeSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
