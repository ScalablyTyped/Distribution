...
trait PlotWordcloudSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
