...
trait PlotFunnel3dSonificationTracksMappingPitchOptions extends StObject {
...
object PlotFunnel3dSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
