...
trait SeriesBubbleDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesBubbleDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesBubbleDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesBubbleDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesBubbleDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesBubbleDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesBubbleDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesBubbleDataDragDropOptions]
  }
}
