...
trait SonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object SonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): SonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
