...
trait PlotFunnelSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
