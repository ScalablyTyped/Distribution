...
trait PlotTrendlineSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotTrendlineSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
