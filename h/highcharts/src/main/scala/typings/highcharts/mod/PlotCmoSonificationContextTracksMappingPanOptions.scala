...
trait PlotCmoSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
