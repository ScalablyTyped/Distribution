...
trait PlotFlowmapSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
