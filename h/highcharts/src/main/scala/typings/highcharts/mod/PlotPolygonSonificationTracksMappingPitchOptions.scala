...
trait PlotPolygonSonificationTracksMappingPitchOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
