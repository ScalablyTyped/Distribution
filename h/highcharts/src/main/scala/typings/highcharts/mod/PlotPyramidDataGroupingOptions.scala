...
trait PlotPyramidDataGroupingOptions extends js.Object {
  /**
...
object PlotPyramidDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramidDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotPyramidDataGroupingOptions]
  }
}
