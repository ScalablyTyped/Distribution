...
trait PlotLinearregressioninterceptSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
