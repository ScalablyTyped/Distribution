...
trait PlotIkhSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotIkhSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
