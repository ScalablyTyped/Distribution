...
trait PlotSmaConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotSmaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSmaConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSmaConnectorsStartMarkerOptions]
  }
}
