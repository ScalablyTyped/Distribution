...
trait PlotCciSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotCciSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
