...
trait PlotVariablepieSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotVariablepieSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
