...
trait PlotWaterfallSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotWaterfallSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotWaterfallSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
