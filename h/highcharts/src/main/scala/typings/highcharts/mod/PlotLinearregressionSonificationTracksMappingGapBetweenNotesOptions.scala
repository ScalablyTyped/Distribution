...
trait PlotLinearregressionSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
