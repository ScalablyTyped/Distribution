...
trait PlotIkhSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotIkhSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
