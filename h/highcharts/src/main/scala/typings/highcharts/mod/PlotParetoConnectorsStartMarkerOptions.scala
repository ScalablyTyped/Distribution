...
trait PlotParetoConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotParetoConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotParetoConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotParetoConnectorsStartMarkerOptions]
  }
}
