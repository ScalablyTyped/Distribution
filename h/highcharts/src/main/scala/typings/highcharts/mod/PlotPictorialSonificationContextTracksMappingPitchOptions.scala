...
trait PlotPictorialSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotPictorialSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
