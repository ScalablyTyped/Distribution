...
trait PlotPpoSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotPpoSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotPpoSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
