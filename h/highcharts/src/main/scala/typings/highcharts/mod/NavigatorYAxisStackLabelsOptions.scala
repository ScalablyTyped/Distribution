...
trait NavigatorYAxisStackLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | NavigatorYAxisStackLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object NavigatorYAxisStackLabelsOptions {
  ...
  inline def apply(): NavigatorYAxisStackLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisStackLabelsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NavigatorYAxisStackLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | NavigatorYAxisStackLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
