...
trait PlotCylinderOnPointPositionOptions extends StObject {
...
object PlotCylinderOnPointPositionOptions {
  
  inline def apply(): PlotCylinderOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderOnPointPositionOptions] (val x: Self) extends AnyVal {
