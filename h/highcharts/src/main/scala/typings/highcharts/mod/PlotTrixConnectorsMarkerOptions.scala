...
trait PlotTrixConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotTrixConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrixConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTrixConnectorsMarkerOptions]
  }
}
