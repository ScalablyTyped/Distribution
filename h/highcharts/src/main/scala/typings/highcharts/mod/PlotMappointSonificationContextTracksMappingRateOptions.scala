...
trait PlotMappointSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotMappointSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
