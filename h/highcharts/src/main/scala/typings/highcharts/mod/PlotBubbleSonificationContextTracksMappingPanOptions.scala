...
trait PlotBubbleSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
