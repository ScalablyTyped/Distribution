...
trait PlotDemaSonificationTracksActiveWhenOptions extends StObject {
...
object PlotDemaSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotDemaSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDemaSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
