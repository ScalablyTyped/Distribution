...
trait PlotIkhSonificationTracksMappingPitchOptions extends StObject {
...
object PlotIkhSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
