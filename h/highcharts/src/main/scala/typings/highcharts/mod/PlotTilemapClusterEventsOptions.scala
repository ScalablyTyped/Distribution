...
trait PlotTilemapClusterEventsOptions extends StObject {
...
object PlotTilemapClusterEventsOptions {
  
  inline def apply(): PlotTilemapClusterEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapClusterEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTilemapClusterEventsOptions] (val x: Self) extends AnyVal {
