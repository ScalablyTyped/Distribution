...
trait PlotColumnrangeSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
