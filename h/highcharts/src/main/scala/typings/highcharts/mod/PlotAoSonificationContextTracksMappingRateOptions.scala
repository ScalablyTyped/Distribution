...
trait PlotAoSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotAoSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotAoSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
