...
trait PlotPsarSonificationTracksMappingPanOptions extends StObject {
...
object PlotPsarSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
