...
trait PlotArearangeSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotArearangeSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotArearangeSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
