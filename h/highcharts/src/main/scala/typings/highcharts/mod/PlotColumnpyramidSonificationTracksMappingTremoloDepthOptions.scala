...
trait PlotColumnpyramidSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
