...
trait PlotBoxplotSonificationTracksPointGroupingOptions extends StObject {
...
object PlotBoxplotSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotBoxplotSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBoxplotSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
