...
trait PlotMaplineClusterLayoutAlgorithmOptions extends StObject {
...
object PlotMaplineClusterLayoutAlgorithmOptions {
  
  inline def apply(): PlotMaplineClusterLayoutAlgorithmOptions = {
