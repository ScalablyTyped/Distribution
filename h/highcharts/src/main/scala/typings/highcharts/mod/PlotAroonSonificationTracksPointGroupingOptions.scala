...
trait PlotAroonSonificationTracksPointGroupingOptions extends StObject {
...
object PlotAroonSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotAroonSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
