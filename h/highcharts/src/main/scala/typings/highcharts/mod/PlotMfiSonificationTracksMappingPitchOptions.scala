...
trait PlotMfiSonificationTracksMappingPitchOptions extends StObject {
...
object PlotMfiSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotMfiSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMfiSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
