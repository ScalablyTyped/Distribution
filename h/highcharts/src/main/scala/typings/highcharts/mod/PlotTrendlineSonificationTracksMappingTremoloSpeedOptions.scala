...
trait PlotTrendlineSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
