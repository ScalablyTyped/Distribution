...
trait PlotTrendlineSonificationTracksMappingPanOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
