...
trait PlotDumbbellSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotDumbbellSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
