...
trait PlotHeikinashiAccessibilityPointOptions extends StObject {
...
object PlotHeikinashiAccessibilityPointOptions {
  
  inline def apply(): PlotHeikinashiAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeikinashiAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeikinashiAccessibilityPointOptions] (val x: Self) extends AnyVal {
