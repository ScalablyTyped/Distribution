...
trait PlotTimelineSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
