...
trait PlotPpoSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotPpoSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
