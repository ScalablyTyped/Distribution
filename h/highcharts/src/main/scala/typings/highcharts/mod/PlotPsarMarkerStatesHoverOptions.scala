...
trait PlotPsarMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotPsarMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPsarMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPsarMarkerStatesHoverOptions]
  }
}
