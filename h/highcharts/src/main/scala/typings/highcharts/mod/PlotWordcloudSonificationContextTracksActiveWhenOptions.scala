...
trait PlotWordcloudSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
