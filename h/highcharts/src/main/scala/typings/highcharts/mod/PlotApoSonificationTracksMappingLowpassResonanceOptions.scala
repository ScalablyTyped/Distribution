...
trait PlotApoSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotApoSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
