...
trait PlotLinearregressionslopeSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
