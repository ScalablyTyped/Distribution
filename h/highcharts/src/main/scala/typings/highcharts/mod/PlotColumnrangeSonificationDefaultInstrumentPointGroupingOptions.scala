...
trait PlotColumnrangeSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
