...
trait PlotDumbbellSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
