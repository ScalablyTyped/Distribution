...
trait PlotPolygonSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
