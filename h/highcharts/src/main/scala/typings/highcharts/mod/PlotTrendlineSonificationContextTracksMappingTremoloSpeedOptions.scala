...
trait PlotTrendlineSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
