...
trait PlotMappointDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotMappointDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMappointDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotMappointDragDropDragHandleOptions]
  }
}
