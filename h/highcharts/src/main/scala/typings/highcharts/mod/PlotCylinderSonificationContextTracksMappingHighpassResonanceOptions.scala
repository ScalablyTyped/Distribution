...
trait PlotCylinderSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotCylinderSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
