...
trait PlotPsarSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPsarSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
