...
trait PlotXrangeSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotXrangeSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
