...
trait PlotPpoSonificationTracksMappingRateOptions extends StObject {
...
object PlotPpoSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
