...
trait PlotTrixSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
