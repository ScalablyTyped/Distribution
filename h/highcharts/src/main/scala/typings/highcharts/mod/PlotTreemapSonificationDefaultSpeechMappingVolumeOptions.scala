...
trait PlotTreemapSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotTreemapSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
