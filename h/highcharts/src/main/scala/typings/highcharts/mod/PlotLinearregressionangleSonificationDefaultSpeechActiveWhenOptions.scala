...
trait PlotLinearregressionangleSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotLinearregressionangleSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
