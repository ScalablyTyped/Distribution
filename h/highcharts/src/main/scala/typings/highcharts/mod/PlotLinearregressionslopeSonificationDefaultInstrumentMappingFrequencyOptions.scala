...
trait PlotLinearregressionslopeSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
