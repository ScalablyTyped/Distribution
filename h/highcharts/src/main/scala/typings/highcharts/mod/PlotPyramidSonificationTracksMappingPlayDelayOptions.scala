...
trait PlotPyramidSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
