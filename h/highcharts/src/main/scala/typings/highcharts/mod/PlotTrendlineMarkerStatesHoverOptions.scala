...
trait PlotTrendlineMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotTrendlineMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrendlineMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineMarkerStatesHoverOptions]
  }
}
