...
trait PlotLinearregressionSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
