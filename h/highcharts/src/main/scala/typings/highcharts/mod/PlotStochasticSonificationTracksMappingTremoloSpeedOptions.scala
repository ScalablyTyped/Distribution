...
trait PlotStochasticSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
