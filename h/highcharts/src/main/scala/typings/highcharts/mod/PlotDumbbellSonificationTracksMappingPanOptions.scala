...
trait PlotDumbbellSonificationTracksMappingPanOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
