...
trait PlotCylinderSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotCylinderSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
