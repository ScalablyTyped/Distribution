...
trait PlotScatterTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotScatterTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotScatterTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotScatterTooltipDateTimeLabelFormatsOptions]
  }
}
