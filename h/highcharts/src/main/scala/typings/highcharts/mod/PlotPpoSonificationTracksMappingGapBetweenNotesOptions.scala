...
trait PlotPpoSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotPpoSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
