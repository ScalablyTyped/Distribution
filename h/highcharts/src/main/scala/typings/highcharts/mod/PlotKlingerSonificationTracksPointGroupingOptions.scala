...
trait PlotKlingerSonificationTracksPointGroupingOptions extends StObject {
...
object PlotKlingerSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotKlingerSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
