...
trait PlotWmaSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotWmaSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotWmaSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
