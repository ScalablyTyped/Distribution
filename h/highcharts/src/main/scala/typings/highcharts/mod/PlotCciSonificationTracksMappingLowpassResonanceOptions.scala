...
trait PlotCciSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotCciSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
