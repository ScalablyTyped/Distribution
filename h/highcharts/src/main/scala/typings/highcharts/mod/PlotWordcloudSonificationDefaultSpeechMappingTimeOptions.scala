...
trait PlotWordcloudSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotWordcloudSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
