...
trait PlotPpoSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotPpoSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotPpoSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
