...
trait PlotTrixSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotTrixSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
