...
trait PlotChaikinSonificationTracksActiveWhenOptions extends StObject {
...
object PlotChaikinSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotChaikinSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotChaikinSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
