...
trait PlotWindbarbAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotWindbarbAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotWindbarbAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotWindbarbAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotWindbarbAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotWindbarbAccessibilityOptions]
  }
}
