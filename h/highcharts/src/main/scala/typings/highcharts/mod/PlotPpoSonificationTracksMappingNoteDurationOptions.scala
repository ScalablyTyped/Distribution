...
trait PlotPpoSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotPpoSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
