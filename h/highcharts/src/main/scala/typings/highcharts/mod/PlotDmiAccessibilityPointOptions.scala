...
trait PlotDmiAccessibilityPointOptions extends StObject {
...
object PlotDmiAccessibilityPointOptions {
  
  inline def apply(): PlotDmiAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiAccessibilityPointOptions] (val x: Self) extends AnyVal {
