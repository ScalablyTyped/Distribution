...
object YAxisPlotBandsEventsOptions {
  ...
  @scala.inline
  def apply(): YAxisPlotBandsEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisPlotBandsEventsOptions]
  }
  
  @scala.inline
  implicit class YAxisPlotBandsEventsOptionsMutableBuilder[Self <: YAxisPlotBandsEventsOptions] (val x: Self) extends AnyVal {
