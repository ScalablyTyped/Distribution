...
trait PlotAoSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotAoSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotAoSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
