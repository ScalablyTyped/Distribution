...
trait PlotCmoSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotCmoSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
