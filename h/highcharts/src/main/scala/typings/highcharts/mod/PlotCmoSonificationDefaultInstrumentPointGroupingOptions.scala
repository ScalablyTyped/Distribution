...
trait PlotCmoSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotCmoSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotCmoSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
