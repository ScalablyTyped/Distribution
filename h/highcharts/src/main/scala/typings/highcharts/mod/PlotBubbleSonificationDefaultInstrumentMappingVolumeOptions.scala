...
trait PlotBubbleSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotBubbleSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
