...
trait PlotLinearregressionslopeSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotLinearregressionslopeSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
