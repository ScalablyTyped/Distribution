...
trait SonificationGlobalContextTracksMappingTimeOptions extends StObject {
...
object SonificationGlobalContextTracksMappingTimeOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
