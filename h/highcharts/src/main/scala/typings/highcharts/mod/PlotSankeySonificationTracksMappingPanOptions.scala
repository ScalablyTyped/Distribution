...
trait PlotSankeySonificationTracksMappingPanOptions extends StObject {
...
object PlotSankeySonificationTracksMappingPanOptions {
  
  inline def apply(): PlotSankeySonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeySonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeySonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
