...
trait PlotWaterfallSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotWaterfallSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotWaterfallSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
