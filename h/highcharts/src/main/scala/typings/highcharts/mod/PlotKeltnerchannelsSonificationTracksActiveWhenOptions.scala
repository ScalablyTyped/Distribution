...
trait PlotKeltnerchannelsSonificationTracksActiveWhenOptions extends StObject {
...
object PlotKeltnerchannelsSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotKeltnerchannelsSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
