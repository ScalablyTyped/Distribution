...
trait PlotKlingerSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotKlingerSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
