...
trait PlotMapbubbleSonificationTracksMappingPitchOptions extends StObject {
...
object PlotMapbubbleSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotMapbubbleSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
