...
trait PlotFunnelSonificationTracksMappingTimeOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
