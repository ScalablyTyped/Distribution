...
trait PlotApoSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotApoSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
