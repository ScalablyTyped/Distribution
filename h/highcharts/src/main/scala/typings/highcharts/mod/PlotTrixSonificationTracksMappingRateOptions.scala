...
trait PlotTrixSonificationTracksMappingRateOptions extends StObject {
...
object PlotTrixSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
