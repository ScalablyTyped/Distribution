...
trait PlotStreamgraphSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
