...
trait PlotFunnelSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotFunnelSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
