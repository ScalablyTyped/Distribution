...
trait PlotScatterSonificationTracksMappingPitchOptions extends StObject {
...
object PlotScatterSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotScatterSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatterSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
