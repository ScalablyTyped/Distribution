...
trait PlotSupertrendSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
