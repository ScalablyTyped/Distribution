...
trait PlotPyramid3dSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
