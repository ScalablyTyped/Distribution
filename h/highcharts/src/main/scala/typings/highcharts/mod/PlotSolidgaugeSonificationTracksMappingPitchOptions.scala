...
trait PlotSolidgaugeSonificationTracksMappingPitchOptions extends StObject {
...
object PlotSolidgaugeSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotSolidgaugeSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSolidgaugeSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
