...
trait PlotIkhSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotIkhSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotIkhSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
