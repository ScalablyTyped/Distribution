...
trait PlotFlowmapSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
