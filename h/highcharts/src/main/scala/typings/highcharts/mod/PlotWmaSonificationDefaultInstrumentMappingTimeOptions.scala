...
trait PlotWmaSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotWmaSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotWmaSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
