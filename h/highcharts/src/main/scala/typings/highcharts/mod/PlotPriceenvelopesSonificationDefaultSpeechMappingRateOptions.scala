...
trait PlotPriceenvelopesSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
