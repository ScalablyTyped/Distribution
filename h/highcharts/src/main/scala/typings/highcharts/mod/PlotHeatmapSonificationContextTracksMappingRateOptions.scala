...
trait PlotHeatmapSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotHeatmapSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
