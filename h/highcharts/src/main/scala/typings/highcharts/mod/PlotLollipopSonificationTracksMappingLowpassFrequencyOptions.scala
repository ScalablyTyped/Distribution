...
trait PlotLollipopSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
