...
trait PlotMfiOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotMfiSonificationOptions] = js.undefined
...
object PlotMfiOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMfiOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotMfiSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
