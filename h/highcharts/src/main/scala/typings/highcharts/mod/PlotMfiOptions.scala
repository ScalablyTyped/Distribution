...
object PlotMfiOptions {
  ...
  @scala.inline
  def apply(): PlotMfiOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiOptions]
  }
  
  @scala.inline
  implicit class PlotMfiOptionsMutableBuilder[Self <: PlotMfiOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMfiAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotMfiDataLabelsOptions | js.Array[PlotMfiDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotMfiDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotMfiDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotMfiParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
