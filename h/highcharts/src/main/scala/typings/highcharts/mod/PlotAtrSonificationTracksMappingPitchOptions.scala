...
trait PlotAtrSonificationTracksMappingPitchOptions extends StObject {
...
object PlotAtrSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
