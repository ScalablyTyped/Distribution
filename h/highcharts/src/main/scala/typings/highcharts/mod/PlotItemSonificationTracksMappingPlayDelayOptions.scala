...
trait PlotItemSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotItemSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
