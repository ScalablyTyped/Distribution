...
trait PlotCciConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotCciConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotCciConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotCciConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotCciConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotCciConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotCciConnectorsMarkerOptions = null,
    startMarker: PlotCciConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotCciConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotCciConnectorsOptions]
  }
}
