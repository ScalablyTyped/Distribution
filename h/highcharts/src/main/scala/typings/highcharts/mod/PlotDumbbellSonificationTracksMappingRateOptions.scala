...
trait PlotDumbbellSonificationTracksMappingRateOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
