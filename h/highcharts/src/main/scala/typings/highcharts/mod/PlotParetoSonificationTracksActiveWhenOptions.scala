...
trait PlotParetoSonificationTracksActiveWhenOptions extends StObject {
...
object PlotParetoSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotParetoSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
