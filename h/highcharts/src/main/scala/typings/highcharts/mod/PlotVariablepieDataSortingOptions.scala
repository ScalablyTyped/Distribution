...
trait PlotVariablepieDataSortingOptions extends StObject {
...
object PlotVariablepieDataSortingOptions {
  
  inline def apply(): PlotVariablepieDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieDataSortingOptions] (val x: Self) extends AnyVal {
