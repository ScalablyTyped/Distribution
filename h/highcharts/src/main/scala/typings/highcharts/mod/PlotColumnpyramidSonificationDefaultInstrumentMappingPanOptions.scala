...
trait PlotColumnpyramidSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
