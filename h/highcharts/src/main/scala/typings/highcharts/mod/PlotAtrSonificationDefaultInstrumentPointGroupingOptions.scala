...
trait PlotAtrSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotAtrSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotAtrSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
