...
trait PlotPyramid3dSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
