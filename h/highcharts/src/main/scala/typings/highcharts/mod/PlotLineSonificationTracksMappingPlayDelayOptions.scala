...
trait PlotLineSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotLineSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
