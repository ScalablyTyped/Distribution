...
trait PlotPictorialSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotPictorialSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
