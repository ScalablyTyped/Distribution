...
trait PlotCmfSonificationPointGroupingOptions extends StObject {
...
object PlotCmfSonificationPointGroupingOptions {
  
  inline def apply(): PlotCmfSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmfSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
