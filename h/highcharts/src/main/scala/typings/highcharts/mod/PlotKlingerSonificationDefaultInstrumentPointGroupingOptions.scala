...
trait PlotKlingerSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotKlingerSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
