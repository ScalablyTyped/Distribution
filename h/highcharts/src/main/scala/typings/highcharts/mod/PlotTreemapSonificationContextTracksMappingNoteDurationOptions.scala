...
trait PlotTreemapSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotTreemapSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
