...
trait PlotLinearregressionangleSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
