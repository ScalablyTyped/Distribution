...
trait SeriesScatterDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesScatterDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesScatterDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesScatterDataDragDropGuideBoxDefaultOptions]
  }
}
