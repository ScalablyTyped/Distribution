...
trait PlotNatrSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotNatrSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
