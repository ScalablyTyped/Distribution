...
trait PlotWmaSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotWmaSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotWmaSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
