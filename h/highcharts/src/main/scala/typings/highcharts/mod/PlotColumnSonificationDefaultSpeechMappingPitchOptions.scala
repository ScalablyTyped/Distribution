...
trait PlotColumnSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotColumnSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotColumnSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
