...
trait PlotArearangeSonificationTracksMappingRateOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
