...
trait PlotDumbbellSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
