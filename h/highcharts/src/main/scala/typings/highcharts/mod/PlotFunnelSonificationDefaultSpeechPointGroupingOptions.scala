...
trait PlotFunnelSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotFunnelSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
