...
trait PlotFlagsSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotFlagsSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
