...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesAbandsOptions
  extends StObject
...
object SeriesAbandsOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | abands): SeriesAbandsOptions = {
  ...
  @scala.inline
  implicit class SeriesAbandsOptionsMutableBuilder[Self <: SeriesAbandsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | abands): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
