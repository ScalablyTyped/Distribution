...
object SeriesAbandsOptions {
  ...
  @scala.inline
  implicit class SeriesAbandsOptionsOps[Self <: SeriesAbandsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | abands): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
