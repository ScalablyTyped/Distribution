...
trait PlotFunnelSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotFunnelSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
