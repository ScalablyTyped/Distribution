...
trait SonificationDefaultInstrumentMappingTremoloDepthOptions extends StObject {
...
object SonificationDefaultInstrumentMappingTremoloDepthOptions {
  
  inline def apply(): SonificationDefaultInstrumentMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultInstrumentMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultInstrumentMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
