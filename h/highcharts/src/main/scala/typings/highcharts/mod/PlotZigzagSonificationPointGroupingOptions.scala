...
trait PlotZigzagSonificationPointGroupingOptions extends StObject {
...
object PlotZigzagSonificationPointGroupingOptions {
  
  inline def apply(): PlotZigzagSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotZigzagSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
