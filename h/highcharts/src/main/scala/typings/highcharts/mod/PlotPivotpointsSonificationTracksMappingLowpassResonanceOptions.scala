...
trait PlotPivotpointsSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
