...
trait PlotStreamgraphSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
