...
trait PlotLinearregressioninterceptSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
