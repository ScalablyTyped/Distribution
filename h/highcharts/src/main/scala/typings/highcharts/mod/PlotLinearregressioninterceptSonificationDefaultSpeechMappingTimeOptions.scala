...
trait PlotLinearregressioninterceptSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
