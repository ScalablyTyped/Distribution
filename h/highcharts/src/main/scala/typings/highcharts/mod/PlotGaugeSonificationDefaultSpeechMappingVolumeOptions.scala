...
trait PlotGaugeSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotGaugeSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotGaugeSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
