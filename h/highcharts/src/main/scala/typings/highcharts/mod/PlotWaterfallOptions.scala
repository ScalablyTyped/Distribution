...
trait PlotWaterfallOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotWaterfallSonificationOptions] = js.undefined
...
object PlotWaterfallOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotWaterfallSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
