...
trait PlotSmaSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotSmaSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
