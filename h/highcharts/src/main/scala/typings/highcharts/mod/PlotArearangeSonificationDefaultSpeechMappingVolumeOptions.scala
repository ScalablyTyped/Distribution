...
trait PlotArearangeSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotArearangeSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
