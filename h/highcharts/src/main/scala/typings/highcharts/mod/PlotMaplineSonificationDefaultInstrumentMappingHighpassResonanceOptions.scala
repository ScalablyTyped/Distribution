...
trait PlotMaplineSonificationDefaultInstrumentMappingHighpassResonanceOptions extends StObject {
...
object PlotMaplineSonificationDefaultInstrumentMappingHighpassResonanceOptions {
  
  inline def apply(): PlotMaplineSonificationDefaultInstrumentMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationDefaultInstrumentMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationDefaultInstrumentMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
