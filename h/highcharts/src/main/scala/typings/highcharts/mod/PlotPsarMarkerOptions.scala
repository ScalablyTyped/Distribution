...
trait PlotPsarMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPsarMarkerStatesOptions] = js.undefined
  /**
...
object PlotPsarMarkerOptions {
  ...
  def apply(
    ...
    states: PlotPsarMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPsarMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPsarMarkerOptions]
  }
}
