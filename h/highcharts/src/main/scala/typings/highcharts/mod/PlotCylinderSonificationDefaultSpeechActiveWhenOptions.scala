...
trait PlotCylinderSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotCylinderSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
