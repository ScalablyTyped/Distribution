...
trait PlotApoConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotApoConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotApoConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotApoConnectorsMarkerOptions]
  }
}
