...
trait PlotWilliamsrSonificationDefaultInstrumentMappingLowpassFrequencyOptions extends StObject {
...
object PlotWilliamsrSonificationDefaultInstrumentMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotWilliamsrSonificationDefaultInstrumentMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrSonificationDefaultInstrumentMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWilliamsrSonificationDefaultInstrumentMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
