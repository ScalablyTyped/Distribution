...
trait PlotSlowstochasticSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
