...
trait PlotAdDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotAdDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotAdDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotAdDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotAdDataLabelsOptionsMutableBuilder[Self <: PlotAdDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAdDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
