...
@js.native
trait PlotAdDataLabelsOptions extends js.Object {
...
object PlotAdDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotAdDataLabelsOptionsOps[Self <: PlotAdDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAdDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
