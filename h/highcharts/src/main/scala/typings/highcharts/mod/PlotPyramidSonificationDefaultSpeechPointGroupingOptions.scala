...
trait PlotPyramidSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotPyramidSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
