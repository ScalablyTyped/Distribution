...
trait PlotWordcloudSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
