...
trait PlotLinearregressionSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
