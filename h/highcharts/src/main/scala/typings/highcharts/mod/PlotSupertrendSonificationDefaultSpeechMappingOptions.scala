...
trait PlotSupertrendSonificationDefaultSpeechMappingOptions extends StObject {
  
  /**
    * (Highstock) Speech pitch (how high/low the voice is) multiplier.
    */
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotSupertrendSonificationDefaultSpeechMappingPitchOptions
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotSupertrendSonificationDefaultSpeechMappingPlayDelayOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var rate: js.UndefOr[
    Double | js.Object | String | js.Function | PlotSupertrendSonificationDefaultSpeechMappingRateOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotSupertrendSonificationDefaultSpeechMappingTimeOptions
  ] = js.undefined
  ...
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotSupertrendSonificationDefaultSpeechMappingVolumeOptions
  ] = js.undefined
}
object PlotSupertrendSonificationDefaultSpeechMappingOptions {
  
  inline def apply(): PlotSupertrendSonificationDefaultSpeechMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationDefaultSpeechMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationDefaultSpeechMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotSupertrendSonificationDefaultSpeechMappingPitchOptions
    ): Self = StObject.set(x, "pitch", value.asInstanceOf[js.Any])
    
    inline def setPitchUndefined: Self = StObject.set(x, "pitch", js.undefined)
    
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotSupertrendSonificationDefaultSpeechMappingPlayDelayOptions
    ...
    inline def setRate(
      value: Double | js.Object | String | js.Function | PlotSupertrendSonificationDefaultSpeechMappingRateOptions
    ...
    inline def setTime(
      value: Double | js.Object | String | js.Function | PlotSupertrendSonificationDefaultSpeechMappingTimeOptions
    ): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setVolume(
      value: Double | js.Object | String | js.Function | PlotSupertrendSonificationDefaultSpeechMappingVolumeOptions
