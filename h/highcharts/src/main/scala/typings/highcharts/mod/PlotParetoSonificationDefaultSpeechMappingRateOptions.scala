...
trait PlotParetoSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotParetoSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotParetoSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
