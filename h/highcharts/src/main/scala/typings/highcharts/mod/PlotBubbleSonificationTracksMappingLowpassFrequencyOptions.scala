...
trait PlotBubbleSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotBubbleSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotBubbleSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
