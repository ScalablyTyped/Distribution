...
trait PlotCmoSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotCmoSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotCmoSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
