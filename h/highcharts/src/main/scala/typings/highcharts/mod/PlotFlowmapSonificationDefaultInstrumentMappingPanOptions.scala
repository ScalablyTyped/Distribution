...
trait PlotFlowmapSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotFlowmapSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
