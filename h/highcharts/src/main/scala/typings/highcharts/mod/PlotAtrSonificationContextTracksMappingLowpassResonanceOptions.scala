...
trait PlotAtrSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
