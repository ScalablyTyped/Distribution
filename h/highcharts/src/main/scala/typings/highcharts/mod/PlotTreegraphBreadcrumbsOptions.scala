...
trait PlotTreegraphBreadcrumbsOptions extends StObject {
  ...
  /**
    ...
    */
  var buttonTheme: js.UndefOr[PlotTreegraphBreadcrumbsButtonThemeOptions | SVGAttributes] = js.undefined
  
  var events: js.UndefOr[PlotTreegraphBreadcrumbsEventsOptions] = js.undefined
  ...
  /**
    ...
    * position properties.
    */
  var position: js.UndefOr[BreadcrumbsAlignOptions | PlotTreegraphBreadcrumbsPositionOptions] = js.undefined
  ...
  /**
    ...
    */
  var separator: js.UndefOr[PlotTreegraphBreadcrumbsSeparatorOptions] = js.undefined
...
object PlotTreegraphBreadcrumbsOptions {
  
  inline def apply(): PlotTreegraphBreadcrumbsOptions = {
  ...
  extension [Self <: PlotTreegraphBreadcrumbsOptions](x: Self) {
    ...
    inline def setButtonTheme(value: PlotTreegraphBreadcrumbsButtonThemeOptions | SVGAttributes): Self = StObject.set(x, "buttonTheme", value.asInstanceOf[js.Any])
    
    inline def setButtonThemeUndefined: Self = StObject.set(x, "buttonTheme", js.undefined)
    
    inline def setEvents(value: PlotTreegraphBreadcrumbsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setPosition(value: BreadcrumbsAlignOptions | PlotTreegraphBreadcrumbsPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
    ...
    inline def setSeparator(value: PlotTreegraphBreadcrumbsSeparatorOptions): Self = StObject.set(x, "separator", value.asInstanceOf[js.Any])
