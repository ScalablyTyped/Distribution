...
trait PlotPyramidSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotPyramidSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
