...
trait PlotAdSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotAdSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotAdSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
