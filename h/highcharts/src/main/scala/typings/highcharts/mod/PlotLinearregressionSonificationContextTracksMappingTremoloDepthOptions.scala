...
trait PlotLinearregressionSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
