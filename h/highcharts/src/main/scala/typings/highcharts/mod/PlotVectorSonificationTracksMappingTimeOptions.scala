...
trait PlotVectorSonificationTracksMappingTimeOptions extends StObject {
...
object PlotVectorSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotVectorSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVectorSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
