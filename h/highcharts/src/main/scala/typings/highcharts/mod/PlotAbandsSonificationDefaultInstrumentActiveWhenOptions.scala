...
trait PlotAbandsSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotAbandsSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
