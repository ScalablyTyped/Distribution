...
trait PlotDependencywheelStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotDependencywheelStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotDependencywheelStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotDependencywheelStatesHoverAnimationOptions = null,
  ...
  ): PlotDependencywheelStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelStatesHoverOptions]
  }
}
