...
@js.native
trait PlotMapDataLabelsAnimationOptions extends js.Object {
...
object PlotMapDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotMapDataLabelsAnimationOptionsOps[Self <: PlotMapDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
