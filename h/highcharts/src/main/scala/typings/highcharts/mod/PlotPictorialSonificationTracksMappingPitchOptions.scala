...
trait PlotPictorialSonificationTracksMappingPitchOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
