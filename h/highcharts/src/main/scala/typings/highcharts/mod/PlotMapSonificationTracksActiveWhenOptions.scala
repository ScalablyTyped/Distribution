...
trait PlotMapSonificationTracksActiveWhenOptions extends StObject {
...
object PlotMapSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotMapSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
