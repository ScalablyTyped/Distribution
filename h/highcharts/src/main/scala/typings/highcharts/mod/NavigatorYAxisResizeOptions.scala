...
trait NavigatorYAxisResizeOptions extends StObject {
  
  /**
    * (Highstock) Contains two arrays of axes that are controlled by control
    * line of the axis.
    */
  var controlledAxis: js.UndefOr[NavigatorYAxisResizeControlledAxisOptions] = js.undefined
...
object NavigatorYAxisResizeOptions {
  
  inline def apply(): NavigatorYAxisResizeOptions = {
