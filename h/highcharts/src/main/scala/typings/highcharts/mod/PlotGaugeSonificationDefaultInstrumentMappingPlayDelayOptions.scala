...
trait PlotGaugeSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotGaugeSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotGaugeSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
