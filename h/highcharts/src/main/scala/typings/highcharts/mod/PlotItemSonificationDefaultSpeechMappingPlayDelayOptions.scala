...
trait PlotItemSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotItemSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotItemSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
