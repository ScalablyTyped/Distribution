...
trait PlotPyramid3dSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
