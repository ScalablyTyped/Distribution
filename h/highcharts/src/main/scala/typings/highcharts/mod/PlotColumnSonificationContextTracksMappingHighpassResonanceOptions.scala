...
trait PlotColumnSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
