...
trait PlotNetworkgraphSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
