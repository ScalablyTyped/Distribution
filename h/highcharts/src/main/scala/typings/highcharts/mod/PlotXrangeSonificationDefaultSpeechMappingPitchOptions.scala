...
trait PlotXrangeSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotXrangeSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
