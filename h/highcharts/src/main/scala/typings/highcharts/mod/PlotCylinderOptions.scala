...
trait PlotCylinderOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotCylinderAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotCylinderOptions {
  ...
  @scala.inline
  implicit class PlotCylinderOptionsMutableBuilder[Self <: PlotCylinderOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotCylinderAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotCylinderDataLabelsOptions | js.Array[PlotCylinderDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotCylinderDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotCylinderDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
