...
trait PlotWmaPointEventsOptions extends js.Object {
  /**
...
object PlotWmaPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotWmaPointEventsOptions]
  }
}
