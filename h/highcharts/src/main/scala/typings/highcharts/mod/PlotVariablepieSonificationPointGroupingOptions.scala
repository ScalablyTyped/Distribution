...
trait PlotVariablepieSonificationPointGroupingOptions extends StObject {
...
object PlotVariablepieSonificationPointGroupingOptions {
  
  inline def apply(): PlotVariablepieSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
