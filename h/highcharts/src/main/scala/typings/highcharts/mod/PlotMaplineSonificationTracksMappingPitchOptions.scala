...
trait PlotMaplineSonificationTracksMappingPitchOptions extends StObject {
...
object PlotMaplineSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotMaplineSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
