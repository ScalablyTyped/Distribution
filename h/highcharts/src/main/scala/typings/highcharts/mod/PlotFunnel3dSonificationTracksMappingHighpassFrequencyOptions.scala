...
trait PlotFunnel3dSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotFunnel3dSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
