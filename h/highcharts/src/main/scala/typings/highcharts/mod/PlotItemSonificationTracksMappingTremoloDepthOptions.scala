...
trait PlotItemSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotItemSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
