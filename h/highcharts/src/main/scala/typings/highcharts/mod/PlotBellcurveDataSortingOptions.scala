...
@js.native
trait PlotBellcurveDataSortingOptions extends StObject {
...
object PlotBellcurveDataSortingOptions {
  
  @scala.inline
  def apply(): PlotBellcurveDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotBellcurveDataSortingOptionsMutableBuilder[Self <: PlotBellcurveDataSortingOptions] (val x: Self) extends AnyVal {
