...
@js.native
trait PlotBellcurveDataSortingOptions extends js.Object {
  /**
...
object PlotBellcurveDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotBellcurveDataSortingOptionsOps[Self <: PlotBellcurveDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
