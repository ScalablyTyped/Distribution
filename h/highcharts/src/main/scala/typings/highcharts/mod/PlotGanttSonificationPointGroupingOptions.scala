...
trait PlotGanttSonificationPointGroupingOptions extends StObject {
...
object PlotGanttSonificationPointGroupingOptions {
  
  inline def apply(): PlotGanttSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
