...
trait PlotDisparityindexSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
