...
trait PlotXrangeSonificationDefaultInstrumentOptions extends StObject {
  
  /**
    * (Highcharts, Highstock, Gantt) Define a condition for when a track should
    * be active and not.
    *
  ...
  var activeWhen: js.UndefOr[
    js.Object | js.Function | PlotXrangeSonificationDefaultInstrumentActiveWhenOptions
  ] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) Instrument to use for playing.
    *
  ...
  /**
    * (Highcharts, Highstock, Gantt) Mapping options for the audio parameters.
    *
    ...
    */
  var mapping: js.UndefOr[PlotXrangeSonificationDefaultInstrumentMappingOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) Name to use for a track when exporting to
    * MIDI. By default it uses the series name if the track is related to a
    * series.
    */
  var midiName: js.UndefOr[String] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) Options for point grouping, specifically
    * for instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotXrangeSonificationDefaultInstrumentPointGroupingOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) Round pitch mapping to musical notes.
    *
  ...
  /**
    * (Highcharts, Highstock, Gantt) Show play marker (tooltip and/or
    * crosshair) for a track.
    */
  var showPlayMarker: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) Type of track. Always `"instrument"` for
    * instrument tracks, and `"speech"` for speech tracks.
    */
  var `type`: js.UndefOr[OptionsTypeValue] = js.undefined
}
object PlotXrangeSonificationDefaultInstrumentOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultInstrumentOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultInstrumentOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultInstrumentOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotXrangeSonificationDefaultInstrumentActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotXrangeSonificationDefaultInstrumentMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotXrangeSonificationDefaultInstrumentPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
