...
trait PlotLinearregressionangleSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotLinearregressionangleSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
