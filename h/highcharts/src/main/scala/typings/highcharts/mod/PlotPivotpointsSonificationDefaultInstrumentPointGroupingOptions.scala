...
trait PlotPivotpointsSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
