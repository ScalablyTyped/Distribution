...
trait PlotPpoSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotPpoSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotPpoSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
