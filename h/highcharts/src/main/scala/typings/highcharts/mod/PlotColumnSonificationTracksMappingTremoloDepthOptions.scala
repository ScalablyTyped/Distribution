...
trait PlotColumnSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotColumnSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
