...
trait PlotSankeySonificationTracksActiveWhenOptions extends StObject {
...
object PlotSankeySonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotSankeySonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeySonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeySonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
