...
trait PlotPcSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotPcSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotPcSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
