...
trait PlotNetworkgraphSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
