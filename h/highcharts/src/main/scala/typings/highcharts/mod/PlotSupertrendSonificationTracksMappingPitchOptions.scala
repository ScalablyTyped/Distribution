...
trait PlotSupertrendSonificationTracksMappingPitchOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
