...
trait PlotPcSonificationTracksMappingPitchOptions extends StObject {
...
object PlotPcSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
