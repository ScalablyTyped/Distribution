...
trait PlotBubbleSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotBubbleSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotBubbleSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
