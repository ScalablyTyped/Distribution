...
trait PlotAoSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotAoSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
