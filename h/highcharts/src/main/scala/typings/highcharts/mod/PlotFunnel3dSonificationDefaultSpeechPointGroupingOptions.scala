...
trait PlotFunnel3dSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
