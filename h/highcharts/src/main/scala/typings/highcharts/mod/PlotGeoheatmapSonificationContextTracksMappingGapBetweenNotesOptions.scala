...
trait PlotGeoheatmapSonificationContextTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
