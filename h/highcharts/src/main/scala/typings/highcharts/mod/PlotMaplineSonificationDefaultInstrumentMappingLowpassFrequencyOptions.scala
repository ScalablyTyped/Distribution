...
trait PlotMaplineSonificationDefaultInstrumentMappingLowpassFrequencyOptions extends StObject {
...
object PlotMaplineSonificationDefaultInstrumentMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotMaplineSonificationDefaultInstrumentMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationDefaultInstrumentMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationDefaultInstrumentMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
