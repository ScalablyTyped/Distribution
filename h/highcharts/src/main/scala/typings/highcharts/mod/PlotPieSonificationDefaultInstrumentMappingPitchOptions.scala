...
trait PlotPieSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotPieSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotPieSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
