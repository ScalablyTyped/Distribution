...
trait PlotIkhSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotIkhSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
