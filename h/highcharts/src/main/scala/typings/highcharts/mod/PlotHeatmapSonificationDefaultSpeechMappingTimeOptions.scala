...
trait PlotHeatmapSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotHeatmapSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
