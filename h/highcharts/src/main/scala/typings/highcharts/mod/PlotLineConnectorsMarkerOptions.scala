...
trait PlotLineConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotLineConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLineConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLineConnectorsMarkerOptions]
  }
}
