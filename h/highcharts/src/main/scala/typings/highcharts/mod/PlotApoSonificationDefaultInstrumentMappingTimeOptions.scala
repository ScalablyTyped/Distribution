...
trait PlotApoSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotApoSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotApoSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
