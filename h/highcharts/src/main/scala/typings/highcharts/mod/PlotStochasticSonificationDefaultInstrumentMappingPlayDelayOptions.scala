...
trait PlotStochasticSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotStochasticSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
