...
trait PlotBulletSonificationTracksMappingRateOptions extends StObject {
...
object PlotBulletSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
