...
trait PlotCciSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotCciSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
