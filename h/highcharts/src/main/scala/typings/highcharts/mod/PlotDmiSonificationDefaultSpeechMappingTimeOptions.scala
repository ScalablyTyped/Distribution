...
trait PlotDmiSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotDmiSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotDmiSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
