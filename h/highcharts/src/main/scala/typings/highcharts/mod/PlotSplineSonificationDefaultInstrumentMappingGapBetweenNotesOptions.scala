...
trait PlotSplineSonificationDefaultInstrumentMappingGapBetweenNotesOptions extends StObject {
...
object PlotSplineSonificationDefaultInstrumentMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotSplineSonificationDefaultInstrumentMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultInstrumentMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultInstrumentMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
