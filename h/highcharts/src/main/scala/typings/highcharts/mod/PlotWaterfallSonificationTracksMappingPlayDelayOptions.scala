...
trait PlotWaterfallSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotWaterfallSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotWaterfallSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
