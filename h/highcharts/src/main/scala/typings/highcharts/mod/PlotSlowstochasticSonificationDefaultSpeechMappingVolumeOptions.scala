...
trait PlotSlowstochasticSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
