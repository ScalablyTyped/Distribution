...
trait PlotOhlcSonificationPointGroupingOptions extends StObject {
...
object PlotOhlcSonificationPointGroupingOptions {
  
  inline def apply(): PlotOhlcSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOhlcSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
