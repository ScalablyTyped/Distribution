...
trait PlotVwapTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotVwapTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotVwapTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotVwapTooltipDateTimeLabelFormatsOptions]
  }
}
