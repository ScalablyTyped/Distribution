...
trait PlotHeatmapSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotHeatmapSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
