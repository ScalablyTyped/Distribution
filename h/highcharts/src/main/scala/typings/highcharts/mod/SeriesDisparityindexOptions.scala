...
import typings.highcharts.highchartsStrings.disparityindex
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesDisparityindexOptions
  extends StObject
     with PlotDisparityindexOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | disparityindex
...
object SeriesDisparityindexOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | disparityindex): SeriesDisparityindexOptions = {
    val __obj = js.Dynamic.literal(dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesDisparityindexOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesDisparityindexOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | disparityindex): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
