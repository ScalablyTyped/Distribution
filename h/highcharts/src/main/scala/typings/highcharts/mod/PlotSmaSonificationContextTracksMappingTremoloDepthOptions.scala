...
trait PlotSmaSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotSmaSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
