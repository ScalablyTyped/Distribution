...
trait PlotAtrSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotAtrSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
