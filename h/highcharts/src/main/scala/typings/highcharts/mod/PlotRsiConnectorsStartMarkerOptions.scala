...
trait PlotRsiConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotRsiConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRsiConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotRsiConnectorsStartMarkerOptions]
  }
}
