...
trait PlotLinearregressionangleSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
