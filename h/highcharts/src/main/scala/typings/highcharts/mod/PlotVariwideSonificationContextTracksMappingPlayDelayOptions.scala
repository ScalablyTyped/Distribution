...
trait PlotVariwideSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotVariwideSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
