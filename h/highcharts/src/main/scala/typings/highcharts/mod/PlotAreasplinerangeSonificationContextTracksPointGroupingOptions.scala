...
trait PlotAreasplinerangeSonificationContextTracksPointGroupingOptions extends StObject {
  
  /**
    * (Highcharts, Highstock) The grouping algorithm, deciding which points to
    * keep when grouping a set of points together. By default `"minmax"` is
  ...
  /**
    * (Highcharts, Highstock) Whether or not to group points
    */
  var enabled: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Highcharts, Highstock) The size of each group in milliseconds. Audio
    * events closer than this are grouped together.
    */
  var groupTimespan: js.UndefOr[Double] = js.undefined
  
  /**
    * (Highcharts, Highstock) The data property for each point to compare when
    * deciding which points to keep in the group.
    *
...
object PlotAreasplinerangeSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotAreasplinerangeSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplinerangeSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
