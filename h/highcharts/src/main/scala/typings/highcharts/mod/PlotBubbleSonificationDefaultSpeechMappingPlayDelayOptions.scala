...
trait PlotBubbleSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotBubbleSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
