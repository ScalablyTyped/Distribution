...
trait PlotAdSonificationPointGroupingOptions extends StObject {
...
object PlotAdSonificationPointGroupingOptions {
  
  inline def apply(): PlotAdSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
