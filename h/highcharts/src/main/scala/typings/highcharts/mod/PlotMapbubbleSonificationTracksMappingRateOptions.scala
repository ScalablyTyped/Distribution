...
trait PlotMapbubbleSonificationTracksMappingRateOptions extends StObject {
...
object PlotMapbubbleSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotMapbubbleSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
