...
trait PlotAreasplineSonificationPointGroupingOptions extends StObject {
...
object PlotAreasplineSonificationPointGroupingOptions {
  
  inline def apply(): PlotAreasplineSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplineSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
