...
trait PlotPsarSonificationTracksActiveWhenOptions extends StObject {
...
object PlotPsarSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotPsarSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
