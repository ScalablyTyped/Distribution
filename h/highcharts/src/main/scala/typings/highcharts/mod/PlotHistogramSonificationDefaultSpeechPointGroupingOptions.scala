...
trait PlotHistogramSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotHistogramSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
