...
object NavigatorXAxisPlotBandsLabelOptions {
  ...
  inline def apply(): NavigatorXAxisPlotBandsLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisPlotBandsLabelOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NavigatorXAxisPlotBandsLabelOptions] (val x: Self) extends AnyVal {
