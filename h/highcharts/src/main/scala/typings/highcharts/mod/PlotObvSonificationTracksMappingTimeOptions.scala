...
trait PlotObvSonificationTracksMappingTimeOptions extends StObject {
...
object PlotObvSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotObvSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotObvSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotObvSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
