...
trait PlotXrangeSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotXrangeSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
