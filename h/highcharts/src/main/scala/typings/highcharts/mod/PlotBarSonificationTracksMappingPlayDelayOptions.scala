...
trait PlotBarSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotBarSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
