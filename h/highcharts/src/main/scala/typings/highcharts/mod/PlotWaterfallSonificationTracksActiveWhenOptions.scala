...
trait PlotWaterfallSonificationTracksActiveWhenOptions extends StObject {
...
object PlotWaterfallSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotWaterfallSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
