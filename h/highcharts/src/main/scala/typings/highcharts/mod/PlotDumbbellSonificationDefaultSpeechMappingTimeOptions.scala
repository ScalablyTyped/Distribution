...
trait PlotDumbbellSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotDumbbellSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
