...
trait PlotTemaSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotTemaSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
