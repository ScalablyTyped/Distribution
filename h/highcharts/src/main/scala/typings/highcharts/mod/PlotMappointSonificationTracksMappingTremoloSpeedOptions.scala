...
trait PlotMappointSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotMappointSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
