...
trait PlotArearangeSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotArearangeSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotArearangeSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
