...
trait PlotDependencywheelSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
