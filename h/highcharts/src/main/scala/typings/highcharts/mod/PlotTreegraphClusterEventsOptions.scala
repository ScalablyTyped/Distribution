...
trait PlotTreegraphClusterEventsOptions extends StObject {
...
object PlotTreegraphClusterEventsOptions {
  
  inline def apply(): PlotTreegraphClusterEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphClusterEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphClusterEventsOptions] (val x: Self) extends AnyVal {
