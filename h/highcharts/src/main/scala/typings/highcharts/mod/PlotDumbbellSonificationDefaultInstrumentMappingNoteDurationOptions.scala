...
trait PlotDumbbellSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotDumbbellSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
