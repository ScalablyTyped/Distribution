...
trait PlotOhlcConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotOhlcConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotOhlcConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotOhlcConnectorsMarkerOptions]
  }
}
