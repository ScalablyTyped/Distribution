...
trait PlotTreemapSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotTreemapSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
