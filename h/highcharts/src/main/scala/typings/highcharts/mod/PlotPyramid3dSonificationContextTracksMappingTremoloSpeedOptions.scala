...
trait PlotPyramid3dSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
