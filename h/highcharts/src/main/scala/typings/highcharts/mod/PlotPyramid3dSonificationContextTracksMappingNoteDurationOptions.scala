...
trait PlotPyramid3dSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
