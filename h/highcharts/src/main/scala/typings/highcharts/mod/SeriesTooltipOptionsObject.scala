...
trait SeriesTooltipOptionsObject extends StObject {
  ...
  /**
    * (Highstock) Enable or disable animation of the tooltip.
    */
  var animation: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Highstock) The background color or gradient for the tooltip.
    *
  ...
  /**
    * (Highstock) The color of the tooltip border. When `undefined`, the border
    * takes the color of the corresponding series or point.
    */
  var borderColor: js.UndefOr[ColorString | GradientColorObject | PatternObject] = js.undefined
  
  /**
    * (Highstock) The radius of the rounded border corners.
    */
  var borderRadius: js.UndefOr[Double] = js.undefined
  
  /**
    * (Highstock) The pixel width of the tooltip border.
    *
    * In styled mode, the stroke width is set in the `.highcharts-tooltip-box`
    * class.
    */
  ...
  /**
    * (Highstock) Enable or disable the tooltip.
    */
  ...
  /**
    * (Highstock) Callback function to format the text of the tooltip from
    * scratch. In case of single or shared tooltips, a string should be
    * returned. In case of split tooltips, it should return an array where the
    * first item is the header, and subsequent items are mapped to the points.
  ...
  /**
    * (Highstock) A callback function to place the tooltip in a custom
    * position. The callback receives three parameters: `labelWidth`,
  ...
  /**
    * (Highstock) Whether to apply a drop shadow to the tooltip.
    */
  ...
  /**
    ...
    * tooltip. Can be one of: `"callout"`, `"circle"` or `"rect"`. When
    * tooltip.split option is enabled, shape is applied to all boxes except
    * header, which is controlled by tooltip.headerShape.
    *
    * Custom callbacks for symbol path generation can also be added to
    * `Highcharts.SVGRenderer.prototype.symbols` the same way as for
    * series.marker.symbol.
  ...
  /**
    * (Highstock) CSS styles for the tooltip. The tooltip can also be styled
    * through the CSS class `.highcharts-tooltip`.
    *
  ...
  /**
    * (Highstock) Use HTML to render the contents of the tooltip instead of
