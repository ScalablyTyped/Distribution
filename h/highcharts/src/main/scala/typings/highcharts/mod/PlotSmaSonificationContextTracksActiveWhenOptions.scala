...
trait PlotSmaSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotSmaSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
