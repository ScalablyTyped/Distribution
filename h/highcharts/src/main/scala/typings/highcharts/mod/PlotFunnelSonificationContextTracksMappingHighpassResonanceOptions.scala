...
trait PlotFunnelSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotFunnelSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
