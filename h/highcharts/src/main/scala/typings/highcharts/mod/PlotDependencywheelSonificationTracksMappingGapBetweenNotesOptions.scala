...
trait PlotDependencywheelSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
