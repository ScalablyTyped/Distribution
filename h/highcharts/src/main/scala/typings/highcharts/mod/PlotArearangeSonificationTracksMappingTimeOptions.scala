...
trait PlotArearangeSonificationTracksMappingTimeOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
