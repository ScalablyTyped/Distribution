...
@js.native
trait PlotMfiDataLabelsOptions extends js.Object {
...
object PlotMfiDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotMfiDataLabelsOptionsOps[Self <: PlotMfiDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMfiDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
