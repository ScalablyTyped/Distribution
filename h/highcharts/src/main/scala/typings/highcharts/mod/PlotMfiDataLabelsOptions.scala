...
object PlotMfiDataLabelsOptions {
  ...
  inline def apply(): PlotMfiDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiDataLabelsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMfiDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotMfiDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
