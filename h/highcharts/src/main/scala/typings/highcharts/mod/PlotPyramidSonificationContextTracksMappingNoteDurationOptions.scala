...
trait PlotPyramidSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotPyramidSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
