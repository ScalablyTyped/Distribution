...
trait PlotKlingerSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotKlingerSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
