...
trait PlotDisparityindexSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
