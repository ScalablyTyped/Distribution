...
trait PlotStochasticSonificationTracksPointGroupingOptions extends StObject {
...
object PlotStochasticSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotStochasticSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
