...
trait PlotBubbleClusterEventsOptions extends StObject {
...
object PlotBubbleClusterEventsOptions {
  
  inline def apply(): PlotBubbleClusterEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleClusterEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleClusterEventsOptions] (val x: Self) extends AnyVal {
