...
trait SeriesFlowMapSeriesOptionsObject extends StObject {
...
object SeriesFlowMapSeriesOptionsObject {
  
  inline def apply(): SeriesFlowMapSeriesOptionsObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesFlowMapSeriesOptionsObject]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesFlowMapSeriesOptionsObject] (val x: Self) extends AnyVal {
