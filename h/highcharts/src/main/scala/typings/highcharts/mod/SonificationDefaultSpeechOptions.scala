...
trait SonificationDefaultSpeechOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | SonificationDefaultSpeechActiveWhenOptions] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[SonificationDefaultSpeechMappingOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock, Highmaps, Gantt) Options for point grouping,
    * specifically for instrument tracks.
    */
  var pointGrouping: js.UndefOr[SonificationDefaultSpeechPointGroupingOptions] = js.undefined
...
object SonificationDefaultSpeechOptions {
  
  inline def apply(): SonificationDefaultSpeechOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultSpeechOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultSpeechOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | SonificationDefaultSpeechActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: SonificationDefaultSpeechMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    
    inline def setMappingUndefined: Self = StObject.set(x, "mapping", js.undefined)
    
    inline def setPointGrouping(value: SonificationDefaultSpeechPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
