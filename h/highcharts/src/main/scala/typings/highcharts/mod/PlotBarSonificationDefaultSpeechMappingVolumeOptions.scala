...
trait PlotBarSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotBarSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotBarSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
