...
trait PlotDependencywheelSonificationTracksMappingPanOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
