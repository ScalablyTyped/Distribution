...
trait PlotCmoSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotCmoSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotCmoSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
