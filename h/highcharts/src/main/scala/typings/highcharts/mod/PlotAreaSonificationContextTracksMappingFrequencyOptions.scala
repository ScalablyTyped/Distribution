...
trait PlotAreaSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotAreaSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotAreaSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
