...
trait PlotDependencywheelSonificationPointGroupingOptions extends StObject {
...
object PlotDependencywheelSonificationPointGroupingOptions {
  
  inline def apply(): PlotDependencywheelSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
