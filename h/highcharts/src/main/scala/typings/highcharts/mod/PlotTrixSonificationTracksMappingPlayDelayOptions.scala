...
trait PlotTrixSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotTrixSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
