...
trait PlotVennSonificationTracksMappingPitchOptions extends StObject {
...
object PlotVennSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
