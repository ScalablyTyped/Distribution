...
trait PlotLinearregressionSonificationTracksMappingTimeOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
