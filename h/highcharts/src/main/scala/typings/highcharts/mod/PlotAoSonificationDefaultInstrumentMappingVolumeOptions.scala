...
trait PlotAoSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotAoSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotAoSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
