...
trait PlotFlagsSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotFlagsSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
