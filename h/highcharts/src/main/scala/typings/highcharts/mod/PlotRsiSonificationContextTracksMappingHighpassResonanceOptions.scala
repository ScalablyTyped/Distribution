...
trait PlotRsiSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotRsiSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
