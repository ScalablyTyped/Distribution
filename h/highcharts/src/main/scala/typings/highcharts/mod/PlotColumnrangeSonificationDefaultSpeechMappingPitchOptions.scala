...
trait PlotColumnrangeSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
