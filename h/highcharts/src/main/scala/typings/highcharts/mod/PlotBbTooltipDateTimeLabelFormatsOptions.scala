...
trait PlotBbTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotBbTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotBbTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotBbTooltipDateTimeLabelFormatsOptions]
  }
}
