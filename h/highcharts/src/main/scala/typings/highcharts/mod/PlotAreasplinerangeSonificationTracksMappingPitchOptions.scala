...
trait PlotAreasplinerangeSonificationTracksMappingPitchOptions extends StObject {
...
object PlotAreasplinerangeSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotAreasplinerangeSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplinerangeSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
