...
trait PlotVariwideSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotVariwideSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
