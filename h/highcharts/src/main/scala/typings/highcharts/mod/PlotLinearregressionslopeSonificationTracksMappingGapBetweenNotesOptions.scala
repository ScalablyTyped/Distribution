...
trait PlotLinearregressionslopeSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
