...
trait PlotLinearregressionSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotLinearregressionSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
