...
trait PlotHeikinashiOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotHeikinashiAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotHeikinashiDataLabelsOptions | js.Array[PlotHeikinashiDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotHeikinashiDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotHeikinashiOnPointOptions] = js.undefined
...
object PlotHeikinashiOptions {
  
  inline def apply(): PlotHeikinashiOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeikinashiOptions]
  }
  
  extension [Self <: PlotHeikinashiOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotHeikinashiAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotHeikinashiDataLabelsOptions | js.Array[PlotHeikinashiDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotHeikinashiDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotHeikinashiDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotHeikinashiOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setUpLineColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "upLineColor", value.asInstanceOf[js.Any])
