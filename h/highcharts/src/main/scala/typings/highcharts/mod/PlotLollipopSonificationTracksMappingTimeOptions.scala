...
trait PlotLollipopSonificationTracksMappingTimeOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
