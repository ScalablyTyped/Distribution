...
trait PlotIkhSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotIkhSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
