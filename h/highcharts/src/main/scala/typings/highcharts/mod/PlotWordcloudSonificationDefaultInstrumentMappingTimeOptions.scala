...
trait PlotWordcloudSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotWordcloudSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
