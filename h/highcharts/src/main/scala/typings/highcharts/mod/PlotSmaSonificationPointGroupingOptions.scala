...
trait PlotSmaSonificationPointGroupingOptions extends StObject {
...
object PlotSmaSonificationPointGroupingOptions {
  
  inline def apply(): PlotSmaSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
