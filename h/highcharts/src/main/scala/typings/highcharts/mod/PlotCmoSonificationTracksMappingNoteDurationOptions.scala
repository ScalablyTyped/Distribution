...
trait PlotCmoSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotCmoSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
