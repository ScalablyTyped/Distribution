...
trait PlotMfiSonificationTracksMappingTimeOptions extends StObject {
...
object PlotMfiSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotMfiSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMfiSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
