...
trait PlotPpoSonificationTracksActiveWhenOptions extends StObject {
...
object PlotPpoSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotPpoSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
