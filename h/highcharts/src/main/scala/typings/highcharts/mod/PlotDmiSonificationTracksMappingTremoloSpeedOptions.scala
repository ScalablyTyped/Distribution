...
trait PlotDmiSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotDmiSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
