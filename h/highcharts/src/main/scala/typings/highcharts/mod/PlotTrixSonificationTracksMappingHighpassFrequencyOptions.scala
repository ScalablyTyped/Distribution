...
trait PlotTrixSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotTrixSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
