...
trait PlotLinearregressionslopeSonificationTracksMappingRateOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
