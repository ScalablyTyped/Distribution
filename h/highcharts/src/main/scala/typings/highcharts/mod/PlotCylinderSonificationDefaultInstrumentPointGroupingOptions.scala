...
trait PlotCylinderSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotCylinderSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
