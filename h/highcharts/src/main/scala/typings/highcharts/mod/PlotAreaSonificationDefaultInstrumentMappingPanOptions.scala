...
trait PlotAreaSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotAreaSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotAreaSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
