...
trait PlotWordcloudSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotWordcloudSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
