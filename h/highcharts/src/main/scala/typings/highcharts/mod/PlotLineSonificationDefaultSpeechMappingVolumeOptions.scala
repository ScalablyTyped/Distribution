...
trait PlotLineSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotLineSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotLineSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
