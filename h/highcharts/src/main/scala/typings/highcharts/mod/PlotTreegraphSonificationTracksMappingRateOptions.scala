...
trait PlotTreegraphSonificationTracksMappingRateOptions extends StObject {
...
object PlotTreegraphSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotTreegraphSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
