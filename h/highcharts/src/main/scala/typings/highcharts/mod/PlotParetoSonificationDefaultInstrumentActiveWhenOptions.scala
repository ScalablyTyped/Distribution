...
trait PlotParetoSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotParetoSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotParetoSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
