...
trait PlotFunnelSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotFunnelSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
