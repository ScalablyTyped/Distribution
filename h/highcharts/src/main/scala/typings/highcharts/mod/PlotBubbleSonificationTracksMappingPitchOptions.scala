...
trait PlotBubbleSonificationTracksMappingPitchOptions extends StObject {
...
object PlotBubbleSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotBubbleSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
