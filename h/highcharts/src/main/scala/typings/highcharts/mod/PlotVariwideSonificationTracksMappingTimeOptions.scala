...
trait PlotVariwideSonificationTracksMappingTimeOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
