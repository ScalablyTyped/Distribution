...
trait PlotPcSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotPcSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
