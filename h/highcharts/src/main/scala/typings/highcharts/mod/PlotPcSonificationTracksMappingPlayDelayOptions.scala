...
trait PlotPcSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotPcSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
