...
trait PlotFunnelSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotFunnelSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
