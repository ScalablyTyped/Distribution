...
trait PlotArearangeSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotArearangeSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
