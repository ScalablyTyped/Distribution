...
trait PlotKeltnerchannelsDataGroupingOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsDataGroupingOptions]
  }
}
