...
trait PlotGeoheatmapSonificationTracksMappingPitchOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
