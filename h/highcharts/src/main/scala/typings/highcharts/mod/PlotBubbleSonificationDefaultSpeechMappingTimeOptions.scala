...
trait PlotBubbleSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotBubbleSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
