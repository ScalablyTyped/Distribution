...
trait PlotDependencywheelSonificationTracksMappingRateOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
