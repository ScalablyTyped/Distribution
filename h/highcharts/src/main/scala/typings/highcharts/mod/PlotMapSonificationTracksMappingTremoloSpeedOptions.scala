...
trait PlotMapSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotMapSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
