...
trait PlotColumnSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotColumnSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
