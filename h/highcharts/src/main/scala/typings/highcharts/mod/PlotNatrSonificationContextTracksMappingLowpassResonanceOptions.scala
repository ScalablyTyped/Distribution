...
trait PlotNatrSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
