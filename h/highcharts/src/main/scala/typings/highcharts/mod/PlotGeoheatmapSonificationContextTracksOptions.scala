...
trait PlotGeoheatmapSonificationContextTracksOptions extends StObject {
  ...
  var activeWhen: js.UndefOr[
    js.Object | js.Function | PlotGeoheatmapSonificationContextTracksActiveWhenOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[PlotGeoheatmapSonificationContextTracksMappingOptions] = js.undefined
  ...
  /**
    ...
    * tracks.
    */
  var pointGrouping: js.UndefOr[PlotGeoheatmapSonificationContextTracksPointGroupingOptions] = js.undefined
...
object PlotGeoheatmapSonificationContextTracksOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotGeoheatmapSonificationContextTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotGeoheatmapSonificationContextTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotGeoheatmapSonificationContextTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
