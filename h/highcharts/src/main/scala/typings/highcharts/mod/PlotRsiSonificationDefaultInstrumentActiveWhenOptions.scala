...
trait PlotRsiSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotRsiSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotRsiSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
