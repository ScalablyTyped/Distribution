...
trait PlotScatter3dClusterLayoutAlgorithmOptions extends StObject {
...
object PlotScatter3dClusterLayoutAlgorithmOptions {
  
  inline def apply(): PlotScatter3dClusterLayoutAlgorithmOptions = {
