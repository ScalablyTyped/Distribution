...
trait PlotSplineSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
