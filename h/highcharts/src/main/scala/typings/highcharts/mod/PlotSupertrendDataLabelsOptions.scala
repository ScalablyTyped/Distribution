...
trait PlotSupertrendDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotSupertrendDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotSupertrendDataLabelsOptions {
  ...
  inline def apply(): PlotSupertrendDataLabelsOptions = {
  ...
  extension [Self <: PlotSupertrendDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotSupertrendDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
