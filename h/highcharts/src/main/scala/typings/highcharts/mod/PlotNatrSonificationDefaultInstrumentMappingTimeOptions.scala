...
trait PlotNatrSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotNatrSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotNatrSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
