...
trait PlotMfiSonificationPointGroupingOptions extends StObject {
...
object PlotMfiSonificationPointGroupingOptions {
  
  inline def apply(): PlotMfiSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMfiSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
