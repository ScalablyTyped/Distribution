...
trait PlotHistogramSonificationDefaultInstrumentMappingTremoloDepthOptions extends StObject {
...
object PlotHistogramSonificationDefaultInstrumentMappingTremoloDepthOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultInstrumentMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultInstrumentMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultInstrumentMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
