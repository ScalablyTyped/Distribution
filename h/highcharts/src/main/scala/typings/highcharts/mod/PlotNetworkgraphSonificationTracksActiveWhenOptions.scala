...
trait PlotNetworkgraphSonificationTracksActiveWhenOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
