...
trait PlotPolygonSonificationTracksMappingRateOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
