...
trait PlotHeatmapSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotHeatmapSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
