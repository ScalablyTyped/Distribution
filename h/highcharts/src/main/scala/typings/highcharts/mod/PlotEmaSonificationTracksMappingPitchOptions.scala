...
trait PlotEmaSonificationTracksMappingPitchOptions extends StObject {
...
object PlotEmaSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
