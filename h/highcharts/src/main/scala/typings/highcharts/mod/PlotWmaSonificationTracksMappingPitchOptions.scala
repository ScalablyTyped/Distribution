...
trait PlotWmaSonificationTracksMappingPitchOptions extends StObject {
...
object PlotWmaSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
