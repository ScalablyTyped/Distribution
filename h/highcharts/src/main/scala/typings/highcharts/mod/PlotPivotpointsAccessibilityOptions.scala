...
trait PlotPivotpointsAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPivotpointsAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotPivotpointsAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotPivotpointsAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotPivotpointsAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsAccessibilityOptions]
  }
}
