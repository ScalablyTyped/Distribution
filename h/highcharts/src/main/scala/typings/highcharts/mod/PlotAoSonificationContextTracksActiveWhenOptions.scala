...
trait PlotAoSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotAoSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotAoSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
