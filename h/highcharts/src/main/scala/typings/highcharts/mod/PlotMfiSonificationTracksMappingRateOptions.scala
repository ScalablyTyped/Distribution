...
trait PlotMfiSonificationTracksMappingRateOptions extends StObject {
...
object PlotMfiSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotMfiSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMfiSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
