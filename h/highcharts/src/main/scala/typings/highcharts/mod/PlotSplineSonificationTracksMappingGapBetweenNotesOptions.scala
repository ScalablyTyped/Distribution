...
trait PlotSplineSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotSplineSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
