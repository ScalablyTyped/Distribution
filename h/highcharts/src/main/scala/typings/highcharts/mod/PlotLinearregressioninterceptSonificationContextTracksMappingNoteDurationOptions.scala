...
trait PlotLinearregressioninterceptSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
