...
trait PlotDmiSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotDmiSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotDmiSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
