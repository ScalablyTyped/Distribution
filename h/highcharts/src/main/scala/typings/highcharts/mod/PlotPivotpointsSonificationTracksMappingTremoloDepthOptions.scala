...
trait PlotPivotpointsSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
