...
trait PlotDependencywheelSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
