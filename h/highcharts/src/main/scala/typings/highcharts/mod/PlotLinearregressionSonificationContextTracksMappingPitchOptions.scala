...
trait PlotLinearregressionSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
