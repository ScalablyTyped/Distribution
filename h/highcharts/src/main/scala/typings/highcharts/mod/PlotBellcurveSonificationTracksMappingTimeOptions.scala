...
trait PlotBellcurveSonificationTracksMappingTimeOptions extends StObject {
...
object PlotBellcurveSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotBellcurveSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBellcurveSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
