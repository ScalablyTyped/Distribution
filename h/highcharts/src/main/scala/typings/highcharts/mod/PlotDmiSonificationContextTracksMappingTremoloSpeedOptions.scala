...
trait PlotDmiSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
