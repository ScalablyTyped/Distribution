...
trait PlotPpoSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotPpoSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotPpoSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
