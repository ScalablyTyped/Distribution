...
trait PlotPyramid3dSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
