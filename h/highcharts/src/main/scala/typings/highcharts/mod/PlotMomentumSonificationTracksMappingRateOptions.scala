...
trait PlotMomentumSonificationTracksMappingRateOptions extends StObject {
...
object PlotMomentumSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotMomentumSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMomentumSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
