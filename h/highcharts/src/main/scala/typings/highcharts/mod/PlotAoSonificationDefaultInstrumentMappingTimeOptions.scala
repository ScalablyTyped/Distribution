...
trait PlotAoSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotAoSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotAoSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
