...
trait PlotTemaSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotTemaSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotTemaSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
