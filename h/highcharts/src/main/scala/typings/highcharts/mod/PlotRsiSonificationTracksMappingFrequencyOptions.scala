...
trait PlotRsiSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotRsiSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
