...
trait PlotTrendlineSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
