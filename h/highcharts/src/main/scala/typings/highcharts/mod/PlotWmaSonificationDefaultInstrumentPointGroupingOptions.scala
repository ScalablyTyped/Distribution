...
trait PlotWmaSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotWmaSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotWmaSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
