...
trait PlotHeatmapSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotHeatmapSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
