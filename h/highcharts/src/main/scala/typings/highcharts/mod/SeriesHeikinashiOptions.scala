...
import typings.highcharts.highchartsStrings.heikinashi
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesHeikinashiOptions
  extends StObject
     with PlotHeikinashiOptions {
...
object SeriesHeikinashiOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | heikinashi): SeriesHeikinashiOptions = {
  ...
  implicit open class MutableBuilder[Self <: SeriesHeikinashiOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | heikinashi): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
