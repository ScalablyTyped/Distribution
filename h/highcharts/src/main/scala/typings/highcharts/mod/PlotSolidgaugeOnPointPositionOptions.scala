...
trait PlotSolidgaugeOnPointPositionOptions extends StObject {
...
object PlotSolidgaugeOnPointPositionOptions {
  
  inline def apply(): PlotSolidgaugeOnPointPositionOptions = {
