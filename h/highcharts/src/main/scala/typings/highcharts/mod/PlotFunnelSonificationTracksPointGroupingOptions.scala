...
trait PlotFunnelSonificationTracksPointGroupingOptions extends StObject {
...
object PlotFunnelSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotFunnelSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
