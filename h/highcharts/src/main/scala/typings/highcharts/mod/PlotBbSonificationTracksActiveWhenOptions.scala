...
trait PlotBbSonificationTracksActiveWhenOptions extends StObject {
...
object PlotBbSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotBbSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBbSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
