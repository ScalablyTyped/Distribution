...
trait PlotCmoSonificationPointGroupingOptions extends StObject {
...
object PlotCmoSonificationPointGroupingOptions {
  
  inline def apply(): PlotCmoSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
