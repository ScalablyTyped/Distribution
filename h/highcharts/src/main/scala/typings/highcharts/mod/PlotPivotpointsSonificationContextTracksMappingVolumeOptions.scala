...
trait PlotPivotpointsSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
