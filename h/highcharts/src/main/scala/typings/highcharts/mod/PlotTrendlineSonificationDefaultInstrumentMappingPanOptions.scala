...
trait PlotTrendlineSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotTrendlineSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
