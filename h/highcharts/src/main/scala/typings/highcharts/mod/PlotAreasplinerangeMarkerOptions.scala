...
trait PlotAreasplinerangeMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAreasplinerangeMarkerStatesOptions] = js.undefined
  /**
...
object PlotAreasplinerangeMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAreasplinerangeMarkerStatesOptions = null,
    symbol: String = null,
    ...
    __obj.asInstanceOf[PlotAreasplinerangeMarkerOptions]
  }
}
