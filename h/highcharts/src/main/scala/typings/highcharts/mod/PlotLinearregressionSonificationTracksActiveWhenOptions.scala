...
trait PlotLinearregressionSonificationTracksActiveWhenOptions extends StObject {
...
object PlotLinearregressionSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
