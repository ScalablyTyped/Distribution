...
trait PlotLinearregressionSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
