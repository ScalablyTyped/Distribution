...
trait PlotPieSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotPieSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPieSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
