...
trait PlotGanttSonificationTracksMappingRateOptions extends StObject {
...
object PlotGanttSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
