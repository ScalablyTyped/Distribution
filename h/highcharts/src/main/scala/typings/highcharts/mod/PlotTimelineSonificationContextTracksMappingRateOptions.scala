...
trait PlotTimelineSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
