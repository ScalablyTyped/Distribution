...
trait PlotKlingerSonificationTracksMappingRateOptions extends StObject {
...
object PlotKlingerSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotKlingerSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
