...
trait PlotBulletSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotBulletSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
