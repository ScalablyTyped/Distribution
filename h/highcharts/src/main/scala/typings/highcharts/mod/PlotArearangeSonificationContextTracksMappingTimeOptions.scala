...
trait PlotArearangeSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotArearangeSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotArearangeSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
