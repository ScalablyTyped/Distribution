...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesTimelineOptions
  extends StObject
     with PlotTimelineOptions {
...
object SeriesTimelineOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | timeline): SeriesTimelineOptions = {
  ...
  extension [Self <: SeriesTimelineOptions](x: Self) {
    ...
    inline def setDataVarargs(value: PointOptionsObject*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    inline def setType(value: String | timeline): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
