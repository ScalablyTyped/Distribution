...
trait PlotNatrSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotNatrSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotNatrSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
