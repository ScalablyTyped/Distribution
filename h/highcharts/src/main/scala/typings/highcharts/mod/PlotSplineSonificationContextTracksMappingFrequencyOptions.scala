...
trait PlotSplineSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
