...
trait PlotBulletConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotBulletConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBulletConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBulletConnectorsMarkerOptions]
  }
}
