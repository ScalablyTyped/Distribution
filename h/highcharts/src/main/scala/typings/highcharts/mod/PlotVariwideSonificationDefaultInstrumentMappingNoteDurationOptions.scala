...
trait PlotVariwideSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotVariwideSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
