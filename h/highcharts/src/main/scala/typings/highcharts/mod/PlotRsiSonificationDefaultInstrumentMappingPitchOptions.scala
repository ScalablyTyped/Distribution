...
trait PlotRsiSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotRsiSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotRsiSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
