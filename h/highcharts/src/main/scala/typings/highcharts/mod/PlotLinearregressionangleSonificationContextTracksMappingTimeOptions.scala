...
trait PlotLinearregressionangleSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
