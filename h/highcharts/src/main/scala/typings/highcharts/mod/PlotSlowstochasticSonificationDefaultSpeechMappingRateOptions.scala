...
trait PlotSlowstochasticSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
