...
trait PlotXrangeSonificationPointGroupingOptions extends StObject {
...
object PlotXrangeSonificationPointGroupingOptions {
  
  inline def apply(): PlotXrangeSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
