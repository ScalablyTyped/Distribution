...
trait PlotColumnrangeSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotColumnrangeSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotColumnrangeSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
