...
trait PlotGaugeSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
