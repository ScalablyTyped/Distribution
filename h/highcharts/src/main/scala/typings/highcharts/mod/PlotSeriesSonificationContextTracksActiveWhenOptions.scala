...
trait PlotSeriesSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotSeriesSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
