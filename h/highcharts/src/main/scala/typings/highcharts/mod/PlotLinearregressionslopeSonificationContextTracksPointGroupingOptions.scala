...
trait PlotLinearregressionslopeSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotLinearregressionslopeSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
