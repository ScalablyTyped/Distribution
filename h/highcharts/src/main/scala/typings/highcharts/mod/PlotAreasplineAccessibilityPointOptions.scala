...
trait PlotAreasplineAccessibilityPointOptions extends StObject {
...
object PlotAreasplineAccessibilityPointOptions {
  
  inline def apply(): PlotAreasplineAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplineAccessibilityPointOptions] (val x: Self) extends AnyVal {
