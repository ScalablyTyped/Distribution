...
trait PlotFunnelOptions extends StObject {
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotFunnelDataSortingOptions] = js.undefined
...
object PlotFunnelOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotFunnelOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotFunnelDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
