...
trait PlotFunnelOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotFunnelSonificationOptions] = js.undefined
...
object PlotFunnelOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotFunnelOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotFunnelSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
