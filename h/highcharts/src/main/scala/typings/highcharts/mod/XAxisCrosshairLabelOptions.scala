...
trait XAxisCrosshairLabelOptions extends js.Object {
  /**
...
object XAxisCrosshairLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[XAxisCrosshairLabelOptions]
  }
}
