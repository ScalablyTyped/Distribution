...
trait PlotTemaSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotTemaSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
