...
trait PlotParetoSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotParetoSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotParetoSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
