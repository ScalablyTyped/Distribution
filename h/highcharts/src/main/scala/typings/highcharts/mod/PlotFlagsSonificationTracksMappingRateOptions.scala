...
trait PlotFlagsSonificationTracksMappingRateOptions extends StObject {
...
object PlotFlagsSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotFlagsSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
