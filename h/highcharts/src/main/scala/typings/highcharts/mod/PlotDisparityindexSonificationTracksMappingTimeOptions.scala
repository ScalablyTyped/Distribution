...
trait PlotDisparityindexSonificationTracksMappingTimeOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
