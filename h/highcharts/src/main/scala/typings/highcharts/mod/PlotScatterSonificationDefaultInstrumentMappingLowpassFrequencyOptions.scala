...
trait PlotScatterSonificationDefaultInstrumentMappingLowpassFrequencyOptions extends StObject {
...
object PlotScatterSonificationDefaultInstrumentMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotScatterSonificationDefaultInstrumentMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterSonificationDefaultInstrumentMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatterSonificationDefaultInstrumentMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
