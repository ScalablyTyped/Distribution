...
trait PlotPcSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotPcSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotPcSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
