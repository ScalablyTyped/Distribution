...
trait PlotTrendlineSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotTrendlineSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
