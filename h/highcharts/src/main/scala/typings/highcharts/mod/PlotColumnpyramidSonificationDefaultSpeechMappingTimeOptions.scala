...
trait PlotColumnpyramidSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
