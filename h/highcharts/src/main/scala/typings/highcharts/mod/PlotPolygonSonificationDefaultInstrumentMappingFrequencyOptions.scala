...
trait PlotPolygonSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotPolygonSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
