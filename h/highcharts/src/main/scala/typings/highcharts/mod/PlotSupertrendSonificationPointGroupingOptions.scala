...
trait PlotSupertrendSonificationPointGroupingOptions extends StObject {
...
object PlotSupertrendSonificationPointGroupingOptions {
  
  inline def apply(): PlotSupertrendSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
