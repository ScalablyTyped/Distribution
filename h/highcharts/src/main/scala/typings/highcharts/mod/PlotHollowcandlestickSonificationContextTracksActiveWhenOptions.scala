...
trait PlotHollowcandlestickSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotHollowcandlestickSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
