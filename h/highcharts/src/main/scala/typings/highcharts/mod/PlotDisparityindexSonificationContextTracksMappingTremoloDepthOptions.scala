...
trait PlotDisparityindexSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
