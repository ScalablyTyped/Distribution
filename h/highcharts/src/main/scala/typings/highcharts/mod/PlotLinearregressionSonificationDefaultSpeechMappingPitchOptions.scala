...
trait PlotLinearregressionSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotLinearregressionSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotLinearregressionSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
