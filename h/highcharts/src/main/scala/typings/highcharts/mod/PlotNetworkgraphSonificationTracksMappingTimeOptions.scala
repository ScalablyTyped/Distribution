...
trait PlotNetworkgraphSonificationTracksMappingTimeOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
