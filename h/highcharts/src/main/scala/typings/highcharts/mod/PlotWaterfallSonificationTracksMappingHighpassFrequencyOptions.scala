...
trait PlotWaterfallSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotWaterfallSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotWaterfallSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
