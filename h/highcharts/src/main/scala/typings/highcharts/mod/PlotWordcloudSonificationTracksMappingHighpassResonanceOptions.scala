...
trait PlotWordcloudSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
