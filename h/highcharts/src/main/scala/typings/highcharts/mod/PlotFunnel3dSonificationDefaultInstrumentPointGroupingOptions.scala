...
trait PlotFunnel3dSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
