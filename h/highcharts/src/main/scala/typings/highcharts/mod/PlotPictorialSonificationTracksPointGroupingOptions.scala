...
trait PlotPictorialSonificationTracksPointGroupingOptions extends StObject {
...
object PlotPictorialSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotPictorialSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
