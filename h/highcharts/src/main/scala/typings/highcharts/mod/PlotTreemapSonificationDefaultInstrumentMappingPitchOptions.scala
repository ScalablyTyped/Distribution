...
trait PlotTreemapSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotTreemapSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
