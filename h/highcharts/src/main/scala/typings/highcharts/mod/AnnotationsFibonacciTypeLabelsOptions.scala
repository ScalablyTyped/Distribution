...
object AnnotationsFibonacciTypeLabelsOptions {
  ...
  @scala.inline
  def apply(): AnnotationsFibonacciTypeLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsFibonacciTypeLabelsOptions]
  }
  
  @scala.inline
  implicit class AnnotationsFibonacciTypeLabelsOptionsMutableBuilder[Self <: AnnotationsFibonacciTypeLabelsOptions] (val x: Self) extends AnyVal {
