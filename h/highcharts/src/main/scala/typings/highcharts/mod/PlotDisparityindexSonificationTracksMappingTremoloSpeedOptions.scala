...
trait PlotDisparityindexSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
