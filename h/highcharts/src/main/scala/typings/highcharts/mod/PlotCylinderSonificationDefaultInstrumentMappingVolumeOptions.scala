...
trait PlotCylinderSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotCylinderSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
