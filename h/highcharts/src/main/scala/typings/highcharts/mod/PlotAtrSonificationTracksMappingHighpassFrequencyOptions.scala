...
trait PlotAtrSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotAtrSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
