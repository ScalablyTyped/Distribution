...
trait PlotScatter3dSonificationPointGroupingOptions extends StObject {
...
object PlotScatter3dSonificationPointGroupingOptions {
  
  inline def apply(): PlotScatter3dSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatter3dSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
