...
trait PlotPcSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotPcSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotPcSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
