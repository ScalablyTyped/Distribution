...
trait PlotColumnpyramidSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
