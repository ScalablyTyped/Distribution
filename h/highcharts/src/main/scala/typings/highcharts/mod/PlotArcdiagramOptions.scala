...
trait PlotArcdiagramOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotArcdiagramSonificationOptions] = js.undefined
...
object PlotArcdiagramOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotArcdiagramOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotArcdiagramSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
