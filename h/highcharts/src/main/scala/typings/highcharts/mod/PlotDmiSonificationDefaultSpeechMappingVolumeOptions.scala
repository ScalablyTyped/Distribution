...
trait PlotDmiSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotDmiSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotDmiSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
