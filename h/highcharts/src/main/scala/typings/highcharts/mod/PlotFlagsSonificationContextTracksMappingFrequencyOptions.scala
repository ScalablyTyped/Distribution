...
trait PlotFlagsSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
