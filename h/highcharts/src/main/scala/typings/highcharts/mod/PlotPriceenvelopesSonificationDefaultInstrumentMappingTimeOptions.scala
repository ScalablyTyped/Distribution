...
trait PlotPriceenvelopesSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
