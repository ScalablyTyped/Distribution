...
trait PlotLineSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotLineSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotLineSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
