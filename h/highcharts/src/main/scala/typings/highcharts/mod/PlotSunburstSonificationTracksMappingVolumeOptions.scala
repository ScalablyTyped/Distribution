...
trait PlotSunburstSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotSunburstSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotSunburstSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
