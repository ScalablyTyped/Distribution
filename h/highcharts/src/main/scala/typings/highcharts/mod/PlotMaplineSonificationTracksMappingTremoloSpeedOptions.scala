...
trait PlotMaplineSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotMaplineSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotMaplineSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
