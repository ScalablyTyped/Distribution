...
trait PlotCylinderSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotCylinderSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
