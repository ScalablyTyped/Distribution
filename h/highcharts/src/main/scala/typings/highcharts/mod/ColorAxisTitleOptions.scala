...
trait ColorAxisTitleOptions extends StObject {
  ...
  /**
    ...
    * default. This can be customized by setting `textOverflow: 'ellipsis'`, by
...
object ColorAxisTitleOptions {
  
  inline def apply(): ColorAxisTitleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColorAxisTitleOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorAxisTitleOptions] (val x: Self) extends AnyVal {
