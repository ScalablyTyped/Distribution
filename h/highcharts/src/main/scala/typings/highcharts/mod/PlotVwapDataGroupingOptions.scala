...
trait PlotVwapDataGroupingOptions extends js.Object {
  /**
...
object PlotVwapDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotVwapDataGroupingOptions]
  }
}
