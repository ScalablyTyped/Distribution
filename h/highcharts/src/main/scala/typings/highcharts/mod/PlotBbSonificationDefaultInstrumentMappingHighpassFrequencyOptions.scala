...
trait PlotBbSonificationDefaultInstrumentMappingHighpassFrequencyOptions extends StObject {
...
object PlotBbSonificationDefaultInstrumentMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotBbSonificationDefaultInstrumentMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbSonificationDefaultInstrumentMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBbSonificationDefaultInstrumentMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
