...
trait PlotHeatmapSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
