...
trait PlotCylinderSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
