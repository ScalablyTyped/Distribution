...
trait SonificationGlobalTracksMappingVolumeOptions extends StObject {
...
object SonificationGlobalTracksMappingVolumeOptions {
  
  inline def apply(): SonificationGlobalTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
