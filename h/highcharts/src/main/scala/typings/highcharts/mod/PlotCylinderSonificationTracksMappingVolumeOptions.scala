...
trait PlotCylinderSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
