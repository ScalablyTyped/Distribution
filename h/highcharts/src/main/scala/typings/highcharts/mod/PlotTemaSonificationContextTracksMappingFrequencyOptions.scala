...
trait PlotTemaSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
