...
trait PlotTemaSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotTemaSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotTemaSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
