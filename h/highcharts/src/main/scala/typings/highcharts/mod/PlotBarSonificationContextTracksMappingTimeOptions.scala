...
trait PlotBarSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotBarSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotBarSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
