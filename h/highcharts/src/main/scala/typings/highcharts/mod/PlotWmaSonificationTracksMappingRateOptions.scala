...
trait PlotWmaSonificationTracksMappingRateOptions extends StObject {
...
object PlotWmaSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
