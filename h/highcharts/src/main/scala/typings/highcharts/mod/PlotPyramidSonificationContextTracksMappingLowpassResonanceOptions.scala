...
trait PlotPyramidSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPyramidSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
