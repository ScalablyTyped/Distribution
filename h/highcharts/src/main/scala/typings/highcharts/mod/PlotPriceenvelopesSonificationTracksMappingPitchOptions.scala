...
trait PlotPriceenvelopesSonificationTracksMappingPitchOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
