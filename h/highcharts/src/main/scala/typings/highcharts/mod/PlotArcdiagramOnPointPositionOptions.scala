...
trait PlotArcdiagramOnPointPositionOptions extends StObject {
...
object PlotArcdiagramOnPointPositionOptions {
  
  inline def apply(): PlotArcdiagramOnPointPositionOptions = {
