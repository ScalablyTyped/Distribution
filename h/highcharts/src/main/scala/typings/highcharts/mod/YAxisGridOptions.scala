...
@js.native
trait YAxisGridOptions extends StObject {
...
object YAxisGridOptions {
  
  @scala.inline
  def apply(): YAxisGridOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisGridOptions]
  }
  
  @scala.inline
  implicit class YAxisGridOptionsMutableBuilder[Self <: YAxisGridOptions] (val x: Self) extends AnyVal {
