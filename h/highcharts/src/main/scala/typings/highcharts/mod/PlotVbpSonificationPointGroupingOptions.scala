...
trait PlotVbpSonificationPointGroupingOptions extends StObject {
...
object PlotVbpSonificationPointGroupingOptions {
  
  inline def apply(): PlotVbpSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVbpSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
