...
object NavigatorXAxisPlotLinesEventsOptions {
  ...
  inline def apply(): NavigatorXAxisPlotLinesEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisPlotLinesEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NavigatorXAxisPlotLinesEventsOptions] (val x: Self) extends AnyVal {
