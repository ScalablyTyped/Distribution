...
@js.native
trait AnnotationsVerticalLineShapeOptions extends StObject {
...
object AnnotationsVerticalLineShapeOptions {
  ...
  @scala.inline
  def apply(): AnnotationsVerticalLineShapeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsVerticalLineShapeOptions]
  }
  
  @scala.inline
  implicit class AnnotationsVerticalLineShapeOptionsMutableBuilder[Self <: AnnotationsVerticalLineShapeOptions] (val x: Self) extends AnyVal {
