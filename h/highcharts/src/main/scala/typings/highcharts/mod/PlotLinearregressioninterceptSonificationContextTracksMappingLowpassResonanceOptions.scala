...
trait PlotLinearregressioninterceptSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
