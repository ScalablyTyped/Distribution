...
trait PlotWordcloudSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
