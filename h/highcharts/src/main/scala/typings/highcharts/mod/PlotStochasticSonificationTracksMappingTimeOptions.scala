...
trait PlotStochasticSonificationTracksMappingTimeOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
