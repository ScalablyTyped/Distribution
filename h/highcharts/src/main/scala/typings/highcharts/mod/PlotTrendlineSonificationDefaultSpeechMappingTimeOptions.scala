...
trait PlotTrendlineSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotTrendlineSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
