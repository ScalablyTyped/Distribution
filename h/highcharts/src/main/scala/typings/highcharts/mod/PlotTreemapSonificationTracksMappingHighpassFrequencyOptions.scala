...
trait PlotTreemapSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
