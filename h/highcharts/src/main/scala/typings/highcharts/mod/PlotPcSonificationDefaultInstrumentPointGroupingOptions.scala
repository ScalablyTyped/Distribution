...
trait PlotPcSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotPcSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotPcSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
