...
trait PlotMapbubbleConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotMapbubbleConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapbubbleConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleConnectorsEndMarkerOptions]
  }
}
