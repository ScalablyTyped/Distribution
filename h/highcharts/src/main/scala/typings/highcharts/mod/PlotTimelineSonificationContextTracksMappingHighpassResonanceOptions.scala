...
trait PlotTimelineSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
