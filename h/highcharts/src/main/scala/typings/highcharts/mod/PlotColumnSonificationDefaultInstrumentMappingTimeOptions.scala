...
trait PlotColumnSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotColumnSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotColumnSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
