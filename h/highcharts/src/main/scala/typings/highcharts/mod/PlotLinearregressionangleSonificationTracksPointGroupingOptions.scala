...
trait PlotLinearregressionangleSonificationTracksPointGroupingOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
