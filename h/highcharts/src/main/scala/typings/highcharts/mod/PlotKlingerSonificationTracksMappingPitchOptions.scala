...
trait PlotKlingerSonificationTracksMappingPitchOptions extends StObject {
...
object PlotKlingerSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotKlingerSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
