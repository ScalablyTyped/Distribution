...
@js.native
trait SeriesPackedBubbleDataLabelsOptionsObject extends js.Object {
...
object SeriesPackedBubbleDataLabelsOptionsObject {
  ...
  implicit class SeriesPackedBubbleDataLabelsOptionsObjectOps[Self <: SeriesPackedBubbleDataLabelsOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPackedbubbleDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFormatter(value: SeriesPackedBubbleDataLabelsFormatterCallbackFunction): Self = this.set("formatter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParentNodeFormat(value: String): Self = this.set("parentNodeFormat", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteParentNodeFormat: Self = this.set("parentNodeFormat", js.undefined)
    
    @scala.inline
    def setParentNodeFormatter(value: SeriesPackedBubbleDataLabelsFormatterCallbackFunction): Self = this.set("parentNodeFormatter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteParentNodeFormatter: Self = this.set("parentNodeFormatter", js.undefined)
    
    @scala.inline
    def setParentNodeTextPath(value: SeriesPackedBubbleDataLabelsTextPathOptionsObject): Self = this.set("parentNodeTextPath", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteParentNodeTextPath: Self = this.set("parentNodeTextPath", js.undefined)
    ...
    @scala.inline
    def setStyle(value: CSSObject | PlotPackedbubbleDataLabelsStyleOptions): Self = this.set("style", value.asInstanceOf[js.Any])
