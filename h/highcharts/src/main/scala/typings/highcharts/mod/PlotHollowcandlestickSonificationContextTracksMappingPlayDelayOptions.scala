...
trait PlotHollowcandlestickSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotHollowcandlestickSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
