...
trait SonificationGlobalTracksMappingTremoloDepthOptions extends StObject {
...
object SonificationGlobalTracksMappingTremoloDepthOptions {
  
  inline def apply(): SonificationGlobalTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
