...
trait PlotRsiDataGroupingOptions extends js.Object {
  /**
...
object PlotRsiDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotRsiDataGroupingOptions]
  }
}
