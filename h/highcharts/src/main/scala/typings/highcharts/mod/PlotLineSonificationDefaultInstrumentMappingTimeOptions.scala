...
trait PlotLineSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotLineSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotLineSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
