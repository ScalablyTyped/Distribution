...
trait SeriesBubbleDataMarkerStatesHoverOptions extends js.Object {
  /**
...
object SeriesBubbleDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesBubbleDataMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[SeriesBubbleDataMarkerStatesHoverOptions]
  }
}
