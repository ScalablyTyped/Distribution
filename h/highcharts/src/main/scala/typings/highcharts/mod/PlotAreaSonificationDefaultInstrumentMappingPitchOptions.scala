...
trait PlotAreaSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotAreaSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotAreaSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
