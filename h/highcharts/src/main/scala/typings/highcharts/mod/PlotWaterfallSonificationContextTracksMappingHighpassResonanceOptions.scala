...
trait PlotWaterfallSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotWaterfallSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotWaterfallSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
