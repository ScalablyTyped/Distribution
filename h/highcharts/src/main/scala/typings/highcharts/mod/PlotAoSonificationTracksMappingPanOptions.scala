...
trait PlotAoSonificationTracksMappingPanOptions extends StObject {
...
object PlotAoSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
