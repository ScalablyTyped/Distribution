...
trait PlotDependencywheelConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotDependencywheelConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDependencywheelConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelConnectorsEndMarkerOptions]
  }
}
