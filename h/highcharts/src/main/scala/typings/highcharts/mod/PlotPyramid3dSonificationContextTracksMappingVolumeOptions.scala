...
trait PlotPyramid3dSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
