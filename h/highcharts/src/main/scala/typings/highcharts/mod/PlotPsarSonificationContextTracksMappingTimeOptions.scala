...
trait PlotPsarSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotPsarSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
