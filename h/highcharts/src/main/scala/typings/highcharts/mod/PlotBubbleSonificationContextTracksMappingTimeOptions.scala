...
trait PlotBubbleSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
