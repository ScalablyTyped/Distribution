...
trait PlotTreemapSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotTreemapSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
