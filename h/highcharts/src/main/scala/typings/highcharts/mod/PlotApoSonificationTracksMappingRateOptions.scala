...
trait PlotApoSonificationTracksMappingRateOptions extends StObject {
...
object PlotApoSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
