...
trait PlotStochasticSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotStochasticSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
