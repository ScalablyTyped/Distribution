...
trait PlotGanttAccessibilityPointOptions extends StObject {
...
object PlotGanttAccessibilityPointOptions {
  
  inline def apply(): PlotGanttAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttAccessibilityPointOptions] (val x: Self) extends AnyVal {
