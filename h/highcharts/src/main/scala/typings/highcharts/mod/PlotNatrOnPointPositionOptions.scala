...
trait PlotNatrOnPointPositionOptions extends StObject {
...
object PlotNatrOnPointPositionOptions {
  
  inline def apply(): PlotNatrOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrOnPointPositionOptions] (val x: Self) extends AnyVal {
