...
trait PlotDumbbellSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotDumbbellSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
