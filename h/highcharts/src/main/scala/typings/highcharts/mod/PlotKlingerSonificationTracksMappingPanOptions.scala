...
trait PlotKlingerSonificationTracksMappingPanOptions extends StObject {
...
object PlotKlingerSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotKlingerSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
