...
trait PlotHistogramZonesOptions extends js.Object {
  /**
...
object PlotHistogramZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotHistogramZonesOptions]
  }
}
