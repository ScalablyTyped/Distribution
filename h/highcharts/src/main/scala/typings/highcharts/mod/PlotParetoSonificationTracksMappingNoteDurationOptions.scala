...
trait PlotParetoSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotParetoSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
