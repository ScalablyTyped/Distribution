...
object XAxisPlotBandsOptions {
  ...
  @scala.inline
  implicit class XAxisPlotBandsOptionsMutableBuilder[Self <: XAxisPlotBandsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: XAxisPlotBandsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: XAxisPlotBandsLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
