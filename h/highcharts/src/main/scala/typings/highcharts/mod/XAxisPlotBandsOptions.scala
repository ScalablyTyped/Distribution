...
trait XAxisPlotBandsOptions
  extends StObject
     with AxisPlotBandsOptions {
  ...
  /**
    ...
    */
  var label: js.UndefOr[XAxisPlotBandsLabelOptions] = js.undefined
...
object XAxisPlotBandsOptions {
  ...
  inline def apply(): XAxisPlotBandsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisPlotBandsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: XAxisPlotBandsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: XAxisPlotBandsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setLabel(value: XAxisPlotBandsLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
