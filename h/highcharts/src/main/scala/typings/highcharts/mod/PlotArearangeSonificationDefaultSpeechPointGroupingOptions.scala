...
trait PlotArearangeSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotArearangeSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
