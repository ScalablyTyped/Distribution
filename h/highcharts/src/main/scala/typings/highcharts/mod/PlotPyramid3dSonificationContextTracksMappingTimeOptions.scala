...
trait PlotPyramid3dSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
