...
trait PlotSeriesSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotSeriesSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
