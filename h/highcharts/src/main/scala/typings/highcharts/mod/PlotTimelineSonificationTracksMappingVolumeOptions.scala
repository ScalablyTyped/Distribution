...
trait PlotTimelineSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
