...
trait PlotFlagsDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotFlagsDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotFlagsDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotFlagsDragDropDragHandleOptions]
  }
}
