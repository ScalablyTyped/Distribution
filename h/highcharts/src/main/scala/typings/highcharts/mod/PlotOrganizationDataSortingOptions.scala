...
trait PlotOrganizationDataSortingOptions extends StObject {
...
object PlotOrganizationDataSortingOptions {
  
  inline def apply(): PlotOrganizationDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOrganizationDataSortingOptions] (val x: Self) extends AnyVal {
