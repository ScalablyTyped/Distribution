...
trait PlotSlowstochasticSonificationContextTracksOptions extends StObject {
  ...
  var activeWhen: js.UndefOr[
    js.Object | js.Function | PlotSlowstochasticSonificationContextTracksActiveWhenOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[PlotSlowstochasticSonificationContextTracksMappingOptions] = js.undefined
  ...
  /**
    ...
    * tracks.
    */
  var pointGrouping: js.UndefOr[PlotSlowstochasticSonificationContextTracksPointGroupingOptions] = js.undefined
...
object PlotSlowstochasticSonificationContextTracksOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotSlowstochasticSonificationContextTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotSlowstochasticSonificationContextTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotSlowstochasticSonificationContextTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
