...
trait PlotBellcurveSonificationTracksMappingRateOptions extends StObject {
...
object PlotBellcurveSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotBellcurveSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBellcurveSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
