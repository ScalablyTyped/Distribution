...
trait PlotTrendlineSonificationPointGroupingOptions extends StObject {
...
object PlotTrendlineSonificationPointGroupingOptions {
  
  inline def apply(): PlotTrendlineSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
