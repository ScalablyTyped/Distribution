...
trait PlotWmaSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotWmaSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
