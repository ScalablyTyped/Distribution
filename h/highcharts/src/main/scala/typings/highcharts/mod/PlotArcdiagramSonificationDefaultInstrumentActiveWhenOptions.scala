...
trait PlotArcdiagramSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
