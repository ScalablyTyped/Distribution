...
trait PlotKlingerSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotKlingerSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
