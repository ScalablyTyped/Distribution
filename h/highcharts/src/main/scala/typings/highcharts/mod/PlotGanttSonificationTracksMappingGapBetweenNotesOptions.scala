...
trait PlotGanttSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotGanttSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
