...
trait PlotLollipopSonificationDefaultInstrumentMappingPitchOptions extends StObject {
  
  /**
    * (Highcharts, Highstock) How to perform the mapping.
    */
  var mapFunction: js.UndefOr[OptionsMapFunctionValue] = js.undefined
  
  /**
    * (Highcharts, Highstock) A point property to map the mapping parameter to.
    *
  ...
  /**
    * (Highcharts, Highstock) The maximum value for the audio parameter. This
    * is the highest value the audio parameter will be mapped to.
    */
  var max: js.UndefOr[String] = js.undefined
  
  /**
    * (Highcharts, Highstock) The minimum value for the audio parameter. This
    * is the lowest value the audio parameter will be mapped to.
    */
  var min: js.UndefOr[String] = js.undefined
  
  /**
    * (Highcharts, Highstock) Map pitches to a musical scale. The scale is
    * defined as an array of semitone offsets from the root note.
    */
  var scale: js.UndefOr[js.Array[Double]] = js.undefined
  
  /**
    * (Highcharts, Highstock) A fixed value to use for the prop when mapping.
    *
  ...
  /**
    * (Highcharts, Highstock) What data values to map the parameter within.
    *
...
object PlotLollipopSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotLollipopSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
