...
trait PlotPieSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotPieSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotPieSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
