...
trait PlotWmaSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotWmaSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
