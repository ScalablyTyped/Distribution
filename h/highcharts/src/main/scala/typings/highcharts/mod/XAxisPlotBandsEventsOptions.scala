...
object XAxisPlotBandsEventsOptions {
  ...
  @scala.inline
  def apply(): XAxisPlotBandsEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisPlotBandsEventsOptions]
  }
  
  @scala.inline
  implicit class XAxisPlotBandsEventsOptionsMutableBuilder[Self <: XAxisPlotBandsEventsOptions] (val x: Self) extends AnyVal {
