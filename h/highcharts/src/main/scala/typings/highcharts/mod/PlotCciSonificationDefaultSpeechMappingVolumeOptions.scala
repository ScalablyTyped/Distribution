...
trait PlotCciSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotCciSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotCciSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
