...
trait PlotEmaSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotEmaSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
