...
trait SonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object SonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): SonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
