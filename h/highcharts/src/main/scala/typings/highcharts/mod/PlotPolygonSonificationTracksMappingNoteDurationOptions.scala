...
trait PlotPolygonSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
