...
trait PlotSmaSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotSmaSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
