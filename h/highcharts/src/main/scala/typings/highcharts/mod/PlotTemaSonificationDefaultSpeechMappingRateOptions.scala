...
trait PlotTemaSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotTemaSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotTemaSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
