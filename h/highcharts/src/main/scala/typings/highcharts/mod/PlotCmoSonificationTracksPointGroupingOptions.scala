...
trait PlotCmoSonificationTracksPointGroupingOptions extends StObject {
...
object PlotCmoSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotCmoSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
