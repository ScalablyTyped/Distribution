...
trait PlotAreaSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotAreaSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotAreaSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
