...
trait PlotMapSonificationTracksMappingTimeOptions extends StObject {
...
object PlotMapSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
