...
trait PlotHeikinashiSonificationTracksActiveWhenOptions extends StObject {
...
object PlotHeikinashiSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotHeikinashiSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeikinashiSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeikinashiSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
