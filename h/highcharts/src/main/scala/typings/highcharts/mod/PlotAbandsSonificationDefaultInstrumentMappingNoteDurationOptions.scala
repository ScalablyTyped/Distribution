...
trait PlotAbandsSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotAbandsSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
