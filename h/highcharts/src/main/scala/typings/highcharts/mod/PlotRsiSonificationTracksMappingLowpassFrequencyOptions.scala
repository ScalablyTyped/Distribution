...
trait PlotRsiSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotRsiSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
