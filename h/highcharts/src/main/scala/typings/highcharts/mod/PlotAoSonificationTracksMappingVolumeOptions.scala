...
trait PlotAoSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotAoSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
