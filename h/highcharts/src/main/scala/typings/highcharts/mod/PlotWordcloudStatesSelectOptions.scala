...
trait PlotWordcloudStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotWordcloudStatesSelectAnimationOptions] = js.undefined
  /**
...
object PlotWordcloudStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotWordcloudStatesSelectAnimationOptions = null,
    borderColor: ColorString | GradientColorObject | PatternObject = null,
    borderWidth: Int | Double = null,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined
  ): PlotWordcloudStatesSelectOptions = {
