...
trait PlotGaugeSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
