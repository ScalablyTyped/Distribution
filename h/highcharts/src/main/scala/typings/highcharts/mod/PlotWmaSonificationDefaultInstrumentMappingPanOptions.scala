...
trait PlotWmaSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotWmaSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotWmaSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
