...
trait PlotPsarSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotPsarSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
