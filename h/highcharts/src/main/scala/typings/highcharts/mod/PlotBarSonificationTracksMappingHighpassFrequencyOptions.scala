...
trait PlotBarSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotBarSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
