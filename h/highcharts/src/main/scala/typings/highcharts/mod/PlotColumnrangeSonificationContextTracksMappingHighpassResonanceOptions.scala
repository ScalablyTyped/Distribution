...
trait PlotColumnrangeSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotColumnrangeSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotColumnrangeSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
