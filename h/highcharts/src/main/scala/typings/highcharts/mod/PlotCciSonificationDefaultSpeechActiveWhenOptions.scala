...
trait PlotCciSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotCciSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotCciSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
