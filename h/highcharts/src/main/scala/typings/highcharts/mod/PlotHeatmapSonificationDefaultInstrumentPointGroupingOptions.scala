...
trait PlotHeatmapSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotHeatmapSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
