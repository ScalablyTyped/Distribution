...
trait PlotGanttSonificationDefaultInstrumentMappingLowpassResonanceOptions extends StObject {
  
  /**
    * (Gantt) How to perform the mapping.
    */
  var mapFunction: js.UndefOr[OptionsMapFunctionValue] = js.undefined
  
  /**
    * (Gantt) A point property to map the mapping parameter to.
    *
  ...
  /**
    * (Gantt) The maximum value for the audio parameter. This is the highest
    * value the audio parameter will be mapped to.
    */
  var max: js.UndefOr[Double] = js.undefined
  
  /**
    * (Gantt) The minimum value for the audio parameter. This is the lowest
    * value the audio parameter will be mapped to.
    */
  var min: js.UndefOr[Double] = js.undefined
  
  /**
    * (Gantt) A fixed value to use for the prop when mapping.
    *
  ...
  /**
    * (Gantt) What data values to map the parameter within.
    *
...
object PlotGanttSonificationDefaultInstrumentMappingLowpassResonanceOptions {
  
  inline def apply(): PlotGanttSonificationDefaultInstrumentMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationDefaultInstrumentMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationDefaultInstrumentMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
