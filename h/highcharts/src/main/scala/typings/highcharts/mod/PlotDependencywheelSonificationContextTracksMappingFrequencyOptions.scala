...
trait PlotDependencywheelSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
