...
trait PlotPieSonificationTracksMappingPitchOptions extends StObject {
...
object PlotPieSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotPieSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
