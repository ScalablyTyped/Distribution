...
trait PlotAbandsMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAbandsMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAbandsMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsMarkerStatesSelectOptions]
  }
}
