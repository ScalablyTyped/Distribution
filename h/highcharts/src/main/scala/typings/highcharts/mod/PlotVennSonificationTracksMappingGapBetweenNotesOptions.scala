...
trait PlotVennSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotVennSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
