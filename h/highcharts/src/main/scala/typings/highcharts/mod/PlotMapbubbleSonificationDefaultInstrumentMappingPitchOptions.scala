...
trait PlotMapbubbleSonificationDefaultInstrumentMappingPitchOptions extends StObject {
  
  /**
    * (Highmaps) How to perform the mapping.
    */
  var mapFunction: js.UndefOr[OptionsMapFunctionValue] = js.undefined
  
  /**
    * (Highmaps) A point property to map the mapping parameter to.
    *
  ...
  /**
    * (Highmaps) The maximum value for the audio parameter. This is the highest
    * value the audio parameter will be mapped to.
    */
  var max: js.UndefOr[String] = js.undefined
  
  /**
    * (Highmaps) The minimum value for the audio parameter. This is the lowest
    * value the audio parameter will be mapped to.
    */
  var min: js.UndefOr[String] = js.undefined
  
  /**
    * (Highmaps) Map pitches to a musical scale. The scale is defined as an
    * array of semitone offsets from the root note.
    */
  var scale: js.UndefOr[js.Array[Double]] = js.undefined
  
  /**
    * (Highmaps) A fixed value to use for the prop when mapping.
    *
  ...
  /**
    * (Highmaps) What data values to map the parameter within.
    *
...
object PlotMapbubbleSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotMapbubbleSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
