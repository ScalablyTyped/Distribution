...
trait PlotMappointSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotMappointSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
