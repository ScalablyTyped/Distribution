...
trait PlotNatrSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
