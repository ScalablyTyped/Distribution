...
trait PlotCmoSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotCmoSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotCmoSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
