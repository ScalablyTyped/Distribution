...
trait PlotCandlestickSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotCandlestickSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
