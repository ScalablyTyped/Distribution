...
trait PlotGeoheatmapSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
