...
trait PlotArcdiagramSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
