...
trait PlotSunburstSonificationPointGroupingOptions extends StObject {
...
object PlotSunburstSonificationPointGroupingOptions {
  
  inline def apply(): PlotSunburstSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
