...
trait PlotSplineSonificationPointGroupingOptions extends StObject {
...
object PlotSplineSonificationPointGroupingOptions {
  
  inline def apply(): PlotSplineSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
