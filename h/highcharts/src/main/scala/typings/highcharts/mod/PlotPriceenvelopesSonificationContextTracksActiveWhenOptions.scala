...
trait PlotPriceenvelopesSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotPriceenvelopesSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
