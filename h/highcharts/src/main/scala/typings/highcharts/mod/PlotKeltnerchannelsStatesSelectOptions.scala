...
trait PlotKeltnerchannelsStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotKeltnerchannelsStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotKeltnerchannelsStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotKeltnerchannelsStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotKeltnerchannelsStatesSelectAnimationOptions = null,
  ...
  ): PlotKeltnerchannelsStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsStatesSelectOptions]
  }
}
