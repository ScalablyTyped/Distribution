...
trait PlotErrorbarSonificationDefaultInstrumentMappingLowpassFrequencyOptions extends StObject {
...
object PlotErrorbarSonificationDefaultInstrumentMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotErrorbarSonificationDefaultInstrumentMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarSonificationDefaultInstrumentMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotErrorbarSonificationDefaultInstrumentMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
