...
trait PlotAreaSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotAreaSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotAreaSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
