...
trait PlotRsiSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotRsiSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotRsiSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
