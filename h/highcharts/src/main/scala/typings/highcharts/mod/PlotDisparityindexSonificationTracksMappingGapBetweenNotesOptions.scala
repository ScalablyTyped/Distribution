...
trait PlotDisparityindexSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
