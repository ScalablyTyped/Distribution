...
trait PlotAreaSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotAreaSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotAreaSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
