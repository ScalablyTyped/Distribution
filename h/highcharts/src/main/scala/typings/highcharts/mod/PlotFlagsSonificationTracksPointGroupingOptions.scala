...
trait PlotFlagsSonificationTracksPointGroupingOptions extends StObject {
...
object PlotFlagsSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotFlagsSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
