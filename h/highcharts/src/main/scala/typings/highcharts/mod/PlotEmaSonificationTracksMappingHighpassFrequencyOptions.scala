...
trait PlotEmaSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotEmaSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
