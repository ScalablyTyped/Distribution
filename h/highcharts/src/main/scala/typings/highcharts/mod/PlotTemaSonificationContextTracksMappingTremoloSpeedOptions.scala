...
trait PlotTemaSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
