...
trait PlotPieSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotPieSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotPieSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
