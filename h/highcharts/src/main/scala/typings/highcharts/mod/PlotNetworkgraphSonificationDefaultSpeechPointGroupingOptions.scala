...
trait PlotNetworkgraphSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
