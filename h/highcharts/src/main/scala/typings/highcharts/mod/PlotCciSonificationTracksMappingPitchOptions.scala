...
trait PlotCciSonificationTracksMappingPitchOptions extends StObject {
...
object PlotCciSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
