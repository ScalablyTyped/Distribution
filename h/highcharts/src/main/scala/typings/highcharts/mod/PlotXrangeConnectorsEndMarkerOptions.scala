...
trait PlotXrangeConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotXrangeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotXrangeConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotXrangeConnectorsEndMarkerOptions]
  }
}
