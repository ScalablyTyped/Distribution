...
trait PlotPolygonSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
