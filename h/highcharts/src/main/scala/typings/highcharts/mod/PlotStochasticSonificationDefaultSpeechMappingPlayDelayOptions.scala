...
trait PlotStochasticSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotStochasticSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
