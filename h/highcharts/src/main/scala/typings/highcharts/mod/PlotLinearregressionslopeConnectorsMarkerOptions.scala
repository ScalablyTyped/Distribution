...
trait PlotLinearregressionslopeConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeConnectorsMarkerOptions]
  }
}
