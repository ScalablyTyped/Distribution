...
trait SeriesSplineDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesSplineDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesSplineDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesSplineDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesSplineDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesSplineDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesSplineDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesSplineDataDragDropOptions]
  }
}
