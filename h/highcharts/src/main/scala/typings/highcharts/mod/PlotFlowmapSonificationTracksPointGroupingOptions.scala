...
trait PlotFlowmapSonificationTracksPointGroupingOptions extends StObject {
...
object PlotFlowmapSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
