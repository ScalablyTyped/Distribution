...
trait PlotPolygonClusterLayoutAlgorithmOptions extends StObject {
...
object PlotPolygonClusterLayoutAlgorithmOptions {
  
  inline def apply(): PlotPolygonClusterLayoutAlgorithmOptions = {
