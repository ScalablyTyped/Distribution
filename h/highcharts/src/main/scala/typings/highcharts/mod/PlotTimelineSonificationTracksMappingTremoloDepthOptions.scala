...
trait PlotTimelineSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
