...
trait PlotApoSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotApoSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotApoSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
