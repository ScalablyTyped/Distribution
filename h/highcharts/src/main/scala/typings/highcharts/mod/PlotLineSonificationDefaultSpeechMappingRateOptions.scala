...
trait PlotLineSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotLineSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotLineSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
