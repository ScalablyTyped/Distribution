...
trait PlotGaugeSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
