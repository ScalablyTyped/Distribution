...
trait PlotXrangeSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotXrangeSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
