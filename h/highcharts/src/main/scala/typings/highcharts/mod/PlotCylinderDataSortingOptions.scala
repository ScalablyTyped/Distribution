...
@js.native
trait PlotCylinderDataSortingOptions extends js.Object {
...
object PlotCylinderDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotCylinderDataSortingOptionsOps[Self <: PlotCylinderDataSortingOptions] (val x: Self) extends AnyVal {
