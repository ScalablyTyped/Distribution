...
trait PlotWmaSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotWmaSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
