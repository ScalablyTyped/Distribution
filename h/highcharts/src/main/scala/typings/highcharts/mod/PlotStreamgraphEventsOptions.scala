...
trait PlotStreamgraphEventsOptions extends js.Object {
  /**
...
object PlotStreamgraphEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotStreamgraphEventsOptions]
  }
}
