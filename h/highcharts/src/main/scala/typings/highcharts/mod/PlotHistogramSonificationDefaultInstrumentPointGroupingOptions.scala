...
trait PlotHistogramSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotHistogramSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
