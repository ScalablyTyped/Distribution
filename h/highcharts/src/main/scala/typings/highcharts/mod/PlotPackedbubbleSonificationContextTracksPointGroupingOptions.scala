...
trait PlotPackedbubbleSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotPackedbubbleSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotPackedbubbleSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPackedbubbleSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
