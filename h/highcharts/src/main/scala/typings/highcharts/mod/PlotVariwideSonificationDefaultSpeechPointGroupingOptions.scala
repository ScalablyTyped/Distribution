...
trait PlotVariwideSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotVariwideSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
