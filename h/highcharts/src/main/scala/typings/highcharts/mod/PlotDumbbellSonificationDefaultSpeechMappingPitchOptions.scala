...
trait PlotDumbbellSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotDumbbellSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
