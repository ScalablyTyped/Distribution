...
trait PlotDmiSonificationPointGroupingOptions extends StObject {
...
object PlotDmiSonificationPointGroupingOptions {
  
  inline def apply(): PlotDmiSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
