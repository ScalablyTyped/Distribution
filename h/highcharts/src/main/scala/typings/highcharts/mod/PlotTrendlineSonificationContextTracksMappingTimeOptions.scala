...
trait PlotTrendlineSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
