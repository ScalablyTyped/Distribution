...
trait PlotLollipopSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
