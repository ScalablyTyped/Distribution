...
trait PlotPivotpointsSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
