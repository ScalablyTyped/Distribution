...
trait PlotGeoheatmapSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
