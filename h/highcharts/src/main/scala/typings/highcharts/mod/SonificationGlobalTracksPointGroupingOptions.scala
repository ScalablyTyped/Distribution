...
trait SonificationGlobalTracksPointGroupingOptions extends StObject {
...
object SonificationGlobalTracksPointGroupingOptions {
  
  inline def apply(): SonificationGlobalTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksPointGroupingOptions] (val x: Self) extends AnyVal {
