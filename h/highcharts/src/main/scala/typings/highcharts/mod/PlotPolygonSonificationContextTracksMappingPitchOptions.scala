...
trait PlotPolygonSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
