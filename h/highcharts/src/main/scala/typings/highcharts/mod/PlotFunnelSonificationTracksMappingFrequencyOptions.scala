...
trait PlotFunnelSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
