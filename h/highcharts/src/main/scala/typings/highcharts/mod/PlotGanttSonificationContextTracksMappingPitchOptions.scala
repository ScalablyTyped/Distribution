...
trait PlotGanttSonificationContextTracksMappingPitchOptions extends StObject {
  ...
  /**
    * (Gantt) Map pitches to a musical scale. The scale is defined as an array
...
object PlotGanttSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
