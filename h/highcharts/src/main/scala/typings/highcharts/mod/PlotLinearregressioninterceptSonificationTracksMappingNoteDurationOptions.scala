...
trait PlotLinearregressioninterceptSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
