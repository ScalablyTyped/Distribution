...
import typings.highcharts.highchartsStrings.atr
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesAtrOptions
  extends StObject
     with PlotAtrOptions {
...
object SeriesAtrOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | atr): SeriesAtrOptions = {
  ...
  @scala.inline
  implicit class SeriesAtrOptionsMutableBuilder[Self <: SeriesAtrOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | atr): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
