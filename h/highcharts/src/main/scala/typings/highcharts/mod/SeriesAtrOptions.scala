...
object SeriesAtrOptions {
  ...
  @scala.inline
  implicit class SeriesAtrOptionsOps[Self <: SeriesAtrOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | atr): Self = this.set("type", value.asInstanceOf[js.Any])
