...
trait PlotCandlestickSonificationDefaultInstrumentMappingTremoloSpeedOptions extends StObject {
...
object PlotCandlestickSonificationDefaultInstrumentMappingTremoloSpeedOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultInstrumentMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultInstrumentMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultInstrumentMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
