...
trait PlotSplineSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
