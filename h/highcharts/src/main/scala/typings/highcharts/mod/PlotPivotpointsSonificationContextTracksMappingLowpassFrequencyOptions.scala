...
trait PlotPivotpointsSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
