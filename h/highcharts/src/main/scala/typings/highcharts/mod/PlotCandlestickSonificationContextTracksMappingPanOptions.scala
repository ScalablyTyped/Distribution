...
trait PlotCandlestickSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
