...
trait PlotFlagsSonificationTracksMappingPanOptions extends StObject {
...
object PlotFlagsSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotFlagsSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
