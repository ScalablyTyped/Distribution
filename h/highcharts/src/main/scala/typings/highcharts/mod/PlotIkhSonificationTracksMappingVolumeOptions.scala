...
trait PlotIkhSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotIkhSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
