...
trait PlotWmaConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotWmaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWmaConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWmaConnectorsStartMarkerOptions]
  }
}
