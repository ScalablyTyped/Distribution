...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesStreamgraphOptions
  extends StObject
     with PlotStreamgraphOptions {
...
object SeriesStreamgraphOptions {
  ...
  implicit open class MutableBuilder[Self <: SeriesStreamgraphOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | streamgraph): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
