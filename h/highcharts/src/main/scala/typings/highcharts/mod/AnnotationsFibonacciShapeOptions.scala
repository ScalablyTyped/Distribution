...
@js.native
trait AnnotationsFibonacciShapeOptions extends StObject {
...
object AnnotationsFibonacciShapeOptions {
  ...
  @scala.inline
  def apply(): AnnotationsFibonacciShapeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsFibonacciShapeOptions]
  }
  
  @scala.inline
  implicit class AnnotationsFibonacciShapeOptionsMutableBuilder[Self <: AnnotationsFibonacciShapeOptions] (val x: Self) extends AnyVal {
