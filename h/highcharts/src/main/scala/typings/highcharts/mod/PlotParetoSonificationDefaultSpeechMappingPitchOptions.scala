...
trait PlotParetoSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotParetoSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotParetoSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
