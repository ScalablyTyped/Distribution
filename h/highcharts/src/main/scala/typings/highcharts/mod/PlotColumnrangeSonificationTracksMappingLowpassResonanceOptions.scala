...
trait PlotColumnrangeSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotColumnrangeSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotColumnrangeSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
