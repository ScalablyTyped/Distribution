...
trait PlotNetworkgraphSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
