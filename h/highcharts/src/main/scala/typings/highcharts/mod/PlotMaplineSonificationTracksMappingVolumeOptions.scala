...
trait PlotMaplineSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotMaplineSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotMaplineSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
