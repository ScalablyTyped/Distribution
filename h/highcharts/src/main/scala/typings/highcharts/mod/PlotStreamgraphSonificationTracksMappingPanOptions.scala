...
trait PlotStreamgraphSonificationTracksMappingPanOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
