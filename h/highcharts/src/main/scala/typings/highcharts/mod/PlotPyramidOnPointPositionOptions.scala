...
trait PlotPyramidOnPointPositionOptions extends StObject {
...
object PlotPyramidOnPointPositionOptions {
  
  inline def apply(): PlotPyramidOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidOnPointPositionOptions] (val x: Self) extends AnyVal {
