...
trait PlotPriceenvelopesOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotPriceenvelopesAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotPriceenvelopesDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotPriceenvelopesOnPointOptions] = js.undefined
...
object PlotPriceenvelopesOptions {
  ...
  inline def apply(): PlotPriceenvelopesOptions = {
  ...
  extension [Self <: PlotPriceenvelopesOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotPriceenvelopesAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setBottomLine(value: PlotPriceenvelopesBottomLineOptions): Self = StObject.set(x, "bottomLine", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotPriceenvelopesDataLabelsOptions | js.Array[PlotPriceenvelopesDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotPriceenvelopesDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotPriceenvelopesDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotPriceenvelopesOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotPriceenvelopesParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    inline def setTopLine(value: PlotPriceenvelopesTopLineOptions): Self = StObject.set(x, "topLine", value.asInstanceOf[js.Any])
