...
trait PlotPriceenvelopesOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotPriceenvelopesSonificationOptions] = js.undefined
...
object PlotPriceenvelopesOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotPriceenvelopesSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
