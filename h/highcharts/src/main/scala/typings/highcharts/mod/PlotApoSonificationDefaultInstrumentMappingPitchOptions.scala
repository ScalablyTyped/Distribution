...
trait PlotApoSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotApoSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotApoSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
