...
trait PlotCandlestickSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotCandlestickSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
