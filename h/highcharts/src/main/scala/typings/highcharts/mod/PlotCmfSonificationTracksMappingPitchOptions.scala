...
trait PlotCmfSonificationTracksMappingPitchOptions extends StObject {
...
object PlotCmfSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotCmfSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmfSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
