...
trait PlotPolygonSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
