...
trait PlotSeriesSonificationTracksMappingRateOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
