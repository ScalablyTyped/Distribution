...
trait PlotKeltnerchannelsMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotKeltnerchannelsMarkerStatesOptions] = js.undefined
  /**
...
object PlotKeltnerchannelsMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotKeltnerchannelsMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotKeltnerchannelsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsMarkerOptions]
  }
}
