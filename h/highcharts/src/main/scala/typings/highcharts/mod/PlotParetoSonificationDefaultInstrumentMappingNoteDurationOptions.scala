...
trait PlotParetoSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotParetoSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotParetoSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
