...
trait PlotSeriesSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
