...
trait PlotHollowcandlestickSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotHollowcandlestickSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
