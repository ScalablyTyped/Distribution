...
trait PlotSlowstochasticSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
