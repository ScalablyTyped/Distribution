...
trait PlotTreemapSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotTreemapSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
