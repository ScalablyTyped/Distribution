...
trait PlotSplineSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotSplineSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
