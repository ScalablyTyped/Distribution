...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesEmaOptions extends PlotEmaOptions {
  /**
    * Not available
    */
...
object SeriesEmaOptions {
  ...
  def apply(
    ...
    dataLabels: PlotEmaDataLabelsOptions | js.Array[PlotEmaDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotEmaDataSortingOptions = null,
