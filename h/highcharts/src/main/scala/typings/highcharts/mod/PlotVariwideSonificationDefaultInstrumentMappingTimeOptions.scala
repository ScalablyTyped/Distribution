...
trait PlotVariwideSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotVariwideSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
