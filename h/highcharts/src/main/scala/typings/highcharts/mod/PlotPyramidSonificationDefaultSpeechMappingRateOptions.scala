...
trait PlotPyramidSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotPyramidSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
