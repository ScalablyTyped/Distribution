...
trait PlotPyramidSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotPyramidSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
