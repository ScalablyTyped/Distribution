...
trait PlotPieSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotPieSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotPieSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
