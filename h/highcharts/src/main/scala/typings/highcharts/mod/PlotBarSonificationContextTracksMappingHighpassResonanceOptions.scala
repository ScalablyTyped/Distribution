...
trait PlotBarSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotBarSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotBarSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
