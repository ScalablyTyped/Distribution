...
trait PlotRocSonificationPointGroupingOptions extends StObject {
...
object PlotRocSonificationPointGroupingOptions {
  
  inline def apply(): PlotRocSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRocSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
