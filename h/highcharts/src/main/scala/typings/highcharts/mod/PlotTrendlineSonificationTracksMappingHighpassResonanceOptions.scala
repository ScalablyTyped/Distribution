...
trait PlotTrendlineSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
