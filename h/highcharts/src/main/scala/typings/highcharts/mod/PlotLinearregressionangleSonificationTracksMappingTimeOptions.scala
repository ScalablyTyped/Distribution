...
trait PlotLinearregressionangleSonificationTracksMappingTimeOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
