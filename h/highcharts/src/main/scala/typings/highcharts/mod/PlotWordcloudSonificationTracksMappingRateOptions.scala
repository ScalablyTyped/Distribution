...
trait PlotWordcloudSonificationTracksMappingRateOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
