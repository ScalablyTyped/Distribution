...
trait PlotArearangeSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
