...
trait PlotSunburstSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotSunburstSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotSunburstSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
