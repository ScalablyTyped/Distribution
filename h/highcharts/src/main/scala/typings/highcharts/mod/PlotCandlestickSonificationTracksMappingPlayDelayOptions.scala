...
trait PlotCandlestickSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
