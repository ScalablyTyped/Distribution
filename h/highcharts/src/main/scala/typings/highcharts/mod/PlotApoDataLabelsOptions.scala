...
object PlotApoDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotApoDataLabelsOptionsMutableBuilder[Self <: PlotApoDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotApoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
