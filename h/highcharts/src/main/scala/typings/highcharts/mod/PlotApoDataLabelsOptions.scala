...
@js.native
trait PlotApoDataLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotApoDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotApoDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotApoDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotApoDataLabelsOptionsOps[Self <: PlotApoDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotApoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
