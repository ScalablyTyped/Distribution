...
trait PlotArcdiagramSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
