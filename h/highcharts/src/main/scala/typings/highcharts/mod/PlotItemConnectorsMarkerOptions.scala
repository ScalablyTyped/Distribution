...
trait PlotItemConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotItemConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotItemConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotItemConnectorsMarkerOptions]
  }
}
