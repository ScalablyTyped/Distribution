...
trait PlotArcdiagramSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
