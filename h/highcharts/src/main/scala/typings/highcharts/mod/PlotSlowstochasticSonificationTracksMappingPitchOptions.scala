...
trait PlotSlowstochasticSonificationTracksMappingPitchOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
