...
trait PlotGeoheatmapSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
