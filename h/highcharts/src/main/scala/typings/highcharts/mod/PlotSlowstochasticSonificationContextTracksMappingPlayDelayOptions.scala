...
trait PlotSlowstochasticSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
