...
trait PlotMapSonificationDefaultInstrumentMappingTremoloSpeedOptions extends StObject {
...
object PlotMapSonificationDefaultInstrumentMappingTremoloSpeedOptions {
  
  inline def apply(): PlotMapSonificationDefaultInstrumentMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationDefaultInstrumentMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationDefaultInstrumentMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
