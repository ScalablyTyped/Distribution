...
trait PlotFunnelSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
