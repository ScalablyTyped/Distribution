...
trait PlotAtrSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
