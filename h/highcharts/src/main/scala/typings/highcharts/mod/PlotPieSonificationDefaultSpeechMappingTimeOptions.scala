...
trait PlotPieSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotPieSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotPieSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
