...
trait PlotPcSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotPcSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotPcSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
