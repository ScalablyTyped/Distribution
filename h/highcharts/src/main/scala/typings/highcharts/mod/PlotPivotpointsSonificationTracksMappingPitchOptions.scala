...
trait PlotPivotpointsSonificationTracksMappingPitchOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
