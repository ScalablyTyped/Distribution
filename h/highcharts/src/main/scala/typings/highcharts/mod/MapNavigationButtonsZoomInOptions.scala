...
object MapNavigationButtonsZoomInOptions {
  ...
  @scala.inline
  def apply(): MapNavigationButtonsZoomInOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MapNavigationButtonsZoomInOptions]
  }
  
  @scala.inline
  implicit class MapNavigationButtonsZoomInOptionsMutableBuilder[Self <: MapNavigationButtonsZoomInOptions] (val x: Self) extends AnyVal {
