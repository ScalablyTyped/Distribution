...
trait PlotLinearregressioninterceptStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressioninterceptStatesHoverAnimationOptions
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressioninterceptStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotLinearregressioninterceptStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressioninterceptStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressioninterceptStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptStatesHoverOptions]
  }
}
