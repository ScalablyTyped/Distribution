...
@js.native
trait PlotWmaDataSortingOptions extends js.Object {
...
object PlotWmaDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotWmaDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotWmaDataSortingOptionsOps[Self <: PlotWmaDataSortingOptions] (val x: Self) extends AnyVal {
