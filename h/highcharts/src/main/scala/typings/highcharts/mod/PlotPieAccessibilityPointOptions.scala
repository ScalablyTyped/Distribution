...
trait PlotPieAccessibilityPointOptions extends StObject {
...
object PlotPieAccessibilityPointOptions {
  
  inline def apply(): PlotPieAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieAccessibilityPointOptions] (val x: Self) extends AnyVal {
