...
trait PlotWaterfallSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotWaterfallSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotWaterfallSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
