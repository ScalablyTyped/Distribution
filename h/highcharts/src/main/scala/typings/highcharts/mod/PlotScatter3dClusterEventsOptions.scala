...
trait PlotScatter3dClusterEventsOptions extends StObject {
...
object PlotScatter3dClusterEventsOptions {
  
  inline def apply(): PlotScatter3dClusterEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dClusterEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatter3dClusterEventsOptions] (val x: Self) extends AnyVal {
