...
trait PlotXrangeSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotXrangeSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
