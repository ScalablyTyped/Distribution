...
trait PlotSeriesSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotSeriesSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
