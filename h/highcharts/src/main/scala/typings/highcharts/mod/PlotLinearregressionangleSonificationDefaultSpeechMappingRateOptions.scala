...
trait PlotLinearregressionangleSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotLinearregressionangleSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
