...
trait PlotSlowstochasticSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
