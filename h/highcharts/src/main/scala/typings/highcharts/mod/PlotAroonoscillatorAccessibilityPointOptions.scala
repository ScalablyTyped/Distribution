...
trait PlotAroonoscillatorAccessibilityPointOptions extends StObject {
...
object PlotAroonoscillatorAccessibilityPointOptions {
  
  inline def apply(): PlotAroonoscillatorAccessibilityPointOptions = {
