...
trait PlotArearangeSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
