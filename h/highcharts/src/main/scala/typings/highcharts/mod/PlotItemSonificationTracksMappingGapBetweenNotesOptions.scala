...
trait PlotItemSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotItemSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
