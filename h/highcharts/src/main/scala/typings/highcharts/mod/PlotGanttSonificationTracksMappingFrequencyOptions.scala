...
trait PlotGanttSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotGanttSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
