...
trait PlotLinearregressionSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotLinearregressionSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotLinearregressionSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
