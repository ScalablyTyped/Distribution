...
trait PlotPictorialAccessibilityPointOptions extends StObject {
...
object PlotPictorialAccessibilityPointOptions {
  
  inline def apply(): PlotPictorialAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialAccessibilityPointOptions] (val x: Self) extends AnyVal {
