...
trait PlotColumnpyramidSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
