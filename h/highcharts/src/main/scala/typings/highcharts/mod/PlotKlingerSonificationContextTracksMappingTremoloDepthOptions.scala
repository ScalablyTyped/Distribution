...
trait PlotKlingerSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotKlingerSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
