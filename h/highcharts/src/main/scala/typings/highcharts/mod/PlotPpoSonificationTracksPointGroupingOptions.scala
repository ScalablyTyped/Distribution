...
trait PlotPpoSonificationTracksPointGroupingOptions extends StObject {
...
object PlotPpoSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotPpoSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
