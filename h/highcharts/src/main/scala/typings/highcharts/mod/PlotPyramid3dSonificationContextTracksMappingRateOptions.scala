...
trait PlotPyramid3dSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
