...
trait PlotFunnel3dSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotFunnel3dSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
