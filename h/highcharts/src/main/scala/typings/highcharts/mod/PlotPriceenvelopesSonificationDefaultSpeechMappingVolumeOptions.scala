...
trait PlotPriceenvelopesSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
