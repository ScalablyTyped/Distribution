...
trait PlotTrendlineSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotTrendlineSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
