...
@js.native
trait PlotTreemapClusterZonesOptions extends StObject {
...
object PlotTreemapClusterZonesOptions {
  ...
  @scala.inline
  implicit class PlotTreemapClusterZonesOptionsMutableBuilder[Self <: PlotTreemapClusterZonesOptions] (val x: Self) extends AnyVal {
