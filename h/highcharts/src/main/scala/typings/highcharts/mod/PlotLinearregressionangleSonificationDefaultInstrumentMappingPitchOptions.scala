...
trait PlotLinearregressionangleSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotLinearregressionangleSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
