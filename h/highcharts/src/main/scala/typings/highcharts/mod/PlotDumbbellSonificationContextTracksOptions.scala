...
trait PlotDumbbellSonificationContextTracksOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotDumbbellSonificationContextTracksActiveWhenOptions] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[PlotDumbbellSonificationContextTracksMappingOptions] = js.undefined
  ...
  /**
    ...
    * instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotDumbbellSonificationContextTracksPointGroupingOptions] = js.undefined
...
object PlotDumbbellSonificationContextTracksOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotDumbbellSonificationContextTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotDumbbellSonificationContextTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotDumbbellSonificationContextTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
