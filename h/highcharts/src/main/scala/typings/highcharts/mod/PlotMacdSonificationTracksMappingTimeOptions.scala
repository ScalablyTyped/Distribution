...
trait PlotMacdSonificationTracksMappingTimeOptions extends StObject {
...
object PlotMacdSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotMacdSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMacdSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
