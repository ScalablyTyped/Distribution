...
trait PlotDumbbellSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
