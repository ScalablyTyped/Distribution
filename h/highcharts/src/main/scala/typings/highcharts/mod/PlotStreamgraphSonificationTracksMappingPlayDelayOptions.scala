...
trait PlotStreamgraphSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
