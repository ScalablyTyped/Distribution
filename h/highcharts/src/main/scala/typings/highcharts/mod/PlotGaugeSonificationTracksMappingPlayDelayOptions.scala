...
trait PlotGaugeSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
