...
trait PlotCciSonificationPointGroupingOptions extends StObject {
...
object PlotCciSonificationPointGroupingOptions {
  
  inline def apply(): PlotCciSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
