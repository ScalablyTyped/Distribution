...
trait PlotWordcloudSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotWordcloudSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
