...
trait PlotWaterfallSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotWaterfallSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotWaterfallSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
