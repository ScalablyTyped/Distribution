...
trait PlotBarSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotBarSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotBarSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
