...
trait PlotStochasticSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotStochasticSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
