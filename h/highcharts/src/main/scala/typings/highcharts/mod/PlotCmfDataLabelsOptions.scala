...
@js.native
trait PlotCmfDataLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotCmfDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotCmfDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotCmfDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotCmfDataLabelsOptionsOps[Self <: PlotCmfDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotCmfDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
