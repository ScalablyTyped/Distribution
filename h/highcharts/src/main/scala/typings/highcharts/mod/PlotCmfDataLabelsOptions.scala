...
object PlotCmfDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotCmfDataLabelsOptionsMutableBuilder[Self <: PlotCmfDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotCmfDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
