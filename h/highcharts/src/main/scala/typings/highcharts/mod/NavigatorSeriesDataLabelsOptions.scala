...
@js.native
trait NavigatorSeriesDataLabelsOptions extends js.Object {
...
object NavigatorSeriesDataLabelsOptions {
  ...
  @scala.inline
  implicit class NavigatorSeriesDataLabelsOptionsOps[Self <: NavigatorSeriesDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | NavigatorSeriesDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
