...
object NavigatorSeriesDataLabelsOptions {
  ...
  inline def apply(): NavigatorSeriesDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorSeriesDataLabelsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NavigatorSeriesDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | NavigatorSeriesDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
