...
trait NavigatorSeriesDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | NavigatorSeriesDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object NavigatorSeriesDataLabelsOptions {
  
  @scala.inline
  def apply(): NavigatorSeriesDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorSeriesDataLabelsOptions]
  }
  
  @scala.inline
  implicit class NavigatorSeriesDataLabelsOptionsMutableBuilder[Self <: NavigatorSeriesDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | NavigatorSeriesDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
