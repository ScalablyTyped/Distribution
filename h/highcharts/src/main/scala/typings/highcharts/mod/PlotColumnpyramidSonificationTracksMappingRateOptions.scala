...
trait PlotColumnpyramidSonificationTracksMappingRateOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
