...
trait PlotPriceenvelopesSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotPriceenvelopesSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
