...
trait PlotDisparityindexSonificationTracksMappingPitchOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
