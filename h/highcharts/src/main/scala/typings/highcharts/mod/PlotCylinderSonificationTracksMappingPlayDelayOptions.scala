...
trait PlotCylinderSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
