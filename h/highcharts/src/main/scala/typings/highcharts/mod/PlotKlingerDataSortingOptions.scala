...
trait PlotKlingerDataSortingOptions extends StObject {
...
object PlotKlingerDataSortingOptions {
  
  inline def apply(): PlotKlingerDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerDataSortingOptions] (val x: Self) extends AnyVal {
