...
trait PlotCylinderSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotCylinderSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
