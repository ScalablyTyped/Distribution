...
trait PlotBubbleDataSortingOptions extends StObject {
...
object PlotBubbleDataSortingOptions {
  
  @scala.inline
  def apply(): PlotBubbleDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotBubbleDataSortingOptionsMutableBuilder[Self <: PlotBubbleDataSortingOptions] (val x: Self) extends AnyVal {
