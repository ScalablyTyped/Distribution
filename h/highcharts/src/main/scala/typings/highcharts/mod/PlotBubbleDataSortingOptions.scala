...
@js.native
trait PlotBubbleDataSortingOptions extends js.Object {
  /**
...
object PlotBubbleDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotBubbleDataSortingOptionsOps[Self <: PlotBubbleDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
