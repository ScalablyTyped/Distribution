...
trait PlotArearangeSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotArearangeSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotArearangeSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
