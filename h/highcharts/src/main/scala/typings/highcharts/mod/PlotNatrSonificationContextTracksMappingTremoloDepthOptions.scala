...
trait PlotNatrSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
