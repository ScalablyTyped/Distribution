...
trait PlotPictorialSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotPictorialSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
