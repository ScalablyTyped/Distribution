...
trait PlotItemSonificationTracksMappingRateOptions extends StObject {
...
object PlotItemSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
