...
trait PlotLinearregressionslopeOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotLinearregressionslopeSonificationOptions] = js.undefined
...
object PlotLinearregressionslopeOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotLinearregressionslopeSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
