...
object PlotLinearregressionslopeOptions {
  ...
  def apply(
    ...
    dataLabels: PlotLinearregressionslopeDataLabelsOptions | js.Array[PlotLinearregressionslopeDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotLinearregressionslopeDataSortingOptions = null,
