...
trait PlotLinearregressionslopeOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotLinearregressionslopeAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotLinearregressionslopeDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotLinearregressionslopeOnPointOptions] = js.undefined
...
object PlotLinearregressionslopeOptions {
  ...
  inline def apply(): PlotLinearregressionslopeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeOptions]
  }
  
  extension [Self <: PlotLinearregressionslopeOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotLinearregressionslopeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabelsVarargs(value: PlotLinearregressionslopeDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotLinearregressionslopeDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotLinearregressionslopeOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotLinearregressionslopeParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
