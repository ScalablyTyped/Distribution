...
trait PlotPictorialSonificationTracksMappingRateOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
