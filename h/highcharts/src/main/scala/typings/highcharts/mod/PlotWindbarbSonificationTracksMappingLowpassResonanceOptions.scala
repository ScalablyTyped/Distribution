...
trait PlotWindbarbSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotWindbarbSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotWindbarbSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
