...
trait PlotHeatmapSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotHeatmapSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
