...
trait PlotDmiSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
