...
trait PlotTemaSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotTemaSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotTemaSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
