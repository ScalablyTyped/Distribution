...
trait PlotHlcSonificationTracksMappingRateOptions extends StObject {
...
object PlotHlcSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotHlcSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHlcSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
