...
trait PlotSlowstochasticSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
