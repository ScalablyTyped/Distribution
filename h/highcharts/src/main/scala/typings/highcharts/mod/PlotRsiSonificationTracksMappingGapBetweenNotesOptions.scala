...
trait PlotRsiSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotRsiSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
