...
trait PlotVennDataSortingOptions extends StObject {
...
object PlotVennDataSortingOptions {
  
  inline def apply(): PlotVennDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennDataSortingOptions] (val x: Self) extends AnyVal {
