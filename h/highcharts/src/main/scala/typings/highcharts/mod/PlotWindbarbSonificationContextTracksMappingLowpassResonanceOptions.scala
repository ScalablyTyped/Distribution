...
trait PlotWindbarbSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotWindbarbSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotWindbarbSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
