...
trait PlotAreaSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotAreaSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotAreaSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
