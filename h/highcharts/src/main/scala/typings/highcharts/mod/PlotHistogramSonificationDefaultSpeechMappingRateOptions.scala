...
trait PlotHistogramSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotHistogramSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
