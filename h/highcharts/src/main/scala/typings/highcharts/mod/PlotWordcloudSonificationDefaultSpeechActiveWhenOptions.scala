...
trait PlotWordcloudSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotWordcloudSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
