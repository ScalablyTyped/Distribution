...
@js.native
trait PlotMappointDataSortingOptions extends js.Object {
...
object PlotMappointDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotMappointDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotMappointDataSortingOptionsOps[Self <: PlotMappointDataSortingOptions] (val x: Self) extends AnyVal {
