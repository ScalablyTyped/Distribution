...
trait PlotNatrSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
