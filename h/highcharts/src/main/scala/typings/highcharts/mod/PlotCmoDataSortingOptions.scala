...
trait PlotCmoDataSortingOptions extends StObject {
...
object PlotCmoDataSortingOptions {
  
  inline def apply(): PlotCmoDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoDataSortingOptions] (val x: Self) extends AnyVal {
