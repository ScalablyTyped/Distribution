...
trait PlotIkhSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotIkhSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotIkhSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
