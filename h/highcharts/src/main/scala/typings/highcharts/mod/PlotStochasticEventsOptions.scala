...
trait PlotStochasticEventsOptions extends js.Object {
  /**
...
object PlotStochasticEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotStochasticEventsOptions]
  }
}
