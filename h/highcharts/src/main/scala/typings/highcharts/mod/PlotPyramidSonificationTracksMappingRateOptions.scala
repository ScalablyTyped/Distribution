...
trait PlotPyramidSonificationTracksMappingRateOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
