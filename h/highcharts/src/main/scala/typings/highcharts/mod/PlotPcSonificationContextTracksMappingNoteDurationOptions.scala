...
trait PlotPcSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotPcSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPcSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
