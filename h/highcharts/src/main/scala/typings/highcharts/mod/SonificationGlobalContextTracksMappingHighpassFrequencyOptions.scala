...
trait SonificationGlobalContextTracksMappingHighpassFrequencyOptions extends StObject {
...
object SonificationGlobalContextTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
