...
trait PlotBubbleClusterOptions extends StObject {
  ...
  var events: js.UndefOr[PlotBubbleClusterEventsOptions] = js.undefined
  ...
  /**
    ...
    * iterations.
    */
  var layoutAlgorithm: js.UndefOr[PlotBubbleClusterLayoutAlgorithmOptions] = js.undefined
  ...
  var states: js.UndefOr[PlotBubbleClusterStatesOptions] = js.undefined
  ...
  /**
    ...
    * `className` option.
    */
  var zones: js.UndefOr[js.Array[PlotBubbleClusterZonesOptions]] = js.undefined
}
object PlotBubbleClusterOptions {
  
  inline def apply(): PlotBubbleClusterOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleClusterOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleClusterOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: PlotBubbleClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    inline def setLayoutAlgorithm(value: PlotBubbleClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setStates(value: PlotBubbleClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    inline def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    inline def setZones(value: js.Array[PlotBubbleClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
    
    inline def setZonesUndefined: Self = StObject.set(x, "zones", js.undefined)
    
    inline def setZonesVarargs(value: PlotBubbleClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value*))
  }
}
