...
trait PlotPictorialSonificationDefaultInstrumentMappingHighpassFrequencyOptions extends StObject {
...
object PlotPictorialSonificationDefaultInstrumentMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultInstrumentMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultInstrumentMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultInstrumentMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
