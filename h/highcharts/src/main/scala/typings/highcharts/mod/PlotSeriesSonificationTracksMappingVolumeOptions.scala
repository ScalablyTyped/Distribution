...
trait PlotSeriesSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
