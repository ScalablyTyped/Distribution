...
trait PlotHeatmapSonificationTracksPointGroupingOptions extends StObject {
...
object PlotHeatmapSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
