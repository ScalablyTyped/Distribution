...
trait PlotFlagsSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
