...
trait PlotRsiSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotRsiSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotRsiSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
