...
trait PlotMacdSonificationTracksMappingPitchOptions extends StObject {
...
object PlotMacdSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotMacdSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMacdSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
