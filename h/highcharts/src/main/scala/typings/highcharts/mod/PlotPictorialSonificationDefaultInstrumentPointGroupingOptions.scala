...
trait PlotPictorialSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotPictorialSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
