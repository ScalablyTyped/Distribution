...
trait PlotAoSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotAoSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotAoSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
