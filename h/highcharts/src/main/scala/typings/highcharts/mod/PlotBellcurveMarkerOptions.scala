...
trait PlotBellcurveMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotBellcurveMarkerStatesOptions] = js.undefined
  /**
...
object PlotBellcurveMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotBellcurveMarkerStatesOptions = null,
    symbol: String = null,
    ...
    __obj.asInstanceOf[PlotBellcurveMarkerOptions]
  }
}
