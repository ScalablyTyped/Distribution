...
trait PlotEmaSonificationTracksMappingPanOptions extends StObject {
...
object PlotEmaSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
