...
trait PlotMappointSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotMappointSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
