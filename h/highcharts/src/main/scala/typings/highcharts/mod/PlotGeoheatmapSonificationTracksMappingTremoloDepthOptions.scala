...
trait PlotGeoheatmapSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
