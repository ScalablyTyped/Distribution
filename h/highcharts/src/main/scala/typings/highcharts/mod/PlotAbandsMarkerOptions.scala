...
trait PlotAbandsMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAbandsMarkerStatesOptions] = js.undefined
  /**
...
object PlotAbandsMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAbandsMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAbandsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsMarkerOptions]
  }
}
