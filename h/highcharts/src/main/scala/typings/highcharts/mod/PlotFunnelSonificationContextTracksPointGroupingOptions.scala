...
trait PlotFunnelSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotFunnelSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
