...
trait PlotPolygonSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
