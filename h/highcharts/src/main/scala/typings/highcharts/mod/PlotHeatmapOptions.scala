...
trait PlotHeatmapOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotHeatmapSonificationOptions] = js.undefined
...
object PlotHeatmapOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotHeatmapOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotHeatmapSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
