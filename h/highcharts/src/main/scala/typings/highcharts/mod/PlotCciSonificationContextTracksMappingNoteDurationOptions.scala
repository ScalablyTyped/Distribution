...
trait PlotCciSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotCciSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotCciSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
