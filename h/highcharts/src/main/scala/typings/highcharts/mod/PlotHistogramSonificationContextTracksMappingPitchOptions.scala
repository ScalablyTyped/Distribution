...
trait PlotHistogramSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotHistogramSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
