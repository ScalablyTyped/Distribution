...
trait PlotPpoSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPpoSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
