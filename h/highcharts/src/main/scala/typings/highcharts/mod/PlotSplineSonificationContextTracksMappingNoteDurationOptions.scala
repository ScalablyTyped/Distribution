...
trait PlotSplineSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
