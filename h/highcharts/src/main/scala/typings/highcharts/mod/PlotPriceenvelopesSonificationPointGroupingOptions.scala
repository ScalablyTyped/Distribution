...
trait PlotPriceenvelopesSonificationPointGroupingOptions extends StObject {
...
object PlotPriceenvelopesSonificationPointGroupingOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
