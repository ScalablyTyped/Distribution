...
trait PlotWordcloudSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotWordcloudSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
