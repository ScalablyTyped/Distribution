...
trait PlotDmiSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotDmiSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotDmiSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
