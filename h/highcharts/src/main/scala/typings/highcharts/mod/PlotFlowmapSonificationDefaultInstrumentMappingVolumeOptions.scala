...
trait PlotFlowmapSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotFlowmapSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
