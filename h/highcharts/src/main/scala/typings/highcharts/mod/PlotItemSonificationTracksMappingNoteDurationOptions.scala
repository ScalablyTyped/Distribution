...
trait PlotItemSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotItemSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
