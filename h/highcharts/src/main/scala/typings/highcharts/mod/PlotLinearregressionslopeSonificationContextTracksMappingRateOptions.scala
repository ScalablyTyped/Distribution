...
trait PlotLinearregressionslopeSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotLinearregressionslopeSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
