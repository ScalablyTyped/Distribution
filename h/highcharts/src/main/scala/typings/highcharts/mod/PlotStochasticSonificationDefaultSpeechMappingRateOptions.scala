...
trait PlotStochasticSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotStochasticSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
