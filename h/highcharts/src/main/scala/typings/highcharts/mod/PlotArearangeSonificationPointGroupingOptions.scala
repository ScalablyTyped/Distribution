...
trait PlotArearangeSonificationPointGroupingOptions extends StObject {
...
object PlotArearangeSonificationPointGroupingOptions {
  
  inline def apply(): PlotArearangeSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
