...
object NavigatorXAxisPlotLinesLabelOptions {
  ...
  @scala.inline
  def apply(): NavigatorXAxisPlotLinesLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisPlotLinesLabelOptions]
  }
  
  @scala.inline
  implicit class NavigatorXAxisPlotLinesLabelOptionsMutableBuilder[Self <: NavigatorXAxisPlotLinesLabelOptions] (val x: Self) extends AnyVal {
