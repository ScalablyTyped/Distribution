...
trait PlotPivotpointsSonificationTracksPointGroupingOptions extends StObject {
...
object PlotPivotpointsSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
