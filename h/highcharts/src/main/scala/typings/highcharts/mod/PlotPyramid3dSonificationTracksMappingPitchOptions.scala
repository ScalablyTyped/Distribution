...
trait PlotPyramid3dSonificationTracksMappingPitchOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
