...
trait PlotPpoSonificationTracksMappingPitchOptions extends StObject {
...
object PlotPpoSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
