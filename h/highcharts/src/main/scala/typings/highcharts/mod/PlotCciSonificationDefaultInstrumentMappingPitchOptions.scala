...
trait PlotCciSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotCciSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotCciSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
