...
trait PlotDumbbellSonificationPointGroupingOptions extends StObject {
...
object PlotDumbbellSonificationPointGroupingOptions {
  
  inline def apply(): PlotDumbbellSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
