...
trait PlotColumnpyramidSonificationTracksMappingPitchOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
