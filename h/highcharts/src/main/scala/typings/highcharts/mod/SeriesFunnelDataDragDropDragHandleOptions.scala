...
trait SeriesFunnelDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesFunnelDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesFunnelDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesFunnelDataDragDropDragHandleOptions]
  }
}
