...
trait PlotPyramid3dSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
