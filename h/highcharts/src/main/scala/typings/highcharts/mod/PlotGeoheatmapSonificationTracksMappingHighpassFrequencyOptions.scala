...
trait PlotGeoheatmapSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
