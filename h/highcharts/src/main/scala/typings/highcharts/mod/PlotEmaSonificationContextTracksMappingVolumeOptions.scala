...
trait PlotEmaSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotEmaSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotEmaSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
