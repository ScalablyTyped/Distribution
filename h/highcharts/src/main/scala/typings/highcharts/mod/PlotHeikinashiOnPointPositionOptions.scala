...
trait PlotHeikinashiOnPointPositionOptions extends StObject {
...
object PlotHeikinashiOnPointPositionOptions {
  
  inline def apply(): PlotHeikinashiOnPointPositionOptions = {
