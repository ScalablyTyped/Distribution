...
trait PlotBubbleClusterZonesOptions extends StObject {
...
object PlotBubbleClusterZonesOptions {
  
  inline def apply(): PlotBubbleClusterZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleClusterZonesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleClusterZonesOptions] (val x: Self) extends AnyVal {
