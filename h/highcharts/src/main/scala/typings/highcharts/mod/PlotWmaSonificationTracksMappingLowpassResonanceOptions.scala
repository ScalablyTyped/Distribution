...
trait PlotWmaSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotWmaSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
