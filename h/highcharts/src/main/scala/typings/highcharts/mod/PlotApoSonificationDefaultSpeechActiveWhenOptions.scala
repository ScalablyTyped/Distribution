...
trait PlotApoSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotApoSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotApoSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
