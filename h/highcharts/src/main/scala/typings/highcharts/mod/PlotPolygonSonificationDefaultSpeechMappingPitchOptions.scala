...
trait PlotPolygonSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotPolygonSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
