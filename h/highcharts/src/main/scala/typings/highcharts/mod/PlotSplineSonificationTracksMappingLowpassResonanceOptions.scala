...
trait PlotSplineSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotSplineSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
