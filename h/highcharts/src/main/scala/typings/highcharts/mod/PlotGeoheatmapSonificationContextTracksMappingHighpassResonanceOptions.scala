...
trait PlotGeoheatmapSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
