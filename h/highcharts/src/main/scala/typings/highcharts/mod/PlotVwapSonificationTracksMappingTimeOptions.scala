...
trait PlotVwapSonificationTracksMappingTimeOptions extends StObject {
...
object PlotVwapSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotVwapSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVwapSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
