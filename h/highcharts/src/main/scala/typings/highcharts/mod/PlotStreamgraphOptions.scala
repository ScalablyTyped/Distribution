...
trait PlotStreamgraphOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotStreamgraphSonificationOptions] = js.undefined
...
object PlotStreamgraphOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotStreamgraphSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
