...
trait PlotSmaSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotSmaSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
