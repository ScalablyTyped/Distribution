...
trait PlotTrixSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
