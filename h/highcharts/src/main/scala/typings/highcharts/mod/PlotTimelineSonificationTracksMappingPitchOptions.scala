...
trait PlotTimelineSonificationTracksMappingPitchOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
