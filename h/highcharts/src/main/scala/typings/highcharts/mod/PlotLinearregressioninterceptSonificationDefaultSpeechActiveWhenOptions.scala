...
trait PlotLinearregressioninterceptSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
