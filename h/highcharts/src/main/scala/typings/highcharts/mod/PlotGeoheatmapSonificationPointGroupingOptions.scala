...
trait PlotGeoheatmapSonificationPointGroupingOptions extends StObject {
...
object PlotGeoheatmapSonificationPointGroupingOptions {
  
  inline def apply(): PlotGeoheatmapSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
