...
trait PlotFlagsDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotFlagsDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotFlagsDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotFlagsDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotFlagsDataLabelsOptionsMutableBuilder[Self <: PlotFlagsDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotFlagsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
