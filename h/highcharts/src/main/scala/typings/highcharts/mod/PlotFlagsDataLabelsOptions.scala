...
@js.native
trait PlotFlagsDataLabelsOptions extends js.Object {
...
object PlotFlagsDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotFlagsDataLabelsOptionsOps[Self <: PlotFlagsDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotFlagsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
