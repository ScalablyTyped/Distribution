...
trait PlotCmoSonificationTracksMappingPitchOptions extends StObject {
...
object PlotCmoSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
