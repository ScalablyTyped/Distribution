...
trait PlotFunnel3dSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
