...
trait PlotTreemapSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
