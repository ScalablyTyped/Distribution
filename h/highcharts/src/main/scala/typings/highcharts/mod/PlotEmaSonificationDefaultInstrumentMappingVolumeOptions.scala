...
trait PlotEmaSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotEmaSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotEmaSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
