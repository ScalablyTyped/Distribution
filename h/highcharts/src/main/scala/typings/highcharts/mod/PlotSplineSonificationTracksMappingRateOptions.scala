...
trait PlotSplineSonificationTracksMappingRateOptions extends StObject {
...
object PlotSplineSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
