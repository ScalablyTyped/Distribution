...
trait PlotMappointSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotMappointSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
