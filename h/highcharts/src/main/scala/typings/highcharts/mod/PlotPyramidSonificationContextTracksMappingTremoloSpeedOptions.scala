...
trait PlotPyramidSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPyramidSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
