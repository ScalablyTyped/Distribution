...
trait PlotMapSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotMapSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotMapSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
