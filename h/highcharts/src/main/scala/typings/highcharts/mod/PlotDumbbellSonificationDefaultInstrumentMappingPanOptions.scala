...
trait PlotDumbbellSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotDumbbellSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
