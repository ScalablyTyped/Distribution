...
trait PlotDisparityindexSonificationTracksMappingPanOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
