...
trait PlotWmaSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotWmaSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotWmaSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
