...
trait PlotSankeySonificationTracksPointGroupingOptions extends StObject {
...
object PlotSankeySonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotSankeySonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeySonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeySonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
