...
trait PlotChaikinAccessibilityPointOptions extends StObject {
...
object PlotChaikinAccessibilityPointOptions {
  
  inline def apply(): PlotChaikinAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotChaikinAccessibilityPointOptions] (val x: Self) extends AnyVal {
