...
trait PlotTimelineSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
