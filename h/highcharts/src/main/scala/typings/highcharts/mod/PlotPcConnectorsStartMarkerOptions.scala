...
trait PlotPcConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotPcConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPcConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPcConnectorsStartMarkerOptions]
  }
}
