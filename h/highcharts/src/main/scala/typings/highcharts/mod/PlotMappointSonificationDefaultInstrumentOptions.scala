...
trait PlotMappointSonificationDefaultInstrumentOptions extends StObject {
  
  /**
    * (Highmaps) Define a condition for when a track should be active and not.
    *
  ...
  var activeWhen: js.UndefOr[
    js.Object | js.Function | PlotMappointSonificationDefaultInstrumentActiveWhenOptions
  ] = js.undefined
  
  /**
    * (Highmaps) Instrument to use for playing.
    *
  ...
  /**
    * (Highmaps) Mapping options for the audio parameters.
    *
    ...
    */
  var mapping: js.UndefOr[PlotMappointSonificationDefaultInstrumentMappingOptions] = js.undefined
  
  /**
    * (Highmaps) Name to use for a track when exporting to MIDI. By default it
    * uses the series name if the track is related to a series.
    */
  var midiName: js.UndefOr[String] = js.undefined
  
  /**
    * (Highmaps) Options for point grouping, specifically for instrument
    * tracks.
    */
  var pointGrouping: js.UndefOr[PlotMappointSonificationDefaultInstrumentPointGroupingOptions] = js.undefined
  
  /**
    * (Highmaps) Round pitch mapping to musical notes.
    *
  ...
  /**
    * (Highmaps) Show play marker (tooltip and/or crosshair) for a track.
    */
  var showPlayMarker: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Highmaps) Type of track. Always `"instrument"` for instrument tracks,
    * and `"speech"` for speech tracks.
    */
  var `type`: js.UndefOr[OptionsTypeValue] = js.undefined
}
object PlotMappointSonificationDefaultInstrumentOptions {
  
  inline def apply(): PlotMappointSonificationDefaultInstrumentOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultInstrumentOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultInstrumentOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotMappointSonificationDefaultInstrumentActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotMappointSonificationDefaultInstrumentMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotMappointSonificationDefaultInstrumentPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
