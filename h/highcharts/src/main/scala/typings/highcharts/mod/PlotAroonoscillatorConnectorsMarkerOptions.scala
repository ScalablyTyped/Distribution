...
trait PlotAroonoscillatorConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotAroonoscillatorConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorConnectorsMarkerOptions]
  }
}
