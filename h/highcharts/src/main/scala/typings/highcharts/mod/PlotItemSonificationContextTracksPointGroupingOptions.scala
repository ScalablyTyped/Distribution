...
trait PlotItemSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotItemSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotItemSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
