...
trait PlotPictorialSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotPictorialSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
