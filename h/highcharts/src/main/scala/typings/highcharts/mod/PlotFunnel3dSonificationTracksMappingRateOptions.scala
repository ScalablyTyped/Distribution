...
trait PlotFunnel3dSonificationTracksMappingRateOptions extends StObject {
...
object PlotFunnel3dSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
