...
trait PlotGanttSonificationDefaultSpeechOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotGanttSonificationDefaultSpeechActiveWhenOptions] = js.undefined
  
  /**
    * (Gantt) The language to speak in for speech tracks, as an IETF BCP 47
    * language tag.
    */
  var language: js.UndefOr[String] = js.undefined
  
  /**
    * (Gantt) Mapping configuration for the speech/audio parameters.
    *
    ...
    */
  var mapping: js.UndefOr[PlotGanttSonificationDefaultSpeechMappingOptions] = js.undefined
  
  /**
    * (Gantt) Options for point grouping, specifically for instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotGanttSonificationDefaultSpeechPointGroupingOptions] = js.undefined
  
  /**
    * (Gantt) Name of the voice synthesis to prefer for speech tracks.
    *
...
object PlotGanttSonificationDefaultSpeechOptions {
  
  inline def apply(): PlotGanttSonificationDefaultSpeechOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationDefaultSpeechOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationDefaultSpeechOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotGanttSonificationDefaultSpeechActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotGanttSonificationDefaultSpeechMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    
    inline def setMappingUndefined: Self = StObject.set(x, "mapping", js.undefined)
    
    inline def setPointGrouping(value: PlotGanttSonificationDefaultSpeechPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
