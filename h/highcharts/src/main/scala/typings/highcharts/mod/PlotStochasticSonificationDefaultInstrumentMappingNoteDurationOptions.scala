...
trait PlotStochasticSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotStochasticSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
