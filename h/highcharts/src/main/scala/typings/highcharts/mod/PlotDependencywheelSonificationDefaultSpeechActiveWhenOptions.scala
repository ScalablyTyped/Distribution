...
trait PlotDependencywheelSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotDependencywheelSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
