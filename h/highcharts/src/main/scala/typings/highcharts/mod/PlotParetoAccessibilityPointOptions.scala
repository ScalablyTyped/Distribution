...
trait PlotParetoAccessibilityPointOptions extends StObject {
...
object PlotParetoAccessibilityPointOptions {
  
  inline def apply(): PlotParetoAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoAccessibilityPointOptions] (val x: Self) extends AnyVal {
