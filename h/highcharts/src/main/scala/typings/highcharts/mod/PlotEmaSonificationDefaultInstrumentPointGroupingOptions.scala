...
trait PlotEmaSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotEmaSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotEmaSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
