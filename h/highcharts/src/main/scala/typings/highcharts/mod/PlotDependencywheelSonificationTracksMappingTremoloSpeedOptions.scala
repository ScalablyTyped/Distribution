...
trait PlotDependencywheelSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
