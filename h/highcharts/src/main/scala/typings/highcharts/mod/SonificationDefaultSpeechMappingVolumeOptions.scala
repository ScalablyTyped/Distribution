...
trait SonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object SonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): SonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
