...
trait PlotOrganizationSonificationTracksPointGroupingOptions extends StObject {
...
object PlotOrganizationSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotOrganizationSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOrganizationSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
