...
trait PlotWordcloudSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
