...
@js.native
trait PlotColumnpyramidDataSortingOptions extends js.Object {
  /**
...
object PlotColumnpyramidDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotColumnpyramidDataSortingOptionsOps[Self <: PlotColumnpyramidDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
