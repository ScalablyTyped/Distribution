...
trait PlotColumnpyramidDataSortingOptions extends StObject {
...
object PlotColumnpyramidDataSortingOptions {
  
  @scala.inline
  def apply(): PlotColumnpyramidDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotColumnpyramidDataSortingOptionsMutableBuilder[Self <: PlotColumnpyramidDataSortingOptions] (val x: Self) extends AnyVal {
