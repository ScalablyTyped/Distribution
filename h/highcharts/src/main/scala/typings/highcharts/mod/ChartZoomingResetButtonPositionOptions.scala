...
trait ChartZoomingResetButtonPositionOptions extends StObject {
...
object ChartZoomingResetButtonPositionOptions {
  
  inline def apply(): ChartZoomingResetButtonPositionOptions = {
