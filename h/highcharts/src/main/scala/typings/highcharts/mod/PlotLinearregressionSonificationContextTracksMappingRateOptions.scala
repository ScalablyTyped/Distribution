...
trait PlotLinearregressionSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
