...
trait PlotPolygonSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
