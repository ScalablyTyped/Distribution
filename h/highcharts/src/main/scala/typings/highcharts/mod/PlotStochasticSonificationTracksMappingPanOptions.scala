...
trait PlotStochasticSonificationTracksMappingPanOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
