...
trait PlotPriceenvelopesSonificationTracksMappingRateOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
