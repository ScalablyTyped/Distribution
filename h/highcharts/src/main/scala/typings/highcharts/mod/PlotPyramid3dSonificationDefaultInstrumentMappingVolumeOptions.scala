...
trait PlotPyramid3dSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
