...
trait PlotDumbbellSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotDumbbellSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
