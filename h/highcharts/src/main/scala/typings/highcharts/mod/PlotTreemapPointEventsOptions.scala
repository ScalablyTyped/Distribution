...
trait PlotTreemapPointEventsOptions extends js.Object {
  /**
...
object PlotTreemapPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotTreemapPointEventsOptions]
  }
}
