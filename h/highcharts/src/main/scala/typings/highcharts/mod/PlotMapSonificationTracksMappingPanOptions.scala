...
trait PlotMapSonificationTracksMappingPanOptions extends StObject {
...
object PlotMapSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
