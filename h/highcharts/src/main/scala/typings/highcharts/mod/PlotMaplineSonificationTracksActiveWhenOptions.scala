...
trait PlotMaplineSonificationTracksActiveWhenOptions extends StObject {
...
object PlotMaplineSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotMaplineSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
