...
trait PlotXrangeSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotXrangeSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
