...
trait PlotScatter3dConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotScatter3dConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatter3dConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dConnectorsMarkerOptions]
  }
}
