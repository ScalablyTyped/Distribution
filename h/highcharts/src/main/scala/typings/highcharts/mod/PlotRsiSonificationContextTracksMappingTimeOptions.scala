...
trait PlotRsiSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotRsiSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
