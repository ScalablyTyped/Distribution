...
trait PlotTreegraphLevelsDataLabelsAnimationOptions extends StObject {
...
object PlotTreegraphLevelsDataLabelsAnimationOptions {
  
  inline def apply(): PlotTreegraphLevelsDataLabelsAnimationOptions = {
