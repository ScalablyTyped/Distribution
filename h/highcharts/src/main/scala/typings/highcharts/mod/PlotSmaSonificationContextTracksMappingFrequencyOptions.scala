...
trait PlotSmaSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotSmaSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
