...
trait PlotEmaSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotEmaSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotEmaSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
