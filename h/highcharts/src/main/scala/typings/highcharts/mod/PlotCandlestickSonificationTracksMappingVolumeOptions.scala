...
trait PlotCandlestickSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
