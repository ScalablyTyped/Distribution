...
trait PlotWordcloudSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
