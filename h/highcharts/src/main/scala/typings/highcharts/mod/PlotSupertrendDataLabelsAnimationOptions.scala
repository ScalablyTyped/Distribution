...
@js.native
trait PlotSupertrendDataLabelsAnimationOptions extends js.Object {
...
object PlotSupertrendDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotSupertrendDataLabelsAnimationOptionsOps[Self <: PlotSupertrendDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
