...
trait PlotItemSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotItemSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotItemSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
