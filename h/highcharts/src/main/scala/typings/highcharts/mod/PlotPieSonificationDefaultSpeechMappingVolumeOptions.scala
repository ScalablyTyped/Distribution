...
trait PlotPieSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotPieSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotPieSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
