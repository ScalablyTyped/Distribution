...
trait PlotAtrSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotAtrSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
