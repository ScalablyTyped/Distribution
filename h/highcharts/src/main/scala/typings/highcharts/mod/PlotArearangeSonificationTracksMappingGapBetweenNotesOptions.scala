...
trait PlotArearangeSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
