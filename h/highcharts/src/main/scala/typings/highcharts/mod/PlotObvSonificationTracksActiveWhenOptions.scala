...
trait PlotObvSonificationTracksActiveWhenOptions extends StObject {
...
object PlotObvSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotObvSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotObvSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotObvSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
