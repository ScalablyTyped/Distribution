...
trait PlotHollowcandlestickSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotHollowcandlestickSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
