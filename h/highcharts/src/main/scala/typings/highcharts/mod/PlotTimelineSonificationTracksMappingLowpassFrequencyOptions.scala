...
trait PlotTimelineSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
