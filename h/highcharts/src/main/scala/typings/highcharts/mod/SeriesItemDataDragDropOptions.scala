...
trait SeriesItemDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesItemDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesItemDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesItemDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesItemDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesItemDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesItemDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesItemDataDragDropOptions]
  }
}
