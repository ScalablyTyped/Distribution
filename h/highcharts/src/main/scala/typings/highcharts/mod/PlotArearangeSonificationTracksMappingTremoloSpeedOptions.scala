...
trait PlotArearangeSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
