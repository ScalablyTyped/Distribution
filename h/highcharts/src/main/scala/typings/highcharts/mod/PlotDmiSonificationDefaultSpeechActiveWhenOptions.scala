...
trait PlotDmiSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotDmiSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotDmiSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
