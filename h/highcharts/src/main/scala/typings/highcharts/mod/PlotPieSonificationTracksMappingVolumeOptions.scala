...
trait PlotPieSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotPieSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotPieSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
