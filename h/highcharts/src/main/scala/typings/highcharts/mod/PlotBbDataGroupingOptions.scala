...
trait PlotBbDataGroupingOptions extends js.Object {
  /**
...
object PlotBbDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotBbDataGroupingOptions]
  }
}
