...
trait PlotLineConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotLineConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLineConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLineConnectorsEndMarkerOptions]
  }
}
