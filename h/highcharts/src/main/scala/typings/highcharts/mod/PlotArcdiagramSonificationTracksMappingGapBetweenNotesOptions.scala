...
trait PlotArcdiagramSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
