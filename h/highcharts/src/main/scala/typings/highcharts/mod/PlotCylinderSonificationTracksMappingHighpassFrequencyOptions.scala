...
trait PlotCylinderSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
