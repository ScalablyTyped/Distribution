...
trait PlotPolygonSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
