...
trait PlotLinearregressionangleParamsOptions extends StObject {
...
object PlotLinearregressionangleParamsOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleParamsOptions] (val x: Self) extends AnyVal {
