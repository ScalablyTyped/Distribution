...
trait PlotCmoSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotCmoSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
