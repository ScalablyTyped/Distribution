...
trait PlotFunnel3dConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotFunnel3dConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotFunnel3dConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotFunnel3dConnectorsMarkerOptions]
  }
}
