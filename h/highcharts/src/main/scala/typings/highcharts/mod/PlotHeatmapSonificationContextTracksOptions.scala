...
trait PlotHeatmapSonificationContextTracksOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotHeatmapSonificationContextTracksActiveWhenOptions] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[PlotHeatmapSonificationContextTracksMappingOptions] = js.undefined
  ...
  /**
    ...
    * instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotHeatmapSonificationContextTracksPointGroupingOptions] = js.undefined
  ...
  /**
    * (Highcharts, Highmaps) Set a context track to play periodically every
  ...
  /**
    * (Highcharts, Highmaps) How to map context events to time when using the
    * `valueInterval` option.
    */
  var valueMapFunction: js.UndefOr[OptionsValueMapFunctionValue] = js.undefined
  
  /**
    * (Highcharts, Highmaps) The point property to play context for when using
    * `valueInterval`.
    */
  var valueProp: js.UndefOr[String] = js.undefined
}
object PlotHeatmapSonificationContextTracksOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotHeatmapSonificationContextTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotHeatmapSonificationContextTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotHeatmapSonificationContextTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
