...
trait PlotIkhSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotIkhSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
