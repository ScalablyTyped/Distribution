...
trait PlotTimelineSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
