...
trait PlotSmaSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotSmaSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
