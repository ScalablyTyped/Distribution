...
trait PlotRocSonificationTracksPointGroupingOptions extends StObject {
...
object PlotRocSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotRocSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRocSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
