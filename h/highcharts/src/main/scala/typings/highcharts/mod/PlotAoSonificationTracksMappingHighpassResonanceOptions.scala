...
trait PlotAoSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotAoSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
