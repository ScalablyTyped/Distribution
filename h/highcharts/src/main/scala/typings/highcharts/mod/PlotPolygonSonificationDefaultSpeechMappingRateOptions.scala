...
trait PlotPolygonSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotPolygonSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
