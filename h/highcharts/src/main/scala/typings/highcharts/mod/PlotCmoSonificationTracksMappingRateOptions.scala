...
trait PlotCmoSonificationTracksMappingRateOptions extends StObject {
...
object PlotCmoSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
