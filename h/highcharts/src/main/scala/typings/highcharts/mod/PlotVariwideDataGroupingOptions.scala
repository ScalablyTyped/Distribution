...
trait PlotVariwideDataGroupingOptions extends js.Object {
  /**
...
object PlotVariwideDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVariwideDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotVariwideDataGroupingOptions]
  }
}
