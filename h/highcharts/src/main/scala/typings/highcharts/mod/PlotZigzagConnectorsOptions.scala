...
trait PlotZigzagConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotZigzagConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotZigzagConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotZigzagConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotZigzagConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotZigzagConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotZigzagConnectorsMarkerOptions = null,
    startMarker: PlotZigzagConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotZigzagConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagConnectorsOptions]
  }
}
