...
trait PlotSplineSonificationTracksMappingTimeOptions extends StObject {
...
object PlotSplineSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
