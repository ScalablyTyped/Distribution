...
trait PlotCylinderSonificationTracksActiveWhenOptions extends StObject {
...
object PlotCylinderSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotCylinderSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
