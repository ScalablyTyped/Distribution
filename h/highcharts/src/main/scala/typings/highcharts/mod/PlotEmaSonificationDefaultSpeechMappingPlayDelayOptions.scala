...
trait PlotEmaSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotEmaSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotEmaSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
