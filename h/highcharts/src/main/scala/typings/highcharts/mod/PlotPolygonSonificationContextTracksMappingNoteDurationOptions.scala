...
trait PlotPolygonSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
