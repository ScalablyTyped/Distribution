...
trait PlotHistogramSonificationDefaultInstrumentMappingOptions extends StObject {
  
  /**
    * (Highcharts) Frequency in Hertz of notes. Overrides pitch mapping if set.
    */
  var frequency: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingFrequencyOptions
  ] = js.undefined
  ...
  var gapBetweenNotes: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingGapBetweenNotesOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var highpass: js.UndefOr[PlotHistogramSonificationDefaultInstrumentMappingHighpassOptions] = js.undefined
  ...
  /**
    ...
    */
  var lowpass: js.UndefOr[PlotHistogramSonificationDefaultInstrumentMappingLowpassOptions] = js.undefined
  ...
  var noteDuration: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingNoteDurationOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var pan: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingPanOptions
  ] = js.undefined
  ...
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingPitchOptions | (js.Array[String | Double])
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingPlayDelayOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingTimeOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var tremolo: js.UndefOr[PlotHistogramSonificationDefaultInstrumentMappingTremoloOptions] = js.undefined
  
  /**
    * (Highcharts) The volume of notes, from 0 to 1.
    */
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingVolumeOptions
  ] = js.undefined
}
object PlotHistogramSonificationDefaultInstrumentMappingOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultInstrumentMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultInstrumentMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultInstrumentMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setFrequency(
      value: Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingFrequencyOptions
    ): Self = StObject.set(x, "frequency", value.asInstanceOf[js.Any])
    
    inline def setFrequencyUndefined: Self = StObject.set(x, "frequency", js.undefined)
    
    inline def setGapBetweenNotes(
      value: Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingGapBetweenNotesOptions
    ...
    inline def setHighpass(value: PlotHistogramSonificationDefaultInstrumentMappingHighpassOptions): Self = StObject.set(x, "highpass", value.asInstanceOf[js.Any])
    
    inline def setHighpassUndefined: Self = StObject.set(x, "highpass", js.undefined)
    
    inline def setLowpass(value: PlotHistogramSonificationDefaultInstrumentMappingLowpassOptions): Self = StObject.set(x, "lowpass", value.asInstanceOf[js.Any])
    
    inline def setLowpassUndefined: Self = StObject.set(x, "lowpass", js.undefined)
    
    inline def setNoteDuration(
      value: Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingNoteDurationOptions
    ...
    inline def setPan(
      value: Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingPanOptions
    ): Self = StObject.set(x, "pan", value.asInstanceOf[js.Any])
    
    inline def setPanUndefined: Self = StObject.set(x, "pan", js.undefined)
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingPitchOptions | (js.Array[String | Double])
    ...
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingPlayDelayOptions
    ...
    inline def setTime(
      value: Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingTimeOptions
    ): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setTremolo(value: PlotHistogramSonificationDefaultInstrumentMappingTremoloOptions): Self = StObject.set(x, "tremolo", value.asInstanceOf[js.Any])
    
    inline def setTremoloUndefined: Self = StObject.set(x, "tremolo", js.undefined)
    
    inline def setVolume(
      value: Double | js.Object | String | js.Function | PlotHistogramSonificationDefaultInstrumentMappingVolumeOptions
