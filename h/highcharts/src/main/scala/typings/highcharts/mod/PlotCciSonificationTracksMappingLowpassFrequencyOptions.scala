...
trait PlotCciSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotCciSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
