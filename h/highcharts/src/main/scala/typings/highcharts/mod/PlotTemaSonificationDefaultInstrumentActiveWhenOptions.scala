...
trait PlotTemaSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotTemaSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotTemaSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
