...
trait SeriesLineDataMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesLineDataMarkerStatesOptions] = js.undefined
  /**
...
object SeriesLineDataMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: SeriesLineDataMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): SeriesLineDataMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesLineDataMarkerOptions]
  }
}
