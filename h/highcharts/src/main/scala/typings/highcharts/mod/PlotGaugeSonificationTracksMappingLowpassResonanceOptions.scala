...
trait PlotGaugeSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
