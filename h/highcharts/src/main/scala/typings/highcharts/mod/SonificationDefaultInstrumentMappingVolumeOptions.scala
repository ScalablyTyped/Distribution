...
trait SonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object SonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): SonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
