...
trait PlotRocSonificationTracksMappingRateOptions extends StObject {
...
object PlotRocSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotRocSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRocSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
