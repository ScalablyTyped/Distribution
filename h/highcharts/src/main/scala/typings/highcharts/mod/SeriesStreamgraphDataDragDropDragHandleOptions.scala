...
trait SeriesStreamgraphDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesStreamgraphDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesStreamgraphDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesStreamgraphDataDragDropDragHandleOptions]
  }
}
