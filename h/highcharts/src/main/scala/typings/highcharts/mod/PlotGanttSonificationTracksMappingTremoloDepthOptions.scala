...
trait PlotGanttSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotGanttSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
