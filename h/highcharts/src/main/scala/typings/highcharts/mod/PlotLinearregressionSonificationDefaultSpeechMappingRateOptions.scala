...
trait PlotLinearregressionSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotLinearregressionSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotLinearregressionSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
