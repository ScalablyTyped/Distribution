...
trait PlotNetworkgraphSonificationTracksPointGroupingOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
