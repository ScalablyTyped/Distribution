...
trait PlotTrixSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
