...
trait PlotCylinderSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotCylinderSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
