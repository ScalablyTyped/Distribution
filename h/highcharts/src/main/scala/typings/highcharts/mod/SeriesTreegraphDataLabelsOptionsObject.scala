...
trait SeriesTreegraphDataLabelsOptionsObject extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotTreegraphDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object SeriesTreegraphDataLabelsOptionsObject {
  
  inline def apply(): SeriesTreegraphDataLabelsOptionsObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesTreegraphDataLabelsOptionsObject]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesTreegraphDataLabelsOptionsObject] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotTreegraphDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
