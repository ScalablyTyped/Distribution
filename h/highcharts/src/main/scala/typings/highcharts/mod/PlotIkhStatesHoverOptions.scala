...
trait PlotIkhStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotIkhStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotIkhStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotIkhStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotIkhStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotIkhStatesHoverOptions]
  }
}
