...
trait PlotGaugeSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotGaugeSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotGaugeSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
