...
trait PlotBoxplotSonificationTracksMappingRateOptions extends StObject {
...
object PlotBoxplotSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotBoxplotSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBoxplotSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
