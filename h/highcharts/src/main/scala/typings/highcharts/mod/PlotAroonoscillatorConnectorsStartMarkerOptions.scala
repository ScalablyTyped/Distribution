...
trait PlotAroonoscillatorConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotAroonoscillatorConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorConnectorsStartMarkerOptions]
  }
}
