...
trait PlotFunnel3dSonificationTracksActiveWhenOptions extends StObject {
...
object PlotFunnel3dSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
