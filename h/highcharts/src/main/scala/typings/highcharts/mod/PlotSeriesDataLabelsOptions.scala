...
@js.native
trait PlotSeriesDataLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotSeriesDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotSeriesDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotSeriesDataLabelsOptionsOps[Self <: PlotSeriesDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSeriesDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
