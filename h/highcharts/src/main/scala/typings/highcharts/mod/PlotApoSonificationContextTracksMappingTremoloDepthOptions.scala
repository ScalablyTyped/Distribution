...
trait PlotApoSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
