...
trait PlotRsiSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotRsiSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
