...
trait PlotHeatmapSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
