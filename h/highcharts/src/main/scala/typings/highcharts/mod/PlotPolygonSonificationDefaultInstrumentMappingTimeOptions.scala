...
trait PlotPolygonSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotPolygonSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
