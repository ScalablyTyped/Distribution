...
trait PlotSplineSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
