...
trait PlotSupertrendSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
