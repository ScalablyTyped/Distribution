...
trait PlotCandlestickSonificationTracksMappingPitchOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
