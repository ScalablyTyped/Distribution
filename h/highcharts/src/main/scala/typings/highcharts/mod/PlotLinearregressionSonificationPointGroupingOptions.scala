...
trait PlotLinearregressionSonificationPointGroupingOptions extends StObject {
...
object PlotLinearregressionSonificationPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
