...
trait PlotPyramidSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
