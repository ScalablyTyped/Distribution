...
trait PlotLinearregressionslopeSonificationTracksPointGroupingOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
