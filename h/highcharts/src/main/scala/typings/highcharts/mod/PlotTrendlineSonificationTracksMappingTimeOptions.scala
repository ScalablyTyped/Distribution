...
trait PlotTrendlineSonificationTracksMappingTimeOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
