...
trait PlotCciSonificationTracksPointGroupingOptions extends StObject {
...
object PlotCciSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotCciSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
