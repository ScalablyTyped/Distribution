...
trait PlotDpoMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotDpoMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDpoMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotDpoMarkerStatesSelectOptions]
  }
}
