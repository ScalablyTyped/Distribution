...
trait PlotLinearregressioninterceptSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
