...
trait PlotBarSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotBarSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotBarSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
