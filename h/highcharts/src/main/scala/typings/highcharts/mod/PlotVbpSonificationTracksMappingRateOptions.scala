...
trait PlotVbpSonificationTracksMappingRateOptions extends StObject {
...
object PlotVbpSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotVbpSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVbpSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
