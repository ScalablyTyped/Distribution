...
trait PlotAreaSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotAreaSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotAreaSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
