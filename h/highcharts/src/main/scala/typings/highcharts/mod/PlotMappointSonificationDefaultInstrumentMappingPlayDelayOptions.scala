...
trait PlotMappointSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotMappointSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotMappointSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
