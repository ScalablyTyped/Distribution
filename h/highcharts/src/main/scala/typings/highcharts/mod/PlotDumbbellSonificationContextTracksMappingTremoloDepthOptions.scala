...
trait PlotDumbbellSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
