...
trait PlotTemaSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotTemaSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotTemaSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
