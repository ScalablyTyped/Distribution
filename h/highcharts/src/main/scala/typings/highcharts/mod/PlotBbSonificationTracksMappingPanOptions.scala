...
trait PlotBbSonificationTracksMappingPanOptions extends StObject {
...
object PlotBbSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotBbSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBbSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
