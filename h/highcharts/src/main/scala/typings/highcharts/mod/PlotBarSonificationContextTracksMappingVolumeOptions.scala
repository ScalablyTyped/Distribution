...
trait PlotBarSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotBarSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotBarSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
