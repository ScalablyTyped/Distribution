...
trait PlotSupertrendSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
