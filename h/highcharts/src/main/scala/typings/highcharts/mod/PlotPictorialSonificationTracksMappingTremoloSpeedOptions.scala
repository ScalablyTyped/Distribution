...
trait PlotPictorialSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
