...
trait PlotParetoSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotParetoSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotParetoSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
