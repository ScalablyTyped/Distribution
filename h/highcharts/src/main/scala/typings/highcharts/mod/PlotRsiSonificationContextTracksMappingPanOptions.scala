...
trait PlotRsiSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotRsiSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
