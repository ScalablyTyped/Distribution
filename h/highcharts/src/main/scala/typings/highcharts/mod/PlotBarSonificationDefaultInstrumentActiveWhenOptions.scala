...
trait PlotBarSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotBarSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotBarSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
