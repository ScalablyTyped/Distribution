...
trait PlotColumnSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotColumnSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
