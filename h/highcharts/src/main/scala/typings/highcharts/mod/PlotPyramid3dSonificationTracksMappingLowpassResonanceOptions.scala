...
trait PlotPyramid3dSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
