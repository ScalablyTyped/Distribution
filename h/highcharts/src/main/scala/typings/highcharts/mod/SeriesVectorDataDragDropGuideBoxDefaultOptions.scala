...
trait SeriesVectorDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesVectorDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesVectorDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesVectorDataDragDropGuideBoxDefaultOptions]
  }
}
