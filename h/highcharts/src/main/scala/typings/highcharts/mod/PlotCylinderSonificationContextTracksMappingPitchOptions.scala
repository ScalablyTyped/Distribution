...
trait PlotCylinderSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotCylinderSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
