...
trait PlotDependencywheelSonificationTracksMappingPitchOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
