...
trait PlotNatrSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotNatrSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
