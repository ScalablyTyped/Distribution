...
trait PlotVariablepieSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotVariablepieSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
