...
trait PlotWmaSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotWmaSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
