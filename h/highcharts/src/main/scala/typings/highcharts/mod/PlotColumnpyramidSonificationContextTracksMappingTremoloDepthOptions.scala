...
trait PlotColumnpyramidSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
