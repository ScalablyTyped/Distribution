...
trait PlotSmaSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotSmaSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
