...
trait PlotTreemapSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotTreemapSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
