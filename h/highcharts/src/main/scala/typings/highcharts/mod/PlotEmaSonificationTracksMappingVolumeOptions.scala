...
trait PlotEmaSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotEmaSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
