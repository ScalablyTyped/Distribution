...
trait PlotSeriesSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotSeriesSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
