...
trait PlotXrangeSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotXrangeSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
