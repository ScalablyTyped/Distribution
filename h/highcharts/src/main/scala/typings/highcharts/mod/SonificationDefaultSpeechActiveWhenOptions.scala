...
trait SonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object SonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): SonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
