...
trait PlotColumnrangeSonificationTracksPointGroupingOptions extends StObject {
...
object PlotColumnrangeSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotColumnrangeSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
