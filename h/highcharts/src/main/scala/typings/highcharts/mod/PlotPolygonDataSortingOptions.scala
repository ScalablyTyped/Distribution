...
@js.native
trait PlotPolygonDataSortingOptions extends StObject {
...
object PlotPolygonDataSortingOptions {
  
  @scala.inline
  def apply(): PlotPolygonDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotPolygonDataSortingOptionsMutableBuilder[Self <: PlotPolygonDataSortingOptions] (val x: Self) extends AnyVal {
