...
@js.native
trait PlotPolygonDataSortingOptions extends js.Object {
...
object PlotPolygonDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotPolygonDataSortingOptionsOps[Self <: PlotPolygonDataSortingOptions] (val x: Self) extends AnyVal {
