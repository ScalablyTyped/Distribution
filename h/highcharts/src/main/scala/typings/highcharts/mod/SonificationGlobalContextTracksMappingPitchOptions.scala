...
trait SonificationGlobalContextTracksMappingPitchOptions extends StObject {
...
object SonificationGlobalContextTracksMappingPitchOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
