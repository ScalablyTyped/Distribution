...
trait PlotTimelineSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
