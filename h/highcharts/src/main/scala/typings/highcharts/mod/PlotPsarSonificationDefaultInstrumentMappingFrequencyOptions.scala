...
trait PlotPsarSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotPsarSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotPsarSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
