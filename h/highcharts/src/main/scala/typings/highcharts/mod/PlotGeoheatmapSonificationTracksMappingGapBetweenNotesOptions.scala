...
trait PlotGeoheatmapSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
