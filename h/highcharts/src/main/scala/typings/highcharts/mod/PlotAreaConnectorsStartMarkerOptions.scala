...
trait PlotAreaConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotAreaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreaConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreaConnectorsStartMarkerOptions]
  }
}
