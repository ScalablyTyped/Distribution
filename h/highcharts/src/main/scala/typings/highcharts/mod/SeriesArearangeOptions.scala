...
import typings.highcharts.highchartsStrings.arearange
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesArearangeOptions
  extends StObject
     with PlotArearangeOptions {
...
object SeriesArearangeOptions {
  
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | arearange): SeriesArearangeOptions = {
  ...
  @scala.inline
  implicit class SeriesArearangeOptionsMutableBuilder[Self <: SeriesArearangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | arearange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
