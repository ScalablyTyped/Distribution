...
object SeriesArearangeOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | arearange): SeriesArearangeOptions = {
  ...
  implicit open class MutableBuilder[Self <: SeriesArearangeOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | arearange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
