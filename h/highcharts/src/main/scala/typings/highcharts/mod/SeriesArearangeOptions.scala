...
object SeriesArearangeOptions {
  ...
  @scala.inline
  implicit class SeriesArearangeOptionsOps[Self <: SeriesArearangeOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | arearange): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
    def setDataVarargs(
