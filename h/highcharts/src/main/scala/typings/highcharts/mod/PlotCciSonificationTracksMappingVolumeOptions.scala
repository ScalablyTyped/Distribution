...
trait PlotCciSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotCciSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
