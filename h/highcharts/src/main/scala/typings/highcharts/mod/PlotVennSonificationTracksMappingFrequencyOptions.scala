...
trait PlotVennSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotVennSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
