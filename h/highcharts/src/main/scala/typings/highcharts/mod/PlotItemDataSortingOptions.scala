...
trait PlotItemDataSortingOptions extends StObject {
...
object PlotItemDataSortingOptions {
  
  inline def apply(): PlotItemDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemDataSortingOptions] (val x: Self) extends AnyVal {
