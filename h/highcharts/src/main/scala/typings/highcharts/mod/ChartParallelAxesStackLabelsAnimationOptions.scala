...
trait ChartParallelAxesStackLabelsAnimationOptions extends StObject {
...
object ChartParallelAxesStackLabelsAnimationOptions {
  
  inline def apply(): ChartParallelAxesStackLabelsAnimationOptions = {
