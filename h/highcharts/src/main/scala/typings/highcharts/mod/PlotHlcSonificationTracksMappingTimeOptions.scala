...
trait PlotHlcSonificationTracksMappingTimeOptions extends StObject {
...
object PlotHlcSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotHlcSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHlcSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
