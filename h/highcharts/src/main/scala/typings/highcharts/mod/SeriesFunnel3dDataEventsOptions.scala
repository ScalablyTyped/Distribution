...
trait SeriesFunnel3dDataEventsOptions extends js.Object {
  /**
...
object SeriesFunnel3dDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesFunnel3dDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesFunnel3dDataEventsOptions]
  }
}
