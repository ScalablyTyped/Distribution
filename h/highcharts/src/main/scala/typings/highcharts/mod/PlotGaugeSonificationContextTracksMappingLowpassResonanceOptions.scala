...
trait PlotGaugeSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotGaugeSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotGaugeSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
