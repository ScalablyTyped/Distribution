...
trait PlotRsiSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotRsiSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
