...
trait PlotVariwideSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotVariwideSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
