...
trait PlotVariwideSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotVariwideSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
