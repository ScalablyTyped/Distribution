...
trait PlotPcStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotPcStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPcStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotPcStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotPcStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotPcStatesSelectOptions]
  }
}
