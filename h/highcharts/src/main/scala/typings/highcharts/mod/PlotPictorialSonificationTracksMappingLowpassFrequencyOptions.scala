...
trait PlotPictorialSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
