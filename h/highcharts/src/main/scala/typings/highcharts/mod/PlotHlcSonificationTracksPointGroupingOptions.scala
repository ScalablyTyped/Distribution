...
trait PlotHlcSonificationTracksPointGroupingOptions extends StObject {
...
object PlotHlcSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotHlcSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHlcSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
