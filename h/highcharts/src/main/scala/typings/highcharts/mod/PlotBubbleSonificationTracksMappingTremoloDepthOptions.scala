...
trait PlotBubbleSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotBubbleSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotBubbleSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
