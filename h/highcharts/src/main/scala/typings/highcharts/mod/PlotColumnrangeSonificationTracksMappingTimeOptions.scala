...
trait PlotColumnrangeSonificationTracksMappingTimeOptions extends StObject {
...
object PlotColumnrangeSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotColumnrangeSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
