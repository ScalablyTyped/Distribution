...
trait PlotAbandsSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotAbandsSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
