...
trait SeriesGeoheatmapDataOptions extends StObject {
  ...
  /**
    ...
    */
  var geometry: js.UndefOr[js.Object | SeriesGeoheatmapDataGeometryOptions] = js.undefined
  ...
  /**
    * (Highmaps) The value of the point, resulting in a color controled by
    * options as set in the colorAxis configuration.
    */
  var value: js.UndefOr[Double | Null] = js.undefined
}
object SeriesGeoheatmapDataOptions {
  
  inline def apply(): SeriesGeoheatmapDataOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGeoheatmapDataOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesGeoheatmapDataOptions] (val x: Self) extends AnyVal {
    ...
    inline def setGeometry(value: js.Object | SeriesGeoheatmapDataGeometryOptions): Self = StObject.set(x, "geometry", value.asInstanceOf[js.Any])
