...
trait PlotPivotpointsOnPointPositionOptions extends StObject {
...
object PlotPivotpointsOnPointPositionOptions {
  
  inline def apply(): PlotPivotpointsOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsOnPointPositionOptions] (val x: Self) extends AnyVal {
