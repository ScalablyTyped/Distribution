...
trait PlotVariwideSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotVariwideSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
