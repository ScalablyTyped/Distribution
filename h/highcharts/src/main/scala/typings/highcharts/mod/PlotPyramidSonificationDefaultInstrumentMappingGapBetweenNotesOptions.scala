...
trait PlotPyramidSonificationDefaultInstrumentMappingGapBetweenNotesOptions extends StObject {
...
object PlotPyramidSonificationDefaultInstrumentMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultInstrumentMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultInstrumentMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultInstrumentMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
