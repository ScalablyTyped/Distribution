...
trait PlotVariwideEventsOptions extends js.Object {
  /**
...
object PlotVariwideEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotVariwideEventsOptions]
  }
}
