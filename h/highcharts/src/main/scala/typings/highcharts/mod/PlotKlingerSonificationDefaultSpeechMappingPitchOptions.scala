...
trait PlotKlingerSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotKlingerSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
