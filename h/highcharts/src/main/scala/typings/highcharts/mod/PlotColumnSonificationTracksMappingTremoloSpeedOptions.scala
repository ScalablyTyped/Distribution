...
trait PlotColumnSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotColumnSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
