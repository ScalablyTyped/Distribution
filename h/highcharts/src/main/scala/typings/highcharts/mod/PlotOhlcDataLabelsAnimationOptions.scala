...
@js.native
trait PlotOhlcDataLabelsAnimationOptions extends js.Object {
...
object PlotOhlcDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): PlotOhlcDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class PlotOhlcDataLabelsAnimationOptionsOps[Self <: PlotOhlcDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
