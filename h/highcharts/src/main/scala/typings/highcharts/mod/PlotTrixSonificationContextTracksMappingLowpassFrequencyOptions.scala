...
trait PlotTrixSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
