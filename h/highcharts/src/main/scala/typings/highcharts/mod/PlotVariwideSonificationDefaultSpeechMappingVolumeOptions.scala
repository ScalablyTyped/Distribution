...
trait PlotVariwideSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotVariwideSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
