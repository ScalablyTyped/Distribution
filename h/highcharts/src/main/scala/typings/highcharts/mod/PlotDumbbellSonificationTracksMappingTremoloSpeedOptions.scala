...
trait PlotDumbbellSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
