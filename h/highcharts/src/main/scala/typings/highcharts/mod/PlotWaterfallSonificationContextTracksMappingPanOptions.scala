...
trait PlotWaterfallSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotWaterfallSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotWaterfallSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
