...
trait PlotAroonoscillatorOptions extends StObject {
  ...
  /**
    ...
    */
  var aroonDown: js.UndefOr[PlotAroonoscillatorAroonDownOptions] = js.undefined
...
object PlotAroonoscillatorOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotAroonoscillatorOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAroonDown(value: PlotAroonoscillatorAroonDownOptions): Self = StObject.set(x, "aroonDown", value.asInstanceOf[js.Any])
