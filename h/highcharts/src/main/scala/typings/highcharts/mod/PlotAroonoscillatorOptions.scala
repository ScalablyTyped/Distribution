...
trait PlotAroonoscillatorOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAroonoscillatorAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotAroonoscillatorOnPointOptions] = js.undefined
...
object PlotAroonoscillatorOptions {
  ...
  inline def apply(): PlotAroonoscillatorOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorOptions]
  }
  
  extension [Self <: PlotAroonoscillatorOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotAroonoscillatorAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotAroonoscillatorDataLabelsOptions | js.Array[PlotAroonoscillatorDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotAroonoscillatorDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotAroonoscillatorDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotAroonoscillatorOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotAroonoscillatorParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
