...
trait PlotDisparityindexSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
