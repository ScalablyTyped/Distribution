...
trait PlotPiePointEventsOptions extends js.Object {
  /**
...
object PlotPiePointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPiePointEventsOptions]
  }
}
