...
trait PlotLinearregressionSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
