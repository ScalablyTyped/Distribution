...
trait PlotIkhSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotIkhSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
