...
trait PlotPsarSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotPsarSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
