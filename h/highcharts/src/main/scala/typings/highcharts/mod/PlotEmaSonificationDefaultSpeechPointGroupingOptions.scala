...
trait PlotEmaSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotEmaSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotEmaSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
