...
trait PlotHeatmapSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotHeatmapSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
