...
trait PlotVwapSonificationPointGroupingOptions extends StObject {
...
object PlotVwapSonificationPointGroupingOptions {
  
  inline def apply(): PlotVwapSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVwapSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
