...
trait PlotVariwideSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
