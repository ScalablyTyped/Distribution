...
trait PlotLinearregressioninterceptSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
