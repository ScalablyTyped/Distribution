...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesColumnpyramidOptions extends PlotColumnpyramidOptions {
  /**
...
object SeriesColumnpyramidOptions {
  ...
  def apply(
    ...
    dataLabels: PlotColumnpyramidDataLabelsOptions | js.Array[PlotColumnpyramidDataLabelsOptions] = null,
