...
trait SeriesColumnpyramidOptions extends PlotColumnpyramidOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | columnpyramid = js.native
...
object SeriesColumnpyramidOptions {
  ...
  @scala.inline
  def apply(`type`: String | columnpyramid): SeriesColumnpyramidOptions = {
  ...
  @scala.inline
  implicit class SeriesColumnpyramidOptionsMutableBuilder[Self <: SeriesColumnpyramidOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | columnpyramid): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
