...
object SeriesColumnpyramidOptions {
  ...
  @scala.inline
  implicit class SeriesColumnpyramidOptionsOps[Self <: SeriesColumnpyramidOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | columnpyramid): Self = this.set("type", value.asInstanceOf[js.Any])
