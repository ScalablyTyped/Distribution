...
trait PlotBubbleSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
