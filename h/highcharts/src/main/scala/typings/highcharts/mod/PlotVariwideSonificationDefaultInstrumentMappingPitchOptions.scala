...
trait PlotVariwideSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotVariwideSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
