...
trait PlotSlowstochasticSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
