...
trait PlotPivotpointsSonificationPointGroupingOptions extends StObject {
...
object PlotPivotpointsSonificationPointGroupingOptions {
  
  inline def apply(): PlotPivotpointsSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
