...
trait PlotAreaSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotAreaSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotAreaSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
