...
trait PlotVariwideSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
