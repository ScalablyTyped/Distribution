...
trait PlotFunnelSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotFunnelSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
