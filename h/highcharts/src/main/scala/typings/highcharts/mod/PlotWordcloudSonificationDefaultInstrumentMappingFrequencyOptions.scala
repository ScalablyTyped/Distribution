...
trait PlotWordcloudSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotWordcloudSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
