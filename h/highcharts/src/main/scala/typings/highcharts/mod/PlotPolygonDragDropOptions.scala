...
trait PlotPolygonDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotPolygonDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotPolygonDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotPolygonDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotPolygonDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotPolygonDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotPolygonDragDropOptions]
  }
}
