...
trait PlotIkhSonificationTracksMappingPanOptions extends StObject {
...
object PlotIkhSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
