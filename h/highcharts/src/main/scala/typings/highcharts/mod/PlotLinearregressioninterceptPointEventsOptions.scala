...
trait PlotLinearregressioninterceptPointEventsOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressioninterceptPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptPointEventsOptions]
  }
}
