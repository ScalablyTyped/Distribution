...
trait PlotDmiSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotDmiSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
