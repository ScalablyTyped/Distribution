...
trait PlotPieSonificationTracksMappingTimeOptions extends StObject {
...
object PlotPieSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotPieSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
