...
trait PlotMomentumAccessibilityPointOptions extends StObject {
...
object PlotMomentumAccessibilityPointOptions {
  
  inline def apply(): PlotMomentumAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMomentumAccessibilityPointOptions] (val x: Self) extends AnyVal {
