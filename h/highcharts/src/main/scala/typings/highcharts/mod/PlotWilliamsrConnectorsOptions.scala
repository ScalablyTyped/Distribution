...
trait PlotWilliamsrConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotWilliamsrConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotWilliamsrConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotWilliamsrConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotWilliamsrConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotWilliamsrConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotWilliamsrConnectorsMarkerOptions = null,
    startMarker: PlotWilliamsrConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotWilliamsrConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrConnectorsOptions]
  }
}
