...
trait PlotFlagsSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotFlagsSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
