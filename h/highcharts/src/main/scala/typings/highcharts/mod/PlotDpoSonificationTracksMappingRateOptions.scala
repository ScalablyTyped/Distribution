...
trait PlotDpoSonificationTracksMappingRateOptions extends StObject {
...
object PlotDpoSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotDpoSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDpoSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
