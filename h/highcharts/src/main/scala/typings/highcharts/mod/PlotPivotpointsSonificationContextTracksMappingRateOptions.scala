...
trait PlotPivotpointsSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
