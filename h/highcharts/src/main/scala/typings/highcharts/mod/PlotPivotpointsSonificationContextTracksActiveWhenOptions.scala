...
trait PlotPivotpointsSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
