...
trait PlotAreasplineSonificationTracksMappingRateOptions extends StObject {
...
object PlotAreasplineSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotAreasplineSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplineSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
