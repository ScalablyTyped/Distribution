...
trait PlotWordcloudSonificationTracksMappingPanOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
