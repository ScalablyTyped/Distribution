...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesWilliamsrOptions
  extends StObject
...
object SeriesWilliamsrOptions {
  ...
  inline def apply(`type`: String | williamsr): SeriesWilliamsrOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesWilliamsrOptions] (val x: Self) extends AnyVal {
