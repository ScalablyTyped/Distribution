...
trait PlotNatrSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
