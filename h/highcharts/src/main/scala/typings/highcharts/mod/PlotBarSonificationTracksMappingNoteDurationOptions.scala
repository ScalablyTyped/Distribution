...
trait PlotBarSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotBarSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
