...
trait PlotPolygonClusterEventsOptions extends StObject {
...
object PlotPolygonClusterEventsOptions {
  
  inline def apply(): PlotPolygonClusterEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonClusterEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonClusterEventsOptions] (val x: Self) extends AnyVal {
