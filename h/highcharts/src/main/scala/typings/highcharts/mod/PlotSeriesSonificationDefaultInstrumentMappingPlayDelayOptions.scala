...
trait PlotSeriesSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotSeriesSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
