...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesCandlestickOptions extends PlotCandlestickOptions {
  /**
...
object SeriesCandlestickOptions {
  ...
  def apply(
    ...
    dataLabels: PlotCandlestickDataLabelsOptions | js.Array[PlotCandlestickDataLabelsOptions] = null,
