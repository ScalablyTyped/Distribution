...
trait NavigationBreadcrumbsPositionOptions extends StObject {
...
object NavigationBreadcrumbsPositionOptions {
  
  inline def apply(): NavigationBreadcrumbsPositionOptions = {
