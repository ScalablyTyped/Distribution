...
trait PlotLinearregressionslopeSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotLinearregressionslopeSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
