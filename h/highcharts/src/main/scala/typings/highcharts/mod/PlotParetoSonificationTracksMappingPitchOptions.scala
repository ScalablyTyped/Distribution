...
trait PlotParetoSonificationTracksMappingPitchOptions extends StObject {
...
object PlotParetoSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
