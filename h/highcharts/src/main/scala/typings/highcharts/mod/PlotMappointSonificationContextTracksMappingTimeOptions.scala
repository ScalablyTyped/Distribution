...
trait PlotMappointSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotMappointSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
