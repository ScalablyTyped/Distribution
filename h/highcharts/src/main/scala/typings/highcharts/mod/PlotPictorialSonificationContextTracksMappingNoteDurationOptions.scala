...
trait PlotPictorialSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotPictorialSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
