...
trait PlotColumnSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotColumnSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotColumnSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
