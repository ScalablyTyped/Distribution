...
trait PlotPriceenvelopesAccessibilityPointOptions extends StObject {
...
object PlotPriceenvelopesAccessibilityPointOptions {
  
  inline def apply(): PlotPriceenvelopesAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesAccessibilityPointOptions] (val x: Self) extends AnyVal {
