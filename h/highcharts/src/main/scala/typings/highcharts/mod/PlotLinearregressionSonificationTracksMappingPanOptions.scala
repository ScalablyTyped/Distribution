...
trait PlotLinearregressionSonificationTracksMappingPanOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
