...
trait PlotFunnel3dSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
