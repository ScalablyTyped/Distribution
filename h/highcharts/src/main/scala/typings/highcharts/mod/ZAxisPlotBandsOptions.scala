...
trait ZAxisPlotBandsOptions extends AxisPlotBandsOptions {
  ...
  /**
    ...
    * `mousemove`.
    */
  var events: js.UndefOr[ZAxisPlotBandsEventsOptions] = js.native
  ...
  /**
    ...
    */
  var label: js.UndefOr[ZAxisPlotBandsLabelOptions] = js.native
...
object ZAxisPlotBandsOptions {
  ...
  @scala.inline
  def apply(): ZAxisPlotBandsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ZAxisPlotBandsOptions]
  }
  
  @scala.inline
  implicit class ZAxisPlotBandsOptionsMutableBuilder[Self <: ZAxisPlotBandsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: ZAxisPlotBandsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: ZAxisPlotBandsLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
