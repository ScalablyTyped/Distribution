...
trait PlotDisparityindexSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
