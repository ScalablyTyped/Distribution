...
trait PlotAbandsMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotAbandsMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAbandsMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsMarkerStatesHoverOptions]
  }
}
