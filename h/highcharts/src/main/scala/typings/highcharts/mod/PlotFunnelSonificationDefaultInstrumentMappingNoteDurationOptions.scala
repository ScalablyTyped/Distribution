...
trait PlotFunnelSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotFunnelSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
