...
trait PlotDependencywheelSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotDependencywheelSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
