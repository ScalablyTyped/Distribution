...
trait PlotLinearregressionslopeSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
