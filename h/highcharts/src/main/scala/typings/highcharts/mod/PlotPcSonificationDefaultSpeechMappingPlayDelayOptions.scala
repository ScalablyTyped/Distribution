...
trait PlotPcSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotPcSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotPcSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
