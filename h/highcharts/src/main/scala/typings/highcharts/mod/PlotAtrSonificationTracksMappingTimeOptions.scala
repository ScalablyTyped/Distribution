...
trait PlotAtrSonificationTracksMappingTimeOptions extends StObject {
...
object PlotAtrSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
