...
trait PlotAbandsSonificationTracksMappingRateOptions extends StObject {
...
object PlotAbandsSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotAbandsSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
