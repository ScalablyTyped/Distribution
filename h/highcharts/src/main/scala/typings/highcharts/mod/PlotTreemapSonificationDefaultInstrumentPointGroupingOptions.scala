...
trait PlotTreemapSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotTreemapSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
