...
trait PlotPictorialSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
