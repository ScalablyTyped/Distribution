...
trait SonificationGlobalContextTracksMappingRateOptions extends StObject {
...
object SonificationGlobalContextTracksMappingRateOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
