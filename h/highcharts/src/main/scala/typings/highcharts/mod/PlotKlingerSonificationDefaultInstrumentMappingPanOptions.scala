...
trait PlotKlingerSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotKlingerSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
