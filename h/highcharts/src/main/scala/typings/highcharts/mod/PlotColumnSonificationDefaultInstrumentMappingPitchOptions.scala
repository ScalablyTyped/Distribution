...
trait PlotColumnSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotColumnSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotColumnSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
