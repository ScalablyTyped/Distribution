...
trait PlotWindbarbSonificationTracksMappingPanOptions extends StObject {
...
object PlotWindbarbSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotWindbarbSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
