...
@js.native
trait PlotLollipopAnimationOptions extends js.Object {
...
object PlotLollipopAnimationOptions {
  ...
  @scala.inline
  implicit class PlotLollipopAnimationOptionsOps[Self <: PlotLollipopAnimationOptions] (val x: Self) extends AnyVal {
