...
trait PlotCandlestickSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
