...
trait PlotVariwideSonificationPointGroupingOptions extends StObject {
...
object PlotVariwideSonificationPointGroupingOptions {
  
  inline def apply(): PlotVariwideSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
