...
trait PlotAroonSonificationTracksMappingTimeOptions extends StObject {
...
object PlotAroonSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotAroonSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
