...
trait NavigatorYAxisScrollbarOptions extends StObject {
...
object NavigatorYAxisScrollbarOptions {
  
  inline def apply(): NavigatorYAxisScrollbarOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisScrollbarOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NavigatorYAxisScrollbarOptions] (val x: Self) extends AnyVal {
