...
trait PlotWindbarbSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotWindbarbSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotWindbarbSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
