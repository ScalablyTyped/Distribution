...
trait PlotHeatmapClusterOptions extends StObject {
  ...
  var events: js.UndefOr[PlotHeatmapClusterEventsOptions] = js.undefined
  ...
  /**
    ...
    * iterations.
    */
  var layoutAlgorithm: js.UndefOr[PlotHeatmapClusterLayoutAlgorithmOptions] = js.undefined
  ...
  var states: js.UndefOr[PlotHeatmapClusterStatesOptions] = js.undefined
  ...
  /**
    ...
    * `className` option.
    */
  var zones: js.UndefOr[js.Array[PlotHeatmapClusterZonesOptions]] = js.undefined
}
object PlotHeatmapClusterOptions {
  
  inline def apply(): PlotHeatmapClusterOptions = {
  ...
  extension [Self <: PlotHeatmapClusterOptions](x: Self) {
    ...
    inline def setEvents(value: PlotHeatmapClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    inline def setLayoutAlgorithm(value: PlotHeatmapClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setStates(value: PlotHeatmapClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    inline def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    inline def setZones(value: js.Array[PlotHeatmapClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
    
    inline def setZonesUndefined: Self = StObject.set(x, "zones", js.undefined)
    
    inline def setZonesVarargs(value: PlotHeatmapClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value*))
  }
}
