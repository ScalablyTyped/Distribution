...
trait PlotXrangeSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotXrangeSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
