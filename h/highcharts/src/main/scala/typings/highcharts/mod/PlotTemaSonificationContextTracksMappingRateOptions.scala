...
trait PlotTemaSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
