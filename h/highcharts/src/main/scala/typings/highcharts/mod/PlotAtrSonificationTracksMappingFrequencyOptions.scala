...
trait PlotAtrSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotAtrSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
