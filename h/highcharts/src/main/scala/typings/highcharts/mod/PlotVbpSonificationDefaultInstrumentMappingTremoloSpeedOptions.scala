...
trait PlotVbpSonificationDefaultInstrumentMappingTremoloSpeedOptions extends StObject {
...
object PlotVbpSonificationDefaultInstrumentMappingTremoloSpeedOptions {
  
  inline def apply(): PlotVbpSonificationDefaultInstrumentMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpSonificationDefaultInstrumentMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVbpSonificationDefaultInstrumentMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
