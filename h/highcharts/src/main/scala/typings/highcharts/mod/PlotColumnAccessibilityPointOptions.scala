...
trait PlotColumnAccessibilityPointOptions extends StObject {
...
object PlotColumnAccessibilityPointOptions {
  
  inline def apply(): PlotColumnAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnAccessibilityPointOptions] (val x: Self) extends AnyVal {
