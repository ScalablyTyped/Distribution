...
trait PlotFlowmapOptions extends StObject {
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotFlowmapDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotFlowmapJitterOptions] = js.undefined
  ...
  /**
    ...
    * which is necessary for operations such as zoom or updates on the flowmap
    * series.
    */
  ...
  /**
    ...
    * for each link.
    */
  var markerEnd: js.UndefOr[SeriesFlowMapSeriesOptionsObject] = js.undefined
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotFlowmapSonificationOptions] = js.undefined
...
object PlotFlowmapOptions {
  
  inline def apply(): PlotFlowmapOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotFlowmapDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setJitter(value: PlotFlowmapJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
    ...
    inline def setMarkerEnd(value: SeriesFlowMapSeriesOptionsObject): Self = StObject.set(x, "markerEnd", value.asInstanceOf[js.Any])
    ...
    inline def setSonification(value: PlotFlowmapSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
