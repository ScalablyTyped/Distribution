...
trait PlotVbpDataGroupingOptions extends js.Object {
  /**
...
object PlotVbpDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotVbpDataGroupingOptions]
  }
}
