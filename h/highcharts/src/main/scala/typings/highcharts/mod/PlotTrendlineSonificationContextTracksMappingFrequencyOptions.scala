...
trait PlotTrendlineSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
