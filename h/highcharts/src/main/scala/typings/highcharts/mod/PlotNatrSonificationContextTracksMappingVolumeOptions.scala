...
trait PlotNatrSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
