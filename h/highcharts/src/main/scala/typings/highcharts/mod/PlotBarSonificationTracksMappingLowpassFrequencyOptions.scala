...
trait PlotBarSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotBarSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
