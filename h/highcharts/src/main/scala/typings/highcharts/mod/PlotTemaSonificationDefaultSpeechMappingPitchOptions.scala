...
trait PlotTemaSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotTemaSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotTemaSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
