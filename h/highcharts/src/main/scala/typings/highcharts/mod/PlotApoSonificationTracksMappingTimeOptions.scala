...
trait PlotApoSonificationTracksMappingTimeOptions extends StObject {
...
object PlotApoSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
