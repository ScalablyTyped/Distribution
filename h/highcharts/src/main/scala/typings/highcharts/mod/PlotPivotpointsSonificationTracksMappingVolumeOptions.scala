...
trait PlotPivotpointsSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
