...
trait PlotMomentumMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMomentumMarkerStatesOptions] = js.undefined
  /**
...
object PlotMomentumMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMomentumMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMomentumMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumMarkerOptions]
  }
}
