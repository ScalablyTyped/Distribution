...
trait PlotPpoSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotPpoSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotPpoSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
