...
trait PlotColumnSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
