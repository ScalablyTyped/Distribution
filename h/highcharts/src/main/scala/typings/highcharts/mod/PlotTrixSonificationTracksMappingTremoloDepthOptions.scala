...
trait PlotTrixSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotTrixSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
