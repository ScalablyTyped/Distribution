...
object SeriesSplineOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | spline): SeriesSplineOptions = {
  ...
  @scala.inline
  implicit class SeriesSplineOptionsMutableBuilder[Self <: SeriesSplineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | spline): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
