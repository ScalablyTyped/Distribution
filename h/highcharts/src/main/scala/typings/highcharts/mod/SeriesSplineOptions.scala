...
object SeriesSplineOptions {
  ...
  @scala.inline
  implicit class SeriesSplineOptionsOps[Self <: SeriesSplineOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | spline): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
