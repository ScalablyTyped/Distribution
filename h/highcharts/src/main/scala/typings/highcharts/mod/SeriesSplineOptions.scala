...
import typings.highcharts.highchartsStrings.spline
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesSplineOptions
  extends StObject
     with PlotSplineOptions {
...
object SeriesSplineOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | spline): SeriesSplineOptions = {
    val __obj = js.Dynamic.literal(dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesSplineOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesSplineOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | spline): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
