...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesSplineOptions extends PlotSplineOptions {
  /**
...
object SeriesSplineOptions {
  ...
  def apply(
    ...
    dataLabels: PlotSplineDataLabelsOptions | js.Array[PlotSplineDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotSplineDataSortingOptions = null,
