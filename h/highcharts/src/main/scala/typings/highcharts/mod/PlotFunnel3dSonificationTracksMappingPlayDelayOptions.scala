...
trait PlotFunnel3dSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotFunnel3dSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
