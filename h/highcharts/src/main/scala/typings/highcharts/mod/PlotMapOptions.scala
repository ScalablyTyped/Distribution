...
trait PlotMapOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotMapDataLabelsOptions | js.Array[PlotMapDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotMapDataSortingOptions] = js.native
...
object PlotMapOptions {
  ...
  @scala.inline
  implicit class PlotMapOptionsMutableBuilder[Self <: PlotMapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMapAnimationOptions): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotMapDataLabelsOptions | js.Array[PlotMapDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotMapDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotMapDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJitter(value: PlotMapJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNullInteraction(value: Boolean): Self = StObject.set(x, "nullInteraction", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNullInteractionUndefined: Self = StObject.set(x, "nullInteraction", js.undefined)
