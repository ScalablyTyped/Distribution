...
trait PlotBarSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotBarSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotBarSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
