...
trait AnnotationsPitchforkTypeInnerBackgroundOptions extends StObject {
...
object AnnotationsPitchforkTypeInnerBackgroundOptions {
  ...
  inline def apply(): AnnotationsPitchforkTypeInnerBackgroundOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsPitchforkTypeInnerBackgroundOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AnnotationsPitchforkTypeInnerBackgroundOptions] (val x: Self) extends AnyVal {
