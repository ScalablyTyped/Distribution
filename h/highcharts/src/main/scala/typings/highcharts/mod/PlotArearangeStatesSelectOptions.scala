...
trait PlotArearangeStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotArearangeStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotArearangeStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotArearangeStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotArearangeStatesSelectAnimationOptions = null,
  ...
  ): PlotArearangeStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeStatesSelectOptions]
  }
}
