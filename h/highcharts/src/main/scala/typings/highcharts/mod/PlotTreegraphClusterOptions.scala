...
trait PlotTreegraphClusterOptions extends StObject {
  ...
  var events: js.UndefOr[PlotTreegraphClusterEventsOptions] = js.undefined
  ...
  /**
    ...
    * iterations.
    */
  var layoutAlgorithm: js.UndefOr[PlotTreegraphClusterLayoutAlgorithmOptions] = js.undefined
  ...
  var states: js.UndefOr[PlotTreegraphClusterStatesOptions] = js.undefined
  ...
  /**
    ...
    * `className` option.
    */
  var zones: js.UndefOr[js.Array[PlotTreegraphClusterZonesOptions]] = js.undefined
}
object PlotTreegraphClusterOptions {
  
  inline def apply(): PlotTreegraphClusterOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphClusterOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphClusterOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: PlotTreegraphClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    inline def setLayoutAlgorithm(value: PlotTreegraphClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setStates(value: PlotTreegraphClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    inline def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    inline def setZones(value: js.Array[PlotTreegraphClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
    
    inline def setZonesUndefined: Self = StObject.set(x, "zones", js.undefined)
    
    inline def setZonesVarargs(value: PlotTreegraphClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value*))
  }
}
