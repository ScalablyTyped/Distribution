...
trait PlotAreaSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotAreaSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotAreaSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
