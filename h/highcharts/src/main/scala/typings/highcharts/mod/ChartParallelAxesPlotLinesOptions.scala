...
trait ChartParallelAxesPlotLinesOptions extends StObject {
  ...
  /**
    ...
    * `mousemove`.
    */
  var events: js.UndefOr[ChartParallelAxesPlotLinesEventsOptions] = js.undefined
  ...
  /**
    ...
    */
  var label: js.UndefOr[ChartParallelAxesPlotLinesLabelOptions] = js.undefined
...
object ChartParallelAxesPlotLinesOptions {
  
  inline def apply(): ChartParallelAxesPlotLinesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesPlotLinesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartParallelAxesPlotLinesOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: ChartParallelAxesPlotLinesEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setLabel(value: ChartParallelAxesPlotLinesLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
