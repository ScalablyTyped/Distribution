...
trait PlotPyramidSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotPyramidSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
