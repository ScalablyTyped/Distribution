...
trait PlotFunnelSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotFunnelSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
