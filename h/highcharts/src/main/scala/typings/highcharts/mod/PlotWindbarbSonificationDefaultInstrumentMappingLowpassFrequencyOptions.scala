...
trait PlotWindbarbSonificationDefaultInstrumentMappingLowpassFrequencyOptions extends StObject {
...
object PlotWindbarbSonificationDefaultInstrumentMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotWindbarbSonificationDefaultInstrumentMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationDefaultInstrumentMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationDefaultInstrumentMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
