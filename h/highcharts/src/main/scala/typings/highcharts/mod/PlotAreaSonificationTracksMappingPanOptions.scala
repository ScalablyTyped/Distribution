...
trait PlotAreaSonificationTracksMappingPanOptions extends StObject {
...
object PlotAreaSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotAreaSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
