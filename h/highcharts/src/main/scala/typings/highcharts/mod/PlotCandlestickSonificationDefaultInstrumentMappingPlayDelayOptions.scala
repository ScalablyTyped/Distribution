...
trait PlotCandlestickSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotCandlestickSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
