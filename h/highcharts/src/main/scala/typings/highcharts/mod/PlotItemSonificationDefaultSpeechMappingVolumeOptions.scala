...
trait PlotItemSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotItemSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotItemSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
