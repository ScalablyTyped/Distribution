...
trait PlotPcSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPcSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPcSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
