...
trait PlotAreaSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotAreaSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotAreaSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
