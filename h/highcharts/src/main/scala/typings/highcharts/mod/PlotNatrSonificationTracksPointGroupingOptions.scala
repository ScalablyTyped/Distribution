...
trait PlotNatrSonificationTracksPointGroupingOptions extends StObject {
...
object PlotNatrSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotNatrSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
