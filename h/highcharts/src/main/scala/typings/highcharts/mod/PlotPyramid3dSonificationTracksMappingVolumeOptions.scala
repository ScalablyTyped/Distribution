...
trait PlotPyramid3dSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
