...
trait PlotPyramid3dSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
