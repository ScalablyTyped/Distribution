...
trait PlotNetworkgraphSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
