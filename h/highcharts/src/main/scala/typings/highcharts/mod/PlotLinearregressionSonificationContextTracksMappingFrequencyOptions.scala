...
trait PlotLinearregressionSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
