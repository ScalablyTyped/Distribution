...
trait PlotXrangeSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotXrangeSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
