...
trait PlotAtrSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotAtrSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
