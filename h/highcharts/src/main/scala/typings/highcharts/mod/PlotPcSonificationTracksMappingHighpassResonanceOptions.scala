...
trait PlotPcSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPcSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
