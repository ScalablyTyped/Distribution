...
trait PlotFunnel3dSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
