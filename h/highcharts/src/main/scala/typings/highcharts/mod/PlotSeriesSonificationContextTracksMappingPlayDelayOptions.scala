...
trait PlotSeriesSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
