...
trait PlotColumnrangeSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotColumnrangeSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotColumnrangeSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
