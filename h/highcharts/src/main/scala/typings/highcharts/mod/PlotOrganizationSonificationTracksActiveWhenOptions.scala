...
trait PlotOrganizationSonificationTracksActiveWhenOptions extends StObject {
...
object PlotOrganizationSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotOrganizationSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOrganizationSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
