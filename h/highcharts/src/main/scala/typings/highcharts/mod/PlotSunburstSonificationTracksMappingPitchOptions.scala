...
trait PlotSunburstSonificationTracksMappingPitchOptions extends StObject {
...
object PlotSunburstSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotSunburstSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
