...
trait PlotSeriesOnPointPositionOptions extends StObject {
...
object PlotSeriesOnPointPositionOptions {
  
  inline def apply(): PlotSeriesOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesOnPointPositionOptions] (val x: Self) extends AnyVal {
