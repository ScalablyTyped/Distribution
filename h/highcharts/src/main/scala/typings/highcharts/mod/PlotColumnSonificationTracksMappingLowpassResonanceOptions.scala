...
trait PlotColumnSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotColumnSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
