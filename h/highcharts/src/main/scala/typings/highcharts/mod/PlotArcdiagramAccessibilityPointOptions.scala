...
trait PlotArcdiagramAccessibilityPointOptions extends StObject {
...
object PlotArcdiagramAccessibilityPointOptions {
  
  inline def apply(): PlotArcdiagramAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramAccessibilityPointOptions] (val x: Self) extends AnyVal {
