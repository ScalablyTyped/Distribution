...
trait PlotPyramid3dSonificationPointGroupingOptions extends StObject {
...
object PlotPyramid3dSonificationPointGroupingOptions {
  
  inline def apply(): PlotPyramid3dSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
