...
trait PlotLinearregressionangleSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
