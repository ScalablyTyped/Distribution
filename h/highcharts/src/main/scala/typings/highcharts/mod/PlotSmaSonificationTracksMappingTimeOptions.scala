...
trait PlotSmaSonificationTracksMappingTimeOptions extends StObject {
...
object PlotSmaSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
