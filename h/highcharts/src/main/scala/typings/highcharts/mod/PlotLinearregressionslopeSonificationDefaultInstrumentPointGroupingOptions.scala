...
trait PlotLinearregressionslopeSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
