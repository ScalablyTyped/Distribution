...
trait PlotSankeySonificationTracksMappingVolumeOptions extends StObject {
...
object PlotSankeySonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotSankeySonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeySonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeySonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
