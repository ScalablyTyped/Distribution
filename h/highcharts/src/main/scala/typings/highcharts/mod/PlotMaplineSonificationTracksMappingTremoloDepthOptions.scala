...
trait PlotMaplineSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotMaplineSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotMaplineSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
