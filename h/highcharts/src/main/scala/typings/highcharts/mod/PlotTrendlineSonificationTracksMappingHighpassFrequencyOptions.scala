...
trait PlotTrendlineSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
