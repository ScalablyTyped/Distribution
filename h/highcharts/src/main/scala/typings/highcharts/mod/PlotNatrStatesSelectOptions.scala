...
trait PlotNatrStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotNatrStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotNatrStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotNatrStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotNatrStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotNatrStatesSelectOptions]
  }
}
