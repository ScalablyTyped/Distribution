...
trait PlotGanttSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotGanttSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
