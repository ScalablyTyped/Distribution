...
trait PlotSmaSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotSmaSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
