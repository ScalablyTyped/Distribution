...
trait PlotDisparityindexSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
