...
trait PlotPyramidTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotPyramidTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotPyramidTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    dateTimeLabelFormats: PlotPyramidTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
    ...
    __obj.asInstanceOf[PlotPyramidTooltipOptions]
  }
}
