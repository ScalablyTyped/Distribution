...
trait PlotLineSonificationTracksMappingPitchOptions extends StObject {
...
object PlotLineSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
