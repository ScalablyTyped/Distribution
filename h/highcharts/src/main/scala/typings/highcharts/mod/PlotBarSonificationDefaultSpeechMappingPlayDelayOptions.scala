...
trait PlotBarSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotBarSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotBarSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
