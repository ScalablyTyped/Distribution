...
trait PlotObvSonificationTracksMappingPitchOptions extends StObject {
...
object PlotObvSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotObvSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotObvSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotObvSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
