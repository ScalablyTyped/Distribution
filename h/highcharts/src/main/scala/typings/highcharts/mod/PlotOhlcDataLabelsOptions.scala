...
object PlotOhlcDataLabelsOptions {
  ...
  inline def apply(): PlotOhlcDataLabelsOptions = {
  ...
  extension [Self <: PlotOhlcDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotOhlcDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
