...
@js.native
trait PlotOhlcDataLabelsOptions extends js.Object {
...
object PlotOhlcDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotOhlcDataLabelsOptionsOps[Self <: PlotOhlcDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotOhlcDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
