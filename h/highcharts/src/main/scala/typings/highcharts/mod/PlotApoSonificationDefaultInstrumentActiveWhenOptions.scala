...
trait PlotApoSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotApoSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotApoSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
