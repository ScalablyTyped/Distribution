...
trait PlotPpoSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotPpoSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotPpoSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
