...
trait PlotDmiSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotDmiSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotDmiSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
