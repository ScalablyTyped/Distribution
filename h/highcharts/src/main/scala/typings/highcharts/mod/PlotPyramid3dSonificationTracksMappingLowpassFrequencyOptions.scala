...
trait PlotPyramid3dSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
