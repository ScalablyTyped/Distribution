...
trait PlotPsarSonificationPointGroupingOptions extends StObject {
...
object PlotPsarSonificationPointGroupingOptions {
  
  inline def apply(): PlotPsarSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
