...
trait PlotHlcSonificationTracksActiveWhenOptions extends StObject {
...
object PlotHlcSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotHlcSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHlcSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
