...
@js.native
trait PlotColumnrangeDataLabelsAnimationOptions extends js.Object {
...
object PlotColumnrangeDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): PlotColumnrangeDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class PlotColumnrangeDataLabelsAnimationOptionsOps[Self <: PlotColumnrangeDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
