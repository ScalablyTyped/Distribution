...
trait PlotTrixSonificationTracksMappingTimeOptions extends StObject {
...
object PlotTrixSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
