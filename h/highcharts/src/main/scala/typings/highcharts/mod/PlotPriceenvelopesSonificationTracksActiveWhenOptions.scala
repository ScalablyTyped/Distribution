...
trait PlotPriceenvelopesSonificationTracksActiveWhenOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
