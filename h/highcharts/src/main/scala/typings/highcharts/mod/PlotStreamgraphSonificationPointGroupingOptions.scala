...
trait PlotStreamgraphSonificationPointGroupingOptions extends StObject {
...
object PlotStreamgraphSonificationPointGroupingOptions {
  
  inline def apply(): PlotStreamgraphSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
