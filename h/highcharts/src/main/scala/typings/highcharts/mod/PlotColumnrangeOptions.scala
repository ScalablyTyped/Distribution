...
trait PlotColumnrangeOptions extends js.Object {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotColumnrangeAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotColumnrangeDataSortingOptions] = js.native
...
object PlotColumnrangeOptions {
  ...
  @scala.inline
  def apply(): PlotColumnrangeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeOptions]
  }
  
  @scala.inline
  implicit class PlotColumnrangeOptionsOps[Self <: PlotColumnrangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotColumnrangeAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotColumnrangeDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
