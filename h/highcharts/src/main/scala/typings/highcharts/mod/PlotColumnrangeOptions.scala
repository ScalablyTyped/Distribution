...
object PlotColumnrangeOptions {
  ...
  extension [Self <: PlotColumnrangeOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotColumnrangeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
