...
object PlotColumnrangeOptions {
  ...
  @scala.inline
  implicit class PlotColumnrangeOptionsMutableBuilder[Self <: PlotColumnrangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotColumnrangeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotColumnrangeDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
