...
trait PlotDependencywheelSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
