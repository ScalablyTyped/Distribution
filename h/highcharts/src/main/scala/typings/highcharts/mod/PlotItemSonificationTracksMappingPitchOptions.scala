...
trait PlotItemSonificationTracksMappingPitchOptions extends StObject {
...
object PlotItemSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
