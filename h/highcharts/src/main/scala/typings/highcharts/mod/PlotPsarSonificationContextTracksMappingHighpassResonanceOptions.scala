...
trait PlotPsarSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPsarSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
