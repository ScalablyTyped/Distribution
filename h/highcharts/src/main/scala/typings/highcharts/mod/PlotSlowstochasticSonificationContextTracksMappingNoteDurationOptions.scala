...
trait PlotSlowstochasticSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
