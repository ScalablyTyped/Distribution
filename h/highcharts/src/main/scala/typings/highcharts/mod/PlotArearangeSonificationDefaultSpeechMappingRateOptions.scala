...
trait PlotArearangeSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotArearangeSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
