...
trait PlotSplineSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotSplineSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotSplineSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
