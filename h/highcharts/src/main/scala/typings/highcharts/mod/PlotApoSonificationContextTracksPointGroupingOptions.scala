...
trait PlotApoSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotApoSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotApoSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
