...
trait PlotCciSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotCciSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotCciSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
