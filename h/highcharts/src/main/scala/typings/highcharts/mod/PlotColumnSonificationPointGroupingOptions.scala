...
trait PlotColumnSonificationPointGroupingOptions extends StObject {
...
object PlotColumnSonificationPointGroupingOptions {
  
  inline def apply(): PlotColumnSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
