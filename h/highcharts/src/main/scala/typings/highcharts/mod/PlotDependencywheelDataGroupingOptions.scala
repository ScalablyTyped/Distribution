...
trait PlotDependencywheelDataGroupingOptions extends js.Object {
  /**
...
object PlotDependencywheelDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDependencywheelDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelDataGroupingOptions]
  }
}
