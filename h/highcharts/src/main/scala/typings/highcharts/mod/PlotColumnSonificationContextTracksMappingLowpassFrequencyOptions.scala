...
trait PlotColumnSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
