...
trait PlotVariwideSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotVariwideSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
