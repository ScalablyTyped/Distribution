...
trait PlotColumnrangeSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
