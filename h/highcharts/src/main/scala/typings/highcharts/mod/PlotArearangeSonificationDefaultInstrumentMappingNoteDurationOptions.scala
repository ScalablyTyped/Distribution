...
trait PlotArearangeSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotArearangeSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
