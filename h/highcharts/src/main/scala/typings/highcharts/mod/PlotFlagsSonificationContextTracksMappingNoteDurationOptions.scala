...
trait PlotFlagsSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
