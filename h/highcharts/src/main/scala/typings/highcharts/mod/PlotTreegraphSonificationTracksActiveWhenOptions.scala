...
trait PlotTreegraphSonificationTracksActiveWhenOptions extends StObject {
...
object PlotTreegraphSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotTreegraphSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
