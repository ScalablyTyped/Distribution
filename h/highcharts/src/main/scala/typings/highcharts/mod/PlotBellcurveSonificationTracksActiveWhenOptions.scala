...
trait PlotBellcurveSonificationTracksActiveWhenOptions extends StObject {
...
object PlotBellcurveSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotBellcurveSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBellcurveSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
