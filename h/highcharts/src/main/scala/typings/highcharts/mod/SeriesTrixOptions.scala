...
trait SeriesTrixOptions extends PlotTrixOptions {
  /**
    * Not available
    */
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | trix = js.native
  /**
...
object SeriesTrixOptions {
  @scala.inline
  def apply(`type`: String | trix): SeriesTrixOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesTrixOptions]
  }
  @scala.inline
  implicit class SeriesTrixOptionsOps[Self <: SeriesTrixOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | trix): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
