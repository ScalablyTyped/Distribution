...
trait PlotPackedbubbleSonificationContextTracksOptions extends StObject {
  ...
  var activeWhen: js.UndefOr[
    js.Object | js.Function | PlotPackedbubbleSonificationContextTracksActiveWhenOptions
  ] = js.undefined
  
  /**
    * (Highcharts) Instrument to use for playing.
    *
  ...
  /**
    * (Highcharts) Mapping options for the audio parameters.
    *
    ...
    */
  var mapping: js.UndefOr[PlotPackedbubbleSonificationContextTracksMappingOptions] = js.undefined
  
  /**
    * (Highcharts) Name to use for a track when exporting to MIDI. By default
    * it uses the series name if the track is related to a series.
    */
  ...
  /**
    ...
    * tracks.
    */
  var pointGrouping: js.UndefOr[PlotPackedbubbleSonificationContextTracksPointGroupingOptions] = js.undefined
  
  /**
    * (Highcharts) Round pitch mapping to musical notes.
    *
  ...
  /**
    * (Highcharts) Set a context track to play periodically every
  ...
  /**
    * (Highcharts) How to map context events to time when using the
    * `valueInterval` option.
    */
  var valueMapFunction: js.UndefOr[OptionsValueMapFunctionValue] = js.undefined
  
  /**
    * (Highcharts) The point property to play context for when using
    * `valueInterval`.
    */
  var valueProp: js.UndefOr[String] = js.undefined
}
object PlotPackedbubbleSonificationContextTracksOptions {
  
  inline def apply(): PlotPackedbubbleSonificationContextTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleSonificationContextTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPackedbubbleSonificationContextTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotPackedbubbleSonificationContextTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotPackedbubbleSonificationContextTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotPackedbubbleSonificationContextTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
