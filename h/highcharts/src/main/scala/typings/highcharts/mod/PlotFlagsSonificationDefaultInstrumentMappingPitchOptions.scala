...
trait PlotFlagsSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotFlagsSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
