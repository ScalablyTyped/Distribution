...
trait PlotSupertrendSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
