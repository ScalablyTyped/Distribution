...
trait PlotPcSonificationTracksMappingPanOptions extends StObject {
...
object PlotPcSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
