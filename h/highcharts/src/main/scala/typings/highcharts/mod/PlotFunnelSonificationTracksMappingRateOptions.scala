...
trait PlotFunnelSonificationTracksMappingRateOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
