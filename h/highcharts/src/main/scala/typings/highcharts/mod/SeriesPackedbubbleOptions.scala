...
object SeriesPackedbubbleOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | packedbubble): SeriesPackedbubbleOptions = {
  ...
  implicit class SeriesPackedbubbleOptionsMutableBuilder[Self <: SeriesPackedbubbleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: PointOptionsObject | (js.Array[js.Object | js.Array[js.Any]])): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
