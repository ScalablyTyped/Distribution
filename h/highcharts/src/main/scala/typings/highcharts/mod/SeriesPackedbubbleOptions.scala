...
object SeriesPackedbubbleOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | packedbubble): SeriesPackedbubbleOptions = {
  ...
  extension [Self <: SeriesPackedbubbleOptions](x: Self) {
    ...
    inline def setType(value: String | packedbubble): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
