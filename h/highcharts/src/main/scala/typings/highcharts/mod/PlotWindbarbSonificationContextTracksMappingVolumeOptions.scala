...
trait PlotWindbarbSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotWindbarbSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotWindbarbSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
