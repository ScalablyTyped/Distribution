...
trait PlotStochasticDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotStochasticDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotStochasticDataLabelsOptions {
  ...
  inline def apply(): PlotStochasticDataLabelsOptions = {
  ...
  implicit open class MutableBuilder[Self <: PlotStochasticDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotStochasticDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
