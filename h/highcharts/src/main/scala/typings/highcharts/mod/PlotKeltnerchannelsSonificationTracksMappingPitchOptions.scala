...
trait PlotKeltnerchannelsSonificationTracksMappingPitchOptions extends StObject {
...
object PlotKeltnerchannelsSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotKeltnerchannelsSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
