...
trait PlotFunnelSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
