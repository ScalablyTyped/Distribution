...
trait PlotCmfConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotCmfConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCmfConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCmfConnectorsMarkerOptions]
  }
}
