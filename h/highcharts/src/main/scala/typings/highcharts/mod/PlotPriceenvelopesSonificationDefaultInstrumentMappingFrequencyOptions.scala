...
trait PlotPriceenvelopesSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
