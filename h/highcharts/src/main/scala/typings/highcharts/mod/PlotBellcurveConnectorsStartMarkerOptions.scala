...
trait PlotBellcurveConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotBellcurveConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBellcurveConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveConnectorsStartMarkerOptions]
  }
}
