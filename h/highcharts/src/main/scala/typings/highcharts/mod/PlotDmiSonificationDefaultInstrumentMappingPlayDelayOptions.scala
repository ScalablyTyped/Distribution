...
trait PlotDmiSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotDmiSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotDmiSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
