...
trait PlotApoSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
