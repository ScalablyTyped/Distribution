...
trait PlotWmaSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotWmaSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
