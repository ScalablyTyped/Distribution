...
trait PlotFlagsSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotFlagsSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
