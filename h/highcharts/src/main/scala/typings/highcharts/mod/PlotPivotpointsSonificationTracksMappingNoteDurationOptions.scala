...
trait PlotPivotpointsSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
