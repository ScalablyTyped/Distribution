...
trait PlotPriceenvelopesConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotPriceenvelopesConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPriceenvelopesConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesConnectorsEndMarkerOptions]
  }
}
