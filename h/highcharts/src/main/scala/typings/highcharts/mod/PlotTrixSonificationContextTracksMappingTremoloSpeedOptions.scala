...
trait PlotTrixSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
