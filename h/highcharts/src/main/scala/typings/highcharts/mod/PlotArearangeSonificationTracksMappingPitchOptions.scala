...
trait PlotArearangeSonificationTracksMappingPitchOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
