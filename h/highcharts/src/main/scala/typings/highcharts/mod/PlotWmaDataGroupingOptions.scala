...
trait PlotWmaDataGroupingOptions extends js.Object {
  /**
...
object PlotWmaDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotWmaDataGroupingOptions]
  }
}
