...
trait PlotFunnelSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotFunnelSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
