...
trait PlotVbpSonificationTracksMappingPitchOptions extends StObject {
...
object PlotVbpSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotVbpSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVbpSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
