...
trait PlotMappointSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotMappointSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotMappointSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
