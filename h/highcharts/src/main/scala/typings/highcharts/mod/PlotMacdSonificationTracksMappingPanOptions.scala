...
trait PlotMacdSonificationTracksMappingPanOptions extends StObject {
...
object PlotMacdSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotMacdSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMacdSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
