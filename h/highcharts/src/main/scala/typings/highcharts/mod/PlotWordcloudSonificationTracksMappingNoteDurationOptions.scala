...
trait PlotWordcloudSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
