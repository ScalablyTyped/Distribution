...
trait PlotVariablepieSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotVariablepieSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
