...
trait PlotVariablepiePointEventsOptions extends js.Object {
  /**
...
object PlotVariablepiePointEventsOptions {
  @scala.inline
  def apply(
    ...
    legendItemClick: PointLegendItemClickCallbackFunction = null,
  ...
  ): PlotVariablepiePointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepiePointEventsOptions]
  }
}
