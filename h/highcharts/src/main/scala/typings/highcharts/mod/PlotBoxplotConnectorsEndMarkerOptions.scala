...
trait PlotBoxplotConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotBoxplotConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBoxplotConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBoxplotConnectorsEndMarkerOptions]
  }
}
