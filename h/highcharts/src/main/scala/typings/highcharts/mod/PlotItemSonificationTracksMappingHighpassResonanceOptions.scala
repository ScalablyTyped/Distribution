...
trait PlotItemSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotItemSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
