...
trait PlotMapSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotMapSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
