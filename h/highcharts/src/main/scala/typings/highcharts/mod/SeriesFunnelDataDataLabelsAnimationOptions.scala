...
@js.native
trait SeriesFunnelDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesFunnelDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesFunnelDataDataLabelsAnimationOptionsOps[Self <: SeriesFunnelDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
