...
trait PlotMapbubbleClusterLayoutAlgorithmOptions extends StObject {
...
object PlotMapbubbleClusterLayoutAlgorithmOptions {
  
  inline def apply(): PlotMapbubbleClusterLayoutAlgorithmOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleClusterLayoutAlgorithmOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleClusterLayoutAlgorithmOptions] (val x: Self) extends AnyVal {
