...
trait PlotGanttSonificationContextTracksOptions extends StObject {
  
  /**
    * (Gantt) Define a condition for when a track should be active and not.
    *
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotGanttSonificationContextTracksActiveWhenOptions] = js.undefined
  
  /**
    * (Gantt) Instrument to use for playing.
    *
  ...
  /**
    * (Gantt) Mapping options for the audio parameters.
    *
    ...
    */
  var mapping: js.UndefOr[PlotGanttSonificationContextTracksMappingOptions] = js.undefined
  
  /**
    * (Gantt) Name to use for a track when exporting to MIDI. By default it
    * uses the series name if the track is related to a series.
    */
  var midiName: js.UndefOr[String] = js.undefined
  
  /**
    * (Gantt) Options for point grouping, specifically for instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotGanttSonificationContextTracksPointGroupingOptions] = js.undefined
  
  /**
    * (Gantt) Round pitch mapping to musical notes.
    *
  ...
  /**
    * (Gantt) Show play marker (tooltip and/or crosshair) for a track.
    */
  var showPlayMarker: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Gantt) Set a context track to play periodically every `timeInterval`
    * milliseconds while the sonification is playing.
    */
  var timeInterval: js.UndefOr[Double] = js.undefined
  
  /**
    * (Gantt) Type of track. Always `"instrument"` for instrument tracks, and
    * `"speech"` for speech tracks.
    */
  var `type`: js.UndefOr[OptionsTypeValue] = js.undefined
  
  /**
    * (Gantt) Set a context track to play periodically every `valueInterval`
    * units of a data property `valueProp` while the sonification is playing.
    *
  ...
  /**
    * (Gantt) How to map context events to time when using the `valueInterval`
    * option.
    */
  var valueMapFunction: js.UndefOr[OptionsValueMapFunctionValue] = js.undefined
  
  /**
    * (Gantt) The point property to play context for when using
    * `valueInterval`.
    */
  var valueProp: js.UndefOr[String] = js.undefined
}
object PlotGanttSonificationContextTracksOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotGanttSonificationContextTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotGanttSonificationContextTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotGanttSonificationContextTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
