...
trait PlotPyramid3dSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
