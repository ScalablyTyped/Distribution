...
trait PlotSupertrendSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
