...
trait PlotNatrSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotNatrSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotNatrSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
