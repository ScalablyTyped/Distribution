...
trait SeriesAreasplineDataEventsOptions extends js.Object {
  /**
...
object SeriesAreasplineDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesAreasplineDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesAreasplineDataEventsOptions]
  }
}
