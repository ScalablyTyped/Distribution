...
trait PlotLinearregressioninterceptSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
