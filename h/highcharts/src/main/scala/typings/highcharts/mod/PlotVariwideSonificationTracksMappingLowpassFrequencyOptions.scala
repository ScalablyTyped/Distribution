...
trait PlotVariwideSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
