...
trait PlotKlingerOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotKlingerSonificationOptions] = js.undefined
...
object PlotKlingerOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotKlingerSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
