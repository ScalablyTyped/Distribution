...
trait PlotKlingerOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotKlingerAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotKlingerDataLabelsOptions | js.Array[PlotKlingerDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotKlingerDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotKlingerOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotKlingerParamsOptions] = js.undefined
  ...
  var signalLine: js.UndefOr[PlotKlingerSignalLineOptions] = js.undefined
...
object PlotKlingerOptions {
  
  inline def apply(): PlotKlingerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerOptions]
  }
  
  extension [Self <: PlotKlingerOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotKlingerAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotKlingerDataLabelsOptions | js.Array[PlotKlingerDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotKlingerDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotKlingerDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotKlingerOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotKlingerParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    inline def setSignalLine(value: PlotKlingerSignalLineOptions): Self = StObject.set(x, "signalLine", value.asInstanceOf[js.Any])
