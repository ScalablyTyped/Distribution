...
trait PlotMfiAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMfiAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotMfiAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotMfiAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotMfiAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotMfiAccessibilityOptions]
  }
}
