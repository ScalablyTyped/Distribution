...
import typings.highcharts.highchartsStrings.tiledwebmap
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesTiledwebmapOptions
  extends StObject
     with PlotTiledwebmapOptions {
...
object SeriesTiledwebmapOptions {
  ...
  inline def apply(
    ...
    dataURL: Unit,
    nullColor: Unit,
    nullInteraction: Unit,
    `type`: String | tiledwebmap
  ): SeriesTiledwebmapOptions = {
    val __obj = js.Dynamic.literal(affectsMapView = affectsMapView.asInstanceOf[js.Any], colorByPoint = colorByPoint.asInstanceOf[js.Any], colors = colors.asInstanceOf[js.Any], dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any], nullColor = nullColor.asInstanceOf[js.Any], nullInteraction = nullInteraction.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesTiledwebmapOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesTiledwebmapOptions] (val x: Self) extends AnyVal {
    ...
    inline def setNullColor(value: Unit): Self = StObject.set(x, "nullColor", value.asInstanceOf[js.Any])
    
    inline def setNullInteraction(value: Unit): Self = StObject.set(x, "nullInteraction", value.asInstanceOf[js.Any])
    
    inline def setStack(value: Double | String): Self = StObject.set(x, "stack", value.asInstanceOf[js.Any])
    
    inline def setStackUndefined: Self = StObject.set(x, "stack", js.undefined)
    
    inline def setType(value: String | tiledwebmap): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
