...
trait PlotPictorialSonificationPointGroupingOptions extends StObject {
...
object PlotPictorialSonificationPointGroupingOptions {
  
  inline def apply(): PlotPictorialSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
