...
trait PlotLinearregressionSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
