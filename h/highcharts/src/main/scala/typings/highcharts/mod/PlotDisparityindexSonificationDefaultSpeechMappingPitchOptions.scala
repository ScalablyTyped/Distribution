...
trait PlotDisparityindexSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
