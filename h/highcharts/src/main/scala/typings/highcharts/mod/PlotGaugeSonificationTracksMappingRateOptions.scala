...
trait PlotGaugeSonificationTracksMappingRateOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
