...
trait PlotHollowcandlestickSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotHollowcandlestickSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
