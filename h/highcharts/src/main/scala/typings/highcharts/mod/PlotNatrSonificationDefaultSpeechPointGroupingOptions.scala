...
trait PlotNatrSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotNatrSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotNatrSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
