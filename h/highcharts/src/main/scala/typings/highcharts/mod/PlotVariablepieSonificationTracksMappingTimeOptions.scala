...
trait PlotVariablepieSonificationTracksMappingTimeOptions extends StObject {
...
object PlotVariablepieSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotVariablepieSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
