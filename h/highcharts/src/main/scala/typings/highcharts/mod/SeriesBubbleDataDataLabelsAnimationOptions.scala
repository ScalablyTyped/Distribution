...
@js.native
trait SeriesBubbleDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesBubbleDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): SeriesBubbleDataDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesBubbleDataDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class SeriesBubbleDataDataLabelsAnimationOptionsOps[Self <: SeriesBubbleDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
