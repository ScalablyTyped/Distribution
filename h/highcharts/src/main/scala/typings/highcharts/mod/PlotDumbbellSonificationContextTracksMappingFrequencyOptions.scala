...
trait PlotDumbbellSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
