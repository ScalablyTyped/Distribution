...
trait PlotDmiSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotDmiSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
