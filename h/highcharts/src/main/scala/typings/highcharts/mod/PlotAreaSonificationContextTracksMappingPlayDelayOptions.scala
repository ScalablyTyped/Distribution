...
trait PlotAreaSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotAreaSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotAreaSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
