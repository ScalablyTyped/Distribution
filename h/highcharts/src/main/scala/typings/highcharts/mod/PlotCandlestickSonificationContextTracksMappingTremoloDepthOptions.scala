...
trait PlotCandlestickSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
