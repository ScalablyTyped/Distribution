...
trait PlotBarConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotBarConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBarConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBarConnectorsEndMarkerOptions]
  }
}
