...
trait PlotHeatmapSonificationDefaultSpeechMappingOptions extends StObject {
  ...
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHeatmapSonificationDefaultSpeechMappingPitchOptions
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHeatmapSonificationDefaultSpeechMappingPlayDelayOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var rate: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHeatmapSonificationDefaultSpeechMappingRateOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHeatmapSonificationDefaultSpeechMappingTimeOptions
  ] = js.undefined
  ...
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotHeatmapSonificationDefaultSpeechMappingVolumeOptions
  ] = js.undefined
}
object PlotHeatmapSonificationDefaultSpeechMappingOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultSpeechMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultSpeechMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultSpeechMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotHeatmapSonificationDefaultSpeechMappingPitchOptions
    ): Self = StObject.set(x, "pitch", value.asInstanceOf[js.Any])
    
    inline def setPitchUndefined: Self = StObject.set(x, "pitch", js.undefined)
    
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotHeatmapSonificationDefaultSpeechMappingPlayDelayOptions
    ...
    inline def setRate(
      value: Double | js.Object | String | js.Function | PlotHeatmapSonificationDefaultSpeechMappingRateOptions
    ...
    inline def setTime(
      value: Double | js.Object | String | js.Function | PlotHeatmapSonificationDefaultSpeechMappingTimeOptions
    ): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setVolume(
      value: Double | js.Object | String | js.Function | PlotHeatmapSonificationDefaultSpeechMappingVolumeOptions
