...
trait PlotPcSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotPcSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotPcSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
