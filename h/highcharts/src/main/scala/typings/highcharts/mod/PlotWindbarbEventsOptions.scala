...
trait PlotWindbarbEventsOptions extends js.Object {
  /**
...
object PlotWindbarbEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotWindbarbEventsOptions]
  }
}
