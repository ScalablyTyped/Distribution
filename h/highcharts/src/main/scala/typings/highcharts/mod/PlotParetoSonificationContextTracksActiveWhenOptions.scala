...
trait PlotParetoSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotParetoSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
