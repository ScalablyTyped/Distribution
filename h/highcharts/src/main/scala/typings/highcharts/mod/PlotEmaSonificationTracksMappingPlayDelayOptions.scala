...
trait PlotEmaSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotEmaSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
