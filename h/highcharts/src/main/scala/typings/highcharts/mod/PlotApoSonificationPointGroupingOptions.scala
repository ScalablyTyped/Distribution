...
trait PlotApoSonificationPointGroupingOptions extends StObject {
...
object PlotApoSonificationPointGroupingOptions {
  
  inline def apply(): PlotApoSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
