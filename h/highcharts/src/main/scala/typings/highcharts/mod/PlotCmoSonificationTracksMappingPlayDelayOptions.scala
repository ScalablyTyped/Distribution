...
trait PlotCmoSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotCmoSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
