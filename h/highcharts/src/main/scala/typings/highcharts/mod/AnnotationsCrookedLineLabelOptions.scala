...
object AnnotationsCrookedLineLabelOptions {
  ...
  @scala.inline
  def apply(): AnnotationsCrookedLineLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsCrookedLineLabelOptions]
  }
  
  @scala.inline
  implicit class AnnotationsCrookedLineLabelOptionsMutableBuilder[Self <: AnnotationsCrookedLineLabelOptions] (val x: Self) extends AnyVal {
