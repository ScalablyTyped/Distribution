...
trait PlotGeoheatmapSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
