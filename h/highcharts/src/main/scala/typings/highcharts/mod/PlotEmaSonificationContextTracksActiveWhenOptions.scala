...
trait PlotEmaSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotEmaSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotEmaSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
