...
trait PlotSupertrendSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
