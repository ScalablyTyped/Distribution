...
trait PlotWindbarbSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotWindbarbSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotWindbarbSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
