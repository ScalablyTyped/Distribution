...
trait PlotBubbleSonificationDefaultInstrumentMappingLowpassFrequencyOptions extends StObject {
...
object PlotBubbleSonificationDefaultInstrumentMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultInstrumentMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultInstrumentMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultInstrumentMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
