...
trait PlotEmaSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotEmaSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotEmaSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
