...
trait PlotMappointOnPointPositionOptions extends StObject {
...
object PlotMappointOnPointPositionOptions {
  
  inline def apply(): PlotMappointOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointOnPointPositionOptions] (val x: Self) extends AnyVal {
