...
trait PlotKlingerSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotKlingerSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
