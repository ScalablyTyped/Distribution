...
trait PlotKlingerSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotKlingerSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
