...
trait PlotAreaSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotAreaSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotAreaSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
