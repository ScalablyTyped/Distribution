...
trait PlotCandlestickLabelOptions extends js.Object {
  /**
...
object PlotCandlestickLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotCandlestickLabelOptions]
  }
}
