...
trait PlotMappointSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotMappointSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotMappointSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
