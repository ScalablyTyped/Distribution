...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesPivotpointsOptions
  extends StObject
     with PlotPivotpointsOptions {
...
object SeriesPivotpointsOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | pivotpoints): SeriesPivotpointsOptions = {
  ...
  @scala.inline
  implicit class SeriesPivotpointsOptionsMutableBuilder[Self <: SeriesPivotpointsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | pivotpoints): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
