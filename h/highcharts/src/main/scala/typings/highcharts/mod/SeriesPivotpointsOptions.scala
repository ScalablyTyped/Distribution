...
object SeriesPivotpointsOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | pivotpoints): SeriesPivotpointsOptions = {
  ...
  implicit open class MutableBuilder[Self <: SeriesPivotpointsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | pivotpoints): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
