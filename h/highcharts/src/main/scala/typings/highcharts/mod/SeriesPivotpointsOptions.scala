...
object SeriesPivotpointsOptions {
  ...
  @scala.inline
  implicit class SeriesPivotpointsOptionsOps[Self <: SeriesPivotpointsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | pivotpoints): Self = this.set("type", value.asInstanceOf[js.Any])
