...
trait SeriesPivotpointsOptions extends PlotPivotpointsOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | pivotpoints = js.native
...
object SeriesPivotpointsOptions {
  ...
  @scala.inline
  def apply(`type`: String | pivotpoints): SeriesPivotpointsOptions = {
