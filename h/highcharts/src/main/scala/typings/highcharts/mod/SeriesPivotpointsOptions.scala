...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesPivotpointsOptions extends PlotPivotpointsOptions {
  /**
    * Not available
    */
...
object SeriesPivotpointsOptions {
  ...
  def apply(
    ...
    dataLabels: PlotPivotpointsDataLabelsOptions | js.Array[PlotPivotpointsDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotPivotpointsDataSortingOptions = null,
