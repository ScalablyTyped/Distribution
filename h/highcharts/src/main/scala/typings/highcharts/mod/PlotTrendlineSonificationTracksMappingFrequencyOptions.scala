...
trait PlotTrendlineSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
