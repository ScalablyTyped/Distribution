...
trait PlotFlowmapSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotFlowmapSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
