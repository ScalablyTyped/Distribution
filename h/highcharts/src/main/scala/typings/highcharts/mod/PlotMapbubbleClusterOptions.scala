...
trait PlotMapbubbleClusterOptions extends StObject {
  ...
  var events: js.UndefOr[PlotMapbubbleClusterEventsOptions] = js.undefined
  ...
  /**
    ...
    * iterations.
    */
  var layoutAlgorithm: js.UndefOr[PlotMapbubbleClusterLayoutAlgorithmOptions] = js.undefined
  ...
  var states: js.UndefOr[PlotMapbubbleClusterStatesOptions] = js.undefined
  ...
  /**
    ...
    * `className` option.
    */
  var zones: js.UndefOr[js.Array[PlotMapbubbleClusterZonesOptions]] = js.undefined
}
object PlotMapbubbleClusterOptions {
  
  inline def apply(): PlotMapbubbleClusterOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleClusterOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleClusterOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: PlotMapbubbleClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    inline def setLayoutAlgorithm(value: PlotMapbubbleClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setStates(value: PlotMapbubbleClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    inline def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    inline def setZones(value: js.Array[PlotMapbubbleClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
    
    inline def setZonesUndefined: Self = StObject.set(x, "zones", js.undefined)
    
    inline def setZonesVarargs(value: PlotMapbubbleClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value*))
  }
}
