...
trait PlotRsiSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotRsiSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotRsiSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
