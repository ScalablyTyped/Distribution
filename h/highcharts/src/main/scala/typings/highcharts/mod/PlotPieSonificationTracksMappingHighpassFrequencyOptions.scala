...
trait PlotPieSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotPieSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotPieSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
