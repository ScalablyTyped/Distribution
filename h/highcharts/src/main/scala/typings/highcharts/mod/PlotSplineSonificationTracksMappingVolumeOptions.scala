...
trait PlotSplineSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotSplineSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
