...
trait PlotAtrSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotAtrSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
