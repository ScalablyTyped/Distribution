...
trait PlotRsiSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotRsiSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotRsiSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
