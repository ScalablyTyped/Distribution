...
trait PlotSplineSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotSplineSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotSplineSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
