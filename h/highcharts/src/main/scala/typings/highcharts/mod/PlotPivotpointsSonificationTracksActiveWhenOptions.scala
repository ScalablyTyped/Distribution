...
trait PlotPivotpointsSonificationTracksActiveWhenOptions extends StObject {
...
object PlotPivotpointsSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
