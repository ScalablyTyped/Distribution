...
trait PlotStochasticSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotStochasticSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
