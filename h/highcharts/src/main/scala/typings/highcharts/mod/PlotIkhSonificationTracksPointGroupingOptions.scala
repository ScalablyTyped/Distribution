...
trait PlotIkhSonificationTracksPointGroupingOptions extends StObject {
...
object PlotIkhSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotIkhSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
