...
trait PlotAtrSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
