...
trait PlotBarSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotBarSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotBarSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
