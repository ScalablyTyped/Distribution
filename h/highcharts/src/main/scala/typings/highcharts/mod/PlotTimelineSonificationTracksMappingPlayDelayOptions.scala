...
trait PlotTimelineSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
