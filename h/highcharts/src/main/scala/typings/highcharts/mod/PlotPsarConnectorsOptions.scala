...
trait PlotPsarConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPsarConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPsarConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPsarConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotPsarConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotPsarConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotPsarConnectorsMarkerOptions = null,
    startMarker: PlotPsarConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotPsarConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotPsarConnectorsOptions]
  }
}
