...
trait PlotGeoheatmapSonificationTracksMappingPanOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
