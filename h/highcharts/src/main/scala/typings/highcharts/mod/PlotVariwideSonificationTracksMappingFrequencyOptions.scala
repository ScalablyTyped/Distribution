...
trait PlotVariwideSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
