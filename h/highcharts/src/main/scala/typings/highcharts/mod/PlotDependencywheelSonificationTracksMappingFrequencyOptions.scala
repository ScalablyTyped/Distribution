...
trait PlotDependencywheelSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
