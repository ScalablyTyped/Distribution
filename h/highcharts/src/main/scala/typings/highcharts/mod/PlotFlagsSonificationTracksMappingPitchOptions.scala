...
trait PlotFlagsSonificationTracksMappingPitchOptions extends StObject {
...
object PlotFlagsSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotFlagsSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
