...
trait PlotRsiSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotRsiSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
