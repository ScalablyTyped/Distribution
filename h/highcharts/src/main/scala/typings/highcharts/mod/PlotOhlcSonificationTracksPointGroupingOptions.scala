...
trait PlotOhlcSonificationTracksPointGroupingOptions extends StObject {
...
object PlotOhlcSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotOhlcSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOhlcSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
