...
trait PlotSmaSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotSmaSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
