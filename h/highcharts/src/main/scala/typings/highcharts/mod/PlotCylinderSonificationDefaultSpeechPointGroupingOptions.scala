...
trait PlotCylinderSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotCylinderSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
