...
trait PlotCandlestickSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
