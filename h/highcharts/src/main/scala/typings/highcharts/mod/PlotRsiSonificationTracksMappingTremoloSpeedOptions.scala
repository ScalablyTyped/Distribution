...
trait PlotRsiSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotRsiSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
