...
trait ChartParallelAxesLabelsOptions extends StObject {
...
object ChartParallelAxesLabelsOptions {
  ...
  @scala.inline
  implicit class ChartParallelAxesLabelsOptionsMutableBuilder[Self <: ChartParallelAxesLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLevels(value: js.Array[ChartParallelAxesLabelsLevelsOptions]): Self = StObject.set(x, "levels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLevelsUndefined: Self = StObject.set(x, "levels", js.undefined)
    
    @scala.inline
    def setLevelsVarargs(value: ChartParallelAxesLabelsLevelsOptions*): Self = StObject.set(x, "levels", js.Array(value :_*))
    ...
    @scala.inline
    def setSymbol(value: ChartParallelAxesLabelsSymbolOptions): Self = StObject.set(x, "symbol", value.asInstanceOf[js.Any])
