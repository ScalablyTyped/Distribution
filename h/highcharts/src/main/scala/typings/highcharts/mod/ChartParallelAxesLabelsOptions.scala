...
object ChartParallelAxesLabelsOptions {
  ...
  inline def apply(): ChartParallelAxesLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesLabelsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartParallelAxesLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setLevels(value: js.Array[ChartParallelAxesLabelsLevelsOptions]): Self = StObject.set(x, "levels", value.asInstanceOf[js.Any])
    ...
    inline def setSymbol(value: ChartParallelAxesLabelsSymbolOptions): Self = StObject.set(x, "symbol", value.asInstanceOf[js.Any])
