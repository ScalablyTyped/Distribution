...
trait PlotLinearregressionangleSonificationTracksMappingPitchOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
