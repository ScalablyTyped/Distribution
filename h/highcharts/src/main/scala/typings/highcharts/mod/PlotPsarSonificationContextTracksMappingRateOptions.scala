...
trait PlotPsarSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotPsarSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
