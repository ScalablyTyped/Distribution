...
trait PlotLinearregressionSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
