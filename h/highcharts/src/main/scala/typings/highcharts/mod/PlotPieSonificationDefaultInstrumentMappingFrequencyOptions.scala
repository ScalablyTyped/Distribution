...
trait PlotPieSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotPieSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotPieSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
