...
trait PlotDependencywheelSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
