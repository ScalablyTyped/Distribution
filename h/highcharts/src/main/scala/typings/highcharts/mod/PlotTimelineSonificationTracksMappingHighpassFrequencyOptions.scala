...
trait PlotTimelineSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
