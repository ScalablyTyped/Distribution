...
trait PlotPsarSonificationTracksMappingTimeOptions extends StObject {
...
object PlotPsarSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
