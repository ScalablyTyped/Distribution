...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesLinearregressionOptions
  extends StObject
...
object SeriesLinearregressionOptions {
  ...
  inline def apply(`type`: String | linearregression): SeriesLinearregressionOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesLinearregressionOptions] (val x: Self) extends AnyVal {
