...
trait PlotDemaSonificationDefaultInstrumentMappingTremoloSpeedOptions extends StObject {
...
object PlotDemaSonificationDefaultInstrumentMappingTremoloSpeedOptions {
  
  inline def apply(): PlotDemaSonificationDefaultInstrumentMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaSonificationDefaultInstrumentMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDemaSonificationDefaultInstrumentMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
