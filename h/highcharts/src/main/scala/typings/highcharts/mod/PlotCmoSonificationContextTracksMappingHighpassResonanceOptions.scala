...
trait PlotCmoSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
