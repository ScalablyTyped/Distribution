...
trait PlotStochasticSonificationContextTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotStochasticSonificationContextTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
