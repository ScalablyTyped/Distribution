...
trait PlotFlowmapSonificationPointGroupingOptions extends StObject {
...
object PlotFlowmapSonificationPointGroupingOptions {
  
  inline def apply(): PlotFlowmapSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
