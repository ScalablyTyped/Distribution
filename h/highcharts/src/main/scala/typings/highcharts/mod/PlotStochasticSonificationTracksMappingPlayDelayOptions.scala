...
trait PlotStochasticSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
