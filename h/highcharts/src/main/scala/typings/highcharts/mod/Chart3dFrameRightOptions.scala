...
@js.native
trait Chart3dFrameRightOptions extends js.Object {
  /**
...
object Chart3dFrameRightOptions {
  @scala.inline
  def apply(): Chart3dFrameRightOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Chart3dFrameRightOptions]
  }
  @scala.inline
  implicit class Chart3dFrameRightOptionsOps[Self <: Chart3dFrameRightOptions] (val x: Self) extends AnyVal {
    @scala.inline
