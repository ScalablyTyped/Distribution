...
trait PlotArearangeOnPointPositionOptions extends StObject {
...
object PlotArearangeOnPointPositionOptions {
  
  inline def apply(): PlotArearangeOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeOnPointPositionOptions] (val x: Self) extends AnyVal {
