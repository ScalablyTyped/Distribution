...
trait PlotWaterfallSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotWaterfallSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotWaterfallSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
