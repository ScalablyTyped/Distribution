...
trait PlotTemaSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotTemaSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotTemaSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
