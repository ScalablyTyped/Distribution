...
trait PlotLinearregressioninterceptSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
