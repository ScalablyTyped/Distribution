...
trait PlotAreaSonificationTracksMappingTimeOptions extends StObject {
...
object PlotAreaSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotAreaSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
