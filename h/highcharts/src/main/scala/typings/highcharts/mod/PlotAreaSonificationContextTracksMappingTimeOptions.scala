...
trait PlotAreaSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotAreaSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotAreaSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
