...
trait SonificationGlobalContextTracksMappingPanOptions extends StObject {
...
object SonificationGlobalContextTracksMappingPanOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
