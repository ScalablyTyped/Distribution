...
trait PlotNatrSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotNatrSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
