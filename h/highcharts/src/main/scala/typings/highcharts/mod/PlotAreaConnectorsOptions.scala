...
trait PlotAreaConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAreaConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAreaConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAreaConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotAreaConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotAreaConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotAreaConnectorsMarkerOptions = null,
    startMarker: PlotAreaConnectorsStartMarkerOptions = null,
    ...
    __obj.asInstanceOf[PlotAreaConnectorsOptions]
  }
}
