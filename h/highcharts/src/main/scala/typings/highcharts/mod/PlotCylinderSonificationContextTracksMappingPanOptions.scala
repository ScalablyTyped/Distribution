...
trait PlotCylinderSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotCylinderSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
