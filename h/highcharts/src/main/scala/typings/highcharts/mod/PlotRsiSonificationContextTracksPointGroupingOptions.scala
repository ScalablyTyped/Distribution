...
trait PlotRsiSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotRsiSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
