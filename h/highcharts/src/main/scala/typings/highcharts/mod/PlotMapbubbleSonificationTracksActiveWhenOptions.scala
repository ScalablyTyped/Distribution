...
trait PlotMapbubbleSonificationTracksActiveWhenOptions extends StObject {
...
object PlotMapbubbleSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotMapbubbleSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
