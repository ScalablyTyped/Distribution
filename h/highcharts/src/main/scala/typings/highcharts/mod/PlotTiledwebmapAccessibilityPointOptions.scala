...
trait PlotTiledwebmapAccessibilityPointOptions extends StObject {
...
object PlotTiledwebmapAccessibilityPointOptions {
  
  inline def apply(): PlotTiledwebmapAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTiledwebmapAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTiledwebmapAccessibilityPointOptions] (val x: Self) extends AnyVal {
