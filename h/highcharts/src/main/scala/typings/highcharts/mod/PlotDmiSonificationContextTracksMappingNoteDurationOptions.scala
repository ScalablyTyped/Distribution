...
trait PlotDmiSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
