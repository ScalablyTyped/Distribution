...
trait PlotDumbbellSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
