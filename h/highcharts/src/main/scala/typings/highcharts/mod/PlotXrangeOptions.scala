...
trait PlotXrangeOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotXrangeAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotXrangeDataLabelsOptions | js.Array[PlotXrangeDataLabelsOptions]] = js.native
  ...
  /**
    ...
    */
  var partialFill: js.UndefOr[PlotXrangePartialFillOptions] = js.native
...
object PlotXrangeOptions {
  ...
  @scala.inline
  def apply(): PlotXrangeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeOptions]
  }
  
  @scala.inline
  implicit class PlotXrangeOptionsMutableBuilder[Self <: PlotXrangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotXrangeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotXrangeDataLabelsOptions | js.Array[PlotXrangeDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotXrangeDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    ...
    @scala.inline
    def setPartialFill(value: PlotXrangePartialFillOptions): Self = StObject.set(x, "partialFill", value.asInstanceOf[js.Any])
