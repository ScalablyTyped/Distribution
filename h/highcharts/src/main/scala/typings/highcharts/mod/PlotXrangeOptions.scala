...
trait PlotXrangeOptions extends StObject {
  ...
  /**
    ...
    * this series. Can be one of `lineMarker` or `rectangle`.
    */
  ...
  /**
    ...
    * series.
    */
  var sonification: js.UndefOr[PlotXrangeSonificationOptions] = js.undefined
...
object PlotXrangeOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotXrangeOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotXrangeSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
