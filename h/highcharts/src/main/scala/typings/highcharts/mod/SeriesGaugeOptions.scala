...
trait SeriesGaugeOptions extends PlotGaugeOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | gauge = js.native
...
object SeriesGaugeOptions {
  ...
  @scala.inline
  def apply(`type`: String | gauge): SeriesGaugeOptions = {
  ...
  @scala.inline
  implicit class SeriesGaugeOptionsOps[Self <: SeriesGaugeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | gauge): Self = this.set("type", value.asInstanceOf[js.Any])
