...
object SeriesGaugeOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | gauge): SeriesGaugeOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesGaugeOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | gauge): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
