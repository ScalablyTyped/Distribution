...
@js.native
trait PlotDpoDataLabelsAnimationOptions extends js.Object {
...
object PlotDpoDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): PlotDpoDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class PlotDpoDataLabelsAnimationOptionsOps[Self <: PlotDpoDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
