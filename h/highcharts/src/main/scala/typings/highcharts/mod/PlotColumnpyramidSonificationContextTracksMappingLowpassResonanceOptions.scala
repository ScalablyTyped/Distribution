...
trait PlotColumnpyramidSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
