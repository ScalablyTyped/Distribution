...
trait PlotItemSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotItemSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotItemSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
