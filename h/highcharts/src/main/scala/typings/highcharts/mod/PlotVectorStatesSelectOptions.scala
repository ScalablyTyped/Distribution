...
trait PlotVectorStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotVectorStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotVectorStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotVectorStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotVectorStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotVectorStatesSelectOptions]
  }
}
