...
trait PlotColumnpyramidSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
