...
trait PlotColumnSonificationTracksMappingPitchOptions extends StObject {
...
object PlotColumnSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
