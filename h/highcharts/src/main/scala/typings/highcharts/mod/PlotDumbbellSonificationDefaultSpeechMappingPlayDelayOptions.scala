...
trait PlotDumbbellSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotDumbbellSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
