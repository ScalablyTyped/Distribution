...
trait PlotArcdiagramSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
