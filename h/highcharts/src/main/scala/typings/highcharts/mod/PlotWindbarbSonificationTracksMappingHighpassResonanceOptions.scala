...
trait PlotWindbarbSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotWindbarbSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotWindbarbSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
