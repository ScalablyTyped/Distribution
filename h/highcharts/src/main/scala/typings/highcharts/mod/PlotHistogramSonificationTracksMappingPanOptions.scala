...
trait PlotHistogramSonificationTracksMappingPanOptions extends StObject {
...
object PlotHistogramSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotHistogramSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
