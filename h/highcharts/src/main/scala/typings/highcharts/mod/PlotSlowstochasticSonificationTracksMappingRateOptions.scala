...
trait PlotSlowstochasticSonificationTracksMappingRateOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
