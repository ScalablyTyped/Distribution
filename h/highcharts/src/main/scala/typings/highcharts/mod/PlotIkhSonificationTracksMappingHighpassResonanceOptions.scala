...
trait PlotIkhSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotIkhSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
