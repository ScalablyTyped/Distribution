...
trait PlotFlowmapSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
