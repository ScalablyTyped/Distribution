...
trait PlotWmaSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotWmaSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotWmaSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
