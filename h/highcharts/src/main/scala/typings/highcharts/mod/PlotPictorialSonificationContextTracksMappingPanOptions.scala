...
trait PlotPictorialSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotPictorialSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
