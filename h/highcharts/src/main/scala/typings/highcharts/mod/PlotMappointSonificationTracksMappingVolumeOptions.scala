...
trait PlotMappointSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotMappointSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
