...
object PlotTreemapClusterOptions {
  ...
  inline def apply(): PlotTreemapClusterOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapClusterOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapClusterOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: PlotTreemapClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    inline def setLayoutAlgorithm(value: PlotTreemapClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setStates(value: PlotTreemapClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    inline def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    inline def setZones(value: js.Array[PlotTreemapClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
    
    inline def setZonesUndefined: Self = StObject.set(x, "zones", js.undefined)
    
    inline def setZonesVarargs(value: PlotTreemapClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value*))
  }
}
