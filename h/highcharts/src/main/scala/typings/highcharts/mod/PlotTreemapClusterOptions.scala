...
object PlotTreemapClusterOptions {
  ...
  extension [Self <: PlotTreemapClusterOptions](x: Self) {
    ...
    inline def setZonesVarargs(value: PlotTreemapClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value :_*))
  }
}
