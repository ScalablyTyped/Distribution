...
@js.native
trait PlotWilliamsrDataSortingOptions extends js.Object {
  /**
...
object PlotWilliamsrDataSortingOptions {
  @scala.inline
  def apply(): PlotWilliamsrDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrDataSortingOptions]
  }
  @scala.inline
  implicit class PlotWilliamsrDataSortingOptionsOps[Self <: PlotWilliamsrDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
