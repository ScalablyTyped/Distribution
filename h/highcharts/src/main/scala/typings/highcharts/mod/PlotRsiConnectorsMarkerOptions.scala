...
trait PlotRsiConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotRsiConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRsiConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotRsiConnectorsMarkerOptions]
  }
}
