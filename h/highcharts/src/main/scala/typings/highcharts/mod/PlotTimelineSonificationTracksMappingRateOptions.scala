...
trait PlotTimelineSonificationTracksMappingRateOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
