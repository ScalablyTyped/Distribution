...
trait PlotEmaSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotEmaSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
