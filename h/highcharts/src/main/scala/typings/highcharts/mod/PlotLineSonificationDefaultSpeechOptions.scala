...
trait PlotLineSonificationDefaultSpeechOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotLineSonificationDefaultSpeechActiveWhenOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock) The language to speak in for speech tracks, as an
    * IETF BCP 47 language tag.
    */
  var language: js.UndefOr[String] = js.undefined
  
  /**
    * (Highcharts, Highstock) Mapping configuration for the speech/audio
    * parameters.
    *
    ...
    */
  var mapping: js.UndefOr[PlotLineSonificationDefaultSpeechMappingOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for point grouping, specifically for
    * instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotLineSonificationDefaultSpeechPointGroupingOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock) Name of the voice synthesis to prefer for speech
    * tracks.
    *
...
object PlotLineSonificationDefaultSpeechOptions {
  
  inline def apply(): PlotLineSonificationDefaultSpeechOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultSpeechOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultSpeechOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotLineSonificationDefaultSpeechActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotLineSonificationDefaultSpeechMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    
    inline def setMappingUndefined: Self = StObject.set(x, "mapping", js.undefined)
    
    inline def setPointGrouping(value: PlotLineSonificationDefaultSpeechPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
