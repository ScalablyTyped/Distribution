...
trait PlotGaugeSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotGaugeSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotGaugeSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
