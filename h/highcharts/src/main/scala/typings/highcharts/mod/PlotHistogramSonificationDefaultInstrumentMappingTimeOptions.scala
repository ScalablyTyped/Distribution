...
trait PlotHistogramSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotHistogramSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
