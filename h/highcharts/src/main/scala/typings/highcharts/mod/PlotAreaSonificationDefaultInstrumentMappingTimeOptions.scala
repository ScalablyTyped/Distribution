...
trait PlotAreaSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotAreaSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotAreaSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
