...
trait PlotWmaAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotWmaAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotWmaAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotWmaAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotWmaAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotWmaAccessibilityOptions]
  }
}
