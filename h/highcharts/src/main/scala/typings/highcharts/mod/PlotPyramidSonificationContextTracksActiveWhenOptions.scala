...
trait PlotPyramidSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotPyramidSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
