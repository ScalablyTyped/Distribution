...
trait PlotTimelineSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
