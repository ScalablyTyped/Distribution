...
trait PlotAreasplineSonificationTracksMappingPitchOptions extends StObject {
...
object PlotAreasplineSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotAreasplineSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplineSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
