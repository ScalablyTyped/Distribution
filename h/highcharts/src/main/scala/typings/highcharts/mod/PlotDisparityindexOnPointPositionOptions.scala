...
trait PlotDisparityindexOnPointPositionOptions extends StObject {
...
object PlotDisparityindexOnPointPositionOptions {
  
  inline def apply(): PlotDisparityindexOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexOnPointPositionOptions] (val x: Self) extends AnyVal {
