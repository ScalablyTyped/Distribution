...
trait PlotSplineSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
