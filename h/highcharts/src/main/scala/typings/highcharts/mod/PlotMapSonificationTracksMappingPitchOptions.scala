...
trait PlotMapSonificationTracksMappingPitchOptions extends StObject {
...
object PlotMapSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
