...
trait PlotTrendlineDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotTrendlineDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotTrendlineDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotTrendlineDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotTrendlineDataLabelsOptionsMutableBuilder[Self <: PlotTrendlineDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTrendlineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
