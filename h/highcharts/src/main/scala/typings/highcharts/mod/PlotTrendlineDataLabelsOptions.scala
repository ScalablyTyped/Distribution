...
@js.native
trait PlotTrendlineDataLabelsOptions extends js.Object {
...
object PlotTrendlineDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotTrendlineDataLabelsOptionsOps[Self <: PlotTrendlineDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTrendlineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
