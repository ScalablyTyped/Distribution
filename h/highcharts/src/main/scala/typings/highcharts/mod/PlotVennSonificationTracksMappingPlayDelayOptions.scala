...
trait PlotVennSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotVennSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
