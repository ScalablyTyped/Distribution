...
trait PlotAbandsSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotAbandsSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
