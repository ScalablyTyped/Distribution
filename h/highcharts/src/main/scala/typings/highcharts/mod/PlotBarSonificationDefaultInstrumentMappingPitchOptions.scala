...
trait PlotBarSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotBarSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotBarSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
