...
trait PlotXrangeSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotXrangeSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
