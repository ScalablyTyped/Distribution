...
trait PlotFlowmapSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotFlowmapSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
