...
trait PlotBulletOnPointPositionOptions extends StObject {
...
object PlotBulletOnPointPositionOptions {
  
  inline def apply(): PlotBulletOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletOnPointPositionOptions] (val x: Self) extends AnyVal {
