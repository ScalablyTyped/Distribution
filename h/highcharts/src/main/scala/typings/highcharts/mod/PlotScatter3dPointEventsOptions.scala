...
trait PlotScatter3dPointEventsOptions extends js.Object {
  /**
...
object PlotScatter3dPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatter3dPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dPointEventsOptions]
  }
}
