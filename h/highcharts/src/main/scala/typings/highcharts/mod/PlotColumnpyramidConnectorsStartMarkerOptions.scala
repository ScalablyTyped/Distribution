...
trait PlotColumnpyramidConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotColumnpyramidConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnpyramidConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotColumnpyramidConnectorsStartMarkerOptions]
  }
}
