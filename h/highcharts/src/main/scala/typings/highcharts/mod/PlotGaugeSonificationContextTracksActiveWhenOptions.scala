...
trait PlotGaugeSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotGaugeSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotGaugeSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
