...
trait PlotAreasplinerangeOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAreasplinerangeAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotAreasplinerangeDataSortingOptions] = js.native
...
object PlotAreasplinerangeOptions {
  ...
  @scala.inline
  def apply(): PlotAreasplinerangeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeOptions]
  }
  
  @scala.inline
  implicit class PlotAreasplinerangeOptionsMutableBuilder[Self <: PlotAreasplinerangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAreasplinerangeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotAreasplinerangeDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
