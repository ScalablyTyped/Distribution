...
trait PlotPivotpointsSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
