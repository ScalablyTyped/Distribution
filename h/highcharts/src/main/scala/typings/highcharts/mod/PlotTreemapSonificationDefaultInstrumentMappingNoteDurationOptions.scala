...
trait PlotTreemapSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotTreemapSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
