...
trait PlotFunnelSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotFunnelSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
