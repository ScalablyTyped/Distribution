...
trait PlotCylinderSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotCylinderSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
