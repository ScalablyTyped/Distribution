...
trait PlotCciSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotCciSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotCciSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
