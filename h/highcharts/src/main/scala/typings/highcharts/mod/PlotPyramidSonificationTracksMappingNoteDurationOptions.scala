...
trait PlotPyramidSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
