...
trait PlotArcdiagramSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
