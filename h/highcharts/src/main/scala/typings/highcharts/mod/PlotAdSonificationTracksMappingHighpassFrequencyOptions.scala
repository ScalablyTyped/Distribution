...
trait PlotAdSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotAdSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotAdSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
