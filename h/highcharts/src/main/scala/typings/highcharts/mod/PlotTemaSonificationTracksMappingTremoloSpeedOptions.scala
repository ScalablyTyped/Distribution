...
trait PlotTemaSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotTemaSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
