...
trait PlotSplineSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotSplineSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
