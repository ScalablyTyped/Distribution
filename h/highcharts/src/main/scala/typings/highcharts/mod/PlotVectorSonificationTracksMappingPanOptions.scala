...
trait PlotVectorSonificationTracksMappingPanOptions extends StObject {
...
object PlotVectorSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotVectorSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVectorSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
