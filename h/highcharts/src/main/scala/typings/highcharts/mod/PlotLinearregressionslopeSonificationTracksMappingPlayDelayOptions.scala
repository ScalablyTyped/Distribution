...
trait PlotLinearregressionslopeSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
