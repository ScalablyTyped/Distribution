...
trait PlotAbandsSonificationTracksMappingPanOptions extends StObject {
...
object PlotAbandsSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotAbandsSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
