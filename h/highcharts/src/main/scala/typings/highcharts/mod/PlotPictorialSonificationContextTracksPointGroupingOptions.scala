...
trait PlotPictorialSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotPictorialSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
