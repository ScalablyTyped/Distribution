...
object SeriesBarOptions {
  ...
  @scala.inline
  implicit class SeriesBarOptionsOps[Self <: SeriesBarOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | bar): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
