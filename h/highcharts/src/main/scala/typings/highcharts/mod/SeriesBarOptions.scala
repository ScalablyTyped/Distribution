...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesBarOptions extends PlotBarOptions {
  /**
...
object SeriesBarOptions {
  ...
  def apply(
    ...
    dataLabels: PlotBarDataLabelsOptions | js.Array[PlotBarDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotBarDataSortingOptions = null,
