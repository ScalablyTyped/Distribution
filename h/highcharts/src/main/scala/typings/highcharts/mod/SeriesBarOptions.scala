...
object SeriesBarOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | bar): SeriesBarOptions = {
  ...
  @scala.inline
  implicit class SeriesBarOptionsMutableBuilder[Self <: SeriesBarOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | bar): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
