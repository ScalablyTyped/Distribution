...
trait PlotDependencywheelSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
