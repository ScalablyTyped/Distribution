...
trait PlotBarSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotBarSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotBarSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
