...
@js.native
trait PlotTrendlineOptions extends js.Object {
...
object PlotTrendlineOptions {
  ...
  @scala.inline
  implicit class PlotTrendlineOptionsOps[Self <: PlotTrendlineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTrendlineAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotTrendlineDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotTrendlineDataLabelsOptions | js.Array[PlotTrendlineDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotTrendlineDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotTrendlineParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
