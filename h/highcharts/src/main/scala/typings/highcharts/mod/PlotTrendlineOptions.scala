...
trait PlotTrendlineOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotTrendlineSonificationOptions] = js.undefined
...
object PlotTrendlineOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotTrendlineSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
