...
object PlotTrendlineOptions {
  ...
  def apply(
    ...
    dataLabels: PlotTrendlineDataLabelsOptions | js.Array[PlotTrendlineDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotTrendlineDataSortingOptions = null,
