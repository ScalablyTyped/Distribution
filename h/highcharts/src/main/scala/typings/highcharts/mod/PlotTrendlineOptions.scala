...
trait PlotTrendlineOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotTrendlineAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotTrendlineDataLabelsOptions | js.Array[PlotTrendlineDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotTrendlineDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotTrendlineParamsOptions] = js.native
