...
trait PlotArearangeSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotArearangeSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotArearangeSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
