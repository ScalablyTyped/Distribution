...
trait SonificationGlobalTracksMappingGapBetweenNotesOptions extends StObject {
...
object SonificationGlobalTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): SonificationGlobalTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
