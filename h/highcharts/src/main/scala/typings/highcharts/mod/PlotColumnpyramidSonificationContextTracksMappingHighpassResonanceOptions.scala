...
trait PlotColumnpyramidSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
