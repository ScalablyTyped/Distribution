...
trait PlotMapSonificationTracksPointGroupingOptions extends StObject {
...
object PlotMapSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotMapSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
