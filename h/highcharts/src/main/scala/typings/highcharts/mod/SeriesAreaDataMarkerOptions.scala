...
trait SeriesAreaDataMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesAreaDataMarkerStatesOptions] = js.undefined
  /**
...
object SeriesAreaDataMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: SeriesAreaDataMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): SeriesAreaDataMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesAreaDataMarkerOptions]
  }
}
