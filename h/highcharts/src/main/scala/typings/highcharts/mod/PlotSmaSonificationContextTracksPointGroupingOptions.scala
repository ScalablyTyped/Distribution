...
trait PlotSmaSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotSmaSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
