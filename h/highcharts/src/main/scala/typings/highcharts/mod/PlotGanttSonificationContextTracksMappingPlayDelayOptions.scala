...
trait PlotGanttSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotGanttSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
