...
trait PlotFlowmapSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotFlowmapSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
