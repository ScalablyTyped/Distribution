...
@js.native
trait PlotDependencywheelDataLabelsAnimationOptions extends js.Object {
...
object PlotDependencywheelDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotDependencywheelDataLabelsAnimationOptionsOps[Self <: PlotDependencywheelDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
