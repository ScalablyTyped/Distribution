...
@js.native
trait PlotChaikinDataSortingOptions extends js.Object {
...
object PlotChaikinDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotChaikinDataSortingOptionsOps[Self <: PlotChaikinDataSortingOptions] (val x: Self) extends AnyVal {
