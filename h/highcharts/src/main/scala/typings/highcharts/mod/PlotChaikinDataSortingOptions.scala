...
trait PlotChaikinDataSortingOptions extends StObject {
...
object PlotChaikinDataSortingOptions {
  
  @scala.inline
  def apply(): PlotChaikinDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotChaikinDataSortingOptionsMutableBuilder[Self <: PlotChaikinDataSortingOptions] (val x: Self) extends AnyVal {
