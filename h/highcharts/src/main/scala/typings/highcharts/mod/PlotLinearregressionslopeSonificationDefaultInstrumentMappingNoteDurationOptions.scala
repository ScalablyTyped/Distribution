...
trait PlotLinearregressionslopeSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
