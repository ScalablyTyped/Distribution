...
trait PlotDmiSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotDmiSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotDmiSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
