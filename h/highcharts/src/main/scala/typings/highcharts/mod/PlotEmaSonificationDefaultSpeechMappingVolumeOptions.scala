...
trait PlotEmaSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotEmaSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotEmaSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
