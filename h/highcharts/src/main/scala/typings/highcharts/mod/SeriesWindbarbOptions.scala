...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesWindbarbOptions extends PlotWindbarbOptions {
  /**
...
object SeriesWindbarbOptions {
  ...
  def apply(
    ...
    data: js.Array[(js.Tuple3[Double | String, Double, Double]) | PointOptionsObject] = null,
    ...
    onSeries: js.UndefOr[Null | String] = js.undefined,
    ...
    if (!js.isUndefined(onSeries)) __obj.updateDynamic("onSeries")(onSeries.asInstanceOf[js.Any])
