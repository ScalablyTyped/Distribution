...
trait SeriesWindbarbOptions extends PlotWindbarbOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[(js.Tuple3[Double | String, Double, Double]) | PointOptionsObject]] = js.native
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | windbarb = js.native
...
object SeriesWindbarbOptions {
  ...
  @scala.inline
  def apply(`type`: String | windbarb): SeriesWindbarbOptions = {
  ...
  @scala.inline
  implicit class SeriesWindbarbOptionsMutableBuilder[Self <: SeriesWindbarbOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: js.Array[(js.Tuple3[Double | String, Double, Double]) | PointOptionsObject]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    @scala.inline
    def setDataVarargs(value: ((js.Tuple3[Double | String, Double, Double]) | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | windbarb): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
