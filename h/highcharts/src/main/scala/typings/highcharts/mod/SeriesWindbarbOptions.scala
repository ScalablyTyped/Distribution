...
object SeriesWindbarbOptions {
  ...
  @scala.inline
  implicit class SeriesWindbarbOptionsOps[Self <: SeriesWindbarbOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | windbarb): Self = this.set("type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataVarargs(value: ((js.Tuple3[Double | String, Double, Double]) | PointOptionsObject)*): Self = this.set("data", js.Array(value :_*))
    
    @scala.inline
    def setData(value: js.Array[(js.Tuple3[Double | String, Double, Double]) | PointOptionsObject]): Self = this.set("data", value.asInstanceOf[js.Any])
