...
trait PlotSupertrendSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
