...
trait PlotPsarSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotPsarSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotPsarSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
