...
trait PlotPictorialSonificationTracksActiveWhenOptions extends StObject {
...
object PlotPictorialSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotPictorialSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
