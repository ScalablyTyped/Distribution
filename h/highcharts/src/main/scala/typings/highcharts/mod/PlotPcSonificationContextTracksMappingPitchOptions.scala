...
trait PlotPcSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotPcSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotPcSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
