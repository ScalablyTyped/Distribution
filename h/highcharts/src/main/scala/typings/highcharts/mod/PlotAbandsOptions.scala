...
object PlotAbandsOptions {
  ...
  def apply(
    ...
    dataLabels: PlotAbandsDataLabelsOptions | js.Array[PlotAbandsDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotAbandsDataSortingOptions = null,
