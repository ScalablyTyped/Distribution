...
trait PlotAbandsOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotAbandsSonificationOptions] = js.undefined
...
object PlotAbandsOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotAbandsSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
