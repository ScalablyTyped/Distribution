...
trait PlotAbandsOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAbandsAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  var bottomLine: js.UndefOr[PlotAbandsBottomLineOptions] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotAbandsDataLabelsOptions | js.Array[PlotAbandsDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotAbandsDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotAbandsParamsOptions] = js.native
  ...
  var topLine: js.UndefOr[PlotAbandsTopLineOptions] = js.native
...
object PlotAbandsOptions {
  ...
  @scala.inline
  def apply(): PlotAbandsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsOptions]
  }
  
  @scala.inline
  implicit class PlotAbandsOptionsMutableBuilder[Self <: PlotAbandsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAbandsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBottomLine(value: PlotAbandsBottomLineOptions): Self = StObject.set(x, "bottomLine", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotAbandsDataLabelsOptions | js.Array[PlotAbandsDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotAbandsDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotAbandsDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotAbandsParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTopLine(value: PlotAbandsTopLineOptions): Self = StObject.set(x, "topLine", value.asInstanceOf[js.Any])
