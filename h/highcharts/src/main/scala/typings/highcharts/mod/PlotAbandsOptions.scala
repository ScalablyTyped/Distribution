...
trait PlotAbandsOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAbandsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotAbandsDataLabelsOptions | js.Array[PlotAbandsDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotAbandsDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotAbandsOnPointOptions] = js.undefined
...
object PlotAbandsOptions {
  ...
  inline def apply(): PlotAbandsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsOptions]
  }
  
  extension [Self <: PlotAbandsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotAbandsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setBottomLine(value: PlotAbandsBottomLineOptions): Self = StObject.set(x, "bottomLine", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotAbandsDataLabelsOptions | js.Array[PlotAbandsDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotAbandsDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotAbandsDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotAbandsOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotAbandsParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    inline def setTopLine(value: PlotAbandsTopLineOptions): Self = StObject.set(x, "topLine", value.asInstanceOf[js.Any])
