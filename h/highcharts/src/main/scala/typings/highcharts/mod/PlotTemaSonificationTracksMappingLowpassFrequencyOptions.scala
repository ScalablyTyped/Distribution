...
trait PlotTemaSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotTemaSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
