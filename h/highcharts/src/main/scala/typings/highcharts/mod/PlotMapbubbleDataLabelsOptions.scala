...
@js.native
trait PlotMapbubbleDataLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotMapbubbleDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotMapbubbleDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotMapbubbleDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotMapbubbleDataLabelsOptionsOps[Self <: PlotMapbubbleDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMapbubbleDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
