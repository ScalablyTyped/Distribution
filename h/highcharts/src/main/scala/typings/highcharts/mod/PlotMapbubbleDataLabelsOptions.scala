...
object PlotMapbubbleDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotMapbubbleDataLabelsOptionsMutableBuilder[Self <: PlotMapbubbleDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMapbubbleDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
