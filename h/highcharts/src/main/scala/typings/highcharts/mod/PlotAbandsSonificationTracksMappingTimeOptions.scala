...
trait PlotAbandsSonificationTracksMappingTimeOptions extends StObject {
...
object PlotAbandsSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotAbandsSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
