...
trait PlotLollipopSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
