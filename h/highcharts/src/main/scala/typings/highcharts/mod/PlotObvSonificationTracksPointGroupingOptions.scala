...
trait PlotObvSonificationTracksPointGroupingOptions extends StObject {
...
object PlotObvSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotObvSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotObvSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotObvSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
