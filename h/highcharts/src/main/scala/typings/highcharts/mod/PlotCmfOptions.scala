...
trait PlotCmfOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotCmfAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotCmfDataLabelsOptions | js.Array[PlotCmfDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotCmfDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotCmfParamsOptions] = js.native
...
object PlotCmfOptions {
  ...
  @scala.inline
  def apply(): PlotCmfOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfOptions]
  }
  
  @scala.inline
  implicit class PlotCmfOptionsMutableBuilder[Self <: PlotCmfOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotCmfAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotCmfDataLabelsOptions | js.Array[PlotCmfDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotCmfDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotCmfDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotCmfParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
