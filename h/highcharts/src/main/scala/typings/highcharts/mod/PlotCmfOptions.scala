...
trait PlotCmfOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotCmfSonificationOptions] = js.undefined
...
object PlotCmfOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmfOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotCmfSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
