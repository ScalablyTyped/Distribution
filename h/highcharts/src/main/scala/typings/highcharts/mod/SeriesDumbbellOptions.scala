...
import typings.highcharts.highchartsStrings.dumbbell
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesDumbbellOptions
  extends PlotDumbbellOptions
  ...
  /**
    * Not available
    */
  var fillColor: js.UndefOr[scala.Nothing] = js.undefined
  /**
    * Not available
    */
  var fillOpacity: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    * Not available
    */
  var trackByArea: js.UndefOr[scala.Nothing] = js.undefined
  /**
...
object SeriesDumbbellOptions {
  ...
  def apply(
    ...
    dataSorting: DataSortingOptionsObject | PlotDumbbellDataSortingOptions = null,
    description: String = null,
    dragDrop: SeriesDragDropOptionsObject = null,
    enableMouseTracking: js.UndefOr[Boolean] = js.undefined,
    events: SeriesEventsOptionsObject = null,
    fillColor: js.UndefOr[scala.Nothing] = js.undefined,
    fillOpacity: js.UndefOr[scala.Nothing] = js.undefined,
    ...
    trackByArea: js.UndefOr[scala.Nothing] = js.undefined,
    ...
    if (!js.isUndefined(fillOpacity)) __obj.updateDynamic("fillOpacity")(fillOpacity.asInstanceOf[js.Any])
