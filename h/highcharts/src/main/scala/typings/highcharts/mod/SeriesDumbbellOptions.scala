...
object SeriesDumbbellOptions {
  ...
  @scala.inline
  def apply(`type`: String | dumbbell): SeriesDumbbellOptions = {
  ...
  @scala.inline
  implicit class SeriesDumbbellOptionsMutableBuilder[Self <: SeriesDumbbellOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | dumbbell): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
