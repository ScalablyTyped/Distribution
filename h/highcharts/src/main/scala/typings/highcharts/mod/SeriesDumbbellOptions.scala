...
object SeriesDumbbellOptions {
  ...
  @scala.inline
  implicit class SeriesDumbbellOptionsOps[Self <: SeriesDumbbellOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | dumbbell): Self = this.set("type", value.asInstanceOf[js.Any])
