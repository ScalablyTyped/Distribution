...
trait PlotWmaSonificationTracksPointGroupingOptions extends StObject {
...
object PlotWmaSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotWmaSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
