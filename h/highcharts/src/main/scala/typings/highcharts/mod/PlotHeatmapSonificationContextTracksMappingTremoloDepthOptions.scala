...
trait PlotHeatmapSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotHeatmapSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
