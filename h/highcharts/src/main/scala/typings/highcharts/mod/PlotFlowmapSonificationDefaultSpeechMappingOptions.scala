...
trait PlotFlowmapSonificationDefaultSpeechMappingOptions extends StObject {
  
  /**
    * (Highmaps) Speech pitch (how high/low the voice is) multiplier.
    */
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotFlowmapSonificationDefaultSpeechMappingPitchOptions
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotFlowmapSonificationDefaultSpeechMappingPlayDelayOptions
  ] = js.undefined
  
  /**
    * (Highmaps) Speech rate (speed) multiplier.
    */
  var rate: js.UndefOr[
    Double | js.Object | String | js.Function | PlotFlowmapSonificationDefaultSpeechMappingRateOptions
  ] = js.undefined
  
  /**
    * (Highmaps) The text to announce for speech tracks. Can either be a format
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotFlowmapSonificationDefaultSpeechMappingTimeOptions
  ] = js.undefined
  
  /**
    * (Highmaps) Volume of the speech announcement.
    */
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotFlowmapSonificationDefaultSpeechMappingVolumeOptions
  ] = js.undefined
}
object PlotFlowmapSonificationDefaultSpeechMappingOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultSpeechMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultSpeechMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultSpeechMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotFlowmapSonificationDefaultSpeechMappingPitchOptions
    ): Self = StObject.set(x, "pitch", value.asInstanceOf[js.Any])
    
    inline def setPitchUndefined: Self = StObject.set(x, "pitch", js.undefined)
    
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotFlowmapSonificationDefaultSpeechMappingPlayDelayOptions
    ...
    inline def setRate(
      value: Double | js.Object | String | js.Function | PlotFlowmapSonificationDefaultSpeechMappingRateOptions
    ...
    inline def setTime(
      value: Double | js.Object | String | js.Function | PlotFlowmapSonificationDefaultSpeechMappingTimeOptions
    ): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setVolume(
      value: Double | js.Object | String | js.Function | PlotFlowmapSonificationDefaultSpeechMappingVolumeOptions
