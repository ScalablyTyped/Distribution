...
trait PlotLinearregressionslopeSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
