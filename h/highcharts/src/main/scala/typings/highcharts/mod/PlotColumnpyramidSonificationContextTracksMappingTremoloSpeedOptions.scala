...
trait PlotColumnpyramidSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
