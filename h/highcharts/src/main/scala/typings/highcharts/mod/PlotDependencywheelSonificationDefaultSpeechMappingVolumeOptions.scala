...
trait PlotDependencywheelSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotDependencywheelSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
