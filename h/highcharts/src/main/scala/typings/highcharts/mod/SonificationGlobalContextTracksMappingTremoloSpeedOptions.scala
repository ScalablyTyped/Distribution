...
trait SonificationGlobalContextTracksMappingTremoloSpeedOptions extends StObject {
...
object SonificationGlobalContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
