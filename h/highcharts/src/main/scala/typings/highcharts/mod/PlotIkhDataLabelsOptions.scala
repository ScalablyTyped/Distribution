...
object PlotIkhDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotIkhDataLabelsOptionsMutableBuilder[Self <: PlotIkhDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotIkhDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
