...
trait PlotPcSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPcSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPcSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
