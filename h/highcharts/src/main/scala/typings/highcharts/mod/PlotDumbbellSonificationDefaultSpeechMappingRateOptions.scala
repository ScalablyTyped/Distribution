...
trait PlotDumbbellSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotDumbbellSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
