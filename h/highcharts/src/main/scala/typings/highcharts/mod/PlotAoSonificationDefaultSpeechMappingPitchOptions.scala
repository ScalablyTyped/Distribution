...
trait PlotAoSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotAoSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotAoSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
