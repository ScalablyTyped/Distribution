...
trait PlotSolidgaugeDataSortingOptions extends StObject {
...
object PlotSolidgaugeDataSortingOptions {
  
  inline def apply(): PlotSolidgaugeDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSolidgaugeDataSortingOptions] (val x: Self) extends AnyVal {
