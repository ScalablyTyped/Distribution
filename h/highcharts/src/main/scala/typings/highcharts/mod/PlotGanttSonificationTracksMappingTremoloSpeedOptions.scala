...
trait PlotGanttSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotGanttSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
