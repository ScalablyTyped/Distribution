...
trait PlotDependencywheelSonificationTracksPointGroupingOptions extends StObject {
...
object PlotDependencywheelSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
