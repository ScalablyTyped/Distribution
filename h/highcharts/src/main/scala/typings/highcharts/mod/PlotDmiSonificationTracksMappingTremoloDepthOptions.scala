...
trait PlotDmiSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotDmiSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
