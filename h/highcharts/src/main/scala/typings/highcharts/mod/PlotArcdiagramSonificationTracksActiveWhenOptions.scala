...
trait PlotArcdiagramSonificationTracksActiveWhenOptions extends StObject {
...
object PlotArcdiagramSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
