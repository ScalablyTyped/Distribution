...
trait PlotColumnpyramidSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
