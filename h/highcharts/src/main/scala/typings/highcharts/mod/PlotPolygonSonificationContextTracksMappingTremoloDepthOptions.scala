...
trait PlotPolygonSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
