...
trait PlotParetoSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotParetoSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotParetoSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
