...
trait PlotLinearregressioninterceptSonificationTracksActiveWhenOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
