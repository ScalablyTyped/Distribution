...
trait PlotSplineSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotSplineSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
