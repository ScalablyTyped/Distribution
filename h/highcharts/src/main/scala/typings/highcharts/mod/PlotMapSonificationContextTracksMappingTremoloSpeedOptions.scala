...
trait PlotMapSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotMapSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotMapSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
