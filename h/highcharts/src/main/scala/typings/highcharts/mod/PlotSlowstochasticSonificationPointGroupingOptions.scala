...
trait PlotSlowstochasticSonificationPointGroupingOptions extends StObject {
...
object PlotSlowstochasticSonificationPointGroupingOptions {
  
  inline def apply(): PlotSlowstochasticSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
