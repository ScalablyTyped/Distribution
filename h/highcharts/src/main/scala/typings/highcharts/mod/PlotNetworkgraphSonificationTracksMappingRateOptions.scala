...
trait PlotNetworkgraphSonificationTracksMappingRateOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
