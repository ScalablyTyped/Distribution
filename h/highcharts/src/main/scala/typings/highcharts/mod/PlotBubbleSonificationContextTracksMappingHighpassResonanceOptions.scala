...
trait PlotBubbleSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
