...
trait PlotTilemapSonificationTracksPointGroupingOptions extends StObject {
...
object PlotTilemapSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotTilemapSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTilemapSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
