...
trait PlotAreaSonificationTracksMappingRateOptions extends StObject {
...
object PlotAreaSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotAreaSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
