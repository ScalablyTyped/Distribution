...
trait PlotArearangeSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotArearangeSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotArearangeSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
