...
trait PlotSolidgaugeConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotSolidgaugeConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSolidgaugeConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSolidgaugeConnectorsStartMarkerOptions]
  }
}
