...
trait PlotFunnel3dSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
