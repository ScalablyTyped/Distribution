...
trait SeriesXrangeDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesXrangeDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesXrangeDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesXrangeDataDragDropDragHandleOptions]
  }
}
