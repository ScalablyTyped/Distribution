...
trait PlotParetoSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
