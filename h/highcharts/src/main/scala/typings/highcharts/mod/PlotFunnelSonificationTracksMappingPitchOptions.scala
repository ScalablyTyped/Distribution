...
trait PlotFunnelSonificationTracksMappingPitchOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
