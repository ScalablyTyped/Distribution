...
trait PlotHeikinashiSonificationTracksMappingPitchOptions extends StObject {
...
object PlotHeikinashiSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotHeikinashiSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeikinashiSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeikinashiSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
