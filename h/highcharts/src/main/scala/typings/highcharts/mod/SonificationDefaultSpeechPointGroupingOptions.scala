...
trait SonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object SonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): SonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
