...
trait SeriesPyramidDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesPyramidDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesPyramidDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesPyramidDataDragDropGuideBoxDefaultOptions]
  }
}
