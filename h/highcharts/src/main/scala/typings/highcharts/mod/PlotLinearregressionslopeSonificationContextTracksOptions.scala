...
trait PlotLinearregressionslopeSonificationContextTracksOptions extends StObject {
  ...
  var activeWhen: js.UndefOr[
    js.Object | js.Function | PlotLinearregressionslopeSonificationContextTracksActiveWhenOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[PlotLinearregressionslopeSonificationContextTracksMappingOptions] = js.undefined
  ...
  /**
    ...
    * tracks.
    */
  var pointGrouping: js.UndefOr[PlotLinearregressionslopeSonificationContextTracksPointGroupingOptions] = js.undefined
...
object PlotLinearregressionslopeSonificationContextTracksOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(
      value: js.Object | js.Function | PlotLinearregressionslopeSonificationContextTracksActiveWhenOptions
    ...
    inline def setMapping(value: PlotLinearregressionslopeSonificationContextTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotLinearregressionslopeSonificationContextTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
