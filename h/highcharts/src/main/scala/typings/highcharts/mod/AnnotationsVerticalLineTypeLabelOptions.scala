...
object AnnotationsVerticalLineTypeLabelOptions {
  ...
  @scala.inline
  def apply(): AnnotationsVerticalLineTypeLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsVerticalLineTypeLabelOptions]
  }
  
  @scala.inline
  implicit class AnnotationsVerticalLineTypeLabelOptionsMutableBuilder[Self <: AnnotationsVerticalLineTypeLabelOptions] (val x: Self) extends AnyVal {
