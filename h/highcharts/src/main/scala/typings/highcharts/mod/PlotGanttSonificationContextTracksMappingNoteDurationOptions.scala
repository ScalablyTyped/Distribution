...
trait PlotGanttSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotGanttSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
