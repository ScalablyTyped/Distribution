...
trait SeriesSolidgaugeDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesSolidgaugeDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesSolidgaugeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesSolidgaugeDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesSolidgaugeDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesSolidgaugeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesSolidgaugeDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesSolidgaugeDataDragDropOptions]
  }
}
