...
trait PlotBarTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotBarTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotBarTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotBarTooltipDateTimeLabelFormatsOptions]
  }
}
