...
trait PlotLinearregressionSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
