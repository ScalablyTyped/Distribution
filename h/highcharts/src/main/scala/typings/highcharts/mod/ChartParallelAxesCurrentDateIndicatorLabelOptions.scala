...
trait ChartParallelAxesCurrentDateIndicatorLabelOptions extends StObject {
...
object ChartParallelAxesCurrentDateIndicatorLabelOptions {
  
  inline def apply(): ChartParallelAxesCurrentDateIndicatorLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesCurrentDateIndicatorLabelOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartParallelAxesCurrentDateIndicatorLabelOptions] (val x: Self) extends AnyVal {
