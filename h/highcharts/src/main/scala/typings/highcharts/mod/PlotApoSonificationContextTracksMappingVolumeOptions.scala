...
trait PlotApoSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
