...
trait PlotLinearregressioninterceptSonificationTracksMappingRateOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
