...
trait PlotPcSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotPcSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotPcSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
