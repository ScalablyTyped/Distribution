...
trait PlotTreemapSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotTreemapSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
