...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesMapOptions
  extends StObject
     with PlotMapOptions {
...
object SeriesMapOptions {
  ...
  extension [Self <: SeriesMapOptions](x: Self) {
    ...
    inline def setDataVarargs(value: (Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMapDataOptions)*): Self = StObject.set(x, "data", js.Array(value :_*))
