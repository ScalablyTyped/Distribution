...
object PlotGaugeOptions {
  ...
  @scala.inline
  implicit class PlotGaugeOptionsOps[Self <: PlotGaugeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotGaugeAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotGaugeDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotGaugeDataLabelsOptions | js.Array[PlotGaugeDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDial(value: PlotGaugeDialOptions): Self = this.set("dial", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPivot(value: PlotGaugePivotOptions): Self = this.set("pivot", value.asInstanceOf[js.Any])
