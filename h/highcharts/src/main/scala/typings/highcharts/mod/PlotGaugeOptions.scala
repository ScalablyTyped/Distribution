...
trait PlotGaugeOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotGaugeAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var dataLabels: js.UndefOr[PlotGaugeDataLabelsOptions | js.Array[PlotGaugeDataLabelsOptions]] = js.native
  ...
  /**
    ...
    */
  var dial: js.UndefOr[PlotGaugeDialOptions] = js.native
  ...
  /**
    ...
    */
  var pivot: js.UndefOr[PlotGaugePivotOptions] = js.native
...
object PlotGaugeOptions {
  ...
  @scala.inline
  def apply(): PlotGaugeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeOptions]
  }
  
  @scala.inline
  implicit class PlotGaugeOptionsMutableBuilder[Self <: PlotGaugeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotGaugeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotGaugeDataLabelsOptions | js.Array[PlotGaugeDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotGaugeDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    ...
    @scala.inline
    def setDial(value: PlotGaugeDialOptions): Self = StObject.set(x, "dial", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPivot(value: PlotGaugePivotOptions): Self = StObject.set(x, "pivot", value.asInstanceOf[js.Any])
