...
trait PlotGaugeOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotGaugeSonificationOptions] = js.undefined
...
object PlotGaugeOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotGaugeOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotGaugeSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
