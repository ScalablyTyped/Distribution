...
trait ZAxisPlotBandsEventsOptions extends StObject {
...
object ZAxisPlotBandsEventsOptions {
  ...
  inline def apply(): ZAxisPlotBandsEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ZAxisPlotBandsEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ZAxisPlotBandsEventsOptions] (val x: Self) extends AnyVal {
