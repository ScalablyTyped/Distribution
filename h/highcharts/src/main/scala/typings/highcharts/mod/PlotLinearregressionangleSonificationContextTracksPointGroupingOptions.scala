...
trait PlotLinearregressionangleSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
