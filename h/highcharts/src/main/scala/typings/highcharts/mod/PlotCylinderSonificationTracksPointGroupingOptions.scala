...
trait PlotCylinderSonificationTracksPointGroupingOptions extends StObject {
...
object PlotCylinderSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotCylinderSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
