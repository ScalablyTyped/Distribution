...
trait PlotLinearregressionangleSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotLinearregressionangleSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
