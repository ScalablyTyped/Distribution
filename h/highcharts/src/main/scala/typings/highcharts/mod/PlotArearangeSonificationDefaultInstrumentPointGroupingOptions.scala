...
trait PlotArearangeSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotArearangeSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
