...
trait PlotEmaSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotEmaSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
