...
trait PlotMapSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotMapSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
