...
trait PlotNetworkgraphSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
