...
trait PlotFlowmapSonificationDefaultSpeechOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotFlowmapSonificationDefaultSpeechActiveWhenOptions] = js.undefined
  
  /**
    * (Highmaps) The language to speak in for speech tracks, as an IETF BCP 47
    * language tag.
    */
  var language: js.UndefOr[String] = js.undefined
  
  /**
    * (Highmaps) Mapping configuration for the speech/audio parameters.
    *
    ...
    */
  var mapping: js.UndefOr[PlotFlowmapSonificationDefaultSpeechMappingOptions] = js.undefined
  
  /**
    * (Highmaps) Options for point grouping, specifically for instrument
    * tracks.
    */
  var pointGrouping: js.UndefOr[PlotFlowmapSonificationDefaultSpeechPointGroupingOptions] = js.undefined
  
  /**
    * (Highmaps) Name of the voice synthesis to prefer for speech tracks.
    *
...
object PlotFlowmapSonificationDefaultSpeechOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultSpeechOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultSpeechOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultSpeechOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotFlowmapSonificationDefaultSpeechActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotFlowmapSonificationDefaultSpeechMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    
    inline def setMappingUndefined: Self = StObject.set(x, "mapping", js.undefined)
    
    inline def setPointGrouping(value: PlotFlowmapSonificationDefaultSpeechPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
