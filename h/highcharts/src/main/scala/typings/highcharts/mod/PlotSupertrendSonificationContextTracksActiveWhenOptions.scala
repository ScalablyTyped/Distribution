...
trait PlotSupertrendSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
