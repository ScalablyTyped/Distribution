...
trait PlotBubbleSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
