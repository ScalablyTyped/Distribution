...
trait PlotParetoSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotParetoSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
