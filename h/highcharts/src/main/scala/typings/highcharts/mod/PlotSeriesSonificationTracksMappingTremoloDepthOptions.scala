...
trait PlotSeriesSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
