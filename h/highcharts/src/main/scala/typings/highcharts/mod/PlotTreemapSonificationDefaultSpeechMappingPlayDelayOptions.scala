...
trait PlotTreemapSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotTreemapSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
