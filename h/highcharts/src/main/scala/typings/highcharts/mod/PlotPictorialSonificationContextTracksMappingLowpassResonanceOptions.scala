...
trait PlotPictorialSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPictorialSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
