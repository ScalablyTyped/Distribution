...
trait PlotHistogramSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotHistogramSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
