...
trait PlotWordcloudSonificationTracksActiveWhenOptions extends StObject {
...
object PlotWordcloudSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
