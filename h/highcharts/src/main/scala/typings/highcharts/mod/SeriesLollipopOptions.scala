...
object SeriesLollipopOptions {
  ...
  @scala.inline
  implicit class SeriesLollipopOptionsMutableBuilder[Self <: SeriesLollipopOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | lollipop): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
