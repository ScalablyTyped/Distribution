...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesLollipopOptions
  extends PlotLollipopOptions
  ...
  /**
    * Not available
    */
  var lowColor: js.UndefOr[scala.Nothing] = js.undefined
  /**
...
object SeriesLollipopOptions {
  ...
  def apply(
    ...
    dataSorting: DataSortingOptionsObject | PlotLollipopDataSortingOptions = null,
    ...
    lowColor: js.UndefOr[scala.Nothing] = js.undefined,
    ...
    if (!js.isUndefined(lowColor)) __obj.updateDynamic("lowColor")(lowColor.asInstanceOf[js.Any])
