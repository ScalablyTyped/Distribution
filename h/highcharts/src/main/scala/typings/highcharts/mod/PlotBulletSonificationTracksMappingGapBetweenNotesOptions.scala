...
trait PlotBulletSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotBulletSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
