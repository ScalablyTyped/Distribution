...
trait PlotPictorialSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotPictorialSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
