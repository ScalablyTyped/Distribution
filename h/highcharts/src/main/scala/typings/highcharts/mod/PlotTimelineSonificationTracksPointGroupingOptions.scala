...
trait PlotTimelineSonificationTracksPointGroupingOptions extends StObject {
...
object PlotTimelineSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotTimelineSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
