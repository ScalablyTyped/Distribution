...
trait PlotCciSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotCciSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotCciSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
