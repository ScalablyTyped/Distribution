...
trait PlotCmfSonificationTracksMappingTimeOptions extends StObject {
...
object PlotCmfSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotCmfSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmfSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
