...
trait PlotColumnrangeSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
