...
trait PlotDisparityindexSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
