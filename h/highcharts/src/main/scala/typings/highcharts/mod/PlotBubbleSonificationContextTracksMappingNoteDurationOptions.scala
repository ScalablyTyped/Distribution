...
trait PlotBubbleSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
