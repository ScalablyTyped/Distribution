...
trait PlotMappointSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotMappointSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotMappointSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
