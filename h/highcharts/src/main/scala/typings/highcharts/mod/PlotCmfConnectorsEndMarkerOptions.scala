...
trait PlotCmfConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotCmfConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCmfConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCmfConnectorsEndMarkerOptions]
  }
}
