...
trait SonificationGlobalTracksMappingPlayDelayOptions extends StObject {
...
object SonificationGlobalTracksMappingPlayDelayOptions {
  
  inline def apply(): SonificationGlobalTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
