...
trait PlotAreaSonificationTracksPointGroupingOptions extends StObject {
...
object PlotAreaSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotAreaSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
