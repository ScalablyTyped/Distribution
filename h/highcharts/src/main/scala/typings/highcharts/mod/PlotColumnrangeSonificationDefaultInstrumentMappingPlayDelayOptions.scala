...
trait PlotColumnrangeSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
