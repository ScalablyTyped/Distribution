...
trait PlotFunnel3dSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotFunnel3dSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
