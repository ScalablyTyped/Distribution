...
trait PlotParetoSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotParetoSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotParetoSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
