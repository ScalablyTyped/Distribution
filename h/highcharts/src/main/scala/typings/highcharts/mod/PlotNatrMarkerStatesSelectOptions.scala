...
trait PlotNatrMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotNatrMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNatrMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotNatrMarkerStatesSelectOptions]
  }
}
