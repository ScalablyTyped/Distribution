...
trait PlotBellcurveStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotBellcurveStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotBellcurveStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotBellcurveStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotBellcurveStatesSelectAnimationOptions = null,
  ...
  ): PlotBellcurveStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveStatesSelectOptions]
  }
}
