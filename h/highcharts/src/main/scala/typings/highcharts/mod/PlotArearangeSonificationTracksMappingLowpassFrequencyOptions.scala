...
trait PlotArearangeSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
