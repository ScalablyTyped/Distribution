...
trait PlotCandlestickSonificationPointGroupingOptions extends StObject {
...
object PlotCandlestickSonificationPointGroupingOptions {
  
  inline def apply(): PlotCandlestickSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
