...
trait PlotVbpSonificationTracksMappingPanOptions extends StObject {
...
object PlotVbpSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotVbpSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVbpSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
