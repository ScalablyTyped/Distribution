...
trait PlotEmaAccessibilityPointOptions extends StObject {
...
object PlotEmaAccessibilityPointOptions {
  
  inline def apply(): PlotEmaAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaAccessibilityPointOptions] (val x: Self) extends AnyVal {
