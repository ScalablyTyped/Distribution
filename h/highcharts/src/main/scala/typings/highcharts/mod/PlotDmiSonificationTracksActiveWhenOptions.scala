...
trait PlotDmiSonificationTracksActiveWhenOptions extends StObject {
...
object PlotDmiSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotDmiSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
