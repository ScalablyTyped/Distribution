...
trait PlotCciSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotCciSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotCciSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
