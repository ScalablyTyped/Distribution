...
trait PlotTreemapSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotTreemapSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
