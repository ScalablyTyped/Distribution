...
trait PlotDumbbellSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
