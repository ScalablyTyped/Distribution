...
trait PlotColumnrangeSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
