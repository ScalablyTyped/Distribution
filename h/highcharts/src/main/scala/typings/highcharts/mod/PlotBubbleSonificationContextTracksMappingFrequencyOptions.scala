...
trait PlotBubbleSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
