...
trait PlotBubbleSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
