...
trait PlotAoSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotAoSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotAoSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
