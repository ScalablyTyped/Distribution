...
trait PlotParetoSonificationTracksMappingRateOptions extends StObject {
...
object PlotParetoSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
