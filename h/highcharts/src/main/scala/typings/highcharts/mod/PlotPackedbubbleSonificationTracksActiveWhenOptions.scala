...
trait PlotPackedbubbleSonificationTracksActiveWhenOptions extends StObject {
...
object PlotPackedbubbleSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotPackedbubbleSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPackedbubbleSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
