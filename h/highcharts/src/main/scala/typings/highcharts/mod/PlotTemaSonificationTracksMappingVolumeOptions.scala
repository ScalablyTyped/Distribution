...
trait PlotTemaSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotTemaSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
