...
trait PlotPackedbubbleClusterEventsOptions extends StObject {
...
object PlotPackedbubbleClusterEventsOptions {
  
  inline def apply(): PlotPackedbubbleClusterEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleClusterEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPackedbubbleClusterEventsOptions] (val x: Self) extends AnyVal {
