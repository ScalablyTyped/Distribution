...
trait PlotXrangeDataSortingOptions extends StObject {
...
object PlotXrangeDataSortingOptions {
  
  inline def apply(): PlotXrangeDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeDataSortingOptions] (val x: Self) extends AnyVal {
