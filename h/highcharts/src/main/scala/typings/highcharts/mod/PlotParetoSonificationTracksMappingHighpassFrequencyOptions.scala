...
trait PlotParetoSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotParetoSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
