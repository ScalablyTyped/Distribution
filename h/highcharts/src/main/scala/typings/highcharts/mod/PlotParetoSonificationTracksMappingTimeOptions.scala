...
trait PlotParetoSonificationTracksMappingTimeOptions extends StObject {
...
object PlotParetoSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
