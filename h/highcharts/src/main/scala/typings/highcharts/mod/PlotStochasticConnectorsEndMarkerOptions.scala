...
trait PlotStochasticConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotStochasticConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStochasticConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticConnectorsEndMarkerOptions]
  }
}
