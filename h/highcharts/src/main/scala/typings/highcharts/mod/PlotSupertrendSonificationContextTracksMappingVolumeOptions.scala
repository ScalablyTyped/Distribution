...
trait PlotSupertrendSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
