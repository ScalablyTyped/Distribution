...
trait PlotLineSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotLineSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
