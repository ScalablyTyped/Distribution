...
import typings.highcharts.highchartsStrings.cmo
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesCmoOptions
  extends StObject
     with PlotCmoOptions {
...
object SeriesCmoOptions {
  ...
  inline def apply(`type`: String | cmo): SeriesCmoOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesCmoOptions] (val x: Self) extends AnyVal {
