...
trait PlotSupertrendSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
