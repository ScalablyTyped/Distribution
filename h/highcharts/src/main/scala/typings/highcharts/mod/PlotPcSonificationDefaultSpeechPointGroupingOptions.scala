...
trait PlotPcSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotPcSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotPcSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
