...
trait PlotMaplineOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotMaplineSonificationOptions] = js.undefined
...
object PlotMaplineOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotMaplineSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
