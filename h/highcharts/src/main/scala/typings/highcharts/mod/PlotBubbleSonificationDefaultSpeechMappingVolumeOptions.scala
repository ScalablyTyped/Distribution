...
trait PlotBubbleSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotBubbleSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
