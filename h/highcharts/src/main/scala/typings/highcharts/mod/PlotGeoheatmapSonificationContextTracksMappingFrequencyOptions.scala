...
trait PlotGeoheatmapSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
