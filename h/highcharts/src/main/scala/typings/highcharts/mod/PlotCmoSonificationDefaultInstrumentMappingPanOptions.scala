...
trait PlotCmoSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotCmoSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotCmoSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
