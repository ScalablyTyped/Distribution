...
trait PlotTrixSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
