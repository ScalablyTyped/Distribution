...
trait PlotEmaSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotEmaSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
