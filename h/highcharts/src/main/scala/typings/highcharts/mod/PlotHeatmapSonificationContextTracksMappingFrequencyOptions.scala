...
trait PlotHeatmapSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotHeatmapSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
