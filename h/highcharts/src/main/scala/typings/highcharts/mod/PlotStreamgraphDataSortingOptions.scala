...
@js.native
trait PlotStreamgraphDataSortingOptions extends js.Object {
  /**
...
object PlotStreamgraphDataSortingOptions {
  @scala.inline
  def apply(): PlotStreamgraphDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphDataSortingOptions]
  }
  @scala.inline
  implicit class PlotStreamgraphDataSortingOptionsOps[Self <: PlotStreamgraphDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
