...
trait PlotSankeyOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotSankeySonificationOptions] = js.undefined
...
object PlotSankeyOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeyOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotSankeySonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
