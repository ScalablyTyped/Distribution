...
trait PlotEmaSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotEmaSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotEmaSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
