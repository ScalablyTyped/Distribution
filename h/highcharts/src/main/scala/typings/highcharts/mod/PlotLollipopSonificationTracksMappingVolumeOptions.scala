...
trait PlotLollipopSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
