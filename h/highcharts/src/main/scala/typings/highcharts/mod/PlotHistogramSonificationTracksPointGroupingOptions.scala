...
trait PlotHistogramSonificationTracksPointGroupingOptions extends StObject {
...
object PlotHistogramSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotHistogramSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
