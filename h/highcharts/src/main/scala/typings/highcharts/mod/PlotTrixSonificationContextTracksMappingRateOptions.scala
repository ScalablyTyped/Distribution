...
trait PlotTrixSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
