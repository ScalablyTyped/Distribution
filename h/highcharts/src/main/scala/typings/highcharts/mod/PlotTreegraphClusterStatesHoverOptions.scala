...
trait PlotTreegraphClusterStatesHoverOptions extends StObject {
...
object PlotTreegraphClusterStatesHoverOptions {
  
  inline def apply(): PlotTreegraphClusterStatesHoverOptions = {
