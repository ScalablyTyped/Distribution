...
trait PlotBulletSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotBulletSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
