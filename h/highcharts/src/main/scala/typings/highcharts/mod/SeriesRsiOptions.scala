...
import typings.highcharts.highchartsStrings.rsi
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesRsiOptions extends PlotRsiOptions {
  /**
    * Not available
    */
...
object SeriesRsiOptions {
  ...
  def apply(
    ...
    dataLabels: PlotRsiDataLabelsOptions | js.Array[PlotRsiDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotRsiDataSortingOptions = null,
