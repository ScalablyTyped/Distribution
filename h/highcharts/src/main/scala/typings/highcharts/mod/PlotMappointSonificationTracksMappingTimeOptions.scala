...
trait PlotMappointSonificationTracksMappingTimeOptions extends StObject {
...
object PlotMappointSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
