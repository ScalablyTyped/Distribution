...
trait PlotWordcloudSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotWordcloudSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
