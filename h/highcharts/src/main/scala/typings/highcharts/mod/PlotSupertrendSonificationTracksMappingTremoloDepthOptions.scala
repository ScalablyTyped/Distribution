...
trait PlotSupertrendSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
