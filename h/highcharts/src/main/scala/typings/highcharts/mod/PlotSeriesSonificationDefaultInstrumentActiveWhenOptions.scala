...
trait PlotSeriesSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotSeriesSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
