...
trait PlotPackedbubbleClusterZonesOptions extends StObject {
...
object PlotPackedbubbleClusterZonesOptions {
  
  inline def apply(): PlotPackedbubbleClusterZonesOptions = {
