...
trait PlotBulletSonificationTracksMappingPitchOptions extends StObject {
...
object PlotBulletSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
