...
trait PlotWmaSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotWmaSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
