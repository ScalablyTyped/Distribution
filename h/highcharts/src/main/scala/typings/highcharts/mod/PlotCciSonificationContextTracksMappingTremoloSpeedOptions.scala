...
trait PlotCciSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotCciSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotCciSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
