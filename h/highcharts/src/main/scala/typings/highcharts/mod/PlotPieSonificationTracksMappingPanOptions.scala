...
trait PlotPieSonificationTracksMappingPanOptions extends StObject {
...
object PlotPieSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotPieSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
