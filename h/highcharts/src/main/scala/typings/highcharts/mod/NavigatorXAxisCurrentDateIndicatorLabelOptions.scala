...
object NavigatorXAxisCurrentDateIndicatorLabelOptions {
  ...
  @scala.inline
  def apply(): NavigatorXAxisCurrentDateIndicatorLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorXAxisCurrentDateIndicatorLabelOptions]
  }
  
  @scala.inline
  implicit class NavigatorXAxisCurrentDateIndicatorLabelOptionsMutableBuilder[Self <: NavigatorXAxisCurrentDateIndicatorLabelOptions] (val x: Self) extends AnyVal {
