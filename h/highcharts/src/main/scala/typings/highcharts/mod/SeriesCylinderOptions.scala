...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesCylinderOptions extends PlotCylinderOptions {
  /**
...
object SeriesCylinderOptions {
  ...
  def apply(
    ...
    dataLabels: PlotCylinderDataLabelsOptions | js.Array[PlotCylinderDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotCylinderDataSortingOptions = null,
