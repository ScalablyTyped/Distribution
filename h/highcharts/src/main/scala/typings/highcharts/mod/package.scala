...
package object mod {
  ...
  type AnnotationControlPointPositionerFunction = js.ThisFunction1[
    /* this */ typings.highcharts.mod.AnnotationControlPoint, 
    /* target */ typings.highcharts.mod.AnnotationControllable, 
  ...
  */
  ...
  type DataLabelsFormatterCallbackFunction = js.ThisFunction1[
    /* this */ typings.highcharts.mod.PointLabelObject, 
    /* options */ typings.highcharts.mod.DataLabelsOptions, 
  ...
  */
  ...
  type PointOptionsType = scala.Double | java.lang.String | typings.highcharts.mod.PointOptionsObject | (js.Array[scala.Double | java.lang.String | scala.Null]) | scala.Null
  ...
  type SVGPathArray = js.Array[
    js.Array[typings.highcharts.mod.SVGPathCommand] | (js.Tuple2[typings.highcharts.mod.SVGPathCommand, scala.Double]) | (js.Tuple3[typings.highcharts.mod.SVGPathCommand, scala.Double, scala.Double]) | (js.Tuple5[
  ...
  */
  ...
  type SeriesNetworkgraphDataLabelsFormatterCallbackFunction = js.ThisFunction0[
    /* this */ typings.highcharts.mod.PointLabelObject | typings.highcharts.mod.SeriesNetworkgraphDataLabelsFormatterContextObject, 
    java.lang.String
  ]
  ...
  @scala.inline
  def arrayMax(data: js.Array[_]): scala.Double = typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("arrayMax")(data.asInstanceOf[js.Any]).asInstanceOf[scala.Double]
  
  @scala.inline
  def arrayMin(data: js.Array[_]): scala.Double = typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("arrayMin")(data.asInstanceOf[js.Any]).asInstanceOf[scala.Double]
  ...
  @scala.inline
  def attr(elem: typings.highcharts.mod.HTMLDOMElement, prop: js.UndefOr[scala.Nothing], value: scala.Double): js.UndefOr[java.lang.String | scala.Null] = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("attr")(elem.asInstanceOf[js.Any], prop.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[java.lang.String | scala.Null]]
  @scala.inline
  ...
  @scala.inline
  def attr(elem: typings.highcharts.mod.SVGDOMElement, prop: js.UndefOr[scala.Nothing], value: scala.Double): js.UndefOr[java.lang.String | scala.Null] = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("attr")(elem.asInstanceOf[js.Any], prop.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[java.lang.String | scala.Null]]
  @scala.inline
  ...
  @scala.inline
  def each(arr: js.Array[_], fn: js.Function): scala.Unit = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("each")(arr.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  def each(arr: js.Array[_], fn: js.Function, ctx: js.Any): scala.Unit = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("each")(arr.asInstanceOf[js.Any], fn.asInstanceOf[js.Any], ctx.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  
  @scala.inline
  def erase(arr: js.Array[_], item: js.Any): scala.Unit = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("erase")(arr.asInstanceOf[js.Any], item.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  ...
  @scala.inline
  def error(code: java.lang.String, stop: js.UndefOr[scala.Nothing], chart: typings.highcharts.mod.Chart_): scala.Unit = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("error")(code.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  def error(
    code: java.lang.String,
    stop: js.UndefOr[scala.Nothing],
  ...
  @scala.inline
  def error(code: scala.Double, stop: js.UndefOr[scala.Nothing], chart: typings.highcharts.mod.Chart_): scala.Unit = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("error")(code.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  def error(
    code: scala.Double,
    stop: js.UndefOr[scala.Nothing],
  ...
  @scala.inline
  def extend[T](a: js.UndefOr[scala.Nothing], b: js.Object): T = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("extend")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[T]
  
  @scala.inline
  def extendClass[T](parent: typings.highcharts.mod.Class[T], members: typings.highcharts.mod.Dictionary[_]): typings.highcharts.mod.Class[T] = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("extendClass")(parent.asInstanceOf[js.Any], members.asInstanceOf[js.Any])).asInstanceOf[typings.highcharts.mod.Class[T]]
  ...
  @scala.inline
  def fireEvent[T](el: T, `type`: java.lang.String, eventArguments: typings.highcharts.mod.Dictionary[_]): scala.Unit = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("fireEvent")(el.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], eventArguments.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  def fireEvent[T](
    el: T,
    `type`: java.lang.String,
    eventArguments: typings.highcharts.mod.Dictionary[_],
    defaultFunction: js.Function
  ): scala.Unit = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("fireEvent")(el.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], eventArguments.asInstanceOf[js.Any], defaultFunction.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  def fireEvent[T](
  ...
  @scala.inline
  def format(str: java.lang.String, ctx: typings.std.Record[java.lang.String, _]): java.lang.String = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("format")(str.asInstanceOf[js.Any], ctx.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
  @scala.inline
  def format(
    str: java.lang.String,
    ctx: typings.std.Record[java.lang.String, _],
    chart: typings.highcharts.mod.Chart_
  ...
  @scala.inline
  def grep(arr: js.Array[_], callback: js.Function): js.Array[_] = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("grep")(arr.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[js.Array[_]]
  
  @scala.inline
  def inArray(item: js.Any, arr: js.Array[_]): scala.Double = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("inArray")(item.asInstanceOf[js.Any], arr.asInstanceOf[js.Any])).asInstanceOf[scala.Double]
  @scala.inline
  def inArray(item: js.Any, arr: js.Array[_], fromIndex: scala.Double): scala.Double = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("inArray")(item.asInstanceOf[js.Any], arr.asInstanceOf[js.Any], fromIndex.asInstanceOf[js.Any])).asInstanceOf[scala.Double]
  ...
  @scala.inline
  def map(arr: js.Array[_], fn: js.Function): js.Array[_] = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("map")(arr.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[js.Array[_]]
  ...
  @scala.inline
  def merge[T](a: js.UndefOr[scala.Nothing], n: js.UndefOr[js.Object]*): T = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("merge")(a.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[T]
  @scala.inline
  ...
  @scala.inline
  def merge[T](extend: scala.Boolean, a: js.UndefOr[scala.Nothing], n: js.UndefOr[js.Object]*): T = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("merge")(extend.asInstanceOf[js.Any], a.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  @scala.inline
  def normalizeTickInterval(interval: scala.Double, multiples: js.UndefOr[scala.Nothing], magnitude: scala.Double): scala.Double = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("normalizeTickInterval")(interval.asInstanceOf[js.Any], multiples.asInstanceOf[js.Any], magnitude.asInstanceOf[js.Any])).asInstanceOf[scala.Double]
  @scala.inline
  def normalizeTickInterval(
    interval: scala.Double,
    multiples: js.UndefOr[scala.Nothing],
  ...
  @scala.inline
  def normalizeTickInterval(interval: scala.Double, multiples: js.Array[_]): scala.Double = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("normalizeTickInterval")(interval.asInstanceOf[js.Any], multiples.asInstanceOf[js.Any])).asInstanceOf[scala.Double]
  @scala.inline
  def normalizeTickInterval(
    interval: scala.Double,
  ...
  @scala.inline
  def normalizeTickInterval(interval: scala.Double, multiples: js.Array[_], magnitude: scala.Double): scala.Double = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("normalizeTickInterval")(interval.asInstanceOf[js.Any], multiples.asInstanceOf[js.Any], magnitude.asInstanceOf[js.Any])).asInstanceOf[scala.Double]
  @scala.inline
  def normalizeTickInterval(
    interval: scala.Double,
    multiples: js.Array[_],
  ...
  @scala.inline
  def pad(number: scala.Double, length: js.UndefOr[scala.Nothing], padder: java.lang.String): java.lang.String = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("pad")(number.asInstanceOf[js.Any], length.asInstanceOf[js.Any], padder.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
  @scala.inline
  ...
  @scala.inline
  def reduce(arr: js.Array[_], fn: js.Function, initialValue: js.Any): js.Any = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("reduce")(arr.asInstanceOf[js.Any], fn.asInstanceOf[js.Any], initialValue.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  @scala.inline
  def removeEvent[T](el: T, `type`: js.UndefOr[scala.Nothing], fn: typings.highcharts.mod.EventCallbackFunction[T]): scala.Unit = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("removeEvent")(el.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  ...
  @scala.inline
  def seriesType(`type`: java.lang.String, parent: java.lang.String, options: typings.highcharts.mod.Dictionary[_]): typings.highcharts.mod.Series = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("seriesType")(`type`.asInstanceOf[js.Any], parent.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.highcharts.mod.Series]
  @scala.inline
  def seriesType(
    `type`: java.lang.String,
    parent: java.lang.String,
    options: typings.highcharts.mod.Dictionary[_],
    props: js.UndefOr[scala.Nothing],
    pointProps: typings.highcharts.mod.Dictionary[_]
  ...
  def seriesType(
    ...
    parent: java.lang.String,
    options: typings.highcharts.mod.Dictionary[_],
    props: typings.highcharts.mod.Dictionary[_]
  ...
  @scala.inline
  def setAnimation(animation: js.UndefOr[scala.Nothing], chart: typings.highcharts.mod.Chart_): scala.Unit = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("setAnimation")(animation.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
  ...
  @scala.inline
  def some(arr: js.Array[_], fn: js.Function, ctx: js.Any): scala.Boolean = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("some")(arr.asInstanceOf[js.Any], fn.asInstanceOf[js.Any], ctx.asInstanceOf[js.Any])).asInstanceOf[scala.Boolean]
  
  @scala.inline
  def splat(obj: js.Any): js.Array[_] = typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("splat")(obj.asInstanceOf[js.Any]).asInstanceOf[js.Array[_]]
  
  @scala.inline
  def stableSort(arr: js.Array[_], sortFunction: js.Function): scala.Unit = (typings.highcharts.mod.^.asInstanceOf[js.Dynamic].applyDynamic("stableSort")(arr.asInstanceOf[js.Any], sortFunction.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
