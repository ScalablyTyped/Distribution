...
trait ChartParallelAxesStackLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | ChartParallelAxesStackLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.undefined
...
object ChartParallelAxesStackLabelsOptions {
  
  inline def apply(): ChartParallelAxesStackLabelsOptions = {
  ...
  extension [Self <: ChartParallelAxesStackLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | ChartParallelAxesStackLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
