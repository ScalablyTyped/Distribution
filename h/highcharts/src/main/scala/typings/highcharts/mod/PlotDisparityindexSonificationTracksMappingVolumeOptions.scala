...
trait PlotDisparityindexSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
