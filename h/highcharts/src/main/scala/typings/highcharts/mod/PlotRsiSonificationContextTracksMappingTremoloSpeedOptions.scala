...
trait PlotRsiSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotRsiSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
