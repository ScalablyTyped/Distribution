...
trait PlotCylinderSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotCylinderSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
