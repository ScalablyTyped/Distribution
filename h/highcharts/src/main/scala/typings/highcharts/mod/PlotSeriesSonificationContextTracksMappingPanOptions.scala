...
trait PlotSeriesSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
