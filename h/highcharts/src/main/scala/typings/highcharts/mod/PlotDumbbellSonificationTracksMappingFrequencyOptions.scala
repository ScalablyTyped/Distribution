...
trait PlotDumbbellSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
