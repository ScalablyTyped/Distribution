...
trait PlotPpoSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPpoSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
