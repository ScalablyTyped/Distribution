...
trait PlotParetoOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotParetoSonificationOptions] = js.undefined
...
object PlotParetoOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotParetoSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
