...
object PlotParetoOptions {
  ...
  def apply(
    ...
    dataLabels: PlotParetoDataLabelsOptions | js.Array[PlotParetoDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotParetoDataSortingOptions = null,
