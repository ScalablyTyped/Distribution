...
trait PlotPackedbubbleAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPackedbubbleAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotPackedbubbleAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotPackedbubbleAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotPackedbubbleAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleAccessibilityOptions]
  }
}
