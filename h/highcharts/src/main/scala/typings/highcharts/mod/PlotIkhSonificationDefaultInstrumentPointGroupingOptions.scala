...
trait PlotIkhSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotIkhSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotIkhSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
