...
trait PlotStreamgraphSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
