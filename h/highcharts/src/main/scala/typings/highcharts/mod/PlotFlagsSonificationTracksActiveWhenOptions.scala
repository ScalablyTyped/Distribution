...
trait PlotFlagsSonificationTracksActiveWhenOptions extends StObject {
...
object PlotFlagsSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotFlagsSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
