...
trait PlotCandlestickSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
