...
trait PlotDependencywheelSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
