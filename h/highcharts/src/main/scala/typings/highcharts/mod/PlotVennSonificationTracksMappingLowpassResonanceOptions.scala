...
trait PlotVennSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotVennSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
