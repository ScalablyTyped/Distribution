...
trait PlotPieDataSortingOptions extends StObject {
...
object PlotPieDataSortingOptions {
  
  inline def apply(): PlotPieDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieDataSortingOptions] (val x: Self) extends AnyVal {
