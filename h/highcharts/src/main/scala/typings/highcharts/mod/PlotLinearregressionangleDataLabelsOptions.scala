...
@js.native
trait PlotLinearregressionangleDataLabelsOptions extends js.Object {
...
object PlotLinearregressionangleDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressionangleDataLabelsOptionsOps[Self <: PlotLinearregressionangleDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressionangleDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
