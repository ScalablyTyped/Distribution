...
@js.native
trait PlotLinearregressionangleDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotLinearregressionangleDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.native
...
object PlotLinearregressionangleDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotLinearregressionangleDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotLinearregressionangleDataLabelsOptionsMutableBuilder[Self <: PlotLinearregressionangleDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressionangleDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
