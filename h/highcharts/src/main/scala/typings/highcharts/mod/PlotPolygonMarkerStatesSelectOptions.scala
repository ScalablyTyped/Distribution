...
trait PlotPolygonMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPolygonMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPolygonMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonMarkerStatesSelectOptions]
  }
}
