...
trait PlotMappointSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotMappointSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotMappointSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
