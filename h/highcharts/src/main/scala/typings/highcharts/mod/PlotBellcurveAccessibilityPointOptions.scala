...
trait PlotBellcurveAccessibilityPointOptions extends StObject {
...
object PlotBellcurveAccessibilityPointOptions {
  
  inline def apply(): PlotBellcurveAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBellcurveAccessibilityPointOptions] (val x: Self) extends AnyVal {
