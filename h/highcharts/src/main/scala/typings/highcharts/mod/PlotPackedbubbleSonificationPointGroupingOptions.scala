...
trait PlotPackedbubbleSonificationPointGroupingOptions extends StObject {
...
object PlotPackedbubbleSonificationPointGroupingOptions {
  
  inline def apply(): PlotPackedbubbleSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPackedbubbleSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
