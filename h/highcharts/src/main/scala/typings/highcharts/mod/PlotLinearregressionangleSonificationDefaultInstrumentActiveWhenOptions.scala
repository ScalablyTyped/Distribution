...
trait PlotLinearregressionangleSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotLinearregressionangleSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
