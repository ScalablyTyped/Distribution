...
trait SonificationGlobalTracksMappingPanOptions extends StObject {
...
object SonificationGlobalTracksMappingPanOptions {
  
  inline def apply(): SonificationGlobalTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingPanOptions] (val x: Self) extends AnyVal {
