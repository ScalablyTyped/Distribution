...
trait PlotMomentumSonificationTracksMappingPitchOptions extends StObject {
...
object PlotMomentumSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotMomentumSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMomentumSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
