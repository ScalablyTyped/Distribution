...
trait PlotWilliamsrAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotWilliamsrAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotWilliamsrAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotWilliamsrAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotWilliamsrAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrAccessibilityOptions]
  }
}
