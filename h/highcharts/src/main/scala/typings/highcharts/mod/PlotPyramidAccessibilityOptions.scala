...
trait PlotPyramidAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotPyramidAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotPyramidAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotPyramidAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotPyramidAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotPyramidAccessibilityOptions]
  }
}
