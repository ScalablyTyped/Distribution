...
trait PlotVariwideOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotVariwideSonificationOptions] = js.undefined
...
object PlotVariwideOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotVariwideSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
