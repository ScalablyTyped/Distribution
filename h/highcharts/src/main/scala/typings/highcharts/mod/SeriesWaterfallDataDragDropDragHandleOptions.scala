...
trait SeriesWaterfallDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesWaterfallDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesWaterfallDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesWaterfallDataDragDropDragHandleOptions]
  }
}
