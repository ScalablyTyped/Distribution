...
trait PlotTrendlineSonificationTracksMappingPitchOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
