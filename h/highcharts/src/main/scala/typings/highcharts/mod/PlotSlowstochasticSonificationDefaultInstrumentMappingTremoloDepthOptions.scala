...
trait PlotSlowstochasticSonificationDefaultInstrumentMappingTremoloDepthOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultInstrumentMappingTremoloDepthOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultInstrumentMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultInstrumentMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultInstrumentMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
