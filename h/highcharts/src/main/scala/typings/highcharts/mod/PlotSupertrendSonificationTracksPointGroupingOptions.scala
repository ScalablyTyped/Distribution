...
trait PlotSupertrendSonificationTracksPointGroupingOptions extends StObject {
...
object PlotSupertrendSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
