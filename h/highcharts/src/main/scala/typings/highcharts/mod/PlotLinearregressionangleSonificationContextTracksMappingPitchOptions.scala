...
trait PlotLinearregressionangleSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
