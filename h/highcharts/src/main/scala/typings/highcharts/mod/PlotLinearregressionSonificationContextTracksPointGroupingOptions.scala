...
trait PlotLinearregressionSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
