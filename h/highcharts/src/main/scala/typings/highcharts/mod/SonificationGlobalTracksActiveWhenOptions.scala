...
trait SonificationGlobalTracksActiveWhenOptions extends StObject {
...
object SonificationGlobalTracksActiveWhenOptions {
  
  inline def apply(): SonificationGlobalTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksActiveWhenOptions] (val x: Self) extends AnyVal {
