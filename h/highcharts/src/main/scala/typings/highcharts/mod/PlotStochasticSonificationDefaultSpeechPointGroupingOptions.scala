...
trait PlotStochasticSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotStochasticSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
