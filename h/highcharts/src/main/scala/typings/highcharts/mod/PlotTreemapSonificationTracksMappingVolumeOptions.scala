...
trait PlotTreemapSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
