...
trait PlotPyramid3dSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
