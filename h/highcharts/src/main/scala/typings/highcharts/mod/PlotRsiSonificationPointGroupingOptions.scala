...
trait PlotRsiSonificationPointGroupingOptions extends StObject {
...
object PlotRsiSonificationPointGroupingOptions {
  
  inline def apply(): PlotRsiSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
