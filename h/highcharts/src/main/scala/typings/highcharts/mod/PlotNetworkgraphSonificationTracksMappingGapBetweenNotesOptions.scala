...
trait PlotNetworkgraphSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
