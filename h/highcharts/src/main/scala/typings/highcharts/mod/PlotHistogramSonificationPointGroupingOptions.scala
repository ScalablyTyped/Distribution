...
trait PlotHistogramSonificationPointGroupingOptions extends StObject {
...
object PlotHistogramSonificationPointGroupingOptions {
  
  inline def apply(): PlotHistogramSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
