...
trait PlotLinearregressionangleSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotLinearregressionangleSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
