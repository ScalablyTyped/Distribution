...
trait PlotSlowstochasticSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
