...
trait PlotArcdiagramSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
