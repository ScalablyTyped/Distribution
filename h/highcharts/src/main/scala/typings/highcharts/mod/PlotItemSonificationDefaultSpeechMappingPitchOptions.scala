...
trait PlotItemSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotItemSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotItemSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
