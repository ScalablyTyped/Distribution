...
trait PlotCciMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotCciMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCciMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotCciMarkerStatesHoverOptions]
  }
}
