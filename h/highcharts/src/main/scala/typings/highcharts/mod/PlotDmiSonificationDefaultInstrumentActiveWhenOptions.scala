...
trait PlotDmiSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotDmiSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotDmiSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
