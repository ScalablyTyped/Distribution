...
trait PlotAbandsSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotAbandsSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
