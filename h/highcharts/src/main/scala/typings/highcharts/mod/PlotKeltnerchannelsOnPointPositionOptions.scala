...
trait PlotKeltnerchannelsOnPointPositionOptions extends StObject {
...
object PlotKeltnerchannelsOnPointPositionOptions {
  
  inline def apply(): PlotKeltnerchannelsOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsOnPointPositionOptions] (val x: Self) extends AnyVal {
