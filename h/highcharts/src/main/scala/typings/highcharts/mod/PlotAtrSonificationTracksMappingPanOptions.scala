...
trait PlotAtrSonificationTracksMappingPanOptions extends StObject {
...
object PlotAtrSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
