...
trait PlotNatrSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotNatrSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotNatrSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
