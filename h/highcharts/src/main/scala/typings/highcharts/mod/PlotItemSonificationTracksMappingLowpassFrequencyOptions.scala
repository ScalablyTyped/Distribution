...
trait PlotItemSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotItemSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
