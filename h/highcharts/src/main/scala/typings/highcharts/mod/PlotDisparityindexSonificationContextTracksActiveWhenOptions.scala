...
trait PlotDisparityindexSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
