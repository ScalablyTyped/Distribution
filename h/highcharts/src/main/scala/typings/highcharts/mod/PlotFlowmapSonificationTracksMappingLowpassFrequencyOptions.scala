...
trait PlotFlowmapSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
