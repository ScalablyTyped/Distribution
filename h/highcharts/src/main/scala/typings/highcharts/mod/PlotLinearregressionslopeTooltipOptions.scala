...
trait PlotLinearregressionslopeTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotLinearregressionslopeTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotLinearregressionslopeTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    dateTimeLabelFormats: PlotLinearregressionslopeTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
  ...
  ): PlotLinearregressionslopeTooltipOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeTooltipOptions]
  }
}
