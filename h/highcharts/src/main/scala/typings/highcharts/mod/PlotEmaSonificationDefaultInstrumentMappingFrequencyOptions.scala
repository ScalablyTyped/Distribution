...
trait PlotEmaSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotEmaSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotEmaSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
