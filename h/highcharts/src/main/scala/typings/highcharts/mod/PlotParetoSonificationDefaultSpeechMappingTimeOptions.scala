...
trait PlotParetoSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotParetoSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotParetoSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
