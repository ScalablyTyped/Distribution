...
trait PlotNatrOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotNatrSonificationOptions] = js.undefined
...
object PlotNatrOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotNatrSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
