...
trait PlotDependencywheelSonificationDefaultSpeechPointGroupingOptions extends StObject {
  
  /**
    * (Highcharts) The grouping algorithm, deciding which points to keep when
  ...
  /**
    * (Highcharts) Whether or not to group points
    */
  var enabled: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Highcharts) The size of each group in milliseconds. Audio events closer
    * than this are grouped together.
    */
  var groupTimespan: js.UndefOr[Double] = js.undefined
  
  /**
    * (Highcharts) The data property for each point to compare when deciding
...
object PlotDependencywheelSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
