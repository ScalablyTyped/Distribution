...
trait PlotAbandsSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotAbandsSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
