...
trait PlotCmfDataGroupingOptions extends js.Object {
  /**
...
object PlotCmfDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotCmfDataGroupingOptions]
  }
}
