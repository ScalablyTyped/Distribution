...
trait PlotMappointSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotMappointSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
