...
object SeriesPyramidDataDragDropGuideBoxOptions {
  ...
  @scala.inline
  def apply(): SeriesPyramidDataDragDropGuideBoxOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPyramidDataDragDropGuideBoxOptions]
  }
  
  @scala.inline
  implicit class SeriesPyramidDataDragDropGuideBoxOptionsMutableBuilder[Self <: SeriesPyramidDataDragDropGuideBoxOptions] (val x: Self) extends AnyVal {
