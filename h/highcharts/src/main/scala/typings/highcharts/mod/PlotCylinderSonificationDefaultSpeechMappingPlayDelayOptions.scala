...
trait PlotCylinderSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotCylinderSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
