...
trait PlotDmiOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotDmiSonificationOptions] = js.undefined
...
object PlotDmiOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotDmiSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
