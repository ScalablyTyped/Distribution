...
trait PlotPolygonSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
