...
trait PlotParetoSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotParetoSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
