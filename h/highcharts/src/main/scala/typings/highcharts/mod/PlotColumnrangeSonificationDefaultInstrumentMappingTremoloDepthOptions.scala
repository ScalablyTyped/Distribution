...
trait PlotColumnrangeSonificationDefaultInstrumentMappingTremoloDepthOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultInstrumentMappingTremoloDepthOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultInstrumentMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultInstrumentMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultInstrumentMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
