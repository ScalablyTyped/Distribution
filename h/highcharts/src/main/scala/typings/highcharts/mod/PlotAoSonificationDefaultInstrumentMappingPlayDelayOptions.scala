...
trait PlotAoSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotAoSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotAoSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
