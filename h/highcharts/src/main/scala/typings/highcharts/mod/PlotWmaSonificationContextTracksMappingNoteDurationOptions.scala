...
trait PlotWmaSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotWmaSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
