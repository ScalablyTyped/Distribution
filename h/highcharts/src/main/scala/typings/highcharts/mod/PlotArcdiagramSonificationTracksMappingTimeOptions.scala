...
trait PlotArcdiagramSonificationTracksMappingTimeOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
