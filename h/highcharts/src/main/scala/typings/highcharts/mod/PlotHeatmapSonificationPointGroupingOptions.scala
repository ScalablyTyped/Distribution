...
trait PlotHeatmapSonificationPointGroupingOptions extends StObject {
...
object PlotHeatmapSonificationPointGroupingOptions {
  
  inline def apply(): PlotHeatmapSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
