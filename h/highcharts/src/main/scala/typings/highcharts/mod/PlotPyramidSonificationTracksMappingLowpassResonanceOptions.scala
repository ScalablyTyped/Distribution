...
trait PlotPyramidSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
