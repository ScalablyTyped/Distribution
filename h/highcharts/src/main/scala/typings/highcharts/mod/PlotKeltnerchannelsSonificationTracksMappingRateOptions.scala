...
trait PlotKeltnerchannelsSonificationTracksMappingRateOptions extends StObject {
...
object PlotKeltnerchannelsSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotKeltnerchannelsSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
