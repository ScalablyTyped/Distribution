...
trait PlotObvDataSortingOptions extends StObject {
...
object PlotObvDataSortingOptions {
  
  inline def apply(): PlotObvDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotObvDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotObvDataSortingOptions] (val x: Self) extends AnyVal {
