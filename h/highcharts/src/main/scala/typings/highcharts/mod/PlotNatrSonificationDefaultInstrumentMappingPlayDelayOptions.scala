...
trait PlotNatrSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotNatrSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotNatrSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
