...
trait PlotWindbarbSonificationDefaultSpeechMappingOptions extends StObject {
  ...
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotWindbarbSonificationDefaultSpeechMappingPitchOptions
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotWindbarbSonificationDefaultSpeechMappingPlayDelayOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var rate: js.UndefOr[
    Double | js.Object | String | js.Function | PlotWindbarbSonificationDefaultSpeechMappingRateOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotWindbarbSonificationDefaultSpeechMappingTimeOptions
  ] = js.undefined
  ...
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotWindbarbSonificationDefaultSpeechMappingVolumeOptions
  ] = js.undefined
}
object PlotWindbarbSonificationDefaultSpeechMappingOptions {
  
  inline def apply(): PlotWindbarbSonificationDefaultSpeechMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationDefaultSpeechMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationDefaultSpeechMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotWindbarbSonificationDefaultSpeechMappingPitchOptions
    ): Self = StObject.set(x, "pitch", value.asInstanceOf[js.Any])
    
    inline def setPitchUndefined: Self = StObject.set(x, "pitch", js.undefined)
    
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotWindbarbSonificationDefaultSpeechMappingPlayDelayOptions
    ...
    inline def setRate(
      value: Double | js.Object | String | js.Function | PlotWindbarbSonificationDefaultSpeechMappingRateOptions
    ...
    inline def setTime(
      value: Double | js.Object | String | js.Function | PlotWindbarbSonificationDefaultSpeechMappingTimeOptions
    ): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setVolume(
      value: Double | js.Object | String | js.Function | PlotWindbarbSonificationDefaultSpeechMappingVolumeOptions
