...
trait SeriesAreasplinerangeDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesAreasplinerangeDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesAreasplinerangeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesAreasplinerangeDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesAreasplinerangeDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesAreasplinerangeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[SeriesAreasplinerangeDataDragDropOptions]
  }
}
