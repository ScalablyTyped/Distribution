...
trait PlotDmiSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotDmiSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotDmiSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
