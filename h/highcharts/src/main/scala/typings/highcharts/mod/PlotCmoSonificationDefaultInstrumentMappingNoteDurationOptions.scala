...
trait PlotCmoSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotCmoSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotCmoSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
