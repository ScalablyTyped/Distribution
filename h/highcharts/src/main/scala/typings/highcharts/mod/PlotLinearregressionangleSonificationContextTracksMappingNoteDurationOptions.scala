...
trait PlotLinearregressionangleSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
