...
trait PlotDpoSonificationPointGroupingOptions extends StObject {
...
object PlotDpoSonificationPointGroupingOptions {
  
  inline def apply(): PlotDpoSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDpoSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
