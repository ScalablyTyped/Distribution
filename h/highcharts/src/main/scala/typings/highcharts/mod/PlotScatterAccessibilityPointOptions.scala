...
trait PlotScatterAccessibilityPointOptions extends StObject {
...
object PlotScatterAccessibilityPointOptions {
  
  inline def apply(): PlotScatterAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatterAccessibilityPointOptions] (val x: Self) extends AnyVal {
