...
trait PlotLinearregressioninterceptSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
