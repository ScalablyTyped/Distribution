...
trait PlotRocSonificationTracksMappingPitchOptions extends StObject {
...
object PlotRocSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotRocSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRocSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
