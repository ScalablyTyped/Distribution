...
trait PlotTiledwebmapDataSortingOptions extends StObject {
...
object PlotTiledwebmapDataSortingOptions {
  
  inline def apply(): PlotTiledwebmapDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTiledwebmapDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTiledwebmapDataSortingOptions] (val x: Self) extends AnyVal {
