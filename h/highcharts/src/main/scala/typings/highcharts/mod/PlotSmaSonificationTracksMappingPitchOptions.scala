...
trait PlotSmaSonificationTracksMappingPitchOptions extends StObject {
...
object PlotSmaSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
