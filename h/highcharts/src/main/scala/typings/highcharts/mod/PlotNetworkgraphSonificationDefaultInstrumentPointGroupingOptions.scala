...
trait PlotNetworkgraphSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
