...
trait PlotApoSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotApoSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
