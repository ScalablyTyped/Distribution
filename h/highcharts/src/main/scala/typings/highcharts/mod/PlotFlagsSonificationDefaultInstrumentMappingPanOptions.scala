...
trait PlotFlagsSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotFlagsSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
