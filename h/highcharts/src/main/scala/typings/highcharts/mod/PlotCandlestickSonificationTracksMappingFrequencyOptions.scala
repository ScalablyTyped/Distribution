...
trait PlotCandlestickSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
