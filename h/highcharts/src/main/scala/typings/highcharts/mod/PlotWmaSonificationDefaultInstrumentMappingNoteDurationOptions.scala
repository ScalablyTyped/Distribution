...
trait PlotWmaSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotWmaSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotWmaSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
