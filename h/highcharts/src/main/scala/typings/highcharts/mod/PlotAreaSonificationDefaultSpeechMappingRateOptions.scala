...
trait PlotAreaSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotAreaSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotAreaSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
