...
trait PlotApoSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotApoSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
