...
trait PlotCmoSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
