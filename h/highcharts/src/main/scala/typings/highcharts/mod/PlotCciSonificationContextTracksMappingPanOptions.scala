...
trait PlotCciSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotCciSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotCciSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
