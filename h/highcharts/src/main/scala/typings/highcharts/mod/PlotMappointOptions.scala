...
trait PlotMappointOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotMappointAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotMappointDataLabelsOptions | js.Array[PlotMappointDataLabelsOptions]] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotMappointOnPointOptions] = js.undefined
...
object PlotMappointOptions {
  ...
  inline def apply(): PlotMappointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointOptions]
  }
  
  extension [Self <: PlotMappointOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotMappointAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setCluster(value: PlotMappointClusterOptions): Self = StObject.set(x, "cluster", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotMappointDataLabelsOptions | js.Array[PlotMappointDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotMappointDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotMappointDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setJitter(value: PlotMappointJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotMappointOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
