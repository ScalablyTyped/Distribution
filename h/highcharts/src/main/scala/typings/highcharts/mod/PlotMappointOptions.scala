...
trait PlotMappointOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotMappointSonificationOptions] = js.undefined
...
object PlotMappointOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotMappointSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
