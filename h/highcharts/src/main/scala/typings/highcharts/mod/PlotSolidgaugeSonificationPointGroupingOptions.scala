...
trait PlotSolidgaugeSonificationPointGroupingOptions extends StObject {
...
object PlotSolidgaugeSonificationPointGroupingOptions {
  
  inline def apply(): PlotSolidgaugeSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSolidgaugeSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
