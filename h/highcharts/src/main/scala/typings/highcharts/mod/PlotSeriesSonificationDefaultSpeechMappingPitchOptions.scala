...
trait PlotSeriesSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotSeriesSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
