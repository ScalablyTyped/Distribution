...
trait PlotWilliamsrSonificationTracksMappingPitchOptions extends StObject {
...
object PlotWilliamsrSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotWilliamsrSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWilliamsrSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
