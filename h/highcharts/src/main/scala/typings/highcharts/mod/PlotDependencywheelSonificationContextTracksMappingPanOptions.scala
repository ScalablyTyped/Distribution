...
trait PlotDependencywheelSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
