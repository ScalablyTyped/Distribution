...
trait PlotNatrSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotNatrSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotNatrSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
