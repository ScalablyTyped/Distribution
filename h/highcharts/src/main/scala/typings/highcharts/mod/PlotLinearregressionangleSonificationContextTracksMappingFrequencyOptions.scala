...
trait PlotLinearregressionangleSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
