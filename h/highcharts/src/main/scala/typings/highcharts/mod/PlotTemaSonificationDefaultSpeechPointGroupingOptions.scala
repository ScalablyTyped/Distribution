...
trait PlotTemaSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotTemaSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotTemaSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
