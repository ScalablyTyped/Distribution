...
trait PlotBbSonificationTracksMappingPitchOptions extends StObject {
...
object PlotBbSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotBbSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBbSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
