...
trait PlotDmiSonificationTracksPointGroupingOptions extends StObject {
...
object PlotDmiSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotDmiSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
