...
trait PlotColumnpyramidSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
