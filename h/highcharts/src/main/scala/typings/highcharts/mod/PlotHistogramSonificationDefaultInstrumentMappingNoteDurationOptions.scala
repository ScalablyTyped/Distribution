...
trait PlotHistogramSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotHistogramSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
