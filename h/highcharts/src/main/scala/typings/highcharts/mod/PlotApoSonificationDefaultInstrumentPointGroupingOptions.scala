...
trait PlotApoSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotApoSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotApoSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
