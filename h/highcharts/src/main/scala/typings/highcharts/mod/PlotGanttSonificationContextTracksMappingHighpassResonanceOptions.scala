...
trait PlotGanttSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotGanttSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
