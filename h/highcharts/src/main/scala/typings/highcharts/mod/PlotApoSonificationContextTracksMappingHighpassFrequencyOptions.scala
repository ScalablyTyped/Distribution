...
trait PlotApoSonificationContextTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
