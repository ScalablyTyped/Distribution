...
trait SonificationGlobalTracksMappingHighpassResonanceOptions extends StObject {
...
object SonificationGlobalTracksMappingHighpassResonanceOptions {
  
  inline def apply(): SonificationGlobalTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
