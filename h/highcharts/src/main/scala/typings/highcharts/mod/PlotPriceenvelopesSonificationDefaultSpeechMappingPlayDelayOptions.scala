...
trait PlotPriceenvelopesSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
