...
trait ChartParallelAxesPlotBandsLabelOptions extends StObject {
...
object ChartParallelAxesPlotBandsLabelOptions {
  
  inline def apply(): ChartParallelAxesPlotBandsLabelOptions = {
