...
trait PlotAbandsSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotAbandsSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
