...
trait PlotBarSonificationPointGroupingOptions extends StObject {
...
object PlotBarSonificationPointGroupingOptions {
  
  inline def apply(): PlotBarSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
