...
trait PlotVariwideSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
