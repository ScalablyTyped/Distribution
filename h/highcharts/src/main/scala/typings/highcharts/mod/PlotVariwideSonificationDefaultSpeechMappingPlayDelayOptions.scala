...
trait PlotVariwideSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotVariwideSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
