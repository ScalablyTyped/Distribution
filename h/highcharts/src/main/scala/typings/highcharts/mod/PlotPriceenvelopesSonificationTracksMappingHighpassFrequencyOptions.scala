...
trait PlotPriceenvelopesSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
