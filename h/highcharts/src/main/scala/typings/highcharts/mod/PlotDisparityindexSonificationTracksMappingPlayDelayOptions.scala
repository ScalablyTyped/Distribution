...
trait PlotDisparityindexSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
