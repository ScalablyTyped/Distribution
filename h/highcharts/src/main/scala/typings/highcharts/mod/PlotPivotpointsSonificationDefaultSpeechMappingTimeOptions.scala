...
trait PlotPivotpointsSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
