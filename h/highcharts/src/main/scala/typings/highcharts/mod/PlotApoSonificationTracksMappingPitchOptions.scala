...
trait PlotApoSonificationTracksMappingPitchOptions extends StObject {
...
object PlotApoSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
