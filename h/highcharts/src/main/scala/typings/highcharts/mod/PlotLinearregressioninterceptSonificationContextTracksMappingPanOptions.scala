...
trait PlotLinearregressioninterceptSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
