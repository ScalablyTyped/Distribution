...
trait PlotVariwideSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotVariwideSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
