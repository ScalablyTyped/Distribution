...
trait PlotTreegraphAccessibilityPointOptions extends StObject {
...
object PlotTreegraphAccessibilityPointOptions {
  
  inline def apply(): PlotTreegraphAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphAccessibilityPointOptions] (val x: Self) extends AnyVal {
