...
trait PlotGaugeSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotGaugeSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotGaugeSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
