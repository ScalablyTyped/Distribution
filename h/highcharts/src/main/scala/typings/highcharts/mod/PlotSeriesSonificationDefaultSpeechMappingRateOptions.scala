...
trait PlotSeriesSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotSeriesSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
