...
trait PlotSeriesSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
