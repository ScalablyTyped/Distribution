...
trait PlotLinearregressionangleSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotLinearregressionangleSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
