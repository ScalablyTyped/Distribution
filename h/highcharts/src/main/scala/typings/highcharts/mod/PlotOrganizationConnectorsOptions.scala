...
trait PlotOrganizationConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotOrganizationConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotOrganizationConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotOrganizationConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotOrganizationConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotOrganizationConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotOrganizationConnectorsMarkerOptions = null,
    startMarker: PlotOrganizationConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotOrganizationConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotOrganizationConnectorsOptions]
  }
}
