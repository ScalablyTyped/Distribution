...
trait PlotPriceenvelopesSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
