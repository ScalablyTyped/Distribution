...
trait PlotAoStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAoStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAoStatesHoverHaloOptions] = js.undefined
  /**
...
object PlotAoStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAoStatesHoverAnimationOptions = null,
    borderColor: ColorString | GradientColorObject | PatternObject = null,
    borderWidth: Int | Double = null,
    brightness: Int | Double = null,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    halo: PlotAoStatesHoverHaloOptions = null,
    lineWidth: Int | Double = null,
    lineWidthPlus: Int | Double = null
  ): PlotAoStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAoStatesHoverOptions]
  }
}
