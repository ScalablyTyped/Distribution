...
trait PlotHeatmapSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotHeatmapSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
