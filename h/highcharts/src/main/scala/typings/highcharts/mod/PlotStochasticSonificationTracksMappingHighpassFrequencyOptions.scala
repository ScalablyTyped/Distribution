...
trait PlotStochasticSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
