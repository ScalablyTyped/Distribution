...
trait PlotGeoheatmapSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
