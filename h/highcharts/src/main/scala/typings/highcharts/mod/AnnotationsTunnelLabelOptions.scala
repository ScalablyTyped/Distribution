...
trait AnnotationsTunnelLabelOptions extends StObject {
...
object AnnotationsTunnelLabelOptions {
  
  @scala.inline
  def apply(): AnnotationsTunnelLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsTunnelLabelOptions]
  }
  
  @scala.inline
  implicit class AnnotationsTunnelLabelOptionsMutableBuilder[Self <: AnnotationsTunnelLabelOptions] (val x: Self) extends AnyVal {
