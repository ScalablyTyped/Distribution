...
@js.native
trait AnnotationsTunnelLabelOptions extends js.Object {
  /**
...
object AnnotationsTunnelLabelOptions {
  ...
  @scala.inline
  implicit class AnnotationsTunnelLabelOptionsOps[Self <: AnnotationsTunnelLabelOptions] (val x: Self) extends AnyVal {
    @scala.inline
