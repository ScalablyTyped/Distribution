...
trait PlotPsarSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotPsarSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotPsarSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
