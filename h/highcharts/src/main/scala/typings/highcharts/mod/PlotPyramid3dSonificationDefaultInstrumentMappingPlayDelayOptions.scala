...
trait PlotPyramid3dSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
