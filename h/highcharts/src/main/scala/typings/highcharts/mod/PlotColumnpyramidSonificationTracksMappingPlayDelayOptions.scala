...
trait PlotColumnpyramidSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
