...
trait PlotHeatmapSonificationDefaultInstrumentMappingHighpassFrequencyOptions extends StObject {
...
object PlotHeatmapSonificationDefaultInstrumentMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultInstrumentMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultInstrumentMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultInstrumentMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
