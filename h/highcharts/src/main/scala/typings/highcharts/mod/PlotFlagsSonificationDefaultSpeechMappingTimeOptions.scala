...
trait PlotFlagsSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotFlagsSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
