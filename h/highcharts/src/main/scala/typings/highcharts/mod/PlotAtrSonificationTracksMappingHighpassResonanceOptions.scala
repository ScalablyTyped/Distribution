...
trait PlotAtrSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotAtrSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
