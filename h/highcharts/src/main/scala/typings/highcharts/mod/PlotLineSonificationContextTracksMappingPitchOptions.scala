...
trait PlotLineSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotLineSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotLineSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
