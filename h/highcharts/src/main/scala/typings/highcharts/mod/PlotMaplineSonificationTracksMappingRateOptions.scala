...
trait PlotMaplineSonificationTracksMappingRateOptions extends StObject {
...
object PlotMaplineSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotMaplineSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
