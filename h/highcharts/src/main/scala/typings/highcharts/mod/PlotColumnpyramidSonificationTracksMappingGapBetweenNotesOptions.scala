...
trait PlotColumnpyramidSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
