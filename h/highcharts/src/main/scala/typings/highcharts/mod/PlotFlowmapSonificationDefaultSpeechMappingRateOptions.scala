...
trait PlotFlowmapSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotFlowmapSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
