...
@js.native
trait PlotVwapDataLabelsOptions extends js.Object {
...
object PlotVwapDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotVwapDataLabelsOptionsOps[Self <: PlotVwapDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVwapDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
