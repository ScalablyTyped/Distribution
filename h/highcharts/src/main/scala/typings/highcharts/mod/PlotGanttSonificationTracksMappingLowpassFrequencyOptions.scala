...
trait PlotGanttSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotGanttSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
