...
trait PlotPackedbubbleDataSortingOptions extends StObject {
...
object PlotPackedbubbleDataSortingOptions {
  
  inline def apply(): PlotPackedbubbleDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPackedbubbleDataSortingOptions] (val x: Self) extends AnyVal {
