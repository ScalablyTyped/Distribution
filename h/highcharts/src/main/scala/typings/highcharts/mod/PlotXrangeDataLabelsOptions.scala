...
object PlotXrangeDataLabelsOptions {
  ...
  inline def apply(): PlotXrangeDataLabelsOptions = {
  ...
  extension [Self <: PlotXrangeDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotXrangeDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
