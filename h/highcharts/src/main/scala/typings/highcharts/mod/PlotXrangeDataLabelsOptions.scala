...
@js.native
trait PlotXrangeDataLabelsOptions extends js.Object {
...
object PlotXrangeDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotXrangeDataLabelsOptionsOps[Self <: PlotXrangeDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotXrangeDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
