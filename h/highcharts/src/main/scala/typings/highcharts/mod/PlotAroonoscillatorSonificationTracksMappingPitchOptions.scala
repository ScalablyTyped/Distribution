...
trait PlotAroonoscillatorSonificationTracksMappingPitchOptions extends StObject {
...
object PlotAroonoscillatorSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotAroonoscillatorSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonoscillatorSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
