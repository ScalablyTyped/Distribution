...
trait PlotEmaSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotEmaSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotEmaSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
