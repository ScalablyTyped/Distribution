...
trait PlotFlowmapSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotFlowmapSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
