...
trait PlotBarSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotBarSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotBarSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
