...
trait PlotArcdiagramSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
