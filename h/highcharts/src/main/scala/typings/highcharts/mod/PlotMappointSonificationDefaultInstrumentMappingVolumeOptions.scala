...
trait PlotMappointSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotMappointSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotMappointSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
