...
import typings.highcharts.highchartsStrings.variwide
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesVariwideOptions extends PlotVariwideOptions {
  /**
...
object SeriesVariwideOptions {
  ...
  def apply(
    ...
    dataLabels: PlotVariwideDataLabelsOptions | js.Array[PlotVariwideDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotVariwideDataSortingOptions = null,
