...
trait SeriesDependencywheelDataDataLabelsAnimationOptions extends StObject {
...
object SeriesDependencywheelDataDataLabelsAnimationOptions {
  
  inline def apply(): SeriesDependencywheelDataDataLabelsAnimationOptions = {
