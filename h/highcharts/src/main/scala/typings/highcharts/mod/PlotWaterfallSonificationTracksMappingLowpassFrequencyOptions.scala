...
trait PlotWaterfallSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotWaterfallSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotWaterfallSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
