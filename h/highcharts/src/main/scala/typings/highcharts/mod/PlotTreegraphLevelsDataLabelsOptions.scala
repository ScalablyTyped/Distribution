...
trait PlotTreegraphLevelsDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotTreegraphLevelsDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.undefined
...
object PlotTreegraphLevelsDataLabelsOptions {
  
  inline def apply(): PlotTreegraphLevelsDataLabelsOptions = {
  ...
  implicit open class MutableBuilder[Self <: PlotTreegraphLevelsDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotTreegraphLevelsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
