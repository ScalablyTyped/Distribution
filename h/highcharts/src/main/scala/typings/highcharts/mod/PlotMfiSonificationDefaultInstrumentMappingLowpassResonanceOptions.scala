...
trait PlotMfiSonificationDefaultInstrumentMappingLowpassResonanceOptions extends StObject {
...
object PlotMfiSonificationDefaultInstrumentMappingLowpassResonanceOptions {
  
  inline def apply(): PlotMfiSonificationDefaultInstrumentMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiSonificationDefaultInstrumentMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMfiSonificationDefaultInstrumentMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
