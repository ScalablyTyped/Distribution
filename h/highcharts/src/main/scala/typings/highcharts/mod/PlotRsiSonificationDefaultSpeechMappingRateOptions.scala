...
trait PlotRsiSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotRsiSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotRsiSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
