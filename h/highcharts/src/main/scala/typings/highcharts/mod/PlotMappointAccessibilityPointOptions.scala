...
trait PlotMappointAccessibilityPointOptions extends StObject {
...
object PlotMappointAccessibilityPointOptions {
  
  inline def apply(): PlotMappointAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointAccessibilityPointOptions] (val x: Self) extends AnyVal {
