...
trait PlotTrixSonificationPointGroupingOptions extends StObject {
...
object PlotTrixSonificationPointGroupingOptions {
  
  inline def apply(): PlotTrixSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
