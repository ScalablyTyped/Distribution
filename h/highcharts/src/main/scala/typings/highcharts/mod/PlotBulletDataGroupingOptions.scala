...
trait PlotBulletDataGroupingOptions extends js.Object {
  /**
...
object PlotBulletDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotBulletDataGroupingOptions]
  }
}
