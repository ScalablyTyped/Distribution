...
trait PlotAreaSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotAreaSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotAreaSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
