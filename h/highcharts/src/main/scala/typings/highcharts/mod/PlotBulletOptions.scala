...
trait PlotBulletOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotBulletSonificationOptions] = js.undefined
...
object PlotBulletOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotBulletSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
