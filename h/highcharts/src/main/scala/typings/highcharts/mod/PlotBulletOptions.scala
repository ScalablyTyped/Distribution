...
trait PlotBulletOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotBulletAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotBulletOnPointOptions] = js.undefined
...
object PlotBulletOptions {
  ...
  inline def apply(): PlotBulletOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletOptions]
  }
  
  extension [Self <: PlotBulletOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotBulletAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotBulletDataLabelsOptions | js.Array[PlotBulletDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotBulletDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    ...
    inline def setOnPoint(value: js.Object | PlotBulletOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setTargetOptions(value: PlotBulletTargetOptions): Self = StObject.set(x, "targetOptions", value.asInstanceOf[js.Any])
