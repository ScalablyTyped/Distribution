...
trait PlotXrangeSonificationContextTracksMappingPitchOptions extends StObject {
  
  /**
    * (Highcharts, Highstock, Gantt) How to perform the mapping.
    */
  var mapFunction: js.UndefOr[OptionsMapFunctionValue] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) A point property to map the mapping
    * parameter to.
    *
  ...
  /**
    * (Highcharts, Highstock, Gantt) The maximum value for the audio parameter.
    * This is the highest value the audio parameter will be mapped to.
    */
  var max: js.UndefOr[String] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) The minimum value for the audio parameter.
    * This is the lowest value the audio parameter will be mapped to.
    */
  var min: js.UndefOr[String] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) Map pitches to a musical scale. The scale
    * is defined as an array of semitone offsets from the root note.
    */
  var scale: js.UndefOr[js.Array[Double]] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) A fixed value to use for the prop when
    * mapping.
    *
  ...
  /**
    * (Highcharts, Highstock, Gantt) What data values to map the parameter
    * within.
    *
...
object PlotXrangeSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
