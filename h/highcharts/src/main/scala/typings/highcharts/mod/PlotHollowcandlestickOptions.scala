...
trait PlotHollowcandlestickOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotHollowcandlestickSonificationOptions] = js.undefined
...
object PlotHollowcandlestickOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotHollowcandlestickSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
