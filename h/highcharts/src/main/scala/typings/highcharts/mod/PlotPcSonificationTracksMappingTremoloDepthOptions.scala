...
trait PlotPcSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPcSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
