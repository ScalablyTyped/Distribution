...
trait PlotParetoSonificationTracksMappingPanOptions extends StObject {
...
object PlotParetoSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
