...
trait PlotFlagsSonificationTracksMappingTimeOptions extends StObject {
...
object PlotFlagsSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotFlagsSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
