...
trait PlotNetworkgraphTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotNetworkgraphTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotNetworkgraphTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphTooltipDateTimeLabelFormatsOptions]
  }
}
