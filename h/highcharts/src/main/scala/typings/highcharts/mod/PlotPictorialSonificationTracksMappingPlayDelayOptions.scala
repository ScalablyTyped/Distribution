...
trait PlotPictorialSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
