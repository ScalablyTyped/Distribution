...
trait PlotPivotpointsSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
