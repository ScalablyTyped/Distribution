...
trait PlotZigzagSonificationTracksMappingOptions extends StObject {
  
  /**
    * (Highstock) Frequency in Hertz of notes. Overrides pitch mapping if set.
    */
  var frequency: js.UndefOr[
    Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingFrequencyOptions
  ] = js.undefined
  ...
  var gapBetweenNotes: js.UndefOr[
    Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingGapBetweenNotesOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var highpass: js.UndefOr[PlotZigzagSonificationTracksMappingHighpassOptions] = js.undefined
  ...
  /**
    ...
    */
  var lowpass: js.UndefOr[PlotZigzagSonificationTracksMappingLowpassOptions] = js.undefined
  ...
  var noteDuration: js.UndefOr[
    Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingNoteDurationOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var pan: js.UndefOr[
    Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingPanOptions
  ] = js.undefined
  ...
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingPitchOptions | (js.Array[String | Double])
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingPlayDelayOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var rate: js.UndefOr[
    Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingRateOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingTimeOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var tremolo: js.UndefOr[PlotZigzagSonificationTracksMappingTremoloOptions] = js.undefined
  
  /**
    * (Highstock) The volume of notes, from 0 to 1.
    */
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingVolumeOptions
  ] = js.undefined
}
object PlotZigzagSonificationTracksMappingOptions {
  
  inline def apply(): PlotZigzagSonificationTracksMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagSonificationTracksMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotZigzagSonificationTracksMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setFrequency(
      value: Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingFrequencyOptions
    ): Self = StObject.set(x, "frequency", value.asInstanceOf[js.Any])
    
    inline def setFrequencyUndefined: Self = StObject.set(x, "frequency", js.undefined)
    
    inline def setGapBetweenNotes(
      value: Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingGapBetweenNotesOptions
    ...
    inline def setHighpass(value: PlotZigzagSonificationTracksMappingHighpassOptions): Self = StObject.set(x, "highpass", value.asInstanceOf[js.Any])
    
    inline def setHighpassUndefined: Self = StObject.set(x, "highpass", js.undefined)
    
    inline def setLowpass(value: PlotZigzagSonificationTracksMappingLowpassOptions): Self = StObject.set(x, "lowpass", value.asInstanceOf[js.Any])
    
    inline def setLowpassUndefined: Self = StObject.set(x, "lowpass", js.undefined)
    
    inline def setNoteDuration(
      value: Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingNoteDurationOptions
    ...
    inline def setPan(value: Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingPanOptions): Self = StObject.set(x, "pan", value.asInstanceOf[js.Any])
    
    inline def setPanUndefined: Self = StObject.set(x, "pan", js.undefined)
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingPitchOptions | (js.Array[String | Double])
    ...
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingPlayDelayOptions
    ...
    inline def setRate(value: Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingRateOptions): Self = StObject.set(x, "rate", value.asInstanceOf[js.Any])
    ...
    inline def setTime(value: Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingTimeOptions): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setTremolo(value: PlotZigzagSonificationTracksMappingTremoloOptions): Self = StObject.set(x, "tremolo", value.asInstanceOf[js.Any])
    
    inline def setTremoloUndefined: Self = StObject.set(x, "tremolo", js.undefined)
    
    inline def setVolume(
      value: Double | js.Object | String | js.Function | PlotZigzagSonificationTracksMappingVolumeOptions
