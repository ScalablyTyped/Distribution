...
trait PlotDmiSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
