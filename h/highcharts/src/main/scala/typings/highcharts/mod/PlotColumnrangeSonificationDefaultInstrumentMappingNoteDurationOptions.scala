...
trait PlotColumnrangeSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
