...
trait PlotArearangeSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotArearangeSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotArearangeSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
