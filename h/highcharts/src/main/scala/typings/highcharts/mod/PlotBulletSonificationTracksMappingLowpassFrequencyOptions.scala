...
trait PlotBulletSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotBulletSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
