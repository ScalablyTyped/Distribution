...
trait PlotEmaSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotEmaSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
