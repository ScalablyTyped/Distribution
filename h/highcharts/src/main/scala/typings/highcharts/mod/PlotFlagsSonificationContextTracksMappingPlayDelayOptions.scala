...
trait PlotFlagsSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
