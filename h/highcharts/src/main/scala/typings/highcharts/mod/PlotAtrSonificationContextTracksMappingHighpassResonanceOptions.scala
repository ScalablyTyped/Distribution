...
trait PlotAtrSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
