...
trait PlotPyramid3dSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
