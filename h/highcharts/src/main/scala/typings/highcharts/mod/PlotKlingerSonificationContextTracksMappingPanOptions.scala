...
trait PlotKlingerSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotKlingerSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
