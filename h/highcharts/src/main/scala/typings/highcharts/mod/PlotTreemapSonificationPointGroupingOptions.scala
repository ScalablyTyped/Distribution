...
trait PlotTreemapSonificationPointGroupingOptions extends StObject {
...
object PlotTreemapSonificationPointGroupingOptions {
  
  inline def apply(): PlotTreemapSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
