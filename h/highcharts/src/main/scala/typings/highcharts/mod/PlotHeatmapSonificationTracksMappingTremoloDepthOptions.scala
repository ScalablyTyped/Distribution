...
trait PlotHeatmapSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
