...
trait PlotPyramidSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotPyramidSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
