...
trait PlotWmaSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotWmaSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
