...
trait PlotLinearregressioninterceptSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
