...
trait PlotPriceenvelopesSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
