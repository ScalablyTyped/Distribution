...
trait PlotRocDataSortingOptions extends StObject {
...
object PlotRocDataSortingOptions {
  
  @scala.inline
  def apply(): PlotRocDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotRocDataSortingOptionsMutableBuilder[Self <: PlotRocDataSortingOptions] (val x: Self) extends AnyVal {
