...
trait PlotApoSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
