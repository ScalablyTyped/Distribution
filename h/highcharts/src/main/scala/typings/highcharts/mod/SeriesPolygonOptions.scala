...
object SeriesPolygonOptions {
  ...
  @scala.inline
  implicit class SeriesPolygonOptionsOps[Self <: SeriesPolygonOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | polygon): Self = this.set("type", value.asInstanceOf[js.Any])
