...
trait PlotAdSonificationTracksMappingTimeOptions extends StObject {
...
object PlotAdSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotAdSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
