...
import typings.highcharts.highchartsStrings.obv
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesObvOptions
  extends StObject
     with PlotObvOptions {
...
object SeriesObvOptions {
  ...
  inline def apply(`type`: String | obv): SeriesObvOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesObvOptions] (val x: Self) extends AnyVal {
