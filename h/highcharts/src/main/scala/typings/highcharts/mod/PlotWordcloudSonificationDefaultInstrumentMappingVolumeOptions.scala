...
trait PlotWordcloudSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotWordcloudSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
