...
trait PlotHeatmapSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotHeatmapSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
