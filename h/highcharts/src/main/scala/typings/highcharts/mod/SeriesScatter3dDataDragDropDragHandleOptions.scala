...
trait SeriesScatter3dDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesScatter3dDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesScatter3dDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesScatter3dDataDragDropDragHandleOptions]
  }
}
