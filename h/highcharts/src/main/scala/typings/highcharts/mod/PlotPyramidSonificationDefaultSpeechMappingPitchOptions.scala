...
trait PlotPyramidSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotPyramidSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
