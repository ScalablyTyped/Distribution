...
trait PlotAbandsConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotAbandsConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAbandsConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsConnectorsStartMarkerOptions]
  }
}
