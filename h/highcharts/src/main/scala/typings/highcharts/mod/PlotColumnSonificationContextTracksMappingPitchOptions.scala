...
trait PlotColumnSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
