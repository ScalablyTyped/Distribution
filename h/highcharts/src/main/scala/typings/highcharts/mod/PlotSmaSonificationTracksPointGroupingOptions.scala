...
trait PlotSmaSonificationTracksPointGroupingOptions extends StObject {
...
object PlotSmaSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotSmaSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
