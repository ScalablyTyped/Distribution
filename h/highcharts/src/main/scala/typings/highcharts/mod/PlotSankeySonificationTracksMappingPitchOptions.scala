...
trait PlotSankeySonificationTracksMappingPitchOptions extends StObject {
...
object PlotSankeySonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotSankeySonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeySonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeySonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
