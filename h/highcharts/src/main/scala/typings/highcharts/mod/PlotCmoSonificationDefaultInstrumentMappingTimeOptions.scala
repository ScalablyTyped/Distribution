...
trait PlotCmoSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotCmoSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotCmoSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
