...
trait PlotHistogramSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotHistogramSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
