...
trait PlotPolygonSonificationPointGroupingOptions extends StObject {
...
object PlotPolygonSonificationPointGroupingOptions {
  
  inline def apply(): PlotPolygonSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
