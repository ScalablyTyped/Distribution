...
trait PlotTemaSonificationTracksMappingTimeOptions extends StObject {
...
object PlotTemaSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
