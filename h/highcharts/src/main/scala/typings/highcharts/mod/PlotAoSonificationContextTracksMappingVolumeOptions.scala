...
trait PlotAoSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotAoSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotAoSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
