...
trait PlotZigzagOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotZigzagAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotZigzagDataLabelsOptions | js.Array[PlotZigzagDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotZigzagDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotZigzagParamsOptions] = js.native
...
object PlotZigzagOptions {
  ...
  @scala.inline
  def apply(): PlotZigzagOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagOptions]
  }
  
  @scala.inline
  implicit class PlotZigzagOptionsMutableBuilder[Self <: PlotZigzagOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotZigzagAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotZigzagDataLabelsOptions | js.Array[PlotZigzagDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotZigzagDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotZigzagDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotZigzagParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
