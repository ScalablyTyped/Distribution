...
@js.native
trait PlotZigzagOptions extends js.Object {
...
object PlotZigzagOptions {
  ...
  @scala.inline
  implicit class PlotZigzagOptionsOps[Self <: PlotZigzagOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotZigzagAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotZigzagDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotZigzagDataLabelsOptions | js.Array[PlotZigzagDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotZigzagDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotZigzagParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
