...
object PlotZigzagOptions {
  ...
  def apply(
    ...
    dataLabels: PlotZigzagDataLabelsOptions | js.Array[PlotZigzagDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotZigzagDataSortingOptions = null,
