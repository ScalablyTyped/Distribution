...
trait PlotPivotpointsSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
