...
trait PlotSmaSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotSmaSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
