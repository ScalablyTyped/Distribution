...
@js.native
trait PlotAreasplinerangeDataSortingOptions extends js.Object {
...
object PlotAreasplinerangeDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotAreasplinerangeDataSortingOptionsOps[Self <: PlotAreasplinerangeDataSortingOptions] (val x: Self) extends AnyVal {
