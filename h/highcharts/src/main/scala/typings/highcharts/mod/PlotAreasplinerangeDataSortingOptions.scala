...
object PlotAreasplinerangeDataSortingOptions {
  ...
  inline def apply(): PlotAreasplinerangeDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplinerangeDataSortingOptions] (val x: Self) extends AnyVal {
