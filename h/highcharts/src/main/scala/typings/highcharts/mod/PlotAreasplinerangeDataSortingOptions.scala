...
trait PlotAreasplinerangeDataSortingOptions extends StObject {
...
object PlotAreasplinerangeDataSortingOptions {
  
  @scala.inline
  def apply(): PlotAreasplinerangeDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotAreasplinerangeDataSortingOptionsMutableBuilder[Self <: PlotAreasplinerangeDataSortingOptions] (val x: Self) extends AnyVal {
