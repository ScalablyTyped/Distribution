...
trait PlotTimelineSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
