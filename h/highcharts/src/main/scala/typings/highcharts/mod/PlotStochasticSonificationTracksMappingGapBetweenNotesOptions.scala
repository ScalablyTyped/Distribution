...
trait PlotStochasticSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
