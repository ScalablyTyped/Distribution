...
trait PlotNetworkgraphConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotNetworkgraphConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotNetworkgraphConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotNetworkgraphConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotNetworkgraphConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotNetworkgraphConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotNetworkgraphConnectorsMarkerOptions = null,
    startMarker: PlotNetworkgraphConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotNetworkgraphConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphConnectorsOptions]
  }
}
