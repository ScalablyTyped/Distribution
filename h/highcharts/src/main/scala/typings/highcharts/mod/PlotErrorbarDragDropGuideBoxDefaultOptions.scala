...
trait PlotErrorbarDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotErrorbarDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotErrorbarDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotErrorbarDragDropGuideBoxDefaultOptions]
  }
}
