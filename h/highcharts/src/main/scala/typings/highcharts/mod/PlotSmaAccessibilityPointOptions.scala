...
trait PlotSmaAccessibilityPointOptions extends StObject {
...
object PlotSmaAccessibilityPointOptions {
  
  inline def apply(): PlotSmaAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaAccessibilityPointOptions] (val x: Self) extends AnyVal {
