...
trait SonificationGlobalContextTracksPointGroupingOptions extends StObject {
...
object SonificationGlobalContextTracksPointGroupingOptions {
  
  inline def apply(): SonificationGlobalContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
