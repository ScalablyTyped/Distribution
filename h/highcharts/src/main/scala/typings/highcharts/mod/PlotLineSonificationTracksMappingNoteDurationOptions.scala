...
trait PlotLineSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotLineSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
