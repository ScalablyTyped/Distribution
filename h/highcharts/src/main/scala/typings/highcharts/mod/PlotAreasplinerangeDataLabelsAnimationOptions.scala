...
@js.native
trait PlotAreasplinerangeDataLabelsAnimationOptions extends js.Object {
...
object PlotAreasplinerangeDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotAreasplinerangeDataLabelsAnimationOptionsOps[Self <: PlotAreasplinerangeDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
