...
trait PlotCmoSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotCmoSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotCmoSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
