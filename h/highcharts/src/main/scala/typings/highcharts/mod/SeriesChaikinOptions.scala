...
object SeriesChaikinOptions {
  ...
  @scala.inline
  implicit class SeriesChaikinOptionsOps[Self <: SeriesChaikinOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | chaikin): Self = this.set("type", value.asInstanceOf[js.Any])
