...
import typings.highcharts.highchartsStrings.chaikin
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesChaikinOptions
  extends StObject
...
object SeriesChaikinOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | chaikin): SeriesChaikinOptions = {
  ...
  @scala.inline
  implicit class SeriesChaikinOptionsMutableBuilder[Self <: SeriesChaikinOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | chaikin): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
