...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesChaikinOptions extends PlotChaikinOptions {
  /**
    * Not available
    */
...
object SeriesChaikinOptions {
  ...
  def apply(
    ...
    dataLabels: PlotChaikinDataLabelsOptions | js.Array[PlotChaikinDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotChaikinDataSortingOptions = null,
