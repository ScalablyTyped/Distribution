...
trait PlotTreemapSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotTreemapSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
