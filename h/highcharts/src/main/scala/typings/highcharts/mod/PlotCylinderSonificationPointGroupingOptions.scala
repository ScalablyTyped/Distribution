...
trait PlotCylinderSonificationPointGroupingOptions extends StObject {
...
object PlotCylinderSonificationPointGroupingOptions {
  
  inline def apply(): PlotCylinderSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
