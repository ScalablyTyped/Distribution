...
trait PlotIkhSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotIkhSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
