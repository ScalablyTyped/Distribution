...
trait PlotFunnelSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
