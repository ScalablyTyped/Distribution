...
trait PlotStreamgraphAccessibilityPointOptions extends StObject {
...
object PlotStreamgraphAccessibilityPointOptions {
  
  inline def apply(): PlotStreamgraphAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphAccessibilityPointOptions] (val x: Self) extends AnyVal {
