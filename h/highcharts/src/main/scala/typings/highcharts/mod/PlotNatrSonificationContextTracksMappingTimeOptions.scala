...
trait PlotNatrSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
