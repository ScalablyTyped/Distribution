...
trait PlotTilemapSonificationTracksMappingPanOptions extends StObject {
...
object PlotTilemapSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotTilemapSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTilemapSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
