...
trait PlotCciSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotCciSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotCciSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
