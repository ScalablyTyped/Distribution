...
trait PlotLinearregressionSonificationTracksMappingPitchOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
