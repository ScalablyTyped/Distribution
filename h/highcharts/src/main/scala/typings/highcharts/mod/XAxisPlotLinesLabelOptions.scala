...
trait XAxisPlotLinesLabelOptions
  extends StObject
...
object XAxisPlotLinesLabelOptions {
  ...
  inline def apply(): XAxisPlotLinesLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisPlotLinesLabelOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: XAxisPlotLinesLabelOptions] (val x: Self) extends AnyVal {
