...
trait PlotDemaOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotDemaSonificationOptions] = js.undefined
...
object PlotDemaOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDemaOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotDemaSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
