...
trait PlotIkhSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotIkhSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
