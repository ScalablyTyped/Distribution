...
trait PlotColumnrangeConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotColumnrangeConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotColumnrangeConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotColumnrangeConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotColumnrangeConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotColumnrangeConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotColumnrangeConnectorsMarkerOptions = null,
    startMarker: PlotColumnrangeConnectorsStartMarkerOptions = null,
    ...
    __obj.asInstanceOf[PlotColumnrangeConnectorsOptions]
  }
}
