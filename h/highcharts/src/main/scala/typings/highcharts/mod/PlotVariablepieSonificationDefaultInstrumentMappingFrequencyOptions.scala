...
trait PlotVariablepieSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotVariablepieSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
