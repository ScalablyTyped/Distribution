...
trait PlotCandlestickSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
