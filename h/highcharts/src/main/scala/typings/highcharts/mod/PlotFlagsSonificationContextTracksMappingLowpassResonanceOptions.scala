...
trait PlotFlagsSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
