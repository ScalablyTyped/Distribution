...
trait PlotDependencywheelSonificationTracksMappingTimeOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
