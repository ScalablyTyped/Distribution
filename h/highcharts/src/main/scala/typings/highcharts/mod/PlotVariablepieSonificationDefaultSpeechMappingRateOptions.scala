...
trait PlotVariablepieSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotVariablepieSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
