...
trait PlotAoSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotAoSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotAoSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
