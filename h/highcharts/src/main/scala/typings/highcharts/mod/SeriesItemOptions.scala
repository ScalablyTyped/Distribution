...
import typings.highcharts.highchartsStrings.item
...
trait SeriesItemOptions extends PlotItemOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | item = js.native
...
object SeriesItemOptions {
  
  @scala.inline
  def apply(`type`: String | item): SeriesItemOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesItemOptions]
  }
  
  @scala.inline
  implicit class SeriesItemOptionsMutableBuilder[Self <: SeriesItemOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | PointOptionsObject]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    @scala.inline
    def setDataVarargs(value: (Double | (js.Tuple2[String, Double | Null]) | Null | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | item): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
