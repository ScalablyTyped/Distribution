...
object SeriesItemOptions {
  ...
  extension [Self <: SeriesItemOptions](x: Self) {
    ...
    inline def setDataVarargs(value: (Double | (js.Tuple2[String, Double | Null]) | Null | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value :_*))
