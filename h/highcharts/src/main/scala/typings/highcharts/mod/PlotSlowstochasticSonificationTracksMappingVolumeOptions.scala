...
trait PlotSlowstochasticSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
