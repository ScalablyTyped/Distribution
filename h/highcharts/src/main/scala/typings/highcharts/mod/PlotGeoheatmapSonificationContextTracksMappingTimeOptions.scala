...
trait PlotGeoheatmapSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
