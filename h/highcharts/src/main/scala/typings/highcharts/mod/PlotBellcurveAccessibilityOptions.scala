...
trait PlotBellcurveAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotBellcurveAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotBellcurveAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotBellcurveAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotBellcurveAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveAccessibilityOptions]
  }
}
