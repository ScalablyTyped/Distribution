...
trait PlotColumnpyramidAccessibilityPointOptions extends StObject {
...
object PlotColumnpyramidAccessibilityPointOptions {
  
  inline def apply(): PlotColumnpyramidAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidAccessibilityPointOptions] (val x: Self) extends AnyVal {
