...
trait PlotPpoSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotPpoSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotPpoSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
