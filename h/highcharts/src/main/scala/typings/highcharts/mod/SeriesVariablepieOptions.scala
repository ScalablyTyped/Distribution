...
object SeriesVariablepieOptions {
  ...
  @scala.inline
  implicit class SeriesVariablepieOptionsOps[Self <: SeriesVariablepieOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | variablepie): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
    def setDataVarargs(value: ((js.Tuple2[Double | String, Double]) | PointOptionsObject)*): Self = this.set("data", js.Array(value :_*))
    @scala.inline
    def setData(value: js.Array[(js.Tuple2[Double | String, Double]) | PointOptionsObject]): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
