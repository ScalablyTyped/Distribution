...
import typings.highcharts.highchartsStrings.variablepie
...
trait SeriesVariablepieOptions extends PlotVariablepieOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[(js.Tuple2[Double | String, Double]) | PointOptionsObject]] = js.native
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | variablepie = js.native
...
object SeriesVariablepieOptions {
  ...
  @scala.inline
  def apply(`type`: String | variablepie): SeriesVariablepieOptions = {
  ...
  @scala.inline
  implicit class SeriesVariablepieOptionsMutableBuilder[Self <: SeriesVariablepieOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: js.Array[(js.Tuple2[Double | String, Double]) | PointOptionsObject]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    @scala.inline
    def setDataVarargs(value: ((js.Tuple2[Double | String, Double]) | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | variablepie): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
