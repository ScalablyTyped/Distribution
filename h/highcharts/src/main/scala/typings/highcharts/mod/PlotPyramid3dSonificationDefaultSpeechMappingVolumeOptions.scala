...
trait PlotPyramid3dSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
