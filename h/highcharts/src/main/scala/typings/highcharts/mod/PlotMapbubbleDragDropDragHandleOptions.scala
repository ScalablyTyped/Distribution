...
trait PlotMapbubbleDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotMapbubbleDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapbubbleDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleDragDropDragHandleOptions]
  }
}
