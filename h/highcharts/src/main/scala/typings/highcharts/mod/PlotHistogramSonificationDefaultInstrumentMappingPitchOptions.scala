...
trait PlotHistogramSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotHistogramSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
