...
trait PlotPsarSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPsarSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
