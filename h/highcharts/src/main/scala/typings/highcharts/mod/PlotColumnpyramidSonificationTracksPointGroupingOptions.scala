...
trait PlotColumnpyramidSonificationTracksPointGroupingOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
