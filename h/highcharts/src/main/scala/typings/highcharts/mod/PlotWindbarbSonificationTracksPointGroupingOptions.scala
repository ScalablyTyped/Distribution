...
trait PlotWindbarbSonificationTracksPointGroupingOptions extends StObject {
...
object PlotWindbarbSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotWindbarbSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
