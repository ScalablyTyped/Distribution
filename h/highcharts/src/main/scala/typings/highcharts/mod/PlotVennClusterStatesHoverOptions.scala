...
@js.native
trait PlotVennClusterStatesHoverOptions extends js.Object {
...
object PlotVennClusterStatesHoverOptions {
  ...
  @scala.inline
  implicit class PlotVennClusterStatesHoverOptionsOps[Self <: PlotVennClusterStatesHoverOptions] (val x: Self) extends AnyVal {
