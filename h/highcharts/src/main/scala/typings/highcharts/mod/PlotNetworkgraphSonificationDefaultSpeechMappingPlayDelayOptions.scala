...
trait PlotNetworkgraphSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
