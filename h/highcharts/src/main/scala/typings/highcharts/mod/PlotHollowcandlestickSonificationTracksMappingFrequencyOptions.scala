...
trait PlotHollowcandlestickSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotHollowcandlestickSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
