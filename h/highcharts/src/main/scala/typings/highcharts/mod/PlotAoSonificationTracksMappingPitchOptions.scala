...
trait PlotAoSonificationTracksMappingPitchOptions extends StObject {
...
object PlotAoSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
