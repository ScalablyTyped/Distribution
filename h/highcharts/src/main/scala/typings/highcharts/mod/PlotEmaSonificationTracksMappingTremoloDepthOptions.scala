...
trait PlotEmaSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotEmaSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
