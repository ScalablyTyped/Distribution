...
trait PlotLinearregressionslopeSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
