...
trait PlotParetoSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotParetoSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
