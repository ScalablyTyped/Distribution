...
trait PlotDisparityindexSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
