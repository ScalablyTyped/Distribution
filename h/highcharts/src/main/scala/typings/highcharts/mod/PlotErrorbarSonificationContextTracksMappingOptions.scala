...
trait PlotErrorbarSonificationContextTracksMappingOptions extends StObject {
  
  /**
    * (Highcharts) Frequency in Hertz of notes. Overrides pitch mapping if set.
    */
  var frequency: js.UndefOr[
    Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingFrequencyOptions
  ] = js.undefined
  ...
  var gapBetweenNotes: js.UndefOr[
    Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingGapBetweenNotesOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var highpass: js.UndefOr[PlotErrorbarSonificationContextTracksMappingHighpassOptions] = js.undefined
  ...
  /**
    ...
    */
  var lowpass: js.UndefOr[PlotErrorbarSonificationContextTracksMappingLowpassOptions] = js.undefined
  ...
  var noteDuration: js.UndefOr[
    Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingNoteDurationOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var pan: js.UndefOr[
    Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingPanOptions
  ] = js.undefined
  ...
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingPitchOptions | (js.Array[String | Double])
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingPlayDelayOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var rate: js.UndefOr[
    Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingRateOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingTimeOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var tremolo: js.UndefOr[PlotErrorbarSonificationContextTracksMappingTremoloOptions] = js.undefined
  
  /**
    * (Highcharts) The volume of notes, from 0 to 1.
    */
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingVolumeOptions
  ] = js.undefined
}
object PlotErrorbarSonificationContextTracksMappingOptions {
  
  inline def apply(): PlotErrorbarSonificationContextTracksMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarSonificationContextTracksMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotErrorbarSonificationContextTracksMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setFrequency(
      value: Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingFrequencyOptions
    ): Self = StObject.set(x, "frequency", value.asInstanceOf[js.Any])
    
    inline def setFrequencyUndefined: Self = StObject.set(x, "frequency", js.undefined)
    
    inline def setGapBetweenNotes(
      value: Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingGapBetweenNotesOptions
    ...
    inline def setHighpass(value: PlotErrorbarSonificationContextTracksMappingHighpassOptions): Self = StObject.set(x, "highpass", value.asInstanceOf[js.Any])
    
    inline def setHighpassUndefined: Self = StObject.set(x, "highpass", js.undefined)
    
    inline def setLowpass(value: PlotErrorbarSonificationContextTracksMappingLowpassOptions): Self = StObject.set(x, "lowpass", value.asInstanceOf[js.Any])
    
    inline def setLowpassUndefined: Self = StObject.set(x, "lowpass", js.undefined)
    
    inline def setNoteDuration(
      value: Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingNoteDurationOptions
    ...
    inline def setPan(
      value: Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingPanOptions
    ): Self = StObject.set(x, "pan", value.asInstanceOf[js.Any])
    
    inline def setPanUndefined: Self = StObject.set(x, "pan", js.undefined)
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingPitchOptions | (js.Array[String | Double])
    ...
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingPlayDelayOptions
    ...
    inline def setRate(
      value: Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingRateOptions
    ...
    inline def setTime(
      value: Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingTimeOptions
    ): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setTremolo(value: PlotErrorbarSonificationContextTracksMappingTremoloOptions): Self = StObject.set(x, "tremolo", value.asInstanceOf[js.Any])
    
    inline def setTremoloUndefined: Self = StObject.set(x, "tremolo", js.undefined)
    
    inline def setVolume(
      value: Double | js.Object | String | js.Function | PlotErrorbarSonificationContextTracksMappingVolumeOptions
