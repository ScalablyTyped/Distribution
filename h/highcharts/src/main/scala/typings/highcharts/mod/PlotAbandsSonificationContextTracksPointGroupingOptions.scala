...
trait PlotAbandsSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotAbandsSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotAbandsSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
