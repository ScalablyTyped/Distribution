...
trait PlotBulletDataSortingOptions extends StObject {
...
object PlotBulletDataSortingOptions {
  
  inline def apply(): PlotBulletDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletDataSortingOptions] (val x: Self) extends AnyVal {
