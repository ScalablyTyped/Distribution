...
trait PlotGanttSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotGanttSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
