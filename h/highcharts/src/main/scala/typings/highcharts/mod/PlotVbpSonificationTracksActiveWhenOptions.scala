...
trait PlotVbpSonificationTracksActiveWhenOptions extends StObject {
...
object PlotVbpSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotVbpSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVbpSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
