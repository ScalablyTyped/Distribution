...
trait PlotTrendlineSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
