...
trait PlotHeatmapSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
