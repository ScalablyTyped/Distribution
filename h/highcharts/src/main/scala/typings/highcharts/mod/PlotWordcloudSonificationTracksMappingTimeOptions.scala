...
trait PlotWordcloudSonificationTracksMappingTimeOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
