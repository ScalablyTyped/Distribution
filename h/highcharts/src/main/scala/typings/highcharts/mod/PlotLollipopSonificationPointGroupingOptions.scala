...
trait PlotLollipopSonificationPointGroupingOptions extends StObject {
...
object PlotLollipopSonificationPointGroupingOptions {
  
  inline def apply(): PlotLollipopSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
