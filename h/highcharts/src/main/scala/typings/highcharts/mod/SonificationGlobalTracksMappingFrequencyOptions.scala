...
trait SonificationGlobalTracksMappingFrequencyOptions extends StObject {
...
object SonificationGlobalTracksMappingFrequencyOptions {
  
  inline def apply(): SonificationGlobalTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
