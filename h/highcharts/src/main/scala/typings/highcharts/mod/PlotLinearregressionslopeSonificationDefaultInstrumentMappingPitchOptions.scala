...
trait PlotLinearregressionslopeSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
