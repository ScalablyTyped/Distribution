...
trait PlotTrendlineSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotTrendlineSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
