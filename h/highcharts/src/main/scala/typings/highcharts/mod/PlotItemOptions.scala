...
trait PlotItemOptions extends StObject {
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotItemDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotItemOnPointOptions] = js.undefined
...
object PlotItemOptions {
  ...
  inline def apply(): PlotItemOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotItemDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotItemOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
