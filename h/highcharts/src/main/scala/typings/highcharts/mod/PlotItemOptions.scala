...
trait PlotItemOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotItemSonificationOptions] = js.undefined
...
object PlotItemOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotItemOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotItemSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
