...
trait PlotItemOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotItemAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotItemOptions {
  ...
  extension [Self <: PlotItemOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotItemAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
