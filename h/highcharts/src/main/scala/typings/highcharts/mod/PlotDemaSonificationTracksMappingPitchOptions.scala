...
trait PlotDemaSonificationTracksMappingPitchOptions extends StObject {
...
object PlotDemaSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotDemaSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDemaSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
