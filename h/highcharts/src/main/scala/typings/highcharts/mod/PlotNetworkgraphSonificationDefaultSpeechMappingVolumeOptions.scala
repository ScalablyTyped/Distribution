...
trait PlotNetworkgraphSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
