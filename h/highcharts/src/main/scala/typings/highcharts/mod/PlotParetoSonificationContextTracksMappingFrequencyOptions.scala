...
trait PlotParetoSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
