...
trait PlotWaterfallSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotWaterfallSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotWaterfallSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
