...
trait PlotPyramidSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
