...
trait PlotAroonSonificationTracksMappingRateOptions extends StObject {
...
object PlotAroonSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotAroonSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
