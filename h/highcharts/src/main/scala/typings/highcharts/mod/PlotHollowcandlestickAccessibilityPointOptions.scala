...
trait PlotHollowcandlestickAccessibilityPointOptions extends StObject {
...
object PlotHollowcandlestickAccessibilityPointOptions {
  
  inline def apply(): PlotHollowcandlestickAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickAccessibilityPointOptions] (val x: Self) extends AnyVal {
