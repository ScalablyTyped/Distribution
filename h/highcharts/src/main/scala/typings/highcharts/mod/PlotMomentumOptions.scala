...
trait PlotMomentumOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotMomentumAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotMomentumDataLabelsOptions | js.Array[PlotMomentumDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotMomentumDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotMomentumParamsOptions] = js.native
...
object PlotMomentumOptions {
  ...
  @scala.inline
  def apply(): PlotMomentumOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumOptions]
  }
  
  @scala.inline
  implicit class PlotMomentumOptionsMutableBuilder[Self <: PlotMomentumOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMomentumAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotMomentumDataLabelsOptions | js.Array[PlotMomentumDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotMomentumDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotMomentumDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotMomentumParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
