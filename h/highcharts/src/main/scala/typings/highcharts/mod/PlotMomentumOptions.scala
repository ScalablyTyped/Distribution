...
trait PlotMomentumOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotMomentumSonificationOptions] = js.undefined
...
object PlotMomentumOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMomentumOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotMomentumSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
