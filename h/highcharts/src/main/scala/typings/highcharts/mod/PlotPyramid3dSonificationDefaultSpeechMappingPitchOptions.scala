...
trait PlotPyramid3dSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
