...
trait PlotScatterSonificationTracksMappingPanOptions extends StObject {
...
object PlotScatterSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotScatterSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatterSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
