...
trait PlotPictorialSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
