...
trait PlotColumnSonificationTracksMappingRateOptions extends StObject {
...
object PlotColumnSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
