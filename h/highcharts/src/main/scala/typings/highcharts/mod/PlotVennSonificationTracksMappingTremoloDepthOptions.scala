...
trait PlotVennSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotVennSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
