...
trait PlotMfiMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMfiMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMfiMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMfiMarkerStatesSelectOptions]
  }
}
