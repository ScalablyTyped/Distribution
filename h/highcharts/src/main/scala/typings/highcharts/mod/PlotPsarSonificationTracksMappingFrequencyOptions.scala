...
trait PlotPsarSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotPsarSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
