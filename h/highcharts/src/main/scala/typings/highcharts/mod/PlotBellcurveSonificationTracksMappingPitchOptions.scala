...
trait PlotBellcurveSonificationTracksMappingPitchOptions extends StObject {
...
object PlotBellcurveSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotBellcurveSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBellcurveSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
