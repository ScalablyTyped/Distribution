...
trait PlotApoSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
