...
trait PlotBarSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotBarSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotBarSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
