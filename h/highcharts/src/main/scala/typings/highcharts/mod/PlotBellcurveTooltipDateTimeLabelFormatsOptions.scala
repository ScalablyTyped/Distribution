...
trait PlotBellcurveTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotBellcurveTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotBellcurveTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveTooltipDateTimeLabelFormatsOptions]
  }
}
