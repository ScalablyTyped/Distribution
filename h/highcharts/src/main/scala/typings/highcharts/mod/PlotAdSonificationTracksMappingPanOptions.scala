...
trait PlotAdSonificationTracksMappingPanOptions extends StObject {
...
object PlotAdSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotAdSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
