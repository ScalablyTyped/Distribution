...
trait PlotNetworkgraphSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
