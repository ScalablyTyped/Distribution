...
trait PlotColumnSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotColumnSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotColumnSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
