...
trait PlotBoxplotConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotBoxplotConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBoxplotConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBoxplotConnectorsMarkerOptions]
  }
}
