...
trait PlotBubbleSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
