...
trait PlotKlingerSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotKlingerSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
