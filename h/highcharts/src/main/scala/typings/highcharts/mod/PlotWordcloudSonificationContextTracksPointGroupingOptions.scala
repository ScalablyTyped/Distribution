...
trait PlotWordcloudSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
