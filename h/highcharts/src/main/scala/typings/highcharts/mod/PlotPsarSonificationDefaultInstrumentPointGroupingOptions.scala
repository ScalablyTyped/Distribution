...
trait PlotPsarSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotPsarSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotPsarSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
