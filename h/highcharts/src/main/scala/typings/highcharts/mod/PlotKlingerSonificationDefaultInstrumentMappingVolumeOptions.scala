...
trait PlotKlingerSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotKlingerSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
