...
@js.native
trait PlotAroonDataSortingOptions extends js.Object {
...
object PlotAroonDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotAroonDataSortingOptionsOps[Self <: PlotAroonDataSortingOptions] (val x: Self) extends AnyVal {
