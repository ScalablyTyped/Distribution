...
trait PlotAroonDataSortingOptions extends StObject {
...
object PlotAroonDataSortingOptions {
  
  @scala.inline
  def apply(): PlotAroonDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotAroonDataSortingOptionsMutableBuilder[Self <: PlotAroonDataSortingOptions] (val x: Self) extends AnyVal {
