...
trait PlotFlagsSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
