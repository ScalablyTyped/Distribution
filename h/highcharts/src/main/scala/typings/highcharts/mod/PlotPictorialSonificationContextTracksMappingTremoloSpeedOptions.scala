...
trait PlotPictorialSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPictorialSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
