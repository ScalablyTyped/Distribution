...
trait PlotSlowstochasticSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
