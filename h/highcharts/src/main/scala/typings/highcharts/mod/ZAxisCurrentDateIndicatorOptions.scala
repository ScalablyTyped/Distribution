...
trait ZAxisCurrentDateIndicatorOptions extends js.Object {
  ...
  /**
    ...
    */
  var events: js.UndefOr[ZAxisCurrentDateIndicatorEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[ZAxisCurrentDateIndicatorLabelOptions] = js.undefined
  /**
...
object ZAxisCurrentDateIndicatorOptions {
  ...
  def apply(
    ...
    events: ZAxisCurrentDateIndicatorEventsOptions = null,
    id: String = null,
    label: ZAxisCurrentDateIndicatorLabelOptions = null,
    width: Int | Double = null,
    zIndex: Int | Double = null
  ): ZAxisCurrentDateIndicatorOptions = {
