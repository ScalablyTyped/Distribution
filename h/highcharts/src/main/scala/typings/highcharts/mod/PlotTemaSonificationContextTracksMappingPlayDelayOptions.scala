...
trait PlotTemaSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
