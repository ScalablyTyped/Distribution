...
@js.native
trait PlotMomentumDataLabelsOptions extends js.Object {
...
object PlotMomentumDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotMomentumDataLabelsOptionsOps[Self <: PlotMomentumDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMomentumDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
