...
object PlotMomentumDataLabelsOptions {
  ...
  inline def apply(): PlotMomentumDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumDataLabelsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMomentumDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotMomentumDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
