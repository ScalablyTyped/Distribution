...
trait PlotPyramidSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
