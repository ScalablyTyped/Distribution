...
trait PlotWmaSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotWmaSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotWmaSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
