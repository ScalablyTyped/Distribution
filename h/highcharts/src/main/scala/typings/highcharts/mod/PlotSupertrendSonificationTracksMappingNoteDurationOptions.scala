...
trait PlotSupertrendSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
