...
trait PlotBbAccessibilityPointOptions extends StObject {
...
object PlotBbAccessibilityPointOptions {
  
  inline def apply(): PlotBbAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBbAccessibilityPointOptions] (val x: Self) extends AnyVal {
