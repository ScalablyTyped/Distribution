...
trait PlotVennSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotVennSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
