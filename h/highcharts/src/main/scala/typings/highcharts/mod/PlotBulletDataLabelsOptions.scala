...
object PlotBulletDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotBulletDataLabelsOptionsMutableBuilder[Self <: PlotBulletDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBulletDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
