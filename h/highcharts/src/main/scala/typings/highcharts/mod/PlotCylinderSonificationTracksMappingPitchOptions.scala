...
trait PlotCylinderSonificationTracksMappingPitchOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
