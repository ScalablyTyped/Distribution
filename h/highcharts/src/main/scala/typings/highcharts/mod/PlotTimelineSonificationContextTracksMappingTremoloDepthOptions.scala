...
trait PlotTimelineSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
