...
trait PlotColumnrangeTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotColumnrangeTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotColumnrangeTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotColumnrangeTooltipDateTimeLabelFormatsOptions]
  }
}
