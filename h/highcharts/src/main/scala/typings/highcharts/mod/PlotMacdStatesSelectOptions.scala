...
trait PlotMacdStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotMacdStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMacdStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotMacdStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotMacdStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotMacdStatesSelectOptions]
  }
}
