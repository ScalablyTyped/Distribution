...
trait PlotWordcloudSonificationTracksPointGroupingOptions extends StObject {
...
object PlotWordcloudSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
