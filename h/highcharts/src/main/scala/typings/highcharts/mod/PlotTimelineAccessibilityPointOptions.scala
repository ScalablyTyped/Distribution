...
trait PlotTimelineAccessibilityPointOptions extends StObject {
...
object PlotTimelineAccessibilityPointOptions {
  
  inline def apply(): PlotTimelineAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineAccessibilityPointOptions] (val x: Self) extends AnyVal {
