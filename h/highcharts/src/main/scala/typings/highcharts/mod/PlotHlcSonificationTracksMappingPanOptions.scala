...
trait PlotHlcSonificationTracksMappingPanOptions extends StObject {
...
object PlotHlcSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotHlcSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHlcSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
