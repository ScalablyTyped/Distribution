...
trait PlotTrixSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotTrixSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
