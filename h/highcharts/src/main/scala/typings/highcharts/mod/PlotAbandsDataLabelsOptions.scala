...
@js.native
trait PlotAbandsDataLabelsOptions extends js.Object {
...
object PlotAbandsDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotAbandsDataLabelsOptionsOps[Self <: PlotAbandsDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAbandsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
