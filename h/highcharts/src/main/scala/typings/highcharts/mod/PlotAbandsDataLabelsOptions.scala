...
trait PlotAbandsDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotAbandsDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotAbandsDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotAbandsDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotAbandsDataLabelsOptionsMutableBuilder[Self <: PlotAbandsDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAbandsDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
