...
trait PlotPsarSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotPsarSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotPsarSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
