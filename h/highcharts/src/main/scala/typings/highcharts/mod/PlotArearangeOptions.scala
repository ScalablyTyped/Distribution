...
trait PlotArearangeOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotArearangeSonificationOptions] = js.undefined
...
object PlotArearangeOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotArearangeSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
