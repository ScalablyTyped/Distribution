...
trait PlotArearangeOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Accessibility options for a series. Requires the
    * accessibility module.
    */
  var accessibility: js.UndefOr[js.Object | PlotArearangeAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotArearangeAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotArearangeConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotArearangeDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotArearangeDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotArearangeEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    * `area`.
    */
  var label: js.UndefOr[PlotArearangeLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotArearangeLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotArearangeLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotArearangeMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var point: js.UndefOr[PlotArearangePointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotArearangeStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotArearangeTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotArearangeZonesOptions]] = js.undefined
}

object PlotArearangeOptions {
  @scala.inline
  def apply(
    ...
    if (!js.isUndefined(trackByArea)) __obj.updateDynamic("trackByArea")(trackByArea.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[PlotArearangeOptions]
  }
}
