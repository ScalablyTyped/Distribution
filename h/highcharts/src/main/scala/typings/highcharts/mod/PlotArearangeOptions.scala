...
trait PlotArearangeOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotArearangeAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotArearangeDataSortingOptions] = js.undefined
...
object PlotArearangeOptions {
  ...
  @scala.inline
  implicit class PlotArearangeOptionsMutableBuilder[Self <: PlotArearangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotArearangeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotArearangeDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTrackByArea(value: Boolean): Self = StObject.set(x, "trackByArea", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTrackByAreaUndefined: Self = StObject.set(x, "trackByArea", js.undefined)
