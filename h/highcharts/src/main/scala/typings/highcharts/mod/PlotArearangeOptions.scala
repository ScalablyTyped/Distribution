...
trait PlotArearangeOptions extends js.Object {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotArearangeAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotArearangeDataSortingOptions] = js.native
...
object PlotArearangeOptions {
  ...
  @scala.inline
  def apply(): PlotArearangeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeOptions]
  }
  
  @scala.inline
  implicit class PlotArearangeOptionsOps[Self <: PlotArearangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotArearangeAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: SeriesAreaRangeDataLabelsOptionsObject*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: SeriesAreaRangeDataLabelsOptionsObject | js.Array[SeriesAreaRangeDataLabelsOptionsObject]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotArearangeDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
