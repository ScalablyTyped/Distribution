...
trait PlotArearangeOptions extends StObject {
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotArearangeOnPointOptions] = js.undefined
...
object PlotArearangeOptions {
  ...
  inline def apply(): PlotArearangeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeOptions]
  }
  
  extension [Self <: PlotArearangeOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotArearangeAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotArearangeDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotArearangeOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
