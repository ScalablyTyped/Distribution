...
@js.native
trait PlotScatter3dDataLabelsOptions extends js.Object {
...
object PlotScatter3dDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotScatter3dDataLabelsOptionsOps[Self <: PlotScatter3dDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotScatter3dDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
