...
object PlotScatter3dDataLabelsOptions {
  ...
  inline def apply(): PlotScatter3dDataLabelsOptions = {
  ...
  extension [Self <: PlotScatter3dDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotScatter3dDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
