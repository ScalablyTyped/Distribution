...
trait PlotPpoAccessibilityPointOptions extends StObject {
...
object PlotPpoAccessibilityPointOptions {
  
  inline def apply(): PlotPpoAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoAccessibilityPointOptions] (val x: Self) extends AnyVal {
