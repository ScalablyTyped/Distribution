...
trait PlotPsarSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotPsarSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotPsarSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
