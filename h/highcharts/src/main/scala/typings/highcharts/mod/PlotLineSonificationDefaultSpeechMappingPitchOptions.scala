...
trait PlotLineSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotLineSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotLineSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
