...
trait PlotSeriesSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
