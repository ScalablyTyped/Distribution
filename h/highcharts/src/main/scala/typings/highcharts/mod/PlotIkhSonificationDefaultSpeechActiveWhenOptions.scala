...
trait PlotIkhSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotIkhSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotIkhSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
