...
trait PlotVariwideSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotVariwideSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
