...
trait PlotSmaSonificationTracksMappingPanOptions extends StObject {
...
object PlotSmaSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
