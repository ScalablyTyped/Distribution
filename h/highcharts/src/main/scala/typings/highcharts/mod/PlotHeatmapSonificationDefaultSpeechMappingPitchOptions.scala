...
trait PlotHeatmapSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotHeatmapSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
