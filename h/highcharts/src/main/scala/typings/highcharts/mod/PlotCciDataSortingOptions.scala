...
@js.native
trait PlotCciDataSortingOptions extends StObject {
...
object PlotCciDataSortingOptions {
  
  @scala.inline
  def apply(): PlotCciDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotCciDataSortingOptionsMutableBuilder[Self <: PlotCciDataSortingOptions] (val x: Self) extends AnyVal {
