...
trait PlotSolidgaugeOptions extends StObject {
  ...
  /**
    ...
    */
  var dataLabels: js.UndefOr[PlotSolidgaugeDataLabelsOptions | js.Array[PlotSolidgaugeDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotSolidgaugeDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var dial: js.UndefOr[PlotSolidgaugeDialOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotSolidgaugeOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var pivot: js.UndefOr[PlotSolidgaugePivotOptions] = js.undefined
  ...
  /**
    * (Highcharts) Whether to draw rounded edges on the gauge.
    */
...
object PlotSolidgaugeOptions {
  ...
  inline def apply(): PlotSolidgaugeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSolidgaugeOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataLabels(value: PlotSolidgaugeDataLabelsOptions | js.Array[PlotSolidgaugeDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotSolidgaugeDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotSolidgaugeDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setDial(value: PlotSolidgaugeDialOptions): Self = StObject.set(x, "dial", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotSolidgaugeOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setPivot(value: PlotSolidgaugePivotOptions): Self = StObject.set(x, "pivot", value.asInstanceOf[js.Any])
