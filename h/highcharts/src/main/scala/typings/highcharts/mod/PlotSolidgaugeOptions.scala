...
trait PlotSolidgaugeOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotSolidgaugeSonificationOptions] = js.undefined
...
object PlotSolidgaugeOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotSolidgaugeOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotSolidgaugeSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
