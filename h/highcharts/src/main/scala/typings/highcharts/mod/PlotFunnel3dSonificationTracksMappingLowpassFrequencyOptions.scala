...
trait PlotFunnel3dSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotFunnel3dSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
