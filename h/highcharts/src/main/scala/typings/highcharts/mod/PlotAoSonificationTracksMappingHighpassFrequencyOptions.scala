...
trait PlotAoSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotAoSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
