...
trait PlotPsarSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotPsarSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotPsarSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
