...
trait PlotSunburstSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotSunburstSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotSunburstSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
