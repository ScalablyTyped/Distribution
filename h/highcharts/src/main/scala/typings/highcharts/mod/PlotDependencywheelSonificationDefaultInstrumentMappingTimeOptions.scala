...
trait PlotDependencywheelSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotDependencywheelSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
