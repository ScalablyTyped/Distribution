...
trait PlotErrorbarSonificationTracksActiveWhenOptions extends StObject {
...
object PlotErrorbarSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotErrorbarSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotErrorbarSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
