...
trait PlotCciSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotCciSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotCciSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
