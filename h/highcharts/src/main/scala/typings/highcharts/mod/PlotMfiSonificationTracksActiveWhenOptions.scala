...
trait PlotMfiSonificationTracksActiveWhenOptions extends StObject {
...
object PlotMfiSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotMfiSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMfiSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
