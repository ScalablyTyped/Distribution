...
trait PlotDmiSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
