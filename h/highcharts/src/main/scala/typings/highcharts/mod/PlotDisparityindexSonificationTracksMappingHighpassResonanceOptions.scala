...
trait PlotDisparityindexSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
