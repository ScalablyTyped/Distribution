...
trait PlotScatterSonificationTracksMappingRateOptions extends StObject {
...
object PlotScatterSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotScatterSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatterSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
