...
trait PlotItemSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotItemSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotItemSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
