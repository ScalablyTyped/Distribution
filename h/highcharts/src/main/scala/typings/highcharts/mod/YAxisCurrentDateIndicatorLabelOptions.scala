...
trait YAxisCurrentDateIndicatorLabelOptions extends StObject {
...
object YAxisCurrentDateIndicatorLabelOptions {
  
  inline def apply(): YAxisCurrentDateIndicatorLabelOptions = {
