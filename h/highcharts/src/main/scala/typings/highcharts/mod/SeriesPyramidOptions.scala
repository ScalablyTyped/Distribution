...
import typings.highcharts.highchartsStrings.pyramid
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesPyramidOptions
  extends StObject
...
object SeriesPyramidOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | pyramid): SeriesPyramidOptions = {
  ...
  @scala.inline
  implicit class SeriesPyramidOptionsMutableBuilder[Self <: SeriesPyramidOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | pyramid): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
