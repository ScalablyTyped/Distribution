...
trait PlotHollowcandlestickOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotHollowcandlestickOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotHollowcandlestickOnPointPositionOptions] = js.undefined
}
object PlotHollowcandlestickOnPointOptions {
  
  inline def apply(): PlotHollowcandlestickOnPointOptions = {
  ...
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickOnPointOptions] (val x: Self) extends AnyVal {
    ...
    inline def setPosition(value: js.Object | PlotHollowcandlestickOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
