...
trait PlotSolidgaugeSonificationTracksMappingRateOptions extends StObject {
...
object PlotSolidgaugeSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotSolidgaugeSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSolidgaugeSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
