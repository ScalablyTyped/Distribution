...
trait PlotStochasticSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotStochasticSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
