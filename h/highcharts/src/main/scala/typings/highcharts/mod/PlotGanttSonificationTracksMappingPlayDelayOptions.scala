...
trait PlotGanttSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotGanttSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
