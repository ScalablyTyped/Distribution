...
trait PlotNatrSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotNatrSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotNatrSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
