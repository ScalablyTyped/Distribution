...
trait PlotTilemapAccessibilityPointOptions extends StObject {
...
object PlotTilemapAccessibilityPointOptions {
  
  inline def apply(): PlotTilemapAccessibilityPointOptions = {
