...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesBellcurveOptions
  extends StObject
...
object SeriesBellcurveOptions {
  ...
  @scala.inline
  def apply(data: Unit, dataParser: Unit, dataURL: Unit, `type`: String | bellcurve): SeriesBellcurveOptions = {
