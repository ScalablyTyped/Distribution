...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesBellcurveOptions extends PlotBellcurveOptions {
  /**
...
object SeriesBellcurveOptions {
  ...
  def apply(
    ...
    dataLabels: PlotBellcurveDataLabelsOptions | js.Array[PlotBellcurveDataLabelsOptions] = null,
