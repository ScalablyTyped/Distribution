...
trait PlotArcdiagramSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
