...
trait PlotWmaSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotWmaSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotWmaSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
