...
trait PlotStochasticSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotStochasticSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
