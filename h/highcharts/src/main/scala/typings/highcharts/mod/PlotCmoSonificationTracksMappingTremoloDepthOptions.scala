...
trait PlotCmoSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotCmoSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
