...
trait SonificationGlobalContextTracksMappingGapBetweenNotesOptions extends StObject {
...
object SonificationGlobalContextTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
