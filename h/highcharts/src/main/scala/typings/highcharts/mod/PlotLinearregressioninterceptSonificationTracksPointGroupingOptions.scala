...
trait PlotLinearregressioninterceptSonificationTracksPointGroupingOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
