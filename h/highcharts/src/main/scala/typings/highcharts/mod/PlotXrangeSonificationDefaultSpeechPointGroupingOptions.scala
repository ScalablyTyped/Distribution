...
trait PlotXrangeSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotXrangeSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
