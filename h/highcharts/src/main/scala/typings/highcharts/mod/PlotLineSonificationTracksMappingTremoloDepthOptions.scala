...
trait PlotLineSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotLineSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
