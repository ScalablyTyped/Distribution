...
object SeriesRocOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | roc): SeriesRocOptions = {
  ...
  @scala.inline
  implicit class SeriesRocOptionsMutableBuilder[Self <: SeriesRocOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | roc): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
