...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesRocOptions
  extends StObject
     with PlotRocOptions {
...
object SeriesRocOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | roc): SeriesRocOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesRocOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | roc): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
