...
object SeriesRocOptions {
  ...
  @scala.inline
  implicit class SeriesRocOptionsOps[Self <: SeriesRocOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | roc): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
