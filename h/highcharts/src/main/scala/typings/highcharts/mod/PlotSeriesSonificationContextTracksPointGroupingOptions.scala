...
trait PlotSeriesSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotSeriesSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
