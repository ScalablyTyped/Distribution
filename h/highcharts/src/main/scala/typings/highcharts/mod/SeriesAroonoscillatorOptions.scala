...
import typings.highcharts.highchartsStrings.aroonoscillator
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesAroonoscillatorOptions
  extends StObject
...
object SeriesAroonoscillatorOptions {
  ...
  @scala.inline
  def apply(aroonDown: Unit, dataParser: Unit, dataURL: Unit, `type`: String | aroonoscillator): SeriesAroonoscillatorOptions = {
  ...
  @scala.inline
  implicit class SeriesAroonoscillatorOptionsMutableBuilder[Self <: SeriesAroonoscillatorOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAroonDown(value: Unit): Self = StObject.set(x, "aroonDown", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setType(value: String | aroonoscillator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
