...
trait SeriesAroonoscillatorOptions extends PlotAroonoscillatorOptions {
  
  /**
    * Not available
    */
  var aroonDown: js.UndefOr[scala.Nothing] = js.native
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | aroonoscillator = js.native
...
object SeriesAroonoscillatorOptions {
  ...
  @scala.inline
  def apply(`type`: String | aroonoscillator): SeriesAroonoscillatorOptions = {
