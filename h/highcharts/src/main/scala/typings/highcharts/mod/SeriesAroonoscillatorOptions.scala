...
object SeriesAroonoscillatorOptions {
  ...
  @scala.inline
  implicit class SeriesAroonoscillatorOptionsOps[Self <: SeriesAroonoscillatorOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | aroonoscillator): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
