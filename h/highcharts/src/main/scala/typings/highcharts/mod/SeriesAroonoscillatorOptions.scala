...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesAroonoscillatorOptions extends PlotAroonoscillatorOptions {
  /**
    * Not available
    */
...
object SeriesAroonoscillatorOptions {
  ...
  def apply(
    ...
    dataLabels: PlotAroonoscillatorDataLabelsOptions | js.Array[PlotAroonoscillatorDataLabelsOptions] = null,
