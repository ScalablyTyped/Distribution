...
trait PlotPolygonSonificationDefaultInstrumentMappingLowpassResonanceOptions extends StObject {
...
object PlotPolygonSonificationDefaultInstrumentMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultInstrumentMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultInstrumentMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultInstrumentMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
