...
trait PlotMacdSonificationPointGroupingOptions extends StObject {
...
object PlotMacdSonificationPointGroupingOptions {
  
  inline def apply(): PlotMacdSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMacdSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
