...
trait PlotAtrSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
