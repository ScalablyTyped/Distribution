...
trait PlotDumbbellSonificationTracksMappingPitchOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
