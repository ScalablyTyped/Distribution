...
trait PlotRsiSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotRsiSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotRsiSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
