...
trait PlotPriceenvelopesSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
