...
trait PlotPpoSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotPpoSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotPpoSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
