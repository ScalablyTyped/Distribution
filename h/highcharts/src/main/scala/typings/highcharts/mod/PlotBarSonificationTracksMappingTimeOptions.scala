...
trait PlotBarSonificationTracksMappingTimeOptions extends StObject {
...
object PlotBarSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
