...
trait PlotStreamgraphSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
