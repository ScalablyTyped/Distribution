...
trait PlotRsiSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotRsiSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotRsiSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
