...
trait PlotScatter3dSonificationTracksPointGroupingOptions extends StObject {
...
object PlotScatter3dSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotScatter3dSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatter3dSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
