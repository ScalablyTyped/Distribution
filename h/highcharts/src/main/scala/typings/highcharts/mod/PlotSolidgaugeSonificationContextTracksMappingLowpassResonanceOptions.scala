...
trait PlotSolidgaugeSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotSolidgaugeSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotSolidgaugeSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSolidgaugeSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
