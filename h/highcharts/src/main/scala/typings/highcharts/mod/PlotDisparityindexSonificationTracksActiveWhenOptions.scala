...
trait PlotDisparityindexSonificationTracksActiveWhenOptions extends StObject {
...
object PlotDisparityindexSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
