...
trait PlotStochasticSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
