...
trait PlotDisparityindexSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
