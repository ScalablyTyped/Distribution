...
trait PlotIkhDataSortingOptions extends StObject {
...
object PlotIkhDataSortingOptions {
  
  @scala.inline
  def apply(): PlotIkhDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotIkhDataSortingOptionsMutableBuilder[Self <: PlotIkhDataSortingOptions] (val x: Self) extends AnyVal {
