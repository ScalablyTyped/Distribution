...
trait PlotPolygonSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
