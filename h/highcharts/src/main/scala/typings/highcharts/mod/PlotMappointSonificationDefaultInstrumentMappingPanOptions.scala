...
trait PlotMappointSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotMappointSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotMappointSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
