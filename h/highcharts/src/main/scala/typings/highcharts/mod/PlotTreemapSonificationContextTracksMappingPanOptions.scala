...
trait PlotTreemapSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotTreemapSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
