...
trait PlotTimelineSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
