...
trait PlotEmaSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotEmaSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotEmaSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
