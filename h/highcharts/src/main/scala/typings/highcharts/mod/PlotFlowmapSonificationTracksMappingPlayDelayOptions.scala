...
trait PlotFlowmapSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
