...
trait PlotCylinderSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotCylinderSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
