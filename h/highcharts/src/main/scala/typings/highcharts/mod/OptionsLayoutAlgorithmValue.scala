...
/* Rewritten from type alias, can be one of: 
  - typings.highcharts.highchartsStrings.squarified
  - typings.highcharts.highchartsStrings.strip
  - typings.highcharts.highchartsStrings.stripes
  - typings.highcharts.highchartsStrings.sliceAndDice
*/
