...
trait PlotAoSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotAoSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotAoSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
