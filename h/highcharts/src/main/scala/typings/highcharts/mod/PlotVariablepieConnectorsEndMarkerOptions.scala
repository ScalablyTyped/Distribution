...
trait PlotVariablepieConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotVariablepieConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVariablepieConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepieConnectorsEndMarkerOptions]
  }
}
