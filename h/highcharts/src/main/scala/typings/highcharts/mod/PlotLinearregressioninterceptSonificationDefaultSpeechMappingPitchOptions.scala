...
trait PlotLinearregressioninterceptSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
