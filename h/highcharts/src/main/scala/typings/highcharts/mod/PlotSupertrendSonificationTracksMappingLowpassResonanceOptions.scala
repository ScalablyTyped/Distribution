...
trait PlotSupertrendSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
