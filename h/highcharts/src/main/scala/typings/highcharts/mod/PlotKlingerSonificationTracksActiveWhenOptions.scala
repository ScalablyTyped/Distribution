...
trait PlotKlingerSonificationTracksActiveWhenOptions extends StObject {
...
object PlotKlingerSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotKlingerSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
