...
trait PlotSlowstochasticSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
