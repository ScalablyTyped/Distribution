...
trait PlotStreamgraphSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
