...
trait PlotMappointSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotMappointSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
