...
trait PlotTemaMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotTemaMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTemaMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTemaMarkerStatesHoverOptions]
  }
}
