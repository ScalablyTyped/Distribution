...
trait PlotPyramidSonificationTracksMappingPanOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
