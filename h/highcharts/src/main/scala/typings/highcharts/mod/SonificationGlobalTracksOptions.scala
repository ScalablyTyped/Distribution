...
trait SonificationGlobalTracksOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | SonificationGlobalTracksActiveWhenOptions] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[SonificationGlobalTracksMappingOptions] = js.undefined
  ...
  /**
    ...
    */
  var pointGrouping: js.UndefOr[SonificationGlobalTracksPointGroupingOptions] = js.undefined
...
object SonificationGlobalTracksOptions {
  
  inline def apply(): SonificationGlobalTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | SonificationGlobalTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: SonificationGlobalTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: SonificationGlobalTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
