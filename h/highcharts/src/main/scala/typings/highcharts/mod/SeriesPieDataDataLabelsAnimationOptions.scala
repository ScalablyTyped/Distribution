...
@js.native
trait SeriesPieDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesPieDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesPieDataDataLabelsAnimationOptionsOps[Self <: SeriesPieDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
