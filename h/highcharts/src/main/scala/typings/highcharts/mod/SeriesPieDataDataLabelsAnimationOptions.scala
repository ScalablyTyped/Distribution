...
object SeriesPieDataDataLabelsAnimationOptions {
  ...
  inline def apply(): SeriesPieDataDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesPieDataDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesPieDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
