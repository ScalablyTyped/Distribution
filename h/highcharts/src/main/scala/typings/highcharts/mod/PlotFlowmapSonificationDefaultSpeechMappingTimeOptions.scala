...
trait PlotFlowmapSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotFlowmapSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
