...
trait PlotNatrSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotNatrSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotNatrSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
