...
trait PlotLinearregressionOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotLinearregressionOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotLinearregressionOnPointPositionOptions] = js.undefined
}
object PlotLinearregressionOnPointOptions {
  
  inline def apply(): PlotLinearregressionOnPointOptions = {
  ...
  extension [Self <: PlotLinearregressionOnPointOptions](x: Self) {
    ...
    inline def setPosition(value: js.Object | PlotLinearregressionOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
