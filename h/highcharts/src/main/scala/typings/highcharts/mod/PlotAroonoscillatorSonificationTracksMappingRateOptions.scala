...
trait PlotAroonoscillatorSonificationTracksMappingRateOptions extends StObject {
...
object PlotAroonoscillatorSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotAroonoscillatorSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonoscillatorSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
