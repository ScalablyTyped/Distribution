...
trait PlotLinearregressionslopeSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
