...
trait PlotCylinderSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
