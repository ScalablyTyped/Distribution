...
trait PlotTrixSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
