...
trait PlotPyramidAccessibilityPointOptions extends StObject {
...
object PlotPyramidAccessibilityPointOptions {
  
  inline def apply(): PlotPyramidAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidAccessibilityPointOptions] (val x: Self) extends AnyVal {
