...
trait PlotIkhSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotIkhSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
