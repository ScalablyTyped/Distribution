...
trait PlotNatrSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotNatrSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotNatrSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
