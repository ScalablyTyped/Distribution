...
trait PlotEmaSonificationPointGroupingOptions extends StObject {
...
object PlotEmaSonificationPointGroupingOptions {
  
  inline def apply(): PlotEmaSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
