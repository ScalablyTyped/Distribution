...
trait PlotLinearregressionSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
