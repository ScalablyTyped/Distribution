...
trait PlotParetoSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotParetoSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
