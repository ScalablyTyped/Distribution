...
trait PlotPolygonSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
