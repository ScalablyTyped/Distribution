...
trait PlotPcSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotPcSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
