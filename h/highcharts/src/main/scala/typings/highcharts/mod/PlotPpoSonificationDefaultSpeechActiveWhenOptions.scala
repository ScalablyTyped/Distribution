...
trait PlotPpoSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotPpoSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotPpoSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
