...
trait PlotLinearregressionslopeSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
