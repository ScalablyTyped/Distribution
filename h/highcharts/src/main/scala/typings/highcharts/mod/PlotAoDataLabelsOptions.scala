...
trait PlotAoDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotAoDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotAoDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotAoDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotAoDataLabelsOptionsMutableBuilder[Self <: PlotAoDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
