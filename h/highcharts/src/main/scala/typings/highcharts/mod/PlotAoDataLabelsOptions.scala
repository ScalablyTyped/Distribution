...
@js.native
trait PlotAoDataLabelsOptions extends js.Object {
...
object PlotAoDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotAoDataLabelsOptionsOps[Self <: PlotAoDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
