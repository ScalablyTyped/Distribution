...
trait PlotTimelineSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
