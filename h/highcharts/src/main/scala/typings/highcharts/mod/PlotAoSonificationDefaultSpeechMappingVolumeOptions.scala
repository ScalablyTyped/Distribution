...
trait PlotAoSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotAoSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotAoSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
