...
trait PlotNetworkgraphSonificationTracksMappingPanOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
