...
@js.native
trait PlotLinearregressionDataSortingOptions extends js.Object {
  /**
...
object PlotLinearregressionDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressionDataSortingOptionsOps[Self <: PlotLinearregressionDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
