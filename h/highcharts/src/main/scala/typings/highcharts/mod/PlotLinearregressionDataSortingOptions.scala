...
object PlotLinearregressionDataSortingOptions {
  ...
  inline def apply(): PlotLinearregressionDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionDataSortingOptions] (val x: Self) extends AnyVal {
