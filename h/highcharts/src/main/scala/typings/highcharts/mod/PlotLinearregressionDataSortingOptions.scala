...
trait PlotLinearregressionDataSortingOptions extends StObject {
...
object PlotLinearregressionDataSortingOptions {
  
  @scala.inline
  def apply(): PlotLinearregressionDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotLinearregressionDataSortingOptionsMutableBuilder[Self <: PlotLinearregressionDataSortingOptions] (val x: Self) extends AnyVal {
