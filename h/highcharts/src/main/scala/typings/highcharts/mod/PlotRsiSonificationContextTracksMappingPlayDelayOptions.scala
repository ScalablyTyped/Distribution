...
trait PlotRsiSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotRsiSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
