...
trait PlotPcSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotPcSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPcSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
