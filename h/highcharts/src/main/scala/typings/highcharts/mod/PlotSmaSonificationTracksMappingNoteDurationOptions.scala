...
trait PlotSmaSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotSmaSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
