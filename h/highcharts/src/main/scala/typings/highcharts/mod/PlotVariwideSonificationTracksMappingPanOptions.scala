...
trait PlotVariwideSonificationTracksMappingPanOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
