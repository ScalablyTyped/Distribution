...
trait PlotLinearregressioninterceptSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
