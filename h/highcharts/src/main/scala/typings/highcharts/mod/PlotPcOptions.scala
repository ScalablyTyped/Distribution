...
trait PlotPcOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotPcSonificationOptions] = js.undefined
...
object PlotPcOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotPcSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
