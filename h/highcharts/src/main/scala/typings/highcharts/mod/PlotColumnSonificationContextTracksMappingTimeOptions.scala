...
trait PlotColumnSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
