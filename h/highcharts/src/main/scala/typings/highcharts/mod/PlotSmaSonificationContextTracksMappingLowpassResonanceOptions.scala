...
trait PlotSmaSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotSmaSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
