...
trait PlotColumnpyramidSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
