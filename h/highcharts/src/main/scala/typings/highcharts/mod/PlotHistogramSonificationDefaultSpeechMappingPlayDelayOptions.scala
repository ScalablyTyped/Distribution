...
trait PlotHistogramSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotHistogramSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
