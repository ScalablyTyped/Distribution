...
trait PlotFunnelSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
