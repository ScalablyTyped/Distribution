...
trait PlotLineSonificationTracksMappingTimeOptions extends StObject {
...
object PlotLineSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
