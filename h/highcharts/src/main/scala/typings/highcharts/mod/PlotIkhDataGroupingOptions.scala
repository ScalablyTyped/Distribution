...
trait PlotIkhDataGroupingOptions extends js.Object {
  /**
...
object PlotIkhDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotIkhDataGroupingOptions]
  }
}
