...
trait PlotNetworkgraphSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
