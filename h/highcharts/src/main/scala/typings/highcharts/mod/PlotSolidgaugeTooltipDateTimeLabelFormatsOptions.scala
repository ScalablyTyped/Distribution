...
trait PlotSolidgaugeTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotSolidgaugeTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotSolidgaugeTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotSolidgaugeTooltipDateTimeLabelFormatsOptions]
  }
}
