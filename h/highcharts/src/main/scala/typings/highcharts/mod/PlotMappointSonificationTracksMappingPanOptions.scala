...
trait PlotMappointSonificationTracksMappingPanOptions extends StObject {
...
object PlotMappointSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
