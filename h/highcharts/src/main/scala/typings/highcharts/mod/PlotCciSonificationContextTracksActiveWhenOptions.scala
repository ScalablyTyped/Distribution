...
trait PlotCciSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotCciSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotCciSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
