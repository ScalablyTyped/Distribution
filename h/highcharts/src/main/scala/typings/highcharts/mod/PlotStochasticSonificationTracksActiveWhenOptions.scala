...
trait PlotStochasticSonificationTracksActiveWhenOptions extends StObject {
...
object PlotStochasticSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotStochasticSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
