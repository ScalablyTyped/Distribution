...
trait PlotGaugeSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
