...
trait PlotBarSonificationTracksPointGroupingOptions extends StObject {
...
object PlotBarSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotBarSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
