...
trait PlotCciSonificationTracksMappingTimeOptions extends StObject {
...
object PlotCciSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
