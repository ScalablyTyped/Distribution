...
trait PlotMaplineSonificationTracksPointGroupingOptions extends StObject {
...
object PlotMaplineSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotMaplineSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
