...
trait PlotFunnelSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotFunnelSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
