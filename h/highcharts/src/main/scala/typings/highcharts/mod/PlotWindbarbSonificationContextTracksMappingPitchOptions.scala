...
trait PlotWindbarbSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotWindbarbSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotWindbarbSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
