...
trait PlotEmaSonificationTracksMappingRateOptions extends StObject {
...
object PlotEmaSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
