...
trait PlotTrendlineSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
