...
trait PlotIkhPointEventsOptions extends js.Object {
  /**
...
object PlotIkhPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotIkhPointEventsOptions]
  }
}
