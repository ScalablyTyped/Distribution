...
trait PlotBubbleSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotBubbleSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotBubbleSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
