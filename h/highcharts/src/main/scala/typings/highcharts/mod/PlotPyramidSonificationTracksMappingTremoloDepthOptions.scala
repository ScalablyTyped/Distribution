...
trait PlotPyramidSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
