...
trait PlotFlowmapSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
