...
trait PlotKeltnerchannelsDataLabelsAnimationOptions extends StObject {
...
object PlotKeltnerchannelsDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
