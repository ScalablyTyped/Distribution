...
@js.native
trait PlotKeltnerchannelsDataLabelsAnimationOptions extends js.Object {
...
object PlotKeltnerchannelsDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotKeltnerchannelsDataLabelsAnimationOptionsOps[Self <: PlotKeltnerchannelsDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
