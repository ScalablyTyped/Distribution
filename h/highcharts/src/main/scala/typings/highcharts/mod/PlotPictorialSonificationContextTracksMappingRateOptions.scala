...
trait PlotPictorialSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotPictorialSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
