...
trait PlotItemSonificationTracksMappingTimeOptions extends StObject {
...
object PlotItemSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
