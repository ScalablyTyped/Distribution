...
trait PlotKeltnerchannelsDataSortingOptions extends StObject {
...
object PlotKeltnerchannelsDataSortingOptions {
  
  @scala.inline
  def apply(): PlotKeltnerchannelsDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotKeltnerchannelsDataSortingOptionsMutableBuilder[Self <: PlotKeltnerchannelsDataSortingOptions] (val x: Self) extends AnyVal {
