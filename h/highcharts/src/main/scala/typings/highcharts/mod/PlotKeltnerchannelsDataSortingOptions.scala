...
@js.native
trait PlotKeltnerchannelsDataSortingOptions extends js.Object {
...
object PlotKeltnerchannelsDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotKeltnerchannelsDataSortingOptionsOps[Self <: PlotKeltnerchannelsDataSortingOptions] (val x: Self) extends AnyVal {
