...
trait PlotArearangeSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotArearangeSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
