...
trait PlotLollipopSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
