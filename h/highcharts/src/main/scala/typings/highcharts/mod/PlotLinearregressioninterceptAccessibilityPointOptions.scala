...
trait PlotLinearregressioninterceptAccessibilityPointOptions extends StObject {
...
object PlotLinearregressioninterceptAccessibilityPointOptions {
  
  inline def apply(): PlotLinearregressioninterceptAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptAccessibilityPointOptions] (val x: Self) extends AnyVal {
