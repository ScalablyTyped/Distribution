...
trait PlotColumnSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
