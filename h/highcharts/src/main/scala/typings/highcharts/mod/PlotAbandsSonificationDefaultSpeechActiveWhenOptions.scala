...
trait PlotAbandsSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotAbandsSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
