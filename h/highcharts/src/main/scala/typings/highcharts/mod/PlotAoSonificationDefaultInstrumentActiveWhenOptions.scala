...
trait PlotAoSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotAoSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotAoSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
