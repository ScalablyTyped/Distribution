...
trait PlotTreemapSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
