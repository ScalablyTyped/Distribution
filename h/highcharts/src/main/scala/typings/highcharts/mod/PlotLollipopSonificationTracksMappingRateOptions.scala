...
trait PlotLollipopSonificationTracksMappingRateOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
