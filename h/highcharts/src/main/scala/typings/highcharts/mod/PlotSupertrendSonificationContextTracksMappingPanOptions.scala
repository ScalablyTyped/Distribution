...
trait PlotSupertrendSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
