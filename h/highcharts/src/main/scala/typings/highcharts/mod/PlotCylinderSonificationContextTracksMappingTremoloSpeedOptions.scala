...
trait PlotCylinderSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotCylinderSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
