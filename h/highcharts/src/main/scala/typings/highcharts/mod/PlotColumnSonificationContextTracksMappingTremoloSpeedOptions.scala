...
trait PlotColumnSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
