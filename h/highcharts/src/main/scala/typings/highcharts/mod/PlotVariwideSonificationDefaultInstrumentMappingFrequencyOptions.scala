...
trait PlotVariwideSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotVariwideSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
