...
trait PlotEmaSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotEmaSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotEmaSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
