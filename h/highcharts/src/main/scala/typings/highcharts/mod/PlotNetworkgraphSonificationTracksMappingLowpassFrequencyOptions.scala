...
trait PlotNetworkgraphSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
