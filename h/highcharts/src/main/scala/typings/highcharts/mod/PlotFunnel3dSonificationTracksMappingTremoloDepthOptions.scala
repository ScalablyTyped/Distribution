...
trait PlotFunnel3dSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotFunnel3dSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
