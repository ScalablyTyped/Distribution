...
trait ChartParallelAxesPlotLinesLabelOptions extends StObject {
...
object ChartParallelAxesPlotLinesLabelOptions {
  
  inline def apply(): ChartParallelAxesPlotLinesLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesPlotLinesLabelOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartParallelAxesPlotLinesLabelOptions] (val x: Self) extends AnyVal {
