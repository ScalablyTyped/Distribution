...
trait PlotDependencywheelSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
