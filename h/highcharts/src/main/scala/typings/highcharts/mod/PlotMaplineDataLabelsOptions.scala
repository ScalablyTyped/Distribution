...
@js.native
trait PlotMaplineDataLabelsOptions extends js.Object {
...
object PlotMaplineDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotMaplineDataLabelsOptionsOps[Self <: PlotMaplineDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMaplineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
