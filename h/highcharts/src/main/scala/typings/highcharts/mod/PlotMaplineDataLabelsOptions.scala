...
object PlotMaplineDataLabelsOptions {
  ...
  inline def apply(): PlotMaplineDataLabelsOptions = {
  ...
  extension [Self <: PlotMaplineDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotMaplineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
