...
trait PlotCandlestickSonificationTracksMappingRateOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
