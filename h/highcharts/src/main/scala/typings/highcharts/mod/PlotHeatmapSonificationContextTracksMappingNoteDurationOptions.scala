...
trait PlotHeatmapSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotHeatmapSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
