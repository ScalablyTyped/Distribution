...
trait PlotColumnpyramidSonificationPointGroupingOptions extends StObject {
...
object PlotColumnpyramidSonificationPointGroupingOptions {
  
  inline def apply(): PlotColumnpyramidSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
