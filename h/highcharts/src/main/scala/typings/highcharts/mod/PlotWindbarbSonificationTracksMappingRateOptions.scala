...
trait PlotWindbarbSonificationTracksMappingRateOptions extends StObject {
...
object PlotWindbarbSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotWindbarbSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
