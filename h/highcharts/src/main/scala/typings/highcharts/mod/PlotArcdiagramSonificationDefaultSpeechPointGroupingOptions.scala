...
trait PlotArcdiagramSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
