...
trait PlotXrangeSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotXrangeSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
