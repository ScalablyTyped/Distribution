...
trait PlotSeriesSonificationTracksMappingPitchOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
