...
trait PlotLollipopSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
