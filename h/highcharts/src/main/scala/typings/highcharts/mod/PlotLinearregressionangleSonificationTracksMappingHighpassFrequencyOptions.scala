...
trait PlotLinearregressionangleSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
