...
trait PlotRsiSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotRsiSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
