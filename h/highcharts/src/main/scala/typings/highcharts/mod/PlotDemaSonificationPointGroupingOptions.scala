...
trait PlotDemaSonificationPointGroupingOptions extends StObject {
...
object PlotDemaSonificationPointGroupingOptions {
  
  inline def apply(): PlotDemaSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDemaSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
