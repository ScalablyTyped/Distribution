...
trait PlotTrixOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotTrixAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotTrixDataLabelsOptions | js.Array[PlotTrixDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotTrixDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotTrixOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotTrixParamsOptions] = js.undefined
...
object PlotTrixOptions {
  
  inline def apply(): PlotTrixOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixOptions]
  }
  
  extension [Self <: PlotTrixOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotTrixAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotTrixDataLabelsOptions | js.Array[PlotTrixDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotTrixDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotTrixDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotTrixOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotTrixParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
