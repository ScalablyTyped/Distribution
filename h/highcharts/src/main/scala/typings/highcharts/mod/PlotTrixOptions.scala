...
object PlotTrixOptions {
  ...
  @scala.inline
  def apply(): PlotTrixOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixOptions]
  }
  
  @scala.inline
  implicit class PlotTrixOptionsMutableBuilder[Self <: PlotTrixOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTrixAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotTrixDataLabelsOptions | js.Array[PlotTrixDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotTrixDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotTrixDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotTrixParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
