...
trait PlotTrixOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotTrixSonificationOptions] = js.undefined
...
object PlotTrixOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotTrixSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
