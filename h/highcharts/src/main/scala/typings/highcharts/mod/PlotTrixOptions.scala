...
trait PlotTrixOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotTrixAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotTrixDataLabelsOptions | js.Array[PlotTrixDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotTrixDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotTrixParamsOptions] = js.native
