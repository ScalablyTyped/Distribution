...
trait PlotLinearregressionSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
