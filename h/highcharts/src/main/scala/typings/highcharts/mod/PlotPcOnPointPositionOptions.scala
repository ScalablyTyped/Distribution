...
trait PlotPcOnPointPositionOptions extends StObject {
...
object PlotPcOnPointPositionOptions {
  
  inline def apply(): PlotPcOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcOnPointPositionOptions] (val x: Self) extends AnyVal {
