...
trait PlotSunburstSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotSunburstSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotSunburstSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
