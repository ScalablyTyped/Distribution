...
object PlotPriceenvelopesTopLineStylesOptions {
  ...
  @scala.inline
  def apply(): PlotPriceenvelopesTopLineStylesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesTopLineStylesOptions]
  }
  
  @scala.inline
  implicit class PlotPriceenvelopesTopLineStylesOptionsMutableBuilder[Self <: PlotPriceenvelopesTopLineStylesOptions] (val x: Self) extends AnyVal {
