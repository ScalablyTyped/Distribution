...
trait PlotEmaSonificationTracksPointGroupingOptions extends StObject {
...
object PlotEmaSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotEmaSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
