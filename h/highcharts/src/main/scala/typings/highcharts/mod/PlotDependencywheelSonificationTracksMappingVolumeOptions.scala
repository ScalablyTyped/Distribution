...
trait PlotDependencywheelSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
