...
trait PlotWordcloudSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
