...
trait PlotColumnpyramidSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
