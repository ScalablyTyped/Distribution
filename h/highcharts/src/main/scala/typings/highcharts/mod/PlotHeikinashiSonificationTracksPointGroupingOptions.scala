...
trait PlotHeikinashiSonificationTracksPointGroupingOptions extends StObject {
...
object PlotHeikinashiSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotHeikinashiSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeikinashiSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeikinashiSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
