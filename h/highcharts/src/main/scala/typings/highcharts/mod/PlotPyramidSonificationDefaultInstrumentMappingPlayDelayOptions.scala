...
trait PlotPyramidSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotPyramidSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
