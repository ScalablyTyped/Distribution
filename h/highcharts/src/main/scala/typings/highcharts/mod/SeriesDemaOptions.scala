...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesDemaOptions extends PlotDemaOptions {
  /**
    * Not available
    */
...
object SeriesDemaOptions {
  ...
  def apply(
    ...
    dataLabels: PlotDemaDataLabelsOptions | js.Array[PlotDemaDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotDemaDataSortingOptions = null,
