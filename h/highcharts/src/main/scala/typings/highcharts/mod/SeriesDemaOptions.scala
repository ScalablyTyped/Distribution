...
import typings.highcharts.highchartsStrings.dema
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesDemaOptions
  extends StObject
     with PlotDemaOptions {
...
object SeriesDemaOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | dema): SeriesDemaOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesDemaOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | dema): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
