...
trait PlotNetworkgraphSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
