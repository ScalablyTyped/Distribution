...
trait PlotItemSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotItemSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
