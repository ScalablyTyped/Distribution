...
trait PlotEmaSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotEmaSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotEmaSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
