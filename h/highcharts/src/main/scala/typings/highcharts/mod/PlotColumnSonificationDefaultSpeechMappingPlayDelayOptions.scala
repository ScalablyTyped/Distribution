...
trait PlotColumnSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotColumnSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotColumnSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
