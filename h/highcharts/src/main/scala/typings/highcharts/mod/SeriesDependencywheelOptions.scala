...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesDependencywheelOptions
  extends StObject
     with PlotDependencywheelOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[(js.Tuple3[String, String, Double]) | SeriesSankeyPointOptionsObject]] = js.undefined
...
object SeriesDependencywheelOptions {
  ...
  inline def apply(`type`: String | dependencywheel): SeriesDependencywheelOptions = {
  ...
  extension [Self <: SeriesDependencywheelOptions](x: Self) {
    ...
    inline def setDataVarargs(value: ((js.Tuple3[String, String, Double]) | SeriesSankeyPointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value*))
    ...
    inline def setType(value: String | dependencywheel): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
