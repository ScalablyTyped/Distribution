...
object SeriesDependencywheelOptions {
  ...
  @scala.inline
  implicit class SeriesDependencywheelOptionsOps[Self <: SeriesDependencywheelOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | dependencywheel): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
    def setDataVarargs(value: SeriesSankeyPointOptionsObject*): Self = this.set("data", js.Array(value :_*))
    @scala.inline
    def setData(value: js.Array[SeriesSankeyPointOptionsObject]): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNodesVarargs(value: SeriesSankeyNodesOptionsObject*): Self = this.set("nodes", js.Array(value :_*))
    @scala.inline
    def setNodes(value: js.Array[SeriesSankeyNodesOptionsObject]): Self = this.set("nodes", value.asInstanceOf[js.Any])
    @scala.inline
