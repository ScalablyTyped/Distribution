...
trait PlotSupertrendOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotSupertrendSonificationOptions] = js.undefined
...
object PlotSupertrendOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotSupertrendOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotSupertrendSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
