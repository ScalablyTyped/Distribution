...
trait PlotSlowstochasticSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
