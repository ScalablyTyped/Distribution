...
trait PlotLinearregressionangleSonificationTracksMappingPanOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
