...
trait PlotTemaSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotTemaSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
