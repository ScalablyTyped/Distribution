...
trait PlotArearangeSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotArearangeSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
