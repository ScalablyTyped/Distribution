...
trait PlotDemaSonificationTracksMappingTimeOptions extends StObject {
...
object PlotDemaSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotDemaSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDemaSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
