...
trait PlotFunnel3dSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
