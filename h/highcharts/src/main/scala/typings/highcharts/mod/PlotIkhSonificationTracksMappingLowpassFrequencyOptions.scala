...
trait PlotIkhSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotIkhSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
