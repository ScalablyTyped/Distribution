...
trait PlotVariablepieSonificationTracksMappingPitchOptions extends StObject {
...
object PlotVariablepieSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotVariablepieSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
