...
trait PlotBarSonificationTracksActiveWhenOptions extends StObject {
...
object PlotBarSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotBarSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
