...
object PlotPolygonOptions {
  ...
  def apply(
    ...
    dataLabels: PlotPolygonDataLabelsOptions | js.Array[PlotPolygonDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotPolygonDataSortingOptions = null,
