...
trait PlotPpoSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotPpoSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPpoSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
