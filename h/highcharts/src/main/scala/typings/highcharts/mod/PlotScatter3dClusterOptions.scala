...
trait PlotScatter3dClusterOptions extends StObject {
  ...
  var events: js.UndefOr[PlotScatter3dClusterEventsOptions] = js.undefined
  ...
  /**
    ...
    * iterations.
    */
  var layoutAlgorithm: js.UndefOr[PlotScatter3dClusterLayoutAlgorithmOptions] = js.undefined
  ...
  var states: js.UndefOr[PlotScatter3dClusterStatesOptions] = js.undefined
  ...
  /**
    ...
    * `className` option.
    */
  var zones: js.UndefOr[js.Array[PlotScatter3dClusterZonesOptions]] = js.undefined
}
object PlotScatter3dClusterOptions {
  
  inline def apply(): PlotScatter3dClusterOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dClusterOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatter3dClusterOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: PlotScatter3dClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    inline def setLayoutAlgorithm(value: PlotScatter3dClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setStates(value: PlotScatter3dClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    inline def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    inline def setZones(value: js.Array[PlotScatter3dClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
    
    inline def setZonesUndefined: Self = StObject.set(x, "zones", js.undefined)
    
    inline def setZonesVarargs(value: PlotScatter3dClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value*))
  }
}
