...
trait PlotPpoSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotPpoSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
