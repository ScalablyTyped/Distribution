...
trait PlotTimelineDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotTimelineDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotTimelineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotTimelineDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotTimelineDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotTimelineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotTimelineDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineDragDropOptions]
  }
}
