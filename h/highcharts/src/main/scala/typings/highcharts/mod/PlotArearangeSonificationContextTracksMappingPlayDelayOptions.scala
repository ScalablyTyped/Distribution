...
trait PlotArearangeSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotArearangeSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotArearangeSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
