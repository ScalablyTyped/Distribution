...
trait PlotFlagsSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotFlagsSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
