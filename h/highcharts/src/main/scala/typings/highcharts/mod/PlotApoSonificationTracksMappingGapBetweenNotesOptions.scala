...
trait PlotApoSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotApoSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
