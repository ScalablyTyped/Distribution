...
trait PlotArearangeSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotArearangeSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
