...
trait PlotItemSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotItemSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotItemSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
