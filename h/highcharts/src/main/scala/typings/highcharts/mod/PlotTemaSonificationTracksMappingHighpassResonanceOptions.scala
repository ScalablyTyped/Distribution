...
trait PlotTemaSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotTemaSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
