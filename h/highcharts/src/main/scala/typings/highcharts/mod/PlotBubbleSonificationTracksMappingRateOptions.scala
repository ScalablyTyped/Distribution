...
trait PlotBubbleSonificationTracksMappingRateOptions extends StObject {
...
object PlotBubbleSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotBubbleSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
