...
trait PlotFunnelSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotFunnelSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
