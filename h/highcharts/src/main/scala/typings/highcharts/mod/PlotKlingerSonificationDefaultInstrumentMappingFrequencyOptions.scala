...
trait PlotKlingerSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotKlingerSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
