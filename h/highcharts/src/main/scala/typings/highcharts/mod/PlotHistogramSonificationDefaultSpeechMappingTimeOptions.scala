...
trait PlotHistogramSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotHistogramSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
