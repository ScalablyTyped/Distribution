...
trait PlotTrendlineSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotTrendlineSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
