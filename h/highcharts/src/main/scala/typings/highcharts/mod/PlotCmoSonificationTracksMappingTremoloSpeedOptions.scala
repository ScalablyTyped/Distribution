...
trait PlotCmoSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotCmoSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
