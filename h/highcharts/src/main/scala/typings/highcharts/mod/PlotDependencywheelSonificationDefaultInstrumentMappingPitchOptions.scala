...
trait PlotDependencywheelSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotDependencywheelSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
