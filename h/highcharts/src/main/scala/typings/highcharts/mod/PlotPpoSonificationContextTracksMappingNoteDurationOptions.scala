...
trait PlotPpoSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotPpoSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPpoSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
