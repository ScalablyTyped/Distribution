...
trait PlotLinearregressionangleSonificationPointGroupingOptions extends StObject {
...
object PlotLinearregressionangleSonificationPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
