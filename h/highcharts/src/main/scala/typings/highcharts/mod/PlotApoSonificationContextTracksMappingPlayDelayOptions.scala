...
trait PlotApoSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
