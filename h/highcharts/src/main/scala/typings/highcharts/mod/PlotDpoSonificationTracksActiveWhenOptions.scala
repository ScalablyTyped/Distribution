...
trait PlotDpoSonificationTracksActiveWhenOptions extends StObject {
...
object PlotDpoSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotDpoSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDpoSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
