...
trait PlotFlagsSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotFlagsSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
