...
trait PlotVariwideSonificationTracksMappingPitchOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
