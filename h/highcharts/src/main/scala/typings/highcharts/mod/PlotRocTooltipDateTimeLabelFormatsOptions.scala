...
trait PlotRocTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotRocTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotRocTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotRocTooltipDateTimeLabelFormatsOptions]
  }
}
