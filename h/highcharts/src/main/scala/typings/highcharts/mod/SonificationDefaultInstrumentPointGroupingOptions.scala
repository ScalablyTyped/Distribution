...
trait SonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object SonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): SonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
