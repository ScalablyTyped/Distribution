...
trait PlotPyramid3dSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
