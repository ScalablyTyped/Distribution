...
trait PlotPolygonSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotPolygonSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
