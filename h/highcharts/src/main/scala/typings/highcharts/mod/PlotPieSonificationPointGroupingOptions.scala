...
trait PlotPieSonificationPointGroupingOptions extends StObject {
...
object PlotPieSonificationPointGroupingOptions {
  
  inline def apply(): PlotPieSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
