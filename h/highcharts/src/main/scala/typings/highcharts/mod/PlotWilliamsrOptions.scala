...
trait PlotWilliamsrOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotWilliamsrSonificationOptions] = js.undefined
...
object PlotWilliamsrOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWilliamsrOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotWilliamsrSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
