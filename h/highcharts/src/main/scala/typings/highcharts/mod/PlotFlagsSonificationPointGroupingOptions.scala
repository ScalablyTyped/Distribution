...
trait PlotFlagsSonificationPointGroupingOptions extends StObject {
...
object PlotFlagsSonificationPointGroupingOptions {
  
  inline def apply(): PlotFlagsSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
