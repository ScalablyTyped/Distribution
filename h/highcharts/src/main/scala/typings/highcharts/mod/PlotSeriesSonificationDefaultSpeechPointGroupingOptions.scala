...
trait PlotSeriesSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotSeriesSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
