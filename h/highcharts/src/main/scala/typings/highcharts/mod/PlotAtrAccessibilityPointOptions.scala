...
trait PlotAtrAccessibilityPointOptions extends StObject {
...
object PlotAtrAccessibilityPointOptions {
  
  inline def apply(): PlotAtrAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrAccessibilityPointOptions] (val x: Self) extends AnyVal {
