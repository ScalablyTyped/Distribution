...
trait PlotSeriesSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
