...
trait PlotNatrSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotNatrSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotNatrSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
