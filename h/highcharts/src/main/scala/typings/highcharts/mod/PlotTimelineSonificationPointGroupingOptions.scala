...
trait PlotTimelineSonificationPointGroupingOptions extends StObject {
...
object PlotTimelineSonificationPointGroupingOptions {
  
  inline def apply(): PlotTimelineSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
