...
trait PlotHeatmapSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotHeatmapSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
