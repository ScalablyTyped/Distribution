...
trait PlotSlowstochasticSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
