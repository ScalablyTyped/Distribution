...
trait PlotPsarSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotPsarSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
