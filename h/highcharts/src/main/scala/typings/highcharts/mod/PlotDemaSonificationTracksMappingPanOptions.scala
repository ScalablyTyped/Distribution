...
trait PlotDemaSonificationTracksMappingPanOptions extends StObject {
...
object PlotDemaSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotDemaSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDemaSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
