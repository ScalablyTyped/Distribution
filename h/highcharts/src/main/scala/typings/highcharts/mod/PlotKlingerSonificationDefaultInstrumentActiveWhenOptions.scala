...
trait PlotKlingerSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotKlingerSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
