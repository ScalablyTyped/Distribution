...
trait PlotMappointSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotMappointSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotMappointSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
