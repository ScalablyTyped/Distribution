...
trait SonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object SonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): SonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
