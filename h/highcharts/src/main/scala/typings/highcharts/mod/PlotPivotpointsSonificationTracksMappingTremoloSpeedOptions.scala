...
trait PlotPivotpointsSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
