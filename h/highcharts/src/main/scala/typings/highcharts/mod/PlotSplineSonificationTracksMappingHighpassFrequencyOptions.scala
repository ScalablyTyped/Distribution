...
trait PlotSplineSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotSplineSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
