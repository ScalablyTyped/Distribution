...
object SeriesPsarOptions {
  ...
  @scala.inline
  implicit class SeriesPsarOptionsOps[Self <: SeriesPsarOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | psar): Self = this.set("type", value.asInstanceOf[js.Any])
