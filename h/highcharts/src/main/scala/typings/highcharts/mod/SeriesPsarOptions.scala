...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesPsarOptions extends PlotPsarOptions {
  /**
    * Not available
    */
...
object SeriesPsarOptions {
  ...
  def apply(
    ...
    dataLabels: PlotPsarDataLabelsOptions | js.Array[PlotPsarDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotPsarDataSortingOptions = null,
