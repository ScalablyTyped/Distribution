...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesPsarOptions
  extends StObject
...
object SeriesPsarOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | psar): SeriesPsarOptions = {
  ...
  @scala.inline
  implicit class SeriesPsarOptionsMutableBuilder[Self <: SeriesPsarOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | psar): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
