...
trait PlotAroonoscillatorSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotAroonoscillatorSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotAroonoscillatorSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonoscillatorSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
