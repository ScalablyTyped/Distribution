...
trait PlotMaplineSonificationDefaultInstrumentPointGroupingOptions extends StObject {
  
  /**
    * (Highmaps) The grouping algorithm, deciding which points to keep when
  ...
  /**
    * (Highmaps) Whether or not to group points
    */
  var enabled: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Highmaps) The size of each group in milliseconds. Audio events closer
    * than this are grouped together.
    */
  var groupTimespan: js.UndefOr[Double] = js.undefined
  
  /**
    * (Highmaps) The data property for each point to compare when deciding
...
object PlotMaplineSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotMaplineSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
