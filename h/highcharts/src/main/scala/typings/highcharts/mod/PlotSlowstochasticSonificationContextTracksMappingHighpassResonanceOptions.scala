...
trait PlotSlowstochasticSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
