...
trait PlotMacdOnPointPositionOptions extends StObject {
...
object PlotMacdOnPointPositionOptions {
  
  inline def apply(): PlotMacdOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMacdOnPointPositionOptions] (val x: Self) extends AnyVal {
