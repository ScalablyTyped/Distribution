...
trait PlotDisparityindexSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
