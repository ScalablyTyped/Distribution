...
trait PlotVariablepieSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotVariablepieSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
