...
@js.native
trait SeriesWindbarbDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesWindbarbDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesWindbarbDataDataLabelsAnimationOptionsOps[Self <: SeriesWindbarbDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
