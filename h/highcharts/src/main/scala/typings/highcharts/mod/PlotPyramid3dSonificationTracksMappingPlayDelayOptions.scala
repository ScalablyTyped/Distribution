...
trait PlotPyramid3dSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
