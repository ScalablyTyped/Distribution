...
trait PlotWaterfallSonificationTracksMappingRateOptions extends StObject {
...
object PlotWaterfallSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotWaterfallSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
