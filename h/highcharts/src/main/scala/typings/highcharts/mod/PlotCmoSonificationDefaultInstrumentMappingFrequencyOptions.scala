...
trait PlotCmoSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotCmoSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotCmoSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
