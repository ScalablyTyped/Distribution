...
trait PlotDumbbellSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
