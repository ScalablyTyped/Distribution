...
trait PlotDisparityindexOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotDisparityindexSonificationOptions] = js.undefined
...
object PlotDisparityindexOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotDisparityindexSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
