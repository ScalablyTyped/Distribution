...
trait PlotHollowcandlestickSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotHollowcandlestickSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
