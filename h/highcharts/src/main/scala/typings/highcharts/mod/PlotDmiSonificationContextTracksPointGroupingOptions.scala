...
trait PlotDmiSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotDmiSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
