...
trait PlotWilliamsrMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotWilliamsrMarkerStatesOptions] = js.undefined
  /**
...
object PlotWilliamsrMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotWilliamsrMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotWilliamsrMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrMarkerOptions]
  }
}
