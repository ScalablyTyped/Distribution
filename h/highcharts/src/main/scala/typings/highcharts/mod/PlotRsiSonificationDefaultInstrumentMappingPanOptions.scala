...
trait PlotRsiSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotRsiSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotRsiSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
