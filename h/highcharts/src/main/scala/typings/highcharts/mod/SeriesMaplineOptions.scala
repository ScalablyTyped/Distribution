...
object SeriesMaplineOptions {
  ...
  extension [Self <: SeriesMaplineOptions](x: Self) {
    ...
    inline def setData(value: js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | js.Any]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    inline def setDataVarargs(value: (Double | (js.Tuple2[String, Double | Null]) | Null | js.Any)*): Self = StObject.set(x, "data", js.Array(value :_*))
