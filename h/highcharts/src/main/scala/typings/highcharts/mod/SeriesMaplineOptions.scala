...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesMaplineOptions extends PlotMaplineOptions {
  /**
...
object SeriesMaplineOptions {
  ...
  def apply(
    ...
    dataLabels: PlotMaplineDataLabelsOptions | js.Array[PlotMaplineDataLabelsOptions] = null,
