...
trait PlotVariablepieAccessibilityPointOptions extends StObject {
...
object PlotVariablepieAccessibilityPointOptions {
  
  inline def apply(): PlotVariablepieAccessibilityPointOptions = {
