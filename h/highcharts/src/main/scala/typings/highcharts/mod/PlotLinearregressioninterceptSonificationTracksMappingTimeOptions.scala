...
trait PlotLinearregressioninterceptSonificationTracksMappingTimeOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
