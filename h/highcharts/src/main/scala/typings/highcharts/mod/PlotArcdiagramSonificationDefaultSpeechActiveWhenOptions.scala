...
trait PlotArcdiagramSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
