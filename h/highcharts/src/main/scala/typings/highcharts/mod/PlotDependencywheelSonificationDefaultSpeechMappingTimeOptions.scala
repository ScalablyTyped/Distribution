...
trait PlotDependencywheelSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotDependencywheelSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
