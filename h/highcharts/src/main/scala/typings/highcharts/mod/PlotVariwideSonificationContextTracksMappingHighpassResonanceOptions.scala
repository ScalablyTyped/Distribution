...
trait PlotVariwideSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotVariwideSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
