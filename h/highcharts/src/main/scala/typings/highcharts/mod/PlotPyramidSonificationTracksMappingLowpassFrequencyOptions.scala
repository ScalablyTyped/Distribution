...
trait PlotPyramidSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
