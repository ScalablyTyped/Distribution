...
trait PlotCmoSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotCmoSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
