...
trait PlotTemaSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotTemaSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotTemaSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
