...
trait PlotDisparityindexSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
