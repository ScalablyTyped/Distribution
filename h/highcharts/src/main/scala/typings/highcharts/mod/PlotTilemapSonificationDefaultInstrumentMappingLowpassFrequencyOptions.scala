...
trait PlotTilemapSonificationDefaultInstrumentMappingLowpassFrequencyOptions extends StObject {
...
object PlotTilemapSonificationDefaultInstrumentMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotTilemapSonificationDefaultInstrumentMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapSonificationDefaultInstrumentMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTilemapSonificationDefaultInstrumentMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
