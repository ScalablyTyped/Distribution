...
trait PlotPictorialSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotPictorialSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
