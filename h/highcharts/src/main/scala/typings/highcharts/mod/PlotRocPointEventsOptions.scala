...
trait PlotRocPointEventsOptions extends js.Object {
  /**
...
object PlotRocPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotRocPointEventsOptions]
  }
}
