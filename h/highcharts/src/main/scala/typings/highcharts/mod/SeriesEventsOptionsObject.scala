...
object SeriesEventsOptionsObject {
  ...
  def apply(
    ...
    checkboxClick: js.Function | SeriesCheckboxClickCallbackFunction = null,
    ...
    if (setRootNode != null) __obj.updateDynamic("setRootNode")(setRootNode.asInstanceOf[js.Any])
