...
trait PlotTrixSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotTrixSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
