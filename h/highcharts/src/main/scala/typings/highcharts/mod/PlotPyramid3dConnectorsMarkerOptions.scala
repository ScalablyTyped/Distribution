...
trait PlotPyramid3dConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotPyramid3dConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramid3dConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPyramid3dConnectorsMarkerOptions]
  }
}
