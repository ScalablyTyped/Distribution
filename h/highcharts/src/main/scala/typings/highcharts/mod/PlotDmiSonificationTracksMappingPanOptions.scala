...
trait PlotDmiSonificationTracksMappingPanOptions extends StObject {
...
object PlotDmiSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
