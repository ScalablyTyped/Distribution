...
trait PlotParetoSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
