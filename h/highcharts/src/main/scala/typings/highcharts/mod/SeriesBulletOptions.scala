...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesBulletOptions
  extends StObject
...
object SeriesBulletOptions {
  ...
  inline def apply(`type`: String | bullet): SeriesBulletOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesBulletOptions] (val x: Self) extends AnyVal {
