...
trait PlotColumnpyramidOnPointPositionOptions extends StObject {
...
object PlotColumnpyramidOnPointPositionOptions {
  
  inline def apply(): PlotColumnpyramidOnPointPositionOptions = {
