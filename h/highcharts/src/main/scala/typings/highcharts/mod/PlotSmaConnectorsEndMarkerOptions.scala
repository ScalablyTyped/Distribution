...
trait PlotSmaConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotSmaConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSmaConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSmaConnectorsEndMarkerOptions]
  }
}
