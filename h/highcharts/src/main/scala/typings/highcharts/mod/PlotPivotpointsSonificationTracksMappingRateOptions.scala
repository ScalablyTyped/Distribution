...
trait PlotPivotpointsSonificationTracksMappingRateOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
