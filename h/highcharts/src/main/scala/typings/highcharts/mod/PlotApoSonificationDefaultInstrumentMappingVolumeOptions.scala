...
trait PlotApoSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotApoSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotApoSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
