...
trait PlotLineSonificationTracksMappingRateOptions extends StObject {
...
object PlotLineSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
