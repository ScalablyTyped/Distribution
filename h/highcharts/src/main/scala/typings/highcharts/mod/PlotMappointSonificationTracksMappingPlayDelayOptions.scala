...
trait PlotMappointSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotMappointSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
