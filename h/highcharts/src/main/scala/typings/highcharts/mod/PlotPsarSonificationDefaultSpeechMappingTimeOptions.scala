...
trait PlotPsarSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotPsarSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotPsarSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
