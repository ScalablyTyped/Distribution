...
trait PlotAreasplineDataSortingOptions extends StObject {
...
object PlotAreasplineDataSortingOptions {
  
  @scala.inline
  def apply(): PlotAreasplineDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotAreasplineDataSortingOptionsMutableBuilder[Self <: PlotAreasplineDataSortingOptions] (val x: Self) extends AnyVal {
