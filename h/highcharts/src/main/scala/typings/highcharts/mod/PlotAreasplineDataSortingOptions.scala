...
@js.native
trait PlotAreasplineDataSortingOptions extends js.Object {
  /**
...
object PlotAreasplineDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotAreasplineDataSortingOptionsOps[Self <: PlotAreasplineDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
