...
@js.native
trait PlotZigzagDataSortingOptions extends StObject {
...
object PlotZigzagDataSortingOptions {
  
  @scala.inline
  def apply(): PlotZigzagDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotZigzagDataSortingOptionsMutableBuilder[Self <: PlotZigzagDataSortingOptions] (val x: Self) extends AnyVal {
