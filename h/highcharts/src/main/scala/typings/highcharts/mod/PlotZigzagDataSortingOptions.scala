...
@js.native
trait PlotZigzagDataSortingOptions extends js.Object {
...
object PlotZigzagDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotZigzagDataSortingOptionsOps[Self <: PlotZigzagDataSortingOptions] (val x: Self) extends AnyVal {
