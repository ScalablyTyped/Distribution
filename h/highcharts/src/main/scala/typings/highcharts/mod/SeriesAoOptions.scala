...
import typings.highcharts.highchartsStrings.ao
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesAoOptions
  extends StObject
     with PlotAoOptions {
...
object SeriesAoOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | ao): SeriesAoOptions = {
  ...
  @scala.inline
  implicit class SeriesAoOptionsMutableBuilder[Self <: SeriesAoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | ao): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
