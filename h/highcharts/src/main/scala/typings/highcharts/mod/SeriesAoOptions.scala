...
object SeriesAoOptions {
  ...
  @scala.inline
  implicit class SeriesAoOptionsOps[Self <: SeriesAoOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | ao): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
