...
trait PlotLinearregressionangleSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
