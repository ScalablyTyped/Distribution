...
trait PlotMacdConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotMacdConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMacdConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMacdConnectorsStartMarkerOptions]
  }
}
