...
trait PlotBoxplotOnPointPositionOptions extends StObject {
...
object PlotBoxplotOnPointPositionOptions {
  
  inline def apply(): PlotBoxplotOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBoxplotOnPointPositionOptions] (val x: Self) extends AnyVal {
