...
trait PlotPriceenvelopesSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotPriceenvelopesSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
