...
trait PlotColumnSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotColumnSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
