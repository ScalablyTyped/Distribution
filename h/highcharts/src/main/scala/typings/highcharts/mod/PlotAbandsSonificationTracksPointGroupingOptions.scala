...
trait PlotAbandsSonificationTracksPointGroupingOptions extends StObject {
...
object PlotAbandsSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotAbandsSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
