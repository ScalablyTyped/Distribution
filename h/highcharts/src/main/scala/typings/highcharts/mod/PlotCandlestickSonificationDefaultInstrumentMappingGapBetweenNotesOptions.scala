...
trait PlotCandlestickSonificationDefaultInstrumentMappingGapBetweenNotesOptions extends StObject {
...
object PlotCandlestickSonificationDefaultInstrumentMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultInstrumentMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultInstrumentMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultInstrumentMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
