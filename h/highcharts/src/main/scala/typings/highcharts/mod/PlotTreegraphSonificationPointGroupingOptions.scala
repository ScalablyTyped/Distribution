...
trait PlotTreegraphSonificationPointGroupingOptions extends StObject {
...
object PlotTreegraphSonificationPointGroupingOptions {
  
  inline def apply(): PlotTreegraphSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
