...
trait PlotSeriesSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
