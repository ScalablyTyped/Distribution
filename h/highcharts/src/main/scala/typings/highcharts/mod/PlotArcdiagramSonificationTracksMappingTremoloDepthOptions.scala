...
trait PlotArcdiagramSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
