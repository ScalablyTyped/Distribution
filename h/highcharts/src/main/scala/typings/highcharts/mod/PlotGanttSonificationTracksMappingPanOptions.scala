...
trait PlotGanttSonificationTracksMappingPanOptions extends StObject {
...
object PlotGanttSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
