...
trait PlotPolygonSonificationTracksMappingPanOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
