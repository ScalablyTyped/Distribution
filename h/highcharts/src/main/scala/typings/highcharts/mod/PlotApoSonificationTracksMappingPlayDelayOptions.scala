...
trait PlotApoSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotApoSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
