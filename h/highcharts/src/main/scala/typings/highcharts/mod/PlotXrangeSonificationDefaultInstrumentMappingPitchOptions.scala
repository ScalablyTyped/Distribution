...
trait PlotXrangeSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotXrangeSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
