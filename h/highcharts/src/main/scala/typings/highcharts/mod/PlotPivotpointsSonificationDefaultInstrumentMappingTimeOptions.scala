...
trait PlotPivotpointsSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
