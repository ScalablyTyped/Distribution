...
trait PlotPyramidSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPyramidSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
