...
trait PlotFunnelSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
