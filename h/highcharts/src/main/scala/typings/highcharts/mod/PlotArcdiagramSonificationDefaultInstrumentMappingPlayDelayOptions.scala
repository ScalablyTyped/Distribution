...
trait PlotArcdiagramSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
