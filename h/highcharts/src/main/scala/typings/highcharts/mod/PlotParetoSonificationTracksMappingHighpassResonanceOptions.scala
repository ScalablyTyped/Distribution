...
trait PlotParetoSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotParetoSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
