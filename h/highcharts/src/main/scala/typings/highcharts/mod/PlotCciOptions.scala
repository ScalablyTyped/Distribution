...
trait PlotCciOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotCciSonificationOptions] = js.undefined
...
object PlotCciOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotCciSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
