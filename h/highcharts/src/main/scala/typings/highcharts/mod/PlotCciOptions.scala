...
trait PlotCciOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotCciAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotCciDataLabelsOptions | js.Array[PlotCciDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotCciDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotCciParamsOptions] = js.native
...
object PlotCciOptions {
  ...
  @scala.inline
  def apply(): PlotCciOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciOptions]
  }
  
  @scala.inline
  implicit class PlotCciOptionsMutableBuilder[Self <: PlotCciOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotCciAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotCciDataLabelsOptions | js.Array[PlotCciDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotCciDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotCciDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotCciParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
