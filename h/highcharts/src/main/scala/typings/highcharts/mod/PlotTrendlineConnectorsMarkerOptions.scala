...
trait PlotTrendlineConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotTrendlineConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrendlineConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineConnectorsMarkerOptions]
  }
}
