...
trait PlotLinearregressionslopeSonificationTracksMappingPitchOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
