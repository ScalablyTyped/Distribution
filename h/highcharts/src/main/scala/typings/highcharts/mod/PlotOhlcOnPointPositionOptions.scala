...
trait PlotOhlcOnPointPositionOptions extends StObject {
...
object PlotOhlcOnPointPositionOptions {
  
  inline def apply(): PlotOhlcOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOhlcOnPointPositionOptions] (val x: Self) extends AnyVal {
