...
trait PlotTreegraphSonificationTracksMappingPitchOptions extends StObject {
...
object PlotTreegraphSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotTreegraphSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
