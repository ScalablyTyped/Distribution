...
trait PlotDmiSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotDmiSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotDmiSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
