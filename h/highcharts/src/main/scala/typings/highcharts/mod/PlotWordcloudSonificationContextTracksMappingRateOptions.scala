...
trait PlotWordcloudSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
