...
trait PlotTreegraphOnPointPositionOptions extends StObject {
...
object PlotTreegraphOnPointPositionOptions {
  
  inline def apply(): PlotTreegraphOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphOnPointPositionOptions] (val x: Self) extends AnyVal {
