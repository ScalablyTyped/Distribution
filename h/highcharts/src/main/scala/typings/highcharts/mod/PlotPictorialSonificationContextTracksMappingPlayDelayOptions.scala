...
trait PlotPictorialSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotPictorialSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
