...
trait PlotAreasplineOnPointPositionOptions extends StObject {
...
object PlotAreasplineOnPointPositionOptions {
  
  inline def apply(): PlotAreasplineOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplineOnPointPositionOptions] (val x: Self) extends AnyVal {
