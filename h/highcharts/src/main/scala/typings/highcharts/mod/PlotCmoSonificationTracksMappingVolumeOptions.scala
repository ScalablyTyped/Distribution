...
trait PlotCmoSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotCmoSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
