...
trait PlotPriceenvelopesSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
