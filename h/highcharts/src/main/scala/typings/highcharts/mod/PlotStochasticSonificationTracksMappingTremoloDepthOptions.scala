...
trait PlotStochasticSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
