...
trait PlotNetworkgraphSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
