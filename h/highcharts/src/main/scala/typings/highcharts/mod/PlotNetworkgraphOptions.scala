...
trait PlotNetworkgraphOptions extends StObject {
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotNetworkgraphDataSortingOptions] = js.undefined
...
object PlotNetworkgraphOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotNetworkgraphDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
