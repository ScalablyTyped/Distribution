...
trait PlotNetworkgraphOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotNetworkgraphSonificationOptions] = js.undefined
...
object PlotNetworkgraphOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotNetworkgraphOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotNetworkgraphSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
