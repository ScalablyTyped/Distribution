...
trait PlotIkhSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotIkhSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotIkhSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
