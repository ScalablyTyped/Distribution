...
@js.native
trait PlotAoOptions extends js.Object {
...
object PlotAoOptions {
  ...
  @scala.inline
  implicit class PlotAoOptionsOps[Self <: PlotAoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAoAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotAoDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotAoDataLabelsOptions | js.Array[PlotAoDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotAoDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGreaterBarColor(value: ColorString | GradientColorObject | PatternObject): Self = this.set("greaterBarColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGreaterBarColor: Self = this.set("greaterBarColor", js.undefined)
    ...
    @scala.inline
    def setLowerBarColor(value: ColorString | GradientColorObject | PatternObject): Self = this.set("lowerBarColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLowerBarColor: Self = this.set("lowerBarColor", js.undefined)
