...
object PlotAoOptions {
  ...
  @scala.inline
  def apply(): PlotAoOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoOptions]
  }
  
  @scala.inline
  implicit class PlotAoOptionsMutableBuilder[Self <: PlotAoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAoAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotAoDataLabelsOptions | js.Array[PlotAoDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotAoDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotAoDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGreaterBarColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "greaterBarColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGreaterBarColorUndefined: Self = StObject.set(x, "greaterBarColor", js.undefined)
    ...
    @scala.inline
    def setLowerBarColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "lowerBarColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLowerBarColorUndefined: Self = StObject.set(x, "lowerBarColor", js.undefined)
