...
trait PlotAoOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAoAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotAoDataLabelsOptions | js.Array[PlotAoDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotAoDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var greaterBarColor: js.UndefOr[ColorString | GradientColorObject | PatternObject] = js.undefined
  ...
  /**
    ...
    */
  var lowerBarColor: js.UndefOr[ColorString | GradientColorObject | PatternObject] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotAoOnPointOptions] = js.undefined
  ...
  var params: js.UndefOr[PlotAoParamsOptions] = js.undefined
...
object PlotAoOptions {
  
  inline def apply(): PlotAoOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoOptions]
  }
  
  extension [Self <: PlotAoOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotAoAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotAoDataLabelsOptions | js.Array[PlotAoDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotAoDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotAoDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setGreaterBarColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "greaterBarColor", value.asInstanceOf[js.Any])
    
    inline def setGreaterBarColorUndefined: Self = StObject.set(x, "greaterBarColor", js.undefined)
    ...
    inline def setLowerBarColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "lowerBarColor", value.asInstanceOf[js.Any])
    
    inline def setLowerBarColorUndefined: Self = StObject.set(x, "lowerBarColor", js.undefined)
    ...
    inline def setOnPoint(value: js.Object | PlotAoOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotAoParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
