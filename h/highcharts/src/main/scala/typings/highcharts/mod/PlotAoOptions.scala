...
trait PlotAoOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAoAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotAoDataLabelsOptions | js.Array[PlotAoDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotAoDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var greaterBarColor: js.UndefOr[ColorString | GradientColorObject | PatternObject] = js.native
  ...
  /**
    ...
    */
  var lowerBarColor: js.UndefOr[ColorString | GradientColorObject | PatternObject] = js.native
