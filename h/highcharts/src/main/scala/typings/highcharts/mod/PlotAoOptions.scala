...
trait PlotAoOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotAoSonificationOptions] = js.undefined
...
object PlotAoOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotAoSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
