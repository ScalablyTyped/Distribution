...
trait PlotStochasticSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
