...
trait PlotHistogramSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotHistogramSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
