...
@js.native
trait PlotLinearregressionslopeDataLabelsAnimationOptions extends js.Object {
...
object PlotLinearregressionslopeDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressionslopeDataLabelsAnimationOptionsOps[Self <: PlotLinearregressionslopeDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
