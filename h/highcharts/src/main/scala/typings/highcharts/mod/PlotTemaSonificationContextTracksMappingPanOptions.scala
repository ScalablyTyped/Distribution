...
trait PlotTemaSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
