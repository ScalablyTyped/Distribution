...
trait SeriesStreamgraphDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesStreamgraphDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesStreamgraphDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesStreamgraphDataDragDropGuideBoxDefaultOptions]
  }
}
