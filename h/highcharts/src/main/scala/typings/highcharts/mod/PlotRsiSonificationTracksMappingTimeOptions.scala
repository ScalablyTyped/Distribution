...
trait PlotRsiSonificationTracksMappingTimeOptions extends StObject {
...
object PlotRsiSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
