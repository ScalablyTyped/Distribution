...
trait PlotArearangeSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
