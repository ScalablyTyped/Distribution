...
trait PlotSplineSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotSplineSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
