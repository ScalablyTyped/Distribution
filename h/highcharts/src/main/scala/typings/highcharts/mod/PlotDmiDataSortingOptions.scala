...
trait PlotDmiDataSortingOptions extends StObject {
...
object PlotDmiDataSortingOptions {
  
  inline def apply(): PlotDmiDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiDataSortingOptions] (val x: Self) extends AnyVal {
