...
trait PlotTilemapSonificationTracksMappingPitchOptions extends StObject {
...
object PlotTilemapSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotTilemapSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTilemapSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
