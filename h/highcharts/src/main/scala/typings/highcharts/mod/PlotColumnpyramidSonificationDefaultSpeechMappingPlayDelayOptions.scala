...
trait PlotColumnpyramidSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
