...
trait PlotPriceenvelopesSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
