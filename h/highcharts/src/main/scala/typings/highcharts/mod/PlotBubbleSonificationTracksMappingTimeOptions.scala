...
trait PlotBubbleSonificationTracksMappingTimeOptions extends StObject {
...
object PlotBubbleSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotBubbleSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
