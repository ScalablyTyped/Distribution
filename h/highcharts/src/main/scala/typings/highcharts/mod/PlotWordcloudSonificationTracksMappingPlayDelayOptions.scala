...
trait PlotWordcloudSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
