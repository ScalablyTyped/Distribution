...
trait PlotBellcurveZonesOptions extends js.Object {
  /**
...
object PlotBellcurveZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotBellcurveZonesOptions]
  }
}
