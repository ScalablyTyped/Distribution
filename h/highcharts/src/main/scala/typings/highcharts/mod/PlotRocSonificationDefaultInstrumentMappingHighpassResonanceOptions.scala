...
trait PlotRocSonificationDefaultInstrumentMappingHighpassResonanceOptions extends StObject {
...
object PlotRocSonificationDefaultInstrumentMappingHighpassResonanceOptions {
  
  inline def apply(): PlotRocSonificationDefaultInstrumentMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocSonificationDefaultInstrumentMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRocSonificationDefaultInstrumentMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
