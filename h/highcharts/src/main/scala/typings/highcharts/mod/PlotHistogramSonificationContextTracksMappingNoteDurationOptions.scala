...
trait PlotHistogramSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotHistogramSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
