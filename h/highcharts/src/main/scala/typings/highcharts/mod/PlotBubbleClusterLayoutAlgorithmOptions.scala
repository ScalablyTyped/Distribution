...
trait PlotBubbleClusterLayoutAlgorithmOptions extends StObject {
...
object PlotBubbleClusterLayoutAlgorithmOptions {
  
  inline def apply(): PlotBubbleClusterLayoutAlgorithmOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleClusterLayoutAlgorithmOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleClusterLayoutAlgorithmOptions] (val x: Self) extends AnyVal {
