...
trait PlotSlowstochasticSonificationTracksActiveWhenOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
