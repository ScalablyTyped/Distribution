...
trait PlotPyramidSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotPyramidSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
