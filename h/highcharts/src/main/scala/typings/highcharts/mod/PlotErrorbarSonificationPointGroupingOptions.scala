...
trait PlotErrorbarSonificationPointGroupingOptions extends StObject {
...
object PlotErrorbarSonificationPointGroupingOptions {
  
  inline def apply(): PlotErrorbarSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotErrorbarSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
