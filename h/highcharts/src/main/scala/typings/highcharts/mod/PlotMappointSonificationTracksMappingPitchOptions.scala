...
trait PlotMappointSonificationTracksMappingPitchOptions extends StObject {
...
object PlotMappointSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
