...
trait PlotHistogramSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotHistogramSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
