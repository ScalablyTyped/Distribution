...
trait PlotDisparityindexSonificationPointGroupingOptions extends StObject {
...
object PlotDisparityindexSonificationPointGroupingOptions {
  
  inline def apply(): PlotDisparityindexSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
