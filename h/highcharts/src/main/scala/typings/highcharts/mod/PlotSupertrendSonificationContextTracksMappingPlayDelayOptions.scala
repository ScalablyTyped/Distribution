...
trait PlotSupertrendSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
