...
trait PlotLinearregressionSonificationTracksMappingRateOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
