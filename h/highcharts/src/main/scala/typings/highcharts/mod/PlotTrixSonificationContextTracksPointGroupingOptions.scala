...
trait PlotTrixSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotTrixSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
