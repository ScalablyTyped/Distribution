...
trait PlotArcdiagramSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
