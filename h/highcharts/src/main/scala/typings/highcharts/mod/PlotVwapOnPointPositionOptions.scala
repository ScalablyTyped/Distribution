...
trait PlotVwapOnPointPositionOptions extends StObject {
...
object PlotVwapOnPointPositionOptions {
  
  inline def apply(): PlotVwapOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVwapOnPointPositionOptions] (val x: Self) extends AnyVal {
