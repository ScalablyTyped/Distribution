...
trait PlotNetworkgraphSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
