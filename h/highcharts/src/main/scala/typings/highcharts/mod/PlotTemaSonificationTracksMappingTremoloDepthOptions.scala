...
trait PlotTemaSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotTemaSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
