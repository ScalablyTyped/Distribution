...
trait PlotArearangeSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
