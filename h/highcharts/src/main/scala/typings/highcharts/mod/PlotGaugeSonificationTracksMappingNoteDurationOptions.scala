...
trait PlotGaugeSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
