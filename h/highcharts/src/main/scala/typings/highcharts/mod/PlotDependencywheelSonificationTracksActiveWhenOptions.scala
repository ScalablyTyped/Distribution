...
trait PlotDependencywheelSonificationTracksActiveWhenOptions extends StObject {
...
object PlotDependencywheelSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
