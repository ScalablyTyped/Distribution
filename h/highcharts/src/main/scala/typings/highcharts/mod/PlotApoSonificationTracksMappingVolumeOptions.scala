...
trait PlotApoSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotApoSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
