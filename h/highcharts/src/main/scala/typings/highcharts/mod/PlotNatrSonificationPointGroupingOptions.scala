...
trait PlotNatrSonificationPointGroupingOptions extends StObject {
...
object PlotNatrSonificationPointGroupingOptions {
  
  inline def apply(): PlotNatrSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
