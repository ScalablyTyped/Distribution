...
trait PlotAtrOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAtrAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotAtrDataLabelsOptions | js.Array[PlotAtrDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotAtrDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotAtrParamsOptions] = js.native
