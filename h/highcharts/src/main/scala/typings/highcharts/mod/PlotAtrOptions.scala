...
trait PlotAtrOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotAtrSonificationOptions] = js.undefined
...
object PlotAtrOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotAtrSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
