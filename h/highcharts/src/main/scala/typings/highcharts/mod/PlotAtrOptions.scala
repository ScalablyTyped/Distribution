...
object PlotAtrOptions {
  ...
  @scala.inline
  def apply(): PlotAtrOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrOptions]
  }
  
  @scala.inline
  implicit class PlotAtrOptionsMutableBuilder[Self <: PlotAtrOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAtrAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotAtrDataLabelsOptions | js.Array[PlotAtrDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotAtrDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotAtrDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotAtrParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
