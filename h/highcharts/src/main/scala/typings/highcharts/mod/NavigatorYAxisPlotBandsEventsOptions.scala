...
@js.native
trait NavigatorYAxisPlotBandsEventsOptions extends js.Object {
  /**
...
object NavigatorYAxisPlotBandsEventsOptions {
  ...
  @scala.inline
  implicit class NavigatorYAxisPlotBandsEventsOptionsOps[Self <: NavigatorYAxisPlotBandsEventsOptions] (val x: Self) extends AnyVal {
    @scala.inline
