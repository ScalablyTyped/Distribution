...
@js.native
trait NavigatorYAxisPlotBandsEventsOptions extends StObject {
...
object NavigatorYAxisPlotBandsEventsOptions {
  
  @scala.inline
  def apply(): NavigatorYAxisPlotBandsEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisPlotBandsEventsOptions]
  }
  
  @scala.inline
  implicit class NavigatorYAxisPlotBandsEventsOptionsMutableBuilder[Self <: NavigatorYAxisPlotBandsEventsOptions] (val x: Self) extends AnyVal {
