...
trait PlotNatrSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotNatrSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
