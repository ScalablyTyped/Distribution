...
@js.native
trait PlotVariwideDataLabelsOptions extends js.Object {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotVariwideDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotVariwideDataLabelsOptions {
  ...
  @scala.inline
  def apply(): PlotVariwideDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotVariwideDataLabelsOptionsOps[Self <: PlotVariwideDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVariwideDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
