...
trait PlotPsarSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotPsarSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
