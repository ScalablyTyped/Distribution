...
trait PlotLinearregressioninterceptSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
