...
trait PlotSankeyDataSortingOptions extends StObject {
...
object PlotSankeyDataSortingOptions {
  
  inline def apply(): PlotSankeyDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeyDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeyDataSortingOptions] (val x: Self) extends AnyVal {
