...
trait PlotBoxplotSonificationTracksActiveWhenOptions extends StObject {
...
object PlotBoxplotSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotBoxplotSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBoxplotSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
