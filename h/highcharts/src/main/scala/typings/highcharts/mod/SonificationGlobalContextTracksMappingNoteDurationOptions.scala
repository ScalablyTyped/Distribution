...
trait SonificationGlobalContextTracksMappingNoteDurationOptions extends StObject {
...
object SonificationGlobalContextTracksMappingNoteDurationOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
