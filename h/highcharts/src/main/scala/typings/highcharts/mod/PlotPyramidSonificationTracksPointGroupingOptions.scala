...
trait PlotPyramidSonificationTracksPointGroupingOptions extends StObject {
...
object PlotPyramidSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotPyramidSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
