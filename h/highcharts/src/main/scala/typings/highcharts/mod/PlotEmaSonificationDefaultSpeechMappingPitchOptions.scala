...
trait PlotEmaSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotEmaSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotEmaSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
