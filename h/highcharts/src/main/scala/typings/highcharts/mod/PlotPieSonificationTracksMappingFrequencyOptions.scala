...
trait PlotPieSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotPieSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPieSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
