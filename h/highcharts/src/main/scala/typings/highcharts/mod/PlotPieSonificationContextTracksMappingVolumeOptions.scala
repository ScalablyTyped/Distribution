...
trait PlotPieSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotPieSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotPieSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
