...
trait PlotTemaSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
