...
trait PlotTemaSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotTemaSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotTemaSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
