...
trait PlotPsarSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotPsarSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotPsarSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
