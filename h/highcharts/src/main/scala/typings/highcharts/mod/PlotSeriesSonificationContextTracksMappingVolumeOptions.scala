...
trait PlotSeriesSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
