...
trait PlotSeriesSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
