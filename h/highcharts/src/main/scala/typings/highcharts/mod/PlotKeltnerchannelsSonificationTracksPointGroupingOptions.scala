...
trait PlotKeltnerchannelsSonificationTracksPointGroupingOptions extends StObject {
...
object PlotKeltnerchannelsSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotKeltnerchannelsSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
