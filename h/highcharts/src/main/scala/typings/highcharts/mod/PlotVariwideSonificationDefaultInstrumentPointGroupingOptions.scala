...
trait PlotVariwideSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotVariwideSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
