...
trait PlotVariwideSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
