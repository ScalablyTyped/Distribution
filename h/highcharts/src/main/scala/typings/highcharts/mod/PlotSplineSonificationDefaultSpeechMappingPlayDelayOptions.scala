...
trait PlotSplineSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotSplineSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotSplineSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
