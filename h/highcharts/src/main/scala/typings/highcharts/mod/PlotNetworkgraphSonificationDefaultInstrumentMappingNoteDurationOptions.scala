...
trait PlotNetworkgraphSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
