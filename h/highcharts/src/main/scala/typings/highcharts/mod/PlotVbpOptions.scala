...
trait PlotVbpOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotVbpAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotVbpDataLabelsOptions | js.Array[PlotVbpDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotVbpDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotVbpParamsOptions] = js.native
  ...
  /**
    ...
    * positive/negative.
    */
  var volumeDivision: js.UndefOr[PlotVbpVolumeDivisionOptions] = js.native
  ...
  /**
    ...
    */
  var zoneLines: js.UndefOr[PlotVbpZoneLinesOptions] = js.native
...
object PlotVbpOptions {
  ...
  @scala.inline
  def apply(): PlotVbpOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpOptions]
  }
  
  @scala.inline
  implicit class PlotVbpOptionsMutableBuilder[Self <: PlotVbpOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVbpAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotVbpDataLabelsOptions | js.Array[PlotVbpDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotVbpDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotVbpDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotVbpParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVolumeDivision(value: PlotVbpVolumeDivisionOptions): Self = StObject.set(x, "volumeDivision", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVolumeDivisionUndefined: Self = StObject.set(x, "volumeDivision", js.undefined)
    ...
    @scala.inline
    def setZoneLines(value: PlotVbpZoneLinesOptions): Self = StObject.set(x, "zoneLines", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setZoneLinesUndefined: Self = StObject.set(x, "zoneLines", js.undefined)
