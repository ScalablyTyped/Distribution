...
trait PlotVbpOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotVbpAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotVbpDataLabelsOptions | js.Array[PlotVbpDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotVbpDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotVbpOnPointOptions] = js.undefined
...
object PlotVbpOptions {
  ...
  inline def apply(): PlotVbpOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpOptions]
  }
  
  extension [Self <: PlotVbpOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotVbpAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotVbpDataLabelsOptions | js.Array[PlotVbpDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotVbpDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotVbpDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotVbpOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotVbpParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    inline def setVolumeDivision(value: PlotVbpVolumeDivisionOptions): Self = StObject.set(x, "volumeDivision", value.asInstanceOf[js.Any])
    
    inline def setVolumeDivisionUndefined: Self = StObject.set(x, "volumeDivision", js.undefined)
    ...
    inline def setZoneLines(value: PlotVbpZoneLinesOptions): Self = StObject.set(x, "zoneLines", value.asInstanceOf[js.Any])
    
    inline def setZoneLinesUndefined: Self = StObject.set(x, "zoneLines", js.undefined)
