...
object PlotVbpOptions {
  ...
  @scala.inline
  implicit class PlotVbpOptionsOps[Self <: PlotVbpOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVbpAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotVbpDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotVbpDataLabelsOptions | js.Array[PlotVbpDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotVbpDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotVbpParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVolumeDivision(value: PlotVbpVolumeDivisionOptions): Self = this.set("volumeDivision", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteVolumeDivision: Self = this.set("volumeDivision", js.undefined)
    ...
    @scala.inline
    def setZoneLines(value: PlotVbpZoneLinesOptions): Self = this.set("zoneLines", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteZoneLines: Self = this.set("zoneLines", js.undefined)
