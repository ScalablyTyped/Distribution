...
trait PlotPivotpointsSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
