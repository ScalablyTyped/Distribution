...
trait PlotPyramid3dSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
