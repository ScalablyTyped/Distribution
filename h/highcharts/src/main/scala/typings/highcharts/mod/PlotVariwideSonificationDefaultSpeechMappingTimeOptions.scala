...
trait PlotVariwideSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotVariwideSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
