...
trait PlotHlcSonificationTracksMappingPitchOptions extends StObject {
...
object PlotHlcSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotHlcSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHlcSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
