...
trait PlotPcSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotPcSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotPcSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
