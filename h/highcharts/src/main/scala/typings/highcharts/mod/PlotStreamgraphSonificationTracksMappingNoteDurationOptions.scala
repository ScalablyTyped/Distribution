...
trait PlotStreamgraphSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
