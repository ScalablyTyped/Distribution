...
trait PlotMapbubbleOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotMapbubbleSonificationOptions] = js.undefined
...
object PlotMapbubbleOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotMapbubbleSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
