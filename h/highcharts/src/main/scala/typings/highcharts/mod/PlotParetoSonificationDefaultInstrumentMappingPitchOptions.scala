...
trait PlotParetoSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotParetoSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotParetoSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
