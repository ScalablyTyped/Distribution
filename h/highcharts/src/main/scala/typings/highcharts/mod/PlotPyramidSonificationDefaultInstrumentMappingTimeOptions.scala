...
trait PlotPyramidSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotPyramidSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
