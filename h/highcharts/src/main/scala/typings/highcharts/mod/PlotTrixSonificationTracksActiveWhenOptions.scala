...
trait PlotTrixSonificationTracksActiveWhenOptions extends StObject {
...
object PlotTrixSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotTrixSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
