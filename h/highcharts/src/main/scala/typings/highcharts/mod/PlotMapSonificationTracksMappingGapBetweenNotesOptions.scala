...
trait PlotMapSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotMapSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
