...
trait PlotStochasticDataGroupingOptions extends js.Object {
  /**
...
object PlotStochasticDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStochasticDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticDataGroupingOptions]
  }
}
