...
trait PlotGeoheatmapSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
