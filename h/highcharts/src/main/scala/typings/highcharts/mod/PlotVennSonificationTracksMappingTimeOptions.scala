...
trait PlotVennSonificationTracksMappingTimeOptions extends StObject {
...
object PlotVennSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
