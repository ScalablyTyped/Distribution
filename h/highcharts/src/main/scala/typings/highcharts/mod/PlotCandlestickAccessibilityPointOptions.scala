...
trait PlotCandlestickAccessibilityPointOptions extends StObject {
...
object PlotCandlestickAccessibilityPointOptions {
  
  inline def apply(): PlotCandlestickAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickAccessibilityPointOptions] (val x: Self) extends AnyVal {
