...
trait PlotPcAccessibilityPointOptions extends StObject {
...
object PlotPcAccessibilityPointOptions {
  
  inline def apply(): PlotPcAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcAccessibilityPointOptions] (val x: Self) extends AnyVal {
