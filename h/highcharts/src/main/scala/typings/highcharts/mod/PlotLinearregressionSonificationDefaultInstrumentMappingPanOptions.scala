...
trait PlotLinearregressionSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotLinearregressionSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotLinearregressionSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
