...
trait SeriesXrangeDataEventsOptions extends js.Object {
  /**
...
object SeriesXrangeDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesXrangeDataEventsOptions]
  }
}
