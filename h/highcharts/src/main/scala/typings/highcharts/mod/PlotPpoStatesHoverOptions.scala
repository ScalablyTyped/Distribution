...
trait PlotPpoStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPpoStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPpoStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotPpoStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPpoStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotPpoStatesHoverOptions]
  }
}
