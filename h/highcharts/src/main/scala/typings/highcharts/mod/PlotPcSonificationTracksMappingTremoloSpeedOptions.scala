...
trait PlotPcSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPcSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
