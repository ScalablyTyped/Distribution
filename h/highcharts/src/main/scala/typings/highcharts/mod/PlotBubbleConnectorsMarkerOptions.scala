...
trait PlotBubbleConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotBubbleConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBubbleConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleConnectorsMarkerOptions]
  }
}
