...
trait SonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object SonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): SonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
