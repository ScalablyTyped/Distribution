...
trait PlotTemaSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotTemaSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotTemaSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
