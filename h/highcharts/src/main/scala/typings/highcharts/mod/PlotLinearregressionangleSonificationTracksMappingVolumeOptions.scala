...
trait PlotLinearregressionangleSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
