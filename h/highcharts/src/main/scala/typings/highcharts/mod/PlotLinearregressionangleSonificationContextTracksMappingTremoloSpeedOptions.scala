...
trait PlotLinearregressionangleSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
