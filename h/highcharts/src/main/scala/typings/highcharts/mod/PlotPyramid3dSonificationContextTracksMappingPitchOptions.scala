...
trait PlotPyramid3dSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
