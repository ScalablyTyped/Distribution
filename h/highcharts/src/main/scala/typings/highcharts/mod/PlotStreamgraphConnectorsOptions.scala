...
trait PlotStreamgraphConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotStreamgraphConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotStreamgraphConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotStreamgraphConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotStreamgraphConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotStreamgraphConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotStreamgraphConnectorsMarkerOptions = null,
    startMarker: PlotStreamgraphConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotStreamgraphConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphConnectorsOptions]
  }
}
