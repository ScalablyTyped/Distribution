...
trait PlotStochasticSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotStochasticSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
