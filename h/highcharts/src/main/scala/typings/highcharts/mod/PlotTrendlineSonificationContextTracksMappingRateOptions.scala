...
trait PlotTrendlineSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
