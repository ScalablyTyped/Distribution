...
trait PlotPsarSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotPsarSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotPsarSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
