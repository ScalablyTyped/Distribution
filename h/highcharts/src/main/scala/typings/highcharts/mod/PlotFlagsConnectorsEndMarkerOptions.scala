...
trait PlotFlagsConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotFlagsConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotFlagsConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotFlagsConnectorsEndMarkerOptions]
  }
}
