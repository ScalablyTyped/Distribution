...
trait PlotPpoSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotPpoSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotPpoSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
