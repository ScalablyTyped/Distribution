...
trait PlotTrixSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotTrixSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
