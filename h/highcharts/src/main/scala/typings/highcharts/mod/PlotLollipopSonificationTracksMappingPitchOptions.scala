...
trait PlotLollipopSonificationTracksMappingPitchOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
