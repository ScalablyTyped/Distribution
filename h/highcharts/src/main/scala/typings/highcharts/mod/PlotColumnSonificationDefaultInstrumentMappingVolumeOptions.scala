...
trait PlotColumnSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotColumnSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotColumnSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
