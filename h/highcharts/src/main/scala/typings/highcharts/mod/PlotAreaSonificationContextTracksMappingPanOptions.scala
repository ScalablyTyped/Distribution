...
trait PlotAreaSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotAreaSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotAreaSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
