...
trait PlotSlowstochasticSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
