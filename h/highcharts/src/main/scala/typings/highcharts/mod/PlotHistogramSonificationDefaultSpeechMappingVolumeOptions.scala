...
trait PlotHistogramSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotHistogramSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotHistogramSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
