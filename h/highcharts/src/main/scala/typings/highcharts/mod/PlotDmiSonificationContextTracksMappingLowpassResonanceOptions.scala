...
trait PlotDmiSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
