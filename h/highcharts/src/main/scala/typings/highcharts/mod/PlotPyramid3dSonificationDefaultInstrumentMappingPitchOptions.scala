...
trait PlotPyramid3dSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
