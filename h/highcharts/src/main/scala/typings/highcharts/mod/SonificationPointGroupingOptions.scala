...
trait SonificationPointGroupingOptions extends StObject {
...
object SonificationPointGroupingOptions {
  
  inline def apply(): SonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationPointGroupingOptions] (val x: Self) extends AnyVal {
