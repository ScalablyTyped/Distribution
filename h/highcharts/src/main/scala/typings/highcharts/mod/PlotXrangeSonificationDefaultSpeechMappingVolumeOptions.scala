...
trait PlotXrangeSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotXrangeSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
