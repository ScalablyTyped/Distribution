...
trait PlotPictorialSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
