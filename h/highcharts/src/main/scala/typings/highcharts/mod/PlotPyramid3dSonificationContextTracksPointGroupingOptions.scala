...
trait PlotPyramid3dSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
