...
trait PlotSolidgaugeAccessibilityPointOptions extends StObject {
...
object PlotSolidgaugeAccessibilityPointOptions {
  
  inline def apply(): PlotSolidgaugeAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSolidgaugeAccessibilityPointOptions] (val x: Self) extends AnyVal {
