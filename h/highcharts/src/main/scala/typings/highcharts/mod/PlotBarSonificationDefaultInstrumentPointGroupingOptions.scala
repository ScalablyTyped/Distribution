...
trait PlotBarSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotBarSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotBarSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
