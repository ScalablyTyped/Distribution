...
trait PlotPolygonSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
