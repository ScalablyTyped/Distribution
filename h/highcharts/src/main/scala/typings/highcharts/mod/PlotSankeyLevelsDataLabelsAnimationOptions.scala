...
@js.native
trait PlotSankeyLevelsDataLabelsAnimationOptions extends js.Object {
...
object PlotSankeyLevelsDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotSankeyLevelsDataLabelsAnimationOptionsOps[Self <: PlotSankeyLevelsDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
