...
trait PlotLinearregressioninterceptSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
