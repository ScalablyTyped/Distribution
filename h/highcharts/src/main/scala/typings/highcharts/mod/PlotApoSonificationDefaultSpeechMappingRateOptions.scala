...
trait PlotApoSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotApoSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotApoSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
