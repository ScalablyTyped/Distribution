...
trait PlotMaplineClusterZonesOptions extends StObject {
...
object PlotMaplineClusterZonesOptions {
  
  inline def apply(): PlotMaplineClusterZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineClusterZonesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineClusterZonesOptions] (val x: Self) extends AnyVal {
