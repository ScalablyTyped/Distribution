...
@js.native
trait PlotTrixDataSortingOptions extends js.Object {
  /**
...
object PlotTrixDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotTrixDataSortingOptionsOps[Self <: PlotTrixDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
