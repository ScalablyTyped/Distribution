...
trait PlotTrixDataSortingOptions extends StObject {
...
object PlotTrixDataSortingOptions {
  
  @scala.inline
  def apply(): PlotTrixDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotTrixDataSortingOptionsMutableBuilder[Self <: PlotTrixDataSortingOptions] (val x: Self) extends AnyVal {
