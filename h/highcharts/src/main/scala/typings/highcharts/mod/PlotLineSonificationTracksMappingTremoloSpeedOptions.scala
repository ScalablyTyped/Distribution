...
trait PlotLineSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotLineSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
