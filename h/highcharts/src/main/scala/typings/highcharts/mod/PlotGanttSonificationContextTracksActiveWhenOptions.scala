...
trait PlotGanttSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotGanttSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
