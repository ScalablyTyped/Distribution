...
trait PlotEmaPointEventsOptions extends js.Object {
  /**
...
object PlotEmaPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotEmaPointEventsOptions]
  }
}
