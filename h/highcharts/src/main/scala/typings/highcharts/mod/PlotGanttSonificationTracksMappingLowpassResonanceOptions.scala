...
trait PlotGanttSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotGanttSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
