...
trait PlotAtrSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotAtrSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
