...
trait PlotDumbbellSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotDumbbellSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
