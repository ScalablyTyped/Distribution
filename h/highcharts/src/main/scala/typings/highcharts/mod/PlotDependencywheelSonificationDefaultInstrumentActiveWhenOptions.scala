...
trait PlotDependencywheelSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotDependencywheelSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotDependencywheelSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
