...
trait PlotArcdiagramSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
