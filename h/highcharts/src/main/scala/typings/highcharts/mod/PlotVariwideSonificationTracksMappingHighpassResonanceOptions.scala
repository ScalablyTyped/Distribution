...
trait PlotVariwideSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
