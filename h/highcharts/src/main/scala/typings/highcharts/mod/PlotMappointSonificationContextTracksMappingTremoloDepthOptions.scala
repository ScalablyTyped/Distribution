...
trait PlotMappointSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotMappointSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
