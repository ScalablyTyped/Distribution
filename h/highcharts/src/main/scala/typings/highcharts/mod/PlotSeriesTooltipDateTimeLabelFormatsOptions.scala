...
trait PlotSeriesTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotSeriesTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotSeriesTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesTooltipDateTimeLabelFormatsOptions]
  }
}
