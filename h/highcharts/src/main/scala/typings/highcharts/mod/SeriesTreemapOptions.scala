...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesTreemapOptions extends PlotTreemapOptions {
  /**
...
object SeriesTreemapOptions {
  ...
  def apply(
    ...
    cluster: PlotTreemapClusterOptions = null,
    ...
    dataLabels: PlotTreemapDataLabelsOptions | js.Array[PlotTreemapDataLabelsOptions] = null,
