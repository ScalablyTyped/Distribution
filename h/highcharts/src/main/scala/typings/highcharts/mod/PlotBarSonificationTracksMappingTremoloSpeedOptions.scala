...
trait PlotBarSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotBarSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
