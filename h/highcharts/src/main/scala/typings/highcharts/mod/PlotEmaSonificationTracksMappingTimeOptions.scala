...
trait PlotEmaSonificationTracksMappingTimeOptions extends StObject {
...
object PlotEmaSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
