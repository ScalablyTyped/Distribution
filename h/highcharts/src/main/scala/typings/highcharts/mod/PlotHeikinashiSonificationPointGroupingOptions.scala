...
trait PlotHeikinashiSonificationPointGroupingOptions extends StObject {
...
object PlotHeikinashiSonificationPointGroupingOptions {
  
  inline def apply(): PlotHeikinashiSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeikinashiSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeikinashiSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
