...
trait PlotHeatmapSonificationTracksOptions extends StObject {
  
  /**
    * (Highcharts, Highmaps) Define a condition for when a track should be
    * active and not.
    *
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotHeatmapSonificationTracksActiveWhenOptions] = js.undefined
  
  /**
    * (Highcharts, Highmaps) Instrument to use for playing.
    *
  ...
  /**
    * (Highcharts, Highmaps) Mapping options for the audio parameters.
    *
    ...
    */
  var mapping: js.UndefOr[PlotHeatmapSonificationTracksMappingOptions] = js.undefined
  
  /**
    * (Highcharts, Highmaps) Name to use for a track when exporting to MIDI. By
    * default it uses the series name if the track is related to a series.
    */
  var midiName: js.UndefOr[String] = js.undefined
  
  /**
    * (Highcharts, Highmaps) Options for point grouping, specifically for
    * instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotHeatmapSonificationTracksPointGroupingOptions] = js.undefined
  
  /**
    * (Highcharts, Highmaps) Round pitch mapping to musical notes.
    *
  ...
  /**
    * (Highcharts, Highmaps) Show play marker (tooltip and/or crosshair) for a
    * track.
    */
  var showPlayMarker: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Highcharts, Highmaps) Type of track. Always `"instrument"` for
    * instrument tracks, and `"speech"` for speech tracks.
    */
  var `type`: js.UndefOr[OptionsTypeValue] = js.undefined
}
object PlotHeatmapSonificationTracksOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotHeatmapSonificationTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotHeatmapSonificationTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotHeatmapSonificationTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
