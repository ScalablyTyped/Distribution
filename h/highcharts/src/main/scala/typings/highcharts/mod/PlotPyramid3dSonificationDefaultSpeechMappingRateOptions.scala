...
trait PlotPyramid3dSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
