...
trait PlotCandlestickSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
