...
trait PlotPivotpointsSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
