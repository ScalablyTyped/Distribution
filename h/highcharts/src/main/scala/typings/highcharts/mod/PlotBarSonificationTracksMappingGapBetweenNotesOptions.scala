...
trait PlotBarSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotBarSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
