...
trait PlotTimelineSonificationContextTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
