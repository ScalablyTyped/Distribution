...
trait PlotBubbleSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
