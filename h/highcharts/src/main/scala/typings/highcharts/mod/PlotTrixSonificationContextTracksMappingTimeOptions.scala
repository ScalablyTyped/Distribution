...
trait PlotTrixSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
