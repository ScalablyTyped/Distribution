...
trait PlotWordcloudSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotWordcloudSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
