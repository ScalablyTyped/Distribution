...
trait PlotBulletSonificationDefaultInstrumentMappingLowpassResonanceOptions extends StObject {
...
object PlotBulletSonificationDefaultInstrumentMappingLowpassResonanceOptions {
  
  inline def apply(): PlotBulletSonificationDefaultInstrumentMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationDefaultInstrumentMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationDefaultInstrumentMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
