...
trait PlotEmaSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotEmaSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotEmaSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
