...
trait PlotColumnSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotColumnSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
