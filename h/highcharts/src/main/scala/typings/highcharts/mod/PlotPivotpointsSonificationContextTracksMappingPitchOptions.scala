...
trait PlotPivotpointsSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
