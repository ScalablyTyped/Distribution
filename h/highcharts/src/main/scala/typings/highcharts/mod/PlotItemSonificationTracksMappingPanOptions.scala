...
trait PlotItemSonificationTracksMappingPanOptions extends StObject {
...
object PlotItemSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
