...
trait PlotBarSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotBarSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
