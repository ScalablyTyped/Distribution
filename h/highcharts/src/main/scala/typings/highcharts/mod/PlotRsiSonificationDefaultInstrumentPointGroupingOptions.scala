...
trait PlotRsiSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotRsiSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotRsiSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
