...
trait PlotLinearregressionSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotLinearregressionSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressionSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
