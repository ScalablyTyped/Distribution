...
trait PlotSankeySonificationTracksMappingRateOptions extends StObject {
...
object PlotSankeySonificationTracksMappingRateOptions {
  
  inline def apply(): PlotSankeySonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeySonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeySonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
