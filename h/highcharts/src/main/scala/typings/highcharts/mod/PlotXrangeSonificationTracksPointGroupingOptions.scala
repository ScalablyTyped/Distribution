...
trait PlotXrangeSonificationTracksPointGroupingOptions extends StObject {
  
  /**
    * (Highcharts, Highstock, Gantt) The grouping algorithm, deciding which
    * points to keep when grouping a set of points together. By default
  ...
  /**
    * (Highcharts, Highstock, Gantt) Whether or not to group points
    */
  var enabled: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) The size of each group in milliseconds.
    * Audio events closer than this are grouped together.
    */
  var groupTimespan: js.UndefOr[Double] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) The data property for each point to
    * compare when deciding which points to keep in the group.
    *
...
object PlotXrangeSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotXrangeSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
