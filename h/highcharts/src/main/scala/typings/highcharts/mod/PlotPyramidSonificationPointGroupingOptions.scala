...
trait PlotPyramidSonificationPointGroupingOptions extends StObject {
...
object PlotPyramidSonificationPointGroupingOptions {
  
  inline def apply(): PlotPyramidSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
