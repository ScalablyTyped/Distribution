...
trait SeriesGeoheatmapDataGeometryOptions extends StObject {
...
object SeriesGeoheatmapDataGeometryOptions {
  
  inline def apply(): SeriesGeoheatmapDataGeometryOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesGeoheatmapDataGeometryOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesGeoheatmapDataGeometryOptions] (val x: Self) extends AnyVal {
