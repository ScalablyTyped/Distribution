...
trait PlotZigzagSonificationTracksMappingRateOptions extends StObject {
...
object PlotZigzagSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotZigzagSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotZigzagSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
