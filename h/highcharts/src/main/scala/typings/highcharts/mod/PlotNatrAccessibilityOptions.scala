...
trait PlotNatrAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotNatrAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotNatrAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotNatrAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotNatrAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotNatrAccessibilityOptions]
  }
}
