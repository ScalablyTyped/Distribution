...
trait PlotHeatmapSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotHeatmapSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
