...
trait PlotLineSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotLineSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotLineSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
