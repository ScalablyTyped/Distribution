...
trait PlotErrorbarSonificationTracksPointGroupingOptions extends StObject {
...
object PlotErrorbarSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotErrorbarSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotErrorbarSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
