...
trait PlotFlowmapSonificationTracksMappingRateOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
