...
trait PlotEmaDataSortingOptions extends StObject {
...
object PlotEmaDataSortingOptions {
  
  @scala.inline
  def apply(): PlotEmaDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotEmaDataSortingOptionsMutableBuilder[Self <: PlotEmaDataSortingOptions] (val x: Self) extends AnyVal {
