...
trait PlotTreemapSonificationTracksMappingTimeOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
