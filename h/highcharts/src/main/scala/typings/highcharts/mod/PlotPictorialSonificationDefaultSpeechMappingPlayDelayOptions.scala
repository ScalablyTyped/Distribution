...
trait PlotPictorialSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotPictorialSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
