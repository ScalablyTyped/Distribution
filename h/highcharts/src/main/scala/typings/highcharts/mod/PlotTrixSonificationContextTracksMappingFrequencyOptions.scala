...
trait PlotTrixSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotTrixSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotTrixSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
