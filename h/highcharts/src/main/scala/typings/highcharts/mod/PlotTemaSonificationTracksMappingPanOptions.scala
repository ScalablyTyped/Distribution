...
trait PlotTemaSonificationTracksMappingPanOptions extends StObject {
...
object PlotTemaSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
