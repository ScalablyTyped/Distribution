...
trait PlotWordcloudSonificationPointGroupingOptions extends StObject {
...
object PlotWordcloudSonificationPointGroupingOptions {
  
  inline def apply(): PlotWordcloudSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
