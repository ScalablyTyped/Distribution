...
object EarconOptionsObject {
  ...
  extension [Self <: EarconOptionsObject](x: Self) {
    ...
    inline def setInstrumentsVarargs(value: typings.highcharts.sonificationMod.highchartsAugmentingMod.EarconInstrument*): Self = StObject.set(x, "instruments", js.Array(value :_*))
