...
object EarconOptionsObject {
  ...
  @scala.inline
  def apply(instruments: js.Array[typings.highcharts.sonificationMod.highchartsAugmentingMod.EarconInstrument]): EarconOptionsObject = {
  ...
  implicit class EarconOptionsObjectMutableBuilder[Self <: EarconOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInstruments(value: js.Array[typings.highcharts.sonificationMod.highchartsAugmentingMod.EarconInstrument]): Self = StObject.set(x, "instruments", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInstrumentsVarargs(value: typings.highcharts.sonificationMod.highchartsAugmentingMod.EarconInstrument*): Self = StObject.set(x, "instruments", js.Array(value :_*))
