...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesMfiOptions
  extends StObject
     with PlotMfiOptions {
...
object SeriesMfiOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | mfi): SeriesMfiOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesMfiOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | mfi): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
