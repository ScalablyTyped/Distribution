...
object SeriesMfiOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | mfi): SeriesMfiOptions = {
  ...
  @scala.inline
  implicit class SeriesMfiOptionsMutableBuilder[Self <: SeriesMfiOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | mfi): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
