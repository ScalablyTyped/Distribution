...
object SeriesMfiOptions {
  ...
  @scala.inline
  implicit class SeriesMfiOptionsOps[Self <: SeriesMfiOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | mfi): Self = this.set("type", value.asInstanceOf[js.Any])
