...
trait PlotTemaSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotTemaSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotTemaSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
