...
import typings.highcharts.highchartsStrings.slowstochastic
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesSlowstochasticOptions extends PlotSlowstochasticOptions {
  /**
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | slowstochastic
  /**
...
object SeriesSlowstochasticOptions {
  ...
  def apply(
    ...
    dataLabels: PlotSlowstochasticDataLabelsOptions | js.Array[PlotSlowstochasticDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotSlowstochasticDataSortingOptions = null,
    ...
    params: PlotSlowstochasticParamsOptions = null,
    ...
    smoothedLine: PlotSlowstochasticSmoothedLineOptions = null,
