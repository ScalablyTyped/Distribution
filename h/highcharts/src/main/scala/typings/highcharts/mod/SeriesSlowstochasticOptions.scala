...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesSlowstochasticOptions
  extends StObject
     with PlotSlowstochasticOptions {
...
object SeriesSlowstochasticOptions {
  ...
  inline def apply(`type`: String | slowstochastic): SeriesSlowstochasticOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesSlowstochasticOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | slowstochastic): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
