...
trait PlotIkhSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotIkhSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotIkhSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
