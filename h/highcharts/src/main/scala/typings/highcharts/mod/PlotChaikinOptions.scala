...
trait PlotChaikinOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotChaikinSonificationOptions] = js.undefined
...
object PlotChaikinOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotChaikinOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotChaikinSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
