...
trait PlotPpoSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotPpoSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotPpoSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
