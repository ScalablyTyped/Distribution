...
trait PlotWordcloudSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
