...
trait PlotPriceenvelopesSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
