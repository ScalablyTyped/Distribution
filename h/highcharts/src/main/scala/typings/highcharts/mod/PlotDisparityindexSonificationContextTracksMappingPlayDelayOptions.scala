...
trait PlotDisparityindexSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
