...
trait PlotEmaOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotEmaSonificationOptions] = js.undefined
...
object PlotEmaOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotEmaSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
