...
trait PlotHistogramOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotHistogramSonificationOptions] = js.undefined
...
object PlotHistogramOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotHistogramOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotHistogramSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
