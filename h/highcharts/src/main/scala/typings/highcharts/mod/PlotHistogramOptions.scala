...
trait PlotHistogramOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotHistogramDataLabelsOptions | js.Array[PlotHistogramDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotHistogramDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var pointPlacement: js.UndefOr[String] = js.native
...
object PlotHistogramOptions {
  ...
  @scala.inline
  def apply(): PlotHistogramOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramOptions]
  }
  
  @scala.inline
  implicit class PlotHistogramOptionsMutableBuilder[Self <: PlotHistogramOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotHistogramAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBinsNumber(value: rice | `square-root` | sturges | Double | js.Function): Self = StObject.set(x, "binsNumber", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBinsNumberUndefined: Self = StObject.set(x, "binsNumber", js.undefined)
    ...
    @scala.inline
    def setDataLabels(value: PlotHistogramDataLabelsOptions | js.Array[PlotHistogramDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotHistogramDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotHistogramDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPointPlacement(value: String): Self = StObject.set(x, "pointPlacement", value.asInstanceOf[js.Any])
