...
object PlotHistogramOptions {
  ...
  @scala.inline
  implicit class PlotHistogramOptionsOps[Self <: PlotHistogramOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBinsNumber(value: rice | `square-root` | sturges | Double | js.Function): Self = this.set("binsNumber", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotHistogramDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    @scala.inline
    def setDataLabels(value: PlotHistogramDataLabelsOptions | js.Array[PlotHistogramDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotHistogramDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPointPlacement(value: String): Self = this.set("pointPlacement", value.asInstanceOf[js.Any])
    @scala.inline
