...
trait PlotCmoSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
