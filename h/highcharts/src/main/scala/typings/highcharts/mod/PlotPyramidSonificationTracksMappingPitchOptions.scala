...
trait PlotPyramidSonificationTracksMappingPitchOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
