...
trait PlotPieSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotPieSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotPieSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
