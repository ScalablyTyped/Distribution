...
trait PlotPolygonSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
