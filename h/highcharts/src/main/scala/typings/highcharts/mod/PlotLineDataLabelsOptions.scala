...
trait PlotLineDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotLineDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotLineDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotLineDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotLineDataLabelsOptionsMutableBuilder[Self <: PlotLineDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
