...
@js.native
trait PlotLineDataLabelsOptions extends js.Object {
...
object PlotLineDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotLineDataLabelsOptionsOps[Self <: PlotLineDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLineDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
