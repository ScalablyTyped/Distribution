...
trait PlotEmaSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotEmaSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotEmaSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
