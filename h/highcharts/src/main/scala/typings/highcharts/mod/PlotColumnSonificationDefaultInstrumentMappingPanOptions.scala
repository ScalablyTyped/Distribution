...
trait PlotColumnSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotColumnSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotColumnSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
