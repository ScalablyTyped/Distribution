...
trait PlotStochasticSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
