...
trait PlotSmaSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotSmaSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
