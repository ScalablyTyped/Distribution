...
trait PlotGaugeSonificationTracksPointGroupingOptions extends StObject {
...
object PlotGaugeSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotGaugeSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
