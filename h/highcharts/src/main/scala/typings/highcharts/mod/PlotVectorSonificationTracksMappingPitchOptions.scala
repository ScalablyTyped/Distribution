...
trait PlotVectorSonificationTracksMappingPitchOptions extends StObject {
...
object PlotVectorSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotVectorSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVectorSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
