...
trait PlotLinearregressionangleSonificationTracksMappingRateOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
