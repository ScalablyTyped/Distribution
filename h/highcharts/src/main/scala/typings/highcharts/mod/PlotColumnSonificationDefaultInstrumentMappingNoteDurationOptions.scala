...
trait PlotColumnSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotColumnSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotColumnSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
