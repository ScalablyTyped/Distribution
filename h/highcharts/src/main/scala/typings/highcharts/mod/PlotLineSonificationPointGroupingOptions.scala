...
trait PlotLineSonificationPointGroupingOptions extends StObject {
...
object PlotLineSonificationPointGroupingOptions {
  
  inline def apply(): PlotLineSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
