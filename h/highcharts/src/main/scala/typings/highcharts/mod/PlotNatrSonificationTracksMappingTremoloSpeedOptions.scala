...
trait PlotNatrSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotNatrSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
