...
trait ChartParallelAxesPlotLinesEventsOptions extends StObject {
...
object ChartParallelAxesPlotLinesEventsOptions {
  
  inline def apply(): ChartParallelAxesPlotLinesEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesPlotLinesEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartParallelAxesPlotLinesEventsOptions] (val x: Self) extends AnyVal {
