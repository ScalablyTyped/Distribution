...
trait PlotPictorialSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotPictorialSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
