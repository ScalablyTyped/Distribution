...
trait PlotVariwideAccessibilityPointOptions extends StObject {
...
object PlotVariwideAccessibilityPointOptions {
  
  inline def apply(): PlotVariwideAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideAccessibilityPointOptions] (val x: Self) extends AnyVal {
