...
trait PlotBulletSonificationTracksMappingTimeOptions extends StObject {
...
object PlotBulletSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
