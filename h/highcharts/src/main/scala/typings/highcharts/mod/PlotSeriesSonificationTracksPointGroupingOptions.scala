...
trait PlotSeriesSonificationTracksPointGroupingOptions extends StObject {
...
object PlotSeriesSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotSeriesSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
