...
trait PlotMappointSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotMappointSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
