...
trait PlotPyramidSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotPyramidSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
