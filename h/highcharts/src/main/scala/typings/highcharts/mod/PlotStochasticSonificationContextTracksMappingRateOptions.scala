...
trait PlotStochasticSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotStochasticSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
