...
trait PlotCylinderSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotCylinderSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
