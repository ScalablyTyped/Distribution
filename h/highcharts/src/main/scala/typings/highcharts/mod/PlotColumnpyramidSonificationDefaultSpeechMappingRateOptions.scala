...
trait PlotColumnpyramidSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
