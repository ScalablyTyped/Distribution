...
trait PlotLineSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotLineSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotLineSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
