...
trait PlotArearangeSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
