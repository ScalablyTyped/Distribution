...
trait PlotBulletSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotBulletSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
