...
trait PlotCandlestickSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
