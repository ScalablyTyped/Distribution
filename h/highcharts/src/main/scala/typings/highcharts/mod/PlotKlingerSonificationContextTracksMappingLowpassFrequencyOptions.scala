...
trait PlotKlingerSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotKlingerSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
