...
trait PlotLinearregressionangleSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
