...
trait PlotDisparityindexSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
