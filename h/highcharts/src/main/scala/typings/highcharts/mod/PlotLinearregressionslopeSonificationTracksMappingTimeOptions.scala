...
trait PlotLinearregressionslopeSonificationTracksMappingTimeOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
