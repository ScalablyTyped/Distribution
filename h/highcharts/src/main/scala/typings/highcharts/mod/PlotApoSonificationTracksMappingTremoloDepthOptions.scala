...
trait PlotApoSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotApoSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
