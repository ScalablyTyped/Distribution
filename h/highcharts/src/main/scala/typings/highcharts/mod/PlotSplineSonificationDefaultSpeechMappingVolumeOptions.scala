...
trait PlotSplineSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotSplineSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotSplineSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
