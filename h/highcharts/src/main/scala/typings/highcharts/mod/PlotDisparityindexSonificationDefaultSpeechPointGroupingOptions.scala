...
trait PlotDisparityindexSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
