...
trait PlotAroonoscillatorSonificationContextTracksMappingOptions extends StObject {
  
  /**
    * (Highstock) Frequency in Hertz of notes. Overrides pitch mapping if set.
    */
  var frequency: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingFrequencyOptions
  ] = js.undefined
  ...
  var gapBetweenNotes: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingGapBetweenNotesOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var highpass: js.UndefOr[PlotAroonoscillatorSonificationContextTracksMappingHighpassOptions] = js.undefined
  ...
  /**
    ...
    */
  var lowpass: js.UndefOr[PlotAroonoscillatorSonificationContextTracksMappingLowpassOptions] = js.undefined
  ...
  var noteDuration: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingNoteDurationOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var pan: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingPanOptions
  ] = js.undefined
  ...
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingPitchOptions | (js.Array[String | Double])
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingPlayDelayOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var rate: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingRateOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingTimeOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var tremolo: js.UndefOr[PlotAroonoscillatorSonificationContextTracksMappingTremoloOptions] = js.undefined
  
  /**
    * (Highstock) The volume of notes, from 0 to 1.
    */
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingVolumeOptions
  ] = js.undefined
}
object PlotAroonoscillatorSonificationContextTracksMappingOptions {
  
  inline def apply(): PlotAroonoscillatorSonificationContextTracksMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorSonificationContextTracksMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonoscillatorSonificationContextTracksMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setFrequency(
      value: Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingFrequencyOptions
    ): Self = StObject.set(x, "frequency", value.asInstanceOf[js.Any])
    
    inline def setFrequencyUndefined: Self = StObject.set(x, "frequency", js.undefined)
    
    inline def setGapBetweenNotes(
      value: Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingGapBetweenNotesOptions
    ...
    inline def setHighpass(value: PlotAroonoscillatorSonificationContextTracksMappingHighpassOptions): Self = StObject.set(x, "highpass", value.asInstanceOf[js.Any])
    
    inline def setHighpassUndefined: Self = StObject.set(x, "highpass", js.undefined)
    
    inline def setLowpass(value: PlotAroonoscillatorSonificationContextTracksMappingLowpassOptions): Self = StObject.set(x, "lowpass", value.asInstanceOf[js.Any])
    
    inline def setLowpassUndefined: Self = StObject.set(x, "lowpass", js.undefined)
    
    inline def setNoteDuration(
      value: Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingNoteDurationOptions
    ...
    inline def setPan(
      value: Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingPanOptions
    ): Self = StObject.set(x, "pan", value.asInstanceOf[js.Any])
    
    inline def setPanUndefined: Self = StObject.set(x, "pan", js.undefined)
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingPitchOptions | (js.Array[String | Double])
    ...
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingPlayDelayOptions
    ...
    inline def setRate(
      value: Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingRateOptions
    ...
    inline def setTime(
      value: Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingTimeOptions
    ): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setTremolo(value: PlotAroonoscillatorSonificationContextTracksMappingTremoloOptions): Self = StObject.set(x, "tremolo", value.asInstanceOf[js.Any])
    
    inline def setTremoloUndefined: Self = StObject.set(x, "tremolo", js.undefined)
    
    inline def setVolume(
      value: Double | js.Object | String | js.Function | PlotAroonoscillatorSonificationContextTracksMappingVolumeOptions
