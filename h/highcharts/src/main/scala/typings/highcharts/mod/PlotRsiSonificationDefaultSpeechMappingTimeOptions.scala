...
trait PlotRsiSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotRsiSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotRsiSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
