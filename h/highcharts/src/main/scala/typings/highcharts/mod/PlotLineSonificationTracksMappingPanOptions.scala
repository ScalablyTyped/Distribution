...
trait PlotLineSonificationTracksMappingPanOptions extends StObject {
...
object PlotLineSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
