...
trait PlotSupertrendSonificationDefaultInstrumentMappingLowpassFrequencyOptions extends StObject {
...
object PlotSupertrendSonificationDefaultInstrumentMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotSupertrendSonificationDefaultInstrumentMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationDefaultInstrumentMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationDefaultInstrumentMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
