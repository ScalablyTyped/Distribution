...
trait PlotPivotpointsSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
