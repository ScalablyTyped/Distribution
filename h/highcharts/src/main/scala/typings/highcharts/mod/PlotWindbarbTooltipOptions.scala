...
trait PlotWindbarbTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotWindbarbTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotWindbarbTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    dateTimeLabelFormats: PlotWindbarbTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
    ...
    __obj.asInstanceOf[PlotWindbarbTooltipOptions]
  }
}
