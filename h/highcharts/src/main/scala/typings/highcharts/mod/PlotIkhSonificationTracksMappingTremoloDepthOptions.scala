...
trait PlotIkhSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotIkhSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
