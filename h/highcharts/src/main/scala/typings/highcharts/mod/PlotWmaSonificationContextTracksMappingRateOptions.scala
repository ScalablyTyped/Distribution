...
trait PlotWmaSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotWmaSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
