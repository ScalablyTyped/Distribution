...
trait PlotCmoSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
