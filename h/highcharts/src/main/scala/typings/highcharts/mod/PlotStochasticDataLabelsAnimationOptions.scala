...
@js.native
trait PlotStochasticDataLabelsAnimationOptions extends js.Object {
...
object PlotStochasticDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotStochasticDataLabelsAnimationOptionsOps[Self <: PlotStochasticDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
