...
trait PlotDmiSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
