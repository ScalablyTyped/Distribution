...
trait PlotTreemapSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotTreemapSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
