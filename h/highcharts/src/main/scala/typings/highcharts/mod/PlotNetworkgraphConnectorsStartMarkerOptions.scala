...
trait PlotNetworkgraphConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotNetworkgraphConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNetworkgraphConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphConnectorsStartMarkerOptions]
  }
}
