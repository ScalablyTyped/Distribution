...
trait PlotAreaSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotAreaSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotAreaSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
