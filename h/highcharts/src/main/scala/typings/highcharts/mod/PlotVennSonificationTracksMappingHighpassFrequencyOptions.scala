...
trait PlotVennSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotVennSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
