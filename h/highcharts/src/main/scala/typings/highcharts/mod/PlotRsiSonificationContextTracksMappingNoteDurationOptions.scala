...
trait PlotRsiSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotRsiSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
