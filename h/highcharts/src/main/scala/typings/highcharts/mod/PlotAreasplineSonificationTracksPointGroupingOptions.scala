...
trait PlotAreasplineSonificationTracksPointGroupingOptions extends StObject {
...
object PlotAreasplineSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotAreasplineSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplineSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplineSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
