...
trait PlotLinearregressionslopeSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
