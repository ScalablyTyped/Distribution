...
trait PlotAtrSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
