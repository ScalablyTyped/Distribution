...
trait PlotTrendlineSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
