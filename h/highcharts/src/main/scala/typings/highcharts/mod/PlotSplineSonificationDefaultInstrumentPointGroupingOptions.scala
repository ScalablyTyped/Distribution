...
trait PlotSplineSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotSplineSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotSplineSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
