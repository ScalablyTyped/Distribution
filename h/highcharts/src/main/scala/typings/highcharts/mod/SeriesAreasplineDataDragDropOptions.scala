...
trait SeriesAreasplineDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesAreasplineDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesAreasplineDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesAreasplineDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesAreasplineDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesAreasplineDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesAreasplineDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesAreasplineDataDragDropOptions]
  }
}
