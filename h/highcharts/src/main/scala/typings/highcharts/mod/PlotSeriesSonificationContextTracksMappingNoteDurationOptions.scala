...
trait PlotSeriesSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
