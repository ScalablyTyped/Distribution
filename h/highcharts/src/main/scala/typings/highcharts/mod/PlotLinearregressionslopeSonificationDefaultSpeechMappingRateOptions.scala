...
trait PlotLinearregressionslopeSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
