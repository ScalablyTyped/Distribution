...
trait PlotPieSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotPieSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPieSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
