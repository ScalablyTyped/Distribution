...
trait PlotPcSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPcSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPcSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
