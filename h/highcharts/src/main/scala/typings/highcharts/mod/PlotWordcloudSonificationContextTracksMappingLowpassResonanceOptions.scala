...
trait PlotWordcloudSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
