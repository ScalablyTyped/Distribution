...
trait PlotSplineSonificationTracksPointGroupingOptions extends StObject {
...
object PlotSplineSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotSplineSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
