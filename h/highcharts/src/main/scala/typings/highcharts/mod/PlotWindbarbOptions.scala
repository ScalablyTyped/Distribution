...
trait PlotWindbarbOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotWindbarbSonificationOptions] = js.undefined
...
object PlotWindbarbOptions {
  ...
  inline def apply(): PlotWindbarbOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataLabels(value: PlotWindbarbDataLabelsOptions | js.Array[PlotWindbarbDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    ...
    inline def setOnSeriesNull: Self = StObject.set(x, "onSeries", null)
    ...
    inline def setSonification(value: PlotWindbarbSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
