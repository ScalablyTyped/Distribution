...
trait PlotTrendlineSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
