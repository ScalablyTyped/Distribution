...
trait PlotIkhSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotIkhSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotIkhSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
