...
trait PlotPyramidSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPyramidSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
