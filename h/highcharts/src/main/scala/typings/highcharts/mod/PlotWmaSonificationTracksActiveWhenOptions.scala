...
trait PlotWmaSonificationTracksActiveWhenOptions extends StObject {
...
object PlotWmaSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotWmaSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
