...
trait PlotAoSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotAoSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
