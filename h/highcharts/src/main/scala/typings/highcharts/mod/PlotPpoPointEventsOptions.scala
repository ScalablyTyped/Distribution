...
trait PlotPpoPointEventsOptions extends js.Object {
  /**
...
object PlotPpoPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPpoPointEventsOptions]
  }
}
