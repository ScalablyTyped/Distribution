...
trait PlotColumnrangeSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotColumnrangeSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotColumnrangeSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
