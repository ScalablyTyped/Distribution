...
trait PlotTrendlineSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
