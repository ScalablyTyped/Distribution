...
trait PlotVennSonificationDefaultInstrumentMappingHighpassResonanceOptions extends StObject {
...
object PlotVennSonificationDefaultInstrumentMappingHighpassResonanceOptions {
  
  inline def apply(): PlotVennSonificationDefaultInstrumentMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationDefaultInstrumentMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationDefaultInstrumentMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
