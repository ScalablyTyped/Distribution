...
trait PlotLollipopSonificationTracksPointGroupingOptions extends StObject {
...
object PlotLollipopSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotLollipopSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
