...
trait PlotCmoAccessibilityPointOptions extends StObject {
...
object PlotCmoAccessibilityPointOptions {
  
  inline def apply(): PlotCmoAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoAccessibilityPointOptions] (val x: Self) extends AnyVal {
