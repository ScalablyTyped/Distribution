...
@js.native
trait PlotScatter3dDataSortingOptions extends js.Object {
  /**
...
object PlotScatter3dDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotScatter3dDataSortingOptionsOps[Self <: PlotScatter3dDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
