...
trait PlotScatter3dDataSortingOptions extends StObject {
...
object PlotScatter3dDataSortingOptions {
  
  @scala.inline
  def apply(): PlotScatter3dDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotScatter3dDataSortingOptionsMutableBuilder[Self <: PlotScatter3dDataSortingOptions] (val x: Self) extends AnyVal {
