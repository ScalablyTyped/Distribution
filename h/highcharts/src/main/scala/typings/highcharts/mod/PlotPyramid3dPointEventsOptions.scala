...
trait PlotPyramid3dPointEventsOptions extends js.Object {
  /**
...
object PlotPyramid3dPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramid3dPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotPyramid3dPointEventsOptions]
  }
}
