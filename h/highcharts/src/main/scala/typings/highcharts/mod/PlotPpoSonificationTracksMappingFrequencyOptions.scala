...
trait PlotPpoSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotPpoSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
