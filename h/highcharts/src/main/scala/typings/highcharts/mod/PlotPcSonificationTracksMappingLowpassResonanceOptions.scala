...
trait PlotPcSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPcSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
