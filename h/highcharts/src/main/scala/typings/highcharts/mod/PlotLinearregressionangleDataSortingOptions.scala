...
@js.native
trait PlotLinearregressionangleDataSortingOptions extends js.Object {
...
object PlotLinearregressionangleDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotLinearregressionangleDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotLinearregressionangleDataSortingOptionsOps[Self <: PlotLinearregressionangleDataSortingOptions] (val x: Self) extends AnyVal {
