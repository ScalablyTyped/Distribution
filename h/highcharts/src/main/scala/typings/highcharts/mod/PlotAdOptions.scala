...
trait PlotAdOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotAdSonificationOptions] = js.undefined
...
object PlotAdOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotAdSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
