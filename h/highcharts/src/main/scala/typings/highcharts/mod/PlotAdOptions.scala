...
trait PlotAdOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotAdAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotAdDataLabelsOptions | js.Array[PlotAdDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotAdDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotAdParamsOptions] = js.native
