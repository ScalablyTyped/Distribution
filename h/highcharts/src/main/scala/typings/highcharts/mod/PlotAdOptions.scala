...
object PlotAdOptions {
  ...
  @scala.inline
  def apply(): PlotAdOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdOptions]
  }
  
  @scala.inline
  implicit class PlotAdOptionsMutableBuilder[Self <: PlotAdOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAdAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotAdDataLabelsOptions | js.Array[PlotAdDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotAdDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotAdDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotAdParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
