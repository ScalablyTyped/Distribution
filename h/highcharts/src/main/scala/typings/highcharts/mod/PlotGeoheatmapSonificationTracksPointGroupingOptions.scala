...
trait PlotGeoheatmapSonificationTracksPointGroupingOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
