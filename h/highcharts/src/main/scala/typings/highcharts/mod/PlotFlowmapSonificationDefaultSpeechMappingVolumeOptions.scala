...
trait PlotFlowmapSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotFlowmapSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotFlowmapSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
