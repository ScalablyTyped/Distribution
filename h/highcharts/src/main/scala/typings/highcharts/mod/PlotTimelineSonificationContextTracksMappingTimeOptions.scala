...
trait PlotTimelineSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
