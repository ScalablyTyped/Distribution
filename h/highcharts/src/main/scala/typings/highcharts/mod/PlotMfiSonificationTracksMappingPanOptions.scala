...
trait PlotMfiSonificationTracksMappingPanOptions extends StObject {
...
object PlotMfiSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotMfiSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMfiSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMfiSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
