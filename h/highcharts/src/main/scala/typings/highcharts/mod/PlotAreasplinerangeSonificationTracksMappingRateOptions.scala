...
trait PlotAreasplinerangeSonificationTracksMappingRateOptions extends StObject {
...
object PlotAreasplinerangeSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotAreasplinerangeSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplinerangeSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
