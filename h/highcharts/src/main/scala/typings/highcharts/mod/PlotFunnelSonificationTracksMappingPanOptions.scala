...
trait PlotFunnelSonificationTracksMappingPanOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
