...
trait PlotRsiSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotRsiSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
