...
trait PlotPpoSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotPpoSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotPpoSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
