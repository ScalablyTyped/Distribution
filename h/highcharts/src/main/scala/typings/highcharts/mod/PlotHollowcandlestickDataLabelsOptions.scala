...
trait PlotHollowcandlestickDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotHollowcandlestickDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.undefined
...
object PlotHollowcandlestickDataLabelsOptions {
  
  inline def apply(): PlotHollowcandlestickDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickDataLabelsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotHollowcandlestickDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
