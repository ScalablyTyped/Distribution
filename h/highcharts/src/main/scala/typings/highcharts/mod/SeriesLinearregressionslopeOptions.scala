...
import typings.highcharts.highchartsStrings.linearregressionslope
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesLinearregressionslopeOptions
  extends StObject
     with PlotLinearregressionslopeOptions {
...
object SeriesLinearregressionslopeOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | linearregressionslope): SeriesLinearregressionslopeOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesLinearregressionslopeOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | linearregressionslope): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
