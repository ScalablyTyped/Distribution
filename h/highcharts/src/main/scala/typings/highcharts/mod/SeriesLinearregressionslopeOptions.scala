...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesLinearregressionslopeOptions extends PlotLinearregressionslopeOptions {
  /**
    * Not available
    */
