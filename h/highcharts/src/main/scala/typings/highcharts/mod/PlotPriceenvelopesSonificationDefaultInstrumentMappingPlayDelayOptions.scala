...
trait PlotPriceenvelopesSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
