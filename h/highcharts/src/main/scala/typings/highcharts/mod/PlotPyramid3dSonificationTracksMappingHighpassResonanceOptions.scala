...
trait PlotPyramid3dSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
