...
trait PlotSlowstochasticSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
