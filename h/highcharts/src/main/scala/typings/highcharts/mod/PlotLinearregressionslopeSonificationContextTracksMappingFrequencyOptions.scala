...
trait PlotLinearregressionslopeSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotLinearregressionslopeSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
