...
trait PlotLineSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotLineSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
