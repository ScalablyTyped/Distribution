...
trait PlotNatrSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotNatrSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
