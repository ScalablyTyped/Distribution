...
trait PlotCandlestickSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotCandlestickSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
