...
object PlotBarOptions {
  ...
  @scala.inline
  def apply(): PlotBarOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarOptions]
  }
  
  @scala.inline
  implicit class PlotBarOptionsMutableBuilder[Self <: PlotBarOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBarAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotBarDataLabelsOptions | js.Array[PlotBarDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotBarDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotBarDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
