...
@js.native
trait PlotBarOptions extends js.Object {
...
object PlotBarOptions {
  ...
  @scala.inline
  implicit class PlotBarOptionsOps[Self <: PlotBarOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBarAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotBarDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotBarDataLabelsOptions | js.Array[PlotBarDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotBarDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
