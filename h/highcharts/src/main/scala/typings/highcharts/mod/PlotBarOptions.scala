...
trait PlotBarOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotBarAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotBarDataLabelsOptions | js.Array[PlotBarDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotBarDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotBarOnPointOptions] = js.undefined
...
object PlotBarOptions {
  
  inline def apply(): PlotBarOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarOptions]
  }
  
  extension [Self <: PlotBarOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotBarAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotBarDataLabelsOptions | js.Array[PlotBarDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotBarDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotBarDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotBarOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
