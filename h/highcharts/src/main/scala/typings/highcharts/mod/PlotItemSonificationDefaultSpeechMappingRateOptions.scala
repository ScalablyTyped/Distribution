...
trait PlotItemSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotItemSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotItemSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
