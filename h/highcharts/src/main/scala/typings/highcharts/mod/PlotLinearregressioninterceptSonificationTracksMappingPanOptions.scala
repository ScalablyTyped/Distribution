...
trait PlotLinearregressioninterceptSonificationTracksMappingPanOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
