...
trait PlotSeriesSonificationPointGroupingOptions extends StObject {
...
object PlotSeriesSonificationPointGroupingOptions {
  
  inline def apply(): PlotSeriesSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
