...
trait PlotSlowstochasticSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
