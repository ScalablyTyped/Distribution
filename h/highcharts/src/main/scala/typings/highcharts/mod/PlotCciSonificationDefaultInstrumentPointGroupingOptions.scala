...
trait PlotCciSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotCciSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotCciSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
