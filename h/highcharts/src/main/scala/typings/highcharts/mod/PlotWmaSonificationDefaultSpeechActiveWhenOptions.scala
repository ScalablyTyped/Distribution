...
trait PlotWmaSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotWmaSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotWmaSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
