...
trait PlotSupertrendSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
