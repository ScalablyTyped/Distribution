...
trait PlotPivotpointsConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotPivotpointsConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPivotpointsConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsConnectorsStartMarkerOptions]
  }
}
