...
trait PlotPolygonSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
