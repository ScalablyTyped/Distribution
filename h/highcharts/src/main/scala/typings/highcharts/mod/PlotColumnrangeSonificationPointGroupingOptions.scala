...
trait PlotColumnrangeSonificationPointGroupingOptions extends StObject {
...
object PlotColumnrangeSonificationPointGroupingOptions {
  
  inline def apply(): PlotColumnrangeSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
