...
trait PlotPpoSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotPpoSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotPpoSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
