...
trait PlotSunburstSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotSunburstSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotSunburstSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
