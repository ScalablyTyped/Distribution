...
trait PlotAbandsSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotAbandsSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
