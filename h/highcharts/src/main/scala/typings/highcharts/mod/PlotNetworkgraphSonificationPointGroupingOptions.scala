...
trait PlotNetworkgraphSonificationPointGroupingOptions extends StObject {
...
object PlotNetworkgraphSonificationPointGroupingOptions {
  
  inline def apply(): PlotNetworkgraphSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
