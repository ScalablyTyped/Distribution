...
trait PlotVectorConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotVectorConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVectorConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVectorConnectorsMarkerOptions]
  }
}
