...
trait PlotLineSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotLineSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
