...
trait PlotFunnelSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotFunnelSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
