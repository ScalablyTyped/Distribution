...
trait PlotFunnel3dSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
