...
trait PlotVariablepieSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotVariablepieSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
