...
trait PlotSplineSonificationTracksMappingPitchOptions extends StObject {
...
object PlotSplineSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
