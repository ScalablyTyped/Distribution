...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesSmaOptions extends PlotSmaOptions {
  /**
    * Not available
    */
...
object SeriesSmaOptions {
  ...
  def apply(
    ...
    dataLabels: PlotSmaDataLabelsOptions | js.Array[PlotSmaDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotSmaDataSortingOptions = null,
