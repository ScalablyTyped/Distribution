...
@js.native
trait PlotTemaDataLabelsOptions extends js.Object {
...
object PlotTemaDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotTemaDataLabelsOptionsOps[Self <: PlotTemaDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTemaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
