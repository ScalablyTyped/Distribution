...
trait PlotTemaDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotTemaDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotTemaDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotTemaDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotTemaDataLabelsOptionsMutableBuilder[Self <: PlotTemaDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTemaDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
