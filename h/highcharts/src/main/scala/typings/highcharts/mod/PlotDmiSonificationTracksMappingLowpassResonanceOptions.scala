...
trait PlotDmiSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotDmiSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
