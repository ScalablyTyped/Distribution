...
trait PlotTrixSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotTrixSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
