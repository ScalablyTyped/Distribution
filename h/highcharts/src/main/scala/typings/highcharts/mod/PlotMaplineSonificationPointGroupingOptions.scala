...
trait PlotMaplineSonificationPointGroupingOptions extends StObject {
...
object PlotMaplineSonificationPointGroupingOptions {
  
  inline def apply(): PlotMaplineSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
