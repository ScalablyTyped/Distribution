...
trait PlotGeoheatmapSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
