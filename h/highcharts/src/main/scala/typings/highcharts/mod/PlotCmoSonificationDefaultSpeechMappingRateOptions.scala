...
trait PlotCmoSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotCmoSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotCmoSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
