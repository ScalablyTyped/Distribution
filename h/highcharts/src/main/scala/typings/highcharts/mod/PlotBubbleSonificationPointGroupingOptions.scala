...
trait PlotBubbleSonificationPointGroupingOptions extends StObject {
...
object PlotBubbleSonificationPointGroupingOptions {
  
  inline def apply(): PlotBubbleSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
