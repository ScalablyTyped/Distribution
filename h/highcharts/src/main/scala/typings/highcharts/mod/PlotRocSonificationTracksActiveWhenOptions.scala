...
trait PlotRocSonificationTracksActiveWhenOptions extends StObject {
...
object PlotRocSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotRocSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRocSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
