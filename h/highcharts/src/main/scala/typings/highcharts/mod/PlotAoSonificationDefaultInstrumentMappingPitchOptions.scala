...
trait PlotAoSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotAoSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotAoSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
