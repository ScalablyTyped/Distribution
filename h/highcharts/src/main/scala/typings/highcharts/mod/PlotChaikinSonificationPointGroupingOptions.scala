...
trait PlotChaikinSonificationPointGroupingOptions extends StObject {
...
object PlotChaikinSonificationPointGroupingOptions {
  
  inline def apply(): PlotChaikinSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotChaikinSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotChaikinSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
