...
trait PlotParetoSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotParetoSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
