...
trait PlotRocMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotRocMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRocMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotRocMarkerStatesSelectOptions]
  }
}
