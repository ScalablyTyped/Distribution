...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesMapbubbleOptions extends PlotMapbubbleOptions {
  /**
...
object SeriesMapbubbleOptions {
  ...
  def apply(
    ...
    dataLabels: PlotMapbubbleDataLabelsOptions | js.Array[PlotMapbubbleDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotMapbubbleDataSortingOptions = null,
