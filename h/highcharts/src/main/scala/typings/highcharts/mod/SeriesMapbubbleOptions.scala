...
trait SeriesMapbubbleOptions extends PlotMapbubbleOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[Double | Null | SeriesMapbubbleDataOptions]] = js.native
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | mapbubble = js.native
...
object SeriesMapbubbleOptions {
  ...
  @scala.inline
  def apply(`type`: String | mapbubble): SeriesMapbubbleOptions = {
