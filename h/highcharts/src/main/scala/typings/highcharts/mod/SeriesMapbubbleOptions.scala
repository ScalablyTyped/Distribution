...
import typings.highcharts.highchartsStrings.mapbubble
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesMapbubbleOptions
  extends StObject
...
object SeriesMapbubbleOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | mapbubble): SeriesMapbubbleOptions = {
  ...
  @scala.inline
  implicit class SeriesMapbubbleOptionsMutableBuilder[Self <: SeriesMapbubbleOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: js.Array[Double | Null | SeriesMapbubbleDataOptions]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataVarargs(value: (Double | Null | SeriesMapbubbleDataOptions)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | mapbubble): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
