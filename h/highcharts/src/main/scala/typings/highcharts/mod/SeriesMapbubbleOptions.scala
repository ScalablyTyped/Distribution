...
object SeriesMapbubbleOptions {
  ...
  @scala.inline
  implicit class SeriesMapbubbleOptionsOps[Self <: SeriesMapbubbleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | mapbubble): Self = this.set("type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataVarargs(value: (Double | Null | SeriesMapbubbleDataOptions)*): Self = this.set("data", js.Array(value :_*))
    
    @scala.inline
    def setData(value: js.Array[Double | Null | SeriesMapbubbleDataOptions]): Self = this.set("data", value.asInstanceOf[js.Any])
