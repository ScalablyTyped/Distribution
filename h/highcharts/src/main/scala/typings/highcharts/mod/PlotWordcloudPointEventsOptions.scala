...
trait PlotWordcloudPointEventsOptions extends js.Object {
  /**
...
object PlotWordcloudPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWordcloudPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotWordcloudPointEventsOptions]
  }
}
