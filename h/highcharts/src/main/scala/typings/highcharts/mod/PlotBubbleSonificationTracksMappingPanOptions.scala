...
trait PlotBubbleSonificationTracksMappingPanOptions extends StObject {
...
object PlotBubbleSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotBubbleSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
