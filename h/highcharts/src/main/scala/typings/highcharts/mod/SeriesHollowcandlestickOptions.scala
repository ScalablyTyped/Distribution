...
import typings.highcharts.highchartsStrings.hollowcandlestick
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesHollowcandlestickOptions
  extends StObject
     with PlotHollowcandlestickOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | hollowcandlestick
...
object SeriesHollowcandlestickOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | hollowcandlestick): SeriesHollowcandlestickOptions = {
    val __obj = js.Dynamic.literal(dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesHollowcandlestickOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesHollowcandlestickOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | hollowcandlestick): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
