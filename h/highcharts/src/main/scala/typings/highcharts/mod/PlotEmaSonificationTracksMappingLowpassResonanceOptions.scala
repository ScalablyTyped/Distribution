...
trait PlotEmaSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotEmaSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
