...
trait PlotDemaDataGroupingOptions extends js.Object {
  /**
...
object PlotDemaDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotDemaDataGroupingOptions]
  }
}
