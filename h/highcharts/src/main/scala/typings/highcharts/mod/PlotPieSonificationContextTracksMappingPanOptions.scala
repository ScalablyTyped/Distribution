...
trait PlotPieSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotPieSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotPieSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
