...
trait PlotLinearregressionAccessibilityPointOptions extends StObject {
...
object PlotLinearregressionAccessibilityPointOptions {
  
  inline def apply(): PlotLinearregressionAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionAccessibilityPointOptions] (val x: Self) extends AnyVal {
