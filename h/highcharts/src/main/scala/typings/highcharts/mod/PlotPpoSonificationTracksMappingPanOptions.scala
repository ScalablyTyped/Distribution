...
trait PlotPpoSonificationTracksMappingPanOptions extends StObject {
...
object PlotPpoSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
