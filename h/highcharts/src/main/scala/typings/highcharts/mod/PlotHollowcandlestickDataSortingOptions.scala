...
trait PlotHollowcandlestickDataSortingOptions extends StObject {
...
object PlotHollowcandlestickDataSortingOptions {
  
  inline def apply(): PlotHollowcandlestickDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickDataSortingOptions] (val x: Self) extends AnyVal {
