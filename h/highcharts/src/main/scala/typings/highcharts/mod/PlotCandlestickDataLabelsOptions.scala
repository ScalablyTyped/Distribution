...
object PlotCandlestickDataLabelsOptions {
  ...
  inline def apply(): PlotCandlestickDataLabelsOptions = {
  ...
  extension [Self <: PlotCandlestickDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotCandlestickDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
