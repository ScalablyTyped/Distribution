...
@js.native
trait PlotCandlestickDataLabelsOptions extends js.Object {
...
object PlotCandlestickDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotCandlestickDataLabelsOptionsOps[Self <: PlotCandlestickDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotCandlestickDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
