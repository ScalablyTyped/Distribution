...
trait PlotPieSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotPieSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotPieSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
