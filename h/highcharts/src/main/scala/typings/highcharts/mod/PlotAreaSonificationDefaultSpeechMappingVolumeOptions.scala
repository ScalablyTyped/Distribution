...
trait PlotAreaSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotAreaSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotAreaSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
