...
trait PlotStochasticSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
