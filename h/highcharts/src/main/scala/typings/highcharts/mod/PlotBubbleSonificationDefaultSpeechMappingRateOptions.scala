...
trait PlotBubbleSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotBubbleSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
