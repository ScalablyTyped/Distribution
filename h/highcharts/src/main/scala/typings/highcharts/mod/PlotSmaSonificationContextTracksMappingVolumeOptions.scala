...
trait PlotSmaSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotSmaSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotSmaSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
