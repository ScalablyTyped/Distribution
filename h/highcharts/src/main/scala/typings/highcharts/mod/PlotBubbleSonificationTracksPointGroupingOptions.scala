...
trait PlotBubbleSonificationTracksPointGroupingOptions extends StObject {
...
object PlotBubbleSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotBubbleSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
