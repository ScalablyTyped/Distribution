...
trait PlotPolygonClusterOptions extends StObject {
  ...
  var events: js.UndefOr[PlotPolygonClusterEventsOptions] = js.undefined
  ...
  /**
    ...
    * iterations.
    */
  var layoutAlgorithm: js.UndefOr[PlotPolygonClusterLayoutAlgorithmOptions] = js.undefined
  ...
  var states: js.UndefOr[PlotPolygonClusterStatesOptions] = js.undefined
  ...
  /**
    ...
    * `className` option.
    */
  var zones: js.UndefOr[js.Array[PlotPolygonClusterZonesOptions]] = js.undefined
}
object PlotPolygonClusterOptions {
  
  inline def apply(): PlotPolygonClusterOptions = {
  ...
  implicit open class MutableBuilder[Self <: PlotPolygonClusterOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: PlotPolygonClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    inline def setLayoutAlgorithm(value: PlotPolygonClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setStates(value: PlotPolygonClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    inline def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    inline def setZones(value: js.Array[PlotPolygonClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
    
    inline def setZonesUndefined: Self = StObject.set(x, "zones", js.undefined)
    
    inline def setZonesVarargs(value: PlotPolygonClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value*))
  }
}
