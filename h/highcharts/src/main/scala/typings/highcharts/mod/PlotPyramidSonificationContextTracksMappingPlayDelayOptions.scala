...
trait PlotPyramidSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotPyramidSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
