...
trait PlotColumnpyramidSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
