...
trait PlotMapbubbleConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotMapbubbleConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMapbubbleConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotMapbubbleConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotMapbubbleConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotMapbubbleConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotMapbubbleConnectorsMarkerOptions = null,
    startMarker: PlotMapbubbleConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotMapbubbleConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleConnectorsOptions]
  }
}
