...
trait PlotTimelineSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotTimelineSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotTimelineSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
