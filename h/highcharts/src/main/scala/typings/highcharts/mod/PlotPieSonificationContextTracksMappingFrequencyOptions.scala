...
trait PlotPieSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotPieSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPieSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
