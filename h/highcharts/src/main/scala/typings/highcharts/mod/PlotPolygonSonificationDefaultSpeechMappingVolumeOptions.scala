...
trait PlotPolygonSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotPolygonSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
