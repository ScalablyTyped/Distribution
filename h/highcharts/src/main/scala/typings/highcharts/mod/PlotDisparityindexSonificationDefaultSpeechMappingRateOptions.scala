...
trait PlotDisparityindexSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
