...
trait PlotPyramid3dSonificationDefaultInstrumentMappingOptions extends StObject {
  
  /**
    * (Highcharts) Frequency in Hertz of notes. Overrides pitch mapping if set.
    */
  var frequency: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingFrequencyOptions
  ] = js.undefined
  ...
  var gapBetweenNotes: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingGapBetweenNotesOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var highpass: js.UndefOr[PlotPyramid3dSonificationDefaultInstrumentMappingHighpassOptions] = js.undefined
  ...
  /**
    ...
    */
  var lowpass: js.UndefOr[PlotPyramid3dSonificationDefaultInstrumentMappingLowpassOptions] = js.undefined
  ...
  var noteDuration: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingNoteDurationOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var pan: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingPanOptions
  ] = js.undefined
  ...
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingPitchOptions | (js.Array[String | Double])
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingPlayDelayOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingTimeOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var tremolo: js.UndefOr[PlotPyramid3dSonificationDefaultInstrumentMappingTremoloOptions] = js.undefined
  
  /**
    * (Highcharts) The volume of notes, from 0 to 1.
    */
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingVolumeOptions
  ] = js.undefined
}
object PlotPyramid3dSonificationDefaultInstrumentMappingOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultInstrumentMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultInstrumentMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultInstrumentMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setFrequency(
      value: Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingFrequencyOptions
    ): Self = StObject.set(x, "frequency", value.asInstanceOf[js.Any])
    
    inline def setFrequencyUndefined: Self = StObject.set(x, "frequency", js.undefined)
    
    inline def setGapBetweenNotes(
      value: Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingGapBetweenNotesOptions
    ...
    inline def setHighpass(value: PlotPyramid3dSonificationDefaultInstrumentMappingHighpassOptions): Self = StObject.set(x, "highpass", value.asInstanceOf[js.Any])
    
    inline def setHighpassUndefined: Self = StObject.set(x, "highpass", js.undefined)
    
    inline def setLowpass(value: PlotPyramid3dSonificationDefaultInstrumentMappingLowpassOptions): Self = StObject.set(x, "lowpass", value.asInstanceOf[js.Any])
    
    inline def setLowpassUndefined: Self = StObject.set(x, "lowpass", js.undefined)
    
    inline def setNoteDuration(
      value: Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingNoteDurationOptions
    ...
    inline def setPan(
      value: Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingPanOptions
    ): Self = StObject.set(x, "pan", value.asInstanceOf[js.Any])
    
    inline def setPanUndefined: Self = StObject.set(x, "pan", js.undefined)
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingPitchOptions | (js.Array[String | Double])
    ...
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingPlayDelayOptions
    ...
    inline def setTime(
      value: Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingTimeOptions
    ): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setTremolo(value: PlotPyramid3dSonificationDefaultInstrumentMappingTremoloOptions): Self = StObject.set(x, "tremolo", value.asInstanceOf[js.Any])
    
    inline def setTremoloUndefined: Self = StObject.set(x, "tremolo", js.undefined)
    
    inline def setVolume(
      value: Double | js.Object | String | js.Function | PlotPyramid3dSonificationDefaultInstrumentMappingVolumeOptions
