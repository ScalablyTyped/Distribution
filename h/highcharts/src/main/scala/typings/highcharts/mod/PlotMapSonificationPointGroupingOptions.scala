...
trait PlotMapSonificationPointGroupingOptions extends StObject {
...
object PlotMapSonificationPointGroupingOptions {
  
  inline def apply(): PlotMapSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
