...
trait PlotCylinderSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotCylinderSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotCylinderSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
