...
@js.native
trait PlotOhlcDataSortingOptions extends js.Object {
  /**
...
object PlotOhlcDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotOhlcDataSortingOptionsOps[Self <: PlotOhlcDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
