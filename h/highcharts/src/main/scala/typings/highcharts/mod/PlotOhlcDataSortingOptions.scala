...
@js.native
trait PlotOhlcDataSortingOptions extends StObject {
...
object PlotOhlcDataSortingOptions {
  
  @scala.inline
  def apply(): PlotOhlcDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotOhlcDataSortingOptionsMutableBuilder[Self <: PlotOhlcDataSortingOptions] (val x: Self) extends AnyVal {
