...
trait PlotVectorSonificationTracksPointGroupingOptions extends StObject {
...
object PlotVectorSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotVectorSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVectorSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
