...
trait PlotVariwideSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotVariwideSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
