...
trait PlotGeoheatmapSonificationTracksMappingRateOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
