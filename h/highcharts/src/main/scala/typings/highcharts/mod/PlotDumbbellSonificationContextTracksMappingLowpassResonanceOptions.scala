...
trait PlotDumbbellSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
