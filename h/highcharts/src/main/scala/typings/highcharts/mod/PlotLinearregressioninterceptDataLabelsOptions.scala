...
trait PlotLinearregressioninterceptDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotLinearregressioninterceptDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.undefined
...
object PlotLinearregressioninterceptDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotLinearregressioninterceptDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotLinearregressioninterceptDataLabelsOptionsMutableBuilder[Self <: PlotLinearregressioninterceptDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(
      value: Boolean | PlotLinearregressioninterceptDataLabelsAnimationOptions | PartialAnimationOptionsOb
