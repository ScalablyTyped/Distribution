...
@js.native
trait PlotLinearregressioninterceptDataLabelsOptions extends js.Object {
...
object PlotLinearregressioninterceptDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressioninterceptDataLabelsOptionsOps[Self <: PlotLinearregressioninterceptDataLabelsOptions] (val x: Self) extends AnyVal {
