...
trait PlotLineSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotLineSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotLineSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
