...
trait PlotRsiSonificationTracksActiveWhenOptions extends StObject {
...
object PlotRsiSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotRsiSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
