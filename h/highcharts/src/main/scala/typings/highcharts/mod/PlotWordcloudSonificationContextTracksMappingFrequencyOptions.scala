...
trait PlotWordcloudSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
