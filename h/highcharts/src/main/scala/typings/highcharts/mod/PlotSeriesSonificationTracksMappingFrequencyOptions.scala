...
trait PlotSeriesSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
