...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesTemaOptions
  extends StObject
...
object SeriesTemaOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | tema): SeriesTemaOptions = {
  ...
  @scala.inline
  implicit class SeriesTemaOptionsMutableBuilder[Self <: SeriesTemaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | tema): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
