...
object SeriesTemaOptions {
  ...
  @scala.inline
  implicit class SeriesTemaOptionsOps[Self <: SeriesTemaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | tema): Self = this.set("type", value.asInstanceOf[js.Any])
