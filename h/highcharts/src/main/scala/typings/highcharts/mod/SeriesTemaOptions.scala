...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesTemaOptions extends PlotTemaOptions {
  /**
    * Not available
    */
...
object SeriesTemaOptions {
  ...
  def apply(
    ...
    dataLabels: PlotTemaDataLabelsOptions | js.Array[PlotTemaDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotTemaDataSortingOptions = null,
