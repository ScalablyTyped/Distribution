...
trait PlotFunnel3dOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotFunnel3dDataLabelsOptions | js.Array[PlotFunnel3dDataLabelsOptions]] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotFunnel3dOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotFunnel3dSonificationOptions] = js.undefined
...
object PlotFunnel3dOptions {
  ...
  inline def apply(): PlotFunnel3dOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataLabels(value: PlotFunnel3dDataLabelsOptions | js.Array[PlotFunnel3dDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotFunnel3dDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    ...
    inline def setOnPoint(value: js.Object | PlotFunnel3dOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setSonification(value: PlotFunnel3dSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
