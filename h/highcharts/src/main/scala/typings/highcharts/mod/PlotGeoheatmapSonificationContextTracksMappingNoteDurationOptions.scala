...
trait PlotGeoheatmapSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
