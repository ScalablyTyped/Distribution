...
trait PlotXrangeConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotXrangeConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotXrangeConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotXrangeConnectorsMarkerOptions]
  }
}
