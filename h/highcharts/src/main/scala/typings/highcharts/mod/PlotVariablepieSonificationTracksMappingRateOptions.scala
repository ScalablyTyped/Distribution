...
trait PlotVariablepieSonificationTracksMappingRateOptions extends StObject {
...
object PlotVariablepieSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotVariablepieSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
