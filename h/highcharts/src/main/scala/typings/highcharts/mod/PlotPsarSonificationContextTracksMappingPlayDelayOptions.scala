...
trait PlotPsarSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotPsarSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
