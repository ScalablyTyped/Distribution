...
trait PlotLineSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotLineSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotLineSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
