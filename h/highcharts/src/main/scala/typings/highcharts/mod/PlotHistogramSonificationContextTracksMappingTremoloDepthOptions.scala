...
trait PlotHistogramSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotHistogramSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
