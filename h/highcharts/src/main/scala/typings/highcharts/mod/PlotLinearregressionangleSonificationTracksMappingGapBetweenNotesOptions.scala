...
trait PlotLinearregressionangleSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
