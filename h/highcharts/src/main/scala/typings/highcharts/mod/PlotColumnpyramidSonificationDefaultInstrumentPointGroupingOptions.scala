...
trait PlotColumnpyramidSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
