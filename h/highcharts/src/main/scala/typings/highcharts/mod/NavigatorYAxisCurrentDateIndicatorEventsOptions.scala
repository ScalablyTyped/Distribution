...
trait NavigatorYAxisCurrentDateIndicatorEventsOptions extends StObject {
...
object NavigatorYAxisCurrentDateIndicatorEventsOptions {
  
  inline def apply(): NavigatorYAxisCurrentDateIndicatorEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisCurrentDateIndicatorEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NavigatorYAxisCurrentDateIndicatorEventsOptions] (val x: Self) extends AnyVal {
