...
trait PlotPyramidSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotPyramidSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
