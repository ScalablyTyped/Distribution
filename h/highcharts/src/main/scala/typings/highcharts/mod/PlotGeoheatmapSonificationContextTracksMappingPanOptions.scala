...
trait PlotGeoheatmapSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
