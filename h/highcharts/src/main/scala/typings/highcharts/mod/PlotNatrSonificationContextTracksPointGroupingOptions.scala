...
trait PlotNatrSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotNatrSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
