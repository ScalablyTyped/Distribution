...
trait PlotPriceenvelopesSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
