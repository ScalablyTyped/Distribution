...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesScatterOptions extends PlotScatterOptions {
  /**
...
object SeriesScatterOptions {
  ...
  def apply(
    ...
    cluster: PlotScatterClusterOptions = null,
    ...
    dataLabels: PlotScatterDataLabelsOptions | js.Array[PlotScatterDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotScatterDataSortingOptions = null,
