...
trait PlotDpoSonificationTracksMappingPanOptions extends StObject {
...
object PlotDpoSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotDpoSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDpoSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
