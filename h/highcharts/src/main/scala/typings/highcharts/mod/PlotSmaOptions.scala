...
trait PlotSmaOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotSmaSonificationOptions] = js.undefined
...
object PlotSmaOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotSmaSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
