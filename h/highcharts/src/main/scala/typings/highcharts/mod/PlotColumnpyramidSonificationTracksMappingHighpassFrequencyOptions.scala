...
trait PlotColumnpyramidSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
