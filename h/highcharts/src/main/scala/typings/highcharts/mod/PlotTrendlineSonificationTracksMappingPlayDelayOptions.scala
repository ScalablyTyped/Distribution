...
trait PlotTrendlineSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
