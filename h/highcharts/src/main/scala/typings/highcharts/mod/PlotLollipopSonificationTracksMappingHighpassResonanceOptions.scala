...
trait PlotLollipopSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
