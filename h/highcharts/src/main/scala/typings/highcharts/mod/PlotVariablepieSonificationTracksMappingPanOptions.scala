...
trait PlotVariablepieSonificationTracksMappingPanOptions extends StObject {
...
object PlotVariablepieSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotVariablepieSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
