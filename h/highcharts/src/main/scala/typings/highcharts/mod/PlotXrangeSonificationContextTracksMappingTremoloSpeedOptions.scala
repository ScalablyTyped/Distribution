...
trait PlotXrangeSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotXrangeSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
