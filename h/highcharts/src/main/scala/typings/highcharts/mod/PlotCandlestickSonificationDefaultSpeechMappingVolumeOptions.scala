...
trait PlotCandlestickSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotCandlestickSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
