...
trait SonificationGlobalContextTracksMappingHighpassResonanceOptions extends StObject {
...
object SonificationGlobalContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
