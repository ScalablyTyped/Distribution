...
trait PlotPsarSonificationTracksMappingRateOptions extends StObject {
...
object PlotPsarSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
