...
trait PlotKlingerSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotKlingerSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
