...
trait PlotStochasticSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotStochasticSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
