...
trait PlotFunnelSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotFunnelSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
