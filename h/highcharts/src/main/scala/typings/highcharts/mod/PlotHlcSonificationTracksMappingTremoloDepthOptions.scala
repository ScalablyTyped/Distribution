...
trait PlotHlcSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotHlcSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotHlcSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHlcSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
