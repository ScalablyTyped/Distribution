...
trait PlotBarSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotBarSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotBarSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
