...
trait PlotGanttSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotGanttSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
