...
trait PlotHistogramConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotHistogramConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotHistogramConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotHistogramConnectorsEndMarkerOptions]
  }
}
