...
trait PlotXrangeSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotXrangeSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
