...
trait PlotSankeySonificationPointGroupingOptions extends StObject {
...
object PlotSankeySonificationPointGroupingOptions {
  
  inline def apply(): PlotSankeySonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeySonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeySonificationPointGroupingOptions] (val x: Self) extends AnyVal {
