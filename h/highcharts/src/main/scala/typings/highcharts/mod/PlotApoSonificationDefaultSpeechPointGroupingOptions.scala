...
trait PlotApoSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotApoSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotApoSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
