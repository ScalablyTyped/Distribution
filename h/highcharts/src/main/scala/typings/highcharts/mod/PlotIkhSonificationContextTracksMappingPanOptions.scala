...
trait PlotIkhSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotIkhSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
