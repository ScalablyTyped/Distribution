...
trait PlotStochasticSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
