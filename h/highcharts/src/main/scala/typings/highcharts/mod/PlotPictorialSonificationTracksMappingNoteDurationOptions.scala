...
trait PlotPictorialSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
