...
trait PlotColumnSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotColumnSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
