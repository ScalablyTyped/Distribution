...
trait PlotPyramidSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotPyramidSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
