...
@js.native
trait PlotVectorDataLabelsAnimationOptions extends js.Object {
...
object PlotVectorDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotVectorDataLabelsAnimationOptionsOps[Self <: PlotVectorDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
