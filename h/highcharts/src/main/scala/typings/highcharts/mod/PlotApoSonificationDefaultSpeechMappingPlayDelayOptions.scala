...
trait PlotApoSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotApoSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotApoSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
