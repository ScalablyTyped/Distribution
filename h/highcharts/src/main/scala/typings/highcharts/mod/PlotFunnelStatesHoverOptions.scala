...
trait PlotFunnelStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotFunnelStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotFunnelStatesHoverOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotFunnelStatesHoverOptions]
  }
}
