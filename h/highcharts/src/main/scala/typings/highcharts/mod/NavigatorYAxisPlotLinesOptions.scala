...
trait NavigatorYAxisPlotLinesOptions extends StObject {
  ...
  /**
    ...
    * `mousemove`.
    */
  var events: js.UndefOr[NavigatorYAxisPlotLinesEventsOptions] = js.native
  ...
  /**
    ...
    */
  var label: js.UndefOr[NavigatorYAxisPlotLinesLabelOptions] = js.native
...
object NavigatorYAxisPlotLinesOptions {
  ...
  @scala.inline
  def apply(): NavigatorYAxisPlotLinesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisPlotLinesOptions]
  }
  
  @scala.inline
  implicit class NavigatorYAxisPlotLinesOptionsMutableBuilder[Self <: NavigatorYAxisPlotLinesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: NavigatorYAxisPlotLinesEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: NavigatorYAxisPlotLinesLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
