...
object NavigatorYAxisPlotLinesOptions {
  ...
  @scala.inline
  implicit class NavigatorYAxisPlotLinesOptionsOps[Self <: NavigatorYAxisPlotLinesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: NavigatorYAxisPlotLinesEventsOptions): Self = this.set("events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: NavigatorYAxisPlotLinesLabelOptions): Self = this.set("label", value.asInstanceOf[js.Any])
