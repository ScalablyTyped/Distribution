...
trait NavigatorYAxisPlotLinesOptions extends StObject {
  ...
  var labels: js.UndefOr[NavigatorYAxisPlotLinesLabelsOptions] = js.undefined
...
object NavigatorYAxisPlotLinesOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NavigatorYAxisPlotLinesOptions] (val x: Self) extends AnyVal {
    ...
    inline def setLabels(value: NavigatorYAxisPlotLinesLabelsOptions): Self = StObject.set(x, "labels", value.asInstanceOf[js.Any])
