...
trait PlotTreegraphSonificationTracksPointGroupingOptions extends StObject {
...
object PlotTreegraphSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotTreegraphSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
