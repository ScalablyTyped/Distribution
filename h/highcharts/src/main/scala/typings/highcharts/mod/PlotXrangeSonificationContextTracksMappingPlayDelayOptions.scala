...
trait PlotXrangeSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotXrangeSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
