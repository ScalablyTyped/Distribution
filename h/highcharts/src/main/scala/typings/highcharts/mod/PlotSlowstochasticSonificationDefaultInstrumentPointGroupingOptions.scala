...
trait PlotSlowstochasticSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
