...
trait PlotDisparityindexSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
