...
trait PlotPieSonificationTracksPointGroupingOptions extends StObject {
...
object PlotPieSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotPieSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
