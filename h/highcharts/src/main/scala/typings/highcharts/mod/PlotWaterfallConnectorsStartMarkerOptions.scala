...
trait PlotWaterfallConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotWaterfallConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWaterfallConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWaterfallConnectorsStartMarkerOptions]
  }
}
