...
trait PlotSlowstochasticSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
