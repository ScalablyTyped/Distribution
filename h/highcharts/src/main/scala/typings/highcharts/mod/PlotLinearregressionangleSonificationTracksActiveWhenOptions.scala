...
trait PlotLinearregressionangleSonificationTracksActiveWhenOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
