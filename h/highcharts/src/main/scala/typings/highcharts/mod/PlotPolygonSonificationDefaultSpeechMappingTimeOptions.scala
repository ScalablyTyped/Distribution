...
trait PlotPolygonSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotPolygonSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
