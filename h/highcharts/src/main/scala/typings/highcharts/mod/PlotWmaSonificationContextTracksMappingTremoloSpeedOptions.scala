...
trait PlotWmaSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotWmaSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
