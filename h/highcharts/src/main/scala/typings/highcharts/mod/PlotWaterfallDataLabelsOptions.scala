...
@js.native
trait PlotWaterfallDataLabelsOptions extends js.Object {
...
object PlotWaterfallDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotWaterfallDataLabelsOptionsOps[Self <: PlotWaterfallDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotWaterfallDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
