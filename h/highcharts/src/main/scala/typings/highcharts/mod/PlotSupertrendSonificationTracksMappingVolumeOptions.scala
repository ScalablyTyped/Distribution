...
trait PlotSupertrendSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
