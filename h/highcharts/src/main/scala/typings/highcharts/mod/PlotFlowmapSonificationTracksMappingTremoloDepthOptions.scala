...
trait PlotFlowmapSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
