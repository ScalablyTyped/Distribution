...
trait PlotTrixPointEventsOptions extends js.Object {
  /**
...
object PlotTrixPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotTrixPointEventsOptions]
  }
}
