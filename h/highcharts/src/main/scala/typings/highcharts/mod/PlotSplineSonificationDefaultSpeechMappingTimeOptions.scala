...
trait PlotSplineSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotSplineSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotSplineSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
