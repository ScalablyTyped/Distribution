...
trait PlotPcSonificationTracksPointGroupingOptions extends StObject {
...
object PlotPcSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotPcSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
