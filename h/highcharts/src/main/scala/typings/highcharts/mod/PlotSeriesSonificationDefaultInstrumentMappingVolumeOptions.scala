...
trait PlotSeriesSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotSeriesSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
