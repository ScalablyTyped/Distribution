...
trait PlotStreamgraphSonificationTracksMappingRateOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
