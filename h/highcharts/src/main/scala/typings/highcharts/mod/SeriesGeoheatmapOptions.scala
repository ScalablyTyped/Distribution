...
import typings.highcharts.highchartsStrings.geoheatmap
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesGeoheatmapOptions
  extends StObject
     with PlotGeoheatmapOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[js.Array[Double] | SeriesGeoheatmapDataOptions]] = js.undefined
...
object SeriesGeoheatmapOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | geoheatmap): SeriesGeoheatmapOptions = {
    val __obj = js.Dynamic.literal(dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesGeoheatmapOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesGeoheatmapOptions] (val x: Self) extends AnyVal {
    
    inline def setData(value: js.Array[js.Array[Double] | SeriesGeoheatmapDataOptions]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    inline def setDataVarargs(value: (js.Array[Double] | SeriesGeoheatmapDataOptions)*): Self = StObject.set(x, "data", js.Array(value*))
    ...
    inline def setType(value: String | geoheatmap): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
