...
trait PlotLollipopSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
