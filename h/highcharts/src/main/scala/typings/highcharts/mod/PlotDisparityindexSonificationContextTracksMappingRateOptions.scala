...
trait PlotDisparityindexSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
