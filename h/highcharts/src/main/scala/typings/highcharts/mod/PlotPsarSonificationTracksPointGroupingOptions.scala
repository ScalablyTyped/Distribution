...
trait PlotPsarSonificationTracksPointGroupingOptions extends StObject {
...
object PlotPsarSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotPsarSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
