...
trait PlotPyramid3dSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
