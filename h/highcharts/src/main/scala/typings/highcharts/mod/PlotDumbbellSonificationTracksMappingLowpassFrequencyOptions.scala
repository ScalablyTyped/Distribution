...
trait PlotDumbbellSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
