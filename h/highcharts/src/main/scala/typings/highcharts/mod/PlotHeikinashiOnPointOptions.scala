...
trait PlotHeikinashiOnPointOptions extends StObject {
  ...
  /**
    ...
    */
  var connectorOptions: js.UndefOr[PlotHeikinashiOnPointConnectorOptions | SVGAttributes] = js.undefined
  ...
  /**
    ...
    */
  var position: js.UndefOr[js.Object | PlotHeikinashiOnPointPositionOptions] = js.undefined
}
object PlotHeikinashiOnPointOptions {
  
  inline def apply(): PlotHeikinashiOnPointOptions = {
  ...
  implicit open class MutableBuilder[Self <: PlotHeikinashiOnPointOptions] (val x: Self) extends AnyVal {
    ...
    inline def setPosition(value: js.Object | PlotHeikinashiOnPointPositionOptions): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
