...
trait PlotGanttSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotGanttSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
