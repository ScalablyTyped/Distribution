...
trait PlotKlingerSonificationPointGroupingOptions extends StObject {
...
object PlotKlingerSonificationPointGroupingOptions {
  
  inline def apply(): PlotKlingerSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
