...
@js.native
trait SeriesSolidgaugeDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesSolidgaugeDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesSolidgaugeDataDataLabelsAnimationOptionsOps[Self <: SeriesSolidgaugeDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
