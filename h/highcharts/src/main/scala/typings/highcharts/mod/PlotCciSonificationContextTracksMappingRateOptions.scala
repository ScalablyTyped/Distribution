...
trait PlotCciSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotCciSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotCciSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
