...
trait PlotCandlestickSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
