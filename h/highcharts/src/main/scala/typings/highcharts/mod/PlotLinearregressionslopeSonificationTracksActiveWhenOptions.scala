...
trait PlotLinearregressionslopeSonificationTracksActiveWhenOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
