...
trait PlotSeriesConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotSeriesConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSeriesConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesConnectorsMarkerOptions]
  }
}
