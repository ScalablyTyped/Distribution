...
trait PlotPpoStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotPpoStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPpoStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotPpoStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotPpoStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotPpoStatesSelectOptions]
  }
}
