...
trait PlotDependencywheelSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
