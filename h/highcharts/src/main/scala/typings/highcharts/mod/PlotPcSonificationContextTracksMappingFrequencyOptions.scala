...
trait PlotPcSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotPcSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPcSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
