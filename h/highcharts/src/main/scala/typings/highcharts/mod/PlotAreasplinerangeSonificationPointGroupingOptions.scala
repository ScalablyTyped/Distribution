...
trait PlotAreasplinerangeSonificationPointGroupingOptions extends StObject {
...
object PlotAreasplinerangeSonificationPointGroupingOptions {
  
  inline def apply(): PlotAreasplinerangeSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplinerangeSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
