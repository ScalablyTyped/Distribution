...
trait PlotSlowstochasticSonificationContextTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
