...
trait PlotColumnOnPointPositionOptions extends StObject {
...
object PlotColumnOnPointPositionOptions {
  
  inline def apply(): PlotColumnOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnOnPointPositionOptions] (val x: Self) extends AnyVal {
