...
trait PlotLineSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotLineSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
