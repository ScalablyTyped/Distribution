...
trait PlotSunburstBreadcrumbsEventsOptions extends StObject {
...
object PlotSunburstBreadcrumbsEventsOptions {
  
  inline def apply(): PlotSunburstBreadcrumbsEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstBreadcrumbsEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstBreadcrumbsEventsOptions] (val x: Self) extends AnyVal {
