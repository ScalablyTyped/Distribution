...
trait PlotCandlestickSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
