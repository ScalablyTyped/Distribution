...
trait PlotHistogramSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotHistogramSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
