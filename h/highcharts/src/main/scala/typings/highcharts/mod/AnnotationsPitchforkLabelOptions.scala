...
object AnnotationsPitchforkLabelOptions {
  ...
  @scala.inline
  def apply(): AnnotationsPitchforkLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsPitchforkLabelOptions]
  }
  
  @scala.inline
  implicit class AnnotationsPitchforkLabelOptionsMutableBuilder[Self <: AnnotationsPitchforkLabelOptions] (val x: Self) extends AnyVal {
