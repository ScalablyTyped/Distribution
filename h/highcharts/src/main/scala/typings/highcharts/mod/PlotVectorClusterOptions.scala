...
@js.native
trait PlotVectorClusterOptions extends js.Object {
  /**
...
object PlotVectorClusterOptions {
  ...
  @scala.inline
  implicit class PlotVectorClusterOptionsOps[Self <: PlotVectorClusterOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEvents(value: PlotVectorClusterEventsOptions): Self = this.set("events", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteEvents: Self = this.set("events", js.undefined)
    @scala.inline
    def setLayoutAlgorithm(value: PlotVectorClusterLayoutAlgorithmOptions): Self = this.set("layoutAlgorithm", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStates(value: PlotVectorClusterStatesOptions): Self = this.set("states", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteStates: Self = this.set("states", js.undefined)
    @scala.inline
    def setZonesVarargs(value: PlotVectorClusterZonesOptions*): Self = this.set("zones", js.Array(value :_*))
    @scala.inline
    def setZones(value: js.Array[PlotVectorClusterZonesOptions]): Self = this.set("zones", value.asInstanceOf[js.Any])
    @scala.inline
