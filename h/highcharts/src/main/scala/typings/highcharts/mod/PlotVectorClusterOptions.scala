...
object PlotVectorClusterOptions {
  ...
  def apply(
    ...
    events: PlotVectorClusterEventsOptions = null,
    layoutAlgorithm: PlotVectorClusterLayoutAlgorithmOptions = null,
    marker: PointMarkerOptionsObject = null,
    minimumClusterSize: js.UndefOr[Double] = js.undefined,
    states: PlotVectorClusterStatesOptions = null,
    zones: js.Array[PlotVectorClusterZonesOptions] = null
  ): PlotVectorClusterOptions = {
