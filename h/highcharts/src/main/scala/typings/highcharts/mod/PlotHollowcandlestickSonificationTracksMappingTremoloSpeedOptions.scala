...
trait PlotHollowcandlestickSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotHollowcandlestickSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
