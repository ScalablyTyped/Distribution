...
trait PlotPieOptions extends js.Object {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotPieAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotPieOptions {
  ...
  @scala.inline
  implicit class PlotPieOptionsOps[Self <: PlotPieOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPieAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
