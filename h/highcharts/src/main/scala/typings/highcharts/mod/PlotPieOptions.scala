...
trait PlotPieOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotPieSonificationOptions] = js.undefined
...
object PlotPieOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotPieOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotPieSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
