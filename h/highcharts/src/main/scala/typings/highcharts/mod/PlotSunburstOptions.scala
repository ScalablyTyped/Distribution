...
trait PlotSunburstOptions extends StObject {
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotSunburstDataSortingOptions] = js.undefined
...
object PlotSunburstOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotSunburstDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
