...
trait PlotSunburstOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotSunburstSonificationOptions] = js.undefined
...
object PlotSunburstOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotSunburstOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotSunburstSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
