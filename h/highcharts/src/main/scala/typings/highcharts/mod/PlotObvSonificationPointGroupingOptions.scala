...
trait PlotObvSonificationPointGroupingOptions extends StObject {
...
object PlotObvSonificationPointGroupingOptions {
  
  inline def apply(): PlotObvSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotObvSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotObvSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
