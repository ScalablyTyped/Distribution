...
trait PlotLinearregressionslopeSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotLinearregressionslopeSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
