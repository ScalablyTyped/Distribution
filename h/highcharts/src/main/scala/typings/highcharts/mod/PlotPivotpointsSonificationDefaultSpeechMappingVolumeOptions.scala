...
trait PlotPivotpointsSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
