...
trait PlotPriceenvelopesSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
