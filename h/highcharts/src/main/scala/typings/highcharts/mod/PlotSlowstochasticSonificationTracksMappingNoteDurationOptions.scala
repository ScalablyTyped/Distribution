...
trait PlotSlowstochasticSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
