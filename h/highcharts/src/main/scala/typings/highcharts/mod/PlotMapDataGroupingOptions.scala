...
trait PlotMapDataGroupingOptions extends js.Object {
  /**
...
object PlotMapDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotMapDataGroupingOptions]
  }
}
