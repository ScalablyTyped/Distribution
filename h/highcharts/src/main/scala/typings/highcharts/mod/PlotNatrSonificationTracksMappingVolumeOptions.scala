...
trait PlotNatrSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotNatrSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
