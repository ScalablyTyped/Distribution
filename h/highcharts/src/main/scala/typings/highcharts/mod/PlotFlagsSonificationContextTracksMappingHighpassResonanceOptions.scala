...
trait PlotFlagsSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
