...
trait PlotLinearregressionslopeSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotLinearregressionslopeSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
