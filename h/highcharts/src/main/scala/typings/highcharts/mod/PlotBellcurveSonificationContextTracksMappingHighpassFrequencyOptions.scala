...
trait PlotBellcurveSonificationContextTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotBellcurveSonificationContextTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotBellcurveSonificationContextTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveSonificationContextTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBellcurveSonificationContextTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
