...
trait PlotPivotpointsSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
