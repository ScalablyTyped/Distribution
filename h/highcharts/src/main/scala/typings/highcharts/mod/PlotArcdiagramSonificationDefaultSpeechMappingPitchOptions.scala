...
trait PlotArcdiagramSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
