...
trait PlotMomentumSonificationTracksActiveWhenOptions extends StObject {
...
object PlotMomentumSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotMomentumSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMomentumSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
