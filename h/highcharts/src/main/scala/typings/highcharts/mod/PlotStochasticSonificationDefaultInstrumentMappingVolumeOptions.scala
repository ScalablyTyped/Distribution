...
trait PlotStochasticSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotStochasticSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
