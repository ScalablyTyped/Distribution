...
trait PlotSlowstochasticSonificationTracksPointGroupingOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
