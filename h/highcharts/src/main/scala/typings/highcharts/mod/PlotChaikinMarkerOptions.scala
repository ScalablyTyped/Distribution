...
trait PlotChaikinMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotChaikinMarkerStatesOptions] = js.undefined
  /**
...
object PlotChaikinMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotChaikinMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotChaikinMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinMarkerOptions]
  }
}
