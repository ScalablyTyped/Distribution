...
trait PlotAreaDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotAreaDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreaDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotAreaDragDropDragHandleOptions]
  }
}
