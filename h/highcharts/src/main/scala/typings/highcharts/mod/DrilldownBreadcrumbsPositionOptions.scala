...
trait DrilldownBreadcrumbsPositionOptions extends StObject {
...
object DrilldownBreadcrumbsPositionOptions {
  
  inline def apply(): DrilldownBreadcrumbsPositionOptions = {
