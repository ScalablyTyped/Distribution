...
trait PlotFunnelSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotFunnelSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
