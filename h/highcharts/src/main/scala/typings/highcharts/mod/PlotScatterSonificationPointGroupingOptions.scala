...
trait PlotScatterSonificationPointGroupingOptions extends StObject {
...
object PlotScatterSonificationPointGroupingOptions {
  
  inline def apply(): PlotScatterSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatterSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatterSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
