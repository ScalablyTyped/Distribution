...
trait PlotWmaOnPointPositionOptions extends StObject {
...
object PlotWmaOnPointPositionOptions {
  
  inline def apply(): PlotWmaOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaOnPointPositionOptions] (val x: Self) extends AnyVal {
