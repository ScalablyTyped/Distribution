...
trait PlotLinearregressionangleSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
