...
trait PlotStreamgraphSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
