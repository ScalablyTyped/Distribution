...
trait PlotWmaSonificationTracksMappingPanOptions extends StObject {
...
object PlotWmaSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
