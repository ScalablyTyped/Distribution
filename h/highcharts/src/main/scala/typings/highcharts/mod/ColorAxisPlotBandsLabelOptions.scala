...
trait ColorAxisPlotBandsLabelOptions extends StObject {
...
object ColorAxisPlotBandsLabelOptions {
  
  inline def apply(): ColorAxisPlotBandsLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColorAxisPlotBandsLabelOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorAxisPlotBandsLabelOptions] (val x: Self) extends AnyVal {
