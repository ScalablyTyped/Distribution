...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.highcharts.highchartsStrings.dataAsColumns
  ...
  - typings.highcharts.highchartsStrings.layout
  - typings.highcharts.highchartsStrings.depth
  - typings.highcharts.highchartsStrings.allowDrillToNode
...
object SeriesOptionsType {
  ...
  inline def affectsMapView: typings.highcharts.highchartsStrings.affectsMapView = "affectsMapView".asInstanceOf[typings.highcharts.highchartsStrings.affectsMapView]
  
  inline def allowDrillToNode: typings.highcharts.highchartsStrings.allowDrillToNode = "allowDrillToNode".asInstanceOf[typings.highcharts.highchartsStrings.allowDrillToNode]
  ...
  inline def dataAsColumns: typings.highcharts.highchartsStrings.dataAsColumns = "dataAsColumns".asInstanceOf[typings.highcharts.highchartsStrings.dataAsColumns]
  ...
  inline def layout: typings.highcharts.highchartsStrings.layout = "layout".asInstanceOf[typings.highcharts.highchartsStrings.layout]
  ...
  inline def paths: typings.highcharts.highchartsStrings.paths = "paths".asInstanceOf[typings.highcharts.highchartsStrings.paths]
