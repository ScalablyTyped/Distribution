...
trait PlotDmiSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotDmiSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
