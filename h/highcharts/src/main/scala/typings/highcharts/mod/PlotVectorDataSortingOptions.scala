...
@js.native
trait PlotVectorDataSortingOptions extends StObject {
...
object PlotVectorDataSortingOptions {
  
  @scala.inline
  def apply(): PlotVectorDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotVectorDataSortingOptionsMutableBuilder[Self <: PlotVectorDataSortingOptions] (val x: Self) extends AnyVal {
