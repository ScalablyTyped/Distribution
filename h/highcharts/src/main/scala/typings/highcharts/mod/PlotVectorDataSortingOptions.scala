...
@js.native
trait PlotVectorDataSortingOptions extends js.Object {
  /**
...
object PlotVectorDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotVectorDataSortingOptionsOps[Self <: PlotVectorDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
