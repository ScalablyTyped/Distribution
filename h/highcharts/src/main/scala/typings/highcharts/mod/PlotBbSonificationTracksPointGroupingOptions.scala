...
trait PlotBbSonificationTracksPointGroupingOptions extends StObject {
...
object PlotBbSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotBbSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBbSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
