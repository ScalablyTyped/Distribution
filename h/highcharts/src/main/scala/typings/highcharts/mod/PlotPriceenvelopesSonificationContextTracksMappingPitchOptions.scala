...
trait PlotPriceenvelopesSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotPriceenvelopesSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
