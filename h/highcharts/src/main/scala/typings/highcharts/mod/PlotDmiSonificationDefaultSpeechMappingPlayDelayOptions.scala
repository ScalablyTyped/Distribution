...
trait PlotDmiSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotDmiSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotDmiSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
