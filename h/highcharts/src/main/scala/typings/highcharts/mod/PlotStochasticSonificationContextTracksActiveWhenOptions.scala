...
trait PlotStochasticSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotStochasticSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
