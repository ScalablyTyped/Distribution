...
@js.native
trait PlotIkhDataLabelsAnimationOptions extends js.Object {
...
object PlotIkhDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): PlotIkhDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class PlotIkhDataLabelsAnimationOptionsOps[Self <: PlotIkhDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
