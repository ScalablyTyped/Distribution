...
trait PlotPyramidSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotPyramidSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
