...
trait PlotDumbbellSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
