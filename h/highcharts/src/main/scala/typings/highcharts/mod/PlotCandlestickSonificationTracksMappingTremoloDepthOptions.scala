...
trait PlotCandlestickSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
