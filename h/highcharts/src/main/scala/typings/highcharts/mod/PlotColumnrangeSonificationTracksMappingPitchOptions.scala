...
trait PlotColumnrangeSonificationTracksMappingPitchOptions extends StObject {
...
object PlotColumnrangeSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotColumnrangeSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
