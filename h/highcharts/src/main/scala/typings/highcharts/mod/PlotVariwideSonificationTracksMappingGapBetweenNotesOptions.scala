...
trait PlotVariwideSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
