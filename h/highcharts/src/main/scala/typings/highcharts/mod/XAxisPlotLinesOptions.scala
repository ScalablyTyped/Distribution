...
object XAxisPlotLinesOptions {
  ...
  @scala.inline
  implicit class XAxisPlotLinesOptionsOps[Self <: XAxisPlotLinesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: XAxisPlotLinesEventsOptions): Self = this.set("events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: XAxisPlotLinesLabelOptions): Self = this.set("label", value.asInstanceOf[js.Any])
