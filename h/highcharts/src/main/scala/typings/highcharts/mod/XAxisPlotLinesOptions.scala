...
trait XAxisPlotLinesOptions extends AxisPlotLinesOptions {
  ...
  /**
    ...
    * `mousemove`.
    */
  var events: js.UndefOr[XAxisPlotLinesEventsOptions] = js.native
  ...
  /**
    ...
    */
  var label: js.UndefOr[XAxisPlotLinesLabelOptions] = js.native
...
object XAxisPlotLinesOptions {
  ...
  @scala.inline
  def apply(): XAxisPlotLinesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisPlotLinesOptions]
  }
  
  @scala.inline
  implicit class XAxisPlotLinesOptionsMutableBuilder[Self <: XAxisPlotLinesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: XAxisPlotLinesEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: XAxisPlotLinesLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
