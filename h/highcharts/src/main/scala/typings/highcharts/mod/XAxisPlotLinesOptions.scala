...
object XAxisPlotLinesOptions {
  ...
  inline def apply(): XAxisPlotLinesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XAxisPlotLinesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: XAxisPlotLinesOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: XAxisPlotLinesEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
