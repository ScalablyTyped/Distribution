...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesMomentumOptions extends PlotMomentumOptions {
  /**
    * Not available
    */
...
object SeriesMomentumOptions {
  ...
  def apply(
    ...
    dataLabels: PlotMomentumDataLabelsOptions | js.Array[PlotMomentumDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotMomentumDataSortingOptions = null,
