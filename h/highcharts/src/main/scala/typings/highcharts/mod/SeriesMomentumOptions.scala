...
import typings.highcharts.highchartsStrings.momentum
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesMomentumOptions
  extends StObject
...
object SeriesMomentumOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | momentum): SeriesMomentumOptions = {
  ...
  @scala.inline
  implicit class SeriesMomentumOptionsMutableBuilder[Self <: SeriesMomentumOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | momentum): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
