...
trait PlotFlowmapSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
