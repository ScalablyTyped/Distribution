...
trait PlotVariablepieSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotVariablepieSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotVariablepieSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
