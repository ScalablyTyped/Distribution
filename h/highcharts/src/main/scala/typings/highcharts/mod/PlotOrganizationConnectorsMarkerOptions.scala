...
trait PlotOrganizationConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotOrganizationConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotOrganizationConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotOrganizationConnectorsMarkerOptions]
  }
}
