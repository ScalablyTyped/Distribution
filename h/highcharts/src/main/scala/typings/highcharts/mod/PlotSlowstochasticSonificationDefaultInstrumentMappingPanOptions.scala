...
trait PlotSlowstochasticSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
