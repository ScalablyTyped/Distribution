...
trait PlotBoxplotOptions extends StObject {
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotBoxplotOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotBoxplotSonificationOptions] = js.undefined
  ...
  /**
    ...
    */
  var stemColor: js.UndefOr[ColorString | GradientColorObject | PatternObject] = js.undefined
...
object PlotBoxplotOptions {
  ...
  inline def apply(): PlotBoxplotOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBoxplotOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataLabels(value: PlotBoxplotDataLabelsOptions | js.Array[PlotBoxplotDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotBoxplotDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotBoxplotDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotBoxplotOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setSonification(value: PlotBoxplotSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
    ...
    inline def setStemColor(value: ColorString | GradientColorObject | PatternObject): Self = StObject.set(x, "stemColor", value.asInstanceOf[js.Any])
    
    inline def setStemColorUndefined: Self = StObject.set(x, "stemColor", js.undefined)
