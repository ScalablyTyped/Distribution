...
object PlotBoxplotOptions {
  ...
  @scala.inline
  implicit class PlotBoxplotOptionsOps[Self <: PlotBoxplotOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBoxplotAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotBoxplotDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotBoxplotDataLabelsOptions | js.Array[PlotBoxplotDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotBoxplotDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMedianColor(value: ColorString | GradientColorObject): Self = this.set("medianColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMedianColor: Self = this.set("medianColor", js.undefined)
    ...
    @scala.inline
    def setMedianWidth(value: Double): Self = this.set("medianWidth", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMedianWidth: Self = this.set("medianWidth", js.undefined)
    
    @scala.inline
    def setMedianWidthNull: Self = this.set("medianWidth", null)
    ...
    @scala.inline
    def setStemWidth(value: Double): Self = this.set("stemWidth", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteStemWidth: Self = this.set("stemWidth", js.undefined)
    ...
    @scala.inline
    def setWhiskerColor(value: ColorString | GradientColorObject | PatternObject): Self = this.set("whiskerColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteWhiskerColor: Self = this.set("whiskerColor", js.undefined)
    ...
    @scala.inline
    def setWhiskerLength(value: Double | String): Self = this.set("whiskerLength", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteWhiskerLength: Self = this.set("whiskerLength", js.undefined)
