...
object PlotBoxplotOptions {
  ...
  extension [Self <: PlotBoxplotOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotBoxplotAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
