...
trait PlotGanttSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotGanttSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
