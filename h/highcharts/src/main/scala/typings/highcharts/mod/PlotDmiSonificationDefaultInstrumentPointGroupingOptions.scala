...
trait PlotDmiSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotDmiSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotDmiSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
