...
trait PlotCylinderSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotCylinderSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
