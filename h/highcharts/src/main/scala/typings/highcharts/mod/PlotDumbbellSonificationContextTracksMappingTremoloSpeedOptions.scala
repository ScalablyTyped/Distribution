...
trait PlotDumbbellSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
