...
trait PlotPictorialSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
