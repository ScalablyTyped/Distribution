...
trait PlotAroonSonificationTracksActiveWhenOptions extends StObject {
...
object PlotAroonSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotAroonSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
