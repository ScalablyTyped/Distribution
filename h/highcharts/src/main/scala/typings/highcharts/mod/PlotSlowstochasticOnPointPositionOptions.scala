...
trait PlotSlowstochasticOnPointPositionOptions extends StObject {
...
object PlotSlowstochasticOnPointPositionOptions {
  
  inline def apply(): PlotSlowstochasticOnPointPositionOptions = {
