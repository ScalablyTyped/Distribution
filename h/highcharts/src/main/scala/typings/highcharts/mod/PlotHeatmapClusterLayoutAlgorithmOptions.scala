...
trait PlotHeatmapClusterLayoutAlgorithmOptions extends StObject {
...
object PlotHeatmapClusterLayoutAlgorithmOptions {
  
  inline def apply(): PlotHeatmapClusterLayoutAlgorithmOptions = {
