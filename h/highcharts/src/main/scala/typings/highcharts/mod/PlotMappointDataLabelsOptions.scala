...
@js.native
trait PlotMappointDataLabelsOptions extends js.Object {
...
object PlotMappointDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotMappointDataLabelsOptionsOps[Self <: PlotMappointDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMappointDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
