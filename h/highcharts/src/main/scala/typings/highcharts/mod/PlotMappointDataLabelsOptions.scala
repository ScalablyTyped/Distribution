...
trait PlotMappointDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotMappointDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotMappointDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotMappointDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotMappointDataLabelsOptionsMutableBuilder[Self <: PlotMappointDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotMappointDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
