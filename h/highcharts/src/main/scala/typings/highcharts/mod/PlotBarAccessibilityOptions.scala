...
trait PlotBarAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotBarAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotBarAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotBarAccessibilityKeyboardNavigationOptions = null,
    ...
    __obj.asInstanceOf[PlotBarAccessibilityOptions]
  }
}
