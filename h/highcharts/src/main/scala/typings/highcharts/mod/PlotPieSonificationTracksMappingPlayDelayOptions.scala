...
trait PlotPieSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotPieSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPieSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
