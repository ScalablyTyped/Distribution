...
trait PlotPriceenvelopesSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
