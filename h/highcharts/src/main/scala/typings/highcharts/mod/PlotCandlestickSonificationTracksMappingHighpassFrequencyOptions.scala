...
trait PlotCandlestickSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotCandlestickSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
