...
trait PlotAreasplinerangeSonificationContextTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotAreasplinerangeSonificationContextTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotAreasplinerangeSonificationContextTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreasplinerangeSonificationContextTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreasplinerangeSonificationContextTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
