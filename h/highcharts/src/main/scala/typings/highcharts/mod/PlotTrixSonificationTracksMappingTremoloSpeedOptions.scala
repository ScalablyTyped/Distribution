...
trait PlotTrixSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotTrixSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
