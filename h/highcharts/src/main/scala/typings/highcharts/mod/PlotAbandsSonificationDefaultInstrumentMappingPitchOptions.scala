...
trait PlotAbandsSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotAbandsSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
