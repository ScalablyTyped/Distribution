...
trait PlotParetoSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
