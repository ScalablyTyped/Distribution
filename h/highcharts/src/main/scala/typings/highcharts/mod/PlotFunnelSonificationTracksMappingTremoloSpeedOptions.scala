...
trait PlotFunnelSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
