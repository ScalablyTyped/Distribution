...
trait PlotPivotpointsSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
