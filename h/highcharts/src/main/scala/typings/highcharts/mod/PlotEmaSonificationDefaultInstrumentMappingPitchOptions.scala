...
trait PlotEmaSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotEmaSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotEmaSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
