...
trait PlotPsarSonificationTracksMappingPitchOptions extends StObject {
...
object PlotPsarSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
