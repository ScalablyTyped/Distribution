...
trait PlotAroonoscillatorSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotAroonoscillatorSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotAroonoscillatorSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonoscillatorSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
