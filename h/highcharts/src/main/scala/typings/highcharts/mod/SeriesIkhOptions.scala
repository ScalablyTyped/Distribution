...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesIkhOptions extends PlotIkhOptions {
  /**
    * Not available
    */
...
object SeriesIkhOptions {
  ...
  def apply(
    ...
    dataLabels: PlotIkhDataLabelsOptions | js.Array[PlotIkhDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotIkhDataSortingOptions = null,
