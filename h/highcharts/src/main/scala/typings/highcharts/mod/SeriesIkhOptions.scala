...
import typings.highcharts.highchartsStrings.ikh
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesIkhOptions
  extends StObject
     with PlotIkhOptions {
...
object SeriesIkhOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | ikh): SeriesIkhOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesIkhOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | ikh): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
