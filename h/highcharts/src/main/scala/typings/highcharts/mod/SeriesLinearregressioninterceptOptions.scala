...
object SeriesLinearregressioninterceptOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | linearregressionintercept): SeriesLinearregressioninterceptOptions = {
  ...
  extension [Self <: SeriesLinearregressioninterceptOptions](x: Self) {
    ...
    inline def setType(value: String | linearregressionintercept): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
