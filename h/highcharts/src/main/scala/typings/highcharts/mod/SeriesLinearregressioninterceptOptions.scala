...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesLinearregressioninterceptOptions extends PlotLinearregressioninterceptOptions {
  /**
    * Not available
    */
...
object SeriesLinearregressioninterceptOptions {
  ...
  def apply(
    ...
    dataLabels: PlotLinearregressioninterceptDataLabelsOptions | js.Array[PlotLinearregressioninterceptDataLabelsOptions] = null,
