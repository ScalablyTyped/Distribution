...
trait SeriesLinearregressioninterceptOptions extends PlotLinearregressioninterceptOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | linearregressionintercept = js.native
...
object SeriesLinearregressioninterceptOptions {
  ...
  @scala.inline
  def apply(`type`: String | linearregressionintercept): SeriesLinearregressioninterceptOptions = {
  ...
  @scala.inline
  implicit class SeriesLinearregressioninterceptOptionsMutableBuilder[Self <: SeriesLinearregressioninterceptOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | linearregressionintercept): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
