...
object SeriesLinearregressioninterceptOptions {
  ...
  @scala.inline
  implicit class SeriesLinearregressioninterceptOptionsOps[Self <: SeriesLinearregressioninterceptOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | linearregressionintercept): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
