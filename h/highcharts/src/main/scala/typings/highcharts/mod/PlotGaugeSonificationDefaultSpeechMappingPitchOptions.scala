...
trait PlotGaugeSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotGaugeSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotGaugeSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
