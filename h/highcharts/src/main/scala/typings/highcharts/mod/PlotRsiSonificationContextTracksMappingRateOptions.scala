...
trait PlotRsiSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotRsiSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
