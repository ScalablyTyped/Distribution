...
trait PlotStochasticSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotStochasticSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
