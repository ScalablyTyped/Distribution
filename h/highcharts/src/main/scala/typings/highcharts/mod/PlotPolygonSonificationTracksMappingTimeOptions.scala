...
trait PlotPolygonSonificationTracksMappingTimeOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
