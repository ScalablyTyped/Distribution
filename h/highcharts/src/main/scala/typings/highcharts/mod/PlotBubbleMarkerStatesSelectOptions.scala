...
trait PlotBubbleMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotBubbleMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBubbleMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleMarkerStatesSelectOptions]
  }
}
