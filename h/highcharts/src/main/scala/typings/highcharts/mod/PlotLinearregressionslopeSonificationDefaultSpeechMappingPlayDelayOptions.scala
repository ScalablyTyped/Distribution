...
trait PlotLinearregressionslopeSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
