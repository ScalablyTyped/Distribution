...
trait PlotApoSonificationTracksPointGroupingOptions extends StObject {
...
object PlotApoSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotApoSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
