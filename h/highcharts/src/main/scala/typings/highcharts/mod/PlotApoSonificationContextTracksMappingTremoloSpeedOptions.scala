...
trait PlotApoSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
