...
trait PlotPolygonSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotPolygonSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
