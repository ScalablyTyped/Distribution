...
trait PlotDependencywheelDataSortingOptions extends js.Object {
  /**
...
object PlotDependencywheelDataSortingOptions {
  @scala.inline
  def apply(
    enabled: js.UndefOr[Boolean] = js.undefined,
    matchByName: js.UndefOr[Boolean] = js.undefined,
    sortKey: String = null
  ): PlotDependencywheelDataSortingOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelDataSortingOptions]
  }
}
