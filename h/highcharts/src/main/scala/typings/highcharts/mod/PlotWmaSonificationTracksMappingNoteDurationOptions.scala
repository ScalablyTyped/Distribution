...
trait PlotWmaSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotWmaSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
