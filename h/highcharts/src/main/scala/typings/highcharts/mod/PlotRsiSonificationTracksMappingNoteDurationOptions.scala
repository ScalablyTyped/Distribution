...
trait PlotRsiSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotRsiSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
