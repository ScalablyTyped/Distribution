...
trait PlotDpoSonificationTracksMappingPitchOptions extends StObject {
...
object PlotDpoSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotDpoSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDpoSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
