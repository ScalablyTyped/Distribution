...
trait PlotMaplineSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotMaplineSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotMaplineSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
