...
trait PlotFlagsSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotFlagsSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
