...
trait PlotSlowstochasticSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
