...
trait PlotPsarSonificationTracksMappingOptions extends StObject {
  
  /**
    * (Highstock) Frequency in Hertz of notes. Overrides pitch mapping if set.
    */
  var frequency: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingFrequencyOptions
  ] = js.undefined
  ...
  var gapBetweenNotes: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingGapBetweenNotesOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var highpass: js.UndefOr[PlotPsarSonificationTracksMappingHighpassOptions] = js.undefined
  ...
  /**
    ...
    */
  var lowpass: js.UndefOr[PlotPsarSonificationTracksMappingLowpassOptions] = js.undefined
  ...
  var noteDuration: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingNoteDurationOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var pan: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingPanOptions
  ] = js.undefined
  ...
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingPitchOptions | (js.Array[String | Double])
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingPlayDelayOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var rate: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingRateOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingTimeOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var tremolo: js.UndefOr[PlotPsarSonificationTracksMappingTremoloOptions] = js.undefined
  
  /**
    * (Highstock) The volume of notes, from 0 to 1.
    */
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingVolumeOptions
  ] = js.undefined
}
object PlotPsarSonificationTracksMappingOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setFrequency(
      value: Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingFrequencyOptions
    ): Self = StObject.set(x, "frequency", value.asInstanceOf[js.Any])
    
    inline def setFrequencyUndefined: Self = StObject.set(x, "frequency", js.undefined)
    
    inline def setGapBetweenNotes(
      value: Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingGapBetweenNotesOptions
    ...
    inline def setHighpass(value: PlotPsarSonificationTracksMappingHighpassOptions): Self = StObject.set(x, "highpass", value.asInstanceOf[js.Any])
    
    inline def setHighpassUndefined: Self = StObject.set(x, "highpass", js.undefined)
    
    inline def setLowpass(value: PlotPsarSonificationTracksMappingLowpassOptions): Self = StObject.set(x, "lowpass", value.asInstanceOf[js.Any])
    
    inline def setLowpassUndefined: Self = StObject.set(x, "lowpass", js.undefined)
    
    inline def setNoteDuration(
      value: Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingNoteDurationOptions
    ...
    inline def setPan(value: Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingPanOptions): Self = StObject.set(x, "pan", value.asInstanceOf[js.Any])
    
    inline def setPanUndefined: Self = StObject.set(x, "pan", js.undefined)
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingPitchOptions | (js.Array[String | Double])
    ...
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingPlayDelayOptions
    ...
    inline def setRate(value: Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingRateOptions): Self = StObject.set(x, "rate", value.asInstanceOf[js.Any])
    ...
    inline def setTime(value: Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingTimeOptions): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setTremolo(value: PlotPsarSonificationTracksMappingTremoloOptions): Self = StObject.set(x, "tremolo", value.asInstanceOf[js.Any])
    
    inline def setTremoloUndefined: Self = StObject.set(x, "tremolo", js.undefined)
    
    inline def setVolume(value: Double | js.Object | String | js.Function | PlotPsarSonificationTracksMappingVolumeOptions): Self = StObject.set(x, "volume", value.asInstanceOf[js.Any])
