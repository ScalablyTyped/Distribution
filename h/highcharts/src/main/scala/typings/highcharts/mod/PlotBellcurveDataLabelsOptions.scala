...
object PlotBellcurveDataLabelsOptions {
  ...
  inline def apply(): PlotBellcurveDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveDataLabelsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBellcurveDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotBellcurveDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
