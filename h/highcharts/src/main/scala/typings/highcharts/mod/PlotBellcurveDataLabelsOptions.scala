...
@js.native
trait PlotBellcurveDataLabelsOptions extends js.Object {
...
object PlotBellcurveDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotBellcurveDataLabelsOptionsOps[Self <: PlotBellcurveDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBellcurveDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
