...
trait PlotHollowcandlestickSonificationPointGroupingOptions extends StObject {
...
object PlotHollowcandlestickSonificationPointGroupingOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
