...
trait PlotPriceenvelopesSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
