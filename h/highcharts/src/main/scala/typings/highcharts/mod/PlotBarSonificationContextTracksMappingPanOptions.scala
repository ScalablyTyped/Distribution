...
trait PlotBarSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotBarSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotBarSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
