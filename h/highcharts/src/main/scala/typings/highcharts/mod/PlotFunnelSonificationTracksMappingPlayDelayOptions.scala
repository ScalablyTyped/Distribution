...
trait PlotFunnelSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotFunnelSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotFunnelSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
