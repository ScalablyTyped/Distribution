...
@js.native
trait PlotMapbubbleDataSortingOptions extends js.Object {
...
object PlotMapbubbleDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotMapbubbleDataSortingOptionsOps[Self <: PlotMapbubbleDataSortingOptions] (val x: Self) extends AnyVal {
