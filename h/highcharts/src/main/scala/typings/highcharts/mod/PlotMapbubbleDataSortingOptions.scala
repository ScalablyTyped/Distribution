...
@js.native
trait PlotMapbubbleDataSortingOptions extends StObject {
...
object PlotMapbubbleDataSortingOptions {
  
  @scala.inline
  def apply(): PlotMapbubbleDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotMapbubbleDataSortingOptionsMutableBuilder[Self <: PlotMapbubbleDataSortingOptions] (val x: Self) extends AnyVal {
