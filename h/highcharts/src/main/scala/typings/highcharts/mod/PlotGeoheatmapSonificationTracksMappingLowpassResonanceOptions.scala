...
trait PlotGeoheatmapSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
