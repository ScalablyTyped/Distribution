...
trait PlotPictorialSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
