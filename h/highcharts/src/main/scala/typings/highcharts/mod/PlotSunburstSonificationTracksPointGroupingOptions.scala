...
trait PlotSunburstSonificationTracksPointGroupingOptions extends StObject {
...
object PlotSunburstSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotSunburstSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
