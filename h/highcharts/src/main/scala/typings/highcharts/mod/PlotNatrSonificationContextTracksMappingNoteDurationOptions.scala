...
trait PlotNatrSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
