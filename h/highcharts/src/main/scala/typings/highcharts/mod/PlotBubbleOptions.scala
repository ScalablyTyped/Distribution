...
trait PlotBubbleOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotBubbleAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotBubbleDataLabelsOptions | js.Array[PlotBubbleDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotBubbleDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotBubbleJitterOptions] = js.native
...
object PlotBubbleOptions {
  ...
  @scala.inline
  def apply(): PlotBubbleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleOptions]
  }
  
  @scala.inline
  implicit class PlotBubbleOptionsMutableBuilder[Self <: PlotBubbleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBubbleAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotBubbleDataLabelsOptions | js.Array[PlotBubbleDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotBubbleDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotBubbleDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJitter(value: PlotBubbleJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
