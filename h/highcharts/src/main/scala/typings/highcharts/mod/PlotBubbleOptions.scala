...
trait PlotBubbleOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotBubbleSonificationOptions] = js.undefined
...
object PlotBubbleOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotBubbleOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotBubbleSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
