...
trait PlotFlagsSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotFlagsSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotFlagsSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
