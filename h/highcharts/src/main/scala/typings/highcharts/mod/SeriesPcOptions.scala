...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesPcOptions
  extends StObject
     with PlotPcOptions {
...
object SeriesPcOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | pc): SeriesPcOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesPcOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | pc): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
