...
import typings.highcharts.highchartsStrings.pc
...
trait SeriesPcOptions extends PlotPcOptions {
...
object SeriesPcOptions {
  
  @scala.inline
  def apply(`type`: String | pc): SeriesPcOptions = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesPcOptions]
  }
  
  @scala.inline
  implicit class SeriesPcOptionsMutableBuilder[Self <: SeriesPcOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | pc): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
