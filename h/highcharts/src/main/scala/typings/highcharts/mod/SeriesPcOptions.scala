...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesPcOptions extends PlotPcOptions {
  /**
    * Not available
    */
...
object SeriesPcOptions {
  ...
  def apply(
    ...
    dataLabels: PlotPcDataLabelsOptions | js.Array[PlotPcDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotPcDataSortingOptions = null,
