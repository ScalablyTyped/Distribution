...
object SeriesPcOptions {
  ...
  @scala.inline
  implicit class SeriesPcOptionsOps[Self <: SeriesPcOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | pc): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
