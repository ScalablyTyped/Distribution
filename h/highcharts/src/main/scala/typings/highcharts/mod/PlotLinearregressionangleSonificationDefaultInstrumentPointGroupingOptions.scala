...
trait PlotLinearregressionangleSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotLinearregressionangleSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
