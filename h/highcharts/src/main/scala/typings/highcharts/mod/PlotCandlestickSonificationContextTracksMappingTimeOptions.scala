...
trait PlotCandlestickSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
