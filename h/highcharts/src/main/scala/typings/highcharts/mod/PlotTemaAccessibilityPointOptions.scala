...
trait PlotTemaAccessibilityPointOptions extends StObject {
...
object PlotTemaAccessibilityPointOptions {
  
  inline def apply(): PlotTemaAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaAccessibilityPointOptions] (val x: Self) extends AnyVal {
