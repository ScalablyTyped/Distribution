...
trait PlotSeriesSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
