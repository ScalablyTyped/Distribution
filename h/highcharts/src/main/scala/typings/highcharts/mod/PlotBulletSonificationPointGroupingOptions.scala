...
trait PlotBulletSonificationPointGroupingOptions extends StObject {
...
object PlotBulletSonificationPointGroupingOptions {
  
  inline def apply(): PlotBulletSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
