...
trait PlotPictorialSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotPictorialSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotPictorialSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
