...
trait PlotDmiSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
