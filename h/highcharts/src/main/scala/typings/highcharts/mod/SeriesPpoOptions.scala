...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesPpoOptions
  extends StObject
     with PlotPpoOptions {
...
object SeriesPpoOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | ppo): SeriesPpoOptions = {
  ...
  @scala.inline
  implicit class SeriesPpoOptionsMutableBuilder[Self <: SeriesPpoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | ppo): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
