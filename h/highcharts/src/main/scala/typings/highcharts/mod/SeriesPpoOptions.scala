...
object SeriesPpoOptions {
  ...
  @scala.inline
  implicit class SeriesPpoOptionsOps[Self <: SeriesPpoOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | ppo): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
