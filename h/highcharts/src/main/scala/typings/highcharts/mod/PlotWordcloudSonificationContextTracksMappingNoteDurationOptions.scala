...
trait PlotWordcloudSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
