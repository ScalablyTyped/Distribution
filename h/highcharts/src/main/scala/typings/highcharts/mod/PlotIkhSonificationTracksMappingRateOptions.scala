...
trait PlotIkhSonificationTracksMappingRateOptions extends StObject {
...
object PlotIkhSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
