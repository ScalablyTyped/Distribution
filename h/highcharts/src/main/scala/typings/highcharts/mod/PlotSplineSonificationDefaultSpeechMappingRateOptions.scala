...
trait PlotSplineSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotSplineSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotSplineSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
