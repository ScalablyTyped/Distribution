...
@js.native
trait PlotRsiDataSortingOptions extends StObject {
...
object PlotRsiDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotRsiDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotRsiDataSortingOptionsMutableBuilder[Self <: PlotRsiDataSortingOptions] (val x: Self) extends AnyVal {
