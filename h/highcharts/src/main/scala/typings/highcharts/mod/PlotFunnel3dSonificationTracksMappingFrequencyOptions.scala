...
trait PlotFunnel3dSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotFunnel3dSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
