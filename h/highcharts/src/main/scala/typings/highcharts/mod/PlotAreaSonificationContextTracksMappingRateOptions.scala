...
trait PlotAreaSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotAreaSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotAreaSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
