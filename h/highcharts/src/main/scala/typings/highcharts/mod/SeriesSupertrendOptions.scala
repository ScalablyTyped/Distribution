...
import typings.highcharts.highchartsStrings.supertrend
...
trait SeriesSupertrendOptions extends PlotSupertrendOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | supertrend = js.native
...
object SeriesSupertrendOptions {
  ...
  @scala.inline
  def apply(`type`: String | supertrend): SeriesSupertrendOptions = {
  ...
  @scala.inline
  implicit class SeriesSupertrendOptionsMutableBuilder[Self <: SeriesSupertrendOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | supertrend): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
