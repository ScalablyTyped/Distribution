...
object SeriesSupertrendOptions {
  ...
  @scala.inline
  implicit class SeriesSupertrendOptionsOps[Self <: SeriesSupertrendOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | supertrend): Self = this.set("type", value.asInstanceOf[js.Any])
