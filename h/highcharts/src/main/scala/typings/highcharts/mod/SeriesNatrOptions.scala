...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesNatrOptions
  extends StObject
     with PlotNatrOptions {
...
object SeriesNatrOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | natr): SeriesNatrOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesNatrOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | natr): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
