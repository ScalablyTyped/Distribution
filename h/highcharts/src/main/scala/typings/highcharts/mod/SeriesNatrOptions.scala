...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesNatrOptions extends PlotNatrOptions {
  /**
    * Not available
    */
...
object SeriesNatrOptions {
  ...
  def apply(
    ...
    dataLabels: PlotNatrDataLabelsOptions | js.Array[PlotNatrDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotNatrDataSortingOptions = null,
