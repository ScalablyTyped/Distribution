...
trait PlotCylinderSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
