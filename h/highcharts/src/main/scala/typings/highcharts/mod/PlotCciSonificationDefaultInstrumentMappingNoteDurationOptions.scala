...
trait PlotCciSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotCciSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotCciSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
