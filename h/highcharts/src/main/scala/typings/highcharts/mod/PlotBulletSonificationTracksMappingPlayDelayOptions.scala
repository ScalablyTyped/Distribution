...
trait PlotBulletSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotBulletSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
