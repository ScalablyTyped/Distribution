...
trait PlotTemaSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotTemaSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
