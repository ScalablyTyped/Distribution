...
trait PlotPsarOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotPsarSonificationOptions] = js.undefined
...
object PlotPsarOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotPsarSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
