...
trait PlotSankeyTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotSankeyTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotSankeyTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotSankeyTooltipDateTimeLabelFormatsOptions]
  }
}
