...
trait SonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object SonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): SonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
