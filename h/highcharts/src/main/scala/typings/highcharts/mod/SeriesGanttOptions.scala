...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesGanttOptions extends PlotGanttOptions {
  /**
...
object SeriesGanttOptions {
  ...
  def apply(
    ...
    data: js.Array[GanttPointOptionsObject] = null,
