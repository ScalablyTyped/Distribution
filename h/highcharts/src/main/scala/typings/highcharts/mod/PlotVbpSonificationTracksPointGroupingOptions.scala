...
trait PlotVbpSonificationTracksPointGroupingOptions extends StObject {
...
object PlotVbpSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotVbpSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVbpSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
