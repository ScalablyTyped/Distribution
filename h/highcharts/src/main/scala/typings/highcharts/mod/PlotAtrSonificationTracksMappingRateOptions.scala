...
trait PlotAtrSonificationTracksMappingRateOptions extends StObject {
...
object PlotAtrSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
