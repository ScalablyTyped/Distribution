...
trait PlotItemSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotItemSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
