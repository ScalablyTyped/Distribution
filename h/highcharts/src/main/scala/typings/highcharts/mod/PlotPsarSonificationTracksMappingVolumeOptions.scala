...
trait PlotPsarSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotPsarSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
