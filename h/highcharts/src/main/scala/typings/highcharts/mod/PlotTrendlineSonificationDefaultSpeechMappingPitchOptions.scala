...
trait PlotTrendlineSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotTrendlineSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
