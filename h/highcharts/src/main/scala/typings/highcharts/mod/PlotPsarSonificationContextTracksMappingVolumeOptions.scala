...
trait PlotPsarSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotPsarSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
