...
trait PlotBarSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotBarSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotBarSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
