...
trait PlotTemaSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotTemaSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
