...
trait PlotCandlestickSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotCandlestickSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
