...
trait PlotColumnpyramidConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotColumnpyramidConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnpyramidConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotColumnpyramidConnectorsMarkerOptions]
  }
}
