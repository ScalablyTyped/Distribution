...
trait PlotArearangeSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
