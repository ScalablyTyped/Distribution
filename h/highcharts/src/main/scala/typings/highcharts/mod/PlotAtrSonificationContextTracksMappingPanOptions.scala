...
trait PlotAtrSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
