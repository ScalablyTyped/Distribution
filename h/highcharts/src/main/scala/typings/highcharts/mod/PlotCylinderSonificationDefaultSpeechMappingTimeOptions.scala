...
trait PlotCylinderSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotCylinderSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
