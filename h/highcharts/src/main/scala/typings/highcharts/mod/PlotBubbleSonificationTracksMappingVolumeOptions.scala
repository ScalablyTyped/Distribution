...
trait PlotBubbleSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotBubbleSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotBubbleSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
