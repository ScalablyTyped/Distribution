...
trait PlotAreaSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotAreaSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotAreaSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
