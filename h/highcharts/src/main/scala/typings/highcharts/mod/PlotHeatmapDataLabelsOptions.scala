...
object PlotHeatmapDataLabelsOptions {
  ...
  inline def apply(): PlotHeatmapDataLabelsOptions = {
  ...
  extension [Self <: PlotHeatmapDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotHeatmapDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
