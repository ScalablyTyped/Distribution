...
trait PlotHeatmapDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotHeatmapDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotHeatmapDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotHeatmapDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotHeatmapDataLabelsOptionsMutableBuilder[Self <: PlotHeatmapDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotHeatmapDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
