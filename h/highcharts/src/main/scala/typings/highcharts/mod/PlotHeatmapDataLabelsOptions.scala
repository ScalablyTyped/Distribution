...
@js.native
trait PlotHeatmapDataLabelsOptions extends js.Object {
...
object PlotHeatmapDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotHeatmapDataLabelsOptionsOps[Self <: PlotHeatmapDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotHeatmapDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
