...
trait PlotTreemapSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotTreemapSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
