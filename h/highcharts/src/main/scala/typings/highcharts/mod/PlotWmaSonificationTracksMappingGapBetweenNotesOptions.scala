...
trait PlotWmaSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotWmaSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
