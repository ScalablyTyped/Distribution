...
trait PlotParetoSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotParetoSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotParetoSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
