...
trait PlotTreemapSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotTreemapSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
