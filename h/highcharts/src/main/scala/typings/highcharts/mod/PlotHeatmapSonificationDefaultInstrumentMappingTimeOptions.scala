...
trait PlotHeatmapSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotHeatmapSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
