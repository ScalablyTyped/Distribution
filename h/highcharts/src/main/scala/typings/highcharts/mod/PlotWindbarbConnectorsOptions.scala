...
trait PlotWindbarbConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotWindbarbConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotWindbarbConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotWindbarbConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotWindbarbConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotWindbarbConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotWindbarbConnectorsMarkerOptions = null,
    startMarker: PlotWindbarbConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotWindbarbConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotWindbarbConnectorsOptions]
  }
}
