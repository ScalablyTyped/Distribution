...
trait PlotArcdiagramSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
