...
trait PlotVariwideSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotVariwideSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
