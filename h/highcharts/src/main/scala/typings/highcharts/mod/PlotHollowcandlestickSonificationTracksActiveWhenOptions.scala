...
trait PlotHollowcandlestickSonificationTracksActiveWhenOptions extends StObject {
...
object PlotHollowcandlestickSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
