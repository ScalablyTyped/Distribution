...
trait PlotDependencywheelSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
