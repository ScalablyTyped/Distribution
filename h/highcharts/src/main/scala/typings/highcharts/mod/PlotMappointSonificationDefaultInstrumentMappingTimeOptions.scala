...
trait PlotMappointSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotMappointSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotMappointSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
