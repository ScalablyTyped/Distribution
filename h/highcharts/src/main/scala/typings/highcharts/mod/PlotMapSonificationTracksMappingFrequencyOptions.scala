...
trait PlotMapSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotMapSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
