...
trait PlotWmaSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotWmaSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
