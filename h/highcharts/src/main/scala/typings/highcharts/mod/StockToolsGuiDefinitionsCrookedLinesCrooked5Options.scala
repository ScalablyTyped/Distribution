...
object StockToolsGuiDefinitionsCrookedLinesCrooked5Options {
  ...
  @scala.inline
  implicit class StockToolsGuiDefinitionsCrookedLinesCrooked5OptionsOps[Self <: StockToolsGuiDefinitionsCrookedLinesCrooked5Options] (val x: Self) extends AnyVal {
    @scala.inline
