...
trait PlotPackedbubbleSonificationTracksPointGroupingOptions extends StObject {
...
object PlotPackedbubbleSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotPackedbubbleSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPackedbubbleSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPackedbubbleSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
