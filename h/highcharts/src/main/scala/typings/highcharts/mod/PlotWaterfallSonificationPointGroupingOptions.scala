...
trait PlotWaterfallSonificationPointGroupingOptions extends StObject {
...
object PlotWaterfallSonificationPointGroupingOptions {
  
  inline def apply(): PlotWaterfallSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
