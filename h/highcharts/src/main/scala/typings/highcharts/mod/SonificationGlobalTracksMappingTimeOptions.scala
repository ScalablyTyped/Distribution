...
trait SonificationGlobalTracksMappingTimeOptions extends StObject {
...
object SonificationGlobalTracksMappingTimeOptions {
  
  inline def apply(): SonificationGlobalTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingTimeOptions] (val x: Self) extends AnyVal {
