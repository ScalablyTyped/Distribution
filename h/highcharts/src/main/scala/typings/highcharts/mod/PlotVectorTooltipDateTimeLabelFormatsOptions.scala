...
trait PlotVectorTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotVectorTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotVectorTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotVectorTooltipDateTimeLabelFormatsOptions]
  }
}
