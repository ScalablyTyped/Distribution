...
trait PlotPyramidSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotPyramidSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
