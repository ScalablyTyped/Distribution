...
trait PlotLinearregressionangleSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
