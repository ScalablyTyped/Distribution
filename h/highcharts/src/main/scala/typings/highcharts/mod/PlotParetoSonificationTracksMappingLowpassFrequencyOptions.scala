...
trait PlotParetoSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotParetoSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotParetoSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
