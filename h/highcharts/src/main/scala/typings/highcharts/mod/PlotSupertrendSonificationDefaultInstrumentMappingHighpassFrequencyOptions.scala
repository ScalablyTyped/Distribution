...
trait PlotSupertrendSonificationDefaultInstrumentMappingHighpassFrequencyOptions extends StObject {
...
object PlotSupertrendSonificationDefaultInstrumentMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotSupertrendSonificationDefaultInstrumentMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationDefaultInstrumentMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationDefaultInstrumentMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
