...
trait PlotBarSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotBarSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
