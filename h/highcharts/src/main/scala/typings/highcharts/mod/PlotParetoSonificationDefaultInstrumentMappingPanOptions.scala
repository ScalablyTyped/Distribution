...
trait PlotParetoSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotParetoSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotParetoSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
