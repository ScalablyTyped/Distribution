...
trait PlotWmaSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotWmaSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
