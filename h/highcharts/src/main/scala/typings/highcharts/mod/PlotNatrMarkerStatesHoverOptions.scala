...
trait PlotNatrMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotNatrMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNatrMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotNatrMarkerStatesHoverOptions]
  }
}
