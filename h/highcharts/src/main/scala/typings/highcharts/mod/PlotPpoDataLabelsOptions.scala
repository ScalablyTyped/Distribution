...
@js.native
trait PlotPpoDataLabelsOptions extends js.Object {
...
object PlotPpoDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotPpoDataLabelsOptionsOps[Self <: PlotPpoDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPpoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
