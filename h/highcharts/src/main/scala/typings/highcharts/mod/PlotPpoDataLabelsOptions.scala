...
trait PlotPpoDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotPpoDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotPpoDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotPpoDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotPpoDataLabelsOptionsMutableBuilder[Self <: PlotPpoDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPpoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
