...
trait PlotPsarSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPsarSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
