...
trait PlotFunnel3dSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
