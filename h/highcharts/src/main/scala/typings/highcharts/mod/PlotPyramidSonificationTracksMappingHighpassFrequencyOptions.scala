...
trait PlotPyramidSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
