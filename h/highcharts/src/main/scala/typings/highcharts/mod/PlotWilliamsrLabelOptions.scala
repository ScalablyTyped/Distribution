...
trait PlotWilliamsrLabelOptions extends js.Object {
  /**
...
object PlotWilliamsrLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotWilliamsrLabelOptions]
  }
}
