...
trait PlotColumnrangeSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
