...
@js.native
trait PlotFunnel3dDataLabelsOptions extends js.Object {
...
object PlotFunnel3dDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotFunnel3dDataLabelsOptionsOps[Self <: PlotFunnel3dDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotFunnel3dDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
