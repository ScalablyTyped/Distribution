...
object PlotFunnel3dDataLabelsOptions {
  ...
  inline def apply(): PlotFunnel3dDataLabelsOptions = {
  ...
  implicit open class MutableBuilder[Self <: PlotFunnel3dDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotFunnel3dDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
