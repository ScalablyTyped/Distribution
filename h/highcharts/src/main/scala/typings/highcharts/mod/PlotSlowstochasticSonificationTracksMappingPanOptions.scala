...
trait PlotSlowstochasticSonificationTracksMappingPanOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
