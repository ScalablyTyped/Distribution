...
trait PlotArearangeSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotArearangeSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
