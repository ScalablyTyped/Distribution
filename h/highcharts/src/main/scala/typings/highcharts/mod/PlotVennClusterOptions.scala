...
object PlotVennClusterOptions {
  ...
  def apply(
    ...
    events: PlotVennClusterEventsOptions = null,
    layoutAlgorithm: PlotVennClusterLayoutAlgorithmOptions = null,
    marker: PointMarkerOptionsObject = null,
    minimumClusterSize: js.UndefOr[Double] = js.undefined,
    states: PlotVennClusterStatesOptions = null,
    zones: js.Array[PlotVennClusterZonesOptions] = null
  ): PlotVennClusterOptions = {
