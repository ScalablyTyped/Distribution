...
object PlotVennClusterOptions {
  ...
  @scala.inline
  implicit class PlotVennClusterOptionsMutableBuilder[Self <: PlotVennClusterOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: PlotVennClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    @scala.inline
    def setLayoutAlgorithm(value: PlotVennClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStates(value: PlotVennClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    @scala.inline
    def setZones(value: js.Array[PlotVennClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setZonesUndefined: Self = StObject.set(x, "zones", js.undefined)
    
    @scala.inline
    def setZonesVarargs(value: PlotVennClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value :_*))
  }
}
