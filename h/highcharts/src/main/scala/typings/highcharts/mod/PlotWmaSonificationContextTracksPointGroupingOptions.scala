...
trait PlotWmaSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotWmaSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
