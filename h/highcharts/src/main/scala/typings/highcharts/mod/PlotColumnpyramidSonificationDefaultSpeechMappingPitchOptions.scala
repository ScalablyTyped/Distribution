...
trait PlotColumnpyramidSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
