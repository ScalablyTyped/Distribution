...
trait PlotLineSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotLineSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotLineSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
