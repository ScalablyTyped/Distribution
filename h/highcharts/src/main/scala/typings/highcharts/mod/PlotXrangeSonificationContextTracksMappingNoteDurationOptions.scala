...
trait PlotXrangeSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotXrangeSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
