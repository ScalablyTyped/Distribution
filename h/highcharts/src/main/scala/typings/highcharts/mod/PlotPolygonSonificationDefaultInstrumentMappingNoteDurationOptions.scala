...
trait PlotPolygonSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotPolygonSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
