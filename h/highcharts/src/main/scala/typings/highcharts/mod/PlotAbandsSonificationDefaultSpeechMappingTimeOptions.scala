...
trait PlotAbandsSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotAbandsSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotAbandsSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
