...
trait PlotNetworkgraphSonificationTracksMappingPitchOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
