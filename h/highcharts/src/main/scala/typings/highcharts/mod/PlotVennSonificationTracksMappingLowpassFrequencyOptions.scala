...
trait PlotVennSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotVennSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
