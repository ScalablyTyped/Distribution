...
trait ChartParallelAxesPlotBandsOptions extends StObject {
  ...
  /**
    ...
    * `mousemove`.
    */
  var events: js.UndefOr[ChartParallelAxesPlotBandsEventsOptions] = js.undefined
  ...
  /**
    ...
    */
  var label: js.UndefOr[ChartParallelAxesPlotBandsLabelOptions] = js.undefined
...
object ChartParallelAxesPlotBandsOptions {
  
  inline def apply(): ChartParallelAxesPlotBandsOptions = {
  ...
  extension [Self <: ChartParallelAxesPlotBandsOptions](x: Self) {
    ...
    inline def setEvents(value: ChartParallelAxesPlotBandsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setLabel(value: ChartParallelAxesPlotBandsLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    inline def setThickness(value: Double | String): Self = StObject.set(x, "thickness", value.asInstanceOf[js.Any])
