...
trait PlotDmiSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
