...
trait PlotAbandsSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotAbandsSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotAbandsSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
