...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesCmfOptions
  extends StObject
     with PlotCmfOptions {
...
object SeriesCmfOptions {
  ...
  inline def apply(`type`: String | cmf): SeriesCmfOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesCmfOptions] (val x: Self) extends AnyVal {
