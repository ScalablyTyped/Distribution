...
trait PlotParetoPointEventsOptions extends js.Object {
  /**
...
object PlotParetoPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotParetoPointEventsOptions]
  }
}
