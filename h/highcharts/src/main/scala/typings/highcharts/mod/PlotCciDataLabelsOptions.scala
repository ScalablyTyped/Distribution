...
@js.native
trait PlotCciDataLabelsOptions extends js.Object {
...
object PlotCciDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotCciDataLabelsOptionsOps[Self <: PlotCciDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotCciDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
