...
object PlotCciDataLabelsOptions {
  ...
  inline def apply(): PlotCciDataLabelsOptions = {
  ...
  implicit open class MutableBuilder[Self <: PlotCciDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotCciDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
