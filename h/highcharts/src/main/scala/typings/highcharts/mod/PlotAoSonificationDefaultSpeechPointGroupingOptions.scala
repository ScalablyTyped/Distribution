...
trait PlotAoSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotAoSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotAoSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
