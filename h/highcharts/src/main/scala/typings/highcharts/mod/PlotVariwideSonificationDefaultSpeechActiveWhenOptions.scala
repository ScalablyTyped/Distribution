...
trait PlotVariwideSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotVariwideSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
