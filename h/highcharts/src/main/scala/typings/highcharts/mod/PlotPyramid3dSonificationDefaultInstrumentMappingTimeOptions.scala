...
trait PlotPyramid3dSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
