...
trait PlotPolygonSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotPolygonSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotPolygonSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
