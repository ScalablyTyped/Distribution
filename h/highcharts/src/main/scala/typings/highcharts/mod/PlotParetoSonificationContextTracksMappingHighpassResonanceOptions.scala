...
trait PlotParetoSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
