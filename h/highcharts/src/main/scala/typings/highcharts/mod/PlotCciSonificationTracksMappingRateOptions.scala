...
trait PlotCciSonificationTracksMappingRateOptions extends StObject {
...
object PlotCciSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
