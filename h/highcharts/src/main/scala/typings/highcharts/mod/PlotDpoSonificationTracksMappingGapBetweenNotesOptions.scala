...
trait PlotDpoSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotDpoSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotDpoSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDpoSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
