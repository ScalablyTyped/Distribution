...
trait PlotAreaSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotAreaSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotAreaSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
