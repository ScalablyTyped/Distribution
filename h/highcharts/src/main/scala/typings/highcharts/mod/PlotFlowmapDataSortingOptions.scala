...
trait PlotFlowmapDataSortingOptions extends StObject {
...
object PlotFlowmapDataSortingOptions {
  
  inline def apply(): PlotFlowmapDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapDataSortingOptions] (val x: Self) extends AnyVal {
