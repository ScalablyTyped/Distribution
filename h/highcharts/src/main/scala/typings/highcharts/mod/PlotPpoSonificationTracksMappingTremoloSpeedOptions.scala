...
trait PlotPpoSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPpoSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
