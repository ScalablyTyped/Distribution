...
object SeriesConnectorsOptionsObject {
  ...
  @scala.inline
  implicit class SeriesConnectorsOptionsObjectOps[Self <: SeriesConnectorsOptionsObject] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAnimation(value: ConnectorsAnimationOptionsObject): Self = this.set("animation", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | PathfinderTypeValue): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
