...
trait PlotPyramid3dConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotPyramid3dConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramid3dConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPyramid3dConnectorsStartMarkerOptions]
  }
}
