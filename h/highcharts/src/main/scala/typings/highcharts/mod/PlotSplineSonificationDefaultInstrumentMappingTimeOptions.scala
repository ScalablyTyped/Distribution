...
trait PlotSplineSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotSplineSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotSplineSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
