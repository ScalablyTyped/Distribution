...
trait PlotArearangeSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotArearangeSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotArearangeSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
