...
trait PlotLinearregressioninterceptSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
