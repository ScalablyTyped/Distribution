...
trait PlotWordcloudSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
