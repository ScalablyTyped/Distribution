...
trait PlotTemaAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTemaAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotTemaAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotTemaAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotTemaAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotTemaAccessibilityOptions]
  }
}
