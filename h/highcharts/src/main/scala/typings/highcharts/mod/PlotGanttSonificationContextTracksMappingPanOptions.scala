...
trait PlotGanttSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotGanttSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
