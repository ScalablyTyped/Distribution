...
trait PlotSlowstochasticSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotSlowstochasticSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotSlowstochasticSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
