...
trait PlotPyramidEventsOptions extends js.Object {
  /**
...
object PlotPyramidEventsOptions {
  @scala.inline
  def apply(
    afterAnimate: SeriesAfterAnimateCallbackFunction = null,
    checkboxClick: js.Function = null,
    ...
    __obj.asInstanceOf[PlotPyramidEventsOptions]
  }
}
