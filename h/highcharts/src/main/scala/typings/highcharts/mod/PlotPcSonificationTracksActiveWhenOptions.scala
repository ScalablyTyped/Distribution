...
trait PlotPcSonificationTracksActiveWhenOptions extends StObject {
...
object PlotPcSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotPcSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
