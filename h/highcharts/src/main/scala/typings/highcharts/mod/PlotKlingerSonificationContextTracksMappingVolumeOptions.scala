...
trait PlotKlingerSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotKlingerSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
