...
trait PlotFunnelSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotFunnelSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotFunnelSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
