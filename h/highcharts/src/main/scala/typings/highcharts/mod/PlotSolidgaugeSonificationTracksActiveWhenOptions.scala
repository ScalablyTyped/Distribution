...
trait PlotSolidgaugeSonificationTracksActiveWhenOptions extends StObject {
...
object PlotSolidgaugeSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotSolidgaugeSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSolidgaugeSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
