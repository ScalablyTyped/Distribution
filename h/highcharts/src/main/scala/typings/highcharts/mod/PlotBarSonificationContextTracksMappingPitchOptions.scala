...
trait PlotBarSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotBarSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotBarSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
