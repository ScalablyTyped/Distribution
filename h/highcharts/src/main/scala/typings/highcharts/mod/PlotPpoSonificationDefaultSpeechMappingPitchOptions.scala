...
trait PlotPpoSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotPpoSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotPpoSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
