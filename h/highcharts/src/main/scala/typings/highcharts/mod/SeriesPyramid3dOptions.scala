...
trait SeriesPyramid3dOptions extends PlotPyramid3dOptions {
  /**
    ...
    */
  var data: js.UndefOr[js.Array[Double | js.Array[Double] | PointOptionsObject]] = js.native
  /**
...
object SeriesPyramid3dOptions {
  ...
  implicit class SeriesPyramid3dOptionsOps[Self <: SeriesPyramid3dOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataVarargs(value: (Double | js.Array[Double] | PointOptionsObject)*): Self = this.set("data", js.Array(value :_*))
    @scala.inline
    def setData(value: js.Array[Double | js.Array[Double] | PointOptionsObject]): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
