...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesPyramid3dOptions extends PlotPyramid3dOptions {
  /**
...
object SeriesPyramid3dOptions {
  ...
  def apply(
    ...
    dataLabels: PlotPyramid3dDataLabelsOptions | js.Array[PlotPyramid3dDataLabelsOptions] = null,
