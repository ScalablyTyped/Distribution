...
object SeriesPyramid3dOptions {
  ...
  implicit open class MutableBuilder[Self <: SeriesPyramid3dOptions] (val x: Self) extends AnyVal {
    ...
    inline def setData(value: js.Array[Double | js.Array[Double] | PointOptionsObject]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    inline def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    inline def setDataVarargs(value: (Double | js.Array[Double] | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value*))
