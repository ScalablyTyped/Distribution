...
trait PlotPcSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotPcSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotPcSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
