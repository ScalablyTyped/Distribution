...
trait PlotFunnel3dSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotFunnel3dSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
