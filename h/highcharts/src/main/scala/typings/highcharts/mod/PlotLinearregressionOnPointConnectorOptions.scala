...
trait PlotLinearregressionOnPointConnectorOptions extends StObject {
...
object PlotLinearregressionOnPointConnectorOptions {
  
  inline def apply(): PlotLinearregressionOnPointConnectorOptions = {
