...
trait SeriesMappointDataEventsOptions extends js.Object {
  /**
...
object SeriesMappointDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesMappointDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesMappointDataEventsOptions]
  }
}
