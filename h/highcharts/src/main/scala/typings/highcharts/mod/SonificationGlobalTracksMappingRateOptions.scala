...
trait SonificationGlobalTracksMappingRateOptions extends StObject {
...
object SonificationGlobalTracksMappingRateOptions {
  
  inline def apply(): SonificationGlobalTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingRateOptions] (val x: Self) extends AnyVal {
