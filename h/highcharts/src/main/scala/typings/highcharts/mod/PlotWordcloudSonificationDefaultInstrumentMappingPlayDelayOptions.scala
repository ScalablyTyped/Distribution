...
trait PlotWordcloudSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotWordcloudSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
