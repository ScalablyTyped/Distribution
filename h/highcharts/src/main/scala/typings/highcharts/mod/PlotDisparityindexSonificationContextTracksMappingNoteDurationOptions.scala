...
trait PlotDisparityindexSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
