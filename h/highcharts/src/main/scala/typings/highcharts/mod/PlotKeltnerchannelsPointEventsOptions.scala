...
trait PlotKeltnerchannelsPointEventsOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsPointEventsOptions]
  }
}
