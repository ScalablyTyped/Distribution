...
trait AnnotationsMeasureOptions extends StObject {
  ...
  /**
    ...
    */
  var labelOptions: js.UndefOr[AnnotationsMeasureLabelOptions] = js.undefined
  ...
  /**
    ...
    */
  var shapeOptions: js.UndefOr[AnnotationsMeasureShapeOptions] = js.undefined
...
object AnnotationsMeasureOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AnnotationsMeasureOptions] (val x: Self) extends AnyVal {
    ...
    inline def setLabelOptions(value: AnnotationsMeasureLabelOptions): Self = StObject.set(x, "labelOptions", value.asInstanceOf[js.Any])
    
    inline def setLabelOptionsUndefined: Self = StObject.set(x, "labelOptions", js.undefined)
    
    inline def setShapeOptions(value: AnnotationsMeasureShapeOptions): Self = StObject.set(x, "shapeOptions", value.asInstanceOf[js.Any])
