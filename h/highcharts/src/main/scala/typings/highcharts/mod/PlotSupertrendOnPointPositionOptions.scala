...
trait PlotSupertrendOnPointPositionOptions extends StObject {
...
object PlotSupertrendOnPointPositionOptions {
  
  inline def apply(): PlotSupertrendOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendOnPointPositionOptions] (val x: Self) extends AnyVal {
