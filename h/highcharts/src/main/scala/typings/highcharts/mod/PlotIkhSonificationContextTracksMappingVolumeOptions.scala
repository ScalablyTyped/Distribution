...
trait PlotIkhSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotIkhSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
