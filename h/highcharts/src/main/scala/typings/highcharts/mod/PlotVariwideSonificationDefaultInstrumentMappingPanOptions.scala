...
trait PlotVariwideSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotVariwideSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
