...
trait PlotOrganizationOnPointPositionOptions extends StObject {
...
object PlotOrganizationOnPointPositionOptions {
  
  inline def apply(): PlotOrganizationOnPointPositionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationOnPointPositionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOrganizationOnPointPositionOptions] (val x: Self) extends AnyVal {
