...
@js.native
trait SeriesOhlcDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesOhlcDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesOhlcDataDataLabelsAnimationOptionsOps[Self <: SeriesOhlcDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
