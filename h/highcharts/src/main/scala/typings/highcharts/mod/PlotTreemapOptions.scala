...
trait PlotTreemapOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotTreemapSonificationOptions] = js.undefined
...
object PlotTreemapOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotTreemapOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotTreemapSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
