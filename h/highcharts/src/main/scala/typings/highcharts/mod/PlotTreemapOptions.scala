...
trait PlotTreemapOptions extends StObject {
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotTreemapDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotTreemapJitterOptions] = js.undefined
...
object PlotTreemapOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotTreemapOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotTreemapDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setJitter(value: PlotTreemapJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
