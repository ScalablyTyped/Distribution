...
trait PlotTreemapOptions extends StObject {
  ...
  /**
    ...
    */
  var cluster: js.UndefOr[PlotTreemapClusterOptions] = js.undefined
  ...
  /**
    ...
    */
  var colorByPoint: js.UndefOr[js.Object] = js.undefined
...
object PlotTreemapOptions {
  ...
  extension [Self <: PlotTreemapOptions](x: Self) {
    ...
    inline def setCluster(value: PlotTreemapClusterOptions): Self = StObject.set(x, "cluster", value.asInstanceOf[js.Any])
    ...
    inline def setColorByPoint(value: js.Object): Self = StObject.set(x, "colorByPoint", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabelsVarargs(value: PlotTreemapDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    ...
    inline def setLevelsVarargs(value: PlotTreemapLevelsOptions*): Self = StObject.set(x, "levels", js.Array(value :_*))
    ...
    inline def setTraverseUpButton(value: PlotTreemapTraverseUpButtonOptions): Self = StObject.set(x, "traverseUpButton", value.asInstanceOf[js.Any])
