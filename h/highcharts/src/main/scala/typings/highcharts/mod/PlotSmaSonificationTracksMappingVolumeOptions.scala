...
trait PlotSmaSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotSmaSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
