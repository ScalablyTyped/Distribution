...
@js.native
trait AnnotationsTunnelShapeOptions extends StObject {
...
object AnnotationsTunnelShapeOptions {
  ...
  @scala.inline
  def apply(): AnnotationsTunnelShapeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnnotationsTunnelShapeOptions]
  }
  
  @scala.inline
  implicit class AnnotationsTunnelShapeOptionsMutableBuilder[Self <: AnnotationsTunnelShapeOptions] (val x: Self) extends AnyVal {
