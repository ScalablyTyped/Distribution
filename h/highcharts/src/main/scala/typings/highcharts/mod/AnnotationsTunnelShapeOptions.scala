...
@js.native
trait AnnotationsTunnelShapeOptions extends js.Object {
  /**
...
object AnnotationsTunnelShapeOptions {
  ...
  @scala.inline
  implicit class AnnotationsTunnelShapeOptionsOps[Self <: AnnotationsTunnelShapeOptions] (val x: Self) extends AnyVal {
    @scala.inline
