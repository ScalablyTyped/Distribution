...
trait PlotArcdiagramSonificationTracksMappingRateOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
