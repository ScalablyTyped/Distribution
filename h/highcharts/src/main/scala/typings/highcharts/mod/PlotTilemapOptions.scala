...
trait PlotTilemapOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotTilemapSonificationOptions] = js.undefined
...
object PlotTilemapOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotTilemapOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotTilemapSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
