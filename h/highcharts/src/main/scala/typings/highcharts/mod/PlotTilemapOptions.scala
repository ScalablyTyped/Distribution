...
trait PlotTilemapOptions extends StObject {
  ...
  /**
    ...
    */
  var cluster: js.UndefOr[PlotTilemapClusterOptions] = js.undefined
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotTilemapDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotTilemapJitterOptions] = js.undefined
...
object PlotTilemapOptions {
  ...
  extension [Self <: PlotTilemapOptions](x: Self) {
    ...
    inline def setCluster(value: PlotTilemapClusterOptions): Self = StObject.set(x, "cluster", value.asInstanceOf[js.Any])
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotTilemapDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setJitter(value: PlotTilemapJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
