...
trait PlotAoSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotAoSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotAoSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
