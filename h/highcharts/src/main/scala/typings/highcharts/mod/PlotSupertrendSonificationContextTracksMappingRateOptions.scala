...
trait PlotSupertrendSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
