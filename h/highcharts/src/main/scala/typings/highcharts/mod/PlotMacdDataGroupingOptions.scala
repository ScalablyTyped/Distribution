...
trait PlotMacdDataGroupingOptions extends js.Object {
  /**
...
object PlotMacdDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotMacdDataGroupingOptions]
  }
}
