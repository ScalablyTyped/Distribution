...
trait PlotGanttSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotGanttSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotGanttSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
