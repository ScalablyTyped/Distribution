...
trait PlotAroonoscillatorSonificationPointGroupingOptions extends StObject {
...
object PlotAroonoscillatorSonificationPointGroupingOptions {
  
  inline def apply(): PlotAroonoscillatorSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonoscillatorSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
