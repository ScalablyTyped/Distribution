...
trait PlotSeriesDataGroupingOptions extends js.Object {
  /**
...
object PlotSeriesDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotSeriesDataGroupingOptions]
  }
}
