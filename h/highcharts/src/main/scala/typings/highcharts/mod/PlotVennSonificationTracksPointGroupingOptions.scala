...
trait PlotVennSonificationTracksPointGroupingOptions extends StObject {
...
object PlotVennSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotVennSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
