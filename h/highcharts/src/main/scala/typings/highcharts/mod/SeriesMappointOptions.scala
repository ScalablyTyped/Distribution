...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesMappointOptions
  extends StObject
     with PlotMappointOptions {
...
object SeriesMappointOptions {
  ...
  extension [Self <: SeriesMappointOptions](x: Self) {
    ...
    inline def setDataVarargs(value: (Double | (js.Tuple2[Double, Double | Null]) | Null | SeriesMappointDataOptions)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    inline def setType(value: String | mappoint): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
