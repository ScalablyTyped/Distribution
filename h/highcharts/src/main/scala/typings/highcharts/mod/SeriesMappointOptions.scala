...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesMappointOptions extends PlotMappointOptions {
  /**
...
object SeriesMappointOptions {
  ...
  def apply(
    ...
    dataLabels: PlotMappointDataLabelsOptions | js.Array[PlotMappointDataLabelsOptions] = null,
