...
trait SeriesBubbleDataEventsOptions extends js.Object {
  /**
...
object SeriesBubbleDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesBubbleDataEventsOptions]
  }
}
