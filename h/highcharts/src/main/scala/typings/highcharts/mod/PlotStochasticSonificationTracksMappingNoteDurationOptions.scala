...
trait PlotStochasticSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
