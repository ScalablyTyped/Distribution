...
trait SonificationGlobalContextTracksMappingLowpassResonanceOptions extends StObject {
...
object SonificationGlobalContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
