...
trait PlotGeoheatmapSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
