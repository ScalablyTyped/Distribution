...
trait PlotPyramid3dSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
