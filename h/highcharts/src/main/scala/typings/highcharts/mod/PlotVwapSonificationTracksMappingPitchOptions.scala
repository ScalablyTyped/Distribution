...
trait PlotVwapSonificationTracksMappingPitchOptions extends StObject {
...
object PlotVwapSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotVwapSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVwapSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
