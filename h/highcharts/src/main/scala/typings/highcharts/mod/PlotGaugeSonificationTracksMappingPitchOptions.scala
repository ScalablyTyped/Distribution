...
trait PlotGaugeSonificationTracksMappingPitchOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
