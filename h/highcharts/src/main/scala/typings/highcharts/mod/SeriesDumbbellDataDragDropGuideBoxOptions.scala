...
object SeriesDumbbellDataDragDropGuideBoxOptions {
  ...
  @scala.inline
  def apply(): SeriesDumbbellDataDragDropGuideBoxOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesDumbbellDataDragDropGuideBoxOptions]
  }
  
  @scala.inline
  implicit class SeriesDumbbellDataDragDropGuideBoxOptionsMutableBuilder[Self <: SeriesDumbbellDataDragDropGuideBoxOptions] (val x: Self) extends AnyVal {
