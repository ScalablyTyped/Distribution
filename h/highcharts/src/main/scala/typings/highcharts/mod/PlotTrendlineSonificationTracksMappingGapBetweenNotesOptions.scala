...
trait PlotTrendlineSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
