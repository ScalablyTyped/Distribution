...
trait PlotDumbbellSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
