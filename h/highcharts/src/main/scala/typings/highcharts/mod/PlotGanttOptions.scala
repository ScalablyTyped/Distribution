...
trait PlotGanttOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotGanttAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotGanttOptions {
  ...
  inline def apply(): PlotGanttOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttOptions]
  }
  
  extension [Self <: PlotGanttOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotGanttAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotGanttDataLabelsOptions | js.Array[PlotGanttDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotGanttDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    ...
    inline def setPartialFill(value: PlotGanttPartialFillOptions): Self = StObject.set(x, "partialFill", value.asInstanceOf[js.Any])
