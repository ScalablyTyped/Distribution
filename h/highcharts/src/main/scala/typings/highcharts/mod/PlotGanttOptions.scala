...
object PlotGanttOptions {
  ...
  @scala.inline
  implicit class PlotGanttOptionsMutableBuilder[Self <: PlotGanttOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotGanttAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotGanttDataLabelsOptions | js.Array[PlotGanttDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotGanttDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    ...
    @scala.inline
    def setPartialFill(value: PlotGanttPartialFillOptions): Self = StObject.set(x, "partialFill", value.asInstanceOf[js.Any])
