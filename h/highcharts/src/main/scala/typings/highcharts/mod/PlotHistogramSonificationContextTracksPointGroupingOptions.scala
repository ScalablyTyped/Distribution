...
trait PlotHistogramSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotHistogramSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
