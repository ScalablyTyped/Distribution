...
trait PlotPivotpointsOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotPivotpointsAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotPivotpointsDataLabelsOptions | js.Array[PlotPivotpointsDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotPivotpointsDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotPivotpointsParamsOptions] = js.native
...
object PlotPivotpointsOptions {
  ...
  @scala.inline
  def apply(): PlotPivotpointsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsOptions]
  }
  
  @scala.inline
  implicit class PlotPivotpointsOptionsMutableBuilder[Self <: PlotPivotpointsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPivotpointsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotPivotpointsDataLabelsOptions | js.Array[PlotPivotpointsDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotPivotpointsDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotPivotpointsDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotPivotpointsParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
