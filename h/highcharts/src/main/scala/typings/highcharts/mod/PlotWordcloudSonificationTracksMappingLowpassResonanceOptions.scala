...
trait PlotWordcloudSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotWordcloudSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotWordcloudSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
