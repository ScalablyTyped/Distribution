...
trait PlotSplineOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotSplineAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotSplineDataLabelsOptions | js.Array[PlotSplineDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotSplineDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotSplineOnPointOptions] = js.undefined
...
object PlotSplineOptions {
  ...
  inline def apply(): PlotSplineOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineOptions]
  }
  
  extension [Self <: PlotSplineOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotSplineAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotSplineDataLabelsOptions | js.Array[PlotSplineDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotSplineDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotSplineDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotSplineOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
