...
object PlotSplineOptions {
  ...
  @scala.inline
  def apply(): PlotSplineOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineOptions]
  }
  
  @scala.inline
  implicit class PlotSplineOptionsMutableBuilder[Self <: PlotSplineOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSplineAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotSplineDataLabelsOptions | js.Array[PlotSplineDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotSplineDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotSplineDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
