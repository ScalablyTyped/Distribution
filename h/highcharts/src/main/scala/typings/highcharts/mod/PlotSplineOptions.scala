...
trait PlotSplineOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotSplineSonificationOptions] = js.undefined
...
object PlotSplineOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotSplineSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
