...
trait PlotVectorSonificationTracksMappingRateOptions extends StObject {
...
object PlotVectorSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotVectorSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVectorSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
