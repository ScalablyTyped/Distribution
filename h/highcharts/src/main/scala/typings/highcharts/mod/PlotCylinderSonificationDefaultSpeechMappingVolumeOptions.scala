...
trait PlotCylinderSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotCylinderSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
