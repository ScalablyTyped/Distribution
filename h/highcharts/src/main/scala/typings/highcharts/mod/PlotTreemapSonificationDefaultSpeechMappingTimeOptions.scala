...
trait PlotTreemapSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotTreemapSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
