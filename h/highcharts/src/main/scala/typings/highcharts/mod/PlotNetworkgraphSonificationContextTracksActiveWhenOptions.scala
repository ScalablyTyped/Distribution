...
trait PlotNetworkgraphSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
