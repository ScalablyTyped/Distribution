...
trait PlotSplineSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotSplineSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotSplineSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
