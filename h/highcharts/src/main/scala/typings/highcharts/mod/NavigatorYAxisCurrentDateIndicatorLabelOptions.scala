...
trait NavigatorYAxisCurrentDateIndicatorLabelOptions extends StObject {
...
object NavigatorYAxisCurrentDateIndicatorLabelOptions {
  
  inline def apply(): NavigatorYAxisCurrentDateIndicatorLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisCurrentDateIndicatorLabelOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NavigatorYAxisCurrentDateIndicatorLabelOptions] (val x: Self) extends AnyVal {
