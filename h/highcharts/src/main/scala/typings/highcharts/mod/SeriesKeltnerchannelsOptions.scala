...
object SeriesKeltnerchannelsOptions {
  ...
  @scala.inline
  implicit class SeriesKeltnerchannelsOptionsOps[Self <: SeriesKeltnerchannelsOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | keltnerchannels): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
