...
import typings.highcharts.highchartsStrings.keltnerchannels
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesKeltnerchannelsOptions
  extends StObject
     with PlotKeltnerchannelsOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | keltnerchannels
...
object SeriesKeltnerchannelsOptions {
  
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | keltnerchannels): SeriesKeltnerchannelsOptions = {
    val __obj = js.Dynamic.literal(dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesKeltnerchannelsOptions]
  }
  
  @scala.inline
  implicit class SeriesKeltnerchannelsOptionsMutableBuilder[Self <: SeriesKeltnerchannelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | keltnerchannels): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
