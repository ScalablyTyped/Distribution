...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ @js.native
trait SeriesKeltnerchannelsOptions extends PlotKeltnerchannelsOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | keltnerchannels = js.native
...
object SeriesKeltnerchannelsOptions {
  ...
  @scala.inline
  def apply(`type`: String | keltnerchannels): SeriesKeltnerchannelsOptions = {
