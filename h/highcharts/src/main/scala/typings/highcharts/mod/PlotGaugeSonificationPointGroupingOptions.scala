...
trait PlotGaugeSonificationPointGroupingOptions extends StObject {
...
object PlotGaugeSonificationPointGroupingOptions {
  
  inline def apply(): PlotGaugeSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
