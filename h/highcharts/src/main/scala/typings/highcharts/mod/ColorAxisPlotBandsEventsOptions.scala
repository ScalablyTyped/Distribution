...
trait ColorAxisPlotBandsEventsOptions extends StObject {
...
object ColorAxisPlotBandsEventsOptions {
  
  inline def apply(): ColorAxisPlotBandsEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColorAxisPlotBandsEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorAxisPlotBandsEventsOptions] (val x: Self) extends AnyVal {
