...
trait PlotCmfSonificationTracksMappingPanOptions extends StObject {
...
object PlotCmfSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotCmfSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmfSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
