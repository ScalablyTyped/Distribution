...
trait PlotBubbleSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotBubbleSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
