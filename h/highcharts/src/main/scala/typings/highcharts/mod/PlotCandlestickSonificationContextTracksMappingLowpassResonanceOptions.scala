...
trait PlotCandlestickSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
