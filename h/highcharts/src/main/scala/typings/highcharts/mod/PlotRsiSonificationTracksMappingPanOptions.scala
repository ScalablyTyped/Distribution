...
trait PlotRsiSonificationTracksMappingPanOptions extends StObject {
...
object PlotRsiSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
