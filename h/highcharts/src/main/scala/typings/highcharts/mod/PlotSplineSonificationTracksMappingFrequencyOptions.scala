...
trait PlotSplineSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotSplineSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
