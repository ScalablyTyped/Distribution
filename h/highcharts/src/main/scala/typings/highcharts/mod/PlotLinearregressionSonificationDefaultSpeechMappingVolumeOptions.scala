...
trait PlotLinearregressionSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotLinearregressionSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressionSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
