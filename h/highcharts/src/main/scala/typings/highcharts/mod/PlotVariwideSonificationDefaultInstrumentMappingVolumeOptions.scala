...
trait PlotVariwideSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotVariwideSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotVariwideSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
