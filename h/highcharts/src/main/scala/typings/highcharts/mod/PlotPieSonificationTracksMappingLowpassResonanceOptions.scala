...
trait PlotPieSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotPieSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotPieSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
