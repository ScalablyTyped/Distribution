...
@js.native
trait PlotVectorDataLabelsOptions extends js.Object {
...
object PlotVectorDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotVectorDataLabelsOptionsOps[Self <: PlotVectorDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVectorDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
