...
trait PlotCciSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotCciSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotCciSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
