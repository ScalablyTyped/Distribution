...
trait PlotKlingerSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotKlingerSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
