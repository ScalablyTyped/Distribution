...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesBbOptions
  extends StObject
     with PlotBbOptions {
...
object SeriesBbOptions {
  ...
  inline def apply(`type`: String | bb): SeriesBbOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesBbOptions] (val x: Self) extends AnyVal {
