...
trait PlotCciSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotCciSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotCciSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
