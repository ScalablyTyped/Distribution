...
trait PlotTrendlineStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTrendlineStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTrendlineStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotTrendlineStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTrendlineStatesHoverAnimationOptions = null,
    borderColor: ColorString | GradientColorObject | PatternObject = null,
    borderWidth: Int | Double = null,
    brightness: Int | Double = null,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    halo: PlotTrendlineStatesHoverHaloOptions = null,
    lineWidth: Int | Double = null,
    lineWidthPlus: Int | Double = null
  ): PlotTrendlineStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineStatesHoverOptions]
  }
}
