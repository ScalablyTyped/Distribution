...
@js.native
trait PlotChaikinDataLabelsOptions extends js.Object {
...
object PlotChaikinDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotChaikinDataLabelsOptionsOps[Self <: PlotChaikinDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotChaikinDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
