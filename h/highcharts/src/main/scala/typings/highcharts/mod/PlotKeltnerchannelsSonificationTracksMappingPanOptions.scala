...
trait PlotKeltnerchannelsSonificationTracksMappingPanOptions extends StObject {
...
object PlotKeltnerchannelsSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotKeltnerchannelsSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
