...
trait PlotCandlestickSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
