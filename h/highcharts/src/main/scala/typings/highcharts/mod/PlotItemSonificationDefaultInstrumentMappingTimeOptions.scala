...
trait PlotItemSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotItemSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotItemSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
