...
trait PlotSlowstochasticSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
