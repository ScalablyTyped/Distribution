...
trait ZAxisPlotLinesOptions
  ...
  var labels: js.UndefOr[ZAxisPlotLinesLabelsOptions] = js.undefined
...
object ZAxisPlotLinesOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ZAxisPlotLinesOptions] (val x: Self) extends AnyVal {
    ...
    inline def setLabels(value: ZAxisPlotLinesLabelsOptions): Self = StObject.set(x, "labels", value.asInstanceOf[js.Any])
