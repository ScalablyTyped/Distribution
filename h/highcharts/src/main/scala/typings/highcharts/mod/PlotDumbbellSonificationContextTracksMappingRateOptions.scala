...
trait PlotDumbbellSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotDumbbellSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotDumbbellSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
