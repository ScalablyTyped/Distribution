...
trait PlotCandlestickSonificationTracksPointGroupingOptions extends StObject {
...
object PlotCandlestickSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
