...
trait PlotHeatmapSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotHeatmapSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
