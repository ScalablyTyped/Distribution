...
trait PlotFunnel3dSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
