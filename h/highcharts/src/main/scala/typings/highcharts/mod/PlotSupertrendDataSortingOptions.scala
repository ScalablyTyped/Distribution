...
@js.native
trait PlotSupertrendDataSortingOptions extends js.Object {
...
object PlotSupertrendDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotSupertrendDataSortingOptionsOps[Self <: PlotSupertrendDataSortingOptions] (val x: Self) extends AnyVal {
