...
trait PlotSupertrendDataSortingOptions extends StObject {
...
object PlotSupertrendDataSortingOptions {
  
  @scala.inline
  def apply(): PlotSupertrendDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotSupertrendDataSortingOptionsMutableBuilder[Self <: PlotSupertrendDataSortingOptions] (val x: Self) extends AnyVal {
