...
trait PlotPriceenvelopesSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
