...
trait PlotAreasplineMarkerStatesHoverOptions extends js.Object {
  /**
...
object PlotAreasplineMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplineMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineMarkerStatesHoverOptions]
  }
}
