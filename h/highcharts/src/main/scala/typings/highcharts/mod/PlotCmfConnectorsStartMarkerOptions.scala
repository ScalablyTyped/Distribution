...
trait PlotCmfConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotCmfConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCmfConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCmfConnectorsStartMarkerOptions]
  }
}
