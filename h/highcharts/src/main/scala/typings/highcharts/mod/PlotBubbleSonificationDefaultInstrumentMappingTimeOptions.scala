...
trait PlotBubbleSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotBubbleSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
