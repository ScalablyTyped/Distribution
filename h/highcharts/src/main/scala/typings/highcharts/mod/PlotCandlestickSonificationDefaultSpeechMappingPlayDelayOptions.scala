...
trait PlotCandlestickSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotCandlestickSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
