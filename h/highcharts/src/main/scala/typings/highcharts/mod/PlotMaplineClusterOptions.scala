...
trait PlotMaplineClusterOptions extends StObject {
  ...
  var events: js.UndefOr[PlotMaplineClusterEventsOptions] = js.undefined
  ...
  /**
    ...
    * iterations.
    */
  var layoutAlgorithm: js.UndefOr[PlotMaplineClusterLayoutAlgorithmOptions] = js.undefined
  ...
  var states: js.UndefOr[PlotMaplineClusterStatesOptions] = js.undefined
  ...
  /**
    ...
    * `className` option.
    */
  var zones: js.UndefOr[js.Array[PlotMaplineClusterZonesOptions]] = js.undefined
}
object PlotMaplineClusterOptions {
  
  inline def apply(): PlotMaplineClusterOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineClusterOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineClusterOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: PlotMaplineClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    inline def setLayoutAlgorithm(value: PlotMaplineClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setStates(value: PlotMaplineClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    inline def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    inline def setZones(value: js.Array[PlotMaplineClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
    
    inline def setZonesUndefined: Self = StObject.set(x, "zones", js.undefined)
    
    inline def setZonesVarargs(value: PlotMaplineClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value*))
  }
}
