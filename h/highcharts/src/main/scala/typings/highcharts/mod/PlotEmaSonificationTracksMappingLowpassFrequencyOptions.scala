...
trait PlotEmaSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotEmaSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotEmaSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
