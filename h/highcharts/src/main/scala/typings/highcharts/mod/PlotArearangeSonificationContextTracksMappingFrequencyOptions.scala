...
trait PlotArearangeSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotArearangeSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotArearangeSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
