...
trait PlotLineSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotLineSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotLineSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
