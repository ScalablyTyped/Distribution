...
trait PlotHeatmapSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotHeatmapSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
