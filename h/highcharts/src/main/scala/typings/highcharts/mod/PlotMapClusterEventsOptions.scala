...
trait PlotMapClusterEventsOptions extends StObject {
...
object PlotMapClusterEventsOptions {
  
  inline def apply(): PlotMapClusterEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapClusterEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapClusterEventsOptions] (val x: Self) extends AnyVal {
