...
trait PlotColumnpyramidSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotColumnpyramidSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotColumnpyramidSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
