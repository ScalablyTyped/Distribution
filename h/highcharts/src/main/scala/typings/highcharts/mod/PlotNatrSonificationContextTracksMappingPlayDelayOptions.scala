...
trait PlotNatrSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
