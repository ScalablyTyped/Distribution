...
trait PlotMacdMacdLineZonesOptions extends js.Object {
  /**
...
object PlotMacdMacdLineZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotMacdMacdLineZonesOptions]
  }
}
