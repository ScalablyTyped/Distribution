...
trait SeriesVectorDataMarkerStatesHoverOptions extends js.Object {
  /**
...
object SeriesVectorDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesVectorDataMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[SeriesVectorDataMarkerStatesHoverOptions]
  }
}
