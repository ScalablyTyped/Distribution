...
trait PlotLinearregressioninterceptSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
