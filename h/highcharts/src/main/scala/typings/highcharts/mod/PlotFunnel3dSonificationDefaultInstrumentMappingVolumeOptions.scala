...
trait PlotFunnel3dSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
