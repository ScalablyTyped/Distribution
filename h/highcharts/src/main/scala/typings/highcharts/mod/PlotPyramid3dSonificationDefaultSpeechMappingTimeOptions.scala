...
trait PlotPyramid3dSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
