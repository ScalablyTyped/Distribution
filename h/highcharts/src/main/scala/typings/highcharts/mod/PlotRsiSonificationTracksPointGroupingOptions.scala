...
trait PlotRsiSonificationTracksPointGroupingOptions extends StObject {
...
object PlotRsiSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotRsiSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
