...
trait PlotSeriesSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
