...
trait PlotPackedbubbleClusterLayoutAlgorithmOptions extends StObject {
...
object PlotPackedbubbleClusterLayoutAlgorithmOptions {
  
  inline def apply(): PlotPackedbubbleClusterLayoutAlgorithmOptions = {
