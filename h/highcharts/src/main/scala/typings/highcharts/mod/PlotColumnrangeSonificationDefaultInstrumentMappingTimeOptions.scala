...
trait PlotColumnrangeSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
