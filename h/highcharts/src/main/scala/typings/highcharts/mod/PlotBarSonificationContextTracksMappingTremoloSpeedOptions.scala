...
trait PlotBarSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotBarSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotBarSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
