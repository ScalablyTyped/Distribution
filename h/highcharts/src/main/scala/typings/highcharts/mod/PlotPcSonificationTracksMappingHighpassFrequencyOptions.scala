...
trait PlotPcSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotPcSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
