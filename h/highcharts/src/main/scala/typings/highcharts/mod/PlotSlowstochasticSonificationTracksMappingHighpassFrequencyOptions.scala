...
trait PlotSlowstochasticSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotSlowstochasticSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotSlowstochasticSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
