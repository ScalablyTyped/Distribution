...
trait PlotNatrSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
