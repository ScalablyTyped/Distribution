...
trait PlotFlowmapSonificationTracksMappingPitchOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
