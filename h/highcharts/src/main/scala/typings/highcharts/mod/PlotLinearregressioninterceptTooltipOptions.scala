...
trait PlotLinearregressioninterceptTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[
    PlotLinearregressioninterceptTooltipDateTimeLabelFormatsOptions | Dictionary[String]
  ] = js.undefined
  /**
...
object PlotLinearregressioninterceptTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    dateTimeLabelFormats: PlotLinearregressioninterceptTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
  ...
  ): PlotLinearregressioninterceptTooltipOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptTooltipOptions]
  }
}
