...
trait PlotMappointSonificationTracksPointGroupingOptions extends StObject {
...
object PlotMappointSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotMappointSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
