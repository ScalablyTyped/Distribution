...
trait PlotMapbubbleSonificationPointGroupingOptions extends StObject {
...
object PlotMapbubbleSonificationPointGroupingOptions {
  
  inline def apply(): PlotMapbubbleSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
