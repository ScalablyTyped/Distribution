...
trait PlotLinearregressionangleSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
