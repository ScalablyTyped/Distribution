...
trait PlotDmiSonificationTracksMappingPitchOptions extends StObject {
...
object PlotDmiSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
