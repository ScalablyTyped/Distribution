...
trait PlotBubbleSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotBubbleSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
