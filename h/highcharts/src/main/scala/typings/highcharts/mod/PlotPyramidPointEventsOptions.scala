...
trait PlotPyramidPointEventsOptions extends js.Object {
  /**
...
object PlotPyramidPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPyramidPointEventsOptions]
  }
}
