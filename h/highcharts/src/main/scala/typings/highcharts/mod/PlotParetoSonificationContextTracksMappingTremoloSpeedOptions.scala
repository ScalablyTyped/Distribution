...
trait PlotParetoSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
