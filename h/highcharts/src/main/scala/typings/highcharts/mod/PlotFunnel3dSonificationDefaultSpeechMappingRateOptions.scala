...
trait PlotFunnel3dSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
