...
trait PlotSplineSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotSplineSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotSplineSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
