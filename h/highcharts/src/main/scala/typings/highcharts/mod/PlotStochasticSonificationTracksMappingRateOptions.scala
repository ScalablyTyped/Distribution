...
trait PlotStochasticSonificationTracksMappingRateOptions extends StObject {
...
object PlotStochasticSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotStochasticSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
