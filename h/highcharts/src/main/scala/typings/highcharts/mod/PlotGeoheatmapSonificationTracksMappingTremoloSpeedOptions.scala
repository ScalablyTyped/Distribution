...
trait PlotGeoheatmapSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
