...
trait PlotFunnel3dSonificationTracksPointGroupingOptions extends StObject {
...
object PlotFunnel3dSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
