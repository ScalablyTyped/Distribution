...
trait PlotCmoSonificationTracksMappingTimeOptions extends StObject {
...
object PlotCmoSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
