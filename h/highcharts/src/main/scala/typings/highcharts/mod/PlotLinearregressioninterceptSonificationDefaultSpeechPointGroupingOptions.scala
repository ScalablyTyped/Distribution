...
trait PlotLinearregressioninterceptSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
