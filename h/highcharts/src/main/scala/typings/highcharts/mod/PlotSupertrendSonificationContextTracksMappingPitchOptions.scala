...
trait PlotSupertrendSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
