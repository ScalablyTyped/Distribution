...
trait PlotCciSonificationTracksMappingPanOptions extends StObject {
...
object PlotCciSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
