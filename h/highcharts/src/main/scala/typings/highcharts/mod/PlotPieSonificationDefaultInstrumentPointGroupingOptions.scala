...
trait PlotPieSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotPieSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotPieSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
