...
trait PlotGanttSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotGanttSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotGanttSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
