...
trait PlotColumnpyramidSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
