...
trait PlotPivotpointsSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
