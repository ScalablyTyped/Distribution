...
trait PlotPriceenvelopesSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
