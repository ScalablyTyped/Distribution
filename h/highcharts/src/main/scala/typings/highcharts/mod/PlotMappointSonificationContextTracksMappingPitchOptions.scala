...
trait PlotMappointSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotMappointSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
