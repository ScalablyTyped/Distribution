...
@js.native
trait PlotAroonoscillatorDataLabelsOptions extends js.Object {
...
object PlotAroonoscillatorDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotAroonoscillatorDataLabelsOptionsOps[Self <: PlotAroonoscillatorDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAroonoscillatorDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
