...
trait PlotHeatmapSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
