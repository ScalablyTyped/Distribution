...
trait PlotStochasticSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotStochasticSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotStochasticSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
