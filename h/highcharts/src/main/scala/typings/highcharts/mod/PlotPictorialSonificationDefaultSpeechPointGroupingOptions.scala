...
trait PlotPictorialSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotPictorialSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
