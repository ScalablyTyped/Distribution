...
trait PlotPpoSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotPpoSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
