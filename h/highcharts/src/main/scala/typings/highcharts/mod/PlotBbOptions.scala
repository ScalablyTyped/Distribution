...
trait PlotBbOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotBbAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotBbDataLabelsOptions | js.Array[PlotBbDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotBbDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotBbOnPointOptions] = js.undefined
...
object PlotBbOptions {
  ...
  inline def apply(): PlotBbOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbOptions]
  }
  
  extension [Self <: PlotBbOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotBbAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setBottomLine(value: PlotBbBottomLineOptions): Self = StObject.set(x, "bottomLine", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotBbDataLabelsOptions | js.Array[PlotBbDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotBbDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotBbDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotBbOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotBbParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    inline def setTopLine(value: PlotBbTopLineOptions): Self = StObject.set(x, "topLine", value.asInstanceOf[js.Any])
