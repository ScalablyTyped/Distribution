...
trait PlotBbOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotBbSonificationOptions] = js.undefined
...
object PlotBbOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBbOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotBbSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
