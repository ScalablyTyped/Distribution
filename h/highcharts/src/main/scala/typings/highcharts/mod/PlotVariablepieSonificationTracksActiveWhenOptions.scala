...
trait PlotVariablepieSonificationTracksActiveWhenOptions extends StObject {
...
object PlotVariablepieSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotVariablepieSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
