...
trait PlotIkhSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotIkhSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotIkhSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
