...
trait PlotWmaOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotWmaAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotWmaDataLabelsOptions | js.Array[PlotWmaDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotWmaDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotWmaParamsOptions] = js.native
...
object PlotWmaOptions {
  ...
  @scala.inline
  def apply(): PlotWmaOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaOptions]
  }
  
  @scala.inline
  implicit class PlotWmaOptionsMutableBuilder[Self <: PlotWmaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotWmaAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotWmaDataLabelsOptions | js.Array[PlotWmaDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotWmaDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotWmaDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotWmaParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
