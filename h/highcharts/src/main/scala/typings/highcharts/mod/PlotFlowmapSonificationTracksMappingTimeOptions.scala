...
trait PlotFlowmapSonificationTracksMappingTimeOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
