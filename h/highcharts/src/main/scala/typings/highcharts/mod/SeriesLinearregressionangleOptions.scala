...
import typings.highcharts.highchartsStrings.linearregressionangle
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesLinearregressionangleOptions
  extends StObject
...
object SeriesLinearregressionangleOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | linearregressionangle): SeriesLinearregressionangleOptions = {
  ...
  @scala.inline
  implicit class SeriesLinearregressionangleOptionsMutableBuilder[Self <: SeriesLinearregressionangleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | linearregressionangle): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
