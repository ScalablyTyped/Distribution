...
object SeriesLinearregressionangleOptions {
  ...
  inline def apply(`type`: String | linearregressionangle): SeriesLinearregressionangleOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesLinearregressionangleOptions] (val x: Self) extends AnyVal {
