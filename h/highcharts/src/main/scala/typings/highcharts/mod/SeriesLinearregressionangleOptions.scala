...
trait SeriesLinearregressionangleOptions extends PlotLinearregressionangleOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | linearregressionangle = js.native
...
object SeriesLinearregressionangleOptions {
  ...
  @scala.inline
  def apply(`type`: String | linearregressionangle): SeriesLinearregressionangleOptions = {
