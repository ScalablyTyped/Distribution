...
object SeriesLinearregressionangleOptions {
  ...
  @scala.inline
  implicit class SeriesLinearregressionangleOptionsOps[Self <: SeriesLinearregressionangleOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | linearregressionangle): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
