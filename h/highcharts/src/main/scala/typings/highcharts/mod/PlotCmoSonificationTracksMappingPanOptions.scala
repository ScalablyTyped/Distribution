...
trait PlotCmoSonificationTracksMappingPanOptions extends StObject {
...
object PlotCmoSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
