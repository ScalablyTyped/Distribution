...
trait PlotSplineSonificationTracksMappingPanOptions extends StObject {
...
object PlotSplineSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
