...
trait PlotDisparityindexSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
