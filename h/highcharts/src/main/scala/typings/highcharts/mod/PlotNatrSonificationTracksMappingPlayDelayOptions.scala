...
trait PlotNatrSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotNatrSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
