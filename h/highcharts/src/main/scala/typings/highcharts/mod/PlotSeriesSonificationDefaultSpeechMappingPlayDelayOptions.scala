...
trait PlotSeriesSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotSeriesSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
