...
object PlotLinearregressionOptions {
  ...
  def apply(
    ...
    dataLabels: PlotLinearregressionDataLabelsOptions | js.Array[PlotLinearregressionDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotLinearregressionDataSortingOptions = null,
