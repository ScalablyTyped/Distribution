...
trait PlotLinearregressionOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotLinearregressionSonificationOptions] = js.undefined
...
object PlotLinearregressionOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotLinearregressionSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
