...
trait PlotOhlcAccessibilityPointOptions extends StObject {
...
object PlotOhlcAccessibilityPointOptions {
  
  inline def apply(): PlotOhlcAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOhlcAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOhlcAccessibilityPointOptions] (val x: Self) extends AnyVal {
