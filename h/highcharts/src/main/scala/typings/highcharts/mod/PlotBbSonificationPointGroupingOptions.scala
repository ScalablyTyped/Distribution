...
trait PlotBbSonificationPointGroupingOptions extends StObject {
...
object PlotBbSonificationPointGroupingOptions {
  
  inline def apply(): PlotBbSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBbSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
