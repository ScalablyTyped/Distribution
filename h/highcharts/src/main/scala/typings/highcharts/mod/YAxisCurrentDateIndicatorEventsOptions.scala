...
trait YAxisCurrentDateIndicatorEventsOptions extends StObject {
...
object YAxisCurrentDateIndicatorEventsOptions {
  
  inline def apply(): YAxisCurrentDateIndicatorEventsOptions = {
