...
trait PlotTrendlineSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotTrendlineSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
