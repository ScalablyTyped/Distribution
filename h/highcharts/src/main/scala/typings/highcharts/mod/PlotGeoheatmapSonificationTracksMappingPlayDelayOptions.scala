...
trait PlotGeoheatmapSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotGeoheatmapSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotGeoheatmapSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
