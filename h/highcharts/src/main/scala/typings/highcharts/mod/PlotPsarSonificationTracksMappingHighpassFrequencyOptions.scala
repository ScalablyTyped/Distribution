...
trait PlotPsarSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotPsarSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotPsarSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
