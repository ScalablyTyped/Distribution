...
trait PlotAtrConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotAtrConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAtrConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAtrConnectorsMarkerOptions]
  }
}
