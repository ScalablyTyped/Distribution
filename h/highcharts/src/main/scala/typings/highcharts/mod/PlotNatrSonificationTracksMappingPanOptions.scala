...
trait PlotNatrSonificationTracksMappingPanOptions extends StObject {
...
object PlotNatrSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
