...
trait PlotPictorialSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotPictorialSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotPictorialSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
