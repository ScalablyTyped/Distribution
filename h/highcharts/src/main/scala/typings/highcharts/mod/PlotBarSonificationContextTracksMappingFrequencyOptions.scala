...
trait PlotBarSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotBarSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotBarSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
