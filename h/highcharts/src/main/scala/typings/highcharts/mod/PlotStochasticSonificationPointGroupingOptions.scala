...
trait PlotStochasticSonificationPointGroupingOptions extends StObject {
...
object PlotStochasticSonificationPointGroupingOptions {
  
  inline def apply(): PlotStochasticSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
