...
trait PlotApoSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotApoSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
