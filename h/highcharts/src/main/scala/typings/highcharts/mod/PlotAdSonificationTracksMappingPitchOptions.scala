...
trait PlotAdSonificationTracksMappingPitchOptions extends StObject {
...
object PlotAdSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotAdSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
