...
trait PlotAtrSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
