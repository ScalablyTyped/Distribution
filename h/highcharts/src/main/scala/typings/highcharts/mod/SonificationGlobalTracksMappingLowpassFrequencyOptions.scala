...
trait SonificationGlobalTracksMappingLowpassFrequencyOptions extends StObject {
...
object SonificationGlobalTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): SonificationGlobalTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
