...
trait PlotTemaSonificationTracksMappingRateOptions extends StObject {
...
object PlotTemaSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotTemaSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
