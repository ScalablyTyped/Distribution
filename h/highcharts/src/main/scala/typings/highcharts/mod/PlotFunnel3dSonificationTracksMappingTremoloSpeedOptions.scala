...
trait PlotFunnel3dSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotFunnel3dSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotFunnel3dSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
