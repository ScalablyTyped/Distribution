...
trait PlotDmiSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotDmiSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
