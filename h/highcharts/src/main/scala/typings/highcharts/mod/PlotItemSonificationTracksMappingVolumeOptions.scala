...
trait PlotItemSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotItemSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotItemSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
