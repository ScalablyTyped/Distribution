...
trait SonificationGlobalTracksMappingHighpassFrequencyOptions extends StObject {
...
object SonificationGlobalTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): SonificationGlobalTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
