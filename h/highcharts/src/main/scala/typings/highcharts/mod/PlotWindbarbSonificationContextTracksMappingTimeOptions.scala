...
trait PlotWindbarbSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotWindbarbSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotWindbarbSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
