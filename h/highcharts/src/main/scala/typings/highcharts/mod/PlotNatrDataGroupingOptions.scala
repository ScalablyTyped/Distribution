...
trait PlotNatrDataGroupingOptions extends js.Object {
  /**
...
object PlotNatrDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotNatrDataGroupingOptions]
  }
}
