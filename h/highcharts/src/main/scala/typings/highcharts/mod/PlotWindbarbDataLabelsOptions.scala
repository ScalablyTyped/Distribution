...
@js.native
trait PlotWindbarbDataLabelsOptions extends js.Object {
...
object PlotWindbarbDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotWindbarbDataLabelsOptionsOps[Self <: PlotWindbarbDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotWindbarbDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
