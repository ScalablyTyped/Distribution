...
trait PlotItemSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotItemSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotItemSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
