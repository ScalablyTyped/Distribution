...
trait PlotPivotpointsSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
