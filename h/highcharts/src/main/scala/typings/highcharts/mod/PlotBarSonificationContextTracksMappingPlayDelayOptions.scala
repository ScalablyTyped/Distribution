...
trait PlotBarSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotBarSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotBarSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
