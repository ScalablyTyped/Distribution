...
trait PlotAoSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotAoSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
