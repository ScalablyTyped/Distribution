...
trait PlotCciSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotCciSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
