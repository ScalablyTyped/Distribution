...
trait PlotCciSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotCciSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotCciSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
