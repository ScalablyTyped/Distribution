...
trait PlotCmoSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
