...
trait PlotDependencywheelSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
