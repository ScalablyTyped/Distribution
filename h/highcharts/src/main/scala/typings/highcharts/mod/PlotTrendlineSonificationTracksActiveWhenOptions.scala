...
trait PlotTrendlineSonificationTracksActiveWhenOptions extends StObject {
...
object PlotTrendlineSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
