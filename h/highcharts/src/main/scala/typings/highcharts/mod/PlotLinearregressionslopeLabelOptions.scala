...
trait PlotLinearregressionslopeLabelOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeLabelOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeLabelOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeLabelOptions]
  }
}
