...
trait PlotEmaSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotEmaSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotEmaSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
