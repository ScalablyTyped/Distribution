...
trait PlotCmoSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotCmoSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
