...
trait PlotWmaSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotWmaSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
