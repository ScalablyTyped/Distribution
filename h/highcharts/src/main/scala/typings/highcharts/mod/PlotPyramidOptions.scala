...
trait PlotPyramidOptions extends StObject {
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotPyramidDataSortingOptions] = js.undefined
...
object PlotPyramidOptions {
  ...
  inline def apply(): PlotPyramidOptions = {
  ...
  extension [Self <: PlotPyramidOptions](x: Self) {
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotPyramidDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
