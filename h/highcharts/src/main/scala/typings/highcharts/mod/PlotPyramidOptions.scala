...
trait PlotPyramidOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotPyramidSonificationOptions] = js.undefined
...
object PlotPyramidOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotPyramidOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotPyramidSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
