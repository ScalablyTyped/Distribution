...
trait PlotArearangeSonificationDefaultInstrumentOptions extends StObject {
  ...
  var activeWhen: js.UndefOr[
    js.Object | js.Function | PlotArearangeSonificationDefaultInstrumentActiveWhenOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[PlotArearangeSonificationDefaultInstrumentMappingOptions] = js.undefined
  ...
  /**
    ...
    * instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotArearangeSonificationDefaultInstrumentPointGroupingOptions] = js.undefined
...
object PlotArearangeSonificationDefaultInstrumentOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultInstrumentOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultInstrumentOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultInstrumentOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotArearangeSonificationDefaultInstrumentActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotArearangeSonificationDefaultInstrumentMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotArearangeSonificationDefaultInstrumentPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
