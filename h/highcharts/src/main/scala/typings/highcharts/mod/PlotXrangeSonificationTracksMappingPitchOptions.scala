...
trait PlotXrangeSonificationTracksMappingPitchOptions extends StObject {
...
object PlotXrangeSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotXrangeSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
