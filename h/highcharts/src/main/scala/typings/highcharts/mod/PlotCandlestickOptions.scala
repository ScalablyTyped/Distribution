...
trait PlotCandlestickOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotCandlestickSonificationOptions] = js.undefined
...
object PlotCandlestickOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotCandlestickSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
