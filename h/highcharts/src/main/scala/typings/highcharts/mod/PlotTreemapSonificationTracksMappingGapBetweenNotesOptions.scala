...
trait PlotTreemapSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
