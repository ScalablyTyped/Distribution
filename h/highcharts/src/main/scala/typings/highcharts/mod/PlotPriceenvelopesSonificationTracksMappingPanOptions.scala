...
trait PlotPriceenvelopesSonificationTracksMappingPanOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
