...
trait PlotMapSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotMapSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
