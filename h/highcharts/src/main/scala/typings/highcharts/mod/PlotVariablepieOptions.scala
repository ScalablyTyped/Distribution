...
trait PlotVariablepieOptions extends StObject {
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotVariablepieDataSortingOptions] = js.undefined
...
object PlotVariablepieOptions {
  ...
  inline def apply(): PlotVariablepieOptions = {
  ...
  extension [Self <: PlotVariablepieOptions](x: Self) {
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotVariablepieDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setMaxPointSize(value: Double | String): Self = StObject.set(x, "maxPointSize", value.asInstanceOf[js.Any])
    
    inline def setMaxPointSizeUndefined: Self = StObject.set(x, "maxPointSize", js.undefined)
    
    inline def setMinPointSize(value: Double | String): Self = StObject.set(x, "minPointSize", value.asInstanceOf[js.Any])
    ...
    inline def setSizeBy(value: VariablePieSizeByValue): Self = StObject.set(x, "sizeBy", value.asInstanceOf[js.Any])
