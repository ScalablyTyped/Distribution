...
object PlotVariablepieOptions {
  ...
  extension [Self <: PlotVariablepieOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotVariablepieAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
