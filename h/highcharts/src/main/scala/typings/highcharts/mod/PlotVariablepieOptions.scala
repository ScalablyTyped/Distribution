...
trait PlotVariablepieOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotVariablepieSonificationOptions] = js.undefined
...
object PlotVariablepieOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotVariablepieOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotVariablepieSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
