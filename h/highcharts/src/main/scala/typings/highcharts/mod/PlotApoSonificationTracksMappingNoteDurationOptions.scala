...
trait PlotApoSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotApoSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotApoSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
