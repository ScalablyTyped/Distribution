...
trait PlotSupertrendSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
