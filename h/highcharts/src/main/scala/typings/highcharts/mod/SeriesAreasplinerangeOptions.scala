...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesAreasplinerangeOptions extends PlotAreasplinerangeOptions {
  /**
...
object SeriesAreasplinerangeOptions {
  ...
  def apply(
    ...
    dataSorting: DataSortingOptionsObject | PlotAreasplinerangeDataSortingOptions = null,
