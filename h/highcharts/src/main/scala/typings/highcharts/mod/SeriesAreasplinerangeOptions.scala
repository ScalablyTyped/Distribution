...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesAreasplinerangeOptions
  extends StObject
     with PlotAreasplinerangeOptions {
...
object SeriesAreasplinerangeOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | areasplinerange): SeriesAreasplinerangeOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesAreasplinerangeOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | areasplinerange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
