...
trait PlotTrixSonificationTracksMappingPitchOptions extends StObject {
...
object PlotTrixSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
