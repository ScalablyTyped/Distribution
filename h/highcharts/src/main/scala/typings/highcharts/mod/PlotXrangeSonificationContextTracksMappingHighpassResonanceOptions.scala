...
trait PlotXrangeSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotXrangeSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotXrangeSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
