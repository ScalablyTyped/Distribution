...
trait PlotGaugeSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotGaugeSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotGaugeSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
