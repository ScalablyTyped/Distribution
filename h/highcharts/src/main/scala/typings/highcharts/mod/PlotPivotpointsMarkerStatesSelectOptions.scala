...
trait PlotPivotpointsMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPivotpointsMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPivotpointsMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsMarkerStatesSelectOptions]
  }
}
