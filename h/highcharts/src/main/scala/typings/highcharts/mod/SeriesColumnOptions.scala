...
object SeriesColumnOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | column): SeriesColumnOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesColumnOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | column): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
