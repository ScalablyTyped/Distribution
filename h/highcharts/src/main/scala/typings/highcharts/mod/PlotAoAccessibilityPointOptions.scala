...
trait PlotAoAccessibilityPointOptions extends StObject {
...
object PlotAoAccessibilityPointOptions {
  
  inline def apply(): PlotAoAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoAccessibilityPointOptions] (val x: Self) extends AnyVal {
