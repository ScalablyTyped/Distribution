...
trait PlotCciSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotCciSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotCciSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
