...
trait PlotPolygonClusterZonesOptions extends StObject {
...
object PlotPolygonClusterZonesOptions {
  
  inline def apply(): PlotPolygonClusterZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonClusterZonesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonClusterZonesOptions] (val x: Self) extends AnyVal {
