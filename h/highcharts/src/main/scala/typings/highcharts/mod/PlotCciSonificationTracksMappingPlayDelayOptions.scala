...
trait PlotCciSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotCciSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotCciSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
