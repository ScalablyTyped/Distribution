...
trait PlotSeriesSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
