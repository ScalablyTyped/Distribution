...
trait PlotPriceenvelopesSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
