...
trait PlotTrixTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotTrixTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotTrixTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotTrixTooltipDateTimeLabelFormatsOptions]
  }
}
