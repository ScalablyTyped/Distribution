...
@js.native
trait YAxisStackLabelsAnimationOptions extends js.Object {
...
object YAxisStackLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class YAxisStackLabelsAnimationOptionsOps[Self <: YAxisStackLabelsAnimationOptions] (val x: Self) extends AnyVal {
