...
trait PlotParetoSonificationPointGroupingOptions extends StObject {
...
object PlotParetoSonificationPointGroupingOptions {
  
  inline def apply(): PlotParetoSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
