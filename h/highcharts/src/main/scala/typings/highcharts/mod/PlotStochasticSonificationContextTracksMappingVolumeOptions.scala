...
trait PlotStochasticSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotStochasticSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
