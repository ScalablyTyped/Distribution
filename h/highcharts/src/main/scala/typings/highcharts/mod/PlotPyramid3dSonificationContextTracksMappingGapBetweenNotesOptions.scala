...
trait PlotPyramid3dSonificationContextTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
