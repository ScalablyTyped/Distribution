...
trait PlotAtrSonificationTracksPointGroupingOptions extends StObject {
...
object PlotAtrSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotAtrSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
