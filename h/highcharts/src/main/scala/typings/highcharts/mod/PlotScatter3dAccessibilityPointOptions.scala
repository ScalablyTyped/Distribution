...
trait PlotScatter3dAccessibilityPointOptions extends StObject {
...
object PlotScatter3dAccessibilityPointOptions {
  
  inline def apply(): PlotScatter3dAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatter3dAccessibilityPointOptions] (val x: Self) extends AnyVal {
