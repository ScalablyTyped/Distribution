...
trait PlotDependencywheelConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotDependencywheelConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotDependencywheelConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotDependencywheelConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotDependencywheelConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotDependencywheelConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotDependencywheelConnectorsMarkerOptions = null,
    startMarker: PlotDependencywheelConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotDependencywheelConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelConnectorsOptions]
  }
}
