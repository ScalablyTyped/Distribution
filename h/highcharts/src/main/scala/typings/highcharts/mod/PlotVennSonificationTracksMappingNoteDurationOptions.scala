...
trait PlotVennSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotVennSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotVennSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
