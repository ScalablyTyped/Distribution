...
trait PlotDisparityindexSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
