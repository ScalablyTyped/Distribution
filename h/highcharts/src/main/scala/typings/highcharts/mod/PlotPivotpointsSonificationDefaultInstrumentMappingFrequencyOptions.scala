...
trait PlotPivotpointsSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
