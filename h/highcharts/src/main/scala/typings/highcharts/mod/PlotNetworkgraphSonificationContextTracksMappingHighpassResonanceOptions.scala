...
trait PlotNetworkgraphSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
