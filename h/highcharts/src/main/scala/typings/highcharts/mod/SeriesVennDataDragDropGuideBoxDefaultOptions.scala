...
trait SeriesVennDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesVennDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesVennDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesVennDataDragDropGuideBoxDefaultOptions]
  }
}
