...
trait PlotMappointSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotMappointSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotMappointSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
