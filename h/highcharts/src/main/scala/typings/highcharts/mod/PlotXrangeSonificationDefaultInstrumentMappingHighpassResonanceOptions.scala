...
trait PlotXrangeSonificationDefaultInstrumentMappingHighpassResonanceOptions extends StObject {
...
object PlotXrangeSonificationDefaultInstrumentMappingHighpassResonanceOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultInstrumentMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultInstrumentMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultInstrumentMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
