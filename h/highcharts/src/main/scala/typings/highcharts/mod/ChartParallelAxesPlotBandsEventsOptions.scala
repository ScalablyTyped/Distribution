...
trait ChartParallelAxesPlotBandsEventsOptions extends StObject {
...
object ChartParallelAxesPlotBandsEventsOptions {
  
  inline def apply(): ChartParallelAxesPlotBandsEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartParallelAxesPlotBandsEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartParallelAxesPlotBandsEventsOptions] (val x: Self) extends AnyVal {
