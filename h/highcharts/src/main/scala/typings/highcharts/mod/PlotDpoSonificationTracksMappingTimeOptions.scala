...
trait PlotDpoSonificationTracksMappingTimeOptions extends StObject {
...
object PlotDpoSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotDpoSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDpoSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
