...
trait PlotSplineSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotSplineSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotSplineSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
