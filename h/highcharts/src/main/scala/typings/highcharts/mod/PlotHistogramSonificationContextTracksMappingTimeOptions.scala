...
trait PlotHistogramSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotHistogramSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotHistogramSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
