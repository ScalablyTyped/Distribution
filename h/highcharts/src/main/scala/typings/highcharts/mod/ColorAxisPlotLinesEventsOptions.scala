...
trait ColorAxisPlotLinesEventsOptions extends StObject {
...
object ColorAxisPlotLinesEventsOptions {
  
  inline def apply(): ColorAxisPlotLinesEventsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColorAxisPlotLinesEventsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorAxisPlotLinesEventsOptions] (val x: Self) extends AnyVal {
