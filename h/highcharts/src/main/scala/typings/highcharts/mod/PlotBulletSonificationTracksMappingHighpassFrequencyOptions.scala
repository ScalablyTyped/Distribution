...
trait PlotBulletSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotBulletSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotBulletSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
