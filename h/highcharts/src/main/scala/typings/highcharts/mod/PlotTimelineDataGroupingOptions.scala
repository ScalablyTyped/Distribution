...
trait PlotTimelineDataGroupingOptions extends js.Object {
  /**
...
object PlotTimelineDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTimelineDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineDataGroupingOptions]
  }
}
