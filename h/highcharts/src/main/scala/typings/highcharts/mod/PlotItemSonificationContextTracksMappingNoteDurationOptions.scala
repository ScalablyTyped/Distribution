...
trait PlotItemSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotItemSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotItemSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
