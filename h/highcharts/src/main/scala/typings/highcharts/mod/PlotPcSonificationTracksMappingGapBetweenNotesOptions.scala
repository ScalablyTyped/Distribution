...
trait PlotPcSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotPcSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
