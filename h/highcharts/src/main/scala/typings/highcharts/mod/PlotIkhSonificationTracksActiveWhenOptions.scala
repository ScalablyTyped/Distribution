...
trait PlotIkhSonificationTracksActiveWhenOptions extends StObject {
...
object PlotIkhSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotIkhSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
