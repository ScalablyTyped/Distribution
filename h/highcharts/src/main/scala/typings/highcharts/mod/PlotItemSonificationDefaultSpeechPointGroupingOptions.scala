...
trait PlotItemSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotItemSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotItemSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
