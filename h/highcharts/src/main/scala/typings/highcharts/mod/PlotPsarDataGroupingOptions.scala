...
trait PlotPsarDataGroupingOptions extends js.Object {
  /**
...
object PlotPsarDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPsarDataGroupingOptions]
  }
}
