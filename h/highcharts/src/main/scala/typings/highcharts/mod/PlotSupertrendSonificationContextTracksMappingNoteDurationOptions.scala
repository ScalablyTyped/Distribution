...
trait PlotSupertrendSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
