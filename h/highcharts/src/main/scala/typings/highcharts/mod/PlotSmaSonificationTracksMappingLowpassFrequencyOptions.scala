...
trait PlotSmaSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotSmaSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
