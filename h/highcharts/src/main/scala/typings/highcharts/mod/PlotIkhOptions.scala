...
trait PlotIkhOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotIkhSonificationOptions] = js.undefined
...
object PlotIkhOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotIkhSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
