...
@js.native
trait PlotNatrDataLabelsOptions extends js.Object {
...
object PlotNatrDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotNatrDataLabelsOptionsOps[Self <: PlotNatrDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotNatrDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
