...
trait PlotColumnpyramidSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotColumnpyramidSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotColumnpyramidSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
