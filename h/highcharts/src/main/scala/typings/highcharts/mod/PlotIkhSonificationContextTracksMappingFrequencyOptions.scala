...
trait PlotIkhSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotIkhSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
