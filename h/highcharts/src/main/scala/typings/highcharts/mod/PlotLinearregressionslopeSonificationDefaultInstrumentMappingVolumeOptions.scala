...
trait PlotLinearregressionslopeSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
