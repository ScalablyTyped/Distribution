...
trait SeriesColumnrangeOptions extends PlotColumnrangeOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | columnrange = js.native
...
object SeriesColumnrangeOptions {
  ...
  @scala.inline
  def apply(`type`: String | columnrange): SeriesColumnrangeOptions = {
