...
import typings.highcharts.highchartsStrings.columnrange
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesColumnrangeOptions
  extends StObject
...
object SeriesColumnrangeOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | columnrange): SeriesColumnrangeOptions = {
  ...
  @scala.inline
  implicit class SeriesColumnrangeOptionsMutableBuilder[Self <: SeriesColumnrangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | columnrange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
