...
object SeriesColumnrangeOptions {
  ...
  inline def apply(`type`: String | columnrange): SeriesColumnrangeOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesColumnrangeOptions] (val x: Self) extends AnyVal {
