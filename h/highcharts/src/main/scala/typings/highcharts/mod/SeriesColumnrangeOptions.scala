...
object SeriesColumnrangeOptions {
  ...
  @scala.inline
  implicit class SeriesColumnrangeOptionsOps[Self <: SeriesColumnrangeOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | columnrange): Self = this.set("type", value.asInstanceOf[js.Any])
