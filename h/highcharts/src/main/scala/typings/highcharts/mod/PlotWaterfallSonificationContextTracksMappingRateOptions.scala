...
trait PlotWaterfallSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotWaterfallSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotWaterfallSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
