...
trait PlotHollowcandlestickSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotHollowcandlestickSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
