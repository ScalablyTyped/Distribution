...
trait PlotColumnOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotColumnAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotColumnDataLabelsOptions | js.Array[PlotColumnDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotColumnDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotColumnOnPointOptions] = js.undefined
...
object PlotColumnOptions {
  ...
  inline def apply(): PlotColumnOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnOptions]
  }
  
  extension [Self <: PlotColumnOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotColumnAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotColumnDataLabelsOptions | js.Array[PlotColumnDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotColumnDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotColumnDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotColumnOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
