...
trait PlotColumnOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotColumnSonificationOptions] = js.undefined
...
object PlotColumnOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotColumnSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
