...
object PlotColumnOptions {
  ...
  def apply(
    ...
    dataLabels: PlotColumnDataLabelsOptions | js.Array[PlotColumnDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotColumnDataSortingOptions = null,
