...
trait PlotPieSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotPieSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotPieSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
