...
trait PlotNetworkgraphSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
