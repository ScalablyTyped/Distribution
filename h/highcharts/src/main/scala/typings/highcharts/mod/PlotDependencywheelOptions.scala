...
trait PlotDependencywheelOptions extends StObject {
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotDependencywheelOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotDependencywheelSonificationOptions] = js.undefined
...
object PlotDependencywheelOptions {
  ...
  inline def apply(): PlotDependencywheelOptions = {
  ...
  implicit open class MutableBuilder[Self <: PlotDependencywheelOptions] (val x: Self) extends AnyVal {
    ...
    inline def setCenter(value: js.Array[Double | String | Null]): Self = StObject.set(x, "center", value.asInstanceOf[js.Any])
    ...
    inline def setCenterVarargs(value: (Double | String | Null)*): Self = StObject.set(x, "center", js.Array(value*))
    ...
    inline def setLevels(value: js.Array[PlotDependencywheelLevelsOptions]): Self = StObject.set(x, "levels", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotDependencywheelOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setSonification(value: PlotDependencywheelSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
