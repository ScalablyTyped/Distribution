...
trait PlotDependencywheelOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotDependencywheelAnimationOptions | PartialAnimationOptionsOb] = js.native
...
object PlotDependencywheelOptions {
  ...
  @scala.inline
  implicit class PlotDependencywheelOptionsMutableBuilder[Self <: PlotDependencywheelOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotDependencywheelAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCenter(value: js.Array[Double | String | Null]): Self = StObject.set(x, "center", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCenterVarargs(value: (Double | String | Null)*): Self = StObject.set(x, "center", js.Array(value :_*))
    ...
    @scala.inline
    def setLevels(value: js.Array[PlotDependencywheelLevelsOptions]): Self = StObject.set(x, "levels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLevelsUndefined: Self = StObject.set(x, "levels", js.undefined)
    
    @scala.inline
    def setLevelsVarargs(value: PlotDependencywheelLevelsOptions*): Self = StObject.set(x, "levels", js.Array(value :_*))
