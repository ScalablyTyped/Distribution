...
object PlotDependencywheelOptions {
  ...
  implicit class PlotDependencywheelOptionsOps[Self <: PlotDependencywheelOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotDependencywheelAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCenterVarargs(value: (Double | String | Null)*): Self = this.set("center", js.Array(value :_*))
    
    @scala.inline
    def setCenter(value: js.Array[Double | String | Null]): Self = this.set("center", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLevelsVarargs(value: PlotDependencywheelLevelsOptions*): Self = this.set("levels", js.Array(value :_*))
    
    @scala.inline
    def setLevels(value: js.Array[PlotDependencywheelLevelsOptions]): Self = this.set("levels", value.asInstanceOf[js.Any])
