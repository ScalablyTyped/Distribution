...
trait PlotPyramidSonificationTracksActiveWhenOptions extends StObject {
...
object PlotPyramidSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotPyramidSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
