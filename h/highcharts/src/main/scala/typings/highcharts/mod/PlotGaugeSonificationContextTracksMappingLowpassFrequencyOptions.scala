...
trait PlotGaugeSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotGaugeSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotGaugeSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
