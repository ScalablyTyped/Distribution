...
trait SonificationGlobalTracksMappingNoteDurationOptions extends StObject {
...
object SonificationGlobalTracksMappingNoteDurationOptions {
  
  inline def apply(): SonificationGlobalTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
