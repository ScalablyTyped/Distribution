...
trait PlotPpoSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPpoSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPpoSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
