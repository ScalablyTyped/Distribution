...
trait PlotNatrSonificationTracksMappingRateOptions extends StObject {
...
object PlotNatrSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
