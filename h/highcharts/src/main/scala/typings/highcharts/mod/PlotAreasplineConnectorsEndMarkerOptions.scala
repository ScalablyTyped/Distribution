...
trait PlotAreasplineConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotAreasplineConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplineConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineConnectorsEndMarkerOptions]
  }
}
