...
trait PlotDumbbellSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
