...
trait PlotCandlestickSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotCandlestickSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotCandlestickSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
