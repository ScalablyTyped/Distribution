...
trait PlotTimelineSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
