...
trait PlotEmaSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotEmaSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotEmaSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
