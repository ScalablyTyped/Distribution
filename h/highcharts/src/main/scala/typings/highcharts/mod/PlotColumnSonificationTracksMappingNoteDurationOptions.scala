...
trait PlotColumnSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotColumnSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
