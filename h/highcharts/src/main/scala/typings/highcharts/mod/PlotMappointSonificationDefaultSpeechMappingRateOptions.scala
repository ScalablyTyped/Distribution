...
trait PlotMappointSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotMappointSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotMappointSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
