...
trait PlotAoSonificationTracksMappingTimeOptions extends StObject {
...
object PlotAoSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
