...
trait PlotPyramidSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotPyramidSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
