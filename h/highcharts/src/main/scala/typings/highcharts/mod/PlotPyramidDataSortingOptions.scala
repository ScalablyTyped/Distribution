...
trait PlotPyramidDataSortingOptions extends StObject {
...
object PlotPyramidDataSortingOptions {
  
  inline def apply(): PlotPyramidDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidDataSortingOptions] (val x: Self) extends AnyVal {
