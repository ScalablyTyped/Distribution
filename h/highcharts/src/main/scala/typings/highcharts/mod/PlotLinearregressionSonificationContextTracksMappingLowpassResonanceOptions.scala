...
trait PlotLinearregressionSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
