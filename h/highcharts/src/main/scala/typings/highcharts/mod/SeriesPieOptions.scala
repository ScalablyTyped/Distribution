...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesPieOptions
  extends StObject
     with PlotPieOptions {
...
object SeriesPieOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | pie): SeriesPieOptions = {
  ...
  @scala.inline
  implicit class SeriesPieOptionsMutableBuilder[Self <: SeriesPieOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | pie): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
