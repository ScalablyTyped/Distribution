...
object SeriesPieOptions {
  ...
  @scala.inline
  implicit class SeriesPieOptionsOps[Self <: SeriesPieOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | pie): Self = this.set("type", value.asInstanceOf[js.Any])
