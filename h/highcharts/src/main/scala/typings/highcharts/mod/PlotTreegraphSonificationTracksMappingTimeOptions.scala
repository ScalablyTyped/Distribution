...
trait PlotTreegraphSonificationTracksMappingTimeOptions extends StObject {
...
object PlotTreegraphSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotTreegraphSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
