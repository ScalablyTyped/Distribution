...
trait PlotLinearregressionslopeStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressionslopeStatesHoverAnimationOptions
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressionslopeStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotLinearregressionslopeStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressionslopeStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressionslopeStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeStatesHoverOptions]
  }
}
