...
trait PlotPieSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotPieSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPieSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
