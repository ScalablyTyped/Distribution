...
trait PlotPriceenvelopesZonesOptions extends js.Object {
  /**
...
object PlotPriceenvelopesZonesOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPriceenvelopesZonesOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesZonesOptions]
  }
}
