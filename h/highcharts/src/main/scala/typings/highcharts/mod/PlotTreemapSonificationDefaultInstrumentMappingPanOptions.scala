...
trait PlotTreemapSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotTreemapSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotTreemapSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
