...
trait PlotTemaSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotTemaSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotTemaSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
