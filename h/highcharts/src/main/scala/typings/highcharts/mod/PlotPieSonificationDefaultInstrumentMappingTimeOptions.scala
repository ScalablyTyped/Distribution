...
trait PlotPieSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotPieSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotPieSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
