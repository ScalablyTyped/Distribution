...
trait PlotPyramid3dSonificationTracksMappingRateOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
