...
trait PlotAroonoscillatorConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotAroonoscillatorConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAroonoscillatorConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotAroonoscillatorConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotAroonoscillatorConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotAroonoscillatorConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotAroonoscillatorConnectorsMarkerOptions = null,
    startMarker: PlotAroonoscillatorConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotAroonoscillatorConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorConnectorsOptions]
  }
}
