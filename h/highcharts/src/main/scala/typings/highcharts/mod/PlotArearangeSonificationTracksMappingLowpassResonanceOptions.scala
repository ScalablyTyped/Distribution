...
trait PlotArearangeSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotArearangeSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotArearangeSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
