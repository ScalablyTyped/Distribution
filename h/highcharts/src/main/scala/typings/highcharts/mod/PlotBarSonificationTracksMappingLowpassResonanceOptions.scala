...
trait PlotBarSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotBarSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
