...
trait ChartParallelAxesCurrentDateIndicatorEventsOptions extends StObject {
...
object ChartParallelAxesCurrentDateIndicatorEventsOptions {
  
  inline def apply(): ChartParallelAxesCurrentDateIndicatorEventsOptions = {
