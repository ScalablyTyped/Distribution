...
@js.native
trait PlotWindbarbDataSortingOptions extends js.Object {
  /**
...
object PlotWindbarbDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotWindbarbDataSortingOptionsOps[Self <: PlotWindbarbDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
