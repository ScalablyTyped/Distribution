...
trait PlotWindbarbDataSortingOptions extends StObject {
...
object PlotWindbarbDataSortingOptions {
  
  @scala.inline
  def apply(): PlotWindbarbDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotWindbarbDataSortingOptionsMutableBuilder[Self <: PlotWindbarbDataSortingOptions] (val x: Self) extends AnyVal {
