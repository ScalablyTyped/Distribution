...
trait PlotKlingerSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotKlingerSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
