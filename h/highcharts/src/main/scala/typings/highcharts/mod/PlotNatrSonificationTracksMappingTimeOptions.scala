...
trait PlotNatrSonificationTracksMappingTimeOptions extends StObject {
...
object PlotNatrSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
