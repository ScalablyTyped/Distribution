...
trait PlotHeatmapSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
