...
trait PlotColumnSonificationContextTracksOptions extends StObject {
  
  /**
    * (Highcharts, Highstock) Define a condition for when a track should be
    * active and not.
    *
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotColumnSonificationContextTracksActiveWhenOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock) Instrument to use for playing.
    *
  ...
  /**
    * (Highcharts, Highstock) Mapping options for the audio parameters.
    *
    ...
    */
  var mapping: js.UndefOr[PlotColumnSonificationContextTracksMappingOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock) Name to use for a track when exporting to MIDI.
    * By default it uses the series name if the track is related to a series.
    */
  var midiName: js.UndefOr[String] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for point grouping, specifically for
    * instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotColumnSonificationContextTracksPointGroupingOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock) Round pitch mapping to musical notes.
    *
  ...
  /**
    * (Highcharts, Highstock) Show play marker (tooltip and/or crosshair) for a
    * track.
    */
  var showPlayMarker: js.UndefOr[Boolean] = js.undefined
  
  /**
    * (Highcharts, Highstock) Set a context track to play periodically every
    * `timeInterval` milliseconds while the sonification is playing.
    */
  var timeInterval: js.UndefOr[Double] = js.undefined
  
  /**
    * (Highcharts, Highstock) Type of track. Always `"instrument"` for
    * instrument tracks, and `"speech"` for speech tracks.
    */
  ...
  /**
    * (Highcharts, Highstock) How to map context events to time when using the
    * `valueInterval` option.
    */
  var valueMapFunction: js.UndefOr[OptionsValueMapFunctionValue] = js.undefined
  
  /**
    * (Highcharts, Highstock) The point property to play context for when using
    * `valueInterval`.
    */
  var valueProp: js.UndefOr[String] = js.undefined
}
object PlotColumnSonificationContextTracksOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotColumnSonificationContextTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotColumnSonificationContextTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotColumnSonificationContextTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
