...
trait PlotLinearregressionslopeSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
