...
trait PlotTrendlineSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
