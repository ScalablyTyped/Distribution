...
trait PlotVwapOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotVwapAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotVwapDataLabelsOptions | js.Array[PlotVwapDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotVwapDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotVwapParamsOptions] = js.native
...
object PlotVwapOptions {
  ...
  @scala.inline
  def apply(): PlotVwapOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapOptions]
  }
  
  @scala.inline
  implicit class PlotVwapOptionsMutableBuilder[Self <: PlotVwapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVwapAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotVwapDataLabelsOptions | js.Array[PlotVwapDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotVwapDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotVwapDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotVwapParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
