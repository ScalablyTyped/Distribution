...
trait PlotVwapOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotVwapSonificationOptions] = js.undefined
...
object PlotVwapOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVwapOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotVwapSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
