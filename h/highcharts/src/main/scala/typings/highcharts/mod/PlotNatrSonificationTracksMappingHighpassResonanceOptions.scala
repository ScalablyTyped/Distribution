...
trait PlotNatrSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotNatrSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
