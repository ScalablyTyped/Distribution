...
trait PlotRsiSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotRsiSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
