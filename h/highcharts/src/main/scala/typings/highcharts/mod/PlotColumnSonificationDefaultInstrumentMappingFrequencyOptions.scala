...
trait PlotColumnSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotColumnSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotColumnSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
