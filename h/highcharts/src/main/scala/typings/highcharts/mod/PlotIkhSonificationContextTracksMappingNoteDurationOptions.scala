...
trait PlotIkhSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotIkhSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
