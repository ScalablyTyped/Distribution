...
trait SonificationGlobalTracksMappingPitchOptions extends StObject {
...
object SonificationGlobalTracksMappingPitchOptions {
  
  inline def apply(): SonificationGlobalTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalTracksMappingPitchOptions] (val x: Self) extends AnyVal {
