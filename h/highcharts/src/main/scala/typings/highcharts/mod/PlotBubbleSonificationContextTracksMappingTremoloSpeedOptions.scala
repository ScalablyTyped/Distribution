...
trait PlotBubbleSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotBubbleSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotBubbleSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
