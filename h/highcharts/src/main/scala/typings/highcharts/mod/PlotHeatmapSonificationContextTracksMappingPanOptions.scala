...
trait PlotHeatmapSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotHeatmapSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotHeatmapSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
