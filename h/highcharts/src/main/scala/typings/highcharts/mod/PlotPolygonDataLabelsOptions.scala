...
@js.native
trait PlotPolygonDataLabelsOptions extends js.Object {
...
object PlotPolygonDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotPolygonDataLabelsOptionsOps[Self <: PlotPolygonDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPolygonDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
