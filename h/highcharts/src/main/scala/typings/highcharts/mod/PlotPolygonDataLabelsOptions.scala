...
trait PlotPolygonDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotPolygonDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotPolygonDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotPolygonDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotPolygonDataLabelsOptionsMutableBuilder[Self <: PlotPolygonDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPolygonDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
