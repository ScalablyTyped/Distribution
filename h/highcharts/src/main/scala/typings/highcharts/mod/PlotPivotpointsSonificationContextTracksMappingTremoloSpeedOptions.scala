...
trait PlotPivotpointsSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
