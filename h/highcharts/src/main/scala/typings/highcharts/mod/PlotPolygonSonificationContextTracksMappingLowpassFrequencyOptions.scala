...
trait PlotPolygonSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
