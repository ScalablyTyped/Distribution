...
trait PlotPyramid3dSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotPyramid3dSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
