...
object SeriesErrorbarOptions {
  ...
  @scala.inline
  implicit class SeriesErrorbarOptionsOps[Self <: SeriesErrorbarOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | errorbar): Self = this.set("type", value.asInstanceOf[js.Any])
