...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesErrorbarOptions extends PlotErrorbarOptions {
  /**
...
object SeriesErrorbarOptions {
  ...
  def apply(
    ...
    dataLabels: PlotErrorbarDataLabelsOptions | js.Array[PlotErrorbarDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotErrorbarDataSortingOptions = null,
    ...
    medianWidth: js.UndefOr[Null | Double] = js.undefined,
    ...
    if (!js.isUndefined(medianWidth)) __obj.updateDynamic("medianWidth")(medianWidth.asInstanceOf[js.Any])
