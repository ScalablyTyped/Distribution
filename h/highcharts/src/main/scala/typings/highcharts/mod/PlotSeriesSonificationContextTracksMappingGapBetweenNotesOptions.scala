...
trait PlotSeriesSonificationContextTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
