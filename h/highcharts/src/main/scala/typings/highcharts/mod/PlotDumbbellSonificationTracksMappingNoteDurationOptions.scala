...
trait PlotDumbbellSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
