...
trait PlotLollipopSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotLollipopSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotLollipopSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLollipopSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLollipopSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
