...
trait PlotEmaSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotEmaSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotEmaSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotEmaSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotEmaSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
