...
trait PlotFlagsSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotFlagsSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
