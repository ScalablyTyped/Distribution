...
trait PlotPolygonSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
