...
trait PlotAtrSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
