...
trait PlotStochasticSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotStochasticSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
