...
trait PlotCandlestickSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
