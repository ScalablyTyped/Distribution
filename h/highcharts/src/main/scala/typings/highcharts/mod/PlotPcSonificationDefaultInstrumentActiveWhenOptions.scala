...
trait PlotPcSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotPcSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotPcSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
