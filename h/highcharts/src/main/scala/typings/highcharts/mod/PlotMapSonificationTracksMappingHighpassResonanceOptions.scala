...
trait PlotMapSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotMapSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
