...
trait PlotCylinderSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
