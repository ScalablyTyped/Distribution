...
trait PlotSmaSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotSmaSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
