...
trait PlotSankeySonificationContextTracksMappingRateOptions extends StObject {
...
object PlotSankeySonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotSankeySonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeySonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeySonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
