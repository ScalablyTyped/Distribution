...
trait PlotPyramid3dSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotPyramid3dSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPyramid3dSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
