...
trait PlotTreegraphSonificationDefaultSpeechMappingOptions extends StObject {
  
  /**
    * (Highcharts) Speech pitch (how high/low the voice is) multiplier.
    */
  var pitch: js.UndefOr[
    Double | js.Object | String | js.Function | PlotTreegraphSonificationDefaultSpeechMappingPitchOptions
  ] = js.undefined
  ...
  var playDelay: js.UndefOr[
    Double | js.Object | String | js.Function | PlotTreegraphSonificationDefaultSpeechMappingPlayDelayOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var rate: js.UndefOr[
    Double | js.Object | String | js.Function | PlotTreegraphSonificationDefaultSpeechMappingRateOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var time: js.UndefOr[
    Double | js.Object | String | js.Function | PlotTreegraphSonificationDefaultSpeechMappingTimeOptions
  ] = js.undefined
  ...
  var volume: js.UndefOr[
    Double | js.Object | String | js.Function | PlotTreegraphSonificationDefaultSpeechMappingVolumeOptions
  ] = js.undefined
}
object PlotTreegraphSonificationDefaultSpeechMappingOptions {
  
  inline def apply(): PlotTreegraphSonificationDefaultSpeechMappingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphSonificationDefaultSpeechMappingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphSonificationDefaultSpeechMappingOptions] (val x: Self) extends AnyVal {
    
    inline def setPitch(
      value: Double | js.Object | String | js.Function | PlotTreegraphSonificationDefaultSpeechMappingPitchOptions
    ): Self = StObject.set(x, "pitch", value.asInstanceOf[js.Any])
    
    inline def setPitchUndefined: Self = StObject.set(x, "pitch", js.undefined)
    
    inline def setPlayDelay(
      value: Double | js.Object | String | js.Function | PlotTreegraphSonificationDefaultSpeechMappingPlayDelayOptions
    ...
    inline def setRate(
      value: Double | js.Object | String | js.Function | PlotTreegraphSonificationDefaultSpeechMappingRateOptions
    ...
    inline def setTime(
      value: Double | js.Object | String | js.Function | PlotTreegraphSonificationDefaultSpeechMappingTimeOptions
    ): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
    
    inline def setTimeUndefined: Self = StObject.set(x, "time", js.undefined)
    
    inline def setVolume(
      value: Double | js.Object | String | js.Function | PlotTreegraphSonificationDefaultSpeechMappingVolumeOptions
