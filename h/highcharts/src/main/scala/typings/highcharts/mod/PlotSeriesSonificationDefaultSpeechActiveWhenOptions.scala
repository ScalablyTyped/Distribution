...
trait PlotSeriesSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotSeriesSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotSeriesSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
