...
trait PlotPsarSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotPsarSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
