...
trait PlotNetworkgraphSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
