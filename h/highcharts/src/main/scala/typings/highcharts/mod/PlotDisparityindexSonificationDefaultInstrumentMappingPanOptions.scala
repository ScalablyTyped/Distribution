...
trait PlotDisparityindexSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotDisparityindexSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotDisparityindexSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
