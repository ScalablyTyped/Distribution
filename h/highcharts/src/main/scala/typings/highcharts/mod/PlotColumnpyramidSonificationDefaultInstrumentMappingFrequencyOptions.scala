...
trait PlotColumnpyramidSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotColumnpyramidSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotColumnpyramidSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
