...
trait PlotCandlestickSonificationTracksActiveWhenOptions extends StObject {
...
object PlotCandlestickSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotCandlestickSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
