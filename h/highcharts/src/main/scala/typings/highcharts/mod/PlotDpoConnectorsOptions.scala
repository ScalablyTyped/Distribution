...
trait PlotDpoConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotDpoConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotDpoConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotDpoConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotDpoConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotDpoConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotDpoConnectorsMarkerOptions = null,
    startMarker: PlotDpoConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotDpoConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotDpoConnectorsOptions]
  }
}
