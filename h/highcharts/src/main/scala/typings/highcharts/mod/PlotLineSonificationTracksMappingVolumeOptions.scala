...
trait PlotLineSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotLineSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
