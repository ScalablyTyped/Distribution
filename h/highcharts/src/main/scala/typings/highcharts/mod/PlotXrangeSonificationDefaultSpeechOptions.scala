...
trait PlotXrangeSonificationDefaultSpeechOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotXrangeSonificationDefaultSpeechActiveWhenOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) The language to speak in for speech
    * tracks, as an IETF BCP 47 language tag.
    */
  var language: js.UndefOr[String] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) Mapping configuration for the speech/audio
    * parameters.
    *
    ...
    */
  var mapping: js.UndefOr[PlotXrangeSonificationDefaultSpeechMappingOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) Options for point grouping, specifically
    * for instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotXrangeSonificationDefaultSpeechPointGroupingOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock, Gantt) Name of the voice synthesis to prefer for
    * speech tracks.
    *
...
object PlotXrangeSonificationDefaultSpeechOptions {
  
  inline def apply(): PlotXrangeSonificationDefaultSpeechOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotXrangeSonificationDefaultSpeechOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotXrangeSonificationDefaultSpeechOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotXrangeSonificationDefaultSpeechActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotXrangeSonificationDefaultSpeechMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    
    inline def setMappingUndefined: Self = StObject.set(x, "mapping", js.undefined)
    
    inline def setPointGrouping(value: PlotXrangeSonificationDefaultSpeechPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
