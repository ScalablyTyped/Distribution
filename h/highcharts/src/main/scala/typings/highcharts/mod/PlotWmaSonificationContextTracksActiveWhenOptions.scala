...
trait PlotWmaSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotWmaSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotWmaSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
