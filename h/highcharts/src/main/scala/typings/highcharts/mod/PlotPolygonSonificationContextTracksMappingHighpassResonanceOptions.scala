...
trait PlotPolygonSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
