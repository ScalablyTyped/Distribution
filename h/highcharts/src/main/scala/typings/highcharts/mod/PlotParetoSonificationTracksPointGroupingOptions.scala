...
trait PlotParetoSonificationTracksPointGroupingOptions extends StObject {
...
object PlotParetoSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotParetoSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
