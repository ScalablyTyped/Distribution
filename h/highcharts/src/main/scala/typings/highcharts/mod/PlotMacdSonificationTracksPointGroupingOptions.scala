...
trait PlotMacdSonificationTracksPointGroupingOptions extends StObject {
...
object PlotMacdSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotMacdSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMacdSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMacdSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
