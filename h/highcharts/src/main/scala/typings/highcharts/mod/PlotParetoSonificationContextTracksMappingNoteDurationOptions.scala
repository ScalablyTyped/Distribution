...
trait PlotParetoSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
