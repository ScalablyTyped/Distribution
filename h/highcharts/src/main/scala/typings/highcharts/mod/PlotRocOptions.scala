...
trait PlotRocOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotRocAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotRocDataLabelsOptions | js.Array[PlotRocDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotRocDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotRocOnPointOptions] = js.undefined
...
object PlotRocOptions {
  ...
  inline def apply(): PlotRocOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocOptions]
  }
  
  extension [Self <: PlotRocOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotRocAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotRocDataLabelsOptions | js.Array[PlotRocDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotRocDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotRocDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotRocOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotRocParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
