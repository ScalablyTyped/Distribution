...
trait PlotRocOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotRocAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotRocDataLabelsOptions | js.Array[PlotRocDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotRocDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotRocParamsOptions] = js.native
...
object PlotRocOptions {
  ...
  @scala.inline
  def apply(): PlotRocOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocOptions]
  }
  
  @scala.inline
  implicit class PlotRocOptionsMutableBuilder[Self <: PlotRocOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotRocAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotRocDataLabelsOptions | js.Array[PlotRocDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotRocDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotRocDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotRocParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
