...
trait PlotRocOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotRocSonificationOptions] = js.undefined
...
object PlotRocOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRocOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotRocSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
