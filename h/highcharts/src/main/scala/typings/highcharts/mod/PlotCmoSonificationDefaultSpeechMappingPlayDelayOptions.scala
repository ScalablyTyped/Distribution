...
trait PlotCmoSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotCmoSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotCmoSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
