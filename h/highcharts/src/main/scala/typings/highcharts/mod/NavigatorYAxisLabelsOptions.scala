...
object NavigatorYAxisLabelsOptions {
  ...
  inline def apply(): NavigatorYAxisLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavigatorYAxisLabelsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NavigatorYAxisLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setLevels(value: js.Array[NavigatorYAxisLabelsLevelsOptions]): Self = StObject.set(x, "levels", value.asInstanceOf[js.Any])
    
    inline def setLevelsUndefined: Self = StObject.set(x, "levels", js.undefined)
    
    inline def setLevelsVarargs(value: NavigatorYAxisLabelsLevelsOptions*): Self = StObject.set(x, "levels", js.Array(value*))
    ...
    inline def setSymbol(value: NavigatorYAxisLabelsSymbolOptions): Self = StObject.set(x, "symbol", value.asInstanceOf[js.Any])
