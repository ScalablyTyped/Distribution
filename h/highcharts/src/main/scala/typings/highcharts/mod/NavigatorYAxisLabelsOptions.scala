...
object NavigatorYAxisLabelsOptions {
  ...
  extension [Self <: NavigatorYAxisLabelsOptions](x: Self) {
    ...
    inline def setLevelsVarargs(value: NavigatorYAxisLabelsLevelsOptions*): Self = StObject.set(x, "levels", js.Array(value :_*))
