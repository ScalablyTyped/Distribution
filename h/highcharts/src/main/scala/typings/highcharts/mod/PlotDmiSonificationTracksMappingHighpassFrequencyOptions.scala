...
trait PlotDmiSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotDmiSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
