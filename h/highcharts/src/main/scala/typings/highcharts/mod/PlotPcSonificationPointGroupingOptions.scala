...
trait PlotPcSonificationPointGroupingOptions extends StObject {
...
object PlotPcSonificationPointGroupingOptions {
  
  inline def apply(): PlotPcSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
