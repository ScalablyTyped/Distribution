...
trait PlotSunburstSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotSunburstSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotSunburstSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
