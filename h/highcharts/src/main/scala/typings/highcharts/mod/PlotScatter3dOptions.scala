...
trait PlotScatter3dOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotScatter3dDataLabelsOptions | js.Array[PlotScatter3dDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotScatter3dDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotScatter3dJitterOptions] = js.native
...
object PlotScatter3dOptions {
  ...
  @scala.inline
  def apply(): PlotScatter3dOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dOptions]
  }
  
  @scala.inline
  implicit class PlotScatter3dOptionsMutableBuilder[Self <: PlotScatter3dOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotScatter3dAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotScatter3dDataLabelsOptions | js.Array[PlotScatter3dDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotScatter3dDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotScatter3dDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJitter(value: PlotScatter3dJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
