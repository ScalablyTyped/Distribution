...
trait PlotScatter3dOptions extends StObject {
  ...
  /**
    ...
    */
  var cluster: js.UndefOr[PlotScatter3dClusterOptions] = js.undefined
...
object PlotScatter3dOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotScatter3dOptions] (val x: Self) extends AnyVal {
    ...
    inline def setCluster(value: PlotScatter3dClusterOptions): Self = StObject.set(x, "cluster", value.asInstanceOf[js.Any])
