...
trait PlotScatter3dOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotScatter3dSonificationOptions] = js.undefined
...
object PlotScatter3dOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotScatter3dOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotScatter3dSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
