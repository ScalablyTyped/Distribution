...
object PlotScatter3dOptions {
  ...
  @scala.inline
  implicit class PlotScatter3dOptionsOps[Self <: PlotScatter3dOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotScatter3dDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    @scala.inline
    def setDataLabels(value: PlotScatter3dDataLabelsOptions | js.Array[PlotScatter3dDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotScatter3dDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setJitter(value: PlotScatter3dJitterOptions): Self = this.set("jitter", value.asInstanceOf[js.Any])
    @scala.inline
