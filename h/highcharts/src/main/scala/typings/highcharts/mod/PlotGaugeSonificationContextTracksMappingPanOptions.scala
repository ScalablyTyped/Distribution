...
trait PlotGaugeSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotGaugeSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotGaugeSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
