...
trait PlotLinearregressionangleAccessibilityPointOptions extends StObject {
...
object PlotLinearregressionangleAccessibilityPointOptions {
  
  inline def apply(): PlotLinearregressionangleAccessibilityPointOptions = {
