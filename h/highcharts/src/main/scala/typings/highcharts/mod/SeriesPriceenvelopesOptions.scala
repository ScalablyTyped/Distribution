...
object SeriesPriceenvelopesOptions {
  ...
  inline def apply(`type`: String | priceenvelopes): SeriesPriceenvelopesOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesPriceenvelopesOptions] (val x: Self) extends AnyVal {
