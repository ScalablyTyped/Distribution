...
trait SeriesPriceenvelopesOptions extends PlotPriceenvelopesOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | priceenvelopes = js.native
...
object SeriesPriceenvelopesOptions {
  ...
  @scala.inline
  def apply(`type`: String | priceenvelopes): SeriesPriceenvelopesOptions = {
