...
object SeriesPriceenvelopesOptions {
  ...
  @scala.inline
  implicit class SeriesPriceenvelopesOptionsOps[Self <: SeriesPriceenvelopesOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | priceenvelopes): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
