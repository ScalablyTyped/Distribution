...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesPriceenvelopesOptions extends PlotPriceenvelopesOptions {
  /**
    * Not available
    */
...
object SeriesPriceenvelopesOptions {
  ...
  def apply(
    ...
    dataLabels: PlotPriceenvelopesDataLabelsOptions | js.Array[PlotPriceenvelopesDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotPriceenvelopesDataSortingOptions = null,
