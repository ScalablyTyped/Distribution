...
import typings.highcharts.highchartsStrings.priceenvelopes
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesPriceenvelopesOptions
  extends StObject
...
object SeriesPriceenvelopesOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | priceenvelopes): SeriesPriceenvelopesOptions = {
  ...
  @scala.inline
  implicit class SeriesPriceenvelopesOptionsMutableBuilder[Self <: SeriesPriceenvelopesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | priceenvelopes): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
