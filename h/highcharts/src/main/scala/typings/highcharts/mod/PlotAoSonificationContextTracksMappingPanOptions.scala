...
trait PlotAoSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotAoSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotAoSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
