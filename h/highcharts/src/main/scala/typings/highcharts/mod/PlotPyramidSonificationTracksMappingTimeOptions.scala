...
trait PlotPyramidSonificationTracksMappingTimeOptions extends StObject {
...
object PlotPyramidSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotPyramidSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
