...
trait SonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object SonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): SonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
