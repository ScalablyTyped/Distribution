...
trait PlotTimelineSonificationTracksActiveWhenOptions extends StObject {
...
object PlotTimelineSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotTimelineSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
