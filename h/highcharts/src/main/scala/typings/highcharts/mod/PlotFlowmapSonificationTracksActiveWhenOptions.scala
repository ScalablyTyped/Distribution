...
trait PlotFlowmapSonificationTracksActiveWhenOptions extends StObject {
...
object PlotFlowmapSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
