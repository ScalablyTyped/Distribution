...
trait PlotDependencywheelSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
