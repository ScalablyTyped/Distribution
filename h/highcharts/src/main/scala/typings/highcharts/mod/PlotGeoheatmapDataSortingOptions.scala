...
trait PlotGeoheatmapDataSortingOptions extends StObject {
...
object PlotGeoheatmapDataSortingOptions {
  
  inline def apply(): PlotGeoheatmapDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapDataSortingOptions] (val x: Self) extends AnyVal {
