...
trait PlotLinearregressionangleConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressionangleConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionangleConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleConnectorsMarkerOptions]
  }
}
