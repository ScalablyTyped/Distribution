...
trait PlotLineSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotLineSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotLineSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
