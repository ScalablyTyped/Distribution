...
trait PlotMomentumSonificationPointGroupingOptions extends StObject {
...
object PlotMomentumSonificationPointGroupingOptions {
  
  inline def apply(): PlotMomentumSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMomentumSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
