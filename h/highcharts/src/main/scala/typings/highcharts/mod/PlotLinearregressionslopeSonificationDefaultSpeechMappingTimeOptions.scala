...
trait PlotLinearregressionslopeSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
