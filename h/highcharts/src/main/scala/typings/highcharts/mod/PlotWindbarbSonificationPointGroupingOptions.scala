...
trait PlotWindbarbSonificationPointGroupingOptions extends StObject {
...
object PlotWindbarbSonificationPointGroupingOptions {
  
  inline def apply(): PlotWindbarbSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
