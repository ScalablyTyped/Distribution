...
@js.native
trait PlotBoxplotDataLabelsOptions extends js.Object {
...
object PlotBoxplotDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotBoxplotDataLabelsOptionsOps[Self <: PlotBoxplotDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBoxplotDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
