...
trait PlotLinearregressionSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotLinearregressionSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotLinearregressionSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
