...
trait PlotTilemapDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotTilemapDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotTilemapDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotTilemapDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotTilemapDataLabelsOptionsMutableBuilder[Self <: PlotTilemapDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTilemapDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
