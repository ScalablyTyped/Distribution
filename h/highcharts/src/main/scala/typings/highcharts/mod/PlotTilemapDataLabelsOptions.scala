...
@js.native
trait PlotTilemapDataLabelsOptions extends js.Object {
...
object PlotTilemapDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotTilemapDataLabelsOptionsOps[Self <: PlotTilemapDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTilemapDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
