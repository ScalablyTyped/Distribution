...
object PlotTilemapDataLabelsOptions {
  ...
  inline def apply(): PlotTilemapDataLabelsOptions = {
  ...
  extension [Self <: PlotTilemapDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotTilemapDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
