...
trait PlotColumnrangeSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotColumnrangeSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotColumnrangeSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
