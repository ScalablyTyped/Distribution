...
trait PlotCmfSonificationTracksPointGroupingOptions extends StObject {
...
object PlotCmfSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotCmfSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmfSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmfSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
