...
trait SeriesDependencywheelNodesDataLabelsAnimationOptions extends StObject {
...
object SeriesDependencywheelNodesDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesDependencywheelNodesDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
