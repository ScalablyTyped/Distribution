...
trait PlotWordcloudSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
