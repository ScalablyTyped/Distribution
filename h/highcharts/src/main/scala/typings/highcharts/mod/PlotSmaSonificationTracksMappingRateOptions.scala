...
trait PlotSmaSonificationTracksMappingRateOptions extends StObject {
...
object PlotSmaSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotSmaSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
