...
trait ColorAxisPlotLinesLabelOptions extends StObject {
...
object ColorAxisPlotLinesLabelOptions {
  
  inline def apply(): ColorAxisPlotLinesLabelOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColorAxisPlotLinesLabelOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorAxisPlotLinesLabelOptions] (val x: Self) extends AnyVal {
