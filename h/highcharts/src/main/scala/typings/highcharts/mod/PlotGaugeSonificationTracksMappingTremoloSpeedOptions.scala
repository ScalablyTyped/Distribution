...
trait PlotGaugeSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotGaugeSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotGaugeSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
