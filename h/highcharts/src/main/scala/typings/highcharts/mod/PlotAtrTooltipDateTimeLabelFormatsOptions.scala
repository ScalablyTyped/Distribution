...
trait PlotAtrTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotAtrTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotAtrTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotAtrTooltipDateTimeLabelFormatsOptions]
  }
}
