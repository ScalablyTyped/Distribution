...
trait PlotPyramidSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotPyramidSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotPyramidSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
