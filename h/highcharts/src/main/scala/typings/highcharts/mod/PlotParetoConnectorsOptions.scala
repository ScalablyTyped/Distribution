...
trait PlotParetoConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotParetoConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotParetoConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotParetoConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotParetoConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotParetoConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotParetoConnectorsMarkerOptions = null,
    startMarker: PlotParetoConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotParetoConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotParetoConnectorsOptions]
  }
}
