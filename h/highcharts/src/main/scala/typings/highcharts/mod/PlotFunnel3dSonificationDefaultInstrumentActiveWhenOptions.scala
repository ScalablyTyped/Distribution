...
trait PlotFunnel3dSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
