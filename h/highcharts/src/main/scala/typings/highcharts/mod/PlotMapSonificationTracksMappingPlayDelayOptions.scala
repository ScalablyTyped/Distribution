...
trait PlotMapSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotMapSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
