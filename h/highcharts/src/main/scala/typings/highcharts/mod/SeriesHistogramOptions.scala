...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesHistogramOptions
  extends StObject
     with PlotHistogramOptions {
...
object SeriesHistogramOptions {
  ...
  @scala.inline
  def apply(data: Unit, dataParser: Unit, dataURL: Unit, `type`: String | histogram): SeriesHistogramOptions = {
