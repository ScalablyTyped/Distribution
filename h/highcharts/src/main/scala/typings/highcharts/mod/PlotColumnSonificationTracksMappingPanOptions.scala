...
trait PlotColumnSonificationTracksMappingPanOptions extends StObject {
...
object PlotColumnSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
