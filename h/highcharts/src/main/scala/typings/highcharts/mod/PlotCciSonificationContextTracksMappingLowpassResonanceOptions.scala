...
trait PlotCciSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotCciSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotCciSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
