...
trait PlotPyramid3dOnPointConnectorOptions extends StObject {
...
object PlotPyramid3dOnPointConnectorOptions {
  
  inline def apply(): PlotPyramid3dOnPointConnectorOptions = {
