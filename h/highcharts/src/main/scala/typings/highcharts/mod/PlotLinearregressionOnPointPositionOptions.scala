...
trait PlotLinearregressionOnPointPositionOptions extends StObject {
...
object PlotLinearregressionOnPointPositionOptions {
  
  inline def apply(): PlotLinearregressionOnPointPositionOptions = {
