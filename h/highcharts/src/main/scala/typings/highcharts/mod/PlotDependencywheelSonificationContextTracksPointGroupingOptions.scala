...
trait PlotDependencywheelSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
