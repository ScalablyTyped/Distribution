...
@js.native
trait SeriesVennDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesVennDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesVennDataDataLabelsAnimationOptionsOps[Self <: SeriesVennDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
