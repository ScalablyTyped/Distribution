...
trait PlotBarSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotBarSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotBarSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
