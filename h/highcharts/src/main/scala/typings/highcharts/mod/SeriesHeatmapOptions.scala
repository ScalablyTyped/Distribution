...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesHeatmapOptions
  extends StObject
     with PlotHeatmapOptions {
...
object SeriesHeatmapOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | heatmap): SeriesHeatmapOptions = {
  ...
  @scala.inline
  implicit class SeriesHeatmapOptionsMutableBuilder[Self <: SeriesHeatmapOptions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setData(value: js.Array[js.Array[Double] | PointOptionsObject]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataVarargs(value: (js.Array[Double] | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setType(value: String | heatmap): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
