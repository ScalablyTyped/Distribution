...
object SeriesHeatmapOptions {
  ...
  extension [Self <: SeriesHeatmapOptions](x: Self) {
    ...
    inline def setDataVarargs(value: (js.Array[Double] | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    inline def setType(value: String | heatmap): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
