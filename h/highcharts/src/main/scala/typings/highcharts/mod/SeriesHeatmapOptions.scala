...
object SeriesHeatmapOptions {
  ...
  @scala.inline
  implicit class SeriesHeatmapOptionsOps[Self <: SeriesHeatmapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | heatmap): Self = this.set("type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataVarargs(value: (js.Array[Double] | PointOptionsObject)*): Self = this.set("data", js.Array(value :_*))
    
    @scala.inline
    def setData(value: js.Array[js.Array[Double] | PointOptionsObject]): Self = this.set("data", value.asInstanceOf[js.Any])
