...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesHeatmapOptions extends PlotHeatmapOptions {
  /**
...
object SeriesHeatmapOptions {
  ...
  def apply(
    ...
    data: js.Array[js.Array[Double] | PointOptionsObject] = null,
