...
trait SeriesHeatmapOptions extends PlotHeatmapOptions {
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[js.Array[Double] | PointOptionsObject]] = js.native
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | heatmap = js.native
...
object SeriesHeatmapOptions {
  ...
  @scala.inline
  def apply(`type`: String | heatmap): SeriesHeatmapOptions = {
