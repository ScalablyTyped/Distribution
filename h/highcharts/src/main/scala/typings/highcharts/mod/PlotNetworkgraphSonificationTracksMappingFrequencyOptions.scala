...
trait PlotNetworkgraphSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotNetworkgraphSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotNetworkgraphSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
