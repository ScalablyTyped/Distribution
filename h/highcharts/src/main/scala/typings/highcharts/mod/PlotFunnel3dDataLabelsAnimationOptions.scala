...
@js.native
trait PlotFunnel3dDataLabelsAnimationOptions extends js.Object {
...
object PlotFunnel3dDataLabelsAnimationOptions {
  ...
  @scala.inline
  def apply(): PlotFunnel3dDataLabelsAnimationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dDataLabelsAnimationOptions]
  }
  
  @scala.inline
  implicit class PlotFunnel3dDataLabelsAnimationOptionsOps[Self <: PlotFunnel3dDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
