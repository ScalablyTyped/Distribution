...
object SeriesWmaOptions {
  ...
  @scala.inline
  implicit class SeriesWmaOptionsOps[Self <: SeriesWmaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | wma): Self = this.set("type", value.asInstanceOf[js.Any])
