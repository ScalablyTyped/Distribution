...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesWmaOptions extends PlotWmaOptions {
  /**
    * Not available
    */
...
object SeriesWmaOptions {
  ...
  def apply(
    ...
    dataLabels: PlotWmaDataLabelsOptions | js.Array[PlotWmaDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotWmaDataSortingOptions = null,
