...
object SeriesWmaOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | wma): SeriesWmaOptions = {
  ...
  @scala.inline
  implicit class SeriesWmaOptionsMutableBuilder[Self <: SeriesWmaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | wma): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
