...
import typings.highcharts.highchartsStrings.wma
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesWmaOptions
  extends StObject
     with PlotWmaOptions {
...
object SeriesWmaOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | wma): SeriesWmaOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesWmaOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | wma): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
