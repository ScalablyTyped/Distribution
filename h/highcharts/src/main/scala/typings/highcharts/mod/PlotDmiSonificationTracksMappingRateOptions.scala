...
trait PlotDmiSonificationTracksMappingRateOptions extends StObject {
...
object PlotDmiSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
