...
trait PlotPriceenvelopesSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPriceenvelopesSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
