...
trait PlotCmoSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotCmoSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
