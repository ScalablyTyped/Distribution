...
trait PlotNetworkgraphSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
