...
trait PlotTilemapSonificationPointGroupingOptions extends StObject {
...
object PlotTilemapSonificationPointGroupingOptions {
  
  inline def apply(): PlotTilemapSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTilemapSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
