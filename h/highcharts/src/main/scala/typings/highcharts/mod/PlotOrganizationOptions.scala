...
trait PlotOrganizationOptions extends StObject {
  ...
  /**
    * (Highcharts, Highstock, Gantt) The border radius of the node cards.
    */
  ...
  /**
    ...
    */
  var link: js.UndefOr[PlotOrganizationLinkOptions] = js.undefined
...
object PlotOrganizationOptions {
  ...
  inline def apply(): PlotOrganizationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOrganizationOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataSorting(value: DataSortingOptionsObject | PlotOrganizationDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setLevels(value: js.Array[PlotOrganizationLevelsOptions]): Self = StObject.set(x, "levels", value.asInstanceOf[js.Any])
    ...
    inline def setLink(value: PlotOrganizationLinkOptions): Self = StObject.set(x, "link", value.asInstanceOf[js.Any])
