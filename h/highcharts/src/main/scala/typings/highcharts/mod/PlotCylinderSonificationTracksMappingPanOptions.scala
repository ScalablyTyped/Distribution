...
trait PlotCylinderSonificationTracksMappingPanOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
