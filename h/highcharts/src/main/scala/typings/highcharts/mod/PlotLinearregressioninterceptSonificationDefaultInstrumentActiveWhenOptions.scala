...
trait PlotLinearregressioninterceptSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
