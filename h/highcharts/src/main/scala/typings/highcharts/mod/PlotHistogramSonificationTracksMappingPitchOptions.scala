...
trait PlotHistogramSonificationTracksMappingPitchOptions extends StObject {
...
object PlotHistogramSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotHistogramSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
