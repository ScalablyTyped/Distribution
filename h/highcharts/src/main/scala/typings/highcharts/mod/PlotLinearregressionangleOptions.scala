...
trait PlotLinearregressionangleOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotLinearregressionangleAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotLinearregressionangleDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotLinearregressionangleParamsOptions] = js.native
...
object PlotLinearregressionangleOptions {
  ...
  @scala.inline
  def apply(): PlotLinearregressionangleOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleOptions]
  }
  
  @scala.inline
  implicit class PlotLinearregressionangleOptionsMutableBuilder[Self <: PlotLinearregressionangleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressionangleAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotLinearregressionangleDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotLinearregressionangleDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotLinearregressionangleParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
