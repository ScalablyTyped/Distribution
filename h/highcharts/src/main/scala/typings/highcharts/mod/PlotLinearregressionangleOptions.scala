...
trait PlotLinearregressionangleOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotLinearregressionangleSonificationOptions] = js.undefined
...
object PlotLinearregressionangleOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotLinearregressionangleSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
