...
object PlotLinearregressionangleOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressionangleOptionsOps[Self <: PlotLinearregressionangleOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressionangleAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotLinearregressionangleDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    ...
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotLinearregressionangleDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotLinearregressionangleParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
