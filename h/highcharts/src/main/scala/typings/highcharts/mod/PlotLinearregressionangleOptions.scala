...
object PlotLinearregressionangleOptions {
  ...
  def apply(
    ...
    dataLabels: PlotLinearregressionangleDataLabelsOptions | js.Array[PlotLinearregressionangleDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotLinearregressionangleDataSortingOptions = null,
