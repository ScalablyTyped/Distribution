...
trait PlotPolygonSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotPolygonSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotPolygonSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
