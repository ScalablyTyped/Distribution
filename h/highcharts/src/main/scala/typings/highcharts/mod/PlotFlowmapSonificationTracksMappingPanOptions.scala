...
trait PlotFlowmapSonificationTracksMappingPanOptions extends StObject {
...
object PlotFlowmapSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotFlowmapSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlowmapSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlowmapSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
