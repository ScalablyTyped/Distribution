...
trait PlotCmoSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotCmoSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotCmoSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
