...
trait PlotArearangeSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotArearangeSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
