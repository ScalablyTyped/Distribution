...
trait PlotColumnSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
