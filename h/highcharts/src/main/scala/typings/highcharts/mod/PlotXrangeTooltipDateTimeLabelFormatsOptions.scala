...
trait PlotXrangeTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotXrangeTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotXrangeTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotXrangeTooltipDateTimeLabelFormatsOptions]
  }
}
