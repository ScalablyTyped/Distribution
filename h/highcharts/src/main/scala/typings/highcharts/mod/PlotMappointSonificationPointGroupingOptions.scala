...
trait PlotMappointSonificationPointGroupingOptions extends StObject {
...
object PlotMappointSonificationPointGroupingOptions {
  
  inline def apply(): PlotMappointSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
