...
trait PlotSlowstochasticOnPointConnectorOptions extends StObject {
...
object PlotSlowstochasticOnPointConnectorOptions {
  
  inline def apply(): PlotSlowstochasticOnPointConnectorOptions = {
