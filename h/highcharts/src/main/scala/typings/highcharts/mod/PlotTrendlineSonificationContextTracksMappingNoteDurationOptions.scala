...
trait PlotTrendlineSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotTrendlineSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotTrendlineSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
