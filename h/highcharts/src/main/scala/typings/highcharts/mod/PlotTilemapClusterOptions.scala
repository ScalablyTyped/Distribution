...
trait PlotTilemapClusterOptions extends StObject {
  ...
  var events: js.UndefOr[PlotTilemapClusterEventsOptions] = js.undefined
  ...
  /**
    ...
    * iterations.
    */
  var layoutAlgorithm: js.UndefOr[PlotTilemapClusterLayoutAlgorithmOptions] = js.undefined
  ...
  var states: js.UndefOr[PlotTilemapClusterStatesOptions] = js.undefined
  ...
  /**
    ...
    * `className` option.
    */
  var zones: js.UndefOr[js.Array[PlotTilemapClusterZonesOptions]] = js.undefined
}
object PlotTilemapClusterOptions {
  
  inline def apply(): PlotTilemapClusterOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapClusterOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTilemapClusterOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: PlotTilemapClusterEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    
    inline def setEventsUndefined: Self = StObject.set(x, "events", js.undefined)
    
    inline def setLayoutAlgorithm(value: PlotTilemapClusterLayoutAlgorithmOptions): Self = StObject.set(x, "layoutAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setStates(value: PlotTilemapClusterStatesOptions): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    
    inline def setStatesUndefined: Self = StObject.set(x, "states", js.undefined)
    
    inline def setZones(value: js.Array[PlotTilemapClusterZonesOptions]): Self = StObject.set(x, "zones", value.asInstanceOf[js.Any])
    
    inline def setZonesUndefined: Self = StObject.set(x, "zones", js.undefined)
    
    inline def setZonesVarargs(value: PlotTilemapClusterZonesOptions*): Self = StObject.set(x, "zones", js.Array(value*))
  }
}
