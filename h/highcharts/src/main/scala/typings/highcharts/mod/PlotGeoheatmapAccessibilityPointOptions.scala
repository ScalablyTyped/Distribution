...
trait PlotGeoheatmapAccessibilityPointOptions extends StObject {
...
object PlotGeoheatmapAccessibilityPointOptions {
  
  inline def apply(): PlotGeoheatmapAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapAccessibilityPointOptions] (val x: Self) extends AnyVal {
