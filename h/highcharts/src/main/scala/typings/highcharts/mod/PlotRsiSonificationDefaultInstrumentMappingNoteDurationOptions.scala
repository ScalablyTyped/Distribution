...
trait PlotRsiSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotRsiSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotRsiSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
