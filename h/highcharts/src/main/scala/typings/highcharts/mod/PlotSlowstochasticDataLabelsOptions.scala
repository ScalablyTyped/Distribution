...
trait PlotSlowstochasticDataLabelsOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotSlowstochasticDataLabelsAnimationOptions | PartialAnimationOptionsOb
  ] = js.undefined
...
object PlotSlowstochasticDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotSlowstochasticDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotSlowstochasticDataLabelsOptionsMutableBuilder[Self <: PlotSlowstochasticDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSlowstochasticDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
