...
@js.native
trait PlotSlowstochasticDataLabelsOptions extends js.Object {
...
object PlotSlowstochasticDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotSlowstochasticDataLabelsOptionsOps[Self <: PlotSlowstochasticDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSlowstochasticDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
