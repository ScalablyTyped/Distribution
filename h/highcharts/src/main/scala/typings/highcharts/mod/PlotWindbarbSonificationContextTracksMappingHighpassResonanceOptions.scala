...
trait PlotWindbarbSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotWindbarbSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotWindbarbSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
