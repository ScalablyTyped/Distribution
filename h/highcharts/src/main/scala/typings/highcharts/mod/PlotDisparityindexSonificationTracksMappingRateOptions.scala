...
trait PlotDisparityindexSonificationTracksMappingRateOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
