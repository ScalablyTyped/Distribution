...
trait PlotSplineSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotSplineSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
