...
trait PlotGaugeSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotGaugeSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotGaugeSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
