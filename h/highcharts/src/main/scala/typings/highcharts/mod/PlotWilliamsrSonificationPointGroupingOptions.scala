...
trait PlotWilliamsrSonificationPointGroupingOptions extends StObject {
...
object PlotWilliamsrSonificationPointGroupingOptions {
  
  inline def apply(): PlotWilliamsrSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWilliamsrSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
