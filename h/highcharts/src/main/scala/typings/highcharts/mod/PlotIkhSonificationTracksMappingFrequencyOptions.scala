...
trait PlotIkhSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotIkhSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotIkhSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
