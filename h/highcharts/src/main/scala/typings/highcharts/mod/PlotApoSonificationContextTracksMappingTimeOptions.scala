...
trait PlotApoSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
