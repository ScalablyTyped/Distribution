...
trait PlotAoSonificationTracksMappingRateOptions extends StObject {
...
object PlotAoSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotAoSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
