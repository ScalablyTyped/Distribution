...
trait PlotTilemapSonificationTracksMappingTimeOptions extends StObject {
...
object PlotTilemapSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotTilemapSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTilemapSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTilemapSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
