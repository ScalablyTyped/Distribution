...
trait PlotSeriesSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotSeriesSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotSeriesSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
