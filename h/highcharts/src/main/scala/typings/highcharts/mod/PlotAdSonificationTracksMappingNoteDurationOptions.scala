...
trait PlotAdSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotAdSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotAdSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
