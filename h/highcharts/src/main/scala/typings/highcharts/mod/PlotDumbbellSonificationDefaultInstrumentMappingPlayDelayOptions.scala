...
trait PlotDumbbellSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotDumbbellSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotDumbbellSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
