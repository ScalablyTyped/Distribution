...
trait SonificationGlobalContextTracksMappingPlayDelayOptions extends StObject {
...
object SonificationGlobalContextTracksMappingPlayDelayOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
