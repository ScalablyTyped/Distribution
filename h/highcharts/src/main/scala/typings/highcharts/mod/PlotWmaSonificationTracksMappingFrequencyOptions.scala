...
trait PlotWmaSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotWmaSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotWmaSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
