...
trait PlotItemPointEventsOptions extends js.Object {
  /**
...
object PlotItemPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotItemPointEventsOptions]
  }
}
