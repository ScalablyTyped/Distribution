...
object SeriesMacdOptions {
  ...
  @scala.inline
  implicit class SeriesMacdOptionsOps[Self <: SeriesMacdOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | macd): Self = this.set("type", value.asInstanceOf[js.Any])
