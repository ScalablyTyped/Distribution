...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesMacdOptions extends PlotMacdOptions {
  /**
    * Not available
    */
...
object SeriesMacdOptions {
  ...
  def apply(
    ...
    dataLabels: PlotMacdDataLabelsOptions | js.Array[PlotMacdDataLabelsOptions] = null,
