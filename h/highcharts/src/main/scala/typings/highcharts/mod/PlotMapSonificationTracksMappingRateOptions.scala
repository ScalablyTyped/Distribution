...
trait PlotMapSonificationTracksMappingRateOptions extends StObject {
...
object PlotMapSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotMapSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
