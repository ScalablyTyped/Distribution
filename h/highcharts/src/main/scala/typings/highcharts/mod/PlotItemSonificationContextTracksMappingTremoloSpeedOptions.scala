...
trait PlotItemSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotItemSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotItemSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotItemSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotItemSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
