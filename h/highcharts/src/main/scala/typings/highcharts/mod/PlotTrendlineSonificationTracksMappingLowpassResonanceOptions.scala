...
trait PlotTrendlineSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotTrendlineSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotTrendlineSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
