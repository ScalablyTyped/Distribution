...
trait PlotRocSonificationTracksMappingTimeOptions extends StObject {
...
object PlotRocSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotRocSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRocSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRocSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
