...
trait PlotColumnrangeSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotColumnrangeSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotColumnrangeSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
