...
trait PlotStochasticConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotStochasticConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStochasticConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticConnectorsMarkerOptions]
  }
}
