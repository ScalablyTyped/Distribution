...
trait PlotSeriesSonificationTracksMappingPanOptions extends StObject {
...
object PlotSeriesSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotSeriesSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
