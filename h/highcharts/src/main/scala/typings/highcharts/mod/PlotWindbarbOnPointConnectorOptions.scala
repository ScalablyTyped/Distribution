...
trait PlotWindbarbOnPointConnectorOptions extends StObject {
...
object PlotWindbarbOnPointConnectorOptions {
  
  inline def apply(): PlotWindbarbOnPointConnectorOptions = {
