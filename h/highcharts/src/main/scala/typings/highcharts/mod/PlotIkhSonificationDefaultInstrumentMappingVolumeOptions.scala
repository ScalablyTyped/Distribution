...
trait PlotIkhSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotIkhSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotIkhSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
