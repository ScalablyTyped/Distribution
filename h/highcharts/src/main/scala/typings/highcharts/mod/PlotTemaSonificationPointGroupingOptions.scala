...
trait PlotTemaSonificationPointGroupingOptions extends StObject {
...
object PlotTemaSonificationPointGroupingOptions {
  
  inline def apply(): PlotTemaSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
