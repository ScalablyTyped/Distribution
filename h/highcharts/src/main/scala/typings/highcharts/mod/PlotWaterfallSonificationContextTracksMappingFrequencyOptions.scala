...
trait PlotWaterfallSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotWaterfallSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotWaterfallSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
