...
trait PlotRsiSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotRsiSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotRsiSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
