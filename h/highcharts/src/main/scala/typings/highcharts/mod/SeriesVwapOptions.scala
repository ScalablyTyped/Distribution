...
object SeriesVwapOptions {
  ...
  @scala.inline
  implicit class SeriesVwapOptionsOps[Self <: SeriesVwapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | vwap): Self = this.set("type", value.asInstanceOf[js.Any])
