...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesVwapOptions extends PlotVwapOptions {
  /**
    * Not available
    */
...
object SeriesVwapOptions {
  ...
  def apply(
    ...
    dataLabels: PlotVwapDataLabelsOptions | js.Array[PlotVwapDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotVwapDataSortingOptions = null,
