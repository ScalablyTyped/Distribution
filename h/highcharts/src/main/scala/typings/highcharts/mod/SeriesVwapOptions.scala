...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesVwapOptions
  extends StObject
     with PlotVwapOptions {
...
object SeriesVwapOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | vwap): SeriesVwapOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesVwapOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | vwap): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
