...
object SeriesVwapOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | vwap): SeriesVwapOptions = {
  ...
  @scala.inline
  implicit class SeriesVwapOptionsMutableBuilder[Self <: SeriesVwapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | vwap): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
