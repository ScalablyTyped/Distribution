...
trait PlotPpoSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotPpoSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotPpoSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
