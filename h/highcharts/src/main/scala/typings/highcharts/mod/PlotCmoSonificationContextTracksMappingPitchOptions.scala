...
trait PlotCmoSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
