...
trait PlotPyramid3dOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotPyramid3dSonificationOptions] = js.undefined
...
object PlotPyramid3dOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotPyramid3dSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
