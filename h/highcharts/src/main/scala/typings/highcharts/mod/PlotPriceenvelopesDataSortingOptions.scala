...
@js.native
trait PlotPriceenvelopesDataSortingOptions extends StObject {
...
object PlotPriceenvelopesDataSortingOptions {
  
  @scala.inline
  def apply(): PlotPriceenvelopesDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotPriceenvelopesDataSortingOptionsMutableBuilder[Self <: PlotPriceenvelopesDataSortingOptions] (val x: Self) extends AnyVal {
