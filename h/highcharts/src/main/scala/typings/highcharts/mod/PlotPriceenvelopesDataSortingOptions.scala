...
@js.native
trait PlotPriceenvelopesDataSortingOptions extends js.Object {
...
object PlotPriceenvelopesDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotPriceenvelopesDataSortingOptionsOps[Self <: PlotPriceenvelopesDataSortingOptions] (val x: Self) extends AnyVal {
