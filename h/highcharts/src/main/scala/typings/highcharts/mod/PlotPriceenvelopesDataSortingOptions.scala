...
object PlotPriceenvelopesDataSortingOptions {
  ...
  inline def apply(): PlotPriceenvelopesDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesDataSortingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesDataSortingOptions] (val x: Self) extends AnyVal {
