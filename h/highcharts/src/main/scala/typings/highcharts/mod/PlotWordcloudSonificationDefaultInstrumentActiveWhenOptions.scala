...
trait PlotWordcloudSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotWordcloudSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotWordcloudSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
