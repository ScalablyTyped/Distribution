...
trait PlotNatrSonificationTracksActiveWhenOptions extends StObject {
...
object PlotNatrSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotNatrSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
