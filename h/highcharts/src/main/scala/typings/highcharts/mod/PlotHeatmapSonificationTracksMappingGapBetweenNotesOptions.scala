...
trait PlotHeatmapSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
