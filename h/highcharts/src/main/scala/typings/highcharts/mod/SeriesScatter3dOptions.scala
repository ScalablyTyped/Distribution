...
object SeriesScatter3dOptions {
  ...
  inline def apply(`type`: String | scatter3d): SeriesScatter3dOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesScatter3dOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | scatter3d): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
