...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesScatter3dOptions
  extends StObject
     with PlotScatter3dOptions {
...
object SeriesScatter3dOptions {
  ...
  @scala.inline
  def apply(`type`: String | scatter3d): SeriesScatter3dOptions = {
  ...
  @scala.inline
  implicit class SeriesScatter3dOptionsMutableBuilder[Self <: SeriesScatter3dOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | scatter3d): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
