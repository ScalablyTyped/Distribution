...
trait PlotLineSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotLineSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotLineSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
