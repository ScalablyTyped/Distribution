...
trait PlotKlingerSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotKlingerSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
