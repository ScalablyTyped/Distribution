...
trait PlotBubbleClusterStatesHoverOptions extends StObject {
...
object PlotBubbleClusterStatesHoverOptions {
  
  inline def apply(): PlotBubbleClusterStatesHoverOptions = {
