...
object PlotColumnpyramidOptions {
  ...
  @scala.inline
  implicit class PlotColumnpyramidOptionsOps[Self <: PlotColumnpyramidOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotColumnpyramidAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotColumnpyramidDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotColumnpyramidDataLabelsOptions | js.Array[PlotColumnpyramidDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotColumnpyramidDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
