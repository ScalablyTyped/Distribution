...
trait PlotColumnpyramidOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotColumnpyramidAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotColumnpyramidDataSortingOptions] = js.native
...
object PlotColumnpyramidOptions {
  ...
  @scala.inline
  def apply(): PlotColumnpyramidOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnpyramidOptions]
  }
  
  @scala.inline
  implicit class PlotColumnpyramidOptionsMutableBuilder[Self <: PlotColumnpyramidOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotColumnpyramidAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotColumnpyramidDataLabelsOptions | js.Array[PlotColumnpyramidDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotColumnpyramidDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotColumnpyramidDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
