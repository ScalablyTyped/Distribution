...
trait PlotColumnpyramidOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotColumnpyramidSonificationOptions] = js.undefined
...
object PlotColumnpyramidOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnpyramidOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotColumnpyramidSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
