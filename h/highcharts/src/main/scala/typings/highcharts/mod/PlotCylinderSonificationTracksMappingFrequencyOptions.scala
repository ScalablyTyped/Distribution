...
trait PlotCylinderSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotCylinderSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotCylinderSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
