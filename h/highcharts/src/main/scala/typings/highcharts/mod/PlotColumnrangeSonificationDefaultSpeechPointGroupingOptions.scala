...
trait PlotColumnrangeSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotColumnrangeSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotColumnrangeSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
