...
trait PlotColumnSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotColumnSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotColumnSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
