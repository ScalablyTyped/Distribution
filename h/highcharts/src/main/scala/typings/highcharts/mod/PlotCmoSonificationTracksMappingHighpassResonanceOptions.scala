...
trait PlotCmoSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotCmoSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotCmoSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
