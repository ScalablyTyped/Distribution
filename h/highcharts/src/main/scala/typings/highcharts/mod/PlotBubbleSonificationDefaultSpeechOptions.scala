...
trait PlotBubbleSonificationDefaultSpeechOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotBubbleSonificationDefaultSpeechActiveWhenOptions] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[PlotBubbleSonificationDefaultSpeechMappingOptions] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for point grouping, specifically for
    * instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotBubbleSonificationDefaultSpeechPointGroupingOptions] = js.undefined
...
object PlotBubbleSonificationDefaultSpeechOptions {
  
  inline def apply(): PlotBubbleSonificationDefaultSpeechOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBubbleSonificationDefaultSpeechOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBubbleSonificationDefaultSpeechOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotBubbleSonificationDefaultSpeechActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotBubbleSonificationDefaultSpeechMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    
    inline def setMappingUndefined: Self = StObject.set(x, "mapping", js.undefined)
    
    inline def setPointGrouping(value: PlotBubbleSonificationDefaultSpeechPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
