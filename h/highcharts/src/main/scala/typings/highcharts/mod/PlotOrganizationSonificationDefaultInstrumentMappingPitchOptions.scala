...
trait PlotOrganizationSonificationDefaultInstrumentMappingPitchOptions extends StObject {
  ...
  /**
    * (Highcharts) Map pitches to a musical scale. The scale is defined as an
...
object PlotOrganizationSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotOrganizationSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOrganizationSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
