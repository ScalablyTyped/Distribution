...
trait PlotPriceenvelopesSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
