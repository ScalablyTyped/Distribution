...
trait PlotIkhSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotIkhSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
