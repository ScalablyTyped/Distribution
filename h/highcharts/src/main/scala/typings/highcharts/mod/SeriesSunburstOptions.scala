...
object SeriesSunburstOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | sunburst): SeriesSunburstOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesSunburstOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataVarargs(value: (Double | Null | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value*))
    ...
    inline def setType(value: String | sunburst): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
