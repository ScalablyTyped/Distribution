...
object SeriesSunburstOptions {
  ...
  @scala.inline
  implicit class SeriesSunburstOptionsOps[Self <: SeriesSunburstOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | sunburst): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
