...
trait SeriesSunburstOptions extends PlotSunburstOptions {
  ...
  /**
    ...
    * unknown sources.
    */
  var `type`: String | sunburst = js.native
...
object SeriesSunburstOptions {
  ...
  @scala.inline
  def apply(`type`: String | sunburst): SeriesSunburstOptions = {
  ...
  @scala.inline
  implicit class SeriesSunburstOptionsMutableBuilder[Self <: SeriesSunburstOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | sunburst): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
