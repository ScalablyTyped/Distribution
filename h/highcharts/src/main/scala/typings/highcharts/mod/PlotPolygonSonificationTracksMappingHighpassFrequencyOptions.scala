...
trait PlotPolygonSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotPolygonSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotPolygonSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPolygonSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPolygonSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
