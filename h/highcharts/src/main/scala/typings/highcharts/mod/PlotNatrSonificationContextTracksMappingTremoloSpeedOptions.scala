...
trait PlotNatrSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotNatrSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotNatrSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
