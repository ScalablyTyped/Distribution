...
trait PlotTreemapSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
