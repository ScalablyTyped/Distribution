...
trait PlotPpoSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotPpoSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotPpoSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
