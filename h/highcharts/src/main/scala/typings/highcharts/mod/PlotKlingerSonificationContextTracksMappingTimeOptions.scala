...
trait PlotKlingerSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotKlingerSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
