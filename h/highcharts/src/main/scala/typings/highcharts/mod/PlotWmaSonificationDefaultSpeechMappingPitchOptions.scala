...
trait PlotWmaSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotWmaSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotWmaSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWmaSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWmaSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
