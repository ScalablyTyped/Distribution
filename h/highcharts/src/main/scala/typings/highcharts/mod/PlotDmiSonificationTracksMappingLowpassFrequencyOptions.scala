...
trait PlotDmiSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotDmiSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
