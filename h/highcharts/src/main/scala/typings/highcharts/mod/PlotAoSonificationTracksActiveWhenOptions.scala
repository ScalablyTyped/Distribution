...
trait PlotAoSonificationTracksActiveWhenOptions extends StObject {
...
object PlotAoSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotAoSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
