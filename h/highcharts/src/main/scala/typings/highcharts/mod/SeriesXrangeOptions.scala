...
object SeriesXrangeOptions {
  ...
  extension [Self <: SeriesXrangeOptions](x: Self) {
    ...
    inline def setDataVarargs(value: XrangePointOptionsObject*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    inline def setType(value: String | xrange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
