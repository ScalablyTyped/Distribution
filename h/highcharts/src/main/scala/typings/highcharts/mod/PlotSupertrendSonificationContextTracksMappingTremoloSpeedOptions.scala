...
trait PlotSupertrendSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
