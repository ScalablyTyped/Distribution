...
trait PlotPpoSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotPpoSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotPpoSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
