...
trait PlotApoSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotApoSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotApoSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
