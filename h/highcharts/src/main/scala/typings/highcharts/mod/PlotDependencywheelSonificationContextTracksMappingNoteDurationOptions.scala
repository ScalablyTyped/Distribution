...
trait PlotDependencywheelSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
