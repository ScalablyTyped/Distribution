...
trait PlotTreemapSonificationTracksPointGroupingOptions extends StObject {
...
object PlotTreemapSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotTreemapSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
