...
trait PlotPyramidSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotPyramidSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
