...
trait ZAxisGridOptions extends StObject {
...
object ZAxisGridOptions {
  
  @scala.inline
  def apply(): ZAxisGridOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ZAxisGridOptions]
  }
  
  @scala.inline
  implicit class ZAxisGridOptionsMutableBuilder[Self <: ZAxisGridOptions] (val x: Self) extends AnyVal {
