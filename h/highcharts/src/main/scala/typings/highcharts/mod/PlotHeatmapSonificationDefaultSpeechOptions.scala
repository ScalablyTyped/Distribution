...
trait PlotHeatmapSonificationDefaultSpeechOptions extends StObject {
  ...
  /**
    ...
    */
  var activeWhen: js.UndefOr[js.Object | js.Function | PlotHeatmapSonificationDefaultSpeechActiveWhenOptions] = js.undefined
  
  /**
    * (Highcharts, Highmaps) The language to speak in for speech tracks, as an
    * IETF BCP 47 language tag.
    */
  var language: js.UndefOr[String] = js.undefined
  
  /**
    * (Highcharts, Highmaps) Mapping configuration for the speech/audio
    * parameters.
    *
    ...
    */
  var mapping: js.UndefOr[PlotHeatmapSonificationDefaultSpeechMappingOptions] = js.undefined
  
  /**
    * (Highcharts, Highmaps) Options for point grouping, specifically for
    * instrument tracks.
    */
  var pointGrouping: js.UndefOr[PlotHeatmapSonificationDefaultSpeechPointGroupingOptions] = js.undefined
  
  /**
    * (Highcharts, Highmaps) Name of the voice synthesis to prefer for speech
    * tracks.
    *
...
object PlotHeatmapSonificationDefaultSpeechOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultSpeechOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultSpeechOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultSpeechOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotHeatmapSonificationDefaultSpeechActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotHeatmapSonificationDefaultSpeechMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    
    inline def setMappingUndefined: Self = StObject.set(x, "mapping", js.undefined)
    
    inline def setPointGrouping(value: PlotHeatmapSonificationDefaultSpeechPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
