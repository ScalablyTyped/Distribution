...
trait PlotArcdiagramSonificationTracksPointGroupingOptions extends StObject {
...
object PlotArcdiagramSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
