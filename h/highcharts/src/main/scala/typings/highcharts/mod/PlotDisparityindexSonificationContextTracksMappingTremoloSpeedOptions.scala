...
trait PlotDisparityindexSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
