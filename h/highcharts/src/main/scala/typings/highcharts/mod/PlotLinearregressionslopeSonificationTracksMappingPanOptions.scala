...
trait PlotLinearregressionslopeSonificationTracksMappingPanOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
