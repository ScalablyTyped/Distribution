...
trait PlotBulletSonificationTracksActiveWhenOptions extends StObject {
...
object PlotBulletSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotBulletSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
