...
trait PlotZigzagSonificationTracksActiveWhenOptions extends StObject {
...
object PlotZigzagSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotZigzagSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotZigzagSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotZigzagSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
