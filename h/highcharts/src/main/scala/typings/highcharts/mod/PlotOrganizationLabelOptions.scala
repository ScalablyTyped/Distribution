...
trait PlotOrganizationLabelOptions extends js.Object {
  /**
...
object PlotOrganizationLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotOrganizationLabelOptions]
  }
}
