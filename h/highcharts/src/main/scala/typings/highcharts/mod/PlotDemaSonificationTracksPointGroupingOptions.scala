...
trait PlotDemaSonificationTracksPointGroupingOptions extends StObject {
...
object PlotDemaSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotDemaSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDemaSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
