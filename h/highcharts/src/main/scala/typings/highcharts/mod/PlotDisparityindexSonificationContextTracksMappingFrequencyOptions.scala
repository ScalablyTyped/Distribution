...
trait PlotDisparityindexSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
