...
trait PlotSunburstSonificationTracksMappingRateOptions extends StObject {
...
object PlotSunburstSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotSunburstSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSunburstSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSunburstSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
