...
trait PlotLinearregressionangleSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
