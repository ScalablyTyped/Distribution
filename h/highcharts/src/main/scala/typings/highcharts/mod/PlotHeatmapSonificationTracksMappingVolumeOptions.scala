...
trait PlotHeatmapSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
