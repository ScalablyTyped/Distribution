...
trait SeriesNetworkgraphDataLabelsOptionsObject extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotNetworkgraphDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var formatter: js.UndefOr[SeriesNetworkgraphDataLabelsFormatterCallbackFunction] = js.native
  ...
  /**
    ...
    * inside long words.
    */
  var style: js.UndefOr[CSSObject | PlotNetworkgraphDataLabelsStyleOptions] = js.native
