...
@js.native
trait SeriesNetworkgraphDataLabelsOptionsObject extends js.Object {
...
object SeriesNetworkgraphDataLabelsOptionsObject {
  ...
  implicit class SeriesNetworkgraphDataLabelsOptionsObjectOps[Self <: SeriesNetworkgraphDataLabelsOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotNetworkgraphDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFormatter(value: SeriesNetworkgraphDataLabelsFormatterCallbackFunction): Self = this.set("formatter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLinkFormat(value: String): Self = this.set("linkFormat", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLinkFormat: Self = this.set("linkFormat", js.undefined)
    
    @scala.inline
    def setLinkFormatter(value: SeriesNetworkgraphDataLabelsFormatterCallbackFunction): Self = this.set("linkFormatter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLinkFormatter: Self = this.set("linkFormatter", js.undefined)
    
    @scala.inline
    def setLinkTextPath(value: DataLabelsTextPathOptionsObject): Self = this.set("linkTextPath", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLinkTextPath: Self = this.set("linkTextPath", js.undefined)
    ...
    @scala.inline
    def setStyle(value: CSSObject | PlotNetworkgraphDataLabelsStyleOptions): Self = this.set("style", value.asInstanceOf[js.Any])
