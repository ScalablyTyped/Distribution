...
trait SeriesNetworkgraphDataLabelsOptionsObject extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotNetworkgraphDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var formatter: js.UndefOr[SeriesNetworkgraphDataLabelsFormatterCallbackFunction] = js.undefined
  ...
  /**
    ...
    * inside long words.
    */
  var style: js.UndefOr[CSSObject | PlotNetworkgraphDataLabelsStyleOptions] = js.undefined
...
object SeriesNetworkgraphDataLabelsOptionsObject {
  ...
  @scala.inline
  implicit class SeriesNetworkgraphDataLabelsOptionsObjectMutableBuilder[Self <: SeriesNetworkgraphDataLabelsOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotNetworkgraphDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFormatter(value: SeriesNetworkgraphDataLabelsFormatterCallbackFunction): Self = StObject.set(x, "formatter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLinkFormat(value: String): Self = StObject.set(x, "linkFormat", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLinkFormatUndefined: Self = StObject.set(x, "linkFormat", js.undefined)
    
    @scala.inline
    def setLinkFormatter(value: SeriesNetworkgraphDataLabelsFormatterCallbackFunction): Self = StObject.set(x, "linkFormatter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLinkFormatterUndefined: Self = StObject.set(x, "linkFormatter", js.undefined)
    
    @scala.inline
    def setLinkTextPath(value: DataLabelsTextPathOptionsObject): Self = StObject.set(x, "linkTextPath", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLinkTextPathUndefined: Self = StObject.set(x, "linkTextPath", js.undefined)
    ...
    @scala.inline
    def setStyle(value: CSSObject | PlotNetworkgraphDataLabelsStyleOptions): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
