...
object SeriesNetworkgraphDataLabelsOptionsObject {
  ...
  inline def apply(): SeriesNetworkgraphDataLabelsOptionsObject = {
  ...
  implicit open class MutableBuilder[Self <: SeriesNetworkgraphDataLabelsOptionsObject] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotNetworkgraphDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setFormatter(value: SeriesNetworkgraphDataLabelsFormatterCallbackFunction): Self = StObject.set(x, "formatter", value.asInstanceOf[js.Any])
    ...
    inline def setLinkFormatter(value: SeriesNetworkgraphDataLabelsFormatterCallbackFunction): Self = StObject.set(x, "linkFormatter", value.asInstanceOf[js.Any])
    
    inline def setLinkFormatterUndefined: Self = StObject.set(x, "linkFormatter", js.undefined)
    ...
    inline def setStyle(value: CSSObject | PlotNetworkgraphDataLabelsStyleOptions): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
