...
trait PlotKlingerSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotKlingerSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotKlingerSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
