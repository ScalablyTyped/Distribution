...
trait PlotDmiSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotDmiSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotDmiSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
