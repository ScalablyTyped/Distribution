...
trait PlotPieSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotPieSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotPieSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
