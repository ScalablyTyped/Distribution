...
trait PlotFlagsSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotFlagsSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotFlagsSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
