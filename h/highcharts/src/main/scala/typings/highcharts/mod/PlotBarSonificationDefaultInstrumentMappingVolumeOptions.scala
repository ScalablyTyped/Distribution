...
trait PlotBarSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotBarSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotBarSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
