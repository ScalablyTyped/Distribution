...
trait PlotSeriesAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotSeriesAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotSeriesAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotSeriesAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotSeriesAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesAccessibilityOptions]
  }
}
