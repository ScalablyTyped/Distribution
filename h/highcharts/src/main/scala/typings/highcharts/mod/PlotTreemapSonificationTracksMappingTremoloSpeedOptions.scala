...
trait PlotTreemapSonificationTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
