...
trait PlotStochasticSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotStochasticSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotStochasticSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStochasticSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
