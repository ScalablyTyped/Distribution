...
trait PlotDmiSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotDmiSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotDmiSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
