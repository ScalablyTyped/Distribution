...
trait PlotArearangeStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotArearangeStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotArearangeStatesHoverHaloOptions | Null] = js.undefined
  /**
...
object PlotArearangeStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotArearangeStatesHoverAnimationOptions = null,
  ...
  ): PlotArearangeStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeStatesHoverOptions]
  }
}
