...
trait PlotTemaSonificationTracksPointGroupingOptions extends StObject {
...
object PlotTemaSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotTemaSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
