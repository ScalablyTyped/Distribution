...
trait PlotAbandsSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotAbandsSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotAbandsSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
