...
trait PlotParetoSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
