...
trait PlotDependencywheelSonificationContextTracksOptions extends StObject {
  ...
  var activeWhen: js.UndefOr[
    js.Object | js.Function | PlotDependencywheelSonificationContextTracksActiveWhenOptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[PlotDependencywheelSonificationContextTracksMappingOptions] = js.undefined
  ...
  /**
    ...
    * tracks.
    */
  var pointGrouping: js.UndefOr[PlotDependencywheelSonificationContextTracksPointGroupingOptions] = js.undefined
...
object PlotDependencywheelSonificationContextTracksOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksOptions] (val x: Self) extends AnyVal {
    
    inline def setActiveWhen(value: js.Object | js.Function | PlotDependencywheelSonificationContextTracksActiveWhenOptions): Self = StObject.set(x, "activeWhen", value.asInstanceOf[js.Any])
    ...
    inline def setMapping(value: PlotDependencywheelSonificationContextTracksMappingOptions): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    ...
    inline def setPointGrouping(value: PlotDependencywheelSonificationContextTracksPointGroupingOptions): Self = StObject.set(x, "pointGrouping", value.asInstanceOf[js.Any])
