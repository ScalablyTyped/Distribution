...
trait PlotLinearregressionangleSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
