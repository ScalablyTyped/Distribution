...
trait PlotParetoSonificationContextTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
