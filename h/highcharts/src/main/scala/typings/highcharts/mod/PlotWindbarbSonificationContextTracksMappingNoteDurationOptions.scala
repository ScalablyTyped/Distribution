...
trait PlotWindbarbSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotWindbarbSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotWindbarbSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
