...
trait PlotHeatmapSonificationTracksMappingRateOptions extends StObject {
...
object PlotHeatmapSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotHeatmapSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
