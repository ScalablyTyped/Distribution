...
trait PlotPyramid3dSonificationTracksPointGroupingOptions extends StObject {
...
object PlotPyramid3dSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
