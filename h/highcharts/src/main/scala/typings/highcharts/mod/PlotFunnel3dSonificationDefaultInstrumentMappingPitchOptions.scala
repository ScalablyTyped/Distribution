...
trait PlotFunnel3dSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotFunnel3dSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotFunnel3dSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnel3dSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnel3dSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
