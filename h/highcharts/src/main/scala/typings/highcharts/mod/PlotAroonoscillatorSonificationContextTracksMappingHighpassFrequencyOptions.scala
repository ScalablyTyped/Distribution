...
trait PlotAroonoscillatorSonificationContextTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotAroonoscillatorSonificationContextTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotAroonoscillatorSonificationContextTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorSonificationContextTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonoscillatorSonificationContextTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
