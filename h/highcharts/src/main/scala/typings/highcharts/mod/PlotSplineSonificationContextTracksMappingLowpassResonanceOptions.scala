...
trait PlotSplineSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
