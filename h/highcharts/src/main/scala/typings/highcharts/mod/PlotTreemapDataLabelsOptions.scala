...
trait PlotTreemapDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotTreemapDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotTreemapDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotTreemapDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotTreemapDataLabelsOptionsMutableBuilder[Self <: PlotTreemapDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotTreemapDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
