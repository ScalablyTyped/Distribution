...
@js.native
trait PlotTreemapDataLabelsOptions extends js.Object {
...
object PlotTreemapDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotTreemapDataLabelsOptionsOps[Self <: PlotTreemapDataLabelsOptions] (val x: Self) extends AnyVal {
