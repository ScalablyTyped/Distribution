...
object PlotTreemapDataLabelsOptions {
  ...
  inline def apply(): PlotTreemapDataLabelsOptions = {
  ...
  extension [Self <: PlotTreemapDataLabelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotTreemapDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
