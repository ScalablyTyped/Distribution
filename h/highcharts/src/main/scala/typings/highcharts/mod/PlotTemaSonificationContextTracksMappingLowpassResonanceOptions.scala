...
trait PlotTemaSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotTemaSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotTemaSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTemaSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTemaSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
