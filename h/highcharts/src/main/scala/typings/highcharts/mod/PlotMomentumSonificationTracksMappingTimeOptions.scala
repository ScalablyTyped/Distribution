...
trait PlotMomentumSonificationTracksMappingTimeOptions extends StObject {
...
object PlotMomentumSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotMomentumSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMomentumSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
