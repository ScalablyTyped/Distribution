...
trait PlotFunnelSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotFunnelSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotFunnelSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFunnelSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFunnelSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
