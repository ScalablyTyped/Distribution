...
trait PlotVectorOptions extends StObject {
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotVectorJitterOptions] = js.undefined
...
object PlotVectorOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotVectorOptions] (val x: Self) extends AnyVal {
    ...
    inline def setJitter(value: PlotVectorJitterOptions): Self = StObject.set(x, "jitter", value.asInstanceOf[js.Any])
