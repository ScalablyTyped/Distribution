...
object PlotVectorOptions {
  ...
  @scala.inline
  implicit class PlotVectorOptionsOps[Self <: PlotVectorOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVectorAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCluster(value: PlotVectorClusterOptions): Self = this.set("cluster", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotVectorDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotVectorDataLabelsOptions | js.Array[PlotVectorDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotVectorDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRotationOrigin(value: OptionsRotationOriginValue): Self = this.set("rotationOrigin", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVectorLength(value: Double): Self = this.set("vectorLength", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteVectorLength: Self = this.set("vectorLength", js.undefined)
