...
trait PlotVectorOptions extends StObject {
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotVectorOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotVectorSonificationOptions] = js.undefined
...
object PlotVectorOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVectorOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataLabelsVarargs(value: PlotVectorDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    ...
    inline def setOnPoint(value: js.Object | PlotVectorOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setSonification(value: PlotVectorSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
