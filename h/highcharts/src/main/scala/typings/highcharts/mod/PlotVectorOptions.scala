...
trait PlotVectorOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotVectorAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var cluster: js.UndefOr[PlotVectorClusterOptions] = js.native
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotVectorDataLabelsOptions | js.Array[PlotVectorDataLabelsOptions]] = js.native
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotVectorDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var rotationOrigin: js.UndefOr[OptionsRotationOriginValue] = js.native
...
object PlotVectorOptions {
  ...
  @scala.inline
  def apply(): PlotVectorOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorOptions]
  }
  
  @scala.inline
  implicit class PlotVectorOptionsMutableBuilder[Self <: PlotVectorOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotVectorAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCluster(value: PlotVectorClusterOptions): Self = StObject.set(x, "cluster", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotVectorDataLabelsOptions | js.Array[PlotVectorDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotVectorDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotVectorDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRotationOrigin(value: OptionsRotationOriginValue): Self = StObject.set(x, "rotationOrigin", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVectorLength(value: Double): Self = StObject.set(x, "vectorLength", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVectorLengthUndefined: Self = StObject.set(x, "vectorLength", js.undefined)
