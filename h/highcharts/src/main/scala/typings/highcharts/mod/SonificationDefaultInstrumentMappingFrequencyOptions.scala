...
trait SonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object SonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): SonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
