...
trait PlotGaugeSonificationTracksActiveWhenOptions extends StObject {
...
object PlotGaugeSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotGaugeSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
