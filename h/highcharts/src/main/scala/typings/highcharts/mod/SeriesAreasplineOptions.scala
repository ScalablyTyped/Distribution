...
object SeriesAreasplineOptions {
  ...
  inline def apply(`type`: String | areaspline): SeriesAreasplineOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesAreasplineOptions] (val x: Self) extends AnyVal {
