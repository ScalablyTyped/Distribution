...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesAreasplineOptions extends PlotAreasplineOptions {
  /**
...
object SeriesAreasplineOptions {
  ...
  def apply(
    ...
    dataLabels: PlotAreasplineDataLabelsOptions | js.Array[PlotAreasplineDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotAreasplineDataSortingOptions = null,
