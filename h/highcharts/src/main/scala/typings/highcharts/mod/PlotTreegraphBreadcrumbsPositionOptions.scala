...
trait PlotTreegraphBreadcrumbsPositionOptions extends StObject {
...
object PlotTreegraphBreadcrumbsPositionOptions {
  
  inline def apply(): PlotTreegraphBreadcrumbsPositionOptions = {
