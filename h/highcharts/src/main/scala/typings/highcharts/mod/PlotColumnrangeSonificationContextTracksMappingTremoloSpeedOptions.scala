...
trait PlotColumnrangeSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotColumnrangeSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotColumnrangeSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
