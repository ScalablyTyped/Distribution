...
trait PlotKlingerSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotKlingerSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotKlingerSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKlingerSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKlingerSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
