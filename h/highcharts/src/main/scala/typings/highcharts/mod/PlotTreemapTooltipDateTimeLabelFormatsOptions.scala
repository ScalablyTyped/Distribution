...
trait PlotTreemapTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotTreemapTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotTreemapTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapTooltipDateTimeLabelFormatsOptions]
  }
}
