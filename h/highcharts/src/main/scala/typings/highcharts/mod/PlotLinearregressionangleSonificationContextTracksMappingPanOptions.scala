...
trait PlotLinearregressionangleSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotLinearregressionangleSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
