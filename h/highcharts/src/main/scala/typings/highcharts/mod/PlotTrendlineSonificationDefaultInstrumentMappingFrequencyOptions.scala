...
trait PlotTrendlineSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotTrendlineSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
