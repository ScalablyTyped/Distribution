...
trait PlotPictorialSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotPictorialSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotPictorialSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPictorialSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPictorialSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
