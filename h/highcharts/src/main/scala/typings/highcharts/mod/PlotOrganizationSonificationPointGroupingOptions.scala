...
trait PlotOrganizationSonificationPointGroupingOptions extends StObject {
...
object PlotOrganizationSonificationPointGroupingOptions {
  
  inline def apply(): PlotOrganizationSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOrganizationSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
