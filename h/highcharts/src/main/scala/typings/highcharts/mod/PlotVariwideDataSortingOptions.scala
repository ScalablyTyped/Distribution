...
object PlotVariwideDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotVariwideDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotVariwideDataSortingOptionsMutableBuilder[Self <: PlotVariwideDataSortingOptions] (val x: Self) extends AnyVal {
