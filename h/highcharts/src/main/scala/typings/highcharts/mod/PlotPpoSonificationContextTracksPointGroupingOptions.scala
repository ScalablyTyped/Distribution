...
trait PlotPpoSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotPpoSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotPpoSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
