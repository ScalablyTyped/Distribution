...
trait PlotPsarSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotPsarSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
