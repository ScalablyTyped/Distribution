...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesVectorOptions
  extends StObject
...
object SeriesVectorOptions {
  ...
  extension [Self <: SeriesVectorOptions](x: Self) {
    ...
    inline def setDataVarargs(value: ((js.Tuple4[Double | String, Double, Double, Double]) | PointOptionsObject)*): Self = StObject.set(x, "data", js.Array(value :_*))
