...
trait PlotAtrSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotAtrSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotAtrSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
