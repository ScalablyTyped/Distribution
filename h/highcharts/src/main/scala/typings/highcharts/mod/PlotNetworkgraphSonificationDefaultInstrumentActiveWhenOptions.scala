...
trait PlotNetworkgraphSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotNetworkgraphSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotNetworkgraphSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
