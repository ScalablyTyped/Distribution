...
trait PlotGaugeSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotGaugeSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotGaugeSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGaugeSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGaugeSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
