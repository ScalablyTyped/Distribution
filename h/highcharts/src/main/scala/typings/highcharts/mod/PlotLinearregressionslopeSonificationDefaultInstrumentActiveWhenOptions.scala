...
trait PlotLinearregressionslopeSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotLinearregressionslopeSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
