...
trait PlotSupertrendSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotSupertrendSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotSupertrendSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
