...
trait PlotTrixSonificationTracksMappingPanOptions extends StObject {
...
object PlotTrixSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
