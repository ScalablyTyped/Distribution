...
trait PlotTrixSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotTrixSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotTrixSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrixSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrixSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
