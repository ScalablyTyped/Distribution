...
trait ColorAxisPlotLinesOptions extends StObject {
  ...
  /**
    ...
    * `mousemove`.
    */
  var events: js.UndefOr[ColorAxisPlotLinesEventsOptions] = js.undefined
  ...
  /**
    ...
    */
  var label: js.UndefOr[ColorAxisPlotLinesLabelOptions] = js.undefined
...
object ColorAxisPlotLinesOptions {
  
  inline def apply(): ColorAxisPlotLinesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColorAxisPlotLinesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorAxisPlotLinesOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: ColorAxisPlotLinesEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setLabel(value: ColorAxisPlotLinesLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
