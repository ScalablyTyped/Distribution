...
trait PlotPieSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotPieSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotPieSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
