...
trait PlotArcdiagramSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
