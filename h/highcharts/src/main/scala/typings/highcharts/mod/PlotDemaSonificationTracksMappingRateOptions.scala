...
trait PlotDemaSonificationTracksMappingRateOptions extends StObject {
...
object PlotDemaSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotDemaSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDemaSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
