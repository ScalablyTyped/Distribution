...
trait PlotLinearregressioninterceptSonificationTracksMappingPitchOptions extends StObject {
...
object PlotLinearregressioninterceptSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotLinearregressioninterceptSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressioninterceptSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressioninterceptSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
