...
trait PlotScatter3dSonificationTracksMappingPitchOptions extends StObject {
...
object PlotScatter3dSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotScatter3dSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotScatter3dSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotScatter3dSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
