...
trait PlotIkhSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotIkhSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotIkhSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
