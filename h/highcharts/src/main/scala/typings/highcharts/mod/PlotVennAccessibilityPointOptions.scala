...
trait PlotVennAccessibilityPointOptions extends StObject {
...
object PlotVennAccessibilityPointOptions {
  
  inline def apply(): PlotVennAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVennAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVennAccessibilityPointOptions] (val x: Self) extends AnyVal {
