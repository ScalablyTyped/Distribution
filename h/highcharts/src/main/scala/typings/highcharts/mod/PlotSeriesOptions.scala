...
object PlotSeriesOptions {
  ...
  def apply(
    ...
    dataLabels: PlotSeriesDataLabelsOptions | js.Array[PlotSeriesDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotSeriesDataSortingOptions = null,
