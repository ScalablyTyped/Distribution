...
object PlotSeriesOptions {
  ...
  @scala.inline
  def apply(): PlotSeriesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesOptions]
  }
  
  @scala.inline
  implicit class PlotSeriesOptionsMutableBuilder[Self <: PlotSeriesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotSeriesAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotSeriesDataLabelsOptions | js.Array[PlotSeriesDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotSeriesDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotSeriesDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
