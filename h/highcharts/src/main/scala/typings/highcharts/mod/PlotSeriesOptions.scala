...
trait PlotSeriesOptions extends StObject {
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotSeriesDataLabelsOptions | js.Array[PlotSeriesDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotSeriesDataSortingOptions] = js.undefined
  ...
  /**
    ...
    * render for this series. Can be one of `lineMarker` or `rectangle`.
    */
  ...
  /**
    ...
    * line and scatter-like series. Properties like `fillColor`, `lineColor`
    * and `lineWidth` define the visual appearance of the markers. The `symbol`
  ...
  /**
    ...
    * moment.
    */
  var onPoint: js.UndefOr[js.Object | PlotSeriesOnPointOptions] = js.undefined
  ...
  /**
    ...
    * for a series.
    */
  var sonification: js.UndefOr[PlotSeriesSonificationOptions] = js.undefined
...
object PlotSeriesOptions {
  ...
  inline def apply(): PlotSeriesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSeriesOptions] (val x: Self) extends AnyVal {
    ...
    inline def setDataLabels(value: PlotSeriesDataLabelsOptions | js.Array[PlotSeriesDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotSeriesDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotSeriesDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotSeriesOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setSonification(value: PlotSeriesSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
