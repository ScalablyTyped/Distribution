...
object PlotSeriesOptions {
  ...
  @scala.inline
  implicit class PlotSeriesOptionsOps[Self <: PlotSeriesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotSeriesDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotSeriesDataLabelsOptions | js.Array[PlotSeriesDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotSeriesDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
