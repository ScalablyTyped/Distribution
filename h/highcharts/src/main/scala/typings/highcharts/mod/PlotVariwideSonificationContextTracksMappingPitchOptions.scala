...
trait PlotVariwideSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotVariwideSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotVariwideSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
