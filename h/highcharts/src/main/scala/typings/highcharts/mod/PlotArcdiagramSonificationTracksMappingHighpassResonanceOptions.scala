...
trait PlotArcdiagramSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotArcdiagramSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotArcdiagramSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
