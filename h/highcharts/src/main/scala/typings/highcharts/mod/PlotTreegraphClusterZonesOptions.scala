...
trait PlotTreegraphClusterZonesOptions extends StObject {
...
object PlotTreegraphClusterZonesOptions {
  
  inline def apply(): PlotTreegraphClusterZonesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreegraphClusterZonesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreegraphClusterZonesOptions] (val x: Self) extends AnyVal {
