...
trait PlotAtrSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotAtrSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotAtrSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
