...
trait PlotPyramidSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotPyramidSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotPyramidSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramidSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramidSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
