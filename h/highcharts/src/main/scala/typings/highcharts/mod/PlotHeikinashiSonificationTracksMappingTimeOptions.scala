...
trait PlotHeikinashiSonificationTracksMappingTimeOptions extends StObject {
...
object PlotHeikinashiSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotHeikinashiSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeikinashiSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeikinashiSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
