...
trait PlotDisparityindexSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotDisparityindexSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotDisparityindexSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
