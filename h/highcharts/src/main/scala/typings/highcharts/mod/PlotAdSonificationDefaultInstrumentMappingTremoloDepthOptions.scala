...
trait PlotAdSonificationDefaultInstrumentMappingTremoloDepthOptions extends StObject {
...
object PlotAdSonificationDefaultInstrumentMappingTremoloDepthOptions {
  
  inline def apply(): PlotAdSonificationDefaultInstrumentMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationDefaultInstrumentMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationDefaultInstrumentMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
