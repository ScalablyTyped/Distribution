...
trait PlotNetworkgraphSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotNetworkgraphSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotNetworkgraphSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNetworkgraphSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNetworkgraphSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
