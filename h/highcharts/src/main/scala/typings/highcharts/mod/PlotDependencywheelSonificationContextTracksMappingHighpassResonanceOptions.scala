...
trait PlotDependencywheelSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
