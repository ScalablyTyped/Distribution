...
trait PlotCandlestickSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
