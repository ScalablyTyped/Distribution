...
trait PlotCmoSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
