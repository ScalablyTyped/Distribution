...
trait PlotBarSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotBarSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotBarSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBarSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
