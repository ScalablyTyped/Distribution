...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesApoOptions extends PlotApoOptions {
  /**
    * Not available
    */
...
object SeriesApoOptions {
  ...
  def apply(
    ...
    dataLabels: PlotApoDataLabelsOptions | js.Array[PlotApoDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotApoDataSortingOptions = null,
