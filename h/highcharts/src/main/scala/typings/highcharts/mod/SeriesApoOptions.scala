...
object SeriesApoOptions {
  ...
  @scala.inline
  implicit class SeriesApoOptionsOps[Self <: SeriesApoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | apo): Self = this.set("type", value.asInstanceOf[js.Any])
