...
trait SeriesApoOptions extends PlotApoOptions {
...
object SeriesApoOptions {
  ...
  @scala.inline
  def apply(`type`: String | apo): SeriesApoOptions = {
  ...
  @scala.inline
  implicit class SeriesApoOptionsMutableBuilder[Self <: SeriesApoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | apo): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
