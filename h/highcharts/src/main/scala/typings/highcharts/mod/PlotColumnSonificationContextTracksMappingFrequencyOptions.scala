...
trait PlotColumnSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotColumnSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotColumnSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
