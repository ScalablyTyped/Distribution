...
trait PlotPcSonificationTracksMappingTimeOptions extends StObject {
...
object PlotPcSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotPcSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPcSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPcSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
