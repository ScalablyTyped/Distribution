...
trait PlotFlagsAccessibilityPointOptions extends StObject {
...
object PlotFlagsAccessibilityPointOptions {
  
  inline def apply(): PlotFlagsAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsAccessibilityPointOptions] (val x: Self) extends AnyVal {
