...
trait SeriesBoxplotDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesBoxplotDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesBoxplotDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesBoxplotDataDragDropDragHandleOptions]
  }
}
