...
trait SeriesAreaDataEventsOptions extends js.Object {
  /**
...
object SeriesAreaDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesAreaDataEventsOptions]
  }
}
