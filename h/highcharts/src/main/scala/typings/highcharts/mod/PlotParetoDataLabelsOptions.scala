...
trait PlotParetoDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotParetoDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotParetoDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotParetoDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotParetoDataLabelsOptionsMutableBuilder[Self <: PlotParetoDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotParetoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
