...
@js.native
trait PlotParetoDataLabelsOptions extends js.Object {
...
object PlotParetoDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotParetoDataLabelsOptionsOps[Self <: PlotParetoDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotParetoDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
