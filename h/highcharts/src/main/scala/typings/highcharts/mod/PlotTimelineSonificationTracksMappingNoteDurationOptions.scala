...
trait PlotTimelineSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotTimelineSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotTimelineSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTimelineSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTimelineSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
