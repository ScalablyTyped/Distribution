...
trait PlotAreaSonificationTracksMappingPitchOptions extends StObject {
...
object PlotAreaSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotAreaSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAreaSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAreaSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
