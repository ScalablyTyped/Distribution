...
trait PlotVariwideSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
