...
trait PlotPyramid3dSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotPyramid3dSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotPyramid3dSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
