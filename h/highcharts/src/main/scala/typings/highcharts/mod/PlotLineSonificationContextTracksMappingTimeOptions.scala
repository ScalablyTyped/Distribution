...
trait PlotLineSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotLineSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotLineSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
