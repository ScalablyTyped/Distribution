...
trait PlotPivotpointsSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
