...
trait PlotBulletSonificationTracksPointGroupingOptions extends StObject {
...
object PlotBulletSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotBulletSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
