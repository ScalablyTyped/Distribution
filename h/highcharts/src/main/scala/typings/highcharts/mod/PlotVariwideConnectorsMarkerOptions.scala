...
trait PlotVariwideConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotVariwideConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVariwideConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVariwideConnectorsMarkerOptions]
  }
}
