...
trait PlotPivotpointsSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
