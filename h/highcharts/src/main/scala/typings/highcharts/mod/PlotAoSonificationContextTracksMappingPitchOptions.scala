...
trait PlotAoSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotAoSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotAoSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAoSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAoSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
