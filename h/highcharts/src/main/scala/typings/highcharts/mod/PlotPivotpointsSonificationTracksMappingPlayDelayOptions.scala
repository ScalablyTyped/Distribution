...
trait PlotPivotpointsSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
