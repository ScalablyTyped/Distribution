...
trait PlotIkhSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotIkhSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotIkhSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotIkhSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotIkhSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
