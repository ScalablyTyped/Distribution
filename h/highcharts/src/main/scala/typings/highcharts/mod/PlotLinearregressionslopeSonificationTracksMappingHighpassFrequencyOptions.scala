...
trait PlotLinearregressionslopeSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotLinearregressionslopeSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotLinearregressionslopeSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionslopeSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionslopeSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
