...
trait PlotKeltnerchannelsAccessibilityPointOptions extends StObject {
...
object PlotKeltnerchannelsAccessibilityPointOptions {
  
  inline def apply(): PlotKeltnerchannelsAccessibilityPointOptions = {
