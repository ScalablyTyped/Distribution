...
trait PlotBoxplotAccessibilityPointOptions extends StObject {
...
object PlotBoxplotAccessibilityPointOptions {
  
  inline def apply(): PlotBoxplotAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBoxplotAccessibilityPointOptions] (val x: Self) extends AnyVal {
