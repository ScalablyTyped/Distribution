...
trait SonificationGlobalContextTracksMappingFrequencyOptions extends StObject {
...
object SonificationGlobalContextTracksMappingFrequencyOptions {
  
  inline def apply(): SonificationGlobalContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
