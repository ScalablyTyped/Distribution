...
trait PlotMappointSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotMappointSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotMappointSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMappointSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMappointSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
