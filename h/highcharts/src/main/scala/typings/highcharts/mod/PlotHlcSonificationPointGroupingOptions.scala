...
trait PlotHlcSonificationPointGroupingOptions extends StObject {
...
object PlotHlcSonificationPointGroupingOptions {
  
  inline def apply(): PlotHlcSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHlcSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
