...
trait PlotSlowstochasticSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotSlowstochasticSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotSlowstochasticSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSlowstochasticSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSlowstochasticSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
