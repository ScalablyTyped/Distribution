...
trait PlotTreemapSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotTreemapSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotTreemapSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
