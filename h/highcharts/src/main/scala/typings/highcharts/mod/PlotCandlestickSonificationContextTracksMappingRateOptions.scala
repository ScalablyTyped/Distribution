...
trait PlotCandlestickSonificationContextTracksMappingRateOptions extends StObject {
...
object PlotCandlestickSonificationContextTracksMappingRateOptions {
  
  inline def apply(): PlotCandlestickSonificationContextTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCandlestickSonificationContextTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCandlestickSonificationContextTracksMappingRateOptions] (val x: Self) extends AnyVal {
