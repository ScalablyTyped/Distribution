...
trait SonificationGlobalContextTracksActiveWhenOptions extends StObject {
...
object SonificationGlobalContextTracksActiveWhenOptions {
  
  inline def apply(): SonificationGlobalContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SonificationGlobalContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SonificationGlobalContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
