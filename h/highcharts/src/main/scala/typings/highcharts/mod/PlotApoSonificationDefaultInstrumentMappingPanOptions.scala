...
trait PlotApoSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotApoSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotApoSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
