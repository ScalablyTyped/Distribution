...
trait PlotSplineSonificationContextTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotSplineSonificationContextTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotSplineSonificationContextTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationContextTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationContextTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
