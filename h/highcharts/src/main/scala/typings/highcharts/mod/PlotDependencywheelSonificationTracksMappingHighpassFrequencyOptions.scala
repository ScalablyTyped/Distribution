...
trait PlotDependencywheelSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotDependencywheelSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotDependencywheelSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
