...
trait PlotOhlcTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotOhlcTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotOhlcTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotOhlcTooltipDateTimeLabelFormatsOptions]
  }
}
