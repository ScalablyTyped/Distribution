...
trait PlotPsarSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotPsarSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotPsarSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPsarSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPsarSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
