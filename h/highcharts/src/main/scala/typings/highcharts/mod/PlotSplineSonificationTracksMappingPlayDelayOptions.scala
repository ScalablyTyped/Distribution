...
trait PlotSplineSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotSplineSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
