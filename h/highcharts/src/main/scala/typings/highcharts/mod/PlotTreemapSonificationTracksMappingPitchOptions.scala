...
trait PlotTreemapSonificationTracksMappingPitchOptions extends StObject {
...
object PlotTreemapSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotTreemapSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTreemapSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTreemapSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
