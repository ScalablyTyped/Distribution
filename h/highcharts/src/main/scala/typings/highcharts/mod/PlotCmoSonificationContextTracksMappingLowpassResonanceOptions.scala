...
trait PlotCmoSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
