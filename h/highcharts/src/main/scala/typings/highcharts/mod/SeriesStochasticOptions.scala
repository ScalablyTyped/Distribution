...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesStochasticOptions extends PlotStochasticOptions {
  /**
    * Not available
    */
...
object SeriesStochasticOptions {
  ...
  def apply(
    ...
    dataLabels: PlotStochasticDataLabelsOptions | js.Array[PlotStochasticDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotStochasticDataSortingOptions = null,
