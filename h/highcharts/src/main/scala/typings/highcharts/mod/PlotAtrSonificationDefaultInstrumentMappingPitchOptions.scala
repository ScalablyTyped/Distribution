...
trait PlotAtrSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotAtrSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotAtrSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAtrSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAtrSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
