...
trait PlotSupertrendSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
