...
trait PlotGeoheatmapSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotGeoheatmapSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotGeoheatmapSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGeoheatmapSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGeoheatmapSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
