...
@js.native
trait PlotStochasticDataSortingOptions extends StObject {
...
object PlotStochasticDataSortingOptions {
  
  @scala.inline
  def apply(): PlotStochasticDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStochasticDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotStochasticDataSortingOptionsMutableBuilder[Self <: PlotStochasticDataSortingOptions] (val x: Self) extends AnyVal {
