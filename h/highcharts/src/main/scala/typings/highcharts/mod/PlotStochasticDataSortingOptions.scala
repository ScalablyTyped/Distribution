...
@js.native
trait PlotStochasticDataSortingOptions extends js.Object {
  /**
...
object PlotStochasticDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotStochasticDataSortingOptionsOps[Self <: PlotStochasticDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
