...
trait PlotSplineSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotSplineSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotSplineSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSplineSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSplineSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
