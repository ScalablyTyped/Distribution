...
object SeriesAreaOptions {
  ...
  @scala.inline
  implicit class SeriesAreaOptionsOps[Self <: SeriesAreaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | area): Self = this.set("type", value.asInstanceOf[js.Any])
