...
object SeriesAreaOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | area, useOhlcData: Unit): SeriesAreaOptions = {
  ...
  @scala.inline
  implicit class SeriesAreaOptionsMutableBuilder[Self <: SeriesAreaOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | area): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
