...
- typings.highcharts.mod.SeriesOptions because var conflicts: zIndex. Inlined id, index, legendIndex, mapData, name, stack, `type`, xAxis, yAxis */ trait SeriesAreaOptions
  extends StObject
     with PlotAreaOptions {
...
object SeriesAreaOptions {
  ...
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | area, useOhlcData: Unit): SeriesAreaOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesAreaOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | area): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
