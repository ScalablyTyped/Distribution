...
trait PlotMapbubbleDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotMapbubbleDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapbubbleDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleDragDropGuideBoxDefaultOptions]
  }
}
