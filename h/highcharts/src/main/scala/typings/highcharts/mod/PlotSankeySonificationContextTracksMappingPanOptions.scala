...
trait PlotSankeySonificationContextTracksMappingPanOptions extends StObject {
...
object PlotSankeySonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotSankeySonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSankeySonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSankeySonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
