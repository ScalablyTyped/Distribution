...
trait PlotZigzagStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotZigzagStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotZigzagStatesSelectHaloOptions | Null] = js.undefined
  /**
...
object PlotZigzagStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotZigzagStatesSelectAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotZigzagStatesSelectOptions]
  }
}
