...
trait PlotNatrSonificationTracksMappingPitchOptions extends StObject {
...
object PlotNatrSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotNatrSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotNatrSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotNatrSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
