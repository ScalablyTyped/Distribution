...
trait PlotDpoAccessibilityPointOptions extends StObject {
...
object PlotDpoAccessibilityPointOptions {
  
  inline def apply(): PlotDpoAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDpoAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDpoAccessibilityPointOptions] (val x: Self) extends AnyVal {
