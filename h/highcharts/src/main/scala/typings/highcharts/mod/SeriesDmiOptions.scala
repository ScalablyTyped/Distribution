...
import typings.highcharts.highchartsStrings.dmi
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesDmiOptions
  extends StObject
     with PlotDmiOptions {
...
object SeriesDmiOptions {
  ...
  inline def apply(`type`: String | dmi): SeriesDmiOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesDmiOptions] (val x: Self) extends AnyVal {
