...
trait PlotDumbbellSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotDumbbellSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotDumbbellSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDumbbellSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDumbbellSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
