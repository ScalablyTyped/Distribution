...
@js.native
trait PlotLinearregressioninterceptParamsOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptParamsOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressioninterceptParamsOptionsOps[Self <: PlotLinearregressioninterceptParamsOptions] (val x: Self) extends AnyVal {
    @scala.inline
