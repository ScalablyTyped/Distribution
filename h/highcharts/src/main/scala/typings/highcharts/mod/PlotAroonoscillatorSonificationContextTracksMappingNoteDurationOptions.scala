...
trait PlotAroonoscillatorSonificationContextTracksMappingNoteDurationOptions extends StObject {
...
object PlotAroonoscillatorSonificationContextTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotAroonoscillatorSonificationContextTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonoscillatorSonificationContextTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonoscillatorSonificationContextTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
