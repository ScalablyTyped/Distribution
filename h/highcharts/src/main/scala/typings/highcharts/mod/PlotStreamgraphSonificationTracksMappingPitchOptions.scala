...
trait PlotStreamgraphSonificationTracksMappingPitchOptions extends StObject {
...
object PlotStreamgraphSonificationTracksMappingPitchOptions {
  
  inline def apply(): PlotStreamgraphSonificationTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationTracksMappingPitchOptions] (val x: Self) extends AnyVal {
