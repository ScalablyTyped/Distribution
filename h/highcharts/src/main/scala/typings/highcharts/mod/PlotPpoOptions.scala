...
trait PlotPpoOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotPpoSonificationOptions] = js.undefined
...
object PlotPpoOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotPpoSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
