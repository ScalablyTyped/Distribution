...
object PlotPpoOptions {
  ...
  @scala.inline
  def apply(): PlotPpoOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoOptions]
  }
  
  @scala.inline
  implicit class PlotPpoOptionsMutableBuilder[Self <: PlotPpoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotPpoAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabels(value: PlotPpoDataLabelsOptions | js.Array[PlotPpoDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotPpoDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotPpoDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotPpoParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
