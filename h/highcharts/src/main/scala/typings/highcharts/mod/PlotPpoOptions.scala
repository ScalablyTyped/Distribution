...
trait PlotPpoOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotPpoAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    * (see example).
    */
  var dataLabels: js.UndefOr[PlotPpoDataLabelsOptions | js.Array[PlotPpoDataLabelsOptions]] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotPpoDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotPpoOnPointOptions] = js.undefined
  ...
  /**
    ...
    * series points.
    */
  var params: js.UndefOr[PlotPpoParamsOptions] = js.undefined
...
object PlotPpoOptions {
  
  inline def apply(): PlotPpoOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoOptions]
  }
  
  extension [Self <: PlotPpoOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotPpoAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabels(value: PlotPpoDataLabelsOptions | js.Array[PlotPpoDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotPpoDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotPpoDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotPpoOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotPpoParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
