...
trait PlotPivotpointsSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
