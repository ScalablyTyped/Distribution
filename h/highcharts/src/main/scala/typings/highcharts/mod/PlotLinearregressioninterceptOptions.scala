...
object PlotLinearregressioninterceptOptions {
  ...
  @scala.inline
  implicit class PlotLinearregressioninterceptOptionsMutableBuilder[Self <: PlotLinearregressioninterceptOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotLinearregressioninterceptAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotLinearregressioninterceptDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotLinearregressioninterceptDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotLinearregressioninterceptParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
