...
trait PlotLinearregressioninterceptOptions extends StObject {
  ...
  var animation: js.UndefOr[
    Boolean | PlotLinearregressioninterceptAnimationOptions | PartialAnimationOptionsOb
  ] = js.undefined
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotLinearregressioninterceptDataSortingOptions] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotLinearregressioninterceptOnPointOptions] = js.undefined
...
object PlotLinearregressioninterceptOptions {
  ...
  inline def apply(): PlotLinearregressioninterceptOptions = {
  ...
  extension [Self <: PlotLinearregressioninterceptOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotLinearregressioninterceptAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setDataLabelsVarargs(value: PlotLinearregressioninterceptDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotLinearregressioninterceptDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotLinearregressioninterceptOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotLinearregressioninterceptParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
