...
trait PlotWordcloudSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotWordcloudSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotWordcloudSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWordcloudSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWordcloudSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
