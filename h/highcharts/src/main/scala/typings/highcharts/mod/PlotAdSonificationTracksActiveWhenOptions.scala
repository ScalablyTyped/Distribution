...
trait PlotAdSonificationTracksActiveWhenOptions extends StObject {
...
object PlotAdSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotAdSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
