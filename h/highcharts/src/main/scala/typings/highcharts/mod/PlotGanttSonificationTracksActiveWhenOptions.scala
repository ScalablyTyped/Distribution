...
trait PlotGanttSonificationTracksActiveWhenOptions extends StObject {
...
object PlotGanttSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotGanttSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotGanttSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotGanttSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
