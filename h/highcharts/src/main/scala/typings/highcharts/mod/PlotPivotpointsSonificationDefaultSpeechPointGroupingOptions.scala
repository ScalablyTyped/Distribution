...
trait PlotPivotpointsSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotPivotpointsSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotPivotpointsSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
