...
trait PlotObvSonificationTracksMappingRateOptions extends StObject {
...
object PlotObvSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotObvSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotObvSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotObvSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
