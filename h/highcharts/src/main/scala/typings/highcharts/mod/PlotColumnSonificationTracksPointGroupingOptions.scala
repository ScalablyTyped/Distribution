...
trait PlotColumnSonificationTracksPointGroupingOptions extends StObject {
...
object PlotColumnSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotColumnSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
