...
trait PlotCciSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotCciSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotCciSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
