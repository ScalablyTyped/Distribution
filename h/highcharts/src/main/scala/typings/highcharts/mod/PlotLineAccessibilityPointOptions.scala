...
trait PlotLineAccessibilityPointOptions extends StObject {
...
object PlotLineAccessibilityPointOptions {
  
  inline def apply(): PlotLineAccessibilityPointOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineAccessibilityPointOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineAccessibilityPointOptions] (val x: Self) extends AnyVal {
