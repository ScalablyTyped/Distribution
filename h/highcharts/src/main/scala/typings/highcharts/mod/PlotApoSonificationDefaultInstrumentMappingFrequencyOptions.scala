...
trait PlotApoSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotApoSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotApoSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
