...
trait PlotAdSonificationTracksMappingRateOptions extends StObject {
...
object PlotAdSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotAdSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
