...
trait PlotVariablepieSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotVariablepieSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotVariablepieSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
