...
object SeriesCciOptions {
  ...
  @scala.inline
  implicit class SeriesCciOptionsOps[Self <: SeriesCciOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: String | cci): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
