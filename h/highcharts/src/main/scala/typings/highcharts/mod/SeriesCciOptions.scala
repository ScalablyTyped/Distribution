...
object SeriesCciOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | cci): SeriesCciOptions = {
  ...
  @scala.inline
  implicit class SeriesCciOptionsMutableBuilder[Self <: SeriesCciOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | cci): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
