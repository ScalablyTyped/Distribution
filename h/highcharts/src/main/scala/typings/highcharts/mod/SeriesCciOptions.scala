...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesCciOptions extends PlotCciOptions {
  /**
    * Not available
    */
...
object SeriesCciOptions {
  ...
  def apply(
    ...
    dataLabels: PlotCciDataLabelsOptions | js.Array[PlotCciDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotCciDataSortingOptions = null,
