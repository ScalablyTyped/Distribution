...
import typings.highcharts.highchartsStrings.cci
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesCciOptions
  extends StObject
     with PlotCciOptions {
...
object SeriesCciOptions {
  
  inline def apply(dataParser: Unit, dataURL: Unit, `type`: String | cci): SeriesCciOptions = {
    val __obj = js.Dynamic.literal(dataParser = dataParser.asInstanceOf[js.Any], dataURL = dataURL.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SeriesCciOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesCciOptions] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: String | cci): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
