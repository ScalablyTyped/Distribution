...
trait PlotApoSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
