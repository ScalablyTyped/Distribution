...
@js.native
trait SeriesOrganizationDataLabelsOptionsObject extends js.Object {
...
object SeriesOrganizationDataLabelsOptionsObject {
  ...
  @scala.inline
  implicit class SeriesOrganizationDataLabelsOptionsObjectOps[Self <: SeriesOrganizationDataLabelsOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotOrganizationDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFormatter(value: SeriesSankeyDataLabelsFormatterCallbackFunction): Self = this.set("formatter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNodeFormatter(value: SeriesSankeyDataLabelsFormatterCallbackFunction): Self = this.set("nodeFormatter", value.asInstanceOf[js.Any])
