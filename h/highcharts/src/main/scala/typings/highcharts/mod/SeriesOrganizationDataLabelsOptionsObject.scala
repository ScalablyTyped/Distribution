...
@js.native
trait SeriesOrganizationDataLabelsOptionsObject extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotOrganizationDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var formatter: js.UndefOr[SeriesSankeyDataLabelsFormatterCallbackFunction] = js.native
...
object SeriesOrganizationDataLabelsOptionsObject {
  ...
  @scala.inline
  def apply(): SeriesOrganizationDataLabelsOptionsObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesOrganizationDataLabelsOptionsObject]
  }
  
  @scala.inline
  implicit class SeriesOrganizationDataLabelsOptionsObjectMutableBuilder[Self <: SeriesOrganizationDataLabelsOptionsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotOrganizationDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFormatter(value: SeriesSankeyDataLabelsFormatterCallbackFunction): Self = StObject.set(x, "formatter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNodeFormatter(value: SeriesSankeyDataLabelsFormatterCallbackFunction): Self = StObject.set(x, "nodeFormatter", value.asInstanceOf[js.Any])
