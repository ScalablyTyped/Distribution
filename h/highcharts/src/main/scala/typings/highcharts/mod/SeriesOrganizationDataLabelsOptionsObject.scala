...
object SeriesOrganizationDataLabelsOptionsObject {
  ...
  inline def apply(): SeriesOrganizationDataLabelsOptionsObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesOrganizationDataLabelsOptionsObject]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesOrganizationDataLabelsOptionsObject] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotOrganizationDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
