...
trait PlotPieSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotPieSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotPieSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPieSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPieSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
