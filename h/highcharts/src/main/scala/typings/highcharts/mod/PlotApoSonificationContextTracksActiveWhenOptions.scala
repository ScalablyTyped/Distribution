...
trait PlotApoSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotApoSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotApoSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
