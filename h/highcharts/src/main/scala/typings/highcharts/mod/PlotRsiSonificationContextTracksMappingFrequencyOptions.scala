...
trait PlotRsiSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotRsiSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotRsiSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotRsiSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotRsiSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
