...
object PlotAroonDataLabelsOptions {
  ...
  inline def apply(): PlotAroonDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAroonDataLabelsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAroonDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setAnimation(value: Boolean | PlotAroonDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
