...
@js.native
trait PlotAroonDataLabelsOptions extends js.Object {
...
object PlotAroonDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotAroonDataLabelsOptionsOps[Self <: PlotAroonDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotAroonDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
