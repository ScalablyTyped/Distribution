...
trait PlotParetoSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotParetoSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotParetoSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
