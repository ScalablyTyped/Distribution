...
trait PlotWilliamsrSonificationDefaultInstrumentPointGroupingOptions extends StObject {
...
object PlotWilliamsrSonificationDefaultInstrumentPointGroupingOptions {
  
  inline def apply(): PlotWilliamsrSonificationDefaultInstrumentPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWilliamsrSonificationDefaultInstrumentPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWilliamsrSonificationDefaultInstrumentPointGroupingOptions] (val x: Self) extends AnyVal {
