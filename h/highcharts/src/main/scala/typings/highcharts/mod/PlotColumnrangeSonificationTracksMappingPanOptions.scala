...
trait PlotColumnrangeSonificationTracksMappingPanOptions extends StObject {
...
object PlotColumnrangeSonificationTracksMappingPanOptions {
  
  inline def apply(): PlotColumnrangeSonificationTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotColumnrangeSonificationTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotColumnrangeSonificationTracksMappingPanOptions] (val x: Self) extends AnyVal {
