...
trait PlotAbandsSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotAbandsSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotAbandsSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAbandsSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAbandsSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
