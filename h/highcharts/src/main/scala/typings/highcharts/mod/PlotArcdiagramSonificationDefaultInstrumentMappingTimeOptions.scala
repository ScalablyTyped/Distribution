...
trait PlotArcdiagramSonificationDefaultInstrumentMappingTimeOptions extends StObject {
...
object PlotArcdiagramSonificationDefaultInstrumentMappingTimeOptions {
  
  inline def apply(): PlotArcdiagramSonificationDefaultInstrumentMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArcdiagramSonificationDefaultInstrumentMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArcdiagramSonificationDefaultInstrumentMappingTimeOptions] (val x: Self) extends AnyVal {
