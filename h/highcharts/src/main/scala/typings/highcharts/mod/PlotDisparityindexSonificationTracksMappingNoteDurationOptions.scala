...
trait PlotDisparityindexSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotDisparityindexSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
