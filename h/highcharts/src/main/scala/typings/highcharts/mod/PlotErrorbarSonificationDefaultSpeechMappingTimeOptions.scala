...
trait PlotErrorbarSonificationDefaultSpeechMappingTimeOptions extends StObject {
...
object PlotErrorbarSonificationDefaultSpeechMappingTimeOptions {
  
  inline def apply(): PlotErrorbarSonificationDefaultSpeechMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotErrorbarSonificationDefaultSpeechMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotErrorbarSonificationDefaultSpeechMappingTimeOptions] (val x: Self) extends AnyVal {
