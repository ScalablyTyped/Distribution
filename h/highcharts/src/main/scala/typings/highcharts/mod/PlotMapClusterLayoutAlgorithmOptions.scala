...
trait PlotMapClusterLayoutAlgorithmOptions extends StObject {
...
object PlotMapClusterLayoutAlgorithmOptions {
  
  inline def apply(): PlotMapClusterLayoutAlgorithmOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapClusterLayoutAlgorithmOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapClusterLayoutAlgorithmOptions] (val x: Self) extends AnyVal {
