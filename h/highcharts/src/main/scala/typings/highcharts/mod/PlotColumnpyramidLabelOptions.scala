...
trait PlotColumnpyramidLabelOptions extends js.Object {
  /**
...
object PlotColumnpyramidLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotColumnpyramidLabelOptions]
  }
}
