...
trait SeriesTilemapOptions extends PlotTilemapOptions {
...
object SeriesTilemapOptions {
  ...
  implicit class SeriesTilemapOptionsMutableBuilder[Self <: SeriesTilemapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMapData(value: js.Any | js.Array[SeriesMapDataOptions] | scala.Nothing): Self = StObject.set(x, "mapData", value.asInstanceOf[js.Any])
