...
object SeriesTilemapOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | tilemap): SeriesTilemapOptions = {
  ...
  @scala.inline
  implicit class SeriesTilemapOptionsMutableBuilder[Self <: SeriesTilemapOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMapData(value: js.Any | js.Array[SeriesMapDataOptions] | Unit): Self = StObject.set(x, "mapData", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setType(value: String | tilemap): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
