...
@js.native
trait PlotBoxplotDataSortingOptions extends js.Object {
  /**
...
object PlotBoxplotDataSortingOptions {
  ...
  @scala.inline
  implicit class PlotBoxplotDataSortingOptionsOps[Self <: PlotBoxplotDataSortingOptions] (val x: Self) extends AnyVal {
    @scala.inline
