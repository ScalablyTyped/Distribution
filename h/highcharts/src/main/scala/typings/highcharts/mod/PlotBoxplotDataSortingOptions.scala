...
@js.native
trait PlotBoxplotDataSortingOptions extends StObject {
...
object PlotBoxplotDataSortingOptions {
  
  @scala.inline
  def apply(): PlotBoxplotDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBoxplotDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotBoxplotDataSortingOptionsMutableBuilder[Self <: PlotBoxplotDataSortingOptions] (val x: Self) extends AnyVal {
