...
trait PlotVariwideSonificationTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
