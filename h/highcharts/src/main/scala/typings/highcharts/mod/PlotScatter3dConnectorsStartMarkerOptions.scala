...
trait PlotScatter3dConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotScatter3dConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatter3dConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dConnectorsStartMarkerOptions]
  }
}
