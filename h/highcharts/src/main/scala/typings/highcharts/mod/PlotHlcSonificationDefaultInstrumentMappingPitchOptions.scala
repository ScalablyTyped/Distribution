...
trait PlotHlcSonificationDefaultInstrumentMappingPitchOptions extends StObject {
...
object PlotHlcSonificationDefaultInstrumentMappingPitchOptions {
  
  inline def apply(): PlotHlcSonificationDefaultInstrumentMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHlcSonificationDefaultInstrumentMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHlcSonificationDefaultInstrumentMappingPitchOptions] (val x: Self) extends AnyVal {
