...
trait PlotCylinderSonificationDefaultInstrumentActiveWhenOptions extends StObject {
...
object PlotCylinderSonificationDefaultInstrumentActiveWhenOptions {
  
  inline def apply(): PlotCylinderSonificationDefaultInstrumentActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCylinderSonificationDefaultInstrumentActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCylinderSonificationDefaultInstrumentActiveWhenOptions] (val x: Self) extends AnyVal {
