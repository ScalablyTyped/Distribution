...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesDpoOptions
  extends StObject
     with PlotDpoOptions {
...
object SeriesDpoOptions {
  ...
  @scala.inline
  def apply(dataParser: Unit, dataURL: Unit, `type`: String | dpo): SeriesDpoOptions = {
  ...
  @scala.inline
  implicit class SeriesDpoOptionsMutableBuilder[Self <: SeriesDpoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | dpo): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
