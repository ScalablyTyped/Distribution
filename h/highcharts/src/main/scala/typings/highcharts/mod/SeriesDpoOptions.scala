...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesDpoOptions extends PlotDpoOptions {
  /**
    * Not available
    */
...
object SeriesDpoOptions {
  ...
  def apply(
    ...
    dataLabels: PlotDpoDataLabelsOptions | js.Array[PlotDpoDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotDpoDataSortingOptions = null,
