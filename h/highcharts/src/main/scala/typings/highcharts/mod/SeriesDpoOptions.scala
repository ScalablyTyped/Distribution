...
object SeriesDpoOptions {
  ...
  @scala.inline
  implicit class SeriesDpoOptionsOps[Self <: SeriesDpoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: String | dpo): Self = this.set("type", value.asInstanceOf[js.Any])
