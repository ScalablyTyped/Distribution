...
trait PlotCciSonificationDefaultInstrumentMappingFrequencyOptions extends StObject {
...
object PlotCciSonificationDefaultInstrumentMappingFrequencyOptions {
  
  inline def apply(): PlotCciSonificationDefaultInstrumentMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCciSonificationDefaultInstrumentMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCciSonificationDefaultInstrumentMappingFrequencyOptions] (val x: Self) extends AnyVal {
