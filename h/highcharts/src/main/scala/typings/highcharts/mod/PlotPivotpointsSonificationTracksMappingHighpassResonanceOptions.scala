...
trait PlotPivotpointsSonificationTracksMappingHighpassResonanceOptions extends StObject {
...
object PlotPivotpointsSonificationTracksMappingHighpassResonanceOptions {
  
  inline def apply(): PlotPivotpointsSonificationTracksMappingHighpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationTracksMappingHighpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationTracksMappingHighpassResonanceOptions] (val x: Self) extends AnyVal {
