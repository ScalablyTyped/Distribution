...
trait PlotKeltnerchannelsSonificationPointGroupingOptions extends StObject {
...
object PlotKeltnerchannelsSonificationPointGroupingOptions {
  
  inline def apply(): PlotKeltnerchannelsSonificationPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsSonificationPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsSonificationPointGroupingOptions] (val x: Self) extends AnyVal {
