...
trait PlotSolidgaugeSonificationDefaultInstrumentMappingVolumeOptions extends StObject {
...
object PlotSolidgaugeSonificationDefaultInstrumentMappingVolumeOptions {
  
  inline def apply(): PlotSolidgaugeSonificationDefaultInstrumentMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSolidgaugeSonificationDefaultInstrumentMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSolidgaugeSonificationDefaultInstrumentMappingVolumeOptions] (val x: Self) extends AnyVal {
