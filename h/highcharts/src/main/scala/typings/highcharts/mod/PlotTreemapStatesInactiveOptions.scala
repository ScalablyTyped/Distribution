...
trait PlotTreemapStatesInactiveOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTreemapStatesInactiveAnimationOptions] = js.undefined
  /**
...
object PlotTreemapStatesInactiveOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTreemapStatesInactiveAnimationOptions = null,
    opacity: Int | Double = null
  ): PlotTreemapStatesInactiveOptions = {
