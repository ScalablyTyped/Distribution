...
trait PlotPpoSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotPpoSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
