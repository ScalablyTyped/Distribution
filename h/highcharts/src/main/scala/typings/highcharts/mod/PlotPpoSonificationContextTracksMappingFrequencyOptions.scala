...
trait PlotPpoSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotPpoSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotPpoSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
