...
trait PlotNetworkgraphMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotNetworkgraphMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNetworkgraphMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphMarkerStatesSelectOptions]
  }
}
