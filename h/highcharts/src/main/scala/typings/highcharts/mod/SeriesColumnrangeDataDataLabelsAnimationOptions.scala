...
@js.native
trait SeriesColumnrangeDataDataLabelsAnimationOptions extends js.Object {
...
object SeriesColumnrangeDataDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class SeriesColumnrangeDataDataLabelsAnimationOptionsOps[Self <: SeriesColumnrangeDataDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
