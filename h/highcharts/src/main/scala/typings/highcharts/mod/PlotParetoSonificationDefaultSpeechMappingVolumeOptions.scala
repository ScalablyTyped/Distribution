...
trait PlotParetoSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotParetoSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotParetoSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotParetoSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotParetoSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
