...
trait PlotSmaSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotSmaSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotSmaSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSmaSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSmaSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
