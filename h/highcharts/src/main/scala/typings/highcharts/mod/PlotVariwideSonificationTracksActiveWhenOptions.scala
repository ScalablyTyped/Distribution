...
trait PlotVariwideSonificationTracksActiveWhenOptions extends StObject {
...
object PlotVariwideSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotVariwideSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
