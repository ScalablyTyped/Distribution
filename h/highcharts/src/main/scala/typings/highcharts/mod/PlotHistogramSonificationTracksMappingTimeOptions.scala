...
trait PlotHistogramSonificationTracksMappingTimeOptions extends StObject {
...
object PlotHistogramSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotHistogramSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHistogramSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHistogramSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
