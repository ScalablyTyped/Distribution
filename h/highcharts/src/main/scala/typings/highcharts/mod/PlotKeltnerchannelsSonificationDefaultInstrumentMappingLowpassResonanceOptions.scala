...
trait PlotKeltnerchannelsSonificationDefaultInstrumentMappingLowpassResonanceOptions extends StObject {
...
object PlotKeltnerchannelsSonificationDefaultInstrumentMappingLowpassResonanceOptions {
  
  inline def apply(): PlotKeltnerchannelsSonificationDefaultInstrumentMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsSonificationDefaultInstrumentMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsSonificationDefaultInstrumentMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
