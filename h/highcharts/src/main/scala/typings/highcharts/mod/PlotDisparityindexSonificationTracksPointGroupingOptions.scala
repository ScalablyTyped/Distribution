...
trait PlotDisparityindexSonificationTracksPointGroupingOptions extends StObject {
...
object PlotDisparityindexSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotDisparityindexSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDisparityindexSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDisparityindexSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
