...
trait PlotWindbarbSonificationContextTracksMappingPlayDelayOptions extends StObject {
...
object PlotWindbarbSonificationContextTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotWindbarbSonificationContextTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationContextTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationContextTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
