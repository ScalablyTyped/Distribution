...
trait PlotOrganizationSonificationTracksMappingRateOptions extends StObject {
...
object PlotOrganizationSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotOrganizationSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOrganizationSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOrganizationSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
