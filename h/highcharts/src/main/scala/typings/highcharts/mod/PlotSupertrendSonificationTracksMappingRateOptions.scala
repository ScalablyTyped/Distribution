...
trait PlotSupertrendSonificationTracksMappingRateOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
