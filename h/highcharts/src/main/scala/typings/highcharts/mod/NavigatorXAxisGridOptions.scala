...
@js.native
trait NavigatorXAxisGridOptions extends StObject {
...
object NavigatorXAxisGridOptions {
  ...
  @scala.inline
  implicit class NavigatorXAxisGridOptionsMutableBuilder[Self <: NavigatorXAxisGridOptions] (val x: Self) extends AnyVal {
