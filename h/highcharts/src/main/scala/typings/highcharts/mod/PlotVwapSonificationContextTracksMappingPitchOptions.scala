...
trait PlotVwapSonificationContextTracksMappingPitchOptions extends StObject {
...
object PlotVwapSonificationContextTracksMappingPitchOptions {
  
  inline def apply(): PlotVwapSonificationContextTracksMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVwapSonificationContextTracksMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVwapSonificationContextTracksMappingPitchOptions] (val x: Self) extends AnyVal {
