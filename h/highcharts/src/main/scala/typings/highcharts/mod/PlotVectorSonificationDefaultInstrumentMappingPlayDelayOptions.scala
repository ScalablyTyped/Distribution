...
trait PlotVectorSonificationDefaultInstrumentMappingPlayDelayOptions extends StObject {
...
object PlotVectorSonificationDefaultInstrumentMappingPlayDelayOptions {
  
  inline def apply(): PlotVectorSonificationDefaultInstrumentMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorSonificationDefaultInstrumentMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVectorSonificationDefaultInstrumentMappingPlayDelayOptions] (val x: Self) extends AnyVal {
