...
@js.native
trait PlotAbandsAnimationOptions extends js.Object {
...
object PlotAbandsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotAbandsAnimationOptionsOps[Self <: PlotAbandsAnimationOptions] (val x: Self) extends AnyVal {
