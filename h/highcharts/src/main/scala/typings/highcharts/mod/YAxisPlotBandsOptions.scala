...
object YAxisPlotBandsOptions {
  ...
  inline def apply(): YAxisPlotBandsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisPlotBandsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: YAxisPlotBandsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEvents(value: YAxisPlotBandsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setLabel(value: YAxisPlotBandsLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
