...
object YAxisPlotBandsOptions {
  ...
  @scala.inline
  implicit class YAxisPlotBandsOptionsOps[Self <: YAxisPlotBandsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: YAxisPlotBandsEventsOptions): Self = this.set("events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: YAxisPlotBandsLabelOptions): Self = this.set("label", value.asInstanceOf[js.Any])
