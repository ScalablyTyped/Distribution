...
trait YAxisPlotBandsOptions extends AxisPlotBandsOptions {
  ...
  /**
    ...
    * `mousemove`.
    */
  var events: js.UndefOr[YAxisPlotBandsEventsOptions] = js.native
  ...
  /**
    ...
    */
  var label: js.UndefOr[YAxisPlotBandsLabelOptions] = js.native
...
object YAxisPlotBandsOptions {
  ...
  @scala.inline
  def apply(): YAxisPlotBandsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[YAxisPlotBandsOptions]
  }
  
  @scala.inline
  implicit class YAxisPlotBandsOptionsMutableBuilder[Self <: YAxisPlotBandsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: YAxisPlotBandsEventsOptions): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: YAxisPlotBandsLabelOptions): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
