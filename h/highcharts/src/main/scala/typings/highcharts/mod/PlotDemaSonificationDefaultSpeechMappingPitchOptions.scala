...
trait PlotDemaSonificationDefaultSpeechMappingPitchOptions extends StObject {
...
object PlotDemaSonificationDefaultSpeechMappingPitchOptions {
  
  inline def apply(): PlotDemaSonificationDefaultSpeechMappingPitchOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDemaSonificationDefaultSpeechMappingPitchOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDemaSonificationDefaultSpeechMappingPitchOptions] (val x: Self) extends AnyVal {
