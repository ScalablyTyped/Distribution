...
trait PlotDmiSonificationTracksMappingTimeOptions extends StObject {
...
object PlotDmiSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotDmiSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDmiSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDmiSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
