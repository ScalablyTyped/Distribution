...
trait PlotHollowcandlestickSonificationDefaultSpeechMappingVolumeOptions extends StObject {
...
object PlotHollowcandlestickSonificationDefaultSpeechMappingVolumeOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationDefaultSpeechMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationDefaultSpeechMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationDefaultSpeechMappingVolumeOptions] (val x: Self) extends AnyVal {
