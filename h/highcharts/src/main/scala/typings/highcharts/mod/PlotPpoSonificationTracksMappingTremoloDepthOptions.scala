...
trait PlotPpoSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotPpoSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
