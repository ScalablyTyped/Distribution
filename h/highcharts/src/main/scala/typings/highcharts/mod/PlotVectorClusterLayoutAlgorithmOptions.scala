...
trait PlotVectorClusterLayoutAlgorithmOptions extends StObject {
...
object PlotVectorClusterLayoutAlgorithmOptions {
  ...
  @scala.inline
  def apply(): PlotVectorClusterLayoutAlgorithmOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVectorClusterLayoutAlgorithmOptions]
  }
  
  @scala.inline
  implicit class PlotVectorClusterLayoutAlgorithmOptionsMutableBuilder[Self <: PlotVectorClusterLayoutAlgorithmOptions] (val x: Self) extends AnyVal {
