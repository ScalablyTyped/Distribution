...
trait PlotApoSonificationContextTracksMappingLowpassResonanceOptions extends StObject {
...
object PlotApoSonificationContextTracksMappingLowpassResonanceOptions {
  
  inline def apply(): PlotApoSonificationContextTracksMappingLowpassResonanceOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotApoSonificationContextTracksMappingLowpassResonanceOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotApoSonificationContextTracksMappingLowpassResonanceOptions] (val x: Self) extends AnyVal {
