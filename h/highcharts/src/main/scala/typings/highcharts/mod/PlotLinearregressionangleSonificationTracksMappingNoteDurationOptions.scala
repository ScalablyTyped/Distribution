...
trait PlotLinearregressionangleSonificationTracksMappingNoteDurationOptions extends StObject {
...
object PlotLinearregressionangleSonificationTracksMappingNoteDurationOptions {
  
  inline def apply(): PlotLinearregressionangleSonificationTracksMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLinearregressionangleSonificationTracksMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLinearregressionangleSonificationTracksMappingNoteDurationOptions] (val x: Self) extends AnyVal {
