...
trait PlotStreamgraphSonificationDefaultSpeechMappingPlayDelayOptions extends StObject {
...
object PlotStreamgraphSonificationDefaultSpeechMappingPlayDelayOptions {
  
  inline def apply(): PlotStreamgraphSonificationDefaultSpeechMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotStreamgraphSonificationDefaultSpeechMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotStreamgraphSonificationDefaultSpeechMappingPlayDelayOptions] (val x: Self) extends AnyVal {
