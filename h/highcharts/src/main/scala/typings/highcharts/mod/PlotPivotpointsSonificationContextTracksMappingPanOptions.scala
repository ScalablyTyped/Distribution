...
trait PlotPivotpointsSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotPivotpointsSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotPivotpointsSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPivotpointsSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPivotpointsSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
