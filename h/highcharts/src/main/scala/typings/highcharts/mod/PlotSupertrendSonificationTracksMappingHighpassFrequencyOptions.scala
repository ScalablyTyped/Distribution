...
trait PlotSupertrendSonificationTracksMappingHighpassFrequencyOptions extends StObject {
...
object PlotSupertrendSonificationTracksMappingHighpassFrequencyOptions {
  
  inline def apply(): PlotSupertrendSonificationTracksMappingHighpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSupertrendSonificationTracksMappingHighpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotSupertrendSonificationTracksMappingHighpassFrequencyOptions] (val x: Self) extends AnyVal {
