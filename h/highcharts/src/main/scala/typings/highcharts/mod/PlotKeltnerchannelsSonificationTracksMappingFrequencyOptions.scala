...
trait PlotKeltnerchannelsSonificationTracksMappingFrequencyOptions extends StObject {
...
object PlotKeltnerchannelsSonificationTracksMappingFrequencyOptions {
  
  inline def apply(): PlotKeltnerchannelsSonificationTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsSonificationTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsSonificationTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
