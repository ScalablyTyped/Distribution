...
trait PlotPpoSonificationTracksMappingTimeOptions extends StObject {
...
object PlotPpoSonificationTracksMappingTimeOptions {
  
  inline def apply(): PlotPpoSonificationTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPpoSonificationTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPpoSonificationTracksMappingTimeOptions] (val x: Self) extends AnyVal {
