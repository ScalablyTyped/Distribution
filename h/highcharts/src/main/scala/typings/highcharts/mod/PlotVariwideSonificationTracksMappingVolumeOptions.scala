...
trait PlotVariwideSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotVariwideSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotVariwideSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariwideSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariwideSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
