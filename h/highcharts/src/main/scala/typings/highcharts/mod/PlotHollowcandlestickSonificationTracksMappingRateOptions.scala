...
trait PlotHollowcandlestickSonificationTracksMappingRateOptions extends StObject {
...
object PlotHollowcandlestickSonificationTracksMappingRateOptions {
  
  inline def apply(): PlotHollowcandlestickSonificationTracksMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHollowcandlestickSonificationTracksMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHollowcandlestickSonificationTracksMappingRateOptions] (val x: Self) extends AnyVal {
