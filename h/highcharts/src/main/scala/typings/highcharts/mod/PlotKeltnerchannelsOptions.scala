...
object PlotKeltnerchannelsOptions {
  ...
  def apply(
    ...
    dataLabels: PlotKeltnerchannelsDataLabelsOptions | js.Array[PlotKeltnerchannelsDataLabelsOptions] = null,
    dataSorting: DataSortingOptionsObject | PlotKeltnerchannelsDataSortingOptions = null,
