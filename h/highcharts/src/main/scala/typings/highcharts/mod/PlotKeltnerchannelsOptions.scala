...
@js.native
trait PlotKeltnerchannelsOptions extends js.Object {
...
object PlotKeltnerchannelsOptions {
  ...
  @scala.inline
  implicit class PlotKeltnerchannelsOptionsOps[Self <: PlotKeltnerchannelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotKeltnerchannelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBottomLine(value: PlotKeltnerchannelsBottomLineOptions): Self = this.set("bottomLine", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBottomLine: Self = this.set("bottomLine", js.undefined)
    ...
    @scala.inline
    def setDataLabelsVarargs(value: PlotKeltnerchannelsDataLabelsOptions*): Self = this.set("dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataLabels(value: PlotKeltnerchannelsDataLabelsOptions | js.Array[PlotKeltnerchannelsDataLabelsOptions]): Self = this.set("dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDataLabels: Self = this.set("dataLabels", js.undefined)
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotKeltnerchannelsDataSortingOptions): Self = this.set("dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotKeltnerchannelsParamsOptions): Self = this.set("params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTopLine(value: PlotKeltnerchannelsTopLineOptions): Self = this.set("topLine", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTopLine: Self = this.set("topLine", js.undefined)
