...
trait PlotKeltnerchannelsOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotKeltnerchannelsAnimationOptions | PartialAnimationOptionsOb] = js.native
  ...
  /**
    ...
    */
  var bottomLine: js.UndefOr[PlotKeltnerchannelsBottomLineOptions] = js.native
  ...
  /**
    ...
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotKeltnerchannelsDataSortingOptions] = js.native
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotKeltnerchannelsParamsOptions] = js.native
  ...
  /**
    ...
    */
  var topLine: js.UndefOr[PlotKeltnerchannelsTopLineOptions] = js.native
