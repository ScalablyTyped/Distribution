...
trait PlotKeltnerchannelsOptions extends StObject {
  ...
  /**
    ...
    */
  var sonification: js.UndefOr[PlotKeltnerchannelsSonificationOptions] = js.undefined
...
object PlotKeltnerchannelsOptions {
  ...
  implicit open class MutableBuilder[Self <: PlotKeltnerchannelsOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSonification(value: PlotKeltnerchannelsSonificationOptions): Self = StObject.set(x, "sonification", value.asInstanceOf[js.Any])
