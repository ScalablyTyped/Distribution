...
object PlotKeltnerchannelsOptions {
  ...
  @scala.inline
  def apply(): PlotKeltnerchannelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotKeltnerchannelsOptions]
  }
  
  @scala.inline
  implicit class PlotKeltnerchannelsOptionsMutableBuilder[Self <: PlotKeltnerchannelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotKeltnerchannelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBottomLine(value: PlotKeltnerchannelsBottomLineOptions): Self = StObject.set(x, "bottomLine", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBottomLineUndefined: Self = StObject.set(x, "bottomLine", js.undefined)
    ...
    @scala.inline
    def setDataLabels(value: PlotKeltnerchannelsDataLabelsOptions | js.Array[PlotKeltnerchannelsDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    @scala.inline
    def setDataLabelsVarargs(value: PlotKeltnerchannelsDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value :_*))
    
    @scala.inline
    def setDataSorting(value: DataSortingOptionsObject | PlotKeltnerchannelsDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParams(value: PlotKeltnerchannelsParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTopLine(value: PlotKeltnerchannelsTopLineOptions): Self = StObject.set(x, "topLine", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTopLineUndefined: Self = StObject.set(x, "topLine", js.undefined)
