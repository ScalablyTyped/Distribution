...
trait PlotKeltnerchannelsOptions extends StObject {
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | PlotKeltnerchannelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
  ...
  /**
    ...
    */
  var bottomLine: js.UndefOr[PlotKeltnerchannelsBottomLineOptions] = js.undefined
  ...
  var dataLabels: js.UndefOr[
    PlotKeltnerchannelsDataLabelsOptions | js.Array[PlotKeltnerchannelsDataLabelsOptions]
  ] = js.undefined
  
  /**
    * (Highcharts, Highstock) Options for the series data sorting.
    */
  var dataSorting: js.UndefOr[DataSortingOptionsObject | PlotKeltnerchannelsDataSortingOptions] = js.undefined
  ...
  /**
    ...
    * Indicator.
    */
  var fillColor: js.UndefOr[Color_] = js.undefined
  ...
  /**
    ...
    */
  var onPoint: js.UndefOr[js.Object | PlotKeltnerchannelsOnPointOptions] = js.undefined
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotKeltnerchannelsParamsOptions] = js.undefined
  ...
  /**
    ...
    */
  var topLine: js.UndefOr[PlotKeltnerchannelsTopLineOptions] = js.undefined
...
object PlotKeltnerchannelsOptions {
  
  inline def apply(): PlotKeltnerchannelsOptions = {
  ...
  extension [Self <: PlotKeltnerchannelsOptions](x: Self) {
    ...
    inline def setAnimation(value: Boolean | PlotKeltnerchannelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    inline def setBottomLine(value: PlotKeltnerchannelsBottomLineOptions): Self = StObject.set(x, "bottomLine", value.asInstanceOf[js.Any])
    
    inline def setBottomLineUndefined: Self = StObject.set(x, "bottomLine", js.undefined)
    ...
    inline def setDataLabels(value: PlotKeltnerchannelsDataLabelsOptions | js.Array[PlotKeltnerchannelsDataLabelsOptions]): Self = StObject.set(x, "dataLabels", value.asInstanceOf[js.Any])
    
    inline def setDataLabelsUndefined: Self = StObject.set(x, "dataLabels", js.undefined)
    
    inline def setDataLabelsVarargs(value: PlotKeltnerchannelsDataLabelsOptions*): Self = StObject.set(x, "dataLabels", js.Array(value*))
    
    inline def setDataSorting(value: DataSortingOptionsObject | PlotKeltnerchannelsDataSortingOptions): Self = StObject.set(x, "dataSorting", value.asInstanceOf[js.Any])
    ...
    inline def setFillColor(value: Color_): Self = StObject.set(x, "fillColor", value.asInstanceOf[js.Any])
    ...
    inline def setOnPoint(value: js.Object | PlotKeltnerchannelsOnPointOptions): Self = StObject.set(x, "onPoint", value.asInstanceOf[js.Any])
    ...
    inline def setParams(value: PlotKeltnerchannelsParamsOptions): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    inline def setTopLine(value: PlotKeltnerchannelsTopLineOptions): Self = StObject.set(x, "topLine", value.asInstanceOf[js.Any])
    
    inline def setTopLineUndefined: Self = StObject.set(x, "topLine", js.undefined)
