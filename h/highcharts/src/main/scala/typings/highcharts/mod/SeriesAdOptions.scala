...
- typings.highcharts.mod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesAdOptions
  extends StObject
     with PlotAdOptions {
...
object SeriesAdOptions {
  ...
  inline def apply(`type`: String | ad): SeriesAdOptions = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesAdOptions] (val x: Self) extends AnyVal {
