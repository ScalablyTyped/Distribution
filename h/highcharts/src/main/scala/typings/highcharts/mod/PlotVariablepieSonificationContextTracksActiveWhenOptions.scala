...
trait PlotVariablepieSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotVariablepieSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotVariablepieSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVariablepieSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVariablepieSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
