...
trait PlotVbpSonificationTracksMappingLowpassFrequencyOptions extends StObject {
...
object PlotVbpSonificationTracksMappingLowpassFrequencyOptions {
  
  inline def apply(): PlotVbpSonificationTracksMappingLowpassFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotVbpSonificationTracksMappingLowpassFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotVbpSonificationTracksMappingLowpassFrequencyOptions] (val x: Self) extends AnyVal {
