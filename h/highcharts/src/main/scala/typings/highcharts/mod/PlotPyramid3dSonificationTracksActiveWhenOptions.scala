...
trait PlotPyramid3dSonificationTracksActiveWhenOptions extends StObject {
...
object PlotPyramid3dSonificationTracksActiveWhenOptions {
  
  inline def apply(): PlotPyramid3dSonificationTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPyramid3dSonificationTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPyramid3dSonificationTracksActiveWhenOptions] (val x: Self) extends AnyVal {
