...
trait PlotBbSonificationDefaultSpeechMappingRateOptions extends StObject {
...
object PlotBbSonificationDefaultSpeechMappingRateOptions {
  
  inline def apply(): PlotBbSonificationDefaultSpeechMappingRateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBbSonificationDefaultSpeechMappingRateOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBbSonificationDefaultSpeechMappingRateOptions] (val x: Self) extends AnyVal {
