...
trait PlotTrixAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotTrixAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotTrixAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotTrixAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotTrixAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotTrixAccessibilityOptions]
  }
}
