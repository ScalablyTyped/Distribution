...
trait PlotWindbarbSonificationTracksMappingTremoloDepthOptions extends StObject {
...
object PlotWindbarbSonificationTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotWindbarbSonificationTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
