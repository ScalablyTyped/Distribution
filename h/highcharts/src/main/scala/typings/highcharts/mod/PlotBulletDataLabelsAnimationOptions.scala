...
@js.native
trait PlotBulletDataLabelsAnimationOptions extends js.Object {
...
object PlotBulletDataLabelsAnimationOptions {
  ...
  @scala.inline
  implicit class PlotBulletDataLabelsAnimationOptionsOps[Self <: PlotBulletDataLabelsAnimationOptions] (val x: Self) extends AnyVal {
