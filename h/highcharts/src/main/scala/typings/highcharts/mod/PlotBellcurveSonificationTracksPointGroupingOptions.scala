...
trait PlotBellcurveSonificationTracksPointGroupingOptions extends StObject {
...
object PlotBellcurveSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotBellcurveSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBellcurveSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
