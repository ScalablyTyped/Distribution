...
trait PlotHeatmapSonificationDefaultSpeechPointGroupingOptions extends StObject {
...
object PlotHeatmapSonificationDefaultSpeechPointGroupingOptions {
  
  inline def apply(): PlotHeatmapSonificationDefaultSpeechPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotHeatmapSonificationDefaultSpeechPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotHeatmapSonificationDefaultSpeechPointGroupingOptions] (val x: Self) extends AnyVal {
