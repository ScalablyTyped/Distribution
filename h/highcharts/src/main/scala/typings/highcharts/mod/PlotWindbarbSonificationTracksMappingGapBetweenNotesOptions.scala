...
trait PlotWindbarbSonificationTracksMappingGapBetweenNotesOptions extends StObject {
...
object PlotWindbarbSonificationTracksMappingGapBetweenNotesOptions {
  
  inline def apply(): PlotWindbarbSonificationTracksMappingGapBetweenNotesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWindbarbSonificationTracksMappingGapBetweenNotesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWindbarbSonificationTracksMappingGapBetweenNotesOptions] (val x: Self) extends AnyVal {
