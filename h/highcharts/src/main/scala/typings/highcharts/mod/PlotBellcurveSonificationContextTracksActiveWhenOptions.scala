...
trait PlotBellcurveSonificationContextTracksActiveWhenOptions extends StObject {
...
object PlotBellcurveSonificationContextTracksActiveWhenOptions {
  
  inline def apply(): PlotBellcurveSonificationContextTracksActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBellcurveSonificationContextTracksActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBellcurveSonificationContextTracksActiveWhenOptions] (val x: Self) extends AnyVal {
