...
trait PlotDependencywheelSonificationContextTracksMappingVolumeOptions extends StObject {
...
object PlotDependencywheelSonificationContextTracksMappingVolumeOptions {
  
  inline def apply(): PlotDependencywheelSonificationContextTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotDependencywheelSonificationContextTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotDependencywheelSonificationContextTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
