...
trait PlotWaterfallSonificationTracksPointGroupingOptions extends StObject {
...
object PlotWaterfallSonificationTracksPointGroupingOptions {
  
  inline def apply(): PlotWaterfallSonificationTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotWaterfallSonificationTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotWaterfallSonificationTracksPointGroupingOptions] (val x: Self) extends AnyVal {
