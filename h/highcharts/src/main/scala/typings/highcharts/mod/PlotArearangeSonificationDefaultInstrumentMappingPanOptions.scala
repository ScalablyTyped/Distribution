...
trait PlotArearangeSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotArearangeSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotArearangeSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotArearangeSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotArearangeSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
