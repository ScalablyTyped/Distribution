...
object LangNavigationPopupOptions {
  ...
  inline def apply(): LangNavigationPopupOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LangNavigationPopupOptions]
  }
  
  extension [Self <: LangNavigationPopupOptions](x: Self) {
    ...
    inline def setBackgroundColors(value: String): Self = StObject.set(x, "backgroundColors", value.asInstanceOf[js.Any])
    ...
    inline def setCrosshairX(value: String): Self = StObject.set(x, "crosshairX", value.asInstanceOf[js.Any])
    
    inline def setCrosshairXUndefined: Self = StObject.set(x, "crosshairX", js.undefined)
    
    inline def setCrosshairY(value: String): Self = StObject.set(x, "crosshairY", value.asInstanceOf[js.Any])
    ...
    inline def setLabelOptions(value: String): Self = StObject.set(x, "labelOptions", value.asInstanceOf[js.Any])
    ...
    inline def setSaveButton(value: String): Self = StObject.set(x, "saveButton", value.asInstanceOf[js.Any])
    ...
    inline def setShapeOptions(value: String): Self = StObject.set(x, "shapeOptions", value.asInstanceOf[js.Any])
    ...
    inline def setTypeOptions(value: String): Self = StObject.set(x, "typeOptions", value.asInstanceOf[js.Any])
