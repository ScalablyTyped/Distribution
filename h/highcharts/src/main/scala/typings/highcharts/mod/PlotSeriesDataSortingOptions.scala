...
@js.native
trait PlotSeriesDataSortingOptions extends js.Object {
...
object PlotSeriesDataSortingOptions {
  ...
  @scala.inline
  def apply(): PlotSeriesDataSortingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotSeriesDataSortingOptions]
  }
  
  @scala.inline
  implicit class PlotSeriesDataSortingOptionsOps[Self <: PlotSeriesDataSortingOptions] (val x: Self) extends AnyVal {
