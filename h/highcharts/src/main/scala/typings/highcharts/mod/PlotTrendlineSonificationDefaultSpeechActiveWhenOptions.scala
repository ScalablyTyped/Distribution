...
trait PlotTrendlineSonificationDefaultSpeechActiveWhenOptions extends StObject {
...
object PlotTrendlineSonificationDefaultSpeechActiveWhenOptions {
  
  inline def apply(): PlotTrendlineSonificationDefaultSpeechActiveWhenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotTrendlineSonificationDefaultSpeechActiveWhenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotTrendlineSonificationDefaultSpeechActiveWhenOptions] (val x: Self) extends AnyVal {
