...
trait PlotMapbubbleSonificationContextTracksMappingTremoloSpeedOptions extends StObject {
...
object PlotMapbubbleSonificationContextTracksMappingTremoloSpeedOptions {
  
  inline def apply(): PlotMapbubbleSonificationContextTracksMappingTremoloSpeedOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleSonificationContextTracksMappingTremoloSpeedOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleSonificationContextTracksMappingTremoloSpeedOptions] (val x: Self) extends AnyVal {
