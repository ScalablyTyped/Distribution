...
trait PlotLineSonificationContextTracksPointGroupingOptions extends StObject {
...
object PlotLineSonificationContextTracksPointGroupingOptions {
  
  inline def apply(): PlotLineSonificationContextTracksPointGroupingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotLineSonificationContextTracksPointGroupingOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotLineSonificationContextTracksPointGroupingOptions] (val x: Self) extends AnyVal {
