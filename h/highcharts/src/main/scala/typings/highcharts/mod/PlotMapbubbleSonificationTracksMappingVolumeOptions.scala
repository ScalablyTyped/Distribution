...
trait PlotMapbubbleSonificationTracksMappingVolumeOptions extends StObject {
...
object PlotMapbubbleSonificationTracksMappingVolumeOptions {
  
  inline def apply(): PlotMapbubbleSonificationTracksMappingVolumeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMapbubbleSonificationTracksMappingVolumeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMapbubbleSonificationTracksMappingVolumeOptions] (val x: Self) extends AnyVal {
