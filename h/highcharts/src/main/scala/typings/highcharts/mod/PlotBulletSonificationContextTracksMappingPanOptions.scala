...
trait PlotBulletSonificationContextTracksMappingPanOptions extends StObject {
...
object PlotBulletSonificationContextTracksMappingPanOptions {
  
  inline def apply(): PlotBulletSonificationContextTracksMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBulletSonificationContextTracksMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotBulletSonificationContextTracksMappingPanOptions] (val x: Self) extends AnyVal {
