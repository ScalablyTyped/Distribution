...
trait PlotPriceenvelopesSonificationDefaultInstrumentMappingNoteDurationOptions extends StObject {
...
object PlotPriceenvelopesSonificationDefaultInstrumentMappingNoteDurationOptions {
  
  inline def apply(): PlotPriceenvelopesSonificationDefaultInstrumentMappingNoteDurationOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotPriceenvelopesSonificationDefaultInstrumentMappingNoteDurationOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotPriceenvelopesSonificationDefaultInstrumentMappingNoteDurationOptions] (val x: Self) extends AnyVal {
