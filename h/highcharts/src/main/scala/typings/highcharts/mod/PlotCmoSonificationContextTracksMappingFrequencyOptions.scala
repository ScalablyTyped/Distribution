...
trait PlotCmoSonificationContextTracksMappingFrequencyOptions extends StObject {
...
object PlotCmoSonificationContextTracksMappingFrequencyOptions {
  
  inline def apply(): PlotCmoSonificationContextTracksMappingFrequencyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotCmoSonificationContextTracksMappingFrequencyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotCmoSonificationContextTracksMappingFrequencyOptions] (val x: Self) extends AnyVal {
