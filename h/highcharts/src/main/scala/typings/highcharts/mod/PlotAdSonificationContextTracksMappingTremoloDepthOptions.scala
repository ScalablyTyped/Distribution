...
trait PlotAdSonificationContextTracksMappingTremoloDepthOptions extends StObject {
...
object PlotAdSonificationContextTracksMappingTremoloDepthOptions {
  
  inline def apply(): PlotAdSonificationContextTracksMappingTremoloDepthOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotAdSonificationContextTracksMappingTremoloDepthOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotAdSonificationContextTracksMappingTremoloDepthOptions] (val x: Self) extends AnyVal {
