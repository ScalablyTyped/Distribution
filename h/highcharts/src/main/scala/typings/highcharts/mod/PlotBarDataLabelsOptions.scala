...
@js.native
trait PlotBarDataLabelsOptions extends js.Object {
...
object PlotBarDataLabelsOptions {
  ...
  @scala.inline
  implicit class PlotBarDataLabelsOptionsOps[Self <: PlotBarDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBarDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = this.set("animation", value.asInstanceOf[js.Any])
