...
trait PlotBarDataLabelsOptions extends StObject {
  ...
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | PlotBarDataLabelsAnimationOptions | PartialAnimationOptionsOb] = js.undefined
...
object PlotBarDataLabelsOptions {
  
  @scala.inline
  def apply(): PlotBarDataLabelsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotBarDataLabelsOptions]
  }
  
  @scala.inline
  implicit class PlotBarDataLabelsOptionsMutableBuilder[Self <: PlotBarDataLabelsOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | PlotBarDataLabelsAnimationOptions | PartialAnimationOptionsOb): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
