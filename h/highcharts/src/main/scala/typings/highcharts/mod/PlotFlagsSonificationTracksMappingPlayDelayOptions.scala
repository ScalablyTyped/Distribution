...
trait PlotFlagsSonificationTracksMappingPlayDelayOptions extends StObject {
...
object PlotFlagsSonificationTracksMappingPlayDelayOptions {
  
  inline def apply(): PlotFlagsSonificationTracksMappingPlayDelayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotFlagsSonificationTracksMappingPlayDelayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotFlagsSonificationTracksMappingPlayDelayOptions] (val x: Self) extends AnyVal {
