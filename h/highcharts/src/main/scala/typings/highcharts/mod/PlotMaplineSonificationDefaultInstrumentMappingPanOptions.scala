...
trait PlotMaplineSonificationDefaultInstrumentMappingPanOptions extends StObject {
...
object PlotMaplineSonificationDefaultInstrumentMappingPanOptions {
  
  inline def apply(): PlotMaplineSonificationDefaultInstrumentMappingPanOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMaplineSonificationDefaultInstrumentMappingPanOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMaplineSonificationDefaultInstrumentMappingPanOptions] (val x: Self) extends AnyVal {
