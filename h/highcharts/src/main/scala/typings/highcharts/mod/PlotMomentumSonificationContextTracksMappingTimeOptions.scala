...
trait PlotMomentumSonificationContextTracksMappingTimeOptions extends StObject {
...
object PlotMomentumSonificationContextTracksMappingTimeOptions {
  
  inline def apply(): PlotMomentumSonificationContextTracksMappingTimeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotMomentumSonificationContextTracksMappingTimeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotMomentumSonificationContextTracksMappingTimeOptions] (val x: Self) extends AnyVal {
