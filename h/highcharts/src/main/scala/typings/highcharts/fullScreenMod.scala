...
object fullScreenMod {
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/full-screen", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/full-screen", "Highcharts.SeriesPalettes")
    @js.native
  ...
  object highchartsAugmentingMod {
    ...
    trait Chart extends StObject {
      ...
      var fullscreen: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Fullscreen */ Any
    }
    object Chart {
      
      inline def apply(
        fullscreen: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Fullscreen */ Any
      ): Chart = {
