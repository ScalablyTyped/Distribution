...
object dependencyWheelMod {
  ...
  @JSImport("highcharts/modules/dependency-wheel", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/dependency-wheel", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/dependency-wheel", "Highcharts.SeriesPalettes")
    @js.native
