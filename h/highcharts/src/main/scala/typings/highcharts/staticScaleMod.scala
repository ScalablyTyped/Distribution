...
object staticScaleMod {
  ...
  @JSImport("highcharts/modules/static-scale", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/static-scale", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/static-scale", "Highcharts.SeriesPalettes")
    @js.native
