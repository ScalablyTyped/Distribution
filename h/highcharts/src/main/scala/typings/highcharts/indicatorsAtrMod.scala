...
object indicatorsAtrMod {
  
  @JSImport("highcharts/indicators/atr", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/atr", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/atr", "Highcharts.SeriesPalettes")
    @js.native
