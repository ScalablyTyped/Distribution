...
object stockMod {
  ...
  @JSImport("highcharts/modules/stock", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/stock", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/stock", "Highcharts.SeriesPalettes")
    @js.native
