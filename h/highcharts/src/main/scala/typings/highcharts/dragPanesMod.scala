...
object dragPanesMod {
  ...
  @JSImport("highcharts/modules/drag-panes", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/drag-panes", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/drag-panes", "Highcharts.SeriesPalettes")
    @js.native
