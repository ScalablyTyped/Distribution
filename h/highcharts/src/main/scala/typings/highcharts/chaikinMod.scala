...
object chaikinMod {
  ...
  @JSImport("highcharts/indicators/chaikin", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/chaikin", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/chaikin", "Highcharts.SeriesPalettes")
    @js.native
