...
object bollingerBandsMod {
  ...
  @JSImport("highcharts/indicators/bollinger-bands", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/bollinger-bands", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/bollinger-bands", "Highcharts.SeriesPalettes")
    @js.native
