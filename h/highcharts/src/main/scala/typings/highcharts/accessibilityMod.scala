  ...
  object highchartsAugmentingMod {
    ...
    trait Chart extends StObject {
      ...
      /**
        ...
        */
      def langFormat(langKey: String, context: Dictionary[js.Any]): String
    }
    object Chart {
      
      inline def apply(dismissPopupContent: () => Unit, langFormat: (String, Dictionary[js.Any]) => String): Chart = {
      ...
      extension [Self <: Chart](x: Self) {
        ...
        inline def setDismissPopupContent(value: () => Unit): Self = StObject.set(x, "dismissPopupContent", js.Any.fromFunction0(value))
        
        inline def setLangFormat(value: (String, Dictionary[js.Any]) => String): Self = StObject.set(x, "langFormat", js.Any.fromFunction2(value))
      }
    }
