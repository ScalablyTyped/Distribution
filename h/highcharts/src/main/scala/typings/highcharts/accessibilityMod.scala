...
object accessibilityMod {
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.addEvent")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.animObject")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.animate")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.arrayMax")
    @js.native
    def arrayMax(data: js.Array[_]): Double = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.arrayMin")
    @js.native
    def arrayMin(data: js.Array[_]): Double = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.attr")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.clearTimeout")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.correctFloat")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.createElement")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.css")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.dateFormat")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.defined")
    @js.native
    def defined(obj: js.Any): Boolean = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.destroyObjectProperties")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.discardElement")
    @js.native
    def discardElement(element: HTMLDOMElement): Unit = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.each")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.erase")
    @js.native
    def erase(arr: js.Array[_], item: js.Any): Unit = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.error")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.extend")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.extendClass")
    @js.native
    def extendClass[T](parent: Class[T], members: Dictionary[_]): Class[T] = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.find")
    @js.native
    def find[T](arr: js.Array[T], callback: js.Function): js.UndefOr[T] = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.fireEvent")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.format")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.getDeferredAnimation")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.getMagnitude")
    @js.native
    def getMagnitude(num: Double): Double = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.getOptions")
    @js.native
    def getOptions(): Options = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.getStyle")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.grep")
    @js.native
    def grep(arr: js.Array[_], callback: js.Function): js.Array[_] = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.inArray")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.isArray")
    @js.native
    def isArray(obj: js.Any): Boolean = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.isClass")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.isDOMElement")
    @js.native
    def isDOMElement(obj: js.Any): Boolean = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.isNumber")
    @js.native
    def isNumber(n: js.Any): Boolean = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.isObject")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.isString")
    @js.native
    def isString(s: js.Any): Boolean = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.keys")
    @js.native
    def keys(obj: js.Any): js.Array[String] = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.map")
    @js.native
    def map(arr: js.Array[_], fn: js.Function): js.Array[_] = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.merge")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.normalizeTickInterval")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.numberFormat")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.objectEach")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.offset")
    @js.native
    def offset(el: Element): OffsetObject = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.pad")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.pick")
    @js.native
    def pick[T](items: (js.UndefOr[T | Null])*): T = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.reduce")
    @js.native
    def reduce(arr: js.Array[_], fn: js.Function, initialValue: js.Any): js.Any = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.relativeLength")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.removeEvent")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.seriesType")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.setAnimation")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.setOptions")
    @js.native
    def setOptions(options: Options): Options = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.some")
    @js.native
    def some(arr: js.Array[_], fn: js.Function, ctx: js.Any): Boolean = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.splat")
    @js.native
    def splat(obj: js.Any): js.Array[_] = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.stableSort")
    @js.native
    def stableSort(arr: js.Array[_], sortFunction: js.Function): Unit = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.stop")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.syncTimeout")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.uniqueKey")
    @js.native
    def uniqueKey(): String = js.native
    
    @JSImport("highcharts/modules/accessibility", "Highcharts.useSerialIds")
    @js.native
    ...
    @JSImport("highcharts/modules/accessibility", "Highcharts.wrap")
    @js.native
  ...
  object highchartsAugmentingMod {
    ...
    object Chart {
      ...
      implicit class ChartMutableBuilder[Self <: Chart] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setDismissPopupContent(value: () => Unit): Self = StObject.set(x, "dismissPopupContent", js.Any.fromFunction0(value))
        
        @scala.inline
        def setLangFormat(value: (String, Dictionary[_]) => String): Self = StObject.set(x, "langFormat", js.Any.fromFunction2(value))
      }
    }
