...
object accessibilityMod {
  ...
  object highchartsAugmentingMod {
    ...
    object Chart {
      ...
      @scala.inline
      def apply(dismissPopupContent: () => Unit, langFormat: (String, Dictionary[js.Any]) => String): Chart = {
      ...
      implicit class ChartMutableBuilder[Self <: Chart] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setLangFormat(value: (String, Dictionary[js.Any]) => String): Self = StObject.set(x, "langFormat", js.Any.fromFunction2(value))
      }
    }
