...
object highchartsGanttMod {
  ...
  @JSImport("highcharts/highcharts-gantt", "AST")
  @js.native
  ...
  object AST {
    ...
    /**
      ...
      */
    @JSImport("highcharts/highcharts-gantt", "AST.bypassHTMLFiltering")
    @js.native
  ...
  object Color_ {
    ...
    /**
      ...
      */
    inline def parse(): typings.highcharts.mod.Color_ = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")().asInstanceOf[typings.highcharts.mod.Color_]
  ...
  object Series {
    ...
    /**
      ...
      */
    @JSImport("highcharts/highcharts-gantt", "Series.types")
    @js.native
  ...
  @JSImport("highcharts/highcharts-gantt", "SeriesPalettes")
  @js.native
  ...
  inline def format(str: String, ctx: Record[String, Any], chart: typings.highcharts.mod.Chart_): String = (^.asInstanceOf[js.Dynamic].applyDynamic("format")(str.asInstanceOf[js.Any], ctx.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[String]
