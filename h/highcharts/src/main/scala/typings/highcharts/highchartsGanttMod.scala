...
object highchartsGanttMod {
  ...
  object Color_ {
    ...
    /**
      ...
      */
    @scala.inline
    def parse(input: ColorType): typings.highcharts.mod.Color_ = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[typings.highcharts.mod.Color_]
  }
  ...
  @scala.inline
  def chart(options: Options): typings.highcharts.mod.Chart_ = ^.asInstanceOf[js.Dynamic].applyDynamic("chart")(options.asInstanceOf[js.Any]).asInstanceOf[typings.highcharts.mod.Chart_]
  @scala.inline
  def chart(options: Options, callback: ChartCallbackFunction): typings.highcharts.mod.Chart_ = (^.asInstanceOf[js.Dynamic].applyDynamic("chart")(options.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[typings.highcharts.mod.Chart_]
  @scala.inline
  def chart(renderTo: String, options: Options): typings.highcharts.mod.Chart_ = (^.asInstanceOf[js.Dynamic].applyDynamic("chart")(renderTo.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.highcharts.mod.Chart_]
  @scala.inline
  def chart(renderTo: String, options: Options, callback: ChartCallbackFunction): typings.highcharts.mod.Chart_ = (^.asInstanceOf[js.Dynamic].applyDynamic("chart")(renderTo.asInstanceOf[js.Any], options.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[typings.highcharts.mod.Chart_]
  @scala.inline
  def chart(renderTo: HTMLDOMElement, options: Options): typings.highcharts.mod.Chart_ = (^.asInstanceOf[js.Dynamic].applyDynamic("chart")(renderTo.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.highcharts.mod.Chart_]
  @scala.inline
  def chart(renderTo: HTMLDOMElement, options: Options, callback: ChartCallbackFunction): typings.highcharts.mod.Chart_ = (^.asInstanceOf[js.Dynamic].applyDynamic("chart")(renderTo.asInstanceOf[js.Any], options.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[typings.highcharts.mod.Chart_]
  
  @JSImport("highcharts/highcharts-gantt", "charts")
  @js.native
  def charts: js.Array[js.UndefOr[typings.highcharts.mod.Chart_]] = js.native
  @scala.inline
  def charts_=(x: js.Array[js.UndefOr[typings.highcharts.mod.Chart_]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("charts")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def color(input: ColorType): typings.highcharts.mod.Color_ = ^.asInstanceOf[js.Dynamic].applyDynamic("color")(input.asInstanceOf[js.Any]).asInstanceOf[typings.highcharts.mod.Color_]
  ...
  @scala.inline
  def error(code: String, stop: Boolean, chart: typings.highcharts.mod.Chart_): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("error")(code.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def error(code: String, stop: Boolean, chart: typings.highcharts.mod.Chart_, params: Dictionary[String]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("error")(code.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], chart.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  ...
  @scala.inline
  def error(code: String, stop: Unit, chart: typings.highcharts.mod.Chart_): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("error")(code.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def error(code: String, stop: Unit, chart: typings.highcharts.mod.Chart_, params: Dictionary[String]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("error")(code.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], chart.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  ...
  @scala.inline
  def error(code: Double, stop: Boolean, chart: typings.highcharts.mod.Chart_): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("error")(code.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def error(code: Double, stop: Boolean, chart: typings.highcharts.mod.Chart_, params: Dictionary[String]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("error")(code.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], chart.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  ...
  @scala.inline
  def error(code: Double, stop: Unit, chart: typings.highcharts.mod.Chart_): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("error")(code.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def error(code: Double, stop: Unit, chart: typings.highcharts.mod.Chart_, params: Dictionary[String]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("error")(code.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], chart.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  @scala.inline
  def format(str: String, ctx: Record[String, js.Any], chart: typings.highcharts.mod.Chart_): String = (^.asInstanceOf[js.Dynamic].applyDynamic("format")(str.asInstanceOf[js.Any], ctx.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[String]
  
  @scala.inline
  def getDeferredAnimation(chart: typings.highcharts.mod.Chart_, animation: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getDeferredAnimation")(chart.asInstanceOf[js.Any], animation.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def getDeferredAnimation(chart: typings.highcharts.mod.Chart_, animation: Boolean, series: typings.highcharts.mod.Series): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getDeferredAnimation")(chart.asInstanceOf[js.Any], animation.asInstanceOf[js.Any], series.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def getDeferredAnimation(chart: typings.highcharts.mod.Chart_, animation: AnimationOptionsObject): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getDeferredAnimation")(chart.asInstanceOf[js.Any], animation.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  ...
  @scala.inline
  def setAnimation(animation: Boolean, chart: typings.highcharts.mod.Chart_): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setAnimation")(animation.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def setAnimation(animation: Unit, chart: typings.highcharts.mod.Chart_): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setAnimation")(animation.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def setAnimation(animation: PartialAnimationOptionsOb, chart: typings.highcharts.mod.Chart_): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setAnimation")(animation.asInstanceOf[js.Any], chart.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  @scala.inline
  def time_=(x: typings.highcharts.mod.Time_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("time")(x.asInstanceOf[js.Any])
