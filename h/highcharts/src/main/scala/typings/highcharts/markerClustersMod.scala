...
object markerClustersMod {
  ...
  @JSImport("highcharts/modules/marker-clusters", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/marker-clusters", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/marker-clusters", "Highcharts.SeriesPalettes")
    @js.native
