...
object mfiMod {
  ...
  @JSImport("highcharts/indicators/mfi", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/mfi", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/mfi", "Highcharts.SeriesPalettes")
    @js.native
