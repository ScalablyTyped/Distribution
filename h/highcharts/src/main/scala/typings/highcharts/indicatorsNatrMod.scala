...
object indicatorsNatrMod {
  
  @JSImport("highcharts/indicators/natr", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/natr", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/natr", "Highcharts.SeriesPalettes")
    @js.native
