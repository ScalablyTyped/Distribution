...
object indicatorsIndicatorsMod {
  
  @JSImport("highcharts/indicators/indicators", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/indicators", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/indicators", "Highcharts.SeriesPalettes")
    @js.native
