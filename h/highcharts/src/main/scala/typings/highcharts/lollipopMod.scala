...
object lollipopMod {
  ...
  @JSImport("highcharts/modules/lollipop", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/lollipop", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/lollipop", "Highcharts.SeriesPalettes")
    @js.native
