...
object parallelCoordinatesMod {
  ...
  @JSImport("highcharts/modules/parallel-coordinates", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/parallel-coordinates", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/parallel-coordinates", "Highcharts.SeriesPalettes")
    @js.native
  ...
  object highchartsAugmentingMod {
    ...
    object Chart {
      ...
      inline def apply(hasParallelCoordinates: Boolean): Chart = {
