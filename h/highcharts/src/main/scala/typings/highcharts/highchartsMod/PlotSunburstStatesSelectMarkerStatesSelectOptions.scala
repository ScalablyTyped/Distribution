...
trait PlotSunburstStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotSunburstStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSunburstStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotSunburstStatesSelectMarkerStatesSelectOptions]
  }
}
