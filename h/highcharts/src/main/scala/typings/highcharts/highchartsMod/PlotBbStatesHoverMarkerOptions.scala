...
trait PlotBbStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotBbStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotBbStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotBbStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    ...
    __obj.asInstanceOf[PlotBbStatesHoverMarkerOptions]
  }
}
