...
trait PlotColumnpyramidAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotColumnpyramidAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotColumnpyramidAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotColumnpyramidAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotColumnpyramidAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotColumnpyramidAccessibilityOptions]
  }
}
