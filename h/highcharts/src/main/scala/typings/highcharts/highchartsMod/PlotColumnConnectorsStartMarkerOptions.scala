...
trait PlotColumnConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotColumnConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotColumnConnectorsStartMarkerOptions]
  }
}
