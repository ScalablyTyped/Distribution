...
trait PlotTimelineStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTimelineStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTimelineStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineStatesHoverMarkerStatesSelectOptions]
  }
}
