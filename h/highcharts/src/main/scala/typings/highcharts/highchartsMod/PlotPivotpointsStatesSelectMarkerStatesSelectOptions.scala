...
trait PlotPivotpointsStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPivotpointsStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPivotpointsStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsStatesSelectMarkerStatesSelectOptions]
  }
}
