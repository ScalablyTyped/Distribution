...
trait PlotRocStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotRocStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotRocStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotRocStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotRocStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotRocStatesSelectMarkerOptions]
  }
}
