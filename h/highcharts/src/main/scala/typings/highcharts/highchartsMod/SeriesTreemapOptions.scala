...
import typings.highcharts.highchartsStrings.treemap
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotTreemapOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowDrillToNode, allowPointSelect, allowTraversingTree, alternateStartingDirection, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorAxis, colorByPoint, colorIndex, colors, compare, compareBase, compareStart, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, drillUpButton, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, ignoreHiddenPoint, includeInDataExport, interactByLeaf, joinBy, keys, label, lastPrice, lastVisiblePrice, layoutAlgorithm, layoutStartingDirection, levelIsConstant, levels, linecap, lineWidth, linkedTo, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointRange, pointStart, selected, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, sortIndex, stacking, states, step, stickyTracking, threshold, tooltip, traverseUpButton, turboThreshold, visible, zoneAxis, zones */ trait SeriesTreemapOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[Double | Null | SeriesTreemapDataOptions]] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesTreemapOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesTreemapOptions: treemap
  /**
...
object SeriesTreemapOptions {
  ...
  def apply(
    ...
    data: js.Array[Double | Null | SeriesTreemapDataOptions] = null,
