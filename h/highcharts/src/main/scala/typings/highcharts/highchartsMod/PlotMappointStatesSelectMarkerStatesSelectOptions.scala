...
trait PlotMappointStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMappointStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMappointStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMappointStatesSelectMarkerStatesSelectOptions]
  }
}
