...
trait PlotMfiStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMfiStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotMfiStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMfiStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMfiStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMfiStatesSelectMarkerOptions]
  }
}
