...
trait PlotPivotpointsStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPivotpointsStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPivotpointsStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsStatesHoverMarkerStatesSelectOptions]
  }
}
