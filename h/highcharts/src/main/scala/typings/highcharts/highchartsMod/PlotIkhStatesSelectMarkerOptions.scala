...
trait PlotIkhStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotIkhStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotIkhStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotIkhStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotIkhStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotIkhStatesSelectMarkerOptions]
  }
}
