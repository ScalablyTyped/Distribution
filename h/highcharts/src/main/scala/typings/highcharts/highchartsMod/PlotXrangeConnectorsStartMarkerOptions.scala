...
trait PlotXrangeConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotXrangeConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotXrangeConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotXrangeConnectorsStartMarkerOptions]
  }
}
