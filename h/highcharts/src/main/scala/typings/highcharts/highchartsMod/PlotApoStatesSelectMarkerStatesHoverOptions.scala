...
trait PlotApoStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotApoStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotApoStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotApoStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotApoStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotApoStatesSelectMarkerStatesHoverOptions]
  }
}
