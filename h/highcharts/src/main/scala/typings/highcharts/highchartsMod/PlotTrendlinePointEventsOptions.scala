...
trait PlotTrendlinePointEventsOptions extends js.Object {
  /**
...
object PlotTrendlinePointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrendlinePointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlinePointEventsOptions]
  }
}
