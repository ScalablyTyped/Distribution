...
- typings.highcharts.highchartsMod.PlotDependencywheelOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, boostBlending, borderColor, borderWidth, center, className, clip, color, colorAxis, colorByPoint, colorIndex, colors, compare, compareBase, compareStart, connectors, cursor, curveFactor, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, getExtremesFromAll, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, levels, linkedTo, linkOpacity, minPointLength, navigatorOptions, nodePadding, nodeWidth, opacity, point, pointDescriptionFormatter, selected, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, startAngle, states, stickyTracking, tooltip, turboThreshold, visible */ trait SeriesDependencywheelOptions
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesDependencywheelOptions: dependencywheel
  /**
