...
trait PlotTrixMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTrixMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotTrixMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTrixMarkerStatesHoverAnimationOptions = null,
