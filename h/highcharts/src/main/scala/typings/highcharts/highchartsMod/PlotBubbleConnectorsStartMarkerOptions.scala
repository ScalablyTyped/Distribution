...
trait PlotBubbleConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotBubbleConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBubbleConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleConnectorsStartMarkerOptions]
  }
}
