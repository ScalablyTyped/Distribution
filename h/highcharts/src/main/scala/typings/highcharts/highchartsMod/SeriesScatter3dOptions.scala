...
import typings.highcharts.highchartsStrings.scatter3d
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotScatter3dOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, compare, compareBase, compareStart, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, includeInDataExport, jitter, joinBy, keys, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, marker, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointRange, pointStart, selected, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, states, step, stickyTracking, threshold, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesScatter3dOptions
  ...
  /**
    ...
    */
  var accessibility: js.UndefOr[js.Object | PlotScatter3dAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotScatter3dAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotScatter3dConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[js.Array[Double] | SeriesScatter3dDataOptions]] = js.undefined
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotScatter3dDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotScatter3dEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var jitter: js.UndefOr[PlotScatter3dJitterOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var lastPrice: js.UndefOr[PlotScatter3dLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotScatter3dLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotScatter3dMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var point: js.UndefOr[PlotScatter3dPointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotScatter3dStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    * in the pointFormat.
    */
  var tooltip: js.UndefOr[PlotScatter3dTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesScatter3dOptions: scatter3d
  /**
    * Not available
    */
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotScatter3dZonesOptions]] = js.undefined
}

object SeriesScatter3dOptions {
  @scala.inline
  def apply(
    `type`: scatter3d,
    ...
    __obj.asInstanceOf[SeriesScatter3dOptions]
  }
}
