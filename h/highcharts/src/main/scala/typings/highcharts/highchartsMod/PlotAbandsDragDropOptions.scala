...
trait PlotAbandsDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotAbandsDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotAbandsDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotAbandsDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotAbandsDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotAbandsDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotAbandsDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsDragDropOptions]
  }
}
