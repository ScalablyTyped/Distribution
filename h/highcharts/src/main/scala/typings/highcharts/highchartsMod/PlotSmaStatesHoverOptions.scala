...
trait PlotSmaStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSmaStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSmaStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSmaStatesHoverMarkerOptions] = js.undefined
}

object PlotSmaStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSmaStatesHoverAnimationOptions = null,
    ...
    marker: PlotSmaStatesHoverMarkerOptions = null
  ): PlotSmaStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotSmaStatesHoverOptions]
  }
}
