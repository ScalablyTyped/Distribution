...
trait PlotRocStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotRocStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotRocStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotRocStatesSelectMarkerOptions] = js.undefined
}

object PlotRocStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotRocStatesSelectAnimationOptions = null,
    ...
    marker: PlotRocStatesSelectMarkerOptions = null
  ): PlotRocStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotRocStatesSelectOptions]
  }
}
