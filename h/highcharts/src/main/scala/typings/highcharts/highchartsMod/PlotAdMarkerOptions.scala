...
trait PlotAdMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAdMarkerStatesOptions] = js.undefined
  /**
...
object PlotAdMarkerOptions {
  ...
  def apply(
    ...
    states: PlotAdMarkerStatesOptions = null,
    symbol: String = null,
    ...
    __obj.asInstanceOf[PlotAdMarkerOptions]
  }
}
