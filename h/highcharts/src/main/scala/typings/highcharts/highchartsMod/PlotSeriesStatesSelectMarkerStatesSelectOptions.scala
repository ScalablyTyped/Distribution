...
trait PlotSeriesStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotSeriesStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSeriesStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesStatesSelectMarkerStatesSelectOptions]
  }
}
