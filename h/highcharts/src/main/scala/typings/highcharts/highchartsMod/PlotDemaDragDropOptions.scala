...
trait PlotDemaDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotDemaDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotDemaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotDemaDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotDemaDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotDemaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotDemaDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotDemaDragDropOptions]
  }
}
