...
trait PlotAoMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAoMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAoMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAoMarkerStatesSelectOptions]
  }
}
