...
trait PlotSplineDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotSplineDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSplineDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotSplineDragDropGuideBoxDefaultOptions]
  }
}
