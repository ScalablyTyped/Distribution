...
trait PlotStreamgraphTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotStreamgraphTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotStreamgraphTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphTooltipDateTimeLabelFormatsOptions]
  }
}
