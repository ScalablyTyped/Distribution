...
trait PlotAroonStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAroonStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAroonStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAroonStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAroonStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAroonStatesHoverMarkerStatesHoverOptions]
  }
}
