...
trait SeriesPieDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesPieDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesPieDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesPieDataDragDropDragHandleOptions]
  }
}
