...
trait PlotSolidgaugePointEventsOptions extends js.Object {
  /**
...
object PlotSolidgaugePointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSolidgaugePointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotSolidgaugePointEventsOptions]
  }
}
