...
trait SeriesXrangeDataMarkerStatesSelectOptions extends js.Object {
  /**
...
object SeriesXrangeDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesXrangeDataMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[SeriesXrangeDataMarkerStatesSelectOptions]
  }
}
