...
trait PlotMacdDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotMacdDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMacdDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotMacdDragDropDragHandleOptions]
  }
}
