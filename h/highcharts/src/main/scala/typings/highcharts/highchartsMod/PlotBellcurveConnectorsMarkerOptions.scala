...
trait PlotBellcurveConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotBellcurveConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBellcurveConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveConnectorsMarkerOptions]
  }
}
