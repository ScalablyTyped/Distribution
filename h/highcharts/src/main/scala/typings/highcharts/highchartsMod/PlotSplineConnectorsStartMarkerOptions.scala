...
trait PlotSplineConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotSplineConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSplineConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSplineConnectorsStartMarkerOptions]
  }
}
