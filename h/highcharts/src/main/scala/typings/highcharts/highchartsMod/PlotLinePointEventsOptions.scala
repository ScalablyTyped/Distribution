...
trait PlotLinePointEventsOptions extends js.Object {
  /**
...
object PlotLinePointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotLinePointEventsOptions]
  }
}
