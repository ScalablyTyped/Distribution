...
trait PlotLinearregressioninterceptConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressioninterceptConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptConnectorsEndMarkerOptions]
  }
}
