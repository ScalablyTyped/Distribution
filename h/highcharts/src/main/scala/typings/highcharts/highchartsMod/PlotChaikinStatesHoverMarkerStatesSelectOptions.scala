...
trait PlotChaikinStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotChaikinStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotChaikinStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinStatesHoverMarkerStatesSelectOptions]
  }
}
