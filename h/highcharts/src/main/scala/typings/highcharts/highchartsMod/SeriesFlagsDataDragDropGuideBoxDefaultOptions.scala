...
trait SeriesFlagsDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesFlagsDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesFlagsDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesFlagsDataDragDropGuideBoxDefaultOptions]
  }
}
