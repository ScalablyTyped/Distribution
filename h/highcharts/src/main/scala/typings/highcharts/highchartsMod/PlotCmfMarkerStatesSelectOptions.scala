...
trait PlotCmfMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotCmfMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCmfMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotCmfMarkerStatesSelectOptions]
  }
}
