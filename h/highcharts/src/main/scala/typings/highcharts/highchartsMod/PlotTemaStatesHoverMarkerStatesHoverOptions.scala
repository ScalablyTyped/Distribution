...
trait PlotTemaStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotTemaStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotTemaStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTemaStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotTemaStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTemaStatesHoverMarkerStatesHoverOptions]
  }
}
