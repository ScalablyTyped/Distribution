...
trait SeriesWordcloudDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesWordcloudDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesWordcloudDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesWordcloudDataDragDropDragHandleOptions]
  }
}
