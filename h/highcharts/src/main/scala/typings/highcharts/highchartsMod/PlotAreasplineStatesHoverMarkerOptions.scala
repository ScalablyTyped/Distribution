...
trait PlotAreasplineStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAreasplineStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotAreasplineStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAreasplineStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAreasplineStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineStatesHoverMarkerOptions]
  }
}
