...
trait PlotParetoDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotParetoDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotParetoDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotParetoDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotParetoDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotParetoDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotParetoDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotParetoDragDropOptions]
  }
}
