...
trait PlotPcDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotPcDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotPcDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotPcDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotPcDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotPcDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotPcDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotPcDragDropOptions]
  }
}
