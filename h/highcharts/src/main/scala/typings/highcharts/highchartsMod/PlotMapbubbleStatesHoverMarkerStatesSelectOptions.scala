...
trait PlotMapbubbleStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMapbubbleStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapbubbleStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleStatesHoverMarkerStatesSelectOptions]
  }
}
