...
trait PlotPyramidDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotPyramidDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotPyramidDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotPyramidDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotPyramidDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotPyramidDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotPyramidDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotPyramidDragDropOptions]
  }
}
