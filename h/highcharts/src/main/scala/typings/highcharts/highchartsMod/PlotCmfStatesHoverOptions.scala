...
trait PlotCmfStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotCmfStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotCmfStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotCmfStatesHoverMarkerOptions] = js.undefined
}

object PlotCmfStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotCmfStatesHoverAnimationOptions = null,
    ...
    marker: PlotCmfStatesHoverMarkerOptions = null
  ): PlotCmfStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotCmfStatesHoverOptions]
  }
}
