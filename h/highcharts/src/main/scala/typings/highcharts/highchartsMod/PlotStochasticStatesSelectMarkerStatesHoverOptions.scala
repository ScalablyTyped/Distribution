...
trait PlotStochasticStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotStochasticStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotStochasticStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotStochasticStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotStochasticStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticStatesSelectMarkerStatesHoverOptions]
  }
}
