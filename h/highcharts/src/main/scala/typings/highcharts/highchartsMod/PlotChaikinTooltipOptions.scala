...
trait PlotChaikinTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotChaikinTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotChaikinTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    className: String = null,
    dateTimeLabelFormats: PlotChaikinTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
    ...
    __obj.asInstanceOf[PlotChaikinTooltipOptions]
  }
}
