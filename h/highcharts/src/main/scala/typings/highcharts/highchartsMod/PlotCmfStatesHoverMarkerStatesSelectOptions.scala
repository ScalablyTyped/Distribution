...
trait PlotCmfStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotCmfStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCmfStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotCmfStatesHoverMarkerStatesSelectOptions]
  }
}
