...
trait PlotNetworkgraphAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotNetworkgraphAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotNetworkgraphAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotNetworkgraphAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotNetworkgraphAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphAccessibilityOptions]
  }
}
