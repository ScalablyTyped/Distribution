...
trait PlotMomentumMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMomentumMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotMomentumMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMomentumMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMomentumMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumMarkerStatesHoverOptions]
  }
}
