...
trait PlotSolidgaugeDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotSolidgaugeDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotSolidgaugeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotSolidgaugeDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotSolidgaugeDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotSolidgaugeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotSolidgaugeDragDropOptions]
  }
}
