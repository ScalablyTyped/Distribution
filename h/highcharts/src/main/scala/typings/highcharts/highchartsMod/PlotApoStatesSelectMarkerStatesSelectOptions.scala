...
trait PlotApoStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotApoStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotApoStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotApoStatesSelectMarkerStatesSelectOptions]
  }
}
