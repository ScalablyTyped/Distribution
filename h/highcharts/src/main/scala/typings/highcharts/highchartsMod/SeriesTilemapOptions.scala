...
- typings.highcharts.highchartsMod.PlotTilemapOptions because var conflicts: zIndex. Inlined accessibility, allowPointSelect, animation, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, colsize, compare, compareBase, compareStart, connectors, cropThreshold, cursor, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, gapSize, gapUnit, includeInDataExport, keys, label, lastPrice, lastVisiblePrice, linkedTo, navigatorOptions, negativeColor, nullColor, opacity, point, pointDescriptionFormatter, pointPadding, rowsize, selected, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, states, stickyTracking, tileShape, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesTilemapOptions
  ...
  /**
    ...
    */
  @JSName("mapData")
  var mapData_SeriesTilemapOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesTilemapOptions: js.UndefOr[scala.Nothing] = js.undefined
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesTilemapOptions: tilemap
  /**
...
object SeriesTilemapOptions {
  ...
  def apply(
    ...
    mapData: js.UndefOr[scala.Nothing] = js.undefined,
    name: String = null,
    ...
    if (!js.isUndefined(mapData)) __obj.updateDynamic("mapData")(mapData)
