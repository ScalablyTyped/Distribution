...
trait PlotPyramidDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotPyramidDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramidDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotPyramidDragDropDragHandleOptions]
  }
}
