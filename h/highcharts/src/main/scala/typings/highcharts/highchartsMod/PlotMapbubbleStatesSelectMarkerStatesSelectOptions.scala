...
trait PlotMapbubbleStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMapbubbleStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapbubbleStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleStatesSelectMarkerStatesSelectOptions]
  }
}
