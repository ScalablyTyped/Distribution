...
trait PlotVwapMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotVwapMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotVwapMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVwapMarkerStatesHoverAnimationOptions = null,
