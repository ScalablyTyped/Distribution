...
trait PlotPackedbubbleDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotPackedbubbleDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotPackedbubbleDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotPackedbubbleDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotPackedbubbleDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotPackedbubbleDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotPackedbubbleDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleDragDropOptions]
  }
}
