...
trait PlotPpoStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPpoStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotPpoStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPpoStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPpoStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPpoStatesHoverMarkerOptions]
  }
}
