...
trait PlotPriceenvelopesConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotPriceenvelopesConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPriceenvelopesConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotPriceenvelopesConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotPriceenvelopesConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotPriceenvelopesConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotPriceenvelopesConnectorsMarkerOptions = null,
    startMarker: PlotPriceenvelopesConnectorsStartMarkerOptions = null,
    ...
    __obj.asInstanceOf[PlotPriceenvelopesConnectorsOptions]
  }
}
