...
trait PlotSolidgaugeDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotSolidgaugeDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSolidgaugeDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotSolidgaugeDragDropDragHandleOptions]
  }
}
