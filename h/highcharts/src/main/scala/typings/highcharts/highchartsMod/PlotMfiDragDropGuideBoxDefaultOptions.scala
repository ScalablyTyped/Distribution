...
trait PlotMfiDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotMfiDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMfiDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotMfiDragDropGuideBoxDefaultOptions]
  }
}
