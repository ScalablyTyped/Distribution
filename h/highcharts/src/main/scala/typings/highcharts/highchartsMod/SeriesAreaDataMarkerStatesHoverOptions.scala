...
trait SeriesAreaDataMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | SeriesAreaDataMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object SeriesAreaDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | SeriesAreaDataMarkerStatesHoverAnimationOptions = null,
