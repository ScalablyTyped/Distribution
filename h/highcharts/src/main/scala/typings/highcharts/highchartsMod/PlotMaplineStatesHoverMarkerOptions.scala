...
trait PlotMaplineStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMaplineStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotMaplineStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMaplineStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMaplineStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineStatesHoverMarkerOptions]
  }
}
