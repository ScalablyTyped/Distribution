...
trait PlotPpoConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotPpoConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPpoConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPpoConnectorsMarkerOptions]
  }
}
