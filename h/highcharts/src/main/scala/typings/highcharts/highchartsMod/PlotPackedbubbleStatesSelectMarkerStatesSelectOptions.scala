...
trait PlotPackedbubbleStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPackedbubbleStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPackedbubbleStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleStatesSelectMarkerStatesSelectOptions]
  }
}
