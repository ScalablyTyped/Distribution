...
trait PlotAdDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotAdDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotAdDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotAdDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotAdDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotAdDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotAdDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotAdDragDropOptions]
  }
}
