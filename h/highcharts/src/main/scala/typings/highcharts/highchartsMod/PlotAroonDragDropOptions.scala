...
trait PlotAroonDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotAroonDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotAroonDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotAroonDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotAroonDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotAroonDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotAroonDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotAroonDragDropOptions]
  }
}
