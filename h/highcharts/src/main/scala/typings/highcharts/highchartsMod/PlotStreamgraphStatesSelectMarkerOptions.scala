...
trait PlotStreamgraphStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotStreamgraphStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotStreamgraphStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotStreamgraphStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotStreamgraphStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphStatesSelectMarkerOptions]
  }
}
