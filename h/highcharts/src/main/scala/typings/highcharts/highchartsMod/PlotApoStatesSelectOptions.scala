...
trait PlotApoStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotApoStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotApoStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotApoStatesSelectMarkerOptions] = js.undefined
}

object PlotApoStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotApoStatesSelectAnimationOptions = null,
    ...
    marker: PlotApoStatesSelectMarkerOptions = null
  ): PlotApoStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotApoStatesSelectOptions]
  }
}
