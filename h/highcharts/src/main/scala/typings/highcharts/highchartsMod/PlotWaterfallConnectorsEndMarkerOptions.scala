...
trait PlotWaterfallConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotWaterfallConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWaterfallConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWaterfallConnectorsEndMarkerOptions]
  }
}
