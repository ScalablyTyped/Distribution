...
trait PlotVariablepieStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotVariablepieStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVariablepieStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepieStatesSelectMarkerStatesSelectOptions]
  }
}
