...
trait PlotParetoStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotParetoStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotParetoStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotParetoStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotParetoStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotParetoStatesSelectMarkerStatesHoverOptions]
  }
}
