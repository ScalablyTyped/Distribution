...
trait PlotTimelineStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTimelineStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotTimelineStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotTimelineStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotTimelineStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineStatesSelectMarkerOptions]
  }
}
