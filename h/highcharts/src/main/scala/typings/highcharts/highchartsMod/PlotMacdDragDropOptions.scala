...
trait PlotMacdDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotMacdDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotMacdDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotMacdDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotMacdDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotMacdDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotMacdDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotMacdDragDropOptions]
  }
}
