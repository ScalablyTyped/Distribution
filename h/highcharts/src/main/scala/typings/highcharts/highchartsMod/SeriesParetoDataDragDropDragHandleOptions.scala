...
trait SeriesParetoDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesParetoDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesParetoDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesParetoDataDragDropDragHandleOptions]
  }
}
