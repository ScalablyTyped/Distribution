...
trait PlotDemaStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotDemaStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotDemaStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotDemaStatesHoverMarkerOptions] = js.undefined
}

object PlotDemaStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotDemaStatesHoverAnimationOptions = null,
    ...
    marker: PlotDemaStatesHoverMarkerOptions = null
  ): PlotDemaStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotDemaStatesHoverOptions]
  }
}
