...
trait PlotDemaStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotDemaStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotDemaStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotDemaStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotDemaStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotDemaStatesHoverMarkerOptions]
  }
}
