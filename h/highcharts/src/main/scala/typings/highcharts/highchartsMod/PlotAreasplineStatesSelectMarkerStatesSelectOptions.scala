...
trait PlotAreasplineStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAreasplineStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplineStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineStatesSelectMarkerStatesSelectOptions]
  }
}
