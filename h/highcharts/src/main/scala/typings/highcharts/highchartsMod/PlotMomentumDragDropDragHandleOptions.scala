...
trait PlotMomentumDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotMomentumDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMomentumDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumDragDropDragHandleOptions]
  }
}
