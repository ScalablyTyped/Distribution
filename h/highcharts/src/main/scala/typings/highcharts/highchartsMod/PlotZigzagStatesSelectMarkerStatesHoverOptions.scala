...
trait PlotZigzagStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotZigzagStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotZigzagStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotZigzagStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotZigzagStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagStatesSelectMarkerStatesHoverOptions]
  }
}
