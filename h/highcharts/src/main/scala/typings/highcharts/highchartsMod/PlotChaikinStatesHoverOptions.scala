...
trait PlotChaikinStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotChaikinStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotChaikinStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotChaikinStatesHoverMarkerOptions] = js.undefined
}

object PlotChaikinStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotChaikinStatesHoverAnimationOptions = null,
    ...
    marker: PlotChaikinStatesHoverMarkerOptions = null
  ): PlotChaikinStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinStatesHoverOptions]
  }
}
