...
trait PlotItemStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotItemStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotItemStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotItemStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotItemStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotItemStatesSelectMarkerStatesHoverOptions]
  }
}
