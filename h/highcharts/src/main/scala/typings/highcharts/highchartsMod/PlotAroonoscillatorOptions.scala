...
trait PlotAroonoscillatorOptions extends js.Object {
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotAroonoscillatorDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    * points.
    */
  var params: js.UndefOr[PlotAroonoscillatorParamsOptions] = js.undefined
  /**
...
object PlotAroonoscillatorOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PlotAroonoscillatorOptions]
  }
}
