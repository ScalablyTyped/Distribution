...
import typings.highcharts.highchartsStrings.line
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotLineOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, compare, compareBase, compareStart, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, marker, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointPlacement, pointRange, pointStart, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, states, step, stickyTracking, threshold, tooltip, turboThreshold, useOhlcData, visible, zoneAxis, zones */ trait SeriesLineOptions
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesLineOptions: line
  /**
...
object SeriesLineOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SeriesLineOptions]
  }
}
