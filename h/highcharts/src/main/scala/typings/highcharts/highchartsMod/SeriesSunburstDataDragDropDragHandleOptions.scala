...
trait SeriesSunburstDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesSunburstDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesSunburstDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesSunburstDataDragDropDragHandleOptions]
  }
}
