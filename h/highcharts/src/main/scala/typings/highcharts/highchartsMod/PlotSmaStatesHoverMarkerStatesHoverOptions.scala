...
trait PlotSmaStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotSmaStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotSmaStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSmaStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotSmaStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotSmaStatesHoverMarkerStatesHoverOptions]
  }
}
