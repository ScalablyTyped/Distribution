...
trait PlotSmaStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSmaStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotSmaStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotSmaStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotSmaStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSmaStatesSelectMarkerOptions]
  }
}
