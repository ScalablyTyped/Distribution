...
trait PlotAbandsDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotAbandsDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAbandsDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsDragDropDragHandleOptions]
  }
}
