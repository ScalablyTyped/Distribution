...
trait SeriesMapDataEventsOptions extends js.Object {
  /**
...
object SeriesMapDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesMapDataEventsOptions]
  }
}
