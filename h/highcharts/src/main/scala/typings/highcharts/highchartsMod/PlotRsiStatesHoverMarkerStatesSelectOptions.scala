...
trait PlotRsiStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotRsiStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRsiStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotRsiStatesHoverMarkerStatesSelectOptions]
  }
}
