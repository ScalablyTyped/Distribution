...
trait PlotTemaStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTemaStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTemaStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTemaStatesSelectMarkerStatesSelectOptions]
  }
}
