...
trait PlotPpoStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPpoStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPpoStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPpoStatesSelectMarkerStatesSelectOptions]
  }
}
