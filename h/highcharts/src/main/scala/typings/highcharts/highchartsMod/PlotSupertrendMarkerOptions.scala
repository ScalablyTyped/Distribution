...
trait PlotSupertrendMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSupertrendMarkerStatesOptions] = js.undefined
  /**
...
object PlotSupertrendMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotSupertrendMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotSupertrendMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendMarkerOptions]
  }
}
