...
trait SeriesErrorbarDataEventsOptions extends js.Object {
  /**
...
object SeriesErrorbarDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesErrorbarDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesErrorbarDataEventsOptions]
  }
}
