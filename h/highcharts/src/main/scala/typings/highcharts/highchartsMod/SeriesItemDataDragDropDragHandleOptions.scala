...
trait SeriesItemDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesItemDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesItemDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesItemDataDragDropDragHandleOptions]
  }
}
