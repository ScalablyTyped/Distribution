...
- typings.highcharts.highchartsMod.PlotAoOptions because var conflicts: name, zIndex. Inlined accessibility, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorIndex, compare, compareBase, compareStart, compareToMain, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, greaterBarColor, groupPadding, includeInDataExport, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, lowerBarColor, marker, negativeColor, opacity, point, pointDescriptionFormatter, pointPadding, selected, shadow, showCheckbox, showInLegend, skipKeyboardNavigation, softThreshold, states, step, stickyTracking, threshold, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesAoOptions
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotAoDragDropOptions] = js.undefined
  /**
...
object SeriesAoOptions {
  ...
  def apply(
    ...
    dragDrop: PlotAoDragDropOptions = null,
