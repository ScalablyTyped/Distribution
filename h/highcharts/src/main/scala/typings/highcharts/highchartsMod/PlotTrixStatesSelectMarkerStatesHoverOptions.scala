...
trait PlotTrixStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotTrixStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotTrixStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTrixStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotTrixStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTrixStatesSelectMarkerStatesHoverOptions]
  }
}
