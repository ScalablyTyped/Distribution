...
trait PlotSplineStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSplineStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotSplineStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotSplineStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotSplineStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSplineStatesSelectMarkerOptions]
  }
}
