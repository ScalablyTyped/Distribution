...
- typings.highcharts.highchartsMod.PlotSunburstOptions because var conflicts: zIndex. Inlined accessibility, allowDrillToNode, allowPointSelect, allowTraversingTree, animation, boostBlending, borderColor, borderWidth, center, className, color, colorByPoint, colorIndex, colors, compareStart, connectors, cursor, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, includeInDataExport, keys, lastPrice, lastVisiblePrice, levelIsConstant, levels, levelSize, linkedTo, opacity, point, pointDescriptionFormatter, rootId, selected, shadow, showCheckbox, showInLegend, showInNavigator, size, skipKeyboardNavigation, slicedOffset, startAngle, states, stickyTracking, tooltip, traverseUpButton, useOhlcData, visible */ trait SeriesSunburstOptions
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesSunburstOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesSunburstOptions: sunburst
  /**
