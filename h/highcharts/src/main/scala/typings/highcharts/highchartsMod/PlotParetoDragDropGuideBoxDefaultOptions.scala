...
trait PlotParetoDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotParetoDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotParetoDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotParetoDragDropGuideBoxDefaultOptions]
  }
}
