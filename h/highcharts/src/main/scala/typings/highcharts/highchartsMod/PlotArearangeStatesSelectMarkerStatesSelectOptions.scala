...
trait PlotArearangeStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotArearangeStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotArearangeStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeStatesSelectMarkerStatesSelectOptions]
  }
}
