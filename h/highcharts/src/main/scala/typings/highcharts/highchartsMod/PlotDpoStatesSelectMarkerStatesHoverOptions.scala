...
trait PlotDpoStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotDpoStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotDpoStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotDpoStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotDpoStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotDpoStatesSelectMarkerStatesHoverOptions]
  }
}
