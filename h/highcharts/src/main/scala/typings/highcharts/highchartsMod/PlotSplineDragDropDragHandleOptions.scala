...
trait PlotSplineDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotSplineDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSplineDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotSplineDragDropDragHandleOptions]
  }
}
