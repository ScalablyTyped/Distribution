...
trait PlotApoStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotApoStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotApoStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotApoStatesHoverMarkerStatesSelectOptions]
  }
}
