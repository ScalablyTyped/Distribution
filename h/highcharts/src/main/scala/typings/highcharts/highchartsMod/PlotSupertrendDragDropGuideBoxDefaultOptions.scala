...
trait PlotSupertrendDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotSupertrendDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSupertrendDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendDragDropGuideBoxDefaultOptions]
  }
}
