...
trait PlotAbandsDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotAbandsDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAbandsDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsDragDropGuideBoxDefaultOptions]
  }
}
