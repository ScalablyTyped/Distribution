...
trait PlotMomentumStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMomentumStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMomentumStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMomentumStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMomentumStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumStatesSelectMarkerStatesHoverOptions]
  }
}
