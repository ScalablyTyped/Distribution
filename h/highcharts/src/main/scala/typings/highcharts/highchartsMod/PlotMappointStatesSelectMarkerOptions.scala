...
trait PlotMappointStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMappointStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotMappointStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMappointStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMappointStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMappointStatesSelectMarkerOptions]
  }
}
