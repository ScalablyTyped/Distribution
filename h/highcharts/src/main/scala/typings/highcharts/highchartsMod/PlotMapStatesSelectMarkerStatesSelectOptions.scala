...
trait PlotMapStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMapStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMapStatesSelectMarkerStatesSelectOptions]
  }
}
