...
trait PlotNatrStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotNatrStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotNatrStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotNatrStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotNatrStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotNatrStatesSelectMarkerStatesHoverOptions]
  }
}
