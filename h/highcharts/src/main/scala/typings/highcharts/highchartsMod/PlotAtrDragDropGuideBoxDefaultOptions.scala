...
trait PlotAtrDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotAtrDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAtrDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotAtrDragDropGuideBoxDefaultOptions]
  }
}
