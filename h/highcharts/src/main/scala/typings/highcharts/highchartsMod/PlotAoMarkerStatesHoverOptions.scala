...
trait PlotAoMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAoMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotAoMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAoMarkerStatesHoverAnimationOptions = null,
