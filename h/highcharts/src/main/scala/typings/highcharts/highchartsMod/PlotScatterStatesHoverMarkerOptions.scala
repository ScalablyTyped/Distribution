...
trait PlotScatterStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotScatterStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotScatterStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotScatterStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotScatterStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotScatterStatesHoverMarkerOptions]
  }
}
