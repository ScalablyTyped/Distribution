...
trait PlotSeriesStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSeriesStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotSeriesStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotSeriesStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotSeriesStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesStatesHoverMarkerOptions]
  }
}
