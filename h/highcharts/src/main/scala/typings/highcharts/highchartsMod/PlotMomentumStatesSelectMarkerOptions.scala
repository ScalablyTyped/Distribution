...
trait PlotMomentumStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMomentumStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotMomentumStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMomentumStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMomentumStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumStatesSelectMarkerOptions]
  }
}
