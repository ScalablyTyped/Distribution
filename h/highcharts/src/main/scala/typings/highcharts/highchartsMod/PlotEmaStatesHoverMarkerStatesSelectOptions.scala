...
trait PlotEmaStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotEmaStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotEmaStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotEmaStatesHoverMarkerStatesSelectOptions]
  }
}
