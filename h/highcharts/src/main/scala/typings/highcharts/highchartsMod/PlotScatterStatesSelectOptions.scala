...
trait PlotScatterStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotScatterStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotScatterStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotScatterStatesSelectMarkerOptions] = js.undefined
}

object PlotScatterStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotScatterStatesSelectAnimationOptions = null,
    ...
    marker: PlotScatterStatesSelectMarkerOptions = null
  ): PlotScatterStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotScatterStatesSelectOptions]
  }
}
