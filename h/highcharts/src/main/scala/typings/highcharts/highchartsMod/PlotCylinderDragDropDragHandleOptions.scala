...
trait PlotCylinderDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotCylinderDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCylinderDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotCylinderDragDropDragHandleOptions]
  }
}
