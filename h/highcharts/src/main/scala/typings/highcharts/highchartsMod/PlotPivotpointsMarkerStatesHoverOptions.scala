...
trait PlotPivotpointsMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPivotpointsMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPivotpointsMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPivotpointsMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPivotpointsMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsMarkerStatesHoverOptions]
  }
}
