...
trait PlotPsarDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotPsarDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPsarDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotPsarDragDropDragHandleOptions]
  }
}
