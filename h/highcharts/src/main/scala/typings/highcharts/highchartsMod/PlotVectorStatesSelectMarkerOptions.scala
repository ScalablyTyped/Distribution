...
trait PlotVectorStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotVectorStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotVectorStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotVectorStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotVectorStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVectorStatesSelectMarkerOptions]
  }
}
