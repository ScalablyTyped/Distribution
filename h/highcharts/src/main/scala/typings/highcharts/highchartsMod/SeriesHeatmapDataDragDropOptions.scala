...
trait SeriesHeatmapDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highmaps) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesHeatmapDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesHeatmapDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesHeatmapDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesHeatmapDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesHeatmapDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesHeatmapDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesHeatmapDataDragDropOptions]
  }
}
