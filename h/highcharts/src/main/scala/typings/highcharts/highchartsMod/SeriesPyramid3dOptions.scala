...
- typings.highcharts.highchartsMod.PlotPyramid3dOptions because var conflicts: zIndex. Inlined accessibility, allowPointSelect, animation, animationLimit, boostBlending, borderColor, borderRadius, borderWidth, className, clip, color, colorByPoint, colorIndex, colors, compareStart, connectors, crisp, cropThreshold, cursor, dataGrouping, dataLabels, depth, description, dragDrop, edgeColor, edgeWidth, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, getExtremesFromAll, gradientForSides, grouping, groupPadding, groupZPadding, height, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, linkedTo, maxPointWidth, minPointLength, navigatorOptions, neckHeight, neckWidth, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointPadding, pointPlacement, pointRange, pointStart, pointWidth, reversed, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, states, stickyTracking, threshold, tooltip, turboThreshold, visible, width, zoneAxis, zones */ trait SeriesPyramid3dOptions
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesPyramid3dOptions: pyramid3d
  /**
