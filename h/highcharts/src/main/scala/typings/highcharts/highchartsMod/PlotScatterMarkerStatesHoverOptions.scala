...
trait PlotScatterMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotScatterMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotScatterMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotScatterMarkerStatesHoverAnimationOptions = null,
