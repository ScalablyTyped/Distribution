...
trait PlotApoDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotApoDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotApoDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotApoDragDropDragHandleOptions]
  }
}
