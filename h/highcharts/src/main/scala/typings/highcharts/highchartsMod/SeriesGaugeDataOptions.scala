...
trait SeriesGaugeDataOptions extends js.Object {
  var accessibility: js.UndefOr[SeriesGaugeDataAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[SeriesGaugeDataDragDropOptions] = js.undefined
  /**
    * (Highcharts, Highstock, Gantt) Individual point events
    */
  var events: js.UndefOr[SeriesGaugeDataEventsOptions] = js.undefined
  /**
...
object SeriesGaugeDataOptions {
  @scala.inline
  def apply(
    accessibility: SeriesGaugeDataAccessibilityOptions = null,
    className: String = null,
    color: ColorString | GradientColorObject | PatternObject = null,
    colorIndex: Int | Double = null,
    dataLabels: DataLabelsOptionsObject | js.Array[DataLabelsOptionsObject] = null,
    description: String = null,
    dragDrop: SeriesGaugeDataDragDropOptions = null,
    events: SeriesGaugeDataEventsOptions = null,
    id: String = null,
    ...
    __obj.asInstanceOf[SeriesGaugeDataOptions]
  }
}
