...
- typings.highcharts.highchartsMod.PlotItemOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, boostBlending, center, className, clip, color, colorAxis, colorIndex, colors, compare, compareBase, compareStart, connectors, cursor, dataGrouping, dataLabels, description, enableMouseTracking, endAngle, events, exposeElementToA11y, gapSize, gapUnit, ignoreHiddenPoint, includeInDataExport, innerSize, itemPadding, joinBy, keys, lastPrice, lastVisiblePrice, layout, linkedTo, marker, minSize, navigatorOptions, opacity, point, pointDescriptionFormatter, pointRange, rows, selected, showCheckbox, showInLegend, showInNavigator, size, skipKeyboardNavigation, startAngle, states, stickyTracking, tooltip, useOhlcData, visible */ trait SeriesItemOptions
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesItemOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesItemOptions: item
  /**
  ...
  /**
    ...
    */
  @JSName("xAxis")
  var xAxis_SeriesItemOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
    * Not available
    */
  @JSName("yAxis")
  var yAxis_SeriesItemOptions: js.UndefOr[scala.Nothing] = js.undefined
}
