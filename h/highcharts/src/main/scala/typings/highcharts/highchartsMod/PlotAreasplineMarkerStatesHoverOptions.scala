...
trait PlotAreasplineMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAreasplineMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAreasplineMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAreasplineMarkerStatesHoverAnimationOptions = null,
