...
trait PlotCmfStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotCmfStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotCmfStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotCmfStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotCmfStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCmfStatesSelectMarkerOptions]
  }
}
