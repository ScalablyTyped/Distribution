...
trait PlotHeatmapStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotHeatmapStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotHeatmapStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotHeatmapStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotHeatmapStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapStatesSelectMarkerStatesHoverOptions]
  }
}
