...
trait PlotLinearregressionangleStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressionangleStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotLinearregressionangleStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLinearregressionangleStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLinearregressionangleStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleStatesHoverMarkerOptions]
  }
}
