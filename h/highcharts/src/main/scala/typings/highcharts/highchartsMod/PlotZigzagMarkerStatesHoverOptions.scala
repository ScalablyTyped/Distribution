...
trait PlotZigzagMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotZigzagMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotZigzagMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotZigzagMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotZigzagMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagMarkerStatesHoverOptions]
  }
}
