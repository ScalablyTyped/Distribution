...
trait PlotAtrConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotAtrConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAtrConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAtrConnectorsEndMarkerOptions]
  }
}
