...
trait SeriesLineDataOptions extends js.Object {
  var accessibility: js.UndefOr[SeriesLineDataAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[SeriesLineDataEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[SeriesLineDataMarkerOptions] = js.undefined
  /**
...
object SeriesLineDataOptions {
  @scala.inline
  def apply(
    accessibility: SeriesLineDataAccessibilityOptions = null,
    ...
    events: SeriesLineDataEventsOptions = null,
    id: String = null,
    labelrank: Int | Double = null,
    marker: SeriesLineDataMarkerOptions = null,
    name: String = null,
    ...
    __obj.asInstanceOf[SeriesLineDataOptions]
  }
}
