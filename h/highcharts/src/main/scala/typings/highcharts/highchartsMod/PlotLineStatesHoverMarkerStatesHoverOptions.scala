...
trait PlotLineStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLineStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLineStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLineStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotLineStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLineStatesHoverMarkerStatesHoverOptions]
  }
}
