...
trait PlotHistogramPointEventsOptions extends js.Object {
  /**
...
object PlotHistogramPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotHistogramPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotHistogramPointEventsOptions]
  }
}
