...
trait PlotGanttTooltipOptions extends js.Object {
  /**
  ...
  /**
    * (Gantt) A CSS class name to apply to the tooltip's container div,
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotGanttTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  ...
  /**
    ...
    * color.
    */
  var pointFormat: js.UndefOr[js.Any] = js.undefined
  /**
...
object PlotGanttTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    className: String = null,
    dateTimeLabelFormats: PlotGanttTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
    ...
    __obj.asInstanceOf[PlotGanttTooltipOptions]
  }
}
