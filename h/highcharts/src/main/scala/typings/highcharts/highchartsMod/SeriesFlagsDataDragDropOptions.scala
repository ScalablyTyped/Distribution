...
trait SeriesFlagsDataDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesFlagsDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesFlagsDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesFlagsDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesFlagsDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesFlagsDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesFlagsDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesFlagsDataDragDropOptions]
  }
}
