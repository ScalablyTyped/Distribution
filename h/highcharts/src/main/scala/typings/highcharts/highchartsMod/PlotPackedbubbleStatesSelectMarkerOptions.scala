...
trait PlotPackedbubbleStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPackedbubbleStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotPackedbubbleStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPackedbubbleStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPackedbubbleStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleStatesSelectMarkerOptions]
  }
}
