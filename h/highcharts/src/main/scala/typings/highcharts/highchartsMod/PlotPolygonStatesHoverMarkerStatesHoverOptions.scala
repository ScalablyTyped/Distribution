...
trait PlotPolygonStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPolygonStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPolygonStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPolygonStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPolygonStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonStatesHoverMarkerStatesHoverOptions]
  }
}
