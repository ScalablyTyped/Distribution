...
trait PlotScatterStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotScatterStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotScatterStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotScatterStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotScatterStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotScatterStatesSelectMarkerOptions]
  }
}
