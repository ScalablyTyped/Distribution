...
trait PlotPcStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPcStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPcStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPcStatesHoverMarkerStatesSelectOptions]
  }
}
