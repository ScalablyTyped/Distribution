...
trait PlotTreemapStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotTreemapStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotTreemapStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTreemapStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotTreemapStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapStatesHoverMarkerStatesHoverOptions]
  }
}
