...
trait PlotLinearregressioninterceptStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressioninterceptStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptStatesSelectMarkerStatesSelectOptions]
  }
}
