...
trait PlotPackedbubbleDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotPackedbubbleDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPackedbubbleDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleDragDropDragHandleOptions]
  }
}
