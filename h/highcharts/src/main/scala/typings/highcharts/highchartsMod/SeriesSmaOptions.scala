...
import typings.highcharts.highchartsStrings.sma
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotSmaOptions because var conflicts: name, zIndex. Inlined accessibility, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorIndex, compare, compareBase, compareStart, compareToMain, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, includeInDataExport, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, marker, negativeColor, opacity, params, point, pointDescriptionFormatter, selected, shadow, showCheckbox, showInLegend, skipKeyboardNavigation, softThreshold, states, step, stickyTracking, threshold, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesSmaOptions
  ...
  /**
    ...
    */
  var accessibility: js.UndefOr[js.Object | PlotSmaAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSmaAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotSmaConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotSmaDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotSmaDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotSmaEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[PlotSmaLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotSmaLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotSmaLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSmaMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotSmaParamsOptions] = js.undefined
  /**
    * (Highstock) Properties for each single point.
    */
  var point: js.UndefOr[PlotSmaPointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotSmaStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotSmaTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotSmaZonesOptions]] = js.undefined
}
...
object SeriesSmaOptions {
  ...
  def apply(
    ...
    dragDrop: PlotSmaDragDropOptions = null,
