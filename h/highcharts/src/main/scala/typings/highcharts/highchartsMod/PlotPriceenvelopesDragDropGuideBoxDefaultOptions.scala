...
trait PlotPriceenvelopesDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotPriceenvelopesDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPriceenvelopesDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesDragDropGuideBoxDefaultOptions]
  }
}
