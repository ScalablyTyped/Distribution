...
trait PlotChaikinStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotChaikinStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotChaikinStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinStatesSelectMarkerStatesSelectOptions]
  }
}
