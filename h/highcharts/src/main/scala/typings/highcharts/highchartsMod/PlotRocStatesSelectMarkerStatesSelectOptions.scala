...
trait PlotRocStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotRocStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRocStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotRocStatesSelectMarkerStatesSelectOptions]
  }
}
