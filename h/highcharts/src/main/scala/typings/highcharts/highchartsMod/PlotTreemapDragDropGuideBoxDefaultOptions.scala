...
trait PlotTreemapDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotTreemapDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTreemapDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapDragDropGuideBoxDefaultOptions]
  }
}
