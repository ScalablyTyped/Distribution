...
trait PlotWilliamsrStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotWilliamsrStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWilliamsrStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrStatesHoverMarkerStatesSelectOptions]
  }
}
