...
trait PlotMapbubbleConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotMapbubbleConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapbubbleConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleConnectorsStartMarkerOptions]
  }
}
