...
trait PlotLinearregressioninterceptStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressioninterceptStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressioninterceptStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressioninterceptStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressioninterceptStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptStatesSelectMarkerStatesHoverOptions]
  }
}
