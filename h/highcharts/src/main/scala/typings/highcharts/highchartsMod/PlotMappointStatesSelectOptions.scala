...
trait PlotMappointStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotMappointStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMappointStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMappointStatesSelectMarkerOptions] = js.undefined
}

object PlotMappointStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotMappointStatesSelectAnimationOptions = null,
    ...
    marker: PlotMappointStatesSelectMarkerOptions = null
  ): PlotMappointStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMappointStatesSelectOptions]
  }
}
