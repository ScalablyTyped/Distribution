...
trait PlotItemStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotItemStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotItemStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotItemStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotItemStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotItemStatesSelectMarkerOptions]
  }
}
