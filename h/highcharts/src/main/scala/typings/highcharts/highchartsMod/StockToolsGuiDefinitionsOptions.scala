...
object StockToolsGuiDefinitionsOptions {
  ...
  def apply(
    ...
    if (crookedLines != null) __obj.updateDynamic("crookedLines")(crookedLines)
    ...
    if (typeChange != null) __obj.updateDynamic("typeChange")(typeChange)
    if (verticalLabels != null) __obj.updateDynamic("verticalLabels")(verticalLabels)
