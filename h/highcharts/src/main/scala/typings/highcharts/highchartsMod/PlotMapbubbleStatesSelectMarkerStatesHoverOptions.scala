...
trait PlotMapbubbleStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMapbubbleStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMapbubbleStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMapbubbleStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMapbubbleStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleStatesSelectMarkerStatesHoverOptions]
  }
}
