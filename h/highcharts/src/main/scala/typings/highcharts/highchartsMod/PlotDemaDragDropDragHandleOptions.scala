...
trait PlotDemaDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotDemaDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDemaDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotDemaDragDropDragHandleOptions]
  }
}
