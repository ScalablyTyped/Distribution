...
trait PlotAdDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotAdDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAdDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotAdDragDropDragHandleOptions]
  }
}
