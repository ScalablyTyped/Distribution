...
trait PlotTemaPointEventsOptions extends js.Object {
  /**
...
object PlotTemaPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotTemaPointEventsOptions]
  }
}
