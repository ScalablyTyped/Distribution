...
trait PlotLinearregressionslopeMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeMarkerStatesSelectOptions]
  }
}
