...
trait PlotVwapStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotVwapStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotVwapStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVwapStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotVwapStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotVwapStatesSelectMarkerStatesHoverOptions]
  }
}
