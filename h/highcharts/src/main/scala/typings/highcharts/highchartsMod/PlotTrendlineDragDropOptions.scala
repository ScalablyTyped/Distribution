...
trait PlotTrendlineDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotTrendlineDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotTrendlineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotTrendlineDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotTrendlineDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotTrendlineDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotTrendlineDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineDragDropOptions]
  }
}
