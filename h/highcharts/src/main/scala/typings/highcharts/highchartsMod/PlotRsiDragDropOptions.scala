...
trait PlotRsiDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotRsiDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotRsiDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotRsiDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotRsiDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotRsiDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotRsiDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotRsiDragDropOptions]
  }
}
