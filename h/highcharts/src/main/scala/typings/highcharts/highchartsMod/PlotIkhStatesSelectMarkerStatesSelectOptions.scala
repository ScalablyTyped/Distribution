...
trait PlotIkhStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotIkhStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotIkhStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotIkhStatesSelectMarkerStatesSelectOptions]
  }
}
