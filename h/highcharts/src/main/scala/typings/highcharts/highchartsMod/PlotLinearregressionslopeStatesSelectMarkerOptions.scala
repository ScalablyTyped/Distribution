...
trait PlotLinearregressionslopeStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressionslopeStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotLinearregressionslopeStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLinearregressionslopeStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLinearregressionslopeStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeStatesSelectMarkerOptions]
  }
}
