...
trait PlotXrangeStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotXrangeStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotXrangeStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotXrangeStatesHoverAnimationOptions = null,
    borderColor: ColorString = null,
    borderWidth: Int | Double = null,
    brightness: Int | Double = null,
    color: ColorString | GradientColorObject | PatternObject = null,
    enabled: js.UndefOr[Boolean] = js.undefined
  ): PlotXrangeStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotXrangeStatesHoverOptions]
  }
}
