...
trait PlotMfiStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMfiStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMfiStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMfiStatesSelectMarkerStatesSelectOptions]
  }
}
