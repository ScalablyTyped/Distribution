...
trait PlotScatter3dMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotScatter3dMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatter3dMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dMarkerStatesSelectOptions]
  }
}
