...
trait PlotVbpStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotVbpStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVbpStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotVbpStatesHoverMarkerStatesSelectOptions]
  }
}
