...
trait PlotTilemapStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotTilemapStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotTilemapStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTilemapStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotTilemapStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTilemapStatesHoverMarkerStatesHoverOptions]
  }
}
