...
trait SeriesTreemapDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesTreemapDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesTreemapDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesTreemapDataDragDropDragHandleOptions]
  }
}
