...
trait PlotLinearregressioninterceptMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressioninterceptMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressioninterceptMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressioninterceptMarkerStatesHoverAnimationOptions = null,
