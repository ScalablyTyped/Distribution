...
trait PlotZigzagDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotZigzagDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotZigzagDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagDragDropDragHandleOptions]
  }
}
