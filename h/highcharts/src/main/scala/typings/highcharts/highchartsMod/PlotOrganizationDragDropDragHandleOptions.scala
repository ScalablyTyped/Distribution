...
trait PlotOrganizationDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotOrganizationDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotOrganizationDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotOrganizationDragDropDragHandleOptions]
  }
}
