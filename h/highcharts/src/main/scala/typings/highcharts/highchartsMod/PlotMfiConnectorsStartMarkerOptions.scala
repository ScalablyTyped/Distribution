...
trait PlotMfiConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotMfiConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMfiConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMfiConnectorsStartMarkerOptions]
  }
}
