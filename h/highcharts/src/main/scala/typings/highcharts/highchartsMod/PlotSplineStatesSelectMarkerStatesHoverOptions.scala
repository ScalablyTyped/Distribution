...
trait PlotSplineStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotSplineStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotSplineStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSplineStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotSplineStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotSplineStatesSelectMarkerStatesHoverOptions]
  }
}
