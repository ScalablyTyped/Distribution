...
trait PlotFunnelDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotFunnelDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotFunnelDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotFunnelDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotFunnelDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotFunnelDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotFunnelDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotFunnelDragDropOptions]
  }
}
