...
trait PlotVariablepieConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotVariablepieConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVariablepieConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepieConnectorsStartMarkerOptions]
  }
}
