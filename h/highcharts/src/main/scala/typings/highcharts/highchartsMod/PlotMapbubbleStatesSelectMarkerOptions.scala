...
trait PlotMapbubbleStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMapbubbleStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotMapbubbleStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMapbubbleStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMapbubbleStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleStatesSelectMarkerOptions]
  }
}
