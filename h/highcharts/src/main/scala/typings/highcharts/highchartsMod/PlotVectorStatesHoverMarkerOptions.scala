...
trait PlotVectorStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotVectorStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotVectorStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotVectorStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotVectorStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVectorStatesHoverMarkerOptions]
  }
}
