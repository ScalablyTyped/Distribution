...
trait PlotCciMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotCciMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotCciMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotCciMarkerStatesHoverAnimationOptions = null,
