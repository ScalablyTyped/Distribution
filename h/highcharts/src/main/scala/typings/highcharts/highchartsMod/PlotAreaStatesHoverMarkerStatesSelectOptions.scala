...
trait PlotAreaStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAreaStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreaStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAreaStatesHoverMarkerStatesSelectOptions]
  }
}
