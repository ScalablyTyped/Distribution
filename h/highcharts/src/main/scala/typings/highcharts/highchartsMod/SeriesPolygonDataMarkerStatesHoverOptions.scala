...
trait SeriesPolygonDataMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | SeriesPolygonDataMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object SeriesPolygonDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | SeriesPolygonDataMarkerStatesHoverAnimationOptions = null,
