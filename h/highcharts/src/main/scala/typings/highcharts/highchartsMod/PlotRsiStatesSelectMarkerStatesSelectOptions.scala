...
trait PlotRsiStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotRsiStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRsiStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotRsiStatesSelectMarkerStatesSelectOptions]
  }
}
