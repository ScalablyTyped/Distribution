...
trait PlotTimelineConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotTimelineConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTimelineConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineConnectorsEndMarkerOptions]
  }
}
