...
trait PlotAbandsStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAbandsStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAbandsStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsStatesSelectMarkerStatesSelectOptions]
  }
}
