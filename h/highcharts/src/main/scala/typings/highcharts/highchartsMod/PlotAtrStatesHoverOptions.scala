...
trait PlotAtrStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAtrStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAtrStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAtrStatesHoverMarkerOptions] = js.undefined
}

object PlotAtrStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAtrStatesHoverAnimationOptions = null,
    ...
    marker: PlotAtrStatesHoverMarkerOptions = null
  ): PlotAtrStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAtrStatesHoverOptions]
  }
}
