...
trait PlotLinearregressionslopeStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressionslopeStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotLinearregressionslopeStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLinearregressionslopeStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLinearregressionslopeStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeStatesHoverMarkerOptions]
  }
}
