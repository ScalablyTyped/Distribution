...
trait PlotStreamgraphStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotStreamgraphStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotStreamgraphStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotStreamgraphStatesHoverMarkerStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotStreamgraphStatesHoverMarkerStatesHoverOptions]
  }
}
