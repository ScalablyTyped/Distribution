...
trait PlotWaterfallTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotWaterfallTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
...
object PlotWaterfallTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    dateTimeLabelFormats: PlotWaterfallTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
    ...
    __obj.asInstanceOf[PlotWaterfallTooltipOptions]
  }
}
