...
trait PlotVbpStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotVbpStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVbpStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotVbpStatesSelectMarkerStatesSelectOptions]
  }
}
