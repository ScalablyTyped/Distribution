...
trait SeriesWordcloudDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesWordcloudDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesWordcloudDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesWordcloudDataDragDropGuideBoxDefaultOptions]
  }
}
