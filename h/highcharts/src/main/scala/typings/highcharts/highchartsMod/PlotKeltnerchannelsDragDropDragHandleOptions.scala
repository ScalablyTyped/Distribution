...
trait PlotKeltnerchannelsDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsDragDropDragHandleOptions]
  }
}
