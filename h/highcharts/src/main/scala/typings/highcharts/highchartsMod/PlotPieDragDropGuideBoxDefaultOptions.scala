...
trait PlotPieDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotPieDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPieDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotPieDragDropGuideBoxDefaultOptions]
  }
}
