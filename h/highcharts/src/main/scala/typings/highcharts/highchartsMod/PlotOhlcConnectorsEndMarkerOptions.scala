...
trait PlotOhlcConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotOhlcConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotOhlcConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotOhlcConnectorsEndMarkerOptions]
  }
}
