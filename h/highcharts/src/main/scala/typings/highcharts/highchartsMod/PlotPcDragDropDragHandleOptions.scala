...
trait PlotPcDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotPcDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPcDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotPcDragDropDragHandleOptions]
  }
}
