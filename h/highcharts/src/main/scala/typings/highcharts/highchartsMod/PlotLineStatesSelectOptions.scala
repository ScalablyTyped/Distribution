...
trait PlotLineStatesSelectOptions extends js.Object {
  /**
    ...
    * line-type series.
    */
  var animation: js.UndefOr[PlotLineStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLineStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotLineStatesSelectMarkerOptions] = js.undefined
}

object PlotLineStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotLineStatesSelectAnimationOptions = null,
    ...
    marker: PlotLineStatesSelectMarkerOptions = null
