...
trait PlotPsarDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotPsarDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotPsarDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotPsarDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotPsarDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotPsarDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotPsarDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotPsarDragDropOptions]
  }
}
