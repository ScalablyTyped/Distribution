...
trait PlotNetworkgraphMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotNetworkgraphMarkerStatesOptions] = js.undefined
  /**
...
object PlotNetworkgraphMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotNetworkgraphMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotNetworkgraphMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphMarkerOptions]
  }
}
