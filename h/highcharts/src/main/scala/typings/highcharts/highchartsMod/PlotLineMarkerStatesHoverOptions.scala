...
trait PlotLineMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotLineMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotLineMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLineMarkerStatesHoverAnimationOptions = null,
