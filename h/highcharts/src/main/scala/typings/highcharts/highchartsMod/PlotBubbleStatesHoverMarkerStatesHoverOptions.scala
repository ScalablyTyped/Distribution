...
trait PlotBubbleStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotBubbleStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotBubbleStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotBubbleStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotBubbleStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleStatesHoverMarkerStatesHoverOptions]
  }
}
