...
trait PlotTrendlineLabelOptions extends js.Object {
  /**
...
object PlotTrendlineLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotTrendlineLabelOptions]
  }
}
