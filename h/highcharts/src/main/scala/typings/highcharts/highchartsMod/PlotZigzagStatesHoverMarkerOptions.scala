...
trait PlotZigzagStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotZigzagStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotZigzagStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotZigzagStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotZigzagStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagStatesHoverMarkerOptions]
  }
}
