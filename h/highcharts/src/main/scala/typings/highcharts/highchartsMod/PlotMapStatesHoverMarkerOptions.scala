...
trait PlotMapStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMapStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotMapStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMapStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMapStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMapStatesHoverMarkerOptions]
  }
}
