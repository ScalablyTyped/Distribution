...
trait PlotTrixDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotTrixDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrixDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotTrixDragDropGuideBoxDefaultOptions]
  }
}
