...
trait PlotMapStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMapStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMapStatesHoverMarkerStatesSelectOptions]
  }
}
