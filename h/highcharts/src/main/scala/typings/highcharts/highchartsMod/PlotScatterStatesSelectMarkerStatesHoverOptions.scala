...
trait PlotScatterStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotScatterStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotScatterStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotScatterStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotScatterStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotScatterStatesSelectMarkerStatesHoverOptions]
  }
}
