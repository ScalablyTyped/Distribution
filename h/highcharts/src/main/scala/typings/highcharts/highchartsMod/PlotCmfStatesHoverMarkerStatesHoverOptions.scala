...
trait PlotCmfStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotCmfStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotCmfStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotCmfStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotCmfStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotCmfStatesHoverMarkerStatesHoverOptions]
  }
}
