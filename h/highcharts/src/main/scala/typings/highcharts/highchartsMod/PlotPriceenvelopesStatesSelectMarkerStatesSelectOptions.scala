...
trait PlotPriceenvelopesStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPriceenvelopesStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPriceenvelopesStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesStatesSelectMarkerStatesSelectOptions]
  }
}
