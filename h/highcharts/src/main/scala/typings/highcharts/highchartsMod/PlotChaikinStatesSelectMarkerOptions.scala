...
trait PlotChaikinStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotChaikinStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotChaikinStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotChaikinStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotChaikinStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinStatesSelectMarkerOptions]
  }
}
