...
trait PlotSupertrendStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotSupertrendStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSupertrendStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendStatesHoverMarkerStatesSelectOptions]
  }
}
