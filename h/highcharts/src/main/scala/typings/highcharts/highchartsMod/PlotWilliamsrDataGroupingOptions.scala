...
trait PlotWilliamsrDataGroupingOptions extends js.Object {
  /**
...
object PlotWilliamsrDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWilliamsrDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrDataGroupingOptions]
  }
}
