...
trait PlotPieStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPieStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPieStatesHoverHaloOptions | Null] = js.undefined
}

object PlotPieStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPieStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotPieStatesHoverOptions]
  }
}
