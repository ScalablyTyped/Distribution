...
trait PlotStochasticConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotStochasticConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStochasticConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticConnectorsStartMarkerOptions]
  }
}
