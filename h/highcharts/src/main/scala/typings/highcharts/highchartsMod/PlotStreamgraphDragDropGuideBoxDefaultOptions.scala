...
trait PlotStreamgraphDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotStreamgraphDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStreamgraphDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphDragDropGuideBoxDefaultOptions]
  }
}
