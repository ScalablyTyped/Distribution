...
trait PlotPolygonStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPolygonStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPolygonStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonStatesHoverMarkerStatesSelectOptions]
  }
}
