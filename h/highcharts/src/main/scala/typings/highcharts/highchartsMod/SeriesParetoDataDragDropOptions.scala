...
trait SeriesParetoDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesParetoDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesParetoDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesParetoDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesParetoDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesParetoDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[SeriesParetoDataDragDropOptions]
  }
}
