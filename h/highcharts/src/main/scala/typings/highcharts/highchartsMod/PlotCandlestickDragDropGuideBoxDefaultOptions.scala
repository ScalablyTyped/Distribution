...
trait PlotCandlestickDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotCandlestickDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCandlestickDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotCandlestickDragDropGuideBoxDefaultOptions]
  }
}
