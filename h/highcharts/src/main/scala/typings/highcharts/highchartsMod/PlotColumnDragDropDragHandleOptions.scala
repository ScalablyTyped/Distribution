...
trait PlotColumnDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotColumnDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotColumnDragDropDragHandleOptions]
  }
}
