...
trait PlotGaugeDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotGaugeDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotGaugeDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotGaugeDragDropDragHandleOptions]
  }
}
