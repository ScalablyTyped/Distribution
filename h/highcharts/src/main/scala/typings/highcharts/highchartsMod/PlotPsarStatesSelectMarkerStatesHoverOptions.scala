...
trait PlotPsarStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPsarStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPsarStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPsarStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPsarStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPsarStatesSelectMarkerStatesHoverOptions]
  }
}
