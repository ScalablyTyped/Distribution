...
trait PlotBellcurveStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotBellcurveStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBellcurveStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveStatesHoverMarkerStatesSelectOptions]
  }
}
