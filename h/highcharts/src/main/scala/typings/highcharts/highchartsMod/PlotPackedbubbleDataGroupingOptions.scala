...
trait PlotPackedbubbleDataGroupingOptions extends js.Object {
  /**
...
object PlotPackedbubbleDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPackedbubbleDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleDataGroupingOptions]
  }
}
