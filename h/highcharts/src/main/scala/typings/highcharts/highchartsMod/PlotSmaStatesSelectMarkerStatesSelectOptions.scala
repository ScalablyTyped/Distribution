...
trait PlotSmaStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotSmaStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotSmaStatesSelectMarkerStatesSelectOptions]
  }
}
