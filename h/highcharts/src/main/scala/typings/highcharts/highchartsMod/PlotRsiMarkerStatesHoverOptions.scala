...
trait PlotRsiMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotRsiMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotRsiMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotRsiMarkerStatesHoverAnimationOptions = null,
