...
trait PlotPivotpointsDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotPivotpointsDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPivotpointsDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsDragDropDragHandleOptions]
  }
}
