...
trait PlotLinearregressionslopeStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressionslopeStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressionslopeStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressionslopeStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressionslopeStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeStatesHoverMarkerStatesHoverOptions]
  }
}
