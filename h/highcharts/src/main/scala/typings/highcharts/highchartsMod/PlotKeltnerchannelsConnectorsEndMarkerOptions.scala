...
trait PlotKeltnerchannelsConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsConnectorsEndMarkerOptions]
  }
}
