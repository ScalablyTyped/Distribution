...
trait PlotTilemapStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTilemapStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotTilemapStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotTilemapStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotTilemapStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTilemapStatesHoverMarkerOptions]
  }
}
