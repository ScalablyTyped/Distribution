...
trait PlotLinearregressioninterceptDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressioninterceptDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptDragDropGuideBoxDefaultOptions]
  }
}
