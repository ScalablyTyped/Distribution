...
trait PlotAreasplineStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAreasplineStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAreasplineStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAreasplineStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAreasplineStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineStatesHoverMarkerStatesHoverOptions]
  }
}
