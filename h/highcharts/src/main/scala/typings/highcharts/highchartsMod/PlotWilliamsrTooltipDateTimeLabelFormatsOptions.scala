...
trait PlotWilliamsrTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotWilliamsrTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotWilliamsrTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrTooltipDateTimeLabelFormatsOptions]
  }
}
