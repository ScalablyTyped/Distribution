...
trait PlotMomentumStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMomentumStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMomentumStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumStatesHoverMarkerStatesSelectOptions]
  }
}
