...
trait PlotTrendlineDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotTrendlineDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrendlineDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineDragDropGuideBoxDefaultOptions]
  }
}
