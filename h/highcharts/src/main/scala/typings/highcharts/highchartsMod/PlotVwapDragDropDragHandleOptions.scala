...
trait PlotVwapDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotVwapDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVwapDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotVwapDragDropDragHandleOptions]
  }
}
