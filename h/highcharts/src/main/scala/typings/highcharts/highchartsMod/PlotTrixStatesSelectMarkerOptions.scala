...
trait PlotTrixStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTrixStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotTrixStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotTrixStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotTrixStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTrixStatesSelectMarkerOptions]
  }
}
