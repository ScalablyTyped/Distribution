...
trait PlotRocStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotRocStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotRocStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotRocStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotRocStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotRocStatesHoverMarkerStatesHoverOptions]
  }
}
