...
trait PlotBellcurveStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotBellcurveStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotBellcurveStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotBellcurveStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotBellcurveStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveStatesSelectMarkerOptions]
  }
}
