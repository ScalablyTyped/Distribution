...
trait PlotNatrDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotNatrDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotNatrDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotNatrDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotNatrDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotNatrDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotNatrDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotNatrDragDropOptions]
  }
}
