...
trait PlotDpoDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotDpoDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDpoDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotDpoDragDropDragHandleOptions]
  }
}
