...
trait PlotAroonoscillatorStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAroonoscillatorStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAroonoscillatorStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAroonoscillatorStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAroonoscillatorStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorStatesHoverMarkerStatesHoverOptions]
  }
}
