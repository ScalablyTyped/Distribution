...
trait PlotAbandsMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAbandsMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotAbandsMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAbandsMarkerStatesHoverAnimationOptions = null,
