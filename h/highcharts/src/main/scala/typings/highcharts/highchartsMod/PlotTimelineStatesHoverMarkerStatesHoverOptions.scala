...
trait PlotTimelineStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotTimelineStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotTimelineStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTimelineStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotTimelineStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineStatesHoverMarkerStatesHoverOptions]
  }
}
