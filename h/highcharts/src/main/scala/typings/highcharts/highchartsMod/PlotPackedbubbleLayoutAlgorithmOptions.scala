...
object PlotPackedbubbleLayoutAlgorithmOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(dragBetweenSeries)) __obj.updateDynamic("dragBetweenSeries")(dragBetweenSeries)
    ...
    if (!js.isUndefined(parentNodeLimit)) __obj.updateDynamic("parentNodeLimit")(parentNodeLimit)
    if (parentNodeOptions != null) __obj.updateDynamic("parentNodeOptions")(parentNodeOptions)
    if (!js.isUndefined(seriesInteraction)) __obj.updateDynamic("seriesInteraction")(seriesInteraction)
    if (splitSeries != null) __obj.updateDynamic("splitSeries")(splitSeries)
