...
object PlotOptions {
  ...
  def apply(
    ...
    if (abands != null) __obj.updateDynamic("abands")(abands)
    if (ad != null) __obj.updateDynamic("ad")(ad)
    if (ao != null) __obj.updateDynamic("ao")(ao)
    if (apo != null) __obj.updateDynamic("apo")(apo)
    ...
    if (aroon != null) __obj.updateDynamic("aroon")(aroon)
    if (aroonoscillator != null) __obj.updateDynamic("aroonoscillator")(aroonoscillator)
    if (atr != null) __obj.updateDynamic("atr")(atr)
    if (bar != null) __obj.updateDynamic("bar")(bar)
    if (bb != null) __obj.updateDynamic("bb")(bb)
    if (bellcurve != null) __obj.updateDynamic("bellcurve")(bellcurve)
    ...
    if (cci != null) __obj.updateDynamic("cci")(cci)
    if (chaikin != null) __obj.updateDynamic("chaikin")(chaikin)
    if (cmf != null) __obj.updateDynamic("cmf")(cmf)
    if (column != null) __obj.updateDynamic("column")(column)
    if (columnpyramid != null) __obj.updateDynamic("columnpyramid")(columnpyramid)
    if (columnrange != null) __obj.updateDynamic("columnrange")(columnrange)
    if (cylinder != null) __obj.updateDynamic("cylinder")(cylinder)
    if (dema != null) __obj.updateDynamic("dema")(dema)
    if (dependencywheel != null) __obj.updateDynamic("dependencywheel")(dependencywheel)
    if (dpo != null) __obj.updateDynamic("dpo")(dpo)
    if (ema != null) __obj.updateDynamic("ema")(ema)
    if (errorbar != null) __obj.updateDynamic("errorbar")(errorbar)
    if (flags != null) __obj.updateDynamic("flags")(flags)
    if (funnel != null) __obj.updateDynamic("funnel")(funnel)
    if (funnel3d != null) __obj.updateDynamic("funnel3d")(funnel3d)
    ...
    if (ikh != null) __obj.updateDynamic("ikh")(ikh)
    if (item != null) __obj.updateDynamic("item")(item)
    if (keltnerchannels != null) __obj.updateDynamic("keltnerchannels")(keltnerchannels)
    if (line != null) __obj.updateDynamic("line")(line)
    if (linearregression != null) __obj.updateDynamic("linearregression")(linearregression)
    if (linearregressionangle != null) __obj.updateDynamic("linearregressionangle")(linearregressionangle)
    if (linearregressionintercept != null) __obj.updateDynamic("linearregressionintercept")(linearregressionintercept)
    if (linearregressionslope != null) __obj.updateDynamic("linearregressionslope")(linearregressionslope)
    if (macd != null) __obj.updateDynamic("macd")(macd)
    if (map != null) __obj.updateDynamic("map")(map)
    if (mapbubble != null) __obj.updateDynamic("mapbubble")(mapbubble)
    if (mapline != null) __obj.updateDynamic("mapline")(mapline)
    if (mappoint != null) __obj.updateDynamic("mappoint")(mappoint)
    if (mfi != null) __obj.updateDynamic("mfi")(mfi)
    if (momentum != null) __obj.updateDynamic("momentum")(momentum)
    if (natr != null) __obj.updateDynamic("natr")(natr)
    if (networkgraph != null) __obj.updateDynamic("networkgraph")(networkgraph)
    if (ohlc != null) __obj.updateDynamic("ohlc")(ohlc)
    if (organization != null) __obj.updateDynamic("organization")(organization)
    if (packedbubble != null) __obj.updateDynamic("packedbubble")(packedbubble)
    if (pareto != null) __obj.updateDynamic("pareto")(pareto)
    if (pc != null) __obj.updateDynamic("pc")(pc)
    if (pie != null) __obj.updateDynamic("pie")(pie)
    if (pivotpoints != null) __obj.updateDynamic("pivotpoints")(pivotpoints)
    if (polygon != null) __obj.updateDynamic("polygon")(polygon)
    if (ppo != null) __obj.updateDynamic("ppo")(ppo)
    if (priceenvelopes != null) __obj.updateDynamic("priceenvelopes")(priceenvelopes)
    if (psar != null) __obj.updateDynamic("psar")(psar)
    if (pyramid != null) __obj.updateDynamic("pyramid")(pyramid)
    if (pyramid3d != null) __obj.updateDynamic("pyramid3d")(pyramid3d)
    if (roc != null) __obj.updateDynamic("roc")(roc)
    if (rsi != null) __obj.updateDynamic("rsi")(rsi)
    if (sankey != null) __obj.updateDynamic("sankey")(sankey)
    if (scatter != null) __obj.updateDynamic("scatter")(scatter)
    if (scatter3d != null) __obj.updateDynamic("scatter3d")(scatter3d)
    if (series != null) __obj.updateDynamic("series")(series)
    if (sma != null) __obj.updateDynamic("sma")(sma)
    if (solidgauge != null) __obj.updateDynamic("solidgauge")(solidgauge)
    if (spline != null) __obj.updateDynamic("spline")(spline)
    if (stochastic != null) __obj.updateDynamic("stochastic")(stochastic)
    if (streamgraph != null) __obj.updateDynamic("streamgraph")(streamgraph)
    if (sunburst != null) __obj.updateDynamic("sunburst")(sunburst)
    if (supertrend != null) __obj.updateDynamic("supertrend")(supertrend)
    if (tema != null) __obj.updateDynamic("tema")(tema)
    ...
    if (vbp != null) __obj.updateDynamic("vbp")(vbp)
    if (vector != null) __obj.updateDynamic("vector")(vector)
    if (venn != null) __obj.updateDynamic("venn")(venn)
    if (vwap != null) __obj.updateDynamic("vwap")(vwap)
    if (waterfall != null) __obj.updateDynamic("waterfall")(waterfall)
    if (williamsr != null) __obj.updateDynamic("williamsr")(williamsr)
    if (windbarb != null) __obj.updateDynamic("windbarb")(windbarb)
    if (wma != null) __obj.updateDynamic("wma")(wma)
    if (wordcloud != null) __obj.updateDynamic("wordcloud")(wordcloud)
    if (xrange != null) __obj.updateDynamic("xrange")(xrange)
    if (zigzag != null) __obj.updateDynamic("zigzag")(zigzag)
