...
trait PlotTemaConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotTemaConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTemaConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotTemaConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotTemaConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotTemaConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotTemaConnectorsMarkerOptions = null,
    startMarker: PlotTemaConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotTemaConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotTemaConnectorsOptions]
  }
}
