...
trait PlotAreasplinerangeStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAreasplinerangeStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplinerangeStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeStatesHoverMarkerStatesSelectOptions]
  }
}
