...
trait PlotMfiConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotMfiConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMfiConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMfiConnectorsEndMarkerOptions]
  }
}
