...
trait PlotNatrConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotNatrConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNatrConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotNatrConnectorsStartMarkerOptions]
  }
}
