...
trait PlotLinearregressionStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressionStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotLinearregressionStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLinearregressionStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLinearregressionStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionStatesSelectMarkerOptions]
  }
}
