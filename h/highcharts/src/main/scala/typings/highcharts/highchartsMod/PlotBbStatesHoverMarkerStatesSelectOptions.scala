...
trait PlotBbStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotBbStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBbStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotBbStatesHoverMarkerStatesSelectOptions]
  }
}
