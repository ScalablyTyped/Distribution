...
trait PlotAoStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAoStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAoStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAoStatesSelectMarkerStatesSelectOptions]
  }
}
