...
trait PlotAreaTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotAreaTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotAreaTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotAreaTooltipDateTimeLabelFormatsOptions]
  }
}
