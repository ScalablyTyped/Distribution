...
trait PlotIkhStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotIkhStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotIkhStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotIkhStatesHoverMarkerStatesSelectOptions]
  }
}
