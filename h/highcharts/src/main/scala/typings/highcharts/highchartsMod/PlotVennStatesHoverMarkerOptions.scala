...
trait PlotVennStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotVennStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotVennStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotVennStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotVennStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVennStatesHoverMarkerOptions]
  }
}
