...
trait PlotVwapStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotVwapStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotVwapStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotVwapStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotVwapStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVwapStatesSelectMarkerOptions]
  }
}
