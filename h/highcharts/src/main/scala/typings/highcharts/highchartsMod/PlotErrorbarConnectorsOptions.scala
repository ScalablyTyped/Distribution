...
trait PlotErrorbarConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotErrorbarConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotErrorbarConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotErrorbarConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotErrorbarConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotErrorbarConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotErrorbarConnectorsMarkerOptions = null,
    startMarker: PlotErrorbarConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotErrorbarConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotErrorbarConnectorsOptions]
  }
}
