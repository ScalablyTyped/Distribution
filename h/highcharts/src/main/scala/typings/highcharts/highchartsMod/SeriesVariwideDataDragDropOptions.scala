...
trait SeriesVariwideDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesVariwideDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesVariwideDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesVariwideDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesVariwideDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesVariwideDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesVariwideDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesVariwideDataDragDropOptions]
  }
}
