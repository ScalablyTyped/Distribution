...
- typings.highcharts.highchartsMod.PlotBoxplotOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, className, clip, color, colorAxis, colorByPoint, colorIndex, colors, compare, compareBase, compareStart, connectors, crisp, cropThreshold, cursor, dataGrouping, dataLabels, depth, description, dragDrop, edgeColor, edgeWidth, enableMouseTracking, events, exposeElementToA11y, fillColor, findNearestPointBy, getExtremesFromAll, grouping, groupPadding, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, lineWidth, linkedTo, maxPointWidth, medianColor, medianWidth, minPointLength, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointPadding, pointPlacement, pointRange, pointStart, pointWidth, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, stemDashStyle, stemWidth, stickyTracking, threshold, tooltip, turboThreshold, visible, whiskerColor, whiskerLength, whiskerWidth, zoneAxis, zones */ trait SeriesBoxplotOptions
  ...
  /**
    ...
    */
  var accessibility: js.UndefOr[js.Object | PlotBoxplotAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotBoxplotAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotBoxplotConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotBoxplotDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotBoxplotDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotBoxplotEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[PlotBoxplotLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotBoxplotLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotBoxplotLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var medianColor: js.UndefOr[ColorString | GradientColorObject] = js.undefined
  /**
    ...
    * `.highcharts-boxplot-median` class.
    */
  var medianWidth: js.UndefOr[Double] = js.undefined
  /**
  ...
  /**
    ...
    */
  var point: js.UndefOr[PlotBoxplotPointOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesBoxplotOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotBoxplotTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesBoxplotOptions: boxplot
  /**
  ...
  /**
    ...
    */
  var whiskerLength: js.UndefOr[Double | String] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotBoxplotZonesOptions]] = js.undefined
}
