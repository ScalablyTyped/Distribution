...
trait PlotRsiStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotRsiStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotRsiStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotRsiStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotRsiStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotRsiStatesHoverMarkerStatesHoverOptions]
  }
}
