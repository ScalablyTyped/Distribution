...
trait PlotVariablepieStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotVariablepieStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotVariablepieStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVariablepieStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotVariablepieStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepieStatesSelectMarkerStatesHoverOptions]
  }
}
