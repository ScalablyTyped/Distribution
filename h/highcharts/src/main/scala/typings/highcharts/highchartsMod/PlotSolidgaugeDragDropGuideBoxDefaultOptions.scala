...
trait PlotSolidgaugeDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotSolidgaugeDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSolidgaugeDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotSolidgaugeDragDropGuideBoxDefaultOptions]
  }
}
