...
trait PlotArearangeStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotArearangeStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotArearangeStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotArearangeStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotArearangeStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeStatesHoverMarkerOptions]
  }
}
