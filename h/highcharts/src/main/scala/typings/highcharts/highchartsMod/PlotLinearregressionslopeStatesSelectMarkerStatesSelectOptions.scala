...
trait PlotLinearregressionslopeStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeStatesSelectMarkerStatesSelectOptions]
  }
}
