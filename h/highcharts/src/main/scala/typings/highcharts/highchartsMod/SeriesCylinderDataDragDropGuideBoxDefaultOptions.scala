...
trait SeriesCylinderDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesCylinderDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesCylinderDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesCylinderDataDragDropGuideBoxDefaultOptions]
  }
}
