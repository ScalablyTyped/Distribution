...
trait PlotStochasticDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotStochasticDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStochasticDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticDragDropDragHandleOptions]
  }
}
