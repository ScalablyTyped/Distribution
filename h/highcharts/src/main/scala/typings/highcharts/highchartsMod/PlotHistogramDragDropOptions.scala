...
trait PlotHistogramDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotHistogramDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotHistogramDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotHistogramDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotHistogramDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotHistogramDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotHistogramDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotHistogramDragDropOptions]
  }
}
