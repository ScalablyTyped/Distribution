...
trait PlotAbandsStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAbandsStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotAbandsStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAbandsStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAbandsStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsStatesSelectMarkerOptions]
  }
}
