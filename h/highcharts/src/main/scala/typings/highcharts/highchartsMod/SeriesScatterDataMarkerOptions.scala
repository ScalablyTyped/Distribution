...
trait SeriesScatterDataMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesScatterDataMarkerStatesOptions] = js.undefined
  /**
...
object SeriesScatterDataMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: SeriesScatterDataMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): SeriesScatterDataMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesScatterDataMarkerOptions]
  }
}
