...
trait SeriesWindbarbDataMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | SeriesWindbarbDataMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object SeriesWindbarbDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | SeriesWindbarbDataMarkerStatesHoverAnimationOptions = null,
  ...
  ): SeriesWindbarbDataMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[SeriesWindbarbDataMarkerStatesHoverOptions]
  }
}
