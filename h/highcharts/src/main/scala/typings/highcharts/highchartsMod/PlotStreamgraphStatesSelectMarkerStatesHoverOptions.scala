...
trait PlotStreamgraphStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotStreamgraphStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotStreamgraphStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotStreamgraphStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotStreamgraphStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphStatesSelectMarkerStatesHoverOptions]
  }
}
