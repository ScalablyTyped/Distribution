...
trait SeriesWindbarbDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesWindbarbDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesWindbarbDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesWindbarbDataDragDropGuideBoxDefaultOptions]
  }
}
