...
trait PlotLinearregressionangleDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotLinearregressionangleDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionangleDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleDragDropGuideBoxDefaultOptions]
  }
}
