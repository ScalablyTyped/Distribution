...
trait PlotTrixDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotTrixDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrixDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotTrixDragDropDragHandleOptions]
  }
}
