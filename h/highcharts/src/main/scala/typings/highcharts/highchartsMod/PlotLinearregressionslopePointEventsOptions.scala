...
trait PlotLinearregressionslopePointEventsOptions extends js.Object {
  /**
...
object PlotLinearregressionslopePointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopePointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopePointEventsOptions]
  }
}
