...
trait PlotTreemapStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTreemapStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTreemapStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapStatesHoverMarkerStatesSelectOptions]
  }
}
