...
trait PlotBbAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotBbAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotBbAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotBbAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotBbAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotBbAccessibilityOptions]
  }
}
