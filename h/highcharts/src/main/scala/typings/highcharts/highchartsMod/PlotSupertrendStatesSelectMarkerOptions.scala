...
trait PlotSupertrendStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSupertrendStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotSupertrendStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotSupertrendStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotSupertrendStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendStatesSelectMarkerOptions]
  }
}
