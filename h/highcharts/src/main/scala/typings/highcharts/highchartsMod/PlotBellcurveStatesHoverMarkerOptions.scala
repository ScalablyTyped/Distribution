...
trait PlotBellcurveStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotBellcurveStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotBellcurveStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotBellcurveStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotBellcurveStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveStatesHoverMarkerOptions]
  }
}
