...
trait PlotStochasticStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotStochasticStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotStochasticStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotStochasticStatesSelectMarkerOptions] = js.undefined
}

object PlotStochasticStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotStochasticStatesSelectAnimationOptions = null,
    ...
    marker: PlotStochasticStatesSelectMarkerOptions = null
  ): PlotStochasticStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticStatesSelectOptions]
  }
}
