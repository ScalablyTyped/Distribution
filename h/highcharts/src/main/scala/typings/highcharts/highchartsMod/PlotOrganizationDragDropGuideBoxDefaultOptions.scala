...
trait PlotOrganizationDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotOrganizationDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotOrganizationDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotOrganizationDragDropGuideBoxDefaultOptions]
  }
}
