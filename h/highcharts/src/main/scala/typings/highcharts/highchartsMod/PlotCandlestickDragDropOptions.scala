...
object PlotCandlestickDragDropOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(draggableClose)) __obj.updateDynamic("draggableClose")(draggableClose)
    ...
    if (!js.isUndefined(draggableOpen)) __obj.updateDynamic("draggableOpen")(draggableOpen)
