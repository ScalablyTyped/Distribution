...
trait PlotLinearregressionangleTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotLinearregressionangleTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotLinearregressionangleTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleTooltipDateTimeLabelFormatsOptions]
  }
}
