...
trait PlotDpoStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotDpoStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDpoStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotDpoStatesHoverMarkerStatesSelectOptions]
  }
}
