...
trait PlotSeriesStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotSeriesStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotSeriesStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSeriesStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotSeriesStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesStatesSelectMarkerStatesHoverOptions]
  }
}
