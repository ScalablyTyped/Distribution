...
trait PlotAoStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAoStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAoStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAoStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAoStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAoStatesSelectMarkerStatesHoverOptions]
  }
}
