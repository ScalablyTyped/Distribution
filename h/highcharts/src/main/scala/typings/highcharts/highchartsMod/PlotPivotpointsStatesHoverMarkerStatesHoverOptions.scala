...
trait PlotPivotpointsStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPivotpointsStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPivotpointsStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPivotpointsStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPivotpointsStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsStatesHoverMarkerStatesHoverOptions]
  }
}
