...
trait PlotPolygonMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPolygonMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotPolygonMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPolygonMarkerStatesHoverAnimationOptions = null,
