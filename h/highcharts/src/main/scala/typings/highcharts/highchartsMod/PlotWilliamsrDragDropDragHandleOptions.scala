...
trait PlotWilliamsrDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotWilliamsrDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWilliamsrDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrDragDropDragHandleOptions]
  }
}
