...
trait PlotKeltnerchannelsStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotKeltnerchannelsStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotKeltnerchannelsStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotKeltnerchannelsStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotKeltnerchannelsStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsStatesHoverMarkerStatesHoverOptions]
  }
}
