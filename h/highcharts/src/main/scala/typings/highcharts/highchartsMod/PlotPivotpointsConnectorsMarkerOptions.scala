...
trait PlotPivotpointsConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotPivotpointsConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPivotpointsConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsConnectorsMarkerOptions]
  }
}
