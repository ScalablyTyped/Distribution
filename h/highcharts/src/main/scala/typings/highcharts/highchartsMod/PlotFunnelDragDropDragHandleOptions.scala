...
trait PlotFunnelDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotFunnelDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotFunnelDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotFunnelDragDropDragHandleOptions]
  }
}
