...
trait PlotVwapStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotVwapStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotVwapStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVwapStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotVwapStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotVwapStatesHoverMarkerStatesHoverOptions]
  }
}
