...
trait PlotKeltnerchannelsMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotKeltnerchannelsMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotKeltnerchannelsMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotKeltnerchannelsMarkerStatesHoverAnimationOptions = null,
