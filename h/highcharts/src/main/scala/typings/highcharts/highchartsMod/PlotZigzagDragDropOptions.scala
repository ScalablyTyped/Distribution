...
trait PlotZigzagDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotZigzagDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotZigzagDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotZigzagDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotZigzagDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotZigzagDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotZigzagDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagDragDropOptions]
  }
}
