...
trait PlotCciConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotCciConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCciConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCciConnectorsMarkerOptions]
  }
}
