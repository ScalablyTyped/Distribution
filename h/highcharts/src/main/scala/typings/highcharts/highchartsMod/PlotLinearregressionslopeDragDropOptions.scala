...
trait PlotLinearregressionslopeDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotLinearregressionslopeDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotLinearregressionslopeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotLinearregressionslopeDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotLinearregressionslopeDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotLinearregressionslopeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotLinearregressionslopeDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeDragDropOptions]
  }
}
