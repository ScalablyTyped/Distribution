...
trait PlotNetworkgraphStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotNetworkgraphStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotNetworkgraphStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotNetworkgraphStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotNetworkgraphStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphStatesSelectMarkerStatesHoverOptions]
  }
}
