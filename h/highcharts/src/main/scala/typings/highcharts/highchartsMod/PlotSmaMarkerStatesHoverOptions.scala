...
trait PlotSmaMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSmaMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotSmaMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSmaMarkerStatesHoverAnimationOptions = null,
