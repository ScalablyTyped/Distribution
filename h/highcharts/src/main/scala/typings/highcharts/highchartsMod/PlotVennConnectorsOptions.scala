...
trait PlotVennConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotVennConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVennConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotVennConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotVennConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotVennConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotVennConnectorsMarkerOptions = null,
    startMarker: PlotVennConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotVennConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotVennConnectorsOptions]
  }
}
