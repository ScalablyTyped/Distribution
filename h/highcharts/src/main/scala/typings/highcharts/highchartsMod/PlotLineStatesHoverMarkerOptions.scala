...
trait PlotLineStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLineStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotLineStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLineStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLineStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLineStatesHoverMarkerOptions]
  }
}
