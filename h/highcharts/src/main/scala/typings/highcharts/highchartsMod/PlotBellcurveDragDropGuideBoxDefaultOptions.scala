...
trait PlotBellcurveDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotBellcurveDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBellcurveDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveDragDropGuideBoxDefaultOptions]
  }
}
