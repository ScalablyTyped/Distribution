...
trait PlotMacdStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMacdStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMacdStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMacdStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMacdStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMacdStatesHoverMarkerStatesHoverOptions]
  }
}
