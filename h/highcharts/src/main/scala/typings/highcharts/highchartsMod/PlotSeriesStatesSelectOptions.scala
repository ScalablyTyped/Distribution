...
trait PlotSeriesStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotSeriesStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotSeriesStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotSeriesStatesSelectMarkerOptions] = js.undefined
}

object PlotSeriesStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotSeriesStatesSelectAnimationOptions = null,
    ...
    marker: PlotSeriesStatesSelectMarkerOptions = null
  ): PlotSeriesStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesStatesSelectOptions]
  }
}
