...
trait PlotCmfMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotCmfMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotCmfMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotCmfMarkerStatesHoverAnimationOptions = null,
