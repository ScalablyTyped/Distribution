...
trait PlotDpoStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotDpoStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotDpoStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotDpoStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotDpoStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotDpoStatesHoverMarkerOptions]
  }
}
