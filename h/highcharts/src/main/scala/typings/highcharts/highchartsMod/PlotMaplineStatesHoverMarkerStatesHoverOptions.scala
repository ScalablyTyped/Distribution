...
trait PlotMaplineStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMaplineStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMaplineStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMaplineStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMaplineStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineStatesHoverMarkerStatesHoverOptions]
  }
}
