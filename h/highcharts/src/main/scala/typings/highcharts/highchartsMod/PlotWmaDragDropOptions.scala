...
trait PlotWmaDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotWmaDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotWmaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotWmaDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotWmaDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotWmaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotWmaDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotWmaDragDropOptions]
  }
}
