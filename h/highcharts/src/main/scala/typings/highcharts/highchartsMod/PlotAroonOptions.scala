...
trait PlotAroonOptions extends js.Object {
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotAroonDragDropOptions] = js.undefined
  /**
...
object PlotAroonOptions {
  ...
  def apply(
    ...
    dragDrop: PlotAroonDragDropOptions = null,
    ...
    if (aroonDown != null) __obj.updateDynamic("aroonDown")(aroonDown)
