...
trait PlotScatterStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotScatterStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatterStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotScatterStatesSelectMarkerStatesSelectOptions]
  }
}
