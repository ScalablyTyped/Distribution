...
trait PlotScatterStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotScatterStatesHoverOptions] = js.undefined
  /**
    * (Highcharts, Highstock) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotScatterStatesInactiveOptions] = js.undefined
  /**
...
object PlotScatterStatesOptions {
  @scala.inline
  def apply(
    hover: PlotScatterStatesHoverOptions = null,
    inactive: PlotScatterStatesInactiveOptions = null,
    normal: PlotScatterStatesNormalOptions = null,
    select: PlotScatterStatesSelectOptions = null
