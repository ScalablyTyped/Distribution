...
- typings.highcharts.highchartsMod.PlotWindbarbOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, borderColor, borderRadius, borderWidth, className, clip, color, colorAxis, colorByPoint, colorIndex, colors, compare, compareBase, compareStart, connectors, crisp, cursor, dataGrouping, dataLabels, depth, description, edgeColor, edgeWidth, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, getExtremesFromAll, grouping, groupPadding, groupZPadding, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, lineWidth, linkedTo, maxPointWidth, minPointLength, navigatorOptions, negativeColor, onSeries, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointPadding, pointPlacement, pointRange, pointStart, pointWidth, selected, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, states, stickyTracking, threshold, tooltip, turboThreshold, vectorLength, visible, xOffset, yOffset, zoneAxis, zones */ trait SeriesWindbarbOptions
  ...
  /**
    ...
    */
  var data: js.UndefOr[
    js.Array[(js.Tuple3[Double | String, Double, Double]) | SeriesWindbarbDataOptions]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesWindbarbOptions: windbarb
  /**
...
object SeriesWindbarbOptions {
  ...
  def apply(
    ...
    data: js.Array[(js.Tuple3[Double | String, Double, Double]) | SeriesWindbarbDataOptions] = null,
