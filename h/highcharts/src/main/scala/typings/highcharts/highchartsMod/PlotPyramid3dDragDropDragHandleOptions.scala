...
trait PlotPyramid3dDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotPyramid3dDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramid3dDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotPyramid3dDragDropDragHandleOptions]
  }
}
