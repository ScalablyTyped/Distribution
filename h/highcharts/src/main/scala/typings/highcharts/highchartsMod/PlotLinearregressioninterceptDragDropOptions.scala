...
trait PlotLinearregressioninterceptDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotLinearregressioninterceptDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotLinearregressioninterceptDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotLinearregressioninterceptDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotLinearregressioninterceptDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotLinearregressioninterceptDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotLinearregressioninterceptDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptDragDropOptions]
  }
}
