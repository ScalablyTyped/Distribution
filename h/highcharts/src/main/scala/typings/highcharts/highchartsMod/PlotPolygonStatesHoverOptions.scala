...
trait PlotPolygonStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPolygonStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPolygonStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPolygonStatesHoverMarkerOptions] = js.undefined
}

object PlotPolygonStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPolygonStatesHoverAnimationOptions = null,
    ...
    marker: PlotPolygonStatesHoverMarkerOptions = null
  ): PlotPolygonStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonStatesHoverOptions]
  }
}
