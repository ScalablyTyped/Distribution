...
trait PlotLinearregressionStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressionStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressionStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressionStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressionStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionStatesHoverMarkerStatesHoverOptions]
  }
}
