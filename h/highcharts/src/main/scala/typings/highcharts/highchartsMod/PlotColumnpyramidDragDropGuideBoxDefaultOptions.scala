...
trait PlotColumnpyramidDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotColumnpyramidDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnpyramidDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotColumnpyramidDragDropGuideBoxDefaultOptions]
  }
}
