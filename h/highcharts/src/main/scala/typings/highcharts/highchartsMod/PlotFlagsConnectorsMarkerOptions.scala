...
trait PlotFlagsConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotFlagsConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotFlagsConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotFlagsConnectorsMarkerOptions]
  }
}
