...
trait PlotMfiStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMfiStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMfiStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMfiStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMfiStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMfiStatesHoverMarkerStatesHoverOptions]
  }
}
