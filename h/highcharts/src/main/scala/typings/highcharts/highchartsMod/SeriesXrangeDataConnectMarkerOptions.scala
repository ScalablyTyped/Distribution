...
trait SeriesXrangeDataConnectMarkerOptions extends js.Object {
  /**
...
object SeriesXrangeDataConnectMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesXrangeDataConnectMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesXrangeDataConnectMarkerOptions]
  }
}
