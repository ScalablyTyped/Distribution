...
trait PlotAbandsStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAbandsStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAbandsStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAbandsStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAbandsStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsStatesHoverMarkerStatesHoverOptions]
  }
}
