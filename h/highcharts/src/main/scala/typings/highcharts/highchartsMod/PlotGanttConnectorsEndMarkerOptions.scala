...
trait PlotGanttConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotGanttConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
    align: String = null,
  ...
  ): PlotGanttConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotGanttConnectorsEndMarkerOptions]
  }
}
