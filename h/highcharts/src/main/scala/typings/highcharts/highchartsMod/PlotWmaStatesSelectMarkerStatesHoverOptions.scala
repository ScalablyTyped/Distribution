...
trait PlotWmaStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotWmaStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotWmaStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotWmaStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotWmaStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotWmaStatesSelectMarkerStatesHoverOptions]
  }
}
