...
trait PlotHistogramAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotHistogramAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotHistogramAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotHistogramAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotHistogramAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotHistogramAccessibilityOptions]
  }
}
