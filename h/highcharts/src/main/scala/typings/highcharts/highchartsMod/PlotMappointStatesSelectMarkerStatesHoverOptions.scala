...
trait PlotMappointStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMappointStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMappointStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMappointStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMappointStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMappointStatesSelectMarkerStatesHoverOptions]
  }
}
