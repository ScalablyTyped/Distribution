...
trait PlotRocStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotRocStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRocStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotRocStatesHoverMarkerStatesSelectOptions]
  }
}
