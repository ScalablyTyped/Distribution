...
trait PlotBubbleStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotBubbleStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBubbleStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleStatesHoverMarkerStatesSelectOptions]
  }
}
