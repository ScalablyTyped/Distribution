...
trait PlotBbStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotBbStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotBbStatesSelectMarkerStatesSelectOptions]
  }
}
