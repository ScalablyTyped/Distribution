...
trait PlotRsiDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotRsiDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRsiDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotRsiDragDropGuideBoxDefaultOptions]
  }
}
