...
trait PlotNetworkgraphStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotNetworkgraphStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNetworkgraphStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphStatesHoverMarkerStatesSelectOptions]
  }
}
