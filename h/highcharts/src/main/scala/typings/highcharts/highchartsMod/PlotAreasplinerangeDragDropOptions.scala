...
trait PlotAreasplinerangeDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotAreasplinerangeDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotAreasplinerangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotAreasplinerangeDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotAreasplinerangeDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotAreasplinerangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotAreasplinerangeDragDropOptions]
  }
}
