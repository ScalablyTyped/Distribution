...
trait PlotTrixConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotTrixConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrixConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTrixConnectorsEndMarkerOptions]
  }
}
