...
trait PlotTemaMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTemaMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotTemaMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTemaMarkerStatesHoverAnimationOptions = null,
