...
trait PlotLinearregressionslopeStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressionslopeStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressionslopeStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressionslopeStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressionslopeStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeStatesSelectMarkerStatesHoverOptions]
  }
}
