...
trait PlotDpoStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotDpoStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotDpoStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotDpoStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotDpoStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotDpoStatesHoverMarkerStatesHoverOptions]
  }
}
