...
trait PlotSplineStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotSplineStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotSplineStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSplineStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotSplineStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotSplineStatesHoverMarkerStatesHoverOptions]
  }
}
