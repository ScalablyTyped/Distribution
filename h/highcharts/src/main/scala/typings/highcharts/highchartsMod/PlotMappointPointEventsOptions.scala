...
trait PlotMappointPointEventsOptions extends js.Object {
  /**
...
object PlotMappointPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMappointPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotMappointPointEventsOptions]
  }
}
