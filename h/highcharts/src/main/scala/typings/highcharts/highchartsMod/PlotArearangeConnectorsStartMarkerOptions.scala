...
trait PlotArearangeConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotArearangeConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotArearangeConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeConnectorsStartMarkerOptions]
  }
}
