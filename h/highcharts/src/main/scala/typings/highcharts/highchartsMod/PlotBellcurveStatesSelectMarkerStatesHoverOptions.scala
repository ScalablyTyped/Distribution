...
trait PlotBellcurveStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotBellcurveStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotBellcurveStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotBellcurveStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotBellcurveStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveStatesSelectMarkerStatesHoverOptions]
  }
}
