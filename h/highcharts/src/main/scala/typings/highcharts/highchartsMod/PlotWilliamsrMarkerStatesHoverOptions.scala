...
trait PlotWilliamsrMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotWilliamsrMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotWilliamsrMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotWilliamsrMarkerStatesHoverAnimationOptions = null,
