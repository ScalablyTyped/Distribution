...
trait PlotPsarStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPsarStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPsarStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPsarStatesHoverMarkerStatesSelectOptions]
  }
}
