...
trait PlotIkhDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotIkhDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotIkhDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotIkhDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotIkhDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotIkhDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotIkhDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotIkhDragDropOptions]
  }
}
