...
trait SeriesPolygonDataMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesPolygonDataMarkerStatesOptions] = js.undefined
  /**
...
object SeriesPolygonDataMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: SeriesPolygonDataMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): SeriesPolygonDataMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesPolygonDataMarkerOptions]
  }
}
