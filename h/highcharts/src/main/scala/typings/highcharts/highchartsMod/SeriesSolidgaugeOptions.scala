...
- typings.highcharts.highchartsMod.PlotSolidgaugeOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, boostBlending, borderColor, borderWidth, className, clip, color, colorAxis, colorByPoint, colorIndex, compare, compareBase, compareStart, connectors, cursor, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, gapSize, gapUnit, includeInDataExport, innerRadius, joinBy, keys, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, navigatorOptions, opacity, overshoot, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointRange, pointStart, radius, rounded, selected, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, stickyTracking, threshold, tooltip, useOhlcData, visible */ trait SeriesSolidgaugeOptions
  ...
  /**
    ...
    */
  var accessibility: js.UndefOr[js.Object | PlotSolidgaugeAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSolidgaugeAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotSolidgaugeConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotSolidgaugeDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotSolidgaugeDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[PlotSolidgaugeLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotSolidgaugeLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotSolidgaugeLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    * `square`.
    */
  var linecap: js.UndefOr[OptionsLinecapValue] = js.undefined
  /**
  ...
  /**
    ...
    */
  var point: js.UndefOr[PlotSolidgaugePointOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesSolidgaugeOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotSolidgaugeTooltipOptions] = js.undefined
  /**
    ...
    */
  @JSName("type")
  var type_SeriesSolidgaugeOptions: solidgauge
  /**
