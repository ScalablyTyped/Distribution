...
trait PlotAreasplineStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAreasplineStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotAreasplineStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAreasplineStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAreasplineStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineStatesSelectMarkerOptions]
  }
}
