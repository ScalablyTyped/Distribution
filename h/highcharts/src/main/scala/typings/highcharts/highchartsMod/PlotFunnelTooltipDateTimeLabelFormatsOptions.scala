...
trait PlotFunnelTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotFunnelTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotFunnelTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotFunnelTooltipDateTimeLabelFormatsOptions]
  }
}
