...
trait PlotAroonStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAroonStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAroonStatesSelectMarkerStatesSelectOptions]
  }
}
