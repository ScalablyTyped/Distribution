...
trait PlotLinearregressioninterceptDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressioninterceptDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptDragDropDragHandleOptions]
  }
}
