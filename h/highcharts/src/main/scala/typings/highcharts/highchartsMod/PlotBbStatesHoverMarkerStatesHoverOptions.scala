...
trait PlotBbStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotBbStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotBbStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotBbStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotBbStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotBbStatesHoverMarkerStatesHoverOptions]
  }
}
