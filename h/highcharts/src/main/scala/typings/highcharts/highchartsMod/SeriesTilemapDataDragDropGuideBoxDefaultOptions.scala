...
trait SeriesTilemapDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesTilemapDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesTilemapDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesTilemapDataDragDropGuideBoxDefaultOptions]
  }
}
