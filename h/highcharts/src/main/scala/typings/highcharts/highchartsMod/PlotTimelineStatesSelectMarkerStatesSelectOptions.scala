...
trait PlotTimelineStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTimelineStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTimelineStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineStatesSelectMarkerStatesSelectOptions]
  }
}
