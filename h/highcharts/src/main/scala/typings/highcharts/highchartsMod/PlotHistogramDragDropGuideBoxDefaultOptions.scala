...
trait PlotHistogramDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotHistogramDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotHistogramDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotHistogramDragDropGuideBoxDefaultOptions]
  }
}
