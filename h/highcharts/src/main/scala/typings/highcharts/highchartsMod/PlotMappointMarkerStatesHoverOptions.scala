...
trait PlotMappointMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMappointMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotMappointMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMappointMarkerStatesHoverAnimationOptions = null,
