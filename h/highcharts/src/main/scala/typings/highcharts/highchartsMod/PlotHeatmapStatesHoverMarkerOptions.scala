...
trait PlotHeatmapStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotHeatmapStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotHeatmapStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotHeatmapStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotHeatmapStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapStatesHoverMarkerOptions]
  }
}
