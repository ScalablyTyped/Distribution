...
trait PlotSmaStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSmaStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotSmaStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotSmaStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotSmaStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSmaStatesHoverMarkerOptions]
  }
}
