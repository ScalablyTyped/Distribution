...
trait PlotHistogramTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotHistogramTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotHistogramTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotHistogramTooltipDateTimeLabelFormatsOptions]
  }
}
