...
trait PlotNatrStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotNatrStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotNatrStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotNatrStatesHoverMarkerOptions] = js.undefined
}

object PlotNatrStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotNatrStatesHoverAnimationOptions = null,
    ...
    marker: PlotNatrStatesHoverMarkerOptions = null
  ): PlotNatrStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotNatrStatesHoverOptions]
  }
}
