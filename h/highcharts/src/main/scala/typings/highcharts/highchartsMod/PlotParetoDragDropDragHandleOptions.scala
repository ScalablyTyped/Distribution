...
trait PlotParetoDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotParetoDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotParetoDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotParetoDragDropDragHandleOptions]
  }
}
