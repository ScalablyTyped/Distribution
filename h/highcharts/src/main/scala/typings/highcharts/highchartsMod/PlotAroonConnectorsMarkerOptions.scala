...
trait PlotAroonConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotAroonConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonConnectorsMarkerOptions]
  }
}
