...
trait PlotAbandsStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAbandsStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotAbandsStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAbandsStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAbandsStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsStatesHoverMarkerOptions]
  }
}
