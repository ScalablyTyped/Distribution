...
trait PlotLinearregressionangleDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotLinearregressionangleDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionangleDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleDragDropDragHandleOptions]
  }
}
