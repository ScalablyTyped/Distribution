...
trait PlotPpoDataGroupingOptions extends js.Object {
  /**
...
object PlotPpoDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPpoDataGroupingOptions]
  }
}
