...
trait PlotBbMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotBbMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotBbMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotBbMarkerStatesHoverAnimationOptions = null,
