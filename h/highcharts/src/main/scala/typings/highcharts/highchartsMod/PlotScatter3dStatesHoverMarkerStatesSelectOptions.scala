...
trait PlotScatter3dStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotScatter3dStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatter3dStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dStatesHoverMarkerStatesSelectOptions]
  }
}
