...
trait PlotLinearregressioninterceptStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressioninterceptStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotLinearregressioninterceptStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLinearregressioninterceptStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLinearregressioninterceptStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptStatesHoverMarkerOptions]
  }
}
