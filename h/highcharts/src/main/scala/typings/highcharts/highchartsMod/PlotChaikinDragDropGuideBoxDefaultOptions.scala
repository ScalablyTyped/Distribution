...
trait PlotChaikinDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotChaikinDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotChaikinDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinDragDropGuideBoxDefaultOptions]
  }
}
