...
trait PlotAreasplinerangeMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAreasplinerangeMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAreasplinerangeMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAreasplinerangeMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAreasplinerangeMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeMarkerStatesHoverOptions]
  }
}
