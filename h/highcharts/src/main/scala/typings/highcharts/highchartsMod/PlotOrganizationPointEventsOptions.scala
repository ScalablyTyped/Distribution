...
trait PlotOrganizationPointEventsOptions extends js.Object {
  /**
...
object PlotOrganizationPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotOrganizationPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotOrganizationPointEventsOptions]
  }
}
