...
trait PlotWmaMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotWmaMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotWmaMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotWmaMarkerStatesHoverAnimationOptions = null,
