...
trait PlotWordcloudDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotWordcloudDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWordcloudDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotWordcloudDragDropGuideBoxDefaultOptions]
  }
}
