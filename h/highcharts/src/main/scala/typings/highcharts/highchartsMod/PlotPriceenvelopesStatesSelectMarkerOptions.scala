...
trait PlotPriceenvelopesStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPriceenvelopesStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotPriceenvelopesStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPriceenvelopesStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPriceenvelopesStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesStatesSelectMarkerOptions]
  }
}
