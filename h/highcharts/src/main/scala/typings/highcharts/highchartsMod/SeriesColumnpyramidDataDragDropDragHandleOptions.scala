...
trait SeriesColumnpyramidDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesColumnpyramidDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesColumnpyramidDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesColumnpyramidDataDragDropDragHandleOptions]
  }
}
