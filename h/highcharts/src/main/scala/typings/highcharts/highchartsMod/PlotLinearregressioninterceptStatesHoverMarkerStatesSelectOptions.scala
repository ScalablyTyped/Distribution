...
trait PlotLinearregressioninterceptStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressioninterceptStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptStatesHoverMarkerStatesSelectOptions]
  }
}
