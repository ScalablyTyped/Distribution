...
trait PlotScatterDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotScatterDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatterDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotScatterDragDropGuideBoxDefaultOptions]
  }
}
