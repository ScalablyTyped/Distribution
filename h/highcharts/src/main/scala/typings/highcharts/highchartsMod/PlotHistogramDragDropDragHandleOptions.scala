...
trait PlotHistogramDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotHistogramDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotHistogramDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotHistogramDragDropDragHandleOptions]
  }
}
