...
trait PlotMacdStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMacdStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMacdStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMacdStatesHoverMarkerStatesSelectOptions]
  }
}
