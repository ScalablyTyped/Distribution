...
trait PlotCciDataGroupingOptions extends js.Object {
  /**
...
object PlotCciDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotCciDataGroupingOptions]
  }
}
