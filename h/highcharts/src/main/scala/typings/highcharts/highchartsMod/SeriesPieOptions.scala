...
- typings.highcharts.highchartsMod.PlotPieOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, boostBlending, borderColor, borderWidth, center, className, clip, color, colorAxis, colorIndex, colors, compare, compareBase, compareStart, connectors, cursor, dataGrouping, dataLabels, depth, description, dragDrop, enableMouseTracking, endAngle, events, exposeElementToA11y, gapSize, gapUnit, ignoreHiddenPoint, includeInDataExport, innerSize, joinBy, keys, lastPrice, lastVisiblePrice, linecap, linkedTo, minSize, navigatorOptions, opacity, point, pointDescriptionFormatter, pointRange, selected, shadow, showCheckbox, showInLegend, showInNavigator, size, skipKeyboardNavigation, slicedOffset, startAngle, states, stickyTracking, tooltip, useOhlcData, visible */ trait SeriesPieOptions
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesPieOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("xAxis")
  var xAxis_SeriesPieOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
    * Not available
    */
  @JSName("yAxis")
  var yAxis_SeriesPieOptions: js.UndefOr[scala.Nothing] = js.undefined
}
