...
trait PlotLinearregressioninterceptConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressioninterceptConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptConnectorsStartMarkerOptions]
  }
}
