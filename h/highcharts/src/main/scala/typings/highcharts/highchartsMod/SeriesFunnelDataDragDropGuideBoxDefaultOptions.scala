...
trait SeriesFunnelDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesFunnelDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesFunnelDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesFunnelDataDragDropGuideBoxDefaultOptions]
  }
}
