...
trait PlotVwapDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotVwapDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotVwapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotVwapDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotVwapDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotVwapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotVwapDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotVwapDragDropOptions]
  }
}
