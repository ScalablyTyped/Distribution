...
trait PlotLinearregressionslopeDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeDragDropGuideBoxDefaultOptions]
  }
}
