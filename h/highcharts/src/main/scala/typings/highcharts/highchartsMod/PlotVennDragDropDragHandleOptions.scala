...
trait PlotVennDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotVennDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVennDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotVennDragDropDragHandleOptions]
  }
}
