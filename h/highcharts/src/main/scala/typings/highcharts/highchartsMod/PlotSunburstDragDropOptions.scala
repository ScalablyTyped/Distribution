...
trait PlotSunburstDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotSunburstDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotSunburstDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotSunburstDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotSunburstDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotSunburstDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotSunburstDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotSunburstDragDropOptions]
  }
}
