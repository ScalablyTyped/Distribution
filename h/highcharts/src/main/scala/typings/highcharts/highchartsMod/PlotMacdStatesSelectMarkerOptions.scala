...
trait PlotMacdStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMacdStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotMacdStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMacdStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMacdStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMacdStatesSelectMarkerOptions]
  }
}
