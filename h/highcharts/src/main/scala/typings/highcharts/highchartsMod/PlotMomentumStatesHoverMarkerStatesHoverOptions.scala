...
trait PlotMomentumStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMomentumStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMomentumStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMomentumStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMomentumStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumStatesHoverMarkerStatesHoverOptions]
  }
}
