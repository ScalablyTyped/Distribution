...
trait PlotMappointConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotMappointConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMappointConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMappointConnectorsMarkerOptions]
  }
}
