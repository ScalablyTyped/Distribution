...
trait PlotSupertrendDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotSupertrendDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSupertrendDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendDragDropDragHandleOptions]
  }
}
