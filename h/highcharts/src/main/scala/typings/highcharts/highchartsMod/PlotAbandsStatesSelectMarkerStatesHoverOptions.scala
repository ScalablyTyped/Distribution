...
trait PlotAbandsStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAbandsStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAbandsStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAbandsStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAbandsStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsStatesSelectMarkerStatesHoverOptions]
  }
}
