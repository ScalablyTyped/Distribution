...
trait PlotRocDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotRocDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRocDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotRocDragDropDragHandleOptions]
  }
}
