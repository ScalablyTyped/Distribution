...
trait PlotWilliamsrZonesOptions extends js.Object {
  /**
...
object PlotWilliamsrZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotWilliamsrZonesOptions]
  }
}
