...
trait SeriesLineDataMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | SeriesLineDataMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object SeriesLineDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | SeriesLineDataMarkerStatesHoverAnimationOptions = null,
