...
trait PlotMappointStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMappointStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMappointStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMappointStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMappointStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMappointStatesHoverMarkerStatesHoverOptions]
  }
}
