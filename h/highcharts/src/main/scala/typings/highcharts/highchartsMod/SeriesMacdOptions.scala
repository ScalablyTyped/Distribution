...
- typings.highcharts.highchartsMod.PlotMacdOptions because var conflicts: name, zIndex. Inlined accessibility, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorIndex, compare, compareBase, compareStart, compareToMain, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, groupPadding, includeInDataExport, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, macdLine, marker, minPointLength, negativeColor, opacity, params, point, pointDescriptionFormatter, pointPadding, selected, shadow, showCheckbox, showInLegend, signalLine, skipKeyboardNavigation, softThreshold, states, step, stickyTracking, threshold, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesMacdOptions
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesMacdOptions: macd
  /**
