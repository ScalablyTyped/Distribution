...
trait PlotLinearregressionDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotLinearregressionDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotLinearregressionDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotLinearregressionDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotLinearregressionDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotLinearregressionDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotLinearregressionDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionDragDropOptions]
  }
}
