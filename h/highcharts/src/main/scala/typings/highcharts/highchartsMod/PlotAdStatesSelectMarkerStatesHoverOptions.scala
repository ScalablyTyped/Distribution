...
trait PlotAdStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAdStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAdStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAdStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAdStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAdStatesSelectMarkerStatesHoverOptions]
  }
}
