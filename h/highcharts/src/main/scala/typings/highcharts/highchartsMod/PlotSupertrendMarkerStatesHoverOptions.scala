...
trait PlotSupertrendMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotSupertrendMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotSupertrendMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSupertrendMarkerStatesHoverAnimationOptions = null,
