...
trait PlotAreasplinerangeTooltipOptions extends js.Object {
  /**
  ...
  /**
    * (Highcharts, Highstock) A CSS class name to apply to the tooltip's
    * container div, allowing unique CSS styling for each chart.
    */
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotAreasplinerangeTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotAreasplinerangeTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    className: String = null,
    dateTimeLabelFormats: PlotAreasplinerangeTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
    ...
    __obj.asInstanceOf[PlotAreasplinerangeTooltipOptions]
  }
}
