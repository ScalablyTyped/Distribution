...
trait PlotNatrStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotNatrStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNatrStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotNatrStatesSelectMarkerStatesSelectOptions]
  }
}
