...
trait PlotPpoDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotPpoDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPpoDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotPpoDragDropDragHandleOptions]
  }
}
