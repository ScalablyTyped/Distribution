...
trait PlotEmaStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotEmaStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotEmaStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotEmaStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotEmaStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotEmaStatesHoverMarkerStatesHoverOptions]
  }
}
