...
trait PlotStreamgraphStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotStreamgraphStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotStreamgraphStatesHoverMarkerStatesSelectOptions]
  }
}
