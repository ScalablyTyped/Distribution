...
trait PlotPcStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPcStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPcStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPcStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPcStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPcStatesSelectMarkerStatesHoverOptions]
  }
}
