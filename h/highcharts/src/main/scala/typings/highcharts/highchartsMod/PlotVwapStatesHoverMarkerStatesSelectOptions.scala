...
trait PlotVwapStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotVwapStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVwapStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotVwapStatesHoverMarkerStatesSelectOptions]
  }
}
