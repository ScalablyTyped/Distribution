...
trait PlotIkhMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotIkhMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotIkhMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotIkhMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotIkhMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotIkhMarkerStatesHoverOptions]
  }
}
