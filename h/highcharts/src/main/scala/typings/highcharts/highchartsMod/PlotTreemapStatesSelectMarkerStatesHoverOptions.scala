...
trait PlotTreemapStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotTreemapStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotTreemapStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTreemapStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotTreemapStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapStatesSelectMarkerStatesHoverOptions]
  }
}
