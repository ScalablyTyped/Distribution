...
import typings.highcharts.highchartsStrings.gantt
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotGanttOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, borderColor, borderRadius, borderWidth, className, clip, color, colorAxis, colorByPoint, colorIndex, colors, compare, compareBase, compareStart, connectors, cursor, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, grouping, groupPadding, groupZPadding, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, linkedTo, maxPointWidth, minPointLength, navigatorOptions, opacity, partialFill, point, pointDescriptionFormatter, pointPadding, pointRange, pointWidth, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, states, stickyTracking, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesGanttOptions
  ...
  /**
    ...
    * module.
    */
  var accessibility: js.UndefOr[js.Object | PlotGanttAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotGanttAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotGanttConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[js.Array[SeriesGanttDataOptions]] = js.undefined
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotGanttDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotGanttDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotGanttEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[PlotGanttLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotGanttLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotGanttLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var partialFill: js.UndefOr[PlotGanttPartialFillOptions] = js.undefined
  /**
    * (Gantt) Properties for each single point.
    */
  var point: js.UndefOr[PlotGanttPointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotGanttStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotGanttTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesGanttOptions: gantt
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotGanttZonesOptions]] = js.undefined
}

object SeriesGanttOptions {
  @scala.inline
  def apply(
    `type`: gantt,
    ...
    if (partialFill != null) __obj.updateDynamic("partialFill")(partialFill)
