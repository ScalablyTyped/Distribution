...
trait PlotMaplineStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMaplineStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotMaplineStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMaplineStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMaplineStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineStatesSelectMarkerOptions]
  }
}
