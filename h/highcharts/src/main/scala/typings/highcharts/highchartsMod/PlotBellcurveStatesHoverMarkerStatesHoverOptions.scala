...
trait PlotBellcurveStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotBellcurveStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotBellcurveStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotBellcurveStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotBellcurveStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveStatesHoverMarkerStatesHoverOptions]
  }
}
