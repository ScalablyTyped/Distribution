...
trait PlotDemaStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotDemaStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotDemaStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotDemaStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotDemaStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotDemaStatesSelectMarkerStatesHoverOptions]
  }
}
