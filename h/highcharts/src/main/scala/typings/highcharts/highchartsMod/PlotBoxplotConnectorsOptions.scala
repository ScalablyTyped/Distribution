...
trait PlotBoxplotConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotBoxplotConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotBoxplotConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotBoxplotConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotBoxplotConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotBoxplotConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotBoxplotConnectorsMarkerOptions = null,
    startMarker: PlotBoxplotConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotBoxplotConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotBoxplotConnectorsOptions]
  }
}
