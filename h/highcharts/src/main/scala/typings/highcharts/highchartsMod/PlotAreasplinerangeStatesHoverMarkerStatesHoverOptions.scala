...
trait PlotAreasplinerangeStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAreasplinerangeStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAreasplinerangeStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAreasplinerangeStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAreasplinerangeStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeStatesHoverMarkerStatesHoverOptions]
  }
}
