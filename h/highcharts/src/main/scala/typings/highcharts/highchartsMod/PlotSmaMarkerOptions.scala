...
trait PlotSmaMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSmaMarkerStatesOptions] = js.undefined
  /**
...
object PlotSmaMarkerOptions {
  ...
  def apply(
    ...
    states: PlotSmaMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotSmaMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSmaMarkerOptions]
  }
}
