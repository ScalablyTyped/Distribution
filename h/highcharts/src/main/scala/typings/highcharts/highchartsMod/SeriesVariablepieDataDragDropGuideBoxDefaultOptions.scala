...
trait SeriesVariablepieDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesVariablepieDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesVariablepieDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesVariablepieDataDragDropGuideBoxDefaultOptions]
  }
}
