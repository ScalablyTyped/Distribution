...
trait PlotSmaMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotSmaMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSmaMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotSmaMarkerStatesSelectOptions]
  }
}
