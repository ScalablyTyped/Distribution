...
trait PlotSunburstDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotSunburstDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSunburstDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotSunburstDragDropGuideBoxDefaultOptions]
  }
}
