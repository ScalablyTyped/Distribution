...
trait PlotZigzagStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotZigzagStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotZigzagStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagStatesSelectMarkerStatesSelectOptions]
  }
}
