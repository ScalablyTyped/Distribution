...
trait PlotPcTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotPcTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotPcTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotPcTooltipDateTimeLabelFormatsOptions]
  }
}
