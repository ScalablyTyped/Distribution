...
trait PlotStreamgraphStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotStreamgraphStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotStreamgraphStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotStreamgraphStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotStreamgraphStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphStatesHoverMarkerOptions]
  }
}
