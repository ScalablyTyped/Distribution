...
trait PlotScatter3dStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotScatter3dStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotScatter3dStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotScatter3dStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotScatter3dStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dStatesHoverMarkerStatesHoverOptions]
  }
}
