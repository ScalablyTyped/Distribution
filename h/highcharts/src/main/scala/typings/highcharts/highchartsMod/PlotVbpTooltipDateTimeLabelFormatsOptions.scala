...
trait PlotVbpTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotVbpTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotVbpTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotVbpTooltipDateTimeLabelFormatsOptions]
  }
}
