...
trait PlotVbpStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotVbpStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotVbpStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVbpStatesSelectMarkerOptions] = js.undefined
}

object PlotVbpStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotVbpStatesSelectAnimationOptions = null,
    ...
    marker: PlotVbpStatesSelectMarkerOptions = null
  ): PlotVbpStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotVbpStatesSelectOptions]
  }
}
