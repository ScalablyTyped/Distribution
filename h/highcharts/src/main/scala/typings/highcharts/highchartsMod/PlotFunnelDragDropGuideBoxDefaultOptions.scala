...
trait PlotFunnelDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotFunnelDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotFunnelDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotFunnelDragDropGuideBoxDefaultOptions]
  }
}
