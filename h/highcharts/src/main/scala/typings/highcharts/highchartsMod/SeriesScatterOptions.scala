...
- typings.highcharts.highchartsMod.PlotScatterOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, compare, compareBase, compareStart, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, includeInDataExport, jitter, joinBy, keys, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, marker, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointRange, pointStart, selected, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, states, step, stickyTracking, threshold, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesScatterOptions
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesScatterOptions: scatter
  /**
    * Not available
    */
