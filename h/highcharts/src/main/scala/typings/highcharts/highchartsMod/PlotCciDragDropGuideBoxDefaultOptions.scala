...
trait PlotCciDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotCciDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCciDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotCciDragDropGuideBoxDefaultOptions]
  }
}
