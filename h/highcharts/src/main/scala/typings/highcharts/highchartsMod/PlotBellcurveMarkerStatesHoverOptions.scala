...
trait PlotBellcurveMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotBellcurveMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotBellcurveMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotBellcurveMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotBellcurveMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveMarkerStatesHoverOptions]
  }
}
