...
trait PlotPriceenvelopesDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotPriceenvelopesDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotPriceenvelopesDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotPriceenvelopesDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotPriceenvelopesDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotPriceenvelopesDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotPriceenvelopesDragDropOptions]
  }
}
