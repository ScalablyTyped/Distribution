...
trait PlotTrendlineDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotTrendlineDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrendlineDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotTrendlineDragDropDragHandleOptions]
  }
}
