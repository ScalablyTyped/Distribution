...
trait PlotLinearregressioninterceptMarkerOptions extends js.Object {
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressioninterceptMarkerStatesOptions] = js.undefined
  /**
...
object PlotLinearregressioninterceptMarkerOptions {
  ...
  def apply(
    ...
    states: PlotLinearregressioninterceptMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLinearregressioninterceptMarkerOptions = {
