...
trait PlotTreemapDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotTreemapDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTreemapDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapDragDropDragHandleOptions]
  }
}
