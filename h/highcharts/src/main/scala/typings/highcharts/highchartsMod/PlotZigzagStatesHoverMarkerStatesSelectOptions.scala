...
trait PlotZigzagStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotZigzagStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotZigzagStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagStatesHoverMarkerStatesSelectOptions]
  }
}
