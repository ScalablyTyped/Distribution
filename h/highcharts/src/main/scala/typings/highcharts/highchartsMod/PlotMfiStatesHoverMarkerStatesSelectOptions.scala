...
trait PlotMfiStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMfiStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMfiStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMfiStatesHoverMarkerStatesSelectOptions]
  }
}
