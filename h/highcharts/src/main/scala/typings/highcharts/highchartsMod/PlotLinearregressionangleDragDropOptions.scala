...
trait PlotLinearregressionangleDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotLinearregressionangleDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotLinearregressionangleDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotLinearregressionangleDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotLinearregressionangleDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotLinearregressionangleDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotLinearregressionangleDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleDragDropOptions]
  }
}
