...
trait SeriesFunnel3dDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesFunnel3dDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesFunnel3dDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesFunnel3dDataDragDropGuideBoxDefaultOptions]
  }
}
