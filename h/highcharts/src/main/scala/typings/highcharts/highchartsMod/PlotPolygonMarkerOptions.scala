...
trait PlotPolygonMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPolygonMarkerStatesOptions] = js.undefined
  /**
...
object PlotPolygonMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPolygonMarkerStatesOptions = null,
    symbol: String = null,
    ...
    __obj.asInstanceOf[PlotPolygonMarkerOptions]
  }
}
