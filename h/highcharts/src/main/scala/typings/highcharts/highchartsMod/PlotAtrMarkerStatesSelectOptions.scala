...
trait PlotAtrMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAtrMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAtrMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAtrMarkerStatesSelectOptions]
  }
}
