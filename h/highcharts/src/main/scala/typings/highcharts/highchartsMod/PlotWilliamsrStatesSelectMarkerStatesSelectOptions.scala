...
trait PlotWilliamsrStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotWilliamsrStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWilliamsrStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrStatesSelectMarkerStatesSelectOptions]
  }
}
