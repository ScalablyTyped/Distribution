...
trait PlotStreamgraphConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotStreamgraphConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStreamgraphConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphConnectorsEndMarkerOptions]
  }
}
