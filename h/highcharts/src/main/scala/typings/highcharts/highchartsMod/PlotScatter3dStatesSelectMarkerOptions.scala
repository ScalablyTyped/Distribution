...
trait PlotScatter3dStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotScatter3dStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotScatter3dStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotScatter3dStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotScatter3dStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dStatesSelectMarkerOptions]
  }
}
