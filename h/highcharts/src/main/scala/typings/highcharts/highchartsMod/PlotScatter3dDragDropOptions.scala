...
trait PlotScatter3dDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotScatter3dDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotScatter3dDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotScatter3dDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotScatter3dDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotScatter3dDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotScatter3dDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dDragDropOptions]
  }
}
