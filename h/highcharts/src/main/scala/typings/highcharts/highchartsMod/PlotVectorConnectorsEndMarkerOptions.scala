...
trait PlotVectorConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotVectorConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVectorConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVectorConnectorsEndMarkerOptions]
  }
}
