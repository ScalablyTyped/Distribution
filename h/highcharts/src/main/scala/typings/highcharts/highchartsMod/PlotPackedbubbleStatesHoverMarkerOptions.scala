...
trait PlotPackedbubbleStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPackedbubbleStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotPackedbubbleStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPackedbubbleStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPackedbubbleStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleStatesHoverMarkerOptions]
  }
}
