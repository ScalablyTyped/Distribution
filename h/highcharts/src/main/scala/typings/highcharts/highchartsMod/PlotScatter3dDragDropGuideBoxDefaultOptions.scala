...
trait PlotScatter3dDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotScatter3dDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatter3dDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dDragDropGuideBoxDefaultOptions]
  }
}
