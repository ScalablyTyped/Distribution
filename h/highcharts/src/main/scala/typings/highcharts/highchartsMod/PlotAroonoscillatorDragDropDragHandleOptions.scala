...
trait PlotAroonoscillatorDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotAroonoscillatorDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorDragDropDragHandleOptions]
  }
}
