...
trait PlotAreasplinerangeStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAreasplinerangeStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplinerangeStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeStatesSelectMarkerStatesSelectOptions]
  }
}
