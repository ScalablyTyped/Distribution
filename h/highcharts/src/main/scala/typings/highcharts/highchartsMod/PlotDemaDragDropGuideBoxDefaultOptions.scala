...
trait PlotDemaDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotDemaDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDemaDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotDemaDragDropGuideBoxDefaultOptions]
  }
}
