...
trait SeriesGanttDataMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | SeriesGanttDataMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object SeriesGanttDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | SeriesGanttDataMarkerStatesHoverAnimationOptions = null,
