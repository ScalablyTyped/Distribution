...
trait PlotAroonDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotAroonDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotAroonDragDropGuideBoxDefaultOptions]
  }
}
