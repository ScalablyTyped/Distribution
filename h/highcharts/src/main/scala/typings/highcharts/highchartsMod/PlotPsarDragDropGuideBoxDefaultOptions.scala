...
trait PlotPsarDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotPsarDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPsarDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotPsarDragDropGuideBoxDefaultOptions]
  }
}
