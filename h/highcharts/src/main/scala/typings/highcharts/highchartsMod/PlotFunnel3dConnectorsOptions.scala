...
trait PlotFunnel3dConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotFunnel3dConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotFunnel3dConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotFunnel3dConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotFunnel3dConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotFunnel3dConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotFunnel3dConnectorsMarkerOptions = null,
    startMarker: PlotFunnel3dConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotFunnel3dConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotFunnel3dConnectorsOptions]
  }
}
