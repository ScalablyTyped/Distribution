...
trait PlotTreemapStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTreemapStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotTreemapStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotTreemapStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotTreemapStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapStatesHoverMarkerOptions]
  }
}
