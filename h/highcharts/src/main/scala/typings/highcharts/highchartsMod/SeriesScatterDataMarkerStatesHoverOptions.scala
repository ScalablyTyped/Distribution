...
trait SeriesScatterDataMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | SeriesScatterDataMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object SeriesScatterDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | SeriesScatterDataMarkerStatesHoverAnimationOptions = null,
