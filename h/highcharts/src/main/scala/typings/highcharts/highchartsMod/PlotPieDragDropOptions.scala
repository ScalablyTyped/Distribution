...
trait PlotPieDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotPieDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotPieDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotPieDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotPieDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotPieDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotPieDragDropOptions]
  }
}
