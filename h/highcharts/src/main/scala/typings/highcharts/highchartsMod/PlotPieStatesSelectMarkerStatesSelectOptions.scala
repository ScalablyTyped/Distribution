...
trait PlotPieStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPieStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPieStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPieStatesSelectMarkerStatesSelectOptions]
  }
}
