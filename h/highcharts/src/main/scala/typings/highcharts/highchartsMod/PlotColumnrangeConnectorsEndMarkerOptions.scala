...
trait PlotColumnrangeConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotColumnrangeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnrangeConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotColumnrangeConnectorsEndMarkerOptions]
  }
}
