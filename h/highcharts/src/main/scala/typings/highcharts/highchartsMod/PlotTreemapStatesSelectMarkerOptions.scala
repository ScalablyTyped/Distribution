...
trait PlotTreemapStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTreemapStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotTreemapStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotTreemapStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotTreemapStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapStatesSelectMarkerOptions]
  }
}
