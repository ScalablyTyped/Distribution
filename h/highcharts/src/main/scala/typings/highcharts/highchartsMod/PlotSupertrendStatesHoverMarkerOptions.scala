...
trait PlotSupertrendStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSupertrendStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotSupertrendStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotSupertrendStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotSupertrendStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendStatesHoverMarkerOptions]
  }
}
