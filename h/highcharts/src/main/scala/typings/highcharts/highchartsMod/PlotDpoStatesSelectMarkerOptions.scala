...
trait PlotDpoStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotDpoStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotDpoStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotDpoStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotDpoStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotDpoStatesSelectMarkerOptions]
  }
}
