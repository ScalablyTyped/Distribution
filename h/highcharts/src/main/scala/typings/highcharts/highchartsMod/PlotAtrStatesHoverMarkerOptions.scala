...
trait PlotAtrStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAtrStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotAtrStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAtrStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAtrStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAtrStatesHoverMarkerOptions]
  }
}
