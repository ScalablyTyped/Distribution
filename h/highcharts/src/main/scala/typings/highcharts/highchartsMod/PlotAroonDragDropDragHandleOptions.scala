...
trait PlotAroonDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotAroonDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotAroonDragDropDragHandleOptions]
  }
}
