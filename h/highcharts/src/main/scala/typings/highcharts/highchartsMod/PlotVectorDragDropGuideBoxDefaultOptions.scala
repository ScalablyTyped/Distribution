...
trait PlotVectorDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotVectorDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVectorDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotVectorDragDropGuideBoxDefaultOptions]
  }
}
