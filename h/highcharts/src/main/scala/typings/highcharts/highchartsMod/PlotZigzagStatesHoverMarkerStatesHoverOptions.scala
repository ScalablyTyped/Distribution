...
trait PlotZigzagStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotZigzagStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotZigzagStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotZigzagStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotZigzagStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagStatesHoverMarkerStatesHoverOptions]
  }
}
