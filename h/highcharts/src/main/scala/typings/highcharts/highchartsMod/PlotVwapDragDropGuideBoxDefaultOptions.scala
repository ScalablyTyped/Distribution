...
trait PlotVwapDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotVwapDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVwapDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotVwapDragDropGuideBoxDefaultOptions]
  }
}
