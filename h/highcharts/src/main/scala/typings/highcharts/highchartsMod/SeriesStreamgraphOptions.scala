...
- typings.highcharts.highchartsMod.PlotStreamgraphOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, compare, compareBase, compareStart, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, fillColor, fillOpacity, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, linecap, lineColor, lineWidth, linkedTo, marker, navigatorOptions, negativeColor, negativeFillColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointPlacement, pointRange, pointStart, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, states, stickyTracking, threshold, tooltip, trackByArea, turboThreshold, visible, zoneAxis, zones */ trait SeriesStreamgraphOptions
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesStreamgraphOptions: streamgraph
  /**
