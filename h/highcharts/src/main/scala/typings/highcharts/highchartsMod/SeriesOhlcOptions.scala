...
- typings.highcharts.highchartsMod.PlotOhlcOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, className, clip, color, colorAxis, colorByPoint, colorIndex, colors, compare, compareBase, compareStart, connectors, cropThreshold, cursor, dataGrouping, dataLabels, depth, description, dragDrop, edgeColor, edgeWidth, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, getExtremesFromAll, grouping, groupPadding, groupZPadding, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, lineWidth, linkedTo, maxPointWidth, minPointLength, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointPadding, pointPlacement, pointRange, pointStart, pointValKey, pointWidth, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, states, stickyTracking, threshold, tooltip, turboThreshold, upColor, visible, zoneAxis, zones */ trait SeriesOhlcOptions
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesOhlcOptions: ohlc
  /**
