...
trait PlotSupertrendDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotSupertrendDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotSupertrendDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotSupertrendDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotSupertrendDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotSupertrendDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotSupertrendDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendDragDropOptions]
  }
}
