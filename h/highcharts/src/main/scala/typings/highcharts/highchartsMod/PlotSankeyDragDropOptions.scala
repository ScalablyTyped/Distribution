...
trait PlotSankeyDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotSankeyDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotSankeyDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotSankeyDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotSankeyDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotSankeyDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotSankeyDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotSankeyDragDropOptions]
  }
}
