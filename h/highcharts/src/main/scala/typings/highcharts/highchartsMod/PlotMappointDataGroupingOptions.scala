...
trait PlotMappointDataGroupingOptions extends js.Object {
  /**
...
object PlotMappointDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMappointDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotMappointDataGroupingOptions]
  }
}
