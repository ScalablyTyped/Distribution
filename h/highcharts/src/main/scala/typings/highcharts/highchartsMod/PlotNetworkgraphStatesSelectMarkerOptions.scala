...
trait PlotNetworkgraphStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotNetworkgraphStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotNetworkgraphStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotNetworkgraphStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotNetworkgraphStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphStatesSelectMarkerOptions]
  }
}
