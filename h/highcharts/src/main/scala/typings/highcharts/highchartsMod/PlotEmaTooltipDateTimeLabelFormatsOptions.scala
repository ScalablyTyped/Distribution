...
trait PlotEmaTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotEmaTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotEmaTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotEmaTooltipDateTimeLabelFormatsOptions]
  }
}
