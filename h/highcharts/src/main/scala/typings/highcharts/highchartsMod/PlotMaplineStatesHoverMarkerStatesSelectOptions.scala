...
trait PlotMaplineStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMaplineStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMaplineStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineStatesHoverMarkerStatesSelectOptions]
  }
}
