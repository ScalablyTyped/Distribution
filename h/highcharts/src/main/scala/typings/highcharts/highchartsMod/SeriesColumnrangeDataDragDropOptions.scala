...
trait SeriesColumnrangeDataDragDropOptions extends js.Object {
  /**
    ...
    */
  var dragHandle: js.UndefOr[SeriesColumnrangeDataDragDropDragHandleOptions] = js.undefined
  /**
...
object SeriesColumnrangeDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesColumnrangeDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesColumnrangeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesColumnrangeDataDragDropOptions = {
