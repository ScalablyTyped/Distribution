...
trait PlotDpoDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotDpoDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotDpoDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotDpoDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotDpoDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotDpoDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotDpoDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotDpoDragDropOptions]
  }
}
