...
trait PlotAoDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotAoDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotAoDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotAoDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotAoDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotAoDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotAoDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotAoDragDropOptions]
  }
}
