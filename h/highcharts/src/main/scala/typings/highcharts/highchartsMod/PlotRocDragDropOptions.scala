...
trait PlotRocDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotRocDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotRocDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotRocDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotRocDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotRocDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotRocDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotRocDragDropOptions]
  }
}
