...
trait PlotVbpOptions extends js.Object {
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotVbpDragDropOptions] = js.undefined
  /**
...
object PlotVbpOptions {
  ...
  def apply(
    ...
    dragDrop: PlotVbpDragDropOptions = null,
    ...
    if (volumeDivision != null) __obj.updateDynamic("volumeDivision")(volumeDivision)
    if (zIndex != null) __obj.updateDynamic("zIndex")(zIndex.asInstanceOf[js.Any])
    if (zoneAxis != null) __obj.updateDynamic("zoneAxis")(zoneAxis)
    if (zoneLines != null) __obj.updateDynamic("zoneLines")(zoneLines)
