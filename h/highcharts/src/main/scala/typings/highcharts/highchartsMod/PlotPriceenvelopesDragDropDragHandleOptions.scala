...
trait PlotPriceenvelopesDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotPriceenvelopesDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPriceenvelopesDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesDragDropDragHandleOptions]
  }
}
