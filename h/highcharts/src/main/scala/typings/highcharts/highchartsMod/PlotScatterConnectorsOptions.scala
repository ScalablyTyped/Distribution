...
trait PlotScatterConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotScatterConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotScatterConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotScatterConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotScatterConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotScatterConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotScatterConnectorsMarkerOptions = null,
    startMarker: PlotScatterConnectorsStartMarkerOptions = null,
    ...
    __obj.asInstanceOf[PlotScatterConnectorsOptions]
  }
}
