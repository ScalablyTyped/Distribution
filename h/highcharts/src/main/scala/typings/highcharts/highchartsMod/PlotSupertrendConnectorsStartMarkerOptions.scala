...
trait PlotSupertrendConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotSupertrendConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSupertrendConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendConnectorsStartMarkerOptions]
  }
}
