...
trait PlotBubbleTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotBubbleTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotBubbleTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleTooltipDateTimeLabelFormatsOptions]
  }
}
