...
trait PlotArearangeStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotArearangeStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotArearangeStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeStatesHoverMarkerStatesSelectOptions]
  }
}
