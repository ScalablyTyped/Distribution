...
trait SeriesBoxplotDataEventsOptions extends js.Object {
  /**
...
object SeriesBoxplotDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesBoxplotDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesBoxplotDataEventsOptions]
  }
}
