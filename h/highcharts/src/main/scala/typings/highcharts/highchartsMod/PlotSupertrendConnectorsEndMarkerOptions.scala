...
trait PlotSupertrendConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotSupertrendConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSupertrendConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendConnectorsEndMarkerOptions]
  }
}
