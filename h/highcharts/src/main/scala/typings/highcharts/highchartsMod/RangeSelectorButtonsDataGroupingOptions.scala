...
trait RangeSelectorButtonsDataGroupingOptions extends js.Object {
  /**
...
object RangeSelectorButtonsDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): RangeSelectorButtonsDataGroupingOptions = {
    ...
    __obj.asInstanceOf[RangeSelectorButtonsDataGroupingOptions]
  }
}
