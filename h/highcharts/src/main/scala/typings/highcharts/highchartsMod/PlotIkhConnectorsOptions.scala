...
trait PlotIkhConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotIkhConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotIkhConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotIkhConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotIkhConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotIkhConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotIkhConnectorsMarkerOptions = null,
    startMarker: PlotIkhConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotIkhConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotIkhConnectorsOptions]
  }
}
