...
trait PlotCciDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotCciDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotCciDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotCciDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotCciDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotCciDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotCciDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotCciDragDropOptions]
  }
}
