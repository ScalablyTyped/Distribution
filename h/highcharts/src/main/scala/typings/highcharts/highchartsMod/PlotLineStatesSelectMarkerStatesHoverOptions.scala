...
trait PlotLineStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLineStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLineStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLineStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotLineStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLineStatesSelectMarkerStatesHoverOptions]
  }
}
