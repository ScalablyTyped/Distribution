...
trait PlotNetworkgraphMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotNetworkgraphMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotNetworkgraphMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotNetworkgraphMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotNetworkgraphMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphMarkerStatesHoverOptions]
  }
}
