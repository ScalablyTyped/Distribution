...
trait PlotAroonoscillatorStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAroonoscillatorStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorStatesSelectMarkerStatesSelectOptions]
  }
}
