...
trait PlotPivotpointsStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPivotpointsStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPivotpointsStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPivotpointsStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPivotpointsStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsStatesSelectMarkerStatesHoverOptions]
  }
}
