...
trait PlotVennStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotVennStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVennStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotVennStatesSelectMarkerStatesSelectOptions]
  }
}
