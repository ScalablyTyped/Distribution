...
trait PlotSeriesStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotSeriesStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotSeriesStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSeriesStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotSeriesStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesStatesHoverMarkerStatesHoverOptions]
  }
}
