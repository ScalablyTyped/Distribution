...
trait PlotSunburstDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotSunburstDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSunburstDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotSunburstDragDropDragHandleOptions]
  }
}
