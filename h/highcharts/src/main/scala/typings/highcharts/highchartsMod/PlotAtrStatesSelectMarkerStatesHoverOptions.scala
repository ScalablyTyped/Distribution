...
trait PlotAtrStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAtrStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAtrStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAtrStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAtrStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAtrStatesSelectMarkerStatesHoverOptions]
  }
}
