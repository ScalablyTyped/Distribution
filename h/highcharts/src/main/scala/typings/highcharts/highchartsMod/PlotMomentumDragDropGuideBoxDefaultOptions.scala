...
trait PlotMomentumDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotMomentumDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMomentumDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumDragDropGuideBoxDefaultOptions]
  }
}
