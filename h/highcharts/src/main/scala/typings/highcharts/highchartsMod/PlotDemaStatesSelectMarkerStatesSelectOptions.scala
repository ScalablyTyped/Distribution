...
trait PlotDemaStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotDemaStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDemaStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotDemaStatesSelectMarkerStatesSelectOptions]
  }
}
