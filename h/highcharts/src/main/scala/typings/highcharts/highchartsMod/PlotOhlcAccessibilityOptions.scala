...
trait PlotOhlcAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotOhlcAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotOhlcAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotOhlcAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotOhlcAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotOhlcAccessibilityOptions]
  }
}
