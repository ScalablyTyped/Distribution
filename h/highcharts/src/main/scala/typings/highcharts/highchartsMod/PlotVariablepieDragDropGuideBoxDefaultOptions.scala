...
trait PlotVariablepieDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotVariablepieDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVariablepieDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepieDragDropGuideBoxDefaultOptions]
  }
}
