...
trait PlotAroonoscillatorStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAroonoscillatorStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAroonoscillatorStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAroonoscillatorStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAroonoscillatorStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorStatesSelectMarkerStatesHoverOptions]
  }
}
