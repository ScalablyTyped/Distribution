...
trait PlotLinearregressioninterceptDataGroupingOptions extends js.Object {
  /**
...
object PlotLinearregressioninterceptDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressioninterceptDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptDataGroupingOptions]
  }
}
