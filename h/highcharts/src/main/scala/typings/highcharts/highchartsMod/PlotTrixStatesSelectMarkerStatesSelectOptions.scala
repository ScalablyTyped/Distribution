...
trait PlotTrixStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTrixStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrixStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTrixStatesSelectMarkerStatesSelectOptions]
  }
}
