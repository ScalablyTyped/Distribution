...
trait PlotTilemapStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTilemapStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotTilemapStatesSelectMarkerStatesSelectOptions]
  }
}
