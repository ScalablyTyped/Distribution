...
trait SeriesBulletDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesBulletDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesBulletDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesBulletDataDragDropDragHandleOptions]
  }
}
