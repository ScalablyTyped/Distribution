...
trait PlotWordcloudLabelOptions extends js.Object {
  /**
...
object PlotWordcloudLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotWordcloudLabelOptions]
  }
}
