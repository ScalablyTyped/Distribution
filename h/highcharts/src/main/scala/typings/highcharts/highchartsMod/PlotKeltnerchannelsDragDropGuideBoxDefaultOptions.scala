...
trait PlotKeltnerchannelsDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsDragDropGuideBoxDefaultOptions]
  }
}
