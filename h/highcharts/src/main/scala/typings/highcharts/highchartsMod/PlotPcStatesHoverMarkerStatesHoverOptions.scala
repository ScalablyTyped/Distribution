...
trait PlotPcStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPcStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPcStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPcStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPcStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPcStatesHoverMarkerStatesHoverOptions]
  }
}
