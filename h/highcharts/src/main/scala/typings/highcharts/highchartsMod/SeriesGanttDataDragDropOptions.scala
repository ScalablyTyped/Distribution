...
trait SeriesGanttDataDragDropOptions extends js.Object {
  /**
    * (Gantt) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesGanttDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesGanttDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesGanttDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesGanttDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesGanttDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesGanttDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesGanttDataDragDropOptions]
  }
}
