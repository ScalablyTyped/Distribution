...
trait PlotMacdStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMacdStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMacdStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMacdStatesSelectMarkerStatesSelectOptions]
  }
}
