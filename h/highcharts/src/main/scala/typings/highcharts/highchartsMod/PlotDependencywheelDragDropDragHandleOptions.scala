...
trait PlotDependencywheelDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotDependencywheelDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDependencywheelDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelDragDropDragHandleOptions]
  }
}
