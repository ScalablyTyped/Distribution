...
- typings.highcharts.highchartsMod.PlotVariablepieOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, boostBlending, borderColor, borderWidth, center, className, clip, color, colorAxis, colorIndex, colors, compare, compareBase, compareStart, connectors, cursor, dataGrouping, dataLabels, depth, description, dragDrop, enableMouseTracking, endAngle, events, exposeElementToA11y, gapSize, gapUnit, ignoreHiddenPoint, includeInDataExport, innerSize, joinBy, keys, lastPrice, lastVisiblePrice, linecap, linkedTo, maxPointSize, minPointSize, minSize, navigatorOptions, opacity, point, pointDescriptionFormatter, pointRange, selected, shadow, showCheckbox, showInLegend, showInNavigator, size, sizeBy, skipKeyboardNavigation, slicedOffset, startAngle, states, stickyTracking, tooltip, useOhlcData, visible, zMax, zMin */ trait SeriesVariablepieOptions
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesVariablepieOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesVariablepieOptions: variablepie
  /**
  ...
  /**
    ...
    */
  @JSName("xAxis")
  var xAxis_SeriesVariablepieOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
    * Not available
    */
  @JSName("yAxis")
  var yAxis_SeriesVariablepieOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
