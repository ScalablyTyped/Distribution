...
trait PlotPriceenvelopesMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPriceenvelopesMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPriceenvelopesMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesMarkerStatesSelectOptions]
  }
}
