...
trait PlotStochasticStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotStochasticStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotStochasticStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotStochasticStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotStochasticStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticStatesHoverMarkerStatesHoverOptions]
  }
}
