...
trait PlotColumnrangeDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotColumnrangeDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnrangeDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotColumnrangeDragDropGuideBoxDefaultOptions]
  }
}
