...
trait SeriesPieDataEventsOptions extends js.Object {
  /**
...
object SeriesPieDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesPieDataEventsOptions]
  }
}
