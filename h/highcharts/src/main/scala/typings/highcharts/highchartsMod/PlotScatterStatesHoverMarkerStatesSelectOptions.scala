...
trait PlotScatterStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotScatterStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatterStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotScatterStatesHoverMarkerStatesSelectOptions]
  }
}
