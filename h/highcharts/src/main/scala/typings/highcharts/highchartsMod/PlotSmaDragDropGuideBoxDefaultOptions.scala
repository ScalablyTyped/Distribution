...
trait PlotSmaDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotSmaDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSmaDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotSmaDragDropGuideBoxDefaultOptions]
  }
}
