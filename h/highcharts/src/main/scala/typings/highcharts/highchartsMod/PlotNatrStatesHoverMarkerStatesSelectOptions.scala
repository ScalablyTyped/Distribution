...
trait PlotNatrStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotNatrStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNatrStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotNatrStatesHoverMarkerStatesSelectOptions]
  }
}
