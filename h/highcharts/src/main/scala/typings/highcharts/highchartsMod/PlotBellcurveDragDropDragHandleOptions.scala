...
trait PlotBellcurveDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotBellcurveDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBellcurveDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveDragDropDragHandleOptions]
  }
}
