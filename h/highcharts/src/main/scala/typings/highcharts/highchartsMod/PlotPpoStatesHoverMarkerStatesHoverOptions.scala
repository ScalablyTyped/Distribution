...
trait PlotPpoStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPpoStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPpoStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPpoStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPpoStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPpoStatesHoverMarkerStatesHoverOptions]
  }
}
