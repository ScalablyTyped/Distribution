...
import typings.highcharts.highchartsStrings.cylinder
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotCylinderOptions because var conflicts: zIndex. Inlined accessibility, allowPointSelect, animation, animationLimit, boostBlending, borderColor, borderRadius, borderWidth, className, clip, color, colorByPoint, colorIndex, colors, compareStart, connectors, crisp, cropThreshold, cursor, dataGrouping, dataLabels, depth, description, dragDrop, edgeColor, edgeWidth, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, getExtremesFromAll, grouping, groupPadding, groupZPadding, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, linkedTo, maxPointWidth, minPointLength, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointPadding, pointPlacement, pointRange, pointStart, pointWidth, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, states, stickyTracking, threshold, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesCylinderOptions
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotCylinderDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesCylinderOptions: cylinder
  /**
...
object SeriesCylinderOptions {
  ...
  def apply(
    ...
    dragDrop: PlotCylinderDragDropOptions = null,
