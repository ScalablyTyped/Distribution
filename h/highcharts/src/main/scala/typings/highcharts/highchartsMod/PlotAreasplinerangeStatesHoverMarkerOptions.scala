...
trait PlotAreasplinerangeStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAreasplinerangeStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotAreasplinerangeStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAreasplinerangeStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAreasplinerangeStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeStatesHoverMarkerOptions]
  }
}
