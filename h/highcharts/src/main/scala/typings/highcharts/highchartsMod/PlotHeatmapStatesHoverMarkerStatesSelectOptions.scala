...
trait PlotHeatmapStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotHeatmapStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotHeatmapStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapStatesHoverMarkerStatesSelectOptions]
  }
}
