...
trait PlotParetoStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotParetoStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotParetoStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotParetoStatesSelectMarkerStatesSelectOptions]
  }
}
