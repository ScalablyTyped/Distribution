...
trait PlotDemaStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotDemaStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDemaStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotDemaStatesHoverMarkerStatesSelectOptions]
  }
}
