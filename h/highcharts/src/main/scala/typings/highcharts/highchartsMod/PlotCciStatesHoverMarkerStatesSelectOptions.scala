...
trait PlotCciStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotCciStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCciStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotCciStatesHoverMarkerStatesSelectOptions]
  }
}
