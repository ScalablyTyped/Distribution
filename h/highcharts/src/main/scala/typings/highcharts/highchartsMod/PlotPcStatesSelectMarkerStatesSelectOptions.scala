...
trait PlotPcStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPcStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPcStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPcStatesSelectMarkerStatesSelectOptions]
  }
}
