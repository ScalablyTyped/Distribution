...
trait PlotHistogramStatesOptions extends js.Object {
  /**
    ...
    * touched.
    */
  var hover: js.UndefOr[PlotHistogramStatesHoverOptions] = js.undefined
  /**
    * (Highcharts) The opposite state of a hover for series.
    */
  var inactive: js.UndefOr[PlotHistogramStatesInactiveOptions] = js.undefined
  /**
    * (Highcharts) The normal state of a series, or for point items in column,
    * pie and similar series. Currently only used for setting animation when
    * returning to normal state from hover.
    */
  var normal: js.UndefOr[PlotHistogramStatesNormalOptions] = js.undefined
  /**
    ...
    */
  var select: js.UndefOr[PlotHistogramStatesSelectOptions] = js.undefined
}

object PlotHistogramStatesOptions {
  @scala.inline
  def apply(
    hover: PlotHistogramStatesHoverOptions = null,
    inactive: PlotHistogramStatesInactiveOptions = null,
    normal: PlotHistogramStatesNormalOptions = null,
    select: PlotHistogramStatesSelectOptions = null
  ): PlotHistogramStatesOptions = {
