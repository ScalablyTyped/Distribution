...
trait PlotDependencywheelDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotDependencywheelDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotDependencywheelDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotDependencywheelDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotDependencywheelDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotDependencywheelDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotDependencywheelDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelDragDropOptions]
  }
}
