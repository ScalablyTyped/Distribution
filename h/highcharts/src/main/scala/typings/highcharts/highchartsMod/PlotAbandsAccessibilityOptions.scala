...
trait PlotAbandsAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotAbandsAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotAbandsAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotAbandsAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotAbandsAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsAccessibilityOptions]
  }
}
