...
trait PlotLinearregressionangleStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressionangleStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotLinearregressionangleStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLinearregressionangleStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLinearregressionangleStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleStatesSelectMarkerOptions]
  }
}
