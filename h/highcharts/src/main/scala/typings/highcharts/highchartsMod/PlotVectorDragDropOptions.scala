...
trait PlotVectorDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotVectorDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotVectorDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotVectorDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotVectorDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotVectorDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotVectorDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotVectorDragDropOptions]
  }
}
