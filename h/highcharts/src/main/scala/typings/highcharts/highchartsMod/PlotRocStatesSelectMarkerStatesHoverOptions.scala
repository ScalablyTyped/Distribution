...
trait PlotRocStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotRocStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotRocStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotRocStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotRocStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotRocStatesSelectMarkerStatesHoverOptions]
  }
}
