...
trait PlotLinearregressionangleMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressionangleMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressionangleMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressionangleMarkerStatesHoverAnimationOptions = null,
