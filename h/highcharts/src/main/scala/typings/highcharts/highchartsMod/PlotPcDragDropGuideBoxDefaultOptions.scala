...
trait PlotPcDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotPcDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPcDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotPcDragDropGuideBoxDefaultOptions]
  }
}
