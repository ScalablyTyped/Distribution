...
trait PlotIkhStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotIkhStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotIkhStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotIkhStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotIkhStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotIkhStatesHoverMarkerStatesHoverOptions]
  }
}
