...
trait PlotVariablepieDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotVariablepieDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVariablepieDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepieDragDropDragHandleOptions]
  }
}
