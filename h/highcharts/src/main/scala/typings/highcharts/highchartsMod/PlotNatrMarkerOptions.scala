...
trait PlotNatrMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotNatrMarkerStatesOptions] = js.undefined
  /**
...
object PlotNatrMarkerOptions {
  ...
  def apply(
    ...
    states: PlotNatrMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotNatrMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotNatrMarkerOptions]
  }
}
