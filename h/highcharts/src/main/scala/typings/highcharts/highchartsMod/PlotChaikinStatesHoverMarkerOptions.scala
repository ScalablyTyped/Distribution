...
trait PlotChaikinStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotChaikinStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotChaikinStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotChaikinStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotChaikinStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinStatesHoverMarkerOptions]
  }
}
