...
trait SonifyChartOptionsObject extends js.Object {
  ...
  var earcons: js.UndefOr[
    js.Array[typings.highcharts.modulesSonificationMod.highchartsMod.EarconConfiguration]
  ] = js.undefined
  /**
    * The instrument definitions for the points in this chart.
    */
  var instruments: js.UndefOr[
    js.Array[typings.highcharts.modulesSonificationMod.highchartsMod.PointInstrumentObject]
  ] = js.undefined
  /**
  ...
  var order: String | (js.Array[
    String | typings.highcharts.modulesSonificationMod.highchartsMod.Earcon | (js.Array[String | typings.highcharts.modulesSonificationMod.highchartsMod.Earcon])
  ])
  /**
...
object SonifyChartOptionsObject {
  ...
  def apply(
    ...
    earcons: js.Array[typings.highcharts.modulesSonificationMod.highchartsMod.EarconConfiguration] = null,
    instruments: js.Array[typings.highcharts.modulesSonificationMod.highchartsMod.PointInstrumentObject] = null,
