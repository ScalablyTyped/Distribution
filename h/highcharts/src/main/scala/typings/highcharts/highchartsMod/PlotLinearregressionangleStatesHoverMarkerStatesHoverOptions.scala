...
trait PlotLinearregressionangleStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressionangleStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressionangleStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressionangleStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressionangleStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleStatesHoverMarkerStatesHoverOptions]
  }
}
