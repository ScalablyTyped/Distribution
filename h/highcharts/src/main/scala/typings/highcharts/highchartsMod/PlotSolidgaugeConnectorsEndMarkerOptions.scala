...
trait PlotSolidgaugeConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotSolidgaugeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSolidgaugeConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSolidgaugeConnectorsEndMarkerOptions]
  }
}
