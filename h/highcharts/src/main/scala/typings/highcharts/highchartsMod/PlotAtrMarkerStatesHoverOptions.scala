...
trait PlotAtrMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAtrMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotAtrMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAtrMarkerStatesHoverAnimationOptions = null,
