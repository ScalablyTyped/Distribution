...
import typings.highcharts.highchartsStrings.pareto
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotParetoOptions because var conflicts: zIndex. Inlined accessibility, allowPointSelect, animation, animationLimit, boostBlending, className, clip, color, colorIndex, compare, compareBase, compareStart, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, getExtremesFromAll, includeInDataExport, joinBy, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, marker, navigatorOptions, opacity, point, pointDescriptionFormatter, selected, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, states, stickyTracking, tooltip, turboThreshold, useOhlcData, visible */ trait SeriesParetoOptions
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesParetoOptions: pareto
  /**
