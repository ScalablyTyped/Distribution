...
trait PlotPivotpointsStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPivotpointsStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotPivotpointsStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPivotpointsStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPivotpointsStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsStatesSelectMarkerOptions]
  }
}
