...
trait PlotPivotpointsDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotPivotpointsDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotPivotpointsDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotPivotpointsDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotPivotpointsDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotPivotpointsDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotPivotpointsDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsDragDropOptions]
  }
}
