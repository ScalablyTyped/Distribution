...
trait PlotRocStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotRocStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotRocStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotRocStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotRocStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotRocStatesHoverMarkerOptions]
  }
}
