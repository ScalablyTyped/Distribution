...
trait PlotLinearregressionanglePointEventsOptions extends js.Object {
  /**
...
object PlotLinearregressionanglePointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionanglePointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionanglePointEventsOptions]
  }
}
