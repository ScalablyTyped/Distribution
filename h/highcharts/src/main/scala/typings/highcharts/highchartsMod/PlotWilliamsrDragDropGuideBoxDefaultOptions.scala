...
trait PlotWilliamsrDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotWilliamsrDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWilliamsrDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrDragDropGuideBoxDefaultOptions]
  }
}
