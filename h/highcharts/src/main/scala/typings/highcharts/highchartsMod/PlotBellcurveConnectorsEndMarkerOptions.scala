...
trait PlotBellcurveConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotBellcurveConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBellcurveConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveConnectorsEndMarkerOptions]
  }
}
