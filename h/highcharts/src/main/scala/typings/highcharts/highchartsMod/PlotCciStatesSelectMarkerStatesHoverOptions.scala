...
trait PlotCciStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotCciStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotCciStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotCciStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotCciStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotCciStatesSelectMarkerStatesHoverOptions]
  }
}
