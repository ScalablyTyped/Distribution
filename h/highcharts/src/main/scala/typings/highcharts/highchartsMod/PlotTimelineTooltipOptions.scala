...
trait PlotTimelineTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotTimelineTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotTimelineTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    className: String = null,
    dateTimeLabelFormats: PlotTimelineTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
    ...
    __obj.asInstanceOf[PlotTimelineTooltipOptions]
  }
}
