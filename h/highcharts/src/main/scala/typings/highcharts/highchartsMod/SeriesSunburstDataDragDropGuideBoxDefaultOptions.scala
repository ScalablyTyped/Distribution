...
trait SeriesSunburstDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesSunburstDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesSunburstDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesSunburstDataDragDropGuideBoxDefaultOptions]
  }
}
