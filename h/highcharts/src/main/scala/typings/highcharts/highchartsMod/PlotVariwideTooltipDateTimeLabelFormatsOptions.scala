...
trait PlotVariwideTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotVariwideTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotVariwideTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotVariwideTooltipDateTimeLabelFormatsOptions]
  }
}
