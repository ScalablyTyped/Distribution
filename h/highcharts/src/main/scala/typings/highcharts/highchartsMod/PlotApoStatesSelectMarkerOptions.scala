...
trait PlotApoStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotApoStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotApoStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotApoStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotApoStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotApoStatesSelectMarkerOptions]
  }
}
