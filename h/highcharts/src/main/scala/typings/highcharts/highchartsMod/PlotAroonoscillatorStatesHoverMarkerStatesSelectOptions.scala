...
trait PlotAroonoscillatorStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAroonoscillatorStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorStatesHoverMarkerStatesSelectOptions]
  }
}
