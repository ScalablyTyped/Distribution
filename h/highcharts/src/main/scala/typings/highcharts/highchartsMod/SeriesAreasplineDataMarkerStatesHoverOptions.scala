...
trait SeriesAreasplineDataMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | SeriesAreasplineDataMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object SeriesAreasplineDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | SeriesAreasplineDataMarkerStatesHoverAnimationOptions = null,
  ...
  ): SeriesAreasplineDataMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[SeriesAreasplineDataMarkerStatesHoverOptions]
  }
}
