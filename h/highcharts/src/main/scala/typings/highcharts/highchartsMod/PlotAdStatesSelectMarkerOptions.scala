...
trait PlotAdStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAdStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotAdStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAdStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAdStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAdStatesSelectMarkerOptions]
  }
}
