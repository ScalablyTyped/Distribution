...
trait PlotVennDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotVennDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotVennDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotVennDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotVennDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotVennDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotVennDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotVennDragDropOptions]
  }
}
