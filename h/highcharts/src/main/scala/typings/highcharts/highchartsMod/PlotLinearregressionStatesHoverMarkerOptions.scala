...
trait PlotLinearregressionStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressionStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotLinearregressionStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLinearregressionStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLinearregressionStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionStatesHoverMarkerOptions]
  }
}
