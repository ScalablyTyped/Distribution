...
trait PlotAroonTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotAroonTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotAroonTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotAroonTooltipDateTimeLabelFormatsOptions]
  }
}
