...
trait PlotAroonStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAroonStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotAroonStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAroonStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAroonStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonStatesHoverMarkerOptions]
  }
}
