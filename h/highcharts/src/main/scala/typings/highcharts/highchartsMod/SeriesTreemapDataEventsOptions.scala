...
trait SeriesTreemapDataEventsOptions extends js.Object {
  /**
...
object SeriesTreemapDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesTreemapDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesTreemapDataEventsOptions]
  }
}
