...
trait SeriesXrangeDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock, Gantt) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesXrangeDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesXrangeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesXrangeDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesXrangeDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesXrangeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesXrangeDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesXrangeDataDragDropOptions]
  }
}
