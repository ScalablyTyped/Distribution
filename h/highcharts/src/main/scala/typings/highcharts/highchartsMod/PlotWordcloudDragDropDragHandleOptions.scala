...
trait PlotWordcloudDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotWordcloudDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWordcloudDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotWordcloudDragDropDragHandleOptions]
  }
}
