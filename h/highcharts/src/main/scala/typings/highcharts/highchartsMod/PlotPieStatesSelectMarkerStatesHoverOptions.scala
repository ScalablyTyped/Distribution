...
trait PlotPieStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPieStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPieStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPieStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPieStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPieStatesSelectMarkerStatesHoverOptions]
  }
}
