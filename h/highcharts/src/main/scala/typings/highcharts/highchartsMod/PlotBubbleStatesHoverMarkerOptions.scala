...
trait PlotBubbleStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotBubbleStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotBubbleStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotBubbleStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotBubbleStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleStatesHoverMarkerOptions]
  }
}
