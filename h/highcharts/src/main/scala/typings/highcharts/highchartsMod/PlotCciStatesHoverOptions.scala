...
trait PlotCciStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotCciStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotCciStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotCciStatesHoverMarkerOptions] = js.undefined
}

object PlotCciStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotCciStatesHoverAnimationOptions = null,
    ...
    marker: PlotCciStatesHoverMarkerOptions = null
  ): PlotCciStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotCciStatesHoverOptions]
  }
}
