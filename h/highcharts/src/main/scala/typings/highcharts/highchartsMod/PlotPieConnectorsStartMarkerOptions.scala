...
trait PlotPieConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotPieConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPieConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPieConnectorsStartMarkerOptions]
  }
}
