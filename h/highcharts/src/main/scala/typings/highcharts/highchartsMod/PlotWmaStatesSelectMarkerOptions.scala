...
trait PlotWmaStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotWmaStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotWmaStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotWmaStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotWmaStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWmaStatesSelectMarkerOptions]
  }
}
