...
trait PlotAdDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotAdDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAdDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotAdDragDropGuideBoxDefaultOptions]
  }
}
