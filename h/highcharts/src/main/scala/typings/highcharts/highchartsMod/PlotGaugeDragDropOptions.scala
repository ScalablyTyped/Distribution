...
trait PlotGaugeDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotGaugeDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotGaugeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotGaugeDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotGaugeDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotGaugeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotGaugeDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotGaugeDragDropOptions]
  }
}
