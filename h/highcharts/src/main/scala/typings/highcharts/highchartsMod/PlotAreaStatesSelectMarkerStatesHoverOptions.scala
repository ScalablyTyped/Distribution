...
trait PlotAreaStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAreaStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAreaStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAreaStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAreaStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAreaStatesSelectMarkerStatesHoverOptions]
  }
}
