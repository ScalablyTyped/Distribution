...
trait PlotZigzagDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotZigzagDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotZigzagDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagDragDropGuideBoxDefaultOptions]
  }
}
