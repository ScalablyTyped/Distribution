...
trait PlotMapConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotMapConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMapConnectorsMarkerOptions]
  }
}
