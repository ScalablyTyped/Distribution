...
trait PlotParetoStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotParetoStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotParetoStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotParetoStatesSelectMarkerOptions] = js.undefined
}

object PlotParetoStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotParetoStatesSelectAnimationOptions = null,
    ...
    marker: PlotParetoStatesSelectMarkerOptions = null
  ): PlotParetoStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotParetoStatesSelectOptions]
  }
}
