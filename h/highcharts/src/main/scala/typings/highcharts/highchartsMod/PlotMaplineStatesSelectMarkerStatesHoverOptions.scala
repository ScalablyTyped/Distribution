...
trait PlotMaplineStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMaplineStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMaplineStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMaplineStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMaplineStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineStatesSelectMarkerStatesHoverOptions]
  }
}
