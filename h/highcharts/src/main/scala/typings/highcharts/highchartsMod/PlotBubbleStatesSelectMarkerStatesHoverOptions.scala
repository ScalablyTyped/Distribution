...
trait PlotBubbleStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotBubbleStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotBubbleStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotBubbleStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotBubbleStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleStatesSelectMarkerStatesHoverOptions]
  }
}
