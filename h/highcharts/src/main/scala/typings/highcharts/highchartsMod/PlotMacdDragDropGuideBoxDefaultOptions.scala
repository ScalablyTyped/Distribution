...
trait PlotMacdDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotMacdDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMacdDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotMacdDragDropGuideBoxDefaultOptions]
  }
}
