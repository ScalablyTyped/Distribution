...
import typings.highcharts.highchartsStrings.area
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotAreaOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, compare, compareBase, compareStart, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, fillColor, fillOpacity, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, linecap, lineColor, lineWidth, linkedTo, marker, navigatorOptions, negativeColor, negativeFillColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointPlacement, pointRange, pointStart, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, states, step, stickyTracking, threshold, tooltip, trackByArea, turboThreshold, visible, zoneAxis, zones */ trait SeriesAreaOptions
  ...
  /**
    ...
    */
  var accessibility: js.UndefOr[js.Object | PlotAreaAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAreaAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotAreaConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotAreaDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotAreaDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotAreaEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[PlotAreaLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotAreaLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotAreaLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAreaMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var point: js.UndefOr[PlotAreaPointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotAreaStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotAreaTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesAreaOptions: area
  /**
    * Not available
    */
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotAreaZonesOptions]] = js.undefined
}

object SeriesAreaOptions {
  @scala.inline
  def apply(
    `type`: area,
    ...
    __obj.asInstanceOf[SeriesAreaOptions]
  }
}
