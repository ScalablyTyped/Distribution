...
trait PlotLinearregressionStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressionStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionStatesHoverMarkerStatesSelectOptions]
  }
}
