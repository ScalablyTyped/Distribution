...
trait PlotArearangePointEventsOptions extends js.Object {
  /**
...
object PlotArearangePointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotArearangePointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotArearangePointEventsOptions]
  }
}
