...
trait PlotDemaConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotDemaConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDemaConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotDemaConnectorsStartMarkerOptions]
  }
}
