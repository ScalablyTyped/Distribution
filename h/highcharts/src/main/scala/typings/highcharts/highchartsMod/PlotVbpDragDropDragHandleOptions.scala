...
trait PlotVbpDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotVbpDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVbpDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotVbpDragDropDragHandleOptions]
  }
}
