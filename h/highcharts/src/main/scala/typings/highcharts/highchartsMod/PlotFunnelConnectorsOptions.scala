...
trait PlotFunnelConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotFunnelConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotFunnelConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotFunnelConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotFunnelConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotFunnelConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotFunnelConnectorsMarkerOptions = null,
    startMarker: PlotFunnelConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotFunnelConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotFunnelConnectorsOptions]
  }
}
