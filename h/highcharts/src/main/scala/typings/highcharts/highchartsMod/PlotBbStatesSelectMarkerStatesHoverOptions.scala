...
trait PlotBbStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotBbStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotBbStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotBbStatesSelectMarkerStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotBbStatesSelectMarkerStatesHoverOptions]
  }
}
