...
trait PlotAreaStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAreaStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreaStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAreaStatesSelectMarkerStatesSelectOptions]
  }
}
