...
trait PlotAdStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAdStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAdStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAdStatesHoverMarkerStatesSelectOptions]
  }
}
