...
trait SeriesGaugeDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesGaugeDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesGaugeDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesGaugeDataDragDropGuideBoxDefaultOptions]
  }
}
