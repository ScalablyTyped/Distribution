...
trait PlotMapbubbleStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMapbubbleStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMapbubbleStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMapbubbleStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMapbubbleStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleStatesHoverMarkerStatesHoverOptions]
  }
}
