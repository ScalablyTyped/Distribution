...
trait PlotSupertrendStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotSupertrendStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSupertrendStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendStatesSelectMarkerStatesSelectOptions]
  }
}
