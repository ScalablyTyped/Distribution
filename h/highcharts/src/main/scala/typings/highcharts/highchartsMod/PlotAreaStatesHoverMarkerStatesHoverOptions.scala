...
trait PlotAreaStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAreaStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAreaStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAreaStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAreaStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAreaStatesHoverMarkerStatesHoverOptions]
  }
}
