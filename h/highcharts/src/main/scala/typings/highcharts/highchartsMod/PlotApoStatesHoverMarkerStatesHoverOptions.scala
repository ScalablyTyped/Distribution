...
trait PlotApoStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotApoStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotApoStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotApoStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotApoStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotApoStatesHoverMarkerStatesHoverOptions]
  }
}
