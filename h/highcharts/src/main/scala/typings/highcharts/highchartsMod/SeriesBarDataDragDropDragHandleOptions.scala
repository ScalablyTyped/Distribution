...
trait SeriesBarDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesBarDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesBarDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesBarDataDragDropDragHandleOptions]
  }
}
