...
trait PlotStreamgraphMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotStreamgraphMarkerStatesOptions] = js.undefined
  /**
...
object PlotStreamgraphMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotStreamgraphMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotStreamgraphMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphMarkerOptions]
  }
}
