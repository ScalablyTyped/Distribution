...
trait PlotAroonStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAroonStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAroonStatesHoverMarkerStatesSelectOptions]
  }
}
