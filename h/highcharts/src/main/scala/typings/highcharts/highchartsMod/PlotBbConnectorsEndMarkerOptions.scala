...
trait PlotBbConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotBbConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBbConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBbConnectorsEndMarkerOptions]
  }
}
