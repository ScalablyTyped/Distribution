...
trait PlotItemMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotItemMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotItemMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotItemMarkerStatesSelectOptions]
  }
}
