...
trait PlotVennStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotVennStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVennStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotVennStatesHoverMarkerStatesSelectOptions]
  }
}
