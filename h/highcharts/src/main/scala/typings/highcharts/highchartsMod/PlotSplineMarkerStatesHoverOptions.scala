...
trait PlotSplineMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSplineMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotSplineMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSplineMarkerStatesHoverAnimationOptions = null,
