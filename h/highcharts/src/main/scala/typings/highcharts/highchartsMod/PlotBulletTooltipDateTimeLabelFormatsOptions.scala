...
trait PlotBulletTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotBulletTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotBulletTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotBulletTooltipDateTimeLabelFormatsOptions]
  }
}
