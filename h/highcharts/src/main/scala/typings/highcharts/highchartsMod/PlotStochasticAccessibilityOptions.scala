...
trait PlotStochasticAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotStochasticAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotStochasticAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotStochasticAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotStochasticAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticAccessibilityOptions]
  }
}
