...
trait PlotPsarStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPsarStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotPsarStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPsarStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPsarStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPsarStatesHoverMarkerOptions]
  }
}
