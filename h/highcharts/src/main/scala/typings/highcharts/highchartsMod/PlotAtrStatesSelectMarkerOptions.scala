...
trait PlotAtrStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAtrStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotAtrStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAtrStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAtrStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAtrStatesSelectMarkerOptions]
  }
}
