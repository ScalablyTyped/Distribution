...
trait PlotMaplineConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotMaplineConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMaplineConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineConnectorsMarkerOptions]
  }
}
