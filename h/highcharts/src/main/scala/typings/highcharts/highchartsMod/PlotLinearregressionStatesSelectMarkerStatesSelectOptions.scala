...
trait PlotLinearregressionStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressionStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionStatesSelectMarkerStatesSelectOptions]
  }
}
