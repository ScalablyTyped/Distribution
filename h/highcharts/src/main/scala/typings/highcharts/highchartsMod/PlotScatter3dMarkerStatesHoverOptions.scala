...
trait PlotScatter3dMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotScatter3dMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotScatter3dMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotScatter3dMarkerStatesHoverAnimationOptions = null,
