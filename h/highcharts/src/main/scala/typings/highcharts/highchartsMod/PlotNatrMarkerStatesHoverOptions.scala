...
trait PlotNatrMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotNatrMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotNatrMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotNatrMarkerStatesHoverAnimationOptions = null,
