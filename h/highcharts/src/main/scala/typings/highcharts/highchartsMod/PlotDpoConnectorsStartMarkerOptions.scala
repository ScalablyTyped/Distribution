...
trait PlotDpoConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotDpoConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDpoConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotDpoConnectorsStartMarkerOptions]
  }
}
