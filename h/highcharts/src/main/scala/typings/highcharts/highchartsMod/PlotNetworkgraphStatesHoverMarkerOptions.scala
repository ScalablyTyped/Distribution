...
trait PlotNetworkgraphStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotNetworkgraphStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotNetworkgraphStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotNetworkgraphStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotNetworkgraphStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphStatesHoverMarkerOptions]
  }
}
