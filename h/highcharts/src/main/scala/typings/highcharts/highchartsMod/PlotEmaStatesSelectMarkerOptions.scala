...
trait PlotEmaStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotEmaStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotEmaStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotEmaStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotEmaStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotEmaStatesSelectMarkerOptions]
  }
}
