...
trait PlotMomentumStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMomentumStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMomentumStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumStatesSelectMarkerStatesSelectOptions]
  }
}
