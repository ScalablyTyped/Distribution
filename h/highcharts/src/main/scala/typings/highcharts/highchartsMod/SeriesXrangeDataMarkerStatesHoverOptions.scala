...
trait SeriesXrangeDataMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | SeriesXrangeDataMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object SeriesXrangeDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | SeriesXrangeDataMarkerStatesHoverAnimationOptions = null,
