...
trait PlotVectorStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotVectorStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotVectorStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVectorStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotVectorStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotVectorStatesSelectMarkerStatesHoverOptions]
  }
}
