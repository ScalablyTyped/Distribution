...
trait PlotErrorbarAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotErrorbarAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotErrorbarAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotErrorbarAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotErrorbarAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotErrorbarAccessibilityOptions]
  }
}
