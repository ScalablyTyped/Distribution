...
trait PlotCmfStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotCmfStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotCmfStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotCmfStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotCmfStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCmfStatesHoverMarkerOptions]
  }
}
