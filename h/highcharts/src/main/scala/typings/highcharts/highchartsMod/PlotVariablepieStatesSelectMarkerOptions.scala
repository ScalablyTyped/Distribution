...
trait PlotVariablepieStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotVariablepieStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotVariablepieStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotVariablepieStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotVariablepieStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepieStatesSelectMarkerOptions]
  }
}
