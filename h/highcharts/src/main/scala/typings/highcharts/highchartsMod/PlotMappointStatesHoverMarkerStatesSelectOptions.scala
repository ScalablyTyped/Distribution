...
trait PlotMappointStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMappointStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMappointStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMappointStatesHoverMarkerStatesSelectOptions]
  }
}
