...
trait PlotPpoStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPpoStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotPpoStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPpoStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPpoStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPpoStatesSelectMarkerOptions]
  }
}
