...
trait PlotBarConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotBarConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBarConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBarConnectorsStartMarkerOptions]
  }
}
