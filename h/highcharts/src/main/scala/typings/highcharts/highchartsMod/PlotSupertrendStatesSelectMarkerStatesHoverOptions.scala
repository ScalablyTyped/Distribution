...
trait PlotSupertrendStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotSupertrendStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotSupertrendStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSupertrendStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotSupertrendStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendStatesSelectMarkerStatesHoverOptions]
  }
}
