...
trait PlotMomentumDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotMomentumDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotMomentumDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotMomentumDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotMomentumDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotMomentumDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotMomentumDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumDragDropOptions]
  }
}
