...
trait PlotLineStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLineStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLineStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLineStatesHoverMarkerStatesSelectOptions]
  }
}
