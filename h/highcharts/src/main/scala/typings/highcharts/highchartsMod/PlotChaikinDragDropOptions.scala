...
trait PlotChaikinDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotChaikinDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotChaikinDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotChaikinDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotChaikinDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotChaikinDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotChaikinDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinDragDropOptions]
  }
}
