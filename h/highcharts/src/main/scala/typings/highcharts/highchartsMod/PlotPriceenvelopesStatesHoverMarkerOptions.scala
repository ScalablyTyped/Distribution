...
trait PlotPriceenvelopesStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPriceenvelopesStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotPriceenvelopesStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPriceenvelopesStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPriceenvelopesStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesStatesHoverMarkerOptions]
  }
}
