...
trait PlotScatter3dStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotScatter3dStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotScatter3dStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotScatter3dStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotScatter3dStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dStatesSelectMarkerStatesHoverOptions]
  }
}
