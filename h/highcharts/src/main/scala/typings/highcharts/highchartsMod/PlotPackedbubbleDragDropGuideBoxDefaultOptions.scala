...
trait PlotPackedbubbleDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotPackedbubbleDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPackedbubbleDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleDragDropGuideBoxDefaultOptions]
  }
}
