...
trait PlotAoStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAoStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotAoStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAoStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAoStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAoStatesSelectMarkerOptions]
  }
}
