...
trait PlotSankeyDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotSankeyDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSankeyDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotSankeyDragDropGuideBoxDefaultOptions]
  }
}
