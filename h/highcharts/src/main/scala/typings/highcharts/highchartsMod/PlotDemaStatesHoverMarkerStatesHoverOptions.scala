...
trait PlotDemaStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotDemaStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotDemaStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotDemaStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotDemaStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotDemaStatesHoverMarkerStatesHoverOptions]
  }
}
