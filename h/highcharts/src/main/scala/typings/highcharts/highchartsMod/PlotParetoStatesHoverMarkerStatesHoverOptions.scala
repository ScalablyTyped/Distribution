...
trait PlotParetoStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotParetoStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotParetoStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotParetoStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotParetoStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotParetoStatesHoverMarkerStatesHoverOptions]
  }
}
