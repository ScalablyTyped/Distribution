...
trait PlotVennStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotVennStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotVennStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVennStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotVennStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotVennStatesHoverMarkerStatesHoverOptions]
  }
}
