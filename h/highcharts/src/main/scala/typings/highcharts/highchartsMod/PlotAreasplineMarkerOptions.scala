...
trait PlotAreasplineMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAreasplineMarkerStatesOptions] = js.undefined
  /**
...
object PlotAreasplineMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAreasplineMarkerStatesOptions = null,
    symbol: String = null,
    ...
    __obj.asInstanceOf[PlotAreasplineMarkerOptions]
  }
}
