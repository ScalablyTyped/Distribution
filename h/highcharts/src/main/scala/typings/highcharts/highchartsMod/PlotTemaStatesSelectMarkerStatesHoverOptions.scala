...
trait PlotTemaStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotTemaStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotTemaStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTemaStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotTemaStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTemaStatesSelectMarkerStatesHoverOptions]
  }
}
