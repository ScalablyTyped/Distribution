...
trait PlotLinearregressionDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotLinearregressionDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionDragDropGuideBoxDefaultOptions]
  }
}
