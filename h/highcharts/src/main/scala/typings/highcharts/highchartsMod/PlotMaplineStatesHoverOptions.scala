...
trait PlotMaplineStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMaplineStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMaplineStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMaplineStatesHoverMarkerOptions] = js.undefined
}

object PlotMaplineStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMaplineStatesHoverAnimationOptions = null,
    ...
    marker: PlotMaplineStatesHoverMarkerOptions = null
  ): PlotMaplineStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineStatesHoverOptions]
  }
}
