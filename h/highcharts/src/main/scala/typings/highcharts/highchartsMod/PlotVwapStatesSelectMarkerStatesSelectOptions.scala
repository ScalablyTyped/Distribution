...
trait PlotVwapStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotVwapStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVwapStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotVwapStatesSelectMarkerStatesSelectOptions]
  }
}
