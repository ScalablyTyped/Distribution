...
trait PlotEmaStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotEmaStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotEmaStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotEmaStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotEmaStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotEmaStatesHoverMarkerOptions]
  }
}
