...
trait PlotStochasticPointEventsOptions extends js.Object {
  /**
...
object PlotStochasticPointEventsOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStochasticPointEventsOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticPointEventsOptions]
  }
}
