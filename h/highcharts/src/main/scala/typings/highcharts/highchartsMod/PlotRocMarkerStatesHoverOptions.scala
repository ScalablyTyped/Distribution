...
trait PlotRocMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotRocMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotRocMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotRocMarkerStatesHoverAnimationOptions = null,
