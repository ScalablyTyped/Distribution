...
trait PlotPolygonStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPolygonStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPolygonStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPolygonStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPolygonStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonStatesSelectMarkerStatesHoverOptions]
  }
}
