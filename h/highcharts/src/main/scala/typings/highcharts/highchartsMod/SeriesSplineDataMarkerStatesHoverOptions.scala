...
trait SeriesSplineDataMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | SeriesSplineDataMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object SeriesSplineDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | SeriesSplineDataMarkerStatesHoverAnimationOptions = null,
  ...
  ): SeriesSplineDataMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[SeriesSplineDataMarkerStatesHoverOptions]
  }
}
