...
trait PlotPivotpointsStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPivotpointsStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotPivotpointsStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPivotpointsStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPivotpointsStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsStatesHoverMarkerOptions]
  }
}
