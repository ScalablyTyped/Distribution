...
trait PlotNatrStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotNatrStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotNatrStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotNatrStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotNatrStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotNatrStatesHoverMarkerOptions]
  }
}
