...
trait PlotVbpMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotVbpMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotVbpMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVbpMarkerStatesHoverAnimationOptions = null,
