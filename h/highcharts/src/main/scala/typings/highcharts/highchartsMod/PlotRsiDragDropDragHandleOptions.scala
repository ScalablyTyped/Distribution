...
trait PlotRsiDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotRsiDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRsiDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotRsiDragDropDragHandleOptions]
  }
}
