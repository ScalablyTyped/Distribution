...
trait PlotSunburstConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotSunburstConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSunburstConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSunburstConnectorsEndMarkerOptions]
  }
}
