...
trait PlotTrixStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotTrixStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotTrixStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTrixStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotTrixStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTrixStatesHoverMarkerStatesHoverOptions]
  }
}
