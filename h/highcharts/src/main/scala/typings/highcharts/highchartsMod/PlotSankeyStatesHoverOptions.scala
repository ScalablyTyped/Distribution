...
trait PlotSankeyStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotSankeyStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotSankeyStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSankeyStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotSankeyStatesHoverOptions]
  }
}
