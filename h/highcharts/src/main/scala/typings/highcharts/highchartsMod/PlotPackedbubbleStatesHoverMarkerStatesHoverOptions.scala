...
trait PlotPackedbubbleStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPackedbubbleStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPackedbubbleStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPackedbubbleStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPackedbubbleStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleStatesHoverMarkerStatesHoverOptions]
  }
}
