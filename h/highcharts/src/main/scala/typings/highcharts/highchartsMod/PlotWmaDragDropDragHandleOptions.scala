...
trait PlotWmaDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotWmaDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWmaDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotWmaDragDropDragHandleOptions]
  }
}
