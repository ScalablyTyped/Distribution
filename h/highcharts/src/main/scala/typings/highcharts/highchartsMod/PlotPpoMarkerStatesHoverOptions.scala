...
trait PlotPpoMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPpoMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotPpoMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPpoMarkerStatesHoverAnimationOptions = null,
