...
trait PlotStochasticMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotStochasticMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotStochasticMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotStochasticMarkerStatesHoverAnimationOptions = null,
