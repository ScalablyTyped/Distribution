...
trait PlotScatterPointEventsOptions extends js.Object {
  /**
...
object PlotScatterPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotScatterPointEventsOptions]
  }
}
