...
trait PlotCandlestickDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotCandlestickDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCandlestickDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotCandlestickDragDropDragHandleOptions]
  }
}
