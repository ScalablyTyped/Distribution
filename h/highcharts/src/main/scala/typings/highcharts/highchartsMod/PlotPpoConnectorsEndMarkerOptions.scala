...
trait PlotPpoConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotPpoConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPpoConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPpoConnectorsEndMarkerOptions]
  }
}
