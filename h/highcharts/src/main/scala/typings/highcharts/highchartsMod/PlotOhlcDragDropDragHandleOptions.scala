...
trait PlotOhlcDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotOhlcDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotOhlcDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotOhlcDragDropDragHandleOptions]
  }
}
