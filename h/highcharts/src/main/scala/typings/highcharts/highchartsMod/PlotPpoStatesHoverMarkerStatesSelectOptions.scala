...
trait PlotPpoStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPpoStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPpoStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPpoStatesHoverMarkerStatesSelectOptions]
  }
}
