...
trait PlotNetworkgraphTooltipOptions extends js.Object {
  /**
  ...
  /**
    ...
    * dateFormat.
    */
  var dateTimeLabelFormats: js.UndefOr[PlotNetworkgraphTooltipDateTimeLabelFormatsOptions | Dictionary[String]] = js.undefined
  /**
...
object PlotNetworkgraphTooltipOptions {
  @scala.inline
  def apply(
    changeDecimals: Int | Double = null,
    className: String = null,
    dateTimeLabelFormats: PlotNetworkgraphTooltipDateTimeLabelFormatsOptions | Dictionary[String] = null,
  ...
  ): PlotNetworkgraphTooltipOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphTooltipOptions]
  }
}
