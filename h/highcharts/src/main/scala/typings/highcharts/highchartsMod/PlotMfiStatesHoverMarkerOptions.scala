...
trait PlotMfiStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMfiStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotMfiStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMfiStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMfiStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMfiStatesHoverMarkerOptions]
  }
}
