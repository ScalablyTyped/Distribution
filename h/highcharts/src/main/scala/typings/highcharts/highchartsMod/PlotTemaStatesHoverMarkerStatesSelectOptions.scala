...
trait PlotTemaStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTemaStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTemaStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTemaStatesHoverMarkerStatesSelectOptions]
  }
}
