...
trait PlotAdStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAdStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAdStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAdStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAdStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAdStatesHoverMarkerStatesHoverOptions]
  }
}
