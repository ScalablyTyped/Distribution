...
trait PlotCciStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotCciStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotCciStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotCciStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotCciStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotCciStatesHoverMarkerStatesHoverOptions]
  }
}
