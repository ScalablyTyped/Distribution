...
trait PlotTemaStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTemaStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotTemaStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotTemaStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotTemaStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTemaStatesSelectMarkerOptions]
  }
}
