...
trait PlotPyramidConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotPyramidConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramidConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPyramidConnectorsEndMarkerOptions]
  }
}
