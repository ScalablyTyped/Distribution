...
trait PlotAroonoscillatorConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotAroonoscillatorConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorConnectorsEndMarkerOptions]
  }
}
