...
trait PlotIkhStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotIkhStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotIkhStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotIkhStatesSelectMarkerOptions] = js.undefined
}

object PlotIkhStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotIkhStatesSelectAnimationOptions = null,
    ...
    marker: PlotIkhStatesSelectMarkerOptions = null
  ): PlotIkhStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotIkhStatesSelectOptions]
  }
}
