...
trait PlotAoMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAoMarkerStatesOptions] = js.undefined
  /**
...
object PlotAoMarkerOptions {
  ...
  def apply(
    ...
    states: PlotAoMarkerStatesOptions = null,
    symbol: String = null,
    ...
    __obj.asInstanceOf[PlotAoMarkerOptions]
  }
}
