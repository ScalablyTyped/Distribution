...
trait PlotKeltnerchannelsConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsConnectorsMarkerOptions]
  }
}
