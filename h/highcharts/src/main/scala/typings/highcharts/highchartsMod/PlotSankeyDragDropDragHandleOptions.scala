...
trait PlotSankeyDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotSankeyDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSankeyDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotSankeyDragDropDragHandleOptions]
  }
}
