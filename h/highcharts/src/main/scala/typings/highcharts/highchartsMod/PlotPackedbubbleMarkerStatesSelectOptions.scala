...
trait PlotPackedbubbleMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPackedbubbleMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPackedbubbleMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleMarkerStatesSelectOptions]
  }
}
