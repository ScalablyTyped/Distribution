...
trait PlotPyramidOptions extends js.Object {
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotPyramidDragDropOptions] = js.undefined
  /**
...
object PlotPyramidOptions {
  ...
  def apply(
    ...
    dragDrop: PlotPyramidDragDropOptions = null,
    ...
    if (neckHeight != null) __obj.updateDynamic("neckHeight")(neckHeight)
    if (neckWidth != null) __obj.updateDynamic("neckWidth")(neckWidth)
