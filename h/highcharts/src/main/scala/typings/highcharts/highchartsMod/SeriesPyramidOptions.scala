...
- typings.highcharts.highchartsMod.PlotPyramidOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, boostBlending, borderColor, borderWidth, center, className, clip, color, colorAxis, colorIndex, colors, compare, compareBase, compareStart, connectors, cursor, dataGrouping, dataLabels, depth, description, dragDrop, enableMouseTracking, endAngle, events, exposeElementToA11y, gapSize, gapUnit, height, ignoreHiddenPoint, includeInDataExport, innerSize, joinBy, keys, lastPrice, lastVisiblePrice, linecap, linkedTo, minSize, navigatorOptions, neckHeight, neckWidth, opacity, point, pointDescriptionFormatter, pointRange, reversed, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, slicedOffset, startAngle, states, stickyTracking, tooltip, useOhlcData, visible, width */ trait SeriesPyramidOptions
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesPyramidOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesPyramidOptions: pyramid
  /**
  ...
  /**
    ...
    */
  @JSName("xAxis")
  var xAxis_SeriesPyramidOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
    * Not available
    */
  @JSName("yAxis")
  var yAxis_SeriesPyramidOptions: js.UndefOr[scala.Nothing] = js.undefined
}
