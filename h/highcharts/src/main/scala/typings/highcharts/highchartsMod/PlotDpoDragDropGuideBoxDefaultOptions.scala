...
trait PlotDpoDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotDpoDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDpoDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotDpoDragDropGuideBoxDefaultOptions]
  }
}
