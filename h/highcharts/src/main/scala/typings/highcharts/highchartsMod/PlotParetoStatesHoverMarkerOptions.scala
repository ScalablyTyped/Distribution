...
trait PlotParetoStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotParetoStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotParetoStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotParetoStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotParetoStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotParetoStatesHoverMarkerOptions]
  }
}
