...
trait PlotLinearregressionangleStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressionangleStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionangleStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleStatesHoverMarkerStatesSelectOptions]
  }
}
