...
trait PlotMfiDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotMfiDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotMfiDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotMfiDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotMfiDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotMfiDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotMfiDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotMfiDragDropOptions]
  }
}
