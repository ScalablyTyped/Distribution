...
trait PlotVbpStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotVbpStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotVbpStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVbpStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotVbpStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotVbpStatesSelectMarkerStatesHoverOptions]
  }
}
