...
trait PlotPcStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPcStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotPcStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPcStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPcStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPcStatesSelectMarkerOptions]
  }
}
