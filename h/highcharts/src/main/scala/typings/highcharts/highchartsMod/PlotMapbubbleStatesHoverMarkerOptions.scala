...
trait PlotMapbubbleStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMapbubbleStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotMapbubbleStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMapbubbleStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMapbubbleStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleStatesHoverMarkerOptions]
  }
}
