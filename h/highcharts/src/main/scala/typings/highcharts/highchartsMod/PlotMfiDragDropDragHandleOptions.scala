...
trait PlotMfiDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotMfiDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMfiDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotMfiDragDropDragHandleOptions]
  }
}
