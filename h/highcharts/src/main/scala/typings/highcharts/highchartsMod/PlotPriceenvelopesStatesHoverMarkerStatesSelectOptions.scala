...
trait PlotPriceenvelopesStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPriceenvelopesStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPriceenvelopesStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesStatesHoverMarkerStatesSelectOptions]
  }
}
