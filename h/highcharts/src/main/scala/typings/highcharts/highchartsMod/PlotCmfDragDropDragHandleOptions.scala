...
trait PlotCmfDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotCmfDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCmfDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotCmfDragDropDragHandleOptions]
  }
}
