...
trait PlotAroonoscillatorStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAroonoscillatorStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotAroonoscillatorStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAroonoscillatorStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAroonoscillatorStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorStatesSelectMarkerOptions]
  }
}
