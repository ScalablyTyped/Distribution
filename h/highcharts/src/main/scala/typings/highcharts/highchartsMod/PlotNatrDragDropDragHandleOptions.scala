...
trait PlotNatrDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotNatrDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNatrDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotNatrDragDropDragHandleOptions]
  }
}
