...
trait PlotDependencywheelDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotDependencywheelDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDependencywheelDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotDependencywheelDragDropGuideBoxDefaultOptions]
  }
}
