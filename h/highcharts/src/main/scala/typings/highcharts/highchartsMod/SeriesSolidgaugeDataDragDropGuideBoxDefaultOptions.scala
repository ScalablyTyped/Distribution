...
trait SeriesSolidgaugeDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesSolidgaugeDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesSolidgaugeDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesSolidgaugeDataDragDropGuideBoxDefaultOptions]
  }
}
