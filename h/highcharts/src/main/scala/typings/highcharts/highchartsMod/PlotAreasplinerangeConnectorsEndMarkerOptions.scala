...
trait PlotAreasplinerangeConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotAreasplinerangeConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplinerangeConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeConnectorsEndMarkerOptions]
  }
}
