...
trait PlotSplineAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotSplineAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotSplineAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotSplineAccessibilityKeyboardNavigationOptions = null,
    ...
    __obj.asInstanceOf[PlotSplineAccessibilityOptions]
  }
}
