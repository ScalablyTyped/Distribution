...
trait PlotScatter3dStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotScatter3dStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatter3dStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dStatesSelectMarkerStatesSelectOptions]
  }
}
