...
trait PlotTilemapStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotTilemapStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotTilemapStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTilemapStatesSelectMarkerStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotTilemapStatesSelectMarkerStatesHoverOptions]
  }
}
