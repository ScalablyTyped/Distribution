...
trait PlotStochasticStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotStochasticStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStochasticStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticStatesHoverMarkerStatesSelectOptions]
  }
}
