...
trait PlotMacdOptions extends js.Object {
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotMacdDragDropOptions] = js.undefined
  /**
...
object PlotMacdOptions {
  ...
  def apply(
    ...
    dragDrop: PlotMacdDragDropOptions = null,
    ...
    if (signalLine != null) __obj.updateDynamic("signalLine")(signalLine)
