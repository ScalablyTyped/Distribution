...
trait PlotAreaDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotAreaDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreaDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotAreaDragDropGuideBoxDefaultOptions]
  }
}
