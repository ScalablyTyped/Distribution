...
trait PlotWmaStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotWmaStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotWmaStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotWmaStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotWmaStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWmaStatesHoverMarkerOptions]
  }
}
