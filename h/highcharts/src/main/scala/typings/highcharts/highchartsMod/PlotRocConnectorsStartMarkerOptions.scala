...
trait PlotRocConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotRocConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRocConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotRocConnectorsStartMarkerOptions]
  }
}
