...
trait PlotWilliamsrStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotWilliamsrStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotWilliamsrStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotWilliamsrStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotWilliamsrStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrStatesSelectMarkerOptions]
  }
}
