...
trait SeriesTreemapDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesTreemapDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesTreemapDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesTreemapDataDragDropGuideBoxDefaultOptions]
  }
}
