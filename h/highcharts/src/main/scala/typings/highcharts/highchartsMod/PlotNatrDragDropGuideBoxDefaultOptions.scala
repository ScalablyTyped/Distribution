...
trait PlotNatrDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotNatrDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNatrDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotNatrDragDropGuideBoxDefaultOptions]
  }
}
