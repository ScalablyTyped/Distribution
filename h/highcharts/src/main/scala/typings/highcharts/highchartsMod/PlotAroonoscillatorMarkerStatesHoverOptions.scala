...
trait PlotAroonoscillatorMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAroonoscillatorMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAroonoscillatorMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAroonoscillatorMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAroonoscillatorMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorMarkerStatesHoverOptions]
  }
}
