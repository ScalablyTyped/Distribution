...
trait PlotBubbleStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotBubbleStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotBubbleStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotBubbleStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotBubbleStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleStatesSelectMarkerOptions]
  }
}
