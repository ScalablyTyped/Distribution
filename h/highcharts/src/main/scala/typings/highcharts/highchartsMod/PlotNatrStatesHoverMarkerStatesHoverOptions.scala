...
trait PlotNatrStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotNatrStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotNatrStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotNatrStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotNatrStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotNatrStatesHoverMarkerStatesHoverOptions]
  }
}
