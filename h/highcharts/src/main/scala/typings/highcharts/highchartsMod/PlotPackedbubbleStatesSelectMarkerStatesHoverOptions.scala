...
trait PlotPackedbubbleStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPackedbubbleStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPackedbubbleStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPackedbubbleStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPackedbubbleStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPackedbubbleStatesSelectMarkerStatesHoverOptions]
  }
}
