...
trait PlotAtrStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAtrStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAtrStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAtrStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAtrStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAtrStatesHoverMarkerStatesHoverOptions]
  }
}
