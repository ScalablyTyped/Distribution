...
trait PlotLinearregressionslopeDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeDragDropDragHandleOptions]
  }
}
