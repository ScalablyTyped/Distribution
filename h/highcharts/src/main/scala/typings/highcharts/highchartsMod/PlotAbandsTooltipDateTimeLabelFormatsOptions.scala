...
trait PlotAbandsTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotAbandsTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotAbandsTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsTooltipDateTimeLabelFormatsOptions]
  }
}
