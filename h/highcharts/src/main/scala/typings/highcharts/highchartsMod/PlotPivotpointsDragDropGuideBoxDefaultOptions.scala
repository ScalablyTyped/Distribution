...
trait PlotPivotpointsDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotPivotpointsDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPivotpointsDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsDragDropGuideBoxDefaultOptions]
  }
}
