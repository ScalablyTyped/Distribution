...
trait SeriesStreamgraphDataMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | SeriesStreamgraphDataMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object SeriesStreamgraphDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | SeriesStreamgraphDataMarkerStatesHoverAnimationOptions = null,
