...
trait PlotWordcloudDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotWordcloudDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotWordcloudDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotWordcloudDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotWordcloudDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotWordcloudDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotWordcloudDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotWordcloudDragDropOptions]
  }
}
