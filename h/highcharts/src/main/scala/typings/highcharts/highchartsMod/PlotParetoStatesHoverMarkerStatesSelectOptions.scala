...
trait PlotParetoStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotParetoStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotParetoStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotParetoStatesHoverMarkerStatesSelectOptions]
  }
}
