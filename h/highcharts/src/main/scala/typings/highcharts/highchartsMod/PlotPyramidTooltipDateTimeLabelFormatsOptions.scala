...
trait PlotPyramidTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotPyramidTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotPyramidTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotPyramidTooltipDateTimeLabelFormatsOptions]
  }
}
