...
trait PlotMaplineTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotMaplineTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotMaplineTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineTooltipDateTimeLabelFormatsOptions]
  }
}
