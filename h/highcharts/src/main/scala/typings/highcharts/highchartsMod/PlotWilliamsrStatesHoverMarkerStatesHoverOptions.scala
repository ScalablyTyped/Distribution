...
trait PlotWilliamsrStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotWilliamsrStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotWilliamsrStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotWilliamsrStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotWilliamsrStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrStatesHoverMarkerStatesHoverOptions]
  }
}
