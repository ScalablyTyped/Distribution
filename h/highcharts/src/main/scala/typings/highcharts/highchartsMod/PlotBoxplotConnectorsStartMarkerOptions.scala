...
trait PlotBoxplotConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotBoxplotConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBoxplotConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBoxplotConnectorsStartMarkerOptions]
  }
}
