...
trait PlotStochasticDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotStochasticDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotStochasticDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotStochasticDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotStochasticDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotStochasticDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotStochasticDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticDragDropOptions]
  }
}
