...
trait PlotLinearregressionangleStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressionangleStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionangleStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleStatesSelectMarkerStatesSelectOptions]
  }
}
