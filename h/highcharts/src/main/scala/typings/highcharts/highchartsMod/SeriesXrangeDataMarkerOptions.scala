...
trait SeriesXrangeDataMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesXrangeDataMarkerStatesOptions] = js.undefined
  /**
...
object SeriesXrangeDataMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: SeriesXrangeDataMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): SeriesXrangeDataMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesXrangeDataMarkerOptions]
  }
}
