...
trait PlotCmfTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotCmfTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotCmfTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotCmfTooltipDateTimeLabelFormatsOptions]
  }
}
