...
trait PlotScatter3dDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotScatter3dDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotScatter3dDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dDragDropDragHandleOptions]
  }
}
