...
import typings.highcharts.highchartsStrings.timeline
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotTimelineOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, boostBlending, borderColor, borderWidth, className, clip, color, colorAxis, colorByPoint, colorIndex, compare, compareBase, compareStart, connectors, cursor, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, gapSize, gapUnit, ignoreHiddenPoint, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, legendType, linecap, lineWidth, linkedTo, marker, navigatorOptions, opacity, point, pointDescriptionFormatter, pointRange, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, states, stickyTracking, tooltip, useOhlcData, visible */ trait SeriesTimelineOptions
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesTimelineOptions: js.UndefOr[scala.Nothing] = js.undefined
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesTimelineOptions: timeline
  /**
