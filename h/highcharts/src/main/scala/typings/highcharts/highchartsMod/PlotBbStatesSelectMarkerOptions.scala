...
trait PlotBbStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotBbStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotBbStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotBbStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotBbStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotBbStatesSelectMarkerOptions]
  }
}
