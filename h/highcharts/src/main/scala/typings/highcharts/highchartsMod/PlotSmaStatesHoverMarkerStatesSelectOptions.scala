...
trait PlotSmaStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotSmaStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSmaStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotSmaStatesHoverMarkerStatesSelectOptions]
  }
}
