...
trait PlotArearangeStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotArearangeStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotArearangeStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotArearangeStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotArearangeStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeStatesHoverMarkerStatesHoverOptions]
  }
}
