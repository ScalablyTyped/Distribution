...
trait PlotRocAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotRocAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotRocAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotRocAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotRocAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotRocAccessibilityOptions]
  }
}
