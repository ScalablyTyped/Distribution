...
trait PlotLinearregressioninterceptStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLinearregressioninterceptStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotLinearregressioninterceptStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLinearregressioninterceptStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLinearregressioninterceptStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptStatesSelectMarkerOptions]
  }
}
