...
trait PlotParetoConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotParetoConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotParetoConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotParetoConnectorsEndMarkerOptions]
  }
}
