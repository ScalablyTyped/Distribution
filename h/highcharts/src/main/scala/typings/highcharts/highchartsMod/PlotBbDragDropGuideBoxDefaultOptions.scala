...
trait PlotBbDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotBbDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBbDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotBbDragDropGuideBoxDefaultOptions]
  }
}
