...
trait PlotTemaDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotTemaDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTemaDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotTemaDragDropGuideBoxDefaultOptions]
  }
}
