...
trait PlotVariablepieDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotVariablepieDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotVariablepieDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotVariablepieDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotVariablepieDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotVariablepieDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotVariablepieDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotVariablepieDragDropOptions]
  }
}
