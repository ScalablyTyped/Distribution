...
trait PlotIkhOptions extends js.Object {
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotIkhDragDropOptions] = js.undefined
  /**
...
object PlotIkhOptions {
  ...
  def apply(
    ...
    dragDrop: PlotIkhDragDropOptions = null,
    ...
    if (chikouLine != null) __obj.updateDynamic("chikouLine")(chikouLine)
    ...
    if (kijunLine != null) __obj.updateDynamic("kijunLine")(kijunLine)
    ...
    if (senkouSpan != null) __obj.updateDynamic("senkouSpan")(senkouSpan)
    if (senkouSpanA != null) __obj.updateDynamic("senkouSpanA")(senkouSpanA)
    if (senkouSpanB != null) __obj.updateDynamic("senkouSpanB")(senkouSpanB)
    ...
    if (tenkanLine != null) __obj.updateDynamic("tenkanLine")(tenkanLine)
