...
trait PlotMomentumStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotMomentumStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotMomentumStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMomentumStatesSelectMarkerOptions] = js.undefined
}

object PlotMomentumStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotMomentumStatesSelectAnimationOptions = null,
    ...
    marker: PlotMomentumStatesSelectMarkerOptions = null
  ): PlotMomentumStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumStatesSelectOptions]
  }
}
