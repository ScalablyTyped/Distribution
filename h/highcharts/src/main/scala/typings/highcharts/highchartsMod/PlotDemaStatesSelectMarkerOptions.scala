...
trait PlotDemaStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotDemaStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotDemaStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotDemaStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotDemaStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotDemaStatesSelectMarkerOptions]
  }
}
