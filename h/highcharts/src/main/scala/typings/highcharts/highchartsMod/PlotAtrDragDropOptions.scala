...
trait PlotAtrDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotAtrDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotAtrDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotAtrDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotAtrDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotAtrDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotAtrDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotAtrDragDropOptions]
  }
}
