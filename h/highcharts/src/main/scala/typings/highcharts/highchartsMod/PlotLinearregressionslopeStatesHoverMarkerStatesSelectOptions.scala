...
trait PlotLinearregressionslopeStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeStatesHoverMarkerStatesSelectOptions]
  }
}
