...
trait PlotTimelineStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotTimelineStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotTimelineStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTimelineStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotTimelineStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineStatesSelectMarkerStatesHoverOptions]
  }
}
