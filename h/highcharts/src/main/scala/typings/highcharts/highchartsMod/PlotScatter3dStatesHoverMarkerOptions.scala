...
trait PlotScatter3dStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotScatter3dStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotScatter3dStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotScatter3dStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotScatter3dStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotScatter3dStatesHoverMarkerOptions]
  }
}
