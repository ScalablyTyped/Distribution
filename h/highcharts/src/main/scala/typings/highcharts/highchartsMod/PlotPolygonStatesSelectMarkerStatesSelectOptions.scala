...
trait PlotPolygonStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPolygonStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPolygonStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonStatesSelectMarkerStatesSelectOptions]
  }
}
