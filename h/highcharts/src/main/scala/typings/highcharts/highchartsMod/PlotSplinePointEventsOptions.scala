...
trait PlotSplinePointEventsOptions extends js.Object {
  /**
...
object PlotSplinePointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotSplinePointEventsOptions]
  }
}
