...
trait PlotAroonStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAroonStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotAroonStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAroonStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAroonStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonStatesSelectMarkerOptions]
  }
}
