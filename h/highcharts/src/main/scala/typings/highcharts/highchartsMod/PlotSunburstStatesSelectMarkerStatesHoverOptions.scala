...
trait PlotSunburstStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotSunburstStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotSunburstStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSunburstStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotSunburstStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotSunburstStatesSelectMarkerStatesHoverOptions]
  }
}
