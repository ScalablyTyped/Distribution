...
trait PlotItemStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotItemStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotItemStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotItemStatesSelectMarkerStatesSelectOptions]
  }
}
