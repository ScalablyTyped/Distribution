...
trait PlotMapbubbleZonesOptions extends js.Object {
  /**
...
object PlotMapbubbleZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotMapbubbleZonesOptions]
  }
}
