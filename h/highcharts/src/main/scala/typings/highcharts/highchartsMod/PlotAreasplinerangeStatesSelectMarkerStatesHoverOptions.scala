...
trait PlotAreasplinerangeStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAreasplinerangeStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAreasplinerangeStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAreasplinerangeStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAreasplinerangeStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeStatesSelectMarkerStatesHoverOptions]
  }
}
