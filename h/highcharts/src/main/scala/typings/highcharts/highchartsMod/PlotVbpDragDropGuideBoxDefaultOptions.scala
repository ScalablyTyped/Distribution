...
trait PlotVbpDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotVbpDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVbpDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotVbpDragDropGuideBoxDefaultOptions]
  }
}
