...
trait PlotPsarStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotPsarStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPsarStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotPsarStatesSelectMarkerStatesSelectOptions]
  }
}
