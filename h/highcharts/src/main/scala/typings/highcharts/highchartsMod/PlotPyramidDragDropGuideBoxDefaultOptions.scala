...
trait PlotPyramidDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotPyramidDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPyramidDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotPyramidDragDropGuideBoxDefaultOptions]
  }
}
