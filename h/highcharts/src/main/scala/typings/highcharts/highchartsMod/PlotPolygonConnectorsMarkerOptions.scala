...
trait PlotPolygonConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotPolygonConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPolygonConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonConnectorsMarkerOptions]
  }
}
