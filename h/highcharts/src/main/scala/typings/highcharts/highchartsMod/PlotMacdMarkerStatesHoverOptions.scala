...
trait PlotMacdMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMacdMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotMacdMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMacdMarkerStatesHoverAnimationOptions = null,
