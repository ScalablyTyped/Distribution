...
trait PlotLinearregressionDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotLinearregressionDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionDragDropDragHandleOptions]
  }
}
