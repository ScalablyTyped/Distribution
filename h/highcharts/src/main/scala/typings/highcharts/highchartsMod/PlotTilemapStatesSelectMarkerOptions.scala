...
trait PlotTilemapStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTilemapStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotTilemapStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotTilemapStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotTilemapStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTilemapStatesSelectMarkerOptions]
  }
}
