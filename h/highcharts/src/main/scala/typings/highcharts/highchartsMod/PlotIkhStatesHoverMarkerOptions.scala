...
trait PlotIkhStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotIkhStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotIkhStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotIkhStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotIkhStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotIkhStatesHoverMarkerOptions]
  }
}
