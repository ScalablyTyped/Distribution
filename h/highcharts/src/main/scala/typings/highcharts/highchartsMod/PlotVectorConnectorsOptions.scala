...
trait PlotVectorConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotVectorConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotVectorConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotVectorConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotVectorConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotVectorConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotVectorConnectorsMarkerOptions = null,
    startMarker: PlotVectorConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotVectorConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotVectorConnectorsOptions]
  }
}
