...
trait PlotWmaDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotWmaDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWmaDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotWmaDragDropGuideBoxDefaultOptions]
  }
}
