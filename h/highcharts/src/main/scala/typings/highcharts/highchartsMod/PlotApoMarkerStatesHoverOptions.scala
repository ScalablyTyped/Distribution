...
trait PlotApoMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotApoMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotApoMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotApoMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotApoMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotApoMarkerStatesHoverOptions]
  }
}
