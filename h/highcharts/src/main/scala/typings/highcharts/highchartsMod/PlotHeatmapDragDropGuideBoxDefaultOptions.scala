...
trait PlotHeatmapDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotHeatmapDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotHeatmapDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapDragDropGuideBoxDefaultOptions]
  }
}
