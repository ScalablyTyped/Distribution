...
trait PlotChaikinTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotChaikinTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotChaikinTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinTooltipDateTimeLabelFormatsOptions]
  }
}
