...
trait PlotWordcloudConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotWordcloudConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotWordcloudConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotWordcloudConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotWordcloudConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotWordcloudConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotWordcloudConnectorsMarkerOptions = null,
    startMarker: PlotWordcloudConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotWordcloudConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotWordcloudConnectorsOptions]
  }
}
