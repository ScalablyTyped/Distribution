...
trait PlotMapOptions extends js.Object {
  ...
  /**
    ...
    */
  var point: js.UndefOr[PlotMapPointOptions] = js.undefined
  /**
...
object PlotMapOptions {
  ...
  def apply(
    ...
    point: PlotMapPointOptions = null,
    ...
    if (!js.isUndefined(nullInteraction)) __obj.updateDynamic("nullInteraction")(nullInteraction)
