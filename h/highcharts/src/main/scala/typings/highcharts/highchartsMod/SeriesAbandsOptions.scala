...
import typings.highcharts.highchartsStrings.abands
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotAbandsOptions because var conflicts: name, zIndex. Inlined accessibility, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, bottomLine, className, clip, color, colorIndex, compareStart, compareToMain, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, includeInDataExport, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, marker, negativeColor, opacity, params, point, pointDescriptionFormatter, selected, shadow, showCheckbox, showInLegend, skipKeyboardNavigation, softThreshold, states, step, stickyTracking, threshold, tooltip, topLine, turboThreshold, visible, zoneAxis, zones */ trait SeriesAbandsOptions
  ...
  /**
    ...
    */
  var accessibility: js.UndefOr[js.Object | PlotAbandsAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAbandsAnimationOptions] = js.undefined
  /**
  ...
  var bottomLine: js.UndefOr[PlotAbandsBottomLineOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotAbandsConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotAbandsDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotAbandsDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotAbandsEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[PlotAbandsLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotAbandsLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotAbandsLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAbandsMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var params: js.UndefOr[PlotAbandsParamsOptions] = js.undefined
  /**
    * (Highstock) Properties for each single point.
    */
  var point: js.UndefOr[PlotAbandsPointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotAbandsStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotAbandsTooltipOptions] = js.undefined
  var topLine: js.UndefOr[PlotAbandsTopLineOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesAbandsOptions: abands
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotAbandsZonesOptions]] = js.undefined
}

object SeriesAbandsOptions {
  @scala.inline
  def apply(
    `type`: abands,
    ...
    dragDrop: PlotAbandsDragDropOptions = null,
    ...
    if (bottomLine != null) __obj.updateDynamic("bottomLine")(bottomLine)
    ...
    if (topLine != null) __obj.updateDynamic("topLine")(topLine)
    ...
    __obj.asInstanceOf[SeriesAbandsOptions]
  }
}
