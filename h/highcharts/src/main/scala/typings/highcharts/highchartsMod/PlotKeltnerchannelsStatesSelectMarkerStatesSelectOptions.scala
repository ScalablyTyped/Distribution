...
trait PlotKeltnerchannelsStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsStatesSelectMarkerStatesSelectOptions]
  }
}
