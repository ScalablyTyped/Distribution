...
import typings.highcharts.highchartsStrings.waterfall
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotWaterfallOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderRadius, borderWidth, className, clip, color, colorAxis, colorByPoint, colorIndex, colors, compare, compareBase, compareStart, connectors, crisp, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, depth, description, dragDrop, edgeColor, edgeWidth, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, getExtremesFromAll, grouping, groupPadding, groupZPadding, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, lineColor, lineWidth, linkedTo, maxPointWidth, minPointLength, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointPadding, pointPlacement, pointRange, pointStart, pointWidth, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, states, stickyTracking, threshold, tooltip, turboThreshold, upColor, visible, zoneAxis, zones */ trait SeriesWaterfallOptions
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesWaterfallOptions: waterfall
  /**
