...
trait PlotStochasticConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotStochasticConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotStochasticConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotStochasticConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotStochasticConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotStochasticConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotStochasticConnectorsMarkerOptions = null,
    startMarker: PlotStochasticConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotStochasticConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticConnectorsOptions]
  }
}
