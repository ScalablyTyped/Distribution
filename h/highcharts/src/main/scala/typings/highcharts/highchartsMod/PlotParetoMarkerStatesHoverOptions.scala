...
trait PlotParetoMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotParetoMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotParetoMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotParetoMarkerStatesHoverAnimationOptions = null,
