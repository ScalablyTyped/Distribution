...
trait PlotAreasplineDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotAreasplineDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplineDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineDragDropGuideBoxDefaultOptions]
  }
}
