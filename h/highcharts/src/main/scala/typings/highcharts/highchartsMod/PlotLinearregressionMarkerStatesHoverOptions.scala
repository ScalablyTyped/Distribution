...
trait PlotLinearregressionMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressionMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressionMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressionMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressionMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionMarkerStatesHoverOptions]
  }
}
