...
trait SeriesWindbarbDataMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[SeriesWindbarbDataMarkerStatesOptions] = js.undefined
  /**
...
object SeriesWindbarbDataMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: SeriesWindbarbDataMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): SeriesWindbarbDataMarkerOptions = {
    ...
    __obj.asInstanceOf[SeriesWindbarbDataMarkerOptions]
  }
}
