...
trait PlotLinearregressionStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressionStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressionStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressionStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressionStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionStatesSelectMarkerStatesHoverOptions]
  }
}
