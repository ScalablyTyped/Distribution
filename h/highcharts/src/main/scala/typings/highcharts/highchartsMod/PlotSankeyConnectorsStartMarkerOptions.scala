...
trait PlotSankeyConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotSankeyConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSankeyConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSankeyConnectorsStartMarkerOptions]
  }
}
