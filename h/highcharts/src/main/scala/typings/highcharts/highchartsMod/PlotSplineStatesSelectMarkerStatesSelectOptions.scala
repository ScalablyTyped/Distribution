...
trait PlotSplineStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotSplineStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSplineStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotSplineStatesSelectMarkerStatesSelectOptions]
  }
}
