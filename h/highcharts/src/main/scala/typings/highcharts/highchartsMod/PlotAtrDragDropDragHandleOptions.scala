...
trait PlotAtrDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotAtrDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAtrDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotAtrDragDropDragHandleOptions]
  }
}
