...
trait PlotWilliamsrStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotWilliamsrStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotWilliamsrStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotWilliamsrStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotWilliamsrStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrStatesHoverMarkerOptions]
  }
}
