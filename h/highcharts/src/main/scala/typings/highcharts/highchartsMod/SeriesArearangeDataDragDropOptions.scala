...
trait SeriesArearangeDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesArearangeDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesArearangeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesArearangeDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesArearangeDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesArearangeDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesArearangeDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesArearangeDataDragDropOptions]
  }
}
