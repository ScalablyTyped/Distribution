...
trait PlotEmaMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotEmaMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotEmaMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotEmaMarkerStatesHoverAnimationOptions = null,
