...
trait PlotMfiConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotMfiConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotMfiConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotMfiConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotMfiConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotMfiConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotMfiConnectorsMarkerOptions = null,
    startMarker: PlotMfiConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotMfiConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotMfiConnectorsOptions]
  }
}
