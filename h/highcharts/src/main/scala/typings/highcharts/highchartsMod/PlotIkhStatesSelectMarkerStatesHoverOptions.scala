...
trait PlotIkhStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotIkhStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotIkhStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotIkhStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotIkhStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotIkhStatesSelectMarkerStatesHoverOptions]
  }
}
