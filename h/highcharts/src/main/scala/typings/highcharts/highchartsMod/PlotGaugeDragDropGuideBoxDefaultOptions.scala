...
trait PlotGaugeDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotGaugeDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotGaugeDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotGaugeDragDropGuideBoxDefaultOptions]
  }
}
