...
trait PlotAdStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAdStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotAdStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAdStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAdStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAdStatesHoverMarkerOptions]
  }
}
