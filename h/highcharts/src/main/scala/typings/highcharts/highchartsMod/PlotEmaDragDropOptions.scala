...
trait PlotEmaDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotEmaDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotEmaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotEmaDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotEmaDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotEmaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotEmaDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotEmaDragDropOptions]
  }
}
