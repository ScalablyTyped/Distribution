...
trait PlotMapbubbleMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMapbubbleMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMapbubbleMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMapbubbleMarkerStatesHoverAnimationOptions = null,
