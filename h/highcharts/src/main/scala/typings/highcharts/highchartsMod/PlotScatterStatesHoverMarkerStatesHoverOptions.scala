...
trait PlotScatterStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotScatterStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotScatterStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotScatterStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotScatterStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotScatterStatesHoverMarkerStatesHoverOptions]
  }
}
