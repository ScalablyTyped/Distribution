...
trait PlotItemMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotItemMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotItemMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotItemMarkerStatesHoverAnimationOptions = null,
