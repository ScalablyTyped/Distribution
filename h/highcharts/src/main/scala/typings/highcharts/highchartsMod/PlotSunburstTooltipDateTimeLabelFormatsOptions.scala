...
trait PlotSunburstTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotSunburstTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotSunburstTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotSunburstTooltipDateTimeLabelFormatsOptions]
  }
}
