...
trait PlotDemaMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotDemaMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotDemaMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotDemaMarkerStatesHoverAnimationOptions = null,
