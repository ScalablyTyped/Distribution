...
trait PlotAreasplinerangeStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAreasplinerangeStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotAreasplinerangeStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAreasplinerangeStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAreasplinerangeStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeStatesSelectMarkerOptions]
  }
}
