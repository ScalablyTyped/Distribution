...
trait PlotIkhDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotIkhDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotIkhDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotIkhDragDropDragHandleOptions]
  }
}
