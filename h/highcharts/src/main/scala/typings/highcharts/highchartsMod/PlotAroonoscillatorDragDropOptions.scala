...
trait PlotAroonoscillatorDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotAroonoscillatorDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotAroonoscillatorDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotAroonoscillatorDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotAroonoscillatorDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotAroonoscillatorDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotAroonoscillatorDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorDragDropOptions]
  }
}
