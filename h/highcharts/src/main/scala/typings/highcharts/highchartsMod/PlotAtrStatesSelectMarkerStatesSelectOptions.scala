...
trait PlotAtrStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAtrStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAtrStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAtrStatesSelectMarkerStatesSelectOptions]
  }
}
