...
trait PlotKeltnerchannelsStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotKeltnerchannelsStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotKeltnerchannelsStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotKeltnerchannelsStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotKeltnerchannelsStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsStatesSelectMarkerStatesHoverOptions]
  }
}
