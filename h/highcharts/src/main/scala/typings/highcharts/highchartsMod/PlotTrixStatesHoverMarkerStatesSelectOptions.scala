...
trait PlotTrixStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTrixStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTrixStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTrixStatesHoverMarkerStatesSelectOptions]
  }
}
