...
trait PlotKeltnerchannelsMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsMarkerStatesSelectOptions]
  }
}
