...
trait PlotMacdTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotMacdTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotMacdTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotMacdTooltipDateTimeLabelFormatsOptions]
  }
}
