...
trait PlotApoDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotApoDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotApoDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotApoDragDropGuideBoxDefaultOptions]
  }
}
