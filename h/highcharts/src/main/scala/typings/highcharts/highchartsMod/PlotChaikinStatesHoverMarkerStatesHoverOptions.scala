...
trait PlotChaikinStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotChaikinStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotChaikinStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotChaikinStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotChaikinStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinStatesHoverMarkerStatesHoverOptions]
  }
}
