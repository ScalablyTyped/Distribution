...
trait PlotMacdStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMacdStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMacdStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMacdStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMacdStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMacdStatesSelectMarkerStatesHoverOptions]
  }
}
