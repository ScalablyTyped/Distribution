...
trait PlotAoDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotAoDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAoDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotAoDragDropGuideBoxDefaultOptions]
  }
}
