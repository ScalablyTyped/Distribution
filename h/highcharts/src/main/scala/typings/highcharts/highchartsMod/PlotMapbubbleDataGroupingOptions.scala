...
trait PlotMapbubbleDataGroupingOptions extends js.Object {
  /**
...
object PlotMapbubbleDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapbubbleDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleDataGroupingOptions]
  }
}
