...
- typings.highcharts.highchartsMod.PlotErrorbarOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, className, clip, color, colorAxis, colorByPoint, colorIndex, colors, compare, compareBase, compareStart, connectors, crisp, cropThreshold, cursor, dataGrouping, dataLabels, depth, description, dragDrop, edgeColor, edgeWidth, enableMouseTracking, events, exposeElementToA11y, fillColor, findNearestPointBy, getExtremesFromAll, grouping, groupPadding, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, lineWidth, linkedTo, maxPointWidth, medianColor, medianWidth, minPointLength, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointPadding, pointPlacement, pointRange, pointStart, pointWidth, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, stemDashStyle, stemWidth, stickyTracking, threshold, tooltip, turboThreshold, visible, whiskerColor, whiskerLength, whiskerWidth, zoneAxis, zones */ trait SeriesErrorbarOptions
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesErrorbarOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesErrorbarOptions: errorbar
  /**
