...
trait PlotTimelineStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTimelineStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotTimelineStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotTimelineStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotTimelineStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineStatesHoverMarkerOptions]
  }
}
