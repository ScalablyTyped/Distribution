...
trait PlotVectorStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotVectorStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVectorStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotVectorStatesHoverMarkerStatesSelectOptions]
  }
}
