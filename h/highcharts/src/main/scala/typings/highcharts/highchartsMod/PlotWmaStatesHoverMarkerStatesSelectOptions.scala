...
trait PlotWmaStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotWmaStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWmaStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotWmaStatesHoverMarkerStatesSelectOptions]
  }
}
