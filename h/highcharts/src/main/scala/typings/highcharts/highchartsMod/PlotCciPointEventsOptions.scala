...
trait PlotCciPointEventsOptions extends js.Object {
  /**
...
object PlotCciPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotCciPointEventsOptions]
  }
}
