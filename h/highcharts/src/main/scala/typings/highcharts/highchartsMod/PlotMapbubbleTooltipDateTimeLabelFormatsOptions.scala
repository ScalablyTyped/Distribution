...
trait PlotMapbubbleTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotMapbubbleTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotMapbubbleTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotMapbubbleTooltipDateTimeLabelFormatsOptions]
  }
}
