...
trait PlotLinearregressionslopeConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeConnectorsStartMarkerOptions]
  }
}
