...
trait PlotRsiStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotRsiStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotRsiStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotRsiStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotRsiStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotRsiStatesHoverMarkerOptions]
  }
}
