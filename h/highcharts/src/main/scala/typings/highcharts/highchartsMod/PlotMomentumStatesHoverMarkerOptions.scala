...
trait PlotMomentumStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMomentumStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotMomentumStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMomentumStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMomentumStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumStatesHoverMarkerOptions]
  }
}
