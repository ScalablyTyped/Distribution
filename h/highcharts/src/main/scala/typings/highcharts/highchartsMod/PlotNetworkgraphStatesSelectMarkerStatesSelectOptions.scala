...
trait PlotNetworkgraphStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotNetworkgraphStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNetworkgraphStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphStatesSelectMarkerStatesSelectOptions]
  }
}
