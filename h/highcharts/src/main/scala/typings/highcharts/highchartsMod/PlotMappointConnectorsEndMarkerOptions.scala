...
trait PlotMappointConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotMappointConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMappointConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMappointConnectorsEndMarkerOptions]
  }
}
