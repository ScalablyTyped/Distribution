...
trait PlotTreemapDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotTreemapDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotTreemapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotTreemapDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotTreemapDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotTreemapDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotTreemapDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapDragDropOptions]
  }
}
