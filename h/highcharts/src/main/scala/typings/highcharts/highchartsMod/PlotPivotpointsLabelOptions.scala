...
trait PlotPivotpointsLabelOptions extends js.Object {
  /**
...
object PlotPivotpointsLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotPivotpointsLabelOptions]
  }
}
