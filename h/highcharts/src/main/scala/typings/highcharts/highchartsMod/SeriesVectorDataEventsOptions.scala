...
trait SeriesVectorDataEventsOptions extends js.Object {
  /**
...
object SeriesVectorDataEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[SeriesVectorDataEventsOptions]
  }
}
