...
trait PlotPpoDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotPpoDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPpoDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotPpoDragDropGuideBoxDefaultOptions]
  }
}
