...
trait PlotAroonStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAroonStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAroonStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAroonStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAroonStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAroonStatesSelectMarkerStatesHoverOptions]
  }
}
