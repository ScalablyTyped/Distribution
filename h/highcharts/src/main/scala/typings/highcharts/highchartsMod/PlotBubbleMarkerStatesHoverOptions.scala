...
trait PlotBubbleMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotBubbleMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotBubbleMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotBubbleMarkerStatesHoverAnimationOptions = null,
