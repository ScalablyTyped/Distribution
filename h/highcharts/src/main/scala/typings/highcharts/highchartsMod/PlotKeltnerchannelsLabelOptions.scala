...
trait PlotKeltnerchannelsLabelOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsLabelOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsLabelOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsLabelOptions]
  }
}
