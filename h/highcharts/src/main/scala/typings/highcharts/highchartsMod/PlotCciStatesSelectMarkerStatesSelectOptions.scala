...
trait PlotCciStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotCciStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCciStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotCciStatesSelectMarkerStatesSelectOptions]
  }
}
