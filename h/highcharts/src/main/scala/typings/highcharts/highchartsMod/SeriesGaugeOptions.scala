...
- typings.highcharts.highchartsMod.PlotGaugeOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, boostBlending, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, compare, compareBase, compareStart, connectors, cursor, dataGrouping, dataLabels, description, dial, dragDrop, enableMouseTracking, events, exposeElementToA11y, gapSize, gapUnit, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, navigatorOptions, opacity, overshoot, pivot, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointRange, pointStart, selected, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, stickyTracking, tooltip, useOhlcData, visible, wrap */ trait SeriesGaugeOptions
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesGaugeOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesGaugeOptions: gauge
  /**
