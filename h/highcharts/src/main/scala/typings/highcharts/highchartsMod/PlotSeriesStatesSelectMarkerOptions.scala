...
trait PlotSeriesStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSeriesStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotSeriesStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotSeriesStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotSeriesStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesStatesSelectMarkerOptions]
  }
}
