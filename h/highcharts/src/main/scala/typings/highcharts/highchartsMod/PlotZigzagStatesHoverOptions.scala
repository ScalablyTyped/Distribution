...
trait PlotZigzagStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotZigzagStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotZigzagStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotZigzagStatesHoverMarkerOptions] = js.undefined
}

object PlotZigzagStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotZigzagStatesHoverAnimationOptions = null,
    ...
    marker: PlotZigzagStatesHoverMarkerOptions = null
    ...
    __obj.asInstanceOf[PlotZigzagStatesHoverOptions]
  }
}
