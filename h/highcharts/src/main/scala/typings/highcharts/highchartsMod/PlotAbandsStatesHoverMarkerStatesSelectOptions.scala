...
trait PlotAbandsStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAbandsStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAbandsStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAbandsStatesHoverMarkerStatesSelectOptions]
  }
}
