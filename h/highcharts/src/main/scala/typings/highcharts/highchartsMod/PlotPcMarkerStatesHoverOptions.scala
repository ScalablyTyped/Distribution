...
trait PlotPcMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPcMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotPcMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPcMarkerStatesHoverAnimationOptions = null,
