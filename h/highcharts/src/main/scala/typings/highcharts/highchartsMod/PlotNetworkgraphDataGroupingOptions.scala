...
trait PlotNetworkgraphDataGroupingOptions extends js.Object {
  /**
...
object PlotNetworkgraphDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotNetworkgraphDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphDataGroupingOptions]
  }
}
