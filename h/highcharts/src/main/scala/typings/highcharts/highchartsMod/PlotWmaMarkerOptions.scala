...
trait PlotWmaMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotWmaMarkerStatesOptions] = js.undefined
  /**
...
object PlotWmaMarkerOptions {
  ...
  def apply(
    ...
    states: PlotWmaMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotWmaMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWmaMarkerOptions]
  }
}
