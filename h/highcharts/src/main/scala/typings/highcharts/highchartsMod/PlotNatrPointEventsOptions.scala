...
trait PlotNatrPointEventsOptions extends js.Object {
  /**
...
object PlotNatrPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotNatrPointEventsOptions]
  }
}
