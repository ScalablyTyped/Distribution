...
trait SeriesWindbarbDataDragDropDragHandleOptions extends js.Object {
  /**
...
object SeriesWindbarbDataDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesWindbarbDataDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[SeriesWindbarbDataDragDropDragHandleOptions]
  }
}
