...
trait PlotTimelineTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotTimelineTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotTimelineTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotTimelineTooltipDateTimeLabelFormatsOptions]
  }
}
