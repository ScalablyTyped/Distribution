...
trait PlotHeatmapStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotHeatmapStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotHeatmapStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotHeatmapStatesHoverMarkerOptions] = js.undefined
}

object PlotHeatmapStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotHeatmapStatesHoverAnimationOptions = null,
    ...
    marker: PlotHeatmapStatesHoverMarkerOptions = null
  ): PlotHeatmapStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapStatesHoverOptions]
  }
}
