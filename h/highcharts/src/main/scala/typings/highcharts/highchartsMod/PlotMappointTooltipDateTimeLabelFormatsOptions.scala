...
trait PlotMappointTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotMappointTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotMappointTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotMappointTooltipDateTimeLabelFormatsOptions]
  }
}
