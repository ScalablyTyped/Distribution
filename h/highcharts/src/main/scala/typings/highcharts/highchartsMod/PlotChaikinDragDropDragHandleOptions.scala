...
trait PlotChaikinDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotChaikinDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotChaikinDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotChaikinDragDropDragHandleOptions]
  }
}
