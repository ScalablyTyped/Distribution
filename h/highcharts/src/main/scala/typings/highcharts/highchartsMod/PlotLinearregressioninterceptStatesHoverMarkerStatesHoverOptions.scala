...
trait PlotLinearregressioninterceptStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressioninterceptStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressioninterceptStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressioninterceptStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressioninterceptStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressioninterceptStatesHoverMarkerStatesHoverOptions]
  }
}
