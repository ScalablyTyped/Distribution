...
trait PlotZigzagStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotZigzagStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotZigzagStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotZigzagStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotZigzagStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotZigzagStatesSelectMarkerOptions]
  }
}
