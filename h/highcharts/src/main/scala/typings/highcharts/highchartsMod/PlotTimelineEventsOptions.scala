...
trait PlotTimelineEventsOptions extends js.Object {
  /**
...
object PlotTimelineEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotTimelineEventsOptions]
  }
}
