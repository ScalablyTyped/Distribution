...
trait PlotPriceenvelopesMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPriceenvelopesMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPriceenvelopesMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPriceenvelopesMarkerStatesHoverAnimationOptions = null,
