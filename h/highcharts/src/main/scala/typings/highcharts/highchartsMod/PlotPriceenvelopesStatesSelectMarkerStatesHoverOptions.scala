...
trait PlotPriceenvelopesStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPriceenvelopesStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPriceenvelopesStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPriceenvelopesStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPriceenvelopesStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesStatesSelectMarkerStatesHoverOptions]
  }
}
