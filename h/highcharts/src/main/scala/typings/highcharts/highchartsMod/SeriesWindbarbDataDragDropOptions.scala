...
trait SeriesWindbarbDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesWindbarbDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesWindbarbDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesWindbarbDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesWindbarbDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesWindbarbDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesWindbarbDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesWindbarbDataDragDropOptions]
  }
}
