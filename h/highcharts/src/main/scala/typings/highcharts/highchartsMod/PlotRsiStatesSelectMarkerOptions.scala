...
trait PlotRsiStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotRsiStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotRsiStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotRsiStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotRsiStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotRsiStatesSelectMarkerOptions]
  }
}
