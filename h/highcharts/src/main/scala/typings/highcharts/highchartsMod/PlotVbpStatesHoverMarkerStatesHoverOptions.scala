...
trait PlotVbpStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotVbpStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotVbpStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVbpStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotVbpStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotVbpStatesHoverMarkerStatesHoverOptions]
  }
}
