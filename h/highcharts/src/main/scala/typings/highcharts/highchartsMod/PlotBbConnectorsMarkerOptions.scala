...
trait PlotBbConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotBbConnectorsMarkerOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotBbConnectorsMarkerOptions]
  }
}
