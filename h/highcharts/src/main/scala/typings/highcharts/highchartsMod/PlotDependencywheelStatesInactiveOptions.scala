...
trait PlotDependencywheelStatesInactiveOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotDependencywheelStatesInactiveAnimationOptions
  ] = js.undefined
  /**
...
object PlotDependencywheelStatesInactiveOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotDependencywheelStatesInactiveAnimationOptions = null,
