...
trait PlotMappointStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMappointStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotMappointStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMappointStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMappointStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMappointStatesHoverMarkerOptions]
  }
}
