...
trait PlotCylinderConnectorsOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var endMarker: js.UndefOr[PlotCylinderConnectorsEndMarkerOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotCylinderConnectorsMarkerOptions] = js.undefined
  /**
    * (Gantt) Marker options specific to the start markers for this chart's
    * Pathfinder connectors. Overrides the generic marker options.
    */
  var startMarker: js.UndefOr[PlotCylinderConnectorsStartMarkerOptions] = js.undefined
  /**
...
object PlotCylinderConnectorsOptions {
  @scala.inline
  def apply(
    dashStyle: String = null,
    endMarker: PlotCylinderConnectorsEndMarkerOptions = null,
    lineColor: ColorString = null,
    lineWidth: Int | Double = null,
    marker: PlotCylinderConnectorsMarkerOptions = null,
    startMarker: PlotCylinderConnectorsStartMarkerOptions = null,
    `type`: PathfinderTypeValue = null
  ): PlotCylinderConnectorsOptions = {
    ...
    __obj.asInstanceOf[PlotCylinderConnectorsOptions]
  }
}
