...
trait PlotAoStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAoStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAoStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAoStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAoStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAoStatesHoverMarkerStatesHoverOptions]
  }
}
