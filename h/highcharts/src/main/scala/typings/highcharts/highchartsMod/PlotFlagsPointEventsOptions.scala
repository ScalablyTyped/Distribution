...
trait PlotFlagsPointEventsOptions extends js.Object {
  /**
...
object PlotFlagsPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotFlagsPointEventsOptions]
  }
}
