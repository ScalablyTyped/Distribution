...
trait PlotPsarStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPsarStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPsarStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPsarStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPsarStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPsarStatesHoverMarkerStatesHoverOptions]
  }
}
