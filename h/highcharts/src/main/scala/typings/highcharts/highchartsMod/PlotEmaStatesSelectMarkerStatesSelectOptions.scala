...
trait PlotEmaStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotEmaStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotEmaStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotEmaStatesSelectMarkerStatesSelectOptions]
  }
}
