...
trait PlotVennStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotVennStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotVennStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVennStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotVennStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotVennStatesSelectMarkerStatesHoverOptions]
  }
}
