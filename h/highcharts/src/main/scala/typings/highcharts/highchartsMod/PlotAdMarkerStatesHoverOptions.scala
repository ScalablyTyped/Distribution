...
trait PlotAdMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAdMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotAdMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAdMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAdMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAdMarkerStatesHoverOptions]
  }
}
