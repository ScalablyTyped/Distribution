...
trait PlotArearangeStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotArearangeStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotArearangeStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotArearangeStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotArearangeStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeStatesSelectMarkerOptions]
  }
}
