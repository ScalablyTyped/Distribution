...
trait PlotCmfStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotCmfStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotCmfStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotCmfStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotCmfStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotCmfStatesSelectMarkerStatesHoverOptions]
  }
}
