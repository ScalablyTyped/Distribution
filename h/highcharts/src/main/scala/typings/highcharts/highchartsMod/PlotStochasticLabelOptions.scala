...
trait PlotStochasticLabelOptions extends js.Object {
  /**
...
object PlotStochasticLabelOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotStochasticLabelOptions]
  }
}
