...
trait PlotKeltnerchannelsStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotKeltnerchannelsStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotKeltnerchannelsStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotKeltnerchannelsStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotKeltnerchannelsStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsStatesHoverMarkerOptions]
  }
}
