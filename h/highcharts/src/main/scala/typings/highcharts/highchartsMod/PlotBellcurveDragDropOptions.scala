...
trait PlotBellcurveDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotBellcurveDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotBellcurveDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotBellcurveDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotBellcurveDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotBellcurveDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotBellcurveDragDropOptions]
  }
}
