...
trait PlotStochasticStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotStochasticStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotStochasticStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotStochasticStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotStochasticStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticStatesSelectMarkerOptions]
  }
}
