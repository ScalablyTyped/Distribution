...
trait PlotAtrStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAtrStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAtrStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAtrStatesHoverMarkerStatesSelectOptions]
  }
}
