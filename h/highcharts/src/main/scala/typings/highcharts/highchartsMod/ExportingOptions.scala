...
object ExportingOptions {
  ...
  def apply(
    ...
    if (menuItemDefinitions != null) __obj.updateDynamic("menuItemDefinitions")(menuItemDefinitions)
    if (printMaxWidth != null) __obj.updateDynamic("printMaxWidth")(printMaxWidth.asInstanceOf[js.Any])
    if (scale != null) __obj.updateDynamic("scale")(scale.asInstanceOf[js.Any])
    if (!js.isUndefined(showTable)) __obj.updateDynamic("showTable")(showTable)
    ...
    if (!js.isUndefined(useMultiLevelHeaders)) __obj.updateDynamic("useMultiLevelHeaders")(useMultiLevelHeaders)
    if (!js.isUndefined(useRowspanHeaders)) __obj.updateDynamic("useRowspanHeaders")(useRowspanHeaders)
