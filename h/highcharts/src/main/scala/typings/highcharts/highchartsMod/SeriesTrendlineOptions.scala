...
- typings.highcharts.highchartsMod.SeriesOptions because var conflicts: name, zIndex. Inlined id, index, legendIndex, mapData, stack, `type`, xAxis, yAxis */ trait SeriesTrendlineOptions
...
object SeriesTrendlineOptions {
  ...
  def apply(
    ...
    dragDrop: PlotTrendlineDragDropOptions = null,
