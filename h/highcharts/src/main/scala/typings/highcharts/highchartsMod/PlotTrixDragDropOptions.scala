...
trait PlotTrixDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotTrixDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotTrixDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotTrixDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotTrixDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotTrixDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotTrixDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotTrixDragDropOptions]
  }
}
