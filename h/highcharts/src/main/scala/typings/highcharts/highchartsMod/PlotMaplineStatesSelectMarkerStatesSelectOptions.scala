...
trait PlotMaplineStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMaplineStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMaplineStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMaplineStatesSelectMarkerStatesSelectOptions]
  }
}
