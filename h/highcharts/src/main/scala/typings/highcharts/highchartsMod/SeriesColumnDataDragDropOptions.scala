...
trait SeriesColumnDataDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesColumnDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesColumnDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesColumnDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesColumnDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesColumnDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesColumnDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesColumnDataDragDropOptions]
  }
}
