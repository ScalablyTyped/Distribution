...
trait PlotBbDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotBbDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotBbDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotBbDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotBbDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotBbDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotBbDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotBbDragDropOptions]
  }
}
