...
trait PlotPpoStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPpoStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPpoStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPpoStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPpoStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPpoStatesSelectMarkerStatesHoverOptions]
  }
}
