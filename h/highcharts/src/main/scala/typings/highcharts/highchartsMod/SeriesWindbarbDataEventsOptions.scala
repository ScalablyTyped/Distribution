...
trait SeriesWindbarbDataEventsOptions extends js.Object {
  /**
...
object SeriesWindbarbDataEventsOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesWindbarbDataEventsOptions = {
    ...
    __obj.asInstanceOf[SeriesWindbarbDataEventsOptions]
  }
}
