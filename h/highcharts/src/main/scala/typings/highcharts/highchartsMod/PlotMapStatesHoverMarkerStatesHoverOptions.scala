...
trait PlotMapStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMapStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMapStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMapStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMapStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMapStatesHoverMarkerStatesHoverOptions]
  }
}
