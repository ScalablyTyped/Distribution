...
trait PlotXrangeDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock, Gantt) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotXrangeDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotXrangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotXrangeDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotXrangeDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotXrangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotXrangeDragDropOptions]
  }
}
