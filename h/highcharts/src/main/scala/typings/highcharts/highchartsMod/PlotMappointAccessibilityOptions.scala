...
trait PlotMappointAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotMappointAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotMappointAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotMappointAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotMappointAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotMappointAccessibilityOptions]
  }
}
