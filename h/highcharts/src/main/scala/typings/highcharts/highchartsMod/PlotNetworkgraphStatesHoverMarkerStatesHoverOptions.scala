...
trait PlotNetworkgraphStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotNetworkgraphStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotNetworkgraphStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotNetworkgraphStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotNetworkgraphStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphStatesHoverMarkerStatesHoverOptions]
  }
}
