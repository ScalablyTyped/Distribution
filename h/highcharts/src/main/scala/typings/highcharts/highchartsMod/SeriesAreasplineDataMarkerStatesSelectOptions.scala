...
trait SeriesAreasplineDataMarkerStatesSelectOptions extends js.Object {
  /**
...
object SeriesAreasplineDataMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesAreasplineDataMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[SeriesAreasplineDataMarkerStatesSelectOptions]
  }
}
