...
trait PlotAreaStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAreaStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotAreaStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAreaStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAreaStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAreaStatesSelectMarkerOptions]
  }
}
