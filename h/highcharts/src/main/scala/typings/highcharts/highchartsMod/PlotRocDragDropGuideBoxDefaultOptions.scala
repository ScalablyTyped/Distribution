...
trait PlotRocDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotRocDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotRocDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotRocDragDropGuideBoxDefaultOptions]
  }
}
