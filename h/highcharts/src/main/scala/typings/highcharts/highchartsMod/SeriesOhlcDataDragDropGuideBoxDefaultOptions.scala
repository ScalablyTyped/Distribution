...
trait SeriesOhlcDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesOhlcDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesOhlcDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesOhlcDataDragDropGuideBoxDefaultOptions]
  }
}
