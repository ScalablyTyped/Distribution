...
trait PlotTemaDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotTemaDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTemaDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotTemaDragDropDragHandleOptions]
  }
}
