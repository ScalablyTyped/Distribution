...
trait PlotEmaStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotEmaStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotEmaStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotEmaStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotEmaStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotEmaStatesSelectMarkerStatesHoverOptions]
  }
}
