...
trait PlotAreasplineStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotAreasplineStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotAreasplineStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAreasplineStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAreasplineStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineStatesSelectMarkerStatesHoverOptions]
  }
}
