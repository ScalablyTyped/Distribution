...
trait PlotWmaStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotWmaStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotWmaStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotWmaStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotWmaStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotWmaStatesHoverMarkerStatesHoverOptions]
  }
}
