...
trait PlotArearangeStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotArearangeStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotArearangeStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotArearangeStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotArearangeStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotArearangeStatesSelectMarkerStatesHoverOptions]
  }
}
