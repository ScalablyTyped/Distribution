...
trait PlotSmaStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotSmaStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotSmaStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSmaStatesSelectMarkerStatesHoverAnimationOptions = null,
    ...
    __obj.asInstanceOf[PlotSmaStatesSelectMarkerStatesHoverOptions]
  }
}
