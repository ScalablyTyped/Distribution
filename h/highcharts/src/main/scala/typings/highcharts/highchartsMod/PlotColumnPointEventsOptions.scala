...
trait PlotColumnPointEventsOptions extends js.Object {
  /**
...
object PlotColumnPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotColumnPointEventsOptions]
  }
}
