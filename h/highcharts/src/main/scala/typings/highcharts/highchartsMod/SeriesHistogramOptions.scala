...
import typings.highcharts.highchartsStrings.histogram
...
- typings.highcharts.highchartsMod.PlotHistogramOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, binsNumber, binWidth, boostBlending, borderColor, borderRadius, borderWidth, className, clip, color, colorAxis, colorByPoint, colorIndex, colors, compare, compareBase, compareStart, connectors, crisp, cropThreshold, cursor, dataGrouping, dataLabels, depth, description, dragDrop, edgeColor, edgeWidth, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, getExtremesFromAll, grouping, groupPadding, groupZPadding, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, linkedTo, maxPointWidth, minPointLength, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointPadding, pointPlacement, pointRange, pointStart, pointWidth, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, states, stickyTracking, threshold, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesHistogramOptions
  ...
  /**
    ...
    */
  var accessibility: js.UndefOr[js.Object | PlotHistogramAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotHistogramAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var binsNumber: js.UndefOr[rice | `square-root` | sturges | Double | js.Function] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotHistogramConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotHistogramDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotHistogramDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var lastPrice: js.UndefOr[PlotHistogramLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotHistogramLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var point: js.UndefOr[PlotHistogramPointOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var pointPlacement: js.UndefOr[String] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotHistogramStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotHistogramTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesHistogramOptions: histogram
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotHistogramZonesOptions]] = js.undefined
}
...
object SeriesHistogramOptions {
  ...
  def apply(
    ...
    if (pointPlacement != null) __obj.updateDynamic("pointPlacement")(pointPlacement)
