...
trait PlotHeatmapStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotHeatmapStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotHeatmapStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotHeatmapStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotHeatmapStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapStatesSelectMarkerOptions]
  }
}
