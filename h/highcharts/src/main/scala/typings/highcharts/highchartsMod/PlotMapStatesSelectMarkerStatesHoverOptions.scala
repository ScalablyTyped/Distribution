...
trait PlotMapStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMapStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMapStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMapStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMapStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMapStatesSelectMarkerStatesHoverOptions]
  }
}
