...
trait PlotWordcloudConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotWordcloudConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWordcloudConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotWordcloudConnectorsStartMarkerOptions]
  }
}
