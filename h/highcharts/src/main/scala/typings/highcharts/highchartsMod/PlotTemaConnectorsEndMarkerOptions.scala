...
trait PlotTemaConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotTemaConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTemaConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTemaConnectorsEndMarkerOptions]
  }
}
