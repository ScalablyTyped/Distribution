...
trait PlotLinearregressionangleStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressionangleStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressionangleStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressionangleStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotLinearregressionangleStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionangleStatesSelectMarkerStatesHoverOptions]
  }
}
