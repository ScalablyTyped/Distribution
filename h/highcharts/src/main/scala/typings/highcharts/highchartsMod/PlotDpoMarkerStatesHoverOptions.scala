...
trait PlotDpoMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotDpoMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotDpoMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotDpoMarkerStatesHoverAnimationOptions = null,
