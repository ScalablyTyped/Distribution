...
trait PlotStreamgraphStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotStreamgraphStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStreamgraphStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphStatesSelectMarkerStatesSelectOptions]
  }
}
