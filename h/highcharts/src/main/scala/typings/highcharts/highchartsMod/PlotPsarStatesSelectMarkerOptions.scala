...
trait PlotPsarStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPsarStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotPsarStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPsarStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPsarStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPsarStatesSelectMarkerOptions]
  }
}
