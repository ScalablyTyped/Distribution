...
trait InstrumentOptionsObject extends js.Object {
  ...
  /**
    ...
    */
  var oscillator: js.UndefOr[typings.highcharts.modulesSonificationMod.highchartsMod.OscillatorOptionsObject] = js.undefined
  /**
...
object InstrumentOptionsObject {
  ...
  def apply(
    ...
    id: String = null,
    oscillator: typings.highcharts.modulesSonificationMod.highchartsMod.OscillatorOptionsObject = null,
