...
trait PlotTemaDataGroupingOptions extends js.Object {
  /**
...
object PlotTemaDataGroupingOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotTemaDataGroupingOptions]
  }
}
