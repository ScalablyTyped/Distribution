...
trait SeriesColumnrangeDataOptions extends js.Object {
  var accessibility: js.UndefOr[SeriesColumnrangeDataAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[SeriesColumnrangeDataDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[SeriesColumnrangeDataEventsOptions] = js.undefined
  /**
...
object SeriesColumnrangeDataOptions {
  @scala.inline
  def apply(
    accessibility: SeriesColumnrangeDataAccessibilityOptions = null,
    ...
    dragDrop: SeriesColumnrangeDataDragDropOptions = null,
    drilldown: String = null,
    events: SeriesColumnrangeDataEventsOptions = null,
    ...
    __obj.asInstanceOf[SeriesColumnrangeDataOptions]
  }
}
