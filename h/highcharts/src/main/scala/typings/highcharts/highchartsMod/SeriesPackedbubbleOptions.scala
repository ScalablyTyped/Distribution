...
import typings.highcharts.highchartsStrings.packedbubble
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotPackedbubbleOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, compare, compareBase, compareStart, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, displayNegative, dragDrop, draggable, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, includeInDataExport, joinBy, label, lastPrice, lastVisiblePrice, layoutAlgorithm, linecap, lineWidth, linkedTo, marker, maxSize, minSize, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointRange, pointStart, selected, showCheckbox, showInLegend, showInNavigator, sizeBy, skipKeyboardNavigation, softThreshold, stacking, states, stickyTracking, threshold, tooltip, turboThreshold, useSimulation, visible, zoneAxis, zones, zThreshold */ trait SeriesPackedbubbleOptions
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotPackedbubbleDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesPackedbubbleOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesPackedbubbleOptions: packedbubble
  /**
...
object SeriesPackedbubbleOptions {
  ...
  def apply(
    ...
    dragDrop: PlotPackedbubbleDragDropOptions = null,
