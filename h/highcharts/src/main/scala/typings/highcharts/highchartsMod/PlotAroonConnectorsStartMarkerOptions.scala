...
trait PlotAroonConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotAroonConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonConnectorsStartMarkerOptions]
  }
}
