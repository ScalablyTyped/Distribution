...
trait PlotCmfStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotCmfStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCmfStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotCmfStatesSelectMarkerStatesSelectOptions]
  }
}
