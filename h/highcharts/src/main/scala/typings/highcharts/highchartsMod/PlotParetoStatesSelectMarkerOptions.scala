...
trait PlotParetoStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotParetoStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotParetoStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotParetoStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotParetoStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotParetoStatesSelectMarkerOptions]
  }
}
