...
import typings.highcharts.highchartsStrings.bellcurve
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typings.highcharts.highchartsMod.PlotBellcurveOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, compare, compareBase, compareStart, connectEnds, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, fillColor, fillOpacity, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, includeInDataExport, intervals, joinBy, keys, label, lastPrice, lastVisiblePrice, linecap, lineColor, lineWidth, linkedTo, marker, navigatorOptions, negativeColor, negativeFillColor, opacity, point, pointDescriptionFormatter, pointPlacement, pointRange, pointsInInterval, pointStart, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, states, stickyTracking, threshold, tooltip, trackByArea, turboThreshold, visible, zoneAxis, zones */ trait SeriesBellcurveOptions
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotBellcurveDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesBellcurveOptions: bellcurve
  /**
