...
trait PlotCciDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotCciDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCciDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotCciDragDropDragHandleOptions]
  }
}
