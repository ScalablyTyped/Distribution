...
trait PlotNatrStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotNatrStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotNatrStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotNatrStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotNatrStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotNatrStatesSelectMarkerOptions]
  }
}
