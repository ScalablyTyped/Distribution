...
trait PlotApoDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotApoDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotApoDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotApoDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotApoDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotApoDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotApoDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotApoDragDropOptions]
  }
}
