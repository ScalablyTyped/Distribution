...
trait PlotMfiStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotMfiStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotMfiStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMfiStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotMfiStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotMfiStatesSelectMarkerStatesHoverOptions]
  }
}
