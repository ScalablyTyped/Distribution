...
trait PlotTreemapStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTreemapStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTreemapStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTreemapStatesSelectMarkerStatesSelectOptions]
  }
}
