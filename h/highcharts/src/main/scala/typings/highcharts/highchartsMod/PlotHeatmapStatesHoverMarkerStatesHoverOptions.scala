...
trait PlotHeatmapStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotHeatmapStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotHeatmapStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotHeatmapStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotHeatmapStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapStatesHoverMarkerStatesHoverOptions]
  }
}
