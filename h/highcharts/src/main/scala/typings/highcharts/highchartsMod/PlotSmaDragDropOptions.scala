...
trait PlotSmaDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotSmaDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotSmaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotSmaDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotSmaDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotSmaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotSmaDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotSmaDragDropOptions]
  }
}
