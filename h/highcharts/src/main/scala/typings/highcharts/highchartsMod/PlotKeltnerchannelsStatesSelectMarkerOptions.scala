...
trait PlotKeltnerchannelsStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotKeltnerchannelsStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotKeltnerchannelsStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotKeltnerchannelsStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotKeltnerchannelsStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsStatesSelectMarkerOptions]
  }
}
