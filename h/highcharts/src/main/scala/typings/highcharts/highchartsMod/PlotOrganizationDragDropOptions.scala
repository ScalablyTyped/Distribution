...
trait PlotOrganizationDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotOrganizationDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotOrganizationDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotOrganizationDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotOrganizationDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotOrganizationDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotOrganizationDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotOrganizationDragDropOptions]
  }
}
