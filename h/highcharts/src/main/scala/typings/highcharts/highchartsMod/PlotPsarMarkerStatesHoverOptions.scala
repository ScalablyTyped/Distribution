...
trait PlotPsarMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPsarMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotPsarMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPsarMarkerStatesHoverAnimationOptions = null,
