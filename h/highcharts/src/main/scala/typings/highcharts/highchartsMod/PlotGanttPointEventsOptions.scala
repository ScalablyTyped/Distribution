...
trait PlotGanttPointEventsOptions extends js.Object {
  /**
...
object PlotGanttPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotGanttPointEventsOptions]
  }
}
