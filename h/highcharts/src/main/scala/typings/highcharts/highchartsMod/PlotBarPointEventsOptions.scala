...
trait PlotBarPointEventsOptions extends js.Object {
  /**
...
object PlotBarPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotBarPointEventsOptions]
  }
}
