...
trait PlotPriceenvelopesStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPriceenvelopesStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPriceenvelopesStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPriceenvelopesStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotPriceenvelopesStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPriceenvelopesStatesHoverMarkerStatesHoverOptions]
  }
}
