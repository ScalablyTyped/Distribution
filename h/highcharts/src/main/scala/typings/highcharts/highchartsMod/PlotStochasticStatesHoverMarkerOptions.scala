...
trait PlotStochasticStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotStochasticStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotStochasticStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotStochasticStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotStochasticStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticStatesHoverMarkerOptions]
  }
}
