...
trait PlotColumnpyramidDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotColumnpyramidDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotColumnpyramidDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotColumnpyramidDragDropDragHandleOptions]
  }
}
