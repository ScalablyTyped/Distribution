...
trait PlotStreamgraphConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotStreamgraphConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStreamgraphConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphConnectorsMarkerOptions]
  }
}
