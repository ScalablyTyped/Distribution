...
trait PlotLinearregressionslopeDataGroupingOptions extends js.Object {
  /**
...
object PlotLinearregressionslopeDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionslopeDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeDataGroupingOptions]
  }
}
