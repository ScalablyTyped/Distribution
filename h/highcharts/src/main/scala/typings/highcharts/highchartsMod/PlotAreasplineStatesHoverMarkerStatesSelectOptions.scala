...
trait PlotAreasplineStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAreasplineStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAreasplineStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplineStatesHoverMarkerStatesSelectOptions]
  }
}
