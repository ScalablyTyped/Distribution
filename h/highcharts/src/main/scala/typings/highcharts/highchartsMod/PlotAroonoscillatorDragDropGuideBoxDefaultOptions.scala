...
trait PlotAroonoscillatorDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotAroonoscillatorDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAroonoscillatorDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorDragDropGuideBoxDefaultOptions]
  }
}
