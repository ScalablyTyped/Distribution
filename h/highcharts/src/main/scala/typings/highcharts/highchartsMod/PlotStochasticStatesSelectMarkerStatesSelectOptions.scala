...
trait PlotStochasticStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotStochasticStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStochasticStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticStatesSelectMarkerStatesSelectOptions]
  }
}
