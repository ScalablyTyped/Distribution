...
trait PlotBubbleAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotBubbleAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotBubbleAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotBubbleAccessibilityKeyboardNavigationOptions = null,
    ...
    __obj.asInstanceOf[PlotBubbleAccessibilityOptions]
  }
}
