...
trait PlotBarDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotBarDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotBarDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotBarDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotBarDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotBarDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    ...
    __obj.asInstanceOf[PlotBarDragDropOptions]
  }
}
