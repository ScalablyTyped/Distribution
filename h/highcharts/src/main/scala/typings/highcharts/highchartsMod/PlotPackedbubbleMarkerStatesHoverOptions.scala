...
trait PlotPackedbubbleMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotPackedbubbleMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotPackedbubbleMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPackedbubbleMarkerStatesHoverAnimationOptions = null,
