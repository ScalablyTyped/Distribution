...
trait PlotHeatmapConnectorsEndMarkerOptions extends js.Object {
  /**
...
object PlotHeatmapConnectorsEndMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotHeatmapConnectorsEndMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapConnectorsEndMarkerOptions]
  }
}
