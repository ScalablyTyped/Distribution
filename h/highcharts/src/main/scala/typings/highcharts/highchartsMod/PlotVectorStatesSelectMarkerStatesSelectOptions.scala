...
trait PlotVectorStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotVectorStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVectorStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotVectorStatesSelectMarkerStatesSelectOptions]
  }
}
