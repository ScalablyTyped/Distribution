...
trait Instrument extends js.Object {
  /**
    ...
    */
  def copy(): typings.highcharts.modulesSonificationMod.highchartsMod.Instrument = js.native
  def copy(options: typings.highcharts.modulesSonificationMod.highchartsMod.InstrumentOptionsObject): typings.highcharts.modulesSonificationMod.highchartsMod.Instrument = js.native
  /**
  ...
  /**
    ...
    */
  def play(options: typings.highcharts.modulesSonificationMod.highchartsMod.InstrumentPlayOptionsObject): Unit = js.native
  /**
