...
trait PlotAoDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotAoDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAoDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotAoDragDropDragHandleOptions]
  }
}
