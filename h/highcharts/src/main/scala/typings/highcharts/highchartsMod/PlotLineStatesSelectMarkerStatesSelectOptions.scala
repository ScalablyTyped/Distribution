...
trait PlotLineStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLineStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLineStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLineStatesSelectMarkerStatesSelectOptions]
  }
}
