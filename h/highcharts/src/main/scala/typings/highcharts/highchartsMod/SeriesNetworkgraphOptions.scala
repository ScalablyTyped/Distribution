...
- typings.highcharts.highchartsMod.PlotNetworkgraphOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, boostBlending, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, compare, compareBase, compareStart, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, draggable, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, gapSize, gapUnit, includeInDataExport, joinBy, keys, lastPrice, lastVisiblePrice, layoutAlgorithm, lineWidth, link, linkedTo, marker, navigatorOptions, opacity, point, pointDescriptionFormatter, pointRange, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, states, stickyTracking, tooltip, turboThreshold, useOhlcData, visible, zones */ trait SeriesNetworkgraphOptions
  ...
  /**
    ...
    */
  @JSName("stack")
  var stack_SeriesNetworkgraphOptions: js.UndefOr[scala.Nothing] = js.undefined
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesNetworkgraphOptions: networkgraph
  /**
  ...
  /**
    ...
    */
  @JSName("xAxis")
  var xAxis_SeriesNetworkgraphOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
    * Not available
    */
  @JSName("yAxis")
  var yAxis_SeriesNetworkgraphOptions: js.UndefOr[scala.Nothing] = js.undefined
  /**
