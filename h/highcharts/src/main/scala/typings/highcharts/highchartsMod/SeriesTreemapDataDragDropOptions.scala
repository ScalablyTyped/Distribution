...
trait SeriesTreemapDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesTreemapDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesTreemapDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesTreemapDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesTreemapDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesTreemapDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesTreemapDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesTreemapDataDragDropOptions]
  }
}
