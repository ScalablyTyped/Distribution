...
trait PlotWilliamsrStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotWilliamsrStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotWilliamsrStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotWilliamsrStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotWilliamsrStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotWilliamsrStatesSelectMarkerStatesHoverOptions]
  }
}
