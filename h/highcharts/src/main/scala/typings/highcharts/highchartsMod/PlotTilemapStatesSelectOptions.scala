...
trait PlotTilemapStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotTilemapStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotTilemapStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotTilemapStatesSelectMarkerOptions] = js.undefined
}

object PlotTilemapStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotTilemapStatesSelectAnimationOptions = null,
    ...
    marker: PlotTilemapStatesSelectMarkerOptions = null
  ): PlotTilemapStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTilemapStatesSelectOptions]
  }
}
