...
trait PlotStreamgraphDataGroupingOptions extends js.Object {
  /**
...
object PlotStreamgraphDataGroupingOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStreamgraphDataGroupingOptions = {
    ...
    __obj.asInstanceOf[PlotStreamgraphDataGroupingOptions]
  }
}
