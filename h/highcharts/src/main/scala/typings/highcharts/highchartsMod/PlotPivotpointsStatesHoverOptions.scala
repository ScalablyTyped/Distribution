...
trait PlotPivotpointsStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotPivotpointsStatesHoverAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotPivotpointsStatesHoverHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotPivotpointsStatesHoverMarkerOptions] = js.undefined
}

object PlotPivotpointsStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotPivotpointsStatesHoverAnimationOptions = null,
    ...
    marker: PlotPivotpointsStatesHoverMarkerOptions = null
  ): PlotPivotpointsStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotPivotpointsStatesHoverOptions]
  }
}
