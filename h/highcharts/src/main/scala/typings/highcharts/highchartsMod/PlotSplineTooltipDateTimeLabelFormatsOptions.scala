...
trait PlotSplineTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotSplineTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotSplineTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotSplineTooltipDateTimeLabelFormatsOptions]
  }
}
