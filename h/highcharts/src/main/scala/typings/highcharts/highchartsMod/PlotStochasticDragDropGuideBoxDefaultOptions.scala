...
trait PlotStochasticDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotStochasticDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotStochasticDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotStochasticDragDropGuideBoxDefaultOptions]
  }
}
