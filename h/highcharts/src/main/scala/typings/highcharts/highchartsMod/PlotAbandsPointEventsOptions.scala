...
trait PlotAbandsPointEventsOptions extends js.Object {
  /**
...
object PlotAbandsPointEventsOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotAbandsPointEventsOptions]
  }
}
