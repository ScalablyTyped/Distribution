...
trait PlotRsiTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotRsiTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotRsiTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotRsiTooltipDateTimeLabelFormatsOptions]
  }
}
