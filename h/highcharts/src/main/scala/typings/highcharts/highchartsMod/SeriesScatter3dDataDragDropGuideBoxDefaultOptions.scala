...
trait SeriesScatter3dDataDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object SeriesScatter3dDataDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): SeriesScatter3dDataDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[SeriesScatter3dDataDragDropGuideBoxDefaultOptions]
  }
}
