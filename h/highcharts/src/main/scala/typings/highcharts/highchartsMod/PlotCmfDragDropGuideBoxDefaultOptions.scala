...
trait PlotCmfDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotCmfDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCmfDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotCmfDragDropGuideBoxDefaultOptions]
  }
}
