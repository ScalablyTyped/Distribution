...
trait PlotVennStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotVennStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotVennStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotVennStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotVennStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVennStatesSelectMarkerOptions]
  }
}
