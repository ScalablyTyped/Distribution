...
trait PlotMapDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotMapDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMapDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotMapDragDropDragHandleOptions]
  }
}
