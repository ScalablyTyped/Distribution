...
trait PlotBubbleStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotBubbleStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBubbleStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotBubbleStatesSelectMarkerStatesSelectOptions]
  }
}
