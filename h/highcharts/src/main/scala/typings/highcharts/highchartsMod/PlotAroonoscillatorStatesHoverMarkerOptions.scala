...
trait PlotAroonoscillatorStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotAroonoscillatorStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotAroonoscillatorStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotAroonoscillatorStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotAroonoscillatorStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAroonoscillatorStatesHoverMarkerOptions]
  }
}
