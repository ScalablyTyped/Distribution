...
trait PlotVbpStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotVbpStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotVbpStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotVbpStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotVbpStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotVbpStatesHoverMarkerOptions]
  }
}
