...
trait PlotKeltnerchannelsDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotKeltnerchannelsDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotKeltnerchannelsDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotKeltnerchannelsDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotKeltnerchannelsDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotKeltnerchannelsDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotKeltnerchannelsDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsDragDropOptions]
  }
}
