...
trait PlotLinearregressionMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotLinearregressionMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionMarkerStatesSelectOptions]
  }
}
