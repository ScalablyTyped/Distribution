...
trait PlotRsiStatesSelectMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotRsiStatesSelectMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotRsiStatesSelectMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotRsiStatesSelectMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotRsiStatesSelectMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotRsiStatesSelectMarkerStatesHoverOptions]
  }
}
