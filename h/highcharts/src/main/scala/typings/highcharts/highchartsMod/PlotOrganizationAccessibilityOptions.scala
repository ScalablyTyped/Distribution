...
trait PlotOrganizationAccessibilityOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var keyboardNavigation: js.UndefOr[js.Object | PlotOrganizationAccessibilityKeyboardNavigationOptions] = js.undefined
  /**
...
object PlotOrganizationAccessibilityOptions {
  @scala.inline
  def apply(
    description: String = null,
    enabled: js.UndefOr[Boolean] = js.undefined,
    exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined,
    keyboardNavigation: js.Object | PlotOrganizationAccessibilityKeyboardNavigationOptions = null,
    pointDescriptionFormatter: js.Function = null
  ): PlotOrganizationAccessibilityOptions = {
    ...
    __obj.asInstanceOf[PlotOrganizationAccessibilityOptions]
  }
}
