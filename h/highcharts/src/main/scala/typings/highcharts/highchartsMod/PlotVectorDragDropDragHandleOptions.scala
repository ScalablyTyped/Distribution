...
trait PlotVectorDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotVectorDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotVectorDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotVectorDragDropDragHandleOptions]
  }
}
