...
trait PlotLinearregressioninterceptStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotLinearregressioninterceptStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressioninterceptStatesSelectHaloOptions | Null] = js.undefined
  /**
