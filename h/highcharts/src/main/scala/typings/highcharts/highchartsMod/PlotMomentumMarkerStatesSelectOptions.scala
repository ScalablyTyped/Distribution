...
trait PlotMomentumMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotMomentumMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotMomentumMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotMomentumMarkerStatesSelectOptions]
  }
}
