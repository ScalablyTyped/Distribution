...
trait PlotHeatmapStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotHeatmapStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotHeatmapStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotHeatmapStatesSelectMarkerStatesSelectOptions]
  }
}
