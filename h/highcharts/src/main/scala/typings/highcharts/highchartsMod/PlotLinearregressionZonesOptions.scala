...
trait PlotLinearregressionZonesOptions extends js.Object {
  /**
...
object PlotLinearregressionZonesOptions {
  @scala.inline
  def apply(
  ...
  ): PlotLinearregressionZonesOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionZonesOptions]
  }
}
