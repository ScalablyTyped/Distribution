...
trait PlotMapStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotMapStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotMapStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotMapStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotMapStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotMapStatesSelectMarkerOptions]
  }
}
