...
trait PlotPolygonStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPolygonStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotPolygonStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPolygonStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPolygonStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonStatesHoverMarkerOptions]
  }
}
