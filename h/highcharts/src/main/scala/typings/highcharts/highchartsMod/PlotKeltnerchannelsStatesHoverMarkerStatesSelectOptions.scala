...
trait PlotKeltnerchannelsStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotKeltnerchannelsStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotKeltnerchannelsStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotKeltnerchannelsStatesHoverMarkerStatesSelectOptions]
  }
}
