...
trait PlotAroonMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAroonMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotAroonMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAroonMarkerStatesHoverAnimationOptions = null,
