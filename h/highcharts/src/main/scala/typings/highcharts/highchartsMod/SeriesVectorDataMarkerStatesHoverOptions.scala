...
trait SeriesVectorDataMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | SeriesVectorDataMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object SeriesVectorDataMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | SeriesVectorDataMarkerStatesHoverAnimationOptions = null,
