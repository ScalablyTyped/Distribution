...
trait PlotCciStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotCciStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotCciStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotCciStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotCciStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotCciStatesHoverMarkerOptions]
  }
}
