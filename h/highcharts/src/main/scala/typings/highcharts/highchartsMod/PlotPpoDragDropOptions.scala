...
trait PlotPpoDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotPpoDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotPpoDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotPpoDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotPpoDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotPpoDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotPpoDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotPpoDragDropOptions]
  }
}
