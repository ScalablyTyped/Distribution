...
trait PlotSeriesStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotSeriesStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSeriesStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotSeriesStatesHoverMarkerStatesSelectOptions]
  }
}
