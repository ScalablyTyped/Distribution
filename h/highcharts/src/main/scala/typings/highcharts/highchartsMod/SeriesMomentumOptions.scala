...
- typings.highcharts.highchartsMod.PlotMomentumOptions because var conflicts: name, zIndex. Inlined accessibility, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorIndex, compare, compareBase, compareStart, compareToMain, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, includeInDataExport, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, marker, negativeColor, opacity, params, point, pointDescriptionFormatter, selected, shadow, showCheckbox, showInLegend, skipKeyboardNavigation, softThreshold, states, step, stickyTracking, threshold, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesMomentumOptions
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotMomentumDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesMomentumOptions: momentum
  /**
