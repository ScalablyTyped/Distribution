...
trait PlotAoStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAoStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAoStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAoStatesHoverMarkerStatesSelectOptions]
  }
}
