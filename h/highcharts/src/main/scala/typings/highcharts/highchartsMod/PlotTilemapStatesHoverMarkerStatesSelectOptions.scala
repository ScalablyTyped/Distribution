...
trait PlotTilemapStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotTilemapStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTilemapStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotTilemapStatesHoverMarkerStatesSelectOptions]
  }
}
