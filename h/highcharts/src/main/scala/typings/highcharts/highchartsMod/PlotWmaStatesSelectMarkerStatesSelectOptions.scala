...
trait PlotWmaStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotWmaStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotWmaStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotWmaStatesSelectMarkerStatesSelectOptions]
  }
}
