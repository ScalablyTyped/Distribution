...
trait PlotBulletOptions extends js.Object {
  /**
    * (Highcharts) Accessibility options for a series. Requires the
    * accessibility module.
    */
  var accessibility: js.UndefOr[js.Object | PlotBulletAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotBulletAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotBulletConnectorsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotBulletDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotBulletDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var events: js.UndefOr[PlotBulletEventsOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[PlotBulletLabelOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from all points.
    */
  var lastPrice: js.UndefOr[PlotBulletLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotBulletLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var point: js.UndefOr[PlotBulletPointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotBulletStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var targetOptions: js.UndefOr[PlotBulletTargetOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotBulletTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotBulletZonesOptions]] = js.undefined
}

object PlotBulletOptions {
  @scala.inline
  def apply(
    ...
    if (targetOptions != null) __obj.updateDynamic("targetOptions")(targetOptions)
    ...
    __obj.asInstanceOf[PlotBulletOptions]
  }
}
