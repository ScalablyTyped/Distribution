...
trait PlotBbDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotBbDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBbDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotBbDragDropDragHandleOptions]
  }
}
