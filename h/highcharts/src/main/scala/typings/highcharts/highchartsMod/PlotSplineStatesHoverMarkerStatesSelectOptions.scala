...
trait PlotSplineStatesHoverMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotSplineStatesHoverMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotSplineStatesHoverMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotSplineStatesHoverMarkerStatesSelectOptions]
  }
}
