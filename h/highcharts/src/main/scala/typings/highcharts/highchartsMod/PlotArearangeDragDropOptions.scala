...
trait PlotArearangeDragDropOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotArearangeDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotArearangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotArearangeDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotArearangeDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotArearangeDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
