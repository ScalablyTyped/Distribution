...
trait PlotStreamgraphZonesOptions extends js.Object {
  /**
...
object PlotStreamgraphZonesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PlotStreamgraphZonesOptions]
  }
}
