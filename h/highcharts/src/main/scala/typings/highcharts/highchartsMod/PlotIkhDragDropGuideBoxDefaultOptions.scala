...
trait PlotIkhDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotIkhDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotIkhDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotIkhDragDropGuideBoxDefaultOptions]
  }
}
