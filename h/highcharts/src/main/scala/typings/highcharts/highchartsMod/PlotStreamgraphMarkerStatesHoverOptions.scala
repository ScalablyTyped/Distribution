...
trait PlotStreamgraphMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotStreamgraphMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotStreamgraphMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotStreamgraphMarkerStatesHoverAnimationOptions = null,
