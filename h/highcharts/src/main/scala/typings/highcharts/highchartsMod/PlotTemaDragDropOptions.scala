...
trait PlotTemaDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotTemaDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotTemaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotTemaDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotTemaDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotTemaDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotTemaDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotTemaDragDropOptions]
  }
}
