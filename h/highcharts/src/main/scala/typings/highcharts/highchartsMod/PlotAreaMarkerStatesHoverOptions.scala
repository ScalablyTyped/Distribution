...
trait PlotAreaMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotAreaMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotAreaMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotAreaMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotAreaMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotAreaMarkerStatesHoverOptions]
  }
}
