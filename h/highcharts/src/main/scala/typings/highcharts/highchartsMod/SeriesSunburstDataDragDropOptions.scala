...
trait SeriesSunburstDataDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[SeriesSunburstDataDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    SeriesSunburstDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object SeriesSunburstDataDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: SeriesSunburstDataDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: SeriesSunburstDataDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): SeriesSunburstDataDragDropOptions = {
    ...
    __obj.asInstanceOf[SeriesSunburstDataDragDropOptions]
  }
}
