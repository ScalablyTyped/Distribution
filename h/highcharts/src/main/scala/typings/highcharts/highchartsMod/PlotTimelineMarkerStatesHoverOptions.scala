...
trait PlotTimelineMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotTimelineMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotTimelineMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotTimelineMarkerStatesHoverAnimationOptions = null,
