...
trait PlotLineStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotLineStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotLineStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotLineStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotLineStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotLineStatesSelectMarkerOptions]
  }
}
