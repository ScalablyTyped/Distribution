...
trait PlotPolygonStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPolygonStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotPolygonStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPolygonStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPolygonStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPolygonStatesSelectMarkerOptions]
  }
}
