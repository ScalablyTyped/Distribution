...
trait PlotCylinderDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotCylinderDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotCylinderDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotCylinderDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotCylinderDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotCylinderDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotCylinderDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotCylinderDragDropOptions]
  }
}
