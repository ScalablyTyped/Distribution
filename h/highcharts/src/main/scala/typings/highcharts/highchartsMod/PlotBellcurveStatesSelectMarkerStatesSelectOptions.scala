...
trait PlotBellcurveStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotBellcurveStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotBellcurveStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotBellcurveStatesSelectMarkerStatesSelectOptions]
  }
}
