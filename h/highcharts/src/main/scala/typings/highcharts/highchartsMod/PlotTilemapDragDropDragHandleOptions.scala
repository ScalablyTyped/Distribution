...
trait PlotTilemapDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotTilemapDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotTilemapDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotTilemapDragDropDragHandleOptions]
  }
}
