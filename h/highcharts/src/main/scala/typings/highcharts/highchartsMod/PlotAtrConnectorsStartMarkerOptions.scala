...
trait PlotAtrConnectorsStartMarkerOptions extends js.Object {
  /**
...
object PlotAtrConnectorsStartMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAtrConnectorsStartMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotAtrConnectorsStartMarkerOptions]
  }
}
