...
trait PlotCmfDragDropOptions extends js.Object {
  /**
    * (Highstock) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotCmfDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotCmfDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotCmfDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotCmfDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotCmfDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotCmfDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotCmfDragDropOptions]
  }
}
