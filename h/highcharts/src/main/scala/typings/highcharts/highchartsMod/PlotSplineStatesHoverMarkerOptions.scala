...
trait PlotSplineStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSplineStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotSplineStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotSplineStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotSplineStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotSplineStatesHoverMarkerOptions]
  }
}
