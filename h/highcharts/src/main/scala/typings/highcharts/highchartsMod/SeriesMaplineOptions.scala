...
- typings.highcharts.highchartsMod.PlotMaplineOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, boostThreshold, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, compare, compareBase, compareStart, connectEnds, connectNulls, connectors, cropThreshold, cursor, dashStyle, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, fillColor, findNearestPointBy, gapSize, gapUnit, getExtremesFromAll, includeInDataExport, jitter, joinBy, keys, label, lastPrice, lastVisiblePrice, linecap, lineWidth, linkedTo, navigatorOptions, negativeColor, nullColor, nullInteraction, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointRange, pointStart, selected, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, states, step, stickyTracking, threshold, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesMaplineOptions
  ...
  /**
    ...
    */
  var fillColor: js.UndefOr[ColorString] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesMaplineOptions: mapline
  /**
...
object SeriesMaplineOptions {
  ...
  def apply(
    ...
    data: js.Array[Double | (js.Tuple2[String, Double | Null]) | Null | SeriesMaplineDataOptions] = null,
