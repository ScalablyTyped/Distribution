...
trait PlotPyramid3dDragDropOptions extends js.Object {
  /**
    * (Highcharts) Options for the drag handles.
    */
  var dragHandle: js.UndefOr[PlotPyramid3dDragDropDragHandleOptions] = js.undefined
  /**
  ...
  var guideBox: js.UndefOr[
    PlotPyramid3dDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions]
  ] = js.undefined
  /**
...
object PlotPyramid3dDragDropOptions {
  @scala.inline
  def apply(
    dragHandle: PlotPyramid3dDragDropDragHandleOptions = null,
    ...
    groupBy: String = null,
    guideBox: PlotPyramid3dDragDropGuideBoxOptions | Dictionary[PlotSeriesDragDropGuideBoxDefaultOptions] = null,
    liveRedraw: js.UndefOr[Boolean] = js.undefined
  ): PlotPyramid3dDragDropOptions = {
    ...
    __obj.asInstanceOf[PlotPyramid3dDragDropOptions]
  }
}
