...
trait PlotPieStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotPieStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotPieStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotPieStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotPieStatesSelectMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotPieStatesSelectMarkerOptions]
  }
}
