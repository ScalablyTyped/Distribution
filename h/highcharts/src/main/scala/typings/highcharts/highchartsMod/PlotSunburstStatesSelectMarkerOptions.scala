...
trait PlotSunburstStatesSelectMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotSunburstStatesSelectMarkerStatesOptions] = js.undefined
  /**
...
object PlotSunburstStatesSelectMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotSunburstStatesSelectMarkerStatesOptions = null,
    symbol: String = null,
    ...
    __obj.asInstanceOf[PlotSunburstStatesSelectMarkerOptions]
  }
}
