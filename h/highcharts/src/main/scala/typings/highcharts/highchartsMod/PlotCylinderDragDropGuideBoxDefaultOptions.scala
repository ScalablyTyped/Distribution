...
trait PlotCylinderDragDropGuideBoxDefaultOptions extends js.Object {
  /**
...
object PlotCylinderDragDropGuideBoxDefaultOptions {
  @scala.inline
  def apply(
  ...
  ): PlotCylinderDragDropGuideBoxDefaultOptions = {
    ...
    __obj.asInstanceOf[PlotCylinderDragDropGuideBoxDefaultOptions]
  }
}
