...
trait PlotTrixStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTrixStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotTrixStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotTrixStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotTrixStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTrixStatesHoverMarkerOptions]
  }
}
