...
trait SonifySeriesOptionsObject extends js.Object {
  ...
  /**
    ...
    */
  var instruments: js.Array[typings.highcharts.modulesSonificationMod.highchartsMod.PointInstrumentObject]
  /**
...
object SonifySeriesOptionsObject {
  ...
  def apply(
    duration: Double,
    instruments: js.Array[typings.highcharts.modulesSonificationMod.highchartsMod.PointInstrumentObject],
