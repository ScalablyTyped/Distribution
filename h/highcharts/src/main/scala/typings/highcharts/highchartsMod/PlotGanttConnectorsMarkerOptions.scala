...
trait PlotGanttConnectorsMarkerOptions extends js.Object {
  /**
...
object PlotGanttConnectorsMarkerOptions {
  @scala.inline
  def apply(
  ...
  ): PlotGanttConnectorsMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotGanttConnectorsMarkerOptions]
  }
}
