...
- typings.highcharts.highchartsMod.PlotVariwideOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, borderColor, borderRadius, borderWidth, className, clip, color, colorAxis, colorByPoint, colorIndex, colors, compare, compareBase, compareStart, connectors, cropThreshold, cursor, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, getExtremesFromAll, grouping, groupPadding, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, linkedTo, maxPointWidth, minPointLength, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointPadding, pointPlacement, pointRange, pointStart, pointWidth, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, stacking, states, stickyTracking, threshold, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesVariwideOptions
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesVariwideOptions: variwide
  /**
