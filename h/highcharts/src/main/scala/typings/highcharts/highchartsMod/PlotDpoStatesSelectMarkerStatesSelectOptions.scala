...
trait PlotDpoStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotDpoStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotDpoStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotDpoStatesSelectMarkerStatesSelectOptions]
  }
}
