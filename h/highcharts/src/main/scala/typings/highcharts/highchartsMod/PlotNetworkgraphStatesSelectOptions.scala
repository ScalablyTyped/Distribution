...
trait PlotNetworkgraphStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotNetworkgraphStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotNetworkgraphStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotNetworkgraphStatesSelectMarkerOptions] = js.undefined
}

object PlotNetworkgraphStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotNetworkgraphStatesSelectAnimationOptions = null,
    ...
    marker: PlotNetworkgraphStatesSelectMarkerOptions = null
  ): PlotNetworkgraphStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotNetworkgraphStatesSelectOptions]
  }
}
