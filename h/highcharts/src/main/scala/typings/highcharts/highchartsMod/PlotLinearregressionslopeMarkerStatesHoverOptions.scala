...
trait PlotLinearregressionslopeMarkerStatesHoverOptions extends js.Object {
  ...
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotLinearregressionslopeMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotLinearregressionslopeMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotLinearregressionslopeMarkerStatesHoverAnimationOptions = null,
