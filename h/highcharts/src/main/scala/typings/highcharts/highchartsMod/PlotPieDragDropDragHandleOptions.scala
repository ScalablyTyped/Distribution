...
trait PlotPieDragDropDragHandleOptions extends js.Object {
  /**
...
object PlotPieDragDropDragHandleOptions {
  @scala.inline
  def apply(
  ...
  ): PlotPieDragDropDragHandleOptions = {
    ...
    __obj.asInstanceOf[PlotPieDragDropDragHandleOptions]
  }
}
