...
trait PlotVectorStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotVectorStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotVectorStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotVectorStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotVectorStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotVectorStatesHoverMarkerStatesHoverOptions]
  }
}
