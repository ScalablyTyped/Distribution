...
- typings.highcharts.highchartsMod.PlotXrangeOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, borderColor, borderRadius, borderWidth, className, clip, color, colorAxis, colorByPoint, colorIndex, colors, compare, compareBase, compareStart, connectors, cursor, dataGrouping, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, grouping, groupPadding, groupZPadding, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, linkedTo, maxPointWidth, minPointLength, navigatorOptions, opacity, partialFill, point, pointDescriptionFormatter, pointPadding, pointRange, pointWidth, selected, shadow, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, states, stickyTracking, tooltip, turboThreshold, visible, zoneAxis, zones */ trait SeriesXrangeOptions
  ...
  /**
    ...
    */
  var accessibility: js.UndefOr[js.Object | PlotXrangeAccessibilityOptions] = js.undefined
  /**
  ...
  /**
    ...
    * several chart types.
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotXrangeAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var connectors: js.UndefOr[PlotXrangeConnectorsOptions] = js.undefined
  /**
    * Not available
    */
  ...
  /**
    ...
    */
  var dataGrouping: js.UndefOr[PlotXrangeDataGroupingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var lastPrice: js.UndefOr[PlotXrangeLastPriceOptions] = js.undefined
  /**
    * (Highstock) The line marks the last price from visible range of points.
    */
  var lastVisiblePrice: js.UndefOr[PlotXrangeLastVisiblePriceOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var point: js.UndefOr[PlotXrangePointOptions] = js.undefined
  /**
  ...
  var states: js.UndefOr[PlotXrangeStatesOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tooltip: js.UndefOr[PlotXrangeTooltipOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesXrangeOptions: xrange
  /**
  ...
  /**
    ...
    */
  var zones: js.UndefOr[js.Array[PlotXrangeZonesOptions]] = js.undefined
}
