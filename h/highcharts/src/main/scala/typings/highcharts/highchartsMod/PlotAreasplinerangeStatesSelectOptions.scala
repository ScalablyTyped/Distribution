...
trait PlotAreasplinerangeStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotAreasplinerangeStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotAreasplinerangeStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotAreasplinerangeStatesSelectMarkerOptions] = js.undefined
}

object PlotAreasplinerangeStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotAreasplinerangeStatesSelectAnimationOptions = null,
    ...
    marker: PlotAreasplinerangeStatesSelectMarkerOptions = null
  ): PlotAreasplinerangeStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAreasplinerangeStatesSelectOptions]
  }
}
