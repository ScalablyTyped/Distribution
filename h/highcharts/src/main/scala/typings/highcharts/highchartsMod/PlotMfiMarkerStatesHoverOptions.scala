...
trait PlotMfiMarkerStatesHoverOptions extends js.Object {
  /**
    ...
    */
  var animation: js.UndefOr[Boolean | AnimationOptionsObject | PlotMfiMarkerStatesHoverAnimationOptions] = js.undefined
  /**
...
object PlotMfiMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotMfiMarkerStatesHoverAnimationOptions = null,
