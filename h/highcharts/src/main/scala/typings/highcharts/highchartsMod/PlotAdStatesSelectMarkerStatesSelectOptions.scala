...
trait PlotAdStatesSelectMarkerStatesSelectOptions extends js.Object {
  /**
...
object PlotAdStatesSelectMarkerStatesSelectOptions {
  @scala.inline
  def apply(
  ...
  ): PlotAdStatesSelectMarkerStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotAdStatesSelectMarkerStatesSelectOptions]
  }
}
