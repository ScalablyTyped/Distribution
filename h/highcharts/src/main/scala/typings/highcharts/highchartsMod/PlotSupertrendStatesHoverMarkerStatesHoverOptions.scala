...
trait PlotSupertrendStatesHoverMarkerStatesHoverOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation when hovering over the marker.
    */
  var animation: js.UndefOr[
    Boolean | AnimationOptionsObject | PlotSupertrendStatesHoverMarkerStatesHoverAnimationOptions
  ] = js.undefined
  /**
...
object PlotSupertrendStatesHoverMarkerStatesHoverOptions {
  @scala.inline
  def apply(
    animation: Boolean | AnimationOptionsObject | PlotSupertrendStatesHoverMarkerStatesHoverAnimationOptions = null,
  ...
  ): PlotSupertrendStatesHoverMarkerStatesHoverOptions = {
    ...
    __obj.asInstanceOf[PlotSupertrendStatesHoverMarkerStatesHoverOptions]
  }
}
