...
- typings.highcharts.highchartsMod.PlotVectorOptions because var conflicts: zIndex. Inlined accessibility, allAreas, allowPointSelect, animation, animationLimit, boostBlending, borderColor, borderWidth, className, clip, color, colorAxis, colorIndex, compare, compareBase, compareStart, connectors, cursor, dataLabels, description, dragDrop, enableMouseTracking, events, exposeElementToA11y, findNearestPointBy, getExtremesFromAll, includeInDataExport, joinBy, keys, label, lastPrice, lastVisiblePrice, lineWidth, linkedTo, navigatorOptions, negativeColor, opacity, point, pointDescriptionFormatter, pointInterval, pointIntervalUnit, pointRange, pointStart, rotationOrigin, selected, showCheckbox, showInLegend, showInNavigator, skipKeyboardNavigation, softThreshold, states, stickyTracking, threshold, tooltip, turboThreshold, vectorLength, visible, zoneAxis, zones */ trait SeriesVectorOptions
  ...
  /**
    ...
    */
  var dragDrop: js.UndefOr[PlotVectorDragDropOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("type")
  var type_SeriesVectorOptions: vector
  /**
