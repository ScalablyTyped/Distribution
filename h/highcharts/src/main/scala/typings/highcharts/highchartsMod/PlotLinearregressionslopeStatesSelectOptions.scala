...
trait PlotLinearregressionslopeStatesSelectOptions extends js.Object {
  /**
    * (Highcharts, Highstock) Animation setting for hovering the graph in
    * line-type series.
    */
  var animation: js.UndefOr[PlotLinearregressionslopeStatesSelectAnimationOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var halo: js.UndefOr[PlotLinearregressionslopeStatesSelectHaloOptions | Null] = js.undefined
  /**
  ...
  /**
    ...
    */
  var marker: js.UndefOr[PlotLinearregressionslopeStatesSelectMarkerOptions] = js.undefined
}

object PlotLinearregressionslopeStatesSelectOptions {
  @scala.inline
  def apply(
    animation: PlotLinearregressionslopeStatesSelectAnimationOptions = null,
    ...
    marker: PlotLinearregressionslopeStatesSelectMarkerOptions = null
  ): PlotLinearregressionslopeStatesSelectOptions = {
    ...
    __obj.asInstanceOf[PlotLinearregressionslopeStatesSelectOptions]
  }
}
