...
trait PlotTemaStatesHoverMarkerOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var states: js.UndefOr[PlotTemaStatesHoverMarkerStatesOptions] = js.undefined
  /**
...
object PlotTemaStatesHoverMarkerOptions {
  @scala.inline
  def apply(
    ...
    states: PlotTemaStatesHoverMarkerStatesOptions = null,
    symbol: String = null,
    width: Int | Double = null
  ): PlotTemaStatesHoverMarkerOptions = {
    ...
    __obj.asInstanceOf[PlotTemaStatesHoverMarkerOptions]
  }
}
