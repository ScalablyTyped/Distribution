...
trait PlotDpoTooltipDateTimeLabelFormatsOptions extends js.Object {
...
object PlotDpoTooltipDateTimeLabelFormatsOptions {
  @scala.inline
  def apply(
    day: String = null,
    hour: String = null,
    ...
    week: String = null,
    year: String = null
  ): PlotDpoTooltipDateTimeLabelFormatsOptions = {
    ...
    __obj.asInstanceOf[PlotDpoTooltipDateTimeLabelFormatsOptions]
  }
}
