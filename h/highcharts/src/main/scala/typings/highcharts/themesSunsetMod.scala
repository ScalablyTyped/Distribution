...
object themesSunsetMod {
  
  @JSImport("highcharts/themes/sunset", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/themes/sunset", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/themes/sunset", "Highcharts.SeriesPalettes")
    @js.native
