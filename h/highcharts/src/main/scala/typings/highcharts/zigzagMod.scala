...
object zigzagMod {
  ...
  @JSImport("highcharts/indicators/zigzag", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/zigzag", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/zigzag", "Highcharts.SeriesPalettes")
    @js.native
