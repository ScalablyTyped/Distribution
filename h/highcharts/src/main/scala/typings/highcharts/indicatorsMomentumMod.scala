...
object indicatorsMomentumMod {
  
  @JSImport("highcharts/indicators/momentum", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/momentum", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/momentum", "Highcharts.SeriesPalettes")
    @js.native
