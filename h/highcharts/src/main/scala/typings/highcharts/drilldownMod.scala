...
object drilldownMod {
  ...
  @JSImport("highcharts/modules/drilldown", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/modules/drilldown", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/modules/drilldown", "Highcharts.SeriesPalettes")
    @js.native
  ...
  object highchartsAugmentingMod {
    ...
    object Chart {
      ...
      inline def apply(addSeriesAsDrilldown: (Point, SeriesOptionsType) => Unit, drillUp: () => Unit): Chart = {
    ...
    trait Point extends StObject {
      ...
      /**
        ...
        */
      def doDrilldown(): Unit
    }
    object Point {
      
      inline def apply(doDrilldown: () => Unit): Point = {
        val __obj = js.Dynamic.literal(doDrilldown = js.Any.fromFunction0(doDrilldown))
