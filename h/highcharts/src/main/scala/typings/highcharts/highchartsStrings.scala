...
object highchartsStrings {
  ...
  sealed trait ignoreHiddenPoint
    extends StObject
       with SeriesOptionsType
  inline def ignoreHiddenPoint: ignoreHiddenPoint = "ignoreHiddenPoint".asInstanceOf[ignoreHiddenPoint]
  ...
  sealed trait minSize
    extends StObject
       with SeriesOptionsType
  inline def minSize: minSize = "minSize".asInstanceOf[minSize]
  ...
  sealed trait slicedOffset
    extends StObject
       with SeriesOptionsType
  inline def slicedOffset: slicedOffset = "slicedOffset".asInstanceOf[slicedOffset]
