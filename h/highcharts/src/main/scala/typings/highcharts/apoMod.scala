...
object apoMod {
  ...
  @JSImport("highcharts/indicators/apo", JSImport.Namespace)
  @js.native
  ...
  object Highcharts {
    ...
    @JSImport("highcharts/indicators/apo", "Highcharts.AST")
    @js.native
    ...
    @JSImport("highcharts/indicators/apo", "Highcharts.SeriesPalettes")
    @js.native
