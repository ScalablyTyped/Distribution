...
- highchartsLib.highchartsMod.IndividualSeriesOptions because var conflicts: color, cursor, linkedTo, maxFontSize, minFontSize, pointWidth, visible. Inlined size, innerSize, `type`, colorIndex, crisp, data, description, id, index, legendIndex, name, stack, xAxis, yAxis, zIndex */ trait BarChartSeriesOptions extends BarChart {
  /**
