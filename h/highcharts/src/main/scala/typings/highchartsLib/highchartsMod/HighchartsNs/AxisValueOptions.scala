...
object AxisValueOptions {
  ...
  def apply(
    ...
    plotBands: js.Array[PlotBands] = null,
    plotLines: js.Array[PlotLines] = null,
    ...
    __obj.asInstanceOf[AxisValueOptions]
  }
}
