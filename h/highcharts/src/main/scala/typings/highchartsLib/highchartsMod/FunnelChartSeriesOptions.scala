...
- highchartsLib.highchartsMod.IndividualSeriesOptions because var conflicts: color, cursor, linkedTo, visible. Inlined size, innerSize, `type`, colorIndex, crisp, data, description, id, index, legendIndex, maxFontSize, minFontSize, name, pointWidth, stack, xAxis, yAxis, zIndex */ trait FunnelChartSeriesOptions extends FunnelChart {
  /**
...
object FunnelChartSeriesOptions {
  @scala.inline
  def apply(
    ...
    neckHeight: scala.Double | java.lang.String = null,
    neckWidth: scala.Double | java.lang.String = null,
    ...
    __obj.asInstanceOf[FunnelChartSeriesOptions]
  }
}
