...
- highchartsLib.highchartsMod.HighchartsNs.IndividualSeriesOptions because var conflicts: color, cursor, maxFontSize, minFontSize, visible. Inlined size, innerSize, `type`, colorIndex, crisp, data, description, id, index, legendIndex, name, pointWidth, stack, xAxis, yAxis, zIndex */ trait AreaRangeChartSeriesOptions extends AreaRangeChart {
  /**
...
object AreaRangeChartSeriesOptions {
  @scala.inline
  def apply(
    ...
    dataLabels: RangeDataLabels = null,
    ...
    __obj.asInstanceOf[AreaRangeChartSeriesOptions]
  }
}
