...
/**
  ...
  */
trait ColumnRangeChart extends BarChart {
  @JSName("dataLabels")
  var dataLabels_ColumnRangeChart: js.UndefOr[RangeDataLabels] = js.undefined
}

object ColumnRangeChart {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ColumnRangeChart]
  }
}
