...
- highchartsLib.highchartsMod.LineStates because var conflicts: enabled, halo. Inlined animation, lineWidth, lineWidthPlus, marker */ trait PieStates extends BarStates {
  /**
