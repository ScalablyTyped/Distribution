...
- highchartsLib.highchartsMod.IndividualSeriesOptions because var conflicts: color, cursor, linkedTo, visible. Inlined size, innerSize, `type`, colorIndex, crisp, data, description, id, index, legendIndex, maxFontSize, minFontSize, name, pointWidth, stack, xAxis, yAxis, zIndex */ trait PyramidChartSeriesOptions extends PyramidChart {
  /**
...
object PyramidChartSeriesOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PyramidChartSeriesOptions]
  }
}
