...
object AreaSplineRangeChartSeriesOptions {
  @scala.inline
  def apply(
  ...
  ): AreaSplineRangeChartSeriesOptions = {
    ...
    __obj.asInstanceOf[AreaSplineRangeChartSeriesOptions]
  }
}
