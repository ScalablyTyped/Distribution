...
trait RangeSelectorOptions extends js.Object {
  ...
  var inputStyle: js.UndefOr[highchartsLib.highchartsMod.CSSObject] = js.undefined
  var labelStyle: js.UndefOr[highchartsLib.highchartsMod.CSSObject] = js.undefined
...
object RangeSelectorOptions {
  ...
  def apply(
    ...
    inputStyle: highchartsLib.highchartsMod.CSSObject = null,
    labelStyle: highchartsLib.highchartsMod.CSSObject = null,
