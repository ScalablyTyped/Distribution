...
trait NavigatorOptions extends js.Object {
  ...
  var series: js.UndefOr[highchartsLib.highchartsMod.IndividualSeriesOptions] = js.undefined
  var xAxis: js.UndefOr[highchartsLib.highchartsMod.AxisOptions] = js.undefined
  var yAxis: js.UndefOr[highchartsLib.highchartsMod.AxisOptions] = js.undefined
}
...
object NavigatorOptions {
  ...
  def apply(
    ...
    series: highchartsLib.highchartsMod.IndividualSeriesOptions = null,
    xAxis: highchartsLib.highchartsMod.AxisOptions = null,
    yAxis: highchartsLib.highchartsMod.AxisOptions = null
  ): NavigatorOptions = {
