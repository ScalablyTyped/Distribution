...
object YAxisOptions {
  ...
  def apply(
    ...
    breaks: js.Array[highchartsLib.highchartsMod.HighchartsNs.AxisBreak] = null,
    categories: js.Array[_] = null,
    ceiling: scala.Int | scala.Double = null,
    className: java.lang.String = null,
    crosshair: highchartsLib.highchartsMod.HighchartsNs.CrosshairObject | scala.Boolean = null,
    dateTimeLabelFormats: highchartsLib.highchartsMod.HighchartsNs.DateTimeFormats = null,
    ...
    labels: highchartsLib.highchartsMod.HighchartsNs.AxisLabels = null,
    lineColor: java.lang.String | highchartsLib.highchartsMod.HighchartsNs.Gradient = null,
    ...
    plotBands: js.Array[highchartsLib.highchartsMod.HighchartsNs.PlotBands] = null,
    plotLines: js.Array[highchartsLib.highchartsMod.HighchartsNs.PlotLines] = null,
    resize: highchartsLib.Anon_ControlledAxis = null,
    ...
    title: highchartsLib.highchartsMod.HighchartsNs.AxisTitle = null,
    tooltipValueFormat: java.lang.String = null,
    ...
    if (tooltipValueFormat != null) __obj.updateDynamic("tooltipValueFormat")(tooltipValueFormat)
    if (top != null) __obj.updateDynamic("top")(top.asInstanceOf[js.Any])
    if (`type` != null) __obj.updateDynamic("type")(`type`)
    if (units != null) __obj.updateDynamic("units")(units)
    if (!js.isUndefined(visible)) __obj.updateDynamic("visible")(visible)
    __obj.asInstanceOf[YAxisOptions]
  }
}
