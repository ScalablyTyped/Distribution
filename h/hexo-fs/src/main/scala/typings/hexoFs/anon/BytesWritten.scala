...
@js.native
trait BytesWritten[TBuffer /* <: typings.node.Buffer | Uint8Array */] extends js.Object {
...
object BytesWritten {
  ...
  @scala.inline
  implicit class BytesWrittenOps[Self <: BytesWritten[_], TBuffer /* <: typings.node.Buffer | Uint8Array */] (val x: Self with BytesWritten[TBuffer]) extends AnyVal {
