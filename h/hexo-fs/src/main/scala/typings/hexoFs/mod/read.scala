...
import typings.hexoFs.AnonBytesRead
...
object read extends js.Object {
  ...
  def apply(fd: Double, buffer: Uint8Array, offset: Double, length: Double): typings.bluebird.mod.^[AnonBytesRead] = js.native
  def apply(fd: Double, buffer: Uint8Array, offset: Double, length: Double, position: Double): typings.bluebird.mod.^[AnonBytesRead] = js.native
}
