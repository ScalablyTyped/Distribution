...
object distCjsHibpMod {
  
  @JSImport("hibp/dist/cjs/hibp", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("hibp/dist/cjs/hibp", "RateLimitError")
  @js.native
  open class RateLimitError protected ()
    extends StObject
       with Error {
    def this(retryAfter: ReturnType[js.Function1[/* name */ String, String | Null]]) = this()
    def this(retryAfter: ReturnType[js.Function1[/* name */ String, String | Null]], message: String) = this()
    def this(
  ...
  trait HIBP extends StObject {
    ...
    var RateLimitError: Instantiable3[
        ...
        /* options */ js.UndefOr[ErrorOptions], 
        typings.hibp.distCjsHibpMod.RateLimitError
      ]
