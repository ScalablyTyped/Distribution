...
object mod {
  ...
  inline def createPath(param0: typings.history.anon.PartialPath): String = ^.asInstanceOf[js.Dynamic].applyDynamic("createPath")(param0.asInstanceOf[js.Any]).asInstanceOf[String]
