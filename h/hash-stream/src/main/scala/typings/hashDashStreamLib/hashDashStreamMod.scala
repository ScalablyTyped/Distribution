...
object hashDashStreamMod extends js.Object {
  def apply(filename: java.lang.String, algorithm: java.lang.String): stdLib.Promise[nodeLib.Buffer] = js.native
  def apply(
  ...
  def apply(stream: nodeLib.streamMod.Readable, algorithm: java.lang.String): stdLib.Promise[nodeLib.Buffer] = js.native
  def apply(
