...
object ^ extends js.Object {
  ...
  def boomify(error: stdLib.Error, options: atHapiBoomLib.Anon_Message): Boom[scala.Null] = js.native
  /**
  ...
  /**
    ...
    */
  def isBoom(error: stdLib.Error): /* is @hapi/boom.@hapi/boom.Boom<any> */ scala.Boolean = js.native
  /**
