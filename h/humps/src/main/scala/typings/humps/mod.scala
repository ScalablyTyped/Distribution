...
object mod {
  ...
  inline def camelize(value: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("camelize")(value.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def pascalize(value: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("pascalize")(value.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  object HumpsOptions {
    ...
    extension [Self <: HumpsOptions](x: Self) {
      ...
      inline def setSplit(value: RegExp): Self = StObject.set(x, "split", value.asInstanceOf[js.Any])
