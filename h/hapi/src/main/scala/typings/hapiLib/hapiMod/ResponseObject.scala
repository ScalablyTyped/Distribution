...
trait ResponseObject
  ...
  /**
    ...
    */
  val headers: hapiLib.hapiMod.UtilNs.Dictionary[java.lang.String | js.Array[java.lang.String]] = js.native
  /**
    * Default value: {}.
  ...
  /**
    ...
    */
  val source: hapiLib.hapiMod.LifecycleNs.ReturnValue = js.native
  /**
    * Default value: 200.
  ...
  /**
    ...
    */
  val variety: hapiLib.hapiLibStrings.plain | hapiLib.hapiLibStrings.buffer | hapiLib.hapiLibStrings.stream = js.native
  /**
    ...
    */
  def bytes(length: scala.Double): ResponseObject = js.native
  /**
    ...
    */
  def charset(charset: java.lang.String): ResponseObject = js.native
  /**
    * Sets the 'Content-Type' HTTP header 'charset' property where:
    * $param charset - the charset property value.
    * @return Return value: the current response object.
    ...
    */
  def code(statusCode: scala.Double): ResponseObject = js.native
  /**
    ...
    */
  def created(uri: java.lang.String): ResponseObject = js.native
  /**
    ...
    */
  @JSName("encoding")
  def encoding_ascii(encoding: hapiLib.hapiLibStrings.ascii): ResponseObject = js.native
  @JSName("encoding")
  def encoding_base64(encoding: hapiLib.hapiLibStrings.base64): ResponseObject = js.native
  @JSName("encoding")
  def encoding_binary(encoding: hapiLib.hapiLibStrings.binary): ResponseObject = js.native
  @JSName("encoding")
  def encoding_hex(encoding: hapiLib.hapiLibStrings.hex): ResponseObject = js.native
  @JSName("encoding")
  def encoding_latin1(encoding: hapiLib.hapiLibStrings.latin1): ResponseObject = js.native
  @JSName("encoding")
  def encoding_ucs2(encoding: hapiLib.hapiLibStrings.ucs2): ResponseObject = js.native
  @JSName("encoding")
  def encoding_utf16le(encoding: hapiLib.hapiLibStrings.utf16le): ResponseObject = js.native
  @JSName("encoding")
  def encoding_utf8(encoding: hapiLib.hapiLibStrings.utf8): ResponseObject = js.native
  /**
  ...
  /**
    ...
    */
  def header(name: java.lang.String, value: java.lang.String): ResponseObject = js.native
  def header(name: java.lang.String, value: java.lang.String, options: ResponseObjectHeaderOptions): ResponseObject = js.native
  /**
    ...
    */
  def location(uri: java.lang.String): ResponseObject = js.native
  /**
    ...
    */
  def message(httpMessage: java.lang.String): ResponseObject = js.native
  /**
    ...
    */
  def permanent(isPermanent: scala.Boolean): ResponseObject = js.native
  /**
    ...
    */
  def redirect(uri: java.lang.String): ResponseObject = js.native
  /**
    ...
    */
  def replacer(method: hapiLib.hapiMod.JsonNs.StringifyReplacer): ResponseObject = js.native
  /**
    ...
    */
  def rewritable(isRewritable: scala.Boolean): ResponseObject = js.native
  /**
    ...
    */
  def spaces(count: scala.Double): ResponseObject = js.native
  def state(name: java.lang.String, value: java.lang.String): ResponseObject = js.native
  def state(name: java.lang.String, value: java.lang.String, options: ServerStateCookieOptions): ResponseObject = js.native
  /**
    ...
    */
  def state(name: java.lang.String, value: js.Object): ResponseObject = js.native
  def state(name: java.lang.String, value: js.Object, options: ServerStateCookieOptions): ResponseObject = js.native
  /**
    ...
    */
  def suffix(suffix: java.lang.String): ResponseObject = js.native
  /**
  ...
  /**
    ...
    */
  def temporary(isTemporary: scala.Boolean): ResponseObject = js.native
  /**
    ...
    */
  def ttl(msec: scala.Double): ResponseObject = js.native
  /**
    ...
    */
  def `type`(mimeType: java.lang.String): ResponseObject = js.native
  /**
    ...
    */
  def unstate(name: java.lang.String): ResponseObject = js.native
  def unstate(name: java.lang.String, options: ServerStateCookieOptions): ResponseObject = js.native
  /**
    ...
    */
  def vary(header: java.lang.String): ResponseObject = js.native
}
