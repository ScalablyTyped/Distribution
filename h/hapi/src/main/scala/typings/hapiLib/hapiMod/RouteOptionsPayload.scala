...
trait RouteOptionsPayload extends js.Object {
  ...
  /**
    ...
    */
  var compression: js.UndefOr[hapiLib.hapiMod.UtilNs.Dictionary[PayloadCompressionDecoderSettings]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var parse: js.UndefOr[scala.Boolean | hapiLib.hapiLibStrings.gunzip] = js.undefined
  /**
    ...
    */
  var timeout: js.UndefOr[hapiLib.hapiLibNumbers.`false` | scala.Double] = js.undefined
  /**
