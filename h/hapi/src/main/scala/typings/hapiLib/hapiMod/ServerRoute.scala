...
trait ServerRoute extends js.Object {
  ...
  /**
    ...
    */
  var method: hapiLib.hapiMod.UtilNs.HTTP_METHODS_PARTIAL | (js.Array[hapiLib.hapiMod.UtilNs.HTTP_METHODS_PARTIAL | java.lang.String]) | java.lang.String
  /**
...
object ServerRoute {
  @scala.inline
  def apply(
    method: hapiLib.hapiMod.UtilNs.HTTP_METHODS_PARTIAL | (js.Array[hapiLib.hapiMod.UtilNs.HTTP_METHODS_PARTIAL | java.lang.String]) | java.lang.String,
