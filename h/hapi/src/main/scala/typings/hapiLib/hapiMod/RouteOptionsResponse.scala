...
trait RouteOptionsResponse extends js.Object {
  /**
    ...
    */
  var emptyStatusCode: js.UndefOr[hapiLib.hapiLibNumbers.`200` | hapiLib.hapiLibNumbers.`204`] = js.undefined
  /**
  ...
  /**
    ...
    */
  var options: js.UndefOr[joiLib.joiMod.ValidationOptions] = js.undefined
