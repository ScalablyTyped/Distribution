...
trait RouteOptionsAccess extends js.Object {
  ...
  /**
    ...
    */
  var mode: js.UndefOr[
    hapiLib.hapiLibStrings.required | hapiLib.hapiLibStrings.optional | hapiLib.hapiLibStrings.`try`
  ] = js.undefined
  /**
  ...
  var payload: js.UndefOr[
    hapiLib.hapiLibNumbers.`false` | hapiLib.hapiLibStrings.required | hapiLib.hapiLibStrings.optional
  ] = js.undefined
  /**
