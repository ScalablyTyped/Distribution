...
trait AnonAllowfrom extends js.Object {
  /**
...
object AnonAllowfrom {
  @scala.inline
  def apply(rule: deny | sameorigin | `allow-from`, source: String): AnonAllowfrom = {
    val __obj = js.Dynamic.literal(rule = rule.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[AnonAllowfrom]
  }
}
