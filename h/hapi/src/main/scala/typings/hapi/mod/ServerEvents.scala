...
import typings.hapi.hapiStrings.log
import typings.hapi.hapiStrings.request
import typings.hapi.hapiStrings.response
import typings.hapi.hapiStrings.route
import typings.hapi.hapiStrings.start
import typings.hapi.hapiStrings.stop
