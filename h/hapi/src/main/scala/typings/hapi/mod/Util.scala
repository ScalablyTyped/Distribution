...
import typings.hapi.hapiStrings.head_
...
object Util {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.hapi.hapiStrings.head_
  ...
  */
  ...
  object HTTP_METHODS {
    ...
    @scala.inline
    def HEAD: typings.hapi.hapiStrings.HEAD = "HEAD".asInstanceOf[typings.hapi.hapiStrings.HEAD]
