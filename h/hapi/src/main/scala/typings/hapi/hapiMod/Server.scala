...
import typings.catbox.catboxMod.Policy
import typings.hapi.Anon_Apply
import typings.hapi.Anon_ApplyExtend
import typings.hapi.Anon_ApplyExtendTrue
import typings.hapi.Anon_ApplyExtendTrueBoolean
import typings.hapi.Anon_ConcurrentEventLoopDelay
import typings.hapi.Anon_Method
...
class Server () extends js.Object {
  ...
  /**
    ...
    */
  val decorations: Anon_Request = js.native
  /**
  ...
  /**
    ...
    */
  def decoder(encoding: String, decoder: js.Function1[/* options */ PayloadCompressionDecoderSettings, Gunzip]): Unit = js.native
  /**
  ...
  @JSName("decorate")
  def decorate_handler(`type`: handler, property: DecorateName, method: HandlerDecorationMethod, options: Anon_Apply): Unit = js.native
  @JSName("decorate")
  ...
  def decorate_request(
    ...
    options: Anon_ApplyExtendTrue
  ): Unit = js.native
  @JSName("decorate")
  def decorate_request(`type`: request, property: DecorateName, method: DecorationMethod[Request]): Unit = js.native
  @JSName("decorate")
  def decorate_request(`type`: request, property: DecorateName, method: DecorationMethod[Request], options: Anon_Apply): Unit = js.native
  @JSName("decorate")
  def decorate_server(
    `type`: server,
    property: DecorateName,
    method: js.Function1[/* existing */ js.Function1[/* repeated */ js.Any, _], DecorationMethod[this.type]],
    options: Anon_ApplyExtendTrueBoolean
  ): Unit = js.native
  @JSName("decorate")
  def decorate_server(`type`: server, property: DecorateName, method: DecorationMethod[Server]): Unit = js.native
  @JSName("decorate")
  def decorate_server(`type`: server, property: DecorateName, method: DecorationMethod[Server], options: Anon_Apply): Unit = js.native
  @JSName("decorate")
  ...
  /**
    ...
    */
  def encoder(encoding: String, encoder: js.Function1[/* options */ RouteCompressionEncoderSettings, Gzip]): Unit = js.native
  ...
  /**
    ...
    */
  def rules(processor: js.Function2[/* rules */ js.Object, /* info */ Anon_Method, js.Object]): Unit = js.native
  def rules(
    processor: js.Function2[/* rules */ js.Object, /* info */ Anon_Method, js.Object],
    options: Anon_Validate
  ): Unit = js.native
  ...
  def stop(options: Anon_Timeout): js.Promise[Unit] = js.native
  /**
