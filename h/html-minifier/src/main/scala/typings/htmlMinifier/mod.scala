...
object mod {
  ...
  object Options {
    ...
    implicit open class MutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      inline def setMinifyCSS(value: Boolean | typings.cleanCss.mod.Options | (js.Function1[/* text */ String, String])): Self = StObject.set(x, "minifyCSS", value.asInstanceOf[js.Any])
      ...
      inline def setMinifyURLs(value: Boolean | typings.relateurl.mod.Options | (js.Function1[/* text */ String, String])): Self = StObject.set(x, "minifyURLs", value.asInstanceOf[js.Any])
