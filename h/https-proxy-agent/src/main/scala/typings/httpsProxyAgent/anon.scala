...
import typings.httpsProxyAgent.distParseProxyResponseMod.ConnectResponse
...
object anon {
  ...
  trait Buffered extends StObject {
    ...
    var connect: ConnectResponse
  }
  object Buffered {
    
    inline def apply(buffered: Buffer, connect: ConnectResponse): Buffered = {
      val __obj = js.Dynamic.literal(buffered = buffered.asInstanceOf[js.Any], connect = connect.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: Buffered] (val x: Self) extends AnyVal {
      ...
      inline def setConnect(value: ConnectResponse): Self = StObject.set(x, "connect", value.asInstanceOf[js.Any])
    }
  }
