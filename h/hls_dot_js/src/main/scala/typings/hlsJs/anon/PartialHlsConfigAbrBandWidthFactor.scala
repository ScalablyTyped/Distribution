...
trait PartialHlsConfigAbrBandWidthFactor extends StObject {
...
object PartialHlsConfigAbrBandWidthFactor {
  
  inline def apply(): PartialHlsConfigAbrBandWidthFactor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialHlsConfigAbrBandWidthFactor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialHlsConfigAbrBandWidthFactor] (val x: Self) extends AnyVal {
    ...
    inline def setLicenseResponseCallback(
      value: js.ThisFunction3[
          PartialHlsConfigAbrBandWidthFactor, 
          /* xhr */ XMLHttpRequest, 
          /* url */ String, 
          /* keyContext */ MediaKeySessionContext, 
          js.typedarray.ArrayBuffer
