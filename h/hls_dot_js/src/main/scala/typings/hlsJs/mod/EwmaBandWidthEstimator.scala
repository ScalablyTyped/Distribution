...
object EwmaBandWidthEstimator {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(canEstimate = js.Any.fromFunction0(canEstimate), defaultEstimate_ = defaultEstimate_.asInstanceOf[js.Any], destroy = js.Any.fromFunction0(destroy), fast_ = fast_.asInstanceOf[js.Any], getEstimate = js.Any.fromFunction0(getEstimate), minDelayMs_ = minDelayMs_.asInstanceOf[js.Any], minWeight_ = minWeight_.asInstanceOf[js.Any], sample = js.Any.fromFunction2(sample), slow_ = slow_.asInstanceOf[js.Any], update = js.Any.fromFunction2(update))
