...
object errorData {
  ...
  inline def apply(details: String, fatal: Boolean, `type`: String): errorData = {
  ...
  extension [Self <: errorData](x: Self) {
    ...
    inline def setContext(value: LoaderContext): Self = StObject.set(x, "context", value.asInstanceOf[js.Any])
    ...
    inline def setNetworkDetails(value: XMLHttpRequest): Self = StObject.set(x, "networkDetails", value.asInstanceOf[js.Any])
    
    inline def setNetworkDetailsUndefined: Self = StObject.set(x, "networkDetails", js.undefined)
    
    inline def setResponse(value: LoaderError): Self = StObject.set(x, "response", value.asInstanceOf[js.Any])
