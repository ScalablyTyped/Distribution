...
object Anon_AUDIOTRACKLOADED {
  ...
  def apply(
    ...
    __obj.updateDynamic("AUDIO_TRACKS_UPDATED")(AUDIO_TRACKS_UPDATED)
    __obj.updateDynamic("AUDIO_TRACK_LOADED")(AUDIO_TRACK_LOADED)
    __obj.updateDynamic("AUDIO_TRACK_LOADING")(AUDIO_TRACK_LOADING)
    __obj.updateDynamic("AUDIO_TRACK_SWITCH")(AUDIO_TRACK_SWITCH)
    __obj.updateDynamic("AUDIO_TRACK_SWITCHED")(AUDIO_TRACK_SWITCHED)
    __obj.updateDynamic("AUDIO_TRACK_SWITCHING")(AUDIO_TRACK_SWITCHING)
    __obj.updateDynamic("BUFFER_APPENDED")(BUFFER_APPENDED)
    __obj.updateDynamic("BUFFER_APPENDING")(BUFFER_APPENDING)
    __obj.updateDynamic("BUFFER_CODECS")(BUFFER_CODECS)
    __obj.updateDynamic("BUFFER_CREATED")(BUFFER_CREATED)
    __obj.updateDynamic("BUFFER_EOS")(BUFFER_EOS)
    __obj.updateDynamic("BUFFER_FLUSHED")(BUFFER_FLUSHED)
    __obj.updateDynamic("BUFFER_FLUSHING")(BUFFER_FLUSHING)
    __obj.updateDynamic("BUFFER_RESET")(BUFFER_RESET)
    __obj.updateDynamic("DESTROYING")(DESTROYING)
    __obj.updateDynamic("ERROR")(ERROR)
    __obj.updateDynamic("FPS_DROP")(FPS_DROP)
    __obj.updateDynamic("FPS_DROP_LEVEL_CAPPING")(FPS_DROP_LEVEL_CAPPING)
    __obj.updateDynamic("FRAG_BUFFERED")(FRAG_BUFFERED)
    __obj.updateDynamic("FRAG_CHANGED")(FRAG_CHANGED)
    __obj.updateDynamic("FRAG_DECRYPTED")(FRAG_DECRYPTED)
    __obj.updateDynamic("FRAG_LOADED")(FRAG_LOADED)
    __obj.updateDynamic("FRAG_LOADING")(FRAG_LOADING)
    __obj.updateDynamic("FRAG_LOAD_EMERGENCY_ABORTED")(FRAG_LOAD_EMERGENCY_ABORTED)
    __obj.updateDynamic("FRAG_LOAD_PROGRESS")(FRAG_LOAD_PROGRESS)
    __obj.updateDynamic("FRAG_PARSED")(FRAG_PARSED)
    __obj.updateDynamic("FRAG_PARSING_DATA")(FRAG_PARSING_DATA)
    __obj.updateDynamic("FRAG_PARSING_INIT_SEGMENT")(FRAG_PARSING_INIT_SEGMENT)
    __obj.updateDynamic("FRAG_PARSING_METADATA")(FRAG_PARSING_METADATA)
    __obj.updateDynamic("FRAG_PARSING_USERDATA")(FRAG_PARSING_USERDATA)
    __obj.updateDynamic("INIT_PTS_FOUND")(INIT_PTS_FOUND)
    __obj.updateDynamic("KEY_LOADED")(KEY_LOADED)
    __obj.updateDynamic("KEY_LOADING")(KEY_LOADING)
    __obj.updateDynamic("LEVEL_LOADED")(LEVEL_LOADED)
    __obj.updateDynamic("LEVEL_LOADING")(LEVEL_LOADING)
    __obj.updateDynamic("LEVEL_PTS_UPDATED")(LEVEL_PTS_UPDATED)
    __obj.updateDynamic("LEVEL_SWITCHED")(LEVEL_SWITCHED)
    __obj.updateDynamic("LEVEL_SWITCHING")(LEVEL_SWITCHING)
    __obj.updateDynamic("LEVEL_UPDATED")(LEVEL_UPDATED)
    __obj.updateDynamic("MANIFEST_LOADED")(MANIFEST_LOADED)
    __obj.updateDynamic("MANIFEST_LOADING")(MANIFEST_LOADING)
    __obj.updateDynamic("MANIFEST_PARSED")(MANIFEST_PARSED)
    __obj.updateDynamic("MEDIA_ATTACHED")(MEDIA_ATTACHED)
    __obj.updateDynamic("MEDIA_ATTACHING")(MEDIA_ATTACHING)
    __obj.updateDynamic("MEDIA_DETACHED")(MEDIA_DETACHED)
    __obj.updateDynamic("MEDIA_DETACHING")(MEDIA_DETACHING)
    __obj.updateDynamic("STREAM_STATE_TRANSITION")(STREAM_STATE_TRANSITION)
    __obj.updateDynamic("SUBTITLE_FRAG_PROCESSED")(SUBTITLE_FRAG_PROCESSED)
    __obj.updateDynamic("SUBTITLE_TRACKS_UPDATED")(SUBTITLE_TRACKS_UPDATED)
    __obj.updateDynamic("SUBTITLE_TRACK_LOADED")(SUBTITLE_TRACK_LOADED)
    __obj.updateDynamic("SUBTITLE_TRACK_LOADING")(SUBTITLE_TRACK_LOADING)
    __obj.updateDynamic("SUBTITLE_TRACK_SWITCH")(SUBTITLE_TRACK_SWITCH)
