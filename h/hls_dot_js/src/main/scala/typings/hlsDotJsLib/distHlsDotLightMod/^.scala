...
/**
  ...
  */
class ^ ()
  extends hlsDotJsLib.hlsDotJsMod.^ {
  def this(config: stdLib.Partial[hlsDotJsLib.hlsDotJsMod.Config]) = this()
}
...
object ^ extends js.Object {
  /**
    ...
    */
  var DefaultConfig: hlsDotJsLib.hlsDotJsMod.Config = js.native
  /**
    * Hls error details
    */
