...
object Anon_AUDIOTRACKLOADERROR {
  ...
  def apply(
    ...
    __obj.updateDynamic("AUDIO_TRACK_LOAD_ERROR")(AUDIO_TRACK_LOAD_ERROR)
    __obj.updateDynamic("AUDIO_TRACK_LOAD_TIMEOUT")(AUDIO_TRACK_LOAD_TIMEOUT)
    __obj.updateDynamic("BUFFER_ADD_CODEC_ERROR")(BUFFER_ADD_CODEC_ERROR)
    __obj.updateDynamic("BUFFER_APPENDING_ERROR")(BUFFER_APPENDING_ERROR)
    __obj.updateDynamic("BUFFER_APPEND_ERROR")(BUFFER_APPEND_ERROR)
    __obj.updateDynamic("BUFFER_FULL_ERROR")(BUFFER_FULL_ERROR)
    __obj.updateDynamic("BUFFER_NUDGE_ON_STALL")(BUFFER_NUDGE_ON_STALL)
    __obj.updateDynamic("BUFFER_SEEK_OVER_HOLE")(BUFFER_SEEK_OVER_HOLE)
    __obj.updateDynamic("BUFFER_STALLED_ERROR")(BUFFER_STALLED_ERROR)
    __obj.updateDynamic("FRAG_DECRYPT_ERROR")(FRAG_DECRYPT_ERROR)
    __obj.updateDynamic("FRAG_LOAD_ERROR")(FRAG_LOAD_ERROR)
    __obj.updateDynamic("FRAG_LOAD_TIMEOUT")(FRAG_LOAD_TIMEOUT)
    __obj.updateDynamic("FRAG_LOOP_LOADING_ERROR")(FRAG_LOOP_LOADING_ERROR)
    __obj.updateDynamic("FRAG_PARSING_ERROR")(FRAG_PARSING_ERROR)
    __obj.updateDynamic("INTERNAL_EXCEPTION")(INTERNAL_EXCEPTION)
    __obj.updateDynamic("KEY_LOAD_ERROR")(KEY_LOAD_ERROR)
    __obj.updateDynamic("KEY_LOAD_TIMEOUT")(KEY_LOAD_TIMEOUT)
    __obj.updateDynamic("LEVEL_LOAD_ERROR")(LEVEL_LOAD_ERROR)
    __obj.updateDynamic("LEVEL_LOAD_TIMEOUT")(LEVEL_LOAD_TIMEOUT)
    __obj.updateDynamic("LEVEL_SWITCH_ERROR")(LEVEL_SWITCH_ERROR)
    __obj.updateDynamic("MANIFEST_INCOMPATIBLE_CODECS_ERROR")(MANIFEST_INCOMPATIBLE_CODECS_ERROR)
    __obj.updateDynamic("MANIFEST_LOAD_ERROR")(MANIFEST_LOAD_ERROR)
    __obj.updateDynamic("MANIFEST_LOAD_TIMEOUT")(MANIFEST_LOAD_TIMEOUT)
    __obj.updateDynamic("MANIFEST_PARSING_ERROR")(MANIFEST_PARSING_ERROR)
    __obj.updateDynamic("REMUX_ALLOC_ERROR")(REMUX_ALLOC_ERROR)
