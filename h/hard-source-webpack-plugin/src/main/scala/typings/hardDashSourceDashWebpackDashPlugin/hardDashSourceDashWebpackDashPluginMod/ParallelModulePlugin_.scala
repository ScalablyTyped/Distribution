...
@js.native
class ParallelModulePlugin_ protected () extends js.Object {
  def this(options: typings.hardDashSourceDashWebpackDashPlugin.hardDashSourceDashWebpackDashPluginMod.ParallelModulePlugin.Options) = this()
  @JSName("apply")
