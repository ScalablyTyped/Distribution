...
import typings.hardDashSourceDashWebpackDashPlugin.hardDashSourceDashWebpackDashPluginMod.ExcludeModulePluginNs.Option
...
@js.native
class ExcludeModulePlugin protected () extends js.Object {
