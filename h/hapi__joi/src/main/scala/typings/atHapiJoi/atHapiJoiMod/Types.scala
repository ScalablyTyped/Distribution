...
/* Rewritten from type alias, can be one of: 
  - typings.atHapiJoi.atHapiJoiStrings.any
  - typings.atHapiJoi.atHapiJoiStrings.alternatives
  - typings.atHapiJoi.atHapiJoiStrings.array
  - typings.atHapiJoi.atHapiJoiStrings.boolean
