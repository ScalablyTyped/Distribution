...
import typings.atHapiJoi.Anon_Alternatives
...
trait Root extends js.Object {
  var ValidationError: typings.atHapiJoi.atHapiJoiMod.ValidationError = js.native
  ...
  /**
    ...
    */
  def types(): Anon_Alternatives = js.native
