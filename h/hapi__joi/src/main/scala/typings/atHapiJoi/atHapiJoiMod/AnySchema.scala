...
import typings.atHapiJoi.Anon_Override
import typings.atHapiJoi.atHapiJoiStrings.map
import typings.atHapiJoi.atHapiJoiStrings.number
import typings.atHapiJoi.atHapiJoiStrings.set
...
trait AnySchema
  ...
  def example(value: js.Any, options: Anon_Override): this.type = js.native
  /**
