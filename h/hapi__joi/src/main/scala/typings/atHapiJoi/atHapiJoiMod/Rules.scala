...
trait Rules[P /* <: js.Object */] extends js.Object {
  ...
  {[ key in keyof P ]: @hapi/joi.@hapi/joi.SchemaLike}
    */ typings.atHapiJoi.atHapiJoiStrings.Rules with js.Any)
  ] = js.undefined
...
object Rules {
  ...
  {[ key in keyof P ]: @hapi/joi.@hapi/joi.SchemaLike}
    */ typings.atHapiJoi.atHapiJoiStrings.Rules with js.Any) = null,
