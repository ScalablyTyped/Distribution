...
trait ValidationOptions extends js.Object {
  ...
  var presence: js.UndefOr[
    atHapiJoiLib.atHapiJoiLibStrings.optional | atHapiJoiLib.atHapiJoiLibStrings.required | atHapiJoiLib.atHapiJoiLibStrings.forbidden
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var stripUnknown: js.UndefOr[scala.Boolean | atHapiJoiLib.Anon_Arrays] = js.undefined
}
...
object ValidationOptions {
  ...
  def apply(
    ...
    presence: atHapiJoiLib.atHapiJoiLibStrings.optional | atHapiJoiLib.atHapiJoiLibStrings.required | atHapiJoiLib.atHapiJoiLibStrings.forbidden = null,
    skipFunctions: js.UndefOr[scala.Boolean] = js.undefined,
    stripUnknown: scala.Boolean | atHapiJoiLib.Anon_Arrays = null
  ): ValidationOptions = {
