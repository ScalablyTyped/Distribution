...
package object atHapiJoiMod {
  ...
  type ExtensionBoundSchema = Schema with atHapiJoiLib.Anon_Context
  ...
  type LanguageRootOptions = atHapiJoiLib.Anon_Key with (stdLib.Partial[stdLib.Record[Types, LanguageOptions]])
