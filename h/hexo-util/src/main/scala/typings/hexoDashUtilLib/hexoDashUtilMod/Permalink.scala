...
class Permalink protected () extends js.Object {
  ...
  def parse(str: java.lang.String): js.UndefOr[ScalablyTyped.runtime.StringDictionary[_]] = js.native
  def stringify(data: ScalablyTyped.runtime.StringDictionary[java.lang.String]): java.lang.String = js.native
