...
object floatMod {
  ...
  @JSImport("html2canvas/dist/types/css/property-descriptors/float", "float")
  @js.native
  val float: IPropertyIdentValueDescriptor[FLOAT_] = js.native
  ...
  */
  trait FLOAT_ extends StObject
  object FLOAT_ {
    
    inline def INLINE_END: `4` = 4.asInstanceOf[`4`]
    
    inline def INLINE_START: `3` = 3.asInstanceOf[`3`]
