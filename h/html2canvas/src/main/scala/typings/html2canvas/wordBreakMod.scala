...
object wordBreakMod {
  ...
  object WORD_BREAK extends StObject {
    ...
    sealed trait BREAK_ALL
      extends StObject
         with WORD_BREAK
    /* "break-all" */ val BREAK_ALL: typings.html2canvas.wordBreakMod.WORD_BREAK.BREAK_ALL & String = js.native
    
    @js.native
    sealed trait KEEP_ALL
      extends StObject
         with WORD_BREAK
    /* "keep-all" */ val KEEP_ALL: typings.html2canvas.wordBreakMod.WORD_BREAK.KEEP_ALL & String = js.native
    
    @js.native
    sealed trait NORMAL
      extends StObject
         with WORD_BREAK
    /* "normal" */ val NORMAL: typings.html2canvas.wordBreakMod.WORD_BREAK.NORMAL & String = js.native
  }
