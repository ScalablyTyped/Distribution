...
object distTypesCssIpropertydescriptorMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyValueDescriptor[T]
    - typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyListDescriptor[T]
    - typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyIdentValueDescriptor[T]
    - typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyTypeValueDescriptor
    - typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyTokenValueDescriptor
  */
  trait CSSPropertyDescriptor[T] extends StObject
  object CSSPropertyDescriptor {
    
    inline def IPropertyIdentValueDescriptor[T](initialValue: String, name: String, parse: (Context, String) => T, prefix: Boolean): typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyIdentValueDescriptor[T] = {
      ...
      __obj.asInstanceOf[typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyIdentValueDescriptor[T]]
    }
    
    inline def IPropertyListDescriptor[T](initialValue: String, name: String, parse: (Context, js.Array[CSSValue]) => T, prefix: Boolean): typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyListDescriptor[T] = {
      val __obj = js.Dynamic.literal(initialValue = initialValue.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], parse = js.Any.fromFunction2(parse), prefix = prefix.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(1)
      __obj.asInstanceOf[typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyListDescriptor[T]]
    }
    
    inline def IPropertyTokenValueDescriptor(initialValue: String, name: String, prefix: Boolean): typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyTokenValueDescriptor = {
      ...
      __obj.asInstanceOf[typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyTokenValueDescriptor]
    }
    
    inline def IPropertyTypeValueDescriptor(format: CSSTypes, initialValue: String, name: String, prefix: Boolean): typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyTypeValueDescriptor = {
      ...
      __obj.asInstanceOf[typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyTypeValueDescriptor]
    }
    
    inline def IPropertyValueDescriptor[T](initialValue: String, name: String, parse: (Context, CSSValue) => T, prefix: Boolean): typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyValueDescriptor[T] = {
      val __obj = js.Dynamic.literal(initialValue = initialValue.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], parse = js.Any.fromFunction2(parse), prefix = prefix.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(0)
      __obj.asInstanceOf[typings.html2canvas.distTypesCssIpropertydescriptorMod.IPropertyValueDescriptor[T]]
    }
  }
