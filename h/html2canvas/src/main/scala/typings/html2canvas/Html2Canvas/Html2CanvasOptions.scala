...
object Html2CanvasOptions {
  ...
  def apply(
    ...
    imageTimeout: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(allowTaint)) __obj.updateDynamic("allowTaint")(allowTaint.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(foreignObjectRendering)) __obj.updateDynamic("foreignObjectRendering")(foreignObjectRendering.get.asInstanceOf[js.Any])
    if (!js.isUndefined(height)) __obj.updateDynamic("height")(height.get.asInstanceOf[js.Any])
    if (ignoreElements != null) __obj.updateDynamic("ignoreElements")(js.Any.fromFunction1(ignoreElements))
    if (!js.isUndefined(imageTimeout)) __obj.updateDynamic("imageTimeout")(imageTimeout.get.asInstanceOf[js.Any])
    if (!js.isUndefined(letterRendering)) __obj.updateDynamic("letterRendering")(letterRendering.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(removeContainer)) __obj.updateDynamic("removeContainer")(removeContainer.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(svgRendering)) __obj.updateDynamic("svgRendering")(svgRendering.get.asInstanceOf[js.Any])
    if (!js.isUndefined(taintTest)) __obj.updateDynamic("taintTest")(taintTest.get.asInstanceOf[js.Any])
