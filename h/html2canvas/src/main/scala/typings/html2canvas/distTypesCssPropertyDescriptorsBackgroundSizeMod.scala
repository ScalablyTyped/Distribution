...
object distTypesCssPropertyDescriptorsBackgroundSizeMod {
  ...
  object BACKGROUND_SIZE extends StObject {
    ...
    /* "auto" */ val AUTO: typings.html2canvas.distTypesCssPropertyDescriptorsBackgroundSizeMod.BACKGROUND_SIZE.AUTO & String = js.native
    
    @js.native
    sealed trait CONTAIN
      extends StObject
         with BACKGROUND_SIZE
    /* "contain" */ val CONTAIN: typings.html2canvas.distTypesCssPropertyDescriptorsBackgroundSizeMod.BACKGROUND_SIZE.CONTAIN & String = js.native
    
    @js.native
    sealed trait COVER
      extends StObject
         with BACKGROUND_SIZE
    /* "cover" */ val COVER: typings.html2canvas.distTypesCssPropertyDescriptorsBackgroundSizeMod.BACKGROUND_SIZE.COVER & String = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.html2canvas.distTypesCssTypesLengthPercentageMod.LengthPercentage
