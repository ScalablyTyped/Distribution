...
object distTypesCssSyntaxTokenizerMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.html2canvas.distTypesCssSyntaxTokenizerMod.StringValueToken
    ...
    - typings.html2canvas.distTypesCssSyntaxTokenizerMod.UnicodeRangeToken
    - typings.html2canvas.distTypesCssSyntaxTokenizerMod.HashToken
  */
  trait CSSToken
    extends StObject
       with CSSValue
