...
import typings.html2canvas.distTypesCoreDebuggerMod.DebuggerType
import typings.html2canvas.distTypesCssIpropertydescriptorMod.PropertyDescriptorParsingType
...
import typings.html2canvas.distTypesCssPropertyDescriptorsDisplayMod.DISPLAY__
...
import typings.html2canvas.distTypesCssPropertyDescriptorsPaintOrderMod.PAINT_ORDER_LAYER
...
import typings.html2canvas.distTypesCssPropertyDescriptorsTextDecorationLineMod.TEXT_DECORATION_LINE
...
import typings.html2canvas.distTypesCssSyntaxParserMod.CSSBlockType
import typings.html2canvas.distTypesCssSyntaxTokenizerMod.TokenType
import typings.html2canvas.distTypesCssTypesImageMod.CSSImageType
import typings.html2canvas.distTypesCssTypesImageMod.CSSRadialExtent
import typings.html2canvas.distTypesCssTypesImageMod.CSSRadialShape
import typings.html2canvas.distTypesDomElementContainerMod.FLAGS
import typings.html2canvas.distTypesRenderEffectsMod.EffectTarget
import typings.html2canvas.distTypesRenderEffectsMod.EffectType
import typings.html2canvas.distTypesRenderPathMod.PathType
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object html2canvasInts {
  
  @js.native
  sealed trait `-1`
    extends StObject
       with LIST_STYLE_TYPE
  inline def `-1`: `-1` = -1.asInstanceOf[`-1`]
  
  @js.native
  sealed trait `0`
    extends StObject
       with BACKGROUND_CLIP
       with BACKGROUND_ORIGIN
       with BACKGROUND_REPEAT
       with BORDER_STYLE
       with CSSImageType
       with CSSRadialExtent
       with CSSRadialShape
       with DIRECTION_
       with DISPLAY__
       with DebuggerType
       with EffectType
       with FLOAT_
       with LIST_STYLE_POSITION
       with LIST_STYLE_TYPE
       with OVERFLOW_
       with PAINT_ORDER_LAYER
       with POSITION_
       with PathType
       with PropertyDescriptorParsingType
       with TEXT_ALIGN
       with TEXT_DECORATION_LINE
       with TEXT_TRANSFORM
       with TokenType
       with VISIBILITY_
