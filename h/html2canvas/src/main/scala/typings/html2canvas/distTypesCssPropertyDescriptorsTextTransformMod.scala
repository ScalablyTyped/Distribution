...
object distTypesCssPropertyDescriptorsTextTransformMod {
  
  @JSImport("html2canvas/dist/types/css/property-descriptors/text-transform", "textTransform")
  @js.native
  ...
  */
  ...
  object TEXT_TRANSFORM {
    ...
    inline def CAPITALIZE: `3` = 3.asInstanceOf[`3`]
    
    inline def LOWERCASE: `1` = 1.asInstanceOf[`1`]
    
    inline def NONE: `0` = 0.asInstanceOf[`0`]
    
    inline def UPPERCASE: `2` = 2.asInstanceOf[`2`]
  }
}
