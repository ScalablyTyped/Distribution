...
object distTypesCssPropertyDescriptorsLineBreakMod {
  ...
  object LINE_BREAK extends StObject {
    ...
    sealed trait NORMAL
      extends StObject
         with LINE_BREAK
    /* "normal" */ val NORMAL: typings.html2canvas.distTypesCssPropertyDescriptorsLineBreakMod.LINE_BREAK.NORMAL & String = js.native
    
    @js.native
    sealed trait STRICT
      extends StObject
         with LINE_BREAK
    /* "strict" */ val STRICT: typings.html2canvas.distTypesCssPropertyDescriptorsLineBreakMod.LINE_BREAK.STRICT & String = js.native
  }
