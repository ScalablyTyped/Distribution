...
@js.native
object hycoDashWsModMembers extends js.Object {
  ...
  def createRelayedServer(options: js.Any, fn: js.Function1[/* ws */ wsLib.wsMod.namespaced, scala.Unit]): HybridConnectionWebSocketServer = js.native
  def relayedConnect(address: java.lang.String, fn: js.Function0[scala.Unit]): wsLib.wsMod.namespaced = js.native
}
