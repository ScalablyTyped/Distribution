...
object ^ extends js.Object {
  ...
  def createRelayedServer(options: js.Any, fn: js.Function1[/* ws */ wsLib.wsMod.namespaced, scala.Unit]): hycoDashWsLib.hycoDashWsMod.HybridConnectionWebSocketServer = js.native
