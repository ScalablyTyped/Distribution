...
@js.native
object hexoDashBunyanModMembers extends js.Object {
  ...
  def createLogger(options: bunyanLib.bunyanMod.LoggerNs.LoggerOptions): bunyanLib.bunyanMod.Logger = js.native
