...
/* Rewritten from type alias, can be one of: 
  - typings.hasura.hasuraStrings.asc
  - typings.hasura.hasuraStrings.desc
  - typings.hasura.hasuraStrings.asc_nulls_first
  - typings.hasura.hasuraStrings.asc_nulls_last
  - typings.hasura.hasuraStrings.desc_nulls_first
  - typings.hasura.hasuraStrings.desc_nulls_last
*/
