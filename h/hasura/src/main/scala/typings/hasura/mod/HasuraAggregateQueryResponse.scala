...
object HasuraAggregateQueryResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: HasuraAggregateQueryResponse[?, ?], K /* <: String */, T /* <: Record[String, Any] */] (val x: Self & (HasuraAggregateQueryResponse[K, T])) extends AnyVal {
