...
- atHapiCatboxLib.atHapiCatboxMod.PolicyOptionVariants because Already inherited */ trait DecoratedPolicyOptions[T] extends PolicyOptions[T] {
  /**
    * @default false
    */
...
object DecoratedPolicyOptions {
  ...
  def apply[T](
    ...
    generateTimeout: scala.Double | atHapiCatboxLib.atHapiCatboxLibNumbers.`false` = null,
