package typings.atHapiTopo.atHapiTopoMod

import typings.atHapiTopo.Anon_After
...
trait Topo[TNode, TGroup] extends js.Object {
  ...
  def add(nodes: TNode, options: Anon_After[TGroup]): js.Array[TNode] = js.native
  def add(nodes: js.Array[TNode]): js.Array[TNode] = js.native
  def add(nodes: js.Array[TNode], options: Anon_After[TGroup]): js.Array[TNode] = js.native
