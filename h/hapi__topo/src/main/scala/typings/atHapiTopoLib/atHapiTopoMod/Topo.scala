...
trait Topo[TNode, TGroup] extends js.Object {
  ...
  def add(nodes: TNode, options: atHapiTopoLib.Anon_After[TGroup]): js.Array[TNode] = js.native
  def add(nodes: js.Array[TNode]): js.Array[TNode] = js.native
  def add(nodes: js.Array[TNode], options: atHapiTopoLib.Anon_After[TGroup]): js.Array[TNode] = js.native
  /**
