...
class Server () extends js.Object {
  ...
  /**
    ...
    */
  def addProtoService[ImplementationType](service: ServiceDefinition[ImplementationType], implementation: ImplementationType): scala.Unit = js.native
  /**
    ...
    * for the provided service.
    */
  def addService[ImplementationType](service: ServiceDefinition[ImplementationType], implementation: ImplementationType): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def forceShutdown(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def tryShutdown(callback: js.Function0[scala.Unit]): scala.Unit = js.native
}
