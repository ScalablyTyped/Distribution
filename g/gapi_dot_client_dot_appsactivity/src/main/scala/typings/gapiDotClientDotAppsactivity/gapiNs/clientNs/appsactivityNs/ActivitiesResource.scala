...
import typings.gapiDotClientDotAppsactivity.Anon_Alt
...
trait ActivitiesResource extends js.Object {
  /**
    ...
    */
  def list(request: Anon_Alt): Request[ListActivitiesResponse]
}

object ActivitiesResource {
  @scala.inline
  def apply(list: Anon_Alt => Request[ListActivitiesResponse]): ActivitiesResource = {
