...
trait Anon_Default extends js.Object {
  ...
  def apply(patterns: java.lang.String, options: globbyLib.globbyMod.GlobbyOptions): js.Promise[js.Array[java.lang.String]] = js.native
  def apply(patterns: js.Array[java.lang.String]): js.Promise[js.Array[java.lang.String]] = js.native
  def apply(patterns: js.Array[java.lang.String], options: globbyLib.globbyMod.GlobbyOptions): js.Promise[js.Array[java.lang.String]] = js.native
  /**
  ...
  /**
  	...
  	```
  	*/
  def gitignore(): js.Promise[globbyLib.globbyMod.FilterFunction] = js.native
  def gitignore(options: globbyLib.globbyMod.GitignoreOptions): js.Promise[globbyLib.globbyMod.FilterFunction] = js.native
  /**
