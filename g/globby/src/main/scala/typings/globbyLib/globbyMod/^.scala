...
object ^ extends js.Object {
  ...
  def apply(patterns: java.lang.String | js.Array[java.lang.String], options: globbyLib.globbyMod.Options): js.Promise[js.Array[java.lang.String]] = js.native
  /**
  ...
  def generateGlobTasks(patterns: java.lang.String, options: globbyLib.globbyMod.Options): js.Array[globbyLib.Anon_Options] = js.native
  def generateGlobTasks(patterns: js.Array[java.lang.String]): js.Array[globbyLib.Anon_Options] = js.native
  def generateGlobTasks(patterns: js.Array[java.lang.String], options: globbyLib.globbyMod.Options): js.Array[globbyLib.Anon_Options] = js.native
  /**
  ...
  def sync(patterns: java.lang.String, options: globbyLib.globbyMod.Options): js.Array[java.lang.String] = js.native
  def sync(patterns: js.Array[java.lang.String]): js.Array[java.lang.String] = js.native
  def sync(patterns: js.Array[java.lang.String], options: globbyLib.globbyMod.Options): js.Array[java.lang.String] = js.native
}
