...
trait ObjectTypeDefinitionNode
  ...
  val kind: ObjectTypeDefinition = js.native
...
object ObjectTypeDefinitionNode {
  @scala.inline
  def apply(kind: ObjectTypeDefinition, name: NameNode): ObjectTypeDefinitionNode = {
    val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[ObjectTypeDefinitionNode]
  }
  @scala.inline
  implicit class ObjectTypeDefinitionNodeOps[Self <: ObjectTypeDefinitionNode] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setKind(value: ObjectTypeDefinition): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
