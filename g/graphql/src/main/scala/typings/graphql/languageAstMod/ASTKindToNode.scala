...
object ASTKindToNode {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(Argument = Argument, BooleanValue = BooleanValue, Directive = Directive, DirectiveDefinition = DirectiveDefinition, Document = Document, EnumTypeDefinition = EnumTypeDefinition, EnumTypeExtension = EnumTypeExtension, EnumValue = EnumValue, EnumValueDefinition = EnumValueDefinition, Field = Field, FieldDefinition = FieldDefinition, FloatValue = FloatValue, FragmentDefinition = FragmentDefinition, FragmentSpread = FragmentSpread, InlineFragment = InlineFragment, InputObjectTypeDefinition = InputObjectTypeDefinition, InputObjectTypeExtension = InputObjectTypeExtension, InputValueDefinition = InputValueDefinition, IntValue = IntValue, InterfaceTypeDefinition = InterfaceTypeDefinition, InterfaceTypeExtension = InterfaceTypeExtension, ListType = ListType, ListValue = ListValue, Name = Name, NamedType = NamedType, NonNullType = NonNullType, NullValue = NullValue, ObjectField = ObjectField, ObjectTypeDefinition = ObjectTypeDefinition, ObjectTypeExtension = ObjectTypeExtension, ObjectValue = ObjectValue, OperationDefinition = OperationDefinition, OperationTypeDefinition = OperationTypeDefinition, ScalarTypeDefinition = ScalarTypeDefinition, ScalarTypeExtension = ScalarTypeExtension, SchemaDefinition = SchemaDefinition, SchemaExtension = SchemaExtension, SelectionSet = SelectionSet, StringValue = StringValue, UnionTypeDefinition = UnionTypeDefinition, UnionTypeExtension = UnionTypeExtension, Variable = Variable, VariableDefinition = VariableDefinition)
  
    __obj.asInstanceOf[ASTKindToNode]
  }
}
