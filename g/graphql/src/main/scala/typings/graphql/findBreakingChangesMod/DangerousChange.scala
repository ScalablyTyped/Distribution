...
trait DangerousChange extends js.Object {
  ...
  var `type`: VALUE_ADDED_TO_ENUM | TYPE_ADDED_TO_UNION | OPTIONAL_INPUT_FIELD_ADDED | OPTIONAL_ARG_ADDED | INTERFACE_ADDED_TO_OBJECT | ARG_DEFAULT_VALUE_CHANGE
}
...
object DangerousChange {
  ...
  def apply(
    description: String,
    `type`: VALUE_ADDED_TO_ENUM | TYPE_ADDED_TO_UNION | OPTIONAL_INPUT_FIELD_ADDED | OPTIONAL_ARG_ADDED | INTERFACE_ADDED_TO_OBJECT | ARG_DEFAULT_VALUE_CHANGE
  ): DangerousChange = {
