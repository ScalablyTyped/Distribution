...
@js.native
object graphqlModMembers extends js.Object {
  ...
  val defaultFieldResolver: graphqlLib.typeDefinitionMod.GraphQLFieldResolver[js.Any, js.Any, ScalablyTyped.runtime.StringDictionary[js.Any]] = js.native
  ...
  def graphql[TData](args: graphqlLib.graphqlGraphqlMod.GraphQLArgs): stdLib.Promise[graphqlLib.executionExecuteMod.ExecutionResult[TData]] = js.native
