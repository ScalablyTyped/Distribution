...
class ASTDefinitionBuilder protected () extends js.Object {
  ...
  def buildField(field: graphqlLib.languageAstMod.FieldDefinitionNode): graphqlLib.typeDefinitionMod.GraphQLFieldConfig[_, _, ScalablyTyped.runtime.StringDictionary[_]] = js.native
