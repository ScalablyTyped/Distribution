...
package object typeDefinitionMod {
  ...
  type GraphQLNullableType = GraphQLScalarType | GraphQLObjectType | GraphQLInterfaceType | GraphQLUnionType | GraphQLEnumType | GraphQLInputObjectType | GraphQLList[js.Any]
  type GraphQLOutputType = GraphQLScalarType | GraphQLObjectType | GraphQLInterfaceType | GraphQLUnionType | GraphQLEnumType | GraphQLList[js.Any] | (GraphQLNonNull[
    GraphQLScalarType | GraphQLObjectType | GraphQLInterfaceType | GraphQLUnionType | GraphQLEnumType | GraphQLList[js.Any]
  ])
  ...
  type GraphQLType = GraphQLScalarType | GraphQLObjectType | GraphQLInterfaceType | GraphQLUnionType | GraphQLEnumType | GraphQLInputObjectType | GraphQLList[js.Any] | GraphQLNonNull[js.Any]
  type GraphQLTypeResolver[TSource, TContext] = js.Function3[
    /* value */ TSource, 
    /* context */ TContext, 
    /* info */ GraphQLResolveInfo, 
    graphqlLib.jsutilsMaybePromiseMod.MaybePromise[graphqlLib.tsutilsMaybeMod.Maybe[GraphQLObjectType | java.lang.String]]
  ]
