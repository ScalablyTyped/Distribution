...
import typings.gapiYoutube.AnonChannelIdId
...
trait playlists extends js.Object {
  ...
  /**
    ...
    */
  def list(`object`: AnonChannelIdId): HttpRequest[GoogleApiYouTubePaginationInfo[GoogleApiYouTubePlaylistResource]]
  /**
...
object playlists {
  ...
  def apply(
    ...
    list: AnonChannelIdId => HttpRequest[GoogleApiYouTubePaginationInfo[GoogleApiYouTubePlaylistResource]],
