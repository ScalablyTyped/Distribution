...
trait channels extends js.Object {
  ...
  /**
    ...
    */
  def update(`object`: AnonOnBehalfOfContentOwnerPart): HttpRequest[GoogleApiYouTubeChannelResource]
}
...
object channels {
  ...
  def apply(
    ...
    update: AnonOnBehalfOfContentOwnerPart => HttpRequest[GoogleApiYouTubeChannelResource]
  ): channels = {
