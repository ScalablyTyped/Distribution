...
trait AnonOnBehalfOfContentOwnerPart extends js.Object {
  /**
    * HTTP Request Body
    */
...
object AnonOnBehalfOfContentOwnerPart {
  @scala.inline
  def apply(part: String, RequestBody: String = null, onBehalfOfContentOwner: String = null): AnonOnBehalfOfContentOwnerPart = {
    ...
    __obj.asInstanceOf[AnonOnBehalfOfContentOwnerPart]
  }
}
