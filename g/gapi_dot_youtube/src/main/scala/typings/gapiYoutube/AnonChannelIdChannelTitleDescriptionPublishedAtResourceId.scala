...
trait AnonChannelIdChannelTitleDescriptionPublishedAtResourceId extends js.Object {
  /**
  ...
  /**
    ...
    */
  var resourceId: AnonChannelIdKindString
  /**
...
object AnonChannelIdChannelTitleDescriptionPublishedAtResourceId {
  @scala.inline
  def apply(
    channelId: String,
    channelTitle: String,
    description: String,
    publishedAt: String,
    resourceId: AnonChannelIdKindString,
    thumbnails: GoogleApiYouTubeThumbnailResource,
    title: String
  ): AnonChannelIdChannelTitleDescriptionPublishedAtResourceId = {
    ...
    __obj.asInstanceOf[AnonChannelIdChannelTitleDescriptionPublishedAtResourceId]
  }
}
