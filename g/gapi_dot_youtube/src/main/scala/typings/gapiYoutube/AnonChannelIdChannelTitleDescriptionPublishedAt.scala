...
trait AnonChannelIdChannelTitleDescriptionPublishedAt extends js.Object {
  /**
...
object AnonChannelIdChannelTitleDescriptionPublishedAt {
  @scala.inline
  def apply(
    channelId: String,
    channelTitle: String,
    ...
    title: String
  ): AnonChannelIdChannelTitleDescriptionPublishedAt = {
    ...
    __obj.asInstanceOf[AnonChannelIdChannelTitleDescriptionPublishedAt]
  }
}
