...
trait AnonChannelIdChannelTitleDescriptionPublishedAtThumbnails extends js.Object {
  /**
...
object AnonChannelIdChannelTitleDescriptionPublishedAtThumbnails {
  @scala.inline
  def apply(
    channelId: String,
    channelTitle: String,
    ...
    title: String
  ): AnonChannelIdChannelTitleDescriptionPublishedAtThumbnails = {
    ...
    __obj.asInstanceOf[AnonChannelIdChannelTitleDescriptionPublishedAtThumbnails]
  }
}
