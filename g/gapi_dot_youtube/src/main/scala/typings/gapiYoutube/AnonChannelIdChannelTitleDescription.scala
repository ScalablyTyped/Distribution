...
trait AnonChannelIdChannelTitleDescription extends js.Object {
  /**
...
object AnonChannelIdChannelTitleDescription {
  @scala.inline
  def apply(
    channelId: String,
    channelTitle: String,
    ...
    title: String
  ): AnonChannelIdChannelTitleDescription = {
    ...
    __obj.asInstanceOf[AnonChannelIdChannelTitleDescription]
  }
}
