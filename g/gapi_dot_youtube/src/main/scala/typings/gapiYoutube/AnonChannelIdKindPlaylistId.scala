...
trait AnonChannelIdKindPlaylistId extends js.Object {
  /**
...
object AnonChannelIdKindPlaylistId {
  @scala.inline
  def apply(channelId: String, kind: String, playlistId: String, videoId: String): AnonChannelIdKindPlaylistId = {
    ...
    __obj.asInstanceOf[AnonChannelIdKindPlaylistId]
  }
}
