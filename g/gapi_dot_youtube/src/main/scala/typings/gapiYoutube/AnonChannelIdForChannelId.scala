...
trait AnonChannelIdForChannelId extends js.Object {
  /**
...
object AnonChannelIdForChannelId {
  @scala.inline
  def apply(
    part: String,
    ...
    __obj.asInstanceOf[AnonChannelIdForChannelId]
  }
}
