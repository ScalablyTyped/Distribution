package typings.gapiDotPagespeedonline.gapi.client.pagespeedonline

import typings.gapi.gapi.client.HttpRequest
import typings.gapiDotPagespeedonline.Anon_Fields
import typings.gapiDotPagespeedonline.GoogleApiPageSpeedOnlineResource
