...
trait pagespeedapi extends js.Object {
  /**
    ...
    */
  def runpagespeed(`object`: gapiDotPagespeedonlineLib.Anon_Url): gapiLib.gapiNs.clientNs.HttpRequest[gapiDotPagespeedonlineLib.GoogleApiPageSpeedOnlineResource]
}
