...
object GridPager {
  ...
  extension [Self <: GridPager](x: Self) {
    ...
    inline def setLeftControls(value: js.Array[js.Any]): Self = StObject.set(x, "leftControls", value.asInstanceOf[js.Any])
    
    inline def setLeftControlsUndefined: Self = StObject.set(x, "leftControls", js.undefined)
    
    inline def setLeftControlsVarargs(value: js.Any*): Self = StObject.set(x, "leftControls", js.Array(value :_*))
    
    inline def setLimit(value: Double): Self = StObject.set(x, "limit", value.asInstanceOf[js.Any])
    
    inline def setLimitUndefined: Self = StObject.set(x, "limit", js.undefined)
    
    inline def setRightControls(value: js.Array[js.Any]): Self = StObject.set(x, "rightControls", value.asInstanceOf[js.Any])
    
    inline def setRightControlsUndefined: Self = StObject.set(x, "rightControls", js.undefined)
    
    inline def setRightControlsVarargs(value: js.Any*): Self = StObject.set(x, "rightControls", js.Array(value :_*))
