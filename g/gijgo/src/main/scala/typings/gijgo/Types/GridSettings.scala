...
trait GridSettings[Entity] extends StObject {
  ...
  //Events
  var beforeEmptyRowInsert: js.UndefOr[js.Function2[/* e */ Any, /* $row */ JQuery, Any]] = js.undefined
  ...
  var columnHide: js.UndefOr[js.Function2[/* e */ Any, /* column */ GridColumn, Any]] = js.undefined
  
  var columnReorder: js.UndefOr[Boolean] = js.undefined
  
  var columnShow: js.UndefOr[js.Function2[/* e */ Any, /* column */ GridColumn, Any]] = js.undefined
  
  var columns: js.UndefOr[js.Array[GridColumn]] = js.undefined
  
  var dataBinding: js.UndefOr[js.Function2[/* e */ Any, /* records */ js.Array[Entity], Any]] = js.undefined
  
  var dataBound: js.UndefOr[
    js.Function3[/* e */ Any, /* records */ js.Array[Entity], /* totalRecords */ Double, Any]
  ] = js.undefined
  
  var dataFiltered: js.UndefOr[js.Function2[/* e */ Any, /* records */ js.Array[Entity], Any]] = js.undefined
  ...
  var detailCollapse: js.UndefOr[js.Function3[/* e */ Any, /* detailWrapper */ JQuery, /* id */ String, Any]] = js.undefined
  
  var detailExpand: js.UndefOr[js.Function3[/* e */ Any, /* detailWrapper */ JQuery, /* id */ String, Any]] = js.undefined
  ...
  var pageChanging: js.UndefOr[js.Function2[/* e */ Any, /* newPage */ Double, Any]] = js.undefined
  
  var pageSizeChange: js.UndefOr[js.Function2[/* e */ Any, /* newPage */ Double, Any]] = js.undefined
  ...
  var resize: js.UndefOr[js.Function3[/* e */ Any, /* newWidth */ Double, /* oldWidth */ Double, Any]] = js.undefined
  ...
  var rowDataBound: js.UndefOr[
    js.Function4[/* e */ Any, /* $row */ JQuery, /* id */ String, /* record */ Entity, Any]
  ] = js.undefined
  
  var rowDataChanged: js.UndefOr[js.Function3[/* e */ Any, /* id */ String, /* record */ Entity, Any]] = js.undefined
...
object GridSettings {
  ...
  extension [Self <: GridSettings[?], Entity](x: Self & GridSettings[Entity]) {
    ...
    inline def setBeforeEmptyRowInsert(value: (/* e */ Any, /* $row */ JQuery) => Any): Self = StObject.set(x, "beforeEmptyRowInsert", js.Any.fromFunction2(value))
    ...
    inline def setCellDataBound(
      value: (/* e */ Any, /* $wrapper */ JQuery, /* id */ String, /* column */ GridColumn, /* record */ Entity) => Any
    ...
    inline def setCellDataChanged(
      value: (/* e */ Any, /* $cell */ JQuery, /* column */ GridColumn, /* record */ Entity, /* oldValue */ Any, /* newValue */ Any) => Any
    ...
    inline def setColumnHide(value: (/* e */ Any, /* column */ GridColumn) => Any): Self = StObject.set(x, "columnHide", js.Any.fromFunction2(value))
    ...
    inline def setColumnShow(value: (/* e */ Any, /* column */ GridColumn) => Any): Self = StObject.set(x, "columnShow", js.Any.fromFunction2(value))
    ...
    inline def setDataBinding(value: (/* e */ Any, /* records */ js.Array[Entity]) => Any): Self = StObject.set(x, "dataBinding", js.Any.fromFunction2(value))
    
    inline def setDataBindingUndefined: Self = StObject.set(x, "dataBinding", js.undefined)
    
    inline def setDataBound(value: (/* e */ Any, /* records */ js.Array[Entity], /* totalRecords */ Double) => Any): Self = StObject.set(x, "dataBound", js.Any.fromFunction3(value))
    
    inline def setDataBoundUndefined: Self = StObject.set(x, "dataBound", js.undefined)
    
    inline def setDataFiltered(value: (/* e */ Any, /* records */ js.Array[Entity]) => Any): Self = StObject.set(x, "dataFiltered", js.Any.fromFunction2(value))
    ...
    inline def setDetailCollapse(value: (/* e */ Any, /* detailWrapper */ JQuery, /* id */ String) => Any): Self = StObject.set(x, "detailCollapse", js.Any.fromFunction3(value))
    
    inline def setDetailCollapseUndefined: Self = StObject.set(x, "detailCollapse", js.undefined)
    
    inline def setDetailExpand(value: (/* e */ Any, /* detailWrapper */ JQuery, /* id */ String) => Any): Self = StObject.set(x, "detailExpand", js.Any.fromFunction3(value))
    ...
    inline def setPageChanging(value: (/* e */ Any, /* newPage */ Double) => Any): Self = StObject.set(x, "pageChanging", js.Any.fromFunction2(value))
    
    inline def setPageChangingUndefined: Self = StObject.set(x, "pageChanging", js.undefined)
    
    inline def setPageSizeChange(value: (/* e */ Any, /* newPage */ Double) => Any): Self = StObject.set(x, "pageSizeChange", js.Any.fromFunction2(value))
    ...
    inline def setResize(value: (/* e */ Any, /* newWidth */ Double, /* oldWidth */ Double) => Any): Self = StObject.set(x, "resize", js.Any.fromFunction3(value))
    ...
    inline def setRowDataBound(value: (/* e */ Any, /* $row */ JQuery, /* id */ String, /* record */ Entity) => Any): Self = StObject.set(x, "rowDataBound", js.Any.fromFunction4(value))
    
    inline def setRowDataBoundUndefined: Self = StObject.set(x, "rowDataBound", js.undefined)
    
    inline def setRowDataChanged(value: (/* e */ Any, /* id */ String, /* record */ Entity) => Any): Self = StObject.set(x, "rowDataChanged", js.Any.fromFunction3(value))
    
    inline def setRowDataChangedUndefined: Self = StObject.set(x, "rowDataChanged", js.undefined)
    
    inline def setRowRemoving(value: (/* e */ Any, /* $row */ JQuery, /* id */ String, /* record */ Entity) => Any): Self = StObject.set(x, "rowRemoving", js.Any.fromFunction4(value))
    ...
    inline def setRowSelect(value: (/* e */ Any, /* $row */ JQuery, /* id */ String, /* record */ Entity) => Any): Self = StObject.set(x, "rowSelect", js.Any.fromFunction4(value))
    
    inline def setRowSelectUndefined: Self = StObject.set(x, "rowSelect", js.undefined)
    
    inline def setRowUnselect(value: (/* e */ Any, /* $row */ JQuery, /* id */ String, /* record */ Entity) => Any): Self = StObject.set(x, "rowUnselect", js.Any.fromFunction4(value))
