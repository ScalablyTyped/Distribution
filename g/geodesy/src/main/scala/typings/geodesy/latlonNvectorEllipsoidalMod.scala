...
object latlonNvectorEllipsoidalMod {
  ...
  object Ned {
    ...
    /* static member */
    @scala.inline
    def fromDistanceBearingElevation(dist: Double, brng: Double, elev: Double): Ned = (^.asInstanceOf[js.Dynamic].applyDynamic("fromDistanceBearingElevation")(dist.asInstanceOf[js.Any], brng.asInstanceOf[js.Any], elev.asInstanceOf[js.Any])).asInstanceOf[Ned]
  }
