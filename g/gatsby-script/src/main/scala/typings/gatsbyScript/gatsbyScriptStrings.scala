...
object gatsbyScriptStrings {
  ...
  @js.native
  sealed trait `off-main-thread` extends StObject
  inline def `off-main-thread`: `off-main-thread` = "off-main-thread".asInstanceOf[`off-main-thread`]
  ...
  @js.native
  sealed trait `post-hydrate` extends StObject
  inline def `post-hydrate`: `post-hydrate` = "post-hydrate".asInstanceOf[`post-hydrate`]
