...
trait HoldsResource extends js.Object {
  ...
  def create(request: gapiDotClientDotVaultLib.Anon_AccesstokenPrettyPrintBearertoken): gapiDotClientLib.gapiNs.clientNs.Request[Hold]
  /** Removes a hold by ID. This will release any HeldAccounts on this Hold. */
  def delete(request: gapiDotClientDotVaultLib.Anon_AccesstokenPrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[js.Object]
  /** Gets a hold by ID. */
