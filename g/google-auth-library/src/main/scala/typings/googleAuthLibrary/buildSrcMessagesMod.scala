...
object buildSrcMessagesMod {
  ...
  object WarningTypes extends StObject {
    ...
    sealed trait DEPRECATION
      extends StObject
         with WarningTypes
    /* "DeprecationWarning" */ val DEPRECATION: typings.googleAuthLibrary.buildSrcMessagesMod.WarningTypes.DEPRECATION & String = js.native
    
    @js.native
    sealed trait WARNING
      extends StObject
         with WarningTypes
    /* "Warning" */ val WARNING: typings.googleAuthLibrary.buildSrcMessagesMod.WarningTypes.WARNING & String = js.native
  }
