...
import typings.googleAuthLibrary.credentialsMod.ImpersonatedJWTInput
...
import typings.googleAuthLibrary.impersonatedMod.Impersonated
...
object googleauthMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.googleAuthLibrary.jwtclientMod.JWT
    - typings.googleAuthLibrary.refreshclientMod.UserRefreshClient
    - typings.googleAuthLibrary.baseexternalclientMod.BaseExternalAccountClient
    - typings.googleAuthLibrary.impersonatedMod.Impersonated
  */
