...
object externalclientMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.googleAuthLibrary.identitypoolclientMod.IdentityPoolClientOptions
    - typings.googleAuthLibrary.awsclientMod.AwsClientOptions
    - typings.googleAuthLibrary.pluggableAuthClientMod.PluggableAuthClientOptions
  */
  ...
  object ExternalAccountClientOptions {
    ...
    inline def AwsClientOptions(
      ...
      __obj.asInstanceOf[typings.googleAuthLibrary.awsclientMod.AwsClientOptions]
    }
    ...
    inline def IdentityPoolClientOptions(
      ...
      val __obj = js.Dynamic.literal(audience = audience.asInstanceOf[js.Any], credential_source = credential_source.asInstanceOf[js.Any], subject_token_type = subject_token_type.asInstanceOf[js.Any], token_url = token_url.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.googleAuthLibrary.identitypoolclientMod.IdentityPoolClientOptions]
    }
    ...
    inline def PluggableAuthClientOptions(
      ...
      val __obj = js.Dynamic.literal(audience = audience.asInstanceOf[js.Any], credential_source = credential_source.asInstanceOf[js.Any], subject_token_type = subject_token_type.asInstanceOf[js.Any], token_url = token_url.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.googleAuthLibrary.pluggableAuthClientMod.PluggableAuthClientOptions]
    }
  }
}
