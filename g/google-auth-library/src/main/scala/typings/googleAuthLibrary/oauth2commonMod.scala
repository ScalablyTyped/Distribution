...
object oauth2commonMod {
  
  @JSImport("google-auth-library/build/src/auth/oauth2common", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("google-auth-library/build/src/auth/oauth2common", "OAuthClientAuthHandler")
  @js.native
  /**
    * Instantiates an OAuth client authentication handler.
    * @param clientAuthentication The client auth credentials.
    */
  abstract class OAuthClientAuthHandler () extends StObject {
