...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.googleAdwordsScripts.googleAdwordsScriptsStrings.DYNAMIC_IMAGE
  - typings.googleAdwordsScripts.googleAdwordsScriptsStrings.ICON
  - typings.googleAdwordsScripts.googleAdwordsScriptsStrings.IMAGE
  - typings.googleAdwordsScripts.googleAdwordsScriptsStrings.STANDARD_ICON
