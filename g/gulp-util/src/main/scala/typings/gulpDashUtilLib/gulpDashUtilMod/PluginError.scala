...
/* RemoveMultipleInheritance: Dropped parents List(gulpDashUtilLib.gulpDashUtilMod.PluginErrorOptions because Would inherit conflicting mutable fields List(stack))*/
@JSImport("gulp-util", "PluginError")
@js.native
class PluginError ()
