...
trait AnonAltConsistencyTokenFieldsIncludeMatchData extends js.Object {
...
object AnonAltConsistencyTokenFieldsIncludeMatchData {
  @scala.inline
  def apply(
    matchId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsIncludeMatchData = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsIncludeMatchData]
  }
}
