...
trait AnonAltConsistencyTokenFieldsKeyLanguageMatchIdOauthtoken extends js.Object {
...
object AnonAltConsistencyTokenFieldsKeyLanguageMatchIdOauthtoken {
  @scala.inline
  def apply(
    matchId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsKeyLanguageMatchIdOauthtoken = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsKeyLanguageMatchIdOauthtoken]
  }
}
