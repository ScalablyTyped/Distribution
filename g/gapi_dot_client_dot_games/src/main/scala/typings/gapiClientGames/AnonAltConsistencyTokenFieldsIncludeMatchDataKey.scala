...
trait AnonAltConsistencyTokenFieldsIncludeMatchDataKey extends js.Object {
...
object AnonAltConsistencyTokenFieldsIncludeMatchDataKey {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsIncludeMatchDataKey = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsIncludeMatchDataKey]
  }
}
