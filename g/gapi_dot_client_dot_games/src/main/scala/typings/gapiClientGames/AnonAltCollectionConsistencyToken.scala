...
trait AnonAltCollectionConsistencyToken extends js.Object {
...
object AnonAltCollectionConsistencyToken {
  @scala.inline
  def apply(
    collection: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltCollectionConsistencyToken = {
    ...
    __obj.asInstanceOf[AnonAltCollectionConsistencyToken]
  }
}
