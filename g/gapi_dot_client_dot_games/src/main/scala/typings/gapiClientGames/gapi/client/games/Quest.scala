...
object Quest {
  ...
  implicit class QuestOps[Self <: Quest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMilestonesVarargs(value: QuestMilestone*): Self = this.set("milestones", js.Array(value :_*))
    @scala.inline
    def setMilestones(value: js.Array[QuestMilestone]): Self = this.set("milestones", value.asInstanceOf[js.Any])
    @scala.inline
