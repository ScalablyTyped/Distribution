...
trait Room extends js.Object {
  ...
  var creationDetails: js.UndefOr[RoomModification] = js.native
  /**
  ...
  var lastUpdateDetails: js.UndefOr[RoomModification] = js.native
...
object Room {
  ...
  implicit class RoomOps[Self <: Room] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreationDetails(value: RoomModification): Self = this.set("creationDetails", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLastUpdateDetails(value: RoomModification): Self = this.set("lastUpdateDetails", value.asInstanceOf[js.Any])
    @scala.inline
