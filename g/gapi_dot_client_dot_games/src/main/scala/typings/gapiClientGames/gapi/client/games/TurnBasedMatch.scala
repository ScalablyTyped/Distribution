...
trait TurnBasedMatch extends js.Object {
  ...
  var creationDetails: js.UndefOr[TurnBasedMatchModification] = js.native
  /** The data / game state for this match. */
  var data: js.UndefOr[TurnBasedMatchData] = js.native
  /**
  ...
  var lastUpdateDetails: js.UndefOr[TurnBasedMatchModification] = js.native
  ...
  var participants: js.UndefOr[js.Array[TurnBasedMatchParticipant]] = js.native
  ...
  var previousMatchData: js.UndefOr[TurnBasedMatchData] = js.native
...
object TurnBasedMatch {
  @scala.inline
  def apply(): TurnBasedMatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TurnBasedMatch]
  }
  @scala.inline
  implicit class TurnBasedMatchOps[Self <: TurnBasedMatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAutoMatchingCriteria(value: TurnBasedAutoMatchingCriteria): Self = this.set("autoMatchingCriteria", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAutoMatchingCriteria: Self = this.set("autoMatchingCriteria", js.undefined)
    @scala.inline
    def setCreationDetails(value: TurnBasedMatchModification): Self = this.set("creationDetails", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCreationDetails: Self = this.set("creationDetails", js.undefined)
    @scala.inline
    def setData(value: TurnBasedMatchData): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLastUpdateDetails(value: TurnBasedMatchModification): Self = this.set("lastUpdateDetails", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setParticipantsVarargs(value: TurnBasedMatchParticipant*): Self = this.set("participants", js.Array(value :_*))
    @scala.inline
    def setParticipants(value: js.Array[TurnBasedMatchParticipant]): Self = this.set("participants", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPreviousMatchData(value: TurnBasedMatchData): Self = this.set("previousMatchData", value.asInstanceOf[js.Any])
    @scala.inline
