...
object Collection {
  @scala.inline
  def apply(collection: String, playerId: String): Collection = {
    val __obj = js.Dynamic.literal(collection = collection.asInstanceOf[js.Any], playerId = playerId.asInstanceOf[js.Any])
