...
object Key {
  @scala.inline
  def apply(achievementId: String, steps: Double): Key = {
    val __obj = js.Dynamic.literal(achievementId = achievementId.asInstanceOf[js.Any], steps = steps.asInstanceOf[js.Any])
