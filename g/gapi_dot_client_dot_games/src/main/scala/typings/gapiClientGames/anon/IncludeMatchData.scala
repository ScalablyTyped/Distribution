...
@js.native
trait IncludeMatchData extends js.Object {
...
object IncludeMatchData {
  @scala.inline
  def apply(matchId: String): IncludeMatchData = {
    val __obj = js.Dynamic.literal(matchId = matchId.asInstanceOf[js.Any])
    __obj.asInstanceOf[IncludeMatchData]
  }
  @scala.inline
  implicit class IncludeMatchDataOps[Self <: IncludeMatchData] (val x: Self) extends AnyVal {
    @scala.inline
