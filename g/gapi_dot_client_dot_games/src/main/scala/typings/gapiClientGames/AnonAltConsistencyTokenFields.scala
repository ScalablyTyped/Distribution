...
trait AnonAltConsistencyTokenFields extends js.Object {
...
object AnonAltConsistencyTokenFields {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFields]
  }
}
