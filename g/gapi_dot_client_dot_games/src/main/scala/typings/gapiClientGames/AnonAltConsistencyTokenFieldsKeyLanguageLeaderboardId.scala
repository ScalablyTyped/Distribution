...
trait AnonAltConsistencyTokenFieldsKeyLanguageLeaderboardId extends js.Object {
...
object AnonAltConsistencyTokenFieldsKeyLanguageLeaderboardId {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsKeyLanguageLeaderboardId = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsKeyLanguageLeaderboardId]
  }
}
