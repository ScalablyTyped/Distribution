...
trait AnonAltConsistencyTokenFieldsKeyLanguageOauthtoken extends js.Object {
...
object AnonAltConsistencyTokenFieldsKeyLanguageOauthtoken {
  @scala.inline
  def apply(
    playerId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsKeyLanguageOauthtoken = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsKeyLanguageOauthtoken]
  }
}
