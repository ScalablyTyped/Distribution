...
trait AnonAltApplicationIdConsistencyToken extends js.Object {
...
object AnonAltApplicationIdConsistencyToken {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): AnonAltApplicationIdConsistencyToken = {
    ...
    __obj.asInstanceOf[AnonAltApplicationIdConsistencyToken]
  }
}
