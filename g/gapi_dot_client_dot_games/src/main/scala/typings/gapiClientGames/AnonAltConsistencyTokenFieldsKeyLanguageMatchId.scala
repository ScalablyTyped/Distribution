...
trait AnonAltConsistencyTokenFieldsKeyLanguageMatchId extends js.Object {
...
object AnonAltConsistencyTokenFieldsKeyLanguageMatchId {
  @scala.inline
  def apply(
    matchId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsKeyLanguageMatchId = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsKeyLanguageMatchId]
  }
}
