...
trait AnonAltConsistencyTokenFieldsKeyLanguageMatchIdMatchVersion extends js.Object {
...
object AnonAltConsistencyTokenFieldsKeyLanguageMatchIdMatchVersion {
  @scala.inline
  def apply(
    matchId: String,
    matchVersion: Double,
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsKeyLanguageMatchIdMatchVersion = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsKeyLanguageMatchIdMatchVersion]
  }
}
