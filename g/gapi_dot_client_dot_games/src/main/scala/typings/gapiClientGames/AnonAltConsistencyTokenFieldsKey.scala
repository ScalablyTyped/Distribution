...
trait AnonAltConsistencyTokenFieldsKey extends js.Object {
...
object AnonAltConsistencyTokenFieldsKey {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsKey = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsKey]
  }
}
