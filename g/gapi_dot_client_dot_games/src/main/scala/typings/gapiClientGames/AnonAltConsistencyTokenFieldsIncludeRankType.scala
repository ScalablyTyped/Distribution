...
trait AnonAltConsistencyTokenFieldsIncludeRankType extends js.Object {
...
object AnonAltConsistencyTokenFieldsIncludeRankType {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsIncludeRankType = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsIncludeRankType]
  }
}
