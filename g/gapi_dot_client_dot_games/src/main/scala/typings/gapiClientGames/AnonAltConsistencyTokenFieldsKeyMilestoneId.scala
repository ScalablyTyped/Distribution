...
trait AnonAltConsistencyTokenFieldsKeyMilestoneId extends js.Object {
...
object AnonAltConsistencyTokenFieldsKeyMilestoneId {
  @scala.inline
  def apply(
    milestoneId: String,
    questId: String,
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsKeyMilestoneId = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsKeyMilestoneId]
  }
}
