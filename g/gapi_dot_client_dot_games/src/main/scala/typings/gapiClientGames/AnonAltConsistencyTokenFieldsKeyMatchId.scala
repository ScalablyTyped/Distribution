...
trait AnonAltConsistencyTokenFieldsKeyMatchId extends js.Object {
...
object AnonAltConsistencyTokenFieldsKeyMatchId {
  @scala.inline
  def apply(
    matchId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsKeyMatchId = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsKeyMatchId]
  }
}
