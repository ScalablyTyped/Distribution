...
trait AnonAltCollectionConsistencyTokenFieldsKey extends js.Object {
...
object AnonAltCollectionConsistencyTokenFieldsKey {
  @scala.inline
  def apply(
    collection: String,
    ...
    userIp: String = null
  ): AnonAltCollectionConsistencyTokenFieldsKey = {
    ...
    __obj.asInstanceOf[AnonAltCollectionConsistencyTokenFieldsKey]
  }
}
