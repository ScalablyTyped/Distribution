...
trait AnonAltConsistencyTokenFieldsKeyOauthtoken extends js.Object {
...
object AnonAltConsistencyTokenFieldsKeyOauthtoken {
  @scala.inline
  def apply(
    roomId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsKeyOauthtoken = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsKeyOauthtoken]
  }
}
