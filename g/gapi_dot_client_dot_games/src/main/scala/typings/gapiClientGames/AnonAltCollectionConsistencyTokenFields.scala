...
trait AnonAltCollectionConsistencyTokenFields extends js.Object {
...
object AnonAltCollectionConsistencyTokenFields {
  @scala.inline
  def apply(
    collection: String,
    ...
    userIp: String = null
  ): AnonAltCollectionConsistencyTokenFields = {
    ...
    __obj.asInstanceOf[AnonAltCollectionConsistencyTokenFields]
  }
}
