...
trait AnonAltConsistencyTokenFieldsKeyLanguageMaxResults extends js.Object {
...
object AnonAltConsistencyTokenFieldsKeyLanguageMaxResults {
  @scala.inline
  def apply(
    playerId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltConsistencyTokenFieldsKeyLanguageMaxResults = {
    ...
    __obj.asInstanceOf[AnonAltConsistencyTokenFieldsKeyLanguageMaxResults]
  }
}
