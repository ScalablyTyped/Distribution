...
trait Anon_AltConsistencyTokenFieldsKeyLanguageOauthtokenPrettyPrintQuotaUserSnapshotId extends js.Object {
...
object Anon_AltConsistencyTokenFieldsKeyLanguageOauthtokenPrettyPrintQuotaUserSnapshotId {
  @scala.inline
  def apply(
    snapshotId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[Anon_AltConsistencyTokenFieldsKeyLanguageOauthtokenPrettyPrintQuotaUserSnapshotId]
  }
}
