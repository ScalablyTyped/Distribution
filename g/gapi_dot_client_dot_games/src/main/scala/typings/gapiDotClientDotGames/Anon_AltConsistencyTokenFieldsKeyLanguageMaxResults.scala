...
trait Anon_AltConsistencyTokenFieldsKeyLanguageMaxResults extends js.Object {
...
object Anon_AltConsistencyTokenFieldsKeyLanguageMaxResults {
  @scala.inline
  def apply(
    playerId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): Anon_AltConsistencyTokenFieldsKeyLanguageMaxResults = {
    ...
    __obj.asInstanceOf[Anon_AltConsistencyTokenFieldsKeyLanguageMaxResults]
  }
}
