...
trait Anon_AchievementId extends js.Object {
  ...
  var stepsToIncrement: Double
  /** IP address of the site where the request originates. Use this if you want to enforce per-user limits. */
  var userIp: js.UndefOr[String] = js.undefined
}

object Anon_AchievementId {
  @scala.inline
  def apply(
    achievementId: String,
    stepsToIncrement: Double,
    alt: String = null,
    ...
    __obj.asInstanceOf[Anon_AchievementId]
  }
}
