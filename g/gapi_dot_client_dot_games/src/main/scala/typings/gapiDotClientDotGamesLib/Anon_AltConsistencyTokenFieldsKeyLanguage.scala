...
trait Anon_AltConsistencyTokenFieldsKeyLanguage extends js.Object {
...
object Anon_AltConsistencyTokenFieldsKeyLanguage {
  @scala.inline
  def apply(
  ...
  ): Anon_AltConsistencyTokenFieldsKeyLanguage = {
    ...
    __obj.asInstanceOf[Anon_AltConsistencyTokenFieldsKeyLanguage]
  }
}
