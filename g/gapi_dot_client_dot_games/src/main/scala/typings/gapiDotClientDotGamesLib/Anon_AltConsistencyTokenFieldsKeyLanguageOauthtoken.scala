...
trait Anon_AltConsistencyTokenFieldsKeyLanguageOauthtoken extends js.Object {
...
object Anon_AltConsistencyTokenFieldsKeyLanguageOauthtoken {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltConsistencyTokenFieldsKeyLanguageOauthtoken]
  }
}
