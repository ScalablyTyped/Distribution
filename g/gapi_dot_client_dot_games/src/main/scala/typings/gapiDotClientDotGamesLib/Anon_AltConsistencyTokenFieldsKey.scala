...
trait Anon_AltConsistencyTokenFieldsKey extends js.Object {
...
object Anon_AltConsistencyTokenFieldsKey {
  @scala.inline
  def apply(
  ...
  ): Anon_AltConsistencyTokenFieldsKey = {
    ...
    __obj.asInstanceOf[Anon_AltConsistencyTokenFieldsKey]
  }
}
