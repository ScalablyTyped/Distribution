...
trait Anon_AltConsistencyTokenFieldsKeyMatchId extends js.Object {
...
object Anon_AltConsistencyTokenFieldsKeyMatchId {
  @scala.inline
  def apply(
    matchId: java.lang.String,
  ...
  ): Anon_AltConsistencyTokenFieldsKeyMatchId = {
    ...
    __obj.asInstanceOf[Anon_AltConsistencyTokenFieldsKeyMatchId]
  }
}
