...
object Anon_AltConsistencyTokenFieldsKeyLanguageMatchIdMatchVersion {
  @scala.inline
  def apply(
    matchId: java.lang.String,
    matchVersion: scala.Double,
    ...
    __obj.asInstanceOf[Anon_AltConsistencyTokenFieldsKeyLanguageMatchIdMatchVersion]
  }
}
