...
trait Anon_AltCollectionConsistencyToken extends js.Object {
...
object Anon_AltCollectionConsistencyToken {
  @scala.inline
  def apply(
  ...
  ): Anon_AltCollectionConsistencyToken = {
    ...
    __obj.asInstanceOf[Anon_AltCollectionConsistencyToken]
  }
}
