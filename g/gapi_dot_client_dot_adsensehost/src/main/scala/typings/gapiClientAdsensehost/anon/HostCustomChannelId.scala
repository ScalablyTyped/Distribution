...
@js.native
trait HostCustomChannelId extends js.Object {
  ...
  var hostCustomChannelId: js.UndefOr[String] = js.native
...
object HostCustomChannelId {
  @scala.inline
  def apply(accountId: String, adClientId: String, adUnitId: String): HostCustomChannelId = {
    ...
    __obj.asInstanceOf[HostCustomChannelId]
  }
  @scala.inline
  implicit class HostCustomChannelIdOps[Self <: HostCustomChannelId] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setHostCustomChannelId(value: String): Self = this.set("hostCustomChannelId", value.asInstanceOf[js.Any])
    @scala.inline
