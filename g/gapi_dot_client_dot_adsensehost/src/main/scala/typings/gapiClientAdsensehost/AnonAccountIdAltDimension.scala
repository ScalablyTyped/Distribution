...
trait AnonAccountIdAltDimension extends js.Object {
...
object AnonAccountIdAltDimension {
  @scala.inline
  def apply(
    accountId: String,
    endDate: String,
    ...
    __obj.asInstanceOf[AnonAccountIdAltDimension]
  }
}
