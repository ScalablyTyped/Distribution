...
trait CategoryDocsUrlLevelText extends StObject {
...
object CategoryDocsUrlLevelText {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CategoryDocsUrlLevelText]
  }
  
  extension [Self <: CategoryDocsUrlLevelText](x: Self) {
