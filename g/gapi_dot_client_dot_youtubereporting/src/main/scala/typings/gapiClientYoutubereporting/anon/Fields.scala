...
object Fields {
  ...
  def apply(
    ...
    fields: String = null,
    includeSystemManaged: js.UndefOr[Boolean] = js.undefined,
    key: String = null,
    ...
    if (!js.isUndefined(includeSystemManaged)) __obj.updateDynamic("includeSystemManaged")(includeSystemManaged.get.asInstanceOf[js.Any])
