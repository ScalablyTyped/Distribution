...
object Anon_AccesstokenAltBearertokenCallbackFields {
  ...
  def apply(
    ...
    includeSystemManaged: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    if (!js.isUndefined(includeSystemManaged)) __obj.updateDynamic("includeSystemManaged")(includeSystemManaged)
