package typings.gapiDotClientDotYoutubereporting.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typings.gapiDotClientDotYoutubereporting.gapiDotClientDotYoutubereportingStrings.youtubereporting,
    version: v1
