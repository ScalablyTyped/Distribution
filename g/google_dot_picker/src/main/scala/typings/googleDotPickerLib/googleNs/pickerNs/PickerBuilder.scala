...
class PickerBuilder () extends js.Object {
  ...
  def disableFeature(feature: java.lang.String): PickerBuilder = js.native
  // Enable a picker feature.
  def enableFeature(feature: java.lang.String): PickerBuilder = js.native
  // Get the relay URL, used for gadgets.rpc.
  def getRelayUrl(): java.lang.String = js.native
  ...
  def isFeatureEnabled(feature: java.lang.String): scala.Boolean = js.native
  // Sets the Google Drive App ID needed to allow application to access the user's files via the Google Drive API.
  def setAppId(appId: java.lang.String): PickerBuilder = js.native
  ...
  def setDeveloperKey(key: java.lang.String): PickerBuilder = js.native
  // Set the document.
  def setDocument(document: java.lang.String): PickerBuilder = js.native
  ...
  def setLocale(locale: java.lang.String): PickerBuilder = js.native
  // Sets the maximum number of items a user can pick.
  def setMaxItems(max: scala.Double): PickerBuilder = js.native
  ...
  def setOAuthToken(token: java.lang.String): PickerBuilder = js.native
  ...
  def setOrigin(origin: java.lang.String): PickerBuilder = js.native
  // Set the relay URL, used for gadgets.rpc.
  def setRelayUrl(url: java.lang.String): PickerBuilder = js.native
  // Set the list of MIME types which will be selectable. Use commas to separate MIME types if more than one is required.
  def setSelectableMimeTypes(`type`: java.lang.String): PickerBuilder = js.native
  ...
  def setSize(width: scala.Double, height: scala.Double): PickerBuilder = js.native
  // Set the dialog title.
  def setTitle(title: java.lang.String): PickerBuilder = js.native
  // Specify an album ID for photo uploads. See Picasa Web Albums Data API documentation for more information about albums.
  def setUploadToAlbumId(albumId: java.lang.String): PickerBuilder = js.native
