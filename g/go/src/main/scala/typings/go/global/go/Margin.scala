...
object Margin {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(str: String): typings.go.mod.Margin = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(str.asInstanceOf[js.Any]).asInstanceOf[typings.go.mod.Margin]
  ...
  /**
    ...
    */
  /* static member */
  inline def stringify(`val`: typings.go.mod.Margin): String = ^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
}
