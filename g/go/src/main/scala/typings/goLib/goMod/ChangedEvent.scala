...
class ChangedEvent () extends js.Object {
  ...
  var isTransactionFinished: scala.Boolean = js.native
  ...
  var modelChange: java.lang.String = js.native
  ...
  /**
    ...
    */
  def getParam(undo: scala.Boolean): js.Any = js.native
  /**
    ...
    */
  def getValue(undo: scala.Boolean): js.Any = js.native
  /**
