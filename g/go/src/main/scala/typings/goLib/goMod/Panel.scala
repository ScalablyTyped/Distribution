...
object Panel extends js.Object {
  ...
  var Auto: goLib.goMod.EnumValue = js.native
  /**This value for .type is used to draw regular patterns of lines.*/
  var Grid: goLib.goMod.EnumValue = js.native
  ...
  var Link: goLib.goMod.EnumValue = js.native
  ...
  var Spot: goLib.goMod.EnumValue = js.native
  ...
  var Table: goLib.goMod.EnumValue = js.native
  /**Organizational Panel type that is only valid inside of a Table panel.*/
  var TableColumn: goLib.goMod.EnumValue = js.native
  /**Organizational Panel type that is only valid inside of a Table panel.*/
  var TableRow: goLib.goMod.EnumValue = js.native
  ...
  var Viewbox: goLib.goMod.EnumValue = js.native
}
