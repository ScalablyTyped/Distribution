...
class LayoutVertex () extends js.Object {
  ...
  var edgesCount: scala.Double = js.native
  ...
  var focusX: scala.Double = js.native
  /**Gets or sets the relative Y position of the "center" point, the focus.*/
  var focusY: scala.Double = js.native
  ...
  /**
    ...
    */
  def addDestinationEdge(edge: LayoutEdge): scala.Unit = js.native
  /**
    * Adds a LayoutEdge to the list of predecessors (the edge will be coming into this vertex).
    * @param {LayoutEdge} edge
    */
  def addSourceEdge(edge: LayoutEdge): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param {LayoutEdge} edge
    */
  def deleteDestinationEdge(edge: LayoutEdge): scala.Unit = js.native
  /**
    * Deletes a LayoutEdge from the list of predecessors (the edge was coming into this vertex).
    * @param {LayoutEdge} edge
    */
  def deleteSourceEdge(edge: LayoutEdge): scala.Unit = js.native
}
...
object LayoutVertex extends js.Object {
  /**
    ...
    */
  def smartComparer(m: goLib.goMod.LayoutVertex, n: goLib.goMod.LayoutVertex): scala.Double = js.native
  /**
    * This static function is used to compare the Part.text values of the .nodes of the argument LayoutVertexes.
    * @param {LayoutVertex} m
    * @param {LayoutVertex} n
    */
  def standardComparer(m: goLib.goMod.LayoutVertex, n: goLib.goMod.LayoutVertex): scala.Double = js.native
}
