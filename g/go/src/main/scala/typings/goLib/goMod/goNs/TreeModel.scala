...
trait TreeModel extends Model {
  ...
  /**
    ...
    */
  def getParentLinkCategoryForNodeData(childdata: js.Object): java.lang.String = js.native
  /**
    ...
    */
  def setParentKeyForNodeData(nodedata: js.Object, key: Key): scala.Unit = js.native
  /**
    ...
    */
  def setParentLinkCategoryForNodeData(childdata: js.Object, cat: java.lang.String): scala.Unit = js.native
}
