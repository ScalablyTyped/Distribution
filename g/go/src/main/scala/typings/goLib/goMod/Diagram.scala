...
object Diagram extends js.Object {
  ...
  var AllParentsCollapsed: goLib.goMod.EnumValue = js.native
  /**This value for Diagram.validCycle states that there are no restrictions on making cycles of links.*/
  var CycleAll: goLib.goMod.EnumValue = js.native
  ...
  var TreeParentCollapsed: goLib.goMod.EnumValue = js.native
  ...
  var Uniform: goLib.goMod.EnumValue = js.native
  /**Diagrams with this autoScale type, used as the value of Diagram.autoScale, are scaled uniformly until the documentBounds fits in the view.*/
  var UniformToFill: goLib.goMod.EnumValue = js.native
  /**
    * This static function gets the Diagram that is attached to an HTML DIV element.
    * @param {HTMLDivElement} div
    */
  def fromDiv(div: stdLib.HTMLDivElement): goLib.goMod.Diagram = js.native
  /**
    ...
    */
  def inherit(derivedclass: goLib.goMod.Constructor, baseclass: goLib.goMod.Constructor): scala.Unit = js.native
}
