...
class ForceDirectedVertex ()
  extends goLib.goMod.goNs.ForceDirectedVertex {
  ...
  /* CompleteClass */
  override var charge: scala.Double = js.native
  ...
  /* CompleteClass */
  override var forceX: scala.Double = js.native
  /**Gets or sets the cumulative force on the vertex in the Y direction.*/
  /* CompleteClass */
  override var forceY: scala.Double = js.native
