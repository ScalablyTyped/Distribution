...
class Node () extends Part {
  ...
  var avoidable: scala.Boolean = js.native
  ...
  var isLinkLabel: scala.Boolean = js.native
  /**Gets or sets whether the subtree graph starting at this node is expanded.*/
  var isTreeExpanded: scala.Boolean = js.native
  /**Gets whether this node has no tree children.*/
  var isTreeLeaf: scala.Boolean = js.native
  ...
  def linkDisconnected(a: Node, b: Link, c: GraphObject): scala.Unit = js.native
  ...
  def linkValidation(from: Node, fromPort: GraphObject, to: Node, toPort: GraphObject, link: Link): scala.Boolean = js.native
  /**Gets or sets the function that is called when .isTreeExpanded has changed value.*/
  def treeExpandedChanged(node: Node): scala.Unit = js.native
}
...
object Node extends js.Object {
  ...
  var DirectionAbsolute: goLib.goMod.EnumValue = js.native
  ...
  var DirectionDefault: goLib.goMod.EnumValue = js.native
  ...
  var DirectionRotatedNode: goLib.goMod.EnumValue = js.native
  ...
  var DirectionRotatedNodeOrthogonal: goLib.goMod.EnumValue = js.native
  ...
  var SpreadingEvenly: goLib.goMod.EnumValue = js.native
  ...
  var SpreadingNone: goLib.goMod.EnumValue = js.native
  ...
  var SpreadingPacked: goLib.goMod.EnumValue = js.native
}
