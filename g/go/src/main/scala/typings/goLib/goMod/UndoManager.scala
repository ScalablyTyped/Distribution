...
class UndoManager () extends js.Object {
  ...
  var hisotryIndex: scala.Double = js.native
  ...
  var nestedTransactionNames: List[java.lang.String] = js.native
  /**This read-only property returns the current transaction level.*/
  var transactionLevel: scala.Double = js.native
  ...
  /**
    ...
    */
  def handleChanged(e: ChangedEvent): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def skipsEvent(e: ChangedEvent): scala.Boolean = js.native
  /**
