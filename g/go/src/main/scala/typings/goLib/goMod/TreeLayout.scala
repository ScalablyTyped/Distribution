...
object TreeLayout extends js.Object {
  ...
  var AlignmentBottomRightBus: goLib.goMod.EnumValue = js.native
  ...
  var AlignmentBus: goLib.goMod.EnumValue = js.native
  ...
  var AlignmentBusBranching: goLib.goMod.EnumValue = js.native
  ...
  var AlignmentCenterChildren: goLib.goMod.EnumValue = js.native
  ...
  var AlignmentCenterSubtrees: goLib.goMod.EnumValue = js.native
  ...
  var AlignmentEnd: goLib.goMod.EnumValue = js.native
  ...
  var AlignmentStart: goLib.goMod.EnumValue = js.native
  ...
  var AlignmentTopLeftBus: goLib.goMod.EnumValue = js.native
  ...
  var ArrangementFixedRoots: goLib.goMod.EnumValue = js.native
  ...
  var ArrangementHorizontal: goLib.goMod.EnumValue = js.native
  ...
  var CompactionNone: goLib.goMod.EnumValue = js.native
  /**This default value for TreeLayout.layerStyle causes each node takes up only the depth that it needs.*/
  var LayerIndividual: goLib.goMod.EnumValue = js.native
  ...
  var LayerSiblings: goLib.goMod.EnumValue = js.native
  ...
  var LayerUniform: goLib.goMod.EnumValue = js.native
  ...
  var PathDefault: goLib.goMod.EnumValue = js.native
  ...
  var PathDestination: goLib.goMod.EnumValue = js.native
  ...
  var PathSource: goLib.goMod.EnumValue = js.native
  ...
  var SortingAscending: goLib.goMod.EnumValue = js.native
  ...
  var SortingDescending: goLib.goMod.EnumValue = js.native
  ...
  var SortingForwards: goLib.goMod.EnumValue = js.native
  ...
  var SortingReverse: goLib.goMod.EnumValue = js.native
  ...
  var StyleAlternating: goLib.goMod.EnumValue = js.native
  ...
  var StyleLastParents: goLib.goMod.EnumValue = js.native
  ...
  var StyleLayered: goLib.goMod.EnumValue = js.native
  ...
  var StyleRootOnly: goLib.goMod.EnumValue = js.native
}
