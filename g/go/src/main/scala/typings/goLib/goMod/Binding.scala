...
object Binding extends js.Object {
  ...
  /**
    ...
    */
  def parseEnum(ctor: goLib.goMod.Constructor, defval: goLib.goMod.EnumValue): js.Function1[/* a */ java.lang.String, goLib.goMod.EnumValue] = js.native
  /**
