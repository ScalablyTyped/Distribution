...
class Point () extends js.Object {
  ...
  /**
    ...
    * @param {number} py
    */
  def direction(px: scala.Double, py: scala.Double): scala.Double = js.native
  /**
  ...
  /**
    ...
    * false otherwise.
    */
  def equalTo(x: scala.Double, y: scala.Double): scala.Boolean = js.native
  /**
  ...
  def equalsApprox(p: Point): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @param {number} dy
    */
  def offset(dx: scala.Double, dy: scala.Double): Point = js.native
  /**
    ...
    * @param {number} qy
    */
  def projectOntoLineSegment(px: scala.Double, py: scala.Double, qx: scala.Double, qy: scala.Double): Point = js.native
  /**
  ...
  /**
    ...
    * @param {number} sy
    */
  def scale(sx: scala.Double, sy: scala.Double): Point = js.native
  /**
  ...
  /**
    ...
    * @param {Spot} spot the Spot; Spot.isSpot must be true for this Spot.
    */
  def setSpot(x: scala.Double, y: scala.Double, w: scala.Double, h: scala.Double, spot: Spot): Point = js.native
  /**
  ...
  /**
    ...
    */
  def snapToGrid(originx: scala.Double, originy: scala.Double, cellwidth: scala.Double, cellheight: scala.Double): Point = js.native
  /**
    * Modify this point to be at the nearest point on an infinite grid,
    * given the grid's origin and size of each grid cell.
    * @param {Point} origin
...
object Point extends js.Object {
  ...
  /**
    ...
    * @param {string} str
    */
  def parse(str: java.lang.String): goLib.goMod.Point = js.native
  /**
    * This static function can be used to write out a Point as a string that can be read by Point.parse.
    * @param {Point} val
    */
  def stringify(`val`: goLib.goMod.Point): java.lang.String = js.native
}
