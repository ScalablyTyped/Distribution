...
class RowColumnDefinition () extends js.Object {
  ...
  var actual: scala.Double = js.native
  ...
  var coversSeparators: scala.Boolean = js.native
  ...
  var isRow: scala.Boolean = js.native
  ...
  var separatorDashArray: js.Array[scala.Double] = js.native
  ...
  var separatorStrokeWidth: scala.Double = js.native
  ...
  def computeEffectiveSpacing(): scala.Double = js.native
    // undocumented
  def computeEffectiveSpacingTop(): scala.Double = js.native
}
...
object RowColumnDefinition extends js.Object {
  ...
  var Default: goLib.goMod.EnumValue = js.native
  ...
  var ProportionalExtra: goLib.goMod.EnumValue = js.native
}
