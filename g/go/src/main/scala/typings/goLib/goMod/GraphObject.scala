...
object GraphObject extends js.Object {
  ...
  var Fill: goLib.goMod.EnumValue = js.native
  ...
  def defineBuilder(name: java.lang.String, func: js.Function1[/* args */ js.Array[_], js.Object]): scala.Unit = js.native
    // undocumented
  def getBuilders(): goLib.goMod.Map[java.lang.String, js.Function1[/* args */ js.Array[_], js.Object]] = js.native
  /**
    ...
    */
  def make(`type`: goLib.goMod.Constructor, initializers: js.Any*): js.Any = js.native
