...
/**
  ...
  */
@js.native
trait GraphLinksModel extends Model {
  /**
  ...
  /**
    ...
    */
  def addLabelKeyForLinkData(linkdata: js.Object, key: Key): scala.Unit = js.native
  /**
    ...
    * @param {Object} linkdata a JavaScript object representing a link.
    */
  def addLinkData(linkdata: js.Object): scala.Unit = js.native
  /**
    ...
    */
  def addLinkDataCollection(coll: Iterable[js.Object]): scala.Unit = js.native
  def addLinkDataCollection(coll: js.Array[js.Object]): scala.Unit = js.native
  /**
    * Decide if a given link data is in this model.
    * @param {Object} linkdata a JavaScript object representing a link.
    */
  def containsLinkData(linkdata: js.Object): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @param {Object} linkdata a JavaScript object representing a link.
    */
  def getCategoryForLinkData(linkdata: js.Object): java.lang.String = js.native
  /**
  ...
  /**
    ...
    * @param {Object} linkdata a JavaScript object representing a link.
    */
  def getFromPortIdForLinkData(linkdata: js.Object): java.lang.String = js.native
  /**
  ...
  /**
    ...
    * @param {Object} linkdata a JavaScript object representing a link.
    */
  def getToPortIdForLinkData(linkdata: js.Object): java.lang.String = js.native
  /**
    ...
    * @param {Object} nodedata a JavaScript object representing a node, group, or non-link.
    */
  def isGroupForNodeData(nodedata: js.Object): scala.Boolean = js.native
  /**
    ...
    * @param {Object} linkdata a JavaScript object representing a link.
    */
  def makeLinkDataKeyUnique(linkdata: js.Object): scala.Unit = js.native
  ...
  /**
    ...
    */
  def removeLabelKeyForLinkData(linkdata: js.Object, key: Key): scala.Unit = js.native
  /**
    ...
    * @param {Object} linkdata a JavaScript object representing a link.
    */
  def removeLinkData(linkdata: js.Object): scala.Unit = js.native
  /**
    ...
    */
  def removeLinkDataCollection(coll: Iterable[js.Object]): scala.Unit = js.native
  def removeLinkDataCollection(coll: js.Array[js.Object]): scala.Unit = js.native
  /**
    ...
    */
  def setCategoryForLinkData(linkdata: js.Object, cat: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def setFromKeyForLinkData(linkdata: js.Object, key: Key): scala.Unit = js.native
  /**
    ...
    */
  def setFromPortIdForLinkData(linkdata: js.Object, portname: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def setGroupKeyForNodeData(nodedata: js.Object, key: Key): scala.Unit = js.native
  /**
    ...
    */
  def setKeyForLinkData(linkdata: js.Object, key: Key): scala.Unit = js.native
  /**
    ...
    */
  def setLabelKeysForLinkData(linkdata: js.Object, arr: js.Array[Key]): scala.Unit = js.native
  /**
    * Change the node key that the given link data references as the
    ...
    */
  def setToKeyForLinkData(linkdata: js.Object, key: Key): scala.Unit = js.native
  /**
    * Change the information that the given link data uses to identify the
    ...
    * the link should no longer be associated with any particular "port".
    */
  def setToPortIdForLinkData(linkdata: js.Object, portname: java.lang.String): scala.Unit = js.native
}
