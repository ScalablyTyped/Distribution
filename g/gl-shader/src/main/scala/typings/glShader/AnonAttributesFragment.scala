...
trait AnonAttributesFragment extends js.Object {
...
object AnonAttributesFragment {
  @scala.inline
  def apply(attributes: js.Array[Parameter], fragment: String, uniforms: js.Array[Parameter], vertex: String): AnonAttributesFragment = {
    ...
    __obj.asInstanceOf[AnonAttributesFragment]
  }
}
