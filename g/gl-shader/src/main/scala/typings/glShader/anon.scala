...
object anon {
  ...
  object Attributes {
    ...
    inline def apply(attributes: js.Array[Parameter], fragment: String, uniforms: js.Array[Parameter], vertex: String): Attributes = {
  ...
  object Fragment {
    ...
    inline def apply(fragment: String, vertex: String): Fragment = {
