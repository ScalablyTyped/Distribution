...
trait Anon_AltAlwaysIncludeEmailCalendarIdEventId extends js.Object {
...
object Anon_AltAlwaysIncludeEmailCalendarIdEventId {
  @scala.inline
  def apply(
  ...
  ): Anon_AltAlwaysIncludeEmailCalendarIdEventId = {
    ...
    __obj.asInstanceOf[Anon_AltAlwaysIncludeEmailCalendarIdEventId]
  }
}
