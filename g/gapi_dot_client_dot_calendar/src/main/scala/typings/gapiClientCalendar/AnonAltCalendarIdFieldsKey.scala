...
trait AnonAltCalendarIdFieldsKey extends js.Object {
...
object AnonAltCalendarIdFieldsKey {
  @scala.inline
  def apply(
    calendarId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltCalendarIdFieldsKey]
  }
}
