...
trait AnonAltCalendarIdFieldsKeyOauthtoken extends js.Object {
...
object AnonAltCalendarIdFieldsKeyOauthtoken {
  @scala.inline
  def apply(
    calendarId: String,
    text: String,
    ...
    userIp: String = null
  ): AnonAltCalendarIdFieldsKeyOauthtoken = {
    ...
    __obj.asInstanceOf[AnonAltCalendarIdFieldsKeyOauthtoken]
  }
}
