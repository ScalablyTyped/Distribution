...
trait AnonAltCalendarIdDestination extends js.Object {
...
object AnonAltCalendarIdDestination {
  @scala.inline
  def apply(
    calendarId: String,
    destination: String,
    ...
    __obj.asInstanceOf[AnonAltCalendarIdDestination]
  }
}
