...
trait AnonAltAlwaysIncludeEmailCalendarIdFields extends js.Object {
...
object AnonAltAlwaysIncludeEmailCalendarIdFields {
  @scala.inline
  def apply(
    calendarId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltAlwaysIncludeEmailCalendarIdFields = {
    ...
    __obj.asInstanceOf[AnonAltAlwaysIncludeEmailCalendarIdFields]
  }
}
