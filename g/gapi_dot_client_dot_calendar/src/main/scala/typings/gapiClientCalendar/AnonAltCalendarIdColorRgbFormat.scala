...
trait AnonAltCalendarIdColorRgbFormat extends js.Object {
...
object AnonAltCalendarIdColorRgbFormat {
  @scala.inline
  def apply(
    calendarId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltCalendarIdColorRgbFormat = {
    ...
    __obj.asInstanceOf[AnonAltCalendarIdColorRgbFormat]
  }
}
