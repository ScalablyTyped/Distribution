...
trait AnonAltAlwaysIncludeEmailCalendarIdEventId extends js.Object {
...
object AnonAltAlwaysIncludeEmailCalendarIdEventId {
  @scala.inline
  def apply(
    calendarId: String,
    eventId: String,
    ...
    userIp: String = null
  ): AnonAltAlwaysIncludeEmailCalendarIdEventId = {
    ...
    __obj.asInstanceOf[AnonAltAlwaysIncludeEmailCalendarIdEventId]
  }
}
