...
trait AnonAltAlwaysIncludeEmail extends js.Object {
...
object AnonAltAlwaysIncludeEmail {
  @scala.inline
  def apply(
    calendarId: String,
    eventId: String,
    ...
    __obj.asInstanceOf[AnonAltAlwaysIncludeEmail]
  }
}
