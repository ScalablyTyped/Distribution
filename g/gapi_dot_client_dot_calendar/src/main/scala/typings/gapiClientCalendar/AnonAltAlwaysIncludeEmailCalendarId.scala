...
trait AnonAltAlwaysIncludeEmailCalendarId extends js.Object {
...
object AnonAltAlwaysIncludeEmailCalendarId {
  @scala.inline
  def apply(
    calendarId: String,
    eventId: String,
    ...
    userIp: String = null
  ): AnonAltAlwaysIncludeEmailCalendarId = {
    ...
    __obj.asInstanceOf[AnonAltAlwaysIncludeEmailCalendarId]
  }
}
