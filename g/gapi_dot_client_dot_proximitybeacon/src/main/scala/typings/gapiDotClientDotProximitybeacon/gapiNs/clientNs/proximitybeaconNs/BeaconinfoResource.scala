...
trait BeaconinfoResource extends js.Object {
  /**
    ...
    * for the application.
    */
  def getforobserved(request: Anon_Accesstoken): Request[GetInfoForObservedBeaconsResponse]
}

object BeaconinfoResource {
  @scala.inline
  def apply(getforobserved: Anon_Accesstoken => Request[GetInfoForObservedBeaconsResponse]): BeaconinfoResource = {
