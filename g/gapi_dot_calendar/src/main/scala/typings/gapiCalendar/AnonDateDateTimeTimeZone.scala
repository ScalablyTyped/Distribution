...
trait AnonDateDateTimeTimeZone extends js.Object {
  var date: typings.gapiCalendar.gapi.client.calendar.date
  var dateTime: datetime
  var timeZone: js.UndefOr[String] = js.undefined
}

object AnonDateDateTimeTimeZone {
  @scala.inline
  def apply(date: date, dateTime: datetime, timeZone: String = null): AnonDateDateTimeTimeZone = {
    val __obj = js.Dynamic.literal(date = date.asInstanceOf[js.Any], dateTime = dateTime.asInstanceOf[js.Any])
    if (timeZone != null) __obj.updateDynamic("timeZone")(timeZone.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDateDateTimeTimeZone]
  }
}
