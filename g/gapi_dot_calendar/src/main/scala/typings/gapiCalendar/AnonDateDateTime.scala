...
trait AnonDateDateTime extends js.Object {
  var date: typings.gapiCalendar.gapi.client.calendar.date
  var dateTime: datetime
  var timeZone: String
}

object AnonDateDateTime {
  @scala.inline
  def apply(date: date, dateTime: datetime, timeZone: String): AnonDateDateTime = {
    ...
    __obj.asInstanceOf[AnonDateDateTime]
  }
}
