...
object Anon_AltFieldsKeyOauthtokenPrettyPrintProposalId {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(proposalId = proposalId.asInstanceOf[js.Any], revisionNumber = revisionNumber.asInstanceOf[js.Any], updateAction = updateAction.asInstanceOf[js.Any])
