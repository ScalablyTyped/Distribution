...
trait Anon_AltFieldsKeyOauthtokenPrettyPrintProposalId extends js.Object {
...
object Anon_AltFieldsKeyOauthtokenPrettyPrintProposalId {
  @scala.inline
  def apply(
    proposalId: java.lang.String,
    revisionNumber: java.lang.String,
  ...
  ): Anon_AltFieldsKeyOauthtokenPrettyPrintProposalId = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("proposalId")(proposalId)
    __obj.updateDynamic("revisionNumber")(revisionNumber)
    __obj.updateDynamic("updateAction")(updateAction)
    ...
    __obj.asInstanceOf[Anon_AltFieldsKeyOauthtokenPrettyPrintProposalId]
  }
}
