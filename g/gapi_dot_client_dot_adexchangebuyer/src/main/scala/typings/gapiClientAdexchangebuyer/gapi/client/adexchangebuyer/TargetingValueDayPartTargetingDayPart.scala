...
object TargetingValueDayPartTargetingDayPart {
  @scala.inline
  def apply(): TargetingValueDayPartTargetingDayPart = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TargetingValueDayPartTargetingDayPart]
  }
  @scala.inline
  implicit class TargetingValueDayPartTargetingDayPartOps[Self <: TargetingValueDayPartTargetingDayPart] (val x: Self) extends AnyVal {
    @scala.inline
