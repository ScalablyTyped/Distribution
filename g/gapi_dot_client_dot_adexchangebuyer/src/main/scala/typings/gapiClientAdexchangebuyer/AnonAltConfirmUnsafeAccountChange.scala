...
trait AnonAltConfirmUnsafeAccountChange extends js.Object {
...
object AnonAltConfirmUnsafeAccountChange {
  @scala.inline
  def apply(
    id: Double,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltConfirmUnsafeAccountChange = {
    ...
    __obj.asInstanceOf[AnonAltConfirmUnsafeAccountChange]
  }
}
