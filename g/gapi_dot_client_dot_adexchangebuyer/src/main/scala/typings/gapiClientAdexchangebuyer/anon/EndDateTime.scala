...
trait EndDateTime extends js.Object {
  ...
  var endDateTime: String = js.native
...
object EndDateTime {
  @scala.inline
  def apply(accountId: String, endDateTime: String, startDateTime: String): EndDateTime = {
  ...
  @scala.inline
  implicit class EndDateTimeOps[Self <: EndDateTime] (val x: Self) extends AnyVal {
    @scala.inline
