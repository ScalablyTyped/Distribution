...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProposalId extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProposalId {
  @scala.inline
  def apply(
    proposalId: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProposalId = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProposalId]
  }
}
