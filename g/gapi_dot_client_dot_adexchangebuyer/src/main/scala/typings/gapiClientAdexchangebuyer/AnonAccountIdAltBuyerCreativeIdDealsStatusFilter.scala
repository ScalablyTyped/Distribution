...
trait AnonAccountIdAltBuyerCreativeIdDealsStatusFilter extends js.Object {
...
object AnonAccountIdAltBuyerCreativeIdDealsStatusFilter {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): AnonAccountIdAltBuyerCreativeIdDealsStatusFilter = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltBuyerCreativeIdDealsStatusFilter]
  }
}
