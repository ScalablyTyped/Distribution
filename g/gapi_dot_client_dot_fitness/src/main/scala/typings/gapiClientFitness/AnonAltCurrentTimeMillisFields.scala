...
trait AnonAltCurrentTimeMillisFields extends js.Object {
...
object AnonAltCurrentTimeMillisFields {
  @scala.inline
  def apply(
    sessionId: String,
    userId: String,
    ...
    userIp: String = null
  ): AnonAltCurrentTimeMillisFields = {
    ...
    __obj.asInstanceOf[AnonAltCurrentTimeMillisFields]
  }
}
