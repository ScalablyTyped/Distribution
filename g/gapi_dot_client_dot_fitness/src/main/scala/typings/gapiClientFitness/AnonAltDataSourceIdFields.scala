...
trait AnonAltDataSourceIdFields extends js.Object {
...
object AnonAltDataSourceIdFields {
  @scala.inline
  def apply(
    dataSourceId: String,
    userId: String,
    ...
    __obj.asInstanceOf[AnonAltDataSourceIdFields]
  }
}
