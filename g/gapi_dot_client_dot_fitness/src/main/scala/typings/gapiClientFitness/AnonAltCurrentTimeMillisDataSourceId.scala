...
trait AnonAltCurrentTimeMillisDataSourceId extends js.Object {
...
object AnonAltCurrentTimeMillisDataSourceId {
  @scala.inline
  def apply(
    dataSourceId: String,
    datasetId: String,
    ...
    userIp: String = null
  ): AnonAltCurrentTimeMillisDataSourceId = {
    ...
    __obj.asInstanceOf[AnonAltCurrentTimeMillisDataSourceId]
  }
}
