...
import typings.gapiClientFitness.AnonAltCurrentTimeMillis
import typings.gapiClientFitness.AnonAltCurrentTimeMillisDataSourceId
import typings.gapiClientFitness.AnonAltDataSourceId
...
trait DatasetsResource extends js.Object {
  /**
    ...
    * deleted.
    */
  def delete(request: AnonAltCurrentTimeMillis): Request_[Unit]
  /**
    ...
    */
  def get(request: AnonAltDataSourceId): Request_[Dataset]
  /**
    ...
    */
  def patch(request: AnonAltCurrentTimeMillisDataSourceId): Request_[Dataset]
}

object DatasetsResource {
  @scala.inline
  def apply(
    delete: AnonAltCurrentTimeMillis => Request_[Unit],
    get: AnonAltDataSourceId => Request_[Dataset],
    patch: AnonAltCurrentTimeMillisDataSourceId => Request_[Dataset]
  ): DatasetsResource = {
