...
trait DataSourcesResource extends js.Object {
  ...
  /**
    ...
    */
  def create(request: Fields): Request[DataSource]
  /** Deletes the specified data source. The request will fail if the data source contains any data points. */
  def delete(request: Key): Request[DataSource]
  /** Returns the specified data source. */
  def get(request: Key): Request[DataSource]
  /**
    ...
    */
  def list(request: DataTypeName): Request[ListDataSourcesResponse]
  /**
    ...
    */
  def patch(request: Key): Request[DataSource]
  /**
    * Updates the specified data source. The dataStreamId, dataType, type, dataStreamName, and device properties with the exception of version, cannot be
    * modified.
    *
    ...
    */
  def update(request: Key): Request[DataSource]
}
