...
trait DatasetsResource extends js.Object {
  /**
    ...
    * deleted.
    */
  def delete(request: gapiDotClientDotFitnessLib.Anon_AltCurrentTimeMillis): gapiDotClientLib.gapiNs.clientNs.Request[scala.Unit]
  /**
    ...
    */
  def get(request: gapiDotClientDotFitnessLib.Anon_AltDataSourceId): gapiDotClientLib.gapiNs.clientNs.Request[Dataset]
  /**
