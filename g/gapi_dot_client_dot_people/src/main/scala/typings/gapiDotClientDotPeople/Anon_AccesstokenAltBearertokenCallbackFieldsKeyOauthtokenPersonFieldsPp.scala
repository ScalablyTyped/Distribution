...
trait Anon_AccesstokenAltBearertokenCallbackFieldsKeyOauthtokenPersonFieldsPp extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
  ...
  /**
    ...
    */
  var `requestMask.includeField`: js.UndefOr[String] = js.undefined
  /**
    ...
    */
  var resourceNames: js.UndefOr[String] = js.undefined
...
object Anon_AccesstokenAltBearertokenCallbackFieldsKeyOauthtokenPersonFieldsPp {
  @scala.inline
  def apply(
    `$.xgafv`: String = null,
    ...
    `requestMask.includeField`: String = null,
    resourceNames: String = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): Anon_AccesstokenAltBearertokenCallbackFieldsKeyOauthtokenPersonFieldsPp = {
    ...
    if (`requestMask.includeField` != null) __obj.updateDynamic("requestMask.includeField")(`requestMask.includeField`.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackFieldsKeyOauthtokenPersonFieldsPp]
  }
}
