...
object Anon_AccesstokenAltBearertokenCallbackFieldsKeyOauthtokenParent {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackFieldsKeyOauthtokenParent = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackFieldsKeyOauthtokenParent]
  }
}
