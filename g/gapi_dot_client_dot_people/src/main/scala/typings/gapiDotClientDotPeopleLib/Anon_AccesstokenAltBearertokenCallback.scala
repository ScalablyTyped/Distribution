...
trait Anon_AccesstokenAltBearertokenCallback extends js.Object {
  ...
  var deleteContacts: js.UndefOr[scala.Boolean] = js.undefined
...
object Anon_AccesstokenAltBearertokenCallback {
  ...
  def apply(
    ...
    deleteContacts: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    if (!js.isUndefined(deleteContacts)) __obj.updateDynamic("deleteContacts")(deleteContacts)
