...
trait AnonDeleteContacts extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonDeleteContacts {
  ...
  def apply(
    ...
    if (!js.isUndefined(deleteContacts)) __obj.updateDynamic("deleteContacts")(deleteContacts.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[AnonDeleteContacts]
  }
}
