...
import typings.gapiClientPeople.gapi.client.people.UpdateContactPhotoRequest
...
trait UploadType extends js.Object {
  ...
  /** Request body */
  var resource: UpdateContactPhotoRequest = js.native
...
object UploadType {
  @scala.inline
  def apply(resource: UpdateContactPhotoRequest, resourceName: String): UploadType = {
  ...
  implicit class UploadTypeOps[Self <: UploadType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: UpdateContactPhotoRequest): Self = this.set("resource", value.asInstanceOf[js.Any])
    @scala.inline
