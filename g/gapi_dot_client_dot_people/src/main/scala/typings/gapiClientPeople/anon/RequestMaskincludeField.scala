...
@js.native
trait RequestMaskincludeField extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object RequestMaskincludeField {
  @scala.inline
  def apply(resourceName: String): RequestMaskincludeField = {
    val __obj = js.Dynamic.literal(resourceName = resourceName.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestMaskincludeField]
  }
  @scala.inline
  implicit class RequestMaskincludeFieldOps[Self <: RequestMaskincludeField] (val x: Self) extends AnyVal {
    @scala.inline
