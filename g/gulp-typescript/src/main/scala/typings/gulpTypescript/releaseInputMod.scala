...
import typings.gulpTypescript.releaseUtilsMod.Map
...
object releaseInputMod {
  ...
  object FileChangeState extends StObject {
    ...
    /* 3 */ val Deleted: typings.gulpTypescript.releaseInputMod.FileChangeState.Deleted & Double = js.native
    
    @js.native
    sealed trait Equal
      extends StObject
         with FileChangeState
    /* 1 */ val Equal: typings.gulpTypescript.releaseInputMod.FileChangeState.Equal & Double = js.native
    
    @js.native
    sealed trait Modified
      extends StObject
         with FileChangeState
    /* 2 */ val Modified: typings.gulpTypescript.releaseInputMod.FileChangeState.Modified & Double = js.native
    
    @js.native
    sealed trait New
      extends StObject
         with FileChangeState
    /* 0 */ val New: typings.gulpTypescript.releaseInputMod.FileChangeState.New & Double = js.native
    
    @js.native
    sealed trait NotFound
      extends StObject
         with FileChangeState
    /* 4 */ val NotFound: typings.gulpTypescript.releaseInputMod.FileChangeState.NotFound & Double = js.native
  }
  ...
  object FileKind extends StObject {
    ...
    sealed trait Config
      extends StObject
         with FileKind
    /* 1 */ val Config: typings.gulpTypescript.releaseInputMod.FileKind.Config & Double = js.native
    
    @js.native
    sealed trait Source
      extends StObject
         with FileKind
    /* 0 */ val Source: typings.gulpTypescript.releaseInputMod.FileKind.Source & Double = js.native
  }
