...
object ^ extends js.Object {
  ...
  def getError(info: typescriptLib.typescriptMod.Diagnostic, typescript: gulpDashTypescriptLib.Typeofts): gulpDashTypescriptLib.releaseReporterMod.TypeScriptError = js.native
  def getError(
