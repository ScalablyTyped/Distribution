...
class FileCache protected () extends js.Object {
  def this(typescript: gulpDashTypescriptLib.Typeofts, options: typescriptLib.typescriptMod.CompilerOptions) = this()
  ...
  var options: typescriptLib.typescriptMod.CompilerOptions = js.native
  var previous: FileDictionary = js.native
  var typescript: gulpDashTypescriptLib.Typeofts = js.native
