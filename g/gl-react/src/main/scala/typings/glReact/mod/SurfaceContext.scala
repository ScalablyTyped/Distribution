...
object SurfaceContext {
  ...
  inline def apply(glParent: Node | Surface[js.Any] | Bus, glSizable: GetGLSize, glSurface: Surface[js.Any]): SurfaceContext = {
  ...
  extension [Self <: SurfaceContext](x: Self) {
    ...
    inline def setGlParent(value: Node | Surface[js.Any] | Bus): Self = StObject.set(x, "glParent", value.asInstanceOf[js.Any])
