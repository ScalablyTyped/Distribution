...
object TextChangeNs extends js.Object {
  ...
  def clone(change: grammarkdownLib.distParserMod.TextChange): grammarkdownLib.Anon_Range = js.native
  def create(text: java.lang.String, range: grammarkdownLib.distCoreMod.Range): grammarkdownLib.Anon_Range = js.native
