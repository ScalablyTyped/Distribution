...
@js.native
object grammarkdownModMembers extends js.Object {
  val Diagnostics: grammarkdownLib.Anon_Thereisnoargumentgivenforparameter0 = js.native
  def forEachChild[T](
  ...
  def isCommentTriviaKind(kind: grammarkdownLib.distTokensMod.SyntaxKind): /* is CommentTriviaKind */scala.Boolean = js.native
  def isHtmlTriviaKind(kind: grammarkdownLib.distTokensMod.SyntaxKind): /* is HtmlTriviaKind */scala.Boolean = js.native
  def isKeywordKind(kind: grammarkdownLib.distTokensMod.SyntaxKind): /* is KeywordKind */scala.Boolean = js.native
  def isProseFragmentLiteralKind(kind: grammarkdownLib.distTokensMod.SyntaxKind): /* is ProseFragmentLiteralKind */scala.Boolean = js.native
  def isPunctuationKind(kind: grammarkdownLib.distTokensMod.SyntaxKind): /* is PunctuationKind */scala.Boolean = js.native
  def isTextContentKind(kind: grammarkdownLib.distTokensMod.SyntaxKind): /* is TextContentKind */scala.Boolean = js.native
  def isTokenKind(kind: grammarkdownLib.distTokensMod.SyntaxKind): /* is TokenKind */scala.Boolean = js.native
  def isTriviaKind(kind: grammarkdownLib.distTokensMod.SyntaxKind): /* is TriviaKind */scala.Boolean = js.native
