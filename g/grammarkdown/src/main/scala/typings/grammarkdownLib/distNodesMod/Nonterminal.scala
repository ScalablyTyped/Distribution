...
class Nonterminal protected ()
  extends OptionalSymbolBase[grammarkdownLib.distTokensMod.SyntaxKind.Nonterminal] {
  def this(name: Identifier) = this()
  def this(name: Identifier, argumentList: ArgumentList) = this()
  def this(name: Identifier, argumentList: js.UndefOr[scala.Nothing], questionToken: Token[grammarkdownLib.distTokensMod.SyntaxKind.QuestionToken]) = this()
  def this(name: Identifier, argumentList: ArgumentList, questionToken: Token[grammarkdownLib.distTokensMod.SyntaxKind.QuestionToken]) = this()
