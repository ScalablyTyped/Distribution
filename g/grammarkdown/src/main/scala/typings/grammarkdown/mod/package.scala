...
@scala.inline
def formatString(format: java.lang.String, args: js.Array[js.Any]): java.lang.String = (typings.grammarkdown.mod.^.asInstanceOf[js.Dynamic].applyDynamic("formatString")(format.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
