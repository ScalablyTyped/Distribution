...
object CoreAsyncHost {
  ...
  inline def forFile(content: String): typings.grammarkdown.hostMod.StringAsyncHost = ^.asInstanceOf[js.Dynamic].applyDynamic("forFile")(content.asInstanceOf[js.Any]).asInstanceOf[typings.grammarkdown.hostMod.StringAsyncHost]
  inline def forFile(content: String, file: String): typings.grammarkdown.hostMod.StringAsyncHost = (^.asInstanceOf[js.Dynamic].applyDynamic("forFile")(content.asInstanceOf[js.Any], file.asInstanceOf[js.Any])).asInstanceOf[typings.grammarkdown.hostMod.StringAsyncHost]
  ...
  /**
    ...
    * @param hostFallback An optional host to use as a fallback for operations not supported by this host.
    */
  inline def forFile(content: js.Thenable[String]): typings.grammarkdown.hostMod.StringAsyncHost = ^.asInstanceOf[js.Dynamic].applyDynamic("forFile")(content.asInstanceOf[js.Any]).asInstanceOf[typings.grammarkdown.hostMod.StringAsyncHost]
  inline def forFile(content: js.Thenable[String], file: String): typings.grammarkdown.hostMod.StringAsyncHost = (^.asInstanceOf[js.Dynamic].applyDynamic("forFile")(content.asInstanceOf[js.Any], file.asInstanceOf[js.Any])).asInstanceOf[typings.grammarkdown.hostMod.StringAsyncHost]
  inline def forFile(
  ...
  /**
    ...
    * @param hostFallback An optional host to use as a fallback for operations not supported by this host.
    */
  inline def from(custom: CoreAsyncHostOptions): typings.grammarkdown.hostMod.CoreAsyncHost = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(custom.asInstanceOf[js.Any]).asInstanceOf[typings.grammarkdown.hostMod.CoreAsyncHost]
  inline def from(custom: CoreAsyncHostOptions, hostFallback: typings.grammarkdown.hostMod.CoreAsyncHost): typings.grammarkdown.hostMod.CoreAsyncHost = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(custom.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any])).asInstanceOf[typings.grammarkdown.hostMod.CoreAsyncHost]
  inline def from(custom: CoreAsyncHostOptions, hostFallback: typings.grammarkdown.hostMod.CoreSyncHost): typings.grammarkdown.hostMod.CoreAsyncHost = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(custom.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any])).asInstanceOf[typings.grammarkdown.hostMod.CoreAsyncHost]
}
