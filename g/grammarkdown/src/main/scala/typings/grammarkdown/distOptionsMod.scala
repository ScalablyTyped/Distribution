...
import typings.grammarkdown.anon.PartialKnownOption
...
object distOptionsMod {
  ...
  @js.native
  open class UsageWriter protected () extends StObject {
    def this(margin: Double, padding: Double) = this()
    
    /* private */ var fit: Any = js.native
    
    /* private */ var margin: Any = js.native
    
    /* private */ var padding: Any = js.native
    
    /* private */ var remainder: Any = js.native
  ...
  type KnownOptions = StringDictionary[PartialKnownOption]
  ...
  object ParsedArguments {
    ...
    extension [Self <: ParsedArguments](x: Self) {
      ...
      inline def setRestVarargs(value: String*): Self = StObject.set(x, "rest", js.Array(value*))
    }
  }
  ...
  object RawArgument {
    ...
    inline def apply(formattedKey: String, option: KnownOption, rawKey: String, value: Any): RawArgument = {
  ...
  object RawArguments {
    ...
    extension [Self <: RawArguments](x: Self) {
      ...
      inline def setArgsVarargs(value: RawArgument*): Self = StObject.set(x, "args", js.Array(value*))
