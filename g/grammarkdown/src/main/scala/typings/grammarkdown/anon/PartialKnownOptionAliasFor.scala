...
@js.native
trait PartialKnownOptionAliasFor extends js.Object {
...
object PartialKnownOptionAliasFor {
  ...
  @scala.inline
  implicit class PartialKnownOptionAliasForOps[Self <: PartialKnownOptionAliasFor] (val x: Self) extends AnyVal {
