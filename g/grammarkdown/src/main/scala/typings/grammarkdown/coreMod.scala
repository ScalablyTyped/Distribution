...
object coreMod {
  ...
  inline def compare(x: js.Any, y: js.Any): `1` | `0` | `-1` = (^.asInstanceOf[js.Dynamic].applyDynamic("compare")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any])).asInstanceOf[`1` | `0` | `-1`]
  ...
  inline def compareStrings(): `1` | `0` | `-1` = ^.asInstanceOf[js.Dynamic].applyDynamic("compareStrings")().asInstanceOf[`1` | `0` | `-1`]
  inline def compareStrings(x: String): `1` | `0` | `-1` = ^.asInstanceOf[js.Dynamic].applyDynamic("compareStrings")(x.asInstanceOf[js.Any]).asInstanceOf[`1` | `0` | `-1`]
  inline def compareStrings(x: String, y: String): `1` | `0` | `-1` = (^.asInstanceOf[js.Dynamic].applyDynamic("compareStrings")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any])).asInstanceOf[`1` | `0` | `-1`]
  inline def compareStrings(x: String, y: String, ignoreCase: Boolean): `1` | `0` | `-1` = (^.asInstanceOf[js.Dynamic].applyDynamic("compareStrings")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[`1` | `0` | `-1`]
  inline def compareStrings(x: String, y: Unit, ignoreCase: Boolean): `1` | `0` | `-1` = (^.asInstanceOf[js.Dynamic].applyDynamic("compareStrings")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[`1` | `0` | `-1`]
  inline def compareStrings(x: Unit, y: String): `1` | `0` | `-1` = (^.asInstanceOf[js.Dynamic].applyDynamic("compareStrings")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any])).asInstanceOf[`1` | `0` | `-1`]
  inline def compareStrings(x: Unit, y: String, ignoreCase: Boolean): `1` | `0` | `-1` = (^.asInstanceOf[js.Dynamic].applyDynamic("compareStrings")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[`1` | `0` | `-1`]
  inline def compareStrings(x: Unit, y: Unit, ignoreCase: Boolean): `1` | `0` | `-1` = (^.asInstanceOf[js.Dynamic].applyDynamic("compareStrings")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[`1` | `0` | `-1`]
  ...
  inline def first[T](iterable: Iterable[T]): js.UndefOr[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("first")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[T]]
  ...
  inline def forEachPossiblyAsync[T, U](iterable: Iterable[T], callback: js.Function1[/* value */ T, js.UndefOr[js.Promise[U] | U]]): Unit | js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("forEachPossiblyAsync")(iterable.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit | js.Promise[Unit]]
  ...
  inline def last[T](iterable: Iterable[T]): js.UndefOr[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("last")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[T]]
  ...
  inline def only[T](iterable: Iterable[T]): js.UndefOr[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("only")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[T]]
  ...
  inline def promiseFinally[T](promise: js.Thenable[T], onFinally: js.Function0[Unit]): js.Thenable[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("promiseFinally")(promise.asInstanceOf[js.Any], onFinally.asInstanceOf[js.Any])).asInstanceOf[js.Thenable[T]]
  ...
  inline def toCancelToken(cancelable: Cancelable): js.UndefOr[CancelToken] = ^.asInstanceOf[js.Dynamic].applyDynamic("toCancelToken")(cancelable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[CancelToken]]
  
  inline def toCancelToken_CancelToken(cancelable: Cancelable): CancelToken = ^.asInstanceOf[js.Dynamic].applyDynamic("toCancelToken")(cancelable.asInstanceOf[js.Any]).asInstanceOf[CancelToken]
  
  inline def wrapCancelToken(): js.UndefOr[CancelToken & CancellationToken] = ^.asInstanceOf[js.Dynamic].applyDynamic("wrapCancelToken")().asInstanceOf[js.UndefOr[CancelToken & CancellationToken]]
  inline def wrapCancelToken(cancelToken: CancelToken): js.UndefOr[CancelToken & CancellationToken] = ^.asInstanceOf[js.Dynamic].applyDynamic("wrapCancelToken")(cancelToken.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[CancelToken & CancellationToken]]
  
  inline def wrapCancelToken_Intersection(cancelToken: CancelToken): CancelToken & CancellationToken = ^.asInstanceOf[js.Dynamic].applyDynamic("wrapCancelToken")(cancelToken.asInstanceOf[js.Any]).asInstanceOf[CancelToken & CancellationToken]
