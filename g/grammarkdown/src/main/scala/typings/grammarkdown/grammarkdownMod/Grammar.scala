...
class Grammar protected () extends StObject {
  ...
  /* private */ var beginParsePossiblyAsync: js.Any = js.native
  ...
  /* private */ var bindPossiblyAsync: js.Any = js.native
  ...
  /* private */ var checkPossiblyAsync: js.Any = js.native
  ...
  /* private */ var emitOnePossiblyAsync: js.Any = js.native
  
  /* private */ var emitPossiblyAsync: js.Any = js.native
  ...
  /* private */ var emitStringPossiblyAsync: js.Any = js.native
  ...
  /* private */ var endBind: js.Any = js.native
  
  /* private */ var endCheck: js.Any = js.native
  
  /* private */ var endEmitPossiblyAsync: js.Any = js.native
  
  /* private */ var endParse: js.Any = js.native
  
  /* private */ var endProcessFilePossiblyAsync: js.Any = js.native
  
  /* private */ var endProcessRootFile: js.Any = js.native
  
  def getSourceFile(file: String): js.UndefOr[SourceFile] = js.native
  
  /* private */ var getSourceFileNoResolve: js.Any = js.native
  
  val host: Host | SyncHost | AsyncHost = js.native
  
  /* private */ var innerBinder: js.Any = js.native
  
  /* private */ var innerChecker: js.Any = js.native
  
  /* private */ var innerEmitter: js.Any = js.native
  ...
  /* private */ var normalizeFile: js.Any = js.native
  ...
  /* private */ var parsePossiblyAsync: js.Any = js.native
  
  /* private */ var parsePromise: js.Any = js.native
  
  /* private */ var parseState: js.Any = js.native
  ...
  /* private */ var processFilePossiblyAsync: js.Any = js.native
  
  /* private */ var processImportsPossiblyAsync: js.Any = js.native
  
  /* private */ var processRootFilePossiblyAsync: js.Any = js.native
  ...
  /* private */ var resolveFile: js.Any = js.native
  
  def resolver: Resolver = js.native
  
  def rootFiles: js.Array[SourceFile] = js.native
  
  /* private */ var rootNames: js.Any = js.native
  
  /* private */ var setSourceFileNoResolve: js.Any = js.native
  ...
  /* private */ var writeFileFallback: js.Any = js.native
  
  /* protected */ def writeFileSync(file: String, content: String): Unit = js.native
  
  /* private */ var writeFileSyncFallback: js.Any = js.native
}
/* static members */
object Grammar {
  ...
  inline def convert(content: String, options: Unit, hostFallback: AsyncHost): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def convert(content: String, options: Unit, hostFallback: AsyncHost, cancelable: Cancelable): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any], cancelable.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def convert(content: String, options: Unit, hostFallback: AsyncHost, cancelable: CancellationToken): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any], cancelable.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def convert(content: String, options: Unit, hostFallback: SyncHost): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def convert(content: String, options: Unit, hostFallback: SyncHost, cancelable: Cancelable): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any], cancelable.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def convert(content: String, options: Unit, hostFallback: SyncHost, cancelable: CancellationToken): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any], cancelable.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def convert(content: String, options: CompilerOptions, hostFallback: AsyncHost): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def convert(content: String, options: CompilerOptions, hostFallback: AsyncHost, cancelable: Cancelable): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any], cancelable.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def convert(content: String, options: CompilerOptions, hostFallback: AsyncHost, cancelable: CancellationToken): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any], cancelable.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def convert(content: String, options: CompilerOptions, hostFallback: SyncHost): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def convert(content: String, options: CompilerOptions, hostFallback: SyncHost, cancelable: Cancelable): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any], cancelable.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def convert(content: String, options: CompilerOptions, hostFallback: SyncHost, cancelable: CancellationToken): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convert")(content.asInstanceOf[js.Any], options.asInstanceOf[js.Any], hostFallback.asInstanceOf[js.Any], cancelable.asInstanceOf[js.Any])).asInstanceOf[String]
}
