...
@JSImport("grammarkdown/dist/grammarkdown", "UnicodeCharacterLiteral")
@js.native
class UnicodeCharacterLiteral ()
  extends OptionalSymbolBase[typings.grammarkdown.grammarkdownMod.SyntaxKind.UnicodeCharacterLiteral]
     with TextContent {
