...
package object grammarkdownMod {
  ...
  @scala.inline
  def formatString(format: java.lang.String, args: js.Array[_]): java.lang.String = (typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("formatString")(format.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
