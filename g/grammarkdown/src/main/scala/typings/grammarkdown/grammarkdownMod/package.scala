...
@scala.inline
def formatList(tokens: js.Array[typings.grammarkdown.grammarkdownMod.SyntaxKind | java.lang.String]): java.lang.String = typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("formatList")(tokens.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]

@scala.inline
def formatString(format: java.lang.String): java.lang.String = typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("formatString")(format.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
@scala.inline
def formatString(format: java.lang.String, args: js.Any*): java.lang.String = (typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("formatString")(format.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
@scala.inline
def formatString(format: java.lang.String, args: js.Array[js.Any]): java.lang.String = (typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("formatString")(format.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]

@scala.inline
def getDefaultOptions(): typings.grammarkdown.grammarkdownMod.CompilerOptions = typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultOptions")().asInstanceOf[typings.grammarkdown.grammarkdownMod.CompilerOptions]
...
@scala.inline
def parse[T /* <: typings.grammarkdown.grammarkdownMod.ParsedArguments */](options: typings.grammarkdown.grammarkdownMod.KnownOptions): js.UndefOr[T] = typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("parse")(options.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[T]]
@scala.inline
...
@scala.inline
def skipTrivia(text: java.lang.String, pos: scala.Double, end: scala.Double): scala.Double = (typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("skipTrivia")(text.asInstanceOf[js.Any], pos.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[scala.Double]
@scala.inline
def skipTrivia(
...
@scala.inline
def stringToToken(text: java.lang.String): js.UndefOr[typings.grammarkdown.grammarkdownMod.SyntaxKind] = typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("stringToToken")(text.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typings.grammarkdown.grammarkdownMod.SyntaxKind]]

@scala.inline
def tokenToString(kind: java.lang.String): java.lang.String = typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("tokenToString")(kind.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
@scala.inline
def tokenToString(kind: java.lang.String, quoted: scala.Boolean): java.lang.String = (typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("tokenToString")(kind.asInstanceOf[js.Any], quoted.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
@scala.inline
def tokenToString(kind: typings.grammarkdown.grammarkdownMod.SyntaxKind): java.lang.String = typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("tokenToString")(kind.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
@scala.inline
def tokenToString(kind: typings.grammarkdown.grammarkdownMod.SyntaxKind, quoted: scala.Boolean): java.lang.String = (typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("tokenToString")(kind.asInstanceOf[js.Any], quoted.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]

@scala.inline
def usage(options: typings.grammarkdown.grammarkdownMod.KnownOptions): scala.Unit = typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("usage")(options.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
@scala.inline
def usage(options: typings.grammarkdown.grammarkdownMod.KnownOptions, margin: scala.Double): scala.Unit = (typings.grammarkdown.grammarkdownMod.^.asInstanceOf[js.Dynamic].applyDynamic("usage")(options.asInstanceOf[js.Any], margin.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
@scala.inline
def usage(
