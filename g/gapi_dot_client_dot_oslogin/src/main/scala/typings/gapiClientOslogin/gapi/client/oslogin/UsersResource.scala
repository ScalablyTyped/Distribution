...
import typings.gapiClientOslogin.AnonAccesstokenAltBearertoken
...
trait UsersResource extends js.Object {
  ...
  /**
    ...
    * login profile.
    */
  def importSshPublicKey(request: AnonAccesstokenAltBearertoken): Request_[ImportSshPublicKeyResponse]
}
...
object UsersResource {
  ...
  def apply(
    ...
    importSshPublicKey: AnonAccesstokenAltBearertoken => Request_[ImportSshPublicKeyResponse],
