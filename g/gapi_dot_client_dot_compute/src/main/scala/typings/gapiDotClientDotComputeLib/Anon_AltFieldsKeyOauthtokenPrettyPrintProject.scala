...
trait Anon_AltFieldsKeyOauthtokenPrettyPrintProject extends js.Object {
...
object Anon_AltFieldsKeyOauthtokenPrettyPrintProject {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltFieldsKeyOauthtokenPrettyPrintProject]
  }
}
