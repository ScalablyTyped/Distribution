...
trait Anon_AltBackendServiceFieldsKey extends js.Object {
...
object Anon_AltBackendServiceFieldsKey {
  @scala.inline
  def apply(
  ...
  ): Anon_AltBackendServiceFieldsKey = {
    ...
    __obj.asInstanceOf[Anon_AltBackendServiceFieldsKey]
  }
}
