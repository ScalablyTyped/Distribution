...
trait Anon_AccessConfig extends js.Object {
  /** The name of the access config to delete. */
  var accessConfig: java.lang.String
...
object Anon_AccessConfig {
  @scala.inline
  def apply(
    accessConfig: java.lang.String,
    ...
    __obj.asInstanceOf[Anon_AccessConfig]
  }
}
