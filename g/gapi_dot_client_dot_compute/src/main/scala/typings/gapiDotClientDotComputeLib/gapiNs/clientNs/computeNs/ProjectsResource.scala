...
trait ProjectsResource extends js.Object {
  ...
  def get(
    request: gapiDotClientDotComputeLib.Anon_ProjectPrettyPrintQuotaUserKeyUserIpOauthtokenAltFieldsString
  ...
  def getXpnResources(request: gapiDotClientDotComputeLib.Anon_ProjectMaxResultsPrettyPrintPageTokenQuotaUser): gapiDotClientLib.gapiNs.clientNs.Request[ProjectsGetXpnResources]
  /** List all shared VPC host projects visible to the user in an organization. */
  def listXpnHosts(request: gapiDotClientDotComputeLib.Anon_ProjectMaxResultsPrettyPrintPageTokenQuotaUser): gapiDotClientLib.gapiNs.clientNs.Request[XpnHostList]
