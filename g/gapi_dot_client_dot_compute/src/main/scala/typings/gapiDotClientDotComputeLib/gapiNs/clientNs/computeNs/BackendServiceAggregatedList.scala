...
trait BackendServiceAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[stdLib.Record[java.lang.String, BackendServicesScopedList]] = js.undefined
  /** Type of resource. */
...
object BackendServiceAggregatedList {
  ...
  def apply(
    ...
    items: stdLib.Record[java.lang.String, BackendServicesScopedList] = null,
