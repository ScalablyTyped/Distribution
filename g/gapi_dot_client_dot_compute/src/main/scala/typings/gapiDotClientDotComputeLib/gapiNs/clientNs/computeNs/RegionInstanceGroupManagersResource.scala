...
trait RegionInstanceGroupManagersResource extends js.Object {
  /**
               ...
               */
  def abandonInstances(request: gapiDotClientDotComputeLib.Anon_InstanceGroupManagerProjectPrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Deletes the specified managed instance group and all of the instances in that group. */
  def delete(request: gapiDotClientDotComputeLib.Anon_InstanceGroupManagerProjectPrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /**
               ...
               * You can specify a maximum of 1000 instances with this method per request.
               */
  def deleteInstances(request: gapiDotClientDotComputeLib.Anon_InstanceGroupManagerProjectPrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Returns all of the details about the specified managed instance group. */
  def get(request: gapiDotClientDotComputeLib.Anon_InstanceGroupManagerProjectPrettyPrintQuotaUser): gapiDotClientLib.gapiNs.clientNs.Request[InstanceGroupManager]
  /**
  ...
  def list(request: gapiDotClientDotComputeLib.Anon_ProjectMaxResultsPrettyPrintPageToken): gapiDotClientLib.gapiNs.clientNs.Request[RegionInstanceGroupManagerList]
  /**
               ...
               */
  def listManagedInstances(request: gapiDotClientDotComputeLib.Anon_InstanceGroupManagerProjectMaxResultsPrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[RegionInstanceGroupManagersListInstancesResponse]
  /**
               ...
               * You can specify a maximum of 1000 instances with this method per request.
               */
  def recreateInstances(request: gapiDotClientDotComputeLib.Anon_InstanceGroupManagerProjectPrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /**
               ...
               * elapsed before the VM instance is removed or deleted.
               */
  def resize(request: gapiDotClientDotComputeLib.Anon_SizeInstanceGroupManager): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Sets the instance template to use when creating new instances or recreating instances in this group. Existing instances are not affected. */
  def setInstanceTemplate(request: gapiDotClientDotComputeLib.Anon_InstanceGroupManagerProjectPrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Modifies the target pools to which all new instances in this group are assigned. Existing instances in the group are not affected. */
  def setTargetPools(request: gapiDotClientDotComputeLib.Anon_InstanceGroupManagerProjectPrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
}
