...
trait TargetInstanceList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[java.lang.String] = js.undefined
  /** A list of TargetInstance resources. */
  var items: js.UndefOr[js.Array[TargetInstance]] = js.undefined
  /** Type of resource. */
...
object TargetInstanceList {
  @scala.inline
  def apply(
    id: java.lang.String = null,
    items: js.Array[TargetInstance] = null,
    ...
    __obj.asInstanceOf[TargetInstanceList]
  }
}
