...
trait TargetInstanceAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[stdLib.Record[java.lang.String, TargetInstancesScopedList]] = js.undefined
  /** Type of resource. */
...
object TargetInstanceAggregatedList {
  ...
  def apply(
    ...
    items: stdLib.Record[java.lang.String, TargetInstancesScopedList] = null,
