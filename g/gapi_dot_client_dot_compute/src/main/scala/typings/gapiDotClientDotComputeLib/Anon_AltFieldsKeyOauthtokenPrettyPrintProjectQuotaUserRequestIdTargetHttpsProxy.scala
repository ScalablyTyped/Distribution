...
trait Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetHttpsProxy extends js.Object {
  ...
  var targetHttpsProxy: java.lang.String
  /** IP address of the site where the request originates. Use this if you want to enforce per-user limits. */
  var userIp: js.UndefOr[java.lang.String] = js.undefined
}

object Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetHttpsProxy {
  @scala.inline
  def apply(
    project: java.lang.String,
    targetHttpsProxy: java.lang.String,
  ...
  ): Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetHttpsProxy = {
    val __obj = js.Dynamic.literal(project = project, targetHttpsProxy = targetHttpsProxy)
    ...
    __obj.asInstanceOf[Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetHttpsProxy]
  }
}
