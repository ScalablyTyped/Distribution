...
trait Anon_AltFieldsForwardingRule extends js.Object {
...
object Anon_AltFieldsForwardingRule {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltFieldsForwardingRule]
  }
}
