...
trait Anon_AltAutoDelete extends js.Object {
  /** Data format for the response. */
  var alt: js.UndefOr[java.lang.String] = js.undefined
  /** Whether to auto-delete the disk when the instance is deleted. */
  var autoDelete: scala.Boolean
...
object Anon_AltAutoDelete {
  @scala.inline
  def apply(
    autoDelete: scala.Boolean,
    ...
    __obj.asInstanceOf[Anon_AltAutoDelete]
  }
}
