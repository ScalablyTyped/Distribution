...
trait Anon_AltDeviceName extends js.Object {
...
object Anon_AltDeviceName {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(deviceName = deviceName, instance = instance, project = project, zone = zone)
    ...
    __obj.asInstanceOf[Anon_AltDeviceName]
  }
}
