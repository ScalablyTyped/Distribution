...
trait Anon_AltFieldsInstanceTemplate extends js.Object {
  /** Data format for the response. */
  var alt: js.UndefOr[java.lang.String] = js.undefined
  /** Selector specifying which fields to include in a partial response. */
  var fields: js.UndefOr[java.lang.String] = js.undefined
  /** The name of the instance template to delete. */
  var instanceTemplate: java.lang.String
...
object Anon_AltFieldsInstanceTemplate {
  @scala.inline
  def apply(
  ...
  ): Anon_AltFieldsInstanceTemplate = {
    val __obj = js.Dynamic.literal(instanceTemplate = instanceTemplate, project = project)
    ...
    __obj.asInstanceOf[Anon_AltFieldsInstanceTemplate]
  }
}
