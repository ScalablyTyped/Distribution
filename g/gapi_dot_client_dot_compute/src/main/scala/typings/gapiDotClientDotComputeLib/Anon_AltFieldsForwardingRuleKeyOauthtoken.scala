...
trait Anon_AltFieldsForwardingRuleKeyOauthtoken extends js.Object {
...
object Anon_AltFieldsForwardingRuleKeyOauthtoken {
  @scala.inline
  def apply(
  ...
  ): Anon_AltFieldsForwardingRuleKeyOauthtoken = {
    ...
    __obj.asInstanceOf[Anon_AltFieldsForwardingRuleKeyOauthtoken]
  }
}
