...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetInstance extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetInstance {
  @scala.inline
  def apply(
    project: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetInstance = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetInstance]
  }
}
