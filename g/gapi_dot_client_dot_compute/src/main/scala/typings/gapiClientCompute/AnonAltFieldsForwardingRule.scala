...
trait AnonAltFieldsForwardingRule extends js.Object {
...
object AnonAltFieldsForwardingRule {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAltFieldsForwardingRule]
  }
}
