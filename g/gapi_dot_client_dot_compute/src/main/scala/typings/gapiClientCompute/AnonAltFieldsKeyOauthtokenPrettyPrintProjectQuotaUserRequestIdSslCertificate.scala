...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdSslCertificate extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdSslCertificate {
  @scala.inline
  def apply(
    project: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdSslCertificate = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdSslCertificate]
  }
}
