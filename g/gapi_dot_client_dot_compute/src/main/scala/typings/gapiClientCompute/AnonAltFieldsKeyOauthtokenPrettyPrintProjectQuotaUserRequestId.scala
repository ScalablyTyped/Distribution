...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId {
  @scala.inline
  def apply(
    project: String,
    route: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId]
  }
}
