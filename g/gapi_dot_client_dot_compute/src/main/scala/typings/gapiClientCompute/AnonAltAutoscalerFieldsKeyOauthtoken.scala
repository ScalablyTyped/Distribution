...
trait AnonAltAutoscalerFieldsKeyOauthtoken extends js.Object {
...
object AnonAltAutoscalerFieldsKeyOauthtoken {
  @scala.inline
  def apply(
    autoscaler: String,
    project: String,
    ...
    userIp: String = null
  ): AnonAltAutoscalerFieldsKeyOauthtoken = {
    ...
    __obj.asInstanceOf[AnonAltAutoscalerFieldsKeyOauthtoken]
  }
}
