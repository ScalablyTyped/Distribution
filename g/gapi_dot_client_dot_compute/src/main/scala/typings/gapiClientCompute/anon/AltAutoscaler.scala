...
@js.native
trait AltAutoscaler extends js.Object {
  /** Data format for the response. */
  var alt: js.UndefOr[String] = js.native
  /** Name of the autoscaler to delete. */
  var autoscaler: String = js.native
...
object AltAutoscaler {
  @scala.inline
  def apply(autoscaler: String, project: String, region: String): AltAutoscaler = {
    ...
    __obj.asInstanceOf[AltAutoscaler]
  }
  @scala.inline
  implicit class AltAutoscalerOps[Self <: AltAutoscaler] (val x: Self) extends AnyVal {
    @scala.inline
