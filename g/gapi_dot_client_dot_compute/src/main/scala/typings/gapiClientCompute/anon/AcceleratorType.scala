...
trait AcceleratorType extends js.Object {
  ...
  var acceleratorType: String = js.native
...
object AcceleratorType {
  @scala.inline
  def apply(acceleratorType: String, project: String, zone: String): AcceleratorType = {
    val __obj = js.Dynamic.literal(acceleratorType = acceleratorType.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
