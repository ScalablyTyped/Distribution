...
@js.native
trait InstanceKey extends js.Object {
...
object InstanceKey {
  @scala.inline
  def apply(instance: String, project: String, zone: String): InstanceKey = {
  ...
  @scala.inline
  implicit class InstanceKeyOps[Self <: InstanceKey] (val x: Self) extends AnyVal {
    @scala.inline
