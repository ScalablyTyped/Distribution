...
@js.native
trait FieldsForwardingRule extends js.Object {
...
object FieldsForwardingRule {
  @scala.inline
  def apply(forwardingRule: String, project: String): FieldsForwardingRule = {
    val __obj = js.Dynamic.literal(forwardingRule = forwardingRule.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsForwardingRule]
  }
  @scala.inline
  implicit class FieldsForwardingRuleOps[Self <: FieldsForwardingRule] (val x: Self) extends AnyVal {
    @scala.inline
