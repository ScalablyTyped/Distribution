...
object AccessConfig {
  @scala.inline
  def apply(accessConfig: String, instance: String, networkInterface: String, project: String, zone: String): AccessConfig = {
    val __obj = js.Dynamic.literal(accessConfig = accessConfig.asInstanceOf[js.Any], instance = instance.asInstanceOf[js.Any], networkInterface = networkInterface.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
