...
@js.native
trait BackendServiceFields extends js.Object {
...
object BackendServiceFields {
  @scala.inline
  def apply(backendService: String, project: String, region: String): BackendServiceFields = {
    ...
    __obj.asInstanceOf[BackendServiceFields]
  }
  @scala.inline
  implicit class BackendServiceFieldsOps[Self <: BackendServiceFields] (val x: Self) extends AnyVal {
    @scala.inline
