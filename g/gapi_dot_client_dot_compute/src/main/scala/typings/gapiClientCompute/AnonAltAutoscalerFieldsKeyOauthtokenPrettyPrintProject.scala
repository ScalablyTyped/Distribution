...
trait AnonAltAutoscalerFieldsKeyOauthtokenPrettyPrintProject extends js.Object {
...
object AnonAltAutoscalerFieldsKeyOauthtokenPrettyPrintProject {
  @scala.inline
  def apply(
    project: String,
    region: String,
    ...
    userIp: String = null
  ): AnonAltAutoscalerFieldsKeyOauthtokenPrettyPrintProject = {
    ...
    __obj.asInstanceOf[AnonAltAutoscalerFieldsKeyOauthtokenPrettyPrintProject]
  }
}
