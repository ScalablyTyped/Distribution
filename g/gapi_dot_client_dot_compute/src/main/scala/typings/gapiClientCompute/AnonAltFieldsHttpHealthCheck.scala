...
trait AnonAltFieldsHttpHealthCheck extends js.Object {
...
object AnonAltFieldsHttpHealthCheck {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAltFieldsHttpHealthCheck]
  }
}
