...
trait AnonAltFieldsFilterInstanceGroupKey extends js.Object {
...
object AnonAltFieldsFilterInstanceGroupKey {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): AnonAltFieldsFilterInstanceGroupKey = {
    ...
    __obj.asInstanceOf[AnonAltFieldsFilterInstanceGroupKey]
  }
}
