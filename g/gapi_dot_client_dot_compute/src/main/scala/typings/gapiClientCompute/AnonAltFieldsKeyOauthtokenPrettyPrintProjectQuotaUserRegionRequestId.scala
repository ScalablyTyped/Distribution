...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestId extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestId {
  @scala.inline
  def apply(
    project: String,
    region: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestId = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestId]
  }
}
