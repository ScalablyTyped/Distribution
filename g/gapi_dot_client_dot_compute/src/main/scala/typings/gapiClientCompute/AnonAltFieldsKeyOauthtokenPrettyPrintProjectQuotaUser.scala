...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser {
  @scala.inline
  def apply(
    project: String,
    resource: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUser]
  }
}
