...
trait AnonAltBackendServiceFieldsKey extends js.Object {
...
object AnonAltBackendServiceFieldsKey {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): AnonAltBackendServiceFieldsKey = {
    ...
    __obj.asInstanceOf[AnonAltBackendServiceFieldsKey]
  }
}
