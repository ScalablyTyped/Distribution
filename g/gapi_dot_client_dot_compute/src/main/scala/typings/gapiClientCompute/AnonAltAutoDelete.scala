...
trait AnonAltAutoDelete extends js.Object {
...
object AnonAltAutoDelete {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(autoDelete = autoDelete.asInstanceOf[js.Any], deviceName = deviceName.asInstanceOf[js.Any], instance = instance.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[AnonAltAutoDelete]
  }
}
