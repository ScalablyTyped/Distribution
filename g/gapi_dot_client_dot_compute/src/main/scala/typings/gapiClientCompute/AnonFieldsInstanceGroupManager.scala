...
trait AnonFieldsInstanceGroupManager extends js.Object {
...
object AnonFieldsInstanceGroupManager {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): AnonFieldsInstanceGroupManager = {
    ...
    __obj.asInstanceOf[AnonFieldsInstanceGroupManager]
  }
}
