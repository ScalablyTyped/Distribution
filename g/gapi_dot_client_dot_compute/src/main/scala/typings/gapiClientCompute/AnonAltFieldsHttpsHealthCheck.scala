...
trait AnonAltFieldsHttpsHealthCheck extends js.Object {
...
object AnonAltFieldsHttpsHealthCheck {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAltFieldsHttpsHealthCheck]
  }
}
