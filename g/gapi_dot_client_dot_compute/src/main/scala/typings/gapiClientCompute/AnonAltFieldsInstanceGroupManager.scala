...
trait AnonAltFieldsInstanceGroupManager extends js.Object {
...
object AnonAltFieldsInstanceGroupManager {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): AnonAltFieldsInstanceGroupManager = {
    ...
    __obj.asInstanceOf[AnonAltFieldsInstanceGroupManager]
  }
}
