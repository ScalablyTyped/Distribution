...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdSnapshot extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdSnapshot {
  @scala.inline
  def apply(
    project: String,
    snapshot: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdSnapshot = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdSnapshot]
  }
}
