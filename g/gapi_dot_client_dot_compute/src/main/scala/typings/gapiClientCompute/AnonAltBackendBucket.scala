...
trait AnonAltBackendBucket extends js.Object {
...
object AnonAltBackendBucket {
  ...
  def apply(
    ...
    userIp: String = null
  ): AnonAltBackendBucket = {
    val __obj = js.Dynamic.literal(backendBucket = backendBucket.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[AnonAltBackendBucket]
  }
}
