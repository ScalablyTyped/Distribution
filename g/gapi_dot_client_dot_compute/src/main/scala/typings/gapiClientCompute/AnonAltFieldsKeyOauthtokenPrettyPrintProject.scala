...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProject extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProject {
  @scala.inline
  def apply(
    project: String,
    zone: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProject = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProject]
  }
}
