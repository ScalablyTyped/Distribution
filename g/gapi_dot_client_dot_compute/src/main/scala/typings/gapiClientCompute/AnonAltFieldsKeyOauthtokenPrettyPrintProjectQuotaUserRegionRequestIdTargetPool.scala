...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdTargetPool extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdTargetPool {
  @scala.inline
  def apply(
    project: String,
    region: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdTargetPool = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdTargetPool]
  }
}
