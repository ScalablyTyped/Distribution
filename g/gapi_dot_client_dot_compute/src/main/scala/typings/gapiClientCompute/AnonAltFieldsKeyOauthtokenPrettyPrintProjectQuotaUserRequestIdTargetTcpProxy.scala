...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetTcpProxy extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetTcpProxy {
  @scala.inline
  def apply(
    project: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetTcpProxy = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdTargetTcpProxy]
  }
}
