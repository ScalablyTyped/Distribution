...
trait AcceleratorTypeAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, AcceleratorTypesScopedList]] = js.native
...
object AcceleratorTypeAggregatedList {
  ...
  implicit class AcceleratorTypeAggregatedListOps[Self <: AcceleratorTypeAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Record[String, AcceleratorTypesScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
