...
trait RouterAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, RoutersScopedList]] = js.native
  /** Type of resource. */
...
object RouterAggregatedList {
  ...
  implicit class RouterAggregatedListOps[Self <: RouterAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Record[String, RoutersScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
