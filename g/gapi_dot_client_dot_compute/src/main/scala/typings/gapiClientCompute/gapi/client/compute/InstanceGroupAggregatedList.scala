...
trait InstanceGroupAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, InstanceGroupsScopedList]] = js.native
...
object InstanceGroupAggregatedList {
  ...
  implicit class InstanceGroupAggregatedListOps[Self <: InstanceGroupAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Record[String, InstanceGroupsScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
