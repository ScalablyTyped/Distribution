...
@js.native
trait AcceleratorTypeList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  /** A list of AcceleratorType resources. */
  var items: js.UndefOr[js.Array[AcceleratorType]] = js.native
...
object AcceleratorTypeList {
  @scala.inline
  def apply(): AcceleratorTypeList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AcceleratorTypeList]
  }
  @scala.inline
  implicit class AcceleratorTypeListOps[Self <: AcceleratorTypeList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: AcceleratorType*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[AcceleratorType]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
