...
import typings.gapiClientCompute.AnonAddressAltFields
import typings.gapiClientCompute.AnonAddressAltFieldsKey
...
trait GlobalAddressesResource extends js.Object {
  ...
  def delete(request: AnonAddressAltFields): Request_[Operation]
  /** Returns the specified address resource. Get a list of available addresses by making a list() request. */
  def get(request: AnonAddressAltFieldsKey): Request_[Address]
...
object GlobalAddressesResource {
  @scala.inline
  def apply(
    delete: AnonAddressAltFields => Request_[Operation],
    get: AnonAddressAltFieldsKey => Request_[Address],
