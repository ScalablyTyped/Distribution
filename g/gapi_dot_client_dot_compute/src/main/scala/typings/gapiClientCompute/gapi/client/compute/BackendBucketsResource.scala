...
trait BackendBucketsResource extends js.Object {
  ...
  def delete(request: typings.gapiClientCompute.anon.BackendBucket): Request[Operation] = js.native
  ...
  /**
    ...
    */
  def patch(request: typings.gapiClientCompute.anon.BackendBucket): Request[Operation] = js.native
  /** Updates the specified BackendBucket resource with the data included in the request. */
  def update(request: typings.gapiClientCompute.anon.BackendBucket): Request[Operation] = js.native
}
...
object BackendBucketsResource {
  ...
  implicit class BackendBucketsResourceOps[Self <: BackendBucketsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDelete(value: typings.gapiClientCompute.anon.BackendBucket => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setPatch(value: typings.gapiClientCompute.anon.BackendBucket => Request[Operation]): Self = this.set("patch", js.Any.fromFunction1(value))
    @scala.inline
    def setUpdate(value: typings.gapiClientCompute.anon.BackendBucket => Request[Operation]): Self = this.set("update", js.Any.fromFunction1(value))
  }
