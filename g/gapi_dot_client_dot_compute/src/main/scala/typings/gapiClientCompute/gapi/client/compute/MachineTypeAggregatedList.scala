...
trait MachineTypeAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, MachineTypesScopedList]] = js.native
...
object MachineTypeAggregatedList {
  ...
  implicit class MachineTypeAggregatedListOps[Self <: MachineTypeAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Record[String, MachineTypesScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
