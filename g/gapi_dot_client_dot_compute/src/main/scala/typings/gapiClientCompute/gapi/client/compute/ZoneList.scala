...
@js.native
trait ZoneList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.native
  /** A list of Zone resources. */
  var items: js.UndefOr[js.Array[Zone]] = js.native
  /** Type of resource. */
...
object ZoneList {
  ...
  @scala.inline
  implicit class ZoneListOps[Self <: ZoneList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: Zone*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Zone]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
