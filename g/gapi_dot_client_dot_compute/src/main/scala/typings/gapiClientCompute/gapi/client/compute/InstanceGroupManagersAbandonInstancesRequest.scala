...
object InstanceGroupManagersAbandonInstancesRequest {
  @scala.inline
  def apply(): InstanceGroupManagersAbandonInstancesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InstanceGroupManagersAbandonInstancesRequest]
  }
  @scala.inline
  implicit class InstanceGroupManagersAbandonInstancesRequestOps[Self <: InstanceGroupManagersAbandonInstancesRequest] (val x: Self) extends AnyVal {
    @scala.inline
