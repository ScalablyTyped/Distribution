...
trait InstanceGroupsResource extends js.Object {
  /**
    ...
    */
  def addInstances(request: typings.gapiClientCompute.anon.InstanceGroup): Request[Operation]
  ...
  /**
    ...
    */
  def delete(request: typings.gapiClientCompute.anon.InstanceGroup): Request[Operation]
  ...
  /**
    ...
    */
  def removeInstances(request: typings.gapiClientCompute.anon.InstanceGroup): Request[Operation]
  /** Sets the named ports for the specified instance group. */
  def setNamedPorts(request: typings.gapiClientCompute.anon.InstanceGroup): Request[Operation]
}
