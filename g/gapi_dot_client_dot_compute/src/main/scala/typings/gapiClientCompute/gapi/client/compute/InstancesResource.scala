...
trait InstancesResource extends js.Object {
  ...
  def addAccessConfig(request: typings.gapiClientCompute.anon.Instance): Request[Operation]
  ...
  def deleteAccessConfig(request: typings.gapiClientCompute.anon.AccessConfig): Request[Operation]
