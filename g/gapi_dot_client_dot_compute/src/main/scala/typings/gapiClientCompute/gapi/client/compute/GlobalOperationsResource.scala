...
import typings.gapiClientCompute.AnonAltFieldsKeyOauthtokenOperation
...
trait GlobalOperationsResource extends js.Object {
  ...
  def delete(request: AnonAltFieldsKeyOauthtokenOperation): Request_[Unit]
  /** Retrieves the specified Operations resource. Get a list of operations by making a list() request. */
  def get(request: AnonAltFieldsKeyOauthtokenOperation): Request_[Operation]
...
object GlobalOperationsResource {
  ...
  def apply(
    ...
    delete: AnonAltFieldsKeyOauthtokenOperation => Request_[Unit],
    get: AnonAltFieldsKeyOauthtokenOperation => Request_[Operation],
