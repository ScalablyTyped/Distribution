...
trait VpnTunnelsResource extends js.Object {
  ...
  def delete(request: typings.gapiClientCompute.anon.VpnTunnel): Request[Operation] = js.native
...
object VpnTunnelsResource {
  ...
  implicit class VpnTunnelsResourceOps[Self <: VpnTunnelsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDelete(value: typings.gapiClientCompute.anon.VpnTunnel => Request[Operation]): Self = this.set("delete", js.Any.fromFunction1(value))
    @scala.inline
