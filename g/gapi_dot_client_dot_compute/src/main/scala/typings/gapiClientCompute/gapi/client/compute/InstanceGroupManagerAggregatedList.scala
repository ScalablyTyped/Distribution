...
trait InstanceGroupManagerAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, InstanceGroupManagersScopedList]] = js.native
...
object InstanceGroupManagerAggregatedList {
  ...
  implicit class InstanceGroupManagerAggregatedListOps[Self <: InstanceGroupManagerAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Record[String, InstanceGroupManagersScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
