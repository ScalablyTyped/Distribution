...
trait SubnetworkAggregatedList extends js.Object {
  ...
  var items: js.UndefOr[Record[String, SubnetworksScopedList]] = js.native
...
object SubnetworkAggregatedList {
  ...
  implicit class SubnetworkAggregatedListOps[Self <: SubnetworkAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Record[String, SubnetworksScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
