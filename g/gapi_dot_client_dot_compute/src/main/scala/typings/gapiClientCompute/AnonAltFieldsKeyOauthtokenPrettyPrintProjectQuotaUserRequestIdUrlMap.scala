...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdUrlMap extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdUrlMap {
  @scala.inline
  def apply(
    project: String,
    urlMap: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdUrlMap = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestIdUrlMap]
  }
}
