...
trait AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdSubnetwork extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdSubnetwork {
  @scala.inline
  def apply(
    project: String,
    region: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdSubnetwork = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdSubnetwork]
  }
}
