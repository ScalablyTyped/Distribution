...
trait AnonAltFieldsInstanceTemplate extends js.Object {
...
object AnonAltFieldsInstanceTemplate {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAltFieldsInstanceTemplate]
  }
}
