...
trait AnonAltFieldsInstanceGroup extends js.Object {
...
object AnonAltFieldsInstanceGroup {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAltFieldsInstanceGroup]
  }
}
