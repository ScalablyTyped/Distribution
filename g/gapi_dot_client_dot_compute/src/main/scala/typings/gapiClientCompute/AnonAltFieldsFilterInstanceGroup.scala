...
trait AnonAltFieldsFilterInstanceGroup extends js.Object {
...
object AnonAltFieldsFilterInstanceGroup {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): AnonAltFieldsFilterInstanceGroup = {
    ...
    __obj.asInstanceOf[AnonAltFieldsFilterInstanceGroup]
  }
}
