...
trait AnonAltAutoscalerFieldsKey extends js.Object {
...
object AnonAltAutoscalerFieldsKey {
  @scala.inline
  def apply(
    project: String,
    zone: String,
    ...
    __obj.asInstanceOf[AnonAltAutoscalerFieldsKey]
  }
}
