...
trait Anon_AltFieldsInstanceGroupKeyOauthtokenPrettyPrint extends js.Object {
...
object Anon_AltFieldsInstanceGroupKeyOauthtokenPrettyPrint {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): Anon_AltFieldsInstanceGroupKeyOauthtokenPrettyPrint = {
    ...
    __obj.asInstanceOf[Anon_AltFieldsInstanceGroupKeyOauthtokenPrettyPrint]
  }
}
