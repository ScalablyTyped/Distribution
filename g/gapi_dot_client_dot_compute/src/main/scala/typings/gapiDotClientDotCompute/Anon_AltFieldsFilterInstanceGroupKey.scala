...
trait Anon_AltFieldsFilterInstanceGroupKey extends js.Object {
...
object Anon_AltFieldsFilterInstanceGroupKey {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltFieldsFilterInstanceGroupKey]
  }
}
