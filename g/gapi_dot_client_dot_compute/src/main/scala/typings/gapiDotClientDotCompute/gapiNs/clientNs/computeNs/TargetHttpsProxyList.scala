...
trait TargetHttpsProxyList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  /** A list of TargetHttpsProxy resources. */
  var items: js.UndefOr[js.Array[TargetHttpsProxy]] = js.undefined
...
object TargetHttpsProxyList {
  @scala.inline
  def apply(
    id: String = null,
    items: js.Array[TargetHttpsProxy] = null,
    kind: String = null,
