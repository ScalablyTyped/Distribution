...
trait BackendBucketList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  /** A list of BackendBucket resources. */
  var items: js.UndefOr[js.Array[BackendBucket]] = js.undefined
  /** Type of resource. */
...
object BackendBucketList {
  @scala.inline
  def apply(
    id: String = null,
    items: js.Array[BackendBucket] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[BackendBucketList]
  }
}
