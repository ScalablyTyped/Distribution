...
import typings.gapiDotClientDotCompute.Anon_AltFieldsFilterInstanceGroupManagerKey
import typings.gapiDotClientDotCompute.Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint
import typings.gapiDotClientDotCompute.Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProject
import typings.gapiDotClientDotCompute.Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser
...
trait RegionInstanceGroupManagersResource extends js.Object {
  /**
    ...
    */
  def abandonInstances(request: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint): Request[Operation]
  /** Deletes the specified managed instance group and all of the instances in that group. */
  def delete(request: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint): Request[Operation]
  /**
    ...
    * You can specify a maximum of 1000 instances with this method per request.
    */
  def deleteInstances(request: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint): Request[Operation]
  /** Returns all of the details about the specified managed instance group. */
  def get(request: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProject): Request[InstanceGroupManager]
  /**
  ...
  def list(request: Anon_AltFieldsFilter): Request[RegionInstanceGroupManagerList]
  /**
    ...
    */
  def listManagedInstances(request: Anon_AltFieldsFilterInstanceGroupManagerKey): Request[RegionInstanceGroupManagersListInstancesResponse]
  /**
    ...
    * You can specify a maximum of 1000 instances with this method per request.
    */
  def recreateInstances(request: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint): Request[Operation]
  /**
    ...
    * elapsed before the VM instance is removed or deleted.
    */
  def resize(request: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser): Request[Operation]
  /** Sets the instance template to use when creating new instances or recreating instances in this group. Existing instances are not affected. */
  def setInstanceTemplate(request: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint): Request[Operation]
  /** Modifies the target pools to which all new instances in this group are assigned. Existing instances in the group are not affected. */
  def setTargetPools(request: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint): Request[Operation]
}

object RegionInstanceGroupManagersResource {
  @scala.inline
  def apply(
    abandonInstances: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint => Request[Operation],
    delete: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint => Request[Operation],
    deleteInstances: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint => Request[Operation],
    get: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProject => Request[InstanceGroupManager],
    insert: Anon_AltFieldsKey => Request[Operation],
    list: Anon_AltFieldsFilter => Request[RegionInstanceGroupManagerList],
    listManagedInstances: Anon_AltFieldsFilterInstanceGroupManagerKey => Request[RegionInstanceGroupManagersListInstancesResponse],
    recreateInstances: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint => Request[Operation],
    resize: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser => Request[Operation],
    setInstanceTemplate: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint => Request[Operation],
    setTargetPools: Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrint => Request[Operation]
