...
trait Anon_AltAutoscaler extends js.Object {
...
object Anon_AltAutoscaler {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(autoscaler = autoscaler, project = project, zone = zone)
    ...
    __obj.asInstanceOf[Anon_AltAutoscaler]
  }
}
