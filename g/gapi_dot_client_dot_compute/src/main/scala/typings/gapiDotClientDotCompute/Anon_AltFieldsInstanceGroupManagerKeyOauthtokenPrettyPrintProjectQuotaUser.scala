...
object Anon_AltFieldsInstanceGroupManagerKeyOauthtokenPrettyPrintProjectQuotaUser {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(instanceGroupManager = instanceGroupManager.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any])
