...
trait Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdSubnetwork extends js.Object {
...
object Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdSubnetwork {
  @scala.inline
  def apply(
    project: String,
    region: String,
    ...
    userIp: String = null
  ): Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdSubnetwork = {
    ...
    __obj.asInstanceOf[Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestIdSubnetwork]
  }
}
