...
trait Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestId extends js.Object {
...
object Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestId {
  @scala.inline
  def apply(
    project: String,
    region: String,
    ...
    userIp: String = null
  ): Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestId = {
    ...
    __obj.asInstanceOf[Anon_AltFieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegionRequestId]
  }
}
