...
trait ForwardingRuleAggregatedList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  /** A list of ForwardingRulesScopedList resources. */
  var items: js.UndefOr[Record[String, ForwardingRulesScopedList]] = js.undefined
...
object ForwardingRuleAggregatedList {
  @scala.inline
  def apply(
    id: String = null,
    items: Record[String, ForwardingRulesScopedList] = null,
    kind: String = null,
