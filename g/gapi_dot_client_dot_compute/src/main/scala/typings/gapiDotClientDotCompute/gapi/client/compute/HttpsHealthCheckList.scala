...
trait HttpsHealthCheckList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  /** A list of HttpsHealthCheck resources. */
  var items: js.UndefOr[js.Array[HttpsHealthCheck]] = js.undefined
  /** Type of resource. */
...
object HttpsHealthCheckList {
  @scala.inline
  def apply(
    id: String = null,
    items: js.Array[HttpsHealthCheck] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[HttpsHealthCheckList]
  }
}
