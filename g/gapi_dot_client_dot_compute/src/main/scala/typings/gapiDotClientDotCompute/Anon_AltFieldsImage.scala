...
trait Anon_AltFieldsImage extends js.Object {
...
object Anon_AltFieldsImage {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(image = image.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[Anon_AltFieldsImage]
  }
}
