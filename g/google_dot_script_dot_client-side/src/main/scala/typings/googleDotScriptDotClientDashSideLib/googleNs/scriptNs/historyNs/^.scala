...
object ^ extends js.Object {
  /**
    ...
    */
  def push(stateObject: googleDotScriptDotClientDashSideLib.googleNs.scriptNs.historyNs.State): scala.Unit = js.native
  def push(
    stateObject: googleDotScriptDotClientDashSideLib.googleNs.scriptNs.historyNs.State,
    params: googleDotScriptDotClientDashSideLib.googleNs.scriptNs.historyNs.Query
  ...
  /**
    ...
    * If null or undefined, the current URL fragment is not changed. If empty, the URL fragment is cleared.
    */
  def replace(stateObject: googleDotScriptDotClientDashSideLib.googleNs.scriptNs.historyNs.State): scala.Unit = js.native
  def replace(
    stateObject: googleDotScriptDotClientDashSideLib.googleNs.scriptNs.historyNs.State,
    params: googleDotScriptDotClientDashSideLib.googleNs.scriptNs.historyNs.Query
  ): scala.Unit = js.native
  ...
  /**
    ...
    */
  def setChangeHandler(
    handler: js.Function1[
      /* event */ googleDotScriptDotClientDashSideLib.googleNs.scriptNs.historyNs.HistoryChangeEvent, 
      scala.Unit
    ]
  ): scala.Unit = js.native
}
