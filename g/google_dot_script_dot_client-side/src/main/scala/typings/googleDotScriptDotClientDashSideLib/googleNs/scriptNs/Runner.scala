...
object Runner {
  @scala.inline
  def apply(
    withFailureHandler: js.Function2[/* error */ stdLib.Error, /* object */ js.UndefOr[js.Any], scala.Unit] => Runner,
    withSuccessHandler: js.Function2[/* value */ js.UndefOr[js.Any], /* object */ js.UndefOr[js.Any], scala.Unit] => Runner,
