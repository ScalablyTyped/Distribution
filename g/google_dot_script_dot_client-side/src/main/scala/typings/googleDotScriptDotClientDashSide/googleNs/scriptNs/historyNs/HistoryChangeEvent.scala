package typings.googleDotScriptDotClientDashSide.googleNs.scriptNs.historyNs

import typings.googleDotScriptDotClientDashSide.googleNs.scriptNs.UrlLocation
...
object HistoryChangeEvent {
  @scala.inline
  def apply(location: UrlLocation, state: State): HistoryChangeEvent = {
