...
object RetryConfig {
  ...
  implicit class RetryConfigOps[Self <: RetryConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnRetryAttempt(value: /* err */ GaxiosError[_] => js.Promise[Unit] | Unit): Self = this.set("onRetryAttempt", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setShouldRetry(value: /* err */ GaxiosError[_] => js.Promise[Boolean] | Boolean): Self = this.set("shouldRetry", js.Any.fromFunction1(value))
    @scala.inline
