...
import typings.googleSpreadsheet.mod.BorderStyle
import typings.googleSpreadsheet.mod.CellErrorType
import typings.googleSpreadsheet.mod.CellValueType
import typings.googleSpreadsheet.mod.DeveloperMetadataLocationType
import typings.googleSpreadsheet.mod.DeveloperMetadataVisibility
import typings.googleSpreadsheet.mod.Dimension
import typings.googleSpreadsheet.mod.HorizontalAlign
import typings.googleSpreadsheet.mod.HyperlinkDisplayType
import typings.googleSpreadsheet.mod.NumberFormatType
import typings.googleSpreadsheet.mod.RecalculationInterval
import typings.googleSpreadsheet.mod.TextDirection
import typings.googleSpreadsheet.mod.ThemeColorType
import typings.googleSpreadsheet.mod.VerticalAlign
import typings.googleSpreadsheet.mod.WorksheetDimension
import typings.googleSpreadsheet.mod.WorksheetType
...
object googleSpreadsheetStrings {
  ...
  sealed trait ACCENT1
    extends StObject
       with ThemeColorType
  inline def ACCENT1: ACCENT1 = "ACCENT1".asInstanceOf[ACCENT1]
  
  @js.native
  sealed trait ACCENT2
    extends StObject
       with ThemeColorType
  inline def ACCENT2: ACCENT2 = "ACCENT2".asInstanceOf[ACCENT2]
  
  @js.native
  sealed trait ACCENT3
    extends StObject
       with ThemeColorType
  inline def ACCENT3: ACCENT3 = "ACCENT3".asInstanceOf[ACCENT3]
  
  @js.native
  sealed trait ACCENT4
    extends StObject
       with ThemeColorType
  inline def ACCENT4: ACCENT4 = "ACCENT4".asInstanceOf[ACCENT4]
  
  @js.native
  sealed trait ACCENT5
    extends StObject
       with ThemeColorType
  inline def ACCENT5: ACCENT5 = "ACCENT5".asInstanceOf[ACCENT5]
  
  @js.native
  sealed trait ACCENT6
    extends StObject
       with ThemeColorType
  inline def ACCENT6: ACCENT6 = "ACCENT6".asInstanceOf[ACCENT6]
  ...
  @js.native
  sealed trait DIVIDE_BY_ZERO
    extends StObject
       with CellErrorType
  inline def DIVIDE_BY_ZERO: DIVIDE_BY_ZERO = "DIVIDE_BY_ZERO".asInstanceOf[DIVIDE_BY_ZERO]
  ...
  @js.native
  sealed trait LEGACY_WRAP
    extends StObject
       with WrapStrategy
  inline def LEGACY_WRAP: LEGACY_WRAP = "LEGACY_WRAP".asInstanceOf[LEGACY_WRAP]
  ...
  sealed trait N_A
    extends StObject
       with CellErrorType
  inline def N_A: N_A = "N_A".asInstanceOf[N_A]
  ...
  sealed trait ON_CHANGE
    extends StObject
       with RecalculationInterval
  inline def ON_CHANGE: ON_CHANGE = "ON_CHANGE".asInstanceOf[ON_CHANGE]
  
  @js.native
  sealed trait OVERFLOW_CELL
    extends StObject
       with WrapStrategy
  inline def OVERFLOW_CELL: OVERFLOW_CELL = "OVERFLOW_CELL".asInstanceOf[OVERFLOW_CELL]
  ...
  sealed trait PLAIN_TEXT
    extends StObject
       with HyperlinkDisplayType
  inline def PLAIN_TEXT: PLAIN_TEXT = "PLAIN_TEXT".asInstanceOf[PLAIN_TEXT]
  ...
  sealed trait SOLID_MEDIUM
    extends StObject
       with BorderStyle
  inline def SOLID_MEDIUM: SOLID_MEDIUM = "SOLID_MEDIUM".asInstanceOf[SOLID_MEDIUM]
  
  @js.native
  sealed trait SOLID_THICK
    extends StObject
       with BorderStyle
  inline def SOLID_THICK: SOLID_THICK = "SOLID_THICK".asInstanceOf[SOLID_THICK]
  ...
  sealed trait errorValue
    extends StObject
       with CellValueType
  inline def errorValue: errorValue = "errorValue".asInstanceOf[errorValue]
  
  @js.native
  sealed trait numberValue
    extends StObject
       with CellValueType
