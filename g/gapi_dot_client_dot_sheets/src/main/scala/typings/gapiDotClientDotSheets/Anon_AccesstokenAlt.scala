...
import typings.gapiDotClientDotSheets.gapiNs.clientNs.sheetsNs.SearchDeveloperMetadataRequest
...
trait Anon_AccesstokenAlt extends js.Object {
  ...
  /** Request body */
  var resource: js.UndefOr[SearchDeveloperMetadataRequest] = js.undefined
...
object Anon_AccesstokenAlt {
  ...
  def apply(
    ...
    resource: SearchDeveloperMetadataRequest = null,
