...
trait Anon_AccesstokenAltCallbackFieldsIncludeGridData extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltCallbackFieldsIncludeGridData {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltCallbackFieldsIncludeGridData = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltCallbackFieldsIncludeGridData]
  }
}
