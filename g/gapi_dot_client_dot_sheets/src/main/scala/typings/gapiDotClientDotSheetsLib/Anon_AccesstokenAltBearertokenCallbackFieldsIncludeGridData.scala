...
trait Anon_AccesstokenAltBearertokenCallbackFieldsIncludeGridData extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackFieldsIncludeGridData {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackFieldsIncludeGridData = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackFieldsIncludeGridData]
  }
}
