...
trait Anon_AltDatasetIdFieldsKeyOauthtoken extends js.Object {
...
object Anon_AltDatasetIdFieldsKeyOauthtoken {
  @scala.inline
  def apply(
  ...
  ): Anon_AltDatasetIdFieldsKeyOauthtoken = {
    ...
    __obj.asInstanceOf[Anon_AltDatasetIdFieldsKeyOauthtoken]
  }
}
