...
import typings.gapiClientBigquery.gapi.client.bigquery.JobConfiguration
import typings.gapiClientBigquery.gapi.client.bigquery.JobReference
import typings.gapiClientBigquery.gapi.client.bigquery.JobStatistics
import typings.gapiClientBigquery.gapi.client.bigquery.JobStatus
