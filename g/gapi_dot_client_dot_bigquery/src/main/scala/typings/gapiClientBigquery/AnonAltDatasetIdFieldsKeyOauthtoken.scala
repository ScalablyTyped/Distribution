...
trait AnonAltDatasetIdFieldsKeyOauthtoken extends js.Object {
...
object AnonAltDatasetIdFieldsKeyOauthtoken {
  @scala.inline
  def apply(
    datasetId: String,
    projectId: String,
    ...
    userIp: String = null
  ): AnonAltDatasetIdFieldsKeyOauthtoken = {
    ...
    __obj.asInstanceOf[AnonAltDatasetIdFieldsKeyOauthtoken]
  }
}
