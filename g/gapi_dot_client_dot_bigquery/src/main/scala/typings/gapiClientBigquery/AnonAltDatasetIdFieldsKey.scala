...
trait AnonAltDatasetIdFieldsKey extends js.Object {
...
object AnonAltDatasetIdFieldsKey {
  @scala.inline
  def apply(
    datasetId: String,
    projectId: String,
    ...
    __obj.asInstanceOf[AnonAltDatasetIdFieldsKey]
  }
}
