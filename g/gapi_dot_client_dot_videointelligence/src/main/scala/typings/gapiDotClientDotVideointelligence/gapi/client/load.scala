package typings.gapiDotClientDotVideointelligence.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typings.gapiDotClientDotVideointelligence.gapiDotClientDotVideointelligenceStrings.videointelligence,
    version: v1beta1
