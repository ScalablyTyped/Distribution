...
trait GoogleCloudVideointelligenceV1VideoAnnotationResults extends js.Object {
  ...
  var labelAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1LabelAnnotation]] = js.native
  /** Safe search annotations. */
  var safeSearchAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1SafeSearchAnnotation]] = js.native
...
object GoogleCloudVideointelligenceV1VideoAnnotationResults {
  ...
  implicit class GoogleCloudVideointelligenceV1VideoAnnotationResultsOps[Self <: GoogleCloudVideointelligenceV1VideoAnnotationResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelAnnotationsVarargs(value: GoogleCloudVideointelligenceV1LabelAnnotation*): Self = this.set("labelAnnotations", js.Array(value :_*))
    @scala.inline
    def setLabelAnnotations(value: js.Array[GoogleCloudVideointelligenceV1LabelAnnotation]): Self = this.set("labelAnnotations", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteLabelAnnotations: Self = this.set("labelAnnotations", js.undefined)
    @scala.inline
    def setSafeSearchAnnotationsVarargs(value: GoogleCloudVideointelligenceV1SafeSearchAnnotation*): Self = this.set("safeSearchAnnotations", js.Array(value :_*))
    @scala.inline
    def setSafeSearchAnnotations(value: js.Array[GoogleCloudVideointelligenceV1SafeSearchAnnotation]): Self = this.set("safeSearchAnnotations", value.asInstanceOf[js.Any])
    @scala.inline
