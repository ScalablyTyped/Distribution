...
trait TaskMethod extends js.Object {
  ...
  def apply(name: java.lang.String, deps: js.Array[java.lang.String], fn: gulpLib.gulpMod.TaskCallback): js.Any = js.native
  def apply(
  ...
  def apply(name: java.lang.String, fn: gulpLib.gulpMod.TaskCallback): js.Any = js.native
  def apply(name: java.lang.String, fn: gulpLib.gulpMod.TaskCallback, option: TaskOptions): js.Any = js.native
  /**
    * Define a task.
    *
    * @param name the name of the task. Tasks that you want to run from the command line should not have spaces in them.
