...
trait AnonAltCurrentStateVersion extends js.Object {
...
object AnonAltCurrentStateVersion {
  @scala.inline
  def apply(
    stateKey: Double,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltCurrentStateVersion]
  }
}
