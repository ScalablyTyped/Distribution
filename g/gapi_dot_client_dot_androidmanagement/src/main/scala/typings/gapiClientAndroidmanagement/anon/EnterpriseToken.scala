package typings.gapiClientAndroidmanagement.anon

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait EnterpriseToken extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object EnterpriseToken {
  ...
  def apply(
    ...
    if (signupUrlName != null) __obj.updateDynamic("signupUrlName")(signupUrlName.asInstanceOf[js.Any])
