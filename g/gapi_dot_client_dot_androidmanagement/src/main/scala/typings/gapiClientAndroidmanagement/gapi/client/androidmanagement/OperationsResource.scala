...
import typings.gapiClientAndroidmanagement.AnonAccesstokenAltBearertoken
...
trait OperationsResource extends js.Object {
  ...
  /**
    ...
    * service.
    */
  def get(request: AnonAccesstokenAlt): Request_[Operation]
  /**
...
object OperationsResource {
  ...
  def apply(
    ...
    get: AnonAccesstokenAlt => Request_[Operation],
