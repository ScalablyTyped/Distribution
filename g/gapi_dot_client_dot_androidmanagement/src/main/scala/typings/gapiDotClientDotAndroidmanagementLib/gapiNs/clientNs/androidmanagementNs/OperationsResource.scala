...
trait OperationsResource extends js.Object {
  /**
    ...
    */
  def cancel(request: gapiDotClientDotAndroidmanagementLib.Anon_Name): gapiDotClientLib.gapiNs.clientNs.Request[js.Object]
  /**
  ...
  /**
    ...
    * service.
    */
  def get(request: gapiDotClientDotAndroidmanagementLib.Anon_Name): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /**
    ...
    * id.
    */
  def list(request: gapiDotClientDotAndroidmanagementLib.Anon_NameAccesstoken): gapiDotClientLib.gapiNs.clientNs.Request[ListOperationsResponse]
}
