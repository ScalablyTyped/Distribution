...
trait ApplicationPolicy extends js.Object {
  ...
  var installType: js.UndefOr[java.lang.String] = js.undefined
  /** Whether the application is allowed to lock itself in full-screen mode. */
  var lockTaskAllowed: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    * </table>
    */
  var managedConfiguration: js.UndefOr[stdLib.Record[java.lang.String, _]] = js.undefined
