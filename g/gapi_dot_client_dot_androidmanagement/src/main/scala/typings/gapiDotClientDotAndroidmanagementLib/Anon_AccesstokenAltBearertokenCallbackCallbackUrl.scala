package typings
package gapiDotClientDotAndroidmanagementLib

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait Anon_AccesstokenAltBearertokenCallbackCallbackUrl extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackCallbackUrl {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackCallbackUrl = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackCallbackUrl]
  }
}
