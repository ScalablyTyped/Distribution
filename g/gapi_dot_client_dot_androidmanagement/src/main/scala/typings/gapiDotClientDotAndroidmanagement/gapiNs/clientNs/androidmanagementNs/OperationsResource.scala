...
import typings.gapiDotClientDotAndroidmanagement.Anon_AccesstokenAltBearertoken
...
trait OperationsResource extends js.Object {
  ...
  /**
    ...
    * service.
    */
  def get(request: Anon_AccesstokenAlt): Request[Operation]
  /**
...
object OperationsResource {
  ...
  def apply(
    ...
    get: Anon_AccesstokenAlt => Request[Operation],
