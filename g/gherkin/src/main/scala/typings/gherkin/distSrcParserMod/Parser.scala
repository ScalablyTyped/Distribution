...
trait Parser extends StObject {
  ...
  def parse(tokenScanner: String, tokenMatcher: typings.gherkin.distSrcTokenMatcherMod.default): Any = js.native
  def parse(tokenScanner: typings.gherkin.distSrcTokenScannerMod.default): Any = js.native
  def parse(
    tokenScanner: typings.gherkin.distSrcTokenScannerMod.default,
    tokenMatcher: typings.gherkin.distSrcTokenMatcherMod.default
  ): Any = js.native
