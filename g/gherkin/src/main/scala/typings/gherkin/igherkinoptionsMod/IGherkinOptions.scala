package typings.gherkin.igherkinoptionsMod
...
@js.native
trait IGherkinOptions extends js.Object {
...
object IGherkinOptions {
  ...
  @scala.inline
  implicit class IGherkinOptionsOps[Self <: IGherkinOptions] (val x: Self) extends AnyVal {
