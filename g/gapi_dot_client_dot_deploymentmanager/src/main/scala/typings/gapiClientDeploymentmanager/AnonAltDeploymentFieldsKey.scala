...
trait AnonAltDeploymentFieldsKey extends js.Object {
...
object AnonAltDeploymentFieldsKey {
  @scala.inline
  def apply(
    deployment: String,
    project: String,
    ...
    __obj.asInstanceOf[AnonAltDeploymentFieldsKey]
  }
}
