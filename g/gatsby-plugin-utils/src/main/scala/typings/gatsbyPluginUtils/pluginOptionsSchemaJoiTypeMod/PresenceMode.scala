...
/* Rewritten from type alias, can be one of: 
  - typings.gatsbyPluginUtils.gatsbyPluginUtilsStrings.optional
  - typings.gatsbyPluginUtils.gatsbyPluginUtilsStrings.required
  - typings.gatsbyPluginUtils.gatsbyPluginUtilsStrings.forbidden
*/
