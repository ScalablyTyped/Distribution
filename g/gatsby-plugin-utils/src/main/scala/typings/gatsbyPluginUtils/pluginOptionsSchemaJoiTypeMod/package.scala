...
package object pluginOptionsSchemaJoiTypeMod {
  ...
  type ExtensionBoundSchema = typings.gatsbyPluginUtils.pluginOptionsSchemaJoiTypeMod.Schema with typings.gatsbyPluginUtils.pluginOptionsSchemaJoiTypeMod.SchemaInternals
  ...
  */
  ...
  {[ key in keyof TSchema ]:? gatsby-plugin-utils.gatsby-plugin-utils/dist/utils/plugin-options-schema-joi-type.SchemaLike | std.Array<gatsby-plugin-utils.gatsby-plugin-utils/dist/utils/plugin-options-schema-joi-type.SchemaLike>}
    */ typings.gatsbyPluginUtils.gatsbyPluginUtilsStrings.SchemaMap with org.scalablytyped.runtime.TopLevel[js.Any]
