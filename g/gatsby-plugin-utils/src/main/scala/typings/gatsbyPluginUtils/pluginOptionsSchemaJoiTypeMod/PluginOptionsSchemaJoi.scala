...
trait PluginOptionsSchemaJoi extends StObject {
  ...
  var ValidationError: Instantiable3[
    ...
    /* details */ js.Any, 
    /* original */ js.Any, 
    typings.gatsbyPluginUtils.pluginOptionsSchemaJoiTypeMod.ValidationError
  ] = js.native
  ...
  /**
    ...
    */
  def defaults(fn: SchemaFunction): PluginOptionsSchemaJoi = js.native
  ...
  /**
    ...
    */
  def isError(error: js.Any): /* is gatsby-plugin-utils.gatsby-plugin-utils/dist/utils/plugin-options-schema-joi-type.ValidationError */ Boolean = js.native
  ...
  /**
    ...
    */
  def isRef(ref: js.Any): /* is gatsby-plugin-utils.gatsby-plugin-utils/dist/utils/plugin-options-schema-joi-type.Reference */ Boolean = js.native
  
  /**
    * Checks whether or not the provided argument is a joi schema.
    */
  def isSchema(schema: js.Any): Boolean = js.native
  def isSchema(schema: js.Any, options: IsSchemaOptions): Boolean = js.native
