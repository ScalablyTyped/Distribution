...
object KmlPlacemark {
  ...
  @scala.inline
  implicit class KmlPlacemarkOps[Self <: KmlPlacemark] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setGetGeometry(value: () => KmlGeometry): Self = this.set("getGeometry", js.Any.fromFunction0(value))
    @scala.inline
    def setSetGeometry(value: KmlGeometry => Unit): Self = this.set("setGeometry", js.Any.fromFunction1(value))
  }
