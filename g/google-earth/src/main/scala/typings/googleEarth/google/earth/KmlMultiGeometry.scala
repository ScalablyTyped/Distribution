...
object KmlMultiGeometry {
  ...
  @scala.inline
  implicit class KmlMultiGeometryOps[Self <: KmlMultiGeometry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetGeometries(value: () => GEGeometryContainer): Self = this.set("getGeometries", js.Any.fromFunction0(value))
  }
}
