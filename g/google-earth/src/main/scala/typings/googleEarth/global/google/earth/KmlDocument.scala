...
@js.native
open class KmlDocument ()
  extends StObject
     with typings.googleEarth.google.earth.KmlDocument {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getElementsByStyleUrl(styleUrl: String): typings.googleEarth.google.earth.KmlObjectList[typings.googleEarth.google.earth.KmlObject] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getStyleSelectors(): typings.googleEarth.google.earth.GEStyleSelectorContainer = js.native
