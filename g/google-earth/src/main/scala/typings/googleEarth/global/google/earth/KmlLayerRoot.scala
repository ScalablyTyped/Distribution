...
@js.native
open class KmlLayerRoot ()
  extends StObject
     with typings.googleEarth.google.earth.KmlLayerRoot {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def enableLayerById(id: String, visibility: Boolean): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getElementsByType(`type`: String): typings.googleEarth.google.earth.KmlObjectList[typings.googleEarth.google.earth.KmlObject] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getLayerById(id: String): typings.googleEarth.google.earth.KmlLayer = js.native
