...
inline def executeBatch(pluginInstance: typings.googleEarth.google.earth.GEPlugin, batchFunction: js.Function): scala.Unit = (typings.googleEarth.global.google.earth.^.asInstanceOf[js.Dynamic].applyDynamic("executeBatch")(pluginInstance.asInstanceOf[js.Any], batchFunction.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
inline def isInstalled(): scala.Boolean = typings.googleEarth.global.google.earth.^.asInstanceOf[js.Dynamic].applyDynamic("isInstalled")().asInstanceOf[scala.Boolean]

inline def isSupported(): scala.Boolean = typings.googleEarth.global.google.earth.^.asInstanceOf[js.Dynamic].applyDynamic("isSupported")().asInstanceOf[scala.Boolean]
...
inline def setLanguage(languageCode: java.lang.String): scala.Unit = typings.googleEarth.global.google.earth.^.asInstanceOf[js.Dynamic].applyDynamic("setLanguage")(languageCode.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
