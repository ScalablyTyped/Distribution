...
@js.native
open class KmlPolygon ()
  extends StObject
     with typings.googleEarth.google.earth.KmlPolygon {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getInnerBoundaries(): typings.googleEarth.google.earth.GELinearRingContainer = js.native
  
  /**
    * Contains a LinearRing element.
    */
  /* CompleteClass */
  override def getOuterBoundary(): typings.googleEarth.google.earth.KmlLinearRing = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setOuterBoundary(outerBoundary: typings.googleEarth.google.earth.KmlLinearRing): Unit = js.native
