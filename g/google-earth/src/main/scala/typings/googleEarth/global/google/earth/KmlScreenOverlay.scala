...
class KmlScreenOverlay ()
  extends typings.googleEarth.google.earth.KmlScreenOverlay {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getOverlayXY(): typings.googleEarth.google.earth.KmlVec2 = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getRotationXY(): typings.googleEarth.google.earth.KmlVec2 = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getSize(): typings.googleEarth.google.earth.KmlVec2 = js.native
  /**
