...
class KmlGroundOverlay ()
  extends typings.googleEarth.google.earth.KmlGroundOverlay {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getLatLonBox(): typings.googleEarth.google.earth.KmlLatLonBox = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setLatLonBox(latLonBox: typings.googleEarth.google.earth.KmlLatLonBox): Unit = js.native
  /**
    * User-defined text displayed in the plugin as the label for the object (for example, for a Placemark).
    */
  /* CompleteClass */
