...
class GEPlugin () extends js.Object {
  ...
  /**
       ...
       */
  var SPEED_TELEPORT: scala.Double = js.native
  /**
  ...
  /**
       ...
       */
  def createCamera(id: java.lang.String): KmlCamera = js.native
  /**
       * Creates a Document. A Document is a container for features and styles.
       */
  def createDocument(id: java.lang.String): KmlDocument = js.native
  /**
       * Creates a Feature balloon.
       */
  def createFeatureBalloon(id: java.lang.String): GEFeatureBalloon = js.native
  /**
       * Creates a folder. 
       ...
       */
  def createFolder(id: java.lang.String): KmlFolder = js.native
  /**
       * Creates a GroundOverlay.
       * A GroundOverlay draws an image overlay draped onto the terrain.
       */
  def createGroundOverlay(id: java.lang.String): KmlGroundOverlay = js.native
  /**
       * Creates an Html Div Balloon.
       */
  def createHtmlDivBalloon(id: java.lang.String): GEHtmlDivBalloon = js.native
  /**
       * Creates an HTML string balloon.
       */
  def createHtmlStringBalloon(id: java.lang.String): GEHtmlStringBalloon = js.native
  /**
       * Creates an Icon. An icon defines an image associated with an Icon style or overlay.
       */
  def createIcon(id: java.lang.String): KmlIcon = js.native
  /**
       * Creates a LatLonAltBox, a bounding box that describes an area of interest defined by geographic coordinates and altitudes.
       */
  def createLatLonAltBox(id: java.lang.String): KmlLatLonAltBox = js.native
  /**
       * Creates a LatLonBox, a bounding box that describes an area of interest defined by geographic coordinates and altitudes.
       */
  def createLatLonBox(id: java.lang.String): KmlLatLonBox = js.native
  /**
       * Creates a line string on Google Earth.
       */
  def createLineString(id: java.lang.String): KmlLineString = js.native
  /**
       ...
       */
  def createLinearRing(id: java.lang.String): KmlLinearRing = js.native
  /**
       * Creates a Link.
       ...
       */
  def createLink(id: java.lang.String): KmlLink = js.native
  /**
       ...
       */
  def createLocation(id: java.lang.String): KmlLocation = js.native
  /**
  ...
  /**
       ...
       */
  def createStyleMap(id: java.lang.String): KmlStyleMap = js.native
  /**
       * Create a KmlTimeSpan object.
       * For more information, refer to the Time chapter of the Google Earth API developer's guide.
       */
  def createTimeSpan(id: java.lang.String): KmlTimeSpan = js.native
  /**
       * Create a KmlTimeStamp object.
       * For more information, refer to the Time chapter of the Google Earth API developer's guide.
       */
  def createTimeStamp(id: java.lang.String): KmlTimeStamp = js.native
  /**
       * Creates a new viewer options object.
       */
  def createViewerOptions(id: java.lang.String): KmlViewerOptions = js.native
  /**
  ...
  /**
       ...
       */
  def getEarthVersion(): java.lang.String = js.native
  /**
  ...
  /**
       ...
       */
  def getPluginVersion(): java.lang.String = js.native
  /**
       ...
       */
  def getStreamingPercent(): scala.Double = js.native
  /**
  ...
  /**
       ...
       */
  def parseKml(kml: java.lang.String): KmlObject = js.native
  /**
       ...
       */
  def setBalloon(newActiveBalloon: GEAbstractBalloon): scala.Unit = js.native
}
