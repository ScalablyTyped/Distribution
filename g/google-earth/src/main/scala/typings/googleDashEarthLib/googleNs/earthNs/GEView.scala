...
class GEView () extends js.Object {
  ...
  /**
    ...
    * * GEPlugin.ALTITUDE_RELATIVE_TO_SEA_FLOOR
    */
  def project(lat: scala.Double, lng: scala.Double, alt: scala.Double, altitudeMode: KmlAltitudeModeEnum): KmlVec2 = js.native
  /**
    * Sets the camera that views the scene in Google Earth.
    */
  def setAbstractView(view: KmlAbstractView): scala.Unit = js.native
}
