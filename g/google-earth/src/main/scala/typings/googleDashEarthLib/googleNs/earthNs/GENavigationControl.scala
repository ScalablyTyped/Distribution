...
class GENavigationControl () extends js.Object {
  ...
  /**
    ...
    */
  def getStreetViewEnabled(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * * GEPlugin.NAVIGATION_CONTROL_SMALL
    */
  def setControlType(controlType: GENavigationControlEnum): scala.Unit = js.native
  /**
    ...
    */
  def setStreetViewEnabled(streetViewEnabled: scala.Boolean): scala.Unit = js.native
  /**
    * Whether the control is always visible, always hidden, or visible only when the user intends to use the control.
    *
    * See also:
    ...
    * * GEPlugin.VISIBILITY_AUTO
    */
  def setVisibility(visibility: GEVisibilityEnum): scala.Unit = js.native
}
