...
class KmlContainer () extends KmlFeature {
  /**
    ...
    */
  def getElementById(id: java.lang.String): KmlObject = js.native
  /**
    ...
    * The object must be a descendant of the container before it can be found.
    */
  def getElementByUrl(url: java.lang.String): KmlObject = js.native
  /**
    * Get an element by type.
    */
  def getElementsByType(`type`: java.lang.String): KmlObjectList[KmlObject] = js.native
  /**
