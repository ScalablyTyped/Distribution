...
object DistanceMatrixResponseTopLevelStatus {
  ...
  @scala.inline
  def MAX_ELEMENTS_EXCEEDED: typings.googleMaps.googleMapsStrings.MAX_ELEMENTS_EXCEEDED = "MAX_ELEMENTS_EXCEEDED".asInstanceOf[typings.googleMaps.googleMapsStrings.MAX_ELEMENTS_EXCEEDED]
  
  @scala.inline
  def OK: typings.googleMaps.googleMapsStrings.OK = "OK".asInstanceOf[typings.googleMaps.googleMapsStrings.OK]
  
  @scala.inline
  def OVER_DAILY_LIMIT: typings.googleMaps.googleMapsStrings.OVER_DAILY_LIMIT = "OVER_DAILY_LIMIT".asInstanceOf[typings.googleMaps.googleMapsStrings.OVER_DAILY_LIMIT]
