...
object DirectionsReponseStatus {
  ...
  @scala.inline
  def `MAX_ROUTE_LENGTH_EXCEEDED `: typings.googleMaps.googleMapsStrings.`MAX_ROUTE_LENGTH_EXCEEDED ` = ("MAX_ROUTE_LENGTH_EXCEEDED ").asInstanceOf[typings.googleMaps.googleMapsStrings.`MAX_ROUTE_LENGTH_EXCEEDED `]
  
  @scala.inline
  def MAX_WAYPOINTS_EXCEEDED: typings.googleMaps.googleMapsStrings.MAX_WAYPOINTS_EXCEEDED = "MAX_WAYPOINTS_EXCEEDED".asInstanceOf[typings.googleMaps.googleMapsStrings.MAX_WAYPOINTS_EXCEEDED]
