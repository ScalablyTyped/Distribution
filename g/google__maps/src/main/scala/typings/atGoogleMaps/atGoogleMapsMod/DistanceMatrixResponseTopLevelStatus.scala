...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.atGoogleMaps.atGoogleMapsStrings.MAX_ELEMENTS_EXCEEDED
...
object DistanceMatrixResponseTopLevelStatus {
  ...
  @scala.inline
  def MAX_ELEMENTS_EXCEEDED: typings.atGoogleMaps.atGoogleMapsStrings.MAX_ELEMENTS_EXCEEDED = this.cast("MAX_ELEMENTS_EXCEEDED")
  @scala.inline
