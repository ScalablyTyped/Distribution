...
@js.native
class DOMPoint ()
  extends typings.geometryDashDom.GeometryDomNs.DOMPoint {
...
@js.native
object DOMPoint
  extends Instantiable0[typings.geometryDashDom.GeometryDomNs.DOMPoint]
     with Instantiable1[/* x */ Double, typings.geometryDashDom.GeometryDomNs.DOMPoint]
     with Instantiable2[/* x */ Double, /* y */ Double, typings.geometryDashDom.GeometryDomNs.DOMPoint]
     with Instantiable3[
      /* x */ Double, 
      /* y */ Double, 
      /* z */ Double, 
      typings.geometryDashDom.GeometryDomNs.DOMPoint
    ]
     with Instantiable4[
      /* x */ Double, 
      /* y */ Double, 
