...
import typings.gapiClientDlp.AnonAccesstokenAlt
...
trait OperationsResource extends js.Object {
  ...
  def cancel(request: AnonAccesstokenAlt): Request_[js.Object]
  /**
  ...
  /**
    ...
    * service.
    */
  def get(request: AnonAccesstokenAlt): Request_[GoogleLongrunningOperation]
  /** Fetches the list of long running operations. */
  def list(request: AnonAccesstokenAltBearertoken): Request_[GoogleLongrunningListOperationsResponse]
}

object OperationsResource {
  @scala.inline
  def apply(
    cancel: AnonAccesstokenAlt => Request_[js.Object],
    create: AnonAccesstoken => Request_[GoogleLongrunningOperation],
    delete: AnonAccesstokenAlt => Request_[js.Object],
    get: AnonAccesstokenAlt => Request_[GoogleLongrunningOperation],
    list: AnonAccesstokenAltBearertoken => Request_[GoogleLongrunningListOperationsResponse]
  ): OperationsResource = {
