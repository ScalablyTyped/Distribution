...
object GooglePrivacyDlpV2beta1Key {
  ...
  implicit class GooglePrivacyDlpV2beta1KeyOps[Self <: GooglePrivacyDlpV2beta1Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPathVarargs(value: GooglePrivacyDlpV2beta1PathElement*): Self = this.set("path", js.Array(value :_*))
    @scala.inline
    def setPath(value: js.Array[GooglePrivacyDlpV2beta1PathElement]): Self = this.set("path", value.asInstanceOf[js.Any])
    @scala.inline
