...
trait Anon_AccesstokenAltBearertokenCallbackFieldsInvitationIdKey extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackFieldsInvitationIdKey {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackFieldsInvitationIdKey = {
    val __obj = js.Dynamic.literal(invitationId = invitationId, studentId = studentId)
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackFieldsInvitationIdKey]
  }
}
