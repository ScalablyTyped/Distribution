...
object AnnouncementsResource {
  @scala.inline
  def apply(
    create: gapiDotClientDotClassroomLib.Anon_Accesstoken => gapiDotClientLib.gapiNs.clientNs.Request[Announcement],
    delete: gapiDotClientDotClassroomLib.Anon_AccesstokenAltBearertoken => gapiDotClientLib.gapiNs.clientNs.Request[js.Object],
    get: gapiDotClientDotClassroomLib.Anon_AccesstokenAltBearertoken => gapiDotClientLib.gapiNs.clientNs.Request[Announcement],
    list: gapiDotClientDotClassroomLib.Anon_AccesstokenAltAnnouncementStates => gapiDotClientLib.gapiNs.clientNs.Request[ListAnnouncementsResponse],
    modifyAssignees: gapiDotClientDotClassroomLib.Anon_AccesstokenAltBearertoken => gapiDotClientLib.gapiNs.clientNs.Request[Announcement],
    patch: gapiDotClientDotClassroomLib.Anon_AccesstokenAltBearertokenCallback => gapiDotClientLib.gapiNs.clientNs.Request[Announcement]
