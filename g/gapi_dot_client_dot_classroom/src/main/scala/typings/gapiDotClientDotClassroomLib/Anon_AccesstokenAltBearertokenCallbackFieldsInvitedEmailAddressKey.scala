...
object Anon_AccesstokenAltBearertokenCallbackFieldsInvitedEmailAddressKey {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackFieldsInvitedEmailAddressKey]
  }
}
