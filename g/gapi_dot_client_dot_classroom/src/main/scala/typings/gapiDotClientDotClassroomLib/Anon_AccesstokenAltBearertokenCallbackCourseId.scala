...
trait Anon_AccesstokenAltBearertokenCallbackCourseId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackCourseId {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackCourseId = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("courseId")(courseId)
    __obj.updateDynamic("courseWorkId")(courseWorkId)
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackCourseId]
  }
}
