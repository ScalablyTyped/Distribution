...
object Anon_AccesstokenAltBearertokenCallbackCourseIdEnrollmentCode {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackCourseIdEnrollmentCode = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackCourseIdEnrollmentCode]
  }
}
