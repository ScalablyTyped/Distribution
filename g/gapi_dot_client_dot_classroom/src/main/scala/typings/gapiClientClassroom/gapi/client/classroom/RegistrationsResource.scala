...
import typings.gapiClientClassroom.AnonAccesstokenAltBearertokenCallbackFieldsKey
...
trait RegistrationsResource extends js.Object {
  /**
    ...
    */
  def create(request: AnonAccesstokenAltBearertokenCallbackFields): Request_[Registration]
  /**
...
object RegistrationsResource {
  @scala.inline
  def apply(
    create: AnonAccesstokenAltBearertokenCallbackFields => Request_[Registration],
