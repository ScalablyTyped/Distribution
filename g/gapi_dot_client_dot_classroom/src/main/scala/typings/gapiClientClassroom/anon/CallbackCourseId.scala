...
@js.native
trait CallbackCourseId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object CallbackCourseId {
  @scala.inline
  def apply(courseId: String): CallbackCourseId = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackCourseId]
  }
  @scala.inline
  implicit class CallbackCourseIdOps[Self <: CallbackCourseId] (val x: Self) extends AnyVal {
    @scala.inline
