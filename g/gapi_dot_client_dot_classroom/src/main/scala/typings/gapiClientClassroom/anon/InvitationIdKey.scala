...
@js.native
trait InvitationIdKey extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object InvitationIdKey {
  @scala.inline
  def apply(invitationId: String, studentId: String): InvitationIdKey = {
    val __obj = js.Dynamic.literal(invitationId = invitationId.asInstanceOf[js.Any], studentId = studentId.asInstanceOf[js.Any])
    __obj.asInstanceOf[InvitationIdKey]
  }
  @scala.inline
  implicit class InvitationIdKeyOps[Self <: InvitationIdKey] (val x: Self) extends AnyVal {
    @scala.inline
