...
trait Anon_AccesstokenAltBearertokenCallbackFieldsInvitationId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackFieldsInvitationId {
  @scala.inline
  def apply(
    invitationId: String,
    studentId: String,
  ...
  ): Anon_AccesstokenAltBearertokenCallbackFieldsInvitationId = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackFieldsInvitationId]
  }
}
