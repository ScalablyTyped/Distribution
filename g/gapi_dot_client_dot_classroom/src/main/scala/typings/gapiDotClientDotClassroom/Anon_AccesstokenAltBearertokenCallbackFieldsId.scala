...
trait Anon_AccesstokenAltBearertokenCallbackFieldsId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackFieldsId {
  @scala.inline
  def apply(
    id: String,
    `$.xgafv`: String = null,
  ...
  ): Anon_AccesstokenAltBearertokenCallbackFieldsId = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackFieldsId]
  }
}
