...
import typings.gapiDotClientDotClassroom.Anon_AccesstokenAlias
...
trait AliasesResource extends js.Object {
  /**
    ...
    */
  def create(request: Anon_Accesstoken): Request[CourseAlias]
  /**
    ...
    */
  def delete(request: Anon_AccesstokenAlias): Request[js.Object]
  /**
    ...
    * &#42; `NOT_FOUND` if the course does not exist.
    */
  def list(request: Anon_AccesstokenAlt): Request[ListCourseAliasesResponse]
}

object AliasesResource {
  @scala.inline
  def apply(
    create: Anon_Accesstoken => Request[CourseAlias],
    delete: Anon_AccesstokenAlias => Request[js.Object],
    list: Anon_AccesstokenAlt => Request[ListCourseAliasesResponse]
  ): AliasesResource = {
