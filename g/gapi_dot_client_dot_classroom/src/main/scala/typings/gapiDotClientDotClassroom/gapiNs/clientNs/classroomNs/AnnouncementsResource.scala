...
import typings.gapiDotClientDotClassroom.Anon_AccesstokenAltAnnouncementStates
...
trait AnnouncementsResource extends js.Object {
  /**
    ...
    */
  def create(request: Anon_Accesstoken): Request[Announcement]
  /**
  ...
  /**
    ...
    */
  def get(request: Anon_AccesstokenAltBearertoken): Request[Announcement]
  /**
    ...
    * &#42; `NOT_FOUND` if the requested course does not exist.
    */
  def list(request: Anon_AccesstokenAltAnnouncementStates): Request[ListAnnouncementsResponse]
  /**
    ...
    */
  def modifyAssignees(request: Anon_AccesstokenAltBearertoken): Request[Announcement]
  /**
    ...
    * &#42; `NOT_FOUND` if the requested course or announcement does not exist
    */
  def patch(request: Anon_AccesstokenAltBearertokenCallback): Request[Announcement]
}

object AnnouncementsResource {
  @scala.inline
  def apply(
    create: Anon_Accesstoken => Request[Announcement],
    delete: Anon_AccesstokenAltBearertoken => Request[js.Object],
    get: Anon_AccesstokenAltBearertoken => Request[Announcement],
    list: Anon_AccesstokenAltAnnouncementStates => Request[ListAnnouncementsResponse],
    modifyAssignees: Anon_AccesstokenAltBearertoken => Request[Announcement],
    patch: Anon_AccesstokenAltBearertokenCallback => Request[Announcement]
