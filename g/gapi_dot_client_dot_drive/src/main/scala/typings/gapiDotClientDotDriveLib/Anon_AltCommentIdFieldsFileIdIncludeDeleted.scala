...
trait Anon_AltCommentIdFieldsFileIdIncludeDeleted extends js.Object {
...
object Anon_AltCommentIdFieldsFileIdIncludeDeleted {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltCommentIdFieldsFileIdIncludeDeleted]
  }
}
