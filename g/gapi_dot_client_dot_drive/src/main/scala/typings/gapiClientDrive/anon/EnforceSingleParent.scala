...
@js.native
trait EnforceSingleParent extends js.Object {
...
object EnforceSingleParent {
  @scala.inline
  def apply(fileId: String, resource: File): EnforceSingleParent = {
  ...
  @scala.inline
  implicit class EnforceSingleParentOps[Self <: EnforceSingleParent] (val x: Self) extends AnyVal {
    @scala.inline
