...
import typings.gapiClientDrive.gapi.client.drive.TeamDrive
...
trait QuotaUserResource extends js.Object {
  ...
  /** Request body */
  var resource: TeamDrive = js.native
...
object QuotaUserResource {
  @scala.inline
  def apply(resource: TeamDrive, teamDriveId: String): QuotaUserResource = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any], teamDriveId = teamDriveId.asInstanceOf[js.Any])
  ...
  implicit class QuotaUserResourceOps[Self <: QuotaUserResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResource(value: TeamDrive): Self = this.set("resource", value.asInstanceOf[js.Any])
    @scala.inline
