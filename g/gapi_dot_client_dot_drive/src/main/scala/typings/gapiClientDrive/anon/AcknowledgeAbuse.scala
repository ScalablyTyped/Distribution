...
@js.native
trait AcknowledgeAbuse extends js.Object {
...
object AcknowledgeAbuse {
  @scala.inline
  def apply(fileId: String): AcknowledgeAbuse = {
    val __obj = js.Dynamic.literal(fileId = fileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AcknowledgeAbuse]
  }
  @scala.inline
  implicit class AcknowledgeAbuseOps[Self <: AcknowledgeAbuse] (val x: Self) extends AnyVal {
    @scala.inline
