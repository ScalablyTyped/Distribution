...
@js.native
trait FileIdIncludeDeleted extends js.Object {
...
object FileIdIncludeDeleted {
  @scala.inline
  def apply(commentId: String, fileId: String): FileIdIncludeDeleted = {
  ...
  @scala.inline
  implicit class FileIdIncludeDeletedOps[Self <: FileIdIncludeDeleted] (val x: Self) extends AnyVal {
    @scala.inline
