...
trait AnonAltFieldsFileIdIncludeDeleted extends js.Object {
...
object AnonAltFieldsFileIdIncludeDeleted {
  @scala.inline
  def apply(
    fileId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsFileIdIncludeDeleted = {
    ...
    __obj.asInstanceOf[AnonAltFieldsFileIdIncludeDeleted]
  }
}
