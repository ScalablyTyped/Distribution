...
trait AnonAltFieldsFileIdKeyOauthtoken extends js.Object {
...
object AnonAltFieldsFileIdKeyOauthtoken {
  @scala.inline
  def apply(
    fileId: String,
    permissionId: String,
    ...
    userIp: String = null
  ): AnonAltFieldsFileIdKeyOauthtoken = {
    ...
    __obj.asInstanceOf[AnonAltFieldsFileIdKeyOauthtoken]
  }
}
