...
trait AnonCanAddChildrenCanChangeTeamDriveBackground extends js.Object {
...
object AnonCanAddChildrenCanChangeTeamDriveBackground {
  @scala.inline
  def apply(
  ...
  ): AnonCanAddChildrenCanChangeTeamDriveBackground = {
    ...
    __obj.asInstanceOf[AnonCanAddChildrenCanChangeTeamDriveBackground]
  }
}
