...
trait AnonAltCommentIdFieldsFileId extends js.Object {
...
object AnonAltCommentIdFieldsFileId {
  @scala.inline
  def apply(
    commentId: String,
    fileId: String,
    ...
    __obj.asInstanceOf[AnonAltCommentIdFieldsFileId]
  }
}
