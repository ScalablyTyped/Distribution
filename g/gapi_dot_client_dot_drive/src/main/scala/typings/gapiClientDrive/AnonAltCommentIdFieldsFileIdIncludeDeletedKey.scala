...
trait AnonAltCommentIdFieldsFileIdIncludeDeletedKey extends js.Object {
...
object AnonAltCommentIdFieldsFileIdIncludeDeletedKey {
  @scala.inline
  def apply(
    commentId: String,
    fileId: String,
    ...
    userIp: String = null
  ): AnonAltCommentIdFieldsFileIdIncludeDeletedKey = {
    ...
    __obj.asInstanceOf[AnonAltCommentIdFieldsFileIdIncludeDeletedKey]
  }
}
