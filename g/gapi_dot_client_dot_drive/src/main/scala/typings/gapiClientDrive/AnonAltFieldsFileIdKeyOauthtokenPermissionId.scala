...
trait AnonAltFieldsFileIdKeyOauthtokenPermissionId extends js.Object {
...
object AnonAltFieldsFileIdKeyOauthtokenPermissionId {
  @scala.inline
  def apply(
    fileId: String,
    permissionId: String,
    ...
    userIp: String = null
  ): AnonAltFieldsFileIdKeyOauthtokenPermissionId = {
    ...
    __obj.asInstanceOf[AnonAltFieldsFileIdKeyOauthtokenPermissionId]
  }
}
