...
trait AnonAltFieldsIncludeCorpusRemovals extends js.Object {
...
object AnonAltFieldsIncludeCorpusRemovals {
  @scala.inline
  def apply(
    pageToken: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsIncludeCorpusRemovals = {
    ...
    __obj.asInstanceOf[AnonAltFieldsIncludeCorpusRemovals]
  }
}
