...
trait AnonAltFieldsKeyOauthtokenPageSize extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPageSize {
  @scala.inline
  def apply(
    alt: String = null,
    fields: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPageSize = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPageSize]
  }
}
