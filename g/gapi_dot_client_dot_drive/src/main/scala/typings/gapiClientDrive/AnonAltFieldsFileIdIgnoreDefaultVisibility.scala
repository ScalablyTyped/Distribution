...
trait AnonAltFieldsFileIdIgnoreDefaultVisibility extends js.Object {
...
object AnonAltFieldsFileIdIgnoreDefaultVisibility {
  @scala.inline
  def apply(
    fileId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsFileIdIgnoreDefaultVisibility = {
    ...
    __obj.asInstanceOf[AnonAltFieldsFileIdIgnoreDefaultVisibility]
  }
}
