...
trait AnonAltFieldsIgnoreDefaultVisibility extends js.Object {
...
object AnonAltFieldsIgnoreDefaultVisibility {
  @scala.inline
  def apply(
    alt: String = null,
    fields: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsIgnoreDefaultVisibility = {
    ...
    __obj.asInstanceOf[AnonAltFieldsIgnoreDefaultVisibility]
  }
}
