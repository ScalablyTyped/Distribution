...
trait AnonAltCommentIdFieldsFileIdIncludeDeleted extends js.Object {
...
object AnonAltCommentIdFieldsFileIdIncludeDeleted {
  @scala.inline
  def apply(
    commentId: String,
    fileId: String,
    ...
    userIp: String = null
  ): AnonAltCommentIdFieldsFileIdIncludeDeleted = {
    ...
    __obj.asInstanceOf[AnonAltCommentIdFieldsFileIdIncludeDeleted]
  }
}
