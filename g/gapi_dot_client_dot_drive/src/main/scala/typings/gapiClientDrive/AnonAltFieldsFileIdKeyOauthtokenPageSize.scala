...
trait AnonAltFieldsFileIdKeyOauthtokenPageSize extends js.Object {
...
object AnonAltFieldsFileIdKeyOauthtokenPageSize {
  @scala.inline
  def apply(
    fileId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsFileIdKeyOauthtokenPageSize = {
    ...
    __obj.asInstanceOf[AnonAltFieldsFileIdKeyOauthtokenPageSize]
  }
}
