...
trait Anon_AccesstokenAltAppsIdBearertokenCallbackFields extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltAppsIdBearertokenCallbackFields {
  @scala.inline
  def apply(
    appsId: String,
  ...
  ): Anon_AccesstokenAltAppsIdBearertokenCallbackFields = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltAppsIdBearertokenCallbackFields]
  }
}
