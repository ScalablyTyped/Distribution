...
trait Anon_AccesstokenAltAppsIdBearertoken extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltAppsIdBearertoken {
  @scala.inline
  def apply(
    appsId: String,
    `$.xgafv`: String = null,
    ...
    view: String = null
  ): Anon_AccesstokenAltAppsIdBearertoken = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltAppsIdBearertoken]
  }
}
