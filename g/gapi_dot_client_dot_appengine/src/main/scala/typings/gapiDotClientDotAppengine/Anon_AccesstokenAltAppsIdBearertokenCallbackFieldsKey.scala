...
trait Anon_AccesstokenAltAppsIdBearertokenCallbackFieldsKey extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltAppsIdBearertokenCallbackFieldsKey {
  @scala.inline
  def apply(
    appsId: String,
    `$.xgafv`: String = null,
  ...
  ): Anon_AccesstokenAltAppsIdBearertokenCallbackFieldsKey = {
    ...
    if (matchingAddress != null) __obj.updateDynamic("matchingAddress")(matchingAddress.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltAppsIdBearertokenCallbackFieldsKey]
  }
}
