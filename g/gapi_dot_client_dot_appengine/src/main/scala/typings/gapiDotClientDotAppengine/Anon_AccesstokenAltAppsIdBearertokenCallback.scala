...
trait Anon_AccesstokenAltAppsIdBearertokenCallback extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltAppsIdBearertokenCallback {
  @scala.inline
  def apply(
    appsId: String,
    `$.xgafv`: String = null,
  ...
  ): Anon_AccesstokenAltAppsIdBearertokenCallback = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltAppsIdBearertokenCallback]
  }
}
