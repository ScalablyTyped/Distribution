...
trait Anon_AccesstokenAltAppsIdAuthorizedCertificatesId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
  ...
  var authorizedCertificatesId: java.lang.String
  /** OAuth bearer token. */
...
object Anon_AccesstokenAltAppsIdAuthorizedCertificatesId {
  @scala.inline
  def apply(
    appsId: java.lang.String,
    authorizedCertificatesId: java.lang.String,
  ...
  ): Anon_AccesstokenAltAppsIdAuthorizedCertificatesId = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltAppsIdAuthorizedCertificatesId]
  }
}
