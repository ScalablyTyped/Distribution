...
object Anon_AccesstokenAltAppsIdBearertokenCallbackFieldsFilter {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltAppsIdBearertokenCallbackFieldsFilter = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltAppsIdBearertokenCallbackFieldsFilter]
  }
}
