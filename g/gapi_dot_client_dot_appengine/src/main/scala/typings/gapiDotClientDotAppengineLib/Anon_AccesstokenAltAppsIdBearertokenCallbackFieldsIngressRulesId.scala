...
object Anon_AccesstokenAltAppsIdBearertokenCallbackFieldsIngressRulesId {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltAppsIdBearertokenCallbackFieldsIngressRulesId = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltAppsIdBearertokenCallbackFieldsIngressRulesId]
  }
}
