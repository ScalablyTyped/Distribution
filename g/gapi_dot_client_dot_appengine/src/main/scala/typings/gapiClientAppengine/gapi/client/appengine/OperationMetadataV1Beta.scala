...
@js.native
trait OperationMetadataV1Beta extends js.Object {
...
object OperationMetadataV1Beta {
  @scala.inline
  def apply(): OperationMetadataV1Beta = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OperationMetadataV1Beta]
  }
  @scala.inline
  implicit class OperationMetadataV1BetaOps[Self <: OperationMetadataV1Beta] (val x: Self) extends AnyVal {
    @scala.inline
