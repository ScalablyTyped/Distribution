package typings.gapiClientAppengine.anon
...
object InstancesId {
  @scala.inline
  def apply(appsId: String, instancesId: String, servicesId: String, versionsId: String): InstancesId = {
    val __obj = js.Dynamic.literal(appsId = appsId.asInstanceOf[js.Any], instancesId = instancesId.asInstanceOf[js.Any], servicesId = servicesId.asInstanceOf[js.Any], versionsId = versionsId.asInstanceOf[js.Any])
