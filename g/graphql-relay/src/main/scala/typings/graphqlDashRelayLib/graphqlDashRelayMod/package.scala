...
package object graphqlDashRelayMod {
  ...
  type ConnectionConfigNodeTypeNullable = graphqlLib.graphqlMod.GraphQLScalarType | graphqlLib.graphqlMod.GraphQLObjectType | graphqlLib.graphqlMod.GraphQLInterfaceType | graphqlLib.graphqlMod.GraphQLUnionType | graphqlLib.graphqlMod.GraphQLEnumType
