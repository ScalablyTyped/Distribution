...
object Stderr {
  ...
  implicit class StderrOps[Self <: Stderr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStderr(value: String | Buffer): Self = this.set("stderr", value.asInstanceOf[js.Any])
    @scala.inline
    def setStdout(value: String | Buffer): Self = this.set("stdout", value.asInstanceOf[js.Any])
  }
