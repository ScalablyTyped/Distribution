...
trait AnonMediaItemIds extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
  ...
  /**
    ...
    */
  var mediaItemIds: js.UndefOr[String | js.Array[String]] = js.undefined
...
object AnonMediaItemIds {
  ...
  def apply(
    ...
    fields: String = null,
    key: String = null,
    mediaItemIds: String | js.Array[String] = null,
    ...
    __obj.asInstanceOf[AnonMediaItemIds]
  }
}
