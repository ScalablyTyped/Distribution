...
import typings.gapiClientPlaymoviespartner.AnonAccesstokenAccountIdAltBearertokenCallbackCountries
...
trait StoreInfosResource extends js.Object {
  ...
  /**
    ...
    */
  def list(request: AnonAccesstokenAccountIdAltBearertokenCallbackCountries): Request_[ListStoreInfosResponse]
}
...
object StoreInfosResource {
  ...
  def apply(
    ...
    list: AnonAccesstokenAccountIdAltBearertokenCallbackCountries => Request_[ListStoreInfosResponse]
  ): StoreInfosResource = {
