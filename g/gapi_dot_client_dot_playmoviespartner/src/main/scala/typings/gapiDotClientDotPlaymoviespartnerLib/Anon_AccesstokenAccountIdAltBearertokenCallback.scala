...
trait Anon_AccesstokenAccountIdAltBearertokenCallback extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAccountIdAltBearertokenCallback {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(accountId = accountId, country = country, videoId = videoId)
