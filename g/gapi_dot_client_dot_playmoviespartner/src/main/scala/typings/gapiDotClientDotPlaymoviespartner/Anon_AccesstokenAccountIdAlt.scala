...
object Anon_AccesstokenAccountIdAlt {
  @scala.inline
  def apply(
    accountId: String,
    orderId: String,
  ...
  ): Anon_AccesstokenAccountIdAlt = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], orderId = orderId.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[Anon_AccesstokenAccountIdAlt]
  }
}
