...
trait MyconfigResource extends js.Object {
  ...
  def releaseDownloadAccess(request: gapiDotClientDotBooksLib.Anon_SourceVolumeIds): gapiDotClientLib.gapiNs.clientNs.Request[DownloadAccesses]
  /** Request concurrent and download access restrictions. */
  def requestAccess(request: gapiDotClientDotBooksLib.Anon_SourceNonce): gapiDotClientLib.gapiNs.clientNs.Request[RequestAccess]
