...
trait Anon_AccessViewStatus extends js.Object {
  /**
    ...
    */
  var accessViewStatus: js.UndefOr[java.lang.String] = js.undefined
  /** The two-letter ISO_3166-1 country code for which this access information is valid. (In LITE projection.) */
  var country: js.UndefOr[java.lang.String] = js.undefined
  /** Information about a volume's download license access restrictions. */
  var downloadAccess: js.UndefOr[gapiDotClientDotBooksLib.gapiNs.clientNs.booksNs.DownloadAccessRestriction] = js.undefined
  /** URL to the Google Drive viewer if this volume is uploaded by the user by selecting the file from Google Drive. */
  var driveImportedContentLink: js.UndefOr[java.lang.String] = js.undefined
  ...
  /**
    ...
    */
  var explicitOfflineLicenseManagement: js.UndefOr[scala.Boolean] = js.undefined
  /** Information about pdf content. (In LITE projection.) */
  var pdf: js.UndefOr[Anon_AcsTokenLink] = js.undefined
  /** Whether or not this book is public domain in the country listed above. */
  var publicDomain: js.UndefOr[scala.Boolean] = js.undefined
  /** Whether quote sharing is allowed for this volume. */
  var quoteSharingAllowed: js.UndefOr[scala.Boolean] = js.undefined
  /** Whether text-to-speech is permitted for this volume. Values can be ALLOWED, ALLOWED_FOR_ACCESSIBILITY, or NOT_ALLOWED. */
  var textToSpeechPermission: js.UndefOr[java.lang.String] = js.undefined
  /** For ordered but not yet processed orders, we give a URL that can be used to go to the appropriate Google Wallet page. */
  var viewOrderUrl: js.UndefOr[java.lang.String] = js.undefined
  /**
    ...
    */
  var viewability: js.UndefOr[java.lang.String] = js.undefined
