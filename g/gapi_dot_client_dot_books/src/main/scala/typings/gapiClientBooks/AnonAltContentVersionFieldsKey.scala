...
trait AnonAltContentVersionFieldsKey extends js.Object {
...
object AnonAltContentVersionFieldsKey {
  @scala.inline
  def apply(
    volumeId: String,
    alt: String = null,
    ...
    source: String = null,
    userIp: String = null
  ): AnonAltContentVersionFieldsKey = {
    ...
    __obj.asInstanceOf[AnonAltContentVersionFieldsKey]
  }
}
