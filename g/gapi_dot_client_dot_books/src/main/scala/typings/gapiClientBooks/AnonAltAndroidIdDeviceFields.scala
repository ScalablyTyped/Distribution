...
trait AnonAltAndroidIdDeviceFields extends js.Object {
...
object AnonAltAndroidIdDeviceFields {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltAndroidIdDeviceFields]
  }
}
