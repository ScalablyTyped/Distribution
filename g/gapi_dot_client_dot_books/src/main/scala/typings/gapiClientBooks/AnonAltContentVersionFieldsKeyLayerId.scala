...
trait AnonAltContentVersionFieldsKeyLayerId extends js.Object {
...
object AnonAltContentVersionFieldsKeyLayerId {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): AnonAltContentVersionFieldsKeyLayerId = {
    ...
    __obj.asInstanceOf[AnonAltContentVersionFieldsKeyLayerId]
  }
}
