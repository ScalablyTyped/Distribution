...
import typings.gapiClientBooks.AnonSourceWords
...
trait Dictlayerdata extends js.Object {
  ...
  var dict: js.UndefOr[AnonSourceWords] = js.undefined
  var kind: js.UndefOr[String] = js.undefined
}

object Dictlayerdata {
  @scala.inline
  def apply(common: AnonTitle = null, dict: AnonSourceWords = null, kind: String = null): Dictlayerdata = {
