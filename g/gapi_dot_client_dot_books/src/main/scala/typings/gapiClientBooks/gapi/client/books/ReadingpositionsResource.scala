...
import typings.gapiClientBooks.AnonAltContentVersionFieldsKeyOauthtoken
...
trait ReadingpositionsResource extends js.Object {
  ...
  def get(request: AnonAltContentVersionFieldsKeyOauthtoken): Request_[ReadingPosition]
...
object ReadingpositionsResource {
  @scala.inline
  def apply(
    get: AnonAltContentVersionFieldsKeyOauthtoken => Request_[ReadingPosition],
    setPosition: AnonAction => Request_[Unit]
