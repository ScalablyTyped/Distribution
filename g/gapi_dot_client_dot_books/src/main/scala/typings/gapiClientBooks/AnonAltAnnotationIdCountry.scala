...
trait AnonAltAnnotationIdCountry extends js.Object {
...
object AnonAltAnnotationIdCountry {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltAnnotationIdCountry]
  }
}
