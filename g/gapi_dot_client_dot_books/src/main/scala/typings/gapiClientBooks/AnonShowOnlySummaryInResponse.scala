...
trait AnonShowOnlySummaryInResponse extends js.Object {
...
object AnonShowOnlySummaryInResponse {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonShowOnlySummaryInResponse]
  }
}
