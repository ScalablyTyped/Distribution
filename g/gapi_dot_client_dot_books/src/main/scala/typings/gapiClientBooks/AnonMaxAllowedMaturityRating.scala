...
trait AnonMaxAllowedMaturityRating extends js.Object {
...
object AnonMaxAllowedMaturityRating {
  @scala.inline
  def apply(
    alt: String = null,
    fields: String = null,
    ...
    __obj.asInstanceOf[AnonMaxAllowedMaturityRating]
  }
}
