...
@js.native
trait MaxAllowedMaturityRating extends js.Object {
...
object MaxAllowedMaturityRating {
  @scala.inline
  def apply(): MaxAllowedMaturityRating = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MaxAllowedMaturityRating]
  }
  @scala.inline
  implicit class MaxAllowedMaturityRatingOps[Self <: MaxAllowedMaturityRating] (val x: Self) extends AnyVal {
    @scala.inline
