...
trait Anon_AltCollectionFieldsKey extends js.Object {
...
object Anon_AltCollectionFieldsKey {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltCollectionFieldsKey]
  }
}
