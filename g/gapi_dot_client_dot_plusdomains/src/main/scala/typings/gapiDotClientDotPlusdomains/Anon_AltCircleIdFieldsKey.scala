...
trait Anon_AltCircleIdFieldsKey extends js.Object {
...
object Anon_AltCircleIdFieldsKey {
  @scala.inline
  def apply(
    circleId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[Anon_AltCircleIdFieldsKey]
  }
}
