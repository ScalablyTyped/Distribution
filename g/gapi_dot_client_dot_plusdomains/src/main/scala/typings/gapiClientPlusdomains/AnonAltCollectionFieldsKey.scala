...
trait AnonAltCollectionFieldsKey extends js.Object {
...
object AnonAltCollectionFieldsKey {
  @scala.inline
  def apply(
    collection: String,
    userId: String,
    ...
    __obj.asInstanceOf[AnonAltCollectionFieldsKey]
  }
}
