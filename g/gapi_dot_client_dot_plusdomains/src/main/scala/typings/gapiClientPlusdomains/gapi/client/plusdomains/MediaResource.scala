...
import typings.gapiClientPlusdomains.AnonAltCollectionFields
...
trait MediaResource extends js.Object {
  /**
    ...
    */
  def insert(request: AnonAltCollectionFields): Request_[Media]
}

object MediaResource {
  @scala.inline
  def apply(insert: AnonAltCollectionFields => Request_[Media]): MediaResource = {
