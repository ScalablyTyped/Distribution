...
import typings.gapiClientPlusdomains.anon.Image
import typings.gapiClientPlusdomains.anon.Time
...
object Media {
  ...
  implicit class MediaOps[Self <: Media] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStreamsVarargs(value: Videostream*): Self = this.set("streams", js.Array(value :_*))
    @scala.inline
    def setStreams(value: js.Array[Videostream]): Self = this.set("streams", value.asInstanceOf[js.Any])
    @scala.inline
