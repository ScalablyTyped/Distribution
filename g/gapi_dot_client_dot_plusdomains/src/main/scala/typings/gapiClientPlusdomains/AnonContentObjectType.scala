...
trait AnonContentObjectType extends js.Object {
...
object AnonContentObjectType {
  @scala.inline
  def apply(content: String = null, objectType: String = null, originalContent: String = null): AnonContentObjectType = {
    ...
    __obj.asInstanceOf[AnonContentObjectType]
  }
}
