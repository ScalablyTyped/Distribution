...
trait Anon_AccesstokenAltBearertokenCallbackClientVersion extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackClientVersion {
  @scala.inline
  def apply(
    `$.xgafv`: String = null,
  ...
  ): Anon_AccesstokenAltBearertokenCallbackClientVersion = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackClientVersion]
  }
}
