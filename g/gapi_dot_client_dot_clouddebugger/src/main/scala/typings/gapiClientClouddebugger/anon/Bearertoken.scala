package typings.gapiClientClouddebugger.anon
...
trait Bearertoken extends js.Object {
  ...
  var breakpointId: String = js.native
  /** JSONP */
...
object Bearertoken {
  @scala.inline
  def apply(breakpointId: String, debuggeeId: String): Bearertoken = {
    val __obj = js.Dynamic.literal(breakpointId = breakpointId.asInstanceOf[js.Any], debuggeeId = debuggeeId.asInstanceOf[js.Any])
