...
object Event {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Event[?], T /* <: (typings.react.mod.SyntheticEvent[HTMLElement, typings.std.Event]) | typings.std.Event */] (val x: Self & Event[T]) extends AnyVal {
