...
trait ModalAlertActionDataType extends StObject {
...
object ModalAlertActionDataType {
  
  inline def apply(accessibilityLabel: String, label: String): ModalAlertActionDataType = {
    val __obj = js.Dynamic.literal(accessibilityLabel = accessibilityLabel.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
    __obj.asInstanceOf[ModalAlertActionDataType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ModalAlertActionDataType] (val x: Self) extends AnyVal {
