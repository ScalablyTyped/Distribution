...
/* Rewritten from type alias, can be one of: 
  - typings.gestalt.gestaltInts.`-12`
  - typings.gestalt.gestaltInts.`-11`
  - typings.gestalt.gestaltInts.`-10`
  - typings.gestalt.gestaltInts.`-9`
...
object SignedUpTo12 {
  ...
  inline def `-10`: typings.gestalt.gestaltInts.`-10` = -10.asInstanceOf[typings.gestalt.gestaltInts.`-10`]
  
  inline def `-11`: typings.gestalt.gestaltInts.`-11` = -11.asInstanceOf[typings.gestalt.gestaltInts.`-11`]
  
  inline def `-12`: typings.gestalt.gestaltInts.`-12` = -12.asInstanceOf[typings.gestalt.gestaltInts.`-12`]
  ...
  inline def `-9`: typings.gestalt.gestaltInts.`-9` = -9.asInstanceOf[typings.gestalt.gestaltInts.`-9`]
