...
trait Anon_EventHTMLVideoElement extends js.Object {
...
object Anon_EventHTMLVideoElement {
  @scala.inline
  def apply(event: reactLib.reactMod.ReactNs.SyntheticEvent[stdLib.HTMLVideoElement, reactLib.Event]): Anon_EventHTMLVideoElement = {
