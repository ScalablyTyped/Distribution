...
trait Anon_SyntheticEvent extends js.Object {
  var syntheticEvent: reactLib.reactMod.SyntheticEvent[stdLib.HTMLInputElement, reactLib.Event]
...
object Anon_SyntheticEvent {
  @scala.inline
  def apply(
    syntheticEvent: reactLib.reactMod.SyntheticEvent[stdLib.HTMLInputElement, reactLib.Event],
