...
trait Anon_EventVolume extends js.Object {
  var event: reactLib.reactMod.ReactNs.SyntheticEvent[stdLib.HTMLDivElement, reactLib.Event]
...
object Anon_EventVolume {
  @scala.inline
  def apply(
    event: reactLib.reactMod.ReactNs.SyntheticEvent[stdLib.HTMLDivElement, reactLib.Event],
    volume: scala.Double
  ): Anon_EventVolume = {
