...
trait PubSub extends js.Object {
  ...
  def createTopic(name: java.lang.String, gaxOpts: atGoogleDashCloudPubsubLib.pubsubMod.PubSubNs.GAXNs.CallOptions): js.Promise[js.Array[_]] = js.native
  def createTopic(
    name: java.lang.String,
  ...
  def getSnapshots(options: atGoogleDashCloudPubsubLib.pubsubMod.PubSubNs.PubSubNs.GetSnapshotsOptions): js.Promise[js.Array[_]] = js.native
  def getSnapshots(
  ...
  def getSubscriptions(options: atGoogleDashCloudPubsubLib.pubsubMod.PubSubNs.PubSubNs.GetSubscriptionsOptions): js.Promise[js.Array[_]] = js.native
  ...
  def getTopics(query: atGoogleDashCloudPubsubLib.pubsubMod.PubSubNs.PubSubNs.GetTopicsQuery): js.Promise[js.Array[_]] = js.native
  def getTopics(
