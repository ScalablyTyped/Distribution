...
trait Topic extends js.Object {
  ...
  def create(): stdLib.Promise[js.Array[_]] = js.native
  def create(callback: atGoogleDashCloudPubsubLib.pubsubMod.PubSubNs.TopicNs.CreateCallback): scala.Unit = js.native
  def create(gaxOpts: atGoogleDashCloudPubsubLib.pubsubMod.PubSubNs.GAXNs.CallOptions): stdLib.Promise[js.Array[_]] = js.native
  def create(
  ...
  def createSubscription(): stdLib.Promise[js.Array[_]] = js.native
  ...
  def createSubscription(nameOrOptions: atGoogleDashCloudPubsubLib.pubsubMod.PubSubNs.TopicNs.CreateSubscriptionOptions): stdLib.Promise[js.Array[_]] = js.native
  ...
  def createSubscription(nameOrOptions: java.lang.String): stdLib.Promise[js.Array[_]] = js.native
  def createSubscription(
  ...
  def getSubscriptions(options: atGoogleDashCloudPubsubLib.pubsubMod.PubSubNs.TopicNs.GetSubscriptionsOptions): stdLib.Promise[js.Array[_]] = js.native
