...
trait IAM extends js.Object {
  def getPolicy(): stdLib.Promise[js.Array[_]] = js.native
  def getPolicy(callback: atGoogleDashCloudPubsubLib.pubsubMod.PubSubNs.IAMNs.GetPolicyCallback): scala.Unit = js.native
  def setPolicy(policy: atGoogleDashCloudPubsubLib.pubsubMod.PubSubNs.IAMNs.Policy): stdLib.Promise[js.Array[_]] = js.native
  def setPolicy(
  ...
  def testPermissions(permissions: java.lang.String): stdLib.Promise[js.Array[_]] = js.native
  def testPermissions(
    permissions: java.lang.String,
    callback: atGoogleDashCloudPubsubLib.pubsubMod.PubSubNs.IAMNs.TestPermissionsCallback
  ): scala.Unit = js.native
  def testPermissions(permissions: js.Array[java.lang.String]): stdLib.Promise[js.Array[_]] = js.native
  def testPermissions(
