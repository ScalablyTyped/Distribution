...
trait GetSubscriptionsOptions extends js.Object {
  ...
  var topic: js.UndefOr[atGoogleDashCloudPubsubLib.atGoogleDashCloudPubsubMod.Topic | java.lang.String] = js.undefined
}
...
object GetSubscriptionsOptions {
  ...
  def apply(
    ...
    topic: atGoogleDashCloudPubsubLib.atGoogleDashCloudPubsubMod.Topic | java.lang.String = null
