...
object DetachSubscriptionResponse {
  ...
  @js.native
  def create(): typings.googleCloudPubsub.protosMod.google.pubsub.v1.DetachSubscriptionResponse = js.native
  @JSImport("@google-cloud/pubsub", "protos.google.pubsub.v1.DetachSubscriptionResponse.create")
  @js.native
  def create(properties: IDetachSubscriptionResponse): typings.googleCloudPubsub.protosMod.google.pubsub.v1.DetachSubscriptionResponse = js.native
  ...
  @js.native
  def decode(reader: Reader): typings.googleCloudPubsub.protosMod.google.pubsub.v1.DetachSubscriptionResponse = js.native
  @JSImport("@google-cloud/pubsub", "protos.google.pubsub.v1.DetachSubscriptionResponse.decode")
  @js.native
  def decode(reader: Reader, length: Double): typings.googleCloudPubsub.protosMod.google.pubsub.v1.DetachSubscriptionResponse = js.native
  @JSImport("@google-cloud/pubsub", "protos.google.pubsub.v1.DetachSubscriptionResponse.decode")
  @js.native
  def decode(reader: Uint8Array): typings.googleCloudPubsub.protosMod.google.pubsub.v1.DetachSubscriptionResponse = js.native
  @JSImport("@google-cloud/pubsub", "protos.google.pubsub.v1.DetachSubscriptionResponse.decode")
  @js.native
  def decode(reader: Uint8Array, length: Double): typings.googleCloudPubsub.protosMod.google.pubsub.v1.DetachSubscriptionResponse = js.native
  ...
  @js.native
  def decodeDelimited(reader: Reader): typings.googleCloudPubsub.protosMod.google.pubsub.v1.DetachSubscriptionResponse = js.native
  @JSImport("@google-cloud/pubsub", "protos.google.pubsub.v1.DetachSubscriptionResponse.decodeDelimited")
  @js.native
  def decodeDelimited(reader: Uint8Array): typings.googleCloudPubsub.protosMod.google.pubsub.v1.DetachSubscriptionResponse = js.native
  ...
  @js.native
  def fromObject(`object`: StringDictionary[js.Any]): typings.googleCloudPubsub.protosMod.google.pubsub.v1.DetachSubscriptionResponse = js.native
  ...
  @js.native
  def toObject(message: typings.googleCloudPubsub.protosMod.google.pubsub.v1.DetachSubscriptionResponse): StringDictionary[js.Any] = js.native
  @JSImport("@google-cloud/pubsub", "protos.google.pubsub.v1.DetachSubscriptionResponse.toObject")
  @js.native
  def toObject(
