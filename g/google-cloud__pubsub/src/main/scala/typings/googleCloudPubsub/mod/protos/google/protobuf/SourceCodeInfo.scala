...
object SourceCodeInfo extends js.Object {
  ...
  object Location extends js.Object {
    /**
      ...
      */
    def create(): typings.googleCloudPubsub.protosMod.google.protobuf.SourceCodeInfo.Location = js.native
    def create(properties: ILocation): typings.googleCloudPubsub.protosMod.google.protobuf.SourceCodeInfo.Location = js.native
    /**
      ...
      * @throws {$protobuf.util.ProtocolError} If required fields are missing
      */
    def decode(reader: Reader): typings.googleCloudPubsub.protosMod.google.protobuf.SourceCodeInfo.Location = js.native
    def decode(reader: Reader, length: Double): typings.googleCloudPubsub.protosMod.google.protobuf.SourceCodeInfo.Location = js.native
    def decode(reader: Uint8Array): typings.googleCloudPubsub.protosMod.google.protobuf.SourceCodeInfo.Location = js.native
    def decode(reader: Uint8Array, length: Double): typings.googleCloudPubsub.protosMod.google.protobuf.SourceCodeInfo.Location = js.native
    /**
      ...
      * @throws {$protobuf.util.ProtocolError} If required fields are missing
      */
    def decodeDelimited(reader: Reader): typings.googleCloudPubsub.protosMod.google.protobuf.SourceCodeInfo.Location = js.native
    def decodeDelimited(reader: Uint8Array): typings.googleCloudPubsub.protosMod.google.protobuf.SourceCodeInfo.Location = js.native
    /**
    ...
    /**
      ...
      * @returns Location
      */
    def fromObject(`object`: StringDictionary[js.Any]): typings.googleCloudPubsub.protosMod.google.protobuf.SourceCodeInfo.Location = js.native
    /**
      ...
      * @returns Plain object
      */
    def toObject(message: typings.googleCloudPubsub.protosMod.google.protobuf.SourceCodeInfo.Location): StringDictionary[js.Any] = js.native
    def toObject(
      message: typings.googleCloudPubsub.protosMod.google.protobuf.SourceCodeInfo.Location,
      options: IConversionOptions
    ): StringDictionary[js.Any] = js.native
    /**
