...
object v1 {
  ...
  @JSImport("@google-cloud/pubsub", "v1.PublisherClient")
  @js.native
  /**
    ...
    *     ```
    */
  open class PublisherClient ()
    extends typings.googleCloudPubsub.v1Mod.PublisherClient {
  ...
  @JSImport("@google-cloud/pubsub", "v1.SchemaServiceClient")
  @js.native
  /**
    ...
    *     ```
    */
  open class SchemaServiceClient ()
    extends typings.googleCloudPubsub.v1Mod.SchemaServiceClient {
    def this(opts: ClientOptions) = this()
    def this(opts: Unit, gaxInstance: Typeoffallback) = this()
    def this(opts: Unit, gaxInstance: Typeofgax) = this()
    def this(opts: ClientOptions, gaxInstance: Typeoffallback) = this()
  ...
  @JSImport("@google-cloud/pubsub", "v1.SubscriberClient")
  @js.native
  /**
    ...
    *     ```
    */
  open class SubscriberClient ()
    extends typings.googleCloudPubsub.v1Mod.SubscriberClient {
    def this(opts: ClientOptions) = this()
    def this(opts: Unit, gaxInstance: Typeoffallback) = this()
    def this(opts: Unit, gaxInstance: Typeofgax) = this()
    def this(opts: ClientOptions, gaxInstance: Typeoffallback) = this()
