...
import typings.googleCloudPubsub.schemaMod.Schema
import typings.googleCloudPubsub.schemaMod.SchemaType
import typings.googleCloudPubsub.schemaMod.SchemaView
...
import typings.googleCloudPubsub.topicMod.TopicMetadata
import typings.googleCloudPubsub.v1Mod.SchemaServiceClient
...
object pubsubMod {
  ...
  open class PubSub () extends StObject {
    ...
    /**
      ...
      * @private
      */
    def getSchemaClient_(): js.Promise[SchemaServiceClient] = js.native
    ...
    /**
      ...
      * ```
      */
    def listSchemas(): AsyncIterable[ISchema] = js.native
    def listSchemas(view: Unit, options: CallOptions): AsyncIterable[ISchema] = js.native
    def listSchemas(view: SchemaView): AsyncIterable[ISchema] = js.native
    def listSchemas(view: SchemaView, options: CallOptions): AsyncIterable[ISchema] = js.native
    ...
    /**
      ...
      * @returns {Promise<void>}
      */
    def validateSchema(schema: typings.googleCloudPubsub.schemaMod.ISchema): js.Promise[Unit] = js.native
    def validateSchema(schema: typings.googleCloudPubsub.schemaMod.ISchema, gaxOpts: CallOptions): js.Promise[Unit] = js.native
  }
  /* static members */
  object PubSub {
