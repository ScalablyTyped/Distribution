...
object v1Mod {
  ...
  @JSImport("@google-cloud/pubsub/build/src/v1", "PublisherClient")
  @js.native
  /**
  ...
  open class PublisherClient ()
    extends typings.googleCloudPubsub.publisherClientMod.PublisherClient {
  ...
  @JSImport("@google-cloud/pubsub/build/src/v1", "SchemaServiceClient")
  @js.native
  /**
  ...
  open class SchemaServiceClient ()
    extends typings.googleCloudPubsub.schemaServiceClientMod.SchemaServiceClient {
    def this(opts: ClientOptions) = this()
    def this(opts: Unit, gaxInstance: Typeoffallback) = this()
    def this(opts: Unit, gaxInstance: Typeofgax) = this()
    def this(opts: ClientOptions, gaxInstance: Typeoffallback) = this()
  ...
  @JSImport("@google-cloud/pubsub/build/src/v1", "SubscriberClient")
  @js.native
  /**
  ...
  open class SubscriberClient ()
    extends typings.googleCloudPubsub.subscriberClientMod.SubscriberClient {
    def this(opts: ClientOptions) = this()
    def this(opts: Unit, gaxInstance: Typeoffallback) = this()
    def this(opts: Unit, gaxInstance: Typeofgax) = this()
    def this(opts: ClientOptions, gaxInstance: Typeoffallback) = this()
