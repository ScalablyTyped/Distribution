...
import typings.googleCloudPubsub.protosMod.google.pubsub.v1.Encoding
...
object schemaMod {
  ...
  open class Schema protected () extends StObject {
    ...
    /**
      ...
      * @returns {Promise<void>}
      */
    def validateMessage(message: String, encoding: Encoding): js.Promise[Unit] = js.native
    def validateMessage(message: String, encoding: Encoding, gaxOpts: CallOptions): js.Promise[Unit] = js.native
  }
  /* static members */
  object Schema {
  ...
  type CreateSchemaResponse = typings.googleCloudPubsub.protosMod.google.pubsub.v1.Schema
  
  type ICreateSchemaRequest = typings.googleCloudPubsub.protosMod.google.pubsub.v1.ICreateSchemaRequest
  
  type ISchema = typings.googleCloudPubsub.protosMod.google.pubsub.v1.ISchema
