...
object subscriptionMod extends js.Object {
  ...
  type CreateSubscriptionOptions = SubscriptionMetadata with AnonFlowControl
  ...
  type GetSubscriptionOptions = CallOptions with AnonAutoCreate
  ...
  type SubscriptionMetadata = AnonMessageRetentionDuration with (Omit[ISubscription, messageRetentionDuration])
  type SubscriptionOptions = SubscriberOptions with AnonTopicOptional
