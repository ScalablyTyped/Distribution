package typings.googleCloudPubsub.pubsubMod.google.protobuf.FieldDescriptorProto
...
/** Type enum. */
@JSImport("@google-cloud/pubsub/build/proto/pubsub", "google.protobuf.FieldDescriptorProto.Type")
@js.native
