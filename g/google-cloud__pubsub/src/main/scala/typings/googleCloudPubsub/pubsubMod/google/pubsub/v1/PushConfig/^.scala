...
object ^ extends js.Object {
  /**
    ...
    */
  def create(): typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  def create(properties: IPushConfig): typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  /**
    ...
    */
  def decode(reader: Reader): typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  def decode(reader: Reader, length: Double): typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  def decode(reader: Uint8Array): typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  def decode(reader: Uint8Array, length: Double): typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  def decodeDelimited(reader: Uint8Array): typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  /**
  ...
  /**
    ...
    * @returns PushConfig
    */
  def fromObject(`object`: StringDictionary[js.Any]): typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig = js.native
  /**
    ...
    */
  def toObject(message: typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig): StringDictionary[js.Any] = js.native
  def toObject(
    message: typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.PushConfig,
