...
import typings.googleCloudPubsub.pubsubMod.google.protobuf.FieldDescriptorProto.Label
import typings.googleCloudPubsub.pubsubMod.google.protobuf.FieldDescriptorProto.Type
...
object IFieldDescriptorProto {
  ...
  def apply(
    ...
    label: js.UndefOr[Null | Label] = js.undefined,
