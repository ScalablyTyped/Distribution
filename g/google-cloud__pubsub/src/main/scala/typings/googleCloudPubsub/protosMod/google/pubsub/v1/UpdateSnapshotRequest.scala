...
/**
  ...
  */
open class UpdateSnapshotRequest ()
  extends StObject
...
object UpdateSnapshotRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): UpdateSnapshotRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[UpdateSnapshotRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): UpdateSnapshotRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[UpdateSnapshotRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): UpdateSnapshotRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[UpdateSnapshotRequest]
  /**
  ...
  /**
    ...
    */
  /* static member */
  inline def fromObject(`object`: StringDictionary[Any]): UpdateSnapshotRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[UpdateSnapshotRequest]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: UpdateSnapshotRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: UpdateSnapshotRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
