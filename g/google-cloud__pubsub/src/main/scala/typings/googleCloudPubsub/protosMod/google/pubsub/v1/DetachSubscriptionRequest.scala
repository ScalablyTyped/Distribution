...
/**
  ...
  */
class DetachSubscriptionRequest () extends IDetachSubscriptionRequest {
...
object DetachSubscriptionRequest {
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.create")
  @js.native
  def create(): DetachSubscriptionRequest = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.create")
  @js.native
  def create(properties: IDetachSubscriptionRequest): DetachSubscriptionRequest = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.decode")
  @js.native
  def decode(reader: Reader): DetachSubscriptionRequest = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.decode")
  @js.native
  def decode(reader: Reader, length: Double): DetachSubscriptionRequest = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.decode")
  @js.native
  def decode(reader: Uint8Array): DetachSubscriptionRequest = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.decode")
  @js.native
  def decode(reader: Uint8Array, length: Double): DetachSubscriptionRequest = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.decodeDelimited")
  @js.native
  def decodeDelimited(reader: Reader): DetachSubscriptionRequest = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.decodeDelimited")
  @js.native
  def decodeDelimited(reader: Uint8Array): DetachSubscriptionRequest = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.encode")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.encodeDelimited")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.fromObject")
  @js.native
  def fromObject(`object`: StringDictionary[js.Any]): DetachSubscriptionRequest = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.toObject")
  @js.native
  def toObject(message: DetachSubscriptionRequest): StringDictionary[js.Any] = js.native
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.toObject")
  @js.native
  def toObject(message: DetachSubscriptionRequest, options: IConversionOptions): StringDictionary[js.Any] = js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.pubsub.v1.DetachSubscriptionRequest.verify")
  @js.native
