...
object PullRequest {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): PullRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[PullRequest]
  inline def create(properties: IPullRequest): PullRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[PullRequest]
  
  inline def decode(reader: js.typedarray.Uint8Array): PullRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[PullRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): PullRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[PullRequest]
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): PullRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[PullRequest]
  inline def decode(reader: Reader, length: Double): PullRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[PullRequest]
  
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): PullRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[PullRequest]
  /**
    ...
    */
  /* static member */
  inline def decodeDelimited(reader: Reader): PullRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[PullRequest]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromObject(`object`: StringDictionary[Any]): PullRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[PullRequest]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: PullRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: PullRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
