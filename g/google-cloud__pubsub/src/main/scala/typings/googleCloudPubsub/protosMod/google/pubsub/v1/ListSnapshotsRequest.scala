...
/**
  ...
  */
open class ListSnapshotsRequest ()
  extends StObject
     with IListSnapshotsRequest {
...
object ListSnapshotsRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): ListSnapshotsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ListSnapshotsRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ListSnapshotsRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ListSnapshotsRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ListSnapshotsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ListSnapshotsRequest]
  /**
  ...
  /**
    ...
    */
  /* static member */
  inline def fromObject(`object`: StringDictionary[Any]): ListSnapshotsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ListSnapshotsRequest]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: ListSnapshotsRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ListSnapshotsRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
