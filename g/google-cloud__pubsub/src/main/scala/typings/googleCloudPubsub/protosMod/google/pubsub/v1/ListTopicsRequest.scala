...
object ListTopicsRequest {
  ...
  /* static member */
  @scala.inline
  def create(): ListTopicsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[ListTopicsRequest]
  @scala.inline
  def create(properties: IListTopicsRequest): ListTopicsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[ListTopicsRequest]
  ...
  /* static member */
  @scala.inline
  def decode(reader: Reader): ListTopicsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ListTopicsRequest]
  @scala.inline
  def decode(reader: Reader, length: Double): ListTopicsRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ListTopicsRequest]
  @scala.inline
  def decode(reader: Uint8Array): ListTopicsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ListTopicsRequest]
  @scala.inline
  def decode(reader: Uint8Array, length: Double): ListTopicsRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ListTopicsRequest]
  ...
  /* static member */
  @scala.inline
  def decodeDelimited(reader: Reader): ListTopicsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ListTopicsRequest]
  @scala.inline
  def decodeDelimited(reader: Uint8Array): ListTopicsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ListTopicsRequest]
  ...
  /* static member */
  @scala.inline
  def fromObject(`object`: StringDictionary[js.Any]): ListTopicsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ListTopicsRequest]
  ...
  /* static member */
  @scala.inline
  def toObject(message: ListTopicsRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  @scala.inline
  def toObject(message: ListTopicsRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
