...
object ResourceDescriptor {
  ...
  /** History enum. */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.api.ResourceDescriptor.History")
  @js.native
  object History extends StObject {
    ...
    sealed trait FUTURE_MULTI_PATTERN
      extends StObject
         with typings.googleCloudPubsub.protosMod.google.api.ResourceDescriptor.History
  ...
  /** Style enum. */
  @JSImport("@google-cloud/pubsub/build/protos/protos", "google.api.ResourceDescriptor.Style")
  @js.native
  object Style extends StObject {
    ...
    sealed trait DECLARATIVE_FRIENDLY
      extends StObject
         with Style
    /* 1 */ val DECLARATIVE_FRIENDLY: typings.googleCloudPubsub.protosMod.google.api.ResourceDescriptor.Style.DECLARATIVE_FRIENDLY & Double = js.native
    
    @js.native
    sealed trait STYLE_UNSPECIFIED
      extends StObject
         with Style
    /* 0 */ val STYLE_UNSPECIFIED: typings.googleCloudPubsub.protosMod.google.api.ResourceDescriptor.Style.STYLE_UNSPECIFIED & Double = js.native
  }
