...
object ListSnapshotsResponse {
  ...
  /* static member */
  @scala.inline
  def create(): ListSnapshotsResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[ListSnapshotsResponse]
  @scala.inline
  def create(properties: IListSnapshotsResponse): ListSnapshotsResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[ListSnapshotsResponse]
  ...
  /* static member */
  @scala.inline
  def decode(reader: Reader): ListSnapshotsResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ListSnapshotsResponse]
  @scala.inline
  def decode(reader: Reader, length: Double): ListSnapshotsResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ListSnapshotsResponse]
  @scala.inline
  def decode(reader: Uint8Array): ListSnapshotsResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ListSnapshotsResponse]
  @scala.inline
  def decode(reader: Uint8Array, length: Double): ListSnapshotsResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ListSnapshotsResponse]
  ...
  /* static member */
  @scala.inline
  def decodeDelimited(reader: Reader): ListSnapshotsResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ListSnapshotsResponse]
  @scala.inline
  def decodeDelimited(reader: Uint8Array): ListSnapshotsResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ListSnapshotsResponse]
  ...
  /* static member */
  @scala.inline
  def fromObject(`object`: StringDictionary[js.Any]): ListSnapshotsResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ListSnapshotsResponse]
  ...
  /* static member */
  @scala.inline
  def toObject(message: ListSnapshotsResponse): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  @scala.inline
  def toObject(message: ListSnapshotsResponse, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
