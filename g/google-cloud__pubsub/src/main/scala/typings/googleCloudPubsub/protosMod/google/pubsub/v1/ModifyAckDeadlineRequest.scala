...
object ModifyAckDeadlineRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): ModifyAckDeadlineRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ModifyAckDeadlineRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ModifyAckDeadlineRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ModifyAckDeadlineRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ModifyAckDeadlineRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ModifyAckDeadlineRequest]
  /**
  ...
  /**
    ...
    */
  /* static member */
  inline def fromObject(`object`: StringDictionary[Any]): ModifyAckDeadlineRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ModifyAckDeadlineRequest]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: ModifyAckDeadlineRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ModifyAckDeadlineRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
