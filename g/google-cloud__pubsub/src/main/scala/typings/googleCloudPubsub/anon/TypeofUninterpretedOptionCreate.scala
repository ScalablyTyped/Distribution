...
@js.native
trait TypeofUninterpretedOptionCreate extends StObject {
  
  /** Represents a NamePart. */
  var NamePart: (Instantiable0[
    typings.googleGax.mod.fallback.IamProtos.google.protobuf.UninterpretedOption.NamePart
  ]) & TypeofNamePart = js.native
