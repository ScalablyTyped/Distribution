...
import typings.googleGax.operationsMod.google.protobuf.DescriptorProto
import typings.googleGax.operationsMod.google.protobuf.IDescriptorProto
...
@js.native
trait TypeofDescriptorProtoEncodeDelimited extends StObject {
  
  /** Represents an ExtensionRange. */
  var ExtensionRange: (Instantiable0[
    typings.googleGax.mod.operationsProtos.google.protobuf.DescriptorProto.ExtensionRange
  ]) & TypeofExtensionRangeDecode = js.native
  
  /** Represents a ReservedRange. */
  var ReservedRange: (Instantiable0[
    typings.googleGax.mod.operationsProtos.google.protobuf.DescriptorProto.ReservedRange
  ]) & TypeofReservedRangeDecode = js.native
