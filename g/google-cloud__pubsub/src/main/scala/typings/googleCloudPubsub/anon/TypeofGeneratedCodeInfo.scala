...
@js.native
trait TypeofGeneratedCodeInfo extends StObject {
  
  /** Represents an Annotation. */
  var Annotation: Instantiable0[typings.googleGax.mod.IamProtos.google.protobuf.GeneratedCodeInfo.Annotation] & TypeofAnnotation = js.native
