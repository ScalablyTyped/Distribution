...
@js.native
trait TypeofutilAsPromise extends StObject {
  ...
  var EventEmitter: Instantiable0[typings.googleGax.mod.protobuf.util.EventEmitter] = js.native
  ...
  var ProtocolError: Instantiable1[
    /* message */ String, 
    typings.googleGax.mod.protobuf.util.ProtocolError[Message[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]]
  ] = js.native
