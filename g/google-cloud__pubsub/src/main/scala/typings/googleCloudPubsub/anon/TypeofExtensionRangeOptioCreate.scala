...
import typings.googleGax.locationsMod.google.protobuf.ExtensionRangeOptions
import typings.googleGax.locationsMod.google.protobuf.IExtensionRangeOptions
...
@js.native
trait TypeofExtensionRangeOptioCreate extends StObject {
  ...
  /**
    ...
    */
  /* static member */
  def fromObject(`object`: StringDictionary[Any]): ExtensionRangeOptions = js.native
  ...
  /**
    ...
    */
  /* static member */
  def toObject(message: ExtensionRangeOptions): StringDictionary[Any] = js.native
  def toObject(message: ExtensionRangeOptions, options: IConversionOptions): StringDictionary[Any] = js.native
