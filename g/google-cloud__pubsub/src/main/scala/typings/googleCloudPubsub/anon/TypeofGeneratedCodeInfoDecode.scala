...
import typings.googleGax.operationsMod.google.protobuf.GeneratedCodeInfo
...
@js.native
trait TypeofGeneratedCodeInfoDecode extends StObject {
  
  /** Represents an Annotation. */
  var Annotation: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.protobuf.GeneratedCodeInfo.Annotation
  ]) & TypeofAnnotationDecode = js.native
