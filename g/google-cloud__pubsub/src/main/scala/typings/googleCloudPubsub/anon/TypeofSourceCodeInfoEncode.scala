...
@js.native
trait TypeofSourceCodeInfoEncode extends StObject {
  
  /** Represents a Location. */
  var Location: Instantiable0[typings.googleGax.mod.LocationProtos.google.protobuf.SourceCodeInfo.Location] & TypeofLocationCreate = js.native
