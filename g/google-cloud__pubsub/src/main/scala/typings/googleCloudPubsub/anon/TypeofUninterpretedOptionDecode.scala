...
import typings.googleGax.locationsMod.google.protobuf.UninterpretedOption
...
@js.native
trait TypeofUninterpretedOptionDecode extends StObject {
  
  /** Represents a NamePart. */
  var NamePart: (Instantiable0[
    typings.googleGax.mod.fallback.LocationProtos.google.protobuf.UninterpretedOption.NamePart
  ]) & TypeofNamePartCreate = js.native
