...
import typings.googleGax.iamServiceMod.google.protobuf.DescriptorProto
...
@js.native
trait TypeofDescriptorProtoCreate extends StObject {
  
  /** Represents an ExtensionRange. */
  var ExtensionRange: (Instantiable0[
    typings.googleGax.mod.fallback.IamProtos.google.protobuf.DescriptorProto.ExtensionRange
  ]) & TypeofExtensionRange = js.native
  
  /** Represents a ReservedRange. */
  var ReservedRange: (Instantiable0[
    typings.googleGax.mod.fallback.IamProtos.google.protobuf.DescriptorProto.ReservedRange
  ]) & TypeofReservedRange = js.native
