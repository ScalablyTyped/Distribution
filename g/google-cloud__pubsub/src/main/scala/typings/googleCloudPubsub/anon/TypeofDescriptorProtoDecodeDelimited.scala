...
@js.native
trait TypeofDescriptorProtoDecodeDelimited extends StObject {
  
  /** Represents an ExtensionRange. */
  var ExtensionRange: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.protobuf.DescriptorProto.ExtensionRange
  ]) & TypeofExtensionRangeDecode = js.native
  
  /** Represents a ReservedRange. */
  var ReservedRange: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.protobuf.DescriptorProto.ReservedRange
