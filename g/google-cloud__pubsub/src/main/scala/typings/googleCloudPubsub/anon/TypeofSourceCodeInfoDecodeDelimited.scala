...
@js.native
trait TypeofSourceCodeInfoDecodeDelimited extends StObject {
  
  /** Represents a Location. */
  var Location: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.protobuf.SourceCodeInfo.Location
  ]) & TypeofLocationDecodeDelimited = js.native
