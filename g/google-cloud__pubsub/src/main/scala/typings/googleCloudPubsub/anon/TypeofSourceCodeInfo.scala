...
@js.native
trait TypeofSourceCodeInfo extends StObject {
  
  /** Represents a Location. */
  var Location: Instantiable0[typings.googleGax.mod.IamProtos.google.protobuf.SourceCodeInfo.Location] & TypeofLocation_ = js.native
