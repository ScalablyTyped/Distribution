...
@js.native
trait TypeofEnumDescriptorProtoEncodeDelimited extends StObject {
  
  /** Represents an EnumReservedRange. */
  var EnumReservedRange: (Instantiable0[
    typings.googleGax.mod.operationsProtos.google.protobuf.EnumDescriptorProto.EnumReservedRange
