...
import typings.googleGax.iamServiceMod.google.protobuf.UninterpretedOption
...
@js.native
trait TypeofUninterpretedOption extends StObject {
  
  /** Represents a NamePart. */
  var NamePart: Instantiable0[typings.googleGax.mod.IamProtos.google.protobuf.UninterpretedOption.NamePart] & TypeofNamePart = js.native
