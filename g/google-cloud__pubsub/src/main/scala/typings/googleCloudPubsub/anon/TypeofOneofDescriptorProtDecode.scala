...
import typings.googleGax.operationsMod.google.protobuf.IOneofDescriptorProto
import typings.googleGax.operationsMod.google.protobuf.OneofDescriptorProto
...
@js.native
trait TypeofOneofDescriptorProtDecode extends StObject {
  ...
  /**
    ...
    */
  /* static member */
  def fromObject(`object`: StringDictionary[Any]): OneofDescriptorProto = js.native
  ...
  /**
    ...
    */
  /* static member */
  def toObject(message: OneofDescriptorProto): StringDictionary[Any] = js.native
  def toObject(message: OneofDescriptorProto, options: IConversionOptions): StringDictionary[Any] = js.native
