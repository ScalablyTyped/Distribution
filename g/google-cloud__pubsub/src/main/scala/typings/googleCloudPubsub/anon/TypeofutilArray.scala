...
trait TypeofutilArray extends StObject {
  ...
  var EventEmitter: Instantiable0[typings.googleGax.mod.fallback.protobufMinimal.util.EventEmitter] = js.native
  ...
  var LongBits: (Instantiable2[
    /* lo */ Double, 
    /* hi */ Double, 
    typings.googleGax.mod.fallback.protobufMinimal.util.LongBits
  ]) & TypeofLongBits = js.native
  
  /** Error subclass indicating a protocol specifc error. */
  var ProtocolError: Instantiable1[
    /* message */ String, 
    typings.googleGax.mod.fallback.protobufMinimal.util.ProtocolError[Message[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]]
  ] = js.native
