...
import typings.googleGax.mod.fallback.LocationProtos.google.api.CustomHttpPattern
import typings.googleGax.mod.fallback.LocationProtos.google.api.Http
import typings.googleGax.mod.fallback.LocationProtos.google.api.HttpRule
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TypeofapiHttp extends StObject {
  
  /** Represents a CustomHttpPattern. */
  var CustomHttpPattern: Instantiable0[typings.googleGax.mod.fallback.LocationProtos.google.api.CustomHttpPattern] & TypeofCustomHttpPatternCreate
  
  /** Represents a Http. */
  var Http: Instantiable0[typings.googleGax.mod.fallback.LocationProtos.google.api.Http] & TypeofHttpCreate
  
  /** Represents a HttpRule. */
  var HttpRule: Instantiable0[typings.googleGax.mod.fallback.LocationProtos.google.api.HttpRule] & TypeofHttpRuleCreate
}
object TypeofapiHttp {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofapiHttp]
  }
  
  extension [Self <: TypeofapiHttp](x: Self) {
