...
import typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.IListTopicSubscriptionsResponse
import typings.googleCloudPubsub.pubsubMod.google.pubsub.v1.ITopic
...
import typings.googleCloudPubsub.srcPubsubMod.PagedResponse
...
object topicMod extends js.Object {
  ...
  type GetTopicOptions = CallOptions with AnonAutoCreate
  ...
  type MessageOptions = PubsubMessage with AnonJson
