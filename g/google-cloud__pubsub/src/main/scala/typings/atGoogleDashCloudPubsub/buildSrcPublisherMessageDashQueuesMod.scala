...
import typings.atGoogleDashCloudPubsub.buildSrcPublisherMessageDashBatchMod.MessageBatch
...
import typings.atGoogleDashCloudPubsub.buildSrcPublisherPublishDashErrorMod.PublishError
...
@JSImport("@google-cloud/pubsub/build/src/publisher/message-queues", JSImport.Namespace)
@js.native
object buildSrcPublisherMessageDashQueuesMod extends js.Object {
  @js.native
  ...
  class OrderedQueue protected () extends MessageQueue {
    ...
    /**
      ...
      */
    val currentBatch: MessageBatch = js.native
