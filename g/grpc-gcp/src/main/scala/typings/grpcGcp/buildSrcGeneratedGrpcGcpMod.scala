...
import typings.grpcGcp.buildSrcGeneratedGrpcGcpMod.grpc.gcp.AffinityConfig.Command
...
object buildSrcGeneratedGrpcGcpMod {
      ...
      object AffinityConfig {
        ...
        object Command extends StObject {
          ...
          sealed trait BIND
            extends StObject
               with Command
          /* 1 */ val BIND: typings.grpcGcp.buildSrcGeneratedGrpcGcpMod.grpc.gcp.AffinityConfig.Command.BIND & Double = js.native
          
          @js.native
          sealed trait BOUND
            extends StObject
               with Command
          /* 0 */ val BOUND: typings.grpcGcp.buildSrcGeneratedGrpcGcpMod.grpc.gcp.AffinityConfig.Command.BOUND & Double = js.native
          
          @js.native
          sealed trait UNBIND
            extends StObject
               with Command
          /* 2 */ val UNBIND: typings.grpcGcp.buildSrcGeneratedGrpcGcpMod.grpc.gcp.AffinityConfig.Command.UNBIND & Double = js.native
        }
