...
trait RolesResource extends js.Object {
  ...
  def list(request: gapiDotClientDotIamLib.Anon_ParentAccesstoken): gapiDotClientLib.gapiNs.clientNs.Request[ListRolesResponse] = js.native
  /** Lists the Roles defined on a resource. */
  def list(request: gapiDotClientDotIamLib.Anon_ParentAccesstokenPageSize): gapiDotClientLib.gapiNs.clientNs.Request[ListRolesResponse] = js.native
