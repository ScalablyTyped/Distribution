...
trait UsersResource extends js.Object {
  ...
  def delete(request: gapiDotClientDotClouduseraccountsLib.Anon_ProjectPrettyPrintQuotaUserKeyUserIp): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Returns the specified User resource. */
  def get(request: gapiDotClientDotClouduseraccountsLib.Anon_ProjectPrettyPrintQuotaUserKeyUserIp): gapiDotClientLib.gapiNs.clientNs.Request[User]
  ...
  def list(request: gapiDotClientDotClouduseraccountsLib.Anon_ProjectMaxResults): gapiDotClientLib.gapiNs.clientNs.Request[UserList]
  /** Removes the specified public key from the user. */
  def removePublicKey(request: gapiDotClientDotClouduseraccountsLib.Anon_Fingerprint): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
