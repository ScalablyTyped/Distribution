...
object Instance {
  @scala.inline
  def apply(instance: String, project: String, user: String, zone: String): Instance = {
    val __obj = js.Dynamic.literal(instance = instance.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], user = user.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
