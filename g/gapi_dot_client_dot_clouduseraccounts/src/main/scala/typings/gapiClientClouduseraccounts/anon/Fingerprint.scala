...
object Fingerprint {
  @scala.inline
  def apply(fingerprint: String, project: String, user: String): Fingerprint = {
    val __obj = js.Dynamic.literal(fingerprint = fingerprint.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], user = user.asInstanceOf[js.Any])
