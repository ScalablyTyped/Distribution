...
trait Anon_ArrayBuffer extends js.Object {
  var MaxBufferError: org.scalablytyped.runtime.Instantiable0[getDashStreamLib.getDashStreamMod.MaxBufferErrorClass] = js.native
  ...
  /**
  	...
  	*/
  // TODO: Remove this for the next major release
  def default(stream: nodeLib.streamMod.Stream): js.Promise[java.lang.String] = js.native
  def default(
    stream: nodeLib.streamMod.Stream,
    options: getDashStreamLib.getDashStreamMod.getStreamNs.OptionsWithEncoding[nodeLib.BufferEncoding]
  ): js.Promise[java.lang.String] = js.native
