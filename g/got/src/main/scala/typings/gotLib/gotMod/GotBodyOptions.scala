...
trait GotBodyOptions[E /* <: java.lang.String | scala.Null */] extends GotOptions[E] {
  ...
  var hooks: js.UndefOr[
    Hooks[GotBodyOptions[E], java.lang.String | nodeLib.Buffer | nodeLib.streamMod.Readable]
  ] = js.undefined
}
...
object GotBodyOptions {
  ...
  def apply[E /* <: java.lang.String | scala.Null */](
    ...
    hooks: Hooks[GotBodyOptions[E], java.lang.String | nodeLib.Buffer | nodeLib.streamMod.Readable] = null,
