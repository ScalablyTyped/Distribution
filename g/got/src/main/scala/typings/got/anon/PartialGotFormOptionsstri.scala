...
object PartialGotFormOptionsstri {
  ...
  @scala.inline
  implicit class PartialGotFormOptionsstriOps[Self <: PartialGotFormOptionsstri] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setHooks(value: Hooks[GotFormOptions[String], Record[String, _]]): Self = this.set("hooks", value.asInstanceOf[js.Any])
    @scala.inline
