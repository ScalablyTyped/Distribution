...
import typings.gapiClientGamesconfiguration.AnonAltFields
...
trait ImageConfigurationsResource extends js.Object {
  ...
  def upload(request: AnonAltFields): Request_[ImageConfiguration]
}

object ImageConfigurationsResource {
  @scala.inline
  def apply(upload: AnonAltFields => Request_[ImageConfiguration]): ImageConfigurationsResource = {
