package typings
package atGoogleDashCloudPaginatorLib.paginatorMod
...
class Paginator () extends js.Object {
  /**
       ...
       */
  def extend(Class: js.Function, methodNames: java.lang.String): scala.Unit = js.native
  /**
       * Cache the original method, then overwrite it on the Class's prototype.
       *
       * @param {function} Class - The parent class of the methods to extend.
       * @param {string|string[]} methodNames - Name(s) of the methods to extend.
       */
  def extend(Class: js.Function, methodNames: js.Array[java.lang.String]): scala.Unit = js.native
  /**
