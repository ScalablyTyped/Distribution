...
object IServerOptions {
  ...
  def apply(
    ...
    if (account_keys_path != null) __obj.updateDynamic("account_keys_path")(account_keys_path)
    if (accounts != null) __obj.updateDynamic("accounts")(accounts)
    if (!js.isUndefined(allowUnlimitedContractSize)) __obj.updateDynamic("allowUnlimitedContractSize")(allowUnlimitedContractSize)
    ...
    if (hd_path != null) __obj.updateDynamic("hd_path")(hd_path)
    ...
    if (unlocked_accounts != null) __obj.updateDynamic("unlocked_accounts")(unlocked_accounts)
