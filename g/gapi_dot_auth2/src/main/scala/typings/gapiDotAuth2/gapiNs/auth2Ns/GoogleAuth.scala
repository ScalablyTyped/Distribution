...
import typings.gapiDotAuth2.Anon_Code
import typings.gapiDotAuth2.Anon_Details
...
class GoogleAuth () extends js.Object {
  ...
  /**
    ...
    */
  def grantOfflineAccess(): js.Promise[Anon_Code] = js.native
  def grantOfflineAccess(options: OfflineAccessOptions): js.Promise[Anon_Code] = js.native
  /**
  ...
  def `then`(
    ...
    onFailure: js.Function1[/* reason */ Anon_Details, _]
  ): js.Any = js.native
}
