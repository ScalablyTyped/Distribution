...
trait Anon_AltFieldsIncludeAttributesKey extends js.Object {
...
object Anon_AltFieldsIncludeAttributesKey {
  @scala.inline
  def apply(
    merchantId: String,
    productId: String,
    ...
    __obj.asInstanceOf[Anon_AltFieldsIncludeAttributesKey]
  }
}
