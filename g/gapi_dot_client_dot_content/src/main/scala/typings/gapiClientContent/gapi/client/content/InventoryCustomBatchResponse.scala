...
object InventoryCustomBatchResponse {
  ...
  implicit class InventoryCustomBatchResponseOps[Self <: InventoryCustomBatchResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntriesVarargs(value: InventoryCustomBatchResponseEntry*): Self = this.set("entries", js.Array(value :_*))
    @scala.inline
    def setEntries(value: js.Array[InventoryCustomBatchResponseEntry]): Self = this.set("entries", value.asInstanceOf[js.Any])
    @scala.inline
