...
object ProductstatusesCustomBatchResponse {
  ...
  implicit class ProductstatusesCustomBatchResponseOps[Self <: ProductstatusesCustomBatchResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntriesVarargs(value: ProductstatusesCustomBatchResponseEntry*): Self = this.set("entries", js.Array(value :_*))
    @scala.inline
    def setEntries(value: js.Array[ProductstatusesCustomBatchResponseEntry]): Self = this.set("entries", value.asInstanceOf[js.Any])
    @scala.inline
