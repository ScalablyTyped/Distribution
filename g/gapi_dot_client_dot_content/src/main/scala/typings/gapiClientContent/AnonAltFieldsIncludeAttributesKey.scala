...
trait AnonAltFieldsIncludeAttributesKey extends js.Object {
...
object AnonAltFieldsIncludeAttributesKey {
  @scala.inline
  def apply(
    merchantId: String,
    productId: String,
    ...
    userIp: String = null
  ): AnonAltFieldsIncludeAttributesKey = {
    ...
    __obj.asInstanceOf[AnonAltFieldsIncludeAttributesKey]
  }
}
