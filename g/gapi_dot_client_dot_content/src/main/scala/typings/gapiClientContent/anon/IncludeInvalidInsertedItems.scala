...
@js.native
trait IncludeInvalidInsertedItems extends js.Object {
...
object IncludeInvalidInsertedItems {
  @scala.inline
  def apply(merchantId: String): IncludeInvalidInsertedItems = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any])
    __obj.asInstanceOf[IncludeInvalidInsertedItems]
  }
  @scala.inline
  implicit class IncludeInvalidInsertedItemsOps[Self <: IncludeInvalidInsertedItems] (val x: Self) extends AnyVal {
    @scala.inline
