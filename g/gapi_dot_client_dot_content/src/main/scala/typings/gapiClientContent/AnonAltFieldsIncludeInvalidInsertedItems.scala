...
trait AnonAltFieldsIncludeInvalidInsertedItems extends js.Object {
...
object AnonAltFieldsIncludeInvalidInsertedItems {
  @scala.inline
  def apply(
    merchantId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsIncludeInvalidInsertedItems = {
    ...
    __obj.asInstanceOf[AnonAltFieldsIncludeInvalidInsertedItems]
  }
}
