...
trait AnonAltFieldsIncludeAttributesIncludeInvalidInsertedItems extends js.Object {
...
object AnonAltFieldsIncludeAttributesIncludeInvalidInsertedItems {
  @scala.inline
  def apply(
    merchantId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsIncludeAttributesIncludeInvalidInsertedItems = {
    ...
    __obj.asInstanceOf[AnonAltFieldsIncludeAttributesIncludeInvalidInsertedItems]
  }
}
