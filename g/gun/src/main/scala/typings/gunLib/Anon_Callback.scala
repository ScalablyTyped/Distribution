...
trait Anon_Callback extends js.Object {
  ...
  var `throw`: js.UndefOr[scala.Boolean] = js.native
  /**
    ...
    */
  def decrypt(message: js.Any, pair: gunLib.gunMod.GunNs.CryptoKeyPair): js.Promise[_] = js.native
  def decrypt(message: js.Any, pair: java.lang.String): js.Promise[_] = js.native
  /**
    ...
    */
  def encrypt(data: js.Any, pair: gunLib.gunMod.GunNs.CryptoKeyPair): js.Promise[java.lang.String] = js.native
  def encrypt(data: js.Any, pair: java.lang.String): js.Promise[java.lang.String] = js.native
  /**
    ...
    */
  def pair(cb: js.Function1[/* data */ gunLib.gunMod.GunNs.CryptoKeyPair, scala.Unit]): js.Promise[js.UndefOr[gunLib.gunMod.GunNs.CryptoKeyPair]] = js.native
  def pair(cb: js.Function1[/* data */ gunLib.gunMod.GunNs.CryptoKeyPair, scala.Unit], opt: js.Object): js.Promise[js.UndefOr[gunLib.gunMod.GunNs.CryptoKeyPair]] = js.native
  /**
    ...
    */
  def sign(data: js.Any, pair: gunLib.gunMod.GunNs.CryptoKeyPair): js.Promise[js.UndefOr[java.lang.String]] = js.native
  /**
    ...
    */
  def verify(message: js.Any, pair: gunLib.gunMod.GunNs.CryptoKeyPair): js.Promise[_] = js.native
  def verify(message: js.Any, pair: java.lang.String): js.Promise[_] = js.native
  /**
    ...
    */
  def work(data: js.Any): js.Promise[js.UndefOr[java.lang.String]] = js.native
  def work(data: js.Any, pair: js.Any): js.Promise[js.UndefOr[java.lang.String]] = js.native
  def work(
    data: js.Any,
    pair: js.Any,
  ...
  def work(
    ...
    pair: js.Any,
    callback: js.Function1[/* data */ js.UndefOr[java.lang.String], scala.Unit],
    opt: stdLib.Partial[Anon_Base16]
  ): js.Promise[js.UndefOr[java.lang.String]] = js.native
}
