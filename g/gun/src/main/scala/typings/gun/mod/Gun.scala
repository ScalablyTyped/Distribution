...
import typings.gun.Anon0
import typings.gun.Anon0Ok
import typings.gun.Anon2
import typings.gun.AnonAnything
import typings.gun.AnonCallback
import typings.gun.AnonChange
import typings.gun.AnonData
import typings.gun.AnonErr
import typings.gun.AnonErrOk
import typings.gun.AnonErrString
import typings.gun.AnonFalse
import typings.gun.AnonFile
import typings.gun.AnonSessionStorage
import typings.gun.AnonWait
...
object Gun extends js.Object {
  ...
  trait ChainReference[DataType, ReferenceKey, IsTop /* <: pre_root | root | `false` */] extends js.Object {
    /**
      ...
      */
    var bye: js.UndefOr[js.Function0[AnonData[DataType]]] = js.native
    /**
    ...
    var promise: js.UndefOr[
        js.Function1[
          /* onfulfilled */ js.UndefOr[
            js.Function1[
              /* value */ AnonFalse[DataType, ReferenceKey], 
              (AnonFalse[DataType, ReferenceKey]) | (js.Thenable[AnonFalse[DataType, ReferenceKey]])
            ]
          ], 
          js.Promise[AnonFalse[DataType, ReferenceKey]]
        ]
      ] = js.native
    /**
      * Returns a promise for you to use.
    ...
    def auth(alias: String, pass: String, cb: js.Function1[/* ack */ Anon2 | AnonErrString, Unit]): ChainReference[_, _, `false`] = js.native
    def auth(
      alias: String,
      pass: String,
      cb: js.Function1[/* ack */ Anon2 | AnonErrString, Unit],
      opt: js.Object
    ...
    def create(alias: String, pass: String, cb: js.Function1[/* ack */ Anon0 | AnonErrString, Unit]): ChainReference[_, _, `false`] = js.native
    def create(
      alias: String,
      pass: String,
      cb: js.Function1[/* ack */ Anon0 | AnonErrString, Unit],
      opt: js.Object
    ): ChainReference[_, _, `false`] = js.native
    /**
    ...
    def delete(alias: String, pass: String, cb: js.Function1[/* ack */ Anon0Ok, Unit]): js.Promise[Unit] = js.native
    /**
  ...
  trait Constructor
    ...
    var SEA: AnonCallback = js.native
    var node: AnonAnything = js.native
    /**
      * @description
  ...
  type AckCallback = js.Function1[/* ack */ AnonErr | AnonErrOk, Unit]
  ...
  /**
    ...
    */
  type ConstructorOptions = Partial[AnonFile]
