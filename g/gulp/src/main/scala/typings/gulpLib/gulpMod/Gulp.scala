...
@js.native
trait Gulp
  extends undertakerLib.undertakerMod.^ {
  /**
  ...
  def watch(globs: Globs, fn: undertakerLib.undertakerMod.TaskFunction): nodeLib.fsMod.FSWatcher = js.native
  def watch(globs: Globs, opts: WatchOptions): nodeLib.fsMod.FSWatcher = js.native
  def watch(globs: Globs, opts: WatchOptions, fn: undertakerLib.undertakerMod.TaskFunction): nodeLib.fsMod.FSWatcher = js.native
}
