...
trait Gulp extends ^ {
  ...
  /**
    ...
    */
  @JSName("symlink")
  var symlink_Original: Fn_File = js.native
  /**
  ...
  def watch(globs: Globs, fn: typings.undertaker.undertakerMod.TaskFunction): FSWatcher = js.native
  def watch(globs: Globs, opts: WatchOptions): FSWatcher = js.native
  def watch(globs: Globs, opts: WatchOptions, fn: typings.undertaker.undertakerMod.TaskFunction): FSWatcher = js.native
}
