...
import typings.gapiDotClientDotSqladmin.Anon_SchemaOnly
import typings.gapiDotClientDotSqladmin.Anon_SelectQuery
...
trait ExportContext extends js.Object {
  ...
  var csvExportOptions: js.UndefOr[Anon_SelectQuery] = js.undefined
  /**
  ...
  var sqlExportOptions: js.UndefOr[Anon_SchemaOnly] = js.undefined
  /**
...
object ExportContext {
  @scala.inline
  def apply(
    csvExportOptions: Anon_SelectQuery = null,
    databases: js.Array[String] = null,
    fileType: String = null,
    kind: String = null,
    sqlExportOptions: Anon_SchemaOnly = null,
    uri: String = null
  ): ExportContext = {
