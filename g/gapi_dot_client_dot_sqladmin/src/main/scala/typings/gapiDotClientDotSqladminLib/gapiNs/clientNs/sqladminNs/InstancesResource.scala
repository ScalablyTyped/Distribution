...
trait InstancesResource extends js.Object {
  ...
  def delete(request: gapiDotClientDotSqladminLib.Anon_Project): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Exports data from a Cloud SQL instance to a Google Cloud Storage bucket as a MySQL dump file. */
  def export(request: gapiDotClientDotSqladminLib.Anon_Project): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Failover the instance to its failover replica instance. */
  def failover(request: gapiDotClientDotSqladminLib.Anon_Project): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Retrieves a resource containing information about a Cloud SQL instance. */
  def get(request: gapiDotClientDotSqladminLib.Anon_Project): gapiDotClientLib.gapiNs.clientNs.Request[DatabaseInstance]
  /** Imports data into a Cloud SQL instance from a MySQL dump file in Google Cloud Storage. */
  def `import`(request: gapiDotClientDotSqladminLib.Anon_Project): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Creates a new Cloud SQL instance. */
  def insert(request: gapiDotClientDotSqladminLib.Anon_ProjectPrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  ...
  def restoreBackup(request: gapiDotClientDotSqladminLib.Anon_Project): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Starts the replication in the read replica instance. */
  def startReplica(request: gapiDotClientDotSqladminLib.Anon_Project): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /** Stops the replication in the read replica instance. */
  def stopReplica(request: gapiDotClientDotSqladminLib.Anon_Project): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
