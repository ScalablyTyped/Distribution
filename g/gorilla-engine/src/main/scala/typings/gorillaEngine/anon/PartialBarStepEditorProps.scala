...
/* Inlined std.Partial<gorilla-engine.GorillaEngine.UI.BarStepEditorProps> */
trait PartialBarStepEditorProps extends StObject {
  ...
  var divSize: js.UndefOr[Double] = js.undefined
  ...
  var paramPath: js.UndefOr[String] = js.undefined
  
  var startIndex: js.UndefOr[Double] = js.undefined
  
  var step: js.UndefOr[Partialxnumberynumberwidt] = js.undefined
...
object PartialBarStepEditorProps {
  
  inline def apply(): PartialBarStepEditorProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBarStepEditorProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialBarStepEditorProps] (val x: Self) extends AnyVal {
    ...
    inline def setDivSizeUndefined: Self = StObject.set(x, "divSize", js.undefined)
    ...
    inline def setParamPathUndefined: Self = StObject.set(x, "paramPath", js.undefined)
