...
/* Inlined std.Partial<gorilla-engine.GorillaEngine.UI.KnobProps> */
trait PartialKnobProps extends StObject {
  ...
  var filmstrip: js.UndefOr[Direction] = js.undefined
...
object PartialKnobProps {
  
  inline def apply(): PartialKnobProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialKnobProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialKnobProps] (val x: Self) extends AnyVal {
