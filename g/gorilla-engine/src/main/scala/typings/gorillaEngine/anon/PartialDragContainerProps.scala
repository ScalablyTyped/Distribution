...
/* Inlined std.Partial<gorilla-engine.GorillaEngine.UI.DragContainerProps> */
trait PartialDragContainerProps extends StObject {
  ...
  var destinationCanMoveDraggedFiles: js.UndefOr[Boolean] = js.undefined
  
  var doubleClickAction: js.UndefOr[String] = js.undefined
  
  var dragContent: js.UndefOr[String] = js.undefined
  
  var dragGroup: js.UndefOr[String] = js.undefined
  
  var enabled: js.UndefOr[Boolean] = js.undefined
  
  var externalDragEndAction: js.UndefOr[String] = js.undefined
  
  var externalDragStartAction: js.UndefOr[String] = js.undefined
  
  var externallyDraggedFiles: js.UndefOr[Any] = js.undefined
  ...
  var onDragging: js.UndefOr[String] = js.undefined
  
  var onExternalDragEnd: js.UndefOr[String] = js.undefined
  
  var onExternalDragStart: js.UndefOr[String] = js.undefined
...
object PartialDragContainerProps {
  
  inline def apply(): PartialDragContainerProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDragContainerProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialDragContainerProps] (val x: Self) extends AnyVal {
    ...
    inline def setDestinationCanMoveDraggedFilesUndefined: Self = StObject.set(x, "destinationCanMoveDraggedFiles", js.undefined)
    ...
    inline def setDragContentUndefined: Self = StObject.set(x, "dragContent", js.undefined)
    ...
    inline def setExternalDragEndActionUndefined: Self = StObject.set(x, "externalDragEndAction", js.undefined)
    
    inline def setExternalDragStartAction(value: String): Self = StObject.set(x, "externalDragStartAction", value.asInstanceOf[js.Any])
    
    inline def setExternalDragStartActionUndefined: Self = StObject.set(x, "externalDragStartAction", js.undefined)
    
    inline def setExternallyDraggedFiles(value: Any): Self = StObject.set(x, "externallyDraggedFiles", value.asInstanceOf[js.Any])
    
    inline def setExternallyDraggedFilesUndefined: Self = StObject.set(x, "externallyDraggedFiles", js.undefined)
    ...
    inline def setOnExternalDragEndUndefined: Self = StObject.set(x, "onExternalDragEnd", js.undefined)
    
    inline def setOnExternalDragStart(value: String): Self = StObject.set(x, "onExternalDragStart", value.asInstanceOf[js.Any])
    
    inline def setOnExternalDragStartUndefined: Self = StObject.set(x, "onExternalDragStart", js.undefined)
