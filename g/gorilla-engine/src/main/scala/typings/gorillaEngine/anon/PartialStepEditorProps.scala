...
/* Inlined std.Partial<gorilla-engine.GorillaEngine.UI.StepEditorProps> */
trait PartialStepEditorProps extends StObject {
  ...
  var step: js.UndefOr[PartialxnumberynumberwidtBackgroundColor] = js.undefined
...
object PartialStepEditorProps {
  
  inline def apply(): PartialStepEditorProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStepEditorProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialStepEditorProps] (val x: Self) extends AnyVal {
