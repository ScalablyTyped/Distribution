...
/* Inlined std.Partial<gorilla-engine.GorillaEngine.UI.DropZoneProps> */
trait PartialDropZoneProps extends StObject {
  
  var acceptedFileTypes: js.UndefOr[js.Array[String] | String] = js.undefined
  ...
  var onDraggedFiles: js.UndefOr[String] = js.undefined
  
  var onDroppedFile: js.UndefOr[String] = js.undefined
...
object PartialDropZoneProps {
  
  inline def apply(): PartialDropZoneProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDropZoneProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialDropZoneProps] (val x: Self) extends AnyVal {
    ...
    inline def setOnDraggedFilesUndefined: Self = StObject.set(x, "onDraggedFiles", js.undefined)
    
    inline def setOnDroppedFile(value: String): Self = StObject.set(x, "onDroppedFile", value.asInstanceOf[js.Any])
    
    inline def setOnDroppedFileUndefined: Self = StObject.set(x, "onDroppedFile", js.undefined)
