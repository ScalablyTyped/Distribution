...
/* Inlined std.Partial<gorilla-engine.GorillaEngine.UI.LabelProps> */
trait PartialLabelProps extends StObject {
...
object PartialLabelProps {
  
  inline def apply(): PartialLabelProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialLabelProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialLabelProps] (val x: Self) extends AnyVal {
