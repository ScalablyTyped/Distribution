...
- typings.gorillaEngine.GorillaEngine.UI.BarStepEditorProps because var conflicts: id. Inlined value, divSize, min, max, paramPath, startIndex, endIndex, step */ trait BarStepEditor
  extends StObject
     with Component
     with Bounds
     with Background
...
object BarStepEditor {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[BarStepEditor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BarStepEditor] (val x: Self) extends AnyVal {
