...
object StepEditorProps {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[StepEditorProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StepEditorProps] (val x: Self) extends AnyVal {
