...
import typings.googleCloudCommon.buildSrcServiceObjectMod.Interceptor
...
import typings.googleCloudCommon.buildSrcUtilMod.Duplexify
import typings.googleCloudCommon.buildSrcUtilMod.MakeAuthenticatedRequest
import typings.googleCloudCommon.buildSrcUtilMod.MakeAuthenticatedRequestOptions
