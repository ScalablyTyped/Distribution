...
class Util () extends js.Object {
  var ApiError: ScalablyTyped.runtime.Instantiable1[/* errorMessage */ java.lang.String, ApiError] = js.native
  var PartialFailureError: ScalablyTyped.runtime.Instantiable1[/* b */ GoogleErrorBody, PartialFailureError] = js.native
  /**
