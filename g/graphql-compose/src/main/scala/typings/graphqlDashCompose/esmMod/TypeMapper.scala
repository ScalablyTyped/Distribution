...
class TypeMapper[TContext] protected ()
  extends typings.graphqlDashCompose.esmTypeMapperMod.TypeMapper[TContext] {
  def this(schemaComposer: typings.graphqlDashCompose.esmSchemaComposerMod.SchemaComposer[TContext]) = this()
}
