...
import typings.graphqlDashCompose.esmEnumTypeComposerMod._EnumTypeComposeDefinition
...
@JSImport("graphql-compose/esm/graphql", JSImport.Namespace)
@js.native
object esmGraphqlMod extends js.Object {
  @js.native
