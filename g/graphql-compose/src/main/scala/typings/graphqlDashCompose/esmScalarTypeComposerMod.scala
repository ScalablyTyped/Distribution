...
import typings.graphqlDashCompose.esmScalarTypeComposerMod.ComposeScalarTypeConfig
import typings.graphqlDashCompose.esmScalarTypeComposerMod.GraphQLScalarTypeExtended
...
@JSImport("graphql-compose/esm/ScalarTypeComposer", JSImport.Namespace)
@js.native
object esmScalarTypeComposerMod extends js.Object {
  @js.native
