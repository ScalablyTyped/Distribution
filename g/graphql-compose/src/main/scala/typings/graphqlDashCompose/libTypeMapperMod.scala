...
import typings.graphqlDashCompose.libInputTypeComposerMod.ComposeInputFieldConfig
...
import typings.graphqlDashCompose.libObjectTypeComposerMod.ComposeFieldConfig
