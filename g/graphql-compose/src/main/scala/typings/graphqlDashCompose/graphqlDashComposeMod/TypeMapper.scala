...
class TypeMapper[TContext] protected ()
  extends typings.graphqlDashCompose.libTypeMapperMod.TypeMapper[TContext] {
  def this(schemaComposer: typings.graphqlDashCompose.libSchemaComposerMod.SchemaComposer[TContext]) = this()
}
