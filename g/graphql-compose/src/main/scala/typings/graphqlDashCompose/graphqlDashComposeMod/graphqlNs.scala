...
object graphqlNs extends js.Object {
  ...
  class GraphQLDirective protected ()
    extends typings.graphqlDashCompose.libGraphqlMod.GraphQLDirective {
    def this(config: GraphQLDirectiveConfig) = this()
  }
  
  @js.native
  class GraphQLEnumType protected ()
    extends typings.graphqlDashCompose.libGraphqlMod.GraphQLEnumType {
    def this(config: GraphQLEnumTypeConfig) = this()
  }
  
  @js.native
  class GraphQLError protected ()
    extends typings.graphqlDashCompose.libGraphqlMod.GraphQLError {
    def this(
      message: String,
  ...
  class TypeInfo protected ()
    extends typings.graphqlDashCompose.libGraphqlMod.TypeInfo {
  ...
  class ValidationContext protected ()
    extends typings.graphqlDashCompose.libGraphqlMod.ValidationContext {
    def this(
      schema: typings.graphql.typeSchemaMod.GraphQLSchema,
      ast: DocumentNode,
