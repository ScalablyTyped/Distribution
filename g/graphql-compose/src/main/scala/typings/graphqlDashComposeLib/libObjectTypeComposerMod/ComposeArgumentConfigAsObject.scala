...
trait ComposeArgumentConfigAsObject extends js.Object {
  ...
  var `type`: graphqlDashComposeLib.libUtilsDefinitionsMod.Thunk[ComposeArgumentType] | graphqlLib.typeDefinitionMod.GraphQLInputType
}

object ComposeArgumentConfigAsObject {
  @scala.inline
  def apply(
    `type`: graphqlDashComposeLib.libUtilsDefinitionsMod.Thunk[ComposeArgumentType] | graphqlLib.typeDefinitionMod.GraphQLInputType,
