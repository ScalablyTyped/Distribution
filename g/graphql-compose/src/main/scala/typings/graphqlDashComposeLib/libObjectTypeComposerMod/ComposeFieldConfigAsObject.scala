...
trait ComposeFieldConfigAsObject[TSource, TContext, TArgs]
  ...
  var `type`: (graphqlDashComposeLib.libUtilsDefinitionsMod.Thunk[ComposeOutputType[_, TContext]]) | graphqlLib.typeDefinitionMod.GraphQLOutputType
}

object ComposeFieldConfigAsObject {
  @scala.inline
  def apply[TSource, TContext, TArgs](
    `type`: (graphqlDashComposeLib.libUtilsDefinitionsMod.Thunk[ComposeOutputType[_, TContext]]) | graphqlLib.typeDefinitionMod.GraphQLOutputType,
