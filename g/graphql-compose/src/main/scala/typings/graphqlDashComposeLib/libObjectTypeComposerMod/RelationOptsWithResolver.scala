...
trait RelationOptsWithResolver[TRelationSource, TSource, TContext, TArgs] extends js.Object {
  ...
  var projection: js.UndefOr[stdLib.Partial[graphqlDashComposeLib.libUtilsProjectionMod.ProjectionType]] = js.undefined
  var resolver: graphqlDashComposeLib.libUtilsDefinitionsMod.Thunk[
    graphqlDashComposeLib.libResolverMod.Resolver[TRelationSource, TContext, TArgs, _]
  ]
}
...
object RelationOptsWithResolver {
  ...
  def apply[TRelationSource, TSource, TContext, TArgs](
    resolver: graphqlDashComposeLib.libUtilsDefinitionsMod.Thunk[
      graphqlDashComposeLib.libResolverMod.Resolver[TRelationSource, TContext, TArgs, _]
    ],
    ...
    projection: stdLib.Partial[graphqlDashComposeLib.libUtilsProjectionMod.ProjectionType] = null
