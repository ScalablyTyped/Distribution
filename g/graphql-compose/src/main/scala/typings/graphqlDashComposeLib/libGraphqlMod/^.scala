...
object ^ extends js.Object {
  ...
  def visit(
    ...
    visitor: graphqlLib.languageVisitorMod.Visitor[
      ...
      graphqlLib.languageAstMod.NameNode | graphqlLib.languageAstMod.DocumentNode | graphqlLib.languageAstMod.OperationDefinitionNode | graphqlLib.languageAstMod.VariableDefinitionNode | graphqlLib.languageAstMod.VariableNode | graphqlLib.languageAstMod.SelectionSetNode | graphqlLib.languageAstMod.FieldNode | graphqlLib.languageAstMod.ArgumentNode | graphqlLib.languageAstMod.FragmentSpreadNode | graphqlLib.languageAstMod.InlineFragmentNode | graphqlLib.languageAstMod.FragmentDefinitionNode | graphqlLib.languageAstMod.IntValueNode | graphqlLib.languageAstMod.FloatValueNode | graphqlLib.languageAstMod.StringValueNode | graphqlLib.languageAstMod.BooleanValueNode | graphqlLib.languageAstMod.NullValueNode | graphqlLib.languageAstMod.EnumValueNode | graphqlLib.languageAstMod.ListValueNode | graphqlLib.languageAstMod.ObjectValueNode | graphqlLib.languageAstMod.ObjectFieldNode | graphqlLib.languageAstMod.DirectiveNode | graphqlLib.languageAstMod.NamedTypeNode | graphqlLib.languageAstMod.ListTypeNode | graphqlLib.languageAstMod.NonNullTypeNode | graphqlLib.languageAstMod.SchemaDefinitionNode | graphqlLib.languageAstMod.OperationTypeDefinitionNode | graphqlLib.languageAstMod.ScalarTypeDefinitionNode | graphqlLib.languageAstMod.ObjectTypeDefinitionNode | graphqlLib.languageAstMod.FieldDefinitionNode | graphqlLib.languageAstMod.InputValueDefinitionNode | graphqlLib.languageAstMod.InterfaceTypeDefinitionNode | graphqlLib.languageAstMod.UnionTypeDefinitionNode | graphqlLib.languageAstMod.EnumTypeDefinitionNode | graphqlLib.languageAstMod.EnumValueDefinitionNode | graphqlLib.languageAstMod.InputObjectTypeDefinitionNode | graphqlLib.languageAstMod.DirectiveDefinitionNode | graphqlLib.languageAstMod.SchemaExtensionNode | graphqlLib.languageAstMod.ScalarTypeExtensionNode | graphqlLib.languageAstMod.ObjectTypeExtensionNode | graphqlLib.languageAstMod.InterfaceTypeExtensionNode | graphqlLib.languageAstMod.UnionTypeExtensionNode | graphqlLib.languageAstMod.EnumTypeExtensionNode | graphqlLib.languageAstMod.InputObjectTypeExtensionNode
    ]
  ): js.Any = js.native
  def visit(
    root: graphqlLib.languageAstMod.ASTNode,
