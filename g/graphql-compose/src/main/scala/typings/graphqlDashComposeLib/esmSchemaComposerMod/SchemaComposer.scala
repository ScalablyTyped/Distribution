...
class SchemaComposer[TContext] ()
  ...
  /**
    ...
    */
  val Mutation: graphqlDashComposeLib.esmObjectTypeComposerMod.ObjectTypeComposer[_, TContext] = js.native
  /**
    ...
    */
  val Query: graphqlDashComposeLib.esmObjectTypeComposerMod.ObjectTypeComposer[_, TContext] = js.native
  /**
    ...
    */
  val Subscription: graphqlDashComposeLib.esmObjectTypeComposerMod.ObjectTypeComposer[_, TContext] = js.native
  ...
  def getAnyTC(typeName: AnyType[_] | graphqlLib.typeDefinitionMod.GraphQLType): (graphqlDashComposeLib.esmObjectTypeComposerMod.ObjectTypeComposer[_, TContext]) | graphqlDashComposeLib.esmInputTypeComposerMod.InputTypeComposer[TContext] | graphqlDashComposeLib.esmEnumTypeComposerMod.EnumTypeComposer[TContext] | (graphqlDashComposeLib.esmInterfaceTypeComposerMod.InterfaceTypeComposer[_, TContext]) | (graphqlDashComposeLib.esmUnionTypeComposerMod.UnionTypeComposer[_, TContext]) | graphqlDashComposeLib.esmScalarTypeComposerMod.ScalarTypeComposer[TContext] = js.native
  def getAnyTC(typeName: java.lang.String): (graphqlDashComposeLib.esmObjectTypeComposerMod.ObjectTypeComposer[_, TContext]) | graphqlDashComposeLib.esmInputTypeComposerMod.InputTypeComposer[TContext] | graphqlDashComposeLib.esmEnumTypeComposerMod.EnumTypeComposer[TContext] | (graphqlDashComposeLib.esmInterfaceTypeComposerMod.InterfaceTypeComposer[_, TContext]) | (graphqlDashComposeLib.esmUnionTypeComposerMod.UnionTypeComposer[_, TContext]) | graphqlDashComposeLib.esmScalarTypeComposerMod.ScalarTypeComposer[TContext] = js.native
