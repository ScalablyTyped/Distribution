...
class UnionTypeComposer[TSource, TContext] protected ()
  ...
  def addType(`type`: graphqlDashComposeLib.esmTypeMapperMod.ComposeObjectType): this.type = js.native
  def addTypeResolver(
  ...
  def getTypes(): js.Array[graphqlDashComposeLib.esmTypeMapperMod.ComposeObjectType] = js.native
  ...
  def setTypes(types: js.Array[graphqlDashComposeLib.esmTypeMapperMod.ComposeObjectType]): this.type = js.native
}
