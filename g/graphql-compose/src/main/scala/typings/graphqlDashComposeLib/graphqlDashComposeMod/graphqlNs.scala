...
object graphqlNs extends js.Object {
  ...
  class GraphQLInputObjectType protected ()
    extends graphqlDashComposeLib.libGraphqlMod.GraphQLInputObjectType {
    def this(config: graphqlLib.typeDefinitionMod.GraphQLInputObjectTypeConfig) = this()
  }
  
  @js.native
  class GraphQLInterfaceType protected ()
    extends graphqlDashComposeLib.libGraphqlMod.GraphQLInterfaceType {
  ...
  class GraphQLListCls protected ()
    extends graphqlDashComposeLib.libGraphqlMod.GraphQLListCls {
    def this(`type`: graphqlLib.typeDefinitionMod.GraphQLType) = this()
  }
  
  @js.native
  class GraphQLNonNullCls protected ()
    extends graphqlDashComposeLib.libGraphqlMod.GraphQLNonNullCls {
  ...
  class GraphQLObjectType[TSource, TContext, TArgs] protected ()
    extends graphqlDashComposeLib.libGraphqlMod.GraphQLObjectType[TSource, TContext, TArgs] {
  ...
  class TypeInfo protected ()
    extends graphqlDashComposeLib.libGraphqlMod.TypeInfo {
  ...
  class ValidationContext protected ()
    extends graphqlDashComposeLib.libGraphqlMod.ValidationContext {
