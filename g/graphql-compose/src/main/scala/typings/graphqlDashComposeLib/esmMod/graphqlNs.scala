...
object graphqlNs extends js.Object {
  ...
  class GraphQLDirective protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.GraphQLDirective {
    def this(config: graphqlLib.typeDirectivesMod.GraphQLDirectiveConfig) = this()
  }
  
  @js.native
  class GraphQLEnumType protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.GraphQLEnumType {
    def this(config: graphqlLib.typeDefinitionMod.GraphQLEnumTypeConfig) = this()
  }
  ...
  class GraphQLInputObjectType protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.GraphQLInputObjectType {
    def this(config: graphqlLib.typeDefinitionMod.GraphQLInputObjectTypeConfig) = this()
  }
  
  @js.native
  class GraphQLInterfaceType protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.GraphQLInterfaceType {
  ...
  class GraphQLListCls protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.GraphQLListCls {
    def this(`type`: graphqlLib.typeDefinitionMod.GraphQLType) = this()
  }
  
  @js.native
  class GraphQLNonNullCls protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.GraphQLNonNullCls {
    def this(`type`: graphqlLib.typeDefinitionMod.GraphQLNullableType) = this()
  }
  
  @js.native
  class GraphQLObjectType[TSource, TContext, TArgs] protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.GraphQLObjectType[TSource, TContext, TArgs] {
  ...
  class GraphQLScalarType protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.GraphQLScalarType {
    def this(config: graphqlLib.typeDefinitionMod.GraphQLScalarTypeConfig[_, _]) = this()
  }
  
  @js.native
  class GraphQLSchema protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.GraphQLSchema {
    def this(config: graphqlLib.typeSchemaMod.GraphQLSchemaConfig) = this()
  }
  
  @js.native
  class GraphQLUnionType protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.GraphQLUnionType {
    def this(config: graphqlLib.typeDefinitionMod.GraphQLUnionTypeConfig[_, _]) = this()
  }
  
  @js.native
  class Source protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.Source {
    def this(body: java.lang.String) = this()
    def this(body: java.lang.String, name: java.lang.String) = this()
    def this(body: java.lang.String, name: java.lang.String, locationOffset: graphqlLib.languageSourceMod.Location) = this()
  }
  
  @js.native
  class TypeInfo protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.TypeInfo {
  ...
  class ValidationContext protected ()
    extends graphqlDashComposeLib.esmGraphqlMod.ValidationContext {
  ...
  val DEFAULT_DEPRECATION_REASON: graphqlDashComposeLib.graphqlDashComposeLibStrings.`No longer supported` = js.native
