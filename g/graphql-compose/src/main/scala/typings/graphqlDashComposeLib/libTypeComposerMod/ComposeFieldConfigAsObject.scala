...
trait ComposeFieldConfigAsObject[TSource, TContext, TArgs]
  extends _ComposeFieldConfig[TSource, TContext, TArgs]
  ...
  var `type`: (graphqlDashComposeLib.libUtilsDefinitionsMod.Thunk[ComposeOutputType[TSource, TContext, TArgs]]) | graphqlLib.typeDefinitionMod.GraphQLOutputType
}

object ComposeFieldConfigAsObject {
  @scala.inline
  def apply[TSource, TContext, TArgs](
    `type`: (graphqlDashComposeLib.libUtilsDefinitionsMod.Thunk[ComposeOutputType[TSource, TContext, TArgs]]) | graphqlLib.typeDefinitionMod.GraphQLOutputType,
