...
trait RelationOptsWithResolver[TRelationSource, TSource, TContext, TArgs] extends js.Object {
  ...
  var projection: js.UndefOr[
    stdLib.Partial[graphqlDashComposeLib.libUtilsProjectionMod.ProjectionType[TSource]]
  ] = js.undefined
  var resolver: graphqlDashComposeLib.libUtilsDefinitionsMod.Thunk[graphqlDashComposeLib.libResolverMod.Resolver[TRelationSource, TContext, TArgs]]
}

object RelationOptsWithResolver {
  @scala.inline
  def apply[TRelationSource, TSource, TContext, TArgs](
    resolver: graphqlDashComposeLib.libUtilsDefinitionsMod.Thunk[graphqlDashComposeLib.libResolverMod.Resolver[TRelationSource, TContext, TArgs]],
    ...
    projection: stdLib.Partial[graphqlDashComposeLib.libUtilsProjectionMod.ProjectionType[TSource]] = null
