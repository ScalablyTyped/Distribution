...
import typings.graphqlCompose.resolverMod.ResolverMiddleware
import typings.graphqlCompose.resolverMod.ResolverNextRpCb
import typings.graphqlCompose.resolverMod.ResolverOpts
import typings.graphqlCompose.resolverMod.ResolverWrapCb
