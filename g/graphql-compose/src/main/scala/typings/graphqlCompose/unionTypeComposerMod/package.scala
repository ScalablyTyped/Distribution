...
package object unionTypeComposerMod {
  ...
  type GraphQLUnionTypeExtended[TSource, TContext] = typings.graphql.mod.GraphQLUnionType with (typings.graphqlCompose.AnonGqcExtensionsGqcTypeMap[TSource, TContext])
