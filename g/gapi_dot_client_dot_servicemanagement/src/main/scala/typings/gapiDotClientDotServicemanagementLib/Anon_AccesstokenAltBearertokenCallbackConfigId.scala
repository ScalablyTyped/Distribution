...
object Anon_AccesstokenAltBearertokenCallbackConfigId {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackConfigId = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackConfigId]
  }
}
