...
import typings.guacamoleClient.libClientMod.Client.ExportLayer
...
object anon {
  ...
  object ExportLayerBasexnumberynu {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ExportLayerBasexnumberynu] (val x: Self) extends AnyVal {
