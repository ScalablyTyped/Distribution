...
object libOnScreenKeyboardMod {
  ...
  object OnScreenKeyboard {
    ...
    type Key = Instantiable2[
        /* template */ typings.guacamoleClient.libOnScreenKeyboardMod.Key, 
        /* name */ js.UndefOr[String], 
        typings.guacamoleClient.libOnScreenKeyboardMod.Key
      ]
    
    type Layout = Instantiable1[
        /* template */ typings.guacamoleClient.libOnScreenKeyboardMod.Layout, 
        typings.guacamoleClient.libOnScreenKeyboardMod.Layout
      ]
  }
