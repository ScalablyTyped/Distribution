...
import typings.guacamoleClient.libVideoPlayerMod.VideoPlayer
...
object libClientMod {
  ...
  open class Client protected () extends StObject {
    ...
    /**
      ...
      */
    def sendMouseState(state: typings.guacamoleClient.libMouseMod.Mouse.State): Unit = js.native
  ...
  object Client {
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.guacamoleClient.libClientMod.Client.ExportLayerBase
      - typings.guacamoleClient.anon.ExportLayerBasexnumberynu
    */
    trait ExportLayer extends StObject
    object ExportLayer {
      
      inline def ExportLayerBase(height: Double, width: Double): typings.guacamoleClient.libClientMod.Client.ExportLayerBase = {
        val __obj = js.Dynamic.literal(height = height.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.guacamoleClient.libClientMod.Client.ExportLayerBase]
      }
