...
import typings.guacamoleClient.libLayerMod.Layer
import typings.guacamoleClient.libLayerMod.Layer.LineCap
import typings.guacamoleClient.libLayerMod.Layer.LineJoin
import typings.guacamoleClient.libLayerMod.Layer.Pixel
import typings.guacamoleClient.libVisibleLayerMod.VisibleLayer
...
object libDisplayMod {
  ...
  object Display {
    ...
    type VisibleLayer = Instantiable2[
        /* width */ Double, 
        /* height */ Double, 
        typings.guacamoleClient.libVisibleLayerMod.VisibleLayer
      ]
  }
}
