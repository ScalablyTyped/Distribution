...
import typings.googletag.anon.ChangeCorrelator
import typings.googletag.anon.FetchMarginPercent
import typings.googletag.anon.Recordvidcmsidstring
...
trait PubAdsService
  ...
  def getCorrelator(): String = js.native
  
  def getImaContent(): Recordvidcmsidstring = js.native
  
  def getTagSessionCorrelator(): Double = js.native
  ...
  def getVideoContent(): Recordvidcmsidstring = js.native
  ...
  /**
    ...
    * @returns The service object on which the method was called.
    */
  def set(key: AttributeName, value: String): PubAdsService = js.native
  ...
  def setImaContent(imaContentId: String, imaCmsId: String): Unit = js.native
