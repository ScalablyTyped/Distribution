...
object secureSignals {
  ...
  /**
    ...
    */
  trait BidderSignalProvider extends StObject {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.googletag.anon.BidderSignalProvidernetwo
    - typings.googletag.googletag.secureSignals.PublisherSignalProvider
  */
  trait SecureSignalProvider extends StObject
  object SecureSignalProvider {
    
    inline def BidderSignalProvidernetwo(collectorFunction: () => js.Promise[String], id: String): typings.googletag.anon.BidderSignalProvidernetwo = {
      val __obj = js.Dynamic.literal(collectorFunction = js.Any.fromFunction0(collectorFunction), id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.googletag.anon.BidderSignalProvidernetwo]
    }
    
    inline def PublisherSignalProvider(collectorFunction: () => js.Promise[String], networkCode: String): typings.googletag.googletag.secureSignals.PublisherSignalProvider = {
      val __obj = js.Dynamic.literal(collectorFunction = js.Any.fromFunction0(collectorFunction), networkCode = networkCode.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.googletag.googletag.secureSignals.PublisherSignalProvider]
    }
  }
