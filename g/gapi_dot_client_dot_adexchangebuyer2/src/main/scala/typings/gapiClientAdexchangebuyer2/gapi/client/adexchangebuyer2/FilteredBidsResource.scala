...
trait FilteredBidsResource extends js.Object {
  ...
  /**
    ...
    */
  def list(request: AnonAccesstokenAccountIdAltBearertokenCallbackFieldsFilterSetId): Request_[ListFilteredBidsResponse]
}
...
object FilteredBidsResource {
  ...
  def apply(
    ...
    list: AnonAccesstokenAccountIdAltBearertokenCallbackFieldsFilterSetId => Request_[ListFilteredBidsResponse]
