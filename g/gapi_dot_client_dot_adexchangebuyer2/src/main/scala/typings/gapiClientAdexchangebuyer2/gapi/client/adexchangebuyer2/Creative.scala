...
trait Creative extends js.Object {
  ...
  var filteringStats: js.UndefOr[FilteringStats] = js.native
  /** An HTML creative. */
...
object Creative {
  ...
  implicit class CreativeOps[Self <: Creative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFilteringStats(value: FilteringStats): Self = this.set("filteringStats", value.asInstanceOf[js.Any])
    @scala.inline
