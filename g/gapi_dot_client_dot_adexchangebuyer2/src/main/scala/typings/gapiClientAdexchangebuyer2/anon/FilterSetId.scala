...
@js.native
trait FilterSetId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object FilterSetId {
  @scala.inline
  def apply(accountId: String, filterSetId: String): FilterSetId = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], filterSetId = filterSetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FilterSetId]
  }
  @scala.inline
  implicit class FilterSetIdOps[Self <: FilterSetId] (val x: Self) extends AnyVal {
    @scala.inline
