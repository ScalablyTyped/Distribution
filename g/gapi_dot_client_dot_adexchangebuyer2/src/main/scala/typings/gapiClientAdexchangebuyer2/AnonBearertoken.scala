...
object AnonBearertoken {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], clientAccountId = clientAccountId.asInstanceOf[js.Any], userId = userId.asInstanceOf[js.Any])
