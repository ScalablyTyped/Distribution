...
trait Anon_AccesstokenAccountIdAltBearertokenCallbackCreativeId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAccountIdAltBearertokenCallbackCreativeId {
  @scala.inline
  def apply(
    accountId: String,
    creativeId: String,
  ...
  ): Anon_AccesstokenAccountIdAltBearertokenCallbackCreativeId = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAccountIdAltBearertokenCallbackCreativeId]
  }
}
