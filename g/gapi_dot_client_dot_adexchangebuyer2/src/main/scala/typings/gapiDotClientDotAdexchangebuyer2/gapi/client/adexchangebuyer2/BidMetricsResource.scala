...
trait BidMetricsResource extends js.Object {
  ...
  def list(request: Anon_AccesstokenAccountIdAltBearertokenCallbackFieldsFilterSetId): Request[ListBidMetricsResponse]
}

object BidMetricsResource {
  @scala.inline
  def apply(
    list: Anon_AccesstokenAccountIdAltBearertokenCallbackFieldsFilterSetId => Request[ListBidMetricsResponse]
  ): BidMetricsResource = {
