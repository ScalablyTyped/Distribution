...
object Anon_AccesstokenAccountIdAltBearertokenCallbackFieldsIsTransient {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAccountIdAltBearertokenCallbackFieldsIsTransient = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAccountIdAltBearertokenCallbackFieldsIsTransient]
  }
}
