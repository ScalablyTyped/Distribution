...
object Anon_AccesstokenAccountIdAltBearertokenCallbackFieldsKey {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAccountIdAltBearertokenCallbackFieldsKey = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAccountIdAltBearertokenCallbackFieldsKey]
  }
}
