...
object Timestamp extends js.Object {
  /**
    ...
    * given date.
    */
  def fromDate(date: stdLib.Date): atGoogleDashCloudFirestoreLib.FirebaseFirestoreNs.Timestamp = js.native
  /**
    ...
    */
  def fromMillis(milliseconds: scala.Double): atGoogleDashCloudFirestoreLib.FirebaseFirestoreNs.Timestamp = js.native
  /**
    * Creates a new timestamp with the current date, with millisecond precision.
    *
    * @return A new `Timestamp` representing the current date.
    */
  def now(): atGoogleDashCloudFirestoreLib.FirebaseFirestoreNs.Timestamp = js.native
}
