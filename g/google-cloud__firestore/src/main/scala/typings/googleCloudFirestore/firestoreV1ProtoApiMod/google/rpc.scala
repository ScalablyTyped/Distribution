...
import typings.googleCloudFirestore.firestoreV1ProtoApiMod.google.protobuf.IAny
...
object rpc {
  ...
  /** Represents a Status. */
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1_proto_api", "google.rpc.Status")
  @js.native
  /**
