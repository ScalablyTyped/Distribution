...
import typings.googleCloudFirestore.firestoreV1ProtoApiMod.google.api.IHttpRule
import typings.googleCloudFirestore.firestoreV1ProtoApiMod.google.longrunning.IOperationInfo
