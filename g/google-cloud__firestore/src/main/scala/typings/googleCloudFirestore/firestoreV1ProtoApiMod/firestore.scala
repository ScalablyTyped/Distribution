package typings.googleCloudFirestore.firestoreV1ProtoApiMod
...
import typings.googleCloudFirestore.firestoreV1ProtoApiMod.google.firestore.v1.IStructuredQuery
