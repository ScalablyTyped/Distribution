...
import typings.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.api.IHttpRule
import typings.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.longrunning.IOperationInfo
