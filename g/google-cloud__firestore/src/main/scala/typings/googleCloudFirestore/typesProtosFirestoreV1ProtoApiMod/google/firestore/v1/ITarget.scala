...
import typings.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.Target.IDocumentsTarget
import typings.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.Target.IQueryTarget
...
object ITarget {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ITarget] (val x: Self) extends AnyVal {
