...
import typings.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.api.FieldBehavior
import typings.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.api.IResourceReference
