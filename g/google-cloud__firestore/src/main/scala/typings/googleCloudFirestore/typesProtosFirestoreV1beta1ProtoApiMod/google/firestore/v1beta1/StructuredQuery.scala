...
import typings.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.firestore.v1beta1.StructuredQuery.CompositeFilter.Operator
import typings.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.firestore.v1beta1.StructuredQuery.ICollectionSelector
import typings.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.firestore.v1beta1.StructuredQuery.IOrder
...
@JSImport("@google-cloud/firestore/types/protos/firestore_v1beta1_proto_api", "google.firestore.v1beta1.StructuredQuery")
@js.native
/**
...
object StructuredQuery {
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1beta1_proto_api", "google.firestore.v1beta1.StructuredQuery.CollectionSelector")
  @js.native
  /**
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1beta1_proto_api", "google.firestore.v1beta1.StructuredQuery.CompositeFilter")
  @js.native
  /**
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1beta1_proto_api", "google.firestore.v1beta1.StructuredQuery.FieldFilter")
  @js.native
  /**
  ...
  open class FieldFilter ()
    ...
    /** FieldFilter op. */
    @JSName("op")
    var op_FieldFilter: typings.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.firestore.v1beta1.StructuredQuery.FieldFilter.Operator = js.native
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1beta1_proto_api", "google.firestore.v1beta1.StructuredQuery.FieldReference")
  @js.native
  /**
  ...
  /** Represents a Filter. */
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1beta1_proto_api", "google.firestore.v1beta1.StructuredQuery.Filter")
  @js.native
  /**
  ...
  /** Represents an Order. */
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1beta1_proto_api", "google.firestore.v1beta1.StructuredQuery.Order")
  @js.native
  /**
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1beta1_proto_api", "google.firestore.v1beta1.StructuredQuery.Projection")
  @js.native
  /**
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1beta1_proto_api", "google.firestore.v1beta1.StructuredQuery.UnaryFilter")
  @js.native
  /**
  ...
  open class UnaryFilter ()
    ...
    /** UnaryFilter op. */
    @JSName("op")
    var op_UnaryFilter: typings.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.firestore.v1beta1.StructuredQuery.UnaryFilter.Operator = js.native
  ...
  */
  ...
  trait IFieldFilter extends StObject {
    ...
    /** FieldFilter op */
    var op: js.UndefOr[
        typings.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.firestore.v1beta1.StructuredQuery.FieldFilter.Operator | Null
      ] = js.undefined
  ...
  object IFieldFilter {
    ...
    implicit open class MutableBuilder[Self <: IFieldFilter] (val x: Self) extends AnyVal {
      ...
      inline def setOp(
        value: typings.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.firestore.v1beta1.StructuredQuery.FieldFilter.Operator
  ...
  trait IUnaryFilter extends StObject {
    ...
    /** UnaryFilter op */
    var op: js.UndefOr[
        typings.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.firestore.v1beta1.StructuredQuery.UnaryFilter.Operator | Null
      ] = js.undefined
  }
  object IUnaryFilter {
    ...
    implicit open class MutableBuilder[Self <: IUnaryFilter] (val x: Self) extends AnyVal {
      ...
      inline def setOp(
        value: typings.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.firestore.v1beta1.StructuredQuery.UnaryFilter.Operator
      ): Self = StObject.set(x, "op", value.asInstanceOf[js.Any])
