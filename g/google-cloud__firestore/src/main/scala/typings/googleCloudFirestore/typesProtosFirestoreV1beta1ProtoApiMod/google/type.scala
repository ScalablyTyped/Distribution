...
object `type` {
  ...
  /** Represents a LatLng. */
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1beta1_proto_api", "google.type.LatLng")
  @js.native
  /**
  ...
  object ILatLng {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ILatLng] (val x: Self) extends AnyVal {
