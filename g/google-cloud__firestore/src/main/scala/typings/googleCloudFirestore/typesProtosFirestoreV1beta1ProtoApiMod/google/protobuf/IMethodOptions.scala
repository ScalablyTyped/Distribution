...
import typings.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.api.IHttpRule
import typings.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.longrunning.IOperationInfo
