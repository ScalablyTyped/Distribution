package typings.googleCloudFirestore.firestoreAdminV1ProtoApiMod.google
...
object api {
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_admin_v1_proto_api", "google.api.CustomHttpPattern")
  @js.native
  /**
  ...
  /** Represents a Http. */
  @JSImport("@google-cloud/firestore/types/protos/firestore_admin_v1_proto_api", "google.api.Http")
  @js.native
  /**
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_admin_v1_proto_api", "google.api.HttpRule")
  @js.native
  /**
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_admin_v1_proto_api", "google.api.ResourceDescriptor")
  @js.native
  /**
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_admin_v1_proto_api", "google.api.ResourceReference")
  @js.native
  /**
