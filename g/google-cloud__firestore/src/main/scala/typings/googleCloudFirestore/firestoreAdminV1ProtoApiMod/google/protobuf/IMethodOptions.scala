...
import typings.googleCloudFirestore.firestoreAdminV1ProtoApiMod.google.api.IHttpRule
import typings.googleCloudFirestore.firestoreAdminV1ProtoApiMod.google.longrunning.IOperationInfo
