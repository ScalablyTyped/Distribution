package typings.gapiDotClientDotDoubleclicksearch.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typings.gapiDotClientDotDoubleclicksearch.gapiDotClientDotDoubleclicksearchStrings.doubleclicksearch,
    version: v2
