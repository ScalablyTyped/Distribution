...
import typings.gapiClientDoubleclicksearch.AnonAltFields
import typings.gapiClientDoubleclicksearch.AnonAltFieldsKey
...
trait ReportsResource extends js.Object {
  ...
  def get(request: AnonAltFields): Request_[Report]
  /** Downloads a report file encoded in UTF-8. */
  def getFile(request: AnonAltFieldsKey): Request_[Unit]
...
object ReportsResource {
  ...
  def apply(
    ...
    get: AnonAltFields => Request_[Report],
    getFile: AnonAltFieldsKey => Request_[Unit],
