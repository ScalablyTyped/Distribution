...
@js.native
trait AgencyId extends js.Object {
...
object AgencyId {
  @scala.inline
  def apply(advertiserId: String, agencyId: String): AgencyId = {
    val __obj = js.Dynamic.literal(advertiserId = advertiserId.asInstanceOf[js.Any], agencyId = agencyId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AgencyId]
  }
  @scala.inline
  implicit class AgencyIdOps[Self <: AgencyId] (val x: Self) extends AnyVal {
    @scala.inline
