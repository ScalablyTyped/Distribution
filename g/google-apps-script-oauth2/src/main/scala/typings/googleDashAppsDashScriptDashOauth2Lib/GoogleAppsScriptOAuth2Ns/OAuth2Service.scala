...
trait OAuth2Service extends js.Object {
  ...
  /**
           ...
           */
  def getAuthorizationUrl(): java.lang.String = js.native
  /**
  ...
  /**
           ...
           */
  def getRedirectUri(): java.lang.String = js.native
  /**
           * Gets the token from the service's property store or cache.
           */
  def getToken(): js.Object | scala.Null = js.native
  /**
           * Completes the OAuth2 flow using the request data passed in to the callback function.
           */
  def handleCallback(callbackRequest: js.Object): scala.Boolean = js.native
  /**
           ...
           */
  def hasAccess(): scala.Boolean = js.native
  /**
  ...
  /**
           ...
           */
  def setAuthorizationBaseUrl(authorizationBaseUrl: java.lang.String): OAuth2Service = js.native
  /**
           ...
           */
  def setCache(cache: googleDashAppsDashScriptLib.GoogleAppsScriptNs.CacheNs.Cache): OAuth2Service = js.native
  /**
           ...
           */
  def setCallbackFunction(callbackFunctionName: java.lang.String): OAuth2Service = js.native
  /**
           ...
           */
  def setClientId(clientId: java.lang.String): OAuth2Service = js.native
  /**
  ...
  /**
           ...
           */
  def setParam(name: java.lang.String, value: java.lang.String): OAuth2Service = js.native
  /**
           * Sets the private key to use for Service Account authorization.
           */
  def setPrivateKey(privateKey: java.lang.String): OAuth2Service = js.native
  /**
           ...
           */
  def setPropertyStore(propertyStore: googleDashAppsDashScriptLib.GoogleAppsScriptNs.PropertiesNs.Properties): OAuth2Service = js.native
  /**
           ...
           */
  def setScope(scope: java.lang.String): OAuth2Service = js.native
  /**
           * Sets the scope or scopes to request during the authorization flow (optional).
           * If the scope value is an array it will be joined using the separator before being sent to the server,
           * which is is a space character by default.
           */
  def setScope(scope: java.lang.String, separator: java.lang.String): OAuth2Service = js.native
  /**
           * Sets the scope or scopes to request during the authorization flow (optional).
           * If the scope value is an array it will be joined using the separator before being sent to the server,
           * which is is a space character by default.
           */
  def setScope(scope: js.Array[java.lang.String]): OAuth2Service = js.native
  /**
           * Sets the scope or scopes to request during the authorization flow (optional).
           * If the scope value is an array it will be joined using the separator before being sent to the server,
           * which is is a space character by default.
           */
  def setScope(scope: js.Array[java.lang.String], separator: java.lang.String): OAuth2Service = js.native
  /**
           * Sets the subject (sub) value to use for Service Account authorization.
           */
  def setSubject(subject: java.lang.String): OAuth2Service = js.native
  /**
  ...
  /**
           ...
           */
  def setTokenUrl(tokenUrl: java.lang.String): OAuth2Service = js.native
}
