...
object StateParameterLocation extends js.Object {
  ...
  /* 0 */ val AUTHORIZATION_URL: typings.googleDashAppsDashScriptDashOauth2.GoogleAppsScriptOAuth2Ns.StateParameterLocation.AUTHORIZATION_URL with Double = js.native
  /* 1 */ val REDIRECT_URL: typings.googleDashAppsDashScriptDashOauth2.GoogleAppsScriptOAuth2Ns.StateParameterLocation.REDIRECT_URL with Double = js.native
  @JSBracketAccess
