...
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.CacheNs.Cache
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.PropertiesNs.Properties
