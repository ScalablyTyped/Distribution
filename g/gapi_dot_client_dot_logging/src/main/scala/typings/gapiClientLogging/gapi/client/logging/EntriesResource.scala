...
import typings.gapiClientLogging.AnonAccesstokenAltBearertokenCallbackFieldsKeyOauthtokenPpPrettyPrint
...
trait EntriesResource extends js.Object {
  ...
  def list(request: AnonAccesstokenAltBearertokenCallbackFieldsKeyOauthtokenPpPrettyPrint): Request_[ListLogEntriesResponse]
  /**
    ...
    */
  def write(request: AnonAccesstokenAltBearertokenCallbackFieldsKeyOauthtokenPpPrettyPrint): Request_[js.Object]
}

object EntriesResource {
  @scala.inline
  def apply(
    list: AnonAccesstokenAltBearertokenCallbackFieldsKeyOauthtokenPpPrettyPrint => Request_[ListLogEntriesResponse],
    write: AnonAccesstokenAltBearertokenCallbackFieldsKeyOauthtokenPpPrettyPrint => Request_[js.Object]
  ): EntriesResource = {
