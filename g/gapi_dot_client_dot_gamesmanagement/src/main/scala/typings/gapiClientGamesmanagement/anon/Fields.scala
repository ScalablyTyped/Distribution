...
object Fields {
  @scala.inline
  def apply(applicationId: String, playerId: String): Fields = {
    val __obj = js.Dynamic.literal(applicationId = applicationId.asInstanceOf[js.Any], playerId = playerId.asInstanceOf[js.Any])
