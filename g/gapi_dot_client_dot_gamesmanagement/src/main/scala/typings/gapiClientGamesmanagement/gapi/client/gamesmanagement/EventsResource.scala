...
import typings.gapiClientGamesmanagement.AnonAltEventId
...
trait EventsResource extends js.Object {
  /**
    ...
    */
  def reset(request: AnonAltEventId): Request_[Unit]
  /**
  ...
  /**
    ...
    */
  def resetForAllPlayers(request: AnonAltEventId): Request_[Unit]
  /**
...
object EventsResource {
  @scala.inline
  def apply(
    reset: AnonAltEventId => Request_[Unit],
    resetAll: AnonAlt => Request_[Unit],
    resetAllForAllPlayers: AnonAlt => Request_[Unit],
    resetForAllPlayers: AnonAltEventId => Request_[Unit],
