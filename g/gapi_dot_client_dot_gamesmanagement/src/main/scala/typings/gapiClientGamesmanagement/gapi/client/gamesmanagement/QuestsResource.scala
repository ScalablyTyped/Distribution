...
import typings.gapiClientGamesmanagement.AnonAltFields
...
trait QuestsResource extends js.Object {
  /**
    ...
    */
  def reset(request: AnonAltFields): Request_[Unit]
  /**
  ...
  /**
    ...
    */
  def resetForAllPlayers(request: AnonAltFields): Request_[Unit]
  /**
...
object QuestsResource {
  @scala.inline
  def apply(
    reset: AnonAltFields => Request_[Unit],
    resetAll: AnonAlt => Request_[Unit],
    resetAllForAllPlayers: AnonAlt => Request_[Unit],
    resetForAllPlayers: AnonAltFields => Request_[Unit],
