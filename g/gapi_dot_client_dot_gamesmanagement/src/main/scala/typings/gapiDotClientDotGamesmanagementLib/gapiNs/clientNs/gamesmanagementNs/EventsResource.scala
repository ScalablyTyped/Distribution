...
trait EventsResource extends js.Object {
  /**
    ...
    */
  def reset(request: gapiDotClientDotGamesmanagementLib.Anon_PrettyPrintEventId): gapiDotClientLib.gapiNs.clientNs.Request[scala.Unit]
  /**
  ...
  /**
    ...
    */
  def resetForAllPlayers(request: gapiDotClientDotGamesmanagementLib.Anon_PrettyPrintEventId): gapiDotClientLib.gapiNs.clientNs.Request[scala.Unit]
  /**
