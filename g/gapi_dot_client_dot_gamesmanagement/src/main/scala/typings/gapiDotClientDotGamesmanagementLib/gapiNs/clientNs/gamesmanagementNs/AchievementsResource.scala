...
trait AchievementsResource extends js.Object {
  /**
    ...
    * application.
    */
  def reset(request: gapiDotClientDotGamesmanagementLib.Anon_PrettyPrintQuotaUser): gapiDotClientLib.gapiNs.clientNs.Request[AchievementResetResponse]
  /**
    ...
    * your application.
    */
  def resetAll(request: gapiDotClientDotGamesmanagementLib.Anon_PrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[AchievementResetAllResponse]
  ...
  /**
    ...
    */
  def resetForAllPlayers(request: gapiDotClientDotGamesmanagementLib.Anon_PrettyPrintQuotaUser): gapiDotClientLib.gapiNs.clientNs.Request[scala.Unit]
  /**
