...
import typings.gapiDotClientDotReseller.Anon_CommitmentInterval
import typings.gapiDotClientDotReseller.Anon_IsInTrial
import typings.gapiDotClientDotReseller.Anon_MinimumTransferableSeats
...
trait Subscription extends js.Object {
  ...
  /**
    ...
    */
  var plan: js.UndefOr[Anon_CommitmentInterval] = js.undefined
  /**
  ...
  var transferInfo: js.UndefOr[Anon_MinimumTransferableSeats] = js.undefined
  /** The G Suite annual commitment and flexible payment plans can be in a 30-day free trial. For more information, see the API concepts. */
  var trialSettings: js.UndefOr[Anon_IsInTrial] = js.undefined
}
