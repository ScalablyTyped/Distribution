...
trait AnonAltCustomerIdDeletionType extends js.Object {
...
object AnonAltCustomerIdDeletionType {
  @scala.inline
  def apply(
    customerId: String,
    deletionType: String,
    ...
    __obj.asInstanceOf[AnonAltCustomerIdDeletionType]
  }
}
