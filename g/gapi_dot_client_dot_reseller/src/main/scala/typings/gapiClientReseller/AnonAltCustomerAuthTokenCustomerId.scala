...
trait AnonAltCustomerAuthTokenCustomerId extends js.Object {
...
object AnonAltCustomerAuthTokenCustomerId {
  @scala.inline
  def apply(
    customerId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltCustomerAuthTokenCustomerId = {
    ...
    __obj.asInstanceOf[AnonAltCustomerAuthTokenCustomerId]
  }
}
