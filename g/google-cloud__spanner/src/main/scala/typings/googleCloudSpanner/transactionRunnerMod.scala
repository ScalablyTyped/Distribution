...
object transactionRunnerMod {
  ...
  @JSImport("@google-cloud/spanner/build/src/transaction-runner", "Runner")
  @js.native
  abstract class Runner[T] protected () extends StObject {
  ...
  trait RunTransactionOptions extends StObject {
    ...
    var requestOptions: js.UndefOr[PickIRequestOptionstransa] = js.undefined
  ...
  object RunTransactionOptions {
    ...
    extension [Self <: RunTransactionOptions](x: Self) {
      ...
      inline def setRequestOptions(value: PickIRequestOptionstransa): Self = StObject.set(x, "requestOptions", value.asInstanceOf[js.Any])
