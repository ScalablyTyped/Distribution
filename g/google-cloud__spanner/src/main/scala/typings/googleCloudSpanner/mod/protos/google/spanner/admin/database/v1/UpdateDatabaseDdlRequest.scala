...
@JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.UpdateDatabaseDdlRequest")
@js.native
/**
...
open class UpdateDatabaseDdlRequest ()
  extends typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.UpdateDatabaseDdlRequest {
...
object UpdateDatabaseDdlRequest {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.UpdateDatabaseDdlRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.UpdateDatabaseDdlRequest]
  inline def create(properties: IUpdateDatabaseDdlRequest): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.UpdateDatabaseDdlRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.UpdateDatabaseDdlRequest]
  ...
  /* static member */
  inline def toObject(
    message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.UpdateDatabaseDdlRequest
