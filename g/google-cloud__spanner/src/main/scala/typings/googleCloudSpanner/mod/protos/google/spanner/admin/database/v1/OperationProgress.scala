...
import typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.IOperationProgress
...
@JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.OperationProgress")
@js.native
/**
...
open class OperationProgress ()
  extends typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OperationProgress {
...
object OperationProgress {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OperationProgress = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OperationProgress]
  inline def create(properties: IOperationProgress): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OperationProgress = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OperationProgress]
  ...
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OperationProgress = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OperationProgress]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OperationProgress): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(
    message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OperationProgress,
