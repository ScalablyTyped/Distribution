...
@JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.GetDatabaseDdlResponse")
@js.native
/**
...
open class GetDatabaseDdlResponse ()
  extends typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.GetDatabaseDdlResponse {
...
object GetDatabaseDdlResponse {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.GetDatabaseDdlResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.GetDatabaseDdlResponse]
  inline def create(properties: IGetDatabaseDdlResponse): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.GetDatabaseDdlResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.GetDatabaseDdlResponse]
  ...
  /* static member */
  inline def toObject(
    message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.GetDatabaseDdlResponse
