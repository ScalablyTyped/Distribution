...
@JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.ListBackupOperationsRequest")
@js.native
/**
...
open class ListBackupOperationsRequest ()
  extends typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListBackupOperationsRequest {
...
object ListBackupOperationsRequest {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListBackupOperationsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListBackupOperationsRequest]
  inline def create(properties: IListBackupOperationsRequest): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListBackupOperationsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListBackupOperationsRequest]
  ...
  /* static member */
  inline def toObject(
    message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListBackupOperationsRequest
