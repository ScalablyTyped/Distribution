...
open class Backup protected ()
  extends typings.googleCloudSpanner.backupMod.Backup {
  def this(instance: typings.googleCloudSpanner.instanceMod.Instance, name: String) = this()
  def this(instance: typings.googleCloudSpanner.instanceMod.Instance, name: String, sourceName: String) = this()
}
object Backup {
