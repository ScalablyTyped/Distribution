...
import typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.IOptimizeRestoredDatabaseMetadata
...
@JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.OptimizeRestoredDatabaseMetadata")
@js.native
/**
...
open class OptimizeRestoredDatabaseMetadata ()
  extends typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OptimizeRestoredDatabaseMetadata {
...
object OptimizeRestoredDatabaseMetadata {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OptimizeRestoredDatabaseMetadata = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OptimizeRestoredDatabaseMetadata]
  inline def create(properties: IOptimizeRestoredDatabaseMetadata): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OptimizeRestoredDatabaseMetadata = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OptimizeRestoredDatabaseMetadata]
  ...
  /* static member */
  inline def toObject(
    message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.OptimizeRestoredDatabaseMetadata
