...
@JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.CreateDatabaseMetadata")
@js.native
/**
...
open class CreateDatabaseMetadata ()
  extends typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateDatabaseMetadata {
...
object CreateDatabaseMetadata {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateDatabaseMetadata = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateDatabaseMetadata]
  inline def create(properties: ICreateDatabaseMetadata): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateDatabaseMetadata = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateDatabaseMetadata]
  ...
  /* static member */
  inline def toObject(
    message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateDatabaseMetadata
