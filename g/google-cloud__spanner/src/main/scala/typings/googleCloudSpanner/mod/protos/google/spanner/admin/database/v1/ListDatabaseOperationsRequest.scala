...
@JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.ListDatabaseOperationsRequest")
@js.native
/**
...
open class ListDatabaseOperationsRequest ()
  extends typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseOperationsRequest {
...
object ListDatabaseOperationsRequest {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseOperationsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseOperationsRequest]
  inline def create(properties: IListDatabaseOperationsRequest): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseOperationsRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseOperationsRequest]
  ...
  /* static member */
  inline def toObject(
    message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseOperationsRequest
