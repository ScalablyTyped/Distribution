...
@JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.ListDatabaseRolesResponse")
@js.native
/**
...
open class ListDatabaseRolesResponse ()
  extends typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseRolesResponse {
...
object ListDatabaseRolesResponse {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseRolesResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseRolesResponse]
  inline def create(properties: IListDatabaseRolesResponse): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseRolesResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseRolesResponse]
  ...
  /* static member */
  inline def toObject(
    message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabaseRolesResponse
