...
@JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.EncryptionInfo")
@js.native
/**
...
open class EncryptionInfo ()
  extends typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.EncryptionInfo {
...
object EncryptionInfo {
  ...
  /** Type enum. */
  @JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.EncryptionInfo.Type")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.EncryptionInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.EncryptionInfo]
  inline def create(properties: IEncryptionInfo): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.EncryptionInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.EncryptionInfo]
  ...
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.EncryptionInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.EncryptionInfo]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.EncryptionInfo): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(
    message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.EncryptionInfo,
