...
@JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.CreateBackupRequest")
@js.native
/**
...
open class CreateBackupRequest ()
  extends typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateBackupRequest {
...
object CreateBackupRequest {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateBackupRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateBackupRequest]
  inline def create(properties: ICreateBackupRequest): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateBackupRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateBackupRequest]
  ...
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateBackupRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateBackupRequest]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateBackupRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(
    message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.CreateBackupRequest,
