...
import typings.googleCloudSpanner.instanceMod.CreateInstanceCallback
import typings.googleCloudSpanner.instanceMod.CreateInstanceResponse
import typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.DatabaseDialect
import typings.googleCloudSpanner.serviceMod.GrpcService
...
open class Spanner () extends GrpcService {
  ...
  /**
    ...
    * ```
    */
  def getInstanceConfigsStream(): ReadableStream[Any] = js.native
  def getInstanceConfigsStream(options: GetInstanceConfigsOptions): ReadableStream[Any] = js.native
  ...
  /**
    ...
    * ```
    */
  def getInstancesStream(): ReadableStream[Any] = js.native
  def getInstancesStream(options: GetInstancesOptions): ReadableStream[Any] = js.native
  ...
  /**
    ...
    * ```
    */
  def instance(name: String): typings.googleCloudSpanner.instanceMod.Instance = js.native
  
  var instances_ : Map[String, typings.googleCloudSpanner.instanceMod.Instance] = js.native
...
object Spanner {
  ...
  @js.native
  def GOOGLE_STANDARD_SQL: DatabaseDialect = js.native
  inline def GOOGLE_STANDARD_SQL_=(x: DatabaseDialect): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GOOGLE_STANDARD_SQL")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("@google-cloud/spanner", "Spanner.POSTGRESQL")
  @js.native
  def POSTGRESQL: DatabaseDialect = js.native
  inline def POSTGRESQL_=(x: DatabaseDialect): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("POSTGRESQL")(x.asInstanceOf[js.Any])
