...
@JSImport("@google-cloud/spanner", "protos.google.spanner.admin.database.v1.ListDatabasesResponse")
@js.native
/**
...
open class ListDatabasesResponse ()
  extends typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabasesResponse {
...
object ListDatabasesResponse {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabasesResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabasesResponse]
  inline def create(properties: IListDatabasesResponse): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabasesResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabasesResponse]
  ...
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabasesResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabasesResponse]
  ...
  /* static member */
  inline def toObject(
    message: typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.ListDatabasesResponse
