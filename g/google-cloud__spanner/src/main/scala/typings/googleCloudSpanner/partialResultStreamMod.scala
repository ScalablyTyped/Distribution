...
import typings.googleCloudSpanner.protosMod.google.spanner.v1.PartialResultSet
...
object partialResultStreamMod {
  ...
  open class PartialResultStream_ ()
    ...
    /**
      ...
      */
    def _transform(chunk: PartialResultSet, enc: String, next: js.Function): Unit = js.native
  ...
  object PartialResultStream_ {
    ...
    /**
      ...
      * @returns {Array.<*>}
      */
    inline def merge(`type`: Type, head: Value, tail: Value): js.Array[Value] = (^.asInstanceOf[js.Dynamic].applyDynamic("merge")(`type`.asInstanceOf[js.Any], head.asInstanceOf[js.Any], tail.asInstanceOf[js.Any])).asInstanceOf[js.Array[Value]]
    ...
    /**
      ...
      * @returns {Array.<*>}
      */
    inline def mergeLists(`type`: Type, head: js.Array[Value], tail: js.Array[Value]): js.Array[Value] = (^.asInstanceOf[js.Dynamic].applyDynamic("mergeLists")(`type`.asInstanceOf[js.Any], head.asInstanceOf[js.Any], tail.asInstanceOf[js.Any])).asInstanceOf[js.Array[Value]]
  }
  ...
  /**
    ...
    */
  type ResponseCallback = js.Function1[/* response */ PartialResultSet, Unit]
  ...
  trait ResultEvents extends StObject {
    ...
    @JSName("emit")
    def emit_response(event: response, data: PartialResultSet): Boolean = js.native
    @JSName("emit")
    def emit_stats(event: stats, data: ResultSetStats): Boolean = js.native
  ...
  /**
    ...
    */
  type StatsCallback = js.Function1[/* stats */ ResultSetStats, Unit]
}
