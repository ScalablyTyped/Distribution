...
import typings.googleCloudSpanner.googleCloudSpannerStrings.readonly_
import typings.googleCloudSpanner.googleCloudSpannerStrings.readwrite_
...
import typings.googleCloudSpanner.transactionMod.PartitionedDml
...
object sessionMod {
  ...
  open class Session protected () extends StObject {
    ...
    def snapshot(options: Unit, queryOptions: IQueryOptions): Snapshot = js.native
    def snapshot(options: TimestampBounds): Snapshot = js.native
    def snapshot(options: TimestampBounds, queryOptions: IQueryOptions): Snapshot = js.native
    ...
    def transaction(queryOptions: Unit, requestOptions: PickIRequestOptionstransa): Transaction = js.native
    def transaction(queryOptions: IQueryOptions): Transaction = js.native
    def transaction(queryOptions: IQueryOptions, requestOptions: PickIRequestOptionstransa): Transaction = js.native
  ...
  type DeleteSessionCallback = NormalCallback[IEmpty]
  
  type DeleteSessionResponse = js.Array[IEmpty]
  
  type GetSessionMetadataCallback = NormalCallback[ISession]
  
  type GetSessionMetadataResponse = js.Array[ISession]
  
  type GetSessionResponse = js.Tuple2[Session, Response[Any]]
  
  type KeepAliveCallback = NormalCallback[IResultSet]
  
  type KeepAliveResponse = js.Array[IResultSet]
  
  /* Rewritten from type alias, can be one of: 
    - typings.googleCloudSpanner.googleCloudSpannerStrings.readonly_
    - typings.googleCloudSpanner.googleCloudSpannerStrings.readwrite_
  */
  ...
  object types {
    ...
    inline def ReadWrite: readwrite_ = "readwrite".asInstanceOf[readwrite_]
  }
}
