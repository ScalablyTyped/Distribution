...
trait IListInstancesRequest extends StObject {
...
object IListInstancesRequest {
  
  inline def apply(): IListInstancesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IListInstancesRequest]
  }
  
  extension [Self <: IListInstancesRequest](x: Self) {
