...
import typings.googleCloudSpanner.protosMod.google.protobuf.MethodOptions.IdempotencyLevel
...
@JSImport("@google-cloud/spanner/build/protos/protos", "google.protobuf.MethodOptions")
@js.native
/**
...
object MethodOptions {
  ...
  @JSImport("@google-cloud/spanner/build/protos/protos", "google.protobuf.MethodOptions.IdempotencyLevel")
  @js.native
  object IdempotencyLevel extends StObject {
    ...
    /* 0 */ val IDEMPOTENCY_UNKNOWN: typings.googleCloudSpanner.protosMod.google.protobuf.MethodOptions.IdempotencyLevel.IDEMPOTENCY_UNKNOWN & Double = js.native
    
    @js.native
    sealed trait IDEMPOTENT
      extends StObject
         with IdempotencyLevel
    /* 2 */ val IDEMPOTENT: typings.googleCloudSpanner.protosMod.google.protobuf.MethodOptions.IdempotencyLevel.IDEMPOTENT & Double = js.native
    
    @js.native
    sealed trait NO_SIDE_EFFECTS
      extends StObject
         with IdempotencyLevel
    /* 1 */ val NO_SIDE_EFFECTS: typings.googleCloudSpanner.protosMod.google.protobuf.MethodOptions.IdempotencyLevel.NO_SIDE_EFFECTS & Double = js.native
  }
