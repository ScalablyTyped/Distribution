...
trait ICreateInstanceMetadata extends StObject {
...
object ICreateInstanceMetadata {
  
  inline def apply(): ICreateInstanceMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ICreateInstanceMetadata]
  }
  
  extension [Self <: ICreateInstanceMetadata](x: Self) {
