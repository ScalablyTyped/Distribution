...
trait IBindingDelta extends StObject {
  ...
  var action: js.UndefOr[
    Action | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.iam.v1.BindingDelta.Action * / any */ String) | Null
  ] = js.undefined
...
object IBindingDelta {
  ...
  extension [Self <: IBindingDelta](x: Self) {
    ...
    inline def setAction(
      value: Action | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.iam.v1.BindingDelta.Action * / any */ String)
