...
@JSImport("@google-cloud/spanner/build/protos/protos", "google.spanner.v1.PartitionQueryRequest")
@js.native
/**
...
open class PartitionQueryRequest ()
  ...
  @JSName("paramTypes")
  var paramTypes_PartitionQueryRequest: StringDictionary[IType] = js.native
  
  /** PartitionQueryRequest session. */
  @JSName("session")
  var session_PartitionQueryRequest: String = js.native
  
  /** PartitionQueryRequest sql. */
  @JSName("sql")
  var sql_PartitionQueryRequest: String = js.native
...
object PartitionQueryRequest {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): PartitionQueryRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[PartitionQueryRequest]
  inline def create(properties: IPartitionQueryRequest): PartitionQueryRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[PartitionQueryRequest]
  
  inline def decode(reader: js.typedarray.Uint8Array): PartitionQueryRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[PartitionQueryRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): PartitionQueryRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[PartitionQueryRequest]
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): PartitionQueryRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[PartitionQueryRequest]
  inline def decode(reader: Reader, length: Double): PartitionQueryRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[PartitionQueryRequest]
  
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): PartitionQueryRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[PartitionQueryRequest]
  /**
    ...
    */
  /* static member */
  inline def decodeDelimited(reader: Reader): PartitionQueryRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[PartitionQueryRequest]
