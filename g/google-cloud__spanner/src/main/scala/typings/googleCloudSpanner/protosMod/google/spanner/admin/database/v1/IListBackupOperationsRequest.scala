...
trait IListBackupOperationsRequest extends StObject {
...
object IListBackupOperationsRequest {
  
  inline def apply(): IListBackupOperationsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IListBackupOperationsRequest]
  }
  
  extension [Self <: IListBackupOperationsRequest](x: Self) {
