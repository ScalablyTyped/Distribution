...
object codecMod {
  ...
  object codec {
    ...
    @js.native
    def Float: Instantiable1[/* value */ Double, typings.googleCloudSpanner.codecMod.Float] = js.native
    ...
    @js.native
    def Int: Instantiable1[/* value */ String, typings.googleCloudSpanner.codecMod.Int] = js.native
    ...
    @js.native
    def Numeric: Instantiable1[/* value */ String, typings.googleCloudSpanner.codecMod.Numeric] = js.native
    ...
    @js.native
    def PGNumeric: Instantiable1[/* pgValue */ String | Double, typings.googleCloudSpanner.codecMod.PGNumeric] = js.native
    ...
    def SpannerDate: Instantiable1[
        ...
        typings.googleCloudSpanner.codecMod.SpannerDate
      ] = js.native
    ...
    @js.native
    def convertMsToProtoTimestamp: js.Function1[/* ms */ Double, ITimestamp] = js.native
    inline def convertMsToProtoTimestamp(ms: Double): ITimestamp = ^.asInstanceOf[js.Dynamic].applyDynamic("convertMsToProtoTimestamp")(ms.asInstanceOf[js.Any]).asInstanceOf[ITimestamp]
    inline def convertMsToProtoTimestamp_=(x: js.Function1[/* ms */ Double, ITimestamp]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("convertMsToProtoTimestamp")(x.asInstanceOf[js.Any])
    
    @JSImport("@google-cloud/spanner/build/src/codec", "codec.convertProtoTimestampToDate")
    @js.native
    def convertProtoTimestampToDate: js.Function1[/* hasNanosSeconds */ typings.protobufjs.mod.common.ITimestamp, js.Date] = js.native
    inline def convertProtoTimestampToDate(hasNanosSeconds: typings.protobufjs.mod.common.ITimestamp): js.Date = ^.asInstanceOf[js.Dynamic].applyDynamic("convertProtoTimestampToDate")(hasNanosSeconds.asInstanceOf[js.Any]).asInstanceOf[js.Date]
    inline def convertProtoTimestampToDate_=(x: js.Function1[/* hasNanosSeconds */ typings.protobufjs.mod.common.ITimestamp, js.Date]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("convertProtoTimestampToDate")(x.asInstanceOf[js.Any])
    ...
    inline def createTypeObject(): typings.googleCloudSpanner.protosMod.google.spanner.v1.Type = ^.asInstanceOf[js.Dynamic].applyDynamic("createTypeObject")().asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.v1.Type]
    inline def createTypeObject(friendlyType: String): typings.googleCloudSpanner.protosMod.google.spanner.v1.Type = ^.asInstanceOf[js.Dynamic].applyDynamic("createTypeObject")(friendlyType.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.v1.Type]
    inline def createTypeObject(friendlyType: Type): typings.googleCloudSpanner.protosMod.google.spanner.v1.Type = ^.asInstanceOf[js.Dynamic].applyDynamic("createTypeObject")(friendlyType.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudSpanner.protosMod.google.spanner.v1.Type]
    ...
    def createTypeObject_Fcodec: js.Function1[
        ...
        typings.googleCloudSpanner.protosMod.google.spanner.v1.Type
      ] = js.native
    ...
    def decode: js.Function2[
        /* value */ Value, 
        /* type */ typings.googleCloudSpanner.protosMod.google.spanner.v1.Type, 
        Value
      ] = js.native
    inline def decode(value: Value, `type`: typings.googleCloudSpanner.protosMod.google.spanner.v1.Type): Value = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(value.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[Value]
    inline def decode_=(
      x: js.Function2[
          /* value */ Value, 
          /* type */ typings.googleCloudSpanner.protosMod.google.spanner.v1.Type, 
