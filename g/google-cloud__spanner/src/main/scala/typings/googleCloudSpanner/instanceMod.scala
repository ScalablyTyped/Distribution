...
import typings.googleCloudSpanner.backupMod.Backup
import typings.googleCloudSpanner.backupMod.CopyBackupCallback
import typings.googleCloudSpanner.backupMod.CopyBackupOptions
import typings.googleCloudSpanner.backupMod.CopyBackupResponse
...
import typings.googleCloudSpanner.sessionPoolMod.SessionPool
...
object instanceMod {
  ...
  open class Instance protected () extends StObject {
    ...
    def database(name: String, poolOptions: Unit, queryOptions: IQueryOptions): Database = js.native
    def database(name: String, poolOptions: SessionPoolConstructor): Database = js.native
    def database(name: String, poolOptions: SessionPoolConstructor, queryOptions: IQueryOptions): Database = js.native
    def database(name: String, poolOptions: SessionPoolOptions): Database = js.native
    def database(name: String, poolOptions: SessionPoolOptions, queryOptions: IQueryOptions): Database = js.native
    ...
    /**
      ...
      * ```
      */
    def getBackupsStream(): ReadableStream[Any] = js.native
    def getBackupsStream(options: GetBackupsOptions): ReadableStream[Any] = js.native
    ...
    /**
      ...
      * ```
      */
    def getDatabasesStream(): ReadableStream[Any] = js.native
    def getDatabasesStream(options: GetDatabasesOptions): ReadableStream[Any] = js.native
  ...
  type DeleteInstanceCallback = NormalCallback[IEmpty]
  
  type DeleteInstanceResponse = js.Array[IEmpty]
  
  type ExistsInstanceCallback = NormalCallback[Boolean]
  
  type ExistsInstanceResponse = js.Array[Boolean]
  
  type GetBackupOperationsCallback = RequestCallback[IOperation, IListBackupOperationsResponse]
  
  type GetBackupOperationsOptions = PagedOptionsWithFilter
  
  type GetBackupOperationsResponse = PagedResponse[IOperation, IListBackupOperationsResponse]
  
  type GetBackupsCallback = RequestCallback[Backup, IListBackupsResponse]
  
  type GetBackupsOptions = PagedOptionsWithFilter
  
  type GetBackupsResponse = PagedResponse[Backup, IListBackupsResponse]
  
  type GetDatabaseOperationsCallback = RequestCallback[IOperation, IListDatabaseOperationsResponse]
  
  type GetDatabaseOperationsOptions = PagedOptionsWithFilter
  
  type GetDatabaseOperationsResponse = PagedResponse[IOperation, IListDatabaseOperationsResponse]
  
  type GetDatabasesCallback = RequestCallback[Database, IListDatabasesResponse]
  
  type GetDatabasesOptions = PagedOptions
  
  type GetDatabasesResponse = PagedResponse[Database, IListDatabasesResponse]
  
  type GetInstanceCallback = ResourceCallback[Instance, IInstance]
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.googleCloudSpanner.instanceMod.GetInstanceMetadataOptions because var conflicts: gaxOptions. Inlined fieldNames */ trait GetInstanceConfig
    extends StObject
       with GetConfig
  ...
  type IBackup = typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.IBackup
  
  type IDatabase = typings.googleCloudSpanner.protosMod.google.spanner.admin.database.v1.IDatabase
  
  type IInstance = typings.googleCloudSpanner.protosMod.google.spanner.admin.instance.v1.IInstance
