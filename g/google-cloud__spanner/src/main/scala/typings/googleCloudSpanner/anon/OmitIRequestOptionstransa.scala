...
/* Inlined std.Omit<@google-cloud/spanner.@google-cloud/spanner/build/protos/protos.google.spanner.v1.IRequestOptions, 'transactionTag'> */
trait OmitIRequestOptionstransa extends StObject {
...
object OmitIRequestOptionstransa {
  
  inline def apply(): OmitIRequestOptionstransa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitIRequestOptionstransa]
  }
  
  extension [Self <: OmitIRequestOptionstransa](x: Self) {
