...
import typings.googleCloudSpanner.databaseMod.UpdateSchemaCallback
import typings.googleCloudSpanner.databaseMod.UpdateSchemaResponse
...
import typings.googleCloudSpanner.transactionMod.CommitCallback
import typings.googleCloudSpanner.transactionMod.CommitOptions
import typings.googleCloudSpanner.transactionMod.CommitResponse
import typings.googleCloudSpanner.transactionMod.ReadCallback
import typings.googleCloudSpanner.transactionMod.ReadRequest
import typings.googleCloudSpanner.transactionMod.ReadResponse
...
object tableMod {
  ...
  type CreateTableResponse = js.Tuple3[Table, Operation_, IOperation]
