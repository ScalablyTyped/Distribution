...
import typings.googleCloudCommon.buildSrcServiceObjectMod.ExistsCallback
import typings.googleCloudCommon.buildSrcServiceObjectMod.GetConfig
import typings.googleCloudSpanner.anon.RestoreInfo
import typings.googleCloudSpanner.buildSrcBatchTransactionMod.BatchTransaction
import typings.googleCloudSpanner.buildSrcBatchTransactionMod.TransactionIdentifier
...
import typings.googleCloudSpanner.buildSrcSessionPoolMod.SessionPoolInterface
import typings.googleCloudSpanner.buildSrcSessionPoolMod.SessionPoolOptions
import typings.googleCloudSpanner.buildSrcTableMod.CreateTableCallback
import typings.googleCloudSpanner.buildSrcTableMod.CreateTableResponse
import typings.googleCloudSpanner.buildSrcTableMod.Table
import typings.googleCloudSpanner.buildSrcTransactionMod.ExecuteSqlRequest
import typings.googleCloudSpanner.buildSrcTransactionMod.RunCallback
import typings.googleCloudSpanner.buildSrcTransactionMod.RunResponse
import typings.googleCloudSpanner.buildSrcTransactionMod.RunUpdateCallback
...
import typings.googleCloudSpanner.buildSrcTransactionRunnerMod.AsyncRunTransactionCallback
import typings.googleCloudSpanner.buildSrcTransactionRunnerMod.RunTransactionCallback
import typings.googleCloudSpanner.buildSrcTransactionRunnerMod.RunTransactionOptions
import typings.googleCloudSpanner.googleCloudSpannerStrings.restoreInfo
import typings.googleCloudSpanner.googleCloudSpannerStrings.sourceType
...
object buildSrcDatabaseMod {
  ...
  open class Database protected () extends StObject {
    ...
    /**
      ...
      * ```
      */
    def getSessionsStream(): ReadableStream = js.native
    def getSessionsStream(options: GetSessionsOptions): ReadableStream = js.native
    ...
    var queryOptions_ : js.UndefOr[
        /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify spannerClient.spanner.v1.ExecuteSqlRequest.IQueryOptions */ Any
      ] = js.native
  ...
  /* import warning: RemoveDifficultInheritance.summarizeChanges 
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify databaseAdmin.spanner.admin.database.v1.IGetDatabaseRequest * / any */ trait GetDatabaseConfig
    extends StObject
       with GetConfig {
  ...
  type GetSchemaCallback = RequestCallback[
    String, 
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify databaseAdmin.spanner.admin.database.v1.IGetDatabaseDdlResponse */ Any
  ]
  
  type GetSchemaResponse = js.Tuple2[
    js.Array[String], 
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify databaseAdmin.spanner.admin.database.v1.IGetDatabaseDdlResponse */ Any
  ]
  ...
  type GetSessionsCallback = RequestCallback[
    Session, 
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify google.spanner.v1.IListSessionsResponse */ Any
  ]
  ...
  type IDatabaseTranslatedEnum = (Omit[
    TranslateEnumKeys[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify databaseAdmin.spanner.admin.database.v1.IDatabase */ Any, 
      state, 
      /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof databaseAdmin.spanner.admin.database.v1.Database.State */ Any
    ], 
    restoreInfo
  ...
  type IRestoreInfoTranslatedEnum = TranslateEnumKeys[
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify databaseAdmin.spanner.admin.database.v1.IRestoreInfo */ Any, 
    sourceType, 
  ...
  trait RestoreOptions extends StObject {
    ...
    var encryptionConfig: js.UndefOr[
        /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify databaseAdmin.spanner.admin.database.v1.IRestoreDatabaseEncryptionConfig */ Any
      ] = js.undefined
  ...
  type UpdateSchemaResponse = js.Tuple2[
    Operation_, 
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify databaseAdmin.longrunning.IOperation */ Any
  ]
}
