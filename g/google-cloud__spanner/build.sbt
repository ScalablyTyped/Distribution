...
version := "6.1.4-45bd74"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "big_dot_js" % "6.1-dt-20220913Z-7d6718",
  ...
  "org.scalablytyped" %%% "google-cloud__common" % "4.0.2-d65360",
  ...
  "org.scalablytyped" %%% "stack-trace" % "0.0-unknown-dt-20221103Z-e5fae4",
