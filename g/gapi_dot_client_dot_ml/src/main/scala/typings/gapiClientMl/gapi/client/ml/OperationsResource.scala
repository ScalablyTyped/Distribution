...
import typings.gapiClientMl.anon.Filter
...
object OperationsResource {
  ...
  implicit class OperationsResourceOps[Self <: OperationsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setList(value: Filter => Request[GoogleLongrunningListOperationsResponse]): Self = this.set("list", js.Any.fromFunction1(value))
  }
