...
trait GoogleIamV1__Binding extends js.Object {
  /**
    ...
    */
  var condition: js.UndefOr[GoogleType__Expr] = js.undefined
  /**
...
object GoogleIamV1__Binding {
  @scala.inline
  def apply(condition: GoogleType__Expr = null, members: js.Array[String] = null, role: String = null): GoogleIamV1__Binding = {
