...
trait JsonSchema extends js.Object {
  ...
  {[ P in string ]: gapi.client.discovery.gapi.client.discovery.JsonSchema}
    */ typings.gapiClientDiscovery.gapiClientDiscoveryStrings.JsonSchema with TopLevel[js.Any]
  ] = js.undefined
  /**
...
object JsonSchema {
  ...
  {[ P in string ]: gapi.client.discovery.gapi.client.discovery.JsonSchema}
    */ typings.gapiClientDiscovery.gapiClientDiscoveryStrings.JsonSchema with TopLevel[js.Any] = null,
