...
import typings.gapiClientDiscovery.AnonAltFields
...
trait ApisResource extends js.Object {
  ...
  def list(request: AnonAltFields): Request_[DirectoryList]
}

object ApisResource {
  @scala.inline
  def apply(getRest: AnonAlt => Request_[RestDescription], list: AnonAltFields => Request_[DirectoryList]): ApisResource = {
