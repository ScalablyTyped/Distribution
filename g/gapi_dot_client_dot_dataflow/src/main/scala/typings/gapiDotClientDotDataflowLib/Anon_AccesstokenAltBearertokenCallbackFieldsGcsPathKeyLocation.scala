...
trait Anon_AccesstokenAltBearertokenCallbackFieldsGcsPathKeyLocation extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackFieldsGcsPathKeyLocation {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackFieldsGcsPathKeyLocation = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackFieldsGcsPathKeyLocation]
  }
}
