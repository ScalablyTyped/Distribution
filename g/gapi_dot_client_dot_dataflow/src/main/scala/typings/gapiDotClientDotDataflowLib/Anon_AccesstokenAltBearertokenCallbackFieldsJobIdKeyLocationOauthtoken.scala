...
trait Anon_AccesstokenAltBearertokenCallbackFieldsJobIdKeyLocationOauthtoken extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackFieldsJobIdKeyLocationOauthtoken {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackFieldsJobIdKeyLocationOauthtoken = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackFieldsJobIdKeyLocationOauthtoken]
  }
}
