...
trait WorkItemsResource extends js.Object {
  ...
  /** Leases a dataflow WorkItem to run. */
  def lease(request: gapiDotClientDotDataflowLib.Anon_AccesstokenLocation): gapiDotClientLib.gapiNs.clientNs.Request[LeaseWorkItemResponse] = js.native
  ...
  /** Reports the status of dataflow WorkItems leased by a worker. */
  def reportStatus(request: gapiDotClientDotDataflowLib.Anon_AccesstokenLocation): gapiDotClientLib.gapiNs.clientNs.Request[ReportWorkItemStatusResponse] = js.native
}
