...
trait LocationsResource extends js.Object {
  ...
  def workerMessages(request: AnonAccesstokenAltBearertokenCallbackFieldsKeyLocationOauthtoken): Request_[SendWorkerMessagesResponse]
}
...
object LocationsResource {
  ...
  def apply(
    ...
    workerMessages: AnonAccesstokenAltBearertokenCallbackFieldsKeyLocationOauthtoken => Request_[SendWorkerMessagesResponse]
  ): LocationsResource = {
