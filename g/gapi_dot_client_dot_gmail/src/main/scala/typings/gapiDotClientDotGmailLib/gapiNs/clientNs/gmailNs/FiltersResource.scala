...
trait FiltersResource extends js.Object {
  ...
  /** Gets a filter. */
  def get(request: gapiDotClientDotGmailLib.Anon_PrettyPrintQuotaUserKeyUserIp): gapiDotClientLib.gapiNs.clientNs.Request[Filter]
  /** Lists the message filters of a Gmail user. */
  def list(request: gapiDotClientDotGmailLib.Anon_PrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[ListFiltersResponse]
}
