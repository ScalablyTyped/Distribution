...
@js.native
trait IncludeSpamTrash extends js.Object {
...
object IncludeSpamTrash {
  @scala.inline
  def apply(userId: String): IncludeSpamTrash = {
    val __obj = js.Dynamic.literal(userId = userId.asInstanceOf[js.Any])
    __obj.asInstanceOf[IncludeSpamTrash]
  }
  @scala.inline
  implicit class IncludeSpamTrashOps[Self <: IncludeSpamTrash] (val x: Self) extends AnyVal {
    @scala.inline
