...
trait AnonAltFieldsIncludeSpamTrash extends js.Object {
...
object AnonAltFieldsIncludeSpamTrash {
  @scala.inline
  def apply(
    userId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltFieldsIncludeSpamTrash]
  }
}
