...
trait AnonAltFieldsIncludeSpamTrashKey extends js.Object {
...
object AnonAltFieldsIncludeSpamTrashKey {
  @scala.inline
  def apply(
    userId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsIncludeSpamTrashKey = {
    ...
    __obj.asInstanceOf[AnonAltFieldsIncludeSpamTrashKey]
  }
}
