package typings.gapiDotClientDotServicecontrol.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typings.gapiDotClientDotServicecontrol.gapiDotClientDotServicecontrolStrings.servicecontrol,
    version: v1
