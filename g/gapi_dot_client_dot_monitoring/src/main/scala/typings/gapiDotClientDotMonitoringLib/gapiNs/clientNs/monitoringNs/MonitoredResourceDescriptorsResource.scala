...
trait MonitoredResourceDescriptorsResource extends js.Object {
  ...
  def list(request: gapiDotClientDotMonitoringLib.Anon_NameAccesstokenPageSizePrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[ListMonitoredResourceDescriptorsResponse]
}
