...
trait MetricDescriptorsResource extends js.Object {
  ...
  def get(request: gapiDotClientDotMonitoringLib.Anon_NameAccesstoken): gapiDotClientLib.gapiNs.clientNs.Request[MetricDescriptor]
  /** Lists metric descriptors that match a filter. This method does not require a Stackdriver account. */
  def list(request: gapiDotClientDotMonitoringLib.Anon_NameAccesstokenPageSizePrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[ListMetricDescriptorsResponse]
}
