...
import typings.gradientParser.gradientParserStrings.circle
import typings.gradientParser.gradientParserStrings.ellipse
import typings.gradientParser.gradientParserStrings.shape
