...
object mod {
  ...
  object IInfoWindowProps {
    ...
    implicit class IInfoWindowPropsMutableBuilder[Self <: IInfoWindowProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMap(value: typings.googlemaps.google.maps.Map[Element]): Self = StObject.set(x, "map", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMarker(value: typings.googlemaps.google.maps.Marker): Self = StObject.set(x, "marker", value.asInstanceOf[js.Any])
  ...
  object IMarkerProps {
    ...
    implicit class IMarkerPropsMutableBuilder[Self <: IMarkerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMap(value: typings.googlemaps.google.maps.Map[Element] | StreetViewPanorama): Self = StObject.set(x, "map", value.asInstanceOf[js.Any])
