...
trait Anon_AltEnterpriseIdEntitlementId extends js.Object {
...
object Anon_AltEnterpriseIdEntitlementId {
  @scala.inline
  def apply(
  ...
  ): Anon_AltEnterpriseIdEntitlementId = {
    ...
    __obj.asInstanceOf[Anon_AltEnterpriseIdEntitlementId]
  }
}
