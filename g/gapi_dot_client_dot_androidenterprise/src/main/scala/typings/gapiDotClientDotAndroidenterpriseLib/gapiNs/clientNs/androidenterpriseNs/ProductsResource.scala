...
trait ProductsResource extends js.Object {
  /**
               ...
               */
  def approve(
    request: gapiDotClientDotAndroidenterpriseLib.Anon_EnterpriseIdPrettyPrintQuotaUserKeyUserIpOauthtokenAltFields
  ...
  /**
               ...
               */
  def generateApprovalUrl(request: gapiDotClientDotAndroidenterpriseLib.Anon_EnterpriseIdPrettyPrintLanguageCode): gapiDotClientLib.gapiNs.clientNs.Request[ProductsGenerateApprovalUrlResponse]
  /** Retrieves details of a product for display to an enterprise admin. */
  def get(
    request: gapiDotClientDotAndroidenterpriseLib.Anon_EnterpriseIdPrettyPrintQuotaUserKeyUserIpOauthtokenLanguage
  ...
  def list(request: gapiDotClientDotAndroidenterpriseLib.Anon_EnterpriseIdMaxResults): gapiDotClientLib.gapiNs.clientNs.Request[ProductsListResponse]
