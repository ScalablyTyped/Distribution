...
trait UsersResource extends js.Object {
  ...
  def delete(request: gapiDotClientDotAndroidenterpriseLib.Anon_AltEnterpriseId): gapiDotClientLib.gapiNs.clientNs.Request[scala.Unit]
  /**
    ...
    */
  def generateAuthenticationToken(request: gapiDotClientDotAndroidenterpriseLib.Anon_AltEnterpriseId): gapiDotClientLib.gapiNs.clientNs.Request[AuthenticationToken]
  /**
    ...
    */
  def generateToken(request: gapiDotClientDotAndroidenterpriseLib.Anon_AltEnterpriseId): gapiDotClientLib.gapiNs.clientNs.Request[UserToken]
  /** Retrieves a user's details. */
  def get(request: gapiDotClientDotAndroidenterpriseLib.Anon_AltEnterpriseId): gapiDotClientLib.gapiNs.clientNs.Request[User]
  /** Retrieves the set of products a user is entitled to access. */
  def getAvailableProductSet(request: gapiDotClientDotAndroidenterpriseLib.Anon_AltEnterpriseId): gapiDotClientLib.gapiNs.clientNs.Request[ProductSet]
  /**
    ...
    */
  def insert(request: gapiDotClientDotAndroidenterpriseLib.Anon_AltEnterpriseIdFields): gapiDotClientLib.gapiNs.clientNs.Request[User]
  /**
    ...
    */
  def list(request: gapiDotClientDotAndroidenterpriseLib.Anon_AltEmail): gapiDotClientLib.gapiNs.clientNs.Request[UsersListResponse]
  /**
    ...
    */
  def patch(request: gapiDotClientDotAndroidenterpriseLib.Anon_AltEnterpriseId): gapiDotClientLib.gapiNs.clientNs.Request[User]
  /** Revokes a previously generated token (activation code) for the user. */
  def revokeToken(request: gapiDotClientDotAndroidenterpriseLib.Anon_AltEnterpriseId): gapiDotClientLib.gapiNs.clientNs.Request[scala.Unit]
  /**
    ...
    */
  def setAvailableProductSet(request: gapiDotClientDotAndroidenterpriseLib.Anon_AltEnterpriseId): gapiDotClientLib.gapiNs.clientNs.Request[ProductSet]
  /**
    * Updates the details of an EMM-managed user.
    *
    * Can be used with EMM-managed users only (not Google managed users). Pass the new details in the Users resource in the request body. Only the
