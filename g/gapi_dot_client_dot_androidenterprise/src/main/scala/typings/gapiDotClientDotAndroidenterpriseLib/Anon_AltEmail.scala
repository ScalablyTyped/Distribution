...
trait Anon_AltEmail extends js.Object {
...
object Anon_AltEmail {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(email = email, enterpriseId = enterpriseId)
    ...
    __obj.asInstanceOf[Anon_AltEmail]
  }
}
