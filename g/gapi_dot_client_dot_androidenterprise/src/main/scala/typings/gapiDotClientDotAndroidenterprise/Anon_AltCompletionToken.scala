...
trait Anon_AltCompletionToken extends js.Object {
...
object Anon_AltCompletionToken {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): Anon_AltCompletionToken = {
    val __obj = js.Dynamic.literal()
    if (alt != null) __obj.updateDynamic("alt")(alt)
    if (completionToken != null) __obj.updateDynamic("completionToken")(completionToken)
    if (enterpriseToken != null) __obj.updateDynamic("enterpriseToken")(enterpriseToken)
    ...
    __obj.asInstanceOf[Anon_AltCompletionToken]
  }
}
