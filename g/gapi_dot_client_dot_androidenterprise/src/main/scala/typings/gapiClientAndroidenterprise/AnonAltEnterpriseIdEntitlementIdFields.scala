...
trait AnonAltEnterpriseIdEntitlementIdFields extends js.Object {
...
object AnonAltEnterpriseIdEntitlementIdFields {
  @scala.inline
  def apply(
    enterpriseId: String,
    ...
    userIp: String = null
  ): AnonAltEnterpriseIdEntitlementIdFields = {
    ...
    __obj.asInstanceOf[AnonAltEnterpriseIdEntitlementIdFields]
  }
}
