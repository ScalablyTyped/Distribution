...
trait AnonAltEnterpriseIdEntitlementId extends js.Object {
...
object AnonAltEnterpriseIdEntitlementId {
  @scala.inline
  def apply(
    enterpriseId: String,
    ...
    userIp: String = null
  ): AnonAltEnterpriseIdEntitlementId = {
    ...
    __obj.asInstanceOf[AnonAltEnterpriseIdEntitlementId]
  }
}
