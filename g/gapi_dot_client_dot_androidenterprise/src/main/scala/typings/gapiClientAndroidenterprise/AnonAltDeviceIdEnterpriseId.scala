...
trait AnonAltDeviceIdEnterpriseId extends js.Object {
...
object AnonAltDeviceIdEnterpriseId {
  @scala.inline
  def apply(
    deviceId: String,
    enterpriseId: String,
    ...
    __obj.asInstanceOf[AnonAltDeviceIdEnterpriseId]
  }
}
