...
@js.native
trait ClusterId extends js.Object {
...
object ClusterId {
  @scala.inline
  def apply(clusterId: String, enterpriseId: String, pageId: String): ClusterId = {
    val __obj = js.Dynamic.literal(clusterId = clusterId.asInstanceOf[js.Any], enterpriseId = enterpriseId.asInstanceOf[js.Any], pageId = pageId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClusterId]
  }
  @scala.inline
  implicit class ClusterIdOps[Self <: ClusterId] (val x: Self) extends AnyVal {
    @scala.inline
