...
trait UsersResource extends js.Object {
  ...
  def delete(request: EnterpriseId): Request[Unit]
  /**
    ...
    */
  def generateAuthenticationToken(request: EnterpriseId): Request[AuthenticationToken]
  /**
    ...
    */
  def generateToken(request: EnterpriseId): Request[UserToken]
  /** Retrieves a user's details. */
  def get(request: EnterpriseId): Request[User]
  /** Retrieves the set of products a user is entitled to access. */
  def getAvailableProductSet(request: EnterpriseId): Request[ProductSet]
  /**
    ...
    */
  def insert(request: Key): Request[User]
  /**
    ...
    */
  def list(request: Email): Request[UsersListResponse]
  /**
    ...
    */
  def patch(request: EnterpriseId): Request[User]
  /** Revokes a previously generated token (activation code) for the user. */
  def revokeToken(request: EnterpriseId): Request[Unit]
  /**
    ...
    */
  def setAvailableProductSet(request: EnterpriseId): Request[ProductSet]
  /**
    * Updates the details of an EMM-managed user.
    *
    * Can be used with EMM-managed users only (not Google managed users). Pass the new details in the Users resource in the request body. Only the
    ...
    */
  def update(request: EnterpriseId): Request[User]
}
