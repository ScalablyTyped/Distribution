...
import typings.gapiClientAndroidenterprise.AnonAltEmail
...
trait UsersResource extends js.Object {
  ...
  def delete(request: AnonAltEnterpriseId): Request_[Unit]
  /**
    ...
    */
  def generateAuthenticationToken(request: AnonAltEnterpriseId): Request_[AuthenticationToken]
  /**
    ...
    */
  def generateToken(request: AnonAltEnterpriseId): Request_[UserToken]
  /** Retrieves a user's details. */
  def get(request: AnonAltEnterpriseId): Request_[User]
  /** Retrieves the set of products a user is entitled to access. */
  def getAvailableProductSet(request: AnonAltEnterpriseId): Request_[ProductSet]
  /**
    ...
    */
  def insert(request: AnonAltEnterpriseIdFields): Request_[User]
  /**
    ...
    */
  def list(request: AnonAltEmail): Request_[UsersListResponse]
  /**
    ...
    */
  def patch(request: AnonAltEnterpriseId): Request_[User]
  /** Revokes a previously generated token (activation code) for the user. */
  def revokeToken(request: AnonAltEnterpriseId): Request_[Unit]
  /**
    ...
    */
  def setAvailableProductSet(request: AnonAltEnterpriseId): Request_[ProductSet]
  /**
    * Updates the details of an EMM-managed user.
    *
    * Can be used with EMM-managed users only (not Google managed users). Pass the new details in the Users resource in the request body. Only the
    ...
    */
  def update(request: AnonAltEnterpriseId): Request_[User]
}

object UsersResource {
  @scala.inline
  def apply(
    delete: AnonAltEnterpriseId => Request_[Unit],
    generateAuthenticationToken: AnonAltEnterpriseId => Request_[AuthenticationToken],
    generateToken: AnonAltEnterpriseId => Request_[UserToken],
    get: AnonAltEnterpriseId => Request_[User],
    getAvailableProductSet: AnonAltEnterpriseId => Request_[ProductSet],
    insert: AnonAltEnterpriseIdFields => Request_[User],
    list: AnonAltEmail => Request_[UsersListResponse],
    patch: AnonAltEnterpriseId => Request_[User],
    revokeToken: AnonAltEnterpriseId => Request_[Unit],
    setAvailableProductSet: AnonAltEnterpriseId => Request_[ProductSet],
    update: AnonAltEnterpriseId => Request_[User]
  ): UsersResource = {
