...
import typings.gapiClientAndroidenterprise.AnonAltCallbackUrl
import typings.gapiClientAndroidenterprise.AnonAltCompletionToken
import typings.gapiClientAndroidenterprise.AnonAltDomain
import typings.gapiClientAndroidenterprise.AnonAltEnterpriseIdFields
import typings.gapiClientAndroidenterprise.AnonAltEnterpriseIdFieldsKey
import typings.gapiClientAndroidenterprise.AnonAltFields
import typings.gapiClientAndroidenterprise.AnonAltFieldsKey
import typings.gapiClientAndroidenterprise.AnonAltFieldsKeyOauthtoken
...
trait EnterprisesResource extends js.Object {
  ...
  def acknowledgeNotificationSet(request: AnonAltFields): Request_[Unit]
  /**
    ...
    * Enterprise Token.
    */
  def completeSignup(request: AnonAltCompletionToken): Request_[Enterprise]
  /**
    ...
    */
  def createWebToken(request: AnonAltEnterpriseIdFields): Request_[AdministratorWebToken]
  /**
    ...
    */
  def delete(request: AnonAltEnterpriseIdFields): Request_[Unit]
  /** Enrolls an enterprise with the calling EMM. */
  def enroll(request: AnonAltFieldsKey): Request_[Enterprise]
  /** Generates a sign-up URL. */
  def generateSignupUrl(request: AnonAltCallbackUrl): Request_[SignupInfo]
  /** Retrieves the name and domain of an enterprise. */
  def get(request: AnonAltEnterpriseIdFields): Request_[Enterprise]
  /** Returns the Android Device Policy config resource. */
  def getAndroidDevicePolicyConfig(request: AnonAltEnterpriseIdFields): Request_[AndroidDevicePolicyConfig]
  /**
    ...
    */
  def getServiceAccount(request: AnonAltEnterpriseIdFieldsKey): Request_[ServiceAccount]
  /** Returns the store layout for the enterprise. If the store layout has not been set, returns "basic" as the store layout type and no homepage. */
  def getStoreLayout(request: AnonAltEnterpriseIdFields): Request_[StoreLayout]
  /** Establishes the binding between the EMM and an enterprise. This is now deprecated; use enroll instead. */
  def insert(request: AnonAltFieldsKey): Request_[Enterprise]
  /**
    ...
    */
  def list(request: AnonAltDomain): Request_[EnterprisesListResponse]
  /**
    ...
    */
  def pullNotificationSet(request: AnonAltFieldsKeyOauthtoken): Request_[NotificationSet]
  /** Sends a test notification to validate the EMM integration with the Google Cloud Pub/Sub service for this enterprise. */
  def sendTestPushNotification(request: AnonAltEnterpriseIdFields): Request_[EnterprisesSendTestPushNotificationResponse]
  /** Sets the account that will be used to authenticate to the API as the enterprise. */
  def setAccount(request: AnonAltEnterpriseIdFields): Request_[EnterpriseAccount]
  /**
    ...
    */
  def setAndroidDevicePolicyConfig(request: AnonAltEnterpriseIdFields): Request_[AndroidDevicePolicyConfig]
  /**
    ...
    */
  def setStoreLayout(request: AnonAltEnterpriseIdFields): Request_[StoreLayout]
  /** Unenrolls an enterprise from the calling EMM. */
  def unenroll(request: AnonAltEnterpriseIdFields): Request_[Unit]
}

object EnterprisesResource {
  @scala.inline
  def apply(
    acknowledgeNotificationSet: AnonAltFields => Request_[Unit],
    completeSignup: AnonAltCompletionToken => Request_[Enterprise],
    createWebToken: AnonAltEnterpriseIdFields => Request_[AdministratorWebToken],
    delete: AnonAltEnterpriseIdFields => Request_[Unit],
    enroll: AnonAltFieldsKey => Request_[Enterprise],
    generateSignupUrl: AnonAltCallbackUrl => Request_[SignupInfo],
    get: AnonAltEnterpriseIdFields => Request_[Enterprise],
    getAndroidDevicePolicyConfig: AnonAltEnterpriseIdFields => Request_[AndroidDevicePolicyConfig],
    getServiceAccount: AnonAltEnterpriseIdFieldsKey => Request_[ServiceAccount],
    getStoreLayout: AnonAltEnterpriseIdFields => Request_[StoreLayout],
    insert: AnonAltFieldsKey => Request_[Enterprise],
    list: AnonAltDomain => Request_[EnterprisesListResponse],
    pullNotificationSet: AnonAltFieldsKeyOauthtoken => Request_[NotificationSet],
    sendTestPushNotification: AnonAltEnterpriseIdFields => Request_[EnterprisesSendTestPushNotificationResponse],
    setAccount: AnonAltEnterpriseIdFields => Request_[EnterpriseAccount],
    setAndroidDevicePolicyConfig: AnonAltEnterpriseIdFields => Request_[AndroidDevicePolicyConfig],
    setStoreLayout: AnonAltEnterpriseIdFields => Request_[StoreLayout],
    unenroll: AnonAltEnterpriseIdFields => Request_[Unit]
  ): EnterprisesResource = {
