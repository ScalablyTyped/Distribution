...
trait Anon_AccesstokenAltBearertokenCallbackCurrentDocumentexists extends js.Object {
  ...
  /**
    ...
    * path syntax reference.
    */
  var `updateMask.fieldPaths`: js.UndefOr[String] = js.undefined
...
object Anon_AccesstokenAltBearertokenCallbackCurrentDocumentexists {
  ...
  def apply(
    ...
    `updateMask.fieldPaths`: String = null,
    ...
    if (!js.isUndefined(`currentDocument.exists`)) __obj.updateDynamic("currentDocument.exists")(`currentDocument.exists`.asInstanceOf[js.Any])
    if (`currentDocument.updateTime` != null) __obj.updateDynamic("currentDocument.updateTime")(`currentDocument.updateTime`.asInstanceOf[js.Any])
    ...
    if (`updateMask.fieldPaths` != null) __obj.updateDynamic("updateMask.fieldPaths")(`updateMask.fieldPaths`.asInstanceOf[js.Any])
