...
@js.native
trait CurrentDocumentexists extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object CurrentDocumentexists {
  @scala.inline
  def apply(name: String): CurrentDocumentexists = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[CurrentDocumentexists]
  }
  @scala.inline
  implicit class CurrentDocumentexistsOps[Self <: CurrentDocumentexists] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUpdateMaskDotfieldPaths(value: String): Self = this.set("updateMask.fieldPaths", value.asInstanceOf[js.Any])
    @scala.inline
