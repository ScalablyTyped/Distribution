...
class FileDescriptorProto ()
  ...
  def addDependency(value: java.lang.String): java.lang.String = js.native
  def addDependency(value: java.lang.String, index: scala.Double): java.lang.String = js.native
  ...
  def addMessageType(value: DescriptorProto, index: scala.Double): DescriptorProto = js.native
  def addPublicDependency(value: scala.Double): scala.Double = js.native
  def addPublicDependency(value: scala.Double, index: scala.Double): scala.Double = js.native
  ...
  def addService(value: ServiceDescriptorProto, index: scala.Double): ServiceDescriptorProto = js.native
  def addWeakDependency(value: scala.Double): scala.Double = js.native
  def addWeakDependency(value: scala.Double, index: scala.Double): scala.Double = js.native
  ...
  def getPackage(): js.UndefOr[java.lang.String] = js.native
  ...
  def getSyntax(): js.UndefOr[java.lang.String] = js.native
