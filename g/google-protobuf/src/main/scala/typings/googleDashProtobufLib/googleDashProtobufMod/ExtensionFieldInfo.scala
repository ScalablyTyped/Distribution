...
class ExtensionFieldInfo[T] protected () extends js.Object {
  def this(fieldIndex: scala.Double, fieldName: org.scalablytyped.runtime.StringDictionary[scala.Double], ctor: org.scalablytyped.runtime.Instantiable0[Message], toObjectFn: googleDashProtobufLib.googleDashProtobufMod.MessageNs.StaticToObject, isRepeated: scala.Double) = this()
  var ctor: org.scalablytyped.runtime.Instantiable0[Message] = js.native
