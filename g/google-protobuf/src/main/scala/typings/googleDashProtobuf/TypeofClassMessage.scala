...
@js.native
trait TypeofClassMessage extends Instantiable0[Message] {
  ...
  def addToRepeatedWrapperField[T /* <: Message */](msg: Message, fieldNumber: Double, value: T, ctor: Anon_T[T]): T = js.native
  def addToRepeatedWrapperField[T /* <: Message */](msg: Message, fieldNumber: Double, value: T, ctor: Anon_T[T], index: Double): T = js.native
  def addToRepeatedWrapperField[T /* <: Message */](msg: Message, fieldNumber: Double, value: js.UndefOr[scala.Nothing], ctor: Anon_T[T]): T = js.native
  ...
  def getRepeatedWrapperField[T /* <: Message */](msg: Message, ctor: Anon_T[T], fieldNumber: Double): js.Array[T] = js.native
  def getWrapperField[T /* <: Message */](msg: Message, ctor: Anon_T[T], fieldNumber: Double): T = js.native
  def getWrapperField[T /* <: Message */](msg: Message, ctor: Anon_T[T], fieldNumber: Double, required: Double): T = js.native
