...
import typings.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FieldOptions.CType
import typings.googleDashProtobuf.googleProtobufDescriptorUnderscorePbMod.FieldOptions.JSType
