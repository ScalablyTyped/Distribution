...
import typings.googleDashProtobuf.googleProtobufTypeUnderscorePbMod.Field.Cardinality
import typings.googleDashProtobuf.googleProtobufTypeUnderscorePbMod.Field.Kind
