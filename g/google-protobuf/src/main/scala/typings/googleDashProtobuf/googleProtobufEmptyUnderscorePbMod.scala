...
import typings.googleDashProtobuf.googleProtobufEmptyUnderscorePbMod.Empty
import typings.googleDashProtobuf.googleProtobufEmptyUnderscorePbMod.Empty.AsObject
