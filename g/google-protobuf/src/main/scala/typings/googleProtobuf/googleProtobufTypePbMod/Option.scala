...
import typings.googleProtobuf.googleProtobufAnyPbMod.Any
...
object Option {
  ...
  trait AsObject extends StObject {
    ...
    var value: js.UndefOr[typings.googleProtobuf.googleProtobufAnyPbMod.Any.AsObject] = js.undefined
  }
  object AsObject {
    ...
    implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      inline def setValue(value: typings.googleProtobuf.googleProtobufAnyPbMod.Any.AsObject): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
