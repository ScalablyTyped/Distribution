...
object Type {
  ...
  trait AsObject extends StObject {
    ...
    var fieldsList: js.Array[typings.googleProtobuf.googleProtobufTypePbMod.Field.AsObject]
  ...
  object AsObject {
    ...
    inline def apply(
      fieldsList: js.Array[typings.googleProtobuf.googleProtobufTypePbMod.Field.AsObject],
      name: String,
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setFieldsListVarargs(value: typings.googleProtobuf.googleProtobufTypePbMod.Field.AsObject*): Self = StObject.set(x, "fieldsList", js.Array(value*))
