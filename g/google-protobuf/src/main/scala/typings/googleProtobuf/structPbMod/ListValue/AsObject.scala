...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValuesListVarargs(value: typings.googleProtobuf.structPbMod.Value.AsObject*): Self = this.set("valuesList", js.Array(value :_*))
    
    @scala.inline
    def setValuesList(value: js.Array[typings.googleProtobuf.structPbMod.Value.AsObject]): Self = this.set("valuesList", value.asInstanceOf[js.Any])
  }
}
