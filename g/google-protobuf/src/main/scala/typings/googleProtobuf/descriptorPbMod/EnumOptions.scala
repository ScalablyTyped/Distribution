...
object EnumOptions {
  ...
  inline def deserializeBinary(bytes: Uint8Array): EnumOptions = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeBinary")(bytes.asInstanceOf[js.Any]).asInstanceOf[EnumOptions]
