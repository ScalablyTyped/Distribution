...
object OneofOptions {
  ...
  inline def deserializeBinary(bytes: Uint8Array): OneofOptions = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeBinary")(bytes.asInstanceOf[js.Any]).asInstanceOf[OneofOptions]
