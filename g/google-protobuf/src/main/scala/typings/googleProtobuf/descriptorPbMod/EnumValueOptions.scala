...
object EnumValueOptions {
  ...
  inline def deserializeBinary(bytes: Uint8Array): EnumValueOptions = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeBinary")(bytes.asInstanceOf[js.Any]).asInstanceOf[EnumValueOptions]
