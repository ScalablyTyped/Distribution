...
object ServiceOptions {
  ...
  inline def deserializeBinary(bytes: Uint8Array): ServiceOptions = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeBinary")(bytes.asInstanceOf[js.Any]).asInstanceOf[ServiceOptions]
