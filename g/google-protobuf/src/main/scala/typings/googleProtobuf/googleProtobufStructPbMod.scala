...
import typings.googleProtobuf.googleProtobufStructPbMod.Value.KindCase
...
object googleProtobufStructPbMod {
  ...
  object ListValue {
    ...
    trait AsObject extends StObject {
      ...
      var valuesList: js.Array[typings.googleProtobuf.googleProtobufStructPbMod.Value.AsObject]
    }
    object AsObject {
      
      inline def apply(valuesList: js.Array[typings.googleProtobuf.googleProtobufStructPbMod.Value.AsObject]): AsObject = {
      ...
      implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        inline def setValuesListVarargs(value: typings.googleProtobuf.googleProtobufStructPbMod.Value.AsObject*): Self = StObject.set(x, "valuesList", js.Array(value*))
      }
    }
  }
  ...
  object NullValue extends StObject {
    ...
    sealed trait NULL_VALUE
      extends StObject
         with NullValue
    /* 0 */ val NULL_VALUE: typings.googleProtobuf.googleProtobufStructPbMod.NullValue.NULL_VALUE & Double = js.native
  }
  ...
  object Struct {
    ...
    trait AsObject extends StObject {
      ...
      var fieldsMap: js.Array[
            js.Tuple2[String, typings.googleProtobuf.googleProtobufStructPbMod.Value.AsObject]
          ]
    }
    object AsObject {
      ...
      implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        ): Self = StObject.set(x, "fieldsMap", value.asInstanceOf[js.Any])
        
        inline def setFieldsMapVarargs(value: (js.Tuple2[String, typings.googleProtobuf.googleProtobufStructPbMod.Value.AsObject])*): Self = StObject.set(x, "fieldsMap", js.Array(value*))
      }
    }
  }
  ...
  object Value {
    ...
    object KindCase extends StObject {
      ...
      sealed trait BOOL_VALUE
        extends StObject
           with KindCase
      /* 4 */ val BOOL_VALUE: typings.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.BOOL_VALUE & Double = js.native
      
      @js.native
      sealed trait KIND_NOT_SET
        extends StObject
           with KindCase
      /* 0 */ val KIND_NOT_SET: typings.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.KIND_NOT_SET & Double = js.native
      
      @js.native
      sealed trait LIST_VALUE
        extends StObject
           with KindCase
      /* 6 */ val LIST_VALUE: typings.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.LIST_VALUE & Double = js.native
      
      @js.native
      sealed trait NULL_VALUE
        extends StObject
           with KindCase
      /* 1 */ val NULL_VALUE: typings.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.NULL_VALUE & Double = js.native
      
      @js.native
      sealed trait NUMBER_VALUE
        extends StObject
           with KindCase
      /* 2 */ val NUMBER_VALUE: typings.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.NUMBER_VALUE & Double = js.native
      
      @js.native
      sealed trait STRING_VALUE
        extends StObject
           with KindCase
      /* 3 */ val STRING_VALUE: typings.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.STRING_VALUE & Double = js.native
      
      @js.native
      sealed trait STRUCT_VALUE
        extends StObject
           with KindCase
      /* 5 */ val STRUCT_VALUE: typings.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.STRUCT_VALUE & Double = js.native
    }
    ...
    trait AsObject extends StObject {
      ...
      var listValue: js.UndefOr[typings.googleProtobuf.googleProtobufStructPbMod.ListValue.AsObject] = js.undefined
      ...
      var structValue: js.UndefOr[typings.googleProtobuf.googleProtobufStructPbMod.Struct.AsObject] = js.undefined
    }
    object AsObject {
      ...
      implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        inline def setListValue(value: typings.googleProtobuf.googleProtobufStructPbMod.ListValue.AsObject): Self = StObject.set(x, "listValue", value.asInstanceOf[js.Any])
        ...
        inline def setStructValue(value: typings.googleProtobuf.googleProtobufStructPbMod.Struct.AsObject): Self = StObject.set(x, "structValue", value.asInstanceOf[js.Any])
