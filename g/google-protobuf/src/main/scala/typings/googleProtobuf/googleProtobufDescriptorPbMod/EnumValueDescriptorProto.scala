...
object EnumValueDescriptorProto {
  ...
  trait AsObject extends StObject {
    ...
    var options: js.UndefOr[typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumValueOptions.AsObject] = js.undefined
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setOptions(value: typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumValueOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
