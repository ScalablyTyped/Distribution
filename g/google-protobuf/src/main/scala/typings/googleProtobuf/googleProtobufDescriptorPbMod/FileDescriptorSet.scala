...
object FileDescriptorSet {
  ...
  object AsObject {
    ...
    implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      inline def setFileListVarargs(value: typings.googleProtobuf.googleProtobufDescriptorPbMod.FileDescriptorProto.AsObject*): Self = StObject.set(x, "fileList", js.Array(value*))
    }
  }
}
