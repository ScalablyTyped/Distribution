...
import typings.googleProtobuf.googleProtobufDescriptorPbMod.FieldOptions.CType
import typings.googleProtobuf.googleProtobufDescriptorPbMod.FieldOptions.JSType
...
object FieldOptions {
  ...
  object CType extends StObject {
    ...
    sealed trait CORD
      extends StObject
         with CType
    /* 1 */ val CORD: typings.googleProtobuf.googleProtobufDescriptorPbMod.FieldOptions.CType.CORD & Double = js.native
    
    @js.native
    sealed trait STRING
      extends StObject
         with CType
    /* 0 */ val STRING: typings.googleProtobuf.googleProtobufDescriptorPbMod.FieldOptions.CType.STRING & Double = js.native
    
    @js.native
    sealed trait STRING_PIECE
      extends StObject
         with CType
    /* 2 */ val STRING_PIECE: typings.googleProtobuf.googleProtobufDescriptorPbMod.FieldOptions.CType.STRING_PIECE & Double = js.native
  }
  ...
  object JSType extends StObject {
    ...
    sealed trait JS_NORMAL
      extends StObject
         with JSType
    /* 0 */ val JS_NORMAL: typings.googleProtobuf.googleProtobufDescriptorPbMod.FieldOptions.JSType.JS_NORMAL & Double = js.native
    
    @js.native
    sealed trait JS_NUMBER
      extends StObject
         with JSType
    /* 2 */ val JS_NUMBER: typings.googleProtobuf.googleProtobufDescriptorPbMod.FieldOptions.JSType.JS_NUMBER & Double = js.native
    
    @js.native
    sealed trait JS_STRING
      extends StObject
         with JSType
    /* 1 */ val JS_STRING: typings.googleProtobuf.googleProtobufDescriptorPbMod.FieldOptions.JSType.JS_STRING & Double = js.native
  }
