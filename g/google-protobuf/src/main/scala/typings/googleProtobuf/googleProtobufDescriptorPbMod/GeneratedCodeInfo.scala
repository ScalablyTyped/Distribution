...
import typings.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation
...
object GeneratedCodeInfo {
  ...
  object Annotation {
    ...
    inline def toObject(includeInstance: Boolean, msg: Annotation): typings.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[typings.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject]
    ...
    object AsObject {
      ...
      inline def apply(pathList: js.Array[Double]): typings.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject = {
  ...
  trait AsObject extends StObject {
    ...
    var annotationList: js.Array[
        typings.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject
      ]
  }
  object AsObject {
    ...
    implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "annotationList", value.asInstanceOf[js.Any])
      
      inline def setAnnotationListVarargs(value: typings.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject*): Self = StObject.set(x, "annotationList", js.Array(value*))
    }
  }
}
