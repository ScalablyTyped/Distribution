...
@js.native
open class OneofDescriptorProto () extends Message {
...
object OneofDescriptorProto {
  ...
  inline def deserializeBinary(bytes: js.typedarray.Uint8Array): OneofDescriptorProto = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeBinary")(bytes.asInstanceOf[js.Any]).asInstanceOf[OneofDescriptorProto]
  ...
  trait AsObject extends StObject {
    ...
    var options: js.UndefOr[typings.googleProtobuf.googleProtobufDescriptorPbMod.OneofOptions.AsObject] = js.undefined
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setOptions(value: typings.googleProtobuf.googleProtobufDescriptorPbMod.OneofOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
