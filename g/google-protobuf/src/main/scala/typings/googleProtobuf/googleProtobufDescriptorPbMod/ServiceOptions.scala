...
@js.native
open class ServiceOptions () extends Message {
...
object ServiceOptions {
  ...
  inline def deserializeBinary(bytes: js.typedarray.Uint8Array): ServiceOptions = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeBinary")(bytes.asInstanceOf[js.Any]).asInstanceOf[ServiceOptions]
  
  inline def deserializeBinaryFromReader(message: ServiceOptions, reader: BinaryReader): ServiceOptions = (^.asInstanceOf[js.Dynamic].applyDynamic("deserializeBinaryFromReader")(message.asInstanceOf[js.Any], reader.asInstanceOf[js.Any])).asInstanceOf[ServiceOptions]
  ...
  inline def serializeBinaryToWriter(message: ServiceOptions, writer: BinaryWriter): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("serializeBinaryToWriter")(message.asInstanceOf[js.Any], writer.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def toObject(includeInstance: Boolean, msg: ServiceOptions): AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[AsObject]
