...
import typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange
...
object EnumDescriptorProto {
  ...
  object EnumReservedRange {
    ...
    inline def toObject(includeInstance: Boolean, msg: EnumReservedRange): typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject]
    ...
    object AsObject {
      ...
      inline def apply(): typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject = {
  ...
  trait AsObject extends StObject {
    ...
    var options: js.UndefOr[typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumOptions.AsObject] = js.undefined
    
    var reservedNameList: js.Array[String]
    
    var reservedRangeList: js.Array[
        typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject
      ]
    
    var valueList: js.Array[
        typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumValueDescriptorProto.AsObject
      ]
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setOptions(value: typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      ...
      inline def setReservedRangeListVarargs(
        value: typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject*
      ): Self = StObject.set(x, "reservedRangeList", js.Array(value*))
      
      inline def setValueList(
        value: js.Array[
              typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumValueDescriptorProto.AsObject
            ]
      ): Self = StObject.set(x, "valueList", value.asInstanceOf[js.Any])
      
      inline def setValueListVarargs(value: typings.googleProtobuf.googleProtobufDescriptorPbMod.EnumValueDescriptorProto.AsObject*): Self = StObject.set(x, "valueList", js.Array(value*))
    }
  }
}
