...
import typings.googleProtobuf.googleProtobufDescriptorPbMod.MethodOptions.IdempotencyLevel
...
object MethodOptions {
  ...
  object IdempotencyLevel extends StObject {
    ...
    /* 0 */ val IDEMPOTENCY_UNKNOWN: typings.googleProtobuf.googleProtobufDescriptorPbMod.MethodOptions.IdempotencyLevel.IDEMPOTENCY_UNKNOWN & Double = js.native
    
    @js.native
    sealed trait IDEMPOTENT
      extends StObject
         with IdempotencyLevel
    /* 2 */ val IDEMPOTENT: typings.googleProtobuf.googleProtobufDescriptorPbMod.MethodOptions.IdempotencyLevel.IDEMPOTENT & Double = js.native
    
    @js.native
    sealed trait NO_SIDE_EFFECTS
      extends StObject
         with IdempotencyLevel
    /* 1 */ val NO_SIDE_EFFECTS: typings.googleProtobuf.googleProtobufDescriptorPbMod.MethodOptions.IdempotencyLevel.NO_SIDE_EFFECTS & Double = js.native
  }
