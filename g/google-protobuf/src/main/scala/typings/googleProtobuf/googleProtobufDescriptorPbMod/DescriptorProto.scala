...
import typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange
import typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange
...
object DescriptorProto {
  ...
  object ExtensionRange {
    ...
    inline def toObject(includeInstance: Boolean, msg: ExtensionRange): typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject]
    ...
    trait AsObject extends StObject {
      ...
      var options: js.UndefOr[
            typings.googleProtobuf.googleProtobufDescriptorPbMod.ExtensionRangeOptions.AsObject
          ] = js.undefined
    ...
    object AsObject {
      ...
      inline def apply(): typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject = {
      ...
      extension [Self <: typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject](x: Self) {
        ...
        inline def setOptions(value: typings.googleProtobuf.googleProtobufDescriptorPbMod.ExtensionRangeOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
  ...
  object ReservedRange {
    ...
    inline def toObject(includeInstance: Boolean, msg: ReservedRange): typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject]
    ...
    object AsObject {
      ...
      inline def apply(): typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject = {
        val __obj = js.Dynamic.literal()
  ...
  trait AsObject extends StObject {
    ...
    var extensionRangeList: js.Array[
        typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject
      ]
    ...
    var oneofDeclList: js.Array[
        typings.googleProtobuf.googleProtobufDescriptorPbMod.OneofDescriptorProto.AsObject
      ]
    
    var options: js.UndefOr[typings.googleProtobuf.googleProtobufDescriptorPbMod.MessageOptions.AsObject] = js.undefined
    
    var reservedNameList: js.Array[String]
    
    var reservedRangeList: js.Array[
        typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject
      ]
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setExtensionRangeList(
        value: js.Array[
              typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject
            ]
      ): Self = StObject.set(x, "extensionRangeList", value.asInstanceOf[js.Any])
      
      inline def setExtensionRangeListVarargs(
        value: typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject*
      ): Self = StObject.set(x, "extensionRangeList", js.Array(value*))
      
      inline def setFieldList(
        value: js.Array[
              typings.googleProtobuf.googleProtobufDescriptorPbMod.FieldDescriptorProto.AsObject
            ]
      ): Self = StObject.set(x, "fieldList", value.asInstanceOf[js.Any])
      
      inline def setFieldListVarargs(value: typings.googleProtobuf.googleProtobufDescriptorPbMod.FieldDescriptorProto.AsObject*): Self = StObject.set(x, "fieldList", js.Array(value*))
      ...
      inline def setOneofDeclList(
        value: js.Array[
              typings.googleProtobuf.googleProtobufDescriptorPbMod.OneofDescriptorProto.AsObject
            ]
      ): Self = StObject.set(x, "oneofDeclList", value.asInstanceOf[js.Any])
      
      inline def setOneofDeclListVarargs(value: typings.googleProtobuf.googleProtobufDescriptorPbMod.OneofDescriptorProto.AsObject*): Self = StObject.set(x, "oneofDeclList", js.Array(value*))
      
      inline def setOptions(value: typings.googleProtobuf.googleProtobufDescriptorPbMod.MessageOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      ...
      inline def setReservedRangeListVarargs(
        value: typings.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject*
