...
@js.native
open class UInt64Value () extends Message {
...
object UInt64Value {
  ...
  inline def deserializeBinary(bytes: js.typedarray.Uint8Array): UInt64Value = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeBinary")(bytes.asInstanceOf[js.Any]).asInstanceOf[UInt64Value]
