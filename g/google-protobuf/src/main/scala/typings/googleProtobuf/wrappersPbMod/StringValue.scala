...
object StringValue {
  ...
  inline def deserializeBinary(bytes: Uint8Array): StringValue = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeBinary")(bytes.asInstanceOf[js.Any]).asInstanceOf[StringValue]
