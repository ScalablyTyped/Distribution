...
object DoubleValue {
  ...
  inline def deserializeBinary(bytes: Uint8Array): DoubleValue = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeBinary")(bytes.asInstanceOf[js.Any]).asInstanceOf[DoubleValue]
