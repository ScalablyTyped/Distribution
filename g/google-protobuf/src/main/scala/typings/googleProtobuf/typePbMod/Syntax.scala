...
object Syntax extends StObject {
  ...
  sealed trait SYNTAX_PROTO2
    extends StObject
       with Syntax
  /* 0 */ val SYNTAX_PROTO2: typings.googleProtobuf.typePbMod.Syntax.SYNTAX_PROTO2 & Double = js.native
  
  @js.native
  sealed trait SYNTAX_PROTO3
    extends StObject
       with Syntax
  /* 1 */ val SYNTAX_PROTO3: typings.googleProtobuf.typePbMod.Syntax.SYNTAX_PROTO3 & Double = js.native
}
