...
trait PawsResource extends js.Object {
  /**
    ...
    */
  def getSpectrum(request: gapiDotClientDotSpectrumLib.Anon_PrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[PawsGetSpectrumResponse]
  /** The Google Spectrum Database does not support batch requests, so this method always yields an UNIMPLEMENTED error. */
  def getSpectrumBatch(request: gapiDotClientDotSpectrumLib.Anon_PrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[PawsGetSpectrumBatchResponse]
  /** Initializes the connection between a white space device and the database. */
  def init(request: gapiDotClientDotSpectrumLib.Anon_PrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[PawsInitResponse]
  /**
    ...
    */
  def notifySpectrumUse(request: gapiDotClientDotSpectrumLib.Anon_PrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[PawsNotifySpectrumUseResponse]
  ...
  def register(request: gapiDotClientDotSpectrumLib.Anon_PrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[PawsRegisterResponse]
  /**
    ...
    */
  def verifyDevice(request: gapiDotClientDotSpectrumLib.Anon_PrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[PawsVerifyDeviceResponse]
}
