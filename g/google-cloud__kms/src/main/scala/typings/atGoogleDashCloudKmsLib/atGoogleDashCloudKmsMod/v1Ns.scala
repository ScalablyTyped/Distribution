package typings
package atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod
...
object v1Ns extends js.Object {
  ...
  class KeyManagementServiceClient () extends js.Object {
    def this(options: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.ConfigurationObject) = this()
    def cryptoKeyPath(
    ...
    def decrypt(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.DecryptRequest
    ): js.Promise[
        js.Tuple3[
          atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.DecryptResponse, 
          _, 
          _
        ]
      ] = js.native
    def decrypt(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.DecryptRequest,
      callback: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.DecryptCallback
    ): scala.Unit = js.native
    def decrypt(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.DecryptRequest,
      gaxOpts: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.GAXNs.CallOptions
    ): js.Promise[
        js.Tuple3[
          atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.DecryptResponse, 
          _, 
    ...
    def encrypt(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.EncryptRequest
    ): js.Promise[
        js.Tuple3[
          atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.EncryptResponse, 
          _, 
          _
        ]
      ] = js.native
    def encrypt(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.EncryptRequest,
      callback: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.EncryptCallback
    ): scala.Unit = js.native
    def encrypt(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.EncryptRequest,
      gaxOpts: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.GAXNs.CallOptions
    ...
    def listCryptoKeys(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.ListCryptoKeysRequest
    ): js.Promise[js.Tuple3[js.Array[CryptoKey], _, _]] = js.native
    def listCryptoKeys(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.ListCryptoKeysRequest,
      callback: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.ListCryptoKeysCallback
    ): scala.Unit = js.native
    def listCryptoKeys(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.ListCryptoKeysRequest,
      gaxOpts: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.GAXNs.CallOptions
    ...
    def listKeyRings(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.ListKeyRingsRequest
    ): js.Promise[js.Tuple3[js.Array[KeyRing], _, _]] = js.native
    def listKeyRings(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.ListKeyRingsRequest,
      callback: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.ListKeyRingsCallback
    ): scala.Unit = js.native
    def listKeyRings(
      request: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyManagementServiceClientNs.ListKeyRingsRequest,
      gaxOpts: atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.GAXNs.CallOptions
  ...
  object AttestationFormat extends js.Object {
    ...
    sealed trait ATTESTATION_FORMAT_UNSPECIFIED
      extends atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.AttestationFormat
    ...
    def apply(value: scala.Double): js.UndefOr[
        atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.AttestationFormat with scala.Double
      ] = js.native
  }
  ...
  object CryptoKeyPurpose extends js.Object {
    ...
    sealed trait ASYMMETRIC_DECRYPT
      extends atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.CryptoKeyPurpose
    ...
    @JSBracketAccess
    def apply(value: scala.Double): js.UndefOr[
        atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.CryptoKeyPurpose with scala.Double
      ] = js.native
  }
  ...
  object CryptoKeyVersionAlgorithm extends js.Object {
    ...
    sealed trait CRYPTO_KEY_VERSION_ALGORITHM_UNSPECIFIED
      extends atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.CryptoKeyVersionAlgorithm
    ...
    @JSBracketAccess
    def apply(value: scala.Double): js.UndefOr[
        atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.CryptoKeyVersionAlgorithm with scala.Double
      ] = js.native
  }
  ...
  object CryptoKeyVersionState extends js.Object {
    ...
    sealed trait CRYPTO_KEY_VERSION_STATE_UNSPECIFIED
      extends atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.CryptoKeyVersionState
    ...
    @JSBracketAccess
    def apply(value: scala.Double): js.UndefOr[
        atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.CryptoKeyVersionState with scala.Double
      ] = js.native
  }
  ...
  object CryptoKeyVersionView extends js.Object {
    ...
    sealed trait CRYPTO_KEY_VERSION_VIEW_UNSPECIFIED
      extends atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.CryptoKeyVersionView
    ...
    @JSBracketAccess
    def apply(value: scala.Double): js.UndefOr[
        atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.CryptoKeyVersionView with scala.Double
      ] = js.native
  }
  ...
  object KeyManagementServiceClientNs extends js.Object {
    ...
    type ListCryptoKeysCallback = js.Function2[
        ...
        /* apiResponse */ js.Tuple3[
          js.Array[atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.CryptoKey], 
          js.Any, 
          js.Any
        ], 
        scala.Unit
    ...
    type ListKeyRingsCallback = js.Function2[
        /* err */ nodeLib.Error | scala.Null, 
        /* apiResponse */ js.Tuple3[
          js.Array[atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.KeyRing], 
          js.Any, 
          js.Any
        ], 
        scala.Unit
  ...
  object ProtectionLevel extends js.Object {
    ...
    @js.native
    sealed trait HSM
      extends atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.ProtectionLevel
    ...
    @JSBracketAccess
    def apply(value: scala.Double): js.UndefOr[
        atGoogleDashCloudKmsLib.atGoogleDashCloudKmsMod.v1Ns.ProtectionLevel with scala.Double
      ] = js.native
  }
