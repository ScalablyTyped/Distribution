...
object AttestationFormat extends StObject {
  ...
  /* 0 */ val ATTESTATION_FORMAT_UNSPECIFIED: typings.googleCloudKms.mod.v1.AttestationFormat.ATTESTATION_FORMAT_UNSPECIFIED & Double = js.native
  ...
  sealed trait CAVIUM_V1_COMPRESSED
    extends StObject
       with AttestationFormat
  /* 3 */ val CAVIUM_V1_COMPRESSED: typings.googleCloudKms.mod.v1.AttestationFormat.CAVIUM_V1_COMPRESSED & Double = js.native
}
