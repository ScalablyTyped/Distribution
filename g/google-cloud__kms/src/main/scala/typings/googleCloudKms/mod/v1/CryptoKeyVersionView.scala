...
object CryptoKeyVersionView extends StObject {
  ...
  /* 0 */ val CRYPTO_KEY_VERSION_VIEW_UNSPECIFIED: typings.googleCloudKms.mod.v1.CryptoKeyVersionView.CRYPTO_KEY_VERSION_VIEW_UNSPECIFIED with Double = js.native
  ...
  /* 1 */ val FULL: typings.googleCloudKms.mod.v1.CryptoKeyVersionView.FULL with Double = js.native
}
