...
object CryptoKeyVersionState extends StObject {
  ...
  /* 0 */ val CRYPTO_KEY_VERSION_STATE_UNSPECIFIED: typings.googleCloudKms.mod.v1.CryptoKeyVersionState.CRYPTO_KEY_VERSION_STATE_UNSPECIFIED with Double = js.native
  
  // This version is destroyed, and the key material is no longer stored.
  // A version may not leave this state once entered.
  @js.native
  sealed trait DESTROYED extends CryptoKeyVersionState
  /* 3 */ val DESTROYED: typings.googleCloudKms.mod.v1.CryptoKeyVersionState.DESTROYED with Double = js.native
  ...
  /* 4 */ val DESTROY_SCHEDULED: typings.googleCloudKms.mod.v1.CryptoKeyVersionState.DESTROY_SCHEDULED with Double = js.native
  ...
  /* 2 */ val DISABLED: typings.googleCloudKms.mod.v1.CryptoKeyVersionState.DISABLED with Double = js.native
  
  // This version may be used for cryptographic operations.
  @js.native
  sealed trait ENABLED extends CryptoKeyVersionState
  /* 1 */ val ENABLED: typings.googleCloudKms.mod.v1.CryptoKeyVersionState.ENABLED with Double = js.native
  ...
  /* 5 */ val PENDING_GENERATION: typings.googleCloudKms.mod.v1.CryptoKeyVersionState.PENDING_GENERATION with Double = js.native
}
