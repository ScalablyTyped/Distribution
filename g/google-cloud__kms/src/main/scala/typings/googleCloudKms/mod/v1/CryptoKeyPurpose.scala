...
object CryptoKeyPurpose extends StObject {
  ...
  /* 6 */ val ASYMMETRIC_DECRYPT: typings.googleCloudKms.mod.v1.CryptoKeyPurpose.ASYMMETRIC_DECRYPT & Double = js.native
  ...
  sealed trait ASYMMETRIC_SIGN
    extends StObject
       with CryptoKeyPurpose
  /* 5 */ val ASYMMETRIC_SIGN: typings.googleCloudKms.mod.v1.CryptoKeyPurpose.ASYMMETRIC_SIGN & Double = js.native
  ...
  sealed trait CRYPTO_KEY_PURPOSE_UNSPECIFIED
    extends StObject
       with CryptoKeyPurpose
  /* 0 */ val CRYPTO_KEY_PURPOSE_UNSPECIFIED: typings.googleCloudKms.mod.v1.CryptoKeyPurpose.CRYPTO_KEY_PURPOSE_UNSPECIFIED & Double = js.native
  ...
  sealed trait ENCRYPT_DECRYPT
    extends StObject
       with CryptoKeyPurpose
  /* 1 */ val ENCRYPT_DECRYPT: typings.googleCloudKms.mod.v1.CryptoKeyPurpose.ENCRYPT_DECRYPT & Double = js.native
}
