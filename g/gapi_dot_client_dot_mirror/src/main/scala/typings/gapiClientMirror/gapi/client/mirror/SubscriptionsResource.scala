...
trait SubscriptionsResource extends js.Object {
  ...
  def insert(request: AnonAltFields): Request_[Subscription]
  /** Retrieves a list of subscriptions for the authenticated user and service. */
  def list(request: AnonAltFields): Request_[SubscriptionsListResponse]
...
object SubscriptionsResource {
  ...
  def apply(
    ...
    insert: AnonAltFields => Request_[Subscription],
    list: AnonAltFields => Request_[SubscriptionsListResponse],
