...
trait LocationsResource extends js.Object {
  ...
  def list(request: AnonAltFields): Request_[LocationsListResponse]
}

object LocationsResource {
  @scala.inline
  def apply(get: AnonAlt => Request_[Location], list: AnonAltFields => Request_[LocationsListResponse]): LocationsResource = {
