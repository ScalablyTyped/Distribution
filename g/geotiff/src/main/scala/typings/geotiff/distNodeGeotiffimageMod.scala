...
object distNodeGeotiffimageMod {
  
  /**
    * GeoTIFF sub-file image.
    */
  @JSImport("geotiff/dist-node/geotiffimage", JSImport.Default)
  @js.native
  ...
  trait GeoTIFFImage extends StObject {
    ...
    def getArrayForSample(sampleIndex: Any, size: Any): js.typedarray.Uint8Array | js.typedarray.Uint16Array | js.typedarray.Uint32Array | js.typedarray.Int32Array | js.typedarray.Int8Array | js.typedarray.Int16Array | js.typedarray.Float32Array | js.typedarray.Float64Array = js.native
