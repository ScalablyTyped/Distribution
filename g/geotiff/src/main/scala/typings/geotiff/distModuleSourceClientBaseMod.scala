...
object distModuleSourceClientBaseMod {
  
  @JSImport("geotiff/dist-module/source/client/base", "BaseClient")
  @js.native
  ...
  @JSImport("geotiff/dist-module/source/client/base", "BaseResponse")
  @js.native
