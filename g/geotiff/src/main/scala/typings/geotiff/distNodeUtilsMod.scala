...
object distNodeUtilsMod {
  
  @JSImport("geotiff/dist-node/utils", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("geotiff/dist-node/utils", "AbortError")
  @js.native
  ...
  @JSImport("geotiff/dist-node/utils", "AggregateError")
  @js.native
  ...
  @JSImport("geotiff/dist-node/utils", "CustomAggregateError")
  @js.native
