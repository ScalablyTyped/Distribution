...
package object entityMod {
  ...
  /**
    ...
    */
  type DatastoreKeyPath = js.Array[typings.googleCloudDatastore.entityMod.PathElement]
  ...
  /**
    ...
    */
  type ObjOrPayload[T] = T | typings.googleCloudDatastore.entityMod.DatastorePayload[T]
  
  type OneOrMany[T] = typings.googleCloudDatastore.entityMod.ObjOrPayload[T] | js.Array[typings.googleCloudDatastore.entityMod.ObjOrPayload[T]]
  
  type PathElement = java.lang.String | scala.Double | typings.googleCloudDatastore.entityMod.DatastoreInt
}
