...
import typings.atGoogleDashCloudDatastore.atGoogleDashCloudDatastoreStrings.eventual
import typings.atGoogleDashCloudDatastore.atGoogleDashCloudDatastoreStrings.strong
