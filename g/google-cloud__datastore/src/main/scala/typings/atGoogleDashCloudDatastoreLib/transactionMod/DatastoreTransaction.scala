...
class DatastoreTransaction protected ()
  ...
  def this(datastore: atGoogleDashCloudDatastoreLib.atGoogleDashCloudDatastoreMod.namespaced) = this()
  def commit(): js.Promise[atGoogleDashCloudDatastoreLib.requestMod.CommitResult] = js.native
