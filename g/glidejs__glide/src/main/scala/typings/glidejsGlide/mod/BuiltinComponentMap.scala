...
trait BuiltinComponentMap extends StObject {
...
object BuiltinComponentMap {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(Anchors = Anchors.asInstanceOf[js.Any], Autoplay = Autoplay.asInstanceOf[js.Any], Breakpoints = Breakpoints.asInstanceOf[js.Any], Build = Build.asInstanceOf[js.Any], Clones = Clones.asInstanceOf[js.Any], Controls = Controls.asInstanceOf[js.Any], Gaps = Gaps.asInstanceOf[js.Any], Html = Html.asInstanceOf[js.Any], Images = Images.asInstanceOf[js.Any], Keyboard = Keyboard.asInstanceOf[js.Any], Move = Move.asInstanceOf[js.Any], Peek = Peek.asInstanceOf[js.Any], Resize = Resize.asInstanceOf[js.Any], Run = Run.asInstanceOf[js.Any], Sizes = Sizes.asInstanceOf[js.Any], Swipe = Swipe.asInstanceOf[js.Any], Transition = Transition.asInstanceOf[js.Any], Translate = Translate.asInstanceOf[js.Any])
