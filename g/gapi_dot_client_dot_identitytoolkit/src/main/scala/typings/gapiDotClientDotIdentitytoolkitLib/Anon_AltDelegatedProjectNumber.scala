...
trait Anon_AltDelegatedProjectNumber extends js.Object {
...
object Anon_AltDelegatedProjectNumber {
  @scala.inline
  def apply(
  ...
  ): Anon_AltDelegatedProjectNumber = {
    ...
    __obj.asInstanceOf[Anon_AltDelegatedProjectNumber]
  }
}
