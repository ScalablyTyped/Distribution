...
trait AnonAltDelegatedProjectNumber extends js.Object {
...
object AnonAltDelegatedProjectNumber {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltDelegatedProjectNumber]
  }
}
