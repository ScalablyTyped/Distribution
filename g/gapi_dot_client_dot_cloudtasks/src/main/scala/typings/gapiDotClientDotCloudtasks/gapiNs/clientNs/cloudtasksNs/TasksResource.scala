...
import typings.gapiDotClientDotCloudtasks.Anon_AccesstokenAltBearertoken
import typings.gapiDotClientDotCloudtasks.Anon_AccesstokenAltBearertokenCallback
...
trait TasksResource extends js.Object {
  /**
    ...
    */
  def acknowledge(request: Anon_Accesstoken): Request[js.Object]
  /**
    ...
    */
  def cancelLease(request: Anon_Accesstoken): Request[Task]
  /**
    ...
    */
  def create(request: Anon_AccesstokenAlt): Request[Task]
  /**
    * Deletes a task.
    *
  ...
  /** Gets a task. */
  def get(request: Anon_AccesstokenAltBearertoken): Request[Task]
  /**
    ...
    */
  def list(request: Anon_AccesstokenAltBearertokenCallback): Request[ListTasksResponse]
  /**
    ...
    */
  def pull(request: Anon_Accesstoken): Request[PullTasksResponse]
  /**
    ...
    */
  def renewLease(request: Anon_Accesstoken): Request[Task]
  /**
    ...
    * already running.
    */
  def run(request: Anon_Accesstoken): Request[Task]
}

object TasksResource {
  @scala.inline
  def apply(
    acknowledge: Anon_Accesstoken => Request[js.Object],
    cancelLease: Anon_Accesstoken => Request[Task],
    create: Anon_AccesstokenAlt => Request[Task],
    delete: Anon_Accesstoken => Request[js.Object],
    get: Anon_AccesstokenAltBearertoken => Request[Task],
    list: Anon_AccesstokenAltBearertokenCallback => Request[ListTasksResponse],
    pull: Anon_Accesstoken => Request[PullTasksResponse],
    renewLease: Anon_Accesstoken => Request[Task],
    run: Anon_Accesstoken => Request[Task]
  ): TasksResource = {
