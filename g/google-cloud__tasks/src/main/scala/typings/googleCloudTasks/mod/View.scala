...
/* Rewritten from type alias, can be one of: 
  - typings.googleCloudTasks.googleCloudTasksNumbers.`0`
  - typings.googleCloudTasks.googleCloudTasksNumbers.`1`
  - typings.googleCloudTasks.googleCloudTasksNumbers.`2`
*/
