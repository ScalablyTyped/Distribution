...
trait AnonAccountIdAltCustomMetricIdFields extends js.Object {
...
object AnonAccountIdAltCustomMetricIdFields {
  @scala.inline
  def apply(
    accountId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAltCustomMetricIdFields = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltCustomMetricIdFields]
  }
}
