...
trait AnonAccountIdAltFieldsKeyOauthtokenPrettyPrintProfileId extends js.Object {
...
object AnonAccountIdAltFieldsKeyOauthtokenPrettyPrintProfileId {
  @scala.inline
  def apply(
    accountId: String,
    profileId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAltFieldsKeyOauthtokenPrettyPrintProfileId = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltFieldsKeyOauthtokenPrettyPrintProfileId]
  }
}
