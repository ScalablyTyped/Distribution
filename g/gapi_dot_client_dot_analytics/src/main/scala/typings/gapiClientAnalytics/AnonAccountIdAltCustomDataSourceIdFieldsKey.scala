...
trait AnonAccountIdAltCustomDataSourceIdFieldsKey extends js.Object {
...
object AnonAccountIdAltCustomDataSourceIdFieldsKey {
  @scala.inline
  def apply(
    accountId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAltCustomDataSourceIdFieldsKey = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltCustomDataSourceIdFieldsKey]
  }
}
