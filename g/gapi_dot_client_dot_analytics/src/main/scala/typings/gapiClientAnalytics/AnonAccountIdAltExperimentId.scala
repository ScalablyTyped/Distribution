...
trait AnonAccountIdAltExperimentId extends js.Object {
...
object AnonAccountIdAltExperimentId {
  @scala.inline
  def apply(
    accountId: String,
    experimentId: String,
    ...
    __obj.asInstanceOf[AnonAccountIdAltExperimentId]
  }
}
