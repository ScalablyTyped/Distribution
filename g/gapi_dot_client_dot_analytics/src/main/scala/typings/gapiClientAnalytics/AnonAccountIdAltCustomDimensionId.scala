...
trait AnonAccountIdAltCustomDimensionId extends js.Object {
...
object AnonAccountIdAltCustomDimensionId {
  @scala.inline
  def apply(
    accountId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAltCustomDimensionId = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltCustomDimensionId]
  }
}
