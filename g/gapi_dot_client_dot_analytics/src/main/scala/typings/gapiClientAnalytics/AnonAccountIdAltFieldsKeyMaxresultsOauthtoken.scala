...
trait AnonAccountIdAltFieldsKeyMaxresultsOauthtoken extends js.Object {
...
object AnonAccountIdAltFieldsKeyMaxresultsOauthtoken {
  @scala.inline
  def apply(
    accountId: String,
    profileId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAltFieldsKeyMaxresultsOauthtoken = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltFieldsKeyMaxresultsOauthtoken]
  }
}
