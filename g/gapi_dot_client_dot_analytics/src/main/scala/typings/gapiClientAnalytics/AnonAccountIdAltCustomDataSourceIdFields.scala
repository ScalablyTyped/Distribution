...
trait AnonAccountIdAltCustomDataSourceIdFields extends js.Object {
...
object AnonAccountIdAltCustomDataSourceIdFields {
  @scala.inline
  def apply(
    accountId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAltCustomDataSourceIdFields = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltCustomDataSourceIdFields]
  }
}
