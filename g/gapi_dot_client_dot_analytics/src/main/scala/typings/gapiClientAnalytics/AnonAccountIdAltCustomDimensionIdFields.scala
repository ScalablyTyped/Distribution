...
trait AnonAccountIdAltCustomDimensionIdFields extends js.Object {
...
object AnonAccountIdAltCustomDimensionIdFields {
  @scala.inline
  def apply(
    accountId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAltCustomDimensionIdFields = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltCustomDimensionIdFields]
  }
}
