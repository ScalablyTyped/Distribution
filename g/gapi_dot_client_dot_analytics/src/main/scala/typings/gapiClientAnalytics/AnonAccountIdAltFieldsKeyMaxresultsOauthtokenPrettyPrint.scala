...
trait AnonAccountIdAltFieldsKeyMaxresultsOauthtokenPrettyPrint extends js.Object {
...
object AnonAccountIdAltFieldsKeyMaxresultsOauthtokenPrettyPrint {
  @scala.inline
  def apply(
    accountId: String,
    ...
    `type`: String = null,
    userIp: String = null
  ): AnonAccountIdAltFieldsKeyMaxresultsOauthtokenPrettyPrint = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltFieldsKeyMaxresultsOauthtokenPrettyPrint]
  }
}
