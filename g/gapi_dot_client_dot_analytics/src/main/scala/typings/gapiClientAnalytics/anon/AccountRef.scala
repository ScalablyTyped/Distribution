...
trait AccountRef extends js.Object {
  ...
  var accountRef: js.UndefOr[typings.gapiClientAnalytics.gapi.client.analytics.AccountRef] = js.native
...
object AccountRef {
  ...
  implicit class AccountRefOps[Self <: AccountRef] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAccountRef(value: typings.gapiClientAnalytics.gapi.client.analytics.AccountRef): Self = this.set("accountRef", value.asInstanceOf[js.Any])
    @scala.inline
