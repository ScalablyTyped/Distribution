...
trait AnonAccountIdAltFieldsKey extends js.Object {
...
object AnonAccountIdAltFieldsKey {
  @scala.inline
  def apply(
    accountId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAccountIdAltFieldsKey]
  }
}
