...
trait AnonAccountIdAltCustomDataSourceId extends js.Object {
...
object AnonAccountIdAltCustomDataSourceId {
  @scala.inline
  def apply(
    accountId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAltCustomDataSourceId = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltCustomDataSourceId]
  }
}
