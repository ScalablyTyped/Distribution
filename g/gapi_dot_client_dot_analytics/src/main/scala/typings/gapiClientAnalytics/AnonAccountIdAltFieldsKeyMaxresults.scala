...
trait AnonAccountIdAltFieldsKeyMaxresults extends js.Object {
...
object AnonAccountIdAltFieldsKeyMaxresults {
  @scala.inline
  def apply(
    accountId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAltFieldsKeyMaxresults = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltFieldsKeyMaxresults]
  }
}
