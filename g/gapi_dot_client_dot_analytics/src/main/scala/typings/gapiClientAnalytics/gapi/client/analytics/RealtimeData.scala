...
trait RealtimeData extends js.Object {
  ...
  var query: js.UndefOr[typings.gapiClientAnalytics.anon.Filters] = js.native
  /**
...
object RealtimeData {
  ...
  implicit class RealtimeDataOps[Self <: RealtimeData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setQuery(value: typings.gapiClientAnalytics.anon.Filters): Self = this.set("query", value.asInstanceOf[js.Any])
    @scala.inline
