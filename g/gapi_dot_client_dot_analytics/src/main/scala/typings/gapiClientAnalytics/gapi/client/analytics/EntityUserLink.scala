...
trait EntityUserLink extends js.Object {
  ...
  var entity: js.UndefOr[typings.gapiClientAnalytics.anon.AccountRef] = js.native
  /** Entity user link ID */
...
object EntityUserLink {
  ...
  implicit class EntityUserLinkOps[Self <: EntityUserLink] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntity(value: typings.gapiClientAnalytics.anon.AccountRef): Self = this.set("entity", value.asInstanceOf[js.Any])
    @scala.inline
