...
object UnsampledReports {
  ...
  @scala.inline
  implicit class UnsampledReportsOps[Self <: UnsampledReports] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: UnsampledReport*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[UnsampledReport]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
