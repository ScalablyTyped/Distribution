...
object Profiles {
  ...
  implicit class ProfilesOps[Self <: Profiles] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Profile*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Profile]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
