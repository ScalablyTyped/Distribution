...
object Webproperties {
  ...
  @scala.inline
  implicit class WebpropertiesOps[Self <: Webproperties] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: Webproperty*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Webproperty]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
