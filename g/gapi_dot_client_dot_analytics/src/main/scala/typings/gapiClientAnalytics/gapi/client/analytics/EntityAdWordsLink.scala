...
trait EntityAdWordsLink extends js.Object {
  ...
  var entity: js.UndefOr[typings.gapiClientAnalytics.anon.WebPropertyRef] = js.native
...
object EntityAdWordsLink {
  ...
  implicit class EntityAdWordsLinkOps[Self <: EntityAdWordsLink] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntity(value: typings.gapiClientAnalytics.anon.WebPropertyRef): Self = this.set("entity", value.asInstanceOf[js.Any])
    @scala.inline
