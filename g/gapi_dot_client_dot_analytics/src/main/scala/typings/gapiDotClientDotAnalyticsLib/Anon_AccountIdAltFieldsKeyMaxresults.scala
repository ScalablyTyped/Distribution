...
trait Anon_AccountIdAltFieldsKeyMaxresults extends js.Object {
...
object Anon_AccountIdAltFieldsKeyMaxresults {
  @scala.inline
  def apply(
  ...
  ): Anon_AccountIdAltFieldsKeyMaxresults = {
    ...
    __obj.asInstanceOf[Anon_AccountIdAltFieldsKeyMaxresults]
  }
}
