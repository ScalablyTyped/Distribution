...
trait Anon_AccountIdAltCustomDataSourceId extends js.Object {
...
object Anon_AccountIdAltCustomDataSourceId {
  @scala.inline
  def apply(
    accountId: String,
    ...
    userIp: String = null
  ): Anon_AccountIdAltCustomDataSourceId = {
    ...
    __obj.asInstanceOf[Anon_AccountIdAltCustomDataSourceId]
  }
}
