package typings.gapiDotClientDotCloudmonitoring.gapi.client
...
object load extends js.Object {
  ...
  def apply(
    name: typings.gapiDotClientDotCloudmonitoring.gapiDotClientDotCloudmonitoringStrings.cloudmonitoring,
    version: v2beta2
