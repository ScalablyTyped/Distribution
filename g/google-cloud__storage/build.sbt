...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "gcp-metadata" % "1.0.0-a30492",
  "org.scalablytyped" %%% "gcs-resumable-upload" % "1.1.0-36254c",
  "org.scalablytyped" %%% "google-auth-library" % "3.1.2-1a8921",
  "org.scalablytyped" %%% "google-cloud__common" % "0.31.1-43ce2d",
  ...
  "org.scalablytyped" %%% "gtoken" % "2.3.3-b9a27f",
  ...
  "org.scalablytyped" %%% "teeny-request" % "3.11.3-1ebf3c",
