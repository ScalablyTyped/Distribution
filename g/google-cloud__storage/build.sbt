...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "duplexify" % "3.6-dt-20181030Z-7c4aaa",
  "org.scalablytyped" %%% "ent" % "2.2.0-dt-20180214Z-a026bc",
  ...
  "org.scalablytyped" %%% "gcs-resumable-upload" % "0.14.1-bf510d",
  "org.scalablytyped" %%% "google-auth-library" % "3.1.0-1a2d6d",
  "org.scalablytyped" %%% "google-cloud__common" % "0.31.0-4f7ac5",
  "org.scalablytyped" %%% "google-cloud__paginator" % "0.1.2-8ae8df",
  ...
  "org.scalablytyped" %%% "pumpify" % "1.4-dt-20181017Z-b152a1",
  "org.scalablytyped" %%% "request" % "2.48-dt-20190117Z-c8dda0",
  "org.scalablytyped" %%% "retry-request" % "4.0.0-30b89c",
  ...
  "org.scalablytyped" %%% "teeny-request" % "3.11.3-8b7f2d",
