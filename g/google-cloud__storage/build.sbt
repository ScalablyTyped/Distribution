...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "gcs-resumable-upload" % "0.14.1-a1aa0d",
  "org.scalablytyped" %%% "google-auth-library" % "3.1.0-118405",
  "org.scalablytyped" %%% "google-cloud__common" % "0.31.0-8bc19d",
  "org.scalablytyped" %%% "google-cloud__paginator" % "0.1.2-8776a4",
  ...
  "org.scalablytyped" %%% "pumpify" % "1.4-dt-20181017Z-4aeca5",
  ...
  "org.scalablytyped" %%% "teeny-request" % "3.11.3-a4ffae",
