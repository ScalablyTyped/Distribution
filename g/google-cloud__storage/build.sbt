...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "gcs-resumable-upload" % "0.14.1-b2e25f",
  "org.scalablytyped" %%% "google-auth-library" % "3.0.1-90ceef",
  "org.scalablytyped" %%% "google-cloud__common" % "0.30.2-86a618",
  "org.scalablytyped" %%% "google-cloud__paginator" % "0.1.2-86d652",
  ...
  "org.scalablytyped" %%% "teeny-request" % "3.11.3-3baed5",
