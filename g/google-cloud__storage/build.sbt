...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "gcs-resumable-upload" % "0.14.1-338eba",
  "org.scalablytyped" %%% "google-auth-library" % "3.1.0-62a1fd",
  "org.scalablytyped" %%% "google-cloud__common" % "0.31.0-a262ea",
