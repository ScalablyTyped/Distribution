...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "gcs-resumable-upload" % "1.1.0-513ec2",
  "org.scalablytyped" %%% "google-auth-library" % "3.1.2-2d4261",
  "org.scalablytyped" %%% "google-cloud__common" % "0.32.0-a540e8",
  "org.scalablytyped" %%% "google-cloud__paginator" % "0.2.0-294c24",
  ...
  "org.scalablytyped" %%% "pumpify" % "1.4-dt-20181017Z-5585fe",
  ...
  "org.scalablytyped" %%% "teeny-request" % "3.11.3-14515e",
