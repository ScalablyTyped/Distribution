...
class Notification protected ()
  extends typings.atGoogleDashCloudStorage.buildSrcNotificationMod.Notification {
  def this(bucket: typings.atGoogleDashCloudStorage.buildSrcBucketMod.Bucket, id: String) = this()
}
