...
object atGoogleDashCloudStorageMod extends js.Object {
  ...
  class File protected ()
    extends typings.atGoogleDashCloudStorage.buildSrcFileMod.File {
    /**
    ...
    /**
      ...
      */
    def this(bucket: typings.atGoogleDashCloudStorage.buildSrcBucketMod.Bucket, name: String) = this()
    def this(
      bucket: typings.atGoogleDashCloudStorage.buildSrcBucketMod.Bucket,
      name: String,
      options: FileOptions
    ) = this()
  }
  ...
  @js.native
  class Iam protected ()
    extends typings.atGoogleDashCloudStorage.buildSrcIamMod.Iam {
    def this(bucket: typings.atGoogleDashCloudStorage.buildSrcBucketMod.Bucket) = this()
  }
  ...
  /**
    ...
    */
  class Storage ()
    extends typings.atGoogleDashCloudStorage.buildSrcStorageMod.Storage {
  ...
  object Storage extends js.Object {
    ...
    var Bucket: Instantiable3[
        ...
        typings.atGoogleDashCloudStorage.buildSrcBucketMod.Bucket
      ] = js.native
    /**
      * {@link Channel} class.
      *
    ...
    var Channel: Instantiable3[
        ...
        /* id */ String, 
        /* resourceId */ String, 
        typings.atGoogleDashCloudStorage.buildSrcChannelMod.Channel
      ] = js.native
    /**
      * {@link File} class.
      *
