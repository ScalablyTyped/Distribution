...
import typings.googleCloudStorage.anon.TypeofApiError
import typings.googleCloudStorage.anon.UserAgent
...
open class Util_ () extends StObject {
  ...
  var PartialFailureError: Instantiable1[
    /* b */ GoogleErrorBody, 
    typings.googleCloudStorage.buildSrcNodejsCommonUtilMod.PartialFailureError
  ] = js.native
  
  def _getDefaultHeaders(): UserAgent = js.native
