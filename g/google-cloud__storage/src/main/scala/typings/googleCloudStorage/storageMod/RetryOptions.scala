...
trait RetryOptions extends StObject {
  ...
  var idempotencyStrategy: js.UndefOr[IdempotencyStrategy] = js.undefined
...
object RetryOptions {
  ...
  extension [Self <: RetryOptions](x: Self) {
    ...
    inline def setIdempotencyStrategy(value: IdempotencyStrategy): Self = StObject.set(x, "idempotencyStrategy", value.asInstanceOf[js.Any])
    
    inline def setIdempotencyStrategyUndefined: Self = StObject.set(x, "idempotencyStrategy", js.undefined)
