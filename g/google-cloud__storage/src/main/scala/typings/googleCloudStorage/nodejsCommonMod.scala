...
import typings.googleCloudStorage.serviceMod.ServiceConfig
import typings.googleCloudStorage.serviceMod.ServiceOptions
import typings.googleCloudStorage.serviceObjectMod.ServiceObjectConfig
import typings.googleCloudStorage.utilMod.GoogleErrorBody
import typings.googleCloudStorage.utilMod.GoogleInnerError
import typings.googleCloudStorage.utilMod.Util_
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object nodejsCommonMod {
  
  @JSImport("@google-cloud/storage/build/src/nodejs-common", "ApiError")
  @js.native
  open class ApiError protected ()
    extends typings.googleCloudStorage.utilMod.ApiError {
  ...
  open class Service protected ()
    extends typings.googleCloudStorage.serviceMod.Service {
    /**
  ...
  open class ServiceObject[T] protected ()
    extends typings.googleCloudStorage.serviceObjectMod.ServiceObject[T] {
  ...
  object util extends Shortcut {
    ...
    open class PartialFailureError protected ()
      extends typings.googleCloudStorage.utilMod.PartialFailureError {
