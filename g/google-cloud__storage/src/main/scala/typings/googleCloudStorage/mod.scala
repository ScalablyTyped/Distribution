...
object mod {
  ...
  @JSImport("@google-cloud/storage", "TransferManager")
  @js.native
  open class TransferManager protected ()
    extends typings.googleCloudStorage.buildSrcTransferManagerMod.TransferManager {
    def this(bucket: typings.googleCloudStorage.buildSrcBucketMod.Bucket) = this()
  }
}
