...
@js.native
object gtinModMembers extends js.Object {
  def getFormat(gtin: java.lang.String): GtinFormat = js.native
  def getRealFormat(gtin: java.lang.String): GtinFormat = js.native
