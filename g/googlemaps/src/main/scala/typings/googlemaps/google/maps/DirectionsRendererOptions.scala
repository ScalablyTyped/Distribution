...
object DirectionsRendererOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(hideRouteList)) __obj.updateDynamic("hideRouteList")(hideRouteList.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(suppressBicyclingLayer)) __obj.updateDynamic("suppressBicyclingLayer")(suppressBicyclingLayer.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(suppressMarkers)) __obj.updateDynamic("suppressMarkers")(suppressMarkers.get.asInstanceOf[js.Any])
    if (!js.isUndefined(suppressPolylines)) __obj.updateDynamic("suppressPolylines")(suppressPolylines.get.asInstanceOf[js.Any])
