...
object RankBy extends js.Object {
  ...
  /* 0 */ val DISTANCE: typings.googlemaps.google.maps.places.RankBy.DISTANCE with Double = js.native
  /* 1 */ val PROMINENCE: typings.googlemaps.google.maps.places.RankBy.PROMINENCE with Double = js.native
  @JSBracketAccess
