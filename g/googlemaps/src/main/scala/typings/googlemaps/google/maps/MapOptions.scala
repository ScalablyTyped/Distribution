...
object MapOptions {
  ...
  extension [Self <: MapOptions](x: Self) {
    ...
    inline def setGestureHandling(value: GestureHandlingOptions): Self = StObject.set(x, "gestureHandling", value.asInstanceOf[js.Any])
    ...
    inline def setMapTypeId(value: MapTypeId | String): Self = StObject.set(x, "mapTypeId", value.asInstanceOf[js.Any])
