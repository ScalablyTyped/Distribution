...
object ControlPosition extends js.Object {
  ...
  /* 0 */ val BOTTOM_CENTER: typings.googlemaps.google.maps.ControlPosition.BOTTOM_CENTER with Double = js.native
  /* 1 */ val BOTTOM_LEFT: typings.googlemaps.google.maps.ControlPosition.BOTTOM_LEFT with Double = js.native
  /* 2 */ val BOTTOM_RIGHT: typings.googlemaps.google.maps.ControlPosition.BOTTOM_RIGHT with Double = js.native
  /* 3 */ val LEFT_BOTTOM: typings.googlemaps.google.maps.ControlPosition.LEFT_BOTTOM with Double = js.native
  ...
  /* 6 */ val RIGHT_BOTTOM: typings.googlemaps.google.maps.ControlPosition.RIGHT_BOTTOM with Double = js.native
  /* 7 */ val RIGHT_CENTER: typings.googlemaps.google.maps.ControlPosition.RIGHT_CENTER with Double = js.native
  /* 8 */ val RIGHT_TOP: typings.googlemaps.google.maps.ControlPosition.RIGHT_TOP with Double = js.native
  /* 9 */ val TOP_CENTER: typings.googlemaps.google.maps.ControlPosition.TOP_CENTER with Double = js.native
  /* 10 */ val TOP_LEFT: typings.googlemaps.google.maps.ControlPosition.TOP_LEFT with Double = js.native
  /* 11 */ val TOP_RIGHT: typings.googlemaps.google.maps.ControlPosition.TOP_RIGHT with Double = js.native
  @JSBracketAccess
