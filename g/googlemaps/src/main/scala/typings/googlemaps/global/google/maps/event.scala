...
object event {
  ...
  /**
    ...
    * function.
    */
  inline def addDomListener(instance: js.Object, eventName: String, handler: js.Function1[/* event */ Event, Unit]): MapsEventListener = (^.asInstanceOf[js.Dynamic].applyDynamic("addDomListener")(instance.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[MapsEventListener]
  inline def addDomListener(
    instance: js.Object,
    eventName: String,
  ...
  /**
    ...
    * event.
    */
  inline def addDomListenerOnce(instance: js.Object, eventName: String, handler: js.Function1[/* event */ Event, Unit]): MapsEventListener = (^.asInstanceOf[js.Dynamic].applyDynamic("addDomListenerOnce")(instance.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[MapsEventListener]
  inline def addDomListenerOnce(
    instance: js.Object,
    eventName: String,
    handler: js.Function1[/* event */ Event, Unit],
    capture: Boolean
  ...
  /**
    ...
    * with removeListener().
    */
  inline def addListener(instance: js.Object, eventName: String, handler: js.Function1[/* repeated */ js.Any, Unit]): MapsEventListener = (^.asInstanceOf[js.Dynamic].applyDynamic("addListener")(instance.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[MapsEventListener]
  
  /**
    * Like addListener, but the handler removes itself after handling the first
    * event.
    */
  inline def addListenerOnce(instance: js.Object, eventName: String, handler: js.Function1[/* repeated */ js.Any, Unit]): MapsEventListener = (^.asInstanceOf[js.Dynamic].applyDynamic("addListenerOnce")(instance.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[MapsEventListener]
  ...
  /**
    ...
    */
  inline def trigger(instance: js.Any, eventName: String, args: js.Any*): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("trigger")(instance.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
