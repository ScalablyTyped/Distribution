...
object StreetViewPreference extends js.Object {
  ...
  /* 0 */ val BEST: typings.googlemaps.googleNs.mapsNs.StreetViewPreference.BEST with Double = js.native
  /* 1 */ val NEAREST: typings.googlemaps.googleNs.mapsNs.StreetViewPreference.NEAREST with Double = js.native
  @JSBracketAccess
