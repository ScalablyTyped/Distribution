...
object Animation extends js.Object {
  ...
  /* 1 */ val BOUNCE: typings.googlemaps.googleNs.mapsNs.Animation.BOUNCE with Double = js.native
  /* 2 */ val DROP: typings.googlemaps.googleNs.mapsNs.Animation.DROP with Double = js.native
  @JSBracketAccess
