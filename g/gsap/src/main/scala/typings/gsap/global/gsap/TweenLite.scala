...
object TweenLite {
  ...
  /* static member */
  @scala.inline
  def delayedCall(delay: Double, callback: js.Function1[/* repeated */ js.Any, Unit]): typings.gsap.gsap.TweenLite = (^.asInstanceOf[js.Dynamic].applyDynamic("delayedCall")(delay.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[typings.gsap.gsap.TweenLite]
  @scala.inline
  def delayedCall(delay: Double, callback: js.Function1[/* repeated */ js.Any, Unit], params: js.Array[js.Any]): typings.gsap.gsap.TweenLite = (^.asInstanceOf[js.Dynamic].applyDynamic("delayedCall")(delay.asInstanceOf[js.Any], callback.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[typings.gsap.gsap.TweenLite]
  @scala.inline
  def delayedCall(
    delay: Double,
  ...
  /* static member */
  @scala.inline
  def from(target: js.Any, duration: Double, vars: js.Any): typings.gsap.gsap.TweenLite = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(target.asInstanceOf[js.Any], duration.asInstanceOf[js.Any], vars.asInstanceOf[js.Any])).asInstanceOf[typings.gsap.gsap.TweenLite]
  ...
  /* static member */
  @scala.inline
  def fromTo(target: js.Any, duration: Double, fromVars: js.Any, toVars: js.Any): typings.gsap.gsap.TweenLite = (^.asInstanceOf[js.Dynamic].applyDynamic("fromTo")(target.asInstanceOf[js.Any], duration.asInstanceOf[js.Any], fromVars.asInstanceOf[js.Any], toVars.asInstanceOf[js.Any])).asInstanceOf[typings.gsap.gsap.TweenLite]
  ...
  /* static member */
  @scala.inline
  def getTweensOf(target: js.Any): js.Array[typings.gsap.gsap.TweenLite] = ^.asInstanceOf[js.Dynamic].applyDynamic("getTweensOf")(target.asInstanceOf[js.Any]).asInstanceOf[js.Array[typings.gsap.gsap.TweenLite]]
  @scala.inline
  def getTweensOf(target: js.Any, onlyActive: Boolean): js.Array[typings.gsap.gsap.TweenLite] = (^.asInstanceOf[js.Dynamic].applyDynamic("getTweensOf")(target.asInstanceOf[js.Any], onlyActive.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.gsap.gsap.TweenLite]]
  ...
  /* static member */
  @scala.inline
  def killTweensOf(target: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("killTweensOf")(target.asInstanceOf[js.Any]).asInstanceOf[Unit]
  @scala.inline
  def killTweensOf(target: js.Any, onlyActive: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("killTweensOf")(target.asInstanceOf[js.Any], onlyActive.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def killTweensOf(target: js.Any, onlyActive: Boolean, vars: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("killTweensOf")(target.asInstanceOf[js.Any], onlyActive.asInstanceOf[js.Any], vars.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def killTweensOf(target: js.Any, onlyActive: Unit, vars: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("killTweensOf")(target.asInstanceOf[js.Any], onlyActive.asInstanceOf[js.Any], vars.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /* static member */
  @scala.inline
  def lagSmoothing(threshold: Double, adjustedLag: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("lagSmoothing")(threshold.asInstanceOf[js.Any], adjustedLag.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /* static member */
  @scala.inline
  def set(target: js.Any, vars: js.Any): typings.gsap.gsap.TweenLite = (^.asInstanceOf[js.Dynamic].applyDynamic("set")(target.asInstanceOf[js.Any], vars.asInstanceOf[js.Any])).asInstanceOf[typings.gsap.gsap.TweenLite]
  ...
  /* static member */
  @scala.inline
  def to(target: js.Any, duration: Double, vars: js.Any): typings.gsap.gsap.TweenLite = (^.asInstanceOf[js.Dynamic].applyDynamic("to")(target.asInstanceOf[js.Any], duration.asInstanceOf[js.Any], vars.asInstanceOf[js.Any])).asInstanceOf[typings.gsap.gsap.TweenLite]
}
