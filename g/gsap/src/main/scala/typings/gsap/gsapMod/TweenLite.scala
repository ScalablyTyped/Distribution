...
class TweenLite protected ()
  extends typings.gsap.gsapNs.TweenLite {
...
object TweenLite extends js.Object {
  ...
  var defaultEase: typings.gsap.gsapNs.Ease = js.native
  ...
  def delayedCall(delay: Double, callback: js.Function1[/* repeated */ js.Any, Unit]): typings.gsap.gsapNs.TweenLite = js.native
  def delayedCall(delay: Double, callback: js.Function1[/* repeated */ js.Any, Unit], params: js.Array[_]): typings.gsap.gsapNs.TweenLite = js.native
  def delayedCall(
    delay: Double,
    callback: js.Function1[/* repeated */ js.Any, Unit],
    params: js.Array[_],
    scope: js.Any
  ): typings.gsap.gsapNs.TweenLite = js.native
  def delayedCall(
    delay: Double,
    callback: js.Function1[/* repeated */ js.Any, Unit],
    params: js.Array[_],
  ...
  /**
    ...
    */
  def from(target: js.Any, duration: Double, vars: js.Any): typings.gsap.gsapNs.TweenLite = js.native
  /**
    ...
    */
  def fromTo(target: js.Any, duration: Double, fromVars: js.Any, toVars: js.Any): typings.gsap.gsapNs.TweenLite = js.native
  /**
    ...
    */
  def getTweensOf(target: js.Any): js.Array[typings.gsap.gsapNs.TweenLite] = js.native
  def getTweensOf(target: js.Any, onlyActive: Boolean): js.Array[typings.gsap.gsapNs.TweenLite] = js.native
  ...
  def set(target: js.Any, vars: js.Any): typings.gsap.gsapNs.TweenLite = js.native
  ...
  def to(target: js.Any, duration: Double, vars: js.Any): typings.gsap.gsapNs.TweenLite = js.native
}
