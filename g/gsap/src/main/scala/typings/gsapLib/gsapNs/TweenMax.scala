...
class TweenMax protected () extends TweenLite {
  ...
  def repeat(value: scala.Double): TweenMax = js.native
  ...
  def repeatDelay(value: scala.Double): TweenMax = js.native
  ...
  def updateTo(vars: js.Object, resetDuration: scala.Boolean): TweenMax = js.native
  def yoyo(): TweenMax = js.native
  def yoyo(value: scala.Boolean): TweenMax = js.native
