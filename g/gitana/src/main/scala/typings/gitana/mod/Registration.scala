...
@js.native
open class Registration protected () extends StObject {
  def this(application: Any, `object`: Any) = this()
  
  def base(): Unit = js.native
  
  def confirm(newUserPassword: Any, paymentMethodObject: Any): Any = js.native
  
  def getType(): Any = js.native
  
  def getUri(): Any = js.native
  
  def sendConfirmationEmail(): Any = js.native
  
  def sendWelcomeEmail(): Any = js.native
}
object Registration {
