...
@js.native
open class AbstractPersistable protected () extends Chainable {
  def this(driver: Any, `object`: Any) = this()
  
  def handleResponse(response: Any): Unit = js.native
  
  def handleSystemProperties(response: Any): Unit = js.native
