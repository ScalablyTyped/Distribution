...
@js.native
open class LogEntry protected () extends AbstractObject {
  def this(platform: Any, `object`: Any) = this()
  
  def getBranchId(): Any = js.native
  
  def getClassDescriptor(): Any = js.native
  
  def getFilename(): Any = js.native
  
  def getLevel(): Any = js.native
  
  def getLineNumber(): Any = js.native
  ...
  def getRepositoryId(): Any = js.native
  
  def getThread(): Any = js.native
  
  def getThrowables(): Any = js.native
