...
@js.native
open class TraversalResults protected () extends AbstractPersistable {
  def this(branch: Any, `object`: Any) = this()
  
  def association(id: String): Association = js.native
  
  def associationCount(callback: Any): this.type = js.native
  
  def associations(): NodeMap = js.native
  
  def center(): Any = js.native
  
  def clear(): Unit = js.native
  
  def node(id: String): Node = js.native
  
  def nodeCount(callback: Any): this.type = js.native
