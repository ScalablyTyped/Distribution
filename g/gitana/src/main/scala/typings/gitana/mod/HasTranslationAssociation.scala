...
@js.native
open class HasTranslationAssociation protected () extends Association {
  def this(branch: Any, `object`: Any) = this()
  
  def getEdition(): Any = js.native
  
  def getLocale(): Any = js.native
  
  def setEdition(edition: Any): Unit = js.native
  
  def setLocale(locale: Any): Unit = js.native
}
