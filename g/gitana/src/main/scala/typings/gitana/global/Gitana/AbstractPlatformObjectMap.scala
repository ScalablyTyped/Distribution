...
@JSGlobal("Gitana.AbstractPlatformObjectMap")
@js.native
open class AbstractPlatformObjectMap protected ()
  extends typings.gitana.mod.AbstractPlatformObjectMap {
  def this(platform: Any, `object`: Any) = this()
}
object AbstractPlatformObjectMap {
