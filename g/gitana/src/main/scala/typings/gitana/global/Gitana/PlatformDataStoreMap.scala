...
@JSGlobal("Gitana.PlatformDataStoreMap")
@js.native
open class PlatformDataStoreMap protected ()
  extends typings.gitana.mod.PlatformDataStoreMap {
  def this(platform: Any, `object`: Any) = this()
}
object PlatformDataStoreMap {
