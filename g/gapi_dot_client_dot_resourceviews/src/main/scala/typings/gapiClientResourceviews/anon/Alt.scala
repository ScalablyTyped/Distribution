...
object Alt {
  @scala.inline
  def apply(operation: String, project: String, zone: String): Alt = {
    val __obj = js.Dynamic.literal(operation = operation.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
