...
trait PrettyPrint extends js.Object {
  ...
  var resourceView: String = js.native
...
object PrettyPrint {
  @scala.inline
  def apply(project: String, resourceView: String, zone: String): PrettyPrint = {
  ...
  implicit class PrettyPrintOps[Self <: PrettyPrint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResourceView(value: String): Self = this.set("resourceView", value.asInstanceOf[js.Any])
    @scala.inline
