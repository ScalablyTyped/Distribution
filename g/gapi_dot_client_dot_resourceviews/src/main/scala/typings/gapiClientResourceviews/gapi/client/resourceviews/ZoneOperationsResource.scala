...
import typings.gapiClientResourceviews.AnonAltFields
...
object ZoneOperationsResource {
  @scala.inline
  def apply(get: AnonAlt => Request_[Operation], list: AnonAltFields => Request_[OperationList]): ZoneOperationsResource = {
