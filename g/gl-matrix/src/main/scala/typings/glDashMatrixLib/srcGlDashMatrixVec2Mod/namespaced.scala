package typings
package glDashMatrixLib.srcGlDashMatrixVec2Mod
...
@js.native
class namespaced ()
  extends glDashMatrixLib.glDashMatrixMod.vec2
...
object namespaced extends js.Object {
  ...
  def forEach(
    ...
    count: scala.Double,
    fn: js.Function2[
      /* a */ glDashMatrixLib.glDashMatrixMod.vec2 | js.Array[scala.Double], 
      /* b */ glDashMatrixLib.glDashMatrixMod.vec2 | js.Array[scala.Double], 
      scala.Unit
    ]
