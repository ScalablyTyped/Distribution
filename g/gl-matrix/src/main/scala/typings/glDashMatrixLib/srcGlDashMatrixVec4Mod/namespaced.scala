package typings
package glDashMatrixLib.srcGlDashMatrixVec4Mod
...
object namespaced extends js.Object {
  ...
  def forEach(
    ...
    count: scala.Double,
    fn: js.Function2[
      /* a */ glDashMatrixLib.glDashMatrixMod.vec4 | js.Array[scala.Double], 
      /* b */ glDashMatrixLib.glDashMatrixMod.vec4 | js.Array[scala.Double], 
      scala.Unit
    ]
