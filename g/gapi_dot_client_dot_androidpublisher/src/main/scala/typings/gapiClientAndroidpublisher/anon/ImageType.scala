...
object ImageType {
  @scala.inline
  def apply(editId: String, imageType: String, language: String, packageName: String): ImageType = {
    val __obj = js.Dynamic.literal(editId = editId.asInstanceOf[js.Any], imageType = imageType.asInstanceOf[js.Any], language = language.asInstanceOf[js.Any], packageName = packageName.asInstanceOf[js.Any])
    __obj.asInstanceOf[ImageType]
  }
  @scala.inline
  implicit class ImageTypeOps[Self <: ImageType] (val x: Self) extends AnyVal {
    @scala.inline
