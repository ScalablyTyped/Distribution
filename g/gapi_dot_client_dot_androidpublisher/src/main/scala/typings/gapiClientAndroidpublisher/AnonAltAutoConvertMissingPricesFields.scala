...
trait AnonAltAutoConvertMissingPricesFields extends js.Object {
...
object AnonAltAutoConvertMissingPricesFields {
  @scala.inline
  def apply(
    packageName: String,
    sku: String,
    ...
    userIp: String = null
  ): AnonAltAutoConvertMissingPricesFields = {
    ...
    __obj.asInstanceOf[AnonAltAutoConvertMissingPricesFields]
  }
}
