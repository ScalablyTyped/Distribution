...
trait AnonAltEditIdFieldsKeyOauthtoken extends js.Object {
...
object AnonAltEditIdFieldsKeyOauthtoken {
  @scala.inline
  def apply(
    editId: String,
    packageName: String,
    ...
    userIp: String = null
  ): AnonAltEditIdFieldsKeyOauthtoken = {
    ...
    __obj.asInstanceOf[AnonAltEditIdFieldsKeyOauthtoken]
  }
}
