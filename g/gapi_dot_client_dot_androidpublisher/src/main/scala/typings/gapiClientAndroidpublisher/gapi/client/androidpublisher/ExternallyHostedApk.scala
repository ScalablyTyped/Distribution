...
object ExternallyHostedApk {
  ...
  implicit class ExternallyHostedApkOps[Self <: ExternallyHostedApk] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUsesPermissionsVarargs(value: ExternallyHostedApkUsesPermission*): Self = this.set("usesPermissions", js.Array(value :_*))
    @scala.inline
    def setUsesPermissions(value: js.Array[ExternallyHostedApkUsesPermission]): Self = this.set("usesPermissions", value.asInstanceOf[js.Any])
    @scala.inline
