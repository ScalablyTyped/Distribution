...
trait AnonAltFieldsKeyOauthtokenPackageNamePrettyPrintQuotaUserReviewId extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPackageNamePrettyPrintQuotaUserReviewId {
  @scala.inline
  def apply(
    packageName: String,
    reviewId: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPackageNamePrettyPrintQuotaUserReviewId = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPackageNamePrettyPrintQuotaUserReviewId]
  }
}
