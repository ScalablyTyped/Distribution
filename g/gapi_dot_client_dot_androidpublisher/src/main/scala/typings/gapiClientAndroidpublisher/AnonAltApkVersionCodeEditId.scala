...
trait AnonAltApkVersionCodeEditId extends js.Object {
...
object AnonAltApkVersionCodeEditId {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAltApkVersionCodeEditId]
  }
}
