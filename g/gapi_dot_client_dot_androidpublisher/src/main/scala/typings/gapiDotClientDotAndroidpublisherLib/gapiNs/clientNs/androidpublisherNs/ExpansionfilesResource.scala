...
trait ExpansionfilesResource extends js.Object {
  ...
  def upload(request: gapiDotClientDotAndroidpublisherLib.Anon_PrettyPrintPackageName): gapiDotClientLib.gapiNs.clientNs.Request[ExpansionFilesUploadResponse]
}
