...
trait Anon_AltFieldsKeyOauthtokenPackageName extends js.Object {
...
object Anon_AltFieldsKeyOauthtokenPackageName {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltFieldsKeyOauthtokenPackageName]
  }
}
