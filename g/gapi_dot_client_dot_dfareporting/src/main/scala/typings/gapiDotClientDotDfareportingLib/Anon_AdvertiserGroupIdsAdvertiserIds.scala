...
trait Anon_AdvertiserGroupIdsAdvertiserIds extends js.Object {
  ...
  var atLeastOneOptimizationActivity: js.UndefOr[scala.Boolean] = js.undefined
  /** Exclude campaigns with these IDs. */
  var excludedIds: js.UndefOr[java.lang.String] = js.undefined
...
object Anon_AdvertiserGroupIdsAdvertiserIds {
  @scala.inline
  def apply(
    ...
    atLeastOneOptimizationActivity: js.UndefOr[scala.Boolean] = js.undefined,
    excludedIds: java.lang.String = null,
    ...
    if (!js.isUndefined(atLeastOneOptimizationActivity)) __obj.updateDynamic("atLeastOneOptimizationActivity")(atLeastOneOptimizationActivity)
    if (excludedIds != null) __obj.updateDynamic("excludedIds")(excludedIds)
    ...
    __obj.asInstanceOf[Anon_AdvertiserGroupIdsAdvertiserIds]
  }
}
