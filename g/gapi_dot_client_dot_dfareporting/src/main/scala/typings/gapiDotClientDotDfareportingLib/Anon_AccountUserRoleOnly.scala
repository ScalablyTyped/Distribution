...
trait Anon_AccountUserRoleOnly extends js.Object {
  /** Select only account level user roles not associated with any specific subaccount. */
  var accountUserRoleOnly: js.UndefOr[scala.Boolean] = js.undefined
...
object Anon_AccountUserRoleOnly {
  @scala.inline
  def apply(
    profileId: java.lang.String,
    accountUserRoleOnly: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    __obj.asInstanceOf[Anon_AccountUserRoleOnly]
  }
}
