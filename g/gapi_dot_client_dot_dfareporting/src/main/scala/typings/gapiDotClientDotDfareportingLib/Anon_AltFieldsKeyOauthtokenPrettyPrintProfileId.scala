...
trait Anon_AltFieldsKeyOauthtokenPrettyPrintProfileId extends js.Object {
...
object Anon_AltFieldsKeyOauthtokenPrettyPrintProfileId {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltFieldsKeyOauthtokenPrettyPrintProfileId]
  }
}
