...
object Anon_AdvertiserIdAltFields {
  ...
  def apply(
    ...
    floodlightActivityGroupIds: java.lang.String = null,
    ...
    if (floodlightActivityGroupIds != null) __obj.updateDynamic("floodlightActivityGroupIds")(floodlightActivityGroupIds)
