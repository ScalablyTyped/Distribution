...
object Anon_AltDefaultLandingPageName {
  @scala.inline
  def apply(
    defaultLandingPageName: java.lang.String,
    defaultLandingPageUrl: java.lang.String,
    ...
    __obj.asInstanceOf[Anon_AltDefaultLandingPageName]
  }
}
