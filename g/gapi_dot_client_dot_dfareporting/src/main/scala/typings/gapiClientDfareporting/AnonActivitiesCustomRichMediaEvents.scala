...
trait AnonActivitiesCustomRichMediaEvents extends js.Object {
  /** Activity group. */
...
object AnonActivitiesCustomRichMediaEvents {
  @scala.inline
  def apply(
  ...
  ): AnonActivitiesCustomRichMediaEvents = {
    ...
    __obj.asInstanceOf[AnonActivitiesCustomRichMediaEvents]
  }
}
