...
trait AnonAltFieldsIdsKeyMaxResults extends js.Object {
...
object AnonAltFieldsIdsKeyMaxResults {
  @scala.inline
  def apply(
    profileId: String,
    projectId: String,
    ...
    __obj.asInstanceOf[AnonAltFieldsIdsKeyMaxResults]
  }
}
