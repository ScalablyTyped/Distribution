...
trait AnonActiveAdvertiserIdAltFieldsKey extends js.Object {
...
object AnonActiveAdvertiserIdAltFieldsKey {
  @scala.inline
  def apply(
    advertiserId: String,
    profileId: String,
    ...
    userIp: String = null
  ): AnonActiveAdvertiserIdAltFieldsKey = {
    ...
    __obj.asInstanceOf[AnonActiveAdvertiserIdAltFieldsKey]
  }
}
