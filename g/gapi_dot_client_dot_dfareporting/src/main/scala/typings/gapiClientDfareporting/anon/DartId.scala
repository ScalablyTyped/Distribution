...
@js.native
trait DartId extends js.Object {
  /** Data format for the response. */
  var alt: js.UndefOr[String] = js.native
  /** Operating system DART ID. */
  var dartId: String = js.native
...
object DartId {
  @scala.inline
  def apply(dartId: String, profileId: String): DartId = {
    val __obj = js.Dynamic.literal(dartId = dartId.asInstanceOf[js.Any], profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[DartId]
  }
  @scala.inline
  implicit class DartIdOps[Self <: DartId] (val x: Self) extends AnyVal {
    @scala.inline
