...
trait Activities extends js.Object {
  /** Activity group. */
  var activities: js.UndefOr[typings.gapiClientDfareporting.gapi.client.dfareporting.Activities] = js.native
  /** Custom Rich Media Events group. */
  var customRichMediaEvents: js.UndefOr[typings.gapiClientDfareporting.gapi.client.dfareporting.CustomRichMediaEvents] = js.native
...
object Activities {
  ...
  implicit class ActivitiesOps[Self <: Activities] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActivities(value: typings.gapiClientDfareporting.gapi.client.dfareporting.Activities): Self = this.set("activities", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteActivities: Self = this.set("activities", js.undefined)
    @scala.inline
    def setCustomRichMediaEvents(value: typings.gapiClientDfareporting.gapi.client.dfareporting.CustomRichMediaEvents): Self = this.set("customRichMediaEvents", value.asInstanceOf[js.Any])
    @scala.inline
