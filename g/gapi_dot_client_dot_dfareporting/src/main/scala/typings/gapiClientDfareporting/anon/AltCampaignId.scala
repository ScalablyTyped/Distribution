...
@js.native
trait AltCampaignId extends js.Object {
...
object AltCampaignId {
  @scala.inline
  def apply(campaignId: String, id: String, profileId: String): AltCampaignId = {
    ...
    __obj.asInstanceOf[AltCampaignId]
  }
  @scala.inline
  implicit class AltCampaignIdOps[Self <: AltCampaignId] (val x: Self) extends AnyVal {
    @scala.inline
