...
object Name {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], objectId = objectId.asInstanceOf[js.Any], objectType = objectType.asInstanceOf[js.Any], profileId = profileId.asInstanceOf[js.Any])
