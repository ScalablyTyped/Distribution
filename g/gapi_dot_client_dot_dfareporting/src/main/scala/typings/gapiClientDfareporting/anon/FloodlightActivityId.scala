...
@js.native
trait FloodlightActivityId extends js.Object {
...
object FloodlightActivityId {
  @scala.inline
  def apply(profileId: String): FloodlightActivityId = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FloodlightActivityId]
  }
  @scala.inline
  implicit class FloodlightActivityIdOps[Self <: FloodlightActivityId] (val x: Self) extends AnyVal {
    @scala.inline
