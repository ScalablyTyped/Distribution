...
trait AnonAltCampaignIdFieldsKey extends js.Object {
...
object AnonAltCampaignIdFieldsKey {
  @scala.inline
  def apply(
    profileId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltCampaignIdFieldsKey]
  }
}
