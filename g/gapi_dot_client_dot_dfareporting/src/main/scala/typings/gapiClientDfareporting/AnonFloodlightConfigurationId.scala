...
trait AnonFloodlightConfigurationId extends js.Object {
  /**
...
object AnonFloodlightConfigurationId {
  @scala.inline
  def apply(
    profileId: String,
    ...
    __obj.asInstanceOf[AnonFloodlightConfigurationId]
  }
}
