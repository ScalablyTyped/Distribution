...
trait AnonAdvertiserIdsAltArchivedCampaignIds extends js.Object {
...
object AnonAdvertiserIdsAltArchivedCampaignIds {
  @scala.inline
  def apply(
    profileId: String,
    ...
    userIp: String = null
  ): AnonAdvertiserIdsAltArchivedCampaignIds = {
    ...
    __obj.asInstanceOf[AnonAdvertiserIdsAltArchivedCampaignIds]
  }
}
