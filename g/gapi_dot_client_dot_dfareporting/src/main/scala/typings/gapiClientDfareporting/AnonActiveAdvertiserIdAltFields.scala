...
trait AnonActiveAdvertiserIdAltFields extends js.Object {
...
object AnonActiveAdvertiserIdAltFields {
  @scala.inline
  def apply(
    advertiserId: String,
    profileId: String,
    ...
    userIp: String = null
  ): AnonActiveAdvertiserIdAltFields = {
    ...
    __obj.asInstanceOf[AnonActiveAdvertiserIdAltFields]
  }
}
