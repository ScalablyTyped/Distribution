...
trait AnonAdvertiserIdAltFieldsFloodlightConfigurationId extends js.Object {
  /**
...
object AnonAdvertiserIdAltFieldsFloodlightConfigurationId {
  @scala.inline
  def apply(
    profileId: String,
    ...
    `type`: String = null,
    userIp: String = null
  ): AnonAdvertiserIdAltFieldsFloodlightConfigurationId = {
    ...
    __obj.asInstanceOf[AnonAdvertiserIdAltFieldsFloodlightConfigurationId]
  }
}
