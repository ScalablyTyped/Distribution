...
trait ChangeLogsResource extends js.Object {
  ...
  def get(request: AnonAltFields): Request_[ChangeLog]
...
object ChangeLogsResource {
  @scala.inline
  def apply(get: AnonAltFields => Request_[ChangeLog], list: AnonAction => Request_[ChangeLogsListResponse]): ChangeLogsResource = {
