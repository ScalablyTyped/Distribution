...
import typings.gapiClientDfareporting.AnonAltFieldsKeyName
...
trait DynamicTargetingKeysResource extends js.Object {
  ...
  def delete(request: AnonAltFieldsKeyName): Request_[Unit]
  /**
    ...
    */
  def insert(request: AnonAltFieldsKey): Request_[DynamicTargetingKey]
  /** Retrieves a list of dynamic targeting keys. */
  def list(request: AnonAdvertiserIdAlt): Request_[DynamicTargetingKeysListResponse]
}

object DynamicTargetingKeysResource {
  @scala.inline
  def apply(
    delete: AnonAltFieldsKeyName => Request_[Unit],
    insert: AnonAltFieldsKey => Request_[DynamicTargetingKey],
    list: AnonAdvertiserIdAlt => Request_[DynamicTargetingKeysListResponse]
