...
trait CreativeAssetsResource extends js.Object {
  ...
  def insert(request: AnonAdvertiserId): Request_[CreativeAssetMetadata]
}

object CreativeAssetsResource {
  @scala.inline
  def apply(insert: AnonAdvertiserId => Request_[CreativeAssetMetadata]): CreativeAssetsResource = {
