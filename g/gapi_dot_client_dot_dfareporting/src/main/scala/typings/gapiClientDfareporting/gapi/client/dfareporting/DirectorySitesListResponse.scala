...
object DirectorySitesListResponse {
  ...
  implicit class DirectorySitesListResponseOps[Self <: DirectorySitesListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDirectorySitesVarargs(value: DirectorySite*): Self = this.set("directorySites", js.Array(value :_*))
    @scala.inline
    def setDirectorySites(value: js.Array[DirectorySite]): Self = this.set("directorySites", value.asInstanceOf[js.Any])
    @scala.inline
