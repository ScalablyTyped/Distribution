...
object ReportList {
  @scala.inline
  def apply(): ReportList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReportList]
  }
  @scala.inline
  implicit class ReportListOps[Self <: ReportList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: Report*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Report]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
