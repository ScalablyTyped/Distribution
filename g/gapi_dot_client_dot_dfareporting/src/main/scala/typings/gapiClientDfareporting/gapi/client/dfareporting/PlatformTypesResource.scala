...
trait PlatformTypesResource extends js.Object {
  ...
  def get(request: AnonAltFields): Request_[PlatformType]
  /** Retrieves a list of platform types. */
  def list(request: AnonAltFieldsKey): Request_[PlatformTypesListResponse]
}

object PlatformTypesResource {
  @scala.inline
  def apply(
    get: AnonAltFields => Request_[PlatformType],
    list: AnonAltFieldsKey => Request_[PlatformTypesListResponse]
