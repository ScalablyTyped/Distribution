...
trait AnonAltCampaignIdFieldsId extends js.Object {
...
object AnonAltCampaignIdFieldsId {
  @scala.inline
  def apply(
    campaignId: String,
    id: String,
    ...
    __obj.asInstanceOf[AnonAltCampaignIdFieldsId]
  }
}
