...
trait AnonAdvertiserGroupIdsAdvertiserIds extends js.Object {
...
object AnonAdvertiserGroupIdsAdvertiserIds {
  @scala.inline
  def apply(
    profileId: String,
    ...
    userIp: String = null
  ): AnonAdvertiserGroupIdsAdvertiserIds = {
    ...
    __obj.asInstanceOf[AnonAdvertiserGroupIdsAdvertiserIds]
  }
}
