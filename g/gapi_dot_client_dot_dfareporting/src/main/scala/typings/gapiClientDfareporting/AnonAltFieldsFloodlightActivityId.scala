...
trait AnonAltFieldsFloodlightActivityId extends js.Object {
...
object AnonAltFieldsFloodlightActivityId {
  @scala.inline
  def apply(
    profileId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsFloodlightActivityId = {
    ...
    __obj.asInstanceOf[AnonAltFieldsFloodlightActivityId]
  }
}
