...
trait AnonAdvertiserIdAltFieldsIds extends js.Object {
...
object AnonAdvertiserIdAltFieldsIds {
  @scala.inline
  def apply(
    profileId: String,
    ...
    __obj.asInstanceOf[AnonAdvertiserIdAltFieldsIds]
  }
}
