...
trait AnonAdvertiserIdsAltArchived extends js.Object {
...
object AnonAdvertiserIdsAltArchived {
  @scala.inline
  def apply(
    profileId: String,
    ...
    __obj.asInstanceOf[AnonAdvertiserIdsAltArchived]
  }
}
