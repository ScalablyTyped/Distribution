...
trait AnonAdvertiserIdAltFields extends js.Object {
  /**
...
object AnonAdvertiserIdAltFields {
  @scala.inline
  def apply(
    profileId: String,
    ...
    __obj.asInstanceOf[AnonAdvertiserIdAltFields]
  }
}
