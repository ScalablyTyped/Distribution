...
trait Anon_ActiveAdvertiserIdAltFields extends js.Object {
...
object Anon_ActiveAdvertiserIdAltFields {
  @scala.inline
  def apply(
    advertiserId: String,
    profileId: String,
    ...
    userIp: String = null
  ): Anon_ActiveAdvertiserIdAltFields = {
    ...
    __obj.asInstanceOf[Anon_ActiveAdvertiserIdAltFields]
  }
}
