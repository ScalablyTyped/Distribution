...
trait Anon_AltFieldsFloodlightActivityId extends js.Object {
...
object Anon_AltFieldsFloodlightActivityId {
  @scala.inline
  def apply(
    profileId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): Anon_AltFieldsFloodlightActivityId = {
    ...
    __obj.asInstanceOf[Anon_AltFieldsFloodlightActivityId]
  }
}
