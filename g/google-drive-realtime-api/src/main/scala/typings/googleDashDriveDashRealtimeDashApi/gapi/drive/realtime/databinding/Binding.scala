package typings.googleDashDriveDashRealtimeDashApi.gapi.drive.realtime.databinding

import typings.googleDashDriveDashRealtimeDashApi.gapi.drive.realtime.CollaborativeObject
