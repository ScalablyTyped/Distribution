...
import typings.googleDashDriveDashRealtimeDashApi.gapiNs.driveNs.realtimeNs.Document
import typings.googleDashDriveDashRealtimeDashApi.gapiNs.driveNs.realtimeNs.Model
