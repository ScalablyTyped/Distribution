package typings.googleDashDriveDashRealtimeDashApi.gapiNs.driveNs.realtimeNs.databindingNs

import typings.googleDashDriveDashRealtimeDashApi.gapiNs.driveNs.realtimeNs.CollaborativeObject
