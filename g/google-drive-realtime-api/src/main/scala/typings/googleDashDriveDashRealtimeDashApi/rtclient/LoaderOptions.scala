...
import typings.googleDashDriveDashRealtimeDashApi.gapi.drive.realtime.Document
import typings.googleDashDriveDashRealtimeDashApi.gapi.drive.realtime.Model
