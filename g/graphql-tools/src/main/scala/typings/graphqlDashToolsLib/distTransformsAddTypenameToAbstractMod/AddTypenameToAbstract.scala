package typings
package graphqlDashToolsLib.distTransformsAddTypenameToAbstractMod
...
trait AddTypenameToAbstract
  ...
  def transformRequest_MAddTypenameToAbstract(originalRequest: graphqlDashToolsLib.distInterfacesMod.Request): graphqlDashToolsLib.distInterfacesMod.Request
}
