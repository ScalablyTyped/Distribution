...
trait IResolverOptions[TSource, TContext] extends js.Object {
  ...
  var resolve: js.UndefOr[IFieldResolver[TSource, TContext, ScalablyTyped.runtime.StringDictionary[_]]] = js.undefined
  var subscribe: js.UndefOr[IFieldResolver[TSource, TContext, ScalablyTyped.runtime.StringDictionary[_]]] = js.undefined
}
