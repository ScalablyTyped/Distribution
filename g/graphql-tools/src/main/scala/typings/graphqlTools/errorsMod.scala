...
import typings.graphqlTools.anon.Error
import typings.graphqlTools.anon.Errors
...
object errorsMod extends js.Object {
  ...
  def getErrorsFromParent(`object`: js.Any, fieldName: String): Error | Errors = js.native
}
