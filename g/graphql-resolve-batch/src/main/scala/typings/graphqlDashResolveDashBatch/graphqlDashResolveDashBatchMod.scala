...
import typings.graphqlDashResolveDashBatch.graphqlDashResolveDashBatchMod.BatchResolveFunction
import typings.graphqlDashResolveDashBatch.graphqlDashResolveDashBatchMod.ResolverFunction
