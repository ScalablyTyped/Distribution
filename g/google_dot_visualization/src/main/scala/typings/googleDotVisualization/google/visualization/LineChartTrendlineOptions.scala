...
trait LineChartTrendlineOptions extends js.Object {
...
object LineChartTrendlineOptions {
  @scala.inline
  def apply(
    color: String = null,
    ...
    __obj.asInstanceOf[LineChartTrendlineOptions]
  }
}
