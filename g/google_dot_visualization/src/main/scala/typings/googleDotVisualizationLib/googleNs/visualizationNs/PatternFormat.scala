...
class PatternFormat protected () extends js.Object {
  ...
  /**
    ...
    */
  def format(dataTable: DataTable, srcColumnIndices: js.Array[scala.Double]): scala.Unit = js.native
  def format(dataTable: DataTable, srcColumnIndices: js.Array[scala.Double], opt_dstColumnIndex: scala.Double): scala.Unit = js.native
}
