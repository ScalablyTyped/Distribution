...
class ColorFormat () extends DefaultFormatter {
  /**
               ...
               */
  def addGradientRange(
    from: js.Any,
    to: js.Any,
    color: java.lang.String,
    fromBgColor: java.lang.String,
    toBgColor: java.lang.String
  ...
  /**
               ...
               */
  def addRange(from: js.Any, to: js.Any, color: java.lang.String, bgcolor: java.lang.String): scala.Unit = js.native
}
