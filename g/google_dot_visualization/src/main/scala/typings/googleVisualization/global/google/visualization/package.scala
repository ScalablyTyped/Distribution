...
@scala.inline
def arrayToDataTable(data: js.Array[js.Any]): typings.googleVisualization.google.visualization.DataTable = typings.googleVisualization.global.google.visualization.^.asInstanceOf[js.Dynamic].applyDynamic("arrayToDataTable")(data.asInstanceOf[js.Any]).asInstanceOf[typings.googleVisualization.google.visualization.DataTable]
@scala.inline
def arrayToDataTable(data: js.Array[js.Any], firstRowIsData: scala.Boolean): typings.googleVisualization.google.visualization.DataTable = (typings.googleVisualization.global.google.visualization.^.asInstanceOf[js.Dynamic].applyDynamic("arrayToDataTable")(data.asInstanceOf[js.Any], firstRowIsData.asInstanceOf[js.Any])).asInstanceOf[typings.googleVisualization.google.visualization.DataTable]
