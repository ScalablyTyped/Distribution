...
object ColorFormat {
  ...
  inline def apply(
    addGradientRange: (Any, Any, String, String, String) => Unit,
    addRange: (Any, Any, String, String) => Unit,
  ...
  implicit open class MutableBuilder[Self <: ColorFormat] (val x: Self) extends AnyVal {
    ...
    inline def setAddRange(value: (Any, Any, String, String) => Unit): Self = StObject.set(x, "addRange", js.Any.fromFunction4(value))
  }
}
