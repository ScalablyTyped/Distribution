...
object BubbleChartOptions {
  ...
  implicit class BubbleChartOptionsOps[Self <: BubbleChartOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBubble(value: ChartBubble): Self = this.set("bubble", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSortBubblesBySize(value: Boolean): Self = this.set("sortBubblesBySize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSortBubblesBySize: Self = this.set("sortBubblesBySize", js.undefined)
