...
object LineChartOptions {
  ...
  @scala.inline
  implicit class LineChartOptionsMutableBuilder[Self <: LineChartOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDomainAxis(value: Type): Self = StObject.set(x, "domainAxis", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDomainAxisUndefined: Self = StObject.set(x, "domainAxis", js.undefined)
    ...
    @scala.inline
    def setIntervals(value: Style): Self = StObject.set(x, "intervals", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSeries(value: js.Array[LineChartSeriesOptions] | NumberDictionary[LineChartSeriesOptions]): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSeriesUndefined: Self = StObject.set(x, "series", js.undefined)
    
    @scala.inline
    def setSeriesVarargs(value: LineChartSeriesOptions*): Self = StObject.set(x, "series", js.Array(value :_*))
