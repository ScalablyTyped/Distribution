...
object ColumnChartOptions {
  ...
  @scala.inline
  implicit class ColumnChartOptionsMutableBuilder[Self <: ColumnChartOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnnotations(value: ChartBarColumnAnnotations): Self = StObject.set(x, "annotations", value.asInstanceOf[js.Any])
