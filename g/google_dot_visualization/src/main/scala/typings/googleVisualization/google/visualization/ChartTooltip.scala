...
object ChartTooltip {
  ...
  def apply(
    ...
    if (!js.isUndefined(ignoreBounds)) __obj.updateDynamic("ignoreBounds")(ignoreBounds.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isHtml)) __obj.updateDynamic("isHtml")(isHtml.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showColorCode)) __obj.updateDynamic("showColorCode")(showColorCode.get.asInstanceOf[js.Any])
