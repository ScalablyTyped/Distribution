...
object BarChartOptions {
  ...
  @scala.inline
  implicit class BarChartOptionsOps[Self <: BarChartOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHAxes(value: js.Any): Self = this.set("hAxes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHAxes: Self = this.set("hAxes", js.undefined)
