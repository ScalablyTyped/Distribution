...
trait BarChartOptions extends StObject {
  ...
  var hAxes: js.UndefOr[js.Any] = js.native
...
object BarChartOptions {
  ...
  @scala.inline
  def apply(): BarChartOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BarChartOptions]
  }
  
  @scala.inline
  implicit class BarChartOptionsMutableBuilder[Self <: BarChartOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHAxes(value: js.Any): Self = StObject.set(x, "hAxes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHAxesUndefined: Self = StObject.set(x, "hAxes", js.undefined)
