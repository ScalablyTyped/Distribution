...
trait CardService extends js.Object {
  ...
  var NotificationType: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof NotificationType */ js.Any
...
object CardService {
  ...
  def apply(
    ...
    NotificationType: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof NotificationType */ js.Any,
    ...
    newAction: js.Function0[Action],
    newActionResponseBuilder: js.Function0[ActionResponseBuilder],
    newAuthorizationAction: js.Function0[AuthorizationAction],
    newAuthorizationException: js.Function0[AuthorizationException],
    newButtonSet: js.Function0[ButtonSet],
    newCardAction: js.Function0[CardAction],
    newCardBuilder: js.Function0[CardBuilder],
    newCardHeader: js.Function0[CardHeader],
    newCardSection: js.Function0[CardSection],
    newComposeActionResponseBuilder: js.Function0[ComposeActionResponseBuilder],
    newImage: js.Function0[Image],
    newImageButton: js.Function0[ImageButton],
    newKeyValue: js.Function0[KeyValue],
    newNavigation: js.Function0[Navigation],
    newNotification: js.Function0[Notification],
    newOpenLink: js.Function0[OpenLink],
    newSelectionInput: js.Function0[SelectionInput],
    newSuggestions: js.Function0[Suggestions],
    newSuggestionsResponseBuilder: js.Function0[SuggestionsResponseBuilder],
    newSwitch: js.Function0[Switch],
    newTextButton: js.Function0[TextButton],
    newTextInput: js.Function0[TextInput],
    newTextParagraph: js.Function0[TextParagraph],
    newUniversalActionResponseBuilder: js.Function0[UniversalActionResponseBuilder],
    newUpdateDraftActionResponseBuilder: js.Function0[UpdateDraftActionResponseBuilder],
    newUpdateDraftBodyAction: js.Function0[UpdateDraftBodyAction]
  ): CardService = {
    val __obj = js.Dynamic.literal(ComposedEmailType = ComposedEmailType, ContentType = ContentType, Icon = Icon, ImageStyle = ImageStyle, LoadIndicator = LoadIndicator, NotificationType = NotificationType, OnClose = OnClose, OpenAs = OpenAs, SelectionInputType = SelectionInputType, TextButtonStyle = TextButtonStyle, UpdateDraftBodyType = UpdateDraftBodyType, newAction = newAction, newActionResponseBuilder = newActionResponseBuilder, newAuthorizationAction = newAuthorizationAction, newAuthorizationException = newAuthorizationException, newButtonSet = newButtonSet, newCardAction = newCardAction, newCardBuilder = newCardBuilder, newCardHeader = newCardHeader, newCardSection = newCardSection, newComposeActionResponseBuilder = newComposeActionResponseBuilder, newImage = newImage, newImageButton = newImageButton, newKeyValue = newKeyValue, newNavigation = newNavigation, newNotification = newNotification, newOpenLink = newOpenLink, newSelectionInput = newSelectionInput, newSuggestions = newSuggestions, newSuggestionsResponseBuilder = newSuggestionsResponseBuilder, newSwitch = newSwitch, newTextButton = newTextButton, newTextInput = newTextInput, newTextParagraph = newTextParagraph, newUniversalActionResponseBuilder = newUniversalActionResponseBuilder, newUpdateDraftActionResponseBuilder = newUpdateDraftActionResponseBuilder, newUpdateDraftBodyAction = newUpdateDraftBodyAction)
