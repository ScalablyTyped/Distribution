...
trait ChannelsCollection extends js.Object {
  ...
  def stop(resource: googleDashAppsDashScriptLib.GoogleAppsScriptNs.AdminDirectoryNs.SchemaNs.Channel): scala.Unit
}

object ChannelsCollection {
  @scala.inline
  def apply(
    stop: googleDashAppsDashScriptLib.GoogleAppsScriptNs.AdminDirectoryNs.SchemaNs.Channel => scala.Unit
  ): ChannelsCollection = {
