...
trait TeamDriveCapabilities extends js.Object {
  ...
  var canChangeCopyRequiresWriterPermissionRestriction: js.UndefOr[scala.Boolean] = js.undefined
  var canChangeDomainUsersOnlyRestriction: js.UndefOr[scala.Boolean] = js.undefined
  var canChangeTeamDriveBackground: js.UndefOr[scala.Boolean] = js.undefined
  var canChangeTeamMembersOnlyRestriction: js.UndefOr[scala.Boolean] = js.undefined
  var canComment: js.UndefOr[scala.Boolean] = js.undefined
  var canCopy: js.UndefOr[scala.Boolean] = js.undefined
  var canDeleteChildren: js.UndefOr[scala.Boolean] = js.undefined
  ...
  var canTrashChildren: js.UndefOr[scala.Boolean] = js.undefined
}
...
object TeamDriveCapabilities {
  ...
  def apply(
    ...
    canChangeCopyRequiresWriterPermissionRestriction: js.UndefOr[scala.Boolean] = js.undefined,
    canChangeDomainUsersOnlyRestriction: js.UndefOr[scala.Boolean] = js.undefined,
    canChangeTeamDriveBackground: js.UndefOr[scala.Boolean] = js.undefined,
    canChangeTeamMembersOnlyRestriction: js.UndefOr[scala.Boolean] = js.undefined,
    canComment: js.UndefOr[scala.Boolean] = js.undefined,
    canCopy: js.UndefOr[scala.Boolean] = js.undefined,
    canDeleteChildren: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    canTrashChildren: js.UndefOr[scala.Boolean] = js.undefined
