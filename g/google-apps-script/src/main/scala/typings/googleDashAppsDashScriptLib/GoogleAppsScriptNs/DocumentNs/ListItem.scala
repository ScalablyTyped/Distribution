...
trait ListItem extends js.Object {
  ...
  def setIndentEnd(indentEnd: stdLib.Number): ListItem = js.native
  def setIndentFirstLine(indentFirstLine: stdLib.Number): ListItem = js.native
  def setIndentStart(indentStart: stdLib.Number): ListItem = js.native
  def setLeftToRight(leftToRight: scala.Boolean): ListItem = js.native
  def setLineSpacing(multiplier: stdLib.Number): ListItem = js.native
  ...
  def setSpacingAfter(spacingAfter: stdLib.Number): ListItem = js.native
  def setSpacingBefore(spacingBefore: stdLib.Number): ListItem = js.native
