...
@JSGlobal("GoogleAppsScript.CalendarApp.GuestStatus")
@js.native
object GuestStatus extends js.Object {
  @js.native
  sealed trait INVITED
    extends googleDashAppsDashScriptLib.GoogleAppsScriptNs.CalendarAppNs.GuestStatus
  ...
  def apply(value: java.lang.String): js.UndefOr[
    googleDashAppsDashScriptLib.GoogleAppsScriptNs.CalendarAppNs.GuestStatus with java.lang.String
  ] = js.native
}
