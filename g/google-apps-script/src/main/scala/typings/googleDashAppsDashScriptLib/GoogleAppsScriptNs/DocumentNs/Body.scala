...
trait Body extends js.Object {
  ...
  def getMarginBottom(): stdLib.Number = js.native
  def getMarginLeft(): stdLib.Number = js.native
  def getMarginRight(): stdLib.Number = js.native
  def getMarginTop(): stdLib.Number = js.native
  ...
  def setMarginBottom(marginBottom: stdLib.Number): Body = js.native
  def setMarginLeft(marginLeft: stdLib.Number): Body = js.native
  def setMarginRight(marginRight: stdLib.Number): Body = js.native
  def setMarginTop(marginTop: stdLib.Number): Body = js.native
  def setPageHeight(pageHeight: stdLib.Number): Body = js.native
  def setPageWidth(pageWidth: stdLib.Number): Body = js.native
