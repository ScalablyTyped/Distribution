...
object SimpleCheckBox {
  ...
  def apply(
    ...
    addStyleDependentName: java.lang.String => SimpleCheckBox,
    addStyleName: java.lang.String => SimpleCheckBox,
    getId: () => java.lang.String,
    getTag: () => java.lang.String,
    getType: () => java.lang.String,
    setAccessKey: googleDashAppsDashScriptLib.GoogleAppsScriptNs.Char => SimpleCheckBox,
    setChecked: scala.Boolean => SimpleCheckBox,
    setEnabled: scala.Boolean => SimpleCheckBox,
    ...
    setTag: java.lang.String => SimpleCheckBox,
    setTitle: java.lang.String => SimpleCheckBox,
    setVisible: scala.Boolean => SimpleCheckBox,
    setWidth: java.lang.String => SimpleCheckBox
  ): SimpleCheckBox = {
