...
trait MailApp extends js.Object {
  ...
  def sendEmail(message: js.Any): scala.Unit = js.native
  def sendEmail(recipient: java.lang.String, subject: java.lang.String, body: java.lang.String): scala.Unit = js.native
  def sendEmail(recipient: java.lang.String, subject: java.lang.String, body: java.lang.String, options: js.Any): scala.Unit = js.native
