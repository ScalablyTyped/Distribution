...
trait SimpleRadioButton extends js.Object {
  ...
  def addStyleDependentName(styleName: java.lang.String): SimpleRadioButton
  def addStyleName(styleName: java.lang.String): SimpleRadioButton
  def getId(): java.lang.String
  def getTag(): java.lang.String
  def getType(): java.lang.String
  def setAccessKey(accessKey: googleDashAppsDashScriptLib.GoogleAppsScriptNs.Char): SimpleRadioButton
  def setChecked(checked: scala.Boolean): SimpleRadioButton
  def setEnabled(enabled: scala.Boolean): SimpleRadioButton
  ...
  def setTag(tag: java.lang.String): SimpleRadioButton
  def setTitle(title: java.lang.String): SimpleRadioButton
  def setVisible(visible: scala.Boolean): SimpleRadioButton
...
object SimpleRadioButton {
  ...
  def apply(
    ...
    addStyleDependentName: java.lang.String => SimpleRadioButton,
    addStyleName: java.lang.String => SimpleRadioButton,
    getId: () => java.lang.String,
    getTag: () => java.lang.String,
    getType: () => java.lang.String,
    setAccessKey: googleDashAppsDashScriptLib.GoogleAppsScriptNs.Char => SimpleRadioButton,
    setChecked: scala.Boolean => SimpleRadioButton,
    setEnabled: scala.Boolean => SimpleRadioButton,
    ...
    setTag: java.lang.String => SimpleRadioButton,
    setTitle: java.lang.String => SimpleRadioButton,
    setVisible: scala.Boolean => SimpleRadioButton,
    setWidth: java.lang.String => SimpleRadioButton
  ): SimpleRadioButton = {
