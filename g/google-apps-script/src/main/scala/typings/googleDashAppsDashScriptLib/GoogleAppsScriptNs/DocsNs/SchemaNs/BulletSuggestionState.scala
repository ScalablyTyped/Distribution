...
trait BulletSuggestionState extends js.Object {
  var listIdSuggested: js.UndefOr[scala.Boolean] = js.undefined
  var nestingLevelSuggested: js.UndefOr[scala.Boolean] = js.undefined
...
object BulletSuggestionState {
  @scala.inline
  def apply(
    listIdSuggested: js.UndefOr[scala.Boolean] = js.undefined,
    nestingLevelSuggested: js.UndefOr[scala.Boolean] = js.undefined,
