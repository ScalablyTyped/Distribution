...
trait Page extends js.Object {
  ...
  def getAnnouncements(optOptions: js.Object): js.Array[Page] = js.native
  def getAttachments(): js.Array[Attachment] = js.native
  def getAttachments(optOptions: js.Object): js.Array[Attachment] = js.native
  ...
  def getComments(optOptions: js.Object): js.Array[Comment] = js.native
  ...
  def getListItems(optOptions: js.Object): js.Array[ListItem] = js.native
