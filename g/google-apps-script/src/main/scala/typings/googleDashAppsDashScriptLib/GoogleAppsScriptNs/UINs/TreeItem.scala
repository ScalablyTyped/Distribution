...
trait TreeItem extends js.Object {
  ...
  def addItem(text: java.lang.String): TreeItem = js.native
  def addItem(widget: Widget): TreeItem = js.native
  def addStyleDependentName(styleName: java.lang.String): TreeItem = js.native
  def addStyleName(styleName: java.lang.String): TreeItem = js.native
  def clear(): TreeItem = js.native
  def getId(): java.lang.String = js.native
  def getTag(): java.lang.String = js.native
  def getType(): java.lang.String = js.native
  def setHTML(html: java.lang.String): TreeItem = js.native
  def setHeight(height: java.lang.String): TreeItem = js.native
  def setId(id: java.lang.String): TreeItem = js.native
  def setPixelSize(
    width: googleDashAppsDashScriptLib.GoogleAppsScriptNs.Integer,
    height: googleDashAppsDashScriptLib.GoogleAppsScriptNs.Integer
  ): TreeItem = js.native
  def setSelected(selected: scala.Boolean): TreeItem = js.native
  def setSize(width: java.lang.String, height: java.lang.String): TreeItem = js.native
