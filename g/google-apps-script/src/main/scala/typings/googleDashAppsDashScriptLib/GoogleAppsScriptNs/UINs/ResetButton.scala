...
object ResetButton {
  ...
  def apply(
    ...
    addStyleDependentName: java.lang.String => ResetButton,
    addStyleName: java.lang.String => ResetButton,
    getId: () => java.lang.String,
    getTag: () => java.lang.String,
    getType: () => java.lang.String,
    setAccessKey: googleDashAppsDashScriptLib.GoogleAppsScriptNs.Char => ResetButton,
    setEnabled: scala.Boolean => ResetButton,
    setFocus: scala.Boolean => ResetButton,
    ...
    setTag: java.lang.String => ResetButton,
    setText: java.lang.String => ResetButton,
    setTitle: java.lang.String => ResetButton,
    setVisible: scala.Boolean => ResetButton,
    setWidth: java.lang.String => ResetButton
  ): ResetButton = {
