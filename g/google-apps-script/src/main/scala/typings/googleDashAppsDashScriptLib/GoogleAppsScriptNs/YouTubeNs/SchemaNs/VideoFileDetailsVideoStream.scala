...
trait VideoFileDetailsVideoStream extends js.Object {
  var aspectRatio: js.UndefOr[stdLib.Number] = js.undefined
  var bitrateBps: js.UndefOr[java.lang.String] = js.undefined
  var codec: js.UndefOr[java.lang.String] = js.undefined
  var frameRateFps: js.UndefOr[stdLib.Number] = js.undefined
...
object VideoFileDetailsVideoStream {
  @scala.inline
  def apply(
    aspectRatio: stdLib.Number = null,
    bitrateBps: java.lang.String = null,
    codec: java.lang.String = null,
    frameRateFps: stdLib.Number = null,
    ...
    if (frameRateFps != null) __obj.updateDynamic("frameRateFps")(frameRateFps)
