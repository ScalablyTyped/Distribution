...
trait ChannelsCollection extends js.Object {
  ...
  def stop(resource: googleDashAppsDashScriptLib.GoogleAppsScriptNs.DriveUnderscoreV2Ns.SchemaNs.Channel): scala.Unit
}

object ChannelsCollection {
  @scala.inline
  def apply(
    stop: googleDashAppsDashScriptLib.GoogleAppsScriptNs.DriveUnderscoreV2Ns.SchemaNs.Channel => scala.Unit
  ): ChannelsCollection = {
