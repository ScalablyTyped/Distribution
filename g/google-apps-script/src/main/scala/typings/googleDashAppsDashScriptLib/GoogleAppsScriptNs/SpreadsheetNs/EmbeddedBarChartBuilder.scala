...
trait EmbeddedBarChartBuilder extends js.Object {
  ...
  def setRange(start: scala.Double, end: scala.Double): EmbeddedBarChartBuilder
...
object EmbeddedBarChartBuilder {
  ...
  def apply(
    ...
    setBackgroundColor: java.lang.String => EmbeddedBarChartBuilder,
    setChartType: googleDashAppsDashScriptLib.GoogleAppsScriptNs.ChartsNs.ChartType => EmbeddedChartBuilder,
    setColors: js.Array[java.lang.String] => EmbeddedBarChartBuilder,
    ...
    setLegendPosition: googleDashAppsDashScriptLib.GoogleAppsScriptNs.ChartsNs.Position => EmbeddedBarChartBuilder,
    setLegendTextStyle: googleDashAppsDashScriptLib.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedBarChartBuilder,
    ...
    setRange: (scala.Double, scala.Double) => EmbeddedBarChartBuilder,
    setStacked: () => EmbeddedBarChartBuilder,
    setTitle: java.lang.String => EmbeddedBarChartBuilder,
    setTitleTextStyle: googleDashAppsDashScriptLib.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedBarChartBuilder,
    setTransposeRowsAndColumns: scala.Boolean => EmbeddedChartBuilder,
    setXAxisTextStyle: googleDashAppsDashScriptLib.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedBarChartBuilder,
    setXAxisTitle: java.lang.String => EmbeddedBarChartBuilder,
    setXAxisTitleTextStyle: googleDashAppsDashScriptLib.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedBarChartBuilder,
    setYAxisTextStyle: googleDashAppsDashScriptLib.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedBarChartBuilder,
    setYAxisTitle: java.lang.String => EmbeddedBarChartBuilder,
    setYAxisTitleTextStyle: googleDashAppsDashScriptLib.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedBarChartBuilder,
