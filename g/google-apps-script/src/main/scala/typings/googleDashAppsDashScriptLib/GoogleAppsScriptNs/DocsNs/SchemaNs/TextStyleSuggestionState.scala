...
trait TextStyleSuggestionState extends js.Object {
  ...
  var baselineOffsetSuggested: js.UndefOr[scala.Boolean] = js.undefined
  var boldSuggested: js.UndefOr[scala.Boolean] = js.undefined
  var fontSizeSuggested: js.UndefOr[scala.Boolean] = js.undefined
  var foregroundColorSuggested: js.UndefOr[scala.Boolean] = js.undefined
  var italicSuggested: js.UndefOr[scala.Boolean] = js.undefined
  var linkSuggested: js.UndefOr[scala.Boolean] = js.undefined
  var smallCapsSuggested: js.UndefOr[scala.Boolean] = js.undefined
  var strikethroughSuggested: js.UndefOr[scala.Boolean] = js.undefined
  var underlineSuggested: js.UndefOr[scala.Boolean] = js.undefined
  var weightedFontFamilySuggested: js.UndefOr[scala.Boolean] = js.undefined
}
...
object TextStyleSuggestionState {
  ...
  def apply(
    ...
    baselineOffsetSuggested: js.UndefOr[scala.Boolean] = js.undefined,
    boldSuggested: js.UndefOr[scala.Boolean] = js.undefined,
    fontSizeSuggested: js.UndefOr[scala.Boolean] = js.undefined,
    foregroundColorSuggested: js.UndefOr[scala.Boolean] = js.undefined,
    italicSuggested: js.UndefOr[scala.Boolean] = js.undefined,
    linkSuggested: js.UndefOr[scala.Boolean] = js.undefined,
    smallCapsSuggested: js.UndefOr[scala.Boolean] = js.undefined,
    strikethroughSuggested: js.UndefOr[scala.Boolean] = js.undefined,
    underlineSuggested: js.UndefOr[scala.Boolean] = js.undefined,
    weightedFontFamilySuggested: js.UndefOr[scala.Boolean] = js.undefined
