...
object SubmitButton {
  ...
  def apply(
    ...
    addStyleDependentName: java.lang.String => SubmitButton,
    addStyleName: java.lang.String => SubmitButton,
    getId: () => java.lang.String,
    getTag: () => java.lang.String,
    getType: () => java.lang.String,
    setAccessKey: googleDashAppsDashScriptLib.GoogleAppsScriptNs.Char => SubmitButton,
    setEnabled: scala.Boolean => SubmitButton,
    setFocus: scala.Boolean => SubmitButton,
    ...
    setTag: java.lang.String => SubmitButton,
    setText: java.lang.String => SubmitButton,
    setTitle: java.lang.String => SubmitButton,
    setVisible: scala.Boolean => SubmitButton,
    setWidth: java.lang.String => SubmitButton
  ): SubmitButton = {
