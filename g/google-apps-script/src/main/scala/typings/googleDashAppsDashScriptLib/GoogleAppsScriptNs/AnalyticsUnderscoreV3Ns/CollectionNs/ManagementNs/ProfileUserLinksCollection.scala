...
trait ProfileUserLinksCollection extends js.Object {
  ...
  def list(accountId: java.lang.String, webPropertyId: java.lang.String, profileId: java.lang.String): googleDashAppsDashScriptLib.GoogleAppsScriptNs.AnalyticsUnderscoreV3Ns.SchemaNs.EntityUserLinks = js.native
  // Lists profile-user links for a given view (profile).
  def list(
    accountId: java.lang.String,
    webPropertyId: java.lang.String,
  ...
  ): googleDashAppsDashScriptLib.GoogleAppsScriptNs.AnalyticsUnderscoreV3Ns.SchemaNs.EntityUserLinks = js.native
