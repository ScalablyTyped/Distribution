...
trait PaymentsCollection extends js.Object {
  ...
  def list(): googleDashAppsDashScriptLib.GoogleAppsScriptNs.AdsenseNs.SchemaNs.Payments
}

object PaymentsCollection {
  @scala.inline
  def apply(list: () => googleDashAppsDashScriptLib.GoogleAppsScriptNs.AdsenseNs.SchemaNs.Payments): PaymentsCollection = {
