...
trait VerificationCodesCollection extends js.Object {
  ...
  def list(userKey: java.lang.String): googleDashAppsDashScriptLib.GoogleAppsScriptNs.AdminDirectoryNs.SchemaNs.VerificationCodes
}
...
object VerificationCodesCollection {
  ...
  def apply(
    ...
    list: java.lang.String => googleDashAppsDashScriptLib.GoogleAppsScriptNs.AdminDirectoryNs.SchemaNs.VerificationCodes
