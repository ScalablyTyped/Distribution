...
trait FileCapabilities extends js.Object {
  ...
  var canChangeCopyRequiresWriterPermission: js.UndefOr[scala.Boolean] = js.undefined
  var canChangeRestrictedDownload: js.UndefOr[scala.Boolean] = js.undefined
...
object FileCapabilities {
  ...
  def apply(
    ...
    canChangeCopyRequiresWriterPermission: js.UndefOr[scala.Boolean] = js.undefined,
    canChangeRestrictedDownload: js.UndefOr[scala.Boolean] = js.undefined,
