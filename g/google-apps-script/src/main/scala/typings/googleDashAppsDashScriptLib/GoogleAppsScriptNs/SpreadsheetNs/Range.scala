...
trait Range extends js.Object {
  ...
  def copyTo(destination: Range, options: js.Object): scala.Unit = js.native
  ...
  def setFontColors(colors: js.Array[js.Array[js.Object]]): Range = js.native
  def setFontFamilies(fontFamilies: js.Array[js.Array[js.Object]]): Range = js.native
  def setFontFamily(fontFamily: java.lang.String): Range = js.native
  def setFontLine(fontLine: java.lang.String): Range = js.native
  def setFontLines(fontLines: js.Array[js.Array[js.Object]]): Range = js.native
  def setFontSize(size: googleDashAppsDashScriptLib.GoogleAppsScriptNs.Integer): Range = js.native
  def setFontSizes(sizes: js.Array[js.Array[js.Object]]): Range = js.native
  def setFontStyle(fontStyle: java.lang.String): Range = js.native
  def setFontStyles(fontStyles: js.Array[js.Array[js.Object]]): Range = js.native
  def setFontWeight(fontWeight: java.lang.String): Range = js.native
  def setFontWeights(fontWeights: js.Array[js.Array[js.Object]]): Range = js.native
  ...
  def setHorizontalAlignments(alignments: js.Array[js.Array[js.Object]]): Range = js.native
  ...
  def setVerticalAlignments(alignments: js.Array[js.Array[js.Object]]): Range = js.native
  ...
  def setWraps(isWrapEnabled: js.Array[js.Array[js.Object]]): Range = js.native
  ...
  def sort(sortSpecObj: js.Object): Range = js.native
