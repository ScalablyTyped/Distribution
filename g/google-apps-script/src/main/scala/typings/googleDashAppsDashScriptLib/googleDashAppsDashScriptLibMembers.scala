...
@JSGlobalScope
@js.native
object googleDashAppsDashScriptLibMembers extends js.Object {
  ...
  var FormApp: googleDashAppsDashScriptLib.GoogleAppsScriptNs.FormsNs.FormApp = js.native
  var GmailApp: googleDashAppsDashScriptLib.GoogleAppsScriptNs.GmailNs.GmailApp = js.native
  var GroupsApp: googleDashAppsDashScriptLib.GoogleAppsScriptNs.GroupsNs.GroupsApp = js.native
  var HtmlService: googleDashAppsDashScriptLib.GoogleAppsScriptNs.HTMLNs.HtmlService = js.native
  var Jdbc: googleDashAppsDashScriptLib.GoogleAppsScriptNs.JDBCNs.Jdbc = js.native
  var LanguageApp: googleDashAppsDashScriptLib.GoogleAppsScriptNs.LanguageNs.LanguageApp = js.native
  var LinearOptimizationService: googleDashAppsDashScriptLib.GoogleAppsScriptNs.OptimizationNs.LinearOptimizationService = js.native
  var LockService: googleDashAppsDashScriptLib.GoogleAppsScriptNs.LockNs.LockService = js.native
  var Logger: googleDashAppsDashScriptLib.GoogleAppsScriptNs.BaseNs.Logger = js.native
  var MacAlgorithm: googleDashAppsDashScriptLib.GoogleAppsScriptNs.UtilitiesNs.MacAlgorithm = js.native
  ...
  var Session: googleDashAppsDashScriptLib.GoogleAppsScriptNs.BaseNs.Session = js.native
  var SitesApp: googleDashAppsDashScriptLib.GoogleAppsScriptNs.SitesNs.SitesApp = js.native
  var SlidesApp: googleDashAppsDashScriptLib.GoogleAppsScriptNs.SlidesNs.SlidesApp = js.native
  var SpreadsheetApp: googleDashAppsDashScriptLib.GoogleAppsScriptNs.SpreadsheetNs.SpreadsheetApp = js.native
  var UiApp: googleDashAppsDashScriptLib.GoogleAppsScriptNs.UINs.UiApp = js.native
  var UrlFetchApp: googleDashAppsDashScriptLib.GoogleAppsScriptNs.URLUnderscoreFetchNs.UrlFetchApp = js.native
