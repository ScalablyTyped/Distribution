...
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.CampaignCreativeAssociation
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.CampaignCreativeAssociationsListResponse
