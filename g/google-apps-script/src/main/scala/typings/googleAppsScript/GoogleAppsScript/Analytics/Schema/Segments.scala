...
object Segments {
  ...
  implicit class SegmentsOps[Self <: Segments] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Segment*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Segment]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
