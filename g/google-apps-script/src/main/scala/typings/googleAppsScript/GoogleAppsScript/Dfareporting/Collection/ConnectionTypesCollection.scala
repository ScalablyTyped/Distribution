...
object ConnectionTypesCollection {
  ...
  implicit class ConnectionTypesCollectionOps[Self <: ConnectionTypesCollection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGet(value: (String, String) => ConnectionType): Self = this.set("get", js.Any.fromFunction2(value))
    
    @scala.inline
    def setList(value: String => ConnectionTypesListResponse): Self = this.set("list", js.Any.fromFunction1(value))
  }
}
