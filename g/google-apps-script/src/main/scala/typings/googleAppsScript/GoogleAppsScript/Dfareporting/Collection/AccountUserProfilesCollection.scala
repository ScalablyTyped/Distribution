...
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.AccountUserProfile
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.AccountUserProfilesListResponse
