...
import typings.googleAppsScript.GoogleAppsScript.UrlShortener.Collection.UrlCollection
import typings.googleAppsScript.GoogleAppsScript.UrlShortener.Schema.AnalyticsSnapshot
import typings.googleAppsScript.GoogleAppsScript.UrlShortener.Schema.AnalyticsSummary
import typings.googleAppsScript.GoogleAppsScript.UrlShortener.Schema.StringCount
import typings.googleAppsScript.GoogleAppsScript.UrlShortener.Schema.Url
