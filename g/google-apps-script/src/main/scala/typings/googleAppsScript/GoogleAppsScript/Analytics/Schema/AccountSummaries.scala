...
@js.native
trait AccountSummaries extends js.Object {
...
object AccountSummaries {
  ...
  @scala.inline
  implicit class AccountSummariesOps[Self <: AccountSummaries] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: AccountSummary*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[AccountSummary]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
