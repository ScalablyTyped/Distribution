...
import typings.googleAppsScript.GoogleAppsScript.YouTube.Schema.Activity
import typings.googleAppsScript.GoogleAppsScript.YouTube.Schema.ActivityListResponse
