...
object EntityUserLinks {
  ...
  implicit class EntityUserLinksOps[Self <: EntityUserLinks] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: EntityUserLink*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[EntityUserLink]): Self = this.set("items", value.asInstanceOf[js.Any])
