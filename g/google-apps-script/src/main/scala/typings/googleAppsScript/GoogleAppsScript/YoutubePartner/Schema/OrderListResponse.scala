...
trait OrderListResponse extends js.Object {
  var items: js.UndefOr[js.Array[Order]] = js.native
...
object OrderListResponse {
  @scala.inline
  def apply(): OrderListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OrderListResponse]
  }
  @scala.inline
  implicit class OrderListResponseOps[Self <: OrderListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: Order*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[Order]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
