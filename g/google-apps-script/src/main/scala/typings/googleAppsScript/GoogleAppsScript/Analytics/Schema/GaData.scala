...
object GaData {
  ...
  implicit class GaDataOps[Self <: GaData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColumnHeadersVarargs(value: GaDataColumnHeaders*): Self = this.set("columnHeaders", js.Array(value :_*))
    
    @scala.inline
    def setColumnHeaders(value: js.Array[GaDataColumnHeaders]): Self = this.set("columnHeaders", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataTable(value: GaDataDataTable): Self = this.set("dataTable", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setProfileInfo(value: GaDataProfileInfo): Self = this.set("profileInfo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteProfileInfo: Self = this.set("profileInfo", js.undefined)
    
    @scala.inline
    def setQuery(value: GaDataQuery): Self = this.set("query", value.asInstanceOf[js.Any])
