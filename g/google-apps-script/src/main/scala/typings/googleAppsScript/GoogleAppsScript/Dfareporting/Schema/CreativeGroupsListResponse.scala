...
object CreativeGroupsListResponse {
  ...
  implicit class CreativeGroupsListResponseOps[Self <: CreativeGroupsListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreativeGroupsVarargs(value: CreativeGroup*): Self = this.set("creativeGroups", js.Array(value :_*))
    
    @scala.inline
    def setCreativeGroups(value: js.Array[CreativeGroup]): Self = this.set("creativeGroups", value.asInstanceOf[js.Any])
