...
object ProfileFilterLinks {
  ...
  @scala.inline
  implicit class ProfileFilterLinksOps[Self <: ProfileFilterLinks] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: ProfileFilterLink*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[ProfileFilterLink]): Self = this.set("items", value.asInstanceOf[js.Any])
