...
object TableCellBorder {
  ...
  @scala.inline
  implicit class TableCellBorderOps[Self <: TableCellBorder] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setColor(value: OptionalColor): Self = this.set("color", value.asInstanceOf[js.Any])
    @scala.inline
