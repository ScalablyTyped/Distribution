...
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.AdvertiserLandingPagesListResponse
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.LandingPage
