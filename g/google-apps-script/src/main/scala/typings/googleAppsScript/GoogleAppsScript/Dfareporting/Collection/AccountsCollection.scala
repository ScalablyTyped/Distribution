...
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.Account
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.AccountsListResponse
