...
object EmbeddedHistogramChartBuilder {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EmbeddedHistogramChartBuilder] (val x: Self) extends AnyVal {
    ...
    inline def setReverseCategories(value: () => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "reverseCategories", js.Any.fromFunction0(value))
    
    inline def setSetBackgroundColor(value: String => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setBackgroundColor", js.Any.fromFunction1(value))
    ...
    inline def setSetColors(value: js.Array[String] => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setColors", js.Any.fromFunction1(value))
    ...
    inline def setSetLegendPosition(value: Position => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setLegendPosition", js.Any.fromFunction1(value))
    
    inline def setSetLegendTextStyle(value: typings.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setLegendTextStyle", js.Any.fromFunction1(value))
    ...
    inline def setSetRange(value: (Double, Double) => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setRange", js.Any.fromFunction2(value))
    
    inline def setSetStacked(value: () => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setStacked", js.Any.fromFunction0(value))
    
    inline def setSetTitle(value: String => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setTitle", js.Any.fromFunction1(value))
    
    inline def setSetTitleTextStyle(value: typings.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setTitleTextStyle", js.Any.fromFunction1(value))
    ...
    inline def setSetXAxisTextStyle(value: typings.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setXAxisTextStyle", js.Any.fromFunction1(value))
    
    inline def setSetXAxisTitle(value: String => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setXAxisTitle", js.Any.fromFunction1(value))
    
    inline def setSetXAxisTitleTextStyle(value: typings.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setXAxisTitleTextStyle", js.Any.fromFunction1(value))
    
    inline def setSetYAxisTextStyle(value: typings.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setYAxisTextStyle", js.Any.fromFunction1(value))
    
    inline def setSetYAxisTitle(value: String => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setYAxisTitle", js.Any.fromFunction1(value))
    
    inline def setSetYAxisTitleTextStyle(value: typings.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "setYAxisTitleTextStyle", js.Any.fromFunction1(value))
    
    inline def setUseLogScale(value: () => EmbeddedHistogramChartBuilder): Self = StObject.set(x, "useLogScale", js.Any.fromFunction0(value))
  }
}
