...
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.Advertiser
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.AdvertisersListResponse
