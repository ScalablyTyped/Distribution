...
object ChannelSectionListResponse {
  ...
  @scala.inline
  implicit class ChannelSectionListResponseOps[Self <: ChannelSectionListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: ChannelSection*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[ChannelSection]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
