...
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.UserRole
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.UserRolesListResponse
