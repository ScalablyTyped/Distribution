...
import typings.googleAppsScript.googleAppsScriptStrings.italic
...
import typings.googleAppsScript.googleAppsScriptStrings.none
...
import typings.googleAppsScript.googleAppsScriptStrings.underline
