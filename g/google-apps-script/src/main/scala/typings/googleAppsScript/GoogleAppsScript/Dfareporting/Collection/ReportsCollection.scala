...
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Collection.Reports.CompatibleFieldsCollection
...
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.ReportList
...
trait ReportsCollection extends js.Object {
  ...
  var Files: js.UndefOr[
    typings.googleAppsScript.GoogleAppsScript.Dfareporting.Collection.Reports.FilesCollection
  ] = js.native
