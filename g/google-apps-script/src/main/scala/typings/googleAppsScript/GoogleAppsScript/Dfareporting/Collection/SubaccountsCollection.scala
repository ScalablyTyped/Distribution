...
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.Subaccount
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.SubaccountsListResponse
