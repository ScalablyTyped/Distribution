...
object Classroom_ {
  ...
  implicit class Classroom_Ops[Self <: Classroom_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewAnnouncement(value: () => Announcement): Self = this.set("newAnnouncement", js.Any.fromFunction0(value))
    @scala.inline
    def setNewAssignment(value: () => Assignment): Self = this.set("newAssignment", js.Any.fromFunction0(value))
    @scala.inline
    def setNewAssignmentSubmission(value: () => AssignmentSubmission): Self = this.set("newAssignmentSubmission", js.Any.fromFunction0(value))
    @scala.inline
    def setNewAttachment(value: () => Attachment): Self = this.set("newAttachment", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCloudPubsubTopic(value: () => CloudPubsubTopic): Self = this.set("newCloudPubsubTopic", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCourse(value: () => Course): Self = this.set("newCourse", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCourseAlias(value: () => CourseAlias): Self = this.set("newCourseAlias", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCourseMaterial(value: () => CourseMaterial): Self = this.set("newCourseMaterial", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCourseMaterialSet(value: () => CourseMaterialSet): Self = this.set("newCourseMaterialSet", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCourseRosterChangesInfo(value: () => CourseRosterChangesInfo): Self = this.set("newCourseRosterChangesInfo", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCourseWork(value: () => CourseWork): Self = this.set("newCourseWork", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCourseWorkChangesInfo(value: () => CourseWorkChangesInfo): Self = this.set("newCourseWorkChangesInfo", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDate(value: () => Date): Self = this.set("newDate", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDriveFile(value: () => DriveFile): Self = this.set("newDriveFile", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDriveFolder(value: () => DriveFolder): Self = this.set("newDriveFolder", js.Any.fromFunction0(value))
    @scala.inline
    def setNewFeed(value: () => Feed): Self = this.set("newFeed", js.Any.fromFunction0(value))
    @scala.inline
    def setNewForm(value: () => Form): Self = this.set("newForm", js.Any.fromFunction0(value))
    @scala.inline
    def setNewGlobalPermission(value: () => GlobalPermission): Self = this.set("newGlobalPermission", js.Any.fromFunction0(value))
    @scala.inline
    def setNewGradeHistory(value: () => GradeHistory): Self = this.set("newGradeHistory", js.Any.fromFunction0(value))
    @scala.inline
    def setNewGuardianInvitation(value: () => GuardianInvitation): Self = this.set("newGuardianInvitation", js.Any.fromFunction0(value))
    @scala.inline
    def setNewIndividualStudentsOptions(value: () => IndividualStudentsOptions): Self = this.set("newIndividualStudentsOptions", js.Any.fromFunction0(value))
    @scala.inline
    def setNewInvitation(value: () => Invitation): Self = this.set("newInvitation", js.Any.fromFunction0(value))
    @scala.inline
    def setNewLink(value: () => Link): Self = this.set("newLink", js.Any.fromFunction0(value))
    @scala.inline
    def setNewMaterial(value: () => Material): Self = this.set("newMaterial", js.Any.fromFunction0(value))
    @scala.inline
    def setNewModifyAnnouncementAssigneesRequest(value: () => ModifyAnnouncementAssigneesRequest): Self = this.set("newModifyAnnouncementAssigneesRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewModifyAttachmentsRequest(value: () => ModifyAttachmentsRequest): Self = this.set("newModifyAttachmentsRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewModifyCourseWorkAssigneesRequest(value: () => ModifyCourseWorkAssigneesRequest): Self = this.set("newModifyCourseWorkAssigneesRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewModifyIndividualStudentsOptions(value: () => ModifyIndividualStudentsOptions): Self = this.set("newModifyIndividualStudentsOptions", js.Any.fromFunction0(value))
    @scala.inline
    def setNewMultipleChoiceQuestion(value: () => MultipleChoiceQuestion): Self = this.set("newMultipleChoiceQuestion", js.Any.fromFunction0(value))
    @scala.inline
    def setNewMultipleChoiceSubmission(value: () => MultipleChoiceSubmission): Self = this.set("newMultipleChoiceSubmission", js.Any.fromFunction0(value))
    @scala.inline
    def setNewName(value: () => Name): Self = this.set("newName", js.Any.fromFunction0(value))
    @scala.inline
    def setNewReclaimStudentSubmissionRequest(value: () => js.Any): Self = this.set("newReclaimStudentSubmissionRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewRegistration(value: () => Registration): Self = this.set("newRegistration", js.Any.fromFunction0(value))
    @scala.inline
    def setNewReturnStudentSubmissionRequest(value: () => js.Any): Self = this.set("newReturnStudentSubmissionRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewSharedDriveFile(value: () => SharedDriveFile): Self = this.set("newSharedDriveFile", js.Any.fromFunction0(value))
    @scala.inline
    def setNewShortAnswerSubmission(value: () => ShortAnswerSubmission): Self = this.set("newShortAnswerSubmission", js.Any.fromFunction0(value))
    @scala.inline
    def setNewStateHistory(value: () => StateHistory): Self = this.set("newStateHistory", js.Any.fromFunction0(value))
    @scala.inline
    def setNewStudent(value: () => Student): Self = this.set("newStudent", js.Any.fromFunction0(value))
    @scala.inline
    def setNewStudentSubmission(value: () => StudentSubmission): Self = this.set("newStudentSubmission", js.Any.fromFunction0(value))
    @scala.inline
    def setNewSubmissionHistory(value: () => SubmissionHistory): Self = this.set("newSubmissionHistory", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTeacher(value: () => Teacher): Self = this.set("newTeacher", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTimeOfDay(value: () => TimeOfDay): Self = this.set("newTimeOfDay", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTurnInStudentSubmissionRequest(value: () => js.Any): Self = this.set("newTurnInStudentSubmissionRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewUserProfile(value: () => UserProfile): Self = this.set("newUserProfile", js.Any.fromFunction0(value))
    @scala.inline
    def setNewYouTubeVideo(value: () => YouTubeVideo): Self = this.set("newYouTubeVideo", js.Any.fromFunction0(value))
    @scala.inline
    def setCourses(value: CoursesCollection): Self = this.set("Courses", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCourses: Self = this.set("Courses", js.undefined)
    @scala.inline
    def setInvitations(value: InvitationsCollection): Self = this.set("Invitations", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteInvitations: Self = this.set("Invitations", js.undefined)
    @scala.inline
    def setRegistrations(value: RegistrationsCollection): Self = this.set("Registrations", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRegistrations: Self = this.set("Registrations", js.undefined)
    @scala.inline
    def setUserProfiles(value: UserProfilesCollection): Self = this.set("UserProfiles", value.asInstanceOf[js.Any])
    @scala.inline
