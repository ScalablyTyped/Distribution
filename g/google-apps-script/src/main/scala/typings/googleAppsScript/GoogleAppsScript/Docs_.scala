...
object Docs_ {
  ...
  implicit class Docs_Ops[Self <: Docs_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewAutoText(value: () => AutoText): Self = this.set("newAutoText", js.Any.fromFunction0(value))
    @scala.inline
    def setNewBackground(value: () => Background): Self = this.set("newBackground", js.Any.fromFunction0(value))
    @scala.inline
    def setNewBatchUpdateDocumentRequest(value: () => BatchUpdateDocumentRequest): Self = this.set("newBatchUpdateDocumentRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewBody(value: () => Body): Self = this.set("newBody", js.Any.fromFunction0(value))
    @scala.inline
    def setNewBullet(value: () => Bullet): Self = this.set("newBullet", js.Any.fromFunction0(value))
    @scala.inline
    def setNewColor(value: () => Color): Self = this.set("newColor", js.Any.fromFunction0(value))
    @scala.inline
    def setNewColumnBreak(value: () => ColumnBreak): Self = this.set("newColumnBreak", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCreateNamedRangeRequest(value: () => CreateNamedRangeRequest): Self = this.set("newCreateNamedRangeRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewCreateParagraphBulletsRequest(value: () => CreateParagraphBulletsRequest): Self = this.set("newCreateParagraphBulletsRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDeleteContentRangeRequest(value: () => DeleteContentRangeRequest): Self = this.set("newDeleteContentRangeRequest", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setNewDeleteParagraphBulletsRequest(value: () => DeleteParagraphBulletsRequest): Self = this.set("newDeleteParagraphBulletsRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDeletePositionedObjectRequest(value: () => DeletePositionedObjectRequest): Self = this.set("newDeletePositionedObjectRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDeleteTableColumnRequest(value: () => DeleteTableColumnRequest): Self = this.set("newDeleteTableColumnRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDeleteTableRowRequest(value: () => DeleteTableRowRequest): Self = this.set("newDeleteTableRowRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDimension(value: () => Dimension): Self = this.set("newDimension", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDocument(value: () => typings.googleAppsScript.GoogleAppsScript.Docs.Schema.Document): Self = this.set("newDocument", js.Any.fromFunction0(value))
    @scala.inline
    def setNewDocumentStyle(value: () => DocumentStyle): Self = this.set("newDocumentStyle", js.Any.fromFunction0(value))
    @scala.inline
    def setNewEndOfSegmentLocation(value: () => EndOfSegmentLocation): Self = this.set("newEndOfSegmentLocation", js.Any.fromFunction0(value))
    @scala.inline
    def setNewEquation(value: () => Equation): Self = this.set("newEquation", js.Any.fromFunction0(value))
    @scala.inline
    def setNewFootnoteReference(value: () => FootnoteReference): Self = this.set("newFootnoteReference", js.Any.fromFunction0(value))
    @scala.inline
    def setNewHorizontalRule(value: () => HorizontalRule): Self = this.set("newHorizontalRule", js.Any.fromFunction0(value))
    @scala.inline
    def setNewInlineObjectElement(value: () => InlineObjectElement): Self = this.set("newInlineObjectElement", js.Any.fromFunction0(value))
    @scala.inline
    def setNewInsertInlineImageRequest(value: () => InsertInlineImageRequest): Self = this.set("newInsertInlineImageRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewInsertPageBreakRequest(value: () => InsertPageBreakRequest): Self = this.set("newInsertPageBreakRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewInsertTableRequest(value: () => InsertTableRequest): Self = this.set("newInsertTableRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewInsertTableRowRequest(value: () => InsertTableRowRequest): Self = this.set("newInsertTableRowRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewInsertTextRequest(value: () => InsertTextRequest): Self = this.set("newInsertTextRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewLink(value: () => Link): Self = this.set("newLink", js.Any.fromFunction0(value))
    @scala.inline
    def setNewLocation(value: () => Location): Self = this.set("newLocation", js.Any.fromFunction0(value))
    @scala.inline
    def setNewNamedStyle(value: () => NamedStyle): Self = this.set("newNamedStyle", js.Any.fromFunction0(value))
    @scala.inline
    def setNewNamedStyles(value: () => NamedStyles): Self = this.set("newNamedStyles", js.Any.fromFunction0(value))
    @scala.inline
    def setNewOptionalColor(value: () => OptionalColor): Self = this.set("newOptionalColor", js.Any.fromFunction0(value))
    @scala.inline
    def setNewPageBreak(value: () => PageBreak): Self = this.set("newPageBreak", js.Any.fromFunction0(value))
    @scala.inline
    def setNewParagraph(value: () => Paragraph): Self = this.set("newParagraph", js.Any.fromFunction0(value))
    @scala.inline
    def setNewParagraphBorder(value: () => ParagraphBorder): Self = this.set("newParagraphBorder", js.Any.fromFunction0(value))
    @scala.inline
    def setNewParagraphElement(value: () => ParagraphElement): Self = this.set("newParagraphElement", js.Any.fromFunction0(value))
    @scala.inline
    def setNewParagraphStyle(value: () => ParagraphStyle): Self = this.set("newParagraphStyle", js.Any.fromFunction0(value))
    @scala.inline
    def setNewRange(value: () => Range): Self = this.set("newRange", js.Any.fromFunction0(value))
    @scala.inline
    def setNewReplaceAllTextRequest(value: () => ReplaceAllTextRequest): Self = this.set("newReplaceAllTextRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewRequest(value: () => Request): Self = this.set("newRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewRgbColor(value: () => RgbColor): Self = this.set("newRgbColor", js.Any.fromFunction0(value))
    @scala.inline
    def setNewSectionBreak(value: () => SectionBreak): Self = this.set("newSectionBreak", js.Any.fromFunction0(value))
    @scala.inline
    def setNewSectionColumnProperties(value: () => SectionColumnProperties): Self = this.set("newSectionColumnProperties", js.Any.fromFunction0(value))
    @scala.inline
    def setNewSectionStyle(value: () => SectionStyle): Self = this.set("newSectionStyle", js.Any.fromFunction0(value))
    @scala.inline
    def setNewShading(value: () => Shading): Self = this.set("newShading", js.Any.fromFunction0(value))
    @scala.inline
    def setNewSize(value: () => Size): Self = this.set("newSize", js.Any.fromFunction0(value))
    @scala.inline
    def setNewStructuralElement(value: () => StructuralElement): Self = this.set("newStructuralElement", js.Any.fromFunction0(value))
    @scala.inline
    def setNewSubstringMatchCriteria(value: () => SubstringMatchCriteria): Self = this.set("newSubstringMatchCriteria", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTabStop(value: () => TabStop): Self = this.set("newTabStop", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTable(value: () => Table): Self = this.set("newTable", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTableCell(value: () => TableCell): Self = this.set("newTableCell", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTableCellBorder(value: () => TableCellBorder): Self = this.set("newTableCellBorder", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTableCellLocation(value: () => TableCellLocation): Self = this.set("newTableCellLocation", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTableCellStyle(value: () => TableCellStyle): Self = this.set("newTableCellStyle", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTableColumnProperties(value: () => TableColumnProperties): Self = this.set("newTableColumnProperties", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTableOfContents(value: () => TableOfContents): Self = this.set("newTableOfContents", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTableRow(value: () => TableRow): Self = this.set("newTableRow", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTableRowStyle(value: () => TableRowStyle): Self = this.set("newTableRowStyle", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTableStyle(value: () => TableStyle): Self = this.set("newTableStyle", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTextRun(value: () => TextRun): Self = this.set("newTextRun", js.Any.fromFunction0(value))
    @scala.inline
    def setNewTextStyle(value: () => TextStyle): Self = this.set("newTextStyle", js.Any.fromFunction0(value))
    @scala.inline
    def setNewUpdateParagraphStyleRequest(value: () => UpdateParagraphStyleRequest): Self = this.set("newUpdateParagraphStyleRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewUpdateTextStyleRequest(value: () => UpdateTextStyleRequest): Self = this.set("newUpdateTextStyleRequest", js.Any.fromFunction0(value))
    @scala.inline
    def setNewWeightedFontFamily(value: () => WeightedFontFamily): Self = this.set("newWeightedFontFamily", js.Any.fromFunction0(value))
    @scala.inline
    def setNewWriteControl(value: () => WriteControl): Self = this.set("newWriteControl", js.Any.fromFunction0(value))
    @scala.inline
    def setDocuments(value: DocumentsCollection): Self = this.set("Documents", value.asInstanceOf[js.Any])
    @scala.inline
