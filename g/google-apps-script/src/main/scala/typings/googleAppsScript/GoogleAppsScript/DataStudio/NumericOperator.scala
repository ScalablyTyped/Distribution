...
/* Rewritten from type alias, can be one of: 
  - typings.googleAppsScript.googleAppsScriptStrings.NUMERIC_GREATER_THAN
  - typings.googleAppsScript.googleAppsScriptStrings.NUMERIC_GREATER_THAN_OR_EQUAL
  - typings.googleAppsScript.googleAppsScriptStrings.NUMERIC_LESS_THAN
  - typings.googleAppsScript.googleAppsScriptStrings.NUMERIC_LESS_THAN_OR_EQUAL
*/
