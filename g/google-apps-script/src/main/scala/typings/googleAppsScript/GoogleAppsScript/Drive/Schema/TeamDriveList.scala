...
object TeamDriveList {
  ...
  implicit class TeamDriveListOps[Self <: TeamDriveList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: TeamDrive*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[TeamDrive]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
