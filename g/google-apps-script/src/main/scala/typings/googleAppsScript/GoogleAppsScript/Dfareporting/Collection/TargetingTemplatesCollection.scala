...
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.TargetingTemplate
import typings.googleAppsScript.GoogleAppsScript.Dfareporting.Schema.TargetingTemplatesListResponse
