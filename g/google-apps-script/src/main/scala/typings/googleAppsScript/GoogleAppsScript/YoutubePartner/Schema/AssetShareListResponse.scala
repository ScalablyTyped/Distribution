...
object AssetShareListResponse {
  ...
  implicit class AssetShareListResponseOps[Self <: AssetShareListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: AssetShare*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[AssetShare]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
