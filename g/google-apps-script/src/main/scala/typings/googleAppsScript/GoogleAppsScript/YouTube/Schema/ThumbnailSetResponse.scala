...
object ThumbnailSetResponse {
  ...
  @scala.inline
  implicit class ThumbnailSetResponseOps[Self <: ThumbnailSetResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: ThumbnailDetails*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[ThumbnailDetails]): Self = this.set("items", value.asInstanceOf[js.Any])
