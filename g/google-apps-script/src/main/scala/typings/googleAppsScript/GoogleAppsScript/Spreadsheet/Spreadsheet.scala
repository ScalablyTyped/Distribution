...
import typings.googleAppsScript.AnonFunctionName
import typings.googleAppsScript.AnonTemplate
...
trait Spreadsheet extends js.Object {
  ...
  def addDeveloperMetadata(key: String, value: String, visibility: DeveloperMetadataVisibility): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addDeveloperMetadata(key: String, visibility: DeveloperMetadataVisibility): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addEditor(emailAddress: String): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addEditor(user: User): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addEditors(emailAddresses: js.Array[String]): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addMenu(name: String, subMenus: js.Array[AnonFunctionName | Null]): Unit = js.native
  def addViewer(emailAddress: String): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addViewer(user: User): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def copy(name: String): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def removeEditor(emailAddress: String): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def removeEditor(user: User): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def removeMenu(name: String): Unit = js.native
  def removeNamedRange(name: String): Unit = js.native
  def removeViewer(emailAddress: String): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def removeViewer(user: User): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def setIterativeCalculationConvergenceThreshold(minThreshold: Double): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def setIterativeCalculationEnabled(isEnabled: Boolean): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def setMaxIterativeCalculationCycles(maxIterations: Integer): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def setNamedRange(name: String, range: Range): Unit = js.native
  def setRecalculationInterval(recalculationInterval: RecalculationInterval): typings.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
