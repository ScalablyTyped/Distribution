...
object Field {
  ...
  implicit open class MutableBuilder[Self <: Field] (val x: Self) extends AnyVal {
    ...
    inline def setGetAggregation(value: () => AggregationType | Null): Self = StObject.set(x, "getAggregation", js.Any.fromFunction0(value))
    
    inline def setGetDescription(value: () => String | Null): Self = StObject.set(x, "getDescription", js.Any.fromFunction0(value))
    
    inline def setGetFormula(value: () => String | Null): Self = StObject.set(x, "getFormula", js.Any.fromFunction0(value))
    
    inline def setGetGroup(value: () => String | Null): Self = StObject.set(x, "getGroup", js.Any.fromFunction0(value))
    
    inline def setGetId(value: () => String | Null): Self = StObject.set(x, "getId", js.Any.fromFunction0(value))
    
    inline def setGetIsReaggregatable(value: () => Boolean | Null): Self = StObject.set(x, "getIsReaggregatable", js.Any.fromFunction0(value))
    
    inline def setGetName(value: () => String | Null): Self = StObject.set(x, "getName", js.Any.fromFunction0(value))
    
    inline def setGetType(value: () => FieldType | Null): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
    
    inline def setIsDefault(value: () => Boolean): Self = StObject.set(x, "isDefault", js.Any.fromFunction0(value))
    
    inline def setIsDimension(value: () => Boolean): Self = StObject.set(x, "isDimension", js.Any.fromFunction0(value))
    
    inline def setIsHidden(value: () => Boolean): Self = StObject.set(x, "isHidden", js.Any.fromFunction0(value))
    
    inline def setIsMetric(value: () => Boolean): Self = StObject.set(x, "isMetric", js.Any.fromFunction0(value))
