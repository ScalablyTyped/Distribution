...
import typings.googleAppsScript.GoogleAppsScript.Sheets.Collection.Spreadsheets.DeveloperMetadataCollection
import typings.googleAppsScript.GoogleAppsScript.Sheets.Collection.Spreadsheets.SheetsCollection
import typings.googleAppsScript.GoogleAppsScript.Sheets.Collection.Spreadsheets.ValuesCollection
...
import typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.BatchUpdateSpreadsheetResponse
...
object Sheets {
  ...
  object Collection {
    ...
    trait SpreadsheetsCollection extends StObject {
      ...
      def create(resource: typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet): typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet = js.native
      ...
      def get(spreadsheetId: String): typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet = js.native
      // Returns the spreadsheet at the given ID.
      // The caller must specify the spreadsheet ID.
      // By default, data within grids will not be returned.
      // You can include grid data one of two ways:
      ...
      // return only the portions of the spreadsheet that intersect the requested
      // ranges. Ranges are specified using A1 notation.
      def get(spreadsheetId: String, optionalArgs: js.Object): typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet = js.native
      ...
      // For large spreadsheets, it is recommended to retrieve only the specific
      // fields of the spreadsheet that you want.
      def getByDataFilter(resource: GetSpreadsheetByDataFilterRequest, spreadsheetId: String): typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet = js.native
    }
  }
  ...
  object Schema {
    ...
    object BatchUpdateSpreadsheetResponse {
      ...
      implicit class BatchUpdateSpreadsheetResponseMutableBuilder[Self <: BatchUpdateSpreadsheetResponse] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setUpdatedSpreadsheet(value: typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet): Self = StObject.set(x, "updatedSpreadsheet", value.asInstanceOf[js.Any])
    ...
    object Spreadsheet {
      ...
      @scala.inline
      def apply(): typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet]
      }
      
      @scala.inline
      implicit class SpreadsheetMutableBuilder[Self <: typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet] (val x: Self) extends AnyVal {
  ...
  implicit class SheetsMutableBuilder[Self <: Sheets] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNewSpreadsheet(value: () => typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet): Self = StObject.set(x, "newSpreadsheet", js.Any.fromFunction0(value))
