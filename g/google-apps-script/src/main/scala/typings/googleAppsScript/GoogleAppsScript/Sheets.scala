  ...
  object Schema {
    ...
    object BatchUpdateSpreadsheetResponse {
      ...
      extension [Self <: BatchUpdateSpreadsheetResponse](x: Self) {
        ...
        inline def setUpdatedSpreadsheet(value: typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet): Self = StObject.set(x, "updatedSpreadsheet", value.asInstanceOf[js.Any])
    ...
    object Spreadsheet {
      ...
      inline def apply(): typings.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet = {
        val __obj = js.Dynamic.literal()
