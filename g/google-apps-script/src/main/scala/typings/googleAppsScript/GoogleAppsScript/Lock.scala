...
object Lock {
  ...
  object Lock {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: typings.googleAppsScript.GoogleAppsScript.Lock.Lock] (val x: Self) extends AnyVal {
  ...
  object LockService {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: LockService] (val x: Self) extends AnyVal {
