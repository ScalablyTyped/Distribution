...
object GuideCategoryListResponse {
  ...
  @scala.inline
  implicit class GuideCategoryListResponseOps[Self <: GuideCategoryListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: GuideCategory*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[GuideCategory]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
