...
import typings.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Asp
import typings.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Asps
