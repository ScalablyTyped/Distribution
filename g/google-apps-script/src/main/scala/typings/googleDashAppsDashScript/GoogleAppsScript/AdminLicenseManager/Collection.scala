package typings.googleDashAppsDashScript.GoogleAppsScript.AdminLicenseManager
...
import typings.googleDashAppsDashScript.GoogleAppsScript.AdminLicenseManager.Schema.LicenseAssignmentList
