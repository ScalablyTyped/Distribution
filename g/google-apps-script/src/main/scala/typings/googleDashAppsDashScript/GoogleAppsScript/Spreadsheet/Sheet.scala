...
trait Sheet extends js.Object {
  ...
  def copyTo(spreadsheet: typings.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet): Sheet = js.native
  ...
  def getParent(): typings.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
