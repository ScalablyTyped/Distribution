package typings.googleDashAppsDashScript.GoogleAppsScript.Appsactivity

import typings.googleDashAppsDashScript.GoogleAppsScript.Appsactivity.Schema.ListActivitiesResponse
