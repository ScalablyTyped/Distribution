...
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.AccountPermissionGroup
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.AccountPermissionGroupsListResponse
