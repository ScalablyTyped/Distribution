package typings.googleDashAppsDashScript.GoogleAppsScript.Gmail.Collection.Users.Settings.SendAs

import typings.googleDashAppsDashScript.GoogleAppsScript.Gmail.Schema.ListSmimeInfoResponse
