...
trait EmbeddedComboChartBuilder extends js.Object {
  ...
  def setLegendTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
  ...
  def setTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
  def setTransposeRowsAndColumns(transpose: Boolean): EmbeddedChartBuilder
  def setXAxisTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
  def setXAxisTitle(title: String): EmbeddedComboChartBuilder
  def setXAxisTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
  def setYAxisTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
  def setYAxisTitle(title: String): EmbeddedComboChartBuilder
  def setYAxisTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedComboChartBuilder
...
object EmbeddedComboChartBuilder {
  ...
  def apply(
    ...
    setLegendTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    ...
    setTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setTransposeRowsAndColumns: Boolean => EmbeddedChartBuilder,
    setXAxisTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setXAxisTitle: String => EmbeddedComboChartBuilder,
    setXAxisTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setYAxisTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setYAxisTitle: String => EmbeddedComboChartBuilder,
    setYAxisTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
