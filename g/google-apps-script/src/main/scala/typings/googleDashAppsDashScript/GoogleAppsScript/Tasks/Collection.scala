package typings.googleDashAppsDashScript.GoogleAppsScript.Tasks
...
import typings.googleDashAppsDashScript.GoogleAppsScript.Tasks.Schema.TaskLists
...
object Collection extends js.Object {
  ...
  trait TasksCollection extends js.Object {
    ...
    def list(tasklist: String): typings.googleDashAppsDashScript.GoogleAppsScript.Tasks.Schema.Tasks = js.native
    // Returns all tasks in the specified task list.
    def list(tasklist: String, optionalArgs: js.Object): typings.googleDashAppsDashScript.GoogleAppsScript.Tasks.Schema.Tasks = js.native
