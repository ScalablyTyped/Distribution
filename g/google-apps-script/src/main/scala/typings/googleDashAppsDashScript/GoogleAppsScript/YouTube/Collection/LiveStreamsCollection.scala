...
import typings.googleDashAppsDashScript.GoogleAppsScript.YouTube.Schema.LiveStream
import typings.googleDashAppsDashScript.GoogleAppsScript.YouTube.Schema.LiveStreamListResponse
