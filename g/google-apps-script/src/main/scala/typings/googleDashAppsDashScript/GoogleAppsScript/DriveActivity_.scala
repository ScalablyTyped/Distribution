...
import typings.googleDashAppsDashScript.GoogleAppsScript.DriveActivity.Collection.ActivityCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.DriveActivity.Schema.ConsolidationStrategy
