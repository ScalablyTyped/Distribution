...
trait EmbeddedAreaChartBuilder extends js.Object {
  ...
  def setLegendTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
  ...
  def setTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
  def setTransposeRowsAndColumns(transpose: Boolean): EmbeddedChartBuilder
  def setXAxisTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
  def setXAxisTitle(title: String): EmbeddedAreaChartBuilder
  def setXAxisTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
  def setYAxisTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
  def setYAxisTitle(title: String): EmbeddedAreaChartBuilder
  def setYAxisTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle): EmbeddedAreaChartBuilder
...
object EmbeddedAreaChartBuilder {
  ...
  def apply(
    ...
    setLegendTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    ...
    setTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setTransposeRowsAndColumns: Boolean => EmbeddedChartBuilder,
    setXAxisTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setXAxisTitle: String => EmbeddedAreaChartBuilder,
    setXAxisTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setYAxisTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
    setYAxisTitle: String => EmbeddedAreaChartBuilder,
    setYAxisTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
