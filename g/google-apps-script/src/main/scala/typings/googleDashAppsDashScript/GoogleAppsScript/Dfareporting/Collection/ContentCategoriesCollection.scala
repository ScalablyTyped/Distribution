...
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.ContentCategoriesListResponse
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.ContentCategory
