package typings.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.Groups

import typings.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Alias
import typings.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Aliases
