...
import typings.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.Users.AliasesCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Collection.Users.PhotosCollection
...
trait UsersCollection extends js.Object {
  ...
  def list(): typings.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Users = js.native
  // Retrieve either deleted users or all users in a domain (paginated)
  def list(optionalArgs: js.Object): typings.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Users = js.native
