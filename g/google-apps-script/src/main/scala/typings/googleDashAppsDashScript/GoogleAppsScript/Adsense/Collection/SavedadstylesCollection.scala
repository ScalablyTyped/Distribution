...
import typings.googleDashAppsDashScript.GoogleAppsScript.Adsense.Schema.SavedAdStyle
import typings.googleDashAppsDashScript.GoogleAppsScript.Adsense.Schema.SavedAdStyles
