package typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Collection.Reports

import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.CompatibleFields
