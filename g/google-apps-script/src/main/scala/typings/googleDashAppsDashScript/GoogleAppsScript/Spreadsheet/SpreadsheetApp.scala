...
trait SpreadsheetApp extends js.Object {
  ...
  def getActive(): typings.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def getActiveRange(): Range = js.native
  def getActiveRangeList(): RangeList = js.native
  def getActiveSheet(): Sheet = js.native
  def getActiveSpreadsheet(): typings.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def open(file: File): typings.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def openById(id: String): typings.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def openByUrl(url: String): typings.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def setActiveSpreadsheet(newActiveSpreadsheet: typings.googleDashAppsDashScript.GoogleAppsScript.Spreadsheet.Spreadsheet): Unit = js.native
