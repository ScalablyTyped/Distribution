...
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Collection.PresentationsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.AffineTransform
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.AutoText
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.BatchUpdatePresentationRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Bullet
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ColorScheme
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ColorStop
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateImageRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateLineRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateParagraphBulletsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateShapeRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateSheetsChartRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateSlideRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateTableRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CreateVideoRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.CropProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DeleteObjectRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DeleteParagraphBulletsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DeleteTableColumnRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DeleteTableRowRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DeleteTextRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Dimension
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.DuplicateObjectRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Group
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.GroupObjectsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Image
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ImageProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.InsertTableColumnsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.InsertTableRowsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.InsertTextRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LayoutPlaceholderIdMapping
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LayoutProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LayoutReference
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Line
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LineConnection
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LineFill
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.LineProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Link
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.MasterProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.MergeTableCellsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.NotesProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.OpaqueColor
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.OptionalColor
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Outline
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.OutlineFill
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Page
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.PageBackgroundFill
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.PageElement
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.PageElementProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.PageProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ParagraphMarker
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ParagraphStyle
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Placeholder
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Presentation
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Range
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Recolor
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.RefreshSheetsChartRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ReplaceAllShapesWithImageRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ReplaceAllShapesWithSheetsChartRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ReplaceAllTextRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ReplaceImageRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Request
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.RerouteLineRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.RgbColor
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Shadow
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Shape
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ShapeBackgroundFill
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ShapeProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.SheetsChart
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.SheetsChartProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Size
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.SlideProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.SolidFill
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.StretchedPictureFill
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.SubstringMatchCriteria
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Table
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableBorderCell
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableBorderFill
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableBorderProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableBorderRow
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableCell
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableCellBackgroundFill
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableCellLocation
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableCellProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableColumnProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableRange
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableRow
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TableRowProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TextContent
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TextElement
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TextRun
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.TextStyle
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.ThemeColorPair
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UngroupObjectsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UnmergeTableCellsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateImagePropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateLineCategoryRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateLinePropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdatePageElementAltTextRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdatePageElementTransformRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdatePageElementsZOrderRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdatePagePropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateParagraphStyleRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateShapePropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateSlidesPositionRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateTableBorderPropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateTableCellPropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateTableColumnPropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateTableRowPropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateTextStyleRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.UpdateVideoPropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.Video
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.VideoProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.WeightedFontFamily
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.WordArt
import typings.googleDashAppsDashScript.GoogleAppsScript.Slides.Schema.WriteControl
