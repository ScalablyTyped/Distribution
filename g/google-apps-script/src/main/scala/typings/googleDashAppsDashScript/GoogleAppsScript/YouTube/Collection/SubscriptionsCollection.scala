...
import typings.googleDashAppsDashScript.GoogleAppsScript.YouTube.Schema.Subscription
import typings.googleDashAppsDashScript.GoogleAppsScript.YouTube.Schema.SubscriptionListResponse
