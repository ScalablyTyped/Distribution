...
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.AccountsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.AccountstatusesCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.AccounttaxCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.DatafeedsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.DatafeedstatusesCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.InventoryCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.LiasettingsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.OrderinvoicesCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.OrderpaymentsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.OrderreportsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.OrderreturnsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.OrdersCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.PosCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.ProductsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.ProductstatusesCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Collection.ShippingsettingsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Account
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountAddress
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountAdwordsLink
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountBusinessInformation
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountCustomerService
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountGoogleMyBusinessLink
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountTax
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountTaxTaxRule
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountUser
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountYouTubeChannelLink
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountsCustomBatchRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountsCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountsCustomBatchRequestEntryLinkRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountsLinkRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountstatusesCustomBatchRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccountstatusesCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccounttaxCustomBatchRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.AccounttaxCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Amount
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.CarrierRate
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.CustomAttribute
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.CustomGroup
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.CutoffTime
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Datafeed
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedFetchSchedule
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedFormat
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedTarget
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedsCustomBatchRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedsCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedstatusesCustomBatchRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DatafeedstatusesCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.DeliveryTime
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Error
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Headers
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.HolidayCutoff
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Installment
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Inventory
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InventoryCustomBatchRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InventoryCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InventoryPickup
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InventorySetRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InvoiceSummary
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.InvoiceSummaryAdditionalChargeSummary
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiaAboutPageSettings
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiaCountrySettings
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiaInventorySettings
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiaOnDisplayToOrderSettings
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiaPosDataProvider
...
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LiasettingsCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LocationIdSet
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.LoyaltyPoints
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLegacyPromotion
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLegacyPromotionBenefit
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLineItemProductVariantAttribute
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLineItemReturnInfo
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLineItemShippingDetails
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderLineItemShippingDetailsMethod
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderMerchantProvidedAnnotation
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderShipmentLineItemShipment
...
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderinvoicesCustomBatchRequestEntryCreateRefundInvoiceRefundOption
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrderinvoicesCustomBatchRequestEntryCreateRefundInvoiceReturnOption
...
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryCancel
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryCancelLineItem
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryCreateTestReturnReturnItem
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryInStoreRefundLineItem
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryRefund
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryRejectReturnLineItem
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryReturnLineItem
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryReturnRefundLineItem
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntrySetLineItemMetadata
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryShipLineItems
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryShipLineItemsShipmentInfo
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryUpdateLineItemShippingDetails
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.OrdersCustomBatchRequestEntryUpdateShipment
...
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosInventory
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosInventoryRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PosSale
...
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PostalCodeGroup
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.PostalCodeRange
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Price
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Product
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductAspect
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductDestination
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductShipping
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductShippingDimension
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductShippingWeight
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductTax
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductUnitPricingBaseMeasure
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductUnitPricingMeasure
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductsCustomBatchRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductsCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductstatusesCustomBatchRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ProductstatusesCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Promotion
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.RateGroup
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Row
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Service
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShipmentInvoice
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShipmentInvoiceLineItemInvoice
...
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.ShippingsettingsCustomBatchRequestEntry
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Table
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrder
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrderCustomer
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrderCustomerMarketingRightsInfo
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrderLineItem
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrderLineItemProduct
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TestOrderPaymentMethod
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TransitTable
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TransitTableTransitTimeRow
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.TransitTableTransitTimeRowTransitTimeValue
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.UnitInvoice
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.UnitInvoiceAdditionalCharge
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.UnitInvoiceTaxLine
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Value
import typings.googleDashAppsDashScript.GoogleAppsScript.Content.Schema.Weight
...
object Content_ {
  ...
  def apply(
    ...
    if (Accountstatuses != null) __obj.updateDynamic("Accountstatuses")(Accountstatuses)
    if (Accounttax != null) __obj.updateDynamic("Accounttax")(Accounttax)
    if (Datafeeds != null) __obj.updateDynamic("Datafeeds")(Datafeeds)
    if (Datafeedstatuses != null) __obj.updateDynamic("Datafeedstatuses")(Datafeedstatuses)
    if (Inventory != null) __obj.updateDynamic("Inventory")(Inventory)
    if (Liasettings != null) __obj.updateDynamic("Liasettings")(Liasettings)
    if (Orderinvoices != null) __obj.updateDynamic("Orderinvoices")(Orderinvoices)
    if (Orderpayments != null) __obj.updateDynamic("Orderpayments")(Orderpayments)
    if (Orderreports != null) __obj.updateDynamic("Orderreports")(Orderreports)
    if (Orderreturns != null) __obj.updateDynamic("Orderreturns")(Orderreturns)
    ...
    if (Productstatuses != null) __obj.updateDynamic("Productstatuses")(Productstatuses)
