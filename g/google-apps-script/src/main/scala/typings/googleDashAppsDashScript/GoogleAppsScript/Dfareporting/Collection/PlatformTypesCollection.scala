...
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.PlatformType
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.PlatformTypesListResponse
