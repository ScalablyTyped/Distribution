...
import typings.googleDashAppsDashScript.GoogleAppsScript.Card_Service.OpenAs.FULL_SIZE
import typings.googleDashAppsDashScript.GoogleAppsScript.Card_Service.OpenAs.OVERLAY
