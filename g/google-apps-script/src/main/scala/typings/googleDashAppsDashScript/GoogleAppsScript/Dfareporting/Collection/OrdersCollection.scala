...
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.Order
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.OrdersListResponse
