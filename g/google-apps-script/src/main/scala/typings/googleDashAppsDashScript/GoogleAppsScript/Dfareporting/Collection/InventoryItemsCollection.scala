...
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.InventoryItem
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.InventoryItemsListResponse
