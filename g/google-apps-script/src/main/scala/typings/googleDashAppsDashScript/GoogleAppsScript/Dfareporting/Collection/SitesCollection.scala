...
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.Site
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.SitesListResponse
