...
import typings.googleDashAppsDashScript.GoogleAppsScript.People.Collection.People.ConnectionsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.People.Schema.GetPeopleResponse
