...
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.UserRolePermissionGroup
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.UserRolePermissionGroupsListResponse
