...
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.AdvertiserLandingPagesListResponse
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.LandingPage
