...
import typings.googleDashAppsDashScript.GoogleAppsScript.Classroom.Collection.UserProfiles.GuardianInvitationsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Classroom.Collection.UserProfiles.GuardiansCollection
