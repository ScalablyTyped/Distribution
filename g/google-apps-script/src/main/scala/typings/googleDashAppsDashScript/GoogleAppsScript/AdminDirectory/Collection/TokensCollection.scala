...
import typings.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Token
import typings.googleDashAppsDashScript.GoogleAppsScript.AdminDirectory.Schema.Tokens
