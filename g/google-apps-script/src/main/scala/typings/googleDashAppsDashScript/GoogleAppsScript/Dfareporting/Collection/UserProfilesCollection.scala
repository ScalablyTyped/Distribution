...
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.UserProfile
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.UserProfileList
