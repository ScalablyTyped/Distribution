...
trait CalendarApp extends js.Object {
  ...
  def createCalendar(name: String): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def createCalendar(name: String, options: StringDictionary[js.Any]): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  ...
  def getAllCalendars(): js.Array[typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar] = js.native
  def getAllOwnedCalendars(): js.Array[typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar] = js.native
  def getCalendarById(id: String): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def getCalendarsByName(name: String): js.Array[typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar] = js.native
  def getColor(): String = js.native
  def getDefaultCalendar(): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  ...
  def getOwnedCalendarById(id: String): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def getOwnedCalendarsByName(name: String): js.Array[typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar] = js.native
  ...
  def subscribeToCalendar(id: String): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def subscribeToCalendar(id: String, options: StringDictionary[js.Any]): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
}
