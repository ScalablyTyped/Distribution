...
trait Calendar extends js.Object {
  ...
  def setColor(color: String): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def setDescription(description: String): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def setHidden(hidden: Boolean): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def setName(name: String): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def setSelected(selected: Boolean): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
  def setTimeZone(timeZone: String): typings.googleDashAppsDashScript.GoogleAppsScript.Calendar.Calendar = js.native
