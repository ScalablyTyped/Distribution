...
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.Placement
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.PlacementsGenerateTagsResponse
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.PlacementsListResponse
