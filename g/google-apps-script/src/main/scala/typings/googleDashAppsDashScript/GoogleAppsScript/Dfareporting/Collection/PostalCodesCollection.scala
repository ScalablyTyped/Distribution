...
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.PostalCode
import typings.googleDashAppsDashScript.GoogleAppsScript.Dfareporting.Schema.PostalCodesListResponse
