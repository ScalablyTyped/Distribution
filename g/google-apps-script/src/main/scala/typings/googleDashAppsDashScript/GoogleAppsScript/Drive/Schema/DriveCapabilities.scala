...
object DriveCapabilities {
  ...
  def apply(
    ...
    if (!js.isUndefined(canChangeDriveBackground)) __obj.updateDynamic("canChangeDriveBackground")(canChangeDriveBackground)
    if (!js.isUndefined(canChangeDriveMembersOnlyRestriction)) __obj.updateDynamic("canChangeDriveMembersOnlyRestriction")(canChangeDriveMembersOnlyRestriction)
    ...
    if (!js.isUndefined(canDeleteDrive)) __obj.updateDynamic("canDeleteDrive")(canDeleteDrive)
    ...
    if (!js.isUndefined(canRenameDrive)) __obj.updateDynamic("canRenameDrive")(canRenameDrive)
