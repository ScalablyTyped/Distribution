...
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Collection.SpreadsheetsCollection
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AddBandingRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AddChartRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AddConditionalFormatRuleRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AddDimensionGroupRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AddFilterViewRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AddNamedRangeRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AddProtectedRangeRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AddSheetRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AppendCellsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AppendDimensionRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AutoFillRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.AutoResizeDimensionsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BandedRange
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BandingProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BasicChartAxis
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BasicChartDomain
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BasicChartSeries
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BasicChartSpec
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BasicFilter
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BatchClearValuesByDataFilterRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BatchClearValuesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BatchGetValuesByDataFilterRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BatchUpdateSpreadsheetRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BatchUpdateValuesByDataFilterRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BatchUpdateValuesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BooleanCondition
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BooleanRule
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.Border
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.Borders
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.BubbleChartSpec
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.CandlestickChartSpec
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.CandlestickData
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.CandlestickDomain
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.CandlestickSeries
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.CellData
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.CellFormat
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ChartData
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ChartSourceRange
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ChartSpec
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ClearBasicFilterRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.Color
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ConditionValue
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ConditionalFormatRule
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.CopyPasteRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.CopySheetToAnotherSpreadsheetRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.CreateDeveloperMetadataRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.CutPasteRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DataFilter
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DataFilterValueRange
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DataValidationRule
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DateTimeRule
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeleteBandingRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeleteConditionalFormatRuleRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeleteDeveloperMetadataRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeleteDimensionGroupRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeleteDimensionRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeleteEmbeddedObjectRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeleteFilterViewRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeleteNamedRangeRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeleteProtectedRangeRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeleteRangeRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeleteSheetRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeveloperMetadata
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeveloperMetadataLocation
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DeveloperMetadataLookup
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DimensionGroup
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DimensionProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DimensionRange
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DuplicateFilterViewRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.DuplicateSheetRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.Editors
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.EmbeddedChart
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.EmbeddedObjectPosition
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ErrorValue
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ExtendedValue
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.FilterView
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.FindReplaceRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.GetSpreadsheetByDataFilterRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.GradientRule
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.GridCoordinate
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.GridData
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.GridProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.GridRange
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.HistogramChartSpec
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.HistogramRule
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.HistogramSeries
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.InsertDimensionRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.InsertRangeRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.InterpolationPoint
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.IterativeCalculationSettings
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.LineStyle
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ManualRule
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ManualRuleGroup
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.MergeCellsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.MoveDimensionRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.NamedRange
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.NumberFormat
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.OrgChartSpec
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.OverlayPosition
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.Padding
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.PasteDataRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.PieChartSpec
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.PivotGroup
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.PivotGroupRule
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.PivotGroupSortValueBucket
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.PivotGroupValueMetadata
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.PivotTable
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.PivotValue
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ProtectedRange
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.RandomizeRangeRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.RepeatCellRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.Request
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.RowData
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.SearchDeveloperMetadataRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.SetBasicFilterRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.SetDataValidationRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.Sheet
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.SheetProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.SortRangeRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.SortSpec
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.SourceAndDestination
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.SpreadsheetProperties
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.TextFormat
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.TextFormatRun
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.TextPosition
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.TextRotation
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.TextToColumnsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.TreemapChartColorScale
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.TreemapChartSpec
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UnmergeCellsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateBandingRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateBordersRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateCellsRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateChartSpecRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateConditionalFormatRuleRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateDeveloperMetadataRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateDimensionGroupRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateDimensionPropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateEmbeddedObjectPositionRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateFilterViewRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateNamedRangeRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateProtectedRangeRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateSheetPropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.UpdateSpreadsheetPropertiesRequest
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.ValueRange
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.WaterfallChartColumnStyle
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.WaterfallChartCustomSubtotal
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.WaterfallChartDomain
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.WaterfallChartSeries
import typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.WaterfallChartSpec
...
trait Sheets_ extends js.Object {
  ...
  def newSpreadsheet(): typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.Spreadsheet
...
object Sheets_ {
  ...
  def apply(
    ...
    newSpreadsheet: () => typings.googleDashAppsDashScript.GoogleAppsScript.Sheets.Schema.Spreadsheet,
    ...
    if (Spreadsheets != null) __obj.updateDynamic("Spreadsheets")(Spreadsheets)
