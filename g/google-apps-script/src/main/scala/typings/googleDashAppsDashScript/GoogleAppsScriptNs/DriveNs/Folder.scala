...
trait Folder extends js.Object {
  ...
  def addEditor(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): Folder = js.native
  ...
  def addViewer(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): Folder = js.native
  ...
  def removeEditor(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): Folder = js.native
  ...
  def removeViewer(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): Folder = js.native
  def revokePermissions(user: String): Folder = js.native
  def revokePermissions(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): Folder = js.native
  ...
  def setOwner(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): Folder = js.native
