...
object SlideLinkingMode extends js.Object {
  ...
  /* 1 */ val LINKED: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.SlideLinkingMode.LINKED with Double = js.native
  /* 2 */ val NOT_LINKED: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.SlideLinkingMode.NOT_LINKED with Double = js.native
  /* 0 */ val UNSUPPORTED: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.SlideLinkingMode.UNSUPPORTED with Double = js.native
  @JSBracketAccess
