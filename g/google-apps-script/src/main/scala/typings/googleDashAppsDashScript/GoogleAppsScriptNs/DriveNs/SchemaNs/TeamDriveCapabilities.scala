...
object TeamDriveCapabilities {
  ...
  def apply(
    ...
    if (!js.isUndefined(canChangeCopyRequiresWriterPermissionRestriction)) __obj.updateDynamic("canChangeCopyRequiresWriterPermissionRestriction")(canChangeCopyRequiresWriterPermissionRestriction)
    if (!js.isUndefined(canChangeDomainUsersOnlyRestriction)) __obj.updateDynamic("canChangeDomainUsersOnlyRestriction")(canChangeDomainUsersOnlyRestriction)
    ...
    if (!js.isUndefined(canChangeTeamMembersOnlyRestriction)) __obj.updateDynamic("canChangeTeamMembersOnlyRestriction")(canChangeTeamMembersOnlyRestriction)
    ...
    if (!js.isUndefined(canDeleteChildren)) __obj.updateDynamic("canDeleteChildren")(canDeleteChildren)
    ...
    if (!js.isUndefined(canTrashChildren)) __obj.updateDynamic("canTrashChildren")(canTrashChildren)
