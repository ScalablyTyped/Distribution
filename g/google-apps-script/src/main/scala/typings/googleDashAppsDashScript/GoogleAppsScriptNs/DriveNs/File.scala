...
trait File extends js.Object {
  ...
  def addCommenter(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): File = js.native
  def addCommenters(emailAddresses: js.Array[String]): File = js.native
  def addEditor(emailAddress: String): File = js.native
  def addEditor(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): File = js.native
  def addEditors(emailAddresses: js.Array[String]): File = js.native
  def addViewer(emailAddress: String): File = js.native
  def addViewer(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): File = js.native
  def addViewers(emailAddresses: js.Array[String]): File = js.native
  def getAccess(email: String): Permission = js.native
  def getAccess(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): Permission = js.native
  ...
  def removeCommenter(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): File = js.native
  def removeEditor(emailAddress: String): File = js.native
  def removeEditor(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): File = js.native
  def removeViewer(emailAddress: String): File = js.native
  def removeViewer(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): File = js.native
  def revokePermissions(user: String): File = js.native
  def revokePermissions(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): File = js.native
  ...
  def setOwner(user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.BaseNs.User): File = js.native
