...
trait Sheet extends js.Object {
  ...
  def getColumnGroup(columnIndex: Integer, groupDepth: Integer): Group = js.native
  ...
  def getRowGroup(rowIndex: Integer, groupDepth: Integer): Group = js.native
  ...
  def getTabColor(): String = js.native
