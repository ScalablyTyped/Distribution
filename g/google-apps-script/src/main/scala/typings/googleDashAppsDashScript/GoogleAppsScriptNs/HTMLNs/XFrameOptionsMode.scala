...
object XFrameOptionsMode extends js.Object {
  ...
  /* 0 */ val ALLOWALL: typings.googleDashAppsDashScript.GoogleAppsScriptNs.HTMLNs.XFrameOptionsMode.ALLOWALL with Double = js.native
  /* 1 */ val DEFAULT: typings.googleDashAppsDashScript.GoogleAppsScriptNs.HTMLNs.XFrameOptionsMode.DEFAULT with Double = js.native
  @JSBracketAccess
