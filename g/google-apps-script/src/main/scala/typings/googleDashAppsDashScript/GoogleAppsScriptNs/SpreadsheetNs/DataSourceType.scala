...
object DataSourceType extends js.Object {
  ...
  /* 1 */ val BIGQUERY: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SpreadsheetNs.DataSourceType.BIGQUERY with Double = js.native
  /* 0 */ val DATA_SOURCE_TYPE_UNSUPPORTED: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SpreadsheetNs.DataSourceType.DATA_SOURCE_TYPE_UNSUPPORTED with Double = js.native
  @JSBracketAccess
