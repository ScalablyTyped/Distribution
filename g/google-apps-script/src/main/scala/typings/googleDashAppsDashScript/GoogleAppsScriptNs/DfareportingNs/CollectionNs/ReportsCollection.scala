...
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.DfareportingNs.CollectionNs.ReportsNs.CompatibleFieldsCollection
...
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.DfareportingNs.SchemaNs.ReportList
...
trait ReportsCollection extends js.Object {
  ...
  var Files: js.UndefOr[
    typings.googleDashAppsDashScript.GoogleAppsScriptNs.DfareportingNs.CollectionNs.ReportsNs.FilesCollection
  ] = js.native
