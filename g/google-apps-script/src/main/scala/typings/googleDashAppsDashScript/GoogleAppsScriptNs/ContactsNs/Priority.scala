...
object Priority extends js.Object {
  ...
  /* 0 */ val HIGH: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ContactsNs.Priority.HIGH with Double = js.native
  /* 1 */ val LOW: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ContactsNs.Priority.LOW with Double = js.native
  /* 2 */ val NORMAL: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ContactsNs.Priority.NORMAL with Double = js.native
  @JSBracketAccess
