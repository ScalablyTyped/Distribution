...
object RsaAlgorithm extends js.Object {
  ...
  /* 0 */ val RSA_SHA_1: typings.googleDashAppsDashScript.GoogleAppsScriptNs.UtilitiesNs.RsaAlgorithm.RSA_SHA_1 with Double = js.native
  /* 1 */ val RSA_SHA_256: typings.googleDashAppsDashScript.GoogleAppsScriptNs.UtilitiesNs.RsaAlgorithm.RSA_SHA_256 with Double = js.native
  @JSBracketAccess
