...
trait About extends js.Object {
  ...
  var user: js.UndefOr[typings.googleDashAppsDashScript.GoogleAppsScriptNs.DriveNs.SchemaNs.User] = js.undefined
}
...
object About {
  ...
  def apply(
    ...
    user: typings.googleDashAppsDashScript.GoogleAppsScriptNs.DriveNs.SchemaNs.User = null
  ): About = {
