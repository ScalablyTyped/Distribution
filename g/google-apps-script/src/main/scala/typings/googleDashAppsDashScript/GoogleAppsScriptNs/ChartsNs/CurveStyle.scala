...
object CurveStyle extends js.Object {
  ...
  /* 0 */ val NORMAL: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.CurveStyle.NORMAL with Double = js.native
  /* 1 */ val SMOOTH: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.CurveStyle.SMOOTH with Double = js.native
  @JSBracketAccess
