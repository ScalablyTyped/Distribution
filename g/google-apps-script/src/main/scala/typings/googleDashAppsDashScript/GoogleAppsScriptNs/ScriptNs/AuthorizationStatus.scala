...
object AuthorizationStatus extends js.Object {
  ...
  /* 1 */ val NOT_REQUIRED: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ScriptNs.AuthorizationStatus.NOT_REQUIRED with Double = js.native
  /* 0 */ val REQUIRED: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ScriptNs.AuthorizationStatus.REQUIRED with Double = js.native
  @JSBracketAccess
