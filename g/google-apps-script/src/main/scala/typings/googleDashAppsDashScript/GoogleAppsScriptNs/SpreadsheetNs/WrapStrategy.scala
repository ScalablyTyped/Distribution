...
object WrapStrategy extends js.Object {
  ...
  /* 2 */ val CLIP: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SpreadsheetNs.WrapStrategy.CLIP with Double = js.native
  /* 1 */ val OVERFLOW: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SpreadsheetNs.WrapStrategy.OVERFLOW with Double = js.native
  /* 0 */ val WRAP: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SpreadsheetNs.WrapStrategy.WRAP with Double = js.native
  @JSBracketAccess
