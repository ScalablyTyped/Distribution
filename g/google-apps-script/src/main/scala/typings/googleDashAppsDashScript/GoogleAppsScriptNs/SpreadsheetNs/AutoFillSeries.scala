...
object AutoFillSeries extends js.Object {
  ...
  /* 1 */ val ALTERNATE_SERIES: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SpreadsheetNs.AutoFillSeries.ALTERNATE_SERIES with Double = js.native
  /* 0 */ val DEFAULT_SERIES: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SpreadsheetNs.AutoFillSeries.DEFAULT_SERIES with Double = js.native
  @JSBracketAccess
