...
object ChartMergeStrategy extends js.Object {
  ...
  /* 0 */ val MERGE_COLUMNS: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.ChartMergeStrategy.MERGE_COLUMNS with Double = js.native
  /* 1 */ val MERGE_ROWS: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.ChartMergeStrategy.MERGE_ROWS with Double = js.native
  @JSBracketAccess
