...
trait Element extends js.Object {
  def addContent(content: typings.googleDashAppsDashScript.GoogleAppsScriptNs.XMLUnderscoreServiceNs.Content): Element = js.native
  def addContent(
    index: Integer,
  ...
  def detach(): typings.googleDashAppsDashScript.GoogleAppsScriptNs.XMLUnderscoreServiceNs.Content = js.native
