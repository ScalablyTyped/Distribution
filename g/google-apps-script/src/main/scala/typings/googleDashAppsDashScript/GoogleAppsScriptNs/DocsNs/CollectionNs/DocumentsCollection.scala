package typings.googleDashAppsDashScript.GoogleAppsScriptNs.DocsNs.CollectionNs

import typings.googleDashAppsDashScript.GoogleAppsScriptNs.DocsNs.SchemaNs.BatchUpdateDocumentRequest
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.DocsNs.SchemaNs.BatchUpdateDocumentResponse
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.DocsNs.SchemaNs.Document
