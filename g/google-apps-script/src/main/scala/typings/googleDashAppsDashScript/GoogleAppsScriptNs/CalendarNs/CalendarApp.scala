...
trait CalendarApp extends js.Object {
  ...
  def getCalendarsByName(name: String): js.Array[typings.googleDashAppsDashScript.GoogleAppsScriptNs.CalendarNs.Calendar] = js.native
  def getColor(): String = js.native
  def getDefaultCalendar(): typings.googleDashAppsDashScript.GoogleAppsScriptNs.CalendarNs.Calendar = js.native
  ...
  def getOwnedCalendarsByName(name: String): js.Array[typings.googleDashAppsDashScript.GoogleAppsScriptNs.CalendarNs.Calendar] = js.native
