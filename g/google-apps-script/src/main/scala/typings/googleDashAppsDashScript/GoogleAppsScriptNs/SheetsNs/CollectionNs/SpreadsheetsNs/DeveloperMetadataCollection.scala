...
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.SheetsNs.SchemaNs.DeveloperMetadata
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.SheetsNs.SchemaNs.SearchDeveloperMetadataRequest
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.SheetsNs.SchemaNs.SearchDeveloperMetadataResponse
