...
object ColorType extends js.Object {
  ...
  /* 1 */ val RGB: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.ColorType.RGB with Double = js.native
  /* 2 */ val THEME: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.ColorType.THEME with Double = js.native
  /* 0 */ val UNSUPPORTED: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.ColorType.UNSUPPORTED with Double = js.native
  @JSBracketAccess
