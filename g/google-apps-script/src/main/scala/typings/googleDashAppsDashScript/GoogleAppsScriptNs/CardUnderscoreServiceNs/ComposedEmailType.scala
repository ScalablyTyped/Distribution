...
object ComposedEmailType extends js.Object {
  ...
  /* 0 */ val REPLY_AS_DRAFT: typings.googleDashAppsDashScript.GoogleAppsScriptNs.CardUnderscoreServiceNs.ComposedEmailType.REPLY_AS_DRAFT with Double = js.native
  /* 1 */ val STANDALONE_DRAFT: typings.googleDashAppsDashScript.GoogleAppsScriptNs.CardUnderscoreServiceNs.ComposedEmailType.STANDALONE_DRAFT with Double = js.native
  @JSBracketAccess
