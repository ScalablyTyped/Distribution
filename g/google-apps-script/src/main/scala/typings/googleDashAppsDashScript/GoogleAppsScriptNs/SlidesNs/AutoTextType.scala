...
object AutoTextType extends js.Object {
  ...
  /* 1 */ val SLIDE_NUMBER: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.AutoTextType.SLIDE_NUMBER with Double = js.native
  /* 0 */ val UNSUPPORTED: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.AutoTextType.UNSUPPORTED with Double = js.native
  @JSBracketAccess
