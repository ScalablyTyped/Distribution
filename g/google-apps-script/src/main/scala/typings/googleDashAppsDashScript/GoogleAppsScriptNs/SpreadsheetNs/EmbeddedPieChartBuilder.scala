...
trait EmbeddedPieChartBuilder extends js.Object {
  ...
  def setLegendTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedPieChartBuilder
  ...
  def setTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedPieChartBuilder
...
object EmbeddedPieChartBuilder {
  ...
  def apply(
    ...
    setLegendTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedPieChartBuilder,
    ...
    setTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedPieChartBuilder,
