...
object Charset extends js.Object {
  ...
  /* 0 */ val US_ASCII: typings.googleDashAppsDashScript.GoogleAppsScriptNs.UtilitiesNs.Charset.US_ASCII with Double = js.native
  /* 1 */ val UTF_8: typings.googleDashAppsDashScript.GoogleAppsScriptNs.UtilitiesNs.Charset.UTF_8 with Double = js.native
  @JSBracketAccess
