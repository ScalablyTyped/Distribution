...
object AlignmentPosition extends js.Object {
  ...
  /* 0 */ val CENTER: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.AlignmentPosition.CENTER with Double = js.native
  /* 1 */ val HORIZONTAL_CENTER: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.AlignmentPosition.HORIZONTAL_CENTER with Double = js.native
  /* 2 */ val VERTICAL_CENTER: typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.AlignmentPosition.VERTICAL_CENTER with Double = js.native
  @JSBracketAccess
