...
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.ContentNs.SchemaNs.ShippingSettings
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.ContentNs.SchemaNs.ShippingsettingsCustomBatchRequest
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.ContentNs.SchemaNs.ShippingsettingsCustomBatchResponse
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.ContentNs.SchemaNs.ShippingsettingsGetSupportedCarriersResponse
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.ContentNs.SchemaNs.ShippingsettingsGetSupportedHolidaysResponse
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.ContentNs.SchemaNs.ShippingsettingsListResponse
