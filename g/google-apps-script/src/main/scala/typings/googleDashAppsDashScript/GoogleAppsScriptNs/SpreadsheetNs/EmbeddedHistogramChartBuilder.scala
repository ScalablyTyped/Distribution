...
trait EmbeddedHistogramChartBuilder extends js.Object {
  ...
  def setLegendTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedHistogramChartBuilder
  ...
  def setTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedHistogramChartBuilder
  def setTransposeRowsAndColumns(transpose: Boolean): EmbeddedChartBuilder
  def setXAxisTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedHistogramChartBuilder
  def setXAxisTitle(title: String): EmbeddedHistogramChartBuilder
  def setXAxisTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedHistogramChartBuilder
  def setYAxisTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedHistogramChartBuilder
  def setYAxisTitle(title: String): EmbeddedHistogramChartBuilder
  def setYAxisTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedHistogramChartBuilder
...
object EmbeddedHistogramChartBuilder {
  ...
  def apply(
    ...
    setLegendTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedHistogramChartBuilder,
    ...
    setTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedHistogramChartBuilder,
    setTransposeRowsAndColumns: Boolean => EmbeddedChartBuilder,
    setXAxisTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedHistogramChartBuilder,
    setXAxisTitle: String => EmbeddedHistogramChartBuilder,
    setXAxisTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedHistogramChartBuilder,
    setYAxisTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedHistogramChartBuilder,
    setYAxisTitle: String => EmbeddedHistogramChartBuilder,
    setYAxisTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedHistogramChartBuilder,
