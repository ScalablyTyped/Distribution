...
object Orientation extends js.Object {
  ...
  /* 0 */ val HORIZONTAL: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.Orientation.HORIZONTAL with Double = js.native
  /* 1 */ val VERTICAL: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.Orientation.VERTICAL with Double = js.native
  @JSBracketAccess
