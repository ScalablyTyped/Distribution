...
trait EmbeddedColumnChartBuilder extends js.Object {
  ...
  def setLegendTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedColumnChartBuilder
  ...
  def setTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedColumnChartBuilder
  def setTransposeRowsAndColumns(transpose: Boolean): EmbeddedChartBuilder
  def setXAxisTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedColumnChartBuilder
  def setXAxisTitle(title: String): EmbeddedColumnChartBuilder
  def setXAxisTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedColumnChartBuilder
  def setYAxisTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedColumnChartBuilder
  def setYAxisTitle(title: String): EmbeddedColumnChartBuilder
  def setYAxisTitleTextStyle(textStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle): EmbeddedColumnChartBuilder
...
object EmbeddedColumnChartBuilder {
  ...
  def apply(
    ...
    setLegendTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedColumnChartBuilder,
    ...
    setTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedColumnChartBuilder,
    setTransposeRowsAndColumns: Boolean => EmbeddedChartBuilder,
    setXAxisTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedColumnChartBuilder,
    setXAxisTitle: String => EmbeddedColumnChartBuilder,
    setXAxisTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedColumnChartBuilder,
    setYAxisTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedColumnChartBuilder,
    setYAxisTitle: String => EmbeddedColumnChartBuilder,
    setYAxisTitleTextStyle: typings.googleDashAppsDashScript.GoogleAppsScriptNs.ChartsNs.TextStyle => EmbeddedColumnChartBuilder,
