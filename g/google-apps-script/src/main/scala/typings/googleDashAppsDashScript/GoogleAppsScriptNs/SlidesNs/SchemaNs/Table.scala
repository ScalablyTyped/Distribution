...
trait Table extends js.Object {
  ...
  var tableRows: js.UndefOr[
    js.Array[typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.SchemaNs.TableRow]
  ] = js.undefined
...
object Table {
  ...
  def apply(
    ...
    tableRows: js.Array[typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.SchemaNs.TableRow] = null,
