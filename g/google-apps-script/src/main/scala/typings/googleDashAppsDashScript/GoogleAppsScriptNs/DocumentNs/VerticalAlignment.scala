...
object VerticalAlignment extends js.Object {
  ...
  /* 0 */ val BOTTOM: typings.googleDashAppsDashScript.GoogleAppsScriptNs.DocumentNs.VerticalAlignment.BOTTOM with Double = js.native
  /* 1 */ val CENTER: typings.googleDashAppsDashScript.GoogleAppsScriptNs.DocumentNs.VerticalAlignment.CENTER with Double = js.native
  /* 2 */ val TOP: typings.googleDashAppsDashScript.GoogleAppsScriptNs.DocumentNs.VerticalAlignment.TOP with Double = js.native
  @JSBracketAccess
