...
trait TableRow extends js.Object {
  ...
  var tableCells: js.UndefOr[
    js.Array[typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.SchemaNs.TableCell]
  ] = js.undefined
...
object TableRow {
  ...
  def apply(
    ...
    tableCells: js.Array[typings.googleDashAppsDashScript.GoogleAppsScriptNs.SlidesNs.SchemaNs.TableCell] = null,
