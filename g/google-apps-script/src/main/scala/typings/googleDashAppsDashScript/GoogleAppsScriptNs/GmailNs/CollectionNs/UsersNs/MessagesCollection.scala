...
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.GmailNs.CollectionNs.UsersNs.MessagesNs.AttachmentsCollection
...
import typings.googleDashAppsDashScript.GoogleAppsScriptNs.GmailNs.SchemaNs.ListMessagesResponse
