...
object anon {
  ...
  @js.native
  trait NonepatternstringArraystr extends StObject {
  ...
  @js.native
  trait NonepatternstringArraystrCall extends StObject {
  ...
  @js.native
  trait NonepatternstringArraystrSync extends StObject {
