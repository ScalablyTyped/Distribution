...
object globModMembers extends js.Object {
  ...
  def `__promisify__`(pattern: java.lang.String): stdLib.Promise[js.Array[java.lang.String]] = js.native
  def `__promisify__`(pattern: java.lang.String, options: globLib.globMod.GNs.IOptions): stdLib.Promise[js.Array[java.lang.String]] = js.native
