...
trait Anon_AdClientIdAltFieldsIncludeInactive extends js.Object {
...
object Anon_AdClientIdAltFieldsIncludeInactive {
  @scala.inline
  def apply(
    adClientId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[Anon_AdClientIdAltFieldsIncludeInactive]
  }
}
