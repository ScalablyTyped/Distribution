...
trait Anon_AccountIdAltCurrency extends js.Object {
...
object Anon_AccountIdAltCurrency {
  @scala.inline
  def apply(
    accountId: String,
    endDate: String,
    ...
    __obj.asInstanceOf[Anon_AccountIdAltCurrency]
  }
}
