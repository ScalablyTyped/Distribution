...
trait Anon_AccountIdAdClientIdAltCustomChannelId extends js.Object {
...
object Anon_AccountIdAdClientIdAltCustomChannelId {
  @scala.inline
  def apply(
    accountId: String,
    adClientId: String,
    ...
    userIp: String = null
  ): Anon_AccountIdAdClientIdAltCustomChannelId = {
    val __obj = js.Dynamic.literal(accountId = accountId, adClientId = adClientId, customChannelId = customChannelId)
    ...
    __obj.asInstanceOf[Anon_AccountIdAdClientIdAltCustomChannelId]
  }
}
