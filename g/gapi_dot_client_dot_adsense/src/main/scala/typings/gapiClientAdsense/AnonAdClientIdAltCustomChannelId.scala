...
trait AnonAdClientIdAltCustomChannelId extends js.Object {
...
object AnonAdClientIdAltCustomChannelId {
  @scala.inline
  def apply(
    adClientId: String,
    ...
    userIp: String = null
  ): AnonAdClientIdAltCustomChannelId = {
    ...
    __obj.asInstanceOf[AnonAdClientIdAltCustomChannelId]
  }
}
