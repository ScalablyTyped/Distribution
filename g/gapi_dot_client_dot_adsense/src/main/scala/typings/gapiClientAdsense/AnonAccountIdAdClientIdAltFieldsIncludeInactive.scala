...
trait AnonAccountIdAdClientIdAltFieldsIncludeInactive extends js.Object {
...
object AnonAccountIdAdClientIdAltFieldsIncludeInactive {
  @scala.inline
  def apply(
    accountId: String,
    adClientId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAdClientIdAltFieldsIncludeInactive = {
    ...
    __obj.asInstanceOf[AnonAccountIdAdClientIdAltFieldsIncludeInactive]
  }
}
