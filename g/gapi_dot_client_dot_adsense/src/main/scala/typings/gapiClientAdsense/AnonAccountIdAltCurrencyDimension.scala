...
trait AnonAccountIdAltCurrencyDimension extends js.Object {
...
object AnonAccountIdAltCurrencyDimension {
  @scala.inline
  def apply(
    endDate: String,
    startDate: String,
    ...
    userIp: String = null
  ): AnonAccountIdAltCurrencyDimension = {
    ...
    __obj.asInstanceOf[AnonAccountIdAltCurrencyDimension]
  }
}
