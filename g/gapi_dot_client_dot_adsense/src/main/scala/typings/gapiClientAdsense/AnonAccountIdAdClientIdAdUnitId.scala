...
trait AnonAccountIdAdClientIdAdUnitId extends js.Object {
...
object AnonAccountIdAdClientIdAdUnitId {
  @scala.inline
  def apply(
    accountId: String,
    adClientId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAdClientIdAdUnitId = {
    ...
    __obj.asInstanceOf[AnonAccountIdAdClientIdAdUnitId]
  }
}
