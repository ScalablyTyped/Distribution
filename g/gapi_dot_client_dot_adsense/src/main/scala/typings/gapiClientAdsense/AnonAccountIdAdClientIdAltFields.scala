...
trait AnonAccountIdAdClientIdAltFields extends js.Object {
...
object AnonAccountIdAdClientIdAltFields {
  @scala.inline
  def apply(
    accountId: String,
    adClientId: String,
    ...
    userIp: String = null
  ): AnonAccountIdAdClientIdAltFields = {
    ...
    __obj.asInstanceOf[AnonAccountIdAdClientIdAltFields]
  }
}
