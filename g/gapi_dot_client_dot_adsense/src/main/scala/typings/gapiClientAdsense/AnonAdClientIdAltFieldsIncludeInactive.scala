...
trait AnonAdClientIdAltFieldsIncludeInactive extends js.Object {
...
object AnonAdClientIdAltFieldsIncludeInactive {
  @scala.inline
  def apply(
    adClientId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAdClientIdAltFieldsIncludeInactive = {
    ...
    __obj.asInstanceOf[AnonAdClientIdAltFieldsIncludeInactive]
  }
}
