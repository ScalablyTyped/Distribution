...
trait Anon_AccountIdAdClientIdAltFieldsIncludeInactive extends js.Object {
...
object Anon_AccountIdAdClientIdAltFieldsIncludeInactive {
  @scala.inline
  def apply(
    accountId: java.lang.String,
    adClientId: java.lang.String,
  ...
  ): Anon_AccountIdAdClientIdAltFieldsIncludeInactive = {
    val __obj = js.Dynamic.literal(accountId = accountId, adClientId = adClientId)
    ...
    __obj.asInstanceOf[Anon_AccountIdAdClientIdAltFieldsIncludeInactive]
  }
}
