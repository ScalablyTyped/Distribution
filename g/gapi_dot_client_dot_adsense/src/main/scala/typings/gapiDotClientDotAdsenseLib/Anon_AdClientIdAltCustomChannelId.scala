...
trait Anon_AdClientIdAltCustomChannelId extends js.Object {
...
object Anon_AdClientIdAltCustomChannelId {
  @scala.inline
  def apply(
    adClientId: java.lang.String,
    customChannelId: java.lang.String,
  ...
  ): Anon_AdClientIdAltCustomChannelId = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("adClientId")(adClientId)
    __obj.updateDynamic("customChannelId")(customChannelId)
    ...
    __obj.asInstanceOf[Anon_AdClientIdAltCustomChannelId]
  }
}
