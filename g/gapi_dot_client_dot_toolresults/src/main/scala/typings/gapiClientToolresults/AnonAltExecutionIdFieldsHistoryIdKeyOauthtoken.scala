...
trait AnonAltExecutionIdFieldsHistoryIdKeyOauthtoken extends js.Object {
...
object AnonAltExecutionIdFieldsHistoryIdKeyOauthtoken {
  @scala.inline
  def apply(
    executionId: String,
    historyId: String,
    ...
    userIp: String = null
  ): AnonAltExecutionIdFieldsHistoryIdKeyOauthtoken = {
    ...
    __obj.asInstanceOf[AnonAltExecutionIdFieldsHistoryIdKeyOauthtoken]
  }
}
