...
trait AnonAltFieldsFilterByName extends js.Object {
...
object AnonAltFieldsFilterByName {
  @scala.inline
  def apply(
    projectId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltFieldsFilterByName]
  }
}
