...
trait PerfMetricsSummaryResource extends js.Object {
  /**
    ...
    */
  def create(request: AnonAltExecutionIdFields): Request_[PerfMetricsSummary]
}

object PerfMetricsSummaryResource {
  @scala.inline
  def apply(create: AnonAltExecutionIdFields => Request_[PerfMetricsSummary]): PerfMetricsSummaryResource = {
