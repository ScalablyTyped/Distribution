...
trait AnonAltExecutionIdFieldsFilter extends js.Object {
...
object AnonAltExecutionIdFieldsFilter {
  @scala.inline
  def apply(
    executionId: String,
    historyId: String,
    ...
    userIp: String = null
  ): AnonAltExecutionIdFieldsFilter = {
    ...
    __obj.asInstanceOf[AnonAltExecutionIdFieldsFilter]
  }
}
