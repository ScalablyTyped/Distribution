...
trait AnonAltExecutionIdFieldsHistoryId extends js.Object {
...
object AnonAltExecutionIdFieldsHistoryId {
  @scala.inline
  def apply(
    executionId: String,
    historyId: String,
    ...
    userIp: String = null
  ): AnonAltExecutionIdFieldsHistoryId = {
    ...
    __obj.asInstanceOf[AnonAltExecutionIdFieldsHistoryId]
  }
}
