...
trait AnonAltExecutionIdFieldsHistoryIdKey extends js.Object {
...
object AnonAltExecutionIdFieldsHistoryIdKey {
  @scala.inline
  def apply(
    executionId: String,
    historyId: String,
    ...
    userIp: String = null
  ): AnonAltExecutionIdFieldsHistoryIdKey = {
    ...
    __obj.asInstanceOf[AnonAltExecutionIdFieldsHistoryIdKey]
  }
}
