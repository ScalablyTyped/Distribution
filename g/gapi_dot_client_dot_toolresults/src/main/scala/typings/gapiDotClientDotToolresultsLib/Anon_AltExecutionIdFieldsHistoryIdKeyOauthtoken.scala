...
trait Anon_AltExecutionIdFieldsHistoryIdKeyOauthtoken extends js.Object {
...
object Anon_AltExecutionIdFieldsHistoryIdKeyOauthtoken {
  @scala.inline
  def apply(
  ...
  ): Anon_AltExecutionIdFieldsHistoryIdKeyOauthtoken = {
    ...
    __obj.asInstanceOf[Anon_AltExecutionIdFieldsHistoryIdKeyOauthtoken]
  }
}
