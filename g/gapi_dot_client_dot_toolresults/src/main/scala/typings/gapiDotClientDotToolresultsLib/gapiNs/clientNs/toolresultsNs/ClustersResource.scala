...
trait ClustersResource extends js.Object {
  ...
  def get(
    request: gapiDotClientDotToolresultsLib.Anon_PrettyPrintHistoryIdProjectIdQuotaUserKeyUserIpClusterId
  ...
  /**
    ...
    */
  def list(request: gapiDotClientDotToolresultsLib.Anon_PrettyPrintHistoryId): gapiDotClientLib.gapiNs.clientNs.Request[ListScreenshotClustersResponse]
}
