...
trait ResourceRecordSetsResource extends js.Object {
  ...
  def list(request: typings.gapiClientDns.anon.ManagedZone): Request[ResourceRecordSetsListResponse] = js.native
}
...
object ResourceRecordSetsResource {
  ...
  implicit class ResourceRecordSetsResourceOps[Self <: ResourceRecordSetsResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setList(value: typings.gapiClientDns.anon.ManagedZone => Request[ResourceRecordSetsListResponse]): Self = this.set("list", js.Any.fromFunction1(value))
  }
