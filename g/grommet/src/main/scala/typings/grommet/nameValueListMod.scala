...
object nameValueListMod {
  ...
  - typings.grommet.gridMod.GridProps because var conflicts: align. Inlined a11yTitle, alignSelf, alignContent, areas, as, border, columns, fill, gap, gridArea, height, justify, justifyContent, margin, pad, responsive, rows, tag, width */ trait NameValueListExtendedProps
    extends StObject
