...
import typings.grommet.pageContentMod.PageContentExtendedProps
import typings.grommet.pageHeaderMod.PageHeaderExtendedProps
import typings.grommet.pageMod.PageExtendedProps
...
object mod {
  ...
  @js.native
  val Grommet_ : FC[GrommetExtendedProps] = js.native
  ...
  @JSImport("grommet", "NameValueList")
  @js.native
  val NameValueList: FC[NameValueListExtendedProps] = js.native
  
  @JSImport("grommet", "NameValuePair")
  @js.native
  ...
  object base {
    ...
    @JSImport("grommet", "base.checkBoxGroup")
    @js.native
    ...
    @JSImport("grommet", "base.fileInput")
    @js.native
    ...
    val formField: js.UndefOr[
        typings.grommet.anon.CheckBox | DeepReadonly[js.UndefOr[typings.grommet.anon.CheckBox]]
      ] = js.native
