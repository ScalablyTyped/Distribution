...
trait AnonBodyBottom extends js.Object {
  var body: js.UndefOr[none | xxsmall | xsmall | small | medium | large | xlarge | AnonBottomHorizontal] = js.undefined
  var bottom: js.UndefOr[xxsmall | xsmall | small | medium | large | xlarge | String] = js.undefined
  var footer: js.UndefOr[none | xxsmall | xsmall | small | medium | large | xlarge | AnonBottomHorizontal] = js.undefined
  var header: js.UndefOr[none | xxsmall | xsmall | small | medium | large | xlarge | AnonBottomHorizontal] = js.undefined
...
object AnonBodyBottom {
  @scala.inline
  def apply(
    body: none | xxsmall | xsmall | small | medium | large | xlarge | AnonBottomHorizontal = null,
    bottom: xxsmall | xsmall | small | medium | large | xlarge | String = null,
    footer: none | xxsmall | xsmall | small | medium | large | xlarge | AnonBottomHorizontal = null,
    header: none | xxsmall | xsmall | small | medium | large | xlarge | AnonBottomHorizontal = null,
    ...
    __obj.asInstanceOf[AnonBodyBottom]
  }
}
