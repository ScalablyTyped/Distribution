...
object Colors {
  ...
  def apply(
    ...
    `graph-0`: ColorType = null,
    `graph-1`: ColorType = null,
    `graph-2`: ColorType = null,
    `graph-3`: ColorType = null,
    `graph-4`: ColorType = null,
    `graph-5`: ColorType = null,
    icon: ColorType = null,
    ...
    if (`graph-0` != null) __obj.updateDynamic("graph-0")(`graph-0`.asInstanceOf[js.Any])
    if (`graph-1` != null) __obj.updateDynamic("graph-1")(`graph-1`.asInstanceOf[js.Any])
    if (`graph-2` != null) __obj.updateDynamic("graph-2")(`graph-2`.asInstanceOf[js.Any])
    if (`graph-3` != null) __obj.updateDynamic("graph-3")(`graph-3`.asInstanceOf[js.Any])
    if (`graph-4` != null) __obj.updateDynamic("graph-4")(`graph-4`.asInstanceOf[js.Any])
    if (`graph-5` != null) __obj.updateDynamic("graph-5")(`graph-5`.asInstanceOf[js.Any])
