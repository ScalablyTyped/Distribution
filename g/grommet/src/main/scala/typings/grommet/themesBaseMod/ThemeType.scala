...
import typings.grommet.Anon_Baseline
import typings.grommet.Anon_BodyFooter
import typings.grommet.Anon_BorderCheck
import typings.grommet.Anon_BorderCheckGap
import typings.grommet.Anon_BorderContent
...
import typings.grommet.Anon_ExtendResponsiveBreakpoint
import typings.grommet.Anon_ExtendSizeAnonLargeMediumSmallX
import typings.grommet.Anon_GroupEnd
import typings.grommet.Anon_Heading
import typings.grommet.Anon_LargeMediumSmallXlargeXsmall
import typings.grommet.Anon_Thumb
...
object ThemeType {
  ...
  def apply(
    ...
    if (carousel != null) __obj.updateDynamic("carousel")(carousel)
    ...
    if (collapsible != null) __obj.updateDynamic("collapsible")(collapsible)
    ...
    if (formField != null) __obj.updateDynamic("formField")(formField)
    if (global != null) __obj.updateDynamic("global")(global)
    if (grommet != null) __obj.updateDynamic("grommet")(grommet)
    ...
    if (rangeInput != null) __obj.updateDynamic("rangeInput")(rangeInput)
    ...
    if (worldMap != null) __obj.updateDynamic("worldMap")(worldMap)
