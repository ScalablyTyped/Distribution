...
trait SelectProps extends js.Object {
  ...
  var value: js.UndefOr[String | Element | js.Object | (js.Array[String | js.Object])] = js.native
...
object SelectProps {
  ...
  implicit class SelectPropsOps[Self <: SelectProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValue(value: String | Element | js.Object | (js.Array[String | js.Object])): Self = this.set("value", value.asInstanceOf[js.Any])
    @scala.inline
