...
object Sections {
  @scala.inline
  def apply[TBody, THeader, TFooter](): Sections[TBody, THeader, TFooter] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Sections[TBody, THeader, TFooter]]
  }
  @scala.inline
  implicit class SectionsOps[Self <: Sections[_, _, _], TBody, THeader, TFooter] (val x: Self with (Sections[TBody, THeader, TFooter])) extends AnyVal {
    @scala.inline
