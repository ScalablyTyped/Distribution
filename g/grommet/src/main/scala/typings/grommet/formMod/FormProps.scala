...
trait FormProps[T] extends js.Object {
  ...
  var onSubmit: js.UndefOr[js.Function1[/* event */ FormEvent[Element], Unit]] = js.native
...
object FormProps {
  ...
  implicit class FormPropsOps[Self <: FormProps[_], T] (val x: Self with FormProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setOnSubmit(value: /* event */ FormEvent[Element] => Unit): Self = this.set("onSubmit", js.Any.fromFunction1(value))
    @scala.inline
