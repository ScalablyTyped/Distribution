...
trait AnonGroupEnd extends js.Object {
  var groupEnd: js.UndefOr[AnonBorderAnonSide] = js.undefined
  var groupHeader: js.UndefOr[AnonBackgroundBorderFill] = js.undefined
  var header: js.UndefOr[js.Object] = js.undefined
  var icons: js.UndefOr[AnonAscending] = js.undefined
  var primary: js.UndefOr[AnonWeight] = js.undefined
  var resize: js.UndefOr[AnonBorderAnonColorSideColorType] = js.undefined
}

object AnonGroupEnd {
  @scala.inline
  def apply(
    groupEnd: AnonBorderAnonSide = null,
    groupHeader: AnonBackgroundBorderFill = null,
    header: js.Object = null,
    icons: AnonAscending = null,
    primary: AnonWeight = null,
    resize: AnonBorderAnonColorSideColorType = null
  ): AnonGroupEnd = {
