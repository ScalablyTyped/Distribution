...
object Global {
  ...
  extension [Self <: Global](x: Self) {
    ...
    inline def setGlobal(value: `5`): Self = StObject.set(x, "global", value.asInstanceOf[js.Any])
    ...
    inline def setToast(value: `5`): Self = StObject.set(x, "toast", value.asInstanceOf[js.Any])
