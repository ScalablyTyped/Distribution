...
object Active {
  ...
  extension [Self <: Active](x: Self) {
    ...
    inline def setActive(value: `3`): Self = StObject.set(x, "active", value.asInstanceOf[js.Any])
    ...
    inline def setDisabled(value: `3`): Self = StObject.set(x, "disabled", value.asInstanceOf[js.Any])
