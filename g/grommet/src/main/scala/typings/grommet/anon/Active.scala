...
trait Active extends StObject {
  ...
  var colors: js.UndefOr[typings.grommet.themesBaseMod.Colors] = js.undefined
...
object Active {
  ...
  extension [Self <: Active](x: Self) {
    ...
    inline def setActive(value: BackgroundColor): Self = StObject.set(x, "active", value.asInstanceOf[js.Any])
    ...
    inline def setBreakpoints(value: Dictx): Self = StObject.set(x, "breakpoints", value.asInstanceOf[js.Any])
    
    inline def setBreakpointsUndefined: Self = StObject.set(x, "breakpoints", js.undefined)
    
    inline def setColors(value: typings.grommet.themesBaseMod.Colors): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
    
    inline def setColorsUndefined: Self = StObject.set(x, "colors", js.undefined)
    
    inline def setControl(value: BorderDisabled): Self = StObject.set(x, "control", value.asInstanceOf[js.Any])
    ...
    inline def setDeviceBreakpoints(value: Computer): Self = StObject.set(x, "deviceBreakpoints", value.asInstanceOf[js.Any])
    ...
    inline def setEdgeSize(value: Hair): Self = StObject.set(x, "edgeSize", value.asInstanceOf[js.Any])
    
    inline def setEdgeSizeUndefined: Self = StObject.set(x, "edgeSize", js.undefined)
    
    inline def setElevation(value: DarkLight): Self = StObject.set(x, "elevation", value.asInstanceOf[js.Any])
    
    inline def setElevationUndefined: Self = StObject.set(x, "elevation", js.undefined)
    
    inline def setFocus(value: Outline): Self = StObject.set(x, "focus", value.asInstanceOf[js.Any])
    ...
    inline def setGraph(value: Colors): Self = StObject.set(x, "graph", value.asInstanceOf[js.Any])
    ...
    inline def setOpacity(value: Strong): Self = StObject.set(x, "opacity", value.asInstanceOf[js.Any])
    ...
    inline def setSize(value: Full): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
