...
object Animation {
  ...
  extension [Self <: Animation](x: Self) {
    ...
    inline def setColors(value: typings.grommet.baseMod.Colors): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
    ...
    inline def setHover(value: BackgroundColor): Self = StObject.set(x, "hover", value.asInstanceOf[js.Any])
    
    inline def setHoverUndefined: Self = StObject.set(x, "hover", js.undefined)
    
    inline def setInput(value: Padding): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
    ...
    inline def setSelected(value: BackgroundColor): Self = StObject.set(x, "selected", value.asInstanceOf[js.Any])
