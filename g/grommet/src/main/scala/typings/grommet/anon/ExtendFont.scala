...
trait ExtendFont extends StObject {
  ...
  var level: js.UndefOr[`34`] = js.undefined
...
object ExtendFont {
  ...
  extension [Self <: ExtendFont](x: Self) {
    ...
    inline def setLevel(value: `34`): Self = StObject.set(x, "level", value.asInstanceOf[js.Any])
