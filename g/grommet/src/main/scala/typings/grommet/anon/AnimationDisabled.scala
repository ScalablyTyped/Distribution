...
trait AnimationDisabled extends js.Object {
  var animation: js.UndefOr[`19`] = js.native
  var disabled: js.UndefOr[`20`] = js.native
...
object AnimationDisabled {
  ...
  implicit class AnimationDisabledOps[Self <: AnimationDisabled] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: `19`): Self = this.set("animation", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAnimation: Self = this.set("animation", js.undefined)
    @scala.inline
    def setDisabled(value: `20`): Self = this.set("disabled", value.asInstanceOf[js.Any])
    @scala.inline
