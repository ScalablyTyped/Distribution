...
trait Upper extends StObject {
  ...
  var lower: js.UndefOr[`3`] = js.undefined
  
  var opacity: js.UndefOr[OpacityType] = js.undefined
  
  var upper: js.UndefOr[`3`] = js.undefined
}
object Upper {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Upper] (val x: Self) extends AnyVal {
    ...
    inline def setLower(value: `3`): Self = StObject.set(x, "lower", value.asInstanceOf[js.Any])
    ...
    inline def setUpper(value: `3`): Self = StObject.set(x, "upper", value.asInstanceOf[js.Any])
