...
trait BorderCheck extends StObject {
  
  var border: js.UndefOr[ColorWidth] = js.undefined
  
  var check: js.UndefOr[BackgroundColorExtend] = js.undefined
...
object BorderCheck {
  ...
  inline def apply(): BorderCheck = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BorderCheck]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BorderCheck] (val x: Self) extends AnyVal {
    
    inline def setBorder(value: ColorWidth): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    
    inline def setBorderUndefined: Self = StObject.set(x, "border", js.undefined)
    
    inline def setCheck(value: BackgroundColorExtend): Self = StObject.set(x, "check", value.asInstanceOf[js.Any])
