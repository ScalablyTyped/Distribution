...
trait grommetProps {
  ...
  type InfiniteScrollProps = typings.grommet.infiniteScrollMod.InfiniteScrollProps
  @scala.inline
  ...
  @scala.inline
  def SkipLinkProps: typings.grommet.skipLinkMod.SkipLinkProps.type = typings.grommet.skipLinkMod.SkipLinkProps
  type SkipLinkProps = typings.grommet.skipLinkMod.SkipLinkProps
  @scala.inline
  def SkipLinkTargetProps: typings.grommet.skipLinkTargetMod.SkipLinkTargetProps.type = typings.grommet.skipLinkTargetMod.SkipLinkTargetProps
  type SkipLinkTargetProps = typings.grommet.skipLinkTargetMod.SkipLinkTargetProps
  @scala.inline
  def SkipLinksProps: typings.grommet.skipLinksMod.SkipLinksProps.type = typings.grommet.skipLinksMod.SkipLinksProps
  type SkipLinksProps = typings.grommet.skipLinksMod.SkipLinksProps
}
