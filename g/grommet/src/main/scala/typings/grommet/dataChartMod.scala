...
object dataChartMod {
  ...
  object DataChartProps {
    ...
    extension [Self <: DataChartProps](x: Self) {
      ...
      inline def setBounds(value: align): Self = StObject.set(x, "bounds", value.asInstanceOf[js.Any])
      ...
      inline def setChartVarargs(value: ChartType*): Self = StObject.set(x, "chart", js.Array(value :_*))
      ...
      inline def setGuide(value: Boolean | Y): Self = StObject.set(x, "guide", value.asInstanceOf[js.Any])
      ...
      inline def setSeriesVarargs(value: SeriesType*): Self = StObject.set(x, "series", js.Array(value :_*))
