...
object pageHeaderMod {
  ...
  - typings.grommet.pageHeaderMod.PageHeaderProps because var conflicts: a11yTitle, alignSelf, gridArea, margin, responsive. Inlined actions, gridProps, parent, size, subtitle, title */ trait PageHeaderExtendedProps
    extends StObject
       with BoxProps {
