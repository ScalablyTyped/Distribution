...
object calendarMod {
  ...
  object CalendarProps {
    ...
    extension [Self <: CalendarProps](x: Self) {
      ...
      inline def setBoundsVarargs(value: String*): Self = StObject.set(x, "bounds", js.Array(value :_*))
      ...
      inline def setDatesVarargs(value: (String | js.Array[String])*): Self = StObject.set(x, "dates", js.Array(value :_*))
      ...
      inline def setDisabledVarargs(value: (String | js.Array[String])*): Self = StObject.set(x, "disabled", js.Array(value :_*))
      ...
      inline def setHeader(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "header", js.Any.fromFunction1(value))
      ...
      inline def setOnSelect(value: /* select */ String | js.Array[String] => js.Any): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
      ...
      inline def setShowAdjacentDays(value: Boolean): Self = StObject.set(x, "showAdjacentDays", value.asInstanceOf[js.Any])
