...
object base extends js.Object {
  ...
  val avatar: js.UndefOr[typings.grommet.anon.Text | DeepReadonly[js.UndefOr[typings.grommet.anon.Text]]] = js.native
  ...
  val calendar: js.UndefOr[
    typings.grommet.anon.Heading | DeepReadonly[js.UndefOr[typings.grommet.anon.Heading]]
  ] = js.native
