...
trait AnonArgsExpand extends js.Object {
  var expand: js.Array[String]
  var property: String
  def onExpand(args: js.Any*): js.Any
}

object AnonArgsExpand {
  @scala.inline
  def apply(expand: js.Array[String], onExpand: /* repeated */ js.Any => js.Any, property: String): AnonArgsExpand = {
    ...
    __obj.asInstanceOf[AnonArgsExpand]
  }
}
