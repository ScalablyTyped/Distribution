...
import typings.gapiDotClientDotStreetviewpublish.Anon_AccesstokenAlt
import typings.gapiDotClientDotStreetviewpublish.Anon_AccesstokenAltBearertoken
import typings.gapiDotClientDotStreetviewpublish.Anon_AccesstokenAltBearertokenCallback
...
trait PhotoResource extends js.Object {
  /**
    ...
    * storage limit.
    */
  def create(request: Anon_Accesstoken): Request[Photo]
  /**
  ...
  /**
    ...
    */
  def get(request: Anon_AccesstokenAltBearertoken): Request[Photo]
  /**
    ...
    */
  def startUpload(request: Anon_Accesstoken): Request[UploadRef]
  /**
    ...
    */
  def update(request: Anon_AccesstokenAltBearertokenCallback): Request[Photo]
}

object PhotoResource {
  @scala.inline
  def apply(
    create: Anon_Accesstoken => Request[Photo],
    delete: Anon_AccesstokenAlt => Request[js.Object],
    get: Anon_AccesstokenAltBearertoken => Request[Photo],
    startUpload: Anon_Accesstoken => Request[UploadRef],
    update: Anon_AccesstokenAltBearertokenCallback => Request[Photo]
  ): PhotoResource = {
