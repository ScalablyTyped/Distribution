...
trait AnonComponentContext[TContext] extends js.Object {
...
object AnonComponentContext {
  @scala.inline
  def apply[TContext](component: String, context: TContext, path: String, matchPath: String = null): AnonComponentContext[TContext] = {
    ...
    __obj.asInstanceOf[AnonComponentContext[TContext]]
  }
}
