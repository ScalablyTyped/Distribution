...
import typings.gatsby.mod.GatsbyCache
...
trait CreatePagesArgstraceIdiniDictkey
  ...
  /**
    ...
    */
  def getNode(id: String): typings.gatsby.mod.Node = js.native
  /**
    ...
    * @returns Single node instance.
    */
  def getNodeAndSavePathDependency(id: String, path: String): typings.gatsby.mod.Node = js.native
  /**
    ...
    */
  def getNodes(): js.Array[typings.gatsby.mod.Node] = js.native
  /**
    ...
    */
  def getNodesByType(`type`: String): js.Array[typings.gatsby.mod.Node] = js.native
  ...
  /**
    ...
    * }
    */
  def loadNodeContent(node: typings.gatsby.mod.Node): js.Promise[String] = js.native
}
