...
trait GatsbyNode extends js.Object {
  ...
  var createPages: js.UndefOr[
    js.Function3[
      /* args */ CreatePagesArgs with gatsbyLib.Anon_InitialcreatePages, 
  ...
  var createPagesStatefully: js.UndefOr[
    js.Function3[
      /* args */ CreatePagesArgs with gatsbyLib.Anon_InitialcreatePagesStatefully, 
      /* options */ js.UndefOr[PluginOptions], 
      /* callback */ js.UndefOr[PluginCallback], 
      scala.Unit
    ]
...
object GatsbyNode {
  @scala.inline
  def apply(
    createPages: (/* args */ CreatePagesArgs with gatsbyLib.Anon_InitialcreatePages, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    createPagesStatefully: (/* args */ CreatePagesArgs with gatsbyLib.Anon_InitialcreatePagesStatefully, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    ...
    onCreateBabelConfig: (/* args */ CreateBabelConfigArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    onCreateDevServer: (/* args */ CreateDevServerArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    onCreateNode: (/* args */ CreateNodeArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    onCreatePage: (/* args */ CreatePageArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    onCreateWebpackConfig: (/* args */ CreateWebpackConfigArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    onPostBootstrap: (/* args */ ParentSpanPluginArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    onPostBuild: (/* args */ BuildArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    onPreBootstrap: (/* args */ ParentSpanPluginArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    onPreBuild: (/* args */ BuildArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    onPreExtractQueries: (/* args */ ParentSpanPluginArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    onPreInit: (/* args */ ParentSpanPluginArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
    preprocessSource: (/* args */ PreprocessSourceArgs, /* options */ js.UndefOr[PluginOptions], /* callback */ js.UndefOr[PluginCallback]) => scala.Unit = null,
