...
class GLViewDOM ()
  ...
  def captureAsBlob(callback: js.Function1[/* data */ stdLib.Blob, scala.Unit]): stdLib.Promise[stdLib.Blob] = js.native
  def captureAsBlob(callback: js.Function1[/* data */ stdLib.Blob, scala.Unit], `type`: SupportedImage): stdLib.Promise[stdLib.Blob] = js.native
  def captureAsBlob(
