...
@JSImport("google-gax/build/src/protobuf", "protobufMinimal.Message")
@js.native
/**
...
open class Message[T /* <: js.Object */] ()
  extends typings.protobufjs.minimalMod.Message[T] {
...
object Message {
  ...
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.Message.$type")
  @js.native
