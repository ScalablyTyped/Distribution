...
@JSImport("google-gax/build/protos/locations", "google.protobuf.EnumDescriptorProto")
@js.native
/**
...
object EnumDescriptorProto {
  ...
  @JSImport("google-gax/build/protos/locations", "google.protobuf.EnumDescriptorProto.EnumReservedRange")
  @js.native
  /**
