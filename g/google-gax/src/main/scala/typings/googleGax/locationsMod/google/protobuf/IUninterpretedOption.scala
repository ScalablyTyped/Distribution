...
trait IUninterpretedOption extends StObject {
  ...
  var negativeIntValue: js.UndefOr[
    Double | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Long */ scala.Any) | Null
  ] = js.undefined
...
object IUninterpretedOption {
  ...
  extension [Self <: IUninterpretedOption](x: Self) {
    ...
    inline def setNegativeIntValue(
      value: Double | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Long */ scala.Any)
