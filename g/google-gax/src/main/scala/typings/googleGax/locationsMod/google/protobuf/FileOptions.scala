...
import typings.googleGax.locationsMod.google.protobuf.FileOptions.OptimizeMode
...
@JSImport("google-gax/build/protos/locations", "google.protobuf.FileOptions")
@js.native
/**
...
object FileOptions {
  ...
  /** OptimizeMode enum. */
  @JSImport("google-gax/build/protos/locations", "google.protobuf.FileOptions.OptimizeMode")
  @js.native
  object OptimizeMode extends StObject {
    ...
    sealed trait CODE_SIZE
      extends StObject
         with OptimizeMode
    /* 2 */ val CODE_SIZE: typings.googleGax.locationsMod.google.protobuf.FileOptions.OptimizeMode.CODE_SIZE & Double = js.native
    
    @js.native
    sealed trait LITE_RUNTIME
      extends StObject
         with OptimizeMode
    /* 3 */ val LITE_RUNTIME: typings.googleGax.locationsMod.google.protobuf.FileOptions.OptimizeMode.LITE_RUNTIME & Double = js.native
    
    @js.native
    sealed trait SPEED
      extends StObject
         with OptimizeMode
    /* 1 */ val SPEED: typings.googleGax.locationsMod.google.protobuf.FileOptions.OptimizeMode.SPEED & Double = js.native
  }
