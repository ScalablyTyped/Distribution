...
object buildSrcLongRunningCallsLongrunningMod {
  ...
  open class Operation_ protected () extends EventEmitter {
    ...
    /**
      ...
      * request.
      */
    def cancel(): js.Promise[
        /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify operationProtos.google.protobuf.Empty */ Any
      ] = js.native
  ...
  type LROOperation = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify operationProtos.google.longrunning.Operation */ Any
}
