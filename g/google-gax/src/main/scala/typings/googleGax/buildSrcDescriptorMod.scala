...
import typings.googleGax.buildSrcLongRunningCallsLongRunningDescriptorMod.AnyDecoder
...
object buildSrcDescriptorMod {
  ...
  open class BundleDescriptor protected ()
    extends typings.googleGax.buildSrcBundlingCallsBundleDescriptorMod.BundleDescriptor {
    /**
  ...
  open class PageDescriptor protected ()
    extends typings.googleGax.buildSrcPaginationCallsPageDescriptorMod.PageDescriptor {
  ...
  open class StreamDescriptor protected ()
    extends typings.googleGax.buildSrcStreamingCallsStreamDescriptorMod.StreamDescriptor {
