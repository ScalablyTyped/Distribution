...
object httpMod {
  ...
  object google {
    ...
    object api {
      ...
      @JSImport("google-gax/build/protos/http", "google.api.CustomHttpPattern")
      @js.native
      /**
      ...
      /** Represents a Http. */
      @JSImport("google-gax/build/protos/http", "google.api.Http")
      @js.native
      /**
      ...
      open class Http ()
        ...
        @JSName("fully_decode_reserved_expansion")
        var fully_decode_reserved_expansion_Http: Boolean = js.native
      ...
      @JSImport("google-gax/build/protos/http", "google.api.HttpRule")
      @js.native
      /**
      ...
      open class HttpRule ()
        ...
        @JSName("additional_bindings")
        var additional_bindings_HttpRule: js.Array[IHttpRule] = js.native
        ...
        @JSName("response_body")
        var response_body_HttpRule: String = js.native
      ...
      trait IHttp extends StObject {
        ...
        /** Http fully_decode_reserved_expansion */
        var fully_decode_reserved_expansion: js.UndefOr[Boolean | Null] = js.undefined
      ...
      object IHttp {
        ...
        extension [Self <: IHttp](x: Self) {
          ...
          inline def setFully_decode_reserved_expansion(value: Boolean): Self = StObject.set(x, "fully_decode_reserved_expansion", value.asInstanceOf[js.Any])
          
          inline def setFully_decode_reserved_expansionNull: Self = StObject.set(x, "fully_decode_reserved_expansion", null)
          
          inline def setFully_decode_reserved_expansionUndefined: Self = StObject.set(x, "fully_decode_reserved_expansion", js.undefined)
      ...
      trait IHttpRule extends StObject {
        ...
        /** HttpRule additional_bindings */
        var additional_bindings: js.UndefOr[js.Array[IHttpRule] | Null] = js.undefined
        ...
        /** HttpRule response_body */
        var response_body: js.UndefOr[String | Null] = js.undefined
      ...
      object IHttpRule {
        ...
        extension [Self <: IHttpRule](x: Self) {
          ...
          inline def setAdditional_bindings(value: js.Array[IHttpRule]): Self = StObject.set(x, "additional_bindings", value.asInstanceOf[js.Any])
          
          inline def setAdditional_bindingsNull: Self = StObject.set(x, "additional_bindings", null)
          
          inline def setAdditional_bindingsUndefined: Self = StObject.set(x, "additional_bindings", js.undefined)
          
          inline def setAdditional_bindingsVarargs(value: IHttpRule*): Self = StObject.set(x, "additional_bindings", js.Array(value*))
          ...
          inline def setResponse_bodyNull: Self = StObject.set(x, "response_body", null)
