...
object anon {
  ...
  /* Inlined {[httpOptionName] : google-gax.google-gax/build/protos/http.google.api.IHttpRule | undefined} & {[ option in google-gax.google-gax/build/src/transcoding.allowedOptions ]:? {} | string | number} */
  @js.native
  trait httpOptionNameIHttpRuleun extends StObject {
