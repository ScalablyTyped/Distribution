package typings.googleGax.operationsMod.google.protobuf.FieldDescriptorProto
...
/** Type enum. */
@JSImport("google-gax/build/protos/operations", "google.protobuf.FieldDescriptorProto.Type")
@js.native
