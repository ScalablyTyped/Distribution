...
@JSImport("google-gax/build/src/fallback", "operationsProtos.google.protobuf.EnumDescriptorProto")
@js.native
/**
...
object EnumDescriptorProto {
  ...
  @JSImport("google-gax/build/src/fallback", "operationsProtos.google.protobuf.EnumDescriptorProto.EnumReservedRange")
  @js.native
  /**
