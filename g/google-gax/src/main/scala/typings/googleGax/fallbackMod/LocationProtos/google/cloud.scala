...
object cloud {
  ...
  object location {
    ...
    @JSImport("google-gax/build/src/fallback", "LocationProtos.google.cloud.location.GetLocationRequest")
    @js.native
    /**
    ...
    @JSImport("google-gax/build/src/fallback", "LocationProtos.google.cloud.location.ListLocationsRequest")
    @js.native
    /**
    ...
    @JSImport("google-gax/build/src/fallback", "LocationProtos.google.cloud.location.ListLocationsResponse")
    @js.native
    /**
    ...
    @JSImport("google-gax/build/src/fallback", "LocationProtos.google.cloud.location.Location")
    @js.native
    /**
    ...
    @JSImport("google-gax/build/src/fallback", "LocationProtos.google.cloud.location.Locations")
    @js.native
