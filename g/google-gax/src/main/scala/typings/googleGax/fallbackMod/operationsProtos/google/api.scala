...
object api {
  ...
  @JSImport("google-gax/build/src/fallback", "operationsProtos.google.api.CustomHttpPattern")
  @js.native
  /**
  ...
  /** Represents a Http. */
  @JSImport("google-gax/build/src/fallback", "operationsProtos.google.api.Http")
  @js.native
  /**
  ...
  @JSImport("google-gax/build/src/fallback", "operationsProtos.google.api.HttpRule")
  @js.native
  /**
