...
inline def fallback: js.Any = typings.googleGax.fallbackMod.^.asInstanceOf[js.Dynamic].selectDynamic("fallback").asInstanceOf[js.Any]

inline def lro(options: typings.googleGax.grpcMod.GrpcClientOptions): typings.googleGax.operationsClientMod.OperationsClientBuilder = typings.googleGax.fallbackMod.^.asInstanceOf[js.Dynamic].applyDynamic("lro")(options.asInstanceOf[js.Any]).asInstanceOf[typings.googleGax.operationsClientMod.OperationsClientBuilder]

inline def version: java.lang.String = typings.googleGax.fallbackMod.^.asInstanceOf[js.Dynamic].selectDynamic("version").asInstanceOf[java.lang.String]
