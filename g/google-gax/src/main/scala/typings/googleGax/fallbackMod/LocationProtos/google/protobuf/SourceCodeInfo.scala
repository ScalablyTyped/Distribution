...
@JSImport("google-gax/build/src/fallback", "LocationProtos.google.protobuf.SourceCodeInfo")
@js.native
/**
...
object SourceCodeInfo {
  ...
  @JSImport("google-gax/build/src/fallback", "LocationProtos.google.protobuf.SourceCodeInfo.Location")
  @js.native
  /**
