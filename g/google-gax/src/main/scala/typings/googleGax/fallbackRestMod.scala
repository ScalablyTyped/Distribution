...
object fallbackRestMod {
  
  @JSImport("google-gax/build/src/fallbackRest", JSImport.Namespace)
  @js.native
  ...
  ): FetchParameters = (^.asInstanceOf[js.Dynamic].applyDynamic("encodeRequest")(rpc.asInstanceOf[js.Any], protocol.asInstanceOf[js.Any], servicePath.asInstanceOf[js.Any], servicePort.asInstanceOf[js.Any], request.asInstanceOf[js.Any], numericEnums.asInstanceOf[js.Any])).asInstanceOf[FetchParameters]
}
