...
package object fallback {
  ...
  @scala.inline
  def fallback: js.Any = typings.googleGax.mod.fallback.^.asInstanceOf[js.Dynamic].selectDynamic("fallback").asInstanceOf[js.Any]
  
  @scala.inline
  def lro(options: typings.googleGax.grpcMod.GrpcClientOptions): typings.googleGax.operationsClientMod.OperationsClientBuilder = typings.googleGax.mod.fallback.^.asInstanceOf[js.Dynamic].applyDynamic("lro")(options.asInstanceOf[js.Any]).asInstanceOf[typings.googleGax.operationsClientMod.OperationsClientBuilder]
  
  @scala.inline
  def version: java.lang.String = typings.googleGax.mod.fallback.^.asInstanceOf[js.Dynamic].selectDynamic("version").asInstanceOf[java.lang.String]
}
