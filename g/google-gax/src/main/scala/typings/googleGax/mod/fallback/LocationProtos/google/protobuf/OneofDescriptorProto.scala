...
@JSImport("google-gax", "fallback.LocationProtos.google.protobuf.OneofDescriptorProto")
@js.native
/**
...
open class OneofDescriptorProto ()
  extends typings.googleGax.fallbackMod.LocationProtos.google.protobuf.OneofDescriptorProto {
