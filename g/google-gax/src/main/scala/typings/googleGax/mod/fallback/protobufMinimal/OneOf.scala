...
@JSImport("google-gax", "fallback.protobufMinimal.OneOf")
@js.native
class OneOf protected ()
  extends typings.googleGax.fallbackMod.protobufMinimal.OneOf {
  /**
...
object OneOf {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.OneOf.d")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.OneOf.fromJSON")
  @js.native
