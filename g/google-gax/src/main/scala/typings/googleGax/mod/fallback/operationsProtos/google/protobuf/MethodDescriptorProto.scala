...
@JSImport("google-gax", "fallback.operationsProtos.google.protobuf.MethodDescriptorProto")
@js.native
/**
...
open class MethodDescriptorProto ()
  extends typings.googleGax.fallbackMod.operationsProtos.google.protobuf.MethodDescriptorProto {
