...
inline def createBundleOptions(options: typings.googleGax.gaxMod.BundlingConfig): typings.googleGax.bundleExecutorMod.BundleOptions = typings.googleGax.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createBundleOptions")(options.asInstanceOf[js.Any]).asInstanceOf[typings.googleGax.bundleExecutorMod.BundleOptions]
...
inline def createDefaultBackoffSettings(): typings.googleGax.gaxMod.BackoffSettings = typings.googleGax.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createDefaultBackoffSettings")().asInstanceOf[typings.googleGax.gaxMod.BackoffSettings]
...
inline def version: js.Any = typings.googleGax.mod.^.asInstanceOf[js.Dynamic].selectDynamic("version").asInstanceOf[js.Any]
