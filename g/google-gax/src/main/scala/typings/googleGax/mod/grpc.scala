...
object grpc {
  ...
  object experimental {
    ...
    open class BackoffTimeout protected ()
      extends typings.grpcGrpcJs.mod.experimental.BackoffTimeout {
    ...
    open class ChildLoadBalancerHandler protected ()
      extends typings.grpcGrpcJs.mod.experimental.ChildLoadBalancerHandler {
    ...
    open class FilterStackFactory protected ()
      extends typings.grpcGrpcJs.mod.experimental.FilterStackFactory {
    ...
    open class OutlierDetectionLoadBalancingConfig protected ()
      extends typings.grpcGrpcJs.mod.experimental.OutlierDetectionLoadBalancingConfig {
      def this(
    ...
    open class QueuePicker protected ()
      extends typings.grpcGrpcJs.mod.experimental.QueuePicker {
    ...
    open class UnavailablePicker ()
      extends typings.grpcGrpcJs.mod.experimental.UnavailablePicker {
