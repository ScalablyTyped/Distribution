package typings.googleGax.mod.fallback.operationsProtos.google
...
object api {
  ...
  @JSImport("google-gax", "fallback.operationsProtos.google.api.CustomHttpPattern")
  @js.native
  /**
  ...
  open class CustomHttpPattern ()
    extends typings.googleGax.fallbackMod.operationsProtos.google.api.CustomHttpPattern {
  ...
  /** Represents a Http. */
  @JSImport("google-gax", "fallback.operationsProtos.google.api.Http")
  @js.native
  /**
    ...
    */
  open class Http ()
    extends typings.googleGax.fallbackMod.operationsProtos.google.api.Http {
  ...
  @JSImport("google-gax", "fallback.operationsProtos.google.api.HttpRule")
  @js.native
  /**
    ...
    */
  open class HttpRule ()
    extends typings.googleGax.fallbackMod.operationsProtos.google.api.HttpRule {
