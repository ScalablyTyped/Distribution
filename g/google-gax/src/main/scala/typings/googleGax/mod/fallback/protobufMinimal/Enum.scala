...
@JSImport("google-gax", "fallback.protobufMinimal.Enum")
@js.native
class Enum protected ()
  extends typings.googleGax.fallbackMod.protobufMinimal.Enum {
  /**
...
object Enum {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Enum.fromJSON")
  @js.native
