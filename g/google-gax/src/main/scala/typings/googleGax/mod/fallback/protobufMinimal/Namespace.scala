...
class Namespace protected ()
  extends typings.googleGax.fallbackMod.protobufMinimal.Namespace {
  /**
...
object Namespace {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Namespace.arrayToJSON")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Namespace.fromJSON")
  @js.native
  def fromJSON(name: String, json: StringDictionary[js.Any]): typings.protobufjs.mod.Namespace = js.native
  
  @JSImport("google-gax", "fallback.protobufMinimal.Namespace.isReservedId")
  @js.native
  ...
  @JSImport("google-gax", "fallback.protobufMinimal.Namespace.isReservedName")
  @js.native
