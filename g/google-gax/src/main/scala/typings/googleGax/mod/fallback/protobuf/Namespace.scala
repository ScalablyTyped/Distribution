...
object Namespace {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobuf.Namespace.arrayToJSON")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobuf.Namespace.fromJSON")
  @js.native
  def fromJSON(name: String, json: StringDictionary[js.Any]): typings.protobufjs.mod.Namespace = js.native
  
  @JSImport("google-gax", "fallback.protobuf.Namespace.isReservedId")
  @js.native
  ...
  @JSImport("google-gax", "fallback.protobuf.Namespace.isReservedName")
  @js.native
