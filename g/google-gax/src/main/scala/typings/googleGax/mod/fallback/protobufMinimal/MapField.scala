...
@JSImport("google-gax", "fallback.protobufMinimal.MapField")
@js.native
class MapField protected ()
  extends typings.googleGax.fallbackMod.protobufMinimal.MapField {
  /**
...
object MapField {
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.MapField.d")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.MapField.fromJSON")
  @js.native
