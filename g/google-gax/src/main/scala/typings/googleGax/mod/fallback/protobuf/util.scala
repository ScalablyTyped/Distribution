...
object util {
  ...
  class Array protected ()
    extends typings.googleGax.fallbackMod.protobuf.util.Array {
  ...
  class Buffer protected ()
    extends typings.googleGax.fallbackMod.protobuf.util.Buffer {
    def this(params: js.Any*) = this()
  }
  ...
  class EventEmitter ()
    extends typings.googleGax.fallbackMod.protobuf.util.EventEmitter
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("google-gax", "fallback.protobuf.util.Long")
  @js.native
  class Long protected ()
    extends typings.googleGax.fallbackMod.protobuf.util.Long {
    def this(params: js.Any*) = this()
  }
  ...
  class LongBits protected ()
    extends typings.googleGax.fallbackMod.protobuf.util.LongBits {
    /**
