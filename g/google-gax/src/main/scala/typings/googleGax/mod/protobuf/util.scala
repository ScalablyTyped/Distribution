...
object util {
  ...
  @JSImport("google-gax", "protobuf.util")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("google-gax", "protobuf.util.Buffer")
  @js.native
  class Buffer protected ()
    extends typings.protobufjs.mod.util.Buffer {
    def this(params: js.Any*) = this()
  }
  ...
  @JSImport("google-gax", "protobuf.util.EventEmitter")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("google-gax", "protobuf.util.Long")
  @js.native
  class Long protected ()
    extends typings.protobufjs.mod.util.Long {
    def this(params: js.Any*) = this()
  }
  ...
  object LongBits {
    ...
    @JSImport("google-gax", "protobuf.util.LongBits.from")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("google-gax", "protobuf.util.LongBits.fromHash")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("google-gax", "protobuf.util.LongBits.fromNumber")
    @js.native
    def fromNumber(value: Double): typings.protobufjs.mod.util.LongBits = js.native
    
    /** Zero bits. */
    /* static member */
    @JSImport("google-gax", "protobuf.util.LongBits.zero")
    @js.native
    def zero: typings.protobufjs.mod.util.LongBits = js.native
    
    /** Zero hash. */
    /* static member */
    @JSImport("google-gax", "protobuf.util.LongBits.zeroHash")
    @js.native
  ...
  object base64 {
    ...
    /**
      ...
      */
    @JSImport("google-gax", "protobuf.util.base64.decode")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "protobuf.util.base64.encode")
    @js.native
    ...
    /**
      ...
      * @returns Byte length
      */
    @JSImport("google-gax", "protobuf.util.base64.length")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "protobuf.util.base64.test")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.camelCase")
  @js.native
  ...
  object codegen {
    ...
    /**
      ...
      */
    @JSImport("google-gax", "protobuf.util.codegen")
    @js.native
    ...
    @JSImport("google-gax", "protobuf.util.codegen.verbose")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.compareFieldsById")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.decorateEnum")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.decorateType")
  @js.native
  ...
  @JSImport("google-gax", "protobuf.util.emptyArray")
  @js.native
  val emptyArray: js.Array[js.Any] = js.native
  
  /** An immutable empty object. */
  @JSImport("google-gax", "protobuf.util.emptyObject")
  @js.native
  ...
  object float {
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax", "protobuf.util.float.readDoubleBE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax", "protobuf.util.float.readDoubleLE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax", "protobuf.util.float.readFloatBE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax", "protobuf.util.float.readFloatLE")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "protobuf.util.float.writeDoubleBE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("google-gax", "protobuf.util.float.writeDoubleLE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("google-gax", "protobuf.util.float.writeFloatBE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("google-gax", "protobuf.util.float.writeFloatLE")
    @js.native
    def writeFloatLE(`val`: Double, buf: Uint8Array, pos: Double): Unit = js.native
  }
  
  /** Global object reference. */
  @JSImport("google-gax", "protobuf.util.global")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.inquire")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.isInteger")
  @js.native
  def isInteger(value: js.Any): Boolean = js.native
  
  /** Whether running within node or not. */
  @JSImport("google-gax", "protobuf.util.isNode")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.isObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.isReserved")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.isSet")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.isString")
  @js.native
  ...
  @JSImport("google-gax", "protobuf.util.key2Re")
  @js.native
  val key2Re: RegExp = js.native
  
  /** Regular expression used to verify 32 bit (`int32` etc.) map keys. */
  @JSImport("google-gax", "protobuf.util.key32Re")
  @js.native
  val key32Re: RegExp = js.native
  
  /** Regular expression used to verify 64 bit (`int64` etc.) map keys. */
  @JSImport("google-gax", "protobuf.util.key64Re")
  @js.native
  ...
  /**
    ...
    * @returns Converted string
    */
  @JSImport("google-gax", "protobuf.util.lcFirst")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.longFromHash")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.merge")
  @js.native
  ...
  /**
    ...
    * @returns Buffer
    */
  @JSImport("google-gax", "protobuf.util.newBuffer")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.newError")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.oneOfGetter")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.oneOfSetter")
  @js.native
  ...
  object path {
    ...
    /**
      ...
      */
    @JSImport("google-gax", "protobuf.util.path.isAbsolute")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "protobuf.util.path.normalize")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "protobuf.util.path.resolve")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.safeProp")
  @js.native
  ...
  /**
    ...
    * @returns Destination object
    */
  @JSImport("google-gax", "protobuf.util.setProperty")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.toArray")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "protobuf.util.toObject")
  @js.native
  ...
  /**
    ...
    * @returns Converted string
    */
  @JSImport("google-gax", "protobuf.util.ucFirst")
  @js.native
  ...
  object utf8 {
    ...
    /**
      ...
      * @returns Byte length
      */
    @JSImport("google-gax", "protobuf.util.utf8.length")
    @js.native
    def length(string: String): Double = js.native
    ...
    /**
      ...
      * @returns String read
      */
    @JSImport("google-gax", "protobuf.util.utf8.read")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "protobuf.util.utf8.write")
    @js.native
