...
@JSImport("google-gax", "fallback.IamProtos.google.protobuf.ServiceDescriptorProto")
@js.native
/**
...
open class ServiceDescriptorProto ()
  extends typings.googleGax.fallbackMod.IamProtos.google.protobuf.ServiceDescriptorProto {
