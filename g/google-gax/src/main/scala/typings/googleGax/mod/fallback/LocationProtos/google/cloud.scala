package typings.googleGax.mod.fallback.LocationProtos.google
...
object cloud {
  ...
  object location {
    ...
    @JSImport("google-gax", "fallback.LocationProtos.google.cloud.location.GetLocationRequest")
    @js.native
    /**
    ...
    open class GetLocationRequest ()
      extends typings.googleGax.fallbackMod.LocationProtos.google.cloud.location.GetLocationRequest {
    ...
    @JSImport("google-gax", "fallback.LocationProtos.google.cloud.location.ListLocationsRequest")
    @js.native
    /**
    ...
    open class ListLocationsRequest ()
      extends typings.googleGax.fallbackMod.LocationProtos.google.cloud.location.ListLocationsRequest {
    ...
    @JSImport("google-gax", "fallback.LocationProtos.google.cloud.location.ListLocationsResponse")
    @js.native
    /**
    ...
    open class ListLocationsResponse ()
      extends typings.googleGax.fallbackMod.LocationProtos.google.cloud.location.ListLocationsResponse {
    ...
    @JSImport("google-gax", "fallback.LocationProtos.google.cloud.location.Location")
    @js.native
    /**
      ...
      */
    open class Location ()
      extends typings.googleGax.fallbackMod.LocationProtos.google.cloud.location.Location {
    ...
    @JSImport("google-gax", "fallback.LocationProtos.google.cloud.location.Locations")
    @js.native
    open class Locations protected ()
      extends typings.googleGax.fallbackMod.LocationProtos.google.cloud.location.Locations {
      /**
