...
@JSImport("google-gax", "fallback.operationsProtos.google.protobuf.ServiceOptions")
@js.native
/**
...
open class ServiceOptions ()
  extends typings.googleGax.fallbackMod.operationsProtos.google.protobuf.ServiceOptions {
