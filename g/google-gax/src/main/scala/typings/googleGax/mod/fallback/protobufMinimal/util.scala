...
object util {
  ...
  object base64 {
    ...
    @JSImport("google-gax", "fallback.protobufMinimal.util.base64")
    @js.native
    val ^ : js.Any = js.native
  ...
  object float {
    ...
    @JSImport("google-gax", "fallback.protobufMinimal.util.float")
    @js.native
    val ^ : js.Any = js.native
  ...
  object path {
    ...
    @JSImport("google-gax", "fallback.protobufMinimal.util.path")
    @js.native
    val ^ : js.Any = js.native
  ...
  object utf8 {
    ...
    @JSImport("google-gax", "fallback.protobufMinimal.util.utf8")
    @js.native
    val ^ : js.Any = js.native
