...
object util {
  ...
  @JSImport("google-gax", "fallback.protobufMinimal.util")
  @js.native
  val ^ : js.Any = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("google-gax", "fallback.protobufMinimal.util.Array")
  @js.native
  class Array protected ()
    extends typings.googleGax.fallbackMod.protobufMinimal.util.Array {
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("google-gax", "fallback.protobufMinimal.util.Buffer")
  @js.native
  class Buffer protected ()
    extends typings.googleGax.fallbackMod.protobufMinimal.util.Buffer {
    def this(params: js.Any*) = this()
  }
  ...
  @JSImport("google-gax", "fallback.protobufMinimal.util.EventEmitter")
  @js.native
  ...
  class Long protected ()
    extends typings.googleGax.fallbackMod.protobufMinimal.util.Long {
    def this(params: js.Any*) = this()
  }
  ...
  object LongBits {
    ...
    @JSImport("google-gax", "fallback.protobufMinimal.util.LongBits.from")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("google-gax", "fallback.protobufMinimal.util.LongBits.fromHash")
    @js.native
    ...
    /**
      ...
      */
    /* static member */
    @JSImport("google-gax", "fallback.protobufMinimal.util.LongBits.fromNumber")
    @js.native
    def fromNumber(value: Double): typings.protobufjs.mod.util.LongBits = js.native
    
    /** Zero bits. */
    /* static member */
    @JSImport("google-gax", "fallback.protobufMinimal.util.LongBits.zero")
    @js.native
    def zero: typings.protobufjs.mod.util.LongBits = js.native
    
    /** Zero hash. */
    /* static member */
    @JSImport("google-gax", "fallback.protobufMinimal.util.LongBits.zeroHash")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.asPromise")
  @js.native
  ...
  object base64 {
    ...
    /**
      ...
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.base64.decode")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.base64.encode")
    @js.native
    ...
    /**
      ...
      * @returns Byte length
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.base64.length")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.base64.test")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.camelCase")
  @js.native
  ...
  object codegen {
    ...
    /**
      ...
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.codegen")
    @js.native
    ...
    @JSImport("google-gax", "fallback.protobufMinimal.util.codegen.verbose")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.compareFieldsById")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.decorateEnum")
  @js.native
  def decorateEnum(`object`: js.Object): typings.protobufjs.mod.Enum = js.native
  
  /** Decorator root (TypeScript). */
  @JSImport("google-gax", "fallback.protobufMinimal.util.decorateRoot")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.decorateType")
  @js.native
  ...
  @JSImport("google-gax", "fallback.protobufMinimal.util.emptyArray")
  @js.native
  val emptyArray: js.Array[js.Any] = js.native
  
  /** An immutable empty object. */
  @JSImport("google-gax", "fallback.protobufMinimal.util.emptyObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.fetch")
  @js.native
  ...
  object float {
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.float.readDoubleBE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.float.readDoubleLE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.float.readFloatBE")
    @js.native
    ...
    /**
      ...
      * @returns Value read
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.float.readFloatLE")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.float.writeDoubleBE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.float.writeDoubleLE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.float.writeFloatBE")
    @js.native
    ...
    /**
      ...
      * @param pos Target buffer offset
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.float.writeFloatLE")
    @js.native
    def writeFloatLE(`val`: Double, buf: Uint8Array, pos: Double): Unit = js.native
  }
  
  /** Global object reference. */
  @JSImport("google-gax", "fallback.protobufMinimal.util.global")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.inquire")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.isInteger")
  @js.native
  def isInteger(value: js.Any): Boolean = js.native
  
  /** Whether running within node or not. */
  @JSImport("google-gax", "fallback.protobufMinimal.util.isNode")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.isObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.isReserved")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.isSet")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.isString")
  @js.native
  ...
  @JSImport("google-gax", "fallback.protobufMinimal.util.key2Re")
  @js.native
  val key2Re: RegExp = js.native
  
  /** Regular expression used to verify 32 bit (`int32` etc.) map keys. */
  @JSImport("google-gax", "fallback.protobufMinimal.util.key32Re")
  @js.native
  val key32Re: RegExp = js.native
  
  /** Regular expression used to verify 64 bit (`int64` etc.) map keys. */
  @JSImport("google-gax", "fallback.protobufMinimal.util.key64Re")
  @js.native
  ...
  /**
    ...
    * @returns Converted string
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.lcFirst")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.longFromHash")
  @js.native
  ...
  @JSImport("google-gax", "fallback.protobufMinimal.util.longToHash")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.merge")
  @js.native
  ...
  /**
    ...
    * @returns Buffer
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.newBuffer")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.newError")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.oneOfGetter")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.oneOfSetter")
  @js.native
  ...
  object path {
    ...
    /**
      ...
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.path.isAbsolute")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.path.normalize")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.path.resolve")
    @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.pool")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.safeProp")
  @js.native
  ...
  /**
    ...
    * @returns Destination object
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.setProperty")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.toArray")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.toJSONOptions")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.toObject")
  @js.native
  ...
  /**
    ...
    * @returns Converted string
    */
  @JSImport("google-gax", "fallback.protobufMinimal.util.ucFirst")
  @js.native
  ...
  object utf8 {
    ...
    /**
      ...
      * @returns Byte length
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.utf8.length")
    @js.native
    def length(string: String): Double = js.native
    ...
    /**
      ...
      * @returns String read
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.utf8.read")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("google-gax", "fallback.protobufMinimal.util.utf8.write")
    @js.native
