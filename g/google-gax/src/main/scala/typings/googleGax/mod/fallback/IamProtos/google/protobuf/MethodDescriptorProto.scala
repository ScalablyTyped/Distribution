...
@JSImport("google-gax", "fallback.IamProtos.google.protobuf.MethodDescriptorProto")
@js.native
/**
...
open class MethodDescriptorProto ()
  extends typings.googleGax.fallbackMod.IamProtos.google.protobuf.MethodDescriptorProto {
