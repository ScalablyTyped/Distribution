...
@JSImport("google-gax", "fallback.protobufMinimal.Message")
@js.native
/**
...
class Message[T /* <: js.Object */] ()
  extends typings.googleGax.fallbackMod.protobufMinimal.Message[T] {
...
object Message {
  ...
  @JSImport("google-gax", "fallback.protobufMinimal.Message.$type")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Message.create")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Message.decode")
  @js.native
  ...
  /**
    ...
    * @returns Decoded message
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Message.decodeDelimited")
  @js.native
  ...
  /**
    ...
    * @returns Writer
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Message.encode")
  @js.native
  ...
  /**
    ...
    * @returns Writer
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Message.encodeDelimited")
  @js.native
  ...
  /**
    ...
    * @returns Message instance
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Message.fromObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Message.toObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax", "fallback.protobufMinimal.Message.verify")
  @js.native
