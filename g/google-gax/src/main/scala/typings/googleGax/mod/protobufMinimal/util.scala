...
object util {
  ...
  class Array protected ()
    extends typings.protobufjs.minimalMod.util.Array {
  ...
  class Buffer protected ()
    extends typings.protobufjs.minimalMod.util.Buffer {
    def this(params: js.Any*) = this()
  }
  ...
  class Long protected ()
    extends typings.protobufjs.minimalMod.util.Long {
    def this(params: js.Any*) = this()
  }
  ...
  object base64 {
    ...
    @JSImport("google-gax", "protobufMinimal.util.base64")
    @js.native
    val ^ : js.Any = js.native
  ...
  object float {
    ...
    @JSImport("google-gax", "protobufMinimal.util.float")
    @js.native
    val ^ : js.Any = js.native
  ...
  object path {
    ...
    @JSImport("google-gax", "protobufMinimal.util.path")
    @js.native
    val ^ : js.Any = js.native
  ...
  object utf8 {
    ...
    @JSImport("google-gax", "protobufMinimal.util.utf8")
    @js.native
    val ^ : js.Any = js.native
