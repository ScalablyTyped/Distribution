...
import typings.googleGax.buildSrcBundlingCallsBundleDescriptorMod.BundleDescriptor
import typings.googleGax.buildSrcBundlingCallsTaskMod.Task
import typings.googleGax.buildSrcBundlingCallsTaskMod.TaskCallback
