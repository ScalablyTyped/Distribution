...
import typings.googleDashGax.buildSrcGrpcMod.Metadata
...
@js.native
class Operation protected () extends EventEmitter {
  /**
...
object operation extends js.Object {
  def apply(op: LROOperation, longrunningDescriptor: LongRunningDescriptor, backoffSettings: BackoffSettings): Operation = js.native
  def apply(
    op: LROOperation,
    longrunningDescriptor: LongRunningDescriptor,
    backoffSettings: BackoffSettings,
