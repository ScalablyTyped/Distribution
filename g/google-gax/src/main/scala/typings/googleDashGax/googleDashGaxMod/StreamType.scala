...
@JSImport("google-gax", "StreamType")
@js.native
object StreamType extends js.Object {
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.googleDashGax.buildSrcStreamingCallsStreamingMod.StreamType with Double] = js.native
}
