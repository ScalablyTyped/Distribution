...
import typings.atGrpcProtoDashLoader.atGrpcProtoDashLoaderMod.Options
import typings.googleDashAuthDashLibrary.googleDashAuthDashLibraryMod.GoogleAuth
import typings.googleDashGax.Anon_Encode
...
class GrpcClient () extends js.Object {
  ...
  def metadataBuilder(headers: OutgoingHttpHeaders): js.Function2[
    ...
    typings.atGrpcGrpcDashJs.atGrpcGrpcDashJsMod.Metadata
  ] = js.native
}
