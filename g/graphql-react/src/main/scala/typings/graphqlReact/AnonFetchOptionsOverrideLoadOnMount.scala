...
trait AnonFetchOptionsOverrideLoadOnMount[V] extends js.Object {
...
object AnonFetchOptionsOverrideLoadOnMount {
  @scala.inline
  def apply[V](
  ...
  ): AnonFetchOptionsOverrideLoadOnMount[V] = {
    ...
    __obj.asInstanceOf[AnonFetchOptionsOverrideLoadOnMount[V]]
  }
}
