...
trait Anon_AccesstokenAltBearertokenCallbackFieldsJobId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackFieldsJobId {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackFieldsJobId = {
    val __obj = js.Dynamic.literal(jobId = jobId, projectId = projectId, region = region)
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackFieldsJobId]
  }
}
