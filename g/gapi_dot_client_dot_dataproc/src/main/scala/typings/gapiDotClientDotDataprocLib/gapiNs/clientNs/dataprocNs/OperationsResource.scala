...
trait OperationsResource extends js.Object {
  /**
    ...
    */
  def cancel(request: gapiDotClientDotDataprocLib.Anon_Name): gapiDotClientLib.gapiNs.clientNs.Request[js.Object]
  /**
    ...
    */
  def delete(request: gapiDotClientDotDataprocLib.Anon_Name): gapiDotClientLib.gapiNs.clientNs.Request[js.Object]
  /**
    ...
    * service.
    */
  def get(request: gapiDotClientDotDataprocLib.Anon_Name): gapiDotClientLib.gapiNs.clientNs.Request[Operation]
  /**
    ...
    * id.
    */
  def list(request: gapiDotClientDotDataprocLib.Anon_NameAccesstoken): gapiDotClientLib.gapiNs.clientNs.Request[ListOperationsResponse]
}
