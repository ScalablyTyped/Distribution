...
object OperationsResource {
  ...
  def apply(
    cancel: js.Function1[
      gapiDotClientDotDataprocLib.Anon_AccesstokenAltBearertokenCallbackFieldsKey, 
    ...
    list: js.Function1[
      gapiDotClientDotDataprocLib.Anon_AccesstokenAltBearertokenCallbackFieldsFilter, 
