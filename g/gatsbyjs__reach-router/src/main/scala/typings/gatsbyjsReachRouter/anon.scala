...
object anon {
  ...
  trait ReadonlyRouterPropsHTMLPr extends StObject {
    ...
    val `aria-braillelabel`: js.UndefOr[String] = js.undefined
    
    val `aria-brailleroledescription`: js.UndefOr[String] = js.undefined
    ...
    val `aria-colindextext`: js.UndefOr[String] = js.undefined
    ...
    val `aria-description`: js.UndefOr[String] = js.undefined
    ...
    val `aria-rowindextext`: js.UndefOr[String] = js.undefined
