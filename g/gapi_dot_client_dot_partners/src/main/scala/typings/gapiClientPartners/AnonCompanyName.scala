...
object AnonCompanyName {
  ...
  def apply(
    ...
    maxMonthlyBudgetDotnanos: Int | Double = null,
    maxMonthlyBudgetDotunits: String = null,
    minMonthlyBudgetDotcurrencyCode: String = null,
    minMonthlyBudgetDotnanos: Int | Double = null,
    ...
    if (maxMonthlyBudgetDotnanos != null) __obj.updateDynamic("maxMonthlyBudget.nanos")(maxMonthlyBudgetDotnanos.asInstanceOf[js.Any])
    ...
    if (minMonthlyBudgetDotnanos != null) __obj.updateDynamic("minMonthlyBudget.nanos")(minMonthlyBudgetDotnanos.asInstanceOf[js.Any])
