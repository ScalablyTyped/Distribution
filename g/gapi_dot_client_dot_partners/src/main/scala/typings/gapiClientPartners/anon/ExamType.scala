...
@js.native
trait ExamType extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object ExamType {
  @scala.inline
  def apply(examType: String): ExamType = {
    val __obj = js.Dynamic.literal(examType = examType.asInstanceOf[js.Any])
    __obj.asInstanceOf[ExamType]
  }
  @scala.inline
  implicit class ExamTypeOps[Self <: ExamType] (val x: Self) extends AnyVal {
    @scala.inline
