...
trait Oauthtoken extends js.Object {
  ...
  var userView: js.UndefOr[String] = js.native
}

object Oauthtoken {
  @scala.inline
  def apply(userId: String): Oauthtoken = {
  ...
  implicit class OauthtokenOps[Self <: Oauthtoken] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUserView(value: String): Self = this.set("userView", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteUserView: Self = this.set("userView", js.undefined)
  }
