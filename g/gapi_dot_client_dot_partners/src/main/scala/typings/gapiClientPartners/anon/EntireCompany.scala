...
@js.native
trait EntireCompany extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object EntireCompany {
  @scala.inline
  def apply(): EntireCompany = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EntireCompany]
  }
  @scala.inline
  implicit class EntireCompanyOps[Self <: EntireCompany] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEntireCompany(value: Boolean): Self = this.set("entireCompany", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteEntireCompany: Self = this.set("entireCompany", js.undefined)
    @scala.inline
