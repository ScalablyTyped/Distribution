...
trait Anon_AccesstokenAltBearertokenCallbackEntireCompany extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackEntireCompany {
  @scala.inline
  def apply(
    ...
    entireCompany: js.UndefOr[scala.Boolean] = js.undefined,
  ...
  ): Anon_AccesstokenAltBearertokenCallbackEntireCompany = {
    ...
    if (!js.isUndefined(entireCompany)) __obj.updateDynamic("entireCompany")(entireCompany)
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackEntireCompany]
  }
}
