...
object HistoryResource {
  @scala.inline
  def apply(
    list: gapiDotClientDotPartnersLib.Anon_AccesstokenAltBearertokenCallbackEntireCompany => gapiDotClientLib.gapiNs.clientNs.Request[ListOffersHistoryResponse]
  ): HistoryResource = {
