...
object Anon_AccesstokenAltBearertokenCallbackExamType {
  @scala.inline
  def apply(
    examType: java.lang.String,
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackExamType]
  }
}
