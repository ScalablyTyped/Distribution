...
version := "0.6.1-e3ecad"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.0.0",
  "org.scalablytyped" %%% "apollo-datasource" % "0.4.0-5f9b2e",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.1.1-c270ce",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.5.1-411425",
  ...
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.16-aa2aa3",
  "org.scalablytyped" %%% "ws" % "6.0-dt-20180830Z-12e646",
