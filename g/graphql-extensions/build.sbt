...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.0.7-911db6",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.4.8-f0c325",
  ...
  "org.scalablytyped" %%% "graphql-subscriptions" % "1.0.0-01aafa",
