...
version := "0.5.4-66e756"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "1.0.0",
  "org.scala-js" %%% "scalajs-dom" % "0.9.6",
  "org.scalablytyped" %%% "apollo-cache-control" % "0.5.2-4cf290",
  "org.scalablytyped" %%% "apollo-datasource" % "0.3.1-ba1bc1",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.0.7-2f43df",
  "org.scalablytyped" %%% "apollo-engine-reporting-protobuf" % "0.2.1-e9e209",
  "org.scalablytyped" %%% "apollo-env" % "0.3.4-a9c3ec",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.4.8-209847",
  ...
  "org.scalablytyped" %%% "apollographql__apollo-tools" % "0.3.4-211228",
  ...
  "org.scalablytyped" %%% "graphql-subscriptions" % "1.0.0-9d8c98",
  "org.scalablytyped" %%% "graphql-tag" % "2.10.1-8ad040",
  "org.scalablytyped" %%% "graphql-tools" % "4.0.4-a12209",
  ...
  "org.scalablytyped" %%% "sha_dot_js" % "2.4-dt-20181126Z-7871b2",
  "org.scalablytyped" %%% "std" % "3.3-ec2942",
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.16-f42ebd",
