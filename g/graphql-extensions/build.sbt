...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "apollo-env" % "0.3.3-408365",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.4.0-4f2edf",
  ...
  "org.scalablytyped" %%% "apollographql__apollo-tools" % "0.3.3-f79199",
