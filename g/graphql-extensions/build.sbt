...
version := "0.5.4-16f47e"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "1.0.0",
  "org.scala-js" %%% "scalajs-dom" % "0.9.6",
  "org.scalablytyped" %%% "apollo-datasource" % "0.3.1-3dc429",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.0.7-2c108c",
  "org.scalablytyped" %%% "apollo-engine-reporting-protobuf" % "0.2.1-75ef89",
  "org.scalablytyped" %%% "apollo-env" % "0.4.0-3cb01d",
  "org.scalablytyped" %%% "apollo-graphql" % "0.1.3-5211d3",
  "org.scalablytyped" %%% "apollo-link" % "1.2.11-e13a57",
  "org.scalablytyped" %%% "apollo-server-caching" % "0.3.1-f091ae",
  "org.scalablytyped" %%% "apollo-server-core" % "2.4.8-5c5228",
  ...
  "org.scalablytyped" %%% "apollographql__apollo-tools" % "0.3.5-3fb4e4",
  ...
  "org.scalablytyped" %%% "graphql-subscriptions" % "1.0.0-8a7e37",
  ...
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.16-619856",
