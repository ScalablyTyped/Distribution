...
version := "0.7.7-092458"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "apollo-datasource" % "0.5.0-cf6876",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.3.6-6fa49c",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.6.9-2acc6c",
  "org.scalablytyped" %%% "apollo-server-env" % "2.4.0-318844",
  "org.scalablytyped" %%% "apollo-server-errors" % "2.3.1-e1bd83",
  "org.scalablytyped" %%% "apollo-server-plugin-base" % "0.5.8-e1085e",
