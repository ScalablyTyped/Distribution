...
version := "0.5.7-050ea9"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "1.0.0",
  "org.scala-js" %%% "scalajs-dom" % "0.9.6",
  "org.scalablytyped" %%% "apollo-datasource" % "0.3.1-86657c",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.0.7-4effb8",
  "org.scalablytyped" %%% "apollo-engine-reporting-protobuf" % "0.2.1-6097f8",
  "org.scalablytyped" %%% "apollo-env" % "0.4.0-9585f8",
  "org.scalablytyped" %%% "apollo-graphql" % "0.1.3-9f5f02",
  "org.scalablytyped" %%% "apollo-link" % "1.2.11-f30531",
  "org.scalablytyped" %%% "apollo-server-caching" % "0.3.1-e72a35",
  "org.scalablytyped" %%% "apollo-server-core" % "2.4.8-50ac84",
  ...
  "org.scalablytyped" %%% "apollographql__apollo-tools" % "0.3.5-3db58f",
  ...
  "org.scalablytyped" %%% "graphql-subscriptions" % "1.1.0-2caa5e",
  "org.scalablytyped" %%% "graphql-tag" % "2.10.1-8907cf",
  "org.scalablytyped" %%% "graphql-tools" % "4.0.4-37a775",
  ...
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.16-7ecfa4",
