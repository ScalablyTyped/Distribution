...
version := "0.7.6-e8ebe6"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "apollo-datasource" % "0.5.0-cf6876",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.3.5-90f362",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.6.7-b96bf0",
  "org.scalablytyped" %%% "apollo-server-env" % "2.4.0-edd3cb",
  ...
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.16-9e7d5d",
