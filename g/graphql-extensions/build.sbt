...
version := "0.5.7-7e0783"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.0.0",
  "org.scalablytyped" %%% "apollo-datasource" % "0.3.1-6d1f87",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.0.7-236e41",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.4.8-3279eb",
  "org.scalablytyped" %%% "apollo-server-env" % "2.2.0-4d2cf6",
  ...
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.16-70badd",
