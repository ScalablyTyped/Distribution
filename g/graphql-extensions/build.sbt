...
version := "0.5.7-979086"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.0.0",
  "org.scalablytyped" %%% "apollo-datasource" % "0.3.1-6a8440",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.0.7-8b37d9",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.4.8-47e179",
  ...
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.16-d289bc",
