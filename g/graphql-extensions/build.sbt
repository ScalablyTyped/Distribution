...
version := "0.5.0-0a6523"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "1.0.0",
  "org.scala-js" %%% "scalajs-dom" % "0.9.6",
  "org.scalablytyped" %%% "apollo-datasource" % "0.3.0-5686fc",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.0.0-f3d9ae",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.4.0-2e1496",
  ...
  "org.scalablytyped" %%% "apollographql__apollo-tools" % "0.3.2-a32b36",
  ...
  "org.scalablytyped" %%% "graphql-subscriptions" % "1.0.0-7eef31",
  "org.scalablytyped" %%% "graphql-tag" % "2.10.1-0e2c1c",
  "org.scalablytyped" %%% "graphql-tools" % "4.0.4-195e04",
