...
version := "0.6.0-5f695f"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.0.0",
  "org.scalablytyped" %%% "apollo-datasource" % "0.4.0-7290f9",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.1.0-d173b6",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.5.0-dcf021",
  "org.scalablytyped" %%% "apollo-server-env" % "2.3.0-42a89d",
  ...
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.16-3cd6d7",
