...
trait Shared extends js.Object {
  ...
  def formatNumber(value: scala.Double, options: NumberFormatterOptions): java.lang.String = js.native
  /**
  ...
  def numberFormatter(options: NumberFormatterOptions): js.Function1[/* value */ scala.Double, java.lang.String] = js.native
  /**
  ...
  def numberParser(options: NumberParserOptions): js.Function1[/* value */ java.lang.String, scala.Double] = js.native
  /**
  ...
  def parseNumber(value: java.lang.String, options: NumberParserOptions): scala.Double = js.native
}
