...
object distGlobalizeMod extends Shortcut {
  ...
  trait DateFormatPart extends StObject {
    ...
    var `type`: typings.globalize.distGlobalizeDateMod.globalizeDistGlobalizeAugmentingMod.DateFormatPartTypes
  ...
  object DateFormatPart {
    ...
    inline def apply(
      `type`: typings.globalize.distGlobalizeDateMod.globalizeDistGlobalizeAugmentingMod.DateFormatPartTypes,
      value: String
    ): DateFormatPart = {
  ...
  */
  ...
  trait Shared extends StObject {
    ...
    def currencyFormatter(
      currency: String,
      options: typings.globalize.distGlobalizeCurrencyMod.globalizeDistGlobalizeAugmentingMod.CurrencyFormatterOptions
    ...
    def dateFormatter(
      options: typings.globalize.distGlobalizeDateMod.globalizeDistGlobalizeAugmentingMod.DateFormatterOptions
    ...
    def dateToPartsFormatter(): js.Function1[
        /* value */ js.Date, 
        js.Array[
          typings.globalize.distGlobalizeDateMod.globalizeDistGlobalizeAugmentingMod.DateFormatPart
        ]
      ] = js.native
    ...
    def formatRelativeTime(
      value: Double,
      unit: String,
      options: typings.globalize.distGlobalizeRelativeTimeMod.globalizeDistGlobalizeAugmentingMod.RelativeTimeFormatterOptions
    ): String = js.native
    ...
    def formatUnit(
      value: Double,
      unit: String,
      options: typings.globalize.distGlobalizeUnitMod.globalizeDistGlobalizeAugmentingMod.UnitFormatterOptions
    ): String = js.native
    ...
    def plural(
      value: Double,
      options: typings.globalize.distGlobalizePluralMod.globalizeDistGlobalizeAugmentingMod.PluralGeneratorOptions
    ): String = js.native
