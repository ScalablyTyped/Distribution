...
object geolibMod extends js.Object {
  /** Computes the destination point given an initial point, a distance (in meters) and a bearing (in degrees). 
    ...
    */
  def computeDestinationPoint(start: geolibLib.geolibNs.PositionAsDecimal, distance: scala.Double, bearing: scala.Double): geolibLib.geolibNs.PositionAsDecimal = js.native
  /** Computes the destination point given an initial point, a distance (in meters) and a bearing (in degrees). 
    * If no radius is given it defaults to the mean earth radius of 6371000 meter. 
    * 
    * Returns an object: `{"latitude": destLat, "longitude": destLng}` 
  ...
  def computeDestinationPoint(
    start: geolibLib.geolibNs.PositionAsDecimal,
    distance: scala.Double,
    bearing: scala.Double,
    radius: scala.Double
  ): geolibLib.geolibNs.PositionAsDecimal = js.native
  ...
  def findNearest(
    latlng: geolibLib.geolibNs.PositionAsDecimal,
    coords: js.Array[geolibLib.geolibNs.PositionAsDecimal]
  ): js.Array[geolibLib.geolibNs.Distance] = js.native
  /** Gets great circle bearing of two points. See description of getRhumbLineBearing for more information. 
    * 
    * Returns calculated bearing as integer 
    */
  def getBearing(originLL: geolibLib.geolibNs.PositionAsDecimal, destLL: geolibLib.geolibNs.PositionAsDecimal): scala.Double = js.native
  /** Calculates the bounds of geo coordinates.
    ...
    */
  def getBounds(coords: js.Array[geolibLib.geolibNs.PositionWithElevation]): geolibLib.geolibNs.Bound = js.native
  /** Calculates the geographical center of all points in a collection of geo coordinates 
    ...
    */
  def getCenter(coords: js.Array[geolibLib.geolibNs.PositionAsDecimal]): geolibLib.geolibNs.PositionAsDecimal = js.native
  /** Calculates the center of the bounds of geo coordinates. Takes an array of coordinates, 
    ...
    */
  def getCenterOfBounds(coords: js.Array[geolibLib.geolibNs.PositionAsDecimal]): geolibLib.geolibNs.PositionAsDecimal = js.native
  /** Gets the compass direction from an origin coordinate (originLL) to a destination coordinate (destLL). 
    ...
    */
  def getCompassDirection(originLL: geolibLib.geolibNs.PositionAsDecimal, destLL: geolibLib.geolibNs.PositionAsDecimal): geolibLib.geolibNs.CompassDirection = js.native
  /** Gets the compass direction from an origin coordinate (originLL) to a destination coordinate (destLL). 
    * Bearing mode. Can be either circle or rhumbline (default). 
    * 
    * Returns an object with a rough (NESW) and an exact direction (NNE, NE, ENE, E, ESE, etc).
  ...
  def getCompassDirection(
    originLL: geolibLib.geolibNs.PositionAsDecimal,
    destLL: geolibLib.geolibNs.PositionAsDecimal,
    bearingMode: java.lang.String
  ): geolibLib.geolibNs.CompassDirection = js.native
  /** Calculates the distance between two geo coordinates
    * 
    * Return value is always float and represents the distance in meters.
    */
  def getDistance(start: geolibLib.geolibNs.PositionAsDecimal, end: geolibLib.geolibNs.PositionAsDecimal): scala.Double = js.native
  /** Calculates the distance between two geo coordinates
    * 
    * Return value is always float and represents the distance in meters.
    */
  def getDistance(
    start: geolibLib.geolibNs.PositionAsDecimal,
    end: geolibLib.geolibNs.PositionAsDecimal,
    accuracy: scala.Double,
    precision: scala.Double
  ): scala.Double = js.native
  def getDistance(start: geolibLib.geolibNs.PositionAsDecimal, end: geolibLib.geolibNs.PositionAsSexadecimal): scala.Double = js.native
  def getDistance(
    start: geolibLib.geolibNs.PositionAsDecimal,
    end: geolibLib.geolibNs.PositionAsSexadecimal,
    accuracy: scala.Double,
    precision: scala.Double
  ): scala.Double = js.native
  def getDistance(start: geolibLib.geolibNs.PositionAsSexadecimal, end: geolibLib.geolibNs.PositionAsDecimal): scala.Double = js.native
  def getDistance(
    start: geolibLib.geolibNs.PositionAsSexadecimal,
    end: geolibLib.geolibNs.PositionAsDecimal,
    accuracy: scala.Double,
    precision: scala.Double
  ): scala.Double = js.native
  def getDistance(start: geolibLib.geolibNs.PositionAsSexadecimal, end: geolibLib.geolibNs.PositionAsSexadecimal): scala.Double = js.native
  def getDistance(
    start: geolibLib.geolibNs.PositionAsSexadecimal,
    end: geolibLib.geolibNs.PositionAsSexadecimal,
    accuracy: scala.Double,
  ...
  /** Calculates the distance between two geo coordinates but this method is far more inaccurate as compared to getDistance.
    ...
    */
  def getDistanceSimple(start: geolibLib.geolibNs.PositionAsDecimal, end: geolibLib.geolibNs.PositionAsDecimal): scala.Double = js.native
  /** Calculates the distance between two geo coordinates but this method is far more inaccurate as compared to getDistance.
    * It can take up 2 to 3 arguments. start, end and accuracy can be defined in the same as in getDistance.
    * 
    * Return value is always float that represents the distance in meters. 
  ...
  def getDistanceSimple(start: geolibLib.geolibNs.PositionAsDecimal, end: geolibLib.geolibNs.PositionAsSexadecimal): scala.Double = js.native
  def getDistanceSimple(
    start: geolibLib.geolibNs.PositionAsDecimal,
    end: geolibLib.geolibNs.PositionAsSexadecimal,
    accuracy: scala.Double
  ): scala.Double = js.native
  def getDistanceSimple(start: geolibLib.geolibNs.PositionAsSexadecimal, end: geolibLib.geolibNs.PositionAsDecimal): scala.Double = js.native
  def getDistanceSimple(
    start: geolibLib.geolibNs.PositionAsSexadecimal,
    end: geolibLib.geolibNs.PositionAsDecimal,
    accuracy: scala.Double
  ): scala.Double = js.native
  def getDistanceSimple(start: geolibLib.geolibNs.PositionAsSexadecimal, end: geolibLib.geolibNs.PositionAsSexadecimal): scala.Double = js.native
  def getDistanceSimple(
    start: geolibLib.geolibNs.PositionAsSexadecimal,
    end: geolibLib.geolibNs.PositionAsSexadecimal,
    accuracy: scala.Double
  ...
  def getPathLength(coords: js.Array[geolibLib.geolibNs.PositionAsDecimal]): scala.Double = js.native
  /** Gets rhumb line bearing of two points. Find out about the difference between rhumb line and great circle bearing on Wikipedia. 
    ...
    * Returns calculated bearing as integer. 
    */
  def getRhumbLineBearing(originLL: geolibLib.geolibNs.PositionAsDecimal, destLL: geolibLib.geolibNs.PositionAsDecimal): scala.Double = js.native
  /** Calculates the speed between two points within a given time span. 
    * 
    * Returns the speed in options.unit (default is km/h). 
    */
  def getSpeed(coords: js.Array[geolibLib.geolibNs.PositionInTime]): scala.Double = js.native
  /** Calculates the speed between two points within a given time span. 
    * 
    * Returns the speed in options.unit (default is km/h). 
    */
  def getSpeed(coords: js.Array[geolibLib.geolibNs.PositionInTime], option: geolibLib.geolibNs.SpeedOption): scala.Double = js.native
  ...
  def isPointInCircle(
    latlng: geolibLib.geolibNs.PositionAsDecimal,
    center: geolibLib.geolibNs.PositionAsDecimal,
    radius: scala.Double
  ): scala.Boolean = js.native
  /** Calculates if given point lies in a line formed by start and end */
  def isPointInLine(
    point: geolibLib.geolibNs.PositionAsDecimal,
    start: geolibLib.geolibNs.PositionAsDecimal,
    end: geolibLib.geolibNs.PositionAsDecimal
  ): scala.Boolean = js.native
  ...
  def isPointInside(
    latlng: geolibLib.geolibNs.PositionAsDecimal,
    polygon: js.Array[geolibLib.geolibNs.PositionAsDecimal]
  ): scala.Boolean = js.native
