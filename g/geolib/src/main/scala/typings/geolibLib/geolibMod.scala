...
object geolibMod extends js.Object {
  ...
  def convertArea(squareMeters: scala.Double): scala.Double = js.native
  def convertArea(squareMeters: scala.Double, targetUnit: java.lang.String): scala.Double = js.native
  def convertDistance(meters: scala.Double): scala.Double = js.native
  def convertDistance(meters: scala.Double, targetUnit: java.lang.String): scala.Double = js.native
  ...
  def getAreaOfPolygon(points: js.Array[geolibLib.esTypesMod.GeolibInputCoordinates]): scala.Double = js.native
