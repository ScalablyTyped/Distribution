...
trait AnonUpdateMask extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnonUpdateMask {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(variantId = variantId.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[AnonUpdateMask]
  }
}
