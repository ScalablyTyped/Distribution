...
@js.native
trait VariantSetId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object VariantSetId {
  @scala.inline
  def apply(variantSetId: String): VariantSetId = {
    val __obj = js.Dynamic.literal(variantSetId = variantSetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[VariantSetId]
  }
  @scala.inline
  implicit class VariantSetIdOps[Self <: VariantSetId] (val x: Self) extends AnyVal {
    @scala.inline
