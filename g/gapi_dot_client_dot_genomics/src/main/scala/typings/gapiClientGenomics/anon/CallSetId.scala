...
@js.native
trait CallSetId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object CallSetId {
  @scala.inline
  def apply(callSetId: String): CallSetId = {
    val __obj = js.Dynamic.literal(callSetId = callSetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallSetId]
  }
  @scala.inline
  implicit class CallSetIdOps[Self <: CallSetId] (val x: Self) extends AnyVal {
    @scala.inline
