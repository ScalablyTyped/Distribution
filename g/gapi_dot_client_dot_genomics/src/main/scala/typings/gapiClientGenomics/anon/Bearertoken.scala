...
trait Bearertoken extends js.Object {
  ...
  var annotationSetId: String = js.native
  /** OAuth bearer token. */
...
object Bearertoken {
  @scala.inline
  def apply(annotationSetId: String): Bearertoken = {
    val __obj = js.Dynamic.literal(annotationSetId = annotationSetId.asInstanceOf[js.Any])
