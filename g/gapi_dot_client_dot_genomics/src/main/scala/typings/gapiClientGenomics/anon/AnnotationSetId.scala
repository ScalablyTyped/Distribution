...
@js.native
trait AnnotationSetId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object AnnotationSetId {
  @scala.inline
  def apply(annotationSetId: String): AnnotationSetId = {
    val __obj = js.Dynamic.literal(annotationSetId = annotationSetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnnotationSetId]
  }
  @scala.inline
  implicit class AnnotationSetIdOps[Self <: AnnotationSetId] (val x: Self) extends AnyVal {
    @scala.inline
