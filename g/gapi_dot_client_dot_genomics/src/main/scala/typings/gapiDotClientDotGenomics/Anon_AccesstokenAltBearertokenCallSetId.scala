...
trait Anon_AccesstokenAltBearertokenCallSetId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallSetId {
  @scala.inline
  def apply(
    callSetId: String,
    `$.xgafv`: String = null,
    ...
    val __obj = js.Dynamic.literal(callSetId = callSetId.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallSetId]
  }
}
