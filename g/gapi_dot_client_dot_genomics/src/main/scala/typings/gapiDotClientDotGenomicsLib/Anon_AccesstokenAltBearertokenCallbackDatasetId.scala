...
trait Anon_AccesstokenAltBearertokenCallbackDatasetId extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackDatasetId {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackDatasetId = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackDatasetId]
  }
}
