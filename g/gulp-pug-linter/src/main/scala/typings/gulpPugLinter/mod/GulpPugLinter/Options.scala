package typings.gulpPugLinter.mod.GulpPugLinter
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFailAfterError(value: Boolean): Self = this.set("failAfterError", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteFailAfterError: Self = this.set("failAfterError", js.undefined)
