...
object gitlabLibStrings {
  @js.native
  sealed trait Bundler extends js.Object
  ...
  sealed trait internal
    extends gitlabLib.distEs5ServicesProjectSnippetsMod.VisibilityLevel
       with gitlabLib.distLatestServicesProjectSnippetsMod.VisibilityLevel
  ...
  @js.native
  sealed trait oauthToken extends js.Object
  ...
  @scala.inline
  def Bundler: Bundler = "Bundler".asInstanceOf[Bundler]
  @scala.inline
  ...
  @scala.inline
  def jobToken: jobToken = "jobToken".asInstanceOf[jobToken]
  @scala.inline
  ...
  @scala.inline
  def oauthToken: oauthToken = "oauthToken".asInstanceOf[oauthToken]
  @scala.inline
