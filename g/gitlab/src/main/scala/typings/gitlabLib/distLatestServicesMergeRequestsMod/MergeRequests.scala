...
trait MergeRequests
  ...
  def accept(
    ...
    options: AcceptMergeRequestOptions with gitlabLib.distLatestInfrastructureRequestHelperMod.RequestOptions
  ...
  def approvals(
    projectId: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ProjectId */ js.Any,
    hasMergerequestId: gitlabLib.Anon_MergerequestIdMergeRequestId
  ): js.Promise[_] = js.native
  def approve(
    projectId: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ProjectId */ js.Any,
    mergerequestId: MergeRequestId,
  ...
  def create(
    ...
    options: CreateMergeRequestOptions with gitlabLib.distLatestInfrastructureRequestHelperMod.RequestOptions
  ): js.Promise[_] = js.native
  def edit(
    projectId: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ProjectId */ js.Any,
    mergerequestId: MergeRequestId,
    options: UpdateMergeRequestOptions with gitlabLib.distLatestInfrastructureRequestHelperMod.RequestOptions
  ): js.Promise[_] = js.native
  def editApprovals(
    projectId: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ProjectId */ js.Any,
  ...
  def show(
    projectId: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ProjectId */ js.Any,
    mergerequestId: MergeRequestId,
    options: ShowMergeRequestOptions with gitlabLib.distLatestInfrastructureRequestHelperMod.RequestOptions
  ): js.Promise[_] = js.native
  def timeStats(
    projectId: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ProjectId */ js.Any,
    mergerequestId: MergeRequestId
