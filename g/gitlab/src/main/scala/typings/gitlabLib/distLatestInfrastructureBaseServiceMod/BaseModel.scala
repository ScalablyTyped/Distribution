...
trait BaseModel extends js.Object {
  ...
  val requester: gitlabLib.distLatestInfrastructureXMLHttpRequesterMod.XhrStaticPromisified
...
object BaseModel {
  ...
  def apply(
    ...
    requester: gitlabLib.distLatestInfrastructureXMLHttpRequesterMod.XhrStaticPromisified,
