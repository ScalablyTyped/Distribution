...
package object mod {
  ...
  @scala.inline
  def Gitlab: typings.gitlab.utilsMod.Bundle[
    typings.gitlab.anon.TypeofAPIServices, 
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 90 */ js.Any
  ] = typings.gitlab.mod.^.asInstanceOf[js.Dynamic].selectDynamic("Gitlab").asInstanceOf[typings.gitlab.utilsMod.Bundle[
    typings.gitlab.anon.TypeofAPIServices, 
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 90 */ js.Any
  ]]
  ...
  @scala.inline
  def GroupsBundle: typings.gitlab.utilsMod.Bundle[
  ...
  ] = typings.gitlab.mod.^.asInstanceOf[js.Dynamic].selectDynamic("UsersBundle").asInstanceOf[typings.gitlab.utilsMod.Bundle[
    typings.gitlab.anon.UserCustomAttributes, 
    typings.gitlab.gitlabStrings.Users | typings.gitlab.gitlabStrings.UserCustomAttributes | typings.gitlab.gitlabStrings.UserEmails | typings.gitlab.gitlabStrings.UserImpersonationTokens | typings.gitlab.gitlabStrings.UserKeys | typings.gitlab.gitlabStrings.UserGPGKeys
  ]]
  type UsersBundle = typings.std.InstanceType[
    typings.gitlab.utilsMod.Bundle[
      typings.gitlab.anon.UserEmails, 
      typings.gitlab.gitlabStrings.Users | typings.gitlab.gitlabStrings.UserCustomAttributes | typings.gitlab.gitlabStrings.UserEmails | typings.gitlab.gitlabStrings.UserImpersonationTokens | typings.gitlab.gitlabStrings.UserKeys | typings.gitlab.gitlabStrings.UserGPGKeys
    ]
  ]
}
