...
object groupsMod extends js.Object {
  ...
  class Groups () extends BaseService {
    ...
    def removeLDAPLink(groupId: String, cn: js.Any, hasProviderOptions: Sudo with AnonProvider): js.Promise[js.Object] = js.native
    def removeLDAPLink(groupId: Double, cn: js.Any): js.Promise[js.Object] = js.native
    def removeLDAPLink(groupId: Double, cn: js.Any, hasProviderOptions: Sudo with AnonProvider): js.Promise[js.Object] = js.native
