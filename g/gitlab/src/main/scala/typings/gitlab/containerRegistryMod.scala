...
object containerRegistryMod extends js.Object {
  ...
  class ContainerRegistry () extends BaseService {
    ...
    def removeTags(projectId: String, repositoryId: Double, tagNameRegex: String, options: Sudo with AnonKeepN): js.Promise[js.Object] = js.native
    def removeTags(projectId: Double, repositoryId: Double, tagNameRegex: String): js.Promise[js.Object] = js.native
    def removeTags(projectId: Double, repositoryId: Double, tagNameRegex: String, options: Sudo with AnonKeepN): js.Promise[js.Object] = js.native
