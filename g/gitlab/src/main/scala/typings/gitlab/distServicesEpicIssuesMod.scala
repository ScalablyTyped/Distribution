...
import typings.gitlab.distServicesEpicIssuesMod.EpicIssues
...
@JSImport("gitlab/dist/services/EpicIssues", JSImport.Namespace)
@js.native
object distServicesEpicIssuesMod extends js.Object {
  @js.native
