...
import typings.gitlab.distTypesCoreServicesMod.VulnerabilityFindings
...
trait TypeofAPIServices extends StObject {
  ...
  var Labels: Instantiable1[/* options */ BaseServiceOptions, typings.gitlab.distTypesCoreServicesMod.Labels]
  ...
  var VulnerabilityFindings: Instantiable0[typings.gitlab.distTypesCoreServicesMod.VulnerabilityFindings]
...
object TypeofAPIServices {
  ...
  inline def apply(
    ...
    Branches: Instantiable0[typings.gitlab.distTypesCoreServicesMod.Branches],
  ...
  implicit open class MutableBuilder[Self <: TypeofAPIServices] (val x: Self) extends AnyVal {
    ...
    inline def setBroadcastMessages(value: Instantiable0[BroadcastMessages]): Self = StObject.set(x, "BroadcastMessages", value.asInstanceOf[js.Any])
    ...
    inline def setFeatureFlags(value: Instantiable0[FeatureFlags]): Self = StObject.set(x, "FeatureFlags", value.asInstanceOf[js.Any])
    
    inline def setGeoNodes(value: Instantiable0[GeoNodes]): Self = StObject.set(x, "GeoNodes", value.asInstanceOf[js.Any])
    
    inline def setGitLabCIYMLTemplates(value: Instantiable1[/* options */ BaseServiceOptions, GitLabCIYMLTemplates]): Self = StObject.set(x, "GitLabCIYMLTemplates", value.asInstanceOf[js.Any])
    
    inline def setGitignoreTemplates(value: Instantiable1[/* options */ BaseServiceOptions, GitignoreTemplates]): Self = StObject.set(x, "GitignoreTemplates", value.asInstanceOf[js.Any])
    ...
    inline def setKeys(value: Instantiable0[Keys]): Self = StObject.set(x, "Keys", value.asInstanceOf[js.Any])
    ...
    inline def setLicence(value: Instantiable0[Licence]): Self = StObject.set(x, "Licence", value.asInstanceOf[js.Any])
    
    inline def setLicenceTemplates(value: Instantiable1[/* options */ BaseServiceOptions, LicenceTemplates]): Self = StObject.set(x, "LicenceTemplates", value.asInstanceOf[js.Any])
    
    inline def setLint(value: Instantiable0[Lint]): Self = StObject.set(x, "Lint", value.asInstanceOf[js.Any])
    
    inline def setMarkdown(value: Instantiable0[Markdown]): Self = StObject.set(x, "Markdown", value.asInstanceOf[js.Any])
    ...
    inline def setNamespaces(value: Instantiable0[Namespaces]): Self = StObject.set(x, "Namespaces", value.asInstanceOf[js.Any])
    
    inline def setNotificationSettings(value: Instantiable0[NotificationSettings]): Self = StObject.set(x, "NotificationSettings", value.asInstanceOf[js.Any])
    
    inline def setPackages(value: Instantiable0[Packages]): Self = StObject.set(x, "Packages", value.asInstanceOf[js.Any])
    
    inline def setPagesDomains(value: Instantiable0[PagesDomains]): Self = StObject.set(x, "PagesDomains", value.asInstanceOf[js.Any])
    ...
    inline def setSearch(value: Instantiable0[Search]): Self = StObject.set(x, "Search", value.asInstanceOf[js.Any])
    
    inline def setServices(value: Instantiable0[Services]): Self = StObject.set(x, "Services", value.asInstanceOf[js.Any])
    
    inline def setSidekiqMetrics(value: Instantiable0[SidekiqMetrics]): Self = StObject.set(x, "SidekiqMetrics", value.asInstanceOf[js.Any])
    
    inline def setSnippets(value: Instantiable0[Snippets]): Self = StObject.set(x, "Snippets", value.asInstanceOf[js.Any])
    
    inline def setSystemHooks(value: Instantiable0[SystemHooks]): Self = StObject.set(x, "SystemHooks", value.asInstanceOf[js.Any])
    
    inline def setTags(value: Instantiable0[Tags]): Self = StObject.set(x, "Tags", value.asInstanceOf[js.Any])
    
    inline def setTodos(value: Instantiable0[Todos]): Self = StObject.set(x, "Todos", value.asInstanceOf[js.Any])
    ...
    inline def setVersion(value: Instantiable0[Version]): Self = StObject.set(x, "Version", value.asInstanceOf[js.Any])
    ...
    inline def setWikis(value: Instantiable0[Wikis]): Self = StObject.set(x, "Wikis", value.asInstanceOf[js.Any])
  }
}
