...
@JSImport("gitlab/dist/types/core/services/Projects", JSImport.Namespace)
@js.native
object distTypesCoreServicesProjectsMod extends js.Object {
  @js.native
  class Projects () extends BaseService {
    ...
    def updatePushRule(projectId: String): js.Promise[js.Object] = js.native
    def updatePushRule(projectId: String, options: BaseRequestOptions): js.Promise[js.Object] = js.native
    def updatePushRule(projectId: Double): js.Promise[js.Object] = js.native
    def updatePushRule(projectId: Double, options: BaseRequestOptions): js.Promise[js.Object] = js.native
