...
object branchesMod extends js.Object {
  ...
  class Branches () extends BaseService {
    ...
    def all(projectId: String, options: AnonSearch with PaginatedRequestOptions): js.Promise[GetResponse] = js.native
    def all(projectId: Double): js.Promise[GetResponse] = js.native
    def all(projectId: Double, options: AnonSearch with PaginatedRequestOptions): js.Promise[GetResponse] = js.native
