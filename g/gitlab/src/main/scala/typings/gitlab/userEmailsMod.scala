...
object userEmailsMod extends js.Object {
  ...
  class UserEmails () extends BaseService {
    ...
    def add(email: js.Any, hasUserIdOptions: AnonUserId with BaseRequestOptions): js.Promise[js.Object] = js.native
    ...
    def remove(emailId: js.Any, hasUserIdOptions: AnonUserId with BaseRequestOptions): js.Promise[js.Object] = js.native
