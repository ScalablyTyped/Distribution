...
import typings.gitlab.distServicesDeployKeysMod.DeployKeys
...
@JSImport("gitlab/dist/services/DeployKeys", JSImport.Namespace)
@js.native
object distServicesDeployKeysMod extends js.Object {
  @js.native
