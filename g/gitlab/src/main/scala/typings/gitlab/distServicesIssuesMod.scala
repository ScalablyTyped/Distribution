...
import typings.gitlab.distServicesIssuesMod.Issues
...
@JSImport("gitlab/dist/services/Issues", JSImport.Namespace)
@js.native
object distServicesIssuesMod extends js.Object {
  @js.native
