...
object pipelinesMod extends js.Object {
  ...
  class Pipelines () extends BaseService {
    ...
    def showJobs(projectId: String, pipelineId: Double, options: AnonScope with Sudo): js.Promise[GetResponse] = js.native
    def showJobs(projectId: Double, pipelineId: Double): js.Promise[GetResponse] = js.native
    def showJobs(projectId: Double, pipelineId: Double, options: AnonScope with Sudo): js.Promise[GetResponse] = js.native
  }
