...
import typings.gitlab.distServicesDeploymentsMod.Deployments
...
@JSImport("gitlab/dist/services/Deployments", JSImport.Namespace)
@js.native
object distServicesDeploymentsMod extends js.Object {
  @js.native
