...
import typings.gitlab.AnonForkedFromId
import typings.gitlab.AnonMetadata
import typings.gitlab.AnonUserId
...
class Projects () extends BaseService {
  ...
  def create(hasUserIdOptions: AnonUserId with BaseRequestOptions): js.Promise[js.Object] = js.native
  ...
  def fork(projectId: String, hasForkedFromIdOptions: AnonForkedFromId with BaseRequestOptions): js.Promise[js.Object] = js.native
  def fork(projectId: Double): js.Promise[js.Object] = js.native
  def fork(projectId: Double, hasForkedFromIdOptions: AnonForkedFromId with BaseRequestOptions): js.Promise[js.Object] = js.native
  ...
  def upload(projectId: js.Any, content: js.Any, hasMetadataSudo: AnonMetadata with Sudo): js.Promise[js.Object] = js.native
}
