...
import typings.giphyApi.BaseImagesizestring
import typings.giphyApi.BaseImagesizestringframes
import typings.giphyApi.BaseImagesizestringmp4str
import typings.giphyApi.BaseImagesizestringwebpst
