...
object Avatarurl {
  ...
  implicit class AvatarurlOps[Self <: Avatarurl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBanner_url(value: String): Self = this.set("banner_url", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDisplay_name(value: String): Self = this.set("display_name", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProfile_url(value: String): Self = this.set("profile_url", value.asInstanceOf[js.Any])
