...
trait Giphy extends js.Object {
  ...
  def random(tagOrOptions: giphyDashApiLib.giphyDashApiMod.RandomOptions): js.Promise[SingleResponse] = js.native
  def random(
    tagOrOptions: giphyDashApiLib.giphyDashApiMod.RandomOptions,
    cb: giphyDashApiLib.Callback[SingleResponse]
  ...
  def translate(termOrOptions: giphyDashApiLib.giphyDashApiMod.TranslateOptions): js.Promise[SingleResponse] = js.native
  def translate(
    termOrOptions: giphyDashApiLib.giphyDashApiMod.TranslateOptions,
    cb: giphyDashApiLib.Callback[SingleResponse]
  ): scala.Unit = js.native
  ...
  def trending(options: giphyDashApiLib.giphyDashApiMod.TrendingOptions): js.Promise[MultiResponse] = js.native
  def trending(
    options: giphyDashApiLib.giphyDashApiMod.TrendingOptions,
    cb: giphyDashApiLib.Callback[MultiResponse]
  ): scala.Unit = js.native
}
