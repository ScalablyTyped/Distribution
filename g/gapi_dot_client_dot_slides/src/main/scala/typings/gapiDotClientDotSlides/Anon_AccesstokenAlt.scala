...
trait Anon_AccesstokenAlt extends js.Object {
  ...
  /**
    ...
    */
  var `thumbnailProperties.mimeType`: js.UndefOr[String] = js.undefined
  /**
    ...
    * image.
    */
  var `thumbnailProperties.thumbnailSize`: js.UndefOr[String] = js.undefined
...
object Anon_AccesstokenAlt {
  ...
  def apply(
    ...
    `thumbnailProperties.mimeType`: String = null,
    `thumbnailProperties.thumbnailSize`: String = null,
