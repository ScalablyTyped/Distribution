...
trait PagesResource extends js.Object {
  ...
  def get(request: Anon_Accesstoken): typings.gapiDotClient.gapiNs.clientNs.Request[Page]
  /**
    * Generates a thumbnail of the latest version of the specified page in the
    * presentation and returns a URL to the thumbnail image.
    */
  def getThumbnail(request: Anon_AccesstokenAlt): typings.gapiDotClient.gapiNs.clientNs.Request[Thumbnail]
}

object PagesResource {
  @scala.inline
  def apply(
    get: Anon_Accesstoken => typings.gapiDotClient.gapiNs.clientNs.Request[Page],
    getThumbnail: Anon_AccesstokenAlt => typings.gapiDotClient.gapiNs.clientNs.Request[Thumbnail]
  ): PagesResource = {
