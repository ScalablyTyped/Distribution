...
trait Anon_Ctx[StateT, CustomT] extends js.Object {
  var `override`: js.UndefOr[
    js.Function1[
      /* ctx */ koaLib.koaMod.ParameterizedContext[StateT, CustomT], 
...
object Anon_Ctx {
  ...
  def apply[StateT, CustomT](
    `override`: /* ctx */ koaLib.koaMod.ParameterizedContext[StateT, CustomT] => graphqlDashApiDashKoaLib.graphqlDashApiDashKoaMod.ExecuteOptions = null
