...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "event-stream" % "v3.3.2-dt-20180510Z-288927",
  "org.scalablytyped" %%% "fancy-log" % "1.3-dt-20190212Z-897bb6",
  ...
  "org.scalablytyped" %%% "progress" % "2.0-dt-20181213Z-c760f4",
  "org.scalablytyped" %%% "shelljs" % "0.8-dt-20190212Z-09150b",
  "org.scalablytyped" %%% "std" % "3.3-0ec965",
  "org.scalablytyped" %%% "typedoc" % "0.14.2-6a3a80",
