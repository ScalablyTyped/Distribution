...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "event-stream" % "v3.3.2-dt-20180910Z-720b0a",
  "org.scalablytyped" %%% "fancy-log" % "1.3-dt-20180910Z-e146a4",
  ...
  "org.scalablytyped" %%% "typedoc" % "0.13.0-b8fa16",
