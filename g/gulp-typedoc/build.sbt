...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "event-stream" % "v3.3.2-dt-20180910Z-75a77a",
  "org.scalablytyped" %%% "fancy-log" % "1.3-dt-20180910Z-6f031a",
  ...
  "org.scalablytyped" %%% "typedoc" % "0.13.0-90e235",
