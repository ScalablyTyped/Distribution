...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "progress" % "2.0-dt-20181213Z-2e44ca",
  "org.scalablytyped" %%% "shelljs" % "0.8-dt-20190125Z-d2ec55",
  "org.scalablytyped" %%% "std" % "3.3-0ec965",
  "org.scalablytyped" %%% "typedoc" % "0.14.2-44d08b",
