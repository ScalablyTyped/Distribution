...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "event-stream" % "v3.3.2-dt-20180910Z-f3cdbc",
  ...
  "org.scalablytyped" %%% "shelljs" % "0.8-dt-20181206Z-c8b493",
  "org.scalablytyped" %%% "std" % "3.2.2-04ea79",
  "org.scalablytyped" %%% "typedoc" % "0.13.0-966140",
