...
name := "gulp-typedoc"
version := "2.2.1-d1d772"
scalaVersion := "2.12.7"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "1.0.0",
  "org.scala-js" %%% "scalajs-dom" % "0.9.6",
  "org.scalablytyped" %%% "ansi-colors" % "1.0-dt-20180214Z-06e5dd",
  "org.scalablytyped" %%% "event-stream" % "v3.3.2-dt-20180510Z-00d8a1",
  ...
  "org.scalablytyped" %%% "typedoc" % "0.13.0-1b6676",
