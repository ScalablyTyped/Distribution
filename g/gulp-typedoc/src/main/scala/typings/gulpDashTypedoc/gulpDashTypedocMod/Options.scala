...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(excludeExternals)) __obj.updateDynamic("excludeExternals")(excludeExternals.asInstanceOf[js.Any])
    if (!js.isUndefined(excludePrivate)) __obj.updateDynamic("excludePrivate")(excludePrivate.asInstanceOf[js.Any])
    if (!js.isUndefined(excludeProtected)) __obj.updateDynamic("excludeProtected")(excludeProtected.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(hideGenerator)) __obj.updateDynamic("hideGenerator")(hideGenerator.asInstanceOf[js.Any])
    if (!js.isUndefined(includeDeclarations)) __obj.updateDynamic("includeDeclarations")(includeDeclarations.asInstanceOf[js.Any])
