...
object mod extends Shortcut {
  ...
  trait Coffeelint extends StObject {
    ...
    def apply(optFile: String, opt: js.Any, literate: Unit, rules: js.Array[js.Function]): ReadWriteStream = js.native
    ...
    def apply(optFile: Unit, opt: js.Any): ReadWriteStream = js.native
    def apply(optFile: Unit, opt: js.Any, literate: Boolean): ReadWriteStream = js.native
    def apply(optFile: Unit, opt: js.Any, literate: Boolean, rules: js.Array[js.Function]): ReadWriteStream = js.native
    def apply(optFile: Unit, opt: js.Any, literate: Unit, rules: js.Array[js.Function]): ReadWriteStream = js.native
