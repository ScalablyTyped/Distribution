...
trait ObjectsResource extends js.Object {
  ...
  def copy(request: gapiDotClientDotStorageLib.Anon_IfSourceMetagenerationMatchIfMetagenerationMatch): gapiDotClientLib.gapiNs.clientNs.Request[Object]
  ...
  def get(request: gapiDotClientDotStorageLib.Anon_IfMetagenerationMatchProjectionGeneration): gapiDotClientLib.gapiNs.clientNs.Request[Object]
  ...
  def insert(request: gapiDotClientDotStorageLib.Anon_Name): gapiDotClientLib.gapiNs.clientNs.Request[Object]
  ...
  def patch(request: gapiDotClientDotStorageLib.Anon_IfMetagenerationMatchProjectionGenerationPrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[Object]
  ...
  def update(request: gapiDotClientDotStorageLib.Anon_IfMetagenerationMatchProjectionGenerationPrettyPrint): gapiDotClientLib.gapiNs.clientNs.Request[Object]
