...
trait AnonAltBucketFieldsIfMetagenerationMatchIfMetagenerationNotMatch extends js.Object {
...
object AnonAltBucketFieldsIfMetagenerationMatchIfMetagenerationNotMatch {
  @scala.inline
  def apply(
    bucket: String,
    alt: String = null,
  ...
  ): AnonAltBucketFieldsIfMetagenerationMatchIfMetagenerationNotMatch = {
    ...
    __obj.asInstanceOf[AnonAltBucketFieldsIfMetagenerationMatchIfMetagenerationNotMatch]
  }
}
