...
trait AnonAltBucketFieldsGenerationIfGenerationMatchIfGenerationNotMatch extends js.Object {
...
object AnonAltBucketFieldsGenerationIfGenerationMatchIfGenerationNotMatch {
  @scala.inline
  def apply(
    bucket: String,
    `object`: String,
  ...
  ): AnonAltBucketFieldsGenerationIfGenerationMatchIfGenerationNotMatch = {
    ...
    __obj.asInstanceOf[AnonAltBucketFieldsGenerationIfGenerationMatchIfGenerationNotMatch]
  }
}
