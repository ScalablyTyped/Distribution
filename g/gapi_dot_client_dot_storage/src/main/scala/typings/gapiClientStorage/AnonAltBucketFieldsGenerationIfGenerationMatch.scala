...
trait AnonAltBucketFieldsGenerationIfGenerationMatch extends js.Object {
...
object AnonAltBucketFieldsGenerationIfGenerationMatch {
  @scala.inline
  def apply(
    bucket: String,
    `object`: String,
  ...
  ): AnonAltBucketFieldsGenerationIfGenerationMatch = {
    ...
    __obj.asInstanceOf[AnonAltBucketFieldsGenerationIfGenerationMatch]
  }
}
