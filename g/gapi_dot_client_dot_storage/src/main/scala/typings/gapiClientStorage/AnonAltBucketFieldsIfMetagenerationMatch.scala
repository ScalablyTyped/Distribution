...
trait AnonAltBucketFieldsIfMetagenerationMatch extends js.Object {
...
object AnonAltBucketFieldsIfMetagenerationMatch {
  @scala.inline
  def apply(
    bucket: String,
    alt: String = null,
  ...
  ): AnonAltBucketFieldsIfMetagenerationMatch = {
    ...
    __obj.asInstanceOf[AnonAltBucketFieldsIfMetagenerationMatch]
  }
}
