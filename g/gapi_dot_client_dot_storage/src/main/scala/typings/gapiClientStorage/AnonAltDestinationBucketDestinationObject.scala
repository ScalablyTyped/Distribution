...
trait AnonAltDestinationBucketDestinationObject extends js.Object {
...
object AnonAltDestinationBucketDestinationObject {
  @scala.inline
  def apply(
  ...
  ): AnonAltDestinationBucketDestinationObject = {
    ...
    __obj.asInstanceOf[AnonAltDestinationBucketDestinationObject]
  }
}
