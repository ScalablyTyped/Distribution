...
trait DefaultObjectAccessControlsResource extends js.Object {
  ...
  def insert(request: AnonAltBucket): Request_[ObjectAccessControl]
  /** Retrieves default object ACL entries on the specified bucket. */
  def list(request: AnonAltBucketFields): Request_[ObjectAccessControls]
...
object DefaultObjectAccessControlsResource {
  ...
  def apply(
    ...
    insert: AnonAltBucket => Request_[ObjectAccessControl],
    list: AnonAltBucketFields => Request_[ObjectAccessControls],
