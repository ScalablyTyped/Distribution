...
import typings.gapiClientStorage.AnonAltFieldsKeyOauthtoken
...
trait ChannelsResource extends js.Object {
  ...
  def stop(request: AnonAltFieldsKeyOauthtoken): Request_[Unit]
}

object ChannelsResource {
  @scala.inline
  def apply(stop: AnonAltFieldsKeyOauthtoken => Request_[Unit]): ChannelsResource = {
