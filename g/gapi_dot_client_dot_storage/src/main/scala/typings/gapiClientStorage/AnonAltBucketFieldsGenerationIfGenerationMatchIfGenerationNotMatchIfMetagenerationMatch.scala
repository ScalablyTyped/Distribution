...
trait AnonAltBucketFieldsGenerationIfGenerationMatchIfGenerationNotMatchIfMetagenerationMatch extends js.Object {
...
object AnonAltBucketFieldsGenerationIfGenerationMatchIfGenerationNotMatchIfMetagenerationMatch {
  @scala.inline
  def apply(
    bucket: String,
    `object`: String,
  ...
  ): AnonAltBucketFieldsGenerationIfGenerationMatchIfGenerationNotMatchIfMetagenerationMatch = {
    ...
    __obj.asInstanceOf[AnonAltBucketFieldsGenerationIfGenerationMatchIfGenerationNotMatchIfMetagenerationMatch]
  }
}
