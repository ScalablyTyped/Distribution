...
trait AnonAltDestinationBucketDestinationKmsKeyName extends js.Object {
...
object AnonAltDestinationBucketDestinationKmsKeyName {
  @scala.inline
  def apply(
  ...
  ): AnonAltDestinationBucketDestinationKmsKeyName = {
    ...
    __obj.asInstanceOf[AnonAltDestinationBucketDestinationKmsKeyName]
  }
}
