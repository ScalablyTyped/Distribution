...
trait AnonAltFieldsIdKeyMaxResults extends js.Object {
...
object AnonAltFieldsIdKeyMaxResults {
  @scala.inline
  def apply(
    part: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltFieldsIdKeyMaxResults]
  }
}
