...
trait AnonAltChannelIdFieldsForChannelId extends js.Object {
...
object AnonAltChannelIdFieldsForChannelId {
  @scala.inline
  def apply(
    part: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltChannelIdFieldsForChannelId = {
    ...
    __obj.asInstanceOf[AnonAltChannelIdFieldsForChannelId]
  }
}
