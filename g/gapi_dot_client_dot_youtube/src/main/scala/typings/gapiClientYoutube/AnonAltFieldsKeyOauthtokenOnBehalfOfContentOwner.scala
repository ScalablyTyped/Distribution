...
trait AnonAltFieldsKeyOauthtokenOnBehalfOfContentOwner extends js.Object {
...
object AnonAltFieldsKeyOauthtokenOnBehalfOfContentOwner {
  @scala.inline
  def apply(
    part: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenOnBehalfOfContentOwner = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenOnBehalfOfContentOwner]
  }
}
