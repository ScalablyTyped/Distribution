...
trait AnonAltFieldsIdKeyOauthtoken extends js.Object {
...
object AnonAltFieldsIdKeyOauthtoken {
  @scala.inline
  def apply(
    id: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltFieldsIdKeyOauthtoken]
  }
}
