...
trait AnonAltFieldsKeyLiveChatId extends js.Object {
...
object AnonAltFieldsKeyLiveChatId {
  @scala.inline
  def apply(
    liveChatId: String,
    part: String,
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyLiveChatId]
  }
}
