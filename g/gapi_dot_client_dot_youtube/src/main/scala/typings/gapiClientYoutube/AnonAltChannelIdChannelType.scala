...
trait AnonAltChannelIdChannelType extends js.Object {
...
object AnonAltChannelIdChannelType {
  @scala.inline
  def apply(
    part: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltChannelIdChannelType]
  }
}
