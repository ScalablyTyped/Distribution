...
trait AnonAltBroadcastStatusFields extends js.Object {
...
object AnonAltBroadcastStatusFields {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAltBroadcastStatusFields]
  }
}
