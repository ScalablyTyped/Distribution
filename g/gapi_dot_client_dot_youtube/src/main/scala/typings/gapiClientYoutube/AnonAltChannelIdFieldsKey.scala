...
trait AnonAltChannelIdFieldsKey extends js.Object {
...
object AnonAltChannelIdFieldsKey {
  @scala.inline
  def apply(
    channelId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltChannelIdFieldsKey]
  }
}
