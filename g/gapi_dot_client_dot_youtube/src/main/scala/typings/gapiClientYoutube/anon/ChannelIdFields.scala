...
@js.native
trait ChannelIdFields extends js.Object {
...
object ChannelIdFields {
  @scala.inline
  def apply(channelId: String): ChannelIdFields = {
    val __obj = js.Dynamic.literal(channelId = channelId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChannelIdFields]
  }
  @scala.inline
  implicit class ChannelIdFieldsOps[Self <: ChannelIdFields] (val x: Self) extends AnyVal {
    @scala.inline
