...
@js.native
trait OnBehalfOfContentOwnerChannel extends js.Object {
...
object OnBehalfOfContentOwnerChannel {
  @scala.inline
  def apply(part: String): OnBehalfOfContentOwnerChannel = {
    val __obj = js.Dynamic.literal(part = part.asInstanceOf[js.Any])
    __obj.asInstanceOf[OnBehalfOfContentOwnerChannel]
  }
  @scala.inline
  implicit class OnBehalfOfContentOwnerChannelOps[Self <: OnBehalfOfContentOwnerChannel] (val x: Self) extends AnyVal {
    @scala.inline
