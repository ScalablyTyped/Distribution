...
trait AnonAltFieldsIdKeyMaxResultsMine extends js.Object {
...
object AnonAltFieldsIdKeyMaxResultsMine {
  @scala.inline
  def apply(
    part: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsIdKeyMaxResultsMine = {
    ...
    __obj.asInstanceOf[AnonAltFieldsIdKeyMaxResultsMine]
  }
}
