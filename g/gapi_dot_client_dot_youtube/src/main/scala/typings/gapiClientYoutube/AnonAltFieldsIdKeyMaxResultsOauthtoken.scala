...
trait AnonAltFieldsIdKeyMaxResultsOauthtoken extends js.Object {
...
object AnonAltFieldsIdKeyMaxResultsOauthtoken {
  @scala.inline
  def apply(
    part: String,
    alt: String = null,
    ...
    userIp: String = null,
    videoId: String = null
  ): AnonAltFieldsIdKeyMaxResultsOauthtoken = {
    ...
    __obj.asInstanceOf[AnonAltFieldsIdKeyMaxResultsOauthtoken]
  }
}
