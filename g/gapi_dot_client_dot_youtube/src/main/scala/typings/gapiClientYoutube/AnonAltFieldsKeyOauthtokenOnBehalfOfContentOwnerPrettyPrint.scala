...
trait AnonAltFieldsKeyOauthtokenOnBehalfOfContentOwnerPrettyPrint extends js.Object {
...
object AnonAltFieldsKeyOauthtokenOnBehalfOfContentOwnerPrettyPrint {
  @scala.inline
  def apply(
    videoId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenOnBehalfOfContentOwnerPrettyPrint = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenOnBehalfOfContentOwnerPrettyPrint]
  }
}
