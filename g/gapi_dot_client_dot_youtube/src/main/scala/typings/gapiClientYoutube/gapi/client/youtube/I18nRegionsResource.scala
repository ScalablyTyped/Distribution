...
trait I18nRegionsResource extends js.Object {
  ...
  def list(request: AnonAltFieldsHlKey): Request_[I18nRegionListResponse]
}

object I18nRegionsResource {
  @scala.inline
  def apply(list: AnonAltFieldsHlKey => Request_[I18nRegionListResponse]): I18nRegionsResource = {
