...
object VideoCategoryListResponse {
  ...
  @scala.inline
  implicit class VideoCategoryListResponseOps[Self <: VideoCategoryListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: VideoCategory*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[VideoCategory]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
