...
@js.native
trait LiveBroadcastListResponse extends js.Object {
...
object LiveBroadcastListResponse {
  ...
  @scala.inline
  implicit class LiveBroadcastListResponseOps[Self <: LiveBroadcastListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: LiveBroadcast*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[LiveBroadcast]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
