...
trait AnonAltChannelIdFieldsHlId extends js.Object {
...
object AnonAltChannelIdFieldsHlId {
  @scala.inline
  def apply(
    part: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltChannelIdFieldsHlId]
  }
}
