...
trait AnonAltFieldsIdKeyOauthtokenOnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel extends js.Object {
...
object AnonAltFieldsIdKeyOauthtokenOnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel {
  @scala.inline
  def apply(
    id: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltFieldsIdKeyOauthtokenOnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel = {
    ...
    __obj.asInstanceOf[AnonAltFieldsIdKeyOauthtokenOnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel]
  }
}
