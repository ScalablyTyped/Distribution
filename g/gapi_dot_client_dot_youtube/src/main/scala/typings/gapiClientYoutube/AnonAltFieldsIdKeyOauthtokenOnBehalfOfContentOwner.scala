...
trait AnonAltFieldsIdKeyOauthtokenOnBehalfOfContentOwner extends js.Object {
...
object AnonAltFieldsIdKeyOauthtokenOnBehalfOfContentOwner {
  @scala.inline
  def apply(
    id: String,
    part: String,
    ...
    userIp: String = null
  ): AnonAltFieldsIdKeyOauthtokenOnBehalfOfContentOwner = {
    ...
    __obj.asInstanceOf[AnonAltFieldsIdKeyOauthtokenOnBehalfOfContentOwner]
  }
}
