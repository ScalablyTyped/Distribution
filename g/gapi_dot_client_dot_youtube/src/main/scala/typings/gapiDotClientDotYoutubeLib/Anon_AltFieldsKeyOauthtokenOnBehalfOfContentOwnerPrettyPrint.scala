...
trait Anon_AltFieldsKeyOauthtokenOnBehalfOfContentOwnerPrettyPrint extends js.Object {
...
object Anon_AltFieldsKeyOauthtokenOnBehalfOfContentOwnerPrettyPrint {
  @scala.inline
  def apply(
  ...
  ): Anon_AltFieldsKeyOauthtokenOnBehalfOfContentOwnerPrettyPrint = {
    ...
    __obj.asInstanceOf[Anon_AltFieldsKeyOauthtokenOnBehalfOfContentOwnerPrettyPrint]
  }
}
