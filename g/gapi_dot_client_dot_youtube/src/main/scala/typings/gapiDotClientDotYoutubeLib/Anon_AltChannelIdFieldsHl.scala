...
trait Anon_AltChannelIdFieldsHl extends js.Object {
...
object Anon_AltChannelIdFieldsHl {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltChannelIdFieldsHl]
  }
}
