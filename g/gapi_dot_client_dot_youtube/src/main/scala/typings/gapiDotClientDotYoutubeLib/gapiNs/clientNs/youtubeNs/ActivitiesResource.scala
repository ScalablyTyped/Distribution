...
trait ActivitiesResource extends js.Object {
  /**
               ...
               */
  def insert(request: gapiDotClientDotYoutubeLib.Anon_PrettyPrintQuotaUserKeyUserIpOauthtoken): gapiDotClientLib.gapiNs.clientNs.Request[Activity]
  /**
               ...
               */
  def list(request: gapiDotClientDotYoutubeLib.Anon_RegionCodeMine): gapiDotClientLib.gapiNs.clientNs.Request[ActivityListResponse]
}
