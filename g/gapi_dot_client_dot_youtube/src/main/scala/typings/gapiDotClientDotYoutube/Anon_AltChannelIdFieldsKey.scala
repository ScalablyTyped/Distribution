...
trait Anon_AltChannelIdFieldsKey extends js.Object {
...
object Anon_AltChannelIdFieldsKey {
  @scala.inline
  def apply(
    channelId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[Anon_AltChannelIdFieldsKey]
  }
}
