...
trait Anon_AltFieldsKeyOauthtokenOnBehalfOfContentOwner extends js.Object {
...
object Anon_AltFieldsKeyOauthtokenOnBehalfOfContentOwner {
  @scala.inline
  def apply(
    part: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[Anon_AltFieldsKeyOauthtokenOnBehalfOfContentOwner]
  }
}
