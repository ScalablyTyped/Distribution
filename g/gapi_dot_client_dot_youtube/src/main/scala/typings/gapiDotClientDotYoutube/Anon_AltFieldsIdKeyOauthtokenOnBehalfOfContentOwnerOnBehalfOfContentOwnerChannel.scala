...
trait Anon_AltFieldsIdKeyOauthtokenOnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel extends js.Object {
...
object Anon_AltFieldsIdKeyOauthtokenOnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel {
  @scala.inline
  def apply(
    id: String,
    alt: String = null,
    ...
    userIp: String = null
  ): Anon_AltFieldsIdKeyOauthtokenOnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel = {
    ...
    __obj.asInstanceOf[Anon_AltFieldsIdKeyOauthtokenOnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel]
  }
}
