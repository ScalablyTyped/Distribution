...
trait Anon_AltFieldsIdKeyOauthtokenPrettyPrint extends js.Object {
...
object Anon_AltFieldsIdKeyOauthtokenPrettyPrint {
  @scala.inline
  def apply(
    id: String,
    alt: String = null,
    ...
    userIp: String = null
  ): Anon_AltFieldsIdKeyOauthtokenPrettyPrint = {
    ...
    __obj.asInstanceOf[Anon_AltFieldsIdKeyOauthtokenPrettyPrint]
  }
}
