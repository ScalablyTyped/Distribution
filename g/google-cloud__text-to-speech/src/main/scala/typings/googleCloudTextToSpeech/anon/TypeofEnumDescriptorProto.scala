...
import typings.googleGax.iamServiceMod.google.protobuf.EnumDescriptorProto
import typings.googleGax.iamServiceMod.google.protobuf.IEnumDescriptorProto
...
@js.native
trait TypeofEnumDescriptorProto extends StObject {
  
  /** Represents an EnumReservedRange. */
  var EnumReservedRange: (Instantiable0[
    typings.googleGax.mod.IamProtos.google.protobuf.EnumDescriptorProto.EnumReservedRange
  ]) & TypeofEnumReservedRange = js.native
