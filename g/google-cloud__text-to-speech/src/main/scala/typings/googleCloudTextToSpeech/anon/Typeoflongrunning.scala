...
import typings.googleGax.mod.fallback.operationsProtos.google.longrunning.CancelOperationRequest
import typings.googleGax.mod.fallback.operationsProtos.google.longrunning.DeleteOperationRequest
import typings.googleGax.mod.fallback.operationsProtos.google.longrunning.GetOperationRequest
import typings.googleGax.mod.fallback.operationsProtos.google.longrunning.ListOperationsRequest
import typings.googleGax.mod.fallback.operationsProtos.google.longrunning.ListOperationsResponse
import typings.googleGax.mod.fallback.operationsProtos.google.longrunning.Operation
import typings.googleGax.mod.fallback.operationsProtos.google.longrunning.OperationInfo
import typings.googleGax.mod.fallback.operationsProtos.google.longrunning.Operations
import typings.googleGax.mod.fallback.operationsProtos.google.longrunning.WaitOperationRequest
import typings.protobufjs.mod.RPCImpl
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait Typeoflongrunning extends StObject {
  
  /** Represents a CancelOperationRequest. */
  var CancelOperationRequest: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.longrunning.CancelOperationRequest
  ]) & TypeofCancelOperationRequ
  
  /** Represents a DeleteOperationRequest. */
  var DeleteOperationRequest: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.longrunning.DeleteOperationRequest
  ]) & TypeofDeleteOperationRequ
  
  /** Represents a GetOperationRequest. */
  var GetOperationRequest: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.longrunning.GetOperationRequest
  ]) & TypeofGetOperationRequest
  
  /** Represents a ListOperationsRequest. */
  var ListOperationsRequest: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.longrunning.ListOperationsRequest
  ]) & TypeofListOperationsReque
  
  /** Represents a ListOperationsResponse. */
  var ListOperationsResponse: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.longrunning.ListOperationsResponse
  ]) & TypeofListOperationsRespo
  
  /** Represents an Operation. */
  var Operation: Instantiable0[typings.googleGax.mod.fallback.operationsProtos.google.longrunning.Operation] & TypeofOperation
  
  /** Represents an OperationInfo. */
  var OperationInfo: Instantiable0[typings.googleGax.mod.fallback.operationsProtos.google.longrunning.OperationInfo] & TypeofOperationInfo
  
  /** Represents an Operations */
  var Operations: (Instantiable1[
    /* rpcImpl */ RPCImpl, 
    typings.googleGax.mod.fallback.operationsProtos.google.longrunning.Operations
  ]) & TypeofOperations
  
  /** Represents a WaitOperationRequest. */
  var WaitOperationRequest: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.longrunning.WaitOperationRequest
  ]) & TypeofWaitOperationReques
}
object Typeoflongrunning {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Typeoflongrunning]
  }
  
  extension [Self <: Typeoflongrunning](x: Self) {
