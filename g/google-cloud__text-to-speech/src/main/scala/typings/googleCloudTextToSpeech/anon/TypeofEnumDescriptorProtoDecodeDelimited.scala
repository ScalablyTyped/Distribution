...
import typings.googleGax.operationsMod.google.protobuf.EnumDescriptorProto
...
@js.native
trait TypeofEnumDescriptorProtoDecodeDelimited extends StObject {
  
  /** Represents an EnumReservedRange. */
  var EnumReservedRange: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.protobuf.EnumDescriptorProto.EnumReservedRange
  ]) & TypeofEnumReservedRangeDecode = js.native
