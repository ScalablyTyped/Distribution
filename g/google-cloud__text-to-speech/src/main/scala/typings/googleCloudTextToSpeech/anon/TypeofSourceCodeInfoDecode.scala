...
import typings.googleGax.locationsMod.google.protobuf.SourceCodeInfo
...
@js.native
trait TypeofSourceCodeInfoDecode extends StObject {
  
  /** Represents a Location. */
  var Location: (Instantiable0[
    typings.googleGax.mod.fallback.LocationProtos.google.protobuf.SourceCodeInfo.Location
  ]) & TypeofLocationCreate = js.native
