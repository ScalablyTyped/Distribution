...
import typings.googleGax.mod.LocationProtos.google.cloud.location.GetLocationRequest
import typings.googleGax.mod.LocationProtos.google.cloud.location.ListLocationsRequest
import typings.googleGax.mod.LocationProtos.google.cloud.location.ListLocationsResponse
import typings.googleGax.mod.LocationProtos.google.cloud.location.Location
import typings.googleGax.mod.LocationProtos.google.cloud.location.Locations
import typings.protobufjs.mod.RPCImpl
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TypeoflocationGetLocationRequest extends StObject {
  
  /** Represents a GetLocationRequest. */
  var GetLocationRequest: Instantiable0[typings.googleGax.mod.LocationProtos.google.cloud.location.GetLocationRequest] & TypeofGetLocationRequest
  
  /** Represents a ListLocationsRequest. */
  var ListLocationsRequest: Instantiable0[typings.googleGax.mod.LocationProtos.google.cloud.location.ListLocationsRequest] & TypeofListLocationsReques
  
  /** Represents a ListLocationsResponse. */
  var ListLocationsResponse: Instantiable0[typings.googleGax.mod.LocationProtos.google.cloud.location.ListLocationsResponse] & TypeofListLocationsRespon
  
  /** Represents a Location. */
  var Location: Instantiable0[typings.googleGax.mod.LocationProtos.google.cloud.location.Location] & TypeofLocationDecode
  
  /** Represents a Locations */
  var Locations: (Instantiable1[
    /* rpcImpl */ RPCImpl, 
    typings.googleGax.mod.LocationProtos.google.cloud.location.Locations
  ]) & TypeofLocations
}
object TypeoflocationGetLocationRequest {
  ...
  inline def apply(
  ...
  ): TypeoflocationGetLocationRequest = {
    ...
    __obj.asInstanceOf[TypeoflocationGetLocationRequest]
  }
  
  extension [Self <: TypeoflocationGetLocationRequest](x: Self) {
