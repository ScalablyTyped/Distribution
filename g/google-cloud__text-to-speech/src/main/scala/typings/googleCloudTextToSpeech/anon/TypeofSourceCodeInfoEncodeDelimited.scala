...
import typings.googleGax.operationsMod.google.protobuf.ISourceCodeInfo
import typings.googleGax.operationsMod.google.protobuf.SourceCodeInfo
...
@js.native
trait TypeofSourceCodeInfoEncodeDelimited extends StObject {
  
  /** Represents a Location. */
  var Location: Instantiable0[typings.googleGax.mod.operationsProtos.google.protobuf.SourceCodeInfo.Location] & TypeofLocationDecodeDelimited = js.native
