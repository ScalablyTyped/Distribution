...
@js.native
trait TypeofDescriptorProtoDecode extends StObject {
  
  /** Represents an ExtensionRange. */
  var ExtensionRange: (Instantiable0[
    typings.googleGax.mod.fallback.LocationProtos.google.protobuf.DescriptorProto.ExtensionRange
  ]) & TypeofExtensionRangeCreate = js.native
  
  /** Represents a ReservedRange. */
  var ReservedRange: (Instantiable0[
    typings.googleGax.mod.fallback.LocationProtos.google.protobuf.DescriptorProto.ReservedRange
