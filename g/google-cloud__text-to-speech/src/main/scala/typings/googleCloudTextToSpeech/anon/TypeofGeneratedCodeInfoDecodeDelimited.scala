...
import typings.googleGax.locationsMod.google.protobuf.GeneratedCodeInfo
import typings.googleGax.locationsMod.google.protobuf.IGeneratedCodeInfo
...
@js.native
trait TypeofGeneratedCodeInfoDecodeDelimited extends StObject {
  
  /** Represents an Annotation. */
  var Annotation: (Instantiable0[
    typings.googleGax.mod.LocationProtos.google.protobuf.GeneratedCodeInfo.Annotation
  ]) & TypeofAnnotationCreate = js.native
