...
import typings.googleGax.mod.IamProtos.google.iam.v1.AuditConfigDelta
import typings.googleGax.mod.IamProtos.google.iam.v1.Binding
import typings.googleGax.mod.IamProtos.google.iam.v1.BindingDelta
import typings.googleGax.mod.IamProtos.google.iam.v1.GetIamPolicyRequest
import typings.googleGax.mod.IamProtos.google.iam.v1.GetPolicyOptions
import typings.googleGax.mod.IamProtos.google.iam.v1.IAMPolicy
import typings.googleGax.mod.IamProtos.google.iam.v1.Policy
import typings.googleGax.mod.IamProtos.google.iam.v1.PolicyDelta
...
trait Typeofv1 extends StObject {
  ...
  var AuditConfigDelta: Instantiable0[typings.googleGax.mod.IamProtos.google.iam.v1.AuditConfigDelta] & TypeofAuditConfigDelta
  
  /** Represents a Binding. */
  var Binding: Instantiable0[typings.googleGax.mod.IamProtos.google.iam.v1.Binding] & TypeofBinding
  
  /** Represents a BindingDelta. */
  var BindingDelta: Instantiable0[typings.googleGax.mod.IamProtos.google.iam.v1.BindingDelta] & TypeofBindingDelta
  
  /** Represents a GetIamPolicyRequest. */
  var GetIamPolicyRequest: Instantiable0[typings.googleGax.mod.IamProtos.google.iam.v1.GetIamPolicyRequest] & TypeofGetIamPolicyRequest
  
  /** Represents a GetPolicyOptions. */
  var GetPolicyOptions: Instantiable0[typings.googleGax.mod.IamProtos.google.iam.v1.GetPolicyOptions] & TypeofGetPolicyOptions
  
  /** Represents a IAMPolicy */
  var IAMPolicy: (Instantiable1[/* rpcImpl */ RPCImpl, typings.googleGax.mod.IamProtos.google.iam.v1.IAMPolicy]) & TypeofIAMPolicy
  
  /** Represents a Policy. */
  var Policy: Instantiable0[typings.googleGax.mod.IamProtos.google.iam.v1.Policy] & TypeofPolicy
  
  /** Represents a PolicyDelta. */
  var PolicyDelta: Instantiable0[typings.googleGax.mod.IamProtos.google.iam.v1.PolicyDelta] & TypeofPolicyDelta
  
  /** Represents a SetIamPolicyRequest. */
  var SetIamPolicyRequest: Instantiable0[typings.googleGax.mod.IamProtos.google.iam.v1.SetIamPolicyRequest] & TypeofSetIamPolicyRequest
  
  /** Represents a TestIamPermissionsRequest. */
  var TestIamPermissionsRequest: Instantiable0[typings.googleGax.mod.IamProtos.google.iam.v1.TestIamPermissionsRequest] & TypeofTestIamPermissionsR
  
  /** Represents a TestIamPermissionsResponse. */
  var TestIamPermissionsResponse: Instantiable0[typings.googleGax.mod.IamProtos.google.iam.v1.TestIamPermissionsResponse] & TypeofTestIamPermissionsRCreate
  
  /** Namespace logging. */
  val logging: Typeoflogging
}
object Typeofv1 {
  ...
  extension [Self <: Typeofv1](x: Self) {
    ...
    inline def setLogging(value: Typeoflogging): Self = StObject.set(x, "logging", value.asInstanceOf[js.Any])
