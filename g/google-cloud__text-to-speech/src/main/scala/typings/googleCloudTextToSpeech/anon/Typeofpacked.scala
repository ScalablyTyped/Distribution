...
trait Typeofpacked extends StObject {
...
object Typeofpacked {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(bool = bool.asInstanceOf[js.Any], double = double.asInstanceOf[js.Any], fixed32 = fixed32.asInstanceOf[js.Any], fixed64 = fixed64.asInstanceOf[js.Any], float = float.asInstanceOf[js.Any], int32 = int32.asInstanceOf[js.Any], int64 = int64.asInstanceOf[js.Any], sfixed32 = sfixed32.asInstanceOf[js.Any], sfixed64 = sfixed64.asInstanceOf[js.Any], sint32 = sint32.asInstanceOf[js.Any], sint64 = sint64.asInstanceOf[js.Any], uint32 = uint32.asInstanceOf[js.Any], uint64 = uint64.asInstanceOf[js.Any])
