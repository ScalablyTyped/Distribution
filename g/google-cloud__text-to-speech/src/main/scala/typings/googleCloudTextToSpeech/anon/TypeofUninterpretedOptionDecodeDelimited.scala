...
@js.native
trait TypeofUninterpretedOptionDecodeDelimited extends StObject {
  
  /** Represents a NamePart. */
  var NamePart: (Instantiable0[
    typings.googleGax.mod.fallback.operationsProtos.google.protobuf.UninterpretedOption.NamePart
