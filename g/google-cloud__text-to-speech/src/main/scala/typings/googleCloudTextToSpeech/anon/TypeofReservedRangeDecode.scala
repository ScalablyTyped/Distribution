...
import typings.googleGax.operationsMod.google.protobuf.DescriptorProto.ReservedRange
...
@js.native
trait TypeofReservedRangeDecode extends StObject {
  ...
  /**
    ...
    */
  /* static member */
  def fromObject(`object`: StringDictionary[Any]): ReservedRange = js.native
  ...
  /**
    ...
    */
  /* static member */
  def toObject(message: ReservedRange): StringDictionary[Any] = js.native
  def toObject(message: ReservedRange, options: IConversionOptions): StringDictionary[Any] = js.native
