...
@JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.protobuf.SourceCodeInfo")
@js.native
/**
...
object SourceCodeInfo {
  ...
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.protobuf.SourceCodeInfo.Location")
  @js.native
  /**
