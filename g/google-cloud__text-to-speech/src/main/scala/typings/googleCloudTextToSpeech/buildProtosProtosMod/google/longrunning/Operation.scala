...
import typings.googleCloudTextToSpeech.googleCloudTextToSpeechStrings.error
import typings.googleCloudTextToSpeech.googleCloudTextToSpeechStrings.response
...
@JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.longrunning.Operation")
@js.native
/**
