...
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.longrunning.Operations.CancelOperationCallback
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.longrunning.Operations.DeleteOperationCallback
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.longrunning.Operations.GetOperationCallback
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.longrunning.Operations.ListOperationsCallback
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.longrunning.Operations.WaitOperationCallback
...
@JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.longrunning.Operations")
@js.native
