...
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.cloud.texttospeech.v1.TextToSpeechLongAudioSynthesize.SynthesizeLongAudioCallback
...
@JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1.TextToSpeechLongAudioSynthesize")
@js.native
