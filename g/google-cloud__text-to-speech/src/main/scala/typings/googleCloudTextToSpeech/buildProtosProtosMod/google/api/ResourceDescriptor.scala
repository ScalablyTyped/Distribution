...
@JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.api.ResourceDescriptor")
@js.native
/**
...
object ResourceDescriptor {
  ...
  /** History enum. */
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.api.ResourceDescriptor.History")
  @js.native
  object History extends StObject {
    ...
    sealed trait FUTURE_MULTI_PATTERN
      extends StObject
         with typings.googleCloudTextToSpeech.buildProtosProtosMod.google.api.ResourceDescriptor.History
  ...
  /** Style enum. */
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.api.ResourceDescriptor.Style")
  @js.native
