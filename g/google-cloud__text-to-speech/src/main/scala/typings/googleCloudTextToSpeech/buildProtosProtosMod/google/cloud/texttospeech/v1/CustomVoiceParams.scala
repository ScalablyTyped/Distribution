...
@JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1.CustomVoiceParams")
@js.native
/**
...
open class CustomVoiceParams ()
  ...
  var reportedUsage_CustomVoiceParams: ReportedUsage | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.texttospeech.v1.CustomVoiceParams.ReportedUsage * / any */ String) = js.native
...
object CustomVoiceParams {
  ...
  /** ReportedUsage enum. */
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.cloud.texttospeech.v1.CustomVoiceParams.ReportedUsage")
  @js.native
