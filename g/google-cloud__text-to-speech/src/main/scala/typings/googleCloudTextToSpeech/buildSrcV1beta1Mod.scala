...
object buildSrcV1beta1Mod {
  ...
  open class TextToSpeechClient ()
    extends typings.googleCloudTextToSpeech.buildSrcV1beta1TextToSpeechClientMod.TextToSpeechClient {
  ...
  open class TextToSpeechLongAudioSynthesizeClient ()
    extends typings.googleCloudTextToSpeech.buildSrcV1beta1TextToSpeechLongAudioSynthesizeClientMod.TextToSpeechLongAudioSynthesizeClient {
    def this(opts: ClientOptions) = this()
    def this(opts: Unit, gaxInstance: Typeoffallback) = this()
    def this(opts: Unit, gaxInstance: Typeofgax) = this()
    def this(opts: ClientOptions, gaxInstance: Typeoffallback) = this()
