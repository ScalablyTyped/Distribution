...
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto.IEnumReservedRange
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.IEnumDescriptorProto
...
open class EnumDescriptorProto ()
  extends typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto {
...
object EnumDescriptorProto {
  ...
  open class EnumReservedRange ()
    extends typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto.EnumReservedRange {
  ...
  object EnumReservedRange {
    ...
    /**
      ...
      */
    /* static member */
    inline def create(): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto.EnumReservedRange = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto.EnumReservedRange]
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto]
  inline def create(properties: IEnumDescriptorProto): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto]
  ...
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto]
  inline def decode(reader: Reader, length: Double): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.EnumDescriptorProto]
