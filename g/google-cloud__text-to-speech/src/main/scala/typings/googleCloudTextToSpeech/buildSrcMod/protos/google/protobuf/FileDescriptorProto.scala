...
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.IFileDescriptorProto
...
open class FileDescriptorProto ()
  extends typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.FileDescriptorProto {
...
object FileDescriptorProto {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.FileDescriptorProto = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.FileDescriptorProto]
  inline def create(properties: IFileDescriptorProto): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.FileDescriptorProto = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.FileDescriptorProto]
  ...
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.FileDescriptorProto = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.FileDescriptorProto]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.FileDescriptorProto): StringDictionary[scala.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[scala.Any]]
  inline def toObject(
    message: typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.FileDescriptorProto,
