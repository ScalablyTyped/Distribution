package typings.googleCloudTextToSpeech.buildSrcMod
...
object v1beta1 {
  ...
  open class TextToSpeechClient ()
    extends typings.googleCloudTextToSpeech.buildSrcV1beta1Mod.TextToSpeechClient {
  ...
  @JSImport("@google-cloud/text-to-speech/build/src", "v1beta1.TextToSpeechLongAudioSynthesizeClient")
  @js.native
  /**
    ...
    *     ```
    */
  open class TextToSpeechLongAudioSynthesizeClient ()
    extends typings.googleCloudTextToSpeech.buildSrcV1beta1Mod.TextToSpeechLongAudioSynthesizeClient {
    def this(opts: ClientOptions) = this()
    def this(opts: Unit, gaxInstance: Typeoffallback) = this()
    def this(opts: Unit, gaxInstance: Typeofgax) = this()
    def this(opts: ClientOptions, gaxInstance: Typeoffallback) = this()
