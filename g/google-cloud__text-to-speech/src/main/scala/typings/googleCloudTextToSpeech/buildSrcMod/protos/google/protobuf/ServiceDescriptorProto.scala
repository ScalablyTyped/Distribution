...
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.IServiceDescriptorProto
...
open class ServiceDescriptorProto ()
  extends typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.ServiceDescriptorProto {
...
object ServiceDescriptorProto {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.ServiceDescriptorProto = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.ServiceDescriptorProto]
  inline def create(properties: IServiceDescriptorProto): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.ServiceDescriptorProto = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.ServiceDescriptorProto]
  ...
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.ServiceDescriptorProto = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.ServiceDescriptorProto]
  ...
  /* static member */
  inline def toObject(
    message: typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.ServiceDescriptorProto
