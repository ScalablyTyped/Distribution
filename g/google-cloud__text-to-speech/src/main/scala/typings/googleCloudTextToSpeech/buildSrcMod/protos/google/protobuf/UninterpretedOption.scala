...
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.IUninterpretedOption
...
open class UninterpretedOption ()
  extends typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption {
...
object UninterpretedOption {
  ...
  /**
    ...
    */
  open class NamePart ()
    extends typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption.NamePart {
  ...
  object NamePart {
    ...
    /**
      ...
      */
    /* static member */
    inline def create(): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption.NamePart = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption.NamePart]
    inline def create(properties: INamePart): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption.NamePart = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption.NamePart]
    ...
    /* static member */
    inline def toObject(
      message: typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption.NamePart
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption]
  inline def create(properties: IUninterpretedOption): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption]
  ...
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption]
  inline def decode(reader: Reader, length: Double): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption): StringDictionary[scala.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[scala.Any]]
  inline def toObject(
    message: typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.UninterpretedOption,
    options: IConversionOptions
  ): StringDictionary[scala.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[scala.Any]]
