...
import typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.IGeneratedCodeInfo
...
open class GeneratedCodeInfo ()
  extends typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo {
...
object GeneratedCodeInfo {
  ...
  open class Annotation ()
    extends typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo.Annotation {
  ...
  object Annotation {
    ...
    object Semantic extends StObject {
      ...
      def apply(value: Double): js.UndefOr[
            typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo.Annotation.Semantic & Double
          ] = js.native
    ...
    /**
      ...
      */
    /* static member */
    inline def create(): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo.Annotation = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo.Annotation]
    inline def create(properties: IAnnotation): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo.Annotation = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo.Annotation]
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo]
  inline def create(properties: IGeneratedCodeInfo): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo]
  ...
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo]
  inline def decode(reader: Reader, length: Double): typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[typings.googleCloudTextToSpeech.buildProtosProtosMod.google.protobuf.GeneratedCodeInfo]
