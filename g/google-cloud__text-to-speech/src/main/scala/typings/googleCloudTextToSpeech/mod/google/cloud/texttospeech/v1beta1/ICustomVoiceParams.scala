...
trait ICustomVoiceParams extends StObject {
  ...
  var reportedUsage: js.UndefOr[
    ReportedUsage | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.texttospeech.v1beta1.CustomVoiceParams.ReportedUsage * / any */ String) | Null
  ] = js.undefined
}
object ICustomVoiceParams {
  ...
  extension [Self <: ICustomVoiceParams](x: Self) {
    ...
    inline def setReportedUsage(
      value: ReportedUsage | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof google.cloud.texttospeech.v1beta1.CustomVoiceParams.ReportedUsage * / any */ String)
