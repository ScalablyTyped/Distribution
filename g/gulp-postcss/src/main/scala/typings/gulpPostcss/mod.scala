...
object mod {
  ...
  inline def apply(plugins: js.Array[js.Any]): ReadWriteStream = ^.asInstanceOf[js.Dynamic].apply(plugins.asInstanceOf[js.Any]).asInstanceOf[ReadWriteStream]
  inline def apply(plugins: js.Array[js.Any], options: Options): ReadWriteStream = (^.asInstanceOf[js.Dynamic].apply(plugins.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ReadWriteStream]
