...
trait Search extends js.Object {
  ...
  var spelling: js.UndefOr[gapiDotClientDotCustomsearchLib.Anon_HtmlCorrectedQuery] = js.undefined
  var url: js.UndefOr[gapiDotClientDotCustomsearchLib.Anon_Type] = js.undefined
}
