...
object ^ extends js.Object {
  val diff: js.Function1[/* dest */ js.UndefOr[java.lang.String], nodeLib.streamMod.Transform] = js.native
  /**
  ...
  def reporter(opts: ReporterOptions): nodeLib.streamMod.Transform = js.native
}
