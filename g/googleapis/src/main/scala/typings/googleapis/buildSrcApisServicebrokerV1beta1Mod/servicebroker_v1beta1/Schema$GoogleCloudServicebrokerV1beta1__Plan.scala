...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudServicebrokerV1beta1__Plan extends js.Object {
  /**
...
object Schema$GoogleCloudServicebrokerV1beta1__Plan {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleCloudServicebrokerV1beta1__Plan = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudServicebrokerV1beta1__Plan]
  }
}
