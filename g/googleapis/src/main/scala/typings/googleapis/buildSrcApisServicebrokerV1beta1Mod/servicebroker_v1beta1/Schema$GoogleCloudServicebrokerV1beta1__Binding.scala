...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudServicebrokerV1beta1__Binding extends js.Object {
  /**
...
object Schema$GoogleCloudServicebrokerV1beta1__Binding {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleCloudServicebrokerV1beta1__Binding = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudServicebrokerV1beta1__Binding]
  }
}
