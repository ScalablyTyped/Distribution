...
object ParamsResourceServicesTenancyunitsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceServicesTenancyunitsCreateOps[Self <: ParamsResourceServicesTenancyunitsCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreateTenancyUnitRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
