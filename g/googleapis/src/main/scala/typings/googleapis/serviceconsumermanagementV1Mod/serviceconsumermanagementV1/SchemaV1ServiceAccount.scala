...
trait SchemaV1ServiceAccount extends StObject {
...
object SchemaV1ServiceAccount {
  
  inline def apply(): SchemaV1ServiceAccount = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaV1ServiceAccount]
  }
  
  extension [Self <: SchemaV1ServiceAccount](x: Self) {
