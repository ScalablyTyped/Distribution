...
trait SchemaV1Beta1ProducerQuotaPolicy extends StObject {
...
object SchemaV1Beta1ProducerQuotaPolicy {
  
  inline def apply(): SchemaV1Beta1ProducerQuotaPolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaV1Beta1ProducerQuotaPolicy]
  }
  
  extension [Self <: SchemaV1Beta1ProducerQuotaPolicy](x: Self) {
