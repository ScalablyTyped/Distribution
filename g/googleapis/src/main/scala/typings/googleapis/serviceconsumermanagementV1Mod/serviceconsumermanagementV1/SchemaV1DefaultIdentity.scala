...
trait SchemaV1DefaultIdentity extends StObject {
...
object SchemaV1DefaultIdentity {
  
  inline def apply(): SchemaV1DefaultIdentity = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaV1DefaultIdentity]
  }
  
  extension [Self <: SchemaV1DefaultIdentity](x: Self) {
