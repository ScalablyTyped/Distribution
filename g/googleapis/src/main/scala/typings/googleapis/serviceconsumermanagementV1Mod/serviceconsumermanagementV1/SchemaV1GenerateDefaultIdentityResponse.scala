...
trait SchemaV1GenerateDefaultIdentityResponse extends StObject {
  ...
  /**
    ...
    */
  var identity: js.UndefOr[SchemaV1DefaultIdentity] = js.undefined
...
object SchemaV1GenerateDefaultIdentityResponse {
  
  inline def apply(): SchemaV1GenerateDefaultIdentityResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaV1GenerateDefaultIdentityResponse]
  }
  
  extension [Self <: SchemaV1GenerateDefaultIdentityResponse](x: Self) {
    ...
    inline def setIdentity(value: SchemaV1DefaultIdentity): Self = StObject.set(x, "identity", value.asInstanceOf[js.Any])
