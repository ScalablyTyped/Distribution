...
@js.native
trait ParamsDollarResourceDollarCreativesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCreativesDollarGet {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCreativesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCreativesDollarGet]
  }
}
