...
trait ParamsResourceUsersInsert
  extends StObject
...
object ParamsResourceUsersInsert {
  
  inline def apply(): ParamsResourceUsersInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersInsert]
  }
  
  extension [Self <: ParamsResourceUsersInsert](x: Self) {
