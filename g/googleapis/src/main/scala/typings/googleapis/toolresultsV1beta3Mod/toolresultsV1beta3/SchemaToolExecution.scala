...
trait SchemaToolExecution extends StObject {
  ...
  /**
    ...
    */
  var commandLineArguments: js.UndefOr[js.Array[String] | Null] = js.undefined
...
object SchemaToolExecution {
  ...
  extension [Self <: SchemaToolExecution](x: Self) {
    ...
    inline def setCommandLineArgumentsNull: Self = StObject.set(x, "commandLineArguments", null)
    ...
    inline def setToolLogsVarargs(value: SchemaFileReference*): Self = StObject.set(x, "toolLogs", js.Array(value*))
