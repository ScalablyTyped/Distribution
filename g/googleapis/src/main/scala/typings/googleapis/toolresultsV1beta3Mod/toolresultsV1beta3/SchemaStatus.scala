...
object SchemaStatus {
  ...
  extension [Self <: SchemaStatus](x: Self) {
    ...
    inline def setDetails(value: js.Array[SchemaAny]): Self = StObject.set(x, "details", value.asInstanceOf[js.Any])
    
    inline def setDetailsUndefined: Self = StObject.set(x, "details", js.undefined)
    
    inline def setDetailsVarargs(value: SchemaAny*): Self = StObject.set(x, "details", js.Array(value :_*))
