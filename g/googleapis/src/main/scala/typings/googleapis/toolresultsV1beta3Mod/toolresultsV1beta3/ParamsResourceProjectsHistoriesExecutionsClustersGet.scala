...
object ParamsResourceProjectsHistoriesExecutionsClustersGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesExecutionsClustersGetMutableBuilder[Self <: ParamsResourceProjectsHistoriesExecutionsClustersGet] (val x: Self) extends AnyVal {
