...
object ParamsResourceProjectsHistoriesExecutionsPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsHistoriesExecutionsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsHistoriesExecutionsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesExecutionsPatchMutableBuilder[Self <: ParamsResourceProjectsHistoriesExecutionsPatch] (val x: Self) extends AnyVal {
