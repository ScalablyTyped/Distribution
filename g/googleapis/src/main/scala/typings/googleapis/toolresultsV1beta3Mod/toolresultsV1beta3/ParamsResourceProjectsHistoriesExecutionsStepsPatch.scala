...
@js.native
trait ParamsResourceProjectsHistoriesExecutionsStepsPatch extends StandardParameters {
...
object ParamsResourceProjectsHistoriesExecutionsStepsPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsHistoriesExecutionsStepsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsHistoriesExecutionsStepsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesExecutionsStepsPatchMutableBuilder[Self <: ParamsResourceProjectsHistoriesExecutionsStepsPatch] (val x: Self) extends AnyVal {
