...
object ParamsResourceProjectsHistoriesExecutionsStepsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesExecutionsStepsListOps[Self <: ParamsResourceProjectsHistoriesExecutionsStepsList] (val x: Self) extends AnyVal {
