...
object ParamsResourceProjectsHistoriesExecutionsStepsThumbnailsList {
  ...
  inline def apply(): ParamsResourceProjectsHistoriesExecutionsStepsThumbnailsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsHistoriesExecutionsStepsThumbnailsList]
  }
  
  extension [Self <: ParamsResourceProjectsHistoriesExecutionsStepsThumbnailsList](x: Self) {
