...
@js.native
trait ParamsResourceProjectsHistoriesExecutionsStepsPerfsampleseriesCreate extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaPerfSampleSeries] = js.native
...
object ParamsResourceProjectsHistoriesExecutionsStepsPerfsampleseriesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsHistoriesExecutionsStepsPerfsampleseriesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsHistoriesExecutionsStepsPerfsampleseriesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesExecutionsStepsPerfsampleseriesCreateMutableBuilder[Self <: ParamsResourceProjectsHistoriesExecutionsStepsPerfsampleseriesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaPerfSampleSeries): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
