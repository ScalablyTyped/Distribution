...
object ParamsResourceProjectsHistoriesExecutionsStepsPerfsampleseriesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesExecutionsStepsPerfsampleseriesCreateOps[Self <: ParamsResourceProjectsHistoriesExecutionsStepsPerfsampleseriesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaPerfSampleSeries): Self = this.set("requestBody", value.asInstanceOf[js.Any])
