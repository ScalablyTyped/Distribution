...
trait ParamsResourceProjectsHistoriesExecutionsStepsGetperfmetricssummary
  extends StObject
...
object ParamsResourceProjectsHistoriesExecutionsStepsGetperfmetricssummary {
  ...
  inline def apply(): ParamsResourceProjectsHistoriesExecutionsStepsGetperfmetricssummary = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsHistoriesExecutionsStepsGetperfmetricssummary]
  }
  
  extension [Self <: ParamsResourceProjectsHistoriesExecutionsStepsGetperfmetricssummary](x: Self) {
