...
object ParamsResourceProjectsHistoriesExecutionsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsHistoriesExecutionsCreateOps[Self <: ParamsResourceProjectsHistoriesExecutionsCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaExecution): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
