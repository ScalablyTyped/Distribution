...
@js.native
trait AnonActivityFiltersConversionDimensionsCustomFloodlightVariables extends js.Object {
...
object AnonActivityFiltersConversionDimensionsCustomFloodlightVariables {
  @scala.inline
  def apply(
  ...
  ): AnonActivityFiltersConversionDimensionsCustomFloodlightVariables = {
    ...
    __obj.asInstanceOf[AnonActivityFiltersConversionDimensionsCustomFloodlightVariables]
  }
}
