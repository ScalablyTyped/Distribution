...
trait SchemaGoogleCloudDatalabelingV1beta1HumanAnnotationConfig extends StObject {
...
object SchemaGoogleCloudDatalabelingV1beta1HumanAnnotationConfig {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1beta1HumanAnnotationConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1beta1HumanAnnotationConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1beta1HumanAnnotationConfig](x: Self) {
