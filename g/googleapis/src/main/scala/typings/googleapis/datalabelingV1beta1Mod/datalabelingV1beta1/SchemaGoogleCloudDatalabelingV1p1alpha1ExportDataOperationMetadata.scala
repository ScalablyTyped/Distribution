...
trait SchemaGoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata extends StObject {
...
object SchemaGoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1p1alpha1ExportDataOperationMetadata](x: Self) {
