...
trait SchemaGoogleCloudDatalabelingV1beta1VideoClassificationAnnotation extends StObject {
...
object SchemaGoogleCloudDatalabelingV1beta1VideoClassificationAnnotation {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1beta1VideoClassificationAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1beta1VideoClassificationAnnotation]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1beta1VideoClassificationAnnotation](x: Self) {
