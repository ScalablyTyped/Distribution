...
@JSImport("googleapis/build/src/apis/datalabeling/v1beta1", "datalabeling_v1beta1.Resource$Projects$Datasets$Dataitems")
@js.native
open class ResourceProjectsDatasetsDataitems protected () extends StObject {
  ...
  def get(params: ParamsResourceProjectsDatasetsDataitemsGet): GaxiosPromise[SchemaGoogleCloudDatalabelingV1beta1DataItem] = js.native
  def get(
    params: ParamsResourceProjectsDatasetsDataitemsGet,
  ...
  def get(params: ParamsResourceProjectsDatasetsDataitemsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDatalabelingV1beta1DataItem] = js.native
  def get(
    params: ParamsResourceProjectsDatasetsDataitemsGet,
  ...
  /**
    ...
    */
  def get(params: ParamsResourceProjectsDatasetsDataitemsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceProjectsDatasetsDataitemsGet,
  ...
  def list(params: ParamsResourceProjectsDatasetsDataitemsList): GaxiosPromise[SchemaGoogleCloudDatalabelingV1beta1ListDataItemsResponse] = js.native
  def list(
    params: ParamsResourceProjectsDatasetsDataitemsList,
  ...
  def list(params: ParamsResourceProjectsDatasetsDataitemsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDatalabelingV1beta1ListDataItemsResponse] = js.native
  def list(
    params: ParamsResourceProjectsDatasetsDataitemsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDatalabelingV1beta1ListDataItemsResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceProjectsDatasetsDataitemsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsDatasetsDataitemsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
