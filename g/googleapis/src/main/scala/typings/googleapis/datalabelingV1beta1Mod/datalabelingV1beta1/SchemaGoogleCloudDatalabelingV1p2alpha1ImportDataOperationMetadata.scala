...
trait SchemaGoogleCloudDatalabelingV1p2alpha1ImportDataOperationMetadata extends StObject {
...
object SchemaGoogleCloudDatalabelingV1p2alpha1ImportDataOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1p2alpha1ImportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1p2alpha1ImportDataOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1p2alpha1ImportDataOperationMetadata](x: Self) {
