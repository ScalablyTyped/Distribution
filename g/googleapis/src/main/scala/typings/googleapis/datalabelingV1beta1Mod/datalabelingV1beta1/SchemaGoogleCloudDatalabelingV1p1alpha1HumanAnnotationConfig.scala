...
trait SchemaGoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig extends StObject {
  
  /**
    * Optional. A human-readable description for AnnotatedDataset. The description can be up to 10000 characters long.
    */
  var annotatedDatasetDescription: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Required. A human-readable name for AnnotatedDataset defined by users. Maximum of 64 characters .
    */
  var annotatedDatasetDisplayName: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Optional. If you want your own labeling contributors to manage and work on this labeling request, you can set these contributors here. We will give them access to the question types in crowdcompute. Note that these emails must be registered in crowdcompute worker UI: https://crowd-compute.appspot.com/
    */
  var contributorEmails: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var labelGroup: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var questionDuration: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Optional. Replication of questions. Each question will be sent to up to this number of contributors to label. Aggregated answers will be returned. Default is set to 1. For image related labeling, valid values are 1, 3, 5.
    */
  var replicaCount: js.UndefOr[Double | Null] = js.undefined
...
object SchemaGoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig](x: Self) {
    ...
    inline def setAnnotatedDatasetDescriptionNull: Self = StObject.set(x, "annotatedDatasetDescription", null)
    ...
    inline def setAnnotatedDatasetDisplayNameNull: Self = StObject.set(x, "annotatedDatasetDisplayName", null)
    ...
    inline def setContributorEmailsNull: Self = StObject.set(x, "contributorEmails", null)
    ...
    inline def setLabelGroupNull: Self = StObject.set(x, "labelGroup", null)
    ...
    inline def setQuestionDurationNull: Self = StObject.set(x, "questionDuration", null)
    ...
    inline def setReplicaCountNull: Self = StObject.set(x, "replicaCount", null)
