...
trait SchemaGoogleCloudDatalabelingV1p1alpha1GcsDestination extends StObject {
...
object SchemaGoogleCloudDatalabelingV1p1alpha1GcsDestination {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1p1alpha1GcsDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1p1alpha1GcsDestination]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1p1alpha1GcsDestination](x: Self) {
