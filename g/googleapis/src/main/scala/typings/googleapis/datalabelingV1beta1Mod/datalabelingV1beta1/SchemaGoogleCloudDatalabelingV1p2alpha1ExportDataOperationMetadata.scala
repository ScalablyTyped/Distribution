...
trait SchemaGoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata extends StObject {
...
object SchemaGoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1p2alpha1ExportDataOperationMetadata](x: Self) {
