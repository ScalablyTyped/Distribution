...
trait SchemaGoogleCloudDatalabelingV1beta1ImportDataOperationMetadata extends StObject {
...
object SchemaGoogleCloudDatalabelingV1beta1ImportDataOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1beta1ImportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1beta1ImportDataOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1beta1ImportDataOperationMetadata](x: Self) {
