...
trait SchemaGoogleCloudDatalabelingV1beta1NormalizedBoundingPoly extends StObject {
...
object SchemaGoogleCloudDatalabelingV1beta1NormalizedBoundingPoly {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1beta1NormalizedBoundingPoly = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1beta1NormalizedBoundingPoly]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1beta1NormalizedBoundingPoly](x: Self) {
