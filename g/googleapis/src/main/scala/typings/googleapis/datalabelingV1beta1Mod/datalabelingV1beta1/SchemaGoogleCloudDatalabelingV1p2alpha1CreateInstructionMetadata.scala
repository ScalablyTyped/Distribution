...
trait SchemaGoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata extends StObject {
...
object SchemaGoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1p2alpha1CreateInstructionMetadata](x: Self) {
