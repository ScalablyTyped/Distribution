...
trait SchemaGoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig extends StObject {
...
object SchemaGoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1p2alpha1HumanAnnotationConfig](x: Self) {
