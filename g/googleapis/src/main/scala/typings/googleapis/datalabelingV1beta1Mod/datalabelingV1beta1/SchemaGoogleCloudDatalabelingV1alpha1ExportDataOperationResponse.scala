...
trait SchemaGoogleCloudDatalabelingV1alpha1ExportDataOperationResponse extends StObject {
  ...
  /**
    ...
    */
  var labelStats: js.UndefOr[SchemaGoogleCloudDatalabelingV1alpha1LabelStats] = js.undefined
  
  /**
    * Output only. output_config in the ExportData request.
    */
  var outputConfig: js.UndefOr[SchemaGoogleCloudDatalabelingV1alpha1OutputConfig] = js.undefined
...
object SchemaGoogleCloudDatalabelingV1alpha1ExportDataOperationResponse {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1alpha1ExportDataOperationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1alpha1ExportDataOperationResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1alpha1ExportDataOperationResponse](x: Self) {
    ...
    inline def setLabelStats(value: SchemaGoogleCloudDatalabelingV1alpha1LabelStats): Self = StObject.set(x, "labelStats", value.asInstanceOf[js.Any])
    
    inline def setLabelStatsUndefined: Self = StObject.set(x, "labelStats", js.undefined)
    
    inline def setOutputConfig(value: SchemaGoogleCloudDatalabelingV1alpha1OutputConfig): Self = StObject.set(x, "outputConfig", value.asInstanceOf[js.Any])
