...
trait SchemaGoogleCloudDatalabelingV1beta1ExportDataOperationMetadata extends StObject {
...
object SchemaGoogleCloudDatalabelingV1beta1ExportDataOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1beta1ExportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1beta1ExportDataOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1beta1ExportDataOperationMetadata](x: Self) {
