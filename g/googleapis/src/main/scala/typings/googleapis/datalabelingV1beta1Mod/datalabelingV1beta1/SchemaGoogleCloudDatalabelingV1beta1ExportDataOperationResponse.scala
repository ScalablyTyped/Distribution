...
trait SchemaGoogleCloudDatalabelingV1beta1ExportDataOperationResponse extends StObject {
...
object SchemaGoogleCloudDatalabelingV1beta1ExportDataOperationResponse {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1beta1ExportDataOperationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1beta1ExportDataOperationResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1beta1ExportDataOperationResponse](x: Self) {
