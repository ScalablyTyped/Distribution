...
trait SchemaGoogleCloudDatalabelingV1alpha1ImportDataOperationResponse extends StObject {
...
object SchemaGoogleCloudDatalabelingV1alpha1ImportDataOperationResponse {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1alpha1ImportDataOperationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1alpha1ImportDataOperationResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1alpha1ImportDataOperationResponse](x: Self) {
