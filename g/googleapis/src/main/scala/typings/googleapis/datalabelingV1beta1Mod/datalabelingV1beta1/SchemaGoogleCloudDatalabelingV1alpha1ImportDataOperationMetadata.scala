...
trait SchemaGoogleCloudDatalabelingV1alpha1ImportDataOperationMetadata extends StObject {
...
object SchemaGoogleCloudDatalabelingV1alpha1ImportDataOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1alpha1ImportDataOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1alpha1ImportDataOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1alpha1ImportDataOperationMetadata](x: Self) {
