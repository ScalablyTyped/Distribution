...
trait ParamsResourceProjectsDatasetsDataitemsList
  extends StObject
...
object ParamsResourceProjectsDatasetsDataitemsList {
  
  inline def apply(): ParamsResourceProjectsDatasetsDataitemsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsDatasetsDataitemsList]
  }
  
  extension [Self <: ParamsResourceProjectsDatasetsDataitemsList](x: Self) {
