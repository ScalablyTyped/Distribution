...
trait ParamsResourceProjectsDatasetsList
  extends StObject
...
object ParamsResourceProjectsDatasetsList {
  
  inline def apply(): ParamsResourceProjectsDatasetsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsDatasetsList]
  }
  
  extension [Self <: ParamsResourceProjectsDatasetsList](x: Self) {
