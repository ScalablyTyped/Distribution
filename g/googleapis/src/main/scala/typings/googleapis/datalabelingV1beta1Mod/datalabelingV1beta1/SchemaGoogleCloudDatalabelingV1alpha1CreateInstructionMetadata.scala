...
trait SchemaGoogleCloudDatalabelingV1alpha1CreateInstructionMetadata extends StObject {
...
object SchemaGoogleCloudDatalabelingV1alpha1CreateInstructionMetadata {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1alpha1CreateInstructionMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1alpha1CreateInstructionMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1alpha1CreateInstructionMetadata](x: Self) {
