...
trait SchemaGoogleCloudDatalabelingV1beta1CreateInstructionMetadata extends StObject {
...
object SchemaGoogleCloudDatalabelingV1beta1CreateInstructionMetadata {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1beta1CreateInstructionMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1beta1CreateInstructionMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1beta1CreateInstructionMetadata](x: Self) {
