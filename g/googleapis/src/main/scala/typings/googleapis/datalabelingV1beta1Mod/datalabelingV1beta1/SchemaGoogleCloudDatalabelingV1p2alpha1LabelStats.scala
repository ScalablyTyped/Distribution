...
trait SchemaGoogleCloudDatalabelingV1p2alpha1LabelStats extends StObject {
...
object SchemaGoogleCloudDatalabelingV1p2alpha1LabelStats {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1p2alpha1LabelStats = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1p2alpha1LabelStats]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1p2alpha1LabelStats](x: Self) {
