...
trait SchemaGoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse extends StObject {
...
object SchemaGoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1p2alpha1ImportDataOperationResponse](x: Self) {
