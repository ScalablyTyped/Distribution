...
trait ParamsResourceProjectsAnnotationspecsetsList
  extends StObject
...
object ParamsResourceProjectsAnnotationspecsetsList {
  
  inline def apply(): ParamsResourceProjectsAnnotationspecsetsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAnnotationspecsetsList]
  }
  
  extension [Self <: ParamsResourceProjectsAnnotationspecsetsList](x: Self) {
