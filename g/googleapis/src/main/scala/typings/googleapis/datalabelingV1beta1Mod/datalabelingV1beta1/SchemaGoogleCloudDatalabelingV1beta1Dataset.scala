...
trait SchemaGoogleCloudDatalabelingV1beta1Dataset extends StObject {
  ...
  /**
    ...
    */
  var dataItemCount: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var inputConfigs: js.UndefOr[js.Array[SchemaGoogleCloudDatalabelingV1beta1InputConfig]] = js.undefined
  
  /**
    * Last time that the Dataset is migrated to AI Platform V2. If any of the AnnotatedDataset is migrated, the last_migration_time in Dataset is also updated.
    */
  var lastMigrateTime: js.UndefOr[String | Null] = js.undefined
...
object SchemaGoogleCloudDatalabelingV1beta1Dataset {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1beta1Dataset = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1beta1Dataset]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1beta1Dataset](x: Self) {
    ...
    inline def setDataItemCountNull: Self = StObject.set(x, "dataItemCount", null)
    ...
    inline def setInputConfigs(value: js.Array[SchemaGoogleCloudDatalabelingV1beta1InputConfig]): Self = StObject.set(x, "inputConfigs", value.asInstanceOf[js.Any])
    
    inline def setInputConfigsUndefined: Self = StObject.set(x, "inputConfigs", js.undefined)
    
    inline def setInputConfigsVarargs(value: SchemaGoogleCloudDatalabelingV1beta1InputConfig*): Self = StObject.set(x, "inputConfigs", js.Array(value*))
    
    inline def setLastMigrateTime(value: String): Self = StObject.set(x, "lastMigrateTime", value.asInstanceOf[js.Any])
    
    inline def setLastMigrateTimeNull: Self = StObject.set(x, "lastMigrateTime", null)
