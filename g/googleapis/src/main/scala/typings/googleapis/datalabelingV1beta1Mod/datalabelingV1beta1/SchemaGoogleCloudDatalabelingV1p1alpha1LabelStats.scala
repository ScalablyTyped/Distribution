...
trait SchemaGoogleCloudDatalabelingV1p1alpha1LabelStats extends StObject {
...
object SchemaGoogleCloudDatalabelingV1p1alpha1LabelStats {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1p1alpha1LabelStats = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1p1alpha1LabelStats]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1p1alpha1LabelStats](x: Self) {
