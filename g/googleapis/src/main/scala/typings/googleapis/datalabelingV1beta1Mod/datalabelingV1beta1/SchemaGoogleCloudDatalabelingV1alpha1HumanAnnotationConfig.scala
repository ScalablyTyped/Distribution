...
trait SchemaGoogleCloudDatalabelingV1alpha1HumanAnnotationConfig extends StObject {
...
object SchemaGoogleCloudDatalabelingV1alpha1HumanAnnotationConfig {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1alpha1HumanAnnotationConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1alpha1HumanAnnotationConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1alpha1HumanAnnotationConfig](x: Self) {
