...
trait SchemaGoogleCloudDatalabelingV1beta1LabelStats extends StObject {
...
object SchemaGoogleCloudDatalabelingV1beta1LabelStats {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1beta1LabelStats = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1beta1LabelStats]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1beta1LabelStats](x: Self) {
