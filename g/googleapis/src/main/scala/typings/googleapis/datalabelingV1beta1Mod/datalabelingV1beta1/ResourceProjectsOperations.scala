...
@JSImport("googleapis/build/src/apis/datalabeling/v1beta1", "datalabeling_v1beta1.Resource$Projects$Operations")
@js.native
open class ResourceProjectsOperations protected () extends StObject {
  ...
  def delete(params: ParamsResourceProjectsOperationsDelete): GaxiosPromise[SchemaGoogleProtobufEmpty] = js.native
  def delete(
  ...
  def delete(params: ParamsResourceProjectsOperationsDelete, options: MethodOptions): GaxiosPromise[SchemaGoogleProtobufEmpty] = js.native
  def delete(
    params: ParamsResourceProjectsOperationsDelete,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleProtobufEmpty]
