...
trait SchemaGoogleCloudDatalabelingV1alpha1GcsDestination extends StObject {
...
object SchemaGoogleCloudDatalabelingV1alpha1GcsDestination {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1alpha1GcsDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1alpha1GcsDestination]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1alpha1GcsDestination](x: Self) {
