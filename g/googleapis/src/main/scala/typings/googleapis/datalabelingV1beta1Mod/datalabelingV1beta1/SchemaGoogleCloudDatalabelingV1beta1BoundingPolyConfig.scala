...
trait SchemaGoogleCloudDatalabelingV1beta1BoundingPolyConfig extends StObject {
...
object SchemaGoogleCloudDatalabelingV1beta1BoundingPolyConfig {
  
  inline def apply(): SchemaGoogleCloudDatalabelingV1beta1BoundingPolyConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatalabelingV1beta1BoundingPolyConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDatalabelingV1beta1BoundingPolyConfig](x: Self) {
