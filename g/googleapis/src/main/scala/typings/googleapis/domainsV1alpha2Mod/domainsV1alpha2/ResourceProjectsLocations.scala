...
@JSImport("googleapis/build/src/apis/domains/v1alpha2", "domains_v1alpha2.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var registrations: ResourceProjectsLocationsRegistrations = js.native
}
