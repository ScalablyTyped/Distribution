...
@js.native
class Resource$Translations protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$TranslationsListResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$TranslationsListResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarTranslationsDollarList): GaxiosPromise[Schema$TranslationsListResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarTranslationsDollarList,
    callback: BodyResponseCallback[Schema$TranslationsListResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarTranslationsDollarList,
    options: BodyResponseCallback[Schema$TranslationsListResponse],
    callback: BodyResponseCallback[Schema$TranslationsListResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarTranslationsDollarList, options: MethodOptions): GaxiosPromise[Schema$TranslationsListResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarTranslationsDollarList,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def translate(): GaxiosPromise[Schema$TranslationsListResponse] = js.native
  def translate(callback: BodyResponseCallback[Schema$TranslationsListResponse]): Unit = js.native
  def translate(params: ParamsDollarResourceDollarTranslationsDollarTranslate): GaxiosPromise[Schema$TranslationsListResponse] = js.native
  def translate(
    params: ParamsDollarResourceDollarTranslationsDollarTranslate,
    callback: BodyResponseCallback[Schema$TranslationsListResponse]
  ): Unit = js.native
  def translate(
    params: ParamsDollarResourceDollarTranslationsDollarTranslate,
  ...
  def translate(params: ParamsDollarResourceDollarTranslationsDollarTranslate, options: MethodOptions): GaxiosPromise[Schema$TranslationsListResponse] = js.native
  def translate(
    params: ParamsDollarResourceDollarTranslationsDollarTranslate,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$TranslationsListResponse]
