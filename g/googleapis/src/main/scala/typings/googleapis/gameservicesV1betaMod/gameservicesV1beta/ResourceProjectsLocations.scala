...
@JSImport("googleapis/build/src/apis/gameservices/v1beta", "gameservices_v1beta.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var gameServerDeployments: ResourceProjectsLocationsGameserverdeployments = js.native
