...
@js.native
trait ParamsDollarResourceDollarSslcertsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSslcertsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSslcertsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSslcertsDollarDelete]
  }
}
