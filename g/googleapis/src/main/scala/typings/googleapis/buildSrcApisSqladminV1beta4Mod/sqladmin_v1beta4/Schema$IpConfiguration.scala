...
/**
  ...
  */
@js.native
trait Schema$IpConfiguration extends js.Object {
  /**
    * The list of external networks that are allowed to connect to the instance
    * using the IP. In CIDR notation, also known as &#39;slash&#39; notation
    * (e.g. 192.168.100.0/24).
    */
  var authorizedNetworks: js.UndefOr[js.Array[Schema$AclEntry]] = js.native
  /**
...
object Schema$IpConfiguration {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$IpConfiguration]
  }
}
