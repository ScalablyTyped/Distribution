...
import typings.googleapis.Anon_MysqlExportOptions
import typings.googleapis.Anon_SelectQuery
...
/**
  ...
  */
@js.native
trait Schema$ExportContext extends js.Object {
  /**
    * Options for exporting data as CSV.
    */
  var csvExportOptions: js.UndefOr[Anon_SelectQuery] = js.native
  /**
  ...
  /**
    ...
    */
  var sqlExportOptions: js.UndefOr[Anon_MysqlExportOptions] = js.native
  /**
...
object Schema$ExportContext {
  ...
  def apply(
    ...
    kind: String = null,
    sqlExportOptions: Anon_MysqlExportOptions = null,
    uri: String = null
  ): Schema$ExportContext = {
    ...
    __obj.asInstanceOf[Schema$ExportContext]
  }
}
