...
import typings.googleapis.Anon_Columns
...
/**
  ...
  */
@js.native
trait Schema$ImportContext extends js.Object {
  /**
    * Options for importing data as CSV.
    */
  var csvImportOptions: js.UndefOr[Anon_Columns] = js.native
  /**
...
object Schema$ImportContext {
  @scala.inline
  def apply(
    csvImportOptions: Anon_Columns = null,
    database: String = null,
    fileType: String = null,
    importUser: String = null,
    kind: String = null,
    uri: String = null
  ): Schema$ImportContext = {
    ...
    __obj.asInstanceOf[Schema$ImportContext]
  }
}
