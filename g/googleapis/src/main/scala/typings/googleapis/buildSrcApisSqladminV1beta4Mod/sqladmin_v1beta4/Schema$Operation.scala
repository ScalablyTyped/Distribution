...
trait Schema$Operation extends js.Object {
  ...
  /**
    ...
    * be populated.
    */
  var error: js.UndefOr[Schema$OperationErrors] = js.native
  /**
...
object Schema$Operation {
  ...
  def apply(
    endTime: String = null,
    error: Schema$OperationErrors = null,
    exportContext: Schema$ExportContext = null,
    importContext: Schema$ImportContext = null,
