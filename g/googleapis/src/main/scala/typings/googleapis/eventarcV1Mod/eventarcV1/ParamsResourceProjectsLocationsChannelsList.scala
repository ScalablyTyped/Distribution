...
trait ParamsResourceProjectsLocationsChannelsList
  extends StObject
...
object ParamsResourceProjectsLocationsChannelsList {
  
  inline def apply(): ParamsResourceProjectsLocationsChannelsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsChannelsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsChannelsList](x: Self) {
