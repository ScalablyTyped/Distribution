...
trait ParamsResourceProjectsLocationsChannelconnectionsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsChannelconnectionsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsChannelconnectionsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsChannelconnectionsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsChannelconnectionsGetiampolicy](x: Self) {
