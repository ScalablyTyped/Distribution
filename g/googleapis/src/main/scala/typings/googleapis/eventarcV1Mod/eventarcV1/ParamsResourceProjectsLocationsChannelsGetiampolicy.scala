...
trait ParamsResourceProjectsLocationsChannelsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsChannelsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsChannelsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsChannelsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsChannelsGetiampolicy](x: Self) {
