...
object ParamsResourceProjectsRollback {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsRollback = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsRollback]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsRollbackMutableBuilder[Self <: ParamsResourceProjectsRollback] (val x: Self) extends AnyVal {
