...
trait ParamsResourceProjectsLocationsGetsupportedlanguages
  extends StObject
...
object ParamsResourceProjectsLocationsGetsupportedlanguages {
  
  inline def apply(): ParamsResourceProjectsLocationsGetsupportedlanguages = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGetsupportedlanguages]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGetsupportedlanguages](x: Self) {
