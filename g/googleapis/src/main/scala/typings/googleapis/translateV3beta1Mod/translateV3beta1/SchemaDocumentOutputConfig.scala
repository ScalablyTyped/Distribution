...
trait SchemaDocumentOutputConfig extends StObject {
...
object SchemaDocumentOutputConfig {
  
  inline def apply(): SchemaDocumentOutputConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDocumentOutputConfig]
  }
  
  extension [Self <: SchemaDocumentOutputConfig](x: Self) {
