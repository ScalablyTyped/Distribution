...
trait ParamsResourceProjectsLocationsGlossariesList
  extends StObject
...
object ParamsResourceProjectsLocationsGlossariesList {
  
  inline def apply(): ParamsResourceProjectsLocationsGlossariesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGlossariesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGlossariesList](x: Self) {
