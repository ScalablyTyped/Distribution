...
trait SchemaAndroidNotification extends StObject {
  ...
  /**
    ...
    */
  var bodyLocArgs: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var bodyLocKey: js.UndefOr[String | Null] = js.undefined
  
  /**
    * If set, display notifications delivered to the device will be handled by the app instead of the proxy.
    */
  var bypassProxyNotification: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var clickAction: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var defaultLightSettings: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var defaultSound: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var defaultVibrateTimings: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var lightSettings: js.UndefOr[SchemaLightSettings] = js.undefined
  ...
  /**
    ...
    */
  var localOnly: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * Sets the number of items this notification represents. May be displayed as a badge count for launchers that support badging.See [Notification Badge](https://developer.android.com/training/notify-user/badges). For example, this might be useful if you're using just one notification to represent multiple new messages but you want the count here to represent the number of total new messages. If zero or unspecified, systems that support badging use the default, which is to increment a number displayed on the long-press menu each time a new notification arrives.
    */
  var notificationCount: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var notificationPriority: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var sound: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var sticky: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var ticker: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var titleLocArgs: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var titleLocKey: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var vibrateTimings: js.UndefOr[js.Array[String] | Null] = js.undefined
...
object SchemaAndroidNotification {
  
  inline def apply(): SchemaAndroidNotification = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAndroidNotification]
  }
  
  extension [Self <: SchemaAndroidNotification](x: Self) {
    ...
    inline def setBodyLocArgsNull: Self = StObject.set(x, "bodyLocArgs", null)
    ...
    inline def setBodyLocKeyNull: Self = StObject.set(x, "bodyLocKey", null)
    ...
    inline def setBypassProxyNotificationNull: Self = StObject.set(x, "bypassProxyNotification", null)
    ...
    inline def setDefaultLightSettingsNull: Self = StObject.set(x, "defaultLightSettings", null)
    ...
    inline def setDefaultSoundNull: Self = StObject.set(x, "defaultSound", null)
    ...
    inline def setDefaultVibrateTimingsNull: Self = StObject.set(x, "defaultVibrateTimings", null)
    ...
    inline def setLightSettings(value: SchemaLightSettings): Self = StObject.set(x, "lightSettings", value.asInstanceOf[js.Any])
    ...
    inline def setLocalOnlyNull: Self = StObject.set(x, "localOnly", null)
    ...
    inline def setNotificationCountNull: Self = StObject.set(x, "notificationCount", null)
    ...
    inline def setNotificationPriorityNull: Self = StObject.set(x, "notificationPriority", null)
    ...
    inline def setStickyNull: Self = StObject.set(x, "sticky", null)
    ...
    inline def setTitleLocArgsNull: Self = StObject.set(x, "titleLocArgs", null)
    ...
    inline def setTitleLocKeyNull: Self = StObject.set(x, "titleLocKey", null)
    ...
    inline def setVibrateTimingsNull: Self = StObject.set(x, "vibrateTimings", null)
