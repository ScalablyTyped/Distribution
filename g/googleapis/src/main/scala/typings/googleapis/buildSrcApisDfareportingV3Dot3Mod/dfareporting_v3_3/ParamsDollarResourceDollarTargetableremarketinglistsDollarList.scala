...
@js.native
trait ParamsDollarResourceDollarTargetableremarketinglistsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTargetableremarketinglistsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTargetableremarketinglistsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTargetableremarketinglistsDollarList]
  }
}
