...
/**
  ...
  */
@js.native
trait Schema$OperatingSystemVersion extends js.Object {
  /**
  ...
  /**
    ...
    */
  var operatingSystem: js.UndefOr[Schema$OperatingSystem] = js.native
}

object Schema$OperatingSystemVersion {
  @scala.inline
  def apply(
    id: String = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$OperatingSystemVersion]
  }
}
