...
/**
  ...
  */
@js.native
trait Schema$Pricing extends js.Object {
  /**
  ...
  /**
    ...
    * of time.
    */
  var flights: js.UndefOr[js.Array[Schema$Flight]] = js.native
  /**
...
object Schema$Pricing {
  @scala.inline
  def apply(
    capCostType: String = null,
    endDate: String = null,
    flights: js.Array[Schema$Flight] = null,
    ...
    __obj.asInstanceOf[Schema$Pricing]
  }
}
