...
/**
  ...
  */
@js.native
trait Schema$ConversionsBatchInsertResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var status: js.UndefOr[js.Array[Schema$ConversionStatus]] = js.native
}

object Schema$ConversionsBatchInsertResponse {
  @scala.inline
  def apply(
    hasFailures: js.UndefOr[Boolean] = js.undefined,
    kind: String = null,
    status: js.Array[Schema$ConversionStatus] = null
  ): Schema$ConversionsBatchInsertResponse = {
    ...
    __obj.asInstanceOf[Schema$ConversionsBatchInsertResponse]
  }
}
