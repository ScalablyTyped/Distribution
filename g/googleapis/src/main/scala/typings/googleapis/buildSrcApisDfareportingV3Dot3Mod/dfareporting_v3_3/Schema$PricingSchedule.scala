...
/**
  ...
  */
@js.native
trait Schema$PricingSchedule extends js.Object {
  /**
  ...
  /**
    ...
    */
  var pricingPeriods: js.UndefOr[js.Array[Schema$PricingSchedulePricingPeriod]] = js.native
  /**
...
object Schema$PricingSchedule {
  ...
  def apply(
    ...
    pricingPeriods: js.Array[Schema$PricingSchedulePricingPeriod] = null,
    pricingType: String = null,
    startDate: String = null,
    testingStartDate: String = null
  ): Schema$PricingSchedule = {
    ...
    __obj.asInstanceOf[Schema$PricingSchedule]
  }
}
