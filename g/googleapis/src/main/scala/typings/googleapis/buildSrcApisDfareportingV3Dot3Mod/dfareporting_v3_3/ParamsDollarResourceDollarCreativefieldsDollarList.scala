...
@js.native
trait ParamsDollarResourceDollarCreativefieldsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCreativefieldsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCreativefieldsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCreativefieldsDollarList]
  }
}
