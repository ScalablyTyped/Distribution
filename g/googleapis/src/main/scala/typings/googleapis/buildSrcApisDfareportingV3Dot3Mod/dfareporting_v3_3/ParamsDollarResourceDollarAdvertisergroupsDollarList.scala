...
@js.native
trait ParamsDollarResourceDollarAdvertisergroupsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAdvertisergroupsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAdvertisergroupsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAdvertisergroupsDollarList]
  }
}
