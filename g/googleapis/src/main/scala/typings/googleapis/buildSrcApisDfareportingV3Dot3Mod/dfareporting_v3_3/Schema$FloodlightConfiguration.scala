...
/**
  ...
  */
@js.native
trait Schema$FloodlightConfiguration extends js.Object {
  /**
  ...
  /**
    ...
    */
  var customViewabilityMetric: js.UndefOr[Schema$CustomViewabilityMetric] = js.native
  /**
  ...
  /**
    ...
    */
  var omnitureSettings: js.UndefOr[Schema$OmnitureSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var tagSettings: js.UndefOr[Schema$TagSettings] = js.native
  /**
    * List of third-party authentication tokens enabled for this configuration.
    */
  var thirdPartyAuthenticationTokens: js.UndefOr[js.Array[Schema$ThirdPartyAuthenticationToken]] = js.native
  /**
    * List of user defined variables enabled for this configuration.
    */
  var userDefinedVariableConfigurations: js.UndefOr[js.Array[Schema$UserDefinedVariableConfiguration]] = js.native
}

object Schema$FloodlightConfiguration {
  @scala.inline
  def apply(
    ...
    customViewabilityMetric: Schema$CustomViewabilityMetric = null,
    ...
    omnitureSettings: Schema$OmnitureSettings = null,
    subaccountId: String = null,
    tagSettings: Schema$TagSettings = null,
    thirdPartyAuthenticationTokens: js.Array[Schema$ThirdPartyAuthenticationToken] = null,
    userDefinedVariableConfigurations: js.Array[Schema$UserDefinedVariableConfiguration] = null
  ): Schema$FloodlightConfiguration = {
    ...
    __obj.asInstanceOf[Schema$FloodlightConfiguration]
  }
}
