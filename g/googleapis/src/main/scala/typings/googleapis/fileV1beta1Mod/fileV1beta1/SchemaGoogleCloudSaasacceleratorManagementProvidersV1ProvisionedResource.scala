...
trait SchemaGoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource extends StObject {
...
object SchemaGoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource {
  
  inline def apply(): SchemaGoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource]
  }
  
  extension [Self <: SchemaGoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource](x: Self) {
