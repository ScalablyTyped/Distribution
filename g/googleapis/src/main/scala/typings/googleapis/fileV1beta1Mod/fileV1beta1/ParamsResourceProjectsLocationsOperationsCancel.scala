...
object ParamsResourceProjectsLocationsOperationsCancel {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsOperationsCancel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsOperationsCancel]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsOperationsCancelOps[Self <: ParamsResourceProjectsLocationsOperationsCancel] (val x: Self) extends AnyVal {
