...
object ParamsResourceProjectsLocationsOperationsCancel {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsOperationsCancelMutableBuilder[Self <: ParamsResourceProjectsLocationsOperationsCancel] (val x: Self) extends AnyVal {
