...
trait ParamsResourceVitalsErrorsReportsSearch
  extends StObject
...
object ParamsResourceVitalsErrorsReportsSearch {
  
  inline def apply(): ParamsResourceVitalsErrorsReportsSearch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceVitalsErrorsReportsSearch]
  }
  
  extension [Self <: ParamsResourceVitalsErrorsReportsSearch](x: Self) {
