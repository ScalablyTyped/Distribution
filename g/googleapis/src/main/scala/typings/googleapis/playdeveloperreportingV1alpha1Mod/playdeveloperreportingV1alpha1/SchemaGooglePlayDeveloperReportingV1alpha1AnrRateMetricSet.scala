...
trait SchemaGooglePlayDeveloperReportingV1alpha1AnrRateMetricSet extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1alpha1AnrRateMetricSet {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1AnrRateMetricSet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1AnrRateMetricSet]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1AnrRateMetricSet](x: Self) {
