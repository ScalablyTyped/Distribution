...
trait ParamsResourceVitalsStuckbackgroundwakelockrateQuery
  ...
  var requestBody: js.UndefOr[
    SchemaGooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetRequest
  ] = js.undefined
}
object ParamsResourceVitalsStuckbackgroundwakelockrateQuery {
  ...
  extension [Self <: ParamsResourceVitalsStuckbackgroundwakelockrateQuery](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
