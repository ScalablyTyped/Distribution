...
trait SchemaGooglePlayDeveloperReportingV1alpha1Anomaly extends StObject {
  ...
  /**
    ...
    */
  var metric: js.UndefOr[SchemaGooglePlayDeveloperReportingV1alpha1MetricValue] = js.undefined
...
object SchemaGooglePlayDeveloperReportingV1alpha1Anomaly {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1Anomaly = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1Anomaly]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1Anomaly](x: Self) {
    ...
    inline def setMetric(value: SchemaGooglePlayDeveloperReportingV1alpha1MetricValue): Self = StObject.set(x, "metric", value.asInstanceOf[js.Any])
