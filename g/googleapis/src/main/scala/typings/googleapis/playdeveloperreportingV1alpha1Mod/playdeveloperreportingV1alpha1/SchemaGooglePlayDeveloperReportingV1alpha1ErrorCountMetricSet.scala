...
trait SchemaGooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1ErrorCountMetricSet](x: Self) {
