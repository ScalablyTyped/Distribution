...
trait SchemaGooglePlayDeveloperReportingV1alpha1DimensionValue extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1alpha1DimensionValue {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1DimensionValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1DimensionValue]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1DimensionValue](x: Self) {
