...
trait ParamsResourceVitalsAnrrateQuery
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest] = js.undefined
}
object ParamsResourceVitalsAnrrateQuery {
  ...
  extension [Self <: ParamsResourceVitalsAnrrateQuery](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
