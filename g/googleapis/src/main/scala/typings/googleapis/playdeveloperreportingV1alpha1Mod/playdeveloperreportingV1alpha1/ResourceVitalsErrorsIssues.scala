...
@JSImport("googleapis/build/src/apis/playdeveloperreporting/v1alpha1", "playdeveloperreporting_v1alpha1.Resource$Vitals$Errors$Issues")
@js.native
open class ResourceVitalsErrorsIssues protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var context: APIRequestContext = js.native
  
  def search(): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse] = js.native
  def search(
    callback: BodyResponseCallback[SchemaGooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse]
  ): Unit = js.native
  def search(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse] = js.native
  def search(params: ParamsResourceVitalsErrorsIssuesSearch): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse] = js.native
  def search(
    params: ParamsResourceVitalsErrorsIssuesSearch,
    callback: BodyResponseCallback[SchemaGooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse]
  ): Unit = js.native
  def search(
    params: ParamsResourceVitalsErrorsIssuesSearch,
    options: BodyResponseCallback[Readable | SchemaGooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse],
    callback: BodyResponseCallback[Readable | SchemaGooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse]
  ): Unit = js.native
  def search(params: ParamsResourceVitalsErrorsIssuesSearch, options: MethodOptions): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse] = js.native
  def search(
    params: ParamsResourceVitalsErrorsIssuesSearch,
  ...
  /**
    ...
    */
  def search(params: ParamsResourceVitalsErrorsIssuesSearch, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def search(
    params: ParamsResourceVitalsErrorsIssuesSearch,
