...
trait SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetResponse extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetResponse {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetResponse]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetResponse](x: Self) {
