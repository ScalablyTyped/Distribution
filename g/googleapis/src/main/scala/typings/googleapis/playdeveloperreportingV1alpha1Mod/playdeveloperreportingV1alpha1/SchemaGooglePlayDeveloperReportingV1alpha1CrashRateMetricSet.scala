...
trait SchemaGooglePlayDeveloperReportingV1alpha1CrashRateMetricSet extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1alpha1CrashRateMetricSet {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1CrashRateMetricSet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1CrashRateMetricSet]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1CrashRateMetricSet](x: Self) {
