...
trait SchemaGooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet](x: Self) {
