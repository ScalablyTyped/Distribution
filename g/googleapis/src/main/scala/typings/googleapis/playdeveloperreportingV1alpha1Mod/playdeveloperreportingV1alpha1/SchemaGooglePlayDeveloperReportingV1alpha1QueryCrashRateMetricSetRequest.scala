...
trait SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest](x: Self) {
