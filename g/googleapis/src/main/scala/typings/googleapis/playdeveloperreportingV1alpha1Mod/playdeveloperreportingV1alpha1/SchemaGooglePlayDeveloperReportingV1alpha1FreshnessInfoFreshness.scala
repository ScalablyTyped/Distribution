...
trait SchemaGooglePlayDeveloperReportingV1alpha1FreshnessInfoFreshness extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1alpha1FreshnessInfoFreshness {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1FreshnessInfoFreshness = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1FreshnessInfoFreshness]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1FreshnessInfoFreshness](x: Self) {
