...
trait ParamsResourceVitalsCrashrateQuery
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest] = js.undefined
}
object ParamsResourceVitalsCrashrateQuery {
  ...
  extension [Self <: ParamsResourceVitalsCrashrateQuery](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
