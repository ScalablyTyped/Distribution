...
trait SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest](x: Self) {
