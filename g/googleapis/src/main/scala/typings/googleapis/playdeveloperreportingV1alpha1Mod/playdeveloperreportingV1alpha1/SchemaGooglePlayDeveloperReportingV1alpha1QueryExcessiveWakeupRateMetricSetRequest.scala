...
trait SchemaGooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest](x: Self) {
