...
trait SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetResponse extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetResponse {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetResponse]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetResponse](x: Self) {
