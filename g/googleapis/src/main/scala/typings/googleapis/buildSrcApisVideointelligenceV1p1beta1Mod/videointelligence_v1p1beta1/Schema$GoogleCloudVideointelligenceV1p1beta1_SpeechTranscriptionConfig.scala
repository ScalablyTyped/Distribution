...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig extends js.Object {
  /**
  ...
  /**
    ...
    */
  var speechContexts: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1p1beta1_SpeechContext]] = js.native
}

object Schema$GoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig {
  @scala.inline
  def apply(
    ...
    speechContexts: js.Array[Schema$GoogleCloudVideointelligenceV1p1beta1_SpeechContext] = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig]
  }
}
