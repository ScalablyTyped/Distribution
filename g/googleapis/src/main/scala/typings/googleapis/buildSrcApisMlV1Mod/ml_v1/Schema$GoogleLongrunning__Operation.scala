...
/**
  ...
  */
@js.native
trait Schema$GoogleLongrunning__Operation extends js.Object {
  /**
  ...
  /**
    ...
    */
  var error: js.UndefOr[Schema$GoogleRpc__Status] = js.native
  /**
...
object Schema$GoogleLongrunning__Operation {
  @scala.inline
  def apply(
    done: js.UndefOr[Boolean] = js.undefined,
    error: Schema$GoogleRpc__Status = null,
    ...
    __obj.asInstanceOf[Schema$GoogleLongrunning__Operation]
  }
}
