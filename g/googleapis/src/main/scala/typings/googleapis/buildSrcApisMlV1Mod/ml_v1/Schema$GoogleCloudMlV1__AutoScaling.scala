...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudMlV1__AutoScaling extends js.Object {
  /**
...
object Schema$GoogleCloudMlV1__AutoScaling {
  @scala.inline
  def apply(minNodes: Int | Double = null): Schema$GoogleCloudMlV1__AutoScaling = {
    val __obj = js.Dynamic.literal()
    if (minNodes != null) __obj.updateDynamic("minNodes")(minNodes.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudMlV1__AutoScaling]
  }
}
