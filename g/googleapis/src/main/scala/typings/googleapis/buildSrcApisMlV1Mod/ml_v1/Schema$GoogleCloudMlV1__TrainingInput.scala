...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudMlV1__TrainingInput extends js.Object {
  /**
  ...
  /**
    ...
    */
  var hyperparameters: js.UndefOr[Schema$GoogleCloudMlV1__HyperparameterSpec] = js.native
  /**
  ...
  /**
    ...
    */
  var masterConfig: js.UndefOr[Schema$GoogleCloudMlV1__ReplicaConfig] = js.native
  /**
  ...
  /**
    ...
    * containers](/ml-engine/docs/distributed-training-containers).
    */
  var parameterServerConfig: js.UndefOr[Schema$GoogleCloudMlV1__ReplicaConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var workerConfig: js.UndefOr[Schema$GoogleCloudMlV1__ReplicaConfig] = js.native
  /**
...
object Schema$GoogleCloudMlV1__TrainingInput {
  @scala.inline
  def apply(
    args: js.Array[String] = null,
    hyperparameters: Schema$GoogleCloudMlV1__HyperparameterSpec = null,
    jobDir: String = null,
    masterConfig: Schema$GoogleCloudMlV1__ReplicaConfig = null,
    masterType: String = null,
    packageUris: js.Array[String] = null,
    parameterServerConfig: Schema$GoogleCloudMlV1__ReplicaConfig = null,
    ...
    workerConfig: Schema$GoogleCloudMlV1__ReplicaConfig = null,
    workerCount: String = null,
    workerType: String = null
  ): Schema$GoogleCloudMlV1__TrainingInput = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudMlV1__TrainingInput]
  }
}
