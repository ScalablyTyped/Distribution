...
@js.native
trait Schema$PagespeedApiImageV4 extends js.Object {
  /**
...
object Schema$PagespeedApiImageV4 {
  @scala.inline
  def apply(
    data: String = null,
    ...
    __obj.asInstanceOf[Schema$PagespeedApiImageV4]
  }
}
