...
/**
  ...
  */
@js.native
trait Schema$CreateManagedShortLinkRequest extends js.Object {
  /**
...
object Schema$CreateManagedShortLinkRequest {
  @scala.inline
  def apply(
  ...
  ): Schema$CreateManagedShortLinkRequest = {
    ...
    __obj.asInstanceOf[Schema$CreateManagedShortLinkRequest]
  }
}
