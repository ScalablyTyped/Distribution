...
/**
  ...
  */
@js.native
trait Schema$GetIosPostInstallAttributionResponse extends js.Object {
  /**
...
object Schema$GetIosPostInstallAttributionResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GetIosPostInstallAttributionResponse]
  }
}
