...
/**
  ...
  */
@js.native
trait Schema$ManagedShortLink extends js.Object {
  /**
  ...
  /**
    ...
    */
  var info: js.UndefOr[Schema$DynamicLinkInfo] = js.native
  /**
...
object Schema$ManagedShortLink {
  @scala.inline
  def apply(
    creationTime: String = null,
    flaggedAttribute: js.Array[String] = null,
    info: Schema$DynamicLinkInfo = null,
    link: String = null,
    linkName: String = null,
    visibility: String = null
  ): Schema$ManagedShortLink = {
    ...
    __obj.asInstanceOf[Schema$ManagedShortLink]
  }
}
