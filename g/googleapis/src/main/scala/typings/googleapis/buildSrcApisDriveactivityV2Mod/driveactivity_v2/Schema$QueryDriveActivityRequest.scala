...
/**
  ...
  */
@js.native
trait Schema$QueryDriveActivityRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var consolidationStrategy: js.UndefOr[Schema$ConsolidationStrategy] = js.native
  /**
...
object Schema$QueryDriveActivityRequest {
  @scala.inline
  def apply(
    ancestorName: String = null,
    consolidationStrategy: Schema$ConsolidationStrategy = null,
    filter: String = null,
    itemName: String = null,
    pageSize: Int | Double = null,
    pageToken: String = null
  ): Schema$QueryDriveActivityRequest = {
    ...
    __obj.asInstanceOf[Schema$QueryDriveActivityRequest]
  }
}
