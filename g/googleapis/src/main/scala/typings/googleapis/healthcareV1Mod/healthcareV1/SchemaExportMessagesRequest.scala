...
trait SchemaExportMessagesRequest extends StObject {
...
object SchemaExportMessagesRequest {
  
  inline def apply(): SchemaExportMessagesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaExportMessagesRequest]
  }
  
  extension [Self <: SchemaExportMessagesRequest](x: Self) {
