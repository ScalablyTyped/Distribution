...
trait SchemaGoogleCloudHealthcareV1DicomGcsDestination extends StObject {
...
object SchemaGoogleCloudHealthcareV1DicomGcsDestination {
  
  inline def apply(): SchemaGoogleCloudHealthcareV1DicomGcsDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudHealthcareV1DicomGcsDestination]
  }
  
  extension [Self <: SchemaGoogleCloudHealthcareV1DicomGcsDestination](x: Self) {
