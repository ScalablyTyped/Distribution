...
trait SchemaExportResourcesRequest extends StObject {
  ...
  /**
    ...
    */
  var gcsDestination: js.UndefOr[SchemaGoogleCloudHealthcareV1FhirGcsDestination] = js.undefined
}
object SchemaExportResourcesRequest {
  ...
  extension [Self <: SchemaExportResourcesRequest](x: Self) {
    ...
    inline def setGcsDestination(value: SchemaGoogleCloudHealthcareV1FhirGcsDestination): Self = StObject.set(x, "gcsDestination", value.asInstanceOf[js.Any])
