...
trait ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesRetrievemetadata
  extends StObject
...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesRetrievemetadata {
  
  inline def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesRetrievemetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesRetrievemetadata]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesRetrievemetadata](x: Self) {
