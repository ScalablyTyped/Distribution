...
trait ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSearchforinstances
  extends StObject
...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSearchforinstances {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSearchforinstances = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSearchforinstances]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSearchforinstances](x: Self) {
