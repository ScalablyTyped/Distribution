...
trait SchemaHl7V2NotificationConfig extends StObject {
...
object SchemaHl7V2NotificationConfig {
  
  inline def apply(): SchemaHl7V2NotificationConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaHl7V2NotificationConfig]
  }
  
  extension [Self <: SchemaHl7V2NotificationConfig](x: Self) {
