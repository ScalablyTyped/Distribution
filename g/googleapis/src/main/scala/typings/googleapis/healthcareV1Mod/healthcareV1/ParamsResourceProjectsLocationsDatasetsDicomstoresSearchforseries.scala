...
trait ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforseries
  extends StObject
...
object ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforseries {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforseries = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforseries]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforseries](x: Self) {
