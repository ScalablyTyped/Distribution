...
trait ParamsResourceProjectsLocationsDatasetsDicomstoresStoreinstances
  extends StObject
...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStoreinstances {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresStoreinstances = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresStoreinstances]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStoreinstances](x: Self) {
