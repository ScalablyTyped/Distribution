...
trait SchemaFhirStore extends StObject {
  ...
  /**
    ...
    */
  var complexDataTypeReferenceParsing: js.UndefOr[String | Null] = js.undefined
  
  /**
    * If true, overrides the default search behavior for this FHIR store to `handling=strict` which returns an error for unrecognized search parameters. If false, uses the FHIR specification default `handling=lenient` which ignores unrecognized search parameters. The handling can always be changed from the default on an individual API call by setting the HTTP header `Prefer: handling=strict` or `Prefer: handling=lenient`.
    */
  var defaultSearchHandlingStrict: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * Immutable. Whether to disable referential integrity in this FHIR store. This field is immutable after FHIR store creation. The default value is false, meaning that the API enforces referential integrity and fails the requests that result in inconsistent state in the FHIR store. When this field is set to true, the API skips referential integrity checks. Consequently, operations that rely on references, such as GetPatientEverything, do not return all the results if broken references exist.
    */
  var disableReferentialIntegrity: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * Immutable. Whether to disable resource versioning for this FHIR store. This field can not be changed after the creation of FHIR store. If set to false, which is the default behavior, all write operations cause historical versions to be recorded automatically. The historical versions can be fetched through the history APIs, but cannot be updated. If set to true, no historical versions are kept. The server sends errors for attempts to read the historical versions.
    */
  var disableResourceVersioning: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var enableUpdateCreate: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var streamConfigs: js.UndefOr[js.Array[SchemaStreamConfig]] = js.undefined
  
  /**
    * Configuration for how to validate incoming FHIR resources against configured profiles.
    */
  var validationConfig: js.UndefOr[SchemaValidationConfig] = js.undefined
...
object SchemaFhirStore {
  ...
  inline def apply(): SchemaFhirStore = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaFhirStore]
  }
  
  extension [Self <: SchemaFhirStore](x: Self) {
    ...
    inline def setComplexDataTypeReferenceParsingNull: Self = StObject.set(x, "complexDataTypeReferenceParsing", null)
    ...
    inline def setDefaultSearchHandlingStrictNull: Self = StObject.set(x, "defaultSearchHandlingStrict", null)
    ...
    inline def setDisableReferentialIntegrityNull: Self = StObject.set(x, "disableReferentialIntegrity", null)
    ...
    inline def setDisableResourceVersioningNull: Self = StObject.set(x, "disableResourceVersioning", null)
    ...
    inline def setEnableUpdateCreateNull: Self = StObject.set(x, "enableUpdateCreate", null)
    ...
    inline def setStreamConfigs(value: js.Array[SchemaStreamConfig]): Self = StObject.set(x, "streamConfigs", value.asInstanceOf[js.Any])
    
    inline def setStreamConfigsUndefined: Self = StObject.set(x, "streamConfigs", js.undefined)
    
    inline def setStreamConfigsVarargs(value: SchemaStreamConfig*): Self = StObject.set(x, "streamConfigs", js.Array(value*))
    
    inline def setValidationConfig(value: SchemaValidationConfig): Self = StObject.set(x, "validationConfig", value.asInstanceOf[js.Any])
