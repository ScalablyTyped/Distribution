...
trait ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesInstancesRetrieverendered
  extends StObject
...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesInstancesRetrieverendered {
  
  inline def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesInstancesRetrieverendered = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesInstancesRetrieverendered]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesInstancesRetrieverendered](x: Self) {
