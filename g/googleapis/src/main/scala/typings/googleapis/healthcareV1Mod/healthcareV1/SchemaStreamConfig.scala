...
trait SchemaStreamConfig extends StObject {
  ...
  /**
    ...
    */
  var bigqueryDestination: js.UndefOr[SchemaGoogleCloudHealthcareV1FhirBigQueryDestination] = js.undefined
...
object SchemaStreamConfig {
  ...
  extension [Self <: SchemaStreamConfig](x: Self) {
    ...
    inline def setBigqueryDestination(value: SchemaGoogleCloudHealthcareV1FhirBigQueryDestination): Self = StObject.set(x, "bigqueryDestination", value.asInstanceOf[js.Any])
