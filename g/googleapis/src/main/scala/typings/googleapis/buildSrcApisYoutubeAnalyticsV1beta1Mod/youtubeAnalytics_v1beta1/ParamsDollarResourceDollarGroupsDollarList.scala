...
object ParamsDollarResourceDollarGroupsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarGroupsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarGroupsDollarList]
  }
}
