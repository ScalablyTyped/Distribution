...
object Common {
  ...
  open class AwsClient protected ()
    extends typings.googleapisCommon.mod.AwsClient {
    /**
  ...
  abstract class BaseExternalAccountClient protected ()
    extends typings.googleapisCommon.mod.BaseExternalAccountClient {
    /**
  ...
  /**
    ...
    */
  open class Compute ()
    extends typings.googleapisCommon.mod.Compute {
  ...
  open class DefaultTransporter ()
    extends typings.googleapisCommon.mod.DefaultTransporter
  /* static members */
  ...
  open class Discovery protected ()
    extends typings.googleapisCommon.mod.Discovery {
    /**
  ...
  open class Endpoint protected ()
    extends typings.googleapisCommon.mod.Endpoint {
  ...
  open class ExternalAccountClient ()
    extends typings.googleapisCommon.mod.ExternalAccountClient
  /* static members */
  ...
  /**
    ...
    */
  open class Gaxios ()
    extends typings.googleapisCommon.mod.Gaxios {
  ...
  open class GaxiosError[T] protected ()
    extends typings.googleapisCommon.mod.GaxiosError[T] {
  ...
  open class GoogleAuth[T /* <: AuthClient */] ()
    extends typings.googleapisCommon.mod.GoogleAuth[T] {
  ...
  open class IdentityPoolClient protected ()
    extends typings.googleapisCommon.mod.IdentityPoolClient {
    /**
  ...
  open class JWT protected ()
    extends typings.googleapisCommon.mod.JWT {
    /**
  ...
  open class OAuth2Client ()
    extends typings.googleapisCommon.mod.OAuth2Client {
  ...
  open class UserRefreshClient ()
    extends typings.googleapisCommon.mod.UserRefreshClient {
    def this(clientId: String) = this()
