...
trait ParamsResourceFoldersLocationsRecommendersRecommendationsList
  extends StObject
...
object ParamsResourceFoldersLocationsRecommendersRecommendationsList {
  
  inline def apply(): ParamsResourceFoldersLocationsRecommendersRecommendationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersLocationsRecommendersRecommendationsList]
  }
  
  extension [Self <: ParamsResourceFoldersLocationsRecommendersRecommendationsList](x: Self) {
