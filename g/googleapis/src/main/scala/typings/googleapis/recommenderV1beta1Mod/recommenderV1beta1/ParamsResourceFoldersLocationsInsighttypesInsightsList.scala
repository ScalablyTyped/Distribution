...
trait ParamsResourceFoldersLocationsInsighttypesInsightsList
  extends StObject
...
object ParamsResourceFoldersLocationsInsighttypesInsightsList {
  
  inline def apply(): ParamsResourceFoldersLocationsInsighttypesInsightsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersLocationsInsighttypesInsightsList]
  }
  
  extension [Self <: ParamsResourceFoldersLocationsInsighttypesInsightsList](x: Self) {
