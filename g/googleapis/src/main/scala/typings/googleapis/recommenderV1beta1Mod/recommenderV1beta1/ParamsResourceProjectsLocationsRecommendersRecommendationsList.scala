...
trait ParamsResourceProjectsLocationsRecommendersRecommendationsList
  extends StObject
...
object ParamsResourceProjectsLocationsRecommendersRecommendationsList {
  
  inline def apply(): ParamsResourceProjectsLocationsRecommendersRecommendationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRecommendersRecommendationsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRecommendersRecommendationsList](x: Self) {
