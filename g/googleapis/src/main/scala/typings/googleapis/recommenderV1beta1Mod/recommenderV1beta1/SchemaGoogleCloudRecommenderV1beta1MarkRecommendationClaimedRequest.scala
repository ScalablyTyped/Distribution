...
trait SchemaGoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest extends StObject {
...
object SchemaGoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest](x: Self) {
