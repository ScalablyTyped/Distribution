...
trait SchemaGoogleCloudRecommenderV1beta1InsightStateInfo extends StObject {
...
object SchemaGoogleCloudRecommenderV1beta1InsightStateInfo {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1beta1InsightStateInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1beta1InsightStateInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1beta1InsightStateInfo](x: Self) {
