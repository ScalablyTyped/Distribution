...
trait ParamsResourceBillingaccountsLocationsRecommendersRecommendationsList
  extends StObject
...
object ParamsResourceBillingaccountsLocationsRecommendersRecommendationsList {
  
  inline def apply(): ParamsResourceBillingaccountsLocationsRecommendersRecommendationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsLocationsRecommendersRecommendationsList]
  }
  
  extension [Self <: ParamsResourceBillingaccountsLocationsRecommendersRecommendationsList](x: Self) {
