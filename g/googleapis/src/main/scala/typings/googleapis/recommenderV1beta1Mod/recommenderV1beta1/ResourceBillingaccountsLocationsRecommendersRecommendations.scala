...
@JSImport("googleapis/build/src/apis/recommender/v1beta1", "recommender_v1beta1.Resource$Billingaccounts$Locations$Recommenders$Recommendations")
@js.native
open class ResourceBillingaccountsLocationsRecommendersRecommendations protected () extends StObject {
  ...
  def get(params: ParamsResourceBillingaccountsLocationsRecommendersRecommendationsGet): GaxiosPromise[SchemaGoogleCloudRecommenderV1beta1Recommendation] = js.native
  def get(
  ...
  def list(params: ParamsResourceBillingaccountsLocationsRecommendersRecommendationsList): GaxiosPromise[SchemaGoogleCloudRecommenderV1beta1ListRecommendationsResponse] = js.native
  def list(
  ...
  def markClaimed(params: ParamsResourceBillingaccountsLocationsRecommendersRecommendationsMarkclaimed): GaxiosPromise[SchemaGoogleCloudRecommenderV1beta1Recommendation] = js.native
  def markClaimed(
  ...
  def markFailed(params: ParamsResourceBillingaccountsLocationsRecommendersRecommendationsMarkfailed): GaxiosPromise[SchemaGoogleCloudRecommenderV1beta1Recommendation] = js.native
  def markFailed(
  ...
  def markSucceeded(params: ParamsResourceBillingaccountsLocationsRecommendersRecommendationsMarksucceeded): GaxiosPromise[SchemaGoogleCloudRecommenderV1beta1Recommendation] = js.native
  def markSucceeded(
