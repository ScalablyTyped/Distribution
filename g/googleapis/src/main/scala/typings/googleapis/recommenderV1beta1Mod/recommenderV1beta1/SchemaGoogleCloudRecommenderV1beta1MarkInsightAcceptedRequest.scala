...
trait SchemaGoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest extends StObject {
...
object SchemaGoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest](x: Self) {
