...
trait ParamsResourceOrganizationsLocationsRecommendersRecommendationsMarkclaimed
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest] = js.undefined
}
object ParamsResourceOrganizationsLocationsRecommendersRecommendationsMarkclaimed {
  ...
  extension [Self <: ParamsResourceOrganizationsLocationsRecommendersRecommendationsMarkclaimed](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
