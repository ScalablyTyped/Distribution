...
trait SchemaGoogleCloudRecommenderV1beta1CostProjection extends StObject {
...
object SchemaGoogleCloudRecommenderV1beta1CostProjection {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1beta1CostProjection = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1beta1CostProjection]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1beta1CostProjection](x: Self) {
