...
trait SchemaGoogleCloudRecommenderV1beta1Operation extends StObject {
  ...
  /**
    ...
    */
  var pathValueMatchers: js.UndefOr[StringDictionary[SchemaGoogleCloudRecommenderV1beta1ValueMatcher] | Null] = js.undefined
  ...
  /**
    ...
    */
  var valueMatcher: js.UndefOr[SchemaGoogleCloudRecommenderV1beta1ValueMatcher] = js.undefined
}
object SchemaGoogleCloudRecommenderV1beta1Operation {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1beta1Operation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1beta1Operation]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1beta1Operation](x: Self) {
    ...
    inline def setPathValueMatchers(value: StringDictionary[SchemaGoogleCloudRecommenderV1beta1ValueMatcher]): Self = StObject.set(x, "pathValueMatchers", value.asInstanceOf[js.Any])
    ...
    inline def setValueMatcher(value: SchemaGoogleCloudRecommenderV1beta1ValueMatcher): Self = StObject.set(x, "valueMatcher", value.asInstanceOf[js.Any])
