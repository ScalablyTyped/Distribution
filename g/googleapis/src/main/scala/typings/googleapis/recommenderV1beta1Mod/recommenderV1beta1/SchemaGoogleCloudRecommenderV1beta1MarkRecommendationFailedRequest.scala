...
trait SchemaGoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest extends StObject {
...
object SchemaGoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest](x: Self) {
