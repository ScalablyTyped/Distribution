...
trait SchemaGoogleCloudRecommenderV1beta1InsightTypeConfig extends StObject {
  ...
  /**
    ...
    */
  var insightTypeGenerationConfig: js.UndefOr[SchemaGoogleCloudRecommenderV1beta1InsightTypeGenerationConfig] = js.undefined
...
object SchemaGoogleCloudRecommenderV1beta1InsightTypeConfig {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1beta1InsightTypeConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1beta1InsightTypeConfig]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1beta1InsightTypeConfig](x: Self) {
    ...
    inline def setInsightTypeGenerationConfig(value: SchemaGoogleCloudRecommenderV1beta1InsightTypeGenerationConfig): Self = StObject.set(x, "insightTypeGenerationConfig", value.asInstanceOf[js.Any])
