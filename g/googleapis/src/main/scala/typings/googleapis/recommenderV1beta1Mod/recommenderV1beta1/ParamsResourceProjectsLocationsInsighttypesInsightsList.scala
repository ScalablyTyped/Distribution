...
trait ParamsResourceProjectsLocationsInsighttypesInsightsList
  extends StObject
...
object ParamsResourceProjectsLocationsInsighttypesInsightsList {
  
  inline def apply(): ParamsResourceProjectsLocationsInsighttypesInsightsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsInsighttypesInsightsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsInsighttypesInsightsList](x: Self) {
