...
trait ParamsResourceOrganizationsLocationsInsighttypesUpdateconfig
  extends StObject
...
object ParamsResourceOrganizationsLocationsInsighttypesUpdateconfig {
  
  inline def apply(): ParamsResourceOrganizationsLocationsInsighttypesUpdateconfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsLocationsInsighttypesUpdateconfig]
  }
  
  extension [Self <: ParamsResourceOrganizationsLocationsInsighttypesUpdateconfig](x: Self) {
