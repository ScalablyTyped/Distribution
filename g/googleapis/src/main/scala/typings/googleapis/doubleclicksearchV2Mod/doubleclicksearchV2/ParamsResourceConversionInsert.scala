...
@js.native
trait ParamsResourceConversionInsert extends StandardParameters {
...
object ParamsResourceConversionInsert {
  ...
  @scala.inline
  def apply(): ParamsResourceConversionInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceConversionInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceConversionInsertMutableBuilder[Self <: ParamsResourceConversionInsert] (val x: Self) extends AnyVal {
