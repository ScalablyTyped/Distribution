...
trait SchemaReportRequest extends StObject {
  ...
  /**
    ...
    */
  var downloadFormat: js.UndefOr[String | Null] = js.undefined
  
  /**
    * A list of filters to be applied to the report.\ The maximum number of filters per request is 300.
    */
  var filters: js.UndefOr[js.Array[Column] | Null] = js.undefined
  
  /**
    * Determines if removed entities should be included in the report. Defaults to `false`. Deprecated, please use `includeRemovedEntities` instead.
    */
  var includeDeletedEntities: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * Determines if removed entities should be included in the report. Defaults to `false`.
    */
  var includeRemovedEntities: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var maxRowsPerFile: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var orderBy: js.UndefOr[js.Array[SortOrder] | Null] = js.undefined
  
  /**
    * The reportScope is a set of IDs that are used to determine which subset of entities will be returned in the report. The full lineage of IDs from the lowest scoped level desired up through agency is required.
    */
  var reportScope: js.UndefOr[AdGroupId | Null] = js.undefined
  ...
  /**
    ...
    */
  var reportType: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var statisticsCurrency: js.UndefOr[String | Null] = js.undefined
  
  /**
    * If metrics are requested in a report, this argument will be used to restrict the metrics to a specific time range.
    */
  var timeRange: js.UndefOr[ChangedAttributesSinceTimestamp | Null] = js.undefined
  
  /**
    * If `true`, the report would only be created if all the requested stat data are sourced from a single timezone. Defaults to `false`.
    */
  var verifySingleTimeZone: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaReportRequest {
  ...
  extension [Self <: SchemaReportRequest](x: Self) {
    ...
    inline def setColumnsVarargs(value: SchemaReportApiColumnSpec*): Self = StObject.set(x, "columns", js.Array(value*))
    
    inline def setDownloadFormat(value: String): Self = StObject.set(x, "downloadFormat", value.asInstanceOf[js.Any])
    
    inline def setDownloadFormatNull: Self = StObject.set(x, "downloadFormat", null)
    ...
    inline def setIncludeDeletedEntitiesNull: Self = StObject.set(x, "includeDeletedEntities", null)
    ...
    inline def setIncludeRemovedEntitiesNull: Self = StObject.set(x, "includeRemovedEntities", null)
    ...
    inline def setMaxRowsPerFileNull: Self = StObject.set(x, "maxRowsPerFile", null)
    ...
    inline def setReportScopeNull: Self = StObject.set(x, "reportScope", null)
    ...
    inline def setReportTypeNull: Self = StObject.set(x, "reportType", null)
    ...
    inline def setStatisticsCurrencyNull: Self = StObject.set(x, "statisticsCurrency", null)
    ...
    inline def setTimeRangeNull: Self = StObject.set(x, "timeRange", null)
    ...
    inline def setVerifySingleTimeZoneNull: Self = StObject.set(x, "verifySingleTimeZone", null)
