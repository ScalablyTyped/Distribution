...
/**
  ...
  */
@js.native
trait Schema$OperationMetadataV1 extends js.Object {
  var createVersionMetadata: js.UndefOr[Schema$CreateVersionMetadataV1] = js.native
  /**
...
object Schema$OperationMetadataV1 {
  @scala.inline
  def apply(
    createVersionMetadata: Schema$CreateVersionMetadataV1 = null,
    endTime: String = null,
    ...
    __obj.asInstanceOf[Schema$OperationMetadataV1]
  }
}
