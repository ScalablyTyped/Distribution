...
@js.native
open class ResourceWorkers protected () extends StObject {
  ...
  /**
    ...
    */
  def checkIn(params: ParamsResourceWorkersCheckin, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def checkIn(
    params: ParamsResourceWorkersCheckin,
