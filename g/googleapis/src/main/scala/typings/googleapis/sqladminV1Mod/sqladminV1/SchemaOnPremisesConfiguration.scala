...
trait SchemaOnPremisesConfiguration extends StObject {
  ...
  /**
    ...
    */
  var sourceInstance: js.UndefOr[SchemaInstanceReference] = js.undefined
...
object SchemaOnPremisesConfiguration {
  ...
  extension [Self <: SchemaOnPremisesConfiguration](x: Self) {
    ...
    inline def setSourceInstance(value: SchemaInstanceReference): Self = StObject.set(x, "sourceInstance", value.asInstanceOf[js.Any])
