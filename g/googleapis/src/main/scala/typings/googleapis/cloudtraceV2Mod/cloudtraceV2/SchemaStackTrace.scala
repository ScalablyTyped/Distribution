...
trait SchemaStackTrace extends StObject {
  ...
  /**
    ...
    */
  var stackTraceHashId: js.UndefOr[String | Null] = js.undefined
}
object SchemaStackTrace {
  ...
  extension [Self <: SchemaStackTrace](x: Self) {
    ...
    inline def setStackFrames(value: SchemaStackFrames): Self = StObject.set(x, "stackFrames", value.asInstanceOf[js.Any])
    ...
    inline def setStackTraceHashIdNull: Self = StObject.set(x, "stackTraceHashId", null)
