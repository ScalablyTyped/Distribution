...
trait SchemaOperationMetadata extends StObject {
  ...
  /**
    ...
    */
  var additionalStatus: js.UndefOr[StringDictionary[String] | Null] = js.undefined
...
object SchemaOperationMetadata {
  ...
  extension [Self <: SchemaOperationMetadata](x: Self) {
    ...
    inline def setAdditionalStatus(value: StringDictionary[String]): Self = StObject.set(x, "additionalStatus", value.asInstanceOf[js.Any])
    
    inline def setAdditionalStatusNull: Self = StObject.set(x, "additionalStatus", null)
