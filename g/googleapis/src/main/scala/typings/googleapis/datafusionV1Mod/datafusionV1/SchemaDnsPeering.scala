...
trait SchemaDnsPeering extends StObject {
  ...
  /**
    ...
    */
  var targetNetwork: js.UndefOr[String | Null] = js.undefined
...
object SchemaDnsPeering {
  
  inline def apply(): SchemaDnsPeering = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDnsPeering]
  }
  
  extension [Self <: SchemaDnsPeering](x: Self) {
    ...
    inline def setTargetNetworkNull: Self = StObject.set(x, "targetNetwork", null)
