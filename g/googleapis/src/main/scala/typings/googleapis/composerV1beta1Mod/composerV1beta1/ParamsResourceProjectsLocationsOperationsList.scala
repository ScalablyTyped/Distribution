...
object ParamsResourceProjectsLocationsOperationsList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsOperationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsOperationsList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsOperationsListMutableBuilder[Self <: ParamsResourceProjectsLocationsOperationsList] (val x: Self) extends AnyVal {
