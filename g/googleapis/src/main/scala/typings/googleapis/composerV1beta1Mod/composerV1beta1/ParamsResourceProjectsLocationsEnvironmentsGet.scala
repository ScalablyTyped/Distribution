...
object ParamsResourceProjectsLocationsEnvironmentsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsEnvironmentsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsEnvironmentsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsEnvironmentsGetMutableBuilder[Self <: ParamsResourceProjectsLocationsEnvironmentsGet] (val x: Self) extends AnyVal {
