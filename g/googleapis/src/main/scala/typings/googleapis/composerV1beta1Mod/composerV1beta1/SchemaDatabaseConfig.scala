...
trait SchemaDatabaseConfig extends StObject {
...
object SchemaDatabaseConfig {
  
  inline def apply(): SchemaDatabaseConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDatabaseConfig]
  }
  
  extension [Self <: SchemaDatabaseConfig](x: Self) {
