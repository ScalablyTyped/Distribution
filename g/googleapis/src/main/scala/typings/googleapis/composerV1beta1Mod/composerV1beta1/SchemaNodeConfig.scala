...
trait SchemaNodeConfig extends StObject {
  ...
  /**
    ...
    */
  var maxPodsPerNode: js.UndefOr[Double | Null] = js.undefined
...
object SchemaNodeConfig {
  ...
  extension [Self <: SchemaNodeConfig](x: Self) {
    ...
    inline def setMaxPodsPerNode(value: Double): Self = StObject.set(x, "maxPodsPerNode", value.asInstanceOf[js.Any])
