...
trait SchemaSoftwareConfig extends StObject {
  ...
  /**
    ...
    */
  var airflowConfigOverrides: js.UndefOr[StringDictionary[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var pypiPackages: js.UndefOr[StringDictionary[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var schedulerCount: js.UndefOr[Double | Null] = js.undefined
}
object SchemaSoftwareConfig {
  ...
  extension [Self <: SchemaSoftwareConfig](x: Self) {
    ...
    inline def setAirflowConfigOverridesNull: Self = StObject.set(x, "airflowConfigOverrides", null)
    ...
    inline def setPypiPackagesNull: Self = StObject.set(x, "pypiPackages", null)
    ...
    inline def setSchedulerCountNull: Self = StObject.set(x, "schedulerCount", null)
