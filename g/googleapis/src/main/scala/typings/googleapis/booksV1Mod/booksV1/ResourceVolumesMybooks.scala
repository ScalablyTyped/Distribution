...
@js.native
open class ResourceVolumesMybooks protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceVolumesMybooksList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceVolumesMybooksList,
