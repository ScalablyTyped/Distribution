...
@js.native
open class ResourceDictionary protected () extends StObject {
  ...
  /**
    ...
    */
  def listOfflineMetadata(params: ParamsResourceDictionaryListofflinemetadata, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def listOfflineMetadata(
    params: ParamsResourceDictionaryListofflinemetadata,
