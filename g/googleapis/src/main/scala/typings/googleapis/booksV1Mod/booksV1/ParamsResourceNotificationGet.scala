...
object ParamsResourceNotificationGet {
  ...
  @scala.inline
  implicit class ParamsResourceNotificationGetOps[Self <: ParamsResourceNotificationGet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNotification_id(value: String): Self = this.set("notification_id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNotification_id: Self = this.set("notification_id", js.undefined)
