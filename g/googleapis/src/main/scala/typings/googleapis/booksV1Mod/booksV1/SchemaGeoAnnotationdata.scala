...
trait SchemaGeoAnnotationdata extends StObject {
  ...
  /**
    ...
    */
  var data: js.UndefOr[SchemaGeolayerdata] = js.undefined
...
object SchemaGeoAnnotationdata {
  
  inline def apply(): SchemaGeoAnnotationdata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGeoAnnotationdata]
  }
  
  extension [Self <: SchemaGeoAnnotationdata](x: Self) {
    ...
    inline def setData(value: SchemaGeolayerdata): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
