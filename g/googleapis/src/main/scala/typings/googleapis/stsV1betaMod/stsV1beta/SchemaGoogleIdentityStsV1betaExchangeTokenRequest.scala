...
trait SchemaGoogleIdentityStsV1betaExchangeTokenRequest extends StObject {
...
object SchemaGoogleIdentityStsV1betaExchangeTokenRequest {
  
  inline def apply(): SchemaGoogleIdentityStsV1betaExchangeTokenRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleIdentityStsV1betaExchangeTokenRequest]
  }
  
  extension [Self <: SchemaGoogleIdentityStsV1betaExchangeTokenRequest](x: Self) {
