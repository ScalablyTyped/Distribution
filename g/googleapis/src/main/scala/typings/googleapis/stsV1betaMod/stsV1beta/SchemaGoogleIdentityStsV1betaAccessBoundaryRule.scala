...
trait SchemaGoogleIdentityStsV1betaAccessBoundaryRule extends StObject {
...
object SchemaGoogleIdentityStsV1betaAccessBoundaryRule {
  
  inline def apply(): SchemaGoogleIdentityStsV1betaAccessBoundaryRule = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleIdentityStsV1betaAccessBoundaryRule]
  }
  
  extension [Self <: SchemaGoogleIdentityStsV1betaAccessBoundaryRule](x: Self) {
