...
trait SchemaGoogleIdentityStsV1betaExchangeTokenResponse extends StObject {
...
object SchemaGoogleIdentityStsV1betaExchangeTokenResponse {
  
  inline def apply(): SchemaGoogleIdentityStsV1betaExchangeTokenResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleIdentityStsV1betaExchangeTokenResponse]
  }
  
  extension [Self <: SchemaGoogleIdentityStsV1betaExchangeTokenResponse](x: Self) {
