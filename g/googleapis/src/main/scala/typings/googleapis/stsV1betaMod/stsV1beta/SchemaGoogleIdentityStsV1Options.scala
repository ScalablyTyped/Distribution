...
trait SchemaGoogleIdentityStsV1Options extends StObject {
  ...
  /**
    ...
    */
  var accessBoundary: js.UndefOr[SchemaGoogleIdentityStsV1AccessBoundary] = js.undefined
...
object SchemaGoogleIdentityStsV1Options {
  
  inline def apply(): SchemaGoogleIdentityStsV1Options = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleIdentityStsV1Options]
  }
  
  extension [Self <: SchemaGoogleIdentityStsV1Options](x: Self) {
    
    inline def setAccessBoundary(value: SchemaGoogleIdentityStsV1AccessBoundary): Self = StObject.set(x, "accessBoundary", value.asInstanceOf[js.Any])
