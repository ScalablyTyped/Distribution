...
trait ParamsResourceProjectsLocationsRegistrationsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsRegistrationsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsRegistrationsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRegistrationsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRegistrationsGetiampolicy](x: Self) {
