...
/**
  ...
  */
@js.native
trait Schema$GoogleDevtoolsRemoteexecutionV1testOutputFile extends js.Object {
  /**
...
object Schema$GoogleDevtoolsRemoteexecutionV1testOutputFile {
  @scala.inline
  def apply(
    content: String = null,
    ...
    path: String = null
  ): Schema$GoogleDevtoolsRemoteexecutionV1testOutputFile = {
    ...
    __obj.asInstanceOf[Schema$GoogleDevtoolsRemoteexecutionV1testOutputFile]
  }
}
