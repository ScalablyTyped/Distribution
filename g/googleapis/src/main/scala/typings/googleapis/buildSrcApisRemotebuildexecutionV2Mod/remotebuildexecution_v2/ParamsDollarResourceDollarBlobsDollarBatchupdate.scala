...
@js.native
trait ParamsDollarResourceDollarBlobsDollarBatchupdate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest] = js.native
}
