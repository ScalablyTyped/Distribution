...
/**
  ...
  */
@js.native
trait Schema$BuildBazelRemoteExecutionV2ResultsCachePolicy extends js.Object {
  /**
...
object Schema$BuildBazelRemoteExecutionV2ResultsCachePolicy {
  @scala.inline
  def apply(priority: Int | Double = null): Schema$BuildBazelRemoteExecutionV2ResultsCachePolicy = {
    val __obj = js.Dynamic.literal()
    if (priority != null) __obj.updateDynamic("priority")(priority.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$BuildBazelRemoteExecutionV2ResultsCachePolicy]
  }
}
