...
@js.native
trait ParamsDollarResourceDollarActionsDollarExecute extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$BuildBazelRemoteExecutionV2ExecuteRequest] = js.native
}
