...
/**
  ...
  */
@js.native
trait Schema$GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance extends js.Object {
  /**
...
object Schema$GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance]
  }
}
