...
/**
  ...
  */
@js.native
trait Schema$BuildBazelRemoteExecutionV2ActionResult extends js.Object {
  /**
    * The details of the execution that originally produced this result.
    */
  var executionMetadata: js.UndefOr[Schema$BuildBazelRemoteExecutionV2ExecutedActionMetadata] = js.native
  /**
  ...
  /**
    ...
    * is_executable: true       }     ]   } } ```
    */
  var outputDirectories: js.UndefOr[js.Array[Schema$BuildBazelRemoteExecutionV2OutputDirectory]] = js.native
  /**
    ...
    */
  var outputDirectorySymlinks: js.UndefOr[js.Array[Schema$BuildBazelRemoteExecutionV2OutputSymlink]] = js.native
  /**
    ...
    * sorted.
    */
  var outputFileSymlinks: js.UndefOr[js.Array[Schema$BuildBazelRemoteExecutionV2OutputSymlink]] = js.native
  /**
    ...
    */
  var outputFiles: js.UndefOr[js.Array[Schema$BuildBazelRemoteExecutionV2OutputFile]] = js.native
  /**
    * The digest for a blob containing the standard error of the action, which
    * can be retrieved from the ContentAddressableStorage. See `stderr_raw` for
    * when this will be set.
    */
  var stderrDigest: js.UndefOr[Schema$BuildBazelRemoteExecutionV2Digest] = js.native
  /**
  ...
  /**
    ...
    * when this will be set.
    */
  var stdoutDigest: js.UndefOr[Schema$BuildBazelRemoteExecutionV2Digest] = js.native
  /**
...
object Schema$BuildBazelRemoteExecutionV2ActionResult {
  @scala.inline
  def apply(
    executionMetadata: Schema$BuildBazelRemoteExecutionV2ExecutedActionMetadata = null,
    exitCode: Int | Double = null,
    outputDirectories: js.Array[Schema$BuildBazelRemoteExecutionV2OutputDirectory] = null,
    outputDirectorySymlinks: js.Array[Schema$BuildBazelRemoteExecutionV2OutputSymlink] = null,
    outputFileSymlinks: js.Array[Schema$BuildBazelRemoteExecutionV2OutputSymlink] = null,
    outputFiles: js.Array[Schema$BuildBazelRemoteExecutionV2OutputFile] = null,
    stderrDigest: Schema$BuildBazelRemoteExecutionV2Digest = null,
    stderrRaw: String = null,
    stdoutDigest: Schema$BuildBazelRemoteExecutionV2Digest = null,
    ...
    __obj.asInstanceOf[Schema$BuildBazelRemoteExecutionV2ActionResult]
  }
}
