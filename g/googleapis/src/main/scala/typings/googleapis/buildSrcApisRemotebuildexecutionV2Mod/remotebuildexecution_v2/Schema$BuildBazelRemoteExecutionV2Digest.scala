...
/**
  ...
  */
@js.native
trait Schema$BuildBazelRemoteExecutionV2Digest extends js.Object {
  /**
...
object Schema$BuildBazelRemoteExecutionV2Digest {
  @scala.inline
  def apply(hash: String = null, sizeBytes: String = null): Schema$BuildBazelRemoteExecutionV2Digest = {
    val __obj = js.Dynamic.literal()
    if (hash != null) __obj.updateDynamic("hash")(hash.asInstanceOf[js.Any])
    if (sizeBytes != null) __obj.updateDynamic("sizeBytes")(sizeBytes.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$BuildBazelRemoteExecutionV2Digest]
  }
}
