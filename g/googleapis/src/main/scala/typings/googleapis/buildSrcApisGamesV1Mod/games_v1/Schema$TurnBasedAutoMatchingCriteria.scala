...
/**
  ...
  */
@js.native
trait Schema$TurnBasedAutoMatchingCriteria extends js.Object {
  /**
...
object Schema$TurnBasedAutoMatchingCriteria {
  @scala.inline
  def apply(
  ...
  ): Schema$TurnBasedAutoMatchingCriteria = {
    ...
    __obj.asInstanceOf[Schema$TurnBasedAutoMatchingCriteria]
  }
}
