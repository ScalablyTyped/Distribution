...
@js.native
trait ParamsDollarResourceDollarScoresDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarScoresDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarScoresDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarScoresDollarGet]
  }
}
