...
/**
  ...
  */
@js.native
trait Schema$RoomAutoMatchingCriteria extends js.Object {
  /**
...
object Schema$RoomAutoMatchingCriteria {
  @scala.inline
  def apply(
  ...
  ): Schema$RoomAutoMatchingCriteria = {
    ...
    __obj.asInstanceOf[Schema$RoomAutoMatchingCriteria]
  }
}
