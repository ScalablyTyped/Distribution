...
@js.native
trait ParamsDollarResourceDollarScoresDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarScoresDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarScoresDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarScoresDollarList]
  }
}
