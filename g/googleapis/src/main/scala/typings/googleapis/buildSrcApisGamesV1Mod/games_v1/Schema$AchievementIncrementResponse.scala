...
/**
  ...
  */
@js.native
trait Schema$AchievementIncrementResponse extends js.Object {
  /**
...
object Schema$AchievementIncrementResponse {
  @scala.inline
  def apply(
    currentSteps: Int | Double = null,
    kind: String = null,
    newlyUnlocked: js.UndefOr[Boolean] = js.undefined
  ): Schema$AchievementIncrementResponse = {
    ...
    __obj.asInstanceOf[Schema$AchievementIncrementResponse]
  }
}
