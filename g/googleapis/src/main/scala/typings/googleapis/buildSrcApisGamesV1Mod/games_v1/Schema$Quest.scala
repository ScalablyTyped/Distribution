...
/**
  ...
  */
@js.native
trait Schema$Quest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var milestones: js.UndefOr[js.Array[Schema$QuestMilestone]] = js.native
  /**
...
object Schema$Quest {
  ...
  def apply(
    ...
    milestones: js.Array[Schema$QuestMilestone] = null,
    name: String = null,
    ...
    __obj.asInstanceOf[Schema$Quest]
  }
}
