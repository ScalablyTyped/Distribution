...
@js.native
trait ParamsDollarResourceDollarAchievementsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAchievementsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    state: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarAchievementsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAchievementsDollarList]
  }
}
