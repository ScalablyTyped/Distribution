...
/**
  ...
  */
@js.native
trait Schema$RoomLeaveDiagnostics extends js.Object {
  /**
  ...
  /**
    ...
    */
  var peerSession: js.UndefOr[js.Array[Schema$PeerSessionDiagnostics]] = js.native
  /**
...
object Schema$RoomLeaveDiagnostics {
  @scala.inline
  def apply(
    ...
    peerSession: js.Array[Schema$PeerSessionDiagnostics] = null,
    socketsUsed: js.UndefOr[Boolean] = js.undefined
  ): Schema$RoomLeaveDiagnostics = {
    ...
    __obj.asInstanceOf[Schema$RoomLeaveDiagnostics]
  }
}
