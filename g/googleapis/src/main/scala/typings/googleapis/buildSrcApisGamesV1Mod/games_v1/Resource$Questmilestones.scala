...
@js.native
class Resource$Questmilestones protected () extends js.Object {
  ...
  def claim(params: ParamsDollarResourceDollarQuestmilestonesDollarClaim): GaxiosPromise[Unit] = js.native
  def claim(params: ParamsDollarResourceDollarQuestmilestonesDollarClaim, callback: BodyResponseCallback[Unit]): Unit = js.native
  def claim(
    params: ParamsDollarResourceDollarQuestmilestonesDollarClaim,
    options: BodyResponseCallback[Unit],
    callback: BodyResponseCallback[Unit]
  ): Unit = js.native
  def claim(params: ParamsDollarResourceDollarQuestmilestonesDollarClaim, options: MethodOptions): GaxiosPromise[Unit] = js.native
  def claim(
    params: ParamsDollarResourceDollarQuestmilestonesDollarClaim,
