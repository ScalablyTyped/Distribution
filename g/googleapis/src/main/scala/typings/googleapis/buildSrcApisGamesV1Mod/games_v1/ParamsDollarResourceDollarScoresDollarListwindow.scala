...
@js.native
trait ParamsDollarResourceDollarScoresDollarListwindow extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarScoresDollarListwindow {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarScoresDollarListwindow = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarScoresDollarListwindow]
  }
}
