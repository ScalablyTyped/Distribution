...
@js.native
trait ParamsDollarResourceDollarTurnbasedmatchesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTurnbasedmatchesDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTurnbasedmatchesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTurnbasedmatchesDollarGet]
  }
}
