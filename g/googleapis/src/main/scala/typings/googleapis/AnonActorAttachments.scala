...
@js.native
trait AnonActorAttachments extends js.Object {
  var actor: js.UndefOr[AnonClientSpecificActorInfoDisplayName] = js.native
  var attachments: js.UndefOr[js.Array[AnonContentDisplayName]] = js.native
...
object AnonActorAttachments {
  @scala.inline
  def apply(
    actor: AnonClientSpecificActorInfoDisplayName = null,
    attachments: js.Array[AnonContentDisplayName] = null,
    content: String = null,
    id: String = null,
    ...
    __obj.asInstanceOf[AnonActorAttachments]
  }
}
