...
trait SchemaBuild extends StObject {
  ...
  /**
    ...
    */
  var approval: js.UndefOr[SchemaBuildApproval] = js.undefined
  ...
  /**
    ...
    */
  var availableSecrets: js.UndefOr[SchemaSecrets] = js.undefined
  ...
  /**
    ...
    */
  var failureInfo: js.UndefOr[SchemaFailureInfo] = js.undefined
  ...
  /**
    ...
    */
  var timing: js.UndefOr[StringDictionary[SchemaTimeSpan] | Null] = js.undefined
  
  /**
    * Output only. Non-fatal problems encountered during the execution of the build.
    */
  var warnings: js.UndefOr[js.Array[SchemaWarning]] = js.undefined
}
object SchemaBuild {
  ...
  extension [Self <: SchemaBuild](x: Self) {
    ...
    inline def setApproval(value: SchemaBuildApproval): Self = StObject.set(x, "approval", value.asInstanceOf[js.Any])
    ...
    inline def setAvailableSecrets(value: SchemaSecrets): Self = StObject.set(x, "availableSecrets", value.asInstanceOf[js.Any])
    ...
    inline def setFailureInfo(value: SchemaFailureInfo): Self = StObject.set(x, "failureInfo", value.asInstanceOf[js.Any])
    ...
    inline def setStepsVarargs(value: SchemaBuildStep*): Self = StObject.set(x, "steps", js.Array(value*))
    ...
    inline def setWarnings(value: js.Array[SchemaWarning]): Self = StObject.set(x, "warnings", value.asInstanceOf[js.Any])
    
    inline def setWarningsUndefined: Self = StObject.set(x, "warnings", js.undefined)
    
    inline def setWarningsVarargs(value: SchemaWarning*): Self = StObject.set(x, "warnings", js.Array(value*))
  }
}
