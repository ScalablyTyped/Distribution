...
object SchemaIterationResult {
  ...
  extension [Self <: SchemaIterationResult](x: Self) {
    ...
    inline def setClusterInfos(value: js.Array[SchemaClusterInfo]): Self = StObject.set(x, "clusterInfos", value.asInstanceOf[js.Any])
    
    inline def setClusterInfosUndefined: Self = StObject.set(x, "clusterInfos", js.undefined)
    
    inline def setClusterInfosVarargs(value: SchemaClusterInfo*): Self = StObject.set(x, "clusterInfos", js.Array(value :_*))
