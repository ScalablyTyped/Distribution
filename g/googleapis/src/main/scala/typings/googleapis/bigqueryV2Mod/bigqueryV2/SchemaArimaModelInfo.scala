...
trait SchemaArimaModelInfo extends StObject {
  
  /**
    * Arima coefficients.
    */
  var arimaCoefficients: js.UndefOr[SchemaArimaCoefficients] = js.undefined
...
object SchemaArimaModelInfo {
  
  inline def apply(): SchemaArimaModelInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaArimaModelInfo]
  }
  
  extension [Self <: SchemaArimaModelInfo](x: Self) {
    
    inline def setArimaCoefficients(value: SchemaArimaCoefficients): Self = StObject.set(x, "arimaCoefficients", value.asInstanceOf[js.Any])
