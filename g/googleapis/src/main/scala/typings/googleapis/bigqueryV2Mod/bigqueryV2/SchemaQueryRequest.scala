...
trait SchemaQueryRequest extends StObject {
  ...
  /**
    ...
    */
  var connectionProperties: js.UndefOr[js.Array[SchemaConnectionProperty]] = js.undefined
  
  /**
    * If true, creates a new session, where session id will be a server generated random id. If false, runs query with an existing session_id passed in ConnectionProperty, otherwise runs query in non-session mode.
    */
  var createSession: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var maximumBytesBilled: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Standard SQL only. Set to POSITIONAL to use positional (?) query parameters or to NAMED to use named (@myparam) query parameters in this query.
    */
  var parameterMode: js.UndefOr[String | Null] = js.undefined
  
  /**
    * [Deprecated] This property is deprecated.
    */
  var preserveNulls: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var timeoutMs: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var useQueryCache: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaQueryRequest {
  ...
  extension [Self <: SchemaQueryRequest](x: Self) {
    ...
    inline def setConnectionProperties(value: js.Array[SchemaConnectionProperty]): Self = StObject.set(x, "connectionProperties", value.asInstanceOf[js.Any])
    
    inline def setConnectionPropertiesUndefined: Self = StObject.set(x, "connectionProperties", js.undefined)
    
    inline def setConnectionPropertiesVarargs(value: SchemaConnectionProperty*): Self = StObject.set(x, "connectionProperties", js.Array(value*))
    
    inline def setCreateSession(value: Boolean): Self = StObject.set(x, "createSession", value.asInstanceOf[js.Any])
    
    inline def setCreateSessionNull: Self = StObject.set(x, "createSession", null)
    
    inline def setCreateSessionUndefined: Self = StObject.set(x, "createSession", js.undefined)
    
    inline def setDefaultDataset(value: SchemaDatasetReference): Self = StObject.set(x, "defaultDataset", value.asInstanceOf[js.Any])
    ...
    inline def setMaximumBytesBilledNull: Self = StObject.set(x, "maximumBytesBilled", null)
    ...
    inline def setParameterModeNull: Self = StObject.set(x, "parameterMode", null)
    ...
    inline def setPreserveNullsNull: Self = StObject.set(x, "preserveNulls", null)
    ...
    inline def setQueryParameters(value: js.Array[SchemaQueryParameter]): Self = StObject.set(x, "queryParameters", value.asInstanceOf[js.Any])
    
    inline def setQueryParametersUndefined: Self = StObject.set(x, "queryParameters", js.undefined)
    
    inline def setQueryParametersVarargs(value: SchemaQueryParameter*): Self = StObject.set(x, "queryParameters", js.Array(value*))
    ...
    inline def setTimeoutMsNull: Self = StObject.set(x, "timeoutMs", null)
    ...
    inline def setUseQueryCacheNull: Self = StObject.set(x, "useQueryCache", null)
