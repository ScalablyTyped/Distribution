...
object SchemaJobConfigurationQuery {
  ...
  @scala.inline
  implicit class SchemaJobConfigurationQueryMutableBuilder[Self <: SchemaJobConfigurationQuery] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTableDefinitions(value: StringDictionary[SchemaExternalDataConfiguration]): Self = StObject.set(x, "tableDefinitions", value.asInstanceOf[js.Any])
