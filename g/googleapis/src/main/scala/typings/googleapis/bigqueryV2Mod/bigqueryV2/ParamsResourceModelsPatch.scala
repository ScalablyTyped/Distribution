...
object ParamsResourceModelsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceModelsPatchOps[Self <: ParamsResourceModelsPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaModel): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
