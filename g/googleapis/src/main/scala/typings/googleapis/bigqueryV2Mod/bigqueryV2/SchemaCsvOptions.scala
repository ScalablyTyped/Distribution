...
trait SchemaCsvOptions extends StObject {
  ...
  /**
    ...
    */
  var null_marker: js.UndefOr[String | Null] = js.undefined
...
object SchemaCsvOptions {
  ...
  inline def apply(): SchemaCsvOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCsvOptions]
  }
  
  extension [Self <: SchemaCsvOptions](x: Self) {
    ...
    inline def setNull_markerNull: Self = StObject.set(x, "null_marker", null)
