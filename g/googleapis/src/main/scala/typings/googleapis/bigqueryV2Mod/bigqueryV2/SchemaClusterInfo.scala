...
trait SchemaClusterInfo extends StObject {
  ...
  /**
    ...
    */
  var clusterRadius: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * Cluster size, the total number of points assigned to the cluster.
    */
  var clusterSize: js.UndefOr[String | Null] = js.undefined
}
object SchemaClusterInfo {
  ...
  extension [Self <: SchemaClusterInfo](x: Self) {
    ...
    inline def setClusterRadiusNull: Self = StObject.set(x, "clusterRadius", null)
    ...
    inline def setClusterSizeNull: Self = StObject.set(x, "clusterSize", null)
