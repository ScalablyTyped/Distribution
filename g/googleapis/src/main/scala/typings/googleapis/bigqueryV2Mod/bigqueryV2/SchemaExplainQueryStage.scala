...
object SchemaExplainQueryStage {
  ...
  @scala.inline
  implicit class SchemaExplainQueryStageMutableBuilder[Self <: SchemaExplainQueryStage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSteps(value: js.Array[SchemaExplainQueryStep]): Self = StObject.set(x, "steps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStepsUndefined: Self = StObject.set(x, "steps", js.undefined)
    
    @scala.inline
    def setStepsVarargs(value: SchemaExplainQueryStep*): Self = StObject.set(x, "steps", js.Array(value :_*))
