...
trait SchemaHivePartitioningOptions extends StObject {
  ...
  /**
    ...
    */
  var sourceUriPrefix: js.UndefOr[String | Null] = js.undefined
}
object SchemaHivePartitioningOptions {
  
  inline def apply(): SchemaHivePartitioningOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaHivePartitioningOptions]
  }
  
  extension [Self <: SchemaHivePartitioningOptions](x: Self) {
    ...
    inline def setSourceUriPrefixNull: Self = StObject.set(x, "sourceUriPrefix", null)
