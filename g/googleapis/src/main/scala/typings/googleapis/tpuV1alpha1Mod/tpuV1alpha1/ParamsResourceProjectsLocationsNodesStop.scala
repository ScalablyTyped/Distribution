...
object ParamsResourceProjectsLocationsNodesStop {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsNodesStopOps[Self <: ParamsResourceProjectsLocationsNodesStop] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaStopNodeRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
