...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative extends js.Object {
  /**
...
object SchemaGoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternativeOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setWordsVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1WordInfo*): Self = this.set("words", js.Array(value :_*))
    @scala.inline
    def setWords(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1WordInfo]): Self = this.set("words", value.asInstanceOf[js.Any])
    @scala.inline
