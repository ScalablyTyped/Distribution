...
trait SchemaGoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1FaceDetectionAnnotation](x: Self) {
