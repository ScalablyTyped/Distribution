...
trait SchemaGoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation extends StObject {
  ...
  /**
    ...
    */
  var frames: js.UndefOr[js.Array[SchemaGoogleCloudVideointelligenceV1beta2ObjectTrackingFrame]] = js.undefined
...
object SchemaGoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation](x: Self) {
    ...
    inline def setFrames(value: js.Array[SchemaGoogleCloudVideointelligenceV1beta2ObjectTrackingFrame]): Self = StObject.set(x, "frames", value.asInstanceOf[js.Any])
    
    inline def setFramesUndefined: Self = StObject.set(x, "frames", js.undefined)
    
    inline def setFramesVarargs(value: SchemaGoogleCloudVideointelligenceV1beta2ObjectTrackingFrame*): Self = StObject.set(x, "frames", js.Array(value :_*))
