...
object SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationProgress](x: Self) {
