...
object SchemaGoogleCloudVideointelligenceV1p2beta1WordInfo {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p2beta1WordInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1WordInfo]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1WordInfoMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1WordInfo] (val x: Self) extends AnyVal {
