...
trait SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse extends StObject {
  ...
  /**
    ...
    */
  var annotationResults: js.UndefOr[js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationResults]] = js.undefined
}
object SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1AnnotateVideoResponse](x: Self) {
    
    inline def setAnnotationResults(value: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1VideoAnnotationResults]): Self = StObject.set(x, "annotationResults", value.asInstanceOf[js.Any])
