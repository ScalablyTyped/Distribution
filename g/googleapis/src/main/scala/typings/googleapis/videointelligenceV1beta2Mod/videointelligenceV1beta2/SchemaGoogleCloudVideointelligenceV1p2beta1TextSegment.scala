...
trait SchemaGoogleCloudVideointelligenceV1p2beta1TextSegment extends StObject {
  ...
  /**
    ...
    */
  var frames: js.UndefOr[js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1TextFrame]] = js.undefined
...
object SchemaGoogleCloudVideointelligenceV1p2beta1TextSegment {
  ...
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1TextSegment](x: Self) {
    ...
    inline def setFramesVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1TextFrame*): Self = StObject.set(x, "frames", js.Array(value*))
