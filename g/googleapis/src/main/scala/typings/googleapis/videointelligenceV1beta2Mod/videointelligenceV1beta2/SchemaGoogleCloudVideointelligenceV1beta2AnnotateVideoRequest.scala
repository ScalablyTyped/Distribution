...
object SchemaGoogleCloudVideointelligenceV1beta2AnnotateVideoRequest {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1beta2AnnotateVideoRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1beta2AnnotateVideoRequest]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1beta2AnnotateVideoRequest](x: Self) {
    ...
    inline def setVideoContext(value: SchemaGoogleCloudVideointelligenceV1beta2VideoContext): Self = StObject.set(x, "videoContext", value.asInstanceOf[js.Any])
