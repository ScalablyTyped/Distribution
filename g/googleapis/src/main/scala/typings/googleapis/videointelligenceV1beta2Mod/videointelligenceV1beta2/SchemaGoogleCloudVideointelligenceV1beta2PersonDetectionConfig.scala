...
trait SchemaGoogleCloudVideointelligenceV1beta2PersonDetectionConfig extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1beta2PersonDetectionConfig {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1beta2PersonDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1beta2PersonDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1beta2PersonDetectionConfig](x: Self) {
