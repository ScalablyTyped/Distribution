...
/**
  ...
  */
trait SchemaGoogleCloudVideointelligenceV1beta2LabelDetectionConfig extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1beta2LabelDetectionConfig {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1beta2LabelDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1beta2LabelDetectionConfig]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1beta2LabelDetectionConfigMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1beta2LabelDetectionConfig] (val x: Self) extends AnyVal {
