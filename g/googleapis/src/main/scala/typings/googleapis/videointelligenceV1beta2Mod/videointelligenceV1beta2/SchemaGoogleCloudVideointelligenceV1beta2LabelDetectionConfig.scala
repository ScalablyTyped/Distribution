...
object SchemaGoogleCloudVideointelligenceV1beta2LabelDetectionConfig {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1beta2LabelDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1beta2LabelDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1beta2LabelDetectionConfig](x: Self) {
