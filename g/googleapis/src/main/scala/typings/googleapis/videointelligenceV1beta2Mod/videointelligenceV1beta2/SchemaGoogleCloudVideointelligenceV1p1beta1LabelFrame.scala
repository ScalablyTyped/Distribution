...
object SchemaGoogleCloudVideointelligenceV1p1beta1LabelFrame {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1LabelFrameOps[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1LabelFrame] (val x: Self) extends AnyVal {
    @scala.inline
