...
trait SchemaGoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation extends StObject {
  ...
  /**
    ...
    */
  var frames: js.UndefOr[js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1ObjectTrackingFrame]] = js.undefined
...
object SchemaGoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation](x: Self) {
    ...
    inline def setFrames(value: js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1ObjectTrackingFrame]): Self = StObject.set(x, "frames", value.asInstanceOf[js.Any])
    
    inline def setFramesUndefined: Self = StObject.set(x, "frames", js.undefined)
    
    inline def setFramesVarargs(value: SchemaGoogleCloudVideointelligenceV1p3beta1ObjectTrackingFrame*): Self = StObject.set(x, "frames", js.Array(value :_*))
