...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1SpeechTranscription extends js.Object {
  /**
    ...
    */
  var alternatives: js.UndefOr[js.Array[SchemaGoogleCloudVideointelligenceV1SpeechRecognitionAlternative]] = js.native
  /**
...
object SchemaGoogleCloudVideointelligenceV1SpeechTranscription {
  ...
  implicit class SchemaGoogleCloudVideointelligenceV1SpeechTranscriptionOps[Self <: SchemaGoogleCloudVideointelligenceV1SpeechTranscription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlternativesVarargs(value: SchemaGoogleCloudVideointelligenceV1SpeechRecognitionAlternative*): Self = this.set("alternatives", js.Array(value :_*))
    @scala.inline
    def setAlternatives(value: js.Array[SchemaGoogleCloudVideointelligenceV1SpeechRecognitionAlternative]): Self = this.set("alternatives", value.asInstanceOf[js.Any])
    @scala.inline
