...
trait ParamsResourceBuyersFinalizeddealsList
  extends StObject
...
object ParamsResourceBuyersFinalizeddealsList {
  
  inline def apply(): ParamsResourceBuyersFinalizeddealsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBuyersFinalizeddealsList]
  }
  
  extension [Self <: ParamsResourceBuyersFinalizeddealsList](x: Self) {
