...
trait ParamsResourceBuyersClientsPatch
  extends StObject
...
object ParamsResourceBuyersClientsPatch {
  
  inline def apply(): ParamsResourceBuyersClientsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBuyersClientsPatch]
  }
  
  extension [Self <: ParamsResourceBuyersClientsPatch](x: Self) {
