...
object gamesManagementMod {
  ...
  @JSImport("googleapis/build/src/apis/gamesManagement", "AuthPlus")
  @js.native
  open class AuthPlus ()
  ...
  object VERSIONS {
    ...
    @js.native
    open class v1management protected () extends Gamesmanagement {
  ...
  object auth extends Shortcut {
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/gamesManagement", "auth.AwsClient")
    @js.native
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/gamesManagement", "auth.ExternalAccountClient")
    @js.native
    open class ExternalAccountClient ()
      extends typings.googleAuthLibrary.mod.ExternalAccountClient
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/gamesManagement", "auth.GoogleAuth")
    @js.native
    open class GoogleAuth[T /* <: AuthClient */] ()
      extends typings.googleAuthLibrary.mod.GoogleAuth[T]
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/gamesManagement", "auth.IdentityPoolClient")
    @js.native
  ...
  object gamesManagementV1management {
    ...
    @JSImport("googleapis/build/src/apis/gamesManagement", "gamesManagement_v1management.Gamesmanagement")
    @js.native
    open class Gamesmanagement protected ()
      extends typings.googleapis.v1managementMod.gamesManagementV1management.Gamesmanagement {
      def this(options: GlobalOptions) = this()
      def this(options: GlobalOptions, google: GoogleConfigurable) = this()
    }
    
    @JSImport("googleapis/build/src/apis/gamesManagement", "gamesManagement_v1management.Resource$Achievements")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/gamesManagement", "gamesManagement_v1management.Resource$Applications")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/gamesManagement", "gamesManagement_v1management.Resource$Events")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/gamesManagement", "gamesManagement_v1management.Resource$Players")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/gamesManagement", "gamesManagement_v1management.Resource$Scores")
    @js.native
