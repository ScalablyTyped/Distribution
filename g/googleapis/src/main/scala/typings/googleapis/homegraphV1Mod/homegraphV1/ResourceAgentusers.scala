...
@JSImport("googleapis/build/src/apis/homegraph/v1", "homegraph_v1.Resource$Agentusers")
@js.native
open class ResourceAgentusers protected () extends StObject {
  ...
  def delete(params: ParamsResourceAgentusersDelete): GaxiosPromise[SchemaEmpty] = js.native
  def delete(params: ParamsResourceAgentusersDelete, callback: BodyResponseCallback[SchemaEmpty]): Unit = js.native
  def delete(
    params: ParamsResourceAgentusersDelete,
    options: BodyResponseCallback[Readable | SchemaEmpty],
    callback: BodyResponseCallback[Readable | SchemaEmpty]
  ): Unit = js.native
  def delete(params: ParamsResourceAgentusersDelete, options: MethodOptions): GaxiosPromise[SchemaEmpty] = js.native
  def delete(
    params: ParamsResourceAgentusersDelete,
  ...
  /**
    ...
    */
  def delete(params: ParamsResourceAgentusersDelete, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def delete(
    params: ParamsResourceAgentusersDelete,
