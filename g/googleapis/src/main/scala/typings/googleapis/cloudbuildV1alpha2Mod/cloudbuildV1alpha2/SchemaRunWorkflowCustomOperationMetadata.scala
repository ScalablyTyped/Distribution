...
trait SchemaRunWorkflowCustomOperationMetadata extends StObject {
  ...
  /**
    ...
    */
  var pipelineRunId: js.UndefOr[String | Null] = js.undefined
...
object SchemaRunWorkflowCustomOperationMetadata {
  
  inline def apply(): SchemaRunWorkflowCustomOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRunWorkflowCustomOperationMetadata]
  }
  
  extension [Self <: SchemaRunWorkflowCustomOperationMetadata](x: Self) {
    ...
    inline def setPipelineRunIdNull: Self = StObject.set(x, "pipelineRunId", null)
