...
@js.native
open class ResourceStatements protected () extends StObject {
  ...
  def list(
    ...
    options: BodyResponseCallback[Readable | SchemaListResponse],
    callback: BodyResponseCallback[Readable | SchemaListResponse]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def list(params: ParamsResourceStatementsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceStatementsList,
