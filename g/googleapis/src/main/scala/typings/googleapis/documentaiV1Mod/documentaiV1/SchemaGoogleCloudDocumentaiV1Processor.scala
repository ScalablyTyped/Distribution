...
trait SchemaGoogleCloudDocumentaiV1Processor extends StObject {
...
object SchemaGoogleCloudDocumentaiV1Processor {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1Processor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1Processor]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1Processor](x: Self) {
