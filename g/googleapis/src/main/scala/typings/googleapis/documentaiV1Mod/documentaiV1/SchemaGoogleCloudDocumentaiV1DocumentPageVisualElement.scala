...
trait SchemaGoogleCloudDocumentaiV1DocumentPageVisualElement extends StObject {
...
object SchemaGoogleCloudDocumentaiV1DocumentPageVisualElement {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentPageVisualElement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentPageVisualElement]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentPageVisualElement](x: Self) {
