...
trait SchemaGoogleCloudDocumentaiV1DocumentPageSymbol extends StObject {
...
object SchemaGoogleCloudDocumentaiV1DocumentPageSymbol {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentPageSymbol = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentPageSymbol]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentPageSymbol](x: Self) {
