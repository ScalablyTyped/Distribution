...
trait SchemaGoogleCloudDocumentaiV1DocumentPageLayout extends StObject {
  
  /**
    * The bounding polygon for the Layout.
    */
  var boundingPoly: js.UndefOr[SchemaGoogleCloudDocumentaiV1BoundingPoly] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1DocumentPageLayout {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentPageLayout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentPageLayout]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentPageLayout](x: Self) {
    
    inline def setBoundingPoly(value: SchemaGoogleCloudDocumentaiV1BoundingPoly): Self = StObject.set(x, "boundingPoly", value.asInstanceOf[js.Any])
