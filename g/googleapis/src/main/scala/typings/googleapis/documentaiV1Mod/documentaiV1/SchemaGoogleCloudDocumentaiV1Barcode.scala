...
trait SchemaGoogleCloudDocumentaiV1Barcode extends StObject {
...
object SchemaGoogleCloudDocumentaiV1Barcode {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1Barcode = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1Barcode]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1Barcode](x: Self) {
