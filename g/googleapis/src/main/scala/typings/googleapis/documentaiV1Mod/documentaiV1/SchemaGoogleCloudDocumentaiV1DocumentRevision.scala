...
trait SchemaGoogleCloudDocumentaiV1DocumentRevision extends StObject {
  ...
  /**
    ...
    */
  var humanReview: js.UndefOr[SchemaGoogleCloudDocumentaiV1DocumentRevisionHumanReview] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1DocumentRevision {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentRevision = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentRevision]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentRevision](x: Self) {
    ...
    inline def setHumanReview(value: SchemaGoogleCloudDocumentaiV1DocumentRevisionHumanReview): Self = StObject.set(x, "humanReview", value.asInstanceOf[js.Any])
