...
trait SchemaGoogleCloudDocumentaiV1beta1DocumentEntityRelation extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta1DocumentEntityRelation {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta1DocumentEntityRelation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta1DocumentEntityRelation]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta1DocumentEntityRelation](x: Self) {
