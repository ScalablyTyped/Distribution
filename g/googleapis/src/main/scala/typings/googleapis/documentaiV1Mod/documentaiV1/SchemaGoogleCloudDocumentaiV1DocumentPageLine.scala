...
trait SchemaGoogleCloudDocumentaiV1DocumentPageLine extends StObject {
...
object SchemaGoogleCloudDocumentaiV1DocumentPageLine {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentPageLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentPageLine]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentPageLine](x: Self) {
