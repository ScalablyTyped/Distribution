...
trait SchemaGoogleCloudDocumentaiV1beta1DocumentPageToken extends StObject {
  
  /**
    * Detected break at the end of a Token.
    */
  var detectedBreak: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta1DocumentPageTokenDetectedBreak] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1beta1DocumentPageToken {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta1DocumentPageToken = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta1DocumentPageToken]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta1DocumentPageToken](x: Self) {
    
    inline def setDetectedBreak(value: SchemaGoogleCloudDocumentaiV1beta1DocumentPageTokenDetectedBreak): Self = StObject.set(x, "detectedBreak", value.asInstanceOf[js.Any])
