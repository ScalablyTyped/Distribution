...
trait SchemaGoogleCloudDocumentaiV1DocumentEntityNormalizedValue extends StObject {
...
object SchemaGoogleCloudDocumentaiV1DocumentEntityNormalizedValue {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentEntityNormalizedValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentEntityNormalizedValue]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentEntityNormalizedValue](x: Self) {
