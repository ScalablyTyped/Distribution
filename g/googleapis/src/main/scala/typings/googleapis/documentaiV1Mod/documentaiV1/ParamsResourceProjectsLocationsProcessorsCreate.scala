...
trait ParamsResourceProjectsLocationsProcessorsCreate
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDocumentaiV1Processor] = js.undefined
}
object ParamsResourceProjectsLocationsProcessorsCreate {
  ...
  extension [Self <: ParamsResourceProjectsLocationsProcessorsCreate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDocumentaiV1Processor): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
