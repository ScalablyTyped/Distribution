...
trait SchemaGoogleCloudDocumentaiV1beta1DocumentPageLayout extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta1DocumentPageLayout {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta1DocumentPageLayout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta1DocumentPageLayout]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta1DocumentPageLayout](x: Self) {
