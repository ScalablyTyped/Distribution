...
trait SchemaGoogleCloudDocumentaiV1beta2DocumentRevision extends StObject {
  ...
  /**
    ...
    */
  var humanReview: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta2DocumentRevisionHumanReview] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1beta2DocumentRevision {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta2DocumentRevision = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta2DocumentRevision]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta2DocumentRevision](x: Self) {
    ...
    inline def setHumanReview(value: SchemaGoogleCloudDocumentaiV1beta2DocumentRevisionHumanReview): Self = StObject.set(x, "humanReview", value.asInstanceOf[js.Any])
