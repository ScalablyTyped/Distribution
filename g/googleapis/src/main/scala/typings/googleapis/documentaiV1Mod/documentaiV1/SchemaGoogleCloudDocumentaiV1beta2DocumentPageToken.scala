...
trait SchemaGoogleCloudDocumentaiV1beta2DocumentPageToken extends StObject {
  
  /**
    * Detected break at the end of a Token.
    */
  var detectedBreak: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta2DocumentPageTokenDetectedBreak] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1beta2DocumentPageToken {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta2DocumentPageToken = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta2DocumentPageToken]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta2DocumentPageToken](x: Self) {
    
    inline def setDetectedBreak(value: SchemaGoogleCloudDocumentaiV1beta2DocumentPageTokenDetectedBreak): Self = StObject.set(x, "detectedBreak", value.asInstanceOf[js.Any])
