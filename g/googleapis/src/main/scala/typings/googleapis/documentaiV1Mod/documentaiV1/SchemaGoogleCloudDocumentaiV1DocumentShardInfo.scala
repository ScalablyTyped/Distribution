...
trait SchemaGoogleCloudDocumentaiV1DocumentShardInfo extends StObject {
...
object SchemaGoogleCloudDocumentaiV1DocumentShardInfo {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentShardInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentShardInfo]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentShardInfo](x: Self) {
