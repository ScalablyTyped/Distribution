...
trait SchemaGoogleCloudDocumentaiV1beta3HumanReviewStatus extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta3HumanReviewStatus {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3HumanReviewStatus = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3HumanReviewStatus]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3HumanReviewStatus](x: Self) {
