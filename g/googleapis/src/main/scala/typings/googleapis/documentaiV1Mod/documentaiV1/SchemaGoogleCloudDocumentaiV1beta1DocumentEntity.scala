...
trait SchemaGoogleCloudDocumentaiV1beta1DocumentEntity extends StObject {
  ...
  /**
    ...
    */
  var normalizedValue: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta1DocumentEntityNormalizedValue] = js.undefined
  
  /**
    * Optional. Represents the provenance of this entity wrt. the location on the page where it was found.
    */
  var pageAnchor: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta1DocumentPageAnchor] = js.undefined
  
  /**
    * Optional. Entities can be nested to form a hierarchical data structure representing the content in the document.
    */
  var properties: js.UndefOr[js.Array[SchemaGoogleCloudDocumentaiV1beta1DocumentEntity]] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1beta1DocumentEntity {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta1DocumentEntity = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta1DocumentEntity]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta1DocumentEntity](x: Self) {
    ...
    inline def setNormalizedValue(value: SchemaGoogleCloudDocumentaiV1beta1DocumentEntityNormalizedValue): Self = StObject.set(x, "normalizedValue", value.asInstanceOf[js.Any])
    
    inline def setNormalizedValueUndefined: Self = StObject.set(x, "normalizedValue", js.undefined)
    
    inline def setPageAnchor(value: SchemaGoogleCloudDocumentaiV1beta1DocumentPageAnchor): Self = StObject.set(x, "pageAnchor", value.asInstanceOf[js.Any])
    
    inline def setPageAnchorUndefined: Self = StObject.set(x, "pageAnchor", js.undefined)
    
    inline def setProperties(value: js.Array[SchemaGoogleCloudDocumentaiV1beta1DocumentEntity]): Self = StObject.set(x, "properties", value.asInstanceOf[js.Any])
    
    inline def setPropertiesUndefined: Self = StObject.set(x, "properties", js.undefined)
    
    inline def setPropertiesVarargs(value: SchemaGoogleCloudDocumentaiV1beta1DocumentEntity*): Self = StObject.set(x, "properties", js.Array(value*))
