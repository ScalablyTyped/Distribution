...
trait SchemaGoogleCloudDocumentaiV1beta1Barcode extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta1Barcode {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta1Barcode = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta1Barcode]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta1Barcode](x: Self) {
