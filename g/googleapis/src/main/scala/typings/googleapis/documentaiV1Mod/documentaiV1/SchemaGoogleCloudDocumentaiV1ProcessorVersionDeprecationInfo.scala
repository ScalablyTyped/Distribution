...
trait SchemaGoogleCloudDocumentaiV1ProcessorVersionDeprecationInfo extends StObject {
...
object SchemaGoogleCloudDocumentaiV1ProcessorVersionDeprecationInfo {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1ProcessorVersionDeprecationInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1ProcessorVersionDeprecationInfo]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1ProcessorVersionDeprecationInfo](x: Self) {
