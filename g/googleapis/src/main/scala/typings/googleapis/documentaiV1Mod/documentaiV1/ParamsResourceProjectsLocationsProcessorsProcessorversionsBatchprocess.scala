...
trait ParamsResourceProjectsLocationsProcessorsProcessorversionsBatchprocess
  extends StObject
...
object ParamsResourceProjectsLocationsProcessorsProcessorversionsBatchprocess {
  
  inline def apply(): ParamsResourceProjectsLocationsProcessorsProcessorversionsBatchprocess = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsProcessorsProcessorversionsBatchprocess]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsProcessorsProcessorversionsBatchprocess](x: Self) {
