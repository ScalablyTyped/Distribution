...
trait SchemaGoogleCloudDocumentaiV1ProcessorType extends StObject {
  ...
  /**
    ...
    */
  var availableLocations: js.UndefOr[js.Array[SchemaGoogleCloudDocumentaiV1ProcessorTypeLocationInfo]] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1ProcessorType {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1ProcessorType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1ProcessorType]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1ProcessorType](x: Self) {
    ...
    inline def setAvailableLocations(value: js.Array[SchemaGoogleCloudDocumentaiV1ProcessorTypeLocationInfo]): Self = StObject.set(x, "availableLocations", value.asInstanceOf[js.Any])
    
    inline def setAvailableLocationsUndefined: Self = StObject.set(x, "availableLocations", js.undefined)
    
    inline def setAvailableLocationsVarargs(value: SchemaGoogleCloudDocumentaiV1ProcessorTypeLocationInfo*): Self = StObject.set(x, "availableLocations", js.Array(value*))
