...
trait SchemaGoogleCloudDocumentaiV1DocumentPageToken extends StObject {
  
  /**
    * Detected break at the end of a Token.
    */
  var detectedBreak: js.UndefOr[SchemaGoogleCloudDocumentaiV1DocumentPageTokenDetectedBreak] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1DocumentPageToken {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentPageToken = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentPageToken]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentPageToken](x: Self) {
    
    inline def setDetectedBreak(value: SchemaGoogleCloudDocumentaiV1DocumentPageTokenDetectedBreak): Self = StObject.set(x, "detectedBreak", value.asInstanceOf[js.Any])
