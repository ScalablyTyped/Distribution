...
trait SchemaGoogleCloudDocumentaiV1DocumentPageAnchorPageRef extends StObject {
...
object SchemaGoogleCloudDocumentaiV1DocumentPageAnchorPageRef {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentPageAnchorPageRef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentPageAnchorPageRef]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentPageAnchorPageRef](x: Self) {
