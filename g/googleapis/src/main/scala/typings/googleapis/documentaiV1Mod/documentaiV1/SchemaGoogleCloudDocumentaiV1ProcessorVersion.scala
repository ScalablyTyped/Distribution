...
trait SchemaGoogleCloudDocumentaiV1ProcessorVersion extends StObject {
  ...
  /**
    ...
    */
  var deprecationInfo: js.UndefOr[SchemaGoogleCloudDocumentaiV1ProcessorVersionDeprecationInfo] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1ProcessorVersion {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1ProcessorVersion = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1ProcessorVersion]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1ProcessorVersion](x: Self) {
    ...
    inline def setDeprecationInfo(value: SchemaGoogleCloudDocumentaiV1ProcessorVersionDeprecationInfo): Self = StObject.set(x, "deprecationInfo", value.asInstanceOf[js.Any])
