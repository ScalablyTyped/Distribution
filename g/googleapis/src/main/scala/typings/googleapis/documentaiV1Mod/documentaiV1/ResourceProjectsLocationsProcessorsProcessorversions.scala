...
@JSImport("googleapis/build/src/apis/documentai/v1", "documentai_v1.Resource$Projects$Locations$Processors$Processorversions")
@js.native
open class ResourceProjectsLocationsProcessorsProcessorversions protected () extends StObject {
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ProcessorVersion] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ProcessorVersion]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ProcessorVersion] = js.native
  def get(params: ParamsResourceProjectsLocationsProcessorsProcessorversionsGet): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ProcessorVersion] = js.native
  def get(
    params: ParamsResourceProjectsLocationsProcessorsProcessorversionsGet,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ProcessorVersion]
  ): Unit = js.native
  def get(
    params: ParamsResourceProjectsLocationsProcessorsProcessorversionsGet,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1ProcessorVersion],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1ProcessorVersion]
  ): Unit = js.native
  def get(params: ParamsResourceProjectsLocationsProcessorsProcessorversionsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ProcessorVersion] = js.native
  def get(
    params: ParamsResourceProjectsLocationsProcessorsProcessorversionsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ProcessorVersion]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ListProcessorVersionsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ListProcessorVersionsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ListProcessorVersionsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsProcessorsProcessorversionsList): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ListProcessorVersionsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsProcessorsProcessorversionsList,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ListProcessorVersionsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsProcessorsProcessorversionsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1ListProcessorVersionsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1ListProcessorVersionsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsProcessorsProcessorversionsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ListProcessorVersionsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsProcessorsProcessorversionsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ListProcessorVersionsResponse]
  ...
  def process(params: ParamsResourceProjectsLocationsProcessorsProcessorversionsProcess): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ProcessResponse] = js.native
  def process(
  ...
  def process(params: ParamsResourceProjectsLocationsProcessorsProcessorversionsProcess, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ProcessResponse] = js.native
  def process(
    params: ParamsResourceProjectsLocationsProcessorsProcessorversionsProcess,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ProcessResponse]
