...
@JSImport("googleapis/build/src/apis/documentai/v1", "documentai_v1.Resource$Projects$Locations$Processors")
@js.native
open class ResourceProjectsLocationsProcessors protected () extends StObject {
  ...
  def create(): GaxiosPromise[SchemaGoogleCloudDocumentaiV1Processor] = js.native
  def create(callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1Processor]): Unit = js.native
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1Processor] = js.native
  def create(params: ParamsResourceProjectsLocationsProcessorsCreate): GaxiosPromise[SchemaGoogleCloudDocumentaiV1Processor] = js.native
  def create(
    params: ParamsResourceProjectsLocationsProcessorsCreate,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1Processor]
  ): Unit = js.native
  def create(
    params: ParamsResourceProjectsLocationsProcessorsCreate,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1Processor],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1Processor]
  ): Unit = js.native
  def create(params: ParamsResourceProjectsLocationsProcessorsCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1Processor] = js.native
  def create(
    params: ParamsResourceProjectsLocationsProcessorsCreate,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1Processor]
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudDocumentaiV1Processor] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1Processor]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1Processor] = js.native
  def get(params: ParamsResourceProjectsLocationsProcessorsGet): GaxiosPromise[SchemaGoogleCloudDocumentaiV1Processor] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsProcessorsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1Processor] = js.native
  def get(
    params: ParamsResourceProjectsLocationsProcessorsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1Processor]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ListProcessorsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ListProcessorsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ListProcessorsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsProcessorsList): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ListProcessorsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsProcessorsList,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ListProcessorsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsProcessorsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1ListProcessorsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1ListProcessorsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsProcessorsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ListProcessorsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsProcessorsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ListProcessorsResponse]
  ...
  def process(): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ProcessResponse] = js.native
  def process(callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ProcessResponse]): Unit = js.native
  def process(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ProcessResponse] = js.native
  def process(params: ParamsResourceProjectsLocationsProcessorsProcess): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ProcessResponse] = js.native
  def process(
    params: ParamsResourceProjectsLocationsProcessorsProcess,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ProcessResponse]
  ): Unit = js.native
  def process(
    params: ParamsResourceProjectsLocationsProcessorsProcess,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1ProcessResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1ProcessResponse]
  ): Unit = js.native
  def process(params: ParamsResourceProjectsLocationsProcessorsProcess, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1ProcessResponse] = js.native
  def process(
    params: ParamsResourceProjectsLocationsProcessorsProcess,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1ProcessResponse]
