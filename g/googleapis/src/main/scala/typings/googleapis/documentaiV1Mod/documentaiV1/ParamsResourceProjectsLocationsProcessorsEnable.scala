...
trait ParamsResourceProjectsLocationsProcessorsEnable
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDocumentaiV1EnableProcessorRequest] = js.undefined
}
object ParamsResourceProjectsLocationsProcessorsEnable {
  ...
  extension [Self <: ParamsResourceProjectsLocationsProcessorsEnable](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDocumentaiV1EnableProcessorRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
