...
trait SchemaGoogleCloudDocumentaiUiv1beta3CommonOperationMetadata extends StObject {
...
object SchemaGoogleCloudDocumentaiUiv1beta3CommonOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDocumentaiUiv1beta3CommonOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiUiv1beta3CommonOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiUiv1beta3CommonOperationMetadata](x: Self) {
