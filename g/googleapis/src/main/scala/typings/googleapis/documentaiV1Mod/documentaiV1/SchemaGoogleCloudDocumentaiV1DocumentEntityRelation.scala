...
trait SchemaGoogleCloudDocumentaiV1DocumentEntityRelation extends StObject {
...
object SchemaGoogleCloudDocumentaiV1DocumentEntityRelation {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentEntityRelation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentEntityRelation]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentEntityRelation](x: Self) {
