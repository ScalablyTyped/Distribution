...
trait SchemaGoogleCloudDocumentaiV1DocumentPageParagraph extends StObject {
...
object SchemaGoogleCloudDocumentaiV1DocumentPageParagraph {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentPageParagraph = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentPageParagraph]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentPageParagraph](x: Self) {
