...
trait SchemaGoogleCloudDocumentaiV1DocumentStyle extends StObject {
  ...
  /**
    * Font size.
    */
  var fontSize: js.UndefOr[SchemaGoogleCloudDocumentaiV1DocumentStyleFontSize] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1DocumentStyle {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DocumentStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DocumentStyle]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DocumentStyle](x: Self) {
    ...
    inline def setFontSize(value: SchemaGoogleCloudDocumentaiV1DocumentStyleFontSize): Self = StObject.set(x, "fontSize", value.asInstanceOf[js.Any])
