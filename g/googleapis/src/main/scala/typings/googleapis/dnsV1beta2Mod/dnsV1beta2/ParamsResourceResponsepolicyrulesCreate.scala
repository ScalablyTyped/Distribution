...
trait ParamsResourceResponsepolicyrulesCreate
  extends StObject
...
object ParamsResourceResponsepolicyrulesCreate {
  
  inline def apply(): ParamsResourceResponsepolicyrulesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResponsepolicyrulesCreate]
  }
  
  extension [Self <: ParamsResourceResponsepolicyrulesCreate](x: Self) {
