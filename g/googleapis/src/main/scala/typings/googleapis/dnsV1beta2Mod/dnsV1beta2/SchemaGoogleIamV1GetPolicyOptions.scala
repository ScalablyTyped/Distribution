...
trait SchemaGoogleIamV1GetPolicyOptions extends StObject {
...
object SchemaGoogleIamV1GetPolicyOptions {
  
  inline def apply(): SchemaGoogleIamV1GetPolicyOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleIamV1GetPolicyOptions]
  }
  
  extension [Self <: SchemaGoogleIamV1GetPolicyOptions](x: Self) {
