...
trait ParamsResourceManagedzonesUpdate
  extends StObject
...
object ParamsResourceManagedzonesUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceManagedzonesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagedzonesUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceManagedzonesUpdateMutableBuilder[Self <: ParamsResourceManagedzonesUpdate] (val x: Self) extends AnyVal {
