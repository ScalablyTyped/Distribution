...
@js.native
trait ParamsResourcePoliciesGet extends StandardParameters {
  /**
...
object ParamsResourcePoliciesGet {
  ...
  @scala.inline
  implicit class ParamsResourcePoliciesGetOps[Self <: ParamsResourcePoliciesGet] (val x: Self) extends AnyVal {
    @scala.inline
