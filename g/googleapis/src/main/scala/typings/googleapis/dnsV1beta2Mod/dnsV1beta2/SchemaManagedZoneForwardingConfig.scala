...
object SchemaManagedZoneForwardingConfig {
  ...
  implicit class SchemaManagedZoneForwardingConfigOps[Self <: SchemaManagedZoneForwardingConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTargetNameServersVarargs(value: SchemaManagedZoneForwardingConfigNameServerTarget*): Self = this.set("targetNameServers", js.Array(value :_*))
    @scala.inline
    def setTargetNameServers(value: js.Array[SchemaManagedZoneForwardingConfigNameServerTarget]): Self = this.set("targetNameServers", value.asInstanceOf[js.Any])
    @scala.inline
