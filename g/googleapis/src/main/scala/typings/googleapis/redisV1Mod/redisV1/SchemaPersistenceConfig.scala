...
trait SchemaPersistenceConfig extends StObject {
  
  /**
    * Optional. Controls whether Persistence features are enabled. If not provided, the existing value will be used.
    */
  var persistenceMode: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Output only. The next time that a snapshot attempt is scheduled to occur.
    */
  var rdbNextSnapshotTime: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Optional. Period between RDB snapshots. Snapshots will be attempted every period starting from the provided snapshot start time. For example, a start time of 01/01/2033 06:45 and SIX_HOURS snapshot period will do nothing until 01/01/2033, and then trigger snapshots every day at 06:45, 12:45, 18:45, and 00:45 the next day, and so on. If not provided, TWENTY_FOUR_HOURS will be used as default.
    */
  var rdbSnapshotPeriod: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Optional. Date and time that the first snapshot was/will be attempted, and to which future snapshots will be aligned. If not provided, the current time will be used.
    */
  var rdbSnapshotStartTime: js.UndefOr[String | Null] = js.undefined
}
object SchemaPersistenceConfig {
  
  inline def apply(): SchemaPersistenceConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPersistenceConfig]
  }
  
  extension [Self <: SchemaPersistenceConfig](x: Self) {
    
    inline def setPersistenceMode(value: String): Self = StObject.set(x, "persistenceMode", value.asInstanceOf[js.Any])
    
    inline def setPersistenceModeNull: Self = StObject.set(x, "persistenceMode", null)
    ...
    inline def setRdbNextSnapshotTimeNull: Self = StObject.set(x, "rdbNextSnapshotTime", null)
    ...
    inline def setRdbSnapshotPeriodNull: Self = StObject.set(x, "rdbSnapshotPeriod", null)
    ...
    inline def setRdbSnapshotStartTimeNull: Self = StObject.set(x, "rdbSnapshotStartTime", null)
