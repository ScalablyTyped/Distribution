...
trait SchemaInstance extends StObject {
  ...
  /**
    ...
    */
  var alternativeLocationId: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Optional. Indicates whether OSS Redis AUTH is enabled for the instance. If set to "true" AUTH is enabled on the instance. Default value is "false" meaning AUTH is disabled.
    */
  var authEnabled: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var currentLocationId: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Optional. The KMS key reference that the customer provides when trying to create the instance.
    */
  var customerManagedKey: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var maintenanceSchedule: js.UndefOr[SchemaMaintenanceSchedule] = js.undefined
  
  /**
    * Required. Redis memory size in GiB.
    */
  var memorySizeGb: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var nodes: js.UndefOr[js.Array[SchemaNodeInfo]] = js.undefined
  
  /**
    * Optional. Persistence configuration parameters
    */
  var persistenceConfig: js.UndefOr[SchemaPersistenceConfig] = js.undefined
  
  /**
    * Output only. Cloud IAM identity used by import / export operations to transfer data to/from Cloud Storage. Format is "serviceAccount:". The value may change over time for a given instance so should be checked before each import/export operation.
    */
  var persistenceIamIdentity: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var readEndpoint: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Output only. The port number of the exposed readonly redis endpoint. Standard tier only. Write requests should target 'port'.
    */
  var readEndpointPort: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * Optional. Read replicas mode for the instance. Defaults to READ_REPLICAS_DISABLED.
    */
  var readReplicasMode: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Optional. Redis configuration parameters, according to http://redis.io/topics/config. Currently, the only supported parameters are: Redis version 3.2 and newer: * maxmemory-policy * notify-keyspace-events Redis version 4.0 and newer: * activedefrag * lfu-decay-time * lfu-log-factor * maxmemory-gb Redis version 5.0 and newer: * stream-node-max-bytes * stream-node-max-entries
    */
  var redisConfigs: js.UndefOr[StringDictionary[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var secondaryIpRange: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Output only. List of server CA certificates for the instance.
    */
  var serverCaCerts: js.UndefOr[js.Array[SchemaTlsCertificate]] = js.undefined
  ...
  /**
    ...
    */
  var transitEncryptionMode: js.UndefOr[String | Null] = js.undefined
}
object SchemaInstance {
  ...
  extension [Self <: SchemaInstance](x: Self) {
    ...
    inline def setAlternativeLocationIdNull: Self = StObject.set(x, "alternativeLocationId", null)
    ...
    inline def setAuthEnabledNull: Self = StObject.set(x, "authEnabled", null)
    ...
    inline def setCurrentLocationIdNull: Self = StObject.set(x, "currentLocationId", null)
    ...
    inline def setCustomerManagedKeyNull: Self = StObject.set(x, "customerManagedKey", null)
    ...
    inline def setMaintenanceSchedule(value: SchemaMaintenanceSchedule): Self = StObject.set(x, "maintenanceSchedule", value.asInstanceOf[js.Any])
    ...
    inline def setMemorySizeGbNull: Self = StObject.set(x, "memorySizeGb", null)
    ...
    inline def setNodes(value: js.Array[SchemaNodeInfo]): Self = StObject.set(x, "nodes", value.asInstanceOf[js.Any])
    
    inline def setNodesUndefined: Self = StObject.set(x, "nodes", js.undefined)
    
    inline def setNodesVarargs(value: SchemaNodeInfo*): Self = StObject.set(x, "nodes", js.Array(value*))
    
    inline def setPersistenceConfig(value: SchemaPersistenceConfig): Self = StObject.set(x, "persistenceConfig", value.asInstanceOf[js.Any])
    ...
    inline def setPersistenceIamIdentityNull: Self = StObject.set(x, "persistenceIamIdentity", null)
    ...
    inline def setReadEndpointNull: Self = StObject.set(x, "readEndpoint", null)
    
    inline def setReadEndpointPort(value: Double): Self = StObject.set(x, "readEndpointPort", value.asInstanceOf[js.Any])
    
    inline def setReadEndpointPortNull: Self = StObject.set(x, "readEndpointPort", null)
    ...
    inline def setReadReplicasModeNull: Self = StObject.set(x, "readReplicasMode", null)
    ...
    inline def setRedisConfigsNull: Self = StObject.set(x, "redisConfigs", null)
    ...
    inline def setSecondaryIpRangeNull: Self = StObject.set(x, "secondaryIpRange", null)
    
    inline def setSecondaryIpRangeUndefined: Self = StObject.set(x, "secondaryIpRange", js.undefined)
    
    inline def setServerCaCerts(value: js.Array[SchemaTlsCertificate]): Self = StObject.set(x, "serverCaCerts", value.asInstanceOf[js.Any])
    
    inline def setServerCaCertsUndefined: Self = StObject.set(x, "serverCaCerts", js.undefined)
    
    inline def setServerCaCertsVarargs(value: SchemaTlsCertificate*): Self = StObject.set(x, "serverCaCerts", js.Array(value*))
    ...
    inline def setTransitEncryptionModeNull: Self = StObject.set(x, "transitEncryptionMode", null)
