...
trait SchemaPostgreSqlConnectionProfile extends StObject {
...
object SchemaPostgreSqlConnectionProfile {
  
  inline def apply(): SchemaPostgreSqlConnectionProfile = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPostgreSqlConnectionProfile]
  }
  
  extension [Self <: SchemaPostgreSqlConnectionProfile](x: Self) {
