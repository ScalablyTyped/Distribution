...
trait SchemaMigrationJob extends StObject {
  ...
  /**
    ...
    */
  var dumpFlags: js.UndefOr[SchemaDumpFlags] = js.undefined
...
object SchemaMigrationJob {
  ...
  extension [Self <: SchemaMigrationJob](x: Self) {
    ...
    inline def setDumpFlags(value: SchemaDumpFlags): Self = StObject.set(x, "dumpFlags", value.asInstanceOf[js.Any])
