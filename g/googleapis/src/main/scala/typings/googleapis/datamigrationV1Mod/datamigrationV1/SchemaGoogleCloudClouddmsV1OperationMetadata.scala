...
trait SchemaGoogleCloudClouddmsV1OperationMetadata extends StObject {
...
object SchemaGoogleCloudClouddmsV1OperationMetadata {
  
  inline def apply(): SchemaGoogleCloudClouddmsV1OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudClouddmsV1OperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudClouddmsV1OperationMetadata](x: Self) {
