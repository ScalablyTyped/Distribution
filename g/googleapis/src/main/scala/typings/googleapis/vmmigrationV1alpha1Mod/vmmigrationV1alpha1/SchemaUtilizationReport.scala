...
trait SchemaUtilizationReport extends StObject {
  ...
  /**
    * Output only. Total number of VMs included in the report.
    */
  var vmsCount: js.UndefOr[Double | Null] = js.undefined
}
object SchemaUtilizationReport {
  ...
  extension [Self <: SchemaUtilizationReport](x: Self) {
    ...
    inline def setVmsCount(value: Double): Self = StObject.set(x, "vmsCount", value.asInstanceOf[js.Any])
    
    inline def setVmsCountNull: Self = StObject.set(x, "vmsCount", null)
    
    inline def setVmsCountUndefined: Self = StObject.set(x, "vmsCount", js.undefined)
