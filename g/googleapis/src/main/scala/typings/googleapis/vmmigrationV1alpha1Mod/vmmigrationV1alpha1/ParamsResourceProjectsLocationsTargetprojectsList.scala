...
trait ParamsResourceProjectsLocationsTargetprojectsList
  extends StObject
...
object ParamsResourceProjectsLocationsTargetprojectsList {
  
  inline def apply(): ParamsResourceProjectsLocationsTargetprojectsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsTargetprojectsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsTargetprojectsList](x: Self) {
