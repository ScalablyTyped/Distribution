...
trait SchemaVmwareVmDetails extends StObject {
  ...
  /**
    ...
    */
  var committedStorage: js.UndefOr[String | Null] = js.undefined
...
object SchemaVmwareVmDetails {
  ...
  extension [Self <: SchemaVmwareVmDetails](x: Self) {
    ...
    inline def setCommittedStorage(value: String): Self = StObject.set(x, "committedStorage", value.asInstanceOf[js.Any])
    ...
    inline def setCommittedStorageNull: Self = StObject.set(x, "committedStorage", null)
    
    inline def setCommittedStorageUndefined: Self = StObject.set(x, "committedStorage", js.undefined)
