...
trait SchemaMigratingVm extends StObject {
  ...
  /**
    ...
    */
  var computeEngineVmDefaults: js.UndefOr[SchemaTargetVMDetails] = js.undefined
  ...
  /**
    ...
    */
  var targetDefaults: js.UndefOr[SchemaTargetVMDetails] = js.undefined
...
object SchemaMigratingVm {
  ...
  extension [Self <: SchemaMigratingVm](x: Self) {
    ...
    inline def setComputeEngineVmDefaults(value: SchemaTargetVMDetails): Self = StObject.set(x, "computeEngineVmDefaults", value.asInstanceOf[js.Any])
    
    inline def setComputeEngineVmDefaultsUndefined: Self = StObject.set(x, "computeEngineVmDefaults", js.undefined)
    ...
    inline def setTargetDefaults(value: SchemaTargetVMDetails): Self = StObject.set(x, "targetDefaults", value.asInstanceOf[js.Any])
    
    inline def setTargetDefaultsUndefined: Self = StObject.set(x, "targetDefaults", js.undefined)
