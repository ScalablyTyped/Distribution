...
trait ParamsResourceProjectsLocationsGroupsList
  extends StObject
...
object ParamsResourceProjectsLocationsGroupsList {
  
  inline def apply(): ParamsResourceProjectsLocationsGroupsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGroupsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGroupsList](x: Self) {
