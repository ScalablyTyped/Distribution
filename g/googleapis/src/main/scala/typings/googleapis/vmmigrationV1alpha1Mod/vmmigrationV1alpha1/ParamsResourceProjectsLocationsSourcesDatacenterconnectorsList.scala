...
trait ParamsResourceProjectsLocationsSourcesDatacenterconnectorsList
  extends StObject
...
object ParamsResourceProjectsLocationsSourcesDatacenterconnectorsList {
  
  inline def apply(): ParamsResourceProjectsLocationsSourcesDatacenterconnectorsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsSourcesDatacenterconnectorsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsSourcesDatacenterconnectorsList](x: Self) {
