...
trait ParamsResourceOrganizationsPoliciesList
  extends StObject
...
object ParamsResourceOrganizationsPoliciesList {
  
  inline def apply(): ParamsResourceOrganizationsPoliciesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsPoliciesList]
  }
  
  extension [Self <: ParamsResourceOrganizationsPoliciesList](x: Self) {
