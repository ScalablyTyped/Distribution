...
@JSImport("googleapis/build/src/apis/orgpolicy/v2", "orgpolicy_v2.Resource$Folders$Constraints")
@js.native
open class ResourceFoldersConstraints protected () extends StObject {
  ...
  def list(params: ParamsResourceFoldersConstraintsList): GaxiosPromise[SchemaGoogleCloudOrgpolicyV2ListConstraintsResponse] = js.native
  def list(
    params: ParamsResourceFoldersConstraintsList,
  ...
  def list(params: ParamsResourceFoldersConstraintsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudOrgpolicyV2ListConstraintsResponse] = js.native
  def list(
    params: ParamsResourceFoldersConstraintsList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceFoldersConstraintsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceFoldersConstraintsList,
