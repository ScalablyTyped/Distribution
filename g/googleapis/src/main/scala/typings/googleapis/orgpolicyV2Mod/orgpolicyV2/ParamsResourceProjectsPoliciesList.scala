...
trait ParamsResourceProjectsPoliciesList
  extends StObject
...
object ParamsResourceProjectsPoliciesList {
  
  inline def apply(): ParamsResourceProjectsPoliciesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsPoliciesList]
  }
  
  extension [Self <: ParamsResourceProjectsPoliciesList](x: Self) {
