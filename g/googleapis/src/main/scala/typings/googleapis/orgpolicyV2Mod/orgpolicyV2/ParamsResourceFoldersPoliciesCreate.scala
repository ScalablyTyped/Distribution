...
trait ParamsResourceFoldersPoliciesCreate
  extends StObject
...
object ParamsResourceFoldersPoliciesCreate {
  
  inline def apply(): ParamsResourceFoldersPoliciesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersPoliciesCreate]
  }
  
  extension [Self <: ParamsResourceFoldersPoliciesCreate](x: Self) {
