...
trait ParamsResourceFoldersPoliciesPatch
  extends StObject
...
object ParamsResourceFoldersPoliciesPatch {
  
  inline def apply(): ParamsResourceFoldersPoliciesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersPoliciesPatch]
  }
  
  extension [Self <: ParamsResourceFoldersPoliciesPatch](x: Self) {
