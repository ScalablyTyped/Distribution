...
@JSImport("googleapis/build/src/apis/orgpolicy/v2", "orgpolicy_v2.Resource$Organizations$Constraints")
@js.native
open class ResourceOrganizationsConstraints protected () extends StObject {
  ...
  def list(params: ParamsResourceOrganizationsConstraintsList): GaxiosPromise[SchemaGoogleCloudOrgpolicyV2ListConstraintsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsConstraintsList,
  ...
  def list(params: ParamsResourceOrganizationsConstraintsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudOrgpolicyV2ListConstraintsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsConstraintsList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceOrganizationsConstraintsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceOrganizationsConstraintsList,
