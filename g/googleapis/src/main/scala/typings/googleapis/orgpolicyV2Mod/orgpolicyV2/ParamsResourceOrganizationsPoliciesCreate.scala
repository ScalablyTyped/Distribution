...
trait ParamsResourceOrganizationsPoliciesCreate
  extends StObject
...
object ParamsResourceOrganizationsPoliciesCreate {
  
  inline def apply(): ParamsResourceOrganizationsPoliciesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsPoliciesCreate]
  }
  
  extension [Self <: ParamsResourceOrganizationsPoliciesCreate](x: Self) {
