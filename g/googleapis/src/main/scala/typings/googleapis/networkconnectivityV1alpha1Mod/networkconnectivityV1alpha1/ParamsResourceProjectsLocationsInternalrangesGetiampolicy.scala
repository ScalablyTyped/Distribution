...
trait ParamsResourceProjectsLocationsInternalrangesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsInternalrangesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsInternalrangesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsInternalrangesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsInternalrangesGetiampolicy](x: Self) {
