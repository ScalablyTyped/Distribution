...
trait ParamsResourceProjectsLocationsSpokesPatch
  extends StObject
...
object ParamsResourceProjectsLocationsSpokesPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsSpokesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsSpokesPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsSpokesPatch](x: Self) {
