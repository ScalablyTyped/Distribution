...
trait ParamsResourceProjectsLocationsServiceinstancesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsServiceinstancesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsServiceinstancesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsServiceinstancesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsServiceinstancesGetiampolicy](x: Self) {
