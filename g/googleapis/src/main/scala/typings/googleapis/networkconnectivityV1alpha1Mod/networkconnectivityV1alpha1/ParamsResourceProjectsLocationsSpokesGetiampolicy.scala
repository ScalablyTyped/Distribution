...
trait ParamsResourceProjectsLocationsSpokesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsSpokesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsSpokesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsSpokesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsSpokesGetiampolicy](x: Self) {
