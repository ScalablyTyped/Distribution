...
trait ParamsResourceProjectsLocationsConnectionpoliciesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsConnectionpoliciesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsConnectionpoliciesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsConnectionpoliciesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsConnectionpoliciesGetiampolicy](x: Self) {
