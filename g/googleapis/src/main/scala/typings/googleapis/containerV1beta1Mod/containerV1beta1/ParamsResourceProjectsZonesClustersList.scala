...
@js.native
trait ParamsResourceProjectsZonesClustersList extends StandardParameters {
...
object ParamsResourceProjectsZonesClustersList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsZonesClustersList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsZonesClustersList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsZonesClustersListMutableBuilder[Self <: ParamsResourceProjectsZonesClustersList] (val x: Self) extends AnyVal {
