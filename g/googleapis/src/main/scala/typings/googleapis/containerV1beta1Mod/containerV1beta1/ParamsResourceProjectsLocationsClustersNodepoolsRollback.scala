...
object ParamsResourceProjectsLocationsClustersNodepoolsRollback {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersNodepoolsRollbackOps[Self <: ParamsResourceProjectsLocationsClustersNodepoolsRollback] (val x: Self) extends AnyVal {
