...
trait ParamsResourceProjectsZonesClustersNodepoolsSetsize
  extends StObject
...
object ParamsResourceProjectsZonesClustersNodepoolsSetsize {
  ...
  inline def apply(): ParamsResourceProjectsZonesClustersNodepoolsSetsize = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsZonesClustersNodepoolsSetsize]
  }
  
  extension [Self <: ParamsResourceProjectsZonesClustersNodepoolsSetsize](x: Self) {
