...
trait ParamsResourceProjectsZonesClustersNodepoolsDelete
  extends StObject
...
object ParamsResourceProjectsZonesClustersNodepoolsDelete {
  ...
  inline def apply(): ParamsResourceProjectsZonesClustersNodepoolsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsZonesClustersNodepoolsDelete]
  }
  
  extension [Self <: ParamsResourceProjectsZonesClustersNodepoolsDelete](x: Self) {
