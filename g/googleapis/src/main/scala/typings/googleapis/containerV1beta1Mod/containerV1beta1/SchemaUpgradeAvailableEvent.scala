...
trait SchemaUpgradeAvailableEvent extends StObject {
  ...
  /**
    ...
    */
  var windowsVersions: js.UndefOr[SchemaWindowsVersions] = js.undefined
}
object SchemaUpgradeAvailableEvent {
  ...
  extension [Self <: SchemaUpgradeAvailableEvent](x: Self) {
    ...
    inline def setWindowsVersions(value: SchemaWindowsVersions): Self = StObject.set(x, "windowsVersions", value.asInstanceOf[js.Any])
