...
object ParamsResourceProjectsLocationsClustersNodepoolsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersNodepoolsCreateMutableBuilder[Self <: ParamsResourceProjectsLocationsClustersNodepoolsCreate] (val x: Self) extends AnyVal {
