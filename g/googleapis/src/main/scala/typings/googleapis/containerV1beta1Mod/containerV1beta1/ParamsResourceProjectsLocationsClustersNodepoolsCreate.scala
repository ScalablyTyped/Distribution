...
object ParamsResourceProjectsLocationsClustersNodepoolsCreate {
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsClustersNodepoolsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsClustersNodepoolsCreate]
  }
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersNodepoolsCreateOps[Self <: ParamsResourceProjectsLocationsClustersNodepoolsCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreateNodePoolRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
