...
trait ParamsResourceProjectsLocationsClustersList
  extends StObject
...
object ParamsResourceProjectsLocationsClustersList {
  ...
  inline def apply(): ParamsResourceProjectsLocationsClustersList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsClustersList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsClustersList](x: Self) {
