...
trait ParamsResourceProjectsZonesClustersNodepoolsCreate
  extends StObject
...
object ParamsResourceProjectsZonesClustersNodepoolsCreate {
  ...
  inline def apply(): ParamsResourceProjectsZonesClustersNodepoolsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsZonesClustersNodepoolsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsZonesClustersNodepoolsCreate](x: Self) {
