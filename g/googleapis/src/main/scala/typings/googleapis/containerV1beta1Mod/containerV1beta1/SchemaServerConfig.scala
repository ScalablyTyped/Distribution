...
trait SchemaServerConfig extends StObject {
  ...
  /**
    ...
    */
  var windowsVersionMaps: js.UndefOr[StringDictionary[SchemaWindowsVersions] | Null] = js.undefined
}
object SchemaServerConfig {
  ...
  extension [Self <: SchemaServerConfig](x: Self) {
    ...
    inline def setWindowsVersionMaps(value: StringDictionary[SchemaWindowsVersions]): Self = StObject.set(x, "windowsVersionMaps", value.asInstanceOf[js.Any])
    
    inline def setWindowsVersionMapsNull: Self = StObject.set(x, "windowsVersionMaps", null)
    
    inline def setWindowsVersionMapsUndefined: Self = StObject.set(x, "windowsVersionMaps", js.undefined)
  }
}
