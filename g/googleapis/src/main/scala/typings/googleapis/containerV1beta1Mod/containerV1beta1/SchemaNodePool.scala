...
trait SchemaNodePool extends StObject {
  ...
  /**
    ...
    */
  var placementPolicy: js.UndefOr[SchemaPlacementPolicy] = js.undefined
...
object SchemaNodePool {
  ...
  extension [Self <: SchemaNodePool](x: Self) {
    ...
    inline def setPlacementPolicy(value: SchemaPlacementPolicy): Self = StObject.set(x, "placementPolicy", value.asInstanceOf[js.Any])
    
    inline def setPlacementPolicyUndefined: Self = StObject.set(x, "placementPolicy", js.undefined)
