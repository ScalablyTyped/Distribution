...
trait ParamsResourceProjectsZonesClustersSetmasterauth
  extends StObject
...
object ParamsResourceProjectsZonesClustersSetmasterauth {
  ...
  inline def apply(): ParamsResourceProjectsZonesClustersSetmasterauth = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsZonesClustersSetmasterauth]
  }
  
  extension [Self <: ParamsResourceProjectsZonesClustersSetmasterauth](x: Self) {
