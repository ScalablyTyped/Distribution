...
object SchemaIPAllocationPolicy {
  ...
  implicit class SchemaIPAllocationPolicyMutableBuilder[Self <: SchemaIPAllocationPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAllowRouteOverlap(value: Boolean): Self = StObject.set(x, "allowRouteOverlap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAllowRouteOverlapUndefined: Self = StObject.set(x, "allowRouteOverlap", js.undefined)
