...
object SchemaIPAllocationPolicy {
  @scala.inline
  def apply(
    allowRouteOverlap: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(allowRouteOverlap)) __obj.updateDynamic("allowRouteOverlap")(allowRouteOverlap.get.asInstanceOf[js.Any])
