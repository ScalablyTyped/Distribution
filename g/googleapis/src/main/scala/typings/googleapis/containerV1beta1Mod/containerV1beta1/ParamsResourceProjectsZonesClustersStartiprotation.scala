...
trait ParamsResourceProjectsZonesClustersStartiprotation
  extends StObject
...
object ParamsResourceProjectsZonesClustersStartiprotation {
  ...
  inline def apply(): ParamsResourceProjectsZonesClustersStartiprotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsZonesClustersStartiprotation]
  }
  
  extension [Self <: ParamsResourceProjectsZonesClustersStartiprotation](x: Self) {
