...
@JSImport("googleapis/build/src/apis/securitycenter/v1beta2", "securitycenter_v1beta2.Resource$Projects$Virtualmachinethreatdetectionsettings")
@js.native
open class ResourceProjectsVirtualmachinethreatdetectionsettings protected () extends StObject {
  ...
  def calculate(params: ParamsResourceProjectsVirtualmachinethreatdetectionsettingsCalculate): GaxiosPromise[SchemaVirtualMachineThreatDetectionSettings] = js.native
  def calculate(
    params: ParamsResourceProjectsVirtualmachinethreatdetectionsettingsCalculate,
