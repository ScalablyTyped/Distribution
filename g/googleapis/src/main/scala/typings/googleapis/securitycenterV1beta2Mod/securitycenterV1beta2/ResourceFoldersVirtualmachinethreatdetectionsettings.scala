...
@JSImport("googleapis/build/src/apis/securitycenter/v1beta2", "securitycenter_v1beta2.Resource$Folders$Virtualmachinethreatdetectionsettings")
@js.native
open class ResourceFoldersVirtualmachinethreatdetectionsettings protected () extends StObject {
  ...
  def calculate(params: ParamsResourceFoldersVirtualmachinethreatdetectionsettingsCalculate): GaxiosPromise[SchemaVirtualMachineThreatDetectionSettings] = js.native
  def calculate(
    params: ParamsResourceFoldersVirtualmachinethreatdetectionsettingsCalculate,
