...
@JSImport("googleapis/build/src/apis/securitycenter/v1beta2", "securitycenter_v1beta2.Resource$Organizations$Containerthreatdetectionsettings")
@js.native
open class ResourceOrganizationsContainerthreatdetectionsettings protected () extends StObject {
  ...
  def calculate(params: ParamsResourceOrganizationsContainerthreatdetectionsettingsCalculate): GaxiosPromise[SchemaContainerThreatDetectionSettings] = js.native
  def calculate(
    params: ParamsResourceOrganizationsContainerthreatdetectionsettingsCalculate,
