...
trait ParamsResourceProjectsUpdatecontainerthreatdetectionsettings
  extends StObject
...
object ParamsResourceProjectsUpdatecontainerthreatdetectionsettings {
  
  inline def apply(): ParamsResourceProjectsUpdatecontainerthreatdetectionsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsUpdatecontainerthreatdetectionsettings]
  }
  
  extension [Self <: ParamsResourceProjectsUpdatecontainerthreatdetectionsettings](x: Self) {
