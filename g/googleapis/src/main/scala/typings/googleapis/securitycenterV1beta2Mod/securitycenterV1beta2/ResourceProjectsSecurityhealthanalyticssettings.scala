...
@JSImport("googleapis/build/src/apis/securitycenter/v1beta2", "securitycenter_v1beta2.Resource$Projects$Securityhealthanalyticssettings")
@js.native
open class ResourceProjectsSecurityhealthanalyticssettings protected () extends StObject {
  ...
  def calculate(params: ParamsResourceProjectsSecurityhealthanalyticssettingsCalculate): GaxiosPromise[SchemaSecurityHealthAnalyticsSettings] = js.native
  def calculate(
    params: ParamsResourceProjectsSecurityhealthanalyticssettingsCalculate,
  ...
  def calculate(params: ParamsResourceProjectsSecurityhealthanalyticssettingsCalculate, options: MethodOptions): GaxiosPromise[SchemaSecurityHealthAnalyticsSettings] = js.native
  def calculate(
    params: ParamsResourceProjectsSecurityhealthanalyticssettingsCalculate,
