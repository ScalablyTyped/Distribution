...
trait ParamsResourceFoldersUpdatesecurityhealthanalyticssettings
  extends StObject
...
object ParamsResourceFoldersUpdatesecurityhealthanalyticssettings {
  
  inline def apply(): ParamsResourceFoldersUpdatesecurityhealthanalyticssettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersUpdatesecurityhealthanalyticssettings]
  }
  
  extension [Self <: ParamsResourceFoldersUpdatesecurityhealthanalyticssettings](x: Self) {
