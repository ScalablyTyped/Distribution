...
@JSImport("googleapis/build/src/apis/securitycenter/v1beta2", "securitycenter_v1beta2.Resource$Folders$Securityhealthanalyticssettings")
@js.native
open class ResourceFoldersSecurityhealthanalyticssettings protected () extends StObject {
  ...
  def calculate(params: ParamsResourceFoldersSecurityhealthanalyticssettingsCalculate): GaxiosPromise[SchemaSecurityHealthAnalyticsSettings] = js.native
  def calculate(
    params: ParamsResourceFoldersSecurityhealthanalyticssettingsCalculate,
  ...
  def calculate(params: ParamsResourceFoldersSecurityhealthanalyticssettingsCalculate, options: MethodOptions): GaxiosPromise[SchemaSecurityHealthAnalyticsSettings] = js.native
  def calculate(
    params: ParamsResourceFoldersSecurityhealthanalyticssettingsCalculate,
