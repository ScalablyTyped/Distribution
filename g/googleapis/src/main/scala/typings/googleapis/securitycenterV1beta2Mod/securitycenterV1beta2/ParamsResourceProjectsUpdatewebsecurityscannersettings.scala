...
trait ParamsResourceProjectsUpdatewebsecurityscannersettings
  extends StObject
...
object ParamsResourceProjectsUpdatewebsecurityscannersettings {
  
  inline def apply(): ParamsResourceProjectsUpdatewebsecurityscannersettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsUpdatewebsecurityscannersettings]
  }
  
  extension [Self <: ParamsResourceProjectsUpdatewebsecurityscannersettings](x: Self) {
