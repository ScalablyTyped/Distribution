...
@JSImport("googleapis/build/src/apis/securitycenter/v1beta2", "securitycenter_v1beta2.Resource$Organizations$Eventthreatdetectionsettings")
@js.native
open class ResourceOrganizationsEventthreatdetectionsettings protected () extends StObject {
  ...
  def calculate(params: ParamsResourceOrganizationsEventthreatdetectionsettingsCalculate): GaxiosPromise[SchemaEventThreatDetectionSettings] = js.native
  def calculate(
    params: ParamsResourceOrganizationsEventthreatdetectionsettingsCalculate,
  ...
  def calculate(params: ParamsResourceOrganizationsEventthreatdetectionsettingsCalculate, options: MethodOptions): GaxiosPromise[SchemaEventThreatDetectionSettings] = js.native
  def calculate(
    params: ParamsResourceOrganizationsEventthreatdetectionsettingsCalculate,
