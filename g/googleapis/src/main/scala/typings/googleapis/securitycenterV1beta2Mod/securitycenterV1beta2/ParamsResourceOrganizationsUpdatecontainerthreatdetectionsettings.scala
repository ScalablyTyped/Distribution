...
trait ParamsResourceOrganizationsUpdatecontainerthreatdetectionsettings
  extends StObject
...
object ParamsResourceOrganizationsUpdatecontainerthreatdetectionsettings {
  
  inline def apply(): ParamsResourceOrganizationsUpdatecontainerthreatdetectionsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsUpdatecontainerthreatdetectionsettings]
  }
  
  extension [Self <: ParamsResourceOrganizationsUpdatecontainerthreatdetectionsettings](x: Self) {
