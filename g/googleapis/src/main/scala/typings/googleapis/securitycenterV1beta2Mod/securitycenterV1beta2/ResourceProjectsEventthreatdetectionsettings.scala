...
@JSImport("googleapis/build/src/apis/securitycenter/v1beta2", "securitycenter_v1beta2.Resource$Projects$Eventthreatdetectionsettings")
@js.native
open class ResourceProjectsEventthreatdetectionsettings protected () extends StObject {
  ...
  def calculate(params: ParamsResourceProjectsEventthreatdetectionsettingsCalculate): GaxiosPromise[SchemaEventThreatDetectionSettings] = js.native
  def calculate(
    params: ParamsResourceProjectsEventthreatdetectionsettingsCalculate,
  ...
  def calculate(params: ParamsResourceProjectsEventthreatdetectionsettingsCalculate, options: MethodOptions): GaxiosPromise[SchemaEventThreatDetectionSettings] = js.native
  def calculate(
    params: ParamsResourceProjectsEventthreatdetectionsettingsCalculate,
  ...
  /**
    ...
    */
  def calculate(params: ParamsResourceProjectsEventthreatdetectionsettingsCalculate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def calculate(
    params: ParamsResourceProjectsEventthreatdetectionsettingsCalculate,
