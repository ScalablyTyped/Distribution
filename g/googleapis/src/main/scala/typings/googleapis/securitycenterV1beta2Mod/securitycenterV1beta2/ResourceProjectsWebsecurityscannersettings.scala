...
@JSImport("googleapis/build/src/apis/securitycenter/v1beta2", "securitycenter_v1beta2.Resource$Projects$Websecurityscannersettings")
@js.native
open class ResourceProjectsWebsecurityscannersettings protected () extends StObject {
  ...
  def calculate(params: ParamsResourceProjectsWebsecurityscannersettingsCalculate): GaxiosPromise[SchemaWebSecurityScannerSettings] = js.native
  def calculate(
    params: ParamsResourceProjectsWebsecurityscannersettingsCalculate,
  ...
  def calculate(params: ParamsResourceProjectsWebsecurityscannersettingsCalculate, options: MethodOptions): GaxiosPromise[SchemaWebSecurityScannerSettings] = js.native
  def calculate(
    params: ParamsResourceProjectsWebsecurityscannersettingsCalculate,
  ...
  /**
    ...
    */
  def calculate(params: ParamsResourceProjectsWebsecurityscannersettingsCalculate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def calculate(
    params: ParamsResourceProjectsWebsecurityscannersettingsCalculate,
