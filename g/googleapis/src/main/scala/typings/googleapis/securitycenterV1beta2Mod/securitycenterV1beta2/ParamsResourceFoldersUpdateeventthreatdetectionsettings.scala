...
trait ParamsResourceFoldersUpdateeventthreatdetectionsettings
  extends StObject
...
object ParamsResourceFoldersUpdateeventthreatdetectionsettings {
  
  inline def apply(): ParamsResourceFoldersUpdateeventthreatdetectionsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersUpdateeventthreatdetectionsettings]
  }
  
  extension [Self <: ParamsResourceFoldersUpdateeventthreatdetectionsettings](x: Self) {
