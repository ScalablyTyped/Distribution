...
trait ParamsResourceProjectsLocationsClustersUpdatecontainerthreatdetectionsettings
  extends StObject
...
object ParamsResourceProjectsLocationsClustersUpdatecontainerthreatdetectionsettings {
  
  inline def apply(): ParamsResourceProjectsLocationsClustersUpdatecontainerthreatdetectionsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsClustersUpdatecontainerthreatdetectionsettings]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsClustersUpdatecontainerthreatdetectionsettings](x: Self) {
