...
trait ParamsResourceOrganizationsUpdatewebsecurityscannersettings
  extends StObject
...
object ParamsResourceOrganizationsUpdatewebsecurityscannersettings {
  
  inline def apply(): ParamsResourceOrganizationsUpdatewebsecurityscannersettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsUpdatewebsecurityscannersettings]
  }
  
  extension [Self <: ParamsResourceOrganizationsUpdatewebsecurityscannersettings](x: Self) {
