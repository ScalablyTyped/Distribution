...
@JSImport("googleapis/build/src/apis/securitycenter/v1beta2", "securitycenter_v1beta2.Resource$Projects$Locations$Clusters$Containerthreatdetectionsettings")
@js.native
open class ResourceProjectsLocationsClustersContainerthreatdetectionsettings protected () extends StObject {
  ...
  def calculate(params: ParamsResourceProjectsLocationsClustersContainerthreatdetectionsettingsCalculate): GaxiosPromise[SchemaContainerThreatDetectionSettings] = js.native
  def calculate(
    params: ParamsResourceProjectsLocationsClustersContainerthreatdetectionsettingsCalculate,
