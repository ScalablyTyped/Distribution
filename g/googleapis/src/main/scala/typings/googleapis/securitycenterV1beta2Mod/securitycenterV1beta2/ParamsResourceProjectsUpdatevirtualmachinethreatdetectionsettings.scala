...
trait ParamsResourceProjectsUpdatevirtualmachinethreatdetectionsettings
  extends StObject
...
object ParamsResourceProjectsUpdatevirtualmachinethreatdetectionsettings {
  
  inline def apply(): ParamsResourceProjectsUpdatevirtualmachinethreatdetectionsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsUpdatevirtualmachinethreatdetectionsettings]
  }
  
  extension [Self <: ParamsResourceProjectsUpdatevirtualmachinethreatdetectionsettings](x: Self) {
