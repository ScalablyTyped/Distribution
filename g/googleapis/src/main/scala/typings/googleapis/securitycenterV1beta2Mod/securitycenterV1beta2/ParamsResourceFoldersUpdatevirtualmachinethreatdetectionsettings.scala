...
trait ParamsResourceFoldersUpdatevirtualmachinethreatdetectionsettings
  extends StObject
...
object ParamsResourceFoldersUpdatevirtualmachinethreatdetectionsettings {
  
  inline def apply(): ParamsResourceFoldersUpdatevirtualmachinethreatdetectionsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersUpdatevirtualmachinethreatdetectionsettings]
  }
  
  extension [Self <: ParamsResourceFoldersUpdatevirtualmachinethreatdetectionsettings](x: Self) {
