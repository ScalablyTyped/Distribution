...
trait SchemaEventThreatDetectionSettings extends StObject {
...
object SchemaEventThreatDetectionSettings {
  
  inline def apply(): SchemaEventThreatDetectionSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaEventThreatDetectionSettings]
  }
  
  extension [Self <: SchemaEventThreatDetectionSettings](x: Self) {
