...
trait ParamsResourceProjectsGetcontainerthreatdetectionsettings
  extends StObject
...
object ParamsResourceProjectsGetcontainerthreatdetectionsettings {
  
  inline def apply(): ParamsResourceProjectsGetcontainerthreatdetectionsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsGetcontainerthreatdetectionsettings]
  }
  
  extension [Self <: ParamsResourceProjectsGetcontainerthreatdetectionsettings](x: Self) {
