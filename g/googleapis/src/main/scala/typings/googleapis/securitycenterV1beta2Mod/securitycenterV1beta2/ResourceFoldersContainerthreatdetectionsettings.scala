...
@JSImport("googleapis/build/src/apis/securitycenter/v1beta2", "securitycenter_v1beta2.Resource$Folders$Containerthreatdetectionsettings")
@js.native
open class ResourceFoldersContainerthreatdetectionsettings protected () extends StObject {
  ...
  def calculate(params: ParamsResourceFoldersContainerthreatdetectionsettingsCalculate): GaxiosPromise[SchemaContainerThreatDetectionSettings] = js.native
  def calculate(
    params: ParamsResourceFoldersContainerthreatdetectionsettingsCalculate,
  ...
  def calculate(params: ParamsResourceFoldersContainerthreatdetectionsettingsCalculate, options: MethodOptions): GaxiosPromise[SchemaContainerThreatDetectionSettings] = js.native
  def calculate(
    params: ParamsResourceFoldersContainerthreatdetectionsettingsCalculate,
