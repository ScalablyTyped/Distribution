...
trait SchemaSecurityHealthAnalyticsSettings extends StObject {
...
object SchemaSecurityHealthAnalyticsSettings {
  
  inline def apply(): SchemaSecurityHealthAnalyticsSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSecurityHealthAnalyticsSettings]
  }
  
  extension [Self <: SchemaSecurityHealthAnalyticsSettings](x: Self) {
