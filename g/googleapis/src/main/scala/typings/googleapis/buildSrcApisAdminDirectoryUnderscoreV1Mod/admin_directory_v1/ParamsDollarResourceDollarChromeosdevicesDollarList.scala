...
@js.native
trait ParamsDollarResourceDollarChromeosdevicesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarChromeosdevicesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarChromeosdevicesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChromeosdevicesDollarList]
  }
}
