...
@js.native
trait ParamsDollarResourceDollarMembersDollarHasmember extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarMembersDollarHasmember {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarMembersDollarHasmember = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMembersDollarHasmember]
  }
}
