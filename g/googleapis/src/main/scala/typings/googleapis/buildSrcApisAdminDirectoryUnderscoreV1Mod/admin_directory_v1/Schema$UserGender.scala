...
@js.native
trait Schema$UserGender extends js.Object {
  /**
...
object Schema$UserGender {
  @scala.inline
  def apply(addressMeAs: String = null, customGender: String = null, `type`: String = null): Schema$UserGender = {
    ...
    __obj.asInstanceOf[Schema$UserGender]
  }
}
