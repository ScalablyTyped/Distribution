...
@js.native
trait ParamsDollarResourceDollarAspsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAspsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    userKey: String = null
  ): ParamsDollarResourceDollarAspsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAspsDollarGet]
  }
}
