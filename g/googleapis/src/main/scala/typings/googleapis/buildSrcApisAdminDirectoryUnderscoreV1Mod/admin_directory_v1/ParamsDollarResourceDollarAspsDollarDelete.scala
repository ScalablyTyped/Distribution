...
@js.native
trait ParamsDollarResourceDollarAspsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAspsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    userKey: String = null
  ): ParamsDollarResourceDollarAspsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAspsDollarDelete]
  }
}
