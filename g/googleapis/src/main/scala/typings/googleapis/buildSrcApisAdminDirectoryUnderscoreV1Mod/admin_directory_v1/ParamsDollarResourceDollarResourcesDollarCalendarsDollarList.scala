...
@js.native
trait ParamsDollarResourceDollarResourcesDollarCalendarsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarResourcesDollarCalendarsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarResourcesDollarCalendarsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarResourcesDollarCalendarsDollarList]
  }
}
