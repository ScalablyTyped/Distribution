...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2ListEntityTypesResponse extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2ListEntityTypesResponse {
  @scala.inline
  def apply(
    entityTypes: js.Array[Schema$GoogleCloudDialogflowV2EntityType] = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2ListEntityTypesResponse]
  }
}
