...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1IntentTrainingPhrase extends js.Object {
  /**
  ...
  /**
    ...
    */
  var parts: js.UndefOr[js.Array[Schema$GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart]] = js.native
  /**
...
object Schema$GoogleCloudDialogflowV2beta1IntentTrainingPhrase {
  @scala.inline
  def apply(
    name: String = null,
    parts: js.Array[Schema$GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart] = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1IntentTrainingPhrase]
  }
}
