...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2BatchUpdateIntentsRequest extends js.Object {
  /**
    * The collection of intents to update or create.
    */
  var intentBatchInline: js.UndefOr[Schema$GoogleCloudDialogflowV2IntentBatch] = js.native
  /**
...
object Schema$GoogleCloudDialogflowV2BatchUpdateIntentsRequest {
  @scala.inline
  def apply(
    intentBatchInline: Schema$GoogleCloudDialogflowV2IntentBatch = null,
    intentBatchUri: String = null,
    intentView: String = null,
    languageCode: String = null,
    updateMask: String = null
  ): Schema$GoogleCloudDialogflowV2BatchUpdateIntentsRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2BatchUpdateIntentsRequest]
  }
}
