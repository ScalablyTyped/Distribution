...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2Agent extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2Agent {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2Agent]
  }
}
