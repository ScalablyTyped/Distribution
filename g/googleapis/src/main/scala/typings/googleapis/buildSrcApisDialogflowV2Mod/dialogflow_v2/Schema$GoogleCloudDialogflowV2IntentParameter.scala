...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2IntentParameter extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2IntentParameter {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2IntentParameter]
  }
}
