...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart {
  @scala.inline
  def apply(
    alias: String = null,
  ...
  ): Schema$GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart]
  }
}
