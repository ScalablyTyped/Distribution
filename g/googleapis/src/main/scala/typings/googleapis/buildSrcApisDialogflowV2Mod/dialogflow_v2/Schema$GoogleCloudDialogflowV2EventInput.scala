...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2EventInput extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2EventInput {
  @scala.inline
  def apply(languageCode: String = null, name: String = null, parameters: StringDictionary[js.Any] = null): Schema$GoogleCloudDialogflowV2EventInput = {
    val __obj = js.Dynamic.literal()
    if (languageCode != null) __obj.updateDynamic("languageCode")(languageCode.asInstanceOf[js.Any])
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    if (parameters != null) __obj.updateDynamic("parameters")(parameters.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2EventInput]
  }
}
