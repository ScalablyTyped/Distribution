...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo {
  @scala.inline
  def apply(followupIntentName: String = null, parentFollowupIntentName: String = null): Schema$GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo]
  }
}
