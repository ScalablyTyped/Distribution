...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1QueryResult extends js.Object {
  /**
  ...
  /**
    ...
    */
  var fulfillmentMessages: js.UndefOr[js.Array[Schema$GoogleCloudDialogflowV2beta1IntentMessage]] = js.native
  /**
  ...
  /**
    ...
    */
  var intent: js.UndefOr[Schema$GoogleCloudDialogflowV2beta1Intent] = js.native
  /**
  ...
  /**
    ...
    */
  var knowledgeAnswers: js.UndefOr[Schema$GoogleCloudDialogflowV2beta1KnowledgeAnswers] = js.native
  /**
  ...
  /**
    ...
    * query.
    */
  var outputContexts: js.UndefOr[js.Array[Schema$GoogleCloudDialogflowV2beta1Context]] = js.native
  /**
  ...
  /**
    ...
    */
  var sentimentAnalysisResult: js.UndefOr[Schema$GoogleCloudDialogflowV2beta1SentimentAnalysisResult] = js.native
  /**
...
object Schema$GoogleCloudDialogflowV2beta1QueryResult {
  @scala.inline
  def apply(
    action: String = null,
    allRequiredParamsPresent: js.UndefOr[Boolean] = js.undefined,
    diagnosticInfo: StringDictionary[js.Any] = null,
    fulfillmentMessages: js.Array[Schema$GoogleCloudDialogflowV2beta1IntentMessage] = null,
    fulfillmentText: String = null,
    intent: Schema$GoogleCloudDialogflowV2beta1Intent = null,
    intentDetectionConfidence: Int | Double = null,
    knowledgeAnswers: Schema$GoogleCloudDialogflowV2beta1KnowledgeAnswers = null,
    languageCode: String = null,
    outputContexts: js.Array[Schema$GoogleCloudDialogflowV2beta1Context] = null,
    parameters: StringDictionary[js.Any] = null,
    queryText: String = null,
    sentimentAnalysisResult: Schema$GoogleCloudDialogflowV2beta1SentimentAnalysisResult = null,
    speechRecognitionConfidence: Int | Double = null,
    webhookPayload: StringDictionary[js.Any] = null,
    webhookSource: String = null
  ): Schema$GoogleCloudDialogflowV2beta1QueryResult = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1QueryResult]
  }
}
