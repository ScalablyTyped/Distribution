...
/**
  ...
  */
@js.native
trait Schema$SuspiciousActivitySecurityDetail extends js.Object {
  /**
...
object Schema$SuspiciousActivitySecurityDetail {
  @scala.inline
  def apply(
  ...
  ): Schema$SuspiciousActivitySecurityDetail = {
    ...
    __obj.asInstanceOf[Schema$SuspiciousActivitySecurityDetail]
  }
}
