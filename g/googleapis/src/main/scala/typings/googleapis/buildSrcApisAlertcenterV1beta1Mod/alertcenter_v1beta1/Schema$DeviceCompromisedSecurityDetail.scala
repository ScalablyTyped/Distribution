...
/**
  ...
  */
@js.native
trait Schema$DeviceCompromisedSecurityDetail extends js.Object {
  /**
...
object Schema$DeviceCompromisedSecurityDetail {
  @scala.inline
  def apply(
  ...
  ): Schema$DeviceCompromisedSecurityDetail = {
    ...
    __obj.asInstanceOf[Schema$DeviceCompromisedSecurityDetail]
  }
}
