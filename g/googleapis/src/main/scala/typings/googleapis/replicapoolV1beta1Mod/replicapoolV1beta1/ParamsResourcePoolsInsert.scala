...
object ParamsResourcePoolsInsert {
  ...
  inline def apply(): ParamsResourcePoolsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePoolsInsert]
  }
  
  extension [Self <: ParamsResourcePoolsInsert](x: Self) {
    ...
    inline def setRequestBody(value: SchemaPool): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
