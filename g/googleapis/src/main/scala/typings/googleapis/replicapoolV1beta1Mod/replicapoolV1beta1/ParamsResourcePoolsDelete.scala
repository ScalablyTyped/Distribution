...
object ParamsResourcePoolsDelete {
  ...
  inline def apply(): ParamsResourcePoolsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePoolsDelete]
  }
  
  extension [Self <: ParamsResourcePoolsDelete](x: Self) {
    ...
    inline def setRequestBody(value: SchemaPoolsDeleteRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
