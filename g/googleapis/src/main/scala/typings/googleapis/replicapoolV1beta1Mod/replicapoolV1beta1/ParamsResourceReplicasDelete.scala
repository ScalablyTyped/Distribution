...
object ParamsResourceReplicasDelete {
  ...
  @scala.inline
  implicit class ParamsResourceReplicasDeleteMutableBuilder[Self <: ParamsResourceReplicasDelete] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaReplicasDeleteRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
