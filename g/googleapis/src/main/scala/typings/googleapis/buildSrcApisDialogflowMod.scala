...
import typings.googleapis.buildSrcApisDialogflowV2Mod.dialogflow_v2.Dialogflow
import typings.googleapis.buildSrcApisDialogflowV2Mod.dialogflow_v2.Options
...
object buildSrcApisDialogflowMod extends js.Object {
  ...
  def dialogflow(options: typings.googleapis.buildSrcApisDialogflowV2beta1Mod.dialogflow_v2beta1.Options): typings.googleapis.buildSrcApisDialogflowV2beta1Mod.dialogflow_v2beta1.Dialogflow = js.native
  @JSName("dialogflow")
  def dialogflow_v2(version: v2): Dialogflow = js.native
  @JSName("dialogflow")
  def dialogflow_v2beta1(version: v2beta1): typings.googleapis.buildSrcApisDialogflowV2beta1Mod.dialogflow_v2beta1.Dialogflow = js.native
  @js.native
  object VERSIONS extends js.Object {
    ...
    class v2beta1 protected ()
      extends typings.googleapis.buildSrcApisDialogflowV2beta1Mod.dialogflow_v2beta1.Dialogflow {
      def this(options: GlobalOptions) = this()
      def this(options: GlobalOptions, google: GoogleConfigurable) = this()
    }
    ...
    object v2beta1
      extends TopLevel[
              Instantiable2[
                ...
                typings.googleapis.buildSrcApisDialogflowV2beta1Mod.dialogflow_v2beta1.Dialogflow
              ]
            ]
