...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudHealthcareV1alpha2FhirRestExportResourcesResponse extends js.Object {
  /**
...
object Schema$GoogleCloudHealthcareV1alpha2FhirRestExportResourcesResponse {
  @scala.inline
  def apply(fhirStore: String = null, resourceCount: String = null): Schema$GoogleCloudHealthcareV1alpha2FhirRestExportResourcesResponse = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudHealthcareV1alpha2FhirRestExportResourcesResponse]
  }
}
