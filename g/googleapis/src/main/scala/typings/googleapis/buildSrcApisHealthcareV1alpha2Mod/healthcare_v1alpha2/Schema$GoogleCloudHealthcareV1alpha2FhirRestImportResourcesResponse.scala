...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudHealthcareV1alpha2FhirRestImportResourcesResponse extends js.Object {
  /**
...
object Schema$GoogleCloudHealthcareV1alpha2FhirRestImportResourcesResponse {
  @scala.inline
  def apply(fhirStore: String = null, inputSize: String = null): Schema$GoogleCloudHealthcareV1alpha2FhirRestImportResourcesResponse = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudHealthcareV1alpha2FhirRestImportResourcesResponse]
  }
}
