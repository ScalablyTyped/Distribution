...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudHealthcareV1alpha2DicomGcsDestination extends js.Object {
  /**
...
object Schema$GoogleCloudHealthcareV1alpha2DicomGcsDestination {
  @scala.inline
  def apply(mimeType: String = null, uriPrefix: String = null): Schema$GoogleCloudHealthcareV1alpha2DicomGcsDestination = {
    val __obj = js.Dynamic.literal()
    if (mimeType != null) __obj.updateDynamic("mimeType")(mimeType.asInstanceOf[js.Any])
    if (uriPrefix != null) __obj.updateDynamic("uriPrefix")(uriPrefix.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudHealthcareV1alpha2DicomGcsDestination]
  }
}
