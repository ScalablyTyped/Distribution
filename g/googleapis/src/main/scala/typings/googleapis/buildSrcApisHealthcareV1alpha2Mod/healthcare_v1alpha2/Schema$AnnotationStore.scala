...
/**
  ...
  */
@js.native
trait Schema$AnnotationStore extends js.Object {
  /**
...
object Schema$AnnotationStore {
  @scala.inline
  def apply(labels: StringDictionary[String] = null, name: String = null): Schema$AnnotationStore = {
    val __obj = js.Dynamic.literal()
    if (labels != null) __obj.updateDynamic("labels")(labels.asInstanceOf[js.Any])
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$AnnotationStore]
  }
}
