...
trait SchemaGoogleCloudMemcacheV1beta2MaintenancePolicy extends StObject {
...
object SchemaGoogleCloudMemcacheV1beta2MaintenancePolicy {
  
  inline def apply(): SchemaGoogleCloudMemcacheV1beta2MaintenancePolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudMemcacheV1beta2MaintenancePolicy]
  }
  
  extension [Self <: SchemaGoogleCloudMemcacheV1beta2MaintenancePolicy](x: Self) {
