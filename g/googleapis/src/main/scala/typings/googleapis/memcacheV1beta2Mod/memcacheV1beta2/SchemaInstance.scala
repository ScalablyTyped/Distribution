...
trait SchemaInstance extends StObject {
  ...
  /**
    ...
    */
  var maintenancePolicy: js.UndefOr[SchemaGoogleCloudMemcacheV1beta2MaintenancePolicy] = js.undefined
  ...
  /**
    ...
    */
  var updateAvailable: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaInstance {
  ...
  extension [Self <: SchemaInstance](x: Self) {
    ...
    inline def setMaintenancePolicy(value: SchemaGoogleCloudMemcacheV1beta2MaintenancePolicy): Self = StObject.set(x, "maintenancePolicy", value.asInstanceOf[js.Any])
    ...
    inline def setUpdateAvailableNull: Self = StObject.set(x, "updateAvailable", null)
