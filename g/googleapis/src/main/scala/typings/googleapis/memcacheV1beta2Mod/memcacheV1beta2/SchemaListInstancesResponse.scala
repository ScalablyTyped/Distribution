...
trait SchemaListInstancesResponse extends StObject {
  ...
  /**
    ...
    */
  var resources: js.UndefOr[js.Array[SchemaInstance]] = js.undefined
...
object SchemaListInstancesResponse {
  ...
  extension [Self <: SchemaListInstancesResponse](x: Self) {
    ...
    inline def setResources(value: js.Array[SchemaInstance]): Self = StObject.set(x, "resources", value.asInstanceOf[js.Any])
    
    inline def setResourcesUndefined: Self = StObject.set(x, "resources", js.undefined)
    
    inline def setResourcesVarargs(value: SchemaInstance*): Self = StObject.set(x, "resources", js.Array(value*))
