...
trait SchemaGoogleCloudMemcacheV1beta2OperationMetadata extends StObject {
...
object SchemaGoogleCloudMemcacheV1beta2OperationMetadata {
  
  inline def apply(): SchemaGoogleCloudMemcacheV1beta2OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudMemcacheV1beta2OperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudMemcacheV1beta2OperationMetadata](x: Self) {
