...
trait ParamsResourceAccountsContainersTriggersUpdate
  extends StObject
...
object ParamsResourceAccountsContainersTriggersUpdate {
  ...
  inline def apply(): ParamsResourceAccountsContainersTriggersUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersTriggersUpdate]
  }
  
  extension [Self <: ParamsResourceAccountsContainersTriggersUpdate](x: Self) {
