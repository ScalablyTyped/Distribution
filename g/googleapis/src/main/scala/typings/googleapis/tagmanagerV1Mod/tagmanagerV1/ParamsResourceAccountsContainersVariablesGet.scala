...
@js.native
trait ParamsResourceAccountsContainersVariablesGet extends StandardParameters {
...
object ParamsResourceAccountsContainersVariablesGet {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsContainersVariablesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersVariablesGet]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsContainersVariablesGetMutableBuilder[Self <: ParamsResourceAccountsContainersVariablesGet] (val x: Self) extends AnyVal {
