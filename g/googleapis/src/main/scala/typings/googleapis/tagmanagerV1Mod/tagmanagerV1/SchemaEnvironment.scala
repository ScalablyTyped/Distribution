...
trait SchemaEnvironment extends StObject {
  ...
  /**
    ...
    */
  var authorizationTimestampMs: js.UndefOr[String | Null] = js.undefined
...
object SchemaEnvironment {
  ...
  extension [Self <: SchemaEnvironment](x: Self) {
    ...
    inline def setAuthorizationTimestampMs(value: String): Self = StObject.set(x, "authorizationTimestampMs", value.asInstanceOf[js.Any])
    
    inline def setAuthorizationTimestampMsNull: Self = StObject.set(x, "authorizationTimestampMs", null)
    
    inline def setAuthorizationTimestampMsUndefined: Self = StObject.set(x, "authorizationTimestampMs", js.undefined)
