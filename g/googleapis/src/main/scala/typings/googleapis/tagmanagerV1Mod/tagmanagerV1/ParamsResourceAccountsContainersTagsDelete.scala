...
object ParamsResourceAccountsContainersTagsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsContainersTagsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersTagsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsContainersTagsDeleteMutableBuilder[Self <: ParamsResourceAccountsContainersTagsDelete] (val x: Self) extends AnyVal {
