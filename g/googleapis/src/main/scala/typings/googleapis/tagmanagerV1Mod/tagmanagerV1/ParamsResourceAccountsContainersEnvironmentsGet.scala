...
@js.native
trait ParamsResourceAccountsContainersEnvironmentsGet extends StandardParameters {
...
object ParamsResourceAccountsContainersEnvironmentsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsContainersEnvironmentsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersEnvironmentsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsContainersEnvironmentsGetMutableBuilder[Self <: ParamsResourceAccountsContainersEnvironmentsGet] (val x: Self) extends AnyVal {
