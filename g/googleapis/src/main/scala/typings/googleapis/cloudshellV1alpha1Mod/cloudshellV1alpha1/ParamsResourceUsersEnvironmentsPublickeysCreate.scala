...
object ParamsResourceUsersEnvironmentsPublickeysCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceUsersEnvironmentsPublickeysCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersEnvironmentsPublickeysCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceUsersEnvironmentsPublickeysCreateMutableBuilder[Self <: ParamsResourceUsersEnvironmentsPublickeysCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreatePublicKeyRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
