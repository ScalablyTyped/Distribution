...
object ParamsResourceUsersEnvironmentsPublickeysCreate {
  ...
  @scala.inline
  implicit class ParamsResourceUsersEnvironmentsPublickeysCreateOps[Self <: ParamsResourceUsersEnvironmentsPublickeysCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreatePublicKeyRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
