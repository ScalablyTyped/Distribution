...
object ParamsResourceUsersEnvironmentsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceUsersEnvironmentsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersEnvironmentsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceUsersEnvironmentsGetMutableBuilder[Self <: ParamsResourceUsersEnvironmentsGet] (val x: Self) extends AnyVal {
