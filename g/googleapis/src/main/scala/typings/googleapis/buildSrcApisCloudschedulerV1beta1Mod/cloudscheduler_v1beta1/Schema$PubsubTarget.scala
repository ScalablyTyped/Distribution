...
/**
  ...
  */
@js.native
trait Schema$PubsubTarget extends js.Object {
  /**
...
object Schema$PubsubTarget {
  @scala.inline
  def apply(attributes: StringDictionary[String] = null, data: String = null, topicName: String = null): Schema$PubsubTarget = {
    val __obj = js.Dynamic.literal()
    if (attributes != null) __obj.updateDynamic("attributes")(attributes.asInstanceOf[js.Any])
    if (data != null) __obj.updateDynamic("data")(data.asInstanceOf[js.Any])
    if (topicName != null) __obj.updateDynamic("topicName")(topicName.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$PubsubTarget]
  }
}
