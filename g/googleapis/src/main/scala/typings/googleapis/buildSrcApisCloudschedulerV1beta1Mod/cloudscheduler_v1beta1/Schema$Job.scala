...
trait Schema$Job extends js.Object {
  ...
  /**
    * HTTP target.
    */
  var httpTarget: js.UndefOr[Schema$HttpTarget] = js.native
  /**
  ...
  /**
    * Pub/Sub target.
    */
  var pubsubTarget: js.UndefOr[Schema$PubsubTarget] = js.native
  /**
...
object Schema$Job {
  ...
  def apply(
    ...
    httpTarget: Schema$HttpTarget = null,
    lastAttemptTime: String = null,
    name: String = null,
    pubsubTarget: Schema$PubsubTarget = null,
