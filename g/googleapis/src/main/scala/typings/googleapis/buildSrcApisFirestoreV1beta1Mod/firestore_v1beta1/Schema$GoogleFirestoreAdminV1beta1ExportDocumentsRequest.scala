...
/**
  ...
  */
@js.native
trait Schema$GoogleFirestoreAdminV1beta1ExportDocumentsRequest extends js.Object {
  /**
...
object Schema$GoogleFirestoreAdminV1beta1ExportDocumentsRequest {
  @scala.inline
  def apply(collectionIds: js.Array[String] = null, outputUriPrefix: String = null): Schema$GoogleFirestoreAdminV1beta1ExportDocumentsRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleFirestoreAdminV1beta1ExportDocumentsRequest]
  }
}
