...
trait ParamsResourceProjectsSecretsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsSecretsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsSecretsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSecretsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsSecretsGetiampolicy](x: Self) {
