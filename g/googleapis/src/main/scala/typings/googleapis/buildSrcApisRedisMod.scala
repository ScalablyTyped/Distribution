...
import typings.googleapis.buildSrcApisRedisV1Mod.redis_v1.Options
import typings.googleapis.buildSrcApisRedisV1Mod.redis_v1.Redis
...
object buildSrcApisRedisMod extends js.Object {
  ...
  def redis(options: typings.googleapis.buildSrcApisRedisV1beta1Mod.redis_v1beta1.Options): typings.googleapis.buildSrcApisRedisV1beta1Mod.redis_v1beta1.Redis = js.native
  @JSName("redis")
  def redis_v1(version: v1): Redis = js.native
  @JSName("redis")
  def redis_v1beta1(version: v1beta1): typings.googleapis.buildSrcApisRedisV1beta1Mod.redis_v1beta1.Redis = js.native
  @js.native
    ...
    object v1beta1
      extends TopLevel[
              Instantiable2[
                ...
                typings.googleapis.buildSrcApisRedisV1beta1Mod.redis_v1beta1.Redis
              ]
            ]
