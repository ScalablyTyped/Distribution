...
trait ParamsResourceProjectsLocationsFeaturesDelete
  extends StObject
...
object ParamsResourceProjectsLocationsFeaturesDelete {
  
  inline def apply(): ParamsResourceProjectsLocationsFeaturesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsFeaturesDelete]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsFeaturesDelete](x: Self) {
