...
trait SchemaConfigManagementMembershipState extends StObject {
  ...
  /**
    * Binauthz status
    */
  var binauthzState: js.UndefOr[SchemaConfigManagementBinauthzState] = js.undefined
...
object SchemaConfigManagementMembershipState {
  ...
  extension [Self <: SchemaConfigManagementMembershipState](x: Self) {
    ...
    inline def setBinauthzState(value: SchemaConfigManagementBinauthzState): Self = StObject.set(x, "binauthzState", value.asInstanceOf[js.Any])
    
    inline def setBinauthzStateUndefined: Self = StObject.set(x, "binauthzState", js.undefined)
