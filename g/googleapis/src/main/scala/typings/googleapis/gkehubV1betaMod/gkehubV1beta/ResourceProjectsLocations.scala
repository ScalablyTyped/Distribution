...
@JSImport("googleapis/build/src/apis/gkehub/v1beta", "gkehub_v1beta.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var features: ResourceProjectsLocationsFeatures = js.native
  ...
  var memberships: ResourceProjectsLocationsMemberships = js.native
