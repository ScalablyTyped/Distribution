...
trait SchemaMembershipFeatureSpec extends StObject {
  ...
  /**
    ...
    */
  var cloudbuild: js.UndefOr[SchemaMembershipSpec] = js.undefined
...
object SchemaMembershipFeatureSpec {
  ...
  extension [Self <: SchemaMembershipFeatureSpec](x: Self) {
    ...
    inline def setCloudbuild(value: SchemaMembershipSpec): Self = StObject.set(x, "cloudbuild", value.asInstanceOf[js.Any])
