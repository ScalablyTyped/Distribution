...
trait SchemaAccountsUpdateLabelsRequest extends StObject {
...
object SchemaAccountsUpdateLabelsRequest {
  
  inline def apply(): SchemaAccountsUpdateLabelsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAccountsUpdateLabelsRequest]
  }
  
  extension [Self <: SchemaAccountsUpdateLabelsRequest](x: Self) {
