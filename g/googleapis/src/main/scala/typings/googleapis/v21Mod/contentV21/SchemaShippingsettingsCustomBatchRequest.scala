...
object SchemaShippingsettingsCustomBatchRequest {
  ...
  implicit class SchemaShippingsettingsCustomBatchRequestOps[Self <: SchemaShippingsettingsCustomBatchRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntriesVarargs(value: SchemaShippingsettingsCustomBatchRequestEntry*): Self = this.set("entries", js.Array(value :_*))
    @scala.inline
    def setEntries(value: js.Array[SchemaShippingsettingsCustomBatchRequestEntry]): Self = this.set("entries", value.asInstanceOf[js.Any])
    @scala.inline
