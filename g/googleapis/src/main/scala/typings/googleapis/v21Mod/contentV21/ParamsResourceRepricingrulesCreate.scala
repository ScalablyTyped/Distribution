...
trait ParamsResourceRepricingrulesCreate
  extends StObject
...
object ParamsResourceRepricingrulesCreate {
  
  inline def apply(): ParamsResourceRepricingrulesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRepricingrulesCreate]
  }
  
  extension [Self <: ParamsResourceRepricingrulesCreate](x: Self) {
