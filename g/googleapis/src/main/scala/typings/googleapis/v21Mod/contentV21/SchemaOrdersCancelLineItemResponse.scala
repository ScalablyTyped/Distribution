...
@js.native
trait SchemaOrdersCancelLineItemResponse extends js.Object {
...
object SchemaOrdersCancelLineItemResponse {
  ...
  @scala.inline
  def apply(): SchemaOrdersCancelLineItemResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOrdersCancelLineItemResponse]
  }
  
  @scala.inline
  implicit class SchemaOrdersCancelLineItemResponseOps[Self <: SchemaOrdersCancelLineItemResponse] (val x: Self) extends AnyVal {
