...
trait ParamsResourceCollectionsDelete
  extends StObject
...
object ParamsResourceCollectionsDelete {
  
  inline def apply(): ParamsResourceCollectionsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCollectionsDelete]
  }
  
  extension [Self <: ParamsResourceCollectionsDelete](x: Self) {
