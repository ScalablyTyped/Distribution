...
trait ParamsResourceCollectionsGet
  extends StObject
...
object ParamsResourceCollectionsGet {
  
  inline def apply(): ParamsResourceCollectionsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCollectionsGet]
  }
  
  extension [Self <: ParamsResourceCollectionsGet](x: Self) {
