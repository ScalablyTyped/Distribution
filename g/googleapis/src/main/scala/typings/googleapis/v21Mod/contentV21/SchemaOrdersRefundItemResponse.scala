...
trait SchemaOrdersRefundItemResponse extends StObject {
...
object SchemaOrdersRefundItemResponse {
  
  inline def apply(): SchemaOrdersRefundItemResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOrdersRefundItemResponse]
  }
  
  extension [Self <: SchemaOrdersRefundItemResponse](x: Self) {
