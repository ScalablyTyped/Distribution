...
trait SchemaMerchantOrderReturn extends StObject {
  ...
  /**
    ...
    */
  var returnPricingInfo: js.UndefOr[SchemaReturnPricingInfo] = js.undefined
...
object SchemaMerchantOrderReturn {
  ...
  extension [Self <: SchemaMerchantOrderReturn](x: Self) {
    ...
    inline def setReturnPricingInfo(value: SchemaReturnPricingInfo): Self = StObject.set(x, "returnPricingInfo", value.asInstanceOf[js.Any])
