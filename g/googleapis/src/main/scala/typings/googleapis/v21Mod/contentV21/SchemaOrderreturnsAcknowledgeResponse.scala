...
trait SchemaOrderreturnsAcknowledgeResponse extends StObject {
...
object SchemaOrderreturnsAcknowledgeResponse {
  
  inline def apply(): SchemaOrderreturnsAcknowledgeResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOrderreturnsAcknowledgeResponse]
  }
  
  extension [Self <: SchemaOrderreturnsAcknowledgeResponse](x: Self) {
