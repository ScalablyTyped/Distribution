...
trait SchemaLocalinventoryCustomBatchRequestEntry extends StObject {
  ...
  /**
    ...
    */
  var localInventory: js.UndefOr[SchemaLocalInventory] = js.undefined
...
object SchemaLocalinventoryCustomBatchRequestEntry {
  
  inline def apply(): SchemaLocalinventoryCustomBatchRequestEntry = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaLocalinventoryCustomBatchRequestEntry]
  }
  
  extension [Self <: SchemaLocalinventoryCustomBatchRequestEntry](x: Self) {
    ...
    inline def setLocalInventory(value: SchemaLocalInventory): Self = StObject.set(x, "localInventory", value.asInstanceOf[js.Any])
