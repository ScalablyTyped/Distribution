...
trait SchemaOrdersRefundOrderResponse extends StObject {
...
object SchemaOrdersRefundOrderResponse {
  
  inline def apply(): SchemaOrdersRefundOrderResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOrdersRefundOrderResponse]
  }
  
  extension [Self <: SchemaOrdersRefundOrderResponse](x: Self) {
