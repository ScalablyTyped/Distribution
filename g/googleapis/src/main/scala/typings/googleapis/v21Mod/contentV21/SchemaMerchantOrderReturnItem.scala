...
trait SchemaMerchantOrderReturnItem extends StObject {
  ...
  /**
    ...
    */
  var merchantRejectionReason: js.UndefOr[SchemaMerchantRejectionReason] = js.undefined
  ...
  /**
    ...
    */
  var refundableAmount: js.UndefOr[SchemaMonetaryAmount] = js.undefined
  ...
  /**
    ...
    */
  var shipmentUnitId: js.UndefOr[String | Null] = js.undefined
...
object SchemaMerchantOrderReturnItem {
  ...
  extension [Self <: SchemaMerchantOrderReturnItem](x: Self) {
    ...
    inline def setMerchantRejectionReason(value: SchemaMerchantRejectionReason): Self = StObject.set(x, "merchantRejectionReason", value.asInstanceOf[js.Any])
    ...
    inline def setRefundableAmount(value: SchemaMonetaryAmount): Self = StObject.set(x, "refundableAmount", value.asInstanceOf[js.Any])
    ...
    inline def setShipmentUnitIdNull: Self = StObject.set(x, "shipmentUnitId", null)
