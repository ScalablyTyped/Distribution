...
trait SchemaAccountItemUpdatesSettings extends StObject {
  ...
  /**
    ...
    */
  var allowAvailabilityUpdates: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var allowConditionUpdates: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * If price updates are enabled, Google always updates the active price with the crawled information.
    */
  var allowPriceUpdates: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * If allow_availability_updates is enabled, items are automatically updated in all your Shopping target countries. By default, availability updates will only be applied to items that are 'out of stock' on your website but 'in stock' on Shopping. Set this to true to also update items that are 'in stock' on your website, but 'out of stock' on Google Shopping. In order for this field to have an effect, you must also allow availability updates.
    */
  var allowStrictAvailabilityUpdates: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaAccountItemUpdatesSettings {
  
  inline def apply(): SchemaAccountItemUpdatesSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAccountItemUpdatesSettings]
  }
  
  extension [Self <: SchemaAccountItemUpdatesSettings](x: Self) {
    ...
    inline def setAllowAvailabilityUpdatesNull: Self = StObject.set(x, "allowAvailabilityUpdates", null)
    ...
    inline def setAllowConditionUpdatesNull: Self = StObject.set(x, "allowConditionUpdates", null)
    ...
    inline def setAllowPriceUpdatesNull: Self = StObject.set(x, "allowPriceUpdates", null)
    ...
    inline def setAllowStrictAvailabilityUpdatesNull: Self = StObject.set(x, "allowStrictAvailabilityUpdates", null)
