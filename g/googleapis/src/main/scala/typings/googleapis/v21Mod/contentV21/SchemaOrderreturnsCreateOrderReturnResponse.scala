...
trait SchemaOrderreturnsCreateOrderReturnResponse extends StObject {
  ...
  /**
    ...
    */
  var orderReturn: js.UndefOr[SchemaMerchantOrderReturn] = js.undefined
}
object SchemaOrderreturnsCreateOrderReturnResponse {
  
  inline def apply(): SchemaOrderreturnsCreateOrderReturnResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOrderreturnsCreateOrderReturnResponse]
  }
  
  extension [Self <: SchemaOrderreturnsCreateOrderReturnResponse](x: Self) {
    ...
    inline def setOrderReturn(value: SchemaMerchantOrderReturn): Self = StObject.set(x, "orderReturn", value.asInstanceOf[js.Any])
