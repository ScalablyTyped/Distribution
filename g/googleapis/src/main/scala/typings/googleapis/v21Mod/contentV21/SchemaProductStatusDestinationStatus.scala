...
trait SchemaProductStatusDestinationStatus extends StObject {
  ...
  /**
    ...
    */
  var approvedCountries: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var pendingCountries: js.UndefOr[js.Array[String] | Null] = js.undefined
...
object SchemaProductStatusDestinationStatus {
  ...
  extension [Self <: SchemaProductStatusDestinationStatus](x: Self) {
    ...
    inline def setApprovedCountriesNull: Self = StObject.set(x, "approvedCountries", null)
    ...
    inline def setPendingCountriesNull: Self = StObject.set(x, "pendingCountries", null)
