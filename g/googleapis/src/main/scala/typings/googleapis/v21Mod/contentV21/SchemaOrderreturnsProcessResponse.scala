...
trait SchemaOrderreturnsProcessResponse extends StObject {
...
object SchemaOrderreturnsProcessResponse {
  
  inline def apply(): SchemaOrderreturnsProcessResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOrderreturnsProcessResponse]
  }
  
  extension [Self <: SchemaOrderreturnsProcessResponse](x: Self) {
