...
trait ParamsResourcePosSale
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaPosSaleRequest] = js.undefined
...
object ParamsResourcePosSale {
  ...
  @scala.inline
  implicit class ParamsResourcePosSaleMutableBuilder[Self <: ParamsResourcePosSale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaPosSaleRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
