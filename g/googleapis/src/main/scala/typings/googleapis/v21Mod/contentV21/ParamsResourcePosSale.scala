...
object ParamsResourcePosSale {
  ...
  inline def apply(): ParamsResourcePosSale = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePosSale]
  }
  
  extension [Self <: ParamsResourcePosSale](x: Self) {
    
    inline def setMerchantId(value: String): Self = StObject.set(x, "merchantId", value.asInstanceOf[js.Any])
    
    inline def setMerchantIdUndefined: Self = StObject.set(x, "merchantId", js.undefined)
    
    inline def setRequestBody(value: SchemaPosSaleRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
