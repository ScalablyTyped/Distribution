...
trait SchemaTestOrderAddress extends StObject {
...
object SchemaTestOrderAddress {
  
  inline def apply(): SchemaTestOrderAddress = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaTestOrderAddress]
  }
  
  extension [Self <: SchemaTestOrderAddress](x: Self) {
