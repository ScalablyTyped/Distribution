...
@js.native
trait ParamsResourceAccountstatusesList extends StandardParameters {
...
object ParamsResourceAccountstatusesList {
  ...
  @scala.inline
  implicit class ParamsResourceAccountstatusesListOps[Self <: ParamsResourceAccountstatusesList] (val x: Self) extends AnyVal {
