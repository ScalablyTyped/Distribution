...
object ParamsResourceOrdersShiplineitems {
  ...
  @scala.inline
  implicit class ParamsResourceOrdersShiplineitemsMutableBuilder[Self <: ParamsResourceOrdersShiplineitems] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaOrdersShipLineItemsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
