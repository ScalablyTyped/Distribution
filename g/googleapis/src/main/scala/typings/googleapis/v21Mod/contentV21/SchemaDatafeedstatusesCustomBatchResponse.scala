...
object SchemaDatafeedstatusesCustomBatchResponse {
  ...
  implicit class SchemaDatafeedstatusesCustomBatchResponseOps[Self <: SchemaDatafeedstatusesCustomBatchResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntriesVarargs(value: SchemaDatafeedstatusesCustomBatchResponseEntry*): Self = this.set("entries", js.Array(value :_*))
    
    @scala.inline
    def setEntries(value: js.Array[SchemaDatafeedstatusesCustomBatchResponseEntry]): Self = this.set("entries", value.asInstanceOf[js.Any])
