...
object ParamsResourceShippingsettingsGetsupportedcarriers {
  ...
  @scala.inline
  implicit class ParamsResourceShippingsettingsGetsupportedcarriersOps[Self <: ParamsResourceShippingsettingsGetsupportedcarriers] (val x: Self) extends AnyVal {
    @scala.inline
