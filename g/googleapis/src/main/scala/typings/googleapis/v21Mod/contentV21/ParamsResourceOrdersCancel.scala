...
object ParamsResourceOrdersCancel {
  ...
  @scala.inline
  implicit class ParamsResourceOrdersCancelOps[Self <: ParamsResourceOrdersCancel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaOrdersCancelRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
