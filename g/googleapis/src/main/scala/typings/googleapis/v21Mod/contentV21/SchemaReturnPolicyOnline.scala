...
trait SchemaReturnPolicyOnline extends StObject {
  ...
  /**
    ...
    */
  var itemConditions: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    * The return policy.
    */
  var policy: js.UndefOr[SchemaReturnPolicyOnlinePolicy] = js.undefined
  ...
  /**
    ...
    */
  var restockingFee: js.UndefOr[SchemaReturnPolicyOnlineRestockingFee] = js.undefined
  ...
  /**
    ...
    */
  var returnMethods: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var returnPolicyUri: js.UndefOr[String | Null] = js.undefined
  
  /**
    * The return reason category information. This required to not be empty unless the type of return policy is noReturns.
    */
  var returnReasonCategoryInfo: js.UndefOr[js.Array[SchemaReturnPolicyOnlineReturnReasonCategoryInfo]] = js.undefined
}
object SchemaReturnPolicyOnline {
  
  inline def apply(): SchemaReturnPolicyOnline = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaReturnPolicyOnline]
  }
  
  extension [Self <: SchemaReturnPolicyOnline](x: Self) {
    ...
    inline def setItemConditionsNull: Self = StObject.set(x, "itemConditions", null)
    ...
    inline def setPolicy(value: SchemaReturnPolicyOnlinePolicy): Self = StObject.set(x, "policy", value.asInstanceOf[js.Any])
    
    inline def setPolicyUndefined: Self = StObject.set(x, "policy", js.undefined)
    
    inline def setRestockingFee(value: SchemaReturnPolicyOnlineRestockingFee): Self = StObject.set(x, "restockingFee", value.asInstanceOf[js.Any])
    ...
    inline def setReturnMethodsNull: Self = StObject.set(x, "returnMethods", null)
    ...
    inline def setReturnPolicyUriNull: Self = StObject.set(x, "returnPolicyUri", null)
    
    inline def setReturnPolicyUriUndefined: Self = StObject.set(x, "returnPolicyUri", js.undefined)
    
    inline def setReturnReasonCategoryInfo(value: js.Array[SchemaReturnPolicyOnlineReturnReasonCategoryInfo]): Self = StObject.set(x, "returnReasonCategoryInfo", value.asInstanceOf[js.Any])
    
    inline def setReturnReasonCategoryInfoUndefined: Self = StObject.set(x, "returnReasonCategoryInfo", js.undefined)
    
    inline def setReturnReasonCategoryInfoVarargs(value: SchemaReturnPolicyOnlineReturnReasonCategoryInfo*): Self = StObject.set(x, "returnReasonCategoryInfo", js.Array(value*))
  }
}
