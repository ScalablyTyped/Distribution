...
trait ParamsResourceReturnpolicyonlineGet
  extends StObject
...
object ParamsResourceReturnpolicyonlineGet {
  
  inline def apply(): ParamsResourceReturnpolicyonlineGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceReturnpolicyonlineGet]
  }
  
  extension [Self <: ParamsResourceReturnpolicyonlineGet](x: Self) {
