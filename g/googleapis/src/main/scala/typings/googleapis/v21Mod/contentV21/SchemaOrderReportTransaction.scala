...
trait SchemaOrderReportTransaction extends StObject {
  ...
  /**
    ...
    */
  var productAmount: js.UndefOr[SchemaProductAmount] = js.undefined
...
object SchemaOrderReportTransaction {
  ...
  extension [Self <: SchemaOrderReportTransaction](x: Self) {
    ...
    inline def setProductAmount(value: SchemaProductAmount): Self = StObject.set(x, "productAmount", value.asInstanceOf[js.Any])
