...
trait ParamsResourceAccountsListlinks
  extends StObject
...
object ParamsResourceAccountsListlinks {
  
  inline def apply(): ParamsResourceAccountsListlinks = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsListlinks]
  }
  
  extension [Self <: ParamsResourceAccountsListlinks](x: Self) {
