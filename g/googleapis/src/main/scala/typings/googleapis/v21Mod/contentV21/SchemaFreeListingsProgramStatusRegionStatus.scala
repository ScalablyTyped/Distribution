...
trait SchemaFreeListingsProgramStatusRegionStatus extends StObject {
  ...
  /**
    ...
    */
  var reviewIneligibilityReasonDetails: js.UndefOr[SchemaFreeListingsProgramStatusReviewIneligibilityReasonDetails] = js.undefined
...
object SchemaFreeListingsProgramStatusRegionStatus {
  
  inline def apply(): SchemaFreeListingsProgramStatusRegionStatus = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaFreeListingsProgramStatusRegionStatus]
  }
  
  extension [Self <: SchemaFreeListingsProgramStatusRegionStatus](x: Self) {
    ...
    inline def setReviewIneligibilityReasonDetails(value: SchemaFreeListingsProgramStatusReviewIneligibilityReasonDetails): Self = StObject.set(x, "reviewIneligibilityReasonDetails", value.asInstanceOf[js.Any])
