...
object ParamsResourceOrdersCreatetestorder {
  ...
  @scala.inline
  implicit class ParamsResourceOrdersCreatetestorderOps[Self <: ParamsResourceOrdersCreatetestorder] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaOrdersCreateTestOrderRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
