...
/**
  ...
  */
@js.native
trait Schema$TimeSeries extends js.Object {
  /**
  ...
  /**
    ...
    * series.
    */
  var metric: js.UndefOr[Schema$Metric] = js.native
  /**
  ...
  /**
    ...
    */
  var points: js.UndefOr[js.Array[Schema$Point]] = js.native
  /**
...
object Schema$TimeSeries {
  @scala.inline
  def apply(
    metadata: Schema$MonitoredResourceMetadata = null,
    metric: Schema$Metric = null,
    metricKind: String = null,
    points: js.Array[Schema$Point] = null,
    ...
    __obj.asInstanceOf[Schema$TimeSeries]
  }
}
