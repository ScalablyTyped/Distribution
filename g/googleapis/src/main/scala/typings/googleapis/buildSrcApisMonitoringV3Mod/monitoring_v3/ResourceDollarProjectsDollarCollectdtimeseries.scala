...
@js.native
class ResourceDollarProjectsDollarCollectdtimeseries protected () extends js.Object {
  ...
  /**
    ...
    */
  def create(): GaxiosPromise[Schema$CreateCollectdTimeSeriesResponse] = js.native
  def create(callback: BodyResponseCallback[Schema$CreateCollectdTimeSeriesResponse]): Unit = js.native
  def create(params: ParamsDollarResourceDollarProjectsDollarCollectdtimeseriesDollarCreate): GaxiosPromise[Schema$CreateCollectdTimeSeriesResponse] = js.native
  def create(
    params: ParamsDollarResourceDollarProjectsDollarCollectdtimeseriesDollarCreate,
    callback: BodyResponseCallback[Schema$CreateCollectdTimeSeriesResponse]
  ): Unit = js.native
  def create(
    params: ParamsDollarResourceDollarProjectsDollarCollectdtimeseriesDollarCreate,
    options: BodyResponseCallback[Schema$CreateCollectdTimeSeriesResponse],
    callback: BodyResponseCallback[Schema$CreateCollectdTimeSeriesResponse]
  ): Unit = js.native
  def create(
    params: ParamsDollarResourceDollarProjectsDollarCollectdtimeseriesDollarCreate,
    options: MethodOptions
  ): GaxiosPromise[Schema$CreateCollectdTimeSeriesResponse] = js.native
  def create(
    params: ParamsDollarResourceDollarProjectsDollarCollectdtimeseriesDollarCreate,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$CreateCollectdTimeSeriesResponse]
