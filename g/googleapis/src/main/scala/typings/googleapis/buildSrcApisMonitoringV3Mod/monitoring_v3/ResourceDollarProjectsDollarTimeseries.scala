...
@js.native
class ResourceDollarProjectsDollarTimeseries protected () extends js.Object {
  ...
  def create(params: ParamsDollarResourceDollarProjectsDollarTimeseriesDollarCreate): GaxiosPromise[Schema$Empty] = js.native
  def create(
    params: ParamsDollarResourceDollarProjectsDollarTimeseriesDollarCreate,
  ...
  def create(params: ParamsDollarResourceDollarProjectsDollarTimeseriesDollarCreate, options: MethodOptions): GaxiosPromise[Schema$Empty] = js.native
  def create(
    params: ParamsDollarResourceDollarProjectsDollarTimeseriesDollarCreate,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def list(): GaxiosPromise[Schema$ListTimeSeriesResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListTimeSeriesResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarProjectsDollarTimeseriesDollarList): GaxiosPromise[Schema$ListTimeSeriesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarTimeseriesDollarList,
    callback: BodyResponseCallback[Schema$ListTimeSeriesResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarTimeseriesDollarList,
    options: BodyResponseCallback[Schema$ListTimeSeriesResponse],
    callback: BodyResponseCallback[Schema$ListTimeSeriesResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarProjectsDollarTimeseriesDollarList, options: MethodOptions): GaxiosPromise[Schema$ListTimeSeriesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarTimeseriesDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListTimeSeriesResponse]
