...
@js.native
class ResourceDollarProjectsDollarMonitoredresourcedescriptors protected () extends js.Object {
  ...
  /**
    ...
    */
  def get(): GaxiosPromise[Schema$MonitoredResourceDescriptor] = js.native
  def get(callback: BodyResponseCallback[Schema$MonitoredResourceDescriptor]): Unit = js.native
  def get(params: ParamsDollarResourceDollarProjectsDollarMonitoredresourcedescriptorsDollarGet): GaxiosPromise[Schema$MonitoredResourceDescriptor] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarMonitoredresourcedescriptorsDollarGet,
    callback: BodyResponseCallback[Schema$MonitoredResourceDescriptor]
  ): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarMonitoredresourcedescriptorsDollarGet,
    options: BodyResponseCallback[Schema$MonitoredResourceDescriptor],
    callback: BodyResponseCallback[Schema$MonitoredResourceDescriptor]
  ): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarMonitoredresourcedescriptorsDollarGet,
    options: MethodOptions
  ): GaxiosPromise[Schema$MonitoredResourceDescriptor] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarMonitoredresourcedescriptorsDollarGet,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$MonitoredResourceDescriptor]
  ...
  def list(params: ParamsDollarResourceDollarProjectsDollarMonitoredresourcedescriptorsDollarList): GaxiosPromise[Schema$ListMonitoredResourceDescriptorsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarMonitoredresourcedescriptorsDollarList,
  ...
  def list(
    params: ParamsDollarResourceDollarProjectsDollarMonitoredresourcedescriptorsDollarList,
    options: MethodOptions
  ): GaxiosPromise[Schema$ListMonitoredResourceDescriptorsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarMonitoredresourcedescriptorsDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListMonitoredResourceDescriptorsResponse]
