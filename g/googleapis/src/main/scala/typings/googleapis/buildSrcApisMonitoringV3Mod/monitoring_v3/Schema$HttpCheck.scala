...
/**
  ...
  */
@js.native
trait Schema$HttpCheck extends js.Object {
  /**
    * The authentication information. Optional when creating an HTTP check;
    * defaults to empty.
    */
  var authInfo: js.UndefOr[Schema$BasicAuthentication] = js.native
  /**
...
object Schema$HttpCheck {
  @scala.inline
  def apply(
    authInfo: Schema$BasicAuthentication = null,
    ...
    __obj.asInstanceOf[Schema$HttpCheck]
  }
}
