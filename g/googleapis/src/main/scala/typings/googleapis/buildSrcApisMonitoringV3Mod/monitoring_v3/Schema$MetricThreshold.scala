...
/**
  ...
  */
@js.native
trait Schema$MetricThreshold extends js.Object {
  /**
  ...
  /**
    ...
    * field.
    */
  var denominatorAggregations: js.UndefOr[js.Array[Schema$Aggregation]] = js.native
  /**
...
object Schema$MetricThreshold {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$MetricThreshold]
  }
}
