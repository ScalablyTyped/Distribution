...
object ParamsResourceProjectsTestmatricesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsTestmatricesCreateMutableBuilder[Self <: ParamsResourceProjectsTestmatricesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaTestMatrix): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
