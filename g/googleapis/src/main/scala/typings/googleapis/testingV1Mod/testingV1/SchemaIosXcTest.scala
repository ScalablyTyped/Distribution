...
trait SchemaIosXcTest extends StObject {
  ...
  /**
    ...
    */
  var testSpecialEntitlements: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaIosXcTest {
  ...
  extension [Self <: SchemaIosXcTest](x: Self) {
    ...
    inline def setTestSpecialEntitlementsNull: Self = StObject.set(x, "testSpecialEntitlements", null)
