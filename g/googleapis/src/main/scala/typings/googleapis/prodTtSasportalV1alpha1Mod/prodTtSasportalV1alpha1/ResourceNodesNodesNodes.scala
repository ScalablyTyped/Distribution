...
@JSImport("googleapis/build/src/apis/prod_tt_sasportal/v1alpha1", "prod_tt_sasportal_v1alpha1.Resource$Nodes$Nodes$Nodes")
@js.native
open class ResourceNodesNodesNodes protected () extends StObject {
  ...
  def create(params: ParamsResourceNodesNodesNodesCreate): GaxiosPromise[SchemaSasPortalNode] = js.native
  def create(params: ParamsResourceNodesNodesNodesCreate, callback: BodyResponseCallback[SchemaSasPortalNode]): Unit = js.native
  def create(
    params: ParamsResourceNodesNodesNodesCreate,
    options: BodyResponseCallback[Readable | SchemaSasPortalNode],
    callback: BodyResponseCallback[Readable | SchemaSasPortalNode]
  ): Unit = js.native
  def create(params: ParamsResourceNodesNodesNodesCreate, options: MethodOptions): GaxiosPromise[SchemaSasPortalNode] = js.native
  def create(
    params: ParamsResourceNodesNodesNodesCreate,
  ...
  /**
    ...
    */
  def create(params: ParamsResourceNodesNodesNodesCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceNodesNodesNodesCreate,
  ...
  def list(params: ParamsResourceNodesNodesNodesList): GaxiosPromise[SchemaSasPortalListNodesResponse] = js.native
  def list(
    params: ParamsResourceNodesNodesNodesList,
  ...
  def list(params: ParamsResourceNodesNodesNodesList, options: MethodOptions): GaxiosPromise[SchemaSasPortalListNodesResponse] = js.native
  def list(
    params: ParamsResourceNodesNodesNodesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaSasPortalListNodesResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceNodesNodesNodesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceNodesNodesNodesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
