...
trait ParamsResourceNodesNodesList
  extends StObject
...
object ParamsResourceNodesNodesList {
  
  inline def apply(): ParamsResourceNodesNodesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodesNodesList]
  }
  
  extension [Self <: ParamsResourceNodesNodesList](x: Self) {
