...
trait ParamsResourceCustomersDeploymentsCreate
  extends StObject
...
object ParamsResourceCustomersDeploymentsCreate {
  
  inline def apply(): ParamsResourceCustomersDeploymentsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomersDeploymentsCreate]
  }
  
  extension [Self <: ParamsResourceCustomersDeploymentsCreate](x: Self) {
