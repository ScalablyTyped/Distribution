...
trait ParamsResourceCustomersNodesDevicesList
  extends StObject
...
object ParamsResourceCustomersNodesDevicesList {
  
  inline def apply(): ParamsResourceCustomersNodesDevicesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomersNodesDevicesList]
  }
  
  extension [Self <: ParamsResourceCustomersNodesDevicesList](x: Self) {
