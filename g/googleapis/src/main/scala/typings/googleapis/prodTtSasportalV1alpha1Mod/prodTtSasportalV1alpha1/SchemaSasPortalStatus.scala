...
trait SchemaSasPortalStatus extends StObject {
...
object SchemaSasPortalStatus {
  
  inline def apply(): SchemaSasPortalStatus = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSasPortalStatus]
  }
  
  extension [Self <: SchemaSasPortalStatus](x: Self) {
