...
trait ParamsResourceNodesDevicesList
  extends StObject
...
object ParamsResourceNodesDevicesList {
  
  inline def apply(): ParamsResourceNodesDevicesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodesDevicesList]
  }
  
  extension [Self <: ParamsResourceNodesDevicesList](x: Self) {
