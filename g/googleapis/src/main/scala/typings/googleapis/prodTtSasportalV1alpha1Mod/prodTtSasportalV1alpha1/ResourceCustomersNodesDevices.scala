...
@JSImport("googleapis/build/src/apis/prod_tt_sasportal/v1alpha1", "prod_tt_sasportal_v1alpha1.Resource$Customers$Nodes$Devices")
@js.native
open class ResourceCustomersNodesDevices protected () extends StObject {
  ...
  def create(params: ParamsResourceCustomersNodesDevicesCreate): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def create(
    params: ParamsResourceCustomersNodesDevicesCreate,
  ...
  def create(params: ParamsResourceCustomersNodesDevicesCreate, options: MethodOptions): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def create(
    params: ParamsResourceCustomersNodesDevicesCreate,
  ...
  /**
    ...
    */
  def create(params: ParamsResourceCustomersNodesDevicesCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceCustomersNodesDevicesCreate,
  ...
  def createSigned(params: ParamsResourceCustomersNodesDevicesCreatesigned): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def createSigned(
    params: ParamsResourceCustomersNodesDevicesCreatesigned,
    callback: BodyResponseCallback[SchemaSasPortalDevice]
  ): Unit = js.native
  def createSigned(
    params: ParamsResourceCustomersNodesDevicesCreatesigned,
  ...
  def createSigned(params: ParamsResourceCustomersNodesDevicesCreatesigned, options: MethodOptions): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def createSigned(
    params: ParamsResourceCustomersNodesDevicesCreatesigned,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaSasPortalDevice]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def createSigned(params: ParamsResourceCustomersNodesDevicesCreatesigned, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def createSigned(
    params: ParamsResourceCustomersNodesDevicesCreatesigned,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def list(params: ParamsResourceCustomersNodesDevicesList): GaxiosPromise[SchemaSasPortalListDevicesResponse] = js.native
  def list(
    params: ParamsResourceCustomersNodesDevicesList,
  ...
  def list(params: ParamsResourceCustomersNodesDevicesList, options: MethodOptions): GaxiosPromise[SchemaSasPortalListDevicesResponse] = js.native
  def list(
    params: ParamsResourceCustomersNodesDevicesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaSasPortalListDevicesResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceCustomersNodesDevicesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceCustomersNodesDevicesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
