...
trait ParamsResourceNodesDevicesCreatesigned
  extends StObject
...
object ParamsResourceNodesDevicesCreatesigned {
  
  inline def apply(): ParamsResourceNodesDevicesCreatesigned = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodesDevicesCreatesigned]
  }
  
  extension [Self <: ParamsResourceNodesDevicesCreatesigned](x: Self) {
