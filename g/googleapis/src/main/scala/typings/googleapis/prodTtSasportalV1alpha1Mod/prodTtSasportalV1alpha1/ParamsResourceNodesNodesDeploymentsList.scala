...
trait ParamsResourceNodesNodesDeploymentsList
  extends StObject
...
object ParamsResourceNodesNodesDeploymentsList {
  
  inline def apply(): ParamsResourceNodesNodesDeploymentsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodesNodesDeploymentsList]
  }
  
  extension [Self <: ParamsResourceNodesNodesDeploymentsList](x: Self) {
