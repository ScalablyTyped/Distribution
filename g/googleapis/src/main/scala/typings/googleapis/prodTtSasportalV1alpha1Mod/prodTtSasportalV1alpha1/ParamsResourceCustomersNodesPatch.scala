...
trait ParamsResourceCustomersNodesPatch
  extends StObject
...
object ParamsResourceCustomersNodesPatch {
  
  inline def apply(): ParamsResourceCustomersNodesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomersNodesPatch]
  }
  
  extension [Self <: ParamsResourceCustomersNodesPatch](x: Self) {
