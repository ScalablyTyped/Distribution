...
trait ParamsResourceCustomersNodesNodesList
  extends StObject
...
object ParamsResourceCustomersNodesNodesList {
  
  inline def apply(): ParamsResourceCustomersNodesNodesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomersNodesNodesList]
  }
  
  extension [Self <: ParamsResourceCustomersNodesNodesList](x: Self) {
