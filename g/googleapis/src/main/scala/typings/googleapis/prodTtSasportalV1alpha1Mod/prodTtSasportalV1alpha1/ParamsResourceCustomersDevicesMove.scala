...
trait ParamsResourceCustomersDevicesMove
  extends StObject
...
object ParamsResourceCustomersDevicesMove {
  
  inline def apply(): ParamsResourceCustomersDevicesMove = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomersDevicesMove]
  }
  
  extension [Self <: ParamsResourceCustomersDevicesMove](x: Self) {
