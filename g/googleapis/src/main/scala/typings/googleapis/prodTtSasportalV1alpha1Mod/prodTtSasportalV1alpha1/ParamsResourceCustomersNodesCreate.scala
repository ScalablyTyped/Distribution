...
trait ParamsResourceCustomersNodesCreate
  extends StObject
...
object ParamsResourceCustomersNodesCreate {
  
  inline def apply(): ParamsResourceCustomersNodesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomersNodesCreate]
  }
  
  extension [Self <: ParamsResourceCustomersNodesCreate](x: Self) {
