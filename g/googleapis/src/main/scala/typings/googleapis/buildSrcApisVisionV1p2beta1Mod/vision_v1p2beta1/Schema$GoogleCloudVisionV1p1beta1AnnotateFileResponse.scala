...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p1beta1AnnotateFileResponse extends js.Object {
  /**
...
object Schema$GoogleCloudVisionV1p1beta1AnnotateFileResponse {
  @scala.inline
  def apply(
    inputConfig: Schema$GoogleCloudVisionV1p1beta1InputConfig = null,
    responses: js.Array[Schema$GoogleCloudVisionV1p1beta1AnnotateImageResponse] = null
  ): Schema$GoogleCloudVisionV1p1beta1AnnotateFileResponse = {
    val __obj = js.Dynamic.literal()
    if (inputConfig != null) __obj.updateDynamic("inputConfig")(inputConfig.asInstanceOf[js.Any])
    if (responses != null) __obj.updateDynamic("responses")(responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p1beta1AnnotateFileResponse]
  }
}
