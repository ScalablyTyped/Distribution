...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p1beta1Block extends js.Object {
  /**
  ...
  /**
    ...
    */
  var paragraphs: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p1beta1Paragraph]] = js.native
  /**
...
object Schema$GoogleCloudVisionV1p1beta1Block {
  @scala.inline
  def apply(
    blockType: String = null,
    boundingBox: Schema$GoogleCloudVisionV1p1beta1BoundingPoly = null,
    confidence: Int | Double = null,
    paragraphs: js.Array[Schema$GoogleCloudVisionV1p1beta1Paragraph] = null,
    property: Schema$GoogleCloudVisionV1p1beta1TextAnnotationTextProperty = null
  ): Schema$GoogleCloudVisionV1p1beta1Block = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p1beta1Block]
  }
}
