...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p2beta1Image extends js.Object {
  /**
  ...
  /**
    ...
    */
  var source: js.UndefOr[Schema$GoogleCloudVisionV1p2beta1ImageSource] = js.native
}

object Schema$GoogleCloudVisionV1p2beta1Image {
  @scala.inline
  def apply(content: String = null, source: Schema$GoogleCloudVisionV1p2beta1ImageSource = null): Schema$GoogleCloudVisionV1p2beta1Image = {
    val __obj = js.Dynamic.literal()
    if (content != null) __obj.updateDynamic("content")(content.asInstanceOf[js.Any])
    if (source != null) __obj.updateDynamic("source")(source.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p2beta1Image]
  }
}
