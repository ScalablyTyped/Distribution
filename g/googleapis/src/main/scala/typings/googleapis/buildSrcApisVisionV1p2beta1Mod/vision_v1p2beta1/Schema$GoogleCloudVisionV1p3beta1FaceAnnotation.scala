...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p3beta1FaceAnnotation extends js.Object {
  /**
    * Anger likelihood.
    */
  ...
  /**
    ...
    * annotated.
    */
  var boundingPoly: js.UndefOr[Schema$GoogleCloudVisionV1p3beta1BoundingPoly] = js.native
  /**
  ...
  /**
    ...
    */
  var fdBoundingPoly: js.UndefOr[Schema$GoogleCloudVisionV1p3beta1BoundingPoly] = js.native
  /**
    * Headwear likelihood.
    */
  ...
  /**
    ...
    */
  var landmarks: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p3beta1FaceAnnotationLandmark]] = js.native
  /**
...
object Schema$GoogleCloudVisionV1p3beta1FaceAnnotation {
  @scala.inline
  def apply(
    angerLikelihood: String = null,
    blurredLikelihood: String = null,
    boundingPoly: Schema$GoogleCloudVisionV1p3beta1BoundingPoly = null,
    detectionConfidence: Int | Double = null,
    fdBoundingPoly: Schema$GoogleCloudVisionV1p3beta1BoundingPoly = null,
    headwearLikelihood: String = null,
    joyLikelihood: String = null,
    landmarkingConfidence: Int | Double = null,
    landmarks: js.Array[Schema$GoogleCloudVisionV1p3beta1FaceAnnotationLandmark] = null,
  ...
  ): Schema$GoogleCloudVisionV1p3beta1FaceAnnotation = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p3beta1FaceAnnotation]
  }
}
