...
object ParamsResourceOrgunitsInsert {
  ...
  @scala.inline
  def apply(): ParamsResourceOrgunitsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrgunitsInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceOrgunitsInsertMutableBuilder[Self <: ParamsResourceOrgunitsInsert] (val x: Self) extends AnyVal {
