...
@js.native
trait ParamsResourceChannelsStop extends StandardParameters {
...
object ParamsResourceChannelsStop {
  ...
  @scala.inline
  implicit class ParamsResourceChannelsStopOps[Self <: ParamsResourceChannelsStop] (val x: Self) extends AnyVal {
