...
@js.native
trait ParamsResourceUsersPhotosGet extends StandardParameters {
...
object ParamsResourceUsersPhotosGet {
  ...
  @scala.inline
  def apply(): ParamsResourceUsersPhotosGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersPhotosGet]
  }
  
  @scala.inline
  implicit class ParamsResourceUsersPhotosGetMutableBuilder[Self <: ParamsResourceUsersPhotosGet] (val x: Self) extends AnyVal {
