...
trait ParamsResourceResourcesBuildingsPatch
  extends StObject
...
object ParamsResourceResourcesBuildingsPatch {
  ...
  inline def apply(): ParamsResourceResourcesBuildingsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResourcesBuildingsPatch]
  }
  
  extension [Self <: ParamsResourceResourcesBuildingsPatch](x: Self) {
