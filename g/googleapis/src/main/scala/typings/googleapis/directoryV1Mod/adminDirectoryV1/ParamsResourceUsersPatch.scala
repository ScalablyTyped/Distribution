...
@js.native
trait ParamsResourceUsersPatch extends StandardParameters {
  /**
...
object ParamsResourceUsersPatch {
  ...
  @scala.inline
  implicit class ParamsResourceUsersPatchOps[Self <: ParamsResourceUsersPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaUser): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
