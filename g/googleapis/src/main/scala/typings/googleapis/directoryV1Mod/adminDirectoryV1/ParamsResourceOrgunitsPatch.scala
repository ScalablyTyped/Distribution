...
object ParamsResourceOrgunitsPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceOrgunitsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrgunitsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceOrgunitsPatchMutableBuilder[Self <: ParamsResourceOrgunitsPatch] (val x: Self) extends AnyVal {
