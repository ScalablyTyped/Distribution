...
object ParamsResourceGroupsAliasesInsert {
  ...
  @scala.inline
  implicit class ParamsResourceGroupsAliasesInsertOps[Self <: ParamsResourceGroupsAliasesInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaAlias): Self = this.set("requestBody", value.asInstanceOf[js.Any])
