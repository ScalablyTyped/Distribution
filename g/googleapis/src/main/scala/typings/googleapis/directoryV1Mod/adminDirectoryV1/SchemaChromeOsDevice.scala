...
object SchemaChromeOsDevice {
  ...
  extension [Self <: SchemaChromeOsDevice](x: Self) {
    ...
    inline def setActiveTimeRangesVarargs(value: ActiveTime*): Self = StObject.set(x, "activeTimeRanges", js.Array(value :_*))
    ...
    inline def setCpuStatusReportsVarargs(value: CpuTemperatureInfo*): Self = StObject.set(x, "cpuStatusReports", js.Array(value :_*))
    ...
    inline def setDeviceFilesVarargs(value: CreateTime*): Self = StObject.set(x, "deviceFiles", js.Array(value :_*))
    ...
    inline def setDiskVolumeReportsVarargs(value: VolumeInfo*): Self = StObject.set(x, "diskVolumeReports", js.Array(value :_*))
    ...
    inline def setRecentUsersVarargs(value: Email*): Self = StObject.set(x, "recentUsers", js.Array(value :_*))
    ...
    inline def setSystemRamFreeReportsVarargs(value: ReportTime*): Self = StObject.set(x, "systemRamFreeReports", js.Array(value :_*))
