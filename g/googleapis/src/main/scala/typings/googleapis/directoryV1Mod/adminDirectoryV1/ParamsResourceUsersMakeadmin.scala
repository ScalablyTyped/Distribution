...
object ParamsResourceUsersMakeadmin {
  ...
  inline def apply(): ParamsResourceUsersMakeadmin = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersMakeadmin]
  }
  
  extension [Self <: ParamsResourceUsersMakeadmin](x: Self) {
    
    inline def setAuth(value: String | OAuth2Client | JWT | Compute | UserRefreshClient): Self = StObject.set(x, "auth", value.asInstanceOf[js.Any])
    
    inline def setAuthUndefined: Self = StObject.set(x, "auth", js.undefined)
    
    inline def setRequestBody(value: SchemaUserMakeAdmin): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
