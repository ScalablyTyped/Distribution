...
trait SchemaGroupAlias extends StObject {
...
object SchemaGroupAlias {
  
  inline def apply(): SchemaGroupAlias = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGroupAlias]
  }
  
  extension [Self <: SchemaGroupAlias](x: Self) {
