...
trait ParamsResourceResourcesCalendarsPatch
  extends StObject
...
object ParamsResourceResourcesCalendarsPatch {
  ...
  inline def apply(): ParamsResourceResourcesCalendarsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResourcesCalendarsPatch]
  }
  
  extension [Self <: ParamsResourceResourcesCalendarsPatch](x: Self) {
