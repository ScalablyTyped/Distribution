...
open class ResourceProjectsLocationsQueues protected () extends StObject {
  ...
  def buffer(): GaxiosPromise[SchemaBufferQueueResponse] = js.native
  def buffer(callback: BodyResponseCallback[SchemaBufferQueueResponse]): Unit = js.native
  def buffer(params: Unit, options: MethodOptions): GaxiosPromise[SchemaBufferQueueResponse] = js.native
  def buffer(params: ParamsResourceProjectsLocationsQueuesBuffer): GaxiosPromise[SchemaBufferQueueResponse] = js.native
  def buffer(
    params: ParamsResourceProjectsLocationsQueuesBuffer,
    callback: BodyResponseCallback[SchemaBufferQueueResponse]
  ): Unit = js.native
  def buffer(
    params: ParamsResourceProjectsLocationsQueuesBuffer,
    options: BodyResponseCallback[Readable | SchemaBufferQueueResponse],
    callback: BodyResponseCallback[Readable | SchemaBufferQueueResponse]
  ): Unit = js.native
  def buffer(params: ParamsResourceProjectsLocationsQueuesBuffer, options: MethodOptions): GaxiosPromise[SchemaBufferQueueResponse] = js.native
  def buffer(
    params: ParamsResourceProjectsLocationsQueuesBuffer,
  ...
  /**
    ...
    */
  def buffer(params: ParamsResourceProjectsLocationsQueuesBuffer, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def buffer(
    params: ParamsResourceProjectsLocationsQueuesBuffer,
