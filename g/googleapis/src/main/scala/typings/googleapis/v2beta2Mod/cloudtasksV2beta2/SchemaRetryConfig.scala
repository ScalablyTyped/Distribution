...
trait SchemaRetryConfig extends StObject {
  ...
  /**
    ...
    */
  var unlimitedAttempts: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaRetryConfig {
  ...
  extension [Self <: SchemaRetryConfig](x: Self) {
    ...
    inline def setUnlimitedAttempts(value: Boolean): Self = StObject.set(x, "unlimitedAttempts", value.asInstanceOf[js.Any])
    
    inline def setUnlimitedAttemptsNull: Self = StObject.set(x, "unlimitedAttempts", null)
    
    inline def setUnlimitedAttemptsUndefined: Self = StObject.set(x, "unlimitedAttempts", js.undefined)
  }
}
