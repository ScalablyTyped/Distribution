...
object ParamsResourceProjectsLocationsQueuesTasksAcknowledge {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesTasksAcknowledgeMutableBuilder[Self <: ParamsResourceProjectsLocationsQueuesTasksAcknowledge] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaAcknowledgeTaskRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
