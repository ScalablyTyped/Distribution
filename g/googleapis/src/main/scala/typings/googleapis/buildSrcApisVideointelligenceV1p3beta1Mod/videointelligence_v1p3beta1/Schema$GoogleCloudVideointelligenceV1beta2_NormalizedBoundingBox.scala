...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1beta2_NormalizedBoundingBox extends js.Object {
  /**
    * Bottom Y coordinate.
    */
...
object Schema$GoogleCloudVideointelligenceV1beta2_NormalizedBoundingBox {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1beta2_NormalizedBoundingBox]
  }
}
