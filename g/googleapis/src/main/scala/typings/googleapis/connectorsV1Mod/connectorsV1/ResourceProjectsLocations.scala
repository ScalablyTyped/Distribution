...
@JSImport("googleapis/build/src/apis/connectors/v1", "connectors_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var connections: ResourceProjectsLocationsConnections = js.native
  ...
  def getRuntimeConfig(): GaxiosPromise[SchemaRuntimeConfig] = js.native
  def getRuntimeConfig(callback: BodyResponseCallback[SchemaRuntimeConfig]): Unit = js.native
  def getRuntimeConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaRuntimeConfig] = js.native
  def getRuntimeConfig(params: ParamsResourceProjectsLocationsGetruntimeconfig): GaxiosPromise[SchemaRuntimeConfig] = js.native
  def getRuntimeConfig(
    params: ParamsResourceProjectsLocationsGetruntimeconfig,
  ...
  def getRuntimeConfig(params: ParamsResourceProjectsLocationsGetruntimeconfig, options: MethodOptions): GaxiosPromise[SchemaRuntimeConfig] = js.native
  def getRuntimeConfig(
    params: ParamsResourceProjectsLocationsGetruntimeconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaRuntimeConfig]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def getRuntimeConfig(params: ParamsResourceProjectsLocationsGetruntimeconfig, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def getRuntimeConfig(
    params: ParamsResourceProjectsLocationsGetruntimeconfig,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
