...
@js.native
trait AnonActivitiesCustomRichMediaEventsDateRangeDimensionFilters extends js.Object {
...
object AnonActivitiesCustomRichMediaEventsDateRangeDimensionFilters {
  @scala.inline
  def apply(
  ...
  ): AnonActivitiesCustomRichMediaEventsDateRangeDimensionFilters = {
    ...
    __obj.asInstanceOf[AnonActivitiesCustomRichMediaEventsDateRangeDimensionFilters]
  }
}
