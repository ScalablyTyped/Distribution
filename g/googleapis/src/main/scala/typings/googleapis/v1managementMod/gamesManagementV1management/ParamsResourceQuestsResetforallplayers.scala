...
@js.native
trait ParamsResourceQuestsResetforallplayers extends StandardParameters {
  /**
...
object ParamsResourceQuestsResetforallplayers {
  ...
  @scala.inline
  implicit class ParamsResourceQuestsResetforallplayersOps[Self <: ParamsResourceQuestsResetforallplayers] (val x: Self) extends AnyVal {
    @scala.inline
