...
trait ParamsResourceBillingaccountsLocationsBucketsList
  extends StObject
...
object ParamsResourceBillingaccountsLocationsBucketsList {
  
  inline def apply(): ParamsResourceBillingaccountsLocationsBucketsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsLocationsBucketsList]
  }
  
  extension [Self <: ParamsResourceBillingaccountsLocationsBucketsList](x: Self) {
