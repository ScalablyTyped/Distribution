...
trait ParamsResourceProjectsLocationsBucketsViewsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsBucketsViewsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsBucketsViewsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsBucketsViewsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsBucketsViewsCreate](x: Self) {
