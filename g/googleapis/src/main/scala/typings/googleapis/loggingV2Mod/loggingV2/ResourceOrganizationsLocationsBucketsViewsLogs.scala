...
@JSImport("googleapis/build/src/apis/logging/v2", "logging_v2.Resource$Organizations$Locations$Buckets$Views$Logs")
@js.native
open class ResourceOrganizationsLocationsBucketsViewsLogs protected () extends StObject {
  ...
  def list(params: ParamsResourceOrganizationsLocationsBucketsViewsLogsList): GaxiosPromise[SchemaListLogsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsBucketsViewsLogsList,
  ...
  def list(params: ParamsResourceOrganizationsLocationsBucketsViewsLogsList, options: MethodOptions): GaxiosPromise[SchemaListLogsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsBucketsViewsLogsList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceOrganizationsLocationsBucketsViewsLogsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsBucketsViewsLogsList,
