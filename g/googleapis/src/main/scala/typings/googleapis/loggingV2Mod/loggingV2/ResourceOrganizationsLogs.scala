...
@js.native
open class ResourceOrganizationsLogs protected () extends StObject {
  ...
  /**
    ...
    */
  def delete(params: ParamsResourceOrganizationsLogsDelete, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def delete(
    params: ParamsResourceOrganizationsLogsDelete,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceOrganizationsLogsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceOrganizationsLogsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
