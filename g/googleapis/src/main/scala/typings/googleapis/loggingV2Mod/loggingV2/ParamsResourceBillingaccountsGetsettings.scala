...
trait ParamsResourceBillingaccountsGetsettings
  extends StObject
...
object ParamsResourceBillingaccountsGetsettings {
  
  inline def apply(): ParamsResourceBillingaccountsGetsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsGetsettings]
  }
  
  extension [Self <: ParamsResourceBillingaccountsGetsettings](x: Self) {
