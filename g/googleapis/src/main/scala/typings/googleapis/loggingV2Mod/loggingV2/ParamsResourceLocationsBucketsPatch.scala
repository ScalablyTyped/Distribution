...
trait ParamsResourceLocationsBucketsPatch
  extends StObject
...
object ParamsResourceLocationsBucketsPatch {
  
  inline def apply(): ParamsResourceLocationsBucketsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLocationsBucketsPatch]
  }
  
  extension [Self <: ParamsResourceLocationsBucketsPatch](x: Self) {
