...
@JSImport("googleapis/build/src/apis/logging/v2", "logging_v2.Resource$Locations$Operations")
@js.native
open class ResourceLocationsOperations protected () extends StObject {
  ...
  def cancel(params: ParamsResourceLocationsOperationsCancel): GaxiosPromise[SchemaEmpty] = js.native
  def cancel(params: ParamsResourceLocationsOperationsCancel, callback: BodyResponseCallback[SchemaEmpty]): Unit = js.native
  def cancel(
    params: ParamsResourceLocationsOperationsCancel,
    options: BodyResponseCallback[Readable | SchemaEmpty],
    callback: BodyResponseCallback[Readable | SchemaEmpty]
  ): Unit = js.native
  def cancel(params: ParamsResourceLocationsOperationsCancel, options: MethodOptions): GaxiosPromise[SchemaEmpty] = js.native
  def cancel(
    params: ParamsResourceLocationsOperationsCancel,
  ...
  /**
    ...
    */
  def cancel(params: ParamsResourceLocationsOperationsCancel, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def cancel(
    params: ParamsResourceLocationsOperationsCancel,
  ...
  def list(params: ParamsResourceLocationsOperationsList): GaxiosPromise[SchemaListOperationsResponse] = js.native
  def list(
    params: ParamsResourceLocationsOperationsList,
  ...
  def list(params: ParamsResourceLocationsOperationsList, options: MethodOptions): GaxiosPromise[SchemaListOperationsResponse] = js.native
  def list(
    params: ParamsResourceLocationsOperationsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaListOperationsResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceLocationsOperationsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceLocationsOperationsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
