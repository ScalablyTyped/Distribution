...
trait SchemaLogSink extends StObject {
  ...
  /**
    ...
    */
  var bigqueryOptions: js.UndefOr[SchemaBigQueryOptions] = js.undefined
  ...
  /**
    ...
    */
  var includeChildren: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var outputVersionFormat: js.UndefOr[String | Null] = js.undefined
...
object SchemaLogSink {
  ...
  extension [Self <: SchemaLogSink](x: Self) {
    ...
    inline def setBigqueryOptions(value: SchemaBigQueryOptions): Self = StObject.set(x, "bigqueryOptions", value.asInstanceOf[js.Any])
    ...
    inline def setIncludeChildrenNull: Self = StObject.set(x, "includeChildren", null)
    ...
    inline def setOutputVersionFormatNull: Self = StObject.set(x, "outputVersionFormat", null)
