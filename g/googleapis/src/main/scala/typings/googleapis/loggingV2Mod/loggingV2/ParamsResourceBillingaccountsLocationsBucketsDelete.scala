...
trait ParamsResourceBillingaccountsLocationsBucketsDelete
  extends StObject
...
object ParamsResourceBillingaccountsLocationsBucketsDelete {
  
  inline def apply(): ParamsResourceBillingaccountsLocationsBucketsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsLocationsBucketsDelete]
  }
  
  extension [Self <: ParamsResourceBillingaccountsLocationsBucketsDelete](x: Self) {
