...
trait ParamsResourceFoldersGetsettings
  extends StObject
...
object ParamsResourceFoldersGetsettings {
  
  inline def apply(): ParamsResourceFoldersGetsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersGetsettings]
  }
  
  extension [Self <: ParamsResourceFoldersGetsettings](x: Self) {
