...
trait ParamsResourceOrganizationsLocationsBucketsCreate
  extends StObject
...
object ParamsResourceOrganizationsLocationsBucketsCreate {
  
  inline def apply(): ParamsResourceOrganizationsLocationsBucketsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsLocationsBucketsCreate]
  }
  
  extension [Self <: ParamsResourceOrganizationsLocationsBucketsCreate](x: Self) {
