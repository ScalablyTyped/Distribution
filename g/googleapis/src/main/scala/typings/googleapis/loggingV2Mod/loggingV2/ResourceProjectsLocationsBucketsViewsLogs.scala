...
@JSImport("googleapis/build/src/apis/logging/v2", "logging_v2.Resource$Projects$Locations$Buckets$Views$Logs")
@js.native
open class ResourceProjectsLocationsBucketsViewsLogs protected () extends StObject {
  ...
  def list(params: ParamsResourceProjectsLocationsBucketsViewsLogsList): GaxiosPromise[SchemaListLogsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsBucketsViewsLogsList,
  ...
  def list(params: ParamsResourceProjectsLocationsBucketsViewsLogsList, options: MethodOptions): GaxiosPromise[SchemaListLogsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsBucketsViewsLogsList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceProjectsLocationsBucketsViewsLogsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsLocationsBucketsViewsLogsList,
