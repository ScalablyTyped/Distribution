...
@js.native
open class ResourceFoldersLogs protected () extends StObject {
  ...
  /**
    ...
    */
  def delete(params: ParamsResourceFoldersLogsDelete, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def delete(
    params: ParamsResourceFoldersLogsDelete,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceFoldersLogsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceFoldersLogsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
