...
trait ParamsResourceProjectsLocationsBucketsPatch
  extends StObject
...
object ParamsResourceProjectsLocationsBucketsPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsBucketsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsBucketsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsBucketsPatch](x: Self) {
