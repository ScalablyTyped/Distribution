...
trait ParamsResourceOrganizationsLocationsBucketsViewsCreate
  extends StObject
...
object ParamsResourceOrganizationsLocationsBucketsViewsCreate {
  
  inline def apply(): ParamsResourceOrganizationsLocationsBucketsViewsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsLocationsBucketsViewsCreate]
  }
  
  extension [Self <: ParamsResourceOrganizationsLocationsBucketsViewsCreate](x: Self) {
