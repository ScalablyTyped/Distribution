...
trait ParamsResourceBillingaccountsLocationsBucketsGet
  extends StObject
...
object ParamsResourceBillingaccountsLocationsBucketsGet {
  
  inline def apply(): ParamsResourceBillingaccountsLocationsBucketsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsLocationsBucketsGet]
  }
  
  extension [Self <: ParamsResourceBillingaccountsLocationsBucketsGet](x: Self) {
