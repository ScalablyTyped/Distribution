...
trait ParamsResourceProjectsLocationsBucketsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsBucketsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsBucketsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsBucketsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsBucketsCreate](x: Self) {
