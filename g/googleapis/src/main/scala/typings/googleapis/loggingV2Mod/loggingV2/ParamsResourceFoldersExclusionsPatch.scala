...
@js.native
trait ParamsResourceFoldersExclusionsPatch extends StandardParameters {
...
object ParamsResourceFoldersExclusionsPatch {
  
  @scala.inline
  def apply(): ParamsResourceFoldersExclusionsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersExclusionsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceFoldersExclusionsPatchMutableBuilder[Self <: ParamsResourceFoldersExclusionsPatch] (val x: Self) extends AnyVal {
