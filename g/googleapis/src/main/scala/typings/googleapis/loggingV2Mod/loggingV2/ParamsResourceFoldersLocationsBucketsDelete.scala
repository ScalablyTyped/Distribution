...
trait ParamsResourceFoldersLocationsBucketsDelete
  extends StObject
...
object ParamsResourceFoldersLocationsBucketsDelete {
  
  inline def apply(): ParamsResourceFoldersLocationsBucketsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersLocationsBucketsDelete]
  }
  
  extension [Self <: ParamsResourceFoldersLocationsBucketsDelete](x: Self) {
