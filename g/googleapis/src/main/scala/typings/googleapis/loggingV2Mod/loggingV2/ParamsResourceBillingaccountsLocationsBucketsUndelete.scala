...
trait ParamsResourceBillingaccountsLocationsBucketsUndelete
  extends StObject
...
object ParamsResourceBillingaccountsLocationsBucketsUndelete {
  
  inline def apply(): ParamsResourceBillingaccountsLocationsBucketsUndelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsLocationsBucketsUndelete]
  }
  
  extension [Self <: ParamsResourceBillingaccountsLocationsBucketsUndelete](x: Self) {
