...
trait ParamsResourceLocationsBucketsCreate
  extends StObject
...
object ParamsResourceLocationsBucketsCreate {
  
  inline def apply(): ParamsResourceLocationsBucketsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLocationsBucketsCreate]
  }
  
  extension [Self <: ParamsResourceLocationsBucketsCreate](x: Self) {
