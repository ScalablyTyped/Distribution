...
trait ParamsResourceOrganizationsSinksCreate
  extends StObject
...
object ParamsResourceOrganizationsSinksCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceOrganizationsSinksCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsSinksCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsSinksCreateMutableBuilder[Self <: ParamsResourceOrganizationsSinksCreate] (val x: Self) extends AnyVal {
