...
trait ParamsResourceBillingaccountsLocationsBucketsPatch
  extends StObject
...
object ParamsResourceBillingaccountsLocationsBucketsPatch {
  
  inline def apply(): ParamsResourceBillingaccountsLocationsBucketsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsLocationsBucketsPatch]
  }
  
  extension [Self <: ParamsResourceBillingaccountsLocationsBucketsPatch](x: Self) {
