...
@JSImport("googleapis/build/src/apis/logging/v2", "logging_v2.Resource$Billingaccounts$Locations$Buckets$Views$Logs")
@js.native
open class ResourceBillingaccountsLocationsBucketsViewsLogs protected () extends StObject {
  ...
  def list(params: ParamsResourceBillingaccountsLocationsBucketsViewsLogsList): GaxiosPromise[SchemaListLogsResponse] = js.native
  def list(
    params: ParamsResourceBillingaccountsLocationsBucketsViewsLogsList,
  ...
  def list(params: ParamsResourceBillingaccountsLocationsBucketsViewsLogsList, options: MethodOptions): GaxiosPromise[SchemaListLogsResponse] = js.native
  def list(
    params: ParamsResourceBillingaccountsLocationsBucketsViewsLogsList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBillingaccountsLocationsBucketsViewsLogsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBillingaccountsLocationsBucketsViewsLogsList,
