...
@js.native
open class ResourceProjectsLogs protected () extends StObject {
  ...
  /**
    ...
    */
  def delete(params: ParamsResourceProjectsLogsDelete, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def delete(
    params: ParamsResourceProjectsLogsDelete,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceProjectsLogsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsLogsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
