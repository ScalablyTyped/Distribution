...
trait ParamsResourceOrganizationsGetsettings
  extends StObject
...
object ParamsResourceOrganizationsGetsettings {
  
  inline def apply(): ParamsResourceOrganizationsGetsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsGetsettings]
  }
  
  extension [Self <: ParamsResourceOrganizationsGetsettings](x: Self) {
