...
trait ParamsResourceOrganizationsLocationsBucketsList
  extends StObject
...
object ParamsResourceOrganizationsLocationsBucketsList {
  
  inline def apply(): ParamsResourceOrganizationsLocationsBucketsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsLocationsBucketsList]
  }
  
  extension [Self <: ParamsResourceOrganizationsLocationsBucketsList](x: Self) {
