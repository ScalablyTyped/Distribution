...
trait ParamsResourceLocationsBucketsViewsPatch
  extends StObject
...
object ParamsResourceLocationsBucketsViewsPatch {
  
  inline def apply(): ParamsResourceLocationsBucketsViewsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLocationsBucketsViewsPatch]
  }
  
  extension [Self <: ParamsResourceLocationsBucketsViewsPatch](x: Self) {
