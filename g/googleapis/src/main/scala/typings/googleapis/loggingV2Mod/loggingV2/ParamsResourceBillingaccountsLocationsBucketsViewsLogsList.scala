...
trait ParamsResourceBillingaccountsLocationsBucketsViewsLogsList
  extends StObject
...
object ParamsResourceBillingaccountsLocationsBucketsViewsLogsList {
  
  inline def apply(): ParamsResourceBillingaccountsLocationsBucketsViewsLogsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsLocationsBucketsViewsLogsList]
  }
  
  extension [Self <: ParamsResourceBillingaccountsLocationsBucketsViewsLogsList](x: Self) {
