...
trait ParamsResourceLocationsBucketsViewsCreate
  extends StObject
...
object ParamsResourceLocationsBucketsViewsCreate {
  
  inline def apply(): ParamsResourceLocationsBucketsViewsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLocationsBucketsViewsCreate]
  }
  
  extension [Self <: ParamsResourceLocationsBucketsViewsCreate](x: Self) {
