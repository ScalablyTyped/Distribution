...
open class ResourceProjects protected () extends StObject {
  ...
  def getCmekSettings(params: ParamsResourceProjectsGetcmeksettings): GaxiosPromise[SchemaCmekSettings] = js.native
  def getCmekSettings(params: ParamsResourceProjectsGetcmeksettings, callback: BodyResponseCallback[SchemaCmekSettings]): Unit = js.native
  def getCmekSettings(
    params: ParamsResourceProjectsGetcmeksettings,
    options: BodyResponseCallback[Readable | SchemaCmekSettings],
    callback: BodyResponseCallback[Readable | SchemaCmekSettings]
  ): Unit = js.native
  def getCmekSettings(params: ParamsResourceProjectsGetcmeksettings, options: MethodOptions): GaxiosPromise[SchemaCmekSettings] = js.native
  def getCmekSettings(
    params: ParamsResourceProjectsGetcmeksettings,
  ...
  /**
    ...
    */
  def getCmekSettings(params: ParamsResourceProjectsGetcmeksettings, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def getCmekSettings(
    params: ParamsResourceProjectsGetcmeksettings,
  ...
  def getSettings(params: ParamsResourceProjectsGetsettings): GaxiosPromise[SchemaSettings] = js.native
  def getSettings(params: ParamsResourceProjectsGetsettings, callback: BodyResponseCallback[SchemaSettings]): Unit = js.native
  def getSettings(
  ...
  def getSettings(params: ParamsResourceProjectsGetsettings, options: MethodOptions): GaxiosPromise[SchemaSettings] = js.native
  def getSettings(
    params: ParamsResourceProjectsGetsettings,
    options: MethodOptions,
