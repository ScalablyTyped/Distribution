...
object ParamsResourceFoldersExclusionsCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceFoldersExclusionsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersExclusionsCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceFoldersExclusionsCreateMutableBuilder[Self <: ParamsResourceFoldersExclusionsCreate] (val x: Self) extends AnyVal {
