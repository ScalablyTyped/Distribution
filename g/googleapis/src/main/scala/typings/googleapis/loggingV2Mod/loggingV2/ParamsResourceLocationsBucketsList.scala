...
trait ParamsResourceLocationsBucketsList
  extends StObject
...
object ParamsResourceLocationsBucketsList {
  
  inline def apply(): ParamsResourceLocationsBucketsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLocationsBucketsList]
  }
  
  extension [Self <: ParamsResourceLocationsBucketsList](x: Self) {
