...
trait ParamsResourceLocationsBucketsDelete
  extends StObject
...
object ParamsResourceLocationsBucketsDelete {
  
  inline def apply(): ParamsResourceLocationsBucketsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLocationsBucketsDelete]
  }
  
  extension [Self <: ParamsResourceLocationsBucketsDelete](x: Self) {
