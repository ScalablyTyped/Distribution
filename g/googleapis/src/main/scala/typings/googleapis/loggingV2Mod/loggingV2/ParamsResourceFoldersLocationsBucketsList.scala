...
trait ParamsResourceFoldersLocationsBucketsList
  extends StObject
...
object ParamsResourceFoldersLocationsBucketsList {
  
  inline def apply(): ParamsResourceFoldersLocationsBucketsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersLocationsBucketsList]
  }
  
  extension [Self <: ParamsResourceFoldersLocationsBucketsList](x: Self) {
