...
trait SchemaCmekSettings extends StObject {
...
object SchemaCmekSettings {
  
  inline def apply(): SchemaCmekSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCmekSettings]
  }
  
  extension [Self <: SchemaCmekSettings](x: Self) {
