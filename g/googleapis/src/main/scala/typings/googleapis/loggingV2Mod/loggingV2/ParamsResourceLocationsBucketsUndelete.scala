...
trait ParamsResourceLocationsBucketsUndelete
  extends StObject
...
object ParamsResourceLocationsBucketsUndelete {
  
  inline def apply(): ParamsResourceLocationsBucketsUndelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLocationsBucketsUndelete]
  }
  
  extension [Self <: ParamsResourceLocationsBucketsUndelete](x: Self) {
