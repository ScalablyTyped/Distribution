...
trait ParamsResourceExclusionsPatch
  extends StObject
...
object ParamsResourceExclusionsPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceExclusionsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceExclusionsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceExclusionsPatchMutableBuilder[Self <: ParamsResourceExclusionsPatch] (val x: Self) extends AnyVal {
