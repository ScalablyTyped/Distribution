...
@js.native
open class ResourceBillingaccountsLogs protected () extends StObject {
  ...
  /**
    ...
    */
  def delete(params: ParamsResourceBillingaccountsLogsDelete, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def delete(
    params: ParamsResourceBillingaccountsLogsDelete,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceBillingaccountsLogsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBillingaccountsLogsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
