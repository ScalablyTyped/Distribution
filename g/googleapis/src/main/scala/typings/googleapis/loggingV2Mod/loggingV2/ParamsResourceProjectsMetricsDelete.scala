...
@js.native
trait ParamsResourceProjectsMetricsDelete extends StandardParameters {
...
object ParamsResourceProjectsMetricsDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsMetricsDeleteOps[Self <: ParamsResourceProjectsMetricsDelete] (val x: Self) extends AnyVal {
