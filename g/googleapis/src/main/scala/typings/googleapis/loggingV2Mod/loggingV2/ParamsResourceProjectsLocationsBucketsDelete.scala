...
trait ParamsResourceProjectsLocationsBucketsDelete
  extends StObject
...
object ParamsResourceProjectsLocationsBucketsDelete {
  
  inline def apply(): ParamsResourceProjectsLocationsBucketsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsBucketsDelete]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsBucketsDelete](x: Self) {
