...
trait ParamsResourceOrganizationsLocationsBucketsUndelete
  extends StObject
...
object ParamsResourceOrganizationsLocationsBucketsUndelete {
  
  inline def apply(): ParamsResourceOrganizationsLocationsBucketsUndelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsLocationsBucketsUndelete]
  }
  
  extension [Self <: ParamsResourceOrganizationsLocationsBucketsUndelete](x: Self) {
