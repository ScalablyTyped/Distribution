...
trait ParamsResourceOrganizationsUpdatecmeksettings
  extends StObject
...
object ParamsResourceOrganizationsUpdatecmeksettings {
  
  inline def apply(): ParamsResourceOrganizationsUpdatecmeksettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsUpdatecmeksettings]
  }
  
  extension [Self <: ParamsResourceOrganizationsUpdatecmeksettings](x: Self) {
