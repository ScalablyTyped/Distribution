...
trait ParamsResourceBillingaccountsSinksGet
  extends StObject
...
object ParamsResourceBillingaccountsSinksGet {
  ...
  inline def apply(): ParamsResourceBillingaccountsSinksGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsSinksGet]
  }
  
  extension [Self <: ParamsResourceBillingaccountsSinksGet](x: Self) {
