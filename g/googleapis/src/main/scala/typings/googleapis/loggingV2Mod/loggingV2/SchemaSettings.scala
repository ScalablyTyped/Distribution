...
trait SchemaSettings extends StObject {
  ...
  /**
    ...
    */
  var disableDefaultSink: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var kmsServiceAccountId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var storageLocation: js.UndefOr[String | Null] = js.undefined
}
object SchemaSettings {
  ...
  extension [Self <: SchemaSettings](x: Self) {
    ...
    inline def setDisableDefaultSinkNull: Self = StObject.set(x, "disableDefaultSink", null)
    ...
    inline def setKmsServiceAccountIdNull: Self = StObject.set(x, "kmsServiceAccountId", null)
