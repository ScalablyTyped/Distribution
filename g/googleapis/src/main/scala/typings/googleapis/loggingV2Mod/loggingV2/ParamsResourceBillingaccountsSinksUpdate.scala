...
trait ParamsResourceBillingaccountsSinksUpdate
  extends StObject
...
object ParamsResourceBillingaccountsSinksUpdate {
  ...
  inline def apply(): ParamsResourceBillingaccountsSinksUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsSinksUpdate]
  }
  
  extension [Self <: ParamsResourceBillingaccountsSinksUpdate](x: Self) {
