...
trait ParamsResourceProjectsLocationsBucketsList
  extends StObject
...
object ParamsResourceProjectsLocationsBucketsList {
  
  inline def apply(): ParamsResourceProjectsLocationsBucketsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsBucketsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsBucketsList](x: Self) {
