...
trait ParamsResourceFoldersLocationsBucketsCreate
  extends StObject
...
object ParamsResourceFoldersLocationsBucketsCreate {
  
  inline def apply(): ParamsResourceFoldersLocationsBucketsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersLocationsBucketsCreate]
  }
  
  extension [Self <: ParamsResourceFoldersLocationsBucketsCreate](x: Self) {
