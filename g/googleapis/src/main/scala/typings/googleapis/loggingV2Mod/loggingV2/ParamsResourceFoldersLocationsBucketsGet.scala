...
trait ParamsResourceFoldersLocationsBucketsGet
  extends StObject
...
object ParamsResourceFoldersLocationsBucketsGet {
  
  inline def apply(): ParamsResourceFoldersLocationsBucketsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersLocationsBucketsGet]
  }
  
  extension [Self <: ParamsResourceFoldersLocationsBucketsGet](x: Self) {
