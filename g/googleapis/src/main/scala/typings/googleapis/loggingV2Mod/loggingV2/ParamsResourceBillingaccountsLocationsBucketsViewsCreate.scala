...
trait ParamsResourceBillingaccountsLocationsBucketsViewsCreate
  extends StObject
...
object ParamsResourceBillingaccountsLocationsBucketsViewsCreate {
  
  inline def apply(): ParamsResourceBillingaccountsLocationsBucketsViewsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsLocationsBucketsViewsCreate]
  }
  
  extension [Self <: ParamsResourceBillingaccountsLocationsBucketsViewsCreate](x: Self) {
