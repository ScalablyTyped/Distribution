...
trait ParamsResourceProjectsLocationsBucketsUndelete
  extends StObject
...
object ParamsResourceProjectsLocationsBucketsUndelete {
  
  inline def apply(): ParamsResourceProjectsLocationsBucketsUndelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsBucketsUndelete]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsBucketsUndelete](x: Self) {
