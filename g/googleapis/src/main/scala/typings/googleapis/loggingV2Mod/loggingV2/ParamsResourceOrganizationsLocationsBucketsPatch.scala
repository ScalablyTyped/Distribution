...
trait ParamsResourceOrganizationsLocationsBucketsPatch
  extends StObject
...
object ParamsResourceOrganizationsLocationsBucketsPatch {
  
  inline def apply(): ParamsResourceOrganizationsLocationsBucketsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsLocationsBucketsPatch]
  }
  
  extension [Self <: ParamsResourceOrganizationsLocationsBucketsPatch](x: Self) {
