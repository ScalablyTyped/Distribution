...
trait ParamsResourceBillingaccountsLogsList
  extends StObject
...
object ParamsResourceBillingaccountsLogsList {
  ...
  inline def apply(): ParamsResourceBillingaccountsLogsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsLogsList]
  }
  
  extension [Self <: ParamsResourceBillingaccountsLogsList](x: Self) {
