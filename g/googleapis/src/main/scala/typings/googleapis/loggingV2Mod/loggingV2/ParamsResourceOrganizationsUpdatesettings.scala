...
trait ParamsResourceOrganizationsUpdatesettings
  extends StObject
...
object ParamsResourceOrganizationsUpdatesettings {
  
  inline def apply(): ParamsResourceOrganizationsUpdatesettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsUpdatesettings]
  }
  
  extension [Self <: ParamsResourceOrganizationsUpdatesettings](x: Self) {
