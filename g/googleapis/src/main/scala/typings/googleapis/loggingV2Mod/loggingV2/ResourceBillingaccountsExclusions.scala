...
@js.native
open class ResourceBillingaccountsExclusions protected () extends StObject {
  ...
  /**
    ...
    */
  def create(params: ParamsResourceBillingaccountsExclusionsCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceBillingaccountsExclusionsCreate,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def delete(params: ParamsResourceBillingaccountsExclusionsDelete, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def delete(
    params: ParamsResourceBillingaccountsExclusionsDelete,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def get(params: ParamsResourceBillingaccountsExclusionsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceBillingaccountsExclusionsGet,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceBillingaccountsExclusionsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBillingaccountsExclusionsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def patch(params: ParamsResourceBillingaccountsExclusionsPatch, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def patch(
    params: ParamsResourceBillingaccountsExclusionsPatch,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
