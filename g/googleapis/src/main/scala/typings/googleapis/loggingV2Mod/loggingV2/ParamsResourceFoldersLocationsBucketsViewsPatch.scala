...
trait ParamsResourceFoldersLocationsBucketsViewsPatch
  extends StObject
...
object ParamsResourceFoldersLocationsBucketsViewsPatch {
  
  inline def apply(): ParamsResourceFoldersLocationsBucketsViewsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersLocationsBucketsViewsPatch]
  }
  
  extension [Self <: ParamsResourceFoldersLocationsBucketsViewsPatch](x: Self) {
