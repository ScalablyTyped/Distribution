...
trait SchemaLogEntry extends StObject {
  ...
  /**
    ...
    */
  var jsonPayload: js.UndefOr[StringDictionary[Any] | Null] = js.undefined
  ...
  /**
    ...
    */
  var receiveTimestamp: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var split: js.UndefOr[SchemaLogSplit] = js.undefined
...
object SchemaLogEntry {
  ...
  extension [Self <: SchemaLogEntry](x: Self) {
    ...
    inline def setJsonPayload(value: StringDictionary[Any]): Self = StObject.set(x, "jsonPayload", value.asInstanceOf[js.Any])
    
    inline def setJsonPayloadNull: Self = StObject.set(x, "jsonPayload", null)
    ...
    inline def setReceiveTimestampNull: Self = StObject.set(x, "receiveTimestamp", null)
    ...
    inline def setSplit(value: SchemaLogSplit): Self = StObject.set(x, "split", value.asInstanceOf[js.Any])
