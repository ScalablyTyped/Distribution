...
trait ParamsResourceBillingaccountsLocationsBucketsViewsPatch
  extends StObject
...
object ParamsResourceBillingaccountsLocationsBucketsViewsPatch {
  
  inline def apply(): ParamsResourceBillingaccountsLocationsBucketsViewsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsLocationsBucketsViewsPatch]
  }
  
  extension [Self <: ParamsResourceBillingaccountsLocationsBucketsViewsPatch](x: Self) {
