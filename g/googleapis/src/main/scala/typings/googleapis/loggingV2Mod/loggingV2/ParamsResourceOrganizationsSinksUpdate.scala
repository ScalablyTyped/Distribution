...
trait ParamsResourceOrganizationsSinksUpdate
  extends StObject
...
object ParamsResourceOrganizationsSinksUpdate {
  ...
  inline def apply(): ParamsResourceOrganizationsSinksUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsSinksUpdate]
  }
  
  extension [Self <: ParamsResourceOrganizationsSinksUpdate](x: Self) {
