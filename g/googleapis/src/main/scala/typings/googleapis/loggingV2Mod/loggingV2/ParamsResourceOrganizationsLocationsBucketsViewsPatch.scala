...
trait ParamsResourceOrganizationsLocationsBucketsViewsPatch
  extends StObject
...
object ParamsResourceOrganizationsLocationsBucketsViewsPatch {
  
  inline def apply(): ParamsResourceOrganizationsLocationsBucketsViewsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsLocationsBucketsViewsPatch]
  }
  
  extension [Self <: ParamsResourceOrganizationsLocationsBucketsViewsPatch](x: Self) {
