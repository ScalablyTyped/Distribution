...
trait ParamsResourceFoldersLocationsBucketsViewsLogsList
  extends StObject
...
object ParamsResourceFoldersLocationsBucketsViewsLogsList {
  
  inline def apply(): ParamsResourceFoldersLocationsBucketsViewsLogsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersLocationsBucketsViewsLogsList]
  }
  
  extension [Self <: ParamsResourceFoldersLocationsBucketsViewsLogsList](x: Self) {
