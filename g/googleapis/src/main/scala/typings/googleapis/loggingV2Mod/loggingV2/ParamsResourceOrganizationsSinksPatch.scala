...
@js.native
trait ParamsResourceOrganizationsSinksPatch extends StandardParameters {
...
object ParamsResourceOrganizationsSinksPatch {
  
  @scala.inline
  def apply(): ParamsResourceOrganizationsSinksPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsSinksPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsSinksPatchMutableBuilder[Self <: ParamsResourceOrganizationsSinksPatch] (val x: Self) extends AnyVal {
