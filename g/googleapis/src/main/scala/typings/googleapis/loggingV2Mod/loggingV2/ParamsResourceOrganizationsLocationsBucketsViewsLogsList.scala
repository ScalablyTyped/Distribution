...
trait ParamsResourceOrganizationsLocationsBucketsViewsLogsList
  extends StObject
...
object ParamsResourceOrganizationsLocationsBucketsViewsLogsList {
  
  inline def apply(): ParamsResourceOrganizationsLocationsBucketsViewsLogsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsLocationsBucketsViewsLogsList]
  }
  
  extension [Self <: ParamsResourceOrganizationsLocationsBucketsViewsLogsList](x: Self) {
