...
object ParamsResourceFoldersSinksUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceFoldersSinksUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersSinksUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceFoldersSinksUpdateMutableBuilder[Self <: ParamsResourceFoldersSinksUpdate] (val x: Self) extends AnyVal {
