...
@js.native
open class ResourceManagementCustomdatasources protected () extends StObject {
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaCustomDataSources] = js.native
  ...
  def list(
    params: ParamsResourceManagementCustomdatasourcesList,
    options: BodyResponseCallback[Readable | SchemaCustomDataSources],
    callback: BodyResponseCallback[Readable | SchemaCustomDataSources]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def list(params: ParamsResourceManagementCustomdatasourcesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceManagementCustomdatasourcesList,
