...
@js.native
open class ResourceManagementAccounts protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceManagementAccountsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceManagementAccountsList,
