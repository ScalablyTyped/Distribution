...
trait ParamsResourceManagementExperimentsPatch
  extends StObject
...
object ParamsResourceManagementExperimentsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceManagementExperimentsPatchMutableBuilder[Self <: ParamsResourceManagementExperimentsPatch] (val x: Self) extends AnyVal {
