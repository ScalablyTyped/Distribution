...
trait ParamsResourceManagementWebpropertyadwordslinksUpdate
  extends StObject
...
object ParamsResourceManagementWebpropertyadwordslinksUpdate {
  ...
  inline def apply(): ParamsResourceManagementWebpropertyadwordslinksUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementWebpropertyadwordslinksUpdate]
  }
  
  extension [Self <: ParamsResourceManagementWebpropertyadwordslinksUpdate](x: Self) {
