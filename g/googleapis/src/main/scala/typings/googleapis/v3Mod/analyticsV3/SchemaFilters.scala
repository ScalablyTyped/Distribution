...
/**
  ...
  */
@js.native
trait SchemaFilters extends js.Object {
  /**
    * A list of filters.
    */
...
object SchemaFilters {
  ...
  @scala.inline
  implicit class SchemaFiltersOps[Self <: SchemaFilters] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaFilter*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaFilter]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
