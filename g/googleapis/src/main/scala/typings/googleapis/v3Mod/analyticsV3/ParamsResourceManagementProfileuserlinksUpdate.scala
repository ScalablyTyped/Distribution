...
trait ParamsResourceManagementProfileuserlinksUpdate
  extends StObject
...
object ParamsResourceManagementProfileuserlinksUpdate {
  ...
  inline def apply(): ParamsResourceManagementProfileuserlinksUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementProfileuserlinksUpdate]
  }
  
  extension [Self <: ParamsResourceManagementProfileuserlinksUpdate](x: Self) {
