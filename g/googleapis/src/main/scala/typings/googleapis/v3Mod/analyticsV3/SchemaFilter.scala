...
trait SchemaFilter extends StObject {
  ...
  /**
    ...
    */
  var excludeDetails: js.UndefOr[SchemaFilterExpression] = js.undefined
  ...
  /**
    ...
    */
  var includeDetails: js.UndefOr[SchemaFilterExpression] = js.undefined
...
object SchemaFilter {
  ...
  extension [Self <: SchemaFilter](x: Self) {
    ...
    inline def setExcludeDetails(value: SchemaFilterExpression): Self = StObject.set(x, "excludeDetails", value.asInstanceOf[js.Any])
