...
trait SchemaCustomDataSource extends StObject {
  ...
  var importBehavior: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var profilesLinked: js.UndefOr[js.Array[String] | Null] = js.undefined
  
  /**
    * Collection of schema headers of the custom data source.
    */
  var schema: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var uploadType: js.UndefOr[String | Null] = js.undefined
...
object SchemaCustomDataSource {
  ...
  inline def apply(): SchemaCustomDataSource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCustomDataSource]
  }
  
  extension [Self <: SchemaCustomDataSource](x: Self) {
    ...
    inline def setImportBehaviorNull: Self = StObject.set(x, "importBehavior", null)
    ...
    inline def setProfilesLinkedNull: Self = StObject.set(x, "profilesLinked", null)
    ...
    inline def setUploadTypeNull: Self = StObject.set(x, "uploadType", null)
