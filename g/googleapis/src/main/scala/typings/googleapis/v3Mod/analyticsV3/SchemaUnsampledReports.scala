...
trait SchemaUnsampledReports extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaUnsampledReport]] = js.undefined
...
object SchemaUnsampledReports {
  ...
  inline def apply(): SchemaUnsampledReports = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaUnsampledReports]
  }
  
  extension [Self <: SchemaUnsampledReports](x: Self) {
    
    inline def setItems(value: js.Array[SchemaUnsampledReport]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaUnsampledReport*): Self = StObject.set(x, "items", js.Array(value :_*))
