...
object SchemaUnsampledReports {
  ...
  implicit class SchemaUnsampledReportsOps[Self <: SchemaUnsampledReports] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaUnsampledReport*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaUnsampledReport]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
