...
trait SchemaCustomDataSources extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaCustomDataSource]] = js.undefined
...
object SchemaCustomDataSources {
  ...
  inline def apply(): SchemaCustomDataSources = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCustomDataSources]
  }
  
  extension [Self <: SchemaCustomDataSources](x: Self) {
    
    inline def setItems(value: js.Array[SchemaCustomDataSource]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaCustomDataSource*): Self = StObject.set(x, "items", js.Array(value :_*))
