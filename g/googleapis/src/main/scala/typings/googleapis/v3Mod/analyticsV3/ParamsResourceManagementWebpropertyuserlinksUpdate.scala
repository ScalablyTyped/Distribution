...
object ParamsResourceManagementWebpropertyuserlinksUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceManagementWebpropertyuserlinksUpdateOps[Self <: ParamsResourceManagementWebpropertyuserlinksUpdate] (val x: Self) extends AnyVal {
    @scala.inline
