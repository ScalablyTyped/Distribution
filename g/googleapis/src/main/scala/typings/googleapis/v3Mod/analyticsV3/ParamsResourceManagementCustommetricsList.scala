...
trait ParamsResourceManagementCustommetricsList
  extends StObject
...
object ParamsResourceManagementCustommetricsList {
  ...
  inline def apply(): ParamsResourceManagementCustommetricsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementCustommetricsList]
  }
  
  extension [Self <: ParamsResourceManagementCustommetricsList](x: Self) {
