...
trait SchemaEntityAdWordsLinks extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaEntityAdWordsLink]] = js.undefined
...
object SchemaEntityAdWordsLinks {
  ...
  inline def apply(): SchemaEntityAdWordsLinks = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaEntityAdWordsLinks]
  }
  
  extension [Self <: SchemaEntityAdWordsLinks](x: Self) {
    
    inline def setItems(value: js.Array[SchemaEntityAdWordsLink]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaEntityAdWordsLink*): Self = StObject.set(x, "items", js.Array(value :_*))
