...
trait SchemaCustomMetrics extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaCustomMetric]] = js.undefined
...
object SchemaCustomMetrics {
  ...
  inline def apply(): SchemaCustomMetrics = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCustomMetrics]
  }
  
  extension [Self <: SchemaCustomMetrics](x: Self) {
    
    inline def setItems(value: js.Array[SchemaCustomMetric]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaCustomMetric*): Self = StObject.set(x, "items", js.Array(value :_*))
