...
trait ParamsResourceManagementFiltersUpdate
  extends StObject
...
object ParamsResourceManagementFiltersUpdate {
  ...
  inline def apply(): ParamsResourceManagementFiltersUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementFiltersUpdate]
  }
  
  extension [Self <: ParamsResourceManagementFiltersUpdate](x: Self) {
