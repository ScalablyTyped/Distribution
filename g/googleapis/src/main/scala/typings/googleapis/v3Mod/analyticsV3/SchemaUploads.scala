...
trait SchemaUploads extends StObject {
  ...
  /**
    * A list of uploads.
    */
  var items: js.UndefOr[js.Array[SchemaUpload]] = js.undefined
...
object SchemaUploads {
  ...
  inline def apply(): SchemaUploads = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaUploads]
  }
  
  extension [Self <: SchemaUploads](x: Self) {
    
    inline def setItems(value: js.Array[SchemaUpload]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaUpload*): Self = StObject.set(x, "items", js.Array(value :_*))
