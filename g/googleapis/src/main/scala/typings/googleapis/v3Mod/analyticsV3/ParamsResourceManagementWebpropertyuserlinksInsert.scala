...
object ParamsResourceManagementWebpropertyuserlinksInsert {
  ...
  @scala.inline
  implicit class ParamsResourceManagementWebpropertyuserlinksInsertMutableBuilder[Self <: ParamsResourceManagementWebpropertyuserlinksInsert] (val x: Self) extends AnyVal {
