...
trait SchemaAccountSummaries extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaAccountSummary]] = js.undefined
...
object SchemaAccountSummaries {
  ...
  inline def apply(): SchemaAccountSummaries = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAccountSummaries]
  }
  
  extension [Self <: SchemaAccountSummaries](x: Self) {
    
    inline def setItems(value: js.Array[SchemaAccountSummary]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaAccountSummary*): Self = StObject.set(x, "items", js.Array(value :_*))
