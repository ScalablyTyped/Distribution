...
object ParamsResourceManagementRemarketingaudienceList {
  ...
  @scala.inline
  def apply(): ParamsResourceManagementRemarketingaudienceList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementRemarketingaudienceList]
  }
  
  @scala.inline
  implicit class ParamsResourceManagementRemarketingaudienceListMutableBuilder[Self <: ParamsResourceManagementRemarketingaudienceList] (val x: Self) extends AnyVal {
