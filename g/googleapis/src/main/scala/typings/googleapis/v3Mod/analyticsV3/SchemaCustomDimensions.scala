...
/**
  ...
  */
trait SchemaCustomDimensions extends StObject {
  
  /**
    * Collection of custom dimensions.
    */
  var items: js.UndefOr[js.Array[SchemaCustomDimension]] = js.undefined
...
object SchemaCustomDimensions {
  
  @scala.inline
  def apply(): SchemaCustomDimensions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCustomDimensions]
  }
  
  @scala.inline
  implicit class SchemaCustomDimensionsMutableBuilder[Self <: SchemaCustomDimensions] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setItems(value: js.Array[SchemaCustomDimension]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaCustomDimension*): Self = StObject.set(x, "items", js.Array(value :_*))
