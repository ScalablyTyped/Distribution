...
object SchemaCustomDimensions {
  ...
  inline def apply(): SchemaCustomDimensions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCustomDimensions]
  }
  
  extension [Self <: SchemaCustomDimensions](x: Self) {
    
    inline def setItems(value: js.Array[SchemaCustomDimension]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaCustomDimension*): Self = StObject.set(x, "items", js.Array(value :_*))
