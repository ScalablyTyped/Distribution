...
/**
  ...
  */
@js.native
trait SchemaCustomDimensions extends js.Object {
  /**
...
object SchemaCustomDimensions {
  ...
  @scala.inline
  implicit class SchemaCustomDimensionsOps[Self <: SchemaCustomDimensions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaCustomDimension*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaCustomDimension]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
