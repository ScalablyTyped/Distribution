...
object SchemaSegments {
  ...
  @scala.inline
  implicit class SchemaSegmentsMutableBuilder[Self <: SchemaSegments] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setItems(value: js.Array[SchemaSegment]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaSegment*): Self = StObject.set(x, "items", js.Array(value :_*))
