...
trait ParamsResourceManagementRemarketingaudienceUpdate
  extends StObject
...
object ParamsResourceManagementRemarketingaudienceUpdate {
  ...
  inline def apply(): ParamsResourceManagementRemarketingaudienceUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementRemarketingaudienceUpdate]
  }
  
  extension [Self <: ParamsResourceManagementRemarketingaudienceUpdate](x: Self) {
