...
object ParamsResourceManagementRemarketingaudiencePatch {
  @scala.inline
  def apply(): ParamsResourceManagementRemarketingaudiencePatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementRemarketingaudiencePatch]
  }
  @scala.inline
  implicit class ParamsResourceManagementRemarketingaudiencePatchOps[Self <: ParamsResourceManagementRemarketingaudiencePatch] (val x: Self) extends AnyVal {
    @scala.inline
