...
object ParamsResourceManagementRemarketingaudiencePatch {
  ...
  @scala.inline
  implicit class ParamsResourceManagementRemarketingaudiencePatchMutableBuilder[Self <: ParamsResourceManagementRemarketingaudiencePatch] (val x: Self) extends AnyVal {
