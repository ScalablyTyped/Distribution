...
trait SchemaRemarketingAudience extends StObject {
  ...
  /**
    ...
    * audience.
    */
  var audienceDefinition: js.UndefOr[IncludeConditions] = js.undefined
...
object SchemaRemarketingAudience {
  ...
  extension [Self <: SchemaRemarketingAudience](x: Self) {
    ...
    inline def setLinkedAdAccountsVarargs(value: SchemaLinkedForeignAccount*): Self = StObject.set(x, "linkedAdAccounts", js.Array(value :_*))
