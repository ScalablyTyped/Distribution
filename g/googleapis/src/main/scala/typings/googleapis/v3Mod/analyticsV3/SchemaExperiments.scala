...
object SchemaExperiments {
  ...
  inline def apply(): SchemaExperiments = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaExperiments]
  }
  
  extension [Self <: SchemaExperiments](x: Self) {
    
    inline def setItems(value: js.Array[SchemaExperiment]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaExperiment*): Self = StObject.set(x, "items", js.Array(value :_*))
