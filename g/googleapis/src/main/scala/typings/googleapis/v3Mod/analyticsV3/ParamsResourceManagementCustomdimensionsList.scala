...
trait ParamsResourceManagementCustomdimensionsList
  extends StObject
...
object ParamsResourceManagementCustomdimensionsList {
  ...
  inline def apply(): ParamsResourceManagementCustomdimensionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementCustomdimensionsList]
  }
  
  extension [Self <: ParamsResourceManagementCustomdimensionsList](x: Self) {
