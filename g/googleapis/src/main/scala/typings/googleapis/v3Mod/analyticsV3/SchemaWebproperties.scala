...
object SchemaWebproperties {
  ...
  inline def apply(): SchemaWebproperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaWebproperties]
  }
  
  extension [Self <: SchemaWebproperties](x: Self) {
    
    inline def setItems(value: js.Array[SchemaWebproperty]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaWebproperty*): Self = StObject.set(x, "items", js.Array(value :_*))
