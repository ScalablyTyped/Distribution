...
trait ParamsResourceManagementProfilesUpdate
  extends StObject
...
object ParamsResourceManagementProfilesUpdate {
  ...
  inline def apply(): ParamsResourceManagementProfilesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementProfilesUpdate]
  }
  
  extension [Self <: ParamsResourceManagementProfilesUpdate](x: Self) {
