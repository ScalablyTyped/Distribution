...
/**
  ...
  * profile filter link.
  */
trait SchemaProfileFilterLinks extends StObject {
  
  /**
    * A list of profile filter links.
    */
  var items: js.UndefOr[js.Array[SchemaProfileFilterLink]] = js.undefined
...
object SchemaProfileFilterLinks {
  ...
  @scala.inline
  def apply(): SchemaProfileFilterLinks = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaProfileFilterLinks]
  }
  
  @scala.inline
  implicit class SchemaProfileFilterLinksMutableBuilder[Self <: SchemaProfileFilterLinks] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setItems(value: js.Array[SchemaProfileFilterLink]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaProfileFilterLink*): Self = StObject.set(x, "items", js.Array(value :_*))
