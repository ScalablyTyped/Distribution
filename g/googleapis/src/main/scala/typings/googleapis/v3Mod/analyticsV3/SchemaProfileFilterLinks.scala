...
object SchemaProfileFilterLinks {
  ...
  inline def apply(): SchemaProfileFilterLinks = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaProfileFilterLinks]
  }
  
  extension [Self <: SchemaProfileFilterLinks](x: Self) {
    
    inline def setItems(value: js.Array[SchemaProfileFilterLink]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaProfileFilterLink*): Self = StObject.set(x, "items", js.Array(value :_*))
