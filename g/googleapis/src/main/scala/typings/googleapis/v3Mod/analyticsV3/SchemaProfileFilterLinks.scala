...
object SchemaProfileFilterLinks {
  ...
  @scala.inline
  implicit class SchemaProfileFilterLinksOps[Self <: SchemaProfileFilterLinks] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaProfileFilterLink*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaProfileFilterLink]): Self = this.set("items", value.asInstanceOf[js.Any])
