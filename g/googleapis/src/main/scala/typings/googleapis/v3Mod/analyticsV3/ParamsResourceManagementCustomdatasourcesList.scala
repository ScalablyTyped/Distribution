...
@js.native
trait ParamsResourceManagementCustomdatasourcesList extends StandardParameters {
...
object ParamsResourceManagementCustomdatasourcesList {
  ...
  @scala.inline
  implicit class ParamsResourceManagementCustomdatasourcesListOps[Self <: ParamsResourceManagementCustomdatasourcesList] (val x: Self) extends AnyVal {
