...
@js.native
trait ParamsResourceManagementProfilefilterlinksGet extends StandardParameters {
...
object ParamsResourceManagementProfilefilterlinksGet {
  ...
  @scala.inline
  def apply(): ParamsResourceManagementProfilefilterlinksGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementProfilefilterlinksGet]
  }
  
  @scala.inline
  implicit class ParamsResourceManagementProfilefilterlinksGetMutableBuilder[Self <: ParamsResourceManagementProfilefilterlinksGet] (val x: Self) extends AnyVal {
