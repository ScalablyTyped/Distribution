...
trait SchemaRemarketingAudiences extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaRemarketingAudience]] = js.undefined
...
object SchemaRemarketingAudiences {
  ...
  inline def apply(): SchemaRemarketingAudiences = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRemarketingAudiences]
  }
  
  extension [Self <: SchemaRemarketingAudiences](x: Self) {
    
    inline def setItems(value: js.Array[SchemaRemarketingAudience]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaRemarketingAudience*): Self = StObject.set(x, "items", js.Array(value :_*))
