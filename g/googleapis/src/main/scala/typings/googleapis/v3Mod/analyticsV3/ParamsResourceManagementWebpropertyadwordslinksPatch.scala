...
object ParamsResourceManagementWebpropertyadwordslinksPatch {
  ...
  @scala.inline
  implicit class ParamsResourceManagementWebpropertyadwordslinksPatchOps[Self <: ParamsResourceManagementWebpropertyadwordslinksPatch] (val x: Self) extends AnyVal {
    @scala.inline
