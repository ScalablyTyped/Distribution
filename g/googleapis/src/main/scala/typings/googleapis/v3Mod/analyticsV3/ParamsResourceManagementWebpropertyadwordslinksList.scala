...
object ParamsResourceManagementWebpropertyadwordslinksList {
  ...
  @scala.inline
  implicit class ParamsResourceManagementWebpropertyadwordslinksListOps[Self <: ParamsResourceManagementWebpropertyadwordslinksList] (val x: Self) extends AnyVal {
