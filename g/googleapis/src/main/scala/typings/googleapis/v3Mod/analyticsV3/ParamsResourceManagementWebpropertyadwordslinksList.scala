...
trait ParamsResourceManagementWebpropertyadwordslinksList
  extends StObject
...
object ParamsResourceManagementWebpropertyadwordslinksList {
  ...
  inline def apply(): ParamsResourceManagementWebpropertyadwordslinksList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementWebpropertyadwordslinksList]
  }
  
  extension [Self <: ParamsResourceManagementWebpropertyadwordslinksList](x: Self) {
