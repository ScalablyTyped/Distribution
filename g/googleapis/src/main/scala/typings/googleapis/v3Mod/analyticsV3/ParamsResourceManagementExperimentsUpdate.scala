...
@js.native
trait ParamsResourceManagementExperimentsUpdate extends StandardParameters {
  /**
...
object ParamsResourceManagementExperimentsUpdate {
  @scala.inline
  def apply(): ParamsResourceManagementExperimentsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagementExperimentsUpdate]
  }
  @scala.inline
  implicit class ParamsResourceManagementExperimentsUpdateOps[Self <: ParamsResourceManagementExperimentsUpdate] (val x: Self) extends AnyVal {
    @scala.inline
