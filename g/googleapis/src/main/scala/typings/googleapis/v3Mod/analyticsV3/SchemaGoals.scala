...
trait SchemaGoals extends StObject {
  ...
  /**
    * A list of goals.
    */
  var items: js.UndefOr[js.Array[SchemaGoal]] = js.undefined
...
object SchemaGoals {
  ...
  inline def apply(): SchemaGoals = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoals]
  }
  
  extension [Self <: SchemaGoals](x: Self) {
    
    inline def setItems(value: js.Array[SchemaGoal]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaGoal*): Self = StObject.set(x, "items", js.Array(value :_*))
