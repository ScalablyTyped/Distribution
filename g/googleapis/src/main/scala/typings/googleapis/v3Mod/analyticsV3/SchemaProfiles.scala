...
trait SchemaProfiles extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaProfile]] = js.undefined
...
object SchemaProfiles {
  ...
  inline def apply(): SchemaProfiles = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaProfiles]
  }
  
  extension [Self <: SchemaProfiles](x: Self) {
    
    inline def setItems(value: js.Array[SchemaProfile]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    inline def setItemsVarargs(value: SchemaProfile*): Self = StObject.set(x, "items", js.Array(value :_*))
