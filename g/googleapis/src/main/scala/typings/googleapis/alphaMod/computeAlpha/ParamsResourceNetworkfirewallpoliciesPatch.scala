...
trait ParamsResourceNetworkfirewallpoliciesPatch
  extends StObject
...
object ParamsResourceNetworkfirewallpoliciesPatch {
  
  inline def apply(): ParamsResourceNetworkfirewallpoliciesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNetworkfirewallpoliciesPatch]
  }
  
  extension [Self <: ParamsResourceNetworkfirewallpoliciesPatch](x: Self) {
