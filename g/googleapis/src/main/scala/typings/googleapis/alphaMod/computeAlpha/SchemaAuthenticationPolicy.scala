...
trait SchemaAuthenticationPolicy extends StObject {
  ...
  /**
    ...
    */
  var principalBinding: js.UndefOr[String | Null] = js.undefined
...
object SchemaAuthenticationPolicy {
  ...
  extension [Self <: SchemaAuthenticationPolicy](x: Self) {
    ...
    inline def setOriginsVarargs(value: SchemaOriginAuthenticationMethod*): Self = StObject.set(x, "origins", js.Array(value*))
    ...
    inline def setPeersVarargs(value: SchemaPeerAuthenticationMethod*): Self = StObject.set(x, "peers", js.Array(value*))
    
    inline def setPrincipalBinding(value: String): Self = StObject.set(x, "principalBinding", value.asInstanceOf[js.Any])
    
    inline def setPrincipalBindingNull: Self = StObject.set(x, "principalBinding", null)
