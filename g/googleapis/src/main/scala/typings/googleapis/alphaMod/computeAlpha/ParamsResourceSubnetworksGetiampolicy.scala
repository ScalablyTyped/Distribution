...
trait ParamsResourceSubnetworksGetiampolicy
  extends StObject
...
object ParamsResourceSubnetworksGetiampolicy {
  ...
  inline def apply(): ParamsResourceSubnetworksGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSubnetworksGetiampolicy]
  }
  
  extension [Self <: ParamsResourceSubnetworksGetiampolicy](x: Self) {
