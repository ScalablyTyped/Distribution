...
trait ParamsResourceRoutesInsert
  extends StObject
...
object ParamsResourceRoutesInsert {
  ...
  @scala.inline
  implicit class ParamsResourceRoutesInsertMutableBuilder[Self <: ParamsResourceRoutesInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRoute): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
