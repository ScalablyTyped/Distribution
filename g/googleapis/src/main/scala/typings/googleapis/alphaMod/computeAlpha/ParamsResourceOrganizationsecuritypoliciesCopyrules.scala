...
object ParamsResourceOrganizationsecuritypoliciesCopyrules {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsecuritypoliciesCopyrulesOps[Self <: ParamsResourceOrganizationsecuritypoliciesCopyrules] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSourceSecurityPolicy(value: String): Self = this.set("sourceSecurityPolicy", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSourceSecurityPolicy: Self = this.set("sourceSecurityPolicy", js.undefined)
  }
