...
open class ResourceNetworks protected () extends StObject {
  ...
  def listIpAddresses(params: Unit, options: MethodOptions): GaxiosPromise[SchemaIpAddressesList] = js.native
  ...
  def listIpAddresses(
    params: ParamsResourceNetworksListipaddresses,
    options: BodyResponseCallback[Readable | SchemaIpAddressesList],
    callback: BodyResponseCallback[Readable | SchemaIpAddressesList]
  ): Unit = js.native
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def listIpAddresses(params: ParamsResourceNetworksListipaddresses, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def listIpAddresses(
    params: ParamsResourceNetworksListipaddresses,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def listIpOwners(params: Unit, options: MethodOptions): GaxiosPromise[SchemaIpOwnerList] = js.native
  ...
  def listIpOwners(
    ...
    options: BodyResponseCallback[Readable | SchemaIpOwnerList],
    callback: BodyResponseCallback[Readable | SchemaIpOwnerList]
  ): Unit = js.native
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def listIpOwners(params: ParamsResourceNetworksListipowners, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def listIpOwners(
    params: ParamsResourceNetworksListipowners,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
