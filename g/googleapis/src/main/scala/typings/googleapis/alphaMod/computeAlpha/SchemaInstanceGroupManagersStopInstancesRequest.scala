...
trait SchemaInstanceGroupManagersStopInstancesRequest extends StObject {
...
object SchemaInstanceGroupManagersStopInstancesRequest {
  
  inline def apply(): SchemaInstanceGroupManagersStopInstancesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInstanceGroupManagersStopInstancesRequest]
  }
  
  extension [Self <: SchemaInstanceGroupManagersStopInstancesRequest](x: Self) {
