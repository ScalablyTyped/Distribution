...
trait ParamsResourceRegioninstancetemplatesList
  extends StObject
...
object ParamsResourceRegioninstancetemplatesList {
  
  inline def apply(): ParamsResourceRegioninstancetemplatesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegioninstancetemplatesList]
  }
  
  extension [Self <: ParamsResourceRegioninstancetemplatesList](x: Self) {
