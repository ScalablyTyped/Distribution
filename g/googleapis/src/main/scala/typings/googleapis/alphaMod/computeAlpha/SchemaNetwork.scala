...
trait SchemaNetwork extends StObject {
  ...
  /**
    ...
    */
  var crossVmEncryption: js.UndefOr[String] = js.undefined
  ...
  /**
    ...
    */
  var loadBalancerVmEncryption: js.UndefOr[String] = js.undefined
...
object SchemaNetwork {
  ...
  extension [Self <: SchemaNetwork](x: Self) {
    ...
    inline def setCrossVmEncryption(value: String): Self = StObject.set(x, "crossVmEncryption", value.asInstanceOf[js.Any])
    
    inline def setCrossVmEncryptionUndefined: Self = StObject.set(x, "crossVmEncryption", js.undefined)
    ...
    inline def setLoadBalancerVmEncryption(value: String): Self = StObject.set(x, "loadBalancerVmEncryption", value.asInstanceOf[js.Any])
    
    inline def setLoadBalancerVmEncryptionUndefined: Self = StObject.set(x, "loadBalancerVmEncryption", js.undefined)
