...
object ParamsResourceRegioninstancegroupmanagersApplyupdatestoinstances {
  ...
  @scala.inline
  implicit class ParamsResourceRegioninstancegroupmanagersApplyupdatestoinstancesOps[Self <: ParamsResourceRegioninstancegroupmanagersApplyupdatestoinstances] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRegionInstanceGroupManagersApplyUpdatesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
