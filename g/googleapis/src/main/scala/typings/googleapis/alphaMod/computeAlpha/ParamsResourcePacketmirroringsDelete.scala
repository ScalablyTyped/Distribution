...
trait ParamsResourcePacketmirroringsDelete
  extends StObject
...
object ParamsResourcePacketmirroringsDelete {
  
  inline def apply(): ParamsResourcePacketmirroringsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePacketmirroringsDelete]
  }
  
  extension [Self <: ParamsResourcePacketmirroringsDelete](x: Self) {
