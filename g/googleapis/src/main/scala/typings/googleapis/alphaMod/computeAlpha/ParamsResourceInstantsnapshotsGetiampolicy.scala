...
trait ParamsResourceInstantsnapshotsGetiampolicy
  extends StObject
...
object ParamsResourceInstantsnapshotsGetiampolicy {
  
  inline def apply(): ParamsResourceInstantsnapshotsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstantsnapshotsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceInstantsnapshotsGetiampolicy](x: Self) {
