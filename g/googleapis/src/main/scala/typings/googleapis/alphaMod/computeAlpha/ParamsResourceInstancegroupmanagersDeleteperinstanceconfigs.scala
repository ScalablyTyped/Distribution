...
object ParamsResourceInstancegroupmanagersDeleteperinstanceconfigs {
  ...
  @scala.inline
  implicit class ParamsResourceInstancegroupmanagersDeleteperinstanceconfigsMutableBuilder[Self <: ParamsResourceInstancegroupmanagersDeleteperinstanceconfigs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaInstanceGroupManagersDeletePerInstanceConfigsReq): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
