...
@js.native
open class ResourceZones protected () extends StObject {
  ...
  /**
    ...
    */
  def get(params: ParamsResourceZonesGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceZonesGet,
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaZoneList] = js.native
  ...
  def list(
    ...
    options: BodyResponseCallback[Readable | SchemaZoneList],
    callback: BodyResponseCallback[Readable | SchemaZoneList]
  ): Unit = js.native
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceZonesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceZonesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
