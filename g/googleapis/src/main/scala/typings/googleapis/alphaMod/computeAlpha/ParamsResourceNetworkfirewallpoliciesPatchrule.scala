...
trait ParamsResourceNetworkfirewallpoliciesPatchrule
  extends StObject
...
object ParamsResourceNetworkfirewallpoliciesPatchrule {
  
  inline def apply(): ParamsResourceNetworkfirewallpoliciesPatchrule = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNetworkfirewallpoliciesPatchrule]
  }
  
  extension [Self <: ParamsResourceNetworkfirewallpoliciesPatchrule](x: Self) {
