...
trait ParamsResourceNetworksListipaddresses
  extends StObject
...
object ParamsResourceNetworksListipaddresses {
  ...
  inline def apply(): ParamsResourceNetworksListipaddresses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNetworksListipaddresses]
  }
  
  extension [Self <: ParamsResourceNetworksListipaddresses](x: Self) {
