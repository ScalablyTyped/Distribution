...
trait ParamsResourceNodegroupsInsert
  extends StObject
...
object ParamsResourceNodegroupsInsert {
  ...
  @scala.inline
  def apply(): ParamsResourceNodegroupsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodegroupsInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceNodegroupsInsertMutableBuilder[Self <: ParamsResourceNodegroupsInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaNodeGroup): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
