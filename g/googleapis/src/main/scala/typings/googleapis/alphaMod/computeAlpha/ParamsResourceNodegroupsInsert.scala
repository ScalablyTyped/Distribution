...
object ParamsResourceNodegroupsInsert {
  ...
  @scala.inline
  implicit class ParamsResourceNodegroupsInsertOps[Self <: ParamsResourceNodegroupsInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaNodeGroup): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
