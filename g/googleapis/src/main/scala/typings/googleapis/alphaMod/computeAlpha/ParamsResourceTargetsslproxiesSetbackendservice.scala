...
object ParamsResourceTargetsslproxiesSetbackendservice {
  ...
  @scala.inline
  implicit class ParamsResourceTargetsslproxiesSetbackendserviceOps[Self <: ParamsResourceTargetsslproxiesSetbackendservice] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaTargetSslProxiesSetBackendServiceRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
