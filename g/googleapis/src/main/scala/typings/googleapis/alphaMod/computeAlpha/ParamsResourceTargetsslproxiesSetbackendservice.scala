...
@js.native
trait ParamsResourceTargetsslproxiesSetbackendservice extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaTargetSslProxiesSetBackendServiceRequest] = js.native
...
object ParamsResourceTargetsslproxiesSetbackendservice {
  ...
  @scala.inline
  def apply(): ParamsResourceTargetsslproxiesSetbackendservice = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTargetsslproxiesSetbackendservice]
  }
  
  @scala.inline
  implicit class ParamsResourceTargetsslproxiesSetbackendserviceMutableBuilder[Self <: ParamsResourceTargetsslproxiesSetbackendservice] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaTargetSslProxiesSetBackendServiceRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
