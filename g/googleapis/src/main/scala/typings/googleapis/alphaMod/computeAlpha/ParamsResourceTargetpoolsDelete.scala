...
@js.native
trait ParamsResourceTargetpoolsDelete extends StandardParameters {
...
object ParamsResourceTargetpoolsDelete {
  
  @scala.inline
  def apply(): ParamsResourceTargetpoolsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTargetpoolsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceTargetpoolsDeleteMutableBuilder[Self <: ParamsResourceTargetpoolsDelete] (val x: Self) extends AnyVal {
