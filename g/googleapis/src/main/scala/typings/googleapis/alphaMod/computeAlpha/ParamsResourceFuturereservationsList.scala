...
trait ParamsResourceFuturereservationsList
  extends StObject
...
object ParamsResourceFuturereservationsList {
  
  inline def apply(): ParamsResourceFuturereservationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFuturereservationsList]
  }
  
  extension [Self <: ParamsResourceFuturereservationsList](x: Self) {
