...
trait SchemaAdvancedMachineFeatures extends StObject {
  ...
  /**
    ...
    */
  var numaNodeCount: js.UndefOr[Double | Null] = js.undefined
...
object SchemaAdvancedMachineFeatures {
  ...
  extension [Self <: SchemaAdvancedMachineFeatures](x: Self) {
    ...
    inline def setNumaNodeCount(value: Double): Self = StObject.set(x, "numaNodeCount", value.asInstanceOf[js.Any])
    
    inline def setNumaNodeCountNull: Self = StObject.set(x, "numaNodeCount", null)
    
    inline def setNumaNodeCountUndefined: Self = StObject.set(x, "numaNodeCount", js.undefined)
