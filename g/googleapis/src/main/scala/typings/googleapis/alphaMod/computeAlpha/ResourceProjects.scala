...
open class ResourceProjects protected () extends StObject {
  ...
  def setDefaultServiceAccount(params: Unit, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def setDefaultServiceAccount(params: ParamsResourceProjectsSetdefaultserviceaccount, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def setDefaultServiceAccount(
    params: ParamsResourceProjectsSetdefaultserviceaccount,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
