...
open class ResourceRegionbackendservices protected () extends StObject {
  ...
  def setSecurityPolicy(params: ParamsResourceRegionbackendservicesSetsecuritypolicy): GaxiosPromise[SchemaOperation] = js.native
  def setSecurityPolicy(
    params: ParamsResourceRegionbackendservicesSetsecuritypolicy,
    callback: BodyResponseCallback[SchemaOperation]
  ): Unit = js.native
  def setSecurityPolicy(
    params: ParamsResourceRegionbackendservicesSetsecuritypolicy,
  ...
  def setSecurityPolicy(params: ParamsResourceRegionbackendservicesSetsecuritypolicy, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def setSecurityPolicy(
    params: ParamsResourceRegionbackendservicesSetsecuritypolicy,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  /**
    ...
    *
    *   // Do the magic
    *   const res = await compute.regionBackendServices.setSecurityPolicy({
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def setSecurityPolicy(params: ParamsResourceRegionbackendservicesSetsecuritypolicy, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def setSecurityPolicy(
    params: ParamsResourceRegionbackendservicesSetsecuritypolicy,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
