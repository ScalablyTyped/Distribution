...
open class ResourceInstances protected () extends StObject {
  ...
  def performMaintenance(): GaxiosPromise[SchemaOperation] = js.native
  def performMaintenance(callback: BodyResponseCallback[SchemaOperation]): Unit = js.native
  def performMaintenance(params: Unit, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def performMaintenance(params: ParamsResourceInstancesPerformmaintenance): GaxiosPromise[SchemaOperation] = js.native
  def performMaintenance(params: ParamsResourceInstancesPerformmaintenance, callback: BodyResponseCallback[SchemaOperation]): Unit = js.native
  def performMaintenance(
    params: ParamsResourceInstancesPerformmaintenance,
    options: BodyResponseCallback[Readable | SchemaOperation],
    callback: BodyResponseCallback[Readable | SchemaOperation]
  ): Unit = js.native
  def performMaintenance(params: ParamsResourceInstancesPerformmaintenance, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def performMaintenance(
    params: ParamsResourceInstancesPerformmaintenance,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  /**
    ...
    *
    *   // Do the magic
    *   const res = await compute.instances.performMaintenance({
    *     // Name of the instance scoping this request.
    *     instance: '[a-z](?:[-a-z0-9]{0,61}[a-z0-9])?|[1-9][0-9]{0,19}',
    *     // Project ID for this request.
    *     project:
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def performMaintenance(params: ParamsResourceInstancesPerformmaintenance, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def performMaintenance(
    params: ParamsResourceInstancesPerformmaintenance,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    *       //   "currentCpus": 0,
    *       //   "currentMemoryMb": "my_currentMemoryMb",
