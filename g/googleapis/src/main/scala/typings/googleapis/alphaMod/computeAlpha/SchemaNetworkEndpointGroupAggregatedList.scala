...
object SchemaNetworkEndpointGroupAggregatedList {
  ...
  @scala.inline
  implicit class SchemaNetworkEndpointGroupAggregatedListOps[Self <: SchemaNetworkEndpointGroupAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: StringDictionary[SchemaNetworkEndpointGroupsScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
