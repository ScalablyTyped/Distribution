...
trait ParamsResourceRegioninstantsnapshotsGetiampolicy
  extends StObject
...
object ParamsResourceRegioninstantsnapshotsGetiampolicy {
  
  inline def apply(): ParamsResourceRegioninstantsnapshotsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegioninstantsnapshotsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceRegioninstantsnapshotsGetiampolicy](x: Self) {
