...
trait SchemaNetworkPeering extends StObject {
  ...
  /**
    ...
    */
  var advertisePeerSubnetsViaRouters: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaNetworkPeering {
  ...
  extension [Self <: SchemaNetworkPeering](x: Self) {
    ...
    inline def setAdvertisePeerSubnetsViaRouters(value: Boolean): Self = StObject.set(x, "advertisePeerSubnetsViaRouters", value.asInstanceOf[js.Any])
    
    inline def setAdvertisePeerSubnetsViaRoutersNull: Self = StObject.set(x, "advertisePeerSubnetsViaRouters", null)
    
    inline def setAdvertisePeerSubnetsViaRoutersUndefined: Self = StObject.set(x, "advertisePeerSubnetsViaRouters", js.undefined)
