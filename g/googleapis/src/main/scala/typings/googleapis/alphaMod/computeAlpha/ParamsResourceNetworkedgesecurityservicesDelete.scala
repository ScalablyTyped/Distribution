...
trait ParamsResourceNetworkedgesecurityservicesDelete
  extends StObject
...
object ParamsResourceNetworkedgesecurityservicesDelete {
  
  inline def apply(): ParamsResourceNetworkedgesecurityservicesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNetworkedgesecurityservicesDelete]
  }
  
  extension [Self <: ParamsResourceNetworkedgesecurityservicesDelete](x: Self) {
