...
trait SchemaInstanceGroupManager extends StObject {
  ...
  /**
    ...
    */
  var instanceLifecyclePolicy: js.UndefOr[SchemaInstanceGroupManagerInstanceLifecyclePolicy] = js.undefined
  ...
  /**
    ...
    */
  var standbyPolicy: js.UndefOr[SchemaInstanceGroupManagerStandbyPolicy] = js.undefined
  ...
  /**
    ...
    */
  var targetStoppedSize: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * The target number of suspended instances for this managed instance group. This number changes when you: - Suspend instance using the suspendInstances method or resume instances using the resumeInstances method. - Manually change the targetSuspendedSize using the update method.
    */
  var targetSuspendedSize: js.UndefOr[Double | Null] = js.undefined
...
object SchemaInstanceGroupManager {
  ...
  extension [Self <: SchemaInstanceGroupManager](x: Self) {
    ...
    inline def setInstanceLifecyclePolicy(value: SchemaInstanceGroupManagerInstanceLifecyclePolicy): Self = StObject.set(x, "instanceLifecyclePolicy", value.asInstanceOf[js.Any])
    
    inline def setInstanceLifecyclePolicyUndefined: Self = StObject.set(x, "instanceLifecyclePolicy", js.undefined)
    ...
    inline def setStandbyPolicy(value: SchemaInstanceGroupManagerStandbyPolicy): Self = StObject.set(x, "standbyPolicy", value.asInstanceOf[js.Any])
    
    inline def setStandbyPolicyUndefined: Self = StObject.set(x, "standbyPolicy", js.undefined)
    ...
    inline def setTargetStoppedSize(value: Double): Self = StObject.set(x, "targetStoppedSize", value.asInstanceOf[js.Any])
    
    inline def setTargetStoppedSizeNull: Self = StObject.set(x, "targetStoppedSize", null)
    
    inline def setTargetStoppedSizeUndefined: Self = StObject.set(x, "targetStoppedSize", js.undefined)
    
    inline def setTargetSuspendedSize(value: Double): Self = StObject.set(x, "targetSuspendedSize", value.asInstanceOf[js.Any])
    
    inline def setTargetSuspendedSizeNull: Self = StObject.set(x, "targetSuspendedSize", null)
    
    inline def setTargetSuspendedSizeUndefined: Self = StObject.set(x, "targetSuspendedSize", js.undefined)
