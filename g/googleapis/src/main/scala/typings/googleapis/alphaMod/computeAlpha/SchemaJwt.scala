...
trait SchemaJwt extends StObject {
  ...
  /**
    ...
    */
  var jwksPublicKeys: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var jwtParams: js.UndefOr[js.Array[String] | Null] = js.undefined
}
object SchemaJwt {
  ...
  extension [Self <: SchemaJwt](x: Self) {
    ...
    inline def setJwksPublicKeysNull: Self = StObject.set(x, "jwksPublicKeys", null)
    ...
    inline def setJwtHeadersVarargs(value: SchemaJwtHeader*): Self = StObject.set(x, "jwtHeaders", js.Array(value*))
    
    inline def setJwtParams(value: js.Array[String]): Self = StObject.set(x, "jwtParams", value.asInstanceOf[js.Any])
    
    inline def setJwtParamsNull: Self = StObject.set(x, "jwtParams", null)
    
    inline def setJwtParamsUndefined: Self = StObject.set(x, "jwtParams", js.undefined)
    
    inline def setJwtParamsVarargs(value: String*): Self = StObject.set(x, "jwtParams", js.Array(value*))
  }
}
