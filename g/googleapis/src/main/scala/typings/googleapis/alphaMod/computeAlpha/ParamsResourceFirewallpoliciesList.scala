...
trait ParamsResourceFirewallpoliciesList
  extends StObject
...
object ParamsResourceFirewallpoliciesList {
  
  inline def apply(): ParamsResourceFirewallpoliciesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFirewallpoliciesList]
  }
  
  extension [Self <: ParamsResourceFirewallpoliciesList](x: Self) {
