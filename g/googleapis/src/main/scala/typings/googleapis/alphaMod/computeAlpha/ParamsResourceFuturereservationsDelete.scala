...
trait ParamsResourceFuturereservationsDelete
  extends StObject
...
object ParamsResourceFuturereservationsDelete {
  
  inline def apply(): ParamsResourceFuturereservationsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFuturereservationsDelete]
  }
  
  extension [Self <: ParamsResourceFuturereservationsDelete](x: Self) {
