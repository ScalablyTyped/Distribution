...
object ParamsResourceSubnetworksSetprivateipgoogleaccess {
  ...
  @scala.inline
  implicit class ParamsResourceSubnetworksSetprivateipgoogleaccessOps[Self <: ParamsResourceSubnetworksSetprivateipgoogleaccess] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaSubnetworksSetPrivateIpGoogleAccessRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
