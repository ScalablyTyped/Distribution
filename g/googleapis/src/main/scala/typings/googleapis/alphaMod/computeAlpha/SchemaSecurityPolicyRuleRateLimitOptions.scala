...
trait SchemaSecurityPolicyRuleRateLimitOptions extends StObject {
  ...
  /**
    ...
    */
  var exceedActionRpcStatus: js.UndefOr[SchemaSecurityPolicyRuleRateLimitOptionsRpcStatus] = js.undefined
...
object SchemaSecurityPolicyRuleRateLimitOptions {
  ...
  extension [Self <: SchemaSecurityPolicyRuleRateLimitOptions](x: Self) {
    ...
    inline def setExceedActionRpcStatus(value: SchemaSecurityPolicyRuleRateLimitOptionsRpcStatus): Self = StObject.set(x, "exceedActionRpcStatus", value.asInstanceOf[js.Any])
    
    inline def setExceedActionRpcStatusUndefined: Self = StObject.set(x, "exceedActionRpcStatus", js.undefined)
