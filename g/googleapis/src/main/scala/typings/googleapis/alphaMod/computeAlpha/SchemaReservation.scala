...
trait SchemaReservation extends StObject {
  ...
  /**
    ...
    */
  var resourcePolicies: js.UndefOr[StringDictionary[String] | Null] = js.undefined
  
  /**
    * [Output Only] Status information for Reservation resource.
    */
  var resourceStatus: js.UndefOr[SchemaAllocationResourceStatus] = js.undefined
...
object SchemaReservation {
  ...
  extension [Self <: SchemaReservation](x: Self) {
    ...
    inline def setResourcePolicies(value: StringDictionary[String]): Self = StObject.set(x, "resourcePolicies", value.asInstanceOf[js.Any])
    ...
    inline def setResourceStatus(value: SchemaAllocationResourceStatus): Self = StObject.set(x, "resourceStatus", value.asInstanceOf[js.Any])
