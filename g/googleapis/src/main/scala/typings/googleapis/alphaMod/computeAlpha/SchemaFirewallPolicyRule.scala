...
trait SchemaFirewallPolicyRule extends StObject {
  ...
  /**
    ...
    */
  var securityProfileGroup: js.UndefOr[String | Null] = js.undefined
...
object SchemaFirewallPolicyRule {
  ...
  extension [Self <: SchemaFirewallPolicyRule](x: Self) {
    ...
    inline def setSecurityProfileGroup(value: String): Self = StObject.set(x, "securityProfileGroup", value.asInstanceOf[js.Any])
    
    inline def setSecurityProfileGroupNull: Self = StObject.set(x, "securityProfileGroup", null)
    
    inline def setSecurityProfileGroupUndefined: Self = StObject.set(x, "securityProfileGroup", js.undefined)
