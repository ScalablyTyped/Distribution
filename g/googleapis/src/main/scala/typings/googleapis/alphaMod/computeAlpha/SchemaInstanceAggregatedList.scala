...
object SchemaInstanceAggregatedList {
  ...
  @scala.inline
  implicit class SchemaInstanceAggregatedListOps[Self <: SchemaInstanceAggregatedList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItems(value: StringDictionary[SchemaInstancesScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
