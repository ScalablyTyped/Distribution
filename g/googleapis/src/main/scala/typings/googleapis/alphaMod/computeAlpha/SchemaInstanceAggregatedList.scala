...
trait SchemaInstanceAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaInstancesScopedList] | Null] = js.undefined
...
object SchemaInstanceAggregatedList {
  ...
  inline def apply(): SchemaInstanceAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInstanceAggregatedList]
  }
  
  extension [Self <: SchemaInstanceAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaInstancesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
