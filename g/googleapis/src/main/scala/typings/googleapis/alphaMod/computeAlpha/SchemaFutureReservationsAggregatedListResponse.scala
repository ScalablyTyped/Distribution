...
trait SchemaFutureReservationsAggregatedListResponse extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaFutureReservationsScopedList] | Null] = js.undefined
...
object SchemaFutureReservationsAggregatedListResponse {
  
  inline def apply(): SchemaFutureReservationsAggregatedListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaFutureReservationsAggregatedListResponse]
  }
  
  extension [Self <: SchemaFutureReservationsAggregatedListResponse](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaFutureReservationsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
