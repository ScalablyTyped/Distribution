...
trait ParamsResourceRegionsslpoliciesList
  extends StObject
...
object ParamsResourceRegionsslpoliciesList {
  
  inline def apply(): ParamsResourceRegionsslpoliciesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionsslpoliciesList]
  }
  
  extension [Self <: ParamsResourceRegionsslpoliciesList](x: Self) {
