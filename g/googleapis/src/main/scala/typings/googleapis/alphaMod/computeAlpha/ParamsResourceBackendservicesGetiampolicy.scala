...
trait ParamsResourceBackendservicesGetiampolicy
  extends StObject
...
object ParamsResourceBackendservicesGetiampolicy {
  
  inline def apply(): ParamsResourceBackendservicesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBackendservicesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceBackendservicesGetiampolicy](x: Self) {
