...
trait SchemaHealthCheckService extends StObject {
  ...
  /**
    ...
    */
  var healthStatusAggregationStrategy: js.UndefOr[String | Null] = js.undefined
...
object SchemaHealthCheckService {
  ...
  extension [Self <: SchemaHealthCheckService](x: Self) {
    ...
    inline def setHealthStatusAggregationStrategyNull: Self = StObject.set(x, "healthStatusAggregationStrategy", null)
