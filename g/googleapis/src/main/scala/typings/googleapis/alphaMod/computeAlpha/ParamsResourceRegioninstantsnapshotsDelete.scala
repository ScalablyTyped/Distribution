...
trait ParamsResourceRegioninstantsnapshotsDelete
  extends StObject
...
object ParamsResourceRegioninstantsnapshotsDelete {
  
  inline def apply(): ParamsResourceRegioninstantsnapshotsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegioninstantsnapshotsDelete]
  }
  
  extension [Self <: ParamsResourceRegioninstantsnapshotsDelete](x: Self) {
