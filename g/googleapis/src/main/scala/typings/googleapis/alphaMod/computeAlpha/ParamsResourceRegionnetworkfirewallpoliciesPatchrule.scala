...
trait ParamsResourceRegionnetworkfirewallpoliciesPatchrule
  extends StObject
...
object ParamsResourceRegionnetworkfirewallpoliciesPatchrule {
  
  inline def apply(): ParamsResourceRegionnetworkfirewallpoliciesPatchrule = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionnetworkfirewallpoliciesPatchrule]
  }
  
  extension [Self <: ParamsResourceRegionnetworkfirewallpoliciesPatchrule](x: Self) {
