...
trait SchemaSubnetworkAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaSubnetworksScopedList] | Null] = js.undefined
...
object SchemaSubnetworkAggregatedList {
  ...
  inline def apply(): SchemaSubnetworkAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSubnetworkAggregatedList]
  }
  
  extension [Self <: SchemaSubnetworkAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaSubnetworksScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
