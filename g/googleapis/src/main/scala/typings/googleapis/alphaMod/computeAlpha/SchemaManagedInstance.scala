...
object SchemaManagedInstance {
  ...
  extension [Self <: SchemaManagedInstance](x: Self) {
    ...
    inline def setInstanceHealthVarargs(value: SchemaManagedInstanceInstanceHealth*): Self = StObject.set(x, "instanceHealth", js.Array(value :_*))
    ...
    inline def setOverride(value: SchemaManagedInstanceOverride): Self = StObject.set(x, "override", value.asInstanceOf[js.Any])
