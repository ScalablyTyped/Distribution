...
trait SchemaManagedInstance extends StObject {
  ...
  /**
    ...
    */
  var targetStatus: js.UndefOr[String | Null] = js.undefined
...
object SchemaManagedInstance {
  ...
  extension [Self <: SchemaManagedInstance](x: Self) {
    ...
    inline def setTargetStatus(value: String): Self = StObject.set(x, "targetStatus", value.asInstanceOf[js.Any])
    
    inline def setTargetStatusNull: Self = StObject.set(x, "targetStatus", null)
