...
@js.native
trait ParamsResourceRoutesDelete extends StandardParameters {
...
object ParamsResourceRoutesDelete {
  
  @scala.inline
  def apply(): ParamsResourceRoutesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRoutesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceRoutesDeleteMutableBuilder[Self <: ParamsResourceRoutesDelete] (val x: Self) extends AnyVal {
