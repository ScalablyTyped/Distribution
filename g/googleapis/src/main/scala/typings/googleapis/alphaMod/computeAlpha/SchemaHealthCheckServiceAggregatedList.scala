...
trait SchemaHealthCheckServiceAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaHealthCheckServicesScopedList] | Null] = js.undefined
...
object SchemaHealthCheckServiceAggregatedList {
  
  inline def apply(): SchemaHealthCheckServiceAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaHealthCheckServiceAggregatedList]
  }
  
  extension [Self <: SchemaHealthCheckServiceAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaHealthCheckServicesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
