...
trait SchemaFirewallPolicyRuleMatcher extends StObject {
  ...
  /**
    ...
    */
  var destFqdns: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var srcFqdns: js.UndefOr[js.Array[String] | Null] = js.undefined
...
object SchemaFirewallPolicyRuleMatcher {
  ...
  extension [Self <: SchemaFirewallPolicyRuleMatcher](x: Self) {
    ...
    inline def setDestFqdns(value: js.Array[String]): Self = StObject.set(x, "destFqdns", value.asInstanceOf[js.Any])
    
    inline def setDestFqdnsNull: Self = StObject.set(x, "destFqdns", null)
    
    inline def setDestFqdnsUndefined: Self = StObject.set(x, "destFqdns", js.undefined)
    
    inline def setDestFqdnsVarargs(value: String*): Self = StObject.set(x, "destFqdns", js.Array(value*))
    ...
    inline def setSrcFqdns(value: js.Array[String]): Self = StObject.set(x, "srcFqdns", value.asInstanceOf[js.Any])
    
    inline def setSrcFqdnsNull: Self = StObject.set(x, "srcFqdns", null)
    
    inline def setSrcFqdnsUndefined: Self = StObject.set(x, "srcFqdns", js.undefined)
    
    inline def setSrcFqdnsVarargs(value: String*): Self = StObject.set(x, "srcFqdns", js.Array(value*))
