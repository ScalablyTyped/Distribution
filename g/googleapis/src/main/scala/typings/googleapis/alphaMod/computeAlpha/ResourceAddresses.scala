...
open class ResourceAddresses protected () extends StObject {
  ...
  def move(params: ParamsResourceAddressesMove): GaxiosPromise[SchemaOperation] = js.native
  def move(params: ParamsResourceAddressesMove, callback: BodyResponseCallback[SchemaOperation]): Unit = js.native
  def move(
    params: ParamsResourceAddressesMove,
    options: BodyResponseCallback[Readable | SchemaOperation],
    callback: BodyResponseCallback[Readable | SchemaOperation]
  ): Unit = js.native
  def move(params: ParamsResourceAddressesMove, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def move(
    params: ParamsResourceAddressesMove,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  /**
    ...
    *
    *   // Do the magic
    *   const res = await compute.addresses.move({
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def move(params: ParamsResourceAddressesMove, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def move(
    params: ParamsResourceAddressesMove,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
