...
trait ParamsResourceServiceattachmentsDelete
  extends StObject
...
object ParamsResourceServiceattachmentsDelete {
  
  inline def apply(): ParamsResourceServiceattachmentsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceServiceattachmentsDelete]
  }
  
  extension [Self <: ParamsResourceServiceattachmentsDelete](x: Self) {
