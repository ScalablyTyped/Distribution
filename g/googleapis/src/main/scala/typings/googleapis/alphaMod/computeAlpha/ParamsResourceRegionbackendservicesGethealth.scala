...
object ParamsResourceRegionbackendservicesGethealth {
  ...
  @scala.inline
  implicit class ParamsResourceRegionbackendservicesGethealthOps[Self <: ParamsResourceRegionbackendservicesGethealth] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaResourceGroupReference): Self = this.set("requestBody", value.asInstanceOf[js.Any])
