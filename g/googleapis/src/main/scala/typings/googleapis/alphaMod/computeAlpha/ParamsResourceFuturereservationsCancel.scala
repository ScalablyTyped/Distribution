...
trait ParamsResourceFuturereservationsCancel
  extends StObject
...
object ParamsResourceFuturereservationsCancel {
  
  inline def apply(): ParamsResourceFuturereservationsCancel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFuturereservationsCancel]
  }
  
  extension [Self <: ParamsResourceFuturereservationsCancel](x: Self) {
