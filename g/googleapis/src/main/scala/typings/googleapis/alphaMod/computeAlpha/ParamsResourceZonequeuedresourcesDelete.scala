...
trait ParamsResourceZonequeuedresourcesDelete
  extends StObject
...
object ParamsResourceZonequeuedresourcesDelete {
  
  inline def apply(): ParamsResourceZonequeuedresourcesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceZonequeuedresourcesDelete]
  }
  
  extension [Self <: ParamsResourceZonequeuedresourcesDelete](x: Self) {
