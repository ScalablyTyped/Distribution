...
trait ParamsResourcePublicdelegatedprefixesAnnounce
  extends StObject
...
object ParamsResourcePublicdelegatedprefixesAnnounce {
  
  inline def apply(): ParamsResourcePublicdelegatedprefixesAnnounce = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePublicdelegatedprefixesAnnounce]
  }
  
  extension [Self <: ParamsResourcePublicdelegatedprefixesAnnounce](x: Self) {
