...
trait SchemaAccessConfig extends StObject {
  ...
  /**
    ...
    */
  var setPublicDns: js.UndefOr[Boolean] = js.undefined
...
object SchemaAccessConfig {
  ...
  implicit class SchemaAccessConfigMutableBuilder[Self <: SchemaAccessConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSetPublicDns(value: Boolean): Self = StObject.set(x, "setPublicDns", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSetPublicDnsUndefined: Self = StObject.set(x, "setPublicDns", js.undefined)
