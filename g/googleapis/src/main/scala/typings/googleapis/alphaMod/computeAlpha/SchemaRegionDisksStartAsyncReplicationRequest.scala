...
trait SchemaRegionDisksStartAsyncReplicationRequest extends StObject {
...
object SchemaRegionDisksStartAsyncReplicationRequest {
  
  inline def apply(): SchemaRegionDisksStartAsyncReplicationRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRegionDisksStartAsyncReplicationRequest]
  }
  
  extension [Self <: SchemaRegionDisksStartAsyncReplicationRequest](x: Self) {
