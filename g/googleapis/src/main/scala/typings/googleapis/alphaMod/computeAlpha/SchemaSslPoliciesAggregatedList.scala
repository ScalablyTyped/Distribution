...
trait SchemaSslPoliciesAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaSslPoliciesScopedList] | Null] = js.undefined
...
object SchemaSslPoliciesAggregatedList {
  
  inline def apply(): SchemaSslPoliciesAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSslPoliciesAggregatedList]
  }
  
  extension [Self <: SchemaSslPoliciesAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaSslPoliciesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
