...
trait ParamsResourceZonequeuedresourcesList
  extends StObject
...
object ParamsResourceZonequeuedresourcesList {
  
  inline def apply(): ParamsResourceZonequeuedresourcesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceZonequeuedresourcesList]
  }
  
  extension [Self <: ParamsResourceZonequeuedresourcesList](x: Self) {
