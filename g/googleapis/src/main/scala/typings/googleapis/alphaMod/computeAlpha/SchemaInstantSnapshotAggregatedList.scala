...
trait SchemaInstantSnapshotAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaInstantSnapshotsScopedList] | Null] = js.undefined
...
object SchemaInstantSnapshotAggregatedList {
  
  inline def apply(): SchemaInstantSnapshotAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInstantSnapshotAggregatedList]
  }
  
  extension [Self <: SchemaInstantSnapshotAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaInstantSnapshotsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
