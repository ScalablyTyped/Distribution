...
trait SchemaInstanceGroupManagersSuspendInstancesRequest extends StObject {
...
object SchemaInstanceGroupManagersSuspendInstancesRequest {
  
  inline def apply(): SchemaInstanceGroupManagersSuspendInstancesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInstanceGroupManagersSuspendInstancesRequest]
  }
  
  extension [Self <: SchemaInstanceGroupManagersSuspendInstancesRequest](x: Self) {
