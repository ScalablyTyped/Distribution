...
trait SchemaQueuedResource extends StObject {
  
  /**
    * Specification of VM instances to create.
    */
  var bulkInsertInstanceResource: js.UndefOr[SchemaBulkInsertInstanceResource] = js.undefined
  ...
  /**
    ...
    */
  var status: js.UndefOr[SchemaQueuedResourceStatus] = js.undefined
...
object SchemaQueuedResource {
  
  inline def apply(): SchemaQueuedResource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaQueuedResource]
  }
  
  extension [Self <: SchemaQueuedResource](x: Self) {
    
    inline def setBulkInsertInstanceResource(value: SchemaBulkInsertInstanceResource): Self = StObject.set(x, "bulkInsertInstanceResource", value.asInstanceOf[js.Any])
    
    inline def setBulkInsertInstanceResourceUndefined: Self = StObject.set(x, "bulkInsertInstanceResource", js.undefined)
    ...
    inline def setStatus(value: SchemaQueuedResourceStatus): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
