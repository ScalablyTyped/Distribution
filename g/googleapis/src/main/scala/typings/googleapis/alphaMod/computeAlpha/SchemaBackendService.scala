...
trait SchemaBackendService extends StObject {
  ...
  /**
    ...
    */
  var appEngineBackend: js.UndefOr[SchemaBackendServiceAppEngineBackend] = js.undefined
  ...
  /**
    ...
    */
  var cloudFunctionBackend: js.UndefOr[SchemaBackendServiceCloudFunctionBackend] = js.undefined
...
object SchemaBackendService {
  ...
  extension [Self <: SchemaBackendService](x: Self) {
    ...
    inline def setAppEngineBackend(value: SchemaBackendServiceAppEngineBackend): Self = StObject.set(x, "appEngineBackend", value.asInstanceOf[js.Any])
    
    inline def setAppEngineBackendUndefined: Self = StObject.set(x, "appEngineBackend", js.undefined)
    ...
    inline def setCloudFunctionBackend(value: SchemaBackendServiceCloudFunctionBackend): Self = StObject.set(x, "cloudFunctionBackend", value.asInstanceOf[js.Any])
    
    inline def setCloudFunctionBackendUndefined: Self = StObject.set(x, "cloudFunctionBackend", js.undefined)
