...
trait SchemaBackendService extends StObject {
  ...
  /**
    ...
    */
  var serviceLbPolicy: js.UndefOr[String | Null] = js.undefined
...
object SchemaBackendService {
  ...
  extension [Self <: SchemaBackendService](x: Self) {
    ...
    inline def setServiceLbPolicy(value: String): Self = StObject.set(x, "serviceLbPolicy", value.asInstanceOf[js.Any])
    
    inline def setServiceLbPolicyNull: Self = StObject.set(x, "serviceLbPolicy", null)
    
    inline def setServiceLbPolicyUndefined: Self = StObject.set(x, "serviceLbPolicy", js.undefined)
