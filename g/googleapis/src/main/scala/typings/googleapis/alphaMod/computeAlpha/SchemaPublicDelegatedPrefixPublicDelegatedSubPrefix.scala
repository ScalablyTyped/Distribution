...
trait SchemaPublicDelegatedPrefixPublicDelegatedSubPrefix extends StObject {
  
  /**
    * Name of the project scoping this PublicDelegatedSubPrefix.
    */
  var delegateeProject: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var isAddress: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaPublicDelegatedPrefixPublicDelegatedSubPrefix {
  
  inline def apply(): SchemaPublicDelegatedPrefixPublicDelegatedSubPrefix = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPublicDelegatedPrefixPublicDelegatedSubPrefix]
  }
  
  extension [Self <: SchemaPublicDelegatedPrefixPublicDelegatedSubPrefix](x: Self) {
    
    inline def setDelegateeProject(value: String): Self = StObject.set(x, "delegateeProject", value.asInstanceOf[js.Any])
    
    inline def setDelegateeProjectNull: Self = StObject.set(x, "delegateeProject", null)
    ...
    inline def setIsAddressNull: Self = StObject.set(x, "isAddress", null)
