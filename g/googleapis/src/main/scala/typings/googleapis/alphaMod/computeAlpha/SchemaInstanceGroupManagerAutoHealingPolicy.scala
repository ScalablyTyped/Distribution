...
trait SchemaInstanceGroupManagerAutoHealingPolicy extends StObject {
  ...
  /**
    ...
    */
  var autoHealingTriggers: js.UndefOr[SchemaInstanceGroupManagerAutoHealingPolicyAutoHealingTriggers] = js.undefined
...
object SchemaInstanceGroupManagerAutoHealingPolicy {
  ...
  extension [Self <: SchemaInstanceGroupManagerAutoHealingPolicy](x: Self) {
    ...
    inline def setAutoHealingTriggers(value: SchemaInstanceGroupManagerAutoHealingPolicyAutoHealingTriggers): Self = StObject.set(x, "autoHealingTriggers", value.asInstanceOf[js.Any])
    
    inline def setAutoHealingTriggersUndefined: Self = StObject.set(x, "autoHealingTriggers", js.undefined)
