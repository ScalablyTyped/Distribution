...
object ParamsResourceDisksInsert {
  ...
  @scala.inline
  def apply(): ParamsResourceDisksInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceDisksInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceDisksInsertMutableBuilder[Self <: ParamsResourceDisksInsert] (val x: Self) extends AnyVal {
