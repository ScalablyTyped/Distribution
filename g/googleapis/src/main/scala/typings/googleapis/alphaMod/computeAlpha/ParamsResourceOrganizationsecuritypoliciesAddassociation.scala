...
object ParamsResourceOrganizationsecuritypoliciesAddassociation {
  ...
  implicit class ParamsResourceOrganizationsecuritypoliciesAddassociationOps[Self <: ParamsResourceOrganizationsecuritypoliciesAddassociation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplaceExistingAssociation(value: Boolean): Self = this.set("replaceExistingAssociation", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteReplaceExistingAssociation: Self = this.set("replaceExistingAssociation", js.undefined)
    
    @scala.inline
    def setRequestBody(value: SchemaSecurityPolicyAssociation): Self = this.set("requestBody", value.asInstanceOf[js.Any])
