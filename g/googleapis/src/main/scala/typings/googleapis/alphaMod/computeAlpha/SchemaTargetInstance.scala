...
object SchemaTargetInstance {
  ...
  @scala.inline
  def apply(): SchemaTargetInstance = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaTargetInstance]
  }
  
  @scala.inline
  implicit class SchemaTargetInstanceMutableBuilder[Self <: SchemaTargetInstance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNatPolicy(value: String): Self = StObject.set(x, "natPolicy", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNatPolicyUndefined: Self = StObject.set(x, "natPolicy", js.undefined)
