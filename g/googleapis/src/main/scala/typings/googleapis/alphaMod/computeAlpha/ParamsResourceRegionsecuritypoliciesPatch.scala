...
trait ParamsResourceRegionsecuritypoliciesPatch
  extends StObject
...
object ParamsResourceRegionsecuritypoliciesPatch {
  
  inline def apply(): ParamsResourceRegionsecuritypoliciesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionsecuritypoliciesPatch]
  }
  
  extension [Self <: ParamsResourceRegionsecuritypoliciesPatch](x: Self) {
