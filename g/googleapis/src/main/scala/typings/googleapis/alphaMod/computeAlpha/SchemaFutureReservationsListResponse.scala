...
trait SchemaFutureReservationsListResponse extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaFutureReservation]] = js.undefined
...
object SchemaFutureReservationsListResponse {
  
  inline def apply(): SchemaFutureReservationsListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaFutureReservationsListResponse]
  }
  
  extension [Self <: SchemaFutureReservationsListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaFutureReservation]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaFutureReservation*): Self = StObject.set(x, "items", js.Array(value*))
