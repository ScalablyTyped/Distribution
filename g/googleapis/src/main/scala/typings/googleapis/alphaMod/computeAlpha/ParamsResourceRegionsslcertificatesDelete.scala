...
trait ParamsResourceRegionsslcertificatesDelete
  extends StObject
...
object ParamsResourceRegionsslcertificatesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceRegionsslcertificatesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionsslcertificatesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceRegionsslcertificatesDeleteMutableBuilder[Self <: ParamsResourceRegionsslcertificatesDelete] (val x: Self) extends AnyVal {
