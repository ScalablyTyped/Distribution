...
trait ParamsResourceInstancetemplatesDelete
  extends StObject
...
object ParamsResourceInstancetemplatesDelete {
  ...
  inline def apply(): ParamsResourceInstancetemplatesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancetemplatesDelete]
  }
  
  extension [Self <: ParamsResourceInstancetemplatesDelete](x: Self) {
