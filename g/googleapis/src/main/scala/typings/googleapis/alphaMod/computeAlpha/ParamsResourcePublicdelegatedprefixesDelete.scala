...
trait ParamsResourcePublicdelegatedprefixesDelete
  extends StObject
...
object ParamsResourcePublicdelegatedprefixesDelete {
  
  inline def apply(): ParamsResourcePublicdelegatedprefixesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePublicdelegatedprefixesDelete]
  }
  
  extension [Self <: ParamsResourcePublicdelegatedprefixesDelete](x: Self) {
