...
object SchemaPermission {
  ...
  extension [Self <: SchemaPermission](x: Self) {
    ...
    inline def setConstraintsVarargs(value: SchemaPermissionConstraint*): Self = StObject.set(x, "constraints", js.Array(value :_*))
    ...
    inline def setNotHostsVarargs(value: String*): Self = StObject.set(x, "notHosts", js.Array(value :_*))
    ...
    inline def setNotMethodsVarargs(value: String*): Self = StObject.set(x, "notMethods", js.Array(value :_*))
    ...
    inline def setNotPathsVarargs(value: String*): Self = StObject.set(x, "notPaths", js.Array(value :_*))
    ...
    inline def setNotPortsVarargs(value: String*): Self = StObject.set(x, "notPorts", js.Array(value :_*))
