...
trait SchemaInstanceGroupManagerActionsSummary extends StObject {
  ...
  /**
    ...
    */
  var creatingAtomically: js.UndefOr[Double | Null] = js.undefined
...
object SchemaInstanceGroupManagerActionsSummary {
  ...
  extension [Self <: SchemaInstanceGroupManagerActionsSummary](x: Self) {
    ...
    inline def setCreatingAtomically(value: Double): Self = StObject.set(x, "creatingAtomically", value.asInstanceOf[js.Any])
    
    inline def setCreatingAtomicallyNull: Self = StObject.set(x, "creatingAtomically", null)
    
    inline def setCreatingAtomicallyUndefined: Self = StObject.set(x, "creatingAtomically", js.undefined)
