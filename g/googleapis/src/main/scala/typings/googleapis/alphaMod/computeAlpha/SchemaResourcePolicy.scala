...
trait SchemaResourcePolicy extends StObject {
  ...
  /**
    ...
    */
  var diskConsistencyGroupPolicy: js.UndefOr[SchemaResourcePolicyDiskConsistencyGroupPolicy] = js.undefined
...
object SchemaResourcePolicy {
  ...
  extension [Self <: SchemaResourcePolicy](x: Self) {
    ...
    inline def setDiskConsistencyGroupPolicy(value: SchemaResourcePolicyDiskConsistencyGroupPolicy): Self = StObject.set(x, "diskConsistencyGroupPolicy", value.asInstanceOf[js.Any])
    
    inline def setDiskConsistencyGroupPolicyUndefined: Self = StObject.set(x, "diskConsistencyGroupPolicy", js.undefined)
