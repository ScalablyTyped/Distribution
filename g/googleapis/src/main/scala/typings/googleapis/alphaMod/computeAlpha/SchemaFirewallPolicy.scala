...
trait SchemaFirewallPolicy extends StObject {
  ...
  /**
    ...
    */
  var vpcNetworkScope: js.UndefOr[String | Null] = js.undefined
}
object SchemaFirewallPolicy {
  ...
  extension [Self <: SchemaFirewallPolicy](x: Self) {
    ...
    inline def setVpcNetworkScope(value: String): Self = StObject.set(x, "vpcNetworkScope", value.asInstanceOf[js.Any])
    
    inline def setVpcNetworkScopeNull: Self = StObject.set(x, "vpcNetworkScope", null)
    
    inline def setVpcNetworkScopeUndefined: Self = StObject.set(x, "vpcNetworkScope", js.undefined)
  }
}
