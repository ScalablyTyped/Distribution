...
object SchemaNetworkInterface {
  ...
  implicit class SchemaNetworkInterfaceMutableBuilder[Self <: SchemaNetworkInterface] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAliasIpRanges(value: js.Array[SchemaAliasIpRange]): Self = StObject.set(x, "aliasIpRanges", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAliasIpRangesUndefined: Self = StObject.set(x, "aliasIpRanges", js.undefined)
    
    @scala.inline
    def setAliasIpRangesVarargs(value: SchemaAliasIpRange*): Self = StObject.set(x, "aliasIpRanges", js.Array(value :_*))
