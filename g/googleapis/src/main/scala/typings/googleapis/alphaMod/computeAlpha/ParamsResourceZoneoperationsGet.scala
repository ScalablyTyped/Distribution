...
@js.native
trait ParamsResourceZoneoperationsGet extends StandardParameters {
...
object ParamsResourceZoneoperationsGet {
  ...
  @scala.inline
  implicit class ParamsResourceZoneoperationsGetOps[Self <: ParamsResourceZoneoperationsGet] (val x: Self) extends AnyVal {
