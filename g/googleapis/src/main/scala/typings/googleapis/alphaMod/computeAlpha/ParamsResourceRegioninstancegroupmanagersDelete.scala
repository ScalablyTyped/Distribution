...
@js.native
trait ParamsResourceRegioninstancegroupmanagersDelete extends StandardParameters {
...
object ParamsResourceRegioninstancegroupmanagersDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceRegioninstancegroupmanagersDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegioninstancegroupmanagersDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceRegioninstancegroupmanagersDeleteMutableBuilder[Self <: ParamsResourceRegioninstancegroupmanagersDelete] (val x: Self) extends AnyVal {
