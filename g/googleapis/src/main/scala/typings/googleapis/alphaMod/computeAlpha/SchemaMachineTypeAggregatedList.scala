...
trait SchemaMachineTypeAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaMachineTypesScopedList] | Null] = js.undefined
...
object SchemaMachineTypeAggregatedList {
  ...
  inline def apply(): SchemaMachineTypeAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaMachineTypeAggregatedList]
  }
  
  extension [Self <: SchemaMachineTypeAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaMachineTypesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
