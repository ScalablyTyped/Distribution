...
trait SchemaAcceleratorTypeAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaAcceleratorTypesScopedList] | Null] = js.undefined
...
object SchemaAcceleratorTypeAggregatedList {
  ...
  inline def apply(): SchemaAcceleratorTypeAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAcceleratorTypeAggregatedList]
  }
  
  extension [Self <: SchemaAcceleratorTypeAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaAcceleratorTypesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
