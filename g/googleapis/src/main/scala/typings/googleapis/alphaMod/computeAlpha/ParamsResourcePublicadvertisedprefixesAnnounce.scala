...
trait ParamsResourcePublicadvertisedprefixesAnnounce
  extends StObject
...
object ParamsResourcePublicadvertisedprefixesAnnounce {
  
  inline def apply(): ParamsResourcePublicadvertisedprefixesAnnounce = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePublicadvertisedprefixesAnnounce]
  }
  
  extension [Self <: ParamsResourcePublicadvertisedprefixesAnnounce](x: Self) {
