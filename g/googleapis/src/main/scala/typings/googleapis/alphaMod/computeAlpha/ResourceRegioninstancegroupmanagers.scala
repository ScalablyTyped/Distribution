...
class ResourceRegioninstancegroupmanagers protected () extends js.Object {
  ...
  def listPerInstanceConfigs(params: js.UndefOr[scala.Nothing], options: MethodOptions): GaxiosPromise[SchemaRegionInstanceGroupManagersListInstanceConfigsResp] = js.native
