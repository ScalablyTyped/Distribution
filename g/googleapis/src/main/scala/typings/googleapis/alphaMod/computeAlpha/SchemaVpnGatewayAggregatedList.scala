...
trait SchemaVpnGatewayAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaVpnGatewaysScopedList] | Null] = js.undefined
...
object SchemaVpnGatewayAggregatedList {
  ...
  inline def apply(): SchemaVpnGatewayAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaVpnGatewayAggregatedList]
  }
  
  extension [Self <: SchemaVpnGatewayAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaVpnGatewaysScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
