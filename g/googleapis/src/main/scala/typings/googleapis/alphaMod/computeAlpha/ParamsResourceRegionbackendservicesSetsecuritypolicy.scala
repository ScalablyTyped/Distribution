...
trait ParamsResourceRegionbackendservicesSetsecuritypolicy
  extends StObject
...
object ParamsResourceRegionbackendservicesSetsecuritypolicy {
  
  inline def apply(): ParamsResourceRegionbackendservicesSetsecuritypolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionbackendservicesSetsecuritypolicy]
  }
  
  extension [Self <: ParamsResourceRegionbackendservicesSetsecuritypolicy](x: Self) {
