...
trait ParamsResourceRegioninstancegroupmanagersListerrors
  extends StObject
...
object ParamsResourceRegioninstancegroupmanagersListerrors {
  
  inline def apply(): ParamsResourceRegioninstancegroupmanagersListerrors = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegioninstancegroupmanagersListerrors]
  }
  
  extension [Self <: ParamsResourceRegioninstancegroupmanagersListerrors](x: Self) {
