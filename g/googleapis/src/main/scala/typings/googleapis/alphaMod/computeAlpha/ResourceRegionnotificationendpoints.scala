...
open class ResourceRegionnotificationendpoints protected () extends StObject {
  ...
  def aggregatedList(): GaxiosPromise[SchemaNotificationEndpointAggregatedList] = js.native
  def aggregatedList(callback: BodyResponseCallback[SchemaNotificationEndpointAggregatedList]): Unit = js.native
  def aggregatedList(params: Unit, options: MethodOptions): GaxiosPromise[SchemaNotificationEndpointAggregatedList] = js.native
  def aggregatedList(params: ParamsResourceRegionnotificationendpointsAggregatedlist): GaxiosPromise[SchemaNotificationEndpointAggregatedList] = js.native
  def aggregatedList(
    params: ParamsResourceRegionnotificationendpointsAggregatedlist,
    callback: BodyResponseCallback[SchemaNotificationEndpointAggregatedList]
  ): Unit = js.native
  def aggregatedList(
    params: ParamsResourceRegionnotificationendpointsAggregatedlist,
    options: BodyResponseCallback[Readable | SchemaNotificationEndpointAggregatedList],
    callback: BodyResponseCallback[Readable | SchemaNotificationEndpointAggregatedList]
  ): Unit = js.native
  def aggregatedList(params: ParamsResourceRegionnotificationendpointsAggregatedlist, options: MethodOptions): GaxiosPromise[SchemaNotificationEndpointAggregatedList] = js.native
  def aggregatedList(
    params: ParamsResourceRegionnotificationendpointsAggregatedlist,
  ...
  /**
    ...
    */
  def aggregatedList(params: ParamsResourceRegionnotificationendpointsAggregatedlist, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def aggregatedList(
    params: ParamsResourceRegionnotificationendpointsAggregatedlist,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def testIamPermissions(params: ParamsResourceRegionnotificationendpointsTestiampermissions, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def testIamPermissions(
    params: ParamsResourceRegionnotificationendpointsTestiampermissions,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
