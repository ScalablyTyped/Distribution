...
trait ParamsResourceInstancegroupmanagerresizerequestsList
  extends StObject
...
object ParamsResourceInstancegroupmanagerresizerequestsList {
  
  inline def apply(): ParamsResourceInstancegroupmanagerresizerequestsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancegroupmanagerresizerequestsList]
  }
  
  extension [Self <: ParamsResourceInstancegroupmanagerresizerequestsList](x: Self) {
