...
object SchemaPrincipal {
  ...
  extension [Self <: SchemaPrincipal](x: Self) {
    ...
    inline def setNotGroupsVarargs(value: String*): Self = StObject.set(x, "notGroups", js.Array(value :_*))
    ...
    inline def setNotIpsVarargs(value: String*): Self = StObject.set(x, "notIps", js.Array(value :_*))
    ...
    inline def setNotNamespacesVarargs(value: String*): Self = StObject.set(x, "notNamespaces", js.Array(value :_*))
    ...
    inline def setNotUsersVarargs(value: String*): Self = StObject.set(x, "notUsers", js.Array(value :_*))
