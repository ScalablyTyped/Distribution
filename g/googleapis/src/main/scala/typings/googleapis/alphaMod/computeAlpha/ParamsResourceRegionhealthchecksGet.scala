...
object ParamsResourceRegionhealthchecksGet {
  ...
  @scala.inline
  def apply(): ParamsResourceRegionhealthchecksGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionhealthchecksGet]
  }
  
  @scala.inline
  implicit class ParamsResourceRegionhealthchecksGetMutableBuilder[Self <: ParamsResourceRegionhealthchecksGet] (val x: Self) extends AnyVal {
