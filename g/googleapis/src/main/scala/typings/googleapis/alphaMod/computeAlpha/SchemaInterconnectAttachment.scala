...
trait SchemaInterconnectAttachment extends StObject {
  ...
  /**
    ...
    */
  var configurationConstraints: js.UndefOr[SchemaInterconnectAttachmentConfigurationConstraints] = js.undefined
  ...
  /**
    ...
    */
  var subnetLength: js.UndefOr[Double | Null] = js.undefined
...
object SchemaInterconnectAttachment {
  ...
  extension [Self <: SchemaInterconnectAttachment](x: Self) {
    ...
    inline def setConfigurationConstraints(value: SchemaInterconnectAttachmentConfigurationConstraints): Self = StObject.set(x, "configurationConstraints", value.asInstanceOf[js.Any])
    
    inline def setConfigurationConstraintsUndefined: Self = StObject.set(x, "configurationConstraints", js.undefined)
    ...
    inline def setSubnetLength(value: Double): Self = StObject.set(x, "subnetLength", value.asInstanceOf[js.Any])
    
    inline def setSubnetLengthNull: Self = StObject.set(x, "subnetLength", null)
    
    inline def setSubnetLengthUndefined: Self = StObject.set(x, "subnetLength", js.undefined)
