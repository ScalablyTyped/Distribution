...
trait SchemaSecurityPolicy extends StObject {
  ...
  var cloudArmorConfig: js.UndefOr[SchemaSecurityPolicyCloudArmorConfig] = js.undefined
...
object SchemaSecurityPolicy {
  ...
  extension [Self <: SchemaSecurityPolicy](x: Self) {
    ...
    inline def setCloudArmorConfig(value: SchemaSecurityPolicyCloudArmorConfig): Self = StObject.set(x, "cloudArmorConfig", value.asInstanceOf[js.Any])
    
    inline def setCloudArmorConfigUndefined: Self = StObject.set(x, "cloudArmorConfig", js.undefined)
