...
object ParamsResourceInstancegroupmanagersSetinstancetemplate {
  ...
  @scala.inline
  implicit class ParamsResourceInstancegroupmanagersSetinstancetemplateOps[Self <: ParamsResourceInstancegroupmanagersSetinstancetemplate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaInstanceGroupManagersSetInstanceTemplateRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
