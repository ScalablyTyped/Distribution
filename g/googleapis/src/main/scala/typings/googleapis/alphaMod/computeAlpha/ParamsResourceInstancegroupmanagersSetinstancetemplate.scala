...
object ParamsResourceInstancegroupmanagersSetinstancetemplate {
  ...
  @scala.inline
  def apply(): ParamsResourceInstancegroupmanagersSetinstancetemplate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancegroupmanagersSetinstancetemplate]
  }
  
  @scala.inline
  implicit class ParamsResourceInstancegroupmanagersSetinstancetemplateMutableBuilder[Self <: ParamsResourceInstancegroupmanagersSetinstancetemplate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaInstanceGroupManagersSetInstanceTemplateRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
