...
object ParamsResourceInstancegroupmanagersSetinstancetemplate {
  ...
  inline def apply(): ParamsResourceInstancegroupmanagersSetinstancetemplate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancegroupmanagersSetinstancetemplate]
  }
  
  extension [Self <: ParamsResourceInstancegroupmanagersSetinstancetemplate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaInstanceGroupManagersSetInstanceTemplateRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
