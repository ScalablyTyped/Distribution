...
trait SchemaHTTP2HealthCheck extends StObject {
  ...
  /**
    ...
    */
  var weightReportMode: js.UndefOr[String | Null] = js.undefined
}
object SchemaHTTP2HealthCheck {
  ...
  extension [Self <: SchemaHTTP2HealthCheck](x: Self) {
    ...
    inline def setWeightReportMode(value: String): Self = StObject.set(x, "weightReportMode", value.asInstanceOf[js.Any])
    
    inline def setWeightReportModeNull: Self = StObject.set(x, "weightReportMode", null)
    
    inline def setWeightReportModeUndefined: Self = StObject.set(x, "weightReportMode", js.undefined)
  }
}
