...
open class ResourceInterconnects protected () extends StObject {
  ...
  /**
    ...
    *   //   "remoteLocation": "my_remoteLocation",
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def getIamPolicy(params: ParamsResourceInterconnectsGetiampolicy, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def getIamPolicy(
    params: ParamsResourceInterconnectsGetiampolicy,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def getMacsecConfig(): GaxiosPromise[SchemaInterconnectsGetMacsecConfigResponse] = js.native
  def getMacsecConfig(callback: BodyResponseCallback[SchemaInterconnectsGetMacsecConfigResponse]): Unit = js.native
  def getMacsecConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaInterconnectsGetMacsecConfigResponse] = js.native
  def getMacsecConfig(params: ParamsResourceInterconnectsGetmacsecconfig): GaxiosPromise[SchemaInterconnectsGetMacsecConfigResponse] = js.native
  def getMacsecConfig(
    params: ParamsResourceInterconnectsGetmacsecconfig,
    callback: BodyResponseCallback[SchemaInterconnectsGetMacsecConfigResponse]
  ): Unit = js.native
  def getMacsecConfig(
    params: ParamsResourceInterconnectsGetmacsecconfig,
    options: BodyResponseCallback[Readable | SchemaInterconnectsGetMacsecConfigResponse],
    callback: BodyResponseCallback[Readable | SchemaInterconnectsGetMacsecConfigResponse]
  ): Unit = js.native
  def getMacsecConfig(params: ParamsResourceInterconnectsGetmacsecconfig, options: MethodOptions): GaxiosPromise[SchemaInterconnectsGetMacsecConfigResponse] = js.native
  def getMacsecConfig(
    params: ParamsResourceInterconnectsGetmacsecconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaInterconnectsGetMacsecConfigResponse]
  ...
  /**
    ...
    *
    *   // Do the magic
    *   const res = await compute.interconnects.getMacsecConfig({
    *     // Name of the interconnect resource to query.
    *     interconnect: '[a-z](?:[-a-z0-9]{0,61}[a-z0-9])?|[1-9][0-9]{0,19}',
    *     // Project ID for this request.
    *     project:
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def getMacsecConfig(params: ParamsResourceInterconnectsGetmacsecconfig, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def getMacsecConfig(
    params: ParamsResourceInterconnectsGetmacsecconfig,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def setIamPolicy(params: ParamsResourceInterconnectsSetiampolicy, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def setIamPolicy(
    params: ParamsResourceInterconnectsSetiampolicy,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
