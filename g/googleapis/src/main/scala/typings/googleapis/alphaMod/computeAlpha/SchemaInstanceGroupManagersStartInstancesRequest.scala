...
trait SchemaInstanceGroupManagersStartInstancesRequest extends StObject {
...
object SchemaInstanceGroupManagersStartInstancesRequest {
  
  inline def apply(): SchemaInstanceGroupManagersStartInstancesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInstanceGroupManagersStartInstancesRequest]
  }
  
  extension [Self <: SchemaInstanceGroupManagersStartInstancesRequest](x: Self) {
