...
trait ParamsResourceZonequeuedresourcesCancel
  extends StObject
...
object ParamsResourceZonequeuedresourcesCancel {
  
  inline def apply(): ParamsResourceZonequeuedresourcesCancel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceZonequeuedresourcesCancel]
  }
  
  extension [Self <: ParamsResourceZonequeuedresourcesCancel](x: Self) {
