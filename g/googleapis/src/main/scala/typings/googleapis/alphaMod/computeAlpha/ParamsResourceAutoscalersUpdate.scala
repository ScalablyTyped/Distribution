...
trait ParamsResourceAutoscalersUpdate
  extends StObject
...
object ParamsResourceAutoscalersUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceAutoscalersUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAutoscalersUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceAutoscalersUpdateMutableBuilder[Self <: ParamsResourceAutoscalersUpdate] (val x: Self) extends AnyVal {
