...
trait ParamsResourcePublicadvertisedprefixesDelete
  extends StObject
...
object ParamsResourcePublicadvertisedprefixesDelete {
  
  inline def apply(): ParamsResourcePublicadvertisedprefixesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePublicadvertisedprefixesDelete]
  }
  
  extension [Self <: ParamsResourcePublicadvertisedprefixesDelete](x: Self) {
