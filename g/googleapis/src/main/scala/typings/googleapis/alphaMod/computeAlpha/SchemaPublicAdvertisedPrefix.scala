...
trait SchemaPublicAdvertisedPrefix extends StObject {
  ...
  /**
    ...
    */
  var pdpScope: js.UndefOr[String | Null] = js.undefined
...
object SchemaPublicAdvertisedPrefix {
  ...
  extension [Self <: SchemaPublicAdvertisedPrefix](x: Self) {
    ...
    inline def setPdpScope(value: String): Self = StObject.set(x, "pdpScope", value.asInstanceOf[js.Any])
    
    inline def setPdpScopeNull: Self = StObject.set(x, "pdpScope", null)
    
    inline def setPdpScopeUndefined: Self = StObject.set(x, "pdpScope", js.undefined)
