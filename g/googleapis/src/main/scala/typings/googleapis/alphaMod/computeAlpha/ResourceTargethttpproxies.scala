...
@js.native
open class ResourceTargethttpproxies protected () extends StObject {
  ...
  def aggregatedList(params: Unit, options: MethodOptions): GaxiosPromise[SchemaTargetHttpProxyAggregatedList] = js.native
  ...
  def aggregatedList(
    params: ParamsResourceTargethttpproxiesAggregatedlist,
    options: BodyResponseCallback[Readable | SchemaTargetHttpProxyAggregatedList],
    callback: BodyResponseCallback[Readable | SchemaTargetHttpProxyAggregatedList]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def aggregatedList(params: ParamsResourceTargethttpproxiesAggregatedlist, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def aggregatedList(
    params: ParamsResourceTargethttpproxiesAggregatedlist,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def delete(params: ParamsResourceTargethttpproxiesDelete, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def delete(
    params: ParamsResourceTargethttpproxiesDelete,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def get(
    ...
    options: BodyResponseCallback[Readable | SchemaTargetHttpProxy],
    callback: BodyResponseCallback[Readable | SchemaTargetHttpProxy]
  ): Unit = js.native
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def get(params: ParamsResourceTargethttpproxiesGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceTargethttpproxiesGet,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def insert(params: ParamsResourceTargethttpproxiesInsert, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def insert(
    params: ParamsResourceTargethttpproxiesInsert,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def list(
    params: ParamsResourceTargethttpproxiesList,
    options: BodyResponseCallback[Readable | SchemaTargetHttpProxyList],
    callback: BodyResponseCallback[Readable | SchemaTargetHttpProxyList]
  ): Unit = js.native
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceTargethttpproxiesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceTargethttpproxiesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def patch(params: ParamsResourceTargethttpproxiesPatch): GaxiosPromise[SchemaOperation] = js.native
  def patch(params: ParamsResourceTargethttpproxiesPatch, callback: BodyResponseCallback[SchemaOperation]): Unit = js.native
  def patch(
    params: ParamsResourceTargethttpproxiesPatch,
    options: BodyResponseCallback[Readable | SchemaOperation],
    callback: BodyResponseCallback[Readable | SchemaOperation]
  ): Unit = js.native
  def patch(params: ParamsResourceTargethttpproxiesPatch, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def patch(
    params: ParamsResourceTargethttpproxiesPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  /**
    ...
    *
    *   // Do the magic
    *   const res = await compute.targetHttpProxies.patch({
    *     // Project ID for this request.
    *     project:
    *       '(?:(?:[-a-z0-9]{1,63}.)*(?:[a-z](?:[-a-z0-9]{0,61}[a-z0-9])?):)?(?:[0-9]{1,19}|(?:[a-z0-9](?:[-a-z0-9]{0,61}[a-z0-9])?))',
    *     // An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def patch(params: ParamsResourceTargethttpproxiesPatch, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def patch(
    params: ParamsResourceTargethttpproxiesPatch,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def setUrlMap(params: ParamsResourceTargethttpproxiesSeturlmap, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def setUrlMap(
    params: ParamsResourceTargethttpproxiesSeturlmap,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def testIamPermissions(params: ParamsResourceTargethttpproxiesTestiampermissions, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def testIamPermissions(
    params: ParamsResourceTargethttpproxiesTestiampermissions,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
