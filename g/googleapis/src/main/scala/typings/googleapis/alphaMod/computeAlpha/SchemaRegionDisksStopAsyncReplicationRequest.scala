...
trait SchemaRegionDisksStopAsyncReplicationRequest extends StObject {
...
object SchemaRegionDisksStopAsyncReplicationRequest {
  
  inline def apply(): SchemaRegionDisksStopAsyncReplicationRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRegionDisksStopAsyncReplicationRequest]
  }
  
  extension [Self <: SchemaRegionDisksStopAsyncReplicationRequest](x: Self) {
