...
trait SchemaBackendBucketCdnPolicy extends StObject {
  ...
  /**
    ...
    */
  var bypassCacheOnRequestHeaders: js.UndefOr[js.Array[SchemaBackendBucketCdnPolicyBypassCacheOnRequestHeader]] = js.undefined
  
  /**
    * The CacheKeyPolicy for this CdnPolicy.
    */
  var cacheKeyPolicy: js.UndefOr[SchemaBackendBucketCdnPolicyCacheKeyPolicy] = js.undefined
  ...
  /**
    ...
    */
  var cacheMode: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var negativeCaching: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * Sets a cache TTL for the specified HTTP status code. negative_caching must be enabled to configure negative_caching_policy. Omitting the policy and leaving negative_caching enabled will use Cloud CDN's default cache TTLs. Note that when specifying an explicit negative_caching_policy, you should take care to specify a cache TTL for all response codes that you wish to cache. Cloud CDN will not apply any default negative caching when a policy exists.
    */
  var negativeCachingPolicy: js.UndefOr[js.Array[SchemaBackendBucketCdnPolicyNegativeCachingPolicy]] = js.undefined
  
  /**
    * If true then Cloud CDN will combine multiple concurrent cache fill requests into a small number of requests to the origin.
    */
  var requestCoalescing: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * Serve existing content from the cache (if available) when revalidating content with the origin, or when an error is encountered when refreshing the cache. This setting defines the default "max-stale" duration for any cached responses that do not specify a max-stale directive. Stale responses that exceed the TTL configured here will not be served. The default limit (max-stale) is 86400s (1 day), which will allow stale content to be served up to this limit beyond the max-age (or s-max-age) of a cached response. The maximum allowed value is 604800 (1 week). Set this to zero (0) to disable serve-while-stale.
    */
  var serveWhileStale: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * Maximum number of seconds the response to a signed URL request will be considered fresh. After this time period, the response will be revalidated before being served. Defaults to 1hr (3600s). When serving responses to signed URL requests, Cloud CDN will internally behave as though all responses from this backend had a "Cache-Control: public, max-age=[TTL]" header, regardless of any existing Cache-Control header. The actual headers served in responses will not be altered.
    */
  var signedUrlCacheMaxAgeSec: js.UndefOr[String | Null] = js.undefined
  
  /**
    * [Output Only] Names of the keys for signing request URLs.
    */
  var signedUrlKeyNames: js.UndefOr[js.Array[String] | Null] = js.undefined
}
object SchemaBackendBucketCdnPolicy {
  ...
  extension [Self <: SchemaBackendBucketCdnPolicy](x: Self) {
    ...
    inline def setBypassCacheOnRequestHeaders(value: js.Array[SchemaBackendBucketCdnPolicyBypassCacheOnRequestHeader]): Self = StObject.set(x, "bypassCacheOnRequestHeaders", value.asInstanceOf[js.Any])
    
    inline def setBypassCacheOnRequestHeadersUndefined: Self = StObject.set(x, "bypassCacheOnRequestHeaders", js.undefined)
    
    inline def setBypassCacheOnRequestHeadersVarargs(value: SchemaBackendBucketCdnPolicyBypassCacheOnRequestHeader*): Self = StObject.set(x, "bypassCacheOnRequestHeaders", js.Array(value*))
    
    inline def setCacheKeyPolicy(value: SchemaBackendBucketCdnPolicyCacheKeyPolicy): Self = StObject.set(x, "cacheKeyPolicy", value.asInstanceOf[js.Any])
    ...
    inline def setCacheModeNull: Self = StObject.set(x, "cacheMode", null)
    ...
    inline def setClientTtlNull: Self = StObject.set(x, "clientTtl", null)
    ...
    inline def setDefaultTtlNull: Self = StObject.set(x, "defaultTtl", null)
    ...
    inline def setMaxTtlNull: Self = StObject.set(x, "maxTtl", null)
    ...
    inline def setNegativeCachingNull: Self = StObject.set(x, "negativeCaching", null)
    
    inline def setNegativeCachingPolicy(value: js.Array[SchemaBackendBucketCdnPolicyNegativeCachingPolicy]): Self = StObject.set(x, "negativeCachingPolicy", value.asInstanceOf[js.Any])
    
    inline def setNegativeCachingPolicyUndefined: Self = StObject.set(x, "negativeCachingPolicy", js.undefined)
    
    inline def setNegativeCachingPolicyVarargs(value: SchemaBackendBucketCdnPolicyNegativeCachingPolicy*): Self = StObject.set(x, "negativeCachingPolicy", js.Array(value*))
    ...
    inline def setRequestCoalescingNull: Self = StObject.set(x, "requestCoalescing", null)
    ...
    inline def setServeWhileStaleNull: Self = StObject.set(x, "serveWhileStale", null)
    ...
    inline def setSignedUrlCacheMaxAgeSecNull: Self = StObject.set(x, "signedUrlCacheMaxAgeSec", null)
    ...
    inline def setSignedUrlKeyNamesNull: Self = StObject.set(x, "signedUrlKeyNames", null)
