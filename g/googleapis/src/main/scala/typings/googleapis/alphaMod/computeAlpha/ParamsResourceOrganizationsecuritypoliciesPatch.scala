...
@js.native
trait ParamsResourceOrganizationsecuritypoliciesPatch extends StandardParameters {
...
object ParamsResourceOrganizationsecuritypoliciesPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceOrganizationsecuritypoliciesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsecuritypoliciesPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsecuritypoliciesPatchMutableBuilder[Self <: ParamsResourceOrganizationsecuritypoliciesPatch] (val x: Self) extends AnyVal {
