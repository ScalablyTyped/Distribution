...
trait ParamsResourcePublicdelegatedprefixesWithdraw
  extends StObject
...
object ParamsResourcePublicdelegatedprefixesWithdraw {
  
  inline def apply(): ParamsResourcePublicdelegatedprefixesWithdraw = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePublicdelegatedprefixesWithdraw]
  }
  
  extension [Self <: ParamsResourcePublicdelegatedprefixesWithdraw](x: Self) {
