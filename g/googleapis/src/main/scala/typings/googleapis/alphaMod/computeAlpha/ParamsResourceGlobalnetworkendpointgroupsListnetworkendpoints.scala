...
trait ParamsResourceGlobalnetworkendpointgroupsListnetworkendpoints
  extends StObject
...
object ParamsResourceGlobalnetworkendpointgroupsListnetworkendpoints {
  
  inline def apply(): ParamsResourceGlobalnetworkendpointgroupsListnetworkendpoints = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceGlobalnetworkendpointgroupsListnetworkendpoints]
  }
  
  extension [Self <: ParamsResourceGlobalnetworkendpointgroupsListnetworkendpoints](x: Self) {
