...
trait ParamsResourceInstantsnapshotsList
  extends StObject
...
object ParamsResourceInstantsnapshotsList {
  
  inline def apply(): ParamsResourceInstantsnapshotsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstantsnapshotsList]
  }
  
  extension [Self <: ParamsResourceInstantsnapshotsList](x: Self) {
