...
trait SchemaDiskInstantiationConfig extends StObject {
  ...
  /**
    ...
    */
  var customImage: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var instantiateFrom: js.UndefOr[String | Null] = js.undefined
}
object SchemaDiskInstantiationConfig {
  
  inline def apply(): SchemaDiskInstantiationConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDiskInstantiationConfig]
  }
  
  extension [Self <: SchemaDiskInstantiationConfig](x: Self) {
    ...
    inline def setCustomImageNull: Self = StObject.set(x, "customImage", null)
    ...
    inline def setInstantiateFromNull: Self = StObject.set(x, "instantiateFrom", null)
