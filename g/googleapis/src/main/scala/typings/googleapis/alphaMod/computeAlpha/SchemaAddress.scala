...
trait SchemaAddress extends StObject {
  ...
  /**
    ...
    */
  var ipv6EndpointType: js.UndefOr[String | Null] = js.undefined
...
object SchemaAddress {
  ...
  extension [Self <: SchemaAddress](x: Self) {
    ...
    inline def setIpv6EndpointType(value: String): Self = StObject.set(x, "ipv6EndpointType", value.asInstanceOf[js.Any])
    
    inline def setIpv6EndpointTypeNull: Self = StObject.set(x, "ipv6EndpointType", null)
    
    inline def setIpv6EndpointTypeUndefined: Self = StObject.set(x, "ipv6EndpointType", js.undefined)
