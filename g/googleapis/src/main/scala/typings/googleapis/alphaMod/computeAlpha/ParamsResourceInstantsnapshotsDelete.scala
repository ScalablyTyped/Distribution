...
trait ParamsResourceInstantsnapshotsDelete
  extends StObject
...
object ParamsResourceInstantsnapshotsDelete {
  
  inline def apply(): ParamsResourceInstantsnapshotsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstantsnapshotsDelete]
  }
  
  extension [Self <: ParamsResourceInstantsnapshotsDelete](x: Self) {
