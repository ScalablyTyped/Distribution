...
object ParamsResourceNetworkendpointgroupsAttachnetworkendpoints {
  ...
  @scala.inline
  implicit class ParamsResourceNetworkendpointgroupsAttachnetworkendpointsMutableBuilder[Self <: ParamsResourceNetworkendpointgroupsAttachnetworkendpoints] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaNetworkEndpointGroupsAttachEndpointsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
