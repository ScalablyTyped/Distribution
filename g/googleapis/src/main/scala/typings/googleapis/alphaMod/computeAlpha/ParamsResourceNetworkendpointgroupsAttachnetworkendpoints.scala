...
@js.native
trait ParamsResourceNetworkendpointgroupsAttachnetworkendpoints extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaNetworkEndpointGroupsAttachEndpointsRequest] = js.native
  /**
...
object ParamsResourceNetworkendpointgroupsAttachnetworkendpoints {
  @scala.inline
  def apply(): ParamsResourceNetworkendpointgroupsAttachnetworkendpoints = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNetworkendpointgroupsAttachnetworkendpoints]
  }
  @scala.inline
  implicit class ParamsResourceNetworkendpointgroupsAttachnetworkendpointsOps[Self <: ParamsResourceNetworkendpointgroupsAttachnetworkendpoints] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaNetworkEndpointGroupsAttachEndpointsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
