...
open class ResourceNodegroups protected () extends StObject {
  ...
  def simulateMaintenanceEvent(params: ParamsResourceNodegroupsSimulatemaintenanceevent): GaxiosPromise[SchemaOperation] = js.native
  def simulateMaintenanceEvent(
    params: ParamsResourceNodegroupsSimulatemaintenanceevent,
    callback: BodyResponseCallback[SchemaOperation]
  ): Unit = js.native
  def simulateMaintenanceEvent(
    params: ParamsResourceNodegroupsSimulatemaintenanceevent,
  ...
  def simulateMaintenanceEvent(params: ParamsResourceNodegroupsSimulatemaintenanceevent, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def simulateMaintenanceEvent(
    params: ParamsResourceNodegroupsSimulatemaintenanceevent,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def simulateMaintenanceEvent(params: ParamsResourceNodegroupsSimulatemaintenanceevent, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def simulateMaintenanceEvent(
    params: ParamsResourceNodegroupsSimulatemaintenanceevent,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
