...
trait SchemaAuditLogConfig extends StObject {
  ...
  /**
    ...
    */
  var ignoreChildExemptions: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaAuditLogConfig {
  ...
  extension [Self <: SchemaAuditLogConfig](x: Self) {
    ...
    inline def setIgnoreChildExemptionsNull: Self = StObject.set(x, "ignoreChildExemptions", null)
    
    inline def setIgnoreChildExemptionsUndefined: Self = StObject.set(x, "ignoreChildExemptions", js.undefined)
