...
trait SchemaNotificationEndpointAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaNotificationEndpointsScopedList] | Null] = js.undefined
...
object SchemaNotificationEndpointAggregatedList {
  
  inline def apply(): SchemaNotificationEndpointAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaNotificationEndpointAggregatedList]
  }
  
  extension [Self <: SchemaNotificationEndpointAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaNotificationEndpointsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
