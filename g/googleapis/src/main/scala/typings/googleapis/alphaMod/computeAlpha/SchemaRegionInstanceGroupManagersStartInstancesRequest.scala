...
trait SchemaRegionInstanceGroupManagersStartInstancesRequest extends StObject {
...
object SchemaRegionInstanceGroupManagersStartInstancesRequest {
  
  inline def apply(): SchemaRegionInstanceGroupManagersStartInstancesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRegionInstanceGroupManagersStartInstancesRequest]
  }
  
  extension [Self <: SchemaRegionInstanceGroupManagersStartInstancesRequest](x: Self) {
