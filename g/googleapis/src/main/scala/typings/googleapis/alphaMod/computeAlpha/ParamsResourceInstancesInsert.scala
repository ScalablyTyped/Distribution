...
object ParamsResourceInstancesInsert {
  ...
  implicit class ParamsResourceInstancesInsertOps[Self <: ParamsResourceInstancesInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaInstance): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSourceInstanceTemplate(value: String): Self = this.set("sourceInstanceTemplate", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSourceInstanceTemplate: Self = this.set("sourceInstanceTemplate", js.undefined)
    
    @scala.inline
    def setSourceMachineImage(value: String): Self = this.set("sourceMachineImage", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSourceMachineImage: Self = this.set("sourceMachineImage", js.undefined)
