...
@js.native
trait ParamsResourceInterconnectsDelete extends StandardParameters {
...
object ParamsResourceInterconnectsDelete {
  
  @scala.inline
  def apply(): ParamsResourceInterconnectsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInterconnectsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceInterconnectsDeleteMutableBuilder[Self <: ParamsResourceInterconnectsDelete] (val x: Self) extends AnyVal {
