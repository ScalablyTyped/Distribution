...
@js.native
class ResourceDollarProjectsDollarCatalogs protected () extends js.Object {
  ...
  def search(params: ParamsDollarResourceDollarProjectsDollarCatalogsDollarSearch): GaxiosPromise[Schema$GoogleCloudPrivatecatalogV1beta1SearchCatalogsResponse] = js.native
  def search(
    params: ParamsDollarResourceDollarProjectsDollarCatalogsDollarSearch,
  ...
  def search(params: ParamsDollarResourceDollarProjectsDollarCatalogsDollarSearch, options: MethodOptions): GaxiosPromise[Schema$GoogleCloudPrivatecatalogV1beta1SearchCatalogsResponse] = js.native
  def search(
    params: ParamsDollarResourceDollarProjectsDollarCatalogsDollarSearch,
