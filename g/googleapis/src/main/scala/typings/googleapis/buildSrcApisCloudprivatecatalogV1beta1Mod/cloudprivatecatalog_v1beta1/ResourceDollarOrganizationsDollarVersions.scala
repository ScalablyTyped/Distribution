...
@JSImport("googleapis/build/src/apis/cloudprivatecatalog/v1beta1", "cloudprivatecatalog_v1beta1.Resource$Organizations$Versions")
@js.native
class ResourceDollarOrganizationsDollarVersions protected () extends js.Object {
  ...
  def search(params: ParamsDollarResourceDollarOrganizationsDollarVersionsDollarSearch): GaxiosPromise[Schema$GoogleCloudPrivatecatalogV1beta1SearchVersionsResponse] = js.native
  def search(
    params: ParamsDollarResourceDollarOrganizationsDollarVersionsDollarSearch,
  ...
  def search(params: ParamsDollarResourceDollarOrganizationsDollarVersionsDollarSearch, options: MethodOptions): GaxiosPromise[Schema$GoogleCloudPrivatecatalogV1beta1SearchVersionsResponse] = js.native
  def search(
    params: ParamsDollarResourceDollarOrganizationsDollarVersionsDollarSearch,
