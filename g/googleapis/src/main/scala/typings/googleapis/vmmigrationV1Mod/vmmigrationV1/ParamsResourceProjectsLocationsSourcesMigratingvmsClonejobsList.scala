...
trait ParamsResourceProjectsLocationsSourcesMigratingvmsClonejobsList
  extends StObject
...
object ParamsResourceProjectsLocationsSourcesMigratingvmsClonejobsList {
  
  inline def apply(): ParamsResourceProjectsLocationsSourcesMigratingvmsClonejobsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsSourcesMigratingvmsClonejobsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsSourcesMigratingvmsClonejobsList](x: Self) {
