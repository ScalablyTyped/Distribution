...
@JSImport("googleapis/build/src/apis/vmmigration/v1", "vmmigration_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var groups: ResourceProjectsLocationsGroups = js.native
  ...
  var sources: ResourceProjectsLocationsSources = js.native
  
  var targetProjects: ResourceProjectsLocationsTargetprojects = js.native
}
