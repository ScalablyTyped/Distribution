...
trait ParamsResourceProjectsLocationsSourcesMigratingvmsList
  extends StObject
...
object ParamsResourceProjectsLocationsSourcesMigratingvmsList {
  
  inline def apply(): ParamsResourceProjectsLocationsSourcesMigratingvmsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsSourcesMigratingvmsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsSourcesMigratingvmsList](x: Self) {
