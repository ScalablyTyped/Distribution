...
trait SchemaComputeEngineTargetDefaults extends StObject {
...
object SchemaComputeEngineTargetDefaults {
  
  inline def apply(): SchemaComputeEngineTargetDefaults = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaComputeEngineTargetDefaults]
  }
  
  extension [Self <: SchemaComputeEngineTargetDefaults](x: Self) {
