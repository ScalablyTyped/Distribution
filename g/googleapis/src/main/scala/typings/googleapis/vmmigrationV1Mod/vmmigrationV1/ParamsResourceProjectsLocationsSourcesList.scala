...
trait ParamsResourceProjectsLocationsSourcesList
  extends StObject
...
object ParamsResourceProjectsLocationsSourcesList {
  
  inline def apply(): ParamsResourceProjectsLocationsSourcesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsSourcesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsSourcesList](x: Self) {
