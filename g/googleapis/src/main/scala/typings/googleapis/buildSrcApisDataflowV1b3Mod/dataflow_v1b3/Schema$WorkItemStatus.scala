...
/**
  ...
  */
@js.native
trait Schema$WorkItemStatus extends js.Object {
  /**
  ...
  /**
    ...
    */
  var counterUpdates: js.UndefOr[js.Array[Schema$CounterUpdate]] = js.native
  /**
    * See documentation of stop_position.
    */
  var dynamicSourceSplit: js.UndefOr[Schema$DynamicSourceSplit] = js.native
  /**
    ...
    * failed.
    */
  var errors: js.UndefOr[js.Array[Schema$Status]] = js.native
  /**
    * DEPRECATED in favor of counter_updates.
    */
  var metricUpdates: js.UndefOr[js.Array[Schema$MetricUpdate]] = js.native
  /**
    * DEPRECATED in favor of reported_progress.
    */
  var progress: js.UndefOr[Schema$ApproximateProgress] = js.native
  /**
  ...
  /**
    ...
    */
  var reportedProgress: js.UndefOr[Schema$ApproximateReportedProgress] = js.native
  /**
  ...
  /**
    ...
    */
  var sourceFork: js.UndefOr[Schema$SourceFork] = js.native
  /**
    * If the work item represented a SourceOperationRequest, and the work is
    * completed, contains the result of the operation.
    */
  var sourceOperationResponse: js.UndefOr[Schema$SourceOperationResponse] = js.native
  /**
    ...
    */
  var stopPosition: js.UndefOr[Schema$Position] = js.native
  /**
...
object Schema$WorkItemStatus {
  @scala.inline
  def apply(
    completed: js.UndefOr[Boolean] = js.undefined,
    counterUpdates: js.Array[Schema$CounterUpdate] = null,
    dynamicSourceSplit: Schema$DynamicSourceSplit = null,
    errors: js.Array[Schema$Status] = null,
    metricUpdates: js.Array[Schema$MetricUpdate] = null,
    progress: Schema$ApproximateProgress = null,
    reportIndex: String = null,
    reportedProgress: Schema$ApproximateReportedProgress = null,
    requestedLeaseDuration: String = null,
    sourceFork: Schema$SourceFork = null,
    sourceOperationResponse: Schema$SourceOperationResponse = null,
    stopPosition: Schema$Position = null,
    totalThrottlerWaitTimeSeconds: Int | Double = null,
    workItemId: String = null
  ): Schema$WorkItemStatus = {
    ...
    __obj.asInstanceOf[Schema$WorkItemStatus]
  }
}
