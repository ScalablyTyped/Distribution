...
@js.native
trait ParamsDollarResourceDollarProjectsDollarTemplatesDollarLaunch extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$LaunchTemplateParameters] = js.native
  /**
