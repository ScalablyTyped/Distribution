...
/**
  ...
  */
@js.native
trait Schema$ApproximateReportedProgress extends js.Object {
  /**
    ...
    */
  var consumedParallelism: js.UndefOr[Schema$ReportedParallelism] = js.native
  /**
  ...
  /**
    ...
    */
  var remainingParallelism: js.UndefOr[Schema$ReportedParallelism] = js.native
}

object Schema$ApproximateReportedProgress {
  @scala.inline
  def apply(
    consumedParallelism: Schema$ReportedParallelism = null,
    fractionConsumed: Int | Double = null,
    position: Schema$Position = null,
    remainingParallelism: Schema$ReportedParallelism = null
  ): Schema$ApproximateReportedProgress = {
    ...
    __obj.asInstanceOf[Schema$ApproximateReportedProgress]
  }
}
