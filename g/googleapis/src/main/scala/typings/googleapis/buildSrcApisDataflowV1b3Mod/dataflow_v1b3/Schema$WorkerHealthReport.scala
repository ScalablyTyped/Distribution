...
/**
  ...
  */
@js.native
trait Schema$WorkerHealthReport extends js.Object {
  /**
...
object Schema$WorkerHealthReport {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$WorkerHealthReport]
  }
}
