...
/**
  ...
  */
@js.native
trait Schema$ExecutionStageState extends js.Object {
  /**
...
object Schema$ExecutionStageState {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$ExecutionStageState]
  }
}
