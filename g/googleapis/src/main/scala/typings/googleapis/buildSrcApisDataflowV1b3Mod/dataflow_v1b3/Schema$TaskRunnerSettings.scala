...
/**
  ...
  */
@js.native
trait Schema$TaskRunnerSettings extends js.Object {
  /**
  ...
  /**
    ...
    */
  var parallelWorkerSettings: js.UndefOr[Schema$WorkerSettings] = js.native
  /**
...
object Schema$TaskRunnerSettings {
  @scala.inline
  def apply(
    ...
    parallelWorkerSettings: Schema$WorkerSettings = null,
    ...
    __obj.asInstanceOf[Schema$TaskRunnerSettings]
  }
}
