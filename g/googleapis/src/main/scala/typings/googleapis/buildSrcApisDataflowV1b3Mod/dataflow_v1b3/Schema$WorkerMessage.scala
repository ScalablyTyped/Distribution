...
/**
  ...
  */
@js.native
trait Schema$WorkerMessage extends js.Object {
  /**
  ...
  /**
    ...
    */
  var workerHealthReport: js.UndefOr[Schema$WorkerHealthReport] = js.native
  /**
    * Record of worker lifecycle events.
    */
  var workerLifecycleEvent: js.UndefOr[Schema$WorkerLifecycleEvent] = js.native
  /**
    * A worker message code.
    */
  var workerMessageCode: js.UndefOr[Schema$WorkerMessageCode] = js.native
  /**
    * Resource metrics reported by workers.
    */
  var workerMetrics: js.UndefOr[Schema$ResourceUtilizationReport] = js.native
  /**
    * Shutdown notice by workers.
    */
  var workerShutdownNotice: js.UndefOr[Schema$WorkerShutdownNotice] = js.native
}

object Schema$WorkerMessage {
  @scala.inline
  def apply(
    labels: StringDictionary[String] = null,
    time: String = null,
    workerHealthReport: Schema$WorkerHealthReport = null,
    workerLifecycleEvent: Schema$WorkerLifecycleEvent = null,
    workerMessageCode: Schema$WorkerMessageCode = null,
    workerMetrics: Schema$ResourceUtilizationReport = null,
    workerShutdownNotice: Schema$WorkerShutdownNotice = null
  ): Schema$WorkerMessage = {
    ...
    __obj.asInstanceOf[Schema$WorkerMessage]
  }
}
