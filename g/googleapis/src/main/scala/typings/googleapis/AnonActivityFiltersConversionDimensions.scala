...
@js.native
trait AnonActivityFiltersConversionDimensions extends js.Object {
...
object AnonActivityFiltersConversionDimensions {
  @scala.inline
  def apply(
  ...
  ): AnonActivityFiltersConversionDimensions = {
    ...
    __obj.asInstanceOf[AnonActivityFiltersConversionDimensions]
  }
}
