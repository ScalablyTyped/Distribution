...
trait ParamsResourceServicesConsumerquotametricsLimitsConsumeroverridesCreate
  extends StObject
...
object ParamsResourceServicesConsumerquotametricsLimitsConsumeroverridesCreate {
  
  inline def apply(): ParamsResourceServicesConsumerquotametricsLimitsConsumeroverridesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceServicesConsumerquotametricsLimitsConsumeroverridesCreate]
  }
  
  extension [Self <: ParamsResourceServicesConsumerquotametricsLimitsConsumeroverridesCreate](x: Self) {
