...
trait ParamsResourceServicesConsumerquotametricsLimitsAdminoverridesDelete
  extends StObject
...
object ParamsResourceServicesConsumerquotametricsLimitsAdminoverridesDelete {
  
  inline def apply(): ParamsResourceServicesConsumerquotametricsLimitsAdminoverridesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceServicesConsumerquotametricsLimitsAdminoverridesDelete]
  }
  
  extension [Self <: ParamsResourceServicesConsumerquotametricsLimitsAdminoverridesDelete](x: Self) {
