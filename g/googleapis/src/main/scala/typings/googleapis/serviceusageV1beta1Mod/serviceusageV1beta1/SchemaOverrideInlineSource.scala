...
trait SchemaOverrideInlineSource extends StObject {
...
object SchemaOverrideInlineSource {
  
  inline def apply(): SchemaOverrideInlineSource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOverrideInlineSource]
  }
  
  extension [Self <: SchemaOverrideInlineSource](x: Self) {
