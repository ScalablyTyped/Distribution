...
trait ParamsResourceServicesConsumerquotametricsLimitsConsumeroverridesDelete
  extends StObject
...
object ParamsResourceServicesConsumerquotametricsLimitsConsumeroverridesDelete {
  
  inline def apply(): ParamsResourceServicesConsumerquotametricsLimitsConsumeroverridesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceServicesConsumerquotametricsLimitsConsumeroverridesDelete]
  }
  
  extension [Self <: ParamsResourceServicesConsumerquotametricsLimitsConsumeroverridesDelete](x: Self) {
