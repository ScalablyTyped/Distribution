...
trait SchemaImportAdminOverridesRequest extends StObject {
  ...
  /**
    ...
    */
  var inlineSource: js.UndefOr[SchemaOverrideInlineSource] = js.undefined
}
object SchemaImportAdminOverridesRequest {
  
  inline def apply(): SchemaImportAdminOverridesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaImportAdminOverridesRequest]
  }
  
  extension [Self <: SchemaImportAdminOverridesRequest](x: Self) {
    ...
    inline def setInlineSource(value: SchemaOverrideInlineSource): Self = StObject.set(x, "inlineSource", value.asInstanceOf[js.Any])
