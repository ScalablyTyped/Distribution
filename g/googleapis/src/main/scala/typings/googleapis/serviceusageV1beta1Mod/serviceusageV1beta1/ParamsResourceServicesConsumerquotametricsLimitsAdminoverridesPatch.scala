...
trait ParamsResourceServicesConsumerquotametricsLimitsAdminoverridesPatch
  extends StObject
...
object ParamsResourceServicesConsumerquotametricsLimitsAdminoverridesPatch {
  
  inline def apply(): ParamsResourceServicesConsumerquotametricsLimitsAdminoverridesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceServicesConsumerquotametricsLimitsAdminoverridesPatch]
  }
  
  extension [Self <: ParamsResourceServicesConsumerquotametricsLimitsAdminoverridesPatch](x: Self) {
