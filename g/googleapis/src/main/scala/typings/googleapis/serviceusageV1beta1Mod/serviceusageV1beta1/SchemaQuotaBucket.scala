...
trait SchemaQuotaBucket extends StObject {
  
  /**
    * Admin override on this quota bucket.
    */
  var adminOverride: js.UndefOr[SchemaQuotaOverride] = js.undefined
  
  /**
    * Consumer override on this quota bucket.
    */
  var consumerOverride: js.UndefOr[SchemaQuotaOverride] = js.undefined
  ...
  /**
    ...
    */
  var producerOverride: js.UndefOr[SchemaQuotaOverride] = js.undefined
}
object SchemaQuotaBucket {
  
  inline def apply(): SchemaQuotaBucket = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaQuotaBucket]
  }
  
  extension [Self <: SchemaQuotaBucket](x: Self) {
    
    inline def setAdminOverride(value: SchemaQuotaOverride): Self = StObject.set(x, "adminOverride", value.asInstanceOf[js.Any])
    
    inline def setAdminOverrideUndefined: Self = StObject.set(x, "adminOverride", js.undefined)
    
    inline def setConsumerOverride(value: SchemaQuotaOverride): Self = StObject.set(x, "consumerOverride", value.asInstanceOf[js.Any])
    ...
    inline def setProducerOverride(value: SchemaQuotaOverride): Self = StObject.set(x, "producerOverride", value.asInstanceOf[js.Any])
