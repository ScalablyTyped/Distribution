...
trait SchemaConsumerQuotaMetric extends StObject {
  
  /**
    * The consumer quota for each quota limit defined on the metric.
    */
  var consumerQuotaLimits: js.UndefOr[js.Array[SchemaConsumerQuotaLimit]] = js.undefined
  ...
  /**
    ...
    */
  var descendantConsumerQuotaLimits: js.UndefOr[js.Array[SchemaConsumerQuotaLimit]] = js.undefined
...
object SchemaConsumerQuotaMetric {
  
  inline def apply(): SchemaConsumerQuotaMetric = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaConsumerQuotaMetric]
  }
  
  extension [Self <: SchemaConsumerQuotaMetric](x: Self) {
    
    inline def setConsumerQuotaLimits(value: js.Array[SchemaConsumerQuotaLimit]): Self = StObject.set(x, "consumerQuotaLimits", value.asInstanceOf[js.Any])
    
    inline def setConsumerQuotaLimitsUndefined: Self = StObject.set(x, "consumerQuotaLimits", js.undefined)
    
    inline def setConsumerQuotaLimitsVarargs(value: SchemaConsumerQuotaLimit*): Self = StObject.set(x, "consumerQuotaLimits", js.Array(value*))
    
    inline def setDescendantConsumerQuotaLimits(value: js.Array[SchemaConsumerQuotaLimit]): Self = StObject.set(x, "descendantConsumerQuotaLimits", value.asInstanceOf[js.Any])
    
    inline def setDescendantConsumerQuotaLimitsUndefined: Self = StObject.set(x, "descendantConsumerQuotaLimits", js.undefined)
    
    inline def setDescendantConsumerQuotaLimitsVarargs(value: SchemaConsumerQuotaLimit*): Self = StObject.set(x, "descendantConsumerQuotaLimits", js.Array(value*))
