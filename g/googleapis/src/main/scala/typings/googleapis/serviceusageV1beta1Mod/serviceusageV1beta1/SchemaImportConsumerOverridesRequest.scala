...
trait SchemaImportConsumerOverridesRequest extends StObject {
...
object SchemaImportConsumerOverridesRequest {
  
  inline def apply(): SchemaImportConsumerOverridesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaImportConsumerOverridesRequest]
  }
  
  extension [Self <: SchemaImportConsumerOverridesRequest](x: Self) {
