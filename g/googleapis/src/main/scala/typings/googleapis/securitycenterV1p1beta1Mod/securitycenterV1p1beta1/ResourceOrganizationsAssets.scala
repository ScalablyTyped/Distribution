...
@JSImport("googleapis/build/src/apis/securitycenter/v1p1beta1", "securitycenter_v1p1beta1.Resource$Organizations$Assets")
@js.native
open class ResourceOrganizationsAssets protected () extends StObject {
  ...
  def updateSecurityMarks(params: ParamsResourceOrganizationsAssetsUpdatesecuritymarks): GaxiosPromise[SchemaGoogleCloudSecuritycenterV1p1beta1SecurityMarks] = js.native
  ...
  def updateSecurityMarks(params: ParamsResourceOrganizationsAssetsUpdatesecuritymarks, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudSecuritycenterV1p1beta1SecurityMarks] = js.native
  def updateSecurityMarks(
    params: ParamsResourceOrganizationsAssetsUpdatesecuritymarks,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudSecuritycenterV1p1beta1SecurityMarks]
