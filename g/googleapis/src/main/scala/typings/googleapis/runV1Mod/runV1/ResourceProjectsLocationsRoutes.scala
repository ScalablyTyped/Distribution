...
@JSImport("googleapis/build/src/apis/run/v1", "run_v1.Resource$Projects$Locations$Routes")
@js.native
open class ResourceProjectsLocationsRoutes protected () extends StObject {
  ...
  /**
    ...
    */
  def get(params: ParamsResourceProjectsLocationsRoutesGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceProjectsLocationsRoutesGet,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceProjectsLocationsRoutesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsLocationsRoutesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
