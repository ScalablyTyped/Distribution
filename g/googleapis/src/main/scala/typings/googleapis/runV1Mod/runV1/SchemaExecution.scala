...
trait SchemaExecution extends StObject {
  ...
  /**
    ...
    */
  var status: js.UndefOr[SchemaExecutionStatus] = js.undefined
}
object SchemaExecution {
  ...
  extension [Self <: SchemaExecution](x: Self) {
    ...
    inline def setStatus(value: SchemaExecutionStatus): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
