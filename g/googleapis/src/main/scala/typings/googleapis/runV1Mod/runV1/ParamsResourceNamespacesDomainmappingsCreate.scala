...
trait ParamsResourceNamespacesDomainmappingsCreate
  extends StObject
...
object ParamsResourceNamespacesDomainmappingsCreate {
  ...
  inline def apply(): ParamsResourceNamespacesDomainmappingsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesDomainmappingsCreate]
  }
  
  extension [Self <: ParamsResourceNamespacesDomainmappingsCreate](x: Self) {
