...
trait ParamsResourceNamespacesRevisionsList
  extends StObject
...
object ParamsResourceNamespacesRevisionsList {
  ...
  inline def apply(): ParamsResourceNamespacesRevisionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesRevisionsList]
  }
  
  extension [Self <: ParamsResourceNamespacesRevisionsList](x: Self) {
