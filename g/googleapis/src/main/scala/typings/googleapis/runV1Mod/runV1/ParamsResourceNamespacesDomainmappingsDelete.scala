...
trait ParamsResourceNamespacesDomainmappingsDelete
  extends StObject
...
object ParamsResourceNamespacesDomainmappingsDelete {
  
  inline def apply(): ParamsResourceNamespacesDomainmappingsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesDomainmappingsDelete]
  }
  
  extension [Self <: ParamsResourceNamespacesDomainmappingsDelete](x: Self) {
