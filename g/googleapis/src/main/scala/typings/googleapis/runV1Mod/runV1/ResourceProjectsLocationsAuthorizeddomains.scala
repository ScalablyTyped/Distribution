...
@JSImport("googleapis/build/src/apis/run/v1", "run_v1.Resource$Projects$Locations$Authorizeddomains")
@js.native
open class ResourceProjectsLocationsAuthorizeddomains protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceProjectsLocationsAuthorizeddomainsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAuthorizeddomainsList,
