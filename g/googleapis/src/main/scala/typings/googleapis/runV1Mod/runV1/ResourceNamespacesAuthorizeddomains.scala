...
@JSImport("googleapis/build/src/apis/run/v1", "run_v1.Resource$Namespaces$Authorizeddomains")
@js.native
open class ResourceNamespacesAuthorizeddomains protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceNamespacesAuthorizeddomainsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceNamespacesAuthorizeddomainsList,
