...
trait SchemaListExecutionsResponse extends StObject {
  ...
  /**
    * List of Executions.
    */
  var items: js.UndefOr[js.Array[SchemaExecution]] = js.undefined
...
object SchemaListExecutionsResponse {
  ...
  extension [Self <: SchemaListExecutionsResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaExecution]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaExecution*): Self = StObject.set(x, "items", js.Array(value*))
