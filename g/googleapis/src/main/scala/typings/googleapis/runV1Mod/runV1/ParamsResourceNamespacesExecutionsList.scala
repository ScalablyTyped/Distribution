...
trait ParamsResourceNamespacesExecutionsList
  extends StObject
...
object ParamsResourceNamespacesExecutionsList {
  
  inline def apply(): ParamsResourceNamespacesExecutionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesExecutionsList]
  }
  
  extension [Self <: ParamsResourceNamespacesExecutionsList](x: Self) {
