...
trait ParamsResourceNamespacesServicesList
  extends StObject
...
object ParamsResourceNamespacesServicesList {
  ...
  inline def apply(): ParamsResourceNamespacesServicesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesServicesList]
  }
  
  extension [Self <: ParamsResourceNamespacesServicesList](x: Self) {
