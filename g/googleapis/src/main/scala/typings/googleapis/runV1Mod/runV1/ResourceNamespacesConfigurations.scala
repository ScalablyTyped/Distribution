...
@JSImport("googleapis/build/src/apis/run/v1", "run_v1.Resource$Namespaces$Configurations")
@js.native
open class ResourceNamespacesConfigurations protected () extends StObject {
  ...
  /**
    ...
    */
  def get(params: ParamsResourceNamespacesConfigurationsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceNamespacesConfigurationsGet,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceNamespacesConfigurationsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceNamespacesConfigurationsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
