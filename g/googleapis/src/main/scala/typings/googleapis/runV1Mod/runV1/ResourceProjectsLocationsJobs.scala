...
@JSImport("googleapis/build/src/apis/run/v1", "run_v1.Resource$Projects$Locations$Jobs")
@js.native
open class ResourceProjectsLocationsJobs protected () extends StObject {
  ...
  def getIamPolicy(params: ParamsResourceProjectsLocationsJobsGetiampolicy): GaxiosPromise[SchemaPolicy] = js.native
  def getIamPolicy(
  ...
  def getIamPolicy(params: ParamsResourceProjectsLocationsJobsGetiampolicy, options: MethodOptions): GaxiosPromise[SchemaPolicy] = js.native
  def getIamPolicy(
    params: ParamsResourceProjectsLocationsJobsGetiampolicy,
  ...
  def setIamPolicy(params: ParamsResourceProjectsLocationsJobsSetiampolicy): GaxiosPromise[SchemaPolicy] = js.native
  def setIamPolicy(
  ...
  def setIamPolicy(params: ParamsResourceProjectsLocationsJobsSetiampolicy, options: MethodOptions): GaxiosPromise[SchemaPolicy] = js.native
  def setIamPolicy(
    params: ParamsResourceProjectsLocationsJobsSetiampolicy,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaPolicy]
  ...
  def testIamPermissions(params: ParamsResourceProjectsLocationsJobsTestiampermissions): GaxiosPromise[SchemaTestIamPermissionsResponse] = js.native
  ...
  def testIamPermissions(params: ParamsResourceProjectsLocationsJobsTestiampermissions, options: MethodOptions): GaxiosPromise[SchemaTestIamPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsResourceProjectsLocationsJobsTestiampermissions,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaTestIamPermissionsResponse]
