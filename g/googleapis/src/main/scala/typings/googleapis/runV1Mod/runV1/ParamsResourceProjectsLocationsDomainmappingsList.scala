...
trait ParamsResourceProjectsLocationsDomainmappingsList
  extends StObject
...
object ParamsResourceProjectsLocationsDomainmappingsList {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDomainmappingsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDomainmappingsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDomainmappingsList](x: Self) {
