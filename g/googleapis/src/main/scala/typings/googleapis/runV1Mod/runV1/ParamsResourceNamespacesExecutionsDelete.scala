...
trait ParamsResourceNamespacesExecutionsDelete
  extends StObject
...
object ParamsResourceNamespacesExecutionsDelete {
  
  inline def apply(): ParamsResourceNamespacesExecutionsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesExecutionsDelete]
  }
  
  extension [Self <: ParamsResourceNamespacesExecutionsDelete](x: Self) {
