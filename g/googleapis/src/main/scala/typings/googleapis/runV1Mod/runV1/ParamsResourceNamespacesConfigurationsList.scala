...
trait ParamsResourceNamespacesConfigurationsList
  extends StObject
...
object ParamsResourceNamespacesConfigurationsList {
  ...
  inline def apply(): ParamsResourceNamespacesConfigurationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesConfigurationsList]
  }
  
  extension [Self <: ParamsResourceNamespacesConfigurationsList](x: Self) {
