...
@JSImport("googleapis/build/src/apis/run/v1", "run_v1.Resource$Projects$Locations$Revisions")
@js.native
open class ResourceProjectsLocationsRevisions protected () extends StObject {
  ...
  def delete(params: ParamsResourceProjectsLocationsRevisionsDelete): GaxiosPromise[SchemaStatus] = js.native
  def delete(
  ...
  def delete(params: ParamsResourceProjectsLocationsRevisionsDelete, options: MethodOptions): GaxiosPromise[SchemaStatus] = js.native
  def delete(
    params: ParamsResourceProjectsLocationsRevisionsDelete,
  ...
  /**
    ...
    */
  def delete(params: ParamsResourceProjectsLocationsRevisionsDelete, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def delete(
    params: ParamsResourceProjectsLocationsRevisionsDelete,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def get(params: ParamsResourceProjectsLocationsRevisionsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceProjectsLocationsRevisionsGet,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceProjectsLocationsRevisionsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsLocationsRevisionsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
