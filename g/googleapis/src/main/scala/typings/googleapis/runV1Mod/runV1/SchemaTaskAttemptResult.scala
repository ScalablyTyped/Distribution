...
trait SchemaTaskAttemptResult extends StObject {
...
object SchemaTaskAttemptResult {
  
  inline def apply(): SchemaTaskAttemptResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaTaskAttemptResult]
  }
  
  extension [Self <: SchemaTaskAttemptResult](x: Self) {
