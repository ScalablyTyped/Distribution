...
trait SchemaGoogleCloudContactcenterinsightsV1alpha1ExportInsightsDataRequest extends StObject {
  
  /**
    * Specified if sink is a BigQuery table.
    */
  var bigQueryDestination: js.UndefOr[
    SchemaGoogleCloudContactcenterinsightsV1alpha1ExportInsightsDataRequestBigQueryDestination
  ] = js.undefined
...
object SchemaGoogleCloudContactcenterinsightsV1alpha1ExportInsightsDataRequest {
  
  inline def apply(): SchemaGoogleCloudContactcenterinsightsV1alpha1ExportInsightsDataRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudContactcenterinsightsV1alpha1ExportInsightsDataRequest]
  }
  
  extension [Self <: SchemaGoogleCloudContactcenterinsightsV1alpha1ExportInsightsDataRequest](x: Self) {
    
    inline def setBigQueryDestination(value: SchemaGoogleCloudContactcenterinsightsV1alpha1ExportInsightsDataRequestBigQueryDestination): Self = StObject.set(x, "bigQueryDestination", value.asInstanceOf[js.Any])
