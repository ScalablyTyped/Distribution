...
trait SchemaGoogleCloudContactcenterinsightsV1alpha1IssueModelLabelStatsIssueStats extends StObject {
...
object SchemaGoogleCloudContactcenterinsightsV1alpha1IssueModelLabelStatsIssueStats {
  
  inline def apply(): SchemaGoogleCloudContactcenterinsightsV1alpha1IssueModelLabelStatsIssueStats = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudContactcenterinsightsV1alpha1IssueModelLabelStatsIssueStats]
  }
  
  extension [Self <: SchemaGoogleCloudContactcenterinsightsV1alpha1IssueModelLabelStatsIssueStats](x: Self) {
