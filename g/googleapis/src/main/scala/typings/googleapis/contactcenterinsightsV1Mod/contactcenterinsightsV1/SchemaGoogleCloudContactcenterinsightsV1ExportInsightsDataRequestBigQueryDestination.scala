...
trait SchemaGoogleCloudContactcenterinsightsV1ExportInsightsDataRequestBigQueryDestination extends StObject {
...
object SchemaGoogleCloudContactcenterinsightsV1ExportInsightsDataRequestBigQueryDestination {
  
  inline def apply(): SchemaGoogleCloudContactcenterinsightsV1ExportInsightsDataRequestBigQueryDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudContactcenterinsightsV1ExportInsightsDataRequestBigQueryDestination]
  }
  
  extension [Self <: SchemaGoogleCloudContactcenterinsightsV1ExportInsightsDataRequestBigQueryDestination](x: Self) {
