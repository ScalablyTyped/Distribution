...
trait SchemaGoogleCloudContactcenterinsightsV1IssueModelInputDataConfig extends StObject {
...
object SchemaGoogleCloudContactcenterinsightsV1IssueModelInputDataConfig {
  
  inline def apply(): SchemaGoogleCloudContactcenterinsightsV1IssueModelInputDataConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudContactcenterinsightsV1IssueModelInputDataConfig]
  }
  
  extension [Self <: SchemaGoogleCloudContactcenterinsightsV1IssueModelInputDataConfig](x: Self) {
