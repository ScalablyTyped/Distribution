...
trait SchemaGoogleCloudContactcenterinsightsV1IssueModelLabelStats extends StObject {
...
object SchemaGoogleCloudContactcenterinsightsV1IssueModelLabelStats {
  
  inline def apply(): SchemaGoogleCloudContactcenterinsightsV1IssueModelLabelStats = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudContactcenterinsightsV1IssueModelLabelStats]
  }
  
  extension [Self <: SchemaGoogleCloudContactcenterinsightsV1IssueModelLabelStats](x: Self) {
    ...
    inline def setIssueStats(value: StringDictionary[SchemaGoogleCloudContactcenterinsightsV1IssueModelLabelStatsIssueStats]): Self = StObject.set(x, "issueStats", value.asInstanceOf[js.Any])
