...
trait ParamsResourceProjectsLocationsServicesDatabasesTablesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsServicesDatabasesTablesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsServicesDatabasesTablesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsServicesDatabasesTablesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsServicesDatabasesTablesGetiampolicy](x: Self) {
