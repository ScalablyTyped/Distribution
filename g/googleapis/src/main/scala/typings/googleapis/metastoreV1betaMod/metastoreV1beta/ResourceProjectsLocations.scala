...
@JSImport("googleapis/build/src/apis/metastore/v1beta", "metastore_v1beta.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var federations: ResourceProjectsLocationsFederations = js.native
