...
trait ParamsResourceProjectsLocationsServicesDatabasesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsServicesDatabasesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsServicesDatabasesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsServicesDatabasesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsServicesDatabasesGetiampolicy](x: Self) {
