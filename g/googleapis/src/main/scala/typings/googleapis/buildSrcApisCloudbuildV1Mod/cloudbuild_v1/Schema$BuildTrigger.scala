...
/**
  ...
  */
@js.native
trait Schema$BuildTrigger extends js.Object {
  /**
  ...
  /**
    ...
    */
  var github: js.UndefOr[Schema$GitHubEventsConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var triggerTemplate: js.UndefOr[Schema$RepoSource] = js.native
}

object Schema$BuildTrigger {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$BuildTrigger]
  }
}
