...
class ResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFields protected () extends js.Object {
  ...
  /**
    ...
    */
  def get(): GaxiosPromise[Schema$GoogleFirestoreAdminV1Field] = js.native
  def get(callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1Field]): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarGet
  ): GaxiosPromise[Schema$GoogleFirestoreAdminV1Field] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarGet,
  ...
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarGet,
    options: BodyResponseCallback[Schema$GoogleFirestoreAdminV1Field],
    callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1Field]
  ): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarGet,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def list(): GaxiosPromise[Schema$GoogleFirestoreAdminV1ListFieldsResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1ListFieldsResponse]): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarList
  ): GaxiosPromise[Schema$GoogleFirestoreAdminV1ListFieldsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarList,
  ...
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarList,
    options: BodyResponseCallback[Schema$GoogleFirestoreAdminV1ListFieldsResponse],
    callback: BodyResponseCallback[Schema$GoogleFirestoreAdminV1ListFieldsResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarList,
