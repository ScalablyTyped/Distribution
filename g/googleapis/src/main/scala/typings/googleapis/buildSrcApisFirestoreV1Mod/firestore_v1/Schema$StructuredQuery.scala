...
/**
  ...
  */
@js.native
trait Schema$StructuredQuery extends js.Object {
  /**
    * A end point for the query results.
    */
  var endAt: js.UndefOr[Schema$Cursor] = js.native
  /**
    * The collections to query.
    */
  var from: js.UndefOr[js.Array[Schema$CollectionSelector]] = js.native
  /**
  ...
  /**
    ...
    */
  var orderBy: js.UndefOr[js.Array[Schema$Order]] = js.native
  /**
    * The projection to return.
    */
  var select: js.UndefOr[Schema$Projection] = js.native
  /**
    * A starting point for the query results.
    */
  var startAt: js.UndefOr[Schema$Cursor] = js.native
  /**
    * The filter to apply.
    */
  var where: js.UndefOr[Schema$Filter] = js.native
}

object Schema$StructuredQuery {
  @scala.inline
  def apply(
    endAt: Schema$Cursor = null,
    from: js.Array[Schema$CollectionSelector] = null,
    limit: Int | Double = null,
    offset: Int | Double = null,
    orderBy: js.Array[Schema$Order] = null,
    select: Schema$Projection = null,
    startAt: Schema$Cursor = null,
    where: Schema$Filter = null
    ...
    __obj.asInstanceOf[Schema$StructuredQuery]
  }
}
