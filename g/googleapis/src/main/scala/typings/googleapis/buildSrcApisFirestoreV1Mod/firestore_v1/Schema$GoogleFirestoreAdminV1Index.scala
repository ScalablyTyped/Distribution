...
/**
  ...
  */
@js.native
trait Schema$GoogleFirestoreAdminV1Index extends js.Object {
  /**
    ...
    * associated field.
    */
  var fields: js.UndefOr[js.Array[Schema$GoogleFirestoreAdminV1IndexField]] = js.native
  /**
...
object Schema$GoogleFirestoreAdminV1Index {
  @scala.inline
  def apply(
    fields: js.Array[Schema$GoogleFirestoreAdminV1IndexField] = null,
    name: String = null,
    queryScope: String = null,
    state: String = null
  ): Schema$GoogleFirestoreAdminV1Index = {
    ...
    __obj.asInstanceOf[Schema$GoogleFirestoreAdminV1Index]
  }
}
