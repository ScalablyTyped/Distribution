...
trait SchemaNotification extends StObject {
  ...
  /**
    ...
    */
  var custom_attributes: js.UndefOr[StringDictionary[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var event_types: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var object_name_prefix: js.UndefOr[String | Null] = js.undefined
  
  /**
    * The desired content of the Payload.
    */
  var payload_format: js.UndefOr[String | Null] = js.undefined
...
object SchemaNotification {
  ...
  extension [Self <: SchemaNotification](x: Self) {
    ...
    inline def setCustom_attributesNull: Self = StObject.set(x, "custom_attributes", null)
    ...
    inline def setEvent_typesNull: Self = StObject.set(x, "event_types", null)
    ...
    inline def setObject_name_prefixNull: Self = StObject.set(x, "object_name_prefix", null)
    ...
    inline def setPayload_formatNull: Self = StObject.set(x, "payload_format", null)
