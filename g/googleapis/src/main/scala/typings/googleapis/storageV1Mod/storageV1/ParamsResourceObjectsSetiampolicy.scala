...
trait ParamsResourceObjectsSetiampolicy
  extends StObject
...
object ParamsResourceObjectsSetiampolicy {
  ...
  @scala.inline
  implicit class ParamsResourceObjectsSetiampolicyMutableBuilder[Self <: ParamsResourceObjectsSetiampolicy] (val x: Self) extends AnyVal {
