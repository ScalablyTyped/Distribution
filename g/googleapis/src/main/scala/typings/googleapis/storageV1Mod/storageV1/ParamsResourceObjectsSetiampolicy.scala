...
object ParamsResourceObjectsSetiampolicy {
  ...
  @scala.inline
  def apply(): ParamsResourceObjectsSetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceObjectsSetiampolicy]
  }
  
  @scala.inline
  implicit class ParamsResourceObjectsSetiampolicyOps[Self <: ParamsResourceObjectsSetiampolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaPolicy): Self = this.set("requestBody", value.asInstanceOf[js.Any])
