...
object ParamsResourceBucketsTestiampermissions {
  ...
  @scala.inline
  def apply(): ParamsResourceBucketsTestiampermissions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBucketsTestiampermissions]
  }
  
  @scala.inline
  implicit class ParamsResourceBucketsTestiampermissionsMutableBuilder[Self <: ParamsResourceBucketsTestiampermissions] (val x: Self) extends AnyVal {
