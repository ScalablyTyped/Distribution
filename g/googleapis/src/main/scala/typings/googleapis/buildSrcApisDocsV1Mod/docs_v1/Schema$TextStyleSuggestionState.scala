...
/**
  ...
  */
@js.native
trait Schema$TextStyleSuggestionState extends js.Object {
  /**
...
object Schema$TextStyleSuggestionState {
  @scala.inline
  def apply(
  ...
  ): Schema$TextStyleSuggestionState = {
    ...
    __obj.asInstanceOf[Schema$TextStyleSuggestionState]
  }
}
