...
/**
  ...
  */
@js.native
trait Schema$TableCellStyleSuggestionState extends js.Object {
  /**
...
object Schema$TableCellStyleSuggestionState {
  @scala.inline
  def apply(
  ...
  ): Schema$TableCellStyleSuggestionState = {
    ...
    __obj.asInstanceOf[Schema$TableCellStyleSuggestionState]
  }
}
