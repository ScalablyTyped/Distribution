...
class Resource$Documents protected () extends js.Object {
  ...
  /**
    ...
    */
  def batchUpdate(): GaxiosPromise[Schema$BatchUpdateDocumentResponse] = js.native
  def batchUpdate(callback: BodyResponseCallback[Schema$BatchUpdateDocumentResponse]): Unit = js.native
  def batchUpdate(params: ParamsDollarResourceDollarDocumentsDollarBatchupdate): GaxiosPromise[Schema$BatchUpdateDocumentResponse] = js.native
  def batchUpdate(
    params: ParamsDollarResourceDollarDocumentsDollarBatchupdate,
    callback: BodyResponseCallback[Schema$BatchUpdateDocumentResponse]
  ): Unit = js.native
  def batchUpdate(
    params: ParamsDollarResourceDollarDocumentsDollarBatchupdate,
    options: BodyResponseCallback[Schema$BatchUpdateDocumentResponse],
    callback: BodyResponseCallback[Schema$BatchUpdateDocumentResponse]
  ): Unit = js.native
  def batchUpdate(params: ParamsDollarResourceDollarDocumentsDollarBatchupdate, options: MethodOptions): GaxiosPromise[Schema$BatchUpdateDocumentResponse] = js.native
  def batchUpdate(
    params: ParamsDollarResourceDollarDocumentsDollarBatchupdate,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def create(): GaxiosPromise[Schema$Document] = js.native
  def create(callback: BodyResponseCallback[Schema$Document]): Unit = js.native
  def create(params: ParamsDollarResourceDollarDocumentsDollarCreate): GaxiosPromise[Schema$Document] = js.native
  def create(
    params: ParamsDollarResourceDollarDocumentsDollarCreate,
  ...
  def create(params: ParamsDollarResourceDollarDocumentsDollarCreate, options: MethodOptions): GaxiosPromise[Schema$Document] = js.native
  def create(
    params: ParamsDollarResourceDollarDocumentsDollarCreate,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Document]
  ...
  def get(params: ParamsDollarResourceDollarDocumentsDollarGet): GaxiosPromise[Schema$Document] = js.native
  def get(
    params: ParamsDollarResourceDollarDocumentsDollarGet,
    callback: BodyResponseCallback[Schema$Document]
  ): Unit = js.native
  def get(
    params: ParamsDollarResourceDollarDocumentsDollarGet,
  ...
  def get(params: ParamsDollarResourceDollarDocumentsDollarGet, options: MethodOptions): GaxiosPromise[Schema$Document] = js.native
  def get(
    params: ParamsDollarResourceDollarDocumentsDollarGet,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Document]
