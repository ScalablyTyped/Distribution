...
/**
  ...
  */
@js.native
trait Schema$TextStyle extends js.Object {
  /**
  ...
  /**
    ...
    */
  var fontSize: js.UndefOr[Schema$Dimension] = js.native
  /**
    * The foreground color of the text. If set, the color is either an RGB
    * color or transparent, depending on the `color` field.
    */
  var foregroundColor: js.UndefOr[Schema$OptionalColor] = js.native
  /**
  ...
  /**
    ...
    * error is returned.
    */
  var weightedFontFamily: js.UndefOr[Schema$WeightedFontFamily] = js.native
}

object Schema$TextStyle {
  @scala.inline
  def apply(
    backgroundColor: Schema$OptionalColor = null,
    baselineOffset: String = null,
    bold: js.UndefOr[Boolean] = js.undefined,
    fontSize: Schema$Dimension = null,
    foregroundColor: Schema$OptionalColor = null,
    ...
    weightedFontFamily: Schema$WeightedFontFamily = null
  ): Schema$TextStyle = {
    ...
    __obj.asInstanceOf[Schema$TextStyle]
  }
}
