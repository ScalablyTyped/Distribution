...
trait Schema$NamedRange extends js.Object {
  ...
  /**
    ...
    */
  var ranges: js.UndefOr[js.Array[Schema$Range]] = js.native
}

object Schema$NamedRange {
  @scala.inline
  def apply(name: String = null, namedRangeId: String = null, ranges: js.Array[Schema$Range] = null): Schema$NamedRange = {
