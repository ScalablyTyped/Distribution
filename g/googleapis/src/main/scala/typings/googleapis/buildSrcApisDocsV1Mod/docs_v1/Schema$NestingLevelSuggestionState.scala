...
/**
  ...
  */
@js.native
trait Schema$NestingLevelSuggestionState extends js.Object {
  /**
...
object Schema$NestingLevelSuggestionState {
  @scala.inline
  def apply(
  ...
  ): Schema$NestingLevelSuggestionState = {
    ...
    __obj.asInstanceOf[Schema$NestingLevelSuggestionState]
  }
}
