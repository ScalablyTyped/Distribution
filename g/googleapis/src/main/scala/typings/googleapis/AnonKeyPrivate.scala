...
@js.native
trait AnonKeyPrivate extends js.Object {
  var `private`: js.UndefOr[StringDictionary[String]] = js.native
  var shared: js.UndefOr[StringDictionary[String]] = js.native
}

object AnonKeyPrivate {
  @scala.inline
  def apply(`private`: StringDictionary[String] = null, shared: StringDictionary[String] = null): AnonKeyPrivate = {
    ...
    __obj.asInstanceOf[AnonKeyPrivate]
  }
}
