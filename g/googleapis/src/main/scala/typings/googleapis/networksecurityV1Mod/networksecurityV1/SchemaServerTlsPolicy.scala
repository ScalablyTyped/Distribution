...
trait SchemaServerTlsPolicy extends StObject {
  ...
  /**
    ...
    */
  var serverCertificate: js.UndefOr[SchemaGoogleCloudNetworksecurityV1CertificateProvider] = js.undefined
...
object SchemaServerTlsPolicy {
  ...
  extension [Self <: SchemaServerTlsPolicy](x: Self) {
    ...
    inline def setServerCertificate(value: SchemaGoogleCloudNetworksecurityV1CertificateProvider): Self = StObject.set(x, "serverCertificate", value.asInstanceOf[js.Any])
