...
trait ParamsResourceProjectsLocationsAuthorizationpoliciesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsAuthorizationpoliciesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsAuthorizationpoliciesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAuthorizationpoliciesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAuthorizationpoliciesGetiampolicy](x: Self) {
