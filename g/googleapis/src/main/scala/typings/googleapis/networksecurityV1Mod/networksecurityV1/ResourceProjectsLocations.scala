...
@JSImport("googleapis/build/src/apis/networksecurity/v1", "networksecurity_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var authorizationPolicies: ResourceProjectsLocationsAuthorizationpolicies = js.native
  
  var clientTlsPolicies: ResourceProjectsLocationsClienttlspolicies = js.native
  ...
  var serverTlsPolicies: ResourceProjectsLocationsServertlspolicies = js.native
}
