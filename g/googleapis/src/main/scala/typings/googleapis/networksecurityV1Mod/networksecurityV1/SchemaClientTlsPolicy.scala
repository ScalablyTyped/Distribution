...
trait SchemaClientTlsPolicy extends StObject {
  ...
  /**
    ...
    */
  var clientCertificate: js.UndefOr[SchemaGoogleCloudNetworksecurityV1CertificateProvider] = js.undefined
...
object SchemaClientTlsPolicy {
  ...
  extension [Self <: SchemaClientTlsPolicy](x: Self) {
    ...
    inline def setClientCertificate(value: SchemaGoogleCloudNetworksecurityV1CertificateProvider): Self = StObject.set(x, "clientCertificate", value.asInstanceOf[js.Any])
