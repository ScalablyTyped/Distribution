...
trait SchemaGoogleCloudNetworksecurityV1GrpcEndpoint extends StObject {
...
object SchemaGoogleCloudNetworksecurityV1GrpcEndpoint {
  
  inline def apply(): SchemaGoogleCloudNetworksecurityV1GrpcEndpoint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudNetworksecurityV1GrpcEndpoint]
  }
  
  extension [Self <: SchemaGoogleCloudNetworksecurityV1GrpcEndpoint](x: Self) {
