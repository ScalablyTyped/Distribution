...
trait ParamsResourceThreatlistupdatesFetch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaFetchThreatListUpdatesRequest] = js.undefined
}
object ParamsResourceThreatlistupdatesFetch {
  ...
  extension [Self <: ParamsResourceThreatlistupdatesFetch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaFetchThreatListUpdatesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
