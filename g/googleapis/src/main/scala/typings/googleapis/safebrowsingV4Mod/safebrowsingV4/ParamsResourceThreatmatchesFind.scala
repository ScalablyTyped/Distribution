...
trait ParamsResourceThreatmatchesFind
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaFindThreatMatchesRequest] = js.undefined
}
object ParamsResourceThreatmatchesFind {
  ...
  extension [Self <: ParamsResourceThreatmatchesFind](x: Self) {
    ...
    inline def setRequestBody(value: SchemaFindThreatMatchesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
