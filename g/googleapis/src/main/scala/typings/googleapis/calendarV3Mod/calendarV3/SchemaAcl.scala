...
object SchemaAcl {
  ...
  implicit class SchemaAclOps[Self <: SchemaAcl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaAclRule*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaAclRule]): Self = this.set("items", value.asInstanceOf[js.Any])
