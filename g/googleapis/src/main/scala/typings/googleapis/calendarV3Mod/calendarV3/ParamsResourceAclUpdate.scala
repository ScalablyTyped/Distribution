...
@js.native
trait ParamsResourceAclUpdate extends StandardParameters {
...
object ParamsResourceAclUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceAclUpdateOps[Self <: ParamsResourceAclUpdate] (val x: Self) extends AnyVal {
