...
object SchemaCalendarList {
  ...
  @scala.inline
  implicit class SchemaCalendarListOps[Self <: SchemaCalendarList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaCalendarListEntry*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaCalendarListEntry]): Self = this.set("items", value.asInstanceOf[js.Any])
