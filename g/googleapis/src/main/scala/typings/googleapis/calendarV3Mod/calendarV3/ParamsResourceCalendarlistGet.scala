...
@js.native
trait ParamsResourceCalendarlistGet extends StandardParameters {
...
object ParamsResourceCalendarlistGet {
  ...
  @scala.inline
  implicit class ParamsResourceCalendarlistGetOps[Self <: ParamsResourceCalendarlistGet] (val x: Self) extends AnyVal {
