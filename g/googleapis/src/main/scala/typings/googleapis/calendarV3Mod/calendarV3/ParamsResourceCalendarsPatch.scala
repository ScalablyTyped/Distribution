...
trait ParamsResourceCalendarsPatch
  extends StObject
...
object ParamsResourceCalendarsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceCalendarsPatchMutableBuilder[Self <: ParamsResourceCalendarsPatch] (val x: Self) extends AnyVal {
