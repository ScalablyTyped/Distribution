...
@js.native
trait ParamsResourceSettingsList extends StandardParameters {
...
object ParamsResourceSettingsList {
  ...
  @scala.inline
  def apply(): ParamsResourceSettingsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSettingsList]
  }
  
  @scala.inline
  implicit class ParamsResourceSettingsListMutableBuilder[Self <: ParamsResourceSettingsList] (val x: Self) extends AnyVal {
