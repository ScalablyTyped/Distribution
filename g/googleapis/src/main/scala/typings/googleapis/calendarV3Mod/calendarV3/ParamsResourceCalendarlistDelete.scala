...
@js.native
trait ParamsResourceCalendarlistDelete extends StandardParameters {
...
object ParamsResourceCalendarlistDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceCalendarlistDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCalendarlistDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceCalendarlistDeleteMutableBuilder[Self <: ParamsResourceCalendarlistDelete] (val x: Self) extends AnyVal {
