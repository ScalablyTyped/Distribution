...
@js.native
trait ParamsResourceCalendarsClear extends StandardParameters {
...
object ParamsResourceCalendarsClear {
  ...
  @scala.inline
  def apply(): ParamsResourceCalendarsClear = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCalendarsClear]
  }
  
  @scala.inline
  implicit class ParamsResourceCalendarsClearMutableBuilder[Self <: ParamsResourceCalendarsClear] (val x: Self) extends AnyVal {
