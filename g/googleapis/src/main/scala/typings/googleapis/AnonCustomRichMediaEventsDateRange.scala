...
@js.native
trait AnonCustomRichMediaEventsDateRange extends js.Object {
...
object AnonCustomRichMediaEventsDateRange {
  @scala.inline
  def apply(
  ...
  ): AnonCustomRichMediaEventsDateRange = {
    ...
    __obj.asInstanceOf[AnonCustomRichMediaEventsDateRange]
  }
}
