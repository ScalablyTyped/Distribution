...
@JSImport("googleapis/build/src/apis/ideahub/v1alpha", "ideahub_v1alpha.Resource$Platforms$Properties$Ideas")
@js.native
open class ResourcePlatformsPropertiesIdeas protected () extends StObject {
  ...
  def list(params: ParamsResourcePlatformsPropertiesIdeasList): GaxiosPromise[SchemaGoogleSearchIdeahubV1alphaListIdeasResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourcePlatformsPropertiesIdeasList, options: MethodOptions): GaxiosPromise[SchemaGoogleSearchIdeahubV1alphaListIdeasResponse] = js.native
  def list(
    params: ParamsResourcePlatformsPropertiesIdeasList,
