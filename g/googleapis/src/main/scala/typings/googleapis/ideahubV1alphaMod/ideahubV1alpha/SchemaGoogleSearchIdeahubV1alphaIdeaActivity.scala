...
trait SchemaGoogleSearchIdeahubV1alphaIdeaActivity extends StObject {
...
object SchemaGoogleSearchIdeahubV1alphaIdeaActivity {
  
  inline def apply(): SchemaGoogleSearchIdeahubV1alphaIdeaActivity = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleSearchIdeahubV1alphaIdeaActivity]
  }
  
  extension [Self <: SchemaGoogleSearchIdeahubV1alphaIdeaActivity](x: Self) {
