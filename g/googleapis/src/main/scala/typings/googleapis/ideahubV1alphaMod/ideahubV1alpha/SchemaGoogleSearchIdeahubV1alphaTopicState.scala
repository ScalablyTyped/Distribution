...
trait SchemaGoogleSearchIdeahubV1alphaTopicState extends StObject {
...
object SchemaGoogleSearchIdeahubV1alphaTopicState {
  
  inline def apply(): SchemaGoogleSearchIdeahubV1alphaTopicState = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleSearchIdeahubV1alphaTopicState]
  }
  
  extension [Self <: SchemaGoogleSearchIdeahubV1alphaTopicState](x: Self) {
