...
trait ParamsResourcePlatformsPropertiesIdeastatesPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleSearchIdeahubV1alphaIdeaState] = js.undefined
...
object ParamsResourcePlatformsPropertiesIdeastatesPatch {
  ...
  extension [Self <: ParamsResourcePlatformsPropertiesIdeastatesPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleSearchIdeahubV1alphaIdeaState): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
