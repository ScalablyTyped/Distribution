...
object ParamsResourceProjectsCompaniesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsCompaniesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsCompaniesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsCompaniesCreateMutableBuilder[Self <: ParamsResourceProjectsCompaniesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreateCompanyRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
