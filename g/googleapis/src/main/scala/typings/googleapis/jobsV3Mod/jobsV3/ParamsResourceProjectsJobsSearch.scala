...
object ParamsResourceProjectsJobsSearch {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsJobsSearch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsJobsSearch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsJobsSearchMutableBuilder[Self <: ParamsResourceProjectsJobsSearch] (val x: Self) extends AnyVal {
