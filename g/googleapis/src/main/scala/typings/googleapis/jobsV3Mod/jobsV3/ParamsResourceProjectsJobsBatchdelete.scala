...
object ParamsResourceProjectsJobsBatchdelete {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsJobsBatchdelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsJobsBatchdelete]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsJobsBatchdeleteMutableBuilder[Self <: ParamsResourceProjectsJobsBatchdelete] (val x: Self) extends AnyVal {
