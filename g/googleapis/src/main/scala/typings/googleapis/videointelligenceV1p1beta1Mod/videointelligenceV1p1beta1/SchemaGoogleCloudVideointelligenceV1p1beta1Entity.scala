...
/**
  ...
  */
trait SchemaGoogleCloudVideointelligenceV1p1beta1Entity extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p1beta1Entity {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1EntityMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1Entity] (val x: Self) extends AnyVal {
