...
object SchemaGoogleCloudVideointelligenceV1beta2VideoAnnotationProgress {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1beta2VideoAnnotationProgress = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1beta2VideoAnnotationProgress]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1beta2VideoAnnotationProgress](x: Self) {
