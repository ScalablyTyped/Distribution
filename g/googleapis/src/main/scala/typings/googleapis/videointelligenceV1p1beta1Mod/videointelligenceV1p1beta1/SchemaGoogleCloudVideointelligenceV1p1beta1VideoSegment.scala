...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p1beta1VideoSegment extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p1beta1VideoSegment {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1VideoSegmentMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1VideoSegment] (val x: Self) extends AnyVal {
