...
trait SchemaGoogleCloudVideointelligenceV1p1beta1FaceDetectionConfig extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p1beta1FaceDetectionConfig {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1FaceDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1FaceDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1FaceDetectionConfig](x: Self) {
