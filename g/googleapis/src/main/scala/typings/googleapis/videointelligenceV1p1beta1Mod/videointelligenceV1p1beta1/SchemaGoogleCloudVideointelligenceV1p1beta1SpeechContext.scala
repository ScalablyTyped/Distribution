...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p1beta1SpeechContext extends js.Object {
  /**
...
object SchemaGoogleCloudVideointelligenceV1p1beta1SpeechContext {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1SpeechContextOps[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechContext] (val x: Self) extends AnyVal {
    @scala.inline
