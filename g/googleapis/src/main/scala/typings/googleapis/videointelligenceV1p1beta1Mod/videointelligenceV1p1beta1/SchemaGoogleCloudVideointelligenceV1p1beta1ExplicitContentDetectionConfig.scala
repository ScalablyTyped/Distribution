...
object SchemaGoogleCloudVideointelligenceV1p1beta1ExplicitContentDetectionConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1ExplicitContentDetectionConfigOps[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1ExplicitContentDetectionConfig] (val x: Self) extends AnyVal {
