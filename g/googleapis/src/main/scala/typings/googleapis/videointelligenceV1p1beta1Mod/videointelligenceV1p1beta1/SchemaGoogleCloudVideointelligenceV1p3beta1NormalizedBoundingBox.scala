...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBoxMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox] (val x: Self) extends AnyVal {
