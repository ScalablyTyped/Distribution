...
object SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox](x: Self) {
