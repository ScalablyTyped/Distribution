...
object SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscription {
  ...
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscription](x: Self) {
    ...
    inline def setAlternativesVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative*): Self = StObject.set(x, "alternatives", js.Array(value*))
