...
object SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscription {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscription] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAlternativesVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative*): Self = this.set("alternatives", js.Array(value :_*))
    @scala.inline
    def setAlternatives(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative]): Self = this.set("alternatives", value.asInstanceOf[js.Any])
    @scala.inline
