...
object SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig](x: Self) {
