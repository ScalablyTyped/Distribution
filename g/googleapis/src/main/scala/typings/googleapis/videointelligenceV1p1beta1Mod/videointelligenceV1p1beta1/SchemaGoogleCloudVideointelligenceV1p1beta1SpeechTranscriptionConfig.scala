...
object SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig {
  ...
  def apply(
    ...
    speechContexts: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1SpeechContext] = null
  ): SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig = {
