...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig extends js.Object {
...
object SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfigOps[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpeechContextsVarargs(value: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechContext*): Self = this.set("speechContexts", js.Array(value :_*))
    
    @scala.inline
    def setSpeechContexts(value: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1SpeechContext]): Self = this.set("speechContexts", value.asInstanceOf[js.Any])
