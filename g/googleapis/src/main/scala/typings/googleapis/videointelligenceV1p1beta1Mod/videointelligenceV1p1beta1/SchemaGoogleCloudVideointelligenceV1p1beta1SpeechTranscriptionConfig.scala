...
trait SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig extends StObject {
  ...
  /**
    ...
    */
  var speechContexts: js.UndefOr[js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1SpeechContext]] = js.undefined
}
object SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig](x: Self) {
    ...
    inline def setSpeechContexts(value: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1SpeechContext]): Self = StObject.set(x, "speechContexts", value.asInstanceOf[js.Any])
    
    inline def setSpeechContextsUndefined: Self = StObject.set(x, "speechContexts", js.undefined)
    
    inline def setSpeechContextsVarargs(value: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechContext*): Self = StObject.set(x, "speechContexts", js.Array(value :_*))
  }
}
