...
object SchemaGoogleCloudVideointelligenceV1p3beta1ObjectTrackingFrame {
  @scala.inline
  def apply(
    normalizedBoundingBox: SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingBox = null,
    timeOffset: String = null
  ): SchemaGoogleCloudVideointelligenceV1p3beta1ObjectTrackingFrame = {
