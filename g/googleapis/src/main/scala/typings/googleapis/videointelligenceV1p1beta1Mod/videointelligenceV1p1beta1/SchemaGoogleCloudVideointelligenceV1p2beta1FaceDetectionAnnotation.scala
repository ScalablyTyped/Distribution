...
trait SchemaGoogleCloudVideointelligenceV1p2beta1FaceDetectionAnnotation extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p2beta1FaceDetectionAnnotation {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p2beta1FaceDetectionAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1FaceDetectionAnnotation]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1FaceDetectionAnnotation](x: Self) {
