...
object SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1ObjectTrackingFrame](x: Self) {
