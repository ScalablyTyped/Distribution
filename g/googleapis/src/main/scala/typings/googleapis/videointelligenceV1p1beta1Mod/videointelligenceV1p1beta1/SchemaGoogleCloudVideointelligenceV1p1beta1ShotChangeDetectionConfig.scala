...
object SchemaGoogleCloudVideointelligenceV1p1beta1ShotChangeDetectionConfig {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1ShotChangeDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1ShotChangeDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1ShotChangeDetectionConfig](x: Self) {
