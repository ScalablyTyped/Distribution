...
@js.native
trait ParamsResourceOrganizationsGetiampolicy extends StandardParameters {
...
object ParamsResourceOrganizationsGetiampolicy {
  ...
  @scala.inline
  def apply(): ParamsResourceOrganizationsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsGetiampolicy]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsGetiampolicyMutableBuilder[Self <: ParamsResourceOrganizationsGetiampolicy] (val x: Self) extends AnyVal {
