...
object ParamsResourceProjectsListorgpolicies {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsListorgpolicies = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsListorgpolicies]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsListorgpoliciesMutableBuilder[Self <: ParamsResourceProjectsListorgpolicies] (val x: Self) extends AnyVal {
