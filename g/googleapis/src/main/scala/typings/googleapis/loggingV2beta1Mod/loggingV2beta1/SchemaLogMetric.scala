...
object SchemaLogMetric {
  ...
  inline def apply(): SchemaLogMetric = {
  ...
  extension [Self <: SchemaLogMetric](x: Self) {
    ...
    inline def setMetricDescriptor(value: SchemaMetricDescriptor): Self = StObject.set(x, "metricDescriptor", value.asInstanceOf[js.Any])
