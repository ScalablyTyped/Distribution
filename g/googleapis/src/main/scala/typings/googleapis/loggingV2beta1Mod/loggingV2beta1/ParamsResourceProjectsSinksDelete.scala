...
@js.native
trait ParamsResourceProjectsSinksDelete extends StandardParameters {
...
object ParamsResourceProjectsSinksDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsSinksDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSinksDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsSinksDeleteMutableBuilder[Self <: ParamsResourceProjectsSinksDelete] (val x: Self) extends AnyVal {
