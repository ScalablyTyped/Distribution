...
@JSImport("googleapis/build/src/apis/policysimulator/v1", "policysimulator_v1.Resource$Folders$Locations$Replays")
@js.native
open class ResourceFoldersLocationsReplays protected () extends StObject {
  ...
  def create(params: ParamsResourceFoldersLocationsReplaysCreate): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def create(
    params: ParamsResourceFoldersLocationsReplaysCreate,
  ...
  def create(params: ParamsResourceFoldersLocationsReplaysCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def create(
    params: ParamsResourceFoldersLocationsReplaysCreate,
  ...
  /**
    ...
    */
  def create(params: ParamsResourceFoldersLocationsReplaysCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceFoldersLocationsReplaysCreate,
  ...
  def get(params: ParamsResourceFoldersLocationsReplaysGet): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1Replay] = js.native
  def get(
    params: ParamsResourceFoldersLocationsReplaysGet,
  ...
  def get(params: ParamsResourceFoldersLocationsReplaysGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1Replay] = js.native
  def get(
    params: ParamsResourceFoldersLocationsReplaysGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudPolicysimulatorV1Replay]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def get(params: ParamsResourceFoldersLocationsReplaysGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceFoldersLocationsReplaysGet,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  var results: ResourceFoldersLocationsReplaysResults = js.native
}
