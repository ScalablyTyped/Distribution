...
@JSImport("googleapis/build/src/apis/policysimulator/v1", "policysimulator_v1.Resource$Projects$Locations$Replays")
@js.native
open class ResourceProjectsLocationsReplays protected () extends StObject {
  ...
  def create(params: ParamsResourceProjectsLocationsReplaysCreate): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def create(
    params: ParamsResourceProjectsLocationsReplaysCreate,
  ...
  def create(params: ParamsResourceProjectsLocationsReplaysCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def create(
    params: ParamsResourceProjectsLocationsReplaysCreate,
  ...
  /**
    ...
    */
  def create(params: ParamsResourceProjectsLocationsReplaysCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceProjectsLocationsReplaysCreate,
  ...
  def get(params: ParamsResourceProjectsLocationsReplaysGet): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1Replay] = js.native
  def get(
    params: ParamsResourceProjectsLocationsReplaysGet,
  ...
  def get(params: ParamsResourceProjectsLocationsReplaysGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1Replay] = js.native
  def get(
    params: ParamsResourceProjectsLocationsReplaysGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudPolicysimulatorV1Replay]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def get(params: ParamsResourceProjectsLocationsReplaysGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceProjectsLocationsReplaysGet,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  var results: ResourceProjectsLocationsReplaysResults = js.native
}
