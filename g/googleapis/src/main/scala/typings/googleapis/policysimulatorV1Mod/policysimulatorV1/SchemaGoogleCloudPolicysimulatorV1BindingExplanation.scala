...
trait SchemaGoogleCloudPolicysimulatorV1BindingExplanation extends StObject {
  ...
  var memberships: js.UndefOr[
    StringDictionary[SchemaGoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership] | Null
  ] = js.undefined
...
object SchemaGoogleCloudPolicysimulatorV1BindingExplanation {
  
  inline def apply(): SchemaGoogleCloudPolicysimulatorV1BindingExplanation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicysimulatorV1BindingExplanation]
  }
  
  extension [Self <: SchemaGoogleCloudPolicysimulatorV1BindingExplanation](x: Self) {
    ...
    inline def setMemberships(value: StringDictionary[SchemaGoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership]): Self = StObject.set(x, "memberships", value.asInstanceOf[js.Any])
