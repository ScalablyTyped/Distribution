...
trait SchemaGoogleCloudPolicysimulatorV1ExplainedPolicy extends StObject {
  ...
  /**
    ...
    */
  var bindingExplanations: js.UndefOr[js.Array[SchemaGoogleCloudPolicysimulatorV1BindingExplanation]] = js.undefined
...
object SchemaGoogleCloudPolicysimulatorV1ExplainedPolicy {
  
  inline def apply(): SchemaGoogleCloudPolicysimulatorV1ExplainedPolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicysimulatorV1ExplainedPolicy]
  }
  
  extension [Self <: SchemaGoogleCloudPolicysimulatorV1ExplainedPolicy](x: Self) {
    ...
    inline def setBindingExplanations(value: js.Array[SchemaGoogleCloudPolicysimulatorV1BindingExplanation]): Self = StObject.set(x, "bindingExplanations", value.asInstanceOf[js.Any])
    
    inline def setBindingExplanationsUndefined: Self = StObject.set(x, "bindingExplanations", js.undefined)
    
    inline def setBindingExplanationsVarargs(value: SchemaGoogleCloudPolicysimulatorV1BindingExplanation*): Self = StObject.set(x, "bindingExplanations", js.Array(value*))
