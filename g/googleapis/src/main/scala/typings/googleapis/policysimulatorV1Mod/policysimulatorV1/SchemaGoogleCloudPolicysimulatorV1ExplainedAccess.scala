...
trait SchemaGoogleCloudPolicysimulatorV1ExplainedAccess extends StObject {
  ...
  /**
    ...
    */
  var policies: js.UndefOr[js.Array[SchemaGoogleCloudPolicysimulatorV1ExplainedPolicy]] = js.undefined
}
object SchemaGoogleCloudPolicysimulatorV1ExplainedAccess {
  
  inline def apply(): SchemaGoogleCloudPolicysimulatorV1ExplainedAccess = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicysimulatorV1ExplainedAccess]
  }
  
  extension [Self <: SchemaGoogleCloudPolicysimulatorV1ExplainedAccess](x: Self) {
    ...
    inline def setPolicies(value: js.Array[SchemaGoogleCloudPolicysimulatorV1ExplainedPolicy]): Self = StObject.set(x, "policies", value.asInstanceOf[js.Any])
    
    inline def setPoliciesUndefined: Self = StObject.set(x, "policies", js.undefined)
    
    inline def setPoliciesVarargs(value: SchemaGoogleCloudPolicysimulatorV1ExplainedPolicy*): Self = StObject.set(x, "policies", js.Array(value*))
  }
}
