...
@JSImport("googleapis/build/src/apis/policysimulator/v1", "policysimulator_v1.Resource$Folders$Locations$Replays$Results")
@js.native
open class ResourceFoldersLocationsReplaysResults protected () extends StObject {
  ...
  def list(params: ParamsResourceFoldersLocationsReplaysResultsList): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1ListReplayResultsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceFoldersLocationsReplaysResultsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1ListReplayResultsResponse] = js.native
  def list(
    params: ParamsResourceFoldersLocationsReplaysResultsList,
