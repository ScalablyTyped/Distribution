...
trait SchemaGoogleCloudPolicysimulatorV1AccessTuple extends StObject {
...
object SchemaGoogleCloudPolicysimulatorV1AccessTuple {
  
  inline def apply(): SchemaGoogleCloudPolicysimulatorV1AccessTuple = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicysimulatorV1AccessTuple]
  }
  
  extension [Self <: SchemaGoogleCloudPolicysimulatorV1AccessTuple](x: Self) {
