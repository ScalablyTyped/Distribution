...
@js.native
trait AnonDisplayNameEmailFederatedId extends js.Object {
...
object AnonDisplayNameEmailFederatedId {
  @scala.inline
  def apply(
  ...
  ): AnonDisplayNameEmailFederatedId = {
    ...
    __obj.asInstanceOf[AnonDisplayNameEmailFederatedId]
  }
}
