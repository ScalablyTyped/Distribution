...
object SchemaAudiencesFeed {
  ...
  inline def apply(): SchemaAudiencesFeed = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAudiencesFeed]
  }
  
  extension [Self <: SchemaAudiencesFeed](x: Self) {
    
    inline def setEtag(value: String): Self = StObject.set(x, "etag", value.asInstanceOf[js.Any])
    
    inline def setEtagUndefined: Self = StObject.set(x, "etag", js.undefined)
    
    inline def setItems(value: js.Array[SchemaAudience]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaAudience*): Self = StObject.set(x, "items", js.Array(value :_*))
