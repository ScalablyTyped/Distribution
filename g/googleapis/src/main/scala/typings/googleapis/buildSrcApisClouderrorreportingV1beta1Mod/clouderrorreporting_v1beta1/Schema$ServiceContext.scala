...
/**
  ...
  */
@js.native
trait Schema$ServiceContext extends js.Object {
  /**
...
object Schema$ServiceContext {
  @scala.inline
  def apply(resourceType: String = null, service: String = null, version: String = null): Schema$ServiceContext = {
    val __obj = js.Dynamic.literal()
    if (resourceType != null) __obj.updateDynamic("resourceType")(resourceType.asInstanceOf[js.Any])
    if (service != null) __obj.updateDynamic("service")(service.asInstanceOf[js.Any])
    if (version != null) __obj.updateDynamic("version")(version.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ServiceContext]
  }
}
