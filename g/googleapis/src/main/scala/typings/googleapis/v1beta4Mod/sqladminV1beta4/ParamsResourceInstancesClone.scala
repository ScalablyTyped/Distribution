...
object ParamsResourceInstancesClone {
  ...
  @scala.inline
  implicit class ParamsResourceInstancesCloneOps[Self <: ParamsResourceInstancesClone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaInstancesCloneRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
