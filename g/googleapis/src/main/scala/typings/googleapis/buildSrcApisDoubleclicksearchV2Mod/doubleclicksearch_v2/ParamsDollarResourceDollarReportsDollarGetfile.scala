...
@js.native
trait ParamsDollarResourceDollarReportsDollarGetfile extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarReportsDollarGetfile {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarReportsDollarGetfile = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarReportsDollarGetfile]
  }
}
