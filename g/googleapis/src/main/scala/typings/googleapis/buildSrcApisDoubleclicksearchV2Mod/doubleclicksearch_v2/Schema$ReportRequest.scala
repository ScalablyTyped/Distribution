...
import typings.googleapis.Anon_AdGroupId
import typings.googleapis.Anon_ChangedAttributesSinceTimestamp
import typings.googleapis.Anon_Column
import typings.googleapis.Anon_ColumnSortOrder
...
trait Schema$ReportRequest extends js.Object {
  /**
    ...
    */
  var columns: js.UndefOr[js.Array[Schema$ReportApiColumnSpec]] = js.native
  /**
  ...
  /**
    ...
    */
  var filters: js.UndefOr[js.Array[Anon_Column]] = js.native
  /**
  ...
  /**
    ...
    */
  var orderBy: js.UndefOr[js.Array[Anon_ColumnSortOrder]] = js.native
  /**
    ...
    */
  var reportScope: js.UndefOr[Anon_AdGroupId] = js.native
  /**
  ...
  /**
    ...
    */
  var timeRange: js.UndefOr[Anon_ChangedAttributesSinceTimestamp] = js.native
  /**
...
object Schema$ReportRequest {
  @scala.inline
  def apply(
    columns: js.Array[Schema$ReportApiColumnSpec] = null,
