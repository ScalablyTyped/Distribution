...
/**
  ...
  */
@js.native
trait Schema$ReportApiColumnSpec extends js.Object {
  /**
...
object Schema$ReportApiColumnSpec {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$ReportApiColumnSpec]
  }
}
