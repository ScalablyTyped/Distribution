...
@js.native
trait ParamsDollarResourceDollarProjectsDollarSubscriptionsDollarPatch extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$UpdateSubscriptionRequest] = js.native
}
