...
trait ParamsResourceEditsDetailsPatch
  extends StObject
...
object ParamsResourceEditsDetailsPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceEditsDetailsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsDetailsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceEditsDetailsPatchMutableBuilder[Self <: ParamsResourceEditsDetailsPatch] (val x: Self) extends AnyVal {
