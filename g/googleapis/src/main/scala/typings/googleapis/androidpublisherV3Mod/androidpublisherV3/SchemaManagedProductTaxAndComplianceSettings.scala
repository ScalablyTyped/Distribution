...
trait SchemaManagedProductTaxAndComplianceSettings extends StObject {
...
object SchemaManagedProductTaxAndComplianceSettings {
  
  inline def apply(): SchemaManagedProductTaxAndComplianceSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaManagedProductTaxAndComplianceSettings]
  }
  
  extension [Self <: SchemaManagedProductTaxAndComplianceSettings](x: Self) {
