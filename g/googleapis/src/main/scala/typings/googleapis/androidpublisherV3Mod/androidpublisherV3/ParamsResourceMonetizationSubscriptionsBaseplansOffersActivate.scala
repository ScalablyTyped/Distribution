...
trait ParamsResourceMonetizationSubscriptionsBaseplansOffersActivate
  extends StObject
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaActivateSubscriptionOfferRequest] = js.undefined
}
object ParamsResourceMonetizationSubscriptionsBaseplansOffersActivate {
  
  inline def apply(): ParamsResourceMonetizationSubscriptionsBaseplansOffersActivate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceMonetizationSubscriptionsBaseplansOffersActivate]
  }
  
  extension [Self <: ParamsResourceMonetizationSubscriptionsBaseplansOffersActivate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaActivateSubscriptionOfferRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
