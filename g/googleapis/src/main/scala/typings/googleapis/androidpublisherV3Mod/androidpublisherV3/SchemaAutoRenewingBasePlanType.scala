...
trait SchemaAutoRenewingBasePlanType extends StObject {
  ...
  /**
    ...
    */
  var gracePeriodDuration: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var legacyCompatible: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var prorationMode: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var resubscribeState: js.UndefOr[String | Null] = js.undefined
}
object SchemaAutoRenewingBasePlanType {
  
  inline def apply(): SchemaAutoRenewingBasePlanType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAutoRenewingBasePlanType]
  }
  
  extension [Self <: SchemaAutoRenewingBasePlanType](x: Self) {
    ...
    inline def setGracePeriodDurationNull: Self = StObject.set(x, "gracePeriodDuration", null)
    ...
    inline def setLegacyCompatibleNull: Self = StObject.set(x, "legacyCompatible", null)
    ...
    inline def setProrationModeNull: Self = StObject.set(x, "prorationMode", null)
    ...
    inline def setResubscribeStateNull: Self = StObject.set(x, "resubscribeState", null)
