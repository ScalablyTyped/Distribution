...
object ParamsResourceEditsTracksPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceEditsTracksPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsTracksPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceEditsTracksPatchMutableBuilder[Self <: ParamsResourceEditsTracksPatch] (val x: Self) extends AnyVal {
