...
trait ParamsResourceMonetizationSubscriptionsBaseplansOffersGet
  extends StObject
...
object ParamsResourceMonetizationSubscriptionsBaseplansOffersGet {
  
  inline def apply(): ParamsResourceMonetizationSubscriptionsBaseplansOffersGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceMonetizationSubscriptionsBaseplansOffersGet]
  }
  
  extension [Self <: ParamsResourceMonetizationSubscriptionsBaseplansOffersGet](x: Self) {
