...
trait ParamsResourceSystemapksVariantsGet
  extends StObject
...
object ParamsResourceSystemapksVariantsGet {
  
  inline def apply(): ParamsResourceSystemapksVariantsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSystemapksVariantsGet]
  }
  
  extension [Self <: ParamsResourceSystemapksVariantsGet](x: Self) {
