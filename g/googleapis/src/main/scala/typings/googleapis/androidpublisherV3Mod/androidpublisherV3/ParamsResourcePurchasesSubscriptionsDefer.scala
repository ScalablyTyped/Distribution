...
object ParamsResourcePurchasesSubscriptionsDefer {
  ...
  @scala.inline
  implicit class ParamsResourcePurchasesSubscriptionsDeferOps[Self <: ParamsResourcePurchasesSubscriptionsDefer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaSubscriptionPurchasesDeferRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
