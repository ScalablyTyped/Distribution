...
trait ParamsResourceGrantsCreate
  extends StObject
...
object ParamsResourceGrantsCreate {
  
  inline def apply(): ParamsResourceGrantsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceGrantsCreate]
  }
  
  extension [Self <: ParamsResourceGrantsCreate](x: Self) {
