...
trait ParamsResourceMonetizationSubscriptionsList
  extends StObject
  ...
  /**
    ...
    */
  var showArchived: js.UndefOr[Boolean] = js.undefined
}
object ParamsResourceMonetizationSubscriptionsList {
  
  inline def apply(): ParamsResourceMonetizationSubscriptionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceMonetizationSubscriptionsList]
  }
  
  extension [Self <: ParamsResourceMonetizationSubscriptionsList](x: Self) {
    ...
    inline def setShowArchived(value: Boolean): Self = StObject.set(x, "showArchived", value.asInstanceOf[js.Any])
    
    inline def setShowArchivedUndefined: Self = StObject.set(x, "showArchived", js.undefined)
  }
}
