...
trait ParamsResourceBackendbucketsSetedgesecuritypolicy
  extends StObject
...
object ParamsResourceBackendbucketsSetedgesecuritypolicy {
  
  inline def apply(): ParamsResourceBackendbucketsSetedgesecuritypolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBackendbucketsSetedgesecuritypolicy]
  }
  
  extension [Self <: ParamsResourceBackendbucketsSetedgesecuritypolicy](x: Self) {
