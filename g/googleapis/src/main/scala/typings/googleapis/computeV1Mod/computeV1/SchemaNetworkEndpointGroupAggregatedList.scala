...
trait SchemaNetworkEndpointGroupAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaNetworkEndpointGroupsScopedList] | Null] = js.undefined
...
object SchemaNetworkEndpointGroupAggregatedList {
  ...
  inline def apply(): SchemaNetworkEndpointGroupAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaNetworkEndpointGroupAggregatedList]
  }
  
  extension [Self <: SchemaNetworkEndpointGroupAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaNetworkEndpointGroupsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
