...
trait ParamsResourceTargethttpsproxiesSeturlmap
  extends StObject
...
object ParamsResourceTargethttpsproxiesSeturlmap {
  ...
  inline def apply(): ParamsResourceTargethttpsproxiesSeturlmap = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTargethttpsproxiesSeturlmap]
  }
  
  extension [Self <: ParamsResourceTargethttpsproxiesSeturlmap](x: Self) {
