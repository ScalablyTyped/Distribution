...
trait ParamsResourceBackendservicesSetedgesecuritypolicy
  extends StObject
...
object ParamsResourceBackendservicesSetedgesecuritypolicy {
  
  inline def apply(): ParamsResourceBackendservicesSetedgesecuritypolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBackendservicesSetedgesecuritypolicy]
  }
  
  extension [Self <: ParamsResourceBackendservicesSetedgesecuritypolicy](x: Self) {
