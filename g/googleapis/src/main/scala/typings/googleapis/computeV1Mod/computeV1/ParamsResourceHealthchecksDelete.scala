...
@js.native
trait ParamsResourceHealthchecksDelete extends StandardParameters {
...
object ParamsResourceHealthchecksDelete {
  
  @scala.inline
  def apply(): ParamsResourceHealthchecksDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceHealthchecksDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceHealthchecksDeleteMutableBuilder[Self <: ParamsResourceHealthchecksDelete] (val x: Self) extends AnyVal {
