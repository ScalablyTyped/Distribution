...
trait SchemaGlobalOrganizationSetPolicyRequest extends StObject {
...
object SchemaGlobalOrganizationSetPolicyRequest {
  
  inline def apply(): SchemaGlobalOrganizationSetPolicyRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGlobalOrganizationSetPolicyRequest]
  }
  
  extension [Self <: SchemaGlobalOrganizationSetPolicyRequest](x: Self) {
