...
object SchemaNodeGroupAggregatedList {
  ...
  @scala.inline
  implicit class SchemaNodeGroupAggregatedListOps[Self <: SchemaNodeGroupAggregatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: StringDictionary[SchemaNodeGroupsScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
