...
trait SchemaNodeGroupAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaNodeGroupsScopedList] | Null] = js.undefined
...
object SchemaNodeGroupAggregatedList {
  ...
  inline def apply(): SchemaNodeGroupAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaNodeGroupAggregatedList]
  }
  
  extension [Self <: SchemaNodeGroupAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaNodeGroupsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
