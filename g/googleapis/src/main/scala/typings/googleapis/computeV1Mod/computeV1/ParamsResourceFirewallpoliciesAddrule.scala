...
trait ParamsResourceFirewallpoliciesAddrule
  extends StObject
...
object ParamsResourceFirewallpoliciesAddrule {
  
  inline def apply(): ParamsResourceFirewallpoliciesAddrule = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFirewallpoliciesAddrule]
  }
  
  extension [Self <: ParamsResourceFirewallpoliciesAddrule](x: Self) {
