...
trait SchemaSecurityPoliciesAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaSecurityPoliciesScopedList] | Null] = js.undefined
...
object SchemaSecurityPoliciesAggregatedList {
  
  inline def apply(): SchemaSecurityPoliciesAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSecurityPoliciesAggregatedList]
  }
  
  extension [Self <: SchemaSecurityPoliciesAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaSecurityPoliciesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
