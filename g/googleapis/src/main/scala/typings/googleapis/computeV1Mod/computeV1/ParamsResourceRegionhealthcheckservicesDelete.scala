...
trait ParamsResourceRegionhealthcheckservicesDelete
  extends StObject
...
object ParamsResourceRegionhealthcheckservicesDelete {
  
  inline def apply(): ParamsResourceRegionhealthcheckservicesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionhealthcheckservicesDelete]
  }
  
  extension [Self <: ParamsResourceRegionhealthcheckservicesDelete](x: Self) {
