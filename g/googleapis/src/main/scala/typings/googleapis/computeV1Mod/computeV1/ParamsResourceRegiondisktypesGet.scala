...
@js.native
trait ParamsResourceRegiondisktypesGet extends StandardParameters {
  /**
...
object ParamsResourceRegiondisktypesGet {
  ...
  @scala.inline
  implicit class ParamsResourceRegiondisktypesGetOps[Self <: ParamsResourceRegiondisktypesGet] (val x: Self) extends AnyVal {
    @scala.inline
