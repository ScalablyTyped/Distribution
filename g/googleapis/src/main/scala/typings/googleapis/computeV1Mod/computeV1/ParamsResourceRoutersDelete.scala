...
trait ParamsResourceRoutersDelete
  extends StObject
...
object ParamsResourceRoutersDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceRoutersDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRoutersDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceRoutersDeleteMutableBuilder[Self <: ParamsResourceRoutersDelete] (val x: Self) extends AnyVal {
