...
trait SchemaPacketMirroringAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaPacketMirroringsScopedList] | Null] = js.undefined
...
object SchemaPacketMirroringAggregatedList {
  
  inline def apply(): SchemaPacketMirroringAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPacketMirroringAggregatedList]
  }
  
  extension [Self <: SchemaPacketMirroringAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaPacketMirroringsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
