...
trait SchemaSslCertificateAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaSslCertificatesScopedList] | Null] = js.undefined
...
object SchemaSslCertificateAggregatedList {
  
  inline def apply(): SchemaSslCertificateAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSslCertificateAggregatedList]
  }
  
  extension [Self <: SchemaSslCertificateAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaSslCertificatesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
