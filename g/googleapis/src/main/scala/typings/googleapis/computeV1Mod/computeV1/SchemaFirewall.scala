...
trait SchemaFirewall extends StObject {
  ...
  /**
    ...
    */
  var allowed: js.UndefOr[js.Array[IPProtocol] | Null] = js.undefined
  ...
  /**
    ...
    */
  var denied: js.UndefOr[js.Array[IPProtocol] | Null] = js.undefined
  ...
  /**
    ...
    */
  var destinationRanges: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var sourceRanges: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var sourceServiceAccounts: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var sourceTags: js.UndefOr[js.Array[String] | Null] = js.undefined
...
object SchemaFirewall {
  ...
  extension [Self <: SchemaFirewall](x: Self) {
    ...
    inline def setDeniedNull: Self = StObject.set(x, "denied", null)
    ...
    inline def setDestinationRangesNull: Self = StObject.set(x, "destinationRanges", null)
    ...
    inline def setSourceRangesNull: Self = StObject.set(x, "sourceRanges", null)
    ...
    inline def setSourceServiceAccountsNull: Self = StObject.set(x, "sourceServiceAccounts", null)
    ...
    inline def setSourceTagsNull: Self = StObject.set(x, "sourceTags", null)
