...
@js.native
trait ParamsResourceTargetinstancesDelete extends StandardParameters {
...
object ParamsResourceTargetinstancesDelete {
  
  @scala.inline
  def apply(): ParamsResourceTargetinstancesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTargetinstancesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceTargetinstancesDeleteMutableBuilder[Self <: ParamsResourceTargetinstancesDelete] (val x: Self) extends AnyVal {
