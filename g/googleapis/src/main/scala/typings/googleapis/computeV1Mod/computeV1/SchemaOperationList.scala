...
object SchemaOperationList {
  ...
  inline def apply(): SchemaOperationList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOperationList]
  }
  
  extension [Self <: SchemaOperationList](x: Self) {
    ...
    inline def setItemsVarargs(value: SchemaOperation*): Self = StObject.set(x, "items", js.Array(value :_*))
