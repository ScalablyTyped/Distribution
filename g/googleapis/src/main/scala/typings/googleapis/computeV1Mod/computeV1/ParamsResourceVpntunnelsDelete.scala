...
trait ParamsResourceVpntunnelsDelete
  extends StObject
...
object ParamsResourceVpntunnelsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceVpntunnelsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceVpntunnelsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceVpntunnelsDeleteMutableBuilder[Self <: ParamsResourceVpntunnelsDelete] (val x: Self) extends AnyVal {
