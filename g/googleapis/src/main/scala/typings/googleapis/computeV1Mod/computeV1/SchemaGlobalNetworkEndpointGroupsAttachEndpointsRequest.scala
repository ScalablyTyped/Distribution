...
trait SchemaGlobalNetworkEndpointGroupsAttachEndpointsRequest extends StObject {
...
object SchemaGlobalNetworkEndpointGroupsAttachEndpointsRequest {
  
  inline def apply(): SchemaGlobalNetworkEndpointGroupsAttachEndpointsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGlobalNetworkEndpointGroupsAttachEndpointsRequest]
  }
  
  extension [Self <: SchemaGlobalNetworkEndpointGroupsAttachEndpointsRequest](x: Self) {
