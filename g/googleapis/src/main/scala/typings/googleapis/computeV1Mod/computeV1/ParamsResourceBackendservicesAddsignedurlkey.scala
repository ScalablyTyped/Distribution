...
trait ParamsResourceBackendservicesAddsignedurlkey
  extends StObject
...
object ParamsResourceBackendservicesAddsignedurlkey {
  ...
  inline def apply(): ParamsResourceBackendservicesAddsignedurlkey = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBackendservicesAddsignedurlkey]
  }
  
  extension [Self <: ParamsResourceBackendservicesAddsignedurlkey](x: Self) {
