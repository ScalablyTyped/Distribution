...
trait SchemaUrlMapsAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaUrlMapsScopedList] | Null] = js.undefined
...
object SchemaUrlMapsAggregatedList {
  ...
  inline def apply(): SchemaUrlMapsAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaUrlMapsAggregatedList]
  }
  
  extension [Self <: SchemaUrlMapsAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaUrlMapsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
