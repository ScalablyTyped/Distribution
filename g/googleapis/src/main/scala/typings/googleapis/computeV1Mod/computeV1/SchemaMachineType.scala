...
trait SchemaMachineType extends StObject {
  ...
  /**
    ...
    */
  var imageSpaceGb: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var scratchDisks: js.UndefOr[js.Array[DiskGb] | Null] = js.undefined
...
object SchemaMachineType {
  ...
  extension [Self <: SchemaMachineType](x: Self) {
    ...
    inline def setImageSpaceGbNull: Self = StObject.set(x, "imageSpaceGb", null)
    ...
    inline def setScratchDisksNull: Self = StObject.set(x, "scratchDisks", null)
