...
trait SchemaDiskAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaDisksScopedList] | Null] = js.undefined
...
object SchemaDiskAggregatedList {
  ...
  inline def apply(): SchemaDiskAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDiskAggregatedList]
  }
  
  extension [Self <: SchemaDiskAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaDisksScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
