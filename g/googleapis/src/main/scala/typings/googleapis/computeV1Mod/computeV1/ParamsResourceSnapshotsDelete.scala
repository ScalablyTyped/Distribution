...
@js.native
trait ParamsResourceSnapshotsDelete extends StandardParameters {
...
object ParamsResourceSnapshotsDelete {
  
  @scala.inline
  def apply(): ParamsResourceSnapshotsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSnapshotsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceSnapshotsDeleteMutableBuilder[Self <: ParamsResourceSnapshotsDelete] (val x: Self) extends AnyVal {
