...
object ParamsResourceRegiondisksInsert {
  ...
  inline def apply(): ParamsResourceRegiondisksInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegiondisksInsert]
  }
  
  extension [Self <: ParamsResourceRegiondisksInsert](x: Self) {
    ...
    inline def setRequestBody(value: SchemaDisk): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
