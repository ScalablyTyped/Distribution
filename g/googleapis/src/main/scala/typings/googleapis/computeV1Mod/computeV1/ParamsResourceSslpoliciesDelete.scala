...
@js.native
trait ParamsResourceSslpoliciesDelete extends StandardParameters {
...
object ParamsResourceSslpoliciesDelete {
  
  @scala.inline
  def apply(): ParamsResourceSslpoliciesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSslpoliciesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceSslpoliciesDeleteMutableBuilder[Self <: ParamsResourceSslpoliciesDelete] (val x: Self) extends AnyVal {
