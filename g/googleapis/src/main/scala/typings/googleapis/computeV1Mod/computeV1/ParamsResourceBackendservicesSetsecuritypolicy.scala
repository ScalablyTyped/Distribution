...
@js.native
trait ParamsResourceBackendservicesSetsecuritypolicy extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaSecurityPolicyReference] = js.native
...
object ParamsResourceBackendservicesSetsecuritypolicy {
  ...
  @scala.inline
  def apply(): ParamsResourceBackendservicesSetsecuritypolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBackendservicesSetsecuritypolicy]
  }
  
  @scala.inline
  implicit class ParamsResourceBackendservicesSetsecuritypolicyMutableBuilder[Self <: ParamsResourceBackendservicesSetsecuritypolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaSecurityPolicyReference): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
