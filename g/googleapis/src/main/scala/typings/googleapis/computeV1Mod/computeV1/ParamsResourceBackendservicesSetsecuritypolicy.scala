...
object ParamsResourceBackendservicesSetsecuritypolicy {
  ...
  @scala.inline
  implicit class ParamsResourceBackendservicesSetsecuritypolicyOps[Self <: ParamsResourceBackendservicesSetsecuritypolicy] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaSecurityPolicyReference): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
