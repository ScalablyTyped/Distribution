...
trait SchemaNetworkEdgeSecurityServiceAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaNetworkEdgeSecurityServicesScopedList] | Null] = js.undefined
...
object SchemaNetworkEdgeSecurityServiceAggregatedList {
  
  inline def apply(): SchemaNetworkEdgeSecurityServiceAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaNetworkEdgeSecurityServiceAggregatedList]
  }
  
  extension [Self <: SchemaNetworkEdgeSecurityServiceAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaNetworkEdgeSecurityServicesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
