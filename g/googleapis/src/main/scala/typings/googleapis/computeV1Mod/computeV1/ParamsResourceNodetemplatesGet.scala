...
@js.native
trait ParamsResourceNodetemplatesGet extends StandardParameters {
...
object ParamsResourceNodetemplatesGet {
  ...
  @scala.inline
  def apply(): ParamsResourceNodetemplatesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodetemplatesGet]
  }
  
  @scala.inline
  implicit class ParamsResourceNodetemplatesGetMutableBuilder[Self <: ParamsResourceNodetemplatesGet] (val x: Self) extends AnyVal {
