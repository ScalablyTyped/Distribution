...
@js.native
trait ParamsResourceSecuritypoliciesDelete extends StandardParameters {
...
object ParamsResourceSecuritypoliciesDelete {
  
  @scala.inline
  def apply(): ParamsResourceSecuritypoliciesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSecuritypoliciesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceSecuritypoliciesDeleteMutableBuilder[Self <: ParamsResourceSecuritypoliciesDelete] (val x: Self) extends AnyVal {
