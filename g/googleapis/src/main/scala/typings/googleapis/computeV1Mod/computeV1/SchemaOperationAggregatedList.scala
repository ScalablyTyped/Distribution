...
object SchemaOperationAggregatedList {
  ...
  @scala.inline
  implicit class SchemaOperationAggregatedListOps[Self <: SchemaOperationAggregatedList] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItems(value: StringDictionary[SchemaOperationsScopedList]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
