...
trait SchemaOperationAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaOperationsScopedList] | Null] = js.undefined
...
object SchemaOperationAggregatedList {
  ...
  inline def apply(): SchemaOperationAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOperationAggregatedList]
  }
  
  extension [Self <: SchemaOperationAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaOperationsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
