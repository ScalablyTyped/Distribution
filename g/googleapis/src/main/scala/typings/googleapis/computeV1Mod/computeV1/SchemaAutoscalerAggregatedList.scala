...
trait SchemaAutoscalerAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaAutoscalersScopedList] | Null] = js.undefined
...
object SchemaAutoscalerAggregatedList {
  ...
  inline def apply(): SchemaAutoscalerAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAutoscalerAggregatedList]
  }
  
  extension [Self <: SchemaAutoscalerAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaAutoscalersScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
