...
trait SchemaTargetHttpProxyAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaTargetHttpProxiesScopedList] | Null] = js.undefined
...
object SchemaTargetHttpProxyAggregatedList {
  ...
  inline def apply(): SchemaTargetHttpProxyAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaTargetHttpProxyAggregatedList]
  }
  
  extension [Self <: SchemaTargetHttpProxyAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaTargetHttpProxiesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
