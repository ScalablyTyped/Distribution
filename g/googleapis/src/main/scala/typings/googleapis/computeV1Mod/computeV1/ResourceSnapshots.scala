...
@JSImport("googleapis/build/src/apis/compute/v1", "compute_v1.Resource$Snapshots")
@js.native
class ResourceSnapshots protected () extends StObject {
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaSnapshotList] = js.native
