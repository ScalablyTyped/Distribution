...
trait ParamsResourceFirewallpoliciesPatchrule
  extends StObject
...
object ParamsResourceFirewallpoliciesPatchrule {
  
  inline def apply(): ParamsResourceFirewallpoliciesPatchrule = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFirewallpoliciesPatchrule]
  }
  
  extension [Self <: ParamsResourceFirewallpoliciesPatchrule](x: Self) {
