...
trait SchemaBackendServiceAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaBackendServicesScopedList] | Null] = js.undefined
...
object SchemaBackendServiceAggregatedList {
  ...
  inline def apply(): SchemaBackendServiceAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBackendServiceAggregatedList]
  }
  
  extension [Self <: SchemaBackendServiceAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaBackendServicesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
