...
trait ParamsResourceServiceattachmentsList
  extends StObject
...
object ParamsResourceServiceattachmentsList {
  
  inline def apply(): ParamsResourceServiceattachmentsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceServiceattachmentsList]
  }
  
  extension [Self <: ParamsResourceServiceattachmentsList](x: Self) {
