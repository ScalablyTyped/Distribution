...
trait SchemaInterconnectAttachmentAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaInterconnectAttachmentsScopedList] | Null] = js.undefined
...
object SchemaInterconnectAttachmentAggregatedList {
  ...
  inline def apply(): SchemaInterconnectAttachmentAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInterconnectAttachmentAggregatedList]
  }
  
  extension [Self <: SchemaInterconnectAttachmentAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaInterconnectAttachmentsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
