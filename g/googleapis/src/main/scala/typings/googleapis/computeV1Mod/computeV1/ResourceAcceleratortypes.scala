...
@js.native
class ResourceAcceleratortypes protected () extends StObject {
  ...
  def aggregatedList(
    params: ParamsResourceAcceleratortypesAggregatedlist,
    options: BodyResponseCallback[SchemaAcceleratorTypeAggregatedList],
    callback: BodyResponseCallback[SchemaAcceleratorTypeAggregatedList]
  ): Unit = js.native
  ...
  /**
    ...
    *     acceleratorType: 'my-accelerator-type',  // TODO: Update placeholder
    * value.
    *
    *     auth: authClient,
    *   };
  ...
  def list(
    params: ParamsResourceAcceleratortypesList,
    options: BodyResponseCallback[SchemaAcceleratorTypeList],
    callback: BodyResponseCallback[SchemaAcceleratorTypeList]
  ): Unit = js.native
