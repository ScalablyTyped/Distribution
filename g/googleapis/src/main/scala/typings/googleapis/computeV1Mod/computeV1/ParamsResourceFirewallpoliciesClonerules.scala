...
trait ParamsResourceFirewallpoliciesClonerules
  extends StObject
...
object ParamsResourceFirewallpoliciesClonerules {
  
  inline def apply(): ParamsResourceFirewallpoliciesClonerules = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFirewallpoliciesClonerules]
  }
  
  extension [Self <: ParamsResourceFirewallpoliciesClonerules](x: Self) {
