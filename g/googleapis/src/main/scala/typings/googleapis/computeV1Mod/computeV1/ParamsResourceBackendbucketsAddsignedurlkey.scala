...
@js.native
trait ParamsResourceBackendbucketsAddsignedurlkey extends StandardParameters {
...
object ParamsResourceBackendbucketsAddsignedurlkey {
  
  @scala.inline
  def apply(): ParamsResourceBackendbucketsAddsignedurlkey = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBackendbucketsAddsignedurlkey]
  }
  
  @scala.inline
  implicit class ParamsResourceBackendbucketsAddsignedurlkeyOps[Self <: ParamsResourceBackendbucketsAddsignedurlkey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaSignedUrlKey): Self = this.set("requestBody", value.asInstanceOf[js.Any])
