...
object ParamsResourceInterconnectattachmentsGet {
  ...
  implicit class ParamsResourceInterconnectattachmentsGetOps[Self <: ParamsResourceInterconnectattachmentsGet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInterconnectAttachment(value: String): Self = this.set("interconnectAttachment", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteInterconnectAttachment: Self = this.set("interconnectAttachment", js.undefined)
