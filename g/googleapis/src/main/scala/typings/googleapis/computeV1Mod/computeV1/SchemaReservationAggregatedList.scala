...
trait SchemaReservationAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaReservationsScopedList] | Null] = js.undefined
...
object SchemaReservationAggregatedList {
  
  inline def apply(): SchemaReservationAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaReservationAggregatedList]
  }
  
  extension [Self <: SchemaReservationAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaReservationsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
