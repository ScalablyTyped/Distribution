...
trait ParamsResourceGlobalforwardingrulesList
  extends StObject
...
object ParamsResourceGlobalforwardingrulesList {
  ...
  inline def apply(): ParamsResourceGlobalforwardingrulesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceGlobalforwardingrulesList]
  }
  
  extension [Self <: ParamsResourceGlobalforwardingrulesList](x: Self) {
