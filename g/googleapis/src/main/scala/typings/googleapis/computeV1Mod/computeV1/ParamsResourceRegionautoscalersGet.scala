...
@js.native
trait ParamsResourceRegionautoscalersGet extends StandardParameters {
...
object ParamsResourceRegionautoscalersGet {
  ...
  @scala.inline
  implicit class ParamsResourceRegionautoscalersGetOps[Self <: ParamsResourceRegionautoscalersGet] (val x: Self) extends AnyVal {
