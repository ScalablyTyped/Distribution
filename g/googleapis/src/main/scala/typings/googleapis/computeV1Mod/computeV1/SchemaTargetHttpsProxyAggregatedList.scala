...
trait SchemaTargetHttpsProxyAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaTargetHttpsProxiesScopedList] | Null] = js.undefined
...
object SchemaTargetHttpsProxyAggregatedList {
  ...
  inline def apply(): SchemaTargetHttpsProxyAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaTargetHttpsProxyAggregatedList]
  }
  
  extension [Self <: SchemaTargetHttpsProxyAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaTargetHttpsProxiesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
