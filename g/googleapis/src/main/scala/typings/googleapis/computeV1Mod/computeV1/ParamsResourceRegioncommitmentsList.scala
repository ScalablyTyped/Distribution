...
trait ParamsResourceRegioncommitmentsList
  extends StObject
...
object ParamsResourceRegioncommitmentsList {
  ...
  inline def apply(): ParamsResourceRegioncommitmentsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegioncommitmentsList]
  }
  
  extension [Self <: ParamsResourceRegioncommitmentsList](x: Self) {
