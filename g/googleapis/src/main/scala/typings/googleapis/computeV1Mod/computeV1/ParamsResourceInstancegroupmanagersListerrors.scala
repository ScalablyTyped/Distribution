...
trait ParamsResourceInstancegroupmanagersListerrors
  extends StObject
...
object ParamsResourceInstancegroupmanagersListerrors {
  
  inline def apply(): ParamsResourceInstancegroupmanagersListerrors = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancegroupmanagersListerrors]
  }
  
  extension [Self <: ParamsResourceInstancegroupmanagersListerrors](x: Self) {
