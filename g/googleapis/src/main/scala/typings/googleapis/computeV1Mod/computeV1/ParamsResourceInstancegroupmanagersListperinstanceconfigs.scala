...
trait ParamsResourceInstancegroupmanagersListperinstanceconfigs
  extends StObject
...
object ParamsResourceInstancegroupmanagersListperinstanceconfigs {
  
  inline def apply(): ParamsResourceInstancegroupmanagersListperinstanceconfigs = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancegroupmanagersListperinstanceconfigs]
  }
  
  extension [Self <: ParamsResourceInstancegroupmanagersListperinstanceconfigs](x: Self) {
