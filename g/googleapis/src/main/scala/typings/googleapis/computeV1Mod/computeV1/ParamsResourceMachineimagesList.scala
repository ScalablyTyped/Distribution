...
trait ParamsResourceMachineimagesList
  extends StObject
...
object ParamsResourceMachineimagesList {
  
  inline def apply(): ParamsResourceMachineimagesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceMachineimagesList]
  }
  
  extension [Self <: ParamsResourceMachineimagesList](x: Self) {
