...
/**
  ...
  */
@js.native
trait Schema$Subnetwork extends js.Object {
  /**
  ...
  /**
    ...
    */
  var logConfig: js.UndefOr[Schema$SubnetworkLogConfig] = js.native
  /**
  ...
  /**
    ...
    * patch request.
    */
  var secondaryIpRanges: js.UndefOr[js.Array[Schema$SubnetworkSecondaryRange]] = js.native
  /**
...
object Schema$Subnetwork {
  ...
  def apply(
    ...
    kind: String = null,
    logConfig: Schema$SubnetworkLogConfig = null,
    name: String = null,
    network: String = null,
    privateIpGoogleAccess: js.UndefOr[Boolean] = js.undefined,
    region: String = null,
    secondaryIpRanges: js.Array[Schema$SubnetworkSecondaryRange] = null,
    ...
    __obj.asInstanceOf[Schema$Subnetwork]
  }
}
