...
/**
  ...
  */
@js.native
trait Schema$InterconnectLocationList extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$InterconnectLocation]] = js.native
  /**
...
object Schema$InterconnectLocationList {
  @scala.inline
  def apply(
    id: String = null,
    items: js.Array[Schema$InterconnectLocation] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$InterconnectLocationList]
  }
}
