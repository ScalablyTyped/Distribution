...
@js.native
trait ParamsDollarResourceDollarTargetinstancesDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTargetinstancesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarTargetinstancesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTargetinstancesDollarDelete]
  }
}
