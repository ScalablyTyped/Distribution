...
/**
  ...
  */
@js.native
trait Schema$ResourceCommitment extends js.Object {
  /**
...
object Schema$ResourceCommitment {
  @scala.inline
  def apply(acceleratorType: String = null, amount: String = null, `type`: String = null): Schema$ResourceCommitment = {
    ...
    __obj.asInstanceOf[Schema$ResourceCommitment]
  }
}
