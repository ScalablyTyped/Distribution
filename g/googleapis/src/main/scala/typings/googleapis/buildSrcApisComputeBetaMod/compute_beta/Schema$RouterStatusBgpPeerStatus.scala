...
@js.native
trait Schema$RouterStatusBgpPeerStatus extends js.Object {
  /**
    * Routes that were advertised to the remote BGP peer
    */
  var advertisedRoutes: js.UndefOr[js.Array[Schema$Route]] = js.native
  /**
...
object Schema$RouterStatusBgpPeerStatus {
  @scala.inline
  def apply(
    advertisedRoutes: js.Array[Schema$Route] = null,
    ...
    __obj.asInstanceOf[Schema$RouterStatusBgpPeerStatus]
  }
}
