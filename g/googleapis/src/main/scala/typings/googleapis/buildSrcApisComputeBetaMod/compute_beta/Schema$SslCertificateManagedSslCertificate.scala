...
/**
  ...
  */
@js.native
trait Schema$SslCertificateManagedSslCertificate extends js.Object {
  /**
...
object Schema$SslCertificateManagedSslCertificate {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$SslCertificateManagedSslCertificate]
  }
}
