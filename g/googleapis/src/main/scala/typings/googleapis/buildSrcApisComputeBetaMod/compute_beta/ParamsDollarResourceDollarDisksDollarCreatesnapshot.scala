...
@js.native
trait ParamsDollarResourceDollarDisksDollarCreatesnapshot extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Snapshot] = js.native
  /**
...
object ParamsDollarResourceDollarDisksDollarCreatesnapshot {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$Snapshot = null,
    requestId: String = null,
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarDisksDollarCreatesnapshot = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDisksDollarCreatesnapshot]
  }
}
