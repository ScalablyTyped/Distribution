...
/**
  ...
  */
@js.native
trait Schema$ResourcePolicySnapshotSchedulePolicySnapshotProperties extends js.Object {
  /**
...
object Schema$ResourcePolicySnapshotSchedulePolicySnapshotProperties {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$ResourcePolicySnapshotSchedulePolicySnapshotProperties]
  }
}
