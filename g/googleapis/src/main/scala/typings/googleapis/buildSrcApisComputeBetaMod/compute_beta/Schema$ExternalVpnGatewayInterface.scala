...
/**
  ...
  */
@js.native
trait Schema$ExternalVpnGatewayInterface extends js.Object {
  /**
...
object Schema$ExternalVpnGatewayInterface {
  @scala.inline
  def apply(id: Int | Double = null, ipAddress: String = null): Schema$ExternalVpnGatewayInterface = {
    val __obj = js.Dynamic.literal()
    if (id != null) __obj.updateDynamic("id")(id.asInstanceOf[js.Any])
    if (ipAddress != null) __obj.updateDynamic("ipAddress")(ipAddress.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ExternalVpnGatewayInterface]
  }
}
