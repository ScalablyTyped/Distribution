...
/**
  ...
  */
@js.native
trait Schema$Autoscaler extends js.Object {
  /**
    ...
    * to 0.6 or 60%.
    */
  var autoscalingPolicy: js.UndefOr[Schema$AutoscalingPolicy] = js.native
  /**
  ...
  /**
    ...
    */
  var statusDetails: js.UndefOr[js.Array[Schema$AutoscalerStatusDetails]] = js.native
  /**
...
object Schema$Autoscaler {
  @scala.inline
  def apply(
    autoscalingPolicy: Schema$AutoscalingPolicy = null,
    ...
    status: String = null,
    statusDetails: js.Array[Schema$AutoscalerStatusDetails] = null,
    target: String = null,
    zone: String = null
  ): Schema$Autoscaler = {
    ...
    __obj.asInstanceOf[Schema$Autoscaler]
  }
}
