...
@js.native
trait ParamsDollarResourceDollarBackendservicesDollarAddsignedurlkey extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$SignedUrlKey] = js.native
  /**
...
object ParamsDollarResourceDollarBackendservicesDollarAddsignedurlkey {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$SignedUrlKey = null,
    requestId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarBackendservicesDollarAddsignedurlkey = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarBackendservicesDollarAddsignedurlkey]
  }
}
