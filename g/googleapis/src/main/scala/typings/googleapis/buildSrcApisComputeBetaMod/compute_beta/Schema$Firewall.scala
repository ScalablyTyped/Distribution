...
import typings.googleapis.Anon_IPProtocol
...
/**
  ...
  */
@js.native
trait Schema$Firewall extends js.Object {
  /**
    * The list of ALLOW rules specified by this firewall. Each rule specifies a
    * protocol and port-range tuple that describes a permitted connection.
    */
  var allowed: js.UndefOr[js.Array[Anon_IPProtocol]] = js.native
  /**
  ...
  /**
    ...
    */
  var denied: js.UndefOr[js.Array[Anon_IPProtocol]] = js.native
  /**
  ...
  /**
    ...
    */
  var logConfig: js.UndefOr[Schema$FirewallLogConfig] = js.native
  /**
...
object Schema$Firewall {
  ...
  def apply(
    ...
    id: String = null,
    kind: String = null,
    logConfig: Schema$FirewallLogConfig = null,
    name: String = null,
    network: String = null,
    ...
    __obj.asInstanceOf[Schema$Firewall]
  }
}
