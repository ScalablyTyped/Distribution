...
/**
  ...
  */
@js.native
trait Schema$Reservation extends js.Object {
  /**
  ...
  /**
    ...
    */
  var specificReservation: js.UndefOr[Schema$AllocationSpecificSKUReservation] = js.native
  /**
...
object Schema$Reservation {
  ...
  def apply(
    ...
    specificReservation: Schema$AllocationSpecificSKUReservation = null,
    ...
    __obj.asInstanceOf[Schema$Reservation]
  }
}
