...
@JSImport("googleapis/build/src/apis/compute/beta", "compute_beta.Resource$Sslcertificates")
@js.native
class Resource$Sslcertificates protected () extends js.Object {
  ...
  /**
    ...
    *   };
    *
    *   compute.sslCertificates.testIamPermissions(request, function(err,
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarSslcertificatesDollarTestiampermissions): GaxiosPromise[Schema$TestPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsDollarResourceDollarSslcertificatesDollarTestiampermissions,
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarSslcertificatesDollarTestiampermissions, options: MethodOptions): GaxiosPromise[Schema$TestPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsDollarResourceDollarSslcertificatesDollarTestiampermissions,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$TestPermissionsResponse]
