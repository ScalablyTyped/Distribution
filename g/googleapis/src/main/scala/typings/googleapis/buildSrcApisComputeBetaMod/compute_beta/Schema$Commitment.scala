...
/**
  ...
  */
@js.native
trait Schema$Commitment extends js.Object {
  /**
  ...
  /**
    ...
    */
  var resources: js.UndefOr[js.Array[Schema$ResourceCommitment]] = js.native
  /**
...
object Schema$Commitment {
  ...
  def apply(
    ...
    plan: String = null,
    region: String = null,
    reservations: js.Array[Schema$Reservation] = null,
    resources: js.Array[Schema$ResourceCommitment] = null,
    ...
    __obj.asInstanceOf[Schema$Commitment]
  }
}
