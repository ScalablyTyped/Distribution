...
@js.native
trait ParamsDollarResourceDollarInstancesDollarSetdeletionprotection extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInstancesDollarSetdeletionprotection {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarInstancesDollarSetdeletionprotection = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInstancesDollarSetdeletionprotection]
  }
}
