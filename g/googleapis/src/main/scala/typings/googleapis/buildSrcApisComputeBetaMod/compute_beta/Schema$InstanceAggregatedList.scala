...
@js.native
trait Schema$InstanceAggregatedList extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[Schema$InstancesScopedList]] = js.native
  /**
...
object Schema$InstanceAggregatedList {
  @scala.inline
  def apply(
    id: String = null,
    items: StringDictionary[Schema$InstancesScopedList] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$InstanceAggregatedList]
  }
}
