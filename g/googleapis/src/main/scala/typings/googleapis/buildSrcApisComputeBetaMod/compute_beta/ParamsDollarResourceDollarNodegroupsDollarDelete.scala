...
@js.native
trait ParamsDollarResourceDollarNodegroupsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarNodegroupsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarNodegroupsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarNodegroupsDollarDelete]
  }
}
