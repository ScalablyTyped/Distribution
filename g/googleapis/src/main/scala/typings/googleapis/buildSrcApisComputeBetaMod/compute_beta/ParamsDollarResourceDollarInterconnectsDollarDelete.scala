...
@js.native
trait ParamsDollarResourceDollarInterconnectsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInterconnectsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarInterconnectsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInterconnectsDollarDelete]
  }
}
