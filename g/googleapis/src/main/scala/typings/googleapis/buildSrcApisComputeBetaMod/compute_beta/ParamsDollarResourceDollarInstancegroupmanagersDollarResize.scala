...
@js.native
trait ParamsDollarResourceDollarInstancegroupmanagersDollarResize extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInstancegroupmanagersDollarResize {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarInstancegroupmanagersDollarResize = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInstancegroupmanagersDollarResize]
  }
}
