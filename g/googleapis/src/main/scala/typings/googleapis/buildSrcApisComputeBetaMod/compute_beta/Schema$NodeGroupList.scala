...
/**
  ...
  */
@js.native
trait Schema$NodeGroupList extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$NodeGroup]] = js.native
  /**
...
object Schema$NodeGroupList {
  @scala.inline
  def apply(
    id: String = null,
    items: js.Array[Schema$NodeGroup] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$NodeGroupList]
  }
}
