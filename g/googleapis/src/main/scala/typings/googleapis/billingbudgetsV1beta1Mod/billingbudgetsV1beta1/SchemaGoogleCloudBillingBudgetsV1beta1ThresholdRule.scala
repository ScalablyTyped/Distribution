...
trait SchemaGoogleCloudBillingBudgetsV1beta1ThresholdRule extends StObject {
...
object SchemaGoogleCloudBillingBudgetsV1beta1ThresholdRule {
  
  inline def apply(): SchemaGoogleCloudBillingBudgetsV1beta1ThresholdRule = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBillingBudgetsV1beta1ThresholdRule]
  }
  
  extension [Self <: SchemaGoogleCloudBillingBudgetsV1beta1ThresholdRule](x: Self) {
