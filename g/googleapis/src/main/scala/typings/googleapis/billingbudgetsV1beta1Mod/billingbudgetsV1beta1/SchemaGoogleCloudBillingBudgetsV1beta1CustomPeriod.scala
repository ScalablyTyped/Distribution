...
trait SchemaGoogleCloudBillingBudgetsV1beta1CustomPeriod extends StObject {
...
object SchemaGoogleCloudBillingBudgetsV1beta1CustomPeriod {
  
  inline def apply(): SchemaGoogleCloudBillingBudgetsV1beta1CustomPeriod = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBillingBudgetsV1beta1CustomPeriod]
  }
  
  extension [Self <: SchemaGoogleCloudBillingBudgetsV1beta1CustomPeriod](x: Self) {
