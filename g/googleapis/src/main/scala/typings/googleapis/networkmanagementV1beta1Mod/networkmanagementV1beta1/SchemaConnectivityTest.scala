...
trait SchemaConnectivityTest extends StObject {
  ...
  /**
    ...
    */
  var probingDetails: js.UndefOr[SchemaProbingDetails] = js.undefined
...
object SchemaConnectivityTest {
  ...
  extension [Self <: SchemaConnectivityTest](x: Self) {
    ...
    inline def setProbingDetails(value: SchemaProbingDetails): Self = StObject.set(x, "probingDetails", value.asInstanceOf[js.Any])
    
    inline def setProbingDetailsUndefined: Self = StObject.set(x, "probingDetails", js.undefined)
