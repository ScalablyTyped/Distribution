...
/**
  ...
  */
@js.native
trait Schema$GeographicDivision extends js.Object {
  /**
...
object Schema$GeographicDivision {
  @scala.inline
  def apply(alsoKnownAs: js.Array[String] = null, name: String = null, officeIndices: js.Array[Double] = null): Schema$GeographicDivision = {
    ...
    __obj.asInstanceOf[Schema$GeographicDivision]
  }
}
