...
/**
  ...
  */
@js.native
trait Schema$ElectoralDistrict extends js.Object {
  /**
...
object Schema$ElectoralDistrict {
  @scala.inline
  def apply(id: String = null, kgForeignKey: String = null, name: String = null, scope: String = null): Schema$ElectoralDistrict = {
    ...
    __obj.asInstanceOf[Schema$ElectoralDistrict]
  }
}
