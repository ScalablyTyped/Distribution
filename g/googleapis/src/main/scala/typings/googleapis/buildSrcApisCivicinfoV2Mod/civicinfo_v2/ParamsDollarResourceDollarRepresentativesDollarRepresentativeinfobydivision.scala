...
@js.native
trait ParamsDollarResourceDollarRepresentativesDollarRepresentativeinfobydivision extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$DivisionRepresentativeInfoRequest] = js.native
  /**
...
object ParamsDollarResourceDollarRepresentativesDollarRepresentativeinfobydivision {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$DivisionRepresentativeInfoRequest = null,
    roles: js.Array[String] = null,
    userIp: String = null
  ): ParamsDollarResourceDollarRepresentativesDollarRepresentativeinfobydivision = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRepresentativesDollarRepresentativeinfobydivision]
  }
}
