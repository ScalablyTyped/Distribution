...
object SchemaVoterInfoResponse {
  ...
  inline def apply(): SchemaVoterInfoResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaVoterInfoResponse]
  }
  
  extension [Self <: SchemaVoterInfoResponse](x: Self) {
    
    inline def setContests(value: js.Array[SchemaContest]): Self = StObject.set(x, "contests", value.asInstanceOf[js.Any])
    ...
    inline def setOtherElections(value: js.Array[SchemaElection]): Self = StObject.set(x, "otherElections", value.asInstanceOf[js.Any])
