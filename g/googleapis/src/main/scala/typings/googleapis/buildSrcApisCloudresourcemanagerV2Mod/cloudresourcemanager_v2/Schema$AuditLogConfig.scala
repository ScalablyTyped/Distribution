...
/**
  ...
  */
@js.native
trait Schema$AuditLogConfig extends js.Object {
  /**
...
object Schema$AuditLogConfig {
  @scala.inline
  def apply(exemptedMembers: js.Array[String] = null, logType: String = null): Schema$AuditLogConfig = {
    ...
    __obj.asInstanceOf[Schema$AuditLogConfig]
  }
}
