...
trait ParamsResourceProjectsLocationsRuntimesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsRuntimesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsRuntimesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRuntimesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRuntimesGetiampolicy](x: Self) {
