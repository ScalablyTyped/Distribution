...
trait SchemaSchedulerAcceleratorConfig extends StObject {
...
object SchemaSchedulerAcceleratorConfig {
  
  inline def apply(): SchemaSchedulerAcceleratorConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSchedulerAcceleratorConfig]
  }
  
  extension [Self <: SchemaSchedulerAcceleratorConfig](x: Self) {
