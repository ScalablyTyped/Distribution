...
trait SchemaVirtualMachineConfig extends StObject {
  ...
  /**
    ...
    */
  var bootImage: js.UndefOr[SchemaBootImage] = js.undefined
  
  /**
    * Optional. Use a list of container images to use as Kernels in the notebook instance.
    */
  var containerImages: js.UndefOr[js.Array[SchemaContainerImage]] = js.undefined
  
  /**
    * Required. Data disk option configuration settings.
    */
  var dataDisk: js.UndefOr[SchemaLocalDisk] = js.undefined
  ...
  /**
    ...
    */
  var guestAttributes: js.UndefOr[StringDictionary[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var shieldedInstanceConfig: js.UndefOr[SchemaRuntimeShieldedInstanceConfig] = js.undefined
...
object SchemaVirtualMachineConfig {
  
  inline def apply(): SchemaVirtualMachineConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaVirtualMachineConfig]
  }
  
  extension [Self <: SchemaVirtualMachineConfig](x: Self) {
    ...
    inline def setBootImage(value: SchemaBootImage): Self = StObject.set(x, "bootImage", value.asInstanceOf[js.Any])
    
    inline def setBootImageUndefined: Self = StObject.set(x, "bootImage", js.undefined)
    
    inline def setContainerImages(value: js.Array[SchemaContainerImage]): Self = StObject.set(x, "containerImages", value.asInstanceOf[js.Any])
    
    inline def setContainerImagesUndefined: Self = StObject.set(x, "containerImages", js.undefined)
    
    inline def setContainerImagesVarargs(value: SchemaContainerImage*): Self = StObject.set(x, "containerImages", js.Array(value*))
    
    inline def setDataDisk(value: SchemaLocalDisk): Self = StObject.set(x, "dataDisk", value.asInstanceOf[js.Any])
    ...
    inline def setGuestAttributes(value: StringDictionary[String]): Self = StObject.set(x, "guestAttributes", value.asInstanceOf[js.Any])
    
    inline def setGuestAttributesNull: Self = StObject.set(x, "guestAttributes", null)
    ...
    inline def setShieldedInstanceConfig(value: SchemaRuntimeShieldedInstanceConfig): Self = StObject.set(x, "shieldedInstanceConfig", value.asInstanceOf[js.Any])
