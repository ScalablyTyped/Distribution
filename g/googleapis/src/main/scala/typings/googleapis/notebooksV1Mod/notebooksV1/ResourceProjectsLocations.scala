...
@JSImport("googleapis/build/src/apis/notebooks/v1", "notebooks_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var executions: ResourceProjectsLocationsExecutions = js.native
  ...
  var schedules: ResourceProjectsLocationsSchedules = js.native
}
