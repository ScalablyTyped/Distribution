...
@js.native
trait AnonDescriptionDiscoveryLink extends js.Object {
...
object AnonDescriptionDiscoveryLink {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonDescriptionDiscoveryLink]
  }
}
