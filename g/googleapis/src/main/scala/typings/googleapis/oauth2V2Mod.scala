...
object oauth2V2Mod {
  ...
  object oauth2V2 {
    ...
    class Oauth2 protected () extends StObject {
      ...
      def getCertForOpenIdConnect(params: Unit, options: MethodOptions): GaxiosPromise[SchemaJwk] = js.native
    ...
    trait ParamsGetcertforopenidconnect
      extends StObject
    ...
    object ParamsGetcertforopenidconnect {
      ...
      inline def apply(): ParamsGetcertforopenidconnect = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[ParamsGetcertforopenidconnect]
      }
      
      extension [Self <: ParamsGetcertforopenidconnect](x: Self) {
    ...
    object ParamsTokeninfo {
      ...
      extension [Self <: ParamsTokeninfo](x: Self) {
        ...
        inline def setToken_handle(value: String): Self = StObject.set(x, "token_handle", value.asInstanceOf[js.Any])
        
        inline def setToken_handleUndefined: Self = StObject.set(x, "token_handle", js.undefined)
      }
    }
    ...
    object SchemaJwk {
      ...
      extension [Self <: SchemaJwk](x: Self) {
        ...
        inline def setKeysVarargs(value: Alg*): Self = StObject.set(x, "keys", js.Array(value :_*))
      }
    }
