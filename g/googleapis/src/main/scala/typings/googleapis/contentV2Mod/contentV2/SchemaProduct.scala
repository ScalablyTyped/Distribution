...
object SchemaProduct {
  ...
  extension [Self <: SchemaProduct](x: Self) {
    ...
    inline def setAspects(value: js.Array[SchemaProductAspect]): Self = StObject.set(x, "aspects", value.asInstanceOf[js.Any])
    ...
    inline def setDestinations(value: js.Array[SchemaProductDestination]): Self = StObject.set(x, "destinations", value.asInstanceOf[js.Any])
