...
object ParamsResourceOrderinvoicesCreatechargeinvoice {
  ...
  @scala.inline
  implicit class ParamsResourceOrderinvoicesCreatechargeinvoiceOps[Self <: ParamsResourceOrderinvoicesCreatechargeinvoice] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaOrderinvoicesCreateChargeInvoiceRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
