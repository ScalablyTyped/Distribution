...
trait ParamsResourcePosInsert
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaPosStore] = js.undefined
...
object ParamsResourcePosInsert {
  ...
  inline def apply(): ParamsResourcePosInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePosInsert]
  }
  
  extension [Self <: ParamsResourcePosInsert](x: Self) {
    ...
    inline def setRequestBody(value: SchemaPosStore): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
