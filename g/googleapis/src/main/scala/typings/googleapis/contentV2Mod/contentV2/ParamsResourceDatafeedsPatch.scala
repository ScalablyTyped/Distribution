...
@js.native
trait ParamsResourceDatafeedsPatch extends StandardParameters {
  /**
...
object ParamsResourceDatafeedsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceDatafeedsPatchOps[Self <: ParamsResourceDatafeedsPatch] (val x: Self) extends AnyVal {
    @scala.inline
