...
object SchemaOrdersCustomBatchRequestEntryInStoreRefundLineItem {
  ...
  inline def apply(): SchemaOrdersCustomBatchRequestEntryInStoreRefundLineItem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOrdersCustomBatchRequestEntryInStoreRefundLineItem]
  }
  
  extension [Self <: SchemaOrdersCustomBatchRequestEntryInStoreRefundLineItem](x: Self) {
