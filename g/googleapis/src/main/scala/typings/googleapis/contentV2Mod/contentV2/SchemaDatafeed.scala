...
trait SchemaDatafeed extends StObject {
  ...
  /**
    ...
    */
  var intendedDestinations: js.UndefOr[js.Array[String] | Null] = js.undefined
...
object SchemaDatafeed {
  ...
  extension [Self <: SchemaDatafeed](x: Self) {
    ...
    inline def setIntendedDestinationsNull: Self = StObject.set(x, "intendedDestinations", null)
