...
trait SchemaOrdersCustomBatchRequestEntryReturnLineItem extends StObject {
...
object SchemaOrdersCustomBatchRequestEntryReturnLineItem {
  ...
  @scala.inline
  implicit class SchemaOrdersCustomBatchRequestEntryReturnLineItemMutableBuilder[Self <: SchemaOrdersCustomBatchRequestEntryReturnLineItem] (val x: Self) extends AnyVal {
