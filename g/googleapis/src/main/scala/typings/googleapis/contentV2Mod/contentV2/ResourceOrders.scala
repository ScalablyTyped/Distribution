...
class ResourceOrders protected () extends js.Object {
  ...
  def custombatch(
    params: ParamsResourceOrdersCustombatch,
    options: BodyResponseCallback[SchemaOrdersCustomBatchResponse],
    callback: BodyResponseCallback[SchemaOrdersCustomBatchResponse]
  ): Unit = js.native
  ...
  def refund(
    ...
    options: BodyResponseCallback[SchemaOrdersRefundResponse],
  ...
  def returnlineitem(
    params: ParamsResourceOrdersReturnlineitem,
    options: BodyResponseCallback[SchemaOrdersReturnLineItemResponse],
    callback: BodyResponseCallback[SchemaOrdersReturnLineItemResponse]
  ): Unit = js.native
