...
@js.native
trait SchemaInventorySetRequest extends js.Object {
...
object SchemaInventorySetRequest {
  ...
  @scala.inline
  def apply(): SchemaInventorySetRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInventorySetRequest]
  }
  
  @scala.inline
  implicit class SchemaInventorySetRequestOps[Self <: SchemaInventorySetRequest] (val x: Self) extends AnyVal {
