...
object SchemaRateGroup {
  ...
  extension [Self <: SchemaRateGroup](x: Self) {
    ...
    inline def setCarrierRatesVarargs(value: SchemaCarrierRate*): Self = StObject.set(x, "carrierRates", js.Array(value :_*))
    ...
    inline def setSubtablesVarargs(value: SchemaTable*): Self = StObject.set(x, "subtables", js.Array(value :_*))
  }
}
