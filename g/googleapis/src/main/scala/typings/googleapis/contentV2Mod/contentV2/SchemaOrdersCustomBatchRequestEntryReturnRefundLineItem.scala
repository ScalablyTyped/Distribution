...
object SchemaOrdersCustomBatchRequestEntryReturnRefundLineItem {
  ...
  @scala.inline
  def apply(): SchemaOrdersCustomBatchRequestEntryReturnRefundLineItem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOrdersCustomBatchRequestEntryReturnRefundLineItem]
  }
  
  @scala.inline
  implicit class SchemaOrdersCustomBatchRequestEntryReturnRefundLineItemMutableBuilder[Self <: SchemaOrdersCustomBatchRequestEntryReturnRefundLineItem] (val x: Self) extends AnyVal {
