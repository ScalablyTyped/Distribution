...
object SchemaOrdersCustomBatchRequestEntryReturnRefundLineItem {
  ...
  @scala.inline
  implicit class SchemaOrdersCustomBatchRequestEntryReturnRefundLineItemOps[Self <: SchemaOrdersCustomBatchRequestEntryReturnRefundLineItem] (val x: Self) extends AnyVal {
