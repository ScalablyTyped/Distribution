...
@js.native
trait SchemaOrdersReturnLineItemResponse extends StObject {
...
object SchemaOrdersReturnLineItemResponse {
  ...
  @scala.inline
  implicit class SchemaOrdersReturnLineItemResponseMutableBuilder[Self <: SchemaOrdersReturnLineItemResponse] (val x: Self) extends AnyVal {
