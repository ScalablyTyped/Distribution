...
object ParamsResourceProductstatusesCustombatch {
  ...
  @scala.inline
  implicit class ParamsResourceProductstatusesCustombatchOps[Self <: ParamsResourceProductstatusesCustombatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaProductstatusesCustomBatchRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
