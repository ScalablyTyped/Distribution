...
object ParamsResourceAccountsPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsPatchMutableBuilder[Self <: ParamsResourceAccountsPatch] (val x: Self) extends AnyVal {
