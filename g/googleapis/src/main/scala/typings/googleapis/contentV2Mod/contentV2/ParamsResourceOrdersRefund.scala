...
trait ParamsResourceOrdersRefund
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaOrdersRefundRequest] = js.undefined
}
object ParamsResourceOrdersRefund {
  ...
  extension [Self <: ParamsResourceOrdersRefund](x: Self) {
    ...
    inline def setRequestBody(value: SchemaOrdersRefundRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
