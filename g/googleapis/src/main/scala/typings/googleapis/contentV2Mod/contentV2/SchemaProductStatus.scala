...
object SchemaProductStatus {
  ...
  extension [Self <: SchemaProductStatus](x: Self) {
    ...
    inline def setDataQualityIssues(value: js.Array[SchemaProductStatusDataQualityIssue]): Self = StObject.set(x, "dataQualityIssues", value.asInstanceOf[js.Any])
    
    inline def setDataQualityIssuesUndefined: Self = StObject.set(x, "dataQualityIssues", js.undefined)
    
    inline def setDataQualityIssuesVarargs(value: SchemaProductStatusDataQualityIssue*): Self = StObject.set(x, "dataQualityIssues", js.Array(value :_*))
