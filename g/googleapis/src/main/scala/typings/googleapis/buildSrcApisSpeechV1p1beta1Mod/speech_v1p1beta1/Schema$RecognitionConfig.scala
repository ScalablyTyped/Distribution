...
/**
  ...
  */
@js.native
trait Schema$RecognitionConfig extends js.Object {
  /**
  ...
  /**
    ...
    */
  var diarizationConfig: js.UndefOr[Schema$SpeakerDiarizationConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var metadata: js.UndefOr[Schema$RecognitionMetadata] = js.native
  /**
  ...
  /**
    ...
    */
  var speechContexts: js.UndefOr[js.Array[Schema$SpeechContext]] = js.native
  /**
...
object Schema$RecognitionConfig {
  @scala.inline
  def apply(
    alternativeLanguageCodes: js.Array[String] = null,
    audioChannelCount: Int | Double = null,
    diarizationConfig: Schema$SpeakerDiarizationConfig = null,
    ...
    __obj.asInstanceOf[Schema$RecognitionConfig]
  }
}
