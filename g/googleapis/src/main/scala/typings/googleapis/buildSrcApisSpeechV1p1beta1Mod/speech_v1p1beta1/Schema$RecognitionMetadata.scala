...
/**
  ...
  */
@js.native
trait Schema$RecognitionMetadata extends js.Object {
  /**
...
object Schema$RecognitionMetadata {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$RecognitionMetadata]
  }
}
