...
/**
  ...
  */
@js.native
trait Schema$RecognitionAudio extends js.Object {
  /**
...
object Schema$RecognitionAudio {
  @scala.inline
  def apply(content: String = null, uri: String = null): Schema$RecognitionAudio = {
    val __obj = js.Dynamic.literal()
    if (content != null) __obj.updateDynamic("content")(content.asInstanceOf[js.Any])
    if (uri != null) __obj.updateDynamic("uri")(uri.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$RecognitionAudio]
  }
}
