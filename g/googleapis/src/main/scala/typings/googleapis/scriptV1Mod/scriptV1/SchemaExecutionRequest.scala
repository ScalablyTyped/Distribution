...
trait SchemaExecutionRequest extends StObject {
  ...
  /**
    ...
    */
  var devMode: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var parameters: js.UndefOr[js.Array[Any] | Null] = js.undefined
...
object SchemaExecutionRequest {
  ...
  extension [Self <: SchemaExecutionRequest](x: Self) {
    ...
    inline def setDevModeNull: Self = StObject.set(x, "devMode", null)
