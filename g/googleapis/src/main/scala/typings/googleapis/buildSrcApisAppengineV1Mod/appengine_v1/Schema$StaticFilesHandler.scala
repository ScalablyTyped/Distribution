...
/**
  ...
  */
@js.native
trait Schema$StaticFilesHandler extends js.Object {
  /**
...
object Schema$StaticFilesHandler {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$StaticFilesHandler]
  }
}
