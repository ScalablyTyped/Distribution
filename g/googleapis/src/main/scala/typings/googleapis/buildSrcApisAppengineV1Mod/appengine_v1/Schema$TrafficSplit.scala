...
/**
  ...
  */
@js.native
trait Schema$TrafficSplit extends js.Object {
  /**
...
object Schema$TrafficSplit {
  @scala.inline
  def apply(allocations: StringDictionary[Double] = null, shardBy: String = null): Schema$TrafficSplit = {
    ...
    __obj.asInstanceOf[Schema$TrafficSplit]
  }
}
