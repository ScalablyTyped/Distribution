...
trait ParamsResourceTurnbasedmatchesRematch
  extends StObject
...
object ParamsResourceTurnbasedmatchesRematch {
  ...
  inline def apply(): ParamsResourceTurnbasedmatchesRematch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTurnbasedmatchesRematch]
  }
  
  extension [Self <: ParamsResourceTurnbasedmatchesRematch](x: Self) {
