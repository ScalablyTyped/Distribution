...
object ParamsResourceAchievementsUpdatemultiple {
  ...
  def apply(
    ...
    builtinGameId: String = null,
    fields: String = null,
    key: String = null,
    oauth_token: String = null,
    prettyPrint: js.UndefOr[Boolean] = js.undefined,
    quotaUser: String = null,
    requestBody: SchemaAchievementUpdateMultipleRequest = null,
    userIp: String = null
  ): ParamsResourceAchievementsUpdatemultiple = {
    val __obj = js.Dynamic.literal()
    if (alt != null) __obj.updateDynamic("alt")(alt.asInstanceOf[js.Any])
    if (auth != null) __obj.updateDynamic("auth")(auth.asInstanceOf[js.Any])
    if (builtinGameId != null) __obj.updateDynamic("builtinGameId")(builtinGameId.asInstanceOf[js.Any])
