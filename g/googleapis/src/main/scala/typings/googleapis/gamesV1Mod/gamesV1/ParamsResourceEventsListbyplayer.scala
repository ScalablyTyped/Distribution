...
@js.native
trait ParamsResourceEventsListbyplayer extends StandardParameters {
  /**
...
object ParamsResourceEventsListbyplayer {
  ...
  @scala.inline
  implicit class ParamsResourceEventsListbyplayerOps[Self <: ParamsResourceEventsListbyplayer] (val x: Self) extends AnyVal {
    @scala.inline
