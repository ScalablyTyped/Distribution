...
@js.native
open class ResourceAchievementdefinitions protected () extends StObject {
  ...
  def list(
    params: ParamsResourceAchievementdefinitionsList,
    options: BodyResponseCallback[Readable | SchemaAchievementDefinitionsListResponse],
    callback: BodyResponseCallback[Readable | SchemaAchievementDefinitionsListResponse]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def list(params: ParamsResourceAchievementdefinitionsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceAchievementdefinitionsList,
