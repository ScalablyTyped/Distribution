...
@js.native
trait ParamsResourceQuestsAccept extends StandardParameters {
  /**
...
object ParamsResourceQuestsAccept {
  ...
  @scala.inline
  implicit class ParamsResourceQuestsAcceptOps[Self <: ParamsResourceQuestsAccept] (val x: Self) extends AnyVal {
    @scala.inline
