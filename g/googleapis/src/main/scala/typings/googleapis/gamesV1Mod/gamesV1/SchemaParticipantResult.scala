...
object SchemaParticipantResult {
  ...
  inline def apply(): SchemaParticipantResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaParticipantResult]
  }
  
  extension [Self <: SchemaParticipantResult](x: Self) {
    ...
    inline def setPlacing(value: Double): Self = StObject.set(x, "placing", value.asInstanceOf[js.Any])
    
    inline def setPlacingUndefined: Self = StObject.set(x, "placing", js.undefined)
