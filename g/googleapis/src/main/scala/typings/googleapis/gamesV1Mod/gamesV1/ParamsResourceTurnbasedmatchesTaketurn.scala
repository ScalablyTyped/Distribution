...
object ParamsResourceTurnbasedmatchesTaketurn {
  ...
  @scala.inline
  implicit class ParamsResourceTurnbasedmatchesTaketurnOps[Self <: ParamsResourceTurnbasedmatchesTaketurn] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaTurnBasedMatchTurn): Self = this.set("requestBody", value.asInstanceOf[js.Any])
