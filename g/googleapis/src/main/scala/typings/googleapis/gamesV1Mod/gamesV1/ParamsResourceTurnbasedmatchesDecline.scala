...
trait ParamsResourceTurnbasedmatchesDecline
  extends StObject
...
object ParamsResourceTurnbasedmatchesDecline {
  ...
  inline def apply(): ParamsResourceTurnbasedmatchesDecline = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTurnbasedmatchesDecline]
  }
  
  extension [Self <: ParamsResourceTurnbasedmatchesDecline](x: Self) {
