...
trait ParamsResourceFirstandthirdpartyaudiencesList
  extends StObject
...
object ParamsResourceFirstandthirdpartyaudiencesList {
  
  inline def apply(): ParamsResourceFirstandthirdpartyaudiencesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFirstandthirdpartyaudiencesList]
  }
  
  extension [Self <: ParamsResourceFirstandthirdpartyaudiencesList](x: Self) {
