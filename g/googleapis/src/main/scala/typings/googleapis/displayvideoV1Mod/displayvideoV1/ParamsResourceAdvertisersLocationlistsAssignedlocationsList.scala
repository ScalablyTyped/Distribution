...
trait ParamsResourceAdvertisersLocationlistsAssignedlocationsList
  extends StObject
...
object ParamsResourceAdvertisersLocationlistsAssignedlocationsList {
  
  inline def apply(): ParamsResourceAdvertisersLocationlistsAssignedlocationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAdvertisersLocationlistsAssignedlocationsList]
  }
  
  extension [Self <: ParamsResourceAdvertisersLocationlistsAssignedlocationsList](x: Self) {
