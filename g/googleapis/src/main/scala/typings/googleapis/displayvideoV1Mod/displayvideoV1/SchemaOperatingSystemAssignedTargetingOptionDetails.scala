...
trait SchemaOperatingSystemAssignedTargetingOptionDetails extends StObject {
...
object SchemaOperatingSystemAssignedTargetingOptionDetails {
  
  inline def apply(): SchemaOperatingSystemAssignedTargetingOptionDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOperatingSystemAssignedTargetingOptionDetails]
  }
  
  extension [Self <: SchemaOperatingSystemAssignedTargetingOptionDetails](x: Self) {
