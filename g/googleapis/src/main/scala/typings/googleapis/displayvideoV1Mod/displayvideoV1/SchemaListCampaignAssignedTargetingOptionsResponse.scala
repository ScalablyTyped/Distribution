...
trait SchemaListCampaignAssignedTargetingOptionsResponse extends StObject {
...
object SchemaListCampaignAssignedTargetingOptionsResponse {
  
  inline def apply(): SchemaListCampaignAssignedTargetingOptionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaListCampaignAssignedTargetingOptionsResponse]
  }
  
  extension [Self <: SchemaListCampaignAssignedTargetingOptionsResponse](x: Self) {
