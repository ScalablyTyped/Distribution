...
trait ParamsResourceGoogleaudiencesList
  extends StObject
...
object ParamsResourceGoogleaudiencesList {
  
  inline def apply(): ParamsResourceGoogleaudiencesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceGoogleaudiencesList]
  }
  
  extension [Self <: ParamsResourceGoogleaudiencesList](x: Self) {
