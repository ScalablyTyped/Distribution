...
trait SchemaDeviceMakeModelAssignedTargetingOptionDetails extends StObject {
...
object SchemaDeviceMakeModelAssignedTargetingOptionDetails {
  
  inline def apply(): SchemaDeviceMakeModelAssignedTargetingOptionDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDeviceMakeModelAssignedTargetingOptionDetails]
  }
  
  extension [Self <: SchemaDeviceMakeModelAssignedTargetingOptionDetails](x: Self) {
