...
trait SchemaListAdvertiserAssignedTargetingOptionsResponse extends StObject {
...
object SchemaListAdvertiserAssignedTargetingOptionsResponse {
  
  inline def apply(): SchemaListAdvertiserAssignedTargetingOptionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaListAdvertiserAssignedTargetingOptionsResponse]
  }
  
  extension [Self <: SchemaListAdvertiserAssignedTargetingOptionsResponse](x: Self) {
