...
trait SchemaInventorySource extends StObject {
  ...
  /**
    ...
    */
  var creativeConfigs: js.UndefOr[js.Array[SchemaCreativeConfig]] = js.undefined
  ...
  /**
    ...
    */
  var deliveryMethod: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var guaranteedOrderId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var inventorySourceProductType: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Denotes the type of the inventory source.
    */
  var inventorySourceType: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var rateDetails: js.UndefOr[SchemaRateDetails] = js.undefined
  ...
  /**
    ...
    */
  var readPartnerIds: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var readWriteAccessors: js.UndefOr[SchemaInventorySourceAccessors] = js.undefined
  
  /**
    * The status settings of the inventory source.
    */
  var status: js.UndefOr[SchemaInventorySourceStatus] = js.undefined
  
  /**
    * Immutable. The unique ID of the sub-site property assigned to this inventory source.
    */
  var subSitePropertyId: js.UndefOr[String | Null] = js.undefined
...
object SchemaInventorySource {
  
  inline def apply(): SchemaInventorySource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInventorySource]
  }
  
  extension [Self <: SchemaInventorySource](x: Self) {
    ...
    inline def setCreativeConfigs(value: js.Array[SchemaCreativeConfig]): Self = StObject.set(x, "creativeConfigs", value.asInstanceOf[js.Any])
    
    inline def setCreativeConfigsUndefined: Self = StObject.set(x, "creativeConfigs", js.undefined)
    
    inline def setCreativeConfigsVarargs(value: SchemaCreativeConfig*): Self = StObject.set(x, "creativeConfigs", js.Array(value*))
    ...
    inline def setDeliveryMethodNull: Self = StObject.set(x, "deliveryMethod", null)
    ...
    inline def setGuaranteedOrderIdNull: Self = StObject.set(x, "guaranteedOrderId", null)
    ...
    inline def setInventorySourceProductTypeNull: Self = StObject.set(x, "inventorySourceProductType", null)
    ...
    inline def setInventorySourceTypeNull: Self = StObject.set(x, "inventorySourceType", null)
    ...
    inline def setRateDetails(value: SchemaRateDetails): Self = StObject.set(x, "rateDetails", value.asInstanceOf[js.Any])
    ...
    inline def setReadPartnerIdsNull: Self = StObject.set(x, "readPartnerIds", null)
    ...
    inline def setReadWriteAccessors(value: SchemaInventorySourceAccessors): Self = StObject.set(x, "readWriteAccessors", value.asInstanceOf[js.Any])
    
    inline def setReadWriteAccessorsUndefined: Self = StObject.set(x, "readWriteAccessors", js.undefined)
    
    inline def setStatus(value: SchemaInventorySourceStatus): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
    ...
    inline def setSubSitePropertyIdNull: Self = StObject.set(x, "subSitePropertyId", null)
