...
trait ParamsResourcePartnersChannelsList
  extends StObject
...
object ParamsResourcePartnersChannelsList {
  
  inline def apply(): ParamsResourcePartnersChannelsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePartnersChannelsList]
  }
  
  extension [Self <: ParamsResourcePartnersChannelsList](x: Self) {
