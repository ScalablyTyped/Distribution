...
trait ParamsResourceAdvertisersNegativekeywordlistsNegativekeywordsList
  extends StObject
...
object ParamsResourceAdvertisersNegativekeywordlistsNegativekeywordsList {
  
  inline def apply(): ParamsResourceAdvertisersNegativekeywordlistsNegativekeywordsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAdvertisersNegativekeywordlistsNegativekeywordsList]
  }
  
  extension [Self <: ParamsResourceAdvertisersNegativekeywordlistsNegativekeywordsList](x: Self) {
