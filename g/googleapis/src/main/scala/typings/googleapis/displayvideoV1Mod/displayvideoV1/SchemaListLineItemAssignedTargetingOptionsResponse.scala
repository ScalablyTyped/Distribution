...
trait SchemaListLineItemAssignedTargetingOptionsResponse extends StObject {
...
object SchemaListLineItemAssignedTargetingOptionsResponse {
  
  inline def apply(): SchemaListLineItemAssignedTargetingOptionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaListLineItemAssignedTargetingOptionsResponse]
  }
  
  extension [Self <: SchemaListLineItemAssignedTargetingOptionsResponse](x: Self) {
