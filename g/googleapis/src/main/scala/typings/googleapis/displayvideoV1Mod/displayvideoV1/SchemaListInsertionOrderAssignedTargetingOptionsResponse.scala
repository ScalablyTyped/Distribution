...
trait SchemaListInsertionOrderAssignedTargetingOptionsResponse extends StObject {
...
object SchemaListInsertionOrderAssignedTargetingOptionsResponse {
  
  inline def apply(): SchemaListInsertionOrderAssignedTargetingOptionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaListInsertionOrderAssignedTargetingOptionsResponse]
  }
  
  extension [Self <: SchemaListInsertionOrderAssignedTargetingOptionsResponse](x: Self) {
