...
trait ParamsResourceAdvertisersChannelsSitesDelete
  extends StObject
...
object ParamsResourceAdvertisersChannelsSitesDelete {
  
  inline def apply(): ParamsResourceAdvertisersChannelsSitesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAdvertisersChannelsSitesDelete]
  }
  
  extension [Self <: ParamsResourceAdvertisersChannelsSitesDelete](x: Self) {
