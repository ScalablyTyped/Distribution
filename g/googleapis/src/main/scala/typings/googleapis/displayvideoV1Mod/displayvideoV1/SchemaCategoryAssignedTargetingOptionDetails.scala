...
trait SchemaCategoryAssignedTargetingOptionDetails extends StObject {
...
object SchemaCategoryAssignedTargetingOptionDetails {
  
  inline def apply(): SchemaCategoryAssignedTargetingOptionDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCategoryAssignedTargetingOptionDetails]
  }
  
  extension [Self <: SchemaCategoryAssignedTargetingOptionDetails](x: Self) {
