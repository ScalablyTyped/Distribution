...
trait ParamsResourcePartnersList
  extends StObject
...
object ParamsResourcePartnersList {
  
  inline def apply(): ParamsResourcePartnersList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePartnersList]
  }
  
  extension [Self <: ParamsResourcePartnersList](x: Self) {
