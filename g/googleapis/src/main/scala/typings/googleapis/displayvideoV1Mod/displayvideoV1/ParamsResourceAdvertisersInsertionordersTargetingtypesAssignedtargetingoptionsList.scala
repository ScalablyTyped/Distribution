...
trait ParamsResourceAdvertisersInsertionordersTargetingtypesAssignedtargetingoptionsList
  extends StObject
...
object ParamsResourceAdvertisersInsertionordersTargetingtypesAssignedtargetingoptionsList {
  
  inline def apply(): ParamsResourceAdvertisersInsertionordersTargetingtypesAssignedtargetingoptionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAdvertisersInsertionordersTargetingtypesAssignedtargetingoptionsList]
  }
  
  extension [Self <: ParamsResourceAdvertisersInsertionordersTargetingtypesAssignedtargetingoptionsList](x: Self) {
