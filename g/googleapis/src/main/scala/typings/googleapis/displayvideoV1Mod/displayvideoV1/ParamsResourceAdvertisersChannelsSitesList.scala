...
trait ParamsResourceAdvertisersChannelsSitesList
  extends StObject
...
object ParamsResourceAdvertisersChannelsSitesList {
  
  inline def apply(): ParamsResourceAdvertisersChannelsSitesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAdvertisersChannelsSitesList]
  }
  
  extension [Self <: ParamsResourceAdvertisersChannelsSitesList](x: Self) {
