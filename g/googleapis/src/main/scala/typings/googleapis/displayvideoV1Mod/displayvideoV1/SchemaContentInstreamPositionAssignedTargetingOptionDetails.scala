...
trait SchemaContentInstreamPositionAssignedTargetingOptionDetails extends StObject {
...
object SchemaContentInstreamPositionAssignedTargetingOptionDetails {
  
  inline def apply(): SchemaContentInstreamPositionAssignedTargetingOptionDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaContentInstreamPositionAssignedTargetingOptionDetails]
  }
  
  extension [Self <: SchemaContentInstreamPositionAssignedTargetingOptionDetails](x: Self) {
