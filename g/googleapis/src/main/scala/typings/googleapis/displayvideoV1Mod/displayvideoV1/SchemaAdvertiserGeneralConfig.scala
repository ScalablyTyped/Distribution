...
trait SchemaAdvertiserGeneralConfig extends StObject {
  ...
  /**
    ...
    */
  var domainUrl: js.UndefOr[String | Null] = js.undefined
...
object SchemaAdvertiserGeneralConfig {
  
  inline def apply(): SchemaAdvertiserGeneralConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAdvertiserGeneralConfig]
  }
  
  extension [Self <: SchemaAdvertiserGeneralConfig](x: Self) {
    ...
    inline def setDomainUrlNull: Self = StObject.set(x, "domainUrl", null)
