...
trait SchemaTranscode extends StObject {
  ...
  /**
    ...
    */
  var fileSizeBytes: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var transcoded: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaTranscode {
  
  inline def apply(): SchemaTranscode = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaTranscode]
  }
  
  extension [Self <: SchemaTranscode](x: Self) {
    
    inline def setAudioBitRateKbps(value: String): Self = StObject.set(x, "audioBitRateKbps", value.asInstanceOf[js.Any])
    
    inline def setAudioBitRateKbpsNull: Self = StObject.set(x, "audioBitRateKbps", null)
    ...
    inline def setAudioSampleRateHzNull: Self = StObject.set(x, "audioSampleRateHz", null)
    ...
    inline def setBitRateKbpsNull: Self = StObject.set(x, "bitRateKbps", null)
    ...
    inline def setFileSizeBytesNull: Self = StObject.set(x, "fileSizeBytes", null)
    ...
    inline def setTranscodedNull: Self = StObject.set(x, "transcoded", null)
