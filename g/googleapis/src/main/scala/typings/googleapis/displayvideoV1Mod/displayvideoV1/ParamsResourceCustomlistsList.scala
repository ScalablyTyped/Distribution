...
trait ParamsResourceCustomlistsList
  extends StObject
...
object ParamsResourceCustomlistsList {
  
  inline def apply(): ParamsResourceCustomlistsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomlistsList]
  }
  
  extension [Self <: ParamsResourceCustomlistsList](x: Self) {
