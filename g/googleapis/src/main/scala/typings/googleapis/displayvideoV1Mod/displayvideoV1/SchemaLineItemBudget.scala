...
trait SchemaLineItemBudget extends StObject {
  ...
  /**
    ...
    */
  var budgetAllocationType: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var maxAmount: js.UndefOr[String | Null] = js.undefined
}
object SchemaLineItemBudget {
  
  inline def apply(): SchemaLineItemBudget = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaLineItemBudget]
  }
  
  extension [Self <: SchemaLineItemBudget](x: Self) {
    
    inline def setBudgetAllocationType(value: String): Self = StObject.set(x, "budgetAllocationType", value.asInstanceOf[js.Any])
    
    inline def setBudgetAllocationTypeNull: Self = StObject.set(x, "budgetAllocationType", null)
    ...
    inline def setMaxAmountNull: Self = StObject.set(x, "maxAmount", null)
