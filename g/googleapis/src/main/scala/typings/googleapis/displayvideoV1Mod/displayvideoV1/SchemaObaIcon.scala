...
trait SchemaObaIcon extends StObject {
  ...
  /**
    ...
    */
  var landingPageUrl: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var resourceMimeType: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var viewTrackingUrl: js.UndefOr[String | Null] = js.undefined
}
object SchemaObaIcon {
  ...
  extension [Self <: SchemaObaIcon](x: Self) {
    ...
    inline def setLandingPageUrlNull: Self = StObject.set(x, "landingPageUrl", null)
    ...
    inline def setResourceMimeTypeNull: Self = StObject.set(x, "resourceMimeType", null)
    ...
    inline def setViewTrackingUrlNull: Self = StObject.set(x, "viewTrackingUrl", null)
