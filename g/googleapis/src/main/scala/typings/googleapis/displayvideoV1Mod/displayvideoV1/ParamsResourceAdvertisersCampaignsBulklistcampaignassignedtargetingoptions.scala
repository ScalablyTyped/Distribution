...
trait ParamsResourceAdvertisersCampaignsBulklistcampaignassignedtargetingoptions
  extends StObject
...
object ParamsResourceAdvertisersCampaignsBulklistcampaignassignedtargetingoptions {
  
  inline def apply(): ParamsResourceAdvertisersCampaignsBulklistcampaignassignedtargetingoptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAdvertisersCampaignsBulklistcampaignassignedtargetingoptions]
  }
  
  extension [Self <: ParamsResourceAdvertisersCampaignsBulklistcampaignassignedtargetingoptions](x: Self) {
