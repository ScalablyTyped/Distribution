...
trait SchemaGuaranteedOrder extends StObject {
  ...
  /**
    ...
    */
  var defaultAdvertiserId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var defaultCampaignId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var legacyGuaranteedOrderId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var readWriteAdvertiserId: js.UndefOr[String | Null] = js.undefined
  
  /**
    * The partner with read/write access to the guaranteed order.
    */
  var readWritePartnerId: js.UndefOr[String | Null] = js.undefined
  
  /**
    * The status settings of the guaranteed order.
    */
  var status: js.UndefOr[SchemaGuaranteedOrderStatus] = js.undefined
...
object SchemaGuaranteedOrder {
  
  inline def apply(): SchemaGuaranteedOrder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGuaranteedOrder]
  }
  
  extension [Self <: SchemaGuaranteedOrder](x: Self) {
    
    inline def setDefaultAdvertiserId(value: String): Self = StObject.set(x, "defaultAdvertiserId", value.asInstanceOf[js.Any])
    
    inline def setDefaultAdvertiserIdNull: Self = StObject.set(x, "defaultAdvertiserId", null)
    ...
    inline def setDefaultCampaignIdNull: Self = StObject.set(x, "defaultCampaignId", null)
    ...
    inline def setLegacyGuaranteedOrderIdNull: Self = StObject.set(x, "legacyGuaranteedOrderId", null)
    ...
    inline def setReadWriteAdvertiserIdNull: Self = StObject.set(x, "readWriteAdvertiserId", null)
    ...
    inline def setReadWritePartnerIdNull: Self = StObject.set(x, "readWritePartnerId", null)
    
    inline def setReadWritePartnerIdUndefined: Self = StObject.set(x, "readWritePartnerId", js.undefined)
    
    inline def setStatus(value: SchemaGuaranteedOrderStatus): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
