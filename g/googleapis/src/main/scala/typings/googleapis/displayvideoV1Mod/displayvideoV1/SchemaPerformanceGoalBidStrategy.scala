...
trait SchemaPerformanceGoalBidStrategy extends StObject {
...
object SchemaPerformanceGoalBidStrategy {
  
  inline def apply(): SchemaPerformanceGoalBidStrategy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPerformanceGoalBidStrategy]
  }
  
  extension [Self <: SchemaPerformanceGoalBidStrategy](x: Self) {
