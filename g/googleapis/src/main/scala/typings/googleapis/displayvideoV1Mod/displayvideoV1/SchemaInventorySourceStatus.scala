...
trait SchemaInventorySourceStatus extends StObject {
  ...
  /**
    ...
    */
  var sellerStatus: js.UndefOr[String | Null] = js.undefined
}
object SchemaInventorySourceStatus {
  
  inline def apply(): SchemaInventorySourceStatus = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInventorySourceStatus]
  }
  
  extension [Self <: SchemaInventorySourceStatus](x: Self) {
    ...
    inline def setSellerStatusNull: Self = StObject.set(x, "sellerStatus", null)
