...
trait ParamsResourceAdvertisersLineitemsBulklistlineitemassignedtargetingoptions
  extends StObject
...
object ParamsResourceAdvertisersLineitemsBulklistlineitemassignedtargetingoptions {
  
  inline def apply(): ParamsResourceAdvertisersLineitemsBulklistlineitemassignedtargetingoptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAdvertisersLineitemsBulklistlineitemassignedtargetingoptions]
  }
  
  extension [Self <: ParamsResourceAdvertisersLineitemsBulklistlineitemassignedtargetingoptions](x: Self) {
