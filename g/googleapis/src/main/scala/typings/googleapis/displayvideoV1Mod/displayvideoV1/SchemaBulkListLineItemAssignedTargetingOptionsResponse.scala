...
trait SchemaBulkListLineItemAssignedTargetingOptionsResponse extends StObject {
...
object SchemaBulkListLineItemAssignedTargetingOptionsResponse {
  
  inline def apply(): SchemaBulkListLineItemAssignedTargetingOptionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBulkListLineItemAssignedTargetingOptionsResponse]
  }
  
  extension [Self <: SchemaBulkListLineItemAssignedTargetingOptionsResponse](x: Self) {
