...
trait SchemaContentGenreAssignedTargetingOptionDetails extends StObject {
...
object SchemaContentGenreAssignedTargetingOptionDetails {
  
  inline def apply(): SchemaContentGenreAssignedTargetingOptionDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaContentGenreAssignedTargetingOptionDetails]
  }
  
  extension [Self <: SchemaContentGenreAssignedTargetingOptionDetails](x: Self) {
