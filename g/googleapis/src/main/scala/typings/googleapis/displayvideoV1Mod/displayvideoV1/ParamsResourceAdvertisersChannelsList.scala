...
trait ParamsResourceAdvertisersChannelsList
  extends StObject
...
object ParamsResourceAdvertisersChannelsList {
  
  inline def apply(): ParamsResourceAdvertisersChannelsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAdvertisersChannelsList]
  }
  
  extension [Self <: ParamsResourceAdvertisersChannelsList](x: Self) {
