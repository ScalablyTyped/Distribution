...
trait SchemaBulkListAdvertiserAssignedTargetingOptionsResponse extends StObject {
...
object SchemaBulkListAdvertiserAssignedTargetingOptionsResponse {
  
  inline def apply(): SchemaBulkListAdvertiserAssignedTargetingOptionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBulkListAdvertiserAssignedTargetingOptionsResponse]
  }
  
  extension [Self <: SchemaBulkListAdvertiserAssignedTargetingOptionsResponse](x: Self) {
