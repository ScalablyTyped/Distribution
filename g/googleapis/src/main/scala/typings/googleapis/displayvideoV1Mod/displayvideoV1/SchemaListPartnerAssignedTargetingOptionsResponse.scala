...
trait SchemaListPartnerAssignedTargetingOptionsResponse extends StObject {
...
object SchemaListPartnerAssignedTargetingOptionsResponse {
  
  inline def apply(): SchemaListPartnerAssignedTargetingOptionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaListPartnerAssignedTargetingOptionsResponse]
  }
  
  extension [Self <: SchemaListPartnerAssignedTargetingOptionsResponse](x: Self) {
