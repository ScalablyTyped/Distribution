...
trait SchemaPacing extends StObject {
  ...
  /**
    ...
    */
  var dailyMaxMicros: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var pacingPeriod: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Required. The type of pacing that defines how the budget amount will be spent across the pacing_period.
    */
  var pacingType: js.UndefOr[String | Null] = js.undefined
}
object SchemaPacing {
  
  inline def apply(): SchemaPacing = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPacing]
  }
  
  extension [Self <: SchemaPacing](x: Self) {
    
    inline def setDailyMaxImpressions(value: String): Self = StObject.set(x, "dailyMaxImpressions", value.asInstanceOf[js.Any])
    
    inline def setDailyMaxImpressionsNull: Self = StObject.set(x, "dailyMaxImpressions", null)
    ...
    inline def setDailyMaxMicrosNull: Self = StObject.set(x, "dailyMaxMicros", null)
    ...
    inline def setPacingPeriodNull: Self = StObject.set(x, "pacingPeriod", null)
    ...
    inline def setPacingTypeNull: Self = StObject.set(x, "pacingType", null)
