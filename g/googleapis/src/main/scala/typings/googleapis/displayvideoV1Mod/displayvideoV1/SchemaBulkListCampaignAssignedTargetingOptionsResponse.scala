...
trait SchemaBulkListCampaignAssignedTargetingOptionsResponse extends StObject {
...
object SchemaBulkListCampaignAssignedTargetingOptionsResponse {
  
  inline def apply(): SchemaBulkListCampaignAssignedTargetingOptionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBulkListCampaignAssignedTargetingOptionsResponse]
  }
  
  extension [Self <: SchemaBulkListCampaignAssignedTargetingOptionsResponse](x: Self) {
