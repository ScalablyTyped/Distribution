...
trait SchemaLineItemFlight extends StObject {
  ...
  /**
    ...
    */
  var flightDateType: js.UndefOr[String | Null] = js.undefined
...
object SchemaLineItemFlight {
  
  inline def apply(): SchemaLineItemFlight = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaLineItemFlight]
  }
  
  extension [Self <: SchemaLineItemFlight](x: Self) {
    ...
    inline def setFlightDateTypeNull: Self = StObject.set(x, "flightDateType", null)
