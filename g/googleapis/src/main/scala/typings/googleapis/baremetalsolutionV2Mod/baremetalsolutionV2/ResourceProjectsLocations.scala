...
@JSImport("googleapis/build/src/apis/baremetalsolution/v2", "baremetalsolution_v2.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var instanceProvisioningSettings: ResourceProjectsLocationsInstanceprovisioningsettings = js.native
  ...
  var networks: ResourceProjectsLocationsNetworks = js.native
  
  var nfsShares: ResourceProjectsLocationsNfsshares = js.native
  
  var operations: ResourceProjectsLocationsOperations = js.native
  
  var provisioningConfigs: ResourceProjectsLocationsProvisioningconfigs = js.native
  
  var provisioningQuotas: ResourceProjectsLocationsProvisioningquotas = js.native
  
  var volumes: ResourceProjectsLocationsVolumes = js.native
}
