...
object ParamsResourceEnterprisesPoliciesPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceEnterprisesPoliciesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEnterprisesPoliciesPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceEnterprisesPoliciesPatchMutableBuilder[Self <: ParamsResourceEnterprisesPoliciesPatch] (val x: Self) extends AnyVal {
