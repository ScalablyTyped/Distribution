...
trait SchemaSigninDetail extends StObject {
  ...
  /**
    ...
    */
  var signinEnrollmentToken: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var signinUrl: js.UndefOr[String | Null] = js.undefined
}
object SchemaSigninDetail {
  ...
  extension [Self <: SchemaSigninDetail](x: Self) {
    ...
    inline def setSigninEnrollmentTokenNull: Self = StObject.set(x, "signinEnrollmentToken", null)
    ...
    inline def setSigninUrlNull: Self = StObject.set(x, "signinUrl", null)
