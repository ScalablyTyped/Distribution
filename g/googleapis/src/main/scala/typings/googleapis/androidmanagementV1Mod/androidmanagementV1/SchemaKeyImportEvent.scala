...
trait SchemaKeyImportEvent extends StObject {
...
object SchemaKeyImportEvent {
  
  inline def apply(): SchemaKeyImportEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaKeyImportEvent]
  }
  
  extension [Self <: SchemaKeyImportEvent](x: Self) {
