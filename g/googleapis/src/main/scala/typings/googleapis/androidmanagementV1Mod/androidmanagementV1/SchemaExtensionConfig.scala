...
trait SchemaExtensionConfig extends StObject {
  ...
  /**
    ...
    */
  var notificationReceiver: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var signingKeyFingerprintsSha256: js.UndefOr[js.Array[String] | Null] = js.undefined
}
object SchemaExtensionConfig {
  
  inline def apply(): SchemaExtensionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaExtensionConfig]
  }
  
  extension [Self <: SchemaExtensionConfig](x: Self) {
    
    inline def setNotificationReceiver(value: String): Self = StObject.set(x, "notificationReceiver", value.asInstanceOf[js.Any])
    
    inline def setNotificationReceiverNull: Self = StObject.set(x, "notificationReceiver", null)
    ...
    inline def setSigningKeyFingerprintsSha256Null: Self = StObject.set(x, "signingKeyFingerprintsSha256", null)
