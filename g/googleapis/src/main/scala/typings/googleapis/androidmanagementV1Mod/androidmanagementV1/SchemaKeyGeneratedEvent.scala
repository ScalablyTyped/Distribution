...
trait SchemaKeyGeneratedEvent extends StObject {
...
object SchemaKeyGeneratedEvent {
  
  inline def apply(): SchemaKeyGeneratedEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaKeyGeneratedEvent]
  }
  
  extension [Self <: SchemaKeyGeneratedEvent](x: Self) {
