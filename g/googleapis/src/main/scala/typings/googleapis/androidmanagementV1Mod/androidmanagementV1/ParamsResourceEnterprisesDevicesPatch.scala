...
@js.native
trait ParamsResourceEnterprisesDevicesPatch extends StandardParameters {
...
object ParamsResourceEnterprisesDevicesPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceEnterprisesDevicesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEnterprisesDevicesPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceEnterprisesDevicesPatchMutableBuilder[Self <: ParamsResourceEnterprisesDevicesPatch] (val x: Self) extends AnyVal {
