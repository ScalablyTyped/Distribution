...
trait SchemaMediaUnmountEvent extends StObject {
...
object SchemaMediaUnmountEvent {
  
  inline def apply(): SchemaMediaUnmountEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaMediaUnmountEvent]
  }
  
  extension [Self <: SchemaMediaUnmountEvent](x: Self) {
