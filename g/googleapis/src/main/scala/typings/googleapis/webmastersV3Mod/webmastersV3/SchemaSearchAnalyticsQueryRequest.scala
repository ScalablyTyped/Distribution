...
trait SchemaSearchAnalyticsQueryRequest extends StObject {
  ...
  /**
    ...
    */
  var aggregationType: js.UndefOr[String | Null] = js.undefined
...
object SchemaSearchAnalyticsQueryRequest {
  ...
  extension [Self <: SchemaSearchAnalyticsQueryRequest](x: Self) {
    ...
    inline def setAggregationTypeNull: Self = StObject.set(x, "aggregationType", null)
    ...
    inline def setDimensionFilterGroupsVarargs(value: SchemaApiDimensionFilterGroup*): Self = StObject.set(x, "dimensionFilterGroups", js.Array(value*))
