...
trait ParamsResourceUrlcrawlerrorssamplesGet
  extends StObject
...
object ParamsResourceUrlcrawlerrorssamplesGet {
  ...
  inline def apply(): ParamsResourceUrlcrawlerrorssamplesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUrlcrawlerrorssamplesGet]
  }
  
  extension [Self <: ParamsResourceUrlcrawlerrorssamplesGet](x: Self) {
