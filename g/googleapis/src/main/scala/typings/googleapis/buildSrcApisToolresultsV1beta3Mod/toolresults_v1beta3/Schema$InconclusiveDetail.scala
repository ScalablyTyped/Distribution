...
@js.native
trait Schema$InconclusiveDetail extends js.Object {
  /**
...
object Schema$InconclusiveDetail {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$InconclusiveDetail]
  }
}
