...
/**
  ...
  */
@js.native
trait Schema$TestCaseReference extends js.Object {
  /**
...
object Schema$TestCaseReference {
  @scala.inline
  def apply(className: String = null, name: String = null, testSuiteName: String = null): Schema$TestCaseReference = {
    ...
    __obj.asInstanceOf[Schema$TestCaseReference]
  }
}
