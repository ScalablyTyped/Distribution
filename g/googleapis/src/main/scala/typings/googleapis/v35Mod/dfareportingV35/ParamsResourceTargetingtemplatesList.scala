...
trait ParamsResourceTargetingtemplatesList
  extends StObject
...
object ParamsResourceTargetingtemplatesList {
  ...
  inline def apply(): ParamsResourceTargetingtemplatesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTargetingtemplatesList]
  }
  
  extension [Self <: ParamsResourceTargetingtemplatesList](x: Self) {
