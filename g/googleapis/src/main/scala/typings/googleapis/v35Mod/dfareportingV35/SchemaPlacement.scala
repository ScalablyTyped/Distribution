...
trait SchemaPlacement extends StObject {
  ...
  /**
    ...
    */
  var partnerWrappingData: js.UndefOr[SchemaMeasurementPartnerWrappingData] = js.undefined
  ...
  /**
    ...
    */
  var wrappingOptOut: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaPlacement {
  ...
  extension [Self <: SchemaPlacement](x: Self) {
    ...
    inline def setPartnerWrappingData(value: SchemaMeasurementPartnerWrappingData): Self = StObject.set(x, "partnerWrappingData", value.asInstanceOf[js.Any])
    ...
    inline def setWrappingOptOutNull: Self = StObject.set(x, "wrappingOptOut", null)
