...
trait SchemaTagSetting extends StObject {
  ...
  /**
    ...
    */
  var additionalKeyValues: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Whether static landing page URLs should be included in the tags. This setting applies only to placements.
    */
  var includeClickThroughUrls: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * Whether click-tracking string should be included in the tags.
    */
  var includeClickTracking: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * Option specifying how keywords are embedded in ad tags. This setting can be used to specify whether keyword placeholders are inserted in placement tags for this site. Publishers can then add keywords to those placeholders.
    */
  var keywordOption: js.UndefOr[String | Null] = js.undefined
}
object SchemaTagSetting {
  ...
  extension [Self <: SchemaTagSetting](x: Self) {
    ...
    inline def setAdditionalKeyValuesNull: Self = StObject.set(x, "additionalKeyValues", null)
    ...
    inline def setIncludeClickThroughUrlsNull: Self = StObject.set(x, "includeClickThroughUrls", null)
    ...
    inline def setIncludeClickTrackingNull: Self = StObject.set(x, "includeClickTracking", null)
    ...
    inline def setKeywordOptionNull: Self = StObject.set(x, "keywordOption", null)
