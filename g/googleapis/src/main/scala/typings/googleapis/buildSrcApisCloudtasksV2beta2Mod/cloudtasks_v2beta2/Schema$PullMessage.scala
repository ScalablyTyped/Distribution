...
/**
  ...
  */
@js.native
trait Schema$PullMessage extends js.Object {
  /**
...
object Schema$PullMessage {
  @scala.inline
  def apply(payload: String = null, tag: String = null): Schema$PullMessage = {
    val __obj = js.Dynamic.literal()
    if (payload != null) __obj.updateDynamic("payload")(payload.asInstanceOf[js.Any])
    if (tag != null) __obj.updateDynamic("tag")(tag.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$PullMessage]
  }
}
