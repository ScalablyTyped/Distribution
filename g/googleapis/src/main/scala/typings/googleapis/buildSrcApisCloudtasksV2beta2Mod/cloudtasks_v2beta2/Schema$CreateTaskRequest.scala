...
/**
  ...
  */
@js.native
trait Schema$CreateTaskRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var task: js.UndefOr[Schema$Task] = js.native
}

object Schema$CreateTaskRequest {
  @scala.inline
  def apply(responseView: String = null, task: Schema$Task = null): Schema$CreateTaskRequest = {
    ...
    __obj.asInstanceOf[Schema$CreateTaskRequest]
  }
}
