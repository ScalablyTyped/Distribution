...
/**
  ...
  */
@js.native
trait Schema$SpeechContext extends js.Object {
  /**
...
object Schema$SpeechContext {
  @scala.inline
  def apply(phrases: js.Array[String] = null): Schema$SpeechContext = {
    val __obj = js.Dynamic.literal()
    if (phrases != null) __obj.updateDynamic("phrases")(phrases.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$SpeechContext]
  }
}
