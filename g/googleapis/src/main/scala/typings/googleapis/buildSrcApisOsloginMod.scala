...
import typings.googleapis.buildSrcApisOsloginV1Mod.oslogin_v1.Options
import typings.googleapis.buildSrcApisOsloginV1Mod.oslogin_v1.Oslogin
...
object buildSrcApisOsloginMod extends js.Object {
  ...
  def oslogin(options: typings.googleapis.buildSrcApisOsloginV1alphaMod.oslogin_v1alpha.Options): typings.googleapis.buildSrcApisOsloginV1alphaMod.oslogin_v1alpha.Oslogin = js.native
  def oslogin(options: typings.googleapis.buildSrcApisOsloginV1betaMod.oslogin_v1beta.Options): typings.googleapis.buildSrcApisOsloginV1betaMod.oslogin_v1beta.Oslogin = js.native
  @JSName("oslogin")
  def oslogin_v1(version: v1): Oslogin = js.native
  @JSName("oslogin")
  def oslogin_v1alpha(version: v1alpha): typings.googleapis.buildSrcApisOsloginV1alphaMod.oslogin_v1alpha.Oslogin = js.native
  @JSName("oslogin")
  def oslogin_v1beta(version: v1beta): typings.googleapis.buildSrcApisOsloginV1betaMod.oslogin_v1beta.Oslogin = js.native
  @js.native
    ...
    object v1alpha
      extends TopLevel[
              Instantiable2[
                ...
                typings.googleapis.buildSrcApisOsloginV1alphaMod.oslogin_v1alpha.Oslogin
              ]
            ]
    ...
    object v1beta
      extends TopLevel[
              Instantiable2[
                /* options */ GlobalOptions, 
                js.UndefOr[/* google */ GoogleConfigurable], 
                typings.googleapis.buildSrcApisOsloginV1betaMod.oslogin_v1beta.Oslogin
              ]
            ]
