...
/**
  ...
  */
@js.native
trait Schema$NewDiskInitializeParams extends js.Object {
  /**
...
object Schema$NewDiskInitializeParams {
  @scala.inline
  def apply(diskSizeGb: String = null, diskType: String = null, sourceImage: String = null): Schema$NewDiskInitializeParams = {
    ...
    __obj.asInstanceOf[Schema$NewDiskInitializeParams]
  }
}
