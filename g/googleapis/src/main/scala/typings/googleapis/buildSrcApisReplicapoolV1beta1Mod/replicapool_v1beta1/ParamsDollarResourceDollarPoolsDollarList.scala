...
@js.native
trait ParamsDollarResourceDollarPoolsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPoolsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarPoolsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPoolsDollarList]
  }
}
