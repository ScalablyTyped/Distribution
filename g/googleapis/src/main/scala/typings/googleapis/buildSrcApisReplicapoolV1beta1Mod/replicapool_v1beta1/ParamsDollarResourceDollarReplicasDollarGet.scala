...
@js.native
trait ParamsDollarResourceDollarReplicasDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarReplicasDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarReplicasDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarReplicasDollarGet]
  }
}
