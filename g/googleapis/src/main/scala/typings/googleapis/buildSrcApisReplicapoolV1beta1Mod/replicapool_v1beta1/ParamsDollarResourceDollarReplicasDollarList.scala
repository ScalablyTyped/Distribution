...
@js.native
trait ParamsDollarResourceDollarReplicasDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarReplicasDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarReplicasDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarReplicasDollarList]
  }
}
