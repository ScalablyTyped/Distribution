...
trait SchemaRecipe extends StObject {
  
  /**
    * Collection of all external inputs that influenced the build on top of recipe.definedInMaterial and recipe.entryPoint. For example, if the recipe type were "make", then this might be the flags passed to make aside from the target, which is captured in recipe.entryPoint. Since the arguments field can greatly vary in structure, depending on the builder and recipe type, this is of form "Any".
    */
  var arguments: js.UndefOr[js.Array[StringDictionary[Any]] | Null] = js.undefined
  ...
  /**
    ...
    */
  var environment: js.UndefOr[js.Array[StringDictionary[Any]] | Null] = js.undefined
...
object SchemaRecipe {
  ...
  inline def apply(): SchemaRecipe = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRecipe]
  }
  
  extension [Self <: SchemaRecipe](x: Self) {
    
    inline def setArguments(value: js.Array[StringDictionary[Any]]): Self = StObject.set(x, "arguments", value.asInstanceOf[js.Any])
    
    inline def setArgumentsNull: Self = StObject.set(x, "arguments", null)
    
    inline def setArgumentsUndefined: Self = StObject.set(x, "arguments", js.undefined)
    
    inline def setArgumentsVarargs(value: StringDictionary[Any]*): Self = StObject.set(x, "arguments", js.Array(value*))
    ...
    inline def setEnvironment(value: js.Array[StringDictionary[Any]]): Self = StObject.set(x, "environment", value.asInstanceOf[js.Any])
    
    inline def setEnvironmentNull: Self = StObject.set(x, "environment", null)
    
    inline def setEnvironmentUndefined: Self = StObject.set(x, "environment", js.undefined)
    
    inline def setEnvironmentVarargs(value: StringDictionary[Any]*): Self = StObject.set(x, "environment", js.Array(value*))
