...
@JSImport("googleapis/build/src/apis/containeranalysis/v1", "containeranalysis_v1.Resource$Projects$Occurrences")
@js.native
open class ResourceProjectsOccurrences protected () extends StObject {
  ...
  def batchCreate(
    params: ParamsResourceProjectsOccurrencesBatchcreate,
    options: BodyResponseCallback[Readable | SchemaBatchCreateOccurrencesResponse],
    callback: BodyResponseCallback[Readable | SchemaBatchCreateOccurrencesResponse]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def batchCreate(params: ParamsResourceProjectsOccurrencesBatchcreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def batchCreate(
    params: ParamsResourceProjectsOccurrencesBatchcreate,
  ...
  def getVulnerabilitySummary(
    params: ParamsResourceProjectsOccurrencesGetvulnerabilitysummary,
    options: BodyResponseCallback[Readable | SchemaVulnerabilityOccurrencesSummary],
    callback: BodyResponseCallback[Readable | SchemaVulnerabilityOccurrencesSummary]
  ): Unit = js.native
