...
trait SchemaContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource extends StObject {
...
object SchemaContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource {
  
  inline def apply(): SchemaContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource]
  }
  
  extension [Self <: SchemaContaineranalysisGoogleDevtoolsCloudbuildV1StorageSource](x: Self) {
