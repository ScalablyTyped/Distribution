...
trait SchemaContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep extends StObject {
  ...
  /**
    ...
    */
  var pullTiming: js.UndefOr[SchemaContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan] = js.undefined
  ...
  /**
    ...
    */
  var timing: js.UndefOr[SchemaContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan] = js.undefined
...
object SchemaContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep {
  
  inline def apply(): SchemaContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep]
  }
  
  extension [Self <: SchemaContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep](x: Self) {
    ...
    inline def setPullTiming(value: SchemaContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan): Self = StObject.set(x, "pullTiming", value.asInstanceOf[js.Any])
    ...
    inline def setTiming(value: SchemaContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan): Self = StObject.set(x, "timing", value.asInstanceOf[js.Any])
