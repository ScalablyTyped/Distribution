...
trait SchemaSlsaMetadata extends StObject {
  ...
  /**
    ...
    */
  var completeness: js.UndefOr[SchemaSlsaCompleteness] = js.undefined
...
object SchemaSlsaMetadata {
  
  inline def apply(): SchemaSlsaMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSlsaMetadata]
  }
  
  extension [Self <: SchemaSlsaMetadata](x: Self) {
    ...
    inline def setCompleteness(value: SchemaSlsaCompleteness): Self = StObject.set(x, "completeness", value.asInstanceOf[js.Any])
