...
trait SchemaPackageNote extends StObject {
...
object SchemaPackageNote {
  
  inline def apply(): SchemaPackageNote = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPackageNote]
  }
  
  extension [Self <: SchemaPackageNote](x: Self) {
