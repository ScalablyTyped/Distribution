...
trait Schema$Group extends js.Object {
  /**
    ...
    */
  var contentDetails: js.UndefOr[Schema$GroupContentDetails] = js.native
  /**
  ...
  /**
    ...
    */
  var snippet: js.UndefOr[Schema$GroupSnippet] = js.native
}

object Schema$Group {
  @scala.inline
  def apply(
    contentDetails: Schema$GroupContentDetails = null,
    errors: Schema$Errors = null,
    etag: String = null,
    id: String = null,
    kind: String = null,
    snippet: Schema$GroupSnippet = null
  ): Schema$Group = {
