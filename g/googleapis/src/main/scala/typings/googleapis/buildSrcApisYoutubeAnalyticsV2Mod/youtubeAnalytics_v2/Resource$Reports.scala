...
class Resource$Reports protected () extends js.Object {
  ...
  def query(params: ParamsDollarResourceDollarReportsDollarQuery): GaxiosPromise[Schema$QueryResponse] = js.native
  def query(
  ...
  def query(params: ParamsDollarResourceDollarReportsDollarQuery, options: MethodOptions): GaxiosPromise[Schema$QueryResponse] = js.native
  def query(
    params: ParamsDollarResourceDollarReportsDollarQuery,
