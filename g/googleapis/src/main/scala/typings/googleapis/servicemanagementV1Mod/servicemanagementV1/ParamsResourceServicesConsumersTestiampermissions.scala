...
trait ParamsResourceServicesConsumersTestiampermissions
  extends StObject
...
object ParamsResourceServicesConsumersTestiampermissions {
  ...
  inline def apply(): ParamsResourceServicesConsumersTestiampermissions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceServicesConsumersTestiampermissions]
  }
  
  extension [Self <: ParamsResourceServicesConsumersTestiampermissions](x: Self) {
