...
trait SchemaGoogleCloudPolicysimulatorV1beta1AccessTuple extends StObject {
...
object SchemaGoogleCloudPolicysimulatorV1beta1AccessTuple {
  
  inline def apply(): SchemaGoogleCloudPolicysimulatorV1beta1AccessTuple = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicysimulatorV1beta1AccessTuple]
  }
  
  extension [Self <: SchemaGoogleCloudPolicysimulatorV1beta1AccessTuple](x: Self) {
