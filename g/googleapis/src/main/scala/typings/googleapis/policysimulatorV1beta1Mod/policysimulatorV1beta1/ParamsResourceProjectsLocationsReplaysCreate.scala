...
trait ParamsResourceProjectsLocationsReplaysCreate
  extends StObject
...
object ParamsResourceProjectsLocationsReplaysCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsReplaysCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsReplaysCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsReplaysCreate](x: Self) {
