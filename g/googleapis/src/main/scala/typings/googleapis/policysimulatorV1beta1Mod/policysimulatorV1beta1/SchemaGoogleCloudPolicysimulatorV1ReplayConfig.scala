...
trait SchemaGoogleCloudPolicysimulatorV1ReplayConfig extends StObject {
...
object SchemaGoogleCloudPolicysimulatorV1ReplayConfig {
  
  inline def apply(): SchemaGoogleCloudPolicysimulatorV1ReplayConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicysimulatorV1ReplayConfig]
  }
  
  extension [Self <: SchemaGoogleCloudPolicysimulatorV1ReplayConfig](x: Self) {
