...
trait ParamsResourceProjectsLocationsReplaysResultsList
  extends StObject
...
object ParamsResourceProjectsLocationsReplaysResultsList {
  
  inline def apply(): ParamsResourceProjectsLocationsReplaysResultsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsReplaysResultsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsReplaysResultsList](x: Self) {
