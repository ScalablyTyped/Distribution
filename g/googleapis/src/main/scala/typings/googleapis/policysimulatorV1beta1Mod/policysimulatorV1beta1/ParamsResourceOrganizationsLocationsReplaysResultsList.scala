...
trait ParamsResourceOrganizationsLocationsReplaysResultsList
  extends StObject
...
object ParamsResourceOrganizationsLocationsReplaysResultsList {
  
  inline def apply(): ParamsResourceOrganizationsLocationsReplaysResultsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsLocationsReplaysResultsList]
  }
  
  extension [Self <: ParamsResourceOrganizationsLocationsReplaysResultsList](x: Self) {
