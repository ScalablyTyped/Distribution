...
trait SchemaGoogleCloudPolicysimulatorV1beta1ReplayResult extends StObject {
  ...
  /**
    ...
    */
  var accessTuple: js.UndefOr[SchemaGoogleCloudPolicysimulatorV1beta1AccessTuple] = js.undefined
  ...
  /**
    ...
    */
  var diff: js.UndefOr[SchemaGoogleCloudPolicysimulatorV1beta1ReplayDiff] = js.undefined
...
object SchemaGoogleCloudPolicysimulatorV1beta1ReplayResult {
  
  inline def apply(): SchemaGoogleCloudPolicysimulatorV1beta1ReplayResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicysimulatorV1beta1ReplayResult]
  }
  
  extension [Self <: SchemaGoogleCloudPolicysimulatorV1beta1ReplayResult](x: Self) {
    
    inline def setAccessTuple(value: SchemaGoogleCloudPolicysimulatorV1beta1AccessTuple): Self = StObject.set(x, "accessTuple", value.asInstanceOf[js.Any])
    
    inline def setAccessTupleUndefined: Self = StObject.set(x, "accessTuple", js.undefined)
    
    inline def setDiff(value: SchemaGoogleCloudPolicysimulatorV1beta1ReplayDiff): Self = StObject.set(x, "diff", value.asInstanceOf[js.Any])
