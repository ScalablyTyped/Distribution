...
trait SchemaGoogleCloudPolicysimulatorV1beta1ExplainedPolicy extends StObject {
  ...
  /**
    ...
    */
  var bindingExplanations: js.UndefOr[js.Array[SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanation]] = js.undefined
...
object SchemaGoogleCloudPolicysimulatorV1beta1ExplainedPolicy {
  
  inline def apply(): SchemaGoogleCloudPolicysimulatorV1beta1ExplainedPolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicysimulatorV1beta1ExplainedPolicy]
  }
  
  extension [Self <: SchemaGoogleCloudPolicysimulatorV1beta1ExplainedPolicy](x: Self) {
    ...
    inline def setBindingExplanations(value: js.Array[SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanation]): Self = StObject.set(x, "bindingExplanations", value.asInstanceOf[js.Any])
    
    inline def setBindingExplanationsUndefined: Self = StObject.set(x, "bindingExplanations", js.undefined)
    
    inline def setBindingExplanationsVarargs(value: SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanation*): Self = StObject.set(x, "bindingExplanations", js.Array(value*))
