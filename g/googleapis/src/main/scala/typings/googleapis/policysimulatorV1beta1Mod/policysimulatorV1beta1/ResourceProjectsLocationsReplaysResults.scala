...
@JSImport("googleapis/build/src/apis/policysimulator/v1beta1", "policysimulator_v1beta1.Resource$Projects$Locations$Replays$Results")
@js.native
open class ResourceProjectsLocationsReplaysResults protected () extends StObject {
  ...
  def list(params: ParamsResourceProjectsLocationsReplaysResultsList): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1beta1ListReplayResultsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsReplaysResultsList,
  ...
  def list(params: ParamsResourceProjectsLocationsReplaysResultsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1beta1ListReplayResultsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsReplaysResultsList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceProjectsLocationsReplaysResultsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsLocationsReplaysResultsList,
