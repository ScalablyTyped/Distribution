...
trait SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanationAnnotatedMembership extends StObject {
...
object SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanationAnnotatedMembership {
  
  inline def apply(): SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanationAnnotatedMembership = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanationAnnotatedMembership]
  }
  
  extension [Self <: SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanationAnnotatedMembership](x: Self) {
