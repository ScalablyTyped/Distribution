...
@JSImport("googleapis/build/src/apis/policysimulator/v1beta1", "policysimulator_v1beta1.Resource$Organizations$Locations$Replays$Results")
@js.native
open class ResourceOrganizationsLocationsReplaysResults protected () extends StObject {
  ...
  def list(params: ParamsResourceOrganizationsLocationsReplaysResultsList): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1beta1ListReplayResultsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsReplaysResultsList,
  ...
  def list(params: ParamsResourceOrganizationsLocationsReplaysResultsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1beta1ListReplayResultsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsReplaysResultsList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceOrganizationsLocationsReplaysResultsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsReplaysResultsList,
