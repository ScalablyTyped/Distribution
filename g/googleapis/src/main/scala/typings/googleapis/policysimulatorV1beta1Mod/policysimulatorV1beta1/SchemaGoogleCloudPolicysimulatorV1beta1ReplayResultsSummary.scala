...
trait SchemaGoogleCloudPolicysimulatorV1beta1ReplayResultsSummary extends StObject {
...
object SchemaGoogleCloudPolicysimulatorV1beta1ReplayResultsSummary {
  
  inline def apply(): SchemaGoogleCloudPolicysimulatorV1beta1ReplayResultsSummary = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicysimulatorV1beta1ReplayResultsSummary]
  }
  
  extension [Self <: SchemaGoogleCloudPolicysimulatorV1beta1ReplayResultsSummary](x: Self) {
