...
trait SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanation extends StObject {
  ...
  var memberships: js.UndefOr[
    StringDictionary[SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanationAnnotatedMembership] | Null
  ] = js.undefined
...
object SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanation {
  
  inline def apply(): SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanation]
  }
  
  extension [Self <: SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanation](x: Self) {
    ...
    inline def setMemberships(
      value: StringDictionary[SchemaGoogleCloudPolicysimulatorV1beta1BindingExplanationAnnotatedMembership]
