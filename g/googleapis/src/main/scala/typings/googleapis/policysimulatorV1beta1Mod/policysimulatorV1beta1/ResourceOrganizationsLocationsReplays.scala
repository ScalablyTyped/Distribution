...
@JSImport("googleapis/build/src/apis/policysimulator/v1beta1", "policysimulator_v1beta1.Resource$Organizations$Locations$Replays")
@js.native
open class ResourceOrganizationsLocationsReplays protected () extends StObject {
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1beta1Replay] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudPolicysimulatorV1beta1Replay]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1beta1Replay] = js.native
  def get(params: ParamsResourceOrganizationsLocationsReplaysGet): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1beta1Replay] = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsReplaysGet,
    callback: BodyResponseCallback[SchemaGoogleCloudPolicysimulatorV1beta1Replay]
  ): Unit = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsReplaysGet,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudPolicysimulatorV1beta1Replay],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudPolicysimulatorV1beta1Replay]
  ): Unit = js.native
  def get(params: ParamsResourceOrganizationsLocationsReplaysGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPolicysimulatorV1beta1Replay] = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsReplaysGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudPolicysimulatorV1beta1Replay]
