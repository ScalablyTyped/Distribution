...
trait ParamsResourceProjectsLocationsAppconnectionsCreate
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudBeyondcorpAppconnectionsV1alphaAppConnection] = js.undefined
...
object ParamsResourceProjectsLocationsAppconnectionsCreate {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAppconnectionsCreate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudBeyondcorpAppconnectionsV1alphaAppConnection): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
