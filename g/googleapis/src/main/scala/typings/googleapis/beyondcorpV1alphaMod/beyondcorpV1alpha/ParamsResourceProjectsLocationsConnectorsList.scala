...
trait ParamsResourceProjectsLocationsConnectorsList
  extends StObject
...
object ParamsResourceProjectsLocationsConnectorsList {
  
  inline def apply(): ParamsResourceProjectsLocationsConnectorsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsConnectorsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsConnectorsList](x: Self) {
