...
trait SchemaContainerHealthDetails extends StObject {
...
object SchemaContainerHealthDetails {
  
  inline def apply(): SchemaContainerHealthDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaContainerHealthDetails]
  }
  
  extension [Self <: SchemaContainerHealthDetails](x: Self) {
