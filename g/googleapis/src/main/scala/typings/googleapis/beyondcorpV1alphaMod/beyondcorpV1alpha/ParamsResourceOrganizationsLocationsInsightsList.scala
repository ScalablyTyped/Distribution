...
trait ParamsResourceOrganizationsLocationsInsightsList
  extends StObject
...
object ParamsResourceOrganizationsLocationsInsightsList {
  
  inline def apply(): ParamsResourceOrganizationsLocationsInsightsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsLocationsInsightsList]
  }
  
  extension [Self <: ParamsResourceOrganizationsLocationsInsightsList](x: Self) {
