...
@JSImport("googleapis/build/src/apis/beyondcorp/v1alpha", "beyondcorp_v1alpha.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var applications: ResourceProjectsLocationsApplications = js.native
  ...
  var connectors: ResourceProjectsLocationsConnectors = js.native
  ...
  var insights: ResourceProjectsLocationsInsights = js.native
