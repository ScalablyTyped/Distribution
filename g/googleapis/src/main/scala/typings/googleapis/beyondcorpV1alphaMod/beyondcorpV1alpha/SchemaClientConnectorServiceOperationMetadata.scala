...
trait SchemaClientConnectorServiceOperationMetadata extends StObject {
...
object SchemaClientConnectorServiceOperationMetadata {
  
  inline def apply(): SchemaClientConnectorServiceOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaClientConnectorServiceOperationMetadata]
  }
  
  extension [Self <: SchemaClientConnectorServiceOperationMetadata](x: Self) {
