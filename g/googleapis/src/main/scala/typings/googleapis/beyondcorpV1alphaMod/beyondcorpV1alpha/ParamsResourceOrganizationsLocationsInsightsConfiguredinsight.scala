...
trait ParamsResourceOrganizationsLocationsInsightsConfiguredinsight
  extends StObject
...
object ParamsResourceOrganizationsLocationsInsightsConfiguredinsight {
  
  inline def apply(): ParamsResourceOrganizationsLocationsInsightsConfiguredinsight = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsLocationsInsightsConfiguredinsight]
  }
  
  extension [Self <: ParamsResourceOrganizationsLocationsInsightsConfiguredinsight](x: Self) {
