...
@JSImport("googleapis/build/src/apis/beyondcorp/v1alpha", "beyondcorp_v1alpha.Resource$Projects$Locations$Appconnectors")
@js.native
open class ResourceProjectsLocationsAppconnectors protected () extends StObject {
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnector] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnector]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnector] = js.native
  def get(params: ParamsResourceProjectsLocationsAppconnectorsGet): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnector] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAppconnectorsGet,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnector]
  ): Unit = js.native
  def get(
    params: ParamsResourceProjectsLocationsAppconnectorsGet,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnector],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnector]
  ): Unit = js.native
  def get(params: ParamsResourceProjectsLocationsAppconnectorsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnector] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAppconnectorsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnector]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaListAppConnectorsResponse] = js.native
  def list(
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaListAppConnectorsResponse]
  ): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaListAppConnectorsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsAppconnectorsList): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaListAppConnectorsResponse] = js.native
  def list(
  ...
  def list(
    ...
    options: BodyResponseCallback[
      Readable | SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaListAppConnectorsResponse
    ],
    callback: BodyResponseCallback[
      Readable | SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaListAppConnectorsResponse
    ]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsAppconnectorsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaListAppConnectorsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAppconnectorsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaListAppConnectorsResponse]
  ...
  def resolveInstanceConfig(): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaResolveInstanceConfigResponse] = js.native
  def resolveInstanceConfig(
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaResolveInstanceConfigResponse]
  ): Unit = js.native
  def resolveInstanceConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaResolveInstanceConfigResponse] = js.native
  def resolveInstanceConfig(params: ParamsResourceProjectsLocationsAppconnectorsResolveinstanceconfig): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaResolveInstanceConfigResponse] = js.native
  def resolveInstanceConfig(
  ...
  def resolveInstanceConfig(
    params: ParamsResourceProjectsLocationsAppconnectorsResolveinstanceconfig,
    options: BodyResponseCallback[
      Readable | SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaResolveInstanceConfigResponse
    ],
    callback: BodyResponseCallback[
      Readable | SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaResolveInstanceConfigResponse
    ]
  ): Unit = js.native
  def resolveInstanceConfig(params: ParamsResourceProjectsLocationsAppconnectorsResolveinstanceconfig, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaResolveInstanceConfigResponse] = js.native
  def resolveInstanceConfig(
    params: ParamsResourceProjectsLocationsAppconnectorsResolveinstanceconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaResolveInstanceConfigResponse]
