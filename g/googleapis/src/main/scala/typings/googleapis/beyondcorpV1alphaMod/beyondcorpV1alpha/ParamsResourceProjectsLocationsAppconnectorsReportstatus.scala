...
trait ParamsResourceProjectsLocationsAppconnectorsReportstatus
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaReportStatusRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAppconnectorsReportstatus {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAppconnectorsReportstatus](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaReportStatusRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
