...
trait SchemaConnectorOperationMetadata extends StObject {
...
object SchemaConnectorOperationMetadata {
  
  inline def apply(): SchemaConnectorOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaConnectorOperationMetadata]
  }
  
  extension [Self <: SchemaConnectorOperationMetadata](x: Self) {
