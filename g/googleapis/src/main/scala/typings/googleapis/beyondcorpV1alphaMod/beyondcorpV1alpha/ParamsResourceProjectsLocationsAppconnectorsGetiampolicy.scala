...
trait ParamsResourceProjectsLocationsAppconnectorsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsAppconnectorsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsAppconnectorsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAppconnectorsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAppconnectorsGetiampolicy](x: Self) {
