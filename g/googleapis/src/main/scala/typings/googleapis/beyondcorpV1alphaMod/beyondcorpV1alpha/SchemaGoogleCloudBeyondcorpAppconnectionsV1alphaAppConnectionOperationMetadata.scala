...
trait SchemaGoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionOperationMetadata extends StObject {
...
object SchemaGoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpAppconnectionsV1alphaAppConnectionOperationMetadata](x: Self) {
