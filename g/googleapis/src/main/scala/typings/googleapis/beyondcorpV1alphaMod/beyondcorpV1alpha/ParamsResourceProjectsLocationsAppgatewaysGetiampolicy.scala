...
trait ParamsResourceProjectsLocationsAppgatewaysGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsAppgatewaysGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsAppgatewaysGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAppgatewaysGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAppgatewaysGetiampolicy](x: Self) {
