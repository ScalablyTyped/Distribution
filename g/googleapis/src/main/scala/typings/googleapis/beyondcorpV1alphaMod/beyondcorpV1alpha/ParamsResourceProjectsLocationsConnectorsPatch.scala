...
trait ParamsResourceProjectsLocationsConnectorsPatch
  extends StObject
...
object ParamsResourceProjectsLocationsConnectorsPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsConnectorsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsConnectorsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsConnectorsPatch](x: Self) {
