...
@JSImport("googleapis/build/src/apis/beyondcorp/v1alpha", "beyondcorp_v1alpha.Resource$Organizations$Locations$Insights")
@js.native
open class ResourceOrganizationsLocationsInsights protected () extends StObject {
  ...
  def configuredInsight(params: ParamsResourceOrganizationsLocationsInsightsConfiguredinsight): GaxiosPromise[SchemaGoogleCloudBeyondcorpSaasplatformInsightsV1alphaConfiguredInsightResponse] = js.native
  def configuredInsight(
    params: ParamsResourceOrganizationsLocationsInsightsConfiguredinsight,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpSaasplatformInsightsV1alphaConfiguredInsightResponse]
  ): Unit = js.native
  def configuredInsight(
    params: ParamsResourceOrganizationsLocationsInsightsConfiguredinsight,
  ...
  def configuredInsight(params: ParamsResourceOrganizationsLocationsInsightsConfiguredinsight, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpSaasplatformInsightsV1alphaConfiguredInsightResponse] = js.native
  def configuredInsight(
    params: ParamsResourceOrganizationsLocationsInsightsConfiguredinsight,
  ...
  def get(params: ParamsResourceOrganizationsLocationsInsightsGet): GaxiosPromise[SchemaGoogleCloudBeyondcorpSaasplatformInsightsV1alphaInsight] = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsInsightsGet,
  ...
  def get(params: ParamsResourceOrganizationsLocationsInsightsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpSaasplatformInsightsV1alphaInsight] = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsInsightsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpSaasplatformInsightsV1alphaInsight]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def get(params: ParamsResourceOrganizationsLocationsInsightsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsInsightsGet,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def list(params: ParamsResourceOrganizationsLocationsInsightsList): GaxiosPromise[SchemaGoogleCloudBeyondcorpSaasplatformInsightsV1alphaListInsightsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsInsightsList,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpSaasplatformInsightsV1alphaListInsightsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsInsightsList,
  ...
  def list(params: ParamsResourceOrganizationsLocationsInsightsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpSaasplatformInsightsV1alphaListInsightsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsInsightsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpSaasplatformInsightsV1alphaListInsightsResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceOrganizationsLocationsInsightsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsInsightsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
