...
trait ParamsResourceProjectsLocationsApplicationsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsApplicationsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsApplicationsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApplicationsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApplicationsGetiampolicy](x: Self) {
