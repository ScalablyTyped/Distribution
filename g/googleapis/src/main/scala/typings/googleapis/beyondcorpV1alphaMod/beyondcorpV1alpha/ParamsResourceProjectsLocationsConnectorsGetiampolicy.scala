...
trait ParamsResourceProjectsLocationsConnectorsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsConnectorsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsConnectorsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsConnectorsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsConnectorsGetiampolicy](x: Self) {
