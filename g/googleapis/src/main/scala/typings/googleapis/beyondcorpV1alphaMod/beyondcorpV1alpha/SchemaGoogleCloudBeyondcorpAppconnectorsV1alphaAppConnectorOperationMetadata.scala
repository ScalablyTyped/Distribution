...
trait SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorOperationMetadata extends StObject {
...
object SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpAppconnectorsV1alphaAppConnectorOperationMetadata](x: Self) {
