...
trait ParamsResourceProjectsLocationsInsightsGet
  extends StObject
...
object ParamsResourceProjectsLocationsInsightsGet {
  
  inline def apply(): ParamsResourceProjectsLocationsInsightsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsInsightsGet]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsInsightsGet](x: Self) {
