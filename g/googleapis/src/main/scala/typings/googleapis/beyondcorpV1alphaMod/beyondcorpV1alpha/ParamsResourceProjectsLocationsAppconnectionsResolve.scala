...
trait ParamsResourceProjectsLocationsAppconnectionsResolve
  extends StObject
...
object ParamsResourceProjectsLocationsAppconnectionsResolve {
  
  inline def apply(): ParamsResourceProjectsLocationsAppconnectionsResolve = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAppconnectionsResolve]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAppconnectionsResolve](x: Self) {
