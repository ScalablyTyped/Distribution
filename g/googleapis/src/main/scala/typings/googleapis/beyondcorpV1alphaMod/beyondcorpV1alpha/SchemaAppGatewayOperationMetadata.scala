...
trait SchemaAppGatewayOperationMetadata extends StObject {
...
object SchemaAppGatewayOperationMetadata {
  
  inline def apply(): SchemaAppGatewayOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAppGatewayOperationMetadata]
  }
  
  extension [Self <: SchemaAppGatewayOperationMetadata](x: Self) {
