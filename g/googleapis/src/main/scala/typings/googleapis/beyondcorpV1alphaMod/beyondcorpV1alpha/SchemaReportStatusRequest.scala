...
trait SchemaReportStatusRequest extends StObject {
...
object SchemaReportStatusRequest {
  
  inline def apply(): SchemaReportStatusRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaReportStatusRequest]
  }
  
  extension [Self <: SchemaReportStatusRequest](x: Self) {
