...
trait SchemaGoogleCloudBeyondcorpClientgatewaysV1ClientGatewayOperationMetadata extends StObject {
...
object SchemaGoogleCloudBeyondcorpClientgatewaysV1ClientGatewayOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpClientgatewaysV1ClientGatewayOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpClientgatewaysV1ClientGatewayOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpClientgatewaysV1ClientGatewayOperationMetadata](x: Self) {
