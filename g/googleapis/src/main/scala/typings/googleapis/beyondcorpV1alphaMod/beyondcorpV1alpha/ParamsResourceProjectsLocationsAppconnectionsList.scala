...
trait ParamsResourceProjectsLocationsAppconnectionsList
  extends StObject
...
object ParamsResourceProjectsLocationsAppconnectionsList {
  
  inline def apply(): ParamsResourceProjectsLocationsAppconnectionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAppconnectionsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAppconnectionsList](x: Self) {
