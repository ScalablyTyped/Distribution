...
trait SchemaConnectionOperationMetadata extends StObject {
...
object SchemaConnectionOperationMetadata {
  
  inline def apply(): SchemaConnectionOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaConnectionOperationMetadata]
  }
  
  extension [Self <: SchemaConnectionOperationMetadata](x: Self) {
