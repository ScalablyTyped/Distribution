...
object SchemaStartIPRotationRequest {
  ...
  implicit class SchemaStartIPRotationRequestOps[Self <: SchemaStartIPRotationRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRotateCredentials(value: Boolean): Self = this.set("rotateCredentials", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRotateCredentials: Self = this.set("rotateCredentials", js.undefined)
