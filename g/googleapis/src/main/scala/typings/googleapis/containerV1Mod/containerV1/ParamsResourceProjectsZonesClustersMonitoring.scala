...
trait ParamsResourceProjectsZonesClustersMonitoring
  extends StObject
...
object ParamsResourceProjectsZonesClustersMonitoring {
  ...
  inline def apply(): ParamsResourceProjectsZonesClustersMonitoring = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsZonesClustersMonitoring]
  }
  
  extension [Self <: ParamsResourceProjectsZonesClustersMonitoring](x: Self) {
