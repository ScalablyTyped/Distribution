...
object ParamsResourceProjectsLocationsClustersNodepoolsSetautoscaling {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersNodepoolsSetautoscalingOps[Self <: ParamsResourceProjectsLocationsClustersNodepoolsSetautoscaling] (val x: Self) extends AnyVal {
