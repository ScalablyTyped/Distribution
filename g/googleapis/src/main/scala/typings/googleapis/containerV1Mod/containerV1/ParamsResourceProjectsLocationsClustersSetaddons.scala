...
object ParamsResourceProjectsLocationsClustersSetaddons {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsClustersSetaddons = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsClustersSetaddons]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsClustersSetaddonsMutableBuilder[Self <: ParamsResourceProjectsLocationsClustersSetaddons] (val x: Self) extends AnyVal {
