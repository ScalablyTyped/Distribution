...
trait ParamsResourceProjectsZonesClustersNodepoolsGet
  extends StObject
...
object ParamsResourceProjectsZonesClustersNodepoolsGet {
  
  @scala.inline
  def apply(): ParamsResourceProjectsZonesClustersNodepoolsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsZonesClustersNodepoolsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsZonesClustersNodepoolsGetMutableBuilder[Self <: ParamsResourceProjectsZonesClustersNodepoolsGet] (val x: Self) extends AnyVal {
