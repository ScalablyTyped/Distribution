...
trait ParamsResourceProjectsZonesClustersResourcelabels
  extends StObject
...
object ParamsResourceProjectsZonesClustersResourcelabels {
  ...
  inline def apply(): ParamsResourceProjectsZonesClustersResourcelabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsZonesClustersResourcelabels]
  }
  
  extension [Self <: ParamsResourceProjectsZonesClustersResourcelabels](x: Self) {
