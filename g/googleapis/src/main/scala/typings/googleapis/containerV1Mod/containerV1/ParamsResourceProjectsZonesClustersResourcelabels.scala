...
object ParamsResourceProjectsZonesClustersResourcelabels {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsZonesClustersResourcelabelsOps[Self <: ParamsResourceProjectsZonesClustersResourcelabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaSetLabelsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
