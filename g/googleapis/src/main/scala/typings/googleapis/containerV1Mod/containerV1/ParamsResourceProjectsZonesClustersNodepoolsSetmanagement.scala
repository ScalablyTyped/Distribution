...
@js.native
trait ParamsResourceProjectsZonesClustersNodepoolsSetmanagement extends StandardParameters {
...
object ParamsResourceProjectsZonesClustersNodepoolsSetmanagement {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsZonesClustersNodepoolsSetmanagementMutableBuilder[Self <: ParamsResourceProjectsZonesClustersNodepoolsSetmanagement] (val x: Self) extends AnyVal {
