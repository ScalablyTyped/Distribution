...
import typings.googleapis.buildSrcApisManufacturersV1Mod.manufacturers_v1.Manufacturers
import typings.googleapis.buildSrcApisManufacturersV1Mod.manufacturers_v1.Options
