...
object ParamsResourceProjectsLocationsQueuesPurge {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesPurgeOps[Self <: ParamsResourceProjectsLocationsQueuesPurge] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaPurgeQueueRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
