...
import typings.googleapis.buildSrcApisCloudfunctionsV1Mod.cloudfunctions_v1.Cloudfunctions
import typings.googleapis.buildSrcApisCloudfunctionsV1Mod.cloudfunctions_v1.Options
...
@js.native
object buildSrcApisCloudfunctionsMod extends js.Object {
  def cloudfunctions(options: Options): Cloudfunctions = js.native
  def cloudfunctions(options: typings.googleapis.buildSrcApisCloudfunctionsV1beta2Mod.cloudfunctions_v1beta2.Options): typings.googleapis.buildSrcApisCloudfunctionsV1beta2Mod.cloudfunctions_v1beta2.Cloudfunctions = js.native
  @JSName("cloudfunctions")
  def cloudfunctions_v1(version: v1): Cloudfunctions = js.native
  @JSName("cloudfunctions")
  def cloudfunctions_v1beta2(version: v1beta2): typings.googleapis.buildSrcApisCloudfunctionsV1beta2Mod.cloudfunctions_v1beta2.Cloudfunctions = js.native
  @js.native
    ...
    object v1beta2
      extends TopLevel[
              Instantiable2[
                /* options */ GlobalOptions, 
                js.UndefOr[/* google */ GoogleConfigurable], 
                typings.googleapis.buildSrcApisCloudfunctionsV1beta2Mod.cloudfunctions_v1beta2.Cloudfunctions
              ]
            ]
