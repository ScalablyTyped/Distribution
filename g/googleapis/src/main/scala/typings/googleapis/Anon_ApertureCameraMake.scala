...
@js.native
trait Anon_ApertureCameraMake extends js.Object {
  ...
  var location: js.UndefOr[Anon_Altitude] = js.native
...
object Anon_ApertureCameraMake {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_ApertureCameraMake]
  }
}
