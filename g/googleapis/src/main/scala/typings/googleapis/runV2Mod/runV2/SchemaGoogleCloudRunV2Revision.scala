...
trait SchemaGoogleCloudRunV2Revision extends StObject {
...
object SchemaGoogleCloudRunV2Revision {
  
  inline def apply(): SchemaGoogleCloudRunV2Revision = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRunV2Revision]
  }
  
  extension [Self <: SchemaGoogleCloudRunV2Revision](x: Self) {
