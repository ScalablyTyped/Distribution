...
trait SchemaGoogleCloudRunV2Service extends StObject {
  ...
  /**
    ...
    */
  var ingress: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var latestCreatedRevision: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Output only. Name of the latest revision that is serving traffic. See comments in `reconciling` for additional information on reconciliation process in Cloud Run.
    */
  var latestReadyRevision: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var template: js.UndefOr[SchemaGoogleCloudRunV2RevisionTemplate] = js.undefined
  ...
  /**
    ...
    */
  var traffic: js.UndefOr[js.Array[SchemaGoogleCloudRunV2TrafficTarget]] = js.undefined
  ...
  /**
    ...
    */
  var trafficStatuses: js.UndefOr[js.Array[SchemaGoogleCloudRunV2TrafficTargetStatus]] = js.undefined
...
object SchemaGoogleCloudRunV2Service {
  
  inline def apply(): SchemaGoogleCloudRunV2Service = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRunV2Service]
  }
  
  extension [Self <: SchemaGoogleCloudRunV2Service](x: Self) {
    ...
    inline def setIngressNull: Self = StObject.set(x, "ingress", null)
    ...
    inline def setLatestCreatedRevisionNull: Self = StObject.set(x, "latestCreatedRevision", null)
    ...
    inline def setLatestReadyRevisionNull: Self = StObject.set(x, "latestReadyRevision", null)
    ...
    inline def setTemplate(value: SchemaGoogleCloudRunV2RevisionTemplate): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
    ...
    inline def setTraffic(value: js.Array[SchemaGoogleCloudRunV2TrafficTarget]): Self = StObject.set(x, "traffic", value.asInstanceOf[js.Any])
    
    inline def setTrafficStatuses(value: js.Array[SchemaGoogleCloudRunV2TrafficTargetStatus]): Self = StObject.set(x, "trafficStatuses", value.asInstanceOf[js.Any])
    
    inline def setTrafficStatusesUndefined: Self = StObject.set(x, "trafficStatuses", js.undefined)
    
    inline def setTrafficStatusesVarargs(value: SchemaGoogleCloudRunV2TrafficTargetStatus*): Self = StObject.set(x, "trafficStatuses", js.Array(value*))
    
    inline def setTrafficUndefined: Self = StObject.set(x, "traffic", js.undefined)
    
    inline def setTrafficVarargs(value: SchemaGoogleCloudRunV2TrafficTarget*): Self = StObject.set(x, "traffic", js.Array(value*))
