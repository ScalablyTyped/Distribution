...
trait ParamsResourceProjectsLocationsJobsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsJobsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsJobsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsJobsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsJobsGetiampolicy](x: Self) {
