...
@js.native
trait ParamsDollarResourceDollarManagedzonesDollarCreate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagedzonesDollarCreate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarManagedzonesDollarCreate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagedzonesDollarCreate]
  }
}
