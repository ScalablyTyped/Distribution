...
trait SchemaBatchDeleteAlertsResponse extends StObject {
...
object SchemaBatchDeleteAlertsResponse {
  
  inline def apply(): SchemaBatchDeleteAlertsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBatchDeleteAlertsResponse]
  }
  
  extension [Self <: SchemaBatchDeleteAlertsResponse](x: Self) {
