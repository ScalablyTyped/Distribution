...
trait SchemaBatchUndeleteAlertsRequest extends StObject {
...
object SchemaBatchUndeleteAlertsRequest {
  
  inline def apply(): SchemaBatchUndeleteAlertsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBatchUndeleteAlertsRequest]
  }
  
  extension [Self <: SchemaBatchUndeleteAlertsRequest](x: Self) {
