...
trait SchemaRuleInfo extends StObject {
...
object SchemaRuleInfo {
  
  inline def apply(): SchemaRuleInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRuleInfo]
  }
  
  extension [Self <: SchemaRuleInfo](x: Self) {
