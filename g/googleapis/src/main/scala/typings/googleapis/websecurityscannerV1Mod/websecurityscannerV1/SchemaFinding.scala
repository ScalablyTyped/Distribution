...
trait SchemaFinding extends StObject {
  ...
  /**
    ...
    */
  var reproductionUrl: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var xxe: js.UndefOr[SchemaXxe] = js.undefined
}
object SchemaFinding {
  ...
  extension [Self <: SchemaFinding](x: Self) {
    ...
    inline def setFrameUrlNull: Self = StObject.set(x, "frameUrl", null)
    ...
    inline def setFuzzedUrlNull: Self = StObject.set(x, "fuzzedUrl", null)
    ...
    inline def setReproductionUrlNull: Self = StObject.set(x, "reproductionUrl", null)
    ...
    inline def setXxe(value: SchemaXxe): Self = StObject.set(x, "xxe", value.asInstanceOf[js.Any])
