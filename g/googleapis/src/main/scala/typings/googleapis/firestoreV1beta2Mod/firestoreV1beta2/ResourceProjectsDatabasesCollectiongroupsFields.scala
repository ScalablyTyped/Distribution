...
open class ResourceProjectsDatabasesCollectiongroupsFields protected () extends StObject {
  ...
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleFirestoreAdminV1beta2Field] = js.native
  ...
  def get(
    params: ParamsResourceProjectsDatabasesCollectiongroupsFieldsGet,
    options: BodyResponseCallback[Readable | SchemaGoogleFirestoreAdminV1beta2Field],
    callback: BodyResponseCallback[Readable | SchemaGoogleFirestoreAdminV1beta2Field]
  ): Unit = js.native
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleFirestoreAdminV1beta2ListFieldsResponse] = js.native
  ...
  def list(
    params: ParamsResourceProjectsDatabasesCollectiongroupsFieldsList,
    options: BodyResponseCallback[Readable | SchemaGoogleFirestoreAdminV1beta2ListFieldsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleFirestoreAdminV1beta2ListFieldsResponse]
  ): Unit = js.native
