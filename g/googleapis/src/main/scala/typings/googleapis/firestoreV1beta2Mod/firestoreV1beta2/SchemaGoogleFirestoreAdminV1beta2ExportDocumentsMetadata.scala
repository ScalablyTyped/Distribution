...
object SchemaGoogleFirestoreAdminV1beta2ExportDocumentsMetadata {
  ...
  @scala.inline
  def apply(): SchemaGoogleFirestoreAdminV1beta2ExportDocumentsMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirestoreAdminV1beta2ExportDocumentsMetadata]
  }
  
  @scala.inline
  implicit class SchemaGoogleFirestoreAdminV1beta2ExportDocumentsMetadataMutableBuilder[Self <: SchemaGoogleFirestoreAdminV1beta2ExportDocumentsMetadata] (val x: Self) extends AnyVal {
