...
object ParamsResourceProjectsDatabasesCollectiongroupsFieldsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsDatabasesCollectiongroupsFieldsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsDatabasesCollectiongroupsFieldsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsDatabasesCollectiongroupsFieldsGetMutableBuilder[Self <: ParamsResourceProjectsDatabasesCollectiongroupsFieldsGet] (val x: Self) extends AnyVal {
