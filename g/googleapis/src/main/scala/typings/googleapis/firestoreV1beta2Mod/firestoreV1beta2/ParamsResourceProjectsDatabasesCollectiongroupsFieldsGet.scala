...
object ParamsResourceProjectsDatabasesCollectiongroupsFieldsGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsDatabasesCollectiongroupsFieldsGetOps[Self <: ParamsResourceProjectsDatabasesCollectiongroupsFieldsGet] (val x: Self) extends AnyVal {
